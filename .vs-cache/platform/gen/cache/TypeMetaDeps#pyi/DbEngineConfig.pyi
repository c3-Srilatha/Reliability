...
# Python definitions for the C3 type DbEngineConfig


class DbEngineConfig(Config):
    """
    Configuration for Db engine.
    
    @remarks this represents a made instance of DbEngineConfig
    """
    ...
    saveOpenIteratorsStackTrace: Optional[bool]=None
    """
    True if we should save the stack trace when tracking open iterators.
    """

    hideSqlErrors: Optional[bool]=None
    """
    True if sql should be suppressed from any errors thrown by the database
    """

    statsLoggingFrequencySeconds: Optional[int]=None
    """
    Frequency to log various database/query statistics.
    """

    monitorLoopFrequencySeconds: Optional[int]=None
    """
    Frequency to run the monitor loop.
    """

    blockedPgStmtTerminateFrequencyMinutes: Optional[int]=None
    """
    The monitor loop sweeps for blocked PG statements.  This is the frequency that the check will be made.
    """

    blockedPgStmtTerminateThresholdMinutes: Optional[int]=None
    """
    The monitor loop sweeps for blocked PG statements.  During that sweep, any statements that have been blocked longer
    than this will have their connection terminated.
    """
    def __init__(self, configOverride: Optional[str]=None, secretOverride: Optional[str]=None, issues: Optional[Array[str]]=None, saveOpenIteratorsStackTrace: Optional[bool]=None, hideSqlErrors: Optional[bool]=None, statsLoggingFrequencySeconds: Optional[int]=None, monitorLoopFrequencySeconds: Optional[int]=None, blockedPgStmtTerminateFrequencyMinutes: Optional[int]=None, blockedPgStmtTerminateThresholdMinutes: Optional[int]=None) -> None: ...
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[DbEngineConfig]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[DbEngineConfig]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[DbEngineConfig]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[DbEngineConfig]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> DbEngineConfig:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> DbEngineConfig:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> DbEngineConfig:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[DbEngineConfig]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[DbEngineConfig]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> DbEngineConfig:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> DbEngineConfig:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> DbEngineConfig:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> DbEngineConfig:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> DbEngineConfig:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> DbEngineConfig:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> DbEngineConfig:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> DbEngineConfig:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> DbEngineConfig:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> DbEngineConfig:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> DbEngineConfig:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> DbEngineConfig:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> DbEngineConfig:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> DbEngineConfig:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> DbEngineConfig:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> DbEngineConfig:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> DbEngineConfig:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> DbEngineConfig:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> DbEngineConfig:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> DbEngineConfig:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> DbEngineConfig:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> DbEngineConfig:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> DbEngineConfig:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> DbEngineConfig:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> DbEngineConfig:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> DbEngineConfig:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> DbEngineConfig:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> DbEngineConfig:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[DbEngineConfig]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[DbEngineConfig]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[DbEngineConfig]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[DbEngineConfig]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[DbEngineConfig]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, DbEngineConfig]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, DbEngineConfig]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[DbEngineConfig]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[DbEngineConfig]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> DbEngineConfig:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> DbEngineConfig:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> DbEngineConfig:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> DbEngineConfig:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> DbEngineConfig:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> DbEngineConfig:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> DbEngineConfig:
    """
    ...
    """
        ...
    def afterMake(self) -> DbEngineConfig:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> DbEngineConfig:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[DbEngineConfig]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> DbEngineConfig:
    """
    ...
    """
        ...
    @classmethod
    def allCached(cls, doNotProduceAll: bool=None) -> Union[Stream[DbEngineConfig]]:
    """
    ...
    """
        ...
    @classmethod
    def find(cls, filter: str=None, doNotProduceAll: bool=None) -> Union[Stream[DbEngineConfig]]:
    """
    ...
    """
        ...
    @classmethod
    def findBy(cls, field: str, value: Any, doNotProduceAll: bool=None) -> Union[Stream[DbEngineConfig]]:
    """
    @param doNotProduceAll if true, will not populate cache and only return available cached instances. Will call
           `produceAll` if cache is empty or if Ann.cache.all is true & data has not previously been fetched.
    @return existing instances of this type that satisfy filter from data cache.
    """
        ...
    @classmethod
    def findByCacheKey(cls, key: str) -> Union[DbEngineConfig]:
    """
    ...
    """
        ...
    @classmethod
    def forCacheKey(cls, key: str) -> Union[DbEngineConfig]:
    """
    Returns cached instance by key, with secrets removed.
    """
        ...
    def getCached(self) -> Union[DbEngineConfig]:
    """
    ...
    """
        ...
    def refreshCache(self) -> Union[DbEngineConfig]:
    """
    ...
    """
        ...
    @classmethod
    def produce(cls, key: str) -> Union[DbEngineConfig]:
    """
    Should produce an entry for the cache key. This method should not be called directly.
    """
        ...
    @classmethod
    def produceAll(cls) -> Union[Map[str, DbEngineConfig]]:
    """
    ...
    """
        ...
    @classmethod
    def doProduceAll(cls) -> Union[Map[str, DbEngineConfig]]:
    """
    ...
    """
        ...
    def getConfig(self) -> DbEngineConfig:
    """
    ...
    """
        ...
    def getSecret(self) -> DbEngineConfig:
    """
    ...
    """
        ...
    @classmethod
    def forConfigKey(cls, configKey: str) -> Union[DbEngineConfig]:
    """
    ...
    """
        ...
    @classmethod
    def listConfigs(cls, parallel: bool=None, filter: Callable[[str], bool]=None) -> Union[Stream[DbEngineConfig]]:
    """
    @param
    ...
    """
        ...
    @overload
    def setConfigValues(self, from_: DbEngineConfig, override: str=None) -> None:
    """
    ...
    """
        ...
    @overload
    def setSecretValues(self, from_: DbEngineConfig, override: str=None) -> None:
    """
    ...
    """
        ...
    @classmethod
    def loadConfigAndSecret(cls, configKey: str) -> Union[DbEngineConfig]:
    """
    ...
    """
        ...
    def removeSecrets(self) -> Union[DbEngineConfig]:
    """
    @return this config without any secret values.
    """
        ...
    def removeNonSecrets(self) -> Union[DbEngineConfig]:
    """
    @return this config with only secret values.
    """
        ...
    def validate(self) -> DbEngineConfig:
    """
