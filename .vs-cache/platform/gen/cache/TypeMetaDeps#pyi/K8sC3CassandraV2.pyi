...
# Python definitions for the C3 type K8sC3CassandraV2


class K8sC3CassandraV2(K8sC3Cassandra):
    """
    @remarks this represents a made instance of K8sC3CassandraV2
    """
    ...
    @overload
    @classmethod
    def fromString(cls, s: str) -> Union[K8sC3CassandraV2]:
    """
    ...
    @overload
    @classmethod
    def fromString(cls, s: str, failIfInvalid: bool=None) -> Union[K8sC3CassandraV2]:
    """
    Constructs Cloud Resource instance with reference fields and credentials based on provided Cloud Reference string.
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[K8sC3CassandraV2]:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> K8sC3CassandraV2:
    """
    ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> K8sC3CassandraV2:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> K8sC3CassandraV2:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> K8sC3CassandraV2:
    """
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[K8sC3CassandraV2]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[K8sC3CassandraV2]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[K8sC3CassandraV2]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[K8sC3CassandraV2]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> K8sC3CassandraV2:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> K8sC3CassandraV2:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> K8sC3CassandraV2:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[K8sC3CassandraV2]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[K8sC3CassandraV2]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> K8sC3CassandraV2:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> K8sC3CassandraV2:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> K8sC3CassandraV2:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> K8sC3CassandraV2:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> K8sC3CassandraV2:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> K8sC3CassandraV2:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> K8sC3CassandraV2:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> K8sC3CassandraV2:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> K8sC3CassandraV2:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> K8sC3CassandraV2:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> K8sC3CassandraV2:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> K8sC3CassandraV2:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> K8sC3CassandraV2:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> K8sC3CassandraV2:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> K8sC3CassandraV2:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> K8sC3CassandraV2:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> K8sC3CassandraV2:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> K8sC3CassandraV2:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> K8sC3CassandraV2:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> K8sC3CassandraV2:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> K8sC3CassandraV2:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> K8sC3CassandraV2:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> K8sC3CassandraV2:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> K8sC3CassandraV2:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> K8sC3CassandraV2:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> K8sC3CassandraV2:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> K8sC3CassandraV2:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> K8sC3CassandraV2:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[K8sC3CassandraV2]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[K8sC3CassandraV2]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[K8sC3CassandraV2]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[K8sC3CassandraV2]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[K8sC3CassandraV2]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, K8sC3CassandraV2]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, K8sC3CassandraV2]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[K8sC3CassandraV2]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[K8sC3CassandraV2]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> K8sC3CassandraV2:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> K8sC3CassandraV2:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> K8sC3CassandraV2:
    """
    ...
    """
        ...
    def afterMake(self) -> K8sC3CassandraV2:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> K8sC3CassandraV2:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[K8sC3CassandraV2]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> K8sC3CassandraV2:
    """
    ...
    """
        ...
    @classmethod
    def forId(cls, id: str, failIfMissing: bool=None) -> Union[K8sC3CassandraV2]:
    """
    Find Cloud Resource in Cloud Provider based on provided C3 canonical identifier.
    """
        ...
    @classmethod
    def fromClusterId(cls, clusterId: str, env: str, app: str, func: str, role: str=None, seq: str=None, subseq: str=None) -> K8sC3CassandraV2:
    """
    Construct a cloud ID from a cluster ID
    """
        ...
    @classmethod
    def fromEnvId(cls, envId: str, app: str, func: str, role: str=None, seq: str=None, subseq: str=None) -> K8sC3CassandraV2:
    """
    ...
    """
        ...
    @classmethod
    def fromAppId(cls, appId: str, func: str, role: str=None, seq: str=None, subseq: str=None) -> K8sC3CassandraV2:
    """
    ...
    """
        ...
    @classmethod
    def fromId(cls, id: str, failIfInvalid: bool=None) -> K8sC3CassandraV2:
    """
    ...
    """
        ...
    @classmethod
    def fromCloudId(cls, id: CloudId, failIfInvalid: bool=None) -> K8sC3CassandraV2:
    """
    ...
    """
        ...
    def fromConfigTemplate(self, spec: CloudResourceOperationSpec=None) -> K8sC3CassandraV2:
    """
    ...
    """
        ...
    def withDefaultConfig(self, spec: CloudResourceOperationSpec=None) -> K8sC3CassandraV2:
    """
    ...
    """
        ...
    def upsertResource(self, spec: CloudResourceOperationSpec=None) -> K8sC3CassandraV2:
    """
    Create or update Cloud Resource.
    """
        ...
    def upsertWithDependencies(self, spec: CloudResourceOperationSpec=None) -> K8sC3CassandraV2:
    """
    ...
    """
        ...
    @classmethod
    def allCached(cls, doNotProduceAll: bool=None) -> Union[Stream[K8sC3CassandraV2]]:
    """
    ...
    """
        ...
    @classmethod
    def find(cls, filter: str=None, doNotProduceAll: bool=None) -> Union[Stream[K8sC3CassandraV2]]:
    """
    ...
    """
        ...
    @classmethod
    def findBy(cls, field: str, value: Any, doNotProduceAll: bool=None) -> Union[Stream[K8sC3CassandraV2]]:
    """
    @param doNotProduceAll if true, will not populate cache and only return available cached instances. Will call
           `produceAll` if cache is empty or if Ann.cache.all is true & data has not previously been fetched.
    @return existing instances of this type that satisfy filter from data cache.
    """
        ...
    @classmethod
    def findByCacheKey(cls, key: str) -> Union[K8sC3CassandraV2]:
    """
    ...
    """
        ...
    @classmethod
    def produce(cls, key: str) -> Union[K8sC3CassandraV2]:
    """
    Should produce an entry for the cache key. This method should not be called directly.
    """
        ...
    @classmethod
    def produceAll(cls) -> Union[Map[str, K8sC3CassandraV2]]:
    """
    ...
    """
        ...
    @classmethod
    def doProduceAll(cls) -> Union[Map[str, K8sC3CassandraV2]]:
    """
    ...
    """
        ...
    def getConfig(self) -> K8sC3CassandraV2:
    """
    This method on any CloudResource is not supported! Use CloudResource.for* or other methods instead.
    """
        ...
    ...
    """
        ...
    def getSecret(self) -> K8sC3CassandraV2:
    """
    ...
    """
        ...
    @classmethod
    def forConfigKey(cls, configKey: str) -> Union[K8sC3CassandraV2]:
    """
    ...
    """
        ...
    @classmethod
    def listConfigs(cls, parallel: bool=None, filter: Callable[[str], bool]=None) -> Union[Stream[K8sC3CassandraV2]]:
    """
    @param
    ...
    """
        ...
    @overload
    def setConfigValues(self, from_: K8sC3CassandraV2, override: str=None) -> None:
    """
    ...
    """
        ...
    @overload
    def setSecretValues(self, from_: K8sC3CassandraV2, override: str=None) -> None:
    """
    ...
    """
        ...
    @classmethod
    def loadConfigAndSecret(cls, configKey: str) -> Union[K8sC3CassandraV2]:
    """
    ...
    """
        ...
    def removeSecrets(self) -> Union[K8sC3CassandraV2]:
    """
    @return this config without any secret values.
    """
        ...
    def removeNonSecrets(self) -> Union[K8sC3CassandraV2]:
    """
    @return this config with only secret values.
    """
        ...
    def validate(self) -> K8sC3CassandraV2:
    """
    ...
    """
        ...
    def withIdentity(self, resource: CloudResource=None, spec: CloudResourceOperationSpec=None) -> K8sC3CassandraV2:
    """
    ...
    """
        ...
    def mergeId(self, other: CloudResource=None) -> K8sC3CassandraV2:
    """
    ...
    """
        ...
    @classmethod
    def forCloudId(cls, id: CloudId, failIfMissing: bool=None) -> Union[K8sC3CassandraV2]:
    """
    ...
    """
        ...
    @classmethod
    def forCloudFunc(cls, func: str, role: str=None, failIfMissing: bool=None) -> K8sC3CassandraV2:
    """
    Find Cloud Resource based on provided cloud func component and optional role.
    """
        ...
    @classmethod
    def forCloudRole(cls, role: str, failIfMissing: bool=None) -> K8sC3CassandraV2:
    """
    Find Cloud Resource of this type based on provided cloud role component.
    """
        ...
    @classmethod
    def forResourceId(cls, resourceId: str, failIfMissing: bool=None) -> Union[K8sC3CassandraV2]:
    """
    Find Cloud Resource in the Cloud Provider by provided resource name.
    """
        ...
    @classmethod
    def forResourceSecondaryId(cls, resourceId: str, failIfMissing: bool=None) -> Union[K8sC3CassandraV2]:
    """
    Find Cloud Resource in the Cloud Provider by provided resource name.
    """
        ...
    ...
    """
        ...
    @classmethod
    def forResourceName(cls, resourceName: str, failIfMissing: bool=None) -> Union[K8sC3CassandraV2]:
    """
    Find Cloud Resource in the Cloud Provider by provided resource name.
    """
        ...
    @classmethod
    def findResource(cls, reference: str, failIfMissing: bool=None) -> Union[K8sC3CassandraV2]:
    """
    Find Cloud Resource in the Cloud Provider by provided {@link CloudRef} string.
    """
        ...
    def getResource(self) -> Union[K8sC3CassandraV2]:
    """
    Find Cloud Resource in the Cloud Provider by provided #resourceId, #resourceSecondaryId, #resourceName or #tags
    (in that order).
    """
        ...
    def ensureResource(self) -> K8sC3CassandraV2:
    """
    Checks that the resource is persisted. If not, upserts the resource, to ensure that the resource exists.
    """
        ...
    @classmethod
    def listResourcesBySubtype(cls, spec: CloudListResourcesSpec=None) -> Map[str, CloudListResourcesResult[K8sC3CassandraV2]]:
    """
    ...
    """
        ...
    @classmethod
    def listResources(cls, spec: CloudListResourcesSpec=None) -> CloudListResourcesResult[K8sC3CassandraV2]:
    """
    ...
    """
        ...
    @classmethod
    def listResourcesForTags(cls, *keyValuePairs: Array[str]) -> CloudListResourcesResult[K8sC3CassandraV2]:
    """
    List all Cloud Resources that satisfies the given spec.
    ...
    """
        ...
    @classmethod
    def listResourcesForClusterId(cls, clusterId: str, cloudIdRole: str=None, spec: CloudListResourcesSpec=None) -> CloudListResourcesResult[K8sC3CassandraV2]:
    """
    List all Cloud Resources that satisfies the given spec.
    ...
    """
        ...
    @classmethod
    def listResourcesForEnvId(cls, envId: str, cloudIdRole: str=None, spec: CloudListResourcesSpec=None) -> CloudListResourcesResult[K8sC3CassandraV2]:
    """
    List all Cloud Resources that satisfies the given spec.
    ...
    """
        ...
    @classmethod
    def listResourcesForAppId(cls, appId: str, cloudIdRole: str=None, spec: CloudListResourcesSpec=None) -> CloudListResourcesResult[K8sC3CassandraV2]:
    """
    List all Cloud Resources that satisfies the given spec.
    ...
    """
        ...
    def upsertDependencies(self, spec: CloudResourceOperationSpec=None) -> K8sC3CassandraV2:
    """
    ...
    """
        ...
    def waitForCreate(self, spec: WaitSpec=None) -> Union[K8sC3CassandraV2]:
    """
    ...
    """
        ...
    @classmethod
    def tagResourcesBatch(cls, resources: Array[K8sC3CassandraV2], tags: Array[CloudTag]) -> Union[Map[str, Error]]:
    """
    ...
    """
        ...
    @classmethod
    def untagResourcesBatch(cls, resources: Array[K8sC3CassandraV2], tagKeys: Array[str]) -> Union[Map[str, Error]]:
    """
    ...
    """
        ...
    def waitForOk(self, spec: WaitSpec=None) -> Union[K8sC3CassandraV2]:
    """
    ...
    """
        ...
    def waitForState(self, state: str='AVAILABLE', spec: WaitSpec=None) -> Union[K8sC3CassandraV2]:
    """
    ...
    """
        ...
    def setFullyConfigured(self, fullyConfigured: bool=None, override: str=None) -> K8sC3CassandraV2:
    """
    ...
    """
        ...
    def afterCreate(self, input: K8sC3CassandraV2=None) -> K8sC3CassandraV2:
    """
    ...
    """
        ...
    def beforeCreate(self) -> K8sC3CassandraV2:
    """
    Optional callback to alter resource before creating it.
    """
        ...
    def beforeUpdate(self) -> K8sC3CassandraV2:
    """
    Optional callback to alter resource before updating it.
    """
        ...
    def beforeDestroy(self) -> K8sC3CassandraV2:
    """
    ...
    """
        ...
    def withoutNonModifiableFields(self) -> K8sC3CassandraV2:
    """
