...
from c3.platform.GlobalCanvasGraphEdge import GlobalCanvasGraphEdge
...
# Python definitions for the C3 type GlobalCanvasGraph


class GlobalCanvasGraph(InMemoryGraph[GlobalCanvasGraphNode[GlobalCanvasGraphNodeData], GlobalCanvasGraphEdge]):
    """
    Graph interface used to model relationships in global canvas.
    
    @remarks this represents a made instance of GlobalCanvasGraph
    """
    
    m_vertices: Optional[Array[GlobalCanvasGraphNode[GlobalCanvasGraphNodeData]]]=None
    """
    All vertices in this graph
    """

    m_edges: Optional[Array[GlobalCanvasGraphEdge]]=None
    """
    All edges in this graph
    """

    m_nonTraversableVertices: Optional[Array[GlobalCanvasGraphNode[GlobalCanvasGraphNodeData]]]=None
    """
    ...
    """
    def __init__(self, m_vertices: Optional[Array[GlobalCanvasGraphNode[GlobalCanvasGraphNodeData]]]=None, m_edges: Optional[Array[GlobalCanvasGraphEdge]]=None, m_nonTraversableVertices: Optional[Array[GlobalCanvasGraphNode[GlobalCanvasGraphNodeData]]]=None, m_cacheKey: Optional[str]=None) -> None: ...
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[GlobalCanvasGraph]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[GlobalCanvasGraph]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[GlobalCanvasGraph]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[GlobalCanvasGraph]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> GlobalCanvasGraph:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> GlobalCanvasGraph:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> GlobalCanvasGraph:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[GlobalCanvasGraph]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[GlobalCanvasGraph]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> GlobalCanvasGraph:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> GlobalCanvasGraph:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> GlobalCanvasGraph:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> GlobalCanvasGraph:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> GlobalCanvasGraph:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> GlobalCanvasGraph:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> GlobalCanvasGraph:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> GlobalCanvasGraph:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> GlobalCanvasGraph:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> GlobalCanvasGraph:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> GlobalCanvasGraph:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> GlobalCanvasGraph:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> GlobalCanvasGraph:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> GlobalCanvasGraph:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> GlobalCanvasGraph:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> GlobalCanvasGraph:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> GlobalCanvasGraph:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> GlobalCanvasGraph:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> GlobalCanvasGraph:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> GlobalCanvasGraph:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> GlobalCanvasGraph:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> GlobalCanvasGraph:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> GlobalCanvasGraph:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> GlobalCanvasGraph:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> GlobalCanvasGraph:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> GlobalCanvasGraph:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> GlobalCanvasGraph:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> GlobalCanvasGraph:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[GlobalCanvasGraph]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[GlobalCanvasGraph]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[GlobalCanvasGraph]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[GlobalCanvasGraph]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[GlobalCanvasGraph]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, GlobalCanvasGraph]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, GlobalCanvasGraph]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[GlobalCanvasGraph]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[GlobalCanvasGraph]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> GlobalCanvasGraph:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> GlobalCanvasGraph:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> GlobalCanvasGraph:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> GlobalCanvasGraph:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> GlobalCanvasGraph:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> GlobalCanvasGraph:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> GlobalCanvasGraph:
    """
    ...
    """
        ...
    def afterMake(self) -> GlobalCanvasGraph:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> GlobalCanvasGraph:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[GlobalCanvasGraph]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> GlobalCanvasGraph:
    """
    ...
    """
        ...
    def vertices(self, filter: str=None, bindings: ObjMapp=None) -> Union[Array[GlobalCanvasGraphNode[GlobalCanvasGraphNodeData]]]:
    """
    ...
    """
        ...
    def containsVertex(self, vertex: GlobalCanvasGraphNode[GlobalCanvasGraphNodeData]) -> bool:
    """
    ...
    """
        ...
    def edges(self, filter: str=None, bindings: ObjMapp=None) -> Union[Array[GlobalCanvasGraphEdge]]:
    """
    ...
    """
        ...
    def containsEdge(self, edge: GlobalCanvasGraphEdge) -> bool:
    """
    ...
    """
        ...
    def connectedVertices(self, vertex: GlobalCanvasGraphNode[GlobalCanvasGraphNodeData]=None, depth: int=None) -> Union[Array[GlobalCanvasGraphNode[GlobalCanvasGraphNodeData]]]:
    """
    ...
    """
        ...
    def connectedEdges(self, vertex: GlobalCanvasGraphNode[GlobalCanvasGraphNodeData]=None) -> Union[Array[GlobalCanvasGraphEdge]]:
    """
    ...
    """
        ...
    def connectedPaths(self, fromVertex: GlobalCanvasGraphNode[GlobalCanvasGraphNodeData]=None, toVertex: GlobalCanvasGraphNode[GlobalCanvasGraphNodeData]=None, noOfPaths: int=None, allowCycles: bool=None, maxDepth: int=None) -> Union[Array[Array[GlobalCanvasGraphNode[GlobalCanvasGraphNodeData]]]]:
    """
    ...
    """
        ...
    def allSubGraphs(self) -> Union[Array[Graph[GlobalCanvasGraphNode[GlobalCanvasGraphNodeData], GlobalCanvasGraphEdge]]]:
    """
    @return List of all the connected sub-graphs
    """
        ...
    def connectedSubGraph(self, vertex: GlobalCanvasGraphNode[GlobalCanvasGraphNodeData]=None) -> Union[Graph[GlobalCanvasGraphNode[GlobalCanvasGraphNodeData], GlobalCanvasGraphEdge]]:
    """
    ...
    """
        ...
    def filteredSubGraph(self, vertex: GlobalCanvasGraphNode[GlobalCanvasGraphNodeData]=None, vertexFilter: str=None, edgeFilter: str=None, bindings: ObjMapp=None, doCache: bool=None) -> Union[Graph[GlobalCanvasGraphNode[GlobalCanvasGraphNodeData], GlobalCanvasGraphEdge]]:
    """
    ...
    """
        ...
    def filteredDirectedSubGraph(self, vertex: GlobalCanvasGraphNode[GlobalCanvasGraphNodeData], spec: TraverseGraphSpec) -> Graph[GlobalCanvasGraphNode[GlobalCanvasGraphNodeData], GlobalCanvasGraphEdge]:
    """
    ...
    """
        ...
    def collectCounts(self, vertex: GlobalCanvasGraphNode[GlobalCanvasGraphNodeData], countsSpec: CollectCountsSpec=None) -> Map[str, int]:
    """
    ...
    """
        ...
    def collectCountsBatch(self, vertices: Array[GlobalCanvasGraphNode[GlobalCanvasGraphNodeData]]=None, countsSpec: CollectCountsSpec=None) -> Array[Map[str, int]]:
    """
    ...
    """
        ...
    def pathToSinkNodes(self, vertex: GlobalCanvasGraphNode[GlobalCanvasGraphNodeData], allowCycles: bool=None) -> Union[Array[Array[GlobalCanvasGraphNode[GlobalCanvasGraphNodeData]]]]:
    """
    ...
    """
        ...
    @classmethod
    def makeGraph(cls, vertices: Array[GlobalCanvasGraphNode[GlobalCanvasGraphNodeData]]=None, edges: Array[GlobalCanvasGraphEdge]=None, nonTraversableVertices: Array[GlobalCanvasGraphNode[GlobalCanvasGraphNodeData]]=None, doCache: bool=None) -> Union[Graph[GlobalCanvasGraphNode[GlobalCanvasGraphNodeData], GlobalCanvasGraphEdge]]:
    """
    ...
    """
        ...
    @classmethod
    def loadGraph(cls, batchSize: int=None, threads: int=None, vertexSpec: GraphDataSpec=None, edgeSpec: GraphDataSpec=None, doCache: bool=None) -> Union[Graph[GlobalCanvasGraphNode[GlobalCanvasGraphNodeData], GlobalCanvasGraphEdge]]:
    """
    ...
    """
        ...
    def addVertices(self, vertices: Stream[GlobalCanvasGraphNode[GlobalCanvasGraphNodeData]]) -> Graph[GlobalCanvasGraphNode[GlobalCanvasGraphNodeData], GlobalCanvasGraphEdge]:
    """
    ...
    """
        ...
    def addEdges(self, edges: Stream[GlobalCanvasGraphEdge]) -> Graph[GlobalCanvasGraphNode[GlobalCanvasGraphNodeData], GlobalCanvasGraphEdge]:
    """
    ...
    """
        ...
    @classmethod
    def saveGraph(cls, spec: LoadGraphSpec) -> Graph[GlobalCanvasGraphNode[GlobalCanvasGraphNodeData], GlobalCanvasGraphEdge]:
    """
    ...
    """
        ...
    @classmethod
    def generateRandomGraph(cls, vertexCount: int=None, edgeCount: int=None, vertexInclude: str=None, edgeInclude: str=None, doCache: bool=None) -> Union[Graph[GlobalCanvasGraphNode[GlobalCanvasGraphNodeData], GlobalCanvasGraphEdge]]:
    """
    ...
    """
        ...
    def topologicalSort(self) -> Union[Array[GlobalCanvasGraphNode[GlobalCanvasGraphNodeData]]]:
    """
    ...
    """
        ...
    def fetchVertices(self, filter: str=None, bindings: ObjMapp=None) -> Union[Array[GlobalCanvasGraphNode[GlobalCanvasGraphNodeData]]]:
    """
    `Graph.vertices` fails when the graph does not have vertices(PLAT-33612). This function is a wrapper
    to `Graph.vertices` that will invoke the latter when the graph has vertices
