...
# Python definitions for the C3 type PublicKeyCryptographyStandards


class PublicKeyCryptographyStandards():
    """
    ...
    """
    def __init__(self, PKCS1: Optional[str]=None, PKCS8: Optional[str]=None, PKCS12: Optional[str]=None) -> None: ...
