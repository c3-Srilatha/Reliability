...
from c3.platform.MapBuilder import MapBuilder
from c3.platform.ExMachina.Api import ExMachina.Api
from c3.platform.Promise import Promise
...
from c3.platform.ExMachinaInstance import ExMachinaInstance
...
# Python definitions for the C3 type ExMachinaSession


class ExMachinaSession():
    """
    ...
    @remarks this represents a made instance of ExMachinaSession
    """
    ...
    instance: Optional[ExMachinaInstance]
    """
    ...
    member: Optional[ExMachinaUser]=None
    """
    The member who started the session
    """

    aclPrivilegeCalc: Optional[Array[User]]=None
    """
    ...
    """
    def __init__(self, id: Optional[str]=None, versionEdits: Optional[Array[VersionEdit]]=None, name: Optional[str]=None, meta: Optional[Meta]=None, version: Optional[int]=None, typeWithBindings: Optional[Type]=None, started: Optional[datetime]=None, stopped: Optional[datetime]=None, instance: Optional[ExMachinaInstance]=None, member: Optional[ExMachinaUser]=None, aclPrivilegeCalc: Optional[Array[User]]=None) -> None: ...
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[ExMachinaSession]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[ExMachinaSession]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[ExMachinaSession]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[ExMachinaSession]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> ExMachinaSession:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> ExMachinaSession:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> ExMachinaSession:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[ExMachinaSession]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[ExMachinaSession]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> ExMachinaSession:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> ExMachinaSession:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> ExMachinaSession:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> ExMachinaSession:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> ExMachinaSession:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> ExMachinaSession:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> ExMachinaSession:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> ExMachinaSession:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> ExMachinaSession:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> ExMachinaSession:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> ExMachinaSession:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> ExMachinaSession:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> ExMachinaSession:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> ExMachinaSession:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> ExMachinaSession:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> ExMachinaSession:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> ExMachinaSession:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> ExMachinaSession:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> ExMachinaSession:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> ExMachinaSession:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> ExMachinaSession:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> ExMachinaSession:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> ExMachinaSession:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> ExMachinaSession:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> ExMachinaSession:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> ExMachinaSession:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> ExMachinaSession:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> ExMachinaSession:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[ExMachinaSession]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[ExMachinaSession]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[ExMachinaSession]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[ExMachinaSession]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[ExMachinaSession]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, ExMachinaSession]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, ExMachinaSession]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[ExMachinaSession]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[ExMachinaSession]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> ExMachinaSession:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> ExMachinaSession:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> ExMachinaSession:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> ExMachinaSession:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> ExMachinaSession:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> ExMachinaSession:
    """
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[ExMachinaSession]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> ExMachinaSession:
    """
    ...
    """
        ...
    def afterMake(self) -> ExMachinaSession:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> ExMachinaSession:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[ExMachinaSession]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> ExMachinaSession:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, spec: FetchSpec=None) -> FetchResult[ExMachinaSession]:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, filter: Filter) -> FetchResult[ExMachinaSession]:
    """
    ...
    """
        ...
    @classmethod
    def fetchObjStream(cls, spec: FetchStreamSpec=None) -> Union[Stream[ExMachinaSession]]:
    """
    Fetches multiple obj instances based on a specification.  Only objs that the caller is authorized to fetch will be
    returned.
    ...
    """
        ...
    @classmethod
    def fetchMultiLocale(cls, spec: MultiLocaleFetchSpec=None) -> Union[Map[str, FetchResult[ExMachinaSession]]]:
    """
    ...
    """
        ...
    def get(self, include: str=None) -> Union[ExMachinaSession]:
    """
    ...
    """
        ...
    def getSpecific(self, include: str=None) -> Union[ExMachinaSession]:
    """
    ...
    """
        ...
    def getMissing(self, spec: GetMissingSpec) -> ExMachinaSession:
    """
    ...
    """
        ...
    def getDirect(self, include: str=None) -> Union[ExMachinaSession]:
    """
    ...
    """
        ...
    def applyReverseEdit(self, versionEdit: VersionEdit) -> ExMachinaSession:
    """
    ...
    """
        ...
    @classmethod
    def fromString(cls, s: str) -> Union[ExMachinaSession]:
    """
    ...
    """
        ...
    def create(self, spec: UpsertSpec=None) -> Union[ExMachinaSession]:
    """
    ...
    """
        ...
    @classmethod
    def createBatch(cls, objs: Array[ExMachinaSession], spec: UpsertSpec=None) -> Union[ObjList[ExMachinaSession]]:
    """
    ...
    """
        ...
    @classmethod
    def createBatchObjStream(cls, objs: Stream[ExMachinaSession], spec: CreateBatchObjStreamSpec=None) -> Union[ObjList[ExMachinaSession]]:
    """
    Creates multiple instances of a C3 type. If the operation fails and {@link UpsertSpec#dontThrowOnBatchError} is not
    specified (the default), then a C3BatchException will be thrown.  Otherwise {@link errors will be reported in the
    returned {@link ObjList}.  This will fail if any of the instances already exist.
    ...
    """
        ...
    def update(self, srcObj: ExMachinaSession=None, spec: UpsertSpec=None) -> Union[ExMachinaSession]:
    """
    ...
    """
        ...
    def upsert(self, srcObj: ExMachinaSession=None, spec: UpsertSpec=None) -> Union[ExMachinaSession]:
    """
    ...
    """
        ...
    @overload
    def merge(self, spec: MergeSpec=None) -> Union[ExMachinaSession]:
    """
    ...
    """
        ...
    @overload
    def merge(self, mergeInclude: str, spec: MergeSpec=None) -> Union[ExMachinaSession]:
    """
    ...
    """
        ...
    def touch(self, spec: TouchSpec=None) -> Union[ExMachinaSession]:
    """
    ...
    """
        ...
    @classmethod
    def updateBatch(cls, objs: Array[ExMachinaSession], srcObjs: Array[ExMachinaSession]=None, spec: UpsertSpec=None) -> Union[ObjList[ExMachinaSession]]:
    """
    ...
    """
        ...
    @classmethod
    def updateObjs(cls, objs: Callable[[], Union[Array[ExMachinaSession]]], spec: UpsertSpec=None) -> Union[ObjList[ExMachinaSession]]:
    """
    ...
    """
        ...
    @classmethod
    def upsertBatch(cls, objs: Array[ExMachinaSession], srcObjs: Array[ExMachinaSession]=None, spec: UpsertSpec=None) -> Union[ObjList[ExMachinaSession]]:
    """
    ...
    """
        ...
    @classmethod
    def upsertObjs(cls, objs: Callable[[], Union[Array[ExMachinaSession]]], spec: UpsertSpec=None) -> Union[ObjList[ExMachinaSession]]:
    """
    Creates instances of a C3 type if they don't already exist and updates them if they do exist. If the operation
    ...
    """
        ...
    @classmethod
    def touchBatch(cls, objs: Array[ExMachinaSession], spec: TouchSpec=None) -> Union[ObjList[ExMachinaSession]]:
    """
    ...
    @overload
    @classmethod
    def mergeBatch(cls, objs: Array[ExMachinaSession], spec: MergeSpec=None) -> Union[ObjList[ExMachinaSession]]:
    """
    ...
    @overload
    @classmethod
    def mergeBatch(cls, objs: Array[ExMachinaSession], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[ExMachinaSession]]:
    """
    Merges multiple instances of a C3 type or creates them if they don't exist. If the operation fails and {@link
    UpsertSpec#dontThrowOnBatchError} is not specified (the default), then a C3BatchException will be thrown.
    Otherwise errors will be reported in the returned {@link ObjList}.  The merge operation is described in the {@link
    ...
    """
        ...
    @classmethod
    def mergeObjs(cls, objs: Callable[[], Union[Array[ExMachinaSession]]], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[ExMachinaSession]]:
    """
    ...
    @overload
    @classmethod
    def mergeAll(cls, mergeObj: ExMachinaSession, spec: MergeAllSpec=None) -> Union[int]:
    """
    ...
    @overload
    @classmethod
    def mergeAll(cls, mergeObj: ExMachinaSession, mergeInclude: str, spec: MergeAllSpec=None) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def removeBatch(cls, objs: Array[ExMachinaSession], spec: UpsertSpec=None) -> Union[ObjList[ExMachinaSession]]:
    """
    ...
    """
        ...
    @classmethod
    def replace(cls, objs: Array[ExMachinaSession], spec: UpsertSpec=None) -> Union[ObjList[ExMachinaSession]]:
    """
    ...
    """
        ...
    def unremove(self) -> Union[ExMachinaSession]:
    """
    ...
    """
        ...
    @classmethod
    def beforeCreate(cls, objs: Array[ExMachinaSession]) -> ObjList[ExMachinaSession]:
    """
    ...
    """
        ...
    @classmethod
    def beforeUpdate(cls, objs: Array[ExMachinaSession]) -> ObjList[ExMachinaSession]:
    """
    ...
    """
        ...
    @classmethod
    def beforeRemove(cls, objs: Array[ExMachinaSession]) -> ObjList[ExMachinaSession]:
    """
    ...
    """
        ...
    @classmethod
    def afterCreate(cls, objs: Array[ExMachinaSession]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def afterUpdate(cls, objs: Array[ExMachinaSession]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def afterRemove(cls, objs: Array[ExMachinaSession]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def startImportData(cls, spec: StartImportDataSpec=None) -> PushStream[ExMachinaSession]:
    """
    @return a push stream to import instances of this type.
    """
        ...
    @classmethod
    def startImportDataWithStats(cls, spec: StartImportDataSpec=None) -> PushStreamWithStats[ExMachinaSession]:
    """
    @return a push stream to import instances of this type.
    """
        ...
    ...
    """
        ...
    @classmethod
    def forId(cls, id: str, failIfMissing: bool=None) -> Union[ExMachinaSession]:
    """
    ...
    """
        ...
    def withoutIdentity(self) -> Union[ExMachinaSession]:
    """
    ...
    """
        ...
    @classmethod
    def typeOfBatch(cls, objs: Array[ExMachinaSession]) -> Union[Array[EntityType]]:
    """
    ...
    """
        ...
    @classmethod
    def dbEcho(cls, template: ExMachinaSession=None, count: int=None, sendBack: bool=None) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def callbackLogic(cls, objs: Array[ExMachinaSession], callback: Callable[[Union[ExMachinaSession]], Union[ExMachinaSession]]=None) -> ObjList[ExMachinaSession]:
    """
    ...
    """
        ...
    @classmethod
    def afterCallbackLogic(cls, objs: Array[ExMachinaSession], callback: Callable[[Union[ExMachinaSession]], Union[ExMachinaSession]]=None) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def start(cls, memorySize: ExMachinaMemorySize="{id: '16G'}", findUnassigned: bool='true', authorizedUserIds: Array[str]=None) -> ExMachinaSession:
    """
    ...
    """
        ...
    def stop(self) -> ExMachinaSession:
    """
    ...
    """
        ...
    def stopWithPrivilege(self) -> ExMachinaSession:
    """
    ...
    """
        ...
    def getInstance(self, include: str='\'this\'') -> ExMachinaInstance:
    """
    Utility to return {@link instance}
    """
        ...
    @classmethod
    def startWithUnassignedInstance(cls, memorySize: ExMachinaMemorySize, authorizedUserIds: Array[str]=None) -> Union[ExMachinaSession]:
    """
    ...
    """
        ...
    @classmethod
    def startWithNewInstance(cls, memorySize: ExMachinaMemorySize, authorizedUserIds: Array[str]=None) -> ExMachinaSession:
    """
    ...
    """
        ...
    @classmethod
    def tryClaimingInstance(cls, instance: ExMachinaInstance) -> Union[ExMachinaSession]:
    """
    ...
    """
        ...
    def waitForStatus(self, status: str, timeoutMinutes: int='4') -> bool:
    """
    ...
    """
        ...
    def abortPipelineRuns(self) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def shutdownSessionsForCompletedRuns(cls, shutdownIfRunIncompleteForNumMinutes: int='90') -> Union[Array[ExMachinaSession]]:
    """
    ...
    """
        ...
    @classmethod
    def forMe(cls, include: str=None) -> Union[ExMachinaSession]:
    """
    Return the {@link ExMachinaUser#session} for the current user's member
    """
        ...
    @classmethod
    def forMember(cls, member: ExMachinaUser, include: str=None) -> Union[ExMachinaSession]:
    """
    Return the {@link ExMachinaUser#session} for the provided member
    """
        ...
    @classmethod
    def startDefaultForMe(cls) -> ExMachinaSession:
    """
    User-facing API that invokes {@link startDefaultForMember} for the current user's member
    """
        ...
    @classmethod
    def startDefaultForMember(cls, member: ExMachinaUser) -> ExMachinaSession:
    """
    ...
    """
        ...
    @classmethod
    def startNewForMember(cls, member: ExMachinaUser, size: ExMachinaMemorySize) -> ExMachinaSession:
    """
    ...
    """
        ...
    @classmethod
    def stopDefaultForMe(cls) -> Union[ExMachinaSession]:
    """
    User-facing API that invokes {@link stopDefaultForMember} for the user's member
    """
        ...
    @classmethod
    def stopDefaultForMember(cls, member: ExMachinaUser) -> Union[ExMachinaSession]:
    """
    ...
    """
        ...
    @classmethod
    def resizeDefaultForMe(cls, size: ExMachinaMemorySize, updateActiveSession: bool=None) -> Union[ExMachinaSession]:
    """
    ...
    """
        ...
    @classmethod
    def resizeDefaultForMember(cls, member: ExMachinaUser, size: ExMachinaMemorySize, updateActiveSession: bool=None) -> Union[ExMachinaSession]:
    """
    ...
    """
        ...
    @classmethod
    def defaultStatusForMe(cls) -> str:
    """
    User-facing API that invokes {@link defaultStatusForMember} for the user's member
    """
        ...
    @classmethod
    def defaultStatusForMember(cls, member: ExMachinaUser) -> str:
    """
    ...
    """
        ...
    @classmethod
    def defaultInfoForMember(cls, member: ExMachinaUser) -> Union[ExMachinaSession.Info]:
    """
    ...
    """
        ...
    @classmethod
    def purgeProjectExecutionsForMe(cls, projectIds: Array[str]=None) -> bool:
    """
    ...
    class Info():
        """
        @remarks this represents a made instance of ExMachinaSession.Info
        """
        
        url: Optional[str]=None
        """
        The url to access the ExMachinaSession
        """
        ...
        """
        Amount of memory that is allocated. e.g. '1G'
        """

        usedMemory: Optional[str]=None
        """
        Amount of memory that has been used.
        """

        percentMemoryUsed: Optional[float]=None
        """
        The reported percentage of the {@link allocatedMemory} that is in use.
        """
        def __init__(self, url: Optional[str]=None, status: Optional[str]=None, allocatedMemory: Optional[str]=None, usedMemory: Optional[str]=None, percentMemoryUsed: Optional[float]=None) -> None: ...
        ...
        """
            ...
        @classmethod
        def fromJson(cls, json: any) -> Union[ExMachinaSession.Info]:
        """
        Load the JSON-based representation and reconstruct the corresponding object.
        ...
        """
            ...
        @classmethod
        def fromJsonString(cls, json: str) -> Union[ExMachinaSession.Info]:
        """
        Load the JSON-based representation and reconstruct the corresponding object.
        ...
        """
            ...
        @classmethod
        def fromXmlString(cls, xml: str) -> Union[ExMachinaSession.Info]:
        """
        Load the XML-based representation and reconstruct the corresponding object.
        ...
        """
            ...
        @classmethod
        def deserialize(cls, contentStr: str, contentType: str) -> Union[ExMachinaSession.Info]:
        """
        Load from contentType representation and reconstruct the corresponding object.
        ...
        """
            ...
        def replaceType(self, old: Type, new: Type) -> ExMachinaSession.Info:
        """
        Returns new instance with all references to old type, including result of #type, replaced with new type. If new
        type does not contain fields from old or field value types are not convertable then drops the field.
        ...
        """
            ...
        @overload
        def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> ExMachinaSession.Info:
        """
        Result of this function call is a copy of current instance with all non empty fields replaced based on results of
        the `mapper` invocation.
        ...
        """
            ...
        @overload
        def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> ExMachinaSession.Info:
        """
        Result of this function call is a copy of current instance with all fields replaced based on results of the
        `mapper` invocation.
        ...
        """
            ...
        @overload
        def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[ExMachinaSession.Info]:
        """
        Result of this function call is a copy of current instance with all non empty fields replaced based on results of
        the asynchronous `mapper` invocation.
        ...
        """
            ...
        @overload
        def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[ExMachinaSession.Info]:
        """
        Result of this function call is a copy of current instance with all fields replaced based on results of the
        asynchronous `mapper` invocation.
        ...
        """
            ...
        def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> ExMachinaSession.Info:
        """
        Result of this function call is a copy of current instance with specified field value replaced based on result of
        the `mapper` invocation.
        @param field
        ...
        """
            ...
        @overload
        def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> ExMachinaSession.Info:
        """
        Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
        lambda application.
        ...
        """
            ...
        @overload
        def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> ExMachinaSession.Info:
        """
        Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
        lambda application.
        ...
        """
            ...
        @overload
        def validateObj(self) -> ExMachinaSession.Info:
        """
        Populates all missing default values and throws error if any constraint is violated.
        """
            ...
        ...
        """
            ...
        @overload
        def withField(self, field: str, value: Any, doNotConvert: bool=None) -> ExMachinaSession.Info:
        """
        Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
        defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
        ...
        """
            ...
        @overload
        def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> ExMachinaSession.Info:
        """
        Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
        defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
        ...
        """
            ...
        def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> ExMachinaSession.Info:
        """
        Builds a new Obj instance by adding the provided fields in it. The name must correspond to an existing fields
        defined on this type or its mixins. The values must be of the correct type if doNotConvert flag is true.
        ...
        """
            ...
        def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> ExMachinaSession.Info:
        """
        Builds a new Obj with the value at the specified path field. If the field is null, the field #isFieldSet to null.
        If you would like to #unsetField, you should call #withoutFieldAtPath instead.
        ...
        """
            ...
        def withoutFieldAtPath(self, path: str) -> ExMachinaSession.Info:
        """
        Builds a new Obj without the specified path field.
        ...
        """
            ...
        @overload
        def withoutField(self, field: str) -> ExMachinaSession.Info:
        """
        Builds a new Obj, removing the field with the provided name.
        ...
        """
            ...
        @overload
        def withoutField(self, field: FieldType) -> ExMachinaSession.Info:
        """
        Builds a new Obj, removing the field with the provided field type.
        ...
        """
            ...
        def withoutFields(self, fields: Array[str]) -> ExMachinaSession.Info:
        """
        Builds a new Obj, removing the fields with the provided names.
        ...
        """
            ...
        def withoutFieldsByType(self, fields: Array[FieldType]) -> ExMachinaSession.Info:
        """
        Builds a new Obj, removing the fields with the provided field types. Be sure to use the FieldType instance for the
        exact same type as the type of the obj to respect the "ordinal" of the field type
        ...
        """
            ...
        def withoutSecretFields(self) -> ExMachinaSession.Info:
        """
        @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
        """
            ...
        ...
        """
            ...
        def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> ExMachinaSession.Info:
        """
        Builds a new Obj instance by adding the default values (if defined) for all unset fields. This is implemented by
        calling {@link FieldType#defaultValue defaultValue} for a field if it is not already set and
        {@link FieldType#hasDefault has a default}. It will also set {@see ValueType#initialValue initial values} for
        ...
        """
            ...
        @overload
        def defaultField(self, field: str) -> ExMachinaSession.Info:
        """
        Builds a new Obj, by setting a field on this `Obj` to the field's default value. If the field has no default, this
        method will behave the same as {@link #unsetField}.
        ...
        """
            ...
        @overload
        def defaultField(self, field: FieldType) -> ExMachinaSession.Info:
        """
        Builds a new Obj, by setting a field on this `Obj` to the fields default value. If the field has no default, this
        method will behave the same as {@link #unsetField}.
        ...
        """
            ...
        @overload
        def unsetField(self, field: str) -> ExMachinaSession.Info:
        """
        Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
        is different from {@link removeField}
        ...
        """
            ...
        @overload
        def unsetField(self, field: FieldType) -> ExMachinaSession.Info:
        """
        Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
        is different from {@link removeField}
        ...
        """
            ...
        @overload
        def removeField(self, field: str) -> ExMachinaSession.Info:
        """
        Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
        is different from {@link #unsetField}
        ...
        """
            ...
        @overload
        def removeField(self, field: FieldType) -> ExMachinaSession.Info:
        """
        Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
        is different from {@link #unsetField}
        ...
        """
            ...
        @overload
        def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> ExMachinaSession.Info:
        """
        Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
        In case of conflicts, fields of other instance take precedence unless otherwise specified by the fieldPathMergeSpec
        ...
        """
            ...
        @overload
        def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> ExMachinaSession.Info:
        """
        Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
        In case of conflicts, fields of other instance take precedence.
        ...
        """
            ...
        @overload
        def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> ExMachinaSession.Info:
        """
        Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
        fields that exist on other Obj and do not exist on this Obj will not be added to final Obj.
        @param deep
        ...
        """
            ...
        @overload
        def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> ExMachinaSession.Info:
        """
        Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
        fields that exist other Obj and do not exist on this Obj will not be added to final Obj or evaluated. Does not
        traverse child reference and collection fields.
        ...
        """
            ...
        def mergeJson(self, json: any) -> ExMachinaSession.Info:
            ...
        def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> ExMachinaSession.Info:
        """
        Merge the obj references within the current obj
        @param deep
               If set, traverses the reference fields within the obj as well for a deep merge
        ...
        """
            ...
        def sumObj(self, other: Obj, deep: bool=None) -> ExMachinaSession.Info:
        """
        Adds the numeric Obj fields with the other Objs respective fields.
        If deep is set it will traverse reference and collection fields and sum corresponding numeric fields in
        references with same name and collection elements at same index or key.
        """
            ...
        def singletonArray(self) -> Array[ExMachinaSession.Info]:
        """
        Build an array of the correct type with a single element which is this instance.
        ...
        """
            ...
        @classmethod
        def array(cls, *elements: Array[Any]) -> Union[Array[ExMachinaSession.Info]]:
        """
        Creates an array of instances of this type.
        """
            ...
        @classmethod
        def arrayBuilder(cls) -> Union[ArrayBuilder[ExMachinaSession.Info]]:
        """
        Creates an array of instances of this type.
        """
            ...
        def singletonSet(self) -> Set[ExMachinaSession.Info]:
        """
        Build an set of the correct type with a single element which is this instance.
        ...
        """
            ...
        @classmethod
        def setBuilder(cls) -> Union[SetBuilder[ExMachinaSession.Info]]:
        """
        Creates a set of instances of this type.
        """
            ...
        @classmethod
        def mapBuilder(cls) -> Union[MapBuilder[str, ExMachinaSession.Info]]:
        """
        Create a map of string to elements of this type.
        """
            ...
        @classmethod
        def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, ExMachinaSession.Info]]:
        """
        Create a map with the given key type and elements of this type.
        """
            ...
        ...
        def myStreamType(cls) -> StreamType:
            ...
        def toBuilder(self) -> ObjBuilder[ExMachinaSession.Info]:
        """
        @return new ObjBuilder with initial state set to fields of this instance.
        """
            ...
        @classmethod
        def builder(cls) -> ObjBuilder[ExMachinaSession.Info]:
        """
        @return new ObjBuilder of this instance.
        """
            ...
        @overload
        @classmethod
        def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> ExMachinaSession.Info:
        """
        Construct instance of this type from provided field values and options
        """
            ...
        @overload
        @classmethod
        def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> ExMachinaSession.Info:
        """
        Construct an instance of this type from provided fields
        @param fields
                   Fields to construct the instance of the obj with
        ...
        @overload
        @classmethod
        def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> ExMachinaSession.Info:
        """
        Construct instance of this type from provided field values and options
        """
            ...
        @overload
        @classmethod
        def make(cls, withDefaults: bool=None) -> ExMachinaSession.Info:
        """
        Construct an instance of this type with no non-default field values unless explicitly specified by passing param true
        @param withDefaults
                   If set, then the Obj is made with default & initial values (required primitive fields e.g. !int32 -> 0)
        ...
        @overload
        @classmethod
        def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> ExMachinaSession.Info:
        """
        Construct an instance from provided fields
        @param fields
                   Fields (in the format <field_name, value>) to construct an instance of the obj. Note that "type" as a
        ...
        @overload
        @classmethod
        def make(cls, fields: Any, withDefaults: bool=None) -> ExMachinaSession.Info:
        """
        Construct an instance of this type from provided fields. Note it is more efficient to use #fromFields and other overloads
        ...
        """
            ...
        @classmethod
        def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> ExMachinaSession.Info:
        """
        Construct an instance of this type from provided instance of a subtype or a "duck type".
        """
            ...
        ...
        """
            ...
        def afterMake(self) -> ExMachinaSession.Info:
        """
        Optional override that will be called after every instance creation.
        ...
        """
            ...
        @classmethod
        def cachedEmptyInst(cls) -> ExMachinaSession.Info:
        """
        Creates an empty inst using `MyType.make()` and caches it. Avoid recreating multiple copies of the spec for
        every action dispatch. The cached inst can also be used for comparing whether the object is an empty or not
        Will only create empty instance for immutable Obj e.g. if an Obj is Mutable, this method will throw an error
        ...
        """
            ...
        @classmethod
        def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[ExMachinaSession.Info]]:
        """
        Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
        value is read.
        """
            ...
        @classmethod
        def generateObj(cls, spec: Obj.GenerateSpec=None) -> ExMachinaSession.Info:
        """
        Generate a single instance of this type. The base implementation uses {@link DataGenObj} to generate uniform
        random (gibberish) values for all fields, but it may be overridden by specific types with custom logic that
        populates fields in a more realistic way.
