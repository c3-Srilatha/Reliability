...
from c3.platform.Feature.Store.MaterializationJob import Feature.Store.MaterializationJob
...
# Python definitions for the C3 type Feature.Store.MaterializationJob

SubjectType = TypeVar('SubjectType')

class MaterializationJob(Generic[SubjectType], MapReduce[SubjectType, void, void, void], FeatureEvaluatable.Bin.JobBase, Feature.Store.MaterializationOptions):
    """
    ...
    @remarks this represents a made instance of Feature.Store.MaterializationJob
    """
    ...
    TRIAL_MODE_SNAPSHOT: Optional[str]=None
    ...
    targetFilter: Optional[SubjectType]=None
    """
    ...
    """
    def __init__(self, priority: Optional[int]=None, disabled: Optional[bool]=None, maxConcurrency: Optional[int]=None, maxConcurrencyPerNode: Optional[int]=None, runAsUser: Optional[bool]=None, nodePool: Optional[str]=None, skipIfRunning: Optional[bool]=None, numAutoRecoveryAttempts: Optional[int]=None, propagateActionContext: Optional[bool]=None, targetType: Optional[Type]=None, useFileSystemForInterVals: Optional[bool]=None, useBatchIdsForReadInput: Optional[bool]=None, include: Optional[str]=None, filter: Optional[str]=None, order: Optional[str]=None, limit: Optional[int]=None, samplePct: Optional[int]=None, batchSize: Optional[int]=None, subBatchSize: Optional[int]=None, numBatches: Optional[int]=None, abortOnError: Optional[bool]=None, TRIAL_MODE_SNAPSHOT: Optional[str]=None, subjectType: Optional[Type[[FeatureEvaluatable]]]=None, features: Optional[Array[str]]=None, trialMode: Optional[bool]=None, run: Optional[MapReduceRun]=None, runs: Optional[Array[MapReduceRun]]=None, options: Optional[Obj]=None, onCompleteCallback: Optional[JobBase.Callback]=None, typeIdent: Optional[str]=None, id: Optional[str]=None, versionEdits: Optional[Array[VersionEdit]]=None, name: Optional[str]=None, meta: Optional[Meta]=None, version: Optional[int]=None, typeWithBindings: Optional[Type]=None, targetFilter: Optional[SubjectType]=None, timeRange: Optional[TimeRange]=None) -> None: ...
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[Feature.Store.MaterializationJob[SubjectType]]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[Feature.Store.MaterializationJob[SubjectType]]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[Feature.Store.MaterializationJob[SubjectType]]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[Feature.Store.MaterializationJob[SubjectType]]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> Feature.Store.MaterializationJob[SubjectType]:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> Feature.Store.MaterializationJob[SubjectType]:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> Feature.Store.MaterializationJob[SubjectType]:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[Feature.Store.MaterializationJob[SubjectType]]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[Feature.Store.MaterializationJob[SubjectType]]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> Feature.Store.MaterializationJob[SubjectType]:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> Feature.Store.MaterializationJob[SubjectType]:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> Feature.Store.MaterializationJob[SubjectType]:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> Feature.Store.MaterializationJob[SubjectType]:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> Feature.Store.MaterializationJob[SubjectType]:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> Feature.Store.MaterializationJob[SubjectType]:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> Feature.Store.MaterializationJob[SubjectType]:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> Feature.Store.MaterializationJob[SubjectType]:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> Feature.Store.MaterializationJob[SubjectType]:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> Feature.Store.MaterializationJob[SubjectType]:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> Feature.Store.MaterializationJob[SubjectType]:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> Feature.Store.MaterializationJob[SubjectType]:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> Feature.Store.MaterializationJob[SubjectType]:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> Feature.Store.MaterializationJob[SubjectType]:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> Feature.Store.MaterializationJob[SubjectType]:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> Feature.Store.MaterializationJob[SubjectType]:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> Feature.Store.MaterializationJob[SubjectType]:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> Feature.Store.MaterializationJob[SubjectType]:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> Feature.Store.MaterializationJob[SubjectType]:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> Feature.Store.MaterializationJob[SubjectType]:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> Feature.Store.MaterializationJob[SubjectType]:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> Feature.Store.MaterializationJob[SubjectType]:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> Feature.Store.MaterializationJob[SubjectType]:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> Feature.Store.MaterializationJob[SubjectType]:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> Feature.Store.MaterializationJob[SubjectType]:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> Feature.Store.MaterializationJob[SubjectType]:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> Feature.Store.MaterializationJob[SubjectType]:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> Feature.Store.MaterializationJob[SubjectType]:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[Feature.Store.MaterializationJob[SubjectType]]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[Feature.Store.MaterializationJob[SubjectType]]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[Feature.Store.MaterializationJob[SubjectType]]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[Feature.Store.MaterializationJob[SubjectType]]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[Feature.Store.MaterializationJob[SubjectType]]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, Feature.Store.MaterializationJob[SubjectType]]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, Feature.Store.MaterializationJob[SubjectType]]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[Feature.Store.MaterializationJob[SubjectType]]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[Feature.Store.MaterializationJob[SubjectType]]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> Feature.Store.MaterializationJob[SubjectType]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> Feature.Store.MaterializationJob[SubjectType]:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> Feature.Store.MaterializationJob[SubjectType]:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> Feature.Store.MaterializationJob[SubjectType]:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> Feature.Store.MaterializationJob[SubjectType]:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> Feature.Store.MaterializationJob[SubjectType]:
    """
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[Feature.Store.MaterializationJob[SubjectType]]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> Feature.Store.MaterializationJob[SubjectType]:
    """
    ...
    """
        ...
    def afterMake(self) -> Feature.Store.MaterializationJob[SubjectType]:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> Feature.Store.MaterializationJob[SubjectType]:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[Feature.Store.MaterializationJob[SubjectType]]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> Feature.Store.MaterializationJob[SubjectType]:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, spec: FetchSpec=None) -> FetchResult[Feature.Store.MaterializationJob[SubjectType]]:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, filter: Filter) -> FetchResult[Feature.Store.MaterializationJob[SubjectType]]:
    """
    ...
    """
        ...
    @classmethod
    def fetchObjStream(cls, spec: FetchStreamSpec=None) -> Union[Stream[Feature.Store.MaterializationJob[SubjectType]]]:
    """
    Fetches multiple obj instances based on a specification.  Only objs that the caller is authorized to fetch will be
    returned.
    ...
    """
        ...
    @classmethod
    def fetchMultiLocale(cls, spec: MultiLocaleFetchSpec=None) -> Union[Map[str, FetchResult[Feature.Store.MaterializationJob[SubjectType]]]]:
    """
    ...
    """
        ...
    def get(self, include: str=None) -> Union[Feature.Store.MaterializationJob[SubjectType]]:
    """
    ...
    """
        ...
    def getSpecific(self, include: str=None) -> Union[Feature.Store.MaterializationJob[SubjectType]]:
    """
    ...
    """
        ...
    def getMissing(self, spec: GetMissingSpec) -> Feature.Store.MaterializationJob[SubjectType]:
    """
    ...
    """
        ...
    def getDirect(self, include: str=None) -> Union[Feature.Store.MaterializationJob[SubjectType]]:
    """
    ...
    """
        ...
    def applyReverseEdit(self, versionEdit: VersionEdit) -> Feature.Store.MaterializationJob[SubjectType]:
    """
    ...
    """
        ...
    @classmethod
    def fromString(cls, s: str) -> Union[Feature.Store.MaterializationJob[SubjectType]]:
    """
    ...
    """
        ...
    def create(self, spec: UpsertSpec=None) -> Union[Feature.Store.MaterializationJob[SubjectType]]:
    """
    ...
    """
        ...
    @classmethod
    def createBatch(cls, objs: Array[Feature.Store.MaterializationJob[SubjectType]], spec: UpsertSpec=None) -> Union[ObjList[Feature.Store.MaterializationJob[SubjectType]]]:
    """
    ...
    """
        ...
    @classmethod
    def createBatchObjStream(cls, objs: Stream[Feature.Store.MaterializationJob[SubjectType]], spec: CreateBatchObjStreamSpec=None) -> Union[ObjList[Feature.Store.MaterializationJob[SubjectType]]]:
    """
    Creates multiple instances of a C3 type. If the operation fails and {@link UpsertSpec#dontThrowOnBatchError} is not
    specified (the default), then a C3BatchException will be thrown.  Otherwise {@link errors will be reported in the
    returned {@link ObjList}.  This will fail if any of the instances already exist.
    ...
    """
        ...
    def update(self, srcObj: Feature.Store.MaterializationJob[SubjectType]=None, spec: UpsertSpec=None) -> Union[Feature.Store.MaterializationJob[SubjectType]]:
    """
    ...
    """
        ...
    def upsert(self, srcObj: Feature.Store.MaterializationJob[SubjectType]=None, spec: UpsertSpec=None) -> Union[Feature.Store.MaterializationJob[SubjectType]]:
    """
    ...
    """
        ...
    @overload
    def merge(self, spec: MergeSpec=None) -> Union[Feature.Store.MaterializationJob[SubjectType]]:
    """
    ...
    """
        ...
    @overload
    def merge(self, mergeInclude: str, spec: MergeSpec=None) -> Union[Feature.Store.MaterializationJob[SubjectType]]:
    """
    ...
    """
        ...
    def touch(self, spec: TouchSpec=None) -> Union[Feature.Store.MaterializationJob[SubjectType]]:
    """
    ...
    """
        ...
    @classmethod
    def updateBatch(cls, objs: Array[Feature.Store.MaterializationJob[SubjectType]], srcObjs: Array[Feature.Store.MaterializationJob[SubjectType]]=None, spec: UpsertSpec=None) -> Union[ObjList[Feature.Store.MaterializationJob[SubjectType]]]:
    """
    ...
    """
        ...
    @classmethod
    def updateObjs(cls, objs: Callable[[], Union[Array[Feature.Store.MaterializationJob[SubjectType]]]], spec: UpsertSpec=None) -> Union[ObjList[Feature.Store.MaterializationJob[SubjectType]]]:
    """
    ...
    """
        ...
    @classmethod
    def upsertBatch(cls, objs: Array[Feature.Store.MaterializationJob[SubjectType]], srcObjs: Array[Feature.Store.MaterializationJob[SubjectType]]=None, spec: UpsertSpec=None) -> Union[ObjList[Feature.Store.MaterializationJob[SubjectType]]]:
    """
    ...
    """
        ...
    @classmethod
    def upsertObjs(cls, objs: Callable[[], Union[Array[Feature.Store.MaterializationJob[SubjectType]]]], spec: UpsertSpec=None) -> Union[ObjList[Feature.Store.MaterializationJob[SubjectType]]]:
    """
    Creates instances of a C3 type if they don't already exist and updates them if they do exist. If the operation
    ...
    """
        ...
    @classmethod
    def touchBatch(cls, objs: Array[Feature.Store.MaterializationJob[SubjectType]], spec: TouchSpec=None) -> Union[ObjList[Feature.Store.MaterializationJob[SubjectType]]]:
    """
    ...
    @overload
    @classmethod
    def mergeBatch(cls, objs: Array[Feature.Store.MaterializationJob[SubjectType]], spec: MergeSpec=None) -> Union[ObjList[Feature.Store.MaterializationJob[SubjectType]]]:
    """
    ...
    @overload
    @classmethod
    def mergeBatch(cls, objs: Array[Feature.Store.MaterializationJob[SubjectType]], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[Feature.Store.MaterializationJob[SubjectType]]]:
    """
    Merges multiple instances of a C3 type or creates them if they don't exist. If the operation fails and {@link
    UpsertSpec#dontThrowOnBatchError} is not specified (the default), then a C3BatchException will be thrown.
    Otherwise errors will be reported in the returned {@link ObjList}.  The merge operation is described in the {@link
    ...
    """
        ...
    @classmethod
    def mergeObjs(cls, objs: Callable[[], Union[Array[Feature.Store.MaterializationJob[SubjectType]]]], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[Feature.Store.MaterializationJob[SubjectType]]]:
    """
    ...
    @overload
    @classmethod
    def mergeAll(cls, mergeObj: Feature.Store.MaterializationJob[SubjectType], spec: MergeAllSpec=None) -> Union[int]:
    """
    ...
    @overload
    @classmethod
    def mergeAll(cls, mergeObj: Feature.Store.MaterializationJob[SubjectType], mergeInclude: str, spec: MergeAllSpec=None) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def removeBatch(cls, objs: Array[Feature.Store.MaterializationJob[SubjectType]], spec: UpsertSpec=None) -> Union[ObjList[Feature.Store.MaterializationJob[SubjectType]]]:
    """
    ...
    """
        ...
    @classmethod
    def replace(cls, objs: Array[Feature.Store.MaterializationJob[SubjectType]], spec: UpsertSpec=None) -> Union[ObjList[Feature.Store.MaterializationJob[SubjectType]]]:
    """
    ...
    """
        ...
    def unremove(self) -> Union[Feature.Store.MaterializationJob[SubjectType]]:
    """
    ...
    """
        ...
    @classmethod
    def beforeCreate(cls, objs: Array[Feature.Store.MaterializationJob[SubjectType]]) -> ObjList[Feature.Store.MaterializationJob[SubjectType]]:
    """
    ...
    """
        ...
    @classmethod
    def beforeUpdate(cls, objs: Array[Feature.Store.MaterializationJob[SubjectType]]) -> ObjList[Feature.Store.MaterializationJob[SubjectType]]:
    """
    ...
    """
        ...
    @classmethod
    def beforeRemove(cls, objs: Array[Feature.Store.MaterializationJob[SubjectType]]) -> ObjList[Feature.Store.MaterializationJob[SubjectType]]:
    """
    ...
    """
        ...
    @classmethod
    def afterCreate(cls, objs: Array[Feature.Store.MaterializationJob[SubjectType]]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def afterUpdate(cls, objs: Array[Feature.Store.MaterializationJob[SubjectType]]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def afterRemove(cls, objs: Array[Feature.Store.MaterializationJob[SubjectType]]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def startImportData(cls, spec: StartImportDataSpec=None) -> PushStream[Feature.Store.MaterializationJob[SubjectType]]:
    """
    @return a push stream to import instances of this type.
    """
        ...
    @classmethod
    def startImportDataWithStats(cls, spec: StartImportDataSpec=None) -> PushStreamWithStats[Feature.Store.MaterializationJob[SubjectType]]:
    """
    @return a push stream to import instances of this type.
    """
        ...
    ...
    """
        ...
    @classmethod
    def forId(cls, id: str, failIfMissing: bool=None) -> Union[Feature.Store.MaterializationJob[SubjectType]]:
    """
    ...
    """
        ...
    def withoutIdentity(self) -> Union[Feature.Store.MaterializationJob[SubjectType]]:
    """
    ...
    """
        ...
    @classmethod
    def typeOfBatch(cls, objs: Array[Feature.Store.MaterializationJob[SubjectType]]) -> Union[Array[EntityType]]:
    """
    ...
    """
        ...
    @classmethod
    def dbEcho(cls, template: Feature.Store.MaterializationJob[SubjectType]=None, count: int=None, sendBack: bool=None) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def callbackLogic(cls, objs: Array[Feature.Store.MaterializationJob[SubjectType]], callback: Callable[[Union[Feature.Store.MaterializationJob[SubjectType]]], Union[Feature.Store.MaterializationJob[SubjectType]]]=None) -> ObjList[Feature.Store.MaterializationJob[SubjectType]]:
    """
    ...
    """
        ...
    @classmethod
    def afterCallbackLogic(cls, objs: Array[Feature.Store.MaterializationJob[SubjectType]], callback: Callable[[Union[Feature.Store.MaterializationJob[SubjectType]]], Union[Feature.Store.MaterializationJob[SubjectType]]]=None) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def map(cls, batch: int=None, objs: Array[SubjectType]=None, job: MapReduce[SubjectType, void, void, void]=None, subBatch: int=None) -> Union[Map[, ]]:
    """
    ...
    """
        ...
    @classmethod
    def reduce(cls, outKey: =None, interValues: Array[]=None, job: MapReduce[SubjectType, void, void, void]=None) -> Union[Union[,Array[]]]:
    """
    ...
    """
        ...
    @classmethod
    def mapCompleted(cls, job: MapReduce[SubjectType, void, void, void]=None) -> None:
    """
    ...
    """
        ...
    @classmethod
    def completed(cls, job: MapReduce[SubjectType, void, void, void]=None) -> Union[str]:
    """
    Overridden to marking the {@link FeatureBase#latestStrategy} as "operationally ready" once the data has been materialized.
    """
        ...
    @classmethod
    def failed(cls, job: MapReduce[SubjectType, void, void, void], status: MapReduceStatus, options: MapReduceOptions=None) -> None:
    """
