...
# Python definitions for the C3 type UserJdbcCredentials


class UserJdbcCredentials(BasicCredentials, ConfigNamed):
    """
    User level credential overrides that may be applied to an external relational datastore.
    
    @remarks this represents a made instance of UserJdbcCredentials
    """
    ...
    """
    def __init__(self, username: Optional[str]=None, password: Optional[str]=None, secretKey: Optional[str]=None, properties: Optional[Map[str, Any]]=None, secretProperties: Optional[Map[str, Any]]=None, configOverride: Optional[str]=None, secretOverride: Optional[str]=None, issues: Optional[Array[str]]=None, name: Optional[str]=None) -> None: ...
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[UserJdbcCredentials]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[UserJdbcCredentials]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[UserJdbcCredentials]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[UserJdbcCredentials]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> UserJdbcCredentials:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> UserJdbcCredentials:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> UserJdbcCredentials:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[UserJdbcCredentials]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[UserJdbcCredentials]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> UserJdbcCredentials:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> UserJdbcCredentials:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> UserJdbcCredentials:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> UserJdbcCredentials:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> UserJdbcCredentials:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> UserJdbcCredentials:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> UserJdbcCredentials:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> UserJdbcCredentials:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> UserJdbcCredentials:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> UserJdbcCredentials:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> UserJdbcCredentials:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> UserJdbcCredentials:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> UserJdbcCredentials:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> UserJdbcCredentials:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> UserJdbcCredentials:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> UserJdbcCredentials:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> UserJdbcCredentials:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> UserJdbcCredentials:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> UserJdbcCredentials:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> UserJdbcCredentials:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> UserJdbcCredentials:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> UserJdbcCredentials:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> UserJdbcCredentials:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> UserJdbcCredentials:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> UserJdbcCredentials:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> UserJdbcCredentials:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> UserJdbcCredentials:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> UserJdbcCredentials:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[UserJdbcCredentials]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[UserJdbcCredentials]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[UserJdbcCredentials]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[UserJdbcCredentials]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[UserJdbcCredentials]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, UserJdbcCredentials]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, UserJdbcCredentials]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[UserJdbcCredentials]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[UserJdbcCredentials]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> UserJdbcCredentials:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> UserJdbcCredentials:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> UserJdbcCredentials:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> UserJdbcCredentials:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> UserJdbcCredentials:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> UserJdbcCredentials:
    """
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[UserJdbcCredentials]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> UserJdbcCredentials:
    """
    ...
    """
        ...
    def afterMake(self) -> UserJdbcCredentials:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> UserJdbcCredentials:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[UserJdbcCredentials]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> UserJdbcCredentials:
    """
    ...
    """
        ...
    @classmethod
    def allCached(cls, doNotProduceAll: bool=None) -> Union[Stream[UserJdbcCredentials]]:
    """
    ...
    """
        ...
    @classmethod
    def find(cls, filter: str=None, doNotProduceAll: bool=None) -> Union[Stream[UserJdbcCredentials]]:
    """
    ...
    """
        ...
    @classmethod
    def findBy(cls, field: str, value: Any, doNotProduceAll: bool=None) -> Union[Stream[UserJdbcCredentials]]:
    """
    @param doNotProduceAll if true, will not populate cache and only return available cached instances. Will call
           `produceAll` if cache is empty or if Ann.cache.all is true & data has not previously been fetched.
    @return existing instances of this type that satisfy filter from data cache.
    """
        ...
    @classmethod
    def findByCacheKey(cls, key: str) -> Union[UserJdbcCredentials]:
    """
    ...
    """
        ...
    @classmethod
    def forCacheKey(cls, key: str) -> Union[UserJdbcCredentials]:
    """
    Returns cached instance by key, with secrets removed.
    """
        ...
    def getCached(self) -> Union[UserJdbcCredentials]:
    """
    ...
    """
        ...
    def refreshCache(self) -> Union[UserJdbcCredentials]:
    """
    ...
    """
        ...
    @classmethod
    def produce(cls, key: str) -> Union[UserJdbcCredentials]:
    """
    Should produce an entry for the cache key. This method should not be called directly.
    """
        ...
    @classmethod
    def produceAll(cls) -> Union[Map[str, UserJdbcCredentials]]:
    """
    ...
    """
        ...
    @classmethod
    def doProduceAll(cls) -> Union[Map[str, UserJdbcCredentials]]:
    """
    ...
    """
        ...
    def getConfig(self) -> UserJdbcCredentials:
    """
    ...
    """
        ...
    def getSecret(self) -> UserJdbcCredentials:
    """
    ...
    """
        ...
    @classmethod
    def forConfigKey(cls, configKey: str) -> Union[UserJdbcCredentials]:
    """
    ...
    """
        ...
    @classmethod
    def listConfigs(cls, parallel: bool=None, filter: Callable[[str], bool]=None) -> Union[Stream[UserJdbcCredentials]]:
    """
    @param
    ...
    """
        ...
    @overload
    def setConfigValues(self, from_: UserJdbcCredentials, override: str=None) -> None:
    """
    ...
    """
        ...
    @overload
    def setSecretValues(self, from_: UserJdbcCredentials, override: str=None) -> None:
    """
    ...
    """
        ...
    @classmethod
    def loadConfigAndSecret(cls, configKey: str) -> Union[UserJdbcCredentials]:
    """
    ...
    """
        ...
    def removeSecrets(self) -> Union[UserJdbcCredentials]:
    """
    @return this config without any secret values.
    """
        ...
    def removeNonSecrets(self) -> Union[UserJdbcCredentials]:
    """
    @return this config with only secret values.
    """
        ...
    def validate(self) -> UserJdbcCredentials:
    """
    ...
    """
        ...
    @classmethod
    def fromString(cls, s: str) -> Union[UserJdbcCredentials]:
    """
    ...
    """
        ...
    @classmethod
    def forName(cls, name: str, failIfMissing: bool=None) -> Union[UserJdbcCredentials]:
    """
