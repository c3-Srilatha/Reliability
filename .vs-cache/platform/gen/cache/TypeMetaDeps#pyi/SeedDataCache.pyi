...
# Python definitions for the C3 type SeedDataCache

T = TypeVar('T')

class SeedDataCache(Generic[T], MetadataCacheOld[T], Value):
    """
    ...
    """
        ...
    @classmethod
    def put(cls, key: str, value: T) -> None:
    """
    ...
    """
        ...
    @classmethod
    def produce(cls, key: str) -> Union[T]:
    """
    ...
    """
        ...
    @classmethod
    def produceAll(cls) -> Union[Map[str, T]]:
    """
    ...
    """
        ...
    @classmethod
    def release(cls, key: str, value: T) -> None:
    """
