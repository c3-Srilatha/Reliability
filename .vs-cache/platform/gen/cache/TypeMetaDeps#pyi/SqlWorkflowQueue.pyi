...
# Python definitions for the C3 type SqlWorkflowQueue


class SqlWorkflowQueue(WorkflowQueue, Value):
    """
    Invalidation queue for workflow processing.
    
    @remarks this represents a made instance of SqlWorkflowQueue
    """
