...
from c3.platform.SourceQueueEntry import SourceQueueEntry

# Python definitions for the C3 type SourceQueue


class SourceQueue(SourceQueueBase[SourceQueueEntry], Value):
    """
    ...
    @classmethod
    def compute(cls, targetType: Type, entries: Array[SourceQueueEntry]) -> None:
    """
    ...
    """
        ...
    @classmethod
    def find(cls, spec: InvalidationQueue.FindSpec=None) -> Union[Array[SourceQueueEntry]]:
    """
    ...
    """
        ...
    @classmethod
    def findStream(cls, spec: InvalidationQueue.FindStreamSpec=None) -> Union[Stream[SourceQueueEntry]]:
    """
    ...
    """
        ...
    @classmethod
    def clearEntries(cls, entries: Array[SourceQueueEntry]) -> None:
    """
