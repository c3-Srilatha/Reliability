...
from c3.platform.SearchableChangeLogInfo import SearchableChangeLogInfo
...
# Python definitions for the C3 type SearchableChangeLogListener


class SearchableChangeLogListener(ChangeLogListener[SearchableChangeLogInfo], Value):
    """
    ...
    """
        ...
    @classmethod
    def logInfo(cls, typeRef: Type, sourceOperInfo: DbSourceOperInfo, changes: Array[DbEditList]=None) -> Union[Map[str, SearchableChangeLogInfo]]:
    """
    ...
    """
        ...
    @classmethod
    def process(cls, typeRef: Type, logs: Map[str, Array[SearchableChangeLogInfo]]) -> None:
    """
