...
# Python definitions for the C3 type AsyncThinTypeSystem


class AsyncThinTypeSystem(ThinTypeSystemBase, Value):
    """
    ...
    def type(self, name: str, failIfMissing: bool=None) -> Promise[AsyncTypeProxy]:
    """
