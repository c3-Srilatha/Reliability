...
from c3.platform.AzureNetworkSecurityGroupFields import AzureNetworkSecurityGroupFields
from c3.platform.Include import Include
from c3.platform.FieldPath import FieldPath
from c3.platform.StreamType import StreamType
from c3.platform.AzureNetworkSecurityGroup import AzureNetworkSecurityGroup
from c3.platform.CloudResourceDestroySpec import CloudResourceDestroySpec
from c3.platform.AzureServiceEndpointPropertiesFormat import AzureServiceEndpointPropertiesFormat
...
from c3.platform.AzureNetworkDelegation import AzureNetworkDelegation
...
from c3.platform.SetBuilder import SetBuilder
from c3.platform.AzureRouteTableFields import AzureRouteTableFields
from c3.platform.MapBuilder import MapBuilder
from c3.platform.TypeMeta import TypeMeta
from c3.platform.AzureNetworkPrivateEndpointInner import AzureNetworkPrivateEndpointInner
...
from c3.platform.AzureVirtualNetwork import AzureVirtualNetwork
from c3.platform.CloudResourceKeyFields import CloudResourceKeyFields
from c3.platform.SetBuilder import SetBuilder
from c3.platform.CloudResource import CloudResource
from c3.platform.AzureNetworkIPConfiguration import AzureNetworkIPConfiguration
from c3.platform.AzureSubnetFields import AzureSubnetFields
from c3.platform.AzureRouteTableMember import AzureRouteTableMember
from c3.platform.Error import Error
from c3.platform.AzureNetworkIPConfigurationProfile import AzureNetworkIPConfigurationProfile
...
from c3.platform.AzureNetworkResourceNavigationLinkInner import AzureNetworkResourceNavigationLinkInner
from c3.platform.ValidateObjResult import ValidateObjResult
from c3.platform.CloudRef import CloudRef
from c3.platform.Promise import Promise
from c3.platform.Obj import Obj
from c3.platform.AzureNetworkServiceAssociationLinkInner import AzureNetworkServiceAssociationLinkInner
from c3.platform.Expr.CompileOptions import Expr.CompileOptions
from c3.platform.CloudListResourcesSpec import CloudListResourcesSpec
from c3.platform.FieldValue import FieldValue
from c3.platform.Obj.MakeSpec import Obj.MakeSpec
from c3.platform.AzureNetworkServiceEndpointPolicyInner import AzureNetworkServiceEndpointPolicyInner
...
from c3.platform.AzureRouteTable import AzureRouteTable
from c3.platform.AzureCredentials import AzureCredentials

# Python definitions for the C3 type AzureSubnet


class AzureSubnet(AzureGenericChildResource[AzureVirtualNetwork], AzureSubnetFields, AzureNetworkSecurityGroupMember, AzureRouteTableMember):
    """
    @remarks this represents a made instance of AzureSubnet
    """
    ...
    parent: Optional[AzureVirtualNetwork]
    """
    The parent resource that this child belongs to. Use #safeParent to retrieve this value.
    """

    ipConfigurationProfiles: Optional[Array[AzureNetworkIPConfigurationProfile]]=None

    purpose: Optional[str]=None

    resourceNavigationLinks: Optional[Array[AzureNetworkResourceNavigationLinkInner]]=None

    routeTable_: Optional[AzureRouteTableFields]=None

    addressPrefix: Optional[str]=None

    addressPrefixes: Optional[Array[str]]=None

    delegations: Optional[Array[AzureNetworkDelegation]]=None

    ipConfigurations: Optional[Array[AzureNetworkIPConfiguration]]=None

    natGateway_: Optional[AzureSubResource]=None

    privateLinkServiceNetworkPolicies: Optional[str]=None

    id_: Optional[str]=None

    networkSecurityGroup_: Optional[AzureNetworkSecurityGroupFields]=None

    serviceEndpoints: Optional[Array[AzureServiceEndpointPropertiesFormat]]=None

    serviceEndpointPolicies: Optional[Array[AzureNetworkServiceEndpointPolicyInner]]=None

    privateEndpoints: Optional[Array[AzureNetworkPrivateEndpointInner]]=None

    provisioningState: Optional[str]=None

    serviceAssociationLinks: Optional[Array[AzureNetworkServiceAssociationLinkInner]]=None

    name_: Optional[str]=None

    etag: Optional[str]=None

    privateEndpointNetworkPolicies: Optional[str]=None

    networkSecurityGroup: Optional[AzureNetworkSecurityGroup]
    """
    Security group associated with the given resource
    """

    routeTable: Optional[AzureRouteTable]=None
    """
    Route table associated with the given resource
    """
    def __init__(self, id: Optional[str]=None, cluster: Optional[str]=None, env: Optional[str]=None, app: Optional[str]=None, func: Optional[str]=None, role: Optional[str]=None, seq: Optional[str]=None, subseq: Optional[str]=None, resourceId: Optional[str]=None, resourceSecondaryId: Optional[str]=None, resourceName: Optional[str]=None, resourceGroupName: Optional[str]=None, fullyConfigured: Optional[bool]=None, resourceNamespace: Optional[str]=None, external: Optional[bool]=None, credentials: Optional[AzureCredentials]=None, hasGeneratedResourceName: Optional[bool]=None, hasGeneratedResourceSecondaryId: Optional[bool]=None, configOverride: Optional[str]=None, secretOverride: Optional[str]=None, issues: Optional[Array[str]]=None, nativeMetricByName: Optional[Map[str, str]]=None, tags: Optional[Array[CloudTag]]=None, description: Optional[str]=None, parentResource: Optional[CloudResource]=None, resourceGroup: Optional[AzureResourceGroup]=None, state: Optional[str]=None, RESOURCE_NAME_DELIMITER: Optional[str]=None, parent: Optional[AzureVirtualNetwork]=None, ipConfigurationProfiles: Optional[Array[AzureNetworkIPConfigurationProfile]]=None, purpose: Optional[str]=None, resourceNavigationLinks: Optional[Array[AzureNetworkResourceNavigationLinkInner]]=None, routeTable_: Optional[AzureRouteTableFields]=None, addressPrefix: Optional[str]=None, addressPrefixes: Optional[Array[str]]=None, delegations: Optional[Array[AzureNetworkDelegation]]=None, ipConfigurations: Optional[Array[AzureNetworkIPConfiguration]]=None, natGateway_: Optional[AzureSubResource]=None, privateLinkServiceNetworkPolicies: Optional[str]=None, id_: Optional[str]=None, networkSecurityGroup_: Optional[AzureNetworkSecurityGroupFields]=None, serviceEndpoints: Optional[Array[AzureServiceEndpointPropertiesFormat]]=None, serviceEndpointPolicies: Optional[Array[AzureNetworkServiceEndpointPolicyInner]]=None, privateEndpoints: Optional[Array[AzureNetworkPrivateEndpointInner]]=None, provisioningState: Optional[str]=None, serviceAssociationLinks: Optional[Array[AzureNetworkServiceAssociationLinkInner]]=None, name_: Optional[str]=None, etag: Optional[str]=None, privateEndpointNetworkPolicies: Optional[str]=None, networkSecurityGroup: Optional[AzureNetworkSecurityGroup]=None, routeTable: Optional[AzureRouteTable]=None) -> None: ...
    ...
    @overload
    @classmethod
    def fromString(cls, s: str) -> Union[AzureSubnet]:
    """
    ...
    @overload
    @classmethod
    def fromString(cls, s: str, failIfInvalid: bool=None) -> Union[AzureSubnet]:
    """
    Constructs Cloud Resource instance with reference fields and credentials based on provided Cloud Reference string.
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[AzureSubnet]:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> AzureSubnet:
    """
    ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> AzureSubnet:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> AzureSubnet:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> AzureSubnet:
    """
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[AzureSubnet]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[AzureSubnet]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[AzureSubnet]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[AzureSubnet]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> AzureSubnet:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> AzureSubnet:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> AzureSubnet:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[AzureSubnet]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[AzureSubnet]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> AzureSubnet:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> AzureSubnet:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> AzureSubnet:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> AzureSubnet:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> AzureSubnet:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> AzureSubnet:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> AzureSubnet:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> AzureSubnet:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> AzureSubnet:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> AzureSubnet:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> AzureSubnet:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> AzureSubnet:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> AzureSubnet:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> AzureSubnet:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> AzureSubnet:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> AzureSubnet:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> AzureSubnet:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> AzureSubnet:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> AzureSubnet:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> AzureSubnet:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> AzureSubnet:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> AzureSubnet:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> AzureSubnet:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> AzureSubnet:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> AzureSubnet:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> AzureSubnet:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> AzureSubnet:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> AzureSubnet:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[AzureSubnet]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[AzureSubnet]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[AzureSubnet]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[AzureSubnet]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[AzureSubnet]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, AzureSubnet]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, AzureSubnet]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[AzureSubnet]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[AzureSubnet]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> AzureSubnet:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> AzureSubnet:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> AzureSubnet:
    """
    ...
    """
        ...
    def afterMake(self) -> AzureSubnet:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> AzureSubnet:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[AzureSubnet]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> AzureSubnet:
    """
    ...
    """
        ...
    @classmethod
    def forId(cls, id: str, failIfMissing: bool=None) -> Union[AzureSubnet]:
    """
    Find Cloud Resource in Cloud Provider based on provided C3 canonical identifier.
    """
        ...
    @classmethod
    def fromClusterId(cls, clusterId: str, env: str, app: str, func: str, role: str=None, seq: str=None, subseq: str=None) -> AzureSubnet:
    """
    Construct a cloud ID from a cluster ID
    """
        ...
    @classmethod
    def fromEnvId(cls, envId: str, app: str, func: str, role: str=None, seq: str=None, subseq: str=None) -> AzureSubnet:
    """
    ...
    """
        ...
    @classmethod
    def fromAppId(cls, appId: str, func: str, role: str=None, seq: str=None, subseq: str=None) -> AzureSubnet:
    """
    ...
    """
        ...
    @classmethod
    def fromId(cls, id: str, failIfInvalid: bool=None) -> AzureSubnet:
    """
    ...
    """
        ...
    @classmethod
    def fromCloudId(cls, id: CloudId, failIfInvalid: bool=None) -> AzureSubnet:
    """
    ...
    """
        ...
    def fromConfigTemplate(self, spec: CloudResourceOperationSpec=None) -> AzureSubnet:
    """
    ...
    """
        ...
    def withDefaultConfig(self, spec: CloudResourceOperationSpec=None) -> AzureSubnet:
    """
    ...
    """
        ...
    def upsertResource(self, spec: CloudResourceOperationSpec=None) -> AzureSubnet:
    """
    Create or update Cloud Resource.
    """
        ...
    def upsertWithDependencies(self, spec: CloudResourceOperationSpec=None) -> AzureSubnet:
    """
    ...
    """
        ...
    @classmethod
    def allCached(cls, doNotProduceAll: bool=None) -> Union[Stream[AzureSubnet]]:
    """
    ...
    """
        ...
    @classmethod
    def find(cls, filter: str=None, doNotProduceAll: bool=None) -> Union[Stream[AzureSubnet]]:
    """
    ...
    """
        ...
    @classmethod
    def findBy(cls, field: str, value: Any, doNotProduceAll: bool=None) -> Union[Stream[AzureSubnet]]:
    """
    @param doNotProduceAll if true, will not populate cache and only return available cached instances. Will call
           `produceAll` if cache is empty or if Ann.cache.all is true & data has not previously been fetched.
    @return existing instances of this type that satisfy filter from data cache.
    """
        ...
    @classmethod
    def findByCacheKey(cls, key: str) -> Union[AzureSubnet]:
    """
    ...
    """
        ...
    @classmethod
    def produce(cls, key: str) -> Union[AzureSubnet]:
    """
    Should produce an entry for the cache key. This method should not be called directly.
    """
        ...
    @classmethod
    def produceAll(cls) -> Union[Map[str, AzureSubnet]]:
    """
    ...
    """
        ...
    @classmethod
    def doProduceAll(cls) -> Union[Map[str, AzureSubnet]]:
    """
    ...
    """
        ...
    def getConfig(self) -> AzureSubnet:
    """
    This method on any CloudResource is not supported! Use CloudResource.for* or other methods instead.
    """
        ...
    ...
    """
        ...
    def getSecret(self) -> AzureSubnet:
    """
    ...
    """
        ...
    @classmethod
    def forConfigKey(cls, configKey: str) -> Union[AzureSubnet]:
    """
    ...
    """
        ...
    @classmethod
    def listConfigs(cls, parallel: bool=None, filter: Callable[[str], bool]=None) -> Union[Stream[AzureSubnet]]:
    """
    @param
    ...
    """
        ...
    @overload
    def setConfigValues(self, from_: AzureSubnet, override: str=None) -> None:
    """
    ...
    """
        ...
    @overload
    def setSecretValues(self, from_: AzureSubnet, override: str=None) -> None:
    """
    ...
    """
        ...
    @classmethod
    def loadConfigAndSecret(cls, configKey: str) -> Union[AzureSubnet]:
    """
    ...
    """
        ...
    def removeSecrets(self) -> Union[AzureSubnet]:
    """
    @return this config without any secret values.
    """
        ...
    def removeNonSecrets(self) -> Union[AzureSubnet]:
    """
    @return this config with only secret values.
    """
        ...
    def validate(self) -> AzureSubnet:
    """
    ...
    """
        ...
    def withIdentity(self, resource: CloudResource=None, spec: CloudResourceOperationSpec=None) -> AzureSubnet:
    """
    ...
    """
        ...
    def mergeId(self, other: CloudResource=None) -> AzureSubnet:
    """
    ...
    """
        ...
    @classmethod
    def forCloudId(cls, id: CloudId, failIfMissing: bool=None) -> Union[AzureSubnet]:
    """
    ...
    """
        ...
    @classmethod
    def forCloudFunc(cls, func: str, role: str=None, failIfMissing: bool=None) -> AzureSubnet:
    """
    Find Cloud Resource based on provided cloud func component and optional role.
    """
        ...
    @classmethod
    def forCloudRole(cls, role: str, failIfMissing: bool=None) -> AzureSubnet:
    """
    Find Cloud Resource of this type based on provided cloud role component.
    """
        ...
    @classmethod
    def forResourceId(cls, resourceId: str, failIfMissing: bool=None) -> Union[AzureSubnet]:
    """
    Find Cloud Resource in the Cloud Provider by provided resource name.
    """
        ...
    @classmethod
    def forResourceSecondaryId(cls, resourceId: str, failIfMissing: bool=None) -> Union[AzureSubnet]:
    """
    Find Cloud Resource in the Cloud Provider by provided resource name.
    """
        ...
    ...
    """
        ...
    @classmethod
    def forResourceName(cls, resourceName: str, failIfMissing: bool=None) -> Union[AzureSubnet]:
    """
    Find Cloud Resource in the Cloud Provider by provided resource name.
    """
        ...
    @classmethod
    def findResource(cls, reference: str, failIfMissing: bool=None) -> Union[AzureSubnet]:
    """
    Find Cloud Resource in the Cloud Provider by provided {@link CloudRef} string.
    """
        ...
    def getResource(self) -> Union[AzureSubnet]:
    """
    Find Cloud Resource in the Cloud Provider by provided #resourceId, #resourceSecondaryId, #resourceName or #tags
    (in that order).
    """
        ...
    def ensureResource(self) -> AzureSubnet:
    """
    Checks that the resource is persisted. If not, upserts the resource, to ensure that the resource exists.
    """
        ...
    @classmethod
    def listResourcesBySubtype(cls, spec: CloudListResourcesSpec=None) -> Map[str, CloudListResourcesResult[AzureSubnet]]:
    """
    ...
    """
        ...
    @classmethod
    def listResources(cls, spec: CloudListResourcesSpec=None) -> CloudListResourcesResult[AzureSubnet]:
    """
    ...
    """
        ...
    @classmethod
    def listResourcesForTags(cls, *keyValuePairs: Array[str]) -> CloudListResourcesResult[AzureSubnet]:
    """
    List all Cloud Resources that satisfies the given spec.
    ...
    """
        ...
    @classmethod
    def listResourcesForClusterId(cls, clusterId: str, cloudIdRole: str=None, spec: CloudListResourcesSpec=None) -> CloudListResourcesResult[AzureSubnet]:
    """
    List all Cloud Resources that satisfies the given spec.
    ...
    """
        ...
    @classmethod
    def listResourcesForEnvId(cls, envId: str, cloudIdRole: str=None, spec: CloudListResourcesSpec=None) -> CloudListResourcesResult[AzureSubnet]:
    """
    List all Cloud Resources that satisfies the given spec.
    ...
    """
        ...
    @classmethod
    def listResourcesForAppId(cls, appId: str, cloudIdRole: str=None, spec: CloudListResourcesSpec=None) -> CloudListResourcesResult[AzureSubnet]:
    """
    List all Cloud Resources that satisfies the given spec.
    ...
    """
        ...
    def upsertDependencies(self, spec: CloudResourceOperationSpec=None) -> AzureSubnet:
    """
    ...
    """
        ...
    def waitForCreate(self, spec: WaitSpec=None) -> Union[AzureSubnet]:
    """
    ...
    """
        ...
    @classmethod
    def tagResourcesBatch(cls, resources: Array[AzureSubnet], tags: Array[CloudTag]) -> Union[Map[str, Error]]:
    """
    ...
    """
        ...
    @classmethod
    def untagResourcesBatch(cls, resources: Array[AzureSubnet], tagKeys: Array[str]) -> Union[Map[str, Error]]:
    """
    ...
    """
        ...
    def waitForOk(self, spec: WaitSpec=None) -> Union[AzureSubnet]:
    """
    ...
    """
        ...
    def waitForState(self, state: str='AVAILABLE', spec: WaitSpec=None) -> Union[AzureSubnet]:
    """
    ...
    """
        ...
    def setFullyConfigured(self, fullyConfigured: bool=None, override: str=None) -> AzureSubnet:
    """
    ...
    """
        ...
    def afterCreate(self, input: AzureSubnet=None) -> AzureSubnet:
    """
    ...
    """
        ...
    def withoutNonModifiableFields(self) -> AzureSubnet:
    """
    ...
    """
        ...
    @classmethod
    def fromImpl(cls, impl: Any=None) -> Union[AzureSubnet]:
    """
    ...
    """
        ...
    def safeParent(self) -> Union[AzureVirtualNetwork]:
    """
    ...
    """
        ...
    @classmethod
    def fromJava(cls, javaObj: Any) -> Union[AzureSubnetFields]:
        ...
    def toJava(self) -> Union[Any]:
        ...
    def safeNetworkSecurityGroup(self) -> AzureNetworkSecurityGroup:
    """
    Security group associated with the given resource
    """
        ...
    def safeRouteTable(self) -> Union[AzureRouteTableMember]:
    """
    Route table associated with the given resource
    """
        ...
