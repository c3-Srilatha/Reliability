...
from c3.platform.AzureResourceGroup import AzureResourceGroup
...
from c3.platform.AzureServiceBusTopicSubscriptionFields import AzureServiceBusTopicSubscriptionFields
from c3.platform.CloudReceiveMessagesSpec import CloudReceiveMessagesSpec
...
from c3.platform.AzureServiceBusTopic import AzureServiceBusTopic
from c3.platform.AzureServiceBusMessageCountDetails import AzureServiceBusMessageCountDetails
from c3.platform.CloudMessageBrokerSendSpec import CloudMessageBrokerSendSpec
from c3.platform.SetBuilder import SetBuilder
from c3.platform.Error import Error
from c3.platform.CloudMessageProcessor import CloudMessageProcessor
...
from c3.platform.AzureCredentials import AzureCredentials

# Python definitions for the C3 type AzureServiceBusTopicSubscription


class AzureServiceBusTopicSubscription(AzureGenericChildResource[AzureServiceBusTopic], AzureServiceBusConsumer, AzureServiceBusTopicSubscriptionFields):
    """
    @remarks this represents a made instance of AzureServiceBusTopicSubscription
    """
    ...
    """
    Represents the uniquely identifiable child resource in the format: <childName>/<parentName>
    """
    ...
    resourceGroup: Optional[AzureResourceGroup]
    """
    Resource group associated with the given resource
    """

    state: Optional[str]=None
    """
    The state of this Azure resource.
    """

    RESOURCE_NAME_DELIMITER: Optional[str]=None

    parent: Optional[AzureServiceBusTopic]
    """
    The parent resource that this child belongs to. Use #safeParent to retrieve this value.
    """

    consumptionMode: Optional[str]=None
    """
    In ReceiveAndDelete mode, receive is a single-shot operation. The Service Bus receives a read request for a message
    in a queue, it marks the message as being consumed and returns it to the application. ReceiveAndDelete mode
    works best for scenarios in which an application can tolerate not processing a message in the event of a failure.
    To understand this, consider a scenario in which the consumer issues the receive request and then crashes before
    processing it. Because Service Bus has marked the message as being consumed, then when the application restarts
    and begins consuming messages again, it has missed the message that was consumed prior to the crash.
    ...
    locks it to prevent other consumers receiving it, and then returns it to the application. After the application
    finishes processing the message (or stores it reliably for future processing), it completes the second stage of
    the receive process by calling Delete on the received message. When Service Bus sees the Delete call, it marks the
    message as being consumed and remove it from the queue.
    """

    asyncMaxConcurrentComputes: Optional[int]=None
    """
    Maximum number of concurrent calls to the callback the service bus should initiate.
    """

    autoCompleteMessages: Optional[bool]=None
    """
    Indicates whether service bus should automatically complete the messages after returning from async callback.
    true indicates the complete will be handled by the async callback.
    """

    autorenewDuration: Optional[int]=None
    """
    Frequency with which to renew the service bus lock in minutes.
    """

    messageCount: Optional[int]=None

    deadLetteringOnFilterEvaluationExceptions: Optional[bool]=None

    maxDeliveryCount: Optional[int]=None
    ...
    countDetails: Optional[AzureServiceBusMessageCountDetails]=None

    updatedAt: Optional[datetime]=None

    defaultMessageTimeToLive: Optional[str]=None

    accessedAt: Optional[datetime]=None

    lockDuration: Optional[str]=None

    requiresSession: Optional[bool]=None

    deadLetteringOnMessageExpiration: Optional[bool]=None

    tags_: Optional[Map[str, str]]=None

    autoDeleteOnIdle: Optional[str]=None

    enableBatchedOperations: Optional[bool]=None
    ...
    def __init__(self, id: Optional[str]=None, cluster: Optional[str]=None, env: Optional[str]=None, app: Optional[str]=None, func: Optional[str]=None, role: Optional[str]=None, seq: Optional[str]=None, subseq: Optional[str]=None, resourceId: Optional[str]=None, resourceSecondaryId: Optional[str]=None, resourceName: Optional[str]=None, resourceGroupName: Optional[str]=None, fullyConfigured: Optional[bool]=None, resourceNamespace: Optional[str]=None, external: Optional[bool]=None, credentials: Optional[AzureCredentials]=None, hasGeneratedResourceName: Optional[bool]=None, hasGeneratedResourceSecondaryId: Optional[bool]=None, configOverride: Optional[str]=None, secretOverride: Optional[str]=None, issues: Optional[Array[str]]=None, nativeMetricByName: Optional[Map[str, str]]=None, tags: Optional[Array[CloudTag]]=None, description: Optional[str]=None, parentResource: Optional[CloudResource]=None, resourceGroup: Optional[AzureResourceGroup]=None, state: Optional[str]=None, RESOURCE_NAME_DELIMITER: Optional[str]=None, parent: Optional[AzureServiceBusTopic]=None, consumptionMode: Optional[str]=None, asyncMaxConcurrentComputes: Optional[int]=None, autoCompleteMessages: Optional[bool]=None, autorenewDuration: Optional[int]=None, messageCount: Optional[int]=None, deadLetteringOnFilterEvaluationExceptions: Optional[bool]=None, maxDeliveryCount: Optional[int]=None, type_: Optional[str]=None, createdAt: Optional[datetime]=None, id_: Optional[str]=None, countDetails: Optional[AzureServiceBusMessageCountDetails]=None, updatedAt: Optional[datetime]=None, defaultMessageTimeToLive: Optional[str]=None, accessedAt: Optional[datetime]=None, lockDuration: Optional[str]=None, requiresSession: Optional[bool]=None, deadLetteringOnMessageExpiration: Optional[bool]=None, tags_: Optional[Map[str, str]]=None, autoDeleteOnIdle: Optional[str]=None, enableBatchedOperations: Optional[bool]=None, name_: Optional[str]=None, location: Optional[str]=None, status: Optional[str]=None) -> None: ...
    ...
    @overload
    @classmethod
    def fromString(cls, s: str) -> Union[AzureServiceBusTopicSubscription]:
    """
    ...
    @overload
    @classmethod
    def fromString(cls, s: str, failIfInvalid: bool=None) -> Union[AzureServiceBusTopicSubscription]:
    """
    Constructs Cloud Resource instance with reference fields and credentials based on provided Cloud Reference string.
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[AzureServiceBusTopicSubscription]:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> AzureServiceBusTopicSubscription:
    """
    ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> AzureServiceBusTopicSubscription:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> AzureServiceBusTopicSubscription:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> AzureServiceBusTopicSubscription:
    """
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[AzureServiceBusTopicSubscription]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[AzureServiceBusTopicSubscription]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[AzureServiceBusTopicSubscription]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[AzureServiceBusTopicSubscription]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> AzureServiceBusTopicSubscription:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> AzureServiceBusTopicSubscription:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> AzureServiceBusTopicSubscription:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[AzureServiceBusTopicSubscription]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[AzureServiceBusTopicSubscription]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> AzureServiceBusTopicSubscription:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> AzureServiceBusTopicSubscription:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> AzureServiceBusTopicSubscription:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> AzureServiceBusTopicSubscription:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> AzureServiceBusTopicSubscription:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> AzureServiceBusTopicSubscription:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> AzureServiceBusTopicSubscription:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> AzureServiceBusTopicSubscription:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> AzureServiceBusTopicSubscription:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> AzureServiceBusTopicSubscription:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> AzureServiceBusTopicSubscription:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> AzureServiceBusTopicSubscription:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> AzureServiceBusTopicSubscription:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> AzureServiceBusTopicSubscription:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> AzureServiceBusTopicSubscription:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> AzureServiceBusTopicSubscription:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> AzureServiceBusTopicSubscription:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> AzureServiceBusTopicSubscription:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> AzureServiceBusTopicSubscription:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> AzureServiceBusTopicSubscription:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> AzureServiceBusTopicSubscription:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> AzureServiceBusTopicSubscription:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> AzureServiceBusTopicSubscription:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> AzureServiceBusTopicSubscription:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> AzureServiceBusTopicSubscription:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> AzureServiceBusTopicSubscription:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> AzureServiceBusTopicSubscription:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> AzureServiceBusTopicSubscription:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[AzureServiceBusTopicSubscription]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[AzureServiceBusTopicSubscription]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[AzureServiceBusTopicSubscription]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[AzureServiceBusTopicSubscription]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[AzureServiceBusTopicSubscription]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, AzureServiceBusTopicSubscription]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, AzureServiceBusTopicSubscription]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[AzureServiceBusTopicSubscription]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[AzureServiceBusTopicSubscription]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> AzureServiceBusTopicSubscription:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> AzureServiceBusTopicSubscription:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> AzureServiceBusTopicSubscription:
    """
    ...
    """
        ...
    def afterMake(self) -> AzureServiceBusTopicSubscription:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> AzureServiceBusTopicSubscription:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[AzureServiceBusTopicSubscription]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> AzureServiceBusTopicSubscription:
    """
    ...
    """
        ...
    @classmethod
    def forId(cls, id: str, failIfMissing: bool=None) -> Union[AzureServiceBusTopicSubscription]:
    """
    Find Cloud Resource in Cloud Provider based on provided C3 canonical identifier.
    """
        ...
    @classmethod
    def fromClusterId(cls, clusterId: str, env: str, app: str, func: str, role: str=None, seq: str=None, subseq: str=None) -> AzureServiceBusTopicSubscription:
    """
    Construct a cloud ID from a cluster ID
    """
        ...
    @classmethod
    def fromEnvId(cls, envId: str, app: str, func: str, role: str=None, seq: str=None, subseq: str=None) -> AzureServiceBusTopicSubscription:
    """
    ...
    """
        ...
    @classmethod
    def fromAppId(cls, appId: str, func: str, role: str=None, seq: str=None, subseq: str=None) -> AzureServiceBusTopicSubscription:
    """
    ...
    """
        ...
    def withDefaultId(self) -> AzureServiceBusTopicSubscription:
    """
    Populate default values for all uninitialized Cloud Identifier fields in this Cloud Resource.
    """
        ...
    def sanitize(self) -> AzureServiceBusTopicSubscription:
    """
    ...
    """
        ...
    @classmethod
    def fromId(cls, id: str, failIfInvalid: bool=None) -> AzureServiceBusTopicSubscription:
    """
    ...
    """
        ...
    @classmethod
    def fromCloudId(cls, id: CloudId, failIfInvalid: bool=None) -> AzureServiceBusTopicSubscription:
    """
    ...
    """
        ...
    @classmethod
    def fromCloudRef(cls, ref: CloudRef, failIfInvalid: bool=None) -> AzureServiceBusTopicSubscription:
    """
    Constructs Cloud Resource instance with reference fields and credentials based on provided Cloud Reference.
    """
        ...
    @classmethod
    def fromCloudFunc(cls, func: str, role: str=None, seq: str=None) -> AzureServiceBusTopicSubscription:
    """
    Constructs Cloud Resource instance based on provided Cloud Func component and optional role.
    """
        ...
    @classmethod
    def fromResourceId(cls, resourceId: str) -> AzureServiceBusTopicSubscription:
    """
    Constructs Cloud Resource instance based on provided Cloud Resource Id.
    """
        ...
    @classmethod
    def fromResourceSecondaryId(cls, resourceSecondaryId: str) -> AzureServiceBusTopicSubscription:
    """
    Constructs Cloud Resource instance based on provided Cloud Resource Secondary Id and available Cloud Configuration.
    """
        ...
    @classmethod
    def fromResourceName(cls, name: str) -> AzureServiceBusTopicSubscription:
    """
    Constructs Cloud Resource instance based on provided Cloud Resource Name and available Cloud Configuration.
    """
        ...
    @classmethod
    def fromReferenceField(cls, fieldName: str, value: str, failIfInvalid: bool=None) -> AzureServiceBusTopicSubscription:
    """
    ...
    """
        ...
    def fromConfigTemplate(self, spec: CloudResourceOperationSpec=None) -> AzureServiceBusTopicSubscription:
    """
    ...
    """
        ...
    def withDefaultConfig(self, spec: CloudResourceOperationSpec=None) -> AzureServiceBusTopicSubscription:
    """
    ...
    """
        ...
    def upsertResource(self, spec: CloudResourceOperationSpec=None) -> AzureServiceBusTopicSubscription:
    """
    Create or update Cloud Resource.
    """
        ...
    def upsertWithDependencies(self, spec: CloudResourceOperationSpec=None) -> AzureServiceBusTopicSubscription:
    """
    ...
    """
        ...
    @classmethod
    def allCached(cls, doNotProduceAll: bool=None) -> Union[Stream[AzureServiceBusTopicSubscription]]:
    """
    ...
    """
        ...
    @classmethod
    def find(cls, filter: str=None, doNotProduceAll: bool=None) -> Union[Stream[AzureServiceBusTopicSubscription]]:
    """
    ...
    """
        ...
    @classmethod
    def findBy(cls, field: str, value: Any, doNotProduceAll: bool=None) -> Union[Stream[AzureServiceBusTopicSubscription]]:
    """
    @param doNotProduceAll if true, will not populate cache and only return available cached instances. Will call
           `produceAll` if cache is empty or if Ann.cache.all is true & data has not previously been fetched.
    @return existing instances of this type that satisfy filter from data cache.
    """
        ...
    @classmethod
    def findByCacheKey(cls, key: str) -> Union[AzureServiceBusTopicSubscription]:
    """
    ...
    """
        ...
    @classmethod
    def forCacheKey(cls, key: str) -> Union[AzureServiceBusTopicSubscription]:
    """
    Returns cached instance by key, with secrets removed.
    """
        ...
    def getCached(self) -> Union[AzureServiceBusTopicSubscription]:
    """
    This method on any CloudResource is not supported! Use CloudResource.for* or other methods instead.
    """
        ...
    def refreshCache(self) -> Union[AzureServiceBusTopicSubscription]:
    """
    ...
    """
        ...
    @classmethod
    def produce(cls, key: str) -> Union[AzureServiceBusTopicSubscription]:
    """
    Should produce an entry for the cache key. This method should not be called directly.
    """
        ...
    @classmethod
    def produceAll(cls) -> Union[Map[str, AzureServiceBusTopicSubscription]]:
    """
    ...
    """
        ...
    @classmethod
    def doProduceAll(cls) -> Union[Map[str, AzureServiceBusTopicSubscription]]:
    """
    ...
    """
        ...
    def getConfig(self) -> AzureServiceBusTopicSubscription:
    """
    This method on any CloudResource is not supported! Use CloudResource.for* or other methods instead.
    """
        ...
    ...
    """
        ...
    def getSecret(self) -> AzureServiceBusTopicSubscription:
    """
    ...
    """
        ...
    @classmethod
    def forConfigKey(cls, configKey: str) -> Union[AzureServiceBusTopicSubscription]:
    """
    ...
    """
        ...
    @classmethod
    def listConfigs(cls, parallel: bool=None, filter: Callable[[str], bool]=None) -> Union[Stream[AzureServiceBusTopicSubscription]]:
    """
    @param
    ...
    """
        ...
    @overload
    def setConfigValues(self, from_: AzureServiceBusTopicSubscription, override: str=None) -> None:
    """
    ...
    """
        ...
    @overload
    def setSecretValues(self, from_: AzureServiceBusTopicSubscription, override: str=None) -> None:
    """
    ...
    """
        ...
    @classmethod
    def loadConfigAndSecret(cls, configKey: str) -> Union[AzureServiceBusTopicSubscription]:
    """
    ...
    """
        ...
    def removeSecrets(self) -> Union[AzureServiceBusTopicSubscription]:
    """
    @return this config without any secret values.
    """
        ...
    def removeNonSecrets(self) -> Union[AzureServiceBusTopicSubscription]:
    """
    @return this config with only secret values.
    """
        ...
    def validate(self) -> AzureServiceBusTopicSubscription:
    """
    ...
    """
        ...
    def withIdentity(self, resource: CloudResource=None, spec: CloudResourceOperationSpec=None) -> AzureServiceBusTopicSubscription:
    """
    ...
    """
        ...
    def mergeId(self, other: CloudResource=None) -> AzureServiceBusTopicSubscription:
    """
    ...
    """
        ...
    @classmethod
    def forCloudId(cls, id: CloudId, failIfMissing: bool=None) -> Union[AzureServiceBusTopicSubscription]:
    """
    ...
    """
        ...
    @classmethod
    def forCloudFunc(cls, func: str, role: str=None, failIfMissing: bool=None) -> AzureServiceBusTopicSubscription:
    """
    Find Cloud Resource based on provided cloud func component and optional role.
    """
        ...
    @classmethod
    def forCloudRole(cls, role: str, failIfMissing: bool=None) -> AzureServiceBusTopicSubscription:
    """
    Find Cloud Resource of this type based on provided cloud role component.
    """
        ...
    @classmethod
    def forResourceId(cls, resourceId: str, failIfMissing: bool=None) -> Union[AzureServiceBusTopicSubscription]:
    """
    Find Cloud Resource in the Cloud Provider by provided resource name.
    """
        ...
    @classmethod
    def forResourceSecondaryId(cls, resourceId: str, failIfMissing: bool=None) -> Union[AzureServiceBusTopicSubscription]:
    """
    Find Cloud Resource in the Cloud Provider by provided resource name.
    """
        ...
    ...
    """
        ...
    @classmethod
    def forResourceName(cls, resourceName: str, failIfMissing: bool=None) -> Union[AzureServiceBusTopicSubscription]:
    """
    Find Cloud Resource in the Cloud Provider by provided resource name.
    """
        ...
    @classmethod
    def findResource(cls, reference: str, failIfMissing: bool=None) -> Union[AzureServiceBusTopicSubscription]:
    """
    Find Cloud Resource in the Cloud Provider by provided {@link CloudRef} string.
    """
        ...
    def getResource(self) -> Union[AzureServiceBusTopicSubscription]:
    """
    Find Cloud Resource in the Cloud Provider by provided #resourceId, #resourceSecondaryId, #resourceName or #tags
    (in that order).
    """
        ...
    def ensureResource(self) -> AzureServiceBusTopicSubscription:
    """
    Checks that the resource is persisted. If not, upserts the resource, to ensure that the resource exists.
    """
        ...
    @classmethod
    def listResourcesBySubtype(cls, spec: CloudListResourcesSpec=None) -> Map[str, CloudListResourcesResult[AzureServiceBusTopicSubscription]]:
    """
    ...
    """
        ...
    @classmethod
    def listResources(cls, spec: CloudListResourcesSpec=None) -> CloudListResourcesResult[AzureServiceBusTopicSubscription]:
    """
    ...
    """
        ...
    @classmethod
    def listResourcesForTags(cls, *keyValuePairs: Array[str]) -> CloudListResourcesResult[AzureServiceBusTopicSubscription]:
    """
    List all Cloud Resources that satisfies the given spec.
    ...
    """
        ...
    @classmethod
    def listResourcesForClusterId(cls, clusterId: str, cloudIdRole: str=None, spec: CloudListResourcesSpec=None) -> CloudListResourcesResult[AzureServiceBusTopicSubscription]:
    """
    List all Cloud Resources that satisfies the given spec.
    ...
    """
        ...
    @classmethod
    def listResourcesForEnvId(cls, envId: str, cloudIdRole: str=None, spec: CloudListResourcesSpec=None) -> CloudListResourcesResult[AzureServiceBusTopicSubscription]:
    """
    List all Cloud Resources that satisfies the given spec.
    ...
    """
        ...
    @classmethod
    def listResourcesForAppId(cls, appId: str, cloudIdRole: str=None, spec: CloudListResourcesSpec=None) -> CloudListResourcesResult[AzureServiceBusTopicSubscription]:
    """
    List all Cloud Resources that satisfies the given spec.
    ...
    """
        ...
    def upsertDependencies(self, spec: CloudResourceOperationSpec=None) -> AzureServiceBusTopicSubscription:
    """
    ...
    """
        ...
    def waitForCreate(self, spec: WaitSpec=None) -> Union[AzureServiceBusTopicSubscription]:
    """
    ...
    """
        ...
    @classmethod
    def tagResourcesBatch(cls, resources: Array[AzureServiceBusTopicSubscription], tags: Array[CloudTag]) -> Union[Map[str, Error]]:
    """
    ...
    """
        ...
    @classmethod
    def untagResourcesBatch(cls, resources: Array[AzureServiceBusTopicSubscription], tagKeys: Array[str]) -> Union[Map[str, Error]]:
    """
    ...
    """
        ...
    def waitForOk(self, spec: WaitSpec=None) -> Union[AzureServiceBusTopicSubscription]:
    """
    ...
    """
        ...
    def waitForState(self, state: str='AVAILABLE', spec: WaitSpec=None) -> Union[AzureServiceBusTopicSubscription]:
    """
    ...
    """
        ...
    def setFullyConfigured(self, fullyConfigured: bool=None, override: str=None) -> AzureServiceBusTopicSubscription:
    """
    ...
    """
        ...
    def afterCreate(self, input: AzureServiceBusTopicSubscription=None) -> AzureServiceBusTopicSubscription:
    """
    ...
    """
        ...
    def beforeCreate(self) -> AzureServiceBusTopicSubscription:
    """
    Optional callback to alter resource before creating it.
    """
        ...
    def beforeUpdate(self) -> AzureServiceBusTopicSubscription:
    """
    Optional callback to alter resource before updating it.
    """
        ...
    def beforeDestroy(self) -> AzureServiceBusTopicSubscription:
    """
    ...
    """
        ...
    def withoutNonModifiableFields(self) -> AzureServiceBusTopicSubscription:
    """
    ...
    def extraTemplateBindings(cls, cid: CloudId=None) -> Union[any]:
        ...
    def safeResourceGroup(self) -> AzureResourceGroup:
    """
    Resource group associated with the given resource
    """
        ...
    def azureCredentials(self) -> AzureCredentials:
    """
    @return the #credentials of the cloud resource including azure specific credential fields
    """
        ...
    def toImpls(self) -> Union[Any]:
    """
    Converts C3 cloud resource to Azure native implementations object.
    """
        ...
    def toImpl(self, isCreate: bool=None) -> Union[Any]:
    """
    Converts C3 cloud resource to Azure native implementation object.
    
    @param isCreate
           specifies whether the object will be used to create a resource.
    """
        ...
    @classmethod
    def fromImpl(cls, impl: Any=None) -> Union[AzureServiceBusTopicSubscription]:
    """
    Converts Azure native object to C3 cloud resource.
    
    @param impl
           The Azure native resource object on which to perform the conversion.
    """
        ...
    def safeParent(self) -> Union[AzureServiceBusTopic]:
    """
    The parent resource that this child belongs to.
    """
        ...
    @classmethod
    def parentType(cls) -> Type:
    """
    The type of the parent.
    """
        ...
    def parentResourceName(self) -> str:
    """
    The name of the parent resource.
    """
        ...
    @classmethod
    def parseResourceName(cls, resourceName: str) -> Pair[str, str]:
    """
    Parses the #resourceName in the following format: "<childName>/<parentResourceName>" into a
    pair where:
    fst: child name
    snd: parent name
    """
        ...
    @classmethod
    def makeResourceName(cls, childName: str, parentName: str) -> str:
    """
    Constructs the #resourceName in the following format: "<childName>/<parentResourceName>"
    
    @param childName
              Name of the child resource
    @param parentName
              Name of the parent resource
    @return the #resourceName in the format: "<childName>/<parentName>"
    """
        ...
    @classmethod
    def parentResourceNameFromImpl(cls, impl: Any=None) -> str:
    """
    Constructs the unique parent resource name from the Azure native object.
    
    @param impl
           The Azure native resource object on which to perform the conversion.
    """
        ...
    def sendMessages(self, messages: Array[CloudMessage]=None) -> Union[Map[str, Error]]:
    """
    Send an array of CloudMessage to this cloud message broker
    
    @param messages
                 Array of messages to be sent to the cloud message broker
    @return Errors with CloudMessage id as key
    """
        ...
    def sendObjs(self, objs: Array[Obj]=None, spec: CloudMessageBrokerSendSpec=None) -> Union[Map[str, Error]]:
    """
    Send an array of Obj to this cloud message broker
    
    @param objs
                 Array of objs to be sent to the cloud message broker
    @param spec
                 Spec for defining {@link CloudMessage} sent to broker.
    @return Errors with CloudMessage id as key
    """
        ...
    def receiveMessages(self, spec: CloudReceiveMessagesSpec=None) -> Union[Array[CloudMessage]]:
    """
    Receive an array of CloudMessage from this cloud message broker
    
    @param spec
             The spec defining the behavior of receiveMessages
    """
        ...
    @classmethod
    def receivesMessagesAsync(cls) -> bool:
    """
    Determines whether this broker registers to receive messages asynchronously.
    """
        ...
    def registerReceiveMessagesAsync(self, spec: CloudReceiveMessagesSpec=None) -> None:
    """
    Registers to receive messages asynchronously from this cloud message broker
    
    @param spec
             The spec defining the behavior of receiveMessages
    """
        ...
    def deregisterReceiveMessagesAsync(self) -> None:
    """
    Deregisters to receive messages from this cloud message broker
    """
        ...
    def processor(self) -> Union[CloudMessageProcessor[CloudMessage, CloudReceiveMessagesSpec]]:
    """
    Construct a CloudMessageProcessor based on this CloudMessageBroker
    """
        ...
    def removeAll(self, confirm: bool=None) -> Union[int]:
    """
    Remove all the messages in the cloud message broker and return the number of messages removed
    
    @param confirm
                Set to true to confirm you want to delete all the messages in this broker
    """
        ...
    def approximateCount(self, partition: str, cloudConsumer: str=None) -> int:
    """
    Counts the number of messages in a partition of this CloudStream
    """
        ...
    def destroyMessages(self, messages: Array[CloudMessage]=None) -> Union[Map[str, Error]]:
    """
    Destroy an array of CloudMessage from the cloud queue
    """
        ...
    def releaseMessages(self, messages: Array[CloudMessage]=None) -> Union[Map[str, Error]]:
    """
    Release the lock of an array of CloudMessage from the cloud queue
    """
        ...
    def peekMessages(self, spec: CloudReceiveMessagesSpec=None) -> Union[Array[CloudMessage]]:
    """
    Peek (receive and do not lock) an array of CloudMessage from the cloud queue
    """
        ...
    @classmethod
    def fromJava(cls, javaObj: Any) -> Union[AzureServiceBusTopicSubscriptionFields]:
        ...
    def toJava(self) -> Union[Any]:
        ...
