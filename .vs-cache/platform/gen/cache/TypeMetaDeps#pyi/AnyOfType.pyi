...
from c3.platform.AnyOfRestriction import AnyOfRestriction
...
# Python definitions for the C3 type AnyOfType


class AnyOfType(ValueType):
    """
    ...
    restrictions: Optional[Array[AnyOfRestriction]]
    """
    ...
    unionRefType: Optional[ReferenceType]=None
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> AnyOfType:
    """
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[AnyOfType]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[AnyOfType]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[AnyOfType]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[AnyOfType]:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> AnyOfType:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> AnyOfType:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[AnyOfType]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[AnyOfType]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> AnyOfType:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> AnyOfType:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> AnyOfType:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> AnyOfType:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> AnyOfType:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> AnyOfType:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> AnyOfType:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> AnyOfType:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> AnyOfType:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> AnyOfType:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> AnyOfType:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> AnyOfType:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> AnyOfType:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> AnyOfType:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> AnyOfType:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> AnyOfType:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> AnyOfType:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> AnyOfType:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> AnyOfType:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> AnyOfType:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> AnyOfType:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> AnyOfType:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> AnyOfType:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> AnyOfType:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> AnyOfType:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> AnyOfType:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> AnyOfType:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> AnyOfType:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[AnyOfType]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[AnyOfType]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[AnyOfType]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[AnyOfType]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[AnyOfType]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, AnyOfType]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, AnyOfType]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[AnyOfType]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[AnyOfType]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> AnyOfType:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> AnyOfType:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> AnyOfType:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> AnyOfType:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> AnyOfType:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> AnyOfType:
    """
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[AnyOfType]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> AnyOfType:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> AnyOfType:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[AnyOfType]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> AnyOfType:
    """
    ...
    """
        ...
    def withoutDeclaredSrcPos(self, recursive: bool=None) -> AnyOfType:
    """
    ...
    """
        ...
    @overload
    def withAnnotation(self, ann: Annotation) -> AnyOfType:
    """
    Add an annotation to the given metadata
    """
        ...
    @overload
    def withAnnotation(self, ann: str, annField: str=None, value: Any=None) -> AnyOfType:
    """
    Add an annotation to the given metadata
    @param ann
            annotation to add
    ...
    """
        ...
    @classmethod
    def fromString(cls, s: str) -> Union[AnyOfType]:
    """
    ...
    """
        ...
    def anyOfBaseType(self) -> ValueType:
    """
    ...
    """
        ...
    def guessPrimitiveRestriction(self, value: Any, failIfNot: bool=None) -> Union[PrimitiveType]:
    """
    ...
    """
        ...
    def guessRestriction(self, value: Any, testContent: bool=None, failIfNone: bool=None) -> Union[ValueType]:
    """
    ...
    """
        ...
    def inclusions(self) -> Array[ValueType]:
    """
    The possible acceptable value types - i.e. restrictions without exclusions.
    """
        ...
    def exclusions(self) -> Union[Array[ValueType]]:
    """
    The exclusion value types.
    """
        ...
    def isExcluded(self, vt: ValueType) -> bool:
    """
    Whether this value type is explicitly excluded (#isA any of the listed exclusions).
    """
        ...
    @classmethod
    def fromRestrictions(cls, pkg: Pkg, restrictions: Array[ValueType]) -> AnyOfType:
    """
