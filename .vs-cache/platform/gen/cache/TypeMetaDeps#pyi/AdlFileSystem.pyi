...
# Python definitions for the C3 type AdlFileSystem


class AdlFileSystem(BlobFileSystem[AdlFile], FileSystemConfigurable[AdlFsConfig]):
    """
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[AdlFileSystem]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[AdlFileSystem]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[AdlFileSystem]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[AdlFileSystem]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> AdlFileSystem:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> AdlFileSystem:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> AdlFileSystem:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[AdlFileSystem]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[AdlFileSystem]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> AdlFileSystem:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> AdlFileSystem:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> AdlFileSystem:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> AdlFileSystem:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> AdlFileSystem:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> AdlFileSystem:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> AdlFileSystem:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> AdlFileSystem:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> AdlFileSystem:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> AdlFileSystem:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> AdlFileSystem:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> AdlFileSystem:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> AdlFileSystem:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> AdlFileSystem:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> AdlFileSystem:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> AdlFileSystem:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> AdlFileSystem:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> AdlFileSystem:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> AdlFileSystem:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> AdlFileSystem:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> AdlFileSystem:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> AdlFileSystem:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> AdlFileSystem:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> AdlFileSystem:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> AdlFileSystem:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> AdlFileSystem:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> AdlFileSystem:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> AdlFileSystem:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[AdlFileSystem]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[AdlFileSystem]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[AdlFileSystem]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[AdlFileSystem]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[AdlFileSystem]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, AdlFileSystem]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, AdlFileSystem]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[AdlFileSystem]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[AdlFileSystem]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> AdlFileSystem:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> AdlFileSystem:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> AdlFileSystem:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> AdlFileSystem:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> AdlFileSystem:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> AdlFileSystem:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> AdlFileSystem:
    """
    ...
    """
        ...
    def afterMake(self) -> AdlFileSystem:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> AdlFileSystem:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[AdlFileSystem]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> AdlFileSystem:
    """
    ...
    def doTruncateContainer(self, containerName: str, spec: FileOperationSpec=None) -> int:
        ...
    def doReadBlobMeta(self, containerName: str, blobKey: str, spec: FileOperationSpec=None) -> Union[AdlFile]:
        ...
    def doBlobEncodedStream(self, containerName: str, blobKey: str, spec: FileOperationSpec=None) -> Union[Pair[AdlFile, ByteStream]]:
        ...
    ...
    def doDeleteBlobs(self, containerName: str, blobKeys: Array[str], spec: FileOperationSpec=None) -> None:
        ...
    def doCopyBlob(self, srcContainerName: str, srcBlobKey: str, destContainerName: str, destBlobKey: str, spec: FileOperationSpec=None) -> Union[AdlFile]:
        ...
    def doCopyBlobs(self, srcContainerNames: Array[str], srcBlobKeys: Array[str], destContainerNames: Array[str], destBlobKeys: Array[str], spec: FileOperationSpec=None) -> Union[Array[AdlFile]]:
    """
    ...
    """
        ...
    def doReplaceBlobContentTypeAndEncoding(self, containerName: str, srcBlobKey: str, contentEncoding: str, contentType: str=None, spec: FileOperationSpec=None) -> Union[AdlFile]:
        ...
    def cloudClient(self, containerName: str) -> Any:
        ...
    def fileType(self) -> Type:
        ...
    def config(self, secrets: bool=None) -> AdlFsConfig:
    """
