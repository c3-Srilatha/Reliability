...
from c3.platform.ExMachinaScheduleUi import ExMachinaScheduleUi
...
from c3.platform.ExMachinaExecutionTrigger import ExMachinaExecutionTrigger
...
from c3.platform.ExMachinaExecutionTriggerOwnership import ExMachinaExecutionTriggerOwnership
...
from c3.platform.ExMachinaPipelineRun import ExMachinaPipelineRun
...
from c3.platform.ExMachinaCreateExecutionScheduleSpec import ExMachinaCreateExecutionScheduleSpec
from c3.platform.ExMachinaExecutionTriggerShareHistory import ExMachinaExecutionTriggerShareHistory
...
from c3.platform.ExMachinaPipelineRunSpec import ExMachinaPipelineRunSpec
...
# Python definitions for the C3 type ExMachinaExecutionSchedule


class ExMachinaExecutionSchedule(ExMachinaExecutionTrigger, ExMachinaDynamicCronJobScheduler[ExMachinaExecutionSchedule], ExMachinaCreateCronJobSpec):
    """
    Schedule for pipeline execution
    
    @remarks this represents a made instance of ExMachinaExecutionSchedule
    """
    
    upsertCronJobBy: Optional[datetime]=None
    """
    ...
    """
    The schedule cron expression. If empty, only one run will be created at the {@link startTime}
    """
    ...
    ownershipHistory: Optional[Array[ExMachinaExecutionTriggerOwnership]]=None
    """
    History of all owners of the shareable entity
    """

    activelyShared: Optional[Array[ExMachinaExecutionTriggerShareHistory]]=None
    """
    Current groups with which the shareable entity has been shared
    """

    sharedHistory: Optional[Array[ExMachinaExecutionTriggerShareHistory]]=None
    """
    ...
    spec: Optional[ExMachinaPipelineRunSpec]
    """
    Specifies parameters for pipeline execution
    """

    runs: Optional[Array[ExMachinaPipelineRun]]=None
    """
    ExMachina pipeline runs associated with given trigger
    """

    lastExecutionDateTime: Optional[datetime]=None
    """
    Execution time of the latest {@link ExMachinaPipelineRun}
    """

    propertiesBindings: Optional[any]=None
    """
    Pipeline properties bindings
    """

    sessionSize: Optional[ExMachinaMemorySize]=None
    """
    The memory size to use when starting an ExMachinaSession for the scheduled execution
    """

    accountMembersToNotify: Optional[Array[ExMachinaUser]]=None
    """
    Account members to be notified when a {@link ExMachinaExecutionSchedule} is updated.
    """
    def __init__(self, upsertCronJobBy: Optional[datetime]=None, startTime: Optional[datetime]=None, endTime: Optional[datetime]=None, cronExpression: Optional[str]=None, acl: Optional[Array[AclEntry]]=None, isPubliclyAccessible: Optional[bool]=None, disabled: Optional[bool]=None, ownershipType: Optional[ExMachinaExecutionTriggerOwnership]=None, shareHistoryType: Optional[ExMachinaExecutionTriggerShareHistory]=None, currentOwner: Optional[User]=None, displayOwner: Optional[str]=None, lastUpdatedBy: Optional[str]=None, ownershipHistory: Optional[Array[ExMachinaExecutionTriggerOwnership]]=None, activelyShared: Optional[Array[ExMachinaExecutionTriggerShareHistory]]=None, sharedHistory: Optional[Array[ExMachinaExecutionTriggerShareHistory]]=None, isOwned: Optional[bool]=None, typeIdent: Optional[str]=None, id: Optional[str]=None, versionEdits: Optional[Array[VersionEdit]]=None, name: Optional[str]=None, meta: Optional[Meta]=None, version: Optional[int]=None, typeWithBindings: Optional[Type]=None, state: Optional[str]=None, spec: Optional[ExMachinaPipelineRunSpec]=None, runs: Optional[Array[ExMachinaPipelineRun]]=None, lastExecutionDateTime: Optional[datetime]=None, propertiesBindings: Optional[any]=None, sessionSize: Optional[ExMachinaMemorySize]=None, accountMembersToNotify: Optional[Array[ExMachinaUser]]=None) -> None: ...
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[ExMachinaExecutionSchedule]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[ExMachinaExecutionSchedule]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[ExMachinaExecutionSchedule]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[ExMachinaExecutionSchedule]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> ExMachinaExecutionSchedule:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> ExMachinaExecutionSchedule:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> ExMachinaExecutionSchedule:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[ExMachinaExecutionSchedule]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[ExMachinaExecutionSchedule]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> ExMachinaExecutionSchedule:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> ExMachinaExecutionSchedule:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> ExMachinaExecutionSchedule:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> ExMachinaExecutionSchedule:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> ExMachinaExecutionSchedule:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> ExMachinaExecutionSchedule:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> ExMachinaExecutionSchedule:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> ExMachinaExecutionSchedule:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> ExMachinaExecutionSchedule:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> ExMachinaExecutionSchedule:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> ExMachinaExecutionSchedule:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> ExMachinaExecutionSchedule:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> ExMachinaExecutionSchedule:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> ExMachinaExecutionSchedule:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> ExMachinaExecutionSchedule:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> ExMachinaExecutionSchedule:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> ExMachinaExecutionSchedule:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> ExMachinaExecutionSchedule:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> ExMachinaExecutionSchedule:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> ExMachinaExecutionSchedule:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> ExMachinaExecutionSchedule:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> ExMachinaExecutionSchedule:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> ExMachinaExecutionSchedule:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> ExMachinaExecutionSchedule:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> ExMachinaExecutionSchedule:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> ExMachinaExecutionSchedule:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> ExMachinaExecutionSchedule:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> ExMachinaExecutionSchedule:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[ExMachinaExecutionSchedule]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[ExMachinaExecutionSchedule]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[ExMachinaExecutionSchedule]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[ExMachinaExecutionSchedule]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[ExMachinaExecutionSchedule]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, ExMachinaExecutionSchedule]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, ExMachinaExecutionSchedule]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[ExMachinaExecutionSchedule]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[ExMachinaExecutionSchedule]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> ExMachinaExecutionSchedule:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> ExMachinaExecutionSchedule:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> ExMachinaExecutionSchedule:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> ExMachinaExecutionSchedule:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> ExMachinaExecutionSchedule:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> ExMachinaExecutionSchedule:
    """
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[ExMachinaExecutionSchedule]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> ExMachinaExecutionSchedule:
    """
    ...
    """
        ...
    def afterMake(self) -> ExMachinaExecutionSchedule:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> ExMachinaExecutionSchedule:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[ExMachinaExecutionSchedule]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> ExMachinaExecutionSchedule:
    """
    ...
    """
        ...
    @classmethod
    def updateUpsertCronJobByFieldForEntitiesThatHaveExistingCronJobs(cls, existingCronJobs: Array[CronJob]=None) -> None:
    """
    For each existing CronJob, updates the {@link upsertCronJobBy} field on the record of the mixing type.
    """
        ...
    @classmethod
    def fetchSchedulesWithUpsertCronJobByWithinHours(cls) -> Union[Array[ExMachinaExecutionSchedule]]:
    """
    ...
    """
        ...
    @classmethod
    def fetchExistingCronJobsForScheduledEntities(cls) -> Union[Array[CronJob]]:
    """
    Returns all CronJobs associated with the type of scheduler (the type that mixes ExMachinaDynamicCronJobScheduler).
    """
        ...
    @classmethod
    def getIdsOfCronJobsToRemove(cls, schedulesToUpsertCronJobsFor: Array[ExMachinaExecutionSchedule]=None, existingCronJobs: Array[CronJob]=None) -> Union[Array[str]]:
    """
    Called within {@link manageCronJobs} to return a list of {@link CronJob} ids that can be removed.
    """
        ...
    @classmethod
    def getIdsOfCronJobsToUpsert(cls, schedulesToUpsertCronJobsFor: Array[ExMachinaExecutionSchedule]=None) -> Union[Array[str]]:
    """
    Called within {@link manageCronJobs} to return a list of {@link CronJob} ids that should be created.
    """
        ...
    @classmethod
    def getCronJobsToUpsert(cls, schedulesToUpsertCronJobsFor: Array[ExMachinaExecutionSchedule]=None, existingCronJobs: Array[CronJob]=None) -> Union[Array[CronJob]]:
    """
    Called within {@link manageCronJobs} to return a list of {@link CronJob}s that should be created.
    """
        ...
    @classmethod
    def makeCronJobForSchedule(cls, cronJobId: str, schedule: ExMachinaExecutionSchedule) -> Union[CronJob]:
    """
    ...
    """
        ...
    @classmethod
    def getNumHoursIntoFutureToUpsertCronJobs(cls) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def getCronJobIdFromScheduleId(cls, scheduleId: str, typeName: str=None) -> Union[str]:
    """
    ...
    """
        ...
    @classmethod
    def getScheduleIdFromCronJobId(cls, cronJobId: str, typeName: str=None) -> Union[str]:
    """
    ...
    """
        ...
    @classmethod
    def populateAcl(cls, objs: Array[ExMachinaExecutionSchedule]=None) -> Union[int]:
    """
    ...
    """
        ...
    def grantMemberReadUpdateRemove(self, member: AccessControlEntity) -> ExMachinaExecutionSchedule:
    """
    Creates (or updates existing) entry with all but modify ACL permissions.
    """
        ...
    def mergeAclEntry(self, entry: AclEntry) -> ExMachinaExecutionSchedule:
    """
    ...
    """
        ...
    def mergeAclEntries(self, entries: Array[AclEntry]) -> ExMachinaExecutionSchedule:
    """
    ...
    """
        ...
    @classmethod
    def refreshData(cls, shareHistoryObjs: Array[ExMachinaExecutionTriggerShareHistory]=None, shareableEntityObjs: Array[ExMachinaExecutionTrigger]=None) -> None:
    """
    Refreshes ACLs for the given share history objects and shareable entity objects.
    """
        ...
    def endShares(self, shares: Array[ExMachinaExecutionTriggerShareHistory]=None) -> None:
    """
    ...
    """
        ...
    def updateShares(self, userGroups: Array[UserGroup]=None) -> bool:
    """
    ...
    """
        ...
    def updateSharesHelper(self, userGroups: Array[UserGroup]=None) -> bool:
    """
    ...
    """
        ...
    @classmethod
    def fetchSharedGroups(cls, id: str, include: str=None) -> Union[FetchResult[UserGroup]]:
    """
    ...
    """
        ...
    @classmethod
    def fetchNonSharedGroups(cls, id: str) -> Union[FetchResult[UserGroup]]:
    """
    ...
    """
        ...
    def transferOwnership(self, newOwner: User=None) -> None:
    """
    ...
    """
        ...
    @classmethod
    def postCreate(cls, objs: Array[ExMachinaExecutionTrigger]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    def updateAdditionalAcls(self) -> None:
    """
    Overridden helper method to manually update necessary ACLs whenever shares are updated
    """
        ...
    @classmethod
    def shouldSendShareableEntityAvailableEmailToViewers(cls) -> bool:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, spec: FetchSpec=None) -> FetchResult[ExMachinaExecutionSchedule]:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, filter: Filter) -> FetchResult[ExMachinaExecutionSchedule]:
    """
    ...
    """
        ...
    @classmethod
    def fetchObjStream(cls, spec: FetchStreamSpec=None) -> Union[Stream[ExMachinaExecutionSchedule]]:
    """
    Fetches multiple obj instances based on a specification.  Only objs that the caller is authorized to fetch will be
    returned.
    ...
    """
        ...
    @classmethod
    def fetchMultiLocale(cls, spec: MultiLocaleFetchSpec=None) -> Union[Map[str, FetchResult[ExMachinaExecutionSchedule]]]:
    """
    ...
    """
        ...
    def get(self, include: str=None) -> Union[ExMachinaExecutionSchedule]:
    """
    ...
    """
        ...
    def getSpecific(self, include: str=None) -> Union[ExMachinaExecutionSchedule]:
    """
    ...
    """
        ...
    def getMissing(self, spec: GetMissingSpec) -> ExMachinaExecutionSchedule:
    """
    ...
    """
        ...
    def getDirect(self, include: str=None) -> Union[ExMachinaExecutionSchedule]:
    """
    ...
    """
        ...
    def applyReverseEdit(self, versionEdit: VersionEdit) -> ExMachinaExecutionSchedule:
    """
    ...
    """
        ...
    @classmethod
    def fromString(cls, s: str) -> Union[ExMachinaExecutionSchedule]:
    """
    ...
    """
        ...
    def create(self, spec: UpsertSpec=None) -> Union[ExMachinaExecutionSchedule]:
    """
    ...
    """
        ...
    @classmethod
    def createBatch(cls, objs: Array[ExMachinaExecutionSchedule], spec: UpsertSpec=None) -> Union[ObjList[ExMachinaExecutionSchedule]]:
    """
    ...
    """
        ...
    @classmethod
    def createBatchObjStream(cls, objs: Stream[ExMachinaExecutionSchedule], spec: CreateBatchObjStreamSpec=None) -> Union[ObjList[ExMachinaExecutionSchedule]]:
    """
    Creates multiple instances of a C3 type. If the operation fails and {@link UpsertSpec#dontThrowOnBatchError} is not
    specified (the default), then a C3BatchException will be thrown.  Otherwise {@link errors will be reported in the
    returned {@link ObjList}.  This will fail if any of the instances already exist.
    ...
    """
        ...
    def update(self, srcObj: ExMachinaExecutionSchedule=None, spec: UpsertSpec=None) -> Union[ExMachinaExecutionSchedule]:
    """
    ...
    """
        ...
    def upsert(self, srcObj: ExMachinaExecutionSchedule=None, spec: UpsertSpec=None) -> Union[ExMachinaExecutionSchedule]:
    """
    ...
    """
        ...
    @overload
    def merge(self, spec: MergeSpec=None) -> Union[ExMachinaExecutionSchedule]:
    """
    ...
    """
        ...
    @overload
    def merge(self, mergeInclude: str, spec: MergeSpec=None) -> Union[ExMachinaExecutionSchedule]:
    """
    ...
    """
        ...
    def touch(self, spec: TouchSpec=None) -> Union[ExMachinaExecutionSchedule]:
    """
    ...
    """
        ...
    @classmethod
    def updateBatch(cls, objs: Array[ExMachinaExecutionSchedule], srcObjs: Array[ExMachinaExecutionSchedule]=None, spec: UpsertSpec=None) -> Union[ObjList[ExMachinaExecutionSchedule]]:
    """
    ...
    """
        ...
    @classmethod
    def updateObjs(cls, objs: Callable[[], Union[Array[ExMachinaExecutionSchedule]]], spec: UpsertSpec=None) -> Union[ObjList[ExMachinaExecutionSchedule]]:
    """
    ...
    """
        ...
    @classmethod
    def upsertBatch(cls, objs: Array[ExMachinaExecutionSchedule], srcObjs: Array[ExMachinaExecutionSchedule]=None, spec: UpsertSpec=None) -> Union[ObjList[ExMachinaExecutionSchedule]]:
    """
    ...
    """
        ...
    @classmethod
    def upsertObjs(cls, objs: Callable[[], Union[Array[ExMachinaExecutionSchedule]]], spec: UpsertSpec=None) -> Union[ObjList[ExMachinaExecutionSchedule]]:
    """
    Creates instances of a C3 type if they don't already exist and updates them if they do exist. If the operation
    ...
    """
        ...
    @classmethod
    def touchBatch(cls, objs: Array[ExMachinaExecutionSchedule], spec: TouchSpec=None) -> Union[ObjList[ExMachinaExecutionSchedule]]:
    """
    ...
    @overload
    @classmethod
    def mergeBatch(cls, objs: Array[ExMachinaExecutionSchedule], spec: MergeSpec=None) -> Union[ObjList[ExMachinaExecutionSchedule]]:
    """
    ...
    @overload
    @classmethod
    def mergeBatch(cls, objs: Array[ExMachinaExecutionSchedule], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[ExMachinaExecutionSchedule]]:
    """
    Merges multiple instances of a C3 type or creates them if they don't exist. If the operation fails and {@link
    UpsertSpec#dontThrowOnBatchError} is not specified (the default), then a C3BatchException will be thrown.
    Otherwise errors will be reported in the returned {@link ObjList}.  The merge operation is described in the {@link
    ...
    """
        ...
    @classmethod
    def mergeObjs(cls, objs: Callable[[], Union[Array[ExMachinaExecutionSchedule]]], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[ExMachinaExecutionSchedule]]:
    """
    ...
    @overload
    @classmethod
    def mergeAll(cls, mergeObj: ExMachinaExecutionSchedule, spec: MergeAllSpec=None) -> Union[int]:
    """
    ...
    @overload
    @classmethod
    def mergeAll(cls, mergeObj: ExMachinaExecutionSchedule, mergeInclude: str, spec: MergeAllSpec=None) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def removeBatch(cls, objs: Array[ExMachinaExecutionSchedule], spec: UpsertSpec=None) -> Union[ObjList[ExMachinaExecutionSchedule]]:
    """
    ...
    """
        ...
    @classmethod
    def replace(cls, objs: Array[ExMachinaExecutionSchedule], spec: UpsertSpec=None) -> Union[ObjList[ExMachinaExecutionSchedule]]:
    """
    ...
    """
        ...
    def unremove(self) -> Union[ExMachinaExecutionSchedule]:
    """
    ...
    """
        ...
    @classmethod
    def beforeCreate(cls, objs: Array[ExMachinaExecutionSchedule]) -> ObjList[ExMachinaExecutionSchedule]:
    """
    ...
    """
        ...
    @classmethod
    def beforeUpdate(cls, objs: Array[ExMachinaExecutionSchedule]) -> ObjList[ExMachinaExecutionSchedule]:
    """
    ...
    """
        ...
    @classmethod
    def beforeRemove(cls, objs: Array[ExMachinaExecutionSchedule]) -> ObjList[ExMachinaExecutionSchedule]:
    """
    ...
    """
        ...
    @classmethod
    def afterCreate(cls, objs: Array[ExMachinaExecutionSchedule]) -> Union[Array[ObjError]]:
    """
    TODO: VAD-16871 - Add a common afterCreate for all shareable types after PLAT-51996 fix
    Common logic to run after creation of any types that mixin {@link ExMachinaUserGroupShareable}
    """
        ...
    @classmethod
    def afterUpdate(cls, objs: Array[ExMachinaExecutionSchedule]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def afterRemove(cls, objs: Array[ExMachinaExecutionSchedule]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def startImportData(cls, spec: StartImportDataSpec=None) -> PushStream[ExMachinaExecutionSchedule]:
    """
    @return a push stream to import instances of this type.
    """
        ...
    @classmethod
    def startImportDataWithStats(cls, spec: StartImportDataSpec=None) -> PushStreamWithStats[ExMachinaExecutionSchedule]:
    """
    @return a push stream to import instances of this type.
    """
        ...
    ...
    """
        ...
    @classmethod
    def forId(cls, id: str, failIfMissing: bool=None) -> Union[ExMachinaExecutionSchedule]:
    """
    ...
    """
        ...
    def withoutIdentity(self) -> Union[ExMachinaExecutionSchedule]:
    """
    ...
    """
        ...
    @classmethod
    def typeOfBatch(cls, objs: Array[ExMachinaExecutionSchedule]) -> Union[Array[EntityType]]:
    """
    ...
    """
        ...
    @classmethod
    def dbEcho(cls, template: ExMachinaExecutionSchedule=None, count: int=None, sendBack: bool=None) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def callbackLogic(cls, objs: Array[ExMachinaExecutionSchedule], callback: Callable[[Union[ExMachinaExecutionSchedule]], Union[ExMachinaExecutionSchedule]]=None) -> ObjList[ExMachinaExecutionSchedule]:
    """
    ...
    """
        ...
    @classmethod
    def afterCallbackLogic(cls, objs: Array[ExMachinaExecutionSchedule], callback: Callable[[Union[ExMachinaExecutionSchedule]], Union[ExMachinaExecutionSchedule]]=None) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    def startSession(self) -> ExMachinaSession:
    """
    Start an {@link ExMachinaSession} for the execution schedule
    @return true if the session started successfully
    """
        ...
    def onStateChange(self) -> Union[ExMachinaExecutionTrigger]:
    """
    Update/remove existing executions based on changes to {@link state}
    """
        ...
    def getScheduleUi(self) -> Union[ExMachinaScheduleUi]:
    """
    Returns a new {@link ExMachinaScheduleUi}.
    """
        ...
    @classmethod
    def createFromSpec(cls, spec: ExMachinaCreateExecutionScheduleSpec) -> Union[ExMachinaExecutionSchedule]:
    """
    Creates a new {@link ExMachinaExecutionSchedule}.
    """
        ...
    def editSchedule(self, spec: ExMachinaCreateExecutionScheduleSpec) -> Union[ExMachinaExecutionSchedule]:
    """
    Edits an existing {@link ExMachinaExecutionSchedule}.
    """
        ...
    def renameSchedule(self, scheduleName: str) -> Union[ExMachinaExecutionSchedule]:
    """
    ...
    """
        ...
    @classmethod
    def draftSchedule(cls, scheduleSpec: ExMachinaCreateExecutionScheduleSpec, runSpec: ExMachinaPipelineRunSpec) -> Union[ExMachinaExecutionSchedule]:
    """
    Draft an {@link ExMachinaExecutionSchedule} based on the original creation spec and run spec
    """
        ...
    @classmethod
    def getRunningSchedules(cls) -> Union[Array[ExMachinaExecutionSchedule]]:
    """
    Helper function to fetch the list of running schedules
    """
        ...
    @classmethod
    def getProjectsRunningInSchedules(cls) -> Union[Array[str]]:
    """
    Helper function to get a list of projects running in schedules
    """
        ...
    @classmethod
    def getEmailServiceConfig(cls) -> bool:
    """
    Checks whether {@link ExMachinaConfig.isEmailServiceConfigured} is configured within {@link ExMachinaConfig}
    """
        ...
    def runFromTrigger(self) -> Union[ExMachinaPipelineRun]:
    """
    Run job associated with trigger.
    """
        ...
    @classmethod
    def createPipelineRunSpec(cls, scheduleSpec: ExMachinaCreateExecutionScheduleSpec) -> Union[ExMachinaExecutionSchedule]:
    """
    Get the {@link ExMachinaExecutionSchedule} for the input spec
    """
        ...
