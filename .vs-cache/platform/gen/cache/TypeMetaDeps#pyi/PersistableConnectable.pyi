...
from c3.platform.PersistableConnection import PersistableConnection
from c3.platform.Type import Type

# Python definitions for the C3 type PersistableConnectable


class PersistableConnectable(Value):
    """
    ...
    @classmethod
    def withConn(cls, type: Type, action: Callable[[Any], Union[Any]], readOnly: bool=None, useSecondaryDs: bool=None, stmtTimeoutMs: int=None) -> Union[Any]:
    """
    ...
    """
        ...
    @classmethod
    def connection(cls, type: Type, readOnly: bool=None, useSecondaryDs: bool=None, dontUseParentConn: bool=None, dontValidateSchema: bool=None, stmtTimeoutMs: int=None) -> Union[PersistableConnection]:
    """
