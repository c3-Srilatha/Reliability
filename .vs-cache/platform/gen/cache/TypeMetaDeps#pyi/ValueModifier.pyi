...
# Python definitions for the C3 type ValueModifier
...
class ValueModifier():
    ...
    NON_EMPTY: Optional[str]=None
    """
    Disallows empty values
    """

    PRESERVES_EMPTY: Optional[str]=None
    """
    Allows empty & preserves empty values
    """

    NON_OPTIONAL_PARAM: Optional[str]=None
    """
    Indicates that function parameter is required but allows empty & preserves empty.
    """
    def __init__(self, NON_EMPTY: Optional[str]=None, PRESERVES_EMPTY: Optional[str]=None, NON_OPTIONAL_PARAM: Optional[str]=None) -> None: ...
    ...
    """
        ...
    @classmethod
    def syntax(cls, modifier: str=None) -> Union[str]:
    """
