...
# Python definitions for the C3 type PermissionAccess
...
class PermissionAccess():
    ...
    DENY_SECURITY_LEVEL: Optional[str]=None
    """
    ...
    """
    def __init__(self, ALLOW: Optional[str]=None, DENY: Optional[str]=None, DENY_SECURITY_LEVEL: Optional[str]=None, DENY_PERMISSION: Optional[str]=None) -> None: ...
