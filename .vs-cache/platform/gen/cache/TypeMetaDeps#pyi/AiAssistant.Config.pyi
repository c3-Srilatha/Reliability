...
# Python definitions for the C3 type AiAssistant.Config


class Config(Config, Singleton):
    """
    Configuration for the C3 AI Assistant feature in Jupyter and VS Code.
    
    @remarks this represents a made instance of AiAssistant.Config
    """
    ...
    """
    Indicates if the C3 AI assistant feature is enabled.
    """

    requestTimeout: Optional[int]=None
    """
    Default timeout in seconds of all AiAssistant requests
    """

    feedbackEnabled: Optional[bool]=None
    """
    Indicates if the C3 AI assistant feedback service is enabled.
    If feedback is disabled, the feedback capabilities of the UI should be removed.
    """

    chatHistoryLimit: Optional[int]=None
    """
    The maximum number of {@link AiAssistant.QAPair}s to pass to {@link AiAssistant#ask}
    and persist in the {@link AiAssistant.FeedbackContext#chatHistory}.
    """

    middlewareProxyName: Optional[str]=None
    """
    The proxy name for the middleware to be used for the C3 AI assistant requests.
    """

    askV2MicroserviceName: Optional[str]=None
    """
    The name of the {@link AiAssistant.Microservice} that should be used for calls to {@link AiAssistant#askV2}.
    """
    def __init__(self, configOverride: Optional[str]=None, secretOverride: Optional[str]=None, issues: Optional[Array[str]]=None, enabled: Optional[bool]=None, requestTimeout: Optional[int]=None, feedbackEnabled: Optional[bool]=None, chatHistoryLimit: Optional[int]=None, middlewareProxyName: Optional[str]=None, askV2MicroserviceName: Optional[str]=None) -> None: ...
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[AiAssistant.Config]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[AiAssistant.Config]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[AiAssistant.Config]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[AiAssistant.Config]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> AiAssistant.Config:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> AiAssistant.Config:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> AiAssistant.Config:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[AiAssistant.Config]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[AiAssistant.Config]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> AiAssistant.Config:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> AiAssistant.Config:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> AiAssistant.Config:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> AiAssistant.Config:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> AiAssistant.Config:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> AiAssistant.Config:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> AiAssistant.Config:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> AiAssistant.Config:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> AiAssistant.Config:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> AiAssistant.Config:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> AiAssistant.Config:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> AiAssistant.Config:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> AiAssistant.Config:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> AiAssistant.Config:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> AiAssistant.Config:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> AiAssistant.Config:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> AiAssistant.Config:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> AiAssistant.Config:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> AiAssistant.Config:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> AiAssistant.Config:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> AiAssistant.Config:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> AiAssistant.Config:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> AiAssistant.Config:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> AiAssistant.Config:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> AiAssistant.Config:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> AiAssistant.Config:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> AiAssistant.Config:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> AiAssistant.Config:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[AiAssistant.Config]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[AiAssistant.Config]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[AiAssistant.Config]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[AiAssistant.Config]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[AiAssistant.Config]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, AiAssistant.Config]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, AiAssistant.Config]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[AiAssistant.Config]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[AiAssistant.Config]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> AiAssistant.Config:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> AiAssistant.Config:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> AiAssistant.Config:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> AiAssistant.Config:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> AiAssistant.Config:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> AiAssistant.Config:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> AiAssistant.Config:
    """
    ...
    """
        ...
    def afterMake(self) -> AiAssistant.Config:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> AiAssistant.Config:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[AiAssistant.Config]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> AiAssistant.Config:
    """
    ...
    """
        ...
    @classmethod
    def allCached(cls, doNotProduceAll: bool=None) -> Union[Stream[AiAssistant.Config]]:
    """
    ...
    """
        ...
    @classmethod
    def find(cls, filter: str=None, doNotProduceAll: bool=None) -> Union[Stream[AiAssistant.Config]]:
    """
    ...
    """
        ...
    @classmethod
    def findBy(cls, field: str, value: Any, doNotProduceAll: bool=None) -> Union[Stream[AiAssistant.Config]]:
    """
    @param doNotProduceAll if true, will not populate cache and only return available cached instances. Will call
           `produceAll` if cache is empty or if Ann.cache.all is true & data has not previously been fetched.
    @return existing instances of this type that satisfy filter from data cache.
    """
        ...
    @classmethod
    def findByCacheKey(cls, key: str) -> Union[AiAssistant.Config]:
    """
    ...
    """
        ...
    @classmethod
    def forCacheKey(cls, key: str) -> Union[AiAssistant.Config]:
    """
    Returns cached instance by key, with secrets removed.
    """
        ...
    def getCached(self) -> Union[AiAssistant.Config]:
    """
    ...
    """
        ...
    def refreshCache(self) -> Union[AiAssistant.Config]:
    """
    ...
    """
        ...
    @classmethod
    def produce(cls, key: str) -> Union[AiAssistant.Config]:
    """
    Should produce an entry for the cache key. This method should not be called directly.
    """
        ...
    @classmethod
    def produceAll(cls) -> Union[Map[str, AiAssistant.Config]]:
    """
    ...
    """
        ...
    @classmethod
    def doProduceAll(cls) -> Union[Map[str, AiAssistant.Config]]:
    """
    ...
    """
        ...
    def getConfig(self) -> AiAssistant.Config:
    """
    ...
    """
        ...
    def getSecret(self) -> AiAssistant.Config:
    """
    ...
    """
        ...
    @classmethod
    def forConfigKey(cls, configKey: str) -> Union[AiAssistant.Config]:
    """
    ...
    """
        ...
    @classmethod
    def listConfigs(cls, parallel: bool=None, filter: Callable[[str], bool]=None) -> Union[Stream[AiAssistant.Config]]:
    """
    @param
    ...
    """
        ...
    @overload
    def setConfigValues(self, from_: AiAssistant.Config, override: str=None) -> None:
    """
    ...
    """
        ...
    @overload
    def setSecretValues(self, from_: AiAssistant.Config, override: str=None) -> None:
    """
    ...
    """
        ...
    @classmethod
    def loadConfigAndSecret(cls, configKey: str) -> Union[AiAssistant.Config]:
    """
    ...
    """
        ...
    def removeSecrets(self) -> Union[AiAssistant.Config]:
    """
    @return this config without any secret values.
    """
        ...
    def removeNonSecrets(self) -> Union[AiAssistant.Config]:
    """
    @return this config with only secret values.
    """
        ...
    def validate(self) -> AiAssistant.Config:
    """
