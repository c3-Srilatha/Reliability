...
from c3.platform.AzureServiceBusAuthorizationKeysFields import AzureServiceBusAuthorizationKeysFields
...
from c3.platform.AzureSharedAccessAuthorizationRuleFields import AzureSharedAccessAuthorizationRuleFields
...
# Python definitions for the C3 type AzureServiceBusNamespaceAuthorizationRule


class AzureServiceBusNamespaceAuthorizationRule(AzureSharedAccessAuthorizationRuleResource[AzureServiceBusNamespace, AzureServiceBusAuthorizationKeysFields], AzureSharedAccessAuthorizationRuleFields):
    """
    @remarks this represents a made instance of AzureServiceBusNamespaceAuthorizationRule
    """
    ...
    @overload
    @classmethod
    def fromString(cls, s: str) -> Union[AzureServiceBusNamespaceAuthorizationRule]:
    """
    ...
    @overload
    @classmethod
    def fromString(cls, s: str, failIfInvalid: bool=None) -> Union[AzureServiceBusNamespaceAuthorizationRule]:
    """
    Constructs Cloud Resource instance with reference fields and credentials based on provided Cloud Reference string.
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[AzureServiceBusNamespaceAuthorizationRule]:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> AzureServiceBusNamespaceAuthorizationRule:
    """
    ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> AzureServiceBusNamespaceAuthorizationRule:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> AzureServiceBusNamespaceAuthorizationRule:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> AzureServiceBusNamespaceAuthorizationRule:
    """
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[AzureServiceBusNamespaceAuthorizationRule]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[AzureServiceBusNamespaceAuthorizationRule]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[AzureServiceBusNamespaceAuthorizationRule]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[AzureServiceBusNamespaceAuthorizationRule]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> AzureServiceBusNamespaceAuthorizationRule:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> AzureServiceBusNamespaceAuthorizationRule:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> AzureServiceBusNamespaceAuthorizationRule:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[AzureServiceBusNamespaceAuthorizationRule]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[AzureServiceBusNamespaceAuthorizationRule]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> AzureServiceBusNamespaceAuthorizationRule:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> AzureServiceBusNamespaceAuthorizationRule:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> AzureServiceBusNamespaceAuthorizationRule:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> AzureServiceBusNamespaceAuthorizationRule:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> AzureServiceBusNamespaceAuthorizationRule:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> AzureServiceBusNamespaceAuthorizationRule:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> AzureServiceBusNamespaceAuthorizationRule:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> AzureServiceBusNamespaceAuthorizationRule:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> AzureServiceBusNamespaceAuthorizationRule:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> AzureServiceBusNamespaceAuthorizationRule:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> AzureServiceBusNamespaceAuthorizationRule:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> AzureServiceBusNamespaceAuthorizationRule:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> AzureServiceBusNamespaceAuthorizationRule:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> AzureServiceBusNamespaceAuthorizationRule:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> AzureServiceBusNamespaceAuthorizationRule:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> AzureServiceBusNamespaceAuthorizationRule:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> AzureServiceBusNamespaceAuthorizationRule:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> AzureServiceBusNamespaceAuthorizationRule:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> AzureServiceBusNamespaceAuthorizationRule:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> AzureServiceBusNamespaceAuthorizationRule:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> AzureServiceBusNamespaceAuthorizationRule:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> AzureServiceBusNamespaceAuthorizationRule:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> AzureServiceBusNamespaceAuthorizationRule:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> AzureServiceBusNamespaceAuthorizationRule:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> AzureServiceBusNamespaceAuthorizationRule:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> AzureServiceBusNamespaceAuthorizationRule:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> AzureServiceBusNamespaceAuthorizationRule:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> AzureServiceBusNamespaceAuthorizationRule:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[AzureServiceBusNamespaceAuthorizationRule]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[AzureServiceBusNamespaceAuthorizationRule]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[AzureServiceBusNamespaceAuthorizationRule]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[AzureServiceBusNamespaceAuthorizationRule]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[AzureServiceBusNamespaceAuthorizationRule]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, AzureServiceBusNamespaceAuthorizationRule]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, AzureServiceBusNamespaceAuthorizationRule]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[AzureServiceBusNamespaceAuthorizationRule]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[AzureServiceBusNamespaceAuthorizationRule]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> AzureServiceBusNamespaceAuthorizationRule:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> AzureServiceBusNamespaceAuthorizationRule:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> AzureServiceBusNamespaceAuthorizationRule:
    """
    ...
    """
        ...
    def afterMake(self) -> AzureServiceBusNamespaceAuthorizationRule:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> AzureServiceBusNamespaceAuthorizationRule:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[AzureServiceBusNamespaceAuthorizationRule]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> AzureServiceBusNamespaceAuthorizationRule:
    """
    ...
    """
        ...
    @classmethod
    def forId(cls, id: str, failIfMissing: bool=None) -> Union[AzureServiceBusNamespaceAuthorizationRule]:
    """
    Find Cloud Resource in Cloud Provider based on provided C3 canonical identifier.
    """
        ...
    @classmethod
    def fromClusterId(cls, clusterId: str, env: str, app: str, func: str, role: str=None, seq: str=None, subseq: str=None) -> AzureServiceBusNamespaceAuthorizationRule:
    """
    Construct a cloud ID from a cluster ID
    """
        ...
    @classmethod
    def fromEnvId(cls, envId: str, app: str, func: str, role: str=None, seq: str=None, subseq: str=None) -> AzureServiceBusNamespaceAuthorizationRule:
    """
    ...
    """
        ...
    @classmethod
    def fromAppId(cls, appId: str, func: str, role: str=None, seq: str=None, subseq: str=None) -> AzureServiceBusNamespaceAuthorizationRule:
    """
    ...
    """
        ...
    def withDefaultId(self) -> AzureServiceBusNamespaceAuthorizationRule:
    """
    Populate default values for all uninitialized Cloud Identifier fields in this Cloud Resource.
    """
        ...
    def sanitize(self) -> AzureServiceBusNamespaceAuthorizationRule:
    """
    ...
    """
        ...
    @classmethod
    def fromId(cls, id: str, failIfInvalid: bool=None) -> AzureServiceBusNamespaceAuthorizationRule:
    """
    ...
    """
        ...
    @classmethod
    def fromCloudId(cls, id: CloudId, failIfInvalid: bool=None) -> AzureServiceBusNamespaceAuthorizationRule:
    """
    ...
    """
        ...
    @classmethod
    def fromCloudRef(cls, ref: CloudRef, failIfInvalid: bool=None) -> AzureServiceBusNamespaceAuthorizationRule:
    """
    Constructs Cloud Resource instance with reference fields and credentials based on provided Cloud Reference.
    """
        ...
    @classmethod
    def fromCloudFunc(cls, func: str, role: str=None, seq: str=None) -> AzureServiceBusNamespaceAuthorizationRule:
    """
    Constructs Cloud Resource instance based on provided Cloud Func component and optional role.
    """
        ...
    @classmethod
    def fromResourceId(cls, resourceId: str) -> AzureServiceBusNamespaceAuthorizationRule:
    """
    Constructs Cloud Resource instance based on provided Cloud Resource Id.
    """
        ...
    @classmethod
    def fromResourceSecondaryId(cls, resourceSecondaryId: str) -> AzureServiceBusNamespaceAuthorizationRule:
    """
    Constructs Cloud Resource instance based on provided Cloud Resource Secondary Id and available Cloud Configuration.
    """
        ...
    @classmethod
    def fromResourceName(cls, name: str) -> AzureServiceBusNamespaceAuthorizationRule:
    """
    Constructs Cloud Resource instance based on provided Cloud Resource Name and available Cloud Configuration.
    """
        ...
    @classmethod
    def fromReferenceField(cls, fieldName: str, value: str, failIfInvalid: bool=None) -> AzureServiceBusNamespaceAuthorizationRule:
    """
    ...
    """
        ...
    def fromConfigTemplate(self, spec: CloudResourceOperationSpec=None) -> AzureServiceBusNamespaceAuthorizationRule:
    """
    ...
    """
        ...
    def withDefaultConfig(self, spec: CloudResourceOperationSpec=None) -> AzureServiceBusNamespaceAuthorizationRule:
    """
    ...
    """
        ...
    def upsertResource(self, spec: CloudResourceOperationSpec=None) -> AzureServiceBusNamespaceAuthorizationRule:
    """
    Create or update Cloud Resource.
    """
        ...
    def upsertWithDependencies(self, spec: CloudResourceOperationSpec=None) -> AzureServiceBusNamespaceAuthorizationRule:
    """
    ...
    """
        ...
    @classmethod
    def allCached(cls, doNotProduceAll: bool=None) -> Union[Stream[AzureServiceBusNamespaceAuthorizationRule]]:
    """
    ...
    """
        ...
    @classmethod
    def find(cls, filter: str=None, doNotProduceAll: bool=None) -> Union[Stream[AzureServiceBusNamespaceAuthorizationRule]]:
    """
    ...
    """
        ...
    @classmethod
    def findBy(cls, field: str, value: Any, doNotProduceAll: bool=None) -> Union[Stream[AzureServiceBusNamespaceAuthorizationRule]]:
    """
    @param doNotProduceAll if true, will not populate cache and only return available cached instances. Will call
           `produceAll` if cache is empty or if Ann.cache.all is true & data has not previously been fetched.
    @return existing instances of this type that satisfy filter from data cache.
    """
        ...
    @classmethod
    def findByCacheKey(cls, key: str) -> Union[AzureServiceBusNamespaceAuthorizationRule]:
    """
    ...
    """
        ...
    @classmethod
    def forCacheKey(cls, key: str) -> Union[AzureServiceBusNamespaceAuthorizationRule]:
    """
    Returns cached instance by key, with secrets removed.
    """
        ...
    def getCached(self) -> Union[AzureServiceBusNamespaceAuthorizationRule]:
    """
    This method on any CloudResource is not supported! Use CloudResource.for* or other methods instead.
    """
        ...
    def refreshCache(self) -> Union[AzureServiceBusNamespaceAuthorizationRule]:
    """
    ...
    """
        ...
    @classmethod
    def produce(cls, key: str) -> Union[AzureServiceBusNamespaceAuthorizationRule]:
    """
    Should produce an entry for the cache key. This method should not be called directly.
    """
        ...
    @classmethod
    def produceAll(cls) -> Union[Map[str, AzureServiceBusNamespaceAuthorizationRule]]:
    """
    ...
    """
        ...
    @classmethod
    def doProduceAll(cls) -> Union[Map[str, AzureServiceBusNamespaceAuthorizationRule]]:
    """
    ...
    """
        ...
    def getConfig(self) -> AzureServiceBusNamespaceAuthorizationRule:
    """
    This method on any CloudResource is not supported! Use CloudResource.for* or other methods instead.
    """
        ...
    ...
    """
        ...
    def getSecret(self) -> AzureServiceBusNamespaceAuthorizationRule:
    """
    ...
    """
        ...
    @classmethod
    def forConfigKey(cls, configKey: str) -> Union[AzureServiceBusNamespaceAuthorizationRule]:
    """
    ...
    """
        ...
    @classmethod
    def listConfigs(cls, parallel: bool=None, filter: Callable[[str], bool]=None) -> Union[Stream[AzureServiceBusNamespaceAuthorizationRule]]:
    """
    @param
    ...
    """
        ...
    @overload
    def setConfigValues(self, from_: AzureServiceBusNamespaceAuthorizationRule, override: str=None) -> None:
    """
    ...
    """
        ...
    @overload
    def setSecretValues(self, from_: AzureServiceBusNamespaceAuthorizationRule, override: str=None) -> None:
    """
    ...
    """
        ...
    @classmethod
    def loadConfigAndSecret(cls, configKey: str) -> Union[AzureServiceBusNamespaceAuthorizationRule]:
    """
    ...
    """
        ...
    def removeSecrets(self) -> Union[AzureServiceBusNamespaceAuthorizationRule]:
    """
    @return this config without any secret values.
    """
        ...
    def removeNonSecrets(self) -> Union[AzureServiceBusNamespaceAuthorizationRule]:
    """
    @return this config with only secret values.
    """
        ...
    def validate(self) -> AzureServiceBusNamespaceAuthorizationRule:
    """
    ...
    """
        ...
    def withIdentity(self, resource: CloudResource=None, spec: CloudResourceOperationSpec=None) -> AzureServiceBusNamespaceAuthorizationRule:
    """
    ...
    """
        ...
    def mergeId(self, other: CloudResource=None) -> AzureServiceBusNamespaceAuthorizationRule:
    """
    ...
    """
        ...
    @classmethod
    def fromCloudRole(cls, role: str, seq: str=None) -> AzureServiceBusNamespaceAuthorizationRule:
    """
    Constructs Cloud Resource instance of this type with reference fields and credentials based on provided cloud role.
    """
        ...
    @classmethod
    def fromCloudSeq(cls, seq: str) -> AzureServiceBusNamespaceAuthorizationRule:
    """
    Constructs Cloud Resource instance of this type with reference fields and credentials based on provided cloud seq.
    """
        ...
    @classmethod
    def fromTags(cls, tags: Array[CloudTag]) -> Union[AzureServiceBusNamespaceAuthorizationRule]:
    """
    ...
    """
        ...
    @classmethod
    def forCloudId(cls, id: CloudId, failIfMissing: bool=None) -> Union[AzureServiceBusNamespaceAuthorizationRule]:
    """
    ...
    """
        ...
    @classmethod
    def forCloudFunc(cls, func: str, role: str=None, failIfMissing: bool=None) -> AzureServiceBusNamespaceAuthorizationRule:
    """
    Find Cloud Resource based on provided cloud func component and optional role.
    """
        ...
    @classmethod
    def forCloudRole(cls, role: str, failIfMissing: bool=None) -> AzureServiceBusNamespaceAuthorizationRule:
    """
    Find Cloud Resource of this type based on provided cloud role component.
    """
        ...
    @classmethod
    def forResourceId(cls, resourceId: str, failIfMissing: bool=None) -> Union[AzureServiceBusNamespaceAuthorizationRule]:
    """
    Find Cloud Resource in the Cloud Provider by provided resource name.
    """
        ...
    @classmethod
    def forResourceSecondaryId(cls, resourceId: str, failIfMissing: bool=None) -> Union[AzureServiceBusNamespaceAuthorizationRule]:
    """
    Find Cloud Resource in the Cloud Provider by provided resource name.
    """
        ...
    ...
    """
        ...
    @classmethod
    def forResourceName(cls, resourceName: str, failIfMissing: bool=None) -> Union[AzureServiceBusNamespaceAuthorizationRule]:
    """
    Find Cloud Resource in the Cloud Provider by provided resource name.
    """
        ...
    @classmethod
    def findResource(cls, reference: str, failIfMissing: bool=None) -> Union[AzureServiceBusNamespaceAuthorizationRule]:
    """
    Find Cloud Resource in the Cloud Provider by provided {@link CloudRef} string.
    """
        ...
    def getResource(self) -> Union[AzureServiceBusNamespaceAuthorizationRule]:
    """
    Find Cloud Resource in the Cloud Provider by provided #resourceId, #resourceSecondaryId, #resourceName or #tags
    (in that order).
    """
        ...
    def ensureResource(self) -> AzureServiceBusNamespaceAuthorizationRule:
    """
    Checks that the resource is persisted. If not, upserts the resource, to ensure that the resource exists.
    """
        ...
    @classmethod
    def listResourcesBySubtype(cls, spec: CloudListResourcesSpec=None) -> Map[str, CloudListResourcesResult[AzureServiceBusNamespaceAuthorizationRule]]:
    """
    ...
    """
        ...
    @classmethod
    def listResources(cls, spec: CloudListResourcesSpec=None) -> CloudListResourcesResult[AzureServiceBusNamespaceAuthorizationRule]:
    """
    ...
    """
        ...
    @classmethod
    def listResourcesForTags(cls, *keyValuePairs: Array[str]) -> CloudListResourcesResult[AzureServiceBusNamespaceAuthorizationRule]:
    """
    List all Cloud Resources that satisfies the given spec.
    ...
    """
        ...
    @classmethod
    def listResourcesForClusterId(cls, clusterId: str, cloudIdRole: str=None, spec: CloudListResourcesSpec=None) -> CloudListResourcesResult[AzureServiceBusNamespaceAuthorizationRule]:
    """
    List all Cloud Resources that satisfies the given spec.
    ...
    """
        ...
    @classmethod
    def listResourcesForEnvId(cls, envId: str, cloudIdRole: str=None, spec: CloudListResourcesSpec=None) -> CloudListResourcesResult[AzureServiceBusNamespaceAuthorizationRule]:
    """
    List all Cloud Resources that satisfies the given spec.
    ...
    """
        ...
    @classmethod
    def listResourcesForAppId(cls, appId: str, cloudIdRole: str=None, spec: CloudListResourcesSpec=None) -> CloudListResourcesResult[AzureServiceBusNamespaceAuthorizationRule]:
    """
    List all Cloud Resources that satisfies the given spec.
    ...
    """
        ...
    def upsertDependencies(self, spec: CloudResourceOperationSpec=None) -> AzureServiceBusNamespaceAuthorizationRule:
    """
    ...
    """
        ...
    def waitForCreate(self, spec: WaitSpec=None) -> Union[AzureServiceBusNamespaceAuthorizationRule]:
    """
    ...
    """
        ...
    @classmethod
    def tagResourcesBatch(cls, resources: Array[AzureServiceBusNamespaceAuthorizationRule], tags: Array[CloudTag]) -> Union[Map[str, Error]]:
    """
    ...
    """
        ...
    @classmethod
    def untagResourcesBatch(cls, resources: Array[AzureServiceBusNamespaceAuthorizationRule], tagKeys: Array[str]) -> Union[Map[str, Error]]:
    """
    ...
    """
        ...
    def waitForOk(self, spec: WaitSpec=None) -> Union[AzureServiceBusNamespaceAuthorizationRule]:
    """
    ...
    """
        ...
    def waitForState(self, state: str='AVAILABLE', spec: WaitSpec=None) -> Union[AzureServiceBusNamespaceAuthorizationRule]:
    """
    ...
    """
        ...
    def setFullyConfigured(self, fullyConfigured: bool=None, override: str=None) -> AzureServiceBusNamespaceAuthorizationRule:
    """
    ...
    """
        ...
    def afterCreate(self, input: AzureServiceBusNamespaceAuthorizationRule=None) -> AzureServiceBusNamespaceAuthorizationRule:
    """
    ...
    """
        ...
    def beforeCreate(self) -> AzureServiceBusNamespaceAuthorizationRule:
    """
    Optional callback to alter resource before creating it.
    """
        ...
    def beforeUpdate(self) -> AzureServiceBusNamespaceAuthorizationRule:
    """
    Optional callback to alter resource before updating it.
    """
        ...
    def beforeDestroy(self) -> AzureServiceBusNamespaceAuthorizationRule:
    """
    ...
    """
        ...
    def withoutNonModifiableFields(self) -> AzureServiceBusNamespaceAuthorizationRule:
    """
    ...
    """
        ...
    @classmethod
    def fromImpl(cls, impl: Any=None) -> Union[AzureServiceBusNamespaceAuthorizationRule]:
    """
    ...
    """
        ...
    def keys(self) -> Union[AzureServiceBusAuthorizationKeysFields]:
    """
    Retrieves the key for this authorization rule.
    """
        ...
    def regenerateKey(self, keyType: str=None) -> Union[AzureServiceBusAuthorizationKeysFields]:
    """
    ...
    """
        ...
    @classmethod
    def fromJava(cls, javaObj: Any) -> Union[AzureSharedAccessAuthorizationRuleFields]:
        ...
