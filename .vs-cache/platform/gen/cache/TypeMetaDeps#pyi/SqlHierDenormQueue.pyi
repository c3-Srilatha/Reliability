...
from c3.platform.HierDenormQueueEntry import HierDenormQueueEntry
from c3.platform.LockedEntries import LockedEntries

# Python definitions for the C3 type SqlHierDenormQueue


class SqlHierDenormQueue(HierDenormQueue, Value):
    """
    Invalidation queue for hierarchy denorm processing.
    
    @remarks this represents a made instance of SqlHierDenormQueue
    """
    def __init__(self) -> None: ...

    @classmethod
    def compute(cls, targetType: Type, entries: Array[HierDenormQueueEntry]) -> None:
    """
    ...
    """
        ...
    @classmethod
    def find(cls, spec: InvalidationQueue.FindSpec=None) -> Union[Array[HierDenormQueueEntry]]:
    """
    ...
    """
        ...
    @classmethod
    def findStream(cls, spec: InvalidationQueue.FindStreamSpec=None) -> Union[Stream[HierDenormQueueEntry]]:
    """
    ...
    """
        ...
    @classmethod
    def clearEntries(cls, entries: Array[HierDenormQueueEntry]) -> None:
    """
