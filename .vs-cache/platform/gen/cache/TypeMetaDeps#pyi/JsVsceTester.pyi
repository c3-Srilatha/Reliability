...
# Python definitions for the C3 type JsVsceTester


class JsVsceTester(Tester):
    """
    @remarks this represents a made instance of JsVsceTester
    """
    ...
    vscodeVersion: Optional[str]=None
    """
    ...
    useInsiders: Optional[bool]=None
    """
    ...
    """
    def __init__(self, testRunner: Optional[TestRunner]=None, state: Optional[str]=None, results: Optional[Array[TestSuiteResult]]=None, engine: Optional[Action.Engine]=None, vscodeVersion: Optional[str]=None, useInsiders: Optional[bool]=None) -> None: ...

    @overload
    @classmethod
    def make(cls) -> JsVsceTester:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> JsVsceTester:
    """
    ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> JsVsceTester:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> JsVsceTester:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> JsVsceTester:
    """
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[JsVsceTester]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[JsVsceTester]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[JsVsceTester]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[JsVsceTester]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> JsVsceTester:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> JsVsceTester:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> JsVsceTester:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[JsVsceTester]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[JsVsceTester]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> JsVsceTester:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> JsVsceTester:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> JsVsceTester:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> JsVsceTester:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> JsVsceTester:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> JsVsceTester:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> JsVsceTester:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> JsVsceTester:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> JsVsceTester:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> JsVsceTester:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> JsVsceTester:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> JsVsceTester:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> JsVsceTester:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> JsVsceTester:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> JsVsceTester:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> JsVsceTester:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> JsVsceTester:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> JsVsceTester:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> JsVsceTester:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> JsVsceTester:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> JsVsceTester:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> JsVsceTester:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> JsVsceTester:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> JsVsceTester:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> JsVsceTester:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> JsVsceTester:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> JsVsceTester:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> JsVsceTester:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[JsVsceTester]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[JsVsceTester]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[JsVsceTester]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[JsVsceTester]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[JsVsceTester]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, JsVsceTester]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, JsVsceTester]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[JsVsceTester]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[JsVsceTester]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> JsVsceTester:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> JsVsceTester:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> JsVsceTester:
    """
    ...
    """
        ...
    def afterMake(self) -> JsVsceTester:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> JsVsceTester:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[JsVsceTester]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> JsVsceTester:
    """
    ...
    """
        ...
    @overload
    def setField(self, field: str, value: Any, doNotConvert: bool=None) -> JsVsceTester:
    """
    ...
    """
        ...
    @overload
    def setField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> JsVsceTester:
    """
    Sets the mutable field value. The name must correspond to an existing field defined on this type or its mixins.
    The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    @classmethod
    def forPathAndEngine(cls, path: str, engine: str) -> JsVsceTester:
    """
    ...
    """
        ...
    @classmethod
    def forNameAndEngine(cls, testName: str, engine: str) -> JsVsceTester:
    """
    ...
    """
        ...
    @classmethod
    def forEngine(cls, engine: str, deep: bool=None) -> JsVsceTester:
    """
    ...
    """
        ...
    def run(self, spec: TesterRunSpec=None) -> JsVsceTester:
    """
    ...
    """
        ...
    @classmethod
    def runtimeRoot(cls) -> str:
    """
    Returns the path of runtime root.
    """
        ...
    @classmethod
    def initTestSession(cls, testSuites: Array[str], spec: TesterRunSpec) -> Union[Promise[]]:
    """
    ...
    """
        ...
    @classmethod
    def runTestSession(cls, testSuites: Array[str]) -> Union[Promise[]]:
    """
    Run the given test suites.
    """
        ...
    @classmethod
    def afterTestSession(cls, testSuites: Array[str], spec: TesterRunSpec) -> Union[Promise[Map[str, TestSuiteResult]]]:
    """
