...
from c3.platform.CalcFieldsQueueEntry import CalcFieldsQueueEntry
...
# Python definitions for the C3 type CalcFieldsQueue


class CalcFieldsQueue(InvalidationQueue[CalcFieldsQueueEntry], MergeableInvalidationQueue[CalcFieldsQueueEntry], Value):
    """
    ...
    @classmethod
    def compute(cls, targetType: Type, entries: Array[CalcFieldsQueueEntry]) -> None:
    """
    ...
    """
        ...
    @classmethod
    def find(cls, spec: InvalidationQueue.FindSpec=None) -> Union[Array[CalcFieldsQueueEntry]]:
    """
    ...
    """
        ...
    @classmethod
    def findStream(cls, spec: InvalidationQueue.FindStreamSpec=None) -> Union[Stream[CalcFieldsQueueEntry]]:
    """
    ...
    """
        ...
    @classmethod
    def clearEntries(cls, entries: Array[CalcFieldsQueueEntry]) -> None:
    """
    ...
    """
        ...
    @classmethod
    def mergeContexts(cls, targetType: Type=None, entries: Array[CalcFieldsQueueEntry]=None) -> Union[Array[CalcFieldsQueueEntry]]:
    """
    ...
    """
        ...
    @classmethod
    def rescheduleByType(cls, thresholdPct: int='50', batchSize: int='1000') -> None:
    """
