...
# Python definitions for the C3 type SqlSourceStatusQueue


class SqlSourceStatusQueue(SourceStatusQueue, Value):
    """
    Invalidation queue for {@link SourceStatus}
    
    @remarks this represents a made instance of SqlSourceStatusQueue
    """
