...
# Python definitions for the C3 type DynamoDBTableDescription


class DynamoDBTableDescription(AwsResource):
    """
    @remarks this represents a made instance of DynamoDBTableDescription
    """
    ...
    """
    Status of the table whether it is ACTIVE or not
    """
    ...
    provisionedReadCapacity: Optional[int]=None
    """
    Currently provisioned read capacity units
    """

    provisionedWriteCapacity: Optional[int]=None
    """
    Currently provisioned write capacity units
    """

    itemCount: Optional[int]=None
    """
    Estimate of number of items in the table
    """

    size: Optional[int]=None
    """
    Estimate of the table size
    """

    attributeDefinitions: Optional[Map[str, str]]=None
    """
    A map of attributes that describe the key schema for the table and indexes.
    """

    keySchemas: Optional[Map[str, str]]=None
    """
    Specifies the key schemas that make up the primary key for the table. The key value pair in KeySchema must
    also be defined in {@link DynamoDBTableDescription#attributeDefinitions} when creating the dynamoDB table.
    Minimum number of keySchemas is 1 item. Maximum number of keySchemas is 2 items.
    """

    partitionsByThroughput: Optional[int]=None
    """
    Calculates the estimated number of partitions based on RCU, WCU
    Remember once the partitions are increased internally by dynamo db, it never reduces the number of partitions
    Hence this method only provides an estimate of the number of partitions based on the current
    RCU & current WCU. It is possible that the number of partitions are higher than what is provided by this api
    """

    partitionsBySize: Optional[int]=None
    """
    Calculates the estimated number of partitions based on the estimated table size
    Remember once the partitions are increased internally by dynamo db, it never reduces the number of partitions
    Hence this method only provides an estimate of the number of partitions based on the current
    table size. It is possible that the number of partitions are higher than what is provided by this api
    """
    def __init__(self, id: Optional[str]=None, cluster: Optional[str]=None, env: Optional[str]=None, app: Optional[str]=None, func: Optional[str]=None, role: Optional[str]=None, seq: Optional[str]=None, subseq: Optional[str]=None, resourceId: Optional[str]=None, resourceSecondaryId: Optional[str]=None, resourceName: Optional[str]=None, resourceGroupName: Optional[str]=None, fullyConfigured: Optional[bool]=None, resourceNamespace: Optional[str]=None, external: Optional[bool]=None, credentials: Optional[AwsCredentials]=None, hasGeneratedResourceName: Optional[bool]=None, hasGeneratedResourceSecondaryId: Optional[bool]=None, configOverride: Optional[str]=None, secretOverride: Optional[str]=None, issues: Optional[Array[str]]=None, nativeMetricByName: Optional[Map[str, str]]=None, tags: Optional[Array[CloudTag]]=None, description: Optional[str]=None, parentResource: Optional[CloudResource]=None, status: Optional[str]=None, creationTime: Optional[datetime]=None, provisionedReadCapacity: Optional[int]=None, provisionedWriteCapacity: Optional[int]=None, itemCount: Optional[int]=None, size: Optional[int]=None, attributeDefinitions: Optional[Map[str, str]]=None, keySchemas: Optional[Map[str, str]]=None, partitionsByThroughput: Optional[int]=None, partitionsBySize: Optional[int]=None) -> None: ...
    ...
    @overload
    @classmethod
    def fromString(cls, s: str) -> Union[DynamoDBTableDescription]:
    """
    ...
    @overload
    @classmethod
    def fromString(cls, s: str, failIfInvalid: bool=None) -> Union[DynamoDBTableDescription]:
    """
    Constructs Cloud Resource instance with reference fields and credentials based on provided Cloud Reference string.
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[DynamoDBTableDescription]:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> DynamoDBTableDescription:
    """
    ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> DynamoDBTableDescription:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> DynamoDBTableDescription:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> DynamoDBTableDescription:
    """
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[DynamoDBTableDescription]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[DynamoDBTableDescription]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[DynamoDBTableDescription]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[DynamoDBTableDescription]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> DynamoDBTableDescription:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> DynamoDBTableDescription:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> DynamoDBTableDescription:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[DynamoDBTableDescription]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[DynamoDBTableDescription]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> DynamoDBTableDescription:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> DynamoDBTableDescription:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> DynamoDBTableDescription:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> DynamoDBTableDescription:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> DynamoDBTableDescription:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> DynamoDBTableDescription:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> DynamoDBTableDescription:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> DynamoDBTableDescription:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> DynamoDBTableDescription:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> DynamoDBTableDescription:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> DynamoDBTableDescription:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> DynamoDBTableDescription:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> DynamoDBTableDescription:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> DynamoDBTableDescription:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> DynamoDBTableDescription:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> DynamoDBTableDescription:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> DynamoDBTableDescription:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> DynamoDBTableDescription:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> DynamoDBTableDescription:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> DynamoDBTableDescription:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> DynamoDBTableDescription:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> DynamoDBTableDescription:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> DynamoDBTableDescription:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> DynamoDBTableDescription:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> DynamoDBTableDescription:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> DynamoDBTableDescription:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> DynamoDBTableDescription:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> DynamoDBTableDescription:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[DynamoDBTableDescription]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[DynamoDBTableDescription]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[DynamoDBTableDescription]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[DynamoDBTableDescription]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[DynamoDBTableDescription]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, DynamoDBTableDescription]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, DynamoDBTableDescription]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[DynamoDBTableDescription]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[DynamoDBTableDescription]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> DynamoDBTableDescription:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> DynamoDBTableDescription:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> DynamoDBTableDescription:
    """
    ...
    """
        ...
    def afterMake(self) -> DynamoDBTableDescription:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> DynamoDBTableDescription:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[DynamoDBTableDescription]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> DynamoDBTableDescription:
    """
    ...
    """
        ...
    @classmethod
    def forId(cls, id: str, failIfMissing: bool=None) -> Union[DynamoDBTableDescription]:
    """
    Find Cloud Resource in Cloud Provider based on provided C3 canonical identifier.
    """
        ...
    @classmethod
    def fromClusterId(cls, clusterId: str, env: str, app: str, func: str, role: str=None, seq: str=None, subseq: str=None) -> DynamoDBTableDescription:
    """
    Construct a cloud ID from a cluster ID
    """
        ...
    @classmethod
    def fromEnvId(cls, envId: str, app: str, func: str, role: str=None, seq: str=None, subseq: str=None) -> DynamoDBTableDescription:
    """
    ...
    """
        ...
    @classmethod
    def fromAppId(cls, appId: str, func: str, role: str=None, seq: str=None, subseq: str=None) -> DynamoDBTableDescription:
    """
    ...
    """
        ...
    @classmethod
    def fromId(cls, id: str, failIfInvalid: bool=None) -> DynamoDBTableDescription:
    """
    ...
    """
        ...
    @classmethod
    def fromCloudId(cls, id: CloudId, failIfInvalid: bool=None) -> DynamoDBTableDescription:
    """
    ...
    """
        ...
    def fromConfigTemplate(self, spec: CloudResourceOperationSpec=None) -> DynamoDBTableDescription:
    """
    ...
    """
        ...
    def withDefaultConfig(self, spec: CloudResourceOperationSpec=None) -> DynamoDBTableDescription:
    """
    ...
    """
        ...
    def upsertResource(self, spec: CloudResourceOperationSpec=None) -> DynamoDBTableDescription:
    """
    Create or update Cloud Resource.
    """
        ...
    def upsertWithDependencies(self, spec: CloudResourceOperationSpec=None) -> DynamoDBTableDescription:
    """
    ...
    """
        ...
    @classmethod
    def allCached(cls, doNotProduceAll: bool=None) -> Union[Stream[DynamoDBTableDescription]]:
    """
    ...
    """
        ...
    @classmethod
    def find(cls, filter: str=None, doNotProduceAll: bool=None) -> Union[Stream[DynamoDBTableDescription]]:
    """
    ...
    """
        ...
    @classmethod
    def findBy(cls, field: str, value: Any, doNotProduceAll: bool=None) -> Union[Stream[DynamoDBTableDescription]]:
    """
    @param doNotProduceAll if true, will not populate cache and only return available cached instances. Will call
           `produceAll` if cache is empty or if Ann.cache.all is true & data has not previously been fetched.
    @return existing instances of this type that satisfy filter from data cache.
    """
        ...
    @classmethod
    def findByCacheKey(cls, key: str) -> Union[DynamoDBTableDescription]:
    """
    ...
    """
        ...
    @classmethod
    def forCacheKey(cls, key: str) -> Union[DynamoDBTableDescription]:
    """
    Returns cached instance by key, with secrets removed.
    """
        ...
    def getCached(self) -> Union[DynamoDBTableDescription]:
    """
    This method on any CloudResource is not supported! Use CloudResource.for* or other methods instead.
    """
        ...
    def refreshCache(self) -> Union[DynamoDBTableDescription]:
    """
    ...
    """
        ...
    @classmethod
    def produce(cls, key: str) -> Union[DynamoDBTableDescription]:
    """
    Should produce an entry for the cache key. This method should not be called directly.
    """
        ...
    @classmethod
    def produceAll(cls) -> Union[Map[str, DynamoDBTableDescription]]:
    """
    ...
    """
        ...
    @classmethod
    def doProduceAll(cls) -> Union[Map[str, DynamoDBTableDescription]]:
    """
    ...
    """
        ...
    def getConfig(self) -> DynamoDBTableDescription:
    """
    This method on any CloudResource is not supported! Use CloudResource.for* or other methods instead.
    """
        ...
    ...
    """
        ...
    def getSecret(self) -> DynamoDBTableDescription:
    """
    ...
    """
        ...
    @classmethod
    def forConfigKey(cls, configKey: str) -> Union[DynamoDBTableDescription]:
    """
    ...
    """
        ...
    @classmethod
    def listConfigs(cls, parallel: bool=None, filter: Callable[[str], bool]=None) -> Union[Stream[DynamoDBTableDescription]]:
    """
    @param
    ...
    """
        ...
    @overload
    def setConfigValues(self, from_: DynamoDBTableDescription, override: str=None) -> None:
    """
    ...
    """
        ...
    @overload
    def setSecretValues(self, from_: DynamoDBTableDescription, override: str=None) -> None:
    """
    ...
    """
        ...
    @classmethod
    def loadConfigAndSecret(cls, configKey: str) -> Union[DynamoDBTableDescription]:
    """
    ...
    """
        ...
    def removeSecrets(self) -> Union[DynamoDBTableDescription]:
    """
    @return this config without any secret values.
    """
        ...
    def removeNonSecrets(self) -> Union[DynamoDBTableDescription]:
    """
    @return this config with only secret values.
    """
        ...
    def validate(self) -> DynamoDBTableDescription:
    """
    ...
    """
        ...
    def withIdentity(self, resource: CloudResource=None, spec: CloudResourceOperationSpec=None) -> DynamoDBTableDescription:
    """
    ...
    """
        ...
    def mergeId(self, other: CloudResource=None) -> DynamoDBTableDescription:
    """
    ...
    """
        ...
    @classmethod
    def forCloudId(cls, id: CloudId, failIfMissing: bool=None) -> Union[DynamoDBTableDescription]:
    """
    ...
    """
        ...
    @classmethod
    def forCloudFunc(cls, func: str, role: str=None, failIfMissing: bool=None) -> DynamoDBTableDescription:
    """
    Find Cloud Resource based on provided cloud func component and optional role.
    """
        ...
    @classmethod
    def forCloudRole(cls, role: str, failIfMissing: bool=None) -> DynamoDBTableDescription:
    """
    Find Cloud Resource of this type based on provided cloud role component.
    """
        ...
    @classmethod
    def forResourceId(cls, resourceId: str, failIfMissing: bool=None) -> Union[DynamoDBTableDescription]:
    """
    Find Cloud Resource in the Cloud Provider by provided resource name.
    """
        ...
    @classmethod
    def forResourceSecondaryId(cls, resourceId: str, failIfMissing: bool=None) -> Union[DynamoDBTableDescription]:
    """
    Find Cloud Resource in the Cloud Provider by provided resource name.
    """
        ...
    ...
    """
        ...
    @classmethod
    def forResourceName(cls, resourceName: str, failIfMissing: bool=None) -> Union[DynamoDBTableDescription]:
    """
    Find Cloud Resource in the Cloud Provider by provided resource name.
    """
        ...
    @classmethod
    def findResource(cls, reference: str, failIfMissing: bool=None) -> Union[DynamoDBTableDescription]:
    """
    Find Cloud Resource in the Cloud Provider by provided {@link CloudRef} string.
    """
        ...
    def getResource(self) -> Union[DynamoDBTableDescription]:
    """
    Find Cloud Resource in the Cloud Provider by provided #resourceId, #resourceSecondaryId, #resourceName or #tags
    (in that order).
    """
        ...
    def ensureResource(self) -> DynamoDBTableDescription:
    """
    Checks that the resource is persisted. If not, upserts the resource, to ensure that the resource exists.
    """
        ...
    @classmethod
    def listResourcesBySubtype(cls, spec: CloudListResourcesSpec=None) -> Map[str, CloudListResourcesResult[DynamoDBTableDescription]]:
    """
    ...
    """
        ...
    @classmethod
    def listResources(cls, spec: CloudListResourcesSpec=None) -> CloudListResourcesResult[DynamoDBTableDescription]:
    """
    ...
    """
        ...
    @classmethod
    def listResourcesForTags(cls, *keyValuePairs: Array[str]) -> CloudListResourcesResult[DynamoDBTableDescription]:
    """
    List all Cloud Resources that satisfies the given spec.
    ...
    """
        ...
    @classmethod
    def listResourcesForClusterId(cls, clusterId: str, cloudIdRole: str=None, spec: CloudListResourcesSpec=None) -> CloudListResourcesResult[DynamoDBTableDescription]:
    """
    List all Cloud Resources that satisfies the given spec.
    ...
    """
        ...
    @classmethod
    def listResourcesForEnvId(cls, envId: str, cloudIdRole: str=None, spec: CloudListResourcesSpec=None) -> CloudListResourcesResult[DynamoDBTableDescription]:
    """
    List all Cloud Resources that satisfies the given spec.
    ...
    """
        ...
    @classmethod
    def listResourcesForAppId(cls, appId: str, cloudIdRole: str=None, spec: CloudListResourcesSpec=None) -> CloudListResourcesResult[DynamoDBTableDescription]:
    """
    List all Cloud Resources that satisfies the given spec.
    ...
    """
        ...
    def upsertDependencies(self, spec: CloudResourceOperationSpec=None) -> DynamoDBTableDescription:
    """
    ...
    """
        ...
    def waitForCreate(self, spec: WaitSpec=None) -> Union[DynamoDBTableDescription]:
    """
    ...
    """
        ...
    @classmethod
    def tagResourcesBatch(cls, resources: Array[DynamoDBTableDescription], tags: Array[CloudTag]) -> Union[Map[str, Error]]:
    """
    ...
    """
        ...
    @classmethod
    def untagResourcesBatch(cls, resources: Array[DynamoDBTableDescription], tagKeys: Array[str]) -> Union[Map[str, Error]]:
    """
    ...
    """
        ...
    def waitForOk(self, spec: WaitSpec=None) -> Union[DynamoDBTableDescription]:
    """
    ...
    """
        ...
    def waitForState(self, state: str='AVAILABLE', spec: WaitSpec=None) -> Union[DynamoDBTableDescription]:
    """
    ...
    """
        ...
    def setFullyConfigured(self, fullyConfigured: bool=None, override: str=None) -> DynamoDBTableDescription:
    """
    ...
    """
        ...
    def afterCreate(self, input: DynamoDBTableDescription=None) -> DynamoDBTableDescription:
    """
    ...
    """
        ...
    def beforeCreate(self) -> DynamoDBTableDescription:
    """
    Optional callback to alter resource before creating it.
    """
        ...
    def beforeUpdate(self) -> DynamoDBTableDescription:
    """
    Optional callback to alter resource before updating it.
    """
        ...
    def beforeDestroy(self) -> DynamoDBTableDescription:
    """
    ...
    """
        ...
    def withoutNonModifiableFields(self) -> DynamoDBTableDescription:
    """
    ...
    """
        ...
    def withResourceArn(self, resourceArn: str) -> Union[DynamoDBTableDescription]:
    """
