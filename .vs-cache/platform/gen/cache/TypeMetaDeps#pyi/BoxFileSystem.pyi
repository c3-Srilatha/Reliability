...
# Python definitions for the C3 type BoxFileSystem


class BoxFileSystem(DriveFileSystem[BoxFile], FileSystemConfigurable[BoxFsConfig]):
    """
    @remarks this represents a made instance of BoxFileSystem
    """
    def __init__(self) -> None: ...

    @classmethod
    def inst(cls) -> BoxFileSystem:
    """
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[BoxFileSystem]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[BoxFileSystem]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[BoxFileSystem]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[BoxFileSystem]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> BoxFileSystem:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> BoxFileSystem:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> BoxFileSystem:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[BoxFileSystem]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[BoxFileSystem]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> BoxFileSystem:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> BoxFileSystem:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> BoxFileSystem:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> BoxFileSystem:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> BoxFileSystem:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> BoxFileSystem:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> BoxFileSystem:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> BoxFileSystem:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> BoxFileSystem:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> BoxFileSystem:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> BoxFileSystem:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> BoxFileSystem:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> BoxFileSystem:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> BoxFileSystem:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> BoxFileSystem:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> BoxFileSystem:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> BoxFileSystem:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> BoxFileSystem:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> BoxFileSystem:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> BoxFileSystem:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> BoxFileSystem:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> BoxFileSystem:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> BoxFileSystem:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> BoxFileSystem:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> BoxFileSystem:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> BoxFileSystem:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> BoxFileSystem:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> BoxFileSystem:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[BoxFileSystem]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[BoxFileSystem]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[BoxFileSystem]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[BoxFileSystem]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[BoxFileSystem]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, BoxFileSystem]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, BoxFileSystem]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[BoxFileSystem]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[BoxFileSystem]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> BoxFileSystem:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> BoxFileSystem:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> BoxFileSystem:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> BoxFileSystem:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> BoxFileSystem:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> BoxFileSystem:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> BoxFileSystem:
    """
    ...
    """
        ...
    def afterMake(self) -> BoxFileSystem:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> BoxFileSystem:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[BoxFileSystem]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> BoxFileSystem:
    """
    ...
    def outputStream(self, file: DriveFile[DriveFileSystem]=None, spec: FileOperationSpec=None) -> Any:
        ...
    def config(self, secrets: bool=None) -> BoxFsConfig:
    """
