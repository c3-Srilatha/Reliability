...
# Python definitions for the C3 type JiraIssuePriority


class JiraIssuePriority():
    """
    Enum type that indicates the Jira issue priority.
    
    @remarks this represents a made instance of JiraIssuePriority
    """
    ...
    P4
    """
    def __init__(self, BLOCKER: Optional[int]=None, URGENT: Optional[int]=None, CRITICAL: Optional[int]=None, NICETOFIX: Optional[int]=None, MINOR: Optional[int]=None) -> None: ...
