...
# Python definitions for the C3 type SqlPiiQueue


class SqlPiiQueue(PiiQueue, Value):
    """
    Invalidation queue for PII event logging.
    
    @remarks this represents a made instance of SqlPiiQueue
    """
