...
from c3.platform.AwsVpc import AwsVpc
from c3.platform.Config import Config
from c3.platform.MapType import MapType
from c3.platform.AwsEmrStep import AwsEmrStep
...
from c3.platform.AwsEmrInstanceGroup import AwsEmrInstanceGroup
from c3.platform.EmrEndpointSpec import EmrEndpointSpec
...
from c3.platform.AwsEmrBootstrap import AwsEmrBootstrap
...
from c3.platform.MapBuilder import MapBuilder
from c3.platform.AwsKeyPair import AwsKeyPair
from c3.platform.Pair import Pair
from c3.platform.CloudId import CloudId
from c3.platform.File import File
from c3.platform.AwsIamInstanceProfile import AwsIamInstanceProfile
from c3.platform.SetBuilder import SetBuilder

# Python definitions for the C3 type AwsEmr


class AwsEmr(AwsResource, AwsVpcMember, AwsSubnetMember, AwsKeyPairMember, AwsIamRoleMember, AwsIamInstanceProfileMember, AwsSecurityGroupsMemberMaster, AwsSecurityGroupsMemberSlave, AwsSecurityGroupMemberService, DefaultInstance):
    """
    AWS Elastic MapReduce service proxy.
    
    @remarks this represents a made instance of AwsEmr
    """
    ...
    vpc: Optional[AwsVpc]
    """
    The id of the VPC the resource is in.
    """

    subnet: Optional[AwsSubnet]
    """
    The id of the Subnet the resource is in.
    """

    keyPair: Optional[AwsKeyPair]
    """
    The name of the key pair the resource is associated with.
    """

    iamRole: Optional[AwsIamRole]=None
    """
    The id of the iam role the resource is associated with.
    """

    iamInstanceProfile: Optional[AwsIamInstanceProfile]
    """
    The arn of the iam instance profile the resource is associated with.
    """

    masterSecurityGroups: Optional[Array[AwsSecurityGroup]]
    """
    The id of the security groups of the master instance in EMR.
    """

    slaveSecurityGroups: Optional[Array[AwsSecurityGroup]]
    """
    The id of the security groups of the slave instance in EMR.
    """

    serviceSecurityGroup: Optional[AwsSecurityGroup]
    """
    Security Group of the EMR cluster in private subnet for service access.
    """
    ...
    terminationProtection: Optional[bool]=None
    """
    False by default. If true, the cluster automatically terminated after finishing jobs;
    otherwise, the cluster would keep running
    """
    ...
    applications: Optional[Array[str]]=None
    """
    ...
    c3Applications: Optional[Array[str]]=None
    """
    ...
    instanceGroups: Optional[Array[AwsEmrInstanceGroup]]
    """
    Master, Core, and Task machine types and counts
    """

    bootstraps: Optional[Array[AwsEmrBootstrap]]=None
    """
    Actions for bootstrap
    """

    steps: Optional[Array[AwsEmrStep]]=None
    """
    Steps to be executed in the Emr cluster
    """

    clusterState: Optional[str]=None
    """
    ...
    requestedInstanceGroups: Optional[Array[AwsEmrInstanceGroup]]=None
    """
    Private field record the requested InstanceGroup.
    """

    requestedSteps: Optional[Array[AwsEmrStep]]=None
    """
    Private field record the requested Steps.
    """
    def __init__(self, id: Optional[str]=None, cluster: Optional[str]=None, env: Optional[str]=None, app: Optional[str]=None, func: Optional[str]=None, role: Optional[str]=None, seq: Optional[str]=None, subseq: Optional[str]=None, resourceId: Optional[str]=None, resourceSecondaryId: Optional[str]=None, resourceName: Optional[str]=None, resourceGroupName: Optional[str]=None, fullyConfigured: Optional[bool]=None, resourceNamespace: Optional[str]=None, external: Optional[bool]=None, credentials: Optional[AwsCredentials]=None, hasGeneratedResourceName: Optional[bool]=None, hasGeneratedResourceSecondaryId: Optional[bool]=None, configOverride: Optional[str]=None, secretOverride: Optional[str]=None, issues: Optional[Array[str]]=None, nativeMetricByName: Optional[Map[str, str]]=None, tags: Optional[Array[CloudTag]]=None, description: Optional[str]=None, parentResource: Optional[CloudResource]=None, vpc: Optional[AwsVpc]=None, subnet: Optional[AwsSubnet]=None, keyPair: Optional[AwsKeyPair]=None, iamRole: Optional[AwsIamRole]=None, iamInstanceProfile: Optional[AwsIamInstanceProfile]=None, masterSecurityGroups: Optional[Array[AwsSecurityGroup]]=None, slaveSecurityGroups: Optional[Array[AwsSecurityGroup]]=None, serviceSecurityGroup: Optional[AwsSecurityGroup]=None, autoTerminate: Optional[bool]=None, terminationProtection: Optional[bool]=None, release: Optional[str]=None, applications: Optional[Array[str]]=None, c3Applications: Optional[Array[str]]=None, logging: Optional[str]=None, visibleToAllUsers: Optional[bool]=None, debugging: Optional[bool]=None, instanceGroups: Optional[Array[AwsEmrInstanceGroup]]=None, bootstraps: Optional[Array[AwsEmrBootstrap]]=None, steps: Optional[Array[AwsEmrStep]]=None, clusterState: Optional[str]=None, state: Optional[str]=None, availabilityZone: Optional[str]=None, requestedInstanceGroups: Optional[Array[AwsEmrInstanceGroup]]=None, requestedSteps: Optional[Array[AwsEmrStep]]=None) -> None: ...
    ...
    @overload
    @classmethod
    def fromString(cls, s: str) -> Union[AwsEmr]:
    """
    ...
    @overload
    @classmethod
    def fromString(cls, s: str, failIfInvalid: bool=None) -> Union[AwsEmr]:
    """
    Constructs Cloud Resource instance with reference fields and credentials based on provided Cloud Reference string.
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[AwsEmr]:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> AwsEmr:
    """
    ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> AwsEmr:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> AwsEmr:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> AwsEmr:
    """
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[AwsEmr]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[AwsEmr]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[AwsEmr]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[AwsEmr]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> AwsEmr:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> AwsEmr:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> AwsEmr:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[AwsEmr]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[AwsEmr]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> AwsEmr:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> AwsEmr:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> AwsEmr:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> AwsEmr:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> AwsEmr:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> AwsEmr:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> AwsEmr:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> AwsEmr:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> AwsEmr:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> AwsEmr:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> AwsEmr:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> AwsEmr:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> AwsEmr:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> AwsEmr:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> AwsEmr:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> AwsEmr:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> AwsEmr:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> AwsEmr:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> AwsEmr:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> AwsEmr:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> AwsEmr:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> AwsEmr:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> AwsEmr:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> AwsEmr:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> AwsEmr:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> AwsEmr:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> AwsEmr:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[AwsEmr]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[AwsEmr]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[AwsEmr]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[AwsEmr]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[AwsEmr]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, AwsEmr]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, AwsEmr]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[AwsEmr]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[AwsEmr]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> AwsEmr:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> AwsEmr:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> AwsEmr:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> AwsEmr:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[AwsEmr]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> AwsEmr:
    """
    ...
    """
        ...
    @classmethod
    def forId(cls, id: str, failIfMissing: bool=None) -> Union[AwsEmr]:
    """
    Find Cloud Resource in Cloud Provider based on provided C3 canonical identifier.
    """
        ...
    @classmethod
    def fromClusterId(cls, clusterId: str, env: str, app: str, func: str, role: str=None, seq: str=None, subseq: str=None) -> AwsEmr:
    """
    Construct a cloud ID from a cluster ID
    """
        ...
    @classmethod
    def fromEnvId(cls, envId: str, app: str, func: str, role: str=None, seq: str=None, subseq: str=None) -> AwsEmr:
    """
    ...
    """
        ...
    @classmethod
    def fromAppId(cls, appId: str, func: str, role: str=None, seq: str=None, subseq: str=None) -> AwsEmr:
    """
    ...
    """
        ...
    @classmethod
    def fromId(cls, id: str, failIfInvalid: bool=None) -> AwsEmr:
    """
    ...
    """
        ...
    @classmethod
    def fromCloudId(cls, id: CloudId, failIfInvalid: bool=None) -> AwsEmr:
    """
    ...
    """
        ...
    def fromConfigTemplate(self, spec: CloudResourceOperationSpec=None) -> AwsEmr:
    """
    ...
    """
        ...
    def withDefaultConfig(self, spec: CloudResourceOperationSpec=None) -> AwsEmr:
    """
    ...
    """
        ...
    def upsertResource(self, spec: CloudResourceOperationSpec=None) -> AwsEmr:
    """
    Create or update Cloud Resource.
    """
        ...
    def upsertWithDependencies(self, spec: CloudResourceOperationSpec=None) -> AwsEmr:
    """
    ...
    """
        ...
    @classmethod
    def allCached(cls, doNotProduceAll: bool=None) -> Union[Stream[AwsEmr]]:
    """
    ...
    """
        ...
    @classmethod
    def find(cls, filter: str=None, doNotProduceAll: bool=None) -> Union[Stream[AwsEmr]]:
    """
    ...
    """
        ...
    @classmethod
    def findBy(cls, field: str, value: Any, doNotProduceAll: bool=None) -> Union[Stream[AwsEmr]]:
    """
    @param doNotProduceAll if true, will not populate cache and only return available cached instances. Will call
           `produceAll` if cache is empty or if Ann.cache.all is true & data has not previously been fetched.
    @return existing instances of this type that satisfy filter from data cache.
    """
        ...
    @classmethod
    def findByCacheKey(cls, key: str) -> Union[AwsEmr]:
    """
    ...
    """
        ...
    @classmethod
    def doProduceAll(cls) -> Union[Map[str, AwsEmr]]:
    """
    ...
    """
        ...
    @classmethod
    def forConfigKey(cls, configKey: str) -> Union[AwsEmr]:
    """
    ...
    """
        ...
    @classmethod
    def listConfigs(cls, parallel: bool=None, filter: Callable[[str], bool]=None) -> Union[Stream[AwsEmr]]:
    """
    @param
    ...
    """
        ...
    @overload
    def setConfigValues(self, from_: AwsEmr, override: str=None) -> None:
    """
    ...
    """
        ...
    @overload
    def setSecretValues(self, from_: AwsEmr, override: str=None) -> None:
    """
    ...
    """
        ...
    @classmethod
    def loadConfigAndSecret(cls, configKey: str) -> Union[AwsEmr]:
    """
    ...
    """
        ...
    def removeSecrets(self) -> Union[AwsEmr]:
    """
    @return this config without any secret values.
    """
        ...
    def removeNonSecrets(self) -> Union[AwsEmr]:
    """
    @return this config with only secret values.
    """
        ...
    def validate(self) -> AwsEmr:
    """
    ...
    """
        ...
    def withIdentity(self, resource: CloudResource=None, spec: CloudResourceOperationSpec=None) -> AwsEmr:
    """
    ...
    """
        ...
    def mergeId(self, other: CloudResource=None) -> AwsEmr:
    """
    ...
    """
        ...
    @classmethod
    def forCloudId(cls, id: CloudId, failIfMissing: bool=None) -> Union[AwsEmr]:
    """
    ...
    """
        ...
    @classmethod
    def forCloudFunc(cls, func: str, role: str=None, failIfMissing: bool=None) -> AwsEmr:
    """
    Find Cloud Resource based on provided cloud func component and optional role.
    """
        ...
    @classmethod
    def forCloudRole(cls, role: str, failIfMissing: bool=None) -> AwsEmr:
    """
    Find Cloud Resource of this type based on provided cloud role component.
    """
        ...
    @classmethod
    def forResourceId(cls, resourceId: str, failIfMissing: bool=None) -> Union[AwsEmr]:
    """
    Find Cloud Resource in the Cloud Provider by provided resource name.
    """
        ...
    @classmethod
    def forResourceSecondaryId(cls, resourceId: str, failIfMissing: bool=None) -> Union[AwsEmr]:
    """
    Find Cloud Resource in the Cloud Provider by provided resource name.
    """
        ...
    ...
    """
        ...
    @classmethod
    def forResourceName(cls, resourceName: str, failIfMissing: bool=None) -> Union[AwsEmr]:
    """
    Find Cloud Resource in the Cloud Provider by provided resource name.
    """
        ...
    @classmethod
    def findResource(cls, reference: str, failIfMissing: bool=None) -> Union[AwsEmr]:
    """
    Find Cloud Resource in the Cloud Provider by provided {@link CloudRef} string.
    """
        ...
    def getResource(self) -> Union[AwsEmr]:
    """
    Find Cloud Resource in the Cloud Provider by provided #resourceId, #resourceSecondaryId, #resourceName or #tags
    (in that order).
    """
        ...
    def ensureResource(self) -> AwsEmr:
    """
    Checks that the resource is persisted. If not, upserts the resource, to ensure that the resource exists.
    """
        ...
    @classmethod
    def listResourcesBySubtype(cls, spec: CloudListResourcesSpec=None) -> Map[str, CloudListResourcesResult[AwsEmr]]:
    """
    ...
    """
        ...
    @classmethod
    def listResources(cls, spec: CloudListResourcesSpec=None) -> CloudListResourcesResult[AwsEmr]:
    """
    ...
    """
        ...
    @classmethod
    def listResourcesForTags(cls, *keyValuePairs: Array[str]) -> CloudListResourcesResult[AwsEmr]:
    """
    List all Cloud Resources that satisfies the given spec.
    ...
    """
        ...
    @classmethod
    def listResourcesForClusterId(cls, clusterId: str, cloudIdRole: str=None, spec: CloudListResourcesSpec=None) -> CloudListResourcesResult[AwsEmr]:
    """
    List all Cloud Resources that satisfies the given spec.
    ...
    """
        ...
    @classmethod
    def listResourcesForEnvId(cls, envId: str, cloudIdRole: str=None, spec: CloudListResourcesSpec=None) -> CloudListResourcesResult[AwsEmr]:
    """
    List all Cloud Resources that satisfies the given spec.
    ...
    """
        ...
    @classmethod
    def listResourcesForAppId(cls, appId: str, cloudIdRole: str=None, spec: CloudListResourcesSpec=None) -> CloudListResourcesResult[AwsEmr]:
    """
    List all Cloud Resources that satisfies the given spec.
    ...
    """
        ...
    def upsertDependencies(self, spec: CloudResourceOperationSpec=None) -> AwsEmr:
    """
    ...
    """
        ...
    def waitForCreate(self, spec: WaitSpec=None) -> Union[AwsEmr]:
    """
    ...
    """
        ...
    @classmethod
    def tagResourcesBatch(cls, resources: Array[AwsEmr], tags: Array[CloudTag]) -> Union[Map[str, Error]]:
    """
    ...
    """
        ...
    @classmethod
    def untagResourcesBatch(cls, resources: Array[AwsEmr], tagKeys: Array[str]) -> Union[Map[str, Error]]:
    """
    ...
    """
        ...
    def waitForOk(self, spec: WaitSpec=None) -> Union[AwsEmr]:
    """
    ...
    """
        ...
    def waitForState(self, state: str='AVAILABLE', spec: WaitSpec=None) -> Union[AwsEmr]:
    """
    ...
    """
        ...
    def setFullyConfigured(self, fullyConfigured: bool=None, override: str=None) -> AwsEmr:
    """
    ...
    """
        ...
    def afterCreate(self, input: AwsEmr=None) -> AwsEmr:
    """
    ...
    """
        ...
    def withoutNonModifiableFields(self) -> AwsEmr:
    """
    ...
    """
        ...
    def withResourceArn(self, resourceArn: str) -> Union[AwsEmr]:
    """
    ...
    """
        ...
    def safeVpc(self) -> Union[AwsVpc]:
    """
    Get the vpc associated with the resource
    """
        ...
    def safeSubnet(self) -> AwsSubnet:
    """
    get the subnet of the resource
    """
        ...
    def safeKeyPair(self) -> AwsKeyPair:
    """
    Get the aws key pair for the given resource
    """
        ...
    def safeIamRole(self) -> Union[AwsIamRole]:
    """
    Get the iam role for the given resource
    """
        ...
    def safeIamInstanceProfile(self) -> AwsIamInstanceProfile:
    """
    Get the iam instance profile for the given resource
    """
        ...
    def safeMasterSecurityGroups(self) -> Union[Array[AwsSecurityGroup]]:
    """
    get the security groups of the master instance in EMR.
    """
        ...
    def safeSlaveSecurityGroups(self) -> Union[Array[AwsSecurityGroup]]:
    """
    get the security groups of the slave instance in EMR.
    """
        ...
    def safeServiceSecurityGroup(self) -> Union[AwsSecurityGroup]:
    """
    get the Service Security Group associated with the EMR cluster
    """
        ...
    @classmethod
    def inst(cls) -> AwsEmr:
    ...
    """
        ...
    def upsertElbs(self) -> Union[Array[str]]:
    """
    Upsert Elbs for the Emr Cluster
    """
        ...
    def upsertUrls(self) -> Union[Array[str]]:
    """
    Upsert Urls for the Emr Cluster
    """
        ...
    def upsertElb(self, spec: EmrEndpointSpec=None) -> Union[str]:
    """
    Upsert Elb for the Emr Cluster
    """
        ...
    def upsertUrl(self, spec: EmrEndpointSpec=None) -> Union[str]:
    """
    ...
    """
        ...
    @classmethod
    def fromServiceName(cls, serviceName: str, autoIncrementSeq: bool=None) -> AwsEmr:
    """
    ...
    """
        ...
    @classmethod
    def clusterDomain(cls) -> str:
    """
    Gives the domain of the current cluster.
    """
        ...
    def isInEmrState(self, state: str) -> bool:
    """
