...
from c3.platform.DataInteg.Pipeline.Step.Output import DataInteg.Pipeline.Step.Output
...
from c3.platform.DataInteg.Pipeline.Step.Load import DataInteg.Pipeline.Step.Load
from c3.platform.Data import Data
from c3.platform.DataInteg.Engine import DataInteg.Engine
...
from c3.platform.MergeActions import MergeActions
...
from c3.platform.DataInteg.Pipeline.Step.Load.OutputConfiguration import DataInteg.Pipeline.Step.Load.OutputConfiguration
...
from c3.platform.DataInteg.Pipeline.Step.Input import DataInteg.Pipeline.Step.Input
from c3.platform.ObjBuilder import ObjBuilder
...
# Python definitions for the C3 type DataInteg.Pipeline.Step.Load

C = TypeVar('C')

class Load(Generic[C], DataInteg.Pipeline.Step[C]):
    """
    This step is responsible for writing to a datastore from a {@link FileSourceCollection}
    
    @remarks this represents a made instance of DataInteg.Pipeline.Step.Load
    """
    ...
    engine: Optional[DataInteg.Engine[DataInteg.Pipeline.Step.Input, DataInteg.Pipeline.Step.Output, DataInteg.Engine.Config]]
    """
    The engine determines where and how to execute a corresponding step. This could be sql, spark, or different
    engine altogether.
    """

    kind: Optional[str]
    """
    The type of the step which determines what to execute on the {@link DataInteg.Engine}
    """

    input: Optional[DataInteg.Pipeline.Step.Input]=None

    output: Optional[DataInteg.Pipeline.Step.Output]=None

    outputConfiguration: Optional[DataInteg.Pipeline.Step.Load.OutputConfiguration[DataInteg.Pipeline.Step.Load.OutputConfiguration.Config]]=None
    def __init__(self, id: Optional[str]=None, versionEdits: Optional[Array[VersionEdit]]=None, name: Optional[str]=None, meta: Optional[Meta]=None, version: Optional[int]=None, typeWithBindings: Optional[Type]=None, userUpdatedFields: Optional[Array[str]]=None, hidden: Optional[bool]=None, userOwned: Optional[bool]=None, engine: Optional[DataInteg.Engine[DataInteg.Pipeline.Step.Input, DataInteg.Pipeline.Step.Output, DataInteg.Engine.Config]]=None, kind: Optional[str]=None, input: Optional[DataInteg.Pipeline.Step.Input]=None, output: Optional[DataInteg.Pipeline.Step.Output]=None, outputConfiguration: Optional[DataInteg.Pipeline.Step.Load.OutputConfiguration[DataInteg.Pipeline.Step.Load.OutputConfiguration.Config]]=None) -> None: ...
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[DataInteg.Pipeline.Step.Load[C]]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[DataInteg.Pipeline.Step.Load[C]]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[DataInteg.Pipeline.Step.Load[C]]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[DataInteg.Pipeline.Step.Load[C]]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> DataInteg.Pipeline.Step.Load[C]:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> DataInteg.Pipeline.Step.Load[C]:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> DataInteg.Pipeline.Step.Load[C]:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[DataInteg.Pipeline.Step.Load[C]]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[DataInteg.Pipeline.Step.Load[C]]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> DataInteg.Pipeline.Step.Load[C]:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> DataInteg.Pipeline.Step.Load[C]:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> DataInteg.Pipeline.Step.Load[C]:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> DataInteg.Pipeline.Step.Load[C]:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> DataInteg.Pipeline.Step.Load[C]:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> DataInteg.Pipeline.Step.Load[C]:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> DataInteg.Pipeline.Step.Load[C]:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> DataInteg.Pipeline.Step.Load[C]:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> DataInteg.Pipeline.Step.Load[C]:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> DataInteg.Pipeline.Step.Load[C]:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> DataInteg.Pipeline.Step.Load[C]:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> DataInteg.Pipeline.Step.Load[C]:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> DataInteg.Pipeline.Step.Load[C]:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> DataInteg.Pipeline.Step.Load[C]:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> DataInteg.Pipeline.Step.Load[C]:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> DataInteg.Pipeline.Step.Load[C]:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> DataInteg.Pipeline.Step.Load[C]:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> DataInteg.Pipeline.Step.Load[C]:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> DataInteg.Pipeline.Step.Load[C]:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> DataInteg.Pipeline.Step.Load[C]:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> DataInteg.Pipeline.Step.Load[C]:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> DataInteg.Pipeline.Step.Load[C]:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> DataInteg.Pipeline.Step.Load[C]:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> DataInteg.Pipeline.Step.Load[C]:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> DataInteg.Pipeline.Step.Load[C]:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> DataInteg.Pipeline.Step.Load[C]:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> DataInteg.Pipeline.Step.Load[C]:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> DataInteg.Pipeline.Step.Load[C]:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[DataInteg.Pipeline.Step.Load[C]]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[DataInteg.Pipeline.Step.Load[C]]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[DataInteg.Pipeline.Step.Load[C]]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[DataInteg.Pipeline.Step.Load[C]]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[DataInteg.Pipeline.Step.Load[C]]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, DataInteg.Pipeline.Step.Load[C]]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, DataInteg.Pipeline.Step.Load[C]]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[DataInteg.Pipeline.Step.Load[C]]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[DataInteg.Pipeline.Step.Load[C]]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> DataInteg.Pipeline.Step.Load[C]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> DataInteg.Pipeline.Step.Load[C]:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> DataInteg.Pipeline.Step.Load[C]:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> DataInteg.Pipeline.Step.Load[C]:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> DataInteg.Pipeline.Step.Load[C]:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> DataInteg.Pipeline.Step.Load[C]:
    """
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[DataInteg.Pipeline.Step.Load[C]]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> DataInteg.Pipeline.Step.Load[C]:
    """
    ...
    """
        ...
    def afterMake(self) -> DataInteg.Pipeline.Step.Load[C]:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> DataInteg.Pipeline.Step.Load[C]:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[DataInteg.Pipeline.Step.Load[C]]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> DataInteg.Pipeline.Step.Load[C]:
    """
    ...
    """
        ...
    @classmethod
    def allCached(cls, doNotProduceAll: bool=None) -> Union[Stream[DataInteg.Pipeline.Step.Load[C]]]:
    """
    ...
    """
        ...
    @classmethod
    def find(cls, filter: str=None, doNotProduceAll: bool=None) -> Union[Stream[DataInteg.Pipeline.Step.Load[C]]]:
    """
    ...
    """
        ...
    @classmethod
    def findBy(cls, field: str, value: Any, doNotProduceAll: bool=None) -> Union[Stream[DataInteg.Pipeline.Step.Load[C]]]:
    """
    @param doNotProduceAll if true, will not populate cache and only return available cached instances. Will call
           `produceAll` if cache is empty or if Ann.cache.all is true & data has not previously been fetched.
    @return existing instances of this type that satisfy filter from data cache.
    """
        ...
    @classmethod
    def findByCacheKey(cls, key: str) -> Union[DataInteg.Pipeline.Step.Load[C]]:
    """
    ...
    """
        ...
    @classmethod
    def forCacheKey(cls, key: str) -> Union[DataInteg.Pipeline.Step.Load[C]]:
    """
    ...
    """
        ...
    def getCached(self) -> Union[DataInteg.Pipeline.Step.Load[C]]:
    """
    ...
    """
        ...
    def refreshCache(self) -> Union[DataInteg.Pipeline.Step.Load[C]]:
    """
    ...
    """
        ...
    @classmethod
    def produce(cls, key: str) -> Union[DataInteg.Pipeline.Step.Load[C]]:
    """
    Should produce an entry for the cache key. This method should not be called directly.
    """
        ...
    @classmethod
    def produceAll(cls) -> Union[Map[str, DataInteg.Pipeline.Step.Load[C]]]:
    """
    ...
    """
        ...
    @classmethod
    def doProduceAll(cls) -> Union[Map[str, DataInteg.Pipeline.Step.Load[C]]]:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, spec: FetchSpec=None) -> FetchResult[DataInteg.Pipeline.Step.Load[C]]:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, filter: Filter) -> FetchResult[DataInteg.Pipeline.Step.Load[C]]:
    """
    ...
    """
        ...
    @classmethod
    def fetchObjStream(cls, spec: FetchStreamSpec=None) -> Union[Stream[DataInteg.Pipeline.Step.Load[C]]]:
    """
    Fetches multiple obj instances based on a specification.  Only objs that the caller is authorized to fetch will be
    returned.
    ...
    """
        ...
    @classmethod
    def fetchMultiLocale(cls, spec: MultiLocaleFetchSpec=None) -> Union[Map[str, FetchResult[DataInteg.Pipeline.Step.Load[C]]]]:
    """
    ...
    """
        ...
    def get(self, include: str=None) -> Union[DataInteg.Pipeline.Step.Load[C]]:
    """
    ...
    """
        ...
    def getSpecific(self, include: str=None) -> Union[DataInteg.Pipeline.Step.Load[C]]:
    """
    ...
    """
        ...
    def getMissing(self, spec: GetMissingSpec) -> DataInteg.Pipeline.Step.Load[C]:
    """
    ...
    """
        ...
    def getDirect(self, include: str=None) -> Union[DataInteg.Pipeline.Step.Load[C]]:
    """
    ...
    """
        ...
    def applyReverseEdit(self, versionEdit: VersionEdit) -> DataInteg.Pipeline.Step.Load[C]:
    """
    ...
    """
        ...
    @classmethod
    def fromString(cls, s: str) -> Union[DataInteg.Pipeline.Step.Load[C]]:
    """
    ...
    """
        ...
    def create(self, spec: UpsertSpec=None) -> Union[DataInteg.Pipeline.Step.Load[C]]:
    """
    ...
    """
        ...
    @classmethod
    def createBatch(cls, objs: Array[DataInteg.Pipeline.Step.Load[C]], spec: UpsertSpec=None) -> Union[ObjList[DataInteg.Pipeline.Step.Load[C]]]:
    """
    ...
    """
        ...
    @classmethod
    def createBatchObjStream(cls, objs: Stream[DataInteg.Pipeline.Step.Load[C]], spec: CreateBatchObjStreamSpec=None) -> Union[ObjList[DataInteg.Pipeline.Step.Load[C]]]:
    """
    Creates multiple instances of a C3 type. If the operation fails and {@link UpsertSpec#dontThrowOnBatchError} is not
    specified (the default), then a C3BatchException will be thrown.  Otherwise {@link errors will be reported in the
    returned {@link ObjList}.  This will fail if any of the instances already exist.
    ...
    """
        ...
    def update(self, srcObj: DataInteg.Pipeline.Step.Load[C]=None, spec: UpsertSpec=None) -> Union[DataInteg.Pipeline.Step.Load[C]]:
    """
    ...
    """
        ...
    def upsert(self, srcObj: DataInteg.Pipeline.Step.Load[C]=None, spec: UpsertSpec=None) -> Union[DataInteg.Pipeline.Step.Load[C]]:
    """
    ...
    """
        ...
    @overload
    def merge(self, spec: MergeSpec=None) -> Union[DataInteg.Pipeline.Step.Load[C]]:
    """
    ...
    """
        ...
    @overload
    def merge(self, mergeInclude: str, spec: MergeSpec=None) -> Union[DataInteg.Pipeline.Step.Load[C]]:
    """
    ...
    """
        ...
    def touch(self, spec: TouchSpec=None) -> Union[DataInteg.Pipeline.Step.Load[C]]:
    """
    ...
    """
        ...
    @classmethod
    def updateBatch(cls, objs: Array[DataInteg.Pipeline.Step.Load[C]], srcObjs: Array[DataInteg.Pipeline.Step.Load[C]]=None, spec: UpsertSpec=None) -> Union[ObjList[DataInteg.Pipeline.Step.Load[C]]]:
    """
    ...
    """
        ...
    @classmethod
    def updateObjs(cls, objs: Callable[[], Union[Array[DataInteg.Pipeline.Step.Load[C]]]], spec: UpsertSpec=None) -> Union[ObjList[DataInteg.Pipeline.Step.Load[C]]]:
    """
    ...
    """
        ...
    @classmethod
    def upsertBatch(cls, objs: Array[DataInteg.Pipeline.Step.Load[C]], srcObjs: Array[DataInteg.Pipeline.Step.Load[C]]=None, spec: UpsertSpec=None) -> Union[ObjList[DataInteg.Pipeline.Step.Load[C]]]:
    """
    ...
    """
        ...
    @classmethod
    def upsertObjs(cls, objs: Callable[[], Union[Array[DataInteg.Pipeline.Step.Load[C]]]], spec: UpsertSpec=None) -> Union[ObjList[DataInteg.Pipeline.Step.Load[C]]]:
    """
    Creates instances of a C3 type if they don't already exist and updates them if they do exist. If the operation
    ...
    """
        ...
    @classmethod
    def touchBatch(cls, objs: Array[DataInteg.Pipeline.Step.Load[C]], spec: TouchSpec=None) -> Union[ObjList[DataInteg.Pipeline.Step.Load[C]]]:
    """
    ...
    @overload
    @classmethod
    def mergeBatch(cls, objs: Array[DataInteg.Pipeline.Step.Load[C]], spec: MergeSpec=None) -> Union[ObjList[DataInteg.Pipeline.Step.Load[C]]]:
    """
    ...
    @overload
    @classmethod
    def mergeBatch(cls, objs: Array[DataInteg.Pipeline.Step.Load[C]], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[DataInteg.Pipeline.Step.Load[C]]]:
    """
    Merges multiple instances of a C3 type or creates them if they don't exist. If the operation fails and {@link
    UpsertSpec#dontThrowOnBatchError} is not specified (the default), then a C3BatchException will be thrown.
    Otherwise errors will be reported in the returned {@link ObjList}.  The merge operation is described in the {@link
    ...
    """
        ...
    @classmethod
    def mergeObjs(cls, objs: Callable[[], Union[Array[DataInteg.Pipeline.Step.Load[C]]]], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[DataInteg.Pipeline.Step.Load[C]]]:
    """
    ...
    @overload
    @classmethod
    def mergeAll(cls, mergeObj: DataInteg.Pipeline.Step.Load[C], spec: MergeAllSpec=None) -> Union[int]:
    """
    ...
    @overload
    @classmethod
    def mergeAll(cls, mergeObj: DataInteg.Pipeline.Step.Load[C], mergeInclude: str, spec: MergeAllSpec=None) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def removeBatch(cls, objs: Array[DataInteg.Pipeline.Step.Load[C]], spec: UpsertSpec=None) -> Union[ObjList[DataInteg.Pipeline.Step.Load[C]]]:
    """
    ...
    """
        ...
    @classmethod
    def replace(cls, objs: Array[DataInteg.Pipeline.Step.Load[C]], spec: UpsertSpec=None) -> Union[ObjList[DataInteg.Pipeline.Step.Load[C]]]:
    """
    ...
    """
        ...
    def unremove(self) -> Union[DataInteg.Pipeline.Step.Load[C]]:
    """
    ...
    """
        ...
    @classmethod
    def beforeCreate(cls, objs: Array[DataInteg.Pipeline.Step.Load[C]]) -> ObjList[DataInteg.Pipeline.Step.Load[C]]:
    """
    ...
    """
        ...
    @classmethod
    def beforeUpdate(cls, objs: Array[DataInteg.Pipeline.Step.Load[C]]) -> ObjList[DataInteg.Pipeline.Step.Load[C]]:
    """
    ...
    """
        ...
    @classmethod
    def beforeRemove(cls, objs: Array[DataInteg.Pipeline.Step.Load[C]]) -> ObjList[DataInteg.Pipeline.Step.Load[C]]:
    """
    ...
    """
        ...
    @classmethod
    def afterCreate(cls, objs: Array[DataInteg.Pipeline.Step.Load[C]]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def afterUpdate(cls, objs: Array[DataInteg.Pipeline.Step.Load[C]]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def afterRemove(cls, objs: Array[DataInteg.Pipeline.Step.Load[C]]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def startImportData(cls, spec: StartImportDataSpec=None) -> PushStream[DataInteg.Pipeline.Step.Load[C]]:
    """
    @return a push stream to import instances of this type.
    """
        ...
    @classmethod
    def startImportDataWithStats(cls, spec: StartImportDataSpec=None) -> PushStreamWithStats[DataInteg.Pipeline.Step.Load[C]]:
    """
    @return a push stream to import instances of this type.
    """
        ...
    ...
    """
        ...
    @classmethod
    def forId(cls, id: str, failIfMissing: bool=None) -> Union[DataInteg.Pipeline.Step.Load[C]]:
    """
    ...
    """
        ...
    def withoutIdentity(self) -> Union[DataInteg.Pipeline.Step.Load[C]]:
    """
    ...
    """
        ...
    @classmethod
    def typeOfBatch(cls, objs: Array[DataInteg.Pipeline.Step.Load[C]]) -> Union[Array[EntityType]]:
    """
    ...
    """
        ...
    @classmethod
    def dbEcho(cls, template: DataInteg.Pipeline.Step.Load[C]=None, count: int=None, sendBack: bool=None) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def callbackLogic(cls, objs: Array[DataInteg.Pipeline.Step.Load[C]], callback: Callable[[Union[DataInteg.Pipeline.Step.Load[C]]], Union[DataInteg.Pipeline.Step.Load[C]]]=None) -> ObjList[DataInteg.Pipeline.Step.Load[C]]:
    """
    ...
    """
        ...
    @classmethod
    def afterCallbackLogic(cls, objs: Array[DataInteg.Pipeline.Step.Load[C]], callback: Callable[[Union[DataInteg.Pipeline.Step.Load[C]]], Union[DataInteg.Pipeline.Step.Load[C]]]=None) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    def publish(self, subPath: str=None, contentType: str=None) -> DataInteg.Pipeline.Step.Load[C]:
    """
    ...
    """
        ...
    @classmethod
    def removeSeedDataBatch(cls, objs: Array[SeedData]=None, spec: UpsertSpec=None) -> Union[ObjList[DataInteg.Pipeline.Step.Load[C]]]:
    """
    ...
    """
        ...
    def createSeedData(self, spec: UpsertSpec=None) -> Union[DataInteg.Pipeline.Step.Load[C]]:
    """
    ...
    """
        ...
    @classmethod
    def createSeedDataBatch(cls, objs: Array[SeedData]=None, spec: UpsertSpec=None) -> Union[ObjList[DataInteg.Pipeline.Step.Load[C]]]:
    """
    ...
    """
        ...
    def updateSeedData(self, srcObj: SeedData=None, spec: UpsertSpec=None) -> Union[DataInteg.Pipeline.Step.Load[C]]:
    """
    ...
    """
        ...
    @classmethod
    def updateSeedDataBatch(cls, objs: Array[SeedData]=None, srcObjs: Array[SeedData]=None, spec: UpsertSpec=None) -> Union[ObjList[DataInteg.Pipeline.Step.Load[C]]]:
    """
    ...
    """
        ...
    def clearUserUpdates(self, spec: MergeSpec=None) -> Union[DataInteg.Pipeline.Step.Load[C]]:
    """
    ...
    """
        ...
    @classmethod
    def clearUserUpdatesBatch(cls, objs: Array[SeedData]=None, spec: MergeSpec=None) -> Union[ObjList[DataInteg.Pipeline.Step.Load[C]]]:
    """
    ...
    """
        ...
    def dependencies(self) -> Union[SeedDataDeps[DataInteg.Pipeline.Step.Load[C]]]:
        ...
    ...
    class OutputConfiguration(Generic[C], Identifiable, Configurable[C]):
        """
        @remarks this represents a made instance of DataInteg.Pipeline.Step.Load.OutputConfiguration
        """
        ...
        """
        The target datastore for data i.e data lake, s3, postgres, etc..
        This specifies where the data will be written during this step.
        """
        def __init__(self, id: Optional[str]=None, datastore: Optional[str]=None) -> None: ...
        ...
        """
            ...
        @classmethod
        def fromJson(cls, json: any) -> Union[DataInteg.Pipeline.Step.Load.OutputConfiguration[C]]:
        """
        Load the JSON-based representation and reconstruct the corresponding object.
        ...
        """
            ...
        @classmethod
        def fromJsonString(cls, json: str) -> Union[DataInteg.Pipeline.Step.Load.OutputConfiguration[C]]:
        """
        Load the JSON-based representation and reconstruct the corresponding object.
        ...
        """
            ...
        @classmethod
        def fromXmlString(cls, xml: str) -> Union[DataInteg.Pipeline.Step.Load.OutputConfiguration[C]]:
        """
        Load the XML-based representation and reconstruct the corresponding object.
        ...
        """
            ...
        @classmethod
        def deserialize(cls, contentStr: str, contentType: str) -> Union[DataInteg.Pipeline.Step.Load.OutputConfiguration[C]]:
        """
        Load from contentType representation and reconstruct the corresponding object.
        ...
        """
            ...
        def replaceType(self, old: Type, new: Type) -> DataInteg.Pipeline.Step.Load.OutputConfiguration[C]:
        """
        Returns new instance with all references to old type, including result of #type, replaced with new type. If new
        type does not contain fields from old or field value types are not convertable then drops the field.
        ...
        """
            ...
        @overload
        def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> DataInteg.Pipeline.Step.Load.OutputConfiguration[C]:
        """
        Result of this function call is a copy of current instance with all non empty fields replaced based on results of
        the `mapper` invocation.
        ...
        """
            ...
        @overload
        def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> DataInteg.Pipeline.Step.Load.OutputConfiguration[C]:
        """
        Result of this function call is a copy of current instance with all fields replaced based on results of the
        `mapper` invocation.
        ...
        """
            ...
        @overload
        def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[DataInteg.Pipeline.Step.Load.OutputConfiguration[C]]:
        """
        Result of this function call is a copy of current instance with all non empty fields replaced based on results of
        the asynchronous `mapper` invocation.
        ...
        """
            ...
        @overload
        def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[DataInteg.Pipeline.Step.Load.OutputConfiguration[C]]:
        """
        Result of this function call is a copy of current instance with all fields replaced based on results of the
        asynchronous `mapper` invocation.
        ...
        """
            ...
        def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> DataInteg.Pipeline.Step.Load.OutputConfiguration[C]:
        """
        Result of this function call is a copy of current instance with specified field value replaced based on result of
        the `mapper` invocation.
        @param field
        ...
        """
            ...
        @overload
        def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> DataInteg.Pipeline.Step.Load.OutputConfiguration[C]:
        """
        Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
        lambda application.
        ...
        """
            ...
        @overload
        def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> DataInteg.Pipeline.Step.Load.OutputConfiguration[C]:
        """
        Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
        lambda application.
        ...
        """
            ...
        @overload
        def validateObj(self) -> DataInteg.Pipeline.Step.Load.OutputConfiguration[C]:
        """
        Populates all missing default values and throws error if any constraint is violated.
        """
            ...
        ...
        """
            ...
        @overload
        def withField(self, field: str, value: Any, doNotConvert: bool=None) -> DataInteg.Pipeline.Step.Load.OutputConfiguration[C]:
        """
        Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
        defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
        ...
        """
            ...
        @overload
        def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> DataInteg.Pipeline.Step.Load.OutputConfiguration[C]:
        """
        Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
        defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
        ...
        """
            ...
        def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> DataInteg.Pipeline.Step.Load.OutputConfiguration[C]:
        """
        Builds a new Obj instance by adding the provided fields in it. The name must correspond to an existing fields
        defined on this type or its mixins. The values must be of the correct type if doNotConvert flag is true.
        ...
        """
            ...
        def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> DataInteg.Pipeline.Step.Load.OutputConfiguration[C]:
        """
        Builds a new Obj with the value at the specified path field. If the field is null, the field #isFieldSet to null.
        If you would like to #unsetField, you should call #withoutFieldAtPath instead.
        ...
        """
            ...
        def withoutFieldAtPath(self, path: str) -> DataInteg.Pipeline.Step.Load.OutputConfiguration[C]:
        """
        Builds a new Obj without the specified path field.
        ...
        """
            ...
        @overload
        def withoutField(self, field: str) -> DataInteg.Pipeline.Step.Load.OutputConfiguration[C]:
        """
        Builds a new Obj, removing the field with the provided name.
        ...
        """
            ...
        @overload
        def withoutField(self, field: FieldType) -> DataInteg.Pipeline.Step.Load.OutputConfiguration[C]:
        """
        Builds a new Obj, removing the field with the provided field type.
        ...
        """
            ...
        def withoutFields(self, fields: Array[str]) -> DataInteg.Pipeline.Step.Load.OutputConfiguration[C]:
        """
        Builds a new Obj, removing the fields with the provided names.
        ...
        """
            ...
        def withoutFieldsByType(self, fields: Array[FieldType]) -> DataInteg.Pipeline.Step.Load.OutputConfiguration[C]:
        """
        Builds a new Obj, removing the fields with the provided field types. Be sure to use the FieldType instance for the
        exact same type as the type of the obj to respect the "ordinal" of the field type
        ...
        """
            ...
        def withoutSecretFields(self) -> DataInteg.Pipeline.Step.Load.OutputConfiguration[C]:
        """
        @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
        """
            ...
        ...
        """
            ...
        def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> DataInteg.Pipeline.Step.Load.OutputConfiguration[C]:
        """
        Builds a new Obj instance by adding the default values (if defined) for all unset fields. This is implemented by
        calling {@link FieldType#defaultValue defaultValue} for a field if it is not already set and
        {@link FieldType#hasDefault has a default}. It will also set {@see ValueType#initialValue initial values} for
        ...
        """
            ...
        @overload
        def defaultField(self, field: str) -> DataInteg.Pipeline.Step.Load.OutputConfiguration[C]:
        """
        Builds a new Obj, by setting a field on this `Obj` to the field's default value. If the field has no default, this
        method will behave the same as {@link #unsetField}.
        ...
        """
            ...
        @overload
        def defaultField(self, field: FieldType) -> DataInteg.Pipeline.Step.Load.OutputConfiguration[C]:
        """
        Builds a new Obj, by setting a field on this `Obj` to the fields default value. If the field has no default, this
        method will behave the same as {@link #unsetField}.
        ...
        """
            ...
        @overload
        def unsetField(self, field: str) -> DataInteg.Pipeline.Step.Load.OutputConfiguration[C]:
        """
        Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
        is different from {@link removeField}
        ...
        """
            ...
        @overload
        def unsetField(self, field: FieldType) -> DataInteg.Pipeline.Step.Load.OutputConfiguration[C]:
        """
        Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
        is different from {@link removeField}
        ...
        """
            ...
        @overload
        def removeField(self, field: str) -> DataInteg.Pipeline.Step.Load.OutputConfiguration[C]:
        """
        Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
        is different from {@link #unsetField}
        ...
        """
            ...
        @overload
        def removeField(self, field: FieldType) -> DataInteg.Pipeline.Step.Load.OutputConfiguration[C]:
        """
        Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
        is different from {@link #unsetField}
        ...
        """
            ...
        @overload
        def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> DataInteg.Pipeline.Step.Load.OutputConfiguration[C]:
        """
        Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
        In case of conflicts, fields of other instance take precedence unless otherwise specified by the fieldPathMergeSpec
        ...
        """
            ...
        @overload
        def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> DataInteg.Pipeline.Step.Load.OutputConfiguration[C]:
        """
        Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
        In case of conflicts, fields of other instance take precedence.
        ...
        """
            ...
        @overload
        def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> DataInteg.Pipeline.Step.Load.OutputConfiguration[C]:
        """
        Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
        fields that exist on other Obj and do not exist on this Obj will not be added to final Obj.
        @param deep
        ...
        """
            ...
        @overload
        def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> DataInteg.Pipeline.Step.Load.OutputConfiguration[C]:
        """
        Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
        fields that exist other Obj and do not exist on this Obj will not be added to final Obj or evaluated. Does not
        traverse child reference and collection fields.
        ...
        """
            ...
        def mergeJson(self, json: any) -> DataInteg.Pipeline.Step.Load.OutputConfiguration[C]:
            ...
        def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> DataInteg.Pipeline.Step.Load.OutputConfiguration[C]:
        """
        Merge the obj references within the current obj
        @param deep
               If set, traverses the reference fields within the obj as well for a deep merge
        ...
        """
            ...
        def sumObj(self, other: Obj, deep: bool=None) -> DataInteg.Pipeline.Step.Load.OutputConfiguration[C]:
        """
        Adds the numeric Obj fields with the other Objs respective fields.
        If deep is set it will traverse reference and collection fields and sum corresponding numeric fields in
        references with same name and collection elements at same index or key.
        """
            ...
        def singletonArray(self) -> Array[DataInteg.Pipeline.Step.Load.OutputConfiguration[C]]:
        """
        Build an array of the correct type with a single element which is this instance.
        ...
        """
            ...
        @classmethod
        def array(cls, *elements: Array[Any]) -> Union[Array[DataInteg.Pipeline.Step.Load.OutputConfiguration[C]]]:
        """
        Creates an array of instances of this type.
        """
            ...
        @classmethod
        def arrayBuilder(cls) -> Union[ArrayBuilder[DataInteg.Pipeline.Step.Load.OutputConfiguration[C]]]:
        """
        Creates an array of instances of this type.
        """
            ...
        def singletonSet(self) -> Set[DataInteg.Pipeline.Step.Load.OutputConfiguration[C]]:
        """
        Build an set of the correct type with a single element which is this instance.
        ...
        """
            ...
        @classmethod
        def setBuilder(cls) -> Union[SetBuilder[DataInteg.Pipeline.Step.Load.OutputConfiguration[C]]]:
        """
        Creates a set of instances of this type.
        """
            ...
        @classmethod
        def mapBuilder(cls) -> Union[MapBuilder[str, DataInteg.Pipeline.Step.Load.OutputConfiguration[C]]]:
        """
        Create a map of string to elements of this type.
        """
            ...
        @classmethod
        def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, DataInteg.Pipeline.Step.Load.OutputConfiguration[C]]]:
        """
        Create a map with the given key type and elements of this type.
        """
            ...
        ...
        def myStreamType(cls) -> StreamType:
            ...
        def toBuilder(self) -> ObjBuilder[DataInteg.Pipeline.Step.Load.OutputConfiguration[C]]:
        """
        @return new ObjBuilder with initial state set to fields of this instance.
        """
            ...
        @classmethod
        def builder(cls) -> ObjBuilder[DataInteg.Pipeline.Step.Load.OutputConfiguration[C]]:
        """
        @return new ObjBuilder of this instance.
        """
            ...
        @overload
        @classmethod
        def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> DataInteg.Pipeline.Step.Load.OutputConfiguration[C]:
        """
        Construct instance of this type from provided field values and options
        """
            ...
        @overload
        @classmethod
        def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> DataInteg.Pipeline.Step.Load.OutputConfiguration[C]:
        """
        Construct an instance of this type from provided fields
        @param fields
                   Fields to construct the instance of the obj with
        ...
        @overload
        @classmethod
        def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> DataInteg.Pipeline.Step.Load.OutputConfiguration[C]:
        """
        Construct instance of this type from provided field values and options
        """
            ...
        @overload
        @classmethod
        def make(cls, withDefaults: bool=None) -> DataInteg.Pipeline.Step.Load.OutputConfiguration[C]:
        """
        Construct an instance of this type with no non-default field values unless explicitly specified by passing param true
        @param withDefaults
                   If set, then the Obj is made with default & initial values (required primitive fields e.g. !int32 -> 0)
        ...
        @overload
        @classmethod
        def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> DataInteg.Pipeline.Step.Load.OutputConfiguration[C]:
        """
        Construct an instance from provided fields
        @param fields
                   Fields (in the format <field_name, value>) to construct an instance of the obj. Note that "type" as a
        ...
        @overload
        @classmethod
        def make(cls, fields: Any, withDefaults: bool=None) -> DataInteg.Pipeline.Step.Load.OutputConfiguration[C]:
        """
        Construct an instance of this type from provided fields. Note it is more efficient to use #fromFields and other overloads
        ...
        @overload
        @classmethod
        def make(cls, s: str) -> Union[DataInteg.Pipeline.Step.Load.OutputConfiguration[C]]:
        """
        Construct an instance of this type from the string. This is an alias for #fromString, as a specific overload
        when the argument is a known string.
        ...
        """
            ...
        @classmethod
        def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> DataInteg.Pipeline.Step.Load.OutputConfiguration[C]:
        """
        Construct an instance of this type from provided instance of a subtype or a "duck type".
        """
            ...
        ...
        """
            ...
        def afterMake(self) -> DataInteg.Pipeline.Step.Load.OutputConfiguration[C]:
        """
        Optional override that will be called after every instance creation.
        ...
        """
            ...
        @classmethod
        def cachedEmptyInst(cls) -> DataInteg.Pipeline.Step.Load.OutputConfiguration[C]:
        """
        Creates an empty inst using `MyType.make()` and caches it. Avoid recreating multiple copies of the spec for
        every action dispatch. The cached inst can also be used for comparing whether the object is an empty or not
        Will only create empty instance for immutable Obj e.g. if an Obj is Mutable, this method will throw an error
        ...
        """
            ...
        @classmethod
        def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[DataInteg.Pipeline.Step.Load.OutputConfiguration[C]]]:
        """
        Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
        value is read.
        """
            ...
        @classmethod
        def generateObj(cls, spec: Obj.GenerateSpec=None) -> DataInteg.Pipeline.Step.Load.OutputConfiguration[C]:
        """
        Generate a single instance of this type. The base implementation uses {@link DataGenObj} to generate uniform
        random (gibberish) values for all fields, but it may be overridden by specific types with custom logic that
        populates fields in a more realistic way.
        ...
        """
            ...
        @classmethod
        def fromString(cls, s: str) -> Union[DataInteg.Pipeline.Step.Load.OutputConfiguration[C]]:
        """
        Parse the string-based representation and reconstruct the corresponding instance. This must be implemented to
        provide deserialization.
        ...
        class DataLakeConfig(DataInteg.Pipeline.Step.Load.OutputConfiguration.Config, DataLake.Table.WriteSpec):
            """
            Runtime configurations for writing to a datalake table from a {@link SourceCollection}.
            
            @remarks this represents a made instance of DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLakeConfig
            """
            ...
            """
            List of column names to match. It's required when the mode is MERGE
            e.g. df.write_table(table, mode="merge", on=["id", "timestamp"]) will match rows in df and table that have the same id and timestamp
            """

            how: Optional[MergeActions]=None
            """
            Define merge actions based on specified conditions. Only applicable when mode is 'merge'. See {@link MergeActions} for more details.
            """

            createTableSpec: Optional[DataLake.CreateTableSpec]=None
            """
            Specifications for creating a table if missing;
            if empty, table is inferred using DataLake.CreateTableSpec.fromSource
            """

            catalog: Optional[str]=None
            """
            The datalake catalog instance
            """

            folderName: Optional[str]=None
            """
            Target folder name in the Data Lake
            """

            fileFormat: Optional[str]=None
            """
            Format of files to be written (e.g., parquet, csv)
            """
            ...
            """
            def __init__(self, configOverride: Optional[str]=None, secretOverride: Optional[str]=None, issues: Optional[Array[str]]=None, id: Optional[str]=None, mode: Optional[str]=None, on: Optional[Array[str]]=None, how: Optional[MergeActions]=None, createTableSpec: Optional[DataLake.CreateTableSpec]=None, catalog: Optional[str]=None, folderName: Optional[str]=None, fileFormat: Optional[str]=None, filePath: Optional[str]=None, objectPath: Optional[str]=None) -> None: ...
            ...
            """
                ...
            @classmethod
            def fromJson(cls, json: any) -> Union[DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLakeConfig]:
            """
            Load the JSON-based representation and reconstruct the corresponding object.
            ...
            """
                ...
            @classmethod
            def fromJsonString(cls, json: str) -> Union[DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLakeConfig]:
            """
            Load the JSON-based representation and reconstruct the corresponding object.
            ...
            """
                ...
            @classmethod
            def fromXmlString(cls, xml: str) -> Union[DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLakeConfig]:
            """
            Load the XML-based representation and reconstruct the corresponding object.
            ...
            """
                ...
            @classmethod
            def deserialize(cls, contentStr: str, contentType: str) -> Union[DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLakeConfig]:
            """
            Load from contentType representation and reconstruct the corresponding object.
            ...
            """
                ...
            def replaceType(self, old: Type, new: Type) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLakeConfig:
            """
            Returns new instance with all references to old type, including result of #type, replaced with new type. If new
            type does not contain fields from old or field value types are not convertable then drops the field.
            ...
            """
                ...
            @overload
            def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLakeConfig:
            """
            Result of this function call is a copy of current instance with all non empty fields replaced based on results of
            the `mapper` invocation.
            ...
            """
                ...
            @overload
            def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLakeConfig:
            """
            Result of this function call is a copy of current instance with all fields replaced based on results of the
            `mapper` invocation.
            ...
            """
                ...
            @overload
            def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLakeConfig]:
            """
            Result of this function call is a copy of current instance with all non empty fields replaced based on results of
            the asynchronous `mapper` invocation.
            ...
            """
                ...
            @overload
            def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLakeConfig]:
            """
            Result of this function call is a copy of current instance with all fields replaced based on results of the
            asynchronous `mapper` invocation.
            ...
            """
                ...
            def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLakeConfig:
            """
            Result of this function call is a copy of current instance with specified field value replaced based on result of
            the `mapper` invocation.
            @param field
            ...
            """
                ...
            @overload
            def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLakeConfig:
            """
            Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
            lambda application.
            ...
            """
                ...
            @overload
            def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLakeConfig:
            """
            Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
            lambda application.
            ...
            """
                ...
            @overload
            def validateObj(self) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLakeConfig:
            """
            Populates all missing default values and throws error if any constraint is violated.
            """
                ...
            ...
            """
                ...
            @overload
            def withField(self, field: str, value: Any, doNotConvert: bool=None) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLakeConfig:
            """
            Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
            defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
            ...
            """
                ...
            @overload
            def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLakeConfig:
            """
            Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
            defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
            ...
            """
                ...
            def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLakeConfig:
            """
            Builds a new Obj instance by adding the provided fields in it. The name must correspond to an existing fields
            defined on this type or its mixins. The values must be of the correct type if doNotConvert flag is true.
            ...
            """
                ...
            def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLakeConfig:
            """
            Builds a new Obj with the value at the specified path field. If the field is null, the field #isFieldSet to null.
            If you would like to #unsetField, you should call #withoutFieldAtPath instead.
            ...
            """
                ...
            def withoutFieldAtPath(self, path: str) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLakeConfig:
            """
            Builds a new Obj without the specified path field.
            ...
            """
                ...
            @overload
            def withoutField(self, field: str) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLakeConfig:
            """
            Builds a new Obj, removing the field with the provided name.
            ...
            """
                ...
            @overload
            def withoutField(self, field: FieldType) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLakeConfig:
            """
            Builds a new Obj, removing the field with the provided field type.
            ...
            """
                ...
            def withoutFields(self, fields: Array[str]) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLakeConfig:
            """
            Builds a new Obj, removing the fields with the provided names.
            ...
            """
                ...
            def withoutFieldsByType(self, fields: Array[FieldType]) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLakeConfig:
            """
            Builds a new Obj, removing the fields with the provided field types. Be sure to use the FieldType instance for the
            exact same type as the type of the obj to respect the "ordinal" of the field type
            ...
            """
                ...
            def withoutSecretFields(self) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLakeConfig:
            """
            @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
            """
                ...
            ...
            """
                ...
            def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLakeConfig:
            """
            Builds a new Obj instance by adding the default values (if defined) for all unset fields. This is implemented by
            calling {@link FieldType#defaultValue defaultValue} for a field if it is not already set and
            {@link FieldType#hasDefault has a default}. It will also set {@see ValueType#initialValue initial values} for
            ...
            """
                ...
            @overload
            def defaultField(self, field: str) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLakeConfig:
            """
            Builds a new Obj, by setting a field on this `Obj` to the field's default value. If the field has no default, this
            method will behave the same as {@link #unsetField}.
            ...
            """
                ...
            @overload
            def defaultField(self, field: FieldType) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLakeConfig:
            """
            Builds a new Obj, by setting a field on this `Obj` to the fields default value. If the field has no default, this
            method will behave the same as {@link #unsetField}.
            ...
            """
                ...
            @overload
            def unsetField(self, field: str) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLakeConfig:
            """
            Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
            is different from {@link removeField}
            ...
            """
                ...
            @overload
            def unsetField(self, field: FieldType) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLakeConfig:
            """
            Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
            is different from {@link removeField}
            ...
            """
                ...
            @overload
            def removeField(self, field: str) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLakeConfig:
            """
            Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
            is different from {@link #unsetField}
            ...
            """
                ...
            @overload
            def removeField(self, field: FieldType) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLakeConfig:
            """
            Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
            is different from {@link #unsetField}
            ...
            """
                ...
            @overload
            def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLakeConfig:
            """
            Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
            In case of conflicts, fields of other instance take precedence unless otherwise specified by the fieldPathMergeSpec
            ...
            """
                ...
            @overload
            def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLakeConfig:
            """
            Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
            In case of conflicts, fields of other instance take precedence.
            ...
            """
                ...
            @overload
            def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLakeConfig:
            """
            Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
            fields that exist on other Obj and do not exist on this Obj will not be added to final Obj.
            @param deep
            ...
            """
                ...
            @overload
            def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLakeConfig:
            """
            Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
            fields that exist other Obj and do not exist on this Obj will not be added to final Obj or evaluated. Does not
            traverse child reference and collection fields.
            ...
            """
                ...
            def mergeJson(self, json: any) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLakeConfig:
                ...
            def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLakeConfig:
            """
            Merge the obj references within the current obj
            @param deep
                   If set, traverses the reference fields within the obj as well for a deep merge
            ...
            """
                ...
            def sumObj(self, other: Obj, deep: bool=None) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLakeConfig:
            """
            Adds the numeric Obj fields with the other Objs respective fields.
            If deep is set it will traverse reference and collection fields and sum corresponding numeric fields in
            references with same name and collection elements at same index or key.
            """
                ...
            def singletonArray(self) -> Array[DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLakeConfig]:
            """
            Build an array of the correct type with a single element which is this instance.
            ...
            """
                ...
            @classmethod
            def array(cls, *elements: Array[Any]) -> Union[Array[DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLakeConfig]]:
            """
            Creates an array of instances of this type.
            """
                ...
            @classmethod
            def arrayBuilder(cls) -> Union[ArrayBuilder[DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLakeConfig]]:
            """
            Creates an array of instances of this type.
            """
                ...
            def singletonSet(self) -> Set[DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLakeConfig]:
            """
            Build an set of the correct type with a single element which is this instance.
            ...
            """
                ...
            @classmethod
            def setBuilder(cls) -> Union[SetBuilder[DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLakeConfig]]:
            """
            Creates a set of instances of this type.
            """
                ...
            @classmethod
            def mapBuilder(cls) -> Union[MapBuilder[str, DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLakeConfig]]:
            """
            Create a map of string to elements of this type.
            """
                ...
            @classmethod
            def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLakeConfig]]:
            """
            Create a map with the given key type and elements of this type.
            """
                ...
            ...
            def myStreamType(cls) -> StreamType:
                ...
            def toBuilder(self) -> ObjBuilder[DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLakeConfig]:
            """
            @return new ObjBuilder with initial state set to fields of this instance.
            """
                ...
            @classmethod
            def builder(cls) -> ObjBuilder[DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLakeConfig]:
            """
            @return new ObjBuilder of this instance.
            """
                ...
            @overload
            @classmethod
            def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLakeConfig:
            """
            Construct instance of this type from provided field values and options
            """
                ...
            @overload
            @classmethod
            def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLakeConfig:
            """
            Construct an instance of this type from provided fields
            @param fields
                       Fields to construct the instance of the obj with
            ...
            @overload
            @classmethod
            def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLakeConfig:
            """
            Construct instance of this type from provided field values and options
            """
                ...
            @overload
            @classmethod
            def make(cls, withDefaults: bool=None) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLakeConfig:
            """
            Construct an instance of this type with no non-default field values unless explicitly specified by passing param true
            @param withDefaults
                       If set, then the Obj is made with default & initial values (required primitive fields e.g. !int32 -> 0)
            ...
            @overload
            @classmethod
            def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLakeConfig:
            """
            Construct an instance from provided fields
            @param fields
                       Fields (in the format <field_name, value>) to construct an instance of the obj. Note that "type" as a
            ...
            @overload
            @classmethod
            def make(cls, fields: Any, withDefaults: bool=None) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLakeConfig:
            """
            Construct an instance of this type from provided fields. Note it is more efficient to use #fromFields and other overloads
            ...
            @overload
            @classmethod
            def make(cls, s: str) -> Union[DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLakeConfig]:
            """
            Construct an instance of this type from the string. This is an alias for #fromString, as a specific overload
            when the argument is a known string.
            ...
            """
                ...
            @classmethod
            def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLakeConfig:
            """
            Construct an instance of this type from provided instance of a subtype or a "duck type".
            """
                ...
            ...
            """
                ...
            def afterMake(self) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLakeConfig:
            """
            Optional override that will be called after every instance creation.
            ...
            """
                ...
            @classmethod
            def cachedEmptyInst(cls) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLakeConfig:
            """
            Creates an empty inst using `MyType.make()` and caches it. Avoid recreating multiple copies of the spec for
            every action dispatch. The cached inst can also be used for comparing whether the object is an empty or not
            Will only create empty instance for immutable Obj e.g. if an Obj is Mutable, this method will throw an error
            ...
            """
                ...
            @classmethod
            def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLakeConfig]]:
            """
            Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
            value is read.
            """
                ...
            @classmethod
            def generateObj(cls, spec: Obj.GenerateSpec=None) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLakeConfig:
            """
            Generate a single instance of this type. The base implementation uses {@link DataGenObj} to generate uniform
            random (gibberish) values for all fields, but it may be overridden by specific types with custom logic that
            populates fields in a more realistic way.
            ...
            """
                ...
            @classmethod
            def allCached(cls, doNotProduceAll: bool=None) -> Union[Stream[DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLakeConfig]]:
            """
            @param doNotProduceAll if true, will not populate cache and only return available cached instances. Will call
                   `produceAll` if cache is empty or if Ann.cache.all is true & data has not previously been fetched.
            @return stream of all available Cached instances.
            """
                ...
            @classmethod
            def find(cls, filter: str=None, doNotProduceAll: bool=None) -> Union[Stream[DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLakeConfig]]:
            """
            @param filter C3 expression based predicate to filter instances. e.g. `field1=='value1' && field2>17`
            @param doNotProduceAll if true, will not populate cache and only return available cached instances. Will call
                   `produceAll` if cache is empty or if Ann.cache.all is true & data has not previously been fetched.
            ...
            """
                ...
            @classmethod
            def findBy(cls, field: str, value: Any, doNotProduceAll: bool=None) -> Union[Stream[DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLakeConfig]]:
            """
            @param doNotProduceAll if true, will not populate cache and only return available cached instances. Will call
                   `produceAll` if cache is empty or if Ann.cache.all is true & data has not previously been fetched.
            @return existing instances of this type that satisfy filter from data cache.
            """
                ...
            @classmethod
            def findByCacheKey(cls, key: str) -> Union[DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLakeConfig]:
            """
            @return cached instance by the cache key. Only returns already cached instances, will not populate cache.
            ...
            """
                ...
            @classmethod
            def forCacheKey(cls, key: str) -> Union[DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLakeConfig]:
            """
            Returns cached instance by key, with secrets removed.
            """
                ...
            def getCached(self) -> Union[DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLakeConfig]:
            """
            @return cached instance.
            ...
            """
                ...
            def refreshCache(self) -> Union[DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLakeConfig]:
            """
            @return newly produced cached instance.
            """
                ...
            ...
            """
                ...
            @classmethod
            def produce(cls, key: str) -> Union[DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLakeConfig]:
            """
            Should produce an entry for the cache key. This method should not be called directly.
            """
                ...
            @classmethod
            def produceAll(cls) -> Union[Map[str, DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLakeConfig]]:
            """
            Produces up to 10,000 entries for the cached data and populates the cache with the produced data. You can change the max entry count with {@link Ann.Cache#maxSize}.
            """
                ...
            @classmethod
            def doProduceAll(cls) -> Union[Map[str, DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLakeConfig]]:
            """
            Override for sub-types to produce all values.
            """
                ...
            ...
            """
                ...
            def getConfig(self) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLakeConfig:
            """
            ...
            """
                ...
            def getSecret(self) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLakeConfig:
            """
            ...
            """
                ...
            @classmethod
            def forConfigKey(cls, configKey: str) -> Union[DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLakeConfig]:
            """
            ...
            """
                ...
            @classmethod
            def listConfigs(cls, parallel: bool=None, filter: Callable[[str], bool]=None) -> Union[Stream[DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLakeConfig]]:
            """
            @param
            ...
            """
                ...
            @overload
            def setConfigValues(self, from_: DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLakeConfig, override: str=None) -> None:
            """
            ...
            """
                ...
            @overload
            def setSecretValues(self, from_: DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLakeConfig, override: str=None) -> None:
            """
            ...
            """
                ...
            @classmethod
            def loadConfigAndSecret(cls, configKey: str) -> Union[DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLakeConfig]:
            """
            ...
            """
                ...
            def removeSecrets(self) -> Union[DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLakeConfig]:
            """
            @return this config without any secret values.
            """
                ...
            def removeNonSecrets(self) -> Union[DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLakeConfig]:
            """
            @return this config with only secret values.
            """
                ...
            def validate(self) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLakeConfig:
            """
            ...
            """
                ...
            @classmethod
            def fromString(cls, s: str) -> Union[DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLakeConfig]:
            """
            Parse the string-based representation and reconstruct the corresponding instance. This must be implemented to
            provide deserialization.
        ...
        class DataLake(DataInteg.Pipeline.Step.Load.OutputConfiguration[DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLakeConfig]):
            """
            This step is responsible for writing to a datastore from a {@link FileSourceCollection}
            
            @remarks this represents a made instance of DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLake
            """
            ...
            """
                ...
            @classmethod
            def fromJson(cls, json: any) -> Union[DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLake]:
            """
            Load the JSON-based representation and reconstruct the corresponding object.
            ...
            """
                ...
            @classmethod
            def fromJsonString(cls, json: str) -> Union[DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLake]:
            """
            Load the JSON-based representation and reconstruct the corresponding object.
            ...
            """
                ...
            @classmethod
            def fromXmlString(cls, xml: str) -> Union[DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLake]:
            """
            Load the XML-based representation and reconstruct the corresponding object.
            ...
            """
                ...
            @classmethod
            def deserialize(cls, contentStr: str, contentType: str) -> Union[DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLake]:
            """
            Load from contentType representation and reconstruct the corresponding object.
            ...
            """
                ...
            def replaceType(self, old: Type, new: Type) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLake:
            """
            Returns new instance with all references to old type, including result of #type, replaced with new type. If new
            type does not contain fields from old or field value types are not convertable then drops the field.
            ...
            """
                ...
            @overload
            def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLake:
            """
            Result of this function call is a copy of current instance with all non empty fields replaced based on results of
            the `mapper` invocation.
            ...
            """
                ...
            @overload
            def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLake:
            """
            Result of this function call is a copy of current instance with all fields replaced based on results of the
            `mapper` invocation.
            ...
            """
                ...
            @overload
            def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLake]:
            """
            Result of this function call is a copy of current instance with all non empty fields replaced based on results of
            the asynchronous `mapper` invocation.
            ...
            """
                ...
            @overload
            def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLake]:
            """
            Result of this function call is a copy of current instance with all fields replaced based on results of the
            asynchronous `mapper` invocation.
            ...
            """
                ...
            def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLake:
            """
            Result of this function call is a copy of current instance with specified field value replaced based on result of
            the `mapper` invocation.
            @param field
            ...
            """
                ...
            @overload
            def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLake:
            """
            Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
            lambda application.
            ...
            """
                ...
            @overload
            def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLake:
            """
            Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
            lambda application.
            ...
            """
                ...
            @overload
            def validateObj(self) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLake:
            """
            Populates all missing default values and throws error if any constraint is violated.
            """
                ...
            ...
            """
                ...
            @overload
            def withField(self, field: str, value: Any, doNotConvert: bool=None) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLake:
            """
            Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
            defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
            ...
            """
                ...
            @overload
            def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLake:
            """
            Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
            defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
            ...
            """
                ...
            def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLake:
            """
            Builds a new Obj instance by adding the provided fields in it. The name must correspond to an existing fields
            defined on this type or its mixins. The values must be of the correct type if doNotConvert flag is true.
            ...
            """
                ...
            def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLake:
            """
            Builds a new Obj with the value at the specified path field. If the field is null, the field #isFieldSet to null.
            If you would like to #unsetField, you should call #withoutFieldAtPath instead.
            ...
            """
                ...
            def withoutFieldAtPath(self, path: str) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLake:
            """
            Builds a new Obj without the specified path field.
            ...
            """
                ...
            @overload
            def withoutField(self, field: str) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLake:
            """
            Builds a new Obj, removing the field with the provided name.
            ...
            """
                ...
            @overload
            def withoutField(self, field: FieldType) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLake:
            """
            Builds a new Obj, removing the field with the provided field type.
            ...
            """
                ...
            def withoutFields(self, fields: Array[str]) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLake:
            """
            Builds a new Obj, removing the fields with the provided names.
            ...
            """
                ...
            def withoutFieldsByType(self, fields: Array[FieldType]) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLake:
            """
            Builds a new Obj, removing the fields with the provided field types. Be sure to use the FieldType instance for the
            exact same type as the type of the obj to respect the "ordinal" of the field type
            ...
            """
                ...
            def withoutSecretFields(self) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLake:
            """
            @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
            """
                ...
            ...
            """
                ...
            def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLake:
            """
            Builds a new Obj instance by adding the default values (if defined) for all unset fields. This is implemented by
            calling {@link FieldType#defaultValue defaultValue} for a field if it is not already set and
            {@link FieldType#hasDefault has a default}. It will also set {@see ValueType#initialValue initial values} for
            ...
            """
                ...
            @overload
            def defaultField(self, field: str) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLake:
            """
            Builds a new Obj, by setting a field on this `Obj` to the field's default value. If the field has no default, this
            method will behave the same as {@link #unsetField}.
            ...
            """
                ...
            @overload
            def defaultField(self, field: FieldType) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLake:
            """
            Builds a new Obj, by setting a field on this `Obj` to the fields default value. If the field has no default, this
            method will behave the same as {@link #unsetField}.
            ...
            """
                ...
            @overload
            def unsetField(self, field: str) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLake:
            """
            Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
            is different from {@link removeField}
            ...
            """
                ...
            @overload
            def unsetField(self, field: FieldType) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLake:
            """
            Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
            is different from {@link removeField}
            ...
            """
                ...
            @overload
            def removeField(self, field: str) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLake:
            """
            Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
            is different from {@link #unsetField}
            ...
            """
                ...
            @overload
            def removeField(self, field: FieldType) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLake:
            """
            Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
            is different from {@link #unsetField}
            ...
            """
                ...
            @overload
            def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLake:
            """
            Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
            In case of conflicts, fields of other instance take precedence unless otherwise specified by the fieldPathMergeSpec
            ...
            """
                ...
            @overload
            def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLake:
            """
            Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
            In case of conflicts, fields of other instance take precedence.
            ...
            """
                ...
            @overload
            def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLake:
            """
            Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
            fields that exist on other Obj and do not exist on this Obj will not be added to final Obj.
            @param deep
            ...
            """
                ...
            @overload
            def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLake:
            """
            Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
            fields that exist other Obj and do not exist on this Obj will not be added to final Obj or evaluated. Does not
            traverse child reference and collection fields.
            ...
            """
                ...
            def mergeJson(self, json: any) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLake:
                ...
            def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLake:
            """
            Merge the obj references within the current obj
            @param deep
                   If set, traverses the reference fields within the obj as well for a deep merge
            ...
            """
                ...
            def sumObj(self, other: Obj, deep: bool=None) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLake:
            """
            Adds the numeric Obj fields with the other Objs respective fields.
            If deep is set it will traverse reference and collection fields and sum corresponding numeric fields in
            references with same name and collection elements at same index or key.
            """
                ...
            def singletonArray(self) -> Array[DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLake]:
            """
            Build an array of the correct type with a single element which is this instance.
            ...
            """
                ...
            @classmethod
            def array(cls, *elements: Array[Any]) -> Union[Array[DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLake]]:
            """
            Creates an array of instances of this type.
            """
                ...
            @classmethod
            def arrayBuilder(cls) -> Union[ArrayBuilder[DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLake]]:
            """
            Creates an array of instances of this type.
            """
                ...
            def singletonSet(self) -> Set[DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLake]:
            """
            Build an set of the correct type with a single element which is this instance.
            ...
            """
                ...
            @classmethod
            def setBuilder(cls) -> Union[SetBuilder[DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLake]]:
            """
            Creates a set of instances of this type.
            """
                ...
            @classmethod
            def mapBuilder(cls) -> Union[MapBuilder[str, DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLake]]:
            """
            Create a map of string to elements of this type.
            """
                ...
            @classmethod
            def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLake]]:
            """
            Create a map with the given key type and elements of this type.
            """
                ...
            ...
            def myStreamType(cls) -> StreamType:
                ...
            def toBuilder(self) -> ObjBuilder[DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLake]:
            """
            @return new ObjBuilder with initial state set to fields of this instance.
            """
                ...
            @classmethod
            def builder(cls) -> ObjBuilder[DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLake]:
            """
            @return new ObjBuilder of this instance.
            """
                ...
            @overload
            @classmethod
            def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLake:
            """
            Construct instance of this type from provided field values and options
            """
                ...
            @overload
            @classmethod
            def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLake:
            """
            Construct an instance of this type from provided fields
            @param fields
                       Fields to construct the instance of the obj with
            ...
            @overload
            @classmethod
            def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLake:
            """
            Construct instance of this type from provided field values and options
            """
                ...
            @overload
            @classmethod
            def make(cls, withDefaults: bool=None) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLake:
            """
            Construct an instance of this type with no non-default field values unless explicitly specified by passing param true
            @param withDefaults
                       If set, then the Obj is made with default & initial values (required primitive fields e.g. !int32 -> 0)
            ...
            @overload
            @classmethod
            def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLake:
            """
            Construct an instance from provided fields
            @param fields
                       Fields (in the format <field_name, value>) to construct an instance of the obj. Note that "type" as a
            ...
            @overload
            @classmethod
            def make(cls, fields: Any, withDefaults: bool=None) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLake:
            """
            Construct an instance of this type from provided fields. Note it is more efficient to use #fromFields and other overloads
            ...
            @overload
            @classmethod
            def make(cls, s: str) -> Union[DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLake]:
            """
            Construct an instance of this type from the string. This is an alias for #fromString, as a specific overload
            when the argument is a known string.
            ...
            """
                ...
            @classmethod
            def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLake:
            """
            Construct an instance of this type from provided instance of a subtype or a "duck type".
            """
                ...
            ...
            """
                ...
            def afterMake(self) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLake:
            """
            Optional override that will be called after every instance creation.
            ...
            """
                ...
            @classmethod
            def cachedEmptyInst(cls) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLake:
            """
            Creates an empty inst using `MyType.make()` and caches it. Avoid recreating multiple copies of the spec for
            every action dispatch. The cached inst can also be used for comparing whether the object is an empty or not
            Will only create empty instance for immutable Obj e.g. if an Obj is Mutable, this method will throw an error
            ...
            """
                ...
            @classmethod
            def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLake]]:
            """
            Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
            value is read.
            """
                ...
            @classmethod
            def generateObj(cls, spec: Obj.GenerateSpec=None) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLake:
            """
            Generate a single instance of this type. The base implementation uses {@link DataGenObj} to generate uniform
            random (gibberish) values for all fields, but it may be overridden by specific types with custom logic that
            populates fields in a more realistic way.
            ...
            """
                ...
            @classmethod
            def fromString(cls, s: str) -> Union[DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLake]:
            """
            Parse the string-based representation and reconstruct the corresponding instance. This must be implemented to
            provide deserialization.
            ...
            """
                ...
            def config(self, secrets: bool=None) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLakeConfig:
            """
            Returns cached configuration for instance of this type. See Configurable type documentation for more details.
            ...
            """
                ...
            @classmethod
            def typeConfig(cls) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.DataLakeConfig:
            """
            @return type configuration for the given {@link Configurable} type.
            E.g. {@see REST} & {@see RestConfig}
            """
                ...
            def dataLakeCatalog(self) -> Union[DataLake.Catalog[DataLake.Table, DataLake.Catalog.Config]]:
            """
            Retrieves the catalog associated with this step.
            This method is used to access metadata and configuration related to the data lake catalog.
            
            @return The DataLake.Catalog instance.
            """
                ...
            def dataLakeCreateTableSpec(self, sourceCollection: SourceCollection[SourceCollection.Config]=None) -> Union[DataLake.CreateTableSpec]:
            """
            Helper function to return the table specification associated with this step.
            If missing, it creates the default spec based on the given source collection.
            
            @param sourceCollection The source collection from which to derive the table spec.
            @return The DataLake.CreateTableSpec instance.
            """
                ...
        
        class Config(Config, Identifiable):
            """
            @remarks this represents a made instance of DataInteg.Pipeline.Step.Load.OutputConfiguration.Config
            """
            ...
            The id of this instance.
            """
            def __init__(self, configOverride: Optional[str]=None, secretOverride: Optional[str]=None, issues: Optional[Array[str]]=None, id: Optional[str]=None) -> None: ...
            ...
            """
                ...
            @classmethod
            def fromJson(cls, json: any) -> Union[DataInteg.Pipeline.Step.Load.OutputConfiguration.Config]:
            """
            Load the JSON-based representation and reconstruct the corresponding object.
            ...
            """
                ...
            @classmethod
            def fromJsonString(cls, json: str) -> Union[DataInteg.Pipeline.Step.Load.OutputConfiguration.Config]:
            """
            Load the JSON-based representation and reconstruct the corresponding object.
            ...
            """
                ...
            @classmethod
            def fromXmlString(cls, xml: str) -> Union[DataInteg.Pipeline.Step.Load.OutputConfiguration.Config]:
            """
            Load the XML-based representation and reconstruct the corresponding object.
            ...
            """
                ...
            @classmethod
            def deserialize(cls, contentStr: str, contentType: str) -> Union[DataInteg.Pipeline.Step.Load.OutputConfiguration.Config]:
            """
            Load from contentType representation and reconstruct the corresponding object.
            ...
            """
                ...
            def replaceType(self, old: Type, new: Type) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.Config:
            """
            Returns new instance with all references to old type, including result of #type, replaced with new type. If new
            type does not contain fields from old or field value types are not convertable then drops the field.
            ...
            """
                ...
            @overload
            def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.Config:
            """
            Result of this function call is a copy of current instance with all non empty fields replaced based on results of
            the `mapper` invocation.
            ...
            """
                ...
            @overload
            def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.Config:
            """
            Result of this function call is a copy of current instance with all fields replaced based on results of the
            `mapper` invocation.
            ...
            """
                ...
            @overload
            def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[DataInteg.Pipeline.Step.Load.OutputConfiguration.Config]:
            """
            Result of this function call is a copy of current instance with all non empty fields replaced based on results of
            the asynchronous `mapper` invocation.
            ...
            """
                ...
            @overload
            def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[DataInteg.Pipeline.Step.Load.OutputConfiguration.Config]:
            """
            Result of this function call is a copy of current instance with all fields replaced based on results of the
            asynchronous `mapper` invocation.
            ...
            """
                ...
            def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.Config:
            """
            Result of this function call is a copy of current instance with specified field value replaced based on result of
            the `mapper` invocation.
            @param field
            ...
            """
                ...
            @overload
            def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.Config:
            """
            Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
            lambda application.
            ...
            """
                ...
            @overload
            def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.Config:
            """
            Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
            lambda application.
            ...
            """
                ...
            @overload
            def validateObj(self) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.Config:
            """
            Populates all missing default values and throws error if any constraint is violated.
            """
                ...
            ...
            """
                ...
            @overload
            def withField(self, field: str, value: Any, doNotConvert: bool=None) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.Config:
            """
            Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
            defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
            ...
            """
                ...
            @overload
            def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.Config:
            """
            Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
            defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
            ...
            """
                ...
            def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.Config:
            """
            Builds a new Obj instance by adding the provided fields in it. The name must correspond to an existing fields
            defined on this type or its mixins. The values must be of the correct type if doNotConvert flag is true.
            ...
            """
                ...
            def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.Config:
            """
            Builds a new Obj with the value at the specified path field. If the field is null, the field #isFieldSet to null.
            If you would like to #unsetField, you should call #withoutFieldAtPath instead.
            ...
            """
                ...
            def withoutFieldAtPath(self, path: str) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.Config:
            """
            Builds a new Obj without the specified path field.
            ...
            """
                ...
            @overload
            def withoutField(self, field: str) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.Config:
            """
            Builds a new Obj, removing the field with the provided name.
            ...
            """
                ...
            @overload
            def withoutField(self, field: FieldType) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.Config:
            """
            Builds a new Obj, removing the field with the provided field type.
            ...
            """
                ...
            def withoutFields(self, fields: Array[str]) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.Config:
            """
            Builds a new Obj, removing the fields with the provided names.
            ...
            """
                ...
            def withoutFieldsByType(self, fields: Array[FieldType]) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.Config:
            """
            Builds a new Obj, removing the fields with the provided field types. Be sure to use the FieldType instance for the
            exact same type as the type of the obj to respect the "ordinal" of the field type
            ...
            """
                ...
            def withoutSecretFields(self) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.Config:
            """
            @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
            """
                ...
            ...
            """
                ...
            def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.Config:
            """
            Builds a new Obj instance by adding the default values (if defined) for all unset fields. This is implemented by
            calling {@link FieldType#defaultValue defaultValue} for a field if it is not already set and
            {@link FieldType#hasDefault has a default}. It will also set {@see ValueType#initialValue initial values} for
            ...
            """
                ...
            @overload
            def defaultField(self, field: str) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.Config:
            """
            Builds a new Obj, by setting a field on this `Obj` to the field's default value. If the field has no default, this
            method will behave the same as {@link #unsetField}.
            ...
            """
                ...
            @overload
            def defaultField(self, field: FieldType) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.Config:
            """
            Builds a new Obj, by setting a field on this `Obj` to the fields default value. If the field has no default, this
            method will behave the same as {@link #unsetField}.
            ...
            """
                ...
            @overload
            def unsetField(self, field: str) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.Config:
            """
            Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
            is different from {@link removeField}
            ...
            """
                ...
            @overload
            def unsetField(self, field: FieldType) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.Config:
            """
            Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
            is different from {@link removeField}
            ...
            """
                ...
            @overload
            def removeField(self, field: str) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.Config:
            """
            Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
            is different from {@link #unsetField}
            ...
            """
                ...
            @overload
            def removeField(self, field: FieldType) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.Config:
            """
            Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
            is different from {@link #unsetField}
            ...
            """
                ...
            @overload
            def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.Config:
            """
            Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
            In case of conflicts, fields of other instance take precedence unless otherwise specified by the fieldPathMergeSpec
            ...
            """
                ...
            @overload
            def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.Config:
            """
            Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
            In case of conflicts, fields of other instance take precedence.
            ...
            """
                ...
            @overload
            def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.Config:
            """
            Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
            fields that exist on other Obj and do not exist on this Obj will not be added to final Obj.
            @param deep
            ...
            """
                ...
            @overload
            def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.Config:
            """
            Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
            fields that exist other Obj and do not exist on this Obj will not be added to final Obj or evaluated. Does not
            traverse child reference and collection fields.
            ...
            """
                ...
            def mergeJson(self, json: any) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.Config:
                ...
            def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.Config:
            """
            Merge the obj references within the current obj
            @param deep
                   If set, traverses the reference fields within the obj as well for a deep merge
            ...
            """
                ...
            def sumObj(self, other: Obj, deep: bool=None) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.Config:
            """
            Adds the numeric Obj fields with the other Objs respective fields.
            If deep is set it will traverse reference and collection fields and sum corresponding numeric fields in
            references with same name and collection elements at same index or key.
            """
                ...
            def singletonArray(self) -> Array[DataInteg.Pipeline.Step.Load.OutputConfiguration.Config]:
            """
            Build an array of the correct type with a single element which is this instance.
            ...
            """
                ...
            @classmethod
            def array(cls, *elements: Array[Any]) -> Union[Array[DataInteg.Pipeline.Step.Load.OutputConfiguration.Config]]:
            """
            Creates an array of instances of this type.
            """
                ...
            @classmethod
            def arrayBuilder(cls) -> Union[ArrayBuilder[DataInteg.Pipeline.Step.Load.OutputConfiguration.Config]]:
            """
            Creates an array of instances of this type.
            """
                ...
            def singletonSet(self) -> Set[DataInteg.Pipeline.Step.Load.OutputConfiguration.Config]:
            """
            Build an set of the correct type with a single element which is this instance.
            ...
            """
                ...
            @classmethod
            def setBuilder(cls) -> Union[SetBuilder[DataInteg.Pipeline.Step.Load.OutputConfiguration.Config]]:
            """
            Creates a set of instances of this type.
            """
                ...
            @classmethod
            def mapBuilder(cls) -> Union[MapBuilder[str, DataInteg.Pipeline.Step.Load.OutputConfiguration.Config]]:
            """
            Create a map of string to elements of this type.
            """
                ...
            @classmethod
            def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, DataInteg.Pipeline.Step.Load.OutputConfiguration.Config]]:
            """
            Create a map with the given key type and elements of this type.
            """
                ...
            ...
            def myStreamType(cls) -> StreamType:
                ...
            def toBuilder(self) -> ObjBuilder[DataInteg.Pipeline.Step.Load.OutputConfiguration.Config]:
            """
            @return new ObjBuilder with initial state set to fields of this instance.
            """
                ...
            @classmethod
            def builder(cls) -> ObjBuilder[DataInteg.Pipeline.Step.Load.OutputConfiguration.Config]:
            """
            @return new ObjBuilder of this instance.
            """
                ...
            @overload
            @classmethod
            def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.Config:
            """
            Construct instance of this type from provided field values and options
            """
                ...
            @overload
            @classmethod
            def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.Config:
            """
            Construct an instance of this type from provided fields
            @param fields
                       Fields to construct the instance of the obj with
            ...
            @overload
            @classmethod
            def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.Config:
            """
            Construct instance of this type from provided field values and options
            """
                ...
            @overload
            @classmethod
            def make(cls, withDefaults: bool=None) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.Config:
            """
            Construct an instance of this type with no non-default field values unless explicitly specified by passing param true
            @param withDefaults
                       If set, then the Obj is made with default & initial values (required primitive fields e.g. !int32 -> 0)
            ...
            @overload
            @classmethod
            def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.Config:
            """
            Construct an instance from provided fields
            @param fields
                       Fields (in the format <field_name, value>) to construct an instance of the obj. Note that "type" as a
            ...
            @overload
            @classmethod
            def make(cls, fields: Any, withDefaults: bool=None) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.Config:
            """
            Construct an instance of this type from provided fields. Note it is more efficient to use #fromFields and other overloads
            ...
            @overload
            @classmethod
            def make(cls, s: str) -> Union[DataInteg.Pipeline.Step.Load.OutputConfiguration.Config]:
            """
            Construct an instance of this type from the string. This is an alias for #fromString, as a specific overload
            when the argument is a known string.
            ...
            """
                ...
            @classmethod
            def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.Config:
            """
            Construct an instance of this type from provided instance of a subtype or a "duck type".
            """
                ...
            ...
            """
                ...
            def afterMake(self) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.Config:
            """
            Optional override that will be called after every instance creation.
            ...
            """
                ...
            @classmethod
            def cachedEmptyInst(cls) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.Config:
            """
            Creates an empty inst using `MyType.make()` and caches it. Avoid recreating multiple copies of the spec for
            every action dispatch. The cached inst can also be used for comparing whether the object is an empty or not
            Will only create empty instance for immutable Obj e.g. if an Obj is Mutable, this method will throw an error
            ...
            """
                ...
            @classmethod
            def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[DataInteg.Pipeline.Step.Load.OutputConfiguration.Config]]:
            """
            Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
            value is read.
            """
                ...
            @classmethod
            def generateObj(cls, spec: Obj.GenerateSpec=None) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.Config:
            """
            Generate a single instance of this type. The base implementation uses {@link DataGenObj} to generate uniform
            random (gibberish) values for all fields, but it may be overridden by specific types with custom logic that
            populates fields in a more realistic way.
            ...
            """
                ...
            @classmethod
            def allCached(cls, doNotProduceAll: bool=None) -> Union[Stream[DataInteg.Pipeline.Step.Load.OutputConfiguration.Config]]:
            """
            @param doNotProduceAll if true, will not populate cache and only return available cached instances. Will call
                   `produceAll` if cache is empty or if Ann.cache.all is true & data has not previously been fetched.
            @return stream of all available Cached instances.
            """
                ...
            @classmethod
            def find(cls, filter: str=None, doNotProduceAll: bool=None) -> Union[Stream[DataInteg.Pipeline.Step.Load.OutputConfiguration.Config]]:
            """
            @param filter C3 expression based predicate to filter instances. e.g. `field1=='value1' && field2>17`
            @param doNotProduceAll if true, will not populate cache and only return available cached instances. Will call
                   `produceAll` if cache is empty or if Ann.cache.all is true & data has not previously been fetched.
            ...
            """
                ...
            @classmethod
            def findBy(cls, field: str, value: Any, doNotProduceAll: bool=None) -> Union[Stream[DataInteg.Pipeline.Step.Load.OutputConfiguration.Config]]:
            """
            @param doNotProduceAll if true, will not populate cache and only return available cached instances. Will call
                   `produceAll` if cache is empty or if Ann.cache.all is true & data has not previously been fetched.
            @return existing instances of this type that satisfy filter from data cache.
            """
                ...
            @classmethod
            def findByCacheKey(cls, key: str) -> Union[DataInteg.Pipeline.Step.Load.OutputConfiguration.Config]:
            """
            @return cached instance by the cache key. Only returns already cached instances, will not populate cache.
            ...
            """
                ...
            @classmethod
            def forCacheKey(cls, key: str) -> Union[DataInteg.Pipeline.Step.Load.OutputConfiguration.Config]:
            """
            Returns cached instance by key, with secrets removed.
            """
                ...
            def getCached(self) -> Union[DataInteg.Pipeline.Step.Load.OutputConfiguration.Config]:
            """
            @return cached instance.
            ...
            """
                ...
            def refreshCache(self) -> Union[DataInteg.Pipeline.Step.Load.OutputConfiguration.Config]:
            """
            @return newly produced cached instance.
            """
                ...
            ...
            """
                ...
            @classmethod
            def produce(cls, key: str) -> Union[DataInteg.Pipeline.Step.Load.OutputConfiguration.Config]:
            """
            Should produce an entry for the cache key. This method should not be called directly.
            """
                ...
            @classmethod
            def produceAll(cls) -> Union[Map[str, DataInteg.Pipeline.Step.Load.OutputConfiguration.Config]]:
            """
            Produces up to 10,000 entries for the cached data and populates the cache with the produced data. You can change the max entry count with {@link Ann.Cache#maxSize}.
            """
                ...
            @classmethod
            def doProduceAll(cls) -> Union[Map[str, DataInteg.Pipeline.Step.Load.OutputConfiguration.Config]]:
            """
            Override for sub-types to produce all values.
            """
                ...
            ...
            """
                ...
            def getConfig(self) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.Config:
            """
            Return cached instance of configuration. For Identifiable configurations `id` field is required. For Nameable
            configurations `name` field is required.
            ...
            """
                ...
            def getSecret(self) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.Config:
            """
            Return cached instance of configuration containing only secret values. For Identifiable configuration, `id` field
            is required. For Nameable configurations `name` field is required.
            ...
            """
                ...
            @classmethod
            def forConfigKey(cls, configKey: str) -> Union[DataInteg.Pipeline.Step.Load.OutputConfiguration.Config]:
            """
            @return return cached config instance for provided config key.
            """
                ...
            ...
            """
                ...
            @classmethod
            def listConfigs(cls, parallel: bool=None, filter: Callable[[str], bool]=None) -> Union[Stream[DataInteg.Pipeline.Step.Load.OutputConfiguration.Config]]:
            """
            @param
            ...
            """
                ...
            @overload
            def setConfigValues(self, from_: DataInteg.Pipeline.Step.Load.OutputConfiguration.Config, override: str=None) -> None:
            """
            Sets multiple field values to be the same as the passed instance.
            @see setConfigValue
            """
            ...
            """
                ...
            @overload
            def setSecretValues(self, from_: DataInteg.Pipeline.Step.Load.OutputConfiguration.Config, override: str=None) -> None:
            """
            Sets multiple secret field values to be the same as the passed instance.
            @see setSecretValue
            """
            ...
            """
                ...
            @classmethod
            def loadConfigAndSecret(cls, configKey: str) -> Union[DataInteg.Pipeline.Step.Load.OutputConfiguration.Config]:
            """
             Loads config and secret by key if exists, default config, or `null` if `doNotDefaultIfMissing` config annotation is
            true and config does not exist.
             Note that this skips caching and directly fetches config from the config store, and secret from vault.
            ...
            """
                ...
            def removeSecrets(self) -> Union[DataInteg.Pipeline.Step.Load.OutputConfiguration.Config]:
            """
            @return this config without any secret values.
            """
                ...
            def removeNonSecrets(self) -> Union[DataInteg.Pipeline.Step.Load.OutputConfiguration.Config]:
            """
            @return this config with only secret values.
            """
                ...
            def validate(self) -> DataInteg.Pipeline.Step.Load.OutputConfiguration.Config:
            """
            Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
            validation and setup.
            """
            ...
            """
                ...
            @classmethod
            def fromString(cls, s: str) -> Union[DataInteg.Pipeline.Step.Load.OutputConfiguration.Config]:
            """
            Parse the string-based representation and reconstruct the corresponding instance. This must be implemented to
            provide deserialization.
