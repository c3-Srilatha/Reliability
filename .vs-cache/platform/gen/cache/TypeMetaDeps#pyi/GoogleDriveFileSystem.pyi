...
from c3.platform.GoogleDriveFile import GoogleDriveFile
from c3.platform.Lambda import Lambda
...
# Python definitions for the C3 type GoogleDriveFileSystem


class GoogleDriveFileSystem(DriveFileSystem[GoogleDriveFile], FileSystemConfigurable[GDriveFsConfig]):
    """
    GoogleDrive based FileSystem implementation to interact with GoogleDrive.
    Avoid using it directly - use {@link FileSystem.googleDrive} instead.
    
    @remarks this represents a made instance of GoogleDriveFileSystem
    """
    def __init__(self) -> None: ...

    @classmethod
    def inst(cls) -> GoogleDriveFileSystem:
    """
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[GoogleDriveFileSystem]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[GoogleDriveFileSystem]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[GoogleDriveFileSystem]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[GoogleDriveFileSystem]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> GoogleDriveFileSystem:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> GoogleDriveFileSystem:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> GoogleDriveFileSystem:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[GoogleDriveFileSystem]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[GoogleDriveFileSystem]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> GoogleDriveFileSystem:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> GoogleDriveFileSystem:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> GoogleDriveFileSystem:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> GoogleDriveFileSystem:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> GoogleDriveFileSystem:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> GoogleDriveFileSystem:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> GoogleDriveFileSystem:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> GoogleDriveFileSystem:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> GoogleDriveFileSystem:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> GoogleDriveFileSystem:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> GoogleDriveFileSystem:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> GoogleDriveFileSystem:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> GoogleDriveFileSystem:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> GoogleDriveFileSystem:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> GoogleDriveFileSystem:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> GoogleDriveFileSystem:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> GoogleDriveFileSystem:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> GoogleDriveFileSystem:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> GoogleDriveFileSystem:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> GoogleDriveFileSystem:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> GoogleDriveFileSystem:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> GoogleDriveFileSystem:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> GoogleDriveFileSystem:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> GoogleDriveFileSystem:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> GoogleDriveFileSystem:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> GoogleDriveFileSystem:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> GoogleDriveFileSystem:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> GoogleDriveFileSystem:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[GoogleDriveFileSystem]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[GoogleDriveFileSystem]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[GoogleDriveFileSystem]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[GoogleDriveFileSystem]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[GoogleDriveFileSystem]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, GoogleDriveFileSystem]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, GoogleDriveFileSystem]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[GoogleDriveFileSystem]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[GoogleDriveFileSystem]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> GoogleDriveFileSystem:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> GoogleDriveFileSystem:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> GoogleDriveFileSystem:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> GoogleDriveFileSystem:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> GoogleDriveFileSystem:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> GoogleDriveFileSystem:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> GoogleDriveFileSystem:
    """
    ...
    """
        ...
    def afterMake(self) -> GoogleDriveFileSystem:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> GoogleDriveFileSystem:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[GoogleDriveFileSystem]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> GoogleDriveFileSystem:
    """
    ...
    """
        ...
    def makeFile(self, urlOrEncodedPath: str, contentType: str=None, contentEncoding: str=None) -> DriveFile[DriveFileSystem]:
    """
    ...
    """
        ...
    def doOpenFile(self, file: File, spec: FileOperationSpec=None) -> Union[GoogleDriveFile]:
    """
    Opens file and reads it's metadata. Returns null if file doesn't exist.
    """
        ...
    ...
    """
        ...
    def doCreateFile(self, file: File, spec: FileOperationSpec=None) -> Union[GoogleDriveFile]:
    """
    Creates new file. If file exists truncates it's content.
    ...
    """
        ...
    def cloudClient(self, resourceName: str) -> Any:
        ...
    def outputStream(self, file: DriveFile[DriveFileSystem]=None, spec: FileOperationSpec=None) -> Any:
        ...
    def config(self, secrets: bool=None) -> GDriveFsConfig:
    """
    Returns cached configuration object for instance of this file system.
    """
        ...
    @classmethod
    def rootId(cls, drive: Any) -> Union[str]:
        ...
    def export(self, file: GoogleDriveFile, contentType: str, contentEncoding: str=None, spec: FileCompressSpec=None) -> GoogleDriveFile:
    """
    Exports a given file into a different contentType.
    
    @param file
             The file to be exported
    @param contentType
             The contentType we want to export the file as
    """
        ...
