...
from c3.platform.LukeCore import LukeCore
...
# Python definitions for the C3 type LukeCore

C = TypeVar('C')
E = TypeVar('E')

class LukeCore(Generic[C, E], MutableObj):
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> LukeCore[E, C]:
    """
    ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> LukeCore[E, C]:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> LukeCore[E, C]:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> LukeCore[E, C]:
    """
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[LukeCore[E, C]]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[LukeCore[E, C]]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[LukeCore[E, C]]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[LukeCore[E, C]]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> LukeCore[E, C]:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> LukeCore[E, C]:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> LukeCore[E, C]:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[LukeCore[E, C]]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[LukeCore[E, C]]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> LukeCore[E, C]:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> LukeCore[E, C]:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> LukeCore[E, C]:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> LukeCore[E, C]:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> LukeCore[E, C]:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> LukeCore[E, C]:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> LukeCore[E, C]:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> LukeCore[E, C]:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> LukeCore[E, C]:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> LukeCore[E, C]:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> LukeCore[E, C]:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> LukeCore[E, C]:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> LukeCore[E, C]:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> LukeCore[E, C]:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> LukeCore[E, C]:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> LukeCore[E, C]:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> LukeCore[E, C]:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> LukeCore[E, C]:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> LukeCore[E, C]:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> LukeCore[E, C]:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> LukeCore[E, C]:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> LukeCore[E, C]:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> LukeCore[E, C]:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> LukeCore[E, C]:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> LukeCore[E, C]:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> LukeCore[E, C]:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> LukeCore[E, C]:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> LukeCore[E, C]:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[LukeCore[E, C]]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[LukeCore[E, C]]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[LukeCore[E, C]]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[LukeCore[E, C]]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[LukeCore[E, C]]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, LukeCore[E, C]]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, LukeCore[E, C]]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[LukeCore[E, C]]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[LukeCore[E, C]]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> LukeCore[E, C]:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> LukeCore[E, C]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> LukeCore[E, C]:
    """
    ...
    """
        ...
    def afterMake(self) -> LukeCore[E, C]:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> LukeCore[E, C]:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[LukeCore[E, C]]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> LukeCore[E, C]:
    """
    ...
    """
        ...
    @overload
    def setField(self, field: str, value: Any, doNotConvert: bool=None) -> LukeCore[E, C]:
    """
    ...
    """
        ...
    @overload
    def setField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> LukeCore[E, C]:
    """
    Sets the mutable field value. The name must correspond to an existing field defined on this type or its mixins.
    The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def runChain(self, head: LukeAsyncQueueNode, scope: Union[LukeCore,LukeAsyncQueueNode]=None) -> Union[Promise[Any]]:
    """
    ...
    """
        ...
    def skipQueue(self, scope: Union[LukeCore,LukeAsyncQueueNode]=None) -> None:
    """
    ...
    """
        ...
    def search(self, selector: str, resolveOnFound: bool=None, timeout: int=None) -> Union[E]:
    """
    ...
    """
        ...
    def searchAll(self, selector: str, resolveOnFound: bool=None, timeout: int=None) -> Union[LukeAsyncQueueCollection[E]]:
    """
    ...
    """
        ...
    def searchForElementWithText(self, selector: str, text: Union[str,LukeDynamicValue], resolveOnFound: bool=None, timeout: int=None) -> Union[E]:
    """
    ...
    """
        ...
    def click(self, selector: str, timeout: int=None) -> Union[E]:
    """
    ...
    """
        ...
    def setValue(self, selector: str, value: Union[str,int,bool,LukeDynamicValue]=None, timeout: int=None) -> Union[E]:
    """
