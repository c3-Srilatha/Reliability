...
# Python definitions for the C3 type SqlBatchQueue


class SqlBatchQueue(BatchQueue, Value):
    """
    Invalidation queue for batch job processing.
    
    @remarks this represents a made instance of SqlBatchQueue
    """
