...
# Python definitions for the C3 type SqlPopulateAclQueue


class SqlPopulateAclQueue(PopulateAclQueue, Value):
    """
    Invalidation queue for populateAcl processing.
    
    @remarks this represents a made instance of SqlPopulateAclQueue
    """
