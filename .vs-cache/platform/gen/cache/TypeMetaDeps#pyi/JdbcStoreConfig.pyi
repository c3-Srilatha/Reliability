...
# Python definitions for the C3 type JdbcStoreConfig


class JdbcStoreConfig(DatastoreConfig[JdbcCredentials]):
    """
    ...
    connectionPool: Optional[DatastoreConnectionPoolConfig[DatastoreConfig[JdbcCredentials]]]=None
    """
    Physical pool for connections
    """

    credentials: Optional[JdbcCredentials]=None
    """
    ...
    readConnectionPool: Optional[DatastoreConnectionPoolConfig[DatastoreConfig[JdbcCredentials]]]=None

    writeConnectionPool: Optional[DatastoreConnectionPoolConfig[DatastoreConfig[JdbcCredentials]]]=None

    validateConnections: Optional[bool]=None
    """
    Set to true to validate connections on borrow from the connection pool.
    """
    def __init__(self, configOverride: Optional[str]=None, secretOverride: Optional[str]=None, issues: Optional[Array[str]]=None, name: Optional[str]=None, connectionPool: Optional[DatastoreConnectionPoolConfig[DatastoreConfig[JdbcCredentials]]]=None, credentials: Optional[JdbcCredentials]=None, cloudId: Optional[str]=None, disabled: Optional[bool]=None, readOnly: Optional[bool]=None, external: Optional[bool]=None, perTenant: Optional[bool]=None, description: Optional[str]=None, dedicated: Optional[bool]=None, shareReadConnection: Optional[bool]=None, sharedReadThreshold: Optional[int]=None, readConnectionPool: Optional[DatastoreConnectionPoolConfig[DatastoreConfig[JdbcCredentials]]]=None, writeConnectionPool: Optional[DatastoreConnectionPoolConfig[DatastoreConfig[JdbcCredentials]]]=None, validateConnections: Optional[bool]=None) -> None: ...
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[JdbcStoreConfig]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[JdbcStoreConfig]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[JdbcStoreConfig]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[JdbcStoreConfig]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> JdbcStoreConfig:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> JdbcStoreConfig:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> JdbcStoreConfig:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[JdbcStoreConfig]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[JdbcStoreConfig]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> JdbcStoreConfig:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> JdbcStoreConfig:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> JdbcStoreConfig:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> JdbcStoreConfig:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> JdbcStoreConfig:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> JdbcStoreConfig:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> JdbcStoreConfig:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> JdbcStoreConfig:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> JdbcStoreConfig:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> JdbcStoreConfig:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> JdbcStoreConfig:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> JdbcStoreConfig:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> JdbcStoreConfig:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> JdbcStoreConfig:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> JdbcStoreConfig:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> JdbcStoreConfig:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> JdbcStoreConfig:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> JdbcStoreConfig:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> JdbcStoreConfig:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> JdbcStoreConfig:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> JdbcStoreConfig:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> JdbcStoreConfig:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> JdbcStoreConfig:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> JdbcStoreConfig:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> JdbcStoreConfig:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> JdbcStoreConfig:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> JdbcStoreConfig:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> JdbcStoreConfig:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[JdbcStoreConfig]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[JdbcStoreConfig]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[JdbcStoreConfig]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[JdbcStoreConfig]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[JdbcStoreConfig]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, JdbcStoreConfig]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, JdbcStoreConfig]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[JdbcStoreConfig]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[JdbcStoreConfig]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> JdbcStoreConfig:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> JdbcStoreConfig:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> JdbcStoreConfig:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> JdbcStoreConfig:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> JdbcStoreConfig:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> JdbcStoreConfig:
    """
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[JdbcStoreConfig]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> JdbcStoreConfig:
    """
    ...
    """
        ...
    def afterMake(self) -> JdbcStoreConfig:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> JdbcStoreConfig:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[JdbcStoreConfig]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> JdbcStoreConfig:
    """
    ...
    """
        ...
    @classmethod
    def allCached(cls, doNotProduceAll: bool=None) -> Union[Stream[JdbcStoreConfig]]:
    """
    ...
    """
        ...
    @classmethod
    def find(cls, filter: str=None, doNotProduceAll: bool=None) -> Union[Stream[JdbcStoreConfig]]:
    """
    ...
    """
        ...
    @classmethod
    def findBy(cls, field: str, value: Any, doNotProduceAll: bool=None) -> Union[Stream[JdbcStoreConfig]]:
    """
    @param doNotProduceAll if true, will not populate cache and only return available cached instances. Will call
           `produceAll` if cache is empty or if Ann.cache.all is true & data has not previously been fetched.
    @return existing instances of this type that satisfy filter from data cache.
    """
        ...
    @classmethod
    def findByCacheKey(cls, key: str) -> Union[JdbcStoreConfig]:
    """
    ...
    """
        ...
    @classmethod
    def forCacheKey(cls, key: str) -> Union[JdbcStoreConfig]:
    """
    Returns cached instance by key, with secrets removed.
    """
        ...
    def getCached(self) -> Union[JdbcStoreConfig]:
    """
    ...
    """
        ...
    def refreshCache(self) -> Union[JdbcStoreConfig]:
    """
    ...
    """
        ...
    @classmethod
    def produce(cls, key: str) -> Union[JdbcStoreConfig]:
    """
    Should produce an entry for the cache key. This method should not be called directly.
    """
        ...
    @classmethod
    def produceAll(cls) -> Union[Map[str, JdbcStoreConfig]]:
    """
    ...
    """
        ...
    @classmethod
    def doProduceAll(cls) -> Union[Map[str, JdbcStoreConfig]]:
    """
    ...
    """
        ...
    def getConfig(self) -> JdbcStoreConfig:
    """
    ...
    """
        ...
    def getSecret(self) -> JdbcStoreConfig:
    """
    ...
    """
        ...
    @classmethod
    def forConfigKey(cls, configKey: str) -> Union[JdbcStoreConfig]:
    """
    ...
    """
        ...
    @classmethod
    def listConfigs(cls, parallel: bool=None, filter: Callable[[str], bool]=None) -> Union[Stream[JdbcStoreConfig]]:
    """
    @param
    ...
    """
        ...
    @overload
    def setConfigValues(self, from_: JdbcStoreConfig, override: str=None) -> None:
    """
    ...
    """
        ...
    @overload
    def setSecretValues(self, from_: JdbcStoreConfig, override: str=None) -> None:
    """
    ...
    """
        ...
    @classmethod
    def loadConfigAndSecret(cls, configKey: str) -> Union[JdbcStoreConfig]:
    """
    ...
    """
        ...
    def removeSecrets(self) -> Union[JdbcStoreConfig]:
    """
    @return this config without any secret values.
    """
        ...
    def removeNonSecrets(self) -> Union[JdbcStoreConfig]:
    """
    @return this config with only secret values.
    """
        ...
    def validate(self) -> JdbcStoreConfig:
    """
    ...
    """
        ...
    @classmethod
    def fromString(cls, s: str) -> Union[JdbcStoreConfig]:
    """
    ...
    """
        ...
    @classmethod
    def forName(cls, name: str, failIfMissing: bool=None) -> Union[JdbcStoreConfig]:
    """
    ...
    def credentialsType(self) -> Type:
        ...
    def secretPassword(self) -> Union[str]:
    """
    @return The password from the vault.
    """
        ...
    def secretAdminPassword(self) -> Union[str]:
    """
