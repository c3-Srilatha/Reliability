...
# Python definitions for the C3 type Stream

E = TypeVar('E')

class Stream(Generic[E], PyReprProtocol, StreamStdLib[E], Collection[E], CollectionWithIndex[E], CollectionConstructors[E], Streamable, Closable, Value):
    """
    ...
    onClose: Optional[Callable[[Union[Stream[E]]]]]=None
    """
    Callback lambda on close of this stream
    """
    def __init__(self, onClose: Optional[Callable[[Union[Stream[E]]]]]=None) -> None: ...
    ...
    def mapToSame(self, mapper: Callable[[Union[E]], Union[E]]) -> Union[Stream[E]]:
        ...
    @overload
    def mapToSame(self, mapper: Callable[[Union[E], Union[int]], Union[E]]) -> Union[Stream[E]]:
    """
    ...
    """
        ...
    @overload
    def map(self, mapper: Callable[[Union[E], int], Union[T]]) -> Union[Stream[T]]:
    """
    ...
    def mapToStr(self, mapper: Callable[[Union[E]], Union[str]]) -> Union[Stream[str]]:
        ...
    @overload
    def mapToStr(self, mapper: Callable[[Union[E], int], Union[str]]) -> Union[Stream[str]]:
    """
    ...
    def mapTo(self, elementType: ValueType, mapper: Callable[[Union[E]], Union[T]]) -> Union[Stream[T]]:
        ...
    @overload
    def mapTo(self, elementType: ValueType, mapper: Callable[[Union[E], int], Union[T]]) -> Union[Stream[T]]:
    """
    ...
    def flatMapToSame(self, mapper: Callable[[Union[E]], Union[CollectionStdLib[E]]]) -> Union[Stream[E]]:
        ...
    @overload
    def flatMapToSame(self, mapper: Callable[[Union[E], Union[int]], Union[Stream[E]]]) -> Union[Stream[E]]:
    """
    ...
    def flatMap(self, mapper: Callable[[Union[E]], Union[CollectionStdLib[T]]]) -> Union[Stream[T]]:
        ...
    @overload
    def flatMap(self, mapper: Callable[[Union[E], int], Union[Stream[T]]]) -> Union[Stream[T]]:
    """
    ...
    def flatMapTo(self, elementType: ValueType, mapper: Callable[[Union[E]], Union[CollectionStdLib[T]]]) -> Union[Stream[T]]:
        ...
    @overload
    def flatMapTo(self, elementType: ValueType, mapper: Callable[[Union[E], int], Union[Stream[T]]]) -> Union[Stream[T]]:
    """
    ...
    def uniqueBy(self, key: Callable[[Union[E]], Union[Any]]=None) -> Union[Stream[E]]:
        ...
    @overload
    def uniqueBy(self, key: Callable[[Union[E], Union[int]], Union[Any]]) -> Union[Stream[E]]:
    """
    ...
    def filter(self, fields: Map[str, Any]) -> Union[Stream[E]]:
        ...
    @overload
    def filter(self, predicate: Callable[[Union[E], Union[int]], bool]) -> Union[Stream[E]]:
    """
    ...
    def reject(self, predicate: Callable[[Union[E]], bool]) -> Union[Stream[E]]:
        ...
    @overload
    def reject(self, predicate: Callable[[Union[E], Union[int]], bool]) -> Union[Stream[E]]:
    """
    ...
    def sortedBy(self, descending: bool, key: Callable[[Union[E]], Union[Any]]) -> Union[Stream[E]]:
        ...
    @overload
    def sortedBy(self, key: Callable[[Union[E], Union[int]], Union[Any]]) -> Union[Stream[E]]:
    """
    ...
    """
        ...
    @overload
    def sortedBy(self, descending: bool, key: Callable[[Union[E], Union[int]], Union[Any]]) -> Union[Stream[E]]:
    """
    Maps this collection to another by re-ordering elements based on natural sorting order of a key computed using
    provided lambda.
    """
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[Stream[E]]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[Stream[E]]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[Stream[E]]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[Stream[E]]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> Stream[E]:
    """
    ...
    """
        ...
    def inferType(self) -> Union[Stream[E]]:
    """
    ...
    **within and across chunk/partition**, this method allows for different lambdas to be applied in each case.
    ...
    """
        ...
    def toMixingCollection(self, collectionType: CollectionType, failIfInvalid: bool=None) -> Union[Stream[T]]:
    """
    ...
    """
        ...
    def boxElements(self) -> Union[Stream[Boxed[E]]]:
    """
    @return copy of this collection with all elements Boxed.
    """
        ...
    def anonymize(self, spec: AnonymizationSpec=None) -> Union[Stream[E]]:
    """
    ...
    """
        ...
    def withoutOutliers(self, spec: OutliersSpec='{ stddev: 2 }') -> Stream[E]:
    """
    ...
    """
        ...
    def extractOutliers(self, spec: OutliersSpec='{ stddev: 2 }') -> Stream[E]:
    """
    ...
    """
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> Stream[E]:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> Union[Stream[E]]:
    """
    ...
    """
        ...
    @overload
    def rolling(self, agg: str, offset: int, span: int, step: int=None) -> Union[Stream[E]]:
    """
    ...
    """
        ...
    def replace(self, index: int, e: E) -> Union[Stream[E]]:
    """
    @return copy of this collection with new element at provided index.
    """
        ...
    def initial(self, exceptLastN: int='1') -> Stream[E]:
    """
    Returns everything but the last N entries of the collection
    """
        ...
    def pairs(self) -> Union[Stream[Pair[E, E]]]:
    """
    ...
    """
        ...
    @classmethod
    def of(cls, elementType: ValueType, *elements: Array[T]) -> Union[Stream[T]]:
    """
    @return collection of provided element type and values.
    """
        ...
    @classmethod
    def ofAny(cls, *elements: Array[T]) -> Union[Stream[T]]:
    """
    @return collection of any with provided elements.
    """
        ...
    @classmethod
    def ofBool(cls, *elements: Array[bool]) -> Union[Stream[bool]]:
    """
    @return collection of provided booleans.
    """
        ...
    @classmethod
    def ofInt(cls, *elements: Array[int]) -> Union[Stream[int]]:
    """
    @return collection of provided 64 bit integers.
    """
        ...
    @classmethod
    def ofInt32(cls, *elements: Array[int]) -> Union[Stream[int]]:
    """
    @return collection of provided 32 bit integers.
    """
        ...
    @classmethod
    def ofInt16(cls, *elements: Array[int]) -> Union[Stream[int]]:
    """
    @return collection of provided 16 bit integers.
    """
        ...
    @classmethod
    def ofFloat(cls, *elements: Array[float]) -> Union[Stream[float]]:
    """
    @return collection of provided floats.
    """
        ...
    @classmethod
    def ofDbl(cls, *elements: Array[float]) -> Union[Stream[float]]:
    """
    ...
    @overload
    @classmethod
    def ofByte(cls, *elements: Array[int]) -> Union[Stream[int]]:
    """
    @return collection of provided doubles.
    """
        ...
    @overload
    @classmethod
    def ofByte(cls, elements: any=None) -> Union[Stream[int]]:
    """
    @return stream of bytes from a binary value
    """
        ...
    @classmethod
    def ofDateTime(cls, *elements: Array[datetime]) -> Union[Stream[datetime]]:
    """
    @return collection of provided datetime.
    """
        ...
    @classmethod
    def ofStr(cls, *strs: Array[str]) -> Union[Stream[str]]:
    """
    ...
    @overload
    @classmethod
    def ofObj(cls, *objs: Array[Obj]) -> Union[Stream[Obj]]:
    """
    ...
    @overload
    @classmethod
    def ofObj(cls, type: Type, *objs: Array[Obj]) -> Union[Stream[O]]:
    """
    @return collection of provided C3 type and provided instances.
    """
        ...
    @classmethod
    def ofIntInRange(cls, min: int, max: int, step: int=None) -> Union[Stream[int]]:
    """
    @return collection of provided integers in a range.
    """
        ...
    @classmethod
    def ofInt32InRange(cls, min: int, max: int, step: int=None) -> Union[Stream[int]]:
    """
    @return collection of provided integers in a range.
    """
        ...
    @classmethod
    def fromHttpRequest(cls, req: HttpRequest) -> Stream[E]:
    """
    ...
    """
        ...
    @overload
    def limit(self, limit: int) -> Stream[E]:
    """
    ...
    """
        ...
    @overload
    def offset(self, offset: int) -> Stream[E]:
    """
    ...
    @overload
    @classmethod
    def concatStreams(cls, streams: Array[Stream[T]]) -> Stream[T]:
    """
    Concatenates multiple streams into a single stream
    ...
    """
        ...
    def shuffle(self, windowSize: int='1000') -> Stream[E]:
    """
    ...
    @overload
    @classmethod
    def make(cls, elementType: ValueType, iter: Iterator[T]) -> Union[Stream[T]]:
    """
    ...
    @overload
    @classmethod
    def make(cls, elementType: ValueType, next: Callable[[], Union[T]], close: Callable[[]]=None) -> Union[Stream[T]]:
    """
    ...
    @overload
    @classmethod
    def make(cls, elementType: ValueType, initial: T, next: Callable[[Union[T], int], Union[T]], close: Callable[[]]=None) -> Union[Stream[T]]:
    """
    Build a stream on top of a lambda that produces the next value or null on end. Note that this model does not
    work for streams that may contain null values.
    ...
    @overload
    @classmethod
    def make(cls, elementType: ValueType, hasNext: Callable[[], bool], next: Callable[[Union[T], int], Union[T]], close: Callable[[]]) -> Union[Stream[T]]:
    """
