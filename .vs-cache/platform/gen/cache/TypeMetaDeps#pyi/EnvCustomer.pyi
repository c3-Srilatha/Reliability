...
# Python definitions for the C3 type EnvCustomer


class EnvCustomer(EnvBillable, Value):
    """
    This type is added as a wrapper to obtain environment costs for the customer.
    
    @remarks this represents a made instance of EnvCustomer
    """
