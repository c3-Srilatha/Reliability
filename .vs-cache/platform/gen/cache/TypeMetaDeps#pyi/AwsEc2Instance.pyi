...
from c3.platform.AwsBlockDeviceMapping import AwsBlockDeviceMapping
...
from c3.platform.AwsElb import AwsElb
...
from c3.platform.AwsEcsCluster import AwsEcsCluster
...
from c3.platform.AwsAmi import AwsAmi
from c3.platform.AwsHostedZone import AwsHostedZone
...
# Python definitions for the C3 type AwsEc2Instance


class AwsEc2Instance(AwsResource, AwsSubnetMember, AwsSecurityGroupsMember, AwsKeyPairMember, AwsIamInstanceProfileMember, AwsHostedZoneMember, AwsElbsMember, AwsEcsClusterMember, CloudComputeInstance):
    """
    This type provides an interface to the AWS *Ec2* service;
    see the [AWS documentation](http://docs.aws.amazon.com/AWSEC2/latest/UserGuide/concepts.html).
    
    @remarks this represents a made instance of AwsEc2Instance
    """
    ...
    securityGroups: Optional[Array[AwsSecurityGroup]]=None
    """
    The id of the child security groups of the resource.
    """
    ...
    hostedZone: Optional[AwsHostedZone]
    """
    The id of the hosted zone the resource is associated with.
    """

    elbs: Optional[Array[AwsElb]]=None
    """
    The ids of elbs the resource is associated with.
    """

    ecsCluster: Optional[AwsEcsCluster]
    """
    The id of the ECS cluster the resource is in.
    """
    ...
    image: Optional[AwsAmi]=None
    """
    Reference to the AWS Machine Image.
    """
    ...
    blockDeviceMappings: Optional[Array[AwsBlockDeviceMapping]]=None
    """
    Any block device mapping entries. Will request following 4 device mappings by default:
        device mapping 1: deviceName: "/dev/sdb", virtualName: "ephemeral0"
        device mapping 2: deviceName: "/dev/sdc", virtualName: "ephemeral1"
        device mapping 3: deviceName: "/dev/sdd", virtualName: "ephemeral2"
        device mapping 4: deviceName: "/dev/sde", virtualName: "ephemeral3"
    Please don't request any of these device mappings again in your entry.
    """
    ...
    """
    Users can specify commands as user data to execute when the ec2 instance brings up.
    """

    status: Optional[str]=None
    """
    Reports status of the instance. eg. "Initializing"
    """

    hasPublicIpAddress: Optional[bool]=None
    """
    Indicates whether to assign a public IPv4 address to an instance.
    """
    def __init__(self, id: Optional[str]=None, cluster: Optional[str]=None, env: Optional[str]=None, app: Optional[str]=None, func: Optional[str]=None, role: Optional[str]=None, seq: Optional[str]=None, subseq: Optional[str]=None, resourceId: Optional[str]=None, resourceSecondaryId: Optional[str]=None, resourceName: Optional[str]=None, resourceGroupName: Optional[str]=None, fullyConfigured: Optional[bool]=None, resourceNamespace: Optional[str]=None, external: Optional[bool]=None, credentials: Optional[AwsCredentials]=None, hasGeneratedResourceName: Optional[bool]=None, hasGeneratedResourceSecondaryId: Optional[bool]=None, configOverride: Optional[str]=None, secretOverride: Optional[str]=None, issues: Optional[Array[str]]=None, nativeMetricByName: Optional[Map[str, str]]=None, tags: Optional[Array[CloudTag]]=None, description: Optional[str]=None, parentResource: Optional[CloudResource]=None, subnet: Optional[AwsSubnet]=None, securityGroups: Optional[Array[AwsSecurityGroup]]=None, keyPair: Optional[AwsKeyPair]=None, iamInstanceProfile: Optional[AwsIamInstanceProfile]=None, hostedZone: Optional[AwsHostedZone]=None, elbs: Optional[Array[AwsElb]]=None, ecsCluster: Optional[AwsEcsCluster]=None, instanceType: Optional[str]=None, dnsHostname: Optional[str]=None, ownerId: Optional[str]=None, requesterId: Optional[str]=None, reservationId: Optional[str]=None, image: Optional[AwsAmi]=None, publicIpAddress: Optional[str]=None, privateIpAddress: Optional[str]=None, lifecycle: Optional[str]=None, rootDeviceType: Optional[str]=None, architecture: Optional[str]=None, platform: Optional[str]=None, networkInterfaceId: Optional[str]=None, blockDeviceMappings: Optional[Array[AwsBlockDeviceMapping]]=None, launchTime: Optional[str]=None, state: Optional[str]=None, m_userData: Optional[str]=None, status: Optional[str]=None, hasPublicIpAddress: Optional[bool]=None) -> None: ...
    ...
    @overload
    @classmethod
    def fromString(cls, s: str) -> Union[AwsEc2Instance]:
    """
    ...
    @overload
    @classmethod
    def fromString(cls, s: str, failIfInvalid: bool=None) -> Union[AwsEc2Instance]:
    """
    Constructs Cloud Resource instance with reference fields and credentials based on provided Cloud Reference string.
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[AwsEc2Instance]:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> AwsEc2Instance:
    """
    ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> AwsEc2Instance:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> AwsEc2Instance:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> AwsEc2Instance:
    """
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[AwsEc2Instance]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[AwsEc2Instance]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[AwsEc2Instance]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[AwsEc2Instance]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> AwsEc2Instance:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> AwsEc2Instance:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> AwsEc2Instance:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[AwsEc2Instance]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[AwsEc2Instance]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> AwsEc2Instance:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> AwsEc2Instance:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> AwsEc2Instance:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> AwsEc2Instance:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> AwsEc2Instance:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> AwsEc2Instance:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> AwsEc2Instance:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> AwsEc2Instance:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> AwsEc2Instance:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> AwsEc2Instance:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> AwsEc2Instance:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> AwsEc2Instance:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> AwsEc2Instance:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> AwsEc2Instance:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> AwsEc2Instance:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> AwsEc2Instance:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> AwsEc2Instance:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> AwsEc2Instance:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> AwsEc2Instance:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> AwsEc2Instance:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> AwsEc2Instance:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> AwsEc2Instance:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> AwsEc2Instance:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> AwsEc2Instance:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> AwsEc2Instance:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> AwsEc2Instance:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> AwsEc2Instance:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> AwsEc2Instance:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[AwsEc2Instance]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[AwsEc2Instance]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[AwsEc2Instance]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[AwsEc2Instance]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[AwsEc2Instance]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, AwsEc2Instance]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, AwsEc2Instance]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[AwsEc2Instance]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[AwsEc2Instance]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> AwsEc2Instance:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> AwsEc2Instance:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> AwsEc2Instance:
    """
    ...
    """
        ...
    def afterMake(self) -> AwsEc2Instance:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> AwsEc2Instance:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[AwsEc2Instance]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> AwsEc2Instance:
    """
    ...
    """
        ...
    @classmethod
    def forId(cls, id: str, failIfMissing: bool=None) -> Union[AwsEc2Instance]:
    """
    Find Cloud Resource in Cloud Provider based on provided C3 canonical identifier.
    """
        ...
    @classmethod
    def fromClusterId(cls, clusterId: str, env: str, app: str, func: str, role: str=None, seq: str=None, subseq: str=None) -> AwsEc2Instance:
    """
    Construct a cloud ID from a cluster ID
    """
        ...
    @classmethod
    def fromEnvId(cls, envId: str, app: str, func: str, role: str=None, seq: str=None, subseq: str=None) -> AwsEc2Instance:
    """
    ...
    """
        ...
    @classmethod
    def fromAppId(cls, appId: str, func: str, role: str=None, seq: str=None, subseq: str=None) -> AwsEc2Instance:
    """
    ...
    """
        ...
    @classmethod
    def fromId(cls, id: str, failIfInvalid: bool=None) -> AwsEc2Instance:
    """
    ...
    """
        ...
    @classmethod
    def fromCloudId(cls, id: CloudId, failIfInvalid: bool=None) -> AwsEc2Instance:
    """
    ...
    """
        ...
    def fromConfigTemplate(self, spec: CloudResourceOperationSpec=None) -> AwsEc2Instance:
    """
    ...
    """
        ...
    def withDefaultConfig(self, spec: CloudResourceOperationSpec=None) -> AwsEc2Instance:
    """
    ...
    """
        ...
    def upsertResource(self, spec: CloudResourceOperationSpec=None) -> AwsEc2Instance:
    """
    Create or update Cloud Resource.
    """
        ...
    def upsertWithDependencies(self, spec: CloudResourceOperationSpec=None) -> AwsEc2Instance:
    """
    ...
    """
        ...
    @classmethod
    def allCached(cls, doNotProduceAll: bool=None) -> Union[Stream[AwsEc2Instance]]:
    """
    ...
    """
        ...
    @classmethod
    def find(cls, filter: str=None, doNotProduceAll: bool=None) -> Union[Stream[AwsEc2Instance]]:
    """
    ...
    """
        ...
    @classmethod
    def findBy(cls, field: str, value: Any, doNotProduceAll: bool=None) -> Union[Stream[AwsEc2Instance]]:
    """
    @param doNotProduceAll if true, will not populate cache and only return available cached instances. Will call
           `produceAll` if cache is empty or if Ann.cache.all is true & data has not previously been fetched.
    @return existing instances of this type that satisfy filter from data cache.
    """
        ...
    @classmethod
    def findByCacheKey(cls, key: str) -> Union[AwsEc2Instance]:
    """
    ...
    """
        ...
    @classmethod
    def produce(cls, key: str) -> Union[AwsEc2Instance]:
    """
    Should produce an entry for the cache key. This method should not be called directly.
    """
        ...
    @classmethod
    def produceAll(cls) -> Union[Map[str, AwsEc2Instance]]:
    """
    ...
    """
        ...
    @classmethod
    def doProduceAll(cls) -> Union[Map[str, AwsEc2Instance]]:
    """
    ...
    """
        ...
    def getConfig(self) -> AwsEc2Instance:
    """
    This method on any CloudResource is not supported! Use CloudResource.for* or other methods instead.
    """
        ...
    ...
    """
        ...
    def getSecret(self) -> AwsEc2Instance:
    """
    ...
    """
        ...
    @classmethod
    def forConfigKey(cls, configKey: str) -> Union[AwsEc2Instance]:
    """
    ...
    """
        ...
    @classmethod
    def listConfigs(cls, parallel: bool=None, filter: Callable[[str], bool]=None) -> Union[Stream[AwsEc2Instance]]:
    """
    @param
    ...
    """
        ...
    @overload
    def setConfigValues(self, from_: AwsEc2Instance, override: str=None) -> None:
    """
    ...
    """
        ...
    @overload
    def setSecretValues(self, from_: AwsEc2Instance, override: str=None) -> None:
    """
    ...
    """
        ...
    @classmethod
    def loadConfigAndSecret(cls, configKey: str) -> Union[AwsEc2Instance]:
    """
    ...
    """
        ...
    def removeSecrets(self) -> Union[AwsEc2Instance]:
    """
    @return this config without any secret values.
    """
        ...
    def removeNonSecrets(self) -> Union[AwsEc2Instance]:
    """
    @return this config with only secret values.
    """
        ...
    def validate(self) -> AwsEc2Instance:
    """
    ...
    """
        ...
    def withIdentity(self, resource: CloudResource=None, spec: CloudResourceOperationSpec=None) -> AwsEc2Instance:
    """
    ...
    """
        ...
    def mergeId(self, other: CloudResource=None) -> AwsEc2Instance:
    """
    ...
    """
        ...
    @classmethod
    def forCloudId(cls, id: CloudId, failIfMissing: bool=None) -> Union[AwsEc2Instance]:
    """
    ...
    """
        ...
    @classmethod
    def forCloudFunc(cls, func: str, role: str=None, failIfMissing: bool=None) -> AwsEc2Instance:
    """
    Find Cloud Resource based on provided cloud func component and optional role.
    """
        ...
    @classmethod
    def forCloudRole(cls, role: str, failIfMissing: bool=None) -> AwsEc2Instance:
    """
    Find Cloud Resource of this type based on provided cloud role component.
    """
        ...
    @classmethod
    def forResourceId(cls, resourceId: str, failIfMissing: bool=None) -> Union[AwsEc2Instance]:
    """
    Find Cloud Resource in the Cloud Provider by provided resource name.
    """
        ...
    @classmethod
    def forResourceSecondaryId(cls, resourceId: str, failIfMissing: bool=None) -> Union[AwsEc2Instance]:
    """
    Find Cloud Resource in the Cloud Provider by provided resource name.
    """
        ...
    ...
    """
        ...
    @classmethod
    def forResourceName(cls, resourceName: str, failIfMissing: bool=None) -> Union[AwsEc2Instance]:
    """
    Find Cloud Resource in the Cloud Provider by provided resource name.
    """
        ...
    @classmethod
    def findResource(cls, reference: str, failIfMissing: bool=None) -> Union[AwsEc2Instance]:
    """
    Find Cloud Resource in the Cloud Provider by provided {@link CloudRef} string.
    """
        ...
    def getResource(self) -> Union[AwsEc2Instance]:
    """
    Find Cloud Resource in the Cloud Provider by provided #resourceId, #resourceSecondaryId, #resourceName or #tags
    (in that order).
    """
        ...
    def ensureResource(self) -> AwsEc2Instance:
    """
    Checks that the resource is persisted. If not, upserts the resource, to ensure that the resource exists.
    """
        ...
    @classmethod
    def listResourcesBySubtype(cls, spec: CloudListResourcesSpec=None) -> Map[str, CloudListResourcesResult[AwsEc2Instance]]:
    """
    ...
    """
        ...
    @classmethod
    def listResources(cls, spec: CloudListResourcesSpec=None) -> CloudListResourcesResult[AwsEc2Instance]:
    """
    ...
    """
        ...
    @classmethod
    def listResourcesForTags(cls, *keyValuePairs: Array[str]) -> CloudListResourcesResult[AwsEc2Instance]:
    """
    List all Cloud Resources that satisfies the given spec.
    ...
    """
        ...
    @classmethod
    def listResourcesForClusterId(cls, clusterId: str, cloudIdRole: str=None, spec: CloudListResourcesSpec=None) -> CloudListResourcesResult[AwsEc2Instance]:
    """
    List all Cloud Resources that satisfies the given spec.
    ...
    """
        ...
    @classmethod
    def listResourcesForEnvId(cls, envId: str, cloudIdRole: str=None, spec: CloudListResourcesSpec=None) -> CloudListResourcesResult[AwsEc2Instance]:
    """
    List all Cloud Resources that satisfies the given spec.
    ...
    """
        ...
    @classmethod
    def listResourcesForAppId(cls, appId: str, cloudIdRole: str=None, spec: CloudListResourcesSpec=None) -> CloudListResourcesResult[AwsEc2Instance]:
    """
    List all Cloud Resources that satisfies the given spec.
    ...
    """
        ...
    def upsertDependencies(self, spec: CloudResourceOperationSpec=None) -> AwsEc2Instance:
    """
    ...
    """
        ...
    def waitForCreate(self, spec: WaitSpec=None) -> Union[AwsEc2Instance]:
    """
    ...
    """
        ...
    @classmethod
    def tagResourcesBatch(cls, resources: Array[AwsEc2Instance], tags: Array[CloudTag]) -> Union[Map[str, Error]]:
    """
    ...
    """
        ...
    @classmethod
    def untagResourcesBatch(cls, resources: Array[AwsEc2Instance], tagKeys: Array[str]) -> Union[Map[str, Error]]:
    """
    ...
    """
        ...
    def waitForOk(self, spec: WaitSpec=None) -> Union[AwsEc2Instance]:
    """
    ...
    """
        ...
    def waitForState(self, state: str='AVAILABLE', spec: WaitSpec=None) -> Union[AwsEc2Instance]:
    """
    ...
    """
        ...
    def setFullyConfigured(self, fullyConfigured: bool=None, override: str=None) -> AwsEc2Instance:
    """
    ...
    """
        ...
    def afterCreate(self, input: AwsEc2Instance=None) -> AwsEc2Instance:
    """
    ...
    """
        ...
    def beforeCreate(self) -> AwsEc2Instance:
    """
    Optional callback to alter resource before creating it.
    """
        ...
    def beforeUpdate(self) -> AwsEc2Instance:
    """
    Optional callback to alter resource before updating it.
    """
        ...
    def beforeDestroy(self) -> AwsEc2Instance:
    """
    ...
    """
        ...
    def withoutNonModifiableFields(self) -> AwsEc2Instance:
    """
    ...
    """
        ...
    def withResourceArn(self, resourceArn: str) -> Union[AwsEc2Instance]:
    """
    ...
    """
        ...
    def safeSecurityGroups(self) -> Union[Array[AwsSecurityGroup]]:
    """
    get the child security groups of the resource
    """
        ...
    ...
    """
        ...
    def safeHostedZone(self) -> Union[AwsHostedZone]:
    """
    Get the aws hosted zone for the given resource
    """
        ...
    def safeElbs(self) -> Union[Array[AwsElb]]:
    """
    Get the aws elbs for the given resource
    """
        ...
    def safeEcsCluster(self) -> Union[AwsEcsCluster]:
    """
    get the ECS cluster associated with the resource
    """
        ...
    @classmethod
    ...
    """
        ...
    def userData(self) -> Union[str]:
    """
    Get user data of the instance.
    """
        ...
    def availabilityZone(self) -> str:
    """
    Get availabilityZone of the instance
    """
        ...
    def upsertImage(self, imageName: str, imageDescription: str, spec: CloudResourceOperationSpec=None) -> AwsAmi:
    """
    create a image from current instance if the image doesn't exist.
    If the image has already existed, will delete it and create a new image from current instance to update.
    @param imageName
