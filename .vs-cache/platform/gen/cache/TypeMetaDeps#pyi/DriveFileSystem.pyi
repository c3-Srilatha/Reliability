...
from c3.platform.DriveFileSystem import DriveFileSystem
...
# Python definitions for the C3 type DriveFileSystem

DF = TypeVar('DF')

class DriveFileSystem(Generic[DF], FileSystem):
    """
    @remarks this represents a made instance of DriveFileSystem
    """
    def __init__(self) -> None: ...

    @classmethod
    def inst(cls) -> DriveFileSystem[DF]:
    """
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[DriveFileSystem[DF]]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[DriveFileSystem[DF]]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[DriveFileSystem[DF]]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[DriveFileSystem[DF]]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> DriveFileSystem[DF]:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> DriveFileSystem[DF]:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> DriveFileSystem[DF]:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[DriveFileSystem[DF]]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[DriveFileSystem[DF]]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> DriveFileSystem[DF]:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> DriveFileSystem[DF]:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> DriveFileSystem[DF]:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> DriveFileSystem[DF]:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> DriveFileSystem[DF]:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> DriveFileSystem[DF]:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> DriveFileSystem[DF]:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> DriveFileSystem[DF]:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> DriveFileSystem[DF]:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> DriveFileSystem[DF]:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> DriveFileSystem[DF]:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> DriveFileSystem[DF]:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> DriveFileSystem[DF]:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> DriveFileSystem[DF]:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> DriveFileSystem[DF]:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> DriveFileSystem[DF]:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> DriveFileSystem[DF]:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> DriveFileSystem[DF]:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> DriveFileSystem[DF]:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> DriveFileSystem[DF]:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> DriveFileSystem[DF]:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> DriveFileSystem[DF]:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> DriveFileSystem[DF]:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> DriveFileSystem[DF]:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> DriveFileSystem[DF]:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> DriveFileSystem[DF]:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> DriveFileSystem[DF]:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> DriveFileSystem[DF]:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[DriveFileSystem[DF]]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[DriveFileSystem[DF]]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[DriveFileSystem[DF]]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[DriveFileSystem[DF]]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[DriveFileSystem[DF]]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, DriveFileSystem[DF]]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, DriveFileSystem[DF]]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[DriveFileSystem[DF]]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[DriveFileSystem[DF]]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> DriveFileSystem[DF]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> DriveFileSystem[DF]:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> DriveFileSystem[DF]:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> DriveFileSystem[DF]:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> DriveFileSystem[DF]:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> DriveFileSystem[DF]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> DriveFileSystem[DF]:
    """
    ...
    """
        ...
    def afterMake(self) -> DriveFileSystem[DF]:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> DriveFileSystem[DF]:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[DriveFileSystem[DF]]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> DriveFileSystem[DF]:
    """
