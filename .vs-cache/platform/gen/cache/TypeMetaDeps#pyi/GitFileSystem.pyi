...
from c3.platform.GitFsConfig import GitFsConfig
...
# Python definitions for the C3 type GitFileSystem


class GitFileSystem(FileSystem, FileSystemConfigurable[GitFsConfig]):
    """
    @remarks this represents a made instance of GitFileSystem
    """
    
    gitUrl: Optional[GitUrl]
    """
    The url of the repository.
    """
    def __init__(self, gitUrl: Optional[GitUrl]=None) -> None: ...

    @classmethod
    def inst(cls) -> GitFileSystem:
    """
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[GitFileSystem]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[GitFileSystem]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[GitFileSystem]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[GitFileSystem]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> GitFileSystem:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> GitFileSystem:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> GitFileSystem:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[GitFileSystem]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[GitFileSystem]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> GitFileSystem:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> GitFileSystem:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> GitFileSystem:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> GitFileSystem:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> GitFileSystem:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> GitFileSystem:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> GitFileSystem:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> GitFileSystem:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> GitFileSystem:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> GitFileSystem:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> GitFileSystem:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> GitFileSystem:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> GitFileSystem:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> GitFileSystem:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> GitFileSystem:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> GitFileSystem:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> GitFileSystem:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> GitFileSystem:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> GitFileSystem:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> GitFileSystem:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> GitFileSystem:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> GitFileSystem:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> GitFileSystem:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> GitFileSystem:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> GitFileSystem:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> GitFileSystem:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> GitFileSystem:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> GitFileSystem:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[GitFileSystem]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[GitFileSystem]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[GitFileSystem]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[GitFileSystem]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[GitFileSystem]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, GitFileSystem]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, GitFileSystem]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[GitFileSystem]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[GitFileSystem]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> GitFileSystem:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> GitFileSystem:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> GitFileSystem:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> GitFileSystem:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> GitFileSystem:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> GitFileSystem:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> GitFileSystem:
    """
    ...
    """
        ...
    def afterMake(self) -> GitFileSystem:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> GitFileSystem:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[GitFileSystem]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> GitFileSystem:
    """
    ...
    """
        ...
    def config(self, secrets: bool=None) -> GitFsConfig:
    """
    Returns cached configuration object for instance of this file system.
    """
        ...
    @classmethod
    def runGitCommand(cls, localRootUrl: Url=None, gitArgs: Array[str]=None) -> Union[str]:
    """
    Run a git operation on the command line.
    
    @param localRootUrl
              The path to the git root directory on the local file system. Since the git command is not run from
              this directory, the path will be specified to the git command using the -C flag. For git clone,
              this should be left blank (the target local directory is specified as a different parameter).
    @param gitArgs
              The arguments to the git command after "git -C ...". For example, for "git pull --rebase", gitArgs
              should be "pull" and "--rebase".
    """
        ...
    def ensureBranchExists(self, targetBranch: str, sourceBranch: str) -> bool:
    """
    If the given target branch does not exist in the repository, create it from the source branch.
    Similar to {@link GitHub.ensureBranchExists}.
    """
        ...
    @classmethod
    def emptyCache(cls) -> None:
    """
    Empty the repository cache. Later file system calls will re-clone the appropriate repository.
    """
        ...
    def reset(self, baseBranch: str) -> None:
    """
    Reset the branch for this file system to the given base branch.
    """
        ...
    @classmethod
    def gitVersion(cls) -> Union[SemanticVersion]:
    """
    Return the version number from "git version".
    """
        ...
