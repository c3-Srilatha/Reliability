...
# Python definitions for the C3 type MetadataCacheOld

V = TypeVar('V')

class MetadataCacheOld(Generic[V], Value):
    """
    ...
    """
        ...
    @classmethod
    def put(cls, key: str, value: V) -> None:
    """
    ...
    """
        ...
    @classmethod
    def produce(cls, key: str) -> Union[V]:
    """
    ...
    """
        ...
    @classmethod
    def produceAll(cls) -> Union[Map[str, V]]:
    """
    ...
    """
        ...
    @classmethod
    def release(cls, key: str, value: V) -> None:
    """
