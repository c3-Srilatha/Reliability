...
from c3.platform.ExMachinaConnectorCredentialShareHistory import ExMachinaConnectorCredentialShareHistory
...
from c3.platform.ExMachinaConnectorCredentialUpdateMetadataSpec import ExMachinaConnectorCredentialUpdateMetadataSpec
from c3.platform.FetchResult import FetchResult
...
from c3.platform.ExMachinaConnectorCredentialOwnership import ExMachinaConnectorCredentialOwnership
...
from c3.platform.DataConnectorCredential import DataConnectorCredential
...
from c3.platform.ExMachinaConnectorCredential import ExMachinaConnectorCredential
...
# Python definitions for the C3 type ExMachinaConnectorCredentialUi


class ExMachinaConnectorCredentialUi(ExMachinaConnectorCredential, ExMachinaUserGroupShareableUi[ExMachinaConnectorCredential, ExMachinaConnectorCredentialUi]):
    """
    A wrapper around {@link ExMachinaConnectorCredential} to provide additional fields that will change depending on the user
    accessing the records.
    
    @remarks this represents a made instance of ExMachinaConnectorCredentialUi
    """
    
    typeName: Optional[ExMachinaConnectorCredential]=None
    """
    Used internally to derive the shareable entity type from the type that mixes ExMachinaUserGroupShareableUi
    """

    allowViewDetails: Optional[bool]=None
    """
    Whether the member viewing a record of a type mixing {@link ExMachinaUserGroupShareable} should be allowed to
    view details of the shareable
    """
    ...
    allowDisable: Optional[bool]=None
    """
    Whether the member viewing a record of a type mixing {@link ExMachinaUserGroupShareable} should be allowed to
    disable the shareable
    """

    allowEnable: Optional[bool]=None
    """
    Whether the member viewing a record of a type mixing {@link ExMachinaUserGroupShareable} should be allowed to
    enable the shareable
    """
    ...
    ownershipType: Optional[ExMachinaConnectorCredentialOwnership]=None
    """
    Used internally to derive the ownership type from the type that mixes ExMachinaUserGroupShareable
    """

    shareHistoryType: Optional[ExMachinaConnectorCredentialShareHistory]=None
    """
    ...
    ownershipHistory: Optional[Array[ExMachinaConnectorCredentialOwnership]]=None
    """
    History of all owners of the shareable entity
    """

    activelyShared: Optional[Array[ExMachinaConnectorCredentialShareHistory]]=None
    """
    Current groups with which the shareable entity has been shared
    """

    sharedHistory: Optional[Array[ExMachinaConnectorCredentialShareHistory]]=None
    """
    ...
    """
    def __init__(self, typeName: Optional[ExMachinaConnectorCredential]=None, allowViewDetails: Optional[bool]=None, allowShare: Optional[bool]=None, allowDelete: Optional[bool]=None, allowDisable: Optional[bool]=None, allowEnable: Optional[bool]=None, allowEdit: Optional[bool]=None, acl: Optional[Array[AclEntry]]=None, isPubliclyAccessible: Optional[bool]=None, disabled: Optional[bool]=None, ownershipType: Optional[ExMachinaConnectorCredentialOwnership]=None, shareHistoryType: Optional[ExMachinaConnectorCredentialShareHistory]=None, currentOwner: Optional[User]=None, displayOwner: Optional[str]=None, lastUpdatedBy: Optional[str]=None, ownershipHistory: Optional[Array[ExMachinaConnectorCredentialOwnership]]=None, activelyShared: Optional[Array[ExMachinaConnectorCredentialShareHistory]]=None, sharedHistory: Optional[Array[ExMachinaConnectorCredentialShareHistory]]=None, isOwned: Optional[bool]=None, typeIdent: Optional[str]=None, id: Optional[str]=None, versionEdits: Optional[Array[VersionEdit]]=None, name: Optional[str]=None, meta: Optional[Meta]=None, version: Optional[int]=None, typeWithBindings: Optional[Type]=None, displayName: Optional[str]=None, datastore: Optional[str]=None, description: Optional[str]=None) -> None: ...
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[ExMachinaConnectorCredentialUi]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[ExMachinaConnectorCredentialUi]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[ExMachinaConnectorCredentialUi]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[ExMachinaConnectorCredentialUi]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> ExMachinaConnectorCredentialUi:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> ExMachinaConnectorCredentialUi:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> ExMachinaConnectorCredentialUi:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[ExMachinaConnectorCredentialUi]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[ExMachinaConnectorCredentialUi]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> ExMachinaConnectorCredentialUi:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> ExMachinaConnectorCredentialUi:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> ExMachinaConnectorCredentialUi:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> ExMachinaConnectorCredentialUi:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> ExMachinaConnectorCredentialUi:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> ExMachinaConnectorCredentialUi:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> ExMachinaConnectorCredentialUi:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> ExMachinaConnectorCredentialUi:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> ExMachinaConnectorCredentialUi:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> ExMachinaConnectorCredentialUi:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> ExMachinaConnectorCredentialUi:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> ExMachinaConnectorCredentialUi:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> ExMachinaConnectorCredentialUi:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> ExMachinaConnectorCredentialUi:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> ExMachinaConnectorCredentialUi:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> ExMachinaConnectorCredentialUi:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> ExMachinaConnectorCredentialUi:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> ExMachinaConnectorCredentialUi:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> ExMachinaConnectorCredentialUi:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> ExMachinaConnectorCredentialUi:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> ExMachinaConnectorCredentialUi:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> ExMachinaConnectorCredentialUi:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> ExMachinaConnectorCredentialUi:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> ExMachinaConnectorCredentialUi:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> ExMachinaConnectorCredentialUi:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> ExMachinaConnectorCredentialUi:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> ExMachinaConnectorCredentialUi:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> ExMachinaConnectorCredentialUi:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[ExMachinaConnectorCredentialUi]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[ExMachinaConnectorCredentialUi]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[ExMachinaConnectorCredentialUi]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[ExMachinaConnectorCredentialUi]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[ExMachinaConnectorCredentialUi]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, ExMachinaConnectorCredentialUi]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, ExMachinaConnectorCredentialUi]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[ExMachinaConnectorCredentialUi]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[ExMachinaConnectorCredentialUi]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> ExMachinaConnectorCredentialUi:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> ExMachinaConnectorCredentialUi:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> ExMachinaConnectorCredentialUi:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> ExMachinaConnectorCredentialUi:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> ExMachinaConnectorCredentialUi:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> ExMachinaConnectorCredentialUi:
    """
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[ExMachinaConnectorCredentialUi]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> ExMachinaConnectorCredentialUi:
    """
    ...
    """
        ...
    def afterMake(self) -> ExMachinaConnectorCredentialUi:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> ExMachinaConnectorCredentialUi:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[ExMachinaConnectorCredentialUi]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> ExMachinaConnectorCredentialUi:
    """
    ...
    """
        ...
    @classmethod
    def getShareableEntityType(cls) -> Union[Type]:
    """
    Helper method to get the shareable entity type related to the caller type that mixes ExMachinaUserGroupShareableUi
    """
        ...
    @overload
    @classmethod
    def fetch(cls, spec: FetchSpec=None) -> Union[FetchResult[ExMachinaConnectorCredentialUi]]:
    """
    Fetches all accessible records for a type mixing {@link ExMachinaUserGroupShareable} and performs additional
    checks to add fields that can be used by the UI. This can be used to populate a grid.
    """
        ...
    @overload
    @classmethod
    def fetch(cls, filter: Filter) -> FetchResult[ExMachinaConnectorCredentialUi]:
    """
    ...
    """
        ...
    @classmethod
    def processFetchResult(cls, shareableEntityFetchResult: FetchResult[ExMachinaConnectorCredential]=None, uiWrapperType: Type=None) -> Union[FetchResult[ExMachinaConnectorCredentialUi]]:
    """
    Utility function to process the fetch results of the shareable entity.
    """
        ...
    @classmethod
    def processShareableEntities(cls, shareableEntities: Array[ExMachinaConnectorCredential]=None, uiWrapperType: Type=None) -> Union[Array[ExMachinaConnectorCredentialUi]]:
    """
    Utility function to process list of shareable entities.
    """
        ...
    @overload
    @classmethod
    ...
    """
    Fetches the accessible count of records for a type mixing {@link ExMachinaUserGroupShareable}. This can be used
    to populate the pagination for a grid.
    """
        ...
    @overload
    @classmethod
    ...
    """
        ...
    @classmethod
    def getIncludeSpec(cls, includeSpec: str=None) -> Union[str]:
    """
    Utility function to retrieve include spec.
    """
        ...
    ...
    """
        ...
    @classmethod
    def populateAcl(cls, objs: Array[ExMachinaConnectorCredentialUi]=None) -> Union[int]:
    """
    ...
    """
        ...
    def grantMemberReadUpdateRemove(self, member: AccessControlEntity) -> ExMachinaConnectorCredentialUi:
    """
    Creates (or updates existing) entry with all but modify ACL permissions.
    """
        ...
    def mergeAclEntry(self, entry: AclEntry) -> ExMachinaConnectorCredentialUi:
    """
    ...
    """
        ...
    def mergeAclEntries(self, entries: Array[AclEntry]) -> ExMachinaConnectorCredentialUi:
    """
    ...
    """
        ...
    @classmethod
    def refreshData(cls, shareHistoryObjs: Array[ExMachinaConnectorCredentialShareHistory]=None, shareableEntityObjs: Array[ExMachinaConnectorCredential]=None) -> None:
    """
    Refreshes ACLs for the given share history objects and shareable entity objects.
    """
        ...
    def endShares(self, shares: Array[ExMachinaConnectorCredentialShareHistory]=None) -> None:
    """
    ...
    """
        ...
    @classmethod
    def postCreate(cls, objs: Array[ExMachinaConnectorCredential]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def fetchObjStream(cls, spec: FetchStreamSpec=None) -> Union[Stream[ExMachinaConnectorCredentialUi]]:
    """
    ...
    """
        ...
    @classmethod
    def fetchMultiLocale(cls, spec: MultiLocaleFetchSpec=None) -> Union[Map[str, FetchResult[ExMachinaConnectorCredentialUi]]]:
    """
    ...
    """
        ...
    def get(self, include: str=None) -> Union[ExMachinaConnectorCredentialUi]:
    """
    ...
    """
        ...
    def getSpecific(self, include: str=None) -> Union[ExMachinaConnectorCredentialUi]:
    """
    ...
    """
        ...
    def getMissing(self, spec: GetMissingSpec) -> ExMachinaConnectorCredentialUi:
    """
    ...
    """
        ...
    def getDirect(self, include: str=None) -> Union[ExMachinaConnectorCredentialUi]:
    """
    ...
    """
        ...
    def applyReverseEdit(self, versionEdit: VersionEdit) -> ExMachinaConnectorCredentialUi:
    """
    ...
    """
        ...
    @classmethod
    def fromString(cls, s: str) -> Union[ExMachinaConnectorCredentialUi]:
    """
    ...
    """
        ...
    def create(self, spec: UpsertSpec=None) -> Union[ExMachinaConnectorCredentialUi]:
    """
    ...
    """
        ...
    @classmethod
    def createBatch(cls, objs: Array[ExMachinaConnectorCredentialUi], spec: UpsertSpec=None) -> Union[ObjList[ExMachinaConnectorCredentialUi]]:
    """
    ...
    """
        ...
    @classmethod
    def createBatchObjStream(cls, objs: Stream[ExMachinaConnectorCredentialUi], spec: CreateBatchObjStreamSpec=None) -> Union[ObjList[ExMachinaConnectorCredentialUi]]:
    """
    Creates multiple instances of a C3 type. If the operation fails and {@link UpsertSpec#dontThrowOnBatchError} is not
    specified (the default), then a C3BatchException will be thrown.  Otherwise {@link errors will be reported in the
    returned {@link ObjList}.  This will fail if any of the instances already exist.
    ...
    """
        ...
    def update(self, srcObj: ExMachinaConnectorCredentialUi=None, spec: UpsertSpec=None) -> Union[ExMachinaConnectorCredentialUi]:
    """
    ...
    """
        ...
    def upsert(self, srcObj: ExMachinaConnectorCredentialUi=None, spec: UpsertSpec=None) -> Union[ExMachinaConnectorCredentialUi]:
    """
    ...
    """
        ...
    @overload
    def merge(self, spec: MergeSpec=None) -> Union[ExMachinaConnectorCredentialUi]:
    """
    ...
    """
        ...
    @overload
    def merge(self, mergeInclude: str, spec: MergeSpec=None) -> Union[ExMachinaConnectorCredentialUi]:
    """
    ...
    """
        ...
    def touch(self, spec: TouchSpec=None) -> Union[ExMachinaConnectorCredentialUi]:
    """
    ...
    """
        ...
    @classmethod
    def updateBatch(cls, objs: Array[ExMachinaConnectorCredentialUi], srcObjs: Array[ExMachinaConnectorCredentialUi]=None, spec: UpsertSpec=None) -> Union[ObjList[ExMachinaConnectorCredentialUi]]:
    """
    ...
    """
        ...
    @classmethod
    def updateObjs(cls, objs: Callable[[], Union[Array[ExMachinaConnectorCredentialUi]]], spec: UpsertSpec=None) -> Union[ObjList[ExMachinaConnectorCredentialUi]]:
    """
    ...
    """
        ...
    @classmethod
    def upsertBatch(cls, objs: Array[ExMachinaConnectorCredentialUi], srcObjs: Array[ExMachinaConnectorCredentialUi]=None, spec: UpsertSpec=None) -> Union[ObjList[ExMachinaConnectorCredentialUi]]:
    """
    ...
    """
        ...
    @classmethod
    def upsertObjs(cls, objs: Callable[[], Union[Array[ExMachinaConnectorCredentialUi]]], spec: UpsertSpec=None) -> Union[ObjList[ExMachinaConnectorCredentialUi]]:
    """
    Creates instances of a C3 type if they don't already exist and updates them if they do exist. If the operation
    ...
    """
        ...
    @classmethod
    def touchBatch(cls, objs: Array[ExMachinaConnectorCredentialUi], spec: TouchSpec=None) -> Union[ObjList[ExMachinaConnectorCredentialUi]]:
    """
    ...
    @overload
    @classmethod
    def mergeBatch(cls, objs: Array[ExMachinaConnectorCredentialUi], spec: MergeSpec=None) -> Union[ObjList[ExMachinaConnectorCredentialUi]]:
    """
    ...
    @overload
    @classmethod
    def mergeBatch(cls, objs: Array[ExMachinaConnectorCredentialUi], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[ExMachinaConnectorCredentialUi]]:
    """
    Merges multiple instances of a C3 type or creates them if they don't exist. If the operation fails and {@link
    UpsertSpec#dontThrowOnBatchError} is not specified (the default), then a C3BatchException will be thrown.
    Otherwise errors will be reported in the returned {@link ObjList}.  The merge operation is described in the {@link
    ...
    """
        ...
    @classmethod
    def mergeObjs(cls, objs: Callable[[], Union[Array[ExMachinaConnectorCredentialUi]]], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[ExMachinaConnectorCredentialUi]]:
    """
    ...
    @overload
    @classmethod
    def mergeAll(cls, mergeObj: ExMachinaConnectorCredentialUi, spec: MergeAllSpec=None) -> Union[int]:
    """
    ...
    @overload
    @classmethod
    def mergeAll(cls, mergeObj: ExMachinaConnectorCredentialUi, mergeInclude: str, spec: MergeAllSpec=None) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def removeBatch(cls, objs: Array[ExMachinaConnectorCredentialUi], spec: UpsertSpec=None) -> Union[ObjList[ExMachinaConnectorCredentialUi]]:
    """
    ...
    """
        ...
    @classmethod
    def replace(cls, objs: Array[ExMachinaConnectorCredentialUi], spec: UpsertSpec=None) -> Union[ObjList[ExMachinaConnectorCredentialUi]]:
    """
    ...
    """
        ...
    def unremove(self) -> Union[ExMachinaConnectorCredentialUi]:
    """
    ...
    """
        ...
    @classmethod
    def beforeCreate(cls, objs: Array[ExMachinaConnectorCredentialUi]) -> ObjList[ExMachinaConnectorCredentialUi]:
    """
    ...
    """
        ...
    @classmethod
    def beforeUpdate(cls, objs: Array[ExMachinaConnectorCredentialUi]) -> ObjList[ExMachinaConnectorCredentialUi]:
    """
    ...
    """
        ...
    @classmethod
    def beforeRemove(cls, objs: Array[ExMachinaConnectorCredentialUi]) -> ObjList[ExMachinaConnectorCredentialUi]:
    """
    ...
    """
        ...
    @classmethod
    def afterCreate(cls, objs: Array[ExMachinaConnectorCredentialUi]) -> Union[Array[ObjError]]:
    """
    TODO: VAD-16871 - Add a common afterCreate for all shareable types after PLAT-51996 fix
    Common logic to run after creation of any types that mixin {@link ExMachinaUserGroupShareable}
    """
        ...
    @classmethod
    def afterUpdate(cls, objs: Array[ExMachinaConnectorCredentialUi]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def afterRemove(cls, objs: Array[ExMachinaConnectorCredentialUi]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def startImportData(cls, spec: StartImportDataSpec=None) -> PushStream[ExMachinaConnectorCredentialUi]:
    """
    @return a push stream to import instances of this type.
    """
        ...
    @classmethod
    def startImportDataWithStats(cls, spec: StartImportDataSpec=None) -> PushStreamWithStats[ExMachinaConnectorCredentialUi]:
    """
    @return a push stream to import instances of this type.
    """
        ...
    ...
    """
        ...
    @classmethod
    def forId(cls, id: str, failIfMissing: bool=None) -> Union[ExMachinaConnectorCredentialUi]:
    """
    ...
    """
        ...
    def withoutIdentity(self) -> Union[ExMachinaConnectorCredentialUi]:
    """
    ...
    """
        ...
    @classmethod
    def typeOfBatch(cls, objs: Array[ExMachinaConnectorCredentialUi]) -> Union[Array[EntityType]]:
    """
    ...
    """
        ...
    @classmethod
    def dbEcho(cls, template: ExMachinaConnectorCredentialUi=None, count: int=None, sendBack: bool=None) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def callbackLogic(cls, objs: Array[ExMachinaConnectorCredentialUi], callback: Callable[[Union[ExMachinaConnectorCredentialUi]], Union[ExMachinaConnectorCredentialUi]]=None) -> ObjList[ExMachinaConnectorCredentialUi]:
    """
    ...
    """
        ...
    @classmethod
    def afterCallbackLogic(cls, objs: Array[ExMachinaConnectorCredentialUi], callback: Callable[[Union[ExMachinaConnectorCredentialUi]], Union[ExMachinaConnectorCredentialUi]]=None) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def upsertCredential(cls, credential: DataConnectorCredential) -> Union[ExMachinaConnectorCredential]:
    """
    ...
    """
        ...
    def getCredential(self) -> Union[DataConnectorCredential]:
    """
    ...
    """
        ...
    @classmethod
    def fetchReadableCredentialObjs(cls, fetchSpec: FetchSpec=None) -> Union[Array[ExMachinaConnectorCredential]]:
    """
    ...
    """
        ...
    @classmethod
    def fetchCredentials(cls, datastore: str=None) -> Union[FetchResult[DataConnectorCredential]]:
    """
    ...
    """
        ...
    @classmethod
    def fetchCredentialAssetsHelper(cls, datastore: str=None, include: str=None) -> Union[FetchResult[ExMachinaConnectorCredential]]:
    """
    ...
    """
        ...
    @classmethod
    def fetchCredentialWrappers(cls, spec: FetchSpec=None) -> Union[FetchResult[ExMachinaConnectorCredential]]:
    """
    ...
    """
        ...
    @classmethod
    def fetchCredentialAssets(cls, datastore: str=None) -> Union[FetchResult[ExMachinaConnectorCredential]]:
    """
    ...
    """
        ...
    def removeCredential(self) -> bool:
    """
    ...
    """
        ...
    @classmethod
    def updateCredentialMetadata(cls, spec: ExMachinaConnectorCredentialUpdateMetadataSpec) -> None:
    """
