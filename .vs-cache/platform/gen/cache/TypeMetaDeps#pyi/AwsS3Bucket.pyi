...
from c3.platform.AwsS3BucketNotificationConfig import AwsS3BucketNotificationConfig
from c3.platform.AwsS3Grant import AwsS3Grant
...
from c3.platform.AwsS3BucketOwner import AwsS3BucketOwner
from c3.platform.CloudUpsertable import CloudUpsertable
from c3.platform.AwsS3BucketWebsiteConfig import AwsS3BucketWebsiteConfig
from c3.platform.SetBuilder import SetBuilder
...
# Python definitions for the C3 type AwsS3Bucket
...
class AwsS3Bucket(AwsResource):
    ...
    @remarks this represents a made instance of AwsS3Bucket
    """
    ...
    owner: Optional[AwsS3BucketOwner]=None
    """
    Owner of this bucket.
    """

    grants: Optional[Array[AwsS3Grant]]=None
    """
    ...
    @overload
    @classmethod
    def fromString(cls, s: str) -> Union[AwsS3Bucket]:
    """
    ...
    @overload
    @classmethod
    def fromString(cls, s: str, failIfInvalid: bool=None) -> Union[AwsS3Bucket]:
    """
    Constructs Cloud Resource instance with reference fields and credentials based on provided Cloud Reference string.
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[AwsS3Bucket]:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> AwsS3Bucket:
    """
    ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> AwsS3Bucket:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> AwsS3Bucket:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> AwsS3Bucket:
    """
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[AwsS3Bucket]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[AwsS3Bucket]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[AwsS3Bucket]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[AwsS3Bucket]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> AwsS3Bucket:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> AwsS3Bucket:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> AwsS3Bucket:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[AwsS3Bucket]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[AwsS3Bucket]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> AwsS3Bucket:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> AwsS3Bucket:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> AwsS3Bucket:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> AwsS3Bucket:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> AwsS3Bucket:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> AwsS3Bucket:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> AwsS3Bucket:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> AwsS3Bucket:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> AwsS3Bucket:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> AwsS3Bucket:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> AwsS3Bucket:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> AwsS3Bucket:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> AwsS3Bucket:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> AwsS3Bucket:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> AwsS3Bucket:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> AwsS3Bucket:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> AwsS3Bucket:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> AwsS3Bucket:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> AwsS3Bucket:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> AwsS3Bucket:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> AwsS3Bucket:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> AwsS3Bucket:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> AwsS3Bucket:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> AwsS3Bucket:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> AwsS3Bucket:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> AwsS3Bucket:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> AwsS3Bucket:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> AwsS3Bucket:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[AwsS3Bucket]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[AwsS3Bucket]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[AwsS3Bucket]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[AwsS3Bucket]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[AwsS3Bucket]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, AwsS3Bucket]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, AwsS3Bucket]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[AwsS3Bucket]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[AwsS3Bucket]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> AwsS3Bucket:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> AwsS3Bucket:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> AwsS3Bucket:
    """
    ...
    """
        ...
    def afterMake(self) -> AwsS3Bucket:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> AwsS3Bucket:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[AwsS3Bucket]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> AwsS3Bucket:
    """
    ...
    """
        ...
    @classmethod
    def forId(cls, id: str, failIfMissing: bool=None) -> Union[AwsS3Bucket]:
    """
    Find Cloud Resource in Cloud Provider based on provided C3 canonical identifier.
    """
        ...
    @classmethod
    def fromClusterId(cls, clusterId: str, env: str, app: str, func: str, role: str=None, seq: str=None, subseq: str=None) -> AwsS3Bucket:
    """
    Construct a cloud ID from a cluster ID
    """
        ...
    @classmethod
    def fromEnvId(cls, envId: str, app: str, func: str, role: str=None, seq: str=None, subseq: str=None) -> AwsS3Bucket:
    """
    ...
    """
        ...
    @classmethod
    def fromAppId(cls, appId: str, func: str, role: str=None, seq: str=None, subseq: str=None) -> AwsS3Bucket:
    """
    ...
    """
        ...
    @classmethod
    def fromId(cls, id: str, failIfInvalid: bool=None) -> AwsS3Bucket:
    """
    ...
    """
        ...
    @classmethod
    def fromCloudId(cls, id: CloudId, failIfInvalid: bool=None) -> AwsS3Bucket:
    """
    ...
    """
        ...
    def fromConfigTemplate(self, spec: CloudResourceOperationSpec=None) -> AwsS3Bucket:
    """
    ...
    """
        ...
    def withDefaultConfig(self, spec: CloudResourceOperationSpec=None) -> AwsS3Bucket:
    """
    ...
    """
        ...
    def upsertResource(self, spec: CloudResourceOperationSpec=None) -> AwsS3Bucket:
    """
    Create or update Cloud Resource.
    """
        ...
    def upsertWithDependencies(self, spec: CloudResourceOperationSpec=None) -> AwsS3Bucket:
    """
    ...
    """
        ...
    @classmethod
    def allCached(cls, doNotProduceAll: bool=None) -> Union[Stream[AwsS3Bucket]]:
    """
    ...
    """
        ...
    @classmethod
    def find(cls, filter: str=None, doNotProduceAll: bool=None) -> Union[Stream[AwsS3Bucket]]:
    """
    ...
    """
        ...
    @classmethod
    def findBy(cls, field: str, value: Any, doNotProduceAll: bool=None) -> Union[Stream[AwsS3Bucket]]:
    """
    @param doNotProduceAll if true, will not populate cache and only return available cached instances. Will call
           `produceAll` if cache is empty or if Ann.cache.all is true & data has not previously been fetched.
    @return existing instances of this type that satisfy filter from data cache.
    """
        ...
    @classmethod
    def findByCacheKey(cls, key: str) -> Union[AwsS3Bucket]:
    """
    ...
    """
        ...
    @classmethod
    def produce(cls, key: str) -> Union[AwsS3Bucket]:
    """
    Should produce an entry for the cache key. This method should not be called directly.
    """
        ...
    @classmethod
    def produceAll(cls) -> Union[Map[str, AwsS3Bucket]]:
    """
    ...
    """
        ...
    @classmethod
    def doProduceAll(cls) -> Union[Map[str, AwsS3Bucket]]:
    """
    ...
    """
        ...
    def getConfig(self) -> AwsS3Bucket:
    """
    This method on any CloudResource is not supported! Use CloudResource.for* or other methods instead.
    """
        ...
    ...
    """
        ...
    def getSecret(self) -> AwsS3Bucket:
    """
    ...
    """
        ...
    @classmethod
    def forConfigKey(cls, configKey: str) -> Union[AwsS3Bucket]:
    """
    ...
    """
        ...
    @classmethod
    def listConfigs(cls, parallel: bool=None, filter: Callable[[str], bool]=None) -> Union[Stream[AwsS3Bucket]]:
    """
    @param
    ...
    """
        ...
    @overload
    def setConfigValues(self, from_: AwsS3Bucket, override: str=None) -> None:
    """
    ...
    """
        ...
    @overload
    def setSecretValues(self, from_: AwsS3Bucket, override: str=None) -> None:
    """
    ...
    """
        ...
    @classmethod
    def loadConfigAndSecret(cls, configKey: str) -> Union[AwsS3Bucket]:
    """
    ...
    """
        ...
    def removeSecrets(self) -> Union[AwsS3Bucket]:
    """
    @return this config without any secret values.
    """
        ...
    def removeNonSecrets(self) -> Union[AwsS3Bucket]:
    """
    @return this config with only secret values.
    """
        ...
    def validate(self) -> AwsS3Bucket:
    """
    ...
    """
        ...
    def withIdentity(self, resource: CloudResource=None, spec: CloudResourceOperationSpec=None) -> AwsS3Bucket:
    """
    ...
    """
        ...
    def mergeId(self, other: CloudResource=None) -> AwsS3Bucket:
    """
    ...
    """
        ...
    @classmethod
    def forCloudId(cls, id: CloudId, failIfMissing: bool=None) -> Union[AwsS3Bucket]:
    """
    ...
    """
        ...
    @classmethod
    def forCloudFunc(cls, func: str, role: str=None, failIfMissing: bool=None) -> AwsS3Bucket:
    """
    Find Cloud Resource based on provided cloud func component and optional role.
    """
        ...
    @classmethod
    def forCloudRole(cls, role: str, failIfMissing: bool=None) -> AwsS3Bucket:
    """
    Find Cloud Resource of this type based on provided cloud role component.
    """
        ...
    @classmethod
    def forResourceId(cls, resourceId: str, failIfMissing: bool=None) -> Union[AwsS3Bucket]:
    """
    Find Cloud Resource in the Cloud Provider by provided resource name.
    """
        ...
    @classmethod
    def forResourceSecondaryId(cls, resourceId: str, failIfMissing: bool=None) -> Union[AwsS3Bucket]:
    """
    Find Cloud Resource in the Cloud Provider by provided resource name.
    """
        ...
    ...
    """
        ...
    @classmethod
    def forResourceName(cls, resourceName: str, failIfMissing: bool=None) -> Union[AwsS3Bucket]:
    """
    Find Cloud Resource in the Cloud Provider by provided resource name.
    """
        ...
    @classmethod
    def findResource(cls, reference: str, failIfMissing: bool=None) -> Union[AwsS3Bucket]:
    """
    Find Cloud Resource in the Cloud Provider by provided {@link CloudRef} string.
    """
        ...
    def getResource(self) -> Union[AwsS3Bucket]:
    """
    Find Cloud Resource in the Cloud Provider by provided #resourceId, #resourceSecondaryId, #resourceName or #tags
    (in that order).
    """
        ...
    def ensureResource(self) -> AwsS3Bucket:
    """
    Checks that the resource is persisted. If not, upserts the resource, to ensure that the resource exists.
    """
        ...
    @classmethod
    def listResourcesBySubtype(cls, spec: CloudListResourcesSpec=None) -> Map[str, CloudListResourcesResult[AwsS3Bucket]]:
    """
    ...
    """
        ...
    @classmethod
    def listResources(cls, spec: CloudListResourcesSpec=None) -> CloudListResourcesResult[AwsS3Bucket]:
    """
    ...
    """
        ...
    @classmethod
    def listResourcesForTags(cls, *keyValuePairs: Array[str]) -> CloudListResourcesResult[AwsS3Bucket]:
    """
    List all Cloud Resources that satisfies the given spec.
    ...
    """
        ...
    @classmethod
    def listResourcesForClusterId(cls, clusterId: str, cloudIdRole: str=None, spec: CloudListResourcesSpec=None) -> CloudListResourcesResult[AwsS3Bucket]:
    """
    List all Cloud Resources that satisfies the given spec.
    ...
    """
        ...
    @classmethod
    def listResourcesForEnvId(cls, envId: str, cloudIdRole: str=None, spec: CloudListResourcesSpec=None) -> CloudListResourcesResult[AwsS3Bucket]:
    """
    List all Cloud Resources that satisfies the given spec.
    ...
    """
        ...
    @classmethod
    def listResourcesForAppId(cls, appId: str, cloudIdRole: str=None, spec: CloudListResourcesSpec=None) -> CloudListResourcesResult[AwsS3Bucket]:
    """
    List all Cloud Resources that satisfies the given spec.
    ...
    """
        ...
    def upsertDependencies(self, spec: CloudResourceOperationSpec=None) -> AwsS3Bucket:
    """
    ...
    """
        ...
    def waitForCreate(self, spec: WaitSpec=None) -> Union[AwsS3Bucket]:
    """
    ...
    """
        ...
    @classmethod
    def tagResourcesBatch(cls, resources: Array[AwsS3Bucket], tags: Array[CloudTag]) -> Union[Map[str, Error]]:
    """
    ...
    """
        ...
    @classmethod
    def untagResourcesBatch(cls, resources: Array[AwsS3Bucket], tagKeys: Array[str]) -> Union[Map[str, Error]]:
    """
    ...
    """
        ...
    def waitForOk(self, spec: WaitSpec=None) -> Union[AwsS3Bucket]:
    """
    ...
    """
        ...
    def waitForState(self, state: str='AVAILABLE', spec: WaitSpec=None) -> Union[AwsS3Bucket]:
    """
    ...
    """
        ...
    def setFullyConfigured(self, fullyConfigured: bool=None, override: str=None) -> AwsS3Bucket:
    """
    ...
    """
        ...
    def afterCreate(self, input: AwsS3Bucket=None) -> AwsS3Bucket:
    """
    ...
    """
        ...
    def withoutNonModifiableFields(self) -> AwsS3Bucket:
    """
    ...
    """
        ...
    def withResourceArn(self, resourceArn: str) -> Union[AwsS3Bucket]:
    """
    ...
    """
        ...
    @classmethod
    def exists(cls, bucketName: str, spec: CloudResourceOperationSpec=None) -> bool:
    """
    ...
    """
        ...
    @classmethod
    def fromName(cls, name: str) -> Union[AwsS3Bucket]:
    """
    ...
    """
        ...
    def s3Client(self) -> Union[Any]:
    """
    @return instance of c3.server.aws.client.AwsS3Client for the bucket.
    """
        ...
    def notificationConfigs(self) -> Union[Map[str, AwsS3BucketNotificationConfig]]:
    """
    ...
    """
        ...
    def upsertNotificationConfigs(self, configs: Map[str, AwsS3BucketNotificationConfig]) -> None:
    """
    ...
    """
        ...
    def websiteConfiguration(self) -> Union[AwsS3BucketWebsiteConfig]:
    """
    Returns static website configurations for the bucket.
    """
        ...
    def upsertWebsiteConfiguration(self, config: AwsS3BucketWebsiteConfig) -> None:
    """
    ...
    """
        ...
    def destroyWebsiteConfiguration(self) -> None:
    """
    This method is used to set up static website configurations for the bucket. This method will overwrite configurations
    if configuration already exists, otherwise it will create a new configuration.
    """
        ...
    def policy(self) -> Union[any]:
    """
    ...
    """
        ...
    def upsertPolicy(self, policy: any) -> None:
    """
    Upserts policy on the bucket.
    """
        ...
    def deletePolicy(self) -> None:
    """
    Delete policy on the bucket.
    """
        ...
    def defaultSseEncryption(self) -> Union[str]:
    """
    ...
    """
        ...
    @classmethod
    def cachedSseEncryption(cls, bucketName: str) -> Union[str]:
    """
    ...
    """
        ...
    def blockPublicAccess(self) -> None:
    """
