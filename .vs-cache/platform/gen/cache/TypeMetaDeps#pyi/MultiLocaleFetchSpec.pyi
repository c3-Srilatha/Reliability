...
from c3.platform.MetaLocale import MetaLocale
from c3.platform.MapType import MapType
from c3.platform.Exclude import Exclude
from c3.platform.MapBuilder import MapBuilder
from c3.platform.TimeRange import TimeRange

# Python definitions for the C3 type MultiLocaleFetchSpec


class MultiLocaleFetchSpec(FetchSpec):
    """
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[MultiLocaleFetchSpec]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[MultiLocaleFetchSpec]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[MultiLocaleFetchSpec]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[MultiLocaleFetchSpec]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> MultiLocaleFetchSpec:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> MultiLocaleFetchSpec:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> MultiLocaleFetchSpec:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[MultiLocaleFetchSpec]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[MultiLocaleFetchSpec]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> MultiLocaleFetchSpec:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> MultiLocaleFetchSpec:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> MultiLocaleFetchSpec:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> MultiLocaleFetchSpec:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> MultiLocaleFetchSpec:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> MultiLocaleFetchSpec:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> MultiLocaleFetchSpec:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> MultiLocaleFetchSpec:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> MultiLocaleFetchSpec:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> MultiLocaleFetchSpec:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> MultiLocaleFetchSpec:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> MultiLocaleFetchSpec:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> MultiLocaleFetchSpec:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> MultiLocaleFetchSpec:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> MultiLocaleFetchSpec:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> MultiLocaleFetchSpec:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> MultiLocaleFetchSpec:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> MultiLocaleFetchSpec:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> MultiLocaleFetchSpec:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> MultiLocaleFetchSpec:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> MultiLocaleFetchSpec:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> MultiLocaleFetchSpec:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> MultiLocaleFetchSpec:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> MultiLocaleFetchSpec:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> MultiLocaleFetchSpec:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> MultiLocaleFetchSpec:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> MultiLocaleFetchSpec:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> MultiLocaleFetchSpec:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[MultiLocaleFetchSpec]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[MultiLocaleFetchSpec]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[MultiLocaleFetchSpec]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[MultiLocaleFetchSpec]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[MultiLocaleFetchSpec]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, MultiLocaleFetchSpec]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, MultiLocaleFetchSpec]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[MultiLocaleFetchSpec]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[MultiLocaleFetchSpec]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> MultiLocaleFetchSpec:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> MultiLocaleFetchSpec:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> MultiLocaleFetchSpec:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> MultiLocaleFetchSpec:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> MultiLocaleFetchSpec:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> MultiLocaleFetchSpec:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> MultiLocaleFetchSpec:
    """
    ...
    """
        ...
    def afterMake(self) -> MultiLocaleFetchSpec:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> MultiLocaleFetchSpec:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[MultiLocaleFetchSpec]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> MultiLocaleFetchSpec:
    """
    ...
    """
        ...
    def withIdFilter(self, id: str) -> Union[MultiLocaleFetchSpec]:
    """
    ...
    """
        ...
    def withIdsFilter(self, ids: Array[str]) -> Union[MultiLocaleFetchSpec]:
    """
    ...
    """
        ...
    def withIdRangeFilter(self, startId: str=None, endId: str=None) -> Union[MultiLocaleFetchSpec]:
    """
