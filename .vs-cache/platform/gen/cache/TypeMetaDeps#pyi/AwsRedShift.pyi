...
from c3.platform.AwsRedShiftInstance import AwsRedShiftInstance
...
# Python definitions for the C3 type AwsRedShift


class AwsRedShift(AwsResource, AwsSecurityGroupsMember):
    """
    AwsRedshift is a fast, fully managed, petabyte-scale data warehouse.
    
    @remarks this represents a made instance of AwsRedShift
    """
    ...
    """
    Auto-generated connection endpoint.
    """
    ...
    """
    By specifying a dbName here, we create another database in addition to the default database named "dev". This name
    cannot be modified. Not Modifiable for a existing cluster.
    """

    dbPort: Optional[int]=None
    """
    The port number on which the database accepts connections. Default value is 5439. Not Modifiable for a existing cluster.
    """

    masterUserName: Optional[str]=None
    """
    Name of master user for your cluster. (e.g. awsuser). Not modifiable for a existing cluster.
    """

    masterUserPassword: Optional[str]=None
    """
    If no set here, a random password will be auto-generated and used. Password must contain 8 to 64 printable ASCII characters excluding: /, ", ', \, and @.
    It must contain 1 uppercase letter, 1 lowercase letter, and 1 number. Modifiable for a existing cluster.
    """

    updatingMasterUserPassword: Optional[bool]=None
    """
    Indicate whether the masterUserPassword is being modified.
    """

    instanceType: Optional[str]
    """
    The node type to be provisioned for the cluster. Modifiable for a existing cluster.
    """

    pendingInstanceType: Optional[str]
    """
    The pending modification of instanceType
    """

    instanceCount: Optional[int]=None
    """
    The number of nodes in the cluster. Default value is 1 if not set here. For nodeType "DC1_LARGE" or "DS2_XLARGE", 1 <= nodeNumber <= 32.
    For nodeType "DC1_8XLARGE" or "DS2_8XLARGE", 1 <= nodeNumber <= 100. Modifiable for a existing cluster.
    """

    pendingInstanceCount: Optional[int]=None
    """
    The pending modification of instanceNumber
    """

    instances: Optional[Array[AwsRedShiftInstance]]=None
    """
    ...
    """
    The name of the subnet group that is associated with the cluster. This parameter is valid only when the cluster is
    in a VPC.
    """

    isPubliclyAccessible: Optional[bool]=None
    """
    Specifies the accessibility options for the cluster. The default is False.
    True specifies an Internet-facing instance with a publicly resolvable DNS name, which resolves to a public IP address.
    False specifies an internal instance with a DNS name that resolves to a private IP address.
    """

    isEnhancedVpcRouting: Optional[bool]=None
    """
    An option that specifies whether to create the cluster with enhanced VPC routing enabled. To create a cluster that
    uses enhanced VPC routing, the cluster must be in a VPC.
    """

    pendingIsEnhancedVpcRouting: Optional[bool]=None
    """
    The pending modification of isEnhancedVpcRouting
    """

    isDbDataEncrypted: Optional[bool]=None
    """
    A Boolean value that, if true , indicates that data in the database is encrypted at rest.
    """

    availabilityZone: Optional[str]=None
    """
    The EC2 Availability Zone (AZ) in which you want Amazon Redshift to provision the cluster. For example, if you have
    several EC2 instances running in a specific Availability Zone, then you might want the cluster to be provisioned
    in the same zone in order to decrease network latency.
    """

    iamRoles: Optional[Array[str]]=None
    """
    A list of AWS IAM roles that can be used by the cluster to access other AWS services.
    """
    def __init__(self, id: Optional[str]=None, cluster: Optional[str]=None, env: Optional[str]=None, app: Optional[str]=None, func: Optional[str]=None, role: Optional[str]=None, seq: Optional[str]=None, subseq: Optional[str]=None, resourceId: Optional[str]=None, resourceSecondaryId: Optional[str]=None, resourceName: Optional[str]=None, resourceGroupName: Optional[str]=None, fullyConfigured: Optional[bool]=None, resourceNamespace: Optional[str]=None, external: Optional[bool]=None, credentials: Optional[AwsCredentials]=None, hasGeneratedResourceName: Optional[bool]=None, hasGeneratedResourceSecondaryId: Optional[bool]=None, configOverride: Optional[str]=None, secretOverride: Optional[str]=None, issues: Optional[Array[str]]=None, nativeMetricByName: Optional[Map[str, str]]=None, tags: Optional[Array[CloudTag]]=None, description: Optional[str]=None, parentResource: Optional[CloudResource]=None, securityGroups: Optional[Array[AwsSecurityGroup]]=None, endpoint: Optional[str]=None, status: Optional[str]=None, dbName: Optional[str]=None, dbPort: Optional[int]=None, masterUserName: Optional[str]=None, masterUserPassword: Optional[str]=None, updatingMasterUserPassword: Optional[bool]=None, instanceType: Optional[str]=None, pendingInstanceType: Optional[str]=None, instanceCount: Optional[int]=None, pendingInstanceCount: Optional[int]=None, instances: Optional[Array[AwsRedShiftInstance]]=None, subnetGroupName: Optional[str]=None, isPubliclyAccessible: Optional[bool]=None, isEnhancedVpcRouting: Optional[bool]=None, pendingIsEnhancedVpcRouting: Optional[bool]=None, isDbDataEncrypted: Optional[bool]=None, availabilityZone: Optional[str]=None, iamRoles: Optional[Array[str]]=None) -> None: ...
    ...
    @overload
    @classmethod
    def fromString(cls, s: str) -> Union[AwsRedShift]:
    """
    ...
    @overload
    @classmethod
    def fromString(cls, s: str, failIfInvalid: bool=None) -> Union[AwsRedShift]:
    """
    Constructs Cloud Resource instance with reference fields and credentials based on provided Cloud Reference string.
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[AwsRedShift]:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> AwsRedShift:
    """
    ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> AwsRedShift:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> AwsRedShift:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> AwsRedShift:
    """
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[AwsRedShift]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[AwsRedShift]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[AwsRedShift]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[AwsRedShift]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> AwsRedShift:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> AwsRedShift:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> AwsRedShift:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[AwsRedShift]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[AwsRedShift]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> AwsRedShift:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> AwsRedShift:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> AwsRedShift:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> AwsRedShift:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> AwsRedShift:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> AwsRedShift:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> AwsRedShift:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> AwsRedShift:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> AwsRedShift:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> AwsRedShift:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> AwsRedShift:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> AwsRedShift:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> AwsRedShift:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> AwsRedShift:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> AwsRedShift:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> AwsRedShift:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> AwsRedShift:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> AwsRedShift:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> AwsRedShift:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> AwsRedShift:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> AwsRedShift:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> AwsRedShift:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> AwsRedShift:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> AwsRedShift:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> AwsRedShift:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> AwsRedShift:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> AwsRedShift:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> AwsRedShift:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[AwsRedShift]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[AwsRedShift]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[AwsRedShift]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[AwsRedShift]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[AwsRedShift]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, AwsRedShift]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, AwsRedShift]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[AwsRedShift]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[AwsRedShift]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> AwsRedShift:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> AwsRedShift:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> AwsRedShift:
    """
    ...
    """
        ...
    def afterMake(self) -> AwsRedShift:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> AwsRedShift:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[AwsRedShift]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> AwsRedShift:
    """
    ...
    """
        ...
    @classmethod
    def forId(cls, id: str, failIfMissing: bool=None) -> Union[AwsRedShift]:
    """
    Find Cloud Resource in Cloud Provider based on provided C3 canonical identifier.
    """
        ...
    @classmethod
    def fromClusterId(cls, clusterId: str, env: str, app: str, func: str, role: str=None, seq: str=None, subseq: str=None) -> AwsRedShift:
    """
    Construct a cloud ID from a cluster ID
    """
        ...
    @classmethod
    def fromEnvId(cls, envId: str, app: str, func: str, role: str=None, seq: str=None, subseq: str=None) -> AwsRedShift:
    """
    ...
    """
        ...
    @classmethod
    def fromAppId(cls, appId: str, func: str, role: str=None, seq: str=None, subseq: str=None) -> AwsRedShift:
    """
    ...
    """
        ...
    @classmethod
    def fromId(cls, id: str, failIfInvalid: bool=None) -> AwsRedShift:
    """
    ...
    """
        ...
    @classmethod
    def fromCloudId(cls, id: CloudId, failIfInvalid: bool=None) -> AwsRedShift:
    """
    ...
    """
        ...
    def fromConfigTemplate(self, spec: CloudResourceOperationSpec=None) -> AwsRedShift:
    """
    ...
    """
        ...
    def withDefaultConfig(self, spec: CloudResourceOperationSpec=None) -> AwsRedShift:
    """
    ...
    """
        ...
    def upsertResource(self, spec: CloudResourceOperationSpec=None) -> AwsRedShift:
    """
    Create or update Cloud Resource.
    """
        ...
    def upsertWithDependencies(self, spec: CloudResourceOperationSpec=None) -> AwsRedShift:
    """
    ...
    """
        ...
    @classmethod
    def allCached(cls, doNotProduceAll: bool=None) -> Union[Stream[AwsRedShift]]:
    """
    ...
    """
        ...
    @classmethod
    def find(cls, filter: str=None, doNotProduceAll: bool=None) -> Union[Stream[AwsRedShift]]:
    """
    ...
    """
        ...
    @classmethod
    def findBy(cls, field: str, value: Any, doNotProduceAll: bool=None) -> Union[Stream[AwsRedShift]]:
    """
    @param doNotProduceAll if true, will not populate cache and only return available cached instances. Will call
           `produceAll` if cache is empty or if Ann.cache.all is true & data has not previously been fetched.
    @return existing instances of this type that satisfy filter from data cache.
    """
        ...
    @classmethod
    def findByCacheKey(cls, key: str) -> Union[AwsRedShift]:
    """
    ...
    """
        ...
    @classmethod
    def produce(cls, key: str) -> Union[AwsRedShift]:
    """
    Should produce an entry for the cache key. This method should not be called directly.
    """
        ...
    @classmethod
    def produceAll(cls) -> Union[Map[str, AwsRedShift]]:
    """
    ...
    """
        ...
    @classmethod
    def doProduceAll(cls) -> Union[Map[str, AwsRedShift]]:
    """
    ...
    """
        ...
    def getConfig(self) -> AwsRedShift:
    """
    This method on any CloudResource is not supported! Use CloudResource.for* or other methods instead.
    """
        ...
    ...
    """
        ...
    def getSecret(self) -> AwsRedShift:
    """
    ...
    """
        ...
    @classmethod
    def forConfigKey(cls, configKey: str) -> Union[AwsRedShift]:
    """
    ...
    """
        ...
    @classmethod
    def listConfigs(cls, parallel: bool=None, filter: Callable[[str], bool]=None) -> Union[Stream[AwsRedShift]]:
    """
    @param
    ...
    """
        ...
    @overload
    def setConfigValues(self, from_: AwsRedShift, override: str=None) -> None:
    """
    ...
    """
        ...
    @overload
    def setSecretValues(self, from_: AwsRedShift, override: str=None) -> None:
    """
    ...
    """
        ...
    @classmethod
    def loadConfigAndSecret(cls, configKey: str) -> Union[AwsRedShift]:
    """
    ...
    """
        ...
    def removeSecrets(self) -> Union[AwsRedShift]:
    """
    @return this config without any secret values.
    """
        ...
    def removeNonSecrets(self) -> Union[AwsRedShift]:
    """
    @return this config with only secret values.
    """
        ...
    def validate(self) -> AwsRedShift:
    """
    ...
    """
        ...
    def withIdentity(self, resource: CloudResource=None, spec: CloudResourceOperationSpec=None) -> AwsRedShift:
    """
    ...
    """
        ...
    def mergeId(self, other: CloudResource=None) -> AwsRedShift:
    """
    ...
    """
        ...
    @classmethod
    def forCloudId(cls, id: CloudId, failIfMissing: bool=None) -> Union[AwsRedShift]:
    """
    ...
    """
        ...
    @classmethod
    def forCloudFunc(cls, func: str, role: str=None, failIfMissing: bool=None) -> AwsRedShift:
    """
    Find Cloud Resource based on provided cloud func component and optional role.
    """
        ...
    @classmethod
    def forCloudRole(cls, role: str, failIfMissing: bool=None) -> AwsRedShift:
    """
    Find Cloud Resource of this type based on provided cloud role component.
    """
        ...
    @classmethod
    def forResourceId(cls, resourceId: str, failIfMissing: bool=None) -> Union[AwsRedShift]:
    """
    Find Cloud Resource in the Cloud Provider by provided resource name.
    """
        ...
    @classmethod
    def forResourceSecondaryId(cls, resourceId: str, failIfMissing: bool=None) -> Union[AwsRedShift]:
    """
    Find Cloud Resource in the Cloud Provider by provided resource name.
    """
        ...
    ...
    """
        ...
    @classmethod
    def forResourceName(cls, resourceName: str, failIfMissing: bool=None) -> Union[AwsRedShift]:
    """
    Find Cloud Resource in the Cloud Provider by provided resource name.
    """
        ...
    @classmethod
    def findResource(cls, reference: str, failIfMissing: bool=None) -> Union[AwsRedShift]:
    """
    Find Cloud Resource in the Cloud Provider by provided {@link CloudRef} string.
    """
        ...
    def getResource(self) -> Union[AwsRedShift]:
    """
    Find Cloud Resource in the Cloud Provider by provided #resourceId, #resourceSecondaryId, #resourceName or #tags
    (in that order).
    """
        ...
    def ensureResource(self) -> AwsRedShift:
    """
    Checks that the resource is persisted. If not, upserts the resource, to ensure that the resource exists.
    """
        ...
    @classmethod
    def listResourcesBySubtype(cls, spec: CloudListResourcesSpec=None) -> Map[str, CloudListResourcesResult[AwsRedShift]]:
    """
    ...
    """
        ...
    @classmethod
    def listResources(cls, spec: CloudListResourcesSpec=None) -> CloudListResourcesResult[AwsRedShift]:
    """
    ...
    """
        ...
    @classmethod
    def listResourcesForTags(cls, *keyValuePairs: Array[str]) -> CloudListResourcesResult[AwsRedShift]:
    """
    List all Cloud Resources that satisfies the given spec.
    ...
    """
        ...
    @classmethod
    def listResourcesForClusterId(cls, clusterId: str, cloudIdRole: str=None, spec: CloudListResourcesSpec=None) -> CloudListResourcesResult[AwsRedShift]:
    """
    List all Cloud Resources that satisfies the given spec.
    ...
    """
        ...
    @classmethod
    def listResourcesForEnvId(cls, envId: str, cloudIdRole: str=None, spec: CloudListResourcesSpec=None) -> CloudListResourcesResult[AwsRedShift]:
    """
    List all Cloud Resources that satisfies the given spec.
    ...
    """
        ...
    @classmethod
    def listResourcesForAppId(cls, appId: str, cloudIdRole: str=None, spec: CloudListResourcesSpec=None) -> CloudListResourcesResult[AwsRedShift]:
    """
    List all Cloud Resources that satisfies the given spec.
    ...
    """
        ...
    def upsertDependencies(self, spec: CloudResourceOperationSpec=None) -> AwsRedShift:
    """
    ...
    """
        ...
    def waitForCreate(self, spec: WaitSpec=None) -> Union[AwsRedShift]:
    """
    ...
    """
        ...
    @classmethod
    def tagResourcesBatch(cls, resources: Array[AwsRedShift], tags: Array[CloudTag]) -> Union[Map[str, Error]]:
    """
    ...
    """
        ...
    @classmethod
    def untagResourcesBatch(cls, resources: Array[AwsRedShift], tagKeys: Array[str]) -> Union[Map[str, Error]]:
    """
    ...
    """
        ...
    def waitForOk(self, spec: WaitSpec=None) -> Union[AwsRedShift]:
    """
    ...
    """
        ...
    def waitForState(self, state: str='AVAILABLE', spec: WaitSpec=None) -> Union[AwsRedShift]:
    """
    ...
    """
        ...
    def setFullyConfigured(self, fullyConfigured: bool=None, override: str=None) -> AwsRedShift:
    """
    ...
    """
        ...
    def afterCreate(self, input: AwsRedShift=None) -> AwsRedShift:
    """
    ...
    """
        ...
    def withoutNonModifiableFields(self) -> AwsRedShift:
    """
    ...
    """
        ...
    def withResourceArn(self, resourceArn: str) -> Union[AwsRedShift]:
    """
