...
# Python definitions for the C3 type DataGrid.Tuples


class Tuples(DataGrid.CollBase):
    """
    ...
    tupleType: Optional[TupleType]=None
    """
    ...
    """
    def __init__(self, source: Optional[Any]=None, label: Optional[str]=None, description: Optional[str]=None, cols: Optional[Array[DataGrid.Col]]=None, _coll: Optional[Collection[]]=None, _stream: Optional[Stream[]]=None, _buffer: Optional[Any]=None, _keys: Optional[Array[Union[Any]]]=None, tupleType: Optional[TupleType]=None) -> None: ...
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[DataGrid.Tuples]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[DataGrid.Tuples]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[DataGrid.Tuples]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[DataGrid.Tuples]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> DataGrid.Tuples:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> DataGrid.Tuples:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> DataGrid.Tuples:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[DataGrid.Tuples]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[DataGrid.Tuples]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> DataGrid.Tuples:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> DataGrid.Tuples:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> DataGrid.Tuples:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> DataGrid.Tuples:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> DataGrid.Tuples:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> DataGrid.Tuples:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> DataGrid.Tuples:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> DataGrid.Tuples:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> DataGrid.Tuples:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> DataGrid.Tuples:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> DataGrid.Tuples:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> DataGrid.Tuples:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> DataGrid.Tuples:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> DataGrid.Tuples:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> DataGrid.Tuples:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> DataGrid.Tuples:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> DataGrid.Tuples:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> DataGrid.Tuples:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> DataGrid.Tuples:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> DataGrid.Tuples:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> DataGrid.Tuples:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> DataGrid.Tuples:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> DataGrid.Tuples:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> DataGrid.Tuples:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> DataGrid.Tuples:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> DataGrid.Tuples:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> DataGrid.Tuples:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> DataGrid.Tuples:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[DataGrid.Tuples]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[DataGrid.Tuples]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[DataGrid.Tuples]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[DataGrid.Tuples]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[DataGrid.Tuples]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, DataGrid.Tuples]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, DataGrid.Tuples]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[DataGrid.Tuples]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[DataGrid.Tuples]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> DataGrid.Tuples:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> DataGrid.Tuples:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> DataGrid.Tuples:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> DataGrid.Tuples:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> DataGrid.Tuples:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> DataGrid.Tuples:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> DataGrid.Tuples:
    """
    ...
    """
        ...
    def afterMake(self) -> DataGrid.Tuples:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> DataGrid.Tuples:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[DataGrid.Tuples]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> DataGrid.Tuples:
    """
    ...
    def _formatLabel(self, value: Any=None) -> Union[str]:
        ...
    @classmethod
    def fromCollection(cls, coll: Collection[Any], spec: DataGrid.LoadSpec=None) -> DataGrid.Tuples:
    """
