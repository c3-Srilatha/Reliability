...
from c3.platform.FileSystemEvent import FileSystemEvent
...
# Python definitions for the C3 type FileSourceCollection


class FileSourceCollection(SourceCollection[SourceCollection.Config], FileInfoOverride, FileSystemListener):
    """
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[FileSourceCollection]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[FileSourceCollection]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[FileSourceCollection]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[FileSourceCollection]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> FileSourceCollection:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> FileSourceCollection:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> FileSourceCollection:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[FileSourceCollection]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[FileSourceCollection]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> FileSourceCollection:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> FileSourceCollection:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> FileSourceCollection:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> FileSourceCollection:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> FileSourceCollection:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> FileSourceCollection:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> FileSourceCollection:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> FileSourceCollection:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> FileSourceCollection:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> FileSourceCollection:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> FileSourceCollection:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> FileSourceCollection:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> FileSourceCollection:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> FileSourceCollection:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> FileSourceCollection:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> FileSourceCollection:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> FileSourceCollection:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> FileSourceCollection:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> FileSourceCollection:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> FileSourceCollection:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> FileSourceCollection:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> FileSourceCollection:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> FileSourceCollection:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> FileSourceCollection:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> FileSourceCollection:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> FileSourceCollection:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> FileSourceCollection:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> FileSourceCollection:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[FileSourceCollection]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[FileSourceCollection]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[FileSourceCollection]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[FileSourceCollection]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[FileSourceCollection]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, FileSourceCollection]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, FileSourceCollection]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[FileSourceCollection]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[FileSourceCollection]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> FileSourceCollection:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> FileSourceCollection:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> FileSourceCollection:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> FileSourceCollection:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> FileSourceCollection:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> FileSourceCollection:
    """
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[FileSourceCollection]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> FileSourceCollection:
    """
    ...
    """
        ...
    def afterMake(self) -> FileSourceCollection:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> FileSourceCollection:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[FileSourceCollection]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> FileSourceCollection:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, spec: FetchSpec=None) -> FetchResult[FileSourceCollection]:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, filter: Filter) -> FetchResult[FileSourceCollection]:
    """
    ...
    """
        ...
    @classmethod
    def fetchObjStream(cls, spec: FetchStreamSpec=None) -> Union[Stream[FileSourceCollection]]:
    """
    Fetches multiple obj instances based on a specification.  Only objs that the caller is authorized to fetch will be
    returned.
    ...
    """
        ...
    @classmethod
    def fetchMultiLocale(cls, spec: MultiLocaleFetchSpec=None) -> Union[Map[str, FetchResult[FileSourceCollection]]]:
    """
    ...
    """
        ...
    def save(self, subPath: str=None, contentType: str=None) -> FileSourceCollection:
        ...
    ...
    def removeAll(cls, removeFilter: str=None) -> int:
        ...
    def update(self, srcObj: FileSourceCollection=None, spec: UpsertSpec=None) -> Union[FileSourceCollection]:
        ...
    def upsert(self, srcObj: FileSourceCollection=None, spec: UpsertSpec=None) -> Union[FileSourceCollection]:
        ...
    @classmethod
    ...
    """
        ...
    @classmethod
    def fromString(cls, s: str) -> Union[FileSourceCollection]:
    """
    ...
    """
        ...
    @classmethod
    def forName(cls, name: str, failIfMissing: bool=None) -> Union[FileSourceCollection]:
    """
    ...
    """
        ...
    @classmethod
    def collectionsForSourceType(cls, sourceType: Type, include: str=None) -> Union[Stream[FileSourceCollection]]:
    """
    ...
    """
        ...
    def setPriority(self, priority: int) -> FileSourceCollection:
    """
    @return SourceCollection after setting the priority
    """
        ...
    def clearPriority(self) -> FileSourceCollection:
    """
    ...
    """
        ...
    def skipTransform(self, transformId: str=None) -> FileSourceCollection:
    """
    skip #transform for the source collection.
    """
        ...
    def skipTransformBatch(self, transformIds: Array[str]) -> FileSourceCollection:
    """
    skip #transform for the source collection.
    """
        ...
    def clearSkippedTransforms(self, transformsId: Array[str]) -> FileSourceCollection:
    """
    skip #transform for the source collection.
    """
        ...
    def clearAllSkippedTransforms(self) -> FileSourceCollection:
    """
    skip #transform for the source collection.
    """
        ...
    ...
    """
        ...
    @classmethod
    def processBatch(cls, events: Array[FileSystemEvent]) -> None:
    """
    Call by the underlying file system to notify listeners of file change events.
    """
        ...
    def notificationConfig(self) -> Union[FileSystemNotificationConfig]:
    """
    ...
    """
        ...
    @classmethod
    def forUrlOrEncodedPath(cls, urlOrEncodedPath: str, failIfMissing: bool=None) -> Union[FileSourceCollection]:
    """
    @return a file source collection for urlOrEncodedPath
    """
        ...
    @classmethod
    def forFile(cls, file: File, failIfMissing: bool=None) -> Union[FileSourceCollection]:
    """
    @return a file source collection for file
    """
        ...
    def fileInfo(self, file: File=None) -> Union[SourceFileInfo]:
    """
    ...
    """
        ...
    def parseInboxUrl(self) -> Url:
    """
    @return {@link Url} instance from the inboxUrl for the source collection
    """
        ...
    def validateUrls(self, failIfInvalid: bool=None) -> bool:
        ...
