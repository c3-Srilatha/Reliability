...
# Python definitions for the C3 type Gettable


class Gettable(Value):
    """
    Type containing functions for all fetch operations
    
    @remarks this represents a made instance of Gettable
    """
    def __init__(self) -> None: ...

    def get(self, include: str=None) -> Union[Gettable]:
    """
    ...
    """
        ...
    def getSpecific(self, include: str=None) -> Union[Gettable]:
    """
    ...
    """
        ...
    def getMissing(self, spec: GetMissingSpec) -> Gettable:
    """
    ...
    """
        ...
    def getDirect(self, include: str=None) -> Union[Gettable]:
    """
