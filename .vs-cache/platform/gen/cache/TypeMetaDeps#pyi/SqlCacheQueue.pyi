...
# Python definitions for the C3 type SqlCacheQueue


class SqlCacheQueue(CacheQueue, Value):
    """
    Invalidation queue for cache invalidation processing.
    
    @remarks this represents a made instance of SqlCacheQueue
    """
