...
# Python definitions for the C3 type Performance
...
class Performance(Value):
    ...
    """
        ...
    @classmethod
    def retainedMem(cls, value: Any) -> int:
    """
    ...
    """
        ...
    @classmethod
    def shallowMem(cls, value: Any) -> int:
    """
    Measure the amount of memory retained by the specified object in bytes. This is the memory used by the object
    itself only.
    """
        ...
    @classmethod
    def retainedMemJava(cls, value: Any) -> int:
    """
    ...
    """
        ...
    @classmethod
    def shallowMemJava(cls, value: Any) -> int:
    """
    Measure the amount of memory retained by the specified object in Java (server). This is the memory used by the
    object itself only.
    """
