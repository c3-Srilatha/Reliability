...
from c3.platform.ModelHealthUiSettings import ModelHealthUiSettings
from c3.platform.SetBuilder import SetBuilder
...
# Python definitions for the C3 type ModelMonitoringUiConfig


class ModelMonitoringUiConfig(Config, Singleton):
    """
    UI configuration settings for model monitoring.
    
    @remarks this represents a made instance of ModelMonitoringUiConfig
    """
    ...
    modelHealthUiSettingsMap: Optional[Map[str, ModelHealthUiSettings]]=None
    """
    Config map containing health value to color, icon, display text mapping.
    """

    documentationUrl: Optional[str]=None
    """
    Model monitoring documentation url.
    """
    def __init__(self, configOverride: Optional[str]=None, secretOverride: Optional[str]=None, issues: Optional[Array[str]]=None, modelHealthUiSettingsMap: Optional[Map[str, ModelHealthUiSettings]]=None, documentationUrl: Optional[str]=None) -> None: ...
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[ModelMonitoringUiConfig]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[ModelMonitoringUiConfig]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[ModelMonitoringUiConfig]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[ModelMonitoringUiConfig]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> ModelMonitoringUiConfig:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> ModelMonitoringUiConfig:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> ModelMonitoringUiConfig:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[ModelMonitoringUiConfig]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[ModelMonitoringUiConfig]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> ModelMonitoringUiConfig:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> ModelMonitoringUiConfig:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> ModelMonitoringUiConfig:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> ModelMonitoringUiConfig:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> ModelMonitoringUiConfig:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> ModelMonitoringUiConfig:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> ModelMonitoringUiConfig:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> ModelMonitoringUiConfig:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> ModelMonitoringUiConfig:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> ModelMonitoringUiConfig:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> ModelMonitoringUiConfig:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> ModelMonitoringUiConfig:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> ModelMonitoringUiConfig:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> ModelMonitoringUiConfig:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> ModelMonitoringUiConfig:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> ModelMonitoringUiConfig:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> ModelMonitoringUiConfig:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> ModelMonitoringUiConfig:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> ModelMonitoringUiConfig:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> ModelMonitoringUiConfig:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> ModelMonitoringUiConfig:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> ModelMonitoringUiConfig:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> ModelMonitoringUiConfig:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> ModelMonitoringUiConfig:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> ModelMonitoringUiConfig:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> ModelMonitoringUiConfig:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> ModelMonitoringUiConfig:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> ModelMonitoringUiConfig:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[ModelMonitoringUiConfig]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[ModelMonitoringUiConfig]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[ModelMonitoringUiConfig]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[ModelMonitoringUiConfig]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[ModelMonitoringUiConfig]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, ModelMonitoringUiConfig]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, ModelMonitoringUiConfig]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[ModelMonitoringUiConfig]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[ModelMonitoringUiConfig]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> ModelMonitoringUiConfig:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> ModelMonitoringUiConfig:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> ModelMonitoringUiConfig:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> ModelMonitoringUiConfig:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> ModelMonitoringUiConfig:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> ModelMonitoringUiConfig:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> ModelMonitoringUiConfig:
    """
    ...
    """
        ...
    def afterMake(self) -> ModelMonitoringUiConfig:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> ModelMonitoringUiConfig:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[ModelMonitoringUiConfig]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> ModelMonitoringUiConfig:
    """
    ...
    """
        ...
    @classmethod
    def allCached(cls, doNotProduceAll: bool=None) -> Union[Stream[ModelMonitoringUiConfig]]:
    """
    ...
    """
        ...
    @classmethod
    def find(cls, filter: str=None, doNotProduceAll: bool=None) -> Union[Stream[ModelMonitoringUiConfig]]:
    """
    ...
    """
        ...
    @classmethod
    def findBy(cls, field: str, value: Any, doNotProduceAll: bool=None) -> Union[Stream[ModelMonitoringUiConfig]]:
    """
    @param doNotProduceAll if true, will not populate cache and only return available cached instances. Will call
           `produceAll` if cache is empty or if Ann.cache.all is true & data has not previously been fetched.
    @return existing instances of this type that satisfy filter from data cache.
    """
        ...
    @classmethod
    def findByCacheKey(cls, key: str) -> Union[ModelMonitoringUiConfig]:
    """
    ...
    """
        ...
    @classmethod
    def forCacheKey(cls, key: str) -> Union[ModelMonitoringUiConfig]:
    """
    Returns cached instance by key, with secrets removed.
    """
        ...
    def getCached(self) -> Union[ModelMonitoringUiConfig]:
    """
    ...
    """
        ...
    def refreshCache(self) -> Union[ModelMonitoringUiConfig]:
    """
    ...
    """
        ...
    @classmethod
    def produce(cls, key: str) -> Union[ModelMonitoringUiConfig]:
    """
    Should produce an entry for the cache key. This method should not be called directly.
    """
        ...
    @classmethod
    def produceAll(cls) -> Union[Map[str, ModelMonitoringUiConfig]]:
    """
    ...
    """
        ...
    @classmethod
    def doProduceAll(cls) -> Union[Map[str, ModelMonitoringUiConfig]]:
    """
    ...
    """
        ...
    def getConfig(self) -> ModelMonitoringUiConfig:
    """
    ...
    """
        ...
    def getSecret(self) -> ModelMonitoringUiConfig:
    """
    ...
    """
        ...
    @classmethod
    def forConfigKey(cls, configKey: str) -> Union[ModelMonitoringUiConfig]:
    """
    ...
    """
        ...
    @classmethod
    def listConfigs(cls, parallel: bool=None, filter: Callable[[str], bool]=None) -> Union[Stream[ModelMonitoringUiConfig]]:
    """
    @param
    ...
    """
        ...
    @overload
    def setConfigValues(self, from_: ModelMonitoringUiConfig, override: str=None) -> None:
    """
    ...
    """
        ...
    @overload
    def setSecretValues(self, from_: ModelMonitoringUiConfig, override: str=None) -> None:
    """
    ...
    """
        ...
    @classmethod
    def loadConfigAndSecret(cls, configKey: str) -> Union[ModelMonitoringUiConfig]:
    """
    ...
    """
        ...
    def removeSecrets(self) -> Union[ModelMonitoringUiConfig]:
    """
    @return this config without any secret values.
    """
        ...
    def removeNonSecrets(self) -> Union[ModelMonitoringUiConfig]:
    """
    @return this config with only secret values.
    """
        ...
    def validate(self) -> ModelMonitoringUiConfig:
    """
