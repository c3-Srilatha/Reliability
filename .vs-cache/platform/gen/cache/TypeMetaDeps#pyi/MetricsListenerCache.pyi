...
from c3.platform.MetricsListenerCacheEntry import MetricsListenerCacheEntry

# Python definitions for the C3 type MetricsListenerCache


class MetricsListenerCache(MetadataCacheOld[MetricsListenerCacheEntry], Value):
    """
    ...
    @classmethod
    def get(cls, key: str) -> Union[MetricsListenerCacheEntry]:
    """
    ...
    """
        ...
    @classmethod
    def require(cls, key: str) -> MetricsListenerCacheEntry:
    """
    ...
    """
        ...
    @classmethod
    def put(cls, key: str, value: MetricsListenerCacheEntry) -> None:
    """
    ...
    """
        ...
    @classmethod
    def produce(cls, key: str) -> Union[MetricsListenerCacheEntry]:
    """
    ...
    """
        ...
    @classmethod
    def produceAll(cls) -> Union[Map[str, MetricsListenerCacheEntry]]:
    """
    ...
    """
        ...
    @classmethod
    def release(cls, key: str, value: MetricsListenerCacheEntry) -> None:
    """
    ...
    """
        ...
    @classmethod
    def validate(cls, value: MetricsListenerCacheEntry) -> bool:
    """
    ...
    """
        ...
    @classmethod
    def info(cls) -> MetricsListenerCacheEntry:
    """
    @return The contents of the cache
    """
        ...
    @classmethod
    def hasListener(cls, metricId: str) -> bool:
    """
    @return True if there is a listener for the metric
    """
        ...
    @classmethod
    def metrics(cls) -> Union[Array[str]]:
    """
    @return A list of all metrics that have listeners.
    """
        ...
    @classmethod
    def metricsForSrcType(cls, srcType: Type) -> Union[Array[str]]:
    """
