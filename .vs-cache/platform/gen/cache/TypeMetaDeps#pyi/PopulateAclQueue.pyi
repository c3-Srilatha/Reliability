...
from c3.platform.PopulateAclQueueEntry import PopulateAclQueueEntry

# Python definitions for the C3 type PopulateAclQueue


class PopulateAclQueue(InvalidationQueue[PopulateAclQueueEntry], Value):
    """
    ...
    @classmethod
    def compute(cls, targetType: Type, entries: Array[PopulateAclQueueEntry]) -> None:
    """
    ...
    """
        ...
    @classmethod
    def find(cls, spec: InvalidationQueue.FindSpec=None) -> Union[Array[PopulateAclQueueEntry]]:
    """
    ...
    """
        ...
    @classmethod
    def findStream(cls, spec: InvalidationQueue.FindStreamSpec=None) -> Union[Stream[PopulateAclQueueEntry]]:
    """
    ...
    """
        ...
    @classmethod
    def clearEntries(cls, entries: Array[PopulateAclQueueEntry]) -> None:
    """
