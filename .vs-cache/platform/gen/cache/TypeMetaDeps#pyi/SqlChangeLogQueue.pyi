...
# Python definitions for the C3 type SqlChangeLogQueue


class SqlChangeLogQueue(ChangeLogQueue, Value):
    """
    Invalidation queue for generic invalidation based on data changes processing.
    
    @remarks this represents a made instance of SqlChangeLogQueue
    """
