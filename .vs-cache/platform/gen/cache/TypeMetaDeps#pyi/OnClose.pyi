...
# Python definitions for the C3 type OnClose


class OnClose(Lambda[function(resource: any): any]):
    """
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[OnClose]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[OnClose]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[OnClose]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[OnClose]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> OnClose:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> OnClose:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> OnClose:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[OnClose]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[OnClose]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> OnClose:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> OnClose:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> OnClose:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> OnClose:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> OnClose:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> OnClose:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> OnClose:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> OnClose:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> OnClose:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> OnClose:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> OnClose:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> OnClose:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> OnClose:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> OnClose:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> OnClose:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> OnClose:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> OnClose:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> OnClose:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> OnClose:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> OnClose:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> OnClose:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> OnClose:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> OnClose:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> OnClose:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> OnClose:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> OnClose:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> OnClose:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[OnClose]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[OnClose]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[OnClose]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[OnClose]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[OnClose]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, OnClose]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, OnClose]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[OnClose]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[OnClose]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> OnClose:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> OnClose:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> OnClose:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> OnClose:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> OnClose:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> OnClose:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> OnClose:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> OnClose:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[OnClose]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> OnClose:
    """
    ...
    """
        ...
    def partiallyApply(self, args: Map[str, Any]=None) -> OnClose:
    """
    @return a clone of this lambda with partially applied arguments.
    """
        ...
    def partiallyApplyBatch(self, args: Array[Map[str, Any]]) -> Array[OnClose]:
    """
    @return an array of clones of this lambda with partially applied arguments (elements of the input array).
    """
        ...
    def partiallyCall(self, *args: Array[Any]) -> OnClose:
    """
    ...
    """
        ...
    def withSignature(self, signature: FunctionType=None) -> OnClose:
    """
    ...
    """
        ...
    @classmethod
    def fromAction(cls, type: Type, action: str) -> OnClose:
    """
    ...
    """
        ...
    @classmethod
    def fromJavaMethod(cls, class_: str, method: str, functionType: str=None) -> OnClose:
    """
    ...
    """
        ...
    @classmethod
    def fromJavaSrc(cls, javaCode: str) -> OnClose:
    """
    ...
    """
        ...
    @classmethod
    def fromJavaSerializableSupplier(cls, javaSerializableSupplier: Callable[[], Union[Any]]) -> OnClose:
    """
    ...
    """
        ...
    @classmethod
    def fromJavaSerializableFunction(cls, javaSerializableFunction: Callable[[Union[Any]], Union[Any]]) -> OnClose:
    """
    Create a lambda from the specified native Java lambda.
    ...
    """
        ...
    @classmethod
    def fromJavaSerializableBiFunction(cls, javaSerializableBiFunction: Callable[[Union[Any], Union[Any]], Union[Any]]) -> OnClose:
    """
    Create a lambda from the specified native Java lambda.
    ...
    """
        ...
    @classmethod
    def fromJavaSerializableRunnable(cls, javaSerializableRunnable: Callable[[]]) -> OnClose:
    """
    Create a lambda from the specified native Java lambda.
    ...
    """
        ...
    @classmethod
    def fromJsSrc(cls, functionCode: str) -> OnClose:
    """
    ...
    """
        ...
    @classmethod
    def fromJsFunc(cls, func: Any) -> OnClose:
    """
    ...
    """
        ...
    @classmethod
    def fromPySrc(cls, functionCode: str, actionRequirement: str=None) -> OnClose:
    """
    ...
    """
        ...
    @classmethod
    def fromPyFunc(cls, func: Any, actionRequirement: str=None) -> OnClose:
    """
    ...
    @overload
    @classmethod
    def fromSrc(cls, signature: FunctionType, src: Content) -> OnClose:
    """
    ...
    @overload
    @classmethod
    def fromSrc(cls, signature: FunctionType, language: str, impl: str, actionRequirement: str=None) -> OnClose:
    """
    ...
    """
        ...
    @classmethod
    def fromString(cls, s: str) -> Union[OnClose]:
    """
    ...
    """
        ...
    @classmethod
    def convertFromString(cls, s: str, failIfInvalid: bool=None) -> Union[OnClose]:
    """
