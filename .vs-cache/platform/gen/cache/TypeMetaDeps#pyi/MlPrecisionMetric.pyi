...
# Python definitions for the C3 type MlPrecisionMetric


class MlPrecisionMetric(MlScoringMetricSupportingPd[Data, Data, { sampleWeights: Data }]):
    """
    The {@link MlPrecisionMetric} computes the proportion of positive prediction values that are correct. Expressed
    as a formula:
    ```
    precision = true_positives / (true_positives + false_positives)
    ```
    This metric only works for binary classification. If there are no true positive and false positive predictions,
    this metric returns 0. The `modelOutput` can either be a single-dimensional with binary (i.e. 0 and 1) data
    or two-dimensional with predicted probabilities for class '0' and '1'. Column '1' will be used for scoring.
    The `targetOutput` is expected to be single-dimensional with binary (i.e. 0 and 1) data.
    This metric supports `sampleWeights` as `context`. `sampleWeights` is single-dimensional
    with same number of samples as the `modelOutput`.
    It represents a per-sample weighting when aggregating for Precision calculation.
    
    @remarks this represents a made instance of MlPrecisionMetric
    """
    ...
    labels for Precision Score calculation. `probaThreshold` defaults to 0.5 if no value is provided with the predicted
    probabilities as input
    """
    def __init__(self, name: Optional[str]=None, useIndex: Optional[bool]=None, batchSize: Optional[int]=None, probaThreshold: Optional[float]=None) -> None: ...
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[MlPrecisionMetric]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[MlPrecisionMetric]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[MlPrecisionMetric]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[MlPrecisionMetric]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> MlPrecisionMetric:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> MlPrecisionMetric:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> MlPrecisionMetric:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[MlPrecisionMetric]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[MlPrecisionMetric]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> MlPrecisionMetric:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> MlPrecisionMetric:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> MlPrecisionMetric:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> MlPrecisionMetric:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> MlPrecisionMetric:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> MlPrecisionMetric:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> MlPrecisionMetric:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> MlPrecisionMetric:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> MlPrecisionMetric:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> MlPrecisionMetric:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> MlPrecisionMetric:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> MlPrecisionMetric:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> MlPrecisionMetric:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> MlPrecisionMetric:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> MlPrecisionMetric:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> MlPrecisionMetric:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> MlPrecisionMetric:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> MlPrecisionMetric:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> MlPrecisionMetric:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> MlPrecisionMetric:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> MlPrecisionMetric:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> MlPrecisionMetric:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> MlPrecisionMetric:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> MlPrecisionMetric:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> MlPrecisionMetric:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> MlPrecisionMetric:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> MlPrecisionMetric:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> MlPrecisionMetric:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[MlPrecisionMetric]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[MlPrecisionMetric]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[MlPrecisionMetric]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[MlPrecisionMetric]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[MlPrecisionMetric]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, MlPrecisionMetric]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, MlPrecisionMetric]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[MlPrecisionMetric]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[MlPrecisionMetric]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> MlPrecisionMetric:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> MlPrecisionMetric:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> MlPrecisionMetric:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> MlPrecisionMetric:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> MlPrecisionMetric:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> MlPrecisionMetric:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> MlPrecisionMetric:
    """
    ...
    """
        ...
    def afterMake(self) -> MlPrecisionMetric:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> MlPrecisionMetric:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[MlPrecisionMetric]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> MlPrecisionMetric:
    """
