...
from c3.platform.MapBuilder import MapBuilder
from c3.platform.App.Metric.Variable import App.Metric.Variable
...
from c3.platform.App.Metric.Container.Summary import App.Metric.Container.Summary
...
from c3.platform.App.Monitoring.Category import App.Monitoring.Category
...
from c3.platform.App.Metric.Bound import App.Metric.Bound
from c3.platform.MapBuilder import MapBuilder
from c3.platform.SetBuilder import SetBuilder
...
# Python definitions for the C3 type App.Metric.Dashboard


class Dashboard(App.Metric.Container, WithDescription):
    """
    Represents a dashboard to visualize metrics
    
    @remarks this represents a made instance of App.Metric.Dashboard
    """
    
    filled: Optional[bool]=None
    """
    Whether or not this specific instance has been processed. Especially helpful when calls from the
    front end require full resolution and serves as a marker for server to know entire instance has
    been fully resolved.
    """

    exposedVariables: Optional[Array[App.Metric.Variable]]=None
    """
    Filter fields to be available at the top level of the dashboard.
    When the metrics are evaluated, the values of {@link App.Metric.EvaluatableSpec#variables} will be
    driven by the selected values in the UI. These fields should correspond to variables defined in
    {@link App.Metric#variables}.
    """

    doNotInferExposedVariables: Optional[bool]=None
    """
    When true, {@link #validateAndFill} will not infer {@link #exposedVariables} if it is empty.
    When false, {@link #validateAndFill} will set {@link #unresolvedVariables} into {@link #exposedVariables}
    if {@link #unresolvedVariables} is not set.
    This flag will be ignored if {@link #exposedVariables} is set.
    This boolean is present because there is no type system distinguishment for entities between null
    and empty arrays.
    """
    ...
    """
    Name of the dashboard, can be a {@link Translation} key
    """
    ...
    tiles: Optional[Array[App.Metric.Dashboard.Tile]]
    """
    The tiles/charts to display in the dashboard
    """

    categories: Optional[Array[App.Monitoring.Category]]=None
    """
    Categories of this dashboard
    """
    def __init__(self, filled: Optional[bool]=None, exposedVariables: Optional[Array[App.Metric.Variable]]=None, doNotInferExposedVariables: Optional[bool]=None, description: Optional[str]=None, id: Optional[str]=None, versionEdits: Optional[Array[VersionEdit]]=None, name: Optional[str]=None, meta: Optional[Meta]=None, version: Optional[int]=None, typeWithBindings: Optional[Type]=None, tiles: Optional[Array[App.Metric.Dashboard.Tile]]=None, categories: Optional[Array[App.Monitoring.Category]]=None) -> None: ...
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[App.Metric.Dashboard]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[App.Metric.Dashboard]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[App.Metric.Dashboard]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[App.Metric.Dashboard]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> App.Metric.Dashboard:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> App.Metric.Dashboard:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> App.Metric.Dashboard:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[App.Metric.Dashboard]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[App.Metric.Dashboard]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> App.Metric.Dashboard:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> App.Metric.Dashboard:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> App.Metric.Dashboard:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> App.Metric.Dashboard:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> App.Metric.Dashboard:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> App.Metric.Dashboard:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> App.Metric.Dashboard:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> App.Metric.Dashboard:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> App.Metric.Dashboard:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> App.Metric.Dashboard:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> App.Metric.Dashboard:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> App.Metric.Dashboard:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> App.Metric.Dashboard:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> App.Metric.Dashboard:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> App.Metric.Dashboard:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> App.Metric.Dashboard:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> App.Metric.Dashboard:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> App.Metric.Dashboard:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> App.Metric.Dashboard:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> App.Metric.Dashboard:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> App.Metric.Dashboard:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> App.Metric.Dashboard:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> App.Metric.Dashboard:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> App.Metric.Dashboard:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> App.Metric.Dashboard:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> App.Metric.Dashboard:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> App.Metric.Dashboard:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> App.Metric.Dashboard:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[App.Metric.Dashboard]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[App.Metric.Dashboard]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[App.Metric.Dashboard]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[App.Metric.Dashboard]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[App.Metric.Dashboard]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, App.Metric.Dashboard]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, App.Metric.Dashboard]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[App.Metric.Dashboard]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[App.Metric.Dashboard]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> App.Metric.Dashboard:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> App.Metric.Dashboard:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> App.Metric.Dashboard:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> App.Metric.Dashboard:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> App.Metric.Dashboard:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> App.Metric.Dashboard:
    """
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[App.Metric.Dashboard]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> App.Metric.Dashboard:
    """
    ...
    """
        ...
    def afterMake(self) -> App.Metric.Dashboard:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> App.Metric.Dashboard:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[App.Metric.Dashboard]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> App.Metric.Dashboard:
    """
    ...
    """
        ...
    def validateAndFill(self) -> Union[App.Metric.Dashboard]:
    """
    Fully populates the references of the object. If {@link #filled} is true, just returns the instance.
    If not, fully fetches the entire type with deep references.
    """
        ...
    def validateAndFillImpl(self) -> Union[App.Metric.Dashboard]:
    """
    Validates the {@link App.Metric.Dashboard} and fills it with cross referenced fields.
    """
        ...
    def unresolvedVariables(self, requiredOnly: bool=None) -> Union[Array[App.Metric.Variable]]:
    """
    Identifies which variables are available to be populated at runtime. This list may or may
    not be the same as {@link #exposedVariables}. The instance must be valid.
    @param requiredOnly
               Return only the {@link App.Metric.Variable} that are required to be populated at runtime.
    """
        ...
    def unresolvedVariablesImpl(self) -> Union[Array[App.Metric.Variable]]:
    """
    Returns all ids of {@link App.Metric.Variable} that can be populated at runtime.
    """
        ...
    def metricNames(self) -> Union[Array[str]]:
    """
    Returns all the metric names being utilized in this dashboard
    """
        ...
    def summarize(self) -> Union[App.Metric.Container.Summary]:
    """
    Summarizes a {@link App.Metric.Container} with human readible descriptions and prepares it for
    """
        ...
    @overload
    @classmethod
    def fetch(cls, spec: FetchSpec=None) -> FetchResult[App.Metric.Dashboard]:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, filter: Filter) -> FetchResult[App.Metric.Dashboard]:
    """
    ...
    """
        ...
    @classmethod
    def fetchObjStream(cls, spec: FetchStreamSpec=None) -> Union[Stream[App.Metric.Dashboard]]:
    """
    Fetches multiple obj instances based on a specification.  Only objs that the caller is authorized to fetch will be
    returned.
    ...
    """
        ...
    @classmethod
    def fetchMultiLocale(cls, spec: MultiLocaleFetchSpec=None) -> Union[Map[str, FetchResult[App.Metric.Dashboard]]]:
    """
    ...
    """
        ...
    def get(self, include: str=None) -> Union[App.Metric.Dashboard]:
    """
    ...
    """
        ...
    def getSpecific(self, include: str=None) -> Union[App.Metric.Dashboard]:
    """
    ...
    """
        ...
    def getMissing(self, spec: GetMissingSpec) -> App.Metric.Dashboard:
    """
    ...
    """
        ...
    def getDirect(self, include: str=None) -> Union[App.Metric.Dashboard]:
    """
    ...
    """
        ...
    def applyReverseEdit(self, versionEdit: VersionEdit) -> App.Metric.Dashboard:
    """
    ...
    """
        ...
    @classmethod
    def fromString(cls, s: str) -> Union[App.Metric.Dashboard]:
    """
    ...
    """
        ...
    def create(self, spec: UpsertSpec=None) -> Union[App.Metric.Dashboard]:
    """
    ...
    """
        ...
    @classmethod
    def createBatch(cls, objs: Array[App.Metric.Dashboard], spec: UpsertSpec=None) -> Union[ObjList[App.Metric.Dashboard]]:
    """
    ...
    """
        ...
    @classmethod
    def createBatchObjStream(cls, objs: Stream[App.Metric.Dashboard], spec: CreateBatchObjStreamSpec=None) -> Union[ObjList[App.Metric.Dashboard]]:
    """
    Creates multiple instances of a C3 type. If the operation fails and {@link UpsertSpec#dontThrowOnBatchError} is not
    specified (the default), then a C3BatchException will be thrown.  Otherwise {@link errors will be reported in the
    returned {@link ObjList}.  This will fail if any of the instances already exist.
    ...
    """
        ...
    def update(self, srcObj: App.Metric.Dashboard=None, spec: UpsertSpec=None) -> Union[App.Metric.Dashboard]:
    """
    ...
    """
        ...
    def upsert(self, srcObj: App.Metric.Dashboard=None, spec: UpsertSpec=None) -> Union[App.Metric.Dashboard]:
    """
    ...
    """
        ...
    @overload
    def merge(self, spec: MergeSpec=None) -> Union[App.Metric.Dashboard]:
    """
    ...
    """
        ...
    @overload
    def merge(self, mergeInclude: str, spec: MergeSpec=None) -> Union[App.Metric.Dashboard]:
    """
    ...
    """
        ...
    def touch(self, spec: TouchSpec=None) -> Union[App.Metric.Dashboard]:
    """
    ...
    """
        ...
    @classmethod
    def updateBatch(cls, objs: Array[App.Metric.Dashboard], srcObjs: Array[App.Metric.Dashboard]=None, spec: UpsertSpec=None) -> Union[ObjList[App.Metric.Dashboard]]:
    """
    ...
    """
        ...
    @classmethod
    def updateObjs(cls, objs: Callable[[], Union[Array[App.Metric.Dashboard]]], spec: UpsertSpec=None) -> Union[ObjList[App.Metric.Dashboard]]:
    """
    ...
    """
        ...
    @classmethod
    def upsertBatch(cls, objs: Array[App.Metric.Dashboard], srcObjs: Array[App.Metric.Dashboard]=None, spec: UpsertSpec=None) -> Union[ObjList[App.Metric.Dashboard]]:
    """
    ...
    """
        ...
    @classmethod
    def upsertObjs(cls, objs: Callable[[], Union[Array[App.Metric.Dashboard]]], spec: UpsertSpec=None) -> Union[ObjList[App.Metric.Dashboard]]:
    """
    Creates instances of a C3 type if they don't already exist and updates them if they do exist. If the operation
    ...
    """
        ...
    @classmethod
    def touchBatch(cls, objs: Array[App.Metric.Dashboard], spec: TouchSpec=None) -> Union[ObjList[App.Metric.Dashboard]]:
    """
    ...
    @overload
    @classmethod
    def mergeBatch(cls, objs: Array[App.Metric.Dashboard], spec: MergeSpec=None) -> Union[ObjList[App.Metric.Dashboard]]:
    """
    ...
    @overload
    @classmethod
    def mergeBatch(cls, objs: Array[App.Metric.Dashboard], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[App.Metric.Dashboard]]:
    """
    Merges multiple instances of a C3 type or creates them if they don't exist. If the operation fails and {@link
    UpsertSpec#dontThrowOnBatchError} is not specified (the default), then a C3BatchException will be thrown.
    Otherwise errors will be reported in the returned {@link ObjList}.  The merge operation is described in the {@link
    ...
    """
        ...
    @classmethod
    def mergeObjs(cls, objs: Callable[[], Union[Array[App.Metric.Dashboard]]], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[App.Metric.Dashboard]]:
    """
    ...
    @overload
    @classmethod
    def mergeAll(cls, mergeObj: App.Metric.Dashboard, spec: MergeAllSpec=None) -> Union[int]:
    """
    ...
    @overload
    @classmethod
    def mergeAll(cls, mergeObj: App.Metric.Dashboard, mergeInclude: str, spec: MergeAllSpec=None) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def removeBatch(cls, objs: Array[App.Metric.Dashboard], spec: UpsertSpec=None) -> Union[ObjList[App.Metric.Dashboard]]:
    """
    ...
    """
        ...
    @classmethod
    def replace(cls, objs: Array[App.Metric.Dashboard], spec: UpsertSpec=None) -> Union[ObjList[App.Metric.Dashboard]]:
    """
    ...
    """
        ...
    def unremove(self) -> Union[App.Metric.Dashboard]:
    """
    ...
    """
        ...
    @classmethod
    def beforeCreate(cls, objs: Array[App.Metric.Dashboard]) -> ObjList[App.Metric.Dashboard]:
    """
    ...
    """
        ...
    @classmethod
    def beforeUpdate(cls, objs: Array[App.Metric.Dashboard]) -> ObjList[App.Metric.Dashboard]:
    """
    ...
    """
        ...
    @classmethod
    def beforeRemove(cls, objs: Array[App.Metric.Dashboard]) -> ObjList[App.Metric.Dashboard]:
    """
    ...
    """
        ...
    @classmethod
    def afterCreate(cls, objs: Array[App.Metric.Dashboard]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def afterUpdate(cls, objs: Array[App.Metric.Dashboard]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def afterRemove(cls, objs: Array[App.Metric.Dashboard]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def startImportData(cls, spec: StartImportDataSpec=None) -> PushStream[App.Metric.Dashboard]:
    """
    @return a push stream to import instances of this type.
    """
        ...
    @classmethod
    def startImportDataWithStats(cls, spec: StartImportDataSpec=None) -> PushStreamWithStats[App.Metric.Dashboard]:
    """
    @return a push stream to import instances of this type.
    """
        ...
    ...
    """
        ...
    @classmethod
    def forId(cls, id: str, failIfMissing: bool=None) -> Union[App.Metric.Dashboard]:
    """
    ...
    """
        ...
    def withoutIdentity(self) -> Union[App.Metric.Dashboard]:
    """
    ...
    """
        ...
    @classmethod
    def typeOfBatch(cls, objs: Array[App.Metric.Dashboard]) -> Union[Array[EntityType]]:
    """
    ...
    """
        ...
    @classmethod
    def dbEcho(cls, template: App.Metric.Dashboard=None, count: int=None, sendBack: bool=None) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def callbackLogic(cls, objs: Array[App.Metric.Dashboard], callback: Callable[[Union[App.Metric.Dashboard]], Union[App.Metric.Dashboard]]=None) -> ObjList[App.Metric.Dashboard]:
    """
    ...
    """
        ...
    @classmethod
    def afterCallbackLogic(cls, objs: Array[App.Metric.Dashboard], callback: Callable[[Union[App.Metric.Dashboard]], Union[App.Metric.Dashboard]]=None) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def dashboardsForApp(cls, appId: str=None, spec: FetchSpec=None) -> Union[Array[App.Metric.Dashboard]]:
    """
    Returns dashboards available for the app
    """
        ...
    
    class View(WithName):
        """
        A view of a specific {@link App.Metric.Dashboard.Tile}. The {@link #name} must be unique
        within its parent {@link App.Metric.Dashboard.Tile}.
        
        @remarks this represents a made instance of App.Metric.Dashboard.View
        """
        ...
        """
        Font Awesome icon associated with this view
        """

        metrics: Optional[Array[App.Metric.Bound[App.Metric.EvaluateSpec]]]=None
        """
        The metrics to show when on this view
        """
        def __init__(self, name: Optional[str]=None, icon: Optional[str]=None, metrics: Optional[Array[App.Metric.Bound[App.Metric.EvaluateSpec]]]=None) -> None: ...
        ...
        """
            ...
        @classmethod
        def fromJson(cls, json: any) -> Union[App.Metric.Dashboard.View]:
        """
        Load the JSON-based representation and reconstruct the corresponding object.
        ...
        """
            ...
        @classmethod
        def fromJsonString(cls, json: str) -> Union[App.Metric.Dashboard.View]:
        """
        Load the JSON-based representation and reconstruct the corresponding object.
        ...
        """
            ...
        @classmethod
        def fromXmlString(cls, xml: str) -> Union[App.Metric.Dashboard.View]:
        """
        Load the XML-based representation and reconstruct the corresponding object.
        ...
        """
            ...
        @classmethod
        def deserialize(cls, contentStr: str, contentType: str) -> Union[App.Metric.Dashboard.View]:
        """
        Load from contentType representation and reconstruct the corresponding object.
        ...
        """
            ...
        def replaceType(self, old: Type, new: Type) -> App.Metric.Dashboard.View:
        """
        Returns new instance with all references to old type, including result of #type, replaced with new type. If new
        type does not contain fields from old or field value types are not convertable then drops the field.
        ...
        """
            ...
        @overload
        def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> App.Metric.Dashboard.View:
        """
        Result of this function call is a copy of current instance with all non empty fields replaced based on results of
        the `mapper` invocation.
        ...
        """
            ...
        @overload
        def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> App.Metric.Dashboard.View:
        """
        Result of this function call is a copy of current instance with all fields replaced based on results of the
        `mapper` invocation.
        ...
        """
            ...
        @overload
        def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[App.Metric.Dashboard.View]:
        """
        Result of this function call is a copy of current instance with all non empty fields replaced based on results of
        the asynchronous `mapper` invocation.
        ...
        """
            ...
        @overload
        def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[App.Metric.Dashboard.View]:
        """
        Result of this function call is a copy of current instance with all fields replaced based on results of the
        asynchronous `mapper` invocation.
        ...
        """
            ...
        def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> App.Metric.Dashboard.View:
        """
        Result of this function call is a copy of current instance with specified field value replaced based on result of
        the `mapper` invocation.
        @param field
        ...
        """
            ...
        @overload
        def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> App.Metric.Dashboard.View:
        """
        Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
        lambda application.
        ...
        """
            ...
        @overload
        def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> App.Metric.Dashboard.View:
        """
        Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
        lambda application.
        ...
        """
            ...
        @overload
        def validateObj(self) -> App.Metric.Dashboard.View:
        """
        Populates all missing default values and throws error if any constraint is violated.
        """
            ...
        ...
        """
            ...
        @overload
        def withField(self, field: str, value: Any, doNotConvert: bool=None) -> App.Metric.Dashboard.View:
        """
        Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
        defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
        ...
        """
            ...
        @overload
        def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> App.Metric.Dashboard.View:
        """
        Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
        defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
        ...
        """
            ...
        def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> App.Metric.Dashboard.View:
        """
        Builds a new Obj instance by adding the provided fields in it. The name must correspond to an existing fields
        defined on this type or its mixins. The values must be of the correct type if doNotConvert flag is true.
        ...
        """
            ...
        def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> App.Metric.Dashboard.View:
        """
        Builds a new Obj with the value at the specified path field. If the field is null, the field #isFieldSet to null.
        If you would like to #unsetField, you should call #withoutFieldAtPath instead.
        ...
        """
            ...
        def withoutFieldAtPath(self, path: str) -> App.Metric.Dashboard.View:
        """
        Builds a new Obj without the specified path field.
        ...
        """
            ...
        @overload
        def withoutField(self, field: str) -> App.Metric.Dashboard.View:
        """
        Builds a new Obj, removing the field with the provided name.
        ...
        """
            ...
        @overload
        def withoutField(self, field: FieldType) -> App.Metric.Dashboard.View:
        """
        Builds a new Obj, removing the field with the provided field type.
        ...
        """
            ...
        def withoutFields(self, fields: Array[str]) -> App.Metric.Dashboard.View:
        """
        Builds a new Obj, removing the fields with the provided names.
        ...
        """
            ...
        def withoutFieldsByType(self, fields: Array[FieldType]) -> App.Metric.Dashboard.View:
        """
        Builds a new Obj, removing the fields with the provided field types. Be sure to use the FieldType instance for the
        exact same type as the type of the obj to respect the "ordinal" of the field type
        ...
        """
            ...
        def withoutSecretFields(self) -> App.Metric.Dashboard.View:
        """
        @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
        """
            ...
        ...
        """
            ...
        def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> App.Metric.Dashboard.View:
        """
        Builds a new Obj instance by adding the default values (if defined) for all unset fields. This is implemented by
        calling {@link FieldType#defaultValue defaultValue} for a field if it is not already set and
        {@link FieldType#hasDefault has a default}. It will also set {@see ValueType#initialValue initial values} for
        ...
        """
            ...
        @overload
        def defaultField(self, field: str) -> App.Metric.Dashboard.View:
        """
        Builds a new Obj, by setting a field on this `Obj` to the field's default value. If the field has no default, this
        method will behave the same as {@link #unsetField}.
        ...
        """
            ...
        @overload
        def defaultField(self, field: FieldType) -> App.Metric.Dashboard.View:
        """
        Builds a new Obj, by setting a field on this `Obj` to the fields default value. If the field has no default, this
        method will behave the same as {@link #unsetField}.
        ...
        """
            ...
        @overload
        def unsetField(self, field: str) -> App.Metric.Dashboard.View:
        """
        Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
        is different from {@link removeField}
        ...
        """
            ...
        @overload
        def unsetField(self, field: FieldType) -> App.Metric.Dashboard.View:
        """
        Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
        is different from {@link removeField}
        ...
        """
            ...
        @overload
        def removeField(self, field: str) -> App.Metric.Dashboard.View:
        """
        Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
        is different from {@link #unsetField}
        ...
        """
            ...
        @overload
        def removeField(self, field: FieldType) -> App.Metric.Dashboard.View:
        """
        Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
        is different from {@link #unsetField}
        ...
        """
            ...
        @overload
        def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> App.Metric.Dashboard.View:
        """
        Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
        In case of conflicts, fields of other instance take precedence unless otherwise specified by the fieldPathMergeSpec
        ...
        """
            ...
        @overload
        def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> App.Metric.Dashboard.View:
        """
        Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
        In case of conflicts, fields of other instance take precedence.
        ...
        """
            ...
        @overload
        def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> App.Metric.Dashboard.View:
        """
        Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
        fields that exist on other Obj and do not exist on this Obj will not be added to final Obj.
        @param deep
        ...
        """
            ...
        @overload
        def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> App.Metric.Dashboard.View:
        """
        Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
        fields that exist other Obj and do not exist on this Obj will not be added to final Obj or evaluated. Does not
        traverse child reference and collection fields.
        ...
        """
            ...
        def mergeJson(self, json: any) -> App.Metric.Dashboard.View:
            ...
        def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> App.Metric.Dashboard.View:
        """
        Merge the obj references within the current obj
        @param deep
               If set, traverses the reference fields within the obj as well for a deep merge
        ...
        """
            ...
        def sumObj(self, other: Obj, deep: bool=None) -> App.Metric.Dashboard.View:
        """
        Adds the numeric Obj fields with the other Objs respective fields.
        If deep is set it will traverse reference and collection fields and sum corresponding numeric fields in
        references with same name and collection elements at same index or key.
        """
            ...
        def singletonArray(self) -> Array[App.Metric.Dashboard.View]:
        """
        Build an array of the correct type with a single element which is this instance.
        ...
        """
            ...
        @classmethod
        def array(cls, *elements: Array[Any]) -> Union[Array[App.Metric.Dashboard.View]]:
        """
        Creates an array of instances of this type.
        """
            ...
        @classmethod
        def arrayBuilder(cls) -> Union[ArrayBuilder[App.Metric.Dashboard.View]]:
        """
        Creates an array of instances of this type.
        """
            ...
        def singletonSet(self) -> Set[App.Metric.Dashboard.View]:
        """
        Build an set of the correct type with a single element which is this instance.
        ...
        """
            ...
        @classmethod
        def setBuilder(cls) -> Union[SetBuilder[App.Metric.Dashboard.View]]:
        """
        Creates a set of instances of this type.
        """
            ...
        @classmethod
        def mapBuilder(cls) -> Union[MapBuilder[str, App.Metric.Dashboard.View]]:
        """
        Create a map of string to elements of this type.
        """
            ...
        @classmethod
        def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, App.Metric.Dashboard.View]]:
        """
        Create a map with the given key type and elements of this type.
        """
            ...
        ...
        def myStreamType(cls) -> StreamType:
            ...
        def toBuilder(self) -> ObjBuilder[App.Metric.Dashboard.View]:
        """
        @return new ObjBuilder with initial state set to fields of this instance.
        """
            ...
        @classmethod
        def builder(cls) -> ObjBuilder[App.Metric.Dashboard.View]:
        """
        @return new ObjBuilder of this instance.
        """
            ...
        @overload
        @classmethod
        def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> App.Metric.Dashboard.View:
        """
        Construct instance of this type from provided field values and options
        """
            ...
        @overload
        @classmethod
        def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> App.Metric.Dashboard.View:
        """
        Construct an instance of this type from provided fields
        @param fields
                   Fields to construct the instance of the obj with
        ...
        @overload
        @classmethod
        def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> App.Metric.Dashboard.View:
        """
        Construct instance of this type from provided field values and options
        """
            ...
        @overload
        @classmethod
        def make(cls, withDefaults: bool=None) -> App.Metric.Dashboard.View:
        """
        Construct an instance of this type with no non-default field values unless explicitly specified by passing param true
        @param withDefaults
                   If set, then the Obj is made with default & initial values (required primitive fields e.g. !int32 -> 0)
        ...
        @overload
        @classmethod
        def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> App.Metric.Dashboard.View:
        """
        Construct an instance from provided fields
        @param fields
                   Fields (in the format <field_name, value>) to construct an instance of the obj. Note that "type" as a
        ...
        @overload
        @classmethod
        def make(cls, fields: Any, withDefaults: bool=None) -> App.Metric.Dashboard.View:
        """
        Construct an instance of this type from provided fields. Note it is more efficient to use #fromFields and other overloads
        ...
        """
            ...
        @classmethod
        def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> App.Metric.Dashboard.View:
        """
        Construct an instance of this type from provided instance of a subtype or a "duck type".
        """
            ...
        ...
        """
            ...
        def afterMake(self) -> App.Metric.Dashboard.View:
        """
        Optional override that will be called after every instance creation.
        ...
        """
            ...
        @classmethod
        def cachedEmptyInst(cls) -> App.Metric.Dashboard.View:
        """
        Creates an empty inst using `MyType.make()` and caches it. Avoid recreating multiple copies of the spec for
        every action dispatch. The cached inst can also be used for comparing whether the object is an empty or not
        Will only create empty instance for immutable Obj e.g. if an Obj is Mutable, this method will throw an error
        ...
        """
            ...
        @classmethod
        def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[App.Metric.Dashboard.View]]:
        """
        Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
        value is read.
        """
            ...
        @classmethod
        def generateObj(cls, spec: Obj.GenerateSpec=None) -> App.Metric.Dashboard.View:
        """
        Generate a single instance of this type. The base implementation uses {@link DataGenObj} to generate uniform
        random (gibberish) values for all fields, but it may be overridden by specific types with custom logic that
        populates fields in a more realistic way.
    ...
    class Tile(WithDescription):
        """
        A representation of a panel or chart space in a dashboard
        
        @remarks this represents a made instance of App.Metric.Dashboard.Tile
        """
        ...
        """
        Title to display with the tile. The {@link #view#name} will be displayed with this title when selected.
        Can be a {@link Translation} key.
        """

        views: Optional[Array[App.Metric.Dashboard.View]]
        """
        All possible views for the tile. Generally should be different ways to view the same, or very similar, data to
        answer related questions.
        """
        def __init__(self, description: Optional[str]=None, title: Optional[str]=None, views: Optional[Array[App.Metric.Dashboard.View]]=None) -> None: ...
        ...
        """
            ...
        @classmethod
        def fromJson(cls, json: any) -> Union[App.Metric.Dashboard.Tile]:
        """
        Load the JSON-based representation and reconstruct the corresponding object.
        ...
        """
            ...
        @classmethod
        def fromJsonString(cls, json: str) -> Union[App.Metric.Dashboard.Tile]:
        """
        Load the JSON-based representation and reconstruct the corresponding object.
        ...
        """
            ...
        @classmethod
        def fromXmlString(cls, xml: str) -> Union[App.Metric.Dashboard.Tile]:
        """
        Load the XML-based representation and reconstruct the corresponding object.
        ...
        """
            ...
        @classmethod
        def deserialize(cls, contentStr: str, contentType: str) -> Union[App.Metric.Dashboard.Tile]:
        """
        Load from contentType representation and reconstruct the corresponding object.
        ...
        """
            ...
        def replaceType(self, old: Type, new: Type) -> App.Metric.Dashboard.Tile:
        """
        Returns new instance with all references to old type, including result of #type, replaced with new type. If new
        type does not contain fields from old or field value types are not convertable then drops the field.
        ...
        """
            ...
        @overload
        def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> App.Metric.Dashboard.Tile:
        """
        Result of this function call is a copy of current instance with all non empty fields replaced based on results of
        the `mapper` invocation.
        ...
        """
            ...
        @overload
        def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> App.Metric.Dashboard.Tile:
        """
        Result of this function call is a copy of current instance with all fields replaced based on results of the
        `mapper` invocation.
        ...
        """
            ...
        @overload
        def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[App.Metric.Dashboard.Tile]:
        """
        Result of this function call is a copy of current instance with all non empty fields replaced based on results of
        the asynchronous `mapper` invocation.
        ...
        """
            ...
        @overload
        def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[App.Metric.Dashboard.Tile]:
        """
        Result of this function call is a copy of current instance with all fields replaced based on results of the
        asynchronous `mapper` invocation.
        ...
        """
            ...
        def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> App.Metric.Dashboard.Tile:
        """
        Result of this function call is a copy of current instance with specified field value replaced based on result of
        the `mapper` invocation.
        @param field
        ...
        """
            ...
        @overload
        def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> App.Metric.Dashboard.Tile:
        """
        Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
        lambda application.
        ...
        """
            ...
        @overload
        def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> App.Metric.Dashboard.Tile:
        """
        Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
        lambda application.
        ...
        """
            ...
        @overload
        def validateObj(self) -> App.Metric.Dashboard.Tile:
        """
        Populates all missing default values and throws error if any constraint is violated.
        """
            ...
        ...
        """
            ...
        @overload
        def withField(self, field: str, value: Any, doNotConvert: bool=None) -> App.Metric.Dashboard.Tile:
        """
        Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
        defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
        ...
        """
            ...
        @overload
        def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> App.Metric.Dashboard.Tile:
        """
        Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
        defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
        ...
        """
            ...
        def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> App.Metric.Dashboard.Tile:
        """
        Builds a new Obj instance by adding the provided fields in it. The name must correspond to an existing fields
        defined on this type or its mixins. The values must be of the correct type if doNotConvert flag is true.
        ...
        """
            ...
        def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> App.Metric.Dashboard.Tile:
        """
        Builds a new Obj with the value at the specified path field. If the field is null, the field #isFieldSet to null.
        If you would like to #unsetField, you should call #withoutFieldAtPath instead.
        ...
        """
            ...
        def withoutFieldAtPath(self, path: str) -> App.Metric.Dashboard.Tile:
        """
        Builds a new Obj without the specified path field.
        ...
        """
            ...
        @overload
        def withoutField(self, field: str) -> App.Metric.Dashboard.Tile:
        """
        Builds a new Obj, removing the field with the provided name.
        ...
        """
            ...
        @overload
        def withoutField(self, field: FieldType) -> App.Metric.Dashboard.Tile:
        """
        Builds a new Obj, removing the field with the provided field type.
        ...
        """
            ...
        def withoutFields(self, fields: Array[str]) -> App.Metric.Dashboard.Tile:
        """
        Builds a new Obj, removing the fields with the provided names.
        ...
        """
            ...
        def withoutFieldsByType(self, fields: Array[FieldType]) -> App.Metric.Dashboard.Tile:
        """
        Builds a new Obj, removing the fields with the provided field types. Be sure to use the FieldType instance for the
        exact same type as the type of the obj to respect the "ordinal" of the field type
        ...
        """
            ...
        def withoutSecretFields(self) -> App.Metric.Dashboard.Tile:
        """
        @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
        """
            ...
        ...
        """
            ...
        def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> App.Metric.Dashboard.Tile:
        """
        Builds a new Obj instance by adding the default values (if defined) for all unset fields. This is implemented by
        calling {@link FieldType#defaultValue defaultValue} for a field if it is not already set and
        {@link FieldType#hasDefault has a default}. It will also set {@see ValueType#initialValue initial values} for
        ...
        """
            ...
        @overload
        def defaultField(self, field: str) -> App.Metric.Dashboard.Tile:
        """
        Builds a new Obj, by setting a field on this `Obj` to the field's default value. If the field has no default, this
        method will behave the same as {@link #unsetField}.
        ...
        """
            ...
        @overload
        def defaultField(self, field: FieldType) -> App.Metric.Dashboard.Tile:
        """
        Builds a new Obj, by setting a field on this `Obj` to the fields default value. If the field has no default, this
        method will behave the same as {@link #unsetField}.
        ...
        """
            ...
        @overload
        def unsetField(self, field: str) -> App.Metric.Dashboard.Tile:
        """
        Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
        is different from {@link removeField}
        ...
        """
            ...
        @overload
        def unsetField(self, field: FieldType) -> App.Metric.Dashboard.Tile:
        """
        Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
        is different from {@link removeField}
        ...
        """
            ...
        @overload
        def removeField(self, field: str) -> App.Metric.Dashboard.Tile:
        """
        Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
        is different from {@link #unsetField}
        ...
        """
            ...
        @overload
        def removeField(self, field: FieldType) -> App.Metric.Dashboard.Tile:
        """
        Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
        is different from {@link #unsetField}
        ...
        """
            ...
        @overload
        def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> App.Metric.Dashboard.Tile:
        """
        Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
        In case of conflicts, fields of other instance take precedence unless otherwise specified by the fieldPathMergeSpec
        ...
        """
            ...
        @overload
        def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> App.Metric.Dashboard.Tile:
        """
        Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
        In case of conflicts, fields of other instance take precedence.
        ...
        """
            ...
        @overload
        def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> App.Metric.Dashboard.Tile:
        """
        Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
        fields that exist on other Obj and do not exist on this Obj will not be added to final Obj.
        @param deep
        ...
        """
            ...
        @overload
        def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> App.Metric.Dashboard.Tile:
        """
        Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
        fields that exist other Obj and do not exist on this Obj will not be added to final Obj or evaluated. Does not
        traverse child reference and collection fields.
        ...
        """
            ...
        def mergeJson(self, json: any) -> App.Metric.Dashboard.Tile:
            ...
        def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> App.Metric.Dashboard.Tile:
        """
        Merge the obj references within the current obj
        @param deep
               If set, traverses the reference fields within the obj as well for a deep merge
        ...
        """
            ...
        def sumObj(self, other: Obj, deep: bool=None) -> App.Metric.Dashboard.Tile:
        """
        Adds the numeric Obj fields with the other Objs respective fields.
        If deep is set it will traverse reference and collection fields and sum corresponding numeric fields in
        references with same name and collection elements at same index or key.
        """
            ...
        def singletonArray(self) -> Array[App.Metric.Dashboard.Tile]:
        """
        Build an array of the correct type with a single element which is this instance.
        ...
        """
            ...
        @classmethod
        def array(cls, *elements: Array[Any]) -> Union[Array[App.Metric.Dashboard.Tile]]:
        """
        Creates an array of instances of this type.
        """
            ...
        @classmethod
        def arrayBuilder(cls) -> Union[ArrayBuilder[App.Metric.Dashboard.Tile]]:
        """
        Creates an array of instances of this type.
        """
            ...
        def singletonSet(self) -> Set[App.Metric.Dashboard.Tile]:
        """
        Build an set of the correct type with a single element which is this instance.
        ...
        """
            ...
        @classmethod
        def setBuilder(cls) -> Union[SetBuilder[App.Metric.Dashboard.Tile]]:
        """
        Creates a set of instances of this type.
        """
            ...
        @classmethod
        def mapBuilder(cls) -> Union[MapBuilder[str, App.Metric.Dashboard.Tile]]:
        """
        Create a map of string to elements of this type.
        """
            ...
        @classmethod
        def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, App.Metric.Dashboard.Tile]]:
        """
        Create a map with the given key type and elements of this type.
        """
            ...
        ...
        def myStreamType(cls) -> StreamType:
            ...
        def toBuilder(self) -> ObjBuilder[App.Metric.Dashboard.Tile]:
        """
        @return new ObjBuilder with initial state set to fields of this instance.
        """
            ...
        @classmethod
        def builder(cls) -> ObjBuilder[App.Metric.Dashboard.Tile]:
        """
        @return new ObjBuilder of this instance.
        """
            ...
        @overload
        @classmethod
        def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> App.Metric.Dashboard.Tile:
        """
        Construct instance of this type from provided field values and options
        """
            ...
        @overload
        @classmethod
        def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> App.Metric.Dashboard.Tile:
        """
        Construct an instance of this type from provided fields
        @param fields
                   Fields to construct the instance of the obj with
        ...
        @overload
        @classmethod
        def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> App.Metric.Dashboard.Tile:
        """
        Construct instance of this type from provided field values and options
        """
            ...
        @overload
        @classmethod
        def make(cls, withDefaults: bool=None) -> App.Metric.Dashboard.Tile:
        """
        Construct an instance of this type with no non-default field values unless explicitly specified by passing param true
        @param withDefaults
                   If set, then the Obj is made with default & initial values (required primitive fields e.g. !int32 -> 0)
        ...
        @overload
        @classmethod
        def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> App.Metric.Dashboard.Tile:
        """
        Construct an instance from provided fields
        @param fields
                   Fields (in the format <field_name, value>) to construct an instance of the obj. Note that "type" as a
        ...
        @overload
        @classmethod
        def make(cls, fields: Any, withDefaults: bool=None) -> App.Metric.Dashboard.Tile:
        """
        Construct an instance of this type from provided fields. Note it is more efficient to use #fromFields and other overloads
        ...
        """
            ...
        @classmethod
        def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> App.Metric.Dashboard.Tile:
        """
        Construct an instance of this type from provided instance of a subtype or a "duck type".
        """
            ...
        ...
        """
            ...
        def afterMake(self) -> App.Metric.Dashboard.Tile:
        """
        Optional override that will be called after every instance creation.
        ...
        """
            ...
        @classmethod
        def cachedEmptyInst(cls) -> App.Metric.Dashboard.Tile:
        """
        Creates an empty inst using `MyType.make()` and caches it. Avoid recreating multiple copies of the spec for
        every action dispatch. The cached inst can also be used for comparing whether the object is an empty or not
        Will only create empty instance for immutable Obj e.g. if an Obj is Mutable, this method will throw an error
        ...
        """
            ...
        @classmethod
        def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[App.Metric.Dashboard.Tile]]:
        """
        Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
        value is read.
        """
            ...
        @classmethod
        def generateObj(cls, spec: Obj.GenerateSpec=None) -> App.Metric.Dashboard.Tile:
        """
        Generate a single instance of this type. The base implementation uses {@link DataGenObj} to generate uniform
        random (gibberish) values for all fields, but it may be overridden by specific types with custom logic that
        populates fields in a more realistic way.
