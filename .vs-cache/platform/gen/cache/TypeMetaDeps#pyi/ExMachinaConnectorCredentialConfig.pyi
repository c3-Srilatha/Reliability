...
# Python definitions for the C3 type ExMachinaConnectorCredentialConfig


class ExMachinaConnectorCredentialConfig(ConfigAclEnabled, Identifiable):
    """
    A shareable credential stored in a Config.
    
    @remarks this represents a made instance of ExMachinaConnectorCredentialConfig
    """
    ...
    credentials: Optional[DataConnectorCredential]=None
    def __init__(self, configOverride: Optional[str]=None, secretOverride: Optional[str]=None, issues: Optional[Array[str]]=None, acl: Optional[Array[AclEntry]]=None, id: Optional[str]=None, credentials: Optional[DataConnectorCredential]=None) -> None: ...
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[ExMachinaConnectorCredentialConfig]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[ExMachinaConnectorCredentialConfig]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[ExMachinaConnectorCredentialConfig]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[ExMachinaConnectorCredentialConfig]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> ExMachinaConnectorCredentialConfig:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> ExMachinaConnectorCredentialConfig:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> ExMachinaConnectorCredentialConfig:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[ExMachinaConnectorCredentialConfig]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[ExMachinaConnectorCredentialConfig]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> ExMachinaConnectorCredentialConfig:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> ExMachinaConnectorCredentialConfig:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> ExMachinaConnectorCredentialConfig:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> ExMachinaConnectorCredentialConfig:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> ExMachinaConnectorCredentialConfig:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> ExMachinaConnectorCredentialConfig:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> ExMachinaConnectorCredentialConfig:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> ExMachinaConnectorCredentialConfig:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> ExMachinaConnectorCredentialConfig:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> ExMachinaConnectorCredentialConfig:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> ExMachinaConnectorCredentialConfig:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> ExMachinaConnectorCredentialConfig:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> ExMachinaConnectorCredentialConfig:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> ExMachinaConnectorCredentialConfig:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> ExMachinaConnectorCredentialConfig:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> ExMachinaConnectorCredentialConfig:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> ExMachinaConnectorCredentialConfig:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> ExMachinaConnectorCredentialConfig:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> ExMachinaConnectorCredentialConfig:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> ExMachinaConnectorCredentialConfig:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> ExMachinaConnectorCredentialConfig:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> ExMachinaConnectorCredentialConfig:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> ExMachinaConnectorCredentialConfig:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> ExMachinaConnectorCredentialConfig:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> ExMachinaConnectorCredentialConfig:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> ExMachinaConnectorCredentialConfig:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> ExMachinaConnectorCredentialConfig:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> ExMachinaConnectorCredentialConfig:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[ExMachinaConnectorCredentialConfig]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[ExMachinaConnectorCredentialConfig]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[ExMachinaConnectorCredentialConfig]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[ExMachinaConnectorCredentialConfig]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[ExMachinaConnectorCredentialConfig]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, ExMachinaConnectorCredentialConfig]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, ExMachinaConnectorCredentialConfig]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[ExMachinaConnectorCredentialConfig]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[ExMachinaConnectorCredentialConfig]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> ExMachinaConnectorCredentialConfig:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> ExMachinaConnectorCredentialConfig:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> ExMachinaConnectorCredentialConfig:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> ExMachinaConnectorCredentialConfig:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> ExMachinaConnectorCredentialConfig:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> ExMachinaConnectorCredentialConfig:
    """
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[ExMachinaConnectorCredentialConfig]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> ExMachinaConnectorCredentialConfig:
    """
    ...
    """
        ...
    def afterMake(self) -> ExMachinaConnectorCredentialConfig:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> ExMachinaConnectorCredentialConfig:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[ExMachinaConnectorCredentialConfig]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> ExMachinaConnectorCredentialConfig:
    """
    ...
    """
        ...
    @classmethod
    def allCached(cls, doNotProduceAll: bool=None) -> Union[Stream[ExMachinaConnectorCredentialConfig]]:
    """
    ...
    """
        ...
    @classmethod
    def find(cls, filter: str=None, doNotProduceAll: bool=None) -> Union[Stream[ExMachinaConnectorCredentialConfig]]:
    """
    ...
    """
        ...
    @classmethod
    def findBy(cls, field: str, value: Any, doNotProduceAll: bool=None) -> Union[Stream[ExMachinaConnectorCredentialConfig]]:
    """
    @param doNotProduceAll if true, will not populate cache and only return available cached instances. Will call
           `produceAll` if cache is empty or if Ann.cache.all is true & data has not previously been fetched.
    @return existing instances of this type that satisfy filter from data cache.
    """
        ...
    @classmethod
    def findByCacheKey(cls, key: str) -> Union[ExMachinaConnectorCredentialConfig]:
    """
    ...
    """
        ...
    @classmethod
    def forCacheKey(cls, key: str) -> Union[ExMachinaConnectorCredentialConfig]:
    """
    Returns cached instance by key, with secrets removed.
    """
        ...
    def getCached(self) -> Union[ExMachinaConnectorCredentialConfig]:
    """
    ...
    """
        ...
    def refreshCache(self) -> Union[ExMachinaConnectorCredentialConfig]:
    """
    ...
    """
        ...
    @classmethod
    def produce(cls, key: str) -> Union[ExMachinaConnectorCredentialConfig]:
    """
    Should produce an entry for the cache key. This method should not be called directly.
    """
        ...
    @classmethod
    def produceAll(cls) -> Union[Map[str, ExMachinaConnectorCredentialConfig]]:
    """
    ...
    """
        ...
    @classmethod
    def doProduceAll(cls) -> Union[Map[str, ExMachinaConnectorCredentialConfig]]:
    """
    ...
    """
        ...
    def getConfig(self) -> ExMachinaConnectorCredentialConfig:
    """
    ...
    """
        ...
    def getSecret(self) -> ExMachinaConnectorCredentialConfig:
    """
    ...
    """
        ...
    @classmethod
    def forConfigKey(cls, configKey: str) -> Union[ExMachinaConnectorCredentialConfig]:
    """
    ...
    """
        ...
    @classmethod
    def listConfigs(cls, parallel: bool=None, filter: Callable[[str], bool]=None) -> Union[Stream[ExMachinaConnectorCredentialConfig]]:
    """
    @param
    ...
    """
        ...
    @overload
    def setConfigValues(self, from_: ExMachinaConnectorCredentialConfig, override: str=None) -> None:
    """
    ...
    """
        ...
    @overload
    def setSecretValues(self, from_: ExMachinaConnectorCredentialConfig, override: str=None) -> None:
    """
    ...
    """
        ...
    @classmethod
    def loadConfigAndSecret(cls, configKey: str) -> Union[ExMachinaConnectorCredentialConfig]:
    """
    ...
    """
        ...
    def removeSecrets(self) -> Union[ExMachinaConnectorCredentialConfig]:
    """
    @return this config without any secret values.
    """
        ...
    def removeNonSecrets(self) -> Union[ExMachinaConnectorCredentialConfig]:
    """
    @return this config with only secret values.
    """
        ...
    def validate(self) -> ExMachinaConnectorCredentialConfig:
    """
    ...
    """
        ...
    @classmethod
    def populateAcl(cls, objs: Array[ExMachinaConnectorCredentialConfig]=None) -> Union[int]:
    """
    ...
    """
        ...
    def grantMemberReadUpdateRemove(self, member: AccessControlEntity) -> ExMachinaConnectorCredentialConfig:
    """
    Creates (or updates existing) entry with all but modify ACL permissions.
    """
        ...
    def mergeAclEntry(self, entry: AclEntry) -> ExMachinaConnectorCredentialConfig:
    """
    ...
    """
        ...
    def mergeAclEntries(self, entries: Array[AclEntry]) -> ExMachinaConnectorCredentialConfig:
    """
    ...
    """
        ...
    @classmethod
    def fromString(cls, s: str) -> Union[ExMachinaConnectorCredentialConfig]:
    """
