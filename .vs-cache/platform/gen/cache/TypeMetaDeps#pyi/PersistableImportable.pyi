...
# Python definitions for the C3 type PersistableImportable


class PersistableImportable(Importable, Value):
    """
    ...
    @classmethod
    def startImportData(cls, spec: StartImportDataSpec=None) -> PushStream[PersistableImportable]:
    """
    @return a push stream to import instances of this type.
    """
        ...
    @classmethod
    def startImportDataWithStats(cls, spec: StartImportDataSpec=None) -> PushStreamWithStats[PersistableImportable]:
    """
    @return a push stream to import instances of this type.
    """
        ...
