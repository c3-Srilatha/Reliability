...
# Python definitions for the C3 type TimedDataHeader

TDP = TypeVar('TDP')

class TimedDataHeader(Generic[TDP], TimedDataFields[TDP]):
    """
    ...
    Mixin this type to provide meta information about the Timeseries being stored in {@link TimedDataPoint}
    ...
    {@link TimedDataPoint} type & {@link TimedDataHeader}
    ...
    @remarks this represents a made instance of TimedDataHeader
    """
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[TimedDataHeader[TDP]]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[TimedDataHeader[TDP]]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[TimedDataHeader[TDP]]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[TimedDataHeader[TDP]]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> TimedDataHeader[TDP]:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> TimedDataHeader[TDP]:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> TimedDataHeader[TDP]:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[TimedDataHeader[TDP]]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[TimedDataHeader[TDP]]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> TimedDataHeader[TDP]:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> TimedDataHeader[TDP]:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> TimedDataHeader[TDP]:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> TimedDataHeader[TDP]:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> TimedDataHeader[TDP]:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> TimedDataHeader[TDP]:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> TimedDataHeader[TDP]:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> TimedDataHeader[TDP]:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> TimedDataHeader[TDP]:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> TimedDataHeader[TDP]:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> TimedDataHeader[TDP]:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> TimedDataHeader[TDP]:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> TimedDataHeader[TDP]:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> TimedDataHeader[TDP]:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> TimedDataHeader[TDP]:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> TimedDataHeader[TDP]:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> TimedDataHeader[TDP]:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> TimedDataHeader[TDP]:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> TimedDataHeader[TDP]:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> TimedDataHeader[TDP]:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> TimedDataHeader[TDP]:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> TimedDataHeader[TDP]:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> TimedDataHeader[TDP]:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> TimedDataHeader[TDP]:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> TimedDataHeader[TDP]:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> TimedDataHeader[TDP]:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> TimedDataHeader[TDP]:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> TimedDataHeader[TDP]:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[TimedDataHeader[TDP]]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[TimedDataHeader[TDP]]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[TimedDataHeader[TDP]]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[TimedDataHeader[TDP]]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[TimedDataHeader[TDP]]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, TimedDataHeader[TDP]]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, TimedDataHeader[TDP]]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[TimedDataHeader[TDP]]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[TimedDataHeader[TDP]]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> TimedDataHeader[TDP]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> TimedDataHeader[TDP]:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> TimedDataHeader[TDP]:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> TimedDataHeader[TDP]:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> TimedDataHeader[TDP]:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> TimedDataHeader[TDP]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> TimedDataHeader[TDP]:
    """
    ...
    """
        ...
    def afterMake(self) -> TimedDataHeader[TDP]:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> TimedDataHeader[TDP]:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[TimedDataHeader[TDP]]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> TimedDataHeader[TDP]:
    """
