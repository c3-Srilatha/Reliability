...
from c3.platform.DbChangeLogInfo import DbChangeLogInfo

# Python definitions for the C3 type DbChangeLogListener


class DbChangeLogListener(ChangeLogListener[DbChangeLogInfo], Value):
    """
    ChangeLogListener for db engine
    
    @remarks this represents a made instance of DbChangeLogListener
    """
    ...
    """
        ...
    @classmethod
    def logInfo(cls, typeRef: Type, sourceOperInfo: DbSourceOperInfo, changes: Array[DbEditList]=None) -> Union[Map[str, DbChangeLogInfo]]:
    """
    ...
    """
        ...
    @classmethod
    def process(cls, typeRef: Type, logs: Map[str, Array[DbChangeLogInfo]]) -> None:
    """
    ...
    """
        ...
    @classmethod
    def bwdDeps(cls, entry: ChangeLogQueueEntry) -> ChangeLogBwdDeps:
    """
    Gets the backward deps that will be invalidated based on the change log queue entry.
    
    @param entry
           Change log queue entry to be used to evaluate the affected backward dependencies.
    
    @return the backward deps that will be invalidated based on the provided change log queue entry.
    """
        ...
