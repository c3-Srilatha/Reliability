...
# Python definitions for the C3 type EvalFeatureSpec


class EvalFeatureSpec(EvalFeatureSpecBase, ProjectionSpecBase):
    """
    ...
    **snapshotId** is used to create a single snapshot. Please also refer to {@link CreateSnapshotSpec#sourceSnapshotId} if an existing
    ...
    ```
    """
    def __init__(self, start: Optional[datetime]=None, end: Optional[datetime]=None, snapshotId: Optional[str]=None, skipMaterialized: Optional[bool]=None, toEmr: Optional[bool]=None, projection: Optional[str]=None) -> None: ...
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[EvalFeatureSpec]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[EvalFeatureSpec]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[EvalFeatureSpec]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[EvalFeatureSpec]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> EvalFeatureSpec:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> EvalFeatureSpec:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> EvalFeatureSpec:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[EvalFeatureSpec]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[EvalFeatureSpec]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> EvalFeatureSpec:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> EvalFeatureSpec:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> EvalFeatureSpec:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> EvalFeatureSpec:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> EvalFeatureSpec:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> EvalFeatureSpec:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> EvalFeatureSpec:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> EvalFeatureSpec:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> EvalFeatureSpec:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> EvalFeatureSpec:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> EvalFeatureSpec:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> EvalFeatureSpec:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> EvalFeatureSpec:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> EvalFeatureSpec:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> EvalFeatureSpec:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> EvalFeatureSpec:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> EvalFeatureSpec:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> EvalFeatureSpec:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> EvalFeatureSpec:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> EvalFeatureSpec:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> EvalFeatureSpec:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> EvalFeatureSpec:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> EvalFeatureSpec:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> EvalFeatureSpec:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> EvalFeatureSpec:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> EvalFeatureSpec:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> EvalFeatureSpec:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> EvalFeatureSpec:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[EvalFeatureSpec]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[EvalFeatureSpec]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[EvalFeatureSpec]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[EvalFeatureSpec]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[EvalFeatureSpec]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, EvalFeatureSpec]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, EvalFeatureSpec]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[EvalFeatureSpec]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[EvalFeatureSpec]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> EvalFeatureSpec:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> EvalFeatureSpec:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> EvalFeatureSpec:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> EvalFeatureSpec:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> EvalFeatureSpec:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> EvalFeatureSpec:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> EvalFeatureSpec:
    """
    ...
    """
        ...
    def afterMake(self) -> EvalFeatureSpec:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> EvalFeatureSpec:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[EvalFeatureSpec]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> EvalFeatureSpec:
    """
    ...
    """
        ...
    @classmethod
    def last12Months(cls) -> Union[EvalFeatureSpec]:
    """
    ...
    """
        ...
    @classmethod
    def prevLast12Months(cls) -> Union[EvalFeatureSpec]:
    """
    ...
    """
        ...
    @classmethod
    def combineAndSort(cls, timeRanges: Array[TimeRange]) -> Union[Array[EvalFeatureSpec]]:
    """
    ...
    """
        ...
    @classmethod
    def coalesce(cls, timeRanges: Array[TimeRange]) -> Union[EvalFeatureSpec]:
    """
    ...
    """
        ...
    def overlap(self, othr: TimeRange) -> Union[EvalFeatureSpec]:
    """
    Returns overlap TimeRange with the input TimeRange. Returns null if no overlap found
    """
        ...
    @classmethod
    def fromPrettyPrint(cls, prettyPrint: str) -> EvalFeatureSpec:
    """
    ...
    """
        ...
    @classmethod
    def fromMap(cls, map: Map[datetime, datetime]) -> Union[Array[EvalFeatureSpec]]:
    """
    ...
    """
        ...
    def shift(self, offset: Duration) -> EvalFeatureSpec:
    """
