...
# Python definitions for the C3 type DataLake.Table.ImportMode
...
class ImportMode():
    ...
    """
    def __init__(self, APPEND: Optional[str]=None, OVERWRITE: Optional[str]=None, MERGE: Optional[str]=None) -> None: ...
