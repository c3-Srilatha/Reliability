...
# Python definitions for the C3 type LightGbmPipeT


class LightGbmPipeT(MlTemplate.AtomicPipe.PipeVersioned[LightGbmPipe.Base, LightGbmPipe, Data, Data, Data], SklearnLikePipe.FieldsAndUtils):
    """
    ...
    @remarks this represents a made instance of LightGbmPipeT
    """
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[LightGbmPipeT]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[LightGbmPipeT]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[LightGbmPipeT]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[LightGbmPipeT]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> LightGbmPipeT:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> LightGbmPipeT:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> LightGbmPipeT:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[LightGbmPipeT]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[LightGbmPipeT]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> LightGbmPipeT:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> LightGbmPipeT:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> LightGbmPipeT:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> LightGbmPipeT:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> LightGbmPipeT:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> LightGbmPipeT:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> LightGbmPipeT:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> LightGbmPipeT:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> LightGbmPipeT:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> LightGbmPipeT:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> LightGbmPipeT:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> LightGbmPipeT:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> LightGbmPipeT:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> LightGbmPipeT:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> LightGbmPipeT:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> LightGbmPipeT:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> LightGbmPipeT:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> LightGbmPipeT:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> LightGbmPipeT:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> LightGbmPipeT:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> LightGbmPipeT:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> LightGbmPipeT:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> LightGbmPipeT:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> LightGbmPipeT:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> LightGbmPipeT:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> LightGbmPipeT:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> LightGbmPipeT:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> LightGbmPipeT:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[LightGbmPipeT]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[LightGbmPipeT]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[LightGbmPipeT]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[LightGbmPipeT]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[LightGbmPipeT]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, LightGbmPipeT]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, LightGbmPipeT]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[LightGbmPipeT]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[LightGbmPipeT]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> LightGbmPipeT:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> LightGbmPipeT:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> LightGbmPipeT:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> LightGbmPipeT:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> LightGbmPipeT:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> LightGbmPipeT:
    """
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[LightGbmPipeT]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> LightGbmPipeT:
    """
    ...
    """
        ...
    def afterMake(self) -> LightGbmPipeT:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> LightGbmPipeT:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[LightGbmPipeT]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> LightGbmPipeT:
    """
    ...
    """
        ...
    def afterConvert(self, model: Any, spec: MlConvertSpec=None) -> LightGbmPipeT:
    """
    ...
    """
        ...
    def remakeTemplate(self) -> LightGbmPipeT:
    """
    ...
    """
        ...
    def withoutIdentity(self) -> LightGbmPipeT:
    """
    ...
    """
        ...
    def trainSync(self, x: Data, y: Data=None, spec: MlOperationSpec=None) -> LightGbmPipeT:
    """
    ...
    """
        ...
    @classmethod
    def allCached(cls, doNotProduceAll: bool=None) -> Union[Stream[LightGbmPipeT]]:
    """
    ...
    """
        ...
    @classmethod
    def find(cls, filter: str=None, doNotProduceAll: bool=None) -> Union[Stream[LightGbmPipeT]]:
    """
    ...
    """
        ...
    @classmethod
    def findBy(cls, field: str, value: Any, doNotProduceAll: bool=None) -> Union[Stream[LightGbmPipeT]]:
    """
    @param doNotProduceAll if true, will not populate cache and only return available cached instances. Will call
           `produceAll` if cache is empty or if Ann.cache.all is true & data has not previously been fetched.
    @return existing instances of this type that satisfy filter from data cache.
    """
        ...
    @classmethod
    def findByCacheKey(cls, key: str) -> Union[LightGbmPipeT]:
    """
    ...
    """
        ...
    @classmethod
    def forCacheKey(cls, key: str) -> Union[LightGbmPipeT]:
    """
    ...
    """
        ...
    def getCached(self) -> Union[LightGbmPipeT]:
    """
    ...
    """
        ...
    def refreshCache(self) -> Union[LightGbmPipeT]:
    """
    ...
    """
        ...
    @classmethod
    def produce(cls, key: str) -> Union[LightGbmPipeT]:
    """
    Should produce an entry for the cache key. This method should not be called directly.
    """
        ...
    @classmethod
    def produceAll(cls) -> Union[Map[str, LightGbmPipeT]]:
    """
    ...
    """
        ...
    @classmethod
    def doProduceAll(cls) -> Union[Map[str, LightGbmPipeT]]:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, spec: FetchSpec=None) -> FetchResult[LightGbmPipeT]:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, filter: Filter) -> FetchResult[LightGbmPipeT]:
    """
    ...
    """
        ...
    @classmethod
    def fetchObjStream(cls, spec: FetchStreamSpec=None) -> Union[Stream[LightGbmPipeT]]:
    """
    Fetches multiple obj instances based on a specification.  Only objs that the caller is authorized to fetch will be
    returned.
    ...
    """
        ...
    @classmethod
    def fetchMultiLocale(cls, spec: MultiLocaleFetchSpec=None) -> Union[Map[str, FetchResult[LightGbmPipeT]]]:
    """
    ...
    """
        ...
    def get(self, include: str=None) -> Union[LightGbmPipeT]:
    """
    ...
    """
        ...
    def getSpecific(self, include: str=None) -> Union[LightGbmPipeT]:
    """
    ...
    """
        ...
    def getMissing(self, spec: GetMissingSpec) -> LightGbmPipeT:
    """
    ...
    """
        ...
    def getDirect(self, include: str=None) -> Union[LightGbmPipeT]:
    """
    ...
    """
        ...
    def applyReverseEdit(self, versionEdit: VersionEdit) -> LightGbmPipeT:
    """
    ...
    """
        ...
    @classmethod
    def fromString(cls, s: str) -> Union[LightGbmPipeT]:
    """
    ...
    """
        ...
    def create(self, spec: UpsertSpec=None) -> Union[LightGbmPipeT]:
    """
    ...
    """
        ...
    @classmethod
    def createBatch(cls, objs: Array[LightGbmPipeT], spec: UpsertSpec=None) -> Union[ObjList[LightGbmPipeT]]:
    """
    ...
    """
        ...
    @classmethod
    def createBatchObjStream(cls, objs: Stream[LightGbmPipeT], spec: CreateBatchObjStreamSpec=None) -> Union[ObjList[LightGbmPipeT]]:
    """
    Creates multiple instances of a C3 type. If the operation fails and {@link UpsertSpec#dontThrowOnBatchError} is not
    specified (the default), then a C3BatchException will be thrown.  Otherwise {@link errors will be reported in the
    returned {@link ObjList}.  This will fail if any of the instances already exist.
    ...
    """
        ...
    def update(self, srcObj: LightGbmPipeT=None, spec: UpsertSpec=None) -> Union[LightGbmPipeT]:
    """
    ...
    """
        ...
    def upsert(self, srcObj: LightGbmPipeT=None, spec: UpsertSpec=None) -> Union[LightGbmPipeT]:
    """
    ...
    """
        ...
    @overload
    def merge(self, spec: MergeSpec=None) -> Union[LightGbmPipeT]:
    """
    ...
    """
        ...
    @overload
    def merge(self, mergeInclude: str, spec: MergeSpec=None) -> Union[LightGbmPipeT]:
    """
    ...
    """
        ...
    def touch(self, spec: TouchSpec=None) -> Union[LightGbmPipeT]:
    """
    ...
    """
        ...
    @classmethod
    def updateBatch(cls, objs: Array[LightGbmPipeT], srcObjs: Array[LightGbmPipeT]=None, spec: UpsertSpec=None) -> Union[ObjList[LightGbmPipeT]]:
    """
    ...
    """
        ...
    @classmethod
    def updateObjs(cls, objs: Callable[[], Union[Array[LightGbmPipeT]]], spec: UpsertSpec=None) -> Union[ObjList[LightGbmPipeT]]:
    """
    ...
    """
        ...
    @classmethod
    def upsertBatch(cls, objs: Array[LightGbmPipeT], srcObjs: Array[LightGbmPipeT]=None, spec: UpsertSpec=None) -> Union[ObjList[LightGbmPipeT]]:
    """
    ...
    """
        ...
    @classmethod
    def upsertObjs(cls, objs: Callable[[], Union[Array[LightGbmPipeT]]], spec: UpsertSpec=None) -> Union[ObjList[LightGbmPipeT]]:
    """
    Creates instances of a C3 type if they don't already exist and updates them if they do exist. If the operation
    ...
    """
        ...
    @classmethod
    def touchBatch(cls, objs: Array[LightGbmPipeT], spec: TouchSpec=None) -> Union[ObjList[LightGbmPipeT]]:
    """
    ...
    @overload
    @classmethod
    def mergeBatch(cls, objs: Array[LightGbmPipeT], spec: MergeSpec=None) -> Union[ObjList[LightGbmPipeT]]:
    """
    ...
    @overload
    @classmethod
    def mergeBatch(cls, objs: Array[LightGbmPipeT], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[LightGbmPipeT]]:
    """
    Merges multiple instances of a C3 type or creates them if they don't exist. If the operation fails and {@link
    UpsertSpec#dontThrowOnBatchError} is not specified (the default), then a C3BatchException will be thrown.
    Otherwise errors will be reported in the returned {@link ObjList}.  The merge operation is described in the {@link
    ...
    """
        ...
    @classmethod
    def mergeObjs(cls, objs: Callable[[], Union[Array[LightGbmPipeT]]], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[LightGbmPipeT]]:
    """
    ...
    @overload
    @classmethod
    def mergeAll(cls, mergeObj: LightGbmPipeT, spec: MergeAllSpec=None) -> Union[int]:
    """
    ...
    @overload
    @classmethod
    def mergeAll(cls, mergeObj: LightGbmPipeT, mergeInclude: str, spec: MergeAllSpec=None) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def removeBatch(cls, objs: Array[LightGbmPipeT], spec: UpsertSpec=None) -> Union[ObjList[LightGbmPipeT]]:
    """
    ...
    """
        ...
    @classmethod
    def replace(cls, objs: Array[LightGbmPipeT], spec: UpsertSpec=None) -> Union[ObjList[LightGbmPipeT]]:
    """
    ...
    """
        ...
    def unremove(self) -> Union[LightGbmPipeT]:
    """
    ...
    """
        ...
    @classmethod
    def beforeCreate(cls, objs: Array[LightGbmPipeT]) -> ObjList[LightGbmPipeT]:
    """
    ...
    """
        ...
    @classmethod
    def beforeUpdate(cls, objs: Array[LightGbmPipeT]) -> ObjList[LightGbmPipeT]:
    """
    ...
    """
        ...
    @classmethod
    def beforeRemove(cls, objs: Array[LightGbmPipeT]) -> ObjList[LightGbmPipeT]:
    """
    ...
    """
        ...
    @classmethod
    def afterCreate(cls, objs: Array[LightGbmPipeT]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def afterUpdate(cls, objs: Array[LightGbmPipeT]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def afterRemove(cls, objs: Array[LightGbmPipeT]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def startImportData(cls, spec: StartImportDataSpec=None) -> PushStream[LightGbmPipeT]:
    """
    @return a push stream to import instances of this type.
    """
        ...
    @classmethod
    def startImportDataWithStats(cls, spec: StartImportDataSpec=None) -> PushStreamWithStats[LightGbmPipeT]:
    """
    @return a push stream to import instances of this type.
    """
        ...
    ...
    """
        ...
    @classmethod
    def forId(cls, id: str, failIfMissing: bool=None) -> Union[LightGbmPipeT]:
    """
    ...
    """
        ...
    @classmethod
    def typeOfBatch(cls, objs: Array[LightGbmPipeT]) -> Union[Array[EntityType]]:
    """
    ...
    """
        ...
    @classmethod
    def dbEcho(cls, template: LightGbmPipeT=None, count: int=None, sendBack: bool=None) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def callbackLogic(cls, objs: Array[LightGbmPipeT], callback: Callable[[Union[LightGbmPipeT]], Union[LightGbmPipeT]]=None) -> ObjList[LightGbmPipeT]:
    """
    ...
    """
        ...
    @classmethod
    def afterCallbackLogic(cls, objs: Array[LightGbmPipeT], callback: Callable[[Union[LightGbmPipeT]], Union[LightGbmPipeT]]=None) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    def publish(self, subPath: str=None, contentType: str=None) -> LightGbmPipeT:
    """
    ...
    """
        ...
    @classmethod
    def removeSeedDataBatch(cls, objs: Array[SeedData]=None, spec: UpsertSpec=None) -> Union[ObjList[LightGbmPipeT]]:
    """
    ...
    """
        ...
    def createSeedData(self, spec: UpsertSpec=None) -> Union[LightGbmPipeT]:
    """
    ...
    """
        ...
    @classmethod
    def createSeedDataBatch(cls, objs: Array[SeedData]=None, spec: UpsertSpec=None) -> Union[ObjList[LightGbmPipeT]]:
    """
    ...
    """
        ...
    def updateSeedData(self, srcObj: SeedData=None, spec: UpsertSpec=None) -> Union[LightGbmPipeT]:
    """
    ...
    """
        ...
    @classmethod
    def updateSeedDataBatch(cls, objs: Array[SeedData]=None, srcObjs: Array[SeedData]=None, spec: UpsertSpec=None) -> Union[ObjList[LightGbmPipeT]]:
    """
    ...
    """
        ...
    def clearUserUpdates(self, spec: MergeSpec=None) -> Union[LightGbmPipeT]:
    """
    ...
    """
        ...
    @classmethod
    def clearUserUpdatesBatch(cls, objs: Array[SeedData]=None, spec: MergeSpec=None) -> Union[ObjList[LightGbmPipeT]]:
    """
    ...
    """
        ...
    def dependencies(self) -> Union[SeedDataDeps[LightGbmPipeT]]:
        ...
    ...
    """
        ...
    @classmethod
    def convert(cls, model: Any, spec: MlConvertSpec=None) -> LightGbmPipeT:
    """
    ...
    """
        ...
    def byReference(self) -> LightGbmPipeT:
    """
    ...
    """
        ...
    def updateModelFiles(self, modelFiles: Map[str, Url], spec: MlOperationSpec=None) -> LightGbmPipeT:
    """
    ...
    """
        ...
    def afterTrain(self, doTrainOutputs: Any, spec: MlOperationSpec=None) -> LightGbmPipeT:
    """
    ...
    """
        ...
    def withNewSpec(self, spec: MlConvertSpec=None) -> LightGbmPipeT:
    """
    ...
    """
        ...
    def withHyperparamSpaces(self, paramSpaces: Map[str, Hp.ParamSpace]) -> LightGbmPipeT:
    """
