...
# Python definitions for the C3 type BlobFile

FS = TypeVar('FS')

class BlobFile(Generic[FS], FileWithUserMetadata):
    """
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[BlobFile[FS]]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[BlobFile[FS]]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[BlobFile[FS]]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[BlobFile[FS]]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> BlobFile[FS]:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> BlobFile[FS]:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> BlobFile[FS]:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[BlobFile[FS]]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[BlobFile[FS]]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> BlobFile[FS]:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> BlobFile[FS]:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> BlobFile[FS]:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> BlobFile[FS]:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> BlobFile[FS]:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> BlobFile[FS]:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> BlobFile[FS]:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> BlobFile[FS]:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> BlobFile[FS]:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> BlobFile[FS]:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> BlobFile[FS]:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> BlobFile[FS]:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> BlobFile[FS]:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> BlobFile[FS]:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> BlobFile[FS]:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> BlobFile[FS]:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> BlobFile[FS]:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> BlobFile[FS]:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> BlobFile[FS]:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> BlobFile[FS]:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> BlobFile[FS]:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> BlobFile[FS]:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> BlobFile[FS]:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> BlobFile[FS]:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> BlobFile[FS]:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> BlobFile[FS]:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> BlobFile[FS]:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> BlobFile[FS]:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[BlobFile[FS]]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[BlobFile[FS]]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[BlobFile[FS]]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[BlobFile[FS]]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[BlobFile[FS]]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, BlobFile[FS]]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, BlobFile[FS]]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[BlobFile[FS]]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[BlobFile[FS]]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> BlobFile[FS]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> BlobFile[FS]:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> BlobFile[FS]:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> BlobFile[FS]:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> BlobFile[FS]:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> BlobFile[FS]:
    """
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[BlobFile[FS]]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> BlobFile[FS]:
    """
    ...
    """
        ...
    def afterMake(self) -> BlobFile[FS]:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> BlobFile[FS]:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[BlobFile[FS]]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> BlobFile[FS]:
    """
    ...
    """
        ...
    def withFileName(self, fileName: str) -> BlobFile[FS]:
    """
    Changes file name in this instance.
    """
        ...
    def withFileExt(self, fileExt: str) -> BlobFile[FS]:
    """
    ...
    """
        ...
    def identify(self, suffix: str=None) -> BlobFile[FS]:
    """
    ...
    """
        ...
    def readMetadata(self, spec: FileOperationSpec=None) -> BlobFile[FS]:
    """
    ...
    """
        ...
    def refreshMetadata(self, spec: FileOperationSpec=None) -> BlobFile[FS]:
    """
    ...
    """
        ...
    def guessMetadata(self, spec: FileOperationSpec=None) -> BlobFile[FS]:
    """
    ...
    """
        ...
    def clearMetadata(self) -> BlobFile[FS]:
    """
    Clears the content metadata; e.g. if it's known to be invalid.
    """
        ...
    def withMetadata(self, meta: ContentMeta=None) -> BlobFile[FS]:
    """
    ...
    """
        ...
    def encodedPushStream(self, spec: FileOperationSpec=None) -> Pair[BlobFile[FS], BytePushStream]:
    """
    ...
    """
        ...
    def pushStream(self, spec: FileOperationSpec=None) -> Pair[BlobFile[FS], BytePushStream]:
    """
    @return byte push stream to be used for writing un-encoded data into this content object.
    """
        ...
    def charPushStream(self, spec: FileOperationSpec=None) -> Pair[BlobFile[FS], CharPushStream]:
    """
    @return character push stream to be used for writing un-encoded data into this content object.
    """
        ...
    def encodedStream(self, spec: FileOperationSpec=None) -> Union[Pair[BlobFile[FS], ByteStream]]:
    """
    ...
    """
        ...
    def writeStream(self, content: ByteStream, spec: FileOperationSpec=None) -> BlobFile[FS]:
    """
    ...
    """
        ...
    def writeInputStream(self, inputStream: Any, spec: FileOperationSpec=None) -> BlobFile[FS]:
    """
    Truncates file and replaces it's content with provided binary content.
    """
        ...
    def writeZipInputStream(self, zipInputStream: Any, spec: FileOperationSpec=None) -> BlobFile[FS]:
    """
    Truncates file and replaces its content with provided binary content from zipInputStream
    """
        ...
    def writeEncodedStream(self, encodedContent: ByteStream, spec: FileOperationSpec=None) -> BlobFile[FS]:
    """
    ...
    """
        ...
    def writeEncodedInputStream(self, inputStream: Any, spec: FileOperationSpec=None) -> BlobFile[FS]:
    """
    Truncates file and replaces it's encoded content with provided binary content.
    """
        ...
    def write(self, content: any, spec: FileOperationSpec=None) -> BlobFile[FS]:
    """
    Truncates file and replaces it's content with provided binary content.
    ...
    """
        ...
    def writeEncoded(self, encodedContent: any, spec: FileOperationSpec=None) -> BlobFile[FS]:
    """
    Truncates file and replaces it's encoded content with provided binary content.
    ...
    """
        ...
    def writeString(self, content: str, spec: FileOperationSpec=None) -> BlobFile[FS]:
    """
    ...
    """
        ...
    def writeObj(self, obj: Obj, spec: FileObjsOperSpec=None) -> BlobFile[FS]:
    """
    ...
    """
        ...
    def startWriteObjs(self, spec: FileObjsOperSpec=None) -> Pair[BlobFile[FS], PushStream[Obj]]:
    """
    Serializes content from a list of c3 objects into a file.
    ...
    """
        ...
    def compress(self, contentEncoding: str=None, spec: FileCompressSpec=None) -> BlobFile[FS]:
    """
    ...
    """
        ...
    def uncompress(self, spec: FileCompressSpec=None) -> BlobFile[FS]:
    """
    Uncompresses file. Removes compression specific extension.
    """
        ...
    def transcode(self, contentType: str, contentEncoding: str, spec: FileCompressSpec=None) -> BlobFile[FS]:
    """
    ...
    """
        ...
    def copyContentTo(self, target: BlobFile[FS], spec: FileOperationSpec=None) -> None:
    """
    ...
    """
        ...
    @overload
    def concat(self, other: Content) -> BlobFile[FS]:
    """
    Creates a new Content by merging the two contents
    """
        ...
    @overload
    def concat(self, other: any) -> BlobFile[FS]:
    """
    ...
    """
        ...
    @classmethod
    def fromString(cls, s: str) -> Union[BlobFile[FS]]:
    """
    ...
    """
        ...
    @classmethod
    def fsForThisType(cls) -> Union[FS]:
        ...
