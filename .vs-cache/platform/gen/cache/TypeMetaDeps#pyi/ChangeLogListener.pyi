...
# Python definitions for the C3 type ChangeLogListener

IT = TypeVar('IT')

class ChangeLogListener(Generic[IT], Value):
    """
    ...
    """
        ...
    @classmethod
    def logInfo(cls, typeRef: Type, sourceOperInfo: DbSourceOperInfo, changes: Array[DbEditList]=None) -> Union[Map[str, IT]]:
    """
    ...
    """
        ...
    @classmethod
    def process(cls, typeRef: Type, logs: Map[str, Array[IT]]) -> None:
    """
