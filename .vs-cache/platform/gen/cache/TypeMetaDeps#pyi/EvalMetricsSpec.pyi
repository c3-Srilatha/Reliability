...
# Python definitions for the C3 type EvalMetricsSpec


class EvalMetricsSpec(MetricSpecBase):
    """
    Type for batch evaluation. Used in cases when we have more than 1 metric or more than 1 source
    
    @remarks this represents a made instance of EvalMetricsSpec
    """
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[EvalMetricsSpec]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[EvalMetricsSpec]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[EvalMetricsSpec]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[EvalMetricsSpec]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> EvalMetricsSpec:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> EvalMetricsSpec:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> EvalMetricsSpec:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[EvalMetricsSpec]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[EvalMetricsSpec]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> EvalMetricsSpec:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> EvalMetricsSpec:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> EvalMetricsSpec:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> EvalMetricsSpec:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> EvalMetricsSpec:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> EvalMetricsSpec:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> EvalMetricsSpec:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> EvalMetricsSpec:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> EvalMetricsSpec:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> EvalMetricsSpec:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> EvalMetricsSpec:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> EvalMetricsSpec:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> EvalMetricsSpec:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> EvalMetricsSpec:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> EvalMetricsSpec:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> EvalMetricsSpec:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> EvalMetricsSpec:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> EvalMetricsSpec:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> EvalMetricsSpec:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> EvalMetricsSpec:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> EvalMetricsSpec:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> EvalMetricsSpec:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> EvalMetricsSpec:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> EvalMetricsSpec:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> EvalMetricsSpec:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> EvalMetricsSpec:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> EvalMetricsSpec:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> EvalMetricsSpec:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[EvalMetricsSpec]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[EvalMetricsSpec]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[EvalMetricsSpec]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[EvalMetricsSpec]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[EvalMetricsSpec]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, EvalMetricsSpec]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, EvalMetricsSpec]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[EvalMetricsSpec]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[EvalMetricsSpec]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> EvalMetricsSpec:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> EvalMetricsSpec:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> EvalMetricsSpec:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> EvalMetricsSpec:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> EvalMetricsSpec:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> EvalMetricsSpec:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> EvalMetricsSpec:
    """
    ...
    """
        ...
    def afterMake(self) -> EvalMetricsSpec:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> EvalMetricsSpec:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[EvalMetricsSpec]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> EvalMetricsSpec:
    """
    ...
    """
        ...
    @classmethod
    def last12Months(cls) -> Union[EvalMetricsSpec]:
    """
    ...
    """
        ...
    @classmethod
    def prevLast12Months(cls) -> Union[EvalMetricsSpec]:
    """
    ...
    """
        ...
    @classmethod
    def combineAndSort(cls, timeRanges: Array[TimeRange]) -> Union[Array[EvalMetricsSpec]]:
    """
    ...
    """
        ...
    @classmethod
    def coalesce(cls, timeRanges: Array[TimeRange]) -> Union[EvalMetricsSpec]:
    """
    ...
    """
        ...
    def overlap(self, othr: TimeRange) -> Union[EvalMetricsSpec]:
    """
    Returns overlap TimeRange with the input TimeRange. Returns null if no overlap found
    """
        ...
    @classmethod
    def fromPrettyPrint(cls, prettyPrint: str) -> EvalMetricsSpec:
    """
    ...
    """
        ...
    @classmethod
    def fromMap(cls, map: Map[datetime, datetime]) -> Union[Array[EvalMetricsSpec]]:
    """
    ...
    """
        ...
    @overload
    def shift(self, offset: Duration) -> EvalMetricsSpec:
    """
