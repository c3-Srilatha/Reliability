...
# Python definitions for the C3 type SetType


class SetType(CollectionType):
    """
    A set is a vector of a single value type, which cannot contain duplicates;
    attempts to add duplicate values are ignored. Null values are not allowed.
    Otherwise, the semantics of set are the same as {@link ArrayType array}.
    
    Sets are declared in DSL using `set<E>` notation:
    
    ```
    // zero or more primitive integers
    counts: set<int>
    
    // Cat objects or any type that mixes Cat
    herd: set<Cat>
    ```
    
    Instances can be created programatically using these convenience methods:
     - #of
     - #ofAny
     - #ofBinary
     - #ofBool
    ...
    @remarks this represents a made instance of SetType
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> SetType:
    """
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[SetType]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[SetType]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[SetType]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[SetType]:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> SetType:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> SetType:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[SetType]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[SetType]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> SetType:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> SetType:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> SetType:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> SetType:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> SetType:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> SetType:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> SetType:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> SetType:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> SetType:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> SetType:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> SetType:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> SetType:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> SetType:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> SetType:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> SetType:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> SetType:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> SetType:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> SetType:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> SetType:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> SetType:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> SetType:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> SetType:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> SetType:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> SetType:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> SetType:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> SetType:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> SetType:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[SetType]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[SetType]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[SetType]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[SetType]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[SetType]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, SetType]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, SetType]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[SetType]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[SetType]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> SetType:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> SetType:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> SetType:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> SetType:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> SetType:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> SetType:
    """
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[SetType]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> SetType:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> SetType:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[SetType]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> SetType:
    """
    ...
    """
        ...
    def withoutDeclaredSrcPos(self, recursive: bool=None) -> SetType:
    """
    ...
    """
        ...
    @overload
    def withAnnotation(self, ann: Annotation) -> SetType:
    """
    Add an annotation to the given metadata
    """
        ...
    @overload
    def withAnnotation(self, ann: str, annField: str=None, value: Any=None) -> SetType:
    """
    Add an annotation to the given metadata
    @param ann
            annotation to add
    ...
    """
        ...
    @classmethod
    def fromString(cls, s: str) -> Union[SetType]:
    """
    ...
    """
    @return {@link #emptySet}
    """
        ...
    def buildSet(self, builder: Callable[[SetBuilder[E]]]) -> Union[Set[E]]:
    """
    @return set built by provided lambda
    """
        ...
    @overload
    def makeBuilder(self, initial: Set[E]=None) -> SetBuilder[E]:
    """
    @return builder of set of this type.
    """
        ...
    @overload
    def makeBuilder(self, size: int) -> SetBuilder[E]:
    """
    @return builder of set of this type with the provided initial size allocation
    """
        ...
    def makeSet(self, *elements: Array[E]) -> Union[Set[E]]:
    """
    @return instance of set of this type from provided elements.
    """
        ...
    def emptySet(self) -> Union[Set[E]]:
    """
    @return instance of empty set of this type.
    """
        ...
