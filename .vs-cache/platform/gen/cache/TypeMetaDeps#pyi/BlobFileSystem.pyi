...
from c3.platform.Promise import Promise
from c3.platform.BlobFileSystem import BlobFileSystem
...
# Python definitions for the C3 type BlobFileSystem

F = TypeVar('F')

class BlobFileSystem(Generic[F], FileSystem):
    """
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[BlobFileSystem[F]]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[BlobFileSystem[F]]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[BlobFileSystem[F]]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[BlobFileSystem[F]]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> BlobFileSystem[F]:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> BlobFileSystem[F]:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> BlobFileSystem[F]:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[BlobFileSystem[F]]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[BlobFileSystem[F]]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> BlobFileSystem[F]:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> BlobFileSystem[F]:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> BlobFileSystem[F]:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> BlobFileSystem[F]:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> BlobFileSystem[F]:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> BlobFileSystem[F]:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> BlobFileSystem[F]:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> BlobFileSystem[F]:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> BlobFileSystem[F]:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> BlobFileSystem[F]:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> BlobFileSystem[F]:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> BlobFileSystem[F]:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> BlobFileSystem[F]:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> BlobFileSystem[F]:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> BlobFileSystem[F]:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> BlobFileSystem[F]:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> BlobFileSystem[F]:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> BlobFileSystem[F]:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> BlobFileSystem[F]:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> BlobFileSystem[F]:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> BlobFileSystem[F]:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> BlobFileSystem[F]:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> BlobFileSystem[F]:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> BlobFileSystem[F]:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> BlobFileSystem[F]:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> BlobFileSystem[F]:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> BlobFileSystem[F]:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> BlobFileSystem[F]:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[BlobFileSystem[F]]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[BlobFileSystem[F]]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[BlobFileSystem[F]]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[BlobFileSystem[F]]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[BlobFileSystem[F]]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, BlobFileSystem[F]]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, BlobFileSystem[F]]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[BlobFileSystem[F]]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[BlobFileSystem[F]]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> BlobFileSystem[F]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> BlobFileSystem[F]:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> BlobFileSystem[F]:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> BlobFileSystem[F]:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> BlobFileSystem[F]:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> BlobFileSystem[F]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> BlobFileSystem[F]:
    """
    ...
    """
        ...
    def afterMake(self) -> BlobFileSystem[F]:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> BlobFileSystem[F]:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[BlobFileSystem[F]]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> BlobFileSystem[F]:
    """
    ...
    def doTruncateContainer(self, containerName: str, spec: FileOperationSpec=None) -> int:
        ...
    def doReadBlobMeta(self, containerName: str, blobKey: str, spec: FileOperationSpec=None) -> Union[F]:
        ...
    def doBlobEncodedStream(self, containerName: str, blobKey: str, spec: FileOperationSpec=None) -> Union[Pair[F, ByteStream]]:
        ...
    ...
    def doDeleteBlobs(self, containerName: str, blobKeys: Array[str], spec: FileOperationSpec=None) -> None:
        ...
    def doCopyBlob(self, srcContainerName: str, srcBlobKey: str, destContainerName: str, destBlobKey: str, spec: FileOperationSpec=None) -> Union[F]:
        ...
    def doCopyBlobs(self, srcContainerNames: Array[str], srcBlobKeys: Array[str], destContainerNames: Array[str], destBlobKeys: Array[str], spec: FileOperationSpec=None) -> Union[Array[F]]:
    """
    ...
    """
        ...
    def doReplaceBlobContentTypeAndEncoding(self, containerName: str, srcBlobKey: str, contentEncoding: str, contentType: str=None, spec: FileOperationSpec=None) -> Union[F]:
        ...
