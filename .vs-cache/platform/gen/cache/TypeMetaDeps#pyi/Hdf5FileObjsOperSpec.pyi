...
# Python definitions for the C3 type Hdf5FileObjsOperSpec


class Hdf5FileObjsOperSpec(FileObjsOperSpec):
    """
    ...
    leafLevelGroupInclude: Optional[str]=None
    """
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[Hdf5FileObjsOperSpec]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[Hdf5FileObjsOperSpec]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[Hdf5FileObjsOperSpec]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[Hdf5FileObjsOperSpec]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> Hdf5FileObjsOperSpec:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> Hdf5FileObjsOperSpec:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> Hdf5FileObjsOperSpec:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[Hdf5FileObjsOperSpec]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[Hdf5FileObjsOperSpec]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> Hdf5FileObjsOperSpec:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> Hdf5FileObjsOperSpec:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> Hdf5FileObjsOperSpec:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> Hdf5FileObjsOperSpec:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> Hdf5FileObjsOperSpec:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> Hdf5FileObjsOperSpec:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> Hdf5FileObjsOperSpec:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> Hdf5FileObjsOperSpec:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> Hdf5FileObjsOperSpec:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> Hdf5FileObjsOperSpec:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> Hdf5FileObjsOperSpec:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> Hdf5FileObjsOperSpec:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> Hdf5FileObjsOperSpec:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> Hdf5FileObjsOperSpec:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> Hdf5FileObjsOperSpec:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> Hdf5FileObjsOperSpec:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> Hdf5FileObjsOperSpec:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> Hdf5FileObjsOperSpec:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> Hdf5FileObjsOperSpec:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> Hdf5FileObjsOperSpec:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> Hdf5FileObjsOperSpec:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> Hdf5FileObjsOperSpec:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> Hdf5FileObjsOperSpec:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> Hdf5FileObjsOperSpec:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> Hdf5FileObjsOperSpec:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> Hdf5FileObjsOperSpec:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> Hdf5FileObjsOperSpec:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> Hdf5FileObjsOperSpec:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[Hdf5FileObjsOperSpec]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[Hdf5FileObjsOperSpec]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[Hdf5FileObjsOperSpec]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[Hdf5FileObjsOperSpec]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[Hdf5FileObjsOperSpec]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, Hdf5FileObjsOperSpec]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, Hdf5FileObjsOperSpec]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[Hdf5FileObjsOperSpec]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[Hdf5FileObjsOperSpec]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> Hdf5FileObjsOperSpec:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> Hdf5FileObjsOperSpec:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> Hdf5FileObjsOperSpec:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> Hdf5FileObjsOperSpec:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> Hdf5FileObjsOperSpec:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> Hdf5FileObjsOperSpec:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> Hdf5FileObjsOperSpec:
    """
    ...
    """
        ...
    def afterMake(self) -> Hdf5FileObjsOperSpec:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> Hdf5FileObjsOperSpec:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[Hdf5FileObjsOperSpec]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> Hdf5FileObjsOperSpec:
    """
    ...
    """
        ...
    def withRetry(self, maxRetries: int=None, initialSleepMillis: int=None, exponent: float=None) -> Union[Hdf5FileObjsOperSpec]:
    """
    @return new instance of this spec with `retrySpec` set
    """
        ...
    @classmethod
    def timeoutSeconds(cls, secs: float) -> Hdf5FileObjsOperSpec:
    """
    @return instance of this spec with `retrySpec`'s `maxTotalMillis` set
    """
        ...
    @classmethod
    def fromType(cls, serType: Type) -> Hdf5FileObjsOperSpec:
    """
    ...
    """
        ...
    @classmethod
    def toDecrypt(cls) -> Union[Hdf5FileObjsOperSpec]:
    """
