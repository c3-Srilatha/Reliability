...
from c3.platform.ArrayBuilder import ArrayBuilder
from c3.platform.SetBuilder import SetBuilder
from c3.platform.Pkg.Store.WriteSpec import Pkg.Store.WriteSpec
...
# Python definitions for the C3 type Pkg.Store.Local


class Local(Pkg.Store.Nested, Configurable[Pkg.Store.Local.Config], Named):
    """
    This represents Pkg.Store backed by local filesystem.
    @see Pkg.Store.Local.Config
    
    @remarks this represents a made instance of Pkg.Store.Local
    """
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[Pkg.Store.Local]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[Pkg.Store.Local]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[Pkg.Store.Local]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[Pkg.Store.Local]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> Pkg.Store.Local:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> Pkg.Store.Local:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> Pkg.Store.Local:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[Pkg.Store.Local]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[Pkg.Store.Local]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> Pkg.Store.Local:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> Pkg.Store.Local:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> Pkg.Store.Local:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> Pkg.Store.Local:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> Pkg.Store.Local:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> Pkg.Store.Local:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> Pkg.Store.Local:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> Pkg.Store.Local:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> Pkg.Store.Local:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> Pkg.Store.Local:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> Pkg.Store.Local:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> Pkg.Store.Local:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> Pkg.Store.Local:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> Pkg.Store.Local:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> Pkg.Store.Local:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> Pkg.Store.Local:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> Pkg.Store.Local:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> Pkg.Store.Local:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> Pkg.Store.Local:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> Pkg.Store.Local:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> Pkg.Store.Local:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> Pkg.Store.Local:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> Pkg.Store.Local:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> Pkg.Store.Local:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> Pkg.Store.Local:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> Pkg.Store.Local:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> Pkg.Store.Local:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> Pkg.Store.Local:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[Pkg.Store.Local]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[Pkg.Store.Local]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[Pkg.Store.Local]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[Pkg.Store.Local]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[Pkg.Store.Local]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, Pkg.Store.Local]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, Pkg.Store.Local]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[Pkg.Store.Local]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[Pkg.Store.Local]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> Pkg.Store.Local:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> Pkg.Store.Local:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> Pkg.Store.Local:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> Pkg.Store.Local:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> Pkg.Store.Local:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> Pkg.Store.Local:
    """
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[Pkg.Store.Local]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> Pkg.Store.Local:
    """
    ...
    """
        ...
    def afterMake(self) -> Pkg.Store.Local:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> Pkg.Store.Local:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[Pkg.Store.Local]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> Pkg.Store.Local:
    """
    ...
    """
        ...
    def pkgs(self) -> Union[Array[str]]:
    """
    @return all root pkg names in store.
    """
        ...
    def pkgVersions(self) -> Union[Map[str, str]]:
    """
    @return all available root pkg names and versions
    """
        ...
    def pkgExists(self, name: str) -> bool:
    """
    @return true if given package is available in this store.
    """
        ...
    def paths(self, pathPrefixOrGlob: str=None, includeDeps: bool=None) -> Union[Set[Pkg.Path]]:
    """
    ...
    """
        ...
    @classmethod
    def fingerprintEncodedContent(cls, content: any=None) -> str:
    """
    @return fingerprint of provided content
    @see Pkg#fileFingerprint
    """
        ...
    def readFingerprint(self, pkgPath: str) -> Union[str]:
    """
    ...
    """
        ...
    @overload
    def readFingerprints(self, pkgPaths: Array[str]) -> Union[Map[str, str]]:
    """
    ...
    """
        ...
    @overload
    def readFingerprints(self, pkgPaths: Collection[Pkg.Path]) -> Union[Map[str, str]]:
    """
    @return fingerprints of paths requested.
    @see Pkg#fileFingerprint
    """
        ...
    def evictFingerprints(self, paths: Array[str]) -> None:
    """
    Remove cached entries of fingerprints for given paths.
    """
        ...
    def content(self, path: str, failIfMissing: bool=None) -> Union[Content]:
    """
    Read content for a given path from this Pkg.Store.
    @see readEncodedContent and readContentString
    """
        ...
    def readEncodedContent(self, pkgPath: str, failIfMissing: bool=None) -> Union[any]:
    """
    Read the bytes for a given path from this Pkg.Store.
    @see content and readContentString
    """
        ...
    def readContentString(self, pkgPath: str, failIfMissing: bool=None) -> Union[str]:
    """
    read content as a string from this store for a path.
    @see content and readEncodedContent
    """
        ...
    def contents(self, paths: Array[str], failIfMissing: bool=None) -> Union[Map[str, Content]]:
    """
    Reads contents for given paths from this Pkg.Store.
    """
        ...
    @overload
    def readEncodedContents(self, pkgPaths: Array[str], failIfMissing: bool=None) -> Union[Map[str, any]]:
    """
    Reads contents for given paths from this Pkg.Store out as binary.
    """
        ...
    @overload
    def readEncodedContents(self, pathPrefixOrGlob: str, includeDeps: bool=None) -> Union[Map[str, any]]:
    """
    Read contents for pathPrefix Or Glob from this Pkg.Store.
    """
        ...
    def writeEncodedContent(self, pkgPath: str, content: any=None, spec: Pkg.Store.WriteSpec=None) -> None:
    """
    ...
    """
        ...
    def writeContentString(self, pkgPath: str, content: str) -> None:
    """
    ...
    """
        ...
    def writeEncodedContents(self, pathToContent: Map[str, any]=None, spec: Pkg.Store.WriteSpec=None) -> None:
    """
    ...
    """
        ...
    def deleteContent(self, pkgPath: str, confirm: bool=None) -> None:
    """
    Delete given pkg path and content from store.
    """
        ...
    def deleteContents(self, pkgPaths: Array[str], confirm: bool=None) -> None:
    """
    ...
    """
        ...
    def pkgDecl(self, pkgName: str, failIfMissing: bool=None) -> Union[Pkg.Decl]:
    """
    return Pkg.Decl for the given pkgName from this store. Null if Pkg.Decl is missing or contains critical issues.
    """
        ...
    def pkgDeclAndIssues(self, pkgName: str, failIfMissing: bool=None) -> Union[Pair[Pkg.Decl, Pkg.Issue]]:
    """
    return Pkg.Decl for the given pkgName from this store as well as any errors in the Pkg.Decl.
    """
        ...
    @classmethod
    def parsePkgDecl(cls, pkgDecl: str, url: Pkg.Path=None) -> Union[Pair[Pkg.Decl, Pkg.Issue]]:
    """
    ...
    """
        ...
    def pkgDeclPaths(self) -> Union[Set[Pkg.Path]]:
    """
    @return all {@link Pkg.Path}s that point to a serialized {@link Pkg.Decl} (aka .c3pkg.json).
    """
        ...
    def writePkgDecl(self, name: str, dependencies: Map[str, str]=None, spec: Pkg.Store.WriteSpec=None) -> None:
    """
    Write Pkg.Decl with given name and dependencies to store.
    """
        ...
    def readFileFingerprints(self, pkgName: str) -> Union[Map[str, str]]:
    """
    Reads fingerprints from precomputed file-fingerprints file for the given package in this store, if it exists.
    """
        ...
    def computeFingerprint(self, pkgPath: str) -> Union[str]:
    """
    computes fingerprints for given path by reading content from this store.
    """
        ...
    def listPaths(self) -> Union[Stream[Pkg.Path]]:
    """
    @return stream of all paths available in this store.
    """
        ...
    def doWriteEncodedContents(self, update: Map[Pkg.Path, any]=None, remove: Array[Pkg.Path]=None) -> None:
    """
    api to just upsert/remove the content from store. will not do any invalidations.
    """
        ...
    def config(self, secrets: bool=None) -> Pkg.Store.Local.Config:
    """
    ...
    """
        ...
    @classmethod
    def typeConfig(cls) -> Pkg.Store.Local.Config:
    """
    ...
    """
        ...
    @classmethod
    def fromString(cls, s: str) -> Union[Pkg.Store.Local]:
    """
    ...
    """
        ...
    @classmethod
    def forName(cls, name: str, failIfMissing: bool=None) -> Union[Pkg.Store.Local]:
    """
    ...
    """
        ...
    @classmethod
    def configureFor(cls, name: str, localRoot: str) -> Union[Pkg.Store.Local]:
    """
    Setup config for name with local path.
    """
        ...
    
    class Config(Config, Named):
        """
        @remarks this represents a made instance of Pkg.Store.Local.Config
        """
        ...
        """
        local path to read packages. Path can end at folder that has *.c3pkg.json or parent folder up to two levels deep
        that has many packages.
        e.g:  /User/c3.developer/repo/server/common -> [./pacakge.json]
              /User/c3.developer/repo/server ->  [common/pacakge.json],
              /User/c3.developer/all/ ->  [base/foundation/foundation.c3pkg.json, ui/uicommon/uicommon.c3pkg.json]
        """
        def __init__(self, configOverride: Optional[str]=None, secretOverride: Optional[str]=None, issues: Optional[Array[str]]=None, name: Optional[str]=None, localRoot: Optional[str]=None) -> None: ...
        ...
        """
            ...
        @classmethod
        def fromJson(cls, json: any) -> Union[Pkg.Store.Local.Config]:
        """
        Load the JSON-based representation and reconstruct the corresponding object.
        ...
        """
            ...
        @classmethod
        def fromJsonString(cls, json: str) -> Union[Pkg.Store.Local.Config]:
        """
        Load the JSON-based representation and reconstruct the corresponding object.
        ...
        """
            ...
        @classmethod
        def fromXmlString(cls, xml: str) -> Union[Pkg.Store.Local.Config]:
        """
        Load the XML-based representation and reconstruct the corresponding object.
        ...
        """
            ...
        @classmethod
        def deserialize(cls, contentStr: str, contentType: str) -> Union[Pkg.Store.Local.Config]:
        """
        Load from contentType representation and reconstruct the corresponding object.
        ...
        """
            ...
        def replaceType(self, old: Type, new: Type) -> Pkg.Store.Local.Config:
        """
        Returns new instance with all references to old type, including result of #type, replaced with new type. If new
        type does not contain fields from old or field value types are not convertable then drops the field.
        ...
        """
            ...
        @overload
        def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> Pkg.Store.Local.Config:
        """
        Result of this function call is a copy of current instance with all non empty fields replaced based on results of
        the `mapper` invocation.
        ...
        """
            ...
        @overload
        def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> Pkg.Store.Local.Config:
        """
        Result of this function call is a copy of current instance with all fields replaced based on results of the
        `mapper` invocation.
        ...
        """
            ...
        @overload
        def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[Pkg.Store.Local.Config]:
        """
        Result of this function call is a copy of current instance with all non empty fields replaced based on results of
        the asynchronous `mapper` invocation.
        ...
        """
            ...
        @overload
        def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[Pkg.Store.Local.Config]:
        """
        Result of this function call is a copy of current instance with all fields replaced based on results of the
        asynchronous `mapper` invocation.
        ...
        """
            ...
        def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> Pkg.Store.Local.Config:
        """
        Result of this function call is a copy of current instance with specified field value replaced based on result of
        the `mapper` invocation.
        @param field
        ...
        """
            ...
        @overload
        def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> Pkg.Store.Local.Config:
        """
        Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
        lambda application.
        ...
        """
            ...
        @overload
        def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> Pkg.Store.Local.Config:
        """
        Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
        lambda application.
        ...
        """
            ...
        @overload
        def validateObj(self) -> Pkg.Store.Local.Config:
        """
        Populates all missing default values and throws error if any constraint is violated.
        """
            ...
        ...
        """
            ...
        @overload
        def withField(self, field: str, value: Any, doNotConvert: bool=None) -> Pkg.Store.Local.Config:
        """
        Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
        defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
        ...
        """
            ...
        @overload
        def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> Pkg.Store.Local.Config:
        """
        Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
        defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
        ...
        """
            ...
        def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> Pkg.Store.Local.Config:
        """
        Builds a new Obj instance by adding the provided fields in it. The name must correspond to an existing fields
        defined on this type or its mixins. The values must be of the correct type if doNotConvert flag is true.
        ...
        """
            ...
        def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> Pkg.Store.Local.Config:
        """
        Builds a new Obj with the value at the specified path field. If the field is null, the field #isFieldSet to null.
        If you would like to #unsetField, you should call #withoutFieldAtPath instead.
        ...
        """
            ...
        def withoutFieldAtPath(self, path: str) -> Pkg.Store.Local.Config:
        """
        Builds a new Obj without the specified path field.
        ...
        """
            ...
        @overload
        def withoutField(self, field: str) -> Pkg.Store.Local.Config:
        """
        Builds a new Obj, removing the field with the provided name.
        ...
        """
            ...
        @overload
        def withoutField(self, field: FieldType) -> Pkg.Store.Local.Config:
        """
        Builds a new Obj, removing the field with the provided field type.
        ...
        """
            ...
        def withoutFields(self, fields: Array[str]) -> Pkg.Store.Local.Config:
        """
        Builds a new Obj, removing the fields with the provided names.
        ...
        """
            ...
        def withoutFieldsByType(self, fields: Array[FieldType]) -> Pkg.Store.Local.Config:
        """
        Builds a new Obj, removing the fields with the provided field types. Be sure to use the FieldType instance for the
        exact same type as the type of the obj to respect the "ordinal" of the field type
        ...
        """
            ...
        def withoutSecretFields(self) -> Pkg.Store.Local.Config:
        """
        @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
        """
            ...
        ...
        """
            ...
        def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> Pkg.Store.Local.Config:
        """
        Builds a new Obj instance by adding the default values (if defined) for all unset fields. This is implemented by
        calling {@link FieldType#defaultValue defaultValue} for a field if it is not already set and
        {@link FieldType#hasDefault has a default}. It will also set {@see ValueType#initialValue initial values} for
        ...
        """
            ...
        @overload
        def defaultField(self, field: str) -> Pkg.Store.Local.Config:
        """
        Builds a new Obj, by setting a field on this `Obj` to the field's default value. If the field has no default, this
        method will behave the same as {@link #unsetField}.
        ...
        """
            ...
        @overload
        def defaultField(self, field: FieldType) -> Pkg.Store.Local.Config:
        """
        Builds a new Obj, by setting a field on this `Obj` to the fields default value. If the field has no default, this
        method will behave the same as {@link #unsetField}.
        ...
        """
            ...
        @overload
        def unsetField(self, field: str) -> Pkg.Store.Local.Config:
        """
        Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
        is different from {@link removeField}
        ...
        """
            ...
        @overload
        def unsetField(self, field: FieldType) -> Pkg.Store.Local.Config:
        """
        Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
        is different from {@link removeField}
        ...
        """
            ...
        @overload
        def removeField(self, field: str) -> Pkg.Store.Local.Config:
        """
        Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
        is different from {@link #unsetField}
        ...
        """
            ...
        @overload
        def removeField(self, field: FieldType) -> Pkg.Store.Local.Config:
        """
        Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
        is different from {@link #unsetField}
        ...
        """
            ...
        @overload
        def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> Pkg.Store.Local.Config:
        """
        Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
        In case of conflicts, fields of other instance take precedence unless otherwise specified by the fieldPathMergeSpec
        ...
        """
            ...
        @overload
        def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> Pkg.Store.Local.Config:
        """
        Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
        In case of conflicts, fields of other instance take precedence.
        ...
        """
            ...
        @overload
        def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> Pkg.Store.Local.Config:
        """
        Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
        fields that exist on other Obj and do not exist on this Obj will not be added to final Obj.
        @param deep
        ...
        """
            ...
        @overload
        def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> Pkg.Store.Local.Config:
        """
        Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
        fields that exist other Obj and do not exist on this Obj will not be added to final Obj or evaluated. Does not
        traverse child reference and collection fields.
        ...
        """
            ...
        def mergeJson(self, json: any) -> Pkg.Store.Local.Config:
            ...
        def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> Pkg.Store.Local.Config:
        """
        Merge the obj references within the current obj
        @param deep
               If set, traverses the reference fields within the obj as well for a deep merge
        ...
        """
            ...
        def sumObj(self, other: Obj, deep: bool=None) -> Pkg.Store.Local.Config:
        """
        Adds the numeric Obj fields with the other Objs respective fields.
        If deep is set it will traverse reference and collection fields and sum corresponding numeric fields in
        references with same name and collection elements at same index or key.
        """
            ...
        def singletonArray(self) -> Array[Pkg.Store.Local.Config]:
        """
        Build an array of the correct type with a single element which is this instance.
        ...
        """
            ...
        @classmethod
        def array(cls, *elements: Array[Any]) -> Union[Array[Pkg.Store.Local.Config]]:
        """
        Creates an array of instances of this type.
        """
            ...
        @classmethod
        def arrayBuilder(cls) -> Union[ArrayBuilder[Pkg.Store.Local.Config]]:
        """
        Creates an array of instances of this type.
        """
            ...
        def singletonSet(self) -> Set[Pkg.Store.Local.Config]:
        """
        Build an set of the correct type with a single element which is this instance.
        ...
        """
            ...
        @classmethod
        def setBuilder(cls) -> Union[SetBuilder[Pkg.Store.Local.Config]]:
        """
        Creates a set of instances of this type.
        """
            ...
        @classmethod
        def mapBuilder(cls) -> Union[MapBuilder[str, Pkg.Store.Local.Config]]:
        """
        Create a map of string to elements of this type.
        """
            ...
        @classmethod
        def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, Pkg.Store.Local.Config]]:
        """
        Create a map with the given key type and elements of this type.
        """
            ...
        ...
        def myStreamType(cls) -> StreamType:
            ...
        def toBuilder(self) -> ObjBuilder[Pkg.Store.Local.Config]:
        """
        @return new ObjBuilder with initial state set to fields of this instance.
        """
            ...
        @classmethod
        def builder(cls) -> ObjBuilder[Pkg.Store.Local.Config]:
        """
        @return new ObjBuilder of this instance.
        """
            ...
        @overload
        @classmethod
        def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> Pkg.Store.Local.Config:
        """
        Construct instance of this type from provided field values and options
        """
            ...
        @overload
        @classmethod
        def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> Pkg.Store.Local.Config:
        """
        Construct an instance of this type from provided fields
        @param fields
                   Fields to construct the instance of the obj with
        ...
        @overload
        @classmethod
        def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> Pkg.Store.Local.Config:
        """
        Construct instance of this type from provided field values and options
        """
            ...
        @overload
        @classmethod
        def make(cls, withDefaults: bool=None) -> Pkg.Store.Local.Config:
        """
        Construct an instance of this type with no non-default field values unless explicitly specified by passing param true
        @param withDefaults
                   If set, then the Obj is made with default & initial values (required primitive fields e.g. !int32 -> 0)
        ...
        @overload
        @classmethod
        def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> Pkg.Store.Local.Config:
        """
        Construct an instance from provided fields
        @param fields
                   Fields (in the format <field_name, value>) to construct an instance of the obj. Note that "type" as a
        ...
        @overload
        @classmethod
        def make(cls, fields: Any, withDefaults: bool=None) -> Pkg.Store.Local.Config:
        """
        Construct an instance of this type from provided fields. Note it is more efficient to use #fromFields and other overloads
        ...
        @overload
        @classmethod
        def make(cls, s: str) -> Union[Pkg.Store.Local.Config]:
        """
        Construct an instance of this type from the string. This is an alias for #fromString, as a specific overload
        when the argument is a known string.
        ...
        """
            ...
        @classmethod
        def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> Pkg.Store.Local.Config:
        """
        Construct an instance of this type from provided instance of a subtype or a "duck type".
        """
            ...
        ...
        """
            ...
        def afterMake(self) -> Pkg.Store.Local.Config:
        """
        Optional override that will be called after every instance creation.
        ...
        """
            ...
        @classmethod
        def cachedEmptyInst(cls) -> Pkg.Store.Local.Config:
        """
        Creates an empty inst using `MyType.make()` and caches it. Avoid recreating multiple copies of the spec for
        every action dispatch. The cached inst can also be used for comparing whether the object is an empty or not
        Will only create empty instance for immutable Obj e.g. if an Obj is Mutable, this method will throw an error
        ...
        """
            ...
        @classmethod
        def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[Pkg.Store.Local.Config]]:
        """
        Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
        value is read.
        """
            ...
        @classmethod
        def generateObj(cls, spec: Obj.GenerateSpec=None) -> Pkg.Store.Local.Config:
        """
        Generate a single instance of this type. The base implementation uses {@link DataGenObj} to generate uniform
        random (gibberish) values for all fields, but it may be overridden by specific types with custom logic that
        populates fields in a more realistic way.
        ...
        """
            ...
        @classmethod
        def allCached(cls, doNotProduceAll: bool=None) -> Union[Stream[Pkg.Store.Local.Config]]:
        """
        ...
        """
            ...
        @classmethod
        def find(cls, filter: str=None, doNotProduceAll: bool=None) -> Union[Stream[Pkg.Store.Local.Config]]:
        """
        ...
        """
            ...
        @classmethod
        def findBy(cls, field: str, value: Any, doNotProduceAll: bool=None) -> Union[Stream[Pkg.Store.Local.Config]]:
        """
        @param doNotProduceAll if true, will not populate cache and only return available cached instances. Will call
               `produceAll` if cache is empty or if Ann.cache.all is true & data has not previously been fetched.
        @return existing instances of this type that satisfy filter from data cache.
        """
            ...
        @classmethod
        def findByCacheKey(cls, key: str) -> Union[Pkg.Store.Local.Config]:
        """
        ...
        """
            ...
        @classmethod
        def forCacheKey(cls, key: str) -> Union[Pkg.Store.Local.Config]:
        """
        Returns cached instance by key, with secrets removed.
        """
            ...
        def getCached(self) -> Union[Pkg.Store.Local.Config]:
        """
        ...
        """
            ...
        def refreshCache(self) -> Union[Pkg.Store.Local.Config]:
        """
        ...
        """
            ...
        @classmethod
        def produce(cls, key: str) -> Union[Pkg.Store.Local.Config]:
        """
        Should produce an entry for the cache key. This method should not be called directly.
        """
            ...
        @classmethod
        def produceAll(cls) -> Union[Map[str, Pkg.Store.Local.Config]]:
        """
        ...
        """
            ...
        @classmethod
        def doProduceAll(cls) -> Union[Map[str, Pkg.Store.Local.Config]]:
        """
        ...
        """
            ...
        def getConfig(self) -> Pkg.Store.Local.Config:
        """
        ...
        """
            ...
        def getSecret(self) -> Pkg.Store.Local.Config:
        """
        ...
        """
            ...
        @classmethod
        def forConfigKey(cls, configKey: str) -> Union[Pkg.Store.Local.Config]:
        """
        ...
        """
            ...
        @classmethod
        def listConfigs(cls, parallel: bool=None, filter: Callable[[str], bool]=None) -> Union[Stream[Pkg.Store.Local.Config]]:
        """
        @param
        ...
        """
            ...
        @overload
        def setConfigValues(self, from_: Pkg.Store.Local.Config, override: str=None) -> None:
        """
        ...
        """
            ...
        @overload
        def setSecretValues(self, from_: Pkg.Store.Local.Config, override: str=None) -> None:
        """
        ...
        """
            ...
        @classmethod
        def loadConfigAndSecret(cls, configKey: str) -> Union[Pkg.Store.Local.Config]:
        """
        ...
        """
            ...
        def removeSecrets(self) -> Union[Pkg.Store.Local.Config]:
        """
        @return this config without any secret values.
        """
            ...
        def removeNonSecrets(self) -> Union[Pkg.Store.Local.Config]:
        """
        @return this config with only secret values.
        """
            ...
        def validate(self) -> Pkg.Store.Local.Config:
        """
        ...
        """
            ...
        @classmethod
        def fromString(cls, s: str) -> Union[Pkg.Store.Local.Config]:
        """
        Parse the string-based representation and reconstruct the corresponding instance. This must be implemented to
        provide deserialization.
        ...
        """
            ...
        @classmethod
        def forName(cls, name: str, failIfMissing: bool=None) -> Union[Pkg.Store.Local.Config]:
        """
        Get the single instance of this Named Type by name.
        @param name
                The unique name of the instance to retrieve.
