...
# Python definitions for the C3 type SourceCollectionReadTuplesSpec


class SourceCollectionReadTuplesSpec(CloudMessageDispatcherFieldsBase, FileObjsOperSpec, Spec):
    """
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[SourceCollectionReadTuplesSpec]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[SourceCollectionReadTuplesSpec]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[SourceCollectionReadTuplesSpec]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[SourceCollectionReadTuplesSpec]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> SourceCollectionReadTuplesSpec:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> SourceCollectionReadTuplesSpec:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> SourceCollectionReadTuplesSpec:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[SourceCollectionReadTuplesSpec]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[SourceCollectionReadTuplesSpec]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> SourceCollectionReadTuplesSpec:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> SourceCollectionReadTuplesSpec:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> SourceCollectionReadTuplesSpec:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> SourceCollectionReadTuplesSpec:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> SourceCollectionReadTuplesSpec:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> SourceCollectionReadTuplesSpec:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> SourceCollectionReadTuplesSpec:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> SourceCollectionReadTuplesSpec:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> SourceCollectionReadTuplesSpec:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> SourceCollectionReadTuplesSpec:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> SourceCollectionReadTuplesSpec:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> SourceCollectionReadTuplesSpec:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> SourceCollectionReadTuplesSpec:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> SourceCollectionReadTuplesSpec:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> SourceCollectionReadTuplesSpec:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> SourceCollectionReadTuplesSpec:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> SourceCollectionReadTuplesSpec:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> SourceCollectionReadTuplesSpec:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> SourceCollectionReadTuplesSpec:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> SourceCollectionReadTuplesSpec:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> SourceCollectionReadTuplesSpec:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> SourceCollectionReadTuplesSpec:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> SourceCollectionReadTuplesSpec:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> SourceCollectionReadTuplesSpec:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> SourceCollectionReadTuplesSpec:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> SourceCollectionReadTuplesSpec:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> SourceCollectionReadTuplesSpec:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> SourceCollectionReadTuplesSpec:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[SourceCollectionReadTuplesSpec]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[SourceCollectionReadTuplesSpec]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[SourceCollectionReadTuplesSpec]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[SourceCollectionReadTuplesSpec]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[SourceCollectionReadTuplesSpec]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, SourceCollectionReadTuplesSpec]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, SourceCollectionReadTuplesSpec]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[SourceCollectionReadTuplesSpec]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[SourceCollectionReadTuplesSpec]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> SourceCollectionReadTuplesSpec:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> SourceCollectionReadTuplesSpec:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> SourceCollectionReadTuplesSpec:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> SourceCollectionReadTuplesSpec:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> SourceCollectionReadTuplesSpec:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> SourceCollectionReadTuplesSpec:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> SourceCollectionReadTuplesSpec:
    """
    ...
    """
        ...
    def afterMake(self) -> SourceCollectionReadTuplesSpec:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> SourceCollectionReadTuplesSpec:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[SourceCollectionReadTuplesSpec]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> SourceCollectionReadTuplesSpec:
    """
    ...
    """
        ...
    def withRetry(self, maxRetries: int=None, initialSleepMillis: int=None, exponent: float=None) -> Union[SourceCollectionReadTuplesSpec]:
    """
    @return new instance of this spec with `retrySpec` set
    """
        ...
    @classmethod
    def timeoutSeconds(cls, secs: float) -> SourceCollectionReadTuplesSpec:
    """
    @return instance of this spec with `retrySpec`'s `maxTotalMillis` set
    """
        ...
    @classmethod
    def fromType(cls, serType: Type) -> SourceCollectionReadTuplesSpec:
    """
    ...
    """
        ...
    @classmethod
    def toDecrypt(cls) -> Union[SourceCollectionReadTuplesSpec]:
    """
