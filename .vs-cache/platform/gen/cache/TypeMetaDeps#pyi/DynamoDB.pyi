...
from c3.platform.DynamoDBWriteResult import DynamoDBWriteResult
from c3.platform.Include import Include
from c3.platform.DynamoDBQueryResult import DynamoDBQueryResult
from c3.platform.DynamoDBUpdateItemSpec import DynamoDBUpdateItemSpec
...
from c3.platform.DynamoDBQuerySpec import DynamoDBQuerySpec
from c3.platform.WithKey import WithKey
from c3.platform.FieldType import FieldType
from c3.platform.DynamoDBDeleteItemSpec import DynamoDBDeleteItemSpec
from c3.platform.Promise import Promise
from c3.platform.KvStoreCapabilities import KvStoreCapabilities
from c3.platform.DynamoDBTableDescription import DynamoDBTableDescription
from c3.platform.Pair import Pair
from c3.platform.SetBuilder import SetBuilder
from c3.platform.Type import Type
from c3.platform.DynamoDBGetItemResult import DynamoDBGetItemResult
...
from c3.platform.DynamoDBBatchWriteSpec import DynamoDBBatchWriteSpec
from c3.platform.DynamoDBGetItemSpec import DynamoDBGetItemSpec
...
from c3.platform.DynamoDBBatchWriteResult import DynamoDBBatchWriteResult

# Python definitions for the C3 type DynamoDB


class DynamoDB(KvStore[DynamoDBConfig]):
    """
    Lowest level type to interact with dynamo db
    
    @remarks this represents a made instance of DynamoDB
    """
    ...
    **CAUTION** if the objects are partitionable then they should belong for the same partition key
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[DynamoDB]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[DynamoDB]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[DynamoDB]:
    """
    ...
    @overload
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[DynamoDB]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> DynamoDB:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> DynamoDB:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> DynamoDB:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[DynamoDB]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[DynamoDB]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> DynamoDB:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> DynamoDB:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> DynamoDB:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> DynamoDB:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> DynamoDB:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> DynamoDB:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> DynamoDB:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> DynamoDB:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> DynamoDB:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> DynamoDB:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> DynamoDB:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> DynamoDB:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> DynamoDB:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> DynamoDB:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> DynamoDB:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> DynamoDB:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> DynamoDB:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> DynamoDB:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> DynamoDB:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> DynamoDB:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> DynamoDB:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> DynamoDB:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> DynamoDB:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> DynamoDB:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> DynamoDB:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> DynamoDB:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> DynamoDB:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[DynamoDB]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[DynamoDB]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[DynamoDB]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[DynamoDB]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[DynamoDB]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, DynamoDB]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, DynamoDB]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[DynamoDB]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[DynamoDB]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> DynamoDB:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> DynamoDB:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> DynamoDB:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> DynamoDB:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> DynamoDB:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> DynamoDB:
    """
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[DynamoDB]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> DynamoDB:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> DynamoDB:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[DynamoDB]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> DynamoDB:
    """
    ...
    """
        ...
    def config(self, secrets: bool=None) -> DynamoDBConfig:
    """
    ...
    """
        ...
    @classmethod
    def typeConfig(cls) -> DynamoDBConfig:
    """
    ...
    """
        ...
    @classmethod
    def fromString(cls, s: str) -> Union[DynamoDB]:
    """
    ...
    """
        ...
    @classmethod
    def forName(cls, name: str, failIfMissing: bool=None) -> Union[DynamoDB]:
    """
    ...
    """
        ...
    @classmethod
    def allCached(cls, doNotProduceAll: bool=None) -> Union[Stream[DynamoDB]]:
    """
    ...
    """
        ...
    @classmethod
    def find(cls, filter: str=None, doNotProduceAll: bool=None) -> Union[Stream[DynamoDB]]:
    """
    ...
    """
        ...
    @classmethod
    def findBy(cls, field: str, value: Any, doNotProduceAll: bool=None) -> Union[Stream[DynamoDB]]:
    """
    @param doNotProduceAll if true, will not populate cache and only return available cached instances. Will call
           `produceAll` if cache is empty or if Ann.cache.all is true & data has not previously been fetched.
    @return existing instances of this type that satisfy filter from data cache.
    """
        ...
    @classmethod
    def findByCacheKey(cls, key: str) -> Union[DynamoDB]:
    """
    ...
    """
        ...
    @classmethod
    def forCacheKey(cls, key: str) -> Union[DynamoDB]:
    """
    ...
    """
        ...
    def getCached(self) -> Union[DynamoDB]:
    """
    ...
    """
        ...
    def refreshCache(self) -> Union[DynamoDB]:
    """
    ...
    """
        ...
    @classmethod
    def doProduceAll(cls) -> Union[Map[str, DynamoDB]]:
    """
    ...
    **CAUTION** if the objects are partitionable then they should belong for the same partition key
    ...
    """
        ...
    @classmethod
    def listTables(cls, lastEvaluatedName: str=None, count: int=None) -> Union[DynamoDBTables]:
    """
    ...
    """
        ...
    @classmethod
    def describeTable(cls, table: str) -> Union[DynamoDBTableDescription]:
    """
    ...
    """
        ...
    @classmethod
    def createTable(cls, table: str, withRangeKey: bool=None) -> bool:
    """
    ...
    """
        ...
    @classmethod
    def deleteTable(cls, table: str, confirm: bool) -> None:
    """
    ...
    """
        ...
    @classmethod
    def updateTable(cls, table: str, readCapacityUnits: int, writeCapacityUnits: int) -> None:
    """
    ...
    """
        ...
    @classmethod
    def query(cls, table: str, spec: DynamoDBQuerySpec) -> Union[DynamoDBQueryResult]:
    """
    ...
    """
        ...
    @classmethod
    def scanItems(cls, table: str, spec: DynamoDBScanSpec=None) -> Union[DynamoDBQueryResult]:
    """
    ...
    """
        ...
    @classmethod
    def getItem(cls, table: str, spec: DynamoDBGetItemSpec=None) -> Union[DynamoDBGetItemResult]:
    """
    ...
    """
        ...
    @classmethod
    def putItem(cls, table: str, spec: DynamoDBPutItemSpec) -> Union[DynamoDBWriteResult]:
    """
    ...
    """
        ...
    @classmethod
    def updateItem(cls, table: str, spec: DynamoDBUpdateItemSpec) -> Union[DynamoDBWriteResult]:
    """
    ...
    """
        ...
    @classmethod
    def deleteItem(cls, table: str, spec: DynamoDBDeleteItemSpec) -> Union[DynamoDBWriteResult]:
    """
    ...
    """
        ...
    @classmethod
    def batchWriteItem(cls, spec: DynamoDBBatchWriteSpec) -> Union[DynamoDBBatchWriteResult]:
    """
