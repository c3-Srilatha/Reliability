...
from c3.platform.ModelInference.SetRouteSpec import ModelInference.SetRouteSpec
from c3.platform.ModelRegistry.Entry import ModelRegistry.Entry
from c3.platform.ModelInference.Pipeline.DeploySpec import ModelInference.Pipeline.DeploySpec
from c3.platform.ModelInference.StreamRequestInfo import ModelInference.StreamRequestInfo
...
from c3.platform.Promise import Promise
from c3.platform.ModelInference.Summary import ModelInference.Summary
...
from c3.platform.ModelInference.TerminateSpec import ModelInference.TerminateSpec
from c3.platform.MapBuilder import MapBuilder
...
# Python definitions for the C3 type ModelInferenceIface


class ModelInferenceIface(Microservice.Iface):
    """
    Interface for Model Inference
    
    @remarks this represents a made instance of ModelInferenceIface
    """
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[ModelInferenceIface]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[ModelInferenceIface]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[ModelInferenceIface]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[ModelInferenceIface]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> ModelInferenceIface:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> ModelInferenceIface:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> ModelInferenceIface:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[ModelInferenceIface]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[ModelInferenceIface]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> ModelInferenceIface:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> ModelInferenceIface:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> ModelInferenceIface:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> ModelInferenceIface:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> ModelInferenceIface:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> ModelInferenceIface:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> ModelInferenceIface:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> ModelInferenceIface:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> ModelInferenceIface:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> ModelInferenceIface:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> ModelInferenceIface:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> ModelInferenceIface:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> ModelInferenceIface:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> ModelInferenceIface:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> ModelInferenceIface:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> ModelInferenceIface:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> ModelInferenceIface:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> ModelInferenceIface:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> ModelInferenceIface:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> ModelInferenceIface:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> ModelInferenceIface:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> ModelInferenceIface:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> ModelInferenceIface:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> ModelInferenceIface:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> ModelInferenceIface:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> ModelInferenceIface:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> ModelInferenceIface:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> ModelInferenceIface:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[ModelInferenceIface]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[ModelInferenceIface]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[ModelInferenceIface]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[ModelInferenceIface]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[ModelInferenceIface]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, ModelInferenceIface]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, ModelInferenceIface]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[ModelInferenceIface]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[ModelInferenceIface]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> ModelInferenceIface:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> ModelInferenceIface:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> ModelInferenceIface:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> ModelInferenceIface:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> ModelInferenceIface:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> ModelInferenceIface:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> ModelInferenceIface:
    """
    ...
    """
        ...
    def afterMake(self) -> ModelInferenceIface:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> ModelInferenceIface:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[ModelInferenceIface]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> ModelInferenceIface:
    """
