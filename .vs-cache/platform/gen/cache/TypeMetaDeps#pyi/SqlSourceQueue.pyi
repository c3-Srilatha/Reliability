...
# Python definitions for the C3 type SqlSourceQueue


class SqlSourceQueue(SourceQueue, Value):
    """
    Invalidation queue for {@link Sources}
    
    @remarks this represents a made instance of SqlSourceQueue
    """
