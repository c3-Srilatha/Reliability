...
# Python definitions for the C3 type Sources


class Sources(ContentMeta, Identified):
    """
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[Sources]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[Sources]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[Sources]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[Sources]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> Sources:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> Sources:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> Sources:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[Sources]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[Sources]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> Sources:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> Sources:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> Sources:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> Sources:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> Sources:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> Sources:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> Sources:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> Sources:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> Sources:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> Sources:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> Sources:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> Sources:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> Sources:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> Sources:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> Sources:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> Sources:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> Sources:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> Sources:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> Sources:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> Sources:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> Sources:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> Sources:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> Sources:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> Sources:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> Sources:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> Sources:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> Sources:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[Sources]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[Sources]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[Sources]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[Sources]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[Sources]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, Sources]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, Sources]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[Sources]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[Sources]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> Sources:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> Sources:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> Sources:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> Sources:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> Sources:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> Sources:
    """
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[Sources]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> Sources:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> Sources:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[Sources]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> Sources:
    """
    ...
    """
        ...
    def withFileName(self, fileName: str) -> Sources:
    """
    Changes file name in this instance.
    """
        ...
    def withFileExt(self, fileExt: str) -> Sources:
    """
    ...
    """
        ...
    def identify(self, suffix: str=None) -> Sources:
    """
    ...
    """
        ...
    @classmethod
    def fromString(cls, s: str) -> Union[Sources]:
    """
    ...
    """
        ...
    @classmethod
    def forId(cls, id: str, failIfMissing: bool=None) -> Union[Sources]:
    """
    ...
    class PipelineStatus():
        """
        Entity representing the status of a source file as it progresses through a pipeline.
        
        @remarks this represents a made instance of Sources.PipelineStatus
        """
        ...
        state: Optional[str]
        """
        The current state of the source file on corresponding pipeline.
        Possible values refer to {@link SourcesState}
        """
        def __init__(self, id: Optional[str]=None, versionEdits: Optional[Array[VersionEdit]]=None, name: Optional[str]=None, meta: Optional[Meta]=None, version: Optional[int]=None, typeWithBindings: Optional[Type]=None, sourcesId: Optional[str]=None, pipelineId: Optional[str]=None, state: Optional[str]=None) -> None: ...
        ...
        """
            ...
        @classmethod
        def fromJson(cls, json: any) -> Union[Sources.PipelineStatus]:
        """
        Load the JSON-based representation and reconstruct the corresponding object.
        ...
        """
            ...
        @classmethod
        def fromJsonString(cls, json: str) -> Union[Sources.PipelineStatus]:
        """
        Load the JSON-based representation and reconstruct the corresponding object.
        ...
        """
            ...
        @classmethod
        def fromXmlString(cls, xml: str) -> Union[Sources.PipelineStatus]:
        """
        Load the XML-based representation and reconstruct the corresponding object.
        ...
        """
            ...
        @classmethod
        def deserialize(cls, contentStr: str, contentType: str) -> Union[Sources.PipelineStatus]:
        """
        Load from contentType representation and reconstruct the corresponding object.
        ...
        """
            ...
        def replaceType(self, old: Type, new: Type) -> Sources.PipelineStatus:
        """
        Returns new instance with all references to old type, including result of #type, replaced with new type. If new
        type does not contain fields from old or field value types are not convertable then drops the field.
        ...
        """
            ...
        @overload
        def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> Sources.PipelineStatus:
        """
        Result of this function call is a copy of current instance with all non empty fields replaced based on results of
        the `mapper` invocation.
        ...
        """
            ...
        @overload
        def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> Sources.PipelineStatus:
        """
        Result of this function call is a copy of current instance with all fields replaced based on results of the
        `mapper` invocation.
        ...
        """
            ...
        @overload
        def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[Sources.PipelineStatus]:
        """
        Result of this function call is a copy of current instance with all non empty fields replaced based on results of
        the asynchronous `mapper` invocation.
        ...
        """
            ...
        @overload
        def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[Sources.PipelineStatus]:
        """
        Result of this function call is a copy of current instance with all fields replaced based on results of the
        asynchronous `mapper` invocation.
        ...
        """
            ...
        def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> Sources.PipelineStatus:
        """
        Result of this function call is a copy of current instance with specified field value replaced based on result of
        the `mapper` invocation.
        @param field
        ...
        """
            ...
        @overload
        def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> Sources.PipelineStatus:
        """
        Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
        lambda application.
        ...
        """
            ...
        @overload
        def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> Sources.PipelineStatus:
        """
        Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
        lambda application.
        ...
        """
            ...
        @overload
        def validateObj(self) -> Sources.PipelineStatus:
        """
        Populates all missing default values and throws error if any constraint is violated.
        """
            ...
        ...
        """
            ...
        @overload
        def withField(self, field: str, value: Any, doNotConvert: bool=None) -> Sources.PipelineStatus:
        """
        Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
        defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
        ...
        """
            ...
        @overload
        def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> Sources.PipelineStatus:
        """
        Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
        defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
        ...
        """
            ...
        def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> Sources.PipelineStatus:
        """
        Builds a new Obj instance by adding the provided fields in it. The name must correspond to an existing fields
        defined on this type or its mixins. The values must be of the correct type if doNotConvert flag is true.
        ...
        """
            ...
        def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> Sources.PipelineStatus:
        """
        Builds a new Obj with the value at the specified path field. If the field is null, the field #isFieldSet to null.
        If you would like to #unsetField, you should call #withoutFieldAtPath instead.
        ...
        """
            ...
        def withoutFieldAtPath(self, path: str) -> Sources.PipelineStatus:
        """
        Builds a new Obj without the specified path field.
        ...
        """
            ...
        @overload
        def withoutField(self, field: str) -> Sources.PipelineStatus:
        """
        Builds a new Obj, removing the field with the provided name.
        ...
        """
            ...
        @overload
        def withoutField(self, field: FieldType) -> Sources.PipelineStatus:
        """
        Builds a new Obj, removing the field with the provided field type.
        ...
        """
            ...
        def withoutFields(self, fields: Array[str]) -> Sources.PipelineStatus:
        """
        Builds a new Obj, removing the fields with the provided names.
        ...
        """
            ...
        def withoutFieldsByType(self, fields: Array[FieldType]) -> Sources.PipelineStatus:
        """
        Builds a new Obj, removing the fields with the provided field types. Be sure to use the FieldType instance for the
        exact same type as the type of the obj to respect the "ordinal" of the field type
        ...
        """
            ...
        def withoutSecretFields(self) -> Sources.PipelineStatus:
        """
        @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
        """
            ...
        ...
        """
            ...
        def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> Sources.PipelineStatus:
        """
        Builds a new Obj instance by adding the default values (if defined) for all unset fields. This is implemented by
        calling {@link FieldType#defaultValue defaultValue} for a field if it is not already set and
        {@link FieldType#hasDefault has a default}. It will also set {@see ValueType#initialValue initial values} for
        ...
        """
            ...
        @overload
        def defaultField(self, field: str) -> Sources.PipelineStatus:
        """
        Builds a new Obj, by setting a field on this `Obj` to the field's default value. If the field has no default, this
        method will behave the same as {@link #unsetField}.
        ...
        """
            ...
        @overload
        def defaultField(self, field: FieldType) -> Sources.PipelineStatus:
        """
        Builds a new Obj, by setting a field on this `Obj` to the fields default value. If the field has no default, this
        method will behave the same as {@link #unsetField}.
        ...
        """
            ...
        @overload
        def unsetField(self, field: str) -> Sources.PipelineStatus:
        """
        Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
        is different from {@link removeField}
        ...
        """
            ...
        @overload
        def unsetField(self, field: FieldType) -> Sources.PipelineStatus:
        """
        Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
        is different from {@link removeField}
        ...
        """
            ...
        @overload
        def removeField(self, field: str) -> Sources.PipelineStatus:
        """
        Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
        is different from {@link #unsetField}
        ...
        """
            ...
        @overload
        def removeField(self, field: FieldType) -> Sources.PipelineStatus:
        """
        Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
        is different from {@link #unsetField}
        ...
        """
            ...
        @overload
        def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> Sources.PipelineStatus:
        """
        Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
        In case of conflicts, fields of other instance take precedence unless otherwise specified by the fieldPathMergeSpec
        ...
        """
            ...
        @overload
        def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> Sources.PipelineStatus:
        """
        Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
        In case of conflicts, fields of other instance take precedence.
        ...
        """
            ...
        @overload
        def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> Sources.PipelineStatus:
        """
        Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
        fields that exist on other Obj and do not exist on this Obj will not be added to final Obj.
        @param deep
        ...
        """
            ...
        @overload
        def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> Sources.PipelineStatus:
        """
        Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
        fields that exist other Obj and do not exist on this Obj will not be added to final Obj or evaluated. Does not
        traverse child reference and collection fields.
        ...
        """
            ...
        def mergeJson(self, json: any) -> Sources.PipelineStatus:
            ...
        def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> Sources.PipelineStatus:
        """
        Merge the obj references within the current obj
        @param deep
               If set, traverses the reference fields within the obj as well for a deep merge
        ...
        """
            ...
        def sumObj(self, other: Obj, deep: bool=None) -> Sources.PipelineStatus:
        """
        Adds the numeric Obj fields with the other Objs respective fields.
        If deep is set it will traverse reference and collection fields and sum corresponding numeric fields in
        references with same name and collection elements at same index or key.
        """
            ...
        def singletonArray(self) -> Array[Sources.PipelineStatus]:
        """
        Build an array of the correct type with a single element which is this instance.
        ...
        """
            ...
        @classmethod
        def array(cls, *elements: Array[Any]) -> Union[Array[Sources.PipelineStatus]]:
        """
        Creates an array of instances of this type.
        """
            ...
        @classmethod
        def arrayBuilder(cls) -> Union[ArrayBuilder[Sources.PipelineStatus]]:
        """
        Creates an array of instances of this type.
        """
            ...
        def singletonSet(self) -> Set[Sources.PipelineStatus]:
        """
        Build an set of the correct type with a single element which is this instance.
        ...
        """
            ...
        @classmethod
        def setBuilder(cls) -> Union[SetBuilder[Sources.PipelineStatus]]:
        """
        Creates a set of instances of this type.
        """
            ...
        @classmethod
        def mapBuilder(cls) -> Union[MapBuilder[str, Sources.PipelineStatus]]:
        """
        Create a map of string to elements of this type.
        """
            ...
        @classmethod
        def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, Sources.PipelineStatus]]:
        """
        Create a map with the given key type and elements of this type.
        """
            ...
        ...
        def myStreamType(cls) -> StreamType:
            ...
        def toBuilder(self) -> ObjBuilder[Sources.PipelineStatus]:
        """
        @return new ObjBuilder with initial state set to fields of this instance.
        """
            ...
        @classmethod
        def builder(cls) -> ObjBuilder[Sources.PipelineStatus]:
        """
        @return new ObjBuilder of this instance.
        """
            ...
        @overload
        @classmethod
        def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> Sources.PipelineStatus:
        """
        Construct instance of this type from provided field values and options
        """
            ...
        @overload
        @classmethod
        def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> Sources.PipelineStatus:
        """
        Construct an instance of this type from provided fields
        @param fields
                   Fields to construct the instance of the obj with
        ...
        @overload
        @classmethod
        def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> Sources.PipelineStatus:
        """
        Construct instance of this type from provided field values and options
        """
            ...
        @overload
        @classmethod
        def make(cls, withDefaults: bool=None) -> Sources.PipelineStatus:
        """
        Construct an instance of this type with no non-default field values unless explicitly specified by passing param true
        @param withDefaults
                   If set, then the Obj is made with default & initial values (required primitive fields e.g. !int32 -> 0)
        ...
        @overload
        @classmethod
        def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> Sources.PipelineStatus:
        """
        Construct an instance from provided fields
        @param fields
                   Fields (in the format <field_name, value>) to construct an instance of the obj. Note that "type" as a
        ...
        @overload
        @classmethod
        def make(cls, fields: Any, withDefaults: bool=None) -> Sources.PipelineStatus:
        """
        Construct an instance of this type from provided fields. Note it is more efficient to use #fromFields and other overloads
        ...
        @overload
        @classmethod
        def make(cls, s: str) -> Union[Sources.PipelineStatus]:
        """
        Construct an instance of this type from the string. This is an alias for #fromString, as a specific overload
        when the argument is a known string.
        ...
        """
            ...
        @classmethod
        def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> Sources.PipelineStatus:
        """
        Construct an instance of this type from provided instance of a subtype or a "duck type".
        """
            ...
        ...
        """
            ...
        def afterMake(self) -> Sources.PipelineStatus:
        """
        Optional override that will be called after every instance creation.
        ...
        """
            ...
        @classmethod
        def cachedEmptyInst(cls) -> Sources.PipelineStatus:
        """
        Creates an empty inst using `MyType.make()` and caches it. Avoid recreating multiple copies of the spec for
        every action dispatch. The cached inst can also be used for comparing whether the object is an empty or not
        Will only create empty instance for immutable Obj e.g. if an Obj is Mutable, this method will throw an error
        ...
        """
            ...
        @classmethod
        def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[Sources.PipelineStatus]]:
        """
        Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
        value is read.
        """
            ...
        @classmethod
        def generateObj(cls, spec: Obj.GenerateSpec=None) -> Sources.PipelineStatus:
        """
        Generate a single instance of this type. The base implementation uses {@link DataGenObj} to generate uniform
        random (gibberish) values for all fields, but it may be overridden by specific types with custom logic that
        populates fields in a more realistic way.
        ...
        @overload
        @classmethod
        def fetch(cls, spec: FetchSpec=None) -> FetchResult[Sources.PipelineStatus]:
        """
        ...
        @overload
        @classmethod
        def fetch(cls, filter: Filter) -> FetchResult[Sources.PipelineStatus]:
        """
        ...
        """
            ...
        @classmethod
        def fetchObjStream(cls, spec: FetchStreamSpec=None) -> Union[Stream[Sources.PipelineStatus]]:
        """
        Fetches multiple obj instances based on a specification.  Only objs that the caller is authorized to fetch will be
        returned.
        ...
        """
            ...
        @classmethod
        def fetchMultiLocale(cls, spec: MultiLocaleFetchSpec=None) -> Union[Map[str, FetchResult[Sources.PipelineStatus]]]:
        """
        ...
        """
            ...
        def get(self, include: str=None) -> Union[Sources.PipelineStatus]:
        """
        ...
        """
            ...
        def getSpecific(self, include: str=None) -> Union[Sources.PipelineStatus]:
        """
        ...
        """
            ...
        def getMissing(self, spec: GetMissingSpec) -> Sources.PipelineStatus:
        """
        ...
        """
            ...
        def getDirect(self, include: str=None) -> Union[Sources.PipelineStatus]:
        """
        ...
        """
            ...
        def applyReverseEdit(self, versionEdit: VersionEdit) -> Sources.PipelineStatus:
        """
        ...
        """
            ...
        @classmethod
        def fromString(cls, s: str) -> Union[Sources.PipelineStatus]:
        """
        Parse the string-based representation and reconstruct the corresponding instance. This must be implemented to
        provide deserialization.
        ...
        """
            ...
        def create(self, spec: UpsertSpec=None) -> Union[Sources.PipelineStatus]:
        """
        ...
        """
            ...
        @classmethod
        def createBatch(cls, objs: Array[Sources.PipelineStatus], spec: UpsertSpec=None) -> Union[ObjList[Sources.PipelineStatus]]:
        """
        ...
        """
            ...
        @classmethod
        def createBatchObjStream(cls, objs: Stream[Sources.PipelineStatus], spec: CreateBatchObjStreamSpec=None) -> Union[ObjList[Sources.PipelineStatus]]:
        """
        Creates multiple instances of a C3 type. If the operation fails and {@link UpsertSpec#dontThrowOnBatchError} is not
        specified (the default), then a C3BatchException will be thrown.  Otherwise {@link errors will be reported in the
        returned {@link ObjList}.  This will fail if any of the instances already exist.
        ...
        """
            ...
        def update(self, srcObj: Sources.PipelineStatus=None, spec: UpsertSpec=None) -> Union[Sources.PipelineStatus]:
        """
        ...
        """
            ...
        def upsert(self, srcObj: Sources.PipelineStatus=None, spec: UpsertSpec=None) -> Union[Sources.PipelineStatus]:
        """
        ...
        """
            ...
        @overload
        def merge(self, spec: MergeSpec=None) -> Union[Sources.PipelineStatus]:
        """
        ...
        """
            ...
        @overload
        def merge(self, mergeInclude: str, spec: MergeSpec=None) -> Union[Sources.PipelineStatus]:
        """
        ...
        """
            ...
        def touch(self, spec: TouchSpec=None) -> Union[Sources.PipelineStatus]:
        """
        ...
        """
            ...
        @classmethod
        def updateBatch(cls, objs: Array[Sources.PipelineStatus], srcObjs: Array[Sources.PipelineStatus]=None, spec: UpsertSpec=None) -> Union[ObjList[Sources.PipelineStatus]]:
        """
        ...
        """
            ...
        @classmethod
        def updateObjs(cls, objs: Callable[[], Union[Array[Sources.PipelineStatus]]], spec: UpsertSpec=None) -> Union[ObjList[Sources.PipelineStatus]]:
        """
        ...
        """
            ...
        @classmethod
        def upsertBatch(cls, objs: Array[Sources.PipelineStatus], srcObjs: Array[Sources.PipelineStatus]=None, spec: UpsertSpec=None) -> Union[ObjList[Sources.PipelineStatus]]:
        """
        ...
        """
            ...
        @classmethod
        def upsertObjs(cls, objs: Callable[[], Union[Array[Sources.PipelineStatus]]], spec: UpsertSpec=None) -> Union[ObjList[Sources.PipelineStatus]]:
        """
        Creates instances of a C3 type if they don't already exist and updates them if they do exist. If the operation
        ...
        """
            ...
        @classmethod
        def touchBatch(cls, objs: Array[Sources.PipelineStatus], spec: TouchSpec=None) -> Union[ObjList[Sources.PipelineStatus]]:
        """
        ...
        @overload
        @classmethod
        def mergeBatch(cls, objs: Array[Sources.PipelineStatus], spec: MergeSpec=None) -> Union[ObjList[Sources.PipelineStatus]]:
        """
        ...
        @overload
        @classmethod
        def mergeBatch(cls, objs: Array[Sources.PipelineStatus], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[Sources.PipelineStatus]]:
        """
        Merges multiple instances of a C3 type or creates them if they don't exist. If the operation fails and {@link
        UpsertSpec#dontThrowOnBatchError} is not specified (the default), then a C3BatchException will be thrown.
        Otherwise errors will be reported in the returned {@link ObjList}.  The merge operation is described in the {@link
        ...
        """
            ...
        @classmethod
        def mergeObjs(cls, objs: Callable[[], Union[Array[Sources.PipelineStatus]]], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[Sources.PipelineStatus]]:
        """
        ...
        @overload
        @classmethod
        def mergeAll(cls, mergeObj: Sources.PipelineStatus, spec: MergeAllSpec=None) -> Union[int]:
        """
        ...
        @overload
        @classmethod
        def mergeAll(cls, mergeObj: Sources.PipelineStatus, mergeInclude: str, spec: MergeAllSpec=None) -> Union[int]:
        """
        ...
        """
            ...
        @classmethod
        def removeBatch(cls, objs: Array[Sources.PipelineStatus], spec: UpsertSpec=None) -> Union[ObjList[Sources.PipelineStatus]]:
        """
        ...
        """
            ...
        @classmethod
        def replace(cls, objs: Array[Sources.PipelineStatus], spec: UpsertSpec=None) -> Union[ObjList[Sources.PipelineStatus]]:
        """
        ...
        """
            ...
        def unremove(self) -> Union[Sources.PipelineStatus]:
        """
        ...
        """
            ...
        @classmethod
        def beforeCreate(cls, objs: Array[Sources.PipelineStatus]) -> ObjList[Sources.PipelineStatus]:
        """
        ...
        """
            ...
        @classmethod
        def beforeUpdate(cls, objs: Array[Sources.PipelineStatus]) -> ObjList[Sources.PipelineStatus]:
        """
        ...
        """
            ...
        @classmethod
        def beforeRemove(cls, objs: Array[Sources.PipelineStatus]) -> ObjList[Sources.PipelineStatus]:
        """
        ...
        """
            ...
        @classmethod
        def afterCreate(cls, objs: Array[Sources.PipelineStatus]) -> Union[Array[ObjError]]:
        """
        ...
        """
            ...
        @classmethod
        def afterUpdate(cls, objs: Array[Sources.PipelineStatus]) -> Union[Array[ObjError]]:
        """
        ...
        """
            ...
        @classmethod
        def afterRemove(cls, objs: Array[Sources.PipelineStatus]) -> Union[Array[ObjError]]:
        """
        ...
        """
            ...
        @classmethod
        def startImportData(cls, spec: StartImportDataSpec=None) -> PushStream[Sources.PipelineStatus]:
        """
        @return a push stream to import instances of this type.
        """
            ...
        @classmethod
        def startImportDataWithStats(cls, spec: StartImportDataSpec=None) -> PushStreamWithStats[Sources.PipelineStatus]:
        """
        @return a push stream to import instances of this type.
        """
            ...
        ...
        """
            ...
        @classmethod
        def forId(cls, id: str, failIfMissing: bool=None) -> Union[Sources.PipelineStatus]:
        """
        ...
        """
            ...
        def withoutIdentity(self) -> Union[Sources.PipelineStatus]:
        """
        ...
        """
            ...
        @classmethod
        def typeOfBatch(cls, objs: Array[Sources.PipelineStatus]) -> Union[Array[EntityType]]:
        """
        ...
        """
            ...
        @classmethod
        def dbEcho(cls, template: Sources.PipelineStatus=None, count: int=None, sendBack: bool=None) -> Union[int]:
        """
        ...
        """
            ...
        @classmethod
        def callbackLogic(cls, objs: Array[Sources.PipelineStatus], callback: Callable[[Union[Sources.PipelineStatus]], Union[Sources.PipelineStatus]]=None) -> ObjList[Sources.PipelineStatus]:
        """
        ...
        """
            ...
        @classmethod
        def afterCallbackLogic(cls, objs: Array[Sources.PipelineStatus], callback: Callable[[Union[Sources.PipelineStatus]], Union[Sources.PipelineStatus]]=None) -> Union[Array[ObjError]]:
        """
        ...
        def sources(self) -> Sources:
            ...
        def pipeline(self) -> DataInteg.Pipeline:
            ...
        def safeId(self) -> str:
        """
        @return The unique id that is safe to be used as {@link Persistable#id} value
        The ID will always be at most 128 characters to meet the DB restriction.
        """
            ...
        @classmethod
        def init(cls, pipelineId: str=None) -> None:
        """
        Initializes the status for the specified pipeline.
        
        This function will:
        1. Delete all existing status entries for specified pipeline
        2. Fetch all the sources and init the state for each sources
        
        @param pipelineId
               The ID of the pipeline to initialize
        """
            ...
