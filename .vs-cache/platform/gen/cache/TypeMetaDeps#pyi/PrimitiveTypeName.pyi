...
# Python definitions for the C3 type PrimitiveTypeName
...
class PrimitiveTypeName():
    ...
    INT16: Optional[str]=None

    INT32: Optional[str]=None
    ...
    """
    def __init__(self, BINARY: Optional[str]=None, BOOLEAN: Optional[str]=None, BYTE: Optional[str]=None, DATE_TIME: Optional[str]=None, DECIMAL: Optional[str]=None, DOUBLE: Optional[str]=None, FLOAT: Optional[str]=None, INT: Optional[str]=None, INT16: Optional[str]=None, INT32: Optional[str]=None, BIGINT: Optional[str]=None, JSON: Optional[str]=None, NUMBER: Optional[str]=None, STRING: Optional[str]=None, DATE_ONLY: Optional[str]=None) -> None: ...
