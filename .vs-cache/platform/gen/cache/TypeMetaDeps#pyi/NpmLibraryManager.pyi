...
from c3.platform.Js.Runtime import Js.Runtime
...
# Python definitions for the C3 type NpmLibraryManager


class NpmLibraryManager(LibraryManager[NpmLibraryManager.Config, Js.Runtime]):
    """
    ...
    @remarks this represents a made instance of NpmLibraryManager
    """
    ...
    def __init__(self, name: Optional[str]=None, CONDA: Optional[str]=None, NPM: Optional[str]=None, PACKAGE_LOCK_JSON: Optional[str]=None, PACKAGE_JSON: Optional[str]=None) -> None: ...
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[NpmLibraryManager]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[NpmLibraryManager]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[NpmLibraryManager]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[NpmLibraryManager]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> NpmLibraryManager:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> NpmLibraryManager:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> NpmLibraryManager:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[NpmLibraryManager]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[NpmLibraryManager]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> NpmLibraryManager:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> NpmLibraryManager:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> NpmLibraryManager:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> NpmLibraryManager:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> NpmLibraryManager:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> NpmLibraryManager:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> NpmLibraryManager:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> NpmLibraryManager:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> NpmLibraryManager:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> NpmLibraryManager:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> NpmLibraryManager:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> NpmLibraryManager:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> NpmLibraryManager:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> NpmLibraryManager:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> NpmLibraryManager:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> NpmLibraryManager:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> NpmLibraryManager:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> NpmLibraryManager:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> NpmLibraryManager:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> NpmLibraryManager:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> NpmLibraryManager:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> NpmLibraryManager:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> NpmLibraryManager:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> NpmLibraryManager:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> NpmLibraryManager:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> NpmLibraryManager:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> NpmLibraryManager:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> NpmLibraryManager:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[NpmLibraryManager]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[NpmLibraryManager]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[NpmLibraryManager]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[NpmLibraryManager]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[NpmLibraryManager]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, NpmLibraryManager]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, NpmLibraryManager]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[NpmLibraryManager]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[NpmLibraryManager]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> NpmLibraryManager:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> NpmLibraryManager:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> NpmLibraryManager:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> NpmLibraryManager:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> NpmLibraryManager:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> NpmLibraryManager:
    """
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[NpmLibraryManager]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> NpmLibraryManager:
    """
    ...
    """
        ...
    def afterMake(self) -> NpmLibraryManager:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> NpmLibraryManager:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[NpmLibraryManager]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> NpmLibraryManager:
    """
    ...
    """
        ...
    @classmethod
    def fromString(cls, s: str) -> Union[NpmLibraryManager]:
    """
    ...
    """
        ...
    @classmethod
    def forName(cls, name: str, failIfMissing: bool=None) -> Union[NpmLibraryManager]:
    """
    ...
    """
        ...
    @classmethod
    def typeConfig(cls) -> NpmLibraryManager.Config:
    """
    @return type configuration for the given {@link Configurable} type.
    E.g. {@see REST} & {@see RestConfig}
    """
        ...
    def resolveRuntime(self, runtime: ImplLanguage.Runtime, doNotValidate: bool=None) -> Js.Runtime:
    """
    ...
    """
        ...
    def installRuntime(self, runtime: Js.Runtime, overridePath: str=None) -> None:
    """
    ...
    """
        ...
    def uninstallRuntime(self, runtime: Js.Runtime) -> None:
    """
    ...
    """
        ...
    def isInstalled(self, runtime: Js.Runtime) -> bool:
    """
    ...
    """
        ...
    @overload
    def packageJsonForRuntime(self, runtime: Js.Runtime) -> Union[any]:
    """
    ...
    """
        ...
    @overload
    def packageJsonForRuntime(self, runtime: Js.Runtime, hostUrl: str=None) -> Union[any]:
    """
    Generate package.json object for the given {@link Js.Runtime}, which includes all libraries based on all its parent runtimes {@link ImplLanguage.Runtime#allLibraries}.
    It also modifies URLs that contain {{HOST_URL}} with the given url.
    """
        ...
    def envVarWithNpmConfigRegistry(self, runtime: Js.Runtime) -> Union[Map[str, str]]:
    """
    ...
    """
        ...
    def ensureRuntimeInstalled(self, runtime: Js.Runtime, overridePath: str=None) -> Union[Promise[bool]]:
    """
    ...
    """
        ...
    def mergedRuntime(self, runtimeName: str, callFromCluster: bool=None) -> Union[Js.Runtime]:
    """
    @param callFromCluster
    ...
    """
        ...
    @classmethod
    def removeC3ReferencesFromPackageLock(cls, packageLock: any=None) -> Union[any]:
    """
    Removes @c3 library references from package-lock.json.
    """
        ...
    @classmethod
    def nodeVersion(cls) -> Union[str]:
    """
    Gets the installed NodeJS version
    """
        ...
    @classmethod
    def npmVersion(cls) -> Union[str]:
    """
    Gets the installed NPM version
    """
        ...
    def npmRegistryUrl(self, callFromCluster: bool=None) -> str:
    """
    @param callFromCluster
           True if method called server-side, else false
    ...
    """
        ...
    def modifiedPackageLock(self, packageLock: any=None, callFromCluster: bool=None, urlToReplace: str='\'https://registry.npmjs.org/\'') -> Union[any]:
    """
    ...
    """
        ...
    @classmethod
    def splitLibraryName(cls, libraryName: str=None) -> Union[Array[str]]:
    """
    ...
    class Config(LibraryManager.Config):
        """
        Type for specifying different configurations used by {@link NpmLibraryManager}.
        
        @remarks this represents a made instance of NpmLibraryManager.Config
        """
        ...
        def __init__(self, configOverride: Optional[str]=None, secretOverride: Optional[str]=None, issues: Optional[Array[str]]=None, useArtifactHub: Optional[bool]=None, username: Optional[str]=None, password: Optional[str]=None, registry: Optional[str]=None) -> None: ...
        ...
        """
            ...
        @classmethod
        def fromJson(cls, json: any) -> Union[NpmLibraryManager.Config]:
        """
        Load the JSON-based representation and reconstruct the corresponding object.
        ...
        """
            ...
        @classmethod
        def fromJsonString(cls, json: str) -> Union[NpmLibraryManager.Config]:
        """
        Load the JSON-based representation and reconstruct the corresponding object.
        ...
        """
            ...
        @classmethod
        def fromXmlString(cls, xml: str) -> Union[NpmLibraryManager.Config]:
        """
        Load the XML-based representation and reconstruct the corresponding object.
        ...
        """
            ...
        @classmethod
        def deserialize(cls, contentStr: str, contentType: str) -> Union[NpmLibraryManager.Config]:
        """
        Load from contentType representation and reconstruct the corresponding object.
        ...
        """
            ...
        def replaceType(self, old: Type, new: Type) -> NpmLibraryManager.Config:
        """
        Returns new instance with all references to old type, including result of #type, replaced with new type. If new
        type does not contain fields from old or field value types are not convertable then drops the field.
        ...
        """
            ...
        @overload
        def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> NpmLibraryManager.Config:
        """
        Result of this function call is a copy of current instance with all non empty fields replaced based on results of
        the `mapper` invocation.
        ...
        """
            ...
        @overload
        def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> NpmLibraryManager.Config:
        """
        Result of this function call is a copy of current instance with all fields replaced based on results of the
        `mapper` invocation.
        ...
        """
            ...
        @overload
        def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[NpmLibraryManager.Config]:
        """
        Result of this function call is a copy of current instance with all non empty fields replaced based on results of
        the asynchronous `mapper` invocation.
        ...
        """
            ...
        @overload
        def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[NpmLibraryManager.Config]:
        """
        Result of this function call is a copy of current instance with all fields replaced based on results of the
        asynchronous `mapper` invocation.
        ...
        """
            ...
        def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> NpmLibraryManager.Config:
        """
        Result of this function call is a copy of current instance with specified field value replaced based on result of
        the `mapper` invocation.
        @param field
        ...
        """
            ...
        @overload
        def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> NpmLibraryManager.Config:
        """
        Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
        lambda application.
        ...
        """
            ...
        @overload
        def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> NpmLibraryManager.Config:
        """
        Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
        lambda application.
        ...
        """
            ...
        @overload
        def validateObj(self) -> NpmLibraryManager.Config:
        """
        Populates all missing default values and throws error if any constraint is violated.
        """
            ...
        ...
        """
            ...
        @overload
        def withField(self, field: str, value: Any, doNotConvert: bool=None) -> NpmLibraryManager.Config:
        """
        Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
        defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
        ...
        """
            ...
        @overload
        def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> NpmLibraryManager.Config:
        """
        Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
        defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
        ...
        """
            ...
        def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> NpmLibraryManager.Config:
        """
        Builds a new Obj instance by adding the provided fields in it. The name must correspond to an existing fields
        defined on this type or its mixins. The values must be of the correct type if doNotConvert flag is true.
        ...
        """
            ...
        def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> NpmLibraryManager.Config:
        """
        Builds a new Obj with the value at the specified path field. If the field is null, the field #isFieldSet to null.
        If you would like to #unsetField, you should call #withoutFieldAtPath instead.
        ...
        """
            ...
        def withoutFieldAtPath(self, path: str) -> NpmLibraryManager.Config:
        """
        Builds a new Obj without the specified path field.
        ...
        """
            ...
        @overload
        def withoutField(self, field: str) -> NpmLibraryManager.Config:
        """
        Builds a new Obj, removing the field with the provided name.
        ...
        """
            ...
        @overload
        def withoutField(self, field: FieldType) -> NpmLibraryManager.Config:
        """
        Builds a new Obj, removing the field with the provided field type.
        ...
        """
            ...
        def withoutFields(self, fields: Array[str]) -> NpmLibraryManager.Config:
        """
        Builds a new Obj, removing the fields with the provided names.
        ...
        """
            ...
        def withoutFieldsByType(self, fields: Array[FieldType]) -> NpmLibraryManager.Config:
        """
        Builds a new Obj, removing the fields with the provided field types. Be sure to use the FieldType instance for the
        exact same type as the type of the obj to respect the "ordinal" of the field type
        ...
        """
            ...
        def withoutSecretFields(self) -> NpmLibraryManager.Config:
        """
        @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
        """
            ...
        ...
        """
            ...
        def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> NpmLibraryManager.Config:
        """
        Builds a new Obj instance by adding the default values (if defined) for all unset fields. This is implemented by
        calling {@link FieldType#defaultValue defaultValue} for a field if it is not already set and
        {@link FieldType#hasDefault has a default}. It will also set {@see ValueType#initialValue initial values} for
        ...
        """
            ...
        @overload
        def defaultField(self, field: str) -> NpmLibraryManager.Config:
        """
        Builds a new Obj, by setting a field on this `Obj` to the field's default value. If the field has no default, this
        method will behave the same as {@link #unsetField}.
        ...
        """
            ...
        @overload
        def defaultField(self, field: FieldType) -> NpmLibraryManager.Config:
        """
        Builds a new Obj, by setting a field on this `Obj` to the fields default value. If the field has no default, this
        method will behave the same as {@link #unsetField}.
        ...
        """
            ...
        @overload
        def unsetField(self, field: str) -> NpmLibraryManager.Config:
        """
        Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
        is different from {@link removeField}
        ...
        """
            ...
        @overload
        def unsetField(self, field: FieldType) -> NpmLibraryManager.Config:
        """
        Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
        is different from {@link removeField}
        ...
        """
            ...
        @overload
        def removeField(self, field: str) -> NpmLibraryManager.Config:
        """
        Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
        is different from {@link #unsetField}
        ...
        """
            ...
        @overload
        def removeField(self, field: FieldType) -> NpmLibraryManager.Config:
        """
        Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
        is different from {@link #unsetField}
        ...
        """
            ...
        @overload
        def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> NpmLibraryManager.Config:
        """
        Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
        In case of conflicts, fields of other instance take precedence unless otherwise specified by the fieldPathMergeSpec
        ...
        """
            ...
        @overload
        def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> NpmLibraryManager.Config:
        """
        Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
        In case of conflicts, fields of other instance take precedence.
        ...
        """
            ...
        @overload
        def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> NpmLibraryManager.Config:
        """
        Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
        fields that exist on other Obj and do not exist on this Obj will not be added to final Obj.
        @param deep
        ...
        """
            ...
        @overload
        def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> NpmLibraryManager.Config:
        """
        Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
        fields that exist other Obj and do not exist on this Obj will not be added to final Obj or evaluated. Does not
        traverse child reference and collection fields.
        ...
        """
            ...
        def mergeJson(self, json: any) -> NpmLibraryManager.Config:
            ...
        def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> NpmLibraryManager.Config:
        """
        Merge the obj references within the current obj
        @param deep
               If set, traverses the reference fields within the obj as well for a deep merge
        ...
        """
            ...
        def sumObj(self, other: Obj, deep: bool=None) -> NpmLibraryManager.Config:
        """
        Adds the numeric Obj fields with the other Objs respective fields.
        If deep is set it will traverse reference and collection fields and sum corresponding numeric fields in
        references with same name and collection elements at same index or key.
        """
            ...
        def singletonArray(self) -> Array[NpmLibraryManager.Config]:
        """
        Build an array of the correct type with a single element which is this instance.
        ...
        """
            ...
        @classmethod
        def array(cls, *elements: Array[Any]) -> Union[Array[NpmLibraryManager.Config]]:
        """
        Creates an array of instances of this type.
        """
            ...
        @classmethod
        def arrayBuilder(cls) -> Union[ArrayBuilder[NpmLibraryManager.Config]]:
        """
        Creates an array of instances of this type.
        """
            ...
        def singletonSet(self) -> Set[NpmLibraryManager.Config]:
        """
        Build an set of the correct type with a single element which is this instance.
        ...
        """
            ...
        @classmethod
        def setBuilder(cls) -> Union[SetBuilder[NpmLibraryManager.Config]]:
        """
        Creates a set of instances of this type.
        """
            ...
        @classmethod
        def mapBuilder(cls) -> Union[MapBuilder[str, NpmLibraryManager.Config]]:
        """
        Create a map of string to elements of this type.
        """
            ...
        @classmethod
        def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, NpmLibraryManager.Config]]:
        """
        Create a map with the given key type and elements of this type.
        """
            ...
        ...
        def myStreamType(cls) -> StreamType:
            ...
        def toBuilder(self) -> ObjBuilder[NpmLibraryManager.Config]:
        """
        @return new ObjBuilder with initial state set to fields of this instance.
        """
            ...
        @classmethod
        def builder(cls) -> ObjBuilder[NpmLibraryManager.Config]:
        """
        @return new ObjBuilder of this instance.
        """
            ...
        @overload
        @classmethod
        def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> NpmLibraryManager.Config:
        """
        Construct instance of this type from provided field values and options
        """
            ...
        @overload
        @classmethod
        def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> NpmLibraryManager.Config:
        """
        Construct an instance of this type from provided fields
        @param fields
                   Fields to construct the instance of the obj with
        ...
        @overload
        @classmethod
        def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> NpmLibraryManager.Config:
        """
        Construct instance of this type from provided field values and options
        """
            ...
        @overload
        @classmethod
        def make(cls, withDefaults: bool=None) -> NpmLibraryManager.Config:
        """
        Construct an instance of this type with no non-default field values unless explicitly specified by passing param true
        @param withDefaults
                   If set, then the Obj is made with default & initial values (required primitive fields e.g. !int32 -> 0)
        ...
        @overload
        @classmethod
        def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> NpmLibraryManager.Config:
        """
        Construct an instance from provided fields
        @param fields
                   Fields (in the format <field_name, value>) to construct an instance of the obj. Note that "type" as a
        ...
        @overload
        @classmethod
        def make(cls, fields: Any, withDefaults: bool=None) -> NpmLibraryManager.Config:
        """
        Construct an instance of this type from provided fields. Note it is more efficient to use #fromFields and other overloads
        ...
        """
            ...
        @classmethod
        def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> NpmLibraryManager.Config:
        """
        Construct an instance of this type from provided instance of a subtype or a "duck type".
        """
            ...
        ...
        """
            ...
        def afterMake(self) -> NpmLibraryManager.Config:
        """
        Optional override that will be called after every instance creation.
        ...
        """
            ...
        @classmethod
        def cachedEmptyInst(cls) -> NpmLibraryManager.Config:
        """
        Creates an empty inst using `MyType.make()` and caches it. Avoid recreating multiple copies of the spec for
        every action dispatch. The cached inst can also be used for comparing whether the object is an empty or not
        Will only create empty instance for immutable Obj e.g. if an Obj is Mutable, this method will throw an error
        ...
        """
            ...
        @classmethod
        def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[NpmLibraryManager.Config]]:
        """
        Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
        value is read.
        """
            ...
        @classmethod
        def generateObj(cls, spec: Obj.GenerateSpec=None) -> NpmLibraryManager.Config:
        """
        Generate a single instance of this type. The base implementation uses {@link DataGenObj} to generate uniform
        random (gibberish) values for all fields, but it may be overridden by specific types with custom logic that
        populates fields in a more realistic way.
        ...
        """
            ...
        @classmethod
        def allCached(cls, doNotProduceAll: bool=None) -> Union[Stream[NpmLibraryManager.Config]]:
        """
        ...
        """
            ...
        @classmethod
        def find(cls, filter: str=None, doNotProduceAll: bool=None) -> Union[Stream[NpmLibraryManager.Config]]:
        """
        ...
        """
            ...
        @classmethod
        def findBy(cls, field: str, value: Any, doNotProduceAll: bool=None) -> Union[Stream[NpmLibraryManager.Config]]:
        """
        @param doNotProduceAll if true, will not populate cache and only return available cached instances. Will call
               `produceAll` if cache is empty or if Ann.cache.all is true & data has not previously been fetched.
        @return existing instances of this type that satisfy filter from data cache.
        """
            ...
        @classmethod
        def findByCacheKey(cls, key: str) -> Union[NpmLibraryManager.Config]:
        """
        ...
        """
            ...
        @classmethod
        def forCacheKey(cls, key: str) -> Union[NpmLibraryManager.Config]:
        """
        Returns cached instance by key, with secrets removed.
        """
            ...
        def getCached(self) -> Union[NpmLibraryManager.Config]:
        """
        ...
        """
            ...
        def refreshCache(self) -> Union[NpmLibraryManager.Config]:
        """
        ...
        """
            ...
        @classmethod
        def produce(cls, key: str) -> Union[NpmLibraryManager.Config]:
        """
        Should produce an entry for the cache key. This method should not be called directly.
        """
            ...
        @classmethod
        def produceAll(cls) -> Union[Map[str, NpmLibraryManager.Config]]:
        """
        ...
        """
            ...
        @classmethod
        def doProduceAll(cls) -> Union[Map[str, NpmLibraryManager.Config]]:
        """
        ...
        """
            ...
        def getConfig(self) -> NpmLibraryManager.Config:
        """
        ...
        """
            ...
        def getSecret(self) -> NpmLibraryManager.Config:
        """
        ...
        """
            ...
        @classmethod
        def forConfigKey(cls, configKey: str) -> Union[NpmLibraryManager.Config]:
        """
        ...
        """
            ...
        @classmethod
        def listConfigs(cls, parallel: bool=None, filter: Callable[[str], bool]=None) -> Union[Stream[NpmLibraryManager.Config]]:
        """
        @param
        ...
        """
            ...
        @overload
        def setConfigValues(self, from_: NpmLibraryManager.Config, override: str=None) -> None:
        """
        ...
        """
            ...
        @overload
        def setSecretValues(self, from_: NpmLibraryManager.Config, override: str=None) -> None:
        """
        ...
        """
            ...
        @classmethod
        def loadConfigAndSecret(cls, configKey: str) -> Union[NpmLibraryManager.Config]:
        """
        ...
        """
            ...
        def removeSecrets(self) -> Union[NpmLibraryManager.Config]:
        """
        @return this config without any secret values.
        """
            ...
        def removeNonSecrets(self) -> Union[NpmLibraryManager.Config]:
        """
        @return this config with only secret values.
        """
            ...
        def validate(self) -> NpmLibraryManager.Config:
        """
        ...
        """
            ...
        @classmethod
        def inst(cls) -> NpmLibraryManager.Config:
        """
        @return the one and only instance to be used when member functions are called on this type.
        """
            ...
        @classmethod
        def cachedInst(cls) -> Union[NpmLibraryManager.Config]:
        """
        @return the cached instance if already cached, null otherwise. Does not instantiate if missing.
        """
            ...
