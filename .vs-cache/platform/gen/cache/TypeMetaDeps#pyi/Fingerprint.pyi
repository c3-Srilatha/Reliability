...
from c3.platform.Fingerprint import Fingerprint

# Python definitions for the C3 type Fingerprint

V = TypeVar('V')

class Fingerprint(Generic[V], Mutable, Value):
    """
    ...
    """
        ...
    @overload
    def add(self, value: int) -> Fingerprint[V]:
    """
    Updates (mutates) instance of this fingerprint by adding the provided value.
    """
        ...
    @overload
    def add(self, value: float) -> Fingerprint[V]:
    """
    Updates (mutates) instance of this fingerprint by adding the provided value.
    """
        ...
    @overload
    def add(self, value: Any) -> Fingerprint[V]:
    """
    Updates (mutates) instance of this fingerprint by adding the provided value.
    """
        ...
    def addAll(self, values: Array[Any]) -> Fingerprint[V]:
    """
    ...
    @overload
    @classmethod
    def fingerprint(cls, v: Any, allIdentifiedRefFields: bool=None, trackRecursiveRefs: bool=None, traversedRefs: SetBuilder[Obj]=None) -> V:
    """
    ...
    @overload
    @classmethod
    def fingerprint(cls, v: datetime) -> V:
    """
    ...
    @overload
    @classmethod
    def accumulate(cls, prior: V, add: V) -> V:
    """
    ...
    @overload
    @classmethod
    def accumulate(cls, prior: V, add1: V, add2: V) -> V:
    """
