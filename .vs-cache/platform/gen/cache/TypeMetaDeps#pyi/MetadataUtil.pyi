...
from c3.platform.Pkg.FilesResult import Pkg.FilesResult
from c3.platform.MetadataTypeImplementationResult import MetadataTypeImplementationResult
...
from c3.platform.TypesThatMixinSpec import TypesThatMixinSpec
from c3.platform.Pkg.FileResult import Pkg.FileResult
from c3.platform.SimpleMetric import SimpleMetric

# Python definitions for the C3 type MetadataUtil


class MetadataUtil(Value):
    """
    ...
    @classmethod
    def fetchMetadataFileContentByPath(cls, path: str=None) -> Union[str]:
    """
    ...
    """
        ...
    @classmethod
    def fetchMetadataFileObjsByPath(cls, path: str=None) -> Union[Array[Obj]]:
    """
    ...
    """
        ...
    @classmethod
    def updateMetadataFileContentByPath(cls, fileContents: Map[str, str]=None) -> None:
    """
    ...
    """
        ...
    @classmethod
    def allCanonicalTransformTypes(cls) -> Union[Map[str, Array[str]]]:
        ...
    @classmethod
    def allCanonicalTransformTypeMappings(cls) -> Union[Map[str, Map[str, Array[str]]]]:
    """
    ...
    """
        ...
    @classmethod
    def upsertSimpleMetric(cls, metric: SimpleMetric=None, subpath: str=None) -> Union[Pkg.FilesResult]:
    """
    ...
    """
        ...
    @classmethod
    def upsertCompoundMetric(cls, metric: CompoundMetric=None, subpath: str=None) -> Union[Pkg.FilesResult]:
        ...
    @classmethod
    def upsertTranslation(cls, translation: Translation=None) -> Union[Pkg.FilesResult]:
        ...
    @classmethod
    def upsertMetricWithTranslation(cls, metric: Any, translation: Translation=None, isCompoundMetric: bool='false') -> Union[Pkg.FilesResult]:
    """
    ...
    """
        ...
    @classmethod
    def upsertSeedObjs(cls, typeRef: Type=None, objs: Array[Any]=None, subpath: str=None, spec: FileObjsOperSpec=None, failIfObjExists: bool=None) -> Union[Pkg.FilesResult]:
    """
    ...
    """
        ...
    @classmethod
    def removeSeedObjs(cls, typeRef: Type=None, objs: Array[Any]=None, spec: FileObjsOperSpec=None) -> Union[Pkg.FilesResult]:
    """
    ...
    """
        ...
    @classmethod
    def getTypesThatMixin(cls, mixinType: Type, deep: bool='false') -> Union[Array[Type]]:
    """
    ...
    """
        ...
    @classmethod
    def getTypesThatMixinMultiple(cls, typesThatMixinSpecs: Array[TypesThatMixinSpec]) -> Union[Array[Type]]:
    """
    ...
    """
        ...
    @classmethod
    def getTypeDependencies(cls, targetType: Type) -> Union[Array[Type]]:
    """
    ...
    """
        ...
    @classmethod
    def getSimpleMetricSourceTypes(cls, metricId: str=None) -> Union[Array[Type]]:
    """
    ...
    """
        ...
    @classmethod
    def getTagTypeMetadata(cls) -> Union[Array[Type]]:
    """
    Returns all of the types in this tag
    """
        ...
    @classmethod
    def readType(cls, typeName: str) -> Union[Type]:
    """
    ...
    """
        ...
    @classmethod
    def readTypeObj(cls, typeName: str) -> Union[Any]:
    """
    ...
    """
        ...
    @classmethod
    def getMetadataIssues(cls, severity: str=None, fileUrl: str=None, spec: FetchSpec=None) -> Union[Array[Pkg.Issue]]:
    """
    ...
    """
        ...
    @classmethod
    def removeType(cls, typeRef: Type) -> Pkg.FileResult:
    """
    ...
    """
        ...
    @classmethod
    def upsertType(cls, typeObj: Any) -> Pkg.FileResult:
    """
    ...
    """
        ...
    @classmethod
    def updateTypes(cls, typesToUpsert: Array[Any]=None, typesToRemove: Array[Type]=None) -> Union[Pkg.FilesResult]:
    """
    ...
    """
        ...
    @classmethod
    def removeTypesAndTransforms(cls, types: Array[Type]=None) -> Pkg.FilesResult:
    """
    ...
    """
        ...
    @classmethod
    def fetchTypeImplementationByExtension(cls, typeName: str, extension: str, tenant: str, fallBackOnDependentPackage: bool=None) -> Union[MetadataTypeImplementationResult]:
    """
    ...
    """
        ...
    @classmethod
    def saveType(cls, typeObj: Any, implementations: Map[str, str]=None, package: str=None) -> Union[Pkg.FileResult]:
    """
    ...
    """
        ...
    @classmethod
    def validateType(cls, typeObj: Any) -> None:
    """
    ...
    """
        ...
    @classmethod
    def validateIncludedReferenceFieldDependency(cls, typeObj: Any) -> None:
    """
