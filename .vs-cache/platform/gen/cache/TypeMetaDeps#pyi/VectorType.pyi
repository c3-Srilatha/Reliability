...
# Python definitions for the C3 type VectorType


class VectorType(ArrayType[[!float]]):
    """
    A vector is a fixed-size array of `float`s. This is used for large arrays of numeric values.
    
    Vectors are declared in DSL using brackets containing the _size_:
    ```type
    samples: [10_000]
    ```
    
    Note that this syntax is similar to the {@link ArrayType array} syntax, but distinct because a literal integer value
    replaces the element type between the brackets. Vectors are also arrays so all the array operations work on them.
    The instance type is {@link Vector}, which extends **Array**.
    
    Unlike other collection types, vectors will _not_ have a default empty value, so will either be null or have the
    full set of values. Note that the #size must be positive, so there are no non-null empty vectors.
    
    @see Vector
    @see ArrayType
    
    @remarks this represents a made instance of VectorType
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> VectorType:
    """
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[VectorType]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[VectorType]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[VectorType]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[VectorType]:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> VectorType:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> VectorType:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[VectorType]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[VectorType]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> VectorType:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> VectorType:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> VectorType:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> VectorType:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> VectorType:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> VectorType:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> VectorType:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> VectorType:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> VectorType:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> VectorType:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> VectorType:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> VectorType:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> VectorType:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> VectorType:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> VectorType:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> VectorType:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> VectorType:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> VectorType:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> VectorType:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> VectorType:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> VectorType:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> VectorType:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> VectorType:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> VectorType:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> VectorType:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> VectorType:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> VectorType:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> VectorType:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[VectorType]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[VectorType]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[VectorType]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[VectorType]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[VectorType]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, VectorType]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, VectorType]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[VectorType]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[VectorType]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> VectorType:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> VectorType:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> VectorType:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> VectorType:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> VectorType:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> VectorType:
    """
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[VectorType]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> VectorType:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> VectorType:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[VectorType]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> VectorType:
    """
    ...
    """
        ...
    def withoutDeclaredSrcPos(self, recursive: bool=None) -> VectorType:
    """
    ...
    """
        ...
    @overload
    def withAnnotation(self, ann: Annotation) -> VectorType:
    """
    Add an annotation to the given metadata
    """
        ...
    @overload
    def withAnnotation(self, ann: str, annField: str=None, value: Any=None) -> VectorType:
    """
    Add an annotation to the given metadata
    @param ann
            annotation to add
    ...
    """
        ...
    @classmethod
    def fromString(cls, s: str) -> Union[VectorType]:
    """
    ...
    """
    @return {@link #emptyArray}
    """
        ...
    def buildArray(self, builder: Callable[[ArrayBuilder[E]]]) -> Union[Array[E]]:
    """
    @return collection built by provided lambda
    """
        ...
    @overload
    def makeBuilder(self, initial: Array[E]=None) -> ArrayBuilder[E]:
    """
    @return builder of array of this type.
    """
        ...
    @overload
    def makeBuilder(self, size: int) -> ArrayBuilder[E]:
    """
    @return builder of array of this type.
    """
        ...
    def makeArray(self, *elements: Array[E]) -> Union[Array[E]]:
    """
    @return instance of array of this type from provided elements.
    """
        ...
    def emptyArray(self) -> Union[Array[E]]:
    """
    @return instance of empty array of this type.
    """
        ...
    def isJavaPrimitiveArray(self) -> bool:
    """
    @return true if instance should use specialized java primitive array; e.g. `[!double]` or `[boolean]`
    """
        ...
    @classmethod
    def ofNonEmptyDbl(cls) -> ArrayType:
    """
    @return cached instance of `[!double]`
    """
        ...
    @classmethod
    def ofNonEmptyInt(cls) -> ArrayType:
    """
    @return cached instance of `[!int]`
    """
        ...
    @classmethod
    def ofSize(cls, size: int) -> Union[VectorType]:
    """
    Create a vector type with the specified size.
    """
        ...
    def zeroVector(self) -> Array[float]:
    """
    Return a vector of all zero values.
    """
        ...
    def nanVector(self) -> Array[float]:
    """
    Return a vector of all NaN values.
    """
        ...
