...
# Python definitions for the C3 type SqlCronQueue


class SqlCronQueue(CronQueue, Value):
    """
    Invalidation queue for cron job processing.
    
    @remarks this represents a made instance of SqlCronQueue
    """
