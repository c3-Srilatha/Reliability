...
# Python definitions for the C3 type SqlNormalizationQueue


class SqlNormalizationQueue(NormalizationQueue, Value):
    """
    Invalidation queue for timeseries normalization processing.
    
    @remarks this represents a made instance of SqlNormalizationQueue
    """
