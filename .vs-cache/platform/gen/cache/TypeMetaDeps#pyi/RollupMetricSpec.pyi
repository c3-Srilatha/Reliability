...
# Python definitions for the C3 type RollupMetricSpec


class RollupMetricSpec(EvalMetricsSpec):
    """
    Specification for rolling up results multiple sources for every metric
    
    @remarks this represents a made instance of RollupMetricSpec
    """
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[RollupMetricSpec]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[RollupMetricSpec]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[RollupMetricSpec]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[RollupMetricSpec]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> RollupMetricSpec:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> RollupMetricSpec:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> RollupMetricSpec:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[RollupMetricSpec]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[RollupMetricSpec]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> RollupMetricSpec:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> RollupMetricSpec:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> RollupMetricSpec:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> RollupMetricSpec:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> RollupMetricSpec:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> RollupMetricSpec:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> RollupMetricSpec:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> RollupMetricSpec:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> RollupMetricSpec:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> RollupMetricSpec:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> RollupMetricSpec:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> RollupMetricSpec:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> RollupMetricSpec:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> RollupMetricSpec:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> RollupMetricSpec:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> RollupMetricSpec:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> RollupMetricSpec:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> RollupMetricSpec:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> RollupMetricSpec:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> RollupMetricSpec:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> RollupMetricSpec:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> RollupMetricSpec:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> RollupMetricSpec:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> RollupMetricSpec:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> RollupMetricSpec:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> RollupMetricSpec:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> RollupMetricSpec:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> RollupMetricSpec:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[RollupMetricSpec]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[RollupMetricSpec]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[RollupMetricSpec]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[RollupMetricSpec]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[RollupMetricSpec]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, RollupMetricSpec]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, RollupMetricSpec]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[RollupMetricSpec]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[RollupMetricSpec]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> RollupMetricSpec:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> RollupMetricSpec:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> RollupMetricSpec:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> RollupMetricSpec:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> RollupMetricSpec:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> RollupMetricSpec:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> RollupMetricSpec:
    """
    ...
    """
        ...
    def afterMake(self) -> RollupMetricSpec:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> RollupMetricSpec:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[RollupMetricSpec]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> RollupMetricSpec:
    """
    ...
    """
        ...
    @classmethod
    def last12Months(cls) -> Union[RollupMetricSpec]:
    """
    ...
    """
        ...
    @classmethod
    def prevLast12Months(cls) -> Union[RollupMetricSpec]:
    """
    ...
    """
        ...
    @classmethod
    def combineAndSort(cls, timeRanges: Array[TimeRange]) -> Union[Array[RollupMetricSpec]]:
    """
    ...
    """
        ...
    @classmethod
    def coalesce(cls, timeRanges: Array[TimeRange]) -> Union[RollupMetricSpec]:
    """
    ...
    """
        ...
    def overlap(self, othr: TimeRange) -> Union[RollupMetricSpec]:
    """
    Returns overlap TimeRange with the input TimeRange. Returns null if no overlap found
    """
        ...
    @classmethod
    def fromPrettyPrint(cls, prettyPrint: str) -> RollupMetricSpec:
    """
    ...
    """
        ...
    @classmethod
    def fromMap(cls, map: Map[datetime, datetime]) -> Union[Array[RollupMetricSpec]]:
    """
    ...
    """
        ...
    @overload
    def shift(self, offset: Duration) -> RollupMetricSpec:
    """
