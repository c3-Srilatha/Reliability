...
from c3.platform.AnalyticsTypesSet import AnalyticsTypesSet

# Python definitions for the C3 type AnalyticsTypesSetCache


class AnalyticsTypesSetCache(MetadataCacheOld[AnalyticsTypesSet], Value):
    """
    Cache for analytics type info.
    
    @remarks this represents a made instance of AnalyticsTypesSetCache
    """
    def __init__(self) -> None: ...

    @classmethod
    def get(cls, key: str) -> Union[AnalyticsTypesSet]:
    """
    ...
    """
        ...
    @classmethod
    def require(cls, key: str) -> AnalyticsTypesSet:
    """
    ...
    """
        ...
    @classmethod
    def put(cls, key: str, value: AnalyticsTypesSet) -> None:
    """
    ...
    """
        ...
    @classmethod
    def produce(cls, key: str) -> Union[AnalyticsTypesSet]:
    """
    ...
    """
        ...
    @classmethod
    def produceAll(cls) -> Union[Map[str, AnalyticsTypesSet]]:
    """
    ...
    """
        ...
    @classmethod
    def release(cls, key: str, value: AnalyticsTypesSet) -> None:
    """
    ...
    """
        ...
    @classmethod
    def validate(cls, value: AnalyticsTypesSet) -> bool:
    """
    ...
    """
        ...
    @classmethod
    def typesSet(cls) -> Union[Any]:
    """
    @return the TypesSet java object.
    """
        ...
    @classmethod
    def putTypesSet(cls, typesSet: Any=None) -> None:
    """
    Put the new TypesSet into the cache.
    """
        ...
