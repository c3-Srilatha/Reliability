...
from c3.platform.AzureServiceBusQueue import AzureServiceBusQueue
...
# Python definitions for the C3 type AzureServiceBusQueueAuthorizationRule


class AzureServiceBusQueueAuthorizationRule(AzureSharedAccessAuthorizationRuleResource[AzureServiceBusQueue, AzureServiceBusAuthorizationKeysFields], AzureSharedAccessAuthorizationRuleFields):
    """
    @remarks this represents a made instance of AzureServiceBusQueueAuthorizationRule
    """
    ...
    parent: Optional[AzureServiceBusQueue]
    """
    ...
    @overload
    @classmethod
    def fromString(cls, s: str) -> Union[AzureServiceBusQueueAuthorizationRule]:
    """
    ...
    @overload
    @classmethod
    def fromString(cls, s: str, failIfInvalid: bool=None) -> Union[AzureServiceBusQueueAuthorizationRule]:
    """
    Constructs Cloud Resource instance with reference fields and credentials based on provided Cloud Reference string.
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[AzureServiceBusQueueAuthorizationRule]:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> AzureServiceBusQueueAuthorizationRule:
    """
    ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> AzureServiceBusQueueAuthorizationRule:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> AzureServiceBusQueueAuthorizationRule:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> AzureServiceBusQueueAuthorizationRule:
    """
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[AzureServiceBusQueueAuthorizationRule]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[AzureServiceBusQueueAuthorizationRule]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[AzureServiceBusQueueAuthorizationRule]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[AzureServiceBusQueueAuthorizationRule]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> AzureServiceBusQueueAuthorizationRule:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> AzureServiceBusQueueAuthorizationRule:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> AzureServiceBusQueueAuthorizationRule:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[AzureServiceBusQueueAuthorizationRule]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[AzureServiceBusQueueAuthorizationRule]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> AzureServiceBusQueueAuthorizationRule:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> AzureServiceBusQueueAuthorizationRule:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> AzureServiceBusQueueAuthorizationRule:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> AzureServiceBusQueueAuthorizationRule:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> AzureServiceBusQueueAuthorizationRule:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> AzureServiceBusQueueAuthorizationRule:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> AzureServiceBusQueueAuthorizationRule:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> AzureServiceBusQueueAuthorizationRule:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> AzureServiceBusQueueAuthorizationRule:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> AzureServiceBusQueueAuthorizationRule:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> AzureServiceBusQueueAuthorizationRule:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> AzureServiceBusQueueAuthorizationRule:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> AzureServiceBusQueueAuthorizationRule:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> AzureServiceBusQueueAuthorizationRule:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> AzureServiceBusQueueAuthorizationRule:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> AzureServiceBusQueueAuthorizationRule:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> AzureServiceBusQueueAuthorizationRule:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> AzureServiceBusQueueAuthorizationRule:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> AzureServiceBusQueueAuthorizationRule:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> AzureServiceBusQueueAuthorizationRule:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> AzureServiceBusQueueAuthorizationRule:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> AzureServiceBusQueueAuthorizationRule:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> AzureServiceBusQueueAuthorizationRule:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> AzureServiceBusQueueAuthorizationRule:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> AzureServiceBusQueueAuthorizationRule:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> AzureServiceBusQueueAuthorizationRule:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> AzureServiceBusQueueAuthorizationRule:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> AzureServiceBusQueueAuthorizationRule:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[AzureServiceBusQueueAuthorizationRule]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[AzureServiceBusQueueAuthorizationRule]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[AzureServiceBusQueueAuthorizationRule]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[AzureServiceBusQueueAuthorizationRule]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[AzureServiceBusQueueAuthorizationRule]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, AzureServiceBusQueueAuthorizationRule]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, AzureServiceBusQueueAuthorizationRule]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[AzureServiceBusQueueAuthorizationRule]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[AzureServiceBusQueueAuthorizationRule]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> AzureServiceBusQueueAuthorizationRule:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> AzureServiceBusQueueAuthorizationRule:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> AzureServiceBusQueueAuthorizationRule:
    """
    ...
    """
        ...
    def afterMake(self) -> AzureServiceBusQueueAuthorizationRule:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> AzureServiceBusQueueAuthorizationRule:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[AzureServiceBusQueueAuthorizationRule]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> AzureServiceBusQueueAuthorizationRule:
    """
    ...
    """
        ...
    @classmethod
    def forId(cls, id: str, failIfMissing: bool=None) -> Union[AzureServiceBusQueueAuthorizationRule]:
    """
    Find Cloud Resource in Cloud Provider based on provided C3 canonical identifier.
    """
        ...
    @classmethod
    def fromClusterId(cls, clusterId: str, env: str, app: str, func: str, role: str=None, seq: str=None, subseq: str=None) -> AzureServiceBusQueueAuthorizationRule:
    """
    Construct a cloud ID from a cluster ID
    """
        ...
    @classmethod
    def fromEnvId(cls, envId: str, app: str, func: str, role: str=None, seq: str=None, subseq: str=None) -> AzureServiceBusQueueAuthorizationRule:
    """
    ...
    """
        ...
    @classmethod
    def fromAppId(cls, appId: str, func: str, role: str=None, seq: str=None, subseq: str=None) -> AzureServiceBusQueueAuthorizationRule:
    """
    ...
    """
        ...
    def withDefaultId(self) -> AzureServiceBusQueueAuthorizationRule:
    """
    Populate default values for all uninitialized Cloud Identifier fields in this Cloud Resource.
    """
        ...
    def sanitize(self) -> AzureServiceBusQueueAuthorizationRule:
    """
    ...
    """
        ...
    @classmethod
    def fromId(cls, id: str, failIfInvalid: bool=None) -> AzureServiceBusQueueAuthorizationRule:
    """
    ...
    """
        ...
    @classmethod
    def fromCloudId(cls, id: CloudId, failIfInvalid: bool=None) -> AzureServiceBusQueueAuthorizationRule:
    """
    ...
    """
        ...
    @classmethod
    def fromCloudRef(cls, ref: CloudRef, failIfInvalid: bool=None) -> AzureServiceBusQueueAuthorizationRule:
    """
    Constructs Cloud Resource instance with reference fields and credentials based on provided Cloud Reference.
    """
        ...
    @classmethod
    def fromCloudFunc(cls, func: str, role: str=None, seq: str=None) -> AzureServiceBusQueueAuthorizationRule:
    """
    Constructs Cloud Resource instance based on provided Cloud Func component and optional role.
    """
        ...
    @classmethod
    def fromResourceId(cls, resourceId: str) -> AzureServiceBusQueueAuthorizationRule:
    """
    Constructs Cloud Resource instance based on provided Cloud Resource Id.
    """
        ...
    @classmethod
    def fromResourceSecondaryId(cls, resourceSecondaryId: str) -> AzureServiceBusQueueAuthorizationRule:
    """
    Constructs Cloud Resource instance based on provided Cloud Resource Secondary Id and available Cloud Configuration.
    """
        ...
    @classmethod
    def fromResourceName(cls, name: str) -> AzureServiceBusQueueAuthorizationRule:
    """
    Constructs Cloud Resource instance based on provided Cloud Resource Name and available Cloud Configuration.
    """
        ...
    @classmethod
    def fromReferenceField(cls, fieldName: str, value: str, failIfInvalid: bool=None) -> AzureServiceBusQueueAuthorizationRule:
    """
    ...
    """
        ...
    def fromConfigTemplate(self, spec: CloudResourceOperationSpec=None) -> AzureServiceBusQueueAuthorizationRule:
    """
    ...
    """
        ...
    def withDefaultConfig(self, spec: CloudResourceOperationSpec=None) -> AzureServiceBusQueueAuthorizationRule:
    """
    ...
    """
        ...
    def upsertResource(self, spec: CloudResourceOperationSpec=None) -> AzureServiceBusQueueAuthorizationRule:
    """
    Create or update Cloud Resource.
    """
        ...
    def upsertWithDependencies(self, spec: CloudResourceOperationSpec=None) -> AzureServiceBusQueueAuthorizationRule:
    """
    ...
    """
        ...
    @classmethod
    def allCached(cls, doNotProduceAll: bool=None) -> Union[Stream[AzureServiceBusQueueAuthorizationRule]]:
    """
    ...
    """
        ...
    @classmethod
    def find(cls, filter: str=None, doNotProduceAll: bool=None) -> Union[Stream[AzureServiceBusQueueAuthorizationRule]]:
    """
    ...
    """
        ...
    @classmethod
    def findBy(cls, field: str, value: Any, doNotProduceAll: bool=None) -> Union[Stream[AzureServiceBusQueueAuthorizationRule]]:
    """
    @param doNotProduceAll if true, will not populate cache and only return available cached instances. Will call
           `produceAll` if cache is empty or if Ann.cache.all is true & data has not previously been fetched.
    @return existing instances of this type that satisfy filter from data cache.
    """
        ...
    @classmethod
    def findByCacheKey(cls, key: str) -> Union[AzureServiceBusQueueAuthorizationRule]:
    """
    ...
    """
        ...
    @classmethod
    def forCacheKey(cls, key: str) -> Union[AzureServiceBusQueueAuthorizationRule]:
    """
    Returns cached instance by key, with secrets removed.
    """
        ...
    def getCached(self) -> Union[AzureServiceBusQueueAuthorizationRule]:
    """
    This method on any CloudResource is not supported! Use CloudResource.for* or other methods instead.
    """
        ...
    def refreshCache(self) -> Union[AzureServiceBusQueueAuthorizationRule]:
    """
    ...
    """
        ...
    @classmethod
    def produce(cls, key: str) -> Union[AzureServiceBusQueueAuthorizationRule]:
    """
    Should produce an entry for the cache key. This method should not be called directly.
    """
        ...
    @classmethod
    def produceAll(cls) -> Union[Map[str, AzureServiceBusQueueAuthorizationRule]]:
    """
    ...
    """
        ...
    @classmethod
    def doProduceAll(cls) -> Union[Map[str, AzureServiceBusQueueAuthorizationRule]]:
    """
    ...
    """
        ...
    def getConfig(self) -> AzureServiceBusQueueAuthorizationRule:
    """
    This method on any CloudResource is not supported! Use CloudResource.for* or other methods instead.
    """
        ...
    ...
    """
        ...
    def getSecret(self) -> AzureServiceBusQueueAuthorizationRule:
    """
    ...
    """
        ...
    @classmethod
    def forConfigKey(cls, configKey: str) -> Union[AzureServiceBusQueueAuthorizationRule]:
    """
    ...
    """
        ...
    @classmethod
    def listConfigs(cls, parallel: bool=None, filter: Callable[[str], bool]=None) -> Union[Stream[AzureServiceBusQueueAuthorizationRule]]:
    """
    @param
    ...
    """
        ...
    @overload
    def setConfigValues(self, from_: AzureServiceBusQueueAuthorizationRule, override: str=None) -> None:
    """
    ...
    """
        ...
    @overload
    def setSecretValues(self, from_: AzureServiceBusQueueAuthorizationRule, override: str=None) -> None:
    """
    ...
    """
        ...
    @classmethod
    def loadConfigAndSecret(cls, configKey: str) -> Union[AzureServiceBusQueueAuthorizationRule]:
    """
    ...
    """
        ...
    def removeSecrets(self) -> Union[AzureServiceBusQueueAuthorizationRule]:
    """
    @return this config without any secret values.
    """
        ...
    def removeNonSecrets(self) -> Union[AzureServiceBusQueueAuthorizationRule]:
    """
    @return this config with only secret values.
    """
        ...
    def validate(self) -> AzureServiceBusQueueAuthorizationRule:
    """
    ...
    """
        ...
    def withIdentity(self, resource: CloudResource=None, spec: CloudResourceOperationSpec=None) -> AzureServiceBusQueueAuthorizationRule:
    """
    ...
    """
        ...
    def mergeId(self, other: CloudResource=None) -> AzureServiceBusQueueAuthorizationRule:
    """
    ...
    """
        ...
    @classmethod
    def fromCloudRole(cls, role: str, seq: str=None) -> AzureServiceBusQueueAuthorizationRule:
    """
    Constructs Cloud Resource instance of this type with reference fields and credentials based on provided cloud role.
    """
        ...
    @classmethod
    def fromCloudSeq(cls, seq: str) -> AzureServiceBusQueueAuthorizationRule:
    """
    Constructs Cloud Resource instance of this type with reference fields and credentials based on provided cloud seq.
    """
        ...
    @classmethod
    def fromTags(cls, tags: Array[CloudTag]) -> Union[AzureServiceBusQueueAuthorizationRule]:
    """
    ...
    """
        ...
    @classmethod
    def forCloudId(cls, id: CloudId, failIfMissing: bool=None) -> Union[AzureServiceBusQueueAuthorizationRule]:
    """
    ...
    """
        ...
    @classmethod
    def forCloudFunc(cls, func: str, role: str=None, failIfMissing: bool=None) -> AzureServiceBusQueueAuthorizationRule:
    """
    Find Cloud Resource based on provided cloud func component and optional role.
    """
        ...
    @classmethod
    def forCloudRole(cls, role: str, failIfMissing: bool=None) -> AzureServiceBusQueueAuthorizationRule:
    """
    Find Cloud Resource of this type based on provided cloud role component.
    """
        ...
    @classmethod
    def forResourceId(cls, resourceId: str, failIfMissing: bool=None) -> Union[AzureServiceBusQueueAuthorizationRule]:
    """
    Find Cloud Resource in the Cloud Provider by provided resource name.
    """
        ...
    @classmethod
    def forResourceSecondaryId(cls, resourceId: str, failIfMissing: bool=None) -> Union[AzureServiceBusQueueAuthorizationRule]:
    """
    Find Cloud Resource in the Cloud Provider by provided resource name.
    """
        ...
    ...
    """
        ...
    @classmethod
    def forResourceName(cls, resourceName: str, failIfMissing: bool=None) -> Union[AzureServiceBusQueueAuthorizationRule]:
    """
    Find Cloud Resource in the Cloud Provider by provided resource name.
    """
        ...
    @classmethod
    def findResource(cls, reference: str, failIfMissing: bool=None) -> Union[AzureServiceBusQueueAuthorizationRule]:
    """
    Find Cloud Resource in the Cloud Provider by provided {@link CloudRef} string.
    """
        ...
    def getResource(self) -> Union[AzureServiceBusQueueAuthorizationRule]:
    """
    Find Cloud Resource in the Cloud Provider by provided #resourceId, #resourceSecondaryId, #resourceName or #tags
    (in that order).
    """
        ...
    def ensureResource(self) -> AzureServiceBusQueueAuthorizationRule:
    """
    Checks that the resource is persisted. If not, upserts the resource, to ensure that the resource exists.
    """
        ...
    @classmethod
    def listResourcesBySubtype(cls, spec: CloudListResourcesSpec=None) -> Map[str, CloudListResourcesResult[AzureServiceBusQueueAuthorizationRule]]:
    """
    ...
    """
        ...
    @classmethod
    def listResources(cls, spec: CloudListResourcesSpec=None) -> CloudListResourcesResult[AzureServiceBusQueueAuthorizationRule]:
    """
    ...
    """
        ...
    @classmethod
    def listResourcesForTags(cls, *keyValuePairs: Array[str]) -> CloudListResourcesResult[AzureServiceBusQueueAuthorizationRule]:
    """
    List all Cloud Resources that satisfies the given spec.
    ...
    """
        ...
    @classmethod
    def listResourcesForClusterId(cls, clusterId: str, cloudIdRole: str=None, spec: CloudListResourcesSpec=None) -> CloudListResourcesResult[AzureServiceBusQueueAuthorizationRule]:
    """
    List all Cloud Resources that satisfies the given spec.
    ...
    """
        ...
    @classmethod
    def listResourcesForEnvId(cls, envId: str, cloudIdRole: str=None, spec: CloudListResourcesSpec=None) -> CloudListResourcesResult[AzureServiceBusQueueAuthorizationRule]:
    """
    List all Cloud Resources that satisfies the given spec.
    ...
    """
        ...
    @classmethod
    def listResourcesForAppId(cls, appId: str, cloudIdRole: str=None, spec: CloudListResourcesSpec=None) -> CloudListResourcesResult[AzureServiceBusQueueAuthorizationRule]:
    """
    List all Cloud Resources that satisfies the given spec.
    ...
    """
        ...
    def upsertDependencies(self, spec: CloudResourceOperationSpec=None) -> AzureServiceBusQueueAuthorizationRule:
    """
    ...
    """
        ...
    def waitForCreate(self, spec: WaitSpec=None) -> Union[AzureServiceBusQueueAuthorizationRule]:
    """
    ...
    """
        ...
    @classmethod
    def tagResourcesBatch(cls, resources: Array[AzureServiceBusQueueAuthorizationRule], tags: Array[CloudTag]) -> Union[Map[str, Error]]:
    """
    ...
    """
        ...
    @classmethod
    def untagResourcesBatch(cls, resources: Array[AzureServiceBusQueueAuthorizationRule], tagKeys: Array[str]) -> Union[Map[str, Error]]:
    """
    ...
    """
        ...
    def waitForOk(self, spec: WaitSpec=None) -> Union[AzureServiceBusQueueAuthorizationRule]:
    """
    ...
    """
        ...
    def waitForState(self, state: str='AVAILABLE', spec: WaitSpec=None) -> Union[AzureServiceBusQueueAuthorizationRule]:
    """
    ...
    """
        ...
    def setFullyConfigured(self, fullyConfigured: bool=None, override: str=None) -> AzureServiceBusQueueAuthorizationRule:
    """
    ...
    """
        ...
    def afterCreate(self, input: AzureServiceBusQueueAuthorizationRule=None) -> AzureServiceBusQueueAuthorizationRule:
    """
    ...
    """
        ...
    def beforeCreate(self) -> AzureServiceBusQueueAuthorizationRule:
    """
    Optional callback to alter resource before creating it.
    """
        ...
    def beforeUpdate(self) -> AzureServiceBusQueueAuthorizationRule:
    """
    Optional callback to alter resource before updating it.
    """
        ...
    def beforeDestroy(self) -> AzureServiceBusQueueAuthorizationRule:
    """
    ...
    """
        ...
    def withoutNonModifiableFields(self) -> AzureServiceBusQueueAuthorizationRule:
    """
    ...
    """
        ...
    @classmethod
    def fromImpl(cls, impl: Any=None) -> Union[AzureServiceBusQueueAuthorizationRule]:
    """
    ...
    """
        ...
    def safeParent(self) -> Union[AzureServiceBusQueue]:
    """
