...
# Python definitions for the C3 type Feature.Set.SchemaUpgrade


class SchemaUpgrade(SchemaUpgrade):
    """
    Schema upgrade for {@link Feature.Set} entities that applies necessary updates to the database
    for continued functionality.
    
    @remarks this represents a made instance of Feature.Set.SchemaUpgrade
    """
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[Feature.Set.SchemaUpgrade]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[Feature.Set.SchemaUpgrade]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[Feature.Set.SchemaUpgrade]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[Feature.Set.SchemaUpgrade]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> Feature.Set.SchemaUpgrade:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> Feature.Set.SchemaUpgrade:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> Feature.Set.SchemaUpgrade:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[Feature.Set.SchemaUpgrade]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[Feature.Set.SchemaUpgrade]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> Feature.Set.SchemaUpgrade:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> Feature.Set.SchemaUpgrade:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> Feature.Set.SchemaUpgrade:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> Feature.Set.SchemaUpgrade:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> Feature.Set.SchemaUpgrade:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> Feature.Set.SchemaUpgrade:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> Feature.Set.SchemaUpgrade:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> Feature.Set.SchemaUpgrade:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> Feature.Set.SchemaUpgrade:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> Feature.Set.SchemaUpgrade:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> Feature.Set.SchemaUpgrade:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> Feature.Set.SchemaUpgrade:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> Feature.Set.SchemaUpgrade:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> Feature.Set.SchemaUpgrade:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> Feature.Set.SchemaUpgrade:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> Feature.Set.SchemaUpgrade:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> Feature.Set.SchemaUpgrade:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> Feature.Set.SchemaUpgrade:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> Feature.Set.SchemaUpgrade:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> Feature.Set.SchemaUpgrade:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> Feature.Set.SchemaUpgrade:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> Feature.Set.SchemaUpgrade:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> Feature.Set.SchemaUpgrade:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> Feature.Set.SchemaUpgrade:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> Feature.Set.SchemaUpgrade:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> Feature.Set.SchemaUpgrade:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> Feature.Set.SchemaUpgrade:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> Feature.Set.SchemaUpgrade:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[Feature.Set.SchemaUpgrade]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[Feature.Set.SchemaUpgrade]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[Feature.Set.SchemaUpgrade]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[Feature.Set.SchemaUpgrade]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[Feature.Set.SchemaUpgrade]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, Feature.Set.SchemaUpgrade]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, Feature.Set.SchemaUpgrade]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[Feature.Set.SchemaUpgrade]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[Feature.Set.SchemaUpgrade]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> Feature.Set.SchemaUpgrade:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> Feature.Set.SchemaUpgrade:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> Feature.Set.SchemaUpgrade:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> Feature.Set.SchemaUpgrade:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> Feature.Set.SchemaUpgrade:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> Feature.Set.SchemaUpgrade:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> Feature.Set.SchemaUpgrade:
    """
    ...
    """
        ...
    def afterMake(self) -> Feature.Set.SchemaUpgrade:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> Feature.Set.SchemaUpgrade:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[Feature.Set.SchemaUpgrade]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> Feature.Set.SchemaUpgrade:
    """
    ...
    """
        ...
    @classmethod
    def migrateMaterializeTimeRange_1(cls) -> None:
    """
    Copies the value of {@link Feature.Set#materializeTimeRange} to {@link Feature.Set#timeHorizon}.
    """
        ...
