...
from c3.platform.AzureEventHubNamespace import AzureEventHubNamespace
from c3.platform.App import App
from c3.platform.Config import Config
from c3.platform.MapType import MapType
from c3.platform.AzureEventHubAuthorizationRule import AzureEventHubAuthorizationRule
...
from c3.platform.CloudStreamReceiveMessagesSpec import CloudStreamReceiveMessagesSpec
from c3.platform.SetBuilder import SetBuilder
from c3.platform.CloudMessageBrokerSendSpec import CloudMessageBrokerSendSpec
from c3.platform.AzureEventHubFields import AzureEventHubFields
...
from c3.platform.AzureEventHubConsumerGroupFields import AzureEventHubConsumerGroupFields
from c3.platform.ValidateObjResult import ValidateObjResult
from c3.platform.CloudRef import CloudRef
from c3.platform.Promise import Promise
from c3.platform.CloudStreamMessage import CloudStreamMessage
from c3.platform.Promise import Promise
...
from c3.platform.MapBuilder import MapBuilder
from c3.platform.AzureEventHubCaptureDescription import AzureEventHubCaptureDescription
...
# Python definitions for the C3 type AzureEventHub


class AzureEventHub(AzureSharedAccessResource[AzureEventHubAuthorizationRule], AzureEventHubNamespaceMember, CloudStream[CloudStreamMessage], AzureEventHubFields):
    """
    @remarks this represents a made instance of AzureEventHub
    """
    ...
    """
    Represents the uniquely identifiable Event Hub resource in the format: <eventHubName>/<namespace>/<resourceGroupName>
    """
    ...
    namespace: Optional[AzureEventHubNamespace]
    """
    Namespace associated with the given resource
    """

    captureDescription: Optional[AzureEventHubCaptureDescription]=None

    type_: Optional[str]=None

    messageRetentionInDays: Optional[int]=None

    partitionIds: Optional[Array[str]]=None
    ...
    @overload
    @classmethod
    def fromString(cls, s: str) -> Union[AzureEventHub]:
    """
    ...
    @overload
    @classmethod
    def fromString(cls, s: str, failIfInvalid: bool=None) -> Union[AzureEventHub]:
    """
    Constructs Cloud Resource instance with reference fields and credentials based on provided Cloud Reference string.
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[AzureEventHub]:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> AzureEventHub:
    """
    ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> AzureEventHub:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> AzureEventHub:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> AzureEventHub:
    """
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[AzureEventHub]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[AzureEventHub]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[AzureEventHub]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[AzureEventHub]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> AzureEventHub:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> AzureEventHub:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> AzureEventHub:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[AzureEventHub]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[AzureEventHub]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> AzureEventHub:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> AzureEventHub:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> AzureEventHub:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> AzureEventHub:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> AzureEventHub:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> AzureEventHub:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> AzureEventHub:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> AzureEventHub:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> AzureEventHub:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> AzureEventHub:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> AzureEventHub:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> AzureEventHub:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> AzureEventHub:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> AzureEventHub:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> AzureEventHub:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> AzureEventHub:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> AzureEventHub:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> AzureEventHub:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> AzureEventHub:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> AzureEventHub:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> AzureEventHub:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> AzureEventHub:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> AzureEventHub:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> AzureEventHub:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> AzureEventHub:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> AzureEventHub:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> AzureEventHub:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> AzureEventHub:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[AzureEventHub]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[AzureEventHub]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[AzureEventHub]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[AzureEventHub]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[AzureEventHub]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, AzureEventHub]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, AzureEventHub]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[AzureEventHub]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[AzureEventHub]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> AzureEventHub:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> AzureEventHub:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> AzureEventHub:
    """
    ...
    """
        ...
    def afterMake(self) -> AzureEventHub:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> AzureEventHub:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[AzureEventHub]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> AzureEventHub:
    """
    ...
    """
        ...
    @classmethod
    def forId(cls, id: str, failIfMissing: bool=None) -> Union[AzureEventHub]:
    """
    Find Cloud Resource in Cloud Provider based on provided C3 canonical identifier.
    """
        ...
    @classmethod
    def fromClusterId(cls, clusterId: str, env: str, app: str, func: str, role: str=None, seq: str=None, subseq: str=None) -> AzureEventHub:
    """
    Construct a cloud ID from a cluster ID
    """
        ...
    @classmethod
    def fromEnvId(cls, envId: str, app: str, func: str, role: str=None, seq: str=None, subseq: str=None) -> AzureEventHub:
    """
    ...
    """
        ...
    @classmethod
    def fromAppId(cls, appId: str, func: str, role: str=None, seq: str=None, subseq: str=None) -> AzureEventHub:
    """
    ...
    """
        ...
    @classmethod
    def fromId(cls, id: str, failIfInvalid: bool=None) -> AzureEventHub:
    """
    ...
    """
        ...
    @classmethod
    def fromCloudId(cls, id: CloudId, failIfInvalid: bool=None) -> AzureEventHub:
    """
    ...
    """
        ...
    def fromConfigTemplate(self, spec: CloudResourceOperationSpec=None) -> AzureEventHub:
    """
    ...
    """
        ...
    def withDefaultConfig(self, spec: CloudResourceOperationSpec=None) -> AzureEventHub:
    """
    ...
    """
        ...
    def upsertResource(self, spec: CloudResourceOperationSpec=None) -> AzureEventHub:
    """
    Create or update Cloud Resource.
    """
        ...
    def upsertWithDependencies(self, spec: CloudResourceOperationSpec=None) -> AzureEventHub:
    """
    ...
    """
        ...
    @classmethod
    def allCached(cls, doNotProduceAll: bool=None) -> Union[Stream[AzureEventHub]]:
    """
    ...
    """
        ...
    @classmethod
    def find(cls, filter: str=None, doNotProduceAll: bool=None) -> Union[Stream[AzureEventHub]]:
    """
    ...
    """
        ...
    @classmethod
    def findBy(cls, field: str, value: Any, doNotProduceAll: bool=None) -> Union[Stream[AzureEventHub]]:
    """
    @param doNotProduceAll if true, will not populate cache and only return available cached instances. Will call
           `produceAll` if cache is empty or if Ann.cache.all is true & data has not previously been fetched.
    @return existing instances of this type that satisfy filter from data cache.
    """
        ...
    @classmethod
    def findByCacheKey(cls, key: str) -> Union[AzureEventHub]:
    """
    ...
    """
        ...
    @classmethod
    def produce(cls, key: str) -> Union[AzureEventHub]:
    """
    Should produce an entry for the cache key. This method should not be called directly.
    """
        ...
    @classmethod
    def produceAll(cls) -> Union[Map[str, AzureEventHub]]:
    """
    ...
    """
        ...
    @classmethod
    def doProduceAll(cls) -> Union[Map[str, AzureEventHub]]:
    """
    ...
    """
        ...
    def getConfig(self) -> AzureEventHub:
    """
    This method on any CloudResource is not supported! Use CloudResource.for* or other methods instead.
    """
        ...
    ...
    """
        ...
    def getSecret(self) -> AzureEventHub:
    """
    ...
    """
        ...
    @classmethod
    def forConfigKey(cls, configKey: str) -> Union[AzureEventHub]:
    """
    ...
    """
        ...
    @classmethod
    def listConfigs(cls, parallel: bool=None, filter: Callable[[str], bool]=None) -> Union[Stream[AzureEventHub]]:
    """
    @param
    ...
    """
        ...
    @overload
    def setConfigValues(self, from_: AzureEventHub, override: str=None) -> None:
    """
    ...
    """
        ...
    @overload
    def setSecretValues(self, from_: AzureEventHub, override: str=None) -> None:
    """
    ...
    """
        ...
    @classmethod
    def loadConfigAndSecret(cls, configKey: str) -> Union[AzureEventHub]:
    """
    ...
    """
        ...
    def removeSecrets(self) -> Union[AzureEventHub]:
    """
    @return this config without any secret values.
    """
        ...
    def removeNonSecrets(self) -> Union[AzureEventHub]:
    """
    @return this config with only secret values.
    """
        ...
    def validate(self) -> AzureEventHub:
    """
    ...
    """
        ...
    def withIdentity(self, resource: CloudResource=None, spec: CloudResourceOperationSpec=None) -> AzureEventHub:
    """
    ...
    """
        ...
    def mergeId(self, other: CloudResource=None) -> AzureEventHub:
    """
    ...
    """
        ...
    @classmethod
    def forCloudId(cls, id: CloudId, failIfMissing: bool=None) -> Union[AzureEventHub]:
    """
    ...
    """
        ...
    @classmethod
    def forCloudFunc(cls, func: str, role: str=None, failIfMissing: bool=None) -> AzureEventHub:
    """
    Find Cloud Resource based on provided cloud func component and optional role.
    """
        ...
    @classmethod
    def forCloudRole(cls, role: str, failIfMissing: bool=None) -> AzureEventHub:
    """
    Find Cloud Resource of this type based on provided cloud role component.
    """
        ...
    @classmethod
    def forResourceId(cls, resourceId: str, failIfMissing: bool=None) -> Union[AzureEventHub]:
    """
    Find Cloud Resource in the Cloud Provider by provided resource name.
    """
        ...
    @classmethod
    def forResourceSecondaryId(cls, resourceId: str, failIfMissing: bool=None) -> Union[AzureEventHub]:
    """
    Find Cloud Resource in the Cloud Provider by provided resource name.
    """
        ...
    ...
    """
        ...
    @classmethod
    def forResourceName(cls, resourceName: str, failIfMissing: bool=None) -> Union[AzureEventHub]:
    """
    Find Cloud Resource in the Cloud Provider by provided resource name.
    """
        ...
    @classmethod
    def findResource(cls, reference: str, failIfMissing: bool=None) -> Union[AzureEventHub]:
    """
    Find Cloud Resource in the Cloud Provider by provided {@link CloudRef} string.
    """
        ...
    def getResource(self) -> Union[AzureEventHub]:
    """
    Find Cloud Resource in the Cloud Provider by provided #resourceId, #resourceSecondaryId, #resourceName or #tags
    (in that order).
    """
        ...
    def ensureResource(self) -> AzureEventHub:
    """
    Checks that the resource is persisted. If not, upserts the resource, to ensure that the resource exists.
    """
        ...
    @classmethod
    def listResourcesBySubtype(cls, spec: CloudListResourcesSpec=None) -> Map[str, CloudListResourcesResult[AzureEventHub]]:
    """
    ...
    """
        ...
    @classmethod
    def listResources(cls, spec: CloudListResourcesSpec=None) -> CloudListResourcesResult[AzureEventHub]:
    """
    ...
    """
        ...
    @classmethod
    def listResourcesForTags(cls, *keyValuePairs: Array[str]) -> CloudListResourcesResult[AzureEventHub]:
    """
    List all Cloud Resources that satisfies the given spec.
    ...
    """
        ...
    @classmethod
    def listResourcesForClusterId(cls, clusterId: str, cloudIdRole: str=None, spec: CloudListResourcesSpec=None) -> CloudListResourcesResult[AzureEventHub]:
    """
    List all Cloud Resources that satisfies the given spec.
    ...
    """
        ...
    @classmethod
    def listResourcesForEnvId(cls, envId: str, cloudIdRole: str=None, spec: CloudListResourcesSpec=None) -> CloudListResourcesResult[AzureEventHub]:
    """
    List all Cloud Resources that satisfies the given spec.
    ...
    """
        ...
    @classmethod
    def listResourcesForAppId(cls, appId: str, cloudIdRole: str=None, spec: CloudListResourcesSpec=None) -> CloudListResourcesResult[AzureEventHub]:
    """
    List all Cloud Resources that satisfies the given spec.
    ...
    """
        ...
    def upsertDependencies(self, spec: CloudResourceOperationSpec=None) -> AzureEventHub:
    """
    ...
    """
        ...
    def waitForCreate(self, spec: WaitSpec=None) -> Union[AzureEventHub]:
    """
    ...
    """
        ...
    @classmethod
    def tagResourcesBatch(cls, resources: Array[AzureEventHub], tags: Array[CloudTag]) -> Union[Map[str, Error]]:
    """
    ...
    """
        ...
    @classmethod
    def untagResourcesBatch(cls, resources: Array[AzureEventHub], tagKeys: Array[str]) -> Union[Map[str, Error]]:
    """
    ...
    """
        ...
    def waitForOk(self, spec: WaitSpec=None) -> Union[AzureEventHub]:
    """
    ...
    """
        ...
    def waitForState(self, state: str='AVAILABLE', spec: WaitSpec=None) -> Union[AzureEventHub]:
    """
    ...
    """
        ...
    def setFullyConfigured(self, fullyConfigured: bool=None, override: str=None) -> AzureEventHub:
    """
    ...
    """
        ...
    def afterCreate(self, input: AzureEventHub=None) -> AzureEventHub:
    """
    ...
    """
        ...
    def withoutNonModifiableFields(self) -> AzureEventHub:
    """
    ...
    """
        ...
    @classmethod
    def fromImpl(cls, impl: Any=None) -> Union[AzureEventHub]:
    """
    ...
    """
        ...
    def listRules(self) -> Union[Array[AzureEventHubAuthorizationRule]]:
    """
    ...
    """
        ...
    def safeNamespace(self) -> AzureEventHubNamespace:
    """
    Namespace associated with the given resource
    """
        ...
    def sendMessages(self, messages: Array[CloudStreamMessage]=None) -> Union[Map[str, Error]]:
    """
    ...
    """
        ...
    def receiveMessages(self, spec: CloudStreamReceiveMessagesSpec=None) -> Union[Array[CloudStreamMessage]]:
    """
    ...
    """
        ...
    def registerReceiveMessagesAsync(self, spec: CloudStreamReceiveMessagesSpec=None) -> None:
    """
    ...
    """
        ...
    def processor(self) -> Union[CloudMessageProcessor[CloudStreamMessage, CloudStreamReceiveMessagesSpec]]:
    """
    ...
    """
    @return The number of partitions this cloud stream has
    """
        ...
    def partitions(self) -> Union[Array[str]]:
    """
    @return The identifiers of all the partitions in this cloud stream
    """
        ...
    def peekMessages(self, spec: CloudStreamReceiveMessagesSpec=None) -> Union[Array[CloudStreamMessage]]:
    """
    Peek an array of CloudMessage from the cloud stream
    If sequence number is provided, this method is the same as {@link CloudMessageBroker#receiveMessages}
    Otherwise, it returns messages within window [lastSequenceNumber-bathSize+1, lastSequenceNumber] (inclusive on both end)
    """
        ...
    @classmethod
    def fromJava(cls, javaObj: Any) -> Union[AzureEventHubFields]:
        ...
    def toJava(self) -> Union[Any]:
        ...
    @classmethod
    def parseResourceName(cls, resourceName: str) -> Union[Triple[str, str, str]]:
    """
    Parses the #resourceName in the following format: "<eventHubName>/<namespace>/<resourceGroupName>" into a
    triple where:
    fst: event hub name
    snd: event hub namespace
    thd: event hub resource group
    """
        ...
    @classmethod
    def makeResourceName(cls, eventHubName: str, namespace: str, resourceGroupName: str) -> str:
    """
    Constructs the #resourceName in the following format: "<eventHubName>/<namespace>/<resourceGroupName>"
    
    @param eventHubName
              Name of the Azure event hub instance
    @param namespace
              Name of the Azure event hub namespace
    @param resourceGroupName
              Name of the Azure event hub resource group
    @return the #resourceName in the format: "<eventHubName>:<namespace>:<resourceGroupName>"
    """
        ...
    @classmethod
    def listByNamespace(cls, resourceGroupName: str, namespaceName: str, spec: CloudListResourcesSpec=None) -> CloudListResourcesResult[AzureEventHub]:
    """
    List the Azure event hubs in a event hub namespace.
    
    @param resourceGroupName
              Name of the Azure resource group that the Azure event hub namespace is in
    @param namespaceName
              Name of the Azure event hub namespace
    @param spec
              spec to list resources.
    @return the list of Azure event hubs
    """
        ...
    def addConsumerGroup(self, groupName: str) -> None:
    """
    Add an event consumer group.
    
    @param groupName
              The name of the consumer group that will be created
    """
        ...
    def removeConsumerGroup(self, groupName: str) -> None:
    """
    Remove an event consumer group.
    
    @param groupName
              The name of the consumer group that will be removed
    """
        ...
    def listConsumerGroups(self) -> Union[Array[AzureEventHubConsumerGroupFields]]:
    """
    List all the consumer groups currently exist in this event hub.
    
    @return An array contains all the consumer groups
    """
        ...
    def consumerGroupExists(self, groupName: str, failIfMissing: bool=None) -> bool:
    """
    Determines whether consumer group exists.
    
    @param groupName
              The name of the consumer group to be checked.
    @param failIfMissing
              Throws exception if group is missing.
    @return whether the consumer group exists on this event hub resource.
    """
        ...
