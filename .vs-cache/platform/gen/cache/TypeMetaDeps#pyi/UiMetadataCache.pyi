...
from c3.platform.UiMetadataCacheEntry import UiMetadataCacheEntry

# Python definitions for the C3 type UiMetadataCache


class UiMetadataCache(MetadataCacheOld[UiMetadataCacheEntry], Value):
    """
    Cache for general tag UI metadata info
    
    @remarks this represents a made instance of UiMetadataCache
    """
    def __init__(self) -> None: ...

    @classmethod
    def get(cls, key: str) -> Union[UiMetadataCacheEntry]:
    """
    ...
    """
        ...
    @classmethod
    def require(cls, key: str) -> UiMetadataCacheEntry:
    """
    ...
    """
        ...
    @classmethod
    def put(cls, key: str, value: UiMetadataCacheEntry) -> None:
    """
    ...
    """
        ...
    @classmethod
    def produce(cls, key: str) -> Union[UiMetadataCacheEntry]:
    """
    ...
    """
        ...
    @classmethod
    def produceAll(cls) -> Union[Map[str, UiMetadataCacheEntry]]:
    """
    ...
    """
        ...
    @classmethod
    def release(cls, key: str, value: UiMetadataCacheEntry) -> None:
    """
    ...
    """
        ...
    @classmethod
    def validate(cls, value: UiMetadataCacheEntry) -> bool:
    """
    ...
    """
        ...
    @classmethod
    def metadata(cls) -> UiMetadataCacheEntry:
    """
    @return the info in the cache.
    """
        ...
    @classmethod
    def putMetadata(cls, metadata: UiMetadataCacheEntry=None) -> None:
        ...
