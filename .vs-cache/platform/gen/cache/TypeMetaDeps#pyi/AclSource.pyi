...
# Python definitions for the C3 type AclSource
...
class AclSource():
    ...
    PrivilegePolicy: Optional[str]=None
    """
    ...
    """
    def __init__(self, Default: Optional[str]=None, PrivilegePolicy: Optional[str]=None) -> None: ...
