...
# Python definitions for the C3 type ServiceGatewayConfig


class ServiceGatewayConfig(Config, Singleton):
    """
    ...
    pluginZipFolderUri: Optional[str]=None
    """
    ...
    pluginRuntimeFolder: Optional[str]=None
    """
    ...
    isProdOnlyMode: Optional[bool]=None
    """
    if set to true, plugins/<plugin-id>/target/classes is not searched for
    when locating a plugin
    """

    defaultPluginVersions: Optional[Map[str, str]]=None
    """
    Default plugin ids by plugin name.
    for example, "cdh" -> "cdh5.14.4", "impala" -> "impala2.3.7"
    """
    def __init__(self, configOverride: Optional[str]=None, secretOverride: Optional[str]=None, issues: Optional[Array[str]]=None, pluginZipFolderUri: Optional[str]=None, pluginRuntimeFolder: Optional[str]=None, isProdOnlyMode: Optional[bool]=None, defaultPluginVersions: Optional[Map[str, str]]=None) -> None: ...
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[ServiceGatewayConfig]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[ServiceGatewayConfig]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[ServiceGatewayConfig]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[ServiceGatewayConfig]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> ServiceGatewayConfig:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> ServiceGatewayConfig:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> ServiceGatewayConfig:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[ServiceGatewayConfig]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[ServiceGatewayConfig]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> ServiceGatewayConfig:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> ServiceGatewayConfig:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> ServiceGatewayConfig:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> ServiceGatewayConfig:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> ServiceGatewayConfig:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> ServiceGatewayConfig:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> ServiceGatewayConfig:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> ServiceGatewayConfig:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> ServiceGatewayConfig:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> ServiceGatewayConfig:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> ServiceGatewayConfig:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> ServiceGatewayConfig:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> ServiceGatewayConfig:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> ServiceGatewayConfig:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> ServiceGatewayConfig:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> ServiceGatewayConfig:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> ServiceGatewayConfig:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> ServiceGatewayConfig:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> ServiceGatewayConfig:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> ServiceGatewayConfig:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> ServiceGatewayConfig:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> ServiceGatewayConfig:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> ServiceGatewayConfig:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> ServiceGatewayConfig:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> ServiceGatewayConfig:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> ServiceGatewayConfig:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> ServiceGatewayConfig:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> ServiceGatewayConfig:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[ServiceGatewayConfig]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[ServiceGatewayConfig]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[ServiceGatewayConfig]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[ServiceGatewayConfig]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[ServiceGatewayConfig]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, ServiceGatewayConfig]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, ServiceGatewayConfig]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[ServiceGatewayConfig]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[ServiceGatewayConfig]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> ServiceGatewayConfig:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> ServiceGatewayConfig:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> ServiceGatewayConfig:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> ServiceGatewayConfig:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> ServiceGatewayConfig:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> ServiceGatewayConfig:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> ServiceGatewayConfig:
    """
    ...
    """
        ...
    def afterMake(self) -> ServiceGatewayConfig:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> ServiceGatewayConfig:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[ServiceGatewayConfig]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> ServiceGatewayConfig:
    """
    ...
    """
        ...
    @classmethod
    def allCached(cls, doNotProduceAll: bool=None) -> Union[Stream[ServiceGatewayConfig]]:
    """
    ...
    """
        ...
    @classmethod
    def find(cls, filter: str=None, doNotProduceAll: bool=None) -> Union[Stream[ServiceGatewayConfig]]:
    """
    ...
    """
        ...
    @classmethod
    def findBy(cls, field: str, value: Any, doNotProduceAll: bool=None) -> Union[Stream[ServiceGatewayConfig]]:
    """
    @param doNotProduceAll if true, will not populate cache and only return available cached instances. Will call
           `produceAll` if cache is empty or if Ann.cache.all is true & data has not previously been fetched.
    @return existing instances of this type that satisfy filter from data cache.
    """
        ...
    @classmethod
    def findByCacheKey(cls, key: str) -> Union[ServiceGatewayConfig]:
    """
    ...
    """
        ...
    @classmethod
    def forCacheKey(cls, key: str) -> Union[ServiceGatewayConfig]:
    """
    Returns cached instance by key, with secrets removed.
    """
        ...
    def getCached(self) -> Union[ServiceGatewayConfig]:
    """
    ...
    """
        ...
    def refreshCache(self) -> Union[ServiceGatewayConfig]:
    """
    ...
    """
        ...
    @classmethod
    def produce(cls, key: str) -> Union[ServiceGatewayConfig]:
    """
    Should produce an entry for the cache key. This method should not be called directly.
    """
        ...
    @classmethod
    def produceAll(cls) -> Union[Map[str, ServiceGatewayConfig]]:
    """
    ...
    """
        ...
    @classmethod
    def doProduceAll(cls) -> Union[Map[str, ServiceGatewayConfig]]:
    """
    ...
    """
        ...
    def getConfig(self) -> ServiceGatewayConfig:
    """
    ...
    """
        ...
    def getSecret(self) -> ServiceGatewayConfig:
    """
    ...
    """
        ...
    @classmethod
    def forConfigKey(cls, configKey: str) -> Union[ServiceGatewayConfig]:
    """
    ...
    """
        ...
    @classmethod
    def listConfigs(cls, parallel: bool=None, filter: Callable[[str], bool]=None) -> Union[Stream[ServiceGatewayConfig]]:
    """
    @param
    ...
    """
        ...
    @overload
    def setConfigValues(self, from_: ServiceGatewayConfig, override: str=None) -> None:
    """
    ...
    """
        ...
    @overload
    def setSecretValues(self, from_: ServiceGatewayConfig, override: str=None) -> None:
    """
    ...
    """
        ...
    @classmethod
    def loadConfigAndSecret(cls, configKey: str) -> Union[ServiceGatewayConfig]:
    """
    ...
    """
        ...
    def removeSecrets(self) -> Union[ServiceGatewayConfig]:
    """
    @return this config without any secret values.
    """
        ...
    def removeNonSecrets(self) -> Union[ServiceGatewayConfig]:
    """
    @return this config with only secret values.
    """
        ...
    def validate(self) -> ServiceGatewayConfig:
    """
