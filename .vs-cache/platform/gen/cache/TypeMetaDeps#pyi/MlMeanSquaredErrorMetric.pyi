...
# Python definitions for the C3 type MlMeanSquaredErrorMetric


class MlMeanSquaredErrorMetric(MlScoringMetricSupportingPd[Data, Data, { sampleWeights: Data }]):
    """
    The {@link MlMeanSquaredErrorMetric} computes the average squared error between the predicted value and target value.
    ...
    as the `modelOutput`. It represents a per-sample weighting when aggregating for MSE calculation.
    
    @remarks this represents a made instance of MlMeanSquaredErrorMetric
    """
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[MlMeanSquaredErrorMetric]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[MlMeanSquaredErrorMetric]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[MlMeanSquaredErrorMetric]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[MlMeanSquaredErrorMetric]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> MlMeanSquaredErrorMetric:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> MlMeanSquaredErrorMetric:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> MlMeanSquaredErrorMetric:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[MlMeanSquaredErrorMetric]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[MlMeanSquaredErrorMetric]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> MlMeanSquaredErrorMetric:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> MlMeanSquaredErrorMetric:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> MlMeanSquaredErrorMetric:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> MlMeanSquaredErrorMetric:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> MlMeanSquaredErrorMetric:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> MlMeanSquaredErrorMetric:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> MlMeanSquaredErrorMetric:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> MlMeanSquaredErrorMetric:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> MlMeanSquaredErrorMetric:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> MlMeanSquaredErrorMetric:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> MlMeanSquaredErrorMetric:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> MlMeanSquaredErrorMetric:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> MlMeanSquaredErrorMetric:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> MlMeanSquaredErrorMetric:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> MlMeanSquaredErrorMetric:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> MlMeanSquaredErrorMetric:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> MlMeanSquaredErrorMetric:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> MlMeanSquaredErrorMetric:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> MlMeanSquaredErrorMetric:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> MlMeanSquaredErrorMetric:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> MlMeanSquaredErrorMetric:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> MlMeanSquaredErrorMetric:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> MlMeanSquaredErrorMetric:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> MlMeanSquaredErrorMetric:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> MlMeanSquaredErrorMetric:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> MlMeanSquaredErrorMetric:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> MlMeanSquaredErrorMetric:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> MlMeanSquaredErrorMetric:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[MlMeanSquaredErrorMetric]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[MlMeanSquaredErrorMetric]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[MlMeanSquaredErrorMetric]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[MlMeanSquaredErrorMetric]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[MlMeanSquaredErrorMetric]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, MlMeanSquaredErrorMetric]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, MlMeanSquaredErrorMetric]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[MlMeanSquaredErrorMetric]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[MlMeanSquaredErrorMetric]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> MlMeanSquaredErrorMetric:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> MlMeanSquaredErrorMetric:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> MlMeanSquaredErrorMetric:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> MlMeanSquaredErrorMetric:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> MlMeanSquaredErrorMetric:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> MlMeanSquaredErrorMetric:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> MlMeanSquaredErrorMetric:
    """
    ...
    """
        ...
    def afterMake(self) -> MlMeanSquaredErrorMetric:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> MlMeanSquaredErrorMetric:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[MlMeanSquaredErrorMetric]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> MlMeanSquaredErrorMetric:
    """
