...
# Python definitions for the C3 type SqlCalcFieldsQueue


class SqlCalcFieldsQueue(CalcFieldsQueue, Value):
    """
    Invalidation queue for calc fields processing.
    
    @remarks this represents a made instance of SqlCalcFieldsQueue
    """
