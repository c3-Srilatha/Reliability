...
from c3.platform.AzureComputeBillingProfile import AzureComputeBillingProfile
from c3.platform.CloudResourceDestroySpec import CloudResourceDestroySpec
from c3.platform.WaitSpec import WaitSpec
from c3.platform.AzureVmNetworkProfile import AzureVmNetworkProfile
...
from c3.platform.AzureVirtualMachineExtensionFields import AzureVirtualMachineExtensionFields
...
from c3.platform.AzureDiagnosticsProfile import AzureDiagnosticsProfile
from c3.platform.Exclude import Exclude
from c3.platform.AzureNetworkInterface import AzureNetworkInterface
from c3.platform.CloudResourceKeyFields import CloudResourceKeyFields
from c3.platform.AzureComputePlan import AzureComputePlan
from c3.platform.CloudResource import CloudResource
from c3.platform.AzureVmOSProfile import AzureVmOSProfile
from c3.platform.Error import Error
from c3.platform.ReferenceType import ReferenceType
from c3.platform.ArrayType import ArrayType
from c3.platform.AzureComputeVirtualMachineInstanceViewInner import AzureComputeVirtualMachineInstanceViewInner
...
from c3.platform.AzureComputeAdditionalCapabilities import AzureComputeAdditionalCapabilities
from c3.platform.CloudRef import CloudRef
from c3.platform.MapBuilder import MapBuilder
from c3.platform.Promise import Promise
from c3.platform.Obj import Obj
from c3.platform.AzureVirtualMachineIdentity import AzureVirtualMachineIdentity
from c3.platform.Expr.CompileOptions import Expr.CompileOptions
from c3.platform.CloudListResourcesSpec import CloudListResourcesSpec
from c3.platform.FieldValue import FieldValue
from c3.platform.AzureVmStorageProfile import AzureVmStorageProfile
...
from c3.platform.AzureVmHardwareProfile import AzureVmHardwareProfile
from c3.platform.File import File
from c3.platform.AzureCredentials import AzureCredentials

# Python definitions for the C3 type AzureVirtualMachine


class AzureVirtualMachine(AzureGenericResource, AzureVirtualMachineFields, CloudComputeInstance, AzureNetworkInterfaceMembers):
    """
    @remarks this represents a made instance of AzureVirtualMachine
    """
    ...
    hardwareProfile: Optional[AzureVmHardwareProfile]=None

    vmId: Optional[str]=None

    proximityPlacementGroup: Optional[AzureSubResource]=None

    type_: Optional[str]=None

    licenseType: Optional[str]=None

    instanceView: Optional[AzureComputeVirtualMachineInstanceViewInner]=None

    identity: Optional[AzureVirtualMachineIdentity]=None

    billingProfile: Optional[AzureComputeBillingProfile]=None

    host: Optional[AzureSubResource]=None

    networkProfile: Optional[AzureVmNetworkProfile]=None

    diagnosticsProfile: Optional[AzureDiagnosticsProfile]=None

    id_: Optional[str]=None

    plan: Optional[AzureComputePlan]=None

    evictionPolicy: Optional[str]=None

    availabilitySet: Optional[AzureSubResource]=None

    resources: Optional[Array[AzureVirtualMachineExtensionFields]]=None
    ...
    virtualMachineScaleSet: Optional[AzureSubResource]=None

    storageProfile: Optional[AzureVmStorageProfile]=None

    name_: Optional[str]=None

    location: Optional[str]=None

    additionalCapabilities: Optional[AzureComputeAdditionalCapabilities]=None

    osProfile: Optional[AzureVmOSProfile]=None
    ...
    networkInterfaces: Optional[Array[AzureNetworkInterface]]
    """
    The network interfaces the given resource is associated with
    """
    def __init__(self, id: Optional[str]=None, cluster: Optional[str]=None, env: Optional[str]=None, app: Optional[str]=None, func: Optional[str]=None, role: Optional[str]=None, seq: Optional[str]=None, subseq: Optional[str]=None, resourceId: Optional[str]=None, resourceSecondaryId: Optional[str]=None, resourceName: Optional[str]=None, resourceGroupName: Optional[str]=None, fullyConfigured: Optional[bool]=None, resourceNamespace: Optional[str]=None, external: Optional[bool]=None, credentials: Optional[AzureCredentials]=None, hasGeneratedResourceName: Optional[bool]=None, hasGeneratedResourceSecondaryId: Optional[bool]=None, configOverride: Optional[str]=None, secretOverride: Optional[str]=None, issues: Optional[Array[str]]=None, nativeMetricByName: Optional[Map[str, str]]=None, tags: Optional[Array[CloudTag]]=None, description: Optional[str]=None, parentResource: Optional[CloudResource]=None, resourceGroup: Optional[AzureResourceGroup]=None, state: Optional[str]=None, hardwareProfile: Optional[AzureVmHardwareProfile]=None, vmId: Optional[str]=None, proximityPlacementGroup: Optional[AzureSubResource]=None, type_: Optional[str]=None, licenseType: Optional[str]=None, instanceView: Optional[AzureComputeVirtualMachineInstanceViewInner]=None, identity: Optional[AzureVirtualMachineIdentity]=None, billingProfile: Optional[AzureComputeBillingProfile]=None, host: Optional[AzureSubResource]=None, networkProfile: Optional[AzureVmNetworkProfile]=None, diagnosticsProfile: Optional[AzureDiagnosticsProfile]=None, id_: Optional[str]=None, plan: Optional[AzureComputePlan]=None, evictionPolicy: Optional[str]=None, availabilitySet: Optional[AzureSubResource]=None, resources: Optional[Array[AzureVirtualMachineExtensionFields]]=None, provisioningState: Optional[str]=None, priority: Optional[str]=None, zones: Optional[Array[str]]=None, tags_: Optional[Map[str, str]]=None, virtualMachineScaleSet: Optional[AzureSubResource]=None, storageProfile: Optional[AzureVmStorageProfile]=None, name_: Optional[str]=None, location: Optional[str]=None, additionalCapabilities: Optional[AzureComputeAdditionalCapabilities]=None, osProfile: Optional[AzureVmOSProfile]=None, instanceType: Optional[str]=None, dnsHostname: Optional[str]=None, networkInterfaces: Optional[Array[AzureNetworkInterface]]=None) -> None: ...
    ...
    @overload
    @classmethod
    def fromString(cls, s: str) -> Union[AzureVirtualMachine]:
    """
    ...
    @overload
    @classmethod
    def fromString(cls, s: str, failIfInvalid: bool=None) -> Union[AzureVirtualMachine]:
    """
    Constructs Cloud Resource instance with reference fields and credentials based on provided Cloud Reference string.
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[AzureVirtualMachine]:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> AzureVirtualMachine:
    """
    ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> AzureVirtualMachine:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> AzureVirtualMachine:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> AzureVirtualMachine:
    """
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[AzureVirtualMachine]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[AzureVirtualMachine]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[AzureVirtualMachine]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[AzureVirtualMachine]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> AzureVirtualMachine:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> AzureVirtualMachine:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> AzureVirtualMachine:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[AzureVirtualMachine]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[AzureVirtualMachine]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> AzureVirtualMachine:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> AzureVirtualMachine:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> AzureVirtualMachine:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> AzureVirtualMachine:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> AzureVirtualMachine:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> AzureVirtualMachine:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> AzureVirtualMachine:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> AzureVirtualMachine:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> AzureVirtualMachine:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> AzureVirtualMachine:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> AzureVirtualMachine:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> AzureVirtualMachine:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> AzureVirtualMachine:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> AzureVirtualMachine:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> AzureVirtualMachine:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> AzureVirtualMachine:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> AzureVirtualMachine:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> AzureVirtualMachine:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> AzureVirtualMachine:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> AzureVirtualMachine:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> AzureVirtualMachine:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> AzureVirtualMachine:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> AzureVirtualMachine:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> AzureVirtualMachine:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> AzureVirtualMachine:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> AzureVirtualMachine:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> AzureVirtualMachine:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> AzureVirtualMachine:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[AzureVirtualMachine]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[AzureVirtualMachine]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[AzureVirtualMachine]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[AzureVirtualMachine]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[AzureVirtualMachine]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, AzureVirtualMachine]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, AzureVirtualMachine]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[AzureVirtualMachine]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[AzureVirtualMachine]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> AzureVirtualMachine:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> AzureVirtualMachine:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> AzureVirtualMachine:
    """
    ...
    """
        ...
    def afterMake(self) -> AzureVirtualMachine:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> AzureVirtualMachine:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[AzureVirtualMachine]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> AzureVirtualMachine:
    """
    ...
    """
        ...
    @classmethod
    def forId(cls, id: str, failIfMissing: bool=None) -> Union[AzureVirtualMachine]:
    """
    Find Cloud Resource in Cloud Provider based on provided C3 canonical identifier.
    """
        ...
    @classmethod
    def fromClusterId(cls, clusterId: str, env: str, app: str, func: str, role: str=None, seq: str=None, subseq: str=None) -> AzureVirtualMachine:
    """
    Construct a cloud ID from a cluster ID
    """
        ...
    @classmethod
    def fromEnvId(cls, envId: str, app: str, func: str, role: str=None, seq: str=None, subseq: str=None) -> AzureVirtualMachine:
    """
    ...
    """
        ...
    @classmethod
    def fromAppId(cls, appId: str, func: str, role: str=None, seq: str=None, subseq: str=None) -> AzureVirtualMachine:
    """
    ...
    """
        ...
    @classmethod
    def fromId(cls, id: str, failIfInvalid: bool=None) -> AzureVirtualMachine:
    """
    ...
    """
        ...
    @classmethod
    def fromCloudId(cls, id: CloudId, failIfInvalid: bool=None) -> AzureVirtualMachine:
    """
    ...
    """
        ...
    def fromConfigTemplate(self, spec: CloudResourceOperationSpec=None) -> AzureVirtualMachine:
    """
    ...
    """
        ...
    def withDefaultConfig(self, spec: CloudResourceOperationSpec=None) -> AzureVirtualMachine:
    """
    ...
    """
        ...
    def upsertResource(self, spec: CloudResourceOperationSpec=None) -> AzureVirtualMachine:
    """
    Create or update Cloud Resource.
    """
        ...
    def upsertWithDependencies(self, spec: CloudResourceOperationSpec=None) -> AzureVirtualMachine:
    """
    ...
    """
        ...
    @classmethod
    def allCached(cls, doNotProduceAll: bool=None) -> Union[Stream[AzureVirtualMachine]]:
    """
    ...
    """
        ...
    @classmethod
    def find(cls, filter: str=None, doNotProduceAll: bool=None) -> Union[Stream[AzureVirtualMachine]]:
    """
    ...
    """
        ...
    @classmethod
    def findBy(cls, field: str, value: Any, doNotProduceAll: bool=None) -> Union[Stream[AzureVirtualMachine]]:
    """
    @param doNotProduceAll if true, will not populate cache and only return available cached instances. Will call
           `produceAll` if cache is empty or if Ann.cache.all is true & data has not previously been fetched.
    @return existing instances of this type that satisfy filter from data cache.
    """
        ...
    @classmethod
    def findByCacheKey(cls, key: str) -> Union[AzureVirtualMachine]:
    """
    ...
    """
        ...
    @classmethod
    def produce(cls, key: str) -> Union[AzureVirtualMachine]:
    """
    Should produce an entry for the cache key. This method should not be called directly.
    """
        ...
    @classmethod
    def produceAll(cls) -> Union[Map[str, AzureVirtualMachine]]:
    """
    ...
    """
        ...
    @classmethod
    def doProduceAll(cls) -> Union[Map[str, AzureVirtualMachine]]:
    """
    ...
    """
        ...
    def getConfig(self) -> AzureVirtualMachine:
    """
    This method on any CloudResource is not supported! Use CloudResource.for* or other methods instead.
    """
        ...
    ...
    """
        ...
    def getSecret(self) -> AzureVirtualMachine:
    """
    ...
    """
        ...
    @classmethod
    def forConfigKey(cls, configKey: str) -> Union[AzureVirtualMachine]:
    """
    ...
    """
        ...
    @classmethod
    def listConfigs(cls, parallel: bool=None, filter: Callable[[str], bool]=None) -> Union[Stream[AzureVirtualMachine]]:
    """
    @param
    ...
    """
        ...
    @overload
    def setConfigValues(self, from_: AzureVirtualMachine, override: str=None) -> None:
    """
    ...
    """
        ...
    @overload
    def setSecretValues(self, from_: AzureVirtualMachine, override: str=None) -> None:
    """
    ...
    """
        ...
    @classmethod
    def loadConfigAndSecret(cls, configKey: str) -> Union[AzureVirtualMachine]:
    """
    ...
    """
        ...
    def removeSecrets(self) -> Union[AzureVirtualMachine]:
    """
    @return this config without any secret values.
    """
        ...
    def removeNonSecrets(self) -> Union[AzureVirtualMachine]:
    """
    @return this config with only secret values.
    """
        ...
    def validate(self) -> AzureVirtualMachine:
    """
    ...
    """
        ...
    def withIdentity(self, resource: CloudResource=None, spec: CloudResourceOperationSpec=None) -> AzureVirtualMachine:
    """
    ...
    """
        ...
    def mergeId(self, other: CloudResource=None) -> AzureVirtualMachine:
    """
    ...
    """
        ...
    @classmethod
    def forCloudId(cls, id: CloudId, failIfMissing: bool=None) -> Union[AzureVirtualMachine]:
    """
    ...
    """
        ...
    @classmethod
    def forCloudFunc(cls, func: str, role: str=None, failIfMissing: bool=None) -> AzureVirtualMachine:
    """
    Find Cloud Resource based on provided cloud func component and optional role.
    """
        ...
    @classmethod
    def forCloudRole(cls, role: str, failIfMissing: bool=None) -> AzureVirtualMachine:
    """
    Find Cloud Resource of this type based on provided cloud role component.
    """
        ...
    @classmethod
    def forResourceId(cls, resourceId: str, failIfMissing: bool=None) -> Union[AzureVirtualMachine]:
    """
    Find Cloud Resource in the Cloud Provider by provided resource name.
    """
        ...
    @classmethod
    def forResourceSecondaryId(cls, resourceId: str, failIfMissing: bool=None) -> Union[AzureVirtualMachine]:
    """
    Find Cloud Resource in the Cloud Provider by provided resource name.
    """
        ...
    ...
    """
        ...
    @classmethod
    def forResourceName(cls, resourceName: str, failIfMissing: bool=None) -> Union[AzureVirtualMachine]:
    """
    Find Cloud Resource in the Cloud Provider by provided resource name.
    """
        ...
    @classmethod
    def findResource(cls, reference: str, failIfMissing: bool=None) -> Union[AzureVirtualMachine]:
    """
    Find Cloud Resource in the Cloud Provider by provided {@link CloudRef} string.
    """
        ...
    def getResource(self) -> Union[AzureVirtualMachine]:
    """
    Find Cloud Resource in the Cloud Provider by provided #resourceId, #resourceSecondaryId, #resourceName or #tags
    (in that order).
    """
        ...
    def ensureResource(self) -> AzureVirtualMachine:
    """
    Checks that the resource is persisted. If not, upserts the resource, to ensure that the resource exists.
    """
        ...
    @classmethod
    def listResourcesBySubtype(cls, spec: CloudListResourcesSpec=None) -> Map[str, CloudListResourcesResult[AzureVirtualMachine]]:
    """
    ...
    """
        ...
    @classmethod
    def listResources(cls, spec: CloudListResourcesSpec=None) -> CloudListResourcesResult[AzureVirtualMachine]:
    """
    ...
    """
        ...
    @classmethod
    def listResourcesForTags(cls, *keyValuePairs: Array[str]) -> CloudListResourcesResult[AzureVirtualMachine]:
    """
    List all Cloud Resources that satisfies the given spec.
    ...
    """
        ...
    @classmethod
    def listResourcesForClusterId(cls, clusterId: str, cloudIdRole: str=None, spec: CloudListResourcesSpec=None) -> CloudListResourcesResult[AzureVirtualMachine]:
    """
    List all Cloud Resources that satisfies the given spec.
    ...
    """
        ...
    @classmethod
    def listResourcesForEnvId(cls, envId: str, cloudIdRole: str=None, spec: CloudListResourcesSpec=None) -> CloudListResourcesResult[AzureVirtualMachine]:
    """
    List all Cloud Resources that satisfies the given spec.
    ...
    """
        ...
    @classmethod
    def listResourcesForAppId(cls, appId: str, cloudIdRole: str=None, spec: CloudListResourcesSpec=None) -> CloudListResourcesResult[AzureVirtualMachine]:
    """
    List all Cloud Resources that satisfies the given spec.
    ...
    """
        ...
    def upsertDependencies(self, spec: CloudResourceOperationSpec=None) -> AzureVirtualMachine:
    """
    ...
    """
        ...
    def waitForCreate(self, spec: WaitSpec=None) -> Union[AzureVirtualMachine]:
    """
    ...
    """
        ...
    @classmethod
    def tagResourcesBatch(cls, resources: Array[AzureVirtualMachine], tags: Array[CloudTag]) -> Union[Map[str, Error]]:
    """
    ...
    """
        ...
    @classmethod
    def untagResourcesBatch(cls, resources: Array[AzureVirtualMachine], tagKeys: Array[str]) -> Union[Map[str, Error]]:
    """
    ...
    """
        ...
    def waitForOk(self, spec: WaitSpec=None) -> Union[AzureVirtualMachine]:
    """
    ...
    """
        ...
    def waitForState(self, state: str='AVAILABLE', spec: WaitSpec=None) -> Union[AzureVirtualMachine]:
    """
    ...
    """
        ...
    def setFullyConfigured(self, fullyConfigured: bool=None, override: str=None) -> AzureVirtualMachine:
    """
    ...
    """
        ...
    def afterCreate(self, input: AzureVirtualMachine=None) -> AzureVirtualMachine:
    """
    ...
    """
        ...
    def beforeCreate(self) -> AzureVirtualMachine:
    """
    Optional callback to alter resource before creating it.
    """
        ...
    def beforeUpdate(self) -> AzureVirtualMachine:
    """
    Optional callback to alter resource before updating it.
    """
        ...
    def beforeDestroy(self) -> AzureVirtualMachine:
    """
    ...
    """
        ...
    def withoutNonModifiableFields(self) -> AzureVirtualMachine:
    """
    ...
    """
        ...
    @classmethod
    def fromImpl(cls, impl: Any=None) -> Union[AzureVirtualMachine]:
    """
    ...
    """
        ...
    @classmethod
    def fromJava(cls, javaObj: Any) -> Union[AzureVirtualMachine]:
        ...
    ...
    """
        ...
    def safeNetworkInterfaces(self) -> Array[AzureNetworkInterface]:
    """
    Get the network interfaces associated with this resource
    """
        ...
    def applyExtensionCommand(self, command: str) -> None:
        ...
