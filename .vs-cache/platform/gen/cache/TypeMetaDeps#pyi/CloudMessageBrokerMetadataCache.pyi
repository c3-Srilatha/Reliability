...
# Python definitions for the C3 type CloudMessageBrokerMetadataCache


class CloudMessageBrokerMetadataCache(MetadataCacheOld[set[Type]], Value):
    """
    Type to hold all inbound message types per cloud message broker (ie. sqs, kinesis, event hub, ect.) for the tag.
    
    @remarks this represents a made instance of CloudMessageBrokerMetadataCache
    """
    def __init__(self) -> None: ...

    @classmethod
    def get(cls, key: str) -> Union[Set[Type]]:
    """
    ...
    """
        ...
    @classmethod
    def require(cls, key: str) -> Set[Type]:
    """
    ...
    """
        ...
    @classmethod
    def put(cls, key: str, value: Set[Type]) -> None:
    """
    ...
    """
        ...
    @classmethod
    def produce(cls, key: str) -> Union[Set[Type]]:
    """
    ...
    """
        ...
    @classmethod
    def produceAll(cls) -> Union[Map[str, Set[Type]]]:
    """
    ...
    """
        ...
    @classmethod
    def release(cls, key: str, value: Set[Type]) -> None:
    """
    ...
    """
        ...
    @classmethod
    def validate(cls, value: Set[Type]) -> bool:
    """
