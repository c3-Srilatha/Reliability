...
# Python definitions for the C3 type MutableObjProtocol


class MutableObjProtocol(ObjProtocol, Mutable, Value):
    """
    ...
    @remarks this represents a made instance of MutableObjProtocol
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> MutableObjProtocol:
    """
    ...
    """
        ...
    @classmethod
    def make(cls) -> MutableObjProtocol:
    """
    Construct an instance with initial state.
    """
        ...
    def setFieldValue(self, name: str, value: Any) -> None:
    """
    Implements the `obj.name = value` syntactic sugar in js and py.
    Also, conditionally implements the square bracket `[]` syntactic sugar in js and py for key-type string.
    @param name
            name associated with the desired attribute.
    @param value
            value associated with the desired attribute.
    """
        ...
    ...
    Also, conditionally implements the square bracket `[]` syntactic sugar in js and py for key-type string.
    @param name
            name associated with the desired attribute to remove.
    """
        ...
