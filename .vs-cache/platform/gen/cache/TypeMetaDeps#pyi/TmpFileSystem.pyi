...
from c3.platform.TmpFileSpec import TmpFileSpec
...
# Python definitions for the C3 type TmpFileSystem


class TmpFileSystem(VirtualFileSystem, FileSystemConfigurable[TmpFsConfig]):
    """
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[TmpFileSystem]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[TmpFileSystem]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[TmpFileSystem]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[TmpFileSystem]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> TmpFileSystem:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> TmpFileSystem:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> TmpFileSystem:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[TmpFileSystem]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[TmpFileSystem]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> TmpFileSystem:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> TmpFileSystem:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> TmpFileSystem:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> TmpFileSystem:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> TmpFileSystem:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> TmpFileSystem:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> TmpFileSystem:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> TmpFileSystem:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> TmpFileSystem:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> TmpFileSystem:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> TmpFileSystem:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> TmpFileSystem:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> TmpFileSystem:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> TmpFileSystem:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> TmpFileSystem:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> TmpFileSystem:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> TmpFileSystem:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> TmpFileSystem:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> TmpFileSystem:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> TmpFileSystem:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> TmpFileSystem:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> TmpFileSystem:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> TmpFileSystem:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> TmpFileSystem:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> TmpFileSystem:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> TmpFileSystem:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> TmpFileSystem:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> TmpFileSystem:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[TmpFileSystem]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[TmpFileSystem]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[TmpFileSystem]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[TmpFileSystem]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[TmpFileSystem]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, TmpFileSystem]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, TmpFileSystem]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[TmpFileSystem]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[TmpFileSystem]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> TmpFileSystem:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> TmpFileSystem:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> TmpFileSystem:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> TmpFileSystem:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> TmpFileSystem:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> TmpFileSystem:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> TmpFileSystem:
    """
    ...
    """
        ...
    def afterMake(self) -> TmpFileSystem:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> TmpFileSystem:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[TmpFileSystem]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> TmpFileSystem:
    """
    ...
    """
        ...
    def config(self, secrets: bool=None) -> TmpFsConfig:
    """
    Returns cached configuration object for instance of this file system.
    """
        ...
    @classmethod
    def createTmpFile(cls, spec: TmpFileSpec=None) -> File:
    """
    Make a temporary file
    """
        ...
    @classmethod
    def createTmpDirectory(cls, spec: TmpFileSpec=None) -> str:
    """
    ...
    """
        ...
    @classmethod
    def reapTmpFiles(cls, clusterWide: bool=None) -> None:
    """
