...
# Python definitions for the C3 type Env.Agent


class Agent(Server):
    """
    Represents an agent node. I.e. one responsible for managing a single compute instance and monitoring health of the
    software running on it.
    
    @see Cluster.Leader
    @see Cluster.Worker
    
    @remarks this represents a made instance of Env.Agent
    """
    ...
    """
    Leader node managing this node
    """
    ...
    """
        ...
    @classmethod
    def fromString(cls, s: str) -> Union[Env.Agent]:
    """
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[Env.Agent]:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> Env.Agent:
    """
    ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> Env.Agent:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> Env.Agent:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> Env.Agent:
    """
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[Env.Agent]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[Env.Agent]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[Env.Agent]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[Env.Agent]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> Env.Agent:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> Env.Agent:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> Env.Agent:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[Env.Agent]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[Env.Agent]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> Env.Agent:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> Env.Agent:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> Env.Agent:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> Env.Agent:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> Env.Agent:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> Env.Agent:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> Env.Agent:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> Env.Agent:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> Env.Agent:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> Env.Agent:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> Env.Agent:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> Env.Agent:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> Env.Agent:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> Env.Agent:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> Env.Agent:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> Env.Agent:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> Env.Agent:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> Env.Agent:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> Env.Agent:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> Env.Agent:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> Env.Agent:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> Env.Agent:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> Env.Agent:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> Env.Agent:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> Env.Agent:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> Env.Agent:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> Env.Agent:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> Env.Agent:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[Env.Agent]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[Env.Agent]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[Env.Agent]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[Env.Agent]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[Env.Agent]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, Env.Agent]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, Env.Agent]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[Env.Agent]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[Env.Agent]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> Env.Agent:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> Env.Agent:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> Env.Agent:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> Env.Agent:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[Env.Agent]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> Env.Agent:
    """
    ...
    """
        ...
    @classmethod
    def forId(cls, id: str, failIfMissing: bool=None) -> Union[Env.Agent]:
    """
    ...
    """
        ...
    @classmethod
    def fromId(cls, id: Server.Id) -> Env.Agent:
    """
