...
# Python definitions for the C3 type CollectionType


class CollectionType(ValueType):
    """
    "Collection type" is the base type for all specific collection value types: array, set, map and stream.
    
    Collections all share the behavior of holding elements of a single value type.
    
    - An {@link ArrayType array} is a collection whose elements are ordered and are accessed by index.
      Arrays allow nulls or duplicates.
    - A {@link SetType set} is a special array which does not allow nulls and duplicates.
      Like arrays, sets are also ordered and accessed by index.
    - A {@link MapType map} is an associative array of elements.  The key can be any primitive value type,
      although most maps are indexed by strings.
    - A {@link StreamType stream} is a read-once collection.  Streams may be arbitrarily large, larger than can fit into
      memory at any one time, so care should be taken not to materialize them all at once.
    
    For programming convenience, instances of collections use underlying language binding facilities where appropriate:
    - In Java, arrays (and sets) implement the java.util.List interface and map collections implement Map.
    - In JavaScript, arrays and sets extend Array and maps are objects.
    - In Python, arrays and sets are lists and maps are dictionaries.
    
    It is also possible to declare _any collection_ using the `collection<..>` syntax. This refers to any collection
    type and specifies only the element type. Instances of any of the concrete collection types are allowed (as long as
    the element type is compatible).
    ...
    @remarks this represents a made instance of CollectionType
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> CollectionType:
    """
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[CollectionType]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[CollectionType]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[CollectionType]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[CollectionType]:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> CollectionType:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> CollectionType:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[CollectionType]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[CollectionType]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> CollectionType:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> CollectionType:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> CollectionType:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> CollectionType:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> CollectionType:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> CollectionType:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> CollectionType:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> CollectionType:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> CollectionType:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> CollectionType:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> CollectionType:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> CollectionType:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> CollectionType:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> CollectionType:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> CollectionType:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> CollectionType:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> CollectionType:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> CollectionType:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> CollectionType:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> CollectionType:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> CollectionType:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> CollectionType:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> CollectionType:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> CollectionType:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> CollectionType:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> CollectionType:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> CollectionType:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> CollectionType:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[CollectionType]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[CollectionType]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[CollectionType]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[CollectionType]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[CollectionType]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, CollectionType]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, CollectionType]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[CollectionType]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[CollectionType]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> CollectionType:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> CollectionType:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> CollectionType:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> CollectionType:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> CollectionType:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> CollectionType:
    """
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[CollectionType]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> CollectionType:
    """
    ...
    """
        ...
    def afterMake(self) -> CollectionType:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> CollectionType:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[CollectionType]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> CollectionType:
    """
    ...
    """
        ...
    def withoutDeclaredSrcPos(self, recursive: bool=None) -> CollectionType:
    """
    ...
    """
        ...
    @overload
    def withAnnotation(self, ann: Annotation) -> CollectionType:
    """
    Add an annotation to the given metadata
    """
        ...
    @overload
    def withAnnotation(self, ann: str, annField: str=None, value: Any=None) -> CollectionType:
    """
    Add an annotation to the given metadata
    @param ann
            annotation to add
    ...
    """
        ...
    @classmethod
    def fromString(cls, s: str) -> Union[CollectionType]:
    """
    ...
    """
    @return the factory method name for this collection type (e.g., "ofInt", "ofStr", "ofDbl") using the type (e.g., ArrayType).
    """
        ...
    @overload
    ...
    """
    @param instanceType
           if true, returns the method name for factory method invocation on an instance type (e.g., for `Array.ofInt()`
           vs for `ArrayType.ofInt()`)
    @return the factory method name for this collection type (e.g., "ofInt", "ofStr", "ofDbl").
    """
        ...
    @overload
    def factoryMethodExpr(self) -> str:
    """
    @return a code expression that instantiates this collection type (e.g., "ArrayType.ofStr()", "Array.ofInt()").
    """
        ...
    @overload
    ...
    """
    @param instanceType
           if true, use instance type for the expression (e.g., Array vs ArrayType)
    @return a code expression that instantiates this collection type (e.g., "ArrayType.ofStr()", "Array.ofInt()").
    """
        ...
    ...
    """
    @return an empty collection (i.e. a collection containing no elements) of this CollectionType
    """
        ...
