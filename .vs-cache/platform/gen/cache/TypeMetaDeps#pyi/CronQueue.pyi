...
# Python definitions for the C3 type CronQueue


class CronQueue(InvalidationQueue[CronQueueEntry], Value):
    """
    ...
    @classmethod
    def compute(cls, targetType: Type, entries: Array[CronQueueEntry]) -> None:
    """
    ...
    """
        ...
    @classmethod
    def find(cls, spec: InvalidationQueue.FindSpec=None) -> Union[Array[CronQueueEntry]]:
    """
    ...
    """
        ...
    @classmethod
    def findStream(cls, spec: InvalidationQueue.FindStreamSpec=None) -> Union[Stream[CronQueueEntry]]:
    """
    ...
    """
        ...
    @classmethod
    def clearEntries(cls, entries: Array[CronQueueEntry]) -> None:
    """
    ...
    """
        ...
    @classmethod
    def needsInvalidation(cls) -> bool:
    """
    ...
    """
        ...
    @classmethod
    def invalidateCron(cls) -> None:
    """
    Invalidates the appropriate cron jobs.
    """
        ...
    @classmethod
    def disableInvalidation(cls) -> None:
    """
