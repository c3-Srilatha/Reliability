...
# Python definitions for the C3 type Collection

E = TypeVar('E')

class Collection(Generic[E], CollectionStats, Serializable, WithToString, Fingerprintable, MemoryMeasurable, CollectionStdLib[E], WithType, Zippable[E], Instance, Value):
    """
    ...
    @remarks this represents a made instance of Collection
    """
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[Collection[E]]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[Collection[E]]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[Collection[E]]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[Collection[E]]:
    """
    ...
    """
        ...
    def abs(self) -> Union[Collection[E]]:
        ...
    @overload
    ...
    """
        ...
    def normalize(self) -> Union[Collection[E]]:
        ...
    def at(self, index: int) -> Union[E]:
        ...
    def pluck(self, fieldPath: str, vtOverride: ValueType=None) -> Union[Collection[T]]:
        ...
    @overload
    ...
    """
        ...
    @overload
    def first(self, n: int) -> Union[Collection[E]]:
    """
    @return first element in this collection.
    """
        ...
    ...
    """
        ...
    @overload
    def last(self, n: int) -> Union[Collection[E]]:
    """
    @return last element of this collection.
    """
        ...
    ...
    """
        ...
    def round(self, decimals: int=None) -> Union[Collection[E]]:
        ...
    def invert(self) -> Union[Collection[E]]:
        ...
    ...
    """
        ...
    def flatMapToSame(self, mapper: Callable[[Union[E]], Union[CollectionStdLib[E]]]) -> Union[Collection[E]]:
    """
    ...
    """
        ...
    def flatMap(self, mapper: Callable[[Union[E]], Union[CollectionStdLib[T]]]) -> Union[Collection[T]]:
    """
    ...
    """
        ...
    def flatMapTo(self, elementType: ValueType, mapper: Callable[[Union[E]], Union[CollectionStdLib[T]]]) -> Union[Collection[T]]:
    """
    ...
    """
        ...
    def flatMapRecursive(self, toInters: Callable[[Union[E]], Union[CollectionStdLib[I]]], fromInter: Callable[[Union[I]], Union[E]]) -> Union[Collection[E]]:
    """
    ...
    """
        ...
    def compact(self) -> Union[Collection[E]]:
    """
    @return new collection with empty elements removed.
    """
        ...
    def unique(self) -> Union[Collection[E]]:
    """
    @return new collection with duplicate elements removed.
    """
        ...
    def uniqueBy(self, key: Callable[[Union[E]], Union[Any]]=None) -> Union[Collection[E]]:
    """
    @return new collection with duplicate elements removed based on provided key supplier.
    """
        ...
    @overload
    def filter(self, predicate: Callable[[Union[E]], bool]) -> Union[Collection[E]]:
    """
    Filters elements from this collection based on evaluation result of the provided filter predicate.
    """
        ...
    @overload
    def filter(self, filter: str) -> Union[Collection[E]]:
    """
    Filters elements from this collection based on evaluation result of the provided filter predicate.
    """
        ...
    @overload
    def filter(self, fields: Map[str, Any]) -> Union[Collection[E]]:
    """
    Filters elements from this collection based on evaluation result of the provided filter predicate.
    """
        ...
    def fillMissingBy(self, method: str='PREVIOUS', spec: FillMissingSpec=None) -> Union[Collection[E]]:
        ...
    def fillMissing(self, value: Any, spec: FillMissingSpec=None) -> Union[Collection[E]]:
        ...
    def fieldNames(self) -> Union[Array[str]]:
        ...
    def fieldValueType(self, field: str) -> Union[ValueType]:
        ...
    def reject(self, predicate: Callable[[Union[E]], bool]) -> Union[Collection[E]]:
    """
    Rejects elements from this collection based on evaluation result of the provided filter expression.
    """
        ...
    @overload
    def include(self, include: str) -> Union[Collection[E]]:
    """
    ...
    """
        ...
    @overload
    def include(self, positions: Collection[int]) -> Union[Collection[E]]:
    """
    Maps this collection to another by removing fields from every element that are not part of the provided include
    spec. If include spec is not provided then does nothing.
    """
        ...
    def exclude(self, exclude: str) -> Union[Collection[E]]:
    """
    ...
    """
        ...
    def replaceByPredicate(self, e: E, predicate: Callable[[Union[E]], bool]) -> Union[Collection[E]]:
        ...
    @overload
    def sorted(self, descending: bool=None) -> Union[Collection[E]]:
    """
    ...
    """
        ...
    @overload
    def sorted(self, comparator: Callable[[Union[E], Union[E]], Union[int]]) -> Union[Collection[E]]:
    """
    Maps this collection to another by re-ordering elements based on natural sorting order.
    ...
    """
        ...
    @overload
    def sorted(self, descending: bool, comparator: Callable[[Union[E], Union[E]], Union[int]]) -> Union[Collection[E]]:
    """
    Maps this collection to another by re-ordering elements based on natural sorting order.
    ...
    """
        ...
    @overload
    def sorted(self, order: str) -> Union[Collection[E]]:
    """
    Maps this collection to another by re-ordering elements based on natural sorting order.
    ...
    """
        ...
    @overload
    def sortedBy(self, key: Callable[[Union[E]], Union[Any]]) -> Union[Collection[E]]:
    """
    ...
    """
        ...
    @overload
    def sortedBy(self, descending: bool, key: Callable[[Union[E]], Union[Any]]) -> Union[Collection[E]]:
    """
    Maps this collection to another by re-ordering elements based on natural sorting order of a key computed using
    provided lambda.
    """
    ...
    """
        ...
    def batch(self, batchSize: int=None) -> Union[Stream[Collection[E]]]:
    """
    ...
    def elementCartesianProduct(self) -> Union[Array[Array[T]]]:
        ...
    @overload
    def flatten(self, shallow: bool=None) -> Union[Collection[T]]:
    """
    ...
    """
        ...
    @overload
    def flatten(self, depth: int, include: str=None) -> Union[Collection[T]]:
    """
    @return new collection with all nested arrays flattened. The nesting can be to any depth unless `shallow`
            parameter is `true` in which case this collection will only be flattened a single level.
    """
        ...
    def sample(self, spec: SampleSpec=None) -> Union[Collection[E]]:
    """
    Produce a random sample from this collection with `count` number of elements.
    """
        ...
    @overload
    def slice(self, fromPos: int, toPos: int=None, stride: int=None) -> Union[Collection[E]]:
    """
    ...
    """
        ...
    @overload
    def slice(self, positions: Collection[int]) -> Union[Collection[E]]:
    """
    Creates a new collection from elements starting at #fromIndex. Positive value of index is relative to the first
    position in the collection. Negative value of the index is relative to last position in the collection.
    If #fromIndex is 0, returns same collection.
    """
        ...
    @overload
    def sliceByKey(self, keys: Collection[Any]) -> Union[Collection[E]]:
        ...
    @overload
    def sliceByKey(self, secondaryIndex: str, keys: Collection[Any]) -> Union[Collection[E]]:
        ...
    ...
    """
        ...
    def downsample(self, spec: DownsampleSpec) -> Union[Collection[E]]:
    """
    ...
    """
        ...
    def rollingDiff(self, stride: int='1') -> Union[Collection[E]]:
        ...
    def pctChange(self, stride: int='1') -> Union[Collection[E]]:
        ...
    def unaryOp(self, op: str) -> Union[Collection[E]]:
        ...
    def shape(self) -> Union[Array[int]]:
        ...
    def toObj(self) -> Union[Obj]:
        ...
    def fetch(self, spec: FetchSpec=None) -> Union[Collection[E]]:
        ...
    ...
    def histogram(self, spec: HistogramSpec=None) -> Histogram[Any, Any, HistogramBuilder]:
        ...
    def neg(self) -> Union[Collection[E]]:
        ...
    ...
    def timeseries(self, spec: DataTimeseriesSpec=None) -> Union[Collection[R]]:
        ...
    @overload
    def timeseries(self, tsFieldSpec: Map[str, TimeseriesFieldSpec], spec: TimeseriesSpec=None) -> Union[Collection[R]]:
        ...
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> Collection[E]:
    """
    ...
    """
        ...
    def inferType(self) -> Union[Collection]:
    """
    ...
    **within and across chunk/partition**, this method allows for different lambdas to be applied in each case.
    ...
    """
        ...
    def toMixingCollection(self, collectionType: CollectionType, failIfInvalid: bool=None) -> Union[Collection[T]]:
    """
    ...
    """
        ...
    def boxElements(self) -> Union[Collection[Boxed[E]]]:
    """
    @return copy of this collection with all elements Boxed.
    """
        ...
    def anonymize(self, spec: AnonymizationSpec=None) -> Union[Collection[E]]:
    """
    ...
    """
        ...
    def withoutOutliers(self, spec: OutliersSpec='{ stddev: 2 }') -> Collection[E]:
    """
    ...
    """
        ...
    def extractOutliers(self, spec: OutliersSpec='{ stddev: 2 }') -> Collection[E]:
    """
    ...
    """
        ...
    def with(self, e: E) -> Collection[E]:
    """
    @return new collection with a new element added to it.
    """
        ...
    def withSome(self, e: E, *more: Array[E]) -> Collection[E]:
    """
    @return new collection with a new elements added to it.
    """
        ...
    def withAll(self, elements: Collection[E]) -> Union[Collection[E]]:
    """
    @return new collection with the provided elements added to it.
    """
        ...
    def without(self, e: E) -> Union[Collection[E]]:
    """
    @return new collection without the provided element.
    """
        ...
    def withoutSome(self, e: E, *more: Array[E]) -> Union[Collection[E]]:
    """
    @return new collection without the provided elements.
    """
        ...
    def withoutAny(self, predicate: Callable[[Union[E]], bool]) -> Union[Collection[E]]:
    """
    @return new collection without elements satisfying provided predicate.
    """
        ...
    def withoutAll(self, elements: Array[E]) -> Union[Collection[E]]:
    """
    @return new collection with the provided elements removed.
    """
        ...
    def difference(self, other: Collection[E]) -> Union[Collection[E]]:
    """
    @return new collection with elements that are not present in provided collection.
    """
        ...
    @classmethod
    def intersection(cls, *collections: Array[Collection[E]]) -> Union[Collection[E]]:
    """
    ...
    """
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> Collection:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> Union[Collection[E]]:
    """
    ...
    """
        ...
    @overload
    def rolling(self, agg: str, offset: int, span: int, step: int=None) -> Union[Collection[E]]:
    """
