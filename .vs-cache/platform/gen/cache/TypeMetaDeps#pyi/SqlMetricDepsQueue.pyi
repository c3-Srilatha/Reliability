...
# Python definitions for the C3 type SqlMetricDepsQueue


class SqlMetricDepsQueue(MetricDepsQueue, Value):
    """
    Invalidation queue for metric dependency processing processing.
    
    @remarks this represents a made instance of SqlMetricDepsQueue
    """
