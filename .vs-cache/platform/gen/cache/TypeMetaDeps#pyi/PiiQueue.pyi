...
from c3.platform.PiiQueueEntry import PiiQueueEntry
...
# Python definitions for the C3 type PiiQueue


class PiiQueue(InvalidationQueue[PiiQueueEntry], Value):
    """
    ...
    @classmethod
    def compute(cls, targetType: Type, entries: Array[PiiQueueEntry]) -> None:
    """
    ...
    """
        ...
    @classmethod
    def find(cls, spec: InvalidationQueue.FindSpec=None) -> Union[Array[PiiQueueEntry]]:
    """
    ...
    """
        ...
    @classmethod
    def findStream(cls, spec: InvalidationQueue.FindStreamSpec=None) -> Union[Stream[PiiQueueEntry]]:
    """
    ...
    """
        ...
    @classmethod
    def clearEntries(cls, entries: Array[PiiQueueEntry]) -> None:
    """
    ...
    """
        ...
    @classmethod
    def submitEvents(cls, typeRef: Type, events: Array[PiiAccessEvent], autoCommit: bool='true') -> None:
        ...
