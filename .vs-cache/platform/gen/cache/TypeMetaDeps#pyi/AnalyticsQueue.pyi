...
from c3.platform.AnalyticsQueueEntry import AnalyticsQueueEntry
...
# Python definitions for the C3 type AnalyticsQueue


class AnalyticsQueue(InvalidationQueue[AnalyticsQueueEntry], MergeableInvalidationQueue[AnalyticsQueueEntry], Value):
    """
    Invalidation queue for analytic invalidation processing.  Entries are added whenever data changes that a
    {@link SimpleMetric} used by an analytic depends on.  The appropriate time range information is included in the
    entry to enable the analytic to be processed for only the affected time range.
    
    @see AnalyticsQueueEntry
    
    @remarks this represents a made instance of AnalyticsQueue
    """
    def __init__(self) -> None: ...

    @classmethod
    def compute(cls, targetType: Type, entries: Array[AnalyticsQueueEntry]) -> None:
    """
    ...
    """
        ...
    @classmethod
    def find(cls, spec: InvalidationQueue.FindSpec=None) -> Union[Array[AnalyticsQueueEntry]]:
    """
    ...
    """
        ...
    @classmethod
    def findStream(cls, spec: InvalidationQueue.FindStreamSpec=None) -> Union[Stream[AnalyticsQueueEntry]]:
    """
    ...
    """
        ...
    @classmethod
    def clearEntries(cls, entries: Array[AnalyticsQueueEntry]) -> None:
    """
    ...
    """
        ...
    @classmethod
    def mergeContexts(cls, targetType: Type=None, entries: Array[AnalyticsQueueEntry]=None) -> Union[Array[AnalyticsQueueEntry]]:
    """
    ...
    """
        ...
    @classmethod
    def invalidateSources(cls, tag: Tag=None, srcs: Array[MetricGroupInvalidationSpec]=None) -> None:
    """
    Creates entries in the queue to invalidate analytics.  When processed, these entries will be used
    to call {@link AnalyticsContainer.invalidateSources}.
    
    @param tag
              Target tag to invalidate analytics sources for
    @param srcs
              Specification of the source objs to invalidate along with various parameters
    """
        ...
