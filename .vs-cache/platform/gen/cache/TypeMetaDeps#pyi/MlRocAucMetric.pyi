...
# Python definitions for the C3 type MlRocAucMetric


class MlRocAucMetric(MlScoringMetricSupportingPd[Data, Data, { sampleWeights: Data }]):
    """
    The {@link MlRocAucMetric} computes the AUC-ROC score, which is the Area Under Curve (AUC)
    score of the Receiver Operating Characteristic (ROC) curve. This metric only works for binary classification.
    This score is used to measure the ability of a binary classifier to distinguish between
    classes. To find the ROC curve, we find true positive rates (TPR) and false positive rates (FPR) for a
    number of thresholds. The curve is then used to find the AUC score.
    The `modelOutput` is expected to be two-dimensional with predicted probabilities for class '0' and '1'.
    The `targetOutput` is expected to be single-dimensional with binary (i.e. 0 and 1) data.
    Column '1' will be used for scoring. This metric supports `sampleWeights` as `context`.
    The `sampleWeights` is single-dimensional with same number of samples as the `modelOutput`. It represents
    a per-sample weighting when aggregating for AUC-ROC score calculation. This metric is a wrapper around the sklearn
    version of (roc_auc_score)[https://scikit-learn.org/stable/modules/generated/sklearn.metrics.roc_auc_score.html]
    
    @remarks this represents a made instance of MlRocAucMetric
    """
    ...
    """
    The `average` is a string that defines the behavior when aggregating the metric values for different classes.
    The `average` supports 'micro', 'macro', 'weighted', 'sample' or None. It defaults to 'macro',
    ...
    instances for each label). 'samples': Calculate metrics for each instance, and find their average.
    """
    def __init__(self, name: Optional[str]=None, useIndex: Optional[bool]=None, batchSize: Optional[int]=None, average: Optional[str]=None) -> None: ...
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[MlRocAucMetric]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[MlRocAucMetric]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[MlRocAucMetric]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[MlRocAucMetric]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> MlRocAucMetric:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> MlRocAucMetric:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> MlRocAucMetric:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[MlRocAucMetric]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[MlRocAucMetric]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> MlRocAucMetric:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> MlRocAucMetric:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> MlRocAucMetric:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> MlRocAucMetric:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> MlRocAucMetric:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> MlRocAucMetric:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> MlRocAucMetric:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> MlRocAucMetric:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> MlRocAucMetric:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> MlRocAucMetric:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> MlRocAucMetric:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> MlRocAucMetric:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> MlRocAucMetric:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> MlRocAucMetric:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> MlRocAucMetric:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> MlRocAucMetric:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> MlRocAucMetric:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> MlRocAucMetric:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> MlRocAucMetric:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> MlRocAucMetric:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> MlRocAucMetric:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> MlRocAucMetric:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> MlRocAucMetric:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> MlRocAucMetric:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> MlRocAucMetric:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> MlRocAucMetric:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> MlRocAucMetric:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> MlRocAucMetric:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[MlRocAucMetric]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[MlRocAucMetric]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[MlRocAucMetric]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[MlRocAucMetric]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[MlRocAucMetric]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, MlRocAucMetric]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, MlRocAucMetric]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[MlRocAucMetric]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[MlRocAucMetric]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> MlRocAucMetric:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> MlRocAucMetric:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> MlRocAucMetric:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> MlRocAucMetric:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> MlRocAucMetric:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> MlRocAucMetric:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> MlRocAucMetric:
    """
    ...
    """
        ...
    def afterMake(self) -> MlRocAucMetric:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> MlRocAucMetric:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[MlRocAucMetric]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> MlRocAucMetric:
    """
