...
from c3.platform.ObjSetBuilder import ObjSetBuilder
...
# Python definitions for the C3 type ObjSetBuilder

OB = TypeVar('OB')
O = TypeVar('O')

class ObjSetBuilder(Generic[OB, O], SetBuilder[O], Value):
    """
    Builder of set of Objs.
    
    @remarks this represents a made instance of ObjSetBuilder
    """
    def __init__(self) -> None: ...

    @classmethod
    def make(cls) -> ObjSetBuilder[O, OB]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> ObjSetBuilder[O, OB]:
    """
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[ObjSetBuilder[O, OB]]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[ObjSetBuilder[O, OB]]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[ObjSetBuilder[O, OB]]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[ObjSetBuilder[O, OB]]:
    """
    ...
    """
        ...
    @overload
    def e(self, e: O) -> ObjSetBuilder[O, OB]:
    """
    Adds new element to this builder.
    """
        ...
    @overload
    def e(self, e: Any, doNotConvert: bool) -> ObjSetBuilder[O, OB]:
    """
    ...
    def e(self) -> OB:
    """
    Adds new element Obj builder that can be used up until building of this set is done.
    """
        ...
    def add(self, e: O) -> ObjSetBuilder[O, OB]:
    """
    Adds new element to this builder.
    """
        ...
    def addConvertValue(self, e: Any) -> ObjSetBuilder[O, OB]:
    """
    Adds new element to this builder converting value to element type.
    """
        ...
    def addCollection(self, elemBuilder: Callable[[Union[CollectionBuilder[Any]]]]) -> ObjSetBuilder[O, OB]:
    """
    Puts new element collection builder in this map builder. Assumes this a builder of map of collections
    """
        ...
    def addRef(self, elemBuilder: Callable[[Union[ObjBuilder[Obj]]]]) -> ObjSetBuilder[O, OB]:
    """
    ...
    """
        ...
    @overload
    def addAll(self, *elements: Array[O]) -> ObjSetBuilder[O, OB]:
    """
    Adds new elements to this builder.
    """
        ...
    @overload
    def addAll(self, elements: Collection[O]) -> ObjSetBuilder[O, OB]:
    """
    Adds all elements from provided collection to this builder.
    """
        ...
    @overload
    def addAll(self, elements: Data) -> ObjSetBuilder[O, OB]:
    """
    Adds all elements from provided collection of Data to this builder.
    """
        ...
    def addAllConvertValue(self, elements: Collection[Any]) -> ObjSetBuilder[O, OB]:
    """
    ...
    """
        ...
    def clear(self) -> ObjSetBuilder[O, OB]:
    """
    Clears contents of this builder.
    """
        ...
    def unique(self) -> ObjSetBuilder[O, OB]:
    """
    Enforce uniqueness of elements in this builder.
    """
        ...
    def index(self) -> ObjSetBuilder[O, OB]:
    """
    ...
    """
        ...
    @overload
    def sort(self) -> ObjSetBuilder[O, OB]:
    """
    ...
    """
        ...
    @overload
    def sort(self, descending: bool=None) -> ObjSetBuilder[O, OB]:
    """
    Insert elements in opposite of natural sorted order in this builder.
    """
        ...
    @overload
    def sort(self, comparator: Callable[[Union[O], Union[O]], Union[int]]) -> ObjSetBuilder[O, OB]:
    """
    Insert elements in order based on provided comparator.
    """
        ...
    @overload
    def sort(self, descending: bool, comparator: Callable[[Union[O], Union[O]], Union[int]]) -> ObjSetBuilder[O, OB]:
    """
    Insert elements in order based on provided comparator.
    """
        ...
    def constrain(self) -> ObjSetBuilder[O, OB]:
    """
    Enforce constraints when inserting element in this builder.
    """
        ...
    def synchronize(self) -> ObjSetBuilder[O, OB]:
    """
    Ensure this builder can be used concurrently from multiple threads.
    """
        ...
    def current(self) -> Union[Set[O]]:
    """
