// TypeScript definitions for the C3 type ReliabilityAssetSensorHierarchicalRelationSchemaUpgrade
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityAssetSensorHierarchicalRelationSchemaUpgrade
 */
declare interface IReliabilityAssetSensorHierarchicalRelationSchemaUpgrade {
}
 ...
 */
declare class ReliabilityAssetSensorHierarchicalRelationSchemaUpgrade extends Obj  {
   ...
   * @see #toJson
   */
  static fromJson(json: any): ReliabilityAssetSensorHierarchicalRelationSchemaUpgrade | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): ReliabilityAssetSensorHierarchicalRelationSchemaUpgrade | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): ReliabilityAssetSensorHierarchicalRelationSchemaUpgrade | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): ReliabilityAssetSensorHierarchicalRelationSchemaUpgrade | null;
   ...
   */
  replaceType(old: Type, new_: Type): ReliabilityAssetSensorHierarchicalRelationSchemaUpgrade;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityAssetSensorHierarchicalRelationSchemaUpgrade;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityAssetSensorHierarchicalRelationSchemaUpgrade;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityAssetSensorHierarchicalRelationSchemaUpgrade>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityAssetSensorHierarchicalRelationSchemaUpgrade>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityAssetSensorHierarchicalRelationSchemaUpgrade;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityAssetSensorHierarchicalRelationSchemaUpgrade;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityAssetSensorHierarchicalRelationSchemaUpgrade;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ReliabilityAssetSensorHierarchicalRelationSchemaUpgrade;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ReliabilityAssetSensorHierarchicalRelationSchemaUpgrade;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityAssetSensorHierarchicalRelationSchemaUpgrade;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityAssetSensorHierarchicalRelationSchemaUpgrade;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityAssetSensorHierarchicalRelationSchemaUpgrade;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ReliabilityAssetSensorHierarchicalRelationSchemaUpgrade;
   ...
   * @see #removeField
   */
  withoutField(field: string): ReliabilityAssetSensorHierarchicalRelationSchemaUpgrade;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): ReliabilityAssetSensorHierarchicalRelationSchemaUpgrade;
   ...
   */
  withoutFields(fields: Array_Type<string>): ReliabilityAssetSensorHierarchicalRelationSchemaUpgrade;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityAssetSensorHierarchicalRelationSchemaUpgrade;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ReliabilityAssetSensorHierarchicalRelationSchemaUpgrade;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityAssetSensorHierarchicalRelationSchemaUpgrade;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ReliabilityAssetSensorHierarchicalRelationSchemaUpgrade;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ReliabilityAssetSensorHierarchicalRelationSchemaUpgrade;
   ...
   * @see #removeField
   */
  unsetField(field: string): ReliabilityAssetSensorHierarchicalRelationSchemaUpgrade;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ReliabilityAssetSensorHierarchicalRelationSchemaUpgrade;
   ...
   * @see #unsetField
   */
  removeField(field: string): ReliabilityAssetSensorHierarchicalRelationSchemaUpgrade;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ReliabilityAssetSensorHierarchicalRelationSchemaUpgrade;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityAssetSensorHierarchicalRelationSchemaUpgrade;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityAssetSensorHierarchicalRelationSchemaUpgrade;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityAssetSensorHierarchicalRelationSchemaUpgrade;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityAssetSensorHierarchicalRelationSchemaUpgrade;

  mergeJson(json: any): ReliabilityAssetSensorHierarchicalRelationSchemaUpgrade;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityAssetSensorHierarchicalRelationSchemaUpgrade;
   ...
   */
  sumObj(other: Obj, deep?: boolean): ReliabilityAssetSensorHierarchicalRelationSchemaUpgrade;
   ...
   */
  singletonArray(): Array_Type<ReliabilityAssetSensorHierarchicalRelationSchemaUpgrade>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityAssetSensorHierarchicalRelationSchemaUpgrade> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ReliabilityAssetSensorHierarchicalRelationSchemaUpgrade> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<ReliabilityAssetSensorHierarchicalRelationSchemaUpgrade>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ReliabilityAssetSensorHierarchicalRelationSchemaUpgrade> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, ReliabilityAssetSensorHierarchicalRelationSchemaUpgrade> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityAssetSensorHierarchicalRelationSchemaUpgrade> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ReliabilityAssetSensorHierarchicalRelationSchemaUpgrade>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ReliabilityAssetSensorHierarchicalRelationSchemaUpgrade>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityAssetSensorHierarchicalRelationSchemaUpgrade;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityAssetSensorHierarchicalRelationSchemaUpgrade;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityAssetSensorHierarchicalRelationSchemaUpgrade;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ReliabilityAssetSensorHierarchicalRelationSchemaUpgrade;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityAssetSensorHierarchicalRelationSchemaUpgrade;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ReliabilityAssetSensorHierarchicalRelationSchemaUpgrade;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityAssetSensorHierarchicalRelationSchemaUpgrade;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): ReliabilityAssetSensorHierarchicalRelationSchemaUpgrade;
   ...
   */
  static cachedEmptyInst(): ReliabilityAssetSensorHierarchicalRelationSchemaUpgrade;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityAssetSensorHierarchicalRelationSchemaUpgrade> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): ReliabilityAssetSensorHierarchicalRelationSchemaUpgrade;
   ...
   */
  static migrateReliabilityAssetSensorHierarchicalRelation_1(): void;
}
