// TypeScript definitions for the C3 type ReliabilityAssetHierarchyDenorm

/**
 * Represents the hierarchy denorm for the Reliability Asset Hierarchy
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityAssetHierarchyDenorm
 */
declare interface IReliabilityAssetHierarchyDenorm {
  ...
  /**
   * From vertex for this edge
   */
  from?: IReliabilityAsset;

  /**
   * To vertex for this edge
   */
  to?: IReliabilityAsset;

  /**
   * Relationship between the from vertex and the to vertex. E.g. Edge-coloring problem where different edges between the
   * same nodes can have different colors a.k.a 'relationships'
   */
  relationship?: string;

  /**
   * Additional info for the 'from' vertex can be stored here
   */
  fromInfo?: string;

  /**
   * Additional info for the 'to' vertex can be stored here
   */
  toInfo?: string;
 ...
 * Represents the hierarchy denorm for the Reliability Asset Hierarchy
 *
 * @remarks this represents a made instance of ReliabilityAssetHierarchyDenorm
 */
declare class ReliabilityAssetHierarchyDenorm extends Obj  {

  /**
   * The id of this instance.
   */
  readonly id: string;
  withId(id: string): ReliabilityAssetHierarchyDenorm;

  /**
   * From vertex for this edge
   */
  readonly from?: ReliabilityAsset;
  withFrom(from: IReliabilityAsset | null): ReliabilityAssetHierarchyDenorm;

  /**
   * To vertex for this edge
   */
  readonly to?: ReliabilityAsset;
  withTo(to: IReliabilityAsset | null): ReliabilityAssetHierarchyDenorm;
  ...
  withRelationship(relationship: string | null): ReliabilityAssetHierarchyDenorm;

  /**
   * Additional info for the 'from' vertex can be stored here
   */
  readonly fromInfo?: string;
  withFromInfo(fromInfo: string | null): ReliabilityAssetHierarchyDenorm;

  /**
   * Additional info for the 'to' vertex can be stored here
   */
  readonly toInfo?: string;
  withToInfo(toInfo: string | null): ReliabilityAssetHierarchyDenorm;

  /**
   * Placeholder field. Not used in current computation.
   */
  readonly involvement?: number;
  withInvolvement(involvement: number | null): ReliabilityAssetHierarchyDenorm;

  readonly EDGE_SEPARATOR?: string;
  withEDGE_SEPARATOR(EDGE_SEPARATOR: string | null): ReliabilityAssetHierarchyDenorm;

  /**
   * If the current edge stems from a root node (root node is one where vertex doesn't have any incident edges)
   */
  readonly isRoot?: boolean;
  withIsRoot(isRoot: boolean): ReliabilityAssetHierarchyDenorm;
  ...
  withDistance(distance: number | null): ReliabilityAssetHierarchyDenorm;

  /**
   * Place holder field. Not being used in internal computation
   */
  readonly versionNumber?: number;
  withVersionNumber(versionNumber: number | null): ReliabilityAssetHierarchyDenorm;

  /**
   * Start timestamp for the value.  If null, assumed to be beginning-of-time (BOT).
   */
  readonly start?: DateTime;
  withStart(start: DateTime | Date | string | null): ReliabilityAssetHierarchyDenorm;

  /**
   * End timestamp for the value.  If null, assumed to be end-of-time (EOT).
   */
  readonly end?: DateTime;
  withEnd(end: DateTime | Date | string | null): ReliabilityAssetHierarchyDenorm;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityAssetHierarchyDenorm;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): ReliabilityAssetHierarchyDenorm;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): ReliabilityAssetHierarchyDenorm;
  ...
  withVersion(version: number | null): ReliabilityAssetHierarchyDenorm;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): ReliabilityAssetHierarchyDenorm;

  /**
   * @inheritdoc
   */
  readonly facilityFilterPaths?: Array_Type<string>;
  withFacilityFilterPaths(facilityFilterPaths: Array_Type<string> | Array<string> | null): ReliabilityAssetHierarchyDenorm;
  ...
  withTypeIdent(typeIdent: string | null): ReliabilityAssetHierarchyDenorm;
   ...
   * @see #toJson
   */
  static fromJson(json: any): ReliabilityAssetHierarchyDenorm | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): ReliabilityAssetHierarchyDenorm | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): ReliabilityAssetHierarchyDenorm | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): ReliabilityAssetHierarchyDenorm | null;
   ...
   */
  replaceType(old: Type, new_: Type): ReliabilityAssetHierarchyDenorm;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityAssetHierarchyDenorm;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityAssetHierarchyDenorm;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityAssetHierarchyDenorm>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityAssetHierarchyDenorm>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityAssetHierarchyDenorm;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityAssetHierarchyDenorm;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityAssetHierarchyDenorm;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ReliabilityAssetHierarchyDenorm;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ReliabilityAssetHierarchyDenorm;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityAssetHierarchyDenorm;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityAssetHierarchyDenorm;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityAssetHierarchyDenorm;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ReliabilityAssetHierarchyDenorm;
   ...
   * @see #removeField
   */
  withoutField(field: string): ReliabilityAssetHierarchyDenorm;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): ReliabilityAssetHierarchyDenorm;
   ...
   */
  withoutFields(fields: Array_Type<string>): ReliabilityAssetHierarchyDenorm;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityAssetHierarchyDenorm;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ReliabilityAssetHierarchyDenorm;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityAssetHierarchyDenorm;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ReliabilityAssetHierarchyDenorm;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ReliabilityAssetHierarchyDenorm;
   ...
   * @see #removeField
   */
  unsetField(field: string): ReliabilityAssetHierarchyDenorm;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ReliabilityAssetHierarchyDenorm;
   ...
   * @see #unsetField
   */
  removeField(field: string): ReliabilityAssetHierarchyDenorm;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ReliabilityAssetHierarchyDenorm;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityAssetHierarchyDenorm;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityAssetHierarchyDenorm;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityAssetHierarchyDenorm;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityAssetHierarchyDenorm;

  mergeJson(json: any): ReliabilityAssetHierarchyDenorm;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityAssetHierarchyDenorm;
   ...
   */
  sumObj(other: Obj, deep?: boolean): ReliabilityAssetHierarchyDenorm;
   ...
   */
  singletonArray(): Array_Type<ReliabilityAssetHierarchyDenorm>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityAssetHierarchyDenorm> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ReliabilityAssetHierarchyDenorm> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<ReliabilityAssetHierarchyDenorm>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ReliabilityAssetHierarchyDenorm> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, ReliabilityAssetHierarchyDenorm> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityAssetHierarchyDenorm> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ReliabilityAssetHierarchyDenorm>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ReliabilityAssetHierarchyDenorm>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityAssetHierarchyDenorm;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityAssetHierarchyDenorm;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityAssetHierarchyDenorm;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ReliabilityAssetHierarchyDenorm;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityAssetHierarchyDenorm;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ReliabilityAssetHierarchyDenorm;
   ...
   * @see #fromString
   */
  static make(s: string): ReliabilityAssetHierarchyDenorm | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityAssetHierarchyDenorm;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): ReliabilityAssetHierarchyDenorm;
   ...
   */
  static cachedEmptyInst(): ReliabilityAssetHierarchyDenorm;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityAssetHierarchyDenorm> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): ReliabilityAssetHierarchyDenorm;
   ...
   * @see #toString
   */
  static fromString(s: string): ReliabilityAssetHierarchyDenorm | null;
   ...
   */
  static denormalizeHierarchy(batchSize?: number, batchWeight?: number, async?: boolean, edgeType?: Type): Array_Type<HierarchyDenormBatchJob> | null;
   ...
   * @return a list of batch jobs one per edge type in async mode indicating status of the denorm
   */
  static denormalizeIncrementally(batchSize?: number, batchWeight?: number, async?: boolean, invalidatedVertices?: Array_Type<string>, edgeType?: Type, edgesRemoved?: boolean): Array_Type<HierarchyDenormBatchJob> | null;
   ...
   */
  static getDescendants(parents?: Array_Type<ReliabilityAsset>, spec?: DescendantsSpec): DescendantsResult | null;
   ...
   */
  static countDescendants(parents?: Array_Type<ReliabilityAsset>, spec?: DescendantsSpec): DescendantsResult | null;
   ...
   */
  static getAncestors(nodes?: Array_Type<ReliabilityAsset>, spec?: AncestorsSpec): Array_Type<AncestorsResult> | null;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<ReliabilityAssetHierarchyDenorm>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<ReliabilityAssetHierarchyDenorm>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityAssetHierarchyDenorm> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityAssetHierarchyDenorm>> | null;
   ...
   */
  get(include?: string): ReliabilityAssetHierarchyDenorm | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): ReliabilityAssetHierarchyDenorm | null;
   ...
   */
  getMissing(spec: GetMissingSpec): ReliabilityAssetHierarchyDenorm;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): ReliabilityAssetHierarchyDenorm | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): ReliabilityAssetHierarchyDenorm;
   ...
   */
  create(spec?: UpsertSpec): ReliabilityAssetHierarchyDenorm | null;
   ...
   */
  static createBatch(objs: Array_Type<ReliabilityAssetHierarchyDenorm>, spec?: UpsertSpec): ObjList<ReliabilityAssetHierarchyDenorm> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<ReliabilityAssetHierarchyDenorm>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityAssetHierarchyDenorm> | null;
   ...
   */
  update(srcObj?: ReliabilityAssetHierarchyDenorm, spec?: UpsertSpec): ReliabilityAssetHierarchyDenorm | null;
   ...
   */
  upsert(srcObj?: ReliabilityAssetHierarchyDenorm, spec?: UpsertSpec): ReliabilityAssetHierarchyDenorm | null;
   ...
   */
  merge(spec?: MergeSpec): ReliabilityAssetHierarchyDenorm | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): ReliabilityAssetHierarchyDenorm | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): ReliabilityAssetHierarchyDenorm | null;
   ...
   */
  static updateBatch(objs: Array_Type<ReliabilityAssetHierarchyDenorm>, srcObjs?: Array_Type<ReliabilityAssetHierarchyDenorm>, spec?: UpsertSpec): ObjList<ReliabilityAssetHierarchyDenorm> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<ReliabilityAssetHierarchyDenorm> | null>, spec?: UpsertSpec): ObjList<ReliabilityAssetHierarchyDenorm> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<ReliabilityAssetHierarchyDenorm>, srcObjs?: Array_Type<ReliabilityAssetHierarchyDenorm>, spec?: UpsertSpec): ObjList<ReliabilityAssetHierarchyDenorm> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<ReliabilityAssetHierarchyDenorm> | null>, spec?: UpsertSpec): ObjList<ReliabilityAssetHierarchyDenorm> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<ReliabilityAssetHierarchyDenorm>, spec?: TouchSpec): ObjList<ReliabilityAssetHierarchyDenorm> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityAssetHierarchyDenorm>, spec?: MergeSpec): ObjList<ReliabilityAssetHierarchyDenorm> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityAssetHierarchyDenorm>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityAssetHierarchyDenorm> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<ReliabilityAssetHierarchyDenorm> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityAssetHierarchyDenorm> | null;
   ...
   */
  static mergeAll(mergeObj: ReliabilityAssetHierarchyDenorm, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: ReliabilityAssetHierarchyDenorm, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<ReliabilityAssetHierarchyDenorm>, spec?: UpsertSpec): ObjList<ReliabilityAssetHierarchyDenorm> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<ReliabilityAssetHierarchyDenorm>, spec?: UpsertSpec): ObjList<ReliabilityAssetHierarchyDenorm> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): ReliabilityAssetHierarchyDenorm | null;
   ...
   */
  static beforeCreate(objs: Array_Type<ReliabilityAssetHierarchyDenorm>): ObjList<ReliabilityAssetHierarchyDenorm>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<ReliabilityAssetHierarchyDenorm>): ObjList<ReliabilityAssetHierarchyDenorm>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<ReliabilityAssetHierarchyDenorm>): ObjList<ReliabilityAssetHierarchyDenorm>;
   ...
   */
  static afterCreate(objs: Array_Type<ReliabilityAssetHierarchyDenorm>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<ReliabilityAssetHierarchyDenorm>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<ReliabilityAssetHierarchyDenorm>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityAssetHierarchyDenorm>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityAssetHierarchyDenorm>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): ReliabilityAssetHierarchyDenorm | null;
   ...
   */
  withoutIdentity(): ReliabilityAssetHierarchyDenorm | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<ReliabilityAssetHierarchyDenorm>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: ReliabilityAssetHierarchyDenorm, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<ReliabilityAssetHierarchyDenorm>, callback?: λFunction<ReliabilityAssetHierarchyDenorm | null, ReliabilityAssetHierarchyDenorm | null>): ObjList<ReliabilityAssetHierarchyDenorm>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<ReliabilityAssetHierarchyDenorm>, callback?: λFunction<ReliabilityAssetHierarchyDenorm | null, ReliabilityAssetHierarchyDenorm | null>): Array_Type<ObjError> | null;
