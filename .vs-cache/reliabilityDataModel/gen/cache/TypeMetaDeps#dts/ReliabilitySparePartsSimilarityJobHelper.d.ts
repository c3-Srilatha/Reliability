// TypeScript definitions for the C3 type ReliabilitySparePartsSimilarityJobHelper

/**
 * Helper entity type to store the MapReduce job id and similar work orders,
 * which will be used after map reduce job has been completed
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilitySparePartsSimilarityJobHelper
 */
declare interface IReliabilitySparePartsSimilarityJobHelper {
  ...
  /**
   * Similar work orders present in one batch of map reduce job
   */
 ...
 * which will be used after map reduce job has been completed
 *
 * @remarks this represents a made instance of ReliabilitySparePartsSimilarityJobHelper
 */
declare class ReliabilitySparePartsSimilarityJobHelper extends Obj  {
   ...
   */
  readonly id: string;
  withId(id: string): ReliabilitySparePartsSimilarityJobHelper;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilitySparePartsSimilarityJobHelper;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): ReliabilitySparePartsSimilarityJobHelper;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): ReliabilitySparePartsSimilarityJobHelper;
  ...
  withVersion(version: number | null): ReliabilitySparePartsSimilarityJobHelper;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): ReliabilitySparePartsSimilarityJobHelper;

  /**
   * MapReduce job id
   */
  readonly jobId?: string;
  withJobId(jobId: string | null): ReliabilitySparePartsSimilarityJobHelper;

  /**
   * Similar work orders present in one batch of map reduce job
   */
  readonly similarWorkOrders?: Array_Type<WorkOrder>;
  withSimilarWorkOrders(similarWorkOrders: Array_Type<WorkOrder> | Array<IWorkOrder> | null): ReliabilitySparePartsSimilarityJobHelper;
   ...
   * @see #toJson
   */
  static fromJson(json: any): ReliabilitySparePartsSimilarityJobHelper | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): ReliabilitySparePartsSimilarityJobHelper | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): ReliabilitySparePartsSimilarityJobHelper | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): ReliabilitySparePartsSimilarityJobHelper | null;
   ...
   */
  replaceType(old: Type, new_: Type): ReliabilitySparePartsSimilarityJobHelper;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilitySparePartsSimilarityJobHelper;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilitySparePartsSimilarityJobHelper;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilitySparePartsSimilarityJobHelper>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilitySparePartsSimilarityJobHelper>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilitySparePartsSimilarityJobHelper;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilitySparePartsSimilarityJobHelper;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilitySparePartsSimilarityJobHelper;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ReliabilitySparePartsSimilarityJobHelper;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ReliabilitySparePartsSimilarityJobHelper;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilitySparePartsSimilarityJobHelper;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilitySparePartsSimilarityJobHelper;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilitySparePartsSimilarityJobHelper;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ReliabilitySparePartsSimilarityJobHelper;
   ...
   * @see #removeField
   */
  withoutField(field: string): ReliabilitySparePartsSimilarityJobHelper;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): ReliabilitySparePartsSimilarityJobHelper;
   ...
   */
  withoutFields(fields: Array_Type<string>): ReliabilitySparePartsSimilarityJobHelper;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilitySparePartsSimilarityJobHelper;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ReliabilitySparePartsSimilarityJobHelper;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilitySparePartsSimilarityJobHelper;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ReliabilitySparePartsSimilarityJobHelper;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ReliabilitySparePartsSimilarityJobHelper;
   ...
   * @see #removeField
   */
  unsetField(field: string): ReliabilitySparePartsSimilarityJobHelper;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ReliabilitySparePartsSimilarityJobHelper;
   ...
   * @see #unsetField
   */
  removeField(field: string): ReliabilitySparePartsSimilarityJobHelper;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ReliabilitySparePartsSimilarityJobHelper;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilitySparePartsSimilarityJobHelper;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilitySparePartsSimilarityJobHelper;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilitySparePartsSimilarityJobHelper;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilitySparePartsSimilarityJobHelper;

  mergeJson(json: any): ReliabilitySparePartsSimilarityJobHelper;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilitySparePartsSimilarityJobHelper;
   ...
   */
  sumObj(other: Obj, deep?: boolean): ReliabilitySparePartsSimilarityJobHelper;
   ...
   */
  singletonArray(): Array_Type<ReliabilitySparePartsSimilarityJobHelper>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<ReliabilitySparePartsSimilarityJobHelper> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ReliabilitySparePartsSimilarityJobHelper> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<ReliabilitySparePartsSimilarityJobHelper>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ReliabilitySparePartsSimilarityJobHelper> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, ReliabilitySparePartsSimilarityJobHelper> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilitySparePartsSimilarityJobHelper> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ReliabilitySparePartsSimilarityJobHelper>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ReliabilitySparePartsSimilarityJobHelper>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilitySparePartsSimilarityJobHelper;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilitySparePartsSimilarityJobHelper;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilitySparePartsSimilarityJobHelper;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ReliabilitySparePartsSimilarityJobHelper;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilitySparePartsSimilarityJobHelper;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ReliabilitySparePartsSimilarityJobHelper;
   ...
   * @see #fromString
   */
  static make(s: string): ReliabilitySparePartsSimilarityJobHelper | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilitySparePartsSimilarityJobHelper;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): ReliabilitySparePartsSimilarityJobHelper;
   ...
   */
  static cachedEmptyInst(): ReliabilitySparePartsSimilarityJobHelper;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilitySparePartsSimilarityJobHelper> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): ReliabilitySparePartsSimilarityJobHelper;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<ReliabilitySparePartsSimilarityJobHelper>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<ReliabilitySparePartsSimilarityJobHelper>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilitySparePartsSimilarityJobHelper> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilitySparePartsSimilarityJobHelper>> | null;
   ...
   */
  get(include?: string): ReliabilitySparePartsSimilarityJobHelper | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): ReliabilitySparePartsSimilarityJobHelper | null;
   ...
   */
  getMissing(spec: GetMissingSpec): ReliabilitySparePartsSimilarityJobHelper;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): ReliabilitySparePartsSimilarityJobHelper | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): ReliabilitySparePartsSimilarityJobHelper;
   ...
   * @see #toString
   */
  static fromString(s: string): ReliabilitySparePartsSimilarityJobHelper | null;
   ...
   */
  create(spec?: UpsertSpec): ReliabilitySparePartsSimilarityJobHelper | null;
   ...
   */
  static createBatch(objs: Array_Type<ReliabilitySparePartsSimilarityJobHelper>, spec?: UpsertSpec): ObjList<ReliabilitySparePartsSimilarityJobHelper> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<ReliabilitySparePartsSimilarityJobHelper>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilitySparePartsSimilarityJobHelper> | null;
   ...
   */
  update(srcObj?: ReliabilitySparePartsSimilarityJobHelper, spec?: UpsertSpec): ReliabilitySparePartsSimilarityJobHelper | null;
   ...
   */
  upsert(srcObj?: ReliabilitySparePartsSimilarityJobHelper, spec?: UpsertSpec): ReliabilitySparePartsSimilarityJobHelper | null;
   ...
   */
  merge(spec?: MergeSpec): ReliabilitySparePartsSimilarityJobHelper | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): ReliabilitySparePartsSimilarityJobHelper | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): ReliabilitySparePartsSimilarityJobHelper | null;
   ...
   */
  static updateBatch(objs: Array_Type<ReliabilitySparePartsSimilarityJobHelper>, srcObjs?: Array_Type<ReliabilitySparePartsSimilarityJobHelper>, spec?: UpsertSpec): ObjList<ReliabilitySparePartsSimilarityJobHelper> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<ReliabilitySparePartsSimilarityJobHelper> | null>, spec?: UpsertSpec): ObjList<ReliabilitySparePartsSimilarityJobHelper> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<ReliabilitySparePartsSimilarityJobHelper>, srcObjs?: Array_Type<ReliabilitySparePartsSimilarityJobHelper>, spec?: UpsertSpec): ObjList<ReliabilitySparePartsSimilarityJobHelper> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<ReliabilitySparePartsSimilarityJobHelper> | null>, spec?: UpsertSpec): ObjList<ReliabilitySparePartsSimilarityJobHelper> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<ReliabilitySparePartsSimilarityJobHelper>, spec?: TouchSpec): ObjList<ReliabilitySparePartsSimilarityJobHelper> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilitySparePartsSimilarityJobHelper>, spec?: MergeSpec): ObjList<ReliabilitySparePartsSimilarityJobHelper> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilitySparePartsSimilarityJobHelper>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilitySparePartsSimilarityJobHelper> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<ReliabilitySparePartsSimilarityJobHelper> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilitySparePartsSimilarityJobHelper> | null;
   ...
   */
  static mergeAll(mergeObj: ReliabilitySparePartsSimilarityJobHelper, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: ReliabilitySparePartsSimilarityJobHelper, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<ReliabilitySparePartsSimilarityJobHelper>, spec?: UpsertSpec): ObjList<ReliabilitySparePartsSimilarityJobHelper> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<ReliabilitySparePartsSimilarityJobHelper>, spec?: UpsertSpec): ObjList<ReliabilitySparePartsSimilarityJobHelper> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): ReliabilitySparePartsSimilarityJobHelper | null;
   ...
   */
  static beforeCreate(objs: Array_Type<ReliabilitySparePartsSimilarityJobHelper>): ObjList<ReliabilitySparePartsSimilarityJobHelper>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<ReliabilitySparePartsSimilarityJobHelper>): ObjList<ReliabilitySparePartsSimilarityJobHelper>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<ReliabilitySparePartsSimilarityJobHelper>): ObjList<ReliabilitySparePartsSimilarityJobHelper>;
   ...
   */
  static afterCreate(objs: Array_Type<ReliabilitySparePartsSimilarityJobHelper>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<ReliabilitySparePartsSimilarityJobHelper>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<ReliabilitySparePartsSimilarityJobHelper>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilitySparePartsSimilarityJobHelper>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilitySparePartsSimilarityJobHelper>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): ReliabilitySparePartsSimilarityJobHelper | null;
   ...
   */
  withoutIdentity(): ReliabilitySparePartsSimilarityJobHelper | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<ReliabilitySparePartsSimilarityJobHelper>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: ReliabilitySparePartsSimilarityJobHelper, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<ReliabilitySparePartsSimilarityJobHelper>, callback?: λFunction<ReliabilitySparePartsSimilarityJobHelper | null, ReliabilitySparePartsSimilarityJobHelper | null>): ObjList<ReliabilitySparePartsSimilarityJobHelper>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<ReliabilitySparePartsSimilarityJobHelper>, callback?: λFunction<ReliabilitySparePartsSimilarityJobHelper | null, ReliabilitySparePartsSimilarityJobHelper | null>): Array_Type<ObjError> | null;
