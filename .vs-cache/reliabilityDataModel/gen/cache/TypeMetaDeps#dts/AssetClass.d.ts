// TypeScript definitions for the C3 type AssetClass
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of AssetClass
 */
declare interface IAssetClass {
   ...
   */
  parentAssetClassRelations?: Array_Type<AssetClassParentChildRelation> | Array<IAssetClassParentChildRelation>;

  /**
   * The relations to children for this class.
   */
  childAssetClassRelations?: Array_Type<AssetClassParentChildRelation> | Array<IAssetClassParentChildRelation>;
   ...
   */
  failureModeLibrary?: IFailureModeLibrary;
   ...
   */
  expectedSensors?: Array_Type<ExpectedSensor> | Array<IExpectedSensor>;
   ...
   * asset class.
   */
  kpis?: Array_Type<string> | Array<string>;
   ...
   */
  hierarchyTemplate?: IAssetHierarchyTemplate;
   ...
   * this asset class.
   */
  definitionVersion?: IReliabilityAssetClassDefinitionVersion;
}
 ...
 */
declare class AssetClass extends Obj  {
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): AssetClass;

  /**
   * The name of the asset class.
   */
  readonly name: string;
  withName(name: string): AssetClass;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): AssetClass;
  ...
  withVersion(version: number | null): AssetClass;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): AssetClass;
  ...
  withTypeIdent(typeIdent: string | null): AssetClass;
  ...
  withTranslatedName(translatedName: string | null): AssetClass;

  /**
   * The relations to parents for this class.
   */
  readonly parentAssetClassRelations?: Array_Type<AssetClassParentChildRelation>;
  withParentAssetClassRelations(parentAssetClassRelations: Array_Type<AssetClassParentChildRelation> | Array<IAssetClassParentChildRelation> | null): AssetClass;

  /**
   * The relations to children for this class.
   */
  readonly childAssetClassRelations?: Array_Type<AssetClassParentChildRelation>;
  withChildAssetClassRelations(childAssetClassRelations: Array_Type<AssetClassParentChildRelation> | Array<IAssetClassParentChildRelation> | null): AssetClass;

  /**
   * Number of children this {@link AssetClass} has.
   */
  readonly countChildren?: number;
  withCountChildren(countChildren: number | null): AssetClass;

  /**
   * Indicates whether this asset class has children.
   */
  readonly hasChildren?: boolean;
  withHasChildren(hasChildren: boolean): AssetClass;

  /**
   * All {@link ReliabilityAsset}s of this asset class.
   */
  readonly assets?: Array_Type<ReliabilityAsset>;
  withAssets(assets: Array_Type<ReliabilityAsset> | Array<IReliabilityAsset> | null): AssetClass;

  /**
   * Number of {@link ReliabilityAsset}s of this asset class.
   */
  readonly countAssets?: number;
  withCountAssets(countAssets: number | null): AssetClass;

  /**
   * The {@link FailureModeLibrary} associated with this asset class.
   */
  readonly failureModeLibrary?: FailureModeLibrary;
  withFailureModeLibrary(failureModeLibrary: IFailureModeLibrary | null): AssetClass;

  /**
   * The {@link FailureMode}s associated with this asset class.
   */
  readonly failureModes?: Array_Type<FailureMode>;
  withFailureModes(failureModes: Array_Type<FailureMode> | Array<IFailureMode> | null): AssetClass;

  /**
   * Number of {@link FailureMode}s associated with this asset class.
   */
  readonly countFailureModes?: number;
  withCountFailureModes(countFailureModes: number | null): AssetClass;
   ...
   * {@link FailureModeLineItem} associated with the {@link #failureModeLibrary} of this asset class.
   */
  readonly expectedSensors?: Array_Type<ExpectedSensor>;
  withExpectedSensors(expectedSensors: Array_Type<ExpectedSensor> | Array<IExpectedSensor> | null): AssetClass;

  /**
   * Number of {@link ExpectedSensor}s associated with this asset class.
   */
  readonly expectedSensorCount?: number;
  withExpectedSensorCount(expectedSensorCount: number | null): AssetClass;

  /**
   * Metric names or expressions that specify key performance indicators for any asset using this
   * asset class.
   */
  readonly kpis?: Array_Type<string>;
  withKpis(kpis: Array_Type<string> | Array<string> | null): AssetClass;
  ...
  withLinked3DModel(linked3DModel: IReliabilityAsset3dmodel | null): AssetClass;
  ...
  withStatus(status: string | null): AssetClass;

  /**
   * Defines the hierarchy that assets using this `AssetClass` should be the root of.
   */
  readonly hierarchyTemplate?: AssetHierarchyTemplate;
  withHierarchyTemplate(hierarchyTemplate: IAssetHierarchyTemplate | null): AssetClass;
   ...
   * this asset class.
   */
  readonly definitionVersion?: ReliabilityAssetClassDefinitionVersion;
  withDefinitionVersion(definitionVersion: IReliabilityAssetClassDefinitionVersion | null): AssetClass;
   ...
   * @see #toJson
   */
  static fromJson(json: any): AssetClass | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): AssetClass | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): AssetClass | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): AssetClass | null;
   ...
   */
  replaceType(old: Type, new_: Type): AssetClass;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): AssetClass;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): AssetClass;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<AssetClass>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<AssetClass>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): AssetClass;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): AssetClass;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): AssetClass;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): AssetClass;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): AssetClass;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): AssetClass;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): AssetClass;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): AssetClass;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): AssetClass;
   ...
   * @see #removeField
   */
  withoutField(field: string): AssetClass;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): AssetClass;
   ...
   */
  withoutFields(fields: Array_Type<string>): AssetClass;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): AssetClass;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): AssetClass;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): AssetClass;
   ...
   * @see #unsetField
   */
  defaultField(field: string): AssetClass;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): AssetClass;
   ...
   * @see #removeField
   */
  unsetField(field: string): AssetClass;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): AssetClass;
   ...
   * @see #unsetField
   */
  removeField(field: string): AssetClass;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): AssetClass;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): AssetClass;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): AssetClass;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): AssetClass;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): AssetClass;

  mergeJson(json: any): AssetClass;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): AssetClass;
   ...
   */
  sumObj(other: Obj, deep?: boolean): AssetClass;
   ...
   */
  singletonArray(): Array_Type<AssetClass>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<AssetClass> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<AssetClass> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<AssetClass>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<AssetClass> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, AssetClass> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, AssetClass> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<AssetClass>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<AssetClass>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): AssetClass;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): AssetClass;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): AssetClass;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): AssetClass;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): AssetClass;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): AssetClass;
   ...
   * @see #fromString
   */
  static make(s: string): AssetClass | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): AssetClass;
   ...
   */
  static cachedEmptyInst(): AssetClass;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<AssetClass> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): AssetClass;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<AssetClass>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<AssetClass>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<AssetClass> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<AssetClass>> | null;
   ...
   */
  static evalFeatureSetBatch(batch: Array_Type<AssetClass>, featureSet: Feature.Set, spec?: EvalFeatureSpec): Data | null;
   ...
   * ```
   */
  static evalFeaturesBatch(batch: Array_Type<AssetClass>, features: Array_Type<string>, spec?: EvalFeaturesSpec): Data | null;
   ...
   */
  get(include?: string): AssetClass | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): AssetClass | null;
   ...
   */
  getMissing(spec: GetMissingSpec): AssetClass;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): AssetClass | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): AssetClass;
   ...
   * @see #toString
   */
  static fromString(s: string): AssetClass | null;
   ...
   */
  create(spec?: UpsertSpec): AssetClass | null;
   ...
   */
  static createBatch(objs: Array_Type<AssetClass>, spec?: UpsertSpec): ObjList<AssetClass> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<AssetClass>, spec?: CreateBatchObjStreamSpec): ObjList<AssetClass> | null;
   ...
   */
  update(srcObj?: AssetClass, spec?: UpsertSpec): AssetClass | null;
   ...
   */
  upsert(srcObj?: AssetClass, spec?: UpsertSpec): AssetClass | null;
   ...
   */
  merge(spec?: MergeSpec): AssetClass | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): AssetClass | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): AssetClass | null;
   ...
   */
  static updateBatch(objs: Array_Type<AssetClass>, srcObjs?: Array_Type<AssetClass>, spec?: UpsertSpec): ObjList<AssetClass> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<AssetClass> | null>, spec?: UpsertSpec): ObjList<AssetClass> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<AssetClass>, srcObjs?: Array_Type<AssetClass>, spec?: UpsertSpec): ObjList<AssetClass> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<AssetClass> | null>, spec?: UpsertSpec): ObjList<AssetClass> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<AssetClass>, spec?: TouchSpec): ObjList<AssetClass> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<AssetClass>, spec?: MergeSpec): ObjList<AssetClass> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<AssetClass>, mergeInclude: string, spec?: MergeSpec): ObjList<AssetClass> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<AssetClass> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<AssetClass> | null;
   ...
   */
  static mergeAll(mergeObj: AssetClass, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: AssetClass, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<AssetClass>, spec?: UpsertSpec): ObjList<AssetClass> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<AssetClass>, spec?: UpsertSpec): ObjList<AssetClass> | null;
   ...
   */
  static beforeCreate(objs: Array_Type<AssetClass>): ObjList<AssetClass>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<AssetClass>): ObjList<AssetClass>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<AssetClass>): ObjList<AssetClass>;
   ...
   */
  static afterCreate(objs: Array_Type<AssetClass>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<AssetClass>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<AssetClass>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<AssetClass>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<AssetClass>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): AssetClass | null;
   ...
   */
  withoutIdentity(): AssetClass | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<AssetClass>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: AssetClass, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<AssetClass>, callback?: λFunction<AssetClass | null, AssetClass | null>): ObjList<AssetClass>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<AssetClass>, callback?: λFunction<AssetClass | null, AssetClass | null>): Array_Type<ObjError> | null;
   ...
   */
  static createSensorRelationsForAllChildAssetsAndSensors(parentAsset?: ReliabilityAsset): Array_Type<string> | null;
   ...
   */
  static createDiagramConfigs(parentAsset?: ReliabilityAsset): void;
   ...
   */
  static fetchAllClassMetricsForDiagram(includeKpis?: boolean): Array_Type<string> | null;
   ...
   */
  static fetchAllClassMetrics(includeKpis?: boolean): Array_Type<string> | null;
   ...
   */
  static fetchClassMetrics(assetClasses?: Array_Type<AssetClass>, includeKpis?: boolean): Array_Type<string> | null;
   ...
   */
  createCopy(newName?: string): AssetClass | null;
   ...
   */
  addMissingAssetsFromHierarchyTemplate(filter?: Filter): Array_Type<ReliabilityAsset> | null;
   ...
   */
  createInstanceWithHierarchy(rootAssetName?: string): Array_Type<ReliabilityAsset> | null;
   ...
   */
  validateHierarchyForInstances(filter?: Filter): boolean;
   ...
   */
  static generateAssetHierarchyGraphFromRelationships(asset?: ReliabilityAsset): any | null;
   ...
   * @return JSON representation of the asset hierarchy graph.
   */
  static generateAssetHierarchyGraphFromAssetClass(rootAssetClass?: AssetClass): any | null;
   ...
   */
  addExpectedSensor(expectedSensor?: ExpectedSensor): void;
