// TypeScript definitions for the C3 type ReliabilityConfig

/**
 * Configurations for Reliability application.
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityConfig
 */
declare interface IReliabilityConfig {
  ...
  /**
   * Base url for the application. Used for embedding links into email notifications.
   */
  baseURL?: string;

  /**
   * The business entity that the application is being deployed for. Displayed at the top of {@link WorkOrder} reports.
   */
  companyName?: string;

  /**
   * The id of the {@link HardwareProfile} that will be used to all DataValidationBatchJob instances.
   */
  dataValidationHardwareProfile?: string;

  /**
   * The priority to be assigned to all DataValidationBatchJob instances.
   */
  dataValidationJobPriority?: number;

  /**
   * Specifies the filter used to fetch the user's cases. Use {{userId}} as a placeholder for the current user's id.
   */
  myCasesFilter: IFilter;

  /**
   * The limit for the fetch call used to retrieve activities related to actions performed on ReliabilityAssetAlert and ReliabilityAssetCase instances. The default value is set to 2000.
   */
  activitiesFetchLimit?: number;

  /**
   * The name of the LLM Model used for Expected Sensor Matching.
   */
  modelName?: string;
}
 ...
 * Configurations for Reliability application.
 *
 * @remarks this represents a made instance of ReliabilityConfig
 */
declare class ReliabilityConfig extends Obj  {

  readonly configOverride?: string;
  withConfigOverride(configOverride: string | null): ReliabilityConfig;

  static readonly configOverride?: string;

  readonly secretOverride?: string;
  withSecretOverride(secretOverride: string | null): ReliabilityConfig;
  ...
  withIssues(issues: Array_Type<string> | Array<string> | null): ReliabilityConfig;
  ...
  withBaseURL(baseURL: string | null): ReliabilityConfig;
  ...
  withCompanyName(companyName: string | null): ReliabilityConfig;
   ...
   * The id of the {@link HardwareProfile} that will be used to all DataValidationBatchJob instances.
   */
  readonly dataValidationHardwareProfile?: string;
  withDataValidationHardwareProfile(dataValidationHardwareProfile: string | null): ReliabilityConfig;

  /**
   * The id of the {@link HardwareProfile} that will be used to all DataValidationBatchJob instances.
   */
  static readonly dataValidationHardwareProfile?: string;

  /**
   * The priority to be assigned to all DataValidationBatchJob instances.
   */
  readonly dataValidationJobPriority?: number;
  withDataValidationJobPriority(dataValidationJobPriority: number | null): ReliabilityConfig;

  /**
   * The priority to be assigned to all DataValidationBatchJob instances.
   */
  static readonly dataValidationJobPriority?: number;

  /**
   * Specifies the filter used to fetch the user's cases. Use {{userId}} as a placeholder for the current user's id.
   */
  readonly myCasesFilter: Filter;
  withMyCasesFilter(myCasesFilter: IFilter): ReliabilityConfig;

  /**
   * Specifies the filter used to fetch the user's cases. Use {{userId}} as a placeholder for the current user's id.
   */
  static readonly myCasesFilter: Filter;

  /**
   * The limit for the fetch call used to retrieve activities related to actions performed on ReliabilityAssetAlert and ReliabilityAssetCase instances. The default value is set to 2000.
   */
  readonly activitiesFetchLimit?: number;
  withActivitiesFetchLimit(activitiesFetchLimit: number | null): ReliabilityConfig;

  /**
   * The limit for the fetch call used to retrieve activities related to actions performed on ReliabilityAssetAlert and ReliabilityAssetCase instances. The default value is set to 2000.
   */
  static readonly activitiesFetchLimit?: number;

  /**
   * The name of the LLM Model used for Expected Sensor Matching.
   */
  readonly modelName?: string;
  withModelName(modelName: string | null): ReliabilityConfig;
   ...
   * @see #toJson
   */
  static fromJson(json: any): ReliabilityConfig | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): ReliabilityConfig | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): ReliabilityConfig | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): ReliabilityConfig | null;
   ...
   */
  replaceType(old: Type, new_: Type): ReliabilityConfig;
   ...
   * This method is used during live metadata update
   */
  static replaceType(old: Type, new_: Type): ReliabilityConfig;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityConfig>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityConfig>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityConfig>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityConfig>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ReliabilityConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  static validateObj(): ReliabilityConfig;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ReliabilityConfig;
   ...
   * @see #defaultField
   */
  static withField(field: string, value: any, doNotConvert?: boolean): ReliabilityConfig;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityConfig;
   ...
   * @see #defaultField
   */
  static withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityConfig;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityConfig;
   ...
   * @return new Obj
   */
  static withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityConfig;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityConfig;
   ...
   * @return new Obj
   */
  static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityConfig;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ReliabilityConfig;
   ...
   * @see #withoutField
   */
  static withoutFieldAtPath(path: string): ReliabilityConfig;
   ...
   * @see #removeField
   */
  withoutField(field: string): ReliabilityConfig;
   ...
   * @see #removeField
   */
  static withoutField(field: string): ReliabilityConfig;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): ReliabilityConfig;
   ...
   * @see #removeField
   */
  static withoutField(field: FieldType): ReliabilityConfig;
   ...
   */
  withoutFields(fields: Array_Type<string>): ReliabilityConfig;
   ...
   * @return new Obj with removed fields
   */
  static withoutFields(fields: Array_Type<string>): ReliabilityConfig;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityConfig;
   ...
   * @return new Obj with removed fields
   */
  static withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ReliabilityConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  static withoutSecretFields(): ReliabilityConfig;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityConfig;
   ...
   * @see FieldType#defaultValue
   */
  static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ReliabilityConfig;
   ...
   * @see #unsetField
   */
  static defaultField(field: string): ReliabilityConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ReliabilityConfig;
   ...
   * @see #unsetField
   */
  static defaultField(field: FieldType): ReliabilityConfig;
   ...
   * @see #removeField
   */
  unsetField(field: string): ReliabilityConfig;
   ...
   * @see #removeField
   */
  static unsetField(field: string): ReliabilityConfig;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ReliabilityConfig;
   ...
   * @see #removeField
   */
  static unsetField(field: FieldType): ReliabilityConfig;
   ...
   * @see #unsetField
   */
  removeField(field: string): ReliabilityConfig;
   ...
   * @see #unsetField
   */
  static removeField(field: string): ReliabilityConfig;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ReliabilityConfig;
   ...
   * @see #unsetField
   */
  static removeField(field: FieldType): ReliabilityConfig;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityConfig;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityConfig;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityConfig;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityConfig;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityConfig;
   ...
   *        the same key or index.
   */
  static mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityConfig;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityConfig;
   ...
   * traverse child reference and collection fields.
   */
  static mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityConfig;

  mergeJson(json: any): ReliabilityConfig;

  static mergeJson(json: any): ReliabilityConfig;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityConfig;
   ...
   * @return Obj with child references merged
   */
  static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityConfig;
   ...
   */
  sumObj(other: Obj, deep?: boolean): ReliabilityConfig;
   ...
   * references with same name and collection elements at same index or key.
   */
  static sumObj(other: Obj, deep?: boolean): ReliabilityConfig;
   ...
   */
  singletonArray(): Array_Type<ReliabilityConfig>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonArray(): Array_Type<ReliabilityConfig>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityConfig> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ReliabilityConfig> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<ReliabilityConfig>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonSet(): Set_Type<ReliabilityConfig>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ReliabilityConfig> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, ReliabilityConfig> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityConfig> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ReliabilityConfig>;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  static toBuilder(): ObjBuilder<ReliabilityConfig>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ReliabilityConfig>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityConfig;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityConfig;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityConfig;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ReliabilityConfig;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityConfig;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ReliabilityConfig;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityConfig;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  static afterMake(): ReliabilityConfig;
   ...
   */
  static cachedEmptyInst(): ReliabilityConfig;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityConfig> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): ReliabilityConfig;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<ReliabilityConfig> | null;
   ...
   */
  static find(filter?: string, doNotProduceAll?: boolean): Stream<ReliabilityConfig> | null;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<ReliabilityConfig> | null;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): ReliabilityConfig | null;

  /**
   * Returns cached instance by key, with secrets removed.
   */
  static forCacheKey(key: string): ReliabilityConfig | null;
   ...
   * @see findByCacheKey
   */
  getCached(): ReliabilityConfig | null;
   ...
   * @see findByCacheKey
   */
  static getCached(): ReliabilityConfig | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): ReliabilityConfig | null;

  /**
   * @return newly produced cached instance.
   */
  static refreshCache(): ReliabilityConfig | null;
   ...
   */
  static produce(key: string): ReliabilityConfig | null;
   ...
   */
  static produceAll(): Map_Type<string, ReliabilityConfig> | null;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): Map_Type<string, ReliabilityConfig> | null;
   ...
   * Note that typical pattern is to use Configurable#config instead of this method.
   */
  static getConfig(): ReliabilityConfig;
   ...
   * Note that typical pattern is to use Configurable#configWithSecrets instead of this method.
   */
  static getSecret(): ReliabilityConfig;
   ...
   */
  withConfigKey(configKey: string): ReliabilityConfig;
   ...
   *     config.configKey() => "folder1/abc"
   */
  static withConfigKey(configKey: string): ReliabilityConfig;

  /**
   * @return copy without config key.
   */
  withoutConfigKey(): ReliabilityConfig;

  /**
   * @return copy without config key.
   */
  static withoutConfigKey(): ReliabilityConfig;

  /**
   * @return return cached config instance for provided config key.
   */
  static forConfigKey(configKey: string): ReliabilityConfig | null;
   ...
   */
  static listConfigs(parallel?: boolean, filter?: λPredicate<string>): Stream<ReliabilityConfig> | null;
   ...
   * @see setConfigValue
   */
  setConfigValues(from: ReliabilityConfig, override?: string): void;

  /**
   * Sets multiple field values to be the same as the passed instance.
   * @see setConfigValue
   */
  static setConfigValues(from: ReliabilityConfig, override?: string): void;
   ...
   * @see setSecretValue
   */
  setSecretValues(from: ReliabilityConfig, override?: string): void;

  /**
   * Sets multiple secret field values to be the same as the passed instance.
   * @see setSecretValue
   */
  static setSecretValues(from: ReliabilityConfig, override?: string): void;
   ...
   */
  static loadConfigAndSecret(configKey: string): ReliabilityConfig | null;
   ...
   */
  removeSecrets(): ReliabilityConfig | null;

  /**
   * @return this config without any secret values.
   */
  static removeSecrets(): ReliabilityConfig | null;

  /**
   * @return this config with only secret values.
   */
  removeNonSecrets(): ReliabilityConfig | null;

  /**
   * @return this config with only secret values.
   */
  static removeNonSecrets(): ReliabilityConfig | null;
   ...
   * validation and setup.
   */
  static validate(): ReliabilityConfig;
