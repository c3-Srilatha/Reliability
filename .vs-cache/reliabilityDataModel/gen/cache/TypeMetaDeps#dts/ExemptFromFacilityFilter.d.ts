// TypeScript definitions for the C3 type ExemptFromFacilityFilter
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of ExemptFromFacilityFilter
 */
declare interface IExemptFromFacilityFilter {
 ...
 */
declare class ExemptFromFacilityFilter extends Obj  {
   ...
   */
  readonly id: string;
  withId(id: string): ExemptFromFacilityFilter;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ExemptFromFacilityFilter;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): ExemptFromFacilityFilter;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): ExemptFromFacilityFilter;
  ...
  withVersion(version: number | null): ExemptFromFacilityFilter;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): ExemptFromFacilityFilter;
   ...
   * @see #toJson
   */
  static fromJson(json: any): ExemptFromFacilityFilter | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): ExemptFromFacilityFilter | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): ExemptFromFacilityFilter | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): ExemptFromFacilityFilter | null;
   ...
   */
  replaceType(old: Type, new_: Type): ExemptFromFacilityFilter;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ExemptFromFacilityFilter;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ExemptFromFacilityFilter;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ExemptFromFacilityFilter>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ExemptFromFacilityFilter>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ExemptFromFacilityFilter;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ExemptFromFacilityFilter;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ExemptFromFacilityFilter;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ExemptFromFacilityFilter;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ExemptFromFacilityFilter;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ExemptFromFacilityFilter;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ExemptFromFacilityFilter;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ExemptFromFacilityFilter;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ExemptFromFacilityFilter;
   ...
   * @see #removeField
   */
  withoutField(field: string): ExemptFromFacilityFilter;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): ExemptFromFacilityFilter;
   ...
   */
  withoutFields(fields: Array_Type<string>): ExemptFromFacilityFilter;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): ExemptFromFacilityFilter;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ExemptFromFacilityFilter;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ExemptFromFacilityFilter;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ExemptFromFacilityFilter;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ExemptFromFacilityFilter;
   ...
   * @see #removeField
   */
  unsetField(field: string): ExemptFromFacilityFilter;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ExemptFromFacilityFilter;
   ...
   * @see #unsetField
   */
  removeField(field: string): ExemptFromFacilityFilter;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ExemptFromFacilityFilter;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ExemptFromFacilityFilter;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): ExemptFromFacilityFilter;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ExemptFromFacilityFilter;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ExemptFromFacilityFilter;

  mergeJson(json: any): ExemptFromFacilityFilter;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ExemptFromFacilityFilter;
   ...
   */
  sumObj(other: Obj, deep?: boolean): ExemptFromFacilityFilter;
   ...
   */
  singletonArray(): Array_Type<ExemptFromFacilityFilter>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<ExemptFromFacilityFilter> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ExemptFromFacilityFilter> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<ExemptFromFacilityFilter>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ExemptFromFacilityFilter> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, ExemptFromFacilityFilter> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ExemptFromFacilityFilter> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ExemptFromFacilityFilter>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ExemptFromFacilityFilter>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ExemptFromFacilityFilter;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ExemptFromFacilityFilter;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ExemptFromFacilityFilter;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ExemptFromFacilityFilter;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ExemptFromFacilityFilter;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ExemptFromFacilityFilter;
   ...
   * @see #fromString
   */
  static make(s: string): ExemptFromFacilityFilter | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ExemptFromFacilityFilter;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): ExemptFromFacilityFilter;
   ...
   */
  static cachedEmptyInst(): ExemptFromFacilityFilter;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<ExemptFromFacilityFilter> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): ExemptFromFacilityFilter;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<ExemptFromFacilityFilter>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<ExemptFromFacilityFilter>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<ExemptFromFacilityFilter> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ExemptFromFacilityFilter>> | null;
   ...
   */
  get(include?: string): ExemptFromFacilityFilter | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): ExemptFromFacilityFilter | null;
   ...
   */
  getMissing(spec: GetMissingSpec): ExemptFromFacilityFilter;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): ExemptFromFacilityFilter | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): ExemptFromFacilityFilter;
   ...
   * @see #toString
   */
  static fromString(s: string): ExemptFromFacilityFilter | null;
   ...
   */
  create(spec?: UpsertSpec): ExemptFromFacilityFilter | null;
   ...
   */
  static createBatch(objs: Array_Type<ExemptFromFacilityFilter>, spec?: UpsertSpec): ObjList<ExemptFromFacilityFilter> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<ExemptFromFacilityFilter>, spec?: CreateBatchObjStreamSpec): ObjList<ExemptFromFacilityFilter> | null;
   ...
   */
  update(srcObj?: ExemptFromFacilityFilter, spec?: UpsertSpec): ExemptFromFacilityFilter | null;
   ...
   */
  upsert(srcObj?: ExemptFromFacilityFilter, spec?: UpsertSpec): ExemptFromFacilityFilter | null;
   ...
   */
  merge(spec?: MergeSpec): ExemptFromFacilityFilter | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): ExemptFromFacilityFilter | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): ExemptFromFacilityFilter | null;
   ...
   */
  static updateBatch(objs: Array_Type<ExemptFromFacilityFilter>, srcObjs?: Array_Type<ExemptFromFacilityFilter>, spec?: UpsertSpec): ObjList<ExemptFromFacilityFilter> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<ExemptFromFacilityFilter> | null>, spec?: UpsertSpec): ObjList<ExemptFromFacilityFilter> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<ExemptFromFacilityFilter>, srcObjs?: Array_Type<ExemptFromFacilityFilter>, spec?: UpsertSpec): ObjList<ExemptFromFacilityFilter> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<ExemptFromFacilityFilter> | null>, spec?: UpsertSpec): ObjList<ExemptFromFacilityFilter> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<ExemptFromFacilityFilter>, spec?: TouchSpec): ObjList<ExemptFromFacilityFilter> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ExemptFromFacilityFilter>, spec?: MergeSpec): ObjList<ExemptFromFacilityFilter> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ExemptFromFacilityFilter>, mergeInclude: string, spec?: MergeSpec): ObjList<ExemptFromFacilityFilter> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<ExemptFromFacilityFilter> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ExemptFromFacilityFilter> | null;
   ...
   */
  static mergeAll(mergeObj: ExemptFromFacilityFilter, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: ExemptFromFacilityFilter, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<ExemptFromFacilityFilter>, spec?: UpsertSpec): ObjList<ExemptFromFacilityFilter> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<ExemptFromFacilityFilter>, spec?: UpsertSpec): ObjList<ExemptFromFacilityFilter> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): ExemptFromFacilityFilter | null;
   ...
   */
  static beforeCreate(objs: Array_Type<ExemptFromFacilityFilter>): ObjList<ExemptFromFacilityFilter>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<ExemptFromFacilityFilter>): ObjList<ExemptFromFacilityFilter>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<ExemptFromFacilityFilter>): ObjList<ExemptFromFacilityFilter>;
   ...
   */
  static afterCreate(objs: Array_Type<ExemptFromFacilityFilter>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<ExemptFromFacilityFilter>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<ExemptFromFacilityFilter>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<ExemptFromFacilityFilter>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ExemptFromFacilityFilter>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): ExemptFromFacilityFilter | null;
   ...
   */
  withoutIdentity(): ExemptFromFacilityFilter | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<ExemptFromFacilityFilter>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: ExemptFromFacilityFilter, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<ExemptFromFacilityFilter>, callback?: λFunction<ExemptFromFacilityFilter | null, ExemptFromFacilityFilter | null>): ObjList<ExemptFromFacilityFilter>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<ExemptFromFacilityFilter>, callback?: λFunction<ExemptFromFacilityFilter | null, ExemptFromFacilityFilter | null>): Array_Type<ObjError> | null;
