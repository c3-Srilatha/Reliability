// TypeScript definitions for the C3 type PointMeasurement

/**
 * Remixing {@link PointMeasurement} to have additional fields used by Reliability specific use-cases.
 *
 * @remarks this represents a value passed to a method that expects an instance of PointMeasurement
 */
declare interface IPointMeasurement {
 ...
 */
declare class PointMeasurement extends Obj  {

  /**
   * start date for the data point
   */
  readonly start: DateTime;
  withStart(start: DateTime | Date | string): PointMeasurement;
  ...
  withOutlierCode(outlierCode: number | null): PointMeasurement;

  /**
   * (Optional) any comments for the data point
   */
  readonly comments?: string;
  withComments(comments: string | null): PointMeasurement;

  /**
   * Denotes if the value is an actual value or an estimated value. default = null (actual value)
   */
  readonly isEstimated?: boolean;
  withIsEstimated(isEstimated: boolean): PointMeasurement;
  ...
  withDataVersion(dataVersion: number | null): PointMeasurement;

  /**
   * Customer specific status code for the data point (may be used to denote data quality)
   */
  readonly statusCode?: string;
  withStatusCode(statusCode: string | null): PointMeasurement;

  /**
   * Partition key Bin separator used to separate partition key from bin id
   */
  readonly PK_BIN_SEPARATOR?: string;
  withPK_BIN_SEPARATOR(PK_BIN_SEPARATOR: string | null): PointMeasurement;

  readonly parent: PointPhysicalMeasurementSeries;
  withParent(parent: IPointPhysicalMeasurementSeries): PointMeasurement;

  /**
   * with numerical value and unit. unit refrenced from {parent.unitConstraint}
   */
  readonly quantity: ExactDimension;
  withQuantity(quantity: IExactDimension): PointMeasurement;
   ...
   */
  readonly id: string;
  withId(id: string): PointMeasurement;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): PointMeasurement;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): PointMeasurement;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): PointMeasurement;
  ...
  withVersion(version: number | null): PointMeasurement;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): PointMeasurement;

  /**
   * stringified representation of {@link PointMeasurement#quantity}.
   */
  readonly stringValue?: string;
  withStringValue(stringValue: string | null): PointMeasurement;
   ...
   * @see #toJson
   */
  static fromJson(json: any): PointMeasurement | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): PointMeasurement | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): PointMeasurement | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): PointMeasurement | null;
   ...
   */
  replaceType(old: Type, new_: Type): PointMeasurement;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): PointMeasurement;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): PointMeasurement;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<PointMeasurement>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<PointMeasurement>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): PointMeasurement;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): PointMeasurement;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): PointMeasurement;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): PointMeasurement;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): PointMeasurement;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): PointMeasurement;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): PointMeasurement;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): PointMeasurement;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): PointMeasurement;
   ...
   * @see #removeField
   */
  withoutField(field: string): PointMeasurement;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): PointMeasurement;
   ...
   */
  withoutFields(fields: Array_Type<string>): PointMeasurement;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): PointMeasurement;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): PointMeasurement;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): PointMeasurement;
   ...
   * @see #unsetField
   */
  defaultField(field: string): PointMeasurement;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): PointMeasurement;
   ...
   * @see #removeField
   */
  unsetField(field: string): PointMeasurement;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): PointMeasurement;
   ...
   * @see #unsetField
   */
  removeField(field: string): PointMeasurement;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): PointMeasurement;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): PointMeasurement;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): PointMeasurement;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): PointMeasurement;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): PointMeasurement;

  mergeJson(json: any): PointMeasurement;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): PointMeasurement;
   ...
   */
  sumObj(other: Obj, deep?: boolean): PointMeasurement;
   ...
   */
  singletonArray(): Array_Type<PointMeasurement>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<PointMeasurement> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<PointMeasurement> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<PointMeasurement>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<PointMeasurement> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, PointMeasurement> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, PointMeasurement> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<PointMeasurement>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<PointMeasurement>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): PointMeasurement;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): PointMeasurement;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): PointMeasurement;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): PointMeasurement;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): PointMeasurement;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): PointMeasurement;
   ...
   * @see #fromString
   */
  static make(s: string): PointMeasurement | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): PointMeasurement;
   ...
   */
  static cachedEmptyInst(): PointMeasurement;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<PointMeasurement> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): PointMeasurement;

  /**
   * Extract the partition key from the given obj
   */
  partitionKey(failIfMissing?: boolean): PointPhysicalMeasurementSeries | null;
   ...
   */
  static partition(objs?: Stream<PointMeasurement>, spec?: PartitionBucketStrategy): Map_Type<string, KvDataPartition> | null;
   ...
   */
  static fromPartitions(partitions?: Stream<KvDataPartition>): Stream<PointMeasurement> | null;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<PointMeasurement>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<PointMeasurement>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<PointMeasurement> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<PointMeasurement>> | null;
   ...
   */
  get(include?: string): PointMeasurement | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): PointMeasurement | null;
   ...
   */
  getMissing(spec: GetMissingSpec): PointMeasurement;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): PointMeasurement | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): PointMeasurement;
   ...
   * @see #toString
   */
  static fromString(s: string): PointMeasurement | null;
   ...
   */
  create(spec?: UpsertSpec): PointMeasurement | null;
   ...
   */
  static createBatch(objs: Array_Type<PointMeasurement>, spec?: UpsertSpec): ObjList<PointMeasurement> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<PointMeasurement>, spec?: CreateBatchObjStreamSpec): ObjList<PointMeasurement> | null;
   ...
   */
  update(srcObj?: PointMeasurement, spec?: UpsertSpec): PointMeasurement | null;
   ...
   */
  upsert(srcObj?: PointMeasurement, spec?: UpsertSpec): PointMeasurement | null;
   ...
   */
  merge(spec?: MergeSpec): PointMeasurement | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): PointMeasurement | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): PointMeasurement | null;
   ...
   */
  static updateBatch(objs: Array_Type<PointMeasurement>, srcObjs?: Array_Type<PointMeasurement>, spec?: UpsertSpec): ObjList<PointMeasurement> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<PointMeasurement> | null>, spec?: UpsertSpec): ObjList<PointMeasurement> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<PointMeasurement>, srcObjs?: Array_Type<PointMeasurement>, spec?: UpsertSpec): ObjList<PointMeasurement> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<PointMeasurement> | null>, spec?: UpsertSpec): ObjList<PointMeasurement> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<PointMeasurement>, spec?: TouchSpec): ObjList<PointMeasurement> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<PointMeasurement>, spec?: MergeSpec): ObjList<PointMeasurement> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<PointMeasurement>, mergeInclude: string, spec?: MergeSpec): ObjList<PointMeasurement> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<PointMeasurement> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<PointMeasurement> | null;
   ...
   */
  static mergeAll(mergeObj: PointMeasurement, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: PointMeasurement, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<PointMeasurement>, spec?: UpsertSpec): ObjList<PointMeasurement> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<PointMeasurement>, spec?: UpsertSpec): ObjList<PointMeasurement> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): PointMeasurement | null;
   ...
   */
  static beforeCreate(objs: Array_Type<PointMeasurement>): ObjList<PointMeasurement>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<PointMeasurement>): ObjList<PointMeasurement>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<PointMeasurement>): ObjList<PointMeasurement>;
   ...
   */
  static afterCreate(objs: Array_Type<PointMeasurement>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<PointMeasurement>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<PointMeasurement>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<PointMeasurement>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<PointMeasurement>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): PointMeasurement | null;
   ...
   */
  withoutIdentity(): PointMeasurement | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<PointMeasurement>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: PointMeasurement, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<PointMeasurement>, callback?: λFunction<PointMeasurement | null, PointMeasurement | null>): ObjList<PointMeasurement>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<PointMeasurement>, callback?: λFunction<PointMeasurement | null, PointMeasurement | null>): Array_Type<ObjError> | null;
