// TypeScript definitions for the C3 type AssetLevel

/**
 * Represents the conceptual level of any {@link ReliabilityAsset} in the hierarchy.
 *
 * @remarks this represents a value passed to a method that expects an instance of AssetLevel
 */
declare interface IAssetLevel {
 ...
 */
declare class AssetLevel extends Obj  {
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): AssetLevel;

  /**
   * The label for this asset level. E.g Facility, System, Equipment etc.
   */
  readonly name: string;
  withName(name: string): AssetLevel;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): AssetLevel;
  ...
  withVersion(version: number | null): AssetLevel;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): AssetLevel;
  ...
  withUserUpdatedFields(userUpdatedFields: Array_Type<string> | Array<string> | null): AssetLevel;
  ...
  withHidden(hidden: boolean): AssetLevel;
  ...
  withUserOwned(userOwned: boolean): AssetLevel;
  ...
  withTranslatedName(translatedName: string | null): AssetLevel;
  ...
  withLevel(level: number): AssetLevel;
   ...
   * @see #toJson
   */
  static fromJson(json: any): AssetLevel | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): AssetLevel | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): AssetLevel | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): AssetLevel | null;
   ...
   */
  replaceType(old: Type, new_: Type): AssetLevel;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): AssetLevel;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): AssetLevel;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<AssetLevel>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<AssetLevel>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): AssetLevel;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): AssetLevel;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): AssetLevel;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): AssetLevel;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): AssetLevel;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): AssetLevel;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): AssetLevel;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): AssetLevel;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): AssetLevel;
   ...
   * @see #removeField
   */
  withoutField(field: string): AssetLevel;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): AssetLevel;
   ...
   */
  withoutFields(fields: Array_Type<string>): AssetLevel;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): AssetLevel;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): AssetLevel;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): AssetLevel;
   ...
   * @see #unsetField
   */
  defaultField(field: string): AssetLevel;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): AssetLevel;
   ...
   * @see #removeField
   */
  unsetField(field: string): AssetLevel;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): AssetLevel;
   ...
   * @see #unsetField
   */
  removeField(field: string): AssetLevel;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): AssetLevel;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): AssetLevel;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): AssetLevel;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): AssetLevel;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): AssetLevel;

  mergeJson(json: any): AssetLevel;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): AssetLevel;
   ...
   */
  sumObj(other: Obj, deep?: boolean): AssetLevel;
   ...
   */
  singletonArray(): Array_Type<AssetLevel>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<AssetLevel> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<AssetLevel> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<AssetLevel>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<AssetLevel> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, AssetLevel> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, AssetLevel> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<AssetLevel>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<AssetLevel>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): AssetLevel;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): AssetLevel;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): AssetLevel;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): AssetLevel;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): AssetLevel;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): AssetLevel;
   ...
   * @see #fromString
   */
  static make(s: string): AssetLevel | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): AssetLevel;
   ...
   */
  static cachedEmptyInst(): AssetLevel;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<AssetLevel> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): AssetLevel;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<AssetLevel> | null;
   ...
   */
  static find(filter?: string, doNotProduceAll?: boolean): Stream<AssetLevel> | null;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<AssetLevel> | null;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): AssetLevel | null;
   ...
   * @see findByCacheKey
   */
  static forCacheKey(key: string): AssetLevel | null;
   ...
   * @see findByCacheKey
   */
  getCached(): AssetLevel | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): AssetLevel | null;
   ...
   */
  static produce(key: string): AssetLevel | null;
   ...
   */
  static produceAll(): Map_Type<string, AssetLevel> | null;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): Map_Type<string, AssetLevel> | null;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<AssetLevel>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<AssetLevel>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<AssetLevel> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<AssetLevel>> | null;
   ...
   */
  get(include?: string): AssetLevel | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): AssetLevel | null;
   ...
   */
  getMissing(spec: GetMissingSpec): AssetLevel;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): AssetLevel | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): AssetLevel;
   ...
   * @see #toString
   */
  static fromString(s: string): AssetLevel | null;
   ...
   */
  create(spec?: UpsertSpec): AssetLevel | null;
   ...
   */
  static createBatch(objs: Array_Type<AssetLevel>, spec?: UpsertSpec): ObjList<AssetLevel> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<AssetLevel>, spec?: CreateBatchObjStreamSpec): ObjList<AssetLevel> | null;
   ...
   */
  update(srcObj?: AssetLevel, spec?: UpsertSpec): AssetLevel | null;
   ...
   */
  upsert(srcObj?: AssetLevel, spec?: UpsertSpec): AssetLevel | null;
   ...
   */
  merge(spec?: MergeSpec): AssetLevel | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): AssetLevel | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): AssetLevel | null;
   ...
   */
  static updateBatch(objs: Array_Type<AssetLevel>, srcObjs?: Array_Type<AssetLevel>, spec?: UpsertSpec): ObjList<AssetLevel> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<AssetLevel> | null>, spec?: UpsertSpec): ObjList<AssetLevel> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<AssetLevel>, srcObjs?: Array_Type<AssetLevel>, spec?: UpsertSpec): ObjList<AssetLevel> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<AssetLevel> | null>, spec?: UpsertSpec): ObjList<AssetLevel> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<AssetLevel>, spec?: TouchSpec): ObjList<AssetLevel> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<AssetLevel>, spec?: MergeSpec): ObjList<AssetLevel> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<AssetLevel>, mergeInclude: string, spec?: MergeSpec): ObjList<AssetLevel> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<AssetLevel> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<AssetLevel> | null;
   ...
   */
  static mergeAll(mergeObj: AssetLevel, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: AssetLevel, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<AssetLevel>, spec?: UpsertSpec): ObjList<AssetLevel> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<AssetLevel>, spec?: UpsertSpec): ObjList<AssetLevel> | null;
   ...
   */
  static beforeCreate(objs: Array_Type<AssetLevel>): ObjList<AssetLevel>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<AssetLevel>): ObjList<AssetLevel>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<AssetLevel>): ObjList<AssetLevel>;
   ...
   */
  static afterCreate(objs: Array_Type<AssetLevel>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<AssetLevel>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<AssetLevel>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<AssetLevel>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<AssetLevel>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): AssetLevel | null;
   ...
   */
  withoutIdentity(): AssetLevel | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<AssetLevel>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: AssetLevel, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<AssetLevel>, callback?: λFunction<AssetLevel | null, AssetLevel | null>): ObjList<AssetLevel>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<AssetLevel>, callback?: λFunction<AssetLevel | null, AssetLevel | null>): Array_Type<ObjError> | null;
   ...
   */
  publish(subPath?: string, contentType?: string): AssetLevel;
   ...
   */
  static removeSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<AssetLevel> | null;
   ...
   */
  createSeedData(spec?: UpsertSpec): AssetLevel | null;
   ...
   */
  static createSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<AssetLevel> | null;
   ...
   */
  updateSeedData(srcObj?: SeedData, spec?: UpsertSpec): AssetLevel | null;
   ...
   */
  static updateSeedDataBatch(objs?: Array_Type<SeedData>, srcObjs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<AssetLevel> | null;
   ...
   * @return updated obj instance, same as {@link Persistable#update} return value.
   */
  clearUserUpdates(spec?: MergeSpec): AssetLevel | null;
   ...
   *         {@link Persistable#updateBatch}.
   */
  static clearUserUpdatesBatch(objs?: Array_Type<SeedData>, spec?: MergeSpec): ObjList<AssetLevel> | null;
  ...
  dependencies(): SeedDataDeps<AssetLevel> | null;
