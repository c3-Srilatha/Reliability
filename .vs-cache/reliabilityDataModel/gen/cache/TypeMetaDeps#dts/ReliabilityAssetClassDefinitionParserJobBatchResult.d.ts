// TypeScript definitions for the C3 type ReliabilityAssetClassDefinitionParserJobBatchResult

/**
 * Represents the result of each batch of {@link ReliabilityAssetClassDefinitionParserJob}.
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityAssetClassDefinitionParserJobBatchResult
 */
declare interface IReliabilityAssetClassDefinitionParserJobBatchResult {
  ...
  /**
   * The job that was executed to produce this result. This will always be the job with `id`
   * equal to "ReliabilityAssetClassDefinitionParserJob", since this type is a singleton.
   */
  job: IReliabilityAssetClassDefinitionParserJob;

  /**
   * Indicates whether the batch was successfully processed or not.
   */
  status: string;

  /**
   * The definition version that this batch should parse and persist.
   */
  definitionVersion: IReliabilityAssetClassDefinitionVersion;

  /**
   * If true, this batch did nothing since an {@link AssetClass} was already persisted with the
   * `definitionVersion.file` of this batch. If {@link ReliabilityAssetClassDefinitionParserJobOptions#shouldOverwrite}
   * is true, this will always be false.
   */
  alreadyPersisted?: boolean;

  /**
   * The {@link AssetClass} that was persisted as a result of this batch. If empty, an error occurred.
   */
  assetClass?: IAssetClass;

  /**
   * An identifier to give this result. Used to aggregate the result of the parser job
   * for a particular {@link Workflow.Run} of {@link ReliabilityAssetClassDefinitionParser}.
   */
  trackingId: string;

  /**
   * The error message that occurred during the processing of this batch. If empty, the batch was
   * processed successfully. This will most likely be an error caused by running
   * {@link ReliabilityAssetClassDefinitionVersion#persistVersion}.
   */
  error?: string;
}
 ...
 * Represents the result of each batch of {@link ReliabilityAssetClassDefinitionParserJob}.
 *
 * @remarks this represents a made instance of ReliabilityAssetClassDefinitionParserJobBatchResult
 */
declare class ReliabilityAssetClassDefinitionParserJobBatchResult extends Obj  {
   ...
   */
  readonly id: string;
  withId(id: string): ReliabilityAssetClassDefinitionParserJobBatchResult;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityAssetClassDefinitionParserJobBatchResult;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): ReliabilityAssetClassDefinitionParserJobBatchResult;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): ReliabilityAssetClassDefinitionParserJobBatchResult;
  ...
  withVersion(version: number | null): ReliabilityAssetClassDefinitionParserJobBatchResult;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): ReliabilityAssetClassDefinitionParserJobBatchResult;

  /**
   * The job that was executed to produce this result. This will always be the job with `id`
   * equal to "ReliabilityAssetClassDefinitionParserJob", since this type is a singleton.
   */
  readonly job: ReliabilityAssetClassDefinitionParserJob;
  withJob(job: IReliabilityAssetClassDefinitionParserJob): ReliabilityAssetClassDefinitionParserJobBatchResult;

  /**
   * Indicates whether the batch was successfully processed or not.
   */
  readonly status: string;
  withStatus(status: string): ReliabilityAssetClassDefinitionParserJobBatchResult;

  /**
   * The definition version that this batch should parse and persist.
   */
  readonly definitionVersion: ReliabilityAssetClassDefinitionVersion;
  withDefinitionVersion(definitionVersion: IReliabilityAssetClassDefinitionVersion): ReliabilityAssetClassDefinitionParserJobBatchResult;
  ...
  withAlreadyPersisted(alreadyPersisted: boolean): ReliabilityAssetClassDefinitionParserJobBatchResult;

  /**
   * The {@link AssetClass} that was persisted as a result of this batch. If empty, an error occurred.
   */
  readonly assetClass?: AssetClass;
  withAssetClass(assetClass: IAssetClass | null): ReliabilityAssetClassDefinitionParserJobBatchResult;
  ...
  withTrackingId(trackingId: string): ReliabilityAssetClassDefinitionParserJobBatchResult;
  ...
  withError(error: string | null): ReliabilityAssetClassDefinitionParserJobBatchResult;
   ...
   * @see #toJson
   */
  static fromJson(json: any): ReliabilityAssetClassDefinitionParserJobBatchResult | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): ReliabilityAssetClassDefinitionParserJobBatchResult | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): ReliabilityAssetClassDefinitionParserJobBatchResult | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): ReliabilityAssetClassDefinitionParserJobBatchResult | null;
   ...
   */
  replaceType(old: Type, new_: Type): ReliabilityAssetClassDefinitionParserJobBatchResult;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityAssetClassDefinitionParserJobBatchResult;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityAssetClassDefinitionParserJobBatchResult;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityAssetClassDefinitionParserJobBatchResult>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityAssetClassDefinitionParserJobBatchResult>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityAssetClassDefinitionParserJobBatchResult;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityAssetClassDefinitionParserJobBatchResult;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityAssetClassDefinitionParserJobBatchResult;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ReliabilityAssetClassDefinitionParserJobBatchResult;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ReliabilityAssetClassDefinitionParserJobBatchResult;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityAssetClassDefinitionParserJobBatchResult;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityAssetClassDefinitionParserJobBatchResult;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityAssetClassDefinitionParserJobBatchResult;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ReliabilityAssetClassDefinitionParserJobBatchResult;
   ...
   * @see #removeField
   */
  withoutField(field: string): ReliabilityAssetClassDefinitionParserJobBatchResult;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): ReliabilityAssetClassDefinitionParserJobBatchResult;
   ...
   */
  withoutFields(fields: Array_Type<string>): ReliabilityAssetClassDefinitionParserJobBatchResult;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityAssetClassDefinitionParserJobBatchResult;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ReliabilityAssetClassDefinitionParserJobBatchResult;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityAssetClassDefinitionParserJobBatchResult;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ReliabilityAssetClassDefinitionParserJobBatchResult;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ReliabilityAssetClassDefinitionParserJobBatchResult;
   ...
   * @see #removeField
   */
  unsetField(field: string): ReliabilityAssetClassDefinitionParserJobBatchResult;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ReliabilityAssetClassDefinitionParserJobBatchResult;
   ...
   * @see #unsetField
   */
  removeField(field: string): ReliabilityAssetClassDefinitionParserJobBatchResult;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ReliabilityAssetClassDefinitionParserJobBatchResult;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityAssetClassDefinitionParserJobBatchResult;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityAssetClassDefinitionParserJobBatchResult;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityAssetClassDefinitionParserJobBatchResult;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityAssetClassDefinitionParserJobBatchResult;

  mergeJson(json: any): ReliabilityAssetClassDefinitionParserJobBatchResult;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityAssetClassDefinitionParserJobBatchResult;
   ...
   */
  sumObj(other: Obj, deep?: boolean): ReliabilityAssetClassDefinitionParserJobBatchResult;
   ...
   */
  singletonArray(): Array_Type<ReliabilityAssetClassDefinitionParserJobBatchResult>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityAssetClassDefinitionParserJobBatchResult> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ReliabilityAssetClassDefinitionParserJobBatchResult> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<ReliabilityAssetClassDefinitionParserJobBatchResult>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ReliabilityAssetClassDefinitionParserJobBatchResult> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, ReliabilityAssetClassDefinitionParserJobBatchResult> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityAssetClassDefinitionParserJobBatchResult> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ReliabilityAssetClassDefinitionParserJobBatchResult>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ReliabilityAssetClassDefinitionParserJobBatchResult>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityAssetClassDefinitionParserJobBatchResult;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityAssetClassDefinitionParserJobBatchResult;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityAssetClassDefinitionParserJobBatchResult;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ReliabilityAssetClassDefinitionParserJobBatchResult;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityAssetClassDefinitionParserJobBatchResult;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ReliabilityAssetClassDefinitionParserJobBatchResult;
   ...
   * @see #fromString
   */
  static make(s: string): ReliabilityAssetClassDefinitionParserJobBatchResult | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityAssetClassDefinitionParserJobBatchResult;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): ReliabilityAssetClassDefinitionParserJobBatchResult;
   ...
   */
  static cachedEmptyInst(): ReliabilityAssetClassDefinitionParserJobBatchResult;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityAssetClassDefinitionParserJobBatchResult> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): ReliabilityAssetClassDefinitionParserJobBatchResult;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<ReliabilityAssetClassDefinitionParserJobBatchResult>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<ReliabilityAssetClassDefinitionParserJobBatchResult>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityAssetClassDefinitionParserJobBatchResult> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityAssetClassDefinitionParserJobBatchResult>> | null;
   ...
   */
  get(include?: string): ReliabilityAssetClassDefinitionParserJobBatchResult | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): ReliabilityAssetClassDefinitionParserJobBatchResult | null;
   ...
   */
  getMissing(spec: GetMissingSpec): ReliabilityAssetClassDefinitionParserJobBatchResult;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): ReliabilityAssetClassDefinitionParserJobBatchResult | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): ReliabilityAssetClassDefinitionParserJobBatchResult;
   ...
   * @see #toString
   */
  static fromString(s: string): ReliabilityAssetClassDefinitionParserJobBatchResult | null;
   ...
   */
  create(spec?: UpsertSpec): ReliabilityAssetClassDefinitionParserJobBatchResult | null;
   ...
   */
  static createBatch(objs: Array_Type<ReliabilityAssetClassDefinitionParserJobBatchResult>, spec?: UpsertSpec): ObjList<ReliabilityAssetClassDefinitionParserJobBatchResult> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<ReliabilityAssetClassDefinitionParserJobBatchResult>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityAssetClassDefinitionParserJobBatchResult> | null;
   ...
   */
  update(srcObj?: ReliabilityAssetClassDefinitionParserJobBatchResult, spec?: UpsertSpec): ReliabilityAssetClassDefinitionParserJobBatchResult | null;
   ...
   */
  upsert(srcObj?: ReliabilityAssetClassDefinitionParserJobBatchResult, spec?: UpsertSpec): ReliabilityAssetClassDefinitionParserJobBatchResult | null;
   ...
   */
  merge(spec?: MergeSpec): ReliabilityAssetClassDefinitionParserJobBatchResult | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): ReliabilityAssetClassDefinitionParserJobBatchResult | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): ReliabilityAssetClassDefinitionParserJobBatchResult | null;
   ...
   */
  static updateBatch(objs: Array_Type<ReliabilityAssetClassDefinitionParserJobBatchResult>, srcObjs?: Array_Type<ReliabilityAssetClassDefinitionParserJobBatchResult>, spec?: UpsertSpec): ObjList<ReliabilityAssetClassDefinitionParserJobBatchResult> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<ReliabilityAssetClassDefinitionParserJobBatchResult> | null>, spec?: UpsertSpec): ObjList<ReliabilityAssetClassDefinitionParserJobBatchResult> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<ReliabilityAssetClassDefinitionParserJobBatchResult>, srcObjs?: Array_Type<ReliabilityAssetClassDefinitionParserJobBatchResult>, spec?: UpsertSpec): ObjList<ReliabilityAssetClassDefinitionParserJobBatchResult> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<ReliabilityAssetClassDefinitionParserJobBatchResult> | null>, spec?: UpsertSpec): ObjList<ReliabilityAssetClassDefinitionParserJobBatchResult> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<ReliabilityAssetClassDefinitionParserJobBatchResult>, spec?: TouchSpec): ObjList<ReliabilityAssetClassDefinitionParserJobBatchResult> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityAssetClassDefinitionParserJobBatchResult>, spec?: MergeSpec): ObjList<ReliabilityAssetClassDefinitionParserJobBatchResult> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityAssetClassDefinitionParserJobBatchResult>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityAssetClassDefinitionParserJobBatchResult> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<ReliabilityAssetClassDefinitionParserJobBatchResult> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityAssetClassDefinitionParserJobBatchResult> | null;
   ...
   */
  static mergeAll(mergeObj: ReliabilityAssetClassDefinitionParserJobBatchResult, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: ReliabilityAssetClassDefinitionParserJobBatchResult, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<ReliabilityAssetClassDefinitionParserJobBatchResult>, spec?: UpsertSpec): ObjList<ReliabilityAssetClassDefinitionParserJobBatchResult> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<ReliabilityAssetClassDefinitionParserJobBatchResult>, spec?: UpsertSpec): ObjList<ReliabilityAssetClassDefinitionParserJobBatchResult> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): ReliabilityAssetClassDefinitionParserJobBatchResult | null;
   ...
   */
  static beforeCreate(objs: Array_Type<ReliabilityAssetClassDefinitionParserJobBatchResult>): ObjList<ReliabilityAssetClassDefinitionParserJobBatchResult>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<ReliabilityAssetClassDefinitionParserJobBatchResult>): ObjList<ReliabilityAssetClassDefinitionParserJobBatchResult>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<ReliabilityAssetClassDefinitionParserJobBatchResult>): ObjList<ReliabilityAssetClassDefinitionParserJobBatchResult>;
   ...
   */
  static afterCreate(objs: Array_Type<ReliabilityAssetClassDefinitionParserJobBatchResult>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<ReliabilityAssetClassDefinitionParserJobBatchResult>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<ReliabilityAssetClassDefinitionParserJobBatchResult>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityAssetClassDefinitionParserJobBatchResult>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityAssetClassDefinitionParserJobBatchResult>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): ReliabilityAssetClassDefinitionParserJobBatchResult | null;
   ...
   */
  withoutIdentity(): ReliabilityAssetClassDefinitionParserJobBatchResult | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<ReliabilityAssetClassDefinitionParserJobBatchResult>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: ReliabilityAssetClassDefinitionParserJobBatchResult, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<ReliabilityAssetClassDefinitionParserJobBatchResult>, callback?: λFunction<ReliabilityAssetClassDefinitionParserJobBatchResult | null, ReliabilityAssetClassDefinitionParserJobBatchResult | null>): ObjList<ReliabilityAssetClassDefinitionParserJobBatchResult>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<ReliabilityAssetClassDefinitionParserJobBatchResult>, callback?: λFunction<ReliabilityAssetClassDefinitionParserJobBatchResult | null, ReliabilityAssetClassDefinitionParserJobBatchResult | null>): Array_Type<ObjError> | null;
