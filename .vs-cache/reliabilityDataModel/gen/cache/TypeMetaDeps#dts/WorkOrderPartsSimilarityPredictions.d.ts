// TypeScript definitions for the C3 type WorkOrderPartsSimilarityPredictions

/**
 * This contains the similiarity scoring for parts in an {@link WorkOrder} to other {@link WorkOrder}s
 *
 * @remarks this represents a value passed to a method that expects an instance of WorkOrderPartsSimilarityPredictions
 */
declare interface IWorkOrderPartsSimilarityPredictions {
  ...
  /**
   * The {@link WorkOrder} for which the prediction is made.
   */
  parent: IWorkOrder;

  /**
   * The similar {@link WorkOrder} for which the the parts scoring were generated.
   */
  similarWorkOrders: Array_Type<WorkOrder> | Array<IWorkOrder>;

  /**
   * The {@link InventorySeries} which is a unique object for a part.
   * This is tied back to the {@link #similarWorkOrders}
   */
  part: IInventorySeries;

  /**
   * The sum of quantity of the {@link #part} from the associated {@link #similarWorkOrders}.
   */
  quantity?: number;

  /**
   * The sum of quantity of the {@link #part} from the associated {@link #similarWorkOrders} normalized
   * by the total quantity of the {@link #part} in the {@link #parent} {@link WorkOrder}. The sum of the
   * normalized scores for all parts in the {@link #parent} will be 100.
   */
 ...
 * This contains the similiarity scoring for parts in an {@link WorkOrder} to other {@link WorkOrder}s
 *
 * @remarks this represents a made instance of WorkOrderPartsSimilarityPredictions
 */
declare class WorkOrderPartsSimilarityPredictions extends Obj  {
   ...
   */
  readonly id: string;
  withId(id: string): WorkOrderPartsSimilarityPredictions;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): WorkOrderPartsSimilarityPredictions;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): WorkOrderPartsSimilarityPredictions;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): WorkOrderPartsSimilarityPredictions;
  ...
  withVersion(version: number | null): WorkOrderPartsSimilarityPredictions;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): WorkOrderPartsSimilarityPredictions;

  /**
   * @inheritdoc
   */
  readonly facilityFilterPaths?: Array_Type<string>;
  withFacilityFilterPaths(facilityFilterPaths: Array_Type<string> | Array<string> | null): WorkOrderPartsSimilarityPredictions;

  /**
   * The {@link WorkOrder} for which the prediction is made.
   */
  readonly parent: WorkOrder;
  withParent(parent: IWorkOrder): WorkOrderPartsSimilarityPredictions;

  /**
   * The similar {@link WorkOrder} for which the the parts scoring were generated.
   */
  readonly similarWorkOrders: Array_Type<WorkOrder>;
  withSimilarWorkOrders(similarWorkOrders: Array_Type<WorkOrder> | Array<IWorkOrder>): WorkOrderPartsSimilarityPredictions;

  /**
   * The {@link InventorySeries} which is a unique object for a part.
   * This is tied back to the {@link #similarWorkOrders}
   */
  readonly part: InventorySeries;
  withPart(part: IInventorySeries): WorkOrderPartsSimilarityPredictions;

  /**
   * The sum of quantity of the {@link #part} from the associated {@link #similarWorkOrders}.
   */
  readonly quantity?: number;
  withQuantity(quantity: number | null): WorkOrderPartsSimilarityPredictions;
  ...
  withNormalizedScore(normalizedScore: number | null): WorkOrderPartsSimilarityPredictions;
   ...
   * @see #toJson
   */
  static fromJson(json: any): WorkOrderPartsSimilarityPredictions | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): WorkOrderPartsSimilarityPredictions | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): WorkOrderPartsSimilarityPredictions | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): WorkOrderPartsSimilarityPredictions | null;
   ...
   */
  replaceType(old: Type, new_: Type): WorkOrderPartsSimilarityPredictions;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): WorkOrderPartsSimilarityPredictions;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): WorkOrderPartsSimilarityPredictions;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<WorkOrderPartsSimilarityPredictions>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<WorkOrderPartsSimilarityPredictions>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): WorkOrderPartsSimilarityPredictions;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): WorkOrderPartsSimilarityPredictions;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): WorkOrderPartsSimilarityPredictions;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): WorkOrderPartsSimilarityPredictions;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): WorkOrderPartsSimilarityPredictions;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): WorkOrderPartsSimilarityPredictions;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): WorkOrderPartsSimilarityPredictions;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): WorkOrderPartsSimilarityPredictions;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): WorkOrderPartsSimilarityPredictions;
   ...
   * @see #removeField
   */
  withoutField(field: string): WorkOrderPartsSimilarityPredictions;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): WorkOrderPartsSimilarityPredictions;
   ...
   */
  withoutFields(fields: Array_Type<string>): WorkOrderPartsSimilarityPredictions;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): WorkOrderPartsSimilarityPredictions;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): WorkOrderPartsSimilarityPredictions;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): WorkOrderPartsSimilarityPredictions;
   ...
   * @see #unsetField
   */
  defaultField(field: string): WorkOrderPartsSimilarityPredictions;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): WorkOrderPartsSimilarityPredictions;
   ...
   * @see #removeField
   */
  unsetField(field: string): WorkOrderPartsSimilarityPredictions;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): WorkOrderPartsSimilarityPredictions;
   ...
   * @see #unsetField
   */
  removeField(field: string): WorkOrderPartsSimilarityPredictions;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): WorkOrderPartsSimilarityPredictions;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): WorkOrderPartsSimilarityPredictions;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): WorkOrderPartsSimilarityPredictions;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): WorkOrderPartsSimilarityPredictions;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): WorkOrderPartsSimilarityPredictions;

  mergeJson(json: any): WorkOrderPartsSimilarityPredictions;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): WorkOrderPartsSimilarityPredictions;
   ...
   */
  sumObj(other: Obj, deep?: boolean): WorkOrderPartsSimilarityPredictions;
   ...
   */
  singletonArray(): Array_Type<WorkOrderPartsSimilarityPredictions>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<WorkOrderPartsSimilarityPredictions> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<WorkOrderPartsSimilarityPredictions> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<WorkOrderPartsSimilarityPredictions>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<WorkOrderPartsSimilarityPredictions> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, WorkOrderPartsSimilarityPredictions> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, WorkOrderPartsSimilarityPredictions> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<WorkOrderPartsSimilarityPredictions>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<WorkOrderPartsSimilarityPredictions>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): WorkOrderPartsSimilarityPredictions;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): WorkOrderPartsSimilarityPredictions;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): WorkOrderPartsSimilarityPredictions;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): WorkOrderPartsSimilarityPredictions;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): WorkOrderPartsSimilarityPredictions;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): WorkOrderPartsSimilarityPredictions;
   ...
   * @see #fromString
   */
  static make(s: string): WorkOrderPartsSimilarityPredictions | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): WorkOrderPartsSimilarityPredictions;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): WorkOrderPartsSimilarityPredictions;
   ...
   */
  static cachedEmptyInst(): WorkOrderPartsSimilarityPredictions;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<WorkOrderPartsSimilarityPredictions> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): WorkOrderPartsSimilarityPredictions;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<WorkOrderPartsSimilarityPredictions>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<WorkOrderPartsSimilarityPredictions>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<WorkOrderPartsSimilarityPredictions> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<WorkOrderPartsSimilarityPredictions>> | null;
   ...
   */
  get(include?: string): WorkOrderPartsSimilarityPredictions | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): WorkOrderPartsSimilarityPredictions | null;
   ...
   */
  getMissing(spec: GetMissingSpec): WorkOrderPartsSimilarityPredictions;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): WorkOrderPartsSimilarityPredictions | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): WorkOrderPartsSimilarityPredictions;
   ...
   * @see #toString
   */
  static fromString(s: string): WorkOrderPartsSimilarityPredictions | null;
   ...
   */
  create(spec?: UpsertSpec): WorkOrderPartsSimilarityPredictions | null;
   ...
   */
  static createBatch(objs: Array_Type<WorkOrderPartsSimilarityPredictions>, spec?: UpsertSpec): ObjList<WorkOrderPartsSimilarityPredictions> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<WorkOrderPartsSimilarityPredictions>, spec?: CreateBatchObjStreamSpec): ObjList<WorkOrderPartsSimilarityPredictions> | null;
   ...
   */
  update(srcObj?: WorkOrderPartsSimilarityPredictions, spec?: UpsertSpec): WorkOrderPartsSimilarityPredictions | null;
   ...
   */
  upsert(srcObj?: WorkOrderPartsSimilarityPredictions, spec?: UpsertSpec): WorkOrderPartsSimilarityPredictions | null;
   ...
   */
  merge(spec?: MergeSpec): WorkOrderPartsSimilarityPredictions | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): WorkOrderPartsSimilarityPredictions | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): WorkOrderPartsSimilarityPredictions | null;
   ...
   */
  static updateBatch(objs: Array_Type<WorkOrderPartsSimilarityPredictions>, srcObjs?: Array_Type<WorkOrderPartsSimilarityPredictions>, spec?: UpsertSpec): ObjList<WorkOrderPartsSimilarityPredictions> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<WorkOrderPartsSimilarityPredictions> | null>, spec?: UpsertSpec): ObjList<WorkOrderPartsSimilarityPredictions> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<WorkOrderPartsSimilarityPredictions>, srcObjs?: Array_Type<WorkOrderPartsSimilarityPredictions>, spec?: UpsertSpec): ObjList<WorkOrderPartsSimilarityPredictions> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<WorkOrderPartsSimilarityPredictions> | null>, spec?: UpsertSpec): ObjList<WorkOrderPartsSimilarityPredictions> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<WorkOrderPartsSimilarityPredictions>, spec?: TouchSpec): ObjList<WorkOrderPartsSimilarityPredictions> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<WorkOrderPartsSimilarityPredictions>, spec?: MergeSpec): ObjList<WorkOrderPartsSimilarityPredictions> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<WorkOrderPartsSimilarityPredictions>, mergeInclude: string, spec?: MergeSpec): ObjList<WorkOrderPartsSimilarityPredictions> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<WorkOrderPartsSimilarityPredictions> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<WorkOrderPartsSimilarityPredictions> | null;
   ...
   */
  static mergeAll(mergeObj: WorkOrderPartsSimilarityPredictions, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: WorkOrderPartsSimilarityPredictions, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<WorkOrderPartsSimilarityPredictions>, spec?: UpsertSpec): ObjList<WorkOrderPartsSimilarityPredictions> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<WorkOrderPartsSimilarityPredictions>, spec?: UpsertSpec): ObjList<WorkOrderPartsSimilarityPredictions> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): WorkOrderPartsSimilarityPredictions | null;
   ...
   */
  static beforeCreate(objs: Array_Type<WorkOrderPartsSimilarityPredictions>): ObjList<WorkOrderPartsSimilarityPredictions>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<WorkOrderPartsSimilarityPredictions>): ObjList<WorkOrderPartsSimilarityPredictions>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<WorkOrderPartsSimilarityPredictions>): ObjList<WorkOrderPartsSimilarityPredictions>;
   ...
   */
  static afterCreate(objs: Array_Type<WorkOrderPartsSimilarityPredictions>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<WorkOrderPartsSimilarityPredictions>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<WorkOrderPartsSimilarityPredictions>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<WorkOrderPartsSimilarityPredictions>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<WorkOrderPartsSimilarityPredictions>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): WorkOrderPartsSimilarityPredictions | null;
   ...
   */
  withoutIdentity(): WorkOrderPartsSimilarityPredictions | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<WorkOrderPartsSimilarityPredictions>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: WorkOrderPartsSimilarityPredictions, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<WorkOrderPartsSimilarityPredictions>, callback?: λFunction<WorkOrderPartsSimilarityPredictions | null, WorkOrderPartsSimilarityPredictions | null>): ObjList<WorkOrderPartsSimilarityPredictions>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<WorkOrderPartsSimilarityPredictions>, callback?: λFunction<WorkOrderPartsSimilarityPredictions | null, WorkOrderPartsSimilarityPredictions | null>): Array_Type<ObjError> | null;
