// TypeScript definitions for the C3 type WorkOrderJobCategory

/**
 * Type used to populate work order type through UI.
 *
 * @remarks this represents a value passed to a method that expects an instance of WorkOrderJobCategory
 */
declare interface IWorkOrderJobCategory {
 ...
 */
declare class WorkOrderJobCategory extends Obj  {
   ...
   */
  readonly id: string;
  withId(id: string): WorkOrderJobCategory;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): WorkOrderJobCategory;

  /**
   * The name used to populate {@link WorkOrder#workOrderType} through the UI.
   */
  readonly name?: string;
  withName(name: string | null): WorkOrderJobCategory;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): WorkOrderJobCategory;
  ...
  withVersion(version: number | null): WorkOrderJobCategory;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): WorkOrderJobCategory;

  /**
   * Translated {@link WorkOrderJobCategory#id}, to be used in the UI.
   */
  readonly displayName?: string;
  withDisplayName(displayName: string | null): WorkOrderJobCategory;
   ...
   * @see #toJson
   */
  static fromJson(json: any): WorkOrderJobCategory | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): WorkOrderJobCategory | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): WorkOrderJobCategory | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): WorkOrderJobCategory | null;
   ...
   */
  replaceType(old: Type, new_: Type): WorkOrderJobCategory;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): WorkOrderJobCategory;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): WorkOrderJobCategory;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<WorkOrderJobCategory>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<WorkOrderJobCategory>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): WorkOrderJobCategory;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): WorkOrderJobCategory;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): WorkOrderJobCategory;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): WorkOrderJobCategory;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): WorkOrderJobCategory;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): WorkOrderJobCategory;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): WorkOrderJobCategory;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): WorkOrderJobCategory;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): WorkOrderJobCategory;
   ...
   * @see #removeField
   */
  withoutField(field: string): WorkOrderJobCategory;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): WorkOrderJobCategory;
   ...
   */
  withoutFields(fields: Array_Type<string>): WorkOrderJobCategory;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): WorkOrderJobCategory;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): WorkOrderJobCategory;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): WorkOrderJobCategory;
   ...
   * @see #unsetField
   */
  defaultField(field: string): WorkOrderJobCategory;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): WorkOrderJobCategory;
   ...
   * @see #removeField
   */
  unsetField(field: string): WorkOrderJobCategory;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): WorkOrderJobCategory;
   ...
   * @see #unsetField
   */
  removeField(field: string): WorkOrderJobCategory;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): WorkOrderJobCategory;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): WorkOrderJobCategory;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): WorkOrderJobCategory;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): WorkOrderJobCategory;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): WorkOrderJobCategory;

  mergeJson(json: any): WorkOrderJobCategory;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): WorkOrderJobCategory;
   ...
   */
  sumObj(other: Obj, deep?: boolean): WorkOrderJobCategory;
   ...
   */
  singletonArray(): Array_Type<WorkOrderJobCategory>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<WorkOrderJobCategory> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<WorkOrderJobCategory> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<WorkOrderJobCategory>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<WorkOrderJobCategory> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, WorkOrderJobCategory> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, WorkOrderJobCategory> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<WorkOrderJobCategory>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<WorkOrderJobCategory>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): WorkOrderJobCategory;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): WorkOrderJobCategory;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): WorkOrderJobCategory;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): WorkOrderJobCategory;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): WorkOrderJobCategory;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): WorkOrderJobCategory;
   ...
   * @see #fromString
   */
  static make(s: string): WorkOrderJobCategory | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): WorkOrderJobCategory;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): WorkOrderJobCategory;
   ...
   */
  static cachedEmptyInst(): WorkOrderJobCategory;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<WorkOrderJobCategory> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): WorkOrderJobCategory;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<WorkOrderJobCategory>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<WorkOrderJobCategory>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<WorkOrderJobCategory> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<WorkOrderJobCategory>> | null;
   ...
   */
  get(include?: string): WorkOrderJobCategory | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): WorkOrderJobCategory | null;
   ...
   */
  getMissing(spec: GetMissingSpec): WorkOrderJobCategory;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): WorkOrderJobCategory | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): WorkOrderJobCategory;
   ...
   * @see #toString
   */
  static fromString(s: string): WorkOrderJobCategory | null;
   ...
   */
  create(spec?: UpsertSpec): WorkOrderJobCategory | null;
   ...
   */
  static createBatch(objs: Array_Type<WorkOrderJobCategory>, spec?: UpsertSpec): ObjList<WorkOrderJobCategory> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<WorkOrderJobCategory>, spec?: CreateBatchObjStreamSpec): ObjList<WorkOrderJobCategory> | null;
   ...
   */
  update(srcObj?: WorkOrderJobCategory, spec?: UpsertSpec): WorkOrderJobCategory | null;
   ...
   */
  upsert(srcObj?: WorkOrderJobCategory, spec?: UpsertSpec): WorkOrderJobCategory | null;
   ...
   */
  merge(spec?: MergeSpec): WorkOrderJobCategory | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): WorkOrderJobCategory | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): WorkOrderJobCategory | null;
   ...
   */
  static updateBatch(objs: Array_Type<WorkOrderJobCategory>, srcObjs?: Array_Type<WorkOrderJobCategory>, spec?: UpsertSpec): ObjList<WorkOrderJobCategory> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<WorkOrderJobCategory> | null>, spec?: UpsertSpec): ObjList<WorkOrderJobCategory> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<WorkOrderJobCategory>, srcObjs?: Array_Type<WorkOrderJobCategory>, spec?: UpsertSpec): ObjList<WorkOrderJobCategory> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<WorkOrderJobCategory> | null>, spec?: UpsertSpec): ObjList<WorkOrderJobCategory> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<WorkOrderJobCategory>, spec?: TouchSpec): ObjList<WorkOrderJobCategory> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<WorkOrderJobCategory>, spec?: MergeSpec): ObjList<WorkOrderJobCategory> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<WorkOrderJobCategory>, mergeInclude: string, spec?: MergeSpec): ObjList<WorkOrderJobCategory> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<WorkOrderJobCategory> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<WorkOrderJobCategory> | null;
   ...
   */
  static mergeAll(mergeObj: WorkOrderJobCategory, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: WorkOrderJobCategory, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<WorkOrderJobCategory>, spec?: UpsertSpec): ObjList<WorkOrderJobCategory> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<WorkOrderJobCategory>, spec?: UpsertSpec): ObjList<WorkOrderJobCategory> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): WorkOrderJobCategory | null;
   ...
   */
  static beforeCreate(objs: Array_Type<WorkOrderJobCategory>): ObjList<WorkOrderJobCategory>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<WorkOrderJobCategory>): ObjList<WorkOrderJobCategory>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<WorkOrderJobCategory>): ObjList<WorkOrderJobCategory>;
   ...
   */
  static afterCreate(objs: Array_Type<WorkOrderJobCategory>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<WorkOrderJobCategory>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<WorkOrderJobCategory>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<WorkOrderJobCategory>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<WorkOrderJobCategory>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): WorkOrderJobCategory | null;
   ...
   */
  withoutIdentity(): WorkOrderJobCategory | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<WorkOrderJobCategory>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: WorkOrderJobCategory, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<WorkOrderJobCategory>, callback?: λFunction<WorkOrderJobCategory | null, WorkOrderJobCategory | null>): ObjList<WorkOrderJobCategory>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<WorkOrderJobCategory>, callback?: λFunction<WorkOrderJobCategory | null, WorkOrderJobCategory | null>): Array_Type<ObjError> | null;
