// TypeScript definitions for the C3 type FailureModeLineItemWithActiveStatus

/**
 * Do not persist this type. It is only used to return the result of the fetchWithActiveStatus function.
 * A {@link FailureModeLineItem} with an additional field to indicate whether it is active.
 *
 * @remarks this represents a value passed to a method that expects an instance of FailureModeLineItemWithActiveStatus
 */
declare interface IFailureModeLineItemWithActiveStatus {
  ...
  /**
   * Whether the {@link FailureModeLineItem} active. Represents if the {@link FailureModeLineItem} can be triggered.
   */
  isActive?: boolean;
}
 ...
 * A {@link FailureModeLineItem} with an additional field to indicate whether it is active.
 *
 * @remarks this represents a made instance of FailureModeLineItemWithActiveStatus
 */
declare class FailureModeLineItemWithActiveStatus extends Obj  {

  /**
   * Latest uploaded asset hierarchy file or spreadsheet containing the entity.
   */
  readonly assetOnboardingSourceFile?: AssetOnboardingSourceFile;
  withAssetOnboardingSourceFile(assetOnboardingSourceFile: IAssetOnboardingSourceFile | null): FailureModeLineItemWithActiveStatus;

  /**
   * Indicates when the configuration of this asset was last updated.
   */
  readonly configurationLastUpdated?: DateTime;
  withConfigurationLastUpdated(configurationLastUpdated: DateTime | Date | string | null): FailureModeLineItemWithActiveStatus;
   ...
   */
  readonly id: string;
  withId(id: string): FailureModeLineItemWithActiveStatus;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): FailureModeLineItemWithActiveStatus;

  /**
   * Name of the failure mechanism
   */
  readonly name?: string;
  withName(name: string | null): FailureModeLineItemWithActiveStatus;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): FailureModeLineItemWithActiveStatus;
  ...
  withVersion(version: number | null): FailureModeLineItemWithActiveStatus;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): FailureModeLineItemWithActiveStatus;

  /**
   * Description of the failure mode.
   */
  readonly description?: string;
  withDescription(description: string | null): FailureModeLineItemWithActiveStatus;

  /**
   * The failure mode that contains this record
   */
  readonly failureMode?: FailureMode;
  withFailureMode(failureMode: IFailureMode | null): FailureModeLineItemWithActiveStatus;

  /**
   * Sensor to which the failure mode applies
   */
  readonly expectedSensor?: ExpectedSensor;
  withExpectedSensor(expectedSensor: IExpectedSensor | null): FailureModeLineItemWithActiveStatus;

  /**
   * The diagnostic to apply on the sensor data
   */
  readonly diagnostic?: FailureModeDiagnostic;
  withDiagnostic(diagnostic: IFailureModeDiagnostic | null): FailureModeLineItemWithActiveStatus;

  /**
   * The failure mode will be recommended if the {@link diagnostic} exceeds this threshold
   */
  readonly sensorThreshold?: number;
  withSensorThreshold(sensorThreshold: number | null): FailureModeLineItemWithActiveStatus;

  /**
   * Exceptions to the failure mechanism
   */
  readonly exceptions?: string;
  withExceptions(exceptions: string | null): FailureModeLineItemWithActiveStatus;

  /**
   * Category of this record
   */
  readonly faultCategory?: string;
  withFaultCategory(faultCategory: string | null): FailureModeLineItemWithActiveStatus;

  /**
   * Priority
   */
  readonly priority?: FailureModePriority;
  withPriority(priority: IFailureModePriority | null): FailureModeLineItemWithActiveStatus;

  /**
   * The failure mode library that contains this record
   */
  readonly failureModeLibrary?: FailureModeLibrary;
  withFailureModeLibrary(failureModeLibrary: IFailureModeLibrary | null): FailureModeLineItemWithActiveStatus;

  /**
   * Recommended actions if this failure mode is recommended
   */
  readonly failureRecommendation?: Array_Type<FailureModeRecommendation>;
  withFailureRecommendation(failureRecommendation: Array_Type<FailureModeRecommendation> | Array<IFailureModeRecommendation> | null): FailureModeLineItemWithActiveStatus;

  /**
   * Number of recommended actions
   */
  readonly numRecommendations?: number;
  withNumRecommendations(numRecommendations: number | null): FailureModeLineItemWithActiveStatus;

  /**
   * Whether the {@link FailureModeLineItem} active. Represents if the {@link FailureModeLineItem} can be triggered.
   */
  readonly isActive?: boolean;
  withIsActive(isActive: boolean): FailureModeLineItemWithActiveStatus;
   ...
   * @see #toJson
   */
  static fromJson(json: any): FailureModeLineItemWithActiveStatus | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): FailureModeLineItemWithActiveStatus | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): FailureModeLineItemWithActiveStatus | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): FailureModeLineItemWithActiveStatus | null;
   ...
   */
  replaceType(old: Type, new_: Type): FailureModeLineItemWithActiveStatus;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): FailureModeLineItemWithActiveStatus;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): FailureModeLineItemWithActiveStatus;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<FailureModeLineItemWithActiveStatus>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<FailureModeLineItemWithActiveStatus>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): FailureModeLineItemWithActiveStatus;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): FailureModeLineItemWithActiveStatus;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): FailureModeLineItemWithActiveStatus;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): FailureModeLineItemWithActiveStatus;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): FailureModeLineItemWithActiveStatus;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): FailureModeLineItemWithActiveStatus;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): FailureModeLineItemWithActiveStatus;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): FailureModeLineItemWithActiveStatus;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): FailureModeLineItemWithActiveStatus;
   ...
   * @see #removeField
   */
  withoutField(field: string): FailureModeLineItemWithActiveStatus;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): FailureModeLineItemWithActiveStatus;
   ...
   */
  withoutFields(fields: Array_Type<string>): FailureModeLineItemWithActiveStatus;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): FailureModeLineItemWithActiveStatus;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): FailureModeLineItemWithActiveStatus;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): FailureModeLineItemWithActiveStatus;
   ...
   * @see #unsetField
   */
  defaultField(field: string): FailureModeLineItemWithActiveStatus;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): FailureModeLineItemWithActiveStatus;
   ...
   * @see #removeField
   */
  unsetField(field: string): FailureModeLineItemWithActiveStatus;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): FailureModeLineItemWithActiveStatus;
   ...
   * @see #unsetField
   */
  removeField(field: string): FailureModeLineItemWithActiveStatus;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): FailureModeLineItemWithActiveStatus;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): FailureModeLineItemWithActiveStatus;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): FailureModeLineItemWithActiveStatus;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): FailureModeLineItemWithActiveStatus;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): FailureModeLineItemWithActiveStatus;

  mergeJson(json: any): FailureModeLineItemWithActiveStatus;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): FailureModeLineItemWithActiveStatus;
   ...
   */
  sumObj(other: Obj, deep?: boolean): FailureModeLineItemWithActiveStatus;
   ...
   */
  singletonArray(): Array_Type<FailureModeLineItemWithActiveStatus>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<FailureModeLineItemWithActiveStatus> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<FailureModeLineItemWithActiveStatus> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<FailureModeLineItemWithActiveStatus>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<FailureModeLineItemWithActiveStatus> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, FailureModeLineItemWithActiveStatus> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, FailureModeLineItemWithActiveStatus> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<FailureModeLineItemWithActiveStatus>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<FailureModeLineItemWithActiveStatus>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): FailureModeLineItemWithActiveStatus;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): FailureModeLineItemWithActiveStatus;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): FailureModeLineItemWithActiveStatus;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): FailureModeLineItemWithActiveStatus;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): FailureModeLineItemWithActiveStatus;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): FailureModeLineItemWithActiveStatus;
   ...
   * @see #fromString
   */
  static make(s: string): FailureModeLineItemWithActiveStatus | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): FailureModeLineItemWithActiveStatus;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): FailureModeLineItemWithActiveStatus;
   ...
   */
  static cachedEmptyInst(): FailureModeLineItemWithActiveStatus;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<FailureModeLineItemWithActiveStatus> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): FailureModeLineItemWithActiveStatus;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<FailureModeLineItemWithActiveStatus>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<FailureModeLineItemWithActiveStatus>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<FailureModeLineItemWithActiveStatus> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<FailureModeLineItemWithActiveStatus>> | null;
   ...
   */
  get(include?: string): FailureModeLineItemWithActiveStatus | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): FailureModeLineItemWithActiveStatus | null;
   ...
   */
  getMissing(spec: GetMissingSpec): FailureModeLineItemWithActiveStatus;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): FailureModeLineItemWithActiveStatus | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): FailureModeLineItemWithActiveStatus;
   ...
   * @see #toString
   */
  static fromString(s: string): FailureModeLineItemWithActiveStatus | null;
   ...
   */
  create(spec?: UpsertSpec): FailureModeLineItemWithActiveStatus | null;
   ...
   */
  static createBatch(objs: Array_Type<FailureModeLineItemWithActiveStatus>, spec?: UpsertSpec): ObjList<FailureModeLineItemWithActiveStatus> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<FailureModeLineItemWithActiveStatus>, spec?: CreateBatchObjStreamSpec): ObjList<FailureModeLineItemWithActiveStatus> | null;
   ...
   */
  update(srcObj?: FailureModeLineItemWithActiveStatus, spec?: UpsertSpec): FailureModeLineItemWithActiveStatus | null;
   ...
   */
  upsert(srcObj?: FailureModeLineItemWithActiveStatus, spec?: UpsertSpec): FailureModeLineItemWithActiveStatus | null;
   ...
   */
  merge(spec?: MergeSpec): FailureModeLineItemWithActiveStatus | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): FailureModeLineItemWithActiveStatus | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): FailureModeLineItemWithActiveStatus | null;
   ...
   */
  static updateBatch(objs: Array_Type<FailureModeLineItemWithActiveStatus>, srcObjs?: Array_Type<FailureModeLineItemWithActiveStatus>, spec?: UpsertSpec): ObjList<FailureModeLineItemWithActiveStatus> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<FailureModeLineItemWithActiveStatus> | null>, spec?: UpsertSpec): ObjList<FailureModeLineItemWithActiveStatus> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<FailureModeLineItemWithActiveStatus>, srcObjs?: Array_Type<FailureModeLineItemWithActiveStatus>, spec?: UpsertSpec): ObjList<FailureModeLineItemWithActiveStatus> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<FailureModeLineItemWithActiveStatus> | null>, spec?: UpsertSpec): ObjList<FailureModeLineItemWithActiveStatus> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<FailureModeLineItemWithActiveStatus>, spec?: TouchSpec): ObjList<FailureModeLineItemWithActiveStatus> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<FailureModeLineItemWithActiveStatus>, spec?: MergeSpec): ObjList<FailureModeLineItemWithActiveStatus> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<FailureModeLineItemWithActiveStatus>, mergeInclude: string, spec?: MergeSpec): ObjList<FailureModeLineItemWithActiveStatus> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<FailureModeLineItemWithActiveStatus> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<FailureModeLineItemWithActiveStatus> | null;
   ...
   */
  static mergeAll(mergeObj: FailureModeLineItemWithActiveStatus, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: FailureModeLineItemWithActiveStatus, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<FailureModeLineItemWithActiveStatus>, spec?: UpsertSpec): ObjList<FailureModeLineItemWithActiveStatus> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<FailureModeLineItemWithActiveStatus>, spec?: UpsertSpec): ObjList<FailureModeLineItemWithActiveStatus> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): FailureModeLineItemWithActiveStatus | null;
   ...
   */
  static beforeCreate(objs: Array_Type<FailureModeLineItemWithActiveStatus>): ObjList<FailureModeLineItemWithActiveStatus>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<FailureModeLineItemWithActiveStatus>): ObjList<FailureModeLineItemWithActiveStatus>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<FailureModeLineItemWithActiveStatus>): ObjList<FailureModeLineItemWithActiveStatus>;
   ...
   */
  static afterCreate(objs: Array_Type<FailureModeLineItemWithActiveStatus>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<FailureModeLineItemWithActiveStatus>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<FailureModeLineItemWithActiveStatus>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<FailureModeLineItemWithActiveStatus>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<FailureModeLineItemWithActiveStatus>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): FailureModeLineItemWithActiveStatus | null;
   ...
   */
  withoutIdentity(): FailureModeLineItemWithActiveStatus | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<FailureModeLineItemWithActiveStatus>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: FailureModeLineItemWithActiveStatus, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<FailureModeLineItemWithActiveStatus>, callback?: λFunction<FailureModeLineItemWithActiveStatus | null, FailureModeLineItemWithActiveStatus | null>): ObjList<FailureModeLineItemWithActiveStatus>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<FailureModeLineItemWithActiveStatus>, callback?: λFunction<FailureModeLineItemWithActiveStatus | null, FailureModeLineItemWithActiveStatus | null>): Array_Type<ObjError> | null;
