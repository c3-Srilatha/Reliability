// TypeScript definitions for the C3 type PurchaseOrderLineReceipt

/**
 * A purchase order line receipt confirms the delivery of a given {@link PurchaseOrderLine} belonging to a {@link PurchaseOrder}.
 *
 * @remarks this represents a value passed to a method that expects an instance of PurchaseOrderLineReceipt
 */
declare interface IPurchaseOrderLineReceipt {
  ...
  /**
   * A unique identifier of this purchase order line receipt. This should be used for display purposes in the UI.
   * **NOTE**: This is different {#id} of this purchase order line receipt, which is system generated.
   */
  orderLineReceiptId?: string;

  /**
   * {@link PurchaseOrderLine} to which this purchase order receipt belongs to.
   * Every purchase order line receipt must belong to one and only one parent purchase order line.
   */
  orderLine: IPurchaseOrderLine;

  /**
   * The quantity of the `item` which was delivered as part of this receipt.
   */
  deliveredQuantity: IDimension;

  /**
   * The date and time when this order was delivered.
   * Deduced from the parent {@link PurchaseOrder#purchaseDate}.
   */
  deliveredDate: DateTime | Date | string;
}

/**
 * A purchase order line receipt confirms the delivery of a given {@link PurchaseOrderLine} belonging to a {@link PurchaseOrder}.
 *
 * @remarks this represents a made instance of PurchaseOrderLineReceipt
 */
declare class PurchaseOrderLineReceipt extends Obj  {
   ...
   */
  readonly id: string;
  withId(id: string): PurchaseOrderLineReceipt;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): PurchaseOrderLineReceipt;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): PurchaseOrderLineReceipt;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): PurchaseOrderLineReceipt;
  ...
  withVersion(version: number | null): PurchaseOrderLineReceipt;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): PurchaseOrderLineReceipt;

  /**
   * A unique identifier of this purchase order line receipt. This should be used for display purposes in the UI.
   * **NOTE**: This is different {#id} of this purchase order line receipt, which is system generated.
   */
  readonly orderLineReceiptId?: string;
  withOrderLineReceiptId(orderLineReceiptId: string | null): PurchaseOrderLineReceipt;
  ...
  withOrderLine(orderLine: IPurchaseOrderLine): PurchaseOrderLineReceipt;

  /**
   * The quantity of the `item` which was delivered as part of this receipt.
   */
  readonly deliveredQuantity: Dimension;
  withDeliveredQuantity(deliveredQuantity: IDimension): PurchaseOrderLineReceipt;

  /**
   * The date and time when this order was delivered.
   * Deduced from the parent {@link PurchaseOrder#purchaseDate}.
   */
  readonly deliveredDate: DateTime;
  withDeliveredDate(deliveredDate: DateTime | Date | string): PurchaseOrderLineReceipt;
   ...
   * @see #toJson
   */
  static fromJson(json: any): PurchaseOrderLineReceipt | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): PurchaseOrderLineReceipt | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): PurchaseOrderLineReceipt | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): PurchaseOrderLineReceipt | null;
   ...
   */
  replaceType(old: Type, new_: Type): PurchaseOrderLineReceipt;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): PurchaseOrderLineReceipt;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): PurchaseOrderLineReceipt;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<PurchaseOrderLineReceipt>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<PurchaseOrderLineReceipt>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): PurchaseOrderLineReceipt;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): PurchaseOrderLineReceipt;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): PurchaseOrderLineReceipt;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): PurchaseOrderLineReceipt;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): PurchaseOrderLineReceipt;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): PurchaseOrderLineReceipt;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): PurchaseOrderLineReceipt;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): PurchaseOrderLineReceipt;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): PurchaseOrderLineReceipt;
   ...
   * @see #removeField
   */
  withoutField(field: string): PurchaseOrderLineReceipt;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): PurchaseOrderLineReceipt;
   ...
   */
  withoutFields(fields: Array_Type<string>): PurchaseOrderLineReceipt;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): PurchaseOrderLineReceipt;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): PurchaseOrderLineReceipt;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): PurchaseOrderLineReceipt;
   ...
   * @see #unsetField
   */
  defaultField(field: string): PurchaseOrderLineReceipt;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): PurchaseOrderLineReceipt;
   ...
   * @see #removeField
   */
  unsetField(field: string): PurchaseOrderLineReceipt;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): PurchaseOrderLineReceipt;
   ...
   * @see #unsetField
   */
  removeField(field: string): PurchaseOrderLineReceipt;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): PurchaseOrderLineReceipt;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): PurchaseOrderLineReceipt;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): PurchaseOrderLineReceipt;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): PurchaseOrderLineReceipt;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): PurchaseOrderLineReceipt;

  mergeJson(json: any): PurchaseOrderLineReceipt;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): PurchaseOrderLineReceipt;
   ...
   */
  sumObj(other: Obj, deep?: boolean): PurchaseOrderLineReceipt;
   ...
   */
  singletonArray(): Array_Type<PurchaseOrderLineReceipt>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<PurchaseOrderLineReceipt> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<PurchaseOrderLineReceipt> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<PurchaseOrderLineReceipt>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<PurchaseOrderLineReceipt> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, PurchaseOrderLineReceipt> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, PurchaseOrderLineReceipt> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<PurchaseOrderLineReceipt>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<PurchaseOrderLineReceipt>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): PurchaseOrderLineReceipt;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): PurchaseOrderLineReceipt;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): PurchaseOrderLineReceipt;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): PurchaseOrderLineReceipt;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): PurchaseOrderLineReceipt;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): PurchaseOrderLineReceipt;
   ...
   * @see #fromString
   */
  static make(s: string): PurchaseOrderLineReceipt | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): PurchaseOrderLineReceipt;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): PurchaseOrderLineReceipt;
   ...
   */
  static cachedEmptyInst(): PurchaseOrderLineReceipt;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<PurchaseOrderLineReceipt> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): PurchaseOrderLineReceipt;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<PurchaseOrderLineReceipt>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<PurchaseOrderLineReceipt>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<PurchaseOrderLineReceipt> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<PurchaseOrderLineReceipt>> | null;
   ...
   */
  get(include?: string): PurchaseOrderLineReceipt | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): PurchaseOrderLineReceipt | null;
   ...
   */
  getMissing(spec: GetMissingSpec): PurchaseOrderLineReceipt;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): PurchaseOrderLineReceipt | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): PurchaseOrderLineReceipt;
   ...
   * @see #toString
   */
  static fromString(s: string): PurchaseOrderLineReceipt | null;
   ...
   */
  create(spec?: UpsertSpec): PurchaseOrderLineReceipt | null;
   ...
   */
  static createBatch(objs: Array_Type<PurchaseOrderLineReceipt>, spec?: UpsertSpec): ObjList<PurchaseOrderLineReceipt> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<PurchaseOrderLineReceipt>, spec?: CreateBatchObjStreamSpec): ObjList<PurchaseOrderLineReceipt> | null;
   ...
   */
  update(srcObj?: PurchaseOrderLineReceipt, spec?: UpsertSpec): PurchaseOrderLineReceipt | null;
   ...
   */
  upsert(srcObj?: PurchaseOrderLineReceipt, spec?: UpsertSpec): PurchaseOrderLineReceipt | null;
   ...
   */
  merge(spec?: MergeSpec): PurchaseOrderLineReceipt | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): PurchaseOrderLineReceipt | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): PurchaseOrderLineReceipt | null;
   ...
   */
  static updateBatch(objs: Array_Type<PurchaseOrderLineReceipt>, srcObjs?: Array_Type<PurchaseOrderLineReceipt>, spec?: UpsertSpec): ObjList<PurchaseOrderLineReceipt> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<PurchaseOrderLineReceipt> | null>, spec?: UpsertSpec): ObjList<PurchaseOrderLineReceipt> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<PurchaseOrderLineReceipt>, srcObjs?: Array_Type<PurchaseOrderLineReceipt>, spec?: UpsertSpec): ObjList<PurchaseOrderLineReceipt> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<PurchaseOrderLineReceipt> | null>, spec?: UpsertSpec): ObjList<PurchaseOrderLineReceipt> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<PurchaseOrderLineReceipt>, spec?: TouchSpec): ObjList<PurchaseOrderLineReceipt> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<PurchaseOrderLineReceipt>, spec?: MergeSpec): ObjList<PurchaseOrderLineReceipt> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<PurchaseOrderLineReceipt>, mergeInclude: string, spec?: MergeSpec): ObjList<PurchaseOrderLineReceipt> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<PurchaseOrderLineReceipt> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<PurchaseOrderLineReceipt> | null;
   ...
   */
  static mergeAll(mergeObj: PurchaseOrderLineReceipt, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: PurchaseOrderLineReceipt, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<PurchaseOrderLineReceipt>, spec?: UpsertSpec): ObjList<PurchaseOrderLineReceipt> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<PurchaseOrderLineReceipt>, spec?: UpsertSpec): ObjList<PurchaseOrderLineReceipt> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): PurchaseOrderLineReceipt | null;
   ...
   */
  static beforeCreate(objs: Array_Type<PurchaseOrderLineReceipt>): ObjList<PurchaseOrderLineReceipt>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<PurchaseOrderLineReceipt>): ObjList<PurchaseOrderLineReceipt>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<PurchaseOrderLineReceipt>): ObjList<PurchaseOrderLineReceipt>;
   ...
   */
  static afterCreate(objs: Array_Type<PurchaseOrderLineReceipt>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<PurchaseOrderLineReceipt>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<PurchaseOrderLineReceipt>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<PurchaseOrderLineReceipt>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<PurchaseOrderLineReceipt>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): PurchaseOrderLineReceipt | null;
   ...
   */
  withoutIdentity(): PurchaseOrderLineReceipt | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<PurchaseOrderLineReceipt>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: PurchaseOrderLineReceipt, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<PurchaseOrderLineReceipt>, callback?: λFunction<PurchaseOrderLineReceipt | null, PurchaseOrderLineReceipt | null>): ObjList<PurchaseOrderLineReceipt>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<PurchaseOrderLineReceipt>, callback?: λFunction<PurchaseOrderLineReceipt | null, PurchaseOrderLineReceipt | null>): Array_Type<ObjError> | null;
