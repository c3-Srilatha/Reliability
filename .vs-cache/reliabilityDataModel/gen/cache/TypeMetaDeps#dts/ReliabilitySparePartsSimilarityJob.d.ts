// TypeScript definitions for the C3 type ReliabilitySparePartsSimilarityJob

/**
 * A batch job that generates a similar work orders and parts.
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilitySparePartsSimilarityJob
 */
declare interface IReliabilitySparePartsSimilarityJob {
 ...
 */
declare class ReliabilitySparePartsSimilarityJob extends Obj  {

  /**
   * current or last job execution for this instance
   */
  readonly run?: BatchJobRun;
  withRun(run: IBatchJobRun | null): ReliabilitySparePartsSimilarityJob;

  /**
   * previous job executions for this instance
   */
  readonly runs?: Array_Type<BatchJobRun>;
  withRuns(runs: Array_Type<BatchJobRun> | Array<IBatchJobRun> | null): ReliabilitySparePartsSimilarityJob;

  /**
   * FOR INTERNAL USE ONLY - Specify options in call to {@link start}.
   */
  readonly options?: Obj;
  withOptions(options: IObj | null): ReliabilitySparePartsSimilarityJob;
  ...
  withOnCompleteCallback(onCompleteCallback: IJobBase.Callback | null): ReliabilitySparePartsSimilarityJob;
  ...
  withPriority(priority: number | null): ReliabilitySparePartsSimilarityJob;
  ...
  withDisabled(disabled: boolean): ReliabilitySparePartsSimilarityJob;
  ...
  withMaxConcurrency(maxConcurrency: number | null): ReliabilitySparePartsSimilarityJob;
  ...
  withMaxConcurrencyPerNode(maxConcurrencyPerNode: number | null): ReliabilitySparePartsSimilarityJob;
  ...
  withRunAsUser(runAsUser: boolean): ReliabilitySparePartsSimilarityJob;

  /**
   * Don't set this field in the BatchJob, set it in the BatchJobOptions when calling `start`
   */
  readonly nodePool?: string;
  withNodePool(nodePool: string | null): ReliabilitySparePartsSimilarityJob;
  ...
  withSkipIfRunning(skipIfRunning: boolean): ReliabilitySparePartsSimilarityJob;

  /**
   * Set to between 1 and 5 to enable auto recovery. See {@link invalidation-queues.c3doc Invalidation Queues} for detailed documentation.
   */
  readonly numAutoRecoveryAttempts?: number;
  withNumAutoRecoveryAttempts(numAutoRecoveryAttempts: number | null): ReliabilitySparePartsSimilarityJob;
  ...
  withPropagateActionContext(propagateActionContext: boolean): ReliabilitySparePartsSimilarityJob;
  ...
  withTypeIdent(typeIdent: string | null): ReliabilitySparePartsSimilarityJob;
   ...
   */
  readonly id: string;
  withId(id: string): ReliabilitySparePartsSimilarityJob;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilitySparePartsSimilarityJob;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): ReliabilitySparePartsSimilarityJob;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): ReliabilitySparePartsSimilarityJob;
  ...
  withVersion(version: number | null): ReliabilitySparePartsSimilarityJob;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): ReliabilitySparePartsSimilarityJob;
  ...
  withAbortOnError(abortOnError: boolean): ReliabilitySparePartsSimilarityJob;
   ...
   * @see #toJson
   */
  static fromJson(json: any): ReliabilitySparePartsSimilarityJob | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): ReliabilitySparePartsSimilarityJob | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): ReliabilitySparePartsSimilarityJob | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): ReliabilitySparePartsSimilarityJob | null;
   ...
   */
  replaceType(old: Type, new_: Type): ReliabilitySparePartsSimilarityJob;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilitySparePartsSimilarityJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilitySparePartsSimilarityJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilitySparePartsSimilarityJob>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilitySparePartsSimilarityJob>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilitySparePartsSimilarityJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilitySparePartsSimilarityJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilitySparePartsSimilarityJob;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ReliabilitySparePartsSimilarityJob;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ReliabilitySparePartsSimilarityJob;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilitySparePartsSimilarityJob;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilitySparePartsSimilarityJob;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilitySparePartsSimilarityJob;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ReliabilitySparePartsSimilarityJob;
   ...
   * @see #removeField
   */
  withoutField(field: string): ReliabilitySparePartsSimilarityJob;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): ReliabilitySparePartsSimilarityJob;
   ...
   */
  withoutFields(fields: Array_Type<string>): ReliabilitySparePartsSimilarityJob;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilitySparePartsSimilarityJob;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ReliabilitySparePartsSimilarityJob;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilitySparePartsSimilarityJob;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ReliabilitySparePartsSimilarityJob;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ReliabilitySparePartsSimilarityJob;
   ...
   * @see #removeField
   */
  unsetField(field: string): ReliabilitySparePartsSimilarityJob;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ReliabilitySparePartsSimilarityJob;
   ...
   * @see #unsetField
   */
  removeField(field: string): ReliabilitySparePartsSimilarityJob;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ReliabilitySparePartsSimilarityJob;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilitySparePartsSimilarityJob;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilitySparePartsSimilarityJob;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilitySparePartsSimilarityJob;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilitySparePartsSimilarityJob;

  mergeJson(json: any): ReliabilitySparePartsSimilarityJob;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilitySparePartsSimilarityJob;
   ...
   */
  sumObj(other: Obj, deep?: boolean): ReliabilitySparePartsSimilarityJob;
   ...
   */
  singletonArray(): Array_Type<ReliabilitySparePartsSimilarityJob>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<ReliabilitySparePartsSimilarityJob> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ReliabilitySparePartsSimilarityJob> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<ReliabilitySparePartsSimilarityJob>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ReliabilitySparePartsSimilarityJob> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, ReliabilitySparePartsSimilarityJob> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilitySparePartsSimilarityJob> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ReliabilitySparePartsSimilarityJob>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ReliabilitySparePartsSimilarityJob>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilitySparePartsSimilarityJob;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilitySparePartsSimilarityJob;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilitySparePartsSimilarityJob;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ReliabilitySparePartsSimilarityJob;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilitySparePartsSimilarityJob;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ReliabilitySparePartsSimilarityJob;
   ...
   * @see #fromString
   */
  static make(s: string): ReliabilitySparePartsSimilarityJob | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilitySparePartsSimilarityJob;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): ReliabilitySparePartsSimilarityJob;
   ...
   */
  static cachedEmptyInst(): ReliabilitySparePartsSimilarityJob;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilitySparePartsSimilarityJob> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): ReliabilitySparePartsSimilarityJob;
   ...
   */
  start(options?: ReliabilitySparePartsSimilarityJobOptions): BatchJobStatus | null;
   ...
   */
  cleanup(options?: ReliabilitySparePartsSimilarityJobOptions): void;
  ...
  cancelJob(removeResults?: boolean, force?: boolean): JobBase<BatchJobRun, BatchJobStatus, ReliabilitySparePartsSimilarityJobOptions> | null;

  failJob(run: JobRun<BatchJobStatusBase>): JobBase<BatchJobRun, BatchJobStatus, ReliabilitySparePartsSimilarityJobOptions> | null;
  ...
  validateStart(options?: ReliabilitySparePartsSimilarityJobOptions): void;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<ReliabilitySparePartsSimilarityJob>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<ReliabilitySparePartsSimilarityJob>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilitySparePartsSimilarityJob> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilitySparePartsSimilarityJob>> | null;
   ...
   */
  get(include?: string): ReliabilitySparePartsSimilarityJob | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): ReliabilitySparePartsSimilarityJob | null;
   ...
   */
  getMissing(spec: GetMissingSpec): ReliabilitySparePartsSimilarityJob;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): ReliabilitySparePartsSimilarityJob | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): ReliabilitySparePartsSimilarityJob;
   ...
   * @see #toString
   */
  static fromString(s: string): ReliabilitySparePartsSimilarityJob | null;
   ...
   */
  create(spec?: UpsertSpec): ReliabilitySparePartsSimilarityJob | null;
   ...
   */
  static createBatch(objs: Array_Type<ReliabilitySparePartsSimilarityJob>, spec?: UpsertSpec): ObjList<ReliabilitySparePartsSimilarityJob> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<ReliabilitySparePartsSimilarityJob>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilitySparePartsSimilarityJob> | null;
   ...
   */
  update(srcObj?: ReliabilitySparePartsSimilarityJob, spec?: UpsertSpec): ReliabilitySparePartsSimilarityJob | null;
   ...
   */
  upsert(srcObj?: ReliabilitySparePartsSimilarityJob, spec?: UpsertSpec): ReliabilitySparePartsSimilarityJob | null;
   ...
   */
  merge(spec?: MergeSpec): ReliabilitySparePartsSimilarityJob | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): ReliabilitySparePartsSimilarityJob | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): ReliabilitySparePartsSimilarityJob | null;
   ...
   */
  static updateBatch(objs: Array_Type<ReliabilitySparePartsSimilarityJob>, srcObjs?: Array_Type<ReliabilitySparePartsSimilarityJob>, spec?: UpsertSpec): ObjList<ReliabilitySparePartsSimilarityJob> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<ReliabilitySparePartsSimilarityJob> | null>, spec?: UpsertSpec): ObjList<ReliabilitySparePartsSimilarityJob> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<ReliabilitySparePartsSimilarityJob>, srcObjs?: Array_Type<ReliabilitySparePartsSimilarityJob>, spec?: UpsertSpec): ObjList<ReliabilitySparePartsSimilarityJob> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<ReliabilitySparePartsSimilarityJob> | null>, spec?: UpsertSpec): ObjList<ReliabilitySparePartsSimilarityJob> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<ReliabilitySparePartsSimilarityJob>, spec?: TouchSpec): ObjList<ReliabilitySparePartsSimilarityJob> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilitySparePartsSimilarityJob>, spec?: MergeSpec): ObjList<ReliabilitySparePartsSimilarityJob> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilitySparePartsSimilarityJob>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilitySparePartsSimilarityJob> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<ReliabilitySparePartsSimilarityJob> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilitySparePartsSimilarityJob> | null;
   ...
   */
  static mergeAll(mergeObj: ReliabilitySparePartsSimilarityJob, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: ReliabilitySparePartsSimilarityJob, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<ReliabilitySparePartsSimilarityJob>, spec?: UpsertSpec): ObjList<ReliabilitySparePartsSimilarityJob> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<ReliabilitySparePartsSimilarityJob>, spec?: UpsertSpec): ObjList<ReliabilitySparePartsSimilarityJob> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): ReliabilitySparePartsSimilarityJob | null;
   ...
   */
  static beforeCreate(objs: Array_Type<ReliabilitySparePartsSimilarityJob>): ObjList<ReliabilitySparePartsSimilarityJob>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<ReliabilitySparePartsSimilarityJob>): ObjList<ReliabilitySparePartsSimilarityJob>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<ReliabilitySparePartsSimilarityJob>): ObjList<ReliabilitySparePartsSimilarityJob>;
   ...
   */
  static afterCreate(objs: Array_Type<ReliabilitySparePartsSimilarityJob>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<ReliabilitySparePartsSimilarityJob>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<ReliabilitySparePartsSimilarityJob>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilitySparePartsSimilarityJob>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilitySparePartsSimilarityJob>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): ReliabilitySparePartsSimilarityJob | null;
   ...
   */
  withoutIdentity(): ReliabilitySparePartsSimilarityJob | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<ReliabilitySparePartsSimilarityJob>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: ReliabilitySparePartsSimilarityJob, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<ReliabilitySparePartsSimilarityJob>, callback?: λFunction<ReliabilitySparePartsSimilarityJob | null, ReliabilitySparePartsSimilarityJob | null>): ObjList<ReliabilitySparePartsSimilarityJob>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<ReliabilitySparePartsSimilarityJob>, callback?: λFunction<ReliabilitySparePartsSimilarityJob | null, ReliabilitySparePartsSimilarityJob | null>): Array_Type<ObjError> | null;
   ...
   * @inheritdoc
   */
  static doStart(job?: ReliabilitySparePartsSimilarityJob, options?: ReliabilitySparePartsSimilarityJobOptions): void;

  /**
   * @inheritdoc
   */
  static processBatch(batch?: ReliabilitySparePartsSimilarityBatch, job?: ReliabilitySparePartsSimilarityJob, options?: ReliabilitySparePartsSimilarityJobOptions): void;
   ...
   */
  static allComplete(job: ReliabilitySparePartsSimilarityJob, options?: ReliabilitySparePartsSimilarityJobOptions): string | null;
   ...
   *           Options the job was run with.
   */
  static failed(job: ReliabilitySparePartsSimilarityJob, status: BatchJobStatus, options?: ReliabilitySparePartsSimilarityJobOptions): void;
   ...
   *        Batch to schedule.
   */
  scheduleBatch(batch?: ReliabilitySparePartsSimilarityBatch): void;
   ...
   *        Batches to schedule.
   */
  scheduleBatches(batches?: Array_Type<ReliabilitySparePartsSimilarityBatch>): void;
   ...
   */
  static scheduleObjBatch(job?: ReliabilitySparePartsSimilarityJob, objBatch?: ObjBatch, logPrefix?: string): number | null;
