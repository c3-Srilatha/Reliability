// TypeScript definitions for the C3 type ReliabilitySyntheticData.LastRunTracker
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilitySyntheticData.LastRunTracker
 */
declare namespace ReliabilitySyntheticData {
  export interface ILastRunTracker {
 ...
 */
declare namespace ReliabilitySyntheticData {
  export class LastRunTracker extends Obj  {
    ...
    withTypeIdent(typeIdent: string | null): ReliabilitySyntheticData.LastRunTracker;
     ...
     */
    readonly id: string;
    withId(id: string): ReliabilitySyntheticData.LastRunTracker;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilitySyntheticData.LastRunTracker;

    /**
     * Name of the Obj instance
     */
    readonly name: string;
    withName(name: string): ReliabilitySyntheticData.LastRunTracker;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): ReliabilitySyntheticData.LastRunTracker;
    ...
    withVersion(version: number | null): ReliabilitySyntheticData.LastRunTracker;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): ReliabilitySyntheticData.LastRunTracker;

    /**
     * The timestamp of the last successful run of a given job.
     */
    readonly lastRun?: DateTime;
    withLastRun(lastRun: DateTime | Date | string | null): ReliabilitySyntheticData.LastRunTracker;
     ...
     * @see #toJson
     */
    static fromJson(json: any): ReliabilitySyntheticData.LastRunTracker | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): ReliabilitySyntheticData.LastRunTracker | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): ReliabilitySyntheticData.LastRunTracker | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): ReliabilitySyntheticData.LastRunTracker | null;
     ...
     */
    replaceType(old: Type, new_: Type): ReliabilitySyntheticData.LastRunTracker;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilitySyntheticData.LastRunTracker;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilitySyntheticData.LastRunTracker;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilitySyntheticData.LastRunTracker>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilitySyntheticData.LastRunTracker>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilitySyntheticData.LastRunTracker;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilitySyntheticData.LastRunTracker;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilitySyntheticData.LastRunTracker;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): ReliabilitySyntheticData.LastRunTracker;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): ReliabilitySyntheticData.LastRunTracker;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilitySyntheticData.LastRunTracker;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilitySyntheticData.LastRunTracker;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilitySyntheticData.LastRunTracker;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): ReliabilitySyntheticData.LastRunTracker;
     ...
     * @see #removeField
     */
    withoutField(field: string): ReliabilitySyntheticData.LastRunTracker;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): ReliabilitySyntheticData.LastRunTracker;
     ...
     */
    withoutFields(fields: Array_Type<string>): ReliabilitySyntheticData.LastRunTracker;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilitySyntheticData.LastRunTracker;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): ReliabilitySyntheticData.LastRunTracker;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilitySyntheticData.LastRunTracker;
     ...
     * @see #unsetField
     */
    defaultField(field: string): ReliabilitySyntheticData.LastRunTracker;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): ReliabilitySyntheticData.LastRunTracker;
     ...
     * @see #removeField
     */
    unsetField(field: string): ReliabilitySyntheticData.LastRunTracker;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): ReliabilitySyntheticData.LastRunTracker;
     ...
     * @see #unsetField
     */
    removeField(field: string): ReliabilitySyntheticData.LastRunTracker;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): ReliabilitySyntheticData.LastRunTracker;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilitySyntheticData.LastRunTracker;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilitySyntheticData.LastRunTracker;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilitySyntheticData.LastRunTracker;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilitySyntheticData.LastRunTracker;

    mergeJson(json: any): ReliabilitySyntheticData.LastRunTracker;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilitySyntheticData.LastRunTracker;
     ...
     */
    sumObj(other: Obj, deep?: boolean): ReliabilitySyntheticData.LastRunTracker;
     ...
     */
    singletonArray(): Array_Type<ReliabilitySyntheticData.LastRunTracker>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<ReliabilitySyntheticData.LastRunTracker> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<ReliabilitySyntheticData.LastRunTracker> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<ReliabilitySyntheticData.LastRunTracker>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<ReliabilitySyntheticData.LastRunTracker> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, ReliabilitySyntheticData.LastRunTracker> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilitySyntheticData.LastRunTracker> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<ReliabilitySyntheticData.LastRunTracker>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<ReliabilitySyntheticData.LastRunTracker>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilitySyntheticData.LastRunTracker;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilitySyntheticData.LastRunTracker;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilitySyntheticData.LastRunTracker;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): ReliabilitySyntheticData.LastRunTracker;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilitySyntheticData.LastRunTracker;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): ReliabilitySyntheticData.LastRunTracker;
     ...
     * @see #fromString
     */
    static make(s: string): ReliabilitySyntheticData.LastRunTracker | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilitySyntheticData.LastRunTracker;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): ReliabilitySyntheticData.LastRunTracker;
     ...
     */
    static cachedEmptyInst(): ReliabilitySyntheticData.LastRunTracker;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilitySyntheticData.LastRunTracker> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): ReliabilitySyntheticData.LastRunTracker;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<ReliabilitySyntheticData.LastRunTracker>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<ReliabilitySyntheticData.LastRunTracker>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilitySyntheticData.LastRunTracker> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilitySyntheticData.LastRunTracker>> | null;
     ...
     */
    get(include?: string): ReliabilitySyntheticData.LastRunTracker | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): ReliabilitySyntheticData.LastRunTracker | null;
     ...
     */
    getMissing(spec: GetMissingSpec): ReliabilitySyntheticData.LastRunTracker;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): ReliabilitySyntheticData.LastRunTracker | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): ReliabilitySyntheticData.LastRunTracker;
     ...
     * @see #toString
     */
    static fromString(s: string): ReliabilitySyntheticData.LastRunTracker | null;
     ...
     */
    create(spec?: UpsertSpec): ReliabilitySyntheticData.LastRunTracker | null;
     ...
     */
    static createBatch(objs: Array_Type<ReliabilitySyntheticData.LastRunTracker>, spec?: UpsertSpec): ObjList<ReliabilitySyntheticData.LastRunTracker> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<ReliabilitySyntheticData.LastRunTracker>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilitySyntheticData.LastRunTracker> | null;
     ...
     */
    update(srcObj?: ReliabilitySyntheticData.LastRunTracker, spec?: UpsertSpec): ReliabilitySyntheticData.LastRunTracker | null;
     ...
     */
    upsert(srcObj?: ReliabilitySyntheticData.LastRunTracker, spec?: UpsertSpec): ReliabilitySyntheticData.LastRunTracker | null;
     ...
     */
    merge(spec?: MergeSpec): ReliabilitySyntheticData.LastRunTracker | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): ReliabilitySyntheticData.LastRunTracker | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): ReliabilitySyntheticData.LastRunTracker | null;
     ...
     */
    static updateBatch(objs: Array_Type<ReliabilitySyntheticData.LastRunTracker>, srcObjs?: Array_Type<ReliabilitySyntheticData.LastRunTracker>, spec?: UpsertSpec): ObjList<ReliabilitySyntheticData.LastRunTracker> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<ReliabilitySyntheticData.LastRunTracker> | null>, spec?: UpsertSpec): ObjList<ReliabilitySyntheticData.LastRunTracker> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<ReliabilitySyntheticData.LastRunTracker>, srcObjs?: Array_Type<ReliabilitySyntheticData.LastRunTracker>, spec?: UpsertSpec): ObjList<ReliabilitySyntheticData.LastRunTracker> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<ReliabilitySyntheticData.LastRunTracker> | null>, spec?: UpsertSpec): ObjList<ReliabilitySyntheticData.LastRunTracker> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<ReliabilitySyntheticData.LastRunTracker>, spec?: TouchSpec): ObjList<ReliabilitySyntheticData.LastRunTracker> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilitySyntheticData.LastRunTracker>, spec?: MergeSpec): ObjList<ReliabilitySyntheticData.LastRunTracker> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilitySyntheticData.LastRunTracker>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilitySyntheticData.LastRunTracker> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<ReliabilitySyntheticData.LastRunTracker> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilitySyntheticData.LastRunTracker> | null;
     ...
     */
    static mergeAll(mergeObj: ReliabilitySyntheticData.LastRunTracker, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: ReliabilitySyntheticData.LastRunTracker, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<ReliabilitySyntheticData.LastRunTracker>, spec?: UpsertSpec): ObjList<ReliabilitySyntheticData.LastRunTracker> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<ReliabilitySyntheticData.LastRunTracker>, spec?: UpsertSpec): ObjList<ReliabilitySyntheticData.LastRunTracker> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): ReliabilitySyntheticData.LastRunTracker | null;
     ...
     */
    static beforeCreate(objs: Array_Type<ReliabilitySyntheticData.LastRunTracker>): ObjList<ReliabilitySyntheticData.LastRunTracker>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<ReliabilitySyntheticData.LastRunTracker>): ObjList<ReliabilitySyntheticData.LastRunTracker>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<ReliabilitySyntheticData.LastRunTracker>): ObjList<ReliabilitySyntheticData.LastRunTracker>;
     ...
     */
    static afterCreate(objs: Array_Type<ReliabilitySyntheticData.LastRunTracker>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<ReliabilitySyntheticData.LastRunTracker>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<ReliabilitySyntheticData.LastRunTracker>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilitySyntheticData.LastRunTracker>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilitySyntheticData.LastRunTracker>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): ReliabilitySyntheticData.LastRunTracker | null;
     ...
     */
    withoutIdentity(): ReliabilitySyntheticData.LastRunTracker | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<ReliabilitySyntheticData.LastRunTracker>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: ReliabilitySyntheticData.LastRunTracker, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<ReliabilitySyntheticData.LastRunTracker>, callback?: λFunction<ReliabilitySyntheticData.LastRunTracker | null, ReliabilitySyntheticData.LastRunTracker | null>): ObjList<ReliabilitySyntheticData.LastRunTracker>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<ReliabilitySyntheticData.LastRunTracker>, callback?: λFunction<ReliabilitySyntheticData.LastRunTracker | null, ReliabilitySyntheticData.LastRunTracker | null>): Array_Type<ObjError> | null;
     ...
     */
    static forName(name: string, failIfInvalid?: boolean): ReliabilitySyntheticData.LastRunTracker;
     ...
     */
    setLastRun(lastRun: DateTime): ReliabilitySyntheticData.LastRunTracker;
     ...
     */
    static lastRunForName(name: string, failIfInvalid?: boolean): DateTime | null;
     ...
     * @return The updated tracker instance.
     */
    static setLastRunForName(name: string, lastRun: DateTime, failIfInvalid?: boolean): ReliabilitySyntheticData.LastRunTracker;
  }
}
