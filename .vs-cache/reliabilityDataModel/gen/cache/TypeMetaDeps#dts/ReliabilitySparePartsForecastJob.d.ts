// TypeScript definitions for the C3 type ReliabilitySparePartsForecastJob

/**
 * A batch job that updates the parts forecast for all parts
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilitySparePartsForecastJob
 */
declare interface IReliabilitySparePartsForecastJob {
 ...
 */
declare class ReliabilitySparePartsForecastJob extends Obj  {

  /**
   * current or last job execution for this instance
   */
  readonly run?: BatchJobRun;
  withRun(run: IBatchJobRun | null): ReliabilitySparePartsForecastJob;

  /**
   * previous job executions for this instance
   */
  readonly runs?: Array_Type<BatchJobRun>;
  withRuns(runs: Array_Type<BatchJobRun> | Array<IBatchJobRun> | null): ReliabilitySparePartsForecastJob;

  /**
   * FOR INTERNAL USE ONLY - Specify options in call to {@link start}.
   */
  readonly options?: Obj;
  withOptions(options: IObj | null): ReliabilitySparePartsForecastJob;
  ...
  withOnCompleteCallback(onCompleteCallback: IJobBase.Callback | null): ReliabilitySparePartsForecastJob;
  ...
  withPriority(priority: number | null): ReliabilitySparePartsForecastJob;
  ...
  withDisabled(disabled: boolean): ReliabilitySparePartsForecastJob;
  ...
  withMaxConcurrency(maxConcurrency: number | null): ReliabilitySparePartsForecastJob;
  ...
  withMaxConcurrencyPerNode(maxConcurrencyPerNode: number | null): ReliabilitySparePartsForecastJob;
  ...
  withRunAsUser(runAsUser: boolean): ReliabilitySparePartsForecastJob;

  /**
   * Don't set this field in the BatchJob, set it in the BatchJobOptions when calling `start`
   */
  readonly nodePool?: string;
  withNodePool(nodePool: string | null): ReliabilitySparePartsForecastJob;
  ...
  withSkipIfRunning(skipIfRunning: boolean): ReliabilitySparePartsForecastJob;

  /**
   * Set to between 1 and 5 to enable auto recovery. See {@link invalidation-queues.c3doc Invalidation Queues} for detailed documentation.
   */
  readonly numAutoRecoveryAttempts?: number;
  withNumAutoRecoveryAttempts(numAutoRecoveryAttempts: number | null): ReliabilitySparePartsForecastJob;
  ...
  withPropagateActionContext(propagateActionContext: boolean): ReliabilitySparePartsForecastJob;
  ...
  withTypeIdent(typeIdent: string | null): ReliabilitySparePartsForecastJob;
   ...
   */
  readonly id: string;
  withId(id: string): ReliabilitySparePartsForecastJob;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilitySparePartsForecastJob;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): ReliabilitySparePartsForecastJob;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): ReliabilitySparePartsForecastJob;
  ...
  withVersion(version: number | null): ReliabilitySparePartsForecastJob;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): ReliabilitySparePartsForecastJob;
  ...
  withAbortOnError(abortOnError: boolean): ReliabilitySparePartsForecastJob;
   ...
   * @see #toJson
   */
  static fromJson(json: any): ReliabilitySparePartsForecastJob | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): ReliabilitySparePartsForecastJob | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): ReliabilitySparePartsForecastJob | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): ReliabilitySparePartsForecastJob | null;
   ...
   */
  replaceType(old: Type, new_: Type): ReliabilitySparePartsForecastJob;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilitySparePartsForecastJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilitySparePartsForecastJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilitySparePartsForecastJob>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilitySparePartsForecastJob>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilitySparePartsForecastJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilitySparePartsForecastJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilitySparePartsForecastJob;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ReliabilitySparePartsForecastJob;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ReliabilitySparePartsForecastJob;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilitySparePartsForecastJob;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilitySparePartsForecastJob;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilitySparePartsForecastJob;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ReliabilitySparePartsForecastJob;
   ...
   * @see #removeField
   */
  withoutField(field: string): ReliabilitySparePartsForecastJob;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): ReliabilitySparePartsForecastJob;
   ...
   */
  withoutFields(fields: Array_Type<string>): ReliabilitySparePartsForecastJob;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilitySparePartsForecastJob;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ReliabilitySparePartsForecastJob;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilitySparePartsForecastJob;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ReliabilitySparePartsForecastJob;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ReliabilitySparePartsForecastJob;
   ...
   * @see #removeField
   */
  unsetField(field: string): ReliabilitySparePartsForecastJob;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ReliabilitySparePartsForecastJob;
   ...
   * @see #unsetField
   */
  removeField(field: string): ReliabilitySparePartsForecastJob;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ReliabilitySparePartsForecastJob;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilitySparePartsForecastJob;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilitySparePartsForecastJob;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilitySparePartsForecastJob;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilitySparePartsForecastJob;

  mergeJson(json: any): ReliabilitySparePartsForecastJob;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilitySparePartsForecastJob;
   ...
   */
  sumObj(other: Obj, deep?: boolean): ReliabilitySparePartsForecastJob;
   ...
   */
  singletonArray(): Array_Type<ReliabilitySparePartsForecastJob>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<ReliabilitySparePartsForecastJob> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ReliabilitySparePartsForecastJob> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<ReliabilitySparePartsForecastJob>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ReliabilitySparePartsForecastJob> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, ReliabilitySparePartsForecastJob> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilitySparePartsForecastJob> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ReliabilitySparePartsForecastJob>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ReliabilitySparePartsForecastJob>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilitySparePartsForecastJob;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilitySparePartsForecastJob;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilitySparePartsForecastJob;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ReliabilitySparePartsForecastJob;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilitySparePartsForecastJob;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ReliabilitySparePartsForecastJob;
   ...
   * @see #fromString
   */
  static make(s: string): ReliabilitySparePartsForecastJob | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilitySparePartsForecastJob;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): ReliabilitySparePartsForecastJob;
   ...
   */
  static cachedEmptyInst(): ReliabilitySparePartsForecastJob;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilitySparePartsForecastJob> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): ReliabilitySparePartsForecastJob;
   ...
   */
  start(options?: ReliabilitySparePartsForecastJobOptions): BatchJobStatus | null;
   ...
   */
  cleanup(options?: ReliabilitySparePartsForecastJobOptions): void;
  ...
  cancelJob(removeResults?: boolean, force?: boolean): JobBase<BatchJobRun, BatchJobStatus, ReliabilitySparePartsForecastJobOptions> | null;

  failJob(run: JobRun<BatchJobStatusBase>): JobBase<BatchJobRun, BatchJobStatus, ReliabilitySparePartsForecastJobOptions> | null;
  ...
  validateStart(options?: ReliabilitySparePartsForecastJobOptions): void;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<ReliabilitySparePartsForecastJob>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<ReliabilitySparePartsForecastJob>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilitySparePartsForecastJob> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilitySparePartsForecastJob>> | null;
   ...
   */
  get(include?: string): ReliabilitySparePartsForecastJob | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): ReliabilitySparePartsForecastJob | null;
   ...
   */
  getMissing(spec: GetMissingSpec): ReliabilitySparePartsForecastJob;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): ReliabilitySparePartsForecastJob | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): ReliabilitySparePartsForecastJob;
   ...
   * @see #toString
   */
  static fromString(s: string): ReliabilitySparePartsForecastJob | null;
   ...
   */
  create(spec?: UpsertSpec): ReliabilitySparePartsForecastJob | null;
   ...
   */
  static createBatch(objs: Array_Type<ReliabilitySparePartsForecastJob>, spec?: UpsertSpec): ObjList<ReliabilitySparePartsForecastJob> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<ReliabilitySparePartsForecastJob>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilitySparePartsForecastJob> | null;
   ...
   */
  update(srcObj?: ReliabilitySparePartsForecastJob, spec?: UpsertSpec): ReliabilitySparePartsForecastJob | null;
   ...
   */
  upsert(srcObj?: ReliabilitySparePartsForecastJob, spec?: UpsertSpec): ReliabilitySparePartsForecastJob | null;
   ...
   */
  merge(spec?: MergeSpec): ReliabilitySparePartsForecastJob | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): ReliabilitySparePartsForecastJob | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): ReliabilitySparePartsForecastJob | null;
   ...
   */
  static updateBatch(objs: Array_Type<ReliabilitySparePartsForecastJob>, srcObjs?: Array_Type<ReliabilitySparePartsForecastJob>, spec?: UpsertSpec): ObjList<ReliabilitySparePartsForecastJob> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<ReliabilitySparePartsForecastJob> | null>, spec?: UpsertSpec): ObjList<ReliabilitySparePartsForecastJob> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<ReliabilitySparePartsForecastJob>, srcObjs?: Array_Type<ReliabilitySparePartsForecastJob>, spec?: UpsertSpec): ObjList<ReliabilitySparePartsForecastJob> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<ReliabilitySparePartsForecastJob> | null>, spec?: UpsertSpec): ObjList<ReliabilitySparePartsForecastJob> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<ReliabilitySparePartsForecastJob>, spec?: TouchSpec): ObjList<ReliabilitySparePartsForecastJob> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilitySparePartsForecastJob>, spec?: MergeSpec): ObjList<ReliabilitySparePartsForecastJob> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilitySparePartsForecastJob>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilitySparePartsForecastJob> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<ReliabilitySparePartsForecastJob> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilitySparePartsForecastJob> | null;
   ...
   */
  static mergeAll(mergeObj: ReliabilitySparePartsForecastJob, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: ReliabilitySparePartsForecastJob, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<ReliabilitySparePartsForecastJob>, spec?: UpsertSpec): ObjList<ReliabilitySparePartsForecastJob> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<ReliabilitySparePartsForecastJob>, spec?: UpsertSpec): ObjList<ReliabilitySparePartsForecastJob> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): ReliabilitySparePartsForecastJob | null;
   ...
   */
  static beforeCreate(objs: Array_Type<ReliabilitySparePartsForecastJob>): ObjList<ReliabilitySparePartsForecastJob>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<ReliabilitySparePartsForecastJob>): ObjList<ReliabilitySparePartsForecastJob>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<ReliabilitySparePartsForecastJob>): ObjList<ReliabilitySparePartsForecastJob>;
   ...
   */
  static afterCreate(objs: Array_Type<ReliabilitySparePartsForecastJob>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<ReliabilitySparePartsForecastJob>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<ReliabilitySparePartsForecastJob>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilitySparePartsForecastJob>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilitySparePartsForecastJob>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): ReliabilitySparePartsForecastJob | null;
   ...
   */
  withoutIdentity(): ReliabilitySparePartsForecastJob | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<ReliabilitySparePartsForecastJob>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: ReliabilitySparePartsForecastJob, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<ReliabilitySparePartsForecastJob>, callback?: λFunction<ReliabilitySparePartsForecastJob | null, ReliabilitySparePartsForecastJob | null>): ObjList<ReliabilitySparePartsForecastJob>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<ReliabilitySparePartsForecastJob>, callback?: λFunction<ReliabilitySparePartsForecastJob | null, ReliabilitySparePartsForecastJob | null>): Array_Type<ObjError> | null;
   ...
   * @inheritdoc
   */
  static doStart(job?: ReliabilitySparePartsForecastJob, options?: ReliabilitySparePartsForecastJobOptions): void;

  /**
   * @inheritdoc
   */
  static processBatch(batch?: ReliabilitySparePartsForecastBatch, job?: ReliabilitySparePartsForecastJob, options?: ReliabilitySparePartsForecastJobOptions): void;

  /**
   * @inheritdoc
   */
  static allComplete(job: ReliabilitySparePartsForecastJob, options?: ReliabilitySparePartsForecastJobOptions): string | null;

  /**
   * @inheritdoc
   */
  static failed(job: ReliabilitySparePartsForecastJob, status: BatchJobStatus, options?: ReliabilitySparePartsForecastJobOptions): void;
   ...
   *        Batch to schedule.
   */
  scheduleBatch(batch?: ReliabilitySparePartsForecastBatch): void;
   ...
   *        Batches to schedule.
   */
  scheduleBatches(batches?: Array_Type<ReliabilitySparePartsForecastBatch>): void;
   ...
   */
  static scheduleObjBatch(job?: ReliabilitySparePartsForecastJob, objBatch?: ObjBatch, logPrefix?: string): number | null;
