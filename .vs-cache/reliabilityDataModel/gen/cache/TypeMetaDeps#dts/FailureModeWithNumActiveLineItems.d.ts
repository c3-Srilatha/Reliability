// TypeScript definitions for the C3 type FailureModeWithNumActiveLineItems

/**
 * Do not persist this type. It is only used to return the result of the FailureModeWithNumActiveLineItems function.
 * A {@link FailureMode} with an additional field to indicate the number of active {@link FailureModeLineItem}s and a field to indicate whether it is active.
 *
 * @remarks this represents a value passed to a method that expects an instance of FailureModeWithNumActiveLineItems
 */
declare interface IFailureModeWithNumActiveLineItems {
   ...
   */
  failureModeLineItems?: Array_Type<FailureModeLineItem> | Array<IFailureModeLineItem>;
   ...
   */
  recommendations?: Array_Type<FailureModeRecommendation> | Array<IFailureModeRecommendation>;
  ...
  /**
   * The number of active {@link FailureModeLineItem}s on the {@link FailureMode}.
   */
  numActiveLineItems?: number;

  /**
   * Whether the {@link FailureMode} is active. Represents if the {@link FailureMode} can be triggered.
   */
  isActive?: boolean;
}
 ...
 * A {@link FailureMode} with an additional field to indicate the number of active {@link FailureModeLineItem}s and a field to indicate whether it is active.
 *
 * @remarks this represents a made instance of FailureModeWithNumActiveLineItems
 */
declare class FailureModeWithNumActiveLineItems extends Obj  {

  /**
   * Latest uploaded asset hierarchy file or spreadsheet containing the entity.
   */
  readonly assetOnboardingSourceFile?: AssetOnboardingSourceFile;
  withAssetOnboardingSourceFile(assetOnboardingSourceFile: IAssetOnboardingSourceFile | null): FailureModeWithNumActiveLineItems;

  /**
   * Indicates when the configuration of this asset was last updated.
   */
  readonly configurationLastUpdated?: DateTime;
  withConfigurationLastUpdated(configurationLastUpdated: DateTime | Date | string | null): FailureModeWithNumActiveLineItems;
   ...
   */
  readonly id: string;
  withId(id: string): FailureModeWithNumActiveLineItems;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): FailureModeWithNumActiveLineItems;
  ...
  withName(name: string): FailureModeWithNumActiveLineItems;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): FailureModeWithNumActiveLineItems;
  ...
  withVersion(version: number | null): FailureModeWithNumActiveLineItems;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): FailureModeWithNumActiveLineItems;

  /**
   * Text that describes the failure mode.
   */
  readonly description?: string;
  withDescription(description: string | null): FailureModeWithNumActiveLineItems;
  ...
  withSingleUse(singleUse: boolean): FailureModeWithNumActiveLineItems;

  /**
   * Indicates whether or not the {@link FailureMode} should be automatically linked to alerts
   * when creating alerts from model predictions.
   */
  readonly autoLinkAlert?: boolean;
  withAutoLinkAlert(autoLinkAlert: boolean): FailureModeWithNumActiveLineItems;
  ...
  withUserCreated(userCreated: boolean): FailureModeWithNumActiveLineItems;

  /**
   * The library to which this failure mode record belongs.
   */
  readonly failureModeLibrary?: FailureModeLibrary;
  withFailureModeLibrary(failureModeLibrary: IFailureModeLibrary | null): FailureModeWithNumActiveLineItems;

  /**
   * List of failure mode line items detailing this failure mode.
   */
  readonly failureModeLineItems?: Array_Type<FailureModeLineItem>;
  withFailureModeLineItems(failureModeLineItems: Array_Type<FailureModeLineItem> | Array<IFailureModeLineItem> | null): FailureModeWithNumActiveLineItems;
  ...
  withExpectedSensors(expectedSensors: Array_Type<ExpectedSensor> | Array<IExpectedSensor> | null): FailureModeWithNumActiveLineItems;

  /**
   * All recommendations linked to this failure mode.
   */
  readonly recommendations?: Array_Type<FailureModeRecommendation>;
  withRecommendations(recommendations: Array_Type<FailureModeRecommendation> | Array<IFailureModeRecommendation> | null): FailureModeWithNumActiveLineItems;

  /**
   * Count of unique recommendations for this failure mode.
   * Calculated from the recommendations list.
   */
  readonly countRecommendations?: number;
  withCountRecommendations(countRecommendations: number | null): FailureModeWithNumActiveLineItems;

  /**
   * Count of line items associated with this failure mode.
   * Calculated from the failureModeLineItems list.
   */
  readonly countLineItems?: number;
  withCountLineItems(countLineItems: number | null): FailureModeWithNumActiveLineItems;

  /**
   * The number of active {@link FailureModeLineItem}s on the {@link FailureMode}.
   */
  readonly numActiveLineItems?: number;
  withNumActiveLineItems(numActiveLineItems: number | null): FailureModeWithNumActiveLineItems;

  /**
   * Whether the {@link FailureMode} is active. Represents if the {@link FailureMode} can be triggered.
   */
  readonly isActive?: boolean;
  withIsActive(isActive: boolean): FailureModeWithNumActiveLineItems;
   ...
   * @see #toJson
   */
  static fromJson(json: any): FailureModeWithNumActiveLineItems | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): FailureModeWithNumActiveLineItems | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): FailureModeWithNumActiveLineItems | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): FailureModeWithNumActiveLineItems | null;
   ...
   */
  replaceType(old: Type, new_: Type): FailureModeWithNumActiveLineItems;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): FailureModeWithNumActiveLineItems;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): FailureModeWithNumActiveLineItems;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<FailureModeWithNumActiveLineItems>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<FailureModeWithNumActiveLineItems>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): FailureModeWithNumActiveLineItems;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): FailureModeWithNumActiveLineItems;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): FailureModeWithNumActiveLineItems;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): FailureModeWithNumActiveLineItems;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): FailureModeWithNumActiveLineItems;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): FailureModeWithNumActiveLineItems;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): FailureModeWithNumActiveLineItems;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): FailureModeWithNumActiveLineItems;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): FailureModeWithNumActiveLineItems;
   ...
   * @see #removeField
   */
  withoutField(field: string): FailureModeWithNumActiveLineItems;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): FailureModeWithNumActiveLineItems;
   ...
   */
  withoutFields(fields: Array_Type<string>): FailureModeWithNumActiveLineItems;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): FailureModeWithNumActiveLineItems;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): FailureModeWithNumActiveLineItems;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): FailureModeWithNumActiveLineItems;
   ...
   * @see #unsetField
   */
  defaultField(field: string): FailureModeWithNumActiveLineItems;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): FailureModeWithNumActiveLineItems;
   ...
   * @see #removeField
   */
  unsetField(field: string): FailureModeWithNumActiveLineItems;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): FailureModeWithNumActiveLineItems;
   ...
   * @see #unsetField
   */
  removeField(field: string): FailureModeWithNumActiveLineItems;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): FailureModeWithNumActiveLineItems;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): FailureModeWithNumActiveLineItems;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): FailureModeWithNumActiveLineItems;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): FailureModeWithNumActiveLineItems;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): FailureModeWithNumActiveLineItems;

  mergeJson(json: any): FailureModeWithNumActiveLineItems;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): FailureModeWithNumActiveLineItems;
   ...
   */
  sumObj(other: Obj, deep?: boolean): FailureModeWithNumActiveLineItems;
   ...
   */
  singletonArray(): Array_Type<FailureModeWithNumActiveLineItems>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<FailureModeWithNumActiveLineItems> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<FailureModeWithNumActiveLineItems> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<FailureModeWithNumActiveLineItems>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<FailureModeWithNumActiveLineItems> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, FailureModeWithNumActiveLineItems> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, FailureModeWithNumActiveLineItems> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<FailureModeWithNumActiveLineItems>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<FailureModeWithNumActiveLineItems>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): FailureModeWithNumActiveLineItems;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): FailureModeWithNumActiveLineItems;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): FailureModeWithNumActiveLineItems;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): FailureModeWithNumActiveLineItems;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): FailureModeWithNumActiveLineItems;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): FailureModeWithNumActiveLineItems;
   ...
   * @see #fromString
   */
  static make(s: string): FailureModeWithNumActiveLineItems | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): FailureModeWithNumActiveLineItems;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): FailureModeWithNumActiveLineItems;
   ...
   */
  static cachedEmptyInst(): FailureModeWithNumActiveLineItems;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<FailureModeWithNumActiveLineItems> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): FailureModeWithNumActiveLineItems;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<FailureModeWithNumActiveLineItems>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<FailureModeWithNumActiveLineItems>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<FailureModeWithNumActiveLineItems> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<FailureModeWithNumActiveLineItems>> | null;
   ...
   */
  get(include?: string): FailureModeWithNumActiveLineItems | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): FailureModeWithNumActiveLineItems | null;
   ...
   */
  getMissing(spec: GetMissingSpec): FailureModeWithNumActiveLineItems;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): FailureModeWithNumActiveLineItems | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): FailureModeWithNumActiveLineItems;
   ...
   * @see #toString
   */
  static fromString(s: string): FailureModeWithNumActiveLineItems | null;
   ...
   */
  create(spec?: UpsertSpec): FailureModeWithNumActiveLineItems | null;
   ...
   */
  static createBatch(objs: Array_Type<FailureModeWithNumActiveLineItems>, spec?: UpsertSpec): ObjList<FailureModeWithNumActiveLineItems> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<FailureModeWithNumActiveLineItems>, spec?: CreateBatchObjStreamSpec): ObjList<FailureModeWithNumActiveLineItems> | null;
   ...
   */
  update(srcObj?: FailureModeWithNumActiveLineItems, spec?: UpsertSpec): FailureModeWithNumActiveLineItems | null;
   ...
   */
  upsert(srcObj?: FailureModeWithNumActiveLineItems, spec?: UpsertSpec): FailureModeWithNumActiveLineItems | null;
   ...
   */
  merge(spec?: MergeSpec): FailureModeWithNumActiveLineItems | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): FailureModeWithNumActiveLineItems | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): FailureModeWithNumActiveLineItems | null;
   ...
   */
  static updateBatch(objs: Array_Type<FailureModeWithNumActiveLineItems>, srcObjs?: Array_Type<FailureModeWithNumActiveLineItems>, spec?: UpsertSpec): ObjList<FailureModeWithNumActiveLineItems> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<FailureModeWithNumActiveLineItems> | null>, spec?: UpsertSpec): ObjList<FailureModeWithNumActiveLineItems> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<FailureModeWithNumActiveLineItems>, srcObjs?: Array_Type<FailureModeWithNumActiveLineItems>, spec?: UpsertSpec): ObjList<FailureModeWithNumActiveLineItems> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<FailureModeWithNumActiveLineItems> | null>, spec?: UpsertSpec): ObjList<FailureModeWithNumActiveLineItems> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<FailureModeWithNumActiveLineItems>, spec?: TouchSpec): ObjList<FailureModeWithNumActiveLineItems> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<FailureModeWithNumActiveLineItems>, spec?: MergeSpec): ObjList<FailureModeWithNumActiveLineItems> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<FailureModeWithNumActiveLineItems>, mergeInclude: string, spec?: MergeSpec): ObjList<FailureModeWithNumActiveLineItems> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<FailureModeWithNumActiveLineItems> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<FailureModeWithNumActiveLineItems> | null;
   ...
   */
  static mergeAll(mergeObj: FailureModeWithNumActiveLineItems, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: FailureModeWithNumActiveLineItems, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<FailureModeWithNumActiveLineItems>, spec?: UpsertSpec): ObjList<FailureModeWithNumActiveLineItems> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<FailureModeWithNumActiveLineItems>, spec?: UpsertSpec): ObjList<FailureModeWithNumActiveLineItems> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): FailureModeWithNumActiveLineItems | null;
   ...
   */
  static beforeCreate(objs: Array_Type<FailureModeWithNumActiveLineItems>): ObjList<FailureModeWithNumActiveLineItems>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<FailureModeWithNumActiveLineItems>): ObjList<FailureModeWithNumActiveLineItems>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<FailureModeWithNumActiveLineItems>): ObjList<FailureModeWithNumActiveLineItems>;
   ...
   */
  static afterCreate(objs: Array_Type<FailureModeWithNumActiveLineItems>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<FailureModeWithNumActiveLineItems>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<FailureModeWithNumActiveLineItems>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<FailureModeWithNumActiveLineItems>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<FailureModeWithNumActiveLineItems>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): FailureModeWithNumActiveLineItems | null;
   ...
   */
  withoutIdentity(): FailureModeWithNumActiveLineItems | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<FailureModeWithNumActiveLineItems>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: FailureModeWithNumActiveLineItems, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<FailureModeWithNumActiveLineItems>, callback?: λFunction<FailureModeWithNumActiveLineItems | null, FailureModeWithNumActiveLineItems | null>): ObjList<FailureModeWithNumActiveLineItems>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<FailureModeWithNumActiveLineItems>, callback?: λFunction<FailureModeWithNumActiveLineItems | null, FailureModeWithNumActiveLineItems | null>): Array_Type<ObjError> | null;
   ...
   */
  static fetchWithNumActiveLineItems(spec?: FetchSpec, expectedSensors?: Array_Type<ExpectedSensor>): FetchResult<FailureModeWithNumActiveLineItems> | null;
   ...
   */
  static cleanupRelatedEntities(failureModes: Array_Type<FailureMode>): number | null;
   ...
   */
  mergeIfUniqueName(spec?: MergeSpec): FailureMode | null;
}
