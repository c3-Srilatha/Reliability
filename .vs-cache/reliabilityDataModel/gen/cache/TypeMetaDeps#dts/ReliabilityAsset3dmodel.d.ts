// TypeScript definitions for the C3 type ReliabilityAsset3dmodel
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityAsset3dmodel
 */
declare interface IReliabilityAsset3dmodel {
   ...
   */
  assetClasses?: Array_Type<AssetClass> | Array<IAssetClass>;
   ...
   */
  assetLinkStatus?: string;

  /**
   * Indicates whether any asset classes are associated with the 3D model.
   */
  assetClassLinkStatus?: string;
}

/**
 * The ReliabilityAsset3dmodel entity represents a 3D model or image asset with associated metadata, used in reliability workflows.
 *
 * @remarks this represents a made instance of ReliabilityAsset3dmodel
 */
declare class ReliabilityAsset3dmodel extends Obj  {
   ...
   */
  readonly id: string;
  withId(id: string): ReliabilityAsset3dmodel;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityAsset3dmodel;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): ReliabilityAsset3dmodel;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): ReliabilityAsset3dmodel;
  ...
  withVersion(version: number | null): ReliabilityAsset3dmodel;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): ReliabilityAsset3dmodel;

  /**
   * object representing the uploaded 3D model or image file.
   */
  readonly file: File;
  withFile(file: IFile): ReliabilityAsset3dmodel;

  /**
   * The type of the file: "3D" for .glb/.gltf, "2D" for .png/.jpg/.jpeg/.gif, otherwise "-".
   */
  readonly fileType?: string;
  withFileType(fileType: string | null): ReliabilityAsset3dmodel;

  /**
   * Object indicating the associated facility for the 3D model.
   */
  readonly facility?: Facility;
  withFacility(facility: IFacility | null): ReliabilityAsset3dmodel;

  /**
   * Timestamp recording when the 3D model was uploaded.
   */
  readonly dateUploaded?: DateTime;
  withDateUploaded(dateUploaded: IDateTime | null): ReliabilityAsset3dmodel;

  /**
   * Array of assets linked to the 3D model.
   */
  readonly assets?: Array_Type<ReliabilityAsset>;
  withAssets(assets: Array_Type<ReliabilityAsset> | Array<IReliabilityAsset> | null): ReliabilityAsset3dmodel;

  /**
   * Array of asset classes linked to the 3D model.
   */
  readonly assetClasses?: Array_Type<AssetClass>;
  withAssetClasses(assetClasses: Array_Type<AssetClass> | Array<IAssetClass> | null): ReliabilityAsset3dmodel;

  /**
   * The link status of the 3D model, which is calculated based on the presence of linked assets or asset classes.
   */
  readonly linkStatus?: string;
  withLinkStatus(linkStatus: string | null): ReliabilityAsset3dmodel;

  /**
   * Indicates whether any assets are directly linked to the 3D model.
   */
  readonly assetLinkStatus?: string;
  withAssetLinkStatus(assetLinkStatus: string | null): ReliabilityAsset3dmodel;

  /**
   * Indicates whether any asset classes are associated with the 3D model.
   */
  readonly assetClassLinkStatus?: string;
  withAssetClassLinkStatus(assetClassLinkStatus: string | null): ReliabilityAsset3dmodel;
   ...
   * @see #toJson
   */
  static fromJson(json: any): ReliabilityAsset3dmodel | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): ReliabilityAsset3dmodel | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): ReliabilityAsset3dmodel | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): ReliabilityAsset3dmodel | null;
   ...
   */
  replaceType(old: Type, new_: Type): ReliabilityAsset3dmodel;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityAsset3dmodel;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityAsset3dmodel;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityAsset3dmodel>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityAsset3dmodel>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityAsset3dmodel;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityAsset3dmodel;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityAsset3dmodel;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ReliabilityAsset3dmodel;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ReliabilityAsset3dmodel;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityAsset3dmodel;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityAsset3dmodel;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityAsset3dmodel;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ReliabilityAsset3dmodel;
   ...
   * @see #removeField
   */
  withoutField(field: string): ReliabilityAsset3dmodel;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): ReliabilityAsset3dmodel;
   ...
   */
  withoutFields(fields: Array_Type<string>): ReliabilityAsset3dmodel;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityAsset3dmodel;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ReliabilityAsset3dmodel;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityAsset3dmodel;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ReliabilityAsset3dmodel;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ReliabilityAsset3dmodel;
   ...
   * @see #removeField
   */
  unsetField(field: string): ReliabilityAsset3dmodel;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ReliabilityAsset3dmodel;
   ...
   * @see #unsetField
   */
  removeField(field: string): ReliabilityAsset3dmodel;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ReliabilityAsset3dmodel;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityAsset3dmodel;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityAsset3dmodel;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityAsset3dmodel;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityAsset3dmodel;

  mergeJson(json: any): ReliabilityAsset3dmodel;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityAsset3dmodel;
   ...
   */
  sumObj(other: Obj, deep?: boolean): ReliabilityAsset3dmodel;
   ...
   */
  singletonArray(): Array_Type<ReliabilityAsset3dmodel>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityAsset3dmodel> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ReliabilityAsset3dmodel> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<ReliabilityAsset3dmodel>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ReliabilityAsset3dmodel> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, ReliabilityAsset3dmodel> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityAsset3dmodel> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ReliabilityAsset3dmodel>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ReliabilityAsset3dmodel>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityAsset3dmodel;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityAsset3dmodel;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityAsset3dmodel;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ReliabilityAsset3dmodel;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityAsset3dmodel;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ReliabilityAsset3dmodel;
   ...
   * @see #fromString
   */
  static make(s: string): ReliabilityAsset3dmodel | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityAsset3dmodel;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): ReliabilityAsset3dmodel;
   ...
   */
  static cachedEmptyInst(): ReliabilityAsset3dmodel;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityAsset3dmodel> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): ReliabilityAsset3dmodel;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<ReliabilityAsset3dmodel>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<ReliabilityAsset3dmodel>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityAsset3dmodel> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityAsset3dmodel>> | null;
   ...
   */
  get(include?: string): ReliabilityAsset3dmodel | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): ReliabilityAsset3dmodel | null;
   ...
   */
  getMissing(spec: GetMissingSpec): ReliabilityAsset3dmodel;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): ReliabilityAsset3dmodel | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): ReliabilityAsset3dmodel;
   ...
   * @see #toString
   */
  static fromString(s: string): ReliabilityAsset3dmodel | null;
   ...
   */
  create(spec?: UpsertSpec): ReliabilityAsset3dmodel | null;
   ...
   */
  static createBatch(objs: Array_Type<ReliabilityAsset3dmodel>, spec?: UpsertSpec): ObjList<ReliabilityAsset3dmodel> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<ReliabilityAsset3dmodel>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityAsset3dmodel> | null;
   ...
   */
  update(srcObj?: ReliabilityAsset3dmodel, spec?: UpsertSpec): ReliabilityAsset3dmodel | null;
   ...
   */
  upsert(srcObj?: ReliabilityAsset3dmodel, spec?: UpsertSpec): ReliabilityAsset3dmodel | null;
   ...
   */
  merge(spec?: MergeSpec): ReliabilityAsset3dmodel | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): ReliabilityAsset3dmodel | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): ReliabilityAsset3dmodel | null;
   ...
   */
  static updateBatch(objs: Array_Type<ReliabilityAsset3dmodel>, srcObjs?: Array_Type<ReliabilityAsset3dmodel>, spec?: UpsertSpec): ObjList<ReliabilityAsset3dmodel> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<ReliabilityAsset3dmodel> | null>, spec?: UpsertSpec): ObjList<ReliabilityAsset3dmodel> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<ReliabilityAsset3dmodel>, srcObjs?: Array_Type<ReliabilityAsset3dmodel>, spec?: UpsertSpec): ObjList<ReliabilityAsset3dmodel> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<ReliabilityAsset3dmodel> | null>, spec?: UpsertSpec): ObjList<ReliabilityAsset3dmodel> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<ReliabilityAsset3dmodel>, spec?: TouchSpec): ObjList<ReliabilityAsset3dmodel> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityAsset3dmodel>, spec?: MergeSpec): ObjList<ReliabilityAsset3dmodel> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityAsset3dmodel>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityAsset3dmodel> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<ReliabilityAsset3dmodel> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityAsset3dmodel> | null;
   ...
   */
  static mergeAll(mergeObj: ReliabilityAsset3dmodel, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: ReliabilityAsset3dmodel, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<ReliabilityAsset3dmodel>, spec?: UpsertSpec): ObjList<ReliabilityAsset3dmodel> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<ReliabilityAsset3dmodel>, spec?: UpsertSpec): ObjList<ReliabilityAsset3dmodel> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): ReliabilityAsset3dmodel | null;
   ...
   */
  static beforeCreate(objs: Array_Type<ReliabilityAsset3dmodel>): ObjList<ReliabilityAsset3dmodel>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<ReliabilityAsset3dmodel>): ObjList<ReliabilityAsset3dmodel>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<ReliabilityAsset3dmodel>): ObjList<ReliabilityAsset3dmodel>;
   ...
   */
  static afterCreate(objs: Array_Type<ReliabilityAsset3dmodel>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<ReliabilityAsset3dmodel>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<ReliabilityAsset3dmodel>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityAsset3dmodel>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityAsset3dmodel>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): ReliabilityAsset3dmodel | null;
   ...
   */
  withoutIdentity(): ReliabilityAsset3dmodel | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<ReliabilityAsset3dmodel>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: ReliabilityAsset3dmodel, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<ReliabilityAsset3dmodel>, callback?: λFunction<ReliabilityAsset3dmodel | null, ReliabilityAsset3dmodel | null>): ObjList<ReliabilityAsset3dmodel>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<ReliabilityAsset3dmodel>, callback?: λFunction<ReliabilityAsset3dmodel | null, ReliabilityAsset3dmodel | null>): Array_Type<ObjError> | null;
   ...
   */
  static uploadModal(formObject?: any): Array_Type<ReliabilityAsset3dmodel> | null;
   ...
   */
  static get3DModelStatistics(): any | null;
}
