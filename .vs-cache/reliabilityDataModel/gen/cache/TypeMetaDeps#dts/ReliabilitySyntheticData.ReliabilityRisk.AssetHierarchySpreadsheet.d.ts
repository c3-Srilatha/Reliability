// TypeScript definitions for the C3 type ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet
 */
declare namespace ReliabilitySyntheticData.ReliabilityRisk {
  export interface IAssetHierarchySpreadsheet {
     ...
     */
    job?: IReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob;
  }
}
 ...
 */
declare namespace ReliabilitySyntheticData.ReliabilityRisk {
  export class AssetHierarchySpreadsheet extends Obj  {
    ...
    withTypeIdent(typeIdent: string | null): ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet;
     ...
     */
    readonly id: string;
    withId(id: string): ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet;
    ...
    withVersion(version: number | null): ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet;

    /**
     * A {@link File} object that contains the excel spreadsheet data
     */
    readonly templateExcel: File;
    withTemplateExcel(templateExcel: IFile): ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet;
     ...
     * that creates this instance.
     */
    readonly job?: ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob;
    withJob(job: IReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob | null): ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet;
     ...
     * @see #toJson
     */
    static fromJson(json: any): ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet | null;
     ...
     */
    replaceType(old: Type, new_: Type): ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet;
     ...
     * @see #removeField
     */
    withoutField(field: string): ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet;
     ...
     */
    withoutFields(fields: Array_Type<string>): ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet;
     ...
     * @see #unsetField
     */
    defaultField(field: string): ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet;
     ...
     * @see #removeField
     */
    unsetField(field: string): ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet;
     ...
     * @see #unsetField
     */
    removeField(field: string): ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet;

    mergeJson(json: any): ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet;
     ...
     */
    sumObj(other: Obj, deep?: boolean): ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet;
     ...
     */
    singletonArray(): Array_Type<ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet;
     ...
     * @see #fromString
     */
    static make(s: string): ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet;
     ...
     */
    static cachedEmptyInst(): ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet>> | null;
     ...
     */
    get(include?: string): ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet | null;
     ...
     */
    getMissing(spec: GetMissingSpec): ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet;
     ...
     * @see #toString
     */
    static fromString(s: string): ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet | null;
     ...
     */
    create(spec?: UpsertSpec): ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet | null;
     ...
     */
    static createBatch(objs: Array_Type<ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet>, spec?: UpsertSpec): ObjList<ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet> | null;
     ...
     */
    update(srcObj?: ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet, spec?: UpsertSpec): ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet | null;
     ...
     */
    upsert(srcObj?: ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet, spec?: UpsertSpec): ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet | null;
     ...
     */
    merge(spec?: MergeSpec): ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet | null;
     ...
     */
    static updateBatch(objs: Array_Type<ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet>, srcObjs?: Array_Type<ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet>, spec?: UpsertSpec): ObjList<ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet> | null>, spec?: UpsertSpec): ObjList<ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet>, srcObjs?: Array_Type<ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet>, spec?: UpsertSpec): ObjList<ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet> | null>, spec?: UpsertSpec): ObjList<ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet>, spec?: TouchSpec): ObjList<ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet>, spec?: MergeSpec): ObjList<ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet> | null;
     ...
     */
    static mergeAll(mergeObj: ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet>, spec?: UpsertSpec): ObjList<ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet>, spec?: UpsertSpec): ObjList<ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet | null;
     ...
     */
    static beforeCreate(objs: Array_Type<ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet>): ObjList<ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet>): ObjList<ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet>): ObjList<ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet>;
     ...
     */
    static afterCreate(objs: Array_Type<ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet | null;
     ...
     */
    withoutIdentity(): ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet>, callback?: λFunction<ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet | null, ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet | null>): ObjList<ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet>, callback?: λFunction<ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet | null, ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet | null>): Array_Type<ObjError> | null;
     ...
     */
    static readAssetHierarchyExcelSpreadsheet(file: File): any | null;
     ...
     */
    static writeAssetHierarchyExcelSpreadsheet(data: Map_Type<string, any>, outputPath: string): File | null;
     ...
     */
    static getMaxDepthOfTemplateFromAssetHierarchyDataframe(df: any): number;
     ...
     */
    static getMaxDepthOfHierarchyFromAssetHierarchyDataframe(df: any): number;
     ...
     */
    static validate(file: File): Map_Type<string, string> | null;
     ...
     */
    static isValidExcel(file: File): boolean;
     ...
     */
    static fromExcel(file: File): ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet | null;
     ...
     */
    static replicateAssetHierarchyExcelSpreadsheet(file: File, intrafacilityReplicationFactor: number, interfacilityReplicationFactor: number): File;
     ...
     */
    replicate(intrafacilityReplicationFactor: number, interfacilityReplicationFactor: number): ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet;
     ...
     */
    static getBatches(file: File, numberOfExternalSensorsPerAsset?: number = '0'): Array_Type<any> | null;
     ...
     */
    static numberOfBatches(file: File, numberOfExternalSensorsPerAsset?: number = '0'): number;
     ...
     */
    static readAssetHierarchyExcelSpreadsheetForBatch(file: File, intrafacilityBatch: number, interfacilityBatch: number): any | null;
     ...
     */
    static getAllExternalSensors(file: File, numberOfExternalSensorsPerAsset?: number = '0'): Array_Type<string> | null;
     ...
     */
    static getExternalSensorsForBatch(file: File, intrafacilityBatch: number, interfacilityBatch: number, numberOfExternalSensorsPerAsset?: number = '0'): Array_Type<string> | null;
     ...
     */
    static generateCanonicalPpmsData(file: File, numberOfExternalSensorsPerAsset: number, folderPath: string): File;
     ...
     * @return The generated CSV file.
     */
    static generateCanonicalEventsData(file: File, folderPath: string): File;
     ...
     */
    static generateTimeRangeChunks(start: DateTime, end: DateTime, chunkDuration: Duration): any;
     ...
     */
    static dedupEventsForAsset(df_events: any): any;
     ...
     */
    static getDedupedEvents(df_events: any, max_depth_of_hierarchy: number): any;
     ...
     */
    static getEventsInTimeRange(df_events: any, start: DateTime, end: DateTime): any;
     ...
     */
    static getSubsetTimeRangesWithFailureModeInTimeRange(start: DateTime, end: DateTime, df_events: any): any;
     ...
     * @return Array of time range chunks with failure mode information.
     */
    static getSubsetTimeRangesWithFailureModesForOverallTimeRange(df_time_range: any, chunkDuration: Duration, df_events: any, max_depth_of_hierarchy: number): any;
     ...
     */
    static getNormalSensorBounds(df_sensor_measurement_bounds: any): any | null;
     ...
     */
    static getAbnormalSensorBoundsForFailureMode(df_sensor_measurement_bounds: any, df_failure_modes: any, df_asset_hierarchy: any, failure_mode: string): any | null;
     ...
     */
    static getAbnormalSensorBoundsForFailureModes(df_sensor_measurement_bounds: any, df_failure_modes: any, df_asset_hierarchy: any): any | null;
     ...
     */
    static generateSensorTimeSeriesDataInTimeRange(sensor_ids: Array_Type<string>, start: DateTime, end: DateTime, frequency: string, sensor_bounds?: any, window_len?: number = '15'): any;
     ...
     */
    static generateExternalSensorTimeSeriesDataInTimeRange(external_sensor_ids: Array_Type<string>, df_sensors: any, target_sensor: string): any;
     ...
     */
    static adjustSensorDataForFailureMode(df: any, expected_sensor_to_sensor_id?: any, abnormal_sensor_bounds_for_failure_mode?: any): any;
     ...
     */
    static generateHistoricalCanonicalPointMeasurementDataForBatch(spec?: ReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet.GeneratePointMeasurementSpec): FileList;
  }
}
