// TypeScript definitions for the C3 type PurchaseOrderLine
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of PurchaseOrderLine
 */
declare interface IPurchaseOrderLine {
   ...
   */
  requestedDeliveryDate?: DateTime | Date | string;

  /**
   * The date and time at which this order line is expected to be delivered.
   */
  expectedDeliveryDate?: DateTime | Date | string;
   ...
   */
  receipts?: Array_Type<PurchaseOrderLineReceipt> | Array<IPurchaseOrderLineReceipt>;
   ...
   */
  fulfillmentDate?: DateTime | Date | string;
 ...
 * Each order line can have one or more receipts, which correspond to each shipment when the supplier delivers for this order line. See {@link PurchaseOrderLineReceipt}s for more details.
 *
 * @remarks this represents a made instance of PurchaseOrderLine
 */
declare class PurchaseOrderLine extends Obj  {
   ...
   */
  readonly id: string;
  withId(id: string): PurchaseOrderLine;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): PurchaseOrderLine;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): PurchaseOrderLine;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): PurchaseOrderLine;
  ...
  withVersion(version: number | null): PurchaseOrderLine;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): PurchaseOrderLine;
  ...
  withPurchaseOrderLineId(purchaseOrderLineId: string | null): PurchaseOrderLine;
  ...
  withPurchaseOrder(purchaseOrder: IPurchaseOrder): PurchaseOrderLine;

  /**
   * The item that is being ordered as part of this purchase order line.
   * {#supplier} for this purchase order line and {#item} must match.
   */
  readonly item: InventorySeries;
  withItem(item: IInventorySeries): PurchaseOrderLine;

  /**
   * The quantity of the {#item} being ordered as part of this purchase order line.
   */
  readonly quantity: Dimension;
  withQuantity(quantity: IDimension): PurchaseOrderLine;

  /**
   * The date and time at which this order line has been requested to be received at the time of placing the order.
   */
  readonly requestedDeliveryDate?: DateTime;
  withRequestedDeliveryDate(requestedDeliveryDate: DateTime | Date | string | null): PurchaseOrderLine;

  /**
   * The date and time at which this order line is expected to be delivered.
   */
  readonly expectedDeliveryDate?: DateTime;
  withExpectedDeliveryDate(expectedDeliveryDate: DateTime | Date | string | null): PurchaseOrderLine;
   ...
   * then the cost is 1000 USD for this order line.
   */
  readonly cost?: MonetaryValue;
  withCost(cost: IMonetaryValue | null): PurchaseOrderLine;
   ...
   * in this list is the receipt corresponding to the last receipt of delivery.
   */
  readonly receipts?: Array_Type<PurchaseOrderLineReceipt>;
  withReceipts(receipts: Array_Type<PurchaseOrderLineReceipt> | Array<IPurchaseOrderLineReceipt> | null): PurchaseOrderLine;
  ...
  withStatus(status: string | null): PurchaseOrderLine;
  ...
  withQuantityReceived(quantityReceived: number | null): PurchaseOrderLine;

  /**
   * Indicator if the order line has been completely received.
   * This is true when {#quantity} is equal to {#quantityReceived}.
   */
  readonly fullyDelivered?: boolean;
  withFullyDelivered(fullyDelivered: boolean): PurchaseOrderLine;

  /**
   * The final date at which the order line has been completely received.
   * It is the latest `deliveredDate` in the #receipts list.
   */
  readonly fulfillmentDate?: DateTime;
  withFulfillmentDate(fulfillmentDate: DateTime | Date | string | null): PurchaseOrderLine;
  ...
  withSupplier(supplier: string | null): PurchaseOrderLine;

  /**
   * The purchase date for this order line.
   * Deduced from the parent {@link PurchaseOrder#purchaseDate}.
   */
  readonly purchaseDate?: DateTime;
  withPurchaseDate(purchaseDate: DateTime | Date | string | null): PurchaseOrderLine;
   ...
   * @see #toJson
   */
  static fromJson(json: any): PurchaseOrderLine | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): PurchaseOrderLine | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): PurchaseOrderLine | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): PurchaseOrderLine | null;
   ...
   */
  replaceType(old: Type, new_: Type): PurchaseOrderLine;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): PurchaseOrderLine;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): PurchaseOrderLine;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<PurchaseOrderLine>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<PurchaseOrderLine>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): PurchaseOrderLine;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): PurchaseOrderLine;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): PurchaseOrderLine;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): PurchaseOrderLine;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): PurchaseOrderLine;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): PurchaseOrderLine;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): PurchaseOrderLine;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): PurchaseOrderLine;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): PurchaseOrderLine;
   ...
   * @see #removeField
   */
  withoutField(field: string): PurchaseOrderLine;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): PurchaseOrderLine;
   ...
   */
  withoutFields(fields: Array_Type<string>): PurchaseOrderLine;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): PurchaseOrderLine;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): PurchaseOrderLine;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): PurchaseOrderLine;
   ...
   * @see #unsetField
   */
  defaultField(field: string): PurchaseOrderLine;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): PurchaseOrderLine;
   ...
   * @see #removeField
   */
  unsetField(field: string): PurchaseOrderLine;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): PurchaseOrderLine;
   ...
   * @see #unsetField
   */
  removeField(field: string): PurchaseOrderLine;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): PurchaseOrderLine;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): PurchaseOrderLine;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): PurchaseOrderLine;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): PurchaseOrderLine;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): PurchaseOrderLine;

  mergeJson(json: any): PurchaseOrderLine;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): PurchaseOrderLine;
   ...
   */
  sumObj(other: Obj, deep?: boolean): PurchaseOrderLine;
   ...
   */
  singletonArray(): Array_Type<PurchaseOrderLine>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<PurchaseOrderLine> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<PurchaseOrderLine> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<PurchaseOrderLine>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<PurchaseOrderLine> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, PurchaseOrderLine> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, PurchaseOrderLine> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<PurchaseOrderLine>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<PurchaseOrderLine>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): PurchaseOrderLine;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): PurchaseOrderLine;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): PurchaseOrderLine;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): PurchaseOrderLine;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): PurchaseOrderLine;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): PurchaseOrderLine;
   ...
   * @see #fromString
   */
  static make(s: string): PurchaseOrderLine | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): PurchaseOrderLine;
   ...
   */
  static cachedEmptyInst(): PurchaseOrderLine;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<PurchaseOrderLine> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): PurchaseOrderLine;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<PurchaseOrderLine>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<PurchaseOrderLine>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<PurchaseOrderLine> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<PurchaseOrderLine>> | null;
   ...
   */
  get(include?: string): PurchaseOrderLine | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): PurchaseOrderLine | null;
   ...
   */
  getMissing(spec: GetMissingSpec): PurchaseOrderLine;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): PurchaseOrderLine | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): PurchaseOrderLine;
   ...
   * @see #toString
   */
  static fromString(s: string): PurchaseOrderLine | null;
   ...
   */
  create(spec?: UpsertSpec): PurchaseOrderLine | null;
   ...
   */
  static createBatch(objs: Array_Type<PurchaseOrderLine>, spec?: UpsertSpec): ObjList<PurchaseOrderLine> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<PurchaseOrderLine>, spec?: CreateBatchObjStreamSpec): ObjList<PurchaseOrderLine> | null;
   ...
   */
  update(srcObj?: PurchaseOrderLine, spec?: UpsertSpec): PurchaseOrderLine | null;
   ...
   */
  upsert(srcObj?: PurchaseOrderLine, spec?: UpsertSpec): PurchaseOrderLine | null;
   ...
   */
  merge(spec?: MergeSpec): PurchaseOrderLine | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): PurchaseOrderLine | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): PurchaseOrderLine | null;
   ...
   */
  static updateBatch(objs: Array_Type<PurchaseOrderLine>, srcObjs?: Array_Type<PurchaseOrderLine>, spec?: UpsertSpec): ObjList<PurchaseOrderLine> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<PurchaseOrderLine> | null>, spec?: UpsertSpec): ObjList<PurchaseOrderLine> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<PurchaseOrderLine>, srcObjs?: Array_Type<PurchaseOrderLine>, spec?: UpsertSpec): ObjList<PurchaseOrderLine> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<PurchaseOrderLine> | null>, spec?: UpsertSpec): ObjList<PurchaseOrderLine> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<PurchaseOrderLine>, spec?: TouchSpec): ObjList<PurchaseOrderLine> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<PurchaseOrderLine>, spec?: MergeSpec): ObjList<PurchaseOrderLine> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<PurchaseOrderLine>, mergeInclude: string, spec?: MergeSpec): ObjList<PurchaseOrderLine> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<PurchaseOrderLine> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<PurchaseOrderLine> | null;
   ...
   */
  static mergeAll(mergeObj: PurchaseOrderLine, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: PurchaseOrderLine, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<PurchaseOrderLine>, spec?: UpsertSpec): ObjList<PurchaseOrderLine> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<PurchaseOrderLine>, spec?: UpsertSpec): ObjList<PurchaseOrderLine> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): PurchaseOrderLine | null;
   ...
   */
  static beforeCreate(objs: Array_Type<PurchaseOrderLine>): ObjList<PurchaseOrderLine>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<PurchaseOrderLine>): ObjList<PurchaseOrderLine>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<PurchaseOrderLine>): ObjList<PurchaseOrderLine>;
   ...
   */
  static afterCreate(objs: Array_Type<PurchaseOrderLine>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<PurchaseOrderLine>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<PurchaseOrderLine>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<PurchaseOrderLine>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<PurchaseOrderLine>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): PurchaseOrderLine | null;
   ...
   */
  withoutIdentity(): PurchaseOrderLine | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<PurchaseOrderLine>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: PurchaseOrderLine, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<PurchaseOrderLine>, callback?: λFunction<PurchaseOrderLine | null, PurchaseOrderLine | null>): ObjList<PurchaseOrderLine>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<PurchaseOrderLine>, callback?: λFunction<PurchaseOrderLine | null, PurchaseOrderLine | null>): Array_Type<ObjError> | null;
