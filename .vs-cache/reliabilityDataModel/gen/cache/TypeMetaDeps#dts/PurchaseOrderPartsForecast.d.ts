// TypeScript definitions for the C3 type PurchaseOrderPartsForecast

/**
 * A purchase order forecast represents a predicted point in time when a {@link PurchaseOrderLine} must be placed.
 * The prediction is made during {@link WorkOrderPartsForecast#updatePartsForecast} when a given part's forecasted inventory
 * is expected go below it's minimum inventory level.
 *
 * @remarks this represents a value passed to a method that expects an instance of PurchaseOrderPartsForecast
 */
declare interface IPurchaseOrderPartsForecast {
  ...
  /**
   * The {@link InventorySeries} part for which the forecast was made.
   */
  part: IInventorySeries;

  /**
   * The date at which the purchase order line must be placed.
   */
  purchaseDate: DateTime | Date | string;

  /**
   * The date at which purchase order line is expected to be delivered.
   * Calculated by adding {#part.avgLeadTime} to {#purchaseDate}.
   */
  expectedDeliveryDate: DateTime | Date | string;

  /**
   * The amount of quantity that must be ordered.
   */
  quantity: IDimension;
}
 ...
 * is expected go below it's minimum inventory level.
 *
 * @remarks this represents a made instance of PurchaseOrderPartsForecast
 */
declare class PurchaseOrderPartsForecast extends Obj  {
   ...
   */
  readonly id: string;
  withId(id: string): PurchaseOrderPartsForecast;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): PurchaseOrderPartsForecast;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): PurchaseOrderPartsForecast;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): PurchaseOrderPartsForecast;
  ...
  withVersion(version: number | null): PurchaseOrderPartsForecast;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): PurchaseOrderPartsForecast;

  /**
   * The {@link InventorySeries} part for which the forecast was made.
   */
  readonly part: InventorySeries;
  withPart(part: IInventorySeries): PurchaseOrderPartsForecast;

  /**
   * The date at which the purchase order line must be placed.
   */
  readonly purchaseDate: DateTime;
  withPurchaseDate(purchaseDate: DateTime | Date | string): PurchaseOrderPartsForecast;
  ...
  withExpectedDeliveryDate(expectedDeliveryDate: DateTime | Date | string): PurchaseOrderPartsForecast;

  /**
   * The amount of quantity that must be ordered.
   */
  readonly quantity: Dimension;
  withQuantity(quantity: IDimension): PurchaseOrderPartsForecast;
   ...
   * @see #toJson
   */
  static fromJson(json: any): PurchaseOrderPartsForecast | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): PurchaseOrderPartsForecast | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): PurchaseOrderPartsForecast | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): PurchaseOrderPartsForecast | null;
   ...
   */
  replaceType(old: Type, new_: Type): PurchaseOrderPartsForecast;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): PurchaseOrderPartsForecast;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): PurchaseOrderPartsForecast;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<PurchaseOrderPartsForecast>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<PurchaseOrderPartsForecast>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): PurchaseOrderPartsForecast;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): PurchaseOrderPartsForecast;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): PurchaseOrderPartsForecast;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): PurchaseOrderPartsForecast;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): PurchaseOrderPartsForecast;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): PurchaseOrderPartsForecast;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): PurchaseOrderPartsForecast;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): PurchaseOrderPartsForecast;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): PurchaseOrderPartsForecast;
   ...
   * @see #removeField
   */
  withoutField(field: string): PurchaseOrderPartsForecast;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): PurchaseOrderPartsForecast;
   ...
   */
  withoutFields(fields: Array_Type<string>): PurchaseOrderPartsForecast;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): PurchaseOrderPartsForecast;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): PurchaseOrderPartsForecast;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): PurchaseOrderPartsForecast;
   ...
   * @see #unsetField
   */
  defaultField(field: string): PurchaseOrderPartsForecast;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): PurchaseOrderPartsForecast;
   ...
   * @see #removeField
   */
  unsetField(field: string): PurchaseOrderPartsForecast;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): PurchaseOrderPartsForecast;
   ...
   * @see #unsetField
   */
  removeField(field: string): PurchaseOrderPartsForecast;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): PurchaseOrderPartsForecast;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): PurchaseOrderPartsForecast;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): PurchaseOrderPartsForecast;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): PurchaseOrderPartsForecast;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): PurchaseOrderPartsForecast;

  mergeJson(json: any): PurchaseOrderPartsForecast;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): PurchaseOrderPartsForecast;
   ...
   */
  sumObj(other: Obj, deep?: boolean): PurchaseOrderPartsForecast;
   ...
   */
  singletonArray(): Array_Type<PurchaseOrderPartsForecast>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<PurchaseOrderPartsForecast> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<PurchaseOrderPartsForecast> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<PurchaseOrderPartsForecast>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<PurchaseOrderPartsForecast> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, PurchaseOrderPartsForecast> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, PurchaseOrderPartsForecast> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<PurchaseOrderPartsForecast>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<PurchaseOrderPartsForecast>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): PurchaseOrderPartsForecast;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): PurchaseOrderPartsForecast;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): PurchaseOrderPartsForecast;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): PurchaseOrderPartsForecast;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): PurchaseOrderPartsForecast;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): PurchaseOrderPartsForecast;
   ...
   * @see #fromString
   */
  static make(s: string): PurchaseOrderPartsForecast | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): PurchaseOrderPartsForecast;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): PurchaseOrderPartsForecast;
   ...
   */
  static cachedEmptyInst(): PurchaseOrderPartsForecast;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<PurchaseOrderPartsForecast> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): PurchaseOrderPartsForecast;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<PurchaseOrderPartsForecast>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<PurchaseOrderPartsForecast>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<PurchaseOrderPartsForecast> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<PurchaseOrderPartsForecast>> | null;
   ...
   */
  get(include?: string): PurchaseOrderPartsForecast | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): PurchaseOrderPartsForecast | null;
   ...
   */
  getMissing(spec: GetMissingSpec): PurchaseOrderPartsForecast;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): PurchaseOrderPartsForecast | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): PurchaseOrderPartsForecast;
   ...
   * @see #toString
   */
  static fromString(s: string): PurchaseOrderPartsForecast | null;
   ...
   */
  create(spec?: UpsertSpec): PurchaseOrderPartsForecast | null;
   ...
   */
  static createBatch(objs: Array_Type<PurchaseOrderPartsForecast>, spec?: UpsertSpec): ObjList<PurchaseOrderPartsForecast> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<PurchaseOrderPartsForecast>, spec?: CreateBatchObjStreamSpec): ObjList<PurchaseOrderPartsForecast> | null;
   ...
   */
  update(srcObj?: PurchaseOrderPartsForecast, spec?: UpsertSpec): PurchaseOrderPartsForecast | null;
   ...
   */
  upsert(srcObj?: PurchaseOrderPartsForecast, spec?: UpsertSpec): PurchaseOrderPartsForecast | null;
   ...
   */
  merge(spec?: MergeSpec): PurchaseOrderPartsForecast | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): PurchaseOrderPartsForecast | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): PurchaseOrderPartsForecast | null;
   ...
   */
  static updateBatch(objs: Array_Type<PurchaseOrderPartsForecast>, srcObjs?: Array_Type<PurchaseOrderPartsForecast>, spec?: UpsertSpec): ObjList<PurchaseOrderPartsForecast> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<PurchaseOrderPartsForecast> | null>, spec?: UpsertSpec): ObjList<PurchaseOrderPartsForecast> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<PurchaseOrderPartsForecast>, srcObjs?: Array_Type<PurchaseOrderPartsForecast>, spec?: UpsertSpec): ObjList<PurchaseOrderPartsForecast> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<PurchaseOrderPartsForecast> | null>, spec?: UpsertSpec): ObjList<PurchaseOrderPartsForecast> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<PurchaseOrderPartsForecast>, spec?: TouchSpec): ObjList<PurchaseOrderPartsForecast> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<PurchaseOrderPartsForecast>, spec?: MergeSpec): ObjList<PurchaseOrderPartsForecast> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<PurchaseOrderPartsForecast>, mergeInclude: string, spec?: MergeSpec): ObjList<PurchaseOrderPartsForecast> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<PurchaseOrderPartsForecast> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<PurchaseOrderPartsForecast> | null;
   ...
   */
  static mergeAll(mergeObj: PurchaseOrderPartsForecast, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: PurchaseOrderPartsForecast, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<PurchaseOrderPartsForecast>, spec?: UpsertSpec): ObjList<PurchaseOrderPartsForecast> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<PurchaseOrderPartsForecast>, spec?: UpsertSpec): ObjList<PurchaseOrderPartsForecast> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): PurchaseOrderPartsForecast | null;
   ...
   */
  static beforeCreate(objs: Array_Type<PurchaseOrderPartsForecast>): ObjList<PurchaseOrderPartsForecast>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<PurchaseOrderPartsForecast>): ObjList<PurchaseOrderPartsForecast>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<PurchaseOrderPartsForecast>): ObjList<PurchaseOrderPartsForecast>;
   ...
   */
  static afterCreate(objs: Array_Type<PurchaseOrderPartsForecast>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<PurchaseOrderPartsForecast>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<PurchaseOrderPartsForecast>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<PurchaseOrderPartsForecast>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<PurchaseOrderPartsForecast>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): PurchaseOrderPartsForecast | null;
   ...
   */
  withoutIdentity(): PurchaseOrderPartsForecast | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<PurchaseOrderPartsForecast>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: PurchaseOrderPartsForecast, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<PurchaseOrderPartsForecast>, callback?: λFunction<PurchaseOrderPartsForecast | null, PurchaseOrderPartsForecast | null>): ObjList<PurchaseOrderPartsForecast>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<PurchaseOrderPartsForecast>, callback?: λFunction<PurchaseOrderPartsForecast | null, PurchaseOrderPartsForecast | null>): Array_Type<ObjError> | null;
