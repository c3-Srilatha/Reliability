// TypeScript definitions for the C3 type ReliabilityTimezoneConfig

/**
 * Configurations for Reliability Timezone.
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityTimezoneConfig
 */
declare interface IReliabilityTimezoneConfig {
  ...
  /**
   * The user's selected timezone used to convert and display timestamps in the UI.
   * `uiTimezone` may not be the precise geographical zone due to many to one relationships between geographic timezones and human readable label.
   * For example, America/Los_Angeles and America/Vancouver are both in Pacific Daylight time, {@link ReliabilityTimezoneUtils}'s getTimeZones returns unique timezones
   * since both are in Pacific Daylight time only one will be in the list. `uiTimezone` is used for timezone conversion purposes not to determine user local timezone.
   */
  uiTimezone?: string;
}
 ...
 * Configurations for Reliability Timezone.
 *
 * @remarks this represents a made instance of ReliabilityTimezoneConfig
 */
declare class ReliabilityTimezoneConfig extends Obj  {

  readonly configOverride?: string;
  withConfigOverride(configOverride: string | null): ReliabilityTimezoneConfig;

  static readonly configOverride?: string;

  readonly secretOverride?: string;
  withSecretOverride(secretOverride: string | null): ReliabilityTimezoneConfig;
  ...
  withIssues(issues: Array_Type<string> | Array<string> | null): ReliabilityTimezoneConfig;
  ...
  withUiTimezone(uiTimezone: string | null): ReliabilityTimezoneConfig;
   ...
   * since both are in Pacific Daylight time only one will be in the list. `uiTimezone` is used for timezone conversion purposes not to determine user local timezone.
   */
  static readonly uiTimezone?: string;
   ...
   * @see #toJson
   */
  static fromJson(json: any): ReliabilityTimezoneConfig | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): ReliabilityTimezoneConfig | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): ReliabilityTimezoneConfig | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): ReliabilityTimezoneConfig | null;
   ...
   */
  replaceType(old: Type, new_: Type): ReliabilityTimezoneConfig;
   ...
   * This method is used during live metadata update
   */
  static replaceType(old: Type, new_: Type): ReliabilityTimezoneConfig;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityTimezoneConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityTimezoneConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityTimezoneConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityTimezoneConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityTimezoneConfig>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityTimezoneConfig>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityTimezoneConfig>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityTimezoneConfig>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityTimezoneConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityTimezoneConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityTimezoneConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityTimezoneConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityTimezoneConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityTimezoneConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ReliabilityTimezoneConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  static validateObj(): ReliabilityTimezoneConfig;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ReliabilityTimezoneConfig;
   ...
   * @see #defaultField
   */
  static withField(field: string, value: any, doNotConvert?: boolean): ReliabilityTimezoneConfig;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityTimezoneConfig;
   ...
   * @see #defaultField
   */
  static withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityTimezoneConfig;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityTimezoneConfig;
   ...
   * @return new Obj
   */
  static withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityTimezoneConfig;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityTimezoneConfig;
   ...
   * @return new Obj
   */
  static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityTimezoneConfig;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ReliabilityTimezoneConfig;
   ...
   * @see #withoutField
   */
  static withoutFieldAtPath(path: string): ReliabilityTimezoneConfig;
   ...
   * @see #removeField
   */
  withoutField(field: string): ReliabilityTimezoneConfig;
   ...
   * @see #removeField
   */
  static withoutField(field: string): ReliabilityTimezoneConfig;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): ReliabilityTimezoneConfig;
   ...
   * @see #removeField
   */
  static withoutField(field: FieldType): ReliabilityTimezoneConfig;
   ...
   */
  withoutFields(fields: Array_Type<string>): ReliabilityTimezoneConfig;
   ...
   * @return new Obj with removed fields
   */
  static withoutFields(fields: Array_Type<string>): ReliabilityTimezoneConfig;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityTimezoneConfig;
   ...
   * @return new Obj with removed fields
   */
  static withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityTimezoneConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ReliabilityTimezoneConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  static withoutSecretFields(): ReliabilityTimezoneConfig;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityTimezoneConfig;
   ...
   * @see FieldType#defaultValue
   */
  static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityTimezoneConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ReliabilityTimezoneConfig;
   ...
   * @see #unsetField
   */
  static defaultField(field: string): ReliabilityTimezoneConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ReliabilityTimezoneConfig;
   ...
   * @see #unsetField
   */
  static defaultField(field: FieldType): ReliabilityTimezoneConfig;
   ...
   * @see #removeField
   */
  unsetField(field: string): ReliabilityTimezoneConfig;
   ...
   * @see #removeField
   */
  static unsetField(field: string): ReliabilityTimezoneConfig;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ReliabilityTimezoneConfig;
   ...
   * @see #removeField
   */
  static unsetField(field: FieldType): ReliabilityTimezoneConfig;
   ...
   * @see #unsetField
   */
  removeField(field: string): ReliabilityTimezoneConfig;
   ...
   * @see #unsetField
   */
  static removeField(field: string): ReliabilityTimezoneConfig;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ReliabilityTimezoneConfig;
   ...
   * @see #unsetField
   */
  static removeField(field: FieldType): ReliabilityTimezoneConfig;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityTimezoneConfig;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityTimezoneConfig;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityTimezoneConfig;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityTimezoneConfig;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityTimezoneConfig;
   ...
   *        the same key or index.
   */
  static mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityTimezoneConfig;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityTimezoneConfig;
   ...
   * traverse child reference and collection fields.
   */
  static mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityTimezoneConfig;

  mergeJson(json: any): ReliabilityTimezoneConfig;

  static mergeJson(json: any): ReliabilityTimezoneConfig;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityTimezoneConfig;
   ...
   * @return Obj with child references merged
   */
  static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityTimezoneConfig;
   ...
   */
  sumObj(other: Obj, deep?: boolean): ReliabilityTimezoneConfig;
   ...
   * references with same name and collection elements at same index or key.
   */
  static sumObj(other: Obj, deep?: boolean): ReliabilityTimezoneConfig;
   ...
   */
  singletonArray(): Array_Type<ReliabilityTimezoneConfig>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonArray(): Array_Type<ReliabilityTimezoneConfig>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityTimezoneConfig> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ReliabilityTimezoneConfig> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<ReliabilityTimezoneConfig>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonSet(): Set_Type<ReliabilityTimezoneConfig>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ReliabilityTimezoneConfig> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, ReliabilityTimezoneConfig> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityTimezoneConfig> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ReliabilityTimezoneConfig>;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  static toBuilder(): ObjBuilder<ReliabilityTimezoneConfig>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ReliabilityTimezoneConfig>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityTimezoneConfig;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityTimezoneConfig;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityTimezoneConfig;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ReliabilityTimezoneConfig;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityTimezoneConfig;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ReliabilityTimezoneConfig;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityTimezoneConfig;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): ReliabilityTimezoneConfig;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  static afterMake(): ReliabilityTimezoneConfig;
   ...
   */
  static cachedEmptyInst(): ReliabilityTimezoneConfig;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityTimezoneConfig> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): ReliabilityTimezoneConfig;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<ReliabilityTimezoneConfig> | null;
   ...
   */
  static find(filter?: string, doNotProduceAll?: boolean): Stream<ReliabilityTimezoneConfig> | null;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<ReliabilityTimezoneConfig> | null;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): ReliabilityTimezoneConfig | null;

  /**
   * Returns cached instance by key, with secrets removed.
   */
  static forCacheKey(key: string): ReliabilityTimezoneConfig | null;
   ...
   * @see findByCacheKey
   */
  getCached(): ReliabilityTimezoneConfig | null;
   ...
   * @see findByCacheKey
   */
  static getCached(): ReliabilityTimezoneConfig | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): ReliabilityTimezoneConfig | null;

  /**
   * @return newly produced cached instance.
   */
  static refreshCache(): ReliabilityTimezoneConfig | null;
   ...
   */
  static produce(key: string): ReliabilityTimezoneConfig | null;
   ...
   */
  static produceAll(): Map_Type<string, ReliabilityTimezoneConfig> | null;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): Map_Type<string, ReliabilityTimezoneConfig> | null;
   ...
   */
  getConfig(): ReliabilityTimezoneConfig;
   ...
   * Note that typical pattern is to use Configurable#config instead of this method.
   */
  static getConfig(): ReliabilityTimezoneConfig;
   ...
   */
  getSecret(): ReliabilityTimezoneConfig;
   ...
   * Note that typical pattern is to use Configurable#configWithSecrets instead of this method.
   */
  static getSecret(): ReliabilityTimezoneConfig;
   ...
   */
  withConfigKey(configKey: string): ReliabilityTimezoneConfig;
   ...
   *     config.configKey() => "folder1/abc"
   */
  static withConfigKey(configKey: string): ReliabilityTimezoneConfig;

  /**
   * @return copy without config key.
   */
  withoutConfigKey(): ReliabilityTimezoneConfig;

  /**
   * @return copy without config key.
   */
  static withoutConfigKey(): ReliabilityTimezoneConfig;

  /**
   * @return return cached config instance for provided config key.
   */
  static forConfigKey(configKey: string): ReliabilityTimezoneConfig | null;
   ...
   */
  static listConfigs(parallel?: boolean, filter?: λPredicate<string>): Stream<ReliabilityTimezoneConfig> | null;
   ...
   * @see setConfigValue
   */
  setConfigValues(from: ReliabilityTimezoneConfig, override?: string): void;

  /**
   * Sets multiple field values to be the same as the passed instance.
   * @see setConfigValue
   */
  static setConfigValues(from: ReliabilityTimezoneConfig, override?: string): void;
   ...
   * @see setSecretValue
   */
  setSecretValues(from: ReliabilityTimezoneConfig, override?: string): void;

  /**
   * Sets multiple secret field values to be the same as the passed instance.
   * @see setSecretValue
   */
  static setSecretValues(from: ReliabilityTimezoneConfig, override?: string): void;
   ...
   */
  static loadConfigAndSecret(configKey: string): ReliabilityTimezoneConfig | null;
   ...
   */
  removeSecrets(): ReliabilityTimezoneConfig | null;

  /**
   * @return this config without any secret values.
   */
  static removeSecrets(): ReliabilityTimezoneConfig | null;

  /**
   * @return this config with only secret values.
   */
  removeNonSecrets(): ReliabilityTimezoneConfig | null;

  /**
   * @return this config with only secret values.
   */
  static removeNonSecrets(): ReliabilityTimezoneConfig | null;

  /**
   * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
   * validation and setup.
   */
  validate(): ReliabilityTimezoneConfig;

  /**
   * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
   * validation and setup.
   */
  static validate(): ReliabilityTimezoneConfig;
