// TypeScript definitions for the C3 type WorkOrderUpdateLogMergeBatchJob

/**
 * A batch job that merges {@link WorkOrderUpdateLog} for each {@link WorkOrder}
 *
 * @remarks this represents a value passed to a method that expects an instance of WorkOrderUpdateLogMergeBatchJob
 */
declare interface IWorkOrderUpdateLogMergeBatchJob {
 ...
 */
declare class WorkOrderUpdateLogMergeBatchJob extends Obj  {

  /**
   * current or last job execution for this instance
   */
  readonly run?: BatchJobRun;
  withRun(run: IBatchJobRun | null): WorkOrderUpdateLogMergeBatchJob;

  /**
   * previous job executions for this instance
   */
  readonly runs?: Array_Type<BatchJobRun>;
  withRuns(runs: Array_Type<BatchJobRun> | Array<IBatchJobRun> | null): WorkOrderUpdateLogMergeBatchJob;

  /**
   * FOR INTERNAL USE ONLY - Specify options in call to {@link start}.
   */
  readonly options?: Obj;
  withOptions(options: IObj | null): WorkOrderUpdateLogMergeBatchJob;
  ...
  withOnCompleteCallback(onCompleteCallback: IJobBase.Callback | null): WorkOrderUpdateLogMergeBatchJob;
  ...
  withPriority(priority: number | null): WorkOrderUpdateLogMergeBatchJob;
  ...
  withDisabled(disabled: boolean): WorkOrderUpdateLogMergeBatchJob;
  ...
  withMaxConcurrency(maxConcurrency: number | null): WorkOrderUpdateLogMergeBatchJob;
  ...
  withMaxConcurrencyPerNode(maxConcurrencyPerNode: number | null): WorkOrderUpdateLogMergeBatchJob;
  ...
  withRunAsUser(runAsUser: boolean): WorkOrderUpdateLogMergeBatchJob;

  /**
   * Don't set this field in the BatchJob, set it in the BatchJobOptions when calling `start`
   */
  readonly nodePool?: string;
  withNodePool(nodePool: string | null): WorkOrderUpdateLogMergeBatchJob;
  ...
  withSkipIfRunning(skipIfRunning: boolean): WorkOrderUpdateLogMergeBatchJob;

  /**
   * Set to between 1 and 5 to enable auto recovery. See {@link invalidation-queues.c3doc Invalidation Queues} for detailed documentation.
   */
  readonly numAutoRecoveryAttempts?: number;
  withNumAutoRecoveryAttempts(numAutoRecoveryAttempts: number | null): WorkOrderUpdateLogMergeBatchJob;
  ...
  withPropagateActionContext(propagateActionContext: boolean): WorkOrderUpdateLogMergeBatchJob;
  ...
  withTypeIdent(typeIdent: string | null): WorkOrderUpdateLogMergeBatchJob;
   ...
   */
  readonly id: string;
  withId(id: string): WorkOrderUpdateLogMergeBatchJob;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): WorkOrderUpdateLogMergeBatchJob;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): WorkOrderUpdateLogMergeBatchJob;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): WorkOrderUpdateLogMergeBatchJob;
  ...
  withVersion(version: number | null): WorkOrderUpdateLogMergeBatchJob;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): WorkOrderUpdateLogMergeBatchJob;
  ...
  withAbortOnError(abortOnError: boolean): WorkOrderUpdateLogMergeBatchJob;
   ...
   * @see #toJson
   */
  static fromJson(json: any): WorkOrderUpdateLogMergeBatchJob | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): WorkOrderUpdateLogMergeBatchJob | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): WorkOrderUpdateLogMergeBatchJob | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): WorkOrderUpdateLogMergeBatchJob | null;
   ...
   */
  replaceType(old: Type, new_: Type): WorkOrderUpdateLogMergeBatchJob;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): WorkOrderUpdateLogMergeBatchJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): WorkOrderUpdateLogMergeBatchJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<WorkOrderUpdateLogMergeBatchJob>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<WorkOrderUpdateLogMergeBatchJob>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): WorkOrderUpdateLogMergeBatchJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): WorkOrderUpdateLogMergeBatchJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): WorkOrderUpdateLogMergeBatchJob;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): WorkOrderUpdateLogMergeBatchJob;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): WorkOrderUpdateLogMergeBatchJob;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): WorkOrderUpdateLogMergeBatchJob;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): WorkOrderUpdateLogMergeBatchJob;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): WorkOrderUpdateLogMergeBatchJob;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): WorkOrderUpdateLogMergeBatchJob;
   ...
   * @see #removeField
   */
  withoutField(field: string): WorkOrderUpdateLogMergeBatchJob;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): WorkOrderUpdateLogMergeBatchJob;
   ...
   */
  withoutFields(fields: Array_Type<string>): WorkOrderUpdateLogMergeBatchJob;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): WorkOrderUpdateLogMergeBatchJob;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): WorkOrderUpdateLogMergeBatchJob;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): WorkOrderUpdateLogMergeBatchJob;
   ...
   * @see #unsetField
   */
  defaultField(field: string): WorkOrderUpdateLogMergeBatchJob;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): WorkOrderUpdateLogMergeBatchJob;
   ...
   * @see #removeField
   */
  unsetField(field: string): WorkOrderUpdateLogMergeBatchJob;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): WorkOrderUpdateLogMergeBatchJob;
   ...
   * @see #unsetField
   */
  removeField(field: string): WorkOrderUpdateLogMergeBatchJob;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): WorkOrderUpdateLogMergeBatchJob;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): WorkOrderUpdateLogMergeBatchJob;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): WorkOrderUpdateLogMergeBatchJob;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): WorkOrderUpdateLogMergeBatchJob;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): WorkOrderUpdateLogMergeBatchJob;

  mergeJson(json: any): WorkOrderUpdateLogMergeBatchJob;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): WorkOrderUpdateLogMergeBatchJob;
   ...
   */
  sumObj(other: Obj, deep?: boolean): WorkOrderUpdateLogMergeBatchJob;
   ...
   */
  singletonArray(): Array_Type<WorkOrderUpdateLogMergeBatchJob>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<WorkOrderUpdateLogMergeBatchJob> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<WorkOrderUpdateLogMergeBatchJob> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<WorkOrderUpdateLogMergeBatchJob>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<WorkOrderUpdateLogMergeBatchJob> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, WorkOrderUpdateLogMergeBatchJob> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, WorkOrderUpdateLogMergeBatchJob> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<WorkOrderUpdateLogMergeBatchJob>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<WorkOrderUpdateLogMergeBatchJob>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): WorkOrderUpdateLogMergeBatchJob;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): WorkOrderUpdateLogMergeBatchJob;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): WorkOrderUpdateLogMergeBatchJob;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): WorkOrderUpdateLogMergeBatchJob;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): WorkOrderUpdateLogMergeBatchJob;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): WorkOrderUpdateLogMergeBatchJob;
   ...
   * @see #fromString
   */
  static make(s: string): WorkOrderUpdateLogMergeBatchJob | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): WorkOrderUpdateLogMergeBatchJob;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): WorkOrderUpdateLogMergeBatchJob;
   ...
   */
  static cachedEmptyInst(): WorkOrderUpdateLogMergeBatchJob;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<WorkOrderUpdateLogMergeBatchJob> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): WorkOrderUpdateLogMergeBatchJob;
   ...
   */
  start(options?: WorkOrderUpdateLogMergeBatchJobOptions): BatchJobStatus | null;
   ...
   */
  cleanup(options?: WorkOrderUpdateLogMergeBatchJobOptions): void;
  ...
  cancelJob(removeResults?: boolean, force?: boolean): JobBase<BatchJobRun, BatchJobStatus, WorkOrderUpdateLogMergeBatchJobOptions> | null;

  failJob(run: JobRun<BatchJobStatusBase>): JobBase<BatchJobRun, BatchJobStatus, WorkOrderUpdateLogMergeBatchJobOptions> | null;
  ...
  validateStart(options?: WorkOrderUpdateLogMergeBatchJobOptions): void;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<WorkOrderUpdateLogMergeBatchJob>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<WorkOrderUpdateLogMergeBatchJob>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<WorkOrderUpdateLogMergeBatchJob> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<WorkOrderUpdateLogMergeBatchJob>> | null;
   ...
   */
  get(include?: string): WorkOrderUpdateLogMergeBatchJob | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): WorkOrderUpdateLogMergeBatchJob | null;
   ...
   */
  getMissing(spec: GetMissingSpec): WorkOrderUpdateLogMergeBatchJob;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): WorkOrderUpdateLogMergeBatchJob | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): WorkOrderUpdateLogMergeBatchJob;
   ...
   * @see #toString
   */
  static fromString(s: string): WorkOrderUpdateLogMergeBatchJob | null;
   ...
   */
  create(spec?: UpsertSpec): WorkOrderUpdateLogMergeBatchJob | null;
   ...
   */
  static createBatch(objs: Array_Type<WorkOrderUpdateLogMergeBatchJob>, spec?: UpsertSpec): ObjList<WorkOrderUpdateLogMergeBatchJob> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<WorkOrderUpdateLogMergeBatchJob>, spec?: CreateBatchObjStreamSpec): ObjList<WorkOrderUpdateLogMergeBatchJob> | null;
   ...
   */
  update(srcObj?: WorkOrderUpdateLogMergeBatchJob, spec?: UpsertSpec): WorkOrderUpdateLogMergeBatchJob | null;
   ...
   */
  upsert(srcObj?: WorkOrderUpdateLogMergeBatchJob, spec?: UpsertSpec): WorkOrderUpdateLogMergeBatchJob | null;
   ...
   */
  merge(spec?: MergeSpec): WorkOrderUpdateLogMergeBatchJob | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): WorkOrderUpdateLogMergeBatchJob | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): WorkOrderUpdateLogMergeBatchJob | null;
   ...
   */
  static updateBatch(objs: Array_Type<WorkOrderUpdateLogMergeBatchJob>, srcObjs?: Array_Type<WorkOrderUpdateLogMergeBatchJob>, spec?: UpsertSpec): ObjList<WorkOrderUpdateLogMergeBatchJob> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<WorkOrderUpdateLogMergeBatchJob> | null>, spec?: UpsertSpec): ObjList<WorkOrderUpdateLogMergeBatchJob> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<WorkOrderUpdateLogMergeBatchJob>, srcObjs?: Array_Type<WorkOrderUpdateLogMergeBatchJob>, spec?: UpsertSpec): ObjList<WorkOrderUpdateLogMergeBatchJob> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<WorkOrderUpdateLogMergeBatchJob> | null>, spec?: UpsertSpec): ObjList<WorkOrderUpdateLogMergeBatchJob> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<WorkOrderUpdateLogMergeBatchJob>, spec?: TouchSpec): ObjList<WorkOrderUpdateLogMergeBatchJob> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<WorkOrderUpdateLogMergeBatchJob>, spec?: MergeSpec): ObjList<WorkOrderUpdateLogMergeBatchJob> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<WorkOrderUpdateLogMergeBatchJob>, mergeInclude: string, spec?: MergeSpec): ObjList<WorkOrderUpdateLogMergeBatchJob> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<WorkOrderUpdateLogMergeBatchJob> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<WorkOrderUpdateLogMergeBatchJob> | null;
   ...
   */
  static mergeAll(mergeObj: WorkOrderUpdateLogMergeBatchJob, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: WorkOrderUpdateLogMergeBatchJob, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<WorkOrderUpdateLogMergeBatchJob>, spec?: UpsertSpec): ObjList<WorkOrderUpdateLogMergeBatchJob> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<WorkOrderUpdateLogMergeBatchJob>, spec?: UpsertSpec): ObjList<WorkOrderUpdateLogMergeBatchJob> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): WorkOrderUpdateLogMergeBatchJob | null;
   ...
   */
  static beforeCreate(objs: Array_Type<WorkOrderUpdateLogMergeBatchJob>): ObjList<WorkOrderUpdateLogMergeBatchJob>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<WorkOrderUpdateLogMergeBatchJob>): ObjList<WorkOrderUpdateLogMergeBatchJob>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<WorkOrderUpdateLogMergeBatchJob>): ObjList<WorkOrderUpdateLogMergeBatchJob>;
   ...
   */
  static afterCreate(objs: Array_Type<WorkOrderUpdateLogMergeBatchJob>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<WorkOrderUpdateLogMergeBatchJob>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<WorkOrderUpdateLogMergeBatchJob>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<WorkOrderUpdateLogMergeBatchJob>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<WorkOrderUpdateLogMergeBatchJob>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): WorkOrderUpdateLogMergeBatchJob | null;
   ...
   */
  withoutIdentity(): WorkOrderUpdateLogMergeBatchJob | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<WorkOrderUpdateLogMergeBatchJob>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: WorkOrderUpdateLogMergeBatchJob, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<WorkOrderUpdateLogMergeBatchJob>, callback?: λFunction<WorkOrderUpdateLogMergeBatchJob | null, WorkOrderUpdateLogMergeBatchJob | null>): ObjList<WorkOrderUpdateLogMergeBatchJob>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<WorkOrderUpdateLogMergeBatchJob>, callback?: λFunction<WorkOrderUpdateLogMergeBatchJob | null, WorkOrderUpdateLogMergeBatchJob | null>): Array_Type<ObjError> | null;
   ...
   * @inheritdoc
   */
  static doStart(job?: WorkOrderUpdateLogMergeBatchJob, options?: WorkOrderUpdateLogMergeBatchJobOptions): void;

  /**
   * @inheritdoc
   */
  static processBatch(batch?: WorkOrderUpdateLogMergeBatch, job?: WorkOrderUpdateLogMergeBatchJob, options?: WorkOrderUpdateLogMergeBatchJobOptions): void;

  /**
   * @inheritdoc
   */
  static allComplete(job: WorkOrderUpdateLogMergeBatchJob, options?: WorkOrderUpdateLogMergeBatchJobOptions): string | null;

  /**
   * @inheritdoc
   */
  static failed(job: WorkOrderUpdateLogMergeBatchJob, status: BatchJobStatus, options?: WorkOrderUpdateLogMergeBatchJobOptions): void;
   ...
   *        Batch to schedule.
   */
  scheduleBatch(batch?: WorkOrderUpdateLogMergeBatch): void;
   ...
   *        Batches to schedule.
   */
  scheduleBatches(batches?: Array_Type<WorkOrderUpdateLogMergeBatch>): void;
   ...
   */
  static scheduleObjBatch(job?: WorkOrderUpdateLogMergeBatchJob, objBatch?: ObjBatch, logPrefix?: string): number | null;
