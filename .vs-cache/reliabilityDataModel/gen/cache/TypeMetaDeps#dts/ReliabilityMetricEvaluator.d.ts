// TypeScript definitions for the C3 type ReliabilityMetricEvaluator

/**
 * The type that is purely used for evaluation of User Defined Metrics of {@link ReliabilityMetric} type.
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityMetricEvaluator
 */
declare interface IReliabilityMetricEvaluator {
 ...
 */
declare class ReliabilityMetricEvaluator extends Obj  {
   ...
   */
  readonly id: string;
  withId(id: string): ReliabilityMetricEvaluator;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityMetricEvaluator;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): ReliabilityMetricEvaluator;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): ReliabilityMetricEvaluator;
  ...
  withVersion(version: number | null): ReliabilityMetricEvaluator;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): ReliabilityMetricEvaluator;

  /**
   * All the sensors in the application are linked to this type.
   */
  readonly sensors?: Array_Type<Sensor>;
  withSensors(sensors: Array_Type<Sensor> | Array<ISensor> | null): ReliabilityMetricEvaluator;
   ...
   * @see #toJson
   */
  static fromJson(json: any): ReliabilityMetricEvaluator | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): ReliabilityMetricEvaluator | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): ReliabilityMetricEvaluator | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): ReliabilityMetricEvaluator | null;
   ...
   */
  replaceType(old: Type, new_: Type): ReliabilityMetricEvaluator;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityMetricEvaluator;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityMetricEvaluator;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityMetricEvaluator>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityMetricEvaluator>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityMetricEvaluator;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityMetricEvaluator;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityMetricEvaluator;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ReliabilityMetricEvaluator;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ReliabilityMetricEvaluator;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityMetricEvaluator;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityMetricEvaluator;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityMetricEvaluator;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ReliabilityMetricEvaluator;
   ...
   * @see #removeField
   */
  withoutField(field: string): ReliabilityMetricEvaluator;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): ReliabilityMetricEvaluator;
   ...
   */
  withoutFields(fields: Array_Type<string>): ReliabilityMetricEvaluator;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityMetricEvaluator;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ReliabilityMetricEvaluator;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityMetricEvaluator;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ReliabilityMetricEvaluator;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ReliabilityMetricEvaluator;
   ...
   * @see #removeField
   */
  unsetField(field: string): ReliabilityMetricEvaluator;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ReliabilityMetricEvaluator;
   ...
   * @see #unsetField
   */
  removeField(field: string): ReliabilityMetricEvaluator;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ReliabilityMetricEvaluator;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityMetricEvaluator;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityMetricEvaluator;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityMetricEvaluator;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityMetricEvaluator;

  mergeJson(json: any): ReliabilityMetricEvaluator;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityMetricEvaluator;
   ...
   */
  sumObj(other: Obj, deep?: boolean): ReliabilityMetricEvaluator;
   ...
   */
  singletonArray(): Array_Type<ReliabilityMetricEvaluator>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityMetricEvaluator> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ReliabilityMetricEvaluator> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<ReliabilityMetricEvaluator>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ReliabilityMetricEvaluator> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, ReliabilityMetricEvaluator> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityMetricEvaluator> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ReliabilityMetricEvaluator>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ReliabilityMetricEvaluator>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityMetricEvaluator;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityMetricEvaluator;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityMetricEvaluator;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ReliabilityMetricEvaluator;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityMetricEvaluator;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ReliabilityMetricEvaluator;
   ...
   * @see #fromString
   */
  static make(s: string): ReliabilityMetricEvaluator | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityMetricEvaluator;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): ReliabilityMetricEvaluator;
   ...
   */
  static cachedEmptyInst(): ReliabilityMetricEvaluator;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityMetricEvaluator> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): ReliabilityMetricEvaluator;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<ReliabilityMetricEvaluator>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<ReliabilityMetricEvaluator>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityMetricEvaluator> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityMetricEvaluator>> | null;
   ...
   */
  static evalFeatureSetBatch(batch: Array_Type<ReliabilityMetricEvaluator>, featureSet: Feature.Set, spec?: EvalFeatureSpec): Data | null;
   ...
   * ```
   */
  static evalFeaturesBatch(batch: Array_Type<ReliabilityMetricEvaluator>, features: Array_Type<string>, spec?: EvalFeaturesSpec): Data | null;
   ...
   */
  get(include?: string): ReliabilityMetricEvaluator | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): ReliabilityMetricEvaluator | null;
   ...
   */
  getMissing(spec: GetMissingSpec): ReliabilityMetricEvaluator;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): ReliabilityMetricEvaluator | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): ReliabilityMetricEvaluator;
   ...
   * @see #toString
   */
  static fromString(s: string): ReliabilityMetricEvaluator | null;
   ...
   */
  create(spec?: UpsertSpec): ReliabilityMetricEvaluator | null;
   ...
   */
  static createBatch(objs: Array_Type<ReliabilityMetricEvaluator>, spec?: UpsertSpec): ObjList<ReliabilityMetricEvaluator> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<ReliabilityMetricEvaluator>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityMetricEvaluator> | null;
   ...
   */
  update(srcObj?: ReliabilityMetricEvaluator, spec?: UpsertSpec): ReliabilityMetricEvaluator | null;
   ...
   */
  upsert(srcObj?: ReliabilityMetricEvaluator, spec?: UpsertSpec): ReliabilityMetricEvaluator | null;
   ...
   */
  merge(spec?: MergeSpec): ReliabilityMetricEvaluator | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): ReliabilityMetricEvaluator | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): ReliabilityMetricEvaluator | null;
   ...
   */
  static updateBatch(objs: Array_Type<ReliabilityMetricEvaluator>, srcObjs?: Array_Type<ReliabilityMetricEvaluator>, spec?: UpsertSpec): ObjList<ReliabilityMetricEvaluator> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<ReliabilityMetricEvaluator> | null>, spec?: UpsertSpec): ObjList<ReliabilityMetricEvaluator> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<ReliabilityMetricEvaluator>, srcObjs?: Array_Type<ReliabilityMetricEvaluator>, spec?: UpsertSpec): ObjList<ReliabilityMetricEvaluator> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<ReliabilityMetricEvaluator> | null>, spec?: UpsertSpec): ObjList<ReliabilityMetricEvaluator> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<ReliabilityMetricEvaluator>, spec?: TouchSpec): ObjList<ReliabilityMetricEvaluator> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityMetricEvaluator>, spec?: MergeSpec): ObjList<ReliabilityMetricEvaluator> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityMetricEvaluator>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityMetricEvaluator> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<ReliabilityMetricEvaluator> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityMetricEvaluator> | null;
   ...
   */
  static mergeAll(mergeObj: ReliabilityMetricEvaluator, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: ReliabilityMetricEvaluator, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<ReliabilityMetricEvaluator>, spec?: UpsertSpec): ObjList<ReliabilityMetricEvaluator> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<ReliabilityMetricEvaluator>, spec?: UpsertSpec): ObjList<ReliabilityMetricEvaluator> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): ReliabilityMetricEvaluator | null;
   ...
   */
  static beforeCreate(objs: Array_Type<ReliabilityMetricEvaluator>): ObjList<ReliabilityMetricEvaluator>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<ReliabilityMetricEvaluator>): ObjList<ReliabilityMetricEvaluator>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<ReliabilityMetricEvaluator>): ObjList<ReliabilityMetricEvaluator>;
   ...
   */
  static afterCreate(objs: Array_Type<ReliabilityMetricEvaluator>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<ReliabilityMetricEvaluator>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<ReliabilityMetricEvaluator>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityMetricEvaluator>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityMetricEvaluator>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): ReliabilityMetricEvaluator | null;
   ...
   */
  withoutIdentity(): ReliabilityMetricEvaluator | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<ReliabilityMetricEvaluator>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: ReliabilityMetricEvaluator, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<ReliabilityMetricEvaluator>, callback?: λFunction<ReliabilityMetricEvaluator | null, ReliabilityMetricEvaluator | null>): ObjList<ReliabilityMetricEvaluator>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<ReliabilityMetricEvaluator>, callback?: λFunction<ReliabilityMetricEvaluator | null, ReliabilityMetricEvaluator | null>): Array_Type<ObjError> | null;
