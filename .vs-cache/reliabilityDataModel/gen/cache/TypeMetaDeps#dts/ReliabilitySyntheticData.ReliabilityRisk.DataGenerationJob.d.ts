// TypeScript definitions for the C3 type ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob

/**
 * A {@link BatchJob} to safely and quickly generate+write synthetic data to disk.
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob
 */
declare namespace ReliabilitySyntheticData.ReliabilityRisk {
  export interface IDataGenerationJob {
     ...
     */
    runs?: Array_Type<BatchJobRun> | Array<IBatchJobRun>;
 ...
 */
declare namespace ReliabilitySyntheticData.ReliabilityRisk {
  export class DataGenerationJob extends Obj  {
    ...
    withTemplateExcel(templateExcel: IFile | null): ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob;
    ...
    withReplicatedExcel(replicatedExcel: IReliabilitySyntheticData.ReliabilityRisk.AssetHierarchySpreadsheet | null): ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob;
    ...
    withSkipRelationalDataGeneration(skipRelationalDataGeneration: boolean): ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob;
    ...
    withIntrafacilityReplicationFactor(intrafacilityReplicationFactor: number): ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob;
    ...
    withInterfacilityReplicationFactor(interfacilityReplicationFactor: number): ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob;
    ...
    withNumberOfExternalSensorsPerAsset(numberOfExternalSensorsPerAsset: number): ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob;

    /**
     * The target expected sensor name for external sensors.
     */
    readonly targetExpectedSensorForExternalSensors?: string;
    withTargetExpectedSensorForExternalSensors(targetExpectedSensorForExternalSensors: string | null): ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob;
    ...
    withOverrideTimeRange(overrideTimeRange: ITimeRange | null): ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob;
    ...
    withChunkDuration(chunkDuration: IDuration): ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob;
    ...
    withFolderPath(folderPath: string): ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob;
    ...
    withBatchSize(batchSize: number): ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob;

    /**
     * current or last job execution for this instance
     */
    readonly run?: BatchJobRun;
    withRun(run: IBatchJobRun | null): ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob;

    /**
     * previous job executions for this instance
     */
    readonly runs?: Array_Type<BatchJobRun>;
    withRuns(runs: Array_Type<BatchJobRun> | Array<IBatchJobRun> | null): ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob;

    /**
     * FOR INTERNAL USE ONLY - Specify options in call to {@link start}.
     */
    readonly options?: Obj;
    withOptions(options: IObj | null): ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob;
    ...
    withOnCompleteCallback(onCompleteCallback: IJobBase.Callback | null): ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob;
    ...
    withPriority(priority: number | null): ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob;
    ...
    withDisabled(disabled: boolean): ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob;
    ...
    withMaxConcurrency(maxConcurrency: number | null): ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob;
    ...
    withMaxConcurrencyPerNode(maxConcurrencyPerNode: number | null): ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob;
    ...
    withRunAsUser(runAsUser: boolean): ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob;

    /**
     * Don't set this field in the BatchJob, set it in the BatchJobOptions when calling `start`
     */
    readonly nodePool?: string;
    withNodePool(nodePool: string | null): ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob;
    ...
    withSkipIfRunning(skipIfRunning: boolean): ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob;

    /**
     * Set to between 1 and 5 to enable auto recovery. See {@link invalidation-queues.c3doc Invalidation Queues} for detailed documentation.
     */
    readonly numAutoRecoveryAttempts?: number;
    withNumAutoRecoveryAttempts(numAutoRecoveryAttempts: number | null): ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob;
    ...
    withPropagateActionContext(propagateActionContext: boolean): ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob;
    ...
    withTypeIdent(typeIdent: string | null): ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob;
     ...
     */
    readonly id: string;
    withId(id: string): ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob;
    ...
    withVersion(version: number | null): ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob;
    ...
    withAbortOnError(abortOnError: boolean): ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob;
     ...
     * @see #toJson
     */
    static fromJson(json: any): ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob | null;
     ...
     */
    replaceType(old: Type, new_: Type): ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob;
     ...
     * @see #removeField
     */
    withoutField(field: string): ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob;
     ...
     */
    withoutFields(fields: Array_Type<string>): ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob;
     ...
     * @see #unsetField
     */
    defaultField(field: string): ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob;
     ...
     * @see #removeField
     */
    unsetField(field: string): ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob;
     ...
     * @see #unsetField
     */
    removeField(field: string): ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob;

    mergeJson(json: any): ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob;
     ...
     */
    sumObj(other: Obj, deep?: boolean): ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob;
     ...
     */
    singletonArray(): Array_Type<ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob;
     ...
     * @see #fromString
     */
    static make(s: string): ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob;
     ...
     */
    static cachedEmptyInst(): ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob;
     ...
     */
    start(options?: BatchJobOptions): BatchJobStatus | null;
     ...
     */
    status(forceRefresh?: boolean): BatchJobStatus | null;
     ...
     */
    recover(forceRefresh?: boolean): BatchJobStatus | null;
     ...
     */
    cancel(removeResults?: boolean): BatchJobStatus | null;
     ...
     */
    cleanup(options?: BatchJobOptions): void;
    ...
    cancelJob(removeResults?: boolean, force?: boolean): JobBase<BatchJobRun, BatchJobStatus, BatchJobOptions> | null;

    failJob(run: JobRun<BatchJobStatusBase>): JobBase<BatchJobRun, BatchJobStatus, BatchJobOptions> | null;
    ...
    validateStart(options?: BatchJobOptions): void;

    updateJobState(): boolean;

    removeResults(run: BatchJobRun): void;

    static cancelJobQueueEntry(run?: BatchJobRun, entry?: InvalidationQueueEntry<any>): void;

    startContext(): string | null;

    startStep(): string | null;

    createRun(status?: BatchJobStatus, startingActionId?: string): BatchJobRun | null;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob>> | null;
     ...
     */
    get(include?: string): ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob | null;
     ...
     */
    getMissing(spec: GetMissingSpec): ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob;
     ...
     * @see #toString
     */
    static fromString(s: string): ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob | null;
     ...
     */
    create(spec?: UpsertSpec): ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob | null;
     ...
     */
    static createBatch(objs: Array_Type<ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob>, spec?: UpsertSpec): ObjList<ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob> | null;
     ...
     */
    update(srcObj?: ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob, spec?: UpsertSpec): ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob | null;
     ...
     */
    upsert(srcObj?: ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob, spec?: UpsertSpec): ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob | null;
     ...
     */
    merge(spec?: MergeSpec): ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob | null;
     ...
     */
    static updateBatch(objs: Array_Type<ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob>, srcObjs?: Array_Type<ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob>, spec?: UpsertSpec): ObjList<ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob> | null>, spec?: UpsertSpec): ObjList<ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob>, srcObjs?: Array_Type<ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob>, spec?: UpsertSpec): ObjList<ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob> | null>, spec?: UpsertSpec): ObjList<ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob>, spec?: TouchSpec): ObjList<ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob>, spec?: MergeSpec): ObjList<ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob> | null;
     ...
     */
    static mergeAll(mergeObj: ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob>, spec?: UpsertSpec): ObjList<ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob>, spec?: UpsertSpec): ObjList<ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob | null;
     ...
     */
    static beforeCreate(objs: Array_Type<ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob>): ObjList<ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob>): ObjList<ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob>): ObjList<ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob>;
     ...
     */
    static afterCreate(objs: Array_Type<ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob | null;
     ...
     */
    withoutIdentity(): ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob>, callback?: λFunction<ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob | null, ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob | null>): ObjList<ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob>, callback?: λFunction<ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob | null, ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob | null>): Array_Type<ObjError> | null;
     ...
     */
    static doStart(job?: ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob, options?: BatchJobOptions): void;
     ...
     */
    static processBatch(batch?: ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJobBatch, job?: ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob, options?: BatchJobOptions): void;
     ...
     */
    static allComplete(job: ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob, options?: BatchJobOptions): string | null;
     ...
     *           Options the job was run with.
     */
    static failed(job: ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob, status: BatchJobStatus, options?: BatchJobOptions): void;
     ...
     *        Batch to schedule.
     */
    scheduleBatch(batch?: ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJobBatch): void;
     ...
     *        Batches to schedule.
     */
    scheduleBatches(batches?: Array_Type<ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJobBatch>): void;
     ...
     */
    static scheduleObjBatch(job?: ReliabilitySyntheticData.ReliabilityRisk.DataGenerationJob, objBatch?: ObjBatch, logPrefix?: string): number | null;
     ...
     *           New subBatchSize
     */
    setSubBatchSize(subBatchSize?: number): void;

    /**
     * BatchJob engine provided internal actions
     */
    static dispatchDoStart(jobId?: string): void;

    static dispatchProcessBatch(jobId?: string, context?: string): void;
  }
}
