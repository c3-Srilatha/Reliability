...
class FailureModeDiagnostic(Value, ExemptFromFacilityFilter):
    """
    ...
    """
    def __init__(self, id: Optional[str]=None, versionEdits: Optional[Array[VersionEdit]]=None, name: Optional[str]=None, meta: Optional[Meta]=None, version: Optional[int]=None, typeWithBindings: Optional[Type]=None, displayName: Optional[str]=None, displayDescription: Optional[str]=None, faIconConfig: Optional[FaIconConfig]=None, lambda: Optional[Callable[[Array[float], float, str], bool]]=None) -> None: ...
