...
class WorkOrderStatusEnum():
    ...
    """
    def __init__(self, OPEN: Optional[str]=None, ASSIGNED: Optional[str]=None, COMPLETED: Optional[str]=None, CLOSED: Optional[str]=None, CANCELLED: Optional[str]=None, INPROGRESS: Optional[str]=None, ONHOLD: Optional[str]=None, CREATED: Optional[str]=None, OPERATING: Optional[str]=None) -> None: ...
