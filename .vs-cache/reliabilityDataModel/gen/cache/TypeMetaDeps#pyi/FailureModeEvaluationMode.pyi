...
# Python definitions for the C3 type FailureModeEvaluationMode


class FailureModeEvaluationMode():
    """
    ...
    SENSOR_BASED: Optional[str]=None
    """
    Evaluation mode based on sensor data.
    """

    RESIDUAL_BASED: Optional[str]=None
    """
    Evaluation mode based on residuals or performance discrepancies.
    """
    def __init__(self, SENSOR_BASED: Optional[str]=None, RESIDUAL_BASED: Optional[str]=None) -> None: ...
