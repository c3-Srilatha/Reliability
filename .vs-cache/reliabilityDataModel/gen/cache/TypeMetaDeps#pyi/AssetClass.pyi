...
class AssetClass(FeatureEvaluatable, ExemptFromFacilityFilter):
    """
    ...
    **DISPLAY USE ONLY**
    ...
    this asset class.
    """
    def __init__(self, id: Optional[str]=None, versionEdits: Optional[Array[VersionEdit]]=None, name: Optional[str]=None, meta: Optional[Meta]=None, version: Optional[int]=None, typeWithBindings: Optional[Type]=None, typeIdent: Optional[str]=None, translatedName: Optional[str]=None, parentAssetClassRelations: Optional[Array[AssetClassParentChildRelation]]=None, childAssetClassRelations: Optional[Array[AssetClassParentChildRelation]]=None, countChildren: Optional[int]=None, hasChildren: Optional[bool]=None, assets: Optional[Array[ReliabilityAsset]]=None, countAssets: Optional[int]=None, failureModeLibrary: Optional[FailureModeLibrary]=None, failureModes: Optional[Array[FailureMode]]=None, countFailureModes: Optional[int]=None, expectedSensors: Optional[Array[ExpectedSensor]]=None, expectedSensorCount: Optional[int]=None, kpis: Optional[Array[str]]=None, linked3DModel: Optional[ReliabilityAsset3dmodel]=None, status: Optional[str]=None, hierarchyTemplate: Optional[AssetHierarchyTemplate]=None, definitionVersion: Optional[ReliabilityAssetClassDefinitionVersion]=None) -> None: ...
