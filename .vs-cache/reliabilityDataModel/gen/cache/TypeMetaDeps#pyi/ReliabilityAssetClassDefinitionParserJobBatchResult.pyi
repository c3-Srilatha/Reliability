...
from c3.reliabilityDataModel.ReliabilityAssetClassDefinitionParserJob import ReliabilityAssetClassDefinitionParserJob
...
# Python definitions for the C3 type ReliabilityAssetClassDefinitionParserJobBatchResult


class ReliabilityAssetClassDefinitionParserJobBatchResult():
    """
    ...
    job: Optional[ReliabilityAssetClassDefinitionParserJob]
    """
    ...
    definitionVersion: Optional[ReliabilityAssetClassDefinitionVersion]
    """
    The definition version that this batch should parse and persist.
    """

    alreadyPersisted: Optional[bool]=None
    """
    ...
    """
    def __init__(self, id: Optional[str]=None, versionEdits: Optional[Array[VersionEdit]]=None, name: Optional[str]=None, meta: Optional[Meta]=None, version: Optional[int]=None, typeWithBindings: Optional[Type]=None, job: Optional[ReliabilityAssetClassDefinitionParserJob]=None, status: Optional[str]=None, definitionVersion: Optional[ReliabilityAssetClassDefinitionVersion]=None, alreadyPersisted: Optional[bool]=None, assetClass: Optional[AssetClass]=None, trackingId: Optional[str]=None, error: Optional[str]=None) -> None: ...
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[ReliabilityAssetClassDefinitionParserJobBatchResult]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[ReliabilityAssetClassDefinitionParserJobBatchResult]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[ReliabilityAssetClassDefinitionParserJobBatchResult]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[ReliabilityAssetClassDefinitionParserJobBatchResult]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> ReliabilityAssetClassDefinitionParserJobBatchResult:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> ReliabilityAssetClassDefinitionParserJobBatchResult:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> ReliabilityAssetClassDefinitionParserJobBatchResult:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[ReliabilityAssetClassDefinitionParserJobBatchResult]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[ReliabilityAssetClassDefinitionParserJobBatchResult]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> ReliabilityAssetClassDefinitionParserJobBatchResult:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> ReliabilityAssetClassDefinitionParserJobBatchResult:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> ReliabilityAssetClassDefinitionParserJobBatchResult:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> ReliabilityAssetClassDefinitionParserJobBatchResult:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> ReliabilityAssetClassDefinitionParserJobBatchResult:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> ReliabilityAssetClassDefinitionParserJobBatchResult:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> ReliabilityAssetClassDefinitionParserJobBatchResult:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> ReliabilityAssetClassDefinitionParserJobBatchResult:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> ReliabilityAssetClassDefinitionParserJobBatchResult:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> ReliabilityAssetClassDefinitionParserJobBatchResult:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> ReliabilityAssetClassDefinitionParserJobBatchResult:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> ReliabilityAssetClassDefinitionParserJobBatchResult:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> ReliabilityAssetClassDefinitionParserJobBatchResult:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> ReliabilityAssetClassDefinitionParserJobBatchResult:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> ReliabilityAssetClassDefinitionParserJobBatchResult:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> ReliabilityAssetClassDefinitionParserJobBatchResult:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> ReliabilityAssetClassDefinitionParserJobBatchResult:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> ReliabilityAssetClassDefinitionParserJobBatchResult:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> ReliabilityAssetClassDefinitionParserJobBatchResult:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> ReliabilityAssetClassDefinitionParserJobBatchResult:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> ReliabilityAssetClassDefinitionParserJobBatchResult:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> ReliabilityAssetClassDefinitionParserJobBatchResult:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> ReliabilityAssetClassDefinitionParserJobBatchResult:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> ReliabilityAssetClassDefinitionParserJobBatchResult:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> ReliabilityAssetClassDefinitionParserJobBatchResult:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> ReliabilityAssetClassDefinitionParserJobBatchResult:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> ReliabilityAssetClassDefinitionParserJobBatchResult:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> ReliabilityAssetClassDefinitionParserJobBatchResult:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[ReliabilityAssetClassDefinitionParserJobBatchResult]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[ReliabilityAssetClassDefinitionParserJobBatchResult]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[ReliabilityAssetClassDefinitionParserJobBatchResult]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[ReliabilityAssetClassDefinitionParserJobBatchResult]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[ReliabilityAssetClassDefinitionParserJobBatchResult]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, ReliabilityAssetClassDefinitionParserJobBatchResult]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, ReliabilityAssetClassDefinitionParserJobBatchResult]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[ReliabilityAssetClassDefinitionParserJobBatchResult]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[ReliabilityAssetClassDefinitionParserJobBatchResult]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> ReliabilityAssetClassDefinitionParserJobBatchResult:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> ReliabilityAssetClassDefinitionParserJobBatchResult:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> ReliabilityAssetClassDefinitionParserJobBatchResult:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> ReliabilityAssetClassDefinitionParserJobBatchResult:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> ReliabilityAssetClassDefinitionParserJobBatchResult:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> ReliabilityAssetClassDefinitionParserJobBatchResult:
    """
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[ReliabilityAssetClassDefinitionParserJobBatchResult]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> ReliabilityAssetClassDefinitionParserJobBatchResult:
    """
    ...
    """
        ...
    def afterMake(self) -> ReliabilityAssetClassDefinitionParserJobBatchResult:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> ReliabilityAssetClassDefinitionParserJobBatchResult:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[ReliabilityAssetClassDefinitionParserJobBatchResult]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> ReliabilityAssetClassDefinitionParserJobBatchResult:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, spec: FetchSpec=None) -> FetchResult[ReliabilityAssetClassDefinitionParserJobBatchResult]:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, filter: Filter) -> FetchResult[ReliabilityAssetClassDefinitionParserJobBatchResult]:
    """
    ...
    """
        ...
    @classmethod
    def fetchObjStream(cls, spec: FetchStreamSpec=None) -> Union[Stream[ReliabilityAssetClassDefinitionParserJobBatchResult]]:
    """
    Fetches multiple obj instances based on a specification.  Only objs that the caller is authorized to fetch will be
    returned.
    ...
    """
        ...
    @classmethod
    def fetchMultiLocale(cls, spec: MultiLocaleFetchSpec=None) -> Union[Map[str, FetchResult[ReliabilityAssetClassDefinitionParserJobBatchResult]]]:
    """
    ...
    """
        ...
    def get(self, include: str=None) -> Union[ReliabilityAssetClassDefinitionParserJobBatchResult]:
    """
    ...
    """
        ...
    def getSpecific(self, include: str=None) -> Union[ReliabilityAssetClassDefinitionParserJobBatchResult]:
    """
    ...
    """
        ...
    def getMissing(self, spec: GetMissingSpec) -> ReliabilityAssetClassDefinitionParserJobBatchResult:
    """
    ...
    """
        ...
    def getDirect(self, include: str=None) -> Union[ReliabilityAssetClassDefinitionParserJobBatchResult]:
    """
    ...
    """
        ...
    def applyReverseEdit(self, versionEdit: VersionEdit) -> ReliabilityAssetClassDefinitionParserJobBatchResult:
    """
    ...
    """
        ...
    @classmethod
    def fromString(cls, s: str) -> Union[ReliabilityAssetClassDefinitionParserJobBatchResult]:
    """
    ...
    """
        ...
    def create(self, spec: UpsertSpec=None) -> Union[ReliabilityAssetClassDefinitionParserJobBatchResult]:
    """
    ...
    """
        ...
    @classmethod
    def createBatch(cls, objs: Array[ReliabilityAssetClassDefinitionParserJobBatchResult], spec: UpsertSpec=None) -> Union[ObjList[ReliabilityAssetClassDefinitionParserJobBatchResult]]:
    """
    ...
    """
        ...
    @classmethod
    def createBatchObjStream(cls, objs: Stream[ReliabilityAssetClassDefinitionParserJobBatchResult], spec: CreateBatchObjStreamSpec=None) -> Union[ObjList[ReliabilityAssetClassDefinitionParserJobBatchResult]]:
    """
    Creates multiple instances of a C3 type. If the operation fails and {@link UpsertSpec#dontThrowOnBatchError} is not
    specified (the default), then a C3BatchException will be thrown.  Otherwise {@link errors will be reported in the
    returned {@link ObjList}.  This will fail if any of the instances already exist.
    ...
    """
        ...
    def update(self, srcObj: ReliabilityAssetClassDefinitionParserJobBatchResult=None, spec: UpsertSpec=None) -> Union[ReliabilityAssetClassDefinitionParserJobBatchResult]:
    """
    ...
    """
        ...
    def upsert(self, srcObj: ReliabilityAssetClassDefinitionParserJobBatchResult=None, spec: UpsertSpec=None) -> Union[ReliabilityAssetClassDefinitionParserJobBatchResult]:
    """
    ...
    """
        ...
    @overload
    def merge(self, spec: MergeSpec=None) -> Union[ReliabilityAssetClassDefinitionParserJobBatchResult]:
    """
    ...
    """
        ...
    @overload
    def merge(self, mergeInclude: str, spec: MergeSpec=None) -> Union[ReliabilityAssetClassDefinitionParserJobBatchResult]:
    """
    ...
    """
        ...
    def touch(self, spec: TouchSpec=None) -> Union[ReliabilityAssetClassDefinitionParserJobBatchResult]:
    """
    ...
    """
        ...
    @classmethod
    def updateBatch(cls, objs: Array[ReliabilityAssetClassDefinitionParserJobBatchResult], srcObjs: Array[ReliabilityAssetClassDefinitionParserJobBatchResult]=None, spec: UpsertSpec=None) -> Union[ObjList[ReliabilityAssetClassDefinitionParserJobBatchResult]]:
    """
    ...
    """
        ...
    @classmethod
    def updateObjs(cls, objs: Callable[[], Union[Array[ReliabilityAssetClassDefinitionParserJobBatchResult]]], spec: UpsertSpec=None) -> Union[ObjList[ReliabilityAssetClassDefinitionParserJobBatchResult]]:
    """
    ...
    """
        ...
    @classmethod
    def upsertBatch(cls, objs: Array[ReliabilityAssetClassDefinitionParserJobBatchResult], srcObjs: Array[ReliabilityAssetClassDefinitionParserJobBatchResult]=None, spec: UpsertSpec=None) -> Union[ObjList[ReliabilityAssetClassDefinitionParserJobBatchResult]]:
    """
    ...
    """
        ...
    @classmethod
    def upsertObjs(cls, objs: Callable[[], Union[Array[ReliabilityAssetClassDefinitionParserJobBatchResult]]], spec: UpsertSpec=None) -> Union[ObjList[ReliabilityAssetClassDefinitionParserJobBatchResult]]:
    """
    Creates instances of a C3 type if they don't already exist and updates them if they do exist. If the operation
    ...
    """
        ...
    @classmethod
    def touchBatch(cls, objs: Array[ReliabilityAssetClassDefinitionParserJobBatchResult], spec: TouchSpec=None) -> Union[ObjList[ReliabilityAssetClassDefinitionParserJobBatchResult]]:
    """
    ...
    @overload
    @classmethod
    def mergeBatch(cls, objs: Array[ReliabilityAssetClassDefinitionParserJobBatchResult], spec: MergeSpec=None) -> Union[ObjList[ReliabilityAssetClassDefinitionParserJobBatchResult]]:
    """
    ...
    @overload
    @classmethod
    def mergeBatch(cls, objs: Array[ReliabilityAssetClassDefinitionParserJobBatchResult], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[ReliabilityAssetClassDefinitionParserJobBatchResult]]:
    """
    Merges multiple instances of a C3 type or creates them if they don't exist. If the operation fails and {@link
    UpsertSpec#dontThrowOnBatchError} is not specified (the default), then a C3BatchException will be thrown.
    Otherwise errors will be reported in the returned {@link ObjList}.  The merge operation is described in the {@link
    ...
    """
        ...
    @classmethod
    def mergeObjs(cls, objs: Callable[[], Union[Array[ReliabilityAssetClassDefinitionParserJobBatchResult]]], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[ReliabilityAssetClassDefinitionParserJobBatchResult]]:
    """
    ...
    @overload
    @classmethod
    def mergeAll(cls, mergeObj: ReliabilityAssetClassDefinitionParserJobBatchResult, spec: MergeAllSpec=None) -> Union[int]:
    """
    ...
    @overload
    @classmethod
    def mergeAll(cls, mergeObj: ReliabilityAssetClassDefinitionParserJobBatchResult, mergeInclude: str, spec: MergeAllSpec=None) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def removeBatch(cls, objs: Array[ReliabilityAssetClassDefinitionParserJobBatchResult], spec: UpsertSpec=None) -> Union[ObjList[ReliabilityAssetClassDefinitionParserJobBatchResult]]:
    """
    ...
    """
        ...
    @classmethod
    def replace(cls, objs: Array[ReliabilityAssetClassDefinitionParserJobBatchResult], spec: UpsertSpec=None) -> Union[ObjList[ReliabilityAssetClassDefinitionParserJobBatchResult]]:
    """
    ...
    """
        ...
    def unremove(self) -> Union[ReliabilityAssetClassDefinitionParserJobBatchResult]:
    """
    ...
    """
        ...
    @classmethod
    def beforeCreate(cls, objs: Array[ReliabilityAssetClassDefinitionParserJobBatchResult]) -> ObjList[ReliabilityAssetClassDefinitionParserJobBatchResult]:
    """
    ...
    """
        ...
    @classmethod
    def beforeUpdate(cls, objs: Array[ReliabilityAssetClassDefinitionParserJobBatchResult]) -> ObjList[ReliabilityAssetClassDefinitionParserJobBatchResult]:
    """
    ...
    """
        ...
    @classmethod
    def beforeRemove(cls, objs: Array[ReliabilityAssetClassDefinitionParserJobBatchResult]) -> ObjList[ReliabilityAssetClassDefinitionParserJobBatchResult]:
    """
    ...
    """
        ...
    @classmethod
    def afterCreate(cls, objs: Array[ReliabilityAssetClassDefinitionParserJobBatchResult]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def afterUpdate(cls, objs: Array[ReliabilityAssetClassDefinitionParserJobBatchResult]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def afterRemove(cls, objs: Array[ReliabilityAssetClassDefinitionParserJobBatchResult]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def startImportData(cls, spec: StartImportDataSpec=None) -> PushStream[ReliabilityAssetClassDefinitionParserJobBatchResult]:
    """
    @return a push stream to import instances of this type.
    """
        ...
    @classmethod
    def startImportDataWithStats(cls, spec: StartImportDataSpec=None) -> PushStreamWithStats[ReliabilityAssetClassDefinitionParserJobBatchResult]:
    """
    @return a push stream to import instances of this type.
    """
        ...
    ...
    """
        ...
    @classmethod
    def forId(cls, id: str, failIfMissing: bool=None) -> Union[ReliabilityAssetClassDefinitionParserJobBatchResult]:
    """
    ...
    """
        ...
    def withoutIdentity(self) -> Union[ReliabilityAssetClassDefinitionParserJobBatchResult]:
    """
    ...
    """
        ...
    @classmethod
    def typeOfBatch(cls, objs: Array[ReliabilityAssetClassDefinitionParserJobBatchResult]) -> Union[Array[EntityType]]:
    """
    ...
    """
        ...
    @classmethod
    def dbEcho(cls, template: ReliabilityAssetClassDefinitionParserJobBatchResult=None, count: int=None, sendBack: bool=None) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def callbackLogic(cls, objs: Array[ReliabilityAssetClassDefinitionParserJobBatchResult], callback: Callable[[Union[ReliabilityAssetClassDefinitionParserJobBatchResult]], Union[ReliabilityAssetClassDefinitionParserJobBatchResult]]=None) -> ObjList[ReliabilityAssetClassDefinitionParserJobBatchResult]:
    """
    ...
    """
        ...
    @classmethod
    def afterCallbackLogic(cls, objs: Array[ReliabilityAssetClassDefinitionParserJobBatchResult], callback: Callable[[Union[ReliabilityAssetClassDefinitionParserJobBatchResult]], Union[ReliabilityAssetClassDefinitionParserJobBatchResult]]=None) -> Union[Array[ObjError]]:
    """
