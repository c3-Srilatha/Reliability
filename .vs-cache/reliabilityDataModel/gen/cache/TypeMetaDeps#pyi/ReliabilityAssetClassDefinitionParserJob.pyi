...
from c3.platform.SetBuilder import SetBuilder
from c3.reliabilityDataModel.ReliabilityAssetClassDefinitionParserJobBatchResult import ReliabilityAssetClassDefinitionParserJobBatchResult
...
from c3.reliabilityDataModel.ReliabilityAssetClassDefinitionParserJobOptions import ReliabilityAssetClassDefinitionParserJobOptions
...
from c3.reliabilityDataModel.ReliabilityAssetClassDefinitionParser import ReliabilityAssetClassDefinitionParser
...
# Python definitions for the C3 type ReliabilityAssetClassDefinitionParserJob


class ReliabilityAssetClassDefinitionParserJob(BatchJob[ReliabilityAssetClassDefinitionParser, ReliabilityAssetClassDefinitionParserJobOptions, ReliabilityAssetClassDefinitionVersion], Singleton):
    """
    Given {@link ReliabilityAssetClassDefinitionParserJobOptions}, this job will parse multiple {@link ReliabilityAssetClassDefinitionVersion}s
    and create {@link AssetClass}es from them.
    
    @remarks this represents a made instance of ReliabilityAssetClassDefinitionParserJob
    """
    ...
    results: Optional[Array[ReliabilityAssetClassDefinitionParserJobBatchResult]]=None
    """
    The results generated by each call of {@link #processBatch}.
    """
    def __init__(self, run: Optional[BatchJobRun]=None, runs: Optional[Array[BatchJobRun]]=None, options: Optional[Obj]=None, onCompleteCallback: Optional[JobBase.Callback]=None, priority: Optional[int]=None, disabled: Optional[bool]=None, maxConcurrency: Optional[int]=None, maxConcurrencyPerNode: Optional[int]=None, runAsUser: Optional[bool]=None, nodePool: Optional[str]=None, skipIfRunning: Optional[bool]=None, numAutoRecoveryAttempts: Optional[int]=None, propagateActionContext: Optional[bool]=None, typeIdent: Optional[str]=None, id: Optional[str]=None, versionEdits: Optional[Array[VersionEdit]]=None, name: Optional[str]=None, meta: Optional[Meta]=None, version: Optional[int]=None, typeWithBindings: Optional[Type]=None, abortOnError: Optional[bool]=None, results: Optional[Array[ReliabilityAssetClassDefinitionParserJobBatchResult]]=None) -> None: ...

    @classmethod
    def inst(cls) -> ReliabilityAssetClassDefinitionParserJob:
    """
    @return the one and only instance to be used when member functions are called on this type.
    """
        ...
    @classmethod
    def cachedInst(cls) -> Union[ReliabilityAssetClassDefinitionParserJob]:
    """
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[ReliabilityAssetClassDefinitionParserJob]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[ReliabilityAssetClassDefinitionParserJob]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[ReliabilityAssetClassDefinitionParserJob]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[ReliabilityAssetClassDefinitionParserJob]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> ReliabilityAssetClassDefinitionParserJob:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> ReliabilityAssetClassDefinitionParserJob:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> ReliabilityAssetClassDefinitionParserJob:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[ReliabilityAssetClassDefinitionParserJob]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[ReliabilityAssetClassDefinitionParserJob]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> ReliabilityAssetClassDefinitionParserJob:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> ReliabilityAssetClassDefinitionParserJob:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> ReliabilityAssetClassDefinitionParserJob:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> ReliabilityAssetClassDefinitionParserJob:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> ReliabilityAssetClassDefinitionParserJob:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> ReliabilityAssetClassDefinitionParserJob:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> ReliabilityAssetClassDefinitionParserJob:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> ReliabilityAssetClassDefinitionParserJob:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> ReliabilityAssetClassDefinitionParserJob:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> ReliabilityAssetClassDefinitionParserJob:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> ReliabilityAssetClassDefinitionParserJob:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> ReliabilityAssetClassDefinitionParserJob:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> ReliabilityAssetClassDefinitionParserJob:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> ReliabilityAssetClassDefinitionParserJob:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> ReliabilityAssetClassDefinitionParserJob:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> ReliabilityAssetClassDefinitionParserJob:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> ReliabilityAssetClassDefinitionParserJob:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> ReliabilityAssetClassDefinitionParserJob:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> ReliabilityAssetClassDefinitionParserJob:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> ReliabilityAssetClassDefinitionParserJob:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> ReliabilityAssetClassDefinitionParserJob:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> ReliabilityAssetClassDefinitionParserJob:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> ReliabilityAssetClassDefinitionParserJob:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> ReliabilityAssetClassDefinitionParserJob:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> ReliabilityAssetClassDefinitionParserJob:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> ReliabilityAssetClassDefinitionParserJob:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> ReliabilityAssetClassDefinitionParserJob:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> ReliabilityAssetClassDefinitionParserJob:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[ReliabilityAssetClassDefinitionParserJob]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[ReliabilityAssetClassDefinitionParserJob]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[ReliabilityAssetClassDefinitionParserJob]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[ReliabilityAssetClassDefinitionParserJob]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[ReliabilityAssetClassDefinitionParserJob]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, ReliabilityAssetClassDefinitionParserJob]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, ReliabilityAssetClassDefinitionParserJob]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[ReliabilityAssetClassDefinitionParserJob]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[ReliabilityAssetClassDefinitionParserJob]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> ReliabilityAssetClassDefinitionParserJob:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> ReliabilityAssetClassDefinitionParserJob:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> ReliabilityAssetClassDefinitionParserJob:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> ReliabilityAssetClassDefinitionParserJob:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> ReliabilityAssetClassDefinitionParserJob:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> ReliabilityAssetClassDefinitionParserJob:
    """
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[ReliabilityAssetClassDefinitionParserJob]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> ReliabilityAssetClassDefinitionParserJob:
    """
    ...
    """
        ...
    def afterMake(self) -> ReliabilityAssetClassDefinitionParserJob:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> ReliabilityAssetClassDefinitionParserJob:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[ReliabilityAssetClassDefinitionParserJob]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> ReliabilityAssetClassDefinitionParserJob:
    """
    ...
    """
        ...
    def start(self, options: ReliabilityAssetClassDefinitionParserJobOptions=None) -> Union[BatchJobStatus]:
    """
    ...
    def setMaxConcurrencyPerNode(self, maxConcurrencyPerNode: int=None) -> None:
        ...
    def cleanup(self, options: ReliabilityAssetClassDefinitionParserJobOptions=None) -> None:
    """
    ...
    """
        ...
    def cancelJob(self, removeResults: bool=None, force: bool=None) -> Union[JobBase[BatchJobRun, BatchJobStatus, ReliabilityAssetClassDefinitionParserJobOptions]]:
        ...
    def failJob(self, run: JobRun[BatchJobStatusBase]) -> Union[JobBase[BatchJobRun, BatchJobStatus, ReliabilityAssetClassDefinitionParserJobOptions]]:
        ...
    @classmethod
    ...
    def hasErrors(self) -> bool:
        ...
    def validateStart(self, options: ReliabilityAssetClassDefinitionParserJobOptions=None) -> None:
        ...
    ...
    @overload
    @classmethod
    def fetch(cls, spec: FetchSpec=None) -> FetchResult[ReliabilityAssetClassDefinitionParserJob]:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, filter: Filter) -> FetchResult[ReliabilityAssetClassDefinitionParserJob]:
    """
    ...
    """
        ...
    @classmethod
    def fetchObjStream(cls, spec: FetchStreamSpec=None) -> Union[Stream[ReliabilityAssetClassDefinitionParserJob]]:
    """
    Fetches multiple obj instances based on a specification.  Only objs that the caller is authorized to fetch will be
    returned.
    ...
    """
        ...
    @classmethod
    def fetchMultiLocale(cls, spec: MultiLocaleFetchSpec=None) -> Union[Map[str, FetchResult[ReliabilityAssetClassDefinitionParserJob]]]:
    """
    ...
    """
        ...
    def get(self, include: str=None) -> Union[ReliabilityAssetClassDefinitionParserJob]:
    """
    ...
    """
        ...
    def getSpecific(self, include: str=None) -> Union[ReliabilityAssetClassDefinitionParserJob]:
    """
    ...
    """
        ...
    def getMissing(self, spec: GetMissingSpec) -> ReliabilityAssetClassDefinitionParserJob:
    """
    ...
    """
        ...
    def getDirect(self, include: str=None) -> Union[ReliabilityAssetClassDefinitionParserJob]:
    """
    ...
    """
        ...
    def applyReverseEdit(self, versionEdit: VersionEdit) -> ReliabilityAssetClassDefinitionParserJob:
    """
    ...
    """
        ...
    @classmethod
    def fromString(cls, s: str) -> Union[ReliabilityAssetClassDefinitionParserJob]:
    """
    ...
    """
        ...
    def create(self, spec: UpsertSpec=None) -> Union[ReliabilityAssetClassDefinitionParserJob]:
    """
    ...
    """
        ...
    @classmethod
    def createBatch(cls, objs: Array[ReliabilityAssetClassDefinitionParserJob], spec: UpsertSpec=None) -> Union[ObjList[ReliabilityAssetClassDefinitionParserJob]]:
    """
    ...
    """
        ...
    @classmethod
    def createBatchObjStream(cls, objs: Stream[ReliabilityAssetClassDefinitionParserJob], spec: CreateBatchObjStreamSpec=None) -> Union[ObjList[ReliabilityAssetClassDefinitionParserJob]]:
    """
    Creates multiple instances of a C3 type. If the operation fails and {@link UpsertSpec#dontThrowOnBatchError} is not
    specified (the default), then a C3BatchException will be thrown.  Otherwise {@link errors will be reported in the
    returned {@link ObjList}.  This will fail if any of the instances already exist.
    ...
    """
        ...
    def update(self, srcObj: ReliabilityAssetClassDefinitionParserJob=None, spec: UpsertSpec=None) -> Union[ReliabilityAssetClassDefinitionParserJob]:
    """
    ...
    """
        ...
    def upsert(self, srcObj: ReliabilityAssetClassDefinitionParserJob=None, spec: UpsertSpec=None) -> Union[ReliabilityAssetClassDefinitionParserJob]:
    """
    ...
    """
        ...
    @overload
    def merge(self, spec: MergeSpec=None) -> Union[ReliabilityAssetClassDefinitionParserJob]:
    """
    ...
    """
        ...
    @overload
    def merge(self, mergeInclude: str, spec: MergeSpec=None) -> Union[ReliabilityAssetClassDefinitionParserJob]:
    """
    ...
    """
        ...
    def touch(self, spec: TouchSpec=None) -> Union[ReliabilityAssetClassDefinitionParserJob]:
    """
    ...
    """
        ...
    @classmethod
    def updateBatch(cls, objs: Array[ReliabilityAssetClassDefinitionParserJob], srcObjs: Array[ReliabilityAssetClassDefinitionParserJob]=None, spec: UpsertSpec=None) -> Union[ObjList[ReliabilityAssetClassDefinitionParserJob]]:
    """
    ...
    """
        ...
    @classmethod
    def updateObjs(cls, objs: Callable[[], Union[Array[ReliabilityAssetClassDefinitionParserJob]]], spec: UpsertSpec=None) -> Union[ObjList[ReliabilityAssetClassDefinitionParserJob]]:
    """
    ...
    """
        ...
    @classmethod
    def upsertBatch(cls, objs: Array[ReliabilityAssetClassDefinitionParserJob], srcObjs: Array[ReliabilityAssetClassDefinitionParserJob]=None, spec: UpsertSpec=None) -> Union[ObjList[ReliabilityAssetClassDefinitionParserJob]]:
    """
    ...
    """
        ...
    @classmethod
    def upsertObjs(cls, objs: Callable[[], Union[Array[ReliabilityAssetClassDefinitionParserJob]]], spec: UpsertSpec=None) -> Union[ObjList[ReliabilityAssetClassDefinitionParserJob]]:
    """
    Creates instances of a C3 type if they don't already exist and updates them if they do exist. If the operation
    ...
    """
        ...
    @classmethod
    def touchBatch(cls, objs: Array[ReliabilityAssetClassDefinitionParserJob], spec: TouchSpec=None) -> Union[ObjList[ReliabilityAssetClassDefinitionParserJob]]:
    """
    ...
    @overload
    @classmethod
    def mergeBatch(cls, objs: Array[ReliabilityAssetClassDefinitionParserJob], spec: MergeSpec=None) -> Union[ObjList[ReliabilityAssetClassDefinitionParserJob]]:
    """
    ...
    @overload
    @classmethod
    def mergeBatch(cls, objs: Array[ReliabilityAssetClassDefinitionParserJob], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[ReliabilityAssetClassDefinitionParserJob]]:
    """
    Merges multiple instances of a C3 type or creates them if they don't exist. If the operation fails and {@link
    UpsertSpec#dontThrowOnBatchError} is not specified (the default), then a C3BatchException will be thrown.
    Otherwise errors will be reported in the returned {@link ObjList}.  The merge operation is described in the {@link
    ...
    """
        ...
    @classmethod
    def mergeObjs(cls, objs: Callable[[], Union[Array[ReliabilityAssetClassDefinitionParserJob]]], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[ReliabilityAssetClassDefinitionParserJob]]:
    """
    ...
    @overload
    @classmethod
    def mergeAll(cls, mergeObj: ReliabilityAssetClassDefinitionParserJob, spec: MergeAllSpec=None) -> Union[int]:
    """
    ...
    @overload
    @classmethod
    def mergeAll(cls, mergeObj: ReliabilityAssetClassDefinitionParserJob, mergeInclude: str, spec: MergeAllSpec=None) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def removeBatch(cls, objs: Array[ReliabilityAssetClassDefinitionParserJob], spec: UpsertSpec=None) -> Union[ObjList[ReliabilityAssetClassDefinitionParserJob]]:
    """
    ...
    """
        ...
    @classmethod
    def replace(cls, objs: Array[ReliabilityAssetClassDefinitionParserJob], spec: UpsertSpec=None) -> Union[ObjList[ReliabilityAssetClassDefinitionParserJob]]:
    """
    ...
    """
        ...
    def unremove(self) -> Union[ReliabilityAssetClassDefinitionParserJob]:
    """
    ...
    """
        ...
    @classmethod
    def beforeCreate(cls, objs: Array[ReliabilityAssetClassDefinitionParserJob]) -> ObjList[ReliabilityAssetClassDefinitionParserJob]:
    """
    ...
    """
        ...
    @classmethod
    def beforeUpdate(cls, objs: Array[ReliabilityAssetClassDefinitionParserJob]) -> ObjList[ReliabilityAssetClassDefinitionParserJob]:
    """
    ...
    """
        ...
    @classmethod
    def beforeRemove(cls, objs: Array[ReliabilityAssetClassDefinitionParserJob]) -> ObjList[ReliabilityAssetClassDefinitionParserJob]:
    """
    ...
    """
        ...
    @classmethod
    def afterCreate(cls, objs: Array[ReliabilityAssetClassDefinitionParserJob]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def afterUpdate(cls, objs: Array[ReliabilityAssetClassDefinitionParserJob]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def afterRemove(cls, objs: Array[ReliabilityAssetClassDefinitionParserJob]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def startImportData(cls, spec: StartImportDataSpec=None) -> PushStream[ReliabilityAssetClassDefinitionParserJob]:
    """
    @return a push stream to import instances of this type.
    """
        ...
    @classmethod
    def startImportDataWithStats(cls, spec: StartImportDataSpec=None) -> PushStreamWithStats[ReliabilityAssetClassDefinitionParserJob]:
    """
    @return a push stream to import instances of this type.
    """
        ...
    ...
    """
        ...
    @classmethod
    def forId(cls, id: str, failIfMissing: bool=None) -> Union[ReliabilityAssetClassDefinitionParserJob]:
    """
    ...
    """
        ...
    def withoutIdentity(self) -> Union[ReliabilityAssetClassDefinitionParserJob]:
    """
    ...
    """
        ...
    @classmethod
    def typeOfBatch(cls, objs: Array[ReliabilityAssetClassDefinitionParserJob]) -> Union[Array[EntityType]]:
    """
    ...
    """
        ...
    @classmethod
    def dbEcho(cls, template: ReliabilityAssetClassDefinitionParserJob=None, count: int=None, sendBack: bool=None) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def callbackLogic(cls, objs: Array[ReliabilityAssetClassDefinitionParserJob], callback: Callable[[Union[ReliabilityAssetClassDefinitionParserJob]], Union[ReliabilityAssetClassDefinitionParserJob]]=None) -> ObjList[ReliabilityAssetClassDefinitionParserJob]:
    """
    ...
    """
        ...
    @classmethod
    def afterCallbackLogic(cls, objs: Array[ReliabilityAssetClassDefinitionParserJob], callback: Callable[[Union[ReliabilityAssetClassDefinitionParserJob]], Union[ReliabilityAssetClassDefinitionParserJob]]=None) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def doStart(cls, job: ReliabilityAssetClassDefinitionParser=None, options: ReliabilityAssetClassDefinitionParserJobOptions=None) -> None:
    """
    ...
    """
        ...
    @classmethod
    def processBatch(cls, batch: ReliabilityAssetClassDefinitionVersion=None, job: ReliabilityAssetClassDefinitionParser=None, options: ReliabilityAssetClassDefinitionParserJobOptions=None) -> None:
    """
    ...
    """
        ...
    @classmethod
    def allComplete(cls, job: ReliabilityAssetClassDefinitionParser, options: ReliabilityAssetClassDefinitionParserJobOptions=None) -> Union[str]:
    """
    ...
    """
        ...
    @classmethod
    def failed(cls, job: ReliabilityAssetClassDefinitionParser, status: BatchJobStatus, options: ReliabilityAssetClassDefinitionParserJobOptions=None) -> None:
    """
    ...
    """
        ...
    def scheduleBatch(self, batch: ReliabilityAssetClassDefinitionVersion=None) -> None:
    """
    ...
    """
        ...
    def scheduleBatches(self, batches: Array[ReliabilityAssetClassDefinitionVersion]=None) -> None:
    """
    ...
    """
        ...
    @classmethod
    def scheduleObjBatch(cls, job: ReliabilityAssetClassDefinitionParser=None, objBatch: ObjBatch=None, logPrefix: str=None) -> Union[int]:
    """
    ...
    def dispatchProcessBatch(cls, jobId: str=None, context: str=None) -> None:
        ...
    def getSuccessResults(self, trackingId: str) -> Union[Array[ReliabilityAssetClassDefinitionParserJobBatchResult]]:
    """
    Gets all the successful {@link #results} with a given trackingId.
    
    @param trackingId
           The tracking ID to filter results by.
    @return List of successful batch results.
    """
        ...
    def getFailResults(self, trackingId: str) -> Union[Array[ReliabilityAssetClassDefinitionParserJobBatchResult]]:
    """
    Gets all the failed {@link #results} with a given trackingId.
    
    @param trackingId
           The tracking ID to filter results by.
    @return List of failed batch results.
    """
        ...
    @classmethod
    def cleanupResults(cls, trackingId: str) -> None:
    """
    Removes all the {@link #results} with a given trackingId.
    
    @param trackingId
           The tracking ID of the results to remove.
    """
        ...
