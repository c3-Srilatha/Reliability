...
class FailureModePriority(ExemptFromFacilityFilter):
    """
    ...
    """
    def __init__(self, id: Optional[str]=None, versionEdits: Optional[Array[VersionEdit]]=None, name: Optional[str]=None, meta: Optional[Meta]=None, version: Optional[int]=None, typeWithBindings: Optional[Type]=None, rank: Optional[int]=None, translatedName: Optional[str]=None) -> None: ...
