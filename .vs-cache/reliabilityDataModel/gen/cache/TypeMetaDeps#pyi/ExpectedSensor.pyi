...
class ExpectedSensor(AssetOnboardingMeta, ExemptFromFacilityFilter):
    """
    ...
    """
    def __init__(self, assetOnboardingSourceFile: Optional[AssetOnboardingSourceFile]=None, configurationLastUpdated: Optional[datetime]=None, id: Optional[str]=None, versionEdits: Optional[Array[VersionEdit]]=None, name: Optional[str]=None, meta: Optional[Meta]=None, version: Optional[int]=None, typeWithBindings: Optional[Type]=None, failureModeLineItems: Optional[Array[FailureModeLineItem]]=None, failureModeLibraries: Optional[Array[FailureModeLibrary]]=None, unit: Optional[Unit]=None, unitType: Optional[str]=None, isMinRequired: Optional[bool]=None, sensorPositiveAnomalyWeight: Optional[float]=None, sensorNegativeAnomalyWeight: Optional[float]=None, sensorType: Optional[str]=None, displayName: Optional[str]=None, sensorDataType: Optional[str]=None, assetSensorRelations: Optional[Array[ReliabilityAssetSensorRelation]]=None) -> None: ...
