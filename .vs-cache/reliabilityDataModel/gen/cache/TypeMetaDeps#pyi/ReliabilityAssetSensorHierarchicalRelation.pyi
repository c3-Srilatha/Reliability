...
class ReliabilityAssetSensorHierarchicalRelation(PhysicalAssetHierarchyRelation):
    """
    ...
    """
    def __init__(self, id: Optional[str]=None, from: Optional[ReliabilityAsset]=None, to: Optional[Sensor]=None, relationship: Optional[str]=None, fromInfo: Optional[str]=None, toInfo: Optional[str]=None, involvement: Optional[float]=None, start: Optional[datetime]=None, end: Optional[datetime]=None, typeIdent: Optional[str]=None, versionEdits: Optional[Array[VersionEdit]]=None, name: Optional[str]=None, meta: Optional[Meta]=None, version: Optional[int]=None, typeWithBindings: Optional[Type]=None) -> None: ...
