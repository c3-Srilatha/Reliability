...
from c3.platform.Pandas.DataFrame import Pandas.DataFrame
...
from c3.reliabilityDataModel.UpdateStartEndDatesForRelationTypesSpec import UpdateStartEndDatesForRelationTypesSpec
...
# Python definitions for the C3 type ReliabilityExcelParser


class ReliabilityExcelParser():
    """
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[ReliabilityExcelParser]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[ReliabilityExcelParser]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[ReliabilityExcelParser]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[ReliabilityExcelParser]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> ReliabilityExcelParser:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> ReliabilityExcelParser:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> ReliabilityExcelParser:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[ReliabilityExcelParser]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[ReliabilityExcelParser]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> ReliabilityExcelParser:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> ReliabilityExcelParser:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> ReliabilityExcelParser:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> ReliabilityExcelParser:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> ReliabilityExcelParser:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> ReliabilityExcelParser:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> ReliabilityExcelParser:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> ReliabilityExcelParser:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> ReliabilityExcelParser:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> ReliabilityExcelParser:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> ReliabilityExcelParser:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> ReliabilityExcelParser:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> ReliabilityExcelParser:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> ReliabilityExcelParser:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> ReliabilityExcelParser:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> ReliabilityExcelParser:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> ReliabilityExcelParser:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> ReliabilityExcelParser:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> ReliabilityExcelParser:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> ReliabilityExcelParser:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> ReliabilityExcelParser:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> ReliabilityExcelParser:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> ReliabilityExcelParser:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> ReliabilityExcelParser:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> ReliabilityExcelParser:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> ReliabilityExcelParser:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> ReliabilityExcelParser:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> ReliabilityExcelParser:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[ReliabilityExcelParser]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[ReliabilityExcelParser]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[ReliabilityExcelParser]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[ReliabilityExcelParser]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[ReliabilityExcelParser]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, ReliabilityExcelParser]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, ReliabilityExcelParser]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[ReliabilityExcelParser]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[ReliabilityExcelParser]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> ReliabilityExcelParser:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> ReliabilityExcelParser:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> ReliabilityExcelParser:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> ReliabilityExcelParser:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> ReliabilityExcelParser:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> ReliabilityExcelParser:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> ReliabilityExcelParser:
    """
    ...
    """
        ...
    def afterMake(self) -> ReliabilityExcelParser:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> ReliabilityExcelParser:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[ReliabilityExcelParser]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> ReliabilityExcelParser:
    """
    ...
    """
        ...
    @classmethod
    def loadTemplateData(cls, systemName: str, packageName: str=None, useTestResources: bool=None, endExistingRelations: bool=None, templateDir: str='\'\'', sourceFileMeta: AssetOnboardingSourceFile=None) -> None:
    """
    ...
    """
        ...
    @classmethod
    def updateStartEndDatesForRelationTypes(cls, newObjects: Array[any]=None, existingObjects: Stream[Obj]=None, now: datetime=None, endExistingRelations: bool=None, isTreeStructure: bool=None) -> Union[Array[any]]:
    """
    ...
    """
        ...
    @classmethod
    def updateStartEndDatesForRelationTypesWithSpec(cls, spec: UpdateStartEndDatesForRelationTypesSpec=None) -> Union[Array[any]]:
    """
    Updates `start` and `end` field values on relation objects from `newObjects` and `existingObjects` arrays.
    ...
    """
        ...
    @classmethod
    def preprocessExcelTemplateFile(cls, inputPath: str, outputPath: str) -> str:
    """
    ...
    """
        ...
    @classmethod
    def loadExcelTemplate(cls, inputPath: str, outputPath: str, endExistingRelations: bool=None) -> LoadExcelTemplateResult:
    """
    *Seamlessly* load asset hierarchy template data from a formatted Excel file.
    ...
    """
        ...
    @classmethod
    def readAssetHierarchyExcelSpreadsheetInline(cls, inputPath: str) -> Union[Any]:
    """
    ...
    """
        ...
    @classmethod
    def readAssetHierarchyExcelSpreadsheetGeneric(cls, inputPath: str=None, file: File=None) -> Union[Any]:
    """
    ...
    """
        ...
    @classmethod
    def readAssetHierarchyExcelSpreadsheet(cls, inputPath: str) -> Union[Map[str, Data]]:
    """
    ...
    """
        ...
    @classmethod
    def writeAssetHierarchyExcelSpreadsheetInline(cls, data: Array[Any], sheetNames: Array[str], outputPath: str) -> Union[File]:
    """
    ...
    """
        ...
    @classmethod
    def writeAssetHierarchyExcelSpreadsheet(cls, data: Array[Data], sheetNames: Array[str], outputPath: str) -> Union[File]:
    """
    Function that writes the asset hierarchy excel spreadsheet from the given data.
    ...
    """
        ...
    @classmethod
    def readCsv(cls, pkg: str, isTest: bool, typeName: str, path: str, continueOnErr: bool=None, isMetaData: bool=None) -> Union[Stream[Obj]]:
    """
    ...
    """
        ...
    @classmethod
    def countOfNewAndEditedAssets(cls, templateDir: str) -> LoadExcelTemplateResult:
    """
    @param templateDir
    ...
    """
        ...
    @classmethod
    def overrideEntityAssets(cls, asset_hierarchy_sheet: Pandas.DataFrame=None, entity_collections: Any=None, asset_levels: Array[str]=None, customer_asset_levels: Array[str]=None, root_asset_id_column: str=None, format_asset_id: FunctionType=None, format_id: FunctionType=None, row_is_valid: FunctionType=None) -> None:
    """
