...
var filename = 'test_COMP_LP_ROTOR_COMPEND_VIB_X';
...
describe(filename, function () {
  beforeAll(function () {
    ...
    this.expectedSensorName = 'COMP_LP_ROTOR_COMPEND_VIB_X';
    this.expectedUnit = 'mm';
    this.customerUnit = 'meter';
  ...
  it('correct evalMetric for COMP_LP_ROTOR_COMPEND_VIB_X', function () {
    ...
    expect(result.data()).toEqual([1000]);
