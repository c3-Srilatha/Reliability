...
var filename = 'test_HP_COMPRESSOR_INLET_P25_PRESS';
...
describe(filename, function () {
  beforeAll(function () {
    ...
    this.expectedSensorName = 'HP_COMPRESSOR_INLET_P25_PRESS';
    this.expectedUnit = 'psia';
    this.customerUnit = 'bar';
  ...
  it('correct evalMetric for HP_COMPRESSOR_INLET_P25_PRESS', function () {
    ...
    expect(result.data()[0]).toBeCloseTo(14.5038);
