...
var filename = 'test_INLET_FILTER_DIFF_PRESS';
...
describe(filename, function () {
  beforeAll(function () {
    ...
    this.expectedSensorName = 'INLET_FILTER_DIFF_PRESS';
    this.expectedUnit = 'inch_of_water';
    this.customerUnit = 'inch_of_water';
  ...
  it('correct evalMetric for INLET_FILTER_DIFF_PRESS', function () {
