...
describe(filename, function () {
  beforeAll(function () {
    ...
    this.expectedSensorName = 'EFFICIENCY';
    this.expectedUnit = 'percent';
    this.customerUnit = 'percent';
    ...
    for (date = this.start; date < this.end; date = date.plusDays(1)) {
  ...
  it('correct evalMetric for EFFICIENCY', function () {
