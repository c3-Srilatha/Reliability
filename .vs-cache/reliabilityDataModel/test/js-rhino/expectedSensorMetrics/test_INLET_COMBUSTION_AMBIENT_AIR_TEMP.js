...
var filename = 'test_INLET_COMBUSTION_AMBIENT_AIR_TEMP';
...
describe(filename, function () {
  beforeAll(function () {
    ...
    this.expectedSensorName = 'INLET_COMBUSTION_AMBIENT_AIR_TEMP';
  ...
  it('correct evalMetric for INLET_COMBUSTION_AMBIENT_AIR_TEMP', function () {
