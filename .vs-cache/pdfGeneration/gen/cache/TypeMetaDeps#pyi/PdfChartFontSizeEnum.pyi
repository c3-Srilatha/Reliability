...
# Python definitions for the C3 type PdfChartFontSizeEnum


class PdfChartFontSizeEnum():
    """
    ...
    XX_SMALL: Optional[str]=None
    """
    Extra extra small font size, smaller than 'x-small'.
    """

    X_SMALL: Optional[str]=None
    """
    ...
    X_LARGE: Optional[str]=None
    """
    Extra large font size, larger than 'large'.
    """

    XX_LARGE: Optional[str]=None
    """
    Extra extra large font size, the largest size available.
    """
    def __init__(self, XX_SMALL: Optional[str]=None, X_SMALL: Optional[str]=None, SMALL: Optional[str]=None, MEDIUM: Optional[str]=None, LARGE: Optional[str]=None, X_LARGE: Optional[str]=None, XX_LARGE: Optional[str]=None) -> None: ...
