...
# Python definitions for the C3 type PdfChartLegendLocationEnum


class PdfChartLegendLocationEnum():
    """
    ...
    """
    def __init__(self, UPPER_LEFT: Optional[str]=None, UPPER_RIGHT: Optional[str]=None, LOWER_LEFT: Optional[str]=None, LOWER_RIGHT: Optional[str]=None, UPPER_CENTER: Optional[str]=None, LOWER_CENTER: Optional[str]=None, CENTER_LEFT: Optional[str]=None, CENTER_RIGHT: Optional[str]=None, CENTER: Optional[str]=None, BEST: Optional[str]=None) -> None: ...
