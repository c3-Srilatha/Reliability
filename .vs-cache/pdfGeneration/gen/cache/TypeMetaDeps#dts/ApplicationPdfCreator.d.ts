// TypeScript definitions for the C3 type ApplicationPdfCreator

/**
 * Standard PDF creator to be used for SaaS applications.
 *
 * @remarks this represents a value passed to a method that expects an instance of ApplicationPdfCreator
 */
declare interface IApplicationPdfCreator {
  ...
  /**
   * Whether or not a timestamp should appear at the top right of each page.
   * When {@link PdfGenerationSpec#headerText} is provided and passed into {@link ApplicationPdfCreator#createPdf}
   * it will override includeTimestamp, and the headerText will appear at the top right instead
   */
  includeTimestamp?: boolean;

  /**
   * The path to the application logo image to display on the bottom left of each page. Path is relative to the resource directory in the {@Pkg.Store}.
   */
  applicationLogoImagePath?: string;

  /**
   * The path to the application logo image to display on the top left of each page. Path is relative to the resource directory in the {@Pkg.Store}.
   */
  applicationMainLogoImagePath?: string;

  /**
   * The font family of all the text in the pdf.
   * Ex. Helvetica
   */
  fontFamily?: string;

  /**
   * The font size of all the text in the {@link PdfComponent}s in the pdf.
   */
  fontSize?: number;
}
 ...
 * Standard PDF creator to be used for SaaS applications.
 *
 * @remarks this represents a made instance of ApplicationPdfCreator
 */
declare class ApplicationPdfCreator extends Obj  {

  readonly configOverride?: string;
  withConfigOverride(configOverride: string | null): ApplicationPdfCreator;

  static readonly configOverride?: string;

  readonly secretOverride?: string;
  withSecretOverride(secretOverride: string | null): ApplicationPdfCreator;
  ...
  withIssues(issues: Array_Type<string> | Array<string> | null): ApplicationPdfCreator;
  ...
  withIncludeTimestamp(includeTimestamp: boolean): ApplicationPdfCreator;
   ...
   * it will override includeTimestamp, and the headerText will appear at the top right instead
   */
  static readonly includeTimestamp?: boolean;

  /**
   * The path to the application logo image to display on the bottom left of each page. Path is relative to the resource directory in the {@Pkg.Store}.
   */
  readonly applicationLogoImagePath?: string;
  withApplicationLogoImagePath(applicationLogoImagePath: string | null): ApplicationPdfCreator;

  /**
   * The path to the application logo image to display on the bottom left of each page. Path is relative to the resource directory in the {@Pkg.Store}.
   */
  static readonly applicationLogoImagePath?: string;

  /**
   * The path to the application logo image to display on the top left of each page. Path is relative to the resource directory in the {@Pkg.Store}.
   */
  readonly applicationMainLogoImagePath?: string;
  withApplicationMainLogoImagePath(applicationMainLogoImagePath: string | null): ApplicationPdfCreator;

  /**
   * The path to the application logo image to display on the top left of each page. Path is relative to the resource directory in the {@Pkg.Store}.
   */
  static readonly applicationMainLogoImagePath?: string;
  ...
  withFontFamily(fontFamily: string | null): ApplicationPdfCreator;
  ...
  withFontSize(fontSize: number | null): ApplicationPdfCreator;
   ...
   * @see #toJson
   */
  static fromJson(json: any): ApplicationPdfCreator | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): ApplicationPdfCreator | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): ApplicationPdfCreator | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): ApplicationPdfCreator | null;
   ...
   */
  replaceType(old: Type, new_: Type): ApplicationPdfCreator;
   ...
   * This method is used during live metadata update
   */
  static replaceType(old: Type, new_: Type): ApplicationPdfCreator;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ApplicationPdfCreator;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ApplicationPdfCreator;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ApplicationPdfCreator;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ApplicationPdfCreator;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ApplicationPdfCreator>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ApplicationPdfCreator>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ApplicationPdfCreator>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ApplicationPdfCreator>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ApplicationPdfCreator;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ApplicationPdfCreator;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ApplicationPdfCreator;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ApplicationPdfCreator;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ApplicationPdfCreator;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ApplicationPdfCreator;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ApplicationPdfCreator;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  static validateObj(): ApplicationPdfCreator;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ApplicationPdfCreator;
   ...
   * @see #defaultField
   */
  static withField(field: string, value: any, doNotConvert?: boolean): ApplicationPdfCreator;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ApplicationPdfCreator;
   ...
   * @see #defaultField
   */
  static withField(field: FieldType, value: any, doNotConvert?: boolean): ApplicationPdfCreator;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ApplicationPdfCreator;
   ...
   * @return new Obj
   */
  static withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ApplicationPdfCreator;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ApplicationPdfCreator;
   ...
   * @return new Obj
   */
  static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ApplicationPdfCreator;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ApplicationPdfCreator;
   ...
   * @see #withoutField
   */
  static withoutFieldAtPath(path: string): ApplicationPdfCreator;
   ...
   * @see #removeField
   */
  withoutField(field: string): ApplicationPdfCreator;
   ...
   * @see #removeField
   */
  static withoutField(field: string): ApplicationPdfCreator;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): ApplicationPdfCreator;
   ...
   * @see #removeField
   */
  static withoutField(field: FieldType): ApplicationPdfCreator;
   ...
   */
  withoutFields(fields: Array_Type<string>): ApplicationPdfCreator;
   ...
   * @return new Obj with removed fields
   */
  static withoutFields(fields: Array_Type<string>): ApplicationPdfCreator;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): ApplicationPdfCreator;
   ...
   * @return new Obj with removed fields
   */
  static withoutFieldsByType(fields: Array_Type<FieldType>): ApplicationPdfCreator;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ApplicationPdfCreator;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  static withoutSecretFields(): ApplicationPdfCreator;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ApplicationPdfCreator;
   ...
   * @see FieldType#defaultValue
   */
  static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ApplicationPdfCreator;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ApplicationPdfCreator;
   ...
   * @see #unsetField
   */
  static defaultField(field: string): ApplicationPdfCreator;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ApplicationPdfCreator;
   ...
   * @see #unsetField
   */
  static defaultField(field: FieldType): ApplicationPdfCreator;
   ...
   * @see #removeField
   */
  unsetField(field: string): ApplicationPdfCreator;
   ...
   * @see #removeField
   */
  static unsetField(field: string): ApplicationPdfCreator;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ApplicationPdfCreator;
   ...
   * @see #removeField
   */
  static unsetField(field: FieldType): ApplicationPdfCreator;
   ...
   * @see #unsetField
   */
  removeField(field: string): ApplicationPdfCreator;
   ...
   * @see #unsetField
   */
  static removeField(field: string): ApplicationPdfCreator;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ApplicationPdfCreator;
   ...
   * @see #unsetField
   */
  static removeField(field: FieldType): ApplicationPdfCreator;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ApplicationPdfCreator;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ApplicationPdfCreator;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): ApplicationPdfCreator;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj, otherFieldsFilter: Type): ApplicationPdfCreator;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ApplicationPdfCreator;
   ...
   *        the same key or index.
   */
  static mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ApplicationPdfCreator;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ApplicationPdfCreator;
   ...
   * traverse child reference and collection fields.
   */
  static mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ApplicationPdfCreator;

  mergeJson(json: any): ApplicationPdfCreator;

  static mergeJson(json: any): ApplicationPdfCreator;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ApplicationPdfCreator;
   ...
   * @return Obj with child references merged
   */
  static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ApplicationPdfCreator;
   ...
   */
  sumObj(other: Obj, deep?: boolean): ApplicationPdfCreator;
   ...
   * references with same name and collection elements at same index or key.
   */
  static sumObj(other: Obj, deep?: boolean): ApplicationPdfCreator;
   ...
   */
  singletonArray(): Array_Type<ApplicationPdfCreator>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonArray(): Array_Type<ApplicationPdfCreator>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<ApplicationPdfCreator> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ApplicationPdfCreator> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<ApplicationPdfCreator>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonSet(): Set_Type<ApplicationPdfCreator>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ApplicationPdfCreator> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, ApplicationPdfCreator> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ApplicationPdfCreator> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ApplicationPdfCreator>;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  static toBuilder(): ObjBuilder<ApplicationPdfCreator>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ApplicationPdfCreator>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ApplicationPdfCreator;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ApplicationPdfCreator;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ApplicationPdfCreator;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ApplicationPdfCreator;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ApplicationPdfCreator;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ApplicationPdfCreator;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ApplicationPdfCreator;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): ApplicationPdfCreator;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  static afterMake(): ApplicationPdfCreator;
   ...
   */
  static cachedEmptyInst(): ApplicationPdfCreator;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<ApplicationPdfCreator> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): ApplicationPdfCreator;

  /**
   * Function which creates an initial PDF for a SaaS application to be consumed by the {@link PdfGenerator}.
   */
  static createPdf(spec?: PdfGenerationSpec): any;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<ApplicationPdfCreator> | null;
   ...
   */
  static find(filter?: string, doNotProduceAll?: boolean): Stream<ApplicationPdfCreator> | null;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<ApplicationPdfCreator> | null;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): ApplicationPdfCreator | null;

  /**
   * Returns cached instance by key, with secrets removed.
   */
  static forCacheKey(key: string): ApplicationPdfCreator | null;
   ...
   * @see findByCacheKey
   */
  getCached(): ApplicationPdfCreator | null;
   ...
   * @see findByCacheKey
   */
  static getCached(): ApplicationPdfCreator | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): ApplicationPdfCreator | null;

  /**
   * @return newly produced cached instance.
   */
  static refreshCache(): ApplicationPdfCreator | null;
   ...
   */
  static produce(key: string): ApplicationPdfCreator | null;
   ...
   */
  static produceAll(): Map_Type<string, ApplicationPdfCreator> | null;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): Map_Type<string, ApplicationPdfCreator> | null;
   ...
   */
  getConfig(): ApplicationPdfCreator;
   ...
   * Note that typical pattern is to use Configurable#config instead of this method.
   */
  static getConfig(): ApplicationPdfCreator;
   ...
   */
  getSecret(): ApplicationPdfCreator;
   ...
   * Note that typical pattern is to use Configurable#configWithSecrets instead of this method.
   */
  static getSecret(): ApplicationPdfCreator;
   ...
   */
  withConfigKey(configKey: string): ApplicationPdfCreator;
   ...
   *     config.configKey() => "folder1/abc"
   */
  static withConfigKey(configKey: string): ApplicationPdfCreator;

  /**
   * @return copy without config key.
   */
  withoutConfigKey(): ApplicationPdfCreator;

  /**
   * @return copy without config key.
   */
  static withoutConfigKey(): ApplicationPdfCreator;

  /**
   * @return return cached config instance for provided config key.
   */
  static forConfigKey(configKey: string): ApplicationPdfCreator | null;
   ...
   */
  static listConfigs(parallel?: boolean, filter?: λPredicate<string>): Stream<ApplicationPdfCreator> | null;
   ...
   * @see setConfigValue
   */
  setConfigValues(from: ApplicationPdfCreator, override?: string): void;

  /**
   * Sets multiple field values to be the same as the passed instance.
   * @see setConfigValue
   */
  static setConfigValues(from: ApplicationPdfCreator, override?: string): void;
   ...
   * @see setSecretValue
   */
  setSecretValues(from: ApplicationPdfCreator, override?: string): void;

  /**
   * Sets multiple secret field values to be the same as the passed instance.
   * @see setSecretValue
   */
  static setSecretValues(from: ApplicationPdfCreator, override?: string): void;
   ...
   */
  static loadConfigAndSecret(configKey: string): ApplicationPdfCreator | null;
   ...
   */
  removeSecrets(): ApplicationPdfCreator | null;

  /**
   * @return this config without any secret values.
   */
  static removeSecrets(): ApplicationPdfCreator | null;

  /**
   * @return this config with only secret values.
   */
  removeNonSecrets(): ApplicationPdfCreator | null;

  /**
   * @return this config with only secret values.
   */
  static removeNonSecrets(): ApplicationPdfCreator | null;

  /**
   * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
   * validation and setup.
   */
  validate(): ApplicationPdfCreator;

  /**
   * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
   * validation and setup.
   */
  static validate(): ApplicationPdfCreator;
