// TypeScript definitions for the C3 type PhysicalMeasurementSeries
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of PhysicalMeasurementSeries
 */
declare interface IPhysicalMeasurementSeries {
   ...
   */
  data?: Array_Type<Measurement> | Array<IMeasurement>;
 ...
 */
declare class PhysicalMeasurementSeries extends Obj  {

  /**
   * Populated on normalization. Indicates the earliest data point across various timeseries fields.
   */
  readonly earliest?: DateTime;
  withEarliest(earliest: DateTime | Date | string | null): PhysicalMeasurementSeries;

  /**
   * Populated on normalization. Indicates the latest data point across various timeseries fields.
   */
  readonly latest?: DateTime;
  withLatest(latest: DateTime | Date | string | null): PhysicalMeasurementSeries;

  /**
   * Populated on normalization. Indicates the earliest data point for each {@link Ann.Ts} fields.
   */
  readonly earliestTsDp?: Map_Type<string, TSDataPoint>;
  withEarliestTsDp(earliestTsDp: Map_Type<string, TSDataPoint> | {[key: string]: ITSDataPoint} | null): PhysicalMeasurementSeries;

  /**
   * Populated on normalization. Indicates the latest data point for each {@link Ann.Ts} fields.
   */
  readonly latestTsDp?: Map_Type<string, TSDataPoint>;
  withLatestTsDp(latestTsDp: Map_Type<string, TSDataPoint> | {[key: string]: ITSDataPoint} | null): PhysicalMeasurementSeries;
  ...
  withInterval(interval: string | null): PhysicalMeasurementSeries;

  /**
   * If set, the time series will be normalized in the specified zone.
   */
  readonly timeZone?: string;
  withTimeZone(timeZone: string | null): PhysicalMeasurementSeries;

  /**
   * If set, disables normalizing this time series. Invalidations will still continue to happen for this series normally.
   */
  readonly doNotNormalize?: boolean;
  withDoNotNormalize(doNotNormalize: boolean): PhysicalMeasurementSeries;

  /**
   * Data points corresponding to this timeseries header
   */
  readonly data?: Array_Type<Measurement>;
  withData(data: Array_Type<Measurement> | Array<IMeasurement> | null): PhysicalMeasurementSeries;

  /**
   * Use this field to specify the interpolation mechanism to be applied for gaps in interval timeseries. Default: `ZERO_INTERPOLATOR`.
   */
  readonly interpolator?: string;
  withInterpolator(interpolator: string | null): PhysicalMeasurementSeries;

  /**
   * Use this field to specify how normalization should handle duplicate data points. A duplicate point is one that has the same start, end, value, unit, and {@link TimedDataPointFields#isEstimated} values. Default: `IGNORE`.
   */
  readonly duplicateHandling?: string;
  withDuplicateHandling(duplicateHandling: string | null): PhysicalMeasurementSeries;

  /**
   * Used to specify how normalization should handle overlapping data points. Default: `AVG`.
   */
  readonly overlapHandling?: string;
  withOverlapHandling(overlapHandling: string | null): PhysicalMeasurementSeries;
  ...
  withBucketInterval(bucketInterval: string | null): PhysicalMeasurementSeries;
  ...
  withNormalizationPartitionStrategy(normalizationPartitionStrategy: INormalizationPartitionStrategy | null): PhysicalMeasurementSeries;
  ...
  withTypeIdent(typeIdent: string | null): PhysicalMeasurementSeries;
   ...
   */
  readonly id: string;
  withId(id: string): PhysicalMeasurementSeries;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): PhysicalMeasurementSeries;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): PhysicalMeasurementSeries;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): PhysicalMeasurementSeries;
  ...
  withVersion(version: number | null): PhysicalMeasurementSeries;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): PhysicalMeasurementSeries;
  ...
  withMeasurementType(measurementType: string | null): PhysicalMeasurementSeries;
  ...
  withOrigin(origin: string | null): PhysicalMeasurementSeries;

  /**
   * The "asset" associated with the series.
   */
  readonly asset?: PhysicalAsset;
  withAsset(asset: IPhysicalAsset | null): PhysicalMeasurementSeries;
  ...
  withKind(kind: string | null): PhysicalMeasurementSeries;

  /**
   * For those series that should have measurements in a specific {@link Unit}.
   */
  readonly unitConstraint: Unit;
  withUnitConstraint(unitConstraint: IUnit): PhysicalMeasurementSeries;
  ...
  withTreatment(treatment: string | null): PhysicalMeasurementSeries;
  ...
  withMultiplier(multiplier: number | null): PhysicalMeasurementSeries;

  /**
   * A field to access this object as array. Used in some metric expression as a workaound to some limitations.
   */
  readonly self?: Array_Type<BasePhysicalMeasurementSeries>;
  withSelf(self: Array_Type<BasePhysicalMeasurementSeries> | Array<IBasePhysicalMeasurementSeries> | null): PhysicalMeasurementSeries;
   ...
   * @see #toJson
   */
  static fromJson(json: any): PhysicalMeasurementSeries | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): PhysicalMeasurementSeries | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): PhysicalMeasurementSeries | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): PhysicalMeasurementSeries | null;
   ...
   */
  replaceType(old: Type, new_: Type): PhysicalMeasurementSeries;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): PhysicalMeasurementSeries;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): PhysicalMeasurementSeries;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<PhysicalMeasurementSeries>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<PhysicalMeasurementSeries>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): PhysicalMeasurementSeries;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): PhysicalMeasurementSeries;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): PhysicalMeasurementSeries;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): PhysicalMeasurementSeries;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): PhysicalMeasurementSeries;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): PhysicalMeasurementSeries;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): PhysicalMeasurementSeries;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): PhysicalMeasurementSeries;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): PhysicalMeasurementSeries;
   ...
   * @see #removeField
   */
  withoutField(field: string): PhysicalMeasurementSeries;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): PhysicalMeasurementSeries;
   ...
   */
  withoutFields(fields: Array_Type<string>): PhysicalMeasurementSeries;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): PhysicalMeasurementSeries;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): PhysicalMeasurementSeries;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): PhysicalMeasurementSeries;
   ...
   * @see #unsetField
   */
  defaultField(field: string): PhysicalMeasurementSeries;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): PhysicalMeasurementSeries;
   ...
   * @see #removeField
   */
  unsetField(field: string): PhysicalMeasurementSeries;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): PhysicalMeasurementSeries;
   ...
   * @see #unsetField
   */
  removeField(field: string): PhysicalMeasurementSeries;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): PhysicalMeasurementSeries;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): PhysicalMeasurementSeries;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): PhysicalMeasurementSeries;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): PhysicalMeasurementSeries;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): PhysicalMeasurementSeries;

  mergeJson(json: any): PhysicalMeasurementSeries;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): PhysicalMeasurementSeries;
   ...
   */
  sumObj(other: Obj, deep?: boolean): PhysicalMeasurementSeries;
   ...
   */
  singletonArray(): Array_Type<PhysicalMeasurementSeries>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<PhysicalMeasurementSeries> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<PhysicalMeasurementSeries> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<PhysicalMeasurementSeries>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<PhysicalMeasurementSeries> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, PhysicalMeasurementSeries> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, PhysicalMeasurementSeries> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<PhysicalMeasurementSeries>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<PhysicalMeasurementSeries>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): PhysicalMeasurementSeries;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): PhysicalMeasurementSeries;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): PhysicalMeasurementSeries;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): PhysicalMeasurementSeries;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): PhysicalMeasurementSeries;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): PhysicalMeasurementSeries;
   ...
   * @see #fromString
   */
  static make(s: string): PhysicalMeasurementSeries | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): PhysicalMeasurementSeries;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): PhysicalMeasurementSeries;
   ...
   */
  static cachedEmptyInst(): PhysicalMeasurementSeries;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<PhysicalMeasurementSeries> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): PhysicalMeasurementSeries;
   ...
   */
  static normalizeTimeseries(timeseries?: TimedDataFields<Measurement>, start?: DateTime, end?: DateTime, overrideGrain?: string, forceGrainDetection?: boolean, force?: boolean): void;
   ...
   */
  static normalize(timeseries?: TimedDataFields<Measurement>, start?: DateTime, end?: DateTime, overrideGrain?: string, forceGrainDetection?: boolean): NormalizationResult | null;
   ...
   */
  static normalizationUnit(rawHeader: TimedDataFields<Measurement>, tsField: string): Unit | null;
   ...
   */
  static normalizationTreatment(rawHeader: TimedDataFields<Measurement>, tsField: string): string;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<PhysicalMeasurementSeries>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<PhysicalMeasurementSeries>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<PhysicalMeasurementSeries> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<PhysicalMeasurementSeries>> | null;
   ...
   */
  get(include?: string): PhysicalMeasurementSeries | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): PhysicalMeasurementSeries | null;
   ...
   */
  getMissing(spec: GetMissingSpec): PhysicalMeasurementSeries;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): PhysicalMeasurementSeries | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): PhysicalMeasurementSeries;
   ...
   * @see #toString
   */
  static fromString(s: string): PhysicalMeasurementSeries | null;
   ...
   */
  create(spec?: UpsertSpec): PhysicalMeasurementSeries | null;
   ...
   */
  static createBatch(objs: Array_Type<PhysicalMeasurementSeries>, spec?: UpsertSpec): ObjList<PhysicalMeasurementSeries> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<PhysicalMeasurementSeries>, spec?: CreateBatchObjStreamSpec): ObjList<PhysicalMeasurementSeries> | null;
   ...
   */
  update(srcObj?: PhysicalMeasurementSeries, spec?: UpsertSpec): PhysicalMeasurementSeries | null;
   ...
   */
  upsert(srcObj?: PhysicalMeasurementSeries, spec?: UpsertSpec): PhysicalMeasurementSeries | null;
   ...
   */
  merge(spec?: MergeSpec): PhysicalMeasurementSeries | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): PhysicalMeasurementSeries | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): PhysicalMeasurementSeries | null;
   ...
   */
  static updateBatch(objs: Array_Type<PhysicalMeasurementSeries>, srcObjs?: Array_Type<PhysicalMeasurementSeries>, spec?: UpsertSpec): ObjList<PhysicalMeasurementSeries> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<PhysicalMeasurementSeries> | null>, spec?: UpsertSpec): ObjList<PhysicalMeasurementSeries> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<PhysicalMeasurementSeries>, srcObjs?: Array_Type<PhysicalMeasurementSeries>, spec?: UpsertSpec): ObjList<PhysicalMeasurementSeries> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<PhysicalMeasurementSeries> | null>, spec?: UpsertSpec): ObjList<PhysicalMeasurementSeries> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<PhysicalMeasurementSeries>, spec?: TouchSpec): ObjList<PhysicalMeasurementSeries> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<PhysicalMeasurementSeries>, spec?: MergeSpec): ObjList<PhysicalMeasurementSeries> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<PhysicalMeasurementSeries>, mergeInclude: string, spec?: MergeSpec): ObjList<PhysicalMeasurementSeries> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<PhysicalMeasurementSeries> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<PhysicalMeasurementSeries> | null;
   ...
   */
  static mergeAll(mergeObj: PhysicalMeasurementSeries, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: PhysicalMeasurementSeries, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<PhysicalMeasurementSeries>, spec?: UpsertSpec): ObjList<PhysicalMeasurementSeries> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<PhysicalMeasurementSeries>, spec?: UpsertSpec): ObjList<PhysicalMeasurementSeries> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): PhysicalMeasurementSeries | null;
   ...
   */
  static beforeCreate(objs: Array_Type<PhysicalMeasurementSeries>): ObjList<PhysicalMeasurementSeries>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<PhysicalMeasurementSeries>): ObjList<PhysicalMeasurementSeries>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<PhysicalMeasurementSeries>): ObjList<PhysicalMeasurementSeries>;
   ...
   */
  static afterCreate(objs: Array_Type<PhysicalMeasurementSeries>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<PhysicalMeasurementSeries>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<PhysicalMeasurementSeries>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<PhysicalMeasurementSeries>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<PhysicalMeasurementSeries>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): PhysicalMeasurementSeries | null;
   ...
   */
  withoutIdentity(): PhysicalMeasurementSeries | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<PhysicalMeasurementSeries>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: PhysicalMeasurementSeries, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<PhysicalMeasurementSeries>, callback?: λFunction<PhysicalMeasurementSeries | null, PhysicalMeasurementSeries | null>): ObjList<PhysicalMeasurementSeries>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<PhysicalMeasurementSeries>, callback?: λFunction<PhysicalMeasurementSeries | null, PhysicalMeasurementSeries | null>): Array_Type<ObjError> | null;
