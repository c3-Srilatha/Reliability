// TypeScript definitions for the C3 type WorkItem

/**
 * WorkItems are specific tasks that are associated with the work order.
 *
 * @remarks this represents a value passed to a method that expects an instance of WorkItem
 */
 ...
 */
declare class WorkItem extends Obj  {
  ...
  withTypeIdent(typeIdent: string | null): WorkItem;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): WorkItem;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): WorkItem;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): WorkItem;
  ...
  withVersion(version: number | null): WorkItem;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): WorkItem;

  /**
   * The parent WorkOrder for the WorkItem
   */
  readonly parentWorkOrder?: WorkOrder;
  withParentWorkOrder(parentWorkOrder: IWorkOrder | null): WorkItem;

  /**
   * The status of the WorkItem represented by codes
   */
  readonly statusCode?: string;
  withStatusCode(statusCode: string | null): WorkItem;

  /**
   * The end date timestamp of the WorkItem
   */
  readonly workEndDate?: DateTime;
  withWorkEndDate(workEndDate: DateTime | Date | string | null): WorkItem;
   ...
   * @see #toJson
   */
  static fromJson(json: any): WorkItem | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): WorkItem | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): WorkItem | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): WorkItem | null;
   ...
   */
  replaceType(old: Type, new_: Type): WorkItem;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): WorkItem;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): WorkItem;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<WorkItem>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<WorkItem>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): WorkItem;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): WorkItem;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): WorkItem;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): WorkItem;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): WorkItem;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): WorkItem;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): WorkItem;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): WorkItem;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): WorkItem;
   ...
   * @see #removeField
   */
  withoutField(field: string): WorkItem;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): WorkItem;
   ...
   */
  withoutFields(fields: Array_Type<string>): WorkItem;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): WorkItem;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): WorkItem;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): WorkItem;
   ...
   * @see #unsetField
   */
  defaultField(field: string): WorkItem;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): WorkItem;
   ...
   * @see #removeField
   */
  unsetField(field: string): WorkItem;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): WorkItem;
   ...
   * @see #unsetField
   */
  removeField(field: string): WorkItem;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): WorkItem;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): WorkItem;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): WorkItem;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): WorkItem;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): WorkItem;

  mergeJson(json: any): WorkItem;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): WorkItem;
   ...
   */
  sumObj(other: Obj, deep?: boolean): WorkItem;
   ...
   */
  singletonArray(): Array_Type<WorkItem>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<WorkItem> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<WorkItem> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<WorkItem>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<WorkItem> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, WorkItem> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, WorkItem> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<WorkItem>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<WorkItem>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): WorkItem;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): WorkItem;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): WorkItem;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): WorkItem;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): WorkItem;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): WorkItem;
   ...
   * @see #fromString
   */
  static make(s: string): WorkItem | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): WorkItem;
   ...
   */
  static cachedEmptyInst(): WorkItem;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<WorkItem> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): WorkItem;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<WorkItem>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<WorkItem>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<WorkItem> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<WorkItem>> | null;
   ...
   */
  get(include?: string): WorkItem | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): WorkItem | null;
   ...
   */
  getMissing(spec: GetMissingSpec): WorkItem;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): WorkItem | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): WorkItem;
   ...
   * @see #toString
   */
  static fromString(s: string): WorkItem | null;
   ...
   */
  create(spec?: UpsertSpec): WorkItem | null;
   ...
   */
  static createBatch(objs: Array_Type<WorkItem>, spec?: UpsertSpec): ObjList<WorkItem> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<WorkItem>, spec?: CreateBatchObjStreamSpec): ObjList<WorkItem> | null;
   ...
   */
  update(srcObj?: WorkItem, spec?: UpsertSpec): WorkItem | null;
   ...
   */
  upsert(srcObj?: WorkItem, spec?: UpsertSpec): WorkItem | null;
   ...
   */
  merge(spec?: MergeSpec): WorkItem | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): WorkItem | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): WorkItem | null;
   ...
   */
  static updateBatch(objs: Array_Type<WorkItem>, srcObjs?: Array_Type<WorkItem>, spec?: UpsertSpec): ObjList<WorkItem> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<WorkItem> | null>, spec?: UpsertSpec): ObjList<WorkItem> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<WorkItem>, srcObjs?: Array_Type<WorkItem>, spec?: UpsertSpec): ObjList<WorkItem> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<WorkItem> | null>, spec?: UpsertSpec): ObjList<WorkItem> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<WorkItem>, spec?: TouchSpec): ObjList<WorkItem> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<WorkItem>, spec?: MergeSpec): ObjList<WorkItem> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<WorkItem>, mergeInclude: string, spec?: MergeSpec): ObjList<WorkItem> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<WorkItem> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<WorkItem> | null;
   ...
   */
  static mergeAll(mergeObj: WorkItem, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: WorkItem, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<WorkItem>, spec?: UpsertSpec): ObjList<WorkItem> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<WorkItem>, spec?: UpsertSpec): ObjList<WorkItem> | null;
   ...
   */
  static beforeCreate(objs: Array_Type<WorkItem>): ObjList<WorkItem>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<WorkItem>): ObjList<WorkItem>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<WorkItem>): ObjList<WorkItem>;
   ...
   */
  static afterCreate(objs: Array_Type<WorkItem>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<WorkItem>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<WorkItem>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<WorkItem>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<WorkItem>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): WorkItem | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<WorkItem>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: WorkItem, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<WorkItem>, callback?: λFunction<WorkItem | null, WorkItem | null>): ObjList<WorkItem>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<WorkItem>, callback?: λFunction<WorkItem | null, WorkItem | null>): Array_Type<ObjError> | null;
