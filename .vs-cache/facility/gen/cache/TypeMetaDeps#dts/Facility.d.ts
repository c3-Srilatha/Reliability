...
/**
 * Facility is sub type for FixedAsset, you can think of it as a building.
 * So Facility has buildingType and construction date, and FixedAsset does not.
 *
 * @see FixedAsset
 *
...
declare interface IFacility {
  ...
  /**
   * Parent relations, where 'to' refers to this asset.
   */
  parentRelations?: Array_Type<PhysicalAssetHierarchyRelation> | Array<IPhysicalAssetHierarchyRelation>;
...
declare class Facility extends Obj  {
   ...
   * Parent relations, where 'to' refers to this asset.
   */
  readonly parentRelations?: Array_Type<PhysicalAssetHierarchyRelation>;
  withParentRelations(parentRelations: Array_Type<PhysicalAssetHierarchyRelation> | Array<IPhysicalAssetHierarchyRelation> | null): Facility;

  /**
   * Child relations, where 'from' refers to this asset.
   */
  readonly childRelations?: Array_Type<PhysicalAssetHierarchyRelation>;
  withChildRelations(childRelations: Array_Type<PhysicalAssetHierarchyRelation> | Array<IPhysicalAssetHierarchyRelation> | null): Facility;
   ...
   * The including asset
   */
  readonly parent?: FixedAsset;
  withParent(parent: IFixedAsset | null): Facility;
