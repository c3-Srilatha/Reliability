// TypeScript definitions for the C3 type Organization

/**
 * Organizations = companies, agencies, etc.
 * Examples: Environmental Protection Agency, Dow Chemicals.
 *
 * @remarks this represents a value passed to a method that expects an instance of Organization
 */
declare interface IOrganization {
   ...
   */
  parentRelations?: Array_Type<PartyTimedIntervalRelation> | Array<IPartyTimedIntervalRelation>;

  /**
   * Outgoing edges of the {@link Party} hierarchy
   */
  childRelations?: Array_Type<PartyTimedIntervalRelation> | Array<IPartyTimedIntervalRelation>;

  /**
   * Outgoing edges of the {@link Party} lateral relation graph
   */
  relatedPartyEdgesFrom?: Array_Type<PartyEdge> | Array<IPartyEdge>;

  /**
   * Incoming edges of the {@link Party} lateral relation graph
   */
  relatedPartyEdgesTo?: Array_Type<PartyEdge> | Array<IPartyEdge>;
   ...
   */
  communicationPreferences?: Array_Type<PartyCommunicationPreference> | Array<IPartyCommunicationPreference>;
   ...
   */
  parents?: Array_Type<Party> | Array<IParty>;
   ...
   */
  preferredLanguageLocaleCode?: ILocale;

  /**
   * PartyRoles assigned to the Party.
   */
  roles?: Array_Type<PartyRole> | Array<IPartyRole>;

  /**
   * Phone contact information entries for the Party.
   */
  phones?: Array_Type<PartyPhone> | Array<IPartyPhone>;
   ...
   */
  electronicCommunications?: Array_Type<PartyElectronicCommunication> | Array<IPartyElectronicCommunication>;
   ...
   * fetch most recent if fetching only 1
   */
  postalAddresses?: Array_Type<PartyPostalAddress> | Array<IPartyPostalAddress>;

  /**
   * Most recent postal address of this party.
   */
  latestAddress?: IPartyPostalAddress;

  /**
   * Customers of this Party.
   */
  customers?: Array_Type<Customer> | Array<ICustomer>;

  /**
   * Preferred phone. Pick the one that was last updated, when there are many.
   */
  preferredPhoneNumber?: IPartyPhone;

  /**
   * Preferred email. Pick the one that was last updated, when there are many.
   */
  preferredEmail?: IPartyElectronicCommunication;

  /**
   * Do not disturb schedule.
   */
  doNotDisturbSchedule?: IScheduleRecurringDayRule;

  /**
   * Full textual description of Organization.
   */
  description?: string;
   ...
   */
  countryOfIncorporation?: ICountry;

  /**
   * Date of incorporation.
   */
  dateOfIncorporation?: DateTime | Date | string;

  /**
   * Country of domicile.
   */
  countryOfDomicile?: ICountry;

  /**
   * Country of location.
   */
  countryOfLocation?: ICountry;

  /**
   * Country of risk.
   */
  countryOfRisk?: ICountry;
   ...
   * The gross revenue.
   */
  grossRevenue?: IMonetaryValue;

  /**
   * The {@link OrganizationSegment} to which belongs this {@link Organization}.
   */
  organizationSegment?: IOrganizationSegment;
  ...
  /**
   * Whether this {@link Organization} is linked to a sanctioned country.
   */
  linkedToSanctionedCountry?: boolean;

  /**
   * In the OrganizationHierarchyDenorm, the parents of this Org.
   */
  denormParents?: Array_Type<OrganizationHierarchyDenorm> | Array<IOrganizationHierarchyDenorm>;

  /**
   * In the OrganizationRollup, the parents of this Org.
   */
  orgRollupParents?: Array_Type<OrganizationRollup> | Array<IOrganizationRollup>;

  /**
   * In the CustomerRelation, the parents of this Org.
   */
  customerRelationParents?: Array_Type<CustomerRelation> | Array<ICustomerRelation>;

  /**
   * In the OrganizationRollup, the children of this Org.
   */
  orgRollupChildren?: Array_Type<OrganizationRollup> | Array<IOrganizationRollup>;

  /**
   * In the CustomerRelation, the children of this Org.
   */
  customerRelationChildren?: Array_Type<CustomerRelation> | Array<ICustomerRelation>;

  /**
   * In the OrganizationHierarchyDenorm, the actual Organization associated with the
   * OrganizationHierarchyDenorm parents of this Organization.
   */
  parentOrgs?: Array_Type<Organization> | Array<IOrganization>;

  /**
   * Depth in the OrganizationHierarchyDenorm
   * - 0 - is root parent,
   * - null - is not part of hierarchy
   * - n (n>0) is nth level from root
   */
  depthFromRootParent?: number;

  /**
   * In the OrganizationHierarchyDenorm, the children of this Org.
   */
  denormChildren?: Array_Type<OrganizationHierarchyDenorm> | Array<IOrganizationHierarchyDenorm>;

  /**
   * The various characteristics of the Org (instead of adding innumerable fields to the type)
   */
  characteristics?: Array_Type<OrganizationCharacteristicSet> | Array<IOrganizationCharacteristicSet>;

  /**
   * The list of {@link PersonOrganizationRelation}s.
   */
  personRelations?: Array_Type<PersonOrganizationRelation> | Array<IPersonOrganizationRelation>;
}
 ...
 * Examples: Environmental Protection Agency, Dow Chemicals.
 *
 * @remarks this represents a made instance of Organization
 */
declare class Organization extends Obj  {

  /**
   * List of {@link AclEntry} entries governing who can read/update/remove Objs.
   */
  readonly acl?: Array_Type<AclEntry>;
  withAcl(acl: Array_Type<AclEntry> | Array<IAclEntry> | null): Organization;

  /**
   * The id of this instance.
   */
  readonly id: string;
  withId(id: string): Organization;

  readonly weatherStation?: WeatherStation;
  withWeatherStation(weatherStation: IWeatherStation | null): Organization;
  ...
  withTypeIdent(typeIdent: string | null): Organization;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Organization;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): Organization;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): Organization;
  ...
  withVersion(version: number | null): Organization;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): Organization;

  /**
   * Incoming edges of the {@link Party} hierarchy
   */
  readonly parentRelations?: Array_Type<PartyTimedIntervalRelation>;
  withParentRelations(parentRelations: Array_Type<PartyTimedIntervalRelation> | Array<IPartyTimedIntervalRelation> | null): Organization;

  /**
   * Outgoing edges of the {@link Party} hierarchy
   */
  readonly childRelations?: Array_Type<PartyTimedIntervalRelation>;
  withChildRelations(childRelations: Array_Type<PartyTimedIntervalRelation> | Array<IPartyTimedIntervalRelation> | null): Organization;

  /**
   * Outgoing edges of the {@link Party} lateral relation graph
   */
  readonly relatedPartyEdgesFrom?: Array_Type<PartyEdge>;
  withRelatedPartyEdgesFrom(relatedPartyEdgesFrom: Array_Type<PartyEdge> | Array<IPartyEdge> | null): Organization;

  /**
   * Incoming edges of the {@link Party} lateral relation graph
   */
  readonly relatedPartyEdgesTo?: Array_Type<PartyEdge>;
  withRelatedPartyEdgesTo(relatedPartyEdgesTo: Array_Type<PartyEdge> | Array<IPartyEdge> | null): Organization;

  /**
   * The party's preferred contact method.
   */
  readonly preferredCommunicationMethod?: string;
  withPreferredCommunicationMethod(preferredCommunicationMethod: string | null): Organization;

  /**
   * Preference of the party's communication method
   */
  readonly communicationPreferences?: Array_Type<PartyCommunicationPreference>;
  withCommunicationPreferences(communicationPreferences: Array_Type<PartyCommunicationPreference> | Array<IPartyCommunicationPreference> | null): Organization;

  /**
   * Whether the party want to receive email or not
   */
  readonly receiveEmail?: boolean;
  withReceiveEmail(receiveEmail: boolean): Organization;

  /**
   * Whether the party want to receive SMS or not
   */
  readonly receiveSMS?: boolean;
  withReceiveSMS(receiveSMS: boolean): Organization;

  /**
   * The parents of the party based on the PartyRoles specified.
   */
  readonly parents?: Array_Type<Party>;
  withParents(parents: Array_Type<Party> | Array<IParty> | null): Organization;
   ...
   * FK references FROM parents
   */
  readonly preferredLanguageLocaleCode?: Locale;
  withPreferredLanguageLocaleCode(preferredLanguageLocaleCode: ILocale | null): Organization;

  /**
   * PartyRoles assigned to the Party.
   */
  readonly roles?: Array_Type<PartyRole>;
  withRoles(roles: Array_Type<PartyRole> | Array<IPartyRole> | null): Organization;

  /**
   * Phone contact information entries for the Party.
   */
  readonly phones?: Array_Type<PartyPhone>;
  withPhones(phones: Array_Type<PartyPhone> | Array<IPartyPhone> | null): Organization;
   ...
   * fetch most recent if fetching only 1
   */
  readonly electronicCommunications?: Array_Type<PartyElectronicCommunication>;
  withElectronicCommunications(electronicCommunications: Array_Type<PartyElectronicCommunication> | Array<IPartyElectronicCommunication> | null): Organization;
   ...
   * fetch most recent if fetching only 1
   */
  readonly postalAddresses?: Array_Type<PartyPostalAddress>;
  withPostalAddresses(postalAddresses: Array_Type<PartyPostalAddress> | Array<IPartyPostalAddress> | null): Organization;

  /**
   * Most recent postal address of this party.
   */
  readonly latestAddress?: PartyPostalAddress;
  withLatestAddress(latestAddress: IPartyPostalAddress | null): Organization;

  /**
   * Customers of this Party.
   */
  readonly customers?: Array_Type<Customer>;
  withCustomers(customers: Array_Type<Customer> | Array<ICustomer> | null): Organization;

  /**
   * Preferred phone. Pick the one that was last updated, when there are many.
   */
  readonly preferredPhoneNumber?: PartyPhone;
  withPreferredPhoneNumber(preferredPhoneNumber: IPartyPhone | null): Organization;

  /**
   * Preferred email. Pick the one that was last updated, when there are many.
   */
  readonly preferredEmail?: PartyElectronicCommunication;
  withPreferredEmail(preferredEmail: IPartyElectronicCommunication | null): Organization;

  /**
   * Do not disturb schedule.
   */
  readonly doNotDisturbSchedule?: ScheduleRecurringDayRule;
  withDoNotDisturbSchedule(doNotDisturbSchedule: IScheduleRecurringDayRule | null): Organization;

  /**
   * Full textual description of Organization.
   */
  readonly description?: string;
  withDescription(description: string | null): Organization;

  /**
   * Country of incorporation.
   */
  readonly countryOfIncorporation?: Country;
  withCountryOfIncorporation(countryOfIncorporation: ICountry | null): Organization;

  /**
   * Date of incorporation.
   */
  readonly dateOfIncorporation?: DateTime;
  withDateOfIncorporation(dateOfIncorporation: DateTime | Date | string | null): Organization;

  /**
   * Country of domicile.
   */
  readonly countryOfDomicile?: Country;
  withCountryOfDomicile(countryOfDomicile: ICountry | null): Organization;

  /**
   * Country of location.
   */
  readonly countryOfLocation?: Country;
  withCountryOfLocation(countryOfLocation: ICountry | null): Organization;

  /**
   * Country of risk.
   */
  readonly countryOfRisk?: Country;
  withCountryOfRisk(countryOfRisk: ICountry | null): Organization;

  /**
   * The company type.
   */
  readonly companyType?: string;
  withCompanyType(companyType: string | null): Organization;

  /**
   * The market segment.
   */
  readonly marketSegment?: string;
  withMarketSegment(marketSegment: string | null): Organization;

  /**
   * The gross revenue.
   */
  readonly grossRevenue?: MonetaryValue;
  withGrossRevenue(grossRevenue: IMonetaryValue | null): Organization;

  /**
   * The {@link OrganizationSegment} to which belongs this {@link Organization}.
   */
  readonly organizationSegment?: OrganizationSegment;
  withOrganizationSegment(organizationSegment: IOrganizationSegment | null): Organization;

  /**
   * The number of employees.
   */
  readonly numberOfEmployees?: number;
  withNumberOfEmployees(numberOfEmployees: number | null): Organization;

  /**
   * Whether this {@link Organization} is linked to a sanctioned country.
   */
  readonly linkedToSanctionedCountry?: boolean;
  withLinkedToSanctionedCountry(linkedToSanctionedCountry: boolean): Organization;

  /**
   * In the OrganizationHierarchyDenorm, the parents of this Org.
   */
  readonly denormParents?: Array_Type<OrganizationHierarchyDenorm>;
  withDenormParents(denormParents: Array_Type<OrganizationHierarchyDenorm> | Array<IOrganizationHierarchyDenorm> | null): Organization;

  /**
   * In the OrganizationRollup, the parents of this Org.
   */
  readonly orgRollupParents?: Array_Type<OrganizationRollup>;
  withOrgRollupParents(orgRollupParents: Array_Type<OrganizationRollup> | Array<IOrganizationRollup> | null): Organization;

  /**
   * In the CustomerRelation, the parents of this Org.
   */
  readonly customerRelationParents?: Array_Type<CustomerRelation>;
  withCustomerRelationParents(customerRelationParents: Array_Type<CustomerRelation> | Array<ICustomerRelation> | null): Organization;

  /**
   * In the OrganizationRollup, the children of this Org.
   */
  readonly orgRollupChildren?: Array_Type<OrganizationRollup>;
  withOrgRollupChildren(orgRollupChildren: Array_Type<OrganizationRollup> | Array<IOrganizationRollup> | null): Organization;

  /**
   * In the CustomerRelation, the children of this Org.
   */
  readonly customerRelationChildren?: Array_Type<CustomerRelation>;
  withCustomerRelationChildren(customerRelationChildren: Array_Type<CustomerRelation> | Array<ICustomerRelation> | null): Organization;

  /**
   * In the OrganizationHierarchyDenorm, the actual Organization associated with the
   * OrganizationHierarchyDenorm parents of this Organization.
   */
  readonly parentOrgs?: Array_Type<Organization>;
  withParentOrgs(parentOrgs: Array_Type<Organization> | Array<IOrganization> | null): Organization;
   ...
   * - n (n>0) is nth level from root
   */
  readonly depthFromRootParent?: number;
  withDepthFromRootParent(depthFromRootParent: number | null): Organization;

  /**
   * In the OrganizationHierarchyDenorm, the children of this Org.
   */
  readonly denormChildren?: Array_Type<OrganizationHierarchyDenorm>;
  withDenormChildren(denormChildren: Array_Type<OrganizationHierarchyDenorm> | Array<IOrganizationHierarchyDenorm> | null): Organization;

  /**
   * The various characteristics of the Org (instead of adding innumerable fields to the type)
   */
  readonly characteristics?: Array_Type<OrganizationCharacteristicSet>;
  withCharacteristics(characteristics: Array_Type<OrganizationCharacteristicSet> | Array<IOrganizationCharacteristicSet> | null): Organization;

  /**
   * The list of {@link PersonOrganizationRelation}s.
   */
  readonly personRelations?: Array_Type<PersonOrganizationRelation>;
  withPersonRelations(personRelations: Array_Type<PersonOrganizationRelation> | Array<IPersonOrganizationRelation> | null): Organization;
   ...
   * @see #toJson
   */
  static fromJson(json: any): Organization | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): Organization | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): Organization | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): Organization | null;
   ...
   */
  replaceType(old: Type, new_: Type): Organization;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Organization;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Organization;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Organization>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Organization>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Organization;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Organization;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Organization;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): Organization;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): Organization;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): Organization;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Organization;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Organization;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): Organization;
   ...
   * @see #removeField
   */
  withoutField(field: string): Organization;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): Organization;
   ...
   */
  withoutFields(fields: Array_Type<string>): Organization;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): Organization;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): Organization;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Organization;
   ...
   * @see #unsetField
   */
  defaultField(field: string): Organization;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): Organization;
   ...
   * @see #removeField
   */
  unsetField(field: string): Organization;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): Organization;
   ...
   * @see #unsetField
   */
  removeField(field: string): Organization;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): Organization;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Organization;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): Organization;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Organization;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Organization;

  mergeJson(json: any): Organization;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Organization;
   ...
   */
  sumObj(other: Obj, deep?: boolean): Organization;
   ...
   */
  singletonArray(): Array_Type<Organization>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<Organization> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<Organization> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<Organization>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<Organization> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, Organization> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, Organization> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<Organization>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<Organization>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Organization;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Organization;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Organization;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): Organization;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Organization;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): Organization;
   ...
   * @see #fromString
   */
  static make(s: string): Organization | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Organization;
   ...
   */
  static cachedEmptyInst(): Organization;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<Organization> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): Organization;
   ...
   */
  static populateAcl(objs?: Array_Type<Organization>): number | null;
   ...
   */
  grantMemberReadUpdateRemove(member: AccessControlEntity): Organization;
   ...
   */
  mergeAclEntry(entry: AclEntry): Organization;
   ...
   * @return the obj with the new acl after merging the indicated entry.
   */
  mergeAclEntries(entries: Array_Type<AclEntry>): Organization;
   ...
   * @see #toString
   */
  static fromString(s: string): Organization | null;
   ...
   */
  create(spec?: UpsertSpec): Organization | null;
   ...
   */
  static createBatch(objs: Array_Type<Organization>, spec?: UpsertSpec): ObjList<Organization> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<Organization>, spec?: CreateBatchObjStreamSpec): ObjList<Organization> | null;
   ...
   */
  update(srcObj?: Organization, spec?: UpsertSpec): Organization | null;
   ...
   */
  upsert(srcObj?: Organization, spec?: UpsertSpec): Organization | null;
   ...
   */
  merge(spec?: MergeSpec): Organization | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): Organization | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): Organization | null;
   ...
   */
  static updateBatch(objs: Array_Type<Organization>, srcObjs?: Array_Type<Organization>, spec?: UpsertSpec): ObjList<Organization> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<Organization> | null>, spec?: UpsertSpec): ObjList<Organization> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<Organization>, srcObjs?: Array_Type<Organization>, spec?: UpsertSpec): ObjList<Organization> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<Organization> | null>, spec?: UpsertSpec): ObjList<Organization> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<Organization>, spec?: TouchSpec): ObjList<Organization> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<Organization>, spec?: MergeSpec): ObjList<Organization> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<Organization>, mergeInclude: string, spec?: MergeSpec): ObjList<Organization> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<Organization> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Organization> | null;
   ...
   */
  static mergeAll(mergeObj: Organization, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: Organization, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<Organization>, spec?: UpsertSpec): ObjList<Organization> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<Organization>, spec?: UpsertSpec): ObjList<Organization> | null;
   ...
   */
  static beforeCreate(objs: Array_Type<Organization>): ObjList<Organization>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<Organization>): ObjList<Organization>;

  /**
   * Overridden beforeRemove function to check for any {@link FixedAsset}s that reference
   * the Organization in addition to checking for sub-Organizations.
   */
  static beforeRemove(objs: Array_Type<Organization>): ObjList<Organization>;
   ...
   */
  static afterCreate(objs: Array_Type<Organization>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<Organization>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<Organization>): Array_Type<ObjError> | null;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<Organization>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<Organization>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<Organization> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Organization>> | null;
   ...
   */
  static evalFeatureSetBatch(batch: Array_Type<Organization>, featureSet: Feature.Set, spec?: EvalFeatureSpec): Data | null;
   ...
   * ```
   */
  static evalFeaturesBatch(batch: Array_Type<Organization>, features: Array_Type<string>, spec?: EvalFeaturesSpec): Data | null;
   ...
   */
  get(include?: string): Organization | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): Organization | null;
   ...
   */
  getMissing(spec: GetMissingSpec): Organization;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): Organization | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): Organization;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<Organization>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Organization>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): Organization | null;
   ...
   */
  withoutIdentity(): Organization | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<Organization>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: Organization, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<Organization>, callback?: λFunction<Organization | null, Organization | null>): ObjList<Organization>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<Organization>, callback?: λFunction<Organization | null, Organization | null>): Array_Type<ObjError> | null;
