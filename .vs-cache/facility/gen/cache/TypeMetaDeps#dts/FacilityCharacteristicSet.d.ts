// TypeScript definitions for the C3 type FacilityCharacteristicSet
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of FacilityCharacteristicSet
 */
declare interface IFacilityCharacteristicSet {
 ...
 */
declare class FacilityCharacteristicSet extends Obj  {

  /**
   * Timestamp for the value.
   */
  readonly timestamp: DateTime;
  withTimestamp(timestamp: DateTime | Date | string): FacilityCharacteristicSet;

  /**
   * Characteristic name.
   */
  readonly name: string;
  withName(name: string): FacilityCharacteristicSet;

  /**
   * Parent/owning obj instance.
   */
  readonly parent: Facility;
  withParent(parent: IFacility): FacilityCharacteristicSet;

  readonly value?: string;
  withValue(value: string | null): FacilityCharacteristicSet;
  ...
  withTypeIdent(typeIdent: string | null): FacilityCharacteristicSet;
   ...
   */
  readonly id: string;
  withId(id: string): FacilityCharacteristicSet;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): FacilityCharacteristicSet;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): FacilityCharacteristicSet;
  ...
  withVersion(version: number | null): FacilityCharacteristicSet;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): FacilityCharacteristicSet;
   ...
   * @see #toJson
   */
  static fromJson(json: any): FacilityCharacteristicSet | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): FacilityCharacteristicSet | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): FacilityCharacteristicSet | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): FacilityCharacteristicSet | null;
   ...
   */
  replaceType(old: Type, new_: Type): FacilityCharacteristicSet;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): FacilityCharacteristicSet;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): FacilityCharacteristicSet;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<FacilityCharacteristicSet>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<FacilityCharacteristicSet>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): FacilityCharacteristicSet;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): FacilityCharacteristicSet;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): FacilityCharacteristicSet;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): FacilityCharacteristicSet;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): FacilityCharacteristicSet;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): FacilityCharacteristicSet;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): FacilityCharacteristicSet;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): FacilityCharacteristicSet;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): FacilityCharacteristicSet;
   ...
   * @see #removeField
   */
  withoutField(field: string): FacilityCharacteristicSet;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): FacilityCharacteristicSet;
   ...
   */
  withoutFields(fields: Array_Type<string>): FacilityCharacteristicSet;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): FacilityCharacteristicSet;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): FacilityCharacteristicSet;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): FacilityCharacteristicSet;
   ...
   * @see #unsetField
   */
  defaultField(field: string): FacilityCharacteristicSet;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): FacilityCharacteristicSet;
   ...
   * @see #removeField
   */
  unsetField(field: string): FacilityCharacteristicSet;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): FacilityCharacteristicSet;
   ...
   * @see #unsetField
   */
  removeField(field: string): FacilityCharacteristicSet;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): FacilityCharacteristicSet;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): FacilityCharacteristicSet;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): FacilityCharacteristicSet;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): FacilityCharacteristicSet;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): FacilityCharacteristicSet;

  mergeJson(json: any): FacilityCharacteristicSet;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): FacilityCharacteristicSet;
   ...
   */
  sumObj(other: Obj, deep?: boolean): FacilityCharacteristicSet;
   ...
   */
  singletonArray(): Array_Type<FacilityCharacteristicSet>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<FacilityCharacteristicSet> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<FacilityCharacteristicSet> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<FacilityCharacteristicSet>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<FacilityCharacteristicSet> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, FacilityCharacteristicSet> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, FacilityCharacteristicSet> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<FacilityCharacteristicSet>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<FacilityCharacteristicSet>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): FacilityCharacteristicSet;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): FacilityCharacteristicSet;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): FacilityCharacteristicSet;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): FacilityCharacteristicSet;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): FacilityCharacteristicSet;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): FacilityCharacteristicSet;
   ...
   * @see #fromString
   */
  static make(s: string): FacilityCharacteristicSet | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): FacilityCharacteristicSet;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): FacilityCharacteristicSet;
   ...
   */
  static cachedEmptyInst(): FacilityCharacteristicSet;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<FacilityCharacteristicSet> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): FacilityCharacteristicSet;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<FacilityCharacteristicSet>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<FacilityCharacteristicSet>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<FacilityCharacteristicSet> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<FacilityCharacteristicSet>> | null;
   ...
   */
  get(include?: string): FacilityCharacteristicSet | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): FacilityCharacteristicSet | null;
   ...
   */
  getMissing(spec: GetMissingSpec): FacilityCharacteristicSet;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): FacilityCharacteristicSet | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): FacilityCharacteristicSet;
   ...
   * @see #toString
   */
  static fromString(s: string): FacilityCharacteristicSet | null;
   ...
   */
  create(spec?: UpsertSpec): FacilityCharacteristicSet | null;
   ...
   */
  static createBatch(objs: Array_Type<FacilityCharacteristicSet>, spec?: UpsertSpec): ObjList<FacilityCharacteristicSet> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<FacilityCharacteristicSet>, spec?: CreateBatchObjStreamSpec): ObjList<FacilityCharacteristicSet> | null;
   ...
   */
  update(srcObj?: FacilityCharacteristicSet, spec?: UpsertSpec): FacilityCharacteristicSet | null;
   ...
   */
  upsert(srcObj?: FacilityCharacteristicSet, spec?: UpsertSpec): FacilityCharacteristicSet | null;
   ...
   */
  merge(spec?: MergeSpec): FacilityCharacteristicSet | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): FacilityCharacteristicSet | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): FacilityCharacteristicSet | null;
   ...
   */
  static updateBatch(objs: Array_Type<FacilityCharacteristicSet>, srcObjs?: Array_Type<FacilityCharacteristicSet>, spec?: UpsertSpec): ObjList<FacilityCharacteristicSet> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<FacilityCharacteristicSet> | null>, spec?: UpsertSpec): ObjList<FacilityCharacteristicSet> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<FacilityCharacteristicSet>, srcObjs?: Array_Type<FacilityCharacteristicSet>, spec?: UpsertSpec): ObjList<FacilityCharacteristicSet> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<FacilityCharacteristicSet> | null>, spec?: UpsertSpec): ObjList<FacilityCharacteristicSet> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<FacilityCharacteristicSet>, spec?: TouchSpec): ObjList<FacilityCharacteristicSet> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<FacilityCharacteristicSet>, spec?: MergeSpec): ObjList<FacilityCharacteristicSet> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<FacilityCharacteristicSet>, mergeInclude: string, spec?: MergeSpec): ObjList<FacilityCharacteristicSet> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<FacilityCharacteristicSet> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<FacilityCharacteristicSet> | null;
   ...
   */
  static mergeAll(mergeObj: FacilityCharacteristicSet, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: FacilityCharacteristicSet, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<FacilityCharacteristicSet>, spec?: UpsertSpec): ObjList<FacilityCharacteristicSet> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<FacilityCharacteristicSet>, spec?: UpsertSpec): ObjList<FacilityCharacteristicSet> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): FacilityCharacteristicSet | null;
   ...
   */
  static beforeCreate(objs: Array_Type<FacilityCharacteristicSet>): ObjList<FacilityCharacteristicSet>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<FacilityCharacteristicSet>): ObjList<FacilityCharacteristicSet>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<FacilityCharacteristicSet>): ObjList<FacilityCharacteristicSet>;
   ...
   */
  static afterCreate(objs: Array_Type<FacilityCharacteristicSet>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<FacilityCharacteristicSet>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<FacilityCharacteristicSet>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<FacilityCharacteristicSet>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<FacilityCharacteristicSet>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): FacilityCharacteristicSet | null;
   ...
   */
  withoutIdentity(): FacilityCharacteristicSet | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<FacilityCharacteristicSet>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: FacilityCharacteristicSet, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<FacilityCharacteristicSet>, callback?: λFunction<FacilityCharacteristicSet | null, FacilityCharacteristicSet | null>): ObjList<FacilityCharacteristicSet>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<FacilityCharacteristicSet>, callback?: λFunction<FacilityCharacteristicSet | null, FacilityCharacteristicSet | null>): Array_Type<ObjError> | null;
