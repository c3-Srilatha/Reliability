...
class Facility(FixedAsset):
    ...
    parentRelations: Optional[Array[PhysicalAssetHierarchyRelation]]=None
    """
    ...
    parent: Optional[FixedAsset]=None
    """
    The including asset
    """
    ...
    """
    def __init__(self, acl: Optional[Array[AclEntry]]=None, id: Optional[str]=None, weatherStation: Optional[WeatherStation]=None, typeIdent: Optional[str]=None, versionEdits: Optional[Array[VersionEdit]]=None, name: Optional[str]=None, meta: Optional[Meta]=None, version: Optional[int]=None, typeWithBindings: Optional[Type]=None, locationHistory: Optional[Array[PhysicalAssetLocationHistory]]=None, location: Optional[PhysicalAssetLocation]=None, description: Optional[str]=None, realTimeLocations: Optional[Array[PhysicalAssetRealTimeLocation]]=None, parentRelations: Optional[Array[PhysicalAssetHierarchyRelation]]=None, childRelations: Optional[Array[PhysicalAssetHierarchyRelation]]=None, denormAncestors: Optional[Array[PhysicalAssetHierarchyDenorm]]=None, denormDescendants: Optional[Array[PhysicalAssetHierarchyDenorm]]=None, relativePositionHistory: Optional[Array[PhysicalAssetRelativePositionHistory]]=None, relativePosition: Optional[PhysicalAssetRelativePosition]=None, measurements: Optional[Array[BasePhysicalMeasurementSeries]]=None, pointMeasurements: Optional[Array[PointPhysicalMeasurementSeries]]=None, events: Optional[Array[PhysicalAssetEvent]]=None, placedAt: Optional[Location]=None, parent: Optional[FixedAsset]=None, children: Optional[Array[FixedAsset]]=None, denormParents: Optional[Array[AssetHierarchyDenorm]]=None, denormChildren: Optional[Array[AssetHierarchyDenorm]]=None, assetOwners: Optional[Array[AssetOwner]]=None, orgs: Optional[Array[Organization]]=None, partyRelations: Optional[Array[AssetPartyRole]]=None, partyRoles: Optional[Array[PartyRole]]=None, regions: Optional[Array[Region]]=None, regionParents: Optional[Array[Region]]=None, allRegionParents: Optional[Array[Region]]=None, geometry: Optional[LatLong]=None, address1: Optional[str]=None, city: Optional[str]=None, state: Optional[str]=None, postal_code: Optional[str]=None, facilityType: Optional[str]=None, characteristics: Optional[Array[FacilityCharacteristicSet]]=None) -> None: ...
