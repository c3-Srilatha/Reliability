// TypeScript definitions for the C3 type Currency
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of Currency
 */
 ...
 */
declare class Currency extends Obj  {
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Currency;

  /**
   * Name of the {@link Currency}.
   */
  readonly name: string;
  withName(name: string): Currency;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): Currency;
  ...
  withVersion(version: number | null): Currency;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): Currency;
  ...
  withUserUpdatedFields(userUpdatedFields: Array_Type<string> | Array<string> | null): Currency;
  ...
  withHidden(hidden: boolean): Currency;
  ...
  withUserOwned(userOwned: boolean): Currency;
  ...
  withTypeIdent(typeIdent: string | null): Currency;

  /**
   * Code used to represent the {@link Currency} in iso format e.g. USD, EUR.
   */
  readonly code: string;
  withCode(code: string): Currency;

  /**
   * Shorthand for the {@link Currency}'s name, especially in reference to amounts of money e.g. $.
   */
  readonly symbol?: string;
  withSymbol(symbol: string | null): Currency;

  /**
   * Subdivision of the {@link Currency}.
   */
  readonly fractionalUnit?: string;
  withFractionalUnit(fractionalUnit: string | null): Currency;

  /**
   * Conversion factor from subdivision unit to basic unit of the {@link Currency}.
   */
  readonly numberToBasic?: number;
  withNumberToBasic(numberToBasic: number | null): Currency;
   ...
   * @see #toJson
   */
  static fromJson(json: any): Currency | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): Currency | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): Currency | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): Currency | null;
   ...
   */
  replaceType(old: Type, new_: Type): Currency;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Currency;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Currency;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Currency>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Currency>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Currency;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Currency;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Currency;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): Currency;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): Currency;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): Currency;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Currency;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Currency;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): Currency;
   ...
   * @see #removeField
   */
  withoutField(field: string): Currency;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): Currency;
   ...
   */
  withoutFields(fields: Array_Type<string>): Currency;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): Currency;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): Currency;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Currency;
   ...
   * @see #unsetField
   */
  defaultField(field: string): Currency;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): Currency;
   ...
   * @see #removeField
   */
  unsetField(field: string): Currency;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): Currency;
   ...
   * @see #unsetField
   */
  removeField(field: string): Currency;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): Currency;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Currency;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): Currency;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Currency;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Currency;

  mergeJson(json: any): Currency;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Currency;
   ...
   */
  sumObj(other: Obj, deep?: boolean): Currency;
   ...
   */
  singletonArray(): Array_Type<Currency>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<Currency> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<Currency> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<Currency>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<Currency> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, Currency> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, Currency> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<Currency>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<Currency>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Currency;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Currency;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Currency;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): Currency;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Currency;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): Currency;
   ...
   * @see #fromString
   */
  static make(s: string): Currency | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Currency;
   ...
   */
  static cachedEmptyInst(): Currency;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<Currency> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): Currency;
   ...
   */
  static allCached(): Stream<Currency> | null;
   ...
   */
  static find(filter?: string): Stream<Currency> | null;
   ...
   *         Otherwise no population will be performed.
   */
  static findBy(field: string, value: any): Stream<Currency> | null;

  /**
   * @return cached instance.
   */
  getCached(): Currency | null;

  /**
   * @return cached instance by the key.
   */
  static forCacheKey(key: string): Currency | null;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<Currency>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<Currency>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<Currency> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Currency>> | null;
   ...
   */
  get(include?: string): Currency | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): Currency | null;
   ...
   */
  getMissing(spec: GetMissingSpec): Currency;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): Currency | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): Currency;
   ...
   * @see #toString
   */
  static fromString(s: string): Currency | null;
   ...
   */
  create(spec?: UpsertSpec): Currency | null;
   ...
   */
  static createBatch(objs: Array_Type<Currency>, spec?: UpsertSpec): ObjList<Currency> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<Currency>, spec?: CreateBatchObjStreamSpec): ObjList<Currency> | null;
   ...
   */
  update(srcObj?: Currency, spec?: UpsertSpec): Currency | null;
   ...
   */
  upsert(srcObj?: Currency, spec?: UpsertSpec): Currency | null;
   ...
   */
  merge(spec?: MergeSpec): Currency | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): Currency | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): Currency | null;
   ...
   */
  static updateBatch(objs: Array_Type<Currency>, srcObjs?: Array_Type<Currency>, spec?: UpsertSpec): ObjList<Currency> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<Currency> | null>, spec?: UpsertSpec): ObjList<Currency> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<Currency>, srcObjs?: Array_Type<Currency>, spec?: UpsertSpec): ObjList<Currency> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<Currency> | null>, spec?: UpsertSpec): ObjList<Currency> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<Currency>, spec?: TouchSpec): ObjList<Currency> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<Currency>, spec?: MergeSpec): ObjList<Currency> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<Currency>, mergeInclude: string, spec?: MergeSpec): ObjList<Currency> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<Currency> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Currency> | null;
   ...
   */
  static mergeAll(mergeObj: Currency, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: Currency, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<Currency>, spec?: UpsertSpec): ObjList<Currency> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<Currency>, spec?: UpsertSpec): ObjList<Currency> | null;
   ...
   */
  static beforeCreate(objs: Array_Type<Currency>): ObjList<Currency>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<Currency>): ObjList<Currency>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<Currency>): ObjList<Currency>;
   ...
   */
  static afterCreate(objs: Array_Type<Currency>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<Currency>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<Currency>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<Currency>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Currency>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): Currency | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<Currency>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: Currency, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<Currency>, callback?: λFunction<Currency | null, Currency | null>): ObjList<Currency>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<Currency>, callback?: λFunction<Currency | null, Currency | null>): Array_Type<ObjError> | null;
   ...
   */
  publish(subPath?: string, contentType?: string): Currency;
   ...
   */
  static removeSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<Currency> | null;
   ...
   */
  createSeedData(spec?: UpsertSpec): Currency | null;
   ...
   */
  static createSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<Currency> | null;
   ...
   */
  updateSeedData(srcObj?: SeedData, spec?: UpsertSpec): Currency | null;
   ...
   */
  static updateSeedDataBatch(objs?: Array_Type<SeedData>, srcObjs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<Currency> | null;
   ...
   * @return updated obj instance, same as {@link Persistable#update} return value.
   */
  clearUserUpdates(spec?: MergeSpec): Currency | null;
   ...
   *         {@link Persistable#updateBatch}.
   */
  static clearUserUpdatesBatch(objs?: Array_Type<SeedData>, spec?: MergeSpec): ObjList<Currency> | null;
  ...
  dependencies(): SeedDataDeps<Currency> | null;
