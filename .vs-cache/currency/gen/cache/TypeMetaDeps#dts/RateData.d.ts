// TypeScript definitions for the C3 type RateData

/**
 * Conversion rate value for a time interval.
 *
 * @remarks this represents a value passed to a method that expects an instance of RateData
 */
declare interface IRateData {
 ...
 */
declare class RateData extends Obj  {

  /**
   * start date for the data point
   */
  readonly start: DateTime;
  withStart(start: DateTime | Date | string): RateData;
  ...
  withOutlierCode(outlierCode: number | null): RateData;

  /**
   * (Optional) any comments for the data point
   */
  readonly comments?: string;
  withComments(comments: string | null): RateData;

  /**
   * Denotes if the value is an actual value or an estimated value. default = null (actual value)
   */
  readonly isEstimated?: boolean;
  withIsEstimated(isEstimated: boolean): RateData;
  ...
  withDataVersion(dataVersion: number | null): RateData;

  /**
   * Customer specific status code for the data point (may be used to denote data quality)
   */
  readonly statusCode?: string;
  withStatusCode(statusCode: string | null): RateData;

  /**
   * end date for the data point (Only applicable for Interval Timeseries)
   */
  readonly end: DateTime;
  withEnd(end: DateTime | Date | string): RateData;

  /**
   * Partition key Bin separator used to separate partition key from bin id
   */
  readonly PK_BIN_SEPARATOR?: string;
  withPK_BIN_SEPARATOR(PK_BIN_SEPARATOR: string | null): RateData;

  readonly parent: Rate;
  withParent(parent: IRate): RateData;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): RateData;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): RateData;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): RateData;
  ...
  withVersion(version: number | null): RateData;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): RateData;
  ...
  withUserUpdatedFields(userUpdatedFields: Array_Type<string> | Array<string> | null): RateData;
  ...
  withHidden(hidden: boolean): RateData;
  ...
  withUserOwned(userOwned: boolean): RateData;

  /**
   * Rate value
   */
  readonly conversion: number;
  withConversion(conversion: number): RateData;
   ...
   * @see #toJson
   */
  static fromJson(json: any): RateData | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): RateData | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): RateData | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): RateData | null;
   ...
   */
  replaceType(old: Type, new_: Type): RateData;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): RateData;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): RateData;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<RateData>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<RateData>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): RateData;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): RateData;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): RateData;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): RateData;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): RateData;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): RateData;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): RateData;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): RateData;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): RateData;
   ...
   * @see #removeField
   */
  withoutField(field: string): RateData;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): RateData;
   ...
   */
  withoutFields(fields: Array_Type<string>): RateData;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): RateData;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): RateData;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): RateData;
   ...
   * @see #unsetField
   */
  defaultField(field: string): RateData;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): RateData;
   ...
   * @see #removeField
   */
  unsetField(field: string): RateData;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): RateData;
   ...
   * @see #unsetField
   */
  removeField(field: string): RateData;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): RateData;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): RateData;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): RateData;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): RateData;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): RateData;

  mergeJson(json: any): RateData;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): RateData;
   ...
   */
  sumObj(other: Obj, deep?: boolean): RateData;
   ...
   */
  singletonArray(): Array_Type<RateData>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<RateData> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<RateData> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<RateData>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<RateData> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, RateData> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, RateData> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<RateData>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<RateData>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): RateData;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): RateData;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): RateData;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): RateData;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): RateData;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): RateData;
   ...
   * @see #fromString
   */
  static make(s: string): RateData | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): RateData;
   ...
   */
  static cachedEmptyInst(): RateData;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<RateData> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): RateData;

  /**
   * Extract the partition key from the given obj
   */
  partitionKey(failIfMissing?: boolean): Rate | null;
   ...
   */
  static partition(objs?: Stream<RateData>, spec?: PartitionBucketStrategy): Map_Type<string, KvDataPartition> | null;
   ...
   */
  static fromPartitions(partitions?: Stream<KvDataPartition>): Stream<RateData> | null;
   ...
   */
  static allCached(): Stream<RateData> | null;
   ...
   */
  static find(filter?: string): Stream<RateData> | null;
   ...
   *         Otherwise no population will be performed.
   */
  static findBy(field: string, value: any): Stream<RateData> | null;

  /**
   * @return cached instance.
   */
  getCached(): RateData | null;

  /**
   * @return cached instance by the key.
   */
  static forCacheKey(key: string): RateData | null;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<RateData>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<RateData>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<RateData> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<RateData>> | null;
   ...
   */
  get(include?: string): RateData | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): RateData | null;
   ...
   */
  getMissing(spec: GetMissingSpec): RateData;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): RateData | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): RateData;
   ...
   * @see #toString
   */
  static fromString(s: string): RateData | null;
   ...
   */
  create(spec?: UpsertSpec): RateData | null;
   ...
   */
  static createBatch(objs: Array_Type<RateData>, spec?: UpsertSpec): ObjList<RateData> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<RateData>, spec?: CreateBatchObjStreamSpec): ObjList<RateData> | null;
   ...
   */
  update(srcObj?: RateData, spec?: UpsertSpec): RateData | null;
   ...
   */
  upsert(srcObj?: RateData, spec?: UpsertSpec): RateData | null;
   ...
   */
  merge(spec?: MergeSpec): RateData | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): RateData | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): RateData | null;
   ...
   */
  static updateBatch(objs: Array_Type<RateData>, srcObjs?: Array_Type<RateData>, spec?: UpsertSpec): ObjList<RateData> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<RateData> | null>, spec?: UpsertSpec): ObjList<RateData> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<RateData>, srcObjs?: Array_Type<RateData>, spec?: UpsertSpec): ObjList<RateData> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<RateData> | null>, spec?: UpsertSpec): ObjList<RateData> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<RateData>, spec?: TouchSpec): ObjList<RateData> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<RateData>, spec?: MergeSpec): ObjList<RateData> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<RateData>, mergeInclude: string, spec?: MergeSpec): ObjList<RateData> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<RateData> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<RateData> | null;
   ...
   */
  static mergeAll(mergeObj: RateData, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: RateData, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<RateData>, spec?: UpsertSpec): ObjList<RateData> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<RateData>, spec?: UpsertSpec): ObjList<RateData> | null;
   ...
   */
  static beforeCreate(objs: Array_Type<RateData>): ObjList<RateData>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<RateData>): ObjList<RateData>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<RateData>): ObjList<RateData>;
   ...
   */
  static afterCreate(objs: Array_Type<RateData>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<RateData>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<RateData>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<RateData>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<RateData>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): RateData | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<RateData>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: RateData, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<RateData>, callback?: λFunction<RateData | null, RateData | null>): ObjList<RateData>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<RateData>, callback?: λFunction<RateData | null, RateData | null>): Array_Type<ObjError> | null;
   ...
   */
  publish(subPath?: string, contentType?: string): RateData;
   ...
   */
  static removeSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<RateData> | null;
   ...
   */
  createSeedData(spec?: UpsertSpec): RateData | null;
   ...
   */
  static createSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<RateData> | null;
   ...
   */
  updateSeedData(srcObj?: SeedData, spec?: UpsertSpec): RateData | null;
   ...
   */
  static updateSeedDataBatch(objs?: Array_Type<SeedData>, srcObjs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<RateData> | null;
   ...
   * @return updated obj instance, same as {@link Persistable#update} return value.
   */
  clearUserUpdates(spec?: MergeSpec): RateData | null;
   ...
   *         {@link Persistable#updateBatch}.
   */
  static clearUserUpdatesBatch(objs?: Array_Type<SeedData>, spec?: MergeSpec): ObjList<RateData> | null;
  ...
  dependencies(): SeedDataDeps<RateData> | null;
