// TypeScript definitions for the C3 type Rate

/**
 * Price history of a {@link Currency} into another {@link Currency}.
 *
 * @remarks this represents a value passed to a method that expects an instance of Rate
 */
declare interface IRate {
   ...
   */
  data?: Array_Type<RateData> | Array<IRateData>;
 ...
 */
declare class Rate extends Obj  {

  /**
   * Populated on normalization. Indicates the earliest data point across various timeseries fields.
   */
  readonly earliest?: DateTime;
  withEarliest(earliest: DateTime | Date | string | null): Rate;

  /**
   * Populated on normalization. Indicates the latest data point across various timeseries fields.
   */
  readonly latest?: DateTime;
  withLatest(latest: DateTime | Date | string | null): Rate;

  /**
   * Populated on normalization. Indicates the earliest data point for each {@link Ann.Ts} fields.
   */
  readonly earliestTsDp?: Map_Type<string, TSDataPoint>;
  withEarliestTsDp(earliestTsDp: Map_Type<string, TSDataPoint> | {[key: string]: ITSDataPoint} | null): Rate;

  /**
   * Populated on normalization. Indicates the latest data point for each {@link Ann.Ts} fields.
   */
  readonly latestTsDp?: Map_Type<string, TSDataPoint>;
  withLatestTsDp(latestTsDp: Map_Type<string, TSDataPoint> | {[key: string]: ITSDataPoint} | null): Rate;
  ...
  withInterval(interval: string | null): Rate;

  /**
   * If set, the time series will be normalized in the specified zone.
   */
  readonly timeZone?: string;
  withTimeZone(timeZone: string | null): Rate;

  /**
   * If set, disables normalizing this time series. Invalidations will still continue to happen for this series normally.
   */
  readonly doNotNormalize?: boolean;
  withDoNotNormalize(doNotNormalize: boolean): Rate;

  /**
   * Data points corresponding to this timeseries header
   */
  readonly data?: Array_Type<RateData>;
  withData(data: Array_Type<RateData> | Array<IRateData> | null): Rate;

  /**
   * Use this field to specify the interpolation mechanism to be applied for gaps in interval timeseries. Default: `ZERO_INTERPOLATOR`.
   */
  readonly interpolator?: string;
  withInterpolator(interpolator: string | null): Rate;

  /**
   * Use this field to specify how normalization should handle duplicate data points. A duplicate point is one that has the same start, end, value, unit, and {@link TimedDataPointFields#isEstimated} values. Default: `IGNORE`.
   */
  readonly duplicateHandling?: string;
  withDuplicateHandling(duplicateHandling: string | null): Rate;

  /**
   * Used to specify how normalization should handle overlapping data points. Default: `AVG`.
   */
  readonly overlapHandling?: string;
  withOverlapHandling(overlapHandling: string | null): Rate;
  ...
  withBucketInterval(bucketInterval: string | null): Rate;
  ...
  withNormalizationPartitionStrategy(normalizationPartitionStrategy: INormalizationPartitionStrategy | null): Rate;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Rate;

  /**
   * Name of the {@link Rate}.
   */
  readonly name: string;
  withName(name: string): Rate;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): Rate;
  ...
  withVersion(version: number | null): Rate;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): Rate;
  ...
  withUserUpdatedFields(userUpdatedFields: Array_Type<string> | Array<string> | null): Rate;
  ...
  withHidden(hidden: boolean): Rate;
  ...
  withUserOwned(userOwned: boolean): Rate;

  /**
   * Symbole of the {@link Rate}.
   */
  readonly symbol: string;
  withSymbol(symbol: string): Rate;

  /**
   * {@link Exchange} used for the {@link Rate}.
   */
  readonly exchange?: Exchange;
  withExchange(exchange: IExchange | null): Rate;

  /**
   * Domestic {@link Currency} for the {@link Rate}.
   */
  readonly from: Currency;
  withFrom(from: ICurrency): Rate;

  /**
   * Foreign {@link Currency} for the {@link Rate}.
   */
  readonly to: Currency;
  withTo(to: ICurrency): Rate;
   ...
   * @see #toJson
   */
  static fromJson(json: any): Rate | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): Rate | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): Rate | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): Rate | null;
   ...
   */
  replaceType(old: Type, new_: Type): Rate;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Rate;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Rate;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Rate>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Rate>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Rate;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Rate;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Rate;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): Rate;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): Rate;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Rate;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Rate;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): Rate;
   ...
   * @see #removeField
   */
  withoutField(field: string): Rate;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): Rate;
   ...
   */
  withoutFields(fields: Array_Type<string>): Rate;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): Rate;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): Rate;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Rate;
   ...
   * @see #unsetField
   */
  defaultField(field: string): Rate;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): Rate;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): Rate;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): Rate;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Rate;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): Rate;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Rate;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Rate;

  mergeJson(json: any): Rate;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Rate;
   ...
   */
  sumObj(other: Obj, deep?: boolean): Rate;
   ...
   */
  singletonArray(): Array_Type<Rate>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<Rate> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<Rate> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<Rate>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<Rate> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, Rate> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, Rate> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<Rate>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<Rate>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Rate;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Rate;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Rate;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): Rate;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Rate;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): Rate;
   ...
   * @see #fromString
   */
  static make(s: string): Rate | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Rate;
   ...
   */
  static cachedEmptyInst(): Rate;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<Rate> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): Rate;
   ...
   */
  static normalizeTimeseries(timeseries?: TimedDataFields<RateData>, start?: DateTime, end?: DateTime, overrideGrain?: string, forceGrainDetection?: boolean, force?: boolean): void;
   ...
   */
  static normalize(timeseries?: TimedDataFields<RateData>, start?: DateTime, end?: DateTime, overrideGrain?: string, forceGrainDetection?: boolean): NormalizationResult | null;
   ...
   */
  static normalizationUnit(rawHeader: TimedDataFields<RateData>, tsField: string): Unit | null;
   ...
   */
  static normalizationTreatment(rawHeader: TimedDataFields<RateData>, tsField: string): string;
   ...
   */
  static allCached(): Stream<Rate> | null;
   ...
   */
  static find(filter?: string): Stream<Rate> | null;
   ...
   *         Otherwise no population will be performed.
   */
  static findBy(field: string, value: any): Stream<Rate> | null;
   ...
   */
  static forCacheKey(key: string): Rate | null;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<Rate>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<Rate>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<Rate> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Rate>> | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): Rate | null;
   ...
   */
  getMissing(spec: GetMissingSpec): Rate;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): Rate | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): Rate;
   ...
   * @see #toString
   */
  static fromString(s: string): Rate | null;
   ...
   */
  create(spec?: UpsertSpec): Rate | null;
   ...
   */
  static createBatch(objs: Array_Type<Rate>, spec?: UpsertSpec): ObjList<Rate> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<Rate>, spec?: CreateBatchObjStreamSpec): ObjList<Rate> | null;
   ...
   */
  update(srcObj?: Rate, spec?: UpsertSpec): Rate | null;
   ...
   */
  upsert(srcObj?: Rate, spec?: UpsertSpec): Rate | null;
   ...
   */
  merge(spec?: MergeSpec): Rate | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): Rate | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): Rate | null;
   ...
   */
  static updateBatch(objs: Array_Type<Rate>, srcObjs?: Array_Type<Rate>, spec?: UpsertSpec): ObjList<Rate> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<Rate> | null>, spec?: UpsertSpec): ObjList<Rate> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<Rate>, srcObjs?: Array_Type<Rate>, spec?: UpsertSpec): ObjList<Rate> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<Rate> | null>, spec?: UpsertSpec): ObjList<Rate> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<Rate>, spec?: TouchSpec): ObjList<Rate> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<Rate>, spec?: MergeSpec): ObjList<Rate> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<Rate>, mergeInclude: string, spec?: MergeSpec): ObjList<Rate> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<Rate> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Rate> | null;
   ...
   */
  static mergeAll(mergeObj: Rate, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: Rate, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<Rate>, spec?: UpsertSpec): ObjList<Rate> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<Rate>, spec?: UpsertSpec): ObjList<Rate> | null;
   ...
   */
  static beforeCreate(objs: Array_Type<Rate>): ObjList<Rate>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<Rate>): ObjList<Rate>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<Rate>): ObjList<Rate>;
   ...
   */
  static afterCreate(objs: Array_Type<Rate>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<Rate>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<Rate>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<Rate>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Rate>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): Rate | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<Rate>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: Rate, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<Rate>, callback?: λFunction<Rate | null, Rate | null>): ObjList<Rate>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<Rate>, callback?: λFunction<Rate | null, Rate | null>): Array_Type<ObjError> | null;
   ...
   */
  publish(subPath?: string, contentType?: string): Rate;
   ...
   */
  static removeSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<Rate> | null;
   ...
   */
  createSeedData(spec?: UpsertSpec): Rate | null;
   ...
   */
  static createSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<Rate> | null;
   ...
   */
  updateSeedData(srcObj?: SeedData, spec?: UpsertSpec): Rate | null;
   ...
   */
  static updateSeedDataBatch(objs?: Array_Type<SeedData>, srcObjs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<Rate> | null;
   ...
   * @return updated obj instance, same as {@link Persistable#update} return value.
   */
  clearUserUpdates(spec?: MergeSpec): Rate | null;
   ...
   *         {@link Persistable#updateBatch}.
   */
  static clearUserUpdatesBatch(objs?: Array_Type<SeedData>, spec?: MergeSpec): ObjList<Rate> | null;
  ...
  dependencies(): SeedDataDeps<Rate> | null;
