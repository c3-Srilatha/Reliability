// TypeScript definitions for the C3 type AssetDocument

/**
 * A type to link a diagram, which is used a `UiSdlImage` to a {@link ReliabilityAsset}
 *
 * @remarks this represents a value passed to a method that expects an instance of AssetDocument
 */
declare interface IAssetDocument {
 ...
 */
declare class AssetDocument extends Obj  {

  /**
   * The information of the {@link User} that created it.
   */
  readonly createdByUser?: User;
  withCreatedByUser(createdByUser: IUser | null): AssetDocument;
   ...
   */
  readonly id: string;
  withId(id: string): AssetDocument;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): AssetDocument;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): AssetDocument;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): AssetDocument;
  ...
  withVersion(version: number | null): AssetDocument;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): AssetDocument;

  /**
   * @inheritdoc
   */
  readonly facilityFilterPaths?: Array_Type<string>;
  withFacilityFilterPaths(facilityFilterPaths: Array_Type<string> | Array<string> | null): AssetDocument;

  /**
   * Description of the document.
   */
  readonly description?: string;
  withDescription(description: string | null): AssetDocument;

  /**
   * The relative URL of attached document used by File API to upload and download document. Starts with `/file/`.
   */
  readonly fileUrl?: string;
  withFileUrl(fileUrl: string | null): AssetDocument;

  /**
   * The {@link ReliabilityAsset} associated with this document.
   */
  readonly asset: ReliabilityAsset;
  withAsset(asset: IReliabilityAsset): AssetDocument;

  /**
   * File containing image for the Subsystem
   */
  readonly imageFile?: File;
  withImageFile(imageFile: IFile | null): AssetDocument;

  /**
   * URL field useable in the UI.
   */
  readonly displayUrl?: string;
  withDisplayUrl(displayUrl: string | null): AssetDocument;

  /**
   * This is typically used to link to an external resource or website associated with the document.
   */
  readonly externalurl?: string;
  withExternalurl(externalurl: string | null): AssetDocument;
   ...
   * @see #toJson
   */
  static fromJson(json: any): AssetDocument | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): AssetDocument | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): AssetDocument | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): AssetDocument | null;
   ...
   */
  replaceType(old: Type, new_: Type): AssetDocument;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): AssetDocument;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): AssetDocument;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<AssetDocument>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<AssetDocument>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): AssetDocument;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): AssetDocument;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): AssetDocument;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): AssetDocument;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): AssetDocument;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): AssetDocument;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): AssetDocument;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): AssetDocument;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): AssetDocument;
   ...
   * @see #removeField
   */
  withoutField(field: string): AssetDocument;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): AssetDocument;
   ...
   */
  withoutFields(fields: Array_Type<string>): AssetDocument;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): AssetDocument;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): AssetDocument;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): AssetDocument;
   ...
   * @see #unsetField
   */
  defaultField(field: string): AssetDocument;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): AssetDocument;
   ...
   * @see #removeField
   */
  unsetField(field: string): AssetDocument;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): AssetDocument;
   ...
   * @see #unsetField
   */
  removeField(field: string): AssetDocument;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): AssetDocument;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): AssetDocument;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): AssetDocument;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): AssetDocument;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): AssetDocument;

  mergeJson(json: any): AssetDocument;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): AssetDocument;
   ...
   */
  sumObj(other: Obj, deep?: boolean): AssetDocument;
   ...
   */
  singletonArray(): Array_Type<AssetDocument>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<AssetDocument> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<AssetDocument> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<AssetDocument>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<AssetDocument> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, AssetDocument> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, AssetDocument> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<AssetDocument>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<AssetDocument>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): AssetDocument;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): AssetDocument;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): AssetDocument;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): AssetDocument;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): AssetDocument;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): AssetDocument;
   ...
   * @see #fromString
   */
  static make(s: string): AssetDocument | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): AssetDocument;
   ...
   */
  static cachedEmptyInst(): AssetDocument;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<AssetDocument> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): AssetDocument;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<AssetDocument>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<AssetDocument>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<AssetDocument> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<AssetDocument>> | null;
   ...
   */
  get(include?: string): AssetDocument | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): AssetDocument | null;
   ...
   */
  getMissing(spec: GetMissingSpec): AssetDocument;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): AssetDocument | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): AssetDocument;
   ...
   * @see #toString
   */
  static fromString(s: string): AssetDocument | null;
   ...
   */
  create(spec?: UpsertSpec): AssetDocument | null;
   ...
   */
  static createBatch(objs: Array_Type<AssetDocument>, spec?: UpsertSpec): ObjList<AssetDocument> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<AssetDocument>, spec?: CreateBatchObjStreamSpec): ObjList<AssetDocument> | null;
   ...
   */
  update(srcObj?: AssetDocument, spec?: UpsertSpec): AssetDocument | null;
   ...
   */
  upsert(srcObj?: AssetDocument, spec?: UpsertSpec): AssetDocument | null;
   ...
   */
  merge(spec?: MergeSpec): AssetDocument | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): AssetDocument | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): AssetDocument | null;
   ...
   */
  static updateBatch(objs: Array_Type<AssetDocument>, srcObjs?: Array_Type<AssetDocument>, spec?: UpsertSpec): ObjList<AssetDocument> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<AssetDocument> | null>, spec?: UpsertSpec): ObjList<AssetDocument> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<AssetDocument>, srcObjs?: Array_Type<AssetDocument>, spec?: UpsertSpec): ObjList<AssetDocument> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<AssetDocument> | null>, spec?: UpsertSpec): ObjList<AssetDocument> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<AssetDocument>, spec?: TouchSpec): ObjList<AssetDocument> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<AssetDocument>, spec?: MergeSpec): ObjList<AssetDocument> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<AssetDocument>, mergeInclude: string, spec?: MergeSpec): ObjList<AssetDocument> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<AssetDocument> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<AssetDocument> | null;
   ...
   */
  static mergeAll(mergeObj: AssetDocument, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: AssetDocument, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<AssetDocument>, spec?: UpsertSpec): ObjList<AssetDocument> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<AssetDocument>, spec?: UpsertSpec): ObjList<AssetDocument> | null;
   ...
   */
  static beforeCreate(objs: Array_Type<AssetDocument>): ObjList<AssetDocument>;

  /**
   * Used to populate AssetDocument#fileUrl upon update
   */
  static beforeUpdate(objs: Array_Type<AssetDocument>): ObjList<AssetDocument>;
   ...
   */
  static beforeRemove(objs: Array_Type<AssetDocument>): ObjList<AssetDocument>;
   ...
   */
  static afterCreate(objs: Array_Type<AssetDocument>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<AssetDocument>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<AssetDocument>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<AssetDocument>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<AssetDocument>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): AssetDocument | null;
   ...
   */
  withoutIdentity(): AssetDocument | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<AssetDocument>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: AssetDocument, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<AssetDocument>, callback?: λFunction<AssetDocument | null, AssetDocument | null>): ObjList<AssetDocument>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<AssetDocument>, callback?: λFunction<AssetDocument | null, AssetDocument | null>): Array_Type<ObjError> | null;
   ...
   */
  static createAssetDocument(formObject: any): void;
