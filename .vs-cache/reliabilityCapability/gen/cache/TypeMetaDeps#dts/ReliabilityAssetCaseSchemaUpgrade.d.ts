// TypeScript definitions for the C3 type ReliabilityAssetCaseSchemaUpgrade
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityAssetCaseSchemaUpgrade
 */
declare interface IReliabilityAssetCaseSchemaUpgrade {
 ...
 */
declare class ReliabilityAssetCaseSchemaUpgrade extends Obj  {

  /**
   * Message used when all the {@link ReliabilityAssetCase}s are successfully migrated.
   */
  readonly SUCCESS_MESSAGE?: string;
  withSUCCESS_MESSAGE(SUCCESS_MESSAGE: string | null): ReliabilityAssetCaseSchemaUpgrade;

  /**
   * Message used when all the {@link ReliabilityAssetCase}s aren't successfully migrated.
   */
  readonly FAILURE_MESSAGE?: string;
  withFAILURE_MESSAGE(FAILURE_MESSAGE: string | null): ReliabilityAssetCaseSchemaUpgrade;
   ...
   * @see #toJson
   */
  static fromJson(json: any): ReliabilityAssetCaseSchemaUpgrade | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): ReliabilityAssetCaseSchemaUpgrade | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): ReliabilityAssetCaseSchemaUpgrade | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): ReliabilityAssetCaseSchemaUpgrade | null;
   ...
   */
  replaceType(old: Type, new_: Type): ReliabilityAssetCaseSchemaUpgrade;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityAssetCaseSchemaUpgrade;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityAssetCaseSchemaUpgrade;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityAssetCaseSchemaUpgrade>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityAssetCaseSchemaUpgrade>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityAssetCaseSchemaUpgrade;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityAssetCaseSchemaUpgrade;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityAssetCaseSchemaUpgrade;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ReliabilityAssetCaseSchemaUpgrade;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ReliabilityAssetCaseSchemaUpgrade;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityAssetCaseSchemaUpgrade;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityAssetCaseSchemaUpgrade;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityAssetCaseSchemaUpgrade;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ReliabilityAssetCaseSchemaUpgrade;
   ...
   * @see #removeField
   */
  withoutField(field: string): ReliabilityAssetCaseSchemaUpgrade;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): ReliabilityAssetCaseSchemaUpgrade;
   ...
   */
  withoutFields(fields: Array_Type<string>): ReliabilityAssetCaseSchemaUpgrade;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityAssetCaseSchemaUpgrade;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ReliabilityAssetCaseSchemaUpgrade;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityAssetCaseSchemaUpgrade;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ReliabilityAssetCaseSchemaUpgrade;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ReliabilityAssetCaseSchemaUpgrade;
   ...
   * @see #removeField
   */
  unsetField(field: string): ReliabilityAssetCaseSchemaUpgrade;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ReliabilityAssetCaseSchemaUpgrade;
   ...
   * @see #unsetField
   */
  removeField(field: string): ReliabilityAssetCaseSchemaUpgrade;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ReliabilityAssetCaseSchemaUpgrade;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityAssetCaseSchemaUpgrade;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityAssetCaseSchemaUpgrade;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityAssetCaseSchemaUpgrade;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityAssetCaseSchemaUpgrade;

  mergeJson(json: any): ReliabilityAssetCaseSchemaUpgrade;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityAssetCaseSchemaUpgrade;
   ...
   */
  sumObj(other: Obj, deep?: boolean): ReliabilityAssetCaseSchemaUpgrade;
   ...
   */
  singletonArray(): Array_Type<ReliabilityAssetCaseSchemaUpgrade>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityAssetCaseSchemaUpgrade> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ReliabilityAssetCaseSchemaUpgrade> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<ReliabilityAssetCaseSchemaUpgrade>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ReliabilityAssetCaseSchemaUpgrade> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, ReliabilityAssetCaseSchemaUpgrade> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityAssetCaseSchemaUpgrade> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ReliabilityAssetCaseSchemaUpgrade>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ReliabilityAssetCaseSchemaUpgrade>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityAssetCaseSchemaUpgrade;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityAssetCaseSchemaUpgrade;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityAssetCaseSchemaUpgrade;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ReliabilityAssetCaseSchemaUpgrade;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityAssetCaseSchemaUpgrade;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ReliabilityAssetCaseSchemaUpgrade;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityAssetCaseSchemaUpgrade;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): ReliabilityAssetCaseSchemaUpgrade;
   ...
   */
  static cachedEmptyInst(): ReliabilityAssetCaseSchemaUpgrade;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityAssetCaseSchemaUpgrade> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): ReliabilityAssetCaseSchemaUpgrade;
   ...
   */
  static migrateReliabilityAssetCase_1(): any | null;
}
