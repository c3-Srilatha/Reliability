// TypeScript definitions for the C3 type ReliabilityOrchestrator.PipelineCreationJob
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityOrchestrator.PipelineCreationJob
 */
declare namespace ReliabilityOrchestrator {
  export interface IPipelineCreationJob {
 ...
 */
declare namespace ReliabilityOrchestrator {
  export class PipelineCreationJob extends Obj  {

    /**
     * current or last job execution for this instance
     */
    readonly run?: BatchJobRun;
    withRun(run: IBatchJobRun | null): ReliabilityOrchestrator.PipelineCreationJob;

    /**
     * previous job executions for this instance
     */
    readonly runs?: Array_Type<BatchJobRun>;
    withRuns(runs: Array_Type<BatchJobRun> | Array<IBatchJobRun> | null): ReliabilityOrchestrator.PipelineCreationJob;

    /**
     * FOR INTERNAL USE ONLY - Specify options in call to {@link start}.
     */
    readonly options?: Obj;
    withOptions(options: IObj | null): ReliabilityOrchestrator.PipelineCreationJob;
    ...
    withOnCompleteCallback(onCompleteCallback: IJobBase.Callback | null): ReliabilityOrchestrator.PipelineCreationJob;
    ...
    withPriority(priority: number | null): ReliabilityOrchestrator.PipelineCreationJob;
    ...
    withDisabled(disabled: boolean): ReliabilityOrchestrator.PipelineCreationJob;
    ...
    withMaxConcurrency(maxConcurrency: number | null): ReliabilityOrchestrator.PipelineCreationJob;
    ...
    withMaxConcurrencyPerNode(maxConcurrencyPerNode: number | null): ReliabilityOrchestrator.PipelineCreationJob;
    ...
    withRunAsUser(runAsUser: boolean): ReliabilityOrchestrator.PipelineCreationJob;

    /**
     * Don't set this field in the BatchJob, set it in the BatchJobOptions when calling `start`
     */
    readonly nodePool?: string;
    withNodePool(nodePool: string | null): ReliabilityOrchestrator.PipelineCreationJob;
    ...
    withSkipIfRunning(skipIfRunning: boolean): ReliabilityOrchestrator.PipelineCreationJob;

    /**
     * Set to between 1 and 5 to enable auto recovery. See {@link invalidation-queues.c3doc Invalidation Queues} for detailed documentation.
     */
    readonly numAutoRecoveryAttempts?: number;
    withNumAutoRecoveryAttempts(numAutoRecoveryAttempts: number | null): ReliabilityOrchestrator.PipelineCreationJob;
    ...
    withPropagateActionContext(propagateActionContext: boolean): ReliabilityOrchestrator.PipelineCreationJob;
    ...
    withTypeIdent(typeIdent: string | null): ReliabilityOrchestrator.PipelineCreationJob;
     ...
     */
    readonly id: string;
    withId(id: string): ReliabilityOrchestrator.PipelineCreationJob;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityOrchestrator.PipelineCreationJob;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): ReliabilityOrchestrator.PipelineCreationJob;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): ReliabilityOrchestrator.PipelineCreationJob;
    ...
    withVersion(version: number | null): ReliabilityOrchestrator.PipelineCreationJob;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): ReliabilityOrchestrator.PipelineCreationJob;
    ...
    withAbortOnError(abortOnError: boolean): ReliabilityOrchestrator.PipelineCreationJob;
     ...
     * @see #toJson
     */
    static fromJson(json: any): ReliabilityOrchestrator.PipelineCreationJob | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): ReliabilityOrchestrator.PipelineCreationJob | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): ReliabilityOrchestrator.PipelineCreationJob | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): ReliabilityOrchestrator.PipelineCreationJob | null;
     ...
     */
    replaceType(old: Type, new_: Type): ReliabilityOrchestrator.PipelineCreationJob;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityOrchestrator.PipelineCreationJob;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityOrchestrator.PipelineCreationJob;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityOrchestrator.PipelineCreationJob>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityOrchestrator.PipelineCreationJob>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityOrchestrator.PipelineCreationJob;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityOrchestrator.PipelineCreationJob;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityOrchestrator.PipelineCreationJob;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): ReliabilityOrchestrator.PipelineCreationJob;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): ReliabilityOrchestrator.PipelineCreationJob;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityOrchestrator.PipelineCreationJob;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityOrchestrator.PipelineCreationJob;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityOrchestrator.PipelineCreationJob;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): ReliabilityOrchestrator.PipelineCreationJob;
     ...
     * @see #removeField
     */
    withoutField(field: string): ReliabilityOrchestrator.PipelineCreationJob;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): ReliabilityOrchestrator.PipelineCreationJob;
     ...
     */
    withoutFields(fields: Array_Type<string>): ReliabilityOrchestrator.PipelineCreationJob;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityOrchestrator.PipelineCreationJob;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): ReliabilityOrchestrator.PipelineCreationJob;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityOrchestrator.PipelineCreationJob;
     ...
     * @see #unsetField
     */
    defaultField(field: string): ReliabilityOrchestrator.PipelineCreationJob;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): ReliabilityOrchestrator.PipelineCreationJob;
     ...
     * @see #removeField
     */
    unsetField(field: string): ReliabilityOrchestrator.PipelineCreationJob;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): ReliabilityOrchestrator.PipelineCreationJob;
     ...
     * @see #unsetField
     */
    removeField(field: string): ReliabilityOrchestrator.PipelineCreationJob;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): ReliabilityOrchestrator.PipelineCreationJob;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityOrchestrator.PipelineCreationJob;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityOrchestrator.PipelineCreationJob;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityOrchestrator.PipelineCreationJob;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityOrchestrator.PipelineCreationJob;

    mergeJson(json: any): ReliabilityOrchestrator.PipelineCreationJob;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityOrchestrator.PipelineCreationJob;
     ...
     */
    sumObj(other: Obj, deep?: boolean): ReliabilityOrchestrator.PipelineCreationJob;
     ...
     */
    singletonArray(): Array_Type<ReliabilityOrchestrator.PipelineCreationJob>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityOrchestrator.PipelineCreationJob> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<ReliabilityOrchestrator.PipelineCreationJob> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<ReliabilityOrchestrator.PipelineCreationJob>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<ReliabilityOrchestrator.PipelineCreationJob> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, ReliabilityOrchestrator.PipelineCreationJob> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityOrchestrator.PipelineCreationJob> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<ReliabilityOrchestrator.PipelineCreationJob>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<ReliabilityOrchestrator.PipelineCreationJob>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityOrchestrator.PipelineCreationJob;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityOrchestrator.PipelineCreationJob;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityOrchestrator.PipelineCreationJob;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): ReliabilityOrchestrator.PipelineCreationJob;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityOrchestrator.PipelineCreationJob;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): ReliabilityOrchestrator.PipelineCreationJob;
     ...
     * @see #fromString
     */
    static make(s: string): ReliabilityOrchestrator.PipelineCreationJob | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityOrchestrator.PipelineCreationJob;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): ReliabilityOrchestrator.PipelineCreationJob;
     ...
     */
    static cachedEmptyInst(): ReliabilityOrchestrator.PipelineCreationJob;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityOrchestrator.PipelineCreationJob> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): ReliabilityOrchestrator.PipelineCreationJob;
     ...
     */
    start(options?: ReliabilityOrchestrator.PipelineCreationJobOptions): BatchJobStatus | null;
     ...
     */
    cleanup(options?: ReliabilityOrchestrator.PipelineCreationJobOptions): void;
    ...
    cancelJob(removeResults?: boolean, force?: boolean): JobBase<BatchJobRun, BatchJobStatus, ReliabilityOrchestrator.PipelineCreationJobOptions> | null;

    failJob(run: JobRun<BatchJobStatusBase>): JobBase<BatchJobRun, BatchJobStatus, ReliabilityOrchestrator.PipelineCreationJobOptions> | null;
    ...
    validateStart(options?: ReliabilityOrchestrator.PipelineCreationJobOptions): void;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<ReliabilityOrchestrator.PipelineCreationJob>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<ReliabilityOrchestrator.PipelineCreationJob>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityOrchestrator.PipelineCreationJob> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityOrchestrator.PipelineCreationJob>> | null;
     ...
     */
    get(include?: string): ReliabilityOrchestrator.PipelineCreationJob | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): ReliabilityOrchestrator.PipelineCreationJob | null;
     ...
     */
    getMissing(spec: GetMissingSpec): ReliabilityOrchestrator.PipelineCreationJob;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): ReliabilityOrchestrator.PipelineCreationJob | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): ReliabilityOrchestrator.PipelineCreationJob;
     ...
     * @see #toString
     */
    static fromString(s: string): ReliabilityOrchestrator.PipelineCreationJob | null;
     ...
     */
    create(spec?: UpsertSpec): ReliabilityOrchestrator.PipelineCreationJob | null;
     ...
     */
    static createBatch(objs: Array_Type<ReliabilityOrchestrator.PipelineCreationJob>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.PipelineCreationJob> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<ReliabilityOrchestrator.PipelineCreationJob>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityOrchestrator.PipelineCreationJob> | null;
     ...
     */
    update(srcObj?: ReliabilityOrchestrator.PipelineCreationJob, spec?: UpsertSpec): ReliabilityOrchestrator.PipelineCreationJob | null;
     ...
     */
    upsert(srcObj?: ReliabilityOrchestrator.PipelineCreationJob, spec?: UpsertSpec): ReliabilityOrchestrator.PipelineCreationJob | null;
     ...
     */
    merge(spec?: MergeSpec): ReliabilityOrchestrator.PipelineCreationJob | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): ReliabilityOrchestrator.PipelineCreationJob | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): ReliabilityOrchestrator.PipelineCreationJob | null;
     ...
     */
    static updateBatch(objs: Array_Type<ReliabilityOrchestrator.PipelineCreationJob>, srcObjs?: Array_Type<ReliabilityOrchestrator.PipelineCreationJob>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.PipelineCreationJob> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<ReliabilityOrchestrator.PipelineCreationJob> | null>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.PipelineCreationJob> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<ReliabilityOrchestrator.PipelineCreationJob>, srcObjs?: Array_Type<ReliabilityOrchestrator.PipelineCreationJob>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.PipelineCreationJob> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<ReliabilityOrchestrator.PipelineCreationJob> | null>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.PipelineCreationJob> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<ReliabilityOrchestrator.PipelineCreationJob>, spec?: TouchSpec): ObjList<ReliabilityOrchestrator.PipelineCreationJob> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityOrchestrator.PipelineCreationJob>, spec?: MergeSpec): ObjList<ReliabilityOrchestrator.PipelineCreationJob> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityOrchestrator.PipelineCreationJob>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityOrchestrator.PipelineCreationJob> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<ReliabilityOrchestrator.PipelineCreationJob> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityOrchestrator.PipelineCreationJob> | null;
     ...
     */
    static mergeAll(mergeObj: ReliabilityOrchestrator.PipelineCreationJob, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: ReliabilityOrchestrator.PipelineCreationJob, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<ReliabilityOrchestrator.PipelineCreationJob>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.PipelineCreationJob> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<ReliabilityOrchestrator.PipelineCreationJob>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.PipelineCreationJob> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): ReliabilityOrchestrator.PipelineCreationJob | null;
     ...
     */
    static beforeCreate(objs: Array_Type<ReliabilityOrchestrator.PipelineCreationJob>): ObjList<ReliabilityOrchestrator.PipelineCreationJob>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<ReliabilityOrchestrator.PipelineCreationJob>): ObjList<ReliabilityOrchestrator.PipelineCreationJob>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<ReliabilityOrchestrator.PipelineCreationJob>): ObjList<ReliabilityOrchestrator.PipelineCreationJob>;
     ...
     */
    static afterCreate(objs: Array_Type<ReliabilityOrchestrator.PipelineCreationJob>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<ReliabilityOrchestrator.PipelineCreationJob>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<ReliabilityOrchestrator.PipelineCreationJob>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityOrchestrator.PipelineCreationJob>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityOrchestrator.PipelineCreationJob>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): ReliabilityOrchestrator.PipelineCreationJob | null;
     ...
     */
    withoutIdentity(): ReliabilityOrchestrator.PipelineCreationJob | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<ReliabilityOrchestrator.PipelineCreationJob>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: ReliabilityOrchestrator.PipelineCreationJob, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<ReliabilityOrchestrator.PipelineCreationJob>, callback?: λFunction<ReliabilityOrchestrator.PipelineCreationJob | null, ReliabilityOrchestrator.PipelineCreationJob | null>): ObjList<ReliabilityOrchestrator.PipelineCreationJob>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<ReliabilityOrchestrator.PipelineCreationJob>, callback?: λFunction<ReliabilityOrchestrator.PipelineCreationJob | null, ReliabilityOrchestrator.PipelineCreationJob | null>): Array_Type<ObjError> | null;
     ...
     */
    static doStart(job?: ReliabilityOrchestrator.PipelineCreationJob, options?: ReliabilityOrchestrator.PipelineCreationJobOptions): void;
     ...
     */
    static processBatch(batch?: ReliabilityOrchestrator.PipelineCreationJobBatch, job?: ReliabilityOrchestrator.PipelineCreationJob, options?: ReliabilityOrchestrator.PipelineCreationJobOptions): void;
     ...
     */
    static allComplete(job: ReliabilityOrchestrator.PipelineCreationJob, options?: ReliabilityOrchestrator.PipelineCreationJobOptions): string | null;
     ...
     *           Options the job was run with.
     */
    static failed(job: ReliabilityOrchestrator.PipelineCreationJob, status: BatchJobStatus, options?: ReliabilityOrchestrator.PipelineCreationJobOptions): void;
     ...
     *        Batch to schedule.
     */
    scheduleBatch(batch?: ReliabilityOrchestrator.PipelineCreationJobBatch): void;
     ...
     *        Batches to schedule.
     */
    scheduleBatches(batches?: Array_Type<ReliabilityOrchestrator.PipelineCreationJobBatch>): void;
     ...
     */
    static scheduleObjBatch(job?: ReliabilityOrchestrator.PipelineCreationJob, objBatch?: ObjBatch, logPrefix?: string): number | null;
