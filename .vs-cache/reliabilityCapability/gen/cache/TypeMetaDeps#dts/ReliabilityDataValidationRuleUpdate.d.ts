// TypeScript definitions for the C3 type ReliabilityDataValidationRuleUpdate

/**
 * This type is used to update the Data Validation Rules by removing or updating existing rules.
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityDataValidationRuleUpdate
 */
declare interface IReliabilityDataValidationRuleUpdate {

  /**
   * `doesAssetTemplateExist` actionName to be removed
   */
  ASSET_TEMPLATE_ACTION_NAME?: string;
}
 ...
 */
declare class ReliabilityDataValidationRuleUpdate extends Obj  {

  /**
   * `doesAssetTemplateExist` actionName to be removed
   */
  readonly ASSET_TEMPLATE_ACTION_NAME?: string;
  withASSET_TEMPLATE_ACTION_NAME(ASSET_TEMPLATE_ACTION_NAME: string | null): ReliabilityDataValidationRuleUpdate;
   ...
   * @see #toJson
   */
  static fromJson(json: any): ReliabilityDataValidationRuleUpdate | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): ReliabilityDataValidationRuleUpdate | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): ReliabilityDataValidationRuleUpdate | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): ReliabilityDataValidationRuleUpdate | null;
   ...
   */
  replaceType(old: Type, new_: Type): ReliabilityDataValidationRuleUpdate;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityDataValidationRuleUpdate;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityDataValidationRuleUpdate;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityDataValidationRuleUpdate>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityDataValidationRuleUpdate>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityDataValidationRuleUpdate;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityDataValidationRuleUpdate;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityDataValidationRuleUpdate;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ReliabilityDataValidationRuleUpdate;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ReliabilityDataValidationRuleUpdate;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityDataValidationRuleUpdate;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityDataValidationRuleUpdate;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityDataValidationRuleUpdate;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ReliabilityDataValidationRuleUpdate;
   ...
   * @see #removeField
   */
  withoutField(field: string): ReliabilityDataValidationRuleUpdate;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): ReliabilityDataValidationRuleUpdate;
   ...
   */
  withoutFields(fields: Array_Type<string>): ReliabilityDataValidationRuleUpdate;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityDataValidationRuleUpdate;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ReliabilityDataValidationRuleUpdate;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityDataValidationRuleUpdate;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ReliabilityDataValidationRuleUpdate;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ReliabilityDataValidationRuleUpdate;
   ...
   * @see #removeField
   */
  unsetField(field: string): ReliabilityDataValidationRuleUpdate;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ReliabilityDataValidationRuleUpdate;
   ...
   * @see #unsetField
   */
  removeField(field: string): ReliabilityDataValidationRuleUpdate;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ReliabilityDataValidationRuleUpdate;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityDataValidationRuleUpdate;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityDataValidationRuleUpdate;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityDataValidationRuleUpdate;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityDataValidationRuleUpdate;

  mergeJson(json: any): ReliabilityDataValidationRuleUpdate;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityDataValidationRuleUpdate;
   ...
   */
  sumObj(other: Obj, deep?: boolean): ReliabilityDataValidationRuleUpdate;
   ...
   */
  singletonArray(): Array_Type<ReliabilityDataValidationRuleUpdate>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityDataValidationRuleUpdate> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ReliabilityDataValidationRuleUpdate> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<ReliabilityDataValidationRuleUpdate>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ReliabilityDataValidationRuleUpdate> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, ReliabilityDataValidationRuleUpdate> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityDataValidationRuleUpdate> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ReliabilityDataValidationRuleUpdate>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ReliabilityDataValidationRuleUpdate>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityDataValidationRuleUpdate;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityDataValidationRuleUpdate;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityDataValidationRuleUpdate;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ReliabilityDataValidationRuleUpdate;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityDataValidationRuleUpdate;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ReliabilityDataValidationRuleUpdate;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityDataValidationRuleUpdate;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): ReliabilityDataValidationRuleUpdate;
   ...
   */
  static cachedEmptyInst(): ReliabilityDataValidationRuleUpdate;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityDataValidationRuleUpdate> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): ReliabilityDataValidationRuleUpdate;
