// TypeScript definitions for the C3 type ReliabilityOrchestrator.ModelMonitoringJobResult

/**
 * Represents the model monitoring workflow that will be executed to monitor a single
 * {@link ReliabilityMlModel} - {@link ReliabilityAsset} pair, and for a specific {@link MlProject}.
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityOrchestrator.ModelMonitoringJobResult
 */
declare namespace ReliabilityOrchestrator {
  export interface IModelMonitoringJobResult {
    ...
    /**
     * Specify the {@link ReliabilityMl.Project} for which model monitoring should be run.
     */
    project: IReliabilityMl.Project;

    /**
     * The {@link ReliabilityAsset} for which model monitoring should be run.
     */
    asset: IReliabilityAsset;

    /**
     * The {@link ReliabilityMlModel} for which the model monitoring job is run.
     */
     ...
     *
     * Use `ReliabilityMl.TimeRange.TRAIN` to use the training time range associated with a {@link ReliabilityMlModel},
     ...
     * model performs. This will usually refer to a custom time range corresponding to the most recent live data, and the model is
     * expected to continue to perform as well on the live data as it does on the training data.
     */
 ...
 * {@link ReliabilityMlModel} - {@link ReliabilityAsset} pair, and for a specific {@link MlProject}.
 *
 * @remarks this represents a made instance of ReliabilityOrchestrator.ModelMonitoringJobResult
 */
declare namespace ReliabilityOrchestrator {
  export class ModelMonitoringJobResult extends Obj  {

    /**
     * The unique and required name of this instance.
     */
    readonly name: string;
    withName(name: string): ReliabilityOrchestrator.ModelMonitoringJobResult;
    ...
    withTypeIdent(typeIdent: string | null): ReliabilityOrchestrator.ModelMonitoringJobResult;
     ...
     */
    readonly id: string;
    withId(id: string): ReliabilityOrchestrator.ModelMonitoringJobResult;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityOrchestrator.ModelMonitoringJobResult;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): ReliabilityOrchestrator.ModelMonitoringJobResult;
    ...
    withVersion(version: number | null): ReliabilityOrchestrator.ModelMonitoringJobResult;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): ReliabilityOrchestrator.ModelMonitoringJobResult;

    /**
     * Parent {@link MlWorkflowCoordinatable} that this result belongs to.
     */
    readonly parentCoordinator: MlWorkflowCoordinatable<MlWorkflowCoordinatableResult>;
    withParentCoordinator(parentCoordinator: IMlWorkflowCoordinatable<MlWorkflowCoordinatableResult>): ReliabilityOrchestrator.ModelMonitoringJobResult;
    ...
    withStatusForCoordinatable(statusForCoordinatable: string): ReliabilityOrchestrator.ModelMonitoringJobResult;

    /**
     * Number of times the {@link #parentCoordinator} has canceled this result.
     */
    readonly canceledCount?: number;
    withCanceledCount(canceledCount: number | null): ReliabilityOrchestrator.ModelMonitoringJobResult;
    ...
    withIsCanceled(isCanceled: boolean): ReliabilityOrchestrator.ModelMonitoringJobResult;
    ...
    withErrorCount(errorCount: number | null): ReliabilityOrchestrator.ModelMonitoringJobResult;
    ...
    withRun(run: IWorkflowExecutorRun | null): ReliabilityOrchestrator.ModelMonitoringJobResult;
    ...
    withDurationSeconds(durationSeconds: number | null): ReliabilityOrchestrator.ModelMonitoringJobResult;
    ...
    withPastRuns(pastRuns: Array_Type<WorkflowExecutorRun> | Array<IWorkflowExecutorRun> | null): ReliabilityOrchestrator.ModelMonitoringJobResult;

    /**
     * Number of times the {@link #parentCoordinator} has attempted to recover this result.
     */
    readonly attemptedRecoveryCount?: number;
    withAttemptedRecoveryCount(attemptedRecoveryCount: number | null): ReliabilityOrchestrator.ModelMonitoringJobResult;

    /**
     * Specify the {@link ReliabilityMl.Project} for which model monitoring should be run.
     */
    readonly project: ReliabilityMl.Project;
    withProject(project: IReliabilityMl.Project): ReliabilityOrchestrator.ModelMonitoringJobResult;

    /**
     * The {@link ReliabilityAsset} for which model monitoring should be run.
     */
    readonly asset: ReliabilityAsset;
    withAsset(asset: IReliabilityAsset): ReliabilityOrchestrator.ModelMonitoringJobResult;

    /**
     * The {@link ReliabilityMlModel} for which the model monitoring job is run.
     */
    readonly model: ReliabilityMlModel;
    withModel(model: IReliabilityMlModel): ReliabilityOrchestrator.ModelMonitoringJobResult;
    ...
    withReferenceTimeRange(referenceTimeRange: ITimeRange | string | null): ReliabilityOrchestrator.ModelMonitoringJobResult;
    ...
    withComparisonTimeRange(comparisonTimeRange: ITimeRange | string | null): ReliabilityOrchestrator.ModelMonitoringJobResult;
     ...
     * @see #toJson
     */
    static fromJson(json: any): ReliabilityOrchestrator.ModelMonitoringJobResult | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): ReliabilityOrchestrator.ModelMonitoringJobResult | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): ReliabilityOrchestrator.ModelMonitoringJobResult | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): ReliabilityOrchestrator.ModelMonitoringJobResult | null;
     ...
     */
    replaceType(old: Type, new_: Type): ReliabilityOrchestrator.ModelMonitoringJobResult;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityOrchestrator.ModelMonitoringJobResult;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityOrchestrator.ModelMonitoringJobResult;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityOrchestrator.ModelMonitoringJobResult>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityOrchestrator.ModelMonitoringJobResult>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityOrchestrator.ModelMonitoringJobResult;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityOrchestrator.ModelMonitoringJobResult;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityOrchestrator.ModelMonitoringJobResult;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): ReliabilityOrchestrator.ModelMonitoringJobResult;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): ReliabilityOrchestrator.ModelMonitoringJobResult;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityOrchestrator.ModelMonitoringJobResult;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityOrchestrator.ModelMonitoringJobResult;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityOrchestrator.ModelMonitoringJobResult;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): ReliabilityOrchestrator.ModelMonitoringJobResult;
     ...
     * @see #removeField
     */
    withoutField(field: string): ReliabilityOrchestrator.ModelMonitoringJobResult;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): ReliabilityOrchestrator.ModelMonitoringJobResult;
     ...
     */
    withoutFields(fields: Array_Type<string>): ReliabilityOrchestrator.ModelMonitoringJobResult;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityOrchestrator.ModelMonitoringJobResult;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): ReliabilityOrchestrator.ModelMonitoringJobResult;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityOrchestrator.ModelMonitoringJobResult;
     ...
     * @see #unsetField
     */
    defaultField(field: string): ReliabilityOrchestrator.ModelMonitoringJobResult;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): ReliabilityOrchestrator.ModelMonitoringJobResult;
     ...
     * @see #removeField
     */
    unsetField(field: string): ReliabilityOrchestrator.ModelMonitoringJobResult;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): ReliabilityOrchestrator.ModelMonitoringJobResult;
     ...
     * @see #unsetField
     */
    removeField(field: string): ReliabilityOrchestrator.ModelMonitoringJobResult;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): ReliabilityOrchestrator.ModelMonitoringJobResult;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityOrchestrator.ModelMonitoringJobResult;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityOrchestrator.ModelMonitoringJobResult;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityOrchestrator.ModelMonitoringJobResult;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityOrchestrator.ModelMonitoringJobResult;

    mergeJson(json: any): ReliabilityOrchestrator.ModelMonitoringJobResult;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityOrchestrator.ModelMonitoringJobResult;
     ...
     */
    sumObj(other: Obj, deep?: boolean): ReliabilityOrchestrator.ModelMonitoringJobResult;
     ...
     */
    singletonArray(): Array_Type<ReliabilityOrchestrator.ModelMonitoringJobResult>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityOrchestrator.ModelMonitoringJobResult> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<ReliabilityOrchestrator.ModelMonitoringJobResult> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<ReliabilityOrchestrator.ModelMonitoringJobResult>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<ReliabilityOrchestrator.ModelMonitoringJobResult> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, ReliabilityOrchestrator.ModelMonitoringJobResult> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityOrchestrator.ModelMonitoringJobResult> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<ReliabilityOrchestrator.ModelMonitoringJobResult>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<ReliabilityOrchestrator.ModelMonitoringJobResult>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityOrchestrator.ModelMonitoringJobResult;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityOrchestrator.ModelMonitoringJobResult;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityOrchestrator.ModelMonitoringJobResult;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): ReliabilityOrchestrator.ModelMonitoringJobResult;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityOrchestrator.ModelMonitoringJobResult;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): ReliabilityOrchestrator.ModelMonitoringJobResult;
     ...
     * @see #fromString
     */
    static make(s: string): ReliabilityOrchestrator.ModelMonitoringJobResult | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityOrchestrator.ModelMonitoringJobResult;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): ReliabilityOrchestrator.ModelMonitoringJobResult;
     ...
     */
    static cachedEmptyInst(): ReliabilityOrchestrator.ModelMonitoringJobResult;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityOrchestrator.ModelMonitoringJobResult> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): ReliabilityOrchestrator.ModelMonitoringJobResult;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<ReliabilityOrchestrator.ModelMonitoringJobResult>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<ReliabilityOrchestrator.ModelMonitoringJobResult>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityOrchestrator.ModelMonitoringJobResult> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityOrchestrator.ModelMonitoringJobResult>> | null;
     ...
     */
    get(include?: string): ReliabilityOrchestrator.ModelMonitoringJobResult | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): ReliabilityOrchestrator.ModelMonitoringJobResult | null;
     ...
     */
    getMissing(spec: GetMissingSpec): ReliabilityOrchestrator.ModelMonitoringJobResult;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): ReliabilityOrchestrator.ModelMonitoringJobResult | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): ReliabilityOrchestrator.ModelMonitoringJobResult;
     ...
     * @see #toString
     */
    static fromString(s: string): ReliabilityOrchestrator.ModelMonitoringJobResult | null;
     ...
     */
    create(spec?: UpsertSpec): ReliabilityOrchestrator.ModelMonitoringJobResult | null;
     ...
     */
    static createBatch(objs: Array_Type<ReliabilityOrchestrator.ModelMonitoringJobResult>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.ModelMonitoringJobResult> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<ReliabilityOrchestrator.ModelMonitoringJobResult>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityOrchestrator.ModelMonitoringJobResult> | null;
     ...
     */
    update(srcObj?: ReliabilityOrchestrator.ModelMonitoringJobResult, spec?: UpsertSpec): ReliabilityOrchestrator.ModelMonitoringJobResult | null;
     ...
     */
    upsert(srcObj?: ReliabilityOrchestrator.ModelMonitoringJobResult, spec?: UpsertSpec): ReliabilityOrchestrator.ModelMonitoringJobResult | null;
     ...
     */
    merge(spec?: MergeSpec): ReliabilityOrchestrator.ModelMonitoringJobResult | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): ReliabilityOrchestrator.ModelMonitoringJobResult | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): ReliabilityOrchestrator.ModelMonitoringJobResult | null;
     ...
     */
    static updateBatch(objs: Array_Type<ReliabilityOrchestrator.ModelMonitoringJobResult>, srcObjs?: Array_Type<ReliabilityOrchestrator.ModelMonitoringJobResult>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.ModelMonitoringJobResult> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<ReliabilityOrchestrator.ModelMonitoringJobResult> | null>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.ModelMonitoringJobResult> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<ReliabilityOrchestrator.ModelMonitoringJobResult>, srcObjs?: Array_Type<ReliabilityOrchestrator.ModelMonitoringJobResult>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.ModelMonitoringJobResult> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<ReliabilityOrchestrator.ModelMonitoringJobResult> | null>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.ModelMonitoringJobResult> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<ReliabilityOrchestrator.ModelMonitoringJobResult>, spec?: TouchSpec): ObjList<ReliabilityOrchestrator.ModelMonitoringJobResult> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityOrchestrator.ModelMonitoringJobResult>, spec?: MergeSpec): ObjList<ReliabilityOrchestrator.ModelMonitoringJobResult> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityOrchestrator.ModelMonitoringJobResult>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityOrchestrator.ModelMonitoringJobResult> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<ReliabilityOrchestrator.ModelMonitoringJobResult> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityOrchestrator.ModelMonitoringJobResult> | null;
     ...
     */
    static mergeAll(mergeObj: ReliabilityOrchestrator.ModelMonitoringJobResult, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: ReliabilityOrchestrator.ModelMonitoringJobResult, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<ReliabilityOrchestrator.ModelMonitoringJobResult>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.ModelMonitoringJobResult> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<ReliabilityOrchestrator.ModelMonitoringJobResult>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.ModelMonitoringJobResult> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): ReliabilityOrchestrator.ModelMonitoringJobResult | null;
     ...
     */
    static beforeCreate(objs: Array_Type<ReliabilityOrchestrator.ModelMonitoringJobResult>): ObjList<ReliabilityOrchestrator.ModelMonitoringJobResult>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<ReliabilityOrchestrator.ModelMonitoringJobResult>): ObjList<ReliabilityOrchestrator.ModelMonitoringJobResult>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<ReliabilityOrchestrator.ModelMonitoringJobResult>): ObjList<ReliabilityOrchestrator.ModelMonitoringJobResult>;
     ...
     */
    static afterCreate(objs: Array_Type<ReliabilityOrchestrator.ModelMonitoringJobResult>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<ReliabilityOrchestrator.ModelMonitoringJobResult>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<ReliabilityOrchestrator.ModelMonitoringJobResult>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityOrchestrator.ModelMonitoringJobResult>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityOrchestrator.ModelMonitoringJobResult>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): ReliabilityOrchestrator.ModelMonitoringJobResult | null;
     ...
     */
    withoutIdentity(): ReliabilityOrchestrator.ModelMonitoringJobResult | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<ReliabilityOrchestrator.ModelMonitoringJobResult>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: ReliabilityOrchestrator.ModelMonitoringJobResult, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<ReliabilityOrchestrator.ModelMonitoringJobResult>, callback?: λFunction<ReliabilityOrchestrator.ModelMonitoringJobResult | null, ReliabilityOrchestrator.ModelMonitoringJobResult | null>): ObjList<ReliabilityOrchestrator.ModelMonitoringJobResult>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<ReliabilityOrchestrator.ModelMonitoringJobResult>, callback?: λFunction<ReliabilityOrchestrator.ModelMonitoringJobResult | null, ReliabilityOrchestrator.ModelMonitoringJobResult | null>): Array_Type<ObjError> | null;
     ...
     */
    beforeRecover(): ReliabilityOrchestrator.ModelMonitoringJobResult;
     ...
     * caller is responsible for persisting the result.
     */
    beforeCancel(): ReliabilityOrchestrator.ModelMonitoringJobResult;

    /**
     * Creates the model output, which contains the outputs of {@link #model} and
    ...
    /**
     * Creates a {@link ReliabilityMlModel.MonitoringScore} from the {@link ReliabilityMlModel.ClassificationScore} created
     * by the {@link #project}, and deletes the classification score.
     * @param classificationScore
     *           The classification score to convert to a monitoring score.
     * @return A {@link ReliabilityMlModel.MonitoringScore} object.
     */
    static createModelMonitoringScore(classificationScore?: ReliabilityMlModel.ClassificationScore): ReliabilityMlModel.MonitoringScore;

    /**
     * Creates the {@link Workflow} to run the model monitoring job for the {@link #asset} - @{link-model} combination,
     * that is started by {@link #startWorkflow}.
     * @return A {@link Workflow} object for the model monitoring job.
     */
