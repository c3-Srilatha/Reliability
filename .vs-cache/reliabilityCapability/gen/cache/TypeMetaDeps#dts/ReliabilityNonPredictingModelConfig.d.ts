// TypeScript definitions for the C3 type ReliabilityNonPredictingModelConfig

/**
 * Configuration for Non-Predicting Models application logic.
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityNonPredictingModelConfig
 */
declare interface IReliabilityNonPredictingModelConfig {
  ...
  /**
   * The threshold duration (in days) equal to or above which, if the model is not generating predictions
   * the model will be classifed as non-predicting.
   */
  nonPredictingThresholdDays?: number;
}

/**
 * Configuration for Non-Predicting Models application logic.
 *
 * @remarks this represents a made instance of ReliabilityNonPredictingModelConfig
 */
declare class ReliabilityNonPredictingModelConfig extends Obj  {

  readonly configOverride?: string;
  withConfigOverride(configOverride: string | null): ReliabilityNonPredictingModelConfig;

  static readonly configOverride?: string;

  readonly secretOverride?: string;
  withSecretOverride(secretOverride: string | null): ReliabilityNonPredictingModelConfig;
  ...
  withIssues(issues: Array_Type<string> | Array<string> | null): ReliabilityNonPredictingModelConfig;
   ...
   * the model will be classifed as non-predicting.
   */
  readonly nonPredictingThresholdDays?: number;
  withNonPredictingThresholdDays(nonPredictingThresholdDays: number | null): ReliabilityNonPredictingModelConfig;

  /**
   * The threshold duration (in days) equal to or above which, if the model is not generating predictions
   * the model will be classifed as non-predicting.
   */
  static readonly nonPredictingThresholdDays?: number;

  /**
   * @return the one and only instance to be used when member functions are called on this type.
   */
  static inst(): ReliabilityNonPredictingModelConfig;

  /**
   * @return the cached instance if already cached, null otherwise. Does not instantiate if missing.
   */
  static cachedInst(): ReliabilityNonPredictingModelConfig | null;
   ...
   * @see #toJson
   */
  static fromJson(json: any): ReliabilityNonPredictingModelConfig | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): ReliabilityNonPredictingModelConfig | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): ReliabilityNonPredictingModelConfig | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): ReliabilityNonPredictingModelConfig | null;
   ...
   */
  replaceType(old: Type, new_: Type): ReliabilityNonPredictingModelConfig;
   ...
   * This method is used during live metadata update
   */
  static replaceType(old: Type, new_: Type): ReliabilityNonPredictingModelConfig;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityNonPredictingModelConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityNonPredictingModelConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityNonPredictingModelConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityNonPredictingModelConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityNonPredictingModelConfig>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityNonPredictingModelConfig>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityNonPredictingModelConfig>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityNonPredictingModelConfig>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityNonPredictingModelConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityNonPredictingModelConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityNonPredictingModelConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityNonPredictingModelConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityNonPredictingModelConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityNonPredictingModelConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ReliabilityNonPredictingModelConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  static validateObj(): ReliabilityNonPredictingModelConfig;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ReliabilityNonPredictingModelConfig;
   ...
   * @see #defaultField
   */
  static withField(field: string, value: any, doNotConvert?: boolean): ReliabilityNonPredictingModelConfig;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityNonPredictingModelConfig;
   ...
   * @see #defaultField
   */
  static withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityNonPredictingModelConfig;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityNonPredictingModelConfig;
   ...
   * @return new Obj
   */
  static withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityNonPredictingModelConfig;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityNonPredictingModelConfig;
   ...
   * @return new Obj
   */
  static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityNonPredictingModelConfig;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ReliabilityNonPredictingModelConfig;
   ...
   * @see #withoutField
   */
  static withoutFieldAtPath(path: string): ReliabilityNonPredictingModelConfig;
   ...
   * @see #removeField
   */
  withoutField(field: string): ReliabilityNonPredictingModelConfig;
   ...
   * @see #removeField
   */
  static withoutField(field: string): ReliabilityNonPredictingModelConfig;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): ReliabilityNonPredictingModelConfig;
   ...
   * @see #removeField
   */
  static withoutField(field: FieldType): ReliabilityNonPredictingModelConfig;
   ...
   */
  withoutFields(fields: Array_Type<string>): ReliabilityNonPredictingModelConfig;
   ...
   * @return new Obj with removed fields
   */
  static withoutFields(fields: Array_Type<string>): ReliabilityNonPredictingModelConfig;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityNonPredictingModelConfig;
   ...
   * @return new Obj with removed fields
   */
  static withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityNonPredictingModelConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ReliabilityNonPredictingModelConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  static withoutSecretFields(): ReliabilityNonPredictingModelConfig;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityNonPredictingModelConfig;
   ...
   * @see FieldType#defaultValue
   */
  static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityNonPredictingModelConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ReliabilityNonPredictingModelConfig;
   ...
   * @see #unsetField
   */
  static defaultField(field: string): ReliabilityNonPredictingModelConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ReliabilityNonPredictingModelConfig;
   ...
   * @see #unsetField
   */
  static defaultField(field: FieldType): ReliabilityNonPredictingModelConfig;
   ...
   * @see #removeField
   */
  unsetField(field: string): ReliabilityNonPredictingModelConfig;
   ...
   * @see #removeField
   */
  static unsetField(field: string): ReliabilityNonPredictingModelConfig;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ReliabilityNonPredictingModelConfig;
   ...
   * @see #removeField
   */
  static unsetField(field: FieldType): ReliabilityNonPredictingModelConfig;
   ...
   * @see #unsetField
   */
  removeField(field: string): ReliabilityNonPredictingModelConfig;
   ...
   * @see #unsetField
   */
  static removeField(field: string): ReliabilityNonPredictingModelConfig;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ReliabilityNonPredictingModelConfig;
   ...
   * @see #unsetField
   */
  static removeField(field: FieldType): ReliabilityNonPredictingModelConfig;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityNonPredictingModelConfig;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityNonPredictingModelConfig;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityNonPredictingModelConfig;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityNonPredictingModelConfig;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityNonPredictingModelConfig;
   ...
   *        the same key or index.
   */
  static mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityNonPredictingModelConfig;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityNonPredictingModelConfig;
   ...
   * traverse child reference and collection fields.
   */
  static mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityNonPredictingModelConfig;

  mergeJson(json: any): ReliabilityNonPredictingModelConfig;

  static mergeJson(json: any): ReliabilityNonPredictingModelConfig;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityNonPredictingModelConfig;
   ...
   * @return Obj with child references merged
   */
  static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityNonPredictingModelConfig;
   ...
   */
  sumObj(other: Obj, deep?: boolean): ReliabilityNonPredictingModelConfig;
   ...
   * references with same name and collection elements at same index or key.
   */
  static sumObj(other: Obj, deep?: boolean): ReliabilityNonPredictingModelConfig;
   ...
   */
  singletonArray(): Array_Type<ReliabilityNonPredictingModelConfig>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonArray(): Array_Type<ReliabilityNonPredictingModelConfig>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityNonPredictingModelConfig> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ReliabilityNonPredictingModelConfig> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<ReliabilityNonPredictingModelConfig>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonSet(): Set_Type<ReliabilityNonPredictingModelConfig>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ReliabilityNonPredictingModelConfig> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, ReliabilityNonPredictingModelConfig> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityNonPredictingModelConfig> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ReliabilityNonPredictingModelConfig>;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  static toBuilder(): ObjBuilder<ReliabilityNonPredictingModelConfig>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ReliabilityNonPredictingModelConfig>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityNonPredictingModelConfig;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityNonPredictingModelConfig;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityNonPredictingModelConfig;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ReliabilityNonPredictingModelConfig;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityNonPredictingModelConfig;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ReliabilityNonPredictingModelConfig;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityNonPredictingModelConfig;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): ReliabilityNonPredictingModelConfig;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  static afterMake(): ReliabilityNonPredictingModelConfig;
   ...
   */
  static cachedEmptyInst(): ReliabilityNonPredictingModelConfig;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityNonPredictingModelConfig> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): ReliabilityNonPredictingModelConfig;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<ReliabilityNonPredictingModelConfig> | null;
   ...
   */
  static find(filter?: string, doNotProduceAll?: boolean): Stream<ReliabilityNonPredictingModelConfig> | null;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<ReliabilityNonPredictingModelConfig> | null;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): ReliabilityNonPredictingModelConfig | null;

  /**
   * Returns cached instance by key, with secrets removed.
   */
  static forCacheKey(key: string): ReliabilityNonPredictingModelConfig | null;
   ...
   * @see findByCacheKey
   */
  getCached(): ReliabilityNonPredictingModelConfig | null;
   ...
   * @see findByCacheKey
   */
  static getCached(): ReliabilityNonPredictingModelConfig | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): ReliabilityNonPredictingModelConfig | null;

  /**
   * @return newly produced cached instance.
   */
  static refreshCache(): ReliabilityNonPredictingModelConfig | null;
   ...
   */
  static produce(key: string): ReliabilityNonPredictingModelConfig | null;
   ...
   */
  static produceAll(): Map_Type<string, ReliabilityNonPredictingModelConfig> | null;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): Map_Type<string, ReliabilityNonPredictingModelConfig> | null;
   ...
   */
  getConfig(): ReliabilityNonPredictingModelConfig;
   ...
   * Note that typical pattern is to use Configurable#config instead of this method.
   */
  static getConfig(): ReliabilityNonPredictingModelConfig;
   ...
   */
  getSecret(): ReliabilityNonPredictingModelConfig;
   ...
   * Note that typical pattern is to use Configurable#configWithSecrets instead of this method.
   */
  static getSecret(): ReliabilityNonPredictingModelConfig;
   ...
   */
  withConfigKey(configKey: string): ReliabilityNonPredictingModelConfig;
   ...
   *     config.configKey() => "folder1/abc"
   */
  static withConfigKey(configKey: string): ReliabilityNonPredictingModelConfig;

  /**
   * @return copy without config key.
   */
  withoutConfigKey(): ReliabilityNonPredictingModelConfig;

  /**
   * @return copy without config key.
   */
  static withoutConfigKey(): ReliabilityNonPredictingModelConfig;

  /**
   * @return return cached config instance for provided config key.
   */
  static forConfigKey(configKey: string): ReliabilityNonPredictingModelConfig | null;
   ...
   */
  static listConfigs(parallel?: boolean, filter?: λPredicate<string>): Stream<ReliabilityNonPredictingModelConfig> | null;
   ...
   * @see setConfigValue
   */
  setConfigValues(from: ReliabilityNonPredictingModelConfig, override?: string): void;

  /**
   * Sets multiple field values to be the same as the passed instance.
   * @see setConfigValue
   */
  static setConfigValues(from: ReliabilityNonPredictingModelConfig, override?: string): void;
   ...
   * @see setSecretValue
   */
  setSecretValues(from: ReliabilityNonPredictingModelConfig, override?: string): void;

  /**
   * Sets multiple secret field values to be the same as the passed instance.
   * @see setSecretValue
   */
  static setSecretValues(from: ReliabilityNonPredictingModelConfig, override?: string): void;
   ...
   */
  static loadConfigAndSecret(configKey: string): ReliabilityNonPredictingModelConfig | null;
   ...
   */
  removeSecrets(): ReliabilityNonPredictingModelConfig | null;

  /**
   * @return this config without any secret values.
   */
  static removeSecrets(): ReliabilityNonPredictingModelConfig | null;

  /**
   * @return this config with only secret values.
   */
  removeNonSecrets(): ReliabilityNonPredictingModelConfig | null;

  /**
   * @return this config with only secret values.
   */
  static removeNonSecrets(): ReliabilityNonPredictingModelConfig | null;

  /**
   * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
   * validation and setup.
   */
  validate(): ReliabilityNonPredictingModelConfig;

  /**
   * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
   * validation and setup.
   */
  static validate(): ReliabilityNonPredictingModelConfig;
