// TypeScript definitions for the C3 type WithPrecomputedFeatures
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of WithPrecomputedFeatures
 */
declare interface IWithPrecomputedFeatures {
 ...
 */
declare class WithPrecomputedFeatures extends Obj  {
   ...
   */
  readonly id: string;
  withId(id: string): WithPrecomputedFeatures;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): WithPrecomputedFeatures;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): WithPrecomputedFeatures;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): WithPrecomputedFeatures;
  ...
  withVersion(version: number | null): WithPrecomputedFeatures;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): WithPrecomputedFeatures;

  /**
   * The precomputed features for this entity.
   */
  readonly precomputedFeatures?: PrecomputedFeatures;
  withPrecomputedFeatures(precomputedFeatures: IPrecomputedFeatures | null): WithPrecomputedFeatures;
  ...
  withIsValidationType(isValidationType: boolean): WithPrecomputedFeatures;
   ...
   * @see #toJson
   */
  static fromJson(json: any): WithPrecomputedFeatures | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): WithPrecomputedFeatures | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): WithPrecomputedFeatures | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): WithPrecomputedFeatures | null;
   ...
   */
  replaceType(old: Type, new_: Type): WithPrecomputedFeatures;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): WithPrecomputedFeatures;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): WithPrecomputedFeatures;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<WithPrecomputedFeatures>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<WithPrecomputedFeatures>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): WithPrecomputedFeatures;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): WithPrecomputedFeatures;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): WithPrecomputedFeatures;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): WithPrecomputedFeatures;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): WithPrecomputedFeatures;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): WithPrecomputedFeatures;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): WithPrecomputedFeatures;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): WithPrecomputedFeatures;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): WithPrecomputedFeatures;
   ...
   * @see #removeField
   */
  withoutField(field: string): WithPrecomputedFeatures;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): WithPrecomputedFeatures;
   ...
   */
  withoutFields(fields: Array_Type<string>): WithPrecomputedFeatures;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): WithPrecomputedFeatures;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): WithPrecomputedFeatures;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): WithPrecomputedFeatures;
   ...
   * @see #unsetField
   */
  defaultField(field: string): WithPrecomputedFeatures;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): WithPrecomputedFeatures;
   ...
   * @see #removeField
   */
  unsetField(field: string): WithPrecomputedFeatures;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): WithPrecomputedFeatures;
   ...
   * @see #unsetField
   */
  removeField(field: string): WithPrecomputedFeatures;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): WithPrecomputedFeatures;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): WithPrecomputedFeatures;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): WithPrecomputedFeatures;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): WithPrecomputedFeatures;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): WithPrecomputedFeatures;

  mergeJson(json: any): WithPrecomputedFeatures;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): WithPrecomputedFeatures;
   ...
   */
  sumObj(other: Obj, deep?: boolean): WithPrecomputedFeatures;
   ...
   */
  singletonArray(): Array_Type<WithPrecomputedFeatures>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<WithPrecomputedFeatures> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<WithPrecomputedFeatures> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<WithPrecomputedFeatures>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<WithPrecomputedFeatures> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, WithPrecomputedFeatures> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, WithPrecomputedFeatures> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<WithPrecomputedFeatures>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<WithPrecomputedFeatures>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): WithPrecomputedFeatures;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): WithPrecomputedFeatures;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): WithPrecomputedFeatures;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): WithPrecomputedFeatures;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): WithPrecomputedFeatures;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): WithPrecomputedFeatures;
   ...
   * @see #fromString
   */
  static make(s: string): WithPrecomputedFeatures | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): WithPrecomputedFeatures;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): WithPrecomputedFeatures;
   ...
   */
  static cachedEmptyInst(): WithPrecomputedFeatures;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<WithPrecomputedFeatures> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): WithPrecomputedFeatures;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<WithPrecomputedFeatures>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<WithPrecomputedFeatures>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<WithPrecomputedFeatures> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<WithPrecomputedFeatures>> | null;
   ...
   */
  get(include?: string): WithPrecomputedFeatures | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): WithPrecomputedFeatures | null;
   ...
   */
  getMissing(spec: GetMissingSpec): WithPrecomputedFeatures;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): WithPrecomputedFeatures | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): WithPrecomputedFeatures;
   ...
   * @see #toString
   */
  static fromString(s: string): WithPrecomputedFeatures | null;
   ...
   */
  create(spec?: UpsertSpec): WithPrecomputedFeatures | null;
   ...
   */
  static createBatch(objs: Array_Type<WithPrecomputedFeatures>, spec?: UpsertSpec): ObjList<WithPrecomputedFeatures> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<WithPrecomputedFeatures>, spec?: CreateBatchObjStreamSpec): ObjList<WithPrecomputedFeatures> | null;
   ...
   */
  update(srcObj?: WithPrecomputedFeatures, spec?: UpsertSpec): WithPrecomputedFeatures | null;
   ...
   */
  upsert(srcObj?: WithPrecomputedFeatures, spec?: UpsertSpec): WithPrecomputedFeatures | null;
   ...
   */
  merge(spec?: MergeSpec): WithPrecomputedFeatures | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): WithPrecomputedFeatures | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): WithPrecomputedFeatures | null;
   ...
   */
  static updateBatch(objs: Array_Type<WithPrecomputedFeatures>, srcObjs?: Array_Type<WithPrecomputedFeatures>, spec?: UpsertSpec): ObjList<WithPrecomputedFeatures> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<WithPrecomputedFeatures> | null>, spec?: UpsertSpec): ObjList<WithPrecomputedFeatures> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<WithPrecomputedFeatures>, srcObjs?: Array_Type<WithPrecomputedFeatures>, spec?: UpsertSpec): ObjList<WithPrecomputedFeatures> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<WithPrecomputedFeatures> | null>, spec?: UpsertSpec): ObjList<WithPrecomputedFeatures> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<WithPrecomputedFeatures>, spec?: TouchSpec): ObjList<WithPrecomputedFeatures> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<WithPrecomputedFeatures>, spec?: MergeSpec): ObjList<WithPrecomputedFeatures> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<WithPrecomputedFeatures>, mergeInclude: string, spec?: MergeSpec): ObjList<WithPrecomputedFeatures> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<WithPrecomputedFeatures> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<WithPrecomputedFeatures> | null;
   ...
   */
  static mergeAll(mergeObj: WithPrecomputedFeatures, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: WithPrecomputedFeatures, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<WithPrecomputedFeatures>, spec?: UpsertSpec): ObjList<WithPrecomputedFeatures> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<WithPrecomputedFeatures>, spec?: UpsertSpec): ObjList<WithPrecomputedFeatures> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): WithPrecomputedFeatures | null;
   ...
   */
  static beforeCreate(objs: Array_Type<WithPrecomputedFeatures>): ObjList<WithPrecomputedFeatures>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<WithPrecomputedFeatures>): ObjList<WithPrecomputedFeatures>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<WithPrecomputedFeatures>): ObjList<WithPrecomputedFeatures>;
   ...
   */
  static afterCreate(objs: Array_Type<WithPrecomputedFeatures>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<WithPrecomputedFeatures>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<WithPrecomputedFeatures>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<WithPrecomputedFeatures>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<WithPrecomputedFeatures>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): WithPrecomputedFeatures | null;
   ...
   */
  withoutIdentity(): WithPrecomputedFeatures | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<WithPrecomputedFeatures>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: WithPrecomputedFeatures, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<WithPrecomputedFeatures>, callback?: λFunction<WithPrecomputedFeatures | null, WithPrecomputedFeatures | null>): ObjList<WithPrecomputedFeatures>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<WithPrecomputedFeatures>, callback?: λFunction<WithPrecomputedFeatures | null, WithPrecomputedFeatures | null>): Array_Type<ObjError> | null;
