// TypeScript definitions for the C3 type ReliabilityOrchestrator.ModelMonitoringJobRun
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityOrchestrator.ModelMonitoringJobRun
 */
declare namespace ReliabilityOrchestrator {
  export interface IModelMonitoringJobRun {

    /**
     * The distributed job this run is an instance of.
     */
    job: IReliabilityOrchestrator.ModelMonitoringJob;

    /**
     * The array of configurations this job run must execute.
     */
    jobSpecs: Array_Type<ReliabilityOrchestrator.ModelMonitoringJobSpec> | Array<IReliabilityOrchestrator.ModelMonitoringJobSpec>;
 ...
 */
declare namespace ReliabilityOrchestrator {
  export class ModelMonitoringJobRun extends Obj  {

    /**
     * The distributed job this run is an instance of.
     */
    readonly job: ReliabilityOrchestrator.ModelMonitoringJob;
    withJob(job: IReliabilityOrchestrator.ModelMonitoringJob): ReliabilityOrchestrator.ModelMonitoringJobRun;

    /**
     * The array of configurations this job run must execute.
     */
    readonly jobSpecs: Array_Type<ReliabilityOrchestrator.ModelMonitoringJobSpec>;
    withJobSpecs(jobSpecs: Array_Type<ReliabilityOrchestrator.ModelMonitoringJobSpec> | Array<IReliabilityOrchestrator.ModelMonitoringJobSpec>): ReliabilityOrchestrator.ModelMonitoringJobRun;
    ...
    withMlOperationRun(mlOperationRun: IMlOperationRun<any> | null): ReliabilityOrchestrator.ModelMonitoringJobRun;

    /**
     * Options that were used to specify execution constraints for this training job run.
     */
    readonly options: ReliabilityOrchestrator.JobOptions;
    withOptions(options: IReliabilityOrchestrator.JobOptions): ReliabilityOrchestrator.ModelMonitoringJobRun;
    ...
    withTypeIdent(typeIdent: string | null): ReliabilityOrchestrator.ModelMonitoringJobRun;
     ...
     */
    readonly id: string;
    withId(id: string): ReliabilityOrchestrator.ModelMonitoringJobRun;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityOrchestrator.ModelMonitoringJobRun;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): ReliabilityOrchestrator.ModelMonitoringJobRun;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): ReliabilityOrchestrator.ModelMonitoringJobRun;
    ...
    withVersion(version: number | null): ReliabilityOrchestrator.ModelMonitoringJobRun;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): ReliabilityOrchestrator.ModelMonitoringJobRun;

    /**
     * {@link JobOptions} for executing this coordinator.
     */
    readonly jobOptions?: JobOptions;
    withJobOptions(jobOptions: IJobOptions | null): ReliabilityOrchestrator.ModelMonitoringJobRun;
     ...
     * @see #toJson
     */
    static fromJson(json: any): ReliabilityOrchestrator.ModelMonitoringJobRun | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): ReliabilityOrchestrator.ModelMonitoringJobRun | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): ReliabilityOrchestrator.ModelMonitoringJobRun | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): ReliabilityOrchestrator.ModelMonitoringJobRun | null;
     ...
     */
    replaceType(old: Type, new_: Type): ReliabilityOrchestrator.ModelMonitoringJobRun;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityOrchestrator.ModelMonitoringJobRun;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityOrchestrator.ModelMonitoringJobRun;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityOrchestrator.ModelMonitoringJobRun>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityOrchestrator.ModelMonitoringJobRun>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityOrchestrator.ModelMonitoringJobRun;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityOrchestrator.ModelMonitoringJobRun;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityOrchestrator.ModelMonitoringJobRun;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): ReliabilityOrchestrator.ModelMonitoringJobRun;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): ReliabilityOrchestrator.ModelMonitoringJobRun;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityOrchestrator.ModelMonitoringJobRun;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityOrchestrator.ModelMonitoringJobRun;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityOrchestrator.ModelMonitoringJobRun;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): ReliabilityOrchestrator.ModelMonitoringJobRun;
     ...
     * @see #removeField
     */
    withoutField(field: string): ReliabilityOrchestrator.ModelMonitoringJobRun;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): ReliabilityOrchestrator.ModelMonitoringJobRun;
     ...
     */
    withoutFields(fields: Array_Type<string>): ReliabilityOrchestrator.ModelMonitoringJobRun;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityOrchestrator.ModelMonitoringJobRun;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): ReliabilityOrchestrator.ModelMonitoringJobRun;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityOrchestrator.ModelMonitoringJobRun;
     ...
     * @see #unsetField
     */
    defaultField(field: string): ReliabilityOrchestrator.ModelMonitoringJobRun;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): ReliabilityOrchestrator.ModelMonitoringJobRun;
     ...
     * @see #removeField
     */
    unsetField(field: string): ReliabilityOrchestrator.ModelMonitoringJobRun;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): ReliabilityOrchestrator.ModelMonitoringJobRun;
     ...
     * @see #unsetField
     */
    removeField(field: string): ReliabilityOrchestrator.ModelMonitoringJobRun;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): ReliabilityOrchestrator.ModelMonitoringJobRun;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityOrchestrator.ModelMonitoringJobRun;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityOrchestrator.ModelMonitoringJobRun;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityOrchestrator.ModelMonitoringJobRun;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityOrchestrator.ModelMonitoringJobRun;

    mergeJson(json: any): ReliabilityOrchestrator.ModelMonitoringJobRun;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityOrchestrator.ModelMonitoringJobRun;
     ...
     */
    sumObj(other: Obj, deep?: boolean): ReliabilityOrchestrator.ModelMonitoringJobRun;
     ...
     */
    singletonArray(): Array_Type<ReliabilityOrchestrator.ModelMonitoringJobRun>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityOrchestrator.ModelMonitoringJobRun> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<ReliabilityOrchestrator.ModelMonitoringJobRun> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<ReliabilityOrchestrator.ModelMonitoringJobRun>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<ReliabilityOrchestrator.ModelMonitoringJobRun> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, ReliabilityOrchestrator.ModelMonitoringJobRun> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityOrchestrator.ModelMonitoringJobRun> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<ReliabilityOrchestrator.ModelMonitoringJobRun>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<ReliabilityOrchestrator.ModelMonitoringJobRun>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityOrchestrator.ModelMonitoringJobRun;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityOrchestrator.ModelMonitoringJobRun;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityOrchestrator.ModelMonitoringJobRun;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): ReliabilityOrchestrator.ModelMonitoringJobRun;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityOrchestrator.ModelMonitoringJobRun;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): ReliabilityOrchestrator.ModelMonitoringJobRun;
     ...
     * @see #fromString
     */
    static make(s: string): ReliabilityOrchestrator.ModelMonitoringJobRun | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityOrchestrator.ModelMonitoringJobRun;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): ReliabilityOrchestrator.ModelMonitoringJobRun;
     ...
     */
    static cachedEmptyInst(): ReliabilityOrchestrator.ModelMonitoringJobRun;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityOrchestrator.ModelMonitoringJobRun> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): ReliabilityOrchestrator.ModelMonitoringJobRun;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<ReliabilityOrchestrator.ModelMonitoringJobRun>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<ReliabilityOrchestrator.ModelMonitoringJobRun>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityOrchestrator.ModelMonitoringJobRun> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityOrchestrator.ModelMonitoringJobRun>> | null;
     ...
     */
    get(include?: string): ReliabilityOrchestrator.ModelMonitoringJobRun | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): ReliabilityOrchestrator.ModelMonitoringJobRun | null;
     ...
     */
    getMissing(spec: GetMissingSpec): ReliabilityOrchestrator.ModelMonitoringJobRun;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): ReliabilityOrchestrator.ModelMonitoringJobRun | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): ReliabilityOrchestrator.ModelMonitoringJobRun;
     ...
     * @see #toString
     */
    static fromString(s: string): ReliabilityOrchestrator.ModelMonitoringJobRun | null;
     ...
     */
    create(spec?: UpsertSpec): ReliabilityOrchestrator.ModelMonitoringJobRun | null;
     ...
     */
    static createBatch(objs: Array_Type<ReliabilityOrchestrator.ModelMonitoringJobRun>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.ModelMonitoringJobRun> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<ReliabilityOrchestrator.ModelMonitoringJobRun>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityOrchestrator.ModelMonitoringJobRun> | null;
     ...
     */
    update(srcObj?: ReliabilityOrchestrator.ModelMonitoringJobRun, spec?: UpsertSpec): ReliabilityOrchestrator.ModelMonitoringJobRun | null;
     ...
     */
    upsert(srcObj?: ReliabilityOrchestrator.ModelMonitoringJobRun, spec?: UpsertSpec): ReliabilityOrchestrator.ModelMonitoringJobRun | null;
     ...
     */
    merge(spec?: MergeSpec): ReliabilityOrchestrator.ModelMonitoringJobRun | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): ReliabilityOrchestrator.ModelMonitoringJobRun | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): ReliabilityOrchestrator.ModelMonitoringJobRun | null;
     ...
     */
    static updateBatch(objs: Array_Type<ReliabilityOrchestrator.ModelMonitoringJobRun>, srcObjs?: Array_Type<ReliabilityOrchestrator.ModelMonitoringJobRun>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.ModelMonitoringJobRun> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<ReliabilityOrchestrator.ModelMonitoringJobRun> | null>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.ModelMonitoringJobRun> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<ReliabilityOrchestrator.ModelMonitoringJobRun>, srcObjs?: Array_Type<ReliabilityOrchestrator.ModelMonitoringJobRun>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.ModelMonitoringJobRun> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<ReliabilityOrchestrator.ModelMonitoringJobRun> | null>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.ModelMonitoringJobRun> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<ReliabilityOrchestrator.ModelMonitoringJobRun>, spec?: TouchSpec): ObjList<ReliabilityOrchestrator.ModelMonitoringJobRun> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityOrchestrator.ModelMonitoringJobRun>, spec?: MergeSpec): ObjList<ReliabilityOrchestrator.ModelMonitoringJobRun> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityOrchestrator.ModelMonitoringJobRun>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityOrchestrator.ModelMonitoringJobRun> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<ReliabilityOrchestrator.ModelMonitoringJobRun> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityOrchestrator.ModelMonitoringJobRun> | null;
     ...
     */
    static mergeAll(mergeObj: ReliabilityOrchestrator.ModelMonitoringJobRun, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: ReliabilityOrchestrator.ModelMonitoringJobRun, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<ReliabilityOrchestrator.ModelMonitoringJobRun>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.ModelMonitoringJobRun> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<ReliabilityOrchestrator.ModelMonitoringJobRun>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.ModelMonitoringJobRun> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): ReliabilityOrchestrator.ModelMonitoringJobRun | null;
     ...
     */
    static beforeCreate(objs: Array_Type<ReliabilityOrchestrator.ModelMonitoringJobRun>): ObjList<ReliabilityOrchestrator.ModelMonitoringJobRun>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<ReliabilityOrchestrator.ModelMonitoringJobRun>): ObjList<ReliabilityOrchestrator.ModelMonitoringJobRun>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<ReliabilityOrchestrator.ModelMonitoringJobRun>): ObjList<ReliabilityOrchestrator.ModelMonitoringJobRun>;
     ...
     */
    static afterCreate(objs: Array_Type<ReliabilityOrchestrator.ModelMonitoringJobRun>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<ReliabilityOrchestrator.ModelMonitoringJobRun>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<ReliabilityOrchestrator.ModelMonitoringJobRun>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityOrchestrator.ModelMonitoringJobRun>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityOrchestrator.ModelMonitoringJobRun>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): ReliabilityOrchestrator.ModelMonitoringJobRun | null;
     ...
     */
    withoutIdentity(): ReliabilityOrchestrator.ModelMonitoringJobRun | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<ReliabilityOrchestrator.ModelMonitoringJobRun>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: ReliabilityOrchestrator.ModelMonitoringJobRun, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<ReliabilityOrchestrator.ModelMonitoringJobRun>, callback?: λFunction<ReliabilityOrchestrator.ModelMonitoringJobRun | null, ReliabilityOrchestrator.ModelMonitoringJobRun | null>): ObjList<ReliabilityOrchestrator.ModelMonitoringJobRun>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<ReliabilityOrchestrator.ModelMonitoringJobRun>, callback?: λFunction<ReliabilityOrchestrator.ModelMonitoringJobRun | null, ReliabilityOrchestrator.ModelMonitoringJobRun | null>): Array_Type<ObjError> | null;
     ...
     */
    generateNextResults(completed?: Stream<ReliabilityOrchestrator.ModelMonitoringJobResult>): number;
     ...
     */
    startResult(result: ReliabilityOrchestrator.ModelMonitoringJobResult): ReliabilityOrchestrator.ModelMonitoringJobResult;
     ...
     */
    afterStart(results: Stream<ReliabilityOrchestrator.ModelMonitoringJobResult>): Stream<ReliabilityOrchestrator.ModelMonitoringJobResult> | null;
     ...
     * @return the result instance, as acknowledgement, even if unmodified.
     */
    completeResult(result: ReliabilityOrchestrator.ModelMonitoringJobResult): ReliabilityOrchestrator.ModelMonitoringJobResult;
     ...
     */
    updateRunningResults(spec?: FetchStreamSpec): Stream<ReliabilityOrchestrator.ModelMonitoringJobResult> | null;
     ...
     */
    afterComplete(results: Stream<ReliabilityOrchestrator.ModelMonitoringJobResult>): Stream<ReliabilityOrchestrator.ModelMonitoringJobResult> | null;
     ...
     */
    runFromResult(result: ReliabilityOrchestrator.ModelMonitoringJobResult): WorkflowExecutorRun | null;
     ...
     *    Optional {@link FetchStreamSpec} for customizing fetching of RT objects.
     */
    pendingResults(spec?: FetchStreamSpec): Stream<ReliabilityOrchestrator.ModelMonitoringJobResult> | null;
     ...
     *    Optional {@link FetchStreamSpec} for customizing fetching of RT objects.
     */
    runningResults(spec?: FetchStreamSpec): Stream<ReliabilityOrchestrator.ModelMonitoringJobResult> | null;
     ...
     *    Optional {@link FetchStreamSpec} for customizing fetching of RT objects.
     */
    completedResults(spec?: FetchStreamSpec): Stream<ReliabilityOrchestrator.ModelMonitoringJobResult> | null;
     ...
     *    Optional {@link FetchStreamSpec} for customizing fetching of RT objects.
     */
    canceledResults(spec?: FetchStreamSpec): Stream<ReliabilityOrchestrator.ModelMonitoringJobResult> | null;
     ...
     *    Optional {@link FetchStreamSpec} for customizing fetching of RT objects.
     */
    erroredResults(spec?: FetchStreamSpec): Stream<ReliabilityOrchestrator.ModelMonitoringJobResult> | null;
     ...
     *    Optional {@link FetchStreamSpec} for customizing fetching of RT objects.
     */
    allResults(spec?: FetchStreamSpec): Stream<ReliabilityOrchestrator.ModelMonitoringJobResult> | null;
     ...
     */
    customSummaryFieldsForResult(result: ReliabilityOrchestrator.ModelMonitoringJobResult): Map_Type<string, any> | null;
     ...
     * @return a table with a row for each step and the corresponding execution metadata.
     */
    summaryForResults(results: Array_Type<ReliabilityOrchestrator.ModelMonitoringJobResult>, spec?: Workflow.Monitorable.SummarySpec): Data;
     ...
     * @return a table with a row for each step and the corresponding execution metadata.
     */
    summaryForResultsPd(results: Array_Type<ReliabilityOrchestrator.ModelMonitoringJobResult>, spec?: Workflow.Monitorable.SummarySpec): any | null;
     ...
     */
    resultsForSummary(spec?: FetchSpec): FetchResult<ReliabilityOrchestrator.ModelMonitoringJobResult> | null;
  }
}
