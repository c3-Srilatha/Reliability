// TypeScript definitions for the C3 type ReliabilityAssetToModelConfigRunRelation

/**
 * Relation type between {@link ReliabilityAsset} and {@link ModelConfigRun}.
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityAssetToModelConfigRunRelation
 */
declare interface IReliabilityAssetToModelConfigRunRelation {
  ...
  /**
   * The {@link ReliabilityAsset} for this relation.
   */
  from?: IReliabilityAsset;

  /**
   * The {@link ModelConfigRun} for this relation.
   */
  to?: IModelConfigRun;
}
 ...
 * Relation type between {@link ReliabilityAsset} and {@link ModelConfigRun}.
 *
 * @remarks this represents a made instance of ReliabilityAssetToModelConfigRunRelation
 */
declare class ReliabilityAssetToModelConfigRunRelation extends Obj  {
   ...
   */
  readonly id: string;
  withId(id: string): ReliabilityAssetToModelConfigRunRelation;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityAssetToModelConfigRunRelation;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): ReliabilityAssetToModelConfigRunRelation;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): ReliabilityAssetToModelConfigRunRelation;
  ...
  withVersion(version: number | null): ReliabilityAssetToModelConfigRunRelation;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): ReliabilityAssetToModelConfigRunRelation;

  /**
   * @inheritdoc
   */
  readonly facilityFilterPaths?: Array_Type<string>;
  withFacilityFilterPaths(facilityFilterPaths: Array_Type<string> | Array<string> | null): ReliabilityAssetToModelConfigRunRelation;

  /**
   * The {@link ReliabilityAsset} for this relation.
   */
  readonly from?: ReliabilityAsset;
  withFrom(from: IReliabilityAsset | null): ReliabilityAssetToModelConfigRunRelation;

  /**
   * The {@link ModelConfigRun} for this relation.
   */
  readonly to?: ModelConfigRun;
  withTo(to: IModelConfigRun | null): ReliabilityAssetToModelConfigRunRelation;
   ...
   * @see #toJson
   */
  static fromJson(json: any): ReliabilityAssetToModelConfigRunRelation | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): ReliabilityAssetToModelConfigRunRelation | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): ReliabilityAssetToModelConfigRunRelation | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): ReliabilityAssetToModelConfigRunRelation | null;
   ...
   */
  replaceType(old: Type, new_: Type): ReliabilityAssetToModelConfigRunRelation;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityAssetToModelConfigRunRelation;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityAssetToModelConfigRunRelation;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityAssetToModelConfigRunRelation>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityAssetToModelConfigRunRelation>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityAssetToModelConfigRunRelation;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityAssetToModelConfigRunRelation;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityAssetToModelConfigRunRelation;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ReliabilityAssetToModelConfigRunRelation;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ReliabilityAssetToModelConfigRunRelation;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityAssetToModelConfigRunRelation;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityAssetToModelConfigRunRelation;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityAssetToModelConfigRunRelation;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ReliabilityAssetToModelConfigRunRelation;
   ...
   * @see #removeField
   */
  withoutField(field: string): ReliabilityAssetToModelConfigRunRelation;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): ReliabilityAssetToModelConfigRunRelation;
   ...
   */
  withoutFields(fields: Array_Type<string>): ReliabilityAssetToModelConfigRunRelation;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityAssetToModelConfigRunRelation;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ReliabilityAssetToModelConfigRunRelation;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityAssetToModelConfigRunRelation;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ReliabilityAssetToModelConfigRunRelation;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ReliabilityAssetToModelConfigRunRelation;
   ...
   * @see #removeField
   */
  unsetField(field: string): ReliabilityAssetToModelConfigRunRelation;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ReliabilityAssetToModelConfigRunRelation;
   ...
   * @see #unsetField
   */
  removeField(field: string): ReliabilityAssetToModelConfigRunRelation;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ReliabilityAssetToModelConfigRunRelation;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityAssetToModelConfigRunRelation;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityAssetToModelConfigRunRelation;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityAssetToModelConfigRunRelation;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityAssetToModelConfigRunRelation;

  mergeJson(json: any): ReliabilityAssetToModelConfigRunRelation;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityAssetToModelConfigRunRelation;
   ...
   */
  sumObj(other: Obj, deep?: boolean): ReliabilityAssetToModelConfigRunRelation;
   ...
   */
  singletonArray(): Array_Type<ReliabilityAssetToModelConfigRunRelation>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityAssetToModelConfigRunRelation> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ReliabilityAssetToModelConfigRunRelation> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<ReliabilityAssetToModelConfigRunRelation>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ReliabilityAssetToModelConfigRunRelation> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, ReliabilityAssetToModelConfigRunRelation> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityAssetToModelConfigRunRelation> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ReliabilityAssetToModelConfigRunRelation>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ReliabilityAssetToModelConfigRunRelation>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityAssetToModelConfigRunRelation;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityAssetToModelConfigRunRelation;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityAssetToModelConfigRunRelation;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ReliabilityAssetToModelConfigRunRelation;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityAssetToModelConfigRunRelation;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ReliabilityAssetToModelConfigRunRelation;
   ...
   * @see #fromString
   */
  static make(s: string): ReliabilityAssetToModelConfigRunRelation | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityAssetToModelConfigRunRelation;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): ReliabilityAssetToModelConfigRunRelation;
   ...
   */
  static cachedEmptyInst(): ReliabilityAssetToModelConfigRunRelation;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityAssetToModelConfigRunRelation> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): ReliabilityAssetToModelConfigRunRelation;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<ReliabilityAssetToModelConfigRunRelation>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<ReliabilityAssetToModelConfigRunRelation>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityAssetToModelConfigRunRelation> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityAssetToModelConfigRunRelation>> | null;
   ...
   */
  get(include?: string): ReliabilityAssetToModelConfigRunRelation | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): ReliabilityAssetToModelConfigRunRelation | null;
   ...
   */
  getMissing(spec: GetMissingSpec): ReliabilityAssetToModelConfigRunRelation;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): ReliabilityAssetToModelConfigRunRelation | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): ReliabilityAssetToModelConfigRunRelation;
   ...
   * @see #toString
   */
  static fromString(s: string): ReliabilityAssetToModelConfigRunRelation | null;
   ...
   */
  create(spec?: UpsertSpec): ReliabilityAssetToModelConfigRunRelation | null;
   ...
   */
  static createBatch(objs: Array_Type<ReliabilityAssetToModelConfigRunRelation>, spec?: UpsertSpec): ObjList<ReliabilityAssetToModelConfigRunRelation> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<ReliabilityAssetToModelConfigRunRelation>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityAssetToModelConfigRunRelation> | null;
   ...
   */
  update(srcObj?: ReliabilityAssetToModelConfigRunRelation, spec?: UpsertSpec): ReliabilityAssetToModelConfigRunRelation | null;
   ...
   */
  upsert(srcObj?: ReliabilityAssetToModelConfigRunRelation, spec?: UpsertSpec): ReliabilityAssetToModelConfigRunRelation | null;
   ...
   */
  merge(spec?: MergeSpec): ReliabilityAssetToModelConfigRunRelation | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): ReliabilityAssetToModelConfigRunRelation | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): ReliabilityAssetToModelConfigRunRelation | null;
   ...
   */
  static updateBatch(objs: Array_Type<ReliabilityAssetToModelConfigRunRelation>, srcObjs?: Array_Type<ReliabilityAssetToModelConfigRunRelation>, spec?: UpsertSpec): ObjList<ReliabilityAssetToModelConfigRunRelation> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<ReliabilityAssetToModelConfigRunRelation> | null>, spec?: UpsertSpec): ObjList<ReliabilityAssetToModelConfigRunRelation> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<ReliabilityAssetToModelConfigRunRelation>, srcObjs?: Array_Type<ReliabilityAssetToModelConfigRunRelation>, spec?: UpsertSpec): ObjList<ReliabilityAssetToModelConfigRunRelation> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<ReliabilityAssetToModelConfigRunRelation> | null>, spec?: UpsertSpec): ObjList<ReliabilityAssetToModelConfigRunRelation> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<ReliabilityAssetToModelConfigRunRelation>, spec?: TouchSpec): ObjList<ReliabilityAssetToModelConfigRunRelation> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityAssetToModelConfigRunRelation>, spec?: MergeSpec): ObjList<ReliabilityAssetToModelConfigRunRelation> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityAssetToModelConfigRunRelation>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityAssetToModelConfigRunRelation> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<ReliabilityAssetToModelConfigRunRelation> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityAssetToModelConfigRunRelation> | null;
   ...
   */
  static mergeAll(mergeObj: ReliabilityAssetToModelConfigRunRelation, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: ReliabilityAssetToModelConfigRunRelation, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<ReliabilityAssetToModelConfigRunRelation>, spec?: UpsertSpec): ObjList<ReliabilityAssetToModelConfigRunRelation> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<ReliabilityAssetToModelConfigRunRelation>, spec?: UpsertSpec): ObjList<ReliabilityAssetToModelConfigRunRelation> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): ReliabilityAssetToModelConfigRunRelation | null;
   ...
   */
  static beforeCreate(objs: Array_Type<ReliabilityAssetToModelConfigRunRelation>): ObjList<ReliabilityAssetToModelConfigRunRelation>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<ReliabilityAssetToModelConfigRunRelation>): ObjList<ReliabilityAssetToModelConfigRunRelation>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<ReliabilityAssetToModelConfigRunRelation>): ObjList<ReliabilityAssetToModelConfigRunRelation>;
   ...
   */
  static afterCreate(objs: Array_Type<ReliabilityAssetToModelConfigRunRelation>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<ReliabilityAssetToModelConfigRunRelation>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<ReliabilityAssetToModelConfigRunRelation>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityAssetToModelConfigRunRelation>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityAssetToModelConfigRunRelation>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): ReliabilityAssetToModelConfigRunRelation | null;
   ...
   */
  withoutIdentity(): ReliabilityAssetToModelConfigRunRelation | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<ReliabilityAssetToModelConfigRunRelation>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: ReliabilityAssetToModelConfigRunRelation, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<ReliabilityAssetToModelConfigRunRelation>, callback?: λFunction<ReliabilityAssetToModelConfigRunRelation | null, ReliabilityAssetToModelConfigRunRelation | null>): ObjList<ReliabilityAssetToModelConfigRunRelation>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<ReliabilityAssetToModelConfigRunRelation>, callback?: λFunction<ReliabilityAssetToModelConfigRunRelation | null, ReliabilityAssetToModelConfigRunRelation | null>): Array_Type<ObjError> | null;
