// TypeScript definitions for the C3 type ReliabilityAlertTriagingConfiguration

/**
 * This type is used to configure the automatic triaging of {@link ReliabilityAssetAlert}s.
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityAlertTriagingConfiguration
 */
declare interface IReliabilityAlertTriagingConfiguration {
  ...
  /**
   * Translation key of the string description of the Similarity Score calculation and the pre-calculation alert filtering logic.
   * The field will be referenced in the UI (e.g., in Similarity Score Grid tooltip).
   */
  displayGroupingAlertLogicDescriptionTranslationKey?: string;

  /**
   * Indicates whether automatic addition to {@link ReliabilityAssetCase}s for {@link ReliabilityAssetAlert} should be enabled.
   */
  automaticallyAddToCase?: boolean;

  /**
   * Once similar {@link ReliabilityAssetAlert}s are determined for a specific alert,
   * the next step is to retrieve {@link ReliabilityAssetCase}s associated with the similar alerts.
   * This {@link FetchSpec} along with a pre-determined filter will be used to retrieve the respective cases to automatically add the alert to.
   *
   * The default is { filter: '', order: 'descending(latestActivityTime)', limit: 1 }
   *
   * - `filter`: Should be set to retrieve the most recent case for the similar alert.
   * - `order`: Should be set to descending(latestActivityTime) to ensure the most recent case is retrieved.
   * - `limit`: Should be set to 1 to ensure only the most recent case is retrieved.
   */
  groupToCasesFetchSpec: IFetchSpec;

  /**
   * Support for Postgres or Cassandra storage is determined by the scale of alerts triggered in the application.
   * This configuration field specifies the selected data type used to retrieve similarity data.
   */
  similarityTypeName?: string;

  /**
   * Threshold for filtering similar alerts and determining case assignments.
   *
   * This value controls which similar alerts are retrieved in the UI for a specific alert. Similar alerts
   * with a similarity score greater than or equal to this threshold will be retrieved.
   *
   * Additionally, when automatically adding an alert to case(s), the applicable cases are retrieved from the cases
   * of the similar alerts. This value will also filter the similar alerts to determine which cases to add the alert to.
   */
  alertSimilarityFilterThreshold?: number;

  /**
   * The limit for the fetch call used to retrieve similarities for alerts belonging to a {@link ReliabilityAssetCase} in
   * {@link ReliabilityAssetCase#fetchSimilarAlerts}. The default value is set to default value 2000 but can be increased.
   */
  similaritiesForAlertsInCaseFetchLimit?: number;
}

/**
 * This type is used to configure the automatic triaging of {@link ReliabilityAssetAlert}s.
 *
 * @remarks this represents a made instance of ReliabilityAlertTriagingConfiguration
 */
declare class ReliabilityAlertTriagingConfiguration extends Obj  {

  readonly configOverride?: string;
  withConfigOverride(configOverride: string | null): ReliabilityAlertTriagingConfiguration;

  static readonly configOverride?: string;

  readonly secretOverride?: string;
  withSecretOverride(secretOverride: string | null): ReliabilityAlertTriagingConfiguration;
  ...
  withIssues(issues: Array_Type<string> | Array<string> | null): ReliabilityAlertTriagingConfiguration;
   ...
   * The field will be referenced in the UI (e.g., in Similarity Score Grid tooltip).
   */
  readonly displayGroupingAlertLogicDescriptionTranslationKey?: string;
  withDisplayGroupingAlertLogicDescriptionTranslationKey(displayGroupingAlertLogicDescriptionTranslationKey: string | null): ReliabilityAlertTriagingConfiguration;

  /**
   * Translation key of the string description of the Similarity Score calculation and the pre-calculation alert filtering logic.
   * The field will be referenced in the UI (e.g., in Similarity Score Grid tooltip).
   */
  static readonly displayGroupingAlertLogicDescriptionTranslationKey?: string;

  /**
   * Indicates whether automatic addition to {@link ReliabilityAssetCase}s for {@link ReliabilityAssetAlert} should be enabled.
   */
  readonly automaticallyAddToCase?: boolean;
  withAutomaticallyAddToCase(automaticallyAddToCase: boolean): ReliabilityAlertTriagingConfiguration;

  /**
   * Indicates whether automatic addition to {@link ReliabilityAssetCase}s for {@link ReliabilityAssetAlert} should be enabled.
   */
  static readonly automaticallyAddToCase?: boolean;
   ...
   * - `limit`: Should be set to 1 to ensure only the most recent case is retrieved.
   */
  readonly groupToCasesFetchSpec: FetchSpec;
  withGroupToCasesFetchSpec(groupToCasesFetchSpec: IFetchSpec): ReliabilityAlertTriagingConfiguration;
   ...
   * - `limit`: Should be set to 1 to ensure only the most recent case is retrieved.
   */
  static readonly groupToCasesFetchSpec: FetchSpec;

  /**
   * Support for Postgres or Cassandra storage is determined by the scale of alerts triggered in the application.
   * This configuration field specifies the selected data type used to retrieve similarity data.
   */
  readonly similarityTypeName?: string;
  withSimilarityTypeName(similarityTypeName: string | null): ReliabilityAlertTriagingConfiguration;

  /**
   * Support for Postgres or Cassandra storage is determined by the scale of alerts triggered in the application.
   * This configuration field specifies the selected data type used to retrieve similarity data.
   */
  static readonly similarityTypeName?: string;
   ...
   * of the similar alerts. This value will also filter the similar alerts to determine which cases to add the alert to.
   */
  readonly alertSimilarityFilterThreshold?: number;
  withAlertSimilarityFilterThreshold(alertSimilarityFilterThreshold: number | null): ReliabilityAlertTriagingConfiguration;
   ...
   * of the similar alerts. This value will also filter the similar alerts to determine which cases to add the alert to.
   */
  static readonly alertSimilarityFilterThreshold?: number;

  /**
   * The limit for the fetch call used to retrieve similarities for alerts belonging to a {@link ReliabilityAssetCase} in
   * {@link ReliabilityAssetCase#fetchSimilarAlerts}. The default value is set to default value 2000 but can be increased.
   */
  readonly similaritiesForAlertsInCaseFetchLimit?: number;
  withSimilaritiesForAlertsInCaseFetchLimit(similaritiesForAlertsInCaseFetchLimit: number | null): ReliabilityAlertTriagingConfiguration;

  /**
   * The limit for the fetch call used to retrieve similarities for alerts belonging to a {@link ReliabilityAssetCase} in
   * {@link ReliabilityAssetCase#fetchSimilarAlerts}. The default value is set to default value 2000 but can be increased.
   */
  static readonly similaritiesForAlertsInCaseFetchLimit?: number;
   ...
   * @see #toJson
   */
  static fromJson(json: any): ReliabilityAlertTriagingConfiguration | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): ReliabilityAlertTriagingConfiguration | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): ReliabilityAlertTriagingConfiguration | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): ReliabilityAlertTriagingConfiguration | null;
   ...
   */
  replaceType(old: Type, new_: Type): ReliabilityAlertTriagingConfiguration;
   ...
   * This method is used during live metadata update
   */
  static replaceType(old: Type, new_: Type): ReliabilityAlertTriagingConfiguration;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityAlertTriagingConfiguration;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityAlertTriagingConfiguration;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityAlertTriagingConfiguration;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityAlertTriagingConfiguration;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityAlertTriagingConfiguration>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityAlertTriagingConfiguration>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityAlertTriagingConfiguration>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityAlertTriagingConfiguration>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityAlertTriagingConfiguration;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityAlertTriagingConfiguration;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityAlertTriagingConfiguration;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityAlertTriagingConfiguration;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityAlertTriagingConfiguration;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityAlertTriagingConfiguration;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ReliabilityAlertTriagingConfiguration;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  static validateObj(): ReliabilityAlertTriagingConfiguration;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ReliabilityAlertTriagingConfiguration;
   ...
   * @see #defaultField
   */
  static withField(field: string, value: any, doNotConvert?: boolean): ReliabilityAlertTriagingConfiguration;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityAlertTriagingConfiguration;
   ...
   * @see #defaultField
   */
  static withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityAlertTriagingConfiguration;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityAlertTriagingConfiguration;
   ...
   * @return new Obj
   */
  static withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityAlertTriagingConfiguration;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityAlertTriagingConfiguration;
   ...
   * @return new Obj
   */
  static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityAlertTriagingConfiguration;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ReliabilityAlertTriagingConfiguration;
   ...
   * @see #withoutField
   */
  static withoutFieldAtPath(path: string): ReliabilityAlertTriagingConfiguration;
   ...
   * @see #removeField
   */
  withoutField(field: string): ReliabilityAlertTriagingConfiguration;
   ...
   * @see #removeField
   */
  static withoutField(field: string): ReliabilityAlertTriagingConfiguration;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): ReliabilityAlertTriagingConfiguration;
   ...
   * @see #removeField
   */
  static withoutField(field: FieldType): ReliabilityAlertTriagingConfiguration;
   ...
   */
  withoutFields(fields: Array_Type<string>): ReliabilityAlertTriagingConfiguration;
   ...
   * @return new Obj with removed fields
   */
  static withoutFields(fields: Array_Type<string>): ReliabilityAlertTriagingConfiguration;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityAlertTriagingConfiguration;
   ...
   * @return new Obj with removed fields
   */
  static withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityAlertTriagingConfiguration;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ReliabilityAlertTriagingConfiguration;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  static withoutSecretFields(): ReliabilityAlertTriagingConfiguration;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityAlertTriagingConfiguration;
   ...
   * @see FieldType#defaultValue
   */
  static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityAlertTriagingConfiguration;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ReliabilityAlertTriagingConfiguration;
   ...
   * @see #unsetField
   */
  static defaultField(field: string): ReliabilityAlertTriagingConfiguration;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ReliabilityAlertTriagingConfiguration;
   ...
   * @see #unsetField
   */
  static defaultField(field: FieldType): ReliabilityAlertTriagingConfiguration;
   ...
   * @see #removeField
   */
  unsetField(field: string): ReliabilityAlertTriagingConfiguration;
   ...
   * @see #removeField
   */
  static unsetField(field: string): ReliabilityAlertTriagingConfiguration;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ReliabilityAlertTriagingConfiguration;
   ...
   * @see #removeField
   */
  static unsetField(field: FieldType): ReliabilityAlertTriagingConfiguration;
   ...
   * @see #unsetField
   */
  removeField(field: string): ReliabilityAlertTriagingConfiguration;
   ...
   * @see #unsetField
   */
  static removeField(field: string): ReliabilityAlertTriagingConfiguration;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ReliabilityAlertTriagingConfiguration;
   ...
   * @see #unsetField
   */
  static removeField(field: FieldType): ReliabilityAlertTriagingConfiguration;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityAlertTriagingConfiguration;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityAlertTriagingConfiguration;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityAlertTriagingConfiguration;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityAlertTriagingConfiguration;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityAlertTriagingConfiguration;
   ...
   *        the same key or index.
   */
  static mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityAlertTriagingConfiguration;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityAlertTriagingConfiguration;
   ...
   * traverse child reference and collection fields.
   */
  static mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityAlertTriagingConfiguration;

  mergeJson(json: any): ReliabilityAlertTriagingConfiguration;

  static mergeJson(json: any): ReliabilityAlertTriagingConfiguration;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityAlertTriagingConfiguration;
   ...
   * @return Obj with child references merged
   */
  static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityAlertTriagingConfiguration;
   ...
   */
  sumObj(other: Obj, deep?: boolean): ReliabilityAlertTriagingConfiguration;
   ...
   * references with same name and collection elements at same index or key.
   */
  static sumObj(other: Obj, deep?: boolean): ReliabilityAlertTriagingConfiguration;
   ...
   */
  singletonArray(): Array_Type<ReliabilityAlertTriagingConfiguration>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonArray(): Array_Type<ReliabilityAlertTriagingConfiguration>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityAlertTriagingConfiguration> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ReliabilityAlertTriagingConfiguration> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<ReliabilityAlertTriagingConfiguration>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonSet(): Set_Type<ReliabilityAlertTriagingConfiguration>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ReliabilityAlertTriagingConfiguration> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, ReliabilityAlertTriagingConfiguration> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityAlertTriagingConfiguration> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ReliabilityAlertTriagingConfiguration>;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  static toBuilder(): ObjBuilder<ReliabilityAlertTriagingConfiguration>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ReliabilityAlertTriagingConfiguration>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityAlertTriagingConfiguration;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityAlertTriagingConfiguration;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityAlertTriagingConfiguration;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ReliabilityAlertTriagingConfiguration;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityAlertTriagingConfiguration;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ReliabilityAlertTriagingConfiguration;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityAlertTriagingConfiguration;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): ReliabilityAlertTriagingConfiguration;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  static afterMake(): ReliabilityAlertTriagingConfiguration;
   ...
   */
  static cachedEmptyInst(): ReliabilityAlertTriagingConfiguration;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityAlertTriagingConfiguration> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): ReliabilityAlertTriagingConfiguration;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<ReliabilityAlertTriagingConfiguration> | null;
   ...
   */
  static find(filter?: string, doNotProduceAll?: boolean): Stream<ReliabilityAlertTriagingConfiguration> | null;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<ReliabilityAlertTriagingConfiguration> | null;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): ReliabilityAlertTriagingConfiguration | null;

  /**
   * Returns cached instance by key, with secrets removed.
   */
  static forCacheKey(key: string): ReliabilityAlertTriagingConfiguration | null;
   ...
   * @see findByCacheKey
   */
  getCached(): ReliabilityAlertTriagingConfiguration | null;
   ...
   * @see findByCacheKey
   */
  static getCached(): ReliabilityAlertTriagingConfiguration | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): ReliabilityAlertTriagingConfiguration | null;

  /**
   * @return newly produced cached instance.
   */
  static refreshCache(): ReliabilityAlertTriagingConfiguration | null;
   ...
   */
  static produce(key: string): ReliabilityAlertTriagingConfiguration | null;
   ...
   */
  static produceAll(): Map_Type<string, ReliabilityAlertTriagingConfiguration> | null;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): Map_Type<string, ReliabilityAlertTriagingConfiguration> | null;
   ...
   */
  getConfig(): ReliabilityAlertTriagingConfiguration;
   ...
   * Note that typical pattern is to use Configurable#config instead of this method.
   */
  static getConfig(): ReliabilityAlertTriagingConfiguration;
   ...
   */
  getSecret(): ReliabilityAlertTriagingConfiguration;
   ...
   * Note that typical pattern is to use Configurable#configWithSecrets instead of this method.
   */
  static getSecret(): ReliabilityAlertTriagingConfiguration;
   ...
   */
  withConfigKey(configKey: string): ReliabilityAlertTriagingConfiguration;
   ...
   *     config.configKey() => "folder1/abc"
   */
  static withConfigKey(configKey: string): ReliabilityAlertTriagingConfiguration;

  /**
   * @return copy without config key.
   */
  withoutConfigKey(): ReliabilityAlertTriagingConfiguration;

  /**
   * @return copy without config key.
   */
  static withoutConfigKey(): ReliabilityAlertTriagingConfiguration;

  /**
   * @return return cached config instance for provided config key.
   */
  static forConfigKey(configKey: string): ReliabilityAlertTriagingConfiguration | null;
   ...
   */
  static listConfigs(parallel?: boolean, filter?: λPredicate<string>): Stream<ReliabilityAlertTriagingConfiguration> | null;
   ...
   * @see setConfigValue
   */
  setConfigValues(from: ReliabilityAlertTriagingConfiguration, override?: string): void;

  /**
   * Sets multiple field values to be the same as the passed instance.
   * @see setConfigValue
   */
  static setConfigValues(from: ReliabilityAlertTriagingConfiguration, override?: string): void;
   ...
   * @see setSecretValue
   */
  setSecretValues(from: ReliabilityAlertTriagingConfiguration, override?: string): void;

  /**
   * Sets multiple secret field values to be the same as the passed instance.
   * @see setSecretValue
   */
  static setSecretValues(from: ReliabilityAlertTriagingConfiguration, override?: string): void;
   ...
   */
  static loadConfigAndSecret(configKey: string): ReliabilityAlertTriagingConfiguration | null;
   ...
   */
  removeSecrets(): ReliabilityAlertTriagingConfiguration | null;

  /**
   * @return this config without any secret values.
   */
  static removeSecrets(): ReliabilityAlertTriagingConfiguration | null;

  /**
   * @return this config with only secret values.
   */
  removeNonSecrets(): ReliabilityAlertTriagingConfiguration | null;

  /**
   * @return this config with only secret values.
   */
  static removeNonSecrets(): ReliabilityAlertTriagingConfiguration | null;

  /**
   * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
   * validation and setup.
   */
  validate(): ReliabilityAlertTriagingConfiguration;

  /**
   * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
   * validation and setup.
   */
  static validate(): ReliabilityAlertTriagingConfiguration;
   ...
   */
  static inst(): ReliabilityAlertTriagingConfiguration;

  /**
   * @return the cached instance if already cached, null otherwise. Does not instantiate if missing.
   */
  static cachedInst(): ReliabilityAlertTriagingConfiguration | null;
}
