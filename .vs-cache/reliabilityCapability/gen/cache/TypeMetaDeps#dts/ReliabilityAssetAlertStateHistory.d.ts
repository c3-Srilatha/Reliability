// TypeScript definitions for the C3 type ReliabilityAssetAlertStateHistory

/**
 * Represents the state transition history for a `ReliabilityAssetAlert`.
 *
 * - Tracks changes in `ReliabilityAssetAlertState` over time.
 * - Captures transitions between states along with associated comments.
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityAssetAlertStateHistory
 */
declare interface IReliabilityAssetAlertStateHistory {
   ...
   */
  state: IReliabilityAssetAlertState;
   ...
   */
  transition?: IReliabilityAssetAlertStateTransition;
  ...
  /**
   * A comment associated with the state transition in the alert history.
   */
 ...
 * - Captures transitions between states along with associated comments.
 *
 * @remarks this represents a made instance of ReliabilityAssetAlertStateHistory
 */
declare class ReliabilityAssetAlertStateHistory extends Obj  {

  /**
   * Timestamp for the value.
   */
  readonly timestamp: DateTime;
  withTimestamp(timestamp: DateTime | Date | string): ReliabilityAssetAlertStateHistory;

  /**
   * Parent/owning obj instance.
   */
  readonly parent: ReliabilityAssetAlert;
  withParent(parent: IReliabilityAssetAlert): ReliabilityAssetAlertStateHistory;

  /**
   * All transition are disabled when `error` is true.
   */
  readonly error?: boolean;
  withError(error: boolean): ReliabilityAssetAlertStateHistory;

  /**
   * A field for populating an error message if an error occurs.
   */
  readonly errorMessage?: string;
  withErrorMessage(errorMessage: string | null): ReliabilityAssetAlertStateHistory;
  ...
  withStateOrderCounter(stateOrderCounter: number): ReliabilityAssetAlertStateHistory;

  /**
   * The state of this step in the {@link StateMachineHistory}.
   */
  readonly state: ReliabilityAssetAlertState;
  withState(state: IReliabilityAssetAlertState): ReliabilityAssetAlertStateHistory;

  /**
   * If null, the new state is set through automatic transition.
   */
  readonly updatedBy?: User;
  withUpdatedBy(updatedBy: IUser | null): ReliabilityAssetAlertStateHistory;

  /**
   * If null, the new state is set without evaluating any transition conditions.
   */
  readonly transition?: ReliabilityAssetAlertStateTransition;
  withTransition(transition: IReliabilityAssetAlertStateTransition | null): ReliabilityAssetAlertStateHistory;
   ...
   */
  readonly id: string;
  withId(id: string): ReliabilityAssetAlertStateHistory;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityAssetAlertStateHistory;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): ReliabilityAssetAlertStateHistory;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): ReliabilityAssetAlertStateHistory;
  ...
  withVersion(version: number | null): ReliabilityAssetAlertStateHistory;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): ReliabilityAssetAlertStateHistory;

  /**
   * A comment associated with the state transition in the alert history.
   */
  readonly comment?: AlertComment;
  withComment(comment: IAlertComment | null): ReliabilityAssetAlertStateHistory;
   ...
   * @see #toJson
   */
  static fromJson(json: any): ReliabilityAssetAlertStateHistory | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): ReliabilityAssetAlertStateHistory | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): ReliabilityAssetAlertStateHistory | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): ReliabilityAssetAlertStateHistory | null;
   ...
   */
  replaceType(old: Type, new_: Type): ReliabilityAssetAlertStateHistory;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityAssetAlertStateHistory;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityAssetAlertStateHistory;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityAssetAlertStateHistory>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityAssetAlertStateHistory>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityAssetAlertStateHistory;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityAssetAlertStateHistory;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityAssetAlertStateHistory;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ReliabilityAssetAlertStateHistory;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ReliabilityAssetAlertStateHistory;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityAssetAlertStateHistory;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityAssetAlertStateHistory;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityAssetAlertStateHistory;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ReliabilityAssetAlertStateHistory;
   ...
   * @see #removeField
   */
  withoutField(field: string): ReliabilityAssetAlertStateHistory;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): ReliabilityAssetAlertStateHistory;
   ...
   */
  withoutFields(fields: Array_Type<string>): ReliabilityAssetAlertStateHistory;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityAssetAlertStateHistory;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ReliabilityAssetAlertStateHistory;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityAssetAlertStateHistory;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ReliabilityAssetAlertStateHistory;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ReliabilityAssetAlertStateHistory;
   ...
   * @see #removeField
   */
  unsetField(field: string): ReliabilityAssetAlertStateHistory;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ReliabilityAssetAlertStateHistory;
   ...
   * @see #unsetField
   */
  removeField(field: string): ReliabilityAssetAlertStateHistory;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ReliabilityAssetAlertStateHistory;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityAssetAlertStateHistory;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityAssetAlertStateHistory;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityAssetAlertStateHistory;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityAssetAlertStateHistory;

  mergeJson(json: any): ReliabilityAssetAlertStateHistory;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityAssetAlertStateHistory;
   ...
   */
  sumObj(other: Obj, deep?: boolean): ReliabilityAssetAlertStateHistory;
   ...
   */
  singletonArray(): Array_Type<ReliabilityAssetAlertStateHistory>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityAssetAlertStateHistory> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ReliabilityAssetAlertStateHistory> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<ReliabilityAssetAlertStateHistory>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ReliabilityAssetAlertStateHistory> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, ReliabilityAssetAlertStateHistory> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityAssetAlertStateHistory> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ReliabilityAssetAlertStateHistory>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ReliabilityAssetAlertStateHistory>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityAssetAlertStateHistory;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityAssetAlertStateHistory;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityAssetAlertStateHistory;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ReliabilityAssetAlertStateHistory;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityAssetAlertStateHistory;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ReliabilityAssetAlertStateHistory;
   ...
   * @see #fromString
   */
  static make(s: string): ReliabilityAssetAlertStateHistory | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityAssetAlertStateHistory;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): ReliabilityAssetAlertStateHistory;
   ...
   */
  static cachedEmptyInst(): ReliabilityAssetAlertStateHistory;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityAssetAlertStateHistory> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): ReliabilityAssetAlertStateHistory;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<ReliabilityAssetAlertStateHistory>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<ReliabilityAssetAlertStateHistory>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityAssetAlertStateHistory> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityAssetAlertStateHistory>> | null;
   ...
   */
  get(include?: string): ReliabilityAssetAlertStateHistory | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): ReliabilityAssetAlertStateHistory | null;
   ...
   */
  getMissing(spec: GetMissingSpec): ReliabilityAssetAlertStateHistory;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): ReliabilityAssetAlertStateHistory | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): ReliabilityAssetAlertStateHistory;
   ...
   * @see #toString
   */
  static fromString(s: string): ReliabilityAssetAlertStateHistory | null;
   ...
   */
  create(spec?: UpsertSpec): ReliabilityAssetAlertStateHistory | null;
   ...
   */
  static createBatch(objs: Array_Type<ReliabilityAssetAlertStateHistory>, spec?: UpsertSpec): ObjList<ReliabilityAssetAlertStateHistory> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<ReliabilityAssetAlertStateHistory>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityAssetAlertStateHistory> | null;
   ...
   */
  update(srcObj?: ReliabilityAssetAlertStateHistory, spec?: UpsertSpec): ReliabilityAssetAlertStateHistory | null;
   ...
   */
  upsert(srcObj?: ReliabilityAssetAlertStateHistory, spec?: UpsertSpec): ReliabilityAssetAlertStateHistory | null;
   ...
   */
  merge(spec?: MergeSpec): ReliabilityAssetAlertStateHistory | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): ReliabilityAssetAlertStateHistory | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): ReliabilityAssetAlertStateHistory | null;
   ...
   */
  static updateBatch(objs: Array_Type<ReliabilityAssetAlertStateHistory>, srcObjs?: Array_Type<ReliabilityAssetAlertStateHistory>, spec?: UpsertSpec): ObjList<ReliabilityAssetAlertStateHistory> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<ReliabilityAssetAlertStateHistory> | null>, spec?: UpsertSpec): ObjList<ReliabilityAssetAlertStateHistory> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<ReliabilityAssetAlertStateHistory>, srcObjs?: Array_Type<ReliabilityAssetAlertStateHistory>, spec?: UpsertSpec): ObjList<ReliabilityAssetAlertStateHistory> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<ReliabilityAssetAlertStateHistory> | null>, spec?: UpsertSpec): ObjList<ReliabilityAssetAlertStateHistory> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<ReliabilityAssetAlertStateHistory>, spec?: TouchSpec): ObjList<ReliabilityAssetAlertStateHistory> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityAssetAlertStateHistory>, spec?: MergeSpec): ObjList<ReliabilityAssetAlertStateHistory> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityAssetAlertStateHistory>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityAssetAlertStateHistory> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<ReliabilityAssetAlertStateHistory> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityAssetAlertStateHistory> | null;
   ...
   */
  static mergeAll(mergeObj: ReliabilityAssetAlertStateHistory, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: ReliabilityAssetAlertStateHistory, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<ReliabilityAssetAlertStateHistory>, spec?: UpsertSpec): ObjList<ReliabilityAssetAlertStateHistory> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<ReliabilityAssetAlertStateHistory>, spec?: UpsertSpec): ObjList<ReliabilityAssetAlertStateHistory> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): ReliabilityAssetAlertStateHistory | null;
   ...
   */
  static beforeCreate(objs: Array_Type<ReliabilityAssetAlertStateHistory>): ObjList<ReliabilityAssetAlertStateHistory>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<ReliabilityAssetAlertStateHistory>): ObjList<ReliabilityAssetAlertStateHistory>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<ReliabilityAssetAlertStateHistory>): ObjList<ReliabilityAssetAlertStateHistory>;
   ...
   */
  static afterCreate(objs: Array_Type<ReliabilityAssetAlertStateHistory>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<ReliabilityAssetAlertStateHistory>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<ReliabilityAssetAlertStateHistory>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityAssetAlertStateHistory>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityAssetAlertStateHistory>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): ReliabilityAssetAlertStateHistory | null;
   ...
   */
  withoutIdentity(): ReliabilityAssetAlertStateHistory | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<ReliabilityAssetAlertStateHistory>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: ReliabilityAssetAlertStateHistory, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<ReliabilityAssetAlertStateHistory>, callback?: λFunction<ReliabilityAssetAlertStateHistory | null, ReliabilityAssetAlertStateHistory | null>): ObjList<ReliabilityAssetAlertStateHistory>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<ReliabilityAssetAlertStateHistory>, callback?: λFunction<ReliabilityAssetAlertStateHistory | null, ReliabilityAssetAlertStateHistory | null>): Array_Type<ObjError> | null;
