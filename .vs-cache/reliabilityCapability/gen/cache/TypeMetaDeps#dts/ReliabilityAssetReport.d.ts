// TypeScript definitions for the C3 type ReliabilityAssetReport

/**
 * A single exportable PDF asset report. May contain information about one or more assets.
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityAssetReport
 */
declare interface IReliabilityAssetReport {
   ...
   * @inheritdoc
   */
  spec: IReliabilityAssetReportSpec;
  ...
  /**
   * Errors collected during the report generation.
   */
  errors?: Array_Type<string> | Array<string>;

  /**
   * The assets whose information is in the report.
   */
  assets?: Array_Type<ReliabilityAsset> | Array<IReliabilityAsset>;

  /**
   * The {@link ReliabilityAssetReportJob job} used to generate the report.
   */
  job?: IReliabilityAssetReportJob;

  /**
   * Status for job used to generate the report
   */
  status?: string;

  /**
   * {@link Facility} that the Report belongs to.
   */
  facility?: IFacility;
}
 ...
 * A single exportable PDF asset report. May contain information about one or more assets.
 *
 * @remarks this represents a made instance of ReliabilityAssetReport
 */
declare class ReliabilityAssetReport extends Obj  {
   ...
   */
  readonly id: string;
  withId(id: string): ReliabilityAssetReport;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityAssetReport;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): ReliabilityAssetReport;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): ReliabilityAssetReport;
  ...
  withVersion(version: number | null): ReliabilityAssetReport;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): ReliabilityAssetReport;

  /**
   * @inheritdoc
   */
  readonly facilityFilterPaths?: Array_Type<string>;
  withFacilityFilterPaths(facilityFilterPaths: Array_Type<string> | Array<string> | null): ReliabilityAssetReport;
  ...
  withTypeIdent(typeIdent: string | null): ReliabilityAssetReport;

  /**
   * @inheritdoc
   */
  readonly spec: ReliabilityAssetReportSpec;
  withSpec(spec: IReliabilityAssetReportSpec): ReliabilityAssetReport;

  /**
   * The report file.
   */
  readonly file?: File;
  withFile(file: IFile | null): ReliabilityAssetReport;

  /**
   * Errors collected during the report generation.
   */
  readonly errors?: Array_Type<string>;
  withErrors(errors: Array_Type<string> | Array<string> | null): ReliabilityAssetReport;

  /**
   * The assets whose information is in the report.
   */
  readonly assets?: Array_Type<ReliabilityAsset>;
  withAssets(assets: Array_Type<ReliabilityAsset> | Array<IReliabilityAsset> | null): ReliabilityAssetReport;

  /**
   * The {@link ReliabilityAssetReportJob job} used to generate the report.
   */
  readonly job?: ReliabilityAssetReportJob;
  withJob(job: IReliabilityAssetReportJob | null): ReliabilityAssetReport;

  /**
   * Status for job used to generate the report
   */
  readonly status?: string;
  withStatus(status: string | null): ReliabilityAssetReport;

  /**
   * {@link Facility} that the Report belongs to.
   */
  readonly facility?: Facility;
  withFacility(facility: IFacility | null): ReliabilityAssetReport;
   ...
   * @see #toJson
   */
  static fromJson(json: any): ReliabilityAssetReport | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): ReliabilityAssetReport | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): ReliabilityAssetReport | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): ReliabilityAssetReport | null;
   ...
   */
  replaceType(old: Type, new_: Type): ReliabilityAssetReport;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityAssetReport;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityAssetReport;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityAssetReport>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityAssetReport>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityAssetReport;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityAssetReport;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityAssetReport;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ReliabilityAssetReport;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ReliabilityAssetReport;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityAssetReport;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityAssetReport;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityAssetReport;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ReliabilityAssetReport;
   ...
   * @see #removeField
   */
  withoutField(field: string): ReliabilityAssetReport;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): ReliabilityAssetReport;
   ...
   */
  withoutFields(fields: Array_Type<string>): ReliabilityAssetReport;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityAssetReport;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ReliabilityAssetReport;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityAssetReport;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ReliabilityAssetReport;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ReliabilityAssetReport;
   ...
   * @see #removeField
   */
  unsetField(field: string): ReliabilityAssetReport;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ReliabilityAssetReport;
   ...
   * @see #unsetField
   */
  removeField(field: string): ReliabilityAssetReport;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ReliabilityAssetReport;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityAssetReport;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityAssetReport;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityAssetReport;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityAssetReport;

  mergeJson(json: any): ReliabilityAssetReport;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityAssetReport;
   ...
   */
  sumObj(other: Obj, deep?: boolean): ReliabilityAssetReport;
   ...
   */
  singletonArray(): Array_Type<ReliabilityAssetReport>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityAssetReport> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ReliabilityAssetReport> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<ReliabilityAssetReport>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ReliabilityAssetReport> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, ReliabilityAssetReport> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityAssetReport> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ReliabilityAssetReport>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ReliabilityAssetReport>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityAssetReport;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityAssetReport;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityAssetReport;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ReliabilityAssetReport;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityAssetReport;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ReliabilityAssetReport;
   ...
   * @see #fromString
   */
  static make(s: string): ReliabilityAssetReport | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityAssetReport;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): ReliabilityAssetReport;
   ...
   */
  static cachedEmptyInst(): ReliabilityAssetReport;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityAssetReport> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): ReliabilityAssetReport;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<ReliabilityAssetReport>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<ReliabilityAssetReport>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityAssetReport> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityAssetReport>> | null;
   ...
   */
  get(include?: string): ReliabilityAssetReport | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): ReliabilityAssetReport | null;
   ...
   */
  getMissing(spec: GetMissingSpec): ReliabilityAssetReport;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): ReliabilityAssetReport | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): ReliabilityAssetReport;
   ...
   * @see #toString
   */
  static fromString(s: string): ReliabilityAssetReport | null;
   ...
   */
  create(spec?: UpsertSpec): ReliabilityAssetReport | null;
   ...
   */
  static createBatch(objs: Array_Type<ReliabilityAssetReport>, spec?: UpsertSpec): ObjList<ReliabilityAssetReport> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<ReliabilityAssetReport>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityAssetReport> | null;
   ...
   */
  update(srcObj?: ReliabilityAssetReport, spec?: UpsertSpec): ReliabilityAssetReport | null;
   ...
   */
  upsert(srcObj?: ReliabilityAssetReport, spec?: UpsertSpec): ReliabilityAssetReport | null;
   ...
   */
  merge(spec?: MergeSpec): ReliabilityAssetReport | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): ReliabilityAssetReport | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): ReliabilityAssetReport | null;
   ...
   */
  static updateBatch(objs: Array_Type<ReliabilityAssetReport>, srcObjs?: Array_Type<ReliabilityAssetReport>, spec?: UpsertSpec): ObjList<ReliabilityAssetReport> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<ReliabilityAssetReport> | null>, spec?: UpsertSpec): ObjList<ReliabilityAssetReport> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<ReliabilityAssetReport>, srcObjs?: Array_Type<ReliabilityAssetReport>, spec?: UpsertSpec): ObjList<ReliabilityAssetReport> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<ReliabilityAssetReport> | null>, spec?: UpsertSpec): ObjList<ReliabilityAssetReport> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<ReliabilityAssetReport>, spec?: TouchSpec): ObjList<ReliabilityAssetReport> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityAssetReport>, spec?: MergeSpec): ObjList<ReliabilityAssetReport> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityAssetReport>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityAssetReport> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<ReliabilityAssetReport> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityAssetReport> | null;
   ...
   */
  static mergeAll(mergeObj: ReliabilityAssetReport, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: ReliabilityAssetReport, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<ReliabilityAssetReport>, spec?: UpsertSpec): ObjList<ReliabilityAssetReport> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<ReliabilityAssetReport>, spec?: UpsertSpec): ObjList<ReliabilityAssetReport> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): ReliabilityAssetReport | null;
   ...
   */
  static beforeCreate(objs: Array_Type<ReliabilityAssetReport>): ObjList<ReliabilityAssetReport>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<ReliabilityAssetReport>): ObjList<ReliabilityAssetReport>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<ReliabilityAssetReport>): ObjList<ReliabilityAssetReport>;
   ...
   */
  static afterCreate(objs: Array_Type<ReliabilityAssetReport>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<ReliabilityAssetReport>): Array_Type<ObjError> | null;

  /**
   * When a report is removed, remove the associated {@link ReliabilityAssetReportJob job}.
   */
  static afterRemove(objs: Array_Type<ReliabilityAssetReport>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityAssetReport>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityAssetReport>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): ReliabilityAssetReport | null;
   ...
   */
  withoutIdentity(): ReliabilityAssetReport | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<ReliabilityAssetReport>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: ReliabilityAssetReport, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<ReliabilityAssetReport>, callback?: λFunction<ReliabilityAssetReport | null, ReliabilityAssetReport | null>): ObjList<ReliabilityAssetReport>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<ReliabilityAssetReport>, callback?: λFunction<ReliabilityAssetReport | null, ReliabilityAssetReport | null>): Array_Type<ObjError> | null;
  ...
  /**
   * Returns the URL at which the report {@link file} can be downloaded.
   */
  getFileUrl(): string | null;

  /**
   * Fetch {@link ReliabilityAssetReport} and includes an extra field for this job status
   * @param spec
   *         spec to fetch {@link ReliabilityAssetReport}
   * @return FetchResult for {@link ReliabilityAssetReport} including status field
   */
  static fetchWithStatus(spec: FetchSpec): FetchResult<ReliabilityAssetReport>;

  /**
   * Return the number of reports that have append a job based on the given specification.
   * @param spec
   *         spec to fetch {@link ReliabilityAssetReport}
   * @return The number of reports after applying the given spec.
   */
  static fetchCountWithStatus(spec?: FetchFilterSpec): number;

  /**
   * Generates a {@link ZipFile ZIP file} based on {@link File files} from the
   * given reports.
   * @param reports
   *         The reports to include in the ZIP file.
   * @return The {@link File#apiEndpoint API endpoint} for this file.
   */
  static getZipUrl(reports: Array_Type<ReliabilityAssetReport>): string | null;
}
