// TypeScript definitions for the C3 type ReliabilityOrchestrator.TrainingJob

/**
 * Represents a model training job that can be executed on {@link ReliabilityAsset}s and a given {@link MlProject}.
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityOrchestrator.TrainingJob
 */
declare namespace ReliabilityOrchestrator {
  export interface ITrainingJob {
     ...
     */
    doNotCompleteModelConfigRun?: boolean;
  }
}
 ...
 */
declare namespace ReliabilityOrchestrator {
  export class TrainingJob extends Obj  {

    /**
     * The array of configurations this job run must execute.
     */
    readonly jobSpecs: Array_Type<ReliabilityOrchestrator.TrainingJobSpec>;
    withJobSpecs(jobSpecs: Array_Type<ReliabilityOrchestrator.TrainingJobSpec> | Array<IReliabilityOrchestrator.TrainingJobSpec>): ReliabilityOrchestrator.TrainingJob;
     ...
     */
    readonly id: string;
    withId(id: string): ReliabilityOrchestrator.TrainingJob;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityOrchestrator.TrainingJob;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): ReliabilityOrchestrator.TrainingJob;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): ReliabilityOrchestrator.TrainingJob;
    ...
    withVersion(version: number | null): ReliabilityOrchestrator.TrainingJob;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): ReliabilityOrchestrator.TrainingJob;
     ...
     * process is complete. Instead, the caller is responsible for updating the status of the {@link ModelConfigRun}.
     */
    readonly doNotCompleteModelConfigRun?: boolean;
    withDoNotCompleteModelConfigRun(doNotCompleteModelConfigRun: boolean): ReliabilityOrchestrator.TrainingJob;
     ...
     * @see #toJson
     */
    static fromJson(json: any): ReliabilityOrchestrator.TrainingJob | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): ReliabilityOrchestrator.TrainingJob | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): ReliabilityOrchestrator.TrainingJob | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): ReliabilityOrchestrator.TrainingJob | null;
     ...
     */
    replaceType(old: Type, new_: Type): ReliabilityOrchestrator.TrainingJob;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityOrchestrator.TrainingJob;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityOrchestrator.TrainingJob;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityOrchestrator.TrainingJob>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityOrchestrator.TrainingJob>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityOrchestrator.TrainingJob;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityOrchestrator.TrainingJob;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityOrchestrator.TrainingJob;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): ReliabilityOrchestrator.TrainingJob;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): ReliabilityOrchestrator.TrainingJob;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityOrchestrator.TrainingJob;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityOrchestrator.TrainingJob;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityOrchestrator.TrainingJob;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): ReliabilityOrchestrator.TrainingJob;
     ...
     * @see #removeField
     */
    withoutField(field: string): ReliabilityOrchestrator.TrainingJob;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): ReliabilityOrchestrator.TrainingJob;
     ...
     */
    withoutFields(fields: Array_Type<string>): ReliabilityOrchestrator.TrainingJob;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityOrchestrator.TrainingJob;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): ReliabilityOrchestrator.TrainingJob;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityOrchestrator.TrainingJob;
     ...
     * @see #unsetField
     */
    defaultField(field: string): ReliabilityOrchestrator.TrainingJob;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): ReliabilityOrchestrator.TrainingJob;
     ...
     * @see #removeField
     */
    unsetField(field: string): ReliabilityOrchestrator.TrainingJob;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): ReliabilityOrchestrator.TrainingJob;
     ...
     * @see #unsetField
     */
    removeField(field: string): ReliabilityOrchestrator.TrainingJob;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): ReliabilityOrchestrator.TrainingJob;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityOrchestrator.TrainingJob;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityOrchestrator.TrainingJob;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityOrchestrator.TrainingJob;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityOrchestrator.TrainingJob;

    mergeJson(json: any): ReliabilityOrchestrator.TrainingJob;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityOrchestrator.TrainingJob;
     ...
     */
    sumObj(other: Obj, deep?: boolean): ReliabilityOrchestrator.TrainingJob;
     ...
     */
    singletonArray(): Array_Type<ReliabilityOrchestrator.TrainingJob>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityOrchestrator.TrainingJob> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<ReliabilityOrchestrator.TrainingJob> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<ReliabilityOrchestrator.TrainingJob>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<ReliabilityOrchestrator.TrainingJob> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, ReliabilityOrchestrator.TrainingJob> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityOrchestrator.TrainingJob> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<ReliabilityOrchestrator.TrainingJob>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<ReliabilityOrchestrator.TrainingJob>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityOrchestrator.TrainingJob;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityOrchestrator.TrainingJob;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityOrchestrator.TrainingJob;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): ReliabilityOrchestrator.TrainingJob;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityOrchestrator.TrainingJob;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): ReliabilityOrchestrator.TrainingJob;
     ...
     * @see #fromString
     */
    static make(s: string): ReliabilityOrchestrator.TrainingJob | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityOrchestrator.TrainingJob;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): ReliabilityOrchestrator.TrainingJob;
     ...
     */
    static cachedEmptyInst(): ReliabilityOrchestrator.TrainingJob;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityOrchestrator.TrainingJob> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): ReliabilityOrchestrator.TrainingJob;
     ...
     *  ```
     */
    doStart(options?: ReliabilityOrchestrator.JobOptions, additionalParams?: Map_Type<string, any>): Pair<ReliabilityOrchestrator.TrainingJobRun, MlOperationRun<ReliabilityOrchestrator.TrainingJobRun>>;
     ...
     */
    start(options?: ReliabilityOrchestrator.JobOptions, additionalParams?: Map_Type<string, any>): MlOperationRun<ReliabilityOrchestrator.TrainingJobRun>;

    /**
     * @return The concrete {@link ReliabilityOrchestrator.JobRun} subType.
     */
    static jobRunType(): Type<<ReliabilityOrchestrator.TrainingJobRun>> | null;

    /**
     * @return the concrete {@link ReliabilityOrchestrator.JobSpec} subType.
     */
    static jobSpecType(): Type<<ReliabilityOrchestrator.TrainingJobSpec>> | null;
     ...
     */
    fetchJobRunForOperationRun(run: MlOperationRun<any>): ReliabilityOrchestrator.TrainingJobRun | null;
     ...
     */
    fetchLatestJobRun(): ReliabilityOrchestrator.TrainingJobRun | null;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<ReliabilityOrchestrator.TrainingJob>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<ReliabilityOrchestrator.TrainingJob>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityOrchestrator.TrainingJob> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityOrchestrator.TrainingJob>> | null;
     ...
     */
    get(include?: string): ReliabilityOrchestrator.TrainingJob | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): ReliabilityOrchestrator.TrainingJob | null;
     ...
     */
    getMissing(spec: GetMissingSpec): ReliabilityOrchestrator.TrainingJob;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): ReliabilityOrchestrator.TrainingJob | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): ReliabilityOrchestrator.TrainingJob;
     ...
     * @see #toString
     */
    static fromString(s: string): ReliabilityOrchestrator.TrainingJob | null;
     ...
     */
    create(spec?: UpsertSpec): ReliabilityOrchestrator.TrainingJob | null;
     ...
     */
    static createBatch(objs: Array_Type<ReliabilityOrchestrator.TrainingJob>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.TrainingJob> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<ReliabilityOrchestrator.TrainingJob>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityOrchestrator.TrainingJob> | null;
     ...
     */
    update(srcObj?: ReliabilityOrchestrator.TrainingJob, spec?: UpsertSpec): ReliabilityOrchestrator.TrainingJob | null;
     ...
     */
    upsert(srcObj?: ReliabilityOrchestrator.TrainingJob, spec?: UpsertSpec): ReliabilityOrchestrator.TrainingJob | null;
     ...
     */
    merge(spec?: MergeSpec): ReliabilityOrchestrator.TrainingJob | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): ReliabilityOrchestrator.TrainingJob | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): ReliabilityOrchestrator.TrainingJob | null;
     ...
     */
    static updateBatch(objs: Array_Type<ReliabilityOrchestrator.TrainingJob>, srcObjs?: Array_Type<ReliabilityOrchestrator.TrainingJob>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.TrainingJob> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<ReliabilityOrchestrator.TrainingJob> | null>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.TrainingJob> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<ReliabilityOrchestrator.TrainingJob>, srcObjs?: Array_Type<ReliabilityOrchestrator.TrainingJob>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.TrainingJob> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<ReliabilityOrchestrator.TrainingJob> | null>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.TrainingJob> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<ReliabilityOrchestrator.TrainingJob>, spec?: TouchSpec): ObjList<ReliabilityOrchestrator.TrainingJob> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityOrchestrator.TrainingJob>, spec?: MergeSpec): ObjList<ReliabilityOrchestrator.TrainingJob> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityOrchestrator.TrainingJob>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityOrchestrator.TrainingJob> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<ReliabilityOrchestrator.TrainingJob> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityOrchestrator.TrainingJob> | null;
     ...
     */
    static mergeAll(mergeObj: ReliabilityOrchestrator.TrainingJob, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: ReliabilityOrchestrator.TrainingJob, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<ReliabilityOrchestrator.TrainingJob>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.TrainingJob> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<ReliabilityOrchestrator.TrainingJob>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.TrainingJob> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): ReliabilityOrchestrator.TrainingJob | null;
     ...
     */
    static beforeCreate(objs: Array_Type<ReliabilityOrchestrator.TrainingJob>): ObjList<ReliabilityOrchestrator.TrainingJob>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<ReliabilityOrchestrator.TrainingJob>): ObjList<ReliabilityOrchestrator.TrainingJob>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<ReliabilityOrchestrator.TrainingJob>): ObjList<ReliabilityOrchestrator.TrainingJob>;
     ...
     */
    static afterCreate(objs: Array_Type<ReliabilityOrchestrator.TrainingJob>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<ReliabilityOrchestrator.TrainingJob>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<ReliabilityOrchestrator.TrainingJob>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityOrchestrator.TrainingJob>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityOrchestrator.TrainingJob>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): ReliabilityOrchestrator.TrainingJob | null;
     ...
     */
    withoutIdentity(): ReliabilityOrchestrator.TrainingJob | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<ReliabilityOrchestrator.TrainingJob>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: ReliabilityOrchestrator.TrainingJob, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<ReliabilityOrchestrator.TrainingJob>, callback?: λFunction<ReliabilityOrchestrator.TrainingJob | null, ReliabilityOrchestrator.TrainingJob | null>): ObjList<ReliabilityOrchestrator.TrainingJob>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<ReliabilityOrchestrator.TrainingJob>, callback?: λFunction<ReliabilityOrchestrator.TrainingJob | null, ReliabilityOrchestrator.TrainingJob | null>): Array_Type<ObjError> | null;
