// TypeScript definitions for the C3 type TimeToEventForecastResultFeature
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of TimeToEventForecastResultFeature
 */
declare interface ITimeToEventForecastResultFeature {
 ...
 */
declare class TimeToEventForecastResultFeature extends Obj  {
   ...
   */
  readonly id: string;
  withId(id: string): TimeToEventForecastResultFeature;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): TimeToEventForecastResultFeature;

  /**
   * Name of this feature
   */
  readonly name: string;
  withName(name: string): TimeToEventForecastResultFeature;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): TimeToEventForecastResultFeature;
  ...
  withVersion(version: number | null): TimeToEventForecastResultFeature;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): TimeToEventForecastResultFeature;

  /**
   * Description of this feature
   */
  readonly description?: string;
  withDescription(description: string | null): TimeToEventForecastResultFeature;

  /**
   * The {@link Sensor} whose measurements constitute this feature. If not populated, this feature did not get data directly from a {@link Sensor}
   */
  readonly sensor?: Sensor;
  withSensor(sensor: ISensor | null): TimeToEventForecastResultFeature;
   ...
   * @see #toJson
   */
  static fromJson(json: any): TimeToEventForecastResultFeature | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): TimeToEventForecastResultFeature | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): TimeToEventForecastResultFeature | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): TimeToEventForecastResultFeature | null;
   ...
   */
  replaceType(old: Type, new_: Type): TimeToEventForecastResultFeature;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): TimeToEventForecastResultFeature;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): TimeToEventForecastResultFeature;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<TimeToEventForecastResultFeature>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<TimeToEventForecastResultFeature>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): TimeToEventForecastResultFeature;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TimeToEventForecastResultFeature;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TimeToEventForecastResultFeature;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): TimeToEventForecastResultFeature;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): TimeToEventForecastResultFeature;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): TimeToEventForecastResultFeature;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): TimeToEventForecastResultFeature;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): TimeToEventForecastResultFeature;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): TimeToEventForecastResultFeature;
   ...
   * @see #removeField
   */
  withoutField(field: string): TimeToEventForecastResultFeature;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): TimeToEventForecastResultFeature;
   ...
   */
  withoutFields(fields: Array_Type<string>): TimeToEventForecastResultFeature;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): TimeToEventForecastResultFeature;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): TimeToEventForecastResultFeature;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): TimeToEventForecastResultFeature;
   ...
   * @see #unsetField
   */
  defaultField(field: string): TimeToEventForecastResultFeature;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): TimeToEventForecastResultFeature;
   ...
   * @see #removeField
   */
  unsetField(field: string): TimeToEventForecastResultFeature;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): TimeToEventForecastResultFeature;
   ...
   * @see #unsetField
   */
  removeField(field: string): TimeToEventForecastResultFeature;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): TimeToEventForecastResultFeature;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): TimeToEventForecastResultFeature;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): TimeToEventForecastResultFeature;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): TimeToEventForecastResultFeature;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): TimeToEventForecastResultFeature;

  mergeJson(json: any): TimeToEventForecastResultFeature;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): TimeToEventForecastResultFeature;
   ...
   */
  sumObj(other: Obj, deep?: boolean): TimeToEventForecastResultFeature;
   ...
   */
  singletonArray(): Array_Type<TimeToEventForecastResultFeature>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<TimeToEventForecastResultFeature> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<TimeToEventForecastResultFeature> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<TimeToEventForecastResultFeature>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<TimeToEventForecastResultFeature> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, TimeToEventForecastResultFeature> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, TimeToEventForecastResultFeature> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<TimeToEventForecastResultFeature>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<TimeToEventForecastResultFeature>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): TimeToEventForecastResultFeature;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): TimeToEventForecastResultFeature;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): TimeToEventForecastResultFeature;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): TimeToEventForecastResultFeature;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): TimeToEventForecastResultFeature;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): TimeToEventForecastResultFeature;
   ...
   * @see #fromString
   */
  static make(s: string): TimeToEventForecastResultFeature | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): TimeToEventForecastResultFeature;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): TimeToEventForecastResultFeature;
   ...
   */
  static cachedEmptyInst(): TimeToEventForecastResultFeature;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<TimeToEventForecastResultFeature> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): TimeToEventForecastResultFeature;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<TimeToEventForecastResultFeature>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<TimeToEventForecastResultFeature>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<TimeToEventForecastResultFeature> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<TimeToEventForecastResultFeature>> | null;
   ...
   */
  get(include?: string): TimeToEventForecastResultFeature | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): TimeToEventForecastResultFeature | null;
   ...
   */
  getMissing(spec: GetMissingSpec): TimeToEventForecastResultFeature;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): TimeToEventForecastResultFeature | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): TimeToEventForecastResultFeature;
   ...
   * @see #toString
   */
  static fromString(s: string): TimeToEventForecastResultFeature | null;
   ...
   */
  create(spec?: UpsertSpec): TimeToEventForecastResultFeature | null;
   ...
   */
  static createBatch(objs: Array_Type<TimeToEventForecastResultFeature>, spec?: UpsertSpec): ObjList<TimeToEventForecastResultFeature> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<TimeToEventForecastResultFeature>, spec?: CreateBatchObjStreamSpec): ObjList<TimeToEventForecastResultFeature> | null;
   ...
   */
  update(srcObj?: TimeToEventForecastResultFeature, spec?: UpsertSpec): TimeToEventForecastResultFeature | null;
   ...
   */
  upsert(srcObj?: TimeToEventForecastResultFeature, spec?: UpsertSpec): TimeToEventForecastResultFeature | null;
   ...
   */
  merge(spec?: MergeSpec): TimeToEventForecastResultFeature | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): TimeToEventForecastResultFeature | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): TimeToEventForecastResultFeature | null;
   ...
   */
  static updateBatch(objs: Array_Type<TimeToEventForecastResultFeature>, srcObjs?: Array_Type<TimeToEventForecastResultFeature>, spec?: UpsertSpec): ObjList<TimeToEventForecastResultFeature> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<TimeToEventForecastResultFeature> | null>, spec?: UpsertSpec): ObjList<TimeToEventForecastResultFeature> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<TimeToEventForecastResultFeature>, srcObjs?: Array_Type<TimeToEventForecastResultFeature>, spec?: UpsertSpec): ObjList<TimeToEventForecastResultFeature> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<TimeToEventForecastResultFeature> | null>, spec?: UpsertSpec): ObjList<TimeToEventForecastResultFeature> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<TimeToEventForecastResultFeature>, spec?: TouchSpec): ObjList<TimeToEventForecastResultFeature> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<TimeToEventForecastResultFeature>, spec?: MergeSpec): ObjList<TimeToEventForecastResultFeature> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<TimeToEventForecastResultFeature>, mergeInclude: string, spec?: MergeSpec): ObjList<TimeToEventForecastResultFeature> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<TimeToEventForecastResultFeature> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<TimeToEventForecastResultFeature> | null;
   ...
   */
  static mergeAll(mergeObj: TimeToEventForecastResultFeature, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: TimeToEventForecastResultFeature, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<TimeToEventForecastResultFeature>, spec?: UpsertSpec): ObjList<TimeToEventForecastResultFeature> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<TimeToEventForecastResultFeature>, spec?: UpsertSpec): ObjList<TimeToEventForecastResultFeature> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): TimeToEventForecastResultFeature | null;
   ...
   */
  static beforeCreate(objs: Array_Type<TimeToEventForecastResultFeature>): ObjList<TimeToEventForecastResultFeature>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<TimeToEventForecastResultFeature>): ObjList<TimeToEventForecastResultFeature>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<TimeToEventForecastResultFeature>): ObjList<TimeToEventForecastResultFeature>;
   ...
   */
  static afterCreate(objs: Array_Type<TimeToEventForecastResultFeature>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<TimeToEventForecastResultFeature>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<TimeToEventForecastResultFeature>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<TimeToEventForecastResultFeature>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<TimeToEventForecastResultFeature>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): TimeToEventForecastResultFeature | null;
   ...
   */
  withoutIdentity(): TimeToEventForecastResultFeature | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<TimeToEventForecastResultFeature>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: TimeToEventForecastResultFeature, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<TimeToEventForecastResultFeature>, callback?: λFunction<TimeToEventForecastResultFeature | null, TimeToEventForecastResultFeature | null>): ObjList<TimeToEventForecastResultFeature>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<TimeToEventForecastResultFeature>, callback?: λFunction<TimeToEventForecastResultFeature | null, TimeToEventForecastResultFeature | null>): Array_Type<ObjError> | null;
