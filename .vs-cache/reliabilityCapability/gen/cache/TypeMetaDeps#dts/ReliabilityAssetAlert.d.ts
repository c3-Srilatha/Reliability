// TypeScript definitions for the C3 type ReliabilityAssetAlert

/**
 * @inheritdoc
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityAssetAlert
 */
declare interface IReliabilityAssetAlert {
   ...
   */
  precomputedFeatures?: IPrecomputedFeatures;
   ...
   */
  featureContributionMap?: Map_Type<string, number> | {[key: string]: number};
   ...
   */
  primaryModelOutput?: IReliabilityAssetAlert.ModelOutput;

  /**
   * A field capturing information about the model output for the {@link timestamp} that the alert is raised.
   * Supports multiple formats for display in the UI.
   */
  allPrimaryModelOutputs?: Map_Type<string, ReliabilityAssetAlert.ModelOutput> | {[key: string]: IReliabilityAssetAlert.ModelOutput};
   ...
   */
  currentState?: IReliabilityAssetAlertState;

  /**
   * A collection of the states this {@link StateMachine} has passed through.
   */
  stateHistories?: Array_Type<ReliabilityAssetAlertStateHistory> | Array<IReliabilityAssetAlertStateHistory>;

  /**
   * Transitions available from the current state
   */
  transitions?: Array_Type<ReliabilityAssetAlertStateTransition> | Array<IReliabilityAssetAlertStateTransition>;

  /**
   * Calc field to get the current state history
   */
  currentStateHistory?: IReliabilityAssetAlertStateHistory;
   ...
   */
  caseRelations?: Array_Type<ReliabilityAssetAlertToCaseRelation> | Array<IReliabilityAssetAlertToCaseRelation>;

  /**
   * {@link ReliabilityAssetAlertFeedback} associated with this alert.
   */
  feedback?: Array_Type<ReliabilityAssetAlertFeedback> | Array<IReliabilityAssetAlertFeedback>;

  /**
   * This field is used by the UI to show the translated value of {@link mostRecentFeedbackCategory}.
   */
  displayMostRecentFeedbackCategory?: string;
 ...
 */
declare class ReliabilityAssetAlert extends Obj  {

  /**
   * Timestamp for the value.
   */
  readonly timestamp?: DateTime;
  withTimestamp(timestamp: DateTime | Date | string | null): ReliabilityAssetAlert;
   ...
   */
  readonly id: string;
  withId(id: string): ReliabilityAssetAlert;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityAssetAlert;

  /**
   * Name of this alert.
   */
  readonly name?: string;
  withName(name: string | null): ReliabilityAssetAlert;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): ReliabilityAssetAlert;
  ...
  withVersion(version: number | null): ReliabilityAssetAlert;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): ReliabilityAssetAlert;

  /**
   * The precomputed features for this entity.
   */
  readonly precomputedFeatures?: PrecomputedFeatures;
  withPrecomputedFeatures(precomputedFeatures: IPrecomputedFeatures | null): ReliabilityAssetAlert;

  /**
   * Whether this entity is a model validation type. These types use a different part of the data model to query
   * feature data. This should be overriden by types that mix {@link WithPrecomputedFeatures} if necessary.
   */
  readonly isValidationType?: boolean;
  withIsValidationType(isValidationType: boolean): ReliabilityAssetAlert;

  /**
   * The {@link ReliabilityAsset} linked to this alert.
   */
  readonly parent: ReliabilityAsset;
  withParent(parent: IReliabilityAsset): ReliabilityAssetAlert;

  /**
   * The {@link ReliabilityMlModel} which triggered this alert.
   */
  readonly triggeringModel?: ReliabilityMlModel;
  withTriggeringModel(triggeringModel: IReliabilityMlModel | null): ReliabilityAssetAlert;

  /**
   * The id of the {@link ReliabilityAssetAlert#triggeringModel}.
   */
  readonly triggeringModelId?: string;
  withTriggeringModelId(triggeringModelId: string | null): ReliabilityAssetAlert;
   ...
   * They are displayed on the contributions grid on the alert detail page.
   */
  readonly featureContributionMap?: Map_Type<string, number>;
  withFeatureContributionMap(featureContributionMap: Map_Type<string, number> | {[key: string]: number} | null): ReliabilityAssetAlert;

  /**
   * A field capturing information about the model output for the {@link timestamp} that the alert is raised.
   * Supports multiple formats for display in the UI.
   */
  readonly primaryModelOutput?: ReliabilityAssetAlert.ModelOutput;
  withPrimaryModelOutput(primaryModelOutput: IReliabilityAssetAlert.ModelOutput | null): ReliabilityAssetAlert;

  /**
   * A field capturing information about the model output for the {@link timestamp} that the alert is raised.
   * Supports multiple formats for display in the UI.
   */
  readonly allPrimaryModelOutputs?: Map_Type<string, ReliabilityAssetAlert.ModelOutput>;
  withAllPrimaryModelOutputs(allPrimaryModelOutputs: Map_Type<string, ReliabilityAssetAlert.ModelOutput> | {[key: string]: IReliabilityAssetAlert.ModelOutput} | null): ReliabilityAssetAlert;

  /**
   * @inheritdoc
   */
  readonly facilityFilterPaths?: Array_Type<string>;
  withFacilityFilterPaths(facilityFilterPaths: Array_Type<string> | Array<string> | null): ReliabilityAssetAlert;

  /**
   * A stored calc field representing the current state - uses a {@link StateMachineHistory} to keep track.
   */
  readonly currentState?: ReliabilityAssetAlertState;
  withCurrentState(currentState: IReliabilityAssetAlertState | null): ReliabilityAssetAlert;

  /**
   * A collection of the states this {@link StateMachine} has passed through.
   */
  readonly stateHistories?: Array_Type<ReliabilityAssetAlertStateHistory>;
  withStateHistories(stateHistories: Array_Type<ReliabilityAssetAlertStateHistory> | Array<IReliabilityAssetAlertStateHistory> | null): ReliabilityAssetAlert;

  /**
   * Transitions available from the current state
   */
  readonly transitions?: Array_Type<ReliabilityAssetAlertStateTransition>;
  withTransitions(transitions: Array_Type<ReliabilityAssetAlertStateTransition> | Array<IReliabilityAssetAlertStateTransition> | null): ReliabilityAssetAlert;

  /**
   * Calc field to get the current state history
   */
  readonly currentStateHistory?: ReliabilityAssetAlertStateHistory;
  withCurrentStateHistory(currentStateHistory: IReliabilityAssetAlertStateHistory | null): ReliabilityAssetAlert;
  ...
  withTypeIdent(typeIdent: string | null): ReliabilityAssetAlert;

  /**
   * The {@link ReliabilityAssetAlertToCaseRelation}s on this alert.
   */
  readonly caseRelations?: Array_Type<ReliabilityAssetAlertToCaseRelation>;
  withCaseRelations(caseRelations: Array_Type<ReliabilityAssetAlertToCaseRelation> | Array<IReliabilityAssetAlertToCaseRelation> | null): ReliabilityAssetAlert;

  /**
   * {@link ReliabilityAssetAlertFeedback} associated with this alert.
   */
  readonly feedback?: Array_Type<ReliabilityAssetAlertFeedback>;
  withFeedback(feedback: Array_Type<ReliabilityAssetAlertFeedback> | Array<IReliabilityAssetAlertFeedback> | null): ReliabilityAssetAlert;

  /**
   * This field is used by the UI to show the translated value of {@link mostRecentFeedbackCategory}.
   */
  readonly displayMostRecentFeedbackCategory?: string;
  withDisplayMostRecentFeedbackCategory(displayMostRecentFeedbackCategory: string | null): ReliabilityAssetAlert;

  /**
   * The {@link ReliabilityAssetCase}s on this alert.
   */
  readonly cases?: Array_Type<ReliabilityAssetCase>;
  withCases(cases: Array_Type<ReliabilityAssetCase> | Array<IReliabilityAssetCase> | null): ReliabilityAssetAlert;

  /**
   * The comments associated with the current Alert
   */
  readonly comments?: Array_Type<AlertComment>;
  withComments(comments: Array_Type<AlertComment> | Array<IAlertComment> | null): ReliabilityAssetAlert;

  /**
   * Date displayed in the UI for when the alert was triggered.
   */
  readonly displayedTriggerDate?: string;
  withDisplayedTriggerDate(displayedTriggerDate: string | null): ReliabilityAssetAlert;

  /**
   * Case to be used for related cases and alerts.
   */
  readonly relatedCase?: ReliabilityAssetCase;
  withRelatedCase(relatedCase: IReliabilityAssetCase | null): ReliabilityAssetAlert;

  /**
   * {@link ReliabilityAssetAlertFeedback}'s' recent category associated with this alert.
   */
  readonly mostRecentFeedbackCategory?: string;
  withMostRecentFeedbackCategory(mostRecentFeedbackCategory: string | null): ReliabilityAssetAlert;

  /**
   * The {@link ReliabilityAssetAlertToCaseRelation}s with a not `Closed` {@link ReliabilityAssetCase}s in this alert.
   */
  readonly notClosedCaseRelations?: Array_Type<ReliabilityAssetAlertToCaseRelation>;
  withNotClosedCaseRelations(notClosedCaseRelations: Array_Type<ReliabilityAssetAlertToCaseRelation> | Array<IReliabilityAssetAlertToCaseRelation> | null): ReliabilityAssetAlert;

  /**
   * The currently `Open` {@link ReliabilityAssetCase}s in this alert.
   */
  readonly notClosedCases?: Array_Type<ReliabilityAssetCase>;
  withNotClosedCases(notClosedCases: Array_Type<ReliabilityAssetCase> | Array<IReliabilityAssetCase> | null): ReliabilityAssetAlert;

  /**
   * Type of the alert. Eg: Reliability Risk.
   */
  readonly displayedMlProject?: string;
  withDisplayedMlProject(displayedMlProject: string | null): ReliabilityAssetAlert;
   ...
   * @see #toJson
   */
  static fromJson(json: any): ReliabilityAssetAlert | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): ReliabilityAssetAlert | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): ReliabilityAssetAlert | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): ReliabilityAssetAlert | null;
   ...
   */
  replaceType(old: Type, new_: Type): ReliabilityAssetAlert;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityAssetAlert;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityAssetAlert;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityAssetAlert>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityAssetAlert>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityAssetAlert;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityAssetAlert;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityAssetAlert;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ReliabilityAssetAlert;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ReliabilityAssetAlert;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityAssetAlert;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityAssetAlert;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityAssetAlert;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ReliabilityAssetAlert;
   ...
   * @see #removeField
   */
  withoutField(field: string): ReliabilityAssetAlert;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): ReliabilityAssetAlert;
   ...
   */
  withoutFields(fields: Array_Type<string>): ReliabilityAssetAlert;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityAssetAlert;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ReliabilityAssetAlert;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityAssetAlert;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ReliabilityAssetAlert;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ReliabilityAssetAlert;
   ...
   * @see #removeField
   */
  unsetField(field: string): ReliabilityAssetAlert;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ReliabilityAssetAlert;
   ...
   * @see #unsetField
   */
  removeField(field: string): ReliabilityAssetAlert;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ReliabilityAssetAlert;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityAssetAlert;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityAssetAlert;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityAssetAlert;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityAssetAlert;

  mergeJson(json: any): ReliabilityAssetAlert;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityAssetAlert;
   ...
   */
  sumObj(other: Obj, deep?: boolean): ReliabilityAssetAlert;
   ...
   */
  singletonArray(): Array_Type<ReliabilityAssetAlert>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityAssetAlert> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ReliabilityAssetAlert> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<ReliabilityAssetAlert>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ReliabilityAssetAlert> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, ReliabilityAssetAlert> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityAssetAlert> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ReliabilityAssetAlert>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ReliabilityAssetAlert>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityAssetAlert;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityAssetAlert;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityAssetAlert;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ReliabilityAssetAlert;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityAssetAlert;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ReliabilityAssetAlert;
   ...
   * @see #fromString
   */
  static make(s: string): ReliabilityAssetAlert | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityAssetAlert;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): ReliabilityAssetAlert;
   ...
   */
  static cachedEmptyInst(): ReliabilityAssetAlert;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityAssetAlert> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): ReliabilityAssetAlert;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<ReliabilityAssetAlert>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<ReliabilityAssetAlert>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityAssetAlert> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityAssetAlert>> | null;
   ...
   */
  get(include?: string): ReliabilityAssetAlert | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): ReliabilityAssetAlert | null;
   ...
   */
  getMissing(spec: GetMissingSpec): ReliabilityAssetAlert;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): ReliabilityAssetAlert | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): ReliabilityAssetAlert;
   ...
   * @see #toString
   */
  static fromString(s: string): ReliabilityAssetAlert | null;
   ...
   */
  create(spec?: UpsertSpec): ReliabilityAssetAlert | null;
   ...
   */
  static createBatch(objs: Array_Type<ReliabilityAssetAlert>, spec?: UpsertSpec): ObjList<ReliabilityAssetAlert> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<ReliabilityAssetAlert>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityAssetAlert> | null;
   ...
   */
  update(srcObj?: ReliabilityAssetAlert, spec?: UpsertSpec): ReliabilityAssetAlert | null;
   ...
   */
  upsert(srcObj?: ReliabilityAssetAlert, spec?: UpsertSpec): ReliabilityAssetAlert | null;
   ...
   */
  merge(spec?: MergeSpec): ReliabilityAssetAlert | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): ReliabilityAssetAlert | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): ReliabilityAssetAlert | null;
   ...
   */
  static updateBatch(objs: Array_Type<ReliabilityAssetAlert>, srcObjs?: Array_Type<ReliabilityAssetAlert>, spec?: UpsertSpec): ObjList<ReliabilityAssetAlert> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<ReliabilityAssetAlert> | null>, spec?: UpsertSpec): ObjList<ReliabilityAssetAlert> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<ReliabilityAssetAlert>, srcObjs?: Array_Type<ReliabilityAssetAlert>, spec?: UpsertSpec): ObjList<ReliabilityAssetAlert> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<ReliabilityAssetAlert> | null>, spec?: UpsertSpec): ObjList<ReliabilityAssetAlert> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<ReliabilityAssetAlert>, spec?: TouchSpec): ObjList<ReliabilityAssetAlert> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityAssetAlert>, spec?: MergeSpec): ObjList<ReliabilityAssetAlert> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityAssetAlert>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityAssetAlert> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<ReliabilityAssetAlert> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityAssetAlert> | null;
   ...
   */
  static mergeAll(mergeObj: ReliabilityAssetAlert, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: ReliabilityAssetAlert, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<ReliabilityAssetAlert>, spec?: UpsertSpec): ObjList<ReliabilityAssetAlert> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<ReliabilityAssetAlert>, spec?: UpsertSpec): ObjList<ReliabilityAssetAlert> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): ReliabilityAssetAlert | null;
   ...
   */
  static beforeCreate(objs: Array_Type<ReliabilityAssetAlert>): ObjList<ReliabilityAssetAlert>;
   ...
   */
  static beforeUpdate(objs: Array_Type<ReliabilityAssetAlert>): ObjList<ReliabilityAssetAlert>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<ReliabilityAssetAlert>): ObjList<ReliabilityAssetAlert>;

  /**
   * See {@link PersistableWritable#afterCreate}
   */
  static afterCreate(objs: Array_Type<ReliabilityAssetAlert>): Array_Type<ObjError> | null;
   ...
   */
  static afterUpdate(objs: Array_Type<ReliabilityAssetAlert>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<ReliabilityAssetAlert>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityAssetAlert>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityAssetAlert>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): ReliabilityAssetAlert | null;
   ...
   */
  withoutIdentity(): ReliabilityAssetAlert | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<ReliabilityAssetAlert>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: ReliabilityAssetAlert, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<ReliabilityAssetAlert>, callback?: λFunction<ReliabilityAssetAlert | null, ReliabilityAssetAlert | null>): ObjList<ReliabilityAssetAlert>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<ReliabilityAssetAlert>, callback?: λFunction<ReliabilityAssetAlert | null, ReliabilityAssetAlert | null>): Array_Type<ObjError> | null;
   ...
   */
  fetchFeaturesWithPrecomputedFeatures(spec?: FeatureFetchBaseSpec): FetchResultWithTotalCount<FeatureFetchBase> | null;
   ...
   */
  fetchFeatureNames(): Array_Type<string> | null;
   ...
   */
  fetchFeatures(spec?: FetchSpec, failureModeIds?: Array_Type<string>): FetchResultWithTotalCount<FeatureFetchBase> | null;
   ...
   */
  static evalFeatureSetBatch(batch: Array_Type<ReliabilityAssetAlert>, featureSet: Feature.Set, spec?: EvalFeatureSpec): Data | null;
   ...
   * ```
   */
  static evalFeaturesBatch(batch: Array_Type<ReliabilityAssetAlert>, features: Array_Type<string>, spec?: EvalFeaturesSpec): Data | null;
   ...
   */
  generateReport(reportSpec: ReliabilityReportSpec): ReliabilityReportResult | null;

  /**
   * @inheritdoc
   */
  generateReportEntity(reportSpec: ReliabilityReportSpec): ReliabilityReport | null;

  /**
   * Transition an array of state machines to a new state
   */
  static transitionBatch(stateMachines: Array_Type<ReliabilityAssetAlert>, toState: ReliabilityAssetAlertState, retry?: number, stateHistoryParams?: ReliabilityAssetAlertStateHistory): Array_Type<StateMachineTransitionStatus<ReliabilityAssetAlertStateHistory, ReliabilityAssetAlertStateTransition>>;
   ...
   */
  transition(toState: ReliabilityAssetAlertState, testOnly?: boolean, stateHistoryParams?: ReliabilityAssetAlertStateHistory): StateMachineTransitionStatus<ReliabilityAssetAlertStateHistory, ReliabilityAssetAlertStateTransition>;
   ...
   */
  checkTransition(toState: ReliabilityAssetAlertState): boolean;
   ...
   */
  possibleStates(): Array_Type<ReliabilityAssetAlertState> | null;

  /**
   * Return list of all states in the {@link StateMachine}.
   */
  static allStates(): Array_Type<ReliabilityAssetAlertState> | null;

  /**
   * Return list of transitions possible from the current state given the current user permissions and current conditions.
   */
  possibleTransitions(): Array_Type<ReliabilityAssetAlertStateTransition> | null;
   ...
   */
  static allTransitions(fromState?: ReliabilityAssetAlertState, toState?: ReliabilityAssetAlertState): Array_Type<ReliabilityAssetAlertStateTransition> | null;
   ...
   */
  forceTransition(toState: ReliabilityAssetAlertState, stateHistoryParams?: ReliabilityAssetAlertStateHistory): boolean;
   ...
   */
  static forceTransitionBatch(stateMachines: Array_Type<ReliabilityAssetAlert>, toState: ReliabilityAssetAlertState, stateHistoryParams?: ReliabilityAssetAlertStateHistory): Map_Type<string, boolean>;
   ...
   */
  static stateRecoverBatch(stateMachines: Array_Type<ReliabilityAssetAlert>): Map_Type<string, boolean>;

  /**
   * Transition with a valid transition in the transitions array
   */
  transitionWithTransitions(transitions?: Array_Type<ReliabilityAssetAlertStateTransition>, testOnly?: boolean, stateHistoryParams?: ReliabilityAssetAlertStateHistory): StateMachineTransitionStatus<ReliabilityAssetAlertStateHistory, ReliabilityAssetAlertStateTransition>;
   ...
   */
  static doBeforeCreate(objs: Array_Type<ReliabilityAssetAlert>): ObjList<ReliabilityAssetAlert> | null;
   ...
   */
  static doAfterUpdate(objs: Array_Type<ReliabilityAssetAlert>): Array_Type<ObjError> | null;
   ...
   */
  static doAfterCreate(objs: Array_Type<ReliabilityAssetAlert>): ObjList<ReliabilityAssetAlert> | null;

  /**
   * If defined, executed in removed after all state histories have been removed.
   * @param txn The transaction
   */
  static doRemoved(txn: Transaction): void;
   ...
   */
  executeTransition(transition: ReliabilityAssetAlertStateTransition, stateOrderCounter: number, stateHistoryParams?: ReliabilityAssetAlertStateHistory): ReliabilityAssetAlertStateHistory;

  /**
   * Internal use only.
   * Execute the {@link Lambda} function and return the error message if the {@link Lambda} fails.
   */
  executeLambda(action?: λConsumer<any | null>): string | null;
   ...
   */
  findTransitions(allTransitions: Array_Type<ReliabilityAssetAlertStateTransition>): Array_Type<ReliabilityAssetAlertStateTransition> | null;

  /**
   * Internal use only.
   * Implements a statemachine db lock.
   */
  reserveStateOrderCounter(): StateMachineTransitionStatus<ReliabilityAssetAlertStateHistory, ReliabilityAssetAlertStateTransition>;

  /**
   * Internal use only.
   * Verify whether the state machine is in error state.
   */
  checkStateMachine(): StateMachineTransitionStatus<ReliabilityAssetAlertStateHistory, ReliabilityAssetAlertStateTransition>;

  /**
   * If defined, executed in {@link updated}
   */
  static doUpdated(txn: Transaction): void;

  /**
   * Used from the UI to transition and refresh currentState stored calc.
   */
  transitionAndRefreshCurrentState(toState: ReliabilityAssetAlertState, stateHistoryParams?: ReliabilityAssetAlertStateHistory): StateMachineTransitionStatus<ReliabilityAssetAlertStateHistory, ReliabilityAssetAlertStateTransition>;

  /**
   * Used from the UI to batch transition and refresh currentState stored calc.
   */
  static transitionBatchAndRefreshCurrentState(stateMachines: Array_Type<ReliabilityAssetAlert>, toState: ReliabilityAssetAlertState, retry?: number, stateHistoryParams?: ReliabilityAssetAlertStateHistory): Array_Type<StateMachineTransitionStatus<ReliabilityAssetAlertStateHistory, ReliabilityAssetAlertStateTransition>>;
   ...
   */
  static triggerAutomaticTransition(stateMachineIds: Array_Type<string>, sync?: boolean): void;
   ...
   */
  fetchSimilarAlerts(spec?: FetchSpec): FetchResult<ReliabilityAssetAlertSimilarityLarge> | FetchResult<ReliabilityAssetAlertSimilaritySmall> | null;
   ...
   */
  reopenAlertAndLinkedCases(reopenSpec?: ReliabilityAssetAlertReopenSpec): void;

  /**
   * Reopen Alert and transition it to `Open` or `Case` state depending on its previous state
   */
  reopenAndTransitionAlert(): void;
   ...
   */
  computeCosineSimilarity(secondAlert: ReliabilityAssetAlert): number | null;
   ...
   */
  fetchFeatureContributionMapData(spec: EvaluateSpec): EvaluateResult | null;
   ...
   */
  static createAlertSimilarityWorkflow(alerts?: Array_Type<ReliabilityAssetAlert>): Workflow | null;
   ...
   */
  static startAlertSimilarityWorkflow(alerts?: Array_Type<ReliabilityAssetAlert>): Workflow.Run | null;
   ...
   */
  fetchCountSimilarAlerts(spec?: FetchSpec): number;
   ...
   */
  calculateAndStoreSimilarAlerts(): Array_Type<ReliabilityAssetAlertSimilaritySmall | ReliabilityAssetAlertSimilarityLarge> | null;
   ...
   */
  addSimilarAlertsToCases(similarities?: Array_Type<ReliabilityAssetAlertSimilaritySmall | ReliabilityAssetAlertSimilarityLarge>): void;
   ...
   */
  linkFailureModesAndRecommendations(): void;
   ...
   */
  processAlertSimilarity(fetchSpec: FetchSpec): Array_Type<ReliabilityAssetAlertSimilaritySmall | ReliabilityAssetAlertSimilarityLarge> | null;
}
