// TypeScript definitions for the C3 type ReliabilityAssetAlertSimilaritySmall

/**
 * Type to store similarity for two {@link ReliabilityAssetAlert}s in the default relational database.
 * Used for deployments with a small volume of alerts.
 * For large volume of alerts use {@link ReliabilityAssetAlertSimilarityLarge}.
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityAssetAlertSimilaritySmall
 */
declare interface IReliabilityAssetAlertSimilaritySmall {

  /**
   * {@link ReliabilityAssetAlert} whose creation prompted the generation of this similarity score.
   */
  baseAlert: IReliabilityAssetAlert;

  /**
   * {@link ReliabilityAssetAlert} being compared against the base alert.
   */
  comparableAlert: IReliabilityAssetAlert;

  /**
   * A numeric score representing the extent of similarity for the two {@link ReliabilityAssetAlert}s.
   * For the base app, this will be a number between 0 and 1 inclusive.
   */
  similarityScore: number;

  /**
   * Value of any type representing similarity for the two {@link ReliabilityAssetAlert}s.
   * It can be a numeric percentage, a categorical string (e.g., High, Medium, Low), or another type of value
   * This value will be showed in the UI.
   *
   * For the base app, this will be the similarityScore * 100.
   */
  displaySimilarity: any;
 ...
 * For large volume of alerts use {@link ReliabilityAssetAlertSimilarityLarge}.
 *
 * @remarks this represents a made instance of ReliabilityAssetAlertSimilaritySmall
 */
declare class ReliabilityAssetAlertSimilaritySmall extends Obj  {

  /**
   * {@link ReliabilityAssetAlert} whose creation prompted the generation of this similarity score.
   */
  readonly baseAlert: ReliabilityAssetAlert;
  withBaseAlert(baseAlert: IReliabilityAssetAlert): ReliabilityAssetAlertSimilaritySmall;

  /**
   * {@link ReliabilityAssetAlert} being compared against the base alert.
   */
  readonly comparableAlert: ReliabilityAssetAlert;
  withComparableAlert(comparableAlert: IReliabilityAssetAlert): ReliabilityAssetAlertSimilaritySmall;
  ...
  withSimilarityScore(similarityScore: number): ReliabilityAssetAlertSimilaritySmall;
   ...
   * For the base app, this will be the similarityScore * 100.
   */
  readonly displaySimilarity: any;
  withDisplaySimilarity(displaySimilarity: any): ReliabilityAssetAlertSimilaritySmall;
   ...
   */
  readonly id: string;
  withId(id: string): ReliabilityAssetAlertSimilaritySmall;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityAssetAlertSimilaritySmall;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): ReliabilityAssetAlertSimilaritySmall;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): ReliabilityAssetAlertSimilaritySmall;
  ...
  withVersion(version: number | null): ReliabilityAssetAlertSimilaritySmall;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): ReliabilityAssetAlertSimilaritySmall;

  /**
   * @inheritdoc
   */
  readonly facilityFilterPaths?: Array_Type<string>;
  withFacilityFilterPaths(facilityFilterPaths: Array_Type<string> | Array<string> | null): ReliabilityAssetAlertSimilaritySmall;
   ...
   * @see #toJson
   */
  static fromJson(json: any): ReliabilityAssetAlertSimilaritySmall | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): ReliabilityAssetAlertSimilaritySmall | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): ReliabilityAssetAlertSimilaritySmall | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): ReliabilityAssetAlertSimilaritySmall | null;
   ...
   */
  replaceType(old: Type, new_: Type): ReliabilityAssetAlertSimilaritySmall;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityAssetAlertSimilaritySmall;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityAssetAlertSimilaritySmall;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityAssetAlertSimilaritySmall>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityAssetAlertSimilaritySmall>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityAssetAlertSimilaritySmall;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityAssetAlertSimilaritySmall;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityAssetAlertSimilaritySmall;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ReliabilityAssetAlertSimilaritySmall;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ReliabilityAssetAlertSimilaritySmall;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityAssetAlertSimilaritySmall;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityAssetAlertSimilaritySmall;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityAssetAlertSimilaritySmall;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ReliabilityAssetAlertSimilaritySmall;
   ...
   * @see #removeField
   */
  withoutField(field: string): ReliabilityAssetAlertSimilaritySmall;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): ReliabilityAssetAlertSimilaritySmall;
   ...
   */
  withoutFields(fields: Array_Type<string>): ReliabilityAssetAlertSimilaritySmall;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityAssetAlertSimilaritySmall;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ReliabilityAssetAlertSimilaritySmall;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityAssetAlertSimilaritySmall;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ReliabilityAssetAlertSimilaritySmall;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ReliabilityAssetAlertSimilaritySmall;
   ...
   * @see #removeField
   */
  unsetField(field: string): ReliabilityAssetAlertSimilaritySmall;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ReliabilityAssetAlertSimilaritySmall;
   ...
   * @see #unsetField
   */
  removeField(field: string): ReliabilityAssetAlertSimilaritySmall;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ReliabilityAssetAlertSimilaritySmall;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityAssetAlertSimilaritySmall;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityAssetAlertSimilaritySmall;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityAssetAlertSimilaritySmall;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityAssetAlertSimilaritySmall;

  mergeJson(json: any): ReliabilityAssetAlertSimilaritySmall;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityAssetAlertSimilaritySmall;
   ...
   */
  sumObj(other: Obj, deep?: boolean): ReliabilityAssetAlertSimilaritySmall;
   ...
   */
  singletonArray(): Array_Type<ReliabilityAssetAlertSimilaritySmall>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityAssetAlertSimilaritySmall> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ReliabilityAssetAlertSimilaritySmall> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<ReliabilityAssetAlertSimilaritySmall>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ReliabilityAssetAlertSimilaritySmall> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, ReliabilityAssetAlertSimilaritySmall> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityAssetAlertSimilaritySmall> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ReliabilityAssetAlertSimilaritySmall>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ReliabilityAssetAlertSimilaritySmall>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityAssetAlertSimilaritySmall;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityAssetAlertSimilaritySmall;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityAssetAlertSimilaritySmall;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ReliabilityAssetAlertSimilaritySmall;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityAssetAlertSimilaritySmall;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ReliabilityAssetAlertSimilaritySmall;
   ...
   * @see #fromString
   */
  static make(s: string): ReliabilityAssetAlertSimilaritySmall | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityAssetAlertSimilaritySmall;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): ReliabilityAssetAlertSimilaritySmall;
   ...
   */
  static cachedEmptyInst(): ReliabilityAssetAlertSimilaritySmall;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityAssetAlertSimilaritySmall> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): ReliabilityAssetAlertSimilaritySmall;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<ReliabilityAssetAlertSimilaritySmall>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<ReliabilityAssetAlertSimilaritySmall>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityAssetAlertSimilaritySmall> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityAssetAlertSimilaritySmall>> | null;
   ...
   */
  get(include?: string): ReliabilityAssetAlertSimilaritySmall | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): ReliabilityAssetAlertSimilaritySmall | null;
   ...
   */
  getMissing(spec: GetMissingSpec): ReliabilityAssetAlertSimilaritySmall;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): ReliabilityAssetAlertSimilaritySmall | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): ReliabilityAssetAlertSimilaritySmall;
   ...
   * @see #toString
   */
  static fromString(s: string): ReliabilityAssetAlertSimilaritySmall | null;
   ...
   */
  create(spec?: UpsertSpec): ReliabilityAssetAlertSimilaritySmall | null;
   ...
   */
  static createBatch(objs: Array_Type<ReliabilityAssetAlertSimilaritySmall>, spec?: UpsertSpec): ObjList<ReliabilityAssetAlertSimilaritySmall> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<ReliabilityAssetAlertSimilaritySmall>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityAssetAlertSimilaritySmall> | null;
   ...
   */
  update(srcObj?: ReliabilityAssetAlertSimilaritySmall, spec?: UpsertSpec): ReliabilityAssetAlertSimilaritySmall | null;
   ...
   */
  upsert(srcObj?: ReliabilityAssetAlertSimilaritySmall, spec?: UpsertSpec): ReliabilityAssetAlertSimilaritySmall | null;
   ...
   */
  merge(spec?: MergeSpec): ReliabilityAssetAlertSimilaritySmall | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): ReliabilityAssetAlertSimilaritySmall | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): ReliabilityAssetAlertSimilaritySmall | null;
   ...
   */
  static updateBatch(objs: Array_Type<ReliabilityAssetAlertSimilaritySmall>, srcObjs?: Array_Type<ReliabilityAssetAlertSimilaritySmall>, spec?: UpsertSpec): ObjList<ReliabilityAssetAlertSimilaritySmall> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<ReliabilityAssetAlertSimilaritySmall> | null>, spec?: UpsertSpec): ObjList<ReliabilityAssetAlertSimilaritySmall> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<ReliabilityAssetAlertSimilaritySmall>, srcObjs?: Array_Type<ReliabilityAssetAlertSimilaritySmall>, spec?: UpsertSpec): ObjList<ReliabilityAssetAlertSimilaritySmall> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<ReliabilityAssetAlertSimilaritySmall> | null>, spec?: UpsertSpec): ObjList<ReliabilityAssetAlertSimilaritySmall> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<ReliabilityAssetAlertSimilaritySmall>, spec?: TouchSpec): ObjList<ReliabilityAssetAlertSimilaritySmall> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityAssetAlertSimilaritySmall>, spec?: MergeSpec): ObjList<ReliabilityAssetAlertSimilaritySmall> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityAssetAlertSimilaritySmall>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityAssetAlertSimilaritySmall> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<ReliabilityAssetAlertSimilaritySmall> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityAssetAlertSimilaritySmall> | null;
   ...
   */
  static mergeAll(mergeObj: ReliabilityAssetAlertSimilaritySmall, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: ReliabilityAssetAlertSimilaritySmall, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<ReliabilityAssetAlertSimilaritySmall>, spec?: UpsertSpec): ObjList<ReliabilityAssetAlertSimilaritySmall> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<ReliabilityAssetAlertSimilaritySmall>, spec?: UpsertSpec): ObjList<ReliabilityAssetAlertSimilaritySmall> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): ReliabilityAssetAlertSimilaritySmall | null;
   ...
   */
  static beforeCreate(objs: Array_Type<ReliabilityAssetAlertSimilaritySmall>): ObjList<ReliabilityAssetAlertSimilaritySmall>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<ReliabilityAssetAlertSimilaritySmall>): ObjList<ReliabilityAssetAlertSimilaritySmall>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<ReliabilityAssetAlertSimilaritySmall>): ObjList<ReliabilityAssetAlertSimilaritySmall>;
   ...
   */
  static afterCreate(objs: Array_Type<ReliabilityAssetAlertSimilaritySmall>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<ReliabilityAssetAlertSimilaritySmall>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<ReliabilityAssetAlertSimilaritySmall>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityAssetAlertSimilaritySmall>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityAssetAlertSimilaritySmall>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): ReliabilityAssetAlertSimilaritySmall | null;
   ...
   */
  withoutIdentity(): ReliabilityAssetAlertSimilaritySmall | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<ReliabilityAssetAlertSimilaritySmall>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: ReliabilityAssetAlertSimilaritySmall, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<ReliabilityAssetAlertSimilaritySmall>, callback?: λFunction<ReliabilityAssetAlertSimilaritySmall | null, ReliabilityAssetAlertSimilaritySmall | null>): ObjList<ReliabilityAssetAlertSimilaritySmall>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<ReliabilityAssetAlertSimilaritySmall>, callback?: λFunction<ReliabilityAssetAlertSimilaritySmall | null, ReliabilityAssetAlertSimilaritySmall | null>): Array_Type<ObjError> | null;
