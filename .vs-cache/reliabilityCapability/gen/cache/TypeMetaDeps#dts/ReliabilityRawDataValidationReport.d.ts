// TypeScript definitions for the C3 type ReliabilityRawDataValidationReport
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityRawDataValidationReport
 */
declare interface IReliabilityRawDataValidationReport {
   ...
   */
  fileStats?: IReliabilityRawDataValidationReportForDataType;

  /**
   * This field stores basic statistics about data quality across all
   * {@link CanonicalPointMeasurement} {@link File}s available.
   */
  canonicalPointMeasurementStats?: IReliabilityRawDataValidationReportForDataType;

  /**
   * This field stores basic statistics about data quality across all
   * {@link CanonicalPointPhysicalMeasurementSeries} {@link File}s available.
   */
  canonicalPointPhysicalMeasurementSeriesStats?: IReliabilityRawDataValidationReportForDataType;

  /**
   * This field stores basic statistics about data quality across all
   * {@link CanonicalReliabilityAssetEvent} {@link File}s available.
   */
  canonicalReliabilityAssetEventStats?: IReliabilityRawDataValidationReportForDataType;

  /**
   * This field stores basic statistics about data quality across all
   * asset hierarchy spreadsheet {@link File}s available.
   */
  assetHierarchyExcelStats?: IReliabilityRawDataValidationReportForDataType;
   ...
   */
  warnings?: Array_Type<string> | Array<string>;
   ...
   */
  job?: IReliabilityRawDataValidationJob;
}
 ...
 */
declare class ReliabilityRawDataValidationReport extends Obj  {
  ...
  withTypeIdent(typeIdent: string | null): ReliabilityRawDataValidationReport;
   ...
   */
  readonly id: string;
  withId(id: string): ReliabilityRawDataValidationReport;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityRawDataValidationReport;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): ReliabilityRawDataValidationReport;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): ReliabilityRawDataValidationReport;
  ...
  withVersion(version: number | null): ReliabilityRawDataValidationReport;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): ReliabilityRawDataValidationReport;

  /**
   * This field stores basic statistics about data quality across all the raw data
   * {@link File}s available.
   */
  readonly fileStats?: ReliabilityRawDataValidationReportForDataType;
  withFileStats(fileStats: IReliabilityRawDataValidationReportForDataType | null): ReliabilityRawDataValidationReport;

  /**
   * This field stores basic statistics about data quality across all
   * {@link CanonicalPointMeasurement} {@link File}s available.
   */
  readonly canonicalPointMeasurementStats?: ReliabilityRawDataValidationReportForDataType;
  withCanonicalPointMeasurementStats(canonicalPointMeasurementStats: IReliabilityRawDataValidationReportForDataType | null): ReliabilityRawDataValidationReport;

  /**
   * This field stores basic statistics about data quality across all
   * {@link CanonicalPointPhysicalMeasurementSeries} {@link File}s available.
   */
  readonly canonicalPointPhysicalMeasurementSeriesStats?: ReliabilityRawDataValidationReportForDataType;
  withCanonicalPointPhysicalMeasurementSeriesStats(canonicalPointPhysicalMeasurementSeriesStats: IReliabilityRawDataValidationReportForDataType | null): ReliabilityRawDataValidationReport;

  /**
   * This field stores basic statistics about data quality across all
   * {@link CanonicalReliabilityAssetEvent} {@link File}s available.
   */
  readonly canonicalReliabilityAssetEventStats?: ReliabilityRawDataValidationReportForDataType;
  withCanonicalReliabilityAssetEventStats(canonicalReliabilityAssetEventStats: IReliabilityRawDataValidationReportForDataType | null): ReliabilityRawDataValidationReport;

  /**
   * This field stores basic statistics about data quality across all
   * asset hierarchy spreadsheet {@link File}s available.
   */
  readonly assetHierarchyExcelStats?: ReliabilityRawDataValidationReportForDataType;
  withAssetHierarchyExcelStats(assetHierarchyExcelStats: IReliabilityRawDataValidationReportForDataType | null): ReliabilityRawDataValidationReport;
  ...
  withErrors(errors: Array_Type<string> | Array<string> | null): ReliabilityRawDataValidationReport;
   ...
   * Warnings are not mandatory to rectify.
   */
  readonly warnings?: Array_Type<string>;
  withWarnings(warnings: Array_Type<string> | Array<string> | null): ReliabilityRawDataValidationReport;
   ...
   */
  readonly stats?: File;
  withStats(stats: IFile | null): ReliabilityRawDataValidationReport;
   ...
   * the reference to the job will be stored in the {@link job} field.
   */
  readonly job?: ReliabilityRawDataValidationJob;
  withJob(job: IReliabilityRawDataValidationJob | null): ReliabilityRawDataValidationReport;
   ...
   * @see #toJson
   */
  static fromJson(json: any): ReliabilityRawDataValidationReport | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): ReliabilityRawDataValidationReport | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): ReliabilityRawDataValidationReport | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): ReliabilityRawDataValidationReport | null;
   ...
   */
  replaceType(old: Type, new_: Type): ReliabilityRawDataValidationReport;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityRawDataValidationReport;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityRawDataValidationReport;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityRawDataValidationReport>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityRawDataValidationReport>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityRawDataValidationReport;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityRawDataValidationReport;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityRawDataValidationReport;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ReliabilityRawDataValidationReport;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ReliabilityRawDataValidationReport;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityRawDataValidationReport;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityRawDataValidationReport;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityRawDataValidationReport;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ReliabilityRawDataValidationReport;
   ...
   * @see #removeField
   */
  withoutField(field: string): ReliabilityRawDataValidationReport;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): ReliabilityRawDataValidationReport;
   ...
   */
  withoutFields(fields: Array_Type<string>): ReliabilityRawDataValidationReport;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityRawDataValidationReport;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ReliabilityRawDataValidationReport;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityRawDataValidationReport;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ReliabilityRawDataValidationReport;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ReliabilityRawDataValidationReport;
   ...
   * @see #removeField
   */
  unsetField(field: string): ReliabilityRawDataValidationReport;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ReliabilityRawDataValidationReport;
   ...
   * @see #unsetField
   */
  removeField(field: string): ReliabilityRawDataValidationReport;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ReliabilityRawDataValidationReport;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityRawDataValidationReport;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityRawDataValidationReport;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityRawDataValidationReport;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityRawDataValidationReport;

  mergeJson(json: any): ReliabilityRawDataValidationReport;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityRawDataValidationReport;
   ...
   */
  sumObj(other: Obj, deep?: boolean): ReliabilityRawDataValidationReport;
   ...
   */
  singletonArray(): Array_Type<ReliabilityRawDataValidationReport>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityRawDataValidationReport> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ReliabilityRawDataValidationReport> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<ReliabilityRawDataValidationReport>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ReliabilityRawDataValidationReport> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, ReliabilityRawDataValidationReport> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityRawDataValidationReport> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ReliabilityRawDataValidationReport>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ReliabilityRawDataValidationReport>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityRawDataValidationReport;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityRawDataValidationReport;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityRawDataValidationReport;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ReliabilityRawDataValidationReport;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityRawDataValidationReport;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ReliabilityRawDataValidationReport;
   ...
   * @see #fromString
   */
  static make(s: string): ReliabilityRawDataValidationReport | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityRawDataValidationReport;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): ReliabilityRawDataValidationReport;
   ...
   */
  static cachedEmptyInst(): ReliabilityRawDataValidationReport;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityRawDataValidationReport> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): ReliabilityRawDataValidationReport;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<ReliabilityRawDataValidationReport>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<ReliabilityRawDataValidationReport>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityRawDataValidationReport> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityRawDataValidationReport>> | null;
   ...
   */
  get(include?: string): ReliabilityRawDataValidationReport | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): ReliabilityRawDataValidationReport | null;
   ...
   */
  getMissing(spec: GetMissingSpec): ReliabilityRawDataValidationReport;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): ReliabilityRawDataValidationReport | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): ReliabilityRawDataValidationReport;
   ...
   * @see #toString
   */
  static fromString(s: string): ReliabilityRawDataValidationReport | null;
   ...
   */
  create(spec?: UpsertSpec): ReliabilityRawDataValidationReport | null;
   ...
   */
  static createBatch(objs: Array_Type<ReliabilityRawDataValidationReport>, spec?: UpsertSpec): ObjList<ReliabilityRawDataValidationReport> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<ReliabilityRawDataValidationReport>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityRawDataValidationReport> | null;
   ...
   */
  update(srcObj?: ReliabilityRawDataValidationReport, spec?: UpsertSpec): ReliabilityRawDataValidationReport | null;
   ...
   */
  upsert(srcObj?: ReliabilityRawDataValidationReport, spec?: UpsertSpec): ReliabilityRawDataValidationReport | null;
   ...
   */
  merge(spec?: MergeSpec): ReliabilityRawDataValidationReport | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): ReliabilityRawDataValidationReport | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): ReliabilityRawDataValidationReport | null;
   ...
   */
  static updateBatch(objs: Array_Type<ReliabilityRawDataValidationReport>, srcObjs?: Array_Type<ReliabilityRawDataValidationReport>, spec?: UpsertSpec): ObjList<ReliabilityRawDataValidationReport> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<ReliabilityRawDataValidationReport> | null>, spec?: UpsertSpec): ObjList<ReliabilityRawDataValidationReport> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<ReliabilityRawDataValidationReport>, srcObjs?: Array_Type<ReliabilityRawDataValidationReport>, spec?: UpsertSpec): ObjList<ReliabilityRawDataValidationReport> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<ReliabilityRawDataValidationReport> | null>, spec?: UpsertSpec): ObjList<ReliabilityRawDataValidationReport> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<ReliabilityRawDataValidationReport>, spec?: TouchSpec): ObjList<ReliabilityRawDataValidationReport> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityRawDataValidationReport>, spec?: MergeSpec): ObjList<ReliabilityRawDataValidationReport> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityRawDataValidationReport>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityRawDataValidationReport> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<ReliabilityRawDataValidationReport> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityRawDataValidationReport> | null;
   ...
   */
  static mergeAll(mergeObj: ReliabilityRawDataValidationReport, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: ReliabilityRawDataValidationReport, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<ReliabilityRawDataValidationReport>, spec?: UpsertSpec): ObjList<ReliabilityRawDataValidationReport> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<ReliabilityRawDataValidationReport>, spec?: UpsertSpec): ObjList<ReliabilityRawDataValidationReport> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): ReliabilityRawDataValidationReport | null;
   ...
   */
  static beforeCreate(objs: Array_Type<ReliabilityRawDataValidationReport>): ObjList<ReliabilityRawDataValidationReport>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<ReliabilityRawDataValidationReport>): ObjList<ReliabilityRawDataValidationReport>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<ReliabilityRawDataValidationReport>): ObjList<ReliabilityRawDataValidationReport>;
   ...
   */
  static afterCreate(objs: Array_Type<ReliabilityRawDataValidationReport>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<ReliabilityRawDataValidationReport>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<ReliabilityRawDataValidationReport>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityRawDataValidationReport>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityRawDataValidationReport>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): ReliabilityRawDataValidationReport | null;
   ...
   */
  withoutIdentity(): ReliabilityRawDataValidationReport | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<ReliabilityRawDataValidationReport>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: ReliabilityRawDataValidationReport, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<ReliabilityRawDataValidationReport>, callback?: λFunction<ReliabilityRawDataValidationReport | null, ReliabilityRawDataValidationReport | null>): ObjList<ReliabilityRawDataValidationReport>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<ReliabilityRawDataValidationReport>, callback?: λFunction<ReliabilityRawDataValidationReport | null, ReliabilityRawDataValidationReport | null>): Array_Type<ObjError> | null;
