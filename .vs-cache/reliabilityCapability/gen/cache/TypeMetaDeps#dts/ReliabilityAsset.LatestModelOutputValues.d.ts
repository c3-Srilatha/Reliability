// TypeScript definitions for the C3 type ReliabilityAsset.LatestModelOutputValues

/**
 * Stores the latest model output values for a {@link ReliabilityAsset}.
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityAsset.LatestModelOutputValues
 */
declare namespace ReliabilityAsset {
  export interface ILatestModelOutputValues {
 ...
 */
declare namespace ReliabilityAsset {
  export class LatestModelOutputValues extends Obj  {
     ...
     */
    readonly id: string;
    withId(id: string): ReliabilityAsset.LatestModelOutputValues;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityAsset.LatestModelOutputValues;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): ReliabilityAsset.LatestModelOutputValues;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): ReliabilityAsset.LatestModelOutputValues;
    ...
    withVersion(version: number | null): ReliabilityAsset.LatestModelOutputValues;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): ReliabilityAsset.LatestModelOutputValues;

    /**
     * The {@link ReliabilityAsset} for which the latest model output values are stored.
     */
    readonly asset: ReliabilityAsset;
    withAsset(asset: IReliabilityAsset): ReliabilityAsset.LatestModelOutputValues;

    /**
     * The {@link ReliabilityMl.Project} that produced the model output scores.
     */
    readonly project: ReliabilityMl.Project;
    withProject(project: IReliabilityMl.Project): ReliabilityAsset.LatestModelOutputValues;

    /**
     * The latest model output score produced by the {@link #project} for the {@link #asset}.
     */
    readonly value: any;
    withValue(value: any): ReliabilityAsset.LatestModelOutputValues;
     ...
     * @see #toJson
     */
    static fromJson(json: any): ReliabilityAsset.LatestModelOutputValues | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): ReliabilityAsset.LatestModelOutputValues | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): ReliabilityAsset.LatestModelOutputValues | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): ReliabilityAsset.LatestModelOutputValues | null;
     ...
     */
    replaceType(old: Type, new_: Type): ReliabilityAsset.LatestModelOutputValues;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityAsset.LatestModelOutputValues;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityAsset.LatestModelOutputValues;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityAsset.LatestModelOutputValues>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityAsset.LatestModelOutputValues>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityAsset.LatestModelOutputValues;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityAsset.LatestModelOutputValues;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityAsset.LatestModelOutputValues;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): ReliabilityAsset.LatestModelOutputValues;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): ReliabilityAsset.LatestModelOutputValues;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityAsset.LatestModelOutputValues;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityAsset.LatestModelOutputValues;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityAsset.LatestModelOutputValues;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): ReliabilityAsset.LatestModelOutputValues;
     ...
     * @see #removeField
     */
    withoutField(field: string): ReliabilityAsset.LatestModelOutputValues;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): ReliabilityAsset.LatestModelOutputValues;
     ...
     */
    withoutFields(fields: Array_Type<string>): ReliabilityAsset.LatestModelOutputValues;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityAsset.LatestModelOutputValues;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): ReliabilityAsset.LatestModelOutputValues;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityAsset.LatestModelOutputValues;
     ...
     * @see #unsetField
     */
    defaultField(field: string): ReliabilityAsset.LatestModelOutputValues;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): ReliabilityAsset.LatestModelOutputValues;
     ...
     * @see #removeField
     */
    unsetField(field: string): ReliabilityAsset.LatestModelOutputValues;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): ReliabilityAsset.LatestModelOutputValues;
     ...
     * @see #unsetField
     */
    removeField(field: string): ReliabilityAsset.LatestModelOutputValues;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): ReliabilityAsset.LatestModelOutputValues;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityAsset.LatestModelOutputValues;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityAsset.LatestModelOutputValues;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityAsset.LatestModelOutputValues;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityAsset.LatestModelOutputValues;

    mergeJson(json: any): ReliabilityAsset.LatestModelOutputValues;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityAsset.LatestModelOutputValues;
     ...
     */
    sumObj(other: Obj, deep?: boolean): ReliabilityAsset.LatestModelOutputValues;
     ...
     */
    singletonArray(): Array_Type<ReliabilityAsset.LatestModelOutputValues>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityAsset.LatestModelOutputValues> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<ReliabilityAsset.LatestModelOutputValues> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<ReliabilityAsset.LatestModelOutputValues>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<ReliabilityAsset.LatestModelOutputValues> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, ReliabilityAsset.LatestModelOutputValues> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityAsset.LatestModelOutputValues> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<ReliabilityAsset.LatestModelOutputValues>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<ReliabilityAsset.LatestModelOutputValues>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityAsset.LatestModelOutputValues;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityAsset.LatestModelOutputValues;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityAsset.LatestModelOutputValues;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): ReliabilityAsset.LatestModelOutputValues;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityAsset.LatestModelOutputValues;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): ReliabilityAsset.LatestModelOutputValues;
     ...
     * @see #fromString
     */
    static make(s: string): ReliabilityAsset.LatestModelOutputValues | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityAsset.LatestModelOutputValues;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): ReliabilityAsset.LatestModelOutputValues;
     ...
     */
    static cachedEmptyInst(): ReliabilityAsset.LatestModelOutputValues;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityAsset.LatestModelOutputValues> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): ReliabilityAsset.LatestModelOutputValues;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<ReliabilityAsset.LatestModelOutputValues>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<ReliabilityAsset.LatestModelOutputValues>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityAsset.LatestModelOutputValues> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityAsset.LatestModelOutputValues>> | null;
     ...
     */
    get(include?: string): ReliabilityAsset.LatestModelOutputValues | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): ReliabilityAsset.LatestModelOutputValues | null;
     ...
     */
    getMissing(spec: GetMissingSpec): ReliabilityAsset.LatestModelOutputValues;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): ReliabilityAsset.LatestModelOutputValues | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): ReliabilityAsset.LatestModelOutputValues;
     ...
     * @see #toString
     */
    static fromString(s: string): ReliabilityAsset.LatestModelOutputValues | null;
     ...
     */
    create(spec?: UpsertSpec): ReliabilityAsset.LatestModelOutputValues | null;
     ...
     */
    static createBatch(objs: Array_Type<ReliabilityAsset.LatestModelOutputValues>, spec?: UpsertSpec): ObjList<ReliabilityAsset.LatestModelOutputValues> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<ReliabilityAsset.LatestModelOutputValues>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityAsset.LatestModelOutputValues> | null;
     ...
     */
    update(srcObj?: ReliabilityAsset.LatestModelOutputValues, spec?: UpsertSpec): ReliabilityAsset.LatestModelOutputValues | null;
     ...
     */
    upsert(srcObj?: ReliabilityAsset.LatestModelOutputValues, spec?: UpsertSpec): ReliabilityAsset.LatestModelOutputValues | null;
     ...
     */
    merge(spec?: MergeSpec): ReliabilityAsset.LatestModelOutputValues | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): ReliabilityAsset.LatestModelOutputValues | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): ReliabilityAsset.LatestModelOutputValues | null;
     ...
     */
    static updateBatch(objs: Array_Type<ReliabilityAsset.LatestModelOutputValues>, srcObjs?: Array_Type<ReliabilityAsset.LatestModelOutputValues>, spec?: UpsertSpec): ObjList<ReliabilityAsset.LatestModelOutputValues> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<ReliabilityAsset.LatestModelOutputValues> | null>, spec?: UpsertSpec): ObjList<ReliabilityAsset.LatestModelOutputValues> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<ReliabilityAsset.LatestModelOutputValues>, srcObjs?: Array_Type<ReliabilityAsset.LatestModelOutputValues>, spec?: UpsertSpec): ObjList<ReliabilityAsset.LatestModelOutputValues> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<ReliabilityAsset.LatestModelOutputValues> | null>, spec?: UpsertSpec): ObjList<ReliabilityAsset.LatestModelOutputValues> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<ReliabilityAsset.LatestModelOutputValues>, spec?: TouchSpec): ObjList<ReliabilityAsset.LatestModelOutputValues> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityAsset.LatestModelOutputValues>, spec?: MergeSpec): ObjList<ReliabilityAsset.LatestModelOutputValues> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityAsset.LatestModelOutputValues>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityAsset.LatestModelOutputValues> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<ReliabilityAsset.LatestModelOutputValues> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityAsset.LatestModelOutputValues> | null;
     ...
     */
    static mergeAll(mergeObj: ReliabilityAsset.LatestModelOutputValues, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: ReliabilityAsset.LatestModelOutputValues, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<ReliabilityAsset.LatestModelOutputValues>, spec?: UpsertSpec): ObjList<ReliabilityAsset.LatestModelOutputValues> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<ReliabilityAsset.LatestModelOutputValues>, spec?: UpsertSpec): ObjList<ReliabilityAsset.LatestModelOutputValues> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): ReliabilityAsset.LatestModelOutputValues | null;
     ...
     */
    static beforeCreate(objs: Array_Type<ReliabilityAsset.LatestModelOutputValues>): ObjList<ReliabilityAsset.LatestModelOutputValues>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<ReliabilityAsset.LatestModelOutputValues>): ObjList<ReliabilityAsset.LatestModelOutputValues>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<ReliabilityAsset.LatestModelOutputValues>): ObjList<ReliabilityAsset.LatestModelOutputValues>;
     ...
     */
    static afterCreate(objs: Array_Type<ReliabilityAsset.LatestModelOutputValues>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<ReliabilityAsset.LatestModelOutputValues>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<ReliabilityAsset.LatestModelOutputValues>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityAsset.LatestModelOutputValues>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityAsset.LatestModelOutputValues>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): ReliabilityAsset.LatestModelOutputValues | null;
     ...
     */
    withoutIdentity(): ReliabilityAsset.LatestModelOutputValues | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<ReliabilityAsset.LatestModelOutputValues>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: ReliabilityAsset.LatestModelOutputValues, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<ReliabilityAsset.LatestModelOutputValues>, callback?: λFunction<ReliabilityAsset.LatestModelOutputValues | null, ReliabilityAsset.LatestModelOutputValues | null>): ObjList<ReliabilityAsset.LatestModelOutputValues>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<ReliabilityAsset.LatestModelOutputValues>, callback?: λFunction<ReliabilityAsset.LatestModelOutputValues | null, ReliabilityAsset.LatestModelOutputValues | null>): Array_Type<ObjError> | null;
