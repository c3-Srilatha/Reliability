// TypeScript definitions for the C3 type ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob
 */
declare namespace ReliabilityOrchestrator.ReliabilityRisk {
  export interface IModelValidationJob {
 ...
 */
declare namespace ReliabilityOrchestrator.ReliabilityRisk {
  export class ModelValidationJob extends Obj  {

    /**
     * current or last job execution for this instance
     */
    readonly run?: BatchJobRun;
    withRun(run: IBatchJobRun | null): ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob;

    /**
     * previous job executions for this instance
     */
    readonly runs?: Array_Type<BatchJobRun>;
    withRuns(runs: Array_Type<BatchJobRun> | Array<IBatchJobRun> | null): ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob;

    /**
     * FOR INTERNAL USE ONLY - Specify options in call to {@link start}.
     */
    readonly options?: Obj;
    withOptions(options: IObj | null): ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob;
    ...
    withOnCompleteCallback(onCompleteCallback: IJobBase.Callback | null): ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob;
    ...
    withPriority(priority: number | null): ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob;
    ...
    withDisabled(disabled: boolean): ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob;
    ...
    withMaxConcurrency(maxConcurrency: number | null): ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob;
    ...
    withMaxConcurrencyPerNode(maxConcurrencyPerNode: number | null): ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob;
    ...
    withRunAsUser(runAsUser: boolean): ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob;

    /**
     * Don't set this field in the BatchJob, set it in the BatchJobOptions when calling `start`
     */
    readonly nodePool?: string;
    withNodePool(nodePool: string | null): ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob;
    ...
    withSkipIfRunning(skipIfRunning: boolean): ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob;

    /**
     * Set to between 1 and 5 to enable auto recovery. See {@link invalidation-queues.c3doc Invalidation Queues} for detailed documentation.
     */
    readonly numAutoRecoveryAttempts?: number;
    withNumAutoRecoveryAttempts(numAutoRecoveryAttempts: number | null): ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob;
    ...
    withPropagateActionContext(propagateActionContext: boolean): ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob;
    ...
    withTypeIdent(typeIdent: string | null): ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob;
     ...
     */
    readonly id: string;
    withId(id: string): ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob;
    ...
    withVersion(version: number | null): ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob;
    ...
    withAbortOnError(abortOnError: boolean): ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob;
     ...
     * @see #toJson
     */
    static fromJson(json: any): ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob | null;
     ...
     */
    replaceType(old: Type, new_: Type): ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob;
     ...
     * @see #removeField
     */
    withoutField(field: string): ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob;
     ...
     */
    withoutFields(fields: Array_Type<string>): ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob;
     ...
     * @see #unsetField
     */
    defaultField(field: string): ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob;
     ...
     * @see #removeField
     */
    unsetField(field: string): ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob;
     ...
     * @see #unsetField
     */
    removeField(field: string): ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob;

    mergeJson(json: any): ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob;
     ...
     */
    sumObj(other: Obj, deep?: boolean): ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob;
     ...
     */
    singletonArray(): Array_Type<ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob;
     ...
     * @see #fromString
     */
    static make(s: string): ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob;
     ...
     */
    static cachedEmptyInst(): ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob;
     ...
     */
    start(options?: ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJobOptions): BatchJobStatus | null;
     ...
     */
    cleanup(options?: ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJobOptions): void;
    ...
    cancelJob(removeResults?: boolean, force?: boolean): JobBase<BatchJobRun, BatchJobStatus, ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJobOptions> | null;

    failJob(run: JobRun<BatchJobStatusBase>): JobBase<BatchJobRun, BatchJobStatus, ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJobOptions> | null;
    ...
    validateStart(options?: ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJobOptions): void;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob>> | null;
     ...
     */
    get(include?: string): ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob | null;
     ...
     */
    getMissing(spec: GetMissingSpec): ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob;
     ...
     * @see #toString
     */
    static fromString(s: string): ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob | null;
     ...
     */
    create(spec?: UpsertSpec): ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob | null;
     ...
     */
    static createBatch(objs: Array_Type<ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob> | null;
     ...
     */
    update(srcObj?: ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob, spec?: UpsertSpec): ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob | null;
     ...
     */
    upsert(srcObj?: ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob, spec?: UpsertSpec): ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob | null;
     ...
     */
    merge(spec?: MergeSpec): ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob | null;
     ...
     */
    static updateBatch(objs: Array_Type<ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob>, srcObjs?: Array_Type<ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob> | null>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob>, srcObjs?: Array_Type<ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob> | null>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob>, spec?: TouchSpec): ObjList<ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob>, spec?: MergeSpec): ObjList<ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob> | null;
     ...
     */
    static mergeAll(mergeObj: ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob | null;
     ...
     */
    static beforeCreate(objs: Array_Type<ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob>): ObjList<ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob>): ObjList<ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob>): ObjList<ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob>;
     ...
     */
    static afterCreate(objs: Array_Type<ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob | null;
     ...
     */
    withoutIdentity(): ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob>, callback?: λFunction<ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob | null, ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob | null>): ObjList<ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob>, callback?: λFunction<ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob | null, ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob | null>): Array_Type<ObjError> | null;
     ...
     */
    static doStart(job?: ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob, options?: ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJobOptions): void;
     ...
     */
    static processBatch(batch?: ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJobBatch, job?: ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob, options?: ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJobOptions): void;
     ...
     */
    static allComplete(job: ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob, options?: ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJobOptions): string | null;
     ...
     *           Options the job was run with.
     */
    static failed(job: ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob, status: BatchJobStatus, options?: ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJobOptions): void;
     ...
     *        Batch to schedule.
     */
    scheduleBatch(batch?: ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJobBatch): void;
     ...
     *        Batches to schedule.
     */
    scheduleBatches(batches?: Array_Type<ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJobBatch>): void;
     ...
     */
    static scheduleObjBatch(job?: ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob, objBatch?: ObjBatch, logPrefix?: string): number | null;
