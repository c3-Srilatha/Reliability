// TypeScript definitions for the C3 type ReliabilityOrchestrator.ReliabilityRisk.InferenceJob
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityOrchestrator.ReliabilityRisk.InferenceJob
 */
declare namespace ReliabilityOrchestrator.ReliabilityRisk {
  export interface IInferenceJob {
     ...
     */
    spec: IReliabilityOrchestrator.ReliabilityRisk.Spec.ModelInference;
  }
}
...
declare namespace ReliabilityOrchestrator.ReliabilityRisk {
  export class InferenceJob extends Obj  {
    ...
    withRun(run: IMapReduceRun | null): ReliabilityOrchestrator.ReliabilityRisk.InferenceJob;

    /**
     * previous job executions for this instance
     */
    readonly runs?: Array_Type<MapReduceRun>;
    withRuns(runs: Array_Type<MapReduceRun> | Array<IMapReduceRun> | null): ReliabilityOrchestrator.ReliabilityRisk.InferenceJob;

    /**
     * FOR INTERNAL USE ONLY - Specify options in call to {@link start}.
     */
    readonly options?: Obj;
    withOptions(options: IObj | null): ReliabilityOrchestrator.ReliabilityRisk.InferenceJob;
    ...
    withOnCompleteCallback(onCompleteCallback: IJobBase.Callback | null): ReliabilityOrchestrator.ReliabilityRisk.InferenceJob;
    ...
    withPriority(priority: number | null): ReliabilityOrchestrator.ReliabilityRisk.InferenceJob;
    ...
    withDisabled(disabled: boolean): ReliabilityOrchestrator.ReliabilityRisk.InferenceJob;
    ...
    withMaxConcurrency(maxConcurrency: number | null): ReliabilityOrchestrator.ReliabilityRisk.InferenceJob;
    ...
    withMaxConcurrencyPerNode(maxConcurrencyPerNode: number | null): ReliabilityOrchestrator.ReliabilityRisk.InferenceJob;
    ...
    withRunAsUser(runAsUser: boolean): ReliabilityOrchestrator.ReliabilityRisk.InferenceJob;

    /**
     * Don't set this field in the MapReduce job, set it in the MapReduceOptions when calling `start`.
     */
    readonly nodePool?: string;
    withNodePool(nodePool: string | null): ReliabilityOrchestrator.ReliabilityRisk.InferenceJob;
    ...
    withSkipIfRunning(skipIfRunning: boolean): ReliabilityOrchestrator.ReliabilityRisk.InferenceJob;

    /**
     * Set to between 1 and 5 to enable auto recovery. See {@link invalidation-queues.c3doc Invalidation Queues} for detailed documentation.
     */
    readonly numAutoRecoveryAttempts?: number;
    withNumAutoRecoveryAttempts(numAutoRecoveryAttempts: number | null): ReliabilityOrchestrator.ReliabilityRisk.InferenceJob;
    ...
    withPropagateActionContext(propagateActionContext: boolean): ReliabilityOrchestrator.ReliabilityRisk.InferenceJob;
    ...
    withTargetType(targetType: IType | null): ReliabilityOrchestrator.ReliabilityRisk.InferenceJob;
    ...
    withUseFileSystemForInterVals(useFileSystemForInterVals: boolean): ReliabilityOrchestrator.ReliabilityRisk.InferenceJob;
    ...
    withUseBatchIdsForReadInput(useBatchIdsForReadInput: boolean): ReliabilityOrchestrator.ReliabilityRisk.InferenceJob;
    ...
    withInclude(include: string | null): ReliabilityOrchestrator.ReliabilityRisk.InferenceJob;

    /**
     * optional filter spec
     */
    readonly filter?: string;
    withFilter(filter: string | null): ReliabilityOrchestrator.ReliabilityRisk.InferenceJob;
    ...
    withOrder(order: string | null): ReliabilityOrchestrator.ReliabilityRisk.InferenceJob;
    ...
    withLimit(limit: number | null): ReliabilityOrchestrator.ReliabilityRisk.InferenceJob;
    ...
    withSamplePct(samplePct: number | null): ReliabilityOrchestrator.ReliabilityRisk.InferenceJob;
    ...
    withBatchSize(batchSize: number | null): ReliabilityOrchestrator.ReliabilityRisk.InferenceJob;
    ...
    withSubBatchSize(subBatchSize: number | null): ReliabilityOrchestrator.ReliabilityRisk.InferenceJob;
    ...
    withNumBatches(numBatches: number | null): ReliabilityOrchestrator.ReliabilityRisk.InferenceJob;
    ...
    withAbortOnError(abortOnError: boolean): ReliabilityOrchestrator.ReliabilityRisk.InferenceJob;
    ...
    withTypeIdent(typeIdent: string | null): ReliabilityOrchestrator.ReliabilityRisk.InferenceJob;
     ...
     */
    readonly id: string;
    withId(id: string): ReliabilityOrchestrator.ReliabilityRisk.InferenceJob;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityOrchestrator.ReliabilityRisk.InferenceJob;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): ReliabilityOrchestrator.ReliabilityRisk.InferenceJob;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): ReliabilityOrchestrator.ReliabilityRisk.InferenceJob;
    ...
    withVersion(version: number | null): ReliabilityOrchestrator.ReliabilityRisk.InferenceJob;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): ReliabilityOrchestrator.ReliabilityRisk.InferenceJob;
    ...
    withTargetFilter(targetFilter: IReliabilityAsset | null): ReliabilityOrchestrator.ReliabilityRisk.InferenceJob;

    /**
     * The inference specification defining how the job should execute.
     * This controls asset filtering, model selection, and inference period settings.
     */
    readonly spec: ReliabilityOrchestrator.ReliabilityRisk.Spec.ModelInference;
    withSpec(spec: IReliabilityOrchestrator.ReliabilityRisk.Spec.ModelInference): ReliabilityOrchestrator.ReliabilityRisk.InferenceJob;
     ...
     * @see #toJson
     */
    static fromJson(json: any): ReliabilityOrchestrator.ReliabilityRisk.InferenceJob | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): ReliabilityOrchestrator.ReliabilityRisk.InferenceJob | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): ReliabilityOrchestrator.ReliabilityRisk.InferenceJob | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): ReliabilityOrchestrator.ReliabilityRisk.InferenceJob | null;
     ...
     */
    replaceType(old: Type, new_: Type): ReliabilityOrchestrator.ReliabilityRisk.InferenceJob;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityOrchestrator.ReliabilityRisk.InferenceJob;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityOrchestrator.ReliabilityRisk.InferenceJob;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityOrchestrator.ReliabilityRisk.InferenceJob>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityOrchestrator.ReliabilityRisk.InferenceJob>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityOrchestrator.ReliabilityRisk.InferenceJob;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityOrchestrator.ReliabilityRisk.InferenceJob;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityOrchestrator.ReliabilityRisk.InferenceJob;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): ReliabilityOrchestrator.ReliabilityRisk.InferenceJob;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): ReliabilityOrchestrator.ReliabilityRisk.InferenceJob;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityOrchestrator.ReliabilityRisk.InferenceJob;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityOrchestrator.ReliabilityRisk.InferenceJob;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityOrchestrator.ReliabilityRisk.InferenceJob;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): ReliabilityOrchestrator.ReliabilityRisk.InferenceJob;
     ...
     * @see #removeField
     */
    withoutField(field: string): ReliabilityOrchestrator.ReliabilityRisk.InferenceJob;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): ReliabilityOrchestrator.ReliabilityRisk.InferenceJob;
     ...
     */
    withoutFields(fields: Array_Type<string>): ReliabilityOrchestrator.ReliabilityRisk.InferenceJob;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityOrchestrator.ReliabilityRisk.InferenceJob;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): ReliabilityOrchestrator.ReliabilityRisk.InferenceJob;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityOrchestrator.ReliabilityRisk.InferenceJob;
     ...
     * @see #unsetField
     */
    defaultField(field: string): ReliabilityOrchestrator.ReliabilityRisk.InferenceJob;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): ReliabilityOrchestrator.ReliabilityRisk.InferenceJob;
     ...
     * @see #removeField
     */
    unsetField(field: string): ReliabilityOrchestrator.ReliabilityRisk.InferenceJob;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): ReliabilityOrchestrator.ReliabilityRisk.InferenceJob;
     ...
     * @see #unsetField
     */
    removeField(field: string): ReliabilityOrchestrator.ReliabilityRisk.InferenceJob;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): ReliabilityOrchestrator.ReliabilityRisk.InferenceJob;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityOrchestrator.ReliabilityRisk.InferenceJob;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityOrchestrator.ReliabilityRisk.InferenceJob;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityOrchestrator.ReliabilityRisk.InferenceJob;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityOrchestrator.ReliabilityRisk.InferenceJob;

    mergeJson(json: any): ReliabilityOrchestrator.ReliabilityRisk.InferenceJob;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityOrchestrator.ReliabilityRisk.InferenceJob;
     ...
     */
    sumObj(other: Obj, deep?: boolean): ReliabilityOrchestrator.ReliabilityRisk.InferenceJob;
     ...
     */
    singletonArray(): Array_Type<ReliabilityOrchestrator.ReliabilityRisk.InferenceJob>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityOrchestrator.ReliabilityRisk.InferenceJob> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<ReliabilityOrchestrator.ReliabilityRisk.InferenceJob> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<ReliabilityOrchestrator.ReliabilityRisk.InferenceJob>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<ReliabilityOrchestrator.ReliabilityRisk.InferenceJob> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, ReliabilityOrchestrator.ReliabilityRisk.InferenceJob> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityOrchestrator.ReliabilityRisk.InferenceJob> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<ReliabilityOrchestrator.ReliabilityRisk.InferenceJob>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<ReliabilityOrchestrator.ReliabilityRisk.InferenceJob>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityOrchestrator.ReliabilityRisk.InferenceJob;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityOrchestrator.ReliabilityRisk.InferenceJob;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityOrchestrator.ReliabilityRisk.InferenceJob;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): ReliabilityOrchestrator.ReliabilityRisk.InferenceJob;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityOrchestrator.ReliabilityRisk.InferenceJob;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): ReliabilityOrchestrator.ReliabilityRisk.InferenceJob;
     ...
     * @see #fromString
     */
    static make(s: string): ReliabilityOrchestrator.ReliabilityRisk.InferenceJob | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityOrchestrator.ReliabilityRisk.InferenceJob;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): ReliabilityOrchestrator.ReliabilityRisk.InferenceJob;
     ...
     */
    static cachedEmptyInst(): ReliabilityOrchestrator.ReliabilityRisk.InferenceJob;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityOrchestrator.ReliabilityRisk.InferenceJob> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): ReliabilityOrchestrator.ReliabilityRisk.InferenceJob;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<ReliabilityOrchestrator.ReliabilityRisk.InferenceJob>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<ReliabilityOrchestrator.ReliabilityRisk.InferenceJob>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityOrchestrator.ReliabilityRisk.InferenceJob> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityOrchestrator.ReliabilityRisk.InferenceJob>> | null;
     ...
     */
    get(include?: string): ReliabilityOrchestrator.ReliabilityRisk.InferenceJob | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): ReliabilityOrchestrator.ReliabilityRisk.InferenceJob | null;
     ...
     */
    getMissing(spec: GetMissingSpec): ReliabilityOrchestrator.ReliabilityRisk.InferenceJob;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): ReliabilityOrchestrator.ReliabilityRisk.InferenceJob | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): ReliabilityOrchestrator.ReliabilityRisk.InferenceJob;
     ...
     * @see #toString
     */
    static fromString(s: string): ReliabilityOrchestrator.ReliabilityRisk.InferenceJob | null;
     ...
     */
    create(spec?: UpsertSpec): ReliabilityOrchestrator.ReliabilityRisk.InferenceJob | null;
     ...
     */
    static createBatch(objs: Array_Type<ReliabilityOrchestrator.ReliabilityRisk.InferenceJob>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.ReliabilityRisk.InferenceJob> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<ReliabilityOrchestrator.ReliabilityRisk.InferenceJob>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityOrchestrator.ReliabilityRisk.InferenceJob> | null;
     ...
     */
    update(srcObj?: ReliabilityOrchestrator.ReliabilityRisk.InferenceJob, spec?: UpsertSpec): ReliabilityOrchestrator.ReliabilityRisk.InferenceJob | null;
     ...
     */
    upsert(srcObj?: ReliabilityOrchestrator.ReliabilityRisk.InferenceJob, spec?: UpsertSpec): ReliabilityOrchestrator.ReliabilityRisk.InferenceJob | null;
     ...
     */
    merge(spec?: MergeSpec): ReliabilityOrchestrator.ReliabilityRisk.InferenceJob | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): ReliabilityOrchestrator.ReliabilityRisk.InferenceJob | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): ReliabilityOrchestrator.ReliabilityRisk.InferenceJob | null;
     ...
     */
    static updateBatch(objs: Array_Type<ReliabilityOrchestrator.ReliabilityRisk.InferenceJob>, srcObjs?: Array_Type<ReliabilityOrchestrator.ReliabilityRisk.InferenceJob>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.ReliabilityRisk.InferenceJob> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<ReliabilityOrchestrator.ReliabilityRisk.InferenceJob> | null>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.ReliabilityRisk.InferenceJob> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<ReliabilityOrchestrator.ReliabilityRisk.InferenceJob>, srcObjs?: Array_Type<ReliabilityOrchestrator.ReliabilityRisk.InferenceJob>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.ReliabilityRisk.InferenceJob> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<ReliabilityOrchestrator.ReliabilityRisk.InferenceJob> | null>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.ReliabilityRisk.InferenceJob> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<ReliabilityOrchestrator.ReliabilityRisk.InferenceJob>, spec?: TouchSpec): ObjList<ReliabilityOrchestrator.ReliabilityRisk.InferenceJob> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityOrchestrator.ReliabilityRisk.InferenceJob>, spec?: MergeSpec): ObjList<ReliabilityOrchestrator.ReliabilityRisk.InferenceJob> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityOrchestrator.ReliabilityRisk.InferenceJob>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityOrchestrator.ReliabilityRisk.InferenceJob> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<ReliabilityOrchestrator.ReliabilityRisk.InferenceJob> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityOrchestrator.ReliabilityRisk.InferenceJob> | null;
     ...
     */
    static mergeAll(mergeObj: ReliabilityOrchestrator.ReliabilityRisk.InferenceJob, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: ReliabilityOrchestrator.ReliabilityRisk.InferenceJob, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<ReliabilityOrchestrator.ReliabilityRisk.InferenceJob>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.ReliabilityRisk.InferenceJob> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<ReliabilityOrchestrator.ReliabilityRisk.InferenceJob>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.ReliabilityRisk.InferenceJob> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): ReliabilityOrchestrator.ReliabilityRisk.InferenceJob | null;
     ...
     */
    static beforeCreate(objs: Array_Type<ReliabilityOrchestrator.ReliabilityRisk.InferenceJob>): ObjList<ReliabilityOrchestrator.ReliabilityRisk.InferenceJob>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<ReliabilityOrchestrator.ReliabilityRisk.InferenceJob>): ObjList<ReliabilityOrchestrator.ReliabilityRisk.InferenceJob>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<ReliabilityOrchestrator.ReliabilityRisk.InferenceJob>): ObjList<ReliabilityOrchestrator.ReliabilityRisk.InferenceJob>;
     ...
     */
    static afterCreate(objs: Array_Type<ReliabilityOrchestrator.ReliabilityRisk.InferenceJob>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<ReliabilityOrchestrator.ReliabilityRisk.InferenceJob>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<ReliabilityOrchestrator.ReliabilityRisk.InferenceJob>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityOrchestrator.ReliabilityRisk.InferenceJob>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityOrchestrator.ReliabilityRisk.InferenceJob>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): ReliabilityOrchestrator.ReliabilityRisk.InferenceJob | null;
     ...
     */
    withoutIdentity(): ReliabilityOrchestrator.ReliabilityRisk.InferenceJob | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<ReliabilityOrchestrator.ReliabilityRisk.InferenceJob>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: ReliabilityOrchestrator.ReliabilityRisk.InferenceJob, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<ReliabilityOrchestrator.ReliabilityRisk.InferenceJob>, callback?: λFunction<ReliabilityOrchestrator.ReliabilityRisk.InferenceJob | null, ReliabilityOrchestrator.ReliabilityRisk.InferenceJob | null>): ObjList<ReliabilityOrchestrator.ReliabilityRisk.InferenceJob>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<ReliabilityOrchestrator.ReliabilityRisk.InferenceJob>, callback?: λFunction<ReliabilityOrchestrator.ReliabilityRisk.InferenceJob | null, ReliabilityOrchestrator.ReliabilityRisk.InferenceJob | null>): Array_Type<ObjError> | null;
     ...
     *         key type.
     */
    static map(batch?: number, objs?: Array_Type<ReliabilityAsset>, job?: MapReduce<ReliabilityAsset, string, , >, subBatch?: number): Map_Type<string, > | null;
     ...
     */
    static reduce(outKey?: string, interValues?: Array_Type<>, job?: MapReduce<ReliabilityAsset, string, , >):  | Array_Type<> | null;
     ...
     */
    static mapCompleted(job?: MapReduce<ReliabilityAsset, string, , >): void;
     ...
     */
    static completed(job?: MapReduce<ReliabilityAsset, string, , >): string | null;
     ...
     */
    static failed(job: MapReduce<ReliabilityAsset, string, , >, status: MapReduceStatus, options?: MapReduceOptions): void;
     ...
     */
    results(limit?: number = '10000'): Map_Type<string,  | Array_Type<>> | null;
