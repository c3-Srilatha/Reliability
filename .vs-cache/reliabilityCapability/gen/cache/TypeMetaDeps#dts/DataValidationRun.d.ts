// TypeScript definitions for the C3 type DataValidationRun

/**
 * @inheritdoc
 *
 * @remarks this represents a value passed to a method that expects an instance of DataValidationRun
 */
declare interface IDataValidationRun {
   ...
   */
  rootRuleset: IDataValidationRuleset;
   ...
   */
  results?: Array_Type<DataValidationResult> | Array<IDataValidationResult>;

  /**
   * The results found by this run that are persisted.
   * Please use {DataValidationRun#getResults} to get the results from a run.
   */
  persistedResults?: Array_Type<DataValidationPersistedResult> | Array<IDataValidationPersistedResult>;
   ...
   */
  rulesetResults?: Array_Type<DataValidationRulesetResult> | Array<IDataValidationRulesetResult>;

  /**
   * The ruleset results found by this run that are persisted.
   * Please use {DataValidationRun#getRulesetResults} to get the results from a run.
   */
  persistedRulesetResults?: Array_Type<DataValidationPersistedRulesetResult> | Array<IDataValidationPersistedRulesetResult>;
   ...
   */
  job?: IDataValidationMapReduceJob | IDataValidationBatchJob;
 ...
 */
declare class DataValidationRun extends Obj  {
   ...
   */
  readonly id: string;
  withId(id: string): DataValidationRun;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): DataValidationRun;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): DataValidationRun;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): DataValidationRun;
  ...
  withVersion(version: number | null): DataValidationRun;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): DataValidationRun;

  /**
   * @inheritdoc
   */
  readonly facilityFilterPaths?: Array_Type<string>;
  withFacilityFilterPaths(facilityFilterPaths: Array_Type<string> | Array<string> | null): DataValidationRun;

  /**
   * The timestamp at which this validation run was executed.
   */
  readonly timestamp: DateTime;
  withTimestamp(timestamp: DateTime | Date | string): DataValidationRun;

  /**
   * The root ruleset whose rules and all descendant rules were run.
   */
  readonly rootRuleset: DataValidationRuleset;
  withRootRuleset(rootRuleset: IDataValidationRuleset): DataValidationRun;

  /**
   * The {@link DataValidationSubject} this run is associated with. If not set, the run is one per ruleset, rather than one per subject.
   */
  readonly subject?: DataValidationSubject;
  withSubject(subject: IDataValidationSubject | null): DataValidationRun;

  /**
   * The args passed into each rule function.
   */
  readonly args?: Map_Type<string, any>;
  withArgs(args: Map_Type<string, any> | {[key: string]: any} | null): DataValidationRun;

  /**
   * The results generated by this run that are not persisted.
   * Please use {DataValidationRun#getResults} to get the results from a run.
   */
  readonly results?: Array_Type<DataValidationResult>;
  withResults(results: Array_Type<DataValidationResult> | Array<IDataValidationResult> | null): DataValidationRun;

  /**
   * The results found by this run that are persisted.
   * Please use {DataValidationRun#getResults} to get the results from a run.
   */
  readonly persistedResults?: Array_Type<DataValidationPersistedResult>;
  withPersistedResults(persistedResults: Array_Type<DataValidationPersistedResult> | Array<IDataValidationPersistedResult> | null): DataValidationRun;

  /**
   * The ruleset results found by this run that are not persisted.
   * Please use {DataValidationRun#getRulesetResults} to get the results from a run.
   */
  readonly rulesetResults?: Array_Type<DataValidationRulesetResult>;
  withRulesetResults(rulesetResults: Array_Type<DataValidationRulesetResult> | Array<IDataValidationRulesetResult> | null): DataValidationRun;

  /**
   * The ruleset results found by this run that are persisted.
   * Please use {DataValidationRun#getRulesetResults} to get the results from a run.
   */
  readonly persistedRulesetResults?: Array_Type<DataValidationPersistedRulesetResult>;
  withPersistedRulesetResults(persistedRulesetResults: Array_Type<DataValidationPersistedRulesetResult> | Array<IDataValidationPersistedRulesetResult> | null): DataValidationRun;

  /**
   * Number of data violations found by this run.
   */
  readonly numViolations?: number;
  withNumViolations(numViolations: number | null): DataValidationRun;

  /**
   * The batch job or map reduce used to generate results, if any.
   */
  readonly job?: DataValidationMapReduceJob | DataValidationBatchJob;
  withJob(job: IDataValidationMapReduceJob | IDataValidationBatchJob | null): DataValidationRun;

  /**
   * The jobId for the current job. It is used as a foreing key on {@link DataValidationMapReduceJob} or {@link DataValidationBatchJob}.
   */
  readonly jobId?: string;
  withJobId(jobId: string | null): DataValidationRun;

  /**
   * The error message, if the run failed.
   */
  readonly jobError?: string;
  withJobError(jobError: string | null): DataValidationRun;

  /**
   * The status of this run.
   */
  readonly runStatus: string;
  withRunStatus(runStatus: string): DataValidationRun;

  /**
   * The status of the {@link DataValidationRuleset} rules ouput.
   */
  readonly validationStatus?: DataValidationStatus;
  withValidationStatus(validationStatus: IDataValidationStatus | null): DataValidationRun;

  /**
   * An optional parent {@link ReliabilityAsset} to filter down the scope of entities validated for some rules.
   */
  readonly parentAsset?: ReliabilityAsset;
  withParentAsset(parentAsset: IReliabilityAsset | null): DataValidationRun;

  /**
   * A translated representation of {@link DataValidationRun#runStatus} to be used in the UI.
   */
  readonly displayStatus?: string;
  withDisplayStatus(displayStatus: string | null): DataValidationRun;
   ...
   * @see #toJson
   */
  static fromJson(json: any): DataValidationRun | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): DataValidationRun | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): DataValidationRun | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): DataValidationRun | null;
   ...
   */
  replaceType(old: Type, new_: Type): DataValidationRun;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): DataValidationRun;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): DataValidationRun;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<DataValidationRun>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<DataValidationRun>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): DataValidationRun;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DataValidationRun;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DataValidationRun;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): DataValidationRun;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): DataValidationRun;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): DataValidationRun;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): DataValidationRun;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): DataValidationRun;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): DataValidationRun;
   ...
   * @see #removeField
   */
  withoutField(field: string): DataValidationRun;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): DataValidationRun;
   ...
   */
  withoutFields(fields: Array_Type<string>): DataValidationRun;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): DataValidationRun;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): DataValidationRun;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): DataValidationRun;
   ...
   * @see #unsetField
   */
  defaultField(field: string): DataValidationRun;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): DataValidationRun;
   ...
   * @see #removeField
   */
  unsetField(field: string): DataValidationRun;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): DataValidationRun;
   ...
   * @see #unsetField
   */
  removeField(field: string): DataValidationRun;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): DataValidationRun;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): DataValidationRun;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): DataValidationRun;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): DataValidationRun;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): DataValidationRun;

  mergeJson(json: any): DataValidationRun;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): DataValidationRun;
   ...
   */
  sumObj(other: Obj, deep?: boolean): DataValidationRun;
   ...
   */
  singletonArray(): Array_Type<DataValidationRun>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<DataValidationRun> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<DataValidationRun> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<DataValidationRun>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<DataValidationRun> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, DataValidationRun> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, DataValidationRun> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<DataValidationRun>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<DataValidationRun>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): DataValidationRun;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): DataValidationRun;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): DataValidationRun;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): DataValidationRun;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): DataValidationRun;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): DataValidationRun;
   ...
   * @see #fromString
   */
  static make(s: string): DataValidationRun | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): DataValidationRun;
   ...
   */
  static cachedEmptyInst(): DataValidationRun;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<DataValidationRun> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): DataValidationRun;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<DataValidationRun>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<DataValidationRun>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<DataValidationRun> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<DataValidationRun>> | null;
   ...
   */
  get(include?: string): DataValidationRun | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): DataValidationRun | null;
   ...
   */
  getMissing(spec: GetMissingSpec): DataValidationRun;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): DataValidationRun | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): DataValidationRun;
   ...
   * @see #toString
   */
  static fromString(s: string): DataValidationRun | null;
   ...
   */
  create(spec?: UpsertSpec): DataValidationRun | null;
   ...
   */
  static createBatch(objs: Array_Type<DataValidationRun>, spec?: UpsertSpec): ObjList<DataValidationRun> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<DataValidationRun>, spec?: CreateBatchObjStreamSpec): ObjList<DataValidationRun> | null;
   ...
   */
  update(srcObj?: DataValidationRun, spec?: UpsertSpec): DataValidationRun | null;
   ...
   */
  upsert(srcObj?: DataValidationRun, spec?: UpsertSpec): DataValidationRun | null;
   ...
   */
  merge(spec?: MergeSpec): DataValidationRun | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): DataValidationRun | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): DataValidationRun | null;
   ...
   */
  static updateBatch(objs: Array_Type<DataValidationRun>, srcObjs?: Array_Type<DataValidationRun>, spec?: UpsertSpec): ObjList<DataValidationRun> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<DataValidationRun> | null>, spec?: UpsertSpec): ObjList<DataValidationRun> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<DataValidationRun>, srcObjs?: Array_Type<DataValidationRun>, spec?: UpsertSpec): ObjList<DataValidationRun> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<DataValidationRun> | null>, spec?: UpsertSpec): ObjList<DataValidationRun> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<DataValidationRun>, spec?: TouchSpec): ObjList<DataValidationRun> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<DataValidationRun>, spec?: MergeSpec): ObjList<DataValidationRun> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<DataValidationRun>, mergeInclude: string, spec?: MergeSpec): ObjList<DataValidationRun> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<DataValidationRun> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<DataValidationRun> | null;
   ...
   */
  static mergeAll(mergeObj: DataValidationRun, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: DataValidationRun, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<DataValidationRun>, spec?: UpsertSpec): ObjList<DataValidationRun> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<DataValidationRun>, spec?: UpsertSpec): ObjList<DataValidationRun> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): DataValidationRun | null;
   ...
   * @inheritdoc
   */
  static beforeCreate(objs: Array_Type<DataValidationRun>): ObjList<DataValidationRun>;
   ...
   */
  static beforeUpdate(objs: Array_Type<DataValidationRun>): ObjList<DataValidationRun>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<DataValidationRun>): ObjList<DataValidationRun>;
   ...
   */
  static afterCreate(objs: Array_Type<DataValidationRun>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<DataValidationRun>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<DataValidationRun>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<DataValidationRun>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<DataValidationRun>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): DataValidationRun | null;
   ...
   */
  withoutIdentity(): DataValidationRun | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<DataValidationRun>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: DataValidationRun, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<DataValidationRun>, callback?: λFunction<DataValidationRun | null, DataValidationRun | null>): ObjList<DataValidationRun>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<DataValidationRun>, callback?: λFunction<DataValidationRun | null, DataValidationRun | null>): Array_Type<ObjError> | null;
   ...
   */
  getResults(include?: string): Array_Type<DataValidationResult> | null;
   ...
   */
  getRulesetResults(include?: string): Array_Type<DataValidationRulesetResult> | null;

  /**
   * A function to set the {@link DataValidationRun#runStatus} of the run.
   */
  setRunStatus(status: string, errorMessage?: string): void;
   ...
   */
  generateResult(persistResults?: boolean): void;
   ...
   *     Flag to determine whether results should be persisted.
   */
  updateRulesetResult(ruleset: DataValidationRuleset, persistResults?: boolean): void;
}
