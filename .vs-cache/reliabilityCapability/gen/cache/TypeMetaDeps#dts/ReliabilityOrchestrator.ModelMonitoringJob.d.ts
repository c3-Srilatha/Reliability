// TypeScript definitions for the C3 type ReliabilityOrchestrator.ModelMonitoringJob
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityOrchestrator.ModelMonitoringJob
 */
declare namespace ReliabilityOrchestrator {
  export interface IModelMonitoringJob {
 ...
 */
declare namespace ReliabilityOrchestrator {
  export class ModelMonitoringJob extends Obj  {

    /**
     * The array of configurations this job run must execute.
     */
    readonly jobSpecs: Array_Type<ReliabilityOrchestrator.ModelMonitoringJobSpec>;
    withJobSpecs(jobSpecs: Array_Type<ReliabilityOrchestrator.ModelMonitoringJobSpec> | Array<IReliabilityOrchestrator.ModelMonitoringJobSpec>): ReliabilityOrchestrator.ModelMonitoringJob;
     ...
     */
    readonly id: string;
    withId(id: string): ReliabilityOrchestrator.ModelMonitoringJob;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityOrchestrator.ModelMonitoringJob;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): ReliabilityOrchestrator.ModelMonitoringJob;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): ReliabilityOrchestrator.ModelMonitoringJob;
    ...
    withVersion(version: number | null): ReliabilityOrchestrator.ModelMonitoringJob;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): ReliabilityOrchestrator.ModelMonitoringJob;
     ...
     * @see #toJson
     */
    static fromJson(json: any): ReliabilityOrchestrator.ModelMonitoringJob | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): ReliabilityOrchestrator.ModelMonitoringJob | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): ReliabilityOrchestrator.ModelMonitoringJob | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): ReliabilityOrchestrator.ModelMonitoringJob | null;
     ...
     */
    replaceType(old: Type, new_: Type): ReliabilityOrchestrator.ModelMonitoringJob;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityOrchestrator.ModelMonitoringJob;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityOrchestrator.ModelMonitoringJob;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityOrchestrator.ModelMonitoringJob>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityOrchestrator.ModelMonitoringJob>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityOrchestrator.ModelMonitoringJob;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityOrchestrator.ModelMonitoringJob;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityOrchestrator.ModelMonitoringJob;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): ReliabilityOrchestrator.ModelMonitoringJob;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): ReliabilityOrchestrator.ModelMonitoringJob;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityOrchestrator.ModelMonitoringJob;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityOrchestrator.ModelMonitoringJob;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityOrchestrator.ModelMonitoringJob;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): ReliabilityOrchestrator.ModelMonitoringJob;
     ...
     * @see #removeField
     */
    withoutField(field: string): ReliabilityOrchestrator.ModelMonitoringJob;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): ReliabilityOrchestrator.ModelMonitoringJob;
     ...
     */
    withoutFields(fields: Array_Type<string>): ReliabilityOrchestrator.ModelMonitoringJob;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityOrchestrator.ModelMonitoringJob;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): ReliabilityOrchestrator.ModelMonitoringJob;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityOrchestrator.ModelMonitoringJob;
     ...
     * @see #unsetField
     */
    defaultField(field: string): ReliabilityOrchestrator.ModelMonitoringJob;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): ReliabilityOrchestrator.ModelMonitoringJob;
     ...
     * @see #removeField
     */
    unsetField(field: string): ReliabilityOrchestrator.ModelMonitoringJob;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): ReliabilityOrchestrator.ModelMonitoringJob;
     ...
     * @see #unsetField
     */
    removeField(field: string): ReliabilityOrchestrator.ModelMonitoringJob;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): ReliabilityOrchestrator.ModelMonitoringJob;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityOrchestrator.ModelMonitoringJob;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityOrchestrator.ModelMonitoringJob;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityOrchestrator.ModelMonitoringJob;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityOrchestrator.ModelMonitoringJob;

    mergeJson(json: any): ReliabilityOrchestrator.ModelMonitoringJob;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityOrchestrator.ModelMonitoringJob;
     ...
     */
    sumObj(other: Obj, deep?: boolean): ReliabilityOrchestrator.ModelMonitoringJob;
     ...
     */
    singletonArray(): Array_Type<ReliabilityOrchestrator.ModelMonitoringJob>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityOrchestrator.ModelMonitoringJob> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<ReliabilityOrchestrator.ModelMonitoringJob> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<ReliabilityOrchestrator.ModelMonitoringJob>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<ReliabilityOrchestrator.ModelMonitoringJob> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, ReliabilityOrchestrator.ModelMonitoringJob> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityOrchestrator.ModelMonitoringJob> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<ReliabilityOrchestrator.ModelMonitoringJob>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<ReliabilityOrchestrator.ModelMonitoringJob>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityOrchestrator.ModelMonitoringJob;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityOrchestrator.ModelMonitoringJob;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityOrchestrator.ModelMonitoringJob;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): ReliabilityOrchestrator.ModelMonitoringJob;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityOrchestrator.ModelMonitoringJob;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): ReliabilityOrchestrator.ModelMonitoringJob;
     ...
     * @see #fromString
     */
    static make(s: string): ReliabilityOrchestrator.ModelMonitoringJob | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityOrchestrator.ModelMonitoringJob;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): ReliabilityOrchestrator.ModelMonitoringJob;
     ...
     */
    static cachedEmptyInst(): ReliabilityOrchestrator.ModelMonitoringJob;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityOrchestrator.ModelMonitoringJob> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): ReliabilityOrchestrator.ModelMonitoringJob;
     ...
     */
    doStart(options?: ReliabilityOrchestrator.JobOptions, additionalParams?: Map_Type<string, any>): Pair<ReliabilityOrchestrator.ModelMonitoringJobRun, MlOperationRun<ReliabilityOrchestrator.ModelMonitoringJobRun>>;
     ...
     */
    start(options?: ReliabilityOrchestrator.JobOptions, additionalParams?: Map_Type<string, any>): MlOperationRun<ReliabilityOrchestrator.ModelMonitoringJobRun>;

    /**
     * @return The concrete {@link ReliabilityOrchestrator.JobRun} subType.
     */
    static jobRunType(): Type<<ReliabilityOrchestrator.ModelMonitoringJobRun>> | null;

    /**
     * @return the concrete {@link ReliabilityOrchestrator.JobSpec} subType.
     */
    static jobSpecType(): Type<<ReliabilityOrchestrator.ModelMonitoringJobSpec>> | null;
     ...
     */
    fetchJobRunForOperationRun(run: MlOperationRun<any>): ReliabilityOrchestrator.ModelMonitoringJobRun | null;
     ...
     */
    fetchLatestJobRun(): ReliabilityOrchestrator.ModelMonitoringJobRun | null;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<ReliabilityOrchestrator.ModelMonitoringJob>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<ReliabilityOrchestrator.ModelMonitoringJob>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityOrchestrator.ModelMonitoringJob> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityOrchestrator.ModelMonitoringJob>> | null;
     ...
     */
    get(include?: string): ReliabilityOrchestrator.ModelMonitoringJob | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): ReliabilityOrchestrator.ModelMonitoringJob | null;
     ...
     */
    getMissing(spec: GetMissingSpec): ReliabilityOrchestrator.ModelMonitoringJob;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): ReliabilityOrchestrator.ModelMonitoringJob | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): ReliabilityOrchestrator.ModelMonitoringJob;
     ...
     * @see #toString
     */
    static fromString(s: string): ReliabilityOrchestrator.ModelMonitoringJob | null;
     ...
     */
    create(spec?: UpsertSpec): ReliabilityOrchestrator.ModelMonitoringJob | null;
     ...
     */
    static createBatch(objs: Array_Type<ReliabilityOrchestrator.ModelMonitoringJob>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.ModelMonitoringJob> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<ReliabilityOrchestrator.ModelMonitoringJob>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityOrchestrator.ModelMonitoringJob> | null;
     ...
     */
    update(srcObj?: ReliabilityOrchestrator.ModelMonitoringJob, spec?: UpsertSpec): ReliabilityOrchestrator.ModelMonitoringJob | null;
     ...
     */
    upsert(srcObj?: ReliabilityOrchestrator.ModelMonitoringJob, spec?: UpsertSpec): ReliabilityOrchestrator.ModelMonitoringJob | null;
     ...
     */
    merge(spec?: MergeSpec): ReliabilityOrchestrator.ModelMonitoringJob | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): ReliabilityOrchestrator.ModelMonitoringJob | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): ReliabilityOrchestrator.ModelMonitoringJob | null;
     ...
     */
    static updateBatch(objs: Array_Type<ReliabilityOrchestrator.ModelMonitoringJob>, srcObjs?: Array_Type<ReliabilityOrchestrator.ModelMonitoringJob>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.ModelMonitoringJob> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<ReliabilityOrchestrator.ModelMonitoringJob> | null>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.ModelMonitoringJob> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<ReliabilityOrchestrator.ModelMonitoringJob>, srcObjs?: Array_Type<ReliabilityOrchestrator.ModelMonitoringJob>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.ModelMonitoringJob> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<ReliabilityOrchestrator.ModelMonitoringJob> | null>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.ModelMonitoringJob> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<ReliabilityOrchestrator.ModelMonitoringJob>, spec?: TouchSpec): ObjList<ReliabilityOrchestrator.ModelMonitoringJob> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityOrchestrator.ModelMonitoringJob>, spec?: MergeSpec): ObjList<ReliabilityOrchestrator.ModelMonitoringJob> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityOrchestrator.ModelMonitoringJob>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityOrchestrator.ModelMonitoringJob> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<ReliabilityOrchestrator.ModelMonitoringJob> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityOrchestrator.ModelMonitoringJob> | null;
     ...
     */
    static mergeAll(mergeObj: ReliabilityOrchestrator.ModelMonitoringJob, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: ReliabilityOrchestrator.ModelMonitoringJob, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<ReliabilityOrchestrator.ModelMonitoringJob>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.ModelMonitoringJob> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<ReliabilityOrchestrator.ModelMonitoringJob>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.ModelMonitoringJob> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): ReliabilityOrchestrator.ModelMonitoringJob | null;
     ...
     */
    static beforeCreate(objs: Array_Type<ReliabilityOrchestrator.ModelMonitoringJob>): ObjList<ReliabilityOrchestrator.ModelMonitoringJob>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<ReliabilityOrchestrator.ModelMonitoringJob>): ObjList<ReliabilityOrchestrator.ModelMonitoringJob>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<ReliabilityOrchestrator.ModelMonitoringJob>): ObjList<ReliabilityOrchestrator.ModelMonitoringJob>;
     ...
     */
    static afterCreate(objs: Array_Type<ReliabilityOrchestrator.ModelMonitoringJob>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<ReliabilityOrchestrator.ModelMonitoringJob>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<ReliabilityOrchestrator.ModelMonitoringJob>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityOrchestrator.ModelMonitoringJob>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityOrchestrator.ModelMonitoringJob>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): ReliabilityOrchestrator.ModelMonitoringJob | null;
     ...
     */
    withoutIdentity(): ReliabilityOrchestrator.ModelMonitoringJob | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<ReliabilityOrchestrator.ModelMonitoringJob>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: ReliabilityOrchestrator.ModelMonitoringJob, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<ReliabilityOrchestrator.ModelMonitoringJob>, callback?: λFunction<ReliabilityOrchestrator.ModelMonitoringJob | null, ReliabilityOrchestrator.ModelMonitoringJob | null>): ObjList<ReliabilityOrchestrator.ModelMonitoringJob>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<ReliabilityOrchestrator.ModelMonitoringJob>, callback?: λFunction<ReliabilityOrchestrator.ModelMonitoringJob | null, ReliabilityOrchestrator.ModelMonitoringJob | null>): Array_Type<ObjError> | null;
