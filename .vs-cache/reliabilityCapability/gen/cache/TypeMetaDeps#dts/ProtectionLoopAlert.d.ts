// TypeScript definitions for the C3 type ProtectionLoopAlert

/**
 * Type that is created when a percentage of sensors fails and belongs to the same {@link ProtectionLoop} type.
 *
 * @remarks this represents a value passed to a method that expects an instance of ProtectionLoopAlert
 */
declare interface IProtectionLoopAlert {
   ...
   */
  currentState?: IProtectionLoopAlertState;

  /**
   * A collection of the states this {@link StateMachine} has passed through.
   */
  stateHistories?: Array_Type<ProtectionLoopAlertHistory> | Array<IProtectionLoopAlertHistory>;

  /**
   * Transitions available from the current state
   */
  transitions?: Array_Type<ProtectionLoopAlertTransition> | Array<IProtectionLoopAlertTransition>;

  /**
   * Calc field to get the current state history
   */
  currentStateHistory?: IProtectionLoopAlertHistory;

  /**
   * The parent {@link ProtectionLoop} this alert is on. TODO: REL-4645 remove field once dataAlerting migrated.
   */
  parent: IProtectionLoop;
 ...
 */
declare class ProtectionLoopAlert extends Obj  {
   ...
   */
  readonly id: string;
  withId(id: string): ProtectionLoopAlert;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ProtectionLoopAlert;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): ProtectionLoopAlert;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): ProtectionLoopAlert;
  ...
  withVersion(version: number | null): ProtectionLoopAlert;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): ProtectionLoopAlert;

  /**
   * A stored calc field representing the current state - uses a {@link StateMachineHistory} to keep track.
   */
  readonly currentState?: ProtectionLoopAlertState;
  withCurrentState(currentState: IProtectionLoopAlertState | null): ProtectionLoopAlert;

  /**
   * A collection of the states this {@link StateMachine} has passed through.
   */
  readonly stateHistories?: Array_Type<ProtectionLoopAlertHistory>;
  withStateHistories(stateHistories: Array_Type<ProtectionLoopAlertHistory> | Array<IProtectionLoopAlertHistory> | null): ProtectionLoopAlert;

  /**
   * Transitions available from the current state
   */
  readonly transitions?: Array_Type<ProtectionLoopAlertTransition>;
  withTransitions(transitions: Array_Type<ProtectionLoopAlertTransition> | Array<IProtectionLoopAlertTransition> | null): ProtectionLoopAlert;

  /**
   * Calc field to get the current state history
   */
  readonly currentStateHistory?: ProtectionLoopAlertHistory;
  withCurrentStateHistory(currentStateHistory: IProtectionLoopAlertHistory | null): ProtectionLoopAlert;

  /**
   * The parent {@link ProtectionLoop} this alert is on. TODO: REL-4645 remove field once dataAlerting migrated.
   */
  readonly parent: ProtectionLoop;
  withParent(parent: IProtectionLoop): ProtectionLoopAlert;

  /**
   * The time the alert was triggered. TODO: REL-4645 remove field once dataAlerting migrated.
   */
  readonly timestamp: DateTime;
  withTimestamp(timestamp: DateTime | Date | string): ProtectionLoopAlert;

  /**
   * Current risk Status {@link ProtectionLoopRiskStatus}
   */
  readonly risk?: string;
  withRisk(risk: string | null): ProtectionLoopAlert;

  /**
   * Unhealthy sensors in the protection loop.
   * {@link ProtectionLoop}
   */
  readonly unhealthySensors?: Array_Type<Sensor>;
  withUnhealthySensors(unhealthySensors: Array_Type<Sensor> | Array<ISensor> | null): ProtectionLoopAlert;

  /**
   * The evaluation of protection loop health which led to this alert.
   */
  readonly healthStatus?: ProtectionLoopHealthHistory;
  withHealthStatus(healthStatus: IProtectionLoopHealthHistory | null): ProtectionLoopAlert;

  /**
   * The trigger value that made this alert. TODO: REL-4645 remove field once dataAlerting migrated.
   */
  readonly triggerValue?: Dimension;
  withTriggerValue(triggerValue: IDimension | null): ProtectionLoopAlert;
   ...
   * @see #toJson
   */
  static fromJson(json: any): ProtectionLoopAlert | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): ProtectionLoopAlert | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): ProtectionLoopAlert | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): ProtectionLoopAlert | null;
   ...
   */
  replaceType(old: Type, new_: Type): ProtectionLoopAlert;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ProtectionLoopAlert;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ProtectionLoopAlert;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ProtectionLoopAlert>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ProtectionLoopAlert>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ProtectionLoopAlert;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ProtectionLoopAlert;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ProtectionLoopAlert;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ProtectionLoopAlert;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ProtectionLoopAlert;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ProtectionLoopAlert;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ProtectionLoopAlert;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ProtectionLoopAlert;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ProtectionLoopAlert;
   ...
   * @see #removeField
   */
  withoutField(field: string): ProtectionLoopAlert;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): ProtectionLoopAlert;
   ...
   */
  withoutFields(fields: Array_Type<string>): ProtectionLoopAlert;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): ProtectionLoopAlert;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ProtectionLoopAlert;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ProtectionLoopAlert;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ProtectionLoopAlert;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ProtectionLoopAlert;
   ...
   * @see #removeField
   */
  unsetField(field: string): ProtectionLoopAlert;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ProtectionLoopAlert;
   ...
   * @see #unsetField
   */
  removeField(field: string): ProtectionLoopAlert;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ProtectionLoopAlert;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ProtectionLoopAlert;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): ProtectionLoopAlert;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ProtectionLoopAlert;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ProtectionLoopAlert;

  mergeJson(json: any): ProtectionLoopAlert;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ProtectionLoopAlert;
   ...
   */
  sumObj(other: Obj, deep?: boolean): ProtectionLoopAlert;
   ...
   */
  singletonArray(): Array_Type<ProtectionLoopAlert>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<ProtectionLoopAlert> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ProtectionLoopAlert> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<ProtectionLoopAlert>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ProtectionLoopAlert> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, ProtectionLoopAlert> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ProtectionLoopAlert> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ProtectionLoopAlert>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ProtectionLoopAlert>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ProtectionLoopAlert;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ProtectionLoopAlert;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ProtectionLoopAlert;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ProtectionLoopAlert;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ProtectionLoopAlert;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ProtectionLoopAlert;
   ...
   * @see #fromString
   */
  static make(s: string): ProtectionLoopAlert | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ProtectionLoopAlert;
   ...
   */
  static cachedEmptyInst(): ProtectionLoopAlert;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<ProtectionLoopAlert> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): ProtectionLoopAlert;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<ProtectionLoopAlert>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<ProtectionLoopAlert>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<ProtectionLoopAlert> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ProtectionLoopAlert>> | null;
   ...
   */
  static evalFeatureSetBatch(batch: Array_Type<ProtectionLoopAlert>, featureSet: Feature.Set, spec?: EvalFeatureSpec): Data | null;
   ...
   * ```
   */
  static evalFeaturesBatch(batch: Array_Type<ProtectionLoopAlert>, features: Array_Type<string>, spec?: EvalFeaturesSpec): Data | null;
   ...
   */
  get(include?: string): ProtectionLoopAlert | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): ProtectionLoopAlert | null;
   ...
   */
  getMissing(spec: GetMissingSpec): ProtectionLoopAlert;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): ProtectionLoopAlert | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): ProtectionLoopAlert;
   ...
   * @see #toString
   */
  static fromString(s: string): ProtectionLoopAlert | null;
   ...
   */
  create(spec?: UpsertSpec): ProtectionLoopAlert | null;
   ...
   */
  static createBatch(objs: Array_Type<ProtectionLoopAlert>, spec?: UpsertSpec): ObjList<ProtectionLoopAlert> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<ProtectionLoopAlert>, spec?: CreateBatchObjStreamSpec): ObjList<ProtectionLoopAlert> | null;
   ...
   */
  update(srcObj?: ProtectionLoopAlert, spec?: UpsertSpec): ProtectionLoopAlert | null;
   ...
   */
  upsert(srcObj?: ProtectionLoopAlert, spec?: UpsertSpec): ProtectionLoopAlert | null;
   ...
   */
  merge(spec?: MergeSpec): ProtectionLoopAlert | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): ProtectionLoopAlert | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): ProtectionLoopAlert | null;
   ...
   */
  static updateBatch(objs: Array_Type<ProtectionLoopAlert>, srcObjs?: Array_Type<ProtectionLoopAlert>, spec?: UpsertSpec): ObjList<ProtectionLoopAlert> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<ProtectionLoopAlert> | null>, spec?: UpsertSpec): ObjList<ProtectionLoopAlert> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<ProtectionLoopAlert>, srcObjs?: Array_Type<ProtectionLoopAlert>, spec?: UpsertSpec): ObjList<ProtectionLoopAlert> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<ProtectionLoopAlert> | null>, spec?: UpsertSpec): ObjList<ProtectionLoopAlert> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<ProtectionLoopAlert>, spec?: TouchSpec): ObjList<ProtectionLoopAlert> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ProtectionLoopAlert>, spec?: MergeSpec): ObjList<ProtectionLoopAlert> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ProtectionLoopAlert>, mergeInclude: string, spec?: MergeSpec): ObjList<ProtectionLoopAlert> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<ProtectionLoopAlert> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ProtectionLoopAlert> | null;
   ...
   */
  static mergeAll(mergeObj: ProtectionLoopAlert, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: ProtectionLoopAlert, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<ProtectionLoopAlert>, spec?: UpsertSpec): ObjList<ProtectionLoopAlert> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<ProtectionLoopAlert>, spec?: UpsertSpec): ObjList<ProtectionLoopAlert> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): ProtectionLoopAlert | null;
   ...
   */
  static beforeCreate(objs: Array_Type<ProtectionLoopAlert>): ObjList<ProtectionLoopAlert>;
   ...
   */
  static beforeUpdate(objs: Array_Type<ProtectionLoopAlert>): ObjList<ProtectionLoopAlert>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<ProtectionLoopAlert>): ObjList<ProtectionLoopAlert>;

  /**
   * See {@link PersistableWritable#afterCreate}
   */
  static afterCreate(objs: Array_Type<ProtectionLoopAlert>): Array_Type<ObjError> | null;
   ...
   */
  static afterUpdate(objs: Array_Type<ProtectionLoopAlert>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<ProtectionLoopAlert>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<ProtectionLoopAlert>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ProtectionLoopAlert>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): ProtectionLoopAlert | null;
   ...
   */
  withoutIdentity(): ProtectionLoopAlert | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<ProtectionLoopAlert>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: ProtectionLoopAlert, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<ProtectionLoopAlert>, callback?: λFunction<ProtectionLoopAlert | null, ProtectionLoopAlert | null>): ObjList<ProtectionLoopAlert>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<ProtectionLoopAlert>, callback?: λFunction<ProtectionLoopAlert | null, ProtectionLoopAlert | null>): Array_Type<ObjError> | null;
   ...
   */
  static transitionBatch(stateMachines: Array_Type<ProtectionLoopAlert>, toState: ProtectionLoopAlertState, retry?: number, stateHistoryParams?: ProtectionLoopAlertHistory): Array_Type<StateMachineTransitionStatus<ProtectionLoopAlertHistory, ProtectionLoopAlertTransition>>;
   ...
   */
  transition(toState: ProtectionLoopAlertState, testOnly?: boolean, stateHistoryParams?: ProtectionLoopAlertHistory): StateMachineTransitionStatus<ProtectionLoopAlertHistory, ProtectionLoopAlertTransition>;
   ...
   */
  checkTransition(toState: ProtectionLoopAlertState): boolean;
   ...
   */
  possibleStates(): Array_Type<ProtectionLoopAlertState> | null;

  /**
   * Return list of all states in the {@link StateMachine}.
   */
  static allStates(): Array_Type<ProtectionLoopAlertState> | null;

  /**
   * Return list of transitions possible from the current state given the current user permissions and current conditions.
   */
  possibleTransitions(): Array_Type<ProtectionLoopAlertTransition> | null;
   ...
   */
  static allTransitions(fromState?: ProtectionLoopAlertState, toState?: ProtectionLoopAlertState): Array_Type<ProtectionLoopAlertTransition> | null;
   ...
   */
  forceTransition(toState: ProtectionLoopAlertState, stateHistoryParams?: ProtectionLoopAlertHistory): boolean;
   ...
   */
  static forceTransitionBatch(stateMachines: Array_Type<ProtectionLoopAlert>, toState: ProtectionLoopAlertState, stateHistoryParams?: ProtectionLoopAlertHistory): Map_Type<string, boolean>;
   ...
   */
  static stateRecoverBatch(stateMachines: Array_Type<ProtectionLoopAlert>): Map_Type<string, boolean>;

  /**
   * Transition with a valid transition in the transitions array
   */
  transitionWithTransitions(transitions?: Array_Type<ProtectionLoopAlertTransition>, testOnly?: boolean, stateHistoryParams?: ProtectionLoopAlertHistory): StateMachineTransitionStatus<ProtectionLoopAlertHistory, ProtectionLoopAlertTransition>;
   ...
   */
  static doBeforeCreate(objs: Array_Type<ProtectionLoopAlert>): ObjList<ProtectionLoopAlert> | null;
   ...
   */
  static doAfterUpdate(objs: Array_Type<ProtectionLoopAlert>): Array_Type<ObjError> | null;
   ...
   */
  static doAfterCreate(objs: Array_Type<ProtectionLoopAlert>): ObjList<ProtectionLoopAlert> | null;
   ...
   */
  executeTransition(transition: ProtectionLoopAlertTransition, stateOrderCounter: number, stateHistoryParams?: ProtectionLoopAlertHistory): ProtectionLoopAlertHistory;
   ...
   */
  findTransitions(allTransitions: Array_Type<ProtectionLoopAlertTransition>): Array_Type<ProtectionLoopAlertTransition> | null;

  /**
   * Internal use only.
   * Implements a statemachine db lock.
   */
  reserveStateOrderCounter(): StateMachineTransitionStatus<ProtectionLoopAlertHistory, ProtectionLoopAlertTransition>;

  /**
   * Internal use only.
   * Verify whether the state machine is in error state.
   */
  checkStateMachine(): StateMachineTransitionStatus<ProtectionLoopAlertHistory, ProtectionLoopAlertTransition>;
   ...
   */
  transitionAndRefreshCurrentState(toState: ProtectionLoopAlertState, stateHistoryParams?: ProtectionLoopAlertHistory): StateMachineTransitionStatus<ProtectionLoopAlertHistory, ProtectionLoopAlertTransition>;

  /**
   * Used from the UI to batch transition and refresh currentState stored calc.
   */
  static transitionBatchAndRefreshCurrentState(stateMachines: Array_Type<ProtectionLoopAlert>, toState: ProtectionLoopAlertState, retry?: number, stateHistoryParams?: ProtectionLoopAlertHistory): Array_Type<StateMachineTransitionStatus<ProtectionLoopAlertHistory, ProtectionLoopAlertTransition>>;
   ...
   */
  fetchSensorStatuses(spec?: FetchSpec): FetchResultWithTotalCount<ProtectionLoopAlertSensorStatus>;

  /**
   * Closing previous open alerts.
   */
  static openStateEntryAction(currentProtectionLoopAlert: ProtectionLoopAlert): void;
