// TypeScript definitions for the C3 type FaultySensor.Orchestrator.History
 ...
 * @see FaultySensor
 *
 * @remarks this represents a value passed to a method that expects an instance of FaultySensor.Orchestrator.History
 */
declare namespace FaultySensor.Orchestrator {
  export interface IHistory {
     ...
     */
    runStartTime: DateTime | Date | string;
     ...
     */
    fetchUpdatedSensorsStart?: DateTime | Date | string;
     ...
     * @see Sensor#fetchSensorsWithOperationalStatusChange
     */
    fetchUpdatedSensorsEnd: DateTime | Date | string;
...
declare namespace FaultySensor.Orchestrator {
  export class History extends Obj  {
     ...
     */
    readonly id: string;
    withId(id: string): FaultySensor.Orchestrator.History;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): FaultySensor.Orchestrator.History;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): FaultySensor.Orchestrator.History;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): FaultySensor.Orchestrator.History;
    ...
    withVersion(version: number | null): FaultySensor.Orchestrator.History;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): FaultySensor.Orchestrator.History;

    /**
     * The time that the {@link FaultySensor.Orchestrator} was kicked off. This time may not be related to the interval
     * of sensor updates that are being handled. See #fetchUpdatedSensorsStart and #fetchUpdatedSensorsEnd for that.
     */
    readonly runStartTime: DateTime;
    withRunStartTime(runStartTime: DateTime | Date | string): FaultySensor.Orchestrator.History;
     ...
     * @see Sensor#fetchSensorsWithOperationalStatusChange
     */
    readonly fetchUpdatedSensorsStart?: DateTime;
    withFetchUpdatedSensorsStart(fetchUpdatedSensorsStart: DateTime | Date | string | null): FaultySensor.Orchestrator.History;
     ...
     * @see Sensor#fetchSensorsWithOperationalStatusChange
     */
    readonly fetchUpdatedSensorsEnd: DateTime;
    withFetchUpdatedSensorsEnd(fetchUpdatedSensorsEnd: DateTime | Date | string): FaultySensor.Orchestrator.History;

    /**
     * The created workflow that was triggered by the {@link FaultySensor.Orchestrator} to handle the #updatedSensors.
     */
    readonly workflow: Workflow;
    withWorkflow(workflow: IWorkflow): FaultySensor.Orchestrator.History;
    ...
    withUpdatedSensors(updatedSensors: Array_Type<Sensor> | Array<ISensor> | null): FaultySensor.Orchestrator.History;
     ...
     * @see #toJson
     */
    static fromJson(json: any): FaultySensor.Orchestrator.History | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): FaultySensor.Orchestrator.History | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): FaultySensor.Orchestrator.History | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): FaultySensor.Orchestrator.History | null;
     ...
     */
    replaceType(old: Type, new_: Type): FaultySensor.Orchestrator.History;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): FaultySensor.Orchestrator.History;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): FaultySensor.Orchestrator.History;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<FaultySensor.Orchestrator.History>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<FaultySensor.Orchestrator.History>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): FaultySensor.Orchestrator.History;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): FaultySensor.Orchestrator.History;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): FaultySensor.Orchestrator.History;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): FaultySensor.Orchestrator.History;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): FaultySensor.Orchestrator.History;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): FaultySensor.Orchestrator.History;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): FaultySensor.Orchestrator.History;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): FaultySensor.Orchestrator.History;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): FaultySensor.Orchestrator.History;
     ...
     * @see #removeField
     */
    withoutField(field: string): FaultySensor.Orchestrator.History;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): FaultySensor.Orchestrator.History;
     ...
     */
    withoutFields(fields: Array_Type<string>): FaultySensor.Orchestrator.History;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): FaultySensor.Orchestrator.History;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): FaultySensor.Orchestrator.History;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): FaultySensor.Orchestrator.History;
     ...
     * @see #unsetField
     */
    defaultField(field: string): FaultySensor.Orchestrator.History;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): FaultySensor.Orchestrator.History;
     ...
     * @see #removeField
     */
    unsetField(field: string): FaultySensor.Orchestrator.History;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): FaultySensor.Orchestrator.History;
     ...
     * @see #unsetField
     */
    removeField(field: string): FaultySensor.Orchestrator.History;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): FaultySensor.Orchestrator.History;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): FaultySensor.Orchestrator.History;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): FaultySensor.Orchestrator.History;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): FaultySensor.Orchestrator.History;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): FaultySensor.Orchestrator.History;

    mergeJson(json: any): FaultySensor.Orchestrator.History;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): FaultySensor.Orchestrator.History;
     ...
     */
    sumObj(other: Obj, deep?: boolean): FaultySensor.Orchestrator.History;
     ...
     */
    singletonArray(): Array_Type<FaultySensor.Orchestrator.History>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<FaultySensor.Orchestrator.History> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<FaultySensor.Orchestrator.History> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<FaultySensor.Orchestrator.History>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<FaultySensor.Orchestrator.History> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, FaultySensor.Orchestrator.History> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, FaultySensor.Orchestrator.History> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<FaultySensor.Orchestrator.History>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<FaultySensor.Orchestrator.History>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): FaultySensor.Orchestrator.History;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): FaultySensor.Orchestrator.History;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): FaultySensor.Orchestrator.History;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): FaultySensor.Orchestrator.History;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): FaultySensor.Orchestrator.History;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): FaultySensor.Orchestrator.History;
     ...
     * @see #fromString
     */
    static make(s: string): FaultySensor.Orchestrator.History | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): FaultySensor.Orchestrator.History;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): FaultySensor.Orchestrator.History;
     ...
     */
    static cachedEmptyInst(): FaultySensor.Orchestrator.History;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<FaultySensor.Orchestrator.History> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): FaultySensor.Orchestrator.History;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<FaultySensor.Orchestrator.History>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<FaultySensor.Orchestrator.History>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<FaultySensor.Orchestrator.History> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<FaultySensor.Orchestrator.History>> | null;
     ...
     */
    get(include?: string): FaultySensor.Orchestrator.History | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): FaultySensor.Orchestrator.History | null;
     ...
     */
    getMissing(spec: GetMissingSpec): FaultySensor.Orchestrator.History;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): FaultySensor.Orchestrator.History | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): FaultySensor.Orchestrator.History;
     ...
     * @see #toString
     */
    static fromString(s: string): FaultySensor.Orchestrator.History | null;
     ...
     */
    create(spec?: UpsertSpec): FaultySensor.Orchestrator.History | null;
     ...
     */
    static createBatch(objs: Array_Type<FaultySensor.Orchestrator.History>, spec?: UpsertSpec): ObjList<FaultySensor.Orchestrator.History> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<FaultySensor.Orchestrator.History>, spec?: CreateBatchObjStreamSpec): ObjList<FaultySensor.Orchestrator.History> | null;
     ...
     */
    update(srcObj?: FaultySensor.Orchestrator.History, spec?: UpsertSpec): FaultySensor.Orchestrator.History | null;
     ...
     */
    upsert(srcObj?: FaultySensor.Orchestrator.History, spec?: UpsertSpec): FaultySensor.Orchestrator.History | null;
     ...
     */
    merge(spec?: MergeSpec): FaultySensor.Orchestrator.History | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): FaultySensor.Orchestrator.History | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): FaultySensor.Orchestrator.History | null;
     ...
     */
    static updateBatch(objs: Array_Type<FaultySensor.Orchestrator.History>, srcObjs?: Array_Type<FaultySensor.Orchestrator.History>, spec?: UpsertSpec): ObjList<FaultySensor.Orchestrator.History> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<FaultySensor.Orchestrator.History> | null>, spec?: UpsertSpec): ObjList<FaultySensor.Orchestrator.History> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<FaultySensor.Orchestrator.History>, srcObjs?: Array_Type<FaultySensor.Orchestrator.History>, spec?: UpsertSpec): ObjList<FaultySensor.Orchestrator.History> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<FaultySensor.Orchestrator.History> | null>, spec?: UpsertSpec): ObjList<FaultySensor.Orchestrator.History> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<FaultySensor.Orchestrator.History>, spec?: TouchSpec): ObjList<FaultySensor.Orchestrator.History> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<FaultySensor.Orchestrator.History>, spec?: MergeSpec): ObjList<FaultySensor.Orchestrator.History> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<FaultySensor.Orchestrator.History>, mergeInclude: string, spec?: MergeSpec): ObjList<FaultySensor.Orchestrator.History> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<FaultySensor.Orchestrator.History> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<FaultySensor.Orchestrator.History> | null;
     ...
     */
    static mergeAll(mergeObj: FaultySensor.Orchestrator.History, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: FaultySensor.Orchestrator.History, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<FaultySensor.Orchestrator.History>, spec?: UpsertSpec): ObjList<FaultySensor.Orchestrator.History> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<FaultySensor.Orchestrator.History>, spec?: UpsertSpec): ObjList<FaultySensor.Orchestrator.History> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): FaultySensor.Orchestrator.History | null;
     ...
     */
    static beforeCreate(objs: Array_Type<FaultySensor.Orchestrator.History>): ObjList<FaultySensor.Orchestrator.History>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<FaultySensor.Orchestrator.History>): ObjList<FaultySensor.Orchestrator.History>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<FaultySensor.Orchestrator.History>): ObjList<FaultySensor.Orchestrator.History>;
     ...
     */
    static afterCreate(objs: Array_Type<FaultySensor.Orchestrator.History>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<FaultySensor.Orchestrator.History>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<FaultySensor.Orchestrator.History>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<FaultySensor.Orchestrator.History>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<FaultySensor.Orchestrator.History>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): FaultySensor.Orchestrator.History | null;
     ...
     */
    withoutIdentity(): FaultySensor.Orchestrator.History | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<FaultySensor.Orchestrator.History>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: FaultySensor.Orchestrator.History, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<FaultySensor.Orchestrator.History>, callback?: λFunction<FaultySensor.Orchestrator.History | null, FaultySensor.Orchestrator.History | null>): ObjList<FaultySensor.Orchestrator.History>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<FaultySensor.Orchestrator.History>, callback?: λFunction<FaultySensor.Orchestrator.History | null, FaultySensor.Orchestrator.History | null>): Array_Type<ObjError> | null;
     ...
     */
    static addUpdatedSensorsToHistory(historyId: string, updatedSensors?: Array_Type<Sensor>): void;
  }
}
