// TypeScript definitions for the C3 type ReliabilityOrchestrator.LoadModelsJobRun
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityOrchestrator.LoadModelsJobRun
 */
declare namespace ReliabilityOrchestrator {
  export interface ILoadModelsJobRun {
     ...
     */
    job: IReliabilityOrchestrator.LoadModelsJob;
     ...
     */
    files: Array_Type<File> | Array<IFile>;
 ...
 */
declare namespace ReliabilityOrchestrator {
  export class LoadModelsJobRun extends Obj  {
    ...
    withTypeIdent(typeIdent: string | null): ReliabilityOrchestrator.LoadModelsJobRun;
     ...
     */
    readonly id: string;
    withId(id: string): ReliabilityOrchestrator.LoadModelsJobRun;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityOrchestrator.LoadModelsJobRun;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): ReliabilityOrchestrator.LoadModelsJobRun;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): ReliabilityOrchestrator.LoadModelsJobRun;
    ...
    withVersion(version: number | null): ReliabilityOrchestrator.LoadModelsJobRun;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): ReliabilityOrchestrator.LoadModelsJobRun;

    /**
     * {@link JobOptions} for executing this coordinator.
     */
    readonly jobOptions?: JobOptions;
    withJobOptions(jobOptions: IJobOptions | null): ReliabilityOrchestrator.LoadModelsJobRun;

    /**
     * {@link ReliabilityOrchestrator.LoadModelsJob} that this job run belongs to
     */
    readonly job: ReliabilityOrchestrator.LoadModelsJob;
    withJob(job: IReliabilityOrchestrator.LoadModelsJob): ReliabilityOrchestrator.LoadModelsJobRun;

    /**
     * Specify the {@link File}s created by {@link ReliabilityOrchestrator.RegisterModelsJob}s, that should be used
     * to load {@link ReliabilityMlModel}s in the target environment.
     */
    readonly files: Array_Type<File>;
    withFiles(files: Array_Type<File> | Array<IFile>): ReliabilityOrchestrator.LoadModelsJobRun;
    ...
    withForce(force: boolean): ReliabilityOrchestrator.LoadModelsJobRun;

    /**
     * Spec that was used to specify execution constraints for this register models job run.
     */
    readonly options?: ReliabilityOrchestrator.JobOptions;
    withOptions(options: IReliabilityOrchestrator.JobOptions | null): ReliabilityOrchestrator.LoadModelsJobRun;
     ...
     * @see #toJson
     */
    static fromJson(json: any): ReliabilityOrchestrator.LoadModelsJobRun | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): ReliabilityOrchestrator.LoadModelsJobRun | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): ReliabilityOrchestrator.LoadModelsJobRun | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): ReliabilityOrchestrator.LoadModelsJobRun | null;
     ...
     */
    replaceType(old: Type, new_: Type): ReliabilityOrchestrator.LoadModelsJobRun;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityOrchestrator.LoadModelsJobRun;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityOrchestrator.LoadModelsJobRun;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityOrchestrator.LoadModelsJobRun>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityOrchestrator.LoadModelsJobRun>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityOrchestrator.LoadModelsJobRun;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityOrchestrator.LoadModelsJobRun;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityOrchestrator.LoadModelsJobRun;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): ReliabilityOrchestrator.LoadModelsJobRun;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): ReliabilityOrchestrator.LoadModelsJobRun;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityOrchestrator.LoadModelsJobRun;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityOrchestrator.LoadModelsJobRun;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityOrchestrator.LoadModelsJobRun;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): ReliabilityOrchestrator.LoadModelsJobRun;
     ...
     * @see #removeField
     */
    withoutField(field: string): ReliabilityOrchestrator.LoadModelsJobRun;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): ReliabilityOrchestrator.LoadModelsJobRun;
     ...
     */
    withoutFields(fields: Array_Type<string>): ReliabilityOrchestrator.LoadModelsJobRun;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityOrchestrator.LoadModelsJobRun;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): ReliabilityOrchestrator.LoadModelsJobRun;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityOrchestrator.LoadModelsJobRun;
     ...
     * @see #unsetField
     */
    defaultField(field: string): ReliabilityOrchestrator.LoadModelsJobRun;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): ReliabilityOrchestrator.LoadModelsJobRun;
     ...
     * @see #removeField
     */
    unsetField(field: string): ReliabilityOrchestrator.LoadModelsJobRun;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): ReliabilityOrchestrator.LoadModelsJobRun;
     ...
     * @see #unsetField
     */
    removeField(field: string): ReliabilityOrchestrator.LoadModelsJobRun;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): ReliabilityOrchestrator.LoadModelsJobRun;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityOrchestrator.LoadModelsJobRun;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityOrchestrator.LoadModelsJobRun;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityOrchestrator.LoadModelsJobRun;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityOrchestrator.LoadModelsJobRun;

    mergeJson(json: any): ReliabilityOrchestrator.LoadModelsJobRun;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityOrchestrator.LoadModelsJobRun;
     ...
     */
    sumObj(other: Obj, deep?: boolean): ReliabilityOrchestrator.LoadModelsJobRun;
     ...
     */
    singletonArray(): Array_Type<ReliabilityOrchestrator.LoadModelsJobRun>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityOrchestrator.LoadModelsJobRun> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<ReliabilityOrchestrator.LoadModelsJobRun> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<ReliabilityOrchestrator.LoadModelsJobRun>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<ReliabilityOrchestrator.LoadModelsJobRun> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, ReliabilityOrchestrator.LoadModelsJobRun> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityOrchestrator.LoadModelsJobRun> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<ReliabilityOrchestrator.LoadModelsJobRun>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<ReliabilityOrchestrator.LoadModelsJobRun>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityOrchestrator.LoadModelsJobRun;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityOrchestrator.LoadModelsJobRun;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityOrchestrator.LoadModelsJobRun;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): ReliabilityOrchestrator.LoadModelsJobRun;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityOrchestrator.LoadModelsJobRun;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): ReliabilityOrchestrator.LoadModelsJobRun;
     ...
     * @see #fromString
     */
    static make(s: string): ReliabilityOrchestrator.LoadModelsJobRun | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityOrchestrator.LoadModelsJobRun;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): ReliabilityOrchestrator.LoadModelsJobRun;
     ...
     */
    static cachedEmptyInst(): ReliabilityOrchestrator.LoadModelsJobRun;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityOrchestrator.LoadModelsJobRun> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): ReliabilityOrchestrator.LoadModelsJobRun;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<ReliabilityOrchestrator.LoadModelsJobRun>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<ReliabilityOrchestrator.LoadModelsJobRun>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityOrchestrator.LoadModelsJobRun> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityOrchestrator.LoadModelsJobRun>> | null;
     ...
     */
    get(include?: string): ReliabilityOrchestrator.LoadModelsJobRun | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): ReliabilityOrchestrator.LoadModelsJobRun | null;
     ...
     */
    getMissing(spec: GetMissingSpec): ReliabilityOrchestrator.LoadModelsJobRun;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): ReliabilityOrchestrator.LoadModelsJobRun | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): ReliabilityOrchestrator.LoadModelsJobRun;
     ...
     * @see #toString
     */
    static fromString(s: string): ReliabilityOrchestrator.LoadModelsJobRun | null;
     ...
     */
    create(spec?: UpsertSpec): ReliabilityOrchestrator.LoadModelsJobRun | null;
     ...
     */
    static createBatch(objs: Array_Type<ReliabilityOrchestrator.LoadModelsJobRun>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.LoadModelsJobRun> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<ReliabilityOrchestrator.LoadModelsJobRun>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityOrchestrator.LoadModelsJobRun> | null;
     ...
     */
    update(srcObj?: ReliabilityOrchestrator.LoadModelsJobRun, spec?: UpsertSpec): ReliabilityOrchestrator.LoadModelsJobRun | null;
     ...
     */
    upsert(srcObj?: ReliabilityOrchestrator.LoadModelsJobRun, spec?: UpsertSpec): ReliabilityOrchestrator.LoadModelsJobRun | null;
     ...
     */
    merge(spec?: MergeSpec): ReliabilityOrchestrator.LoadModelsJobRun | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): ReliabilityOrchestrator.LoadModelsJobRun | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): ReliabilityOrchestrator.LoadModelsJobRun | null;
     ...
     */
    static updateBatch(objs: Array_Type<ReliabilityOrchestrator.LoadModelsJobRun>, srcObjs?: Array_Type<ReliabilityOrchestrator.LoadModelsJobRun>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.LoadModelsJobRun> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<ReliabilityOrchestrator.LoadModelsJobRun> | null>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.LoadModelsJobRun> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<ReliabilityOrchestrator.LoadModelsJobRun>, srcObjs?: Array_Type<ReliabilityOrchestrator.LoadModelsJobRun>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.LoadModelsJobRun> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<ReliabilityOrchestrator.LoadModelsJobRun> | null>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.LoadModelsJobRun> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<ReliabilityOrchestrator.LoadModelsJobRun>, spec?: TouchSpec): ObjList<ReliabilityOrchestrator.LoadModelsJobRun> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityOrchestrator.LoadModelsJobRun>, spec?: MergeSpec): ObjList<ReliabilityOrchestrator.LoadModelsJobRun> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityOrchestrator.LoadModelsJobRun>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityOrchestrator.LoadModelsJobRun> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<ReliabilityOrchestrator.LoadModelsJobRun> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityOrchestrator.LoadModelsJobRun> | null;
     ...
     */
    static mergeAll(mergeObj: ReliabilityOrchestrator.LoadModelsJobRun, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: ReliabilityOrchestrator.LoadModelsJobRun, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<ReliabilityOrchestrator.LoadModelsJobRun>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.LoadModelsJobRun> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<ReliabilityOrchestrator.LoadModelsJobRun>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.LoadModelsJobRun> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): ReliabilityOrchestrator.LoadModelsJobRun | null;
     ...
     */
    static beforeCreate(objs: Array_Type<ReliabilityOrchestrator.LoadModelsJobRun>): ObjList<ReliabilityOrchestrator.LoadModelsJobRun>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<ReliabilityOrchestrator.LoadModelsJobRun>): ObjList<ReliabilityOrchestrator.LoadModelsJobRun>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<ReliabilityOrchestrator.LoadModelsJobRun>): ObjList<ReliabilityOrchestrator.LoadModelsJobRun>;
     ...
     */
    static afterCreate(objs: Array_Type<ReliabilityOrchestrator.LoadModelsJobRun>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<ReliabilityOrchestrator.LoadModelsJobRun>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<ReliabilityOrchestrator.LoadModelsJobRun>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityOrchestrator.LoadModelsJobRun>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityOrchestrator.LoadModelsJobRun>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): ReliabilityOrchestrator.LoadModelsJobRun | null;
     ...
     */
    withoutIdentity(): ReliabilityOrchestrator.LoadModelsJobRun | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<ReliabilityOrchestrator.LoadModelsJobRun>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: ReliabilityOrchestrator.LoadModelsJobRun, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<ReliabilityOrchestrator.LoadModelsJobRun>, callback?: λFunction<ReliabilityOrchestrator.LoadModelsJobRun | null, ReliabilityOrchestrator.LoadModelsJobRun | null>): ObjList<ReliabilityOrchestrator.LoadModelsJobRun>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<ReliabilityOrchestrator.LoadModelsJobRun>, callback?: λFunction<ReliabilityOrchestrator.LoadModelsJobRun | null, ReliabilityOrchestrator.LoadModelsJobRun | null>): Array_Type<ObjError> | null;
     ...
     */
    generateNextResults(completed?: Stream<ReliabilityOrchestrator.LoadModelsJobResult>): number;
     ...
     */
    startResult(result: ReliabilityOrchestrator.LoadModelsJobResult): ReliabilityOrchestrator.LoadModelsJobResult;
     ...
     */
    afterStart(results: Stream<ReliabilityOrchestrator.LoadModelsJobResult>): Stream<ReliabilityOrchestrator.LoadModelsJobResult> | null;
     ...
     * @return the result instance, as acknowledgement, even if unmodified.
     */
    completeResult(result: ReliabilityOrchestrator.LoadModelsJobResult): ReliabilityOrchestrator.LoadModelsJobResult;
     ...
     */
    updateRunningResults(spec?: FetchStreamSpec): Stream<ReliabilityOrchestrator.LoadModelsJobResult> | null;
     ...
     */
    afterComplete(results: Stream<ReliabilityOrchestrator.LoadModelsJobResult>): Stream<ReliabilityOrchestrator.LoadModelsJobResult> | null;
     ...
     */
    runFromResult(result: ReliabilityOrchestrator.LoadModelsJobResult): WorkflowExecutorRun | null;
     ...
     *    Optional {@link FetchStreamSpec} for customizing fetching of RT objects.
     */
    pendingResults(spec?: FetchStreamSpec): Stream<ReliabilityOrchestrator.LoadModelsJobResult> | null;
     ...
     *    Optional {@link FetchStreamSpec} for customizing fetching of RT objects.
     */
    runningResults(spec?: FetchStreamSpec): Stream<ReliabilityOrchestrator.LoadModelsJobResult> | null;
     ...
     *    Optional {@link FetchStreamSpec} for customizing fetching of RT objects.
     */
    completedResults(spec?: FetchStreamSpec): Stream<ReliabilityOrchestrator.LoadModelsJobResult> | null;
     ...
     *    Optional {@link FetchStreamSpec} for customizing fetching of RT objects.
     */
    canceledResults(spec?: FetchStreamSpec): Stream<ReliabilityOrchestrator.LoadModelsJobResult> | null;
     ...
     *    Optional {@link FetchStreamSpec} for customizing fetching of RT objects.
     */
    erroredResults(spec?: FetchStreamSpec): Stream<ReliabilityOrchestrator.LoadModelsJobResult> | null;
     ...
     *    Optional {@link FetchStreamSpec} for customizing fetching of RT objects.
     */
    allResults(spec?: FetchStreamSpec): Stream<ReliabilityOrchestrator.LoadModelsJobResult> | null;
     ...
     */
    customSummaryFieldsForResult(result: ReliabilityOrchestrator.LoadModelsJobResult): Map_Type<string, any> | null;
     ...
     * @return a table with a row for each step and the corresponding execution metadata.
     */
    summaryForResults(results: Array_Type<ReliabilityOrchestrator.LoadModelsJobResult>, spec?: Workflow.Monitorable.SummarySpec): Data;
     ...
     * @return a table with a row for each step and the corresponding execution metadata.
     */
    summaryForResultsPd(results: Array_Type<ReliabilityOrchestrator.LoadModelsJobResult>, spec?: Workflow.Monitorable.SummarySpec): any | null;
     ...
     */
    resultsForSummary(spec?: FetchSpec): FetchResult<ReliabilityOrchestrator.LoadModelsJobResult> | null;
     ...
     */
    getTargetEntries(): Array_Type<ReliabilityModelRegistry.TargetEntry>;
  }
}
