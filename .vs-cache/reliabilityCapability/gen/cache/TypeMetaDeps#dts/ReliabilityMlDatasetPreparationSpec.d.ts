...
declare interface IReliabilityMlDatasetPreparationSpec {
   ...
   */
  doNotUpdateSpecForSensorAssociation?: boolean;
}
...
declare class ReliabilityMlDatasetPreparationSpec extends Obj  {
  ...
  withSensorAssociationJobId(sensorAssociationJobId: string | null): ReliabilityMlDatasetPreparationSpec;

  /**
   * Specifies whether to update the fields of {@link ReliabilityMlDatasetPreparationSpec} based on
   * {@link ReliabilityAssetSensorAssociationSpec}.
   */
  readonly doNotUpdateSpecForSensorAssociation?: boolean;
  withDoNotUpdateSpecForSensorAssociation(doNotUpdateSpecForSensorAssociation: boolean): ReliabilityMlDatasetPreparationSpec;
   ...
   */
  static _currentResultAndNextResultTransition(current_result?: string, next_result?: string): string | null;
   ...
   */
  static _datasetPrepTopLevelSpecUsesSensors(datasetPrepRun: ReliabilityMlDatasetPreparationRun, sensors?: Array_Type<Sensor>): FaultySensor.ImpactedBatchResult<ReliabilityMlDatasetPreparationRun>;
   ...
   */
  static _combineResultsForSpec(results?: Array_Type<FaultySensor.ImpactedBatchResult<ReliabilityMlDatasetPreparationRun>>): FaultySensor.ImpactedBatchResult<ReliabilityMlDatasetPreparationRun>;
}
