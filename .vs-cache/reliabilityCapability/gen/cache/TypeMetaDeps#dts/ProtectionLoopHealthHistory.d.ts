// TypeScript definitions for the C3 type ProtectionLoopHealthHistory

/**
 * An evaluation of {@link ProtectionLoop} health at a point in time.
 *
 * @remarks this represents a value passed to a method that expects an instance of ProtectionLoopHealthHistory
 */
declare interface IProtectionLoopHealthHistory {
  ...
  /**
   * The alert in the health history, if it was a bad enough health to raise an alert.
   */
  alert?: IProtectionLoopAlert;

  /**
   * The overall risk level for this evaluation of the {@link ProtectionLoop}.
   */
  risk?: string;

  /**
   * Translated {@link ProtectionLoopHealthHistory#risk}, to be displayed in the UI.
   */
  translatedRisk?: string;

  /**
   * The number of "unhealthy" sensors found.
   */
  numUnhealthySensors: number;

  /**
   * All the sensors with a sensor health issue (e.g. missing data, flatlining). Includes threshold issues.
   */
  sensorsWithHealthIssuesRelations?: Array_Type<SensorHealthIssueRelation> | Array<ISensorHealthIssueRelation>;

  /**
   * All the sensors which deviate from at least one other sensor in the loop.
   * Does not include any sensors with sensor health or threshold issues.
   */
  numSensorsWithDeviation: number;
}

/**
 * An evaluation of {@link ProtectionLoop} health at a point in time.
 *
 * @remarks this represents a made instance of ProtectionLoopHealthHistory
 */
declare class ProtectionLoopHealthHistory extends Obj  {

  /**
   * Timestamp for the value.
   */
  readonly timestamp: DateTime;
  withTimestamp(timestamp: DateTime | Date | string): ProtectionLoopHealthHistory;

  /**
   * Parent/owning obj instance.
   */
  readonly parent: ProtectionLoop;
  withParent(parent: IProtectionLoop): ProtectionLoopHealthHistory;
   ...
   */
  readonly id: string;
  withId(id: string): ProtectionLoopHealthHistory;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ProtectionLoopHealthHistory;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): ProtectionLoopHealthHistory;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): ProtectionLoopHealthHistory;
  ...
  withVersion(version: number | null): ProtectionLoopHealthHistory;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): ProtectionLoopHealthHistory;

  /**
   * The alert in the health history, if it was a bad enough health to raise an alert.
   */
  readonly alert?: ProtectionLoopAlert;
  withAlert(alert: IProtectionLoopAlert | null): ProtectionLoopHealthHistory;

  /**
   * The overall risk level for this evaluation of the {@link ProtectionLoop}.
   */
  readonly risk?: string;
  withRisk(risk: string | null): ProtectionLoopHealthHistory;

  /**
   * Translated {@link ProtectionLoopHealthHistory#risk}, to be displayed in the UI.
   */
  readonly translatedRisk?: string;
  withTranslatedRisk(translatedRisk: string | null): ProtectionLoopHealthHistory;

  /**
   * The number of "unhealthy" sensors found.
   */
  readonly numUnhealthySensors: number;
  withNumUnhealthySensors(numUnhealthySensors: number): ProtectionLoopHealthHistory;

  /**
   * All the sensors with a sensor health issue (e.g. missing data, flatlining). Includes threshold issues.
   */
  readonly sensorsWithHealthIssuesRelations?: Array_Type<SensorHealthIssueRelation>;
  withSensorsWithHealthIssuesRelations(sensorsWithHealthIssuesRelations: Array_Type<SensorHealthIssueRelation> | Array<ISensorHealthIssueRelation> | null): ProtectionLoopHealthHistory;

  /**
   * All the sensors which deviate from at least one other sensor in the loop.
   * Does not include any sensors with sensor health or threshold issues.
   */
  readonly numSensorsWithDeviation: number;
  withNumSensorsWithDeviation(numSensorsWithDeviation: number): ProtectionLoopHealthHistory;
   ...
   * @see #toJson
   */
  static fromJson(json: any): ProtectionLoopHealthHistory | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): ProtectionLoopHealthHistory | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): ProtectionLoopHealthHistory | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): ProtectionLoopHealthHistory | null;
   ...
   */
  replaceType(old: Type, new_: Type): ProtectionLoopHealthHistory;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ProtectionLoopHealthHistory;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ProtectionLoopHealthHistory;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ProtectionLoopHealthHistory>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ProtectionLoopHealthHistory>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ProtectionLoopHealthHistory;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ProtectionLoopHealthHistory;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ProtectionLoopHealthHistory;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ProtectionLoopHealthHistory;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ProtectionLoopHealthHistory;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ProtectionLoopHealthHistory;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ProtectionLoopHealthHistory;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ProtectionLoopHealthHistory;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ProtectionLoopHealthHistory;
   ...
   * @see #removeField
   */
  withoutField(field: string): ProtectionLoopHealthHistory;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): ProtectionLoopHealthHistory;
   ...
   */
  withoutFields(fields: Array_Type<string>): ProtectionLoopHealthHistory;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): ProtectionLoopHealthHistory;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ProtectionLoopHealthHistory;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ProtectionLoopHealthHistory;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ProtectionLoopHealthHistory;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ProtectionLoopHealthHistory;
   ...
   * @see #removeField
   */
  unsetField(field: string): ProtectionLoopHealthHistory;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ProtectionLoopHealthHistory;
   ...
   * @see #unsetField
   */
  removeField(field: string): ProtectionLoopHealthHistory;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ProtectionLoopHealthHistory;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ProtectionLoopHealthHistory;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): ProtectionLoopHealthHistory;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ProtectionLoopHealthHistory;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ProtectionLoopHealthHistory;

  mergeJson(json: any): ProtectionLoopHealthHistory;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ProtectionLoopHealthHistory;
   ...
   */
  sumObj(other: Obj, deep?: boolean): ProtectionLoopHealthHistory;
   ...
   */
  singletonArray(): Array_Type<ProtectionLoopHealthHistory>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<ProtectionLoopHealthHistory> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ProtectionLoopHealthHistory> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<ProtectionLoopHealthHistory>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ProtectionLoopHealthHistory> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, ProtectionLoopHealthHistory> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ProtectionLoopHealthHistory> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ProtectionLoopHealthHistory>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ProtectionLoopHealthHistory>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ProtectionLoopHealthHistory;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ProtectionLoopHealthHistory;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ProtectionLoopHealthHistory;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ProtectionLoopHealthHistory;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ProtectionLoopHealthHistory;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ProtectionLoopHealthHistory;
   ...
   * @see #fromString
   */
  static make(s: string): ProtectionLoopHealthHistory | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ProtectionLoopHealthHistory;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): ProtectionLoopHealthHistory;
   ...
   */
  static cachedEmptyInst(): ProtectionLoopHealthHistory;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<ProtectionLoopHealthHistory> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): ProtectionLoopHealthHistory;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<ProtectionLoopHealthHistory>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<ProtectionLoopHealthHistory>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<ProtectionLoopHealthHistory> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ProtectionLoopHealthHistory>> | null;
   ...
   */
  get(include?: string): ProtectionLoopHealthHistory | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): ProtectionLoopHealthHistory | null;
   ...
   */
  getMissing(spec: GetMissingSpec): ProtectionLoopHealthHistory;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): ProtectionLoopHealthHistory | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): ProtectionLoopHealthHistory;
   ...
   * @see #toString
   */
  static fromString(s: string): ProtectionLoopHealthHistory | null;
   ...
   */
  create(spec?: UpsertSpec): ProtectionLoopHealthHistory | null;
   ...
   */
  static createBatch(objs: Array_Type<ProtectionLoopHealthHistory>, spec?: UpsertSpec): ObjList<ProtectionLoopHealthHistory> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<ProtectionLoopHealthHistory>, spec?: CreateBatchObjStreamSpec): ObjList<ProtectionLoopHealthHistory> | null;
   ...
   */
  update(srcObj?: ProtectionLoopHealthHistory, spec?: UpsertSpec): ProtectionLoopHealthHistory | null;
   ...
   */
  upsert(srcObj?: ProtectionLoopHealthHistory, spec?: UpsertSpec): ProtectionLoopHealthHistory | null;
   ...
   */
  merge(spec?: MergeSpec): ProtectionLoopHealthHistory | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): ProtectionLoopHealthHistory | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): ProtectionLoopHealthHistory | null;
   ...
   */
  static updateBatch(objs: Array_Type<ProtectionLoopHealthHistory>, srcObjs?: Array_Type<ProtectionLoopHealthHistory>, spec?: UpsertSpec): ObjList<ProtectionLoopHealthHistory> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<ProtectionLoopHealthHistory> | null>, spec?: UpsertSpec): ObjList<ProtectionLoopHealthHistory> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<ProtectionLoopHealthHistory>, srcObjs?: Array_Type<ProtectionLoopHealthHistory>, spec?: UpsertSpec): ObjList<ProtectionLoopHealthHistory> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<ProtectionLoopHealthHistory> | null>, spec?: UpsertSpec): ObjList<ProtectionLoopHealthHistory> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<ProtectionLoopHealthHistory>, spec?: TouchSpec): ObjList<ProtectionLoopHealthHistory> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ProtectionLoopHealthHistory>, spec?: MergeSpec): ObjList<ProtectionLoopHealthHistory> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ProtectionLoopHealthHistory>, mergeInclude: string, spec?: MergeSpec): ObjList<ProtectionLoopHealthHistory> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<ProtectionLoopHealthHistory> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ProtectionLoopHealthHistory> | null;
   ...
   */
  static mergeAll(mergeObj: ProtectionLoopHealthHistory, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: ProtectionLoopHealthHistory, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<ProtectionLoopHealthHistory>, spec?: UpsertSpec): ObjList<ProtectionLoopHealthHistory> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<ProtectionLoopHealthHistory>, spec?: UpsertSpec): ObjList<ProtectionLoopHealthHistory> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): ProtectionLoopHealthHistory | null;
   ...
   */
  static beforeCreate(objs: Array_Type<ProtectionLoopHealthHistory>): ObjList<ProtectionLoopHealthHistory>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<ProtectionLoopHealthHistory>): ObjList<ProtectionLoopHealthHistory>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<ProtectionLoopHealthHistory>): ObjList<ProtectionLoopHealthHistory>;
   ...
   */
  static afterCreate(objs: Array_Type<ProtectionLoopHealthHistory>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<ProtectionLoopHealthHistory>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<ProtectionLoopHealthHistory>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<ProtectionLoopHealthHistory>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ProtectionLoopHealthHistory>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): ProtectionLoopHealthHistory | null;
   ...
   */
  withoutIdentity(): ProtectionLoopHealthHistory | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<ProtectionLoopHealthHistory>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: ProtectionLoopHealthHistory, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<ProtectionLoopHealthHistory>, callback?: λFunction<ProtectionLoopHealthHistory | null, ProtectionLoopHealthHistory | null>): ObjList<ProtectionLoopHealthHistory>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<ProtectionLoopHealthHistory>, callback?: λFunction<ProtectionLoopHealthHistory | null, ProtectionLoopHealthHistory | null>): Array_Type<ObjError> | null;
