// TypeScript definitions for the C3 type SensorHealthAlert

/**
 * A sensor health alert that is raised when a {@link Sensor} experiences a health issue.
 *
 * @remarks this represents a value passed to a method that expects an instance of SensorHealthAlert
 */
declare interface ISensorHealthAlert {
   ...
   */
  currentState?: ISensorHealthAlertState;

  /**
   * A collection of the states this {@link StateMachine} has passed through.
   */
  stateHistories?: Array_Type<SensorHealthAlertStateHistory> | Array<ISensorHealthAlertStateHistory>;

  /**
   * Transitions available from the current state
   */
  transitions?: Array_Type<SensorHealthAlertStateTransition> | Array<ISensorHealthAlertStateTransition>;

  /**
   * Calc field to get the current state history
   */
  currentStateHistory?: ISensorHealthAlertStateHistory;
  ...
  /**
   * The {@link Sensor} that this alert refers to
   */
  sensor: ISensor;

  /**
   * Type of SensorHealthAlert
   */
  sensorAlertCategory: ISensorHealthCategory;

  /**
   * {@link ReliabilityAsset} linked to this alert
   */
  parent?: IReliabilityAsset;

  /**
   * {@link ReliabilityAssetAlert}s that share the same {@link ReliabilityAsset} parent
   */
  assetAlerts?: Array_Type<ReliabilityAssetAlert> | Array<IReliabilityAssetAlert>;

  /**
   * Formatted timestamp of when this alert was triggered to display in UI.
   */
 ...
 * A sensor health alert that is raised when a {@link Sensor} experiences a health issue.
 *
 * @remarks this represents a made instance of SensorHealthAlert
 */
declare class SensorHealthAlert extends Obj  {

  /**
   * Timestamp for the value.
   */
  readonly timestamp?: DateTime;
  withTimestamp(timestamp: DateTime | Date | string | null): SensorHealthAlert;
   ...
   */
  readonly id: string;
  withId(id: string): SensorHealthAlert;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): SensorHealthAlert;

  /**
   * Name of this alert
   */
  readonly name?: string;
  withName(name: string | null): SensorHealthAlert;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): SensorHealthAlert;
  ...
  withVersion(version: number | null): SensorHealthAlert;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): SensorHealthAlert;

  /**
   * A stored calc field representing the current state - uses a {@link StateMachineHistory} to keep track.
   */
  readonly currentState?: SensorHealthAlertState;
  withCurrentState(currentState: ISensorHealthAlertState | null): SensorHealthAlert;

  /**
   * A collection of the states this {@link StateMachine} has passed through.
   */
  readonly stateHistories?: Array_Type<SensorHealthAlertStateHistory>;
  withStateHistories(stateHistories: Array_Type<SensorHealthAlertStateHistory> | Array<ISensorHealthAlertStateHistory> | null): SensorHealthAlert;

  /**
   * Transitions available from the current state
   */
  readonly transitions?: Array_Type<SensorHealthAlertStateTransition>;
  withTransitions(transitions: Array_Type<SensorHealthAlertStateTransition> | Array<ISensorHealthAlertStateTransition> | null): SensorHealthAlert;

  /**
   * Calc field to get the current state history
   */
  readonly currentStateHistory?: SensorHealthAlertStateHistory;
  withCurrentStateHistory(currentStateHistory: ISensorHealthAlertStateHistory | null): SensorHealthAlert;

  /**
   * @inheritdoc
   */
  readonly facilityFilterPaths?: Array_Type<string>;
  withFacilityFilterPaths(facilityFilterPaths: Array_Type<string> | Array<string> | null): SensorHealthAlert;
  ...
  withTypeIdent(typeIdent: string | null): SensorHealthAlert;

  /**
   * The {@link Sensor} that this alert refers to
   */
  readonly sensor: Sensor;
  withSensor(sensor: ISensor): SensorHealthAlert;

  /**
   * Type of SensorHealthAlert
   */
  readonly sensorAlertCategory: SensorHealthCategory;
  withSensorAlertCategory(sensorAlertCategory: ISensorHealthCategory): SensorHealthAlert;

  /**
   * {@link ReliabilityAsset} linked to this alert
   */
  readonly parent?: ReliabilityAsset;
  withParent(parent: IReliabilityAsset | null): SensorHealthAlert;

  /**
   * {@link ReliabilityAssetAlert}s that share the same {@link ReliabilityAsset} parent
   */
  readonly assetAlerts?: Array_Type<ReliabilityAssetAlert>;
  withAssetAlerts(assetAlerts: Array_Type<ReliabilityAssetAlert> | Array<IReliabilityAssetAlert> | null): SensorHealthAlert;

  /**
   * Formatted timestamp of when this alert was triggered to display in UI.
   */
  readonly formattedTimestamp?: string;
  withFormattedTimestamp(formattedTimestamp: string | null): SensorHealthAlert;
   ...
   * @see #toJson
   */
  static fromJson(json: any): SensorHealthAlert | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): SensorHealthAlert | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): SensorHealthAlert | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): SensorHealthAlert | null;
   ...
   */
  replaceType(old: Type, new_: Type): SensorHealthAlert;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): SensorHealthAlert;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): SensorHealthAlert;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<SensorHealthAlert>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<SensorHealthAlert>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): SensorHealthAlert;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SensorHealthAlert;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SensorHealthAlert;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): SensorHealthAlert;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): SensorHealthAlert;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): SensorHealthAlert;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): SensorHealthAlert;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): SensorHealthAlert;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): SensorHealthAlert;
   ...
   * @see #removeField
   */
  withoutField(field: string): SensorHealthAlert;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): SensorHealthAlert;
   ...
   */
  withoutFields(fields: Array_Type<string>): SensorHealthAlert;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): SensorHealthAlert;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): SensorHealthAlert;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): SensorHealthAlert;
   ...
   * @see #unsetField
   */
  defaultField(field: string): SensorHealthAlert;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): SensorHealthAlert;
   ...
   * @see #removeField
   */
  unsetField(field: string): SensorHealthAlert;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): SensorHealthAlert;
   ...
   * @see #unsetField
   */
  removeField(field: string): SensorHealthAlert;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): SensorHealthAlert;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): SensorHealthAlert;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): SensorHealthAlert;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): SensorHealthAlert;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): SensorHealthAlert;

  mergeJson(json: any): SensorHealthAlert;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): SensorHealthAlert;
   ...
   */
  sumObj(other: Obj, deep?: boolean): SensorHealthAlert;
   ...
   */
  singletonArray(): Array_Type<SensorHealthAlert>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<SensorHealthAlert> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<SensorHealthAlert> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<SensorHealthAlert>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<SensorHealthAlert> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, SensorHealthAlert> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, SensorHealthAlert> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<SensorHealthAlert>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<SensorHealthAlert>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): SensorHealthAlert;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): SensorHealthAlert;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): SensorHealthAlert;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): SensorHealthAlert;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): SensorHealthAlert;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): SensorHealthAlert;
   ...
   * @see #fromString
   */
  static make(s: string): SensorHealthAlert | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): SensorHealthAlert;
   ...
   */
  static cachedEmptyInst(): SensorHealthAlert;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<SensorHealthAlert> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): SensorHealthAlert;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<SensorHealthAlert>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<SensorHealthAlert>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<SensorHealthAlert> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<SensorHealthAlert>> | null;
   ...
   */
  static evalFeatureSetBatch(batch: Array_Type<SensorHealthAlert>, featureSet: Feature.Set, spec?: EvalFeatureSpec): Data | null;
   ...
   * ```
   */
  static evalFeaturesBatch(batch: Array_Type<SensorHealthAlert>, features: Array_Type<string>, spec?: EvalFeaturesSpec): Data | null;
   ...
   */
  get(include?: string): SensorHealthAlert | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): SensorHealthAlert | null;
   ...
   */
  getMissing(spec: GetMissingSpec): SensorHealthAlert;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): SensorHealthAlert | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): SensorHealthAlert;
   ...
   * @see #toString
   */
  static fromString(s: string): SensorHealthAlert | null;
   ...
   */
  create(spec?: UpsertSpec): SensorHealthAlert | null;
   ...
   */
  static createBatch(objs: Array_Type<SensorHealthAlert>, spec?: UpsertSpec): ObjList<SensorHealthAlert> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<SensorHealthAlert>, spec?: CreateBatchObjStreamSpec): ObjList<SensorHealthAlert> | null;
   ...
   */
  update(srcObj?: SensorHealthAlert, spec?: UpsertSpec): SensorHealthAlert | null;
   ...
   */
  upsert(srcObj?: SensorHealthAlert, spec?: UpsertSpec): SensorHealthAlert | null;
   ...
   */
  merge(spec?: MergeSpec): SensorHealthAlert | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): SensorHealthAlert | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): SensorHealthAlert | null;
   ...
   */
  static updateBatch(objs: Array_Type<SensorHealthAlert>, srcObjs?: Array_Type<SensorHealthAlert>, spec?: UpsertSpec): ObjList<SensorHealthAlert> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<SensorHealthAlert> | null>, spec?: UpsertSpec): ObjList<SensorHealthAlert> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<SensorHealthAlert>, srcObjs?: Array_Type<SensorHealthAlert>, spec?: UpsertSpec): ObjList<SensorHealthAlert> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<SensorHealthAlert> | null>, spec?: UpsertSpec): ObjList<SensorHealthAlert> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<SensorHealthAlert>, spec?: TouchSpec): ObjList<SensorHealthAlert> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<SensorHealthAlert>, spec?: MergeSpec): ObjList<SensorHealthAlert> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<SensorHealthAlert>, mergeInclude: string, spec?: MergeSpec): ObjList<SensorHealthAlert> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<SensorHealthAlert> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<SensorHealthAlert> | null;
   ...
   */
  static mergeAll(mergeObj: SensorHealthAlert, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: SensorHealthAlert, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<SensorHealthAlert>, spec?: UpsertSpec): ObjList<SensorHealthAlert> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<SensorHealthAlert>, spec?: UpsertSpec): ObjList<SensorHealthAlert> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): SensorHealthAlert | null;
   ...
   */
  static beforeCreate(objs: Array_Type<SensorHealthAlert>): ObjList<SensorHealthAlert>;
   ...
   */
  static beforeUpdate(objs: Array_Type<SensorHealthAlert>): ObjList<SensorHealthAlert>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<SensorHealthAlert>): ObjList<SensorHealthAlert>;

  /**
   * See {@link PersistableWritable#afterCreate}
   */
  static afterCreate(objs: Array_Type<SensorHealthAlert>): Array_Type<ObjError> | null;
   ...
   */
  static afterUpdate(objs: Array_Type<SensorHealthAlert>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<SensorHealthAlert>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<SensorHealthAlert>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<SensorHealthAlert>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): SensorHealthAlert | null;
   ...
   */
  withoutIdentity(): SensorHealthAlert | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<SensorHealthAlert>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: SensorHealthAlert, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<SensorHealthAlert>, callback?: λFunction<SensorHealthAlert | null, SensorHealthAlert | null>): ObjList<SensorHealthAlert>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<SensorHealthAlert>, callback?: λFunction<SensorHealthAlert | null, SensorHealthAlert | null>): Array_Type<ObjError> | null;
   ...
   */
  static transitionBatch(stateMachines: Array_Type<SensorHealthAlert>, toState: SensorHealthAlertState, retry?: number, stateHistoryParams?: SensorHealthAlertStateHistory): Array_Type<StateMachineTransitionStatus<SensorHealthAlertStateHistory, SensorHealthAlertStateTransition>>;
   ...
   */
  transition(toState: SensorHealthAlertState, testOnly?: boolean, stateHistoryParams?: SensorHealthAlertStateHistory): StateMachineTransitionStatus<SensorHealthAlertStateHistory, SensorHealthAlertStateTransition>;
   ...
   */
  checkTransition(toState: SensorHealthAlertState): boolean;
   ...
   */
  possibleStates(): Array_Type<SensorHealthAlertState> | null;

  /**
   * Return list of all states in the {@link StateMachine}.
   */
  static allStates(): Array_Type<SensorHealthAlertState> | null;

  /**
   * Return list of transitions possible from the current state given the current user permissions and current conditions.
   */
  possibleTransitions(): Array_Type<SensorHealthAlertStateTransition> | null;
   ...
   */
  static allTransitions(fromState?: SensorHealthAlertState, toState?: SensorHealthAlertState): Array_Type<SensorHealthAlertStateTransition> | null;
   ...
   */
  forceTransition(toState: SensorHealthAlertState, stateHistoryParams?: SensorHealthAlertStateHistory): boolean;
   ...
   */
  static forceTransitionBatch(stateMachines: Array_Type<SensorHealthAlert>, toState: SensorHealthAlertState, stateHistoryParams?: SensorHealthAlertStateHistory): Map_Type<string, boolean>;
   ...
   */
  static stateRecoverBatch(stateMachines: Array_Type<SensorHealthAlert>): Map_Type<string, boolean>;

  /**
   * Transition with a valid transition in the transitions array
   */
  transitionWithTransitions(transitions?: Array_Type<SensorHealthAlertStateTransition>, testOnly?: boolean, stateHistoryParams?: SensorHealthAlertStateHistory): StateMachineTransitionStatus<SensorHealthAlertStateHistory, SensorHealthAlertStateTransition>;
   ...
   */
  static doBeforeCreate(objs: Array_Type<SensorHealthAlert>): ObjList<SensorHealthAlert> | null;
   ...
   */
  static doAfterUpdate(objs: Array_Type<SensorHealthAlert>): Array_Type<ObjError> | null;

  /**
   * Transition alerts to "Muted" state and creates {@link UserRecommendation} if applicable.
   */
  static doAfterCreate(objs: Array_Type<SensorHealthAlert>): ObjList<SensorHealthAlert> | null;
   ...
   */
  executeTransition(transition: SensorHealthAlertStateTransition, stateOrderCounter: number, stateHistoryParams?: SensorHealthAlertStateHistory): SensorHealthAlertStateHistory;
   ...
   */
  findTransitions(allTransitions: Array_Type<SensorHealthAlertStateTransition>): Array_Type<SensorHealthAlertStateTransition> | null;

  /**
   * Internal use only.
   * Implements a statemachine db lock.
   */
  reserveStateOrderCounter(): StateMachineTransitionStatus<SensorHealthAlertStateHistory, SensorHealthAlertStateTransition>;

  /**
   * Internal use only.
   * Verify whether the state machine is in error state.
   */
  checkStateMachine(): StateMachineTransitionStatus<SensorHealthAlertStateHistory, SensorHealthAlertStateTransition>;
   ...
   */
  transitionAndRefreshCurrentState(toState: SensorHealthAlertState, stateHistoryParams?: SensorHealthAlertStateHistory): StateMachineTransitionStatus<SensorHealthAlertStateHistory, SensorHealthAlertStateTransition>;

  /**
   * Used from the UI to batch transition and refresh currentState stored calc.
   */
  static transitionBatchAndRefreshCurrentState(stateMachines: Array_Type<SensorHealthAlert>, toState: SensorHealthAlertState, retry?: number, stateHistoryParams?: SensorHealthAlertStateHistory): Array_Type<StateMachineTransitionStatus<SensorHealthAlertStateHistory, SensorHealthAlertStateTransition>>;
