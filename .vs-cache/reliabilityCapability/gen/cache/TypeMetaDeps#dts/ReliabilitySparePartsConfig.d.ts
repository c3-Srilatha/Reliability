// TypeScript definitions for the C3 type ReliabilitySparePartsConfig

/**
 * Configurations for Spare parts related application logic.
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilitySparePartsConfig
 */
declare interface IReliabilitySparePartsConfig {
  ...
  /**
   * The look back window, expressed in months, to be used during {@link InventoryStats#calculateInventoryStats}
   * Defaults to previous 3 months.
   */
  lookBackTimeWindow?: number;

  /**
   * The look ahead window, expressed in months.
   */
  lookAheadTimeWindow?: number;

  /**
   * The look back window, expressed in months, to be used during {@link PurchaseOrderStats#calculatePurchaseOrderStats}.
   * Defaults to previous 12 months.
   */
  purchaseOrderLookBackMonths?: number;
}

/**
 * Configurations for Spare parts related application logic.
 *
 * @remarks this represents a made instance of ReliabilitySparePartsConfig
 */
declare class ReliabilitySparePartsConfig extends Obj  {

  readonly configOverride?: string;
  withConfigOverride(configOverride: string | null): ReliabilitySparePartsConfig;

  static readonly configOverride?: string;

  readonly secretOverride?: string;
  withSecretOverride(secretOverride: string | null): ReliabilitySparePartsConfig;
  ...
  withIssues(issues: Array_Type<string> | Array<string> | null): ReliabilitySparePartsConfig;
   ...
   * Defaults to previous 3 months.
   */
  readonly lookBackTimeWindow?: number;
  withLookBackTimeWindow(lookBackTimeWindow: number | null): ReliabilitySparePartsConfig;

  /**
   * The look back window, expressed in months, to be used during {@link InventoryStats#calculateInventoryStats}
   * Defaults to previous 3 months.
   */
  static readonly lookBackTimeWindow?: number;

  /**
   * The look ahead window, expressed in months.
   */
  readonly lookAheadTimeWindow?: number;
  withLookAheadTimeWindow(lookAheadTimeWindow: number | null): ReliabilitySparePartsConfig;

  /**
   * The look ahead window, expressed in months.
   */
  static readonly lookAheadTimeWindow?: number;

  /**
   * The look back window, expressed in months, to be used during {@link PurchaseOrderStats#calculatePurchaseOrderStats}.
   * Defaults to previous 12 months.
   */
  readonly purchaseOrderLookBackMonths?: number;
  withPurchaseOrderLookBackMonths(purchaseOrderLookBackMonths: number | null): ReliabilitySparePartsConfig;

  /**
   * The look back window, expressed in months, to be used during {@link PurchaseOrderStats#calculatePurchaseOrderStats}.
   * Defaults to previous 12 months.
   */
  static readonly purchaseOrderLookBackMonths?: number;
   ...
   * @see #toJson
   */
  static fromJson(json: any): ReliabilitySparePartsConfig | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): ReliabilitySparePartsConfig | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): ReliabilitySparePartsConfig | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): ReliabilitySparePartsConfig | null;
   ...
   */
  replaceType(old: Type, new_: Type): ReliabilitySparePartsConfig;
   ...
   * This method is used during live metadata update
   */
  static replaceType(old: Type, new_: Type): ReliabilitySparePartsConfig;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilitySparePartsConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilitySparePartsConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilitySparePartsConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilitySparePartsConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilitySparePartsConfig>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilitySparePartsConfig>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilitySparePartsConfig>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilitySparePartsConfig>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilitySparePartsConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilitySparePartsConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilitySparePartsConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilitySparePartsConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilitySparePartsConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilitySparePartsConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ReliabilitySparePartsConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  static validateObj(): ReliabilitySparePartsConfig;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ReliabilitySparePartsConfig;
   ...
   * @see #defaultField
   */
  static withField(field: string, value: any, doNotConvert?: boolean): ReliabilitySparePartsConfig;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilitySparePartsConfig;
   ...
   * @see #defaultField
   */
  static withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilitySparePartsConfig;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilitySparePartsConfig;
   ...
   * @return new Obj
   */
  static withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilitySparePartsConfig;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilitySparePartsConfig;
   ...
   * @return new Obj
   */
  static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilitySparePartsConfig;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ReliabilitySparePartsConfig;
   ...
   * @see #withoutField
   */
  static withoutFieldAtPath(path: string): ReliabilitySparePartsConfig;
   ...
   * @see #removeField
   */
  withoutField(field: string): ReliabilitySparePartsConfig;
   ...
   * @see #removeField
   */
  static withoutField(field: string): ReliabilitySparePartsConfig;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): ReliabilitySparePartsConfig;
   ...
   * @see #removeField
   */
  static withoutField(field: FieldType): ReliabilitySparePartsConfig;
   ...
   */
  withoutFields(fields: Array_Type<string>): ReliabilitySparePartsConfig;
   ...
   * @return new Obj with removed fields
   */
  static withoutFields(fields: Array_Type<string>): ReliabilitySparePartsConfig;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilitySparePartsConfig;
   ...
   * @return new Obj with removed fields
   */
  static withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilitySparePartsConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ReliabilitySparePartsConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  static withoutSecretFields(): ReliabilitySparePartsConfig;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilitySparePartsConfig;
   ...
   * @see FieldType#defaultValue
   */
  static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilitySparePartsConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ReliabilitySparePartsConfig;
   ...
   * @see #unsetField
   */
  static defaultField(field: string): ReliabilitySparePartsConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ReliabilitySparePartsConfig;
   ...
   * @see #unsetField
   */
  static defaultField(field: FieldType): ReliabilitySparePartsConfig;
   ...
   * @see #removeField
   */
  unsetField(field: string): ReliabilitySparePartsConfig;
   ...
   * @see #removeField
   */
  static unsetField(field: string): ReliabilitySparePartsConfig;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ReliabilitySparePartsConfig;
   ...
   * @see #removeField
   */
  static unsetField(field: FieldType): ReliabilitySparePartsConfig;
   ...
   * @see #unsetField
   */
  removeField(field: string): ReliabilitySparePartsConfig;
   ...
   * @see #unsetField
   */
  static removeField(field: string): ReliabilitySparePartsConfig;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ReliabilitySparePartsConfig;
   ...
   * @see #unsetField
   */
  static removeField(field: FieldType): ReliabilitySparePartsConfig;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilitySparePartsConfig;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilitySparePartsConfig;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilitySparePartsConfig;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilitySparePartsConfig;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilitySparePartsConfig;
   ...
   *        the same key or index.
   */
  static mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilitySparePartsConfig;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilitySparePartsConfig;
   ...
   * traverse child reference and collection fields.
   */
  static mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilitySparePartsConfig;

  mergeJson(json: any): ReliabilitySparePartsConfig;

  static mergeJson(json: any): ReliabilitySparePartsConfig;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilitySparePartsConfig;
   ...
   * @return Obj with child references merged
   */
  static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilitySparePartsConfig;
   ...
   */
  sumObj(other: Obj, deep?: boolean): ReliabilitySparePartsConfig;
   ...
   * references with same name and collection elements at same index or key.
   */
  static sumObj(other: Obj, deep?: boolean): ReliabilitySparePartsConfig;
   ...
   */
  singletonArray(): Array_Type<ReliabilitySparePartsConfig>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonArray(): Array_Type<ReliabilitySparePartsConfig>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<ReliabilitySparePartsConfig> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ReliabilitySparePartsConfig> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<ReliabilitySparePartsConfig>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonSet(): Set_Type<ReliabilitySparePartsConfig>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ReliabilitySparePartsConfig> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, ReliabilitySparePartsConfig> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilitySparePartsConfig> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ReliabilitySparePartsConfig>;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  static toBuilder(): ObjBuilder<ReliabilitySparePartsConfig>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ReliabilitySparePartsConfig>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilitySparePartsConfig;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilitySparePartsConfig;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilitySparePartsConfig;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ReliabilitySparePartsConfig;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilitySparePartsConfig;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ReliabilitySparePartsConfig;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilitySparePartsConfig;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): ReliabilitySparePartsConfig;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  static afterMake(): ReliabilitySparePartsConfig;
   ...
   */
  static cachedEmptyInst(): ReliabilitySparePartsConfig;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilitySparePartsConfig> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): ReliabilitySparePartsConfig;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<ReliabilitySparePartsConfig> | null;
   ...
   */
  static find(filter?: string, doNotProduceAll?: boolean): Stream<ReliabilitySparePartsConfig> | null;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<ReliabilitySparePartsConfig> | null;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): ReliabilitySparePartsConfig | null;

  /**
   * Returns cached instance by key, with secrets removed.
   */
  static forCacheKey(key: string): ReliabilitySparePartsConfig | null;
   ...
   * @see findByCacheKey
   */
  getCached(): ReliabilitySparePartsConfig | null;
   ...
   * @see findByCacheKey
   */
  static getCached(): ReliabilitySparePartsConfig | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): ReliabilitySparePartsConfig | null;

  /**
   * @return newly produced cached instance.
   */
  static refreshCache(): ReliabilitySparePartsConfig | null;
   ...
   */
  static produce(key: string): ReliabilitySparePartsConfig | null;
   ...
   */
  static produceAll(): Map_Type<string, ReliabilitySparePartsConfig> | null;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): Map_Type<string, ReliabilitySparePartsConfig> | null;
   ...
   */
  getConfig(): ReliabilitySparePartsConfig;
   ...
   * Note that typical pattern is to use Configurable#config instead of this method.
   */
  static getConfig(): ReliabilitySparePartsConfig;
   ...
   */
  getSecret(): ReliabilitySparePartsConfig;
   ...
   * Note that typical pattern is to use Configurable#configWithSecrets instead of this method.
   */
  static getSecret(): ReliabilitySparePartsConfig;
   ...
   */
  withConfigKey(configKey: string): ReliabilitySparePartsConfig;
   ...
   *     config.configKey() => "folder1/abc"
   */
  static withConfigKey(configKey: string): ReliabilitySparePartsConfig;

  /**
   * @return copy without config key.
   */
  withoutConfigKey(): ReliabilitySparePartsConfig;

  /**
   * @return copy without config key.
   */
  static withoutConfigKey(): ReliabilitySparePartsConfig;

  /**
   * @return return cached config instance for provided config key.
   */
  static forConfigKey(configKey: string): ReliabilitySparePartsConfig | null;
   ...
   */
  static listConfigs(parallel?: boolean, filter?: λPredicate<string>): Stream<ReliabilitySparePartsConfig> | null;
   ...
   * @see setConfigValue
   */
  setConfigValues(from: ReliabilitySparePartsConfig, override?: string): void;

  /**
   * Sets multiple field values to be the same as the passed instance.
   * @see setConfigValue
   */
  static setConfigValues(from: ReliabilitySparePartsConfig, override?: string): void;
   ...
   * @see setSecretValue
   */
  setSecretValues(from: ReliabilitySparePartsConfig, override?: string): void;

  /**
   * Sets multiple secret field values to be the same as the passed instance.
   * @see setSecretValue
   */
  static setSecretValues(from: ReliabilitySparePartsConfig, override?: string): void;
   ...
   */
  static loadConfigAndSecret(configKey: string): ReliabilitySparePartsConfig | null;
   ...
   */
  removeSecrets(): ReliabilitySparePartsConfig | null;

  /**
   * @return this config without any secret values.
   */
  static removeSecrets(): ReliabilitySparePartsConfig | null;

  /**
   * @return this config with only secret values.
   */
  removeNonSecrets(): ReliabilitySparePartsConfig | null;

  /**
   * @return this config with only secret values.
   */
  static removeNonSecrets(): ReliabilitySparePartsConfig | null;

  /**
   * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
   * validation and setup.
   */
  validate(): ReliabilitySparePartsConfig;

  /**
   * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
   * validation and setup.
   */
  static validate(): ReliabilitySparePartsConfig;
