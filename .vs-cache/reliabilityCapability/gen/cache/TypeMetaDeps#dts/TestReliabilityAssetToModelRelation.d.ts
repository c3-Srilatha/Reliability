// TypeScript definitions for the C3 type TestReliabilityAssetToModelRelation

/**
 * A test type used for `test_ReliabilityAsset_ModelMetrics`.
 *
 * @remarks this represents a value passed to a method that expects an instance of TestReliabilityAssetToModelRelation
 */
declare interface ITestReliabilityAssetToModelRelation {
  ...
  /**
   * The {@link ReliabilityMlModel} referenced by the relation
   */
  to: IReliabilityMlModel;
  ...
  /**
   * Shows the date of the last alert triggered by this {@link ReliabilityMlModel}
   * for this {@link ReliabilityAsset}
   */
  lastAlertActivity?: DateTime | Date | string;

  /**
   * Identifier of the {@link ReliabilityOrchestrator.TrainingJob} that produced this {@link ReliabilityAssetToModelRelation} relation.
   * This field links the current model-to-asset relationship to the specific {@link ReliabilityOrchestrator.TrainingJob} that generated it.
   * It is populated when models are retrained as part of an automated workflow and subsequently deployed. This association
   * enables traceability between retraining runs and resulting {@link ReliabilityMlModel} deployments, allowing for
   * {@link ReliabilityOrchestrator.PostTrainingJob} evaluation, auditability, and workflow integration.
   */
  automatedRetrainingJobId?: string;

  /**
   * The {@link ReliabilityOrchestrator.TrainingJobRun} that created this relation.
   */
  trainJobRun?: IReliabilityOrchestrator.TrainingJobRun;

  /**
   * Shows the count of open alerts triggered by this {@link ReliabilityMlModel}
   * for this {@link ReliabilityAsset}
   */
 ...
 * A test type used for `test_ReliabilityAsset_ModelMetrics`.
 *
 * @remarks this represents a made instance of TestReliabilityAssetToModelRelation
 */
declare class TestReliabilityAssetToModelRelation extends Obj  {
   ...
   */
  readonly id: string;
  withId(id: string): TestReliabilityAssetToModelRelation;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): TestReliabilityAssetToModelRelation;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): TestReliabilityAssetToModelRelation;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): TestReliabilityAssetToModelRelation;
  ...
  withVersion(version: number | null): TestReliabilityAssetToModelRelation;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): TestReliabilityAssetToModelRelation;

  /**
   * @inheritdoc
   */
  readonly facilityFilterPaths?: Array_Type<string>;
  withFacilityFilterPaths(facilityFilterPaths: Array_Type<string> | Array<string> | null): TestReliabilityAssetToModelRelation;

  /**
   * Start timestamp for the value.  If null, assumed to be beginning-of-time (BOT).
   */
  readonly start?: DateTime;
  withStart(start: DateTime | Date | string | null): TestReliabilityAssetToModelRelation;

  /**
   * End timestamp for the value.  If null, assumed to be end-of-time (EOT).
   */
  readonly end?: DateTime;
  withEnd(end: DateTime | Date | string | null): TestReliabilityAssetToModelRelation;

  /**
   * The instance of {@link MlSubject} referenced by the relation.
   */
  readonly from: ReliabilityAsset;
  withFrom(from: IReliabilityAsset): TestReliabilityAssetToModelRelation;

  /**
   * The {@link ReliabilityMlModel} referenced by the relation
   */
  readonly to: ReliabilityMlModel;
  withTo(to: IReliabilityMlModel): TestReliabilityAssetToModelRelation;
  ...
  withTypeIdent(typeIdent: string | null): TestReliabilityAssetToModelRelation;

  /**
   * The {@link MlModel.Route} that originated this relation.
   */
  readonly route: MlModel.Route;
  withRoute(route: IMlModel.Route): TestReliabilityAssetToModelRelation;
  ...
  withStatus(status: IMlModel.Route.Status): TestReliabilityAssetToModelRelation;
  ...
  withGroupId(groupId: string | null): TestReliabilityAssetToModelRelation;

  /**
   * Timed predictions for this relation.
   */
  readonly timedMlPredictions?: Array_Type<ReliabilityMl.PredictionHeader>;
  withTimedMlPredictions(timedMlPredictions: Array_Type<ReliabilityMl.PredictionHeader> | Array<IReliabilityMl.PredictionHeader> | null): TestReliabilityAssetToModelRelation;

  /**
   * Timed contribution for this relation.
   */
  readonly timedMlContributions?: Array_Type<ReliabilityMl.ContributionHeader>;
  withTimedMlContributions(timedMlContributions: Array_Type<ReliabilityMl.ContributionHeader> | Array<IReliabilityMl.ContributionHeader> | null): TestReliabilityAssetToModelRelation;

  /**
   * Shows the date of the last alert triggered by this {@link ReliabilityMlModel}
   * for this {@link ReliabilityAsset}
   */
  readonly lastAlertActivity?: DateTime;
  withLastAlertActivity(lastAlertActivity: DateTime | Date | string | null): TestReliabilityAssetToModelRelation;
   ...
   * {@link ReliabilityOrchestrator.PostTrainingJob} evaluation, auditability, and workflow integration.
   */
  readonly automatedRetrainingJobId?: string;
  withAutomatedRetrainingJobId(automatedRetrainingJobId: string | null): TestReliabilityAssetToModelRelation;

  /**
   * The {@link ReliabilityOrchestrator.TrainingJobRun} that created this relation.
   */
  readonly trainJobRun?: ReliabilityOrchestrator.TrainingJobRun;
  withTrainJobRun(trainJobRun: IReliabilityOrchestrator.TrainingJobRun | null): TestReliabilityAssetToModelRelation;
  ...
  withOpenAlertsCount(openAlertsCount: number | null): TestReliabilityAssetToModelRelation;
   ...
   * @see #toJson
   */
  static fromJson(json: any): TestReliabilityAssetToModelRelation | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): TestReliabilityAssetToModelRelation | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): TestReliabilityAssetToModelRelation | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): TestReliabilityAssetToModelRelation | null;
   ...
   */
  replaceType(old: Type, new_: Type): TestReliabilityAssetToModelRelation;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): TestReliabilityAssetToModelRelation;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): TestReliabilityAssetToModelRelation;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<TestReliabilityAssetToModelRelation>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<TestReliabilityAssetToModelRelation>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): TestReliabilityAssetToModelRelation;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TestReliabilityAssetToModelRelation;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TestReliabilityAssetToModelRelation;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): TestReliabilityAssetToModelRelation;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): TestReliabilityAssetToModelRelation;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): TestReliabilityAssetToModelRelation;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): TestReliabilityAssetToModelRelation;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): TestReliabilityAssetToModelRelation;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): TestReliabilityAssetToModelRelation;
   ...
   * @see #removeField
   */
  withoutField(field: string): TestReliabilityAssetToModelRelation;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): TestReliabilityAssetToModelRelation;
   ...
   */
  withoutFields(fields: Array_Type<string>): TestReliabilityAssetToModelRelation;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): TestReliabilityAssetToModelRelation;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): TestReliabilityAssetToModelRelation;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): TestReliabilityAssetToModelRelation;
   ...
   * @see #unsetField
   */
  defaultField(field: string): TestReliabilityAssetToModelRelation;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): TestReliabilityAssetToModelRelation;
   ...
   * @see #removeField
   */
  unsetField(field: string): TestReliabilityAssetToModelRelation;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): TestReliabilityAssetToModelRelation;
   ...
   * @see #unsetField
   */
  removeField(field: string): TestReliabilityAssetToModelRelation;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): TestReliabilityAssetToModelRelation;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): TestReliabilityAssetToModelRelation;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): TestReliabilityAssetToModelRelation;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): TestReliabilityAssetToModelRelation;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): TestReliabilityAssetToModelRelation;

  mergeJson(json: any): TestReliabilityAssetToModelRelation;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): TestReliabilityAssetToModelRelation;
   ...
   */
  sumObj(other: Obj, deep?: boolean): TestReliabilityAssetToModelRelation;
   ...
   */
  singletonArray(): Array_Type<TestReliabilityAssetToModelRelation>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<TestReliabilityAssetToModelRelation> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<TestReliabilityAssetToModelRelation> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<TestReliabilityAssetToModelRelation>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<TestReliabilityAssetToModelRelation> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, TestReliabilityAssetToModelRelation> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, TestReliabilityAssetToModelRelation> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<TestReliabilityAssetToModelRelation>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<TestReliabilityAssetToModelRelation>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): TestReliabilityAssetToModelRelation;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): TestReliabilityAssetToModelRelation;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): TestReliabilityAssetToModelRelation;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): TestReliabilityAssetToModelRelation;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): TestReliabilityAssetToModelRelation;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): TestReliabilityAssetToModelRelation;
   ...
   * @see #fromString
   */
  static make(s: string): TestReliabilityAssetToModelRelation | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): TestReliabilityAssetToModelRelation;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): TestReliabilityAssetToModelRelation;
   ...
   */
  static cachedEmptyInst(): TestReliabilityAssetToModelRelation;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<TestReliabilityAssetToModelRelation> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): TestReliabilityAssetToModelRelation;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<TestReliabilityAssetToModelRelation>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<TestReliabilityAssetToModelRelation>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<TestReliabilityAssetToModelRelation> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<TestReliabilityAssetToModelRelation>> | null;
   ...
   */
  static evalFeatureSetBatch(batch: Array_Type<TestReliabilityAssetToModelRelation>, featureSet: Feature.Set, spec?: EvalFeatureSpec): Data | null;
   ...
   * ```
   */
  static evalFeaturesBatch(batch: Array_Type<TestReliabilityAssetToModelRelation>, features: Array_Type<string>, spec?: EvalFeaturesSpec): Data | null;
   ...
   */
  get(include?: string): TestReliabilityAssetToModelRelation | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): TestReliabilityAssetToModelRelation | null;
   ...
   */
  getMissing(spec: GetMissingSpec): TestReliabilityAssetToModelRelation;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): TestReliabilityAssetToModelRelation | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): TestReliabilityAssetToModelRelation;
   ...
   * @see #toString
   */
  static fromString(s: string): TestReliabilityAssetToModelRelation | null;
   ...
   */
  create(spec?: UpsertSpec): TestReliabilityAssetToModelRelation | null;
   ...
   */
  static createBatch(objs: Array_Type<TestReliabilityAssetToModelRelation>, spec?: UpsertSpec): ObjList<TestReliabilityAssetToModelRelation> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<TestReliabilityAssetToModelRelation>, spec?: CreateBatchObjStreamSpec): ObjList<TestReliabilityAssetToModelRelation> | null;
   ...
   */
  update(srcObj?: TestReliabilityAssetToModelRelation, spec?: UpsertSpec): TestReliabilityAssetToModelRelation | null;
   ...
   */
  upsert(srcObj?: TestReliabilityAssetToModelRelation, spec?: UpsertSpec): TestReliabilityAssetToModelRelation | null;
   ...
   */
  merge(spec?: MergeSpec): TestReliabilityAssetToModelRelation | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): TestReliabilityAssetToModelRelation | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): TestReliabilityAssetToModelRelation | null;
   ...
   */
  static updateBatch(objs: Array_Type<TestReliabilityAssetToModelRelation>, srcObjs?: Array_Type<TestReliabilityAssetToModelRelation>, spec?: UpsertSpec): ObjList<TestReliabilityAssetToModelRelation> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<TestReliabilityAssetToModelRelation> | null>, spec?: UpsertSpec): ObjList<TestReliabilityAssetToModelRelation> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<TestReliabilityAssetToModelRelation>, srcObjs?: Array_Type<TestReliabilityAssetToModelRelation>, spec?: UpsertSpec): ObjList<TestReliabilityAssetToModelRelation> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<TestReliabilityAssetToModelRelation> | null>, spec?: UpsertSpec): ObjList<TestReliabilityAssetToModelRelation> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<TestReliabilityAssetToModelRelation>, spec?: TouchSpec): ObjList<TestReliabilityAssetToModelRelation> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<TestReliabilityAssetToModelRelation>, spec?: MergeSpec): ObjList<TestReliabilityAssetToModelRelation> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<TestReliabilityAssetToModelRelation>, mergeInclude: string, spec?: MergeSpec): ObjList<TestReliabilityAssetToModelRelation> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<TestReliabilityAssetToModelRelation> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<TestReliabilityAssetToModelRelation> | null;
   ...
   */
  static mergeAll(mergeObj: TestReliabilityAssetToModelRelation, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: TestReliabilityAssetToModelRelation, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<TestReliabilityAssetToModelRelation>, spec?: UpsertSpec): ObjList<TestReliabilityAssetToModelRelation> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<TestReliabilityAssetToModelRelation>, spec?: UpsertSpec): ObjList<TestReliabilityAssetToModelRelation> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): TestReliabilityAssetToModelRelation | null;
   ...
   */
  static beforeCreate(objs: Array_Type<TestReliabilityAssetToModelRelation>): ObjList<TestReliabilityAssetToModelRelation>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<TestReliabilityAssetToModelRelation>): ObjList<TestReliabilityAssetToModelRelation>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<TestReliabilityAssetToModelRelation>): ObjList<TestReliabilityAssetToModelRelation>;
   ...
   */
  static afterCreate(objs: Array_Type<TestReliabilityAssetToModelRelation>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<TestReliabilityAssetToModelRelation>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<TestReliabilityAssetToModelRelation>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<TestReliabilityAssetToModelRelation>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<TestReliabilityAssetToModelRelation>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): TestReliabilityAssetToModelRelation | null;
   ...
   */
  withoutIdentity(): TestReliabilityAssetToModelRelation | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<TestReliabilityAssetToModelRelation>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: TestReliabilityAssetToModelRelation, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<TestReliabilityAssetToModelRelation>, callback?: λFunction<TestReliabilityAssetToModelRelation | null, TestReliabilityAssetToModelRelation | null>): ObjList<TestReliabilityAssetToModelRelation>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<TestReliabilityAssetToModelRelation>, callback?: λFunction<TestReliabilityAssetToModelRelation | null, TestReliabilityAssetToModelRelation | null>): Array_Type<ObjError> | null;
