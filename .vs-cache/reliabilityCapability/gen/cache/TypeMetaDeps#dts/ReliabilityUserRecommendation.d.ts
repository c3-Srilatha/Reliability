// TypeScript definitions for the C3 type ReliabilityUserRecommendation

/**
 * A recommended action for a {@link User} to take on {@link ReliabilityAsset}s.
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityUserRecommendation
 */
declare interface IReliabilityUserRecommendation {
  ...
  /**
   * The {@link UserRecommendationCategory} which generated this.
   */
  category: IUserRecommendationCategory;
  ...
  /**
   * Information specific to the recommended action.
   */
  description: string;

  /**
   * Whether or not the recommendation has been dismissed for all {@link User}s.
   */
  dismissedGlobally?: boolean;

  /**
   * The dismissal history of this recommendation for {@link User}s.
   */
  dismissedHistory?: Array_Type<UserRecommendationDismissedHistory> | Array<IUserRecommendationDismissedHistory>;

  /**
   * The set of {@link User}s that have dismissed this recommendation.
   */
  dismissedUsers?: Array_Type<string> | Array<string>;

  /**
   * The {@link ReliabilityAsset}s this recommendation is for.
   */
 ...
 * A recommended action for a {@link User} to take on {@link ReliabilityAsset}s.
 *
 * @remarks this represents a made instance of ReliabilityUserRecommendation
 */
declare class ReliabilityUserRecommendation extends Obj  {
   ...
   */
  readonly id: string;
  withId(id: string): ReliabilityUserRecommendation;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityUserRecommendation;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): ReliabilityUserRecommendation;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): ReliabilityUserRecommendation;
  ...
  withVersion(version: number | null): ReliabilityUserRecommendation;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): ReliabilityUserRecommendation;

  /**
   * @inheritdoc
   */
  readonly facilityFilterPaths?: Array_Type<string>;
  withFacilityFilterPaths(facilityFilterPaths: Array_Type<string> | Array<string> | null): ReliabilityUserRecommendation;
  ...
  withTypeIdent(typeIdent: string | null): ReliabilityUserRecommendation;

  /**
   * The {@link UserRecommendationCategory} which generated this.
   */
  readonly category: UserRecommendationCategory;
  withCategory(category: IUserRecommendationCategory): ReliabilityUserRecommendation;

  /**
   * @inheritdoc
   */
  readonly redirectUrl: string;
  withRedirectUrl(redirectUrl: string): ReliabilityUserRecommendation;

  /**
   * Information specific to the recommended action.
   */
  readonly description: string;
  withDescription(description: string): ReliabilityUserRecommendation;

  /**
   * Whether or not the recommendation has been dismissed for all {@link User}s.
   */
  readonly dismissedGlobally?: boolean;
  withDismissedGlobally(dismissedGlobally: boolean): ReliabilityUserRecommendation;

  /**
   * The dismissal history of this recommendation for {@link User}s.
   */
  readonly dismissedHistory?: Array_Type<UserRecommendationDismissedHistory>;
  withDismissedHistory(dismissedHistory: Array_Type<UserRecommendationDismissedHistory> | Array<IUserRecommendationDismissedHistory> | null): ReliabilityUserRecommendation;

  /**
   * The set of {@link User}s that have dismissed this recommendation.
   */
  readonly dismissedUsers?: Array_Type<string>;
  withDismissedUsers(dismissedUsers: Array_Type<string> | Array<string> | null): ReliabilityUserRecommendation;

  /**
   * The {@link ReliabilityAsset}s this recommendation is for.
   */
  readonly assets?: Array_Type<ReliabilityAsset>;
  withAssets(assets: Array_Type<ReliabilityAsset> | Array<IReliabilityAsset> | null): ReliabilityUserRecommendation;
   ...
   * @see #toJson
   */
  static fromJson(json: any): ReliabilityUserRecommendation | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): ReliabilityUserRecommendation | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): ReliabilityUserRecommendation | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): ReliabilityUserRecommendation | null;
   ...
   */
  replaceType(old: Type, new_: Type): ReliabilityUserRecommendation;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityUserRecommendation;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityUserRecommendation;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityUserRecommendation>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityUserRecommendation>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityUserRecommendation;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityUserRecommendation;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityUserRecommendation;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ReliabilityUserRecommendation;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ReliabilityUserRecommendation;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityUserRecommendation;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityUserRecommendation;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityUserRecommendation;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ReliabilityUserRecommendation;
   ...
   * @see #removeField
   */
  withoutField(field: string): ReliabilityUserRecommendation;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): ReliabilityUserRecommendation;
   ...
   */
  withoutFields(fields: Array_Type<string>): ReliabilityUserRecommendation;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityUserRecommendation;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ReliabilityUserRecommendation;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityUserRecommendation;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ReliabilityUserRecommendation;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ReliabilityUserRecommendation;
   ...
   * @see #removeField
   */
  unsetField(field: string): ReliabilityUserRecommendation;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ReliabilityUserRecommendation;
   ...
   * @see #unsetField
   */
  removeField(field: string): ReliabilityUserRecommendation;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ReliabilityUserRecommendation;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityUserRecommendation;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityUserRecommendation;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityUserRecommendation;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityUserRecommendation;

  mergeJson(json: any): ReliabilityUserRecommendation;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityUserRecommendation;
   ...
   */
  sumObj(other: Obj, deep?: boolean): ReliabilityUserRecommendation;
   ...
   */
  singletonArray(): Array_Type<ReliabilityUserRecommendation>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityUserRecommendation> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ReliabilityUserRecommendation> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<ReliabilityUserRecommendation>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ReliabilityUserRecommendation> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, ReliabilityUserRecommendation> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityUserRecommendation> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ReliabilityUserRecommendation>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ReliabilityUserRecommendation>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityUserRecommendation;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityUserRecommendation;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityUserRecommendation;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ReliabilityUserRecommendation;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityUserRecommendation;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ReliabilityUserRecommendation;
   ...
   * @see #fromString
   */
  static make(s: string): ReliabilityUserRecommendation | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityUserRecommendation;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): ReliabilityUserRecommendation;
   ...
   */
  static cachedEmptyInst(): ReliabilityUserRecommendation;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityUserRecommendation> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): ReliabilityUserRecommendation;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<ReliabilityUserRecommendation>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<ReliabilityUserRecommendation>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityUserRecommendation> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityUserRecommendation>> | null;
   ...
   */
  get(include?: string): ReliabilityUserRecommendation | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): ReliabilityUserRecommendation | null;
   ...
   */
  getMissing(spec: GetMissingSpec): ReliabilityUserRecommendation;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): ReliabilityUserRecommendation | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): ReliabilityUserRecommendation;
   ...
   * @see #toString
   */
  static fromString(s: string): ReliabilityUserRecommendation | null;
   ...
   */
  create(spec?: UpsertSpec): ReliabilityUserRecommendation | null;
   ...
   */
  static createBatch(objs: Array_Type<ReliabilityUserRecommendation>, spec?: UpsertSpec): ObjList<ReliabilityUserRecommendation> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<ReliabilityUserRecommendation>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityUserRecommendation> | null;
   ...
   */
  update(srcObj?: ReliabilityUserRecommendation, spec?: UpsertSpec): ReliabilityUserRecommendation | null;
   ...
   */
  upsert(srcObj?: ReliabilityUserRecommendation, spec?: UpsertSpec): ReliabilityUserRecommendation | null;
   ...
   */
  merge(spec?: MergeSpec): ReliabilityUserRecommendation | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): ReliabilityUserRecommendation | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): ReliabilityUserRecommendation | null;
   ...
   */
  static updateBatch(objs: Array_Type<ReliabilityUserRecommendation>, srcObjs?: Array_Type<ReliabilityUserRecommendation>, spec?: UpsertSpec): ObjList<ReliabilityUserRecommendation> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<ReliabilityUserRecommendation> | null>, spec?: UpsertSpec): ObjList<ReliabilityUserRecommendation> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<ReliabilityUserRecommendation>, srcObjs?: Array_Type<ReliabilityUserRecommendation>, spec?: UpsertSpec): ObjList<ReliabilityUserRecommendation> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<ReliabilityUserRecommendation> | null>, spec?: UpsertSpec): ObjList<ReliabilityUserRecommendation> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<ReliabilityUserRecommendation>, spec?: TouchSpec): ObjList<ReliabilityUserRecommendation> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityUserRecommendation>, spec?: MergeSpec): ObjList<ReliabilityUserRecommendation> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityUserRecommendation>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityUserRecommendation> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<ReliabilityUserRecommendation> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityUserRecommendation> | null;
   ...
   */
  static mergeAll(mergeObj: ReliabilityUserRecommendation, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: ReliabilityUserRecommendation, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<ReliabilityUserRecommendation>, spec?: UpsertSpec): ObjList<ReliabilityUserRecommendation> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<ReliabilityUserRecommendation>, spec?: UpsertSpec): ObjList<ReliabilityUserRecommendation> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): ReliabilityUserRecommendation | null;
   ...
   */
  static beforeCreate(objs: Array_Type<ReliabilityUserRecommendation>): ObjList<ReliabilityUserRecommendation>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<ReliabilityUserRecommendation>): ObjList<ReliabilityUserRecommendation>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<ReliabilityUserRecommendation>): ObjList<ReliabilityUserRecommendation>;
   ...
   */
  static afterCreate(objs: Array_Type<ReliabilityUserRecommendation>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<ReliabilityUserRecommendation>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<ReliabilityUserRecommendation>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityUserRecommendation>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityUserRecommendation>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): ReliabilityUserRecommendation | null;
   ...
   */
  withoutIdentity(): ReliabilityUserRecommendation | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<ReliabilityUserRecommendation>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: ReliabilityUserRecommendation, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<ReliabilityUserRecommendation>, callback?: λFunction<ReliabilityUserRecommendation | null, ReliabilityUserRecommendation | null>): ObjList<ReliabilityUserRecommendation>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<ReliabilityUserRecommendation>, callback?: λFunction<ReliabilityUserRecommendation | null, ReliabilityUserRecommendation | null>): Array_Type<ObjError> | null;
  ...
  /**
   * Fetches the recommendations for the current {@link User} based on if those recommendations have not been dismissed for that user.
   */
  static fetchForUser(spec: FetchSpec): FetchResult<ReliabilityUserRecommendation>;

  /**
   * Dismisses this recommendation for the current {@link User}.
   */
  dismissForUser(): void;

  /**
   * Dismisses this recommendation globally for all {@link User}s.
   */
  dismissGlobally(): void;

  /**
   * Calls {@link ReliabilityUserRecommendation#fetchForUser} and enhances {@link description} with a string indicating time elapsed since recommendation.
   */
  static fetchForUserWithTimeElapsed(spec?: FetchSpec): FetchResult<ReliabilityUserRecommendation> | null;

  /**
   * Returns a human readable string indicating how much time has elapsed since the given datetime, e.g. '2 days ago'.
   */
  static getTimeElapsedString(timestamp: DateTime): string;
}
