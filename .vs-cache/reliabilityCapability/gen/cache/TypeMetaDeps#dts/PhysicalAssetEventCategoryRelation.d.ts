// TypeScript definitions for the C3 type PhysicalAssetEventCategoryRelation

/**
 * Represents the relation between a {@link PhysicalAsset} and an {@link EventCategory}.
 *
 * @remarks this represents a value passed to a method that expects an instance of PhysicalAssetEventCategoryRelation
 */
declare interface IPhysicalAssetEventCategoryRelation {
  ...
  /**
   * The {@link PhysicalAsset} this relation comes from.
   */
  from: IPhysicalAsset;

  /**
   * The {@link EventCategory} this relation connects to.
   */
  to: IEventCategory;

  /**
   * Display string for UI to represent this relation
   */
  displayStr?: string;

  /**
   * The predictions associated with this relation
   */
  predictions?: Array_Type<TimeToEventPrediction> | Array<ITimeToEventPrediction>;

  /**
   * The latest prediction for this asset/event combination
   */
  latestPrediction?: ITimeToEventPrediction;

  /**
   * How often a prediction is generated for this event-asset combination, in terms of number of hours
   */
  predictionFrequency?: number;

  /**
   * The last date where a prediction was generated for this event-asset combination
   */
  lastPredictionDate?: DateTime | Date | string;

  /**
   * All instances of {@link ProbabilisticForecastResult} associated with this relation
   */
  probabilisticForecastResults?: Array_Type<ProbabilisticForecastResult> | Array<IProbabilisticForecastResult>;
}

/**
 * Represents the relation between a {@link PhysicalAsset} and an {@link EventCategory}.
 *
 * @remarks this represents a made instance of PhysicalAssetEventCategoryRelation
 */
declare class PhysicalAssetEventCategoryRelation extends Obj  {
  ...
  withTypeIdent(typeIdent: string | null): PhysicalAssetEventCategoryRelation;
   ...
   */
  readonly id: string;
  withId(id: string): PhysicalAssetEventCategoryRelation;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): PhysicalAssetEventCategoryRelation;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): PhysicalAssetEventCategoryRelation;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): PhysicalAssetEventCategoryRelation;
  ...
  withVersion(version: number | null): PhysicalAssetEventCategoryRelation;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): PhysicalAssetEventCategoryRelation;

  /**
   * The {@link PhysicalAsset} this relation comes from.
   */
  readonly from: PhysicalAsset;
  withFrom(from: IPhysicalAsset): PhysicalAssetEventCategoryRelation;

  /**
   * The {@link EventCategory} this relation connects to.
   */
  readonly to: EventCategory;
  withTo(to: IEventCategory): PhysicalAssetEventCategoryRelation;

  /**
   * Display string for UI to represent this relation
   */
  readonly displayStr?: string;
  withDisplayStr(displayStr: string | null): PhysicalAssetEventCategoryRelation;

  /**
   * The predictions associated with this relation
   */
  readonly predictions?: Array_Type<TimeToEventPrediction>;
  withPredictions(predictions: Array_Type<TimeToEventPrediction> | Array<ITimeToEventPrediction> | null): PhysicalAssetEventCategoryRelation;

  /**
   * The latest prediction for this asset/event combination
   */
  readonly latestPrediction?: TimeToEventPrediction;
  withLatestPrediction(latestPrediction: ITimeToEventPrediction | null): PhysicalAssetEventCategoryRelation;

  /**
   * How often a prediction is generated for this event-asset combination, in terms of number of hours
   */
  readonly predictionFrequency?: number;
  withPredictionFrequency(predictionFrequency: number | null): PhysicalAssetEventCategoryRelation;

  /**
   * The last date where a prediction was generated for this event-asset combination
   */
  readonly lastPredictionDate?: DateTime;
  withLastPredictionDate(lastPredictionDate: DateTime | Date | string | null): PhysicalAssetEventCategoryRelation;

  /**
   * All instances of {@link ProbabilisticForecastResult} associated with this relation
   */
  readonly probabilisticForecastResults?: Array_Type<ProbabilisticForecastResult>;
  withProbabilisticForecastResults(probabilisticForecastResults: Array_Type<ProbabilisticForecastResult> | Array<IProbabilisticForecastResult> | null): PhysicalAssetEventCategoryRelation;
   ...
   * @see #toJson
   */
  static fromJson(json: any): PhysicalAssetEventCategoryRelation | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): PhysicalAssetEventCategoryRelation | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): PhysicalAssetEventCategoryRelation | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): PhysicalAssetEventCategoryRelation | null;
   ...
   */
  replaceType(old: Type, new_: Type): PhysicalAssetEventCategoryRelation;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): PhysicalAssetEventCategoryRelation;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): PhysicalAssetEventCategoryRelation;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<PhysicalAssetEventCategoryRelation>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<PhysicalAssetEventCategoryRelation>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): PhysicalAssetEventCategoryRelation;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): PhysicalAssetEventCategoryRelation;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): PhysicalAssetEventCategoryRelation;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): PhysicalAssetEventCategoryRelation;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): PhysicalAssetEventCategoryRelation;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): PhysicalAssetEventCategoryRelation;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): PhysicalAssetEventCategoryRelation;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): PhysicalAssetEventCategoryRelation;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): PhysicalAssetEventCategoryRelation;
   ...
   * @see #removeField
   */
  withoutField(field: string): PhysicalAssetEventCategoryRelation;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): PhysicalAssetEventCategoryRelation;
   ...
   */
  withoutFields(fields: Array_Type<string>): PhysicalAssetEventCategoryRelation;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): PhysicalAssetEventCategoryRelation;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): PhysicalAssetEventCategoryRelation;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): PhysicalAssetEventCategoryRelation;
   ...
   * @see #unsetField
   */
  defaultField(field: string): PhysicalAssetEventCategoryRelation;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): PhysicalAssetEventCategoryRelation;
   ...
   * @see #removeField
   */
  unsetField(field: string): PhysicalAssetEventCategoryRelation;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): PhysicalAssetEventCategoryRelation;
   ...
   * @see #unsetField
   */
  removeField(field: string): PhysicalAssetEventCategoryRelation;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): PhysicalAssetEventCategoryRelation;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): PhysicalAssetEventCategoryRelation;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): PhysicalAssetEventCategoryRelation;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): PhysicalAssetEventCategoryRelation;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): PhysicalAssetEventCategoryRelation;

  mergeJson(json: any): PhysicalAssetEventCategoryRelation;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): PhysicalAssetEventCategoryRelation;
   ...
   */
  sumObj(other: Obj, deep?: boolean): PhysicalAssetEventCategoryRelation;
   ...
   */
  singletonArray(): Array_Type<PhysicalAssetEventCategoryRelation>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<PhysicalAssetEventCategoryRelation> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<PhysicalAssetEventCategoryRelation> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<PhysicalAssetEventCategoryRelation>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<PhysicalAssetEventCategoryRelation> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, PhysicalAssetEventCategoryRelation> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, PhysicalAssetEventCategoryRelation> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<PhysicalAssetEventCategoryRelation>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<PhysicalAssetEventCategoryRelation>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): PhysicalAssetEventCategoryRelation;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): PhysicalAssetEventCategoryRelation;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): PhysicalAssetEventCategoryRelation;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): PhysicalAssetEventCategoryRelation;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): PhysicalAssetEventCategoryRelation;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): PhysicalAssetEventCategoryRelation;
   ...
   * @see #fromString
   */
  static make(s: string): PhysicalAssetEventCategoryRelation | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): PhysicalAssetEventCategoryRelation;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): PhysicalAssetEventCategoryRelation;
   ...
   */
  static cachedEmptyInst(): PhysicalAssetEventCategoryRelation;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<PhysicalAssetEventCategoryRelation> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): PhysicalAssetEventCategoryRelation;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<PhysicalAssetEventCategoryRelation>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<PhysicalAssetEventCategoryRelation>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<PhysicalAssetEventCategoryRelation> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<PhysicalAssetEventCategoryRelation>> | null;
   ...
   */
  static evalFeatureSetBatch(batch: Array_Type<PhysicalAssetEventCategoryRelation>, featureSet: Feature.Set, spec?: EvalFeatureSpec): Data | null;
   ...
   * ```
   */
  static evalFeaturesBatch(batch: Array_Type<PhysicalAssetEventCategoryRelation>, features: Array_Type<string>, spec?: EvalFeaturesSpec): Data | null;
   ...
   */
  get(include?: string): PhysicalAssetEventCategoryRelation | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): PhysicalAssetEventCategoryRelation | null;
   ...
   */
  getMissing(spec: GetMissingSpec): PhysicalAssetEventCategoryRelation;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): PhysicalAssetEventCategoryRelation | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): PhysicalAssetEventCategoryRelation;
   ...
   * @see #toString
   */
  static fromString(s: string): PhysicalAssetEventCategoryRelation | null;
   ...
   */
  create(spec?: UpsertSpec): PhysicalAssetEventCategoryRelation | null;
   ...
   */
  static createBatch(objs: Array_Type<PhysicalAssetEventCategoryRelation>, spec?: UpsertSpec): ObjList<PhysicalAssetEventCategoryRelation> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<PhysicalAssetEventCategoryRelation>, spec?: CreateBatchObjStreamSpec): ObjList<PhysicalAssetEventCategoryRelation> | null;
   ...
   */
  update(srcObj?: PhysicalAssetEventCategoryRelation, spec?: UpsertSpec): PhysicalAssetEventCategoryRelation | null;
   ...
   */
  upsert(srcObj?: PhysicalAssetEventCategoryRelation, spec?: UpsertSpec): PhysicalAssetEventCategoryRelation | null;
   ...
   */
  merge(spec?: MergeSpec): PhysicalAssetEventCategoryRelation | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): PhysicalAssetEventCategoryRelation | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): PhysicalAssetEventCategoryRelation | null;
   ...
   */
  static updateBatch(objs: Array_Type<PhysicalAssetEventCategoryRelation>, srcObjs?: Array_Type<PhysicalAssetEventCategoryRelation>, spec?: UpsertSpec): ObjList<PhysicalAssetEventCategoryRelation> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<PhysicalAssetEventCategoryRelation> | null>, spec?: UpsertSpec): ObjList<PhysicalAssetEventCategoryRelation> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<PhysicalAssetEventCategoryRelation>, srcObjs?: Array_Type<PhysicalAssetEventCategoryRelation>, spec?: UpsertSpec): ObjList<PhysicalAssetEventCategoryRelation> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<PhysicalAssetEventCategoryRelation> | null>, spec?: UpsertSpec): ObjList<PhysicalAssetEventCategoryRelation> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<PhysicalAssetEventCategoryRelation>, spec?: TouchSpec): ObjList<PhysicalAssetEventCategoryRelation> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<PhysicalAssetEventCategoryRelation>, spec?: MergeSpec): ObjList<PhysicalAssetEventCategoryRelation> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<PhysicalAssetEventCategoryRelation>, mergeInclude: string, spec?: MergeSpec): ObjList<PhysicalAssetEventCategoryRelation> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<PhysicalAssetEventCategoryRelation> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<PhysicalAssetEventCategoryRelation> | null;
   ...
   */
  static mergeAll(mergeObj: PhysicalAssetEventCategoryRelation, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: PhysicalAssetEventCategoryRelation, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<PhysicalAssetEventCategoryRelation>, spec?: UpsertSpec): ObjList<PhysicalAssetEventCategoryRelation> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<PhysicalAssetEventCategoryRelation>, spec?: UpsertSpec): ObjList<PhysicalAssetEventCategoryRelation> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): PhysicalAssetEventCategoryRelation | null;
   ...
   */
  static beforeCreate(objs: Array_Type<PhysicalAssetEventCategoryRelation>): ObjList<PhysicalAssetEventCategoryRelation>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<PhysicalAssetEventCategoryRelation>): ObjList<PhysicalAssetEventCategoryRelation>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<PhysicalAssetEventCategoryRelation>): ObjList<PhysicalAssetEventCategoryRelation>;
   ...
   */
  static afterCreate(objs: Array_Type<PhysicalAssetEventCategoryRelation>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<PhysicalAssetEventCategoryRelation>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<PhysicalAssetEventCategoryRelation>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<PhysicalAssetEventCategoryRelation>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<PhysicalAssetEventCategoryRelation>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): PhysicalAssetEventCategoryRelation | null;
   ...
   */
  withoutIdentity(): PhysicalAssetEventCategoryRelation | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<PhysicalAssetEventCategoryRelation>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: PhysicalAssetEventCategoryRelation, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<PhysicalAssetEventCategoryRelation>, callback?: λFunction<PhysicalAssetEventCategoryRelation | null, PhysicalAssetEventCategoryRelation | null>): ObjList<PhysicalAssetEventCategoryRelation>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<PhysicalAssetEventCategoryRelation>, callback?: λFunction<PhysicalAssetEventCategoryRelation | null, PhysicalAssetEventCategoryRelation | null>): Array_Type<ObjError> | null;
