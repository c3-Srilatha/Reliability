// TypeScript definitions for the C3 type ReliabilityAssetReportJob

/**
 * A map reduce job that generates a single PDF file containing reports for multiple {@link ReliabilityAsset}s
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityAssetReportJob
 */
declare interface IReliabilityAssetReportJob {
   ...
   */
  report: IReliabilityAssetReport;
 ...
 */
declare class ReliabilityAssetReportJob extends Obj  {
   ...
   */
  readonly id: string;
  withId(id: string): ReliabilityAssetReportJob;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityAssetReportJob;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): ReliabilityAssetReportJob;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): ReliabilityAssetReportJob;
  ...
  withVersion(version: number | null): ReliabilityAssetReportJob;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): ReliabilityAssetReportJob;

  /**
   * @inheritdoc
   */
  readonly facilityFilterPaths?: Array_Type<string>;
  withFacilityFilterPaths(facilityFilterPaths: Array_Type<string> | Array<string> | null): ReliabilityAssetReportJob;

  /**
   * current or last job execution for this instance
   */
  readonly run?: MapReduceRun;
  withRun(run: IMapReduceRun | null): ReliabilityAssetReportJob;

  /**
   * previous job executions for this instance
   */
  readonly runs?: Array_Type<MapReduceRun>;
  withRuns(runs: Array_Type<MapReduceRun> | Array<IMapReduceRun> | null): ReliabilityAssetReportJob;

  /**
   * FOR INTERNAL USE ONLY - Specify options in call to {@link start}.
   */
  readonly options?: Obj;
  withOptions(options: IObj | null): ReliabilityAssetReportJob;
  ...
  withOnCompleteCallback(onCompleteCallback: IJobBase.Callback | null): ReliabilityAssetReportJob;
  ...
  withPriority(priority: number | null): ReliabilityAssetReportJob;
  ...
  withDisabled(disabled: boolean): ReliabilityAssetReportJob;
  ...
  withMaxConcurrency(maxConcurrency: number | null): ReliabilityAssetReportJob;
  ...
  withMaxConcurrencyPerNode(maxConcurrencyPerNode: number | null): ReliabilityAssetReportJob;
  ...
  withRunAsUser(runAsUser: boolean): ReliabilityAssetReportJob;

  /**
   * Don't set this field in the MapReduce job, set it in the MapReduceOptions when calling `start`.
   */
  readonly nodePool?: string;
  withNodePool(nodePool: string | null): ReliabilityAssetReportJob;
  ...
  withSkipIfRunning(skipIfRunning: boolean): ReliabilityAssetReportJob;

  /**
   * Set to between 1 and 5 to enable auto recovery. See {@link invalidation-queues.c3doc Invalidation Queues} for detailed documentation.
   */
  readonly numAutoRecoveryAttempts?: number;
  withNumAutoRecoveryAttempts(numAutoRecoveryAttempts: number | null): ReliabilityAssetReportJob;
  ...
  withPropagateActionContext(propagateActionContext: boolean): ReliabilityAssetReportJob;
  ...
  withTargetType(targetType: IType | null): ReliabilityAssetReportJob;
  ...
  withUseFileSystemForInterVals(useFileSystemForInterVals: boolean): ReliabilityAssetReportJob;
  ...
  withUseBatchIdsForReadInput(useBatchIdsForReadInput: boolean): ReliabilityAssetReportJob;
  ...
  withInclude(include: string | null): ReliabilityAssetReportJob;

  /**
   * optional filter spec
   */
  readonly filter?: string;
  withFilter(filter: string | null): ReliabilityAssetReportJob;
  ...
  withOrder(order: string | null): ReliabilityAssetReportJob;
  ...
  withLimit(limit: number | null): ReliabilityAssetReportJob;
  ...
  withSamplePct(samplePct: number | null): ReliabilityAssetReportJob;
  ...
  withBatchSize(batchSize: number | null): ReliabilityAssetReportJob;
  ...
  withSubBatchSize(subBatchSize: number | null): ReliabilityAssetReportJob;
  ...
  withNumBatches(numBatches: number | null): ReliabilityAssetReportJob;
  ...
  withAbortOnError(abortOnError: boolean): ReliabilityAssetReportJob;
  ...
  withTypeIdent(typeIdent: string | null): ReliabilityAssetReportJob;
  ...
  withTargetFilter(targetFilter: IReliabilityAsset | null): ReliabilityAssetReportJob;

  /**
   * the {@link ReliabilityAssetReport} based on which to generate a report for {@link ReliabilityAsset}s
   */
  readonly report: ReliabilityAssetReport;
  withReport(report: IReliabilityAssetReport): ReliabilityAssetReportJob;
  ...
  withMapDirectory(mapDirectory: string): ReliabilityAssetReportJob;
   ...
   * @see #toJson
   */
  static fromJson(json: any): ReliabilityAssetReportJob | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): ReliabilityAssetReportJob | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): ReliabilityAssetReportJob | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): ReliabilityAssetReportJob | null;
   ...
   */
  replaceType(old: Type, new_: Type): ReliabilityAssetReportJob;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityAssetReportJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityAssetReportJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityAssetReportJob>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityAssetReportJob>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityAssetReportJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityAssetReportJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityAssetReportJob;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ReliabilityAssetReportJob;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ReliabilityAssetReportJob;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityAssetReportJob;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityAssetReportJob;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityAssetReportJob;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ReliabilityAssetReportJob;
   ...
   * @see #removeField
   */
  withoutField(field: string): ReliabilityAssetReportJob;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): ReliabilityAssetReportJob;
   ...
   */
  withoutFields(fields: Array_Type<string>): ReliabilityAssetReportJob;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityAssetReportJob;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ReliabilityAssetReportJob;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityAssetReportJob;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ReliabilityAssetReportJob;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ReliabilityAssetReportJob;
   ...
   * @see #removeField
   */
  unsetField(field: string): ReliabilityAssetReportJob;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ReliabilityAssetReportJob;
   ...
   * @see #unsetField
   */
  removeField(field: string): ReliabilityAssetReportJob;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ReliabilityAssetReportJob;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityAssetReportJob;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityAssetReportJob;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityAssetReportJob;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityAssetReportJob;

  mergeJson(json: any): ReliabilityAssetReportJob;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityAssetReportJob;
   ...
   */
  sumObj(other: Obj, deep?: boolean): ReliabilityAssetReportJob;
   ...
   */
  singletonArray(): Array_Type<ReliabilityAssetReportJob>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityAssetReportJob> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ReliabilityAssetReportJob> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<ReliabilityAssetReportJob>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ReliabilityAssetReportJob> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, ReliabilityAssetReportJob> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityAssetReportJob> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ReliabilityAssetReportJob>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ReliabilityAssetReportJob>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityAssetReportJob;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityAssetReportJob;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityAssetReportJob;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ReliabilityAssetReportJob;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityAssetReportJob;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ReliabilityAssetReportJob;
   ...
   * @see #fromString
   */
  static make(s: string): ReliabilityAssetReportJob | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityAssetReportJob;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): ReliabilityAssetReportJob;
   ...
   */
  static cachedEmptyInst(): ReliabilityAssetReportJob;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityAssetReportJob> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): ReliabilityAssetReportJob;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<ReliabilityAssetReportJob>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<ReliabilityAssetReportJob>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityAssetReportJob> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityAssetReportJob>> | null;
   ...
   */
  get(include?: string): ReliabilityAssetReportJob | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): ReliabilityAssetReportJob | null;
   ...
   */
  getMissing(spec: GetMissingSpec): ReliabilityAssetReportJob;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): ReliabilityAssetReportJob | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): ReliabilityAssetReportJob;
   ...
   * @see #toString
   */
  static fromString(s: string): ReliabilityAssetReportJob | null;
   ...
   */
  create(spec?: UpsertSpec): ReliabilityAssetReportJob | null;
   ...
   */
  static createBatch(objs: Array_Type<ReliabilityAssetReportJob>, spec?: UpsertSpec): ObjList<ReliabilityAssetReportJob> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<ReliabilityAssetReportJob>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityAssetReportJob> | null;
   ...
   */
  update(srcObj?: ReliabilityAssetReportJob, spec?: UpsertSpec): ReliabilityAssetReportJob | null;
   ...
   */
  upsert(srcObj?: ReliabilityAssetReportJob, spec?: UpsertSpec): ReliabilityAssetReportJob | null;
   ...
   */
  merge(spec?: MergeSpec): ReliabilityAssetReportJob | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): ReliabilityAssetReportJob | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): ReliabilityAssetReportJob | null;
   ...
   */
  static updateBatch(objs: Array_Type<ReliabilityAssetReportJob>, srcObjs?: Array_Type<ReliabilityAssetReportJob>, spec?: UpsertSpec): ObjList<ReliabilityAssetReportJob> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<ReliabilityAssetReportJob> | null>, spec?: UpsertSpec): ObjList<ReliabilityAssetReportJob> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<ReliabilityAssetReportJob>, srcObjs?: Array_Type<ReliabilityAssetReportJob>, spec?: UpsertSpec): ObjList<ReliabilityAssetReportJob> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<ReliabilityAssetReportJob> | null>, spec?: UpsertSpec): ObjList<ReliabilityAssetReportJob> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<ReliabilityAssetReportJob>, spec?: TouchSpec): ObjList<ReliabilityAssetReportJob> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityAssetReportJob>, spec?: MergeSpec): ObjList<ReliabilityAssetReportJob> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityAssetReportJob>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityAssetReportJob> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<ReliabilityAssetReportJob> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityAssetReportJob> | null;
   ...
   */
  static mergeAll(mergeObj: ReliabilityAssetReportJob, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: ReliabilityAssetReportJob, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<ReliabilityAssetReportJob>, spec?: UpsertSpec): ObjList<ReliabilityAssetReportJob> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<ReliabilityAssetReportJob>, spec?: UpsertSpec): ObjList<ReliabilityAssetReportJob> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): ReliabilityAssetReportJob | null;
   ...
   */
  static beforeCreate(objs: Array_Type<ReliabilityAssetReportJob>): ObjList<ReliabilityAssetReportJob>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<ReliabilityAssetReportJob>): ObjList<ReliabilityAssetReportJob>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<ReliabilityAssetReportJob>): ObjList<ReliabilityAssetReportJob>;
   ...
   */
  static afterCreate(objs: Array_Type<ReliabilityAssetReportJob>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<ReliabilityAssetReportJob>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<ReliabilityAssetReportJob>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityAssetReportJob>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityAssetReportJob>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): ReliabilityAssetReportJob | null;
   ...
   */
  withoutIdentity(): ReliabilityAssetReportJob | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<ReliabilityAssetReportJob>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: ReliabilityAssetReportJob, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<ReliabilityAssetReportJob>, callback?: λFunction<ReliabilityAssetReportJob | null, ReliabilityAssetReportJob | null>): ObjList<ReliabilityAssetReportJob>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<ReliabilityAssetReportJob>, callback?: λFunction<ReliabilityAssetReportJob | null, ReliabilityAssetReportJob | null>): Array_Type<ObjError> | null;
   ...
   */
  static map(batch?: number, objs?: Array_Type<ReliabilityAsset>, job?: MapReduce<ReliabilityAsset, string, File, File>, subBatch?: number): Map_Type<string, File> | null;
   ...
   */
  static reduce(outKey?: string, interValues?: Array_Type<File>, job?: MapReduce<ReliabilityAsset, string, File, File>): File | Array_Type<File> | null;
   ...
   */
  static mapCompleted(job?: MapReduce<ReliabilityAsset, string, File, File>): void;
   ...
   */
  static completed(job?: MapReduce<ReliabilityAsset, string, File, File>): string | null;
   ...
   */
  static failed(job: MapReduce<ReliabilityAsset, string, File, File>, status: MapReduceStatus, options?: MapReduceOptions): void;
