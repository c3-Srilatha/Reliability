// TypeScript definitions for the C3 type BulkDataPreparationUiSettings

/**
 * Type to store UI dataset preparation settings for a run of data prep on multiple assets.
 * The settings serve as input arguments to create a {@link ReliabilityMlDatasetPreparationSpec}
 * for multiple assets.
 *
 * To start the job using this settings, use {@link BulkModelSetupUiSettings}.
 *
 * @remarks this represents a value passed to a method that expects an instance of BulkDataPreparationUiSettings
 */
declare interface IBulkDataPreparationUiSettings {
 ...
 * To start the job using this settings, use {@link BulkModelSetupUiSettings}.
 *
 * @remarks this represents a made instance of BulkDataPreparationUiSettings
 */
declare class BulkDataPreparationUiSettings extends Obj  {
  ...
  withNonOperationalMasks(nonOperationalMasks: Array_Type<ReliabilityDataPreparationRuleMaskSpec> | Array<IReliabilityDataPreparationRuleMaskSpec> | null): BulkDataPreparationUiSettings;
  ...
  withPreNonOperationalMaskPeriod(preNonOperationalMaskPeriod: IPeriod | null): BulkDataPreparationUiSettings;
  ...
  withPostNonOperationalTrainingMaskPeriod(postNonOperationalTrainingMaskPeriod: IPeriod | null): BulkDataPreparationUiSettings;
  ...
  withPostNonOperationalInferenceMaskPeriod(postNonOperationalInferenceMaskPeriod: IPeriod | null): BulkDataPreparationUiSettings;

  /**
   * A {@link Period} of time before each [event](ReliabilityAssetEvent) to exclude {@link Sensor} data for training.
   */
  readonly preEventMaskPeriod: Period;
  withPreEventMaskPeriod(preEventMaskPeriod: IPeriod): BulkDataPreparationUiSettings;

  /**
   * A {@link Period} of time after each [event](ReliabilityAssetEvent) to exclude {@link Sensor} data for training and inference.
   */
  readonly postEventMaskPeriod: Period;
  withPostEventMaskPeriod(postEventMaskPeriod: IPeriod): BulkDataPreparationUiSettings;

  /**
   * {@link TimeRange}s to exclude {@Sensor} data from training data.
   */
  readonly dateRangeMaskTimeRanges?: Array_Type<TimeRange>;
  withDateRangeMaskTimeRanges(dateRangeMaskTimeRanges: Array_Type<TimeRange> | Array<ITimeRange> | null): BulkDataPreparationUiSettings;
  ...
  withTrainingRuleMasks(trainingRuleMasks: Array_Type<ReliabilityDataPreparationRuleMaskSpec> | Array<IReliabilityDataPreparationRuleMaskSpec> | null): BulkDataPreparationUiSettings;
  ...
  withInferenceRuleMasks(inferenceRuleMasks: Array_Type<ReliabilityDataPreparationRuleMaskSpec> | Array<IReliabilityDataPreparationRuleMaskSpec> | null): BulkDataPreparationUiSettings;

  /**
   * String of rules indicating the time period when {@link ReliabilityAsset} was non-operational
   */
  readonly nonOperationalMasksExpression?: string;
  withNonOperationalMasksExpression(nonOperationalMasksExpression: string | null): BulkDataPreparationUiSettings;

  /**
   * String of rules indicating the time periods to exclude {@link Sensor} data from training data.
   */
  readonly trainingRuleMasksExpression?: string;
  withTrainingRuleMasksExpression(trainingRuleMasksExpression: string | null): BulkDataPreparationUiSettings;

  /**
   * String of rules indicating the time periods to exclude {@link Sensor} data from inference data.
   */
  readonly inferenceRuleMasksExpression?: string;
  withInferenceRuleMasksExpression(inferenceRuleMasksExpression: string | null): BulkDataPreparationUiSettings;

  /**
   * The flatline sensor data threshold to use for the Data Preparation Job
   */
  readonly flatlineThreshold?: number;
  withFlatlineThreshold(flatlineThreshold: number | null): BulkDataPreparationUiSettings;

  /**
   * The missing sensor data threshold to use for the Data Preparation Job
   */
  readonly missingDataThreshold?: number;
  withMissingDataThreshold(missingDataThreshold: number | null): BulkDataPreparationUiSettings;

  /**
   * Start {@link datetime} of window for {@link Sensor} data utilized in the dataset.
   */
  readonly windowStart: DateTime;
  withWindowStart(windowStart: DateTime | Date | string): BulkDataPreparationUiSettings;

  /**
   * End {@link datetime} of window for {@link Sensor} data utilized in the dataset.
   */
  readonly windowEnd: DateTime;
  withWindowEnd(windowEnd: DateTime | Date | string): BulkDataPreparationUiSettings;

  /**
   * The percentage of the dataset used for training.
   */
  readonly trainingPercentage: number;
  withTrainingPercentage(trainingPercentage: number): BulkDataPreparationUiSettings;

  /**
   * Start Date of the dataset used for training.
   */
  readonly trainStart?: DateTime;
  withTrainStart(trainStart: DateTime | Date | string | null): BulkDataPreparationUiSettings;

  /**
   * End Date of the dataset used for training.
   */
  readonly trainEnd?: DateTime;
  withTrainEnd(trainEnd: DateTime | Date | string | null): BulkDataPreparationUiSettings;

  /**
   * Start Date of the dataset used for Validating.
   */
  readonly validStart?: DateTime;
  withValidStart(validStart: DateTime | Date | string | null): BulkDataPreparationUiSettings;

  /**
   * End Date of the dataset used for Validating.
   */
  readonly validEnd?: DateTime;
  withValidEnd(validEnd: DateTime | Date | string | null): BulkDataPreparationUiSettings;

  /**
   * The subset of the dataset to use for training.
   */
  readonly trainingSubset: string;
  withTrainingSubset(trainingSubset: string): BulkDataPreparationUiSettings;

  /**
   * The data {@link Interval} to analyze the data of the {@link Sensor}.
   */
  readonly interval: string;
  withInterval(interval: string): BulkDataPreparationUiSettings;
  ...
  withNumAssets(numAssets: number | null): BulkDataPreparationUiSettings;
  ...
  withTargetAssets(targetAssets: Array_Type<ReliabilityAsset> | Array<IReliabilityAsset> | null): BulkDataPreparationUiSettings;
  ...
  withIncludeSensors(includeSensors: Array_Type<Sensor> | Array<ISensor> | null): BulkDataPreparationUiSettings;
  ...
  withExcludeSensors(excludeSensors: Array_Type<Sensor> | Array<ISensor> | null): BulkDataPreparationUiSettings;

  /**
   * Variance value used to filter {@link SensorDataReport}
   */
  readonly variance?: number;
  withVariance(variance: number | null): BulkDataPreparationUiSettings;

  /**
   * Stores the id of the {@link MlProject} that the user selected to create the new dataset
   */
  readonly project?: ReliabilityMl.Project;
  withProject(project: IReliabilityMl.Project | null): BulkDataPreparationUiSettings;

  /**
   * The date time ranges selected by the user for training
   */
  readonly trainingDatasetTimeRanges?: Array_Type<TimeRange>;
  withTrainingDatasetTimeRanges(trainingDatasetTimeRanges: Array_Type<TimeRange> | Array<ITimeRange> | null): BulkDataPreparationUiSettings;

  /**
   * The date time ranges selected by the user for validation
   */
  readonly validateDatasetTimeRanges?: Array_Type<TimeRange>;
  withValidateDatasetTimeRanges(validateDatasetTimeRanges: Array_Type<TimeRange> | Array<ITimeRange> | null): BulkDataPreparationUiSettings;

  /**
   * The selected split type, can be either by percentage or by time ranges.
   */
  readonly splitByPercentage?: boolean;
  withSplitByPercentage(splitByPercentage: boolean): BulkDataPreparationUiSettings;
  ...
  withExtraTimeRangeMasks(extraTimeRangeMasks: Array_Type<TimeRange> | Array<ITimeRange> | null): BulkDataPreparationUiSettings;

  /**
   * Field name containing the desired name for the {@link ReliabilityMlDatasetPreparationJob}.
   */
  readonly jobName?: string;
  withJobName(jobName: string | null): BulkDataPreparationUiSettings;
   ...
   * @see #toJson
   */
  static fromJson(json: any): BulkDataPreparationUiSettings | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): BulkDataPreparationUiSettings | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): BulkDataPreparationUiSettings | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): BulkDataPreparationUiSettings | null;
   ...
   */
  replaceType(old: Type, new_: Type): BulkDataPreparationUiSettings;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): BulkDataPreparationUiSettings;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): BulkDataPreparationUiSettings;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<BulkDataPreparationUiSettings>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<BulkDataPreparationUiSettings>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): BulkDataPreparationUiSettings;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): BulkDataPreparationUiSettings;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): BulkDataPreparationUiSettings;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): BulkDataPreparationUiSettings;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): BulkDataPreparationUiSettings;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): BulkDataPreparationUiSettings;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): BulkDataPreparationUiSettings;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): BulkDataPreparationUiSettings;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): BulkDataPreparationUiSettings;
   ...
   * @see #removeField
   */
  withoutField(field: string): BulkDataPreparationUiSettings;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): BulkDataPreparationUiSettings;
   ...
   */
  withoutFields(fields: Array_Type<string>): BulkDataPreparationUiSettings;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): BulkDataPreparationUiSettings;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): BulkDataPreparationUiSettings;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): BulkDataPreparationUiSettings;
   ...
   * @see #unsetField
   */
  defaultField(field: string): BulkDataPreparationUiSettings;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): BulkDataPreparationUiSettings;
   ...
   * @see #removeField
   */
  unsetField(field: string): BulkDataPreparationUiSettings;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): BulkDataPreparationUiSettings;
   ...
   * @see #unsetField
   */
  removeField(field: string): BulkDataPreparationUiSettings;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): BulkDataPreparationUiSettings;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): BulkDataPreparationUiSettings;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): BulkDataPreparationUiSettings;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): BulkDataPreparationUiSettings;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): BulkDataPreparationUiSettings;

  mergeJson(json: any): BulkDataPreparationUiSettings;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): BulkDataPreparationUiSettings;
   ...
   */
  sumObj(other: Obj, deep?: boolean): BulkDataPreparationUiSettings;
   ...
   */
  singletonArray(): Array_Type<BulkDataPreparationUiSettings>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<BulkDataPreparationUiSettings> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<BulkDataPreparationUiSettings> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<BulkDataPreparationUiSettings>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<BulkDataPreparationUiSettings> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, BulkDataPreparationUiSettings> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, BulkDataPreparationUiSettings> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<BulkDataPreparationUiSettings>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<BulkDataPreparationUiSettings>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): BulkDataPreparationUiSettings;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): BulkDataPreparationUiSettings;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): BulkDataPreparationUiSettings;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): BulkDataPreparationUiSettings;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): BulkDataPreparationUiSettings;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): BulkDataPreparationUiSettings;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): BulkDataPreparationUiSettings;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): BulkDataPreparationUiSettings;
   ...
   */
  static cachedEmptyInst(): BulkDataPreparationUiSettings;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<BulkDataPreparationUiSettings> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): BulkDataPreparationUiSettings;
