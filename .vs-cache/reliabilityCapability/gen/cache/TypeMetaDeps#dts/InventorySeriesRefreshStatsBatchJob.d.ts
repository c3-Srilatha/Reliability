// TypeScript definitions for the C3 type InventorySeriesRefreshStatsBatchJob

/**
 * A batch job that refreshes the stats for all parts in {@link InventorySeries}.
 *
 * @remarks this represents a value passed to a method that expects an instance of InventorySeriesRefreshStatsBatchJob
 */
declare interface IInventorySeriesRefreshStatsBatchJob {
 ...
 */
declare class InventorySeriesRefreshStatsBatchJob extends Obj  {

  /**
   * current or last job execution for this instance
   */
  readonly run?: BatchJobRun;
  withRun(run: IBatchJobRun | null): InventorySeriesRefreshStatsBatchJob;

  /**
   * previous job executions for this instance
   */
  readonly runs?: Array_Type<BatchJobRun>;
  withRuns(runs: Array_Type<BatchJobRun> | Array<IBatchJobRun> | null): InventorySeriesRefreshStatsBatchJob;

  /**
   * FOR INTERNAL USE ONLY - Specify options in call to {@link start}.
   */
  readonly options?: Obj;
  withOptions(options: IObj | null): InventorySeriesRefreshStatsBatchJob;
  ...
  withOnCompleteCallback(onCompleteCallback: IJobBase.Callback | null): InventorySeriesRefreshStatsBatchJob;
  ...
  withPriority(priority: number | null): InventorySeriesRefreshStatsBatchJob;
  ...
  withDisabled(disabled: boolean): InventorySeriesRefreshStatsBatchJob;
  ...
  withMaxConcurrency(maxConcurrency: number | null): InventorySeriesRefreshStatsBatchJob;
  ...
  withMaxConcurrencyPerNode(maxConcurrencyPerNode: number | null): InventorySeriesRefreshStatsBatchJob;
  ...
  withRunAsUser(runAsUser: boolean): InventorySeriesRefreshStatsBatchJob;

  /**
   * Don't set this field in the BatchJob, set it in the BatchJobOptions when calling `start`
   */
  readonly nodePool?: string;
  withNodePool(nodePool: string | null): InventorySeriesRefreshStatsBatchJob;
  ...
  withSkipIfRunning(skipIfRunning: boolean): InventorySeriesRefreshStatsBatchJob;

  /**
   * Set to between 1 and 5 to enable auto recovery. See {@link invalidation-queues.c3doc Invalidation Queues} for detailed documentation.
   */
  readonly numAutoRecoveryAttempts?: number;
  withNumAutoRecoveryAttempts(numAutoRecoveryAttempts: number | null): InventorySeriesRefreshStatsBatchJob;
  ...
  withPropagateActionContext(propagateActionContext: boolean): InventorySeriesRefreshStatsBatchJob;
  ...
  withTypeIdent(typeIdent: string | null): InventorySeriesRefreshStatsBatchJob;
   ...
   */
  readonly id: string;
  withId(id: string): InventorySeriesRefreshStatsBatchJob;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): InventorySeriesRefreshStatsBatchJob;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): InventorySeriesRefreshStatsBatchJob;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): InventorySeriesRefreshStatsBatchJob;
  ...
  withVersion(version: number | null): InventorySeriesRefreshStatsBatchJob;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): InventorySeriesRefreshStatsBatchJob;
  ...
  withAbortOnError(abortOnError: boolean): InventorySeriesRefreshStatsBatchJob;
   ...
   * @see #toJson
   */
  static fromJson(json: any): InventorySeriesRefreshStatsBatchJob | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): InventorySeriesRefreshStatsBatchJob | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): InventorySeriesRefreshStatsBatchJob | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): InventorySeriesRefreshStatsBatchJob | null;
   ...
   */
  replaceType(old: Type, new_: Type): InventorySeriesRefreshStatsBatchJob;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): InventorySeriesRefreshStatsBatchJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): InventorySeriesRefreshStatsBatchJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<InventorySeriesRefreshStatsBatchJob>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<InventorySeriesRefreshStatsBatchJob>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): InventorySeriesRefreshStatsBatchJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): InventorySeriesRefreshStatsBatchJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): InventorySeriesRefreshStatsBatchJob;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): InventorySeriesRefreshStatsBatchJob;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): InventorySeriesRefreshStatsBatchJob;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): InventorySeriesRefreshStatsBatchJob;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): InventorySeriesRefreshStatsBatchJob;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): InventorySeriesRefreshStatsBatchJob;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): InventorySeriesRefreshStatsBatchJob;
   ...
   * @see #removeField
   */
  withoutField(field: string): InventorySeriesRefreshStatsBatchJob;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): InventorySeriesRefreshStatsBatchJob;
   ...
   */
  withoutFields(fields: Array_Type<string>): InventorySeriesRefreshStatsBatchJob;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): InventorySeriesRefreshStatsBatchJob;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): InventorySeriesRefreshStatsBatchJob;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): InventorySeriesRefreshStatsBatchJob;
   ...
   * @see #unsetField
   */
  defaultField(field: string): InventorySeriesRefreshStatsBatchJob;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): InventorySeriesRefreshStatsBatchJob;
   ...
   * @see #removeField
   */
  unsetField(field: string): InventorySeriesRefreshStatsBatchJob;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): InventorySeriesRefreshStatsBatchJob;
   ...
   * @see #unsetField
   */
  removeField(field: string): InventorySeriesRefreshStatsBatchJob;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): InventorySeriesRefreshStatsBatchJob;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): InventorySeriesRefreshStatsBatchJob;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): InventorySeriesRefreshStatsBatchJob;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): InventorySeriesRefreshStatsBatchJob;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): InventorySeriesRefreshStatsBatchJob;

  mergeJson(json: any): InventorySeriesRefreshStatsBatchJob;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): InventorySeriesRefreshStatsBatchJob;
   ...
   */
  sumObj(other: Obj, deep?: boolean): InventorySeriesRefreshStatsBatchJob;
   ...
   */
  singletonArray(): Array_Type<InventorySeriesRefreshStatsBatchJob>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<InventorySeriesRefreshStatsBatchJob> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<InventorySeriesRefreshStatsBatchJob> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<InventorySeriesRefreshStatsBatchJob>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<InventorySeriesRefreshStatsBatchJob> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, InventorySeriesRefreshStatsBatchJob> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, InventorySeriesRefreshStatsBatchJob> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<InventorySeriesRefreshStatsBatchJob>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<InventorySeriesRefreshStatsBatchJob>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): InventorySeriesRefreshStatsBatchJob;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): InventorySeriesRefreshStatsBatchJob;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): InventorySeriesRefreshStatsBatchJob;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): InventorySeriesRefreshStatsBatchJob;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): InventorySeriesRefreshStatsBatchJob;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): InventorySeriesRefreshStatsBatchJob;
   ...
   * @see #fromString
   */
  static make(s: string): InventorySeriesRefreshStatsBatchJob | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): InventorySeriesRefreshStatsBatchJob;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): InventorySeriesRefreshStatsBatchJob;
   ...
   */
  static cachedEmptyInst(): InventorySeriesRefreshStatsBatchJob;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<InventorySeriesRefreshStatsBatchJob> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): InventorySeriesRefreshStatsBatchJob;
   ...
   */
  start(options?: InventorySeriesRefreshStatsBatchJobOptions): BatchJobStatus | null;
   ...
   */
  cleanup(options?: InventorySeriesRefreshStatsBatchJobOptions): void;
  ...
  cancelJob(removeResults?: boolean, force?: boolean): JobBase<BatchJobRun, BatchJobStatus, InventorySeriesRefreshStatsBatchJobOptions> | null;

  failJob(run: JobRun<BatchJobStatusBase>): JobBase<BatchJobRun, BatchJobStatus, InventorySeriesRefreshStatsBatchJobOptions> | null;
  ...
  validateStart(options?: InventorySeriesRefreshStatsBatchJobOptions): void;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<InventorySeriesRefreshStatsBatchJob>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<InventorySeriesRefreshStatsBatchJob>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<InventorySeriesRefreshStatsBatchJob> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<InventorySeriesRefreshStatsBatchJob>> | null;
   ...
   */
  get(include?: string): InventorySeriesRefreshStatsBatchJob | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): InventorySeriesRefreshStatsBatchJob | null;
   ...
   */
  getMissing(spec: GetMissingSpec): InventorySeriesRefreshStatsBatchJob;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): InventorySeriesRefreshStatsBatchJob | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): InventorySeriesRefreshStatsBatchJob;
   ...
   * @see #toString
   */
  static fromString(s: string): InventorySeriesRefreshStatsBatchJob | null;
   ...
   */
  create(spec?: UpsertSpec): InventorySeriesRefreshStatsBatchJob | null;
   ...
   */
  static createBatch(objs: Array_Type<InventorySeriesRefreshStatsBatchJob>, spec?: UpsertSpec): ObjList<InventorySeriesRefreshStatsBatchJob> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<InventorySeriesRefreshStatsBatchJob>, spec?: CreateBatchObjStreamSpec): ObjList<InventorySeriesRefreshStatsBatchJob> | null;
   ...
   */
  update(srcObj?: InventorySeriesRefreshStatsBatchJob, spec?: UpsertSpec): InventorySeriesRefreshStatsBatchJob | null;
   ...
   */
  upsert(srcObj?: InventorySeriesRefreshStatsBatchJob, spec?: UpsertSpec): InventorySeriesRefreshStatsBatchJob | null;
   ...
   */
  merge(spec?: MergeSpec): InventorySeriesRefreshStatsBatchJob | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): InventorySeriesRefreshStatsBatchJob | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): InventorySeriesRefreshStatsBatchJob | null;
   ...
   */
  static updateBatch(objs: Array_Type<InventorySeriesRefreshStatsBatchJob>, srcObjs?: Array_Type<InventorySeriesRefreshStatsBatchJob>, spec?: UpsertSpec): ObjList<InventorySeriesRefreshStatsBatchJob> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<InventorySeriesRefreshStatsBatchJob> | null>, spec?: UpsertSpec): ObjList<InventorySeriesRefreshStatsBatchJob> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<InventorySeriesRefreshStatsBatchJob>, srcObjs?: Array_Type<InventorySeriesRefreshStatsBatchJob>, spec?: UpsertSpec): ObjList<InventorySeriesRefreshStatsBatchJob> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<InventorySeriesRefreshStatsBatchJob> | null>, spec?: UpsertSpec): ObjList<InventorySeriesRefreshStatsBatchJob> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<InventorySeriesRefreshStatsBatchJob>, spec?: TouchSpec): ObjList<InventorySeriesRefreshStatsBatchJob> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<InventorySeriesRefreshStatsBatchJob>, spec?: MergeSpec): ObjList<InventorySeriesRefreshStatsBatchJob> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<InventorySeriesRefreshStatsBatchJob>, mergeInclude: string, spec?: MergeSpec): ObjList<InventorySeriesRefreshStatsBatchJob> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<InventorySeriesRefreshStatsBatchJob> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<InventorySeriesRefreshStatsBatchJob> | null;
   ...
   */
  static mergeAll(mergeObj: InventorySeriesRefreshStatsBatchJob, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: InventorySeriesRefreshStatsBatchJob, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<InventorySeriesRefreshStatsBatchJob>, spec?: UpsertSpec): ObjList<InventorySeriesRefreshStatsBatchJob> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<InventorySeriesRefreshStatsBatchJob>, spec?: UpsertSpec): ObjList<InventorySeriesRefreshStatsBatchJob> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): InventorySeriesRefreshStatsBatchJob | null;
   ...
   */
  static beforeCreate(objs: Array_Type<InventorySeriesRefreshStatsBatchJob>): ObjList<InventorySeriesRefreshStatsBatchJob>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<InventorySeriesRefreshStatsBatchJob>): ObjList<InventorySeriesRefreshStatsBatchJob>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<InventorySeriesRefreshStatsBatchJob>): ObjList<InventorySeriesRefreshStatsBatchJob>;
   ...
   */
  static afterCreate(objs: Array_Type<InventorySeriesRefreshStatsBatchJob>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<InventorySeriesRefreshStatsBatchJob>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<InventorySeriesRefreshStatsBatchJob>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<InventorySeriesRefreshStatsBatchJob>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<InventorySeriesRefreshStatsBatchJob>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): InventorySeriesRefreshStatsBatchJob | null;
   ...
   */
  withoutIdentity(): InventorySeriesRefreshStatsBatchJob | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<InventorySeriesRefreshStatsBatchJob>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: InventorySeriesRefreshStatsBatchJob, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<InventorySeriesRefreshStatsBatchJob>, callback?: λFunction<InventorySeriesRefreshStatsBatchJob | null, InventorySeriesRefreshStatsBatchJob | null>): ObjList<InventorySeriesRefreshStatsBatchJob>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<InventorySeriesRefreshStatsBatchJob>, callback?: λFunction<InventorySeriesRefreshStatsBatchJob | null, InventorySeriesRefreshStatsBatchJob | null>): Array_Type<ObjError> | null;
   ...
   * @inheritdoc
   */
  static doStart(job?: InventorySeriesRefreshStatsBatchJob, options?: InventorySeriesRefreshStatsBatchJobOptions): void;

  /**
   * @inheritdoc
   */
  static processBatch(batch?: InventorySeriesRefreshStatsBatch, job?: InventorySeriesRefreshStatsBatchJob, options?: InventorySeriesRefreshStatsBatchJobOptions): void;
   ...
   */
  static allComplete(job: InventorySeriesRefreshStatsBatchJob, options?: InventorySeriesRefreshStatsBatchJobOptions): string | null;
   ...
   *           Options the job was run with.
   */
  static failed(job: InventorySeriesRefreshStatsBatchJob, status: BatchJobStatus, options?: InventorySeriesRefreshStatsBatchJobOptions): void;
   ...
   *        Batch to schedule.
   */
  scheduleBatch(batch?: InventorySeriesRefreshStatsBatch): void;
   ...
   *        Batches to schedule.
   */
  scheduleBatches(batches?: Array_Type<InventorySeriesRefreshStatsBatch>): void;
   ...
   */
  static scheduleObjBatch(job?: InventorySeriesRefreshStatsBatchJob, objBatch?: ObjBatch, logPrefix?: string): number | null;
