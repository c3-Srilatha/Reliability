// TypeScript definitions for the C3 type ReliabilityOrchestrator.LoadModelsJobResult

/**
 * Represents the load models workflow that will be executed to load a single {@link ReliabilityMlModel} in the target
 * environment.
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityOrchestrator.LoadModelsJobResult
 */
declare namespace ReliabilityOrchestrator {
  export interface ILoadModelsJobResult {
    ...
    /**
     * The id of the {@link ReliabilityMlModel} in the source environment that is being migrated.
     */
    sourceModelId: string;

    /**
     * The uri of the {@link ModelRegistry.Entry} corresponding to the {@link #sourceModelId} which will be used to
     * migrate the model to the target environment.
     */
    uri: string;
    ...
    /**
     * The {@link ReliabilityModelRegistry.TargetEntry} created for the migrated {@link ReliabilityMlModel}, after the load model
     * workflow completes.
     */
    targetEntry?: IReliabilityModelRegistry.TargetEntry;
  }
}
 ...
 * environment.
 *
 * @remarks this represents a made instance of ReliabilityOrchestrator.LoadModelsJobResult
 */
declare namespace ReliabilityOrchestrator {
  export class LoadModelsJobResult extends Obj  {

    /**
     * The unique and required name of this instance.
     */
    readonly name: string;
    withName(name: string): ReliabilityOrchestrator.LoadModelsJobResult;
    ...
    withTypeIdent(typeIdent: string | null): ReliabilityOrchestrator.LoadModelsJobResult;
     ...
     */
    readonly id: string;
    withId(id: string): ReliabilityOrchestrator.LoadModelsJobResult;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityOrchestrator.LoadModelsJobResult;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): ReliabilityOrchestrator.LoadModelsJobResult;
    ...
    withVersion(version: number | null): ReliabilityOrchestrator.LoadModelsJobResult;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): ReliabilityOrchestrator.LoadModelsJobResult;

    /**
     * Parent {@link MlWorkflowCoordinatable} that this result belongs to.
     */
    readonly parentCoordinator: MlWorkflowCoordinatable<MlWorkflowCoordinatableResult>;
    withParentCoordinator(parentCoordinator: IMlWorkflowCoordinatable<MlWorkflowCoordinatableResult>): ReliabilityOrchestrator.LoadModelsJobResult;
    ...
    withStatusForCoordinatable(statusForCoordinatable: string): ReliabilityOrchestrator.LoadModelsJobResult;

    /**
     * Number of times the {@link #parentCoordinator} has canceled this result.
     */
    readonly canceledCount?: number;
    withCanceledCount(canceledCount: number | null): ReliabilityOrchestrator.LoadModelsJobResult;
    ...
    withIsCanceled(isCanceled: boolean): ReliabilityOrchestrator.LoadModelsJobResult;
    ...
    withErrorCount(errorCount: number | null): ReliabilityOrchestrator.LoadModelsJobResult;
    ...
    withRun(run: IWorkflowExecutorRun | null): ReliabilityOrchestrator.LoadModelsJobResult;
    ...
    withDurationSeconds(durationSeconds: number | null): ReliabilityOrchestrator.LoadModelsJobResult;
    ...
    withPastRuns(pastRuns: Array_Type<WorkflowExecutorRun> | Array<IWorkflowExecutorRun> | null): ReliabilityOrchestrator.LoadModelsJobResult;

    /**
     * Number of times the {@link #parentCoordinator} has attempted to recover this result.
     */
    readonly attemptedRecoveryCount?: number;
    withAttemptedRecoveryCount(attemptedRecoveryCount: number | null): ReliabilityOrchestrator.LoadModelsJobResult;

    /**
     * The id of the {@link ReliabilityMlModel} in the source environment that is being migrated.
     */
    readonly sourceModelId: string;
    withSourceModelId(sourceModelId: string): ReliabilityOrchestrator.LoadModelsJobResult;
     ...
     */
    readonly uri: string;
    withUri(uri: string): ReliabilityOrchestrator.LoadModelsJobResult;
    ...
    withForce(force: boolean): ReliabilityOrchestrator.LoadModelsJobResult;

    /**
     * Spec that was used to specify execution constraints for this register models workflow.
     */
    readonly options?: ReliabilityOrchestrator.JobOptions;
    withOptions(options: IReliabilityOrchestrator.JobOptions | null): ReliabilityOrchestrator.LoadModelsJobResult;

    /**
     * The {@link ReliabilityModelRegistry.TargetEntry} created for the migrated {@link ReliabilityMlModel}, after the load model
     * workflow completes.
     */
    readonly targetEntry?: ReliabilityModelRegistry.TargetEntry;
    withTargetEntry(targetEntry: IReliabilityModelRegistry.TargetEntry | null): ReliabilityOrchestrator.LoadModelsJobResult;
     ...
     * @see #toJson
     */
    static fromJson(json: any): ReliabilityOrchestrator.LoadModelsJobResult | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): ReliabilityOrchestrator.LoadModelsJobResult | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): ReliabilityOrchestrator.LoadModelsJobResult | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): ReliabilityOrchestrator.LoadModelsJobResult | null;
     ...
     */
    replaceType(old: Type, new_: Type): ReliabilityOrchestrator.LoadModelsJobResult;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityOrchestrator.LoadModelsJobResult;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityOrchestrator.LoadModelsJobResult;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityOrchestrator.LoadModelsJobResult>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityOrchestrator.LoadModelsJobResult>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityOrchestrator.LoadModelsJobResult;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityOrchestrator.LoadModelsJobResult;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityOrchestrator.LoadModelsJobResult;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): ReliabilityOrchestrator.LoadModelsJobResult;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): ReliabilityOrchestrator.LoadModelsJobResult;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityOrchestrator.LoadModelsJobResult;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityOrchestrator.LoadModelsJobResult;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityOrchestrator.LoadModelsJobResult;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): ReliabilityOrchestrator.LoadModelsJobResult;
     ...
     * @see #removeField
     */
    withoutField(field: string): ReliabilityOrchestrator.LoadModelsJobResult;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): ReliabilityOrchestrator.LoadModelsJobResult;
     ...
     */
    withoutFields(fields: Array_Type<string>): ReliabilityOrchestrator.LoadModelsJobResult;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityOrchestrator.LoadModelsJobResult;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): ReliabilityOrchestrator.LoadModelsJobResult;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityOrchestrator.LoadModelsJobResult;
     ...
     * @see #unsetField
     */
    defaultField(field: string): ReliabilityOrchestrator.LoadModelsJobResult;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): ReliabilityOrchestrator.LoadModelsJobResult;
     ...
     * @see #removeField
     */
    unsetField(field: string): ReliabilityOrchestrator.LoadModelsJobResult;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): ReliabilityOrchestrator.LoadModelsJobResult;
     ...
     * @see #unsetField
     */
    removeField(field: string): ReliabilityOrchestrator.LoadModelsJobResult;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): ReliabilityOrchestrator.LoadModelsJobResult;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityOrchestrator.LoadModelsJobResult;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityOrchestrator.LoadModelsJobResult;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityOrchestrator.LoadModelsJobResult;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityOrchestrator.LoadModelsJobResult;

    mergeJson(json: any): ReliabilityOrchestrator.LoadModelsJobResult;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityOrchestrator.LoadModelsJobResult;
     ...
     */
    sumObj(other: Obj, deep?: boolean): ReliabilityOrchestrator.LoadModelsJobResult;
     ...
     */
    singletonArray(): Array_Type<ReliabilityOrchestrator.LoadModelsJobResult>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityOrchestrator.LoadModelsJobResult> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<ReliabilityOrchestrator.LoadModelsJobResult> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<ReliabilityOrchestrator.LoadModelsJobResult>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<ReliabilityOrchestrator.LoadModelsJobResult> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, ReliabilityOrchestrator.LoadModelsJobResult> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityOrchestrator.LoadModelsJobResult> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<ReliabilityOrchestrator.LoadModelsJobResult>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<ReliabilityOrchestrator.LoadModelsJobResult>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityOrchestrator.LoadModelsJobResult;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityOrchestrator.LoadModelsJobResult;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityOrchestrator.LoadModelsJobResult;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): ReliabilityOrchestrator.LoadModelsJobResult;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityOrchestrator.LoadModelsJobResult;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): ReliabilityOrchestrator.LoadModelsJobResult;
     ...
     * @see #fromString
     */
    static make(s: string): ReliabilityOrchestrator.LoadModelsJobResult | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityOrchestrator.LoadModelsJobResult;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): ReliabilityOrchestrator.LoadModelsJobResult;
     ...
     */
    static cachedEmptyInst(): ReliabilityOrchestrator.LoadModelsJobResult;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityOrchestrator.LoadModelsJobResult> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): ReliabilityOrchestrator.LoadModelsJobResult;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<ReliabilityOrchestrator.LoadModelsJobResult>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<ReliabilityOrchestrator.LoadModelsJobResult>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityOrchestrator.LoadModelsJobResult> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityOrchestrator.LoadModelsJobResult>> | null;
     ...
     */
    get(include?: string): ReliabilityOrchestrator.LoadModelsJobResult | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): ReliabilityOrchestrator.LoadModelsJobResult | null;
     ...
     */
    getMissing(spec: GetMissingSpec): ReliabilityOrchestrator.LoadModelsJobResult;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): ReliabilityOrchestrator.LoadModelsJobResult | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): ReliabilityOrchestrator.LoadModelsJobResult;
     ...
     * @see #toString
     */
    static fromString(s: string): ReliabilityOrchestrator.LoadModelsJobResult | null;
     ...
     */
    create(spec?: UpsertSpec): ReliabilityOrchestrator.LoadModelsJobResult | null;
     ...
     */
    static createBatch(objs: Array_Type<ReliabilityOrchestrator.LoadModelsJobResult>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.LoadModelsJobResult> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<ReliabilityOrchestrator.LoadModelsJobResult>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityOrchestrator.LoadModelsJobResult> | null;
     ...
     */
    update(srcObj?: ReliabilityOrchestrator.LoadModelsJobResult, spec?: UpsertSpec): ReliabilityOrchestrator.LoadModelsJobResult | null;
     ...
     */
    upsert(srcObj?: ReliabilityOrchestrator.LoadModelsJobResult, spec?: UpsertSpec): ReliabilityOrchestrator.LoadModelsJobResult | null;
     ...
     */
    merge(spec?: MergeSpec): ReliabilityOrchestrator.LoadModelsJobResult | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): ReliabilityOrchestrator.LoadModelsJobResult | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): ReliabilityOrchestrator.LoadModelsJobResult | null;
     ...
     */
    static updateBatch(objs: Array_Type<ReliabilityOrchestrator.LoadModelsJobResult>, srcObjs?: Array_Type<ReliabilityOrchestrator.LoadModelsJobResult>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.LoadModelsJobResult> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<ReliabilityOrchestrator.LoadModelsJobResult> | null>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.LoadModelsJobResult> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<ReliabilityOrchestrator.LoadModelsJobResult>, srcObjs?: Array_Type<ReliabilityOrchestrator.LoadModelsJobResult>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.LoadModelsJobResult> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<ReliabilityOrchestrator.LoadModelsJobResult> | null>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.LoadModelsJobResult> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<ReliabilityOrchestrator.LoadModelsJobResult>, spec?: TouchSpec): ObjList<ReliabilityOrchestrator.LoadModelsJobResult> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityOrchestrator.LoadModelsJobResult>, spec?: MergeSpec): ObjList<ReliabilityOrchestrator.LoadModelsJobResult> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityOrchestrator.LoadModelsJobResult>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityOrchestrator.LoadModelsJobResult> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<ReliabilityOrchestrator.LoadModelsJobResult> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityOrchestrator.LoadModelsJobResult> | null;
     ...
     */
    static mergeAll(mergeObj: ReliabilityOrchestrator.LoadModelsJobResult, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: ReliabilityOrchestrator.LoadModelsJobResult, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<ReliabilityOrchestrator.LoadModelsJobResult>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.LoadModelsJobResult> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<ReliabilityOrchestrator.LoadModelsJobResult>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.LoadModelsJobResult> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): ReliabilityOrchestrator.LoadModelsJobResult | null;
     ...
     */
    static beforeCreate(objs: Array_Type<ReliabilityOrchestrator.LoadModelsJobResult>): ObjList<ReliabilityOrchestrator.LoadModelsJobResult>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<ReliabilityOrchestrator.LoadModelsJobResult>): ObjList<ReliabilityOrchestrator.LoadModelsJobResult>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<ReliabilityOrchestrator.LoadModelsJobResult>): ObjList<ReliabilityOrchestrator.LoadModelsJobResult>;
     ...
     */
    static afterCreate(objs: Array_Type<ReliabilityOrchestrator.LoadModelsJobResult>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<ReliabilityOrchestrator.LoadModelsJobResult>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<ReliabilityOrchestrator.LoadModelsJobResult>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityOrchestrator.LoadModelsJobResult>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityOrchestrator.LoadModelsJobResult>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): ReliabilityOrchestrator.LoadModelsJobResult | null;
     ...
     */
    withoutIdentity(): ReliabilityOrchestrator.LoadModelsJobResult | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<ReliabilityOrchestrator.LoadModelsJobResult>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: ReliabilityOrchestrator.LoadModelsJobResult, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<ReliabilityOrchestrator.LoadModelsJobResult>, callback?: λFunction<ReliabilityOrchestrator.LoadModelsJobResult | null, ReliabilityOrchestrator.LoadModelsJobResult | null>): ObjList<ReliabilityOrchestrator.LoadModelsJobResult>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<ReliabilityOrchestrator.LoadModelsJobResult>, callback?: λFunction<ReliabilityOrchestrator.LoadModelsJobResult | null, ReliabilityOrchestrator.LoadModelsJobResult | null>): Array_Type<ObjError> | null;
     ...
     */
    beforeRecover(): ReliabilityOrchestrator.LoadModelsJobResult;
     ...
     * caller is responsible for persisting the result.
     */
    beforeCancel(): ReliabilityOrchestrator.LoadModelsJobResult;
  }
}
