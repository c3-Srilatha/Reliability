// TypeScript definitions for the C3 type ReliabilityExpressionEngineFunction
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityExpressionEngineFunction
 */
declare interface IReliabilityExpressionEngineFunction {
}
 ...
 */
declare class ReliabilityExpressionEngineFunction {
   ...
   */
  static abs(dimension?: Dimension): Dimension | null;
   ...
   */
  static abs(timeseries?: Timeseries<any>): Timeseries<any> | null;
   ...
   */
  static acos(value?: number): number | null;
   ...
   */
  static acos(dimension?: Dimension): Dimension | null;
   ...
   */
  static acos(timeseries?: Timeseries<any>): Timeseries<any> | null;
   ...
   */
  static aggregate(timeseries: Timeseries<any>, aggregationFunction: string, prorate?: boolean): Timeseries<any>;
   ...
   */
  static and(timeseriesArry: Array_Type<Timeseries<any>>): Timeseries<any>;
   ...
   */
  static asin(value?: number): number | null;
   ...
   */
  static asin(dimension?: Dimension): Dimension | null;
   ...
   */
  static asin(timeseries?: Timeseries<any>): Timeseries<any> | null;
   ...
   */
  static atan(value?: number): number | null;
   ...
   */
  static atan(dimension?: Dimension): Dimension | null;
   ...
   */
  static atan(timeseries?: Timeseries<any>): Timeseries<any> | null;
   ...
   */
  static avg(value?: Array_Type<number>): number | null;
   ...
   */
  static avg(dimension?: Array_Type<Dimension>): Dimension | null;
   ...
   */
  static avg(timeserieses?: Array_Type<Timeseries<any>>): Timeseries<any> | null;
   ...
   */
  static bit(timeseries: Timeseries<any>, bitIndex: number): Timeseries<any>;
   ...
   */
  static bool(input?: number): boolean;
   ...
   */
  static ceil(value?: number, scale?: number): number | null;
   ...
   * @return The input value that is rounded towards positive infinity.
   */
  static ceil(value?: number): number | null;
   ...
   */
  static ceil(dimension?: Dimension, scale?: number): Dimension | null;
   ...
   */
  static ceil(timeseries?: Timeseries<any>, scale?: number): Timeseries<any> | null;
   ...
   */
  static compareTo(obj1: string | number | number | number | number | DateTime, obj2: string | number | number | number | number | DateTime): number;
   ...
   */
  static concat(strs?: Array_Type<string>): string | null;
   ...
   */
  static concat(objs?: Array_Type<any>): Array_Type<Obj> | null;
   ...
   */
  static contains(str1?: string, str2?: string): boolean;
   ...
   * @return Boolean - if `str1` contains `str2`.
   */
  static containsIgnoreCase(str1?: string, str2?: string): boolean;
   ...
   */
  static cos(value?: number): number | null;
   ...
   */
  static cos(dimension?: Dimension): Dimension | null;
   ...
   */
  static cos(timeseries?: Timeseries<any>): Timeseries<any> | null;
   ...
   */
  static count(obj?: Array_Type<any>): number | null;
   ...
   */
  static count(timeserieses?: Array_Type<Timeseries<any>>): Timeseries<any> | null;
   ...
   */
  static cuberoot(value?: number): number | null;
   ...
   */
  static cuberoot(dimension?: Dimension): Dimension | null;
   ...
   */
  static cuberoot(timeseries?: Timeseries<any>): Timeseries<any> | null;
   ...
   */
  static cusumDiffScore(measurements: Timeseries<any>, reconstructions: Timeseries<any>, k: number, cusumH?: number, memoryLength?: number, ignoreMask?: Timeseries<any>, resetMask?: Timeseries<any>, resetOnResidualDirectionChange?: boolean, resetOnResidualDirectionChangeThreshold?: number, percentResetOnResidualDirectionChange?: number): Timeseries<any> | null;
   ...
   */
  static dateTime(time: string, format?: string): DateTime | null;
   ...
   * @return A datetime object.
   */
  static dateTime(timeMillis: number): DateTime | null;
   ...
   */
  static inferDateTimeFormat(str: string): string | null;
   ...
   */
  static day(datetime: DateTime): number;
   ...
   */
  static dayOfWeek(datetime: DateTime): number;
   ...
   */
  static daysInYear(datetime: DateTime): number;
   ...
   */
  static decimal(v: any): number | null;
   ...
   */
  static temporalDistance(period: string, dt1: DateTime, dt2: DateTime): number;
   ...
   */
  static nextTimePoint(interval: string, datetime: DateTime, n: number, align?: boolean): DateTime;
   ...
   */
  static prevTimePoint(interval: string, datetime: DateTime, n: number, align?: boolean): DateTime;
   ...
   */
  static dimensionCreator(dimensionType: string, value: number, unitId: string): Dimension;
   ...
   */
  static distance(geographyA: Geo, geographyB: Geo): number | null;
   ...
   */
  static distance(geometryA: Geom, geometryB: Geom): number | null;
   ...
   */
  static binaryQuantize(vector: string, dimension?: number): string;
   ...
   */
  static vectorDistance(vectorA: string, vectorB: string, spec?: Expr.DistanceSpec): number;
   ...
   */
  static similarity(field: string, text: string, spec?: string): number;
   ...
   */
  static dotProduct(timeseries1: Timeseries<any>, timeseries2: Timeseries<any>): Timeseries<any>;
   ...
   */
  static earliest(timeseries: Timeseries<any>): Timeseries<any>;
   ...
   */
  static earliest(dates: Array_Type<DateTime>): DateTime;
   ...
   */
  static embedding(text: string, embedder: string): Array_Type<number>;
   ...
   */
  static embeddingDimension(embedder: string): number;
   ...
   */
  static endsWithIgnoreCase(str1: string, str2: string): boolean;
   ...
   */
  static eval(aggregationFunction: string, interval: string, timeseries: Timeseries<any>, start?: any, end?: any): Timeseries<any>;
   ...
   */
  static isInfinityOrNaN(x?: number | Dimension): boolean;
   ...
   */
  static isInfinityOrNaN(ts?: Timeseries<any>): Timeseries<any>;
   ...
   */
  static exp(value?: number): number | null;
   ...
   */
  static exp(dimension?: Dimension): Dimension | null;
   ...
   */
  static exp(timeseries?: Timeseries<any>): Timeseries<any> | null;
   ...
   */
  static exponentialDecay(timeseries: Timeseries<any>, reset: Timeseries<any>, width: number, decay: number): Timeseries<any>;
   ...
   */
  static fillMissing(timeseries?: Timeseries<any>, fillerValue?: number): Timeseries<any> | null;
   ...
   */
  static fillMissing(timeseries?: Timeseries<any>, fillerValue?: any): Timeseries<any> | null;
   ...
   */
  static withMissing(timeseries: Timeseries<any>, fillerValue?: number): Timeseries<any>;
   ...
   * @return Returns time series with missing value replaced on the input {@link timeseries} with the specified {@link fillerValue}
   */
  static withMissing(timeseries: Timeseries<any>, fillerValue?: Timeseries<any>): Timeseries<any>;
   ...
   */
  static fixDstOffset(datetime: DateTime, datetimeZone: string): DateTime | null;
   ...
   */
  static floor(value?: number, scale?: number): number | null;
   ...
   */
  static floor(value?: number): number | null;
   ...
   */
  static floor(dimension?: Dimension, scale?: number): Dimension | null;
   ...
   */
  static floor(timeseries?: Timeseries<any>, scale?: number): Timeseries<any> | null;
   ...
   */
  static geogFromText(geographicWKT: string): Geo | null;
   ...
   */
  static geomBuffer(geometry?: Geom, bufferRadius?: number): Geom | null;
   ...
   */
  static geomBuffer(geography?: Geo, bufferRadius?: number): Geo | null;
   ...
   */
  static geomClosestPoint(geometryA?: Geom, geometryB?: Geom): boolean;
   ...
   */
  static geomContains(geometryA?: Geom, geometryB?: Geom): boolean;
   ...
   */
  static geomExteriorRing(polygon: GeomPolygon | GeomPolygon3D): boolean;
   ...
   */
  static geomAsText(geog: Geo): string | null;
   ...
   */
  static geomAsText(geom: Geom): string | null;
   ...
   */
  static geomFromText(geometricWKT: string): Geom | null;
   ...
   */
  static geomIntersects(geographyA?: Geo, geographyB?: Geo): boolean;
   ...
   */
  static geomIntersects(geometryA?: Geom, geometryB?: Geom): boolean;
   ...
   */
  static geomUnion(geometry?: Geom): Geom | null;
   ...
   */
  static geomX(geomPoint?: GeomPoint): number | null;
   ...
   */
  static geomY(geomPoint?: GeomPoint): number | null;
   ...
   */
  static geomZ(geomPoint?: GeomPoint): number | null;
   ...
   */
  static haversineDistance(xLat: Timeseries<any>, xLong: Timeseries<any>, yLat: Timeseries<any>, yLong: Timeseries<any>): Timeseries<any>;
   ...
   */
  static correlation(kind: string, ts1: Timeseries<any>, ts2: Timeseries<any>): Timeseries<any>;
   ...
   */
  static hour(datetime: DateTime): number;
   ...
   */
  static id(): Array_Type<string> | null;
   ...
   */
  static intersects(collection1: any, collections: Array_Type<any>): boolean;
   ...
   */
  static join(strs: Array_Type<string>): string;
   ...
   */
  static latest(timeseries: Timeseries<any>): Timeseries<any>;
   ...
   */
  static latest(dates: Array_Type<DateTime>): DateTime;
   ...
   */
  static registerReadInterpolator(ts: Timeseries<any>, resetOper: string, resetThreshold: number, rolloverMax?: number): Timeseries<any>;
   ...
   */
  static interpolate(ts: Timeseries<any>, interpolatorType?: string, performOn?: string): Timeseries<any>;
   ...
   */
  static lerp(oldValue: Timeseries<any>, to: Timeseries<any>, scale: Timeseries<any>): Timeseries<any>;
   ...
   */
  static linearDecay(timeseries: Timeseries<any>, width: number): Timeseries<any>;
   ...
   */
  static log(dimension?: Dimension): Dimension | null;
   ...
   */
  static log(timeseries?: Timeseries<any>): Timeseries<any> | null;
   ...
   */
  static log10(value?: number): number | null;
   ...
   */
  static log10(dimension?: Dimension): Dimension | null;
   ...
   */
  static log10(timeseries?: Timeseries<any>): Timeseries<any> | null;
   ...
   */
  static lowerCase(str?: string): string | null;
   ...
   */
  static makeLineString(points: Array_Type<GeomPoint>): GeomLineString | null;
   ...
   */
  static makePoint(x: number, y: number, z?: number, m?: number): GeomPoint | GeomPoint3D | GeomPoint3DWithMeasure | null;
   ...
   */
  static makePointM(x: number, y: number, m: number): GeomPointWithMeasure | null;
   ...
   */
  static map(lambdaField: λFunction<any, any | null>): Array_Type<any> | null;
   ...
   */
  static matchCount(str: string, regex: string): number;
   ...
   */
  static matches(str: string, regex: string): boolean;
   ...
   * @return `true` if `str` matches the `regex`.
   */
  static matchesRegex(str: string, regex: string): boolean;
   ...
   */
  static matchesGlob(str: string, glob: string): boolean;
   ...
   */
  static matchesCamelCase(str: string, camelCase: string, allowLowerCamelCase?: boolean): boolean;
   ...
   */
  static regexMatch(str: string, regex: string): StringPatternMatch;
   ...
   * @return The match details.
   */
  static globMatch(str: string, glob: string): StringPatternMatch;
   ...
   */
  static camelCaseMatch(str: string, camelCase: string, allowLowerCamelCase?: boolean): StringPatternMatch;
   ...
   */
  static findAll(str: string, regex: string): Array_Type<string> | null;
   ...
   */
  static max(timeserieses?: Array_Type<Timeseries<any>>): Timeseries<any> | null;
   ...
   */
  static max(numbers?: Array_Type<number>): number | null;
   ...
   */
  static md5HashKey(str: string): number;
   ...
   */
  static mean(timeseries: Timeseries<any>): Timeseries<any>;
   ...
   */
  static mean(input?: Array_Type<number>): number | null;
   ...
   */
  static median(timeseries: Timeseries<any>): Timeseries<any>;
   ...
   */
  static median(input?: Array_Type<number>): number | null;
   ...
   */
  static min(timeseries?: Array_Type<Timeseries<any>>): Timeseries<any> | null;
   ...
   */
  static min(numbers?: Array_Type<number>): number | null;
   ...
   */
  static minute(datetime: DateTime): number;
   ...
   */
  static modalValue(objs: Array_Type<any>): any | null;
   ...
   */
  static month(datetime: DateTime): number;
   ...
   */
  static nthroot(value?: number, nthRoot?: number): number | null;
   ...
   */
  static nthroot(dimension?: Dimension, nthRoot?: number): Dimension | null;
   ...
   */
  static nthroot(input?: Timeseries<any>, nthRoot?: number): Timeseries<any> | null;
   ...
   */
  static number(dimension?: Dimension): number | null;
   ...
   */
  static or(timeserieses: Array_Type<Timeseries<any>>): Timeseries<any>;
   ...
   */
  static percentile(timeseries: Timeseries<any>, n: number): Timeseries<any>;
   ...
   */
  static percentile(input: Array_Type<number>, n: number): number | null;
   ...
   */
  static period(number: number, grain: string): number;
   ...
   */
  static plusDays(dateTime: DateTime, num: number): DateTime;
   ...
   * @return Milliseconds in the period.
   */
  static plusMonths(dateTime: DateTime, num: number): DateTime;
   ...
   */
  static plusYears(dateTime: DateTime, num: number): DateTime;
   ...
   */
  static pointInsideCircle(geomPoint: GeomPoint, center_x?: number, center_y?: number, radius?: number): boolean;
   ...
   */
  static pow(value?: number, power?: number): number | null;
   ...
   */
  static pow(dimension?: Dimension, power?: number): Dimension | null;
   ...
   */
  static pow(timeseries?: Timeseries<any>, power?: number): Timeseries<any> | null;
   ...
   */
  static replace(str: string, replaced: string, replacement: string): string;
   ...
   */
  static rolling(aggregationFunction: string, timeseries: Timeseries<any>, resetOn?: any, resetTo?: any, resetAfter?: number): Timeseries<any>;
   ...
   */
  static rollingDiff(timeseries: Timeseries<any>, resetDropThreshold: number, rollOverThreshold?: boolean): Timeseries<any>;
   ...
   */
  static rollup(aggregationFunction?: string, nthPercentileValue?: number, timeserieses: Array_Type<Timeseries<any>>): Timeseries<any>;
   ...
   */
  static round(value?: number, scale?: number): number | null;
   ...
   */
  static round(dimension?: Dimension, scale?: number): Dimension | null;
   ...
   */
  static round(timeseries?: Timeseries<any>, scale?: number): Timeseries<any> | null;
   ...
   */
  static roundHalfToEven(value?: number): number | null;
   ...
   */
  static roundHalfToEven(dimension?: Dimension): Dimension | null;
   ...
   */
  static roundHalfToEven(timeseries?: Timeseries<any>): Timeseries<any> | null;
   ...
   */
  static scaleMinMax(timeseries: Timeseries<any>, min?: number, max?: number): Timeseries<any>;
   ...
   */
  static scaleStandard(timeseries: Timeseries<any>): Timeseries<any>;
   ...
   */
  static setSrid(geomPoint?: GeomPoint, srid?: number): GeomPoint | null;
   ...
   */
  static second(datetime: DateTime): number | null;
   ...
   */
  static sin(value?: number): number | null;
   ...
   */
  static sin(dimension?: Dimension): Dimension | null;
   ...
   */
  static sin(timeseries?: Timeseries<any>): Timeseries<any> | null;
   ...
   */
  static skipIfMissing(timeseries: Timeseries<any>, equalityOperator: string, percent: number): Timeseries<any>;
   ...
   */
  static sqrt(dimension?: Dimension): Dimension | null;
   ...
   */
  static sqrt(timeseries?: Timeseries<any>): Timeseries<any> | null;
   ...
   * @return `true` if `str1` starts with `str2`.
   */
  static startsWithIgnoreCase(str1: string, str2: string): boolean;
   ...
   */
  static stddev(timeseries: Timeseries<any>): Timeseries<any>;
   ...
   */
  static stddev(input?: Array_Type<number>): number | null;
   ...
   * @return The string representation of the input.
   */
  static string(obj: any): string | null;
   ...
   */
  static substring(str: string, start: number, end: number): string | null;
   ...
   */
  static sum(values?: Array_Type<number>): number | null;
   ...
   */
  static sum(dimension?: Array_Type<Dimension>): Dimension | null;
   ...
   */
  static sum(timeserieses?: Array_Type<Timeseries<any>>): Timeseries<any> | null;
   ...
   */
  static tan(value?: number): number | null;
   ...
   */
  static tan(dimension?: Dimension): Dimension | null;
   ...
   */
  static tan(timeseries?: Timeseries<any>): Timeseries<any> | null;
   ...
   */
  static timeComponent(timeComponent: string, timeseries: Timeseries<any>): Timeseries<any>;
   ...
   */
  static toDegrees(timeseries: Timeseries<any>): Timeseries<any>;
   ...
   */
  static toRadians(timeseries: Timeseries<any>): Timeseries<any>;
   ...
   */
  static transformGeom(geom: Geom, srid?: number): Geom | null;
   ...
   */
  static union(collection1: Array_Type<any>, collection2: Array_Type<any>): Array_Type<any> | null;
   ...
   */
  static unique(collection: Array_Type<any>): Array_Type<any> | null;
   ...
   */
  static upperCase(str?: string): string | null;
   ...
   */
  static variance(timeseries: Timeseries<any>): Timeseries<any>;
   ...
   */
  static variance(input?: Array_Type<number>): number | null;
   ...
   */
  static sumOfSquares(input?: Array_Type<number>): number | null;
   ...
   */
  static weatherIndependentTimeseries(timeseries: Timeseries<any>, weatherTimeseries: Timeseries<any>, heatingCoolingCoeffs?: Array_Type<number>, missingThreshold?: number): Timeseries<any>;
   ...
   */
  static window(aggFunc: string, timeseries: Timeseries<any>, inputOffset: number, inputSpan: number, inputStep?: number): Timeseries<any>;
   ...
   */
  static operationalWindow(aggFunc: string, dataTs: Timeseries<any>, operationalTs: Timeseries<any>, operationalOffset: number, operationalSpan?: number): Timeseries<any>;
   ...
   */
  static withinDistance(geographyA: Geo, geographyB: Geo, distance: number, unit?: string): boolean;
   ...
   */
  static withinDistance(geometryA: Geom, geometryB: Geom, distance: number): boolean;
   ...
   */
  static withinDistance(latA: number, longA: number, latB: number, longB: number, distance: number, unit: string): boolean;
   ...
   */
  static year(dateTime: DateTime): number;
   ...
   */
  static available(timeseries: Timeseries<any>): Timeseries<any>;
   ...
   */
  static convertToUnit(UnitId: string, timeseries: Timeseries<any>): Timeseries<any>;
   ...
   */
  static identity(number: number, unitId?: string): Timeseries<any>;
   ...
   */
  static linearRecurrenceTimeseries(initialValues: Array_Type<number>, doubleArray: Array_Type<Array_Type<number>>): Timeseries<any>;
   ...
   */
  static missing(timeseries: Timeseries<any>): Timeseries<any>;
   ...
   */
  static randomTimeseries(origin?: number, bound?: number): Timeseries<any>;
   ...
   */
  static sineWave(waveStart?: DateTime, amplitude?: number, frequency?: number, phase?: number): Timeseries<any>;
   ...
   */
  static squareWave(timeComponent?: string, pulseStart?: number, pulseEnd?: number): Timeseries<any>;
   ...
   */
  static start(): Timeseries<any> | null;
   ...
   */
  static treatAsUnit(unitId: string, timeseries: Timeseries<any>): Timeseries<any>;
   ...
   */
  static ascending(objs?: Array_Type<any>): Array_Type<any> | null;
   ...
   */
  static ascending(objs?: Array_Type<any>, path?: string): Array_Type<any> | null;
   ...
   */
  static descending(arry?: Array_Type<any>): Array_Type<any> | null;
   ...
   */
  static descending(objs?: Array_Type<any>, path?: string): Array_Type<any> | null;
   ...
   */
  static split(str?: string, delimiter: string): Array_Type<string> | null;
   ...
   */
  static removeOutliers(timeseries: Timeseries<any>, span?: number, threshold?: number): Timeseries<any>;
   ...
   */
  static earliestValue(timeseries: Timeseries<any>): Timeseries<any>;
   ...
   */
  static earliestValue(array: Array_Type<any>): any;
   ...
   */
  static latestValue(timeseries: Timeseries<any>): Timeseries<any>;
   ...
   */
  static latestValue(array: Array_Type<any>): any;
   ...
   */
  static makeMissing(missingPercent: number, value: number, unitId: string): Timeseries<any>;
   ...
   * @return A time series with the above-mentioned specification.
   */
  static makeEstimates(estimatePercent: number, value: number, unitId: string): Timeseries<any>;
   ...
   */
  static convertToTimeZone(timeZone: string, dt: DateTime): DateTime | null;
   ...
   */
  static treatAsTimeZone(timeZone: string, dt: DateTime): DateTime | null;
   ...
   */
  static arrayAgg(expr: string): Array_Type<any> | null;
   ...
   */
  static arrayAggAsString(expr: string, delimiter?: string): string | null;
   ...
   */
  static compact(array?: Array_Type<any>): Array_Type<any> | null;
   ...
   */
  static flatten(array?: Array_Type<Array_Type<any>>, shallow?: boolean): Array_Type<any> | null;
   ...
   */
  static userInformation(userId: string): User | null;
   ...
   */
  static parseJobErrorMessage(jobRunErrorDetailId: string, modelConfigTag?: boolean = 'false'): string | null;
   ...
   */
  static getConfigValue(configTypeName: string, fieldName: string): any | null;
   ...
   */
  static evalMetricOnExpectedSensor(metricName: string, expectedSensorId: string, srcId?: string, interval?: string, range?: TimeRange): Timeseries<any> | null;
   ...
   */
  static expectedSensor(sensorId: string, assetId: string, interval?: string, range?: TimeRange): Timeseries<any>;
   ...
   * @return The timeseries data for the sensor.
   */
  static sensor(sensorId: string, assetId: string, interval?: string, range?: TimeRange): Timeseries<any>;
   ...
   * @return The timeseries data for the sensor.
   */
  static evalSensorForAnyAsset(sensorId: string, interval?: string, range?: TimeRange): Timeseries<any> | null;
   ...
   */
  static getAssetImportanceName(translationMap?: any, fallback?: string): string | null;

  /**
   * Retrieves the correct header name for feature contributions sum.
   */
  static getFeatureContributionsSumHeaderName(): string;

  /**
   * Used to get risk score timeseries header names. Wrapper for {@link MlProject.ReliabilityRisk#getRiskScoreHeaderName}.
   */
  static getRiskScoreHeaderName(): string;

  /**
   * Helper function to fetch and organize training and validation periods for {@link ReliabilityMlModel#trainingValidationPeriods} field
   *
   * Returns a list where return[0] is a list of time ranges for Training Period and return[1] is for Validation Period
   */
  static computeTrainingValidationPeriods(datasetPreparationRunId: string): Array_Type<Array_Type<TimeRange>> | null;

  /**
   * Used to get reconstruction timeseries header names. Wrapper for {@link MlProject.ReliabilityRisk#getReconstructionHeaderName}.
   */
  static getReconstructionHeaderName(sensorId: string, assetId?: string): string;

  /**
   * Get the latest model output value for agnostic {@link ReliabilityMl.Project} associated with the {@link ReliabilityAsset}.
   *
   * @param assetId
   *        The ID of the asset for which to retrieve and upsert the latest model output values
   * @return Array of JSON objects representing the upserted latest model output entities for each associated project
   */
  static getLatestModelOutputValue(assetId: string): Array_Type<any> | null;

  /**
   * Used in {@link ReliabilityAssetCase#topContributors} to get the top contributing feature names
   */
  static getTopFeatureContributors(alert?: Array_Type<ReliabilityAssetAlert>, count?: number = '3'): string;

  /**
   * Gets the latest minimum model output for agnostic {@link ReliabilityMl.Project} associated with the {@link ReliabilityAsset} and its children.
   *
   * @param assetIds
   *        Array of asset IDs for which to find the minimum model output values across all associated projects
   * @return JSON object containing project IDs as keys and their corresponding minimum model output values
   */
  static getLatestMinModelOutputValue(assetIds: Array_Type<string>): any | null;

  /**
   * Format the datetime according to the specified string. See {@link DateTime#toString} method.
   */
  static formatDateTime(date: DateTime, format: string): string | null;

  /**
   * Returns the first day of the month as a Timeseries.
   *
   * This function is used to get the first day of the month as a Timeseries to use as an ExpressionEngineFunction.
   * The function was originally designed to return a datetime, however, MetricFunctionLibrary only supports Timeseries
   * return types.
   *
   * Example: `firstDayOfMonth(['2019-09-02', '2019-09-03', '2019-10-10']) ==> ['2019-09-01', '2019-09-01', '2019-10-01']`
   *
   * @param timeseries
   *        timeseries input
   * @return a timeseries containing the first day of the month.
   */
  static firstDayOfMonth(timeseries: Timeseries<any>): Timeseries<any> | null;

  /**
   * Gets the latest average risk score associated a {@link ReliabilityAsset} and its children.
   */
  static getLatestAvgRiskScoreValue(assetIds: Array_Type<string>): number | null;

  /**
   * Used in metric expressions on {@link ReliabilityAsset} to filter on the latest {@link ReliabilityAssetRegime} at a given date.
   */
  static evalMetricOnLatestRegimeDates(context: MetricContext): Timeseries<any> | null;

  /**
   * Get the latest risk score id associated with the {@link ReliabilityAsset}.
   */
  static getLatestRiskScoreId(assetId: string): string | null;

  /**
   * Gets the latest maximum risk score associated a {@link ReliabilityAsset} and its children.
   */
  static getLatestMaxRiskScoreValue(assetIds: Array_Type<string>): number | null;

  /**
   * Gets the first x objs from the specified array
   *
   * @param objs the array to get from.
   * @param numObjs the number of objs to get from the array.
   * @return the first x objs from the specified array
   */
  static getFirstObjs(objs: Array_Type<string>, numObjs: number): Array_Type<any> | null;

  /**
   * Used to fetch the asset class that corresponds to the {@link ReliabilityAsset#depth}'.
   * This method uses the {@link ReliabilityUIConfig#assetLevels} list to map from
   * depth to asset concept.
   *
   * @param depth
   *      depth of the {@link ReliabilityAsset}
   * @return the corresponding defined asset level for the depth; L{depth} is no concept is defined.
   */
  static getAssetLevel(depth: number): string | null;

  /**
   * Gets the upper bound value for a given classification label
   *
   * @param value label of the classification
   *
   * @param configField the name of the field on the config type. Only supports fields which are array of {@link ThresholdConfig}.
   *
   * @return the value from the config for the given label.
   */
  static getLabelForValue(value?: number, configField: string): string | null;

  /**
   * Gets the latest model output for agnostic {@link ReliabilityMl.Project} associated with the {@link ReliabilityAsset}.
   *
   * @param assetId
   *        The ID of the asset for which to retrieve the latest model output predictions
   * @return Map containing project IDs as keys and their corresponding latest {@link ReliabilityMl.Prediction} objects as values
   */
  static getLatestModelOutput(assetId: string): Map_Type<string, ReliabilityMl.Prediction> | null;

  /**
   * **NOTE:** In most circumstances, you should use #window. This function is only necessary to avoid
   *           a known issue with evaluating expression engine functions within a `window` expression.
   *
   * This function is identical to #window, but instead of directly evaluating `expression` within
   * the specified window, it creates a temporary {@link SimpleMetric} from `expression` and evaluates
   * that metric over the specified window.
   *
   * @param aggFunc
   *        See [#window#aggFunc](#window).
   * @param expression
   *        The expression to be evaluated over the specified window. This expression must return
   *        a single {@link Timeseries}.
   * @param inputOffset
   *        See [#window#inputOffset](#window).
   * @param inputSpan
   *        See [#window#inputSpan](#window).
   * @param inputStep
   *        See [#window#inputStep](#window).
   * @param context
   *        A context object containing the source {@link Obj} and {@link TimeInfo} for evaluation.
   *        The context is automatically populated by the metric engine and can be referenced through
   *        the `$metric` object in an expression.
   */
  static windowAsMetadata(aggFunc: string, expression: string, inputOffset: number, inputSpan: number, inputStep: number, context: MetricContext): Timeseries<any>;

  /**
   * Gets the latest risk score of a {@link ReliabilityAsset}.
   */
  static getLatestRiskScore(assetId: string): ReliabilityRiskScoreMlPrediction | null;

  /**
   * Gets the latest average model output for agnostic {@link ReliabilityMl.Project} associated with the {@link ReliabilityAsset} and its children.
   *
   * @param assetIds
   *        Array of asset IDs for which to calculate the average model output values across all associated projects
   * @return JSON object containing project IDs as keys and their corresponding average model output values
   */
  static getLatestAvgModelOutputValue(assetIds: Array_Type<string>): any | null;

  /**
   * Used in metric expressions on {@link ReliabilityAsset} to filter on the latest {@link FlaggedEventType} for {@link ReliabilityAssetRegime} at a given date.
   */
  static evalMetricOnLatestRegimeTypeDates(context: MetricContext): Timeseries<any> | null;

  /**
   * Get the champion {@link MlModel} of a {@link MlProject} for a specific {@link ReliabilityAsset}
   *
   * @param assetId
   *        the asset for which to get the champion {@link MlModel}
   *
   * @param projectId
   *        the project with the champion {@link MlModel}
   *
   * @return the champion {@link MlModel}.
   */
  static liveModel(assetId?: string, projectId?: string): ReliabilityMlModel | null;

  /**
   * Get the latest risk score value associated with the {@link ReliabilityAsset}.
   */
  static getLatestRiskScoreValue(assetId: string): number | null;

  /**
   * Gets the latest minimum risk score associated a {@link ReliabilityAsset} and its children.
   */
  static getLatestMinRiskScoreValue(assetIds: Array_Type<string>): number | null;

  /**
   * Used in metric expressions on {@link ReliabilityAsset} to filter on a specific {@link ReliabilityAssetRegime}.
   */
  static evalMetricOnRegimeType(metricName: string, regimeType: string, context: MetricContext): Timeseries<any> | null;

  /**
   * Gets the latest maximum model output for agnostic {@link ReliabilityMl.Project} associated with the {@link ReliabilityAsset} and its children.
   *
   * @param assetIds
   *        Array of asset IDs for which to find the maximum model output values across all associated projects
   * @return JSON object containing project IDs as keys and their corresponding maximum model output values
   */
  static getLatestMaxModelOutputValue(assetIds: Array_Type<string>): any | null;

  /**
   * Gets the translation for the given key and postfix. The postfix has `JSON.stringify` applied to it, and then is
   * concatenated to the key **without** a period between. The resulting string is then used as the translation key.
   * Does not support translation without a postfix, as passing null will result in `${key}null` being used as the
   * translation key.
   *
   * Has two advantages over `translate by`:
   *  - Allows translation based on any field (including booleans)
   *  - Allows for translation separate from the type the field comes from. This is useful for translation fields
   *    that are shared by multiple types.
   *
   * The postfix is of type `json` since `any` isn't supported in expression engine functions.
   */
  static getTranslationWithPostfix(key?: string, postfix?: any): string | null;
}
