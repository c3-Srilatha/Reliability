// TypeScript definitions for the C3 type ReliabilityAlertType

/**
 * Helper seed data type used to help easily distinguish and reference different kinds of Reliability Alerts used
 * throughout the application.
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityAlertType
 */
declare interface IReliabilityAlertType {
 ...
 */
declare class ReliabilityAlertType extends Obj  {
   ...
   */
  readonly id: string;
  withId(id: string): ReliabilityAlertType;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityAlertType;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): ReliabilityAlertType;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): ReliabilityAlertType;
  ...
  withVersion(version: number | null): ReliabilityAlertType;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): ReliabilityAlertType;
  ...
  withUserUpdatedFields(userUpdatedFields: Array_Type<string> | Array<string> | null): ReliabilityAlertType;
  ...
  withHidden(hidden: boolean): ReliabilityAlertType;
  ...
  withUserOwned(userOwned: boolean): ReliabilityAlertType;

  /**
   * The {@link Persistable} type that this spec applies to.
   */
  readonly typeName?: string;
  withTypeName(typeName: string | null): ReliabilityAlertType;
  ...
  withAlertKey(alertKey: string | null): ReliabilityAlertType;

  /**
   * The type of alert.
   */
  readonly alertType: Type;
  withAlertType(alertType: IType): ReliabilityAlertType;
   ...
   * @see #toJson
   */
  static fromJson(json: any): ReliabilityAlertType | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): ReliabilityAlertType | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): ReliabilityAlertType | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): ReliabilityAlertType | null;
   ...
   */
  replaceType(old: Type, new_: Type): ReliabilityAlertType;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityAlertType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityAlertType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityAlertType>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityAlertType>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityAlertType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityAlertType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityAlertType;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ReliabilityAlertType;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ReliabilityAlertType;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityAlertType;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityAlertType;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityAlertType;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ReliabilityAlertType;
   ...
   * @see #removeField
   */
  withoutField(field: string): ReliabilityAlertType;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): ReliabilityAlertType;
   ...
   */
  withoutFields(fields: Array_Type<string>): ReliabilityAlertType;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityAlertType;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ReliabilityAlertType;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityAlertType;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ReliabilityAlertType;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ReliabilityAlertType;
   ...
   * @see #removeField
   */
  unsetField(field: string): ReliabilityAlertType;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ReliabilityAlertType;
   ...
   * @see #unsetField
   */
  removeField(field: string): ReliabilityAlertType;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ReliabilityAlertType;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityAlertType;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityAlertType;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityAlertType;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityAlertType;

  mergeJson(json: any): ReliabilityAlertType;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityAlertType;
   ...
   */
  sumObj(other: Obj, deep?: boolean): ReliabilityAlertType;
   ...
   */
  singletonArray(): Array_Type<ReliabilityAlertType>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityAlertType> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ReliabilityAlertType> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<ReliabilityAlertType>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ReliabilityAlertType> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, ReliabilityAlertType> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityAlertType> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ReliabilityAlertType>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ReliabilityAlertType>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityAlertType;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityAlertType;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityAlertType;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ReliabilityAlertType;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityAlertType;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ReliabilityAlertType;
   ...
   * @see #fromString
   */
  static make(s: string): ReliabilityAlertType | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityAlertType;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): ReliabilityAlertType;
   ...
   */
  static cachedEmptyInst(): ReliabilityAlertType;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityAlertType> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): ReliabilityAlertType;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<ReliabilityAlertType> | null;
   ...
   */
  static find(filter?: string, doNotProduceAll?: boolean): Stream<ReliabilityAlertType> | null;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<ReliabilityAlertType> | null;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): ReliabilityAlertType | null;
   ...
   * @see findByCacheKey
   */
  static forCacheKey(key: string): ReliabilityAlertType | null;
   ...
   * @see findByCacheKey
   */
  getCached(): ReliabilityAlertType | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): ReliabilityAlertType | null;
   ...
   */
  static produce(key: string): ReliabilityAlertType | null;
   ...
   */
  static produceAll(): Map_Type<string, ReliabilityAlertType> | null;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): Map_Type<string, ReliabilityAlertType> | null;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<ReliabilityAlertType>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<ReliabilityAlertType>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityAlertType> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityAlertType>> | null;
   ...
   */
  get(include?: string): ReliabilityAlertType | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): ReliabilityAlertType | null;
   ...
   */
  getMissing(spec: GetMissingSpec): ReliabilityAlertType;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): ReliabilityAlertType | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): ReliabilityAlertType;
   ...
   * @see #toString
   */
  static fromString(s: string): ReliabilityAlertType | null;
   ...
   */
  create(spec?: UpsertSpec): ReliabilityAlertType | null;
   ...
   */
  static createBatch(objs: Array_Type<ReliabilityAlertType>, spec?: UpsertSpec): ObjList<ReliabilityAlertType> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<ReliabilityAlertType>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityAlertType> | null;
   ...
   */
  update(srcObj?: ReliabilityAlertType, spec?: UpsertSpec): ReliabilityAlertType | null;
   ...
   */
  upsert(srcObj?: ReliabilityAlertType, spec?: UpsertSpec): ReliabilityAlertType | null;
   ...
   */
  merge(spec?: MergeSpec): ReliabilityAlertType | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): ReliabilityAlertType | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): ReliabilityAlertType | null;
   ...
   */
  static updateBatch(objs: Array_Type<ReliabilityAlertType>, srcObjs?: Array_Type<ReliabilityAlertType>, spec?: UpsertSpec): ObjList<ReliabilityAlertType> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<ReliabilityAlertType> | null>, spec?: UpsertSpec): ObjList<ReliabilityAlertType> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<ReliabilityAlertType>, srcObjs?: Array_Type<ReliabilityAlertType>, spec?: UpsertSpec): ObjList<ReliabilityAlertType> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<ReliabilityAlertType> | null>, spec?: UpsertSpec): ObjList<ReliabilityAlertType> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<ReliabilityAlertType>, spec?: TouchSpec): ObjList<ReliabilityAlertType> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityAlertType>, spec?: MergeSpec): ObjList<ReliabilityAlertType> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityAlertType>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityAlertType> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<ReliabilityAlertType> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityAlertType> | null;
   ...
   */
  static mergeAll(mergeObj: ReliabilityAlertType, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: ReliabilityAlertType, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<ReliabilityAlertType>, spec?: UpsertSpec): ObjList<ReliabilityAlertType> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<ReliabilityAlertType>, spec?: UpsertSpec): ObjList<ReliabilityAlertType> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): ReliabilityAlertType | null;
   ...
   */
  static beforeCreate(objs: Array_Type<ReliabilityAlertType>): ObjList<ReliabilityAlertType>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<ReliabilityAlertType>): ObjList<ReliabilityAlertType>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<ReliabilityAlertType>): ObjList<ReliabilityAlertType>;
   ...
   */
  static afterCreate(objs: Array_Type<ReliabilityAlertType>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<ReliabilityAlertType>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<ReliabilityAlertType>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityAlertType>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityAlertType>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): ReliabilityAlertType | null;
   ...
   */
  withoutIdentity(): ReliabilityAlertType | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<ReliabilityAlertType>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: ReliabilityAlertType, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<ReliabilityAlertType>, callback?: λFunction<ReliabilityAlertType | null, ReliabilityAlertType | null>): ObjList<ReliabilityAlertType>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<ReliabilityAlertType>, callback?: λFunction<ReliabilityAlertType | null, ReliabilityAlertType | null>): Array_Type<ObjError> | null;
   ...
   */
  publish(subPath?: string, contentType?: string): ReliabilityAlertType;
   ...
   */
  static removeSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<ReliabilityAlertType> | null;
   ...
   */
  createSeedData(spec?: UpsertSpec): ReliabilityAlertType | null;
   ...
   */
  static createSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<ReliabilityAlertType> | null;
   ...
   */
  updateSeedData(srcObj?: SeedData, spec?: UpsertSpec): ReliabilityAlertType | null;
   ...
   */
  static updateSeedDataBatch(objs?: Array_Type<SeedData>, srcObjs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<ReliabilityAlertType> | null;
   ...
   * @return updated obj instance, same as {@link Persistable#update} return value.
   */
  clearUserUpdates(spec?: MergeSpec): ReliabilityAlertType | null;
   ...
   *         {@link Persistable#updateBatch}.
   */
  static clearUserUpdatesBatch(objs?: Array_Type<SeedData>, spec?: MergeSpec): ObjList<ReliabilityAlertType> | null;
  ...
  dependencies(): SeedDataDeps<ReliabilityAlertType> | null;
