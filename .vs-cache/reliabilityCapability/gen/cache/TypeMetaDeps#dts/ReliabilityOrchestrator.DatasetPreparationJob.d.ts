// TypeScript definitions for the C3 type ReliabilityOrchestrator.DatasetPreparationJob

/**
 * Represents a model inference job that can be executed on {@link ReliabilityAsset}s and a given {@link MlProject}.
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityOrchestrator.DatasetPreparationJob
 */
declare namespace ReliabilityOrchestrator {
  export interface IDatasetPreparationJob {
 ...
 */
declare namespace ReliabilityOrchestrator {
  export class DatasetPreparationJob extends Obj  {

    /**
     * The array of configurations this job run must execute.
     */
    readonly jobSpecs: Array_Type<ReliabilityOrchestrator.DatasetPreparationJobSpec>;
    withJobSpecs(jobSpecs: Array_Type<ReliabilityOrchestrator.DatasetPreparationJobSpec> | Array<IReliabilityOrchestrator.DatasetPreparationJobSpec>): ReliabilityOrchestrator.DatasetPreparationJob;
     ...
     */
    readonly id: string;
    withId(id: string): ReliabilityOrchestrator.DatasetPreparationJob;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityOrchestrator.DatasetPreparationJob;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): ReliabilityOrchestrator.DatasetPreparationJob;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): ReliabilityOrchestrator.DatasetPreparationJob;
    ...
    withVersion(version: number | null): ReliabilityOrchestrator.DatasetPreparationJob;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): ReliabilityOrchestrator.DatasetPreparationJob;
     ...
     * @see #toJson
     */
    static fromJson(json: any): ReliabilityOrchestrator.DatasetPreparationJob | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): ReliabilityOrchestrator.DatasetPreparationJob | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): ReliabilityOrchestrator.DatasetPreparationJob | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): ReliabilityOrchestrator.DatasetPreparationJob | null;
     ...
     */
    replaceType(old: Type, new_: Type): ReliabilityOrchestrator.DatasetPreparationJob;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityOrchestrator.DatasetPreparationJob;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityOrchestrator.DatasetPreparationJob;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityOrchestrator.DatasetPreparationJob>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityOrchestrator.DatasetPreparationJob>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityOrchestrator.DatasetPreparationJob;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityOrchestrator.DatasetPreparationJob;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityOrchestrator.DatasetPreparationJob;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): ReliabilityOrchestrator.DatasetPreparationJob;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): ReliabilityOrchestrator.DatasetPreparationJob;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityOrchestrator.DatasetPreparationJob;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityOrchestrator.DatasetPreparationJob;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityOrchestrator.DatasetPreparationJob;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): ReliabilityOrchestrator.DatasetPreparationJob;
     ...
     * @see #removeField
     */
    withoutField(field: string): ReliabilityOrchestrator.DatasetPreparationJob;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): ReliabilityOrchestrator.DatasetPreparationJob;
     ...
     */
    withoutFields(fields: Array_Type<string>): ReliabilityOrchestrator.DatasetPreparationJob;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityOrchestrator.DatasetPreparationJob;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): ReliabilityOrchestrator.DatasetPreparationJob;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityOrchestrator.DatasetPreparationJob;
     ...
     * @see #unsetField
     */
    defaultField(field: string): ReliabilityOrchestrator.DatasetPreparationJob;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): ReliabilityOrchestrator.DatasetPreparationJob;
     ...
     * @see #removeField
     */
    unsetField(field: string): ReliabilityOrchestrator.DatasetPreparationJob;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): ReliabilityOrchestrator.DatasetPreparationJob;
     ...
     * @see #unsetField
     */
    removeField(field: string): ReliabilityOrchestrator.DatasetPreparationJob;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): ReliabilityOrchestrator.DatasetPreparationJob;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityOrchestrator.DatasetPreparationJob;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityOrchestrator.DatasetPreparationJob;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityOrchestrator.DatasetPreparationJob;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityOrchestrator.DatasetPreparationJob;

    mergeJson(json: any): ReliabilityOrchestrator.DatasetPreparationJob;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityOrchestrator.DatasetPreparationJob;
     ...
     */
    sumObj(other: Obj, deep?: boolean): ReliabilityOrchestrator.DatasetPreparationJob;
     ...
     */
    singletonArray(): Array_Type<ReliabilityOrchestrator.DatasetPreparationJob>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityOrchestrator.DatasetPreparationJob> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<ReliabilityOrchestrator.DatasetPreparationJob> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<ReliabilityOrchestrator.DatasetPreparationJob>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<ReliabilityOrchestrator.DatasetPreparationJob> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, ReliabilityOrchestrator.DatasetPreparationJob> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityOrchestrator.DatasetPreparationJob> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<ReliabilityOrchestrator.DatasetPreparationJob>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<ReliabilityOrchestrator.DatasetPreparationJob>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityOrchestrator.DatasetPreparationJob;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityOrchestrator.DatasetPreparationJob;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityOrchestrator.DatasetPreparationJob;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): ReliabilityOrchestrator.DatasetPreparationJob;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityOrchestrator.DatasetPreparationJob;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): ReliabilityOrchestrator.DatasetPreparationJob;
     ...
     * @see #fromString
     */
    static make(s: string): ReliabilityOrchestrator.DatasetPreparationJob | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityOrchestrator.DatasetPreparationJob;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): ReliabilityOrchestrator.DatasetPreparationJob;
     ...
     */
    static cachedEmptyInst(): ReliabilityOrchestrator.DatasetPreparationJob;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityOrchestrator.DatasetPreparationJob> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): ReliabilityOrchestrator.DatasetPreparationJob;
     ...
     */
    doStart(options?: ReliabilityOrchestrator.JobOptions, additionalParams?: Map_Type<string, any>): Pair<ReliabilityOrchestrator.DatasetPreparationJobRun, MlOperationRun<ReliabilityOrchestrator.DatasetPreparationJobRun>>;
     ...
     */
    start(options?: ReliabilityOrchestrator.JobOptions, additionalParams?: Map_Type<string, any>): MlOperationRun<ReliabilityOrchestrator.DatasetPreparationJobRun>;

    /**
     * @return The concrete {@link ReliabilityOrchestrator.JobRun} subType.
     */
    static jobRunType(): Type<<ReliabilityOrchestrator.DatasetPreparationJobRun>> | null;

    /**
     * @return the concrete {@link ReliabilityOrchestrator.JobSpec} subType.
     */
    static jobSpecType(): Type<<ReliabilityOrchestrator.DatasetPreparationJobSpec>> | null;
     ...
     */
    fetchJobRunForOperationRun(run: MlOperationRun<any>): ReliabilityOrchestrator.DatasetPreparationJobRun | null;
     ...
     */
    fetchLatestJobRun(): ReliabilityOrchestrator.DatasetPreparationJobRun | null;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<ReliabilityOrchestrator.DatasetPreparationJob>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<ReliabilityOrchestrator.DatasetPreparationJob>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityOrchestrator.DatasetPreparationJob> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityOrchestrator.DatasetPreparationJob>> | null;
     ...
     */
    get(include?: string): ReliabilityOrchestrator.DatasetPreparationJob | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): ReliabilityOrchestrator.DatasetPreparationJob | null;
     ...
     */
    getMissing(spec: GetMissingSpec): ReliabilityOrchestrator.DatasetPreparationJob;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): ReliabilityOrchestrator.DatasetPreparationJob | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): ReliabilityOrchestrator.DatasetPreparationJob;
     ...
     * @see #toString
     */
    static fromString(s: string): ReliabilityOrchestrator.DatasetPreparationJob | null;
     ...
     */
    create(spec?: UpsertSpec): ReliabilityOrchestrator.DatasetPreparationJob | null;
     ...
     */
    static createBatch(objs: Array_Type<ReliabilityOrchestrator.DatasetPreparationJob>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.DatasetPreparationJob> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<ReliabilityOrchestrator.DatasetPreparationJob>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityOrchestrator.DatasetPreparationJob> | null;
     ...
     */
    update(srcObj?: ReliabilityOrchestrator.DatasetPreparationJob, spec?: UpsertSpec): ReliabilityOrchestrator.DatasetPreparationJob | null;
     ...
     */
    upsert(srcObj?: ReliabilityOrchestrator.DatasetPreparationJob, spec?: UpsertSpec): ReliabilityOrchestrator.DatasetPreparationJob | null;
     ...
     */
    merge(spec?: MergeSpec): ReliabilityOrchestrator.DatasetPreparationJob | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): ReliabilityOrchestrator.DatasetPreparationJob | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): ReliabilityOrchestrator.DatasetPreparationJob | null;
     ...
     */
    static updateBatch(objs: Array_Type<ReliabilityOrchestrator.DatasetPreparationJob>, srcObjs?: Array_Type<ReliabilityOrchestrator.DatasetPreparationJob>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.DatasetPreparationJob> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<ReliabilityOrchestrator.DatasetPreparationJob> | null>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.DatasetPreparationJob> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<ReliabilityOrchestrator.DatasetPreparationJob>, srcObjs?: Array_Type<ReliabilityOrchestrator.DatasetPreparationJob>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.DatasetPreparationJob> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<ReliabilityOrchestrator.DatasetPreparationJob> | null>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.DatasetPreparationJob> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<ReliabilityOrchestrator.DatasetPreparationJob>, spec?: TouchSpec): ObjList<ReliabilityOrchestrator.DatasetPreparationJob> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityOrchestrator.DatasetPreparationJob>, spec?: MergeSpec): ObjList<ReliabilityOrchestrator.DatasetPreparationJob> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityOrchestrator.DatasetPreparationJob>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityOrchestrator.DatasetPreparationJob> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<ReliabilityOrchestrator.DatasetPreparationJob> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityOrchestrator.DatasetPreparationJob> | null;
     ...
     */
    static mergeAll(mergeObj: ReliabilityOrchestrator.DatasetPreparationJob, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: ReliabilityOrchestrator.DatasetPreparationJob, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<ReliabilityOrchestrator.DatasetPreparationJob>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.DatasetPreparationJob> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<ReliabilityOrchestrator.DatasetPreparationJob>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.DatasetPreparationJob> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): ReliabilityOrchestrator.DatasetPreparationJob | null;
     ...
     */
    static beforeCreate(objs: Array_Type<ReliabilityOrchestrator.DatasetPreparationJob>): ObjList<ReliabilityOrchestrator.DatasetPreparationJob>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<ReliabilityOrchestrator.DatasetPreparationJob>): ObjList<ReliabilityOrchestrator.DatasetPreparationJob>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<ReliabilityOrchestrator.DatasetPreparationJob>): ObjList<ReliabilityOrchestrator.DatasetPreparationJob>;
     ...
     */
    static afterCreate(objs: Array_Type<ReliabilityOrchestrator.DatasetPreparationJob>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<ReliabilityOrchestrator.DatasetPreparationJob>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<ReliabilityOrchestrator.DatasetPreparationJob>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityOrchestrator.DatasetPreparationJob>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityOrchestrator.DatasetPreparationJob>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): ReliabilityOrchestrator.DatasetPreparationJob | null;
     ...
     */
    withoutIdentity(): ReliabilityOrchestrator.DatasetPreparationJob | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<ReliabilityOrchestrator.DatasetPreparationJob>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: ReliabilityOrchestrator.DatasetPreparationJob, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<ReliabilityOrchestrator.DatasetPreparationJob>, callback?: λFunction<ReliabilityOrchestrator.DatasetPreparationJob | null, ReliabilityOrchestrator.DatasetPreparationJob | null>): ObjList<ReliabilityOrchestrator.DatasetPreparationJob>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<ReliabilityOrchestrator.DatasetPreparationJob>, callback?: λFunction<ReliabilityOrchestrator.DatasetPreparationJob | null, ReliabilityOrchestrator.DatasetPreparationJob | null>): Array_Type<ObjError> | null;
