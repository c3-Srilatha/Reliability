// TypeScript definitions for the C3 type ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob
 */
declare namespace ReliabilityOrchestrator.ReliabilityRisk {
  export interface IModelClassificationJob {
 ...
 */
declare namespace ReliabilityOrchestrator.ReliabilityRisk {
  export class ModelClassificationJob extends Obj  {

    /**
     * current or last job execution for this instance
     */
    readonly run?: BatchJobRun;
    withRun(run: IBatchJobRun | null): ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob;

    /**
     * previous job executions for this instance
     */
    readonly runs?: Array_Type<BatchJobRun>;
    withRuns(runs: Array_Type<BatchJobRun> | Array<IBatchJobRun> | null): ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob;

    /**
     * FOR INTERNAL USE ONLY - Specify options in call to {@link start}.
     */
    readonly options?: Obj;
    withOptions(options: IObj | null): ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob;
    ...
    withOnCompleteCallback(onCompleteCallback: IJobBase.Callback | null): ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob;
    ...
    withPriority(priority: number | null): ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob;
    ...
    withDisabled(disabled: boolean): ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob;
    ...
    withMaxConcurrency(maxConcurrency: number | null): ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob;
    ...
    withMaxConcurrencyPerNode(maxConcurrencyPerNode: number | null): ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob;
    ...
    withRunAsUser(runAsUser: boolean): ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob;

    /**
     * Don't set this field in the BatchJob, set it in the BatchJobOptions when calling `start`
     */
    readonly nodePool?: string;
    withNodePool(nodePool: string | null): ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob;
    ...
    withSkipIfRunning(skipIfRunning: boolean): ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob;

    /**
     * Set to between 1 and 5 to enable auto recovery. See {@link invalidation-queues.c3doc Invalidation Queues} for detailed documentation.
     */
    readonly numAutoRecoveryAttempts?: number;
    withNumAutoRecoveryAttempts(numAutoRecoveryAttempts: number | null): ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob;
    ...
    withPropagateActionContext(propagateActionContext: boolean): ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob;
    ...
    withTypeIdent(typeIdent: string | null): ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob;
     ...
     */
    readonly id: string;
    withId(id: string): ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob;
    ...
    withVersion(version: number | null): ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob;
    ...
    withAbortOnError(abortOnError: boolean): ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob;
     ...
     * @see #toJson
     */
    static fromJson(json: any): ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob | null;
     ...
     */
    replaceType(old: Type, new_: Type): ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob;
     ...
     * @see #removeField
     */
    withoutField(field: string): ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob;
     ...
     */
    withoutFields(fields: Array_Type<string>): ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob;
     ...
     * @see #unsetField
     */
    defaultField(field: string): ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob;
     ...
     * @see #removeField
     */
    unsetField(field: string): ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob;
     ...
     * @see #unsetField
     */
    removeField(field: string): ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob;

    mergeJson(json: any): ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob;
     ...
     */
    sumObj(other: Obj, deep?: boolean): ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob;
     ...
     */
    singletonArray(): Array_Type<ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob;
     ...
     * @see #fromString
     */
    static make(s: string): ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob;
     ...
     */
    static cachedEmptyInst(): ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob;
     ...
     */
    start(options?: ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJobOptions): BatchJobStatus | null;
     ...
     */
    cleanup(options?: ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJobOptions): void;
    ...
    cancelJob(removeResults?: boolean, force?: boolean): JobBase<BatchJobRun, BatchJobStatus, ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJobOptions> | null;

    failJob(run: JobRun<BatchJobStatusBase>): JobBase<BatchJobRun, BatchJobStatus, ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJobOptions> | null;
    ...
    validateStart(options?: ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJobOptions): void;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob>> | null;
     ...
     */
    get(include?: string): ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob | null;
     ...
     */
    getMissing(spec: GetMissingSpec): ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob;
     ...
     * @see #toString
     */
    static fromString(s: string): ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob | null;
     ...
     */
    create(spec?: UpsertSpec): ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob | null;
     ...
     */
    static createBatch(objs: Array_Type<ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob> | null;
     ...
     */
    update(srcObj?: ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob, spec?: UpsertSpec): ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob | null;
     ...
     */
    upsert(srcObj?: ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob, spec?: UpsertSpec): ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob | null;
     ...
     */
    merge(spec?: MergeSpec): ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob | null;
     ...
     */
    static updateBatch(objs: Array_Type<ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob>, srcObjs?: Array_Type<ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob> | null>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob>, srcObjs?: Array_Type<ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob> | null>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob>, spec?: TouchSpec): ObjList<ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob>, spec?: MergeSpec): ObjList<ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob> | null;
     ...
     */
    static mergeAll(mergeObj: ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob | null;
     ...
     */
    static beforeCreate(objs: Array_Type<ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob>): ObjList<ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob>): ObjList<ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob>): ObjList<ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob>;
     ...
     */
    static afterCreate(objs: Array_Type<ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob | null;
     ...
     */
    withoutIdentity(): ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob>, callback?: λFunction<ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob | null, ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob | null>): ObjList<ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob>, callback?: λFunction<ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob | null, ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob | null>): Array_Type<ObjError> | null;
     ...
     */
    static doStart(job?: ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob, options?: ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJobOptions): void;
     ...
     */
    static processBatch(batch?: ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJobBatch, job?: ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob, options?: ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJobOptions): void;
     ...
     */
    static allComplete(job: ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob, options?: ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJobOptions): string | null;
     ...
     *           Options the job was run with.
     */
    static failed(job: ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob, status: BatchJobStatus, options?: ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJobOptions): void;
     ...
     *        Batch to schedule.
     */
    scheduleBatch(batch?: ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJobBatch): void;
     ...
     *        Batches to schedule.
     */
    scheduleBatches(batches?: Array_Type<ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJobBatch>): void;
     ...
     */
    static scheduleObjBatch(job?: ReliabilityOrchestrator.ReliabilityRisk.ModelClassificationJob, objBatch?: ObjBatch, logPrefix?: string): number | null;
