// TypeScript definitions for the C3 type InventorySeries
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of InventorySeries
 */
declare interface IInventorySeries {
   ...
   */
  data?: Array_Type<InventoryMeasurement> | Array<IInventoryMeasurement>;
   ...
   */
  forecasts?: Array_Type<WorkOrderPartsForecast> | Array<IWorkOrderPartsForecast>;
 ...
 */
declare class InventorySeries extends Obj  {

  /**
   * Populated on normalization. Indicates the earliest data point across various timeseries fields.
   */
  readonly earliest?: DateTime;
  withEarliest(earliest: DateTime | Date | string | null): InventorySeries;

  /**
   * Populated on normalization. Indicates the latest data point across various timeseries fields.
   */
  readonly latest?: DateTime;
  withLatest(latest: DateTime | Date | string | null): InventorySeries;

  /**
   * Populated on normalization. Indicates the earliest data point for each {@link Ann.Ts} fields.
   */
  readonly earliestTsDp?: Map_Type<string, TSDataPoint>;
  withEarliestTsDp(earliestTsDp: Map_Type<string, TSDataPoint> | {[key: string]: ITSDataPoint} | null): InventorySeries;

  /**
   * Populated on normalization. Indicates the latest data point for each {@link Ann.Ts} fields.
   */
  readonly latestTsDp?: Map_Type<string, TSDataPoint>;
  withLatestTsDp(latestTsDp: Map_Type<string, TSDataPoint> | {[key: string]: ITSDataPoint} | null): InventorySeries;
  ...
  withInterval(interval: string | null): InventorySeries;
  ...
  withTimeZone(timeZone: string | null): InventorySeries;

  /**
   * If set, disables normalizing this time series. Invalidations will still continue to happen for this series normally.
   */
  readonly doNotNormalize?: boolean;
  withDoNotNormalize(doNotNormalize: boolean): InventorySeries;

  /**
   * Data points corresponding to this timeseries header
   */
  readonly data?: Array_Type<InventoryMeasurement>;
  withData(data: Array_Type<InventoryMeasurement> | Array<IInventoryMeasurement> | null): InventorySeries;

  /**
   * Use this field to specify the interpolation mechanism to be applied for gaps in interval timeseries. Default: `ZERO_INTERPOLATOR`.
   */
  readonly interpolator?: string;
  withInterpolator(interpolator: string | null): InventorySeries;

  /**
   * Use this field to specify how normalization should handle duplicate data points. A duplicate point is one that has the same start, end, value, unit, and {@link TimedDataPointFields#isEstimated} values. Default: `IGNORE`.
   */
  readonly duplicateHandling?: string;
  withDuplicateHandling(duplicateHandling: string | null): InventorySeries;

  /**
   * Used to specify how normalization should handle overlapping data points. Default: `AVG`.
   */
  readonly overlapHandling?: string;
  withOverlapHandling(overlapHandling: string | null): InventorySeries;
  ...
  withBucketInterval(bucketInterval: string | null): InventorySeries;
  ...
  withNormalizationPartitionStrategy(normalizationPartitionStrategy: INormalizationPartitionStrategy | null): InventorySeries;

  /**
   * Indicates whether the last data point should be repeated until infinity
   */
  readonly extrapolate?: boolean;
  withExtrapolate(extrapolate: boolean): InventorySeries;
  ...
  withAvgDailyUsage(avgDailyUsage: number | null): InventorySeries;
  ...
  withCurrentStock(currentStock: number | null): InventorySeries;
  ...
  withAvgLeadTime(avgLeadTime: number | null): InventorySeries;
  ...
  withCalculatedAvgLeadTime(calculatedAvgLeadTime: number | null): InventorySeries;
  ...
  withReorderLevel(reorderLevel: number | null): InventorySeries;
  ...
  withReorderQty(reorderQty: number | null): InventorySeries;
  ...
  withDaysOnHand(daysOnHand: number | null): InventorySeries;
  ...
  withDohOverLeadTimeRatio(dohOverLeadTimeRatio: number | null): InventorySeries;

  /**
   * Represents number of {@link WorkOrder}s which have a given {@link InventorySeries#partNumber} part allocated/reserved for it's execution.
   * Only considers {@link WorkOrder}s scheduled in the future.
   */
  readonly workOrdersReserved?: number;
  withWorkOrdersReserved(workOrdersReserved: number | null): InventorySeries;

  /**
   * Represents number of {@link WorkOrder}s which have a given {@link InventorySeries#partNumber} required for it's execution, but was not allocated to it.
   * Only considers {@link WorkOrder}s scheduled in the future.
   */
  readonly workOrdersImpacted?: number;
  withWorkOrdersImpacted(workOrdersImpacted: number | null): InventorySeries;

  /**
   * Represents number of {@link PurchaseOrderLine}s for a given {@link InventorySeries#partNumber} that have been placed in the past.
   */
  readonly numberOfReorders?: number;
  withNumberOfReorders(numberOfReorders: number | null): InventorySeries;
  ...
  withTypeIdent(typeIdent: string | null): InventorySeries;
   ...
   */
  readonly id: string;
  withId(id: string): InventorySeries;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): InventorySeries;

  /**
   * The name of the part
   */
  readonly name?: string;
  withName(name: string | null): InventorySeries;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): InventorySeries;
  ...
  withVersion(version: number | null): InventorySeries;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): InventorySeries;

  /**
   * The item facility associated with this series
   */
  readonly itemFacility?: string;
  withItemFacility(itemFacility: string | null): InventorySeries;

  /**
   * The treatment to apply to {@link InventoryMeasurement#quantity}
   */
  readonly treatment?: string;
  withTreatment(treatment: string | null): InventorySeries;

  /**
   * All the inventory related {@link WorkOrderPartsForecast}s that have been made for this part.
   */
  readonly forecasts?: Array_Type<WorkOrderPartsForecast>;
  withForecasts(forecasts: Array_Type<WorkOrderPartsForecast> | Array<IWorkOrderPartsForecast> | null): InventorySeries;
  ...
  withUnitConstraint(unitConstraint: IUnit | null): InventorySeries;

  /**
   * A unique identifier for the part.  This should never be duplicated across unique parts
   */
  readonly partNumber?: string;
  withPartNumber(partNumber: string | null): InventorySeries;

  /**
   * A description of the part
   */
  readonly description?: string;
  withDescription(description: string | null): InventorySeries;

  /**
   * The supplier of the part
   */
  readonly supplier?: string;
  withSupplier(supplier: string | null): InventorySeries;

  /**
   * The cost of the part
   */
  readonly cost?: number;
  withCost(cost: number | null): InventorySeries;
   ...
   * @see #toJson
   */
  static fromJson(json: any): InventorySeries | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): InventorySeries | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): InventorySeries | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): InventorySeries | null;
   ...
   */
  replaceType(old: Type, new_: Type): InventorySeries;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): InventorySeries;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): InventorySeries;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<InventorySeries>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<InventorySeries>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): InventorySeries;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): InventorySeries;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): InventorySeries;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): InventorySeries;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): InventorySeries;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): InventorySeries;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): InventorySeries;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): InventorySeries;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): InventorySeries;
   ...
   * @see #removeField
   */
  withoutField(field: string): InventorySeries;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): InventorySeries;
   ...
   */
  withoutFields(fields: Array_Type<string>): InventorySeries;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): InventorySeries;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): InventorySeries;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): InventorySeries;
   ...
   * @see #unsetField
   */
  defaultField(field: string): InventorySeries;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): InventorySeries;
   ...
   * @see #removeField
   */
  unsetField(field: string): InventorySeries;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): InventorySeries;
   ...
   * @see #unsetField
   */
  removeField(field: string): InventorySeries;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): InventorySeries;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): InventorySeries;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): InventorySeries;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): InventorySeries;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): InventorySeries;

  mergeJson(json: any): InventorySeries;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): InventorySeries;
   ...
   */
  sumObj(other: Obj, deep?: boolean): InventorySeries;
   ...
   */
  singletonArray(): Array_Type<InventorySeries>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<InventorySeries> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<InventorySeries> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<InventorySeries>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<InventorySeries> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, InventorySeries> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, InventorySeries> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<InventorySeries>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<InventorySeries>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): InventorySeries;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): InventorySeries;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): InventorySeries;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): InventorySeries;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): InventorySeries;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): InventorySeries;
   ...
   * @see #fromString
   */
  static make(s: string): InventorySeries | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): InventorySeries;
   ...
   */
  static cachedEmptyInst(): InventorySeries;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<InventorySeries> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): InventorySeries;
   ...
   */
  static normalizeTimeseries(timeseries?: TimedDataFields<InventoryMeasurement>, start?: DateTime, end?: DateTime, overrideGrain?: string, forceGrainDetection?: boolean, force?: boolean): void;
   ...
   */
  static normalize(timeseries?: TimedDataFields<InventoryMeasurement>, start?: DateTime, end?: DateTime, overrideGrain?: string, forceGrainDetection?: boolean): NormalizationResult | null;
   ...
   */
  static normalizationUnit(rawHeader: TimedDataFields<InventoryMeasurement>, tsField: string): Unit | null;
   ...
   */
  static normalizationTreatment(rawHeader: TimedDataFields<InventoryMeasurement>, tsField: string): string;
   ...
   * Only considers {@link WorkOrder}s scheduled in the future.
   */
  static calculateWorkOrdersReserved(seriesObj?: InventorySeries): number | null;
   ...
   * Only considers {@link WorkOrder}s scheduled in the future.
   */
  static calculateWorkOrdersImpacted(seriesObj?: InventorySeries): number | null;
   ...
   */
  static calculateWorkOrderStats(seriesObj: InventorySeries): InventorySeries;
   ...
   */
  static calculatePurchaseOrderStats(seriesObj: InventorySeries, lookBackTimeRange?: TimeRange): InventorySeries;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<InventorySeries>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<InventorySeries>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<InventorySeries> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<InventorySeries>> | null;
   ...
   */
  get(include?: string): InventorySeries | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): InventorySeries | null;
   ...
   */
  getMissing(spec: GetMissingSpec): InventorySeries;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): InventorySeries | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): InventorySeries;
   ...
   * @see #toString
   */
  static fromString(s: string): InventorySeries | null;
   ...
   */
  create(spec?: UpsertSpec): InventorySeries | null;
   ...
   */
  static createBatch(objs: Array_Type<InventorySeries>, spec?: UpsertSpec): ObjList<InventorySeries> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<InventorySeries>, spec?: CreateBatchObjStreamSpec): ObjList<InventorySeries> | null;
   ...
   */
  update(srcObj?: InventorySeries, spec?: UpsertSpec): InventorySeries | null;
   ...
   */
  upsert(srcObj?: InventorySeries, spec?: UpsertSpec): InventorySeries | null;
   ...
   */
  merge(spec?: MergeSpec): InventorySeries | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): InventorySeries | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): InventorySeries | null;
   ...
   */
  static updateBatch(objs: Array_Type<InventorySeries>, srcObjs?: Array_Type<InventorySeries>, spec?: UpsertSpec): ObjList<InventorySeries> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<InventorySeries> | null>, spec?: UpsertSpec): ObjList<InventorySeries> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<InventorySeries>, srcObjs?: Array_Type<InventorySeries>, spec?: UpsertSpec): ObjList<InventorySeries> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<InventorySeries> | null>, spec?: UpsertSpec): ObjList<InventorySeries> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<InventorySeries>, spec?: TouchSpec): ObjList<InventorySeries> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<InventorySeries>, spec?: MergeSpec): ObjList<InventorySeries> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<InventorySeries>, mergeInclude: string, spec?: MergeSpec): ObjList<InventorySeries> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<InventorySeries> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<InventorySeries> | null;
   ...
   */
  static mergeAll(mergeObj: InventorySeries, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: InventorySeries, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<InventorySeries>, spec?: UpsertSpec): ObjList<InventorySeries> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<InventorySeries>, spec?: UpsertSpec): ObjList<InventorySeries> | null;
   ...
   */
  static beforeCreate(objs: Array_Type<InventorySeries>): ObjList<InventorySeries>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<InventorySeries>): ObjList<InventorySeries>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<InventorySeries>): ObjList<InventorySeries>;
   ...
   */
  static afterCreate(objs: Array_Type<InventorySeries>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<InventorySeries>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<InventorySeries>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<InventorySeries>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<InventorySeries>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): InventorySeries | null;
   ...
   */
  withoutIdentity(): InventorySeries | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<InventorySeries>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: InventorySeries, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<InventorySeries>, callback?: λFunction<InventorySeries | null, InventorySeries | null>): ObjList<InventorySeries>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<InventorySeries>, callback?: λFunction<InventorySeries | null, InventorySeries | null>): Array_Type<ObjError> | null;
   ...
   */
  static refreshStats(spec?: InventorySeriesFetchSpec, partsToRefresh?: Array_Type<InventorySeries> = '[]'): void;

  /**
   * function that starts a {@link InventorySeriesRefreshStatsBatchJob} to refresh parts' stats.
   */
  static triggerRefreshStatsBatchJob(options?: InventorySeriesRefreshStatsBatchJobOptions): void;
}
