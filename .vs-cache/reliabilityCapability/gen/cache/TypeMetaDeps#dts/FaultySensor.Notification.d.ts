// TypeScript definitions for the C3 type FaultySensor.Notification
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of FaultySensor.Notification
 */
declare namespace FaultySensor {
  export interface INotification {
     ...
     */
    updatedOperationalStatus: string;

    /**
     * Related model of the current notification.
     */
    relatedModel: IReliabilityRiskMlModel;
     ...
     */
    resultingFeatureSetCardinality: number;

    /**
     * Related asset of the current notification.
     */
    relatedAsset: IReliabilityAsset;
     ...
     */
    trainJob?: IMlModel.Train.JobRun;
     ...
     */
    jobStatus: IFaultySensor.Notification.TrainJobStatus;
 ...
 */
declare namespace FaultySensor {
  export class Notification extends Obj  {
     ...
     */
    readonly id: string;
    withId(id: string): FaultySensor.Notification;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): FaultySensor.Notification;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): FaultySensor.Notification;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): FaultySensor.Notification;
    ...
    withVersion(version: number | null): FaultySensor.Notification;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): FaultySensor.Notification;

    /**
     * Sensor of the current notification.
     */
    readonly sensor: Sensor;
    withSensor(sensor: ISensor): FaultySensor.Notification;

    /**
     * Name of the #sensor to be included in the notification content.
     */
    readonly sensorName: string;
    withSensorName(sensorName: string): FaultySensor.Notification;

    /**
     * Operational status of the #sensor to be included in the notification content.
     */
    readonly updatedOperationalStatus: string;
    withUpdatedOperationalStatus(updatedOperationalStatus: string): FaultySensor.Notification;

    /**
     * Related model of the current notification.
     */
    readonly relatedModel: ReliabilityRiskMlModel;
    withRelatedModel(relatedModel: IReliabilityRiskMlModel): FaultySensor.Notification;

    /**
     * Name of the #relatedModel to be included in the notification content.
     */
    readonly relatedModelName: string;
    withRelatedModelName(relatedModelName: string): FaultySensor.Notification;

    /**
     * Feature set cardinality of the #relatedModel to be included in the notification content.
     */
    readonly resultingFeatureSetCardinality: number;
    withResultingFeatureSetCardinality(resultingFeatureSetCardinality: number): FaultySensor.Notification;

    /**
     * Related asset of the current notification.
     */
    readonly relatedAsset: ReliabilityAsset;
    withRelatedAsset(relatedAsset: IReliabilityAsset): FaultySensor.Notification;

    /**
     * Name of the #relatedAsset to be included in the notification content.
     */
    readonly relatedAssetName: string;
    withRelatedAssetName(relatedAssetName: string): FaultySensor.Notification;

    /**
     * Train job of the current notification.
     * If there's a failure that prevents the model from retraining, the job will be empty
     */
    readonly trainJob?: MlModel.Train.JobRun;
    withTrainJob(trainJob: IMlModel.Train.JobRun | null): FaultySensor.Notification;

    /**
     * Name of the #trainJob to be included in the notification content.
     */
    readonly trainJobName?: string;
    withTrainJobName(trainJobName: string | null): FaultySensor.Notification;

    /**
     * The most recent job status of the current notification. This object will be updated at run time only if the train
     * job exists in order to update the latest status of the job.
     */
    readonly jobStatus: FaultySensor.Notification.TrainJobStatus;
    withJobStatus(jobStatus: IFaultySensor.Notification.TrainJobStatus): FaultySensor.Notification;

    /**
     * Author of the current notification, it refers to the user who triggered the operating status update.
     */
    readonly author: User;
    withAuthor(author: IUser): FaultySensor.Notification;

    /**
     * Name of the #author to be included in the notification content.
     */
    readonly authorName: string;
    withAuthorName(authorName: string): FaultySensor.Notification;

    /**
     * The time of creation of the current notification
     */
    readonly timestamp: DateTime;
    withTimestamp(timestamp: DateTime | Date | string): FaultySensor.Notification;
    ...
    withIsTest(isTest: boolean): FaultySensor.Notification;
     ...
     * @see #toJson
     */
    static fromJson(json: any): FaultySensor.Notification | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): FaultySensor.Notification | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): FaultySensor.Notification | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): FaultySensor.Notification | null;
     ...
     */
    replaceType(old: Type, new_: Type): FaultySensor.Notification;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): FaultySensor.Notification;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): FaultySensor.Notification;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<FaultySensor.Notification>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<FaultySensor.Notification>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): FaultySensor.Notification;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): FaultySensor.Notification;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): FaultySensor.Notification;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): FaultySensor.Notification;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): FaultySensor.Notification;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): FaultySensor.Notification;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): FaultySensor.Notification;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): FaultySensor.Notification;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): FaultySensor.Notification;
     ...
     * @see #removeField
     */
    withoutField(field: string): FaultySensor.Notification;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): FaultySensor.Notification;
     ...
     */
    withoutFields(fields: Array_Type<string>): FaultySensor.Notification;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): FaultySensor.Notification;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): FaultySensor.Notification;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): FaultySensor.Notification;
     ...
     * @see #unsetField
     */
    defaultField(field: string): FaultySensor.Notification;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): FaultySensor.Notification;
     ...
     * @see #removeField
     */
    unsetField(field: string): FaultySensor.Notification;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): FaultySensor.Notification;
     ...
     * @see #unsetField
     */
    removeField(field: string): FaultySensor.Notification;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): FaultySensor.Notification;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): FaultySensor.Notification;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): FaultySensor.Notification;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): FaultySensor.Notification;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): FaultySensor.Notification;

    mergeJson(json: any): FaultySensor.Notification;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): FaultySensor.Notification;
     ...
     */
    sumObj(other: Obj, deep?: boolean): FaultySensor.Notification;
     ...
     */
    singletonArray(): Array_Type<FaultySensor.Notification>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<FaultySensor.Notification> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<FaultySensor.Notification> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<FaultySensor.Notification>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<FaultySensor.Notification> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, FaultySensor.Notification> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, FaultySensor.Notification> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<FaultySensor.Notification>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<FaultySensor.Notification>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): FaultySensor.Notification;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): FaultySensor.Notification;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): FaultySensor.Notification;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): FaultySensor.Notification;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): FaultySensor.Notification;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): FaultySensor.Notification;
     ...
     * @see #fromString
     */
    static make(s: string): FaultySensor.Notification | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): FaultySensor.Notification;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): FaultySensor.Notification;
     ...
     */
    static cachedEmptyInst(): FaultySensor.Notification;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<FaultySensor.Notification> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): FaultySensor.Notification;

    /**
     * Calls {@link TemplateWithDefaultValue} and gets the corresponding title for this section
     */
    static buildTitle(): string | null;
     ...
     * </ol>
     */
    static buildContent(isTest?: boolean = 'false'): string | null;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<FaultySensor.Notification>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<FaultySensor.Notification>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<FaultySensor.Notification> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<FaultySensor.Notification>> | null;
     ...
     */
    get(include?: string): FaultySensor.Notification | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): FaultySensor.Notification | null;
     ...
     */
    getMissing(spec: GetMissingSpec): FaultySensor.Notification;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): FaultySensor.Notification | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): FaultySensor.Notification;
     ...
     * @see #toString
     */
    static fromString(s: string): FaultySensor.Notification | null;
     ...
     */
    create(spec?: UpsertSpec): FaultySensor.Notification | null;
     ...
     */
    static createBatch(objs: Array_Type<FaultySensor.Notification>, spec?: UpsertSpec): ObjList<FaultySensor.Notification> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<FaultySensor.Notification>, spec?: CreateBatchObjStreamSpec): ObjList<FaultySensor.Notification> | null;
     ...
     */
    update(srcObj?: FaultySensor.Notification, spec?: UpsertSpec): FaultySensor.Notification | null;
     ...
     */
    upsert(srcObj?: FaultySensor.Notification, spec?: UpsertSpec): FaultySensor.Notification | null;
     ...
     */
    merge(spec?: MergeSpec): FaultySensor.Notification | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): FaultySensor.Notification | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): FaultySensor.Notification | null;
     ...
     */
    static updateBatch(objs: Array_Type<FaultySensor.Notification>, srcObjs?: Array_Type<FaultySensor.Notification>, spec?: UpsertSpec): ObjList<FaultySensor.Notification> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<FaultySensor.Notification> | null>, spec?: UpsertSpec): ObjList<FaultySensor.Notification> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<FaultySensor.Notification>, srcObjs?: Array_Type<FaultySensor.Notification>, spec?: UpsertSpec): ObjList<FaultySensor.Notification> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<FaultySensor.Notification> | null>, spec?: UpsertSpec): ObjList<FaultySensor.Notification> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<FaultySensor.Notification>, spec?: TouchSpec): ObjList<FaultySensor.Notification> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<FaultySensor.Notification>, spec?: MergeSpec): ObjList<FaultySensor.Notification> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<FaultySensor.Notification>, mergeInclude: string, spec?: MergeSpec): ObjList<FaultySensor.Notification> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<FaultySensor.Notification> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<FaultySensor.Notification> | null;
     ...
     */
    static mergeAll(mergeObj: FaultySensor.Notification, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: FaultySensor.Notification, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<FaultySensor.Notification>, spec?: UpsertSpec): ObjList<FaultySensor.Notification> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<FaultySensor.Notification>, spec?: UpsertSpec): ObjList<FaultySensor.Notification> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): FaultySensor.Notification | null;
     ...
     */
    static beforeCreate(objs: Array_Type<FaultySensor.Notification>): ObjList<FaultySensor.Notification>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<FaultySensor.Notification>): ObjList<FaultySensor.Notification>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<FaultySensor.Notification>): ObjList<FaultySensor.Notification>;
     ...
     */
    static afterCreate(objs: Array_Type<FaultySensor.Notification>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<FaultySensor.Notification>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<FaultySensor.Notification>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<FaultySensor.Notification>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<FaultySensor.Notification>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): FaultySensor.Notification | null;
     ...
     */
    withoutIdentity(): FaultySensor.Notification | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<FaultySensor.Notification>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: FaultySensor.Notification, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<FaultySensor.Notification>, callback?: λFunction<FaultySensor.Notification | null, FaultySensor.Notification | null>): ObjList<FaultySensor.Notification>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<FaultySensor.Notification>, callback?: λFunction<FaultySensor.Notification | null, FaultySensor.Notification | null>): Array_Type<ObjError> | null;
     ...
     */
    static createNotificationsFromMapReduceResult(mrResults: Map_Type<string, FaultySensor.ModelRetrainValidationResult>, maxErrors?: number = '2000', isTest?: boolean = 'false'): void;
     ...
     */
    static _get_feature_set_cardinality_from_error(model: ReliabilityRiskMlModel, validation_error?: FaultySensor.ModelRetrainValidationError): number | null;
     ...
     *     Flag to determine if the content should only include test instances in the content. Used for testing purposes.
     */
    static createNotificationsFromModelRetraining(originalModel: ReliabilityRiskMlModel, newModels: Array_Type<ReliabilityRiskMlModel>, retrainValidationResult: FaultySensor.ModelRetrainValidationResult, modelConfigRun?: ModelConfigRun, sourceOfTruthModel?: ReliabilityRiskMlModel, isTest?: boolean = 'false'): void;
  }
}
