// TypeScript definitions for the C3 type ReliabilityMlModelReport

/**
 * A single exportable PDF model report. May contain information about one or more models.
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityMlModelReport
 */
declare interface IReliabilityMlModelReport {
   ...
   * @inheritdoc
   */
  spec: IReliabilityMlModelReportSpec;
  ...
  /**
   * The models whose information is in the report.
   */
  models?: Array_Type<ReliabilityMlModel> | Array<IReliabilityMlModel>;

  /**
   * The model that this report is the model validation report for (if applicable).
   */
  modelForValidation?: IReliabilityMlModel;
}

/**
 * A single exportable PDF model report. May contain information about one or more models.
 *
 * @remarks this represents a made instance of ReliabilityMlModelReport
 */
declare class ReliabilityMlModelReport extends Obj  {
   ...
   */
  readonly id: string;
  withId(id: string): ReliabilityMlModelReport;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityMlModelReport;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): ReliabilityMlModelReport;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): ReliabilityMlModelReport;
  ...
  withVersion(version: number | null): ReliabilityMlModelReport;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): ReliabilityMlModelReport;

  /**
   * @inheritdoc
   */
  readonly facilityFilterPaths?: Array_Type<string>;
  withFacilityFilterPaths(facilityFilterPaths: Array_Type<string> | Array<string> | null): ReliabilityMlModelReport;
  ...
  withTypeIdent(typeIdent: string | null): ReliabilityMlModelReport;

  /**
   * @inheritdoc
   */
  readonly spec: ReliabilityMlModelReportSpec;
  withSpec(spec: IReliabilityMlModelReportSpec): ReliabilityMlModelReport;

  /**
   * The report file.
   */
  readonly file?: File;
  withFile(file: IFile | null): ReliabilityMlModelReport;

  /**
   * Errors collected during the report generation.
   */
  readonly errors?: Array_Type<string>;
  withErrors(errors: Array_Type<string> | Array<string> | null): ReliabilityMlModelReport;

  /**
   * The models whose information is in the report.
   */
  readonly models?: Array_Type<ReliabilityMlModel>;
  withModels(models: Array_Type<ReliabilityMlModel> | Array<IReliabilityMlModel> | null): ReliabilityMlModelReport;

  /**
   * The model that this report is the model validation report for (if applicable).
   */
  readonly modelForValidation?: ReliabilityMlModel;
  withModelForValidation(modelForValidation: IReliabilityMlModel | null): ReliabilityMlModelReport;
   ...
   * @see #toJson
   */
  static fromJson(json: any): ReliabilityMlModelReport | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): ReliabilityMlModelReport | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): ReliabilityMlModelReport | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): ReliabilityMlModelReport | null;
   ...
   */
  replaceType(old: Type, new_: Type): ReliabilityMlModelReport;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityMlModelReport;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityMlModelReport;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityMlModelReport>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityMlModelReport>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityMlModelReport;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityMlModelReport;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityMlModelReport;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ReliabilityMlModelReport;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ReliabilityMlModelReport;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityMlModelReport;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityMlModelReport;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityMlModelReport;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ReliabilityMlModelReport;
   ...
   * @see #removeField
   */
  withoutField(field: string): ReliabilityMlModelReport;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): ReliabilityMlModelReport;
   ...
   */
  withoutFields(fields: Array_Type<string>): ReliabilityMlModelReport;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityMlModelReport;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ReliabilityMlModelReport;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityMlModelReport;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ReliabilityMlModelReport;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ReliabilityMlModelReport;
   ...
   * @see #removeField
   */
  unsetField(field: string): ReliabilityMlModelReport;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ReliabilityMlModelReport;
   ...
   * @see #unsetField
   */
  removeField(field: string): ReliabilityMlModelReport;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ReliabilityMlModelReport;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityMlModelReport;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityMlModelReport;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityMlModelReport;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityMlModelReport;

  mergeJson(json: any): ReliabilityMlModelReport;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityMlModelReport;
   ...
   */
  sumObj(other: Obj, deep?: boolean): ReliabilityMlModelReport;
   ...
   */
  singletonArray(): Array_Type<ReliabilityMlModelReport>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityMlModelReport> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ReliabilityMlModelReport> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<ReliabilityMlModelReport>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ReliabilityMlModelReport> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, ReliabilityMlModelReport> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityMlModelReport> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ReliabilityMlModelReport>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ReliabilityMlModelReport>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityMlModelReport;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityMlModelReport;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityMlModelReport;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ReliabilityMlModelReport;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityMlModelReport;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ReliabilityMlModelReport;
   ...
   * @see #fromString
   */
  static make(s: string): ReliabilityMlModelReport | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityMlModelReport;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): ReliabilityMlModelReport;
   ...
   */
  static cachedEmptyInst(): ReliabilityMlModelReport;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityMlModelReport> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): ReliabilityMlModelReport;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<ReliabilityMlModelReport>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<ReliabilityMlModelReport>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityMlModelReport> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityMlModelReport>> | null;
   ...
   */
  get(include?: string): ReliabilityMlModelReport | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): ReliabilityMlModelReport | null;
   ...
   */
  getMissing(spec: GetMissingSpec): ReliabilityMlModelReport;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): ReliabilityMlModelReport | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): ReliabilityMlModelReport;
   ...
   * @see #toString
   */
  static fromString(s: string): ReliabilityMlModelReport | null;
   ...
   */
  create(spec?: UpsertSpec): ReliabilityMlModelReport | null;
   ...
   */
  static createBatch(objs: Array_Type<ReliabilityMlModelReport>, spec?: UpsertSpec): ObjList<ReliabilityMlModelReport> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<ReliabilityMlModelReport>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityMlModelReport> | null;
   ...
   */
  update(srcObj?: ReliabilityMlModelReport, spec?: UpsertSpec): ReliabilityMlModelReport | null;
   ...
   */
  upsert(srcObj?: ReliabilityMlModelReport, spec?: UpsertSpec): ReliabilityMlModelReport | null;
   ...
   */
  merge(spec?: MergeSpec): ReliabilityMlModelReport | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): ReliabilityMlModelReport | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): ReliabilityMlModelReport | null;
   ...
   */
  static updateBatch(objs: Array_Type<ReliabilityMlModelReport>, srcObjs?: Array_Type<ReliabilityMlModelReport>, spec?: UpsertSpec): ObjList<ReliabilityMlModelReport> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<ReliabilityMlModelReport> | null>, spec?: UpsertSpec): ObjList<ReliabilityMlModelReport> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<ReliabilityMlModelReport>, srcObjs?: Array_Type<ReliabilityMlModelReport>, spec?: UpsertSpec): ObjList<ReliabilityMlModelReport> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<ReliabilityMlModelReport> | null>, spec?: UpsertSpec): ObjList<ReliabilityMlModelReport> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<ReliabilityMlModelReport>, spec?: TouchSpec): ObjList<ReliabilityMlModelReport> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityMlModelReport>, spec?: MergeSpec): ObjList<ReliabilityMlModelReport> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityMlModelReport>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityMlModelReport> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<ReliabilityMlModelReport> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityMlModelReport> | null;
   ...
   */
  static mergeAll(mergeObj: ReliabilityMlModelReport, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: ReliabilityMlModelReport, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<ReliabilityMlModelReport>, spec?: UpsertSpec): ObjList<ReliabilityMlModelReport> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<ReliabilityMlModelReport>, spec?: UpsertSpec): ObjList<ReliabilityMlModelReport> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): ReliabilityMlModelReport | null;
   ...
   */
  static beforeCreate(objs: Array_Type<ReliabilityMlModelReport>): ObjList<ReliabilityMlModelReport>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<ReliabilityMlModelReport>): ObjList<ReliabilityMlModelReport>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<ReliabilityMlModelReport>): ObjList<ReliabilityMlModelReport>;
   ...
   */
  static afterCreate(objs: Array_Type<ReliabilityMlModelReport>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<ReliabilityMlModelReport>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<ReliabilityMlModelReport>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityMlModelReport>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityMlModelReport>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): ReliabilityMlModelReport | null;
   ...
   */
  withoutIdentity(): ReliabilityMlModelReport | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<ReliabilityMlModelReport>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: ReliabilityMlModelReport, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<ReliabilityMlModelReport>, callback?: λFunction<ReliabilityMlModelReport | null, ReliabilityMlModelReport | null>): ObjList<ReliabilityMlModelReport>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<ReliabilityMlModelReport>, callback?: λFunction<ReliabilityMlModelReport | null, ReliabilityMlModelReport | null>): Array_Type<ObjError> | null;
