// TypeScript definitions for the C3 type ReliabilityOrchestrator.PostTrainingJob
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityOrchestrator.PostTrainingJob
 */
declare namespace ReliabilityOrchestrator {
  export interface IPostTrainingJob {
 ...
 */
declare namespace ReliabilityOrchestrator {
  export class PostTrainingJob extends Obj  {

    /**
     * The array of configurations this job run must execute.
     */
    readonly jobSpecs: Array_Type<ReliabilityOrchestrator.PostTrainingJobSpec>;
    withJobSpecs(jobSpecs: Array_Type<ReliabilityOrchestrator.PostTrainingJobSpec> | Array<IReliabilityOrchestrator.PostTrainingJobSpec>): ReliabilityOrchestrator.PostTrainingJob;
     ...
     */
    readonly id: string;
    withId(id: string): ReliabilityOrchestrator.PostTrainingJob;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityOrchestrator.PostTrainingJob;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): ReliabilityOrchestrator.PostTrainingJob;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): ReliabilityOrchestrator.PostTrainingJob;
    ...
    withVersion(version: number | null): ReliabilityOrchestrator.PostTrainingJob;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): ReliabilityOrchestrator.PostTrainingJob;
     ...
     * @see #toJson
     */
    static fromJson(json: any): ReliabilityOrchestrator.PostTrainingJob | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): ReliabilityOrchestrator.PostTrainingJob | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): ReliabilityOrchestrator.PostTrainingJob | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): ReliabilityOrchestrator.PostTrainingJob | null;
     ...
     */
    replaceType(old: Type, new_: Type): ReliabilityOrchestrator.PostTrainingJob;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityOrchestrator.PostTrainingJob;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityOrchestrator.PostTrainingJob;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityOrchestrator.PostTrainingJob>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityOrchestrator.PostTrainingJob>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityOrchestrator.PostTrainingJob;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityOrchestrator.PostTrainingJob;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityOrchestrator.PostTrainingJob;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): ReliabilityOrchestrator.PostTrainingJob;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): ReliabilityOrchestrator.PostTrainingJob;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityOrchestrator.PostTrainingJob;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityOrchestrator.PostTrainingJob;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityOrchestrator.PostTrainingJob;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): ReliabilityOrchestrator.PostTrainingJob;
     ...
     * @see #removeField
     */
    withoutField(field: string): ReliabilityOrchestrator.PostTrainingJob;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): ReliabilityOrchestrator.PostTrainingJob;
     ...
     */
    withoutFields(fields: Array_Type<string>): ReliabilityOrchestrator.PostTrainingJob;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityOrchestrator.PostTrainingJob;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): ReliabilityOrchestrator.PostTrainingJob;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityOrchestrator.PostTrainingJob;
     ...
     * @see #unsetField
     */
    defaultField(field: string): ReliabilityOrchestrator.PostTrainingJob;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): ReliabilityOrchestrator.PostTrainingJob;
     ...
     * @see #removeField
     */
    unsetField(field: string): ReliabilityOrchestrator.PostTrainingJob;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): ReliabilityOrchestrator.PostTrainingJob;
     ...
     * @see #unsetField
     */
    removeField(field: string): ReliabilityOrchestrator.PostTrainingJob;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): ReliabilityOrchestrator.PostTrainingJob;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityOrchestrator.PostTrainingJob;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityOrchestrator.PostTrainingJob;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityOrchestrator.PostTrainingJob;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityOrchestrator.PostTrainingJob;

    mergeJson(json: any): ReliabilityOrchestrator.PostTrainingJob;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityOrchestrator.PostTrainingJob;
     ...
     */
    sumObj(other: Obj, deep?: boolean): ReliabilityOrchestrator.PostTrainingJob;
     ...
     */
    singletonArray(): Array_Type<ReliabilityOrchestrator.PostTrainingJob>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityOrchestrator.PostTrainingJob> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<ReliabilityOrchestrator.PostTrainingJob> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<ReliabilityOrchestrator.PostTrainingJob>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<ReliabilityOrchestrator.PostTrainingJob> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, ReliabilityOrchestrator.PostTrainingJob> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityOrchestrator.PostTrainingJob> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<ReliabilityOrchestrator.PostTrainingJob>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<ReliabilityOrchestrator.PostTrainingJob>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityOrchestrator.PostTrainingJob;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityOrchestrator.PostTrainingJob;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityOrchestrator.PostTrainingJob;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): ReliabilityOrchestrator.PostTrainingJob;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityOrchestrator.PostTrainingJob;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): ReliabilityOrchestrator.PostTrainingJob;
     ...
     * @see #fromString
     */
    static make(s: string): ReliabilityOrchestrator.PostTrainingJob | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityOrchestrator.PostTrainingJob;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): ReliabilityOrchestrator.PostTrainingJob;
     ...
     */
    static cachedEmptyInst(): ReliabilityOrchestrator.PostTrainingJob;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityOrchestrator.PostTrainingJob> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): ReliabilityOrchestrator.PostTrainingJob;
     ...
     *  ```
     */
    doStart(options?: ReliabilityOrchestrator.JobOptions, additionalParams?: Map_Type<string, any>): Pair<ReliabilityOrchestrator.PostTrainingJobRun, MlOperationRun<ReliabilityOrchestrator.PostTrainingJobRun>>;
     ...
     */
    start(options?: ReliabilityOrchestrator.JobOptions, additionalParams?: Map_Type<string, any>): MlOperationRun<ReliabilityOrchestrator.PostTrainingJobRun>;

    /**
     * @return The concrete {@link ReliabilityOrchestrator.JobRun} subType.
     */
    static jobRunType(): Type<<ReliabilityOrchestrator.PostTrainingJobRun>> | null;

    /**
     * @return the concrete {@link ReliabilityOrchestrator.JobSpec} subType.
     */
    static jobSpecType(): Type<<ReliabilityOrchestrator.PostTrainingJobSpec>> | null;
     ...
     */
    fetchJobRunForOperationRun(run: MlOperationRun<any>): ReliabilityOrchestrator.PostTrainingJobRun | null;
     ...
     */
    fetchLatestJobRun(): ReliabilityOrchestrator.PostTrainingJobRun | null;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<ReliabilityOrchestrator.PostTrainingJob>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<ReliabilityOrchestrator.PostTrainingJob>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityOrchestrator.PostTrainingJob> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityOrchestrator.PostTrainingJob>> | null;
     ...
     */
    get(include?: string): ReliabilityOrchestrator.PostTrainingJob | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): ReliabilityOrchestrator.PostTrainingJob | null;
     ...
     */
    getMissing(spec: GetMissingSpec): ReliabilityOrchestrator.PostTrainingJob;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): ReliabilityOrchestrator.PostTrainingJob | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): ReliabilityOrchestrator.PostTrainingJob;
     ...
     * @see #toString
     */
    static fromString(s: string): ReliabilityOrchestrator.PostTrainingJob | null;
     ...
     */
    create(spec?: UpsertSpec): ReliabilityOrchestrator.PostTrainingJob | null;
     ...
     */
    static createBatch(objs: Array_Type<ReliabilityOrchestrator.PostTrainingJob>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.PostTrainingJob> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<ReliabilityOrchestrator.PostTrainingJob>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityOrchestrator.PostTrainingJob> | null;
     ...
     */
    update(srcObj?: ReliabilityOrchestrator.PostTrainingJob, spec?: UpsertSpec): ReliabilityOrchestrator.PostTrainingJob | null;
     ...
     */
    upsert(srcObj?: ReliabilityOrchestrator.PostTrainingJob, spec?: UpsertSpec): ReliabilityOrchestrator.PostTrainingJob | null;
     ...
     */
    merge(spec?: MergeSpec): ReliabilityOrchestrator.PostTrainingJob | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): ReliabilityOrchestrator.PostTrainingJob | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): ReliabilityOrchestrator.PostTrainingJob | null;
     ...
     */
    static updateBatch(objs: Array_Type<ReliabilityOrchestrator.PostTrainingJob>, srcObjs?: Array_Type<ReliabilityOrchestrator.PostTrainingJob>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.PostTrainingJob> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<ReliabilityOrchestrator.PostTrainingJob> | null>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.PostTrainingJob> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<ReliabilityOrchestrator.PostTrainingJob>, srcObjs?: Array_Type<ReliabilityOrchestrator.PostTrainingJob>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.PostTrainingJob> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<ReliabilityOrchestrator.PostTrainingJob> | null>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.PostTrainingJob> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<ReliabilityOrchestrator.PostTrainingJob>, spec?: TouchSpec): ObjList<ReliabilityOrchestrator.PostTrainingJob> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityOrchestrator.PostTrainingJob>, spec?: MergeSpec): ObjList<ReliabilityOrchestrator.PostTrainingJob> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityOrchestrator.PostTrainingJob>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityOrchestrator.PostTrainingJob> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<ReliabilityOrchestrator.PostTrainingJob> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityOrchestrator.PostTrainingJob> | null;
     ...
     */
    static mergeAll(mergeObj: ReliabilityOrchestrator.PostTrainingJob, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: ReliabilityOrchestrator.PostTrainingJob, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<ReliabilityOrchestrator.PostTrainingJob>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.PostTrainingJob> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<ReliabilityOrchestrator.PostTrainingJob>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.PostTrainingJob> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): ReliabilityOrchestrator.PostTrainingJob | null;
     ...
     */
    static beforeCreate(objs: Array_Type<ReliabilityOrchestrator.PostTrainingJob>): ObjList<ReliabilityOrchestrator.PostTrainingJob>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<ReliabilityOrchestrator.PostTrainingJob>): ObjList<ReliabilityOrchestrator.PostTrainingJob>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<ReliabilityOrchestrator.PostTrainingJob>): ObjList<ReliabilityOrchestrator.PostTrainingJob>;
     ...
     */
    static afterCreate(objs: Array_Type<ReliabilityOrchestrator.PostTrainingJob>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<ReliabilityOrchestrator.PostTrainingJob>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<ReliabilityOrchestrator.PostTrainingJob>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityOrchestrator.PostTrainingJob>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityOrchestrator.PostTrainingJob>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): ReliabilityOrchestrator.PostTrainingJob | null;
     ...
     */
    withoutIdentity(): ReliabilityOrchestrator.PostTrainingJob | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<ReliabilityOrchestrator.PostTrainingJob>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: ReliabilityOrchestrator.PostTrainingJob, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<ReliabilityOrchestrator.PostTrainingJob>, callback?: λFunction<ReliabilityOrchestrator.PostTrainingJob | null, ReliabilityOrchestrator.PostTrainingJob | null>): ObjList<ReliabilityOrchestrator.PostTrainingJob>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<ReliabilityOrchestrator.PostTrainingJob>, callback?: λFunction<ReliabilityOrchestrator.PostTrainingJob | null, ReliabilityOrchestrator.PostTrainingJob | null>): Array_Type<ObjError> | null;
