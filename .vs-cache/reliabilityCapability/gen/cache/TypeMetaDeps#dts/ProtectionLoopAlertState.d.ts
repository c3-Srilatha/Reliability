// TypeScript definitions for the C3 type ProtectionLoopAlertState

/**
 * Represents a state in a state machine for {@link ProtectionLoopAlert}.
 * This entity defines the different states that a protection loop alert can be in.
 *
 * @remarks this represents a value passed to a method that expects an instance of ProtectionLoopAlertState
 */
declare interface IProtectionLoopAlertState {
   ...
   */
  autoTransitions?: Array_Type<ProtectionLoopAlertTransition> | Array<IProtectionLoopAlertTransition>;
   ...
   */
  periodicTransitions?: Array_Type<ProtectionLoopAlertTransition> | Array<IProtectionLoopAlertTransition>;
   ...
   */
  fromTransitions?: Array_Type<ProtectionLoopAlertTransition> | Array<IProtectionLoopAlertTransition>;

  /**
   * {@link StateMachineTransition}s that lead into this {@link StateMachineState}.
   */
  toTransitions?: Array_Type<ProtectionLoopAlertTransition> | Array<IProtectionLoopAlertTransition>;
}
 ...
 * This entity defines the different states that a protection loop alert can be in.
 *
 * @remarks this represents a made instance of ProtectionLoopAlertState
 */
declare class ProtectionLoopAlertState extends Obj  {
   ...
   */
  readonly id: string;
  withId(id: string): ProtectionLoopAlertState;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ProtectionLoopAlertState;

  /**
   * The name of this {@link StateMachineState}.
   */
  readonly name?: string;
  withName(name: string | null): ProtectionLoopAlertState;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): ProtectionLoopAlertState;
  ...
  withVersion(version: number | null): ProtectionLoopAlertState;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): ProtectionLoopAlertState;
  ...
  withUserUpdatedFields(userUpdatedFields: Array_Type<string> | Array<string> | null): ProtectionLoopAlertState;
  ...
  withHidden(hidden: boolean): ProtectionLoopAlertState;
  ...
  withUserOwned(userOwned: boolean): ProtectionLoopAlertState;
  ...
  withDisplayName(displayName: string | null): ProtectionLoopAlertState;
  ...
  withInitialState(initialState: boolean): ProtectionLoopAlertState;

  /**
   * Used to soft delete a record so all state histories still have valid pointers.
   */
  readonly deleted?: boolean;
  withDeleted(deleted: boolean): ProtectionLoopAlertState;

  /**
   * Used to include fields on the source type for exitAction and entryAction.
   */
  readonly includeSpec?: string;
  withIncludeSpec(includeSpec: string | null): ProtectionLoopAlertState;

  /**
   * Action to be triggered when leaving this state.
   */
  readonly exitAction?: λConsumer<any | null>;
  withExitAction(exitAction: λConsumer<any | null> | null): ProtectionLoopAlertState;

  /**
   * Action to be triggered when entering this state.
   */
  readonly entryAction?: λConsumer<any | null>;
  withEntryAction(entryAction: λConsumer<any | null> | null): ProtectionLoopAlertState;

  /**
   * The list of automatic transitions from this state to another that are {@link StateMachineTransition#isValid}.
   */
  readonly autoTransitions?: Array_Type<ProtectionLoopAlertTransition>;
  withAutoTransitions(autoTransitions: Array_Type<ProtectionLoopAlertTransition> | Array<IProtectionLoopAlertTransition> | null): ProtectionLoopAlertState;

  /**
   * Whether this state has automatic transitions.
   */
  readonly hasAutoTransition?: boolean;
  withHasAutoTransition(hasAutoTransition: boolean): ProtectionLoopAlertState;

  /**
   * The list of periodic transitions from this state to another that are {@link StateMachineTransition#isValid}.
   */
  readonly periodicTransitions?: Array_Type<ProtectionLoopAlertTransition>;
  withPeriodicTransitions(periodicTransitions: Array_Type<ProtectionLoopAlertTransition> | Array<IProtectionLoopAlertTransition> | null): ProtectionLoopAlertState;

  /**
   * Whether this state has periodic transitions.
   */
  readonly hasPeriodicTransitions?: boolean;
  withHasPeriodicTransitions(hasPeriodicTransitions: boolean): ProtectionLoopAlertState;

  /**
   * {@link StateMachineTransition}s that originate from this {@link StateMachineState}.
   */
  readonly fromTransitions?: Array_Type<ProtectionLoopAlertTransition>;
  withFromTransitions(fromTransitions: Array_Type<ProtectionLoopAlertTransition> | Array<IProtectionLoopAlertTransition> | null): ProtectionLoopAlertState;

  /**
   * {@link StateMachineTransition}s that lead into this {@link StateMachineState}.
   */
  readonly toTransitions?: Array_Type<ProtectionLoopAlertTransition>;
  withToTransitions(toTransitions: Array_Type<ProtectionLoopAlertTransition> | Array<IProtectionLoopAlertTransition> | null): ProtectionLoopAlertState;
   ...
   * @see #toJson
   */
  static fromJson(json: any): ProtectionLoopAlertState | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): ProtectionLoopAlertState | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): ProtectionLoopAlertState | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): ProtectionLoopAlertState | null;
   ...
   */
  replaceType(old: Type, new_: Type): ProtectionLoopAlertState;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ProtectionLoopAlertState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ProtectionLoopAlertState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ProtectionLoopAlertState>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ProtectionLoopAlertState>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ProtectionLoopAlertState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ProtectionLoopAlertState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ProtectionLoopAlertState;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ProtectionLoopAlertState;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ProtectionLoopAlertState;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ProtectionLoopAlertState;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ProtectionLoopAlertState;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ProtectionLoopAlertState;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ProtectionLoopAlertState;
   ...
   * @see #removeField
   */
  withoutField(field: string): ProtectionLoopAlertState;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): ProtectionLoopAlertState;
   ...
   */
  withoutFields(fields: Array_Type<string>): ProtectionLoopAlertState;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): ProtectionLoopAlertState;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ProtectionLoopAlertState;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ProtectionLoopAlertState;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ProtectionLoopAlertState;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ProtectionLoopAlertState;
   ...
   * @see #removeField
   */
  unsetField(field: string): ProtectionLoopAlertState;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ProtectionLoopAlertState;
   ...
   * @see #unsetField
   */
  removeField(field: string): ProtectionLoopAlertState;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ProtectionLoopAlertState;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ProtectionLoopAlertState;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): ProtectionLoopAlertState;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ProtectionLoopAlertState;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ProtectionLoopAlertState;

  mergeJson(json: any): ProtectionLoopAlertState;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ProtectionLoopAlertState;
   ...
   */
  sumObj(other: Obj, deep?: boolean): ProtectionLoopAlertState;
   ...
   */
  singletonArray(): Array_Type<ProtectionLoopAlertState>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<ProtectionLoopAlertState> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ProtectionLoopAlertState> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<ProtectionLoopAlertState>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ProtectionLoopAlertState> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, ProtectionLoopAlertState> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ProtectionLoopAlertState> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ProtectionLoopAlertState>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ProtectionLoopAlertState>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ProtectionLoopAlertState;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ProtectionLoopAlertState;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ProtectionLoopAlertState;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ProtectionLoopAlertState;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ProtectionLoopAlertState;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ProtectionLoopAlertState;
   ...
   * @see #fromString
   */
  static make(s: string): ProtectionLoopAlertState | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ProtectionLoopAlertState;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): ProtectionLoopAlertState;
   ...
   */
  static cachedEmptyInst(): ProtectionLoopAlertState;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<ProtectionLoopAlertState> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): ProtectionLoopAlertState;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<ProtectionLoopAlertState> | null;
   ...
   */
  static find(filter?: string, doNotProduceAll?: boolean): Stream<ProtectionLoopAlertState> | null;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<ProtectionLoopAlertState> | null;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): ProtectionLoopAlertState | null;
   ...
   * @see findByCacheKey
   */
  static forCacheKey(key: string): ProtectionLoopAlertState | null;
   ...
   * @see findByCacheKey
   */
  getCached(): ProtectionLoopAlertState | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): ProtectionLoopAlertState | null;
   ...
   */
  static produce(key: string): ProtectionLoopAlertState | null;
   ...
   */
  static produceAll(): Map_Type<string, ProtectionLoopAlertState> | null;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): Map_Type<string, ProtectionLoopAlertState> | null;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<ProtectionLoopAlertState>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<ProtectionLoopAlertState>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<ProtectionLoopAlertState> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ProtectionLoopAlertState>> | null;
   ...
   */
  get(include?: string): ProtectionLoopAlertState | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): ProtectionLoopAlertState | null;
   ...
   */
  getMissing(spec: GetMissingSpec): ProtectionLoopAlertState;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): ProtectionLoopAlertState | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): ProtectionLoopAlertState;
   ...
   * @see #toString
   */
  static fromString(s: string): ProtectionLoopAlertState | null;
   ...
   */
  create(spec?: UpsertSpec): ProtectionLoopAlertState | null;
   ...
   */
  static createBatch(objs: Array_Type<ProtectionLoopAlertState>, spec?: UpsertSpec): ObjList<ProtectionLoopAlertState> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<ProtectionLoopAlertState>, spec?: CreateBatchObjStreamSpec): ObjList<ProtectionLoopAlertState> | null;
   ...
   */
  update(srcObj?: ProtectionLoopAlertState, spec?: UpsertSpec): ProtectionLoopAlertState | null;
   ...
   */
  upsert(srcObj?: ProtectionLoopAlertState, spec?: UpsertSpec): ProtectionLoopAlertState | null;
   ...
   */
  merge(spec?: MergeSpec): ProtectionLoopAlertState | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): ProtectionLoopAlertState | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): ProtectionLoopAlertState | null;
   ...
   */
  static updateBatch(objs: Array_Type<ProtectionLoopAlertState>, srcObjs?: Array_Type<ProtectionLoopAlertState>, spec?: UpsertSpec): ObjList<ProtectionLoopAlertState> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<ProtectionLoopAlertState> | null>, spec?: UpsertSpec): ObjList<ProtectionLoopAlertState> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<ProtectionLoopAlertState>, srcObjs?: Array_Type<ProtectionLoopAlertState>, spec?: UpsertSpec): ObjList<ProtectionLoopAlertState> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<ProtectionLoopAlertState> | null>, spec?: UpsertSpec): ObjList<ProtectionLoopAlertState> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<ProtectionLoopAlertState>, spec?: TouchSpec): ObjList<ProtectionLoopAlertState> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ProtectionLoopAlertState>, spec?: MergeSpec): ObjList<ProtectionLoopAlertState> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ProtectionLoopAlertState>, mergeInclude: string, spec?: MergeSpec): ObjList<ProtectionLoopAlertState> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<ProtectionLoopAlertState> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ProtectionLoopAlertState> | null;
   ...
   */
  static mergeAll(mergeObj: ProtectionLoopAlertState, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: ProtectionLoopAlertState, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<ProtectionLoopAlertState>, spec?: UpsertSpec): ObjList<ProtectionLoopAlertState> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<ProtectionLoopAlertState>, spec?: UpsertSpec): ObjList<ProtectionLoopAlertState> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): ProtectionLoopAlertState | null;
   ...
   */
  static beforeCreate(objs: Array_Type<ProtectionLoopAlertState>): ObjList<ProtectionLoopAlertState>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<ProtectionLoopAlertState>): ObjList<ProtectionLoopAlertState>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<ProtectionLoopAlertState>): ObjList<ProtectionLoopAlertState>;
   ...
   */
  static afterCreate(objs: Array_Type<ProtectionLoopAlertState>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<ProtectionLoopAlertState>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<ProtectionLoopAlertState>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<ProtectionLoopAlertState>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ProtectionLoopAlertState>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): ProtectionLoopAlertState | null;
   ...
   */
  withoutIdentity(): ProtectionLoopAlertState | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<ProtectionLoopAlertState>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: ProtectionLoopAlertState, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<ProtectionLoopAlertState>, callback?: λFunction<ProtectionLoopAlertState | null, ProtectionLoopAlertState | null>): ObjList<ProtectionLoopAlertState>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<ProtectionLoopAlertState>, callback?: λFunction<ProtectionLoopAlertState | null, ProtectionLoopAlertState | null>): Array_Type<ObjError> | null;
   ...
   */
  publish(subPath?: string, contentType?: string): ProtectionLoopAlertState;
   ...
   */
  static removeSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<ProtectionLoopAlertState> | null;
   ...
   */
  createSeedData(spec?: UpsertSpec): ProtectionLoopAlertState | null;
   ...
   */
  static createSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<ProtectionLoopAlertState> | null;
   ...
   */
  updateSeedData(srcObj?: SeedData, spec?: UpsertSpec): ProtectionLoopAlertState | null;
   ...
   */
  static updateSeedDataBatch(objs?: Array_Type<SeedData>, srcObjs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<ProtectionLoopAlertState> | null;
   ...
   * @return updated obj instance, same as {@link Persistable#update} return value.
   */
  clearUserUpdates(spec?: MergeSpec): ProtectionLoopAlertState | null;
   ...
   *         {@link Persistable#updateBatch}.
   */
  static clearUserUpdatesBatch(objs?: Array_Type<SeedData>, spec?: MergeSpec): ObjList<ProtectionLoopAlertState> | null;
  ...
  dependencies(): SeedDataDeps<ProtectionLoopAlertState> | null;
