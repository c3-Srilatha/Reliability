// TypeScript definitions for the C3 type TimeToEventPrediction

/**
 * Created by parsing a {@link TimeToEventForecastResult} and extracting the relevant information for UI purposes.
 *
 * @remarks this represents a value passed to a method that expects an instance of TimeToEventPrediction
 */
declare interface ITimeToEventPrediction {
   ...
   */
  physicalAssetEventCategoryRelation?: IEquipmentEventCategoryRelation;

  /**
   * The ML pipeline result that this prediction is based off of
   */
  parent: ITimeToEventForecastResult;
   ...
   */
  predictedValueExceedsThresholdDate?: DateTime | Date | string;
   ...
   */
  predictedLowerBoundExceedsThresholdDate?: DateTime | Date | string;
   ...
   */
  predictedUpperBoundExceedsThresholdDate?: DateTime | Date | string;
   ...
   */
  lowerBoundPredictedDate?: DateTime | Date | string;
   ...
   */
  numDaysToPredictedDateFormatted?: string;
}

/**
 * Created by parsing a {@link TimeToEventForecastResult} and extracting the relevant information for UI purposes.
 *
 * @remarks this represents a made instance of TimeToEventPrediction
 */
declare class TimeToEventPrediction extends Obj  {
   ...
   */
  readonly id: string;
  withId(id: string): TimeToEventPrediction;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): TimeToEventPrediction;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): TimeToEventPrediction;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): TimeToEventPrediction;
  ...
  withVersion(version: number | null): TimeToEventPrediction;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): TimeToEventPrediction;

  /**
   * Equipment-event category combination that this prediction is for
   */
  readonly physicalAssetEventCategoryRelation?: EquipmentEventCategoryRelation;
  withPhysicalAssetEventCategoryRelation(physicalAssetEventCategoryRelation: IEquipmentEventCategoryRelation | null): TimeToEventPrediction;

  /**
   * The ML pipeline result that this prediction is based off of
   */
  readonly parent: TimeToEventForecastResult;
  withParent(parent: ITimeToEventForecastResult): TimeToEventPrediction;

  /**
   * Category of this prediction
   */
  readonly predictionCategory: string;
  withPredictionCategory(predictionCategory: string): TimeToEventPrediction;

  /**
   * "Most likely" predicted date. Represents when the main forecast crosses the threshold. If null, indicates that the main forecast never crosses the threshold
   */
  readonly predictedValueExceedsThresholdDate?: DateTime;
  withPredictedValueExceedsThresholdDate(predictedValueExceedsThresholdDate: DateTime | Date | string | null): TimeToEventPrediction;

  /**
   * Represents when the lower bound forecast crosses the threshold. May be sooner or later than the `predictedValueExceedsThresholdDate` depending on the diagnostic of the forecast.
   */
  readonly predictedLowerBoundExceedsThresholdDate?: DateTime;
  withPredictedLowerBoundExceedsThresholdDate(predictedLowerBoundExceedsThresholdDate: DateTime | Date | string | null): TimeToEventPrediction;

  /**
   * Represents when the upper bound forecast crosses the threshold. May be sooner or later than the `predictedValueExceedsThresholdDate` depending on the diagnostic of the forecast.
   */
  readonly predictedUpperBoundExceedsThresholdDate?: DateTime;
  withPredictedUpperBoundExceedsThresholdDate(predictedUpperBoundExceedsThresholdDate: DateTime | Date | string | null): TimeToEventPrediction;

  /**
   * Represents the lower bound of the range of predicted dates for the event, i.e. the earliest an event is predicted to happen, with 95% confidence.
   */
  readonly lowerBoundPredictedDate?: DateTime;
  withLowerBoundPredictedDate(lowerBoundPredictedDate: DateTime | Date | string | null): TimeToEventPrediction;

  /**
   * Represents the upper bound of the range of predicted dates for the event, i.e. the latest an event is predicted to happen, with 95% confidence
   */
  readonly upperBoundPredictedDate?: DateTime;
  withUpperBoundPredictedDate(upperBoundPredictedDate: DateTime | Date | string | null): TimeToEventPrediction;

  /**
   * Days until the predicted date when value exceeds threshold.
   */
  readonly numDaysToPredictedDate?: number;
  withNumDaysToPredictedDate(numDaysToPredictedDate: number | null): TimeToEventPrediction;

  /**
   * Days until the predicted date when lower bound exceeds threshold.
   */
  readonly numDaysToPredictedDateLowerBound?: number;
  withNumDaysToPredictedDateLowerBound(numDaysToPredictedDateLowerBound: number | null): TimeToEventPrediction;

  /**
   * Days until the predicted date when upper bound exceeds threshold.
   */
  readonly numDaysToPredictedDateUpperBound?: number;
  withNumDaysToPredictedDateUpperBound(numDaysToPredictedDateUpperBound: number | null): TimeToEventPrediction;

  /**
   * Days until the predicted date (formatted). The extra preceding spaces are to make this a sortable field, e.g. to make '  2 Days' come before '100 Days'.
   */
  readonly numDaysToPredictedDateFormatted?: string;
  withNumDaysToPredictedDateFormatted(numDaysToPredictedDateFormatted: string | null): TimeToEventPrediction;
   ...
   * @see #toJson
   */
  static fromJson(json: any): TimeToEventPrediction | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): TimeToEventPrediction | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): TimeToEventPrediction | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): TimeToEventPrediction | null;
   ...
   */
  replaceType(old: Type, new_: Type): TimeToEventPrediction;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): TimeToEventPrediction;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): TimeToEventPrediction;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<TimeToEventPrediction>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<TimeToEventPrediction>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): TimeToEventPrediction;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TimeToEventPrediction;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TimeToEventPrediction;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): TimeToEventPrediction;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): TimeToEventPrediction;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): TimeToEventPrediction;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): TimeToEventPrediction;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): TimeToEventPrediction;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): TimeToEventPrediction;
   ...
   * @see #removeField
   */
  withoutField(field: string): TimeToEventPrediction;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): TimeToEventPrediction;
   ...
   */
  withoutFields(fields: Array_Type<string>): TimeToEventPrediction;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): TimeToEventPrediction;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): TimeToEventPrediction;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): TimeToEventPrediction;
   ...
   * @see #unsetField
   */
  defaultField(field: string): TimeToEventPrediction;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): TimeToEventPrediction;
   ...
   * @see #removeField
   */
  unsetField(field: string): TimeToEventPrediction;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): TimeToEventPrediction;
   ...
   * @see #unsetField
   */
  removeField(field: string): TimeToEventPrediction;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): TimeToEventPrediction;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): TimeToEventPrediction;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): TimeToEventPrediction;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): TimeToEventPrediction;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): TimeToEventPrediction;

  mergeJson(json: any): TimeToEventPrediction;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): TimeToEventPrediction;
   ...
   */
  sumObj(other: Obj, deep?: boolean): TimeToEventPrediction;
   ...
   */
  singletonArray(): Array_Type<TimeToEventPrediction>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<TimeToEventPrediction> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<TimeToEventPrediction> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<TimeToEventPrediction>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<TimeToEventPrediction> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, TimeToEventPrediction> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, TimeToEventPrediction> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<TimeToEventPrediction>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<TimeToEventPrediction>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): TimeToEventPrediction;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): TimeToEventPrediction;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): TimeToEventPrediction;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): TimeToEventPrediction;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): TimeToEventPrediction;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): TimeToEventPrediction;
   ...
   * @see #fromString
   */
  static make(s: string): TimeToEventPrediction | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): TimeToEventPrediction;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): TimeToEventPrediction;
   ...
   */
  static cachedEmptyInst(): TimeToEventPrediction;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<TimeToEventPrediction> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): TimeToEventPrediction;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<TimeToEventPrediction>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<TimeToEventPrediction>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<TimeToEventPrediction> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<TimeToEventPrediction>> | null;
   ...
   */
  get(include?: string): TimeToEventPrediction | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): TimeToEventPrediction | null;
   ...
   */
  getMissing(spec: GetMissingSpec): TimeToEventPrediction;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): TimeToEventPrediction | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): TimeToEventPrediction;
   ...
   * @see #toString
   */
  static fromString(s: string): TimeToEventPrediction | null;
   ...
   */
  create(spec?: UpsertSpec): TimeToEventPrediction | null;
   ...
   */
  static createBatch(objs: Array_Type<TimeToEventPrediction>, spec?: UpsertSpec): ObjList<TimeToEventPrediction> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<TimeToEventPrediction>, spec?: CreateBatchObjStreamSpec): ObjList<TimeToEventPrediction> | null;
   ...
   */
  update(srcObj?: TimeToEventPrediction, spec?: UpsertSpec): TimeToEventPrediction | null;
   ...
   */
  upsert(srcObj?: TimeToEventPrediction, spec?: UpsertSpec): TimeToEventPrediction | null;
   ...
   */
  merge(spec?: MergeSpec): TimeToEventPrediction | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): TimeToEventPrediction | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): TimeToEventPrediction | null;
   ...
   */
  static updateBatch(objs: Array_Type<TimeToEventPrediction>, srcObjs?: Array_Type<TimeToEventPrediction>, spec?: UpsertSpec): ObjList<TimeToEventPrediction> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<TimeToEventPrediction> | null>, spec?: UpsertSpec): ObjList<TimeToEventPrediction> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<TimeToEventPrediction>, srcObjs?: Array_Type<TimeToEventPrediction>, spec?: UpsertSpec): ObjList<TimeToEventPrediction> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<TimeToEventPrediction> | null>, spec?: UpsertSpec): ObjList<TimeToEventPrediction> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<TimeToEventPrediction>, spec?: TouchSpec): ObjList<TimeToEventPrediction> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<TimeToEventPrediction>, spec?: MergeSpec): ObjList<TimeToEventPrediction> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<TimeToEventPrediction>, mergeInclude: string, spec?: MergeSpec): ObjList<TimeToEventPrediction> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<TimeToEventPrediction> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<TimeToEventPrediction> | null;
   ...
   */
  static mergeAll(mergeObj: TimeToEventPrediction, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: TimeToEventPrediction, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<TimeToEventPrediction>, spec?: UpsertSpec): ObjList<TimeToEventPrediction> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<TimeToEventPrediction>, spec?: UpsertSpec): ObjList<TimeToEventPrediction> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): TimeToEventPrediction | null;
   ...
   */
  static beforeCreate(objs: Array_Type<TimeToEventPrediction>): ObjList<TimeToEventPrediction>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<TimeToEventPrediction>): ObjList<TimeToEventPrediction>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<TimeToEventPrediction>): ObjList<TimeToEventPrediction>;
   ...
   */
  static afterCreate(objs: Array_Type<TimeToEventPrediction>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<TimeToEventPrediction>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<TimeToEventPrediction>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<TimeToEventPrediction>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<TimeToEventPrediction>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): TimeToEventPrediction | null;
   ...
   */
  withoutIdentity(): TimeToEventPrediction | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<TimeToEventPrediction>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: TimeToEventPrediction, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<TimeToEventPrediction>, callback?: λFunction<TimeToEventPrediction | null, TimeToEventPrediction | null>): ObjList<TimeToEventPrediction>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<TimeToEventPrediction>, callback?: λFunction<TimeToEventPrediction | null, TimeToEventPrediction | null>): Array_Type<ObjError> | null;
   ...
   */
  static refreshDaysToPredictedDate(): void;
}
