// TypeScript definitions for the C3 type ProtectionLoopBatchJob

/**
 * Batch Job to run {@link ProtectionLoop#computeLoopHealth} for each
 *
 * @remarks this represents a value passed to a method that expects an instance of ProtectionLoopBatchJob
 */
declare interface IProtectionLoopBatchJob {
 ...
 */
declare class ProtectionLoopBatchJob extends Obj  {

  /**
   * current or last job execution for this instance
   */
  readonly run?: BatchJobRun;
  withRun(run: IBatchJobRun | null): ProtectionLoopBatchJob;

  /**
   * previous job executions for this instance
   */
  readonly runs?: Array_Type<BatchJobRun>;
  withRuns(runs: Array_Type<BatchJobRun> | Array<IBatchJobRun> | null): ProtectionLoopBatchJob;

  /**
   * FOR INTERNAL USE ONLY - Specify options in call to {@link start}.
   */
  readonly options?: Obj;
  withOptions(options: IObj | null): ProtectionLoopBatchJob;
  ...
  withOnCompleteCallback(onCompleteCallback: IJobBase.Callback | null): ProtectionLoopBatchJob;
  ...
  withPriority(priority: number | null): ProtectionLoopBatchJob;
  ...
  withDisabled(disabled: boolean): ProtectionLoopBatchJob;
  ...
  withMaxConcurrency(maxConcurrency: number | null): ProtectionLoopBatchJob;
  ...
  withMaxConcurrencyPerNode(maxConcurrencyPerNode: number | null): ProtectionLoopBatchJob;
  ...
  withRunAsUser(runAsUser: boolean): ProtectionLoopBatchJob;

  /**
   * Don't set this field in the BatchJob, set it in the BatchJobOptions when calling `start`
   */
  readonly nodePool?: string;
  withNodePool(nodePool: string | null): ProtectionLoopBatchJob;
  ...
  withSkipIfRunning(skipIfRunning: boolean): ProtectionLoopBatchJob;

  /**
   * Set to between 1 and 5 to enable auto recovery. See {@link invalidation-queues.c3doc Invalidation Queues} for detailed documentation.
   */
  readonly numAutoRecoveryAttempts?: number;
  withNumAutoRecoveryAttempts(numAutoRecoveryAttempts: number | null): ProtectionLoopBatchJob;
  ...
  withPropagateActionContext(propagateActionContext: boolean): ProtectionLoopBatchJob;
  ...
  withTypeIdent(typeIdent: string | null): ProtectionLoopBatchJob;
   ...
   */
  readonly id: string;
  withId(id: string): ProtectionLoopBatchJob;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ProtectionLoopBatchJob;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): ProtectionLoopBatchJob;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): ProtectionLoopBatchJob;
  ...
  withVersion(version: number | null): ProtectionLoopBatchJob;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): ProtectionLoopBatchJob;
  ...
  withAbortOnError(abortOnError: boolean): ProtectionLoopBatchJob;
   ...
   * @see #toJson
   */
  static fromJson(json: any): ProtectionLoopBatchJob | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): ProtectionLoopBatchJob | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): ProtectionLoopBatchJob | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): ProtectionLoopBatchJob | null;
   ...
   */
  replaceType(old: Type, new_: Type): ProtectionLoopBatchJob;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ProtectionLoopBatchJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ProtectionLoopBatchJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ProtectionLoopBatchJob>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ProtectionLoopBatchJob>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ProtectionLoopBatchJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ProtectionLoopBatchJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ProtectionLoopBatchJob;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ProtectionLoopBatchJob;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ProtectionLoopBatchJob;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ProtectionLoopBatchJob;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ProtectionLoopBatchJob;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ProtectionLoopBatchJob;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ProtectionLoopBatchJob;
   ...
   * @see #removeField
   */
  withoutField(field: string): ProtectionLoopBatchJob;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): ProtectionLoopBatchJob;
   ...
   */
  withoutFields(fields: Array_Type<string>): ProtectionLoopBatchJob;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): ProtectionLoopBatchJob;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ProtectionLoopBatchJob;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ProtectionLoopBatchJob;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ProtectionLoopBatchJob;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ProtectionLoopBatchJob;
   ...
   * @see #removeField
   */
  unsetField(field: string): ProtectionLoopBatchJob;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ProtectionLoopBatchJob;
   ...
   * @see #unsetField
   */
  removeField(field: string): ProtectionLoopBatchJob;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ProtectionLoopBatchJob;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ProtectionLoopBatchJob;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): ProtectionLoopBatchJob;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ProtectionLoopBatchJob;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ProtectionLoopBatchJob;

  mergeJson(json: any): ProtectionLoopBatchJob;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ProtectionLoopBatchJob;
   ...
   */
  sumObj(other: Obj, deep?: boolean): ProtectionLoopBatchJob;
   ...
   */
  singletonArray(): Array_Type<ProtectionLoopBatchJob>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<ProtectionLoopBatchJob> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ProtectionLoopBatchJob> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<ProtectionLoopBatchJob>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ProtectionLoopBatchJob> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, ProtectionLoopBatchJob> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ProtectionLoopBatchJob> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ProtectionLoopBatchJob>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ProtectionLoopBatchJob>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ProtectionLoopBatchJob;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ProtectionLoopBatchJob;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ProtectionLoopBatchJob;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ProtectionLoopBatchJob;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ProtectionLoopBatchJob;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ProtectionLoopBatchJob;
   ...
   * @see #fromString
   */
  static make(s: string): ProtectionLoopBatchJob | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ProtectionLoopBatchJob;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): ProtectionLoopBatchJob;
   ...
   */
  static cachedEmptyInst(): ProtectionLoopBatchJob;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<ProtectionLoopBatchJob> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): ProtectionLoopBatchJob;
   ...
   */
  start(options?: ProtectionLoopBatchJobOptions): BatchJobStatus | null;
   ...
   */
  cleanup(options?: ProtectionLoopBatchJobOptions): void;
  ...
  cancelJob(removeResults?: boolean, force?: boolean): JobBase<BatchJobRun, BatchJobStatus, ProtectionLoopBatchJobOptions> | null;

  failJob(run: JobRun<BatchJobStatusBase>): JobBase<BatchJobRun, BatchJobStatus, ProtectionLoopBatchJobOptions> | null;
  ...
  validateStart(options?: ProtectionLoopBatchJobOptions): void;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<ProtectionLoopBatchJob>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<ProtectionLoopBatchJob>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<ProtectionLoopBatchJob> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ProtectionLoopBatchJob>> | null;
   ...
   */
  get(include?: string): ProtectionLoopBatchJob | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): ProtectionLoopBatchJob | null;
   ...
   */
  getMissing(spec: GetMissingSpec): ProtectionLoopBatchJob;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): ProtectionLoopBatchJob | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): ProtectionLoopBatchJob;
   ...
   * @see #toString
   */
  static fromString(s: string): ProtectionLoopBatchJob | null;
   ...
   */
  create(spec?: UpsertSpec): ProtectionLoopBatchJob | null;
   ...
   */
  static createBatch(objs: Array_Type<ProtectionLoopBatchJob>, spec?: UpsertSpec): ObjList<ProtectionLoopBatchJob> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<ProtectionLoopBatchJob>, spec?: CreateBatchObjStreamSpec): ObjList<ProtectionLoopBatchJob> | null;
   ...
   */
  update(srcObj?: ProtectionLoopBatchJob, spec?: UpsertSpec): ProtectionLoopBatchJob | null;
   ...
   */
  upsert(srcObj?: ProtectionLoopBatchJob, spec?: UpsertSpec): ProtectionLoopBatchJob | null;
   ...
   */
  merge(spec?: MergeSpec): ProtectionLoopBatchJob | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): ProtectionLoopBatchJob | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): ProtectionLoopBatchJob | null;
   ...
   */
  static updateBatch(objs: Array_Type<ProtectionLoopBatchJob>, srcObjs?: Array_Type<ProtectionLoopBatchJob>, spec?: UpsertSpec): ObjList<ProtectionLoopBatchJob> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<ProtectionLoopBatchJob> | null>, spec?: UpsertSpec): ObjList<ProtectionLoopBatchJob> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<ProtectionLoopBatchJob>, srcObjs?: Array_Type<ProtectionLoopBatchJob>, spec?: UpsertSpec): ObjList<ProtectionLoopBatchJob> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<ProtectionLoopBatchJob> | null>, spec?: UpsertSpec): ObjList<ProtectionLoopBatchJob> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<ProtectionLoopBatchJob>, spec?: TouchSpec): ObjList<ProtectionLoopBatchJob> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ProtectionLoopBatchJob>, spec?: MergeSpec): ObjList<ProtectionLoopBatchJob> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ProtectionLoopBatchJob>, mergeInclude: string, spec?: MergeSpec): ObjList<ProtectionLoopBatchJob> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<ProtectionLoopBatchJob> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ProtectionLoopBatchJob> | null;
   ...
   */
  static mergeAll(mergeObj: ProtectionLoopBatchJob, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: ProtectionLoopBatchJob, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<ProtectionLoopBatchJob>, spec?: UpsertSpec): ObjList<ProtectionLoopBatchJob> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<ProtectionLoopBatchJob>, spec?: UpsertSpec): ObjList<ProtectionLoopBatchJob> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): ProtectionLoopBatchJob | null;
   ...
   */
  static beforeCreate(objs: Array_Type<ProtectionLoopBatchJob>): ObjList<ProtectionLoopBatchJob>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<ProtectionLoopBatchJob>): ObjList<ProtectionLoopBatchJob>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<ProtectionLoopBatchJob>): ObjList<ProtectionLoopBatchJob>;
   ...
   */
  static afterCreate(objs: Array_Type<ProtectionLoopBatchJob>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<ProtectionLoopBatchJob>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<ProtectionLoopBatchJob>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<ProtectionLoopBatchJob>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ProtectionLoopBatchJob>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): ProtectionLoopBatchJob | null;
   ...
   */
  withoutIdentity(): ProtectionLoopBatchJob | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<ProtectionLoopBatchJob>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: ProtectionLoopBatchJob, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<ProtectionLoopBatchJob>, callback?: λFunction<ProtectionLoopBatchJob | null, ProtectionLoopBatchJob | null>): ObjList<ProtectionLoopBatchJob>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<ProtectionLoopBatchJob>, callback?: λFunction<ProtectionLoopBatchJob | null, ProtectionLoopBatchJob | null>): Array_Type<ObjError> | null;
   ...
   * @inheritdoc
   */
  static doStart(job?: ProtectionLoopBatchJob, options?: ProtectionLoopBatchJobOptions): void;

  /**
   * @inheritdoc
   */
  static processBatch(batch?: ProtectionLoopBatch, job?: ProtectionLoopBatchJob, options?: ProtectionLoopBatchJobOptions): void;
   ...
   */
  static allComplete(job: ProtectionLoopBatchJob, options?: ProtectionLoopBatchJobOptions): string | null;
   ...
   *           Options the job was run with.
   */
  static failed(job: ProtectionLoopBatchJob, status: BatchJobStatus, options?: ProtectionLoopBatchJobOptions): void;
   ...
   *        Batch to schedule.
   */
  scheduleBatch(batch?: ProtectionLoopBatch): void;
   ...
   *        Batches to schedule.
   */
  scheduleBatches(batches?: Array_Type<ProtectionLoopBatch>): void;
   ...
   */
  static scheduleObjBatch(job?: ProtectionLoopBatchJob, objBatch?: ObjBatch, logPrefix?: string): number | null;
   ...
   */
  static startJob(batchSize?: number): ProtectionLoopBatchJob;
}
