// TypeScript definitions for the C3 type ReliabilityReport

/**
 * A single exportable PDF report.
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityReport
 */
declare interface IReliabilityReport {
 ...
 */
declare class ReliabilityReport extends Obj  {
  ...
  withTypeIdent(typeIdent: string | null): ReliabilityReport;
   ...
   */
  readonly id: string;
  withId(id: string): ReliabilityReport;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityReport;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): ReliabilityReport;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): ReliabilityReport;
  ...
  withVersion(version: number | null): ReliabilityReport;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): ReliabilityReport;

  /**
   * The spec used to generate the report.
   */
  readonly spec: ReliabilityReportSpec;
  withSpec(spec: IReliabilityReportSpec): ReliabilityReport;

  /**
   * The report file.
   */
  readonly file?: File;
  withFile(file: IFile | null): ReliabilityReport;

  /**
   * Errors collected during the report generation.
   */
  readonly errors?: Array_Type<string>;
  withErrors(errors: Array_Type<string> | Array<string> | null): ReliabilityReport;
   ...
   * @see #toJson
   */
  static fromJson(json: any): ReliabilityReport | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): ReliabilityReport | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): ReliabilityReport | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): ReliabilityReport | null;
   ...
   */
  replaceType(old: Type, new_: Type): ReliabilityReport;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityReport;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityReport;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityReport>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityReport>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityReport;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityReport;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityReport;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ReliabilityReport;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ReliabilityReport;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityReport;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityReport;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityReport;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ReliabilityReport;
   ...
   * @see #removeField
   */
  withoutField(field: string): ReliabilityReport;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): ReliabilityReport;
   ...
   */
  withoutFields(fields: Array_Type<string>): ReliabilityReport;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityReport;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ReliabilityReport;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityReport;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ReliabilityReport;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ReliabilityReport;
   ...
   * @see #removeField
   */
  unsetField(field: string): ReliabilityReport;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ReliabilityReport;
   ...
   * @see #unsetField
   */
  removeField(field: string): ReliabilityReport;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ReliabilityReport;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityReport;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityReport;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityReport;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityReport;

  mergeJson(json: any): ReliabilityReport;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityReport;
   ...
   */
  sumObj(other: Obj, deep?: boolean): ReliabilityReport;
   ...
   */
  singletonArray(): Array_Type<ReliabilityReport>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityReport> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ReliabilityReport> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<ReliabilityReport>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ReliabilityReport> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, ReliabilityReport> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityReport> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ReliabilityReport>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ReliabilityReport>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityReport;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityReport;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityReport;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ReliabilityReport;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityReport;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ReliabilityReport;
   ...
   * @see #fromString
   */
  static make(s: string): ReliabilityReport | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityReport;
   ...
   */
  static cachedEmptyInst(): ReliabilityReport;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityReport> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): ReliabilityReport;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<ReliabilityReport>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<ReliabilityReport>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityReport> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityReport>> | null;
   ...
   */
  get(include?: string): ReliabilityReport | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): ReliabilityReport | null;
   ...
   */
  getMissing(spec: GetMissingSpec): ReliabilityReport;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): ReliabilityReport | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): ReliabilityReport;
   ...
   * @see #toString
   */
  static fromString(s: string): ReliabilityReport | null;
   ...
   */
  create(spec?: UpsertSpec): ReliabilityReport | null;
   ...
   */
  static createBatch(objs: Array_Type<ReliabilityReport>, spec?: UpsertSpec): ObjList<ReliabilityReport> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<ReliabilityReport>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityReport> | null;
   ...
   */
  update(srcObj?: ReliabilityReport, spec?: UpsertSpec): ReliabilityReport | null;
   ...
   */
  upsert(srcObj?: ReliabilityReport, spec?: UpsertSpec): ReliabilityReport | null;
   ...
   */
  merge(spec?: MergeSpec): ReliabilityReport | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): ReliabilityReport | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): ReliabilityReport | null;
   ...
   */
  static updateBatch(objs: Array_Type<ReliabilityReport>, srcObjs?: Array_Type<ReliabilityReport>, spec?: UpsertSpec): ObjList<ReliabilityReport> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<ReliabilityReport> | null>, spec?: UpsertSpec): ObjList<ReliabilityReport> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<ReliabilityReport>, srcObjs?: Array_Type<ReliabilityReport>, spec?: UpsertSpec): ObjList<ReliabilityReport> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<ReliabilityReport> | null>, spec?: UpsertSpec): ObjList<ReliabilityReport> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<ReliabilityReport>, spec?: TouchSpec): ObjList<ReliabilityReport> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityReport>, spec?: MergeSpec): ObjList<ReliabilityReport> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityReport>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityReport> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<ReliabilityReport> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityReport> | null;
   ...
   */
  static mergeAll(mergeObj: ReliabilityReport, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: ReliabilityReport, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<ReliabilityReport>, spec?: UpsertSpec): ObjList<ReliabilityReport> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<ReliabilityReport>, spec?: UpsertSpec): ObjList<ReliabilityReport> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): ReliabilityReport | null;
   ...
   */
  static beforeCreate(objs: Array_Type<ReliabilityReport>): ObjList<ReliabilityReport>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<ReliabilityReport>): ObjList<ReliabilityReport>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<ReliabilityReport>): ObjList<ReliabilityReport>;
   ...
   */
  static afterCreate(objs: Array_Type<ReliabilityReport>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<ReliabilityReport>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<ReliabilityReport>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityReport>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityReport>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): ReliabilityReport | null;
   ...
   */
  withoutIdentity(): ReliabilityReport | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<ReliabilityReport>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: ReliabilityReport, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<ReliabilityReport>, callback?: λFunction<ReliabilityReport | null, ReliabilityReport | null>): ObjList<ReliabilityReport>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<ReliabilityReport>, callback?: λFunction<ReliabilityReport | null, ReliabilityReport | null>): Array_Type<ObjError> | null;
