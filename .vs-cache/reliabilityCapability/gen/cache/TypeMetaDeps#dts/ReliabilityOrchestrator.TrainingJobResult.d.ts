// TypeScript definitions for the C3 type ReliabilityOrchestrator.TrainingJobResult

/**
 * Represents the training workflow that will be executed to train and deploy as `CANDIDATE` a single
 * {@link ReliabilityMlModel} and for a specific {@link MlProject}. {@link ReliabilityOrchestrator.TrainingJobResult#datasetPreparationRun}
 * consists {@link ReliabilityMlDatasetPreparationRun#trainFeatureTimeRanges} map for the start and end time range.
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityOrchestrator.TrainingJobResult
 */
declare namespace ReliabilityOrchestrator {
  export interface ITrainingJobResult {
    ...
    /**
     * The filter corresponding to the {@link ReliabilityAsset}s for which models should be created and trained.
     */
    assetFilter?: string;

    /**
     * The {@link ReliabilityMlDatasetPreparationRun} that should be used to train the {@link ReliabilityAsset}s
     * corresponding to the {@link #assetFilter}. {@link ReliabilityMlDatasetPreparationRun#trainFeatureTimeRanges}
     * map contains the time range used for model training.
     *
     * Example:
     * start = datasetPreparationRun.trainFeatureTimeRanges.get("features").start
     * end = datasetPreparationRun.trainFeatureTimeRanges.get("features").end
     */
    datasetPreparationRun?: IReliabilityMlDatasetPreparationRun;

    /**
     * Specify the {@link ReliabilityMl.Project} for which training should be run.
     */
    project: IReliabilityMl.Project;

    /**
     * The {@link ReliabilityMl.Pipeline} to be used to train for the {@link ReliabilityAsset}s.
     ...
     */
    pipeline?: IReliabilityMl.Pipeline<any, any, any, any>;
    ...
    /**
     * If specified, represents the already trained {@link ReliabilityMlModel}, that will be used for deployment and
     * optionally, classification and validation.
     */
    model?: IReliabilityMlModel;

    /**
     * Contains the trained {@link ReliabilityMlModel} that is output by the workflow. Note that if {@link #model}
     * is specified and is trained, then this field just points to the same model, since it is already trained.
     * DO NOT MANUALLY POPULATE THIS FIELD.
     */
    trainedModel?: IReliabilityMlModel;

    /**
     * Specify the filter corresponding to {@link ReliabilityAsset}s for which the trained models
     * should be deployed on as `CANDIDATE`.
     */
    deploymentAssetFilter?: string;
 ...
 * consists {@link ReliabilityMlDatasetPreparationRun#trainFeatureTimeRanges} map for the start and end time range.
 *
 * @remarks this represents a made instance of ReliabilityOrchestrator.TrainingJobResult
 */
declare namespace ReliabilityOrchestrator {
  export class TrainingJobResult extends Obj  {

    /**
     * The unique and required name of this instance.
     */
    readonly name: string;
    withName(name: string): ReliabilityOrchestrator.TrainingJobResult;
    ...
    withTypeIdent(typeIdent: string | null): ReliabilityOrchestrator.TrainingJobResult;
     ...
     */
    readonly id: string;
    withId(id: string): ReliabilityOrchestrator.TrainingJobResult;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityOrchestrator.TrainingJobResult;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): ReliabilityOrchestrator.TrainingJobResult;
    ...
    withVersion(version: number | null): ReliabilityOrchestrator.TrainingJobResult;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): ReliabilityOrchestrator.TrainingJobResult;

    /**
     * Parent {@link MlWorkflowCoordinatable} that this result belongs to.
     */
    readonly parentCoordinator: MlWorkflowCoordinatable<MlWorkflowCoordinatableResult>;
    withParentCoordinator(parentCoordinator: IMlWorkflowCoordinatable<MlWorkflowCoordinatableResult>): ReliabilityOrchestrator.TrainingJobResult;
    ...
    withStatusForCoordinatable(statusForCoordinatable: string): ReliabilityOrchestrator.TrainingJobResult;

    /**
     * Number of times the {@link #parentCoordinator} has canceled this result.
     */
    readonly canceledCount?: number;
    withCanceledCount(canceledCount: number | null): ReliabilityOrchestrator.TrainingJobResult;
    ...
    withIsCanceled(isCanceled: boolean): ReliabilityOrchestrator.TrainingJobResult;
    ...
    withErrorCount(errorCount: number | null): ReliabilityOrchestrator.TrainingJobResult;
    ...
    withRun(run: IWorkflowExecutorRun | null): ReliabilityOrchestrator.TrainingJobResult;
    ...
    withDurationSeconds(durationSeconds: number | null): ReliabilityOrchestrator.TrainingJobResult;
    ...
    withPastRuns(pastRuns: Array_Type<WorkflowExecutorRun> | Array<IWorkflowExecutorRun> | null): ReliabilityOrchestrator.TrainingJobResult;

    /**
     * Number of times the {@link #parentCoordinator} has attempted to recover this result.
     */
    readonly attemptedRecoveryCount?: number;
    withAttemptedRecoveryCount(attemptedRecoveryCount: number | null): ReliabilityOrchestrator.TrainingJobResult;

    /**
     * The filter corresponding to the {@link ReliabilityAsset}s for which models should be created and trained.
     */
    readonly assetFilter?: string;
    withAssetFilter(assetFilter: string | null): ReliabilityOrchestrator.TrainingJobResult;
    ...
    withDatasetPreparationRun(datasetPreparationRun: IReliabilityMlDatasetPreparationRun | null): ReliabilityOrchestrator.TrainingJobResult;

    /**
     * Specify the {@link ReliabilityMl.Project} for which training should be run.
     */
    readonly project: ReliabilityMl.Project;
    withProject(project: IReliabilityMl.Project): ReliabilityOrchestrator.TrainingJobResult;
     ...
     * The job will fail immediately if the pipeline is not upserted.
     */
    readonly pipeline?: ReliabilityMl.Pipeline<any, any, any, any>;
    withPipeline(pipeline: IReliabilityMl.Pipeline<any, any, any, any> | null): ReliabilityOrchestrator.TrainingJobResult;
    ...
    withModelName(modelName: string | null): ReliabilityOrchestrator.TrainingJobResult;
    ...
    withTemplate(template: IModelTemplate | null): ReliabilityOrchestrator.TrainingJobResult;
    ...
    withModel(model: IReliabilityMlModel | null): ReliabilityOrchestrator.TrainingJobResult;
     ...
     * DO NOT MANUALLY POPULATE THIS FIELD.
     */
    readonly trainedModel?: ReliabilityMlModel;
    withTrainedModel(trainedModel: IReliabilityMlModel | null): ReliabilityOrchestrator.TrainingJobResult;

    /**
     * Specify the filter corresponding to {@link ReliabilityAsset}s for which the trained models
     * should be deployed on as `CANDIDATE`.
     */
    readonly deploymentAssetFilter?: string;
    withDeploymentAssetFilter(deploymentAssetFilter: string | null): ReliabilityOrchestrator.TrainingJobResult;
    ...
    withHyperparamOverrides(hyperparamOverrides: Map_Type<string, any> | {[key: string]: any} | null): ReliabilityOrchestrator.TrainingJobResult;
     ...
     * @see #toJson
     */
    static fromJson(json: any): ReliabilityOrchestrator.TrainingJobResult | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): ReliabilityOrchestrator.TrainingJobResult | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): ReliabilityOrchestrator.TrainingJobResult | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): ReliabilityOrchestrator.TrainingJobResult | null;
     ...
     */
    replaceType(old: Type, new_: Type): ReliabilityOrchestrator.TrainingJobResult;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityOrchestrator.TrainingJobResult;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityOrchestrator.TrainingJobResult;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityOrchestrator.TrainingJobResult>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityOrchestrator.TrainingJobResult>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityOrchestrator.TrainingJobResult;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityOrchestrator.TrainingJobResult;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityOrchestrator.TrainingJobResult;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): ReliabilityOrchestrator.TrainingJobResult;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): ReliabilityOrchestrator.TrainingJobResult;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityOrchestrator.TrainingJobResult;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityOrchestrator.TrainingJobResult;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityOrchestrator.TrainingJobResult;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): ReliabilityOrchestrator.TrainingJobResult;
     ...
     * @see #removeField
     */
    withoutField(field: string): ReliabilityOrchestrator.TrainingJobResult;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): ReliabilityOrchestrator.TrainingJobResult;
     ...
     */
    withoutFields(fields: Array_Type<string>): ReliabilityOrchestrator.TrainingJobResult;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityOrchestrator.TrainingJobResult;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): ReliabilityOrchestrator.TrainingJobResult;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityOrchestrator.TrainingJobResult;
     ...
     * @see #unsetField
     */
    defaultField(field: string): ReliabilityOrchestrator.TrainingJobResult;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): ReliabilityOrchestrator.TrainingJobResult;
     ...
     * @see #removeField
     */
    unsetField(field: string): ReliabilityOrchestrator.TrainingJobResult;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): ReliabilityOrchestrator.TrainingJobResult;
     ...
     * @see #unsetField
     */
    removeField(field: string): ReliabilityOrchestrator.TrainingJobResult;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): ReliabilityOrchestrator.TrainingJobResult;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityOrchestrator.TrainingJobResult;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityOrchestrator.TrainingJobResult;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityOrchestrator.TrainingJobResult;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityOrchestrator.TrainingJobResult;

    mergeJson(json: any): ReliabilityOrchestrator.TrainingJobResult;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityOrchestrator.TrainingJobResult;
     ...
     */
    sumObj(other: Obj, deep?: boolean): ReliabilityOrchestrator.TrainingJobResult;
     ...
     */
    singletonArray(): Array_Type<ReliabilityOrchestrator.TrainingJobResult>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityOrchestrator.TrainingJobResult> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<ReliabilityOrchestrator.TrainingJobResult> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<ReliabilityOrchestrator.TrainingJobResult>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<ReliabilityOrchestrator.TrainingJobResult> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, ReliabilityOrchestrator.TrainingJobResult> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityOrchestrator.TrainingJobResult> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<ReliabilityOrchestrator.TrainingJobResult>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<ReliabilityOrchestrator.TrainingJobResult>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityOrchestrator.TrainingJobResult;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityOrchestrator.TrainingJobResult;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityOrchestrator.TrainingJobResult;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): ReliabilityOrchestrator.TrainingJobResult;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityOrchestrator.TrainingJobResult;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): ReliabilityOrchestrator.TrainingJobResult;
     ...
     * @see #fromString
     */
    static make(s: string): ReliabilityOrchestrator.TrainingJobResult | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityOrchestrator.TrainingJobResult;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): ReliabilityOrchestrator.TrainingJobResult;
     ...
     */
    static cachedEmptyInst(): ReliabilityOrchestrator.TrainingJobResult;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityOrchestrator.TrainingJobResult> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): ReliabilityOrchestrator.TrainingJobResult;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<ReliabilityOrchestrator.TrainingJobResult>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<ReliabilityOrchestrator.TrainingJobResult>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityOrchestrator.TrainingJobResult> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityOrchestrator.TrainingJobResult>> | null;
     ...
     */
    get(include?: string): ReliabilityOrchestrator.TrainingJobResult | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): ReliabilityOrchestrator.TrainingJobResult | null;
     ...
     */
    getMissing(spec: GetMissingSpec): ReliabilityOrchestrator.TrainingJobResult;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): ReliabilityOrchestrator.TrainingJobResult | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): ReliabilityOrchestrator.TrainingJobResult;
     ...
     * @see #toString
     */
    static fromString(s: string): ReliabilityOrchestrator.TrainingJobResult | null;
     ...
     */
    create(spec?: UpsertSpec): ReliabilityOrchestrator.TrainingJobResult | null;
     ...
     */
    static createBatch(objs: Array_Type<ReliabilityOrchestrator.TrainingJobResult>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.TrainingJobResult> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<ReliabilityOrchestrator.TrainingJobResult>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityOrchestrator.TrainingJobResult> | null;
     ...
     */
    update(srcObj?: ReliabilityOrchestrator.TrainingJobResult, spec?: UpsertSpec): ReliabilityOrchestrator.TrainingJobResult | null;
     ...
     */
    upsert(srcObj?: ReliabilityOrchestrator.TrainingJobResult, spec?: UpsertSpec): ReliabilityOrchestrator.TrainingJobResult | null;
     ...
     */
    merge(spec?: MergeSpec): ReliabilityOrchestrator.TrainingJobResult | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): ReliabilityOrchestrator.TrainingJobResult | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): ReliabilityOrchestrator.TrainingJobResult | null;
     ...
     */
    static updateBatch(objs: Array_Type<ReliabilityOrchestrator.TrainingJobResult>, srcObjs?: Array_Type<ReliabilityOrchestrator.TrainingJobResult>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.TrainingJobResult> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<ReliabilityOrchestrator.TrainingJobResult> | null>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.TrainingJobResult> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<ReliabilityOrchestrator.TrainingJobResult>, srcObjs?: Array_Type<ReliabilityOrchestrator.TrainingJobResult>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.TrainingJobResult> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<ReliabilityOrchestrator.TrainingJobResult> | null>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.TrainingJobResult> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<ReliabilityOrchestrator.TrainingJobResult>, spec?: TouchSpec): ObjList<ReliabilityOrchestrator.TrainingJobResult> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityOrchestrator.TrainingJobResult>, spec?: MergeSpec): ObjList<ReliabilityOrchestrator.TrainingJobResult> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityOrchestrator.TrainingJobResult>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityOrchestrator.TrainingJobResult> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<ReliabilityOrchestrator.TrainingJobResult> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityOrchestrator.TrainingJobResult> | null;
     ...
     */
    static mergeAll(mergeObj: ReliabilityOrchestrator.TrainingJobResult, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: ReliabilityOrchestrator.TrainingJobResult, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<ReliabilityOrchestrator.TrainingJobResult>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.TrainingJobResult> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<ReliabilityOrchestrator.TrainingJobResult>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.TrainingJobResult> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): ReliabilityOrchestrator.TrainingJobResult | null;
     ...
     */
    static beforeCreate(objs: Array_Type<ReliabilityOrchestrator.TrainingJobResult>): ObjList<ReliabilityOrchestrator.TrainingJobResult>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<ReliabilityOrchestrator.TrainingJobResult>): ObjList<ReliabilityOrchestrator.TrainingJobResult>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<ReliabilityOrchestrator.TrainingJobResult>): ObjList<ReliabilityOrchestrator.TrainingJobResult>;
     ...
     */
    static afterCreate(objs: Array_Type<ReliabilityOrchestrator.TrainingJobResult>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<ReliabilityOrchestrator.TrainingJobResult>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<ReliabilityOrchestrator.TrainingJobResult>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityOrchestrator.TrainingJobResult>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityOrchestrator.TrainingJobResult>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): ReliabilityOrchestrator.TrainingJobResult | null;
     ...
     */
    withoutIdentity(): ReliabilityOrchestrator.TrainingJobResult | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<ReliabilityOrchestrator.TrainingJobResult>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: ReliabilityOrchestrator.TrainingJobResult, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<ReliabilityOrchestrator.TrainingJobResult>, callback?: λFunction<ReliabilityOrchestrator.TrainingJobResult | null, ReliabilityOrchestrator.TrainingJobResult | null>): ObjList<ReliabilityOrchestrator.TrainingJobResult>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<ReliabilityOrchestrator.TrainingJobResult>, callback?: λFunction<ReliabilityOrchestrator.TrainingJobResult | null, ReliabilityOrchestrator.TrainingJobResult | null>): Array_Type<ObjError> | null;
     ...
     */
    beforeRecover(): ReliabilityOrchestrator.TrainingJobResult;
     ...
     * caller is responsible for persisting the result.
     */
    beforeCancel(): ReliabilityOrchestrator.TrainingJobResult;

    /**
     * This function creates a {@link ReliabilityMlModel} by first constructing a {@link ReliabilityMl.Pipeline} from the
     * provided {@link #pipeline}, {@link #template} and {@link #hyperparamOverrides}, and then calls
     * {@link ReliabilityMlModel#createReliabilityModel).
     */
    static createReliabilityModel(project: ReliabilityMl.Project, datasetPreparationRun: ReliabilityMlDatasetPreparationRun, pipeline?: ReliabilityMl.Pipeline<any, any, any, any>, template?: ModelTemplate, name?: string, id?: string, replicatedFrom?: ReliabilityMlModel, hyperparamOverrides?: Map_Type<string, any>): ReliabilityMlModel;

    /**
     * Deploy the trainedModel as a `CANDIDATE` model. If a {@link MlModel.DeploySpec#subjectFilter} is specified, the model will be deployed
     * for the {@link ReliabilityAsset}s in the provided subjectFilter.
     * If not specified, the model will be deployed for the {@link ReliabilityAsset}s corresponding to the
     */
    static deployModelAsCandidate(trainedModel: ReliabilityMlModel, subjectFilter?: string, trainJobRun?: ReliabilityOrchestrator.TrainingJobRun): void;
  }
}
