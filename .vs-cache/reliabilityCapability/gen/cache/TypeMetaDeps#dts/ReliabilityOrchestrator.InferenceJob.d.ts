// TypeScript definitions for the C3 type ReliabilityOrchestrator.InferenceJob

/**
 * Represents a model inference job that can be executed on {@link ReliabilityAsset}s and a given {@link MlProject}.
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityOrchestrator.InferenceJob
 */
declare namespace ReliabilityOrchestrator {
  export interface IInferenceJob {
 ...
 */
declare namespace ReliabilityOrchestrator {
  export class InferenceJob extends Obj  {

    /**
     * The array of configurations this job run must execute.
     */
    readonly jobSpecs: Array_Type<ReliabilityOrchestrator.InferenceJobSpec>;
    withJobSpecs(jobSpecs: Array_Type<ReliabilityOrchestrator.InferenceJobSpec> | Array<IReliabilityOrchestrator.InferenceJobSpec>): ReliabilityOrchestrator.InferenceJob;
     ...
     */
    readonly id: string;
    withId(id: string): ReliabilityOrchestrator.InferenceJob;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityOrchestrator.InferenceJob;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): ReliabilityOrchestrator.InferenceJob;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): ReliabilityOrchestrator.InferenceJob;
    ...
    withVersion(version: number | null): ReliabilityOrchestrator.InferenceJob;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): ReliabilityOrchestrator.InferenceJob;
     ...
     * @see #toJson
     */
    static fromJson(json: any): ReliabilityOrchestrator.InferenceJob | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): ReliabilityOrchestrator.InferenceJob | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): ReliabilityOrchestrator.InferenceJob | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): ReliabilityOrchestrator.InferenceJob | null;
     ...
     */
    replaceType(old: Type, new_: Type): ReliabilityOrchestrator.InferenceJob;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityOrchestrator.InferenceJob;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityOrchestrator.InferenceJob;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityOrchestrator.InferenceJob>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityOrchestrator.InferenceJob>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityOrchestrator.InferenceJob;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityOrchestrator.InferenceJob;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityOrchestrator.InferenceJob;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): ReliabilityOrchestrator.InferenceJob;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): ReliabilityOrchestrator.InferenceJob;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityOrchestrator.InferenceJob;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityOrchestrator.InferenceJob;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityOrchestrator.InferenceJob;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): ReliabilityOrchestrator.InferenceJob;
     ...
     * @see #removeField
     */
    withoutField(field: string): ReliabilityOrchestrator.InferenceJob;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): ReliabilityOrchestrator.InferenceJob;
     ...
     */
    withoutFields(fields: Array_Type<string>): ReliabilityOrchestrator.InferenceJob;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityOrchestrator.InferenceJob;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): ReliabilityOrchestrator.InferenceJob;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityOrchestrator.InferenceJob;
     ...
     * @see #unsetField
     */
    defaultField(field: string): ReliabilityOrchestrator.InferenceJob;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): ReliabilityOrchestrator.InferenceJob;
     ...
     * @see #removeField
     */
    unsetField(field: string): ReliabilityOrchestrator.InferenceJob;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): ReliabilityOrchestrator.InferenceJob;
     ...
     * @see #unsetField
     */
    removeField(field: string): ReliabilityOrchestrator.InferenceJob;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): ReliabilityOrchestrator.InferenceJob;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityOrchestrator.InferenceJob;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityOrchestrator.InferenceJob;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityOrchestrator.InferenceJob;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityOrchestrator.InferenceJob;

    mergeJson(json: any): ReliabilityOrchestrator.InferenceJob;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityOrchestrator.InferenceJob;
     ...
     */
    sumObj(other: Obj, deep?: boolean): ReliabilityOrchestrator.InferenceJob;
     ...
     */
    singletonArray(): Array_Type<ReliabilityOrchestrator.InferenceJob>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityOrchestrator.InferenceJob> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<ReliabilityOrchestrator.InferenceJob> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<ReliabilityOrchestrator.InferenceJob>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<ReliabilityOrchestrator.InferenceJob> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, ReliabilityOrchestrator.InferenceJob> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityOrchestrator.InferenceJob> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<ReliabilityOrchestrator.InferenceJob>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<ReliabilityOrchestrator.InferenceJob>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityOrchestrator.InferenceJob;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityOrchestrator.InferenceJob;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityOrchestrator.InferenceJob;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): ReliabilityOrchestrator.InferenceJob;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityOrchestrator.InferenceJob;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): ReliabilityOrchestrator.InferenceJob;
     ...
     * @see #fromString
     */
    static make(s: string): ReliabilityOrchestrator.InferenceJob | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityOrchestrator.InferenceJob;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): ReliabilityOrchestrator.InferenceJob;
     ...
     */
    static cachedEmptyInst(): ReliabilityOrchestrator.InferenceJob;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityOrchestrator.InferenceJob> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): ReliabilityOrchestrator.InferenceJob;
     ...
     */
    doStart(options?: ReliabilityOrchestrator.JobOptions, additionalParams?: Map_Type<string, any>): Pair<ReliabilityOrchestrator.InferenceJobRun, MlOperationRun<ReliabilityOrchestrator.InferenceJobRun>>;
     ...
     */
    start(options?: ReliabilityOrchestrator.JobOptions, additionalParams?: Map_Type<string, any>): MlOperationRun<ReliabilityOrchestrator.InferenceJobRun>;

    /**
     * @return The concrete {@link ReliabilityOrchestrator.JobRun} subType.
     */
    static jobRunType(): Type<<ReliabilityOrchestrator.InferenceJobRun>> | null;

    /**
     * @return the concrete {@link ReliabilityOrchestrator.JobSpec} subType.
     */
    static jobSpecType(): Type<<ReliabilityOrchestrator.InferenceJobSpec>> | null;
     ...
     */
    fetchJobRunForOperationRun(run: MlOperationRun<any>): ReliabilityOrchestrator.InferenceJobRun | null;
     ...
     */
    fetchLatestJobRun(): ReliabilityOrchestrator.InferenceJobRun | null;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<ReliabilityOrchestrator.InferenceJob>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<ReliabilityOrchestrator.InferenceJob>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityOrchestrator.InferenceJob> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityOrchestrator.InferenceJob>> | null;
     ...
     */
    get(include?: string): ReliabilityOrchestrator.InferenceJob | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): ReliabilityOrchestrator.InferenceJob | null;
     ...
     */
    getMissing(spec: GetMissingSpec): ReliabilityOrchestrator.InferenceJob;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): ReliabilityOrchestrator.InferenceJob | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): ReliabilityOrchestrator.InferenceJob;
     ...
     * @see #toString
     */
    static fromString(s: string): ReliabilityOrchestrator.InferenceJob | null;
     ...
     */
    create(spec?: UpsertSpec): ReliabilityOrchestrator.InferenceJob | null;
     ...
     */
    static createBatch(objs: Array_Type<ReliabilityOrchestrator.InferenceJob>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.InferenceJob> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<ReliabilityOrchestrator.InferenceJob>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityOrchestrator.InferenceJob> | null;
     ...
     */
    update(srcObj?: ReliabilityOrchestrator.InferenceJob, spec?: UpsertSpec): ReliabilityOrchestrator.InferenceJob | null;
     ...
     */
    upsert(srcObj?: ReliabilityOrchestrator.InferenceJob, spec?: UpsertSpec): ReliabilityOrchestrator.InferenceJob | null;
     ...
     */
    merge(spec?: MergeSpec): ReliabilityOrchestrator.InferenceJob | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): ReliabilityOrchestrator.InferenceJob | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): ReliabilityOrchestrator.InferenceJob | null;
     ...
     */
    static updateBatch(objs: Array_Type<ReliabilityOrchestrator.InferenceJob>, srcObjs?: Array_Type<ReliabilityOrchestrator.InferenceJob>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.InferenceJob> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<ReliabilityOrchestrator.InferenceJob> | null>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.InferenceJob> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<ReliabilityOrchestrator.InferenceJob>, srcObjs?: Array_Type<ReliabilityOrchestrator.InferenceJob>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.InferenceJob> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<ReliabilityOrchestrator.InferenceJob> | null>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.InferenceJob> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<ReliabilityOrchestrator.InferenceJob>, spec?: TouchSpec): ObjList<ReliabilityOrchestrator.InferenceJob> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityOrchestrator.InferenceJob>, spec?: MergeSpec): ObjList<ReliabilityOrchestrator.InferenceJob> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityOrchestrator.InferenceJob>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityOrchestrator.InferenceJob> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<ReliabilityOrchestrator.InferenceJob> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityOrchestrator.InferenceJob> | null;
     ...
     */
    static mergeAll(mergeObj: ReliabilityOrchestrator.InferenceJob, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: ReliabilityOrchestrator.InferenceJob, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<ReliabilityOrchestrator.InferenceJob>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.InferenceJob> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<ReliabilityOrchestrator.InferenceJob>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.InferenceJob> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): ReliabilityOrchestrator.InferenceJob | null;
     ...
     */
    static beforeCreate(objs: Array_Type<ReliabilityOrchestrator.InferenceJob>): ObjList<ReliabilityOrchestrator.InferenceJob>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<ReliabilityOrchestrator.InferenceJob>): ObjList<ReliabilityOrchestrator.InferenceJob>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<ReliabilityOrchestrator.InferenceJob>): ObjList<ReliabilityOrchestrator.InferenceJob>;
     ...
     */
    static afterCreate(objs: Array_Type<ReliabilityOrchestrator.InferenceJob>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<ReliabilityOrchestrator.InferenceJob>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<ReliabilityOrchestrator.InferenceJob>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityOrchestrator.InferenceJob>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityOrchestrator.InferenceJob>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): ReliabilityOrchestrator.InferenceJob | null;
     ...
     */
    withoutIdentity(): ReliabilityOrchestrator.InferenceJob | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<ReliabilityOrchestrator.InferenceJob>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: ReliabilityOrchestrator.InferenceJob, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<ReliabilityOrchestrator.InferenceJob>, callback?: λFunction<ReliabilityOrchestrator.InferenceJob | null, ReliabilityOrchestrator.InferenceJob | null>): ObjList<ReliabilityOrchestrator.InferenceJob>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<ReliabilityOrchestrator.InferenceJob>, callback?: λFunction<ReliabilityOrchestrator.InferenceJob | null, ReliabilityOrchestrator.InferenceJob | null>): Array_Type<ObjError> | null;
     ...
     */
    static triggerInferenceJob(periodBeforeEnd: Period, jobSpecs: Array_Type<ReliabilityOrchestrator.InferenceJobSpec>, options?: ReliabilityOrchestrator.JobOptions): MlOperationRun<ReliabilityOrchestrator.InferenceJobRun>;
  }
}
