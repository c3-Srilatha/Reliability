// TypeScript definitions for the C3 type ReliabilityAssetAlertSimilarityCreationBatchJob

/**
 * A batch job that creates the {@link ReliabilityAssetAlertSimilarity} objects for {@ReliabilityAssetAlert}s.
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityAssetAlertSimilarityCreationBatchJob
 */
declare interface IReliabilityAssetAlertSimilarityCreationBatchJob {
 ...
 */
declare class ReliabilityAssetAlertSimilarityCreationBatchJob extends Obj  {

  /**
   * current or last job execution for this instance
   */
  readonly run?: BatchJobRun;
  withRun(run: IBatchJobRun | null): ReliabilityAssetAlertSimilarityCreationBatchJob;

  /**
   * previous job executions for this instance
   */
  readonly runs?: Array_Type<BatchJobRun>;
  withRuns(runs: Array_Type<BatchJobRun> | Array<IBatchJobRun> | null): ReliabilityAssetAlertSimilarityCreationBatchJob;

  /**
   * FOR INTERNAL USE ONLY - Specify options in call to {@link start}.
   */
  readonly options?: Obj;
  withOptions(options: IObj | null): ReliabilityAssetAlertSimilarityCreationBatchJob;
  ...
  withOnCompleteCallback(onCompleteCallback: IJobBase.Callback | null): ReliabilityAssetAlertSimilarityCreationBatchJob;
  ...
  withPriority(priority: number | null): ReliabilityAssetAlertSimilarityCreationBatchJob;
  ...
  withDisabled(disabled: boolean): ReliabilityAssetAlertSimilarityCreationBatchJob;
  ...
  withMaxConcurrency(maxConcurrency: number | null): ReliabilityAssetAlertSimilarityCreationBatchJob;
  ...
  withMaxConcurrencyPerNode(maxConcurrencyPerNode: number | null): ReliabilityAssetAlertSimilarityCreationBatchJob;
  ...
  withRunAsUser(runAsUser: boolean): ReliabilityAssetAlertSimilarityCreationBatchJob;

  /**
   * Don't set this field in the BatchJob, set it in the BatchJobOptions when calling `start`
   */
  readonly nodePool?: string;
  withNodePool(nodePool: string | null): ReliabilityAssetAlertSimilarityCreationBatchJob;
  ...
  withSkipIfRunning(skipIfRunning: boolean): ReliabilityAssetAlertSimilarityCreationBatchJob;

  /**
   * Set to between 1 and 5 to enable auto recovery. See {@link invalidation-queues.c3doc Invalidation Queues} for detailed documentation.
   */
  readonly numAutoRecoveryAttempts?: number;
  withNumAutoRecoveryAttempts(numAutoRecoveryAttempts: number | null): ReliabilityAssetAlertSimilarityCreationBatchJob;
  ...
  withPropagateActionContext(propagateActionContext: boolean): ReliabilityAssetAlertSimilarityCreationBatchJob;
  ...
  withTypeIdent(typeIdent: string | null): ReliabilityAssetAlertSimilarityCreationBatchJob;
   ...
   */
  readonly id: string;
  withId(id: string): ReliabilityAssetAlertSimilarityCreationBatchJob;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityAssetAlertSimilarityCreationBatchJob;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): ReliabilityAssetAlertSimilarityCreationBatchJob;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): ReliabilityAssetAlertSimilarityCreationBatchJob;
  ...
  withVersion(version: number | null): ReliabilityAssetAlertSimilarityCreationBatchJob;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): ReliabilityAssetAlertSimilarityCreationBatchJob;
  ...
  withAbortOnError(abortOnError: boolean): ReliabilityAssetAlertSimilarityCreationBatchJob;
   ...
   * @see #toJson
   */
  static fromJson(json: any): ReliabilityAssetAlertSimilarityCreationBatchJob | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): ReliabilityAssetAlertSimilarityCreationBatchJob | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): ReliabilityAssetAlertSimilarityCreationBatchJob | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): ReliabilityAssetAlertSimilarityCreationBatchJob | null;
   ...
   */
  replaceType(old: Type, new_: Type): ReliabilityAssetAlertSimilarityCreationBatchJob;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityAssetAlertSimilarityCreationBatchJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityAssetAlertSimilarityCreationBatchJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityAssetAlertSimilarityCreationBatchJob>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityAssetAlertSimilarityCreationBatchJob>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityAssetAlertSimilarityCreationBatchJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityAssetAlertSimilarityCreationBatchJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityAssetAlertSimilarityCreationBatchJob;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ReliabilityAssetAlertSimilarityCreationBatchJob;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ReliabilityAssetAlertSimilarityCreationBatchJob;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityAssetAlertSimilarityCreationBatchJob;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityAssetAlertSimilarityCreationBatchJob;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityAssetAlertSimilarityCreationBatchJob;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ReliabilityAssetAlertSimilarityCreationBatchJob;
   ...
   * @see #removeField
   */
  withoutField(field: string): ReliabilityAssetAlertSimilarityCreationBatchJob;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): ReliabilityAssetAlertSimilarityCreationBatchJob;
   ...
   */
  withoutFields(fields: Array_Type<string>): ReliabilityAssetAlertSimilarityCreationBatchJob;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityAssetAlertSimilarityCreationBatchJob;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ReliabilityAssetAlertSimilarityCreationBatchJob;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityAssetAlertSimilarityCreationBatchJob;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ReliabilityAssetAlertSimilarityCreationBatchJob;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ReliabilityAssetAlertSimilarityCreationBatchJob;
   ...
   * @see #removeField
   */
  unsetField(field: string): ReliabilityAssetAlertSimilarityCreationBatchJob;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ReliabilityAssetAlertSimilarityCreationBatchJob;
   ...
   * @see #unsetField
   */
  removeField(field: string): ReliabilityAssetAlertSimilarityCreationBatchJob;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ReliabilityAssetAlertSimilarityCreationBatchJob;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityAssetAlertSimilarityCreationBatchJob;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityAssetAlertSimilarityCreationBatchJob;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityAssetAlertSimilarityCreationBatchJob;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityAssetAlertSimilarityCreationBatchJob;

  mergeJson(json: any): ReliabilityAssetAlertSimilarityCreationBatchJob;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityAssetAlertSimilarityCreationBatchJob;
   ...
   */
  sumObj(other: Obj, deep?: boolean): ReliabilityAssetAlertSimilarityCreationBatchJob;
   ...
   */
  singletonArray(): Array_Type<ReliabilityAssetAlertSimilarityCreationBatchJob>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityAssetAlertSimilarityCreationBatchJob> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ReliabilityAssetAlertSimilarityCreationBatchJob> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<ReliabilityAssetAlertSimilarityCreationBatchJob>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ReliabilityAssetAlertSimilarityCreationBatchJob> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, ReliabilityAssetAlertSimilarityCreationBatchJob> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityAssetAlertSimilarityCreationBatchJob> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ReliabilityAssetAlertSimilarityCreationBatchJob>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ReliabilityAssetAlertSimilarityCreationBatchJob>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityAssetAlertSimilarityCreationBatchJob;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityAssetAlertSimilarityCreationBatchJob;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityAssetAlertSimilarityCreationBatchJob;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ReliabilityAssetAlertSimilarityCreationBatchJob;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityAssetAlertSimilarityCreationBatchJob;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ReliabilityAssetAlertSimilarityCreationBatchJob;
   ...
   * @see #fromString
   */
  static make(s: string): ReliabilityAssetAlertSimilarityCreationBatchJob | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityAssetAlertSimilarityCreationBatchJob;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): ReliabilityAssetAlertSimilarityCreationBatchJob;
   ...
   */
  static cachedEmptyInst(): ReliabilityAssetAlertSimilarityCreationBatchJob;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityAssetAlertSimilarityCreationBatchJob> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): ReliabilityAssetAlertSimilarityCreationBatchJob;
   ...
   */
  start(options?: ReliabilityAssetAlertSimilarityCreationJobOptions): BatchJobStatus | null;
   ...
   */
  cleanup(options?: ReliabilityAssetAlertSimilarityCreationJobOptions): void;
  ...
  cancelJob(removeResults?: boolean, force?: boolean): JobBase<BatchJobRun, BatchJobStatus, ReliabilityAssetAlertSimilarityCreationJobOptions> | null;

  failJob(run: JobRun<BatchJobStatusBase>): JobBase<BatchJobRun, BatchJobStatus, ReliabilityAssetAlertSimilarityCreationJobOptions> | null;
  ...
  validateStart(options?: ReliabilityAssetAlertSimilarityCreationJobOptions): void;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<ReliabilityAssetAlertSimilarityCreationBatchJob>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<ReliabilityAssetAlertSimilarityCreationBatchJob>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityAssetAlertSimilarityCreationBatchJob> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityAssetAlertSimilarityCreationBatchJob>> | null;
   ...
   */
  get(include?: string): ReliabilityAssetAlertSimilarityCreationBatchJob | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): ReliabilityAssetAlertSimilarityCreationBatchJob | null;
   ...
   */
  getMissing(spec: GetMissingSpec): ReliabilityAssetAlertSimilarityCreationBatchJob;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): ReliabilityAssetAlertSimilarityCreationBatchJob | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): ReliabilityAssetAlertSimilarityCreationBatchJob;
   ...
   * @see #toString
   */
  static fromString(s: string): ReliabilityAssetAlertSimilarityCreationBatchJob | null;
   ...
   */
  create(spec?: UpsertSpec): ReliabilityAssetAlertSimilarityCreationBatchJob | null;
   ...
   */
  static createBatch(objs: Array_Type<ReliabilityAssetAlertSimilarityCreationBatchJob>, spec?: UpsertSpec): ObjList<ReliabilityAssetAlertSimilarityCreationBatchJob> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<ReliabilityAssetAlertSimilarityCreationBatchJob>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityAssetAlertSimilarityCreationBatchJob> | null;
   ...
   */
  update(srcObj?: ReliabilityAssetAlertSimilarityCreationBatchJob, spec?: UpsertSpec): ReliabilityAssetAlertSimilarityCreationBatchJob | null;
   ...
   */
  upsert(srcObj?: ReliabilityAssetAlertSimilarityCreationBatchJob, spec?: UpsertSpec): ReliabilityAssetAlertSimilarityCreationBatchJob | null;
   ...
   */
  merge(spec?: MergeSpec): ReliabilityAssetAlertSimilarityCreationBatchJob | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): ReliabilityAssetAlertSimilarityCreationBatchJob | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): ReliabilityAssetAlertSimilarityCreationBatchJob | null;
   ...
   */
  static updateBatch(objs: Array_Type<ReliabilityAssetAlertSimilarityCreationBatchJob>, srcObjs?: Array_Type<ReliabilityAssetAlertSimilarityCreationBatchJob>, spec?: UpsertSpec): ObjList<ReliabilityAssetAlertSimilarityCreationBatchJob> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<ReliabilityAssetAlertSimilarityCreationBatchJob> | null>, spec?: UpsertSpec): ObjList<ReliabilityAssetAlertSimilarityCreationBatchJob> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<ReliabilityAssetAlertSimilarityCreationBatchJob>, srcObjs?: Array_Type<ReliabilityAssetAlertSimilarityCreationBatchJob>, spec?: UpsertSpec): ObjList<ReliabilityAssetAlertSimilarityCreationBatchJob> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<ReliabilityAssetAlertSimilarityCreationBatchJob> | null>, spec?: UpsertSpec): ObjList<ReliabilityAssetAlertSimilarityCreationBatchJob> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<ReliabilityAssetAlertSimilarityCreationBatchJob>, spec?: TouchSpec): ObjList<ReliabilityAssetAlertSimilarityCreationBatchJob> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityAssetAlertSimilarityCreationBatchJob>, spec?: MergeSpec): ObjList<ReliabilityAssetAlertSimilarityCreationBatchJob> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityAssetAlertSimilarityCreationBatchJob>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityAssetAlertSimilarityCreationBatchJob> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<ReliabilityAssetAlertSimilarityCreationBatchJob> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityAssetAlertSimilarityCreationBatchJob> | null;
   ...
   */
  static mergeAll(mergeObj: ReliabilityAssetAlertSimilarityCreationBatchJob, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: ReliabilityAssetAlertSimilarityCreationBatchJob, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<ReliabilityAssetAlertSimilarityCreationBatchJob>, spec?: UpsertSpec): ObjList<ReliabilityAssetAlertSimilarityCreationBatchJob> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<ReliabilityAssetAlertSimilarityCreationBatchJob>, spec?: UpsertSpec): ObjList<ReliabilityAssetAlertSimilarityCreationBatchJob> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): ReliabilityAssetAlertSimilarityCreationBatchJob | null;
   ...
   */
  static beforeCreate(objs: Array_Type<ReliabilityAssetAlertSimilarityCreationBatchJob>): ObjList<ReliabilityAssetAlertSimilarityCreationBatchJob>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<ReliabilityAssetAlertSimilarityCreationBatchJob>): ObjList<ReliabilityAssetAlertSimilarityCreationBatchJob>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<ReliabilityAssetAlertSimilarityCreationBatchJob>): ObjList<ReliabilityAssetAlertSimilarityCreationBatchJob>;
   ...
   */
  static afterCreate(objs: Array_Type<ReliabilityAssetAlertSimilarityCreationBatchJob>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<ReliabilityAssetAlertSimilarityCreationBatchJob>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<ReliabilityAssetAlertSimilarityCreationBatchJob>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityAssetAlertSimilarityCreationBatchJob>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityAssetAlertSimilarityCreationBatchJob>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): ReliabilityAssetAlertSimilarityCreationBatchJob | null;
   ...
   */
  withoutIdentity(): ReliabilityAssetAlertSimilarityCreationBatchJob | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<ReliabilityAssetAlertSimilarityCreationBatchJob>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: ReliabilityAssetAlertSimilarityCreationBatchJob, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<ReliabilityAssetAlertSimilarityCreationBatchJob>, callback?: λFunction<ReliabilityAssetAlertSimilarityCreationBatchJob | null, ReliabilityAssetAlertSimilarityCreationBatchJob | null>): ObjList<ReliabilityAssetAlertSimilarityCreationBatchJob>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<ReliabilityAssetAlertSimilarityCreationBatchJob>, callback?: λFunction<ReliabilityAssetAlertSimilarityCreationBatchJob | null, ReliabilityAssetAlertSimilarityCreationBatchJob | null>): Array_Type<ObjError> | null;
   ...
   */
  static doStart(job?: ReliabilityAssetAlertSimilarityCreationBatchJob, options?: ReliabilityAssetAlertSimilarityCreationJobOptions): void;
   ...
   */
  static processBatch(batch?: ReliabilityAssetAlertSimilarityCreationBatch, job?: ReliabilityAssetAlertSimilarityCreationBatchJob, options?: ReliabilityAssetAlertSimilarityCreationJobOptions): void;
   ...
   */
  static allComplete(job: ReliabilityAssetAlertSimilarityCreationBatchJob, options?: ReliabilityAssetAlertSimilarityCreationJobOptions): string | null;
   ...
   *           Options the job was run with.
   */
  static failed(job: ReliabilityAssetAlertSimilarityCreationBatchJob, status: BatchJobStatus, options?: ReliabilityAssetAlertSimilarityCreationJobOptions): void;
   ...
   *        Batch to schedule.
   */
  scheduleBatch(batch?: ReliabilityAssetAlertSimilarityCreationBatch): void;
   ...
   *        Batches to schedule.
   */
  scheduleBatches(batches?: Array_Type<ReliabilityAssetAlertSimilarityCreationBatch>): void;
   ...
   */
  static scheduleObjBatch(job?: ReliabilityAssetAlertSimilarityCreationBatchJob, objBatch?: ObjBatch, logPrefix?: string): number | null;
