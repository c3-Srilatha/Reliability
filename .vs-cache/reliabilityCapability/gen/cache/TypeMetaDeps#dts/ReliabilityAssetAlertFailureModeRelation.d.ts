// TypeScript definitions for the C3 type ReliabilityAssetAlertFailureModeRelation

/**
 * Type that allows us to go from {@link ReliabilityAssetAlert} to the {@link FailureModeLineItem}(s) associated with it.
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityAssetAlertFailureModeRelation
 */
declare interface IReliabilityAssetAlertFailureModeRelation {
  ...
  /**
   * The {@link FailureModeLineItem} related to by this relation.
   */
  to: IFailureModeLineItem;

  /**
   * The name of the alert being linked. Necessary because {@link FailureModeRelation#fromName} is an `anyof` reference, which cannot be traversed.
   */
  fromName?: string;

  /**
   * If true, the {@link FailureModeLineItem} is recommended by user.
   * Otherwise, it is recommended by the failure mode reommendation engine.
   */
  userRecommended?: boolean;

  /**
   * User feedback for the recommendation
   */
  feedbacks?: Array_Type<FailureModeFeedback> | Array<IFailureModeFeedback>;

  /**
   * Most recent feedback for the failure mode
   */
  latestFeedback?: IFailureModeFeedbackTimedValue;

  /**
   * How significant the {@link FailureModeLineItem} is to the {@link ReliabilityAssetAlert}. All significance scores for an alert add up to 1.
   * This is populated upon the creation of the {@link ReliabilityAssetAlert}s.
   */
  significance?: number;

  /**
   * Displayed text of significance field. Round to 2 decimal precision.
   */
  displaySignificance?: number;

  /**
   * Only used to show the icon on the UI.
   * Ranges from -1 to 2.
   * -1: no feedback
   * 0: bad
   * 1: so-so
  ...
  /**
   * Text of latest feedback to be displayed in UI. 0 - "Not Helpful", 2 - "Helpful"
   */
 ...
 * Type that allows us to go from {@link ReliabilityAssetAlert} to the {@link FailureModeLineItem}(s) associated with it.
 *
 * @remarks this represents a made instance of ReliabilityAssetAlertFailureModeRelation
 */
declare class ReliabilityAssetAlertFailureModeRelation extends Obj  {
   ...
   */
  readonly id: string;
  withId(id: string): ReliabilityAssetAlertFailureModeRelation;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityAssetAlertFailureModeRelation;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): ReliabilityAssetAlertFailureModeRelation;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): ReliabilityAssetAlertFailureModeRelation;
  ...
  withVersion(version: number | null): ReliabilityAssetAlertFailureModeRelation;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): ReliabilityAssetAlertFailureModeRelation;

  /**
   * @inheritdoc
   */
  readonly facilityFilterPaths?: Array_Type<string>;
  withFacilityFilterPaths(facilityFilterPaths: Array_Type<string> | Array<string> | null): ReliabilityAssetAlertFailureModeRelation;
  ...
  withTypeIdent(typeIdent: string | null): ReliabilityAssetAlertFailureModeRelation;

  /**
   * The {@link FailureModeLineItem} related to by this relation.
   */
  readonly to: FailureModeLineItem;
  withTo(to: IFailureModeLineItem): ReliabilityAssetAlertFailureModeRelation;

  /**
   * The name of the alert being linked. Necessary because {@link FailureModeRelation#fromName} is an `anyof` reference, which cannot be traversed.
   */
  readonly fromName?: string;
  withFromName(fromName: string | null): ReliabilityAssetAlertFailureModeRelation;

  /**
   * If true, the {@link FailureModeLineItem} is recommended by user.
   * Otherwise, it is recommended by the failure mode reommendation engine.
   */
  readonly userRecommended?: boolean;
  withUserRecommended(userRecommended: boolean): ReliabilityAssetAlertFailureModeRelation;

  /**
   * User feedback for the recommendation
   */
  readonly feedbacks?: Array_Type<FailureModeFeedback>;
  withFeedbacks(feedbacks: Array_Type<FailureModeFeedback> | Array<IFailureModeFeedback> | null): ReliabilityAssetAlertFailureModeRelation;

  /**
   * Most recent feedback for the failure mode
   */
  readonly latestFeedback?: FailureModeFeedbackTimedValue;
  withLatestFeedback(latestFeedback: IFailureModeFeedbackTimedValue | null): ReliabilityAssetAlertFailureModeRelation;
  ...
  withSignificance(significance: number | null): ReliabilityAssetAlertFailureModeRelation;

  /**
   * Displayed text of significance field. Round to 2 decimal precision.
   */
  readonly displaySignificance?: number;
  withDisplaySignificance(displaySignificance: number | null): ReliabilityAssetAlertFailureModeRelation;
   ...
   * 2: good
   */
  readonly feedbackIcon?: number;
  withFeedbackIcon(feedbackIcon: number | null): ReliabilityAssetAlertFailureModeRelation;

  /**
   * Text of latest feedback to be displayed in UI. 0 - "Not Helpful", 2 - "Helpful"
   */
  readonly latestFeedbackText?: string;
  withLatestFeedbackText(latestFeedbackText: string | null): ReliabilityAssetAlertFailureModeRelation;

  /**
   * The alert of the relation.
   */
  readonly from: ReliabilityAssetAlert;
  withFrom(from: IReliabilityAssetAlert): ReliabilityAssetAlertFailureModeRelation;
   ...
   * @see #toJson
   */
  static fromJson(json: any): ReliabilityAssetAlertFailureModeRelation | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): ReliabilityAssetAlertFailureModeRelation | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): ReliabilityAssetAlertFailureModeRelation | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): ReliabilityAssetAlertFailureModeRelation | null;
   ...
   */
  replaceType(old: Type, new_: Type): ReliabilityAssetAlertFailureModeRelation;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityAssetAlertFailureModeRelation;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityAssetAlertFailureModeRelation;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityAssetAlertFailureModeRelation>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityAssetAlertFailureModeRelation>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityAssetAlertFailureModeRelation;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityAssetAlertFailureModeRelation;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityAssetAlertFailureModeRelation;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ReliabilityAssetAlertFailureModeRelation;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ReliabilityAssetAlertFailureModeRelation;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityAssetAlertFailureModeRelation;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityAssetAlertFailureModeRelation;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityAssetAlertFailureModeRelation;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ReliabilityAssetAlertFailureModeRelation;
   ...
   * @see #removeField
   */
  withoutField(field: string): ReliabilityAssetAlertFailureModeRelation;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): ReliabilityAssetAlertFailureModeRelation;
   ...
   */
  withoutFields(fields: Array_Type<string>): ReliabilityAssetAlertFailureModeRelation;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityAssetAlertFailureModeRelation;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ReliabilityAssetAlertFailureModeRelation;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityAssetAlertFailureModeRelation;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ReliabilityAssetAlertFailureModeRelation;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ReliabilityAssetAlertFailureModeRelation;
   ...
   * @see #removeField
   */
  unsetField(field: string): ReliabilityAssetAlertFailureModeRelation;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ReliabilityAssetAlertFailureModeRelation;
   ...
   * @see #unsetField
   */
  removeField(field: string): ReliabilityAssetAlertFailureModeRelation;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ReliabilityAssetAlertFailureModeRelation;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityAssetAlertFailureModeRelation;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityAssetAlertFailureModeRelation;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityAssetAlertFailureModeRelation;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityAssetAlertFailureModeRelation;

  mergeJson(json: any): ReliabilityAssetAlertFailureModeRelation;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityAssetAlertFailureModeRelation;
   ...
   */
  sumObj(other: Obj, deep?: boolean): ReliabilityAssetAlertFailureModeRelation;
   ...
   */
  singletonArray(): Array_Type<ReliabilityAssetAlertFailureModeRelation>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityAssetAlertFailureModeRelation> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ReliabilityAssetAlertFailureModeRelation> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<ReliabilityAssetAlertFailureModeRelation>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ReliabilityAssetAlertFailureModeRelation> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, ReliabilityAssetAlertFailureModeRelation> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityAssetAlertFailureModeRelation> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ReliabilityAssetAlertFailureModeRelation>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ReliabilityAssetAlertFailureModeRelation>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityAssetAlertFailureModeRelation;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityAssetAlertFailureModeRelation;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityAssetAlertFailureModeRelation;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ReliabilityAssetAlertFailureModeRelation;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityAssetAlertFailureModeRelation;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ReliabilityAssetAlertFailureModeRelation;
   ...
   * @see #fromString
   */
  static make(s: string): ReliabilityAssetAlertFailureModeRelation | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityAssetAlertFailureModeRelation;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): ReliabilityAssetAlertFailureModeRelation;
   ...
   */
  static cachedEmptyInst(): ReliabilityAssetAlertFailureModeRelation;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityAssetAlertFailureModeRelation> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): ReliabilityAssetAlertFailureModeRelation;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<ReliabilityAssetAlertFailureModeRelation>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<ReliabilityAssetAlertFailureModeRelation>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityAssetAlertFailureModeRelation> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityAssetAlertFailureModeRelation>> | null;
   ...
   */
  get(include?: string): ReliabilityAssetAlertFailureModeRelation | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): ReliabilityAssetAlertFailureModeRelation | null;
   ...
   */
  getMissing(spec: GetMissingSpec): ReliabilityAssetAlertFailureModeRelation;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): ReliabilityAssetAlertFailureModeRelation | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): ReliabilityAssetAlertFailureModeRelation;
   ...
   * @see #toString
   */
  static fromString(s: string): ReliabilityAssetAlertFailureModeRelation | null;
   ...
   */
  create(spec?: UpsertSpec): ReliabilityAssetAlertFailureModeRelation | null;
   ...
   */
  static createBatch(objs: Array_Type<ReliabilityAssetAlertFailureModeRelation>, spec?: UpsertSpec): ObjList<ReliabilityAssetAlertFailureModeRelation> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<ReliabilityAssetAlertFailureModeRelation>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityAssetAlertFailureModeRelation> | null;
   ...
   */
  update(srcObj?: ReliabilityAssetAlertFailureModeRelation, spec?: UpsertSpec): ReliabilityAssetAlertFailureModeRelation | null;
   ...
   */
  upsert(srcObj?: ReliabilityAssetAlertFailureModeRelation, spec?: UpsertSpec): ReliabilityAssetAlertFailureModeRelation | null;
   ...
   */
  merge(spec?: MergeSpec): ReliabilityAssetAlertFailureModeRelation | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): ReliabilityAssetAlertFailureModeRelation | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): ReliabilityAssetAlertFailureModeRelation | null;
   ...
   */
  static updateBatch(objs: Array_Type<ReliabilityAssetAlertFailureModeRelation>, srcObjs?: Array_Type<ReliabilityAssetAlertFailureModeRelation>, spec?: UpsertSpec): ObjList<ReliabilityAssetAlertFailureModeRelation> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<ReliabilityAssetAlertFailureModeRelation> | null>, spec?: UpsertSpec): ObjList<ReliabilityAssetAlertFailureModeRelation> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<ReliabilityAssetAlertFailureModeRelation>, srcObjs?: Array_Type<ReliabilityAssetAlertFailureModeRelation>, spec?: UpsertSpec): ObjList<ReliabilityAssetAlertFailureModeRelation> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<ReliabilityAssetAlertFailureModeRelation> | null>, spec?: UpsertSpec): ObjList<ReliabilityAssetAlertFailureModeRelation> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<ReliabilityAssetAlertFailureModeRelation>, spec?: TouchSpec): ObjList<ReliabilityAssetAlertFailureModeRelation> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityAssetAlertFailureModeRelation>, spec?: MergeSpec): ObjList<ReliabilityAssetAlertFailureModeRelation> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityAssetAlertFailureModeRelation>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityAssetAlertFailureModeRelation> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<ReliabilityAssetAlertFailureModeRelation> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityAssetAlertFailureModeRelation> | null;
   ...
   */
  static mergeAll(mergeObj: ReliabilityAssetAlertFailureModeRelation, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: ReliabilityAssetAlertFailureModeRelation, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<ReliabilityAssetAlertFailureModeRelation>, spec?: UpsertSpec): ObjList<ReliabilityAssetAlertFailureModeRelation> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<ReliabilityAssetAlertFailureModeRelation>, spec?: UpsertSpec): ObjList<ReliabilityAssetAlertFailureModeRelation> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): ReliabilityAssetAlertFailureModeRelation | null;
   ...
   */
  static beforeCreate(objs: Array_Type<ReliabilityAssetAlertFailureModeRelation>): ObjList<ReliabilityAssetAlertFailureModeRelation>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<ReliabilityAssetAlertFailureModeRelation>): ObjList<ReliabilityAssetAlertFailureModeRelation>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<ReliabilityAssetAlertFailureModeRelation>): ObjList<ReliabilityAssetAlertFailureModeRelation>;
   ...
   */
  static afterCreate(objs: Array_Type<ReliabilityAssetAlertFailureModeRelation>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<ReliabilityAssetAlertFailureModeRelation>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<ReliabilityAssetAlertFailureModeRelation>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityAssetAlertFailureModeRelation>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityAssetAlertFailureModeRelation>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): ReliabilityAssetAlertFailureModeRelation | null;
   ...
   */
  withoutIdentity(): ReliabilityAssetAlertFailureModeRelation | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<ReliabilityAssetAlertFailureModeRelation>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: ReliabilityAssetAlertFailureModeRelation, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<ReliabilityAssetAlertFailureModeRelation>, callback?: λFunction<ReliabilityAssetAlertFailureModeRelation | null, ReliabilityAssetAlertFailureModeRelation | null>): ObjList<ReliabilityAssetAlertFailureModeRelation>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<ReliabilityAssetAlertFailureModeRelation>, callback?: λFunction<ReliabilityAssetAlertFailureModeRelation | null, ReliabilityAssetAlertFailureModeRelation | null>): Array_Type<ObjError> | null;
