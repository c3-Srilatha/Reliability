// TypeScript definitions for the C3 type ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob
 */
declare namespace ReliabilityOrchestrator.ReliabilityRisk {
  export interface IModelCreationJob {
 ...
 */
declare namespace ReliabilityOrchestrator.ReliabilityRisk {
  export class ModelCreationJob extends Obj  {

    /**
     * current or last job execution for this instance
     */
    readonly run?: BatchJobRun;
    withRun(run: IBatchJobRun | null): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob;

    /**
     * previous job executions for this instance
     */
    readonly runs?: Array_Type<BatchJobRun>;
    withRuns(runs: Array_Type<BatchJobRun> | Array<IBatchJobRun> | null): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob;

    /**
     * FOR INTERNAL USE ONLY - Specify options in call to {@link start}.
     */
    readonly options?: Obj;
    withOptions(options: IObj | null): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob;
    ...
    withOnCompleteCallback(onCompleteCallback: IJobBase.Callback | null): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob;
    ...
    withPriority(priority: number | null): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob;
    ...
    withDisabled(disabled: boolean): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob;
    ...
    withMaxConcurrency(maxConcurrency: number | null): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob;
    ...
    withMaxConcurrencyPerNode(maxConcurrencyPerNode: number | null): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob;
    ...
    withRunAsUser(runAsUser: boolean): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob;

    /**
     * Don't set this field in the BatchJob, set it in the BatchJobOptions when calling `start`
     */
    readonly nodePool?: string;
    withNodePool(nodePool: string | null): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob;
    ...
    withSkipIfRunning(skipIfRunning: boolean): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob;

    /**
     * Set to between 1 and 5 to enable auto recovery. See {@link invalidation-queues.c3doc Invalidation Queues} for detailed documentation.
     */
    readonly numAutoRecoveryAttempts?: number;
    withNumAutoRecoveryAttempts(numAutoRecoveryAttempts: number | null): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob;
    ...
    withPropagateActionContext(propagateActionContext: boolean): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob;
    ...
    withTypeIdent(typeIdent: string | null): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob;
     ...
     */
    readonly id: string;
    withId(id: string): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob;
    ...
    withVersion(version: number | null): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob;
    ...
    withAbortOnError(abortOnError: boolean): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob;
     ...
     * @see #toJson
     */
    static fromJson(json: any): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob | null;
     ...
     */
    replaceType(old: Type, new_: Type): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob;
     ...
     * @see #removeField
     */
    withoutField(field: string): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob;
     ...
     */
    withoutFields(fields: Array_Type<string>): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob;
     ...
     * @see #unsetField
     */
    defaultField(field: string): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob;
     ...
     * @see #removeField
     */
    unsetField(field: string): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob;
     ...
     * @see #unsetField
     */
    removeField(field: string): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob;

    mergeJson(json: any): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob;
     ...
     */
    sumObj(other: Obj, deep?: boolean): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob;
     ...
     */
    singletonArray(): Array_Type<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob;
     ...
     * @see #fromString
     */
    static make(s: string): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob;
     ...
     */
    static cachedEmptyInst(): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob;
     ...
     */
    start(options?: ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobOptions): BatchJobStatus | null;
     ...
     */
    cleanup(options?: ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobOptions): void;
    ...
    cancelJob(removeResults?: boolean, force?: boolean): JobBase<BatchJobRun, BatchJobStatus, ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobOptions> | null;

    failJob(run: JobRun<BatchJobStatusBase>): JobBase<BatchJobRun, BatchJobStatus, ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobOptions> | null;
    ...
    validateStart(options?: ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobOptions): void;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob>> | null;
     ...
     */
    get(include?: string): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob | null;
     ...
     */
    getMissing(spec: GetMissingSpec): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob;
     ...
     * @see #toString
     */
    static fromString(s: string): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob | null;
     ...
     */
    create(spec?: UpsertSpec): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob | null;
     ...
     */
    static createBatch(objs: Array_Type<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob> | null;
     ...
     */
    update(srcObj?: ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob, spec?: UpsertSpec): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob | null;
     ...
     */
    upsert(srcObj?: ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob, spec?: UpsertSpec): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob | null;
     ...
     */
    merge(spec?: MergeSpec): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob | null;
     ...
     */
    static updateBatch(objs: Array_Type<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob>, srcObjs?: Array_Type<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob> | null>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob>, srcObjs?: Array_Type<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob> | null>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob>, spec?: TouchSpec): ObjList<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob>, spec?: MergeSpec): ObjList<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob> | null;
     ...
     */
    static mergeAll(mergeObj: ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob | null;
     ...
     */
    static beforeCreate(objs: Array_Type<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob>): ObjList<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob>): ObjList<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob>): ObjList<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob>;
     ...
     */
    static afterCreate(objs: Array_Type<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob | null;
     ...
     */
    withoutIdentity(): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob>, callback?: λFunction<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob | null, ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob | null>): ObjList<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob>, callback?: λFunction<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob | null, ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob | null>): Array_Type<ObjError> | null;
     ...
     */
    static doStart(job?: ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob, options?: ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobOptions): void;
     ...
     */
    static processBatch(batch?: ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobBatch, job?: ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob, options?: ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobOptions): void;
     ...
     */
    static allComplete(job: ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob, options?: ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobOptions): string | null;
     ...
     *           Options the job was run with.
     */
    static failed(job: ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob, status: BatchJobStatus, options?: ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobOptions): void;
     ...
     *        Batch to schedule.
     */
    scheduleBatch(batch?: ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobBatch): void;
     ...
     *        Batches to schedule.
     */
    scheduleBatches(batches?: Array_Type<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobBatch>): void;
     ...
     */
    static scheduleObjBatch(job?: ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob, objBatch?: ObjBatch, logPrefix?: string): number | null;
