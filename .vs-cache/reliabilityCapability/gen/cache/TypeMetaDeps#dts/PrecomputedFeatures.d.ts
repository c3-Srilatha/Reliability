// TypeScript definitions for the C3 type PrecomputedFeatures
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of PrecomputedFeatures
 */
declare interface IPrecomputedFeatures {
   ...
   */
  blacklistedFields?: Array_Type<string> | Array<string>;

  /**
   * A map of feature id to feature data. Stores the precomputed features with the {@link #precomputedFields} filled in.
   */
  featureIdToPrecomputedFeature?: Map_Type<string, FeatureFetchBase> | {[key: string]: IFeatureFetchBase};
 ...
 * **Do not store any data here that you are unwilling to recompute as it could be removed**
 *
 * @remarks this represents a made instance of PrecomputedFeatures
 */
declare class PrecomputedFeatures extends Obj  {
   ...
   */
  readonly id: string;
  withId(id: string): PrecomputedFeatures;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): PrecomputedFeatures;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): PrecomputedFeatures;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): PrecomputedFeatures;
  ...
  withVersion(version: number | null): PrecomputedFeatures;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): PrecomputedFeatures;

  /**
   * @inheritdoc
   */
  readonly facilityFilterPaths?: Array_Type<string>;
  withFacilityFilterPaths(facilityFilterPaths: Array_Type<string> | Array<string> | null): PrecomputedFeatures;

  /**
   * The fields of {@link FeatureFetchBase} that will never be precomputed. These fields can change
   * because of updates to entities other than the one that this {@link PrecomputedFeatures} is storing features for.
   */
  readonly blacklistedFields?: Array_Type<string>;
  withBlacklistedFields(blacklistedFields: Array_Type<string> | Array<string> | null): PrecomputedFeatures;

  /**
   * A map of feature id to feature data. Stores the precomputed features with the {@link #precomputedFields} filled in.
   */
  readonly featureIdToPrecomputedFeature?: Map_Type<string, FeatureFetchBase>;
  withFeatureIdToPrecomputedFeature(featureIdToPrecomputedFeature: Map_Type<string, FeatureFetchBase> | {[key: string]: IFeatureFetchBase} | null): PrecomputedFeatures;
   ...
   * or if the {@link #featureIdToPrecomputedFeature} is sufficient.
   */
  readonly precomputedFields?: Set_Type<string>;
  withPrecomputedFields(precomputedFields: Set_Type<string> | Array<string> | null): PrecomputedFeatures;

  /**
   * The {@link ReliabilityAssetAlert} that this {@link PrecomputedFeatures} is storing features for.
   */
  readonly alert?: ReliabilityAssetAlert;
  withAlert(alert: IReliabilityAssetAlert | null): PrecomputedFeatures;
   ...
   * @see #toJson
   */
  static fromJson(json: any): PrecomputedFeatures | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): PrecomputedFeatures | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): PrecomputedFeatures | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): PrecomputedFeatures | null;
   ...
   */
  replaceType(old: Type, new_: Type): PrecomputedFeatures;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): PrecomputedFeatures;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): PrecomputedFeatures;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<PrecomputedFeatures>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<PrecomputedFeatures>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): PrecomputedFeatures;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): PrecomputedFeatures;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): PrecomputedFeatures;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): PrecomputedFeatures;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): PrecomputedFeatures;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): PrecomputedFeatures;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): PrecomputedFeatures;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): PrecomputedFeatures;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): PrecomputedFeatures;
   ...
   * @see #removeField
   */
  withoutField(field: string): PrecomputedFeatures;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): PrecomputedFeatures;
   ...
   */
  withoutFields(fields: Array_Type<string>): PrecomputedFeatures;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): PrecomputedFeatures;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): PrecomputedFeatures;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): PrecomputedFeatures;
   ...
   * @see #unsetField
   */
  defaultField(field: string): PrecomputedFeatures;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): PrecomputedFeatures;
   ...
   * @see #removeField
   */
  unsetField(field: string): PrecomputedFeatures;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): PrecomputedFeatures;
   ...
   * @see #unsetField
   */
  removeField(field: string): PrecomputedFeatures;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): PrecomputedFeatures;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): PrecomputedFeatures;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): PrecomputedFeatures;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): PrecomputedFeatures;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): PrecomputedFeatures;

  mergeJson(json: any): PrecomputedFeatures;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): PrecomputedFeatures;
   ...
   */
  sumObj(other: Obj, deep?: boolean): PrecomputedFeatures;
   ...
   */
  singletonArray(): Array_Type<PrecomputedFeatures>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<PrecomputedFeatures> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<PrecomputedFeatures> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<PrecomputedFeatures>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<PrecomputedFeatures> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, PrecomputedFeatures> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, PrecomputedFeatures> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<PrecomputedFeatures>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<PrecomputedFeatures>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): PrecomputedFeatures;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): PrecomputedFeatures;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): PrecomputedFeatures;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): PrecomputedFeatures;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): PrecomputedFeatures;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): PrecomputedFeatures;
   ...
   * @see #fromString
   */
  static make(s: string): PrecomputedFeatures | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): PrecomputedFeatures;
   ...
   */
  static cachedEmptyInst(): PrecomputedFeatures;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<PrecomputedFeatures> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): PrecomputedFeatures;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<PrecomputedFeatures>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<PrecomputedFeatures>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<PrecomputedFeatures> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<PrecomputedFeatures>> | null;
   ...
   */
  get(include?: string): PrecomputedFeatures | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): PrecomputedFeatures | null;
   ...
   */
  getMissing(spec: GetMissingSpec): PrecomputedFeatures;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): PrecomputedFeatures | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): PrecomputedFeatures;
   ...
   * @see #toString
   */
  static fromString(s: string): PrecomputedFeatures | null;
   ...
   */
  create(spec?: UpsertSpec): PrecomputedFeatures | null;
   ...
   */
  static createBatch(objs: Array_Type<PrecomputedFeatures>, spec?: UpsertSpec): ObjList<PrecomputedFeatures> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<PrecomputedFeatures>, spec?: CreateBatchObjStreamSpec): ObjList<PrecomputedFeatures> | null;
   ...
   */
  update(srcObj?: PrecomputedFeatures, spec?: UpsertSpec): PrecomputedFeatures | null;
   ...
   */
  upsert(srcObj?: PrecomputedFeatures, spec?: UpsertSpec): PrecomputedFeatures | null;
   ...
   */
  merge(spec?: MergeSpec): PrecomputedFeatures | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): PrecomputedFeatures | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): PrecomputedFeatures | null;
   ...
   */
  static updateBatch(objs: Array_Type<PrecomputedFeatures>, srcObjs?: Array_Type<PrecomputedFeatures>, spec?: UpsertSpec): ObjList<PrecomputedFeatures> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<PrecomputedFeatures> | null>, spec?: UpsertSpec): ObjList<PrecomputedFeatures> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<PrecomputedFeatures>, srcObjs?: Array_Type<PrecomputedFeatures>, spec?: UpsertSpec): ObjList<PrecomputedFeatures> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<PrecomputedFeatures> | null>, spec?: UpsertSpec): ObjList<PrecomputedFeatures> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<PrecomputedFeatures>, spec?: TouchSpec): ObjList<PrecomputedFeatures> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<PrecomputedFeatures>, spec?: MergeSpec): ObjList<PrecomputedFeatures> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<PrecomputedFeatures>, mergeInclude: string, spec?: MergeSpec): ObjList<PrecomputedFeatures> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<PrecomputedFeatures> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<PrecomputedFeatures> | null;
   ...
   */
  static mergeAll(mergeObj: PrecomputedFeatures, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: PrecomputedFeatures, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<PrecomputedFeatures>, spec?: UpsertSpec): ObjList<PrecomputedFeatures> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<PrecomputedFeatures>, spec?: UpsertSpec): ObjList<PrecomputedFeatures> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): PrecomputedFeatures | null;
   ...
   */
  static beforeCreate(objs: Array_Type<PrecomputedFeatures>): ObjList<PrecomputedFeatures>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<PrecomputedFeatures>): ObjList<PrecomputedFeatures>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<PrecomputedFeatures>): ObjList<PrecomputedFeatures>;
   ...
   */
  static afterCreate(objs: Array_Type<PrecomputedFeatures>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<PrecomputedFeatures>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<PrecomputedFeatures>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<PrecomputedFeatures>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<PrecomputedFeatures>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): PrecomputedFeatures | null;
   ...
   */
  withoutIdentity(): PrecomputedFeatures | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<PrecomputedFeatures>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: PrecomputedFeatures, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<PrecomputedFeatures>, callback?: λFunction<PrecomputedFeatures | null, PrecomputedFeatures | null>): ObjList<PrecomputedFeatures>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<PrecomputedFeatures>, callback?: λFunction<PrecomputedFeatures | null, PrecomputedFeatures | null>): Array_Type<ObjError> | null;
   ...
   */
  updatePrecomputedFeaturesAsync(features: Array_Type<FeatureFetchBase>, retrySpec?: RetrySpec): AsyncAction | null;
   ...
   *           Controls the retrying behavior of the update. Retrying will happen by default.
   */
  updatePrecomputedFeaturesWithRetry(features: Array_Type<FeatureFetchBase>, retrySpec?: RetrySpec): void;
   ...
   *           The features to update this {@link PrecomputedFeatures} with.
   */
  updatePrecomputedFeatures(features: Array_Type<FeatureFetchBase>): void;
   ...
   */
  getPrecomputedFeatures(): Array_Type<FeatureFetchBase> | null;
   ...
   */
  mergeFeaturesWithPrecomputedFeatures(spec?: MergeFeaturesWithPrecomputedFeaturesSpec): Map_Type<string, FeatureFetchBase> | null;
   ...
   */
  fieldsMissing(fields?: Set_Type<string>): Array_Type<string> | null;
   ...
   */
  static clearPrecomputedFeatures(filter?: Filter): number;
}
