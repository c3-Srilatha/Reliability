// TypeScript definitions for the C3 type ReliabilityDataPreparationUiBaseSettings
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityDataPreparationUiBaseSettings
 */
declare interface IReliabilityDataPreparationUiBaseSettings {
 ...
 * for a specific asset.
 *
 * @remarks this represents a made instance of ReliabilityDataPreparationUiBaseSettings
 */
declare class ReliabilityDataPreparationUiBaseSettings extends Obj  {
  ...
  withNonOperationalMasks(nonOperationalMasks: Array_Type<ReliabilityDataPreparationRuleMaskSpec> | Array<IReliabilityDataPreparationRuleMaskSpec> | null): ReliabilityDataPreparationUiBaseSettings;
  ...
  withPreNonOperationalMaskPeriod(preNonOperationalMaskPeriod: IPeriod | null): ReliabilityDataPreparationUiBaseSettings;
  ...
  withPostNonOperationalTrainingMaskPeriod(postNonOperationalTrainingMaskPeriod: IPeriod | null): ReliabilityDataPreparationUiBaseSettings;
  ...
  withPostNonOperationalInferenceMaskPeriod(postNonOperationalInferenceMaskPeriod: IPeriod | null): ReliabilityDataPreparationUiBaseSettings;

  /**
   * A {@link Period} of time before each [event](ReliabilityAssetEvent) to exclude {@link Sensor} data for training.
   */
  readonly preEventMaskPeriod: Period;
  withPreEventMaskPeriod(preEventMaskPeriod: IPeriod): ReliabilityDataPreparationUiBaseSettings;

  /**
   * A {@link Period} of time after each [event](ReliabilityAssetEvent) to exclude {@link Sensor} data for training and inference.
   */
  readonly postEventMaskPeriod: Period;
  withPostEventMaskPeriod(postEventMaskPeriod: IPeriod): ReliabilityDataPreparationUiBaseSettings;

  /**
   * {@link TimeRange}s to exclude {@Sensor} data from training data.
   */
  readonly dateRangeMaskTimeRanges?: Array_Type<TimeRange>;
  withDateRangeMaskTimeRanges(dateRangeMaskTimeRanges: Array_Type<TimeRange> | Array<ITimeRange> | null): ReliabilityDataPreparationUiBaseSettings;
  ...
  withTrainingRuleMasks(trainingRuleMasks: Array_Type<ReliabilityDataPreparationRuleMaskSpec> | Array<IReliabilityDataPreparationRuleMaskSpec> | null): ReliabilityDataPreparationUiBaseSettings;
  ...
  withInferenceRuleMasks(inferenceRuleMasks: Array_Type<ReliabilityDataPreparationRuleMaskSpec> | Array<IReliabilityDataPreparationRuleMaskSpec> | null): ReliabilityDataPreparationUiBaseSettings;

  /**
   * String of rules indicating the time period when {@link ReliabilityAsset} was non-operational
   */
  readonly nonOperationalMasksExpression?: string;
  withNonOperationalMasksExpression(nonOperationalMasksExpression: string | null): ReliabilityDataPreparationUiBaseSettings;

  /**
   * String of rules indicating the time periods to exclude {@link Sensor} data from training data.
   */
  readonly trainingRuleMasksExpression?: string;
  withTrainingRuleMasksExpression(trainingRuleMasksExpression: string | null): ReliabilityDataPreparationUiBaseSettings;

  /**
   * String of rules indicating the time periods to exclude {@link Sensor} data from inference data.
   */
  readonly inferenceRuleMasksExpression?: string;
  withInferenceRuleMasksExpression(inferenceRuleMasksExpression: string | null): ReliabilityDataPreparationUiBaseSettings;

  /**
   * The flatline sensor data threshold to use for the Data Preparation Job
   */
  readonly flatlineThreshold?: number;
  withFlatlineThreshold(flatlineThreshold: number | null): ReliabilityDataPreparationUiBaseSettings;

  /**
   * The missing sensor data threshold to use for the Data Preparation Job
   */
  readonly missingDataThreshold?: number;
  withMissingDataThreshold(missingDataThreshold: number | null): ReliabilityDataPreparationUiBaseSettings;

  /**
   * Start {@link datetime} of window for {@link Sensor} data utilized in the dataset.
   */
  readonly windowStart: DateTime;
  withWindowStart(windowStart: DateTime | Date | string): ReliabilityDataPreparationUiBaseSettings;

  /**
   * End {@link datetime} of window for {@link Sensor} data utilized in the dataset.
   */
  readonly windowEnd: DateTime;
  withWindowEnd(windowEnd: DateTime | Date | string): ReliabilityDataPreparationUiBaseSettings;

  /**
   * The percentage of the dataset used for training.
   */
  readonly trainingPercentage: number;
  withTrainingPercentage(trainingPercentage: number): ReliabilityDataPreparationUiBaseSettings;

  /**
   * Start Date of the dataset used for training.
   */
  readonly trainStart?: DateTime;
  withTrainStart(trainStart: DateTime | Date | string | null): ReliabilityDataPreparationUiBaseSettings;

  /**
   * End Date of the dataset used for training.
   */
  readonly trainEnd?: DateTime;
  withTrainEnd(trainEnd: DateTime | Date | string | null): ReliabilityDataPreparationUiBaseSettings;

  /**
   * Start Date of the dataset used for Validating.
   */
  readonly validStart?: DateTime;
  withValidStart(validStart: DateTime | Date | string | null): ReliabilityDataPreparationUiBaseSettings;

  /**
   * End Date of the dataset used for Validating.
   */
  readonly validEnd?: DateTime;
  withValidEnd(validEnd: DateTime | Date | string | null): ReliabilityDataPreparationUiBaseSettings;

  /**
   * The subset of the dataset to use for training.
   */
  readonly trainingSubset: string;
  withTrainingSubset(trainingSubset: string): ReliabilityDataPreparationUiBaseSettings;

  /**
   * The data {@link Interval} to analyze the data of the {@link Sensor}.
   */
  readonly interval: string;
  withInterval(interval: string): ReliabilityDataPreparationUiBaseSettings;
  ...
  withNumAssets(numAssets: number | null): ReliabilityDataPreparationUiBaseSettings;
  ...
  withTargetAssets(targetAssets: Array_Type<ReliabilityAsset> | Array<IReliabilityAsset> | null): ReliabilityDataPreparationUiBaseSettings;
  ...
  withIncludeSensors(includeSensors: Array_Type<Sensor> | Array<ISensor> | null): ReliabilityDataPreparationUiBaseSettings;
  ...
  withExcludeSensors(excludeSensors: Array_Type<Sensor> | Array<ISensor> | null): ReliabilityDataPreparationUiBaseSettings;

  /**
   * Variance value used to filter {@link SensorDataReport}
   */
  readonly variance?: number;
  withVariance(variance: number | null): ReliabilityDataPreparationUiBaseSettings;

  /**
   * Stores the id of the {@link MlProject} that the user selected to create the new dataset
   */
  readonly project?: ReliabilityMl.Project;
  withProject(project: IReliabilityMl.Project | null): ReliabilityDataPreparationUiBaseSettings;

  /**
   * The date time ranges selected by the user for training
   */
  readonly trainingDatasetTimeRanges?: Array_Type<TimeRange>;
  withTrainingDatasetTimeRanges(trainingDatasetTimeRanges: Array_Type<TimeRange> | Array<ITimeRange> | null): ReliabilityDataPreparationUiBaseSettings;

  /**
   * The date time ranges selected by the user for validation
   */
  readonly validateDatasetTimeRanges?: Array_Type<TimeRange>;
  withValidateDatasetTimeRanges(validateDatasetTimeRanges: Array_Type<TimeRange> | Array<ITimeRange> | null): ReliabilityDataPreparationUiBaseSettings;

  /**
   * The selected split type, can be either by percentage or by time ranges.
   */
  readonly splitByPercentage?: boolean;
  withSplitByPercentage(splitByPercentage: boolean): ReliabilityDataPreparationUiBaseSettings;
  ...
  withExtraTimeRangeMasks(extraTimeRangeMasks: Array_Type<TimeRange> | Array<ITimeRange> | null): ReliabilityDataPreparationUiBaseSettings;
   ...
   * @see #toJson
   */
  static fromJson(json: any): ReliabilityDataPreparationUiBaseSettings | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): ReliabilityDataPreparationUiBaseSettings | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): ReliabilityDataPreparationUiBaseSettings | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): ReliabilityDataPreparationUiBaseSettings | null;
   ...
   */
  replaceType(old: Type, new_: Type): ReliabilityDataPreparationUiBaseSettings;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityDataPreparationUiBaseSettings;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityDataPreparationUiBaseSettings;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityDataPreparationUiBaseSettings>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityDataPreparationUiBaseSettings>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityDataPreparationUiBaseSettings;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityDataPreparationUiBaseSettings;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityDataPreparationUiBaseSettings;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ReliabilityDataPreparationUiBaseSettings;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ReliabilityDataPreparationUiBaseSettings;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityDataPreparationUiBaseSettings;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityDataPreparationUiBaseSettings;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityDataPreparationUiBaseSettings;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ReliabilityDataPreparationUiBaseSettings;
   ...
   * @see #removeField
   */
  withoutField(field: string): ReliabilityDataPreparationUiBaseSettings;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): ReliabilityDataPreparationUiBaseSettings;
   ...
   */
  withoutFields(fields: Array_Type<string>): ReliabilityDataPreparationUiBaseSettings;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityDataPreparationUiBaseSettings;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ReliabilityDataPreparationUiBaseSettings;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityDataPreparationUiBaseSettings;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ReliabilityDataPreparationUiBaseSettings;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ReliabilityDataPreparationUiBaseSettings;
   ...
   * @see #removeField
   */
  unsetField(field: string): ReliabilityDataPreparationUiBaseSettings;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ReliabilityDataPreparationUiBaseSettings;
   ...
   * @see #unsetField
   */
  removeField(field: string): ReliabilityDataPreparationUiBaseSettings;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ReliabilityDataPreparationUiBaseSettings;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityDataPreparationUiBaseSettings;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityDataPreparationUiBaseSettings;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityDataPreparationUiBaseSettings;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityDataPreparationUiBaseSettings;

  mergeJson(json: any): ReliabilityDataPreparationUiBaseSettings;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityDataPreparationUiBaseSettings;
   ...
   */
  sumObj(other: Obj, deep?: boolean): ReliabilityDataPreparationUiBaseSettings;
   ...
   */
  singletonArray(): Array_Type<ReliabilityDataPreparationUiBaseSettings>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityDataPreparationUiBaseSettings> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ReliabilityDataPreparationUiBaseSettings> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<ReliabilityDataPreparationUiBaseSettings>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ReliabilityDataPreparationUiBaseSettings> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, ReliabilityDataPreparationUiBaseSettings> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityDataPreparationUiBaseSettings> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ReliabilityDataPreparationUiBaseSettings>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ReliabilityDataPreparationUiBaseSettings>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityDataPreparationUiBaseSettings;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityDataPreparationUiBaseSettings;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityDataPreparationUiBaseSettings;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ReliabilityDataPreparationUiBaseSettings;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityDataPreparationUiBaseSettings;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ReliabilityDataPreparationUiBaseSettings;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityDataPreparationUiBaseSettings;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): ReliabilityDataPreparationUiBaseSettings;
   ...
   */
  static cachedEmptyInst(): ReliabilityDataPreparationUiBaseSettings;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityDataPreparationUiBaseSettings> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): ReliabilityDataPreparationUiBaseSettings;
