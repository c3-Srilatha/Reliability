// TypeScript definitions for the C3 type SurvivalAnalysisResult

/**
 * Represents the result of a survival analysis prediction, extending {@link TimeToEventForecastResult}.
 * This type stores predicted survival durations and confidence bounds for an event occurring.
 *
 * @remarks this represents a value passed to a method that expects an instance of SurvivalAnalysisResult
 */
declare interface ISurvivalAnalysisResult {
  ...
  /**
   * Predicted number of days until the event, as of time of generation.
   */
  predictedDaysUntilEvent: number;

  /**
   * Lower bound on the predicted number of days until the event, as of time of generation.
   */
  predictedDaysUntilEventLowerBound?: number;

  /**
   * Upper bound on the predicted number of days until the event, as of time of generation.
   */
  predictedDaysUntilEventUpperBound?: number;
}
 ...
 * This type stores predicted survival durations and confidence bounds for an event occurring.
 *
 * @remarks this represents a made instance of SurvivalAnalysisResult
 */
declare class SurvivalAnalysisResult extends Obj  {
  ...
  withTypeIdent(typeIdent: string | null): SurvivalAnalysisResult;
   ...
   */
  readonly id: string;
  withId(id: string): SurvivalAnalysisResult;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): SurvivalAnalysisResult;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): SurvivalAnalysisResult;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): SurvivalAnalysisResult;
  ...
  withVersion(version: number | null): SurvivalAnalysisResult;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): SurvivalAnalysisResult;

  /**
   * Description of this prediction, corresponds to description from ML pipeline directly
   */
  readonly description?: string;
  withDescription(description: string | null): SurvivalAnalysisResult;

  /**
   * When this forecast was generated
   */
  readonly timestamp?: DateTime;
  withTimestamp(timestamp: DateTime | Date | string | null): SurvivalAnalysisResult;

  /**
   * Equipment-event category combination that this forecast is for
   */
  readonly physicalAssetEventCategoryRelation: EquipmentEventCategoryRelation;
  withPhysicalAssetEventCategoryRelation(physicalAssetEventCategoryRelation: IEquipmentEventCategoryRelation): SurvivalAnalysisResult;

  /**
   * The features which contributed to this forecast
   */
  readonly featureRelations?: Array_Type<TimeToEventForecastResultFeatureRelation>;
  withFeatureRelations(featureRelations: Array_Type<TimeToEventForecastResultFeatureRelation> | Array<ITimeToEventForecastResultFeatureRelation> | null): SurvivalAnalysisResult;

  /**
   * Predicted number of days until the event, as of time of generation.
   */
  readonly predictedDaysUntilEvent: number;
  withPredictedDaysUntilEvent(predictedDaysUntilEvent: number): SurvivalAnalysisResult;

  /**
   * Lower bound on the predicted number of days until the event, as of time of generation.
   */
  readonly predictedDaysUntilEventLowerBound?: number;
  withPredictedDaysUntilEventLowerBound(predictedDaysUntilEventLowerBound: number | null): SurvivalAnalysisResult;

  /**
   * Upper bound on the predicted number of days until the event, as of time of generation.
   */
  readonly predictedDaysUntilEventUpperBound?: number;
  withPredictedDaysUntilEventUpperBound(predictedDaysUntilEventUpperBound: number | null): SurvivalAnalysisResult;
   ...
   * @see #toJson
   */
  static fromJson(json: any): SurvivalAnalysisResult | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): SurvivalAnalysisResult | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): SurvivalAnalysisResult | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): SurvivalAnalysisResult | null;
   ...
   */
  replaceType(old: Type, new_: Type): SurvivalAnalysisResult;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): SurvivalAnalysisResult;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): SurvivalAnalysisResult;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<SurvivalAnalysisResult>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<SurvivalAnalysisResult>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): SurvivalAnalysisResult;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SurvivalAnalysisResult;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SurvivalAnalysisResult;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): SurvivalAnalysisResult;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): SurvivalAnalysisResult;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): SurvivalAnalysisResult;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): SurvivalAnalysisResult;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): SurvivalAnalysisResult;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): SurvivalAnalysisResult;
   ...
   * @see #removeField
   */
  withoutField(field: string): SurvivalAnalysisResult;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): SurvivalAnalysisResult;
   ...
   */
  withoutFields(fields: Array_Type<string>): SurvivalAnalysisResult;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): SurvivalAnalysisResult;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): SurvivalAnalysisResult;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): SurvivalAnalysisResult;
   ...
   * @see #unsetField
   */
  defaultField(field: string): SurvivalAnalysisResult;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): SurvivalAnalysisResult;
   ...
   * @see #removeField
   */
  unsetField(field: string): SurvivalAnalysisResult;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): SurvivalAnalysisResult;
   ...
   * @see #unsetField
   */
  removeField(field: string): SurvivalAnalysisResult;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): SurvivalAnalysisResult;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): SurvivalAnalysisResult;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): SurvivalAnalysisResult;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): SurvivalAnalysisResult;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): SurvivalAnalysisResult;

  mergeJson(json: any): SurvivalAnalysisResult;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): SurvivalAnalysisResult;
   ...
   */
  sumObj(other: Obj, deep?: boolean): SurvivalAnalysisResult;
   ...
   */
  singletonArray(): Array_Type<SurvivalAnalysisResult>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<SurvivalAnalysisResult> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<SurvivalAnalysisResult> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<SurvivalAnalysisResult>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<SurvivalAnalysisResult> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, SurvivalAnalysisResult> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, SurvivalAnalysisResult> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<SurvivalAnalysisResult>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<SurvivalAnalysisResult>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): SurvivalAnalysisResult;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): SurvivalAnalysisResult;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): SurvivalAnalysisResult;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): SurvivalAnalysisResult;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): SurvivalAnalysisResult;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): SurvivalAnalysisResult;
   ...
   * @see #fromString
   */
  static make(s: string): SurvivalAnalysisResult | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): SurvivalAnalysisResult;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): SurvivalAnalysisResult;
   ...
   */
  static cachedEmptyInst(): SurvivalAnalysisResult;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<SurvivalAnalysisResult> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): SurvivalAnalysisResult;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<SurvivalAnalysisResult>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<SurvivalAnalysisResult>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<SurvivalAnalysisResult> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<SurvivalAnalysisResult>> | null;
   ...
   */
  get(include?: string): SurvivalAnalysisResult | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): SurvivalAnalysisResult | null;
   ...
   */
  getMissing(spec: GetMissingSpec): SurvivalAnalysisResult;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): SurvivalAnalysisResult | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): SurvivalAnalysisResult;
   ...
   * @see #toString
   */
  static fromString(s: string): SurvivalAnalysisResult | null;
   ...
   */
  create(spec?: UpsertSpec): SurvivalAnalysisResult | null;
   ...
   */
  static createBatch(objs: Array_Type<SurvivalAnalysisResult>, spec?: UpsertSpec): ObjList<SurvivalAnalysisResult> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<SurvivalAnalysisResult>, spec?: CreateBatchObjStreamSpec): ObjList<SurvivalAnalysisResult> | null;
   ...
   */
  update(srcObj?: SurvivalAnalysisResult, spec?: UpsertSpec): SurvivalAnalysisResult | null;
   ...
   */
  upsert(srcObj?: SurvivalAnalysisResult, spec?: UpsertSpec): SurvivalAnalysisResult | null;
   ...
   */
  merge(spec?: MergeSpec): SurvivalAnalysisResult | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): SurvivalAnalysisResult | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): SurvivalAnalysisResult | null;
   ...
   */
  static updateBatch(objs: Array_Type<SurvivalAnalysisResult>, srcObjs?: Array_Type<SurvivalAnalysisResult>, spec?: UpsertSpec): ObjList<SurvivalAnalysisResult> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<SurvivalAnalysisResult> | null>, spec?: UpsertSpec): ObjList<SurvivalAnalysisResult> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<SurvivalAnalysisResult>, srcObjs?: Array_Type<SurvivalAnalysisResult>, spec?: UpsertSpec): ObjList<SurvivalAnalysisResult> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<SurvivalAnalysisResult> | null>, spec?: UpsertSpec): ObjList<SurvivalAnalysisResult> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<SurvivalAnalysisResult>, spec?: TouchSpec): ObjList<SurvivalAnalysisResult> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<SurvivalAnalysisResult>, spec?: MergeSpec): ObjList<SurvivalAnalysisResult> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<SurvivalAnalysisResult>, mergeInclude: string, spec?: MergeSpec): ObjList<SurvivalAnalysisResult> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<SurvivalAnalysisResult> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<SurvivalAnalysisResult> | null;
   ...
   */
  static mergeAll(mergeObj: SurvivalAnalysisResult, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: SurvivalAnalysisResult, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<SurvivalAnalysisResult>, spec?: UpsertSpec): ObjList<SurvivalAnalysisResult> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<SurvivalAnalysisResult>, spec?: UpsertSpec): ObjList<SurvivalAnalysisResult> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): SurvivalAnalysisResult | null;
   ...
   */
  static beforeCreate(objs: Array_Type<SurvivalAnalysisResult>): ObjList<SurvivalAnalysisResult>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<SurvivalAnalysisResult>): ObjList<SurvivalAnalysisResult>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<SurvivalAnalysisResult>): ObjList<SurvivalAnalysisResult>;
   ...
   */
  static afterCreate(objs: Array_Type<SurvivalAnalysisResult>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<SurvivalAnalysisResult>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<SurvivalAnalysisResult>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<SurvivalAnalysisResult>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<SurvivalAnalysisResult>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): SurvivalAnalysisResult | null;
   ...
   */
  withoutIdentity(): SurvivalAnalysisResult | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<SurvivalAnalysisResult>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: SurvivalAnalysisResult, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<SurvivalAnalysisResult>, callback?: λFunction<SurvivalAnalysisResult | null, SurvivalAnalysisResult | null>): ObjList<SurvivalAnalysisResult>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<SurvivalAnalysisResult>, callback?: λFunction<SurvivalAnalysisResult | null, SurvivalAnalysisResult | null>): Array_Type<ObjError> | null;
  ...
  /**
   * Function to create TimeToEventPrediction with predicted dates from SurvivalAnalysisResult
   * Returns a TimeToEventPrediction obj
   * @return A {@link TimeToEventPrediction} object with predicted dates.
   */
  createTimetoEventPrediction(): TimeToEventPrediction | null;

  /**
   * Function to return a TimeToEventPrediction with predicted dates from SurvivalAnalysisResult
   * This method does not upsert TimeToEventPrediction
   * @return A {@link TimeToEventPrediction} object with predicted dates.
   */
  getTimetoEventPredictionFromSAR(): TimeToEventPrediction | null;

  /**
   * Function to create batch of TimeToEventPredictions with predicted dates from SurvivalAnalysisResult
   * @param survivalAnalysisResults
   *           Array of survival analysis results to create predictions from.
   * @return An array of newly created {@link TimeToEventPrediction} objects.
   */
  static createBatchTimeToEventPredictions(survivalAnalysisResults?: Array_Type<SurvivalAnalysisResult>): Array_Type<TimeToEventPrediction> | null;
}
