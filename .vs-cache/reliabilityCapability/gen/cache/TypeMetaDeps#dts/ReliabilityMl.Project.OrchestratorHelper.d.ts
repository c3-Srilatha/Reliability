// TypeScript definitions for the C3 type ReliabilityMl.Project.OrchestratorHelper
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityMl.Project.OrchestratorHelper
 */
declare namespace ReliabilityMl.Project {
  export interface IOrchestratorHelper {
 ...
 */
declare namespace ReliabilityMl.Project {
  export class OrchestratorHelper extends Obj  {
    ...
    withOverrideDataPrepSettingsToSpec(overrideDataPrepSettingsToSpec: ILambda<function(settings?: BulkDataPreparationUiSettings): ReliabilityMlDatasetPreparationSpec | null> | null): ReliabilityMl.Project.OrchestratorHelper;
    ...
    withOverrideModelConfigSettingsToSpec(overrideModelConfigSettingsToSpec: ILambda<function(settings?: BulkModelConfigUiSettings): ReliabilityOrchestrator.TrainingJobSpec | null> | null): ReliabilityMl.Project.OrchestratorHelper;
    ...
    withOverrideDataPrepSettingsToJobRun(overrideDataPrepSettingsToJobRun: ILambda<function(settings?: BulkDataPreparationUiSettings): MlOperationRun<ReliabilityOrchestrator.DatasetPreparationJobRun> | null> | null): ReliabilityMl.Project.OrchestratorHelper;
    ...
    withOverrideStartPostTrainingJob(overrideStartPostTrainingJob: ILambda<function(settings?: BulkModelConfigUiSettings, trainingRun?: ReliabilityOrchestrator.TrainingJobRun, modelConfigRun?: ModelConfigRun): MlOperationRun<ReliabilityOrchestrator.PostTrainingJobRun> | null> | null): ReliabilityMl.Project.OrchestratorHelper;

    /**
     * Lambda to override {@link #modelSetupSettingsToWorkflowRun}.
     */
    readonly overrideModelSetupSettingsToWorkflowRun?: Lambda<function(settings?: BulkModelSetupUiSettings): Workflow.Run | null>;
    withOverrideModelSetupSettingsToWorkflowRun(overrideModelSetupSettingsToWorkflowRun: ILambda<function(settings?: BulkModelSetupUiSettings): Workflow.Run | null> | null): ReliabilityMl.Project.OrchestratorHelper;
     ...
     * @see #toJson
     */
    static fromJson(json: any): ReliabilityMl.Project.OrchestratorHelper | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): ReliabilityMl.Project.OrchestratorHelper | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): ReliabilityMl.Project.OrchestratorHelper | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): ReliabilityMl.Project.OrchestratorHelper | null;
     ...
     */
    replaceType(old: Type, new_: Type): ReliabilityMl.Project.OrchestratorHelper;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityMl.Project.OrchestratorHelper;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityMl.Project.OrchestratorHelper;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityMl.Project.OrchestratorHelper>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityMl.Project.OrchestratorHelper>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityMl.Project.OrchestratorHelper;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityMl.Project.OrchestratorHelper;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityMl.Project.OrchestratorHelper;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): ReliabilityMl.Project.OrchestratorHelper;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): ReliabilityMl.Project.OrchestratorHelper;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityMl.Project.OrchestratorHelper;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityMl.Project.OrchestratorHelper;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityMl.Project.OrchestratorHelper;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): ReliabilityMl.Project.OrchestratorHelper;
     ...
     * @see #removeField
     */
    withoutField(field: string): ReliabilityMl.Project.OrchestratorHelper;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): ReliabilityMl.Project.OrchestratorHelper;
     ...
     */
    withoutFields(fields: Array_Type<string>): ReliabilityMl.Project.OrchestratorHelper;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityMl.Project.OrchestratorHelper;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): ReliabilityMl.Project.OrchestratorHelper;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityMl.Project.OrchestratorHelper;
     ...
     * @see #unsetField
     */
    defaultField(field: string): ReliabilityMl.Project.OrchestratorHelper;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): ReliabilityMl.Project.OrchestratorHelper;
     ...
     * @see #removeField
     */
    unsetField(field: string): ReliabilityMl.Project.OrchestratorHelper;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): ReliabilityMl.Project.OrchestratorHelper;
     ...
     * @see #unsetField
     */
    removeField(field: string): ReliabilityMl.Project.OrchestratorHelper;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): ReliabilityMl.Project.OrchestratorHelper;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityMl.Project.OrchestratorHelper;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityMl.Project.OrchestratorHelper;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityMl.Project.OrchestratorHelper;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityMl.Project.OrchestratorHelper;

    mergeJson(json: any): ReliabilityMl.Project.OrchestratorHelper;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityMl.Project.OrchestratorHelper;
     ...
     */
    sumObj(other: Obj, deep?: boolean): ReliabilityMl.Project.OrchestratorHelper;
     ...
     */
    singletonArray(): Array_Type<ReliabilityMl.Project.OrchestratorHelper>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityMl.Project.OrchestratorHelper> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<ReliabilityMl.Project.OrchestratorHelper> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<ReliabilityMl.Project.OrchestratorHelper>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<ReliabilityMl.Project.OrchestratorHelper> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, ReliabilityMl.Project.OrchestratorHelper> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityMl.Project.OrchestratorHelper> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<ReliabilityMl.Project.OrchestratorHelper>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<ReliabilityMl.Project.OrchestratorHelper>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityMl.Project.OrchestratorHelper;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityMl.Project.OrchestratorHelper;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityMl.Project.OrchestratorHelper;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): ReliabilityMl.Project.OrchestratorHelper;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityMl.Project.OrchestratorHelper;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): ReliabilityMl.Project.OrchestratorHelper;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityMl.Project.OrchestratorHelper;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): ReliabilityMl.Project.OrchestratorHelper;
     ...
     */
    static cachedEmptyInst(): ReliabilityMl.Project.OrchestratorHelper;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityMl.Project.OrchestratorHelper> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): ReliabilityMl.Project.OrchestratorHelper;
