// TypeScript definitions for the C3 type ReliabilityOrchestrator.PostTrainingJobResult

/**
 * Represents the post training workflow that will be executed to validate/classify/generate reports for a single
 * {@link ReliabilityMlModel} - {@link ReliabilityAsset} and for a specific {@link MlProject}.
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityOrchestrator.PostTrainingJobResult
 */
declare namespace ReliabilityOrchestrator {
  export interface IPostTrainingJobResult {
     ...
     * result.
     */
    pastRuns?: Array_Type<WorkflowExecutorRun> | Array<IWorkflowExecutorRun>;
    ...
    /**
     * Specify the {@link ReliabilityMl.Project} for which the post model training job should be run.
     */
    project: IReliabilityMl.Project;

    /**
     * The {@link ReliabilityAsset} for which model validation/classification/reporting should be run.
     */
    asset: IReliabilityAsset;

    /**
     * The {@link ReliabilityMlModel} for which the post training job is run.
     */
    model: IReliabilityMlModel;

    /**
     * The reference period for which a {@link ReliabilityMl.ModelOutput}s are generated in order to determine how the
     * model performs. This usually can correspond to the training period for the model, since the model is expected to
     * perform well on the training data
     *
     * Use `ReliabilityMl.TimeRange.TRAIN` to use the training time range associated with a {@link ReliabilityMlModel#datasetPreparationRun},
     * or instead provide your own custom time range.
     *
     * The model outputs from this period can be compared with the model outputs generated for the {@link #comparisonTimeRange} to
     * classify the model.
     */
    referenceTimeRange?: ITimeRange | string;

    /**
     * The comparison period for which a {@link ReliabilityMl.ModelOutput}s are generated in order to determine how the
     * model performs. This can correspond to the validation period for the model, since the model is expected to
     * perform well as well on held out validation data as the training data.
     *
     * Use `ReliabilityMl.TimeRange.VAL` to use the validation time range associated with a {@link ReliabilityMlModel#datasetPreparationRun},
     * or instead provide your own custom time range.
     *
     * The model outputs from this period can be compared with the model outputs generated for the {@link #referenceTimeRange} to
     * classify the model.
     */
    comparisonTimeRange?: ITimeRange | string;

    /**
     * Specify whether to classify the {@link #model} after it is trained. By default this
     * field is set to False, meaning the model will be classified.
     * The classification logic must be specified in the {@link ReliabilityMl.Project#classifyModelForAssetLambda} associated with the
     * {@link ReliabilityOrchestrator.PostTrainingJob}
     */
    doNotClassify?: boolean;

    /**
     * Specify whether to validate the {@link #model} after it is trained. By default this
     * field is set to False, meaning the model will be validated.
     */
    doNotValidate?: boolean;

    /**
     * Specify whether to generate model validation reports for the {@link #model} after it is trained.
     * By default this field is set to False, meaning that a model report will be generated.
     * The reporting logic must be specified in the {@link ReliabilityMl.Project#reportModelForAssetLambda} associated with the
     * {@link ReliabilityOrchestrator.PostTrainingJob}
     */
 ...
 * {@link ReliabilityMlModel} - {@link ReliabilityAsset} and for a specific {@link MlProject}.
 *
 * @remarks this represents a made instance of ReliabilityOrchestrator.PostTrainingJobResult
 */
declare namespace ReliabilityOrchestrator {
  export class PostTrainingJobResult extends Obj  {

    /**
     * The unique and required name of this instance.
     */
    readonly name: string;
    withName(name: string): ReliabilityOrchestrator.PostTrainingJobResult;
    ...
    withTypeIdent(typeIdent: string | null): ReliabilityOrchestrator.PostTrainingJobResult;
     ...
     */
    readonly id: string;
    withId(id: string): ReliabilityOrchestrator.PostTrainingJobResult;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityOrchestrator.PostTrainingJobResult;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): ReliabilityOrchestrator.PostTrainingJobResult;
    ...
    withVersion(version: number | null): ReliabilityOrchestrator.PostTrainingJobResult;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): ReliabilityOrchestrator.PostTrainingJobResult;

    /**
     * Parent {@link MlWorkflowCoordinatable} that this result belongs to.
     */
    readonly parentCoordinator: MlWorkflowCoordinatable<MlWorkflowCoordinatableResult>;
    withParentCoordinator(parentCoordinator: IMlWorkflowCoordinatable<MlWorkflowCoordinatableResult>): ReliabilityOrchestrator.PostTrainingJobResult;

    /**
     * Helper field for filtering during the coordinator implementation.
     * See {@link Workflow.Coordinatable} for status semantics.
     */
    readonly statusForCoordinatable: string;
    withStatusForCoordinatable(statusForCoordinatable: string): ReliabilityOrchestrator.PostTrainingJobResult;

    /**
     * Number of times the {@link #parentCoordinator} has canceled this result.
     */
    readonly canceledCount?: number;
    withCanceledCount(canceledCount: number | null): ReliabilityOrchestrator.PostTrainingJobResult;
    ...
    withIsCanceled(isCanceled: boolean): ReliabilityOrchestrator.PostTrainingJobResult;
    ...
    withErrorCount(errorCount: number | null): ReliabilityOrchestrator.PostTrainingJobResult;

    /**
     * Reference to the {@link WorkflowExecutorRun} that executed the actions to execute this
     * result.
     */
    readonly run?: WorkflowExecutorRun;
    withRun(run: IWorkflowExecutorRun | null): ReliabilityOrchestrator.PostTrainingJobResult;
    ...
    withDurationSeconds(durationSeconds: number | null): ReliabilityOrchestrator.PostTrainingJobResult;

    /**
     * Reference to all past {@link WorkflowExecutorRun}s that executed the actions pertaining to this
     * result.
     */
    readonly pastRuns?: Array_Type<WorkflowExecutorRun>;
    withPastRuns(pastRuns: Array_Type<WorkflowExecutorRun> | Array<IWorkflowExecutorRun> | null): ReliabilityOrchestrator.PostTrainingJobResult;

    /**
     * Number of times the {@link #parentCoordinator} has attempted to recover this result.
     */
    readonly attemptedRecoveryCount?: number;
    withAttemptedRecoveryCount(attemptedRecoveryCount: number | null): ReliabilityOrchestrator.PostTrainingJobResult;

    /**
     * Specify the {@link ReliabilityMl.Project} for which the post model training job should be run.
     */
    readonly project: ReliabilityMl.Project;
    withProject(project: IReliabilityMl.Project): ReliabilityOrchestrator.PostTrainingJobResult;

    /**
     * The {@link ReliabilityAsset} for which model validation/classification/reporting should be run.
     */
    readonly asset: ReliabilityAsset;
    withAsset(asset: IReliabilityAsset): ReliabilityOrchestrator.PostTrainingJobResult;

    /**
     * The {@link ReliabilityMlModel} for which the post training job is run.
     */
    readonly model: ReliabilityMlModel;
    withModel(model: IReliabilityMlModel): ReliabilityOrchestrator.PostTrainingJobResult;
     ...
     * classify the model.
     */
    readonly referenceTimeRange?: TimeRange | string;
    withReferenceTimeRange(referenceTimeRange: ITimeRange | string | null): ReliabilityOrchestrator.PostTrainingJobResult;
     ...
     * classify the model.
     */
    readonly comparisonTimeRange?: TimeRange | string;
    withComparisonTimeRange(comparisonTimeRange: ITimeRange | string | null): ReliabilityOrchestrator.PostTrainingJobResult;
     ...
     * {@link ReliabilityOrchestrator.PostTrainingJob}
     */
    readonly doNotClassify?: boolean;
    withDoNotClassify(doNotClassify: boolean): ReliabilityOrchestrator.PostTrainingJobResult;
    ...
    withDoNotValidate(doNotValidate: boolean): ReliabilityOrchestrator.PostTrainingJobResult;
     ...
     * {@link ReliabilityOrchestrator.PostTrainingJob}
     */
    readonly doNotGenerateValidationReports?: boolean;
    withDoNotGenerateValidationReports(doNotGenerateValidationReports: boolean): ReliabilityOrchestrator.PostTrainingJobResult;
     ...
     * @see #toJson
     */
    static fromJson(json: any): ReliabilityOrchestrator.PostTrainingJobResult | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): ReliabilityOrchestrator.PostTrainingJobResult | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): ReliabilityOrchestrator.PostTrainingJobResult | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): ReliabilityOrchestrator.PostTrainingJobResult | null;
     ...
     */
    replaceType(old: Type, new_: Type): ReliabilityOrchestrator.PostTrainingJobResult;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityOrchestrator.PostTrainingJobResult;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityOrchestrator.PostTrainingJobResult;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityOrchestrator.PostTrainingJobResult>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityOrchestrator.PostTrainingJobResult>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityOrchestrator.PostTrainingJobResult;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityOrchestrator.PostTrainingJobResult;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityOrchestrator.PostTrainingJobResult;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): ReliabilityOrchestrator.PostTrainingJobResult;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): ReliabilityOrchestrator.PostTrainingJobResult;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityOrchestrator.PostTrainingJobResult;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityOrchestrator.PostTrainingJobResult;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityOrchestrator.PostTrainingJobResult;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): ReliabilityOrchestrator.PostTrainingJobResult;
     ...
     * @see #removeField
     */
    withoutField(field: string): ReliabilityOrchestrator.PostTrainingJobResult;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): ReliabilityOrchestrator.PostTrainingJobResult;
     ...
     */
    withoutFields(fields: Array_Type<string>): ReliabilityOrchestrator.PostTrainingJobResult;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityOrchestrator.PostTrainingJobResult;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): ReliabilityOrchestrator.PostTrainingJobResult;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityOrchestrator.PostTrainingJobResult;
     ...
     * @see #unsetField
     */
    defaultField(field: string): ReliabilityOrchestrator.PostTrainingJobResult;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): ReliabilityOrchestrator.PostTrainingJobResult;
     ...
     * @see #removeField
     */
    unsetField(field: string): ReliabilityOrchestrator.PostTrainingJobResult;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): ReliabilityOrchestrator.PostTrainingJobResult;
     ...
     * @see #unsetField
     */
    removeField(field: string): ReliabilityOrchestrator.PostTrainingJobResult;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): ReliabilityOrchestrator.PostTrainingJobResult;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityOrchestrator.PostTrainingJobResult;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityOrchestrator.PostTrainingJobResult;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityOrchestrator.PostTrainingJobResult;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityOrchestrator.PostTrainingJobResult;

    mergeJson(json: any): ReliabilityOrchestrator.PostTrainingJobResult;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityOrchestrator.PostTrainingJobResult;
     ...
     */
    sumObj(other: Obj, deep?: boolean): ReliabilityOrchestrator.PostTrainingJobResult;
     ...
     */
    singletonArray(): Array_Type<ReliabilityOrchestrator.PostTrainingJobResult>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityOrchestrator.PostTrainingJobResult> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<ReliabilityOrchestrator.PostTrainingJobResult> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<ReliabilityOrchestrator.PostTrainingJobResult>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<ReliabilityOrchestrator.PostTrainingJobResult> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, ReliabilityOrchestrator.PostTrainingJobResult> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityOrchestrator.PostTrainingJobResult> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<ReliabilityOrchestrator.PostTrainingJobResult>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<ReliabilityOrchestrator.PostTrainingJobResult>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityOrchestrator.PostTrainingJobResult;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityOrchestrator.PostTrainingJobResult;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityOrchestrator.PostTrainingJobResult;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): ReliabilityOrchestrator.PostTrainingJobResult;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityOrchestrator.PostTrainingJobResult;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): ReliabilityOrchestrator.PostTrainingJobResult;
     ...
     * @see #fromString
     */
    static make(s: string): ReliabilityOrchestrator.PostTrainingJobResult | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityOrchestrator.PostTrainingJobResult;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): ReliabilityOrchestrator.PostTrainingJobResult;
     ...
     */
    static cachedEmptyInst(): ReliabilityOrchestrator.PostTrainingJobResult;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityOrchestrator.PostTrainingJobResult> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): ReliabilityOrchestrator.PostTrainingJobResult;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<ReliabilityOrchestrator.PostTrainingJobResult>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<ReliabilityOrchestrator.PostTrainingJobResult>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityOrchestrator.PostTrainingJobResult> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityOrchestrator.PostTrainingJobResult>> | null;
     ...
     */
    get(include?: string): ReliabilityOrchestrator.PostTrainingJobResult | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): ReliabilityOrchestrator.PostTrainingJobResult | null;
     ...
     */
    getMissing(spec: GetMissingSpec): ReliabilityOrchestrator.PostTrainingJobResult;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): ReliabilityOrchestrator.PostTrainingJobResult | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): ReliabilityOrchestrator.PostTrainingJobResult;
     ...
     * @see #toString
     */
    static fromString(s: string): ReliabilityOrchestrator.PostTrainingJobResult | null;
     ...
     */
    create(spec?: UpsertSpec): ReliabilityOrchestrator.PostTrainingJobResult | null;
     ...
     */
    static createBatch(objs: Array_Type<ReliabilityOrchestrator.PostTrainingJobResult>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.PostTrainingJobResult> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<ReliabilityOrchestrator.PostTrainingJobResult>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityOrchestrator.PostTrainingJobResult> | null;
     ...
     */
    update(srcObj?: ReliabilityOrchestrator.PostTrainingJobResult, spec?: UpsertSpec): ReliabilityOrchestrator.PostTrainingJobResult | null;
     ...
     */
    upsert(srcObj?: ReliabilityOrchestrator.PostTrainingJobResult, spec?: UpsertSpec): ReliabilityOrchestrator.PostTrainingJobResult | null;
     ...
     */
    merge(spec?: MergeSpec): ReliabilityOrchestrator.PostTrainingJobResult | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): ReliabilityOrchestrator.PostTrainingJobResult | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): ReliabilityOrchestrator.PostTrainingJobResult | null;
     ...
     */
    static updateBatch(objs: Array_Type<ReliabilityOrchestrator.PostTrainingJobResult>, srcObjs?: Array_Type<ReliabilityOrchestrator.PostTrainingJobResult>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.PostTrainingJobResult> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<ReliabilityOrchestrator.PostTrainingJobResult> | null>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.PostTrainingJobResult> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<ReliabilityOrchestrator.PostTrainingJobResult>, srcObjs?: Array_Type<ReliabilityOrchestrator.PostTrainingJobResult>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.PostTrainingJobResult> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<ReliabilityOrchestrator.PostTrainingJobResult> | null>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.PostTrainingJobResult> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<ReliabilityOrchestrator.PostTrainingJobResult>, spec?: TouchSpec): ObjList<ReliabilityOrchestrator.PostTrainingJobResult> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityOrchestrator.PostTrainingJobResult>, spec?: MergeSpec): ObjList<ReliabilityOrchestrator.PostTrainingJobResult> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityOrchestrator.PostTrainingJobResult>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityOrchestrator.PostTrainingJobResult> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<ReliabilityOrchestrator.PostTrainingJobResult> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityOrchestrator.PostTrainingJobResult> | null;
     ...
     */
    static mergeAll(mergeObj: ReliabilityOrchestrator.PostTrainingJobResult, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: ReliabilityOrchestrator.PostTrainingJobResult, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<ReliabilityOrchestrator.PostTrainingJobResult>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.PostTrainingJobResult> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<ReliabilityOrchestrator.PostTrainingJobResult>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.PostTrainingJobResult> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): ReliabilityOrchestrator.PostTrainingJobResult | null;
     ...
     */
    static beforeCreate(objs: Array_Type<ReliabilityOrchestrator.PostTrainingJobResult>): ObjList<ReliabilityOrchestrator.PostTrainingJobResult>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<ReliabilityOrchestrator.PostTrainingJobResult>): ObjList<ReliabilityOrchestrator.PostTrainingJobResult>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<ReliabilityOrchestrator.PostTrainingJobResult>): ObjList<ReliabilityOrchestrator.PostTrainingJobResult>;
     ...
     */
    static afterCreate(objs: Array_Type<ReliabilityOrchestrator.PostTrainingJobResult>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<ReliabilityOrchestrator.PostTrainingJobResult>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<ReliabilityOrchestrator.PostTrainingJobResult>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityOrchestrator.PostTrainingJobResult>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityOrchestrator.PostTrainingJobResult>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): ReliabilityOrchestrator.PostTrainingJobResult | null;
     ...
     */
    withoutIdentity(): ReliabilityOrchestrator.PostTrainingJobResult | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<ReliabilityOrchestrator.PostTrainingJobResult>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: ReliabilityOrchestrator.PostTrainingJobResult, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<ReliabilityOrchestrator.PostTrainingJobResult>, callback?: λFunction<ReliabilityOrchestrator.PostTrainingJobResult | null, ReliabilityOrchestrator.PostTrainingJobResult | null>): ObjList<ReliabilityOrchestrator.PostTrainingJobResult>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<ReliabilityOrchestrator.PostTrainingJobResult>, callback?: λFunction<ReliabilityOrchestrator.PostTrainingJobResult | null, ReliabilityOrchestrator.PostTrainingJobResult | null>): Array_Type<ObjError> | null;
     ...
     */
    errors(): Map_Type<string, Array_Type<string>> | null;
     ...
     */
    startWorkflow(): WorkflowExecutorRun;
     ...
     */
    beforeRecover(): ReliabilityOrchestrator.PostTrainingJobResult;
     ...
     * caller is responsible for persisting the result.
     */
    beforeCancel(): ReliabilityOrchestrator.PostTrainingJobResult;

    /**
     * Creates a {@link ReliabilityAssetToModelValidationRelation} for the given {@link #asset} and {@link #model},
     * for the specified time range provided by start and end. This is used as a step in the
     * @param asset
     *           The reliability asset to create the validation relation for.
     * @param model
     *           The reliability ML model to create the validation relation for.
     * @param start
     *           The start datetime for the validation relation.
     * @param end
     *           The end datetime for the validation relation.
     */
    static createModelValidationRelation(asset: ReliabilityAsset, model: ReliabilityMlModel, start?: DateTime, end?: DateTime): void;

    /**
     * Creates a {@link ReliabilityOrchestrator.ModelMonitoringJobResult}, which contains the outputs of {@link #model} and
     * {@link #model} for either the {@link #referenceTimeRange} or the {@link #comparisonTimeRange}.
     * @param timeRange
     *           The time range for which to create model outputs.
     * @param processOutputs
     *           Tuple containing the process outputs.
     * @param interpretOutputs
     *           Tuple containing the interpret outputs.
     * @return A {@link ReliabilityMl.ModelOutput} object for the specified time range.
     */
    static createModelOutputForTimeRange(timeRange: TimeRange, processOutputs: Tuple, interpretOutputs?: Tuple): ReliabilityMl.ModelOutput;

    /**
     * Creates the {@link Workflow} to run the post training job for the {@link #asset} - @{link-model} combination,
     * that is started by {@link #startWorkflow}.
     * @return A {@link Workflow} object for the post training job.
     */
