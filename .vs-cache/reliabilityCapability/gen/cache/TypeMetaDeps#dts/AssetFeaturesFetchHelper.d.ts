// TypeScript definitions for the C3 type AssetFeaturesFetchHelper
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of AssetFeaturesFetchHelper
 */
declare interface IAssetFeaturesFetchHelper {
 ...
 */
declare class AssetFeaturesFetchHelper extends Obj  {
   ...
   */
  readonly id?: string;
  withId(id: string | null): AssetFeaturesFetchHelper;

  /**
   * {@link Sensor#id}, if applicable.
   */
  readonly sensorId?: string;
  withSensorId(sensorId: string | null): AssetFeaturesFetchHelper;

  /**
   * {@link Sensor}, if applicable.
   */
  readonly sensorOperationalStatus?: SensorOperationalStatusTimedValue;
  withSensorOperationalStatus(sensorOperationalStatus: ISensorOperationalStatusTimedValue | null): AssetFeaturesFetchHelper;

  /**
   * Display name for the feature. Corresponds to {@link Sensor#tag} or {@link Metric#name}.
   */
  readonly name?: string;
  withName(name: string | null): AssetFeaturesFetchHelper;

  /**
   * Description of the feature. Corresponds to {@link Sensor#description} or {@link Metric#description}.
   */
  readonly description?: string;
  withDescription(description: string | null): AssetFeaturesFetchHelper;
  ...
  withExpectedSensor(expectedSensor: string | null): AssetFeaturesFetchHelper;
  ...
  withValue(value: number | null): AssetFeaturesFetchHelper;

  /**
   * Unit of the feature. Corresponds to {@link Sensor#unitConstraint} or {@link Metric#unit}
   */
  readonly unit?: Unit;
  withUnit(unit: IUnit | null): AssetFeaturesFetchHelper;

  /**
   * Feature contribution value, i.e. how important this feature is at a given time.
   */
  readonly contribution?: number;
  withContribution(contribution: number | null): AssetFeaturesFetchHelper;

  /**
   * Feature reconstruction value, i.e. the predicted value by the model for this feature.
   */
  readonly reconstruction?: number;
  withReconstruction(reconstruction: number | null): AssetFeaturesFetchHelper;

  /**
   * Feature contribution value in Percentage to display in UI.
   */
  readonly contributionPercentage?: number;
  withContributionPercentage(contributionPercentage: number | null): AssetFeaturesFetchHelper;

  /**
   * Current value and unit to display in UI.
   */
  readonly valueWithUnit?: string;
  withValueWithUnit(valueWithUnit: string | null): AssetFeaturesFetchHelper;
  ...
  withVariance(variance: number | null): AssetFeaturesFetchHelper;

  /**
   * The standard deviation of the feature value. Defined as the square root of the variance field.
   */
  readonly stddev?: number;
  withStddev(stddev: number | null): AssetFeaturesFetchHelper;

  /**
   * The latest {@link SensorHealthAlert} on a {@link Sensor} feature.
   */
  readonly sensorAlert?: SensorHealthAlert;
  withSensorAlert(sensorAlert: ISensorHealthAlert | null): AssetFeaturesFetchHelper;
   ...
   * @see #toJson
   */
  static fromJson(json: any): AssetFeaturesFetchHelper | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): AssetFeaturesFetchHelper | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): AssetFeaturesFetchHelper | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): AssetFeaturesFetchHelper | null;
   ...
   */
  replaceType(old: Type, new_: Type): AssetFeaturesFetchHelper;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): AssetFeaturesFetchHelper;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): AssetFeaturesFetchHelper;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<AssetFeaturesFetchHelper>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<AssetFeaturesFetchHelper>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): AssetFeaturesFetchHelper;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): AssetFeaturesFetchHelper;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): AssetFeaturesFetchHelper;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): AssetFeaturesFetchHelper;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): AssetFeaturesFetchHelper;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): AssetFeaturesFetchHelper;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): AssetFeaturesFetchHelper;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): AssetFeaturesFetchHelper;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): AssetFeaturesFetchHelper;
   ...
   * @see #removeField
   */
  withoutField(field: string): AssetFeaturesFetchHelper;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): AssetFeaturesFetchHelper;
   ...
   */
  withoutFields(fields: Array_Type<string>): AssetFeaturesFetchHelper;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): AssetFeaturesFetchHelper;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): AssetFeaturesFetchHelper;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): AssetFeaturesFetchHelper;
   ...
   * @see #unsetField
   */
  defaultField(field: string): AssetFeaturesFetchHelper;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): AssetFeaturesFetchHelper;
   ...
   * @see #removeField
   */
  unsetField(field: string): AssetFeaturesFetchHelper;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): AssetFeaturesFetchHelper;
   ...
   * @see #unsetField
   */
  removeField(field: string): AssetFeaturesFetchHelper;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): AssetFeaturesFetchHelper;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): AssetFeaturesFetchHelper;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): AssetFeaturesFetchHelper;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): AssetFeaturesFetchHelper;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): AssetFeaturesFetchHelper;

  mergeJson(json: any): AssetFeaturesFetchHelper;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): AssetFeaturesFetchHelper;
   ...
   */
  sumObj(other: Obj, deep?: boolean): AssetFeaturesFetchHelper;
   ...
   */
  singletonArray(): Array_Type<AssetFeaturesFetchHelper>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<AssetFeaturesFetchHelper> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<AssetFeaturesFetchHelper> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<AssetFeaturesFetchHelper>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<AssetFeaturesFetchHelper> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, AssetFeaturesFetchHelper> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, AssetFeaturesFetchHelper> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<AssetFeaturesFetchHelper>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<AssetFeaturesFetchHelper>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): AssetFeaturesFetchHelper;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): AssetFeaturesFetchHelper;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): AssetFeaturesFetchHelper;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): AssetFeaturesFetchHelper;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): AssetFeaturesFetchHelper;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): AssetFeaturesFetchHelper;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): AssetFeaturesFetchHelper;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): AssetFeaturesFetchHelper;
   ...
   */
  static cachedEmptyInst(): AssetFeaturesFetchHelper;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<AssetFeaturesFetchHelper> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): AssetFeaturesFetchHelper;
   ...
   */
  static fetchFeaturesForAsset(spec?: FetchSpec, assetId: string): FetchResultWithTotalCount<FeatureFetchBase> | null;
   ...
   */
  static getFeatureNamesForAsset(assetId: string): Array_Type<string> | null;
   ...
   * @return FetchResultWithTotalCount<AssetFeaturesFetchHelper>
   */
  static fetchFeaturesForAssetModelConfig(spec?: FetchSpec, assetId: string, selectionFilter?: boolean): FetchResultWithTotalCount<FeatureFetchBase> | null;
}
