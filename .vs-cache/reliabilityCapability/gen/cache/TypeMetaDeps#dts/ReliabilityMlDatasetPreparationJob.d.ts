// TypeScript definitions for the C3 type ReliabilityMlDatasetPreparationJob

/**
 * @inheritdoc
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityMlDatasetPreparationJob
 */
declare interface IReliabilityMlDatasetPreparationJob {
   ...
   */
  targetFilter?: IReliabilityAsset;
   ...
   */
  datasetRuns?: Array_Type<ReliabilityMlDatasetPreparationRun> | Array<IReliabilityMlDatasetPreparationRun>;
   ...
   */
  dataPrepJobRun?: IReliabilityOrchestrator.DatasetPreparationJobRun;
   ...
   */
  preparationSettings?: IReliabilityDataPreparationUiBaseSettings;
}
 ...
 */
declare class ReliabilityMlDatasetPreparationJob extends Obj  {
   ...
   */
  readonly id: string;
  withId(id: string): ReliabilityMlDatasetPreparationJob;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityMlDatasetPreparationJob;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): ReliabilityMlDatasetPreparationJob;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): ReliabilityMlDatasetPreparationJob;
  ...
  withVersion(version: number | null): ReliabilityMlDatasetPreparationJob;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): ReliabilityMlDatasetPreparationJob;

  /**
   * @inheritdoc
   */
  readonly facilityFilterPaths?: Array_Type<string>;
  withFacilityFilterPaths(facilityFilterPaths: Array_Type<string> | Array<string> | null): ReliabilityMlDatasetPreparationJob;

  /**
   * current or last job execution for this instance
   */
  readonly run?: MapReduceRun;
  withRun(run: IMapReduceRun | null): ReliabilityMlDatasetPreparationJob;

  /**
   * previous job executions for this instance
   */
  readonly runs?: Array_Type<MapReduceRun>;
  withRuns(runs: Array_Type<MapReduceRun> | Array<IMapReduceRun> | null): ReliabilityMlDatasetPreparationJob;

  /**
   * FOR INTERNAL USE ONLY - Specify options in call to {@link start}.
   */
  readonly options?: Obj;
  withOptions(options: IObj | null): ReliabilityMlDatasetPreparationJob;
  ...
  withOnCompleteCallback(onCompleteCallback: IJobBase.Callback | null): ReliabilityMlDatasetPreparationJob;
  ...
  withPriority(priority: number | null): ReliabilityMlDatasetPreparationJob;
  ...
  withDisabled(disabled: boolean): ReliabilityMlDatasetPreparationJob;
  ...
  withMaxConcurrency(maxConcurrency: number | null): ReliabilityMlDatasetPreparationJob;
  ...
  withMaxConcurrencyPerNode(maxConcurrencyPerNode: number | null): ReliabilityMlDatasetPreparationJob;
  ...
  withRunAsUser(runAsUser: boolean): ReliabilityMlDatasetPreparationJob;

  /**
   * Don't set this field in the MapReduce job, set it in the MapReduceOptions when calling `start`.
   */
  readonly nodePool?: string;
  withNodePool(nodePool: string | null): ReliabilityMlDatasetPreparationJob;
  ...
  withSkipIfRunning(skipIfRunning: boolean): ReliabilityMlDatasetPreparationJob;

  /**
   * Set to between 1 and 5 to enable auto recovery. See {@link invalidation-queues.c3doc Invalidation Queues} for detailed documentation.
   */
  readonly numAutoRecoveryAttempts?: number;
  withNumAutoRecoveryAttempts(numAutoRecoveryAttempts: number | null): ReliabilityMlDatasetPreparationJob;
  ...
  withPropagateActionContext(propagateActionContext: boolean): ReliabilityMlDatasetPreparationJob;
  ...
  withTargetType(targetType: IType | null): ReliabilityMlDatasetPreparationJob;
  ...
  withUseFileSystemForInterVals(useFileSystemForInterVals: boolean): ReliabilityMlDatasetPreparationJob;
  ...
  withUseBatchIdsForReadInput(useBatchIdsForReadInput: boolean): ReliabilityMlDatasetPreparationJob;
  ...
  withInclude(include: string | null): ReliabilityMlDatasetPreparationJob;

  /**
   * optional filter spec
   */
  readonly filter?: string;
  withFilter(filter: string | null): ReliabilityMlDatasetPreparationJob;
  ...
  withOrder(order: string | null): ReliabilityMlDatasetPreparationJob;
  ...
  withLimit(limit: number | null): ReliabilityMlDatasetPreparationJob;
  ...
  withSamplePct(samplePct: number | null): ReliabilityMlDatasetPreparationJob;
  ...
  withBatchSize(batchSize: number | null): ReliabilityMlDatasetPreparationJob;
  ...
  withSubBatchSize(subBatchSize: number | null): ReliabilityMlDatasetPreparationJob;
  ...
  withNumBatches(numBatches: number | null): ReliabilityMlDatasetPreparationJob;
  ...
  withAbortOnError(abortOnError: boolean): ReliabilityMlDatasetPreparationJob;
  ...
  withTypeIdent(typeIdent: string | null): ReliabilityMlDatasetPreparationJob;

  /**
   * Optional target type instance to be used as the filter for the job.  When specified, the {~link map} function will
   * only be called for that obj.
   */
  readonly targetFilter?: ReliabilityAsset;
  withTargetFilter(targetFilter: IReliabilityAsset | null): ReliabilityMlDatasetPreparationJob;
  ...
  withSpec(spec: IReliabilityMlDatasetPreparationSpec | null): ReliabilityMlDatasetPreparationJob;

  /**
   * Error message that will be populated with its corresponding error in the worfklow in the case of failure.
   */
  readonly errorMessage?: string;
  withErrorMessage(errorMessage: string | null): ReliabilityMlDatasetPreparationJob;

  /**
   * The {@link ReliabilityMlDatasetPreparationRun}s this map-reduce job is responsible for generating results for.
   */
  readonly datasetRuns?: Array_Type<ReliabilityMlDatasetPreparationRun>;
  withDatasetRuns(datasetRuns: Array_Type<ReliabilityMlDatasetPreparationRun> | Array<IReliabilityMlDatasetPreparationRun> | null): ReliabilityMlDatasetPreparationJob;

  /**
   * If populated, this entity is a tracking entity for a project agnostic dataset preparation job.
   * The field links to the project agnostic orchestrator run that this job is tracking.
   */
  readonly dataPrepJobRun?: ReliabilityOrchestrator.DatasetPreparationJobRun;
  withDataPrepJobRun(dataPrepJobRun: IReliabilityOrchestrator.DatasetPreparationJobRun | null): ReliabilityMlDatasetPreparationJob;
  ...
  withJobSpecs(jobSpecs: Array_Type<ReliabilityOrchestrator.DatasetPreparationJobSpec> | Array<IReliabilityOrchestrator.DatasetPreparationJobSpec> | null): ReliabilityMlDatasetPreparationJob;

  /**
   * {@link ReliabilityDataPreparationUiBaseSettings} to run dataset preparation.
   */
  readonly preparationSettings?: ReliabilityDataPreparationUiBaseSettings;
  withPreparationSettings(preparationSettings: IReliabilityDataPreparationUiBaseSettings | null): ReliabilityMlDatasetPreparationJob;
   ...
   * @see #toJson
   */
  static fromJson(json: any): ReliabilityMlDatasetPreparationJob | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): ReliabilityMlDatasetPreparationJob | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): ReliabilityMlDatasetPreparationJob | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): ReliabilityMlDatasetPreparationJob | null;
   ...
   */
  replaceType(old: Type, new_: Type): ReliabilityMlDatasetPreparationJob;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityMlDatasetPreparationJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityMlDatasetPreparationJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityMlDatasetPreparationJob>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityMlDatasetPreparationJob>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityMlDatasetPreparationJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityMlDatasetPreparationJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityMlDatasetPreparationJob;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ReliabilityMlDatasetPreparationJob;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ReliabilityMlDatasetPreparationJob;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityMlDatasetPreparationJob;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityMlDatasetPreparationJob;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityMlDatasetPreparationJob;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ReliabilityMlDatasetPreparationJob;
   ...
   * @see #removeField
   */
  withoutField(field: string): ReliabilityMlDatasetPreparationJob;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): ReliabilityMlDatasetPreparationJob;
   ...
   */
  withoutFields(fields: Array_Type<string>): ReliabilityMlDatasetPreparationJob;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityMlDatasetPreparationJob;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ReliabilityMlDatasetPreparationJob;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityMlDatasetPreparationJob;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ReliabilityMlDatasetPreparationJob;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ReliabilityMlDatasetPreparationJob;
   ...
   * @see #removeField
   */
  unsetField(field: string): ReliabilityMlDatasetPreparationJob;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ReliabilityMlDatasetPreparationJob;
   ...
   * @see #unsetField
   */
  removeField(field: string): ReliabilityMlDatasetPreparationJob;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ReliabilityMlDatasetPreparationJob;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityMlDatasetPreparationJob;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityMlDatasetPreparationJob;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityMlDatasetPreparationJob;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityMlDatasetPreparationJob;

  mergeJson(json: any): ReliabilityMlDatasetPreparationJob;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityMlDatasetPreparationJob;
   ...
   */
  sumObj(other: Obj, deep?: boolean): ReliabilityMlDatasetPreparationJob;
   ...
   */
  singletonArray(): Array_Type<ReliabilityMlDatasetPreparationJob>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityMlDatasetPreparationJob> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ReliabilityMlDatasetPreparationJob> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<ReliabilityMlDatasetPreparationJob>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ReliabilityMlDatasetPreparationJob> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, ReliabilityMlDatasetPreparationJob> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityMlDatasetPreparationJob> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ReliabilityMlDatasetPreparationJob>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ReliabilityMlDatasetPreparationJob>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityMlDatasetPreparationJob;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityMlDatasetPreparationJob;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityMlDatasetPreparationJob;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ReliabilityMlDatasetPreparationJob;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityMlDatasetPreparationJob;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ReliabilityMlDatasetPreparationJob;
   ...
   * @see #fromString
   */
  static make(s: string): ReliabilityMlDatasetPreparationJob | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityMlDatasetPreparationJob;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): ReliabilityMlDatasetPreparationJob;
   ...
   */
  static cachedEmptyInst(): ReliabilityMlDatasetPreparationJob;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityMlDatasetPreparationJob> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): ReliabilityMlDatasetPreparationJob;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<ReliabilityMlDatasetPreparationJob>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<ReliabilityMlDatasetPreparationJob>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityMlDatasetPreparationJob> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityMlDatasetPreparationJob>> | null;
   ...
   */
  get(include?: string): ReliabilityMlDatasetPreparationJob | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): ReliabilityMlDatasetPreparationJob | null;
   ...
   */
  getMissing(spec: GetMissingSpec): ReliabilityMlDatasetPreparationJob;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): ReliabilityMlDatasetPreparationJob | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): ReliabilityMlDatasetPreparationJob;
   ...
   * @see #toString
   */
  static fromString(s: string): ReliabilityMlDatasetPreparationJob | null;
   ...
   */
  create(spec?: UpsertSpec): ReliabilityMlDatasetPreparationJob | null;
   ...
   */
  static createBatch(objs: Array_Type<ReliabilityMlDatasetPreparationJob>, spec?: UpsertSpec): ObjList<ReliabilityMlDatasetPreparationJob> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<ReliabilityMlDatasetPreparationJob>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityMlDatasetPreparationJob> | null;
   ...
   */
  update(srcObj?: ReliabilityMlDatasetPreparationJob, spec?: UpsertSpec): ReliabilityMlDatasetPreparationJob | null;
   ...
   */
  upsert(srcObj?: ReliabilityMlDatasetPreparationJob, spec?: UpsertSpec): ReliabilityMlDatasetPreparationJob | null;
   ...
   */
  merge(spec?: MergeSpec): ReliabilityMlDatasetPreparationJob | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): ReliabilityMlDatasetPreparationJob | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): ReliabilityMlDatasetPreparationJob | null;
   ...
   */
  static updateBatch(objs: Array_Type<ReliabilityMlDatasetPreparationJob>, srcObjs?: Array_Type<ReliabilityMlDatasetPreparationJob>, spec?: UpsertSpec): ObjList<ReliabilityMlDatasetPreparationJob> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<ReliabilityMlDatasetPreparationJob> | null>, spec?: UpsertSpec): ObjList<ReliabilityMlDatasetPreparationJob> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<ReliabilityMlDatasetPreparationJob>, srcObjs?: Array_Type<ReliabilityMlDatasetPreparationJob>, spec?: UpsertSpec): ObjList<ReliabilityMlDatasetPreparationJob> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<ReliabilityMlDatasetPreparationJob> | null>, spec?: UpsertSpec): ObjList<ReliabilityMlDatasetPreparationJob> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<ReliabilityMlDatasetPreparationJob>, spec?: TouchSpec): ObjList<ReliabilityMlDatasetPreparationJob> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityMlDatasetPreparationJob>, spec?: MergeSpec): ObjList<ReliabilityMlDatasetPreparationJob> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityMlDatasetPreparationJob>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityMlDatasetPreparationJob> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<ReliabilityMlDatasetPreparationJob> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityMlDatasetPreparationJob> | null;
   ...
   */
  static mergeAll(mergeObj: ReliabilityMlDatasetPreparationJob, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: ReliabilityMlDatasetPreparationJob, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<ReliabilityMlDatasetPreparationJob>, spec?: UpsertSpec): ObjList<ReliabilityMlDatasetPreparationJob> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<ReliabilityMlDatasetPreparationJob>, spec?: UpsertSpec): ObjList<ReliabilityMlDatasetPreparationJob> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): ReliabilityMlDatasetPreparationJob | null;
   ...
   */
  static beforeCreate(objs: Array_Type<ReliabilityMlDatasetPreparationJob>): ObjList<ReliabilityMlDatasetPreparationJob>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<ReliabilityMlDatasetPreparationJob>): ObjList<ReliabilityMlDatasetPreparationJob>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<ReliabilityMlDatasetPreparationJob>): ObjList<ReliabilityMlDatasetPreparationJob>;
   ...
   */
  static afterCreate(objs: Array_Type<ReliabilityMlDatasetPreparationJob>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<ReliabilityMlDatasetPreparationJob>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<ReliabilityMlDatasetPreparationJob>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityMlDatasetPreparationJob>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityMlDatasetPreparationJob>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): ReliabilityMlDatasetPreparationJob | null;
   ...
   */
  withoutIdentity(): ReliabilityMlDatasetPreparationJob | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<ReliabilityMlDatasetPreparationJob>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: ReliabilityMlDatasetPreparationJob, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<ReliabilityMlDatasetPreparationJob>, callback?: λFunction<ReliabilityMlDatasetPreparationJob | null, ReliabilityMlDatasetPreparationJob | null>): ObjList<ReliabilityMlDatasetPreparationJob>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<ReliabilityMlDatasetPreparationJob>, callback?: λFunction<ReliabilityMlDatasetPreparationJob | null, ReliabilityMlDatasetPreparationJob | null>): Array_Type<ObjError> | null;
   ...
   *         key type.
   */
  static map(batch?: number, objs?: Array_Type<ReliabilityAsset>, job?: MapReduce<ReliabilityAsset, , , >, subBatch?: number): Map_Type<, > | null;
   ...
   */
  static reduce(outKey?: , interValues?: Array_Type<>, job?: MapReduce<ReliabilityAsset, , , >):  | Array_Type<> | null;
   ...
   */
  static mapCompleted(job?: MapReduce<ReliabilityAsset, , , >): void;
   ...
   */
  static completed(job?: MapReduce<ReliabilityAsset, , , >): string | null;
   ...
   */
  static failed(job: MapReduce<ReliabilityAsset, , , >, status: MapReduceStatus, options?: MapReduceOptions): void;
   ...
   */
  results(limit?: number = '10000'): Map_Type<,  | Array_Type<>> | null;
   ...
   */
  populatePreparationSettings(run: ReliabilityMlDatasetPreparationRun): ReliabilityMlDatasetPreparationJob;
   ...
   */
  initializeBeforeWorkflow(): ReliabilityOrchestrator.DatasetPreparationJobRun | null;

  /**
   * Update the tracking information after a project agnostic dataset preparation job has completed.
   * Used by {@link ReliabilityOrchestrator.DatasetPreparationJob}
   */
  updateAfterWorkflow(): void;
}
