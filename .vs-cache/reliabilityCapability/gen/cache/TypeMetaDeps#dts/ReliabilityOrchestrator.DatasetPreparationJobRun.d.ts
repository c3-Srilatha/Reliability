// TypeScript definitions for the C3 type ReliabilityOrchestrator.DatasetPreparationJobRun
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityOrchestrator.DatasetPreparationJobRun
 */
declare namespace ReliabilityOrchestrator {
  export interface IDatasetPreparationJobRun {

    /**
     * The distributed job this run is an instance of.
     */
    job: IReliabilityOrchestrator.DatasetPreparationJob;

    /**
     * The array of configurations this job run must execute.
     */
    jobSpecs: Array_Type<ReliabilityOrchestrator.DatasetPreparationJobSpec> | Array<IReliabilityOrchestrator.DatasetPreparationJobSpec>;
 ...
 */
declare namespace ReliabilityOrchestrator {
  export class DatasetPreparationJobRun extends Obj  {

    /**
     * The distributed job this run is an instance of.
     */
    readonly job: ReliabilityOrchestrator.DatasetPreparationJob;
    withJob(job: IReliabilityOrchestrator.DatasetPreparationJob): ReliabilityOrchestrator.DatasetPreparationJobRun;

    /**
     * The array of configurations this job run must execute.
     */
    readonly jobSpecs: Array_Type<ReliabilityOrchestrator.DatasetPreparationJobSpec>;
    withJobSpecs(jobSpecs: Array_Type<ReliabilityOrchestrator.DatasetPreparationJobSpec> | Array<IReliabilityOrchestrator.DatasetPreparationJobSpec>): ReliabilityOrchestrator.DatasetPreparationJobRun;
    ...
    withMlOperationRun(mlOperationRun: IMlOperationRun<any> | null): ReliabilityOrchestrator.DatasetPreparationJobRun;

    /**
     * Options that were used to specify execution constraints for this training job run.
     */
    readonly options: ReliabilityOrchestrator.JobOptions;
    withOptions(options: IReliabilityOrchestrator.JobOptions): ReliabilityOrchestrator.DatasetPreparationJobRun;
    ...
    withTypeIdent(typeIdent: string | null): ReliabilityOrchestrator.DatasetPreparationJobRun;
     ...
     */
    readonly id: string;
    withId(id: string): ReliabilityOrchestrator.DatasetPreparationJobRun;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityOrchestrator.DatasetPreparationJobRun;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): ReliabilityOrchestrator.DatasetPreparationJobRun;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): ReliabilityOrchestrator.DatasetPreparationJobRun;
    ...
    withVersion(version: number | null): ReliabilityOrchestrator.DatasetPreparationJobRun;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): ReliabilityOrchestrator.DatasetPreparationJobRun;

    /**
     * {@link JobOptions} for executing this coordinator.
     */
    readonly jobOptions?: JobOptions;
    withJobOptions(jobOptions: IJobOptions | null): ReliabilityOrchestrator.DatasetPreparationJobRun;
     ...
     * @see #toJson
     */
    static fromJson(json: any): ReliabilityOrchestrator.DatasetPreparationJobRun | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): ReliabilityOrchestrator.DatasetPreparationJobRun | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): ReliabilityOrchestrator.DatasetPreparationJobRun | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): ReliabilityOrchestrator.DatasetPreparationJobRun | null;
     ...
     */
    replaceType(old: Type, new_: Type): ReliabilityOrchestrator.DatasetPreparationJobRun;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityOrchestrator.DatasetPreparationJobRun;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityOrchestrator.DatasetPreparationJobRun;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityOrchestrator.DatasetPreparationJobRun>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityOrchestrator.DatasetPreparationJobRun>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityOrchestrator.DatasetPreparationJobRun;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityOrchestrator.DatasetPreparationJobRun;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityOrchestrator.DatasetPreparationJobRun;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): ReliabilityOrchestrator.DatasetPreparationJobRun;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): ReliabilityOrchestrator.DatasetPreparationJobRun;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityOrchestrator.DatasetPreparationJobRun;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityOrchestrator.DatasetPreparationJobRun;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityOrchestrator.DatasetPreparationJobRun;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): ReliabilityOrchestrator.DatasetPreparationJobRun;
     ...
     * @see #removeField
     */
    withoutField(field: string): ReliabilityOrchestrator.DatasetPreparationJobRun;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): ReliabilityOrchestrator.DatasetPreparationJobRun;
     ...
     */
    withoutFields(fields: Array_Type<string>): ReliabilityOrchestrator.DatasetPreparationJobRun;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityOrchestrator.DatasetPreparationJobRun;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): ReliabilityOrchestrator.DatasetPreparationJobRun;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityOrchestrator.DatasetPreparationJobRun;
     ...
     * @see #unsetField
     */
    defaultField(field: string): ReliabilityOrchestrator.DatasetPreparationJobRun;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): ReliabilityOrchestrator.DatasetPreparationJobRun;
     ...
     * @see #removeField
     */
    unsetField(field: string): ReliabilityOrchestrator.DatasetPreparationJobRun;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): ReliabilityOrchestrator.DatasetPreparationJobRun;
     ...
     * @see #unsetField
     */
    removeField(field: string): ReliabilityOrchestrator.DatasetPreparationJobRun;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): ReliabilityOrchestrator.DatasetPreparationJobRun;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityOrchestrator.DatasetPreparationJobRun;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityOrchestrator.DatasetPreparationJobRun;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityOrchestrator.DatasetPreparationJobRun;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityOrchestrator.DatasetPreparationJobRun;

    mergeJson(json: any): ReliabilityOrchestrator.DatasetPreparationJobRun;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityOrchestrator.DatasetPreparationJobRun;
     ...
     */
    sumObj(other: Obj, deep?: boolean): ReliabilityOrchestrator.DatasetPreparationJobRun;
     ...
     */
    singletonArray(): Array_Type<ReliabilityOrchestrator.DatasetPreparationJobRun>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityOrchestrator.DatasetPreparationJobRun> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<ReliabilityOrchestrator.DatasetPreparationJobRun> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<ReliabilityOrchestrator.DatasetPreparationJobRun>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<ReliabilityOrchestrator.DatasetPreparationJobRun> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, ReliabilityOrchestrator.DatasetPreparationJobRun> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityOrchestrator.DatasetPreparationJobRun> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<ReliabilityOrchestrator.DatasetPreparationJobRun>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<ReliabilityOrchestrator.DatasetPreparationJobRun>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityOrchestrator.DatasetPreparationJobRun;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityOrchestrator.DatasetPreparationJobRun;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityOrchestrator.DatasetPreparationJobRun;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): ReliabilityOrchestrator.DatasetPreparationJobRun;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityOrchestrator.DatasetPreparationJobRun;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): ReliabilityOrchestrator.DatasetPreparationJobRun;
     ...
     * @see #fromString
     */
    static make(s: string): ReliabilityOrchestrator.DatasetPreparationJobRun | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityOrchestrator.DatasetPreparationJobRun;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): ReliabilityOrchestrator.DatasetPreparationJobRun;
     ...
     */
    static cachedEmptyInst(): ReliabilityOrchestrator.DatasetPreparationJobRun;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityOrchestrator.DatasetPreparationJobRun> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): ReliabilityOrchestrator.DatasetPreparationJobRun;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<ReliabilityOrchestrator.DatasetPreparationJobRun>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<ReliabilityOrchestrator.DatasetPreparationJobRun>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityOrchestrator.DatasetPreparationJobRun> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityOrchestrator.DatasetPreparationJobRun>> | null;
     ...
     */
    get(include?: string): ReliabilityOrchestrator.DatasetPreparationJobRun | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): ReliabilityOrchestrator.DatasetPreparationJobRun | null;
     ...
     */
    getMissing(spec: GetMissingSpec): ReliabilityOrchestrator.DatasetPreparationJobRun;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): ReliabilityOrchestrator.DatasetPreparationJobRun | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): ReliabilityOrchestrator.DatasetPreparationJobRun;
     ...
     * @see #toString
     */
    static fromString(s: string): ReliabilityOrchestrator.DatasetPreparationJobRun | null;
     ...
     */
    create(spec?: UpsertSpec): ReliabilityOrchestrator.DatasetPreparationJobRun | null;
     ...
     */
    static createBatch(objs: Array_Type<ReliabilityOrchestrator.DatasetPreparationJobRun>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.DatasetPreparationJobRun> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<ReliabilityOrchestrator.DatasetPreparationJobRun>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityOrchestrator.DatasetPreparationJobRun> | null;
     ...
     */
    update(srcObj?: ReliabilityOrchestrator.DatasetPreparationJobRun, spec?: UpsertSpec): ReliabilityOrchestrator.DatasetPreparationJobRun | null;
     ...
     */
    upsert(srcObj?: ReliabilityOrchestrator.DatasetPreparationJobRun, spec?: UpsertSpec): ReliabilityOrchestrator.DatasetPreparationJobRun | null;
     ...
     */
    merge(spec?: MergeSpec): ReliabilityOrchestrator.DatasetPreparationJobRun | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): ReliabilityOrchestrator.DatasetPreparationJobRun | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): ReliabilityOrchestrator.DatasetPreparationJobRun | null;
     ...
     */
    static updateBatch(objs: Array_Type<ReliabilityOrchestrator.DatasetPreparationJobRun>, srcObjs?: Array_Type<ReliabilityOrchestrator.DatasetPreparationJobRun>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.DatasetPreparationJobRun> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<ReliabilityOrchestrator.DatasetPreparationJobRun> | null>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.DatasetPreparationJobRun> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<ReliabilityOrchestrator.DatasetPreparationJobRun>, srcObjs?: Array_Type<ReliabilityOrchestrator.DatasetPreparationJobRun>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.DatasetPreparationJobRun> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<ReliabilityOrchestrator.DatasetPreparationJobRun> | null>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.DatasetPreparationJobRun> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<ReliabilityOrchestrator.DatasetPreparationJobRun>, spec?: TouchSpec): ObjList<ReliabilityOrchestrator.DatasetPreparationJobRun> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityOrchestrator.DatasetPreparationJobRun>, spec?: MergeSpec): ObjList<ReliabilityOrchestrator.DatasetPreparationJobRun> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityOrchestrator.DatasetPreparationJobRun>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityOrchestrator.DatasetPreparationJobRun> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<ReliabilityOrchestrator.DatasetPreparationJobRun> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityOrchestrator.DatasetPreparationJobRun> | null;
     ...
     */
    static mergeAll(mergeObj: ReliabilityOrchestrator.DatasetPreparationJobRun, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: ReliabilityOrchestrator.DatasetPreparationJobRun, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<ReliabilityOrchestrator.DatasetPreparationJobRun>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.DatasetPreparationJobRun> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<ReliabilityOrchestrator.DatasetPreparationJobRun>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.DatasetPreparationJobRun> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): ReliabilityOrchestrator.DatasetPreparationJobRun | null;
     ...
     */
    static beforeCreate(objs: Array_Type<ReliabilityOrchestrator.DatasetPreparationJobRun>): ObjList<ReliabilityOrchestrator.DatasetPreparationJobRun>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<ReliabilityOrchestrator.DatasetPreparationJobRun>): ObjList<ReliabilityOrchestrator.DatasetPreparationJobRun>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<ReliabilityOrchestrator.DatasetPreparationJobRun>): ObjList<ReliabilityOrchestrator.DatasetPreparationJobRun>;
     ...
     */
    static afterCreate(objs: Array_Type<ReliabilityOrchestrator.DatasetPreparationJobRun>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<ReliabilityOrchestrator.DatasetPreparationJobRun>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<ReliabilityOrchestrator.DatasetPreparationJobRun>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityOrchestrator.DatasetPreparationJobRun>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityOrchestrator.DatasetPreparationJobRun>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): ReliabilityOrchestrator.DatasetPreparationJobRun | null;
     ...
     */
    withoutIdentity(): ReliabilityOrchestrator.DatasetPreparationJobRun | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<ReliabilityOrchestrator.DatasetPreparationJobRun>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: ReliabilityOrchestrator.DatasetPreparationJobRun, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<ReliabilityOrchestrator.DatasetPreparationJobRun>, callback?: λFunction<ReliabilityOrchestrator.DatasetPreparationJobRun | null, ReliabilityOrchestrator.DatasetPreparationJobRun | null>): ObjList<ReliabilityOrchestrator.DatasetPreparationJobRun>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<ReliabilityOrchestrator.DatasetPreparationJobRun>, callback?: λFunction<ReliabilityOrchestrator.DatasetPreparationJobRun | null, ReliabilityOrchestrator.DatasetPreparationJobRun | null>): Array_Type<ObjError> | null;
     ...
     */
    generateNextResults(completed?: Stream<ReliabilityOrchestrator.DatasetPreparationJobResult>): number;
     ...
     */
    startResult(result: ReliabilityOrchestrator.DatasetPreparationJobResult): ReliabilityOrchestrator.DatasetPreparationJobResult;
     ...
     */
    afterStart(results: Stream<ReliabilityOrchestrator.DatasetPreparationJobResult>): Stream<ReliabilityOrchestrator.DatasetPreparationJobResult> | null;
     ...
     * @return the result instance, as acknowledgement, even if unmodified.
     */
    completeResult(result: ReliabilityOrchestrator.DatasetPreparationJobResult): ReliabilityOrchestrator.DatasetPreparationJobResult;
     ...
     */
    updateRunningResults(spec?: FetchStreamSpec): Stream<ReliabilityOrchestrator.DatasetPreparationJobResult> | null;
     ...
     */
    afterComplete(results: Stream<ReliabilityOrchestrator.DatasetPreparationJobResult>): Stream<ReliabilityOrchestrator.DatasetPreparationJobResult> | null;
     ...
     */
    runFromResult(result: ReliabilityOrchestrator.DatasetPreparationJobResult): WorkflowExecutorRun | null;
     ...
     *    Optional {@link FetchStreamSpec} for customizing fetching of RT objects.
     */
    pendingResults(spec?: FetchStreamSpec): Stream<ReliabilityOrchestrator.DatasetPreparationJobResult> | null;
     ...
     *    Optional {@link FetchStreamSpec} for customizing fetching of RT objects.
     */
    runningResults(spec?: FetchStreamSpec): Stream<ReliabilityOrchestrator.DatasetPreparationJobResult> | null;
     ...
     *    Optional {@link FetchStreamSpec} for customizing fetching of RT objects.
     */
    completedResults(spec?: FetchStreamSpec): Stream<ReliabilityOrchestrator.DatasetPreparationJobResult> | null;
     ...
     *    Optional {@link FetchStreamSpec} for customizing fetching of RT objects.
     */
    canceledResults(spec?: FetchStreamSpec): Stream<ReliabilityOrchestrator.DatasetPreparationJobResult> | null;
     ...
     *    Optional {@link FetchStreamSpec} for customizing fetching of RT objects.
     */
    erroredResults(spec?: FetchStreamSpec): Stream<ReliabilityOrchestrator.DatasetPreparationJobResult> | null;
     ...
     *    Optional {@link FetchStreamSpec} for customizing fetching of RT objects.
     */
    allResults(spec?: FetchStreamSpec): Stream<ReliabilityOrchestrator.DatasetPreparationJobResult> | null;
     ...
     */
    customSummaryFieldsForResult(result: ReliabilityOrchestrator.DatasetPreparationJobResult): Map_Type<string, any> | null;
     ...
     * @return a table with a row for each step and the corresponding execution metadata.
     */
    summaryForResults(results: Array_Type<ReliabilityOrchestrator.DatasetPreparationJobResult>, spec?: Workflow.Monitorable.SummarySpec): Data;
     ...
     * @return a table with a row for each step and the corresponding execution metadata.
     */
    summaryForResultsPd(results: Array_Type<ReliabilityOrchestrator.DatasetPreparationJobResult>, spec?: Workflow.Monitorable.SummarySpec): any | null;
     ...
     */
    resultsForSummary(spec?: FetchSpec): FetchResult<ReliabilityOrchestrator.DatasetPreparationJobResult> | null;
  }
}
