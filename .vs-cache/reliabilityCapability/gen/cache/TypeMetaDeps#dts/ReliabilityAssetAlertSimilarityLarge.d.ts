// TypeScript definitions for the C3 type ReliabilityAssetAlertSimilarityLarge

/**
 * Type to store similarity for two {@link ReliabilityAssetAlert}s in the default key value database (Cassandra).
 * Used for deployments with a large volume of alerts.
 * For small volume of alerts use {@link ReliabilityAssetAlertSimilaritySmall}
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityAssetAlertSimilarityLarge
 */
declare interface IReliabilityAssetAlertSimilarityLarge {
 ...
 * For small volume of alerts use {@link ReliabilityAssetAlertSimilaritySmall}
 *
 * @remarks this represents a made instance of ReliabilityAssetAlertSimilarityLarge
 */
declare class ReliabilityAssetAlertSimilarityLarge extends Obj  {

  /**
   * {@link ReliabilityAssetAlert} whose creation prompted the generation of this similarity score.
   */
  readonly baseAlert: ReliabilityAssetAlert;
  withBaseAlert(baseAlert: IReliabilityAssetAlert): ReliabilityAssetAlertSimilarityLarge;

  /**
   * {@link ReliabilityAssetAlert} being compared against the base alert.
   */
  readonly comparableAlert: ReliabilityAssetAlert;
  withComparableAlert(comparableAlert: IReliabilityAssetAlert): ReliabilityAssetAlertSimilarityLarge;
  ...
  withSimilarityScore(similarityScore: number): ReliabilityAssetAlertSimilarityLarge;
  ...
  withDisplaySimilarity(displaySimilarity: any): ReliabilityAssetAlertSimilarityLarge;
   ...
   */
  readonly id: string;
  withId(id: string): ReliabilityAssetAlertSimilarityLarge;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityAssetAlertSimilarityLarge;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): ReliabilityAssetAlertSimilarityLarge;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): ReliabilityAssetAlertSimilarityLarge;
  ...
  withVersion(version: number | null): ReliabilityAssetAlertSimilarityLarge;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): ReliabilityAssetAlertSimilarityLarge;
   ...
   * @see #toJson
   */
  static fromJson(json: any): ReliabilityAssetAlertSimilarityLarge | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): ReliabilityAssetAlertSimilarityLarge | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): ReliabilityAssetAlertSimilarityLarge | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): ReliabilityAssetAlertSimilarityLarge | null;
   ...
   */
  replaceType(old: Type, new_: Type): ReliabilityAssetAlertSimilarityLarge;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityAssetAlertSimilarityLarge;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityAssetAlertSimilarityLarge;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityAssetAlertSimilarityLarge>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityAssetAlertSimilarityLarge>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityAssetAlertSimilarityLarge;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityAssetAlertSimilarityLarge;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityAssetAlertSimilarityLarge;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ReliabilityAssetAlertSimilarityLarge;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ReliabilityAssetAlertSimilarityLarge;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityAssetAlertSimilarityLarge;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityAssetAlertSimilarityLarge;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityAssetAlertSimilarityLarge;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ReliabilityAssetAlertSimilarityLarge;
   ...
   * @see #removeField
   */
  withoutField(field: string): ReliabilityAssetAlertSimilarityLarge;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): ReliabilityAssetAlertSimilarityLarge;
   ...
   */
  withoutFields(fields: Array_Type<string>): ReliabilityAssetAlertSimilarityLarge;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityAssetAlertSimilarityLarge;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ReliabilityAssetAlertSimilarityLarge;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityAssetAlertSimilarityLarge;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ReliabilityAssetAlertSimilarityLarge;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ReliabilityAssetAlertSimilarityLarge;
   ...
   * @see #removeField
   */
  unsetField(field: string): ReliabilityAssetAlertSimilarityLarge;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ReliabilityAssetAlertSimilarityLarge;
   ...
   * @see #unsetField
   */
  removeField(field: string): ReliabilityAssetAlertSimilarityLarge;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ReliabilityAssetAlertSimilarityLarge;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityAssetAlertSimilarityLarge;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityAssetAlertSimilarityLarge;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityAssetAlertSimilarityLarge;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityAssetAlertSimilarityLarge;

  mergeJson(json: any): ReliabilityAssetAlertSimilarityLarge;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityAssetAlertSimilarityLarge;
   ...
   */
  sumObj(other: Obj, deep?: boolean): ReliabilityAssetAlertSimilarityLarge;
   ...
   */
  singletonArray(): Array_Type<ReliabilityAssetAlertSimilarityLarge>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityAssetAlertSimilarityLarge> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ReliabilityAssetAlertSimilarityLarge> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<ReliabilityAssetAlertSimilarityLarge>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ReliabilityAssetAlertSimilarityLarge> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, ReliabilityAssetAlertSimilarityLarge> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityAssetAlertSimilarityLarge> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ReliabilityAssetAlertSimilarityLarge>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ReliabilityAssetAlertSimilarityLarge>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityAssetAlertSimilarityLarge;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityAssetAlertSimilarityLarge;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityAssetAlertSimilarityLarge;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ReliabilityAssetAlertSimilarityLarge;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityAssetAlertSimilarityLarge;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ReliabilityAssetAlertSimilarityLarge;
   ...
   * @see #fromString
   */
  static make(s: string): ReliabilityAssetAlertSimilarityLarge | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityAssetAlertSimilarityLarge;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): ReliabilityAssetAlertSimilarityLarge;
   ...
   */
  static cachedEmptyInst(): ReliabilityAssetAlertSimilarityLarge;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityAssetAlertSimilarityLarge> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): ReliabilityAssetAlertSimilarityLarge;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<ReliabilityAssetAlertSimilarityLarge>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<ReliabilityAssetAlertSimilarityLarge>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityAssetAlertSimilarityLarge> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityAssetAlertSimilarityLarge>> | null;
   ...
   */
  get(include?: string): ReliabilityAssetAlertSimilarityLarge | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): ReliabilityAssetAlertSimilarityLarge | null;
   ...
   */
  getMissing(spec: GetMissingSpec): ReliabilityAssetAlertSimilarityLarge;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): ReliabilityAssetAlertSimilarityLarge | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): ReliabilityAssetAlertSimilarityLarge;
   ...
   * @see #toString
   */
  static fromString(s: string): ReliabilityAssetAlertSimilarityLarge | null;
   ...
   */
  create(spec?: UpsertSpec): ReliabilityAssetAlertSimilarityLarge | null;
   ...
   */
  static createBatch(objs: Array_Type<ReliabilityAssetAlertSimilarityLarge>, spec?: UpsertSpec): ObjList<ReliabilityAssetAlertSimilarityLarge> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<ReliabilityAssetAlertSimilarityLarge>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityAssetAlertSimilarityLarge> | null;
   ...
   */
  update(srcObj?: ReliabilityAssetAlertSimilarityLarge, spec?: UpsertSpec): ReliabilityAssetAlertSimilarityLarge | null;
   ...
   */
  upsert(srcObj?: ReliabilityAssetAlertSimilarityLarge, spec?: UpsertSpec): ReliabilityAssetAlertSimilarityLarge | null;
   ...
   */
  merge(spec?: MergeSpec): ReliabilityAssetAlertSimilarityLarge | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): ReliabilityAssetAlertSimilarityLarge | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): ReliabilityAssetAlertSimilarityLarge | null;
   ...
   */
  static updateBatch(objs: Array_Type<ReliabilityAssetAlertSimilarityLarge>, srcObjs?: Array_Type<ReliabilityAssetAlertSimilarityLarge>, spec?: UpsertSpec): ObjList<ReliabilityAssetAlertSimilarityLarge> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<ReliabilityAssetAlertSimilarityLarge> | null>, spec?: UpsertSpec): ObjList<ReliabilityAssetAlertSimilarityLarge> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<ReliabilityAssetAlertSimilarityLarge>, srcObjs?: Array_Type<ReliabilityAssetAlertSimilarityLarge>, spec?: UpsertSpec): ObjList<ReliabilityAssetAlertSimilarityLarge> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<ReliabilityAssetAlertSimilarityLarge> | null>, spec?: UpsertSpec): ObjList<ReliabilityAssetAlertSimilarityLarge> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<ReliabilityAssetAlertSimilarityLarge>, spec?: TouchSpec): ObjList<ReliabilityAssetAlertSimilarityLarge> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityAssetAlertSimilarityLarge>, spec?: MergeSpec): ObjList<ReliabilityAssetAlertSimilarityLarge> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityAssetAlertSimilarityLarge>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityAssetAlertSimilarityLarge> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<ReliabilityAssetAlertSimilarityLarge> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityAssetAlertSimilarityLarge> | null;
   ...
   */
  static mergeAll(mergeObj: ReliabilityAssetAlertSimilarityLarge, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: ReliabilityAssetAlertSimilarityLarge, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<ReliabilityAssetAlertSimilarityLarge>, spec?: UpsertSpec): ObjList<ReliabilityAssetAlertSimilarityLarge> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<ReliabilityAssetAlertSimilarityLarge>, spec?: UpsertSpec): ObjList<ReliabilityAssetAlertSimilarityLarge> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): ReliabilityAssetAlertSimilarityLarge | null;
   ...
   */
  static beforeCreate(objs: Array_Type<ReliabilityAssetAlertSimilarityLarge>): ObjList<ReliabilityAssetAlertSimilarityLarge>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<ReliabilityAssetAlertSimilarityLarge>): ObjList<ReliabilityAssetAlertSimilarityLarge>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<ReliabilityAssetAlertSimilarityLarge>): ObjList<ReliabilityAssetAlertSimilarityLarge>;
   ...
   */
  static afterCreate(objs: Array_Type<ReliabilityAssetAlertSimilarityLarge>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<ReliabilityAssetAlertSimilarityLarge>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<ReliabilityAssetAlertSimilarityLarge>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityAssetAlertSimilarityLarge>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityAssetAlertSimilarityLarge>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): ReliabilityAssetAlertSimilarityLarge | null;
   ...
   */
  withoutIdentity(): ReliabilityAssetAlertSimilarityLarge | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<ReliabilityAssetAlertSimilarityLarge>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: ReliabilityAssetAlertSimilarityLarge, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<ReliabilityAssetAlertSimilarityLarge>, callback?: λFunction<ReliabilityAssetAlertSimilarityLarge | null, ReliabilityAssetAlertSimilarityLarge | null>): ObjList<ReliabilityAssetAlertSimilarityLarge>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<ReliabilityAssetAlertSimilarityLarge>, callback?: λFunction<ReliabilityAssetAlertSimilarityLarge | null, ReliabilityAssetAlertSimilarityLarge | null>): Array_Type<ObjError> | null;
