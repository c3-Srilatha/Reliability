// TypeScript definitions for the C3 type SensorOperationalStatus

/**
 * Type for storing the history of {@link SensorOperationalStatusTimedValue} for a {@link Sensor}
 *
 * @remarks this represents a value passed to a method that expects an instance of SensorOperationalStatus
 */
declare interface ISensorOperationalStatus {
 ...
 */
declare class SensorOperationalStatus extends Obj  {

  /**
   * Timestamp for the value.
   */
  readonly timestamp: DateTime;
  withTimestamp(timestamp: DateTime | Date | string): SensorOperationalStatus;

  /**
   * Parent/owning obj instance.
   */
  readonly parent: Sensor;
  withParent(parent: ISensor): SensorOperationalStatus;
  ...
  withStatus(status: string): SensorOperationalStatus;
  ...
  withEndDate(endDate: DateTime | Date | string | null): SensorOperationalStatus;
   ...
   */
  readonly id: string;
  withId(id: string): SensorOperationalStatus;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): SensorOperationalStatus;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): SensorOperationalStatus;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): SensorOperationalStatus;
  ...
  withVersion(version: number | null): SensorOperationalStatus;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): SensorOperationalStatus;

  /**
   * @inheritdoc
   */
  readonly facilityFilterPaths?: Array_Type<string>;
  withFacilityFilterPaths(facilityFilterPaths: Array_Type<string> | Array<string> | null): SensorOperationalStatus;
   ...
   * @see #toJson
   */
  static fromJson(json: any): SensorOperationalStatus | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): SensorOperationalStatus | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): SensorOperationalStatus | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): SensorOperationalStatus | null;
   ...
   */
  replaceType(old: Type, new_: Type): SensorOperationalStatus;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): SensorOperationalStatus;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): SensorOperationalStatus;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<SensorOperationalStatus>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<SensorOperationalStatus>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): SensorOperationalStatus;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SensorOperationalStatus;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SensorOperationalStatus;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): SensorOperationalStatus;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): SensorOperationalStatus;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): SensorOperationalStatus;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): SensorOperationalStatus;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): SensorOperationalStatus;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): SensorOperationalStatus;
   ...
   * @see #removeField
   */
  withoutField(field: string): SensorOperationalStatus;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): SensorOperationalStatus;
   ...
   */
  withoutFields(fields: Array_Type<string>): SensorOperationalStatus;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): SensorOperationalStatus;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): SensorOperationalStatus;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): SensorOperationalStatus;
   ...
   * @see #unsetField
   */
  defaultField(field: string): SensorOperationalStatus;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): SensorOperationalStatus;
   ...
   * @see #removeField
   */
  unsetField(field: string): SensorOperationalStatus;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): SensorOperationalStatus;
   ...
   * @see #unsetField
   */
  removeField(field: string): SensorOperationalStatus;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): SensorOperationalStatus;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): SensorOperationalStatus;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): SensorOperationalStatus;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): SensorOperationalStatus;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): SensorOperationalStatus;

  mergeJson(json: any): SensorOperationalStatus;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): SensorOperationalStatus;
   ...
   */
  sumObj(other: Obj, deep?: boolean): SensorOperationalStatus;
   ...
   */
  singletonArray(): Array_Type<SensorOperationalStatus>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<SensorOperationalStatus> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<SensorOperationalStatus> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<SensorOperationalStatus>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<SensorOperationalStatus> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, SensorOperationalStatus> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, SensorOperationalStatus> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<SensorOperationalStatus>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<SensorOperationalStatus>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): SensorOperationalStatus;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): SensorOperationalStatus;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): SensorOperationalStatus;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): SensorOperationalStatus;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): SensorOperationalStatus;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): SensorOperationalStatus;
   ...
   * @see #fromString
   */
  static make(s: string): SensorOperationalStatus | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): SensorOperationalStatus;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): SensorOperationalStatus;
   ...
   */
  static cachedEmptyInst(): SensorOperationalStatus;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<SensorOperationalStatus> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): SensorOperationalStatus;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<SensorOperationalStatus>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<SensorOperationalStatus>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<SensorOperationalStatus> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<SensorOperationalStatus>> | null;
   ...
   */
  get(include?: string): SensorOperationalStatus | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): SensorOperationalStatus | null;
   ...
   */
  getMissing(spec: GetMissingSpec): SensorOperationalStatus;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): SensorOperationalStatus | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): SensorOperationalStatus;
   ...
   * @see #toString
   */
  static fromString(s: string): SensorOperationalStatus | null;
   ...
   */
  create(spec?: UpsertSpec): SensorOperationalStatus | null;
   ...
   */
  static createBatch(objs: Array_Type<SensorOperationalStatus>, spec?: UpsertSpec): ObjList<SensorOperationalStatus> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<SensorOperationalStatus>, spec?: CreateBatchObjStreamSpec): ObjList<SensorOperationalStatus> | null;
   ...
   */
  update(srcObj?: SensorOperationalStatus, spec?: UpsertSpec): SensorOperationalStatus | null;
   ...
   */
  upsert(srcObj?: SensorOperationalStatus, spec?: UpsertSpec): SensorOperationalStatus | null;
   ...
   */
  merge(spec?: MergeSpec): SensorOperationalStatus | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): SensorOperationalStatus | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): SensorOperationalStatus | null;
   ...
   */
  static updateBatch(objs: Array_Type<SensorOperationalStatus>, srcObjs?: Array_Type<SensorOperationalStatus>, spec?: UpsertSpec): ObjList<SensorOperationalStatus> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<SensorOperationalStatus> | null>, spec?: UpsertSpec): ObjList<SensorOperationalStatus> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<SensorOperationalStatus>, srcObjs?: Array_Type<SensorOperationalStatus>, spec?: UpsertSpec): ObjList<SensorOperationalStatus> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<SensorOperationalStatus> | null>, spec?: UpsertSpec): ObjList<SensorOperationalStatus> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<SensorOperationalStatus>, spec?: TouchSpec): ObjList<SensorOperationalStatus> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<SensorOperationalStatus>, spec?: MergeSpec): ObjList<SensorOperationalStatus> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<SensorOperationalStatus>, mergeInclude: string, spec?: MergeSpec): ObjList<SensorOperationalStatus> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<SensorOperationalStatus> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<SensorOperationalStatus> | null;
   ...
   */
  static mergeAll(mergeObj: SensorOperationalStatus, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: SensorOperationalStatus, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<SensorOperationalStatus>, spec?: UpsertSpec): ObjList<SensorOperationalStatus> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<SensorOperationalStatus>, spec?: UpsertSpec): ObjList<SensorOperationalStatus> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): SensorOperationalStatus | null;
   ...
   */
  static beforeCreate(objs: Array_Type<SensorOperationalStatus>): ObjList<SensorOperationalStatus>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<SensorOperationalStatus>): ObjList<SensorOperationalStatus>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<SensorOperationalStatus>): ObjList<SensorOperationalStatus>;
   ...
   */
  static afterCreate(objs: Array_Type<SensorOperationalStatus>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<SensorOperationalStatus>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<SensorOperationalStatus>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<SensorOperationalStatus>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<SensorOperationalStatus>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): SensorOperationalStatus | null;
   ...
   */
  withoutIdentity(): SensorOperationalStatus | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<SensorOperationalStatus>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: SensorOperationalStatus, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<SensorOperationalStatus>, callback?: λFunction<SensorOperationalStatus | null, SensorOperationalStatus | null>): ObjList<SensorOperationalStatus>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<SensorOperationalStatus>, callback?: λFunction<SensorOperationalStatus | null, SensorOperationalStatus | null>): Array_Type<ObjError> | null;
