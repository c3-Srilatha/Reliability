// TypeScript definitions for the C3 type ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker

/**
 * A type to store intermediate and final results for a given {@link ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob}.
 * The final result stored is the {@link MlModel.Train.Job} that is created by the
 * {@link ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob}. This job can then be used to subsequently train all the
 * {@link ReliabilityRiskMlModel}s that are created by the {@link ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob}.
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker
 */
declare namespace ReliabilityOrchestrator.ReliabilityRisk {
  export interface IModelCreationJobTracker {
    ...
    /**
     * An {@link ReliabilityRiskMlModel} that is created by the {@link #modelCreationJob}
     */
    model?: IReliabilityRiskMlModel;

    /**
     * The {@link ReliabilityMlDatasetPreparationRun} that is used to train the given {@link #model}
     */
    datasetPreparationRun?: IReliabilityMlDatasetPreparationRun;

    /**
     * The {@link MlOperationSpec} that will be used to train the created {@link ReliabilityRiskMlModel}
     */
    mlOperationSpec?: IMlOperationSpec;

    /**
     * The {@link ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob} that is used to create the given {@link #model}
     */
    modelCreationJob?: IReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob;

    /**
     * The {@link MlModel.Train.Job} that is created by the {@link #modelCreationJob}
     */
    modelTrainingJob?: IMlModel.Train.Job;
  }
}
 ...
 * {@link ReliabilityRiskMlModel}s that are created by the {@link ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob}.
 *
 * @remarks this represents a made instance of ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker
 */
declare namespace ReliabilityOrchestrator.ReliabilityRisk {
  export class ModelCreationJobTracker extends Obj  {
     ...
     */
    readonly id: string;
    withId(id: string): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker;
    ...
    withVersion(version: number | null): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker;

    /**
     * An {@link ReliabilityRiskMlModel} that is created by the {@link #modelCreationJob}
     */
    readonly model?: ReliabilityRiskMlModel;
    withModel(model: IReliabilityRiskMlModel | null): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker;

    /**
     * The {@link ReliabilityMlDatasetPreparationRun} that is used to train the given {@link #model}
     */
    readonly datasetPreparationRun?: ReliabilityMlDatasetPreparationRun;
    withDatasetPreparationRun(datasetPreparationRun: IReliabilityMlDatasetPreparationRun | null): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker;

    /**
     * The {@link MlOperationSpec} that will be used to train the created {@link ReliabilityRiskMlModel}
     */
    readonly mlOperationSpec?: MlOperationSpec;
    withMlOperationSpec(mlOperationSpec: IMlOperationSpec | null): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker;

    /**
     * The {@link ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob} that is used to create the given {@link #model}
     */
    readonly modelCreationJob?: ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob;
    withModelCreationJob(modelCreationJob: IReliabilityOrchestrator.ReliabilityRisk.ModelCreationJob | null): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker;

    /**
     * The {@link MlModel.Train.Job} that is created by the {@link #modelCreationJob}
     */
    readonly modelTrainingJob?: MlModel.Train.Job;
    withModelTrainingJob(modelTrainingJob: IMlModel.Train.Job | null): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker;
     ...
     * @see #toJson
     */
    static fromJson(json: any): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker | null;
     ...
     */
    replaceType(old: Type, new_: Type): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker;
     ...
     * @see #removeField
     */
    withoutField(field: string): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker;
     ...
     */
    withoutFields(fields: Array_Type<string>): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker;
     ...
     * @see #unsetField
     */
    defaultField(field: string): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker;
     ...
     * @see #removeField
     */
    unsetField(field: string): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker;
     ...
     * @see #unsetField
     */
    removeField(field: string): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker;

    mergeJson(json: any): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker;
     ...
     */
    sumObj(other: Obj, deep?: boolean): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker;
     ...
     */
    singletonArray(): Array_Type<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker;
     ...
     * @see #fromString
     */
    static make(s: string): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker;
     ...
     */
    static cachedEmptyInst(): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker>> | null;
     ...
     */
    get(include?: string): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker | null;
     ...
     */
    getMissing(spec: GetMissingSpec): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker;
     ...
     * @see #toString
     */
    static fromString(s: string): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker | null;
     ...
     */
    create(spec?: UpsertSpec): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker | null;
     ...
     */
    static createBatch(objs: Array_Type<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker> | null;
     ...
     */
    update(srcObj?: ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker, spec?: UpsertSpec): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker | null;
     ...
     */
    upsert(srcObj?: ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker, spec?: UpsertSpec): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker | null;
     ...
     */
    merge(spec?: MergeSpec): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker | null;
     ...
     */
    static updateBatch(objs: Array_Type<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker>, srcObjs?: Array_Type<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker> | null>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker>, srcObjs?: Array_Type<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker> | null>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker>, spec?: TouchSpec): ObjList<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker>, spec?: MergeSpec): ObjList<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker> | null;
     ...
     */
    static mergeAll(mergeObj: ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker | null;
     ...
     */
    static beforeCreate(objs: Array_Type<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker>): ObjList<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker>): ObjList<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker>): ObjList<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker>;
     ...
     */
    static afterCreate(objs: Array_Type<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker | null;
     ...
     */
    withoutIdentity(): ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker>, callback?: λFunction<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker | null, ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker | null>): ObjList<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker>, callback?: λFunction<ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker | null, ReliabilityOrchestrator.ReliabilityRisk.ModelCreationJobTracker | null>): Array_Type<ObjError> | null;
