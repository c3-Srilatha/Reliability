// TypeScript definitions for the C3 type ProtectionLoopAlertTransition

/**
 * Represents a state transition for {@link ProtectionLoopAlertState} within a state machine.
 * This entity defines the allowable transitions between different protection loop alert states.
 *
 * @remarks this represents a value passed to a method that expects an instance of ProtectionLoopAlertTransition
 */
declare interface IProtectionLoopAlertTransition {
   ...
   */
  from: IProtectionLoopAlertState;

  /**
   * The {@link StateMachineState} to transition to.
   */
  to: IProtectionLoopAlertState;
 ...
 * This entity defines the allowable transitions between different protection loop alert states.
 *
 * @remarks this represents a made instance of ProtectionLoopAlertTransition
 */
declare class ProtectionLoopAlertTransition extends Obj  {
   ...
   */
  readonly id: string;
  withId(id: string): ProtectionLoopAlertTransition;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ProtectionLoopAlertTransition;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): ProtectionLoopAlertTransition;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): ProtectionLoopAlertTransition;
  ...
  withVersion(version: number | null): ProtectionLoopAlertTransition;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): ProtectionLoopAlertTransition;
  ...
  withUserUpdatedFields(userUpdatedFields: Array_Type<string> | Array<string> | null): ProtectionLoopAlertTransition;
  ...
  withHidden(hidden: boolean): ProtectionLoopAlertTransition;
  ...
  withUserOwned(userOwned: boolean): ProtectionLoopAlertTransition;

  /**
   * List of {@link AclEntry} entries governing who can read/update/remove Objs.
   */
  readonly acl?: Array_Type<AclEntry>;
  withAcl(acl: Array_Type<AclEntry> | Array<IAclEntry> | null): ProtectionLoopAlertTransition;

  /**
   * The {@link StateMachineState} to transition from.
   */
  readonly from: ProtectionLoopAlertState;
  withFrom(from: IProtectionLoopAlertState): ProtectionLoopAlertTransition;

  /**
   * The {@link StateMachineState} to transition to.
   */
  readonly to: ProtectionLoopAlertState;
  withTo(to: IProtectionLoopAlertState): ProtectionLoopAlertTransition;

  /**
   * Used to soft delete a record so all state histories still have valid pointers.
   */
  readonly deleted?: boolean;
  withDeleted(deleted: boolean): ProtectionLoopAlertTransition;

  /**
   * A transition is only valid if the {@link from}, {@link to}, and itself are not deleted.
   */
  readonly isValid?: boolean;
  withIsValid(isValid: boolean): ProtectionLoopAlertTransition;

  /**
   * The trigger that must be satisfied in order for this transition to take place.
   */
  readonly trigger?: TransitionTrigger;
  withTrigger(trigger: ITransitionTrigger | null): ProtectionLoopAlertTransition;
  ...
  withCondition(condition: string | null): ProtectionLoopAlertTransition;

  /**
   * Used to include fields on the source type for exitAction and entryAction.
   */
  readonly includeSpec?: string;
  withIncludeSpec(includeSpec: string | null): ProtectionLoopAlertTransition;

  /**
   * The action to be taken during this {@link StateMachineTransition}.
   */
  readonly action?: λConsumer<any | null>;
  withAction(action: λConsumer<any | null> | null): ProtectionLoopAlertTransition;
   ...
   * @see #toJson
   */
  static fromJson(json: any): ProtectionLoopAlertTransition | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): ProtectionLoopAlertTransition | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): ProtectionLoopAlertTransition | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): ProtectionLoopAlertTransition | null;
   ...
   */
  replaceType(old: Type, new_: Type): ProtectionLoopAlertTransition;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ProtectionLoopAlertTransition;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ProtectionLoopAlertTransition;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ProtectionLoopAlertTransition>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ProtectionLoopAlertTransition>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ProtectionLoopAlertTransition;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ProtectionLoopAlertTransition;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ProtectionLoopAlertTransition;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ProtectionLoopAlertTransition;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ProtectionLoopAlertTransition;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ProtectionLoopAlertTransition;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ProtectionLoopAlertTransition;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ProtectionLoopAlertTransition;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ProtectionLoopAlertTransition;
   ...
   * @see #removeField
   */
  withoutField(field: string): ProtectionLoopAlertTransition;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): ProtectionLoopAlertTransition;
   ...
   */
  withoutFields(fields: Array_Type<string>): ProtectionLoopAlertTransition;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): ProtectionLoopAlertTransition;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ProtectionLoopAlertTransition;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ProtectionLoopAlertTransition;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ProtectionLoopAlertTransition;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ProtectionLoopAlertTransition;
   ...
   * @see #removeField
   */
  unsetField(field: string): ProtectionLoopAlertTransition;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ProtectionLoopAlertTransition;
   ...
   * @see #unsetField
   */
  removeField(field: string): ProtectionLoopAlertTransition;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ProtectionLoopAlertTransition;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ProtectionLoopAlertTransition;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): ProtectionLoopAlertTransition;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ProtectionLoopAlertTransition;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ProtectionLoopAlertTransition;

  mergeJson(json: any): ProtectionLoopAlertTransition;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ProtectionLoopAlertTransition;
   ...
   */
  sumObj(other: Obj, deep?: boolean): ProtectionLoopAlertTransition;
   ...
   */
  singletonArray(): Array_Type<ProtectionLoopAlertTransition>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<ProtectionLoopAlertTransition> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ProtectionLoopAlertTransition> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<ProtectionLoopAlertTransition>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ProtectionLoopAlertTransition> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, ProtectionLoopAlertTransition> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ProtectionLoopAlertTransition> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ProtectionLoopAlertTransition>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ProtectionLoopAlertTransition>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ProtectionLoopAlertTransition;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ProtectionLoopAlertTransition;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ProtectionLoopAlertTransition;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ProtectionLoopAlertTransition;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ProtectionLoopAlertTransition;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ProtectionLoopAlertTransition;
   ...
   * @see #fromString
   */
  static make(s: string): ProtectionLoopAlertTransition | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ProtectionLoopAlertTransition;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): ProtectionLoopAlertTransition;
   ...
   */
  static cachedEmptyInst(): ProtectionLoopAlertTransition;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<ProtectionLoopAlertTransition> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): ProtectionLoopAlertTransition;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<ProtectionLoopAlertTransition> | null;
   ...
   */
  static find(filter?: string, doNotProduceAll?: boolean): Stream<ProtectionLoopAlertTransition> | null;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<ProtectionLoopAlertTransition> | null;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): ProtectionLoopAlertTransition | null;
   ...
   * @see findByCacheKey
   */
  static forCacheKey(key: string): ProtectionLoopAlertTransition | null;
   ...
   * @see findByCacheKey
   */
  getCached(): ProtectionLoopAlertTransition | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): ProtectionLoopAlertTransition | null;
   ...
   */
  static produce(key: string): ProtectionLoopAlertTransition | null;
   ...
   */
  static produceAll(): Map_Type<string, ProtectionLoopAlertTransition> | null;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): Map_Type<string, ProtectionLoopAlertTransition> | null;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<ProtectionLoopAlertTransition>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<ProtectionLoopAlertTransition>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<ProtectionLoopAlertTransition> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ProtectionLoopAlertTransition>> | null;
   ...
   */
  get(include?: string): ProtectionLoopAlertTransition | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): ProtectionLoopAlertTransition | null;
   ...
   */
  getMissing(spec: GetMissingSpec): ProtectionLoopAlertTransition;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): ProtectionLoopAlertTransition | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): ProtectionLoopAlertTransition;
   ...
   * @see #toString
   */
  static fromString(s: string): ProtectionLoopAlertTransition | null;
   ...
   */
  create(spec?: UpsertSpec): ProtectionLoopAlertTransition | null;
   ...
   */
  static createBatch(objs: Array_Type<ProtectionLoopAlertTransition>, spec?: UpsertSpec): ObjList<ProtectionLoopAlertTransition> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<ProtectionLoopAlertTransition>, spec?: CreateBatchObjStreamSpec): ObjList<ProtectionLoopAlertTransition> | null;
   ...
   */
  update(srcObj?: ProtectionLoopAlertTransition, spec?: UpsertSpec): ProtectionLoopAlertTransition | null;
   ...
   */
  upsert(srcObj?: ProtectionLoopAlertTransition, spec?: UpsertSpec): ProtectionLoopAlertTransition | null;
   ...
   */
  merge(spec?: MergeSpec): ProtectionLoopAlertTransition | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): ProtectionLoopAlertTransition | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): ProtectionLoopAlertTransition | null;
   ...
   */
  static updateBatch(objs: Array_Type<ProtectionLoopAlertTransition>, srcObjs?: Array_Type<ProtectionLoopAlertTransition>, spec?: UpsertSpec): ObjList<ProtectionLoopAlertTransition> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<ProtectionLoopAlertTransition> | null>, spec?: UpsertSpec): ObjList<ProtectionLoopAlertTransition> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<ProtectionLoopAlertTransition>, srcObjs?: Array_Type<ProtectionLoopAlertTransition>, spec?: UpsertSpec): ObjList<ProtectionLoopAlertTransition> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<ProtectionLoopAlertTransition> | null>, spec?: UpsertSpec): ObjList<ProtectionLoopAlertTransition> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<ProtectionLoopAlertTransition>, spec?: TouchSpec): ObjList<ProtectionLoopAlertTransition> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ProtectionLoopAlertTransition>, spec?: MergeSpec): ObjList<ProtectionLoopAlertTransition> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ProtectionLoopAlertTransition>, mergeInclude: string, spec?: MergeSpec): ObjList<ProtectionLoopAlertTransition> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<ProtectionLoopAlertTransition> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ProtectionLoopAlertTransition> | null;
   ...
   */
  static mergeAll(mergeObj: ProtectionLoopAlertTransition, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: ProtectionLoopAlertTransition, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<ProtectionLoopAlertTransition>, spec?: UpsertSpec): ObjList<ProtectionLoopAlertTransition> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<ProtectionLoopAlertTransition>, spec?: UpsertSpec): ObjList<ProtectionLoopAlertTransition> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): ProtectionLoopAlertTransition | null;
   ...
   */
  static beforeCreate(objs: Array_Type<ProtectionLoopAlertTransition>): ObjList<ProtectionLoopAlertTransition>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<ProtectionLoopAlertTransition>): ObjList<ProtectionLoopAlertTransition>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<ProtectionLoopAlertTransition>): ObjList<ProtectionLoopAlertTransition>;
   ...
   */
  static afterCreate(objs: Array_Type<ProtectionLoopAlertTransition>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<ProtectionLoopAlertTransition>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<ProtectionLoopAlertTransition>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<ProtectionLoopAlertTransition>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ProtectionLoopAlertTransition>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): ProtectionLoopAlertTransition | null;
   ...
   */
  withoutIdentity(): ProtectionLoopAlertTransition | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<ProtectionLoopAlertTransition>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: ProtectionLoopAlertTransition, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<ProtectionLoopAlertTransition>, callback?: λFunction<ProtectionLoopAlertTransition | null, ProtectionLoopAlertTransition | null>): ObjList<ProtectionLoopAlertTransition>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<ProtectionLoopAlertTransition>, callback?: λFunction<ProtectionLoopAlertTransition | null, ProtectionLoopAlertTransition | null>): Array_Type<ObjError> | null;
   ...
   */
  publish(subPath?: string, contentType?: string): ProtectionLoopAlertTransition;
   ...
   */
  static removeSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<ProtectionLoopAlertTransition> | null;
   ...
   */
  createSeedData(spec?: UpsertSpec): ProtectionLoopAlertTransition | null;
   ...
   */
  static createSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<ProtectionLoopAlertTransition> | null;
   ...
   */
  updateSeedData(srcObj?: SeedData, spec?: UpsertSpec): ProtectionLoopAlertTransition | null;
   ...
   */
  static updateSeedDataBatch(objs?: Array_Type<SeedData>, srcObjs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<ProtectionLoopAlertTransition> | null;
   ...
   * @return updated obj instance, same as {@link Persistable#update} return value.
   */
  clearUserUpdates(spec?: MergeSpec): ProtectionLoopAlertTransition | null;
   ...
   *         {@link Persistable#updateBatch}.
   */
  static clearUserUpdatesBatch(objs?: Array_Type<SeedData>, spec?: MergeSpec): ObjList<ProtectionLoopAlertTransition> | null;
  ...
  dependencies(): SeedDataDeps<ProtectionLoopAlertTransition> | null;
   ...
   */
  static populateAcl(objs?: Array_Type<ProtectionLoopAlertTransition>): number | null;
   ...
   */
  grantMemberReadUpdateRemove(member: AccessControlEntity): ProtectionLoopAlertTransition;
   ...
   */
  mergeAclEntry(entry: AclEntry): ProtectionLoopAlertTransition;
   ...
   * @return the obj with the new acl after merging the indicated entry.
   */
  mergeAclEntries(entries: Array_Type<AclEntry>): ProtectionLoopAlertTransition;
