// TypeScript definitions for the C3 type NotificationConfig

/**
 * @inheritdoc
 *
 * @remarks this represents a value passed to a method that expects an instance of NotificationConfig
 */
declare interface INotificationConfig {
  ...
  /**
   * Unsubscribe text in each notification
   * The text and URL are in HTML format (e.g. <p> To unsubscribe click <a href = ''>unsubscribe</a></p>)
   */
  unsubscribeText?: string;

  /**
   * Configuration for the batch email subject.
   */
  batchSubject?: string;

  /**
   * Default batch period to use if not defined
   * Unit: number of minutes
   */
  defaultBatchPeriod?: number;

  /**
   * The email address the notifications are sent from
   */
  fromAddress?: string;
}
 ...
 * @inheritdoc
 *
 * @remarks this represents a made instance of NotificationConfig
 */
declare class NotificationConfig extends Obj  {

  readonly configOverride?: string;
  withConfigOverride(configOverride: string | null): NotificationConfig;

  static readonly configOverride?: string;

  readonly secretOverride?: string;
  withSecretOverride(secretOverride: string | null): NotificationConfig;
  ...
  withIssues(issues: Array_Type<string> | Array<string> | null): NotificationConfig;
  ...
  withUnsubscribeText(unsubscribeText: string | null): NotificationConfig;

  /**
   * Unsubscribe text in each notification
   * The text and URL are in HTML format (e.g. <p> To unsubscribe click <a href = ''>unsubscribe</a></p>)
   */
  static readonly unsubscribeText?: string;

  /**
   * Configuration for the batch email subject.
   */
  readonly batchSubject?: string;
  withBatchSubject(batchSubject: string | null): NotificationConfig;

  /**
   * Configuration for the batch email subject.
   */
  static readonly batchSubject?: string;

  /**
   * Default batch period to use if not defined
   * Unit: number of minutes
   */
  readonly defaultBatchPeriod?: number;
  withDefaultBatchPeriod(defaultBatchPeriod: number | null): NotificationConfig;

  /**
   * Default batch period to use if not defined
   * Unit: number of minutes
   */
  static readonly defaultBatchPeriod?: number;

  /**
   * The email address the notifications are sent from
   */
  readonly fromAddress?: string;
  withFromAddress(fromAddress: string | null): NotificationConfig;

  /**
   * The email address the notifications are sent from
   */
  static readonly fromAddress?: string;
   ...
   * @see #toJson
   */
  static fromJson(json: any): NotificationConfig | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): NotificationConfig | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): NotificationConfig | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): NotificationConfig | null;
   ...
   */
  replaceType(old: Type, new_: Type): NotificationConfig;
   ...
   * This method is used during live metadata update
   */
  static replaceType(old: Type, new_: Type): NotificationConfig;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): NotificationConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): NotificationConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): NotificationConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): NotificationConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<NotificationConfig>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<NotificationConfig>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<NotificationConfig>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<NotificationConfig>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): NotificationConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): NotificationConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): NotificationConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): NotificationConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): NotificationConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): NotificationConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): NotificationConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  static validateObj(): NotificationConfig;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): NotificationConfig;
   ...
   * @see #defaultField
   */
  static withField(field: string, value: any, doNotConvert?: boolean): NotificationConfig;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): NotificationConfig;
   ...
   * @see #defaultField
   */
  static withField(field: FieldType, value: any, doNotConvert?: boolean): NotificationConfig;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): NotificationConfig;
   ...
   * @return new Obj
   */
  static withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): NotificationConfig;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): NotificationConfig;
   ...
   * @return new Obj
   */
  static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): NotificationConfig;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): NotificationConfig;
   ...
   * @see #withoutField
   */
  static withoutFieldAtPath(path: string): NotificationConfig;
   ...
   * @see #removeField
   */
  withoutField(field: string): NotificationConfig;
   ...
   * @see #removeField
   */
  static withoutField(field: string): NotificationConfig;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): NotificationConfig;
   ...
   * @see #removeField
   */
  static withoutField(field: FieldType): NotificationConfig;
   ...
   */
  withoutFields(fields: Array_Type<string>): NotificationConfig;
   ...
   * @return new Obj with removed fields
   */
  static withoutFields(fields: Array_Type<string>): NotificationConfig;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): NotificationConfig;
   ...
   * @return new Obj with removed fields
   */
  static withoutFieldsByType(fields: Array_Type<FieldType>): NotificationConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): NotificationConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  static withoutSecretFields(): NotificationConfig;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): NotificationConfig;
   ...
   * @see FieldType#defaultValue
   */
  static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): NotificationConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: string): NotificationConfig;
   ...
   * @see #unsetField
   */
  static defaultField(field: string): NotificationConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): NotificationConfig;
   ...
   * @see #unsetField
   */
  static defaultField(field: FieldType): NotificationConfig;
   ...
   * @see #removeField
   */
  unsetField(field: string): NotificationConfig;
   ...
   * @see #removeField
   */
  static unsetField(field: string): NotificationConfig;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): NotificationConfig;
   ...
   * @see #removeField
   */
  static unsetField(field: FieldType): NotificationConfig;
   ...
   * @see #unsetField
   */
  removeField(field: string): NotificationConfig;
   ...
   * @see #unsetField
   */
  static removeField(field: string): NotificationConfig;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): NotificationConfig;
   ...
   * @see #unsetField
   */
  static removeField(field: FieldType): NotificationConfig;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): NotificationConfig;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): NotificationConfig;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): NotificationConfig;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj, otherFieldsFilter: Type): NotificationConfig;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): NotificationConfig;
   ...
   *        the same key or index.
   */
  static mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): NotificationConfig;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): NotificationConfig;
   ...
   * traverse child reference and collection fields.
   */
  static mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): NotificationConfig;

  mergeJson(json: any): NotificationConfig;

  static mergeJson(json: any): NotificationConfig;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): NotificationConfig;
   ...
   * @return Obj with child references merged
   */
  static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): NotificationConfig;
   ...
   */
  sumObj(other: Obj, deep?: boolean): NotificationConfig;
   ...
   * references with same name and collection elements at same index or key.
   */
  static sumObj(other: Obj, deep?: boolean): NotificationConfig;
   ...
   */
  singletonArray(): Array_Type<NotificationConfig>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonArray(): Array_Type<NotificationConfig>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<NotificationConfig> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<NotificationConfig> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<NotificationConfig>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonSet(): Set_Type<NotificationConfig>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<NotificationConfig> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, NotificationConfig> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, NotificationConfig> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<NotificationConfig>;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  static toBuilder(): ObjBuilder<NotificationConfig>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<NotificationConfig>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): NotificationConfig;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): NotificationConfig;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): NotificationConfig;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): NotificationConfig;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): NotificationConfig;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): NotificationConfig;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): NotificationConfig;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  static afterMake(): NotificationConfig;
   ...
   */
  static cachedEmptyInst(): NotificationConfig;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<NotificationConfig> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): NotificationConfig;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<NotificationConfig> | null;
   ...
   */
  static find(filter?: string, doNotProduceAll?: boolean): Stream<NotificationConfig> | null;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<NotificationConfig> | null;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): NotificationConfig | null;

  /**
   * Returns cached instance by key, with secrets removed.
   */
  static forCacheKey(key: string): NotificationConfig | null;
   ...
   * @see findByCacheKey
   */
  getCached(): NotificationConfig | null;
   ...
   * @see findByCacheKey
   */
  static getCached(): NotificationConfig | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): NotificationConfig | null;

  /**
   * @return newly produced cached instance.
   */
  static refreshCache(): NotificationConfig | null;
   ...
   */
  static produce(key: string): NotificationConfig | null;
   ...
   */
  static produceAll(): Map_Type<string, NotificationConfig> | null;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): Map_Type<string, NotificationConfig> | null;
   ...
   * Note that typical pattern is to use Configurable#configWithSecrets instead of this method.
   */
  static getSecret(): NotificationConfig;
   ...
   */
  withConfigKey(configKey: string): NotificationConfig;
   ...
   *     config.configKey() => "folder1/abc"
   */
  static withConfigKey(configKey: string): NotificationConfig;

  /**
   * @return copy without config key.
   */
  withoutConfigKey(): NotificationConfig;

  /**
   * @return copy without config key.
   */
  static withoutConfigKey(): NotificationConfig;

  /**
   * @return return cached config instance for provided config key.
   */
  static forConfigKey(configKey: string): NotificationConfig | null;
   ...
   */
  static listConfigs(parallel?: boolean, filter?: λPredicate<string>): Stream<NotificationConfig> | null;
   ...
   * @see setConfigValue
   */
  setConfigValues(from: NotificationConfig, override?: string): void;

  /**
   * Sets multiple field values to be the same as the passed instance.
   * @see setConfigValue
   */
  static setConfigValues(from: NotificationConfig, override?: string): void;
   ...
   * @see setSecretValue
   */
  setSecretValues(from: NotificationConfig, override?: string): void;

  /**
   * Sets multiple secret field values to be the same as the passed instance.
   * @see setSecretValue
   */
  static setSecretValues(from: NotificationConfig, override?: string): void;
   ...
   */
  static loadConfigAndSecret(configKey: string): NotificationConfig | null;
   ...
   */
  removeSecrets(): NotificationConfig | null;

  /**
   * @return this config without any secret values.
   */
  static removeSecrets(): NotificationConfig | null;

  /**
   * @return this config with only secret values.
   */
  removeNonSecrets(): NotificationConfig | null;

  /**
   * @return this config with only secret values.
   */
  static removeNonSecrets(): NotificationConfig | null;
   ...
   * validation and setup.
   */
  static validate(): NotificationConfig;
