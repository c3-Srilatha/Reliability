// TypeScript definitions for the C3 type ReliabilityOrchestrator.AutomatedRetrainingJobResult

/**
 * Represents the automated retraining workflow that will be executed to retrain a single
 * {@link ReliabilityMlModel} using the project's configured retraining lambda.
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityOrchestrator.AutomatedRetrainingJobResult
 */
declare namespace ReliabilityOrchestrator {
  export interface IAutomatedRetrainingJobResult {
    ...
    /**
     * The {@link ReliabilityMlModel} to be retrained. This model must have an associated project
     * with a configured retrainingWorkflowLambda.
     */
    model: IReliabilityMlModel;

    /**
     * Contains the retrained {@link ReliabilityMlModel} that is output by the workflow created using lambda.
     */
    retrainedModel?: IReliabilityMlModel;

    /**
     * Errors when {@link ReliabilityMl.Project#retrainingWorkflowLambda} failed, did not produce any retrained models, or returned an error.
     */
    errorMessages?: Array_Type<string> | Array<string>;
  }
}
 ...
 * {@link ReliabilityMlModel} using the project's configured retraining lambda.
 *
 * @remarks this represents a made instance of ReliabilityOrchestrator.AutomatedRetrainingJobResult
 */
declare namespace ReliabilityOrchestrator {
  export class AutomatedRetrainingJobResult extends Obj  {

    /**
     * The unique and required name of this instance.
     */
    readonly name: string;
    withName(name: string): ReliabilityOrchestrator.AutomatedRetrainingJobResult;
    ...
    withTypeIdent(typeIdent: string | null): ReliabilityOrchestrator.AutomatedRetrainingJobResult;
     ...
     */
    readonly id: string;
    withId(id: string): ReliabilityOrchestrator.AutomatedRetrainingJobResult;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityOrchestrator.AutomatedRetrainingJobResult;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): ReliabilityOrchestrator.AutomatedRetrainingJobResult;
    ...
    withVersion(version: number | null): ReliabilityOrchestrator.AutomatedRetrainingJobResult;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): ReliabilityOrchestrator.AutomatedRetrainingJobResult;

    /**
     * Parent {@link MlWorkflowCoordinatable} that this result belongs to.
     */
    readonly parentCoordinator: MlWorkflowCoordinatable<MlWorkflowCoordinatableResult>;
    withParentCoordinator(parentCoordinator: IMlWorkflowCoordinatable<MlWorkflowCoordinatableResult>): ReliabilityOrchestrator.AutomatedRetrainingJobResult;
    ...
    withStatusForCoordinatable(statusForCoordinatable: string): ReliabilityOrchestrator.AutomatedRetrainingJobResult;

    /**
     * Number of times the {@link #parentCoordinator} has canceled this result.
     */
    readonly canceledCount?: number;
    withCanceledCount(canceledCount: number | null): ReliabilityOrchestrator.AutomatedRetrainingJobResult;
    ...
    withIsCanceled(isCanceled: boolean): ReliabilityOrchestrator.AutomatedRetrainingJobResult;
    ...
    withErrorCount(errorCount: number | null): ReliabilityOrchestrator.AutomatedRetrainingJobResult;
    ...
    withRun(run: IWorkflowExecutorRun | null): ReliabilityOrchestrator.AutomatedRetrainingJobResult;
    ...
    withDurationSeconds(durationSeconds: number | null): ReliabilityOrchestrator.AutomatedRetrainingJobResult;
    ...
    withPastRuns(pastRuns: Array_Type<WorkflowExecutorRun> | Array<IWorkflowExecutorRun> | null): ReliabilityOrchestrator.AutomatedRetrainingJobResult;

    /**
     * Number of times the {@link #parentCoordinator} has attempted to recover this result.
     */
    readonly attemptedRecoveryCount?: number;
    withAttemptedRecoveryCount(attemptedRecoveryCount: number | null): ReliabilityOrchestrator.AutomatedRetrainingJobResult;
    ...
    withModel(model: IReliabilityMlModel): ReliabilityOrchestrator.AutomatedRetrainingJobResult;

    /**
     * Contains the retrained {@link ReliabilityMlModel} that is output by the workflow created using lambda.
     */
    readonly retrainedModel?: ReliabilityMlModel;
    withRetrainedModel(retrainedModel: IReliabilityMlModel | null): ReliabilityOrchestrator.AutomatedRetrainingJobResult;

    /**
     * Errors when {@link ReliabilityMl.Project#retrainingWorkflowLambda} failed, did not produce any retrained models, or returned an error.
     */
    readonly errorMessages?: Array_Type<string>;
    withErrorMessages(errorMessages: Array_Type<string> | Array<string> | null): ReliabilityOrchestrator.AutomatedRetrainingJobResult;
     ...
     * @see #toJson
     */
    static fromJson(json: any): ReliabilityOrchestrator.AutomatedRetrainingJobResult | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): ReliabilityOrchestrator.AutomatedRetrainingJobResult | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): ReliabilityOrchestrator.AutomatedRetrainingJobResult | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): ReliabilityOrchestrator.AutomatedRetrainingJobResult | null;
     ...
     */
    replaceType(old: Type, new_: Type): ReliabilityOrchestrator.AutomatedRetrainingJobResult;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityOrchestrator.AutomatedRetrainingJobResult;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityOrchestrator.AutomatedRetrainingJobResult;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityOrchestrator.AutomatedRetrainingJobResult>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityOrchestrator.AutomatedRetrainingJobResult>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityOrchestrator.AutomatedRetrainingJobResult;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityOrchestrator.AutomatedRetrainingJobResult;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityOrchestrator.AutomatedRetrainingJobResult;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): ReliabilityOrchestrator.AutomatedRetrainingJobResult;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): ReliabilityOrchestrator.AutomatedRetrainingJobResult;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityOrchestrator.AutomatedRetrainingJobResult;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityOrchestrator.AutomatedRetrainingJobResult;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityOrchestrator.AutomatedRetrainingJobResult;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): ReliabilityOrchestrator.AutomatedRetrainingJobResult;
     ...
     * @see #removeField
     */
    withoutField(field: string): ReliabilityOrchestrator.AutomatedRetrainingJobResult;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): ReliabilityOrchestrator.AutomatedRetrainingJobResult;
     ...
     */
    withoutFields(fields: Array_Type<string>): ReliabilityOrchestrator.AutomatedRetrainingJobResult;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityOrchestrator.AutomatedRetrainingJobResult;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): ReliabilityOrchestrator.AutomatedRetrainingJobResult;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityOrchestrator.AutomatedRetrainingJobResult;
     ...
     * @see #unsetField
     */
    defaultField(field: string): ReliabilityOrchestrator.AutomatedRetrainingJobResult;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): ReliabilityOrchestrator.AutomatedRetrainingJobResult;
     ...
     * @see #removeField
     */
    unsetField(field: string): ReliabilityOrchestrator.AutomatedRetrainingJobResult;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): ReliabilityOrchestrator.AutomatedRetrainingJobResult;
     ...
     * @see #unsetField
     */
    removeField(field: string): ReliabilityOrchestrator.AutomatedRetrainingJobResult;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): ReliabilityOrchestrator.AutomatedRetrainingJobResult;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityOrchestrator.AutomatedRetrainingJobResult;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityOrchestrator.AutomatedRetrainingJobResult;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityOrchestrator.AutomatedRetrainingJobResult;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityOrchestrator.AutomatedRetrainingJobResult;

    mergeJson(json: any): ReliabilityOrchestrator.AutomatedRetrainingJobResult;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityOrchestrator.AutomatedRetrainingJobResult;
     ...
     */
    sumObj(other: Obj, deep?: boolean): ReliabilityOrchestrator.AutomatedRetrainingJobResult;
     ...
     */
    singletonArray(): Array_Type<ReliabilityOrchestrator.AutomatedRetrainingJobResult>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityOrchestrator.AutomatedRetrainingJobResult> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<ReliabilityOrchestrator.AutomatedRetrainingJobResult> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<ReliabilityOrchestrator.AutomatedRetrainingJobResult>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<ReliabilityOrchestrator.AutomatedRetrainingJobResult> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, ReliabilityOrchestrator.AutomatedRetrainingJobResult> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityOrchestrator.AutomatedRetrainingJobResult> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<ReliabilityOrchestrator.AutomatedRetrainingJobResult>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<ReliabilityOrchestrator.AutomatedRetrainingJobResult>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityOrchestrator.AutomatedRetrainingJobResult;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityOrchestrator.AutomatedRetrainingJobResult;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityOrchestrator.AutomatedRetrainingJobResult;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): ReliabilityOrchestrator.AutomatedRetrainingJobResult;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityOrchestrator.AutomatedRetrainingJobResult;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): ReliabilityOrchestrator.AutomatedRetrainingJobResult;
     ...
     * @see #fromString
     */
    static make(s: string): ReliabilityOrchestrator.AutomatedRetrainingJobResult | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityOrchestrator.AutomatedRetrainingJobResult;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): ReliabilityOrchestrator.AutomatedRetrainingJobResult;
     ...
     */
    static cachedEmptyInst(): ReliabilityOrchestrator.AutomatedRetrainingJobResult;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityOrchestrator.AutomatedRetrainingJobResult> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): ReliabilityOrchestrator.AutomatedRetrainingJobResult;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<ReliabilityOrchestrator.AutomatedRetrainingJobResult>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<ReliabilityOrchestrator.AutomatedRetrainingJobResult>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityOrchestrator.AutomatedRetrainingJobResult> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityOrchestrator.AutomatedRetrainingJobResult>> | null;
     ...
     */
    get(include?: string): ReliabilityOrchestrator.AutomatedRetrainingJobResult | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): ReliabilityOrchestrator.AutomatedRetrainingJobResult | null;
     ...
     */
    getMissing(spec: GetMissingSpec): ReliabilityOrchestrator.AutomatedRetrainingJobResult;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): ReliabilityOrchestrator.AutomatedRetrainingJobResult | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): ReliabilityOrchestrator.AutomatedRetrainingJobResult;
     ...
     * @see #toString
     */
    static fromString(s: string): ReliabilityOrchestrator.AutomatedRetrainingJobResult | null;
     ...
     */
    create(spec?: UpsertSpec): ReliabilityOrchestrator.AutomatedRetrainingJobResult | null;
     ...
     */
    static createBatch(objs: Array_Type<ReliabilityOrchestrator.AutomatedRetrainingJobResult>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.AutomatedRetrainingJobResult> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<ReliabilityOrchestrator.AutomatedRetrainingJobResult>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityOrchestrator.AutomatedRetrainingJobResult> | null;
     ...
     */
    update(srcObj?: ReliabilityOrchestrator.AutomatedRetrainingJobResult, spec?: UpsertSpec): ReliabilityOrchestrator.AutomatedRetrainingJobResult | null;
     ...
     */
    upsert(srcObj?: ReliabilityOrchestrator.AutomatedRetrainingJobResult, spec?: UpsertSpec): ReliabilityOrchestrator.AutomatedRetrainingJobResult | null;
     ...
     */
    merge(spec?: MergeSpec): ReliabilityOrchestrator.AutomatedRetrainingJobResult | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): ReliabilityOrchestrator.AutomatedRetrainingJobResult | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): ReliabilityOrchestrator.AutomatedRetrainingJobResult | null;
     ...
     */
    static updateBatch(objs: Array_Type<ReliabilityOrchestrator.AutomatedRetrainingJobResult>, srcObjs?: Array_Type<ReliabilityOrchestrator.AutomatedRetrainingJobResult>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.AutomatedRetrainingJobResult> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<ReliabilityOrchestrator.AutomatedRetrainingJobResult> | null>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.AutomatedRetrainingJobResult> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<ReliabilityOrchestrator.AutomatedRetrainingJobResult>, srcObjs?: Array_Type<ReliabilityOrchestrator.AutomatedRetrainingJobResult>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.AutomatedRetrainingJobResult> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<ReliabilityOrchestrator.AutomatedRetrainingJobResult> | null>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.AutomatedRetrainingJobResult> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<ReliabilityOrchestrator.AutomatedRetrainingJobResult>, spec?: TouchSpec): ObjList<ReliabilityOrchestrator.AutomatedRetrainingJobResult> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityOrchestrator.AutomatedRetrainingJobResult>, spec?: MergeSpec): ObjList<ReliabilityOrchestrator.AutomatedRetrainingJobResult> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityOrchestrator.AutomatedRetrainingJobResult>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityOrchestrator.AutomatedRetrainingJobResult> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<ReliabilityOrchestrator.AutomatedRetrainingJobResult> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityOrchestrator.AutomatedRetrainingJobResult> | null;
     ...
     */
    static mergeAll(mergeObj: ReliabilityOrchestrator.AutomatedRetrainingJobResult, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: ReliabilityOrchestrator.AutomatedRetrainingJobResult, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<ReliabilityOrchestrator.AutomatedRetrainingJobResult>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.AutomatedRetrainingJobResult> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<ReliabilityOrchestrator.AutomatedRetrainingJobResult>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.AutomatedRetrainingJobResult> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): ReliabilityOrchestrator.AutomatedRetrainingJobResult | null;
     ...
     */
    static beforeCreate(objs: Array_Type<ReliabilityOrchestrator.AutomatedRetrainingJobResult>): ObjList<ReliabilityOrchestrator.AutomatedRetrainingJobResult>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<ReliabilityOrchestrator.AutomatedRetrainingJobResult>): ObjList<ReliabilityOrchestrator.AutomatedRetrainingJobResult>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<ReliabilityOrchestrator.AutomatedRetrainingJobResult>): ObjList<ReliabilityOrchestrator.AutomatedRetrainingJobResult>;
     ...
     */
    static afterCreate(objs: Array_Type<ReliabilityOrchestrator.AutomatedRetrainingJobResult>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<ReliabilityOrchestrator.AutomatedRetrainingJobResult>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<ReliabilityOrchestrator.AutomatedRetrainingJobResult>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityOrchestrator.AutomatedRetrainingJobResult>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityOrchestrator.AutomatedRetrainingJobResult>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): ReliabilityOrchestrator.AutomatedRetrainingJobResult | null;
     ...
     */
    withoutIdentity(): ReliabilityOrchestrator.AutomatedRetrainingJobResult | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<ReliabilityOrchestrator.AutomatedRetrainingJobResult>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: ReliabilityOrchestrator.AutomatedRetrainingJobResult, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<ReliabilityOrchestrator.AutomatedRetrainingJobResult>, callback?: λFunction<ReliabilityOrchestrator.AutomatedRetrainingJobResult | null, ReliabilityOrchestrator.AutomatedRetrainingJobResult | null>): ObjList<ReliabilityOrchestrator.AutomatedRetrainingJobResult>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<ReliabilityOrchestrator.AutomatedRetrainingJobResult>, callback?: λFunction<ReliabilityOrchestrator.AutomatedRetrainingJobResult | null, ReliabilityOrchestrator.AutomatedRetrainingJobResult | null>): Array_Type<ObjError> | null;
    ...
    /**
     * Starts the automated retraining workflow for the specified model using the project's
     * configured retraining lambda.
     */
     ...
     */
    beforeRecover(): ReliabilityOrchestrator.AutomatedRetrainingJobResult;
     ...
     * caller is responsible for persisting the result.
     */
    beforeCancel(): ReliabilityOrchestrator.AutomatedRetrainingJobResult;
  }
}
