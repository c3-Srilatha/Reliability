// TypeScript definitions for the C3 type FaultySensor.RiskModelSourceOfTruthRelation
 ...
 * - ...
 *
 * @remarks this represents a value passed to a method that expects an instance of FaultySensor.RiskModelSourceOfTruthRelation
 */
declare namespace FaultySensor {
  export interface IRiskModelSourceOfTruthRelation {
     ...
     */
    sourceOfTruth: IReliabilityMlModel;
 ...
 * - ...
 *
 * @remarks this represents a made instance of FaultySensor.RiskModelSourceOfTruthRelation
 */
declare namespace FaultySensor {
  export class RiskModelSourceOfTruthRelation extends Obj  {
     ...
     */
    readonly id: string;
    withId(id: string): FaultySensor.RiskModelSourceOfTruthRelation;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): FaultySensor.RiskModelSourceOfTruthRelation;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): FaultySensor.RiskModelSourceOfTruthRelation;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): FaultySensor.RiskModelSourceOfTruthRelation;
    ...
    withVersion(version: number | null): FaultySensor.RiskModelSourceOfTruthRelation;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): FaultySensor.RiskModelSourceOfTruthRelation;
     ...
     * See example on the type documentation.
     */
    readonly child: ReliabilityMlModel;
    withChild(child: IReliabilityMlModel): FaultySensor.RiskModelSourceOfTruthRelation;
     ...
     * the data from [faulty sensors](SensorOperationalStatusEnum).
     */
    readonly sourceOfTruth: ReliabilityMlModel;
    withSourceOfTruth(sourceOfTruth: IReliabilityMlModel): FaultySensor.RiskModelSourceOfTruthRelation;
     ...
     * retraining process.
     */
    readonly parent: ReliabilityMlModel;
    withParent(parent: IReliabilityMlModel): FaultySensor.RiskModelSourceOfTruthRelation;
     ...
     * @see #toJson
     */
    static fromJson(json: any): FaultySensor.RiskModelSourceOfTruthRelation | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): FaultySensor.RiskModelSourceOfTruthRelation | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): FaultySensor.RiskModelSourceOfTruthRelation | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): FaultySensor.RiskModelSourceOfTruthRelation | null;
     ...
     */
    replaceType(old: Type, new_: Type): FaultySensor.RiskModelSourceOfTruthRelation;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): FaultySensor.RiskModelSourceOfTruthRelation;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): FaultySensor.RiskModelSourceOfTruthRelation;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<FaultySensor.RiskModelSourceOfTruthRelation>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<FaultySensor.RiskModelSourceOfTruthRelation>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): FaultySensor.RiskModelSourceOfTruthRelation;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): FaultySensor.RiskModelSourceOfTruthRelation;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): FaultySensor.RiskModelSourceOfTruthRelation;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): FaultySensor.RiskModelSourceOfTruthRelation;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): FaultySensor.RiskModelSourceOfTruthRelation;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): FaultySensor.RiskModelSourceOfTruthRelation;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): FaultySensor.RiskModelSourceOfTruthRelation;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): FaultySensor.RiskModelSourceOfTruthRelation;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): FaultySensor.RiskModelSourceOfTruthRelation;
     ...
     * @see #removeField
     */
    withoutField(field: string): FaultySensor.RiskModelSourceOfTruthRelation;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): FaultySensor.RiskModelSourceOfTruthRelation;
     ...
     */
    withoutFields(fields: Array_Type<string>): FaultySensor.RiskModelSourceOfTruthRelation;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): FaultySensor.RiskModelSourceOfTruthRelation;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): FaultySensor.RiskModelSourceOfTruthRelation;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): FaultySensor.RiskModelSourceOfTruthRelation;
     ...
     * @see #unsetField
     */
    defaultField(field: string): FaultySensor.RiskModelSourceOfTruthRelation;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): FaultySensor.RiskModelSourceOfTruthRelation;
     ...
     * @see #removeField
     */
    unsetField(field: string): FaultySensor.RiskModelSourceOfTruthRelation;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): FaultySensor.RiskModelSourceOfTruthRelation;
     ...
     * @see #unsetField
     */
    removeField(field: string): FaultySensor.RiskModelSourceOfTruthRelation;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): FaultySensor.RiskModelSourceOfTruthRelation;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): FaultySensor.RiskModelSourceOfTruthRelation;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): FaultySensor.RiskModelSourceOfTruthRelation;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): FaultySensor.RiskModelSourceOfTruthRelation;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): FaultySensor.RiskModelSourceOfTruthRelation;

    mergeJson(json: any): FaultySensor.RiskModelSourceOfTruthRelation;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): FaultySensor.RiskModelSourceOfTruthRelation;
     ...
     */
    sumObj(other: Obj, deep?: boolean): FaultySensor.RiskModelSourceOfTruthRelation;
     ...
     */
    singletonArray(): Array_Type<FaultySensor.RiskModelSourceOfTruthRelation>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<FaultySensor.RiskModelSourceOfTruthRelation> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<FaultySensor.RiskModelSourceOfTruthRelation> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<FaultySensor.RiskModelSourceOfTruthRelation>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<FaultySensor.RiskModelSourceOfTruthRelation> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, FaultySensor.RiskModelSourceOfTruthRelation> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, FaultySensor.RiskModelSourceOfTruthRelation> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<FaultySensor.RiskModelSourceOfTruthRelation>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<FaultySensor.RiskModelSourceOfTruthRelation>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): FaultySensor.RiskModelSourceOfTruthRelation;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): FaultySensor.RiskModelSourceOfTruthRelation;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): FaultySensor.RiskModelSourceOfTruthRelation;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): FaultySensor.RiskModelSourceOfTruthRelation;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): FaultySensor.RiskModelSourceOfTruthRelation;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): FaultySensor.RiskModelSourceOfTruthRelation;
     ...
     * @see #fromString
     */
    static make(s: string): FaultySensor.RiskModelSourceOfTruthRelation | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): FaultySensor.RiskModelSourceOfTruthRelation;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): FaultySensor.RiskModelSourceOfTruthRelation;
     ...
     */
    static cachedEmptyInst(): FaultySensor.RiskModelSourceOfTruthRelation;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<FaultySensor.RiskModelSourceOfTruthRelation> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): FaultySensor.RiskModelSourceOfTruthRelation;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<FaultySensor.RiskModelSourceOfTruthRelation>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<FaultySensor.RiskModelSourceOfTruthRelation>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<FaultySensor.RiskModelSourceOfTruthRelation> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<FaultySensor.RiskModelSourceOfTruthRelation>> | null;
     ...
     */
    get(include?: string): FaultySensor.RiskModelSourceOfTruthRelation | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): FaultySensor.RiskModelSourceOfTruthRelation | null;
     ...
     */
    getMissing(spec: GetMissingSpec): FaultySensor.RiskModelSourceOfTruthRelation;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): FaultySensor.RiskModelSourceOfTruthRelation | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): FaultySensor.RiskModelSourceOfTruthRelation;
     ...
     * @see #toString
     */
    static fromString(s: string): FaultySensor.RiskModelSourceOfTruthRelation | null;
     ...
     */
    create(spec?: UpsertSpec): FaultySensor.RiskModelSourceOfTruthRelation | null;
     ...
     */
    static createBatch(objs: Array_Type<FaultySensor.RiskModelSourceOfTruthRelation>, spec?: UpsertSpec): ObjList<FaultySensor.RiskModelSourceOfTruthRelation> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<FaultySensor.RiskModelSourceOfTruthRelation>, spec?: CreateBatchObjStreamSpec): ObjList<FaultySensor.RiskModelSourceOfTruthRelation> | null;
     ...
     */
    update(srcObj?: FaultySensor.RiskModelSourceOfTruthRelation, spec?: UpsertSpec): FaultySensor.RiskModelSourceOfTruthRelation | null;
     ...
     */
    upsert(srcObj?: FaultySensor.RiskModelSourceOfTruthRelation, spec?: UpsertSpec): FaultySensor.RiskModelSourceOfTruthRelation | null;
     ...
     */
    merge(spec?: MergeSpec): FaultySensor.RiskModelSourceOfTruthRelation | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): FaultySensor.RiskModelSourceOfTruthRelation | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): FaultySensor.RiskModelSourceOfTruthRelation | null;
     ...
     */
    static updateBatch(objs: Array_Type<FaultySensor.RiskModelSourceOfTruthRelation>, srcObjs?: Array_Type<FaultySensor.RiskModelSourceOfTruthRelation>, spec?: UpsertSpec): ObjList<FaultySensor.RiskModelSourceOfTruthRelation> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<FaultySensor.RiskModelSourceOfTruthRelation> | null>, spec?: UpsertSpec): ObjList<FaultySensor.RiskModelSourceOfTruthRelation> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<FaultySensor.RiskModelSourceOfTruthRelation>, srcObjs?: Array_Type<FaultySensor.RiskModelSourceOfTruthRelation>, spec?: UpsertSpec): ObjList<FaultySensor.RiskModelSourceOfTruthRelation> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<FaultySensor.RiskModelSourceOfTruthRelation> | null>, spec?: UpsertSpec): ObjList<FaultySensor.RiskModelSourceOfTruthRelation> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<FaultySensor.RiskModelSourceOfTruthRelation>, spec?: TouchSpec): ObjList<FaultySensor.RiskModelSourceOfTruthRelation> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<FaultySensor.RiskModelSourceOfTruthRelation>, spec?: MergeSpec): ObjList<FaultySensor.RiskModelSourceOfTruthRelation> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<FaultySensor.RiskModelSourceOfTruthRelation>, mergeInclude: string, spec?: MergeSpec): ObjList<FaultySensor.RiskModelSourceOfTruthRelation> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<FaultySensor.RiskModelSourceOfTruthRelation> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<FaultySensor.RiskModelSourceOfTruthRelation> | null;
     ...
     */
    static mergeAll(mergeObj: FaultySensor.RiskModelSourceOfTruthRelation, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: FaultySensor.RiskModelSourceOfTruthRelation, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<FaultySensor.RiskModelSourceOfTruthRelation>, spec?: UpsertSpec): ObjList<FaultySensor.RiskModelSourceOfTruthRelation> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<FaultySensor.RiskModelSourceOfTruthRelation>, spec?: UpsertSpec): ObjList<FaultySensor.RiskModelSourceOfTruthRelation> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): FaultySensor.RiskModelSourceOfTruthRelation | null;
     ...
     */
    static beforeCreate(objs: Array_Type<FaultySensor.RiskModelSourceOfTruthRelation>): ObjList<FaultySensor.RiskModelSourceOfTruthRelation>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<FaultySensor.RiskModelSourceOfTruthRelation>): ObjList<FaultySensor.RiskModelSourceOfTruthRelation>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<FaultySensor.RiskModelSourceOfTruthRelation>): ObjList<FaultySensor.RiskModelSourceOfTruthRelation>;
     ...
     */
    static afterCreate(objs: Array_Type<FaultySensor.RiskModelSourceOfTruthRelation>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<FaultySensor.RiskModelSourceOfTruthRelation>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<FaultySensor.RiskModelSourceOfTruthRelation>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<FaultySensor.RiskModelSourceOfTruthRelation>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<FaultySensor.RiskModelSourceOfTruthRelation>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): FaultySensor.RiskModelSourceOfTruthRelation | null;
     ...
     */
    withoutIdentity(): FaultySensor.RiskModelSourceOfTruthRelation | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<FaultySensor.RiskModelSourceOfTruthRelation>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: FaultySensor.RiskModelSourceOfTruthRelation, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<FaultySensor.RiskModelSourceOfTruthRelation>, callback?: λFunction<FaultySensor.RiskModelSourceOfTruthRelation | null, FaultySensor.RiskModelSourceOfTruthRelation | null>): ObjList<FaultySensor.RiskModelSourceOfTruthRelation>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<FaultySensor.RiskModelSourceOfTruthRelation>, callback?: λFunction<FaultySensor.RiskModelSourceOfTruthRelation | null, FaultySensor.RiskModelSourceOfTruthRelation | null>): Array_Type<ObjError> | null;
     ...
     */
    static getSourceOfTruthForModelsBatch(models?: Set_Type<ReliabilityMlModel>): Map_Type<string, ReliabilityMlModel> | null;
  }
}
