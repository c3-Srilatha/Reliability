// TypeScript definitions for the C3 type ReliabilityOrchestrator.AutomatedRetrainingJobRun
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityOrchestrator.AutomatedRetrainingJobRun
 */
declare namespace ReliabilityOrchestrator {
  export interface IAutomatedRetrainingJobRun {

    /**
     * The distributed job this run is an instance of.
     */
    job: IReliabilityOrchestrator.AutomatedRetrainingJob;

    /**
     * The array of configurations this job run must execute.
     */
    jobSpecs: Array_Type<ReliabilityOrchestrator.AutomatedRetrainingJobSpec> | Array<IReliabilityOrchestrator.AutomatedRetrainingJobSpec>;
     ...
     */
    mlOperationRun?: IMlOperationRun<any>;
 ...
 */
declare namespace ReliabilityOrchestrator {
  export class AutomatedRetrainingJobRun extends Obj  {

    /**
     * The distributed job this run is an instance of.
     */
    readonly job: ReliabilityOrchestrator.AutomatedRetrainingJob;
    withJob(job: IReliabilityOrchestrator.AutomatedRetrainingJob): ReliabilityOrchestrator.AutomatedRetrainingJobRun;

    /**
     * The array of configurations this job run must execute.
     */
    readonly jobSpecs: Array_Type<ReliabilityOrchestrator.AutomatedRetrainingJobSpec>;
    withJobSpecs(jobSpecs: Array_Type<ReliabilityOrchestrator.AutomatedRetrainingJobSpec> | Array<IReliabilityOrchestrator.AutomatedRetrainingJobSpec>): ReliabilityOrchestrator.AutomatedRetrainingJobRun;
     ...
     * debugging, inspection, or monitoring.
     */
    readonly mlOperationRun?: MlOperationRun<any>;
    withMlOperationRun(mlOperationRun: IMlOperationRun<any> | null): ReliabilityOrchestrator.AutomatedRetrainingJobRun;

    /**
     * Options that were used to specify execution constraints for this training job run.
     */
    readonly options: ReliabilityOrchestrator.JobOptions;
    withOptions(options: IReliabilityOrchestrator.JobOptions): ReliabilityOrchestrator.AutomatedRetrainingJobRun;
    ...
    withTypeIdent(typeIdent: string | null): ReliabilityOrchestrator.AutomatedRetrainingJobRun;
     ...
     */
    readonly id: string;
    withId(id: string): ReliabilityOrchestrator.AutomatedRetrainingJobRun;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityOrchestrator.AutomatedRetrainingJobRun;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): ReliabilityOrchestrator.AutomatedRetrainingJobRun;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): ReliabilityOrchestrator.AutomatedRetrainingJobRun;
    ...
    withVersion(version: number | null): ReliabilityOrchestrator.AutomatedRetrainingJobRun;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): ReliabilityOrchestrator.AutomatedRetrainingJobRun;

    /**
     * {@link JobOptions} for executing this coordinator.
     */
    readonly jobOptions?: JobOptions;
    withJobOptions(jobOptions: IJobOptions | null): ReliabilityOrchestrator.AutomatedRetrainingJobRun;
     ...
     * @see #toJson
     */
    static fromJson(json: any): ReliabilityOrchestrator.AutomatedRetrainingJobRun | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): ReliabilityOrchestrator.AutomatedRetrainingJobRun | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): ReliabilityOrchestrator.AutomatedRetrainingJobRun | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): ReliabilityOrchestrator.AutomatedRetrainingJobRun | null;
     ...
     */
    replaceType(old: Type, new_: Type): ReliabilityOrchestrator.AutomatedRetrainingJobRun;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityOrchestrator.AutomatedRetrainingJobRun;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityOrchestrator.AutomatedRetrainingJobRun;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityOrchestrator.AutomatedRetrainingJobRun>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityOrchestrator.AutomatedRetrainingJobRun>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityOrchestrator.AutomatedRetrainingJobRun;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityOrchestrator.AutomatedRetrainingJobRun;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityOrchestrator.AutomatedRetrainingJobRun;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): ReliabilityOrchestrator.AutomatedRetrainingJobRun;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): ReliabilityOrchestrator.AutomatedRetrainingJobRun;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityOrchestrator.AutomatedRetrainingJobRun;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityOrchestrator.AutomatedRetrainingJobRun;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityOrchestrator.AutomatedRetrainingJobRun;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): ReliabilityOrchestrator.AutomatedRetrainingJobRun;
     ...
     * @see #removeField
     */
    withoutField(field: string): ReliabilityOrchestrator.AutomatedRetrainingJobRun;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): ReliabilityOrchestrator.AutomatedRetrainingJobRun;
     ...
     */
    withoutFields(fields: Array_Type<string>): ReliabilityOrchestrator.AutomatedRetrainingJobRun;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityOrchestrator.AutomatedRetrainingJobRun;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): ReliabilityOrchestrator.AutomatedRetrainingJobRun;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityOrchestrator.AutomatedRetrainingJobRun;
     ...
     * @see #unsetField
     */
    defaultField(field: string): ReliabilityOrchestrator.AutomatedRetrainingJobRun;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): ReliabilityOrchestrator.AutomatedRetrainingJobRun;
     ...
     * @see #removeField
     */
    unsetField(field: string): ReliabilityOrchestrator.AutomatedRetrainingJobRun;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): ReliabilityOrchestrator.AutomatedRetrainingJobRun;
     ...
     * @see #unsetField
     */
    removeField(field: string): ReliabilityOrchestrator.AutomatedRetrainingJobRun;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): ReliabilityOrchestrator.AutomatedRetrainingJobRun;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityOrchestrator.AutomatedRetrainingJobRun;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityOrchestrator.AutomatedRetrainingJobRun;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityOrchestrator.AutomatedRetrainingJobRun;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityOrchestrator.AutomatedRetrainingJobRun;

    mergeJson(json: any): ReliabilityOrchestrator.AutomatedRetrainingJobRun;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityOrchestrator.AutomatedRetrainingJobRun;
     ...
     */
    sumObj(other: Obj, deep?: boolean): ReliabilityOrchestrator.AutomatedRetrainingJobRun;
     ...
     */
    singletonArray(): Array_Type<ReliabilityOrchestrator.AutomatedRetrainingJobRun>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityOrchestrator.AutomatedRetrainingJobRun> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<ReliabilityOrchestrator.AutomatedRetrainingJobRun> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<ReliabilityOrchestrator.AutomatedRetrainingJobRun>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<ReliabilityOrchestrator.AutomatedRetrainingJobRun> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, ReliabilityOrchestrator.AutomatedRetrainingJobRun> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityOrchestrator.AutomatedRetrainingJobRun> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<ReliabilityOrchestrator.AutomatedRetrainingJobRun>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<ReliabilityOrchestrator.AutomatedRetrainingJobRun>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityOrchestrator.AutomatedRetrainingJobRun;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityOrchestrator.AutomatedRetrainingJobRun;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityOrchestrator.AutomatedRetrainingJobRun;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): ReliabilityOrchestrator.AutomatedRetrainingJobRun;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityOrchestrator.AutomatedRetrainingJobRun;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): ReliabilityOrchestrator.AutomatedRetrainingJobRun;
     ...
     * @see #fromString
     */
    static make(s: string): ReliabilityOrchestrator.AutomatedRetrainingJobRun | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityOrchestrator.AutomatedRetrainingJobRun;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): ReliabilityOrchestrator.AutomatedRetrainingJobRun;
     ...
     */
    static cachedEmptyInst(): ReliabilityOrchestrator.AutomatedRetrainingJobRun;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityOrchestrator.AutomatedRetrainingJobRun> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): ReliabilityOrchestrator.AutomatedRetrainingJobRun;
     ...
     */
    progressSummary(grain?: string = '\'H\''): Data.Persisted;
     ...
     */
    summary(spec?: Workflow.Monitorable.SummarySpec): Data;
     ...
     */
    errorsAsFlatArray(): Array_Type<string> | null;
     ...
     */
    summaryAsFetchResult(spec?: FetchSpec): FetchResult<any>;
     ...
     */
    summaryCount(spec?: FetchFilterSpec): number;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<ReliabilityOrchestrator.AutomatedRetrainingJobRun>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<ReliabilityOrchestrator.AutomatedRetrainingJobRun>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityOrchestrator.AutomatedRetrainingJobRun> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityOrchestrator.AutomatedRetrainingJobRun>> | null;
     ...
     */
    get(include?: string): ReliabilityOrchestrator.AutomatedRetrainingJobRun | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): ReliabilityOrchestrator.AutomatedRetrainingJobRun | null;
     ...
     */
    getMissing(spec: GetMissingSpec): ReliabilityOrchestrator.AutomatedRetrainingJobRun;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): ReliabilityOrchestrator.AutomatedRetrainingJobRun | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): ReliabilityOrchestrator.AutomatedRetrainingJobRun;
     ...
     * @see #toString
     */
    static fromString(s: string): ReliabilityOrchestrator.AutomatedRetrainingJobRun | null;
     ...
     */
    create(spec?: UpsertSpec): ReliabilityOrchestrator.AutomatedRetrainingJobRun | null;
     ...
     */
    static createBatch(objs: Array_Type<ReliabilityOrchestrator.AutomatedRetrainingJobRun>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.AutomatedRetrainingJobRun> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<ReliabilityOrchestrator.AutomatedRetrainingJobRun>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityOrchestrator.AutomatedRetrainingJobRun> | null;
     ...
     */
    update(srcObj?: ReliabilityOrchestrator.AutomatedRetrainingJobRun, spec?: UpsertSpec): ReliabilityOrchestrator.AutomatedRetrainingJobRun | null;
     ...
     */
    upsert(srcObj?: ReliabilityOrchestrator.AutomatedRetrainingJobRun, spec?: UpsertSpec): ReliabilityOrchestrator.AutomatedRetrainingJobRun | null;
     ...
     */
    merge(spec?: MergeSpec): ReliabilityOrchestrator.AutomatedRetrainingJobRun | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): ReliabilityOrchestrator.AutomatedRetrainingJobRun | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): ReliabilityOrchestrator.AutomatedRetrainingJobRun | null;
     ...
     */
    static updateBatch(objs: Array_Type<ReliabilityOrchestrator.AutomatedRetrainingJobRun>, srcObjs?: Array_Type<ReliabilityOrchestrator.AutomatedRetrainingJobRun>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.AutomatedRetrainingJobRun> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<ReliabilityOrchestrator.AutomatedRetrainingJobRun> | null>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.AutomatedRetrainingJobRun> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<ReliabilityOrchestrator.AutomatedRetrainingJobRun>, srcObjs?: Array_Type<ReliabilityOrchestrator.AutomatedRetrainingJobRun>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.AutomatedRetrainingJobRun> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<ReliabilityOrchestrator.AutomatedRetrainingJobRun> | null>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.AutomatedRetrainingJobRun> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<ReliabilityOrchestrator.AutomatedRetrainingJobRun>, spec?: TouchSpec): ObjList<ReliabilityOrchestrator.AutomatedRetrainingJobRun> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityOrchestrator.AutomatedRetrainingJobRun>, spec?: MergeSpec): ObjList<ReliabilityOrchestrator.AutomatedRetrainingJobRun> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityOrchestrator.AutomatedRetrainingJobRun>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityOrchestrator.AutomatedRetrainingJobRun> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<ReliabilityOrchestrator.AutomatedRetrainingJobRun> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityOrchestrator.AutomatedRetrainingJobRun> | null;
     ...
     */
    static mergeAll(mergeObj: ReliabilityOrchestrator.AutomatedRetrainingJobRun, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: ReliabilityOrchestrator.AutomatedRetrainingJobRun, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<ReliabilityOrchestrator.AutomatedRetrainingJobRun>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.AutomatedRetrainingJobRun> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<ReliabilityOrchestrator.AutomatedRetrainingJobRun>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.AutomatedRetrainingJobRun> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): ReliabilityOrchestrator.AutomatedRetrainingJobRun | null;
     ...
     */
    static beforeCreate(objs: Array_Type<ReliabilityOrchestrator.AutomatedRetrainingJobRun>): ObjList<ReliabilityOrchestrator.AutomatedRetrainingJobRun>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<ReliabilityOrchestrator.AutomatedRetrainingJobRun>): ObjList<ReliabilityOrchestrator.AutomatedRetrainingJobRun>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<ReliabilityOrchestrator.AutomatedRetrainingJobRun>): ObjList<ReliabilityOrchestrator.AutomatedRetrainingJobRun>;
     ...
     */
    static afterCreate(objs: Array_Type<ReliabilityOrchestrator.AutomatedRetrainingJobRun>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<ReliabilityOrchestrator.AutomatedRetrainingJobRun>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<ReliabilityOrchestrator.AutomatedRetrainingJobRun>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityOrchestrator.AutomatedRetrainingJobRun>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityOrchestrator.AutomatedRetrainingJobRun>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): ReliabilityOrchestrator.AutomatedRetrainingJobRun | null;
     ...
     */
    withoutIdentity(): ReliabilityOrchestrator.AutomatedRetrainingJobRun | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<ReliabilityOrchestrator.AutomatedRetrainingJobRun>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: ReliabilityOrchestrator.AutomatedRetrainingJobRun, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<ReliabilityOrchestrator.AutomatedRetrainingJobRun>, callback?: λFunction<ReliabilityOrchestrator.AutomatedRetrainingJobRun | null, ReliabilityOrchestrator.AutomatedRetrainingJobRun | null>): ObjList<ReliabilityOrchestrator.AutomatedRetrainingJobRun>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<ReliabilityOrchestrator.AutomatedRetrainingJobRun>, callback?: λFunction<ReliabilityOrchestrator.AutomatedRetrainingJobRun | null, ReliabilityOrchestrator.AutomatedRetrainingJobRun | null>): Array_Type<ObjError> | null;
     ...
     */
    generateNextResults(completed?: Stream<ReliabilityOrchestrator.AutomatedRetrainingJobResult>): number;
     ...
     */
    startResult(result: ReliabilityOrchestrator.AutomatedRetrainingJobResult): ReliabilityOrchestrator.AutomatedRetrainingJobResult;
     ...
     */
    afterStart(results: Stream<ReliabilityOrchestrator.AutomatedRetrainingJobResult>): Stream<ReliabilityOrchestrator.AutomatedRetrainingJobResult> | null;
     ...
     * @return the result instance, as acknowledgement, even if unmodified.
     */
    completeResult(result: ReliabilityOrchestrator.AutomatedRetrainingJobResult): ReliabilityOrchestrator.AutomatedRetrainingJobResult;
     ...
     */
    updateRunningResults(spec?: FetchStreamSpec): Stream<ReliabilityOrchestrator.AutomatedRetrainingJobResult> | null;
     ...
     */
    afterComplete(results: Stream<ReliabilityOrchestrator.AutomatedRetrainingJobResult>): Stream<ReliabilityOrchestrator.AutomatedRetrainingJobResult> | null;
     ...
     */
    runFromResult(result: ReliabilityOrchestrator.AutomatedRetrainingJobResult): WorkflowExecutorRun | null;
     ...
     *    Optional {@link FetchStreamSpec} for customizing fetching of RT objects.
     */
    pendingResults(spec?: FetchStreamSpec): Stream<ReliabilityOrchestrator.AutomatedRetrainingJobResult> | null;
     ...
     *    Optional {@link FetchStreamSpec} for customizing fetching of RT objects.
     */
    runningResults(spec?: FetchStreamSpec): Stream<ReliabilityOrchestrator.AutomatedRetrainingJobResult> | null;
     ...
     *    Optional {@link FetchStreamSpec} for customizing fetching of RT objects.
     */
    completedResults(spec?: FetchStreamSpec): Stream<ReliabilityOrchestrator.AutomatedRetrainingJobResult> | null;
     ...
     *    Optional {@link FetchStreamSpec} for customizing fetching of RT objects.
     */
    canceledResults(spec?: FetchStreamSpec): Stream<ReliabilityOrchestrator.AutomatedRetrainingJobResult> | null;
     ...
     *    Optional {@link FetchStreamSpec} for customizing fetching of RT objects.
     */
    erroredResults(spec?: FetchStreamSpec): Stream<ReliabilityOrchestrator.AutomatedRetrainingJobResult> | null;
     ...
     *    Optional {@link FetchStreamSpec} for customizing fetching of RT objects.
     */
    allResults(spec?: FetchStreamSpec): Stream<ReliabilityOrchestrator.AutomatedRetrainingJobResult> | null;
     ...
     */
    pendingResultsCount(spec?: FetchFilterSpec): number;
     ...
     *    Optional {@link FetchFilterSpec} for customizing fetching of RT objects.
     */
    runningResultsCount(spec?: FetchFilterSpec): number;
     ...
     *    Optional {@link FetchFilterSpec} for customizing fetching of RT objects.
     */
    completedResultsCount(spec?: FetchFilterSpec): number;
     ...
     *    Optional {@link FetchFilterSpec} for customizing fetching of RT objects.
     */
    canceledResultsCount(spec?: FetchFilterSpec): number;
     ...
     *    Optional {@link FetchFilterSpec} for customizing fetching of RT objects.
     */
    allResultsCount(spec?: FetchFilterSpec): number;
     ...
     */
    customSummaryFieldsForResult(result: ReliabilityOrchestrator.AutomatedRetrainingJobResult): Map_Type<string, any> | null;
     ...
     * @return a table with a row for each step and the corresponding execution metadata.
     */
    summaryForResults(results: Array_Type<ReliabilityOrchestrator.AutomatedRetrainingJobResult>, spec?: Workflow.Monitorable.SummarySpec): Data;
     ...
     * @return a table with a row for each step and the corresponding execution metadata.
     */
    summaryForResultsPd(results: Array_Type<ReliabilityOrchestrator.AutomatedRetrainingJobResult>, spec?: Workflow.Monitorable.SummarySpec): any | null;
     ...
     */
    recover(jobOptions?: JobOptions): any | null;
     ...
     */
    resultsForSummary(spec?: FetchSpec): FetchResult<ReliabilityOrchestrator.AutomatedRetrainingJobResult> | null;
     ...
     */
    retrainingResults(spec?: FetchSpec): Array_Type<ReliabilityOrchestrator.AutomatedRetrainingJobResult>;
  }
}
