// TypeScript definitions for the C3 type ReliabilityEmailUpdateNotificationConfig

/**
 * Configurations for the {@link ReliabilityEmailUpdateNotificationScheduler}.
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityEmailUpdateNotificationConfig
 */
declare interface IReliabilityEmailUpdateNotificationConfig {
  ...
  /**
   * Roles that are going to receive the email notification.
   */
  userRoles: Array_Type<string> | Array<string>;

  /**
   * Sections which will be used to build the content of the email notification. These are strings that correspond to
   * types that implement the {@link ReliabilityEmailUpdateNotificationSection} interface. The order of the array
   * matters.
   */
  sections: Array_Type<string> | Array<string>;

  /**
   * Category of the email notification to be used in {@link NotificationSpec#category}. For more information about the
   * possible categories, @see NotificationCategoryEnum
   */
  notificationCategory: string;

  /**
   * Configurable batch period to use for the {@link ReliabilityEmailUpdateNotificationScheduler}. Represents the time
   * span, in hours, used to construct the email notification in order to include only the data points that have been
   * created within this specified period. This must be referenced in the implementations of
   * {@link ReliabilityEmailUpdateNotificationSection#buildContent}.
   */
  batchPeriodHours?: number;
}

/**
 * Configurations for the {@link ReliabilityEmailUpdateNotificationScheduler}.
 *
 * @remarks this represents a made instance of ReliabilityEmailUpdateNotificationConfig
 */
declare class ReliabilityEmailUpdateNotificationConfig extends Obj  {

  readonly configOverride?: string;
  withConfigOverride(configOverride: string | null): ReliabilityEmailUpdateNotificationConfig;

  static readonly configOverride?: string;

  readonly secretOverride?: string;
  withSecretOverride(secretOverride: string | null): ReliabilityEmailUpdateNotificationConfig;
  ...
  withIssues(issues: Array_Type<string> | Array<string> | null): ReliabilityEmailUpdateNotificationConfig;
   ...
   * Roles that are going to receive the email notification.
   */
  readonly userRoles: Array_Type<string>;
  withUserRoles(userRoles: Array_Type<string> | Array<string>): ReliabilityEmailUpdateNotificationConfig;

  /**
   * Roles that are going to receive the email notification.
   */
  static readonly userRoles: Array_Type<string>;
   ...
   * matters.
   */
  readonly sections: Array_Type<string>;
  withSections(sections: Array_Type<string> | Array<string>): ReliabilityEmailUpdateNotificationConfig;
   ...
   * matters.
   */
  static readonly sections: Array_Type<string>;
  ...
  withNotificationCategory(notificationCategory: string): ReliabilityEmailUpdateNotificationConfig;

  /**
   * Category of the email notification to be used in {@link NotificationSpec#category}. For more information about the
   * possible categories, @see NotificationCategoryEnum
   */
  static readonly notificationCategory: string;
   ...
   * {@link ReliabilityEmailUpdateNotificationSection#buildContent}.
   */
  readonly batchPeriodHours?: number;
  withBatchPeriodHours(batchPeriodHours: number | null): ReliabilityEmailUpdateNotificationConfig;
   ...
   * @see #toJson
   */
  static fromJson(json: any): ReliabilityEmailUpdateNotificationConfig | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): ReliabilityEmailUpdateNotificationConfig | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): ReliabilityEmailUpdateNotificationConfig | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): ReliabilityEmailUpdateNotificationConfig | null;
   ...
   */
  replaceType(old: Type, new_: Type): ReliabilityEmailUpdateNotificationConfig;
   ...
   * This method is used during live metadata update
   */
  static replaceType(old: Type, new_: Type): ReliabilityEmailUpdateNotificationConfig;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityEmailUpdateNotificationConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityEmailUpdateNotificationConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityEmailUpdateNotificationConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityEmailUpdateNotificationConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityEmailUpdateNotificationConfig>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityEmailUpdateNotificationConfig>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityEmailUpdateNotificationConfig>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityEmailUpdateNotificationConfig>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityEmailUpdateNotificationConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityEmailUpdateNotificationConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityEmailUpdateNotificationConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityEmailUpdateNotificationConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityEmailUpdateNotificationConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityEmailUpdateNotificationConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ReliabilityEmailUpdateNotificationConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  static validateObj(): ReliabilityEmailUpdateNotificationConfig;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ReliabilityEmailUpdateNotificationConfig;
   ...
   * @see #defaultField
   */
  static withField(field: string, value: any, doNotConvert?: boolean): ReliabilityEmailUpdateNotificationConfig;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityEmailUpdateNotificationConfig;
   ...
   * @see #defaultField
   */
  static withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityEmailUpdateNotificationConfig;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityEmailUpdateNotificationConfig;
   ...
   * @return new Obj
   */
  static withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityEmailUpdateNotificationConfig;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityEmailUpdateNotificationConfig;
   ...
   * @return new Obj
   */
  static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityEmailUpdateNotificationConfig;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ReliabilityEmailUpdateNotificationConfig;
   ...
   * @see #withoutField
   */
  static withoutFieldAtPath(path: string): ReliabilityEmailUpdateNotificationConfig;
   ...
   * @see #removeField
   */
  withoutField(field: string): ReliabilityEmailUpdateNotificationConfig;
   ...
   * @see #removeField
   */
  static withoutField(field: string): ReliabilityEmailUpdateNotificationConfig;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): ReliabilityEmailUpdateNotificationConfig;
   ...
   * @see #removeField
   */
  static withoutField(field: FieldType): ReliabilityEmailUpdateNotificationConfig;
   ...
   */
  withoutFields(fields: Array_Type<string>): ReliabilityEmailUpdateNotificationConfig;
   ...
   * @return new Obj with removed fields
   */
  static withoutFields(fields: Array_Type<string>): ReliabilityEmailUpdateNotificationConfig;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityEmailUpdateNotificationConfig;
   ...
   * @return new Obj with removed fields
   */
  static withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityEmailUpdateNotificationConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ReliabilityEmailUpdateNotificationConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  static withoutSecretFields(): ReliabilityEmailUpdateNotificationConfig;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityEmailUpdateNotificationConfig;
   ...
   * @see FieldType#defaultValue
   */
  static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityEmailUpdateNotificationConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ReliabilityEmailUpdateNotificationConfig;
   ...
   * @see #unsetField
   */
  static defaultField(field: string): ReliabilityEmailUpdateNotificationConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ReliabilityEmailUpdateNotificationConfig;
   ...
   * @see #unsetField
   */
  static defaultField(field: FieldType): ReliabilityEmailUpdateNotificationConfig;
   ...
   * @see #removeField
   */
  unsetField(field: string): ReliabilityEmailUpdateNotificationConfig;
   ...
   * @see #removeField
   */
  static unsetField(field: string): ReliabilityEmailUpdateNotificationConfig;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ReliabilityEmailUpdateNotificationConfig;
   ...
   * @see #removeField
   */
  static unsetField(field: FieldType): ReliabilityEmailUpdateNotificationConfig;
   ...
   * @see #unsetField
   */
  removeField(field: string): ReliabilityEmailUpdateNotificationConfig;
   ...
   * @see #unsetField
   */
  static removeField(field: string): ReliabilityEmailUpdateNotificationConfig;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ReliabilityEmailUpdateNotificationConfig;
   ...
   * @see #unsetField
   */
  static removeField(field: FieldType): ReliabilityEmailUpdateNotificationConfig;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityEmailUpdateNotificationConfig;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityEmailUpdateNotificationConfig;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityEmailUpdateNotificationConfig;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityEmailUpdateNotificationConfig;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityEmailUpdateNotificationConfig;
   ...
   *        the same key or index.
   */
  static mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityEmailUpdateNotificationConfig;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityEmailUpdateNotificationConfig;
   ...
   * traverse child reference and collection fields.
   */
  static mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityEmailUpdateNotificationConfig;

  mergeJson(json: any): ReliabilityEmailUpdateNotificationConfig;

  static mergeJson(json: any): ReliabilityEmailUpdateNotificationConfig;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityEmailUpdateNotificationConfig;
   ...
   * @return Obj with child references merged
   */
  static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityEmailUpdateNotificationConfig;
   ...
   */
  sumObj(other: Obj, deep?: boolean): ReliabilityEmailUpdateNotificationConfig;
   ...
   * references with same name and collection elements at same index or key.
   */
  static sumObj(other: Obj, deep?: boolean): ReliabilityEmailUpdateNotificationConfig;
   ...
   */
  singletonArray(): Array_Type<ReliabilityEmailUpdateNotificationConfig>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonArray(): Array_Type<ReliabilityEmailUpdateNotificationConfig>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityEmailUpdateNotificationConfig> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ReliabilityEmailUpdateNotificationConfig> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<ReliabilityEmailUpdateNotificationConfig>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonSet(): Set_Type<ReliabilityEmailUpdateNotificationConfig>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ReliabilityEmailUpdateNotificationConfig> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, ReliabilityEmailUpdateNotificationConfig> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityEmailUpdateNotificationConfig> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ReliabilityEmailUpdateNotificationConfig>;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  static toBuilder(): ObjBuilder<ReliabilityEmailUpdateNotificationConfig>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ReliabilityEmailUpdateNotificationConfig>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityEmailUpdateNotificationConfig;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityEmailUpdateNotificationConfig;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityEmailUpdateNotificationConfig;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ReliabilityEmailUpdateNotificationConfig;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityEmailUpdateNotificationConfig;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ReliabilityEmailUpdateNotificationConfig;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityEmailUpdateNotificationConfig;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): ReliabilityEmailUpdateNotificationConfig;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  static afterMake(): ReliabilityEmailUpdateNotificationConfig;
   ...
   */
  static cachedEmptyInst(): ReliabilityEmailUpdateNotificationConfig;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityEmailUpdateNotificationConfig> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): ReliabilityEmailUpdateNotificationConfig;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<ReliabilityEmailUpdateNotificationConfig> | null;
   ...
   */
  static find(filter?: string, doNotProduceAll?: boolean): Stream<ReliabilityEmailUpdateNotificationConfig> | null;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<ReliabilityEmailUpdateNotificationConfig> | null;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): ReliabilityEmailUpdateNotificationConfig | null;

  /**
   * Returns cached instance by key, with secrets removed.
   */
  static forCacheKey(key: string): ReliabilityEmailUpdateNotificationConfig | null;
   ...
   * @see findByCacheKey
   */
  getCached(): ReliabilityEmailUpdateNotificationConfig | null;
   ...
   * @see findByCacheKey
   */
  static getCached(): ReliabilityEmailUpdateNotificationConfig | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): ReliabilityEmailUpdateNotificationConfig | null;

  /**
   * @return newly produced cached instance.
   */
  static refreshCache(): ReliabilityEmailUpdateNotificationConfig | null;
   ...
   */
  static produce(key: string): ReliabilityEmailUpdateNotificationConfig | null;
   ...
   */
  static produceAll(): Map_Type<string, ReliabilityEmailUpdateNotificationConfig> | null;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): Map_Type<string, ReliabilityEmailUpdateNotificationConfig> | null;
   ...
   */
  getConfig(): ReliabilityEmailUpdateNotificationConfig;
   ...
   * Note that typical pattern is to use Configurable#config instead of this method.
   */
  static getConfig(): ReliabilityEmailUpdateNotificationConfig;
   ...
   */
  getSecret(): ReliabilityEmailUpdateNotificationConfig;
   ...
   * Note that typical pattern is to use Configurable#configWithSecrets instead of this method.
   */
  static getSecret(): ReliabilityEmailUpdateNotificationConfig;
   ...
   */
  withConfigKey(configKey: string): ReliabilityEmailUpdateNotificationConfig;
   ...
   *     config.configKey() => "folder1/abc"
   */
  static withConfigKey(configKey: string): ReliabilityEmailUpdateNotificationConfig;

  /**
   * @return copy without config key.
   */
  withoutConfigKey(): ReliabilityEmailUpdateNotificationConfig;

  /**
   * @return copy without config key.
   */
  static withoutConfigKey(): ReliabilityEmailUpdateNotificationConfig;

  /**
   * @return return cached config instance for provided config key.
   */
  static forConfigKey(configKey: string): ReliabilityEmailUpdateNotificationConfig | null;
   ...
   */
  static listConfigs(parallel?: boolean, filter?: λPredicate<string>): Stream<ReliabilityEmailUpdateNotificationConfig> | null;
   ...
   * @see setConfigValue
   */
  setConfigValues(from: ReliabilityEmailUpdateNotificationConfig, override?: string): void;

  /**
   * Sets multiple field values to be the same as the passed instance.
   * @see setConfigValue
   */
  static setConfigValues(from: ReliabilityEmailUpdateNotificationConfig, override?: string): void;
   ...
   * @see setSecretValue
   */
  setSecretValues(from: ReliabilityEmailUpdateNotificationConfig, override?: string): void;

  /**
   * Sets multiple secret field values to be the same as the passed instance.
   * @see setSecretValue
   */
  static setSecretValues(from: ReliabilityEmailUpdateNotificationConfig, override?: string): void;
   ...
   */
  static loadConfigAndSecret(configKey: string): ReliabilityEmailUpdateNotificationConfig | null;
   ...
   */
  removeSecrets(): ReliabilityEmailUpdateNotificationConfig | null;

  /**
   * @return this config without any secret values.
   */
  static removeSecrets(): ReliabilityEmailUpdateNotificationConfig | null;

  /**
   * @return this config with only secret values.
   */
  removeNonSecrets(): ReliabilityEmailUpdateNotificationConfig | null;

  /**
   * @return this config with only secret values.
   */
  static removeNonSecrets(): ReliabilityEmailUpdateNotificationConfig | null;

  /**
   * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
   * validation and setup.
   */
  validate(): ReliabilityEmailUpdateNotificationConfig;

  /**
   * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
   * validation and setup.
   */
  static validate(): ReliabilityEmailUpdateNotificationConfig;
