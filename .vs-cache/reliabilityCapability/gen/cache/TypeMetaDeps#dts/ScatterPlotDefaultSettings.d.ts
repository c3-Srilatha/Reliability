// TypeScript definitions for the C3 type ScatterPlotDefaultSettings

/**
 * Type which represents the default settings inside either the global scatter plot or the scatter plot on the Asset Details Page.
 *
 * {@link ScatterPlotChartDataSpec#assetId} field goes into filter panel for global scatter plot but specifies which Asset these
 * are the default settings for on Asset Detail Page.
 *
 * @remarks this represents a value passed to a method that expects an instance of ScatterPlotDefaultSettings
 */
declare interface IScatterPlotDefaultSettings {

  /**
   * Metric name to be plotted on the x-axis.
   */
  xAxisMetric: string;

  /**
   * Metric name to be plotted on the y-axis.
   */
  yAxisMetric: string;

  /**
   * Start Date for the metric expression.
   */
  startDate?: DateTime | Date | string;

  /**
   * End Date for the metric expression.
   */
  endDate?: DateTime | Date | string;

  /**
   * Interval for the metric expression.
   */
  interval?: string;

  /**
   * {@link ReliabilityAsset#id} whose metrics will be plotted.
   */
  assetId: string;

  /**
   * Grouping option used to color the points.
   */
  colorGrouping?: string;

  /**
   * Metric name for filter metric.
   */
  filterMetric?: string;

  /**
   * Metric value comparator operator
   */
  filterMetricComparatorOperator?: string;

  /**
   * Metric value comparator value
   */
  filterMetricComparatorValue?: number;
  ...
  /**
   * The period of time that was plotted in the Scatter Plot Chart when the user saved the Scatter Plot Chart settings.
   * The period is rounded up to the nearest number of hours if less than a day is plotted and rounded up to the nearest
   * numbers of days otherwise.
   *
   * Used to fill out the start and end time (from now until now - period) of the Scatter Plot Chart when the chart initially renders.
   */
  period?: IPeriod;

  /**
   * Specifies whether or not the {@link ScatterPlotDefaultSettings} is for the global analyzer Scatter Plot or not.
   *
   * There should only ever be one instance with this field set to true.
   */
  isGlobal?: boolean;
}
 ...
 * are the default settings for on Asset Detail Page.
 *
 * @remarks this represents a made instance of ScatterPlotDefaultSettings
 */
declare class ScatterPlotDefaultSettings extends Obj  {

  /**
   * Metric name to be plotted on the x-axis.
   */
  readonly xAxisMetric: string;
  withXAxisMetric(xAxisMetric: string): ScatterPlotDefaultSettings;

  /**
   * Metric name to be plotted on the y-axis.
   */
  readonly yAxisMetric: string;
  withYAxisMetric(yAxisMetric: string): ScatterPlotDefaultSettings;

  /**
   * Start Date for the metric expression.
   */
  readonly startDate?: DateTime;
  withStartDate(startDate: DateTime | Date | string | null): ScatterPlotDefaultSettings;

  /**
   * End Date for the metric expression.
   */
  readonly endDate?: DateTime;
  withEndDate(endDate: DateTime | Date | string | null): ScatterPlotDefaultSettings;

  /**
   * Interval for the metric expression.
   */
  readonly interval?: string;
  withInterval(interval: string | null): ScatterPlotDefaultSettings;

  /**
   * {@link ReliabilityAsset#id} whose metrics will be plotted.
   */
  readonly assetId: string;
  withAssetId(assetId: string): ScatterPlotDefaultSettings;

  /**
   * Grouping option used to color the points.
   */
  readonly colorGrouping?: string;
  withColorGrouping(colorGrouping: string | null): ScatterPlotDefaultSettings;

  /**
   * Metric name for filter metric.
   */
  readonly filterMetric?: string;
  withFilterMetric(filterMetric: string | null): ScatterPlotDefaultSettings;

  /**
   * Metric value comparator operator
   */
  readonly filterMetricComparatorOperator?: string;
  withFilterMetricComparatorOperator(filterMetricComparatorOperator: string | null): ScatterPlotDefaultSettings;

  /**
   * Metric value comparator value
   */
  readonly filterMetricComparatorValue?: number;
  withFilterMetricComparatorValue(filterMetricComparatorValue: number | null): ScatterPlotDefaultSettings;
   ...
   */
  readonly id: string;
  withId(id: string): ScatterPlotDefaultSettings;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ScatterPlotDefaultSettings;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): ScatterPlotDefaultSettings;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): ScatterPlotDefaultSettings;
  ...
  withVersion(version: number | null): ScatterPlotDefaultSettings;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): ScatterPlotDefaultSettings;
  ...
  withPeriod(period: IPeriod | null): ScatterPlotDefaultSettings;
  ...
  withIsGlobal(isGlobal: boolean): ScatterPlotDefaultSettings;
   ...
   * @see #toJson
   */
  static fromJson(json: any): ScatterPlotDefaultSettings | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): ScatterPlotDefaultSettings | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): ScatterPlotDefaultSettings | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): ScatterPlotDefaultSettings | null;
   ...
   */
  replaceType(old: Type, new_: Type): ScatterPlotDefaultSettings;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ScatterPlotDefaultSettings;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ScatterPlotDefaultSettings;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ScatterPlotDefaultSettings>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ScatterPlotDefaultSettings>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ScatterPlotDefaultSettings;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ScatterPlotDefaultSettings;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ScatterPlotDefaultSettings;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ScatterPlotDefaultSettings;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ScatterPlotDefaultSettings;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ScatterPlotDefaultSettings;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ScatterPlotDefaultSettings;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ScatterPlotDefaultSettings;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ScatterPlotDefaultSettings;
   ...
   * @see #removeField
   */
  withoutField(field: string): ScatterPlotDefaultSettings;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): ScatterPlotDefaultSettings;
   ...
   */
  withoutFields(fields: Array_Type<string>): ScatterPlotDefaultSettings;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): ScatterPlotDefaultSettings;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ScatterPlotDefaultSettings;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ScatterPlotDefaultSettings;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ScatterPlotDefaultSettings;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ScatterPlotDefaultSettings;
   ...
   * @see #removeField
   */
  unsetField(field: string): ScatterPlotDefaultSettings;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ScatterPlotDefaultSettings;
   ...
   * @see #unsetField
   */
  removeField(field: string): ScatterPlotDefaultSettings;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ScatterPlotDefaultSettings;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ScatterPlotDefaultSettings;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): ScatterPlotDefaultSettings;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ScatterPlotDefaultSettings;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ScatterPlotDefaultSettings;

  mergeJson(json: any): ScatterPlotDefaultSettings;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ScatterPlotDefaultSettings;
   ...
   */
  sumObj(other: Obj, deep?: boolean): ScatterPlotDefaultSettings;
   ...
   */
  singletonArray(): Array_Type<ScatterPlotDefaultSettings>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<ScatterPlotDefaultSettings> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ScatterPlotDefaultSettings> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<ScatterPlotDefaultSettings>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ScatterPlotDefaultSettings> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, ScatterPlotDefaultSettings> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ScatterPlotDefaultSettings> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ScatterPlotDefaultSettings>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ScatterPlotDefaultSettings>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ScatterPlotDefaultSettings;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ScatterPlotDefaultSettings;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ScatterPlotDefaultSettings;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ScatterPlotDefaultSettings;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ScatterPlotDefaultSettings;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ScatterPlotDefaultSettings;
   ...
   * @see #fromString
   */
  static make(s: string): ScatterPlotDefaultSettings | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ScatterPlotDefaultSettings;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): ScatterPlotDefaultSettings;
   ...
   */
  static cachedEmptyInst(): ScatterPlotDefaultSettings;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<ScatterPlotDefaultSettings> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): ScatterPlotDefaultSettings;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<ScatterPlotDefaultSettings>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<ScatterPlotDefaultSettings>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<ScatterPlotDefaultSettings> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ScatterPlotDefaultSettings>> | null;
   ...
   */
  get(include?: string): ScatterPlotDefaultSettings | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): ScatterPlotDefaultSettings | null;
   ...
   */
  getMissing(spec: GetMissingSpec): ScatterPlotDefaultSettings;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): ScatterPlotDefaultSettings | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): ScatterPlotDefaultSettings;
   ...
   * @see #toString
   */
  static fromString(s: string): ScatterPlotDefaultSettings | null;
   ...
   */
  create(spec?: UpsertSpec): ScatterPlotDefaultSettings | null;
   ...
   */
  static createBatch(objs: Array_Type<ScatterPlotDefaultSettings>, spec?: UpsertSpec): ObjList<ScatterPlotDefaultSettings> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<ScatterPlotDefaultSettings>, spec?: CreateBatchObjStreamSpec): ObjList<ScatterPlotDefaultSettings> | null;
   ...
   */
  update(srcObj?: ScatterPlotDefaultSettings, spec?: UpsertSpec): ScatterPlotDefaultSettings | null;
   ...
   */
  upsert(srcObj?: ScatterPlotDefaultSettings, spec?: UpsertSpec): ScatterPlotDefaultSettings | null;
   ...
   */
  merge(spec?: MergeSpec): ScatterPlotDefaultSettings | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): ScatterPlotDefaultSettings | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): ScatterPlotDefaultSettings | null;
   ...
   */
  static updateBatch(objs: Array_Type<ScatterPlotDefaultSettings>, srcObjs?: Array_Type<ScatterPlotDefaultSettings>, spec?: UpsertSpec): ObjList<ScatterPlotDefaultSettings> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<ScatterPlotDefaultSettings> | null>, spec?: UpsertSpec): ObjList<ScatterPlotDefaultSettings> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<ScatterPlotDefaultSettings>, srcObjs?: Array_Type<ScatterPlotDefaultSettings>, spec?: UpsertSpec): ObjList<ScatterPlotDefaultSettings> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<ScatterPlotDefaultSettings> | null>, spec?: UpsertSpec): ObjList<ScatterPlotDefaultSettings> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<ScatterPlotDefaultSettings>, spec?: TouchSpec): ObjList<ScatterPlotDefaultSettings> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ScatterPlotDefaultSettings>, spec?: MergeSpec): ObjList<ScatterPlotDefaultSettings> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ScatterPlotDefaultSettings>, mergeInclude: string, spec?: MergeSpec): ObjList<ScatterPlotDefaultSettings> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<ScatterPlotDefaultSettings> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ScatterPlotDefaultSettings> | null;
   ...
   */
  static mergeAll(mergeObj: ScatterPlotDefaultSettings, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: ScatterPlotDefaultSettings, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<ScatterPlotDefaultSettings>, spec?: UpsertSpec): ObjList<ScatterPlotDefaultSettings> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<ScatterPlotDefaultSettings>, spec?: UpsertSpec): ObjList<ScatterPlotDefaultSettings> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): ScatterPlotDefaultSettings | null;
   ...
   */
  static beforeCreate(objs: Array_Type<ScatterPlotDefaultSettings>): ObjList<ScatterPlotDefaultSettings>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<ScatterPlotDefaultSettings>): ObjList<ScatterPlotDefaultSettings>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<ScatterPlotDefaultSettings>): ObjList<ScatterPlotDefaultSettings>;
   ...
   */
  static afterCreate(objs: Array_Type<ScatterPlotDefaultSettings>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<ScatterPlotDefaultSettings>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<ScatterPlotDefaultSettings>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<ScatterPlotDefaultSettings>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ScatterPlotDefaultSettings>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): ScatterPlotDefaultSettings | null;
   ...
   */
  withoutIdentity(): ScatterPlotDefaultSettings | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<ScatterPlotDefaultSettings>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: ScatterPlotDefaultSettings, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<ScatterPlotDefaultSettings>, callback?: λFunction<ScatterPlotDefaultSettings | null, ScatterPlotDefaultSettings | null>): ObjList<ScatterPlotDefaultSettings>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<ScatterPlotDefaultSettings>, callback?: λFunction<ScatterPlotDefaultSettings | null, ScatterPlotDefaultSettings | null>): Array_Type<ObjError> | null;
  ...
  /**
   * Retrieve the period of time plotted in the Scatter Plot rounded to nearest HOUR or DAY.
   */
  static getPlotPeriod(millis: number): Period | null;
}
