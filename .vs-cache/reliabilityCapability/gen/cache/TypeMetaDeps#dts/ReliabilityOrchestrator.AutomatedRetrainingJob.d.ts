// TypeScript definitions for the C3 type ReliabilityOrchestrator.AutomatedRetrainingJob
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityOrchestrator.AutomatedRetrainingJob
 */
declare namespace ReliabilityOrchestrator {
  export interface IAutomatedRetrainingJob {
 ...
 */
declare namespace ReliabilityOrchestrator {
  export class AutomatedRetrainingJob extends Obj  {

    /**
     * The array of configurations this job run must execute.
     */
    readonly jobSpecs: Array_Type<ReliabilityOrchestrator.AutomatedRetrainingJobSpec>;
    withJobSpecs(jobSpecs: Array_Type<ReliabilityOrchestrator.AutomatedRetrainingJobSpec> | Array<IReliabilityOrchestrator.AutomatedRetrainingJobSpec>): ReliabilityOrchestrator.AutomatedRetrainingJob;
     ...
     */
    readonly id: string;
    withId(id: string): ReliabilityOrchestrator.AutomatedRetrainingJob;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityOrchestrator.AutomatedRetrainingJob;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): ReliabilityOrchestrator.AutomatedRetrainingJob;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): ReliabilityOrchestrator.AutomatedRetrainingJob;
    ...
    withVersion(version: number | null): ReliabilityOrchestrator.AutomatedRetrainingJob;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): ReliabilityOrchestrator.AutomatedRetrainingJob;
     ...
     * @see #toJson
     */
    static fromJson(json: any): ReliabilityOrchestrator.AutomatedRetrainingJob | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): ReliabilityOrchestrator.AutomatedRetrainingJob | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): ReliabilityOrchestrator.AutomatedRetrainingJob | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): ReliabilityOrchestrator.AutomatedRetrainingJob | null;
     ...
     */
    replaceType(old: Type, new_: Type): ReliabilityOrchestrator.AutomatedRetrainingJob;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityOrchestrator.AutomatedRetrainingJob;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityOrchestrator.AutomatedRetrainingJob;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityOrchestrator.AutomatedRetrainingJob>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityOrchestrator.AutomatedRetrainingJob>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityOrchestrator.AutomatedRetrainingJob;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityOrchestrator.AutomatedRetrainingJob;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityOrchestrator.AutomatedRetrainingJob;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): ReliabilityOrchestrator.AutomatedRetrainingJob;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): ReliabilityOrchestrator.AutomatedRetrainingJob;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityOrchestrator.AutomatedRetrainingJob;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityOrchestrator.AutomatedRetrainingJob;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityOrchestrator.AutomatedRetrainingJob;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): ReliabilityOrchestrator.AutomatedRetrainingJob;
     ...
     * @see #removeField
     */
    withoutField(field: string): ReliabilityOrchestrator.AutomatedRetrainingJob;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): ReliabilityOrchestrator.AutomatedRetrainingJob;
     ...
     */
    withoutFields(fields: Array_Type<string>): ReliabilityOrchestrator.AutomatedRetrainingJob;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityOrchestrator.AutomatedRetrainingJob;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): ReliabilityOrchestrator.AutomatedRetrainingJob;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityOrchestrator.AutomatedRetrainingJob;
     ...
     * @see #unsetField
     */
    defaultField(field: string): ReliabilityOrchestrator.AutomatedRetrainingJob;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): ReliabilityOrchestrator.AutomatedRetrainingJob;
     ...
     * @see #removeField
     */
    unsetField(field: string): ReliabilityOrchestrator.AutomatedRetrainingJob;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): ReliabilityOrchestrator.AutomatedRetrainingJob;
     ...
     * @see #unsetField
     */
    removeField(field: string): ReliabilityOrchestrator.AutomatedRetrainingJob;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): ReliabilityOrchestrator.AutomatedRetrainingJob;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityOrchestrator.AutomatedRetrainingJob;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityOrchestrator.AutomatedRetrainingJob;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityOrchestrator.AutomatedRetrainingJob;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityOrchestrator.AutomatedRetrainingJob;

    mergeJson(json: any): ReliabilityOrchestrator.AutomatedRetrainingJob;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityOrchestrator.AutomatedRetrainingJob;
     ...
     */
    sumObj(other: Obj, deep?: boolean): ReliabilityOrchestrator.AutomatedRetrainingJob;
     ...
     */
    singletonArray(): Array_Type<ReliabilityOrchestrator.AutomatedRetrainingJob>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityOrchestrator.AutomatedRetrainingJob> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<ReliabilityOrchestrator.AutomatedRetrainingJob> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<ReliabilityOrchestrator.AutomatedRetrainingJob>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<ReliabilityOrchestrator.AutomatedRetrainingJob> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, ReliabilityOrchestrator.AutomatedRetrainingJob> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityOrchestrator.AutomatedRetrainingJob> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<ReliabilityOrchestrator.AutomatedRetrainingJob>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<ReliabilityOrchestrator.AutomatedRetrainingJob>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityOrchestrator.AutomatedRetrainingJob;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityOrchestrator.AutomatedRetrainingJob;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityOrchestrator.AutomatedRetrainingJob;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): ReliabilityOrchestrator.AutomatedRetrainingJob;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityOrchestrator.AutomatedRetrainingJob;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): ReliabilityOrchestrator.AutomatedRetrainingJob;
     ...
     * @see #fromString
     */
    static make(s: string): ReliabilityOrchestrator.AutomatedRetrainingJob | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityOrchestrator.AutomatedRetrainingJob;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): ReliabilityOrchestrator.AutomatedRetrainingJob;
     ...
     */
    static cachedEmptyInst(): ReliabilityOrchestrator.AutomatedRetrainingJob;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityOrchestrator.AutomatedRetrainingJob> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): ReliabilityOrchestrator.AutomatedRetrainingJob;
     ...
     */
    createWorkflow(options?: ReliabilityOrchestrator.JobOptions, additionalParams?: Map_Type<string, any>, name?: string): Workflow;
     ...
     */
    doStart(options?: ReliabilityOrchestrator.JobOptions, additionalParams?: Map_Type<string, any>): Pair<ReliabilityOrchestrator.AutomatedRetrainingJobRun, MlOperationRun<ReliabilityOrchestrator.AutomatedRetrainingJobRun>>;
     ...
     */
    start(options?: ReliabilityOrchestrator.JobOptions, additionalParams?: Map_Type<string, any>): MlOperationRun<ReliabilityOrchestrator.AutomatedRetrainingJobRun>;

    /**
     * @return The concrete {@link ReliabilityOrchestrator.JobRun} subType.
     */
    static jobRunType(): Type<<ReliabilityOrchestrator.AutomatedRetrainingJobRun>> | null;

    /**
     * @return the concrete {@link ReliabilityOrchestrator.JobSpec} subType.
     */
    static jobSpecType(): Type<<ReliabilityOrchestrator.AutomatedRetrainingJobSpec>> | null;
     ...
     */
    fetchJobRunForOperationRun(run: MlOperationRun<any>): ReliabilityOrchestrator.AutomatedRetrainingJobRun | null;
     ...
     */
    fetchLatestJobRun(): ReliabilityOrchestrator.AutomatedRetrainingJobRun | null;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<ReliabilityOrchestrator.AutomatedRetrainingJob>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<ReliabilityOrchestrator.AutomatedRetrainingJob>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityOrchestrator.AutomatedRetrainingJob> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityOrchestrator.AutomatedRetrainingJob>> | null;
     ...
     */
    get(include?: string): ReliabilityOrchestrator.AutomatedRetrainingJob | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): ReliabilityOrchestrator.AutomatedRetrainingJob | null;
     ...
     */
    getMissing(spec: GetMissingSpec): ReliabilityOrchestrator.AutomatedRetrainingJob;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): ReliabilityOrchestrator.AutomatedRetrainingJob | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): ReliabilityOrchestrator.AutomatedRetrainingJob;
     ...
     * @see #toString
     */
    static fromString(s: string): ReliabilityOrchestrator.AutomatedRetrainingJob | null;
     ...
     */
    create(spec?: UpsertSpec): ReliabilityOrchestrator.AutomatedRetrainingJob | null;
     ...
     */
    static createBatch(objs: Array_Type<ReliabilityOrchestrator.AutomatedRetrainingJob>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.AutomatedRetrainingJob> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<ReliabilityOrchestrator.AutomatedRetrainingJob>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityOrchestrator.AutomatedRetrainingJob> | null;
     ...
     */
    update(srcObj?: ReliabilityOrchestrator.AutomatedRetrainingJob, spec?: UpsertSpec): ReliabilityOrchestrator.AutomatedRetrainingJob | null;
     ...
     */
    upsert(srcObj?: ReliabilityOrchestrator.AutomatedRetrainingJob, spec?: UpsertSpec): ReliabilityOrchestrator.AutomatedRetrainingJob | null;
     ...
     */
    merge(spec?: MergeSpec): ReliabilityOrchestrator.AutomatedRetrainingJob | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): ReliabilityOrchestrator.AutomatedRetrainingJob | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): ReliabilityOrchestrator.AutomatedRetrainingJob | null;
     ...
     */
    static updateBatch(objs: Array_Type<ReliabilityOrchestrator.AutomatedRetrainingJob>, srcObjs?: Array_Type<ReliabilityOrchestrator.AutomatedRetrainingJob>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.AutomatedRetrainingJob> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<ReliabilityOrchestrator.AutomatedRetrainingJob> | null>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.AutomatedRetrainingJob> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<ReliabilityOrchestrator.AutomatedRetrainingJob>, srcObjs?: Array_Type<ReliabilityOrchestrator.AutomatedRetrainingJob>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.AutomatedRetrainingJob> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<ReliabilityOrchestrator.AutomatedRetrainingJob> | null>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.AutomatedRetrainingJob> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<ReliabilityOrchestrator.AutomatedRetrainingJob>, spec?: TouchSpec): ObjList<ReliabilityOrchestrator.AutomatedRetrainingJob> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityOrchestrator.AutomatedRetrainingJob>, spec?: MergeSpec): ObjList<ReliabilityOrchestrator.AutomatedRetrainingJob> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityOrchestrator.AutomatedRetrainingJob>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityOrchestrator.AutomatedRetrainingJob> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<ReliabilityOrchestrator.AutomatedRetrainingJob> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityOrchestrator.AutomatedRetrainingJob> | null;
     ...
     */
    static mergeAll(mergeObj: ReliabilityOrchestrator.AutomatedRetrainingJob, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: ReliabilityOrchestrator.AutomatedRetrainingJob, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<ReliabilityOrchestrator.AutomatedRetrainingJob>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.AutomatedRetrainingJob> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<ReliabilityOrchestrator.AutomatedRetrainingJob>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.AutomatedRetrainingJob> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): ReliabilityOrchestrator.AutomatedRetrainingJob | null;
     ...
     */
    static beforeCreate(objs: Array_Type<ReliabilityOrchestrator.AutomatedRetrainingJob>): ObjList<ReliabilityOrchestrator.AutomatedRetrainingJob>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<ReliabilityOrchestrator.AutomatedRetrainingJob>): ObjList<ReliabilityOrchestrator.AutomatedRetrainingJob>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<ReliabilityOrchestrator.AutomatedRetrainingJob>): ObjList<ReliabilityOrchestrator.AutomatedRetrainingJob>;
     ...
     */
    static afterCreate(objs: Array_Type<ReliabilityOrchestrator.AutomatedRetrainingJob>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<ReliabilityOrchestrator.AutomatedRetrainingJob>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<ReliabilityOrchestrator.AutomatedRetrainingJob>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityOrchestrator.AutomatedRetrainingJob>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityOrchestrator.AutomatedRetrainingJob>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): ReliabilityOrchestrator.AutomatedRetrainingJob | null;
     ...
     */
    withoutIdentity(): ReliabilityOrchestrator.AutomatedRetrainingJob | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<ReliabilityOrchestrator.AutomatedRetrainingJob>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: ReliabilityOrchestrator.AutomatedRetrainingJob, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<ReliabilityOrchestrator.AutomatedRetrainingJob>, callback?: λFunction<ReliabilityOrchestrator.AutomatedRetrainingJob | null, ReliabilityOrchestrator.AutomatedRetrainingJob | null>): ObjList<ReliabilityOrchestrator.AutomatedRetrainingJob>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<ReliabilityOrchestrator.AutomatedRetrainingJob>, callback?: λFunction<ReliabilityOrchestrator.AutomatedRetrainingJob | null, ReliabilityOrchestrator.AutomatedRetrainingJob | null>): Array_Type<ObjError> | null;
