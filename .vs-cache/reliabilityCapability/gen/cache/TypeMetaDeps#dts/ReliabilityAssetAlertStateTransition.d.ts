// TypeScript definitions for the C3 type ReliabilityAssetAlertStateTransition

/**
 * Represents a state transition for {@link ReliabilityAssetAlertState} within a state machine.
 * This entity defines the valid transitions between different alert states for a reliability asset.
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityAssetAlertStateTransition
 */
declare interface IReliabilityAssetAlertStateTransition {
   ...
   */
  from: IReliabilityAssetAlertState;

  /**
   * The {@link StateMachineState} to transition to.
   */
  to: IReliabilityAssetAlertState;
 ...
 * This entity defines the valid transitions between different alert states for a reliability asset.
 *
 * @remarks this represents a made instance of ReliabilityAssetAlertStateTransition
 */
declare class ReliabilityAssetAlertStateTransition extends Obj  {
   ...
   */
  readonly id: string;
  withId(id: string): ReliabilityAssetAlertStateTransition;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityAssetAlertStateTransition;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): ReliabilityAssetAlertStateTransition;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): ReliabilityAssetAlertStateTransition;
  ...
  withVersion(version: number | null): ReliabilityAssetAlertStateTransition;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): ReliabilityAssetAlertStateTransition;
  ...
  withUserUpdatedFields(userUpdatedFields: Array_Type<string> | Array<string> | null): ReliabilityAssetAlertStateTransition;
  ...
  withHidden(hidden: boolean): ReliabilityAssetAlertStateTransition;
  ...
  withUserOwned(userOwned: boolean): ReliabilityAssetAlertStateTransition;

  /**
   * List of {@link AclEntry} entries governing who can read/update/remove Objs.
   */
  readonly acl?: Array_Type<AclEntry>;
  withAcl(acl: Array_Type<AclEntry> | Array<IAclEntry> | null): ReliabilityAssetAlertStateTransition;

  /**
   * The {@link StateMachineState} to transition from.
   */
  readonly from: ReliabilityAssetAlertState;
  withFrom(from: IReliabilityAssetAlertState): ReliabilityAssetAlertStateTransition;

  /**
   * The {@link StateMachineState} to transition to.
   */
  readonly to: ReliabilityAssetAlertState;
  withTo(to: IReliabilityAssetAlertState): ReliabilityAssetAlertStateTransition;

  /**
   * Used to soft delete a record so all state histories still have valid pointers.
   */
  readonly deleted?: boolean;
  withDeleted(deleted: boolean): ReliabilityAssetAlertStateTransition;

  /**
   * A transition is only valid if the {@link from}, {@link to}, and itself are not deleted.
   */
  readonly isValid?: boolean;
  withIsValid(isValid: boolean): ReliabilityAssetAlertStateTransition;

  /**
   * The trigger that must be satisfied in order for this transition to take place.
   */
  readonly trigger?: TransitionTrigger;
  withTrigger(trigger: ITransitionTrigger | null): ReliabilityAssetAlertStateTransition;
  ...
  withCondition(condition: string | null): ReliabilityAssetAlertStateTransition;

  /**
   * Used to include fields on the source type for exitAction and entryAction.
   */
  readonly includeSpec?: string;
  withIncludeSpec(includeSpec: string | null): ReliabilityAssetAlertStateTransition;

  /**
   * The action to be taken during this {@link StateMachineTransition}.
   */
  readonly action?: λConsumer<any | null>;
  withAction(action: λConsumer<any | null> | null): ReliabilityAssetAlertStateTransition;
   ...
   * @see #toJson
   */
  static fromJson(json: any): ReliabilityAssetAlertStateTransition | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): ReliabilityAssetAlertStateTransition | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): ReliabilityAssetAlertStateTransition | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): ReliabilityAssetAlertStateTransition | null;
   ...
   */
  replaceType(old: Type, new_: Type): ReliabilityAssetAlertStateTransition;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityAssetAlertStateTransition;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityAssetAlertStateTransition;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityAssetAlertStateTransition>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityAssetAlertStateTransition>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityAssetAlertStateTransition;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityAssetAlertStateTransition;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityAssetAlertStateTransition;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ReliabilityAssetAlertStateTransition;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ReliabilityAssetAlertStateTransition;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityAssetAlertStateTransition;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityAssetAlertStateTransition;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityAssetAlertStateTransition;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ReliabilityAssetAlertStateTransition;
   ...
   * @see #removeField
   */
  withoutField(field: string): ReliabilityAssetAlertStateTransition;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): ReliabilityAssetAlertStateTransition;
   ...
   */
  withoutFields(fields: Array_Type<string>): ReliabilityAssetAlertStateTransition;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityAssetAlertStateTransition;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ReliabilityAssetAlertStateTransition;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityAssetAlertStateTransition;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ReliabilityAssetAlertStateTransition;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ReliabilityAssetAlertStateTransition;
   ...
   * @see #removeField
   */
  unsetField(field: string): ReliabilityAssetAlertStateTransition;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ReliabilityAssetAlertStateTransition;
   ...
   * @see #unsetField
   */
  removeField(field: string): ReliabilityAssetAlertStateTransition;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ReliabilityAssetAlertStateTransition;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityAssetAlertStateTransition;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityAssetAlertStateTransition;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityAssetAlertStateTransition;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityAssetAlertStateTransition;

  mergeJson(json: any): ReliabilityAssetAlertStateTransition;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityAssetAlertStateTransition;
   ...
   */
  sumObj(other: Obj, deep?: boolean): ReliabilityAssetAlertStateTransition;
   ...
   */
  singletonArray(): Array_Type<ReliabilityAssetAlertStateTransition>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityAssetAlertStateTransition> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ReliabilityAssetAlertStateTransition> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<ReliabilityAssetAlertStateTransition>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ReliabilityAssetAlertStateTransition> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, ReliabilityAssetAlertStateTransition> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityAssetAlertStateTransition> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ReliabilityAssetAlertStateTransition>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ReliabilityAssetAlertStateTransition>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityAssetAlertStateTransition;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityAssetAlertStateTransition;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityAssetAlertStateTransition;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ReliabilityAssetAlertStateTransition;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityAssetAlertStateTransition;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ReliabilityAssetAlertStateTransition;
   ...
   * @see #fromString
   */
  static make(s: string): ReliabilityAssetAlertStateTransition | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityAssetAlertStateTransition;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): ReliabilityAssetAlertStateTransition;
   ...
   */
  static cachedEmptyInst(): ReliabilityAssetAlertStateTransition;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityAssetAlertStateTransition> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): ReliabilityAssetAlertStateTransition;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<ReliabilityAssetAlertStateTransition> | null;
   ...
   */
  static find(filter?: string, doNotProduceAll?: boolean): Stream<ReliabilityAssetAlertStateTransition> | null;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<ReliabilityAssetAlertStateTransition> | null;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): ReliabilityAssetAlertStateTransition | null;
   ...
   * @see findByCacheKey
   */
  static forCacheKey(key: string): ReliabilityAssetAlertStateTransition | null;
   ...
   * @see findByCacheKey
   */
  getCached(): ReliabilityAssetAlertStateTransition | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): ReliabilityAssetAlertStateTransition | null;
   ...
   */
  static produce(key: string): ReliabilityAssetAlertStateTransition | null;
   ...
   */
  static produceAll(): Map_Type<string, ReliabilityAssetAlertStateTransition> | null;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): Map_Type<string, ReliabilityAssetAlertStateTransition> | null;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<ReliabilityAssetAlertStateTransition>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<ReliabilityAssetAlertStateTransition>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityAssetAlertStateTransition> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityAssetAlertStateTransition>> | null;
   ...
   */
  get(include?: string): ReliabilityAssetAlertStateTransition | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): ReliabilityAssetAlertStateTransition | null;
   ...
   */
  getMissing(spec: GetMissingSpec): ReliabilityAssetAlertStateTransition;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): ReliabilityAssetAlertStateTransition | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): ReliabilityAssetAlertStateTransition;
   ...
   * @see #toString
   */
  static fromString(s: string): ReliabilityAssetAlertStateTransition | null;
   ...
   */
  create(spec?: UpsertSpec): ReliabilityAssetAlertStateTransition | null;
   ...
   */
  static createBatch(objs: Array_Type<ReliabilityAssetAlertStateTransition>, spec?: UpsertSpec): ObjList<ReliabilityAssetAlertStateTransition> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<ReliabilityAssetAlertStateTransition>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityAssetAlertStateTransition> | null;
   ...
   */
  update(srcObj?: ReliabilityAssetAlertStateTransition, spec?: UpsertSpec): ReliabilityAssetAlertStateTransition | null;
   ...
   */
  upsert(srcObj?: ReliabilityAssetAlertStateTransition, spec?: UpsertSpec): ReliabilityAssetAlertStateTransition | null;
   ...
   */
  merge(spec?: MergeSpec): ReliabilityAssetAlertStateTransition | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): ReliabilityAssetAlertStateTransition | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): ReliabilityAssetAlertStateTransition | null;
   ...
   */
  static updateBatch(objs: Array_Type<ReliabilityAssetAlertStateTransition>, srcObjs?: Array_Type<ReliabilityAssetAlertStateTransition>, spec?: UpsertSpec): ObjList<ReliabilityAssetAlertStateTransition> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<ReliabilityAssetAlertStateTransition> | null>, spec?: UpsertSpec): ObjList<ReliabilityAssetAlertStateTransition> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<ReliabilityAssetAlertStateTransition>, srcObjs?: Array_Type<ReliabilityAssetAlertStateTransition>, spec?: UpsertSpec): ObjList<ReliabilityAssetAlertStateTransition> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<ReliabilityAssetAlertStateTransition> | null>, spec?: UpsertSpec): ObjList<ReliabilityAssetAlertStateTransition> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<ReliabilityAssetAlertStateTransition>, spec?: TouchSpec): ObjList<ReliabilityAssetAlertStateTransition> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityAssetAlertStateTransition>, spec?: MergeSpec): ObjList<ReliabilityAssetAlertStateTransition> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityAssetAlertStateTransition>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityAssetAlertStateTransition> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<ReliabilityAssetAlertStateTransition> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityAssetAlertStateTransition> | null;
   ...
   */
  static mergeAll(mergeObj: ReliabilityAssetAlertStateTransition, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: ReliabilityAssetAlertStateTransition, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<ReliabilityAssetAlertStateTransition>, spec?: UpsertSpec): ObjList<ReliabilityAssetAlertStateTransition> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<ReliabilityAssetAlertStateTransition>, spec?: UpsertSpec): ObjList<ReliabilityAssetAlertStateTransition> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): ReliabilityAssetAlertStateTransition | null;
   ...
   */
  static beforeCreate(objs: Array_Type<ReliabilityAssetAlertStateTransition>): ObjList<ReliabilityAssetAlertStateTransition>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<ReliabilityAssetAlertStateTransition>): ObjList<ReliabilityAssetAlertStateTransition>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<ReliabilityAssetAlertStateTransition>): ObjList<ReliabilityAssetAlertStateTransition>;

  /**
   * Adds retry mechanism to wait for {@link ReliabilityAssetAlertState} to be seeded before
   * executing {@link ReliabilityAssetAlertStateTransition#refreshCalcFields}.
   */
  static afterCreate(objs: Array_Type<ReliabilityAssetAlertStateTransition>): Array_Type<ObjError> | null;
   ...
   */
  static afterUpdate(objs: Array_Type<ReliabilityAssetAlertStateTransition>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<ReliabilityAssetAlertStateTransition>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityAssetAlertStateTransition>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityAssetAlertStateTransition>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): ReliabilityAssetAlertStateTransition | null;
   ...
   */
  withoutIdentity(): ReliabilityAssetAlertStateTransition | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<ReliabilityAssetAlertStateTransition>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: ReliabilityAssetAlertStateTransition, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<ReliabilityAssetAlertStateTransition>, callback?: λFunction<ReliabilityAssetAlertStateTransition | null, ReliabilityAssetAlertStateTransition | null>): ObjList<ReliabilityAssetAlertStateTransition>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<ReliabilityAssetAlertStateTransition>, callback?: λFunction<ReliabilityAssetAlertStateTransition | null, ReliabilityAssetAlertStateTransition | null>): Array_Type<ObjError> | null;
   ...
   */
  publish(subPath?: string, contentType?: string): ReliabilityAssetAlertStateTransition;
   ...
   */
  static removeSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<ReliabilityAssetAlertStateTransition> | null;
   ...
   */
  createSeedData(spec?: UpsertSpec): ReliabilityAssetAlertStateTransition | null;
   ...
   */
  static createSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<ReliabilityAssetAlertStateTransition> | null;
   ...
   */
  updateSeedData(srcObj?: SeedData, spec?: UpsertSpec): ReliabilityAssetAlertStateTransition | null;
   ...
   */
  static updateSeedDataBatch(objs?: Array_Type<SeedData>, srcObjs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<ReliabilityAssetAlertStateTransition> | null;
   ...
   * @return updated obj instance, same as {@link Persistable#update} return value.
   */
  clearUserUpdates(spec?: MergeSpec): ReliabilityAssetAlertStateTransition | null;
   ...
   *         {@link Persistable#updateBatch}.
   */
  static clearUserUpdatesBatch(objs?: Array_Type<SeedData>, spec?: MergeSpec): ObjList<ReliabilityAssetAlertStateTransition> | null;
  ...
  dependencies(): SeedDataDeps<ReliabilityAssetAlertStateTransition> | null;
   ...
   */
  static populateAcl(objs?: Array_Type<ReliabilityAssetAlertStateTransition>): number | null;
   ...
   */
  grantMemberReadUpdateRemove(member: AccessControlEntity): ReliabilityAssetAlertStateTransition;
   ...
   */
  mergeAclEntry(entry: AclEntry): ReliabilityAssetAlertStateTransition;
   ...
   * @return the obj with the new acl after merging the indicated entry.
   */
  mergeAclEntries(entries: Array_Type<AclEntry>): ReliabilityAssetAlertStateTransition;
