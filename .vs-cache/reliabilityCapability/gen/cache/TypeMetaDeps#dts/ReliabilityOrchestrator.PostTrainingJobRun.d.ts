// TypeScript definitions for the C3 type ReliabilityOrchestrator.PostTrainingJobRun
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityOrchestrator.PostTrainingJobRun
 */
declare namespace ReliabilityOrchestrator {
  export interface IPostTrainingJobRun {

    /**
     * The distributed job this run is an instance of.
     */
    job: IReliabilityOrchestrator.PostTrainingJob;

    /**
     * The array of configurations this job run must execute.
     */
    jobSpecs: Array_Type<ReliabilityOrchestrator.PostTrainingJobSpec> | Array<IReliabilityOrchestrator.PostTrainingJobSpec>;
 ...
 */
declare namespace ReliabilityOrchestrator {
  export class PostTrainingJobRun extends Obj  {

    /**
     * The distributed job this run is an instance of.
     */
    readonly job: ReliabilityOrchestrator.PostTrainingJob;
    withJob(job: IReliabilityOrchestrator.PostTrainingJob): ReliabilityOrchestrator.PostTrainingJobRun;

    /**
     * The array of configurations this job run must execute.
     */
    readonly jobSpecs: Array_Type<ReliabilityOrchestrator.PostTrainingJobSpec>;
    withJobSpecs(jobSpecs: Array_Type<ReliabilityOrchestrator.PostTrainingJobSpec> | Array<IReliabilityOrchestrator.PostTrainingJobSpec>): ReliabilityOrchestrator.PostTrainingJobRun;
    ...
    withMlOperationRun(mlOperationRun: IMlOperationRun<any> | null): ReliabilityOrchestrator.PostTrainingJobRun;

    /**
     * Options that were used to specify execution constraints for this training job run.
     */
    readonly options: ReliabilityOrchestrator.JobOptions;
    withOptions(options: IReliabilityOrchestrator.JobOptions): ReliabilityOrchestrator.PostTrainingJobRun;
    ...
    withTypeIdent(typeIdent: string | null): ReliabilityOrchestrator.PostTrainingJobRun;
     ...
     */
    readonly id: string;
    withId(id: string): ReliabilityOrchestrator.PostTrainingJobRun;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityOrchestrator.PostTrainingJobRun;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): ReliabilityOrchestrator.PostTrainingJobRun;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): ReliabilityOrchestrator.PostTrainingJobRun;
    ...
    withVersion(version: number | null): ReliabilityOrchestrator.PostTrainingJobRun;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): ReliabilityOrchestrator.PostTrainingJobRun;

    /**
     * {@link JobOptions} for executing this coordinator.
     */
    readonly jobOptions?: JobOptions;
    withJobOptions(jobOptions: IJobOptions | null): ReliabilityOrchestrator.PostTrainingJobRun;
     ...
     * @see #toJson
     */
    static fromJson(json: any): ReliabilityOrchestrator.PostTrainingJobRun | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): ReliabilityOrchestrator.PostTrainingJobRun | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): ReliabilityOrchestrator.PostTrainingJobRun | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): ReliabilityOrchestrator.PostTrainingJobRun | null;
     ...
     */
    replaceType(old: Type, new_: Type): ReliabilityOrchestrator.PostTrainingJobRun;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityOrchestrator.PostTrainingJobRun;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityOrchestrator.PostTrainingJobRun;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityOrchestrator.PostTrainingJobRun>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityOrchestrator.PostTrainingJobRun>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityOrchestrator.PostTrainingJobRun;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityOrchestrator.PostTrainingJobRun;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityOrchestrator.PostTrainingJobRun;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): ReliabilityOrchestrator.PostTrainingJobRun;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): ReliabilityOrchestrator.PostTrainingJobRun;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityOrchestrator.PostTrainingJobRun;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityOrchestrator.PostTrainingJobRun;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityOrchestrator.PostTrainingJobRun;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): ReliabilityOrchestrator.PostTrainingJobRun;
     ...
     * @see #removeField
     */
    withoutField(field: string): ReliabilityOrchestrator.PostTrainingJobRun;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): ReliabilityOrchestrator.PostTrainingJobRun;
     ...
     */
    withoutFields(fields: Array_Type<string>): ReliabilityOrchestrator.PostTrainingJobRun;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityOrchestrator.PostTrainingJobRun;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): ReliabilityOrchestrator.PostTrainingJobRun;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityOrchestrator.PostTrainingJobRun;
     ...
     * @see #unsetField
     */
    defaultField(field: string): ReliabilityOrchestrator.PostTrainingJobRun;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): ReliabilityOrchestrator.PostTrainingJobRun;
     ...
     * @see #removeField
     */
    unsetField(field: string): ReliabilityOrchestrator.PostTrainingJobRun;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): ReliabilityOrchestrator.PostTrainingJobRun;
     ...
     * @see #unsetField
     */
    removeField(field: string): ReliabilityOrchestrator.PostTrainingJobRun;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): ReliabilityOrchestrator.PostTrainingJobRun;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityOrchestrator.PostTrainingJobRun;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityOrchestrator.PostTrainingJobRun;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityOrchestrator.PostTrainingJobRun;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityOrchestrator.PostTrainingJobRun;

    mergeJson(json: any): ReliabilityOrchestrator.PostTrainingJobRun;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityOrchestrator.PostTrainingJobRun;
     ...
     */
    sumObj(other: Obj, deep?: boolean): ReliabilityOrchestrator.PostTrainingJobRun;
     ...
     */
    singletonArray(): Array_Type<ReliabilityOrchestrator.PostTrainingJobRun>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityOrchestrator.PostTrainingJobRun> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<ReliabilityOrchestrator.PostTrainingJobRun> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<ReliabilityOrchestrator.PostTrainingJobRun>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<ReliabilityOrchestrator.PostTrainingJobRun> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, ReliabilityOrchestrator.PostTrainingJobRun> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityOrchestrator.PostTrainingJobRun> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<ReliabilityOrchestrator.PostTrainingJobRun>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<ReliabilityOrchestrator.PostTrainingJobRun>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityOrchestrator.PostTrainingJobRun;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityOrchestrator.PostTrainingJobRun;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityOrchestrator.PostTrainingJobRun;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): ReliabilityOrchestrator.PostTrainingJobRun;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityOrchestrator.PostTrainingJobRun;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): ReliabilityOrchestrator.PostTrainingJobRun;
     ...
     * @see #fromString
     */
    static make(s: string): ReliabilityOrchestrator.PostTrainingJobRun | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityOrchestrator.PostTrainingJobRun;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): ReliabilityOrchestrator.PostTrainingJobRun;
     ...
     */
    static cachedEmptyInst(): ReliabilityOrchestrator.PostTrainingJobRun;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityOrchestrator.PostTrainingJobRun> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): ReliabilityOrchestrator.PostTrainingJobRun;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<ReliabilityOrchestrator.PostTrainingJobRun>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<ReliabilityOrchestrator.PostTrainingJobRun>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityOrchestrator.PostTrainingJobRun> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityOrchestrator.PostTrainingJobRun>> | null;
     ...
     */
    get(include?: string): ReliabilityOrchestrator.PostTrainingJobRun | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): ReliabilityOrchestrator.PostTrainingJobRun | null;
     ...
     */
    getMissing(spec: GetMissingSpec): ReliabilityOrchestrator.PostTrainingJobRun;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): ReliabilityOrchestrator.PostTrainingJobRun | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): ReliabilityOrchestrator.PostTrainingJobRun;
     ...
     * @see #toString
     */
    static fromString(s: string): ReliabilityOrchestrator.PostTrainingJobRun | null;
     ...
     */
    create(spec?: UpsertSpec): ReliabilityOrchestrator.PostTrainingJobRun | null;
     ...
     */
    static createBatch(objs: Array_Type<ReliabilityOrchestrator.PostTrainingJobRun>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.PostTrainingJobRun> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<ReliabilityOrchestrator.PostTrainingJobRun>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityOrchestrator.PostTrainingJobRun> | null;
     ...
     */
    update(srcObj?: ReliabilityOrchestrator.PostTrainingJobRun, spec?: UpsertSpec): ReliabilityOrchestrator.PostTrainingJobRun | null;
     ...
     */
    upsert(srcObj?: ReliabilityOrchestrator.PostTrainingJobRun, spec?: UpsertSpec): ReliabilityOrchestrator.PostTrainingJobRun | null;
     ...
     */
    merge(spec?: MergeSpec): ReliabilityOrchestrator.PostTrainingJobRun | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): ReliabilityOrchestrator.PostTrainingJobRun | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): ReliabilityOrchestrator.PostTrainingJobRun | null;
     ...
     */
    static updateBatch(objs: Array_Type<ReliabilityOrchestrator.PostTrainingJobRun>, srcObjs?: Array_Type<ReliabilityOrchestrator.PostTrainingJobRun>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.PostTrainingJobRun> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<ReliabilityOrchestrator.PostTrainingJobRun> | null>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.PostTrainingJobRun> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<ReliabilityOrchestrator.PostTrainingJobRun>, srcObjs?: Array_Type<ReliabilityOrchestrator.PostTrainingJobRun>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.PostTrainingJobRun> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<ReliabilityOrchestrator.PostTrainingJobRun> | null>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.PostTrainingJobRun> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<ReliabilityOrchestrator.PostTrainingJobRun>, spec?: TouchSpec): ObjList<ReliabilityOrchestrator.PostTrainingJobRun> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityOrchestrator.PostTrainingJobRun>, spec?: MergeSpec): ObjList<ReliabilityOrchestrator.PostTrainingJobRun> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityOrchestrator.PostTrainingJobRun>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityOrchestrator.PostTrainingJobRun> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<ReliabilityOrchestrator.PostTrainingJobRun> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityOrchestrator.PostTrainingJobRun> | null;
     ...
     */
    static mergeAll(mergeObj: ReliabilityOrchestrator.PostTrainingJobRun, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: ReliabilityOrchestrator.PostTrainingJobRun, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<ReliabilityOrchestrator.PostTrainingJobRun>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.PostTrainingJobRun> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<ReliabilityOrchestrator.PostTrainingJobRun>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.PostTrainingJobRun> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): ReliabilityOrchestrator.PostTrainingJobRun | null;
     ...
     */
    static beforeCreate(objs: Array_Type<ReliabilityOrchestrator.PostTrainingJobRun>): ObjList<ReliabilityOrchestrator.PostTrainingJobRun>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<ReliabilityOrchestrator.PostTrainingJobRun>): ObjList<ReliabilityOrchestrator.PostTrainingJobRun>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<ReliabilityOrchestrator.PostTrainingJobRun>): ObjList<ReliabilityOrchestrator.PostTrainingJobRun>;
     ...
     */
    static afterCreate(objs: Array_Type<ReliabilityOrchestrator.PostTrainingJobRun>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<ReliabilityOrchestrator.PostTrainingJobRun>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<ReliabilityOrchestrator.PostTrainingJobRun>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityOrchestrator.PostTrainingJobRun>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityOrchestrator.PostTrainingJobRun>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): ReliabilityOrchestrator.PostTrainingJobRun | null;
     ...
     */
    withoutIdentity(): ReliabilityOrchestrator.PostTrainingJobRun | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<ReliabilityOrchestrator.PostTrainingJobRun>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: ReliabilityOrchestrator.PostTrainingJobRun, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<ReliabilityOrchestrator.PostTrainingJobRun>, callback?: λFunction<ReliabilityOrchestrator.PostTrainingJobRun | null, ReliabilityOrchestrator.PostTrainingJobRun | null>): ObjList<ReliabilityOrchestrator.PostTrainingJobRun>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<ReliabilityOrchestrator.PostTrainingJobRun>, callback?: λFunction<ReliabilityOrchestrator.PostTrainingJobRun | null, ReliabilityOrchestrator.PostTrainingJobRun | null>): Array_Type<ObjError> | null;
     ...
     */
    generateNextResults(completed?: Stream<ReliabilityOrchestrator.PostTrainingJobResult>): number;
     ...
     */
    startResult(result: ReliabilityOrchestrator.PostTrainingJobResult): ReliabilityOrchestrator.PostTrainingJobResult;
     ...
     */
    afterStart(results: Stream<ReliabilityOrchestrator.PostTrainingJobResult>): Stream<ReliabilityOrchestrator.PostTrainingJobResult> | null;
     ...
     * @return the result instance, as acknowledgement, even if unmodified.
     */
    completeResult(result: ReliabilityOrchestrator.PostTrainingJobResult): ReliabilityOrchestrator.PostTrainingJobResult;
     ...
     */
    updateRunningResults(spec?: FetchStreamSpec): Stream<ReliabilityOrchestrator.PostTrainingJobResult> | null;
     ...
     */
    afterComplete(results: Stream<ReliabilityOrchestrator.PostTrainingJobResult>): Stream<ReliabilityOrchestrator.PostTrainingJobResult> | null;
     ...
     */
    runFromResult(result: ReliabilityOrchestrator.PostTrainingJobResult): WorkflowExecutorRun | null;
     ...
     *    Optional {@link FetchStreamSpec} for customizing fetching of RT objects.
     */
    pendingResults(spec?: FetchStreamSpec): Stream<ReliabilityOrchestrator.PostTrainingJobResult> | null;
     ...
     *    Optional {@link FetchStreamSpec} for customizing fetching of RT objects.
     */
    runningResults(spec?: FetchStreamSpec): Stream<ReliabilityOrchestrator.PostTrainingJobResult> | null;
     ...
     *    Optional {@link FetchStreamSpec} for customizing fetching of RT objects.
     */
    completedResults(spec?: FetchStreamSpec): Stream<ReliabilityOrchestrator.PostTrainingJobResult> | null;
     ...
     *    Optional {@link FetchStreamSpec} for customizing fetching of RT objects.
     */
    canceledResults(spec?: FetchStreamSpec): Stream<ReliabilityOrchestrator.PostTrainingJobResult> | null;
     ...
     *    Optional {@link FetchStreamSpec} for customizing fetching of RT objects.
     */
    erroredResults(spec?: FetchStreamSpec): Stream<ReliabilityOrchestrator.PostTrainingJobResult> | null;
     ...
     *    Optional {@link FetchStreamSpec} for customizing fetching of RT objects.
     */
    allResults(spec?: FetchStreamSpec): Stream<ReliabilityOrchestrator.PostTrainingJobResult> | null;
     ...
     */
    customSummaryFieldsForResult(result: ReliabilityOrchestrator.PostTrainingJobResult): Map_Type<string, any> | null;
     ...
     * @return a table with a row for each step and the corresponding execution metadata.
     */
    summaryForResults(results: Array_Type<ReliabilityOrchestrator.PostTrainingJobResult>, spec?: Workflow.Monitorable.SummarySpec): Data;
     ...
     * @return a table with a row for each step and the corresponding execution metadata.
     */
    summaryForResultsPd(results: Array_Type<ReliabilityOrchestrator.PostTrainingJobResult>, spec?: Workflow.Monitorable.SummarySpec): any | null;
     ...
     */
    resultsForSummary(spec?: FetchSpec): FetchResult<ReliabilityOrchestrator.PostTrainingJobResult> | null;
  }
}
