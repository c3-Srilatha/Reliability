// TypeScript definitions for the C3 type ReliabilityAssetAlertState

/**
 * The state of a {@link ReliabilityAssetAlert}.
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityAssetAlertState
 */
declare interface IReliabilityAssetAlertState {
  ...
  /**
   * The name of the state, translated based on id,
   * including: Closed, Muted, Open, Case.
   */
  name?: string;
   ...
   */
  autoTransitions?: Array_Type<ReliabilityAssetAlertStateTransition> | Array<IReliabilityAssetAlertStateTransition>;
   ...
   */
  periodicTransitions?: Array_Type<ReliabilityAssetAlertStateTransition> | Array<IReliabilityAssetAlertStateTransition>;
   ...
   */
  fromTransitions?: Array_Type<ReliabilityAssetAlertStateTransition> | Array<IReliabilityAssetAlertStateTransition>;

  /**
   * {@link StateMachineTransition}s that lead into this {@link StateMachineState}.
   */
  toTransitions?: Array_Type<ReliabilityAssetAlertStateTransition> | Array<IReliabilityAssetAlertStateTransition>;
}
 ...
 * The state of a {@link ReliabilityAssetAlert}.
 *
 * @remarks this represents a made instance of ReliabilityAssetAlertState
 */
declare class ReliabilityAssetAlertState extends Obj  {
   ...
   */
  readonly id: string;
  withId(id: string): ReliabilityAssetAlertState;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityAssetAlertState;
  ...
  withName(name: string | null): ReliabilityAssetAlertState;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): ReliabilityAssetAlertState;
  ...
  withVersion(version: number | null): ReliabilityAssetAlertState;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): ReliabilityAssetAlertState;
  ...
  withUserUpdatedFields(userUpdatedFields: Array_Type<string> | Array<string> | null): ReliabilityAssetAlertState;
  ...
  withHidden(hidden: boolean): ReliabilityAssetAlertState;
  ...
  withUserOwned(userOwned: boolean): ReliabilityAssetAlertState;
  ...
  withDisplayName(displayName: string | null): ReliabilityAssetAlertState;
  ...
  withInitialState(initialState: boolean): ReliabilityAssetAlertState;

  /**
   * Used to soft delete a record so all state histories still have valid pointers.
   */
  readonly deleted?: boolean;
  withDeleted(deleted: boolean): ReliabilityAssetAlertState;

  /**
   * Used to include fields on the source type for exitAction and entryAction.
   */
  readonly includeSpec?: string;
  withIncludeSpec(includeSpec: string | null): ReliabilityAssetAlertState;

  /**
   * Action to be triggered when leaving this state.
   */
  readonly exitAction?: λConsumer<any | null>;
  withExitAction(exitAction: λConsumer<any | null> | null): ReliabilityAssetAlertState;

  /**
   * Action to be triggered when entering this state.
   */
  readonly entryAction?: λConsumer<any | null>;
  withEntryAction(entryAction: λConsumer<any | null> | null): ReliabilityAssetAlertState;

  /**
   * The list of automatic transitions from this state to another that are {@link StateMachineTransition#isValid}.
   */
  readonly autoTransitions?: Array_Type<ReliabilityAssetAlertStateTransition>;
  withAutoTransitions(autoTransitions: Array_Type<ReliabilityAssetAlertStateTransition> | Array<IReliabilityAssetAlertStateTransition> | null): ReliabilityAssetAlertState;

  /**
   * Whether this state has automatic transitions.
   */
  readonly hasAutoTransition?: boolean;
  withHasAutoTransition(hasAutoTransition: boolean): ReliabilityAssetAlertState;

  /**
   * The list of periodic transitions from this state to another that are {@link StateMachineTransition#isValid}.
   */
  readonly periodicTransitions?: Array_Type<ReliabilityAssetAlertStateTransition>;
  withPeriodicTransitions(periodicTransitions: Array_Type<ReliabilityAssetAlertStateTransition> | Array<IReliabilityAssetAlertStateTransition> | null): ReliabilityAssetAlertState;

  /**
   * Whether this state has periodic transitions.
   */
  readonly hasPeriodicTransitions?: boolean;
  withHasPeriodicTransitions(hasPeriodicTransitions: boolean): ReliabilityAssetAlertState;

  /**
   * {@link StateMachineTransition}s that originate from this {@link StateMachineState}.
   */
  readonly fromTransitions?: Array_Type<ReliabilityAssetAlertStateTransition>;
  withFromTransitions(fromTransitions: Array_Type<ReliabilityAssetAlertStateTransition> | Array<IReliabilityAssetAlertStateTransition> | null): ReliabilityAssetAlertState;

  /**
   * {@link StateMachineTransition}s that lead into this {@link StateMachineState}.
   */
  readonly toTransitions?: Array_Type<ReliabilityAssetAlertStateTransition>;
  withToTransitions(toTransitions: Array_Type<ReliabilityAssetAlertStateTransition> | Array<IReliabilityAssetAlertStateTransition> | null): ReliabilityAssetAlertState;
   ...
   * @see #toJson
   */
  static fromJson(json: any): ReliabilityAssetAlertState | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): ReliabilityAssetAlertState | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): ReliabilityAssetAlertState | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): ReliabilityAssetAlertState | null;
   ...
   */
  replaceType(old: Type, new_: Type): ReliabilityAssetAlertState;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityAssetAlertState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityAssetAlertState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityAssetAlertState>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityAssetAlertState>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityAssetAlertState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityAssetAlertState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityAssetAlertState;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ReliabilityAssetAlertState;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ReliabilityAssetAlertState;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityAssetAlertState;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityAssetAlertState;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityAssetAlertState;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ReliabilityAssetAlertState;
   ...
   * @see #removeField
   */
  withoutField(field: string): ReliabilityAssetAlertState;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): ReliabilityAssetAlertState;
   ...
   */
  withoutFields(fields: Array_Type<string>): ReliabilityAssetAlertState;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityAssetAlertState;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ReliabilityAssetAlertState;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityAssetAlertState;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ReliabilityAssetAlertState;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ReliabilityAssetAlertState;
   ...
   * @see #removeField
   */
  unsetField(field: string): ReliabilityAssetAlertState;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ReliabilityAssetAlertState;
   ...
   * @see #unsetField
   */
  removeField(field: string): ReliabilityAssetAlertState;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ReliabilityAssetAlertState;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityAssetAlertState;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityAssetAlertState;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityAssetAlertState;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityAssetAlertState;

  mergeJson(json: any): ReliabilityAssetAlertState;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityAssetAlertState;
   ...
   */
  sumObj(other: Obj, deep?: boolean): ReliabilityAssetAlertState;
   ...
   */
  singletonArray(): Array_Type<ReliabilityAssetAlertState>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityAssetAlertState> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ReliabilityAssetAlertState> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<ReliabilityAssetAlertState>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ReliabilityAssetAlertState> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, ReliabilityAssetAlertState> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityAssetAlertState> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ReliabilityAssetAlertState>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ReliabilityAssetAlertState>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityAssetAlertState;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityAssetAlertState;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityAssetAlertState;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ReliabilityAssetAlertState;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityAssetAlertState;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ReliabilityAssetAlertState;
   ...
   * @see #fromString
   */
  static make(s: string): ReliabilityAssetAlertState | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityAssetAlertState;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): ReliabilityAssetAlertState;
   ...
   */
  static cachedEmptyInst(): ReliabilityAssetAlertState;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityAssetAlertState> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): ReliabilityAssetAlertState;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<ReliabilityAssetAlertState> | null;
   ...
   */
  static find(filter?: string, doNotProduceAll?: boolean): Stream<ReliabilityAssetAlertState> | null;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<ReliabilityAssetAlertState> | null;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): ReliabilityAssetAlertState | null;
   ...
   * @see findByCacheKey
   */
  static forCacheKey(key: string): ReliabilityAssetAlertState | null;
   ...
   * @see findByCacheKey
   */
  getCached(): ReliabilityAssetAlertState | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): ReliabilityAssetAlertState | null;
   ...
   */
  static produce(key: string): ReliabilityAssetAlertState | null;
   ...
   */
  static produceAll(): Map_Type<string, ReliabilityAssetAlertState> | null;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): Map_Type<string, ReliabilityAssetAlertState> | null;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<ReliabilityAssetAlertState>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<ReliabilityAssetAlertState>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityAssetAlertState> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityAssetAlertState>> | null;
   ...
   */
  get(include?: string): ReliabilityAssetAlertState | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): ReliabilityAssetAlertState | null;
   ...
   */
  getMissing(spec: GetMissingSpec): ReliabilityAssetAlertState;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): ReliabilityAssetAlertState | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): ReliabilityAssetAlertState;
   ...
   * @see #toString
   */
  static fromString(s: string): ReliabilityAssetAlertState | null;
   ...
   */
  create(spec?: UpsertSpec): ReliabilityAssetAlertState | null;
   ...
   */
  static createBatch(objs: Array_Type<ReliabilityAssetAlertState>, spec?: UpsertSpec): ObjList<ReliabilityAssetAlertState> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<ReliabilityAssetAlertState>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityAssetAlertState> | null;
   ...
   */
  update(srcObj?: ReliabilityAssetAlertState, spec?: UpsertSpec): ReliabilityAssetAlertState | null;
   ...
   */
  upsert(srcObj?: ReliabilityAssetAlertState, spec?: UpsertSpec): ReliabilityAssetAlertState | null;
   ...
   */
  merge(spec?: MergeSpec): ReliabilityAssetAlertState | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): ReliabilityAssetAlertState | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): ReliabilityAssetAlertState | null;
   ...
   */
  static updateBatch(objs: Array_Type<ReliabilityAssetAlertState>, srcObjs?: Array_Type<ReliabilityAssetAlertState>, spec?: UpsertSpec): ObjList<ReliabilityAssetAlertState> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<ReliabilityAssetAlertState> | null>, spec?: UpsertSpec): ObjList<ReliabilityAssetAlertState> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<ReliabilityAssetAlertState>, srcObjs?: Array_Type<ReliabilityAssetAlertState>, spec?: UpsertSpec): ObjList<ReliabilityAssetAlertState> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<ReliabilityAssetAlertState> | null>, spec?: UpsertSpec): ObjList<ReliabilityAssetAlertState> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<ReliabilityAssetAlertState>, spec?: TouchSpec): ObjList<ReliabilityAssetAlertState> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityAssetAlertState>, spec?: MergeSpec): ObjList<ReliabilityAssetAlertState> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityAssetAlertState>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityAssetAlertState> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<ReliabilityAssetAlertState> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityAssetAlertState> | null;
   ...
   */
  static mergeAll(mergeObj: ReliabilityAssetAlertState, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: ReliabilityAssetAlertState, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<ReliabilityAssetAlertState>, spec?: UpsertSpec): ObjList<ReliabilityAssetAlertState> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<ReliabilityAssetAlertState>, spec?: UpsertSpec): ObjList<ReliabilityAssetAlertState> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): ReliabilityAssetAlertState | null;
   ...
   */
  static beforeCreate(objs: Array_Type<ReliabilityAssetAlertState>): ObjList<ReliabilityAssetAlertState>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<ReliabilityAssetAlertState>): ObjList<ReliabilityAssetAlertState>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<ReliabilityAssetAlertState>): ObjList<ReliabilityAssetAlertState>;
   ...
   */
  static afterCreate(objs: Array_Type<ReliabilityAssetAlertState>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<ReliabilityAssetAlertState>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<ReliabilityAssetAlertState>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityAssetAlertState>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityAssetAlertState>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): ReliabilityAssetAlertState | null;
   ...
   */
  withoutIdentity(): ReliabilityAssetAlertState | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<ReliabilityAssetAlertState>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: ReliabilityAssetAlertState, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<ReliabilityAssetAlertState>, callback?: λFunction<ReliabilityAssetAlertState | null, ReliabilityAssetAlertState | null>): ObjList<ReliabilityAssetAlertState>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<ReliabilityAssetAlertState>, callback?: λFunction<ReliabilityAssetAlertState | null, ReliabilityAssetAlertState | null>): Array_Type<ObjError> | null;
   ...
   */
  publish(subPath?: string, contentType?: string): ReliabilityAssetAlertState;
   ...
   */
  static removeSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<ReliabilityAssetAlertState> | null;
   ...
   */
  createSeedData(spec?: UpsertSpec): ReliabilityAssetAlertState | null;
   ...
   */
  static createSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<ReliabilityAssetAlertState> | null;
   ...
   */
  updateSeedData(srcObj?: SeedData, spec?: UpsertSpec): ReliabilityAssetAlertState | null;
   ...
   */
  static updateSeedDataBatch(objs?: Array_Type<SeedData>, srcObjs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<ReliabilityAssetAlertState> | null;
   ...
   * @return updated obj instance, same as {@link Persistable#update} return value.
   */
  clearUserUpdates(spec?: MergeSpec): ReliabilityAssetAlertState | null;
   ...
   *         {@link Persistable#updateBatch}.
   */
  static clearUserUpdatesBatch(objs?: Array_Type<SeedData>, spec?: MergeSpec): ObjList<ReliabilityAssetAlertState> | null;
  ...
  dependencies(): SeedDataDeps<ReliabilityAssetAlertState> | null;
