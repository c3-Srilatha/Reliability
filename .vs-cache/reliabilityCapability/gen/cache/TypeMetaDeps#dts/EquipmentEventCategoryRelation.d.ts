// TypeScript definitions for the C3 type EquipmentEventCategoryRelation

/**
 * Type which links a {@link ReliabilityAsset} to an {@link EventCategory}.
 *
 * @remarks this represents a value passed to a method that expects an instance of EquipmentEventCategoryRelation
 */
declare interface IEquipmentEventCategoryRelation {
  ...
  /**
   * The {@link ReliabilityAsset} to link from.
   */
 ...
 * Type which links a {@link ReliabilityAsset} to an {@link EventCategory}.
 *
 * @remarks this represents a made instance of EquipmentEventCategoryRelation
 */
declare class EquipmentEventCategoryRelation extends Obj  {
  ...
  withTypeIdent(typeIdent: string | null): EquipmentEventCategoryRelation;
   ...
   */
  readonly id: string;
  withId(id: string): EquipmentEventCategoryRelation;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): EquipmentEventCategoryRelation;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): EquipmentEventCategoryRelation;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): EquipmentEventCategoryRelation;
  ...
  withVersion(version: number | null): EquipmentEventCategoryRelation;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): EquipmentEventCategoryRelation;

  /**
   * The {@link ReliabilityAsset} to link from.
   */
  readonly from: ReliabilityAsset;
  withFrom(from: IReliabilityAsset): EquipmentEventCategoryRelation;

  /**
   * The {@link EventCategory} this relation connects to.
   */
  readonly to: EventCategory;
  withTo(to: IEventCategory): EquipmentEventCategoryRelation;

  /**
   * Display string for UI to represent this relation
   */
  readonly displayStr?: string;
  withDisplayStr(displayStr: string | null): EquipmentEventCategoryRelation;

  /**
   * The predictions associated with this relation
   */
  readonly predictions?: Array_Type<TimeToEventPrediction>;
  withPredictions(predictions: Array_Type<TimeToEventPrediction> | Array<ITimeToEventPrediction> | null): EquipmentEventCategoryRelation;

  /**
   * The latest prediction for this asset/event combination
   */
  readonly latestPrediction?: TimeToEventPrediction;
  withLatestPrediction(latestPrediction: ITimeToEventPrediction | null): EquipmentEventCategoryRelation;

  /**
   * How often a prediction is generated for this event-asset combination, in terms of number of hours
   */
  readonly predictionFrequency?: number;
  withPredictionFrequency(predictionFrequency: number | null): EquipmentEventCategoryRelation;

  /**
   * The last date where a prediction was generated for this event-asset combination
   */
  readonly lastPredictionDate?: DateTime;
  withLastPredictionDate(lastPredictionDate: DateTime | Date | string | null): EquipmentEventCategoryRelation;

  /**
   * All instances of {@link ProbabilisticForecastResult} associated with this relation
   */
  readonly probabilisticForecastResults?: Array_Type<ProbabilisticForecastResult>;
  withProbabilisticForecastResults(probabilisticForecastResults: Array_Type<ProbabilisticForecastResult> | Array<IProbabilisticForecastResult> | null): EquipmentEventCategoryRelation;
   ...
   * @see #toJson
   */
  static fromJson(json: any): EquipmentEventCategoryRelation | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): EquipmentEventCategoryRelation | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): EquipmentEventCategoryRelation | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): EquipmentEventCategoryRelation | null;
   ...
   */
  replaceType(old: Type, new_: Type): EquipmentEventCategoryRelation;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): EquipmentEventCategoryRelation;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): EquipmentEventCategoryRelation;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<EquipmentEventCategoryRelation>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<EquipmentEventCategoryRelation>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): EquipmentEventCategoryRelation;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): EquipmentEventCategoryRelation;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): EquipmentEventCategoryRelation;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): EquipmentEventCategoryRelation;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): EquipmentEventCategoryRelation;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): EquipmentEventCategoryRelation;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): EquipmentEventCategoryRelation;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): EquipmentEventCategoryRelation;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): EquipmentEventCategoryRelation;
   ...
   * @see #removeField
   */
  withoutField(field: string): EquipmentEventCategoryRelation;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): EquipmentEventCategoryRelation;
   ...
   */
  withoutFields(fields: Array_Type<string>): EquipmentEventCategoryRelation;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): EquipmentEventCategoryRelation;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): EquipmentEventCategoryRelation;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): EquipmentEventCategoryRelation;
   ...
   * @see #unsetField
   */
  defaultField(field: string): EquipmentEventCategoryRelation;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): EquipmentEventCategoryRelation;
   ...
   * @see #removeField
   */
  unsetField(field: string): EquipmentEventCategoryRelation;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): EquipmentEventCategoryRelation;
   ...
   * @see #unsetField
   */
  removeField(field: string): EquipmentEventCategoryRelation;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): EquipmentEventCategoryRelation;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): EquipmentEventCategoryRelation;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): EquipmentEventCategoryRelation;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): EquipmentEventCategoryRelation;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): EquipmentEventCategoryRelation;

  mergeJson(json: any): EquipmentEventCategoryRelation;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): EquipmentEventCategoryRelation;
   ...
   */
  sumObj(other: Obj, deep?: boolean): EquipmentEventCategoryRelation;
   ...
   */
  singletonArray(): Array_Type<EquipmentEventCategoryRelation>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<EquipmentEventCategoryRelation> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<EquipmentEventCategoryRelation> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<EquipmentEventCategoryRelation>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<EquipmentEventCategoryRelation> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, EquipmentEventCategoryRelation> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, EquipmentEventCategoryRelation> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<EquipmentEventCategoryRelation>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<EquipmentEventCategoryRelation>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): EquipmentEventCategoryRelation;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): EquipmentEventCategoryRelation;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): EquipmentEventCategoryRelation;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): EquipmentEventCategoryRelation;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): EquipmentEventCategoryRelation;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): EquipmentEventCategoryRelation;
   ...
   * @see #fromString
   */
  static make(s: string): EquipmentEventCategoryRelation | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): EquipmentEventCategoryRelation;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): EquipmentEventCategoryRelation;
   ...
   */
  static cachedEmptyInst(): EquipmentEventCategoryRelation;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<EquipmentEventCategoryRelation> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): EquipmentEventCategoryRelation;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<EquipmentEventCategoryRelation>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<EquipmentEventCategoryRelation>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<EquipmentEventCategoryRelation> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<EquipmentEventCategoryRelation>> | null;
   ...
   */
  static evalFeatureSetBatch(batch: Array_Type<EquipmentEventCategoryRelation>, featureSet: Feature.Set, spec?: EvalFeatureSpec): Data | null;
   ...
   * ```
   */
  static evalFeaturesBatch(batch: Array_Type<EquipmentEventCategoryRelation>, features: Array_Type<string>, spec?: EvalFeaturesSpec): Data | null;
   ...
   */
  get(include?: string): EquipmentEventCategoryRelation | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): EquipmentEventCategoryRelation | null;
   ...
   */
  getMissing(spec: GetMissingSpec): EquipmentEventCategoryRelation;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): EquipmentEventCategoryRelation | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): EquipmentEventCategoryRelation;
   ...
   * @see #toString
   */
  static fromString(s: string): EquipmentEventCategoryRelation | null;
   ...
   */
  create(spec?: UpsertSpec): EquipmentEventCategoryRelation | null;
   ...
   */
  static createBatch(objs: Array_Type<EquipmentEventCategoryRelation>, spec?: UpsertSpec): ObjList<EquipmentEventCategoryRelation> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<EquipmentEventCategoryRelation>, spec?: CreateBatchObjStreamSpec): ObjList<EquipmentEventCategoryRelation> | null;
   ...
   */
  update(srcObj?: EquipmentEventCategoryRelation, spec?: UpsertSpec): EquipmentEventCategoryRelation | null;
   ...
   */
  upsert(srcObj?: EquipmentEventCategoryRelation, spec?: UpsertSpec): EquipmentEventCategoryRelation | null;
   ...
   */
  merge(spec?: MergeSpec): EquipmentEventCategoryRelation | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): EquipmentEventCategoryRelation | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): EquipmentEventCategoryRelation | null;
   ...
   */
  static updateBatch(objs: Array_Type<EquipmentEventCategoryRelation>, srcObjs?: Array_Type<EquipmentEventCategoryRelation>, spec?: UpsertSpec): ObjList<EquipmentEventCategoryRelation> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<EquipmentEventCategoryRelation> | null>, spec?: UpsertSpec): ObjList<EquipmentEventCategoryRelation> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<EquipmentEventCategoryRelation>, srcObjs?: Array_Type<EquipmentEventCategoryRelation>, spec?: UpsertSpec): ObjList<EquipmentEventCategoryRelation> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<EquipmentEventCategoryRelation> | null>, spec?: UpsertSpec): ObjList<EquipmentEventCategoryRelation> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<EquipmentEventCategoryRelation>, spec?: TouchSpec): ObjList<EquipmentEventCategoryRelation> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<EquipmentEventCategoryRelation>, spec?: MergeSpec): ObjList<EquipmentEventCategoryRelation> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<EquipmentEventCategoryRelation>, mergeInclude: string, spec?: MergeSpec): ObjList<EquipmentEventCategoryRelation> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<EquipmentEventCategoryRelation> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<EquipmentEventCategoryRelation> | null;
   ...
   */
  static mergeAll(mergeObj: EquipmentEventCategoryRelation, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: EquipmentEventCategoryRelation, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<EquipmentEventCategoryRelation>, spec?: UpsertSpec): ObjList<EquipmentEventCategoryRelation> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<EquipmentEventCategoryRelation>, spec?: UpsertSpec): ObjList<EquipmentEventCategoryRelation> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): EquipmentEventCategoryRelation | null;
   ...
   */
  static beforeCreate(objs: Array_Type<EquipmentEventCategoryRelation>): ObjList<EquipmentEventCategoryRelation>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<EquipmentEventCategoryRelation>): ObjList<EquipmentEventCategoryRelation>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<EquipmentEventCategoryRelation>): ObjList<EquipmentEventCategoryRelation>;
   ...
   */
  static afterCreate(objs: Array_Type<EquipmentEventCategoryRelation>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<EquipmentEventCategoryRelation>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<EquipmentEventCategoryRelation>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<EquipmentEventCategoryRelation>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<EquipmentEventCategoryRelation>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): EquipmentEventCategoryRelation | null;
   ...
   */
  withoutIdentity(): EquipmentEventCategoryRelation | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<EquipmentEventCategoryRelation>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: EquipmentEventCategoryRelation, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<EquipmentEventCategoryRelation>, callback?: λFunction<EquipmentEventCategoryRelation | null, EquipmentEventCategoryRelation | null>): ObjList<EquipmentEventCategoryRelation>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<EquipmentEventCategoryRelation>, callback?: λFunction<EquipmentEventCategoryRelation | null, EquipmentEventCategoryRelation | null>): Array_Type<ObjError> | null;
