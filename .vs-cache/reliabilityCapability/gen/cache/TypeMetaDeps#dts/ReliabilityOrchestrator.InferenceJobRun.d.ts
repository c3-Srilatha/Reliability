// TypeScript definitions for the C3 type ReliabilityOrchestrator.InferenceJobRun
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityOrchestrator.InferenceJobRun
 */
declare namespace ReliabilityOrchestrator {
  export interface IInferenceJobRun {

    /**
     * The distributed job this run is an instance of.
     */
    job: IReliabilityOrchestrator.InferenceJob;

    /**
     * The array of configurations this job run must execute.
     */
    jobSpecs: Array_Type<ReliabilityOrchestrator.InferenceJobSpec> | Array<IReliabilityOrchestrator.InferenceJobSpec>;
 ...
 */
declare namespace ReliabilityOrchestrator {
  export class InferenceJobRun extends Obj  {

    /**
     * The distributed job this run is an instance of.
     */
    readonly job: ReliabilityOrchestrator.InferenceJob;
    withJob(job: IReliabilityOrchestrator.InferenceJob): ReliabilityOrchestrator.InferenceJobRun;

    /**
     * The array of configurations this job run must execute.
     */
    readonly jobSpecs: Array_Type<ReliabilityOrchestrator.InferenceJobSpec>;
    withJobSpecs(jobSpecs: Array_Type<ReliabilityOrchestrator.InferenceJobSpec> | Array<IReliabilityOrchestrator.InferenceJobSpec>): ReliabilityOrchestrator.InferenceJobRun;
    ...
    withMlOperationRun(mlOperationRun: IMlOperationRun<any> | null): ReliabilityOrchestrator.InferenceJobRun;

    /**
     * Options that were used to specify execution constraints for this training job run.
     */
    readonly options: ReliabilityOrchestrator.JobOptions;
    withOptions(options: IReliabilityOrchestrator.JobOptions): ReliabilityOrchestrator.InferenceJobRun;
    ...
    withTypeIdent(typeIdent: string | null): ReliabilityOrchestrator.InferenceJobRun;
     ...
     */
    readonly id: string;
    withId(id: string): ReliabilityOrchestrator.InferenceJobRun;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityOrchestrator.InferenceJobRun;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): ReliabilityOrchestrator.InferenceJobRun;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): ReliabilityOrchestrator.InferenceJobRun;
    ...
    withVersion(version: number | null): ReliabilityOrchestrator.InferenceJobRun;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): ReliabilityOrchestrator.InferenceJobRun;

    /**
     * {@link JobOptions} for executing this coordinator.
     */
    readonly jobOptions?: JobOptions;
    withJobOptions(jobOptions: IJobOptions | null): ReliabilityOrchestrator.InferenceJobRun;
     ...
     * @see #toJson
     */
    static fromJson(json: any): ReliabilityOrchestrator.InferenceJobRun | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): ReliabilityOrchestrator.InferenceJobRun | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): ReliabilityOrchestrator.InferenceJobRun | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): ReliabilityOrchestrator.InferenceJobRun | null;
     ...
     */
    replaceType(old: Type, new_: Type): ReliabilityOrchestrator.InferenceJobRun;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityOrchestrator.InferenceJobRun;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityOrchestrator.InferenceJobRun;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityOrchestrator.InferenceJobRun>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityOrchestrator.InferenceJobRun>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityOrchestrator.InferenceJobRun;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityOrchestrator.InferenceJobRun;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityOrchestrator.InferenceJobRun;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): ReliabilityOrchestrator.InferenceJobRun;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): ReliabilityOrchestrator.InferenceJobRun;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityOrchestrator.InferenceJobRun;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityOrchestrator.InferenceJobRun;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityOrchestrator.InferenceJobRun;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): ReliabilityOrchestrator.InferenceJobRun;
     ...
     * @see #removeField
     */
    withoutField(field: string): ReliabilityOrchestrator.InferenceJobRun;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): ReliabilityOrchestrator.InferenceJobRun;
     ...
     */
    withoutFields(fields: Array_Type<string>): ReliabilityOrchestrator.InferenceJobRun;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityOrchestrator.InferenceJobRun;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): ReliabilityOrchestrator.InferenceJobRun;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityOrchestrator.InferenceJobRun;
     ...
     * @see #unsetField
     */
    defaultField(field: string): ReliabilityOrchestrator.InferenceJobRun;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): ReliabilityOrchestrator.InferenceJobRun;
     ...
     * @see #removeField
     */
    unsetField(field: string): ReliabilityOrchestrator.InferenceJobRun;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): ReliabilityOrchestrator.InferenceJobRun;
     ...
     * @see #unsetField
     */
    removeField(field: string): ReliabilityOrchestrator.InferenceJobRun;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): ReliabilityOrchestrator.InferenceJobRun;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityOrchestrator.InferenceJobRun;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityOrchestrator.InferenceJobRun;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityOrchestrator.InferenceJobRun;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityOrchestrator.InferenceJobRun;

    mergeJson(json: any): ReliabilityOrchestrator.InferenceJobRun;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityOrchestrator.InferenceJobRun;
     ...
     */
    sumObj(other: Obj, deep?: boolean): ReliabilityOrchestrator.InferenceJobRun;
     ...
     */
    singletonArray(): Array_Type<ReliabilityOrchestrator.InferenceJobRun>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityOrchestrator.InferenceJobRun> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<ReliabilityOrchestrator.InferenceJobRun> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<ReliabilityOrchestrator.InferenceJobRun>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<ReliabilityOrchestrator.InferenceJobRun> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, ReliabilityOrchestrator.InferenceJobRun> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityOrchestrator.InferenceJobRun> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<ReliabilityOrchestrator.InferenceJobRun>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<ReliabilityOrchestrator.InferenceJobRun>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityOrchestrator.InferenceJobRun;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityOrchestrator.InferenceJobRun;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityOrchestrator.InferenceJobRun;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): ReliabilityOrchestrator.InferenceJobRun;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityOrchestrator.InferenceJobRun;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): ReliabilityOrchestrator.InferenceJobRun;
     ...
     * @see #fromString
     */
    static make(s: string): ReliabilityOrchestrator.InferenceJobRun | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityOrchestrator.InferenceJobRun;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): ReliabilityOrchestrator.InferenceJobRun;
     ...
     */
    static cachedEmptyInst(): ReliabilityOrchestrator.InferenceJobRun;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityOrchestrator.InferenceJobRun> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): ReliabilityOrchestrator.InferenceJobRun;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<ReliabilityOrchestrator.InferenceJobRun>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<ReliabilityOrchestrator.InferenceJobRun>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityOrchestrator.InferenceJobRun> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityOrchestrator.InferenceJobRun>> | null;
     ...
     */
    get(include?: string): ReliabilityOrchestrator.InferenceJobRun | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): ReliabilityOrchestrator.InferenceJobRun | null;
     ...
     */
    getMissing(spec: GetMissingSpec): ReliabilityOrchestrator.InferenceJobRun;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): ReliabilityOrchestrator.InferenceJobRun | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): ReliabilityOrchestrator.InferenceJobRun;
     ...
     * @see #toString
     */
    static fromString(s: string): ReliabilityOrchestrator.InferenceJobRun | null;
     ...
     */
    create(spec?: UpsertSpec): ReliabilityOrchestrator.InferenceJobRun | null;
     ...
     */
    static createBatch(objs: Array_Type<ReliabilityOrchestrator.InferenceJobRun>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.InferenceJobRun> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<ReliabilityOrchestrator.InferenceJobRun>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityOrchestrator.InferenceJobRun> | null;
     ...
     */
    update(srcObj?: ReliabilityOrchestrator.InferenceJobRun, spec?: UpsertSpec): ReliabilityOrchestrator.InferenceJobRun | null;
     ...
     */
    upsert(srcObj?: ReliabilityOrchestrator.InferenceJobRun, spec?: UpsertSpec): ReliabilityOrchestrator.InferenceJobRun | null;
     ...
     */
    merge(spec?: MergeSpec): ReliabilityOrchestrator.InferenceJobRun | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): ReliabilityOrchestrator.InferenceJobRun | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): ReliabilityOrchestrator.InferenceJobRun | null;
     ...
     */
    static updateBatch(objs: Array_Type<ReliabilityOrchestrator.InferenceJobRun>, srcObjs?: Array_Type<ReliabilityOrchestrator.InferenceJobRun>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.InferenceJobRun> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<ReliabilityOrchestrator.InferenceJobRun> | null>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.InferenceJobRun> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<ReliabilityOrchestrator.InferenceJobRun>, srcObjs?: Array_Type<ReliabilityOrchestrator.InferenceJobRun>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.InferenceJobRun> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<ReliabilityOrchestrator.InferenceJobRun> | null>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.InferenceJobRun> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<ReliabilityOrchestrator.InferenceJobRun>, spec?: TouchSpec): ObjList<ReliabilityOrchestrator.InferenceJobRun> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityOrchestrator.InferenceJobRun>, spec?: MergeSpec): ObjList<ReliabilityOrchestrator.InferenceJobRun> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityOrchestrator.InferenceJobRun>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityOrchestrator.InferenceJobRun> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<ReliabilityOrchestrator.InferenceJobRun> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityOrchestrator.InferenceJobRun> | null;
     ...
     */
    static mergeAll(mergeObj: ReliabilityOrchestrator.InferenceJobRun, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: ReliabilityOrchestrator.InferenceJobRun, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<ReliabilityOrchestrator.InferenceJobRun>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.InferenceJobRun> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<ReliabilityOrchestrator.InferenceJobRun>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.InferenceJobRun> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): ReliabilityOrchestrator.InferenceJobRun | null;
     ...
     */
    static beforeCreate(objs: Array_Type<ReliabilityOrchestrator.InferenceJobRun>): ObjList<ReliabilityOrchestrator.InferenceJobRun>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<ReliabilityOrchestrator.InferenceJobRun>): ObjList<ReliabilityOrchestrator.InferenceJobRun>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<ReliabilityOrchestrator.InferenceJobRun>): ObjList<ReliabilityOrchestrator.InferenceJobRun>;
     ...
     */
    static afterCreate(objs: Array_Type<ReliabilityOrchestrator.InferenceJobRun>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<ReliabilityOrchestrator.InferenceJobRun>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<ReliabilityOrchestrator.InferenceJobRun>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityOrchestrator.InferenceJobRun>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityOrchestrator.InferenceJobRun>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): ReliabilityOrchestrator.InferenceJobRun | null;
     ...
     */
    withoutIdentity(): ReliabilityOrchestrator.InferenceJobRun | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<ReliabilityOrchestrator.InferenceJobRun>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: ReliabilityOrchestrator.InferenceJobRun, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<ReliabilityOrchestrator.InferenceJobRun>, callback?: λFunction<ReliabilityOrchestrator.InferenceJobRun | null, ReliabilityOrchestrator.InferenceJobRun | null>): ObjList<ReliabilityOrchestrator.InferenceJobRun>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<ReliabilityOrchestrator.InferenceJobRun>, callback?: λFunction<ReliabilityOrchestrator.InferenceJobRun | null, ReliabilityOrchestrator.InferenceJobRun | null>): Array_Type<ObjError> | null;
     ...
     */
    generateNextResults(completed?: Stream<ReliabilityOrchestrator.InferenceJobResult>): number;
     ...
     */
    startResult(result: ReliabilityOrchestrator.InferenceJobResult): ReliabilityOrchestrator.InferenceJobResult;
     ...
     */
    afterStart(results: Stream<ReliabilityOrchestrator.InferenceJobResult>): Stream<ReliabilityOrchestrator.InferenceJobResult> | null;
     ...
     * @return the result instance, as acknowledgement, even if unmodified.
     */
    completeResult(result: ReliabilityOrchestrator.InferenceJobResult): ReliabilityOrchestrator.InferenceJobResult;
     ...
     */
    updateRunningResults(spec?: FetchStreamSpec): Stream<ReliabilityOrchestrator.InferenceJobResult> | null;
     ...
     */
    afterComplete(results: Stream<ReliabilityOrchestrator.InferenceJobResult>): Stream<ReliabilityOrchestrator.InferenceJobResult> | null;
     ...
     */
    runFromResult(result: ReliabilityOrchestrator.InferenceJobResult): WorkflowExecutorRun | null;
     ...
     *    Optional {@link FetchStreamSpec} for customizing fetching of RT objects.
     */
    pendingResults(spec?: FetchStreamSpec): Stream<ReliabilityOrchestrator.InferenceJobResult> | null;
     ...
     *    Optional {@link FetchStreamSpec} for customizing fetching of RT objects.
     */
    runningResults(spec?: FetchStreamSpec): Stream<ReliabilityOrchestrator.InferenceJobResult> | null;
     ...
     *    Optional {@link FetchStreamSpec} for customizing fetching of RT objects.
     */
    completedResults(spec?: FetchStreamSpec): Stream<ReliabilityOrchestrator.InferenceJobResult> | null;
     ...
     *    Optional {@link FetchStreamSpec} for customizing fetching of RT objects.
     */
    canceledResults(spec?: FetchStreamSpec): Stream<ReliabilityOrchestrator.InferenceJobResult> | null;
     ...
     *    Optional {@link FetchStreamSpec} for customizing fetching of RT objects.
     */
    erroredResults(spec?: FetchStreamSpec): Stream<ReliabilityOrchestrator.InferenceJobResult> | null;
     ...
     *    Optional {@link FetchStreamSpec} for customizing fetching of RT objects.
     */
    allResults(spec?: FetchStreamSpec): Stream<ReliabilityOrchestrator.InferenceJobResult> | null;
     ...
     */
    customSummaryFieldsForResult(result: ReliabilityOrchestrator.InferenceJobResult): Map_Type<string, any> | null;
     ...
     * @return a table with a row for each step and the corresponding execution metadata.
     */
    summaryForResults(results: Array_Type<ReliabilityOrchestrator.InferenceJobResult>, spec?: Workflow.Monitorable.SummarySpec): Data;
     ...
     * @return a table with a row for each step and the corresponding execution metadata.
     */
    summaryForResultsPd(results: Array_Type<ReliabilityOrchestrator.InferenceJobResult>, spec?: Workflow.Monitorable.SummarySpec): any | null;
     ...
     */
    resultsForSummary(spec?: FetchSpec): FetchResult<ReliabilityOrchestrator.InferenceJobResult> | null;
  }
}
