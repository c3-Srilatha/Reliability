// TypeScript definitions for the C3 type ReliabilityOrchestrator.RegisterModelsJobRun
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityOrchestrator.RegisterModelsJobRun
 */
declare namespace ReliabilityOrchestrator {
  export interface IRegisterModelsJobRun {
     ...
     */
    job: IReliabilityOrchestrator.RegisterModelsJob;
 ...
 */
declare namespace ReliabilityOrchestrator {
  export class RegisterModelsJobRun extends Obj  {
    ...
    withTypeIdent(typeIdent: string | null): ReliabilityOrchestrator.RegisterModelsJobRun;
     ...
     */
    readonly id: string;
    withId(id: string): ReliabilityOrchestrator.RegisterModelsJobRun;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityOrchestrator.RegisterModelsJobRun;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): ReliabilityOrchestrator.RegisterModelsJobRun;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): ReliabilityOrchestrator.RegisterModelsJobRun;
    ...
    withVersion(version: number | null): ReliabilityOrchestrator.RegisterModelsJobRun;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): ReliabilityOrchestrator.RegisterModelsJobRun;

    /**
     * {@link JobOptions} for executing this coordinator.
     */
    readonly jobOptions?: JobOptions;
    withJobOptions(jobOptions: IJobOptions | null): ReliabilityOrchestrator.RegisterModelsJobRun;

    /**
     * {@link ReliabilityOrchestrator.RegisterModelsJob} that this job run belongs to
     */
    readonly job: ReliabilityOrchestrator.RegisterModelsJob;
    withJob(job: IReliabilityOrchestrator.RegisterModelsJob): ReliabilityOrchestrator.RegisterModelsJobRun;

    /**
     * Specify the modelFilter for which models should be registered.
     */
    readonly modelFilter: string;
    withModelFilter(modelFilter: string): ReliabilityOrchestrator.RegisterModelsJobRun;

    /**
     * Spec that was used to specify execution constraints for this register models job run.
     */
    readonly options?: ReliabilityOrchestrator.JobOptions;
    withOptions(options: IReliabilityOrchestrator.JobOptions | null): ReliabilityOrchestrator.RegisterModelsJobRun;
     ...
     */
    readonly file?: File;
    withFile(file: IFile | null): ReliabilityOrchestrator.RegisterModelsJobRun;
     ...
     * @see #toJson
     */
    static fromJson(json: any): ReliabilityOrchestrator.RegisterModelsJobRun | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): ReliabilityOrchestrator.RegisterModelsJobRun | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): ReliabilityOrchestrator.RegisterModelsJobRun | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): ReliabilityOrchestrator.RegisterModelsJobRun | null;
     ...
     */
    replaceType(old: Type, new_: Type): ReliabilityOrchestrator.RegisterModelsJobRun;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityOrchestrator.RegisterModelsJobRun;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityOrchestrator.RegisterModelsJobRun;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityOrchestrator.RegisterModelsJobRun>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityOrchestrator.RegisterModelsJobRun>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityOrchestrator.RegisterModelsJobRun;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityOrchestrator.RegisterModelsJobRun;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityOrchestrator.RegisterModelsJobRun;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): ReliabilityOrchestrator.RegisterModelsJobRun;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): ReliabilityOrchestrator.RegisterModelsJobRun;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityOrchestrator.RegisterModelsJobRun;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityOrchestrator.RegisterModelsJobRun;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityOrchestrator.RegisterModelsJobRun;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): ReliabilityOrchestrator.RegisterModelsJobRun;
     ...
     * @see #removeField
     */
    withoutField(field: string): ReliabilityOrchestrator.RegisterModelsJobRun;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): ReliabilityOrchestrator.RegisterModelsJobRun;
     ...
     */
    withoutFields(fields: Array_Type<string>): ReliabilityOrchestrator.RegisterModelsJobRun;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityOrchestrator.RegisterModelsJobRun;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): ReliabilityOrchestrator.RegisterModelsJobRun;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityOrchestrator.RegisterModelsJobRun;
     ...
     * @see #unsetField
     */
    defaultField(field: string): ReliabilityOrchestrator.RegisterModelsJobRun;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): ReliabilityOrchestrator.RegisterModelsJobRun;
     ...
     * @see #removeField
     */
    unsetField(field: string): ReliabilityOrchestrator.RegisterModelsJobRun;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): ReliabilityOrchestrator.RegisterModelsJobRun;
     ...
     * @see #unsetField
     */
    removeField(field: string): ReliabilityOrchestrator.RegisterModelsJobRun;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): ReliabilityOrchestrator.RegisterModelsJobRun;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityOrchestrator.RegisterModelsJobRun;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityOrchestrator.RegisterModelsJobRun;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityOrchestrator.RegisterModelsJobRun;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityOrchestrator.RegisterModelsJobRun;

    mergeJson(json: any): ReliabilityOrchestrator.RegisterModelsJobRun;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityOrchestrator.RegisterModelsJobRun;
     ...
     */
    sumObj(other: Obj, deep?: boolean): ReliabilityOrchestrator.RegisterModelsJobRun;
     ...
     */
    singletonArray(): Array_Type<ReliabilityOrchestrator.RegisterModelsJobRun>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityOrchestrator.RegisterModelsJobRun> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<ReliabilityOrchestrator.RegisterModelsJobRun> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<ReliabilityOrchestrator.RegisterModelsJobRun>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<ReliabilityOrchestrator.RegisterModelsJobRun> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, ReliabilityOrchestrator.RegisterModelsJobRun> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityOrchestrator.RegisterModelsJobRun> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<ReliabilityOrchestrator.RegisterModelsJobRun>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<ReliabilityOrchestrator.RegisterModelsJobRun>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityOrchestrator.RegisterModelsJobRun;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityOrchestrator.RegisterModelsJobRun;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityOrchestrator.RegisterModelsJobRun;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): ReliabilityOrchestrator.RegisterModelsJobRun;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityOrchestrator.RegisterModelsJobRun;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): ReliabilityOrchestrator.RegisterModelsJobRun;
     ...
     * @see #fromString
     */
    static make(s: string): ReliabilityOrchestrator.RegisterModelsJobRun | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityOrchestrator.RegisterModelsJobRun;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): ReliabilityOrchestrator.RegisterModelsJobRun;
     ...
     */
    static cachedEmptyInst(): ReliabilityOrchestrator.RegisterModelsJobRun;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityOrchestrator.RegisterModelsJobRun> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): ReliabilityOrchestrator.RegisterModelsJobRun;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<ReliabilityOrchestrator.RegisterModelsJobRun>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<ReliabilityOrchestrator.RegisterModelsJobRun>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityOrchestrator.RegisterModelsJobRun> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityOrchestrator.RegisterModelsJobRun>> | null;
     ...
     */
    get(include?: string): ReliabilityOrchestrator.RegisterModelsJobRun | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): ReliabilityOrchestrator.RegisterModelsJobRun | null;
     ...
     */
    getMissing(spec: GetMissingSpec): ReliabilityOrchestrator.RegisterModelsJobRun;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): ReliabilityOrchestrator.RegisterModelsJobRun | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): ReliabilityOrchestrator.RegisterModelsJobRun;
     ...
     * @see #toString
     */
    static fromString(s: string): ReliabilityOrchestrator.RegisterModelsJobRun | null;
     ...
     */
    create(spec?: UpsertSpec): ReliabilityOrchestrator.RegisterModelsJobRun | null;
     ...
     */
    static createBatch(objs: Array_Type<ReliabilityOrchestrator.RegisterModelsJobRun>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.RegisterModelsJobRun> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<ReliabilityOrchestrator.RegisterModelsJobRun>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityOrchestrator.RegisterModelsJobRun> | null;
     ...
     */
    update(srcObj?: ReliabilityOrchestrator.RegisterModelsJobRun, spec?: UpsertSpec): ReliabilityOrchestrator.RegisterModelsJobRun | null;
     ...
     */
    upsert(srcObj?: ReliabilityOrchestrator.RegisterModelsJobRun, spec?: UpsertSpec): ReliabilityOrchestrator.RegisterModelsJobRun | null;
     ...
     */
    merge(spec?: MergeSpec): ReliabilityOrchestrator.RegisterModelsJobRun | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): ReliabilityOrchestrator.RegisterModelsJobRun | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): ReliabilityOrchestrator.RegisterModelsJobRun | null;
     ...
     */
    static updateBatch(objs: Array_Type<ReliabilityOrchestrator.RegisterModelsJobRun>, srcObjs?: Array_Type<ReliabilityOrchestrator.RegisterModelsJobRun>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.RegisterModelsJobRun> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<ReliabilityOrchestrator.RegisterModelsJobRun> | null>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.RegisterModelsJobRun> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<ReliabilityOrchestrator.RegisterModelsJobRun>, srcObjs?: Array_Type<ReliabilityOrchestrator.RegisterModelsJobRun>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.RegisterModelsJobRun> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<ReliabilityOrchestrator.RegisterModelsJobRun> | null>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.RegisterModelsJobRun> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<ReliabilityOrchestrator.RegisterModelsJobRun>, spec?: TouchSpec): ObjList<ReliabilityOrchestrator.RegisterModelsJobRun> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityOrchestrator.RegisterModelsJobRun>, spec?: MergeSpec): ObjList<ReliabilityOrchestrator.RegisterModelsJobRun> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityOrchestrator.RegisterModelsJobRun>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityOrchestrator.RegisterModelsJobRun> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<ReliabilityOrchestrator.RegisterModelsJobRun> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityOrchestrator.RegisterModelsJobRun> | null;
     ...
     */
    static mergeAll(mergeObj: ReliabilityOrchestrator.RegisterModelsJobRun, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: ReliabilityOrchestrator.RegisterModelsJobRun, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<ReliabilityOrchestrator.RegisterModelsJobRun>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.RegisterModelsJobRun> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<ReliabilityOrchestrator.RegisterModelsJobRun>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.RegisterModelsJobRun> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): ReliabilityOrchestrator.RegisterModelsJobRun | null;
     ...
     */
    static beforeCreate(objs: Array_Type<ReliabilityOrchestrator.RegisterModelsJobRun>): ObjList<ReliabilityOrchestrator.RegisterModelsJobRun>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<ReliabilityOrchestrator.RegisterModelsJobRun>): ObjList<ReliabilityOrchestrator.RegisterModelsJobRun>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<ReliabilityOrchestrator.RegisterModelsJobRun>): ObjList<ReliabilityOrchestrator.RegisterModelsJobRun>;
     ...
     */
    static afterCreate(objs: Array_Type<ReliabilityOrchestrator.RegisterModelsJobRun>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<ReliabilityOrchestrator.RegisterModelsJobRun>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<ReliabilityOrchestrator.RegisterModelsJobRun>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityOrchestrator.RegisterModelsJobRun>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityOrchestrator.RegisterModelsJobRun>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): ReliabilityOrchestrator.RegisterModelsJobRun | null;
     ...
     */
    withoutIdentity(): ReliabilityOrchestrator.RegisterModelsJobRun | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<ReliabilityOrchestrator.RegisterModelsJobRun>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: ReliabilityOrchestrator.RegisterModelsJobRun, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<ReliabilityOrchestrator.RegisterModelsJobRun>, callback?: λFunction<ReliabilityOrchestrator.RegisterModelsJobRun | null, ReliabilityOrchestrator.RegisterModelsJobRun | null>): ObjList<ReliabilityOrchestrator.RegisterModelsJobRun>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<ReliabilityOrchestrator.RegisterModelsJobRun>, callback?: λFunction<ReliabilityOrchestrator.RegisterModelsJobRun | null, ReliabilityOrchestrator.RegisterModelsJobRun | null>): Array_Type<ObjError> | null;
     ...
     */
    generateNextResults(completed?: Stream<ReliabilityOrchestrator.RegisterModelsJobResult>): number;
     ...
     */
    startResult(result: ReliabilityOrchestrator.RegisterModelsJobResult): ReliabilityOrchestrator.RegisterModelsJobResult;
     ...
     */
    afterStart(results: Stream<ReliabilityOrchestrator.RegisterModelsJobResult>): Stream<ReliabilityOrchestrator.RegisterModelsJobResult> | null;
     ...
     * @return the result instance, as acknowledgement, even if unmodified.
     */
    completeResult(result: ReliabilityOrchestrator.RegisterModelsJobResult): ReliabilityOrchestrator.RegisterModelsJobResult;
     ...
     */
    updateRunningResults(spec?: FetchStreamSpec): Stream<ReliabilityOrchestrator.RegisterModelsJobResult> | null;
     ...
     */
    afterComplete(results: Stream<ReliabilityOrchestrator.RegisterModelsJobResult>): Stream<ReliabilityOrchestrator.RegisterModelsJobResult> | null;
     ...
     */
    runFromResult(result: ReliabilityOrchestrator.RegisterModelsJobResult): WorkflowExecutorRun | null;
     ...
     *    Optional {@link FetchStreamSpec} for customizing fetching of RT objects.
     */
    pendingResults(spec?: FetchStreamSpec): Stream<ReliabilityOrchestrator.RegisterModelsJobResult> | null;
     ...
     *    Optional {@link FetchStreamSpec} for customizing fetching of RT objects.
     */
    runningResults(spec?: FetchStreamSpec): Stream<ReliabilityOrchestrator.RegisterModelsJobResult> | null;
     ...
     *    Optional {@link FetchStreamSpec} for customizing fetching of RT objects.
     */
    completedResults(spec?: FetchStreamSpec): Stream<ReliabilityOrchestrator.RegisterModelsJobResult> | null;
     ...
     *    Optional {@link FetchStreamSpec} for customizing fetching of RT objects.
     */
    canceledResults(spec?: FetchStreamSpec): Stream<ReliabilityOrchestrator.RegisterModelsJobResult> | null;
     ...
     *    Optional {@link FetchStreamSpec} for customizing fetching of RT objects.
     */
    erroredResults(spec?: FetchStreamSpec): Stream<ReliabilityOrchestrator.RegisterModelsJobResult> | null;
     ...
     *    Optional {@link FetchStreamSpec} for customizing fetching of RT objects.
     */
    allResults(spec?: FetchStreamSpec): Stream<ReliabilityOrchestrator.RegisterModelsJobResult> | null;
     ...
     */
    customSummaryFieldsForResult(result: ReliabilityOrchestrator.RegisterModelsJobResult): Map_Type<string, any> | null;
     ...
     * @return a table with a row for each step and the corresponding execution metadata.
     */
    summaryForResults(results: Array_Type<ReliabilityOrchestrator.RegisterModelsJobResult>, spec?: Workflow.Monitorable.SummarySpec): Data;
     ...
     * @return a table with a row for each step and the corresponding execution metadata.
     */
    summaryForResultsPd(results: Array_Type<ReliabilityOrchestrator.RegisterModelsJobResult>, spec?: Workflow.Monitorable.SummarySpec): any | null;
     ...
     */
    resultsForSummary(spec?: FetchSpec): FetchResult<ReliabilityOrchestrator.RegisterModelsJobResult> | null;

    /**
     * Returns a {@link File} that can be ported to the target environment, and used to load
     * {@link ReliabilityMlModel}s in the target environment.
     */
    getModelRegistryFile(): File;
  }
}
