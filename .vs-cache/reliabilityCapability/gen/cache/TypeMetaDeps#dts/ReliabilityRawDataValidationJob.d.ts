// TypeScript definitions for the C3 type ReliabilityRawDataValidationJob
 ...
 * ```
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityRawDataValidationJob
 */
declare interface IReliabilityRawDataValidationJob {
 ...
 */
declare class ReliabilityRawDataValidationJob extends Obj  {

  /**
   * current or last job execution for this instance
   */
  readonly run?: BatchJobRun;
  withRun(run: IBatchJobRun | null): ReliabilityRawDataValidationJob;

  /**
   * previous job executions for this instance
   */
  readonly runs?: Array_Type<BatchJobRun>;
  withRuns(runs: Array_Type<BatchJobRun> | Array<IBatchJobRun> | null): ReliabilityRawDataValidationJob;

  /**
   * FOR INTERNAL USE ONLY - Specify options in call to {@link start}.
   */
  readonly options?: Obj;
  withOptions(options: IObj | null): ReliabilityRawDataValidationJob;
  ...
  withOnCompleteCallback(onCompleteCallback: IJobBase.Callback | null): ReliabilityRawDataValidationJob;
  ...
  withPriority(priority: number | null): ReliabilityRawDataValidationJob;
  ...
  withDisabled(disabled: boolean): ReliabilityRawDataValidationJob;
  ...
  withMaxConcurrency(maxConcurrency: number | null): ReliabilityRawDataValidationJob;
  ...
  withMaxConcurrencyPerNode(maxConcurrencyPerNode: number | null): ReliabilityRawDataValidationJob;
  ...
  withRunAsUser(runAsUser: boolean): ReliabilityRawDataValidationJob;

  /**
   * Don't set this field in the BatchJob, set it in the BatchJobOptions when calling `start`
   */
  readonly nodePool?: string;
  withNodePool(nodePool: string | null): ReliabilityRawDataValidationJob;
  ...
  withSkipIfRunning(skipIfRunning: boolean): ReliabilityRawDataValidationJob;

  /**
   * Set to between 1 and 5 to enable auto recovery. See {@link invalidation-queues.c3doc Invalidation Queues} for detailed documentation.
   */
  readonly numAutoRecoveryAttempts?: number;
  withNumAutoRecoveryAttempts(numAutoRecoveryAttempts: number | null): ReliabilityRawDataValidationJob;
  ...
  withPropagateActionContext(propagateActionContext: boolean): ReliabilityRawDataValidationJob;
  ...
  withTypeIdent(typeIdent: string | null): ReliabilityRawDataValidationJob;
   ...
   */
  readonly id: string;
  withId(id: string): ReliabilityRawDataValidationJob;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityRawDataValidationJob;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): ReliabilityRawDataValidationJob;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): ReliabilityRawDataValidationJob;
  ...
  withVersion(version: number | null): ReliabilityRawDataValidationJob;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): ReliabilityRawDataValidationJob;
  ...
  withAbortOnError(abortOnError: boolean): ReliabilityRawDataValidationJob;
   ...
   * @see #toJson
   */
  static fromJson(json: any): ReliabilityRawDataValidationJob | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): ReliabilityRawDataValidationJob | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): ReliabilityRawDataValidationJob | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): ReliabilityRawDataValidationJob | null;
   ...
   */
  replaceType(old: Type, new_: Type): ReliabilityRawDataValidationJob;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityRawDataValidationJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityRawDataValidationJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityRawDataValidationJob>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityRawDataValidationJob>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityRawDataValidationJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityRawDataValidationJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityRawDataValidationJob;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ReliabilityRawDataValidationJob;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ReliabilityRawDataValidationJob;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityRawDataValidationJob;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityRawDataValidationJob;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityRawDataValidationJob;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ReliabilityRawDataValidationJob;
   ...
   * @see #removeField
   */
  withoutField(field: string): ReliabilityRawDataValidationJob;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): ReliabilityRawDataValidationJob;
   ...
   */
  withoutFields(fields: Array_Type<string>): ReliabilityRawDataValidationJob;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityRawDataValidationJob;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ReliabilityRawDataValidationJob;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityRawDataValidationJob;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ReliabilityRawDataValidationJob;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ReliabilityRawDataValidationJob;
   ...
   * @see #removeField
   */
  unsetField(field: string): ReliabilityRawDataValidationJob;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ReliabilityRawDataValidationJob;
   ...
   * @see #unsetField
   */
  removeField(field: string): ReliabilityRawDataValidationJob;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ReliabilityRawDataValidationJob;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityRawDataValidationJob;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityRawDataValidationJob;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityRawDataValidationJob;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityRawDataValidationJob;

  mergeJson(json: any): ReliabilityRawDataValidationJob;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityRawDataValidationJob;
   ...
   */
  sumObj(other: Obj, deep?: boolean): ReliabilityRawDataValidationJob;
   ...
   */
  singletonArray(): Array_Type<ReliabilityRawDataValidationJob>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityRawDataValidationJob> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ReliabilityRawDataValidationJob> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<ReliabilityRawDataValidationJob>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ReliabilityRawDataValidationJob> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, ReliabilityRawDataValidationJob> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityRawDataValidationJob> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ReliabilityRawDataValidationJob>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ReliabilityRawDataValidationJob>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityRawDataValidationJob;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityRawDataValidationJob;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityRawDataValidationJob;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ReliabilityRawDataValidationJob;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityRawDataValidationJob;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ReliabilityRawDataValidationJob;
   ...
   * @see #fromString
   */
  static make(s: string): ReliabilityRawDataValidationJob | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityRawDataValidationJob;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): ReliabilityRawDataValidationJob;
   ...
   */
  static cachedEmptyInst(): ReliabilityRawDataValidationJob;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityRawDataValidationJob> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): ReliabilityRawDataValidationJob;
   ...
   */
  start(options?: ReliabilityRawDataValidationJobOptions): BatchJobStatus | null;
   ...
   */
  cleanup(options?: ReliabilityRawDataValidationJobOptions): void;
  ...
  cancelJob(removeResults?: boolean, force?: boolean): JobBase<BatchJobRun, BatchJobStatus, ReliabilityRawDataValidationJobOptions> | null;

  failJob(run: JobRun<BatchJobStatusBase>): JobBase<BatchJobRun, BatchJobStatus, ReliabilityRawDataValidationJobOptions> | null;
  ...
  validateStart(options?: ReliabilityRawDataValidationJobOptions): void;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<ReliabilityRawDataValidationJob>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<ReliabilityRawDataValidationJob>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityRawDataValidationJob> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityRawDataValidationJob>> | null;
   ...
   */
  get(include?: string): ReliabilityRawDataValidationJob | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): ReliabilityRawDataValidationJob | null;
   ...
   */
  getMissing(spec: GetMissingSpec): ReliabilityRawDataValidationJob;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): ReliabilityRawDataValidationJob | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): ReliabilityRawDataValidationJob;
   ...
   * @see #toString
   */
  static fromString(s: string): ReliabilityRawDataValidationJob | null;
   ...
   */
  create(spec?: UpsertSpec): ReliabilityRawDataValidationJob | null;
   ...
   */
  static createBatch(objs: Array_Type<ReliabilityRawDataValidationJob>, spec?: UpsertSpec): ObjList<ReliabilityRawDataValidationJob> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<ReliabilityRawDataValidationJob>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityRawDataValidationJob> | null;
   ...
   */
  update(srcObj?: ReliabilityRawDataValidationJob, spec?: UpsertSpec): ReliabilityRawDataValidationJob | null;
   ...
   */
  upsert(srcObj?: ReliabilityRawDataValidationJob, spec?: UpsertSpec): ReliabilityRawDataValidationJob | null;
   ...
   */
  merge(spec?: MergeSpec): ReliabilityRawDataValidationJob | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): ReliabilityRawDataValidationJob | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): ReliabilityRawDataValidationJob | null;
   ...
   */
  static updateBatch(objs: Array_Type<ReliabilityRawDataValidationJob>, srcObjs?: Array_Type<ReliabilityRawDataValidationJob>, spec?: UpsertSpec): ObjList<ReliabilityRawDataValidationJob> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<ReliabilityRawDataValidationJob> | null>, spec?: UpsertSpec): ObjList<ReliabilityRawDataValidationJob> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<ReliabilityRawDataValidationJob>, srcObjs?: Array_Type<ReliabilityRawDataValidationJob>, spec?: UpsertSpec): ObjList<ReliabilityRawDataValidationJob> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<ReliabilityRawDataValidationJob> | null>, spec?: UpsertSpec): ObjList<ReliabilityRawDataValidationJob> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<ReliabilityRawDataValidationJob>, spec?: TouchSpec): ObjList<ReliabilityRawDataValidationJob> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityRawDataValidationJob>, spec?: MergeSpec): ObjList<ReliabilityRawDataValidationJob> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityRawDataValidationJob>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityRawDataValidationJob> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<ReliabilityRawDataValidationJob> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityRawDataValidationJob> | null;
   ...
   */
  static mergeAll(mergeObj: ReliabilityRawDataValidationJob, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: ReliabilityRawDataValidationJob, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<ReliabilityRawDataValidationJob>, spec?: UpsertSpec): ObjList<ReliabilityRawDataValidationJob> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<ReliabilityRawDataValidationJob>, spec?: UpsertSpec): ObjList<ReliabilityRawDataValidationJob> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): ReliabilityRawDataValidationJob | null;
   ...
   */
  static beforeCreate(objs: Array_Type<ReliabilityRawDataValidationJob>): ObjList<ReliabilityRawDataValidationJob>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<ReliabilityRawDataValidationJob>): ObjList<ReliabilityRawDataValidationJob>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<ReliabilityRawDataValidationJob>): ObjList<ReliabilityRawDataValidationJob>;
   ...
   */
  static afterCreate(objs: Array_Type<ReliabilityRawDataValidationJob>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<ReliabilityRawDataValidationJob>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<ReliabilityRawDataValidationJob>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityRawDataValidationJob>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityRawDataValidationJob>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): ReliabilityRawDataValidationJob | null;
   ...
   */
  withoutIdentity(): ReliabilityRawDataValidationJob | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<ReliabilityRawDataValidationJob>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: ReliabilityRawDataValidationJob, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<ReliabilityRawDataValidationJob>, callback?: λFunction<ReliabilityRawDataValidationJob | null, ReliabilityRawDataValidationJob | null>): ObjList<ReliabilityRawDataValidationJob>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<ReliabilityRawDataValidationJob>, callback?: λFunction<ReliabilityRawDataValidationJob | null, ReliabilityRawDataValidationJob | null>): Array_Type<ObjError> | null;
   ...
   */
  static doStart(job?: ReliabilityRawDataValidationJob, options?: ReliabilityRawDataValidationJobOptions): void;
   ...
   */
  static processBatch(batch?: ReliabilityRawDataValidationJobBatch, job?: ReliabilityRawDataValidationJob, options?: ReliabilityRawDataValidationJobOptions): void;
   ...
   */
  static allComplete(job: ReliabilityRawDataValidationJob, options?: ReliabilityRawDataValidationJobOptions): string | null;
   ...
   */
  static failed(job: ReliabilityRawDataValidationJob, status: BatchJobStatus, options?: ReliabilityRawDataValidationJobOptions): void;
   ...
   *        Batch to schedule.
   */
  scheduleBatch(batch?: ReliabilityRawDataValidationJobBatch): void;
   ...
   *        Batches to schedule.
   */
  scheduleBatches(batches?: Array_Type<ReliabilityRawDataValidationJobBatch>): void;
   ...
   */
  static scheduleObjBatch(job?: ReliabilityRawDataValidationJob, objBatch?: ObjBatch, logPrefix?: string): number | null;
