// TypeScript definitions for the C3 type ReliabilityAssetCase

/**
 * Remixed to support logic for criticality:
 * - added db order annotation to the alertRelations field
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityAssetCase
 */
declare interface IReliabilityAssetCase {
   ...
   */
  currentState?: ICaseState;

  /**
   * A collection of the states this {@link StateMachine} has passed through.
   */
  stateHistories?: Array_Type<CaseStateHistory> | Array<ICaseStateHistory>;

  /**
   * Transitions available from the current state
   */
  transitions?: Array_Type<CaseStateTransition> | Array<ICaseStateTransition>;

  /**
   * Calc field to get the current state history
   */
  currentStateHistory?: ICaseStateHistory;
  ...
  /**
   * All the {@link ReliabilityAssetAlertToCaseRelation}s related to this case, sorted by importance using the {@link ReliabilityAssetImportance#importanceLevel}.
   */
  alertRelations?: Array_Type<ReliabilityAssetAlertToCaseRelation> | Array<IReliabilityAssetAlertToCaseRelation>;
   ...
   */
  alertAssets?: Array_Type<ReliabilityAsset> | Array<IReliabilityAsset>;

  /**
   * All associated {@link ReliabilityAsset}s associated with this ReliabilityAssetCase.
   */
  allAssets?: Array_Type<ReliabilityAsset> | Array<IReliabilityAsset>;
   ...
   */
  priorityHistory?: Array_Type<CasePriorityHistory> | Array<ICasePriorityHistory>;

  /**
   * The user assigned to this ReliabilityAssetCase.
   */
  assignee?: IReliabilityAssigneeTimedValue;
   ...
   */
  comments?: Array_Type<CaseComment> | Array<ICaseComment>;
   ...
   */
  assigneeHistory?: Array_Type<CaseAssigneeHistory> | Array<ICaseAssigneeHistory>;
   ...
   */
  latestCommentCreationTime?: DateTime | Date | string;

  /**
   * Timestamp of the latest state change for this case.
   */
  latestStateCreationTime?: DateTime | Date | string;
   ...
   */
  latestActivityTime?: DateTime | Date | string;
   ...
   */
  latestActivityDisplayName?: string;
 ...
 * - added db order annotation to the alertRelations field
 *
 * @remarks this represents a made instance of ReliabilityAssetCase
 */
declare class ReliabilityAssetCase extends Obj  {
   ...
   */
  readonly id: string;
  withId(id: string): ReliabilityAssetCase;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityAssetCase;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): ReliabilityAssetCase;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): ReliabilityAssetCase;
  ...
  withVersion(version: number | null): ReliabilityAssetCase;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): ReliabilityAssetCase;

  /**
   * A stored calc field representing the current state - uses a {@link StateMachineHistory} to keep track.
   */
  readonly currentState?: CaseState;
  withCurrentState(currentState: ICaseState | null): ReliabilityAssetCase;

  /**
   * A collection of the states this {@link StateMachine} has passed through.
   */
  readonly stateHistories?: Array_Type<CaseStateHistory>;
  withStateHistories(stateHistories: Array_Type<CaseStateHistory> | Array<ICaseStateHistory> | null): ReliabilityAssetCase;

  /**
   * Transitions available from the current state
   */
  readonly transitions?: Array_Type<CaseStateTransition>;
  withTransitions(transitions: Array_Type<CaseStateTransition> | Array<ICaseStateTransition> | null): ReliabilityAssetCase;

  /**
   * Calc field to get the current state history
   */
  readonly currentStateHistory?: CaseStateHistory;
  withCurrentStateHistory(currentStateHistory: ICaseStateHistory | null): ReliabilityAssetCase;

  /**
   * @inheritdoc
   */
  readonly facilityFilterPaths?: Array_Type<string>;
  withFacilityFilterPaths(facilityFilterPaths: Array_Type<string> | Array<string> | null): ReliabilityAssetCase;
  ...
  withTypeIdent(typeIdent: string | null): ReliabilityAssetCase;

  /**
   * All the {@link ReliabilityAssetAlertToCaseRelation}s related to this case, sorted by importance using the {@link ReliabilityAssetImportance#importanceLevel}.
   */
  readonly alertRelations?: Array_Type<ReliabilityAssetAlertToCaseRelation>;
  withAlertRelations(alertRelations: Array_Type<ReliabilityAssetAlertToCaseRelation> | Array<IReliabilityAssetAlertToCaseRelation> | null): ReliabilityAssetCase;
  ...
  withAlerts(alerts: Array_Type<ReliabilityAssetAlert> | Array<IReliabilityAssetAlert> | null): ReliabilityAssetCase;

  /**
   * Reference to the most critical {@link ReliabilityAssetAlert} linked to this case.
   * This is the first alert in the sorted alert list.
   */
  readonly firstAlert?: ReliabilityAssetAlert;
  withFirstAlert(firstAlert: IReliabilityAssetAlert | null): ReliabilityAssetCase;

  /**
   * The estimated cost in dollars ($) of unplanned downtime due to this {@link ReliabilityAssetCase}.
   */
  readonly estimatedCostOfUnplannedDowntime?: number;
  withEstimatedCostOfUnplannedDowntime(estimatedCostOfUnplannedDowntime: number | null): ReliabilityAssetCase;

  /**
   * The estimated cost in dollars ($) of unplanned maintenance for this {@link ReliabilityAssetCase}.
   */
  readonly estimatedCostOfUnplannedMaintenance?: number;
  withEstimatedCostOfUnplannedMaintenance(estimatedCostOfUnplannedMaintenance: number | null): ReliabilityAssetCase;

  /**
   * A description of the case. Readiness sets this based on alert failure mode and {@link ReliabilityAsset#functionalLocation}
   */
  readonly description?: string;
  withDescription(description: string | null): ReliabilityAssetCase;

  /**
   * Total number of alerts associated with this case.
   * Currently, only one alert is allowed per case.
   */
  readonly numTotalAlerts?: number;
  withNumTotalAlerts(numTotalAlerts: number | null): ReliabilityAssetCase;

  /**
   * Total number of assets directly linked to alerts in the case.
   */
  readonly numTotalAssets?: number;
  withNumTotalAssets(numTotalAssets: number | null): ReliabilityAssetCase;

  /**
   * Total number of feedbacks associated with the failure modes in the case.
   */
  readonly numFeedbacks?: number;
  withNumFeedbacks(numFeedbacks: number | null): ReliabilityAssetCase;

  /**
   * The number of work orders created for this ReliabilityAssetCase.
   */
  readonly numWorkOrders?: number;
  withNumWorkOrders(numWorkOrders: number | null): ReliabilityAssetCase;

  /**
   * The number of open work orders for this ReliabilityAssetCase that are not 'CLOSED'.
   */
  readonly numOpenWorkOrders?: number;
  withNumOpenWorkOrders(numOpenWorkOrders: number | null): ReliabilityAssetCase;

  /**
   * All the {@link ReliabilityAssetCaseToAssetRelation}s related to this case.
   * These relations link assets to the case.
   */
  readonly assetRelations?: Array_Type<ReliabilityAssetCaseToAssetRelation>;
  withAssetRelations(assetRelations: Array_Type<ReliabilityAssetCaseToAssetRelation> | Array<IReliabilityAssetCaseToAssetRelation> | null): ReliabilityAssetCase;

  /**
   * All directly linked {@link ReliabilityAsset}s associated with this ReliabilityAssetCase
   */
  readonly directAssets?: Array_Type<ReliabilityAsset>;
  withDirectAssets(directAssets: Array_Type<ReliabilityAsset> | Array<IReliabilityAsset> | null): ReliabilityAssetCase;

  /**
   * All {@link ReliabilityAsset}s associated with this ReliabilityAssetCase as calculated from
   * this case's {@link ReliabilityAssetCase#alerts alerts}.
   */
  readonly alertAssets?: Array_Type<ReliabilityAsset>;
  withAlertAssets(alertAssets: Array_Type<ReliabilityAsset> | Array<IReliabilityAsset> | null): ReliabilityAssetCase;

  /**
   * All associated {@link ReliabilityAsset}s associated with this ReliabilityAssetCase.
   */
  readonly allAssets?: Array_Type<ReliabilityAsset>;
  withAllAssets(allAssets: Array_Type<ReliabilityAsset> | Array<IReliabilityAsset> | null): ReliabilityAssetCase;

  /**
   * Subheader displaying case priority and its current state.
   */
  readonly subHeaderText?: string;
  withSubHeaderText(subHeaderText: string | null): ReliabilityAssetCase;

  /**
   * List of users who have commented or are tagged in a comment on this case.
   */
  readonly collaborators?: Array_Type<string>;
  withCollaborators(collaborators: Array_Type<string> | Array<string> | null): ReliabilityAssetCase;

  /**
   * All related work orders for the current case.
   */
  readonly workOrders?: Array_Type<WorkOrder>;
  withWorkOrders(workOrders: Array_Type<WorkOrder> | Array<IWorkOrder> | null): ReliabilityAssetCase;

  /**
   * The priority assigned to the current case.
   * The priority value represents the case's criticality level.
   */
  readonly priority?: ReliabilityPriorityTimedValue;
  withPriority(priority: IReliabilityPriorityTimedValue | null): ReliabilityAssetCase;

  /**
   * The string value representing the priority of the case (P0, P1, P2).
   */
  readonly priorityValue?: string;
  withPriorityValue(priorityValue: string | null): ReliabilityAssetCase;

  /**
   * Timed history of priority changes for the case.
   * The history is ordered by timestamp in descending order.
   */
  readonly priorityHistory?: Array_Type<CasePriorityHistory>;
  withPriorityHistory(priorityHistory: Array_Type<CasePriorityHistory> | Array<ICasePriorityHistory> | null): ReliabilityAssetCase;

  /**
   * The user assigned to this ReliabilityAssetCase.
   */
  readonly assignee?: ReliabilityAssigneeTimedValue;
  withAssignee(assignee: IReliabilityAssigneeTimedValue | null): ReliabilityAssetCase;

  /**
   * The full name or email of the user assigned to the case for UI display.
   */
  readonly assigneeName?: string;
  withAssigneeName(assigneeName: string | null): ReliabilityAssetCase;

  /**
   * List of comments associated with the current case.
   * Comments are sorted by the most recently updated first.
   */
  readonly comments?: Array_Type<CaseComment>;
  withComments(comments: Array_Type<CaseComment> | Array<ICaseComment> | null): ReliabilityAssetCase;

  /**
   * Latest comment associated with the current case
   */
  readonly latestComment?: string;
  withLatestComment(latestComment: string | null): ReliabilityAssetCase;

  /**
   * History of user assignments to the case.
   * This allows tracking the change in case ownership over time.
   */
  readonly assigneeHistory?: Array_Type<CaseAssigneeHistory>;
  withAssigneeHistory(assigneeHistory: Array_Type<CaseAssigneeHistory> | Array<ICaseAssigneeHistory> | null): ReliabilityAssetCase;

  /**
   * The top 3 feature contributors for the case based on alerts.
   * Returns a string with names of the top 3 contributors.
   */
  readonly topContributors?: string;
  withTopContributors(topContributors: string | null): ReliabilityAssetCase;

  /**
   * The timestamp of the latest comment added to the case.
   * Used to track recent activity.
   */
  readonly latestCommentCreationTime?: DateTime;
  withLatestCommentCreationTime(latestCommentCreationTime: DateTime | Date | string | null): ReliabilityAssetCase;

  /**
   * Timestamp of the latest state change for this case.
   */
  readonly latestStateCreationTime?: DateTime;
  withLatestStateCreationTime(latestStateCreationTime: DateTime | Date | string | null): ReliabilityAssetCase;

  /**
   * The timestamp for the most recent activity on this case.
   * This combines the latest comment, state, priority, and assignee updates.
   */
  readonly latestActivityTime?: DateTime;
  withLatestActivityTime(latestActivityTime: DateTime | Date | string | null): ReliabilityAssetCase;
  ...
  withLatestActivity(latestActivity: string | null): ReliabilityAssetCase;

  /**
   * Translates the {@link latestActivity} to a user-friendly format.
   */
  readonly latestActivityDisplayName?: string;
  withLatestActivityDisplayName(latestActivityDisplayName: string | null): ReliabilityAssetCase;

  /**
   * The {@link Facility} associated with this {@link ReliabilityAssetCase}.
   */
  readonly facility?: Facility;
  withFacility(facility: IFacility | null): ReliabilityAssetCase;
   ...
   * @see #toJson
   */
  static fromJson(json: any): ReliabilityAssetCase | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): ReliabilityAssetCase | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): ReliabilityAssetCase | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): ReliabilityAssetCase | null;
   ...
   */
  replaceType(old: Type, new_: Type): ReliabilityAssetCase;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityAssetCase;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityAssetCase;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityAssetCase>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityAssetCase>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityAssetCase;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityAssetCase;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityAssetCase;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ReliabilityAssetCase;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ReliabilityAssetCase;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityAssetCase;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityAssetCase;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityAssetCase;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ReliabilityAssetCase;
   ...
   * @see #removeField
   */
  withoutField(field: string): ReliabilityAssetCase;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): ReliabilityAssetCase;
   ...
   */
  withoutFields(fields: Array_Type<string>): ReliabilityAssetCase;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityAssetCase;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ReliabilityAssetCase;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityAssetCase;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ReliabilityAssetCase;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ReliabilityAssetCase;
   ...
   * @see #removeField
   */
  unsetField(field: string): ReliabilityAssetCase;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ReliabilityAssetCase;
   ...
   * @see #unsetField
   */
  removeField(field: string): ReliabilityAssetCase;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ReliabilityAssetCase;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityAssetCase;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityAssetCase;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityAssetCase;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityAssetCase;

  mergeJson(json: any): ReliabilityAssetCase;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityAssetCase;
   ...
   */
  sumObj(other: Obj, deep?: boolean): ReliabilityAssetCase;
   ...
   */
  singletonArray(): Array_Type<ReliabilityAssetCase>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityAssetCase> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ReliabilityAssetCase> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<ReliabilityAssetCase>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ReliabilityAssetCase> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, ReliabilityAssetCase> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityAssetCase> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ReliabilityAssetCase>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ReliabilityAssetCase>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityAssetCase;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityAssetCase;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityAssetCase;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ReliabilityAssetCase;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityAssetCase;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ReliabilityAssetCase;
   ...
   * @see #fromString
   */
  static make(s: string): ReliabilityAssetCase | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityAssetCase;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): ReliabilityAssetCase;
   ...
   */
  static cachedEmptyInst(): ReliabilityAssetCase;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityAssetCase> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): ReliabilityAssetCase;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<ReliabilityAssetCase>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<ReliabilityAssetCase>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityAssetCase> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityAssetCase>> | null;
   ...
   */
  get(include?: string): ReliabilityAssetCase | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): ReliabilityAssetCase | null;
   ...
   */
  getMissing(spec: GetMissingSpec): ReliabilityAssetCase;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): ReliabilityAssetCase | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): ReliabilityAssetCase;
   ...
   * @see #toString
   */
  static fromString(s: string): ReliabilityAssetCase | null;
   ...
   */
  create(spec?: UpsertSpec): ReliabilityAssetCase | null;
   ...
   */
  static createBatch(objs: Array_Type<ReliabilityAssetCase>, spec?: UpsertSpec): ObjList<ReliabilityAssetCase> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<ReliabilityAssetCase>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityAssetCase> | null;
   ...
   */
  update(srcObj?: ReliabilityAssetCase, spec?: UpsertSpec): ReliabilityAssetCase | null;
   ...
   */
  upsert(srcObj?: ReliabilityAssetCase, spec?: UpsertSpec): ReliabilityAssetCase | null;
   ...
   */
  merge(spec?: MergeSpec): ReliabilityAssetCase | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): ReliabilityAssetCase | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): ReliabilityAssetCase | null;
   ...
   */
  static updateBatch(objs: Array_Type<ReliabilityAssetCase>, srcObjs?: Array_Type<ReliabilityAssetCase>, spec?: UpsertSpec): ObjList<ReliabilityAssetCase> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<ReliabilityAssetCase> | null>, spec?: UpsertSpec): ObjList<ReliabilityAssetCase> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<ReliabilityAssetCase>, srcObjs?: Array_Type<ReliabilityAssetCase>, spec?: UpsertSpec): ObjList<ReliabilityAssetCase> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<ReliabilityAssetCase> | null>, spec?: UpsertSpec): ObjList<ReliabilityAssetCase> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<ReliabilityAssetCase>, spec?: TouchSpec): ObjList<ReliabilityAssetCase> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityAssetCase>, spec?: MergeSpec): ObjList<ReliabilityAssetCase> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityAssetCase>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityAssetCase> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<ReliabilityAssetCase> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityAssetCase> | null;
   ...
   */
  static mergeAll(mergeObj: ReliabilityAssetCase, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: ReliabilityAssetCase, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<ReliabilityAssetCase>, spec?: UpsertSpec): ObjList<ReliabilityAssetCase> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<ReliabilityAssetCase>, spec?: UpsertSpec): ObjList<ReliabilityAssetCase> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): ReliabilityAssetCase | null;
   ...
   */
  static beforeCreate(objs: Array_Type<ReliabilityAssetCase>): ObjList<ReliabilityAssetCase>;
   ...
   */
  static beforeUpdate(objs: Array_Type<ReliabilityAssetCase>): ObjList<ReliabilityAssetCase>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<ReliabilityAssetCase>): ObjList<ReliabilityAssetCase>;

  /**
   * See {@link PersistableWritable#afterCreate}
   */
  static afterCreate(objs: Array_Type<ReliabilityAssetCase>): Array_Type<ObjError> | null;
   ...
   */
  static afterUpdate(objs: Array_Type<ReliabilityAssetCase>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<ReliabilityAssetCase>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityAssetCase>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityAssetCase>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): ReliabilityAssetCase | null;
   ...
   */
  withoutIdentity(): ReliabilityAssetCase | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<ReliabilityAssetCase>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: ReliabilityAssetCase, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<ReliabilityAssetCase>, callback?: λFunction<ReliabilityAssetCase | null, ReliabilityAssetCase | null>): ObjList<ReliabilityAssetCase>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<ReliabilityAssetCase>, callback?: λFunction<ReliabilityAssetCase | null, ReliabilityAssetCase | null>): Array_Type<ObjError> | null;
   ...
   */
  static transitionBatch(stateMachines: Array_Type<ReliabilityAssetCase>, toState: CaseState, retry?: number, stateHistoryParams?: CaseStateHistory): Array_Type<StateMachineTransitionStatus<CaseStateHistory, CaseStateTransition>>;
   ...
   */
  transition(toState: CaseState, testOnly?: boolean, stateHistoryParams?: CaseStateHistory): StateMachineTransitionStatus<CaseStateHistory, CaseStateTransition>;
   ...
   */
  checkTransition(toState: CaseState): boolean;
   ...
   */
  static allTransitions(fromState?: CaseState, toState?: CaseState): Array_Type<CaseStateTransition> | null;
   ...
   */
  forceTransition(toState: CaseState, stateHistoryParams?: CaseStateHistory): boolean;
   ...
   */
  static forceTransitionBatch(stateMachines: Array_Type<ReliabilityAssetCase>, toState: CaseState, stateHistoryParams?: CaseStateHistory): Map_Type<string, boolean>;
   ...
   */
  static stateRecoverBatch(stateMachines: Array_Type<ReliabilityAssetCase>): Map_Type<string, boolean>;

  /**
   * Transition with a valid transition in the transitions array
   */
  transitionWithTransitions(transitions?: Array_Type<CaseStateTransition>, testOnly?: boolean, stateHistoryParams?: CaseStateHistory): StateMachineTransitionStatus<CaseStateHistory, CaseStateTransition>;
   ...
   */
  static doBeforeCreate(objs: Array_Type<ReliabilityAssetCase>): ObjList<ReliabilityAssetCase> | null;
   ...
   */
  static doAfterUpdate(objs: Array_Type<ReliabilityAssetCase>): Array_Type<ObjError> | null;
   ...
   */
  static doAfterCreate(objs: Array_Type<ReliabilityAssetCase>): ObjList<ReliabilityAssetCase> | null;
   ...
   */
  executeTransition(transition: CaseStateTransition, stateOrderCounter: number, stateHistoryParams?: CaseStateHistory): CaseStateHistory;
   ...
   */
  findTransitions(allTransitions: Array_Type<CaseStateTransition>): Array_Type<CaseStateTransition> | null;

  /**
   * Internal use only.
   * Implements a statemachine db lock.
   */
  reserveStateOrderCounter(): StateMachineTransitionStatus<CaseStateHistory, CaseStateTransition>;

  /**
   * Internal use only.
   * Verify whether the state machine is in error state.
   */
  checkStateMachine(): StateMachineTransitionStatus<CaseStateHistory, CaseStateTransition>;
   ...
   */
  transitionAndRefreshCurrentState(toState: CaseState, stateHistoryParams?: CaseStateHistory): StateMachineTransitionStatus<CaseStateHistory, CaseStateTransition>;

  /**
   * Used from the UI to batch transition and refresh currentState stored calc.
   */
  static transitionBatchAndRefreshCurrentState(stateMachines: Array_Type<ReliabilityAssetCase>, toState: CaseState, retry?: number, stateHistoryParams?: CaseStateHistory): Array_Type<StateMachineTransitionStatus<CaseStateHistory, CaseStateTransition>>;
   ...
   */
  static evalFeatureSetBatch(batch: Array_Type<ReliabilityAssetCase>, featureSet: Feature.Set, spec?: EvalFeatureSpec): Data | null;
   ...
   * ```
   */
  static evalFeaturesBatch(batch: Array_Type<ReliabilityAssetCase>, features: Array_Type<string>, spec?: EvalFeaturesSpec): Data | null;
   ...
   */
  static createCaseOnFormSubmit(formObject: OpenCaseSpec): ReliabilityAssetCase | null;

  /**
   * Sends notifications to the assignees of work orders related to this case.
   */
  static sendWorkOrderNotification(srcObj?: any): void;

  /**
   * Method invoked after submitting the "AddCommentForm" from the case detail page.
   * This function creates a comment on the case.
   */
  static createCommentOnFormSubmit(formObject: AddCommentSpec): CaseComment;
   ...
   */
  static createCommentWithMultipleFileOnFormSubmit(formObject: AddCommentSpec): CaseComment;
   ...
   */
  static replaceCurrentUserPlaceholder(filter?: string): string | null;
   ...
   */
  static fetchForCurrentUser(spec?: FetchSpec): FetchResult<ReliabilityAssetCase>;
   ...
   */
  static fetchCountForCurrentUser(spec?: FetchFilterSpec): number;
   ...
   */
  closedToOpenTransitionAction(): void;
   ...
   */
  addAlertsToCase(alerts: Array_Type<ReliabilityAssetAlert>): void;

  /**
   * Closing the case and add details to a {@link CaseStateHistory} history state.
   */
  closeWithDetails(spec: CloseWithDetailsSpec): void;

  /**
   * Helper function for {@link fetchFailureModeRelations} and {@link fetchFailureRecommendationRelations}.
   */
  doFetchFailureModeRelations(spec: FetchSpec, baseType: Type, alertType: Type): FetchResult<FailureModeRelation | FailureRecommendationRelation>;

  /**
   * Helper function for count {@link fetchFailureModeRelations} and {@link fetchFailureRecommendationRelations}.
   */
  doFetchCountFailureModeRelations(spec: FetchSpec, alertType: Type): number;

  /**
   * This method fetches the {@link ReliabilityAssetAlertSimilarity#comparableAlert}s that are similar to the {@link ReliabilityAssetAlert}s
   * associated to a {@link ReliabilityAssetCase} based on the {@link ReliabilityAssetAlertToCaseRelation}s.
   *
   * @param spec
   *   A {@link FetchSpec} to define the retrieval for the similar alerts.
   *
   * @returns {@link FetchResultWithTotalCount<ReliabilityAssetAlert>}
   *   Result containing the similar {@link ReliabilityAssetAlert}s along with the total count excluding for limit and offset.
   */
  fetchSimilarAlerts(spec?: FetchSpec): FetchResultWithTotalCount<ReliabilityAssetAlert> | null;

  /**
   * Fetches the failure mode details for the {@link ReliabilityAssetAlert}s associated with a {@link ReliabilityAssetCase}.
   * The fetch result includes the `failureModeId`, `failureModeName`, `alertId`, `alertName`, `latestFeedbackText`,
   * `alertFailureModeRelationId`, `numRecommendations`, and `numSensorBehaviours` fields.
   * This custom fetch supports pagination, and searching and sorting on the `Failure Mode` and `Alert Name` fields.
   *
   * @param caseId
   *   The ID of the {@link ReliabilityAssetCase} to fetch the failure modes for the associated {@link ReliabilityAssetAlert}.
   * @param spec
   *   A {@link FetchSpec} that contains the filters, pagination, and sorting options for the fetch.
   *
   * @returns {@link FetchResultWithTotalCount<json>}
   *   Result containing the failure mode objects along with the total count.
   */
  static fetchFailureModeDetails(caseId: string, spec?: FetchSpec): FetchResultWithTotalCount<any> | null;

  /**
   * Retrieves the total count fetchFailureModeRelations
   */
  fetchCountFailureModeRelations(spec?: FetchSpec): number;

  /**
   * Retrieves all {@link FailureModeRelation}s for the case, including those for all linked alerts.
   * The given {@link FetchSpec#include} argument should be populated but not include `from` to avoid issues with fetching on an `anyof` field.
   */
  fetchFailureModeRelations(spec?: FetchSpec): FetchResult<FailureModeRelation>;

  /**
   * Reopen the case and transition alerts back to case.
   */
  reopenCaseAndTransitionAlerts(spec: ReopenAndTransitionAlertsSpec): void;

  /**
   * Retrieves all {@link FailureRecommendationRelation}s for the case, including those for all linked alerts.
   * The given {@link FetchSpec#include} argument should be populated but not include `from` to avoid issues with fetching on an `anyof` field.
   */
  fetchFailureRecommendationRelations(spec?: FetchSpec): FetchResult<FailureRecommendationRelation>;
}
