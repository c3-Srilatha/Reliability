// TypeScript definitions for the C3 type ReliabilityOrchestrator.InferenceJobResult

/**
 * Represents the inference workflow that will be executed for a single {@link ReliabilityAsset} and for
 * a specific {@link MlProject}.
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityOrchestrator.InferenceJobResult
 */
declare namespace ReliabilityOrchestrator {
  export interface IInferenceJobResult {
    ...
    /**
     * The {@link ReliabilityAsset} for which inference is executed.
     */
    asset: IReliabilityAsset;

    /**
     * Specify the {@link MlProject} for which inference should be run.
     */
    project: IReliabilityMl.Project;

    /**
     * Specify the {@link TimeRange} for which inference should be run. Note that both
     * `inferencePeriod.start` and `inferencePeriod.end` MUST be provided.
     */
    inferencePeriod: ITimeRange;

    /**
     * Flag to indicate if the inference period provided should be overriden to account for
     * incremental inference.
     *
     * This flag should be inherited from the {@link ReliabilityOrchestrator.InferenceJobSpec} used
     * to create this result.
     */
    overrideInferencePeriodForInference: boolean;

    /**
     * Specify the statusLabel for which inference should be executed.
     * NOTE: Inference can only be executed for `CHAMPION` or `CHALLENGER` models.
     */
    statusLabel?: string;
  }
}
 ...
 * a specific {@link MlProject}.
 *
 * @remarks this represents a made instance of ReliabilityOrchestrator.InferenceJobResult
 */
declare namespace ReliabilityOrchestrator {
  export class InferenceJobResult extends Obj  {

    /**
     * The unique and required name of this instance.
     */
    readonly name: string;
    withName(name: string): ReliabilityOrchestrator.InferenceJobResult;
    ...
    withTypeIdent(typeIdent: string | null): ReliabilityOrchestrator.InferenceJobResult;
     ...
     */
    readonly id: string;
    withId(id: string): ReliabilityOrchestrator.InferenceJobResult;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityOrchestrator.InferenceJobResult;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): ReliabilityOrchestrator.InferenceJobResult;
    ...
    withVersion(version: number | null): ReliabilityOrchestrator.InferenceJobResult;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): ReliabilityOrchestrator.InferenceJobResult;

    /**
     * Parent {@link MlWorkflowCoordinatable} that this result belongs to.
     */
    readonly parentCoordinator: MlWorkflowCoordinatable<MlWorkflowCoordinatableResult>;
    withParentCoordinator(parentCoordinator: IMlWorkflowCoordinatable<MlWorkflowCoordinatableResult>): ReliabilityOrchestrator.InferenceJobResult;
    ...
    withStatusForCoordinatable(statusForCoordinatable: string): ReliabilityOrchestrator.InferenceJobResult;

    /**
     * Number of times the {@link #parentCoordinator} has canceled this result.
     */
    readonly canceledCount?: number;
    withCanceledCount(canceledCount: number | null): ReliabilityOrchestrator.InferenceJobResult;
    ...
    withIsCanceled(isCanceled: boolean): ReliabilityOrchestrator.InferenceJobResult;
    ...
    withErrorCount(errorCount: number | null): ReliabilityOrchestrator.InferenceJobResult;
    ...
    withRun(run: IWorkflowExecutorRun | null): ReliabilityOrchestrator.InferenceJobResult;
    ...
    withDurationSeconds(durationSeconds: number | null): ReliabilityOrchestrator.InferenceJobResult;
    ...
    withPastRuns(pastRuns: Array_Type<WorkflowExecutorRun> | Array<IWorkflowExecutorRun> | null): ReliabilityOrchestrator.InferenceJobResult;

    /**
     * Number of times the {@link #parentCoordinator} has attempted to recover this result.
     */
    readonly attemptedRecoveryCount?: number;
    withAttemptedRecoveryCount(attemptedRecoveryCount: number | null): ReliabilityOrchestrator.InferenceJobResult;

    /**
     * The {@link ReliabilityAsset} for which inference is executed.
     */
    readonly asset: ReliabilityAsset;
    withAsset(asset: IReliabilityAsset): ReliabilityOrchestrator.InferenceJobResult;

    /**
     * Specify the {@link MlProject} for which inference should be run.
     */
    readonly project: ReliabilityMl.Project;
    withProject(project: IReliabilityMl.Project): ReliabilityOrchestrator.InferenceJobResult;

    /**
     * Specify the {@link TimeRange} for which inference should be run. Note that both
     * `inferencePeriod.start` and `inferencePeriod.end` MUST be provided.
     */
    readonly inferencePeriod: TimeRange;
    withInferencePeriod(inferencePeriod: ITimeRange): ReliabilityOrchestrator.InferenceJobResult;
     ...
     * to create this result.
     */
    readonly overrideInferencePeriodForInference: boolean;
    withOverrideInferencePeriodForInference(overrideInferencePeriodForInference: boolean): ReliabilityOrchestrator.InferenceJobResult;
    ...
    withStatusLabel(statusLabel: string | null): ReliabilityOrchestrator.InferenceJobResult;
     ...
     * @see #toJson
     */
    static fromJson(json: any): ReliabilityOrchestrator.InferenceJobResult | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): ReliabilityOrchestrator.InferenceJobResult | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): ReliabilityOrchestrator.InferenceJobResult | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): ReliabilityOrchestrator.InferenceJobResult | null;
     ...
     */
    replaceType(old: Type, new_: Type): ReliabilityOrchestrator.InferenceJobResult;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityOrchestrator.InferenceJobResult;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityOrchestrator.InferenceJobResult;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityOrchestrator.InferenceJobResult>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityOrchestrator.InferenceJobResult>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityOrchestrator.InferenceJobResult;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityOrchestrator.InferenceJobResult;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityOrchestrator.InferenceJobResult;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): ReliabilityOrchestrator.InferenceJobResult;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): ReliabilityOrchestrator.InferenceJobResult;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityOrchestrator.InferenceJobResult;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityOrchestrator.InferenceJobResult;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityOrchestrator.InferenceJobResult;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): ReliabilityOrchestrator.InferenceJobResult;
     ...
     * @see #removeField
     */
    withoutField(field: string): ReliabilityOrchestrator.InferenceJobResult;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): ReliabilityOrchestrator.InferenceJobResult;
     ...
     */
    withoutFields(fields: Array_Type<string>): ReliabilityOrchestrator.InferenceJobResult;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityOrchestrator.InferenceJobResult;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): ReliabilityOrchestrator.InferenceJobResult;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityOrchestrator.InferenceJobResult;
     ...
     * @see #unsetField
     */
    defaultField(field: string): ReliabilityOrchestrator.InferenceJobResult;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): ReliabilityOrchestrator.InferenceJobResult;
     ...
     * @see #removeField
     */
    unsetField(field: string): ReliabilityOrchestrator.InferenceJobResult;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): ReliabilityOrchestrator.InferenceJobResult;
     ...
     * @see #unsetField
     */
    removeField(field: string): ReliabilityOrchestrator.InferenceJobResult;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): ReliabilityOrchestrator.InferenceJobResult;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityOrchestrator.InferenceJobResult;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityOrchestrator.InferenceJobResult;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityOrchestrator.InferenceJobResult;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityOrchestrator.InferenceJobResult;

    mergeJson(json: any): ReliabilityOrchestrator.InferenceJobResult;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityOrchestrator.InferenceJobResult;
     ...
     */
    sumObj(other: Obj, deep?: boolean): ReliabilityOrchestrator.InferenceJobResult;
     ...
     */
    singletonArray(): Array_Type<ReliabilityOrchestrator.InferenceJobResult>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityOrchestrator.InferenceJobResult> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<ReliabilityOrchestrator.InferenceJobResult> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<ReliabilityOrchestrator.InferenceJobResult>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<ReliabilityOrchestrator.InferenceJobResult> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, ReliabilityOrchestrator.InferenceJobResult> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityOrchestrator.InferenceJobResult> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<ReliabilityOrchestrator.InferenceJobResult>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<ReliabilityOrchestrator.InferenceJobResult>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityOrchestrator.InferenceJobResult;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityOrchestrator.InferenceJobResult;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityOrchestrator.InferenceJobResult;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): ReliabilityOrchestrator.InferenceJobResult;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityOrchestrator.InferenceJobResult;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): ReliabilityOrchestrator.InferenceJobResult;
     ...
     * @see #fromString
     */
    static make(s: string): ReliabilityOrchestrator.InferenceJobResult | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityOrchestrator.InferenceJobResult;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): ReliabilityOrchestrator.InferenceJobResult;
     ...
     */
    static cachedEmptyInst(): ReliabilityOrchestrator.InferenceJobResult;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityOrchestrator.InferenceJobResult> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): ReliabilityOrchestrator.InferenceJobResult;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<ReliabilityOrchestrator.InferenceJobResult>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<ReliabilityOrchestrator.InferenceJobResult>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityOrchestrator.InferenceJobResult> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityOrchestrator.InferenceJobResult>> | null;
     ...
     */
    get(include?: string): ReliabilityOrchestrator.InferenceJobResult | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): ReliabilityOrchestrator.InferenceJobResult | null;
     ...
     */
    getMissing(spec: GetMissingSpec): ReliabilityOrchestrator.InferenceJobResult;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): ReliabilityOrchestrator.InferenceJobResult | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): ReliabilityOrchestrator.InferenceJobResult;
     ...
     * @see #toString
     */
    static fromString(s: string): ReliabilityOrchestrator.InferenceJobResult | null;
     ...
     */
    create(spec?: UpsertSpec): ReliabilityOrchestrator.InferenceJobResult | null;
     ...
     */
    static createBatch(objs: Array_Type<ReliabilityOrchestrator.InferenceJobResult>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.InferenceJobResult> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<ReliabilityOrchestrator.InferenceJobResult>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityOrchestrator.InferenceJobResult> | null;
     ...
     */
    update(srcObj?: ReliabilityOrchestrator.InferenceJobResult, spec?: UpsertSpec): ReliabilityOrchestrator.InferenceJobResult | null;
     ...
     */
    upsert(srcObj?: ReliabilityOrchestrator.InferenceJobResult, spec?: UpsertSpec): ReliabilityOrchestrator.InferenceJobResult | null;
     ...
     */
    merge(spec?: MergeSpec): ReliabilityOrchestrator.InferenceJobResult | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): ReliabilityOrchestrator.InferenceJobResult | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): ReliabilityOrchestrator.InferenceJobResult | null;
     ...
     */
    static updateBatch(objs: Array_Type<ReliabilityOrchestrator.InferenceJobResult>, srcObjs?: Array_Type<ReliabilityOrchestrator.InferenceJobResult>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.InferenceJobResult> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<ReliabilityOrchestrator.InferenceJobResult> | null>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.InferenceJobResult> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<ReliabilityOrchestrator.InferenceJobResult>, srcObjs?: Array_Type<ReliabilityOrchestrator.InferenceJobResult>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.InferenceJobResult> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<ReliabilityOrchestrator.InferenceJobResult> | null>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.InferenceJobResult> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<ReliabilityOrchestrator.InferenceJobResult>, spec?: TouchSpec): ObjList<ReliabilityOrchestrator.InferenceJobResult> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityOrchestrator.InferenceJobResult>, spec?: MergeSpec): ObjList<ReliabilityOrchestrator.InferenceJobResult> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityOrchestrator.InferenceJobResult>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityOrchestrator.InferenceJobResult> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<ReliabilityOrchestrator.InferenceJobResult> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityOrchestrator.InferenceJobResult> | null;
     ...
     */
    static mergeAll(mergeObj: ReliabilityOrchestrator.InferenceJobResult, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: ReliabilityOrchestrator.InferenceJobResult, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<ReliabilityOrchestrator.InferenceJobResult>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.InferenceJobResult> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<ReliabilityOrchestrator.InferenceJobResult>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.InferenceJobResult> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): ReliabilityOrchestrator.InferenceJobResult | null;
     ...
     */
    static beforeCreate(objs: Array_Type<ReliabilityOrchestrator.InferenceJobResult>): ObjList<ReliabilityOrchestrator.InferenceJobResult>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<ReliabilityOrchestrator.InferenceJobResult>): ObjList<ReliabilityOrchestrator.InferenceJobResult>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<ReliabilityOrchestrator.InferenceJobResult>): ObjList<ReliabilityOrchestrator.InferenceJobResult>;
     ...
     */
    static afterCreate(objs: Array_Type<ReliabilityOrchestrator.InferenceJobResult>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<ReliabilityOrchestrator.InferenceJobResult>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<ReliabilityOrchestrator.InferenceJobResult>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityOrchestrator.InferenceJobResult>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityOrchestrator.InferenceJobResult>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): ReliabilityOrchestrator.InferenceJobResult | null;
     ...
     */
    withoutIdentity(): ReliabilityOrchestrator.InferenceJobResult | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<ReliabilityOrchestrator.InferenceJobResult>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: ReliabilityOrchestrator.InferenceJobResult, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<ReliabilityOrchestrator.InferenceJobResult>, callback?: λFunction<ReliabilityOrchestrator.InferenceJobResult | null, ReliabilityOrchestrator.InferenceJobResult | null>): ObjList<ReliabilityOrchestrator.InferenceJobResult>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<ReliabilityOrchestrator.InferenceJobResult>, callback?: λFunction<ReliabilityOrchestrator.InferenceJobResult | null, ReliabilityOrchestrator.InferenceJobResult | null>): Array_Type<ObjError> | null;
     ...
     */
    beforeRecover(): ReliabilityOrchestrator.InferenceJobResult;
     ...
     * caller is responsible for persisting the result.
     */
    beforeCancel(): ReliabilityOrchestrator.InferenceJobResult;
     ...
     * 4) Generates alerts.
     * @param project
     *           The reliability ML project to use for inference.
     * @param asset
     *           The reliability asset to run inference on.
     * @param model
     *           The reliability ML model to run inference with.
     * @param start
     *           The start datetime for inference.
     * @param end
     *           The end datetime for inference.
     * @param operationTimeout
     *           The operation timeout string.
     * @param statusLabel
     *           The status label for the model.
     * @return A {@link Workflow} object for the model inference.
     */
    static createModelInferenceWorkflow(project: ReliabilityMl.Project, asset: ReliabilityAsset, model: ReliabilityMlModel, start: DateTime, end: DateTime, operationTimeout?: string, statusLabel?: string): Workflow | null;
     ...
     * @param model
     *           The reliability ML model to process.
     * @param asset
     *           The reliability asset associated with the model.
     * @param statusLabel
     *           The status label for the model.
     * @param outputs
     *           Tuple containing the model outputs.
     * @param forInterpretation
     *           Whether the outputs are for interpretation.
     */
    static processAndInterpretHandle(model: ReliabilityMlModel, asset: ReliabilityAsset, statusLabel: string, outputs?: Tuple, forInterpretation?: boolean): void;
  }
}
