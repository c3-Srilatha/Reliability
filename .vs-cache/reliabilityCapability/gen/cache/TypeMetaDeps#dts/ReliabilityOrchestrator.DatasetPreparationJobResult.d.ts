// TypeScript definitions for the C3 type ReliabilityOrchestrator.DatasetPreparationJobResult

/**
 * Represents the dataset preparation workflow that will be executed for a single {@link ReliabilityAsset} and for
 * a specific {@link MlProject}.
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityOrchestrator.DatasetPreparationJobResult
 */
declare namespace ReliabilityOrchestrator {
  export interface IDatasetPreparationJobResult {
    ...
    /**
     * The {@link ReliabilityAsset} for which dataset preparation is executed.
     */
    assets: Array_Type<ReliabilityAsset> | Array<IReliabilityAsset>;

    /**
     * Specify the {@link MlProject} for which dataset preparation should be run.
     */
    project: IReliabilityMl.Project;

    /**
     * Spec that was used to specify execution constraints for this dataset preparation run.
     */
    spec: IReliabilityMlDatasetPreparationSpec;

    /**
     * Options to configure the execution of the dataset preparation job.
     */
    options?: IReliabilityOrchestrator.JobOptions;

    /**
     * Reference to the {@link ReliabilityMlDatasetPreparationRun} which was created as part of this Job.
     */
 ...
 * a specific {@link MlProject}.
 *
 * @remarks this represents a made instance of ReliabilityOrchestrator.DatasetPreparationJobResult
 */
declare namespace ReliabilityOrchestrator {
  export class DatasetPreparationJobResult extends Obj  {

    /**
     * The unique and required name of this instance.
     */
    readonly name: string;
    withName(name: string): ReliabilityOrchestrator.DatasetPreparationJobResult;
    ...
    withTypeIdent(typeIdent: string | null): ReliabilityOrchestrator.DatasetPreparationJobResult;
     ...
     */
    readonly id: string;
    withId(id: string): ReliabilityOrchestrator.DatasetPreparationJobResult;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityOrchestrator.DatasetPreparationJobResult;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): ReliabilityOrchestrator.DatasetPreparationJobResult;
    ...
    withVersion(version: number | null): ReliabilityOrchestrator.DatasetPreparationJobResult;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): ReliabilityOrchestrator.DatasetPreparationJobResult;

    /**
     * Parent {@link MlWorkflowCoordinatable} that this result belongs to.
     */
    readonly parentCoordinator: MlWorkflowCoordinatable<MlWorkflowCoordinatableResult>;
    withParentCoordinator(parentCoordinator: IMlWorkflowCoordinatable<MlWorkflowCoordinatableResult>): ReliabilityOrchestrator.DatasetPreparationJobResult;
    ...
    withStatusForCoordinatable(statusForCoordinatable: string): ReliabilityOrchestrator.DatasetPreparationJobResult;

    /**
     * Number of times the {@link #parentCoordinator} has canceled this result.
     */
    readonly canceledCount?: number;
    withCanceledCount(canceledCount: number | null): ReliabilityOrchestrator.DatasetPreparationJobResult;
    ...
    withIsCanceled(isCanceled: boolean): ReliabilityOrchestrator.DatasetPreparationJobResult;
    ...
    withErrorCount(errorCount: number | null): ReliabilityOrchestrator.DatasetPreparationJobResult;
    ...
    withRun(run: IWorkflowExecutorRun | null): ReliabilityOrchestrator.DatasetPreparationJobResult;
    ...
    withDurationSeconds(durationSeconds: number | null): ReliabilityOrchestrator.DatasetPreparationJobResult;
    ...
    withPastRuns(pastRuns: Array_Type<WorkflowExecutorRun> | Array<IWorkflowExecutorRun> | null): ReliabilityOrchestrator.DatasetPreparationJobResult;

    /**
     * Number of times the {@link #parentCoordinator} has attempted to recover this result.
     */
    readonly attemptedRecoveryCount?: number;
    withAttemptedRecoveryCount(attemptedRecoveryCount: number | null): ReliabilityOrchestrator.DatasetPreparationJobResult;

    /**
     * The {@link ReliabilityAsset} for which dataset preparation is executed.
     */
    readonly assets: Array_Type<ReliabilityAsset>;
    withAssets(assets: Array_Type<ReliabilityAsset> | Array<IReliabilityAsset>): ReliabilityOrchestrator.DatasetPreparationJobResult;

    /**
     * Specify the {@link MlProject} for which dataset preparation should be run.
     */
    readonly project: ReliabilityMl.Project;
    withProject(project: IReliabilityMl.Project): ReliabilityOrchestrator.DatasetPreparationJobResult;

    /**
     * Spec that was used to specify execution constraints for this dataset preparation run.
     */
    readonly spec: ReliabilityMlDatasetPreparationSpec;
    withSpec(spec: IReliabilityMlDatasetPreparationSpec): ReliabilityOrchestrator.DatasetPreparationJobResult;

    /**
     * Options to configure the execution of the dataset preparation job.
     */
    readonly options?: ReliabilityOrchestrator.JobOptions;
    withOptions(options: IReliabilityOrchestrator.JobOptions | null): ReliabilityOrchestrator.DatasetPreparationJobResult;

    /**
     * Reference to the {@link ReliabilityMlDatasetPreparationRun} which was created as part of this Job.
     */
    readonly datasetPreparationRun?: ReliabilityMlDatasetPreparationRun;
    withDatasetPreparationRun(datasetPreparationRun: IReliabilityMlDatasetPreparationRun | null): ReliabilityOrchestrator.DatasetPreparationJobResult;
     ...
     * @see #toJson
     */
    static fromJson(json: any): ReliabilityOrchestrator.DatasetPreparationJobResult | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): ReliabilityOrchestrator.DatasetPreparationJobResult | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): ReliabilityOrchestrator.DatasetPreparationJobResult | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): ReliabilityOrchestrator.DatasetPreparationJobResult | null;
     ...
     */
    replaceType(old: Type, new_: Type): ReliabilityOrchestrator.DatasetPreparationJobResult;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityOrchestrator.DatasetPreparationJobResult;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityOrchestrator.DatasetPreparationJobResult;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityOrchestrator.DatasetPreparationJobResult>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityOrchestrator.DatasetPreparationJobResult>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityOrchestrator.DatasetPreparationJobResult;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityOrchestrator.DatasetPreparationJobResult;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityOrchestrator.DatasetPreparationJobResult;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): ReliabilityOrchestrator.DatasetPreparationJobResult;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): ReliabilityOrchestrator.DatasetPreparationJobResult;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityOrchestrator.DatasetPreparationJobResult;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityOrchestrator.DatasetPreparationJobResult;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityOrchestrator.DatasetPreparationJobResult;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): ReliabilityOrchestrator.DatasetPreparationJobResult;
     ...
     * @see #removeField
     */
    withoutField(field: string): ReliabilityOrchestrator.DatasetPreparationJobResult;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): ReliabilityOrchestrator.DatasetPreparationJobResult;
     ...
     */
    withoutFields(fields: Array_Type<string>): ReliabilityOrchestrator.DatasetPreparationJobResult;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityOrchestrator.DatasetPreparationJobResult;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): ReliabilityOrchestrator.DatasetPreparationJobResult;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityOrchestrator.DatasetPreparationJobResult;
     ...
     * @see #unsetField
     */
    defaultField(field: string): ReliabilityOrchestrator.DatasetPreparationJobResult;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): ReliabilityOrchestrator.DatasetPreparationJobResult;
     ...
     * @see #removeField
     */
    unsetField(field: string): ReliabilityOrchestrator.DatasetPreparationJobResult;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): ReliabilityOrchestrator.DatasetPreparationJobResult;
     ...
     * @see #unsetField
     */
    removeField(field: string): ReliabilityOrchestrator.DatasetPreparationJobResult;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): ReliabilityOrchestrator.DatasetPreparationJobResult;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityOrchestrator.DatasetPreparationJobResult;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityOrchestrator.DatasetPreparationJobResult;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityOrchestrator.DatasetPreparationJobResult;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityOrchestrator.DatasetPreparationJobResult;

    mergeJson(json: any): ReliabilityOrchestrator.DatasetPreparationJobResult;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityOrchestrator.DatasetPreparationJobResult;
     ...
     */
    sumObj(other: Obj, deep?: boolean): ReliabilityOrchestrator.DatasetPreparationJobResult;
     ...
     */
    singletonArray(): Array_Type<ReliabilityOrchestrator.DatasetPreparationJobResult>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityOrchestrator.DatasetPreparationJobResult> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<ReliabilityOrchestrator.DatasetPreparationJobResult> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<ReliabilityOrchestrator.DatasetPreparationJobResult>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<ReliabilityOrchestrator.DatasetPreparationJobResult> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, ReliabilityOrchestrator.DatasetPreparationJobResult> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityOrchestrator.DatasetPreparationJobResult> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<ReliabilityOrchestrator.DatasetPreparationJobResult>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<ReliabilityOrchestrator.DatasetPreparationJobResult>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityOrchestrator.DatasetPreparationJobResult;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityOrchestrator.DatasetPreparationJobResult;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityOrchestrator.DatasetPreparationJobResult;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): ReliabilityOrchestrator.DatasetPreparationJobResult;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityOrchestrator.DatasetPreparationJobResult;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): ReliabilityOrchestrator.DatasetPreparationJobResult;
     ...
     * @see #fromString
     */
    static make(s: string): ReliabilityOrchestrator.DatasetPreparationJobResult | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityOrchestrator.DatasetPreparationJobResult;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): ReliabilityOrchestrator.DatasetPreparationJobResult;
     ...
     */
    static cachedEmptyInst(): ReliabilityOrchestrator.DatasetPreparationJobResult;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityOrchestrator.DatasetPreparationJobResult> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): ReliabilityOrchestrator.DatasetPreparationJobResult;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<ReliabilityOrchestrator.DatasetPreparationJobResult>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<ReliabilityOrchestrator.DatasetPreparationJobResult>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityOrchestrator.DatasetPreparationJobResult> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityOrchestrator.DatasetPreparationJobResult>> | null;
     ...
     */
    get(include?: string): ReliabilityOrchestrator.DatasetPreparationJobResult | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): ReliabilityOrchestrator.DatasetPreparationJobResult | null;
     ...
     */
    getMissing(spec: GetMissingSpec): ReliabilityOrchestrator.DatasetPreparationJobResult;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): ReliabilityOrchestrator.DatasetPreparationJobResult | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): ReliabilityOrchestrator.DatasetPreparationJobResult;
     ...
     * @see #toString
     */
    static fromString(s: string): ReliabilityOrchestrator.DatasetPreparationJobResult | null;
     ...
     */
    create(spec?: UpsertSpec): ReliabilityOrchestrator.DatasetPreparationJobResult | null;
     ...
     */
    static createBatch(objs: Array_Type<ReliabilityOrchestrator.DatasetPreparationJobResult>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.DatasetPreparationJobResult> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<ReliabilityOrchestrator.DatasetPreparationJobResult>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityOrchestrator.DatasetPreparationJobResult> | null;
     ...
     */
    update(srcObj?: ReliabilityOrchestrator.DatasetPreparationJobResult, spec?: UpsertSpec): ReliabilityOrchestrator.DatasetPreparationJobResult | null;
     ...
     */
    upsert(srcObj?: ReliabilityOrchestrator.DatasetPreparationJobResult, spec?: UpsertSpec): ReliabilityOrchestrator.DatasetPreparationJobResult | null;
     ...
     */
    merge(spec?: MergeSpec): ReliabilityOrchestrator.DatasetPreparationJobResult | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): ReliabilityOrchestrator.DatasetPreparationJobResult | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): ReliabilityOrchestrator.DatasetPreparationJobResult | null;
     ...
     */
    static updateBatch(objs: Array_Type<ReliabilityOrchestrator.DatasetPreparationJobResult>, srcObjs?: Array_Type<ReliabilityOrchestrator.DatasetPreparationJobResult>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.DatasetPreparationJobResult> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<ReliabilityOrchestrator.DatasetPreparationJobResult> | null>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.DatasetPreparationJobResult> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<ReliabilityOrchestrator.DatasetPreparationJobResult>, srcObjs?: Array_Type<ReliabilityOrchestrator.DatasetPreparationJobResult>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.DatasetPreparationJobResult> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<ReliabilityOrchestrator.DatasetPreparationJobResult> | null>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.DatasetPreparationJobResult> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<ReliabilityOrchestrator.DatasetPreparationJobResult>, spec?: TouchSpec): ObjList<ReliabilityOrchestrator.DatasetPreparationJobResult> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityOrchestrator.DatasetPreparationJobResult>, spec?: MergeSpec): ObjList<ReliabilityOrchestrator.DatasetPreparationJobResult> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityOrchestrator.DatasetPreparationJobResult>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityOrchestrator.DatasetPreparationJobResult> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<ReliabilityOrchestrator.DatasetPreparationJobResult> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityOrchestrator.DatasetPreparationJobResult> | null;
     ...
     */
    static mergeAll(mergeObj: ReliabilityOrchestrator.DatasetPreparationJobResult, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: ReliabilityOrchestrator.DatasetPreparationJobResult, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<ReliabilityOrchestrator.DatasetPreparationJobResult>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.DatasetPreparationJobResult> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<ReliabilityOrchestrator.DatasetPreparationJobResult>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.DatasetPreparationJobResult> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): ReliabilityOrchestrator.DatasetPreparationJobResult | null;
     ...
     */
    static beforeCreate(objs: Array_Type<ReliabilityOrchestrator.DatasetPreparationJobResult>): ObjList<ReliabilityOrchestrator.DatasetPreparationJobResult>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<ReliabilityOrchestrator.DatasetPreparationJobResult>): ObjList<ReliabilityOrchestrator.DatasetPreparationJobResult>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<ReliabilityOrchestrator.DatasetPreparationJobResult>): ObjList<ReliabilityOrchestrator.DatasetPreparationJobResult>;
     ...
     */
    static afterCreate(objs: Array_Type<ReliabilityOrchestrator.DatasetPreparationJobResult>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<ReliabilityOrchestrator.DatasetPreparationJobResult>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<ReliabilityOrchestrator.DatasetPreparationJobResult>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityOrchestrator.DatasetPreparationJobResult>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityOrchestrator.DatasetPreparationJobResult>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): ReliabilityOrchestrator.DatasetPreparationJobResult | null;
     ...
     */
    withoutIdentity(): ReliabilityOrchestrator.DatasetPreparationJobResult | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<ReliabilityOrchestrator.DatasetPreparationJobResult>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: ReliabilityOrchestrator.DatasetPreparationJobResult, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<ReliabilityOrchestrator.DatasetPreparationJobResult>, callback?: λFunction<ReliabilityOrchestrator.DatasetPreparationJobResult | null, ReliabilityOrchestrator.DatasetPreparationJobResult | null>): ObjList<ReliabilityOrchestrator.DatasetPreparationJobResult>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<ReliabilityOrchestrator.DatasetPreparationJobResult>, callback?: λFunction<ReliabilityOrchestrator.DatasetPreparationJobResult | null, ReliabilityOrchestrator.DatasetPreparationJobResult | null>): Array_Type<ObjError> | null;
     ...
     */
    beforeRecover(): ReliabilityOrchestrator.DatasetPreparationJobResult;
     ...
     * caller is responsible for persisting the result.
     */
    beforeCancel(): ReliabilityOrchestrator.DatasetPreparationJobResult;

    /**
     * Creates a dataset preparation run for all {@link ReliabilityAsset}s according to the passed in {@link ReliabilityMlDatasetPreparationSpec}.
     * This workflow:
     * 1) Executes `ReliabilityAsset.prepareMlDatasetsAndSensorDataReports()` for all the assets
     * 2) Refreshes calc fields on asset
     * 3) Creates {@link Feature.Set.Snapshot}s for the {@link ReliabilityMlDatasetPreparationRunCommon#xFeatures} and
     * {@link ReliabilityMlDatasetPreparationRunCommon#yFeatures}, for both the train and validation periods.
     * 4) Outputs {@link ReliabilityMlDatasetPreparationRunCommon}.
     */
    static createDatasetPreparationWorkflow(assets: Array_Type<ReliabilityAsset>, spec: ReliabilityMlDatasetPreparationSpec, operationTimeout?: string): Workflow | null;
  }
}
