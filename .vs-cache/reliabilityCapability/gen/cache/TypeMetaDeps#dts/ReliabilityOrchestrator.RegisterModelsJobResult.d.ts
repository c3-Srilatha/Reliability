// TypeScript definitions for the C3 type ReliabilityOrchestrator.RegisterModelsJobResult

/**
 * Represents the register models workflow that will be executed for a single {@link ReliabilityMlModel}.
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityOrchestrator.RegisterModelsJobResult
 */
declare namespace ReliabilityOrchestrator {
  export interface IRegisterModelsJobResult {
    ...
    /**
     * The {@link ReliabilityMlModel} that should be registered into model registry.
     */
    model: IReliabilityMlModel;

    /**
     * Spec that was used to specify execution constraints for this register models workflow.
     */
    options?: IReliabilityOrchestrator.JobOptions;

    /**
     * The {@link ReliabilityModelRegistry.SourceEntry} created for this {@link #model}, after the model registry
     * workflow completes.
     */
    sourceEntry?: IReliabilityModelRegistry.SourceEntry;
  }
}
 ...
 * Represents the register models workflow that will be executed for a single {@link ReliabilityMlModel}.
 *
 * @remarks this represents a made instance of ReliabilityOrchestrator.RegisterModelsJobResult
 */
declare namespace ReliabilityOrchestrator {
  export class RegisterModelsJobResult extends Obj  {

    /**
     * The unique and required name of this instance.
     */
    readonly name: string;
    withName(name: string): ReliabilityOrchestrator.RegisterModelsJobResult;
    ...
    withTypeIdent(typeIdent: string | null): ReliabilityOrchestrator.RegisterModelsJobResult;
     ...
     */
    readonly id: string;
    withId(id: string): ReliabilityOrchestrator.RegisterModelsJobResult;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityOrchestrator.RegisterModelsJobResult;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): ReliabilityOrchestrator.RegisterModelsJobResult;
    ...
    withVersion(version: number | null): ReliabilityOrchestrator.RegisterModelsJobResult;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): ReliabilityOrchestrator.RegisterModelsJobResult;

    /**
     * Parent {@link MlWorkflowCoordinatable} that this result belongs to.
     */
    readonly parentCoordinator: MlWorkflowCoordinatable<MlWorkflowCoordinatableResult>;
    withParentCoordinator(parentCoordinator: IMlWorkflowCoordinatable<MlWorkflowCoordinatableResult>): ReliabilityOrchestrator.RegisterModelsJobResult;
    ...
    withStatusForCoordinatable(statusForCoordinatable: string): ReliabilityOrchestrator.RegisterModelsJobResult;

    /**
     * Number of times the {@link #parentCoordinator} has canceled this result.
     */
    readonly canceledCount?: number;
    withCanceledCount(canceledCount: number | null): ReliabilityOrchestrator.RegisterModelsJobResult;
    ...
    withIsCanceled(isCanceled: boolean): ReliabilityOrchestrator.RegisterModelsJobResult;
    ...
    withErrorCount(errorCount: number | null): ReliabilityOrchestrator.RegisterModelsJobResult;
    ...
    withRun(run: IWorkflowExecutorRun | null): ReliabilityOrchestrator.RegisterModelsJobResult;
    ...
    withDurationSeconds(durationSeconds: number | null): ReliabilityOrchestrator.RegisterModelsJobResult;
    ...
    withPastRuns(pastRuns: Array_Type<WorkflowExecutorRun> | Array<IWorkflowExecutorRun> | null): ReliabilityOrchestrator.RegisterModelsJobResult;

    /**
     * Number of times the {@link #parentCoordinator} has attempted to recover this result.
     */
    readonly attemptedRecoveryCount?: number;
    withAttemptedRecoveryCount(attemptedRecoveryCount: number | null): ReliabilityOrchestrator.RegisterModelsJobResult;

    /**
     * The {@link ReliabilityMlModel} that should be registered into model registry.
     */
    readonly model: ReliabilityMlModel;
    withModel(model: IReliabilityMlModel): ReliabilityOrchestrator.RegisterModelsJobResult;

    /**
     * Spec that was used to specify execution constraints for this register models workflow.
     */
    readonly options?: ReliabilityOrchestrator.JobOptions;
    withOptions(options: IReliabilityOrchestrator.JobOptions | null): ReliabilityOrchestrator.RegisterModelsJobResult;

    /**
     * The {@link ReliabilityModelRegistry.SourceEntry} created for this {@link #model}, after the model registry
     * workflow completes.
     */
    readonly sourceEntry?: ReliabilityModelRegistry.SourceEntry;
    withSourceEntry(sourceEntry: IReliabilityModelRegistry.SourceEntry | null): ReliabilityOrchestrator.RegisterModelsJobResult;
     ...
     * @see #toJson
     */
    static fromJson(json: any): ReliabilityOrchestrator.RegisterModelsJobResult | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): ReliabilityOrchestrator.RegisterModelsJobResult | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): ReliabilityOrchestrator.RegisterModelsJobResult | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): ReliabilityOrchestrator.RegisterModelsJobResult | null;
     ...
     */
    replaceType(old: Type, new_: Type): ReliabilityOrchestrator.RegisterModelsJobResult;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityOrchestrator.RegisterModelsJobResult;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityOrchestrator.RegisterModelsJobResult;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityOrchestrator.RegisterModelsJobResult>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityOrchestrator.RegisterModelsJobResult>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityOrchestrator.RegisterModelsJobResult;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityOrchestrator.RegisterModelsJobResult;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityOrchestrator.RegisterModelsJobResult;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): ReliabilityOrchestrator.RegisterModelsJobResult;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): ReliabilityOrchestrator.RegisterModelsJobResult;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityOrchestrator.RegisterModelsJobResult;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityOrchestrator.RegisterModelsJobResult;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityOrchestrator.RegisterModelsJobResult;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): ReliabilityOrchestrator.RegisterModelsJobResult;
     ...
     * @see #removeField
     */
    withoutField(field: string): ReliabilityOrchestrator.RegisterModelsJobResult;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): ReliabilityOrchestrator.RegisterModelsJobResult;
     ...
     */
    withoutFields(fields: Array_Type<string>): ReliabilityOrchestrator.RegisterModelsJobResult;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityOrchestrator.RegisterModelsJobResult;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): ReliabilityOrchestrator.RegisterModelsJobResult;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityOrchestrator.RegisterModelsJobResult;
     ...
     * @see #unsetField
     */
    defaultField(field: string): ReliabilityOrchestrator.RegisterModelsJobResult;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): ReliabilityOrchestrator.RegisterModelsJobResult;
     ...
     * @see #removeField
     */
    unsetField(field: string): ReliabilityOrchestrator.RegisterModelsJobResult;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): ReliabilityOrchestrator.RegisterModelsJobResult;
     ...
     * @see #unsetField
     */
    removeField(field: string): ReliabilityOrchestrator.RegisterModelsJobResult;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): ReliabilityOrchestrator.RegisterModelsJobResult;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityOrchestrator.RegisterModelsJobResult;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityOrchestrator.RegisterModelsJobResult;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityOrchestrator.RegisterModelsJobResult;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityOrchestrator.RegisterModelsJobResult;

    mergeJson(json: any): ReliabilityOrchestrator.RegisterModelsJobResult;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityOrchestrator.RegisterModelsJobResult;
     ...
     */
    sumObj(other: Obj, deep?: boolean): ReliabilityOrchestrator.RegisterModelsJobResult;
     ...
     */
    singletonArray(): Array_Type<ReliabilityOrchestrator.RegisterModelsJobResult>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityOrchestrator.RegisterModelsJobResult> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<ReliabilityOrchestrator.RegisterModelsJobResult> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<ReliabilityOrchestrator.RegisterModelsJobResult>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<ReliabilityOrchestrator.RegisterModelsJobResult> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, ReliabilityOrchestrator.RegisterModelsJobResult> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityOrchestrator.RegisterModelsJobResult> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<ReliabilityOrchestrator.RegisterModelsJobResult>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<ReliabilityOrchestrator.RegisterModelsJobResult>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityOrchestrator.RegisterModelsJobResult;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityOrchestrator.RegisterModelsJobResult;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityOrchestrator.RegisterModelsJobResult;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): ReliabilityOrchestrator.RegisterModelsJobResult;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityOrchestrator.RegisterModelsJobResult;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): ReliabilityOrchestrator.RegisterModelsJobResult;
     ...
     * @see #fromString
     */
    static make(s: string): ReliabilityOrchestrator.RegisterModelsJobResult | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityOrchestrator.RegisterModelsJobResult;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): ReliabilityOrchestrator.RegisterModelsJobResult;
     ...
     */
    static cachedEmptyInst(): ReliabilityOrchestrator.RegisterModelsJobResult;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityOrchestrator.RegisterModelsJobResult> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): ReliabilityOrchestrator.RegisterModelsJobResult;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<ReliabilityOrchestrator.RegisterModelsJobResult>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<ReliabilityOrchestrator.RegisterModelsJobResult>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityOrchestrator.RegisterModelsJobResult> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityOrchestrator.RegisterModelsJobResult>> | null;
     ...
     */
    get(include?: string): ReliabilityOrchestrator.RegisterModelsJobResult | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): ReliabilityOrchestrator.RegisterModelsJobResult | null;
     ...
     */
    getMissing(spec: GetMissingSpec): ReliabilityOrchestrator.RegisterModelsJobResult;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): ReliabilityOrchestrator.RegisterModelsJobResult | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): ReliabilityOrchestrator.RegisterModelsJobResult;
     ...
     * @see #toString
     */
    static fromString(s: string): ReliabilityOrchestrator.RegisterModelsJobResult | null;
     ...
     */
    create(spec?: UpsertSpec): ReliabilityOrchestrator.RegisterModelsJobResult | null;
     ...
     */
    static createBatch(objs: Array_Type<ReliabilityOrchestrator.RegisterModelsJobResult>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.RegisterModelsJobResult> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<ReliabilityOrchestrator.RegisterModelsJobResult>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityOrchestrator.RegisterModelsJobResult> | null;
     ...
     */
    update(srcObj?: ReliabilityOrchestrator.RegisterModelsJobResult, spec?: UpsertSpec): ReliabilityOrchestrator.RegisterModelsJobResult | null;
     ...
     */
    upsert(srcObj?: ReliabilityOrchestrator.RegisterModelsJobResult, spec?: UpsertSpec): ReliabilityOrchestrator.RegisterModelsJobResult | null;
     ...
     */
    merge(spec?: MergeSpec): ReliabilityOrchestrator.RegisterModelsJobResult | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): ReliabilityOrchestrator.RegisterModelsJobResult | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): ReliabilityOrchestrator.RegisterModelsJobResult | null;
     ...
     */
    static updateBatch(objs: Array_Type<ReliabilityOrchestrator.RegisterModelsJobResult>, srcObjs?: Array_Type<ReliabilityOrchestrator.RegisterModelsJobResult>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.RegisterModelsJobResult> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<ReliabilityOrchestrator.RegisterModelsJobResult> | null>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.RegisterModelsJobResult> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<ReliabilityOrchestrator.RegisterModelsJobResult>, srcObjs?: Array_Type<ReliabilityOrchestrator.RegisterModelsJobResult>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.RegisterModelsJobResult> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<ReliabilityOrchestrator.RegisterModelsJobResult> | null>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.RegisterModelsJobResult> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<ReliabilityOrchestrator.RegisterModelsJobResult>, spec?: TouchSpec): ObjList<ReliabilityOrchestrator.RegisterModelsJobResult> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityOrchestrator.RegisterModelsJobResult>, spec?: MergeSpec): ObjList<ReliabilityOrchestrator.RegisterModelsJobResult> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityOrchestrator.RegisterModelsJobResult>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityOrchestrator.RegisterModelsJobResult> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<ReliabilityOrchestrator.RegisterModelsJobResult> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityOrchestrator.RegisterModelsJobResult> | null;
     ...
     */
    static mergeAll(mergeObj: ReliabilityOrchestrator.RegisterModelsJobResult, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: ReliabilityOrchestrator.RegisterModelsJobResult, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<ReliabilityOrchestrator.RegisterModelsJobResult>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.RegisterModelsJobResult> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<ReliabilityOrchestrator.RegisterModelsJobResult>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.RegisterModelsJobResult> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): ReliabilityOrchestrator.RegisterModelsJobResult | null;
     ...
     */
    static beforeCreate(objs: Array_Type<ReliabilityOrchestrator.RegisterModelsJobResult>): ObjList<ReliabilityOrchestrator.RegisterModelsJobResult>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<ReliabilityOrchestrator.RegisterModelsJobResult>): ObjList<ReliabilityOrchestrator.RegisterModelsJobResult>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<ReliabilityOrchestrator.RegisterModelsJobResult>): ObjList<ReliabilityOrchestrator.RegisterModelsJobResult>;
     ...
     */
    static afterCreate(objs: Array_Type<ReliabilityOrchestrator.RegisterModelsJobResult>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<ReliabilityOrchestrator.RegisterModelsJobResult>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<ReliabilityOrchestrator.RegisterModelsJobResult>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityOrchestrator.RegisterModelsJobResult>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityOrchestrator.RegisterModelsJobResult>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): ReliabilityOrchestrator.RegisterModelsJobResult | null;
     ...
     */
    withoutIdentity(): ReliabilityOrchestrator.RegisterModelsJobResult | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<ReliabilityOrchestrator.RegisterModelsJobResult>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: ReliabilityOrchestrator.RegisterModelsJobResult, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<ReliabilityOrchestrator.RegisterModelsJobResult>, callback?: λFunction<ReliabilityOrchestrator.RegisterModelsJobResult | null, ReliabilityOrchestrator.RegisterModelsJobResult | null>): ObjList<ReliabilityOrchestrator.RegisterModelsJobResult>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<ReliabilityOrchestrator.RegisterModelsJobResult>, callback?: λFunction<ReliabilityOrchestrator.RegisterModelsJobResult | null, ReliabilityOrchestrator.RegisterModelsJobResult | null>): Array_Type<ObjError> | null;
     ...
     */
    beforeRecover(): ReliabilityOrchestrator.RegisterModelsJobResult;
     ...
     * caller is responsible for persisting the result.
     */
    beforeCancel(): ReliabilityOrchestrator.RegisterModelsJobResult;
  }
}
