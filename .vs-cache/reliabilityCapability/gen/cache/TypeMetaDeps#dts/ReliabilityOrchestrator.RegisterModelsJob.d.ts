// TypeScript definitions for the C3 type ReliabilityOrchestrator.RegisterModelsJob

/**
 * Represents a model registry job that can be executed on {@link ReliabilityMlModel}s.
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityOrchestrator.RegisterModelsJob
 */
declare namespace ReliabilityOrchestrator {
  export interface IRegisterModelsJob {
 ...
 */
declare namespace ReliabilityOrchestrator {
  export class RegisterModelsJob extends Obj  {
     ...
     */
    readonly id: string;
    withId(id: string): ReliabilityOrchestrator.RegisterModelsJob;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityOrchestrator.RegisterModelsJob;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): ReliabilityOrchestrator.RegisterModelsJob;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): ReliabilityOrchestrator.RegisterModelsJob;
    ...
    withVersion(version: number | null): ReliabilityOrchestrator.RegisterModelsJob;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): ReliabilityOrchestrator.RegisterModelsJob;

    /**
     * Specify the modelFilter for which models should be registered.
     */
    readonly modelFilter?: string;
    withModelFilter(modelFilter: string | null): ReliabilityOrchestrator.RegisterModelsJob;
     ...
     * @see #toJson
     */
    static fromJson(json: any): ReliabilityOrchestrator.RegisterModelsJob | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): ReliabilityOrchestrator.RegisterModelsJob | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): ReliabilityOrchestrator.RegisterModelsJob | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): ReliabilityOrchestrator.RegisterModelsJob | null;
     ...
     */
    replaceType(old: Type, new_: Type): ReliabilityOrchestrator.RegisterModelsJob;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityOrchestrator.RegisterModelsJob;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityOrchestrator.RegisterModelsJob;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityOrchestrator.RegisterModelsJob>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityOrchestrator.RegisterModelsJob>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityOrchestrator.RegisterModelsJob;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityOrchestrator.RegisterModelsJob;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityOrchestrator.RegisterModelsJob;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): ReliabilityOrchestrator.RegisterModelsJob;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): ReliabilityOrchestrator.RegisterModelsJob;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityOrchestrator.RegisterModelsJob;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityOrchestrator.RegisterModelsJob;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityOrchestrator.RegisterModelsJob;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): ReliabilityOrchestrator.RegisterModelsJob;
     ...
     * @see #removeField
     */
    withoutField(field: string): ReliabilityOrchestrator.RegisterModelsJob;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): ReliabilityOrchestrator.RegisterModelsJob;
     ...
     */
    withoutFields(fields: Array_Type<string>): ReliabilityOrchestrator.RegisterModelsJob;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityOrchestrator.RegisterModelsJob;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): ReliabilityOrchestrator.RegisterModelsJob;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityOrchestrator.RegisterModelsJob;
     ...
     * @see #unsetField
     */
    defaultField(field: string): ReliabilityOrchestrator.RegisterModelsJob;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): ReliabilityOrchestrator.RegisterModelsJob;
     ...
     * @see #removeField
     */
    unsetField(field: string): ReliabilityOrchestrator.RegisterModelsJob;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): ReliabilityOrchestrator.RegisterModelsJob;
     ...
     * @see #unsetField
     */
    removeField(field: string): ReliabilityOrchestrator.RegisterModelsJob;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): ReliabilityOrchestrator.RegisterModelsJob;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityOrchestrator.RegisterModelsJob;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityOrchestrator.RegisterModelsJob;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityOrchestrator.RegisterModelsJob;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityOrchestrator.RegisterModelsJob;

    mergeJson(json: any): ReliabilityOrchestrator.RegisterModelsJob;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityOrchestrator.RegisterModelsJob;
     ...
     */
    sumObj(other: Obj, deep?: boolean): ReliabilityOrchestrator.RegisterModelsJob;
     ...
     */
    singletonArray(): Array_Type<ReliabilityOrchestrator.RegisterModelsJob>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityOrchestrator.RegisterModelsJob> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<ReliabilityOrchestrator.RegisterModelsJob> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<ReliabilityOrchestrator.RegisterModelsJob>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<ReliabilityOrchestrator.RegisterModelsJob> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, ReliabilityOrchestrator.RegisterModelsJob> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityOrchestrator.RegisterModelsJob> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<ReliabilityOrchestrator.RegisterModelsJob>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<ReliabilityOrchestrator.RegisterModelsJob>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityOrchestrator.RegisterModelsJob;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityOrchestrator.RegisterModelsJob;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityOrchestrator.RegisterModelsJob;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): ReliabilityOrchestrator.RegisterModelsJob;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityOrchestrator.RegisterModelsJob;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): ReliabilityOrchestrator.RegisterModelsJob;
     ...
     * @see #fromString
     */
    static make(s: string): ReliabilityOrchestrator.RegisterModelsJob | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityOrchestrator.RegisterModelsJob;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): ReliabilityOrchestrator.RegisterModelsJob;
     ...
     */
    static cachedEmptyInst(): ReliabilityOrchestrator.RegisterModelsJob;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityOrchestrator.RegisterModelsJob> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): ReliabilityOrchestrator.RegisterModelsJob;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<ReliabilityOrchestrator.RegisterModelsJob>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<ReliabilityOrchestrator.RegisterModelsJob>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityOrchestrator.RegisterModelsJob> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityOrchestrator.RegisterModelsJob>> | null;
     ...
     */
    get(include?: string): ReliabilityOrchestrator.RegisterModelsJob | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): ReliabilityOrchestrator.RegisterModelsJob | null;
     ...
     */
    getMissing(spec: GetMissingSpec): ReliabilityOrchestrator.RegisterModelsJob;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): ReliabilityOrchestrator.RegisterModelsJob | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): ReliabilityOrchestrator.RegisterModelsJob;
     ...
     * @see #toString
     */
    static fromString(s: string): ReliabilityOrchestrator.RegisterModelsJob | null;
     ...
     */
    create(spec?: UpsertSpec): ReliabilityOrchestrator.RegisterModelsJob | null;
     ...
     */
    static createBatch(objs: Array_Type<ReliabilityOrchestrator.RegisterModelsJob>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.RegisterModelsJob> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<ReliabilityOrchestrator.RegisterModelsJob>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityOrchestrator.RegisterModelsJob> | null;
     ...
     */
    update(srcObj?: ReliabilityOrchestrator.RegisterModelsJob, spec?: UpsertSpec): ReliabilityOrchestrator.RegisterModelsJob | null;
     ...
     */
    upsert(srcObj?: ReliabilityOrchestrator.RegisterModelsJob, spec?: UpsertSpec): ReliabilityOrchestrator.RegisterModelsJob | null;
     ...
     */
    merge(spec?: MergeSpec): ReliabilityOrchestrator.RegisterModelsJob | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): ReliabilityOrchestrator.RegisterModelsJob | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): ReliabilityOrchestrator.RegisterModelsJob | null;
     ...
     */
    static updateBatch(objs: Array_Type<ReliabilityOrchestrator.RegisterModelsJob>, srcObjs?: Array_Type<ReliabilityOrchestrator.RegisterModelsJob>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.RegisterModelsJob> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<ReliabilityOrchestrator.RegisterModelsJob> | null>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.RegisterModelsJob> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<ReliabilityOrchestrator.RegisterModelsJob>, srcObjs?: Array_Type<ReliabilityOrchestrator.RegisterModelsJob>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.RegisterModelsJob> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<ReliabilityOrchestrator.RegisterModelsJob> | null>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.RegisterModelsJob> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<ReliabilityOrchestrator.RegisterModelsJob>, spec?: TouchSpec): ObjList<ReliabilityOrchestrator.RegisterModelsJob> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityOrchestrator.RegisterModelsJob>, spec?: MergeSpec): ObjList<ReliabilityOrchestrator.RegisterModelsJob> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityOrchestrator.RegisterModelsJob>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityOrchestrator.RegisterModelsJob> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<ReliabilityOrchestrator.RegisterModelsJob> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityOrchestrator.RegisterModelsJob> | null;
     ...
     */
    static mergeAll(mergeObj: ReliabilityOrchestrator.RegisterModelsJob, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: ReliabilityOrchestrator.RegisterModelsJob, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<ReliabilityOrchestrator.RegisterModelsJob>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.RegisterModelsJob> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<ReliabilityOrchestrator.RegisterModelsJob>, spec?: UpsertSpec): ObjList<ReliabilityOrchestrator.RegisterModelsJob> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): ReliabilityOrchestrator.RegisterModelsJob | null;
     ...
     */
    static beforeCreate(objs: Array_Type<ReliabilityOrchestrator.RegisterModelsJob>): ObjList<ReliabilityOrchestrator.RegisterModelsJob>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<ReliabilityOrchestrator.RegisterModelsJob>): ObjList<ReliabilityOrchestrator.RegisterModelsJob>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<ReliabilityOrchestrator.RegisterModelsJob>): ObjList<ReliabilityOrchestrator.RegisterModelsJob>;
     ...
     */
    static afterCreate(objs: Array_Type<ReliabilityOrchestrator.RegisterModelsJob>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<ReliabilityOrchestrator.RegisterModelsJob>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<ReliabilityOrchestrator.RegisterModelsJob>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityOrchestrator.RegisterModelsJob>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityOrchestrator.RegisterModelsJob>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): ReliabilityOrchestrator.RegisterModelsJob | null;
     ...
     */
    withoutIdentity(): ReliabilityOrchestrator.RegisterModelsJob | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<ReliabilityOrchestrator.RegisterModelsJob>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: ReliabilityOrchestrator.RegisterModelsJob, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<ReliabilityOrchestrator.RegisterModelsJob>, callback?: λFunction<ReliabilityOrchestrator.RegisterModelsJob | null, ReliabilityOrchestrator.RegisterModelsJob | null>): ObjList<ReliabilityOrchestrator.RegisterModelsJob>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<ReliabilityOrchestrator.RegisterModelsJob>, callback?: λFunction<ReliabilityOrchestrator.RegisterModelsJob | null, ReliabilityOrchestrator.RegisterModelsJob | null>): Array_Type<ObjError> | null;
     ...
     */
    start(options?: ReliabilityOrchestrator.JobOptions): MlOperationRun<ReliabilityOrchestrator.RegisterModelsJobRun>;
  }
}
