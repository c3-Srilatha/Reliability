// TypeScript definitions for the C3 type ReliabilityMlDatasetPreparationRun

/**
 * @inheritdoc
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityMlDatasetPreparationRun
 */
declare interface IReliabilityMlDatasetPreparationRun {
   ...
   */
  spec?: IReliabilityMlDatasetPreparationSpec;
   ...
   */
  featurePreparation?: IReliabilityMlDatasetPreparationStep;

  /**
   * The dataset corresponding to the features that will be input to the {@link MlModel}.
   */
  featureDatasets?: Map_Type<string, Feature.Set> | {[key: string]: IFeature.Set};

  /**
   * The time range used to extract training data from {@link Feature.Set.Snapshot}.
   */
  trainFeatureTimeRanges?: Map_Type<string, TimeRange> | {[key: string]: ITimeRange};

  /**
   * The time range used to extract validation data from {@link Feature.Set.Snapshot}.
   */
  valFeatureTimeRanges?: Map_Type<string, TimeRange> | {[key: string]: ITimeRange};

  /**
   * This field will report the status of the masks creation step of the
   * overall {@link ReliabilityMlDatasetPreparationHelper#prepareMlDatasets}.
   */
  maskPreparation?: IReliabilityMlDatasetPreparationStep;
   ...
   */
  maskDatasets?: Map_Type<string, Feature.Set> | {[key: string]: IFeature.Set};

  /**
   * The mask time range used to extract training data from {@link Feature.Set.Snapshot}.
   */
  trainMaskTimeRanges?: Map_Type<string, TimeRange> | {[key: string]: ITimeRange};

  /**
   * The mask time range used to extract validation data from {@link Feature.Set.Snapshot}.
   */
  valMaskTimeRanges?: Map_Type<string, TimeRange> | {[key: string]: ITimeRange};

  /**
   * This field will report the status of the alertContext creation step of the
   * overall {@link ReliabilityMlDatasetPreparationHelper#prepareMlDatasets}.
   */
  alertContextPreparation?: IReliabilityMlDatasetPreparationStep;

  /**
   * The dataset corresponding to the alertContext that will be input to the {@link MlModel}.
   */
  alertContextDatasets?: Map_Type<string, Feature.Set> | {[key: string]: IFeature.Set};
   ...
   */
  trainSnapshots?: Map_Type<string, Map_Type<string, string>> | {[key: string]: Map_Type<string, string> | {[key: string]: string}};

  /**
   * The {@link Feature.Set.Snapshot} ids for the validation period associated with this run,
   * for each {@link Feature.Set} in {@link #xFeatures} and {@link #yFeatures}.
   */
  valSnapshots?: Map_Type<string, Map_Type<string, string>> | {[key: string]: Map_Type<string, string> | {[key: string]: string}};
   ...
   */
  job?: IReliabilityMlDatasetPreparationJob;
   ...
   */
  featureDataReports?: Array_Type<any> | Array<any>;
   ...
   */
  computeMetricErrors?: Array_Type<string> | Array<string>;
   ...
   */
  isLatestCompleteDatasetPreparationRun?: boolean;
  ...
  /**
   * Displays the name of this {@link ReliabilityMlDatasetPreparationRun} if exists, else displays the id.
   */
  displayName?: string;

  /**
   * The {@link ReliabilityOrchestrator.DatasetPreparationJobResult}, as part of which, this {@link ReliabilityMlDatasetPreparationRun}
   * was created in an asynchronous manner.
   */
  jobResult?: IReliabilityOrchestrator.DatasetPreparationJobResult;
}

/**
 * @inheritdoc
 *
 * @remarks this represents a made instance of ReliabilityMlDatasetPreparationRun
 */
declare class ReliabilityMlDatasetPreparationRun extends Obj  {

  /**
   * Timestamp for the value.
   */
  readonly timestamp: DateTime;
  withTimestamp(timestamp: DateTime | Date | string): ReliabilityMlDatasetPreparationRun;

  /**
   * Parent/owning obj instance.
   */
  readonly parent: ReliabilityAsset;
  withParent(parent: IReliabilityAsset): ReliabilityMlDatasetPreparationRun;
   ...
   */
  readonly id: string;
  withId(id: string): ReliabilityMlDatasetPreparationRun;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityMlDatasetPreparationRun;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): ReliabilityMlDatasetPreparationRun;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): ReliabilityMlDatasetPreparationRun;
  ...
  withVersion(version: number | null): ReliabilityMlDatasetPreparationRun;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): ReliabilityMlDatasetPreparationRun;

  /**
   * @inheritdoc
   */
  readonly facilityFilterPaths?: Array_Type<string>;
  withFacilityFilterPaths(facilityFilterPaths: Array_Type<string> | Array<string> | null): ReliabilityMlDatasetPreparationRun;
  ...
  withProject(project: IReliabilityMl.Project | null): ReliabilityMlDatasetPreparationRun;
  ...
  withTypeIdent(typeIdent: string | null): ReliabilityMlDatasetPreparationRun;

  /**
   * The {@link ReliabilityMlDatasetPreparationSpec} that was used to
   * generate the datasets detailed in this {@link ReliabilityMlDatasetPreparationRun}.
   */
  readonly spec?: ReliabilityMlDatasetPreparationSpec;
  withSpec(spec: IReliabilityMlDatasetPreparationSpec | null): ReliabilityMlDatasetPreparationRun;
  ...
  withStart(start: DateTime | Date | string | null): ReliabilityMlDatasetPreparationRun;
  ...
  withEnd(end: DateTime | Date | string | null): ReliabilityMlDatasetPreparationRun;
  ...
  withInterval(interval: string | null): ReliabilityMlDatasetPreparationRun;

  /**
   * This field will report the status of the feature creation step of the
   * overall {@link ReliabilityMlDatasetPreparationHelper#prepareMlDatasets}.
   */
  readonly featurePreparation?: ReliabilityMlDatasetPreparationStep;
  withFeaturePreparation(featurePreparation: IReliabilityMlDatasetPreparationStep | null): ReliabilityMlDatasetPreparationRun;

  /**
   * The dataset corresponding to the features that will be input to the {@link MlModel}.
   */
  readonly featureDatasets?: Map_Type<string, Feature.Set>;
  withFeatureDatasets(featureDatasets: Map_Type<string, Feature.Set> | {[key: string]: IFeature.Set} | null): ReliabilityMlDatasetPreparationRun;

  /**
   * The time range used to extract training data from {@link Feature.Set.Snapshot}.
   */
  readonly trainFeatureTimeRanges?: Map_Type<string, TimeRange>;
  withTrainFeatureTimeRanges(trainFeatureTimeRanges: Map_Type<string, TimeRange> | {[key: string]: ITimeRange} | null): ReliabilityMlDatasetPreparationRun;

  /**
   * The time range used to extract validation data from {@link Feature.Set.Snapshot}.
   */
  readonly valFeatureTimeRanges?: Map_Type<string, TimeRange>;
  withValFeatureTimeRanges(valFeatureTimeRanges: Map_Type<string, TimeRange> | {[key: string]: ITimeRange} | null): ReliabilityMlDatasetPreparationRun;

  /**
   * This field will report the status of the masks creation step of the
   * overall {@link ReliabilityMlDatasetPreparationHelper#prepareMlDatasets}.
   */
  readonly maskPreparation?: ReliabilityMlDatasetPreparationStep;
  withMaskPreparation(maskPreparation: IReliabilityMlDatasetPreparationStep | null): ReliabilityMlDatasetPreparationRun;
   ...
   * The key of the map is a string descriptor for the mask feature set. One example is 'mask_AdHocTraining'.
   */
  readonly maskDatasets?: Map_Type<string, Feature.Set>;
  withMaskDatasets(maskDatasets: Map_Type<string, Feature.Set> | {[key: string]: IFeature.Set} | null): ReliabilityMlDatasetPreparationRun;

  /**
   * The mask time range used to extract training data from {@link Feature.Set.Snapshot}.
   */
  readonly trainMaskTimeRanges?: Map_Type<string, TimeRange>;
  withTrainMaskTimeRanges(trainMaskTimeRanges: Map_Type<string, TimeRange> | {[key: string]: ITimeRange} | null): ReliabilityMlDatasetPreparationRun;

  /**
   * The mask time range used to extract validation data from {@link Feature.Set.Snapshot}.
   */
  readonly valMaskTimeRanges?: Map_Type<string, TimeRange>;
  withValMaskTimeRanges(valMaskTimeRanges: Map_Type<string, TimeRange> | {[key: string]: ITimeRange} | null): ReliabilityMlDatasetPreparationRun;

  /**
   * This field will report the status of the alertContext creation step of the
   * overall {@link ReliabilityMlDatasetPreparationHelper#prepareMlDatasets}.
   */
  readonly alertContextPreparation?: ReliabilityMlDatasetPreparationStep;
  withAlertContextPreparation(alertContextPreparation: IReliabilityMlDatasetPreparationStep | null): ReliabilityMlDatasetPreparationRun;

  /**
   * The dataset corresponding to the alertContext that will be input to the {@link MlModel}.
   */
  readonly alertContextDatasets?: Map_Type<string, Feature.Set>;
  withAlertContextDatasets(alertContextDatasets: Map_Type<string, Feature.Set> | {[key: string]: IFeature.Set} | null): ReliabilityMlDatasetPreparationRun;
   ...
   * if {@link ReliabilityMlDatasetPreparationSpec#evaluateTarget} is `true`.
   */
  readonly targetPreparation?: ReliabilityMlDatasetPreparationStep;
  withTargetPreparation(targetPreparation: IReliabilityMlDatasetPreparationStep | null): ReliabilityMlDatasetPreparationRun;

  /**
   * The dataset corresponding to the targets that will be input to the {@link MlModel}.
   */
  readonly targetDatasets?: Map_Type<string, Feature.Set>;
  withTargetDatasets(targetDatasets: Map_Type<string, Feature.Set> | {[key: string]: IFeature.Set} | null): ReliabilityMlDatasetPreparationRun;

  /**
   * The target time range used to extract training data from {@link Feature.Set.Snapshot}.
   */
  readonly trainTargetTimeRanges?: Map_Type<string, TimeRange>;
  withTrainTargetTimeRanges(trainTargetTimeRanges: Map_Type<string, TimeRange> | {[key: string]: ITimeRange} | null): ReliabilityMlDatasetPreparationRun;

  /**
   * The target time range used to extract validation data from {@link Feature.Set.Snapshot}.
   */
  readonly valTargetTimeRanges?: Map_Type<string, TimeRange>;
  withValTargetTimeRanges(valTargetTimeRanges: Map_Type<string, TimeRange> | {[key: string]: ITimeRange} | null): ReliabilityMlDatasetPreparationRun;

  /**
   * This field will report the status of the dataset splitting step of the
   * overall {@link ReliabilityMlDatasetPreparationHelper#prepareMlDatasets}.
   */
  readonly trainValSplit?: ReliabilityMlDatasetPreparationStep;
  withTrainValSplit(trainValSplit: IReliabilityMlDatasetPreparationStep | null): ReliabilityMlDatasetPreparationRun;
  ...
  withXFeatures(xFeatures: Map_Type<string, Feature.Set> | {[key: string]: IFeature.Set} | null): ReliabilityMlDatasetPreparationRun;
  ...
  withFeatures(features: Array_Type<string> | Array<string> | null): ReliabilityMlDatasetPreparationRun;
  ...
  withNumFeatures(numFeatures: number | null): ReliabilityMlDatasetPreparationRun;
  ...
  withYFeatures(yFeatures: Map_Type<string, Feature.Set> | {[key: string]: IFeature.Set} | null): ReliabilityMlDatasetPreparationRun;

  /**
   * Overall status of {@link ReliabilityMlDatasetPreparationHelper#prepareMlDatasets}.
   */
  readonly status?: string;
  withStatus(status: string | null): ReliabilityMlDatasetPreparationRun;
  ...
  withIncludeSensors(includeSensors: Array_Type<Sensor> | Array<ISensor> | null): ReliabilityMlDatasetPreparationRun;
  ...
  withExcludeSensors(excludeSensors: Array_Type<Sensor> | Array<ISensor> | null): ReliabilityMlDatasetPreparationRun;

  /**
   * The {@link Feature.Set.Snapshot} ids for the training period associated with this run,
   * for each {@link Feature.Set} in {@link #xFeatures} and {@link #yFeatures}.
   */
  readonly trainSnapshots?: Map_Type<string, Map_Type<string, string>>;
  withTrainSnapshots(trainSnapshots: Map_Type<string, Map_Type<string, string>> | {[key: string]: Map_Type<string, string> | {[key: string]: string}} | null): ReliabilityMlDatasetPreparationRun;

  /**
   * The {@link Feature.Set.Snapshot} ids for the validation period associated with this run,
   * for each {@link Feature.Set} in {@link #xFeatures} and {@link #yFeatures}.
   */
  readonly valSnapshots?: Map_Type<string, Map_Type<string, string>>;
  withValSnapshots(valSnapshots: Map_Type<string, Map_Type<string, string>> | {[key: string]: Map_Type<string, string> | {[key: string]: string}} | null): ReliabilityMlDatasetPreparationRun;

  /**
   * The {@link MapReduce} job, as part of which, this {@link ReliabilityMlDatasetPreparationRun}
   * was created in an asynchronous manner.
   */
  readonly job?: ReliabilityMlDatasetPreparationJob;
  withJob(job: IReliabilityMlDatasetPreparationJob | null): ReliabilityMlDatasetPreparationRun;
   ...
   * If featureDataReports are generated, then the number of reports should be equal to #numFeatures.
   */
  readonly featureDataReports?: Array_Type<any>;
  withFeatureDataReports(featureDataReports: Array_Type<any> | Array<any> | null): ReliabilityMlDatasetPreparationRun;
  ...
  withNumFeatureDataReports(numFeatureDataReports: number | null): ReliabilityMlDatasetPreparationRun;

  /**
   * Contains errors from {@link computeMetrics}.
   * This stores any error messages or issues encountered during the metrics computation.
   */
  readonly computeMetricErrors?: Array_Type<string>;
  withComputeMetricErrors(computeMetricErrors: Array_Type<string> | Array<string> | null): ReliabilityMlDatasetPreparationRun;

  /**
   * Whether or not this run is the parent {@link ReliabilityAsset}'s latest dataset preparation run,
   * and therefore the default dataset preparation run for model configuration purposes.
   */
  readonly isLatestCompleteDatasetPreparationRun?: boolean;
  withIsLatestCompleteDatasetPreparationRun(isLatestCompleteDatasetPreparationRun: boolean): ReliabilityMlDatasetPreparationRun;
   ...
   */
  readonly owner?: User;
  withOwner(owner: IUser | null): ReliabilityMlDatasetPreparationRun;

  /**
   * Displays the name of this {@link ReliabilityMlDatasetPreparationRun} if exists, else displays the id.
   */
  readonly displayName?: string;
  withDisplayName(displayName: string | null): ReliabilityMlDatasetPreparationRun;

  /**
   * The {@link ReliabilityOrchestrator.DatasetPreparationJobResult}, as part of which, this {@link ReliabilityMlDatasetPreparationRun}
   * was created in an asynchronous manner.
   */
  readonly jobResult?: ReliabilityOrchestrator.DatasetPreparationJobResult;
  withJobResult(jobResult: IReliabilityOrchestrator.DatasetPreparationJobResult | null): ReliabilityMlDatasetPreparationRun;
   ...
   * @see #toJson
   */
  static fromJson(json: any): ReliabilityMlDatasetPreparationRun | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): ReliabilityMlDatasetPreparationRun | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): ReliabilityMlDatasetPreparationRun | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): ReliabilityMlDatasetPreparationRun | null;
   ...
   */
  replaceType(old: Type, new_: Type): ReliabilityMlDatasetPreparationRun;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityMlDatasetPreparationRun;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityMlDatasetPreparationRun;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityMlDatasetPreparationRun>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityMlDatasetPreparationRun>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityMlDatasetPreparationRun;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityMlDatasetPreparationRun;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityMlDatasetPreparationRun;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ReliabilityMlDatasetPreparationRun;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ReliabilityMlDatasetPreparationRun;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityMlDatasetPreparationRun;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityMlDatasetPreparationRun;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityMlDatasetPreparationRun;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ReliabilityMlDatasetPreparationRun;
   ...
   * @see #removeField
   */
  withoutField(field: string): ReliabilityMlDatasetPreparationRun;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): ReliabilityMlDatasetPreparationRun;
   ...
   */
  withoutFields(fields: Array_Type<string>): ReliabilityMlDatasetPreparationRun;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityMlDatasetPreparationRun;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ReliabilityMlDatasetPreparationRun;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityMlDatasetPreparationRun;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ReliabilityMlDatasetPreparationRun;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ReliabilityMlDatasetPreparationRun;
   ...
   * @see #removeField
   */
  unsetField(field: string): ReliabilityMlDatasetPreparationRun;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ReliabilityMlDatasetPreparationRun;
   ...
   * @see #unsetField
   */
  removeField(field: string): ReliabilityMlDatasetPreparationRun;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ReliabilityMlDatasetPreparationRun;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityMlDatasetPreparationRun;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityMlDatasetPreparationRun;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityMlDatasetPreparationRun;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityMlDatasetPreparationRun;

  mergeJson(json: any): ReliabilityMlDatasetPreparationRun;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityMlDatasetPreparationRun;
   ...
   */
  sumObj(other: Obj, deep?: boolean): ReliabilityMlDatasetPreparationRun;
   ...
   */
  singletonArray(): Array_Type<ReliabilityMlDatasetPreparationRun>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityMlDatasetPreparationRun> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ReliabilityMlDatasetPreparationRun> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<ReliabilityMlDatasetPreparationRun>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ReliabilityMlDatasetPreparationRun> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, ReliabilityMlDatasetPreparationRun> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityMlDatasetPreparationRun> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ReliabilityMlDatasetPreparationRun>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ReliabilityMlDatasetPreparationRun>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityMlDatasetPreparationRun;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityMlDatasetPreparationRun;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityMlDatasetPreparationRun;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ReliabilityMlDatasetPreparationRun;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityMlDatasetPreparationRun;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ReliabilityMlDatasetPreparationRun;
   ...
   * @see #fromString
   */
  static make(s: string): ReliabilityMlDatasetPreparationRun | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityMlDatasetPreparationRun;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): ReliabilityMlDatasetPreparationRun;
   ...
   */
  static cachedEmptyInst(): ReliabilityMlDatasetPreparationRun;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityMlDatasetPreparationRun> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): ReliabilityMlDatasetPreparationRun;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<ReliabilityMlDatasetPreparationRun>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<ReliabilityMlDatasetPreparationRun>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityMlDatasetPreparationRun> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityMlDatasetPreparationRun>> | null;
   ...
   */
  get(include?: string): ReliabilityMlDatasetPreparationRun | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): ReliabilityMlDatasetPreparationRun | null;
   ...
   */
  getMissing(spec: GetMissingSpec): ReliabilityMlDatasetPreparationRun;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): ReliabilityMlDatasetPreparationRun | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): ReliabilityMlDatasetPreparationRun;
   ...
   * @see #toString
   */
  static fromString(s: string): ReliabilityMlDatasetPreparationRun | null;
   ...
   */
  create(spec?: UpsertSpec): ReliabilityMlDatasetPreparationRun | null;
   ...
   */
  static createBatch(objs: Array_Type<ReliabilityMlDatasetPreparationRun>, spec?: UpsertSpec): ObjList<ReliabilityMlDatasetPreparationRun> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<ReliabilityMlDatasetPreparationRun>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityMlDatasetPreparationRun> | null;
   ...
   */
  update(srcObj?: ReliabilityMlDatasetPreparationRun, spec?: UpsertSpec): ReliabilityMlDatasetPreparationRun | null;
   ...
   */
  upsert(srcObj?: ReliabilityMlDatasetPreparationRun, spec?: UpsertSpec): ReliabilityMlDatasetPreparationRun | null;
   ...
   */
  merge(spec?: MergeSpec): ReliabilityMlDatasetPreparationRun | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): ReliabilityMlDatasetPreparationRun | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): ReliabilityMlDatasetPreparationRun | null;
   ...
   */
  static updateBatch(objs: Array_Type<ReliabilityMlDatasetPreparationRun>, srcObjs?: Array_Type<ReliabilityMlDatasetPreparationRun>, spec?: UpsertSpec): ObjList<ReliabilityMlDatasetPreparationRun> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<ReliabilityMlDatasetPreparationRun> | null>, spec?: UpsertSpec): ObjList<ReliabilityMlDatasetPreparationRun> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<ReliabilityMlDatasetPreparationRun>, srcObjs?: Array_Type<ReliabilityMlDatasetPreparationRun>, spec?: UpsertSpec): ObjList<ReliabilityMlDatasetPreparationRun> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<ReliabilityMlDatasetPreparationRun> | null>, spec?: UpsertSpec): ObjList<ReliabilityMlDatasetPreparationRun> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<ReliabilityMlDatasetPreparationRun>, spec?: TouchSpec): ObjList<ReliabilityMlDatasetPreparationRun> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityMlDatasetPreparationRun>, spec?: MergeSpec): ObjList<ReliabilityMlDatasetPreparationRun> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityMlDatasetPreparationRun>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityMlDatasetPreparationRun> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<ReliabilityMlDatasetPreparationRun> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityMlDatasetPreparationRun> | null;
   ...
   */
  static mergeAll(mergeObj: ReliabilityMlDatasetPreparationRun, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: ReliabilityMlDatasetPreparationRun, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<ReliabilityMlDatasetPreparationRun>, spec?: UpsertSpec): ObjList<ReliabilityMlDatasetPreparationRun> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<ReliabilityMlDatasetPreparationRun>, spec?: UpsertSpec): ObjList<ReliabilityMlDatasetPreparationRun> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): ReliabilityMlDatasetPreparationRun | null;
   ...
   */
  static beforeCreate(objs: Array_Type<ReliabilityMlDatasetPreparationRun>): ObjList<ReliabilityMlDatasetPreparationRun>;

  /**
   * Function to execute any actions before updating the entity.
   */
  static beforeUpdate(objs: Array_Type<ReliabilityMlDatasetPreparationRun>): ObjList<ReliabilityMlDatasetPreparationRun>;
   ...
   */
  static beforeRemove(objs: Array_Type<ReliabilityMlDatasetPreparationRun>): ObjList<ReliabilityMlDatasetPreparationRun>;

  /**
   * Function to execute any actions after creating the entity.
   */
  static afterCreate(objs: Array_Type<ReliabilityMlDatasetPreparationRun>): Array_Type<ObjError> | null;
   ...
   */
  static afterUpdate(objs: Array_Type<ReliabilityMlDatasetPreparationRun>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<ReliabilityMlDatasetPreparationRun>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityMlDatasetPreparationRun>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityMlDatasetPreparationRun>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): ReliabilityMlDatasetPreparationRun | null;
   ...
   */
  withoutIdentity(): ReliabilityMlDatasetPreparationRun | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<ReliabilityMlDatasetPreparationRun>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: ReliabilityMlDatasetPreparationRun, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<ReliabilityMlDatasetPreparationRun>, callback?: λFunction<ReliabilityMlDatasetPreparationRun | null, ReliabilityMlDatasetPreparationRun | null>): ObjList<ReliabilityMlDatasetPreparationRun>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<ReliabilityMlDatasetPreparationRun>, callback?: λFunction<ReliabilityMlDatasetPreparationRun | null, ReliabilityMlDatasetPreparationRun | null>): Array_Type<ObjError> | null;
   ...
   */
  updateSnapshots(trainSnapshotIds?: Map_Type<string, Map_Type<string, string>>, valSnapshotIds?: Map_Type<string, Map_Type<string, string>>): void;
   ...
   */
  fetchFeatureDataReport(spec?: FetchSpec): FetchResultWithTotalCount<FeatureDataReport>;
   ...
   */
  computeData(spec: ReliabilityMlDatasetPreparationRunComputeDataSpec): Data.Persisted | null;
   ...
   */
  computeMetrics(): Array_Type<FeatureDataReport> | null;
   ...
   */
  describe(spec: ReliabilityMlDatasetPreparationRunComputeDataSpec): Data.Persisted | null;
}
