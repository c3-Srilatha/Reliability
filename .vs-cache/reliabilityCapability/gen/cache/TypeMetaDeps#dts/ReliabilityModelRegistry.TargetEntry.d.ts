// TypeScript definitions for the C3 type ReliabilityModelRegistry.TargetEntry
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityModelRegistry.TargetEntry
 */
declare namespace ReliabilityModelRegistry {
  export interface ITargetEntry {
    ...
    /**
     * The {@link ReliabilityOrchestrator.ReliabilityRisk.LoadModelsJob} that created this entry.
     */
    job?: IReliabilityOrchestrator.ReliabilityRisk.LoadModelsJob;
  }
}
 ...
 */
declare namespace ReliabilityModelRegistry {
  export class TargetEntry extends Obj  {
     ...
     */
    readonly id: string;
    withId(id: string): ReliabilityModelRegistry.TargetEntry;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityModelRegistry.TargetEntry;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): ReliabilityModelRegistry.TargetEntry;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): ReliabilityModelRegistry.TargetEntry;
    ...
    withVersion(version: number | null): ReliabilityModelRegistry.TargetEntry;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): ReliabilityModelRegistry.TargetEntry;

    /**
     * @inheritdoc
     */
    readonly facilityFilterPaths?: Array_Type<string>;
    withFacilityFilterPaths(facilityFilterPaths: Array_Type<string> | Array<string> | null): ReliabilityModelRegistry.TargetEntry;

    /**
     * A new {@link ReliabilityMlModel} that has been created in the target environment.
     */
    readonly model: ReliabilityMlModel;
    withModel(model: IReliabilityMlModel): ReliabilityModelRegistry.TargetEntry;

    /**
     * The id of the {@link ReliabilityMlModel} in the source environment that corresponds to the migrated {@link #model}.
     */
    readonly sourceModelId?: string;
    withSourceModelId(sourceModelId: string | null): ReliabilityModelRegistry.TargetEntry;

    /**
     * Indicates whether the migrated {@link ReliabilityMlModel} generates the same predictions as it's corresponding model
     * from the source environment, by comparing their predictions and contributions on a small sample dataset.
     */
    readonly hasValidPredictions?: boolean;
    withHasValidPredictions(hasValidPredictions: boolean): ReliabilityModelRegistry.TargetEntry;

    /**
     * The {@link ReliabilityOrchestrator.ReliabilityRisk.LoadModelsJob} that created this entry.
     */
    readonly job?: ReliabilityOrchestrator.ReliabilityRisk.LoadModelsJob;
    withJob(job: IReliabilityOrchestrator.ReliabilityRisk.LoadModelsJob | null): ReliabilityModelRegistry.TargetEntry;
     ...
     * @see #toJson
     */
    static fromJson(json: any): ReliabilityModelRegistry.TargetEntry | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): ReliabilityModelRegistry.TargetEntry | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): ReliabilityModelRegistry.TargetEntry | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): ReliabilityModelRegistry.TargetEntry | null;
     ...
     */
    replaceType(old: Type, new_: Type): ReliabilityModelRegistry.TargetEntry;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityModelRegistry.TargetEntry;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityModelRegistry.TargetEntry;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityModelRegistry.TargetEntry>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityModelRegistry.TargetEntry>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityModelRegistry.TargetEntry;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityModelRegistry.TargetEntry;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityModelRegistry.TargetEntry;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): ReliabilityModelRegistry.TargetEntry;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): ReliabilityModelRegistry.TargetEntry;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityModelRegistry.TargetEntry;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityModelRegistry.TargetEntry;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityModelRegistry.TargetEntry;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): ReliabilityModelRegistry.TargetEntry;
     ...
     * @see #removeField
     */
    withoutField(field: string): ReliabilityModelRegistry.TargetEntry;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): ReliabilityModelRegistry.TargetEntry;
     ...
     */
    withoutFields(fields: Array_Type<string>): ReliabilityModelRegistry.TargetEntry;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityModelRegistry.TargetEntry;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): ReliabilityModelRegistry.TargetEntry;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityModelRegistry.TargetEntry;
     ...
     * @see #unsetField
     */
    defaultField(field: string): ReliabilityModelRegistry.TargetEntry;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): ReliabilityModelRegistry.TargetEntry;
     ...
     * @see #removeField
     */
    unsetField(field: string): ReliabilityModelRegistry.TargetEntry;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): ReliabilityModelRegistry.TargetEntry;
     ...
     * @see #unsetField
     */
    removeField(field: string): ReliabilityModelRegistry.TargetEntry;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): ReliabilityModelRegistry.TargetEntry;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityModelRegistry.TargetEntry;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityModelRegistry.TargetEntry;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityModelRegistry.TargetEntry;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityModelRegistry.TargetEntry;

    mergeJson(json: any): ReliabilityModelRegistry.TargetEntry;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityModelRegistry.TargetEntry;
     ...
     */
    sumObj(other: Obj, deep?: boolean): ReliabilityModelRegistry.TargetEntry;
     ...
     */
    singletonArray(): Array_Type<ReliabilityModelRegistry.TargetEntry>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityModelRegistry.TargetEntry> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<ReliabilityModelRegistry.TargetEntry> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<ReliabilityModelRegistry.TargetEntry>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<ReliabilityModelRegistry.TargetEntry> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, ReliabilityModelRegistry.TargetEntry> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityModelRegistry.TargetEntry> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<ReliabilityModelRegistry.TargetEntry>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<ReliabilityModelRegistry.TargetEntry>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityModelRegistry.TargetEntry;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityModelRegistry.TargetEntry;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityModelRegistry.TargetEntry;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): ReliabilityModelRegistry.TargetEntry;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityModelRegistry.TargetEntry;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): ReliabilityModelRegistry.TargetEntry;
     ...
     * @see #fromString
     */
    static make(s: string): ReliabilityModelRegistry.TargetEntry | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityModelRegistry.TargetEntry;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): ReliabilityModelRegistry.TargetEntry;
     ...
     */
    static cachedEmptyInst(): ReliabilityModelRegistry.TargetEntry;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityModelRegistry.TargetEntry> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): ReliabilityModelRegistry.TargetEntry;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<ReliabilityModelRegistry.TargetEntry>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<ReliabilityModelRegistry.TargetEntry>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityModelRegistry.TargetEntry> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityModelRegistry.TargetEntry>> | null;
     ...
     */
    get(include?: string): ReliabilityModelRegistry.TargetEntry | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): ReliabilityModelRegistry.TargetEntry | null;
     ...
     */
    getMissing(spec: GetMissingSpec): ReliabilityModelRegistry.TargetEntry;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): ReliabilityModelRegistry.TargetEntry | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): ReliabilityModelRegistry.TargetEntry;
     ...
     * @see #toString
     */
    static fromString(s: string): ReliabilityModelRegistry.TargetEntry | null;
     ...
     */
    create(spec?: UpsertSpec): ReliabilityModelRegistry.TargetEntry | null;
     ...
     */
    static createBatch(objs: Array_Type<ReliabilityModelRegistry.TargetEntry>, spec?: UpsertSpec): ObjList<ReliabilityModelRegistry.TargetEntry> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<ReliabilityModelRegistry.TargetEntry>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityModelRegistry.TargetEntry> | null;
     ...
     */
    update(srcObj?: ReliabilityModelRegistry.TargetEntry, spec?: UpsertSpec): ReliabilityModelRegistry.TargetEntry | null;
     ...
     */
    upsert(srcObj?: ReliabilityModelRegistry.TargetEntry, spec?: UpsertSpec): ReliabilityModelRegistry.TargetEntry | null;
     ...
     */
    merge(spec?: MergeSpec): ReliabilityModelRegistry.TargetEntry | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): ReliabilityModelRegistry.TargetEntry | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): ReliabilityModelRegistry.TargetEntry | null;
     ...
     */
    static updateBatch(objs: Array_Type<ReliabilityModelRegistry.TargetEntry>, srcObjs?: Array_Type<ReliabilityModelRegistry.TargetEntry>, spec?: UpsertSpec): ObjList<ReliabilityModelRegistry.TargetEntry> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<ReliabilityModelRegistry.TargetEntry> | null>, spec?: UpsertSpec): ObjList<ReliabilityModelRegistry.TargetEntry> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<ReliabilityModelRegistry.TargetEntry>, srcObjs?: Array_Type<ReliabilityModelRegistry.TargetEntry>, spec?: UpsertSpec): ObjList<ReliabilityModelRegistry.TargetEntry> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<ReliabilityModelRegistry.TargetEntry> | null>, spec?: UpsertSpec): ObjList<ReliabilityModelRegistry.TargetEntry> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<ReliabilityModelRegistry.TargetEntry>, spec?: TouchSpec): ObjList<ReliabilityModelRegistry.TargetEntry> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityModelRegistry.TargetEntry>, spec?: MergeSpec): ObjList<ReliabilityModelRegistry.TargetEntry> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityModelRegistry.TargetEntry>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityModelRegistry.TargetEntry> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<ReliabilityModelRegistry.TargetEntry> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityModelRegistry.TargetEntry> | null;
     ...
     */
    static mergeAll(mergeObj: ReliabilityModelRegistry.TargetEntry, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: ReliabilityModelRegistry.TargetEntry, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<ReliabilityModelRegistry.TargetEntry>, spec?: UpsertSpec): ObjList<ReliabilityModelRegistry.TargetEntry> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<ReliabilityModelRegistry.TargetEntry>, spec?: UpsertSpec): ObjList<ReliabilityModelRegistry.TargetEntry> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): ReliabilityModelRegistry.TargetEntry | null;
     ...
     */
    static beforeCreate(objs: Array_Type<ReliabilityModelRegistry.TargetEntry>): ObjList<ReliabilityModelRegistry.TargetEntry>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<ReliabilityModelRegistry.TargetEntry>): ObjList<ReliabilityModelRegistry.TargetEntry>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<ReliabilityModelRegistry.TargetEntry>): ObjList<ReliabilityModelRegistry.TargetEntry>;
     ...
     */
    static afterCreate(objs: Array_Type<ReliabilityModelRegistry.TargetEntry>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<ReliabilityModelRegistry.TargetEntry>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<ReliabilityModelRegistry.TargetEntry>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityModelRegistry.TargetEntry>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityModelRegistry.TargetEntry>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): ReliabilityModelRegistry.TargetEntry | null;
     ...
     */
    withoutIdentity(): ReliabilityModelRegistry.TargetEntry | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<ReliabilityModelRegistry.TargetEntry>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: ReliabilityModelRegistry.TargetEntry, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<ReliabilityModelRegistry.TargetEntry>, callback?: λFunction<ReliabilityModelRegistry.TargetEntry | null, ReliabilityModelRegistry.TargetEntry | null>): ObjList<ReliabilityModelRegistry.TargetEntry>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<ReliabilityModelRegistry.TargetEntry>, callback?: λFunction<ReliabilityModelRegistry.TargetEntry | null, ReliabilityModelRegistry.TargetEntry | null>): Array_Type<ObjError> | null;
