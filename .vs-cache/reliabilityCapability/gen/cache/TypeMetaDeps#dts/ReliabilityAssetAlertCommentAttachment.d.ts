// TypeScript definitions for the C3 type ReliabilityAssetAlertCommentAttachment

/**
 * Type representing attachment on a {@link AlertComment}
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityAssetAlertCommentAttachment
 */
declare interface IReliabilityAssetAlertCommentAttachment {

  /**
   * The entity that is associated with the {@link File}
   */
  parent: IAlertComment;

  /**
   * The {@link FileMeta} of the {@link File}
   */
  fileMeta: IFileMeta;
 ...
 * Type representing attachment on a {@link AlertComment}
 *
 * @remarks this represents a made instance of ReliabilityAssetAlertCommentAttachment
 */
declare class ReliabilityAssetAlertCommentAttachment extends Obj  {

  /**
   * The entity that is associated with the {@link File}
   */
  readonly parent: AlertComment;
  withParent(parent: IAlertComment): ReliabilityAssetAlertCommentAttachment;

  /**
   * The {@link FileMeta} of the {@link File}
   */
  readonly fileMeta: FileMeta;
  withFileMeta(fileMeta: IFileMeta): ReliabilityAssetAlertCommentAttachment;
   ...
   */
  readonly id: string;
  withId(id: string): ReliabilityAssetAlertCommentAttachment;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityAssetAlertCommentAttachment;

  /**
   * Name of the file.
   */
  readonly name?: string;
  withName(name: string | null): ReliabilityAssetAlertCommentAttachment;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): ReliabilityAssetAlertCommentAttachment;
  ...
  withVersion(version: number | null): ReliabilityAssetAlertCommentAttachment;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): ReliabilityAssetAlertCommentAttachment;

  /**
   * @inheritdoc
   */
  readonly facilityFilterPaths?: Array_Type<string>;
  withFacilityFilterPaths(facilityFilterPaths: Array_Type<string> | Array<string> | null): ReliabilityAssetAlertCommentAttachment;

  /**
   * URL for this file.
   */
  readonly url?: string;
  withUrl(url: string | null): ReliabilityAssetAlertCommentAttachment;
   ...
   * @see #toJson
   */
  static fromJson(json: any): ReliabilityAssetAlertCommentAttachment | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): ReliabilityAssetAlertCommentAttachment | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): ReliabilityAssetAlertCommentAttachment | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): ReliabilityAssetAlertCommentAttachment | null;
   ...
   */
  replaceType(old: Type, new_: Type): ReliabilityAssetAlertCommentAttachment;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityAssetAlertCommentAttachment;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityAssetAlertCommentAttachment;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityAssetAlertCommentAttachment>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityAssetAlertCommentAttachment>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityAssetAlertCommentAttachment;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityAssetAlertCommentAttachment;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityAssetAlertCommentAttachment;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ReliabilityAssetAlertCommentAttachment;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ReliabilityAssetAlertCommentAttachment;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityAssetAlertCommentAttachment;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityAssetAlertCommentAttachment;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityAssetAlertCommentAttachment;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ReliabilityAssetAlertCommentAttachment;
   ...
   * @see #removeField
   */
  withoutField(field: string): ReliabilityAssetAlertCommentAttachment;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): ReliabilityAssetAlertCommentAttachment;
   ...
   */
  withoutFields(fields: Array_Type<string>): ReliabilityAssetAlertCommentAttachment;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityAssetAlertCommentAttachment;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ReliabilityAssetAlertCommentAttachment;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityAssetAlertCommentAttachment;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ReliabilityAssetAlertCommentAttachment;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ReliabilityAssetAlertCommentAttachment;
   ...
   * @see #removeField
   */
  unsetField(field: string): ReliabilityAssetAlertCommentAttachment;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ReliabilityAssetAlertCommentAttachment;
   ...
   * @see #unsetField
   */
  removeField(field: string): ReliabilityAssetAlertCommentAttachment;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ReliabilityAssetAlertCommentAttachment;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityAssetAlertCommentAttachment;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityAssetAlertCommentAttachment;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityAssetAlertCommentAttachment;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityAssetAlertCommentAttachment;

  mergeJson(json: any): ReliabilityAssetAlertCommentAttachment;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityAssetAlertCommentAttachment;
   ...
   */
  sumObj(other: Obj, deep?: boolean): ReliabilityAssetAlertCommentAttachment;
   ...
   */
  singletonArray(): Array_Type<ReliabilityAssetAlertCommentAttachment>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityAssetAlertCommentAttachment> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ReliabilityAssetAlertCommentAttachment> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<ReliabilityAssetAlertCommentAttachment>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ReliabilityAssetAlertCommentAttachment> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, ReliabilityAssetAlertCommentAttachment> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityAssetAlertCommentAttachment> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ReliabilityAssetAlertCommentAttachment>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ReliabilityAssetAlertCommentAttachment>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityAssetAlertCommentAttachment;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityAssetAlertCommentAttachment;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityAssetAlertCommentAttachment;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ReliabilityAssetAlertCommentAttachment;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityAssetAlertCommentAttachment;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ReliabilityAssetAlertCommentAttachment;
   ...
   * @see #fromString
   */
  static make(s: string): ReliabilityAssetAlertCommentAttachment | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityAssetAlertCommentAttachment;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): ReliabilityAssetAlertCommentAttachment;
   ...
   */
  static cachedEmptyInst(): ReliabilityAssetAlertCommentAttachment;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityAssetAlertCommentAttachment> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): ReliabilityAssetAlertCommentAttachment;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<ReliabilityAssetAlertCommentAttachment>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<ReliabilityAssetAlertCommentAttachment>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityAssetAlertCommentAttachment> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityAssetAlertCommentAttachment>> | null;
   ...
   */
  get(include?: string): ReliabilityAssetAlertCommentAttachment | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): ReliabilityAssetAlertCommentAttachment | null;
   ...
   */
  getMissing(spec: GetMissingSpec): ReliabilityAssetAlertCommentAttachment;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): ReliabilityAssetAlertCommentAttachment | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): ReliabilityAssetAlertCommentAttachment;
   ...
   * @see #toString
   */
  static fromString(s: string): ReliabilityAssetAlertCommentAttachment | null;
   ...
   */
  create(spec?: UpsertSpec): ReliabilityAssetAlertCommentAttachment | null;
   ...
   */
  static createBatch(objs: Array_Type<ReliabilityAssetAlertCommentAttachment>, spec?: UpsertSpec): ObjList<ReliabilityAssetAlertCommentAttachment> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<ReliabilityAssetAlertCommentAttachment>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityAssetAlertCommentAttachment> | null;
   ...
   */
  update(srcObj?: ReliabilityAssetAlertCommentAttachment, spec?: UpsertSpec): ReliabilityAssetAlertCommentAttachment | null;
   ...
   */
  upsert(srcObj?: ReliabilityAssetAlertCommentAttachment, spec?: UpsertSpec): ReliabilityAssetAlertCommentAttachment | null;
   ...
   */
  merge(spec?: MergeSpec): ReliabilityAssetAlertCommentAttachment | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): ReliabilityAssetAlertCommentAttachment | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): ReliabilityAssetAlertCommentAttachment | null;
   ...
   */
  static updateBatch(objs: Array_Type<ReliabilityAssetAlertCommentAttachment>, srcObjs?: Array_Type<ReliabilityAssetAlertCommentAttachment>, spec?: UpsertSpec): ObjList<ReliabilityAssetAlertCommentAttachment> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<ReliabilityAssetAlertCommentAttachment> | null>, spec?: UpsertSpec): ObjList<ReliabilityAssetAlertCommentAttachment> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<ReliabilityAssetAlertCommentAttachment>, srcObjs?: Array_Type<ReliabilityAssetAlertCommentAttachment>, spec?: UpsertSpec): ObjList<ReliabilityAssetAlertCommentAttachment> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<ReliabilityAssetAlertCommentAttachment> | null>, spec?: UpsertSpec): ObjList<ReliabilityAssetAlertCommentAttachment> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<ReliabilityAssetAlertCommentAttachment>, spec?: TouchSpec): ObjList<ReliabilityAssetAlertCommentAttachment> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityAssetAlertCommentAttachment>, spec?: MergeSpec): ObjList<ReliabilityAssetAlertCommentAttachment> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityAssetAlertCommentAttachment>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityAssetAlertCommentAttachment> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<ReliabilityAssetAlertCommentAttachment> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityAssetAlertCommentAttachment> | null;
   ...
   */
  static mergeAll(mergeObj: ReliabilityAssetAlertCommentAttachment, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: ReliabilityAssetAlertCommentAttachment, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<ReliabilityAssetAlertCommentAttachment>, spec?: UpsertSpec): ObjList<ReliabilityAssetAlertCommentAttachment> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<ReliabilityAssetAlertCommentAttachment>, spec?: UpsertSpec): ObjList<ReliabilityAssetAlertCommentAttachment> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): ReliabilityAssetAlertCommentAttachment | null;
   ...
   */
  static beforeCreate(objs: Array_Type<ReliabilityAssetAlertCommentAttachment>): ObjList<ReliabilityAssetAlertCommentAttachment>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<ReliabilityAssetAlertCommentAttachment>): ObjList<ReliabilityAssetAlertCommentAttachment>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<ReliabilityAssetAlertCommentAttachment>): ObjList<ReliabilityAssetAlertCommentAttachment>;
   ...
   */
  static afterCreate(objs: Array_Type<ReliabilityAssetAlertCommentAttachment>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<ReliabilityAssetAlertCommentAttachment>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<ReliabilityAssetAlertCommentAttachment>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityAssetAlertCommentAttachment>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityAssetAlertCommentAttachment>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): ReliabilityAssetAlertCommentAttachment | null;
   ...
   */
  withoutIdentity(): ReliabilityAssetAlertCommentAttachment | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<ReliabilityAssetAlertCommentAttachment>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: ReliabilityAssetAlertCommentAttachment, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<ReliabilityAssetAlertCommentAttachment>, callback?: λFunction<ReliabilityAssetAlertCommentAttachment | null, ReliabilityAssetAlertCommentAttachment | null>): ObjList<ReliabilityAssetAlertCommentAttachment>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<ReliabilityAssetAlertCommentAttachment>, callback?: λFunction<ReliabilityAssetAlertCommentAttachment | null, ReliabilityAssetAlertCommentAttachment | null>): Array_Type<ObjError> | null;
