// TypeScript definitions for the C3 type ReliabilityProtectionLoopConfig

/**
 * Configurations for Reliability Protection Loop logic.
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityProtectionLoopConfig
 */
declare interface IReliabilityProtectionLoopConfig {
  ...
  /**
   * Specifies the percentage of {@link Sensor}s greater than this value in a {@link ProtectionLoop} that need
   * an issue for a {@link ProtectionLoop} to be at medium risk. Value should be between 0 and 1 and less than
   * the high or equal to the {@link #highRiskPercentage}.
   */
  mediumRiskPercentage?: number;

  /**
   * Specifies the percentage of {@link Sensor}s greater than this value in a {@link ProtectionLoop} that need
   * an issue for a {@link ProtectionLoop} to be at high risk. Value should be between 0 and 1.
   */
  highRiskPercentage?: number;

  /**
   * The lookback period for evaluating sensor protection loop low-low and high-high threshold logic.
   */
  highLowLookbackPeriod?: IPeriod;

  /**
   * The amount of time that needs to have passed for {@link ProtectionLoopAlert}s to be automatically closed.
   */
  protectionLoopAlertClosePeriod?: IPeriod;
}

/**
 * Configurations for Reliability Protection Loop logic.
 *
 * @remarks this represents a made instance of ReliabilityProtectionLoopConfig
 */
declare class ReliabilityProtectionLoopConfig extends Obj  {

  readonly configOverride?: string;
  withConfigOverride(configOverride: string | null): ReliabilityProtectionLoopConfig;

  static readonly configOverride?: string;

  readonly secretOverride?: string;
  withSecretOverride(secretOverride: string | null): ReliabilityProtectionLoopConfig;
  ...
  withIssues(issues: Array_Type<string> | Array<string> | null): ReliabilityProtectionLoopConfig;
   ...
   * the high or equal to the {@link #highRiskPercentage}.
   */
  readonly mediumRiskPercentage?: number;
  withMediumRiskPercentage(mediumRiskPercentage: number | null): ReliabilityProtectionLoopConfig;
   ...
   * the high or equal to the {@link #highRiskPercentage}.
   */
  static readonly mediumRiskPercentage?: number;

  /**
   * Specifies the percentage of {@link Sensor}s greater than this value in a {@link ProtectionLoop} that need
   * an issue for a {@link ProtectionLoop} to be at high risk. Value should be between 0 and 1.
   */
  readonly highRiskPercentage?: number;
  withHighRiskPercentage(highRiskPercentage: number | null): ReliabilityProtectionLoopConfig;

  /**
   * Specifies the percentage of {@link Sensor}s greater than this value in a {@link ProtectionLoop} that need
   * an issue for a {@link ProtectionLoop} to be at high risk. Value should be between 0 and 1.
   */
  static readonly highRiskPercentage?: number;

  /**
   * The lookback period for evaluating sensor protection loop low-low and high-high threshold logic.
   */
  readonly highLowLookbackPeriod?: Period;
  withHighLowLookbackPeriod(highLowLookbackPeriod: IPeriod | null): ReliabilityProtectionLoopConfig;

  /**
   * The lookback period for evaluating sensor protection loop low-low and high-high threshold logic.
   */
  static readonly highLowLookbackPeriod?: Period;

  /**
   * The amount of time that needs to have passed for {@link ProtectionLoopAlert}s to be automatically closed.
   */
  readonly protectionLoopAlertClosePeriod?: Period;
  withProtectionLoopAlertClosePeriod(protectionLoopAlertClosePeriod: IPeriod | null): ReliabilityProtectionLoopConfig;

  /**
   * The amount of time that needs to have passed for {@link ProtectionLoopAlert}s to be automatically closed.
   */
  static readonly protectionLoopAlertClosePeriod?: Period;
   ...
   * @see #toJson
   */
  static fromJson(json: any): ReliabilityProtectionLoopConfig | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): ReliabilityProtectionLoopConfig | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): ReliabilityProtectionLoopConfig | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): ReliabilityProtectionLoopConfig | null;
   ...
   */
  replaceType(old: Type, new_: Type): ReliabilityProtectionLoopConfig;
   ...
   * This method is used during live metadata update
   */
  static replaceType(old: Type, new_: Type): ReliabilityProtectionLoopConfig;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityProtectionLoopConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityProtectionLoopConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityProtectionLoopConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityProtectionLoopConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityProtectionLoopConfig>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityProtectionLoopConfig>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityProtectionLoopConfig>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityProtectionLoopConfig>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityProtectionLoopConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityProtectionLoopConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityProtectionLoopConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityProtectionLoopConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityProtectionLoopConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityProtectionLoopConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ReliabilityProtectionLoopConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  static validateObj(): ReliabilityProtectionLoopConfig;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ReliabilityProtectionLoopConfig;
   ...
   * @see #defaultField
   */
  static withField(field: string, value: any, doNotConvert?: boolean): ReliabilityProtectionLoopConfig;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityProtectionLoopConfig;
   ...
   * @see #defaultField
   */
  static withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityProtectionLoopConfig;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityProtectionLoopConfig;
   ...
   * @return new Obj
   */
  static withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityProtectionLoopConfig;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityProtectionLoopConfig;
   ...
   * @return new Obj
   */
  static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityProtectionLoopConfig;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ReliabilityProtectionLoopConfig;
   ...
   * @see #withoutField
   */
  static withoutFieldAtPath(path: string): ReliabilityProtectionLoopConfig;
   ...
   * @see #removeField
   */
  withoutField(field: string): ReliabilityProtectionLoopConfig;
   ...
   * @see #removeField
   */
  static withoutField(field: string): ReliabilityProtectionLoopConfig;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): ReliabilityProtectionLoopConfig;
   ...
   * @see #removeField
   */
  static withoutField(field: FieldType): ReliabilityProtectionLoopConfig;
   ...
   */
  withoutFields(fields: Array_Type<string>): ReliabilityProtectionLoopConfig;
   ...
   * @return new Obj with removed fields
   */
  static withoutFields(fields: Array_Type<string>): ReliabilityProtectionLoopConfig;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityProtectionLoopConfig;
   ...
   * @return new Obj with removed fields
   */
  static withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityProtectionLoopConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ReliabilityProtectionLoopConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  static withoutSecretFields(): ReliabilityProtectionLoopConfig;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityProtectionLoopConfig;
   ...
   * @see FieldType#defaultValue
   */
  static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityProtectionLoopConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ReliabilityProtectionLoopConfig;
   ...
   * @see #unsetField
   */
  static defaultField(field: string): ReliabilityProtectionLoopConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ReliabilityProtectionLoopConfig;
   ...
   * @see #unsetField
   */
  static defaultField(field: FieldType): ReliabilityProtectionLoopConfig;
   ...
   * @see #removeField
   */
  unsetField(field: string): ReliabilityProtectionLoopConfig;
   ...
   * @see #removeField
   */
  static unsetField(field: string): ReliabilityProtectionLoopConfig;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ReliabilityProtectionLoopConfig;
   ...
   * @see #removeField
   */
  static unsetField(field: FieldType): ReliabilityProtectionLoopConfig;
   ...
   * @see #unsetField
   */
  removeField(field: string): ReliabilityProtectionLoopConfig;
   ...
   * @see #unsetField
   */
  static removeField(field: string): ReliabilityProtectionLoopConfig;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ReliabilityProtectionLoopConfig;
   ...
   * @see #unsetField
   */
  static removeField(field: FieldType): ReliabilityProtectionLoopConfig;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityProtectionLoopConfig;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityProtectionLoopConfig;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityProtectionLoopConfig;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityProtectionLoopConfig;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityProtectionLoopConfig;
   ...
   *        the same key or index.
   */
  static mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityProtectionLoopConfig;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityProtectionLoopConfig;
   ...
   * traverse child reference and collection fields.
   */
  static mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityProtectionLoopConfig;

  mergeJson(json: any): ReliabilityProtectionLoopConfig;

  static mergeJson(json: any): ReliabilityProtectionLoopConfig;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityProtectionLoopConfig;
   ...
   * @return Obj with child references merged
   */
  static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityProtectionLoopConfig;
   ...
   */
  sumObj(other: Obj, deep?: boolean): ReliabilityProtectionLoopConfig;
   ...
   * references with same name and collection elements at same index or key.
   */
  static sumObj(other: Obj, deep?: boolean): ReliabilityProtectionLoopConfig;
   ...
   */
  singletonArray(): Array_Type<ReliabilityProtectionLoopConfig>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonArray(): Array_Type<ReliabilityProtectionLoopConfig>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityProtectionLoopConfig> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ReliabilityProtectionLoopConfig> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<ReliabilityProtectionLoopConfig>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonSet(): Set_Type<ReliabilityProtectionLoopConfig>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ReliabilityProtectionLoopConfig> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, ReliabilityProtectionLoopConfig> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityProtectionLoopConfig> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ReliabilityProtectionLoopConfig>;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  static toBuilder(): ObjBuilder<ReliabilityProtectionLoopConfig>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ReliabilityProtectionLoopConfig>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityProtectionLoopConfig;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityProtectionLoopConfig;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityProtectionLoopConfig;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ReliabilityProtectionLoopConfig;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityProtectionLoopConfig;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ReliabilityProtectionLoopConfig;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityProtectionLoopConfig;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): ReliabilityProtectionLoopConfig;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  static afterMake(): ReliabilityProtectionLoopConfig;
   ...
   */
  static cachedEmptyInst(): ReliabilityProtectionLoopConfig;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityProtectionLoopConfig> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): ReliabilityProtectionLoopConfig;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<ReliabilityProtectionLoopConfig> | null;
   ...
   */
  static find(filter?: string, doNotProduceAll?: boolean): Stream<ReliabilityProtectionLoopConfig> | null;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<ReliabilityProtectionLoopConfig> | null;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): ReliabilityProtectionLoopConfig | null;

  /**
   * Returns cached instance by key, with secrets removed.
   */
  static forCacheKey(key: string): ReliabilityProtectionLoopConfig | null;
   ...
   * @see findByCacheKey
   */
  getCached(): ReliabilityProtectionLoopConfig | null;
   ...
   * @see findByCacheKey
   */
  static getCached(): ReliabilityProtectionLoopConfig | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): ReliabilityProtectionLoopConfig | null;

  /**
   * @return newly produced cached instance.
   */
  static refreshCache(): ReliabilityProtectionLoopConfig | null;
   ...
   */
  static produce(key: string): ReliabilityProtectionLoopConfig | null;
   ...
   */
  static produceAll(): Map_Type<string, ReliabilityProtectionLoopConfig> | null;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): Map_Type<string, ReliabilityProtectionLoopConfig> | null;
   ...
   */
  getConfig(): ReliabilityProtectionLoopConfig;
   ...
   * Note that typical pattern is to use Configurable#config instead of this method.
   */
  static getConfig(): ReliabilityProtectionLoopConfig;
   ...
   */
  getSecret(): ReliabilityProtectionLoopConfig;
   ...
   * Note that typical pattern is to use Configurable#configWithSecrets instead of this method.
   */
  static getSecret(): ReliabilityProtectionLoopConfig;
   ...
   */
  withConfigKey(configKey: string): ReliabilityProtectionLoopConfig;
   ...
   *     config.configKey() => "folder1/abc"
   */
  static withConfigKey(configKey: string): ReliabilityProtectionLoopConfig;

  /**
   * @return copy without config key.
   */
  withoutConfigKey(): ReliabilityProtectionLoopConfig;

  /**
   * @return copy without config key.
   */
  static withoutConfigKey(): ReliabilityProtectionLoopConfig;

  /**
   * @return return cached config instance for provided config key.
   */
  static forConfigKey(configKey: string): ReliabilityProtectionLoopConfig | null;
   ...
   */
  static listConfigs(parallel?: boolean, filter?: λPredicate<string>): Stream<ReliabilityProtectionLoopConfig> | null;
   ...
   * @see setConfigValue
   */
  setConfigValues(from: ReliabilityProtectionLoopConfig, override?: string): void;

  /**
   * Sets multiple field values to be the same as the passed instance.
   * @see setConfigValue
   */
  static setConfigValues(from: ReliabilityProtectionLoopConfig, override?: string): void;
   ...
   * @see setSecretValue
   */
  setSecretValues(from: ReliabilityProtectionLoopConfig, override?: string): void;

  /**
   * Sets multiple secret field values to be the same as the passed instance.
   * @see setSecretValue
   */
  static setSecretValues(from: ReliabilityProtectionLoopConfig, override?: string): void;
   ...
   */
  static loadConfigAndSecret(configKey: string): ReliabilityProtectionLoopConfig | null;
   ...
   */
  removeSecrets(): ReliabilityProtectionLoopConfig | null;

  /**
   * @return this config without any secret values.
   */
  static removeSecrets(): ReliabilityProtectionLoopConfig | null;

  /**
   * @return this config with only secret values.
   */
  removeNonSecrets(): ReliabilityProtectionLoopConfig | null;

  /**
   * @return this config with only secret values.
   */
  static removeNonSecrets(): ReliabilityProtectionLoopConfig | null;

  /**
   * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
   * validation and setup.
   */
  validate(): ReliabilityProtectionLoopConfig;

  /**
   * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
   * validation and setup.
   */
  static validate(): ReliabilityProtectionLoopConfig;
   ...
   */
  static inst(): ReliabilityProtectionLoopConfig;

  /**
   * @return the cached instance if already cached, null otherwise. Does not instantiate if missing.
   */
  static cachedInst(): ReliabilityProtectionLoopConfig | null;
}
