...
from c3.reliabilityCapability.AlertComment import AlertComment
...
from c3.reliabilityCapability.ReliabilityReport import ReliabilityReport
from c3.reliabilityCapability.ReliabilityReportSpec import ReliabilityReportSpec
...
from c3.reliabilityCapability.ReliabilityAssetAlertStateTransition import ReliabilityAssetAlertStateTransition
from c3.platform.SetBuilder import SetBuilder
...
from c3.reliabilityMl.ReliabilityAssetAlertFeedback import ReliabilityAssetAlertFeedback
from c3.platform.EvalMetricsResult import EvalMetricsResult
from c3.platform.Transaction import Transaction
from c3.reliabilityCapability.FeatureFetchBaseSpec import FeatureFetchBaseSpec
from c3.platform.RefreshBatchJob import RefreshBatchJob
from c3.platform.Obj.MakeSpec import Obj.MakeSpec
from c3.platform.BatchFetchSpec import BatchFetchSpec
from c3.reliabilityCapability.ReliabilityAssetAlertStateHistory import ReliabilityAssetAlertStateHistory
from c3.platform.EvalMetricsBatchCacheSize import EvalMetricsBatchCacheSize
from c3.platform.DblRange import DblRange
...
from c3.reliabilityAssetCase.ReliabilityAssetCase import ReliabilityAssetCase
from c3.platform.FieldPath import FieldPath
from c3.platform.StreamType import StreamType
from c3.stateMachineWorkflow.StateMachineTransitionStatus import StateMachineTransitionStatus
from c3.platform.Promise import Promise
...
from c3.reliabilityCapability.ReliabilityAssetAlertSimilarityLarge import ReliabilityAssetAlertSimilarityLarge
...
from c3.reliabilityCapability.ReliabilityAssetAlertState import ReliabilityAssetAlertState
...
from c3.reliabilityCapability.ReliabilityAssetAlertSimilaritySmall import ReliabilityAssetAlertSimilaritySmall
from c3.platform.HistogramEvaluationResult import HistogramEvaluationResult
from c3.reliabilityAssetCase.ReliabilityAssetAlertToCaseRelation import ReliabilityAssetAlertToCaseRelation
from c3.platform.ValidateObjResult import ValidateObjResult
from c3.platform.Promise import Promise
from c3.reliabilityCapability.PrecomputedFeatures import PrecomputedFeatures
...
from c3.platform.FetchResult import FetchResult
from c3.reliabilityCapability.ReliabilityAssetAlertReopenSpec import ReliabilityAssetAlertReopenSpec
from c3.platform.ExistsSpec import ExistsSpec
from c3.platform.PushStream import PushStream

# Python definitions for the C3 type ReliabilityAssetAlert


class ReliabilityAssetAlert(ReliabilityAssetAlertBase, FeatureEvaluatable, FilterableByFacility, ReliabilityReportHelper[ReliabilityReportSpec, ReliabilityReport], StateMachine[ReliabilityAssetAlertStateHistory, ReliabilityAssetAlertState, ReliabilityAssetAlertStateTransition]):
    """
    @inheritdoc
    
    @remarks this represents a made instance of ReliabilityAssetAlert
    """
    ...
    precomputedFeatures: Optional[PrecomputedFeatures]=None
    """
    The precomputed features for this entity.
    """

    isValidationType: Optional[bool]=None
    """
    Whether this entity is a model validation type. These types use a different part of the data model to query
    feature data. This should be overriden by types that mix {@link WithPrecomputedFeatures} if necessary.
    """

    parent: Optional[ReliabilityAsset]
    """
    The {@link ReliabilityAsset} linked to this alert.
    """

    triggeringModel: Optional[ReliabilityMlModel]=None
    """
    The {@link ReliabilityMlModel} which triggered this alert.
    """

    triggeringModelId: Optional[str]=None
    """
    The id of the {@link ReliabilityAssetAlert#triggeringModel}.
    """

    featureContributionMap: Optional[Map[str, float]]=None
    """
    Direct mapping of feature name to value based off of the feature contributions associated with the alert.
    These feature contributions are normalized and they add up to 1.
    They are displayed on the contributions grid on the alert detail page.
    """

    primaryModelOutput: Optional[ReliabilityAssetAlert.ModelOutput]=None
    """
    A field capturing information about the model output for the {@link timestamp} that the alert is raised.
    Supports multiple formats for display in the UI.
    """

    allPrimaryModelOutputs: Optional[Map[str, ReliabilityAssetAlert.ModelOutput]]=None
    """
    A field capturing information about the model output for the {@link timestamp} that the alert is raised.
    Supports multiple formats for display in the UI.
    """
    ...
    currentState: Optional[ReliabilityAssetAlertState]=None
    """
    A stored calc field representing the current state - uses a {@link StateMachineHistory} to keep track.
    """

    stateHistories: Optional[Array[ReliabilityAssetAlertStateHistory]]=None
    """
    A collection of the states this {@link StateMachine} has passed through.
    """

    transitions: Optional[Array[ReliabilityAssetAlertStateTransition]]=None
    """
    Transitions available from the current state
    """

    currentStateHistory: Optional[ReliabilityAssetAlertStateHistory]=None
    """
    ...
    caseRelations: Optional[Array[ReliabilityAssetAlertToCaseRelation]]=None
    """
    The {@link ReliabilityAssetAlertToCaseRelation}s on this alert.
    """

    feedback: Optional[Array[ReliabilityAssetAlertFeedback]]=None
    """
    {@link ReliabilityAssetAlertFeedback} associated with this alert.
    """

    displayMostRecentFeedbackCategory: Optional[str]=None
    """
    This field is used by the UI to show the translated value of {@link mostRecentFeedbackCategory}.
    """

    cases: Optional[Array[ReliabilityAssetCase]]=None
    """
    The {@link ReliabilityAssetCase}s on this alert.
    """

    comments: Optional[Array[AlertComment]]=None
    """
    The comments associated with the current Alert
    """

    displayedTriggerDate: Optional[str]=None
    """
    Date displayed in the UI for when the alert was triggered.
    """

    relatedCase: Optional[ReliabilityAssetCase]=None
    """
    Case to be used for related cases and alerts.
    """

    mostRecentFeedbackCategory: Optional[str]=None
    """
    {@link ReliabilityAssetAlertFeedback}'s' recent category associated with this alert.
    """

    notClosedCaseRelations: Optional[Array[ReliabilityAssetAlertToCaseRelation]]=None
    """
    The {@link ReliabilityAssetAlertToCaseRelation}s with a not `Closed` {@link ReliabilityAssetCase}s in this alert.
    """

    notClosedCases: Optional[Array[ReliabilityAssetCase]]=None
    """
    The currently `Open` {@link ReliabilityAssetCase}s in this alert.
    """

    displayedMlProject: Optional[str]=None
    """
    Type of the alert. Eg: Reliability Risk.
    """
    def __init__(self, timestamp: Optional[datetime]=None, id: Optional[str]=None, versionEdits: Optional[Array[VersionEdit]]=None, name: Optional[str]=None, meta: Optional[Meta]=None, version: Optional[int]=None, typeWithBindings: Optional[Type]=None, precomputedFeatures: Optional[PrecomputedFeatures]=None, isValidationType: Optional[bool]=None, parent: Optional[ReliabilityAsset]=None, triggeringModel: Optional[ReliabilityMlModel]=None, triggeringModelId: Optional[str]=None, featureContributionMap: Optional[Map[str, float]]=None, primaryModelOutput: Optional[ReliabilityAssetAlert.ModelOutput]=None, allPrimaryModelOutputs: Optional[Map[str, ReliabilityAssetAlert.ModelOutput]]=None, facilityFilterPaths: Optional[Array[str]]=None, currentState: Optional[ReliabilityAssetAlertState]=None, stateHistories: Optional[Array[ReliabilityAssetAlertStateHistory]]=None, transitions: Optional[Array[ReliabilityAssetAlertStateTransition]]=None, currentStateHistory: Optional[ReliabilityAssetAlertStateHistory]=None, typeIdent: Optional[str]=None, caseRelations: Optional[Array[ReliabilityAssetAlertToCaseRelation]]=None, feedback: Optional[Array[ReliabilityAssetAlertFeedback]]=None, displayMostRecentFeedbackCategory: Optional[str]=None, cases: Optional[Array[ReliabilityAssetCase]]=None, comments: Optional[Array[AlertComment]]=None, displayedTriggerDate: Optional[str]=None, relatedCase: Optional[ReliabilityAssetCase]=None, mostRecentFeedbackCategory: Optional[str]=None, notClosedCaseRelations: Optional[Array[ReliabilityAssetAlertToCaseRelation]]=None, notClosedCases: Optional[Array[ReliabilityAssetCase]]=None, displayedMlProject: Optional[str]=None) -> None: ...
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[ReliabilityAssetAlert]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[ReliabilityAssetAlert]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[ReliabilityAssetAlert]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[ReliabilityAssetAlert]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> ReliabilityAssetAlert:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> ReliabilityAssetAlert:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> ReliabilityAssetAlert:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[ReliabilityAssetAlert]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[ReliabilityAssetAlert]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> ReliabilityAssetAlert:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> ReliabilityAssetAlert:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> ReliabilityAssetAlert:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> ReliabilityAssetAlert:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> ReliabilityAssetAlert:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> ReliabilityAssetAlert:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> ReliabilityAssetAlert:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> ReliabilityAssetAlert:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> ReliabilityAssetAlert:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> ReliabilityAssetAlert:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> ReliabilityAssetAlert:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> ReliabilityAssetAlert:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> ReliabilityAssetAlert:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> ReliabilityAssetAlert:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> ReliabilityAssetAlert:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> ReliabilityAssetAlert:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> ReliabilityAssetAlert:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> ReliabilityAssetAlert:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> ReliabilityAssetAlert:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> ReliabilityAssetAlert:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> ReliabilityAssetAlert:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> ReliabilityAssetAlert:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> ReliabilityAssetAlert:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> ReliabilityAssetAlert:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> ReliabilityAssetAlert:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> ReliabilityAssetAlert:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> ReliabilityAssetAlert:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> ReliabilityAssetAlert:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[ReliabilityAssetAlert]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[ReliabilityAssetAlert]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[ReliabilityAssetAlert]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[ReliabilityAssetAlert]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[ReliabilityAssetAlert]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, ReliabilityAssetAlert]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, ReliabilityAssetAlert]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[ReliabilityAssetAlert]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[ReliabilityAssetAlert]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> ReliabilityAssetAlert:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> ReliabilityAssetAlert:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> ReliabilityAssetAlert:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> ReliabilityAssetAlert:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> ReliabilityAssetAlert:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> ReliabilityAssetAlert:
    """
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[ReliabilityAssetAlert]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> ReliabilityAssetAlert:
    """
    ...
    """
        ...
    def afterMake(self) -> ReliabilityAssetAlert:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> ReliabilityAssetAlert:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[ReliabilityAssetAlert]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> ReliabilityAssetAlert:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, spec: FetchSpec=None) -> FetchResult[ReliabilityAssetAlert]:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, filter: Filter) -> FetchResult[ReliabilityAssetAlert]:
    """
    ...
    """
        ...
    @classmethod
    def fetchObjStream(cls, spec: FetchStreamSpec=None) -> Union[Stream[ReliabilityAssetAlert]]:
    """
    Fetches multiple obj instances based on a specification.  Only objs that the caller is authorized to fetch will be
    returned.
    ...
    """
        ...
    @classmethod
    def fetchMultiLocale(cls, spec: MultiLocaleFetchSpec=None) -> Union[Map[str, FetchResult[ReliabilityAssetAlert]]]:
    """
    ...
    """
        ...
    def get(self, include: str=None) -> Union[ReliabilityAssetAlert]:
    """
    ...
    """
        ...
    def getSpecific(self, include: str=None) -> Union[ReliabilityAssetAlert]:
    """
    ...
    """
        ...
    def getMissing(self, spec: GetMissingSpec) -> ReliabilityAssetAlert:
    """
    ...
    """
        ...
    def getDirect(self, include: str=None) -> Union[ReliabilityAssetAlert]:
    """
    ...
    """
        ...
    def applyReverseEdit(self, versionEdit: VersionEdit) -> ReliabilityAssetAlert:
    """
    ...
    """
        ...
    @classmethod
    def fromString(cls, s: str) -> Union[ReliabilityAssetAlert]:
    """
    ...
    """
        ...
    def create(self, spec: UpsertSpec=None) -> Union[ReliabilityAssetAlert]:
    """
    ...
    """
        ...
    @classmethod
    def createBatch(cls, objs: Array[ReliabilityAssetAlert], spec: UpsertSpec=None) -> Union[ObjList[ReliabilityAssetAlert]]:
    """
    ...
    """
        ...
    @classmethod
    def createBatchObjStream(cls, objs: Stream[ReliabilityAssetAlert], spec: CreateBatchObjStreamSpec=None) -> Union[ObjList[ReliabilityAssetAlert]]:
    """
    Creates multiple instances of a C3 type. If the operation fails and {@link UpsertSpec#dontThrowOnBatchError} is not
    specified (the default), then a C3BatchException will be thrown.  Otherwise {@link errors will be reported in the
    returned {@link ObjList}.  This will fail if any of the instances already exist.
    ...
    """
        ...
    def update(self, srcObj: ReliabilityAssetAlert=None, spec: UpsertSpec=None) -> Union[ReliabilityAssetAlert]:
    """
    ...
    """
        ...
    def upsert(self, srcObj: ReliabilityAssetAlert=None, spec: UpsertSpec=None) -> Union[ReliabilityAssetAlert]:
    """
    ...
    """
        ...
    @overload
    def merge(self, spec: MergeSpec=None) -> Union[ReliabilityAssetAlert]:
    """
    ...
    """
        ...
    @overload
    def merge(self, mergeInclude: str, spec: MergeSpec=None) -> Union[ReliabilityAssetAlert]:
    """
    ...
    """
        ...
    def touch(self, spec: TouchSpec=None) -> Union[ReliabilityAssetAlert]:
    """
    ...
    """
        ...
    @classmethod
    def updateBatch(cls, objs: Array[ReliabilityAssetAlert], srcObjs: Array[ReliabilityAssetAlert]=None, spec: UpsertSpec=None) -> Union[ObjList[ReliabilityAssetAlert]]:
    """
    ...
    """
        ...
    @classmethod
    def updateObjs(cls, objs: Callable[[], Union[Array[ReliabilityAssetAlert]]], spec: UpsertSpec=None) -> Union[ObjList[ReliabilityAssetAlert]]:
    """
    ...
    """
        ...
    @classmethod
    def upsertBatch(cls, objs: Array[ReliabilityAssetAlert], srcObjs: Array[ReliabilityAssetAlert]=None, spec: UpsertSpec=None) -> Union[ObjList[ReliabilityAssetAlert]]:
    """
    ...
    """
        ...
    @classmethod
    def upsertObjs(cls, objs: Callable[[], Union[Array[ReliabilityAssetAlert]]], spec: UpsertSpec=None) -> Union[ObjList[ReliabilityAssetAlert]]:
    """
    Creates instances of a C3 type if they don't already exist and updates them if they do exist. If the operation
    ...
    """
        ...
    @classmethod
    def touchBatch(cls, objs: Array[ReliabilityAssetAlert], spec: TouchSpec=None) -> Union[ObjList[ReliabilityAssetAlert]]:
    """
    ...
    @overload
    @classmethod
    def mergeBatch(cls, objs: Array[ReliabilityAssetAlert], spec: MergeSpec=None) -> Union[ObjList[ReliabilityAssetAlert]]:
    """
    ...
    @overload
    @classmethod
    def mergeBatch(cls, objs: Array[ReliabilityAssetAlert], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[ReliabilityAssetAlert]]:
    """
    Merges multiple instances of a C3 type or creates them if they don't exist. If the operation fails and {@link
    UpsertSpec#dontThrowOnBatchError} is not specified (the default), then a C3BatchException will be thrown.
    Otherwise errors will be reported in the returned {@link ObjList}.  The merge operation is described in the {@link
    ...
    """
        ...
    @classmethod
    def mergeObjs(cls, objs: Callable[[], Union[Array[ReliabilityAssetAlert]]], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[ReliabilityAssetAlert]]:
    """
    ...
    @overload
    @classmethod
    def mergeAll(cls, mergeObj: ReliabilityAssetAlert, spec: MergeAllSpec=None) -> Union[int]:
    """
    ...
    @overload
    @classmethod
    def mergeAll(cls, mergeObj: ReliabilityAssetAlert, mergeInclude: str, spec: MergeAllSpec=None) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def removeBatch(cls, objs: Array[ReliabilityAssetAlert], spec: UpsertSpec=None) -> Union[ObjList[ReliabilityAssetAlert]]:
    """
    ...
    """
        ...
    @classmethod
    def replace(cls, objs: Array[ReliabilityAssetAlert], spec: UpsertSpec=None) -> Union[ObjList[ReliabilityAssetAlert]]:
    """
    ...
    """
        ...
    def unremove(self) -> Union[ReliabilityAssetAlert]:
    """
    ...
    """
        ...
    @classmethod
    def beforeCreate(cls, objs: Array[ReliabilityAssetAlert]) -> ObjList[ReliabilityAssetAlert]:
    """
    See {@link PersistableWritable#beforeCreate}
    """
        ...
    @classmethod
    def beforeUpdate(cls, objs: Array[ReliabilityAssetAlert]) -> ObjList[ReliabilityAssetAlert]:
    """
    ...
    """
        ...
    @classmethod
    def beforeRemove(cls, objs: Array[ReliabilityAssetAlert]) -> ObjList[ReliabilityAssetAlert]:
    """
    ...
    """
        ...
    @classmethod
    def afterCreate(cls, objs: Array[ReliabilityAssetAlert]) -> Union[Array[ObjError]]:
    """
    See {@link PersistableWritable#afterCreate}
    """
        ...
    @classmethod
    def afterUpdate(cls, objs: Array[ReliabilityAssetAlert]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def afterRemove(cls, objs: Array[ReliabilityAssetAlert]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def startImportData(cls, spec: StartImportDataSpec=None) -> PushStream[ReliabilityAssetAlert]:
    """
    @return a push stream to import instances of this type.
    """
        ...
    @classmethod
    def startImportDataWithStats(cls, spec: StartImportDataSpec=None) -> PushStreamWithStats[ReliabilityAssetAlert]:
    """
    @return a push stream to import instances of this type.
    """
        ...
    ...
    """
        ...
    @classmethod
    def forId(cls, id: str, failIfMissing: bool=None) -> Union[ReliabilityAssetAlert]:
    """
    ...
    """
        ...
    def withoutIdentity(self) -> Union[ReliabilityAssetAlert]:
    """
    ...
    """
        ...
    @classmethod
    def typeOfBatch(cls, objs: Array[ReliabilityAssetAlert]) -> Union[Array[EntityType]]:
    """
    ...
    """
        ...
    @classmethod
    def dbEcho(cls, template: ReliabilityAssetAlert=None, count: int=None, sendBack: bool=None) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def callbackLogic(cls, objs: Array[ReliabilityAssetAlert], callback: Callable[[Union[ReliabilityAssetAlert]], Union[ReliabilityAssetAlert]]=None) -> ObjList[ReliabilityAssetAlert]:
    """
    ...
    """
        ...
    @classmethod
    def afterCallbackLogic(cls, objs: Array[ReliabilityAssetAlert], callback: Callable[[Union[ReliabilityAssetAlert]], Union[ReliabilityAssetAlert]]=None) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    def fetchFeaturesWithPrecomputedFeatures(self, spec: FeatureFetchBaseSpec=None) -> Union[FetchResultWithTotalCount[FeatureFetchBase]]:
    """
    Returns the same output as {@link FeatureFetchBase#fetchFeatures}, but reduces the data fetched from Cassandra
    by using the {@link #precomputedFeatures}. See {@link FeatureFetchBase#fetchFeatures} for more details on
    parameters and output.
    
    `featureNames`, `assetId`, and `modelId` are required to be the same every single time this function is called for
    this entity. `contributionMap` should not change either, however it is unused after the first time `contribution`
    is cached in the {@link #precomputedFeatures}
    
    {@link FeatureFetchBaseSpec#isValidation} is not utilized by this function.
    """
        ...
    def fetchFeatureNames(self) -> Union[Array[str]]:
    """
    Gets all the relevant feature names for this alert.
    
    @return The feature names of this alert.
    """
        ...
    def fetchFeatures(self, spec: FetchSpec=None, failureModeIds: Array[str]=None) -> Union[FetchResultWithTotalCount[FeatureFetchBase]]:
    """
    Fetches the features for a particular alert based on its {@link #triggeringModel}. Utilizes
    {@link #featureContributionMap} for fetching contributions if available.
    
    This function uses {@link WithPrecomputedFeatures#precomputedFeatures} to store precomputedFeatures. If the
    result is not updating as expected, remove {@link PrecomputedFeatures} instances.
    
    @param spec
           The specification for the features to fetch. See {@link FeatureFetchBase#fetchFeatures} for more details
           on what the `spec` parameter can contain.
    @param failureModeIds
           The failure mode ids to filter the features by.
    
    @returns {@link FetchResultWithTotalCount<FeatureFetchBase>}
       A result containing the fetched features along with a total count of matches.
    """
        ...
    ...
    @overload
    @classmethod
    def evalFeatureSetBatch(cls, batch: Array[ReliabilityAssetAlert], featureSet: Feature.Set, spec: EvalFeatureSpec=None) -> Union[Data]:
    """
    ...
    @overload
    @classmethod
    def evalFeaturesBatch(cls, batch: Array[ReliabilityAssetAlert], features: Array[str], spec: EvalFeaturesSpec=None) -> Union[Data]:
    """
    ...
    """
        ...
    def generateReport(self, reportSpec: ReliabilityReportSpec) -> Union[ReliabilityReportResult]:
    """
    ...
    """
        ...
    def generateReportEntity(self, reportSpec: ReliabilityReportSpec) -> Union[ReliabilityReport]:
    """
    @inheritdoc
    """
        ...
    @classmethod
    def transitionBatch(cls, stateMachines: Array[ReliabilityAssetAlert], toState: ReliabilityAssetAlertState, retry: int=None, stateHistoryParams: ReliabilityAssetAlertStateHistory=None) -> Array[StateMachineTransitionStatus[ReliabilityAssetAlertStateHistory, ReliabilityAssetAlertStateTransition]]:
    """
    Transition an array of state machines to a new state
    """
        ...
    def transition(self, toState: ReliabilityAssetAlertState, testOnly: bool=None, stateHistoryParams: ReliabilityAssetAlertStateHistory=None) -> StateMachineTransitionStatus[ReliabilityAssetAlertStateHistory, ReliabilityAssetAlertStateTransition]:
    """
    ...
    """
        ...
    def checkTransition(self, toState: ReliabilityAssetAlertState) -> bool:
    """
    ...
    """
        ...
    def possibleStates(self) -> Union[Array[ReliabilityAssetAlertState]]:
    """
    ...
    """
        ...
    @classmethod
    def allStates(cls) -> Union[Array[ReliabilityAssetAlertState]]:
    """
    Return list of all states in the {@link StateMachine}.
    """
        ...
    def possibleTransitions(self) -> Union[Array[ReliabilityAssetAlertStateTransition]]:
    """
    Return list of transitions possible from the current state given the current user permissions and current conditions.
    """
        ...
    @classmethod
    def allTransitions(cls, fromState: ReliabilityAssetAlertState=None, toState: ReliabilityAssetAlertState=None) -> Union[Array[ReliabilityAssetAlertStateTransition]]:
    """
    ...
    """
        ...
    def forceTransition(self, toState: ReliabilityAssetAlertState, stateHistoryParams: ReliabilityAssetAlertStateHistory=None) -> bool:
    """
    ...
    """
        ...
    @classmethod
    def forceTransitionBatch(cls, stateMachines: Array[ReliabilityAssetAlert], toState: ReliabilityAssetAlertState, stateHistoryParams: ReliabilityAssetAlertStateHistory=None) -> Map[str, bool]:
    """
    ...
    """
        ...
    @classmethod
    def stateRecoverBatch(cls, stateMachines: Array[ReliabilityAssetAlert]) -> Map[str, bool]:
    """
    ...
    """
        ...
    def transitionWithTransitions(self, transitions: Array[ReliabilityAssetAlertStateTransition]=None, testOnly: bool=None, stateHistoryParams: ReliabilityAssetAlertStateHistory=None) -> StateMachineTransitionStatus[ReliabilityAssetAlertStateHistory, ReliabilityAssetAlertStateTransition]:
    """
    Transition with a valid transition in the transitions array
    """
        ...
    @classmethod
    def doBeforeCreate(cls, objs: Array[ReliabilityAssetAlert]) -> Union[ObjList[ReliabilityAssetAlert]]:
    """
    ...
    """
        ...
    @classmethod
    def doAfterUpdate(cls, objs: Array[ReliabilityAssetAlert]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def doAfterCreate(cls, objs: Array[ReliabilityAssetAlert]) -> Union[ObjList[ReliabilityAssetAlert]]:
    """
    ...
    """
        ...
    @classmethod
    def doRemoved(cls, txn: Transaction) -> None:
    """
    If defined, executed in removed after all state histories have been removed.
    @param txn The transaction
    """
        ...
    def executeTransition(self, transition: ReliabilityAssetAlertStateTransition, stateOrderCounter: int, stateHistoryParams: ReliabilityAssetAlertStateHistory=None) -> ReliabilityAssetAlertStateHistory:
    """
    Internal use only.
    ...
    """
        ...
    def executeLambda(self, action: Callable[[Union[Any]]]=None) -> Union[str]:
    """
    Internal use only.
    Execute the {@link Lambda} function and return the error message if the {@link Lambda} fails.
    """
        ...
    def findTransitions(self, allTransitions: Array[ReliabilityAssetAlertStateTransition]) -> Union[Array[ReliabilityAssetAlertStateTransition]]:
    """
    Internal use only.
    ...
    """
        ...
    def reserveStateOrderCounter(self) -> StateMachineTransitionStatus[ReliabilityAssetAlertStateHistory, ReliabilityAssetAlertStateTransition]:
    """
    Internal use only.
    Implements a statemachine db lock.
    """
        ...
    def checkStateMachine(self) -> StateMachineTransitionStatus[ReliabilityAssetAlertStateHistory, ReliabilityAssetAlertStateTransition]:
    """
    Internal use only.
    ...
    """
        ...
    @classmethod
    def doUpdated(cls, txn: Transaction) -> None:
    """
    If defined, executed in {@link updated}
    """
        ...
    def transitionAndRefreshCurrentState(self, toState: ReliabilityAssetAlertState, stateHistoryParams: ReliabilityAssetAlertStateHistory=None) -> StateMachineTransitionStatus[ReliabilityAssetAlertStateHistory, ReliabilityAssetAlertStateTransition]:
    """
    Used from the UI to transition and refresh currentState stored calc.
    """
        ...
    @classmethod
    def transitionBatchAndRefreshCurrentState(cls, stateMachines: Array[ReliabilityAssetAlert], toState: ReliabilityAssetAlertState, retry: int=None, stateHistoryParams: ReliabilityAssetAlertStateHistory=None) -> Array[StateMachineTransitionStatus[ReliabilityAssetAlertStateHistory, ReliabilityAssetAlertStateTransition]]:
    """
    Used from the UI to batch transition and refresh currentState stored calc.
    """
        ...
    @classmethod
    def triggerAutomaticTransition(cls, stateMachineIds: Array[str], sync: bool=None) -> None:
    """
    ...
    """
        ...
    def fetchSimilarAlerts(self, spec: FetchSpec=None) -> Union[Union[FetchResult[ReliabilityAssetAlertSimilarityLarge],FetchResult[ReliabilityAssetAlertSimilaritySmall]]]:
    """
    ...
    """
        ...
    def reopenAlertAndLinkedCases(self, reopenSpec: ReliabilityAssetAlertReopenSpec=None) -> None:
    """
    ...
    """
        ...
    def reopenAndTransitionAlert(self) -> None:
    """
    Reopen Alert and transition it to `Open` or `Case` state depending on its previous state
    """
        ...
    def computeCosineSimilarity(self, secondAlert: ReliabilityAssetAlert) -> Union[float]:
    """
    ...
    """
        ...
    def fetchFeatureContributionMapData(self, spec: EvaluateSpec) -> Union[EvaluateResult]:
    """
    ...
    """
        ...
    def sendAlertNotification(self) -> None:
    """
    ...
    """
        ...
    @classmethod
    def createAlertSimilarityWorkflow(cls, alerts: Array[ReliabilityAssetAlert]=None) -> Union[Workflow]:
    """
    ...
    """
        ...
    @classmethod
    def startAlertSimilarityWorkflow(cls, alerts: Array[ReliabilityAssetAlert]=None) -> Union[Workflow.Run]:
    """
    ...
    """
        ...
    def fetchCountSimilarAlerts(self, spec: FetchSpec=None) -> int:
    """
    ...
    """
        ...
    def calculateAndStoreSimilarAlerts(self) -> Union[Array[Union[ReliabilityAssetAlertSimilaritySmall,ReliabilityAssetAlertSimilarityLarge]]]:
    """
    ...
    """
        ...
    def addSimilarAlertsToCases(self, similarities: Array[Union[ReliabilityAssetAlertSimilaritySmall,ReliabilityAssetAlertSimilarityLarge]]=None) -> None:
    """
    ...
    """
        ...
    def linkFailureModesAndRecommendations(self) -> None:
    """
    ...
    """
        ...
    def processAlertSimilarity(self, fetchSpec: FetchSpec) -> Union[Array[Union[ReliabilityAssetAlertSimilaritySmall,ReliabilityAssetAlertSimilarityLarge]]]:
    """
    ...
    class ModelOutput():
        """
        Represents the model output associated with a {@link ReliabilityAssetAlert} or other
        types of alerts mixing in {@link ReliabilityAssetAlertBase}.
        Typically is some value representative of alert criticality, e.g. risk score for anomaly detection or predicted time to failure.
        When fetched in the UI, renders depending on which fields are populated using the `UiSdlAlertModelOutputGridCell` component.
        
        @remarks this represents a made instance of ReliabilityAssetAlert.ModelOutput
        """
        
        value: Optional[Any]
        """
        The value representing the model output.
        
        If a numerical value and {@link range} is populated, shows a risk gauge component where the gauge is set
        relative to where the value lies within the given range.
        
        Otherwise, the raw value will be displayed.
        """

        range: Optional[DblRange]=None
        """
        A numerical range putting the {@link value} in context for criticality purposes, if applicable.
        If populated, {@link value} must be a numerical value that lies within the given range.
        """
        def __init__(self, value: Optional[Any]=None, range: Optional[DblRange]=None) -> None: ...
        ...
        """
            ...
        @classmethod
        def fromJson(cls, json: any) -> Union[ReliabilityAssetAlert.ModelOutput]:
        """
        Load the JSON-based representation and reconstruct the corresponding object.
        ...
        """
            ...
        @classmethod
        def fromJsonString(cls, json: str) -> Union[ReliabilityAssetAlert.ModelOutput]:
        """
        Load the JSON-based representation and reconstruct the corresponding object.
        ...
        """
            ...
        @classmethod
        def fromXmlString(cls, xml: str) -> Union[ReliabilityAssetAlert.ModelOutput]:
        """
        Load the XML-based representation and reconstruct the corresponding object.
        ...
        """
            ...
        @classmethod
        def deserialize(cls, contentStr: str, contentType: str) -> Union[ReliabilityAssetAlert.ModelOutput]:
        """
        Load from contentType representation and reconstruct the corresponding object.
        ...
        """
            ...
        def replaceType(self, old: Type, new: Type) -> ReliabilityAssetAlert.ModelOutput:
        """
        Returns new instance with all references to old type, including result of #type, replaced with new type. If new
        type does not contain fields from old or field value types are not convertable then drops the field.
        ...
        """
            ...
        @overload
        def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> ReliabilityAssetAlert.ModelOutput:
        """
        Result of this function call is a copy of current instance with all non empty fields replaced based on results of
        the `mapper` invocation.
        ...
        """
            ...
        @overload
        def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> ReliabilityAssetAlert.ModelOutput:
        """
        Result of this function call is a copy of current instance with all fields replaced based on results of the
        `mapper` invocation.
        ...
        """
            ...
        @overload
        def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[ReliabilityAssetAlert.ModelOutput]:
        """
        Result of this function call is a copy of current instance with all non empty fields replaced based on results of
        the asynchronous `mapper` invocation.
        ...
        """
            ...
        @overload
        def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[ReliabilityAssetAlert.ModelOutput]:
        """
        Result of this function call is a copy of current instance with all fields replaced based on results of the
        asynchronous `mapper` invocation.
        ...
        """
            ...
        def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> ReliabilityAssetAlert.ModelOutput:
        """
        Result of this function call is a copy of current instance with specified field value replaced based on result of
        the `mapper` invocation.
        @param field
        ...
        """
            ...
        @overload
        def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> ReliabilityAssetAlert.ModelOutput:
        """
        Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
        lambda application.
        ...
        """
            ...
        @overload
        def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> ReliabilityAssetAlert.ModelOutput:
        """
        Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
        lambda application.
        ...
        """
            ...
        @overload
        def validateObj(self) -> ReliabilityAssetAlert.ModelOutput:
        """
        Populates all missing default values and throws error if any constraint is violated.
        """
            ...
        ...
        """
            ...
        @overload
        def withField(self, field: str, value: Any, doNotConvert: bool=None) -> ReliabilityAssetAlert.ModelOutput:
        """
        Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
        defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
        ...
        """
            ...
        @overload
        def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> ReliabilityAssetAlert.ModelOutput:
        """
        Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
        defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
        ...
        """
            ...
        def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> ReliabilityAssetAlert.ModelOutput:
        """
        Builds a new Obj instance by adding the provided fields in it. The name must correspond to an existing fields
        defined on this type or its mixins. The values must be of the correct type if doNotConvert flag is true.
        ...
        """
            ...
        def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> ReliabilityAssetAlert.ModelOutput:
        """
        Builds a new Obj with the value at the specified path field. If the field is null, the field #isFieldSet to null.
        If you would like to #unsetField, you should call #withoutFieldAtPath instead.
        ...
        """
            ...
        def withoutFieldAtPath(self, path: str) -> ReliabilityAssetAlert.ModelOutput:
        """
        Builds a new Obj without the specified path field.
        ...
        """
            ...
        @overload
        def withoutField(self, field: str) -> ReliabilityAssetAlert.ModelOutput:
        """
        Builds a new Obj, removing the field with the provided name.
        ...
        """
            ...
        @overload
        def withoutField(self, field: FieldType) -> ReliabilityAssetAlert.ModelOutput:
        """
        Builds a new Obj, removing the field with the provided field type.
        ...
        """
            ...
        def withoutFields(self, fields: Array[str]) -> ReliabilityAssetAlert.ModelOutput:
        """
        Builds a new Obj, removing the fields with the provided names.
        ...
        """
            ...
        def withoutFieldsByType(self, fields: Array[FieldType]) -> ReliabilityAssetAlert.ModelOutput:
        """
        Builds a new Obj, removing the fields with the provided field types. Be sure to use the FieldType instance for the
        exact same type as the type of the obj to respect the "ordinal" of the field type
        ...
        """
            ...
        def withoutSecretFields(self) -> ReliabilityAssetAlert.ModelOutput:
        """
        @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
        """
            ...
        ...
        """
            ...
        def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> ReliabilityAssetAlert.ModelOutput:
        """
        Builds a new Obj instance by adding the default values (if defined) for all unset fields. This is implemented by
        calling {@link FieldType#defaultValue defaultValue} for a field if it is not already set and
        {@link FieldType#hasDefault has a default}. It will also set {@see ValueType#initialValue initial values} for
        ...
        """
            ...
        @overload
        def defaultField(self, field: str) -> ReliabilityAssetAlert.ModelOutput:
        """
        Builds a new Obj, by setting a field on this `Obj` to the field's default value. If the field has no default, this
        method will behave the same as {@link #unsetField}.
        ...
        """
            ...
        @overload
        def defaultField(self, field: FieldType) -> ReliabilityAssetAlert.ModelOutput:
        """
        Builds a new Obj, by setting a field on this `Obj` to the fields default value. If the field has no default, this
        method will behave the same as {@link #unsetField}.
        ...
        """
            ...
        @overload
        def unsetField(self, field: str) -> ReliabilityAssetAlert.ModelOutput:
        """
        Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
        is different from {@link removeField}
        ...
        """
            ...
        @overload
        def unsetField(self, field: FieldType) -> ReliabilityAssetAlert.ModelOutput:
        """
        Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
        is different from {@link removeField}
        ...
        """
            ...
        @overload
        def removeField(self, field: str) -> ReliabilityAssetAlert.ModelOutput:
        """
        Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
        is different from {@link #unsetField}
        ...
        """
            ...
        @overload
        def removeField(self, field: FieldType) -> ReliabilityAssetAlert.ModelOutput:
        """
        Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
        is different from {@link #unsetField}
        ...
        """
            ...
        @overload
        def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> ReliabilityAssetAlert.ModelOutput:
        """
        Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
        In case of conflicts, fields of other instance take precedence unless otherwise specified by the fieldPathMergeSpec
        ...
        """
            ...
        @overload
        def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> ReliabilityAssetAlert.ModelOutput:
        """
        Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
        In case of conflicts, fields of other instance take precedence.
        ...
        """
            ...
        @overload
        def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> ReliabilityAssetAlert.ModelOutput:
        """
        Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
        fields that exist on other Obj and do not exist on this Obj will not be added to final Obj.
        @param deep
        ...
        """
            ...
        @overload
        def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> ReliabilityAssetAlert.ModelOutput:
        """
        Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
        fields that exist other Obj and do not exist on this Obj will not be added to final Obj or evaluated. Does not
        traverse child reference and collection fields.
        ...
        """
            ...
        def mergeJson(self, json: any) -> ReliabilityAssetAlert.ModelOutput:
            ...
        def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> ReliabilityAssetAlert.ModelOutput:
        """
        Merge the obj references within the current obj
        @param deep
               If set, traverses the reference fields within the obj as well for a deep merge
        ...
        """
            ...
        def sumObj(self, other: Obj, deep: bool=None) -> ReliabilityAssetAlert.ModelOutput:
        """
        Adds the numeric Obj fields with the other Objs respective fields.
        If deep is set it will traverse reference and collection fields and sum corresponding numeric fields in
        references with same name and collection elements at same index or key.
        """
            ...
        def singletonArray(self) -> Array[ReliabilityAssetAlert.ModelOutput]:
        """
        Build an array of the correct type with a single element which is this instance.
        ...
        """
            ...
        @classmethod
        def array(cls, *elements: Array[Any]) -> Union[Array[ReliabilityAssetAlert.ModelOutput]]:
        """
        Creates an array of instances of this type.
        """
            ...
        @classmethod
        def arrayBuilder(cls) -> Union[ArrayBuilder[ReliabilityAssetAlert.ModelOutput]]:
        """
        Creates an array of instances of this type.
        """
            ...
        def singletonSet(self) -> Set[ReliabilityAssetAlert.ModelOutput]:
        """
        Build an set of the correct type with a single element which is this instance.
        ...
        """
            ...
        @classmethod
        def setBuilder(cls) -> Union[SetBuilder[ReliabilityAssetAlert.ModelOutput]]:
        """
        Creates a set of instances of this type.
        """
            ...
        @classmethod
        def mapBuilder(cls) -> Union[MapBuilder[str, ReliabilityAssetAlert.ModelOutput]]:
        """
        Create a map of string to elements of this type.
        """
            ...
        @classmethod
        def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, ReliabilityAssetAlert.ModelOutput]]:
        """
        Create a map with the given key type and elements of this type.
        """
            ...
        ...
        def myStreamType(cls) -> StreamType:
            ...
        def toBuilder(self) -> ObjBuilder[ReliabilityAssetAlert.ModelOutput]:
        """
        @return new ObjBuilder with initial state set to fields of this instance.
        """
            ...
        @classmethod
        def builder(cls) -> ObjBuilder[ReliabilityAssetAlert.ModelOutput]:
        """
        @return new ObjBuilder of this instance.
        """
            ...
        @overload
        @classmethod
        def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> ReliabilityAssetAlert.ModelOutput:
        """
        Construct instance of this type from provided field values and options
        """
            ...
        @overload
        @classmethod
        def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> ReliabilityAssetAlert.ModelOutput:
        """
        Construct an instance of this type from provided fields
        @param fields
                   Fields to construct the instance of the obj with
        ...
        @overload
        @classmethod
        def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> ReliabilityAssetAlert.ModelOutput:
        """
        Construct instance of this type from provided field values and options
        """
            ...
        @overload
        @classmethod
        def make(cls, withDefaults: bool=None) -> ReliabilityAssetAlert.ModelOutput:
        """
        Construct an instance of this type with no non-default field values unless explicitly specified by passing param true
        @param withDefaults
                   If set, then the Obj is made with default & initial values (required primitive fields e.g. !int32 -> 0)
        ...
        @overload
        @classmethod
        def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> ReliabilityAssetAlert.ModelOutput:
        """
        Construct an instance from provided fields
        @param fields
                   Fields (in the format <field_name, value>) to construct an instance of the obj. Note that "type" as a
        ...
        @overload
        @classmethod
        def make(cls, fields: Any, withDefaults: bool=None) -> ReliabilityAssetAlert.ModelOutput:
        """
        Construct an instance of this type from provided fields. Note it is more efficient to use #fromFields and other overloads
        ...
        """
            ...
        @classmethod
        def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> ReliabilityAssetAlert.ModelOutput:
        """
        Construct an instance of this type from provided instance of a subtype or a "duck type".
        """
            ...
        ...
        """
            ...
        def afterMake(self) -> ReliabilityAssetAlert.ModelOutput:
        """
        Optional override that will be called after every instance creation.
        ...
        """
            ...
        @classmethod
        def cachedEmptyInst(cls) -> ReliabilityAssetAlert.ModelOutput:
        """
        Creates an empty inst using `MyType.make()` and caches it. Avoid recreating multiple copies of the spec for
        every action dispatch. The cached inst can also be used for comparing whether the object is an empty or not
        Will only create empty instance for immutable Obj e.g. if an Obj is Mutable, this method will throw an error
        ...
        """
            ...
        @classmethod
        def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[ReliabilityAssetAlert.ModelOutput]]:
        """
        Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
        value is read.
        """
            ...
        @classmethod
        def generateObj(cls, spec: Obj.GenerateSpec=None) -> ReliabilityAssetAlert.ModelOutput:
        """
        Generate a single instance of this type. The base implementation uses {@link DataGenObj} to generate uniform
        random (gibberish) values for all fields, but it may be overridden by specific types with custom logic that
        populates fields in a more realistic way.
