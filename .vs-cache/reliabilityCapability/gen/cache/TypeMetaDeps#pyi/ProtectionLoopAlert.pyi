...
from c3.reliabilityCapability.ProtectionLoopAlertTransition import ProtectionLoopAlertTransition
...
from c3.reliabilityCapability.ProtectionLoopHealthHistory import ProtectionLoopHealthHistory
...
from c3.reliabilityCapability.ProtectionLoopAlertHistory import ProtectionLoopAlertHistory
...
from c3.reliabilityCapability.ProtectionLoopAlertState import ProtectionLoopAlertState
...
from c3.sensor.ProtectionLoop import ProtectionLoop
...
# Python definitions for the C3 type ProtectionLoopAlert


class ProtectionLoopAlert(FeatureEvaluatable, StateMachine[ProtectionLoopAlertHistory, ProtectionLoopAlertState, ProtectionLoopAlertTransition]):
    """
    Type that is created when a percentage of sensors fails and belongs to the same {@link ProtectionLoop} type.
    
    @remarks this represents a made instance of ProtectionLoopAlert
    """
    ...
    currentState: Optional[ProtectionLoopAlertState]=None
    """
    A stored calc field representing the current state - uses a {@link StateMachineHistory} to keep track.
    """

    stateHistories: Optional[Array[ProtectionLoopAlertHistory]]=None
    """
    A collection of the states this {@link StateMachine} has passed through.
    """

    transitions: Optional[Array[ProtectionLoopAlertTransition]]=None
    """
    Transitions available from the current state
    """

    currentStateHistory: Optional[ProtectionLoopAlertHistory]=None
    """
    Calc field to get the current state history
    """

    parent: Optional[ProtectionLoop]
    """
    The parent {@link ProtectionLoop} this alert is on. TODO: REL-4645 remove field once dataAlerting migrated.
    """

    timestamp: Optional[datetime]
    """
    The time the alert was triggered. TODO: REL-4645 remove field once dataAlerting migrated.
    """

    risk: Optional[str]=None
    """
    Current risk Status {@link ProtectionLoopRiskStatus}
    """

    unhealthySensors: Optional[Array[Sensor]]=None
    """
    Unhealthy sensors in the protection loop.
    {@link ProtectionLoop}
    """

    healthStatus: Optional[ProtectionLoopHealthHistory]=None
    """
    The evaluation of protection loop health which led to this alert.
    """

    triggerValue: Optional[Dimension]=None
    """
    The trigger value that made this alert. TODO: REL-4645 remove field once dataAlerting migrated.
    """
    def __init__(self, id: Optional[str]=None, versionEdits: Optional[Array[VersionEdit]]=None, name: Optional[str]=None, meta: Optional[Meta]=None, version: Optional[int]=None, typeWithBindings: Optional[Type]=None, currentState: Optional[ProtectionLoopAlertState]=None, stateHistories: Optional[Array[ProtectionLoopAlertHistory]]=None, transitions: Optional[Array[ProtectionLoopAlertTransition]]=None, currentStateHistory: Optional[ProtectionLoopAlertHistory]=None, parent: Optional[ProtectionLoop]=None, timestamp: Optional[datetime]=None, risk: Optional[str]=None, unhealthySensors: Optional[Array[Sensor]]=None, healthStatus: Optional[ProtectionLoopHealthHistory]=None, triggerValue: Optional[Dimension]=None) -> None: ...
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[ProtectionLoopAlert]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[ProtectionLoopAlert]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[ProtectionLoopAlert]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[ProtectionLoopAlert]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> ProtectionLoopAlert:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> ProtectionLoopAlert:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> ProtectionLoopAlert:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[ProtectionLoopAlert]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[ProtectionLoopAlert]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> ProtectionLoopAlert:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> ProtectionLoopAlert:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> ProtectionLoopAlert:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> ProtectionLoopAlert:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> ProtectionLoopAlert:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> ProtectionLoopAlert:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> ProtectionLoopAlert:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> ProtectionLoopAlert:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> ProtectionLoopAlert:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> ProtectionLoopAlert:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> ProtectionLoopAlert:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> ProtectionLoopAlert:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> ProtectionLoopAlert:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> ProtectionLoopAlert:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> ProtectionLoopAlert:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> ProtectionLoopAlert:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> ProtectionLoopAlert:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> ProtectionLoopAlert:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> ProtectionLoopAlert:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> ProtectionLoopAlert:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> ProtectionLoopAlert:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> ProtectionLoopAlert:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> ProtectionLoopAlert:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> ProtectionLoopAlert:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> ProtectionLoopAlert:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> ProtectionLoopAlert:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> ProtectionLoopAlert:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> ProtectionLoopAlert:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[ProtectionLoopAlert]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[ProtectionLoopAlert]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[ProtectionLoopAlert]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[ProtectionLoopAlert]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[ProtectionLoopAlert]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, ProtectionLoopAlert]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, ProtectionLoopAlert]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[ProtectionLoopAlert]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[ProtectionLoopAlert]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> ProtectionLoopAlert:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> ProtectionLoopAlert:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> ProtectionLoopAlert:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> ProtectionLoopAlert:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> ProtectionLoopAlert:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> ProtectionLoopAlert:
    """
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[ProtectionLoopAlert]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> ProtectionLoopAlert:
    """
    ...
    """
        ...
    def afterMake(self) -> ProtectionLoopAlert:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> ProtectionLoopAlert:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[ProtectionLoopAlert]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> ProtectionLoopAlert:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, spec: FetchSpec=None) -> FetchResult[ProtectionLoopAlert]:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, filter: Filter) -> FetchResult[ProtectionLoopAlert]:
    """
    ...
    """
        ...
    @classmethod
    def fetchObjStream(cls, spec: FetchStreamSpec=None) -> Union[Stream[ProtectionLoopAlert]]:
    """
    Fetches multiple obj instances based on a specification.  Only objs that the caller is authorized to fetch will be
    returned.
    ...
    """
        ...
    @classmethod
    def fetchMultiLocale(cls, spec: MultiLocaleFetchSpec=None) -> Union[Map[str, FetchResult[ProtectionLoopAlert]]]:
    """
    ...
    @overload
    @classmethod
    def evalFeatureSetBatch(cls, batch: Array[ProtectionLoopAlert], featureSet: Feature.Set, spec: EvalFeatureSpec=None) -> Union[Data]:
    """
    ...
    @overload
    @classmethod
    def evalFeaturesBatch(cls, batch: Array[ProtectionLoopAlert], features: Array[str], spec: EvalFeaturesSpec=None) -> Union[Data]:
    """
    ...
    """
        ...
    def get(self, include: str=None) -> Union[ProtectionLoopAlert]:
    """
    ...
    """
        ...
    def getSpecific(self, include: str=None) -> Union[ProtectionLoopAlert]:
    """
    ...
    """
        ...
    def getMissing(self, spec: GetMissingSpec) -> ProtectionLoopAlert:
    """
    ...
    """
        ...
    def getDirect(self, include: str=None) -> Union[ProtectionLoopAlert]:
    """
    ...
    """
        ...
    def applyReverseEdit(self, versionEdit: VersionEdit) -> ProtectionLoopAlert:
    """
    ...
    """
        ...
    @classmethod
    def fromString(cls, s: str) -> Union[ProtectionLoopAlert]:
    """
    ...
    """
        ...
    def create(self, spec: UpsertSpec=None) -> Union[ProtectionLoopAlert]:
    """
    ...
    """
        ...
    @classmethod
    def createBatch(cls, objs: Array[ProtectionLoopAlert], spec: UpsertSpec=None) -> Union[ObjList[ProtectionLoopAlert]]:
    """
    ...
    """
        ...
    @classmethod
    def createBatchObjStream(cls, objs: Stream[ProtectionLoopAlert], spec: CreateBatchObjStreamSpec=None) -> Union[ObjList[ProtectionLoopAlert]]:
    """
    Creates multiple instances of a C3 type. If the operation fails and {@link UpsertSpec#dontThrowOnBatchError} is not
    specified (the default), then a C3BatchException will be thrown.  Otherwise {@link errors will be reported in the
    returned {@link ObjList}.  This will fail if any of the instances already exist.
    ...
    """
        ...
    def update(self, srcObj: ProtectionLoopAlert=None, spec: UpsertSpec=None) -> Union[ProtectionLoopAlert]:
    """
    ...
    """
        ...
    def upsert(self, srcObj: ProtectionLoopAlert=None, spec: UpsertSpec=None) -> Union[ProtectionLoopAlert]:
    """
    ...
    """
        ...
    @overload
    def merge(self, spec: MergeSpec=None) -> Union[ProtectionLoopAlert]:
    """
    ...
    """
        ...
    @overload
    def merge(self, mergeInclude: str, spec: MergeSpec=None) -> Union[ProtectionLoopAlert]:
    """
    ...
    """
        ...
    def touch(self, spec: TouchSpec=None) -> Union[ProtectionLoopAlert]:
    """
    ...
    """
        ...
    @classmethod
    def updateBatch(cls, objs: Array[ProtectionLoopAlert], srcObjs: Array[ProtectionLoopAlert]=None, spec: UpsertSpec=None) -> Union[ObjList[ProtectionLoopAlert]]:
    """
    ...
    """
        ...
    @classmethod
    def updateObjs(cls, objs: Callable[[], Union[Array[ProtectionLoopAlert]]], spec: UpsertSpec=None) -> Union[ObjList[ProtectionLoopAlert]]:
    """
    ...
    """
        ...
    @classmethod
    def upsertBatch(cls, objs: Array[ProtectionLoopAlert], srcObjs: Array[ProtectionLoopAlert]=None, spec: UpsertSpec=None) -> Union[ObjList[ProtectionLoopAlert]]:
    """
    ...
    """
        ...
    @classmethod
    def upsertObjs(cls, objs: Callable[[], Union[Array[ProtectionLoopAlert]]], spec: UpsertSpec=None) -> Union[ObjList[ProtectionLoopAlert]]:
    """
    Creates instances of a C3 type if they don't already exist and updates them if they do exist. If the operation
    ...
    """
        ...
    @classmethod
    def touchBatch(cls, objs: Array[ProtectionLoopAlert], spec: TouchSpec=None) -> Union[ObjList[ProtectionLoopAlert]]:
    """
    ...
    @overload
    @classmethod
    def mergeBatch(cls, objs: Array[ProtectionLoopAlert], spec: MergeSpec=None) -> Union[ObjList[ProtectionLoopAlert]]:
    """
    ...
    @overload
    @classmethod
    def mergeBatch(cls, objs: Array[ProtectionLoopAlert], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[ProtectionLoopAlert]]:
    """
    Merges multiple instances of a C3 type or creates them if they don't exist. If the operation fails and {@link
    UpsertSpec#dontThrowOnBatchError} is not specified (the default), then a C3BatchException will be thrown.
    Otherwise errors will be reported in the returned {@link ObjList}.  The merge operation is described in the {@link
    ...
    """
        ...
    @classmethod
    def mergeObjs(cls, objs: Callable[[], Union[Array[ProtectionLoopAlert]]], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[ProtectionLoopAlert]]:
    """
    ...
    @overload
    @classmethod
    def mergeAll(cls, mergeObj: ProtectionLoopAlert, spec: MergeAllSpec=None) -> Union[int]:
    """
    ...
    @overload
    @classmethod
    def mergeAll(cls, mergeObj: ProtectionLoopAlert, mergeInclude: str, spec: MergeAllSpec=None) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def removeBatch(cls, objs: Array[ProtectionLoopAlert], spec: UpsertSpec=None) -> Union[ObjList[ProtectionLoopAlert]]:
    """
    ...
    """
        ...
    @classmethod
    def replace(cls, objs: Array[ProtectionLoopAlert], spec: UpsertSpec=None) -> Union[ObjList[ProtectionLoopAlert]]:
    """
    ...
    """
        ...
    def unremove(self) -> Union[ProtectionLoopAlert]:
    """
    ...
    """
        ...
    @classmethod
    def beforeCreate(cls, objs: Array[ProtectionLoopAlert]) -> ObjList[ProtectionLoopAlert]:
    """
    See {@link PersistableWritable#beforeCreate}
    """
        ...
    @classmethod
    def beforeUpdate(cls, objs: Array[ProtectionLoopAlert]) -> ObjList[ProtectionLoopAlert]:
    """
    ...
    """
        ...
    @classmethod
    def beforeRemove(cls, objs: Array[ProtectionLoopAlert]) -> ObjList[ProtectionLoopAlert]:
    """
    ...
    """
        ...
    @classmethod
    def afterCreate(cls, objs: Array[ProtectionLoopAlert]) -> Union[Array[ObjError]]:
    """
    See {@link PersistableWritable#afterCreate}
    """
        ...
    @classmethod
    def afterUpdate(cls, objs: Array[ProtectionLoopAlert]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def afterRemove(cls, objs: Array[ProtectionLoopAlert]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def startImportData(cls, spec: StartImportDataSpec=None) -> PushStream[ProtectionLoopAlert]:
    """
    @return a push stream to import instances of this type.
    """
        ...
    @classmethod
    def startImportDataWithStats(cls, spec: StartImportDataSpec=None) -> PushStreamWithStats[ProtectionLoopAlert]:
    """
    @return a push stream to import instances of this type.
    """
        ...
    ...
    """
        ...
    @classmethod
    def forId(cls, id: str, failIfMissing: bool=None) -> Union[ProtectionLoopAlert]:
    """
    ...
    """
        ...
    def withoutIdentity(self) -> Union[ProtectionLoopAlert]:
    """
    ...
    """
        ...
    @classmethod
    def typeOfBatch(cls, objs: Array[ProtectionLoopAlert]) -> Union[Array[EntityType]]:
    """
    ...
    """
        ...
    @classmethod
    def dbEcho(cls, template: ProtectionLoopAlert=None, count: int=None, sendBack: bool=None) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def callbackLogic(cls, objs: Array[ProtectionLoopAlert], callback: Callable[[Union[ProtectionLoopAlert]], Union[ProtectionLoopAlert]]=None) -> ObjList[ProtectionLoopAlert]:
    """
    ...
    """
        ...
    @classmethod
    def afterCallbackLogic(cls, objs: Array[ProtectionLoopAlert], callback: Callable[[Union[ProtectionLoopAlert]], Union[ProtectionLoopAlert]]=None) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def transitionBatch(cls, stateMachines: Array[ProtectionLoopAlert], toState: ProtectionLoopAlertState, retry: int=None, stateHistoryParams: ProtectionLoopAlertHistory=None) -> Array[StateMachineTransitionStatus[ProtectionLoopAlertHistory, ProtectionLoopAlertTransition]]:
    """
    Transition an array of state machines to a new state
    """
        ...
    def transition(self, toState: ProtectionLoopAlertState, testOnly: bool=None, stateHistoryParams: ProtectionLoopAlertHistory=None) -> StateMachineTransitionStatus[ProtectionLoopAlertHistory, ProtectionLoopAlertTransition]:
    """
    ...
    """
        ...
    def checkTransition(self, toState: ProtectionLoopAlertState) -> bool:
    """
    ...
    """
        ...
    def possibleStates(self) -> Union[Array[ProtectionLoopAlertState]]:
    """
    ...
    """
        ...
    @classmethod
    def allStates(cls) -> Union[Array[ProtectionLoopAlertState]]:
    """
    Return list of all states in the {@link StateMachine}.
    """
        ...
    def possibleTransitions(self) -> Union[Array[ProtectionLoopAlertTransition]]:
    """
    Return list of transitions possible from the current state given the current user permissions and current conditions.
    """
        ...
    @classmethod
    def allTransitions(cls, fromState: ProtectionLoopAlertState=None, toState: ProtectionLoopAlertState=None) -> Union[Array[ProtectionLoopAlertTransition]]:
    """
    ...
    """
        ...
    def forceTransition(self, toState: ProtectionLoopAlertState, stateHistoryParams: ProtectionLoopAlertHistory=None) -> bool:
    """
    ...
    """
        ...
    @classmethod
    def forceTransitionBatch(cls, stateMachines: Array[ProtectionLoopAlert], toState: ProtectionLoopAlertState, stateHistoryParams: ProtectionLoopAlertHistory=None) -> Map[str, bool]:
    """
    ...
    """
        ...
    @classmethod
    def stateRecoverBatch(cls, stateMachines: Array[ProtectionLoopAlert]) -> Map[str, bool]:
    """
    ...
    """
        ...
    def transitionWithTransitions(self, transitions: Array[ProtectionLoopAlertTransition]=None, testOnly: bool=None, stateHistoryParams: ProtectionLoopAlertHistory=None) -> StateMachineTransitionStatus[ProtectionLoopAlertHistory, ProtectionLoopAlertTransition]:
    """
    Transition with a valid transition in the transitions array
    """
        ...
    @classmethod
    def doBeforeCreate(cls, objs: Array[ProtectionLoopAlert]) -> Union[ObjList[ProtectionLoopAlert]]:
    """
    ...
    """
        ...
    @classmethod
    def doAfterUpdate(cls, objs: Array[ProtectionLoopAlert]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def doAfterCreate(cls, objs: Array[ProtectionLoopAlert]) -> Union[ObjList[ProtectionLoopAlert]]:
    """
    ...
    """
        ...
    def executeTransition(self, transition: ProtectionLoopAlertTransition, stateOrderCounter: int, stateHistoryParams: ProtectionLoopAlertHistory=None) -> ProtectionLoopAlertHistory:
    """
    Internal use only.
    ...
    """
        ...
    def findTransitions(self, allTransitions: Array[ProtectionLoopAlertTransition]) -> Union[Array[ProtectionLoopAlertTransition]]:
    """
    Internal use only.
    ...
    """
        ...
    def reserveStateOrderCounter(self) -> StateMachineTransitionStatus[ProtectionLoopAlertHistory, ProtectionLoopAlertTransition]:
    """
    Internal use only.
    Implements a statemachine db lock.
    """
        ...
    def checkStateMachine(self) -> StateMachineTransitionStatus[ProtectionLoopAlertHistory, ProtectionLoopAlertTransition]:
    """
    Internal use only.
    ...
    """
        ...
    def transitionAndRefreshCurrentState(self, toState: ProtectionLoopAlertState, stateHistoryParams: ProtectionLoopAlertHistory=None) -> StateMachineTransitionStatus[ProtectionLoopAlertHistory, ProtectionLoopAlertTransition]:
    """
    Used from the UI to transition and refresh currentState stored calc.
    """
        ...
    @classmethod
    def transitionBatchAndRefreshCurrentState(cls, stateMachines: Array[ProtectionLoopAlert], toState: ProtectionLoopAlertState, retry: int=None, stateHistoryParams: ProtectionLoopAlertHistory=None) -> Array[StateMachineTransitionStatus[ProtectionLoopAlertHistory, ProtectionLoopAlertTransition]]:
    """
    ...
    """
        ...
    def fetchSensorStatuses(self, spec: FetchSpec=None) -> FetchResultWithTotalCount[ProtectionLoopAlertSensorStatus]:
    """
    Fetch the sensors in the protection loop as well as their statuses at the time the alert was raised and
    their current statuses/health.
    """
        ...
    @classmethod
    def openStateEntryAction(cls, currentProtectionLoopAlert: ProtectionLoopAlert) -> None:
    """
    Closing previous open alerts.
    """
        ...
    @classmethod
    def closeAlerts(cls) -> None:
    """
    Close protection loops alerts that have been open for more than
    {@link ReliabilityProtectionLoopConfig#protectionLoopAlertClosePeriod} period of time.
    """
        ...
