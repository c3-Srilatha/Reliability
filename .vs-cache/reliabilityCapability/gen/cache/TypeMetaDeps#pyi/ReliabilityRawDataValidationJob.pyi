...
from c3.reliabilityCapability.ReliabilityRawDataValidationJobOptions import ReliabilityRawDataValidationJobOptions
...
from c3.reliabilityCapability.ReliabilityRawDataValidationJobBatch import ReliabilityRawDataValidationJobBatch
...
# Python definitions for the C3 type ReliabilityRawDataValidationJob


class ReliabilityRawDataValidationJob(BatchJob[ReliabilityRawDataValidationJob, ReliabilityRawDataValidationJobOptions, ReliabilityRawDataValidationJobBatch]):
    """
    A distributed {@link BatchJob} that parallelizes the validation of raw data source {@link File}s.
    See individual function documentation for more information.
    Example python usage of the job:
    ```py
    job = c3.ReliabilityRawDataValidationJob().create()
    job_options = c3.ReliabilityRawDataValidationJobOptions(
        rootFolderPath = "stage/rawDataValidationFiles",
        assetHierarchyExcelPath = "AssetHierarchyExcelSpreadsheet",
        batchSize = 2
    )
    status = job.start(job_options)
    ```
    
    @remarks this represents a made instance of ReliabilityRawDataValidationJob
    """
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[ReliabilityRawDataValidationJob]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[ReliabilityRawDataValidationJob]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[ReliabilityRawDataValidationJob]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[ReliabilityRawDataValidationJob]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> ReliabilityRawDataValidationJob:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> ReliabilityRawDataValidationJob:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> ReliabilityRawDataValidationJob:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[ReliabilityRawDataValidationJob]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[ReliabilityRawDataValidationJob]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> ReliabilityRawDataValidationJob:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> ReliabilityRawDataValidationJob:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> ReliabilityRawDataValidationJob:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> ReliabilityRawDataValidationJob:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> ReliabilityRawDataValidationJob:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> ReliabilityRawDataValidationJob:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> ReliabilityRawDataValidationJob:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> ReliabilityRawDataValidationJob:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> ReliabilityRawDataValidationJob:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> ReliabilityRawDataValidationJob:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> ReliabilityRawDataValidationJob:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> ReliabilityRawDataValidationJob:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> ReliabilityRawDataValidationJob:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> ReliabilityRawDataValidationJob:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> ReliabilityRawDataValidationJob:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> ReliabilityRawDataValidationJob:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> ReliabilityRawDataValidationJob:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> ReliabilityRawDataValidationJob:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> ReliabilityRawDataValidationJob:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> ReliabilityRawDataValidationJob:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> ReliabilityRawDataValidationJob:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> ReliabilityRawDataValidationJob:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> ReliabilityRawDataValidationJob:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> ReliabilityRawDataValidationJob:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> ReliabilityRawDataValidationJob:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> ReliabilityRawDataValidationJob:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> ReliabilityRawDataValidationJob:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> ReliabilityRawDataValidationJob:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[ReliabilityRawDataValidationJob]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[ReliabilityRawDataValidationJob]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[ReliabilityRawDataValidationJob]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[ReliabilityRawDataValidationJob]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[ReliabilityRawDataValidationJob]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, ReliabilityRawDataValidationJob]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, ReliabilityRawDataValidationJob]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[ReliabilityRawDataValidationJob]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[ReliabilityRawDataValidationJob]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> ReliabilityRawDataValidationJob:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> ReliabilityRawDataValidationJob:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> ReliabilityRawDataValidationJob:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> ReliabilityRawDataValidationJob:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> ReliabilityRawDataValidationJob:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> ReliabilityRawDataValidationJob:
    """
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[ReliabilityRawDataValidationJob]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> ReliabilityRawDataValidationJob:
    """
    ...
    """
        ...
    def afterMake(self) -> ReliabilityRawDataValidationJob:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> ReliabilityRawDataValidationJob:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[ReliabilityRawDataValidationJob]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> ReliabilityRawDataValidationJob:
    """
    ...
    """
        ...
    def start(self, options: ReliabilityRawDataValidationJobOptions=None) -> Union[BatchJobStatus]:
    """
    ...
    def setMaxConcurrencyPerNode(self, maxConcurrencyPerNode: int=None) -> None:
        ...
    def cleanup(self, options: ReliabilityRawDataValidationJobOptions=None) -> None:
    """
    ...
    """
        ...
    def cancelJob(self, removeResults: bool=None, force: bool=None) -> Union[JobBase[BatchJobRun, BatchJobStatus, ReliabilityRawDataValidationJobOptions]]:
        ...
    def failJob(self, run: JobRun[BatchJobStatusBase]) -> Union[JobBase[BatchJobRun, BatchJobStatus, ReliabilityRawDataValidationJobOptions]]:
        ...
    @classmethod
    ...
    def hasErrors(self) -> bool:
        ...
    def validateStart(self, options: ReliabilityRawDataValidationJobOptions=None) -> None:
        ...
    ...
    @overload
    @classmethod
    def fetch(cls, spec: FetchSpec=None) -> FetchResult[ReliabilityRawDataValidationJob]:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, filter: Filter) -> FetchResult[ReliabilityRawDataValidationJob]:
    """
    ...
    """
        ...
    @classmethod
    def fetchObjStream(cls, spec: FetchStreamSpec=None) -> Union[Stream[ReliabilityRawDataValidationJob]]:
    """
    Fetches multiple obj instances based on a specification.  Only objs that the caller is authorized to fetch will be
    returned.
    ...
    """
        ...
    @classmethod
    def fetchMultiLocale(cls, spec: MultiLocaleFetchSpec=None) -> Union[Map[str, FetchResult[ReliabilityRawDataValidationJob]]]:
    """
    ...
    """
        ...
    def get(self, include: str=None) -> Union[ReliabilityRawDataValidationJob]:
    """
    ...
    """
        ...
    def getSpecific(self, include: str=None) -> Union[ReliabilityRawDataValidationJob]:
    """
    ...
    """
        ...
    def getMissing(self, spec: GetMissingSpec) -> ReliabilityRawDataValidationJob:
    """
    ...
    """
        ...
    def getDirect(self, include: str=None) -> Union[ReliabilityRawDataValidationJob]:
    """
    ...
    """
        ...
    def applyReverseEdit(self, versionEdit: VersionEdit) -> ReliabilityRawDataValidationJob:
    """
    ...
    """
        ...
    @classmethod
    def fromString(cls, s: str) -> Union[ReliabilityRawDataValidationJob]:
    """
    ...
    """
        ...
    def create(self, spec: UpsertSpec=None) -> Union[ReliabilityRawDataValidationJob]:
    """
    ...
    """
        ...
    @classmethod
    def createBatch(cls, objs: Array[ReliabilityRawDataValidationJob], spec: UpsertSpec=None) -> Union[ObjList[ReliabilityRawDataValidationJob]]:
    """
    ...
    """
        ...
    @classmethod
    def createBatchObjStream(cls, objs: Stream[ReliabilityRawDataValidationJob], spec: CreateBatchObjStreamSpec=None) -> Union[ObjList[ReliabilityRawDataValidationJob]]:
    """
    Creates multiple instances of a C3 type. If the operation fails and {@link UpsertSpec#dontThrowOnBatchError} is not
    specified (the default), then a C3BatchException will be thrown.  Otherwise {@link errors will be reported in the
    returned {@link ObjList}.  This will fail if any of the instances already exist.
    ...
    """
        ...
    def update(self, srcObj: ReliabilityRawDataValidationJob=None, spec: UpsertSpec=None) -> Union[ReliabilityRawDataValidationJob]:
    """
    ...
    """
        ...
    def upsert(self, srcObj: ReliabilityRawDataValidationJob=None, spec: UpsertSpec=None) -> Union[ReliabilityRawDataValidationJob]:
    """
    ...
    """
        ...
    @overload
    def merge(self, spec: MergeSpec=None) -> Union[ReliabilityRawDataValidationJob]:
    """
    ...
    """
        ...
    @overload
    def merge(self, mergeInclude: str, spec: MergeSpec=None) -> Union[ReliabilityRawDataValidationJob]:
    """
    ...
    """
        ...
    def touch(self, spec: TouchSpec=None) -> Union[ReliabilityRawDataValidationJob]:
    """
    ...
    """
        ...
    @classmethod
    def updateBatch(cls, objs: Array[ReliabilityRawDataValidationJob], srcObjs: Array[ReliabilityRawDataValidationJob]=None, spec: UpsertSpec=None) -> Union[ObjList[ReliabilityRawDataValidationJob]]:
    """
    ...
    """
        ...
    @classmethod
    def updateObjs(cls, objs: Callable[[], Union[Array[ReliabilityRawDataValidationJob]]], spec: UpsertSpec=None) -> Union[ObjList[ReliabilityRawDataValidationJob]]:
    """
    ...
    """
        ...
    @classmethod
    def upsertBatch(cls, objs: Array[ReliabilityRawDataValidationJob], srcObjs: Array[ReliabilityRawDataValidationJob]=None, spec: UpsertSpec=None) -> Union[ObjList[ReliabilityRawDataValidationJob]]:
    """
    ...
    """
        ...
    @classmethod
    def upsertObjs(cls, objs: Callable[[], Union[Array[ReliabilityRawDataValidationJob]]], spec: UpsertSpec=None) -> Union[ObjList[ReliabilityRawDataValidationJob]]:
    """
    Creates instances of a C3 type if they don't already exist and updates them if they do exist. If the operation
    ...
    """
        ...
    @classmethod
    def touchBatch(cls, objs: Array[ReliabilityRawDataValidationJob], spec: TouchSpec=None) -> Union[ObjList[ReliabilityRawDataValidationJob]]:
    """
    ...
    @overload
    @classmethod
    def mergeBatch(cls, objs: Array[ReliabilityRawDataValidationJob], spec: MergeSpec=None) -> Union[ObjList[ReliabilityRawDataValidationJob]]:
    """
    ...
    @overload
    @classmethod
    def mergeBatch(cls, objs: Array[ReliabilityRawDataValidationJob], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[ReliabilityRawDataValidationJob]]:
    """
    Merges multiple instances of a C3 type or creates them if they don't exist. If the operation fails and {@link
    UpsertSpec#dontThrowOnBatchError} is not specified (the default), then a C3BatchException will be thrown.
    Otherwise errors will be reported in the returned {@link ObjList}.  The merge operation is described in the {@link
    ...
    """
        ...
    @classmethod
    def mergeObjs(cls, objs: Callable[[], Union[Array[ReliabilityRawDataValidationJob]]], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[ReliabilityRawDataValidationJob]]:
    """
    ...
    @overload
    @classmethod
    def mergeAll(cls, mergeObj: ReliabilityRawDataValidationJob, spec: MergeAllSpec=None) -> Union[int]:
    """
    ...
    @overload
    @classmethod
    def mergeAll(cls, mergeObj: ReliabilityRawDataValidationJob, mergeInclude: str, spec: MergeAllSpec=None) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def removeBatch(cls, objs: Array[ReliabilityRawDataValidationJob], spec: UpsertSpec=None) -> Union[ObjList[ReliabilityRawDataValidationJob]]:
    """
    ...
    """
        ...
    @classmethod
    def replace(cls, objs: Array[ReliabilityRawDataValidationJob], spec: UpsertSpec=None) -> Union[ObjList[ReliabilityRawDataValidationJob]]:
    """
    ...
    """
        ...
    def unremove(self) -> Union[ReliabilityRawDataValidationJob]:
    """
    ...
    """
        ...
    @classmethod
    def beforeCreate(cls, objs: Array[ReliabilityRawDataValidationJob]) -> ObjList[ReliabilityRawDataValidationJob]:
    """
    ...
    """
        ...
    @classmethod
    def beforeUpdate(cls, objs: Array[ReliabilityRawDataValidationJob]) -> ObjList[ReliabilityRawDataValidationJob]:
    """
    ...
    """
        ...
    @classmethod
    def beforeRemove(cls, objs: Array[ReliabilityRawDataValidationJob]) -> ObjList[ReliabilityRawDataValidationJob]:
    """
    ...
    """
        ...
    @classmethod
    def afterCreate(cls, objs: Array[ReliabilityRawDataValidationJob]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def afterUpdate(cls, objs: Array[ReliabilityRawDataValidationJob]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def afterRemove(cls, objs: Array[ReliabilityRawDataValidationJob]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def startImportData(cls, spec: StartImportDataSpec=None) -> PushStream[ReliabilityRawDataValidationJob]:
    """
    @return a push stream to import instances of this type.
    """
        ...
    @classmethod
    def startImportDataWithStats(cls, spec: StartImportDataSpec=None) -> PushStreamWithStats[ReliabilityRawDataValidationJob]:
    """
    @return a push stream to import instances of this type.
    """
        ...
    ...
    """
        ...
    @classmethod
    def forId(cls, id: str, failIfMissing: bool=None) -> Union[ReliabilityRawDataValidationJob]:
    """
    ...
    """
        ...
    def withoutIdentity(self) -> Union[ReliabilityRawDataValidationJob]:
    """
    ...
    """
        ...
    @classmethod
    def typeOfBatch(cls, objs: Array[ReliabilityRawDataValidationJob]) -> Union[Array[EntityType]]:
    """
    ...
    """
        ...
    @classmethod
    def dbEcho(cls, template: ReliabilityRawDataValidationJob=None, count: int=None, sendBack: bool=None) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def callbackLogic(cls, objs: Array[ReliabilityRawDataValidationJob], callback: Callable[[Union[ReliabilityRawDataValidationJob]], Union[ReliabilityRawDataValidationJob]]=None) -> ObjList[ReliabilityRawDataValidationJob]:
    """
    ...
    """
        ...
    @classmethod
    def afterCallbackLogic(cls, objs: Array[ReliabilityRawDataValidationJob], callback: Callable[[Union[ReliabilityRawDataValidationJob]], Union[ReliabilityRawDataValidationJob]]=None) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def doStart(cls, job: ReliabilityRawDataValidationJob=None, options: ReliabilityRawDataValidationJobOptions=None) -> None:
    """
    In this function, all the raw data {@link File}s will be read, batched,
    and dispatched to {@link processBatch}.
    """
        ...
    @classmethod
    def processBatch(cls, batch: ReliabilityRawDataValidationJobBatch=None, job: ReliabilityRawDataValidationJob=None, options: ReliabilityRawDataValidationJobOptions=None) -> None:
    """
    In this function, all the files in the dispatched batch from {@link doStart}
    are validated with a call to {@link ReliabilityRawDataValidationHelper#validateFile}.
    This will generate a {@link ReliabilityRawDataValidationFileReport} per {@link File}.
    """
        ...
    @classmethod
    def allComplete(cls, job: ReliabilityRawDataValidationJob, options: ReliabilityRawDataValidationJobOptions=None) -> Union[str]:
    """
    In this function, all the {@link ReliabilityRawDataValidationFileReport}s from
    {@link processBatch} will be cross-validated by a call to
    {@link ReliabilityRawDataValidationHelper#crossValidateReports}. An overall
    {@link ReliabilityRawDataValidationReport} is generated.
    """
        ...
    @classmethod
    def failed(cls, job: ReliabilityRawDataValidationJob, status: BatchJobStatus, options: ReliabilityRawDataValidationJobOptions=None) -> None:
    """
    ...
    """
        ...
    def scheduleBatch(self, batch: ReliabilityRawDataValidationJobBatch=None) -> None:
    """
    ...
    """
        ...
    def scheduleBatches(self, batches: Array[ReliabilityRawDataValidationJobBatch]=None) -> None:
    """
    ...
    """
        ...
    @classmethod
    def scheduleObjBatch(cls, job: ReliabilityRawDataValidationJob=None, objBatch: ObjBatch=None, logPrefix: str=None) -> Union[int]:
    """
