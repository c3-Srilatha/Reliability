...
from c3.reliabilityCapability.FaultySensor.ImpactedRelationsBatchResult import FaultySensor.ImpactedRelationsBatchResult
...
from c3.reliabilityCapability.FaultySensor.ModelRetrainValidationInput import FaultySensor.ModelRetrainValidationInput
...
# Python definitions for the C3 type FaultySensor.ModelImpactMapReduceJob


class ModelImpactMapReduceJob(MapReduce[ReliabilityAssetToRiskModelRelation, string, FaultySensor.ModelImpactMapReduceJob.InterValType, FaultySensor.ModelRetrainValidationResult]):
    """
    ...
    targetFilter: Optional[ReliabilityAssetToRiskModelRelation]=None
    """
    ...
    multipleAssetRelationsPerModel: Optional[bool]=None
    """
    ...
    callMockMapApis: Optional[bool]=None
    """
    ...
    callMockReduceApis: Optional[bool]=None
    """
    Use only for testing. If this is true, then call the mock APIs defined on this type. Those functions will throw
    exceptions, but if they are mocked it can allow for testing.
    """
    def __init__(self, run: Optional[MapReduceRun]=None, runs: Optional[Array[MapReduceRun]]=None, options: Optional[Obj]=None, onCompleteCallback: Optional[JobBase.Callback]=None, priority: Optional[int]=None, disabled: Optional[bool]=None, maxConcurrency: Optional[int]=None, maxConcurrencyPerNode: Optional[int]=None, runAsUser: Optional[bool]=None, nodePool: Optional[str]=None, skipIfRunning: Optional[bool]=None, numAutoRecoveryAttempts: Optional[int]=None, propagateActionContext: Optional[bool]=None, targetType: Optional[Type]=None, useFileSystemForInterVals: Optional[bool]=None, useBatchIdsForReadInput: Optional[bool]=None, include: Optional[str]=None, filter: Optional[str]=None, order: Optional[str]=None, limit: Optional[int]=None, samplePct: Optional[int]=None, batchSize: Optional[int]=None, subBatchSize: Optional[int]=None, numBatches: Optional[int]=None, abortOnError: Optional[bool]=None, typeIdent: Optional[str]=None, id: Optional[str]=None, versionEdits: Optional[Array[VersionEdit]]=None, name: Optional[str]=None, meta: Optional[Meta]=None, version: Optional[int]=None, typeWithBindings: Optional[Type]=None, targetFilter: Optional[ReliabilityAssetToRiskModelRelation]=None, updatedSensors: Optional[Array[Sensor]]=None, multipleAssetRelationsPerModel: Optional[bool]=None, callMockMapApis: Optional[bool]=None, callMockReduceApis: Optional[bool]=None) -> None: ...
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[FaultySensor.ModelImpactMapReduceJob]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[FaultySensor.ModelImpactMapReduceJob]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[FaultySensor.ModelImpactMapReduceJob]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[FaultySensor.ModelImpactMapReduceJob]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> FaultySensor.ModelImpactMapReduceJob:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> FaultySensor.ModelImpactMapReduceJob:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> FaultySensor.ModelImpactMapReduceJob:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[FaultySensor.ModelImpactMapReduceJob]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[FaultySensor.ModelImpactMapReduceJob]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> FaultySensor.ModelImpactMapReduceJob:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> FaultySensor.ModelImpactMapReduceJob:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> FaultySensor.ModelImpactMapReduceJob:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> FaultySensor.ModelImpactMapReduceJob:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> FaultySensor.ModelImpactMapReduceJob:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> FaultySensor.ModelImpactMapReduceJob:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> FaultySensor.ModelImpactMapReduceJob:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> FaultySensor.ModelImpactMapReduceJob:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> FaultySensor.ModelImpactMapReduceJob:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> FaultySensor.ModelImpactMapReduceJob:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> FaultySensor.ModelImpactMapReduceJob:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> FaultySensor.ModelImpactMapReduceJob:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> FaultySensor.ModelImpactMapReduceJob:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> FaultySensor.ModelImpactMapReduceJob:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> FaultySensor.ModelImpactMapReduceJob:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> FaultySensor.ModelImpactMapReduceJob:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> FaultySensor.ModelImpactMapReduceJob:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> FaultySensor.ModelImpactMapReduceJob:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> FaultySensor.ModelImpactMapReduceJob:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> FaultySensor.ModelImpactMapReduceJob:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> FaultySensor.ModelImpactMapReduceJob:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> FaultySensor.ModelImpactMapReduceJob:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> FaultySensor.ModelImpactMapReduceJob:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> FaultySensor.ModelImpactMapReduceJob:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> FaultySensor.ModelImpactMapReduceJob:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> FaultySensor.ModelImpactMapReduceJob:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> FaultySensor.ModelImpactMapReduceJob:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> FaultySensor.ModelImpactMapReduceJob:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[FaultySensor.ModelImpactMapReduceJob]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[FaultySensor.ModelImpactMapReduceJob]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[FaultySensor.ModelImpactMapReduceJob]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[FaultySensor.ModelImpactMapReduceJob]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[FaultySensor.ModelImpactMapReduceJob]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, FaultySensor.ModelImpactMapReduceJob]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, FaultySensor.ModelImpactMapReduceJob]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[FaultySensor.ModelImpactMapReduceJob]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[FaultySensor.ModelImpactMapReduceJob]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> FaultySensor.ModelImpactMapReduceJob:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> FaultySensor.ModelImpactMapReduceJob:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> FaultySensor.ModelImpactMapReduceJob:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> FaultySensor.ModelImpactMapReduceJob:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> FaultySensor.ModelImpactMapReduceJob:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> FaultySensor.ModelImpactMapReduceJob:
    """
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[FaultySensor.ModelImpactMapReduceJob]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> FaultySensor.ModelImpactMapReduceJob:
    """
    ...
    """
        ...
    def afterMake(self) -> FaultySensor.ModelImpactMapReduceJob:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> FaultySensor.ModelImpactMapReduceJob:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[FaultySensor.ModelImpactMapReduceJob]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> FaultySensor.ModelImpactMapReduceJob:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, spec: FetchSpec=None) -> FetchResult[FaultySensor.ModelImpactMapReduceJob]:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, filter: Filter) -> FetchResult[FaultySensor.ModelImpactMapReduceJob]:
    """
    ...
    """
        ...
    @classmethod
    def fetchObjStream(cls, spec: FetchStreamSpec=None) -> Union[Stream[FaultySensor.ModelImpactMapReduceJob]]:
    """
    Fetches multiple obj instances based on a specification.  Only objs that the caller is authorized to fetch will be
    returned.
    ...
    """
        ...
    @classmethod
    def fetchMultiLocale(cls, spec: MultiLocaleFetchSpec=None) -> Union[Map[str, FetchResult[FaultySensor.ModelImpactMapReduceJob]]]:
    """
    ...
    """
        ...
    def get(self, include: str=None) -> Union[FaultySensor.ModelImpactMapReduceJob]:
    """
    ...
    """
        ...
    def getSpecific(self, include: str=None) -> Union[FaultySensor.ModelImpactMapReduceJob]:
    """
    ...
    """
        ...
    def getMissing(self, spec: GetMissingSpec) -> FaultySensor.ModelImpactMapReduceJob:
    """
    ...
    """
        ...
    def getDirect(self, include: str=None) -> Union[FaultySensor.ModelImpactMapReduceJob]:
    """
    ...
    """
        ...
    def applyReverseEdit(self, versionEdit: VersionEdit) -> FaultySensor.ModelImpactMapReduceJob:
    """
    ...
    """
        ...
    @classmethod
    def fromString(cls, s: str) -> Union[FaultySensor.ModelImpactMapReduceJob]:
    """
    ...
    """
        ...
    def create(self, spec: UpsertSpec=None) -> Union[FaultySensor.ModelImpactMapReduceJob]:
    """
    ...
    """
        ...
    @classmethod
    def createBatch(cls, objs: Array[FaultySensor.ModelImpactMapReduceJob], spec: UpsertSpec=None) -> Union[ObjList[FaultySensor.ModelImpactMapReduceJob]]:
    """
    ...
    """
        ...
    @classmethod
    def createBatchObjStream(cls, objs: Stream[FaultySensor.ModelImpactMapReduceJob], spec: CreateBatchObjStreamSpec=None) -> Union[ObjList[FaultySensor.ModelImpactMapReduceJob]]:
    """
    Creates multiple instances of a C3 type. If the operation fails and {@link UpsertSpec#dontThrowOnBatchError} is not
    specified (the default), then a C3BatchException will be thrown.  Otherwise {@link errors will be reported in the
    returned {@link ObjList}.  This will fail if any of the instances already exist.
    ...
    """
        ...
    def update(self, srcObj: FaultySensor.ModelImpactMapReduceJob=None, spec: UpsertSpec=None) -> Union[FaultySensor.ModelImpactMapReduceJob]:
    """
    ...
    """
        ...
    def upsert(self, srcObj: FaultySensor.ModelImpactMapReduceJob=None, spec: UpsertSpec=None) -> Union[FaultySensor.ModelImpactMapReduceJob]:
    """
    ...
    """
        ...
    @overload
    def merge(self, spec: MergeSpec=None) -> Union[FaultySensor.ModelImpactMapReduceJob]:
    """
    ...
    """
        ...
    @overload
    def merge(self, mergeInclude: str, spec: MergeSpec=None) -> Union[FaultySensor.ModelImpactMapReduceJob]:
    """
    ...
    """
        ...
    def touch(self, spec: TouchSpec=None) -> Union[FaultySensor.ModelImpactMapReduceJob]:
    """
    ...
    """
        ...
    @classmethod
    def updateBatch(cls, objs: Array[FaultySensor.ModelImpactMapReduceJob], srcObjs: Array[FaultySensor.ModelImpactMapReduceJob]=None, spec: UpsertSpec=None) -> Union[ObjList[FaultySensor.ModelImpactMapReduceJob]]:
    """
    ...
    """
        ...
    @classmethod
    def updateObjs(cls, objs: Callable[[], Union[Array[FaultySensor.ModelImpactMapReduceJob]]], spec: UpsertSpec=None) -> Union[ObjList[FaultySensor.ModelImpactMapReduceJob]]:
    """
    ...
    """
        ...
    @classmethod
    def upsertBatch(cls, objs: Array[FaultySensor.ModelImpactMapReduceJob], srcObjs: Array[FaultySensor.ModelImpactMapReduceJob]=None, spec: UpsertSpec=None) -> Union[ObjList[FaultySensor.ModelImpactMapReduceJob]]:
    """
    ...
    """
        ...
    @classmethod
    def upsertObjs(cls, objs: Callable[[], Union[Array[FaultySensor.ModelImpactMapReduceJob]]], spec: UpsertSpec=None) -> Union[ObjList[FaultySensor.ModelImpactMapReduceJob]]:
    """
    Creates instances of a C3 type if they don't already exist and updates them if they do exist. If the operation
    ...
    """
        ...
    @classmethod
    def touchBatch(cls, objs: Array[FaultySensor.ModelImpactMapReduceJob], spec: TouchSpec=None) -> Union[ObjList[FaultySensor.ModelImpactMapReduceJob]]:
    """
    ...
    @overload
    @classmethod
    def mergeBatch(cls, objs: Array[FaultySensor.ModelImpactMapReduceJob], spec: MergeSpec=None) -> Union[ObjList[FaultySensor.ModelImpactMapReduceJob]]:
    """
    ...
    @overload
    @classmethod
    def mergeBatch(cls, objs: Array[FaultySensor.ModelImpactMapReduceJob], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[FaultySensor.ModelImpactMapReduceJob]]:
    """
    Merges multiple instances of a C3 type or creates them if they don't exist. If the operation fails and {@link
    UpsertSpec#dontThrowOnBatchError} is not specified (the default), then a C3BatchException will be thrown.
    Otherwise errors will be reported in the returned {@link ObjList}.  The merge operation is described in the {@link
    ...
    """
        ...
    @classmethod
    def mergeObjs(cls, objs: Callable[[], Union[Array[FaultySensor.ModelImpactMapReduceJob]]], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[FaultySensor.ModelImpactMapReduceJob]]:
    """
    ...
    @overload
    @classmethod
    def mergeAll(cls, mergeObj: FaultySensor.ModelImpactMapReduceJob, spec: MergeAllSpec=None) -> Union[int]:
    """
    ...
    @overload
    @classmethod
    def mergeAll(cls, mergeObj: FaultySensor.ModelImpactMapReduceJob, mergeInclude: str, spec: MergeAllSpec=None) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def removeBatch(cls, objs: Array[FaultySensor.ModelImpactMapReduceJob], spec: UpsertSpec=None) -> Union[ObjList[FaultySensor.ModelImpactMapReduceJob]]:
    """
    ...
    """
        ...
    @classmethod
    def replace(cls, objs: Array[FaultySensor.ModelImpactMapReduceJob], spec: UpsertSpec=None) -> Union[ObjList[FaultySensor.ModelImpactMapReduceJob]]:
    """
    ...
    """
        ...
    def unremove(self) -> Union[FaultySensor.ModelImpactMapReduceJob]:
    """
    ...
    """
        ...
    @classmethod
    def beforeCreate(cls, objs: Array[FaultySensor.ModelImpactMapReduceJob]) -> ObjList[FaultySensor.ModelImpactMapReduceJob]:
    """
    ...
    """
        ...
    @classmethod
    def beforeUpdate(cls, objs: Array[FaultySensor.ModelImpactMapReduceJob]) -> ObjList[FaultySensor.ModelImpactMapReduceJob]:
    """
    ...
    """
        ...
    @classmethod
    def beforeRemove(cls, objs: Array[FaultySensor.ModelImpactMapReduceJob]) -> ObjList[FaultySensor.ModelImpactMapReduceJob]:
    """
    ...
    """
        ...
    @classmethod
    def afterCreate(cls, objs: Array[FaultySensor.ModelImpactMapReduceJob]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def afterUpdate(cls, objs: Array[FaultySensor.ModelImpactMapReduceJob]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def afterRemove(cls, objs: Array[FaultySensor.ModelImpactMapReduceJob]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def startImportData(cls, spec: StartImportDataSpec=None) -> PushStream[FaultySensor.ModelImpactMapReduceJob]:
    """
    @return a push stream to import instances of this type.
    """
        ...
    @classmethod
    def startImportDataWithStats(cls, spec: StartImportDataSpec=None) -> PushStreamWithStats[FaultySensor.ModelImpactMapReduceJob]:
    """
    @return a push stream to import instances of this type.
    """
        ...
    ...
    """
        ...
    @classmethod
    def forId(cls, id: str, failIfMissing: bool=None) -> Union[FaultySensor.ModelImpactMapReduceJob]:
    """
    ...
    """
        ...
    def withoutIdentity(self) -> Union[FaultySensor.ModelImpactMapReduceJob]:
    """
    ...
    """
        ...
    @classmethod
    def typeOfBatch(cls, objs: Array[FaultySensor.ModelImpactMapReduceJob]) -> Union[Array[EntityType]]:
    """
    ...
    """
        ...
    @classmethod
    def dbEcho(cls, template: FaultySensor.ModelImpactMapReduceJob=None, count: int=None, sendBack: bool=None) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def callbackLogic(cls, objs: Array[FaultySensor.ModelImpactMapReduceJob], callback: Callable[[Union[FaultySensor.ModelImpactMapReduceJob]], Union[FaultySensor.ModelImpactMapReduceJob]]=None) -> ObjList[FaultySensor.ModelImpactMapReduceJob]:
    """
    ...
    """
        ...
    @classmethod
    def afterCallbackLogic(cls, objs: Array[FaultySensor.ModelImpactMapReduceJob], callback: Callable[[Union[FaultySensor.ModelImpactMapReduceJob]], Union[FaultySensor.ModelImpactMapReduceJob]]=None) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def map(cls, batch: int=None, objs: Array[ReliabilityAssetToRiskModelRelation]=None, job: MapReduce[ReliabilityAssetToRiskModelRelation, str, FaultySensor.ModelImpactMapReduceJob.InterValType, FaultySensor.ModelRetrainValidationResult]=None, subBatch: int=None) -> Union[Map[str, FaultySensor.ModelImpactMapReduceJob.InterValType]]:
    """
    ...
    **Note:** relations for which it was not possible to verify if they are impacted
    ...
    """
        ...
    @classmethod
    def reduce(cls, outKey: str=None, interValues: Array[FaultySensor.ModelImpactMapReduceJob.InterValType]=None, job: MapReduce[ReliabilityAssetToRiskModelRelation, str, FaultySensor.ModelImpactMapReduceJob.InterValType, FaultySensor.ModelRetrainValidationResult]=None) -> Union[Union[FaultySensor.ModelRetrainValidationResult,Array[FaultySensor.ModelRetrainValidationResult]]]:
    """
    ...
    """
        ...
    @classmethod
    def mapCompleted(cls, job: MapReduce[ReliabilityAssetToRiskModelRelation, str, FaultySensor.ModelImpactMapReduceJob.InterValType, FaultySensor.ModelRetrainValidationResult]=None) -> None:
    """
    ...
    """
        ...
    @classmethod
    def completed(cls, job: MapReduce[ReliabilityAssetToRiskModelRelation, str, FaultySensor.ModelImpactMapReduceJob.InterValType, FaultySensor.ModelRetrainValidationResult]=None) -> Union[str]:
    """
    ...
    """
        ...
    @classmethod
    def failed(cls, job: MapReduce[ReliabilityAssetToRiskModelRelation, str, FaultySensor.ModelImpactMapReduceJob.InterValType, FaultySensor.ModelRetrainValidationResult], status: MapReduceStatus, options: MapReduceOptions=None) -> None:
    """
    ...
    """
        ...
    def results(self, limit: int='10000') -> Union[Map[str, Union[FaultySensor.ModelRetrainValidationResult,Array[FaultySensor.ModelRetrainValidationResult]]]]:
    """
    ...
    """
        ...
    @classmethod
    def retrieveMapReduceResults(cls, mapReduceJob: FaultySensor.ModelImpactMapReduceJob) -> Union[Map[str, FaultySensor.ModelRetrainValidationResult]]:
    """
    ...
    """
        ...
    @classmethod
    def filterRelationsImpactedBySensorsBatch(cls, relations: Array[ReliabilityAssetToRiskModelRelation], modelIdsToSourceOfTruthModels: Map[str, ReliabilityRiskMlModel], updatedSensors: Array[Sensor]) -> FaultySensor.ImpactedRelationsBatchResult:
    """
    ...
    """
        ...
    @classmethod
    def validateModelCanBeRetrained(cls, validationSpec: FaultySensor.ModelRetrainValidationInput) -> FaultySensor.ModelRetrainValidationResult:
    """
    ...
    """
        ...
    @classmethod
    def doValidateModelWithDatasetPrepCanBeRetrained(cls, validationSpec: FaultySensor.ModelRetrainValidationInput) -> FaultySensor.ModelRetrainValidationResult:
    """
    ...
    """
        ...
    @classmethod
    def validateDatasetPrepRunMasks(cls, validationSpec: FaultySensor.ModelRetrainValidationInput, run: ReliabilityMlDatasetPreparationRun, faulty_sensor_metric_safe_ids: Any=None, faulty_sensor_expected_sensor_ids: Any=None, faulty_sensor_ids: Any=None) -> Union[FaultySensor.ModelRetrainValidationResult]:
    """
    ...
    """
        ...
    @classmethod
    def validateDatasetPrepRunFeatures(cls, validationSpec: FaultySensor.ModelRetrainValidationInput, run: ReliabilityMlDatasetPreparationRun, faulty_sensor_ids: Any=None) -> Union[FaultySensor.ModelRetrainValidationResult]:
    """
    ...
    """
        ...
    @classmethod
    def _get_faulty_sensor_ids(cls, reliability_asset: ReliabilityAsset, maximum_faulty_sensors: int='2000') -> Union[Any]:
    """
    ...
    """
        ...
    @classmethod
    def _are_sensor_ids_used_in_metric_str(cls, expr: str=None, all_sensor_related_ids: Any=None) -> Union[str]:
    """
    ...
    """
        ...
    @classmethod
    def _add_relations_for_runs_to_arr(cls, runs: Array[ReliabilityMlDatasetPreparationRun]=None, run_id_to_relation_ids_map: Map[str, str]=None, relation_id_to_relations_map: Map[str, Array[ReliabilityAssetToRiskModelRelation]]=None, array_to_add_to: Any=None) -> None:
    """
    ...
    """
        ...
    @classmethod
    def _add_relations_for_impacted_sensors(cls, run_to_sensors: Array[Pair[ReliabilityMlDatasetPreparationRun, Array[str]]]=None, run_id_to_relation_ids_map: Map[str, str]=None, relation_id_to_relations_map: Map[str, Array[ReliabilityAssetToRiskModelRelation]]=None, impacted_sensors_arr: Any=None) -> None:
    """
    This function takes in a list of runs that have been processed to match a certain criteria. It will
    then find which {@link ReliabilityAssetToRiskModelRelation}s used this run before adding those relations to the
    ...
    """
        ...
    @classmethod
    def _generate_populated_relations_to_sot_model_map(cls, relations: Array[ReliabilityAssetToRiskModelRelation]=None, modelIdsToSourceOfTruthModels: Map[str, ReliabilityRiskMlModel]=None) -> Union[Map[str, ReliabilityRiskMlModel]]:
    """
    ...
    """
        ...
    @classmethod
    def _source_of_truth_model_include(cls) -> str:
    """
    ...
    """
        ...
    @classmethod
    def _merge_dictionaries_with_lists(cls, dict1: Any=None, dict2: Any=None) -> Union[Any]:
    """
    ...
    class InterValType():
        """
        An intermediate type in the {@link FaultySensor.ModelImpactMapReduceJob}. The key is the ID of the model
        that all #impactedRelations are related to.
        
        This type is the result of identifying which relations are impacted by {@link Sensor}s becoming faulty or
        operational.
        
        @remarks this represents a made instance of FaultySensor.ModelImpactMapReduceJob.InterValType
        """
        
        impactedRelations: Optional[Array[ReliabilityAssetToRiskModelRelation]]
        """
        The relations that were impacted by the {@link FaultySensor.ModelImpactMapReduceJob#updatedSensors}.
        See {@link FaultySensor.ModelImpactMapReduceJob#map} for more details.
        """

        sourceOfTruthModel: Optional[ReliabilityMlModel]
        """
        The [source of truth](FaultySensor.RiskModelSourceOfTruthRelation) model for the specific
        [model](ReliabilityRiskMlModel). The model is the one with ID equal the the key in the result from
        {@link FaultySensor.ModelImpactMapReduceJob#map}.
        """

        sensorToImpactedRelations: Optional[Map[str, Array[ReliabilityAssetToRiskModelRelation]]]=None
        """
        A map of {@link Sensor} ids to the #impactedRelations. This is used for generating notifications in
        {@link FaultySensor.Notification}.
        """
        def __init__(self, impactedRelations: Optional[Array[ReliabilityAssetToRiskModelRelation]]=None, sourceOfTruthModel: Optional[ReliabilityMlModel]=None, sensorToImpactedRelations: Optional[Map[str, Array[ReliabilityAssetToRiskModelRelation]]]=None) -> None: ...
        ...
        """
            ...
        @classmethod
        def fromJson(cls, json: any) -> Union[FaultySensor.ModelImpactMapReduceJob.InterValType]:
        """
        Load the JSON-based representation and reconstruct the corresponding object.
        ...
        """
            ...
        @classmethod
        def fromJsonString(cls, json: str) -> Union[FaultySensor.ModelImpactMapReduceJob.InterValType]:
        """
        Load the JSON-based representation and reconstruct the corresponding object.
        ...
        """
            ...
        @classmethod
        def fromXmlString(cls, xml: str) -> Union[FaultySensor.ModelImpactMapReduceJob.InterValType]:
        """
        Load the XML-based representation and reconstruct the corresponding object.
        ...
        """
            ...
        @classmethod
        def deserialize(cls, contentStr: str, contentType: str) -> Union[FaultySensor.ModelImpactMapReduceJob.InterValType]:
        """
        Load from contentType representation and reconstruct the corresponding object.
        ...
        """
            ...
        def replaceType(self, old: Type, new: Type) -> FaultySensor.ModelImpactMapReduceJob.InterValType:
        """
        Returns new instance with all references to old type, including result of #type, replaced with new type. If new
        type does not contain fields from old or field value types are not convertable then drops the field.
        ...
        """
            ...
        @overload
        def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> FaultySensor.ModelImpactMapReduceJob.InterValType:
        """
        Result of this function call is a copy of current instance with all non empty fields replaced based on results of
        the `mapper` invocation.
        ...
        """
            ...
        @overload
        def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> FaultySensor.ModelImpactMapReduceJob.InterValType:
        """
        Result of this function call is a copy of current instance with all fields replaced based on results of the
        `mapper` invocation.
        ...
        """
            ...
        @overload
        def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[FaultySensor.ModelImpactMapReduceJob.InterValType]:
        """
        Result of this function call is a copy of current instance with all non empty fields replaced based on results of
        the asynchronous `mapper` invocation.
        ...
        """
            ...
        @overload
        def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[FaultySensor.ModelImpactMapReduceJob.InterValType]:
        """
        Result of this function call is a copy of current instance with all fields replaced based on results of the
        asynchronous `mapper` invocation.
        ...
        """
            ...
        def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> FaultySensor.ModelImpactMapReduceJob.InterValType:
        """
        Result of this function call is a copy of current instance with specified field value replaced based on result of
        the `mapper` invocation.
        @param field
        ...
        """
            ...
        @overload
        def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> FaultySensor.ModelImpactMapReduceJob.InterValType:
        """
        Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
        lambda application.
        ...
        """
            ...
        @overload
        def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> FaultySensor.ModelImpactMapReduceJob.InterValType:
        """
        Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
        lambda application.
        ...
        """
            ...
        @overload
        def validateObj(self) -> FaultySensor.ModelImpactMapReduceJob.InterValType:
        """
        Populates all missing default values and throws error if any constraint is violated.
        """
            ...
        ...
        """
            ...
        @overload
        def withField(self, field: str, value: Any, doNotConvert: bool=None) -> FaultySensor.ModelImpactMapReduceJob.InterValType:
        """
        Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
        defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
        ...
        """
            ...
        @overload
        def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> FaultySensor.ModelImpactMapReduceJob.InterValType:
        """
        Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
        defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
        ...
        """
            ...
        def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> FaultySensor.ModelImpactMapReduceJob.InterValType:
        """
        Builds a new Obj instance by adding the provided fields in it. The name must correspond to an existing fields
        defined on this type or its mixins. The values must be of the correct type if doNotConvert flag is true.
        ...
        """
            ...
        def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> FaultySensor.ModelImpactMapReduceJob.InterValType:
        """
        Builds a new Obj with the value at the specified path field. If the field is null, the field #isFieldSet to null.
        If you would like to #unsetField, you should call #withoutFieldAtPath instead.
        ...
        """
            ...
        def withoutFieldAtPath(self, path: str) -> FaultySensor.ModelImpactMapReduceJob.InterValType:
        """
        Builds a new Obj without the specified path field.
        ...
        """
            ...
        @overload
        def withoutField(self, field: str) -> FaultySensor.ModelImpactMapReduceJob.InterValType:
        """
        Builds a new Obj, removing the field with the provided name.
        ...
        """
            ...
        @overload
        def withoutField(self, field: FieldType) -> FaultySensor.ModelImpactMapReduceJob.InterValType:
        """
        Builds a new Obj, removing the field with the provided field type.
        ...
        """
            ...
        def withoutFields(self, fields: Array[str]) -> FaultySensor.ModelImpactMapReduceJob.InterValType:
        """
        Builds a new Obj, removing the fields with the provided names.
        ...
        """
            ...
        def withoutFieldsByType(self, fields: Array[FieldType]) -> FaultySensor.ModelImpactMapReduceJob.InterValType:
        """
        Builds a new Obj, removing the fields with the provided field types. Be sure to use the FieldType instance for the
        exact same type as the type of the obj to respect the "ordinal" of the field type
        ...
        """
            ...
        def withoutSecretFields(self) -> FaultySensor.ModelImpactMapReduceJob.InterValType:
        """
        @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
        """
            ...
        ...
        """
            ...
        def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> FaultySensor.ModelImpactMapReduceJob.InterValType:
        """
        Builds a new Obj instance by adding the default values (if defined) for all unset fields. This is implemented by
        calling {@link FieldType#defaultValue defaultValue} for a field if it is not already set and
        {@link FieldType#hasDefault has a default}. It will also set {@see ValueType#initialValue initial values} for
        ...
        """
            ...
        @overload
        def defaultField(self, field: str) -> FaultySensor.ModelImpactMapReduceJob.InterValType:
        """
        Builds a new Obj, by setting a field on this `Obj` to the field's default value. If the field has no default, this
        method will behave the same as {@link #unsetField}.
        ...
        """
            ...
        @overload
        def defaultField(self, field: FieldType) -> FaultySensor.ModelImpactMapReduceJob.InterValType:
        """
        Builds a new Obj, by setting a field on this `Obj` to the fields default value. If the field has no default, this
        method will behave the same as {@link #unsetField}.
        ...
        """
            ...
        @overload
        def unsetField(self, field: str) -> FaultySensor.ModelImpactMapReduceJob.InterValType:
        """
        Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
        is different from {@link removeField}
        ...
        """
            ...
        @overload
        def unsetField(self, field: FieldType) -> FaultySensor.ModelImpactMapReduceJob.InterValType:
        """
        Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
        is different from {@link removeField}
        ...
        """
            ...
        @overload
        def removeField(self, field: str) -> FaultySensor.ModelImpactMapReduceJob.InterValType:
        """
        Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
        is different from {@link #unsetField}
        ...
        """
            ...
        @overload
        def removeField(self, field: FieldType) -> FaultySensor.ModelImpactMapReduceJob.InterValType:
        """
        Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
        is different from {@link #unsetField}
        ...
        """
            ...
        @overload
        def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> FaultySensor.ModelImpactMapReduceJob.InterValType:
        """
        Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
        In case of conflicts, fields of other instance take precedence unless otherwise specified by the fieldPathMergeSpec
        ...
        """
            ...
        @overload
        def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> FaultySensor.ModelImpactMapReduceJob.InterValType:
        """
        Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
        In case of conflicts, fields of other instance take precedence.
        ...
        """
            ...
        @overload
        def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> FaultySensor.ModelImpactMapReduceJob.InterValType:
        """
        Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
        fields that exist on other Obj and do not exist on this Obj will not be added to final Obj.
        @param deep
        ...
        """
            ...
        @overload
        def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> FaultySensor.ModelImpactMapReduceJob.InterValType:
        """
        Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
        fields that exist other Obj and do not exist on this Obj will not be added to final Obj or evaluated. Does not
        traverse child reference and collection fields.
        ...
        """
            ...
        def mergeJson(self, json: any) -> FaultySensor.ModelImpactMapReduceJob.InterValType:
            ...
        def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> FaultySensor.ModelImpactMapReduceJob.InterValType:
        """
        Merge the obj references within the current obj
        @param deep
               If set, traverses the reference fields within the obj as well for a deep merge
        ...
        """
            ...
        def sumObj(self, other: Obj, deep: bool=None) -> FaultySensor.ModelImpactMapReduceJob.InterValType:
        """
        Adds the numeric Obj fields with the other Objs respective fields.
        If deep is set it will traverse reference and collection fields and sum corresponding numeric fields in
        references with same name and collection elements at same index or key.
        """
            ...
        def singletonArray(self) -> Array[FaultySensor.ModelImpactMapReduceJob.InterValType]:
        """
        Build an array of the correct type with a single element which is this instance.
        ...
        """
            ...
        @classmethod
        def array(cls, *elements: Array[Any]) -> Union[Array[FaultySensor.ModelImpactMapReduceJob.InterValType]]:
        """
        Creates an array of instances of this type.
        """
            ...
        @classmethod
        def arrayBuilder(cls) -> Union[ArrayBuilder[FaultySensor.ModelImpactMapReduceJob.InterValType]]:
        """
        Creates an array of instances of this type.
        """
            ...
        def singletonSet(self) -> Set[FaultySensor.ModelImpactMapReduceJob.InterValType]:
        """
        Build an set of the correct type with a single element which is this instance.
        ...
        """
            ...
        @classmethod
        def setBuilder(cls) -> Union[SetBuilder[FaultySensor.ModelImpactMapReduceJob.InterValType]]:
        """
        Creates a set of instances of this type.
        """
            ...
        @classmethod
        def mapBuilder(cls) -> Union[MapBuilder[str, FaultySensor.ModelImpactMapReduceJob.InterValType]]:
        """
        Create a map of string to elements of this type.
        """
            ...
        @classmethod
        def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, FaultySensor.ModelImpactMapReduceJob.InterValType]]:
        """
        Create a map with the given key type and elements of this type.
        """
            ...
        ...
        def myStreamType(cls) -> StreamType:
            ...
        def toBuilder(self) -> ObjBuilder[FaultySensor.ModelImpactMapReduceJob.InterValType]:
        """
        @return new ObjBuilder with initial state set to fields of this instance.
        """
            ...
        @classmethod
        def builder(cls) -> ObjBuilder[FaultySensor.ModelImpactMapReduceJob.InterValType]:
        """
        @return new ObjBuilder of this instance.
        """
            ...
        @overload
        @classmethod
        def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> FaultySensor.ModelImpactMapReduceJob.InterValType:
        """
        Construct instance of this type from provided field values and options
        """
            ...
        @overload
        @classmethod
        def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> FaultySensor.ModelImpactMapReduceJob.InterValType:
        """
        Construct an instance of this type from provided fields
        @param fields
                   Fields to construct the instance of the obj with
        ...
        @overload
        @classmethod
        def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> FaultySensor.ModelImpactMapReduceJob.InterValType:
        """
        Construct instance of this type from provided field values and options
        """
            ...
        @overload
        @classmethod
        def make(cls, withDefaults: bool=None) -> FaultySensor.ModelImpactMapReduceJob.InterValType:
        """
        Construct an instance of this type with no non-default field values unless explicitly specified by passing param true
        @param withDefaults
                   If set, then the Obj is made with default & initial values (required primitive fields e.g. !int32 -> 0)
        ...
        @overload
        @classmethod
        def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> FaultySensor.ModelImpactMapReduceJob.InterValType:
        """
        Construct an instance from provided fields
        @param fields
                   Fields (in the format <field_name, value>) to construct an instance of the obj. Note that "type" as a
        ...
        @overload
        @classmethod
        def make(cls, fields: Any, withDefaults: bool=None) -> FaultySensor.ModelImpactMapReduceJob.InterValType:
        """
        Construct an instance of this type from provided fields. Note it is more efficient to use #fromFields and other overloads
        ...
        """
            ...
        @classmethod
        def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> FaultySensor.ModelImpactMapReduceJob.InterValType:
        """
        Construct an instance of this type from provided instance of a subtype or a "duck type".
        """
            ...
        ...
        """
            ...
        def afterMake(self) -> FaultySensor.ModelImpactMapReduceJob.InterValType:
        """
        Optional override that will be called after every instance creation.
        ...
        """
            ...
        @classmethod
        def cachedEmptyInst(cls) -> FaultySensor.ModelImpactMapReduceJob.InterValType:
        """
        Creates an empty inst using `MyType.make()` and caches it. Avoid recreating multiple copies of the spec for
        every action dispatch. The cached inst can also be used for comparing whether the object is an empty or not
        Will only create empty instance for immutable Obj e.g. if an Obj is Mutable, this method will throw an error
        ...
        """
            ...
        @classmethod
        def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[FaultySensor.ModelImpactMapReduceJob.InterValType]]:
        """
        Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
        value is read.
        """
            ...
        @classmethod
        def generateObj(cls, spec: Obj.GenerateSpec=None) -> FaultySensor.ModelImpactMapReduceJob.InterValType:
        """
        Generate a single instance of this type. The base implementation uses {@link DataGenObj} to generate uniform
        random (gibberish) values for all fields, but it may be overridden by specific types with custom logic that
        populates fields in a more realistic way.
