...
class DataValidationRun(FilterableByFacility):
    """
    @inheritdoc
    ...
    """
    An optional parent {@link ReliabilityAsset} to filter down the scope of entities validated for some rules.
    """

    displayStatus: Optional[str]=None
    """
    A translated representation of {@link DataValidationRun#runStatus} to be used in the UI.
    """
    def __init__(self, id: Optional[str]=None, versionEdits: Optional[Array[VersionEdit]]=None, name: Optional[str]=None, meta: Optional[Meta]=None, version: Optional[int]=None, typeWithBindings: Optional[Type]=None, facilityFilterPaths: Optional[Array[str]]=None, timestamp: Optional[datetime]=None, rootRuleset: Optional[DataValidationRuleset]=None, subject: Optional[DataValidationSubject]=None, args: Optional[Map[str, Any]]=None, results: Optional[Array[DataValidationResult]]=None, persistedResults: Optional[Array[DataValidationPersistedResult]]=None, rulesetResults: Optional[Array[DataValidationRulesetResult]]=None, persistedRulesetResults: Optional[Array[DataValidationPersistedRulesetResult]]=None, numViolations: Optional[int]=None, job: Optional[Union[DataValidationMapReduceJob,DataValidationBatchJob]]=None, jobId: Optional[str]=None, jobError: Optional[str]=None, runStatus: Optional[str]=None, validationStatus: Optional[DataValidationStatus]=None, parentAsset: Optional[ReliabilityAsset]=None, displayStatus: Optional[str]=None) -> None: ...
