...
class FailureModeLibrary(AssetOnboardingMeta, ExemptFromFacilityFilter):
    """
    ...
    """
    def __init__(self, assetOnboardingSourceFile: Optional[AssetOnboardingSourceFile]=None, configurationLastUpdated: Optional[datetime]=None, id: Optional[str]=None, versionEdits: Optional[Array[VersionEdit]]=None, name: Optional[str]=None, meta: Optional[Meta]=None, version: Optional[int]=None, typeWithBindings: Optional[Type]=None, typeIdent: Optional[str]=None, failureModes: Optional[Array[FailureMode]]=None, countFailureModes: Optional[int]=None) -> None: ...
