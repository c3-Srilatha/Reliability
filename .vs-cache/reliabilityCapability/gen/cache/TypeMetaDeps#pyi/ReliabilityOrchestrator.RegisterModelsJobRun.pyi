...
from c3.reliabilityCapability.ReliabilityOrchestrator.RegisterModelsJobResult import ReliabilityOrchestrator.RegisterModelsJobResult
...
from c3.reliabilityCapability.ReliabilityOrchestrator.RegisterModelsJob import ReliabilityOrchestrator.RegisterModelsJob
...
# Python definitions for the C3 type ReliabilityOrchestrator.RegisterModelsJobRun


class RegisterModelsJobRun(MlWorkflowCoordinatable[ReliabilityOrchestrator.RegisterModelsJobResult]):
    """
    Manages the execution of a set of register model job runs for multiple {@link ReliabilityMlModel}s.
    This is created by {@link ReliabilityOrchestrator.RegisterModelsJob#start}.
    
    @remarks this represents a made instance of ReliabilityOrchestrator.RegisterModelsJobRun
    """
    ...
    job: Optional[ReliabilityOrchestrator.RegisterModelsJob]
    """
    {@link ReliabilityOrchestrator.RegisterModelsJob} that this job run belongs to
    """

    modelFilter: Optional[str]
    """
    Specify the modelFilter for which models should be registered.
    """

    options: Optional[ReliabilityOrchestrator.JobOptions]=None
    """
    Spec that was used to specify execution constraints for this register models job run.
    """

    file: Optional[File]=None
    """
    Contains a {@link File} that can be ported to the target environment, and used to load
    {@link ReliabilityMlModel}s in the target environment.
    """
    def __init__(self, typeIdent: Optional[str]=None, id: Optional[str]=None, versionEdits: Optional[Array[VersionEdit]]=None, name: Optional[str]=None, meta: Optional[Meta]=None, version: Optional[int]=None, typeWithBindings: Optional[Type]=None, jobOptions: Optional[JobOptions]=None, job: Optional[ReliabilityOrchestrator.RegisterModelsJob]=None, modelFilter: Optional[str]=None, options: Optional[ReliabilityOrchestrator.JobOptions]=None, file: Optional[File]=None) -> None: ...
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[ReliabilityOrchestrator.RegisterModelsJobRun]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[ReliabilityOrchestrator.RegisterModelsJobRun]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[ReliabilityOrchestrator.RegisterModelsJobRun]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[ReliabilityOrchestrator.RegisterModelsJobRun]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> ReliabilityOrchestrator.RegisterModelsJobRun:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> ReliabilityOrchestrator.RegisterModelsJobRun:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> ReliabilityOrchestrator.RegisterModelsJobRun:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[ReliabilityOrchestrator.RegisterModelsJobRun]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[ReliabilityOrchestrator.RegisterModelsJobRun]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> ReliabilityOrchestrator.RegisterModelsJobRun:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> ReliabilityOrchestrator.RegisterModelsJobRun:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> ReliabilityOrchestrator.RegisterModelsJobRun:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> ReliabilityOrchestrator.RegisterModelsJobRun:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> ReliabilityOrchestrator.RegisterModelsJobRun:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> ReliabilityOrchestrator.RegisterModelsJobRun:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> ReliabilityOrchestrator.RegisterModelsJobRun:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> ReliabilityOrchestrator.RegisterModelsJobRun:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> ReliabilityOrchestrator.RegisterModelsJobRun:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> ReliabilityOrchestrator.RegisterModelsJobRun:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> ReliabilityOrchestrator.RegisterModelsJobRun:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> ReliabilityOrchestrator.RegisterModelsJobRun:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> ReliabilityOrchestrator.RegisterModelsJobRun:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> ReliabilityOrchestrator.RegisterModelsJobRun:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> ReliabilityOrchestrator.RegisterModelsJobRun:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> ReliabilityOrchestrator.RegisterModelsJobRun:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> ReliabilityOrchestrator.RegisterModelsJobRun:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> ReliabilityOrchestrator.RegisterModelsJobRun:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> ReliabilityOrchestrator.RegisterModelsJobRun:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> ReliabilityOrchestrator.RegisterModelsJobRun:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> ReliabilityOrchestrator.RegisterModelsJobRun:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> ReliabilityOrchestrator.RegisterModelsJobRun:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> ReliabilityOrchestrator.RegisterModelsJobRun:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> ReliabilityOrchestrator.RegisterModelsJobRun:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> ReliabilityOrchestrator.RegisterModelsJobRun:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> ReliabilityOrchestrator.RegisterModelsJobRun:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> ReliabilityOrchestrator.RegisterModelsJobRun:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> ReliabilityOrchestrator.RegisterModelsJobRun:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[ReliabilityOrchestrator.RegisterModelsJobRun]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[ReliabilityOrchestrator.RegisterModelsJobRun]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[ReliabilityOrchestrator.RegisterModelsJobRun]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[ReliabilityOrchestrator.RegisterModelsJobRun]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[ReliabilityOrchestrator.RegisterModelsJobRun]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, ReliabilityOrchestrator.RegisterModelsJobRun]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, ReliabilityOrchestrator.RegisterModelsJobRun]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[ReliabilityOrchestrator.RegisterModelsJobRun]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[ReliabilityOrchestrator.RegisterModelsJobRun]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> ReliabilityOrchestrator.RegisterModelsJobRun:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> ReliabilityOrchestrator.RegisterModelsJobRun:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> ReliabilityOrchestrator.RegisterModelsJobRun:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> ReliabilityOrchestrator.RegisterModelsJobRun:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> ReliabilityOrchestrator.RegisterModelsJobRun:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> ReliabilityOrchestrator.RegisterModelsJobRun:
    """
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[ReliabilityOrchestrator.RegisterModelsJobRun]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> ReliabilityOrchestrator.RegisterModelsJobRun:
    """
    ...
    """
        ...
    def afterMake(self) -> ReliabilityOrchestrator.RegisterModelsJobRun:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> ReliabilityOrchestrator.RegisterModelsJobRun:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[ReliabilityOrchestrator.RegisterModelsJobRun]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> ReliabilityOrchestrator.RegisterModelsJobRun:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, spec: FetchSpec=None) -> FetchResult[ReliabilityOrchestrator.RegisterModelsJobRun]:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, filter: Filter) -> FetchResult[ReliabilityOrchestrator.RegisterModelsJobRun]:
    """
    ...
    """
        ...
    @classmethod
    def fetchObjStream(cls, spec: FetchStreamSpec=None) -> Union[Stream[ReliabilityOrchestrator.RegisterModelsJobRun]]:
    """
    Fetches multiple obj instances based on a specification.  Only objs that the caller is authorized to fetch will be
    returned.
    ...
    """
        ...
    @classmethod
    def fetchMultiLocale(cls, spec: MultiLocaleFetchSpec=None) -> Union[Map[str, FetchResult[ReliabilityOrchestrator.RegisterModelsJobRun]]]:
    """
    ...
    """
        ...
    def get(self, include: str=None) -> Union[ReliabilityOrchestrator.RegisterModelsJobRun]:
    """
    ...
    """
        ...
    def getSpecific(self, include: str=None) -> Union[ReliabilityOrchestrator.RegisterModelsJobRun]:
    """
    ...
    """
        ...
    def getMissing(self, spec: GetMissingSpec) -> ReliabilityOrchestrator.RegisterModelsJobRun:
    """
    ...
    """
        ...
    def getDirect(self, include: str=None) -> Union[ReliabilityOrchestrator.RegisterModelsJobRun]:
    """
    ...
    """
        ...
    def applyReverseEdit(self, versionEdit: VersionEdit) -> ReliabilityOrchestrator.RegisterModelsJobRun:
    """
    ...
    """
        ...
    @classmethod
    def fromString(cls, s: str) -> Union[ReliabilityOrchestrator.RegisterModelsJobRun]:
    """
    ...
    """
        ...
    def create(self, spec: UpsertSpec=None) -> Union[ReliabilityOrchestrator.RegisterModelsJobRun]:
    """
    ...
    """
        ...
    @classmethod
    def createBatch(cls, objs: Array[ReliabilityOrchestrator.RegisterModelsJobRun], spec: UpsertSpec=None) -> Union[ObjList[ReliabilityOrchestrator.RegisterModelsJobRun]]:
    """
    ...
    """
        ...
    @classmethod
    def createBatchObjStream(cls, objs: Stream[ReliabilityOrchestrator.RegisterModelsJobRun], spec: CreateBatchObjStreamSpec=None) -> Union[ObjList[ReliabilityOrchestrator.RegisterModelsJobRun]]:
    """
    Creates multiple instances of a C3 type. If the operation fails and {@link UpsertSpec#dontThrowOnBatchError} is not
    specified (the default), then a C3BatchException will be thrown.  Otherwise {@link errors will be reported in the
    returned {@link ObjList}.  This will fail if any of the instances already exist.
    ...
    """
        ...
    def update(self, srcObj: ReliabilityOrchestrator.RegisterModelsJobRun=None, spec: UpsertSpec=None) -> Union[ReliabilityOrchestrator.RegisterModelsJobRun]:
    """
    ...
    """
        ...
    def upsert(self, srcObj: ReliabilityOrchestrator.RegisterModelsJobRun=None, spec: UpsertSpec=None) -> Union[ReliabilityOrchestrator.RegisterModelsJobRun]:
    """
    ...
    """
        ...
    @overload
    def merge(self, spec: MergeSpec=None) -> Union[ReliabilityOrchestrator.RegisterModelsJobRun]:
    """
    ...
    """
        ...
    @overload
    def merge(self, mergeInclude: str, spec: MergeSpec=None) -> Union[ReliabilityOrchestrator.RegisterModelsJobRun]:
    """
    ...
    """
        ...
    def touch(self, spec: TouchSpec=None) -> Union[ReliabilityOrchestrator.RegisterModelsJobRun]:
    """
    ...
    """
        ...
    @classmethod
    def updateBatch(cls, objs: Array[ReliabilityOrchestrator.RegisterModelsJobRun], srcObjs: Array[ReliabilityOrchestrator.RegisterModelsJobRun]=None, spec: UpsertSpec=None) -> Union[ObjList[ReliabilityOrchestrator.RegisterModelsJobRun]]:
    """
    ...
    """
        ...
    @classmethod
    def updateObjs(cls, objs: Callable[[], Union[Array[ReliabilityOrchestrator.RegisterModelsJobRun]]], spec: UpsertSpec=None) -> Union[ObjList[ReliabilityOrchestrator.RegisterModelsJobRun]]:
    """
    ...
    """
        ...
    @classmethod
    def upsertBatch(cls, objs: Array[ReliabilityOrchestrator.RegisterModelsJobRun], srcObjs: Array[ReliabilityOrchestrator.RegisterModelsJobRun]=None, spec: UpsertSpec=None) -> Union[ObjList[ReliabilityOrchestrator.RegisterModelsJobRun]]:
    """
    ...
    """
        ...
    @classmethod
    def upsertObjs(cls, objs: Callable[[], Union[Array[ReliabilityOrchestrator.RegisterModelsJobRun]]], spec: UpsertSpec=None) -> Union[ObjList[ReliabilityOrchestrator.RegisterModelsJobRun]]:
    """
    Creates instances of a C3 type if they don't already exist and updates them if they do exist. If the operation
    ...
    """
        ...
    @classmethod
    def touchBatch(cls, objs: Array[ReliabilityOrchestrator.RegisterModelsJobRun], spec: TouchSpec=None) -> Union[ObjList[ReliabilityOrchestrator.RegisterModelsJobRun]]:
    """
    ...
    @overload
    @classmethod
    def mergeBatch(cls, objs: Array[ReliabilityOrchestrator.RegisterModelsJobRun], spec: MergeSpec=None) -> Union[ObjList[ReliabilityOrchestrator.RegisterModelsJobRun]]:
    """
    ...
    @overload
    @classmethod
    def mergeBatch(cls, objs: Array[ReliabilityOrchestrator.RegisterModelsJobRun], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[ReliabilityOrchestrator.RegisterModelsJobRun]]:
    """
    Merges multiple instances of a C3 type or creates them if they don't exist. If the operation fails and {@link
    UpsertSpec#dontThrowOnBatchError} is not specified (the default), then a C3BatchException will be thrown.
    Otherwise errors will be reported in the returned {@link ObjList}.  The merge operation is described in the {@link
    ...
    """
        ...
    @classmethod
    def mergeObjs(cls, objs: Callable[[], Union[Array[ReliabilityOrchestrator.RegisterModelsJobRun]]], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[ReliabilityOrchestrator.RegisterModelsJobRun]]:
    """
    ...
    @overload
    @classmethod
    def mergeAll(cls, mergeObj: ReliabilityOrchestrator.RegisterModelsJobRun, spec: MergeAllSpec=None) -> Union[int]:
    """
    ...
    @overload
    @classmethod
    def mergeAll(cls, mergeObj: ReliabilityOrchestrator.RegisterModelsJobRun, mergeInclude: str, spec: MergeAllSpec=None) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def removeBatch(cls, objs: Array[ReliabilityOrchestrator.RegisterModelsJobRun], spec: UpsertSpec=None) -> Union[ObjList[ReliabilityOrchestrator.RegisterModelsJobRun]]:
    """
    ...
    """
        ...
    @classmethod
    def replace(cls, objs: Array[ReliabilityOrchestrator.RegisterModelsJobRun], spec: UpsertSpec=None) -> Union[ObjList[ReliabilityOrchestrator.RegisterModelsJobRun]]:
    """
    ...
    """
        ...
    def unremove(self) -> Union[ReliabilityOrchestrator.RegisterModelsJobRun]:
    """
    ...
    """
        ...
    @classmethod
    def beforeCreate(cls, objs: Array[ReliabilityOrchestrator.RegisterModelsJobRun]) -> ObjList[ReliabilityOrchestrator.RegisterModelsJobRun]:
    """
    ...
    """
        ...
    @classmethod
    def beforeUpdate(cls, objs: Array[ReliabilityOrchestrator.RegisterModelsJobRun]) -> ObjList[ReliabilityOrchestrator.RegisterModelsJobRun]:
    """
    ...
    """
        ...
    @classmethod
    def beforeRemove(cls, objs: Array[ReliabilityOrchestrator.RegisterModelsJobRun]) -> ObjList[ReliabilityOrchestrator.RegisterModelsJobRun]:
    """
    ...
    """
        ...
    @classmethod
    def afterCreate(cls, objs: Array[ReliabilityOrchestrator.RegisterModelsJobRun]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def afterUpdate(cls, objs: Array[ReliabilityOrchestrator.RegisterModelsJobRun]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def afterRemove(cls, objs: Array[ReliabilityOrchestrator.RegisterModelsJobRun]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def startImportData(cls, spec: StartImportDataSpec=None) -> PushStream[ReliabilityOrchestrator.RegisterModelsJobRun]:
    """
    @return a push stream to import instances of this type.
    """
        ...
    @classmethod
    def startImportDataWithStats(cls, spec: StartImportDataSpec=None) -> PushStreamWithStats[ReliabilityOrchestrator.RegisterModelsJobRun]:
    """
    @return a push stream to import instances of this type.
    """
        ...
    ...
    """
        ...
    @classmethod
    def forId(cls, id: str, failIfMissing: bool=None) -> Union[ReliabilityOrchestrator.RegisterModelsJobRun]:
    """
    ...
    """
        ...
    def withoutIdentity(self) -> Union[ReliabilityOrchestrator.RegisterModelsJobRun]:
    """
    ...
    """
        ...
    @classmethod
    def typeOfBatch(cls, objs: Array[ReliabilityOrchestrator.RegisterModelsJobRun]) -> Union[Array[EntityType]]:
    """
    ...
    """
        ...
    @classmethod
    def dbEcho(cls, template: ReliabilityOrchestrator.RegisterModelsJobRun=None, count: int=None, sendBack: bool=None) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def callbackLogic(cls, objs: Array[ReliabilityOrchestrator.RegisterModelsJobRun], callback: Callable[[Union[ReliabilityOrchestrator.RegisterModelsJobRun]], Union[ReliabilityOrchestrator.RegisterModelsJobRun]]=None) -> ObjList[ReliabilityOrchestrator.RegisterModelsJobRun]:
    """
    ...
    """
        ...
    @classmethod
    def afterCallbackLogic(cls, objs: Array[ReliabilityOrchestrator.RegisterModelsJobRun], callback: Callable[[Union[ReliabilityOrchestrator.RegisterModelsJobRun]], Union[ReliabilityOrchestrator.RegisterModelsJobRun]]=None) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    def generateNextResults(self, completed: Stream[ReliabilityOrchestrator.RegisterModelsJobResult]=None) -> int:
    """
    ...
    """
        ...
    def startResult(self, result: ReliabilityOrchestrator.RegisterModelsJobResult) -> ReliabilityOrchestrator.RegisterModelsJobResult:
    """
    ...
    """
        ...
    def afterStart(self, results: Stream[ReliabilityOrchestrator.RegisterModelsJobResult]) -> Union[Stream[ReliabilityOrchestrator.RegisterModelsJobResult]]:
    """
    ...
    """
        ...
    def completeResult(self, result: ReliabilityOrchestrator.RegisterModelsJobResult) -> ReliabilityOrchestrator.RegisterModelsJobResult:
    """
    ...
    """
        ...
    def updateRunningResults(self, spec: FetchStreamSpec=None) -> Union[Stream[ReliabilityOrchestrator.RegisterModelsJobResult]]:
    """
    ...
    """
        ...
    def afterComplete(self, results: Stream[ReliabilityOrchestrator.RegisterModelsJobResult]) -> Union[Stream[ReliabilityOrchestrator.RegisterModelsJobResult]]:
    """
    ...
    """
        ...
    def runFromResult(self, result: ReliabilityOrchestrator.RegisterModelsJobResult) -> Union[WorkflowExecutorRun]:
    """
    ...
    """
        ...
    def pendingResults(self, spec: FetchStreamSpec=None) -> Union[Stream[ReliabilityOrchestrator.RegisterModelsJobResult]]:
    """
    ...
    """
        ...
    def runningResults(self, spec: FetchStreamSpec=None) -> Union[Stream[ReliabilityOrchestrator.RegisterModelsJobResult]]:
    """
    ...
    """
        ...
    def completedResults(self, spec: FetchStreamSpec=None) -> Union[Stream[ReliabilityOrchestrator.RegisterModelsJobResult]]:
    """
    ...
    """
        ...
    def canceledResults(self, spec: FetchStreamSpec=None) -> Union[Stream[ReliabilityOrchestrator.RegisterModelsJobResult]]:
    """
    ...
    """
        ...
    def erroredResults(self, spec: FetchStreamSpec=None) -> Union[Stream[ReliabilityOrchestrator.RegisterModelsJobResult]]:
    """
    ...
    """
        ...
    def allResults(self, spec: FetchStreamSpec=None) -> Union[Stream[ReliabilityOrchestrator.RegisterModelsJobResult]]:
    """
    ...
    """
        ...
    def customSummaryFieldsForResult(self, result: ReliabilityOrchestrator.RegisterModelsJobResult) -> Union[Map[str, Any]]:
    """
    ...
    """
        ...
    def summaryForResults(self, results: Array[ReliabilityOrchestrator.RegisterModelsJobResult], spec: Workflow.Monitorable.SummarySpec=None) -> Data:
    """
    ...
    """
        ...
    def summaryForResultsPd(self, results: Array[ReliabilityOrchestrator.RegisterModelsJobResult], spec: Workflow.Monitorable.SummarySpec=None) -> Union[Any]:
    """
    ...
    """
        ...
    def resultsForSummary(self, spec: FetchSpec=None) -> Union[FetchResult[ReliabilityOrchestrator.RegisterModelsJobResult]]:
    """
    ...
    """
        ...
    def getModelRegistryFile(self) -> File:
    """
    Returns a {@link File} that can be ported to the target environment, and used to load
    {@link ReliabilityMlModel}s in the target environment.
    """
        ...
