...
# Python definitions for the C3 type ReliabilityDataValidationRuleUpdate


class ReliabilityDataValidationRuleUpdate(SchemaUpgrade):
    """
    This type is used to update the Data Validation Rules by removing or updating existing rules.
    
    @remarks this represents a made instance of ReliabilityDataValidationRuleUpdate
    """
    
    ASSET_TEMPLATE_ACTION_NAME: Optional[str]=None
    """
    `doesAssetTemplateExist` actionName to be removed
    """
    def __init__(self, ASSET_TEMPLATE_ACTION_NAME: Optional[str]=None) -> None: ...
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[ReliabilityDataValidationRuleUpdate]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[ReliabilityDataValidationRuleUpdate]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[ReliabilityDataValidationRuleUpdate]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[ReliabilityDataValidationRuleUpdate]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> ReliabilityDataValidationRuleUpdate:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> ReliabilityDataValidationRuleUpdate:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> ReliabilityDataValidationRuleUpdate:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[ReliabilityDataValidationRuleUpdate]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[ReliabilityDataValidationRuleUpdate]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> ReliabilityDataValidationRuleUpdate:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> ReliabilityDataValidationRuleUpdate:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> ReliabilityDataValidationRuleUpdate:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> ReliabilityDataValidationRuleUpdate:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> ReliabilityDataValidationRuleUpdate:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> ReliabilityDataValidationRuleUpdate:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> ReliabilityDataValidationRuleUpdate:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> ReliabilityDataValidationRuleUpdate:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> ReliabilityDataValidationRuleUpdate:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> ReliabilityDataValidationRuleUpdate:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> ReliabilityDataValidationRuleUpdate:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> ReliabilityDataValidationRuleUpdate:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> ReliabilityDataValidationRuleUpdate:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> ReliabilityDataValidationRuleUpdate:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> ReliabilityDataValidationRuleUpdate:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> ReliabilityDataValidationRuleUpdate:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> ReliabilityDataValidationRuleUpdate:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> ReliabilityDataValidationRuleUpdate:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> ReliabilityDataValidationRuleUpdate:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> ReliabilityDataValidationRuleUpdate:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> ReliabilityDataValidationRuleUpdate:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> ReliabilityDataValidationRuleUpdate:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> ReliabilityDataValidationRuleUpdate:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> ReliabilityDataValidationRuleUpdate:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> ReliabilityDataValidationRuleUpdate:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> ReliabilityDataValidationRuleUpdate:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> ReliabilityDataValidationRuleUpdate:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> ReliabilityDataValidationRuleUpdate:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[ReliabilityDataValidationRuleUpdate]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[ReliabilityDataValidationRuleUpdate]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[ReliabilityDataValidationRuleUpdate]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[ReliabilityDataValidationRuleUpdate]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[ReliabilityDataValidationRuleUpdate]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, ReliabilityDataValidationRuleUpdate]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, ReliabilityDataValidationRuleUpdate]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[ReliabilityDataValidationRuleUpdate]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[ReliabilityDataValidationRuleUpdate]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> ReliabilityDataValidationRuleUpdate:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> ReliabilityDataValidationRuleUpdate:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> ReliabilityDataValidationRuleUpdate:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> ReliabilityDataValidationRuleUpdate:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> ReliabilityDataValidationRuleUpdate:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> ReliabilityDataValidationRuleUpdate:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> ReliabilityDataValidationRuleUpdate:
    """
    ...
    """
        ...
    def afterMake(self) -> ReliabilityDataValidationRuleUpdate:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> ReliabilityDataValidationRuleUpdate:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[ReliabilityDataValidationRuleUpdate]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> ReliabilityDataValidationRuleUpdate:
    """
    ...
    """
        ...
    @classmethod
    def removeDataValidationRule_1(cls, actionName: str=None) -> Union[Any]:
    """
    This method is used to remove any {@link DataValidationRule} based on a given action Name.
    """
        ...
    @classmethod
    def removeAssetTemplateRule_1(cls) -> Union[Any]:
    """
    This method updates the {@link DataValidationRule} type by removing the rules with the actionName `doesAssetTemplateExist`
    """
        ...
