...
from c3.reliabilityCapability.InventorySeriesFetchSpec import InventorySeriesFetchSpec
...
from c3.reliabilityDataModel.WorkOrderPartsForecast import WorkOrderPartsForecast
...
from c3.reliabilityDataModel.InventoryMeasurement import InventoryMeasurement
...
from c3.reliabilityCapability.InventorySeriesRefreshStatsBatchJobOptions import InventorySeriesRefreshStatsBatchJobOptions
...
# Python definitions for the C3 type InventorySeries


class InventorySeries(TimedDataHeader[InventoryMeasurement], MetricEvaluatable, InventoryStats, WorkOrderStats, PurchaseOrderStats):
    """
    {@link TimedDataHeader} for {@link InventoryMeasurement}
    This header file is used to track parts tied to {@link WorkOrder}s and items tied to {@link PurchaseOrder}s.
    Type which introduces various statistics related fields and their calculation capability into {@link InventorySeries}.
    
    @remarks this represents a made instance of InventorySeries
    """
    ...
    data: Optional[Array[InventoryMeasurement]]=None
    """
    ...
    avgDailyUsage: Optional[float]=None
    """
    ...
    avgLeadTime: Optional[float]=None
    """
    ...
    calculatedAvgLeadTime: Optional[float]=None
    """
    ...
    **Note**: If the user doesn't provide their own {#avgLeadTime},  only then this field is computed.
    ...
    dohOverLeadTimeRatio: Optional[float]=None
    """
    ...
    workOrdersReserved: Optional[int]=None
    """
    Represents number of {@link WorkOrder}s which have a given {@link InventorySeries#partNumber} part allocated/reserved for it's execution.
    Only considers {@link WorkOrder}s scheduled in the future.
    """

    workOrdersImpacted: Optional[int]=None
    """
    Represents number of {@link WorkOrder}s which have a given {@link InventorySeries#partNumber} required for it's execution, but was not allocated to it.
    Only considers {@link WorkOrder}s scheduled in the future.
    """

    numberOfReorders: Optional[int]=None
    """
    Represents number of {@link PurchaseOrderLine}s for a given {@link InventorySeries#partNumber} that have been placed in the past.
    """
    ...
    itemFacility: Optional[str]=None
    """
    The item facility associated with this series
    """

    treatment: Optional[str]=None
    """
    The treatment to apply to {@link InventoryMeasurement#quantity}
    """

    forecasts: Optional[Array[WorkOrderPartsForecast]]=None
    """
    All the inventory related {@link WorkOrderPartsForecast}s that have been made for this part.
    """

    unitConstraint: Optional[Unit]=None
    """
    The {@link Unit} to apply to {@link InventoryMeasurement}s if none is provided
    directly on the measurement
    """

    partNumber: Optional[str]=None
    """
    A unique identifier for the part.  This should never be duplicated across unique parts
    """
    ...
    """
    def __init__(self, earliest: Optional[datetime]=None, latest: Optional[datetime]=None, earliestTsDp: Optional[Map[str, TSDataPoint]]=None, latestTsDp: Optional[Map[str, TSDataPoint]]=None, interval: Optional[str]=None, timeZone: Optional[str]=None, doNotNormalize: Optional[bool]=None, data: Optional[Array[InventoryMeasurement]]=None, interpolator: Optional[str]=None, duplicateHandling: Optional[str]=None, overlapHandling: Optional[str]=None, bucketInterval: Optional[str]=None, normalizationPartitionStrategy: Optional[NormalizationPartitionStrategy]=None, extrapolate: Optional[bool]=None, avgDailyUsage: Optional[float]=None, currentStock: Optional[int]=None, avgLeadTime: Optional[float]=None, calculatedAvgLeadTime: Optional[float]=None, reorderLevel: Optional[int]=None, reorderQty: Optional[int]=None, daysOnHand: Optional[int]=None, dohOverLeadTimeRatio: Optional[float]=None, workOrdersReserved: Optional[int]=None, workOrdersImpacted: Optional[int]=None, numberOfReorders: Optional[int]=None, typeIdent: Optional[str]=None, id: Optional[str]=None, versionEdits: Optional[Array[VersionEdit]]=None, name: Optional[str]=None, meta: Optional[Meta]=None, version: Optional[int]=None, typeWithBindings: Optional[Type]=None, itemFacility: Optional[str]=None, treatment: Optional[str]=None, forecasts: Optional[Array[WorkOrderPartsForecast]]=None, unitConstraint: Optional[Unit]=None, partNumber: Optional[str]=None, description: Optional[str]=None, supplier: Optional[str]=None, cost: Optional[float]=None) -> None: ...
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[InventorySeries]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[InventorySeries]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[InventorySeries]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[InventorySeries]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> InventorySeries:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> InventorySeries:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> InventorySeries:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[InventorySeries]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[InventorySeries]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> InventorySeries:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> InventorySeries:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> InventorySeries:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> InventorySeries:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> InventorySeries:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> InventorySeries:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> InventorySeries:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> InventorySeries:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> InventorySeries:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> InventorySeries:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> InventorySeries:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> InventorySeries:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> InventorySeries:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> InventorySeries:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> InventorySeries:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> InventorySeries:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> InventorySeries:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> InventorySeries:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> InventorySeries:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> InventorySeries:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> InventorySeries:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> InventorySeries:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> InventorySeries:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> InventorySeries:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> InventorySeries:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> InventorySeries:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> InventorySeries:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> InventorySeries:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[InventorySeries]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[InventorySeries]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[InventorySeries]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[InventorySeries]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[InventorySeries]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, InventorySeries]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, InventorySeries]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[InventorySeries]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[InventorySeries]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> InventorySeries:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> InventorySeries:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> InventorySeries:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> InventorySeries:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> InventorySeries:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> InventorySeries:
    """
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[InventorySeries]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> InventorySeries:
    """
    ...
    """
        ...
    def afterMake(self) -> InventorySeries:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> InventorySeries:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[InventorySeries]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> InventorySeries:
    """
    ...
    """
        ...
    @classmethod
    def normalizeTimeseries(cls, timeseries: TimedDataFields[InventoryMeasurement]=None, start: datetime=None, end: datetime=None, overrideGrain: str=None, forceGrainDetection: bool=None, force: bool=None) -> None:
    """
    ...
    """
        ...
    @classmethod
    def normalize(cls, timeseries: TimedDataFields[InventoryMeasurement]=None, start: datetime=None, end: datetime=None, overrideGrain: str=None, forceGrainDetection: bool=None) -> Union[NormalizationResult]:
    """
    ...
    **Note:**`` If data is removed, there will be no incremental normalization, but the series will be fully normalized at the appropriate time as defined in the {@link NormalizationMode}.
    ...
    """
        ...
    @classmethod
    def normalizationUnit(cls, rawHeader: TimedDataFields[InventoryMeasurement], tsField: str) -> Union[Unit]:
    """
    ...
    """
        ...
    @classmethod
    def normalizationTreatment(cls, rawHeader: TimedDataFields[InventoryMeasurement], tsField: str) -> str:
    """
    ...
    """
        ...
    @classmethod
    def calculateInventoryStats(cls, seriesObj: InventorySeries, lookBackTimeRange: TimeRange=None) -> InventorySeries:
    """
    ...
    **NOTE:** It's important to note that it defaults to user provided {#avgLeadTime}. Calculation is done as per above formula only in the cases user provided {#avgLeadTime} is missing.
    ...
    """
        ...
    @classmethod
    def calculateWorkOrdersReserved(cls, seriesObj: InventorySeries=None) -> Union[int]:
    """
    Calculates number of {@link WorkOrder}s which have sufficient required parts reserved/allocated to them.
    If no `seriesObj` parameter is passed, gets count of all and any such work orders.
    If `seriesObj` paramter is passed, get count of only those work orders which have part resevred for them.
    Only considers {@link WorkOrder}s scheduled in the future.
    """
        ...
    @classmethod
    def calculateWorkOrdersImpacted(cls, seriesObj: InventorySeries=None) -> Union[int]:
    """
    Calculates number of {@link WorkOrder}s which don't have sufficient required parts allocated to them.
    If no `seriesObj` parameter is passed, gets count of all and any such work orders.
    If `seriesObj` paramter is passed, get count of only those work orders impacted by that part.
    Only considers {@link WorkOrder}s scheduled in the future.
    """
        ...
    @classmethod
    def calculateWorkOrderStats(cls, seriesObj: InventorySeries) -> InventorySeries:
    """
    Calculates {#workOrdersReserved} and {#workOrdersImpacted}
    
    'workOrdersReserved' is the count of {@link WorkOrderPartsForecast} instances that match `part.id`,
    forecasted based on the {@link WorkOrder}s, and have an `inventoryDelta` greater than or equal to 0
    
    `workOrdersImpacted` is the count of {@link WorkOrderPartsForecast} instances that match `part.id`,
    forecasted based on the {@link WorkOrder}s, and have an `inventoryDelta` less than 0
    
    @param seriesObj
             The {@link InventorySeries} instance, for which the stats have to be calculated.
    
    @returns instance of {@link InventorySeries} object with {#workOrdersReserved} and {#workOrdersImpacted} populated.
    """
        ...
    @classmethod
    def calculatePurchaseOrderStats(cls, seriesObj: InventorySeries, lookBackTimeRange: TimeRange=None) -> InventorySeries:
    """
    Calculates {#numberOfReorders}.
    
    @param seriesObj
             The {@link InventorySeries} instance, for which the stats have to be calculated.
    @param lookBackTimeRange
             The {@link TimeRange} which will be used in calculation fo the stats. Defaults to {@link ReliabilitySparePartsConfig#purchaseOrderLookBackMonths}.
    
    @returns instance of {@link InventorySeries} object with {#numberOfReorders} populated.
    """
        ...
    @classmethod
    ...
    @overload
    @classmethod
    def fetch(cls, spec: FetchSpec=None) -> FetchResult[InventorySeries]:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, filter: Filter) -> FetchResult[InventorySeries]:
    """
    ...
    """
        ...
    @classmethod
    def fetchObjStream(cls, spec: FetchStreamSpec=None) -> Union[Stream[InventorySeries]]:
    """
    Fetches multiple obj instances based on a specification.  Only objs that the caller is authorized to fetch will be
    returned.
    ...
    """
        ...
    @classmethod
    def fetchMultiLocale(cls, spec: MultiLocaleFetchSpec=None) -> Union[Map[str, FetchResult[InventorySeries]]]:
    """
    ...
    """
        ...
    def get(self, include: str=None) -> Union[InventorySeries]:
    """
    ...
    """
        ...
    def getSpecific(self, include: str=None) -> Union[InventorySeries]:
    """
    ...
    """
        ...
    def getMissing(self, spec: GetMissingSpec) -> InventorySeries:
    """
    ...
    """
        ...
    def getDirect(self, include: str=None) -> Union[InventorySeries]:
    """
    ...
    """
        ...
    def applyReverseEdit(self, versionEdit: VersionEdit) -> InventorySeries:
    """
    ...
    """
        ...
    @classmethod
    def fromString(cls, s: str) -> Union[InventorySeries]:
    """
    ...
    """
        ...
    def create(self, spec: UpsertSpec=None) -> Union[InventorySeries]:
    """
    ...
    """
        ...
    @classmethod
    def createBatch(cls, objs: Array[InventorySeries], spec: UpsertSpec=None) -> Union[ObjList[InventorySeries]]:
    """
    ...
    """
        ...
    @classmethod
    def createBatchObjStream(cls, objs: Stream[InventorySeries], spec: CreateBatchObjStreamSpec=None) -> Union[ObjList[InventorySeries]]:
    """
    Creates multiple instances of a C3 type. If the operation fails and {@link UpsertSpec#dontThrowOnBatchError} is not
    specified (the default), then a C3BatchException will be thrown.  Otherwise {@link errors will be reported in the
    returned {@link ObjList}.  This will fail if any of the instances already exist.
    ...
    """
        ...
    def update(self, srcObj: InventorySeries=None, spec: UpsertSpec=None) -> Union[InventorySeries]:
    """
    ...
    """
        ...
    def upsert(self, srcObj: InventorySeries=None, spec: UpsertSpec=None) -> Union[InventorySeries]:
    """
    ...
    """
        ...
    @overload
    def merge(self, spec: MergeSpec=None) -> Union[InventorySeries]:
    """
    ...
    """
        ...
    @overload
    def merge(self, mergeInclude: str, spec: MergeSpec=None) -> Union[InventorySeries]:
    """
    ...
    """
        ...
    def touch(self, spec: TouchSpec=None) -> Union[InventorySeries]:
    """
    ...
    """
        ...
    @classmethod
    def updateBatch(cls, objs: Array[InventorySeries], srcObjs: Array[InventorySeries]=None, spec: UpsertSpec=None) -> Union[ObjList[InventorySeries]]:
    """
    ...
    """
        ...
    @classmethod
    def updateObjs(cls, objs: Callable[[], Union[Array[InventorySeries]]], spec: UpsertSpec=None) -> Union[ObjList[InventorySeries]]:
    """
    ...
    """
        ...
    @classmethod
    def upsertBatch(cls, objs: Array[InventorySeries], srcObjs: Array[InventorySeries]=None, spec: UpsertSpec=None) -> Union[ObjList[InventorySeries]]:
    """
    ...
    """
        ...
    @classmethod
    def upsertObjs(cls, objs: Callable[[], Union[Array[InventorySeries]]], spec: UpsertSpec=None) -> Union[ObjList[InventorySeries]]:
    """
    Creates instances of a C3 type if they don't already exist and updates them if they do exist. If the operation
    ...
    """
        ...
    @classmethod
    def touchBatch(cls, objs: Array[InventorySeries], spec: TouchSpec=None) -> Union[ObjList[InventorySeries]]:
    """
    ...
    @overload
    @classmethod
    def mergeBatch(cls, objs: Array[InventorySeries], spec: MergeSpec=None) -> Union[ObjList[InventorySeries]]:
    """
    ...
    @overload
    @classmethod
    def mergeBatch(cls, objs: Array[InventorySeries], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[InventorySeries]]:
    """
    Merges multiple instances of a C3 type or creates them if they don't exist. If the operation fails and {@link
    UpsertSpec#dontThrowOnBatchError} is not specified (the default), then a C3BatchException will be thrown.
    Otherwise errors will be reported in the returned {@link ObjList}.  The merge operation is described in the {@link
    ...
    """
        ...
    @classmethod
    def mergeObjs(cls, objs: Callable[[], Union[Array[InventorySeries]]], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[InventorySeries]]:
    """
    ...
    @overload
    @classmethod
    def mergeAll(cls, mergeObj: InventorySeries, spec: MergeAllSpec=None) -> Union[int]:
    """
    ...
    @overload
    @classmethod
    def mergeAll(cls, mergeObj: InventorySeries, mergeInclude: str, spec: MergeAllSpec=None) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def removeBatch(cls, objs: Array[InventorySeries], spec: UpsertSpec=None) -> Union[ObjList[InventorySeries]]:
    """
    ...
    """
        ...
    @classmethod
    def replace(cls, objs: Array[InventorySeries], spec: UpsertSpec=None) -> Union[ObjList[InventorySeries]]:
    """
    ...
    """
        ...
    def unremove(self) -> Union[InventorySeries]:
    """
    ...
    """
        ...
    @classmethod
    def beforeCreate(cls, objs: Array[InventorySeries]) -> ObjList[InventorySeries]:
    """
    ...
    """
        ...
    @classmethod
    def beforeUpdate(cls, objs: Array[InventorySeries]) -> ObjList[InventorySeries]:
    """
    ...
    """
        ...
    @classmethod
    def beforeRemove(cls, objs: Array[InventorySeries]) -> ObjList[InventorySeries]:
    """
    ...
    """
        ...
    @classmethod
    def afterCreate(cls, objs: Array[InventorySeries]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def afterUpdate(cls, objs: Array[InventorySeries]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def afterRemove(cls, objs: Array[InventorySeries]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def startImportData(cls, spec: StartImportDataSpec=None) -> PushStream[InventorySeries]:
    """
    @return a push stream to import instances of this type.
    """
        ...
    @classmethod
    def startImportDataWithStats(cls, spec: StartImportDataSpec=None) -> PushStreamWithStats[InventorySeries]:
    """
    @return a push stream to import instances of this type.
    """
        ...
    ...
    """
        ...
    @classmethod
    def forId(cls, id: str, failIfMissing: bool=None) -> Union[InventorySeries]:
    """
    ...
    """
        ...
    def withoutIdentity(self) -> Union[InventorySeries]:
    """
    ...
    """
        ...
    @classmethod
    def typeOfBatch(cls, objs: Array[InventorySeries]) -> Union[Array[EntityType]]:
    """
    ...
    """
        ...
    @classmethod
    def dbEcho(cls, template: InventorySeries=None, count: int=None, sendBack: bool=None) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def callbackLogic(cls, objs: Array[InventorySeries], callback: Callable[[Union[InventorySeries]], Union[InventorySeries]]=None) -> ObjList[InventorySeries]:
    """
    ...
    """
        ...
    @classmethod
    def afterCallbackLogic(cls, objs: Array[InventorySeries], callback: Callable[[Union[InventorySeries]], Union[InventorySeries]]=None) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def refreshStats(cls, spec: InventorySeriesFetchSpec=None, partsToRefresh: Array[InventorySeries]='[]') -> None:
    """
    Refreshes and updates the following for the parts resolved through passed in spec:
    - {#daysOnHand}, {#currentStock}, {#avgDailyUsage} calculated via {@link InventoryStats#calculateInventoryStats}.
    - {#workOrdersImpacted}, {#workOrdersReserved} calculated via {@link WorkOrderStats#calculateWorkOrderStats}.
    - {#numberOfReorders} calculated via {@link PurchaseOrderStats#calculatePurchaseOrderStats}.
    
    @param spec
          The {@link InventorySeriesFetchSpec} will be executed on the {@link InventorySeries} type to retrieve parts whose stats will be refreshed.
          The `spec` passed should be compatible with {@link InventorySeries}.
    @param partsToRefresh
          The list of {@link InventorySeries} objects that needs to be refreshed.
    """
        ...
    @classmethod
    def triggerRefreshStatsBatchJob(cls, options: InventorySeriesRefreshStatsBatchJobOptions=None) -> None:
    """
    function that starts a {@link InventorySeriesRefreshStatsBatchJob} to refresh parts' stats.
    """
        ...
