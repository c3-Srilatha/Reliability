...
# Python definitions for the C3 type SensorOperationalStatusEnum


class SensorOperationalStatusEnum():
    """
    ...
    """
    def __init__(self, OPERATIONAL: Optional[str]=None, FAULTY: Optional[str]=None) -> None: ...
