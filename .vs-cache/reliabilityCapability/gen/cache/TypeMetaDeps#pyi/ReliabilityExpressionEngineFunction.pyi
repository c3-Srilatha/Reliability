...
from c3.platform.MetricContext import MetricContext
...
class ReliabilityExpressionEngineFunction(MetricFunctionLibrary, ExpressionEngineFunction):
    ...
    **Note on ML applications**
    ...
    """
        ...
    @classmethod
    def getFeatureContributionsSumHeaderName(cls) -> str:
    """
    Retrieves the correct header name for feature contributions sum.
    """
        ...
    @classmethod
    def getRiskScoreHeaderName(cls) -> str:
    """
    Used to get risk score timeseries header names. Wrapper for {@link MlProject.ReliabilityRisk#getRiskScoreHeaderName}.
    """
        ...
    @classmethod
    def computeTrainingValidationPeriods(cls, datasetPreparationRunId: str) -> Union[Array[Array[TimeRange]]]:
    """
    ...
    """
        ...
    @classmethod
    def getReconstructionHeaderName(cls, sensorId: str, assetId: str=None) -> str:
    """
    ...
    """
        ...
    @classmethod
    def getLatestModelOutputValue(cls, assetId: str) -> Union[Array[any]]:
    """
    ...
    """
        ...
    @classmethod
    def getTopFeatureContributors(cls, alert: Array[ReliabilityAssetAlert]=None, count: int='3') -> str:
    """
    Used in {@link ReliabilityAssetCase#topContributors} to get the top contributing feature names
    """
        ...
    @classmethod
    def getLatestMinModelOutputValue(cls, assetIds: Array[str]) -> Union[any]:
    """
    ...
    """
        ...
    @classmethod
    def formatDateTime(cls, date: datetime, format: str) -> Union[str]:
    """
    Format the datetime according to the specified string. See {@link DateTime#toString} method.
    """
        ...
    @classmethod
    def firstDayOfMonth(cls, timeseries: Timeseries[Any]) -> Union[Timeseries[Any]]:
    """
    ...
    """
        ...
    @classmethod
    def getAssetLevel(cls, depth: int) -> Union[str]:
    """
    ...
    """
        ...
    @classmethod
    def getLabelForValue(cls, configField: str, value: float=None) -> Union[str]:
    """
    ...
    """
        ...
    @classmethod
    def getLatestModelOutput(cls, assetId: str) -> Union[Map[str, ReliabilityMl.Prediction]]:
    """
    ...
    """
        ...
    @classmethod
    def windowAsMetadata(cls, aggFunc: str, expression: str, inputOffset: int, inputSpan: int, inputStep: int, context: MetricContext) -> Timeseries[Any]:
    """
    **NOTE:** In most circumstances, you should use #window. This function is only necessary to avoid
    ...
    """
        ...
    @classmethod
    def getLatestRiskScore(cls, assetId: str) -> Union[ReliabilityRiskScoreMlPrediction]:
    """
    Gets the latest risk score of a {@link ReliabilityAsset}.
    """
        ...
    @classmethod
    def getLatestAvgModelOutputValue(cls, assetIds: Array[str]) -> Union[any]:
    """
    ...
    """
        ...
    @classmethod
    def evalMetricOnLatestRegimeTypeDates(cls, context: MetricContext) -> Union[Timeseries[Any]]:
    """
    ...
    """
        ...
    @classmethod
    def liveModel(cls, assetId: str=None, projectId: str=None) -> Union[ReliabilityMlModel]:
    """
    ...
    """
        ...
    @classmethod
    def getLatestRiskScoreValue(cls, assetId: str) -> Union[float]:
    """
    Get the latest risk score value associated with the {@link ReliabilityAsset}.
    """
        ...
    @classmethod
    def getLatestMinRiskScoreValue(cls, assetIds: Array[str]) -> Union[float]:
    """
    Gets the latest minimum risk score associated a {@link ReliabilityAsset} and its children.
    """
        ...
    @classmethod
    def evalMetricOnRegimeType(cls, metricName: str, regimeType: str, context: MetricContext) -> Union[Timeseries[Any]]:
    """
    Used in metric expressions on {@link ReliabilityAsset} to filter on a specific {@link ReliabilityAssetRegime}.
    """
        ...
    @classmethod
    def getLatestMaxModelOutputValue(cls, assetIds: Array[str]) -> Union[any]:
    """
    ...
    """
        ...
    @classmethod
    def getTranslationWithPostfix(cls, key: str=None, postfix: any=None) -> Union[str]:
    """
