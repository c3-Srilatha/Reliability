...
from c3.reliabilityCapability.ReliabilityOrchestrator.AutomatedRetrainingJob import ReliabilityOrchestrator.AutomatedRetrainingJob
...
from c3.reliabilityCapability.ReliabilityOrchestrator.AutomatedRetrainingJobResult import ReliabilityOrchestrator.AutomatedRetrainingJobResult
...
from c3.reliabilityCapability.ReliabilityOrchestrator.AutomatedRetrainingJobSpec import ReliabilityOrchestrator.AutomatedRetrainingJobSpec
...
# Python definitions for the C3 type ReliabilityOrchestrator.AutomatedRetrainingJobRun


class AutomatedRetrainingJobRun(MlWorkflowCoordinatable[ReliabilityOrchestrator.AutomatedRetrainingJobResult], ReliabilityOrchestrator.JobRun[ReliabilityOrchestrator.AutomatedRetrainingJob, ReliabilityOrchestrator.AutomatedRetrainingJobSpec]):
    """
    Manages the execution of a set of Automated Retraining jobs run for multiple {@link ReliabilityMlModel}s.
    This is created by {@link ReliabilityOrchestrator.AutomatedRetrainingJob#start}.
    
    @remarks this represents a made instance of ReliabilityOrchestrator.AutomatedRetrainingJobRun
    """
    
    job: Optional[ReliabilityOrchestrator.AutomatedRetrainingJob]
    """
    The distributed job this run is an instance of.
    """

    jobSpecs: Optional[Array[ReliabilityOrchestrator.AutomatedRetrainingJobSpec]]
    """
    The array of configurations this job run must execute.
    """

    mlOperationRun: Optional[MlOperationRun[Any]]=None
    """
    When {@link ReliabilityOrchestrator.Job#start} is invoked, it returns an {@link MlOperationRun}.
    That is referenced in this field so that it may be used to fetch the job run for downstream
    debugging, inspection, or monitoring.
    """

    options: Optional[ReliabilityOrchestrator.JobOptions]
    """
    Options that were used to specify execution constraints for this training job run.
    """
    ...
    """
    def __init__(self, job: Optional[ReliabilityOrchestrator.AutomatedRetrainingJob]=None, jobSpecs: Optional[Array[ReliabilityOrchestrator.AutomatedRetrainingJobSpec]]=None, mlOperationRun: Optional[MlOperationRun[Any]]=None, options: Optional[ReliabilityOrchestrator.JobOptions]=None, typeIdent: Optional[str]=None, id: Optional[str]=None, versionEdits: Optional[Array[VersionEdit]]=None, name: Optional[str]=None, meta: Optional[Meta]=None, version: Optional[int]=None, typeWithBindings: Optional[Type]=None, jobOptions: Optional[JobOptions]=None) -> None: ...
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[ReliabilityOrchestrator.AutomatedRetrainingJobRun]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[ReliabilityOrchestrator.AutomatedRetrainingJobRun]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[ReliabilityOrchestrator.AutomatedRetrainingJobRun]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[ReliabilityOrchestrator.AutomatedRetrainingJobRun]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> ReliabilityOrchestrator.AutomatedRetrainingJobRun:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> ReliabilityOrchestrator.AutomatedRetrainingJobRun:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> ReliabilityOrchestrator.AutomatedRetrainingJobRun:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[ReliabilityOrchestrator.AutomatedRetrainingJobRun]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[ReliabilityOrchestrator.AutomatedRetrainingJobRun]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> ReliabilityOrchestrator.AutomatedRetrainingJobRun:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> ReliabilityOrchestrator.AutomatedRetrainingJobRun:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> ReliabilityOrchestrator.AutomatedRetrainingJobRun:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> ReliabilityOrchestrator.AutomatedRetrainingJobRun:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> ReliabilityOrchestrator.AutomatedRetrainingJobRun:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> ReliabilityOrchestrator.AutomatedRetrainingJobRun:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> ReliabilityOrchestrator.AutomatedRetrainingJobRun:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> ReliabilityOrchestrator.AutomatedRetrainingJobRun:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> ReliabilityOrchestrator.AutomatedRetrainingJobRun:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> ReliabilityOrchestrator.AutomatedRetrainingJobRun:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> ReliabilityOrchestrator.AutomatedRetrainingJobRun:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> ReliabilityOrchestrator.AutomatedRetrainingJobRun:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> ReliabilityOrchestrator.AutomatedRetrainingJobRun:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> ReliabilityOrchestrator.AutomatedRetrainingJobRun:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> ReliabilityOrchestrator.AutomatedRetrainingJobRun:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> ReliabilityOrchestrator.AutomatedRetrainingJobRun:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> ReliabilityOrchestrator.AutomatedRetrainingJobRun:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> ReliabilityOrchestrator.AutomatedRetrainingJobRun:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> ReliabilityOrchestrator.AutomatedRetrainingJobRun:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> ReliabilityOrchestrator.AutomatedRetrainingJobRun:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> ReliabilityOrchestrator.AutomatedRetrainingJobRun:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> ReliabilityOrchestrator.AutomatedRetrainingJobRun:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> ReliabilityOrchestrator.AutomatedRetrainingJobRun:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> ReliabilityOrchestrator.AutomatedRetrainingJobRun:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> ReliabilityOrchestrator.AutomatedRetrainingJobRun:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> ReliabilityOrchestrator.AutomatedRetrainingJobRun:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> ReliabilityOrchestrator.AutomatedRetrainingJobRun:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> ReliabilityOrchestrator.AutomatedRetrainingJobRun:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[ReliabilityOrchestrator.AutomatedRetrainingJobRun]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[ReliabilityOrchestrator.AutomatedRetrainingJobRun]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[ReliabilityOrchestrator.AutomatedRetrainingJobRun]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[ReliabilityOrchestrator.AutomatedRetrainingJobRun]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[ReliabilityOrchestrator.AutomatedRetrainingJobRun]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, ReliabilityOrchestrator.AutomatedRetrainingJobRun]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, ReliabilityOrchestrator.AutomatedRetrainingJobRun]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[ReliabilityOrchestrator.AutomatedRetrainingJobRun]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[ReliabilityOrchestrator.AutomatedRetrainingJobRun]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> ReliabilityOrchestrator.AutomatedRetrainingJobRun:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> ReliabilityOrchestrator.AutomatedRetrainingJobRun:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> ReliabilityOrchestrator.AutomatedRetrainingJobRun:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> ReliabilityOrchestrator.AutomatedRetrainingJobRun:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> ReliabilityOrchestrator.AutomatedRetrainingJobRun:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> ReliabilityOrchestrator.AutomatedRetrainingJobRun:
    """
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[ReliabilityOrchestrator.AutomatedRetrainingJobRun]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> ReliabilityOrchestrator.AutomatedRetrainingJobRun:
    """
    ...
    """
        ...
    def afterMake(self) -> ReliabilityOrchestrator.AutomatedRetrainingJobRun:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> ReliabilityOrchestrator.AutomatedRetrainingJobRun:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[ReliabilityOrchestrator.AutomatedRetrainingJobRun]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> ReliabilityOrchestrator.AutomatedRetrainingJobRun:
    """
    ...
    """
        ...
    def status(self) -> Workflow.Status:
    """
    Returns the status of the {@link MlOperationRun}.
    @return The workflow status of the job run.
    """
        ...
    def statusSummary(self) -> Data.Persisted:
    """
    Returns a count of pending, running, completed, and failed.
    Even though `failed` is not an official status, any {@link MlWorkflowCoordinatableResult}
    that is completed but has an `errorCount > 0` is denoted as `failed`.
    @return A {@link Data.Persisted} object containing the status summary counts.
    """
        ...
    def progressSummary(self, grain: str='\'H\'') -> Data.Persisted:
    """
    Returns a {@link Data.Persisted} which contains the history of completion statuses
    of the {@link MlWorkflowCoordinatableResult}s for this job run.
    @param grain
              The time grain for the progress summary (default: 'H' for hourly).
    @return A {@link Data.Persisted} object containing the progress summary history.
    """
        ...
    ...
    @overload
    @classmethod
    def fetch(cls, spec: FetchSpec=None) -> FetchResult[ReliabilityOrchestrator.AutomatedRetrainingJobRun]:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, filter: Filter) -> FetchResult[ReliabilityOrchestrator.AutomatedRetrainingJobRun]:
    """
    ...
    """
        ...
    @classmethod
    def fetchObjStream(cls, spec: FetchStreamSpec=None) -> Union[Stream[ReliabilityOrchestrator.AutomatedRetrainingJobRun]]:
    """
    Fetches multiple obj instances based on a specification.  Only objs that the caller is authorized to fetch will be
    returned.
    ...
    """
        ...
    @classmethod
    def fetchMultiLocale(cls, spec: MultiLocaleFetchSpec=None) -> Union[Map[str, FetchResult[ReliabilityOrchestrator.AutomatedRetrainingJobRun]]]:
    """
    ...
    """
        ...
    def get(self, include: str=None) -> Union[ReliabilityOrchestrator.AutomatedRetrainingJobRun]:
    """
    ...
    """
        ...
    def getSpecific(self, include: str=None) -> Union[ReliabilityOrchestrator.AutomatedRetrainingJobRun]:
    """
    ...
    """
        ...
    def getMissing(self, spec: GetMissingSpec) -> ReliabilityOrchestrator.AutomatedRetrainingJobRun:
    """
    ...
    """
        ...
    def getDirect(self, include: str=None) -> Union[ReliabilityOrchestrator.AutomatedRetrainingJobRun]:
    """
    ...
    """
        ...
    def applyReverseEdit(self, versionEdit: VersionEdit) -> ReliabilityOrchestrator.AutomatedRetrainingJobRun:
    """
    ...
    """
        ...
    @classmethod
    def fromString(cls, s: str) -> Union[ReliabilityOrchestrator.AutomatedRetrainingJobRun]:
    """
    ...
    """
        ...
    def create(self, spec: UpsertSpec=None) -> Union[ReliabilityOrchestrator.AutomatedRetrainingJobRun]:
    """
    ...
    """
        ...
    @classmethod
    def createBatch(cls, objs: Array[ReliabilityOrchestrator.AutomatedRetrainingJobRun], spec: UpsertSpec=None) -> Union[ObjList[ReliabilityOrchestrator.AutomatedRetrainingJobRun]]:
    """
    ...
    """
        ...
    @classmethod
    def createBatchObjStream(cls, objs: Stream[ReliabilityOrchestrator.AutomatedRetrainingJobRun], spec: CreateBatchObjStreamSpec=None) -> Union[ObjList[ReliabilityOrchestrator.AutomatedRetrainingJobRun]]:
    """
    Creates multiple instances of a C3 type. If the operation fails and {@link UpsertSpec#dontThrowOnBatchError} is not
    specified (the default), then a C3BatchException will be thrown.  Otherwise {@link errors will be reported in the
    returned {@link ObjList}.  This will fail if any of the instances already exist.
    ...
    """
        ...
    def update(self, srcObj: ReliabilityOrchestrator.AutomatedRetrainingJobRun=None, spec: UpsertSpec=None) -> Union[ReliabilityOrchestrator.AutomatedRetrainingJobRun]:
    """
    ...
    """
        ...
    def upsert(self, srcObj: ReliabilityOrchestrator.AutomatedRetrainingJobRun=None, spec: UpsertSpec=None) -> Union[ReliabilityOrchestrator.AutomatedRetrainingJobRun]:
    """
    ...
    """
        ...
    @overload
    def merge(self, spec: MergeSpec=None) -> Union[ReliabilityOrchestrator.AutomatedRetrainingJobRun]:
    """
    ...
    """
        ...
    @overload
    def merge(self, mergeInclude: str, spec: MergeSpec=None) -> Union[ReliabilityOrchestrator.AutomatedRetrainingJobRun]:
    """
    ...
    """
        ...
    def touch(self, spec: TouchSpec=None) -> Union[ReliabilityOrchestrator.AutomatedRetrainingJobRun]:
    """
    ...
    """
        ...
    @classmethod
    def updateBatch(cls, objs: Array[ReliabilityOrchestrator.AutomatedRetrainingJobRun], srcObjs: Array[ReliabilityOrchestrator.AutomatedRetrainingJobRun]=None, spec: UpsertSpec=None) -> Union[ObjList[ReliabilityOrchestrator.AutomatedRetrainingJobRun]]:
    """
    ...
    """
        ...
    @classmethod
    def updateObjs(cls, objs: Callable[[], Union[Array[ReliabilityOrchestrator.AutomatedRetrainingJobRun]]], spec: UpsertSpec=None) -> Union[ObjList[ReliabilityOrchestrator.AutomatedRetrainingJobRun]]:
    """
    ...
    """
        ...
    @classmethod
    def upsertBatch(cls, objs: Array[ReliabilityOrchestrator.AutomatedRetrainingJobRun], srcObjs: Array[ReliabilityOrchestrator.AutomatedRetrainingJobRun]=None, spec: UpsertSpec=None) -> Union[ObjList[ReliabilityOrchestrator.AutomatedRetrainingJobRun]]:
    """
    ...
    """
        ...
    @classmethod
    def upsertObjs(cls, objs: Callable[[], Union[Array[ReliabilityOrchestrator.AutomatedRetrainingJobRun]]], spec: UpsertSpec=None) -> Union[ObjList[ReliabilityOrchestrator.AutomatedRetrainingJobRun]]:
    """
    Creates instances of a C3 type if they don't already exist and updates them if they do exist. If the operation
    ...
    """
        ...
    @classmethod
    def touchBatch(cls, objs: Array[ReliabilityOrchestrator.AutomatedRetrainingJobRun], spec: TouchSpec=None) -> Union[ObjList[ReliabilityOrchestrator.AutomatedRetrainingJobRun]]:
    """
    ...
    @overload
    @classmethod
    def mergeBatch(cls, objs: Array[ReliabilityOrchestrator.AutomatedRetrainingJobRun], spec: MergeSpec=None) -> Union[ObjList[ReliabilityOrchestrator.AutomatedRetrainingJobRun]]:
    """
    ...
    @overload
    @classmethod
    def mergeBatch(cls, objs: Array[ReliabilityOrchestrator.AutomatedRetrainingJobRun], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[ReliabilityOrchestrator.AutomatedRetrainingJobRun]]:
    """
    Merges multiple instances of a C3 type or creates them if they don't exist. If the operation fails and {@link
    UpsertSpec#dontThrowOnBatchError} is not specified (the default), then a C3BatchException will be thrown.
    Otherwise errors will be reported in the returned {@link ObjList}.  The merge operation is described in the {@link
    ...
    """
        ...
    @classmethod
    def mergeObjs(cls, objs: Callable[[], Union[Array[ReliabilityOrchestrator.AutomatedRetrainingJobRun]]], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[ReliabilityOrchestrator.AutomatedRetrainingJobRun]]:
    """
    ...
    @overload
    @classmethod
    def mergeAll(cls, mergeObj: ReliabilityOrchestrator.AutomatedRetrainingJobRun, spec: MergeAllSpec=None) -> Union[int]:
    """
    ...
    @overload
    @classmethod
    def mergeAll(cls, mergeObj: ReliabilityOrchestrator.AutomatedRetrainingJobRun, mergeInclude: str, spec: MergeAllSpec=None) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def removeBatch(cls, objs: Array[ReliabilityOrchestrator.AutomatedRetrainingJobRun], spec: UpsertSpec=None) -> Union[ObjList[ReliabilityOrchestrator.AutomatedRetrainingJobRun]]:
    """
    ...
    """
        ...
    @classmethod
    def replace(cls, objs: Array[ReliabilityOrchestrator.AutomatedRetrainingJobRun], spec: UpsertSpec=None) -> Union[ObjList[ReliabilityOrchestrator.AutomatedRetrainingJobRun]]:
    """
    ...
    """
        ...
    def unremove(self) -> Union[ReliabilityOrchestrator.AutomatedRetrainingJobRun]:
    """
    ...
    """
        ...
    @classmethod
    def beforeCreate(cls, objs: Array[ReliabilityOrchestrator.AutomatedRetrainingJobRun]) -> ObjList[ReliabilityOrchestrator.AutomatedRetrainingJobRun]:
    """
    ...
    """
        ...
    @classmethod
    def beforeUpdate(cls, objs: Array[ReliabilityOrchestrator.AutomatedRetrainingJobRun]) -> ObjList[ReliabilityOrchestrator.AutomatedRetrainingJobRun]:
    """
    ...
    """
        ...
    @classmethod
    def beforeRemove(cls, objs: Array[ReliabilityOrchestrator.AutomatedRetrainingJobRun]) -> ObjList[ReliabilityOrchestrator.AutomatedRetrainingJobRun]:
    """
    ...
    """
        ...
    @classmethod
    def afterCreate(cls, objs: Array[ReliabilityOrchestrator.AutomatedRetrainingJobRun]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def afterUpdate(cls, objs: Array[ReliabilityOrchestrator.AutomatedRetrainingJobRun]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def afterRemove(cls, objs: Array[ReliabilityOrchestrator.AutomatedRetrainingJobRun]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def startImportData(cls, spec: StartImportDataSpec=None) -> PushStream[ReliabilityOrchestrator.AutomatedRetrainingJobRun]:
    """
    @return a push stream to import instances of this type.
    """
        ...
    @classmethod
    def startImportDataWithStats(cls, spec: StartImportDataSpec=None) -> PushStreamWithStats[ReliabilityOrchestrator.AutomatedRetrainingJobRun]:
    """
    @return a push stream to import instances of this type.
    """
        ...
    ...
    """
        ...
    @classmethod
    def forId(cls, id: str, failIfMissing: bool=None) -> Union[ReliabilityOrchestrator.AutomatedRetrainingJobRun]:
    """
    ...
    """
        ...
    def withoutIdentity(self) -> Union[ReliabilityOrchestrator.AutomatedRetrainingJobRun]:
    """
    ...
    """
        ...
    @classmethod
    def typeOfBatch(cls, objs: Array[ReliabilityOrchestrator.AutomatedRetrainingJobRun]) -> Union[Array[EntityType]]:
    """
    ...
    """
        ...
    @classmethod
    def dbEcho(cls, template: ReliabilityOrchestrator.AutomatedRetrainingJobRun=None, count: int=None, sendBack: bool=None) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def callbackLogic(cls, objs: Array[ReliabilityOrchestrator.AutomatedRetrainingJobRun], callback: Callable[[Union[ReliabilityOrchestrator.AutomatedRetrainingJobRun]], Union[ReliabilityOrchestrator.AutomatedRetrainingJobRun]]=None) -> ObjList[ReliabilityOrchestrator.AutomatedRetrainingJobRun]:
    """
    ...
    """
        ...
    @classmethod
    def afterCallbackLogic(cls, objs: Array[ReliabilityOrchestrator.AutomatedRetrainingJobRun], callback: Callable[[Union[ReliabilityOrchestrator.AutomatedRetrainingJobRun]], Union[ReliabilityOrchestrator.AutomatedRetrainingJobRun]]=None) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    def generateNextResults(self, completed: Stream[ReliabilityOrchestrator.AutomatedRetrainingJobResult]=None) -> int:
    """
    ...
    """
        ...
    def startResult(self, result: ReliabilityOrchestrator.AutomatedRetrainingJobResult) -> ReliabilityOrchestrator.AutomatedRetrainingJobResult:
    """
    ...
    """
        ...
    def afterStart(self, results: Stream[ReliabilityOrchestrator.AutomatedRetrainingJobResult]) -> Union[Stream[ReliabilityOrchestrator.AutomatedRetrainingJobResult]]:
    """
    ...
    """
        ...
    def completeResult(self, result: ReliabilityOrchestrator.AutomatedRetrainingJobResult) -> ReliabilityOrchestrator.AutomatedRetrainingJobResult:
    """
    ...
    """
        ...
    def updateRunningResults(self, spec: FetchStreamSpec=None) -> Union[Stream[ReliabilityOrchestrator.AutomatedRetrainingJobResult]]:
    """
    ...
    """
        ...
    def afterComplete(self, results: Stream[ReliabilityOrchestrator.AutomatedRetrainingJobResult]) -> Union[Stream[ReliabilityOrchestrator.AutomatedRetrainingJobResult]]:
    """
    ...
    """
        ...
    def runFromResult(self, result: ReliabilityOrchestrator.AutomatedRetrainingJobResult) -> Union[WorkflowExecutorRun]:
    """
    ...
    """
        ...
    def pendingResults(self, spec: FetchStreamSpec=None) -> Union[Stream[ReliabilityOrchestrator.AutomatedRetrainingJobResult]]:
    """
    ...
    """
        ...
    def runningResults(self, spec: FetchStreamSpec=None) -> Union[Stream[ReliabilityOrchestrator.AutomatedRetrainingJobResult]]:
    """
    ...
    """
        ...
    def completedResults(self, spec: FetchStreamSpec=None) -> Union[Stream[ReliabilityOrchestrator.AutomatedRetrainingJobResult]]:
    """
    ...
    """
        ...
    def canceledResults(self, spec: FetchStreamSpec=None) -> Union[Stream[ReliabilityOrchestrator.AutomatedRetrainingJobResult]]:
    """
    ...
    """
        ...
    def erroredResults(self, spec: FetchStreamSpec=None) -> Union[Stream[ReliabilityOrchestrator.AutomatedRetrainingJobResult]]:
    """
    ...
    """
        ...
    def allResults(self, spec: FetchStreamSpec=None) -> Union[Stream[ReliabilityOrchestrator.AutomatedRetrainingJobResult]]:
    """
    ...
    """
        ...
    def customSummaryFieldsForResult(self, result: ReliabilityOrchestrator.AutomatedRetrainingJobResult) -> Union[Map[str, Any]]:
    """
    ...
    """
        ...
    def summaryForResults(self, results: Array[ReliabilityOrchestrator.AutomatedRetrainingJobResult], spec: Workflow.Monitorable.SummarySpec=None) -> Data:
    """
    ...
    """
        ...
    def summaryForResultsPd(self, results: Array[ReliabilityOrchestrator.AutomatedRetrainingJobResult], spec: Workflow.Monitorable.SummarySpec=None) -> Union[Any]:
    """
    ...
    """
        ...
    def resultsForSummary(self, spec: FetchSpec=None) -> Union[FetchResult[ReliabilityOrchestrator.AutomatedRetrainingJobResult]]:
    """
    ...
    """
        ...
    def retrainingResults(self, spec: FetchSpec=None) -> Array[ReliabilityOrchestrator.AutomatedRetrainingJobResult]:
    """
    Returns all {@link ReliabilityOrchestrator.AutomatedRetrainingJobResult}s associated with this run.
    @param spec
       Common specifications for fetching the results.
    @return a list of {@link ReliabilityOrchestrator.AutomatedRetrainingJobResult}.
    """
        ...
