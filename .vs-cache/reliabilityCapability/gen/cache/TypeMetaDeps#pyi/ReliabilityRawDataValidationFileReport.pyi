...
from c3.reliabilityCapability.ReliabilityRawDataValidationJob import ReliabilityRawDataValidationJob
...
# Python definitions for the C3 type ReliabilityRawDataValidationFileReport


class ReliabilityRawDataValidationFileReport():
    """
    This is a report on the quality of data present in a single raw data {@link File}.
    If there are errors in the raw data, they will be recorded in the {@link errors} field. In this case,
    no {@link stats} will be computed.
    If there are warnings, they will be recorded in the {@link warnings} field. {@link stats} will still
    be computed.
    
    @remarks this represents a made instance of ReliabilityRawDataValidationFileReport
    """
    ...
    """
    The kind of data source. Example data sources are:
    1. `SENSOR_TIME_SERIES` --> Contains time series data for sensors in the canonical format
    2. `ASSET_HIERARCHY_EXCEL` --> Contains the asset hierarchy, asset class, failure mode,
    and recommended actions in a single excel spreadsheet
    3. etc. Look at {@link ReliabilityRawDataValidationDataType} for more information on the different
    kinds of raw data sources supported.
    """

    file: Optional[File]
    """
    A link to the raw source data {@link File} that is being checked for data quality.
    """

    errors: Optional[Array[str]]=None
    """
    For the {@link file} corresponding to the {@link dataType}, there are certain characteristics
    that need to be present in the data. If they are not present in the data, all the erroneous aspects
    of data quality will be stored in this field. If there are {@link errors} in the {@link file}, then
    no {@link stats} will be computed since these statistics may be wrong.
    """

    warnings: Optional[Array[str]]=None
    """
    If there are any warnings related to data quality in the {@link file}, those will be raised here.
    Warnings don't block the system for computing the relevant {@link stats} for this {@link file}. They can
    be thought of as issues about the data that are nice to fix, not necessary to fix.
    An example warning could be that there is no asset class information in the asset hierarchy excel
    spreadsheet. While it is great to organize the hierarchy into templates, it is not needed for the
    application to function.
    """

    stats: Optional[File]=None
    """
    Relevant statistics computed on the data in the {@link file} for its {@link dataType}. The kind
    of statistics change with the {@link dataType}. But they are all stored as a json {@link File}. These
    statistics will be cross-referenced by {@link ReliabilityRawDataValidationHelper#crossValidateReports}.
    """

    job: Optional[ReliabilityRawDataValidationJob]=None
    """
    It is highly recommended that the raw data validation be executed as a distributed
    {@link ReliabilityRawDataValidationJob}. In the case that this report is generated by the job,
    the reference to the job will be stored in the {@link job} field.
    """
    def __init__(self, typeIdent: Optional[str]=None, id: Optional[str]=None, versionEdits: Optional[Array[VersionEdit]]=None, name: Optional[str]=None, meta: Optional[Meta]=None, version: Optional[int]=None, typeWithBindings: Optional[Type]=None, dataType: Optional[str]=None, file: Optional[File]=None, errors: Optional[Array[str]]=None, warnings: Optional[Array[str]]=None, stats: Optional[File]=None, job: Optional[ReliabilityRawDataValidationJob]=None) -> None: ...
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[ReliabilityRawDataValidationFileReport]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[ReliabilityRawDataValidationFileReport]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[ReliabilityRawDataValidationFileReport]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[ReliabilityRawDataValidationFileReport]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> ReliabilityRawDataValidationFileReport:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> ReliabilityRawDataValidationFileReport:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> ReliabilityRawDataValidationFileReport:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[ReliabilityRawDataValidationFileReport]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[ReliabilityRawDataValidationFileReport]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> ReliabilityRawDataValidationFileReport:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> ReliabilityRawDataValidationFileReport:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> ReliabilityRawDataValidationFileReport:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> ReliabilityRawDataValidationFileReport:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> ReliabilityRawDataValidationFileReport:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> ReliabilityRawDataValidationFileReport:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> ReliabilityRawDataValidationFileReport:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> ReliabilityRawDataValidationFileReport:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> ReliabilityRawDataValidationFileReport:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> ReliabilityRawDataValidationFileReport:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> ReliabilityRawDataValidationFileReport:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> ReliabilityRawDataValidationFileReport:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> ReliabilityRawDataValidationFileReport:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> ReliabilityRawDataValidationFileReport:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> ReliabilityRawDataValidationFileReport:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> ReliabilityRawDataValidationFileReport:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> ReliabilityRawDataValidationFileReport:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> ReliabilityRawDataValidationFileReport:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> ReliabilityRawDataValidationFileReport:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> ReliabilityRawDataValidationFileReport:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> ReliabilityRawDataValidationFileReport:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> ReliabilityRawDataValidationFileReport:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> ReliabilityRawDataValidationFileReport:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> ReliabilityRawDataValidationFileReport:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> ReliabilityRawDataValidationFileReport:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> ReliabilityRawDataValidationFileReport:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> ReliabilityRawDataValidationFileReport:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> ReliabilityRawDataValidationFileReport:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[ReliabilityRawDataValidationFileReport]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[ReliabilityRawDataValidationFileReport]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[ReliabilityRawDataValidationFileReport]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[ReliabilityRawDataValidationFileReport]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[ReliabilityRawDataValidationFileReport]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, ReliabilityRawDataValidationFileReport]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, ReliabilityRawDataValidationFileReport]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[ReliabilityRawDataValidationFileReport]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[ReliabilityRawDataValidationFileReport]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> ReliabilityRawDataValidationFileReport:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> ReliabilityRawDataValidationFileReport:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> ReliabilityRawDataValidationFileReport:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> ReliabilityRawDataValidationFileReport:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> ReliabilityRawDataValidationFileReport:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> ReliabilityRawDataValidationFileReport:
    """
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[ReliabilityRawDataValidationFileReport]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> ReliabilityRawDataValidationFileReport:
    """
    ...
    """
        ...
    def afterMake(self) -> ReliabilityRawDataValidationFileReport:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> ReliabilityRawDataValidationFileReport:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[ReliabilityRawDataValidationFileReport]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> ReliabilityRawDataValidationFileReport:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, spec: FetchSpec=None) -> FetchResult[ReliabilityRawDataValidationFileReport]:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, filter: Filter) -> FetchResult[ReliabilityRawDataValidationFileReport]:
    """
    ...
    """
        ...
    @classmethod
    def fetchObjStream(cls, spec: FetchStreamSpec=None) -> Union[Stream[ReliabilityRawDataValidationFileReport]]:
    """
    Fetches multiple obj instances based on a specification.  Only objs that the caller is authorized to fetch will be
    returned.
    ...
    """
        ...
    @classmethod
    def fetchMultiLocale(cls, spec: MultiLocaleFetchSpec=None) -> Union[Map[str, FetchResult[ReliabilityRawDataValidationFileReport]]]:
    """
    ...
    """
        ...
    def get(self, include: str=None) -> Union[ReliabilityRawDataValidationFileReport]:
    """
    ...
    """
        ...
    def getSpecific(self, include: str=None) -> Union[ReliabilityRawDataValidationFileReport]:
    """
    ...
    """
        ...
    def getMissing(self, spec: GetMissingSpec) -> ReliabilityRawDataValidationFileReport:
    """
    ...
    """
        ...
    def getDirect(self, include: str=None) -> Union[ReliabilityRawDataValidationFileReport]:
    """
    ...
    """
        ...
    def applyReverseEdit(self, versionEdit: VersionEdit) -> ReliabilityRawDataValidationFileReport:
    """
    ...
    """
        ...
    @classmethod
    def fromString(cls, s: str) -> Union[ReliabilityRawDataValidationFileReport]:
    """
    ...
    """
        ...
    def create(self, spec: UpsertSpec=None) -> Union[ReliabilityRawDataValidationFileReport]:
    """
    ...
    """
        ...
    @classmethod
    def createBatch(cls, objs: Array[ReliabilityRawDataValidationFileReport], spec: UpsertSpec=None) -> Union[ObjList[ReliabilityRawDataValidationFileReport]]:
    """
    ...
    """
        ...
    @classmethod
    def createBatchObjStream(cls, objs: Stream[ReliabilityRawDataValidationFileReport], spec: CreateBatchObjStreamSpec=None) -> Union[ObjList[ReliabilityRawDataValidationFileReport]]:
    """
    Creates multiple instances of a C3 type. If the operation fails and {@link UpsertSpec#dontThrowOnBatchError} is not
    specified (the default), then a C3BatchException will be thrown.  Otherwise {@link errors will be reported in the
    returned {@link ObjList}.  This will fail if any of the instances already exist.
    ...
    """
        ...
    def update(self, srcObj: ReliabilityRawDataValidationFileReport=None, spec: UpsertSpec=None) -> Union[ReliabilityRawDataValidationFileReport]:
    """
    ...
    """
        ...
    def upsert(self, srcObj: ReliabilityRawDataValidationFileReport=None, spec: UpsertSpec=None) -> Union[ReliabilityRawDataValidationFileReport]:
    """
    ...
    """
        ...
    @overload
    def merge(self, spec: MergeSpec=None) -> Union[ReliabilityRawDataValidationFileReport]:
    """
    ...
    """
        ...
    @overload
    def merge(self, mergeInclude: str, spec: MergeSpec=None) -> Union[ReliabilityRawDataValidationFileReport]:
    """
    ...
    """
        ...
    def touch(self, spec: TouchSpec=None) -> Union[ReliabilityRawDataValidationFileReport]:
    """
    ...
    """
        ...
    @classmethod
    def updateBatch(cls, objs: Array[ReliabilityRawDataValidationFileReport], srcObjs: Array[ReliabilityRawDataValidationFileReport]=None, spec: UpsertSpec=None) -> Union[ObjList[ReliabilityRawDataValidationFileReport]]:
    """
    ...
    """
        ...
    @classmethod
    def updateObjs(cls, objs: Callable[[], Union[Array[ReliabilityRawDataValidationFileReport]]], spec: UpsertSpec=None) -> Union[ObjList[ReliabilityRawDataValidationFileReport]]:
    """
    ...
    """
        ...
    @classmethod
    def upsertBatch(cls, objs: Array[ReliabilityRawDataValidationFileReport], srcObjs: Array[ReliabilityRawDataValidationFileReport]=None, spec: UpsertSpec=None) -> Union[ObjList[ReliabilityRawDataValidationFileReport]]:
    """
    ...
    """
        ...
    @classmethod
    def upsertObjs(cls, objs: Callable[[], Union[Array[ReliabilityRawDataValidationFileReport]]], spec: UpsertSpec=None) -> Union[ObjList[ReliabilityRawDataValidationFileReport]]:
    """
    Creates instances of a C3 type if they don't already exist and updates them if they do exist. If the operation
    ...
    """
        ...
    @classmethod
    def touchBatch(cls, objs: Array[ReliabilityRawDataValidationFileReport], spec: TouchSpec=None) -> Union[ObjList[ReliabilityRawDataValidationFileReport]]:
    """
    ...
    @overload
    @classmethod
    def mergeBatch(cls, objs: Array[ReliabilityRawDataValidationFileReport], spec: MergeSpec=None) -> Union[ObjList[ReliabilityRawDataValidationFileReport]]:
    """
    ...
    @overload
    @classmethod
    def mergeBatch(cls, objs: Array[ReliabilityRawDataValidationFileReport], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[ReliabilityRawDataValidationFileReport]]:
    """
    Merges multiple instances of a C3 type or creates them if they don't exist. If the operation fails and {@link
    UpsertSpec#dontThrowOnBatchError} is not specified (the default), then a C3BatchException will be thrown.
    Otherwise errors will be reported in the returned {@link ObjList}.  The merge operation is described in the {@link
    ...
    """
        ...
    @classmethod
    def mergeObjs(cls, objs: Callable[[], Union[Array[ReliabilityRawDataValidationFileReport]]], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[ReliabilityRawDataValidationFileReport]]:
    """
    ...
    @overload
    @classmethod
    def mergeAll(cls, mergeObj: ReliabilityRawDataValidationFileReport, spec: MergeAllSpec=None) -> Union[int]:
    """
    ...
    @overload
    @classmethod
    def mergeAll(cls, mergeObj: ReliabilityRawDataValidationFileReport, mergeInclude: str, spec: MergeAllSpec=None) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def removeBatch(cls, objs: Array[ReliabilityRawDataValidationFileReport], spec: UpsertSpec=None) -> Union[ObjList[ReliabilityRawDataValidationFileReport]]:
    """
    ...
    """
        ...
    @classmethod
    def replace(cls, objs: Array[ReliabilityRawDataValidationFileReport], spec: UpsertSpec=None) -> Union[ObjList[ReliabilityRawDataValidationFileReport]]:
    """
    ...
    """
        ...
    def unremove(self) -> Union[ReliabilityRawDataValidationFileReport]:
    """
    ...
    """
        ...
    @classmethod
    def beforeCreate(cls, objs: Array[ReliabilityRawDataValidationFileReport]) -> ObjList[ReliabilityRawDataValidationFileReport]:
    """
    ...
    """
        ...
    @classmethod
    def beforeUpdate(cls, objs: Array[ReliabilityRawDataValidationFileReport]) -> ObjList[ReliabilityRawDataValidationFileReport]:
    """
    ...
    """
        ...
    @classmethod
    def beforeRemove(cls, objs: Array[ReliabilityRawDataValidationFileReport]) -> ObjList[ReliabilityRawDataValidationFileReport]:
    """
    ...
    """
        ...
    @classmethod
    def afterCreate(cls, objs: Array[ReliabilityRawDataValidationFileReport]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def afterUpdate(cls, objs: Array[ReliabilityRawDataValidationFileReport]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def afterRemove(cls, objs: Array[ReliabilityRawDataValidationFileReport]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def startImportData(cls, spec: StartImportDataSpec=None) -> PushStream[ReliabilityRawDataValidationFileReport]:
    """
    @return a push stream to import instances of this type.
    """
        ...
    @classmethod
    def startImportDataWithStats(cls, spec: StartImportDataSpec=None) -> PushStreamWithStats[ReliabilityRawDataValidationFileReport]:
    """
    @return a push stream to import instances of this type.
    """
        ...
    ...
    """
        ...
    @classmethod
    def forId(cls, id: str, failIfMissing: bool=None) -> Union[ReliabilityRawDataValidationFileReport]:
    """
    ...
    """
        ...
    def withoutIdentity(self) -> Union[ReliabilityRawDataValidationFileReport]:
    """
    ...
    """
        ...
    @classmethod
    def typeOfBatch(cls, objs: Array[ReliabilityRawDataValidationFileReport]) -> Union[Array[EntityType]]:
    """
    ...
    """
        ...
    @classmethod
    def dbEcho(cls, template: ReliabilityRawDataValidationFileReport=None, count: int=None, sendBack: bool=None) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def callbackLogic(cls, objs: Array[ReliabilityRawDataValidationFileReport], callback: Callable[[Union[ReliabilityRawDataValidationFileReport]], Union[ReliabilityRawDataValidationFileReport]]=None) -> ObjList[ReliabilityRawDataValidationFileReport]:
    """
    ...
    """
        ...
    @classmethod
    def afterCallbackLogic(cls, objs: Array[ReliabilityRawDataValidationFileReport], callback: Callable[[Union[ReliabilityRawDataValidationFileReport]], Union[ReliabilityRawDataValidationFileReport]]=None) -> Union[Array[ObjError]]:
    """
