...
# Python definitions for the C3 type ReliabilityAssetExclusionMaskExpressions


class ReliabilityAssetExclusionMaskExpressions(ExpressionEngineFunction):
    """
    ...
    **Note on ML applications**
    ...
    """
        ...
    @classmethod
    def shortTimePeriodExclusionPyTs(cls, ts: Timeseries[Any]=None, days: int=None) -> Union[Timeseries[Any]]:
    """
    ...
    """
        ...
    @classmethod
    def fTFExclusion(cls, ts: Timeseries[Any]=None, lag: int=None, threshold: float=None, delay: int=None) -> Union[Timeseries[Any]]:
    """
