...
from c3.reliabilityCapability.ReliabilityRawDataValidationReportForDataType import ReliabilityRawDataValidationReportForDataType
...
# Python definitions for the C3 type ReliabilityRawDataValidationReport


class ReliabilityRawDataValidationReport():
    """
    This is the report of data quality across all the raw source data {@link File}s
    available. While {@link ReliabilityRawDataValidationFileReport} contains the report of
    a single {@link File} of one {@link ReliabilityRawDataValidationDataType}, this report contains
    cross-checked data quality reports of all {@link File}s across all available
    {@link ReliabilityRawDataValidationDataType}s.
    
    @remarks this represents a made instance of ReliabilityRawDataValidationReport
    """
    ...
    fileStats: Optional[ReliabilityRawDataValidationReportForDataType]=None
    """
    This field stores basic statistics about data quality across all the raw data
    {@link File}s available.
    """

    canonicalPointMeasurementStats: Optional[ReliabilityRawDataValidationReportForDataType]=None
    """
    This field stores basic statistics about data quality across all
    {@link CanonicalPointMeasurement} {@link File}s available.
    """

    canonicalPointPhysicalMeasurementSeriesStats: Optional[ReliabilityRawDataValidationReportForDataType]=None
    """
    This field stores basic statistics about data quality across all
    {@link CanonicalPointPhysicalMeasurementSeries} {@link File}s available.
    """

    canonicalReliabilityAssetEventStats: Optional[ReliabilityRawDataValidationReportForDataType]=None
    """
    This field stores basic statistics about data quality across all
    {@link CanonicalReliabilityAssetEvent} {@link File}s available.
    """

    assetHierarchyExcelStats: Optional[ReliabilityRawDataValidationReportForDataType]=None
    """
    This field stores basic statistics about data quality across all
    asset hierarchy spreadsheet {@link File}s available.
    """

    errors: Optional[Array[str]]=None
    """
    If there are errors discovered while cross-checking data of different
    {@link ReliabilityRawDataValidationDataType}s, they will be reported in this field.
    Errors are mandatory to rectify.
    """

    warnings: Optional[Array[str]]=None
    """
    If there are warnings discovered while cross-checking data of different
    {@link ReliabilityRawDataValidationDataType}s, they will be reported in this field.
    Warnings are not mandatory to rectify.
    """

    stats: Optional[File]=None
    """
    The overall picture of data quality is stored as a json {@link File} in the {@link stats}
    field. This json {@link File} is available for consumption by the end user. However, it is encouraged
    to use one of the helper functions on this Type to get a user-friendly output of the most
    commonly required overviews of data quality.
    """
    ...
    """
    def __init__(self, typeIdent: Optional[str]=None, id: Optional[str]=None, versionEdits: Optional[Array[VersionEdit]]=None, name: Optional[str]=None, meta: Optional[Meta]=None, version: Optional[int]=None, typeWithBindings: Optional[Type]=None, fileStats: Optional[ReliabilityRawDataValidationReportForDataType]=None, canonicalPointMeasurementStats: Optional[ReliabilityRawDataValidationReportForDataType]=None, canonicalPointPhysicalMeasurementSeriesStats: Optional[ReliabilityRawDataValidationReportForDataType]=None, canonicalReliabilityAssetEventStats: Optional[ReliabilityRawDataValidationReportForDataType]=None, assetHierarchyExcelStats: Optional[ReliabilityRawDataValidationReportForDataType]=None, errors: Optional[Array[str]]=None, warnings: Optional[Array[str]]=None, stats: Optional[File]=None, job: Optional[ReliabilityRawDataValidationJob]=None) -> None: ...
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[ReliabilityRawDataValidationReport]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[ReliabilityRawDataValidationReport]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[ReliabilityRawDataValidationReport]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[ReliabilityRawDataValidationReport]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> ReliabilityRawDataValidationReport:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> ReliabilityRawDataValidationReport:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> ReliabilityRawDataValidationReport:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[ReliabilityRawDataValidationReport]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[ReliabilityRawDataValidationReport]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> ReliabilityRawDataValidationReport:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> ReliabilityRawDataValidationReport:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> ReliabilityRawDataValidationReport:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> ReliabilityRawDataValidationReport:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> ReliabilityRawDataValidationReport:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> ReliabilityRawDataValidationReport:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> ReliabilityRawDataValidationReport:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> ReliabilityRawDataValidationReport:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> ReliabilityRawDataValidationReport:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> ReliabilityRawDataValidationReport:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> ReliabilityRawDataValidationReport:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> ReliabilityRawDataValidationReport:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> ReliabilityRawDataValidationReport:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> ReliabilityRawDataValidationReport:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> ReliabilityRawDataValidationReport:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> ReliabilityRawDataValidationReport:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> ReliabilityRawDataValidationReport:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> ReliabilityRawDataValidationReport:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> ReliabilityRawDataValidationReport:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> ReliabilityRawDataValidationReport:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> ReliabilityRawDataValidationReport:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> ReliabilityRawDataValidationReport:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> ReliabilityRawDataValidationReport:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> ReliabilityRawDataValidationReport:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> ReliabilityRawDataValidationReport:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> ReliabilityRawDataValidationReport:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> ReliabilityRawDataValidationReport:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> ReliabilityRawDataValidationReport:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[ReliabilityRawDataValidationReport]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[ReliabilityRawDataValidationReport]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[ReliabilityRawDataValidationReport]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[ReliabilityRawDataValidationReport]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[ReliabilityRawDataValidationReport]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, ReliabilityRawDataValidationReport]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, ReliabilityRawDataValidationReport]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[ReliabilityRawDataValidationReport]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[ReliabilityRawDataValidationReport]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> ReliabilityRawDataValidationReport:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> ReliabilityRawDataValidationReport:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> ReliabilityRawDataValidationReport:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> ReliabilityRawDataValidationReport:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> ReliabilityRawDataValidationReport:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> ReliabilityRawDataValidationReport:
    """
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[ReliabilityRawDataValidationReport]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> ReliabilityRawDataValidationReport:
    """
    ...
    """
        ...
    def afterMake(self) -> ReliabilityRawDataValidationReport:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> ReliabilityRawDataValidationReport:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[ReliabilityRawDataValidationReport]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> ReliabilityRawDataValidationReport:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, spec: FetchSpec=None) -> FetchResult[ReliabilityRawDataValidationReport]:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, filter: Filter) -> FetchResult[ReliabilityRawDataValidationReport]:
    """
    ...
    """
        ...
    @classmethod
    def fetchObjStream(cls, spec: FetchStreamSpec=None) -> Union[Stream[ReliabilityRawDataValidationReport]]:
    """
    Fetches multiple obj instances based on a specification.  Only objs that the caller is authorized to fetch will be
    returned.
    ...
    """
        ...
    @classmethod
    def fetchMultiLocale(cls, spec: MultiLocaleFetchSpec=None) -> Union[Map[str, FetchResult[ReliabilityRawDataValidationReport]]]:
    """
    ...
    """
        ...
    def get(self, include: str=None) -> Union[ReliabilityRawDataValidationReport]:
    """
    ...
    """
        ...
    def getSpecific(self, include: str=None) -> Union[ReliabilityRawDataValidationReport]:
    """
    ...
    """
        ...
    def getMissing(self, spec: GetMissingSpec) -> ReliabilityRawDataValidationReport:
    """
    ...
    """
        ...
    def getDirect(self, include: str=None) -> Union[ReliabilityRawDataValidationReport]:
    """
    ...
    """
        ...
    def applyReverseEdit(self, versionEdit: VersionEdit) -> ReliabilityRawDataValidationReport:
    """
    ...
    """
        ...
    @classmethod
    def fromString(cls, s: str) -> Union[ReliabilityRawDataValidationReport]:
    """
    ...
    """
        ...
    def create(self, spec: UpsertSpec=None) -> Union[ReliabilityRawDataValidationReport]:
    """
    ...
    """
        ...
    @classmethod
    def createBatch(cls, objs: Array[ReliabilityRawDataValidationReport], spec: UpsertSpec=None) -> Union[ObjList[ReliabilityRawDataValidationReport]]:
    """
    ...
    """
        ...
    @classmethod
    def createBatchObjStream(cls, objs: Stream[ReliabilityRawDataValidationReport], spec: CreateBatchObjStreamSpec=None) -> Union[ObjList[ReliabilityRawDataValidationReport]]:
    """
    Creates multiple instances of a C3 type. If the operation fails and {@link UpsertSpec#dontThrowOnBatchError} is not
    specified (the default), then a C3BatchException will be thrown.  Otherwise {@link errors will be reported in the
    returned {@link ObjList}.  This will fail if any of the instances already exist.
    ...
    """
        ...
    def update(self, srcObj: ReliabilityRawDataValidationReport=None, spec: UpsertSpec=None) -> Union[ReliabilityRawDataValidationReport]:
    """
    ...
    """
        ...
    def upsert(self, srcObj: ReliabilityRawDataValidationReport=None, spec: UpsertSpec=None) -> Union[ReliabilityRawDataValidationReport]:
    """
    ...
    """
        ...
    @overload
    def merge(self, spec: MergeSpec=None) -> Union[ReliabilityRawDataValidationReport]:
    """
    ...
    """
        ...
    @overload
    def merge(self, mergeInclude: str, spec: MergeSpec=None) -> Union[ReliabilityRawDataValidationReport]:
    """
    ...
    """
        ...
    def touch(self, spec: TouchSpec=None) -> Union[ReliabilityRawDataValidationReport]:
    """
    ...
    """
        ...
    @classmethod
    def updateBatch(cls, objs: Array[ReliabilityRawDataValidationReport], srcObjs: Array[ReliabilityRawDataValidationReport]=None, spec: UpsertSpec=None) -> Union[ObjList[ReliabilityRawDataValidationReport]]:
    """
    ...
    """
        ...
    @classmethod
    def updateObjs(cls, objs: Callable[[], Union[Array[ReliabilityRawDataValidationReport]]], spec: UpsertSpec=None) -> Union[ObjList[ReliabilityRawDataValidationReport]]:
    """
    ...
    """
        ...
    @classmethod
    def upsertBatch(cls, objs: Array[ReliabilityRawDataValidationReport], srcObjs: Array[ReliabilityRawDataValidationReport]=None, spec: UpsertSpec=None) -> Union[ObjList[ReliabilityRawDataValidationReport]]:
    """
    ...
    """
        ...
    @classmethod
    def upsertObjs(cls, objs: Callable[[], Union[Array[ReliabilityRawDataValidationReport]]], spec: UpsertSpec=None) -> Union[ObjList[ReliabilityRawDataValidationReport]]:
    """
    Creates instances of a C3 type if they don't already exist and updates them if they do exist. If the operation
    ...
    """
        ...
    @classmethod
    def touchBatch(cls, objs: Array[ReliabilityRawDataValidationReport], spec: TouchSpec=None) -> Union[ObjList[ReliabilityRawDataValidationReport]]:
    """
    ...
    @overload
    @classmethod
    def mergeBatch(cls, objs: Array[ReliabilityRawDataValidationReport], spec: MergeSpec=None) -> Union[ObjList[ReliabilityRawDataValidationReport]]:
    """
    ...
    @overload
    @classmethod
    def mergeBatch(cls, objs: Array[ReliabilityRawDataValidationReport], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[ReliabilityRawDataValidationReport]]:
    """
    Merges multiple instances of a C3 type or creates them if they don't exist. If the operation fails and {@link
    UpsertSpec#dontThrowOnBatchError} is not specified (the default), then a C3BatchException will be thrown.
    Otherwise errors will be reported in the returned {@link ObjList}.  The merge operation is described in the {@link
    ...
    """
        ...
    @classmethod
    def mergeObjs(cls, objs: Callable[[], Union[Array[ReliabilityRawDataValidationReport]]], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[ReliabilityRawDataValidationReport]]:
    """
    ...
    @overload
    @classmethod
    def mergeAll(cls, mergeObj: ReliabilityRawDataValidationReport, spec: MergeAllSpec=None) -> Union[int]:
    """
    ...
    @overload
    @classmethod
    def mergeAll(cls, mergeObj: ReliabilityRawDataValidationReport, mergeInclude: str, spec: MergeAllSpec=None) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def removeBatch(cls, objs: Array[ReliabilityRawDataValidationReport], spec: UpsertSpec=None) -> Union[ObjList[ReliabilityRawDataValidationReport]]:
    """
    ...
    """
        ...
    @classmethod
    def replace(cls, objs: Array[ReliabilityRawDataValidationReport], spec: UpsertSpec=None) -> Union[ObjList[ReliabilityRawDataValidationReport]]:
    """
    ...
    """
        ...
    def unremove(self) -> Union[ReliabilityRawDataValidationReport]:
    """
    ...
    """
        ...
    @classmethod
    def beforeCreate(cls, objs: Array[ReliabilityRawDataValidationReport]) -> ObjList[ReliabilityRawDataValidationReport]:
    """
    ...
    """
        ...
    @classmethod
    def beforeUpdate(cls, objs: Array[ReliabilityRawDataValidationReport]) -> ObjList[ReliabilityRawDataValidationReport]:
    """
    ...
    """
        ...
    @classmethod
    def beforeRemove(cls, objs: Array[ReliabilityRawDataValidationReport]) -> ObjList[ReliabilityRawDataValidationReport]:
    """
    ...
    """
        ...
    @classmethod
    def afterCreate(cls, objs: Array[ReliabilityRawDataValidationReport]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def afterUpdate(cls, objs: Array[ReliabilityRawDataValidationReport]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def afterRemove(cls, objs: Array[ReliabilityRawDataValidationReport]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def startImportData(cls, spec: StartImportDataSpec=None) -> PushStream[ReliabilityRawDataValidationReport]:
    """
    @return a push stream to import instances of this type.
    """
        ...
    @classmethod
    def startImportDataWithStats(cls, spec: StartImportDataSpec=None) -> PushStreamWithStats[ReliabilityRawDataValidationReport]:
    """
    @return a push stream to import instances of this type.
    """
        ...
    ...
    """
        ...
    @classmethod
    def forId(cls, id: str, failIfMissing: bool=None) -> Union[ReliabilityRawDataValidationReport]:
    """
    ...
    """
        ...
    def withoutIdentity(self) -> Union[ReliabilityRawDataValidationReport]:
    """
    ...
    """
        ...
    @classmethod
    def typeOfBatch(cls, objs: Array[ReliabilityRawDataValidationReport]) -> Union[Array[EntityType]]:
    """
    ...
    """
        ...
    @classmethod
    def dbEcho(cls, template: ReliabilityRawDataValidationReport=None, count: int=None, sendBack: bool=None) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def callbackLogic(cls, objs: Array[ReliabilityRawDataValidationReport], callback: Callable[[Union[ReliabilityRawDataValidationReport]], Union[ReliabilityRawDataValidationReport]]=None) -> ObjList[ReliabilityRawDataValidationReport]:
    """
    ...
    """
        ...
    @classmethod
    def afterCallbackLogic(cls, objs: Array[ReliabilityRawDataValidationReport], callback: Callable[[Union[ReliabilityRawDataValidationReport]], Union[ReliabilityRawDataValidationReport]]=None) -> Union[Array[ObjError]]:
    """
