// TypeScript definitions for the C3 type Person

/**
 * Represents a single logical human being.
 *
 * Human persons
 *
 * @remarks this represents a value passed to a method that expects an instance of Person
 */
declare interface IPerson {
   ...
   */
  nationalities?: Array_Type<Country> | Array<ICountry>;

  /**
   * Person's current address.
   */
  currentAddress?: IInlineAddress;

  /**
   * The list of {@link PersonOrganizationRelation}s.
   */
  organizationRelations?: Array_Type<PersonOrganizationRelation> | Array<IPersonOrganizationRelation>;

  /**
   * All contacts for the person.
   *
   * FK references FROM parents
   */
  contact?: IContact;
  ...
  /**
   * Date person registered on the C3 Portal (and created User row).
   */
  registrationDate?: DateTime | Date | string;

  /**
   * Related login user accounts for this person
   */
  userMapping?: Array_Type<PersonUser> | Array<IPersonUser>;
 ...
 * Human persons
 *
 * @remarks this represents a made instance of Person
 */
declare class Person extends Obj  {
  ...
  withTypeIdent(typeIdent: string | null): Person;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Person;

  /**
   * Full name: "<first> <last>"
   */
  readonly name?: string;
  withName(name: string | null): Person;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): Person;
  ...
  withVersion(version: number | null): Person;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): Person;

  /**
   * Incoming edges of the {@link Party} hierarchy
   */
  readonly parentRelations?: Array_Type<PartyTimedIntervalRelation>;
  withParentRelations(parentRelations: Array_Type<PartyTimedIntervalRelation> | Array<IPartyTimedIntervalRelation> | null): Person;

  /**
   * Outgoing edges of the {@link Party} hierarchy
   */
  readonly childRelations?: Array_Type<PartyTimedIntervalRelation>;
  withChildRelations(childRelations: Array_Type<PartyTimedIntervalRelation> | Array<IPartyTimedIntervalRelation> | null): Person;

  /**
   * Outgoing edges of the {@link Party} lateral relation graph
   */
  readonly relatedPartyEdgesFrom?: Array_Type<PartyEdge>;
  withRelatedPartyEdgesFrom(relatedPartyEdgesFrom: Array_Type<PartyEdge> | Array<IPartyEdge> | null): Person;

  /**
   * Incoming edges of the {@link Party} lateral relation graph
   */
  readonly relatedPartyEdgesTo?: Array_Type<PartyEdge>;
  withRelatedPartyEdgesTo(relatedPartyEdgesTo: Array_Type<PartyEdge> | Array<IPartyEdge> | null): Person;

  /**
   * The party's preferred contact method.
   */
  readonly preferredCommunicationMethod?: string;
  withPreferredCommunicationMethod(preferredCommunicationMethod: string | null): Person;

  /**
   * Preference of the party's communication method
   */
  readonly communicationPreferences?: Array_Type<PartyCommunicationPreference>;
  withCommunicationPreferences(communicationPreferences: Array_Type<PartyCommunicationPreference> | Array<IPartyCommunicationPreference> | null): Person;

  /**
   * Whether the party want to receive email or not
   */
  readonly receiveEmail?: boolean;
  withReceiveEmail(receiveEmail: boolean): Person;

  /**
   * Whether the party want to receive SMS or not
   */
  readonly receiveSMS?: boolean;
  withReceiveSMS(receiveSMS: boolean): Person;

  /**
   * The parents of the party based on the PartyRoles specified.
   */
  readonly parents?: Array_Type<Party>;
  withParents(parents: Array_Type<Party> | Array<IParty> | null): Person;
  ...
  withPreferredLanguageLocaleCode(preferredLanguageLocaleCode: ILocale | null): Person;

  /**
   * PartyRoles assigned to the Party.
   */
  readonly roles?: Array_Type<PartyRole>;
  withRoles(roles: Array_Type<PartyRole> | Array<IPartyRole> | null): Person;

  /**
   * Phone contact information entries for the Party.
   */
  readonly phones?: Array_Type<PartyPhone>;
  withPhones(phones: Array_Type<PartyPhone> | Array<IPartyPhone> | null): Person;
  ...
  withElectronicCommunications(electronicCommunications: Array_Type<PartyElectronicCommunication> | Array<IPartyElectronicCommunication> | null): Person;
  ...
  withPostalAddresses(postalAddresses: Array_Type<PartyPostalAddress> | Array<IPartyPostalAddress> | null): Person;

  /**
   * Most recent postal address of this party.
   */
  readonly latestAddress?: PartyPostalAddress;
  withLatestAddress(latestAddress: IPartyPostalAddress | null): Person;

  /**
   * Customers of this Party.
   */
  readonly customers?: Array_Type<Customer>;
  withCustomers(customers: Array_Type<Customer> | Array<ICustomer> | null): Person;

  /**
   * Preferred phone. Pick the one that was last updated, when there are many.
   */
  readonly preferredPhoneNumber?: PartyPhone;
  withPreferredPhoneNumber(preferredPhoneNumber: IPartyPhone | null): Person;

  /**
   * Preferred email. Pick the one that was last updated, when there are many.
   */
  readonly preferredEmail?: PartyElectronicCommunication;
  withPreferredEmail(preferredEmail: IPartyElectronicCommunication | null): Person;

  /**
   * Do not disturb schedule.
   */
  readonly doNotDisturbSchedule?: ScheduleRecurringDayRule;
  withDoNotDisturbSchedule(doNotDisturbSchedule: IScheduleRecurringDayRule | null): Person;

  /**
   * Given name.
   */
  readonly firstName?: string;
  withFirstName(firstName: string | null): Person;

  /**
   * Surname.
   */
  readonly lastName?: string;
  withLastName(lastName: string | null): Person;

  /**
   * Country where the person was born.
   */
  readonly countryOfBirth?: Country;
  withCountryOfBirth(countryOfBirth: ICountry | null): Person;

  /**
   * Person's nationalities.
   */
  readonly nationalities?: Array_Type<Country>;
  withNationalities(nationalities: Array_Type<Country> | Array<ICountry> | null): Person;

  /**
   * Person's current address.
   */
  readonly currentAddress?: InlineAddress;
  withCurrentAddress(currentAddress: IInlineAddress | null): Person;

  /**
   * The list of {@link PersonOrganizationRelation}s.
   */
  readonly organizationRelations?: Array_Type<PersonOrganizationRelation>;
  withOrganizationRelations(organizationRelations: Array_Type<PersonOrganizationRelation> | Array<IPersonOrganizationRelation> | null): Person;
  ...
  withContact(contact: IContact | null): Person;

  /**
   * Date person registered on the C3 Portal (and created User row).
   */
  readonly registrationDate?: DateTime;
  withRegistrationDate(registrationDate: DateTime | Date | string | null): Person;

  /**
   * Related login user accounts for this person
   */
  readonly userMapping?: Array_Type<PersonUser>;
  withUserMapping(userMapping: Array_Type<PersonUser> | Array<IPersonUser> | null): Person;

  /**
   * The member.
   */
  readonly member?: Member;
  withMember(member: IMember | null): Person;
   ...
   * @see #toJson
   */
  static fromJson(json: any): Person | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): Person | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): Person | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): Person | null;
   ...
   */
  replaceType(old: Type, new_: Type): Person;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Person;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Person;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Person>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Person>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Person;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Person;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Person;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): Person;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): Person;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Person;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Person;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): Person;
   ...
   * @see #removeField
   */
  withoutField(field: string): Person;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): Person;
   ...
   */
  withoutFields(fields: Array_Type<string>): Person;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): Person;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): Person;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Person;
   ...
   * @see #unsetField
   */
  defaultField(field: string): Person;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): Person;
   ...
   * @see #removeField
   */
  unsetField(field: string): Person;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): Person;
   ...
   * @see #unsetField
   */
  removeField(field: string): Person;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): Person;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Person;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): Person;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Person;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Person;

  mergeJson(json: any): Person;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Person;
   ...
   */
  sumObj(other: Obj, deep?: boolean): Person;
   ...
   */
  singletonArray(): Array_Type<Person>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<Person> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<Person> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<Person>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<Person> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, Person> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, Person> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<Person>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<Person>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Person;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Person;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Person;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): Person;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Person;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): Person;
   ...
   * @see #fromString
   */
  static make(s: string): Person | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Person;
   ...
   */
  static cachedEmptyInst(): Person;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<Person> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): Person;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<Person>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<Person>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<Person> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Person>> | null;
   ...
   */
  get(include?: string): Person | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): Person | null;
   ...
   */
  getMissing(spec: GetMissingSpec): Person;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): Person | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): Person;
   ...
   * @see #toString
   */
  static fromString(s: string): Person | null;
   ...
   */
  create(spec?: UpsertSpec): Person | null;
   ...
   */
  static createBatch(objs: Array_Type<Person>, spec?: UpsertSpec): ObjList<Person> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<Person>, spec?: CreateBatchObjStreamSpec): ObjList<Person> | null;
   ...
   */
  update(srcObj?: Person, spec?: UpsertSpec): Person | null;
   ...
   */
  upsert(srcObj?: Person, spec?: UpsertSpec): Person | null;
   ...
   */
  merge(spec?: MergeSpec): Person | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): Person | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): Person | null;
   ...
   */
  static updateBatch(objs: Array_Type<Person>, srcObjs?: Array_Type<Person>, spec?: UpsertSpec): ObjList<Person> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<Person> | null>, spec?: UpsertSpec): ObjList<Person> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<Person>, srcObjs?: Array_Type<Person>, spec?: UpsertSpec): ObjList<Person> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<Person> | null>, spec?: UpsertSpec): ObjList<Person> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<Person>, spec?: TouchSpec): ObjList<Person> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<Person>, spec?: MergeSpec): ObjList<Person> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<Person>, mergeInclude: string, spec?: MergeSpec): ObjList<Person> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<Person> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Person> | null;
   ...
   */
  static mergeAll(mergeObj: Person, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: Person, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<Person>, spec?: UpsertSpec): ObjList<Person> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<Person>, spec?: UpsertSpec): ObjList<Person> | null;
   ...
   */
  static beforeCreate(objs: Array_Type<Person>): ObjList<Person>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<Person>): ObjList<Person>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<Person>): ObjList<Person>;
   ...
   */
  static afterCreate(objs: Array_Type<Person>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<Person>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<Person>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<Person>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Person>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): Person | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<Person>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: Person, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<Person>, callback?: λFunction<Person | null, Person | null>): ObjList<Person>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<Person>, callback?: λFunction<Person | null, Person | null>): Array_Type<ObjError> | null;
