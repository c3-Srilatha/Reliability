// TypeScript definitions for the C3 type UserFieldPreference
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of UserFieldPreference
 */
declare interface IUserFieldPreference {
   ...
   */
  personMappings?: Array_Type<PersonUser> | Array<IPersonUser>;
}
 ...
 */
declare class UserFieldPreference extends Obj  {
   ...
   */
  readonly id: string;
  withId(id: string): UserFieldPreference;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): UserFieldPreference;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): UserFieldPreference;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): UserFieldPreference;
  ...
  withVersion(version: number | null): UserFieldPreference;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): UserFieldPreference;

  /**
   * The member (user) this preference belongs to
   */
  readonly member?: Member;
  withMember(member: IMember | null): UserFieldPreference;

  /**
   * The preference key identifier
   */
  readonly key?: string;
  withKey(key: string | null): UserFieldPreference;

  /**
   * The preference value associated with the key
   */
  readonly value?: string;
  withValue(value: string | null): UserFieldPreference;

  /**
   * Person-to-user mappings for this member
   */
  readonly personMappings?: Array_Type<PersonUser>;
  withPersonMappings(personMappings: Array_Type<PersonUser> | Array<IPersonUser> | null): UserFieldPreference;
   ...
   * @see #toJson
   */
  static fromJson(json: any): UserFieldPreference | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): UserFieldPreference | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): UserFieldPreference | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): UserFieldPreference | null;
   ...
   */
  replaceType(old: Type, new_: Type): UserFieldPreference;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): UserFieldPreference;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): UserFieldPreference;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<UserFieldPreference>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<UserFieldPreference>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): UserFieldPreference;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UserFieldPreference;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UserFieldPreference;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): UserFieldPreference;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): UserFieldPreference;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): UserFieldPreference;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): UserFieldPreference;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): UserFieldPreference;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): UserFieldPreference;
   ...
   * @see #removeField
   */
  withoutField(field: string): UserFieldPreference;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): UserFieldPreference;
   ...
   */
  withoutFields(fields: Array_Type<string>): UserFieldPreference;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): UserFieldPreference;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): UserFieldPreference;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): UserFieldPreference;
   ...
   * @see #unsetField
   */
  defaultField(field: string): UserFieldPreference;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): UserFieldPreference;
   ...
   * @see #removeField
   */
  unsetField(field: string): UserFieldPreference;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): UserFieldPreference;
   ...
   * @see #unsetField
   */
  removeField(field: string): UserFieldPreference;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): UserFieldPreference;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): UserFieldPreference;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): UserFieldPreference;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): UserFieldPreference;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): UserFieldPreference;

  mergeJson(json: any): UserFieldPreference;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): UserFieldPreference;
   ...
   */
  sumObj(other: Obj, deep?: boolean): UserFieldPreference;
   ...
   */
  singletonArray(): Array_Type<UserFieldPreference>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<UserFieldPreference> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<UserFieldPreference> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<UserFieldPreference>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<UserFieldPreference> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, UserFieldPreference> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, UserFieldPreference> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<UserFieldPreference>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<UserFieldPreference>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): UserFieldPreference;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): UserFieldPreference;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): UserFieldPreference;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): UserFieldPreference;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): UserFieldPreference;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): UserFieldPreference;
   ...
   * @see #fromString
   */
  static make(s: string): UserFieldPreference | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): UserFieldPreference;
   ...
   */
  static cachedEmptyInst(): UserFieldPreference;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<UserFieldPreference> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): UserFieldPreference;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<UserFieldPreference>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<UserFieldPreference>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<UserFieldPreference> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<UserFieldPreference>> | null;
   ...
   */
  get(include?: string): UserFieldPreference | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): UserFieldPreference | null;
   ...
   */
  getMissing(spec: GetMissingSpec): UserFieldPreference;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): UserFieldPreference | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): UserFieldPreference;
   ...
   * @see #toString
   */
  static fromString(s: string): UserFieldPreference | null;
   ...
   */
  create(spec?: UpsertSpec): UserFieldPreference | null;
   ...
   */
  static createBatch(objs: Array_Type<UserFieldPreference>, spec?: UpsertSpec): ObjList<UserFieldPreference> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<UserFieldPreference>, spec?: CreateBatchObjStreamSpec): ObjList<UserFieldPreference> | null;
   ...
   */
  update(srcObj?: UserFieldPreference, spec?: UpsertSpec): UserFieldPreference | null;
   ...
   */
  upsert(srcObj?: UserFieldPreference, spec?: UpsertSpec): UserFieldPreference | null;
   ...
   */
  merge(spec?: MergeSpec): UserFieldPreference | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): UserFieldPreference | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): UserFieldPreference | null;
   ...
   */
  static updateBatch(objs: Array_Type<UserFieldPreference>, srcObjs?: Array_Type<UserFieldPreference>, spec?: UpsertSpec): ObjList<UserFieldPreference> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<UserFieldPreference> | null>, spec?: UpsertSpec): ObjList<UserFieldPreference> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<UserFieldPreference>, srcObjs?: Array_Type<UserFieldPreference>, spec?: UpsertSpec): ObjList<UserFieldPreference> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<UserFieldPreference> | null>, spec?: UpsertSpec): ObjList<UserFieldPreference> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<UserFieldPreference>, spec?: TouchSpec): ObjList<UserFieldPreference> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<UserFieldPreference>, spec?: MergeSpec): ObjList<UserFieldPreference> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<UserFieldPreference>, mergeInclude: string, spec?: MergeSpec): ObjList<UserFieldPreference> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<UserFieldPreference> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<UserFieldPreference> | null;
   ...
   */
  static mergeAll(mergeObj: UserFieldPreference, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: UserFieldPreference, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<UserFieldPreference>, spec?: UpsertSpec): ObjList<UserFieldPreference> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<UserFieldPreference>, spec?: UpsertSpec): ObjList<UserFieldPreference> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): UserFieldPreference | null;
   ...
   */
  static beforeCreate(objs: Array_Type<UserFieldPreference>): ObjList<UserFieldPreference>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<UserFieldPreference>): ObjList<UserFieldPreference>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<UserFieldPreference>): ObjList<UserFieldPreference>;
   ...
   */
  static afterCreate(objs: Array_Type<UserFieldPreference>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<UserFieldPreference>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<UserFieldPreference>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<UserFieldPreference>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<UserFieldPreference>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): UserFieldPreference | null;
   ...
   */
  withoutIdentity(): UserFieldPreference | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<UserFieldPreference>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: UserFieldPreference, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<UserFieldPreference>, callback?: λFunction<UserFieldPreference | null, UserFieldPreference | null>): ObjList<UserFieldPreference>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<UserFieldPreference>, callback?: λFunction<UserFieldPreference | null, UserFieldPreference | null>): Array_Type<ObjError> | null;
