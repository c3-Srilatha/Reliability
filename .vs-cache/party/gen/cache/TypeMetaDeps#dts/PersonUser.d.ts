// TypeScript definitions for the C3 type PersonUser

/**
 * Map between a Person and a login user
 *
 * @remarks this represents a value passed to a method that expects an instance of PersonUser
 */
declare interface IPersonUser {
 ...
 */
declare class PersonUser extends Obj  {
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): PersonUser;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): PersonUser;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): PersonUser;
  ...
  withVersion(version: number | null): PersonUser;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): PersonUser;

  /**
   * The {@link Person} associated with the user account
   */
  readonly person: Person;
  withPerson(person: IPerson): PersonUser;

  /**
   * Reference from login user account
   */
  readonly user: User;
  withUser(user: IUser): PersonUser;

  /**
   * Date person registered on the C3 Portal (and created User row).
   */
  readonly registrationDate?: DateTime;
  withRegistrationDate(registrationDate: DateTime | Date | string | null): PersonUser;
   ...
   * @see #toJson
   */
  static fromJson(json: any): PersonUser | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): PersonUser | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): PersonUser | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): PersonUser | null;
   ...
   */
  replaceType(old: Type, new_: Type): PersonUser;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): PersonUser;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): PersonUser;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<PersonUser>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<PersonUser>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): PersonUser;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): PersonUser;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): PersonUser;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): PersonUser;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): PersonUser;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): PersonUser;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): PersonUser;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): PersonUser;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): PersonUser;
   ...
   * @see #removeField
   */
  withoutField(field: string): PersonUser;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): PersonUser;
   ...
   */
  withoutFields(fields: Array_Type<string>): PersonUser;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): PersonUser;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): PersonUser;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): PersonUser;
   ...
   * @see #unsetField
   */
  defaultField(field: string): PersonUser;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): PersonUser;
   ...
   * @see #removeField
   */
  unsetField(field: string): PersonUser;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): PersonUser;
   ...
   * @see #unsetField
   */
  removeField(field: string): PersonUser;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): PersonUser;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): PersonUser;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): PersonUser;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): PersonUser;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): PersonUser;

  mergeJson(json: any): PersonUser;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): PersonUser;
   ...
   */
  sumObj(other: Obj, deep?: boolean): PersonUser;
   ...
   */
  singletonArray(): Array_Type<PersonUser>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<PersonUser> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<PersonUser> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<PersonUser>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<PersonUser> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, PersonUser> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, PersonUser> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<PersonUser>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<PersonUser>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): PersonUser;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): PersonUser;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): PersonUser;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): PersonUser;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): PersonUser;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): PersonUser;
   ...
   * @see #fromString
   */
  static make(s: string): PersonUser | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): PersonUser;
   ...
   */
  static cachedEmptyInst(): PersonUser;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<PersonUser> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): PersonUser;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<PersonUser>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<PersonUser>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<PersonUser> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<PersonUser>> | null;
   ...
   */
  static evalFeatureSetBatch(batch: Array_Type<PersonUser>, featureSet: Feature.Set, spec?: EvalFeatureSpec): Data | null;
   ...
   * ```
   */
  static evalFeaturesBatch(batch: Array_Type<PersonUser>, features: Array_Type<string>, spec?: EvalFeaturesSpec): Data | null;
   ...
   */
  get(include?: string): PersonUser | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): PersonUser | null;
   ...
   */
  getMissing(spec: GetMissingSpec): PersonUser;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): PersonUser | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): PersonUser;
   ...
   * @see #toString
   */
  static fromString(s: string): PersonUser | null;
   ...
   */
  create(spec?: UpsertSpec): PersonUser | null;
   ...
   */
  static createBatch(objs: Array_Type<PersonUser>, spec?: UpsertSpec): ObjList<PersonUser> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<PersonUser>, spec?: CreateBatchObjStreamSpec): ObjList<PersonUser> | null;
   ...
   */
  update(srcObj?: PersonUser, spec?: UpsertSpec): PersonUser | null;
   ...
   */
  upsert(srcObj?: PersonUser, spec?: UpsertSpec): PersonUser | null;
   ...
   */
  merge(spec?: MergeSpec): PersonUser | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): PersonUser | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): PersonUser | null;
   ...
   */
  static updateBatch(objs: Array_Type<PersonUser>, srcObjs?: Array_Type<PersonUser>, spec?: UpsertSpec): ObjList<PersonUser> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<PersonUser> | null>, spec?: UpsertSpec): ObjList<PersonUser> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<PersonUser>, srcObjs?: Array_Type<PersonUser>, spec?: UpsertSpec): ObjList<PersonUser> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<PersonUser> | null>, spec?: UpsertSpec): ObjList<PersonUser> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<PersonUser>, spec?: TouchSpec): ObjList<PersonUser> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<PersonUser>, spec?: MergeSpec): ObjList<PersonUser> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<PersonUser>, mergeInclude: string, spec?: MergeSpec): ObjList<PersonUser> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<PersonUser> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<PersonUser> | null;
   ...
   */
  static mergeAll(mergeObj: PersonUser, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: PersonUser, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<PersonUser>, spec?: UpsertSpec): ObjList<PersonUser> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<PersonUser>, spec?: UpsertSpec): ObjList<PersonUser> | null;
   ...
   */
  static beforeCreate(objs: Array_Type<PersonUser>): ObjList<PersonUser>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<PersonUser>): ObjList<PersonUser>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<PersonUser>): ObjList<PersonUser>;
   ...
   */
  static afterCreate(objs: Array_Type<PersonUser>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<PersonUser>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<PersonUser>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<PersonUser>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<PersonUser>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): PersonUser | null;
   ...
   */
  withoutIdentity(): PersonUser | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<PersonUser>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: PersonUser, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<PersonUser>, callback?: λFunction<PersonUser | null, PersonUser | null>): ObjList<PersonUser>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<PersonUser>, callback?: λFunction<PersonUser | null, PersonUser | null>): Array_Type<ObjError> | null;
