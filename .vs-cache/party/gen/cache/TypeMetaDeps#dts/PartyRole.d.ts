// TypeScript definitions for the C3 type PartyRole

/**
 * Represents a specific role that a Party can assume in business contexts.
 * PartyRole is an extendable base type that allows parties ({@link Organization}s or {@link Person}s)
 * to take on different roles such as {@link Customer}, {@link Supplier}, {@link Contact}, {@link Department}, etc.
 * This enables flexible modeling of business relationships and organizational structures.
 *
 * @remarks this represents a value passed to a method that expects an instance of PartyRole
 */
declare interface IPartyRole {
  ...
  /**
   * The {@link Party} that assumes this role
   */
  party: IParty;
 ...
 * This enables flexible modeling of business relationships and organizational structures.
 *
 * @remarks this represents a made instance of PartyRole
 */
declare class PartyRole extends Obj  {
  ...
  withTypeIdent(typeIdent: string | null): PartyRole;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): PartyRole;

  /**
   * Name of this role, derived from the associated party's name
   */
  readonly name?: string;
  withName(name: string | null): PartyRole;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): PartyRole;
  ...
  withVersion(version: number | null): PartyRole;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): PartyRole;

  /**
   * The {@link Party} that assumes this role
   */
  readonly party: Party;
  withParty(party: IParty): PartyRole;

  /**
   * Relationships where this role serves as the source/from role
   */
  readonly relationSources?: Array_Type<PartyRoleRelation>;
  withRelationSources(relationSources: Array_Type<PartyRoleRelation> | Array<IPartyRoleRelation> | null): PartyRole;

  /**
   * Relationships where this role serves as the target/to role
   */
  readonly relationTargets?: Array_Type<PartyRoleRelation>;
  withRelationTargets(relationTargets: Array_Type<PartyRoleRelation> | Array<IPartyRoleRelation> | null): PartyRole;

  /**
   * Parent {@link PartyRole} in the relationship hierarchy, derived from relation targets
   */
  readonly parents?: Array_Type<PartyRole>;
  withParents(parents: Array_Type<PartyRole> | Array<IPartyRole> | null): PartyRole;

  /**
   * Denormalized organizational parents for efficient hierarchy queries
   */
  readonly denormOrgParents?: Array_Type<OrganizationHierarchyDenorm>;
  withDenormOrgParents(denormOrgParents: Array_Type<OrganizationHierarchyDenorm> | Array<IOrganizationHierarchyDenorm> | null): PartyRole;

  /**
   * {@link ScheduleCalendar}s associated with this party role
   */
  readonly scheduleCalendar?: Array_Type<ScheduleCalendar>;
  withScheduleCalendar(scheduleCalendar: Array_Type<ScheduleCalendar> | Array<IScheduleCalendar> | null): PartyRole;
   ...
   * @see #toJson
   */
  static fromJson(json: any): PartyRole | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): PartyRole | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): PartyRole | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): PartyRole | null;
   ...
   */
  replaceType(old: Type, new_: Type): PartyRole;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): PartyRole;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): PartyRole;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<PartyRole>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<PartyRole>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): PartyRole;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): PartyRole;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): PartyRole;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): PartyRole;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): PartyRole;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): PartyRole;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): PartyRole;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): PartyRole;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): PartyRole;
   ...
   * @see #removeField
   */
  withoutField(field: string): PartyRole;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): PartyRole;
   ...
   */
  withoutFields(fields: Array_Type<string>): PartyRole;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): PartyRole;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): PartyRole;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): PartyRole;
   ...
   * @see #unsetField
   */
  defaultField(field: string): PartyRole;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): PartyRole;
   ...
   * @see #removeField
   */
  unsetField(field: string): PartyRole;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): PartyRole;
   ...
   * @see #unsetField
   */
  removeField(field: string): PartyRole;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): PartyRole;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): PartyRole;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): PartyRole;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): PartyRole;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): PartyRole;

  mergeJson(json: any): PartyRole;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): PartyRole;
   ...
   */
  sumObj(other: Obj, deep?: boolean): PartyRole;
   ...
   */
  singletonArray(): Array_Type<PartyRole>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<PartyRole> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<PartyRole> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<PartyRole>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<PartyRole> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, PartyRole> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, PartyRole> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<PartyRole>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<PartyRole>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): PartyRole;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): PartyRole;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): PartyRole;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): PartyRole;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): PartyRole;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): PartyRole;
   ...
   * @see #fromString
   */
  static make(s: string): PartyRole | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): PartyRole;
   ...
   */
  static cachedEmptyInst(): PartyRole;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<PartyRole> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): PartyRole;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<PartyRole>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<PartyRole>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<PartyRole> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<PartyRole>> | null;
   ...
   */
  get(include?: string): PartyRole | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): PartyRole | null;
   ...
   */
  getMissing(spec: GetMissingSpec): PartyRole;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): PartyRole | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): PartyRole;
   ...
   * @see #toString
   */
  static fromString(s: string): PartyRole | null;
   ...
   */
  create(spec?: UpsertSpec): PartyRole | null;
   ...
   */
  static createBatch(objs: Array_Type<PartyRole>, spec?: UpsertSpec): ObjList<PartyRole> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<PartyRole>, spec?: CreateBatchObjStreamSpec): ObjList<PartyRole> | null;
   ...
   */
  update(srcObj?: PartyRole, spec?: UpsertSpec): PartyRole | null;
   ...
   */
  upsert(srcObj?: PartyRole, spec?: UpsertSpec): PartyRole | null;
   ...
   */
  merge(spec?: MergeSpec): PartyRole | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): PartyRole | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): PartyRole | null;
   ...
   */
  static updateBatch(objs: Array_Type<PartyRole>, srcObjs?: Array_Type<PartyRole>, spec?: UpsertSpec): ObjList<PartyRole> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<PartyRole> | null>, spec?: UpsertSpec): ObjList<PartyRole> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<PartyRole>, srcObjs?: Array_Type<PartyRole>, spec?: UpsertSpec): ObjList<PartyRole> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<PartyRole> | null>, spec?: UpsertSpec): ObjList<PartyRole> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<PartyRole>, spec?: TouchSpec): ObjList<PartyRole> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<PartyRole>, spec?: MergeSpec): ObjList<PartyRole> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<PartyRole>, mergeInclude: string, spec?: MergeSpec): ObjList<PartyRole> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<PartyRole> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<PartyRole> | null;
   ...
   */
  static mergeAll(mergeObj: PartyRole, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: PartyRole, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<PartyRole>, spec?: UpsertSpec): ObjList<PartyRole> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<PartyRole>, spec?: UpsertSpec): ObjList<PartyRole> | null;
   ...
   */
  static beforeCreate(objs: Array_Type<PartyRole>): ObjList<PartyRole>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<PartyRole>): ObjList<PartyRole>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<PartyRole>): ObjList<PartyRole>;
   ...
   */
  static afterCreate(objs: Array_Type<PartyRole>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<PartyRole>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<PartyRole>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<PartyRole>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<PartyRole>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): PartyRole | null;
   ...
   */
  withoutIdentity(): PartyRole | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<PartyRole>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: PartyRole, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<PartyRole>, callback?: λFunction<PartyRole | null, PartyRole | null>): ObjList<PartyRole>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<PartyRole>, callback?: λFunction<PartyRole | null, PartyRole | null>): Array_Type<ObjError> | null;
