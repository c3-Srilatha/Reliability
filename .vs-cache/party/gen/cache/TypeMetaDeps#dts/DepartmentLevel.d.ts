// TypeScript definitions for the C3 type DepartmentLevel

/**
 * The department level that maintained by user to indicate different Organization level information
 *
 * @remarks this represents a value passed to a method that expects an instance of DepartmentLevel
 */
declare interface IDepartmentLevel {
 ...
 */
declare class DepartmentLevel extends Obj  {
   ...
   */
  readonly id: string;
  withId(id: string): DepartmentLevel;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): DepartmentLevel;

  /**
   * The name of this LOV item.
   */
  readonly name?: string;
  withName(name: string | null): DepartmentLevel;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): DepartmentLevel;
  ...
  withVersion(version: number | null): DepartmentLevel;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): DepartmentLevel;
  ...
  withUserUpdatedFields(userUpdatedFields: Array_Type<string> | Array<string> | null): DepartmentLevel;
  ...
  withHidden(hidden: boolean): DepartmentLevel;
  ...
  withUserOwned(userOwned: boolean): DepartmentLevel;
  ...
  withTypeIdent(typeIdent: string | null): DepartmentLevel;

  /**
   * The position of this LOV item in the list of values.
   */
  readonly position?: number;
  withPosition(position: number | null): DepartmentLevel;
   ...
   * @see #toJson
   */
  static fromJson(json: any): DepartmentLevel | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): DepartmentLevel | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): DepartmentLevel | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): DepartmentLevel | null;
   ...
   */
  replaceType(old: Type, new_: Type): DepartmentLevel;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): DepartmentLevel;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): DepartmentLevel;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<DepartmentLevel>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<DepartmentLevel>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): DepartmentLevel;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DepartmentLevel;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DepartmentLevel;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): DepartmentLevel;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): DepartmentLevel;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): DepartmentLevel;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): DepartmentLevel;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): DepartmentLevel;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): DepartmentLevel;
   ...
   * @see #removeField
   */
  withoutField(field: string): DepartmentLevel;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): DepartmentLevel;
   ...
   */
  withoutFields(fields: Array_Type<string>): DepartmentLevel;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): DepartmentLevel;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): DepartmentLevel;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): DepartmentLevel;
   ...
   * @see #unsetField
   */
  defaultField(field: string): DepartmentLevel;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): DepartmentLevel;
   ...
   * @see #removeField
   */
  unsetField(field: string): DepartmentLevel;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): DepartmentLevel;
   ...
   * @see #unsetField
   */
  removeField(field: string): DepartmentLevel;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): DepartmentLevel;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): DepartmentLevel;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): DepartmentLevel;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): DepartmentLevel;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): DepartmentLevel;

  mergeJson(json: any): DepartmentLevel;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): DepartmentLevel;
   ...
   */
  sumObj(other: Obj, deep?: boolean): DepartmentLevel;
   ...
   */
  singletonArray(): Array_Type<DepartmentLevel>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<DepartmentLevel> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<DepartmentLevel> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<DepartmentLevel>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<DepartmentLevel> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, DepartmentLevel> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, DepartmentLevel> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<DepartmentLevel>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<DepartmentLevel>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): DepartmentLevel;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): DepartmentLevel;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): DepartmentLevel;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): DepartmentLevel;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): DepartmentLevel;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): DepartmentLevel;
   ...
   * @see #fromString
   */
  static make(s: string): DepartmentLevel | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): DepartmentLevel;
   ...
   */
  static cachedEmptyInst(): DepartmentLevel;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<DepartmentLevel> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): DepartmentLevel;
   ...
   */
  static allCached(): Stream<DepartmentLevel> | null;
   ...
   */
  static find(filter?: string): Stream<DepartmentLevel> | null;
   ...
   *         Otherwise no population will be performed.
   */
  static findBy(field: string, value: any): Stream<DepartmentLevel> | null;

  /**
   * @return cached instance.
   */
  getCached(): DepartmentLevel | null;

  /**
   * @return cached instance by the key.
   */
  static forCacheKey(key: string): DepartmentLevel | null;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<DepartmentLevel>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<DepartmentLevel>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<DepartmentLevel> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<DepartmentLevel>> | null;
   ...
   */
  get(include?: string): DepartmentLevel | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): DepartmentLevel | null;
   ...
   */
  getMissing(spec: GetMissingSpec): DepartmentLevel;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): DepartmentLevel | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): DepartmentLevel;
   ...
   * @see #toString
   */
  static fromString(s: string): DepartmentLevel | null;
   ...
   */
  create(spec?: UpsertSpec): DepartmentLevel | null;
   ...
   */
  static createBatch(objs: Array_Type<DepartmentLevel>, spec?: UpsertSpec): ObjList<DepartmentLevel> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<DepartmentLevel>, spec?: CreateBatchObjStreamSpec): ObjList<DepartmentLevel> | null;
   ...
   */
  update(srcObj?: DepartmentLevel, spec?: UpsertSpec): DepartmentLevel | null;
   ...
   */
  upsert(srcObj?: DepartmentLevel, spec?: UpsertSpec): DepartmentLevel | null;
   ...
   */
  merge(spec?: MergeSpec): DepartmentLevel | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): DepartmentLevel | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): DepartmentLevel | null;
   ...
   */
  static updateBatch(objs: Array_Type<DepartmentLevel>, srcObjs?: Array_Type<DepartmentLevel>, spec?: UpsertSpec): ObjList<DepartmentLevel> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<DepartmentLevel> | null>, spec?: UpsertSpec): ObjList<DepartmentLevel> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<DepartmentLevel>, srcObjs?: Array_Type<DepartmentLevel>, spec?: UpsertSpec): ObjList<DepartmentLevel> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<DepartmentLevel> | null>, spec?: UpsertSpec): ObjList<DepartmentLevel> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<DepartmentLevel>, spec?: TouchSpec): ObjList<DepartmentLevel> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<DepartmentLevel>, spec?: MergeSpec): ObjList<DepartmentLevel> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<DepartmentLevel>, mergeInclude: string, spec?: MergeSpec): ObjList<DepartmentLevel> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<DepartmentLevel> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<DepartmentLevel> | null;
   ...
   */
  static mergeAll(mergeObj: DepartmentLevel, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: DepartmentLevel, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<DepartmentLevel>, spec?: UpsertSpec): ObjList<DepartmentLevel> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<DepartmentLevel>, spec?: UpsertSpec): ObjList<DepartmentLevel> | null;
   ...
   */
  static beforeCreate(objs: Array_Type<DepartmentLevel>): ObjList<DepartmentLevel>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<DepartmentLevel>): ObjList<DepartmentLevel>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<DepartmentLevel>): ObjList<DepartmentLevel>;
   ...
   */
  static afterCreate(objs: Array_Type<DepartmentLevel>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<DepartmentLevel>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<DepartmentLevel>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<DepartmentLevel>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<DepartmentLevel>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): DepartmentLevel | null;
   ...
   */
  withoutIdentity(): DepartmentLevel | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<DepartmentLevel>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: DepartmentLevel, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<DepartmentLevel>, callback?: λFunction<DepartmentLevel | null, DepartmentLevel | null>): ObjList<DepartmentLevel>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<DepartmentLevel>, callback?: λFunction<DepartmentLevel | null, DepartmentLevel | null>): Array_Type<ObjError> | null;
   ...
   */
  publish(subPath?: string, contentType?: string): DepartmentLevel;
   ...
   */
  static removeSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<DepartmentLevel> | null;
   ...
   */
  createSeedData(spec?: UpsertSpec): DepartmentLevel | null;
   ...
   */
  static createSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<DepartmentLevel> | null;
   ...
   */
  updateSeedData(srcObj?: SeedData, spec?: UpsertSpec): DepartmentLevel | null;
   ...
   */
  static updateSeedDataBatch(objs?: Array_Type<SeedData>, srcObjs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<DepartmentLevel> | null;
   ...
   * @return updated obj instance, same as {@link Persistable#update} return value.
   */
  clearUserUpdates(spec?: MergeSpec): DepartmentLevel | null;
   ...
   *         {@link Persistable#updateBatch}.
   */
  static clearUserUpdatesBatch(objs?: Array_Type<SeedData>, spec?: MergeSpec): ObjList<DepartmentLevel> | null;
  ...
  dependencies(): SeedDataDeps<DepartmentLevel> | null;
