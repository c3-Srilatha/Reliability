// TypeScript definitions for the C3 type TestDepartment

/**
 * @remarks this represents a value passed to a method that expects an instance of TestDepartment
 */
declare interface ITestDepartment {
  ...
  children?: C3.Array<TestDepartment | null> | Array<ITestDepartment | null>;

  parent?: ITestDepartment | null;

  denormParents?: C3.Array<TestDepartmentDenorm | null> | Array<ITestDepartmentDenorm | null>;

  denormChildren?: C3.Array<TestDepartmentDenorm | null> | Array<ITestDepartmentDenorm | null>;
}

/**
 * @remarks this represents a made instance of TestDepartment
 */
declare class TestDepartment extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): TestDepartment | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): TestDepartment | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): TestDepartment | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): TestDepartment | null;
   ...
   */
  replaceType(old: Type, new_: Type): TestDepartment;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): TestDepartment;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): TestDepartment;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<TestDepartment | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<TestDepartment | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): TestDepartment;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TestDepartment;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TestDepartment;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): TestDepartment;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): TestDepartment;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): TestDepartment;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): TestDepartment;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): TestDepartment;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): TestDepartment;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): TestDepartment;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): TestDepartment;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): TestDepartment;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): TestDepartment;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): TestDepartment;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): TestDepartment;
   ...
   * @see #unsetField
   */
  defaultField(field: string): TestDepartment;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): TestDepartment;
   ...
   * @see #removeField
   */
  unsetField(field: string): TestDepartment;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): TestDepartment;
   ...
   * @see #unsetField
   */
  removeField(field: string): TestDepartment;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): TestDepartment;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): TestDepartment;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): TestDepartment;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): TestDepartment;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): TestDepartment;

  mergeJson(json: any | null): TestDepartment;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): TestDepartment;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): TestDepartment;
   ...
   */
  singletonArray(): C3.Array<TestDepartment | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<TestDepartment | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<TestDepartment | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<TestDepartment | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<TestDepartment | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, TestDepartment | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, TestDepartment | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<TestDepartment | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<TestDepartment | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): TestDepartment;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): TestDepartment;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): TestDepartment;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): TestDepartment;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): TestDepartment;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): TestDepartment;
   ...
   * @see #fromString
   */
  static make(s: string | null): TestDepartment | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): TestDepartment;
   ...
   */
  static cachedEmptyInst(): TestDepartment;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<TestDepartment>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): TestDepartment;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<TestDepartment | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<TestDepartment | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<TestDepartment | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<TestDepartment | null> | null>;
   ...
   */
  get(include?: string | null): TestDepartment | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): TestDepartment | null;
   ...
   */
  getMissing(spec: GetMissingSpec): TestDepartment;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): TestDepartment | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): TestDepartment;
   ...
   * @see #toString
   */
  static fromString(s: string | null): TestDepartment | null;
   ...
   */
  create(spec?: UpsertSpec | null): TestDepartment | null;
   ...
   */
  static createBatch(objs: C3.Array<TestDepartment | null> | null, spec?: UpsertSpec | null): ObjList<TestDepartment | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<TestDepartment | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<TestDepartment | null> | null;
   ...
   */
  update(srcObj?: TestDepartment | null, spec?: UpsertSpec | null): TestDepartment | null;
   ...
   */
  upsert(srcObj?: TestDepartment | null, spec?: UpsertSpec | null): TestDepartment | null;
   ...
   */
  merge(spec?: MergeSpec | null): TestDepartment | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): TestDepartment | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): TestDepartment | null;
   ...
   */
  static updateBatch(objs: C3.Array<TestDepartment | null> | null, srcObjs?: C3.Array<TestDepartment | null>, spec?: UpsertSpec | null): ObjList<TestDepartment | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<TestDepartment | null>>, spec?: UpsertSpec | null): ObjList<TestDepartment | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<TestDepartment | null> | null, srcObjs?: C3.Array<TestDepartment | null>, spec?: UpsertSpec | null): ObjList<TestDepartment | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<TestDepartment | null>>, spec?: UpsertSpec | null): ObjList<TestDepartment | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<TestDepartment | null> | null, spec?: TouchSpec | null): ObjList<TestDepartment | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<TestDepartment | null> | null, spec?: MergeSpec | null): ObjList<TestDepartment | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<TestDepartment | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<TestDepartment | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<TestDepartment | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<TestDepartment | null> | null;
   ...
   */
  static mergeAll(mergeObj: TestDepartment | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: TestDepartment | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<TestDepartment | null> | null, spec?: UpsertSpec | null): ObjList<TestDepartment | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<TestDepartment | null> | null, spec?: UpsertSpec | null): ObjList<TestDepartment | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<TestDepartment | null> | null): ObjList<TestDepartment | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<TestDepartment | null> | null): ObjList<TestDepartment | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<TestDepartment | null> | null): ObjList<TestDepartment | null>;
   ...
   */
  static afterCreate(objs: C3.Array<TestDepartment | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<TestDepartment | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<TestDepartment | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<TestDepartment | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<TestDepartment | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): TestDepartment | null;
   ...
   */
  withoutIdentity(): TestDepartment | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<TestDepartment | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: TestDepartment | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<TestDepartment | null> | null, callback?: λFunction<TestDepartment | null, TestDepartment | null> | null): ObjList<TestDepartment | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<TestDepartment | null> | null, callback?: λFunction<TestDepartment | null, TestDepartment | null> | null): C3.Array<ObjError | null>;
