// TypeScript definitions for the C3 type TestOrganizationDenorm

/**
 * @remarks this represents a value passed to a method that expects an instance of TestOrganizationDenorm
 */
declare interface ITestOrganizationDenorm {
   ...
   */
  from?: ITestOrganization | null;

  /**
   * To vertex for this edge
   */
  to?: ITestOrganization | null;
 ...
 */
declare class TestOrganizationDenorm extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): TestOrganizationDenorm | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): TestOrganizationDenorm | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): TestOrganizationDenorm | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): TestOrganizationDenorm | null;
   ...
   */
  replaceType(old: Type, new_: Type): TestOrganizationDenorm;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): TestOrganizationDenorm;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): TestOrganizationDenorm;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<TestOrganizationDenorm | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<TestOrganizationDenorm | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): TestOrganizationDenorm;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TestOrganizationDenorm;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TestOrganizationDenorm;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): TestOrganizationDenorm;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): TestOrganizationDenorm;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): TestOrganizationDenorm;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): TestOrganizationDenorm;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): TestOrganizationDenorm;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): TestOrganizationDenorm;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): TestOrganizationDenorm;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): TestOrganizationDenorm;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): TestOrganizationDenorm;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): TestOrganizationDenorm;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): TestOrganizationDenorm;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): TestOrganizationDenorm;
   ...
   * @see #unsetField
   */
  defaultField(field: string): TestOrganizationDenorm;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): TestOrganizationDenorm;
   ...
   * @see #removeField
   */
  unsetField(field: string): TestOrganizationDenorm;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): TestOrganizationDenorm;
   ...
   * @see #unsetField
   */
  removeField(field: string): TestOrganizationDenorm;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): TestOrganizationDenorm;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): TestOrganizationDenorm;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): TestOrganizationDenorm;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): TestOrganizationDenorm;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): TestOrganizationDenorm;

  mergeJson(json: any | null): TestOrganizationDenorm;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): TestOrganizationDenorm;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): TestOrganizationDenorm;
   ...
   */
  singletonArray(): C3.Array<TestOrganizationDenorm | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<TestOrganizationDenorm | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<TestOrganizationDenorm | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<TestOrganizationDenorm | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<TestOrganizationDenorm | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, TestOrganizationDenorm | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, TestOrganizationDenorm | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<TestOrganizationDenorm | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<TestOrganizationDenorm | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): TestOrganizationDenorm;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): TestOrganizationDenorm;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): TestOrganizationDenorm;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): TestOrganizationDenorm;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): TestOrganizationDenorm;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): TestOrganizationDenorm;
   ...
   * @see #fromString
   */
  static make(s: string | null): TestOrganizationDenorm | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): TestOrganizationDenorm;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): TestOrganizationDenorm;
   ...
   */
  static cachedEmptyInst(): TestOrganizationDenorm;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<TestOrganizationDenorm>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): TestOrganizationDenorm;
   ...
   * @see #toString
   */
  static fromString(s: string | null): TestOrganizationDenorm | null;
   ...
   */
  static denormalizeHierarchy(batchSize?: number | null, batchWeight?: number | null, async?: boolean, edgeType?: Type | null): C3.Array<HierarchyDenormBatchJob | null>;
   ...
   * @return a list of batch jobs one per edge type in async mode indicating status of the denorm
   */
  static denormalizeIncrementally(batchSize?: number | null, batchWeight?: number | null, async?: boolean, invalidatedVertices?: C3.Array<string | null>, edgeType?: Type | null, edgesRemoved?: boolean): C3.Array<HierarchyDenormBatchJob | null>;
   ...
   */
  static getDescendants(parents?: C3.Array<TestOrganization | null>, spec?: DescendantsSpec | null): DescendantsResult | null;
   ...
   */
  static countDescendants(parents?: C3.Array<TestOrganization | null>, spec?: DescendantsSpec | null): DescendantsResult | null;
   ...
   */
  static getAncestors(nodes?: C3.Array<TestOrganization | null>, spec?: AncestorsSpec | null): C3.Array<AncestorsResult | null>;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<TestOrganizationDenorm | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<TestOrganizationDenorm | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<TestOrganizationDenorm | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<TestOrganizationDenorm | null> | null>;
   ...
   */
  get(include?: string | null): TestOrganizationDenorm | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): TestOrganizationDenorm | null;
   ...
   */
  getMissing(spec: GetMissingSpec): TestOrganizationDenorm;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): TestOrganizationDenorm | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): TestOrganizationDenorm;
   ...
   */
  create(spec?: UpsertSpec | null): TestOrganizationDenorm | null;
   ...
   */
  static createBatch(objs: C3.Array<TestOrganizationDenorm | null> | null, spec?: UpsertSpec | null): ObjList<TestOrganizationDenorm | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<TestOrganizationDenorm | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<TestOrganizationDenorm | null> | null;
   ...
   */
  update(srcObj?: TestOrganizationDenorm | null, spec?: UpsertSpec | null): TestOrganizationDenorm | null;
   ...
   */
  upsert(srcObj?: TestOrganizationDenorm | null, spec?: UpsertSpec | null): TestOrganizationDenorm | null;
   ...
   */
  merge(spec?: MergeSpec | null): TestOrganizationDenorm | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): TestOrganizationDenorm | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): TestOrganizationDenorm | null;
   ...
   */
  static updateBatch(objs: C3.Array<TestOrganizationDenorm | null> | null, srcObjs?: C3.Array<TestOrganizationDenorm | null>, spec?: UpsertSpec | null): ObjList<TestOrganizationDenorm | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<TestOrganizationDenorm | null>>, spec?: UpsertSpec | null): ObjList<TestOrganizationDenorm | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<TestOrganizationDenorm | null> | null, srcObjs?: C3.Array<TestOrganizationDenorm | null>, spec?: UpsertSpec | null): ObjList<TestOrganizationDenorm | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<TestOrganizationDenorm | null>>, spec?: UpsertSpec | null): ObjList<TestOrganizationDenorm | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<TestOrganizationDenorm | null> | null, spec?: TouchSpec | null): ObjList<TestOrganizationDenorm | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<TestOrganizationDenorm | null> | null, spec?: MergeSpec | null): ObjList<TestOrganizationDenorm | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<TestOrganizationDenorm | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<TestOrganizationDenorm | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<TestOrganizationDenorm | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<TestOrganizationDenorm | null> | null;
   ...
   */
  static mergeAll(mergeObj: TestOrganizationDenorm | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: TestOrganizationDenorm | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<TestOrganizationDenorm | null> | null, spec?: UpsertSpec | null): ObjList<TestOrganizationDenorm | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<TestOrganizationDenorm | null> | null, spec?: UpsertSpec | null): ObjList<TestOrganizationDenorm | null> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): TestOrganizationDenorm | null;
   ...
   */
  static beforeCreate(objs: C3.Array<TestOrganizationDenorm | null> | null): ObjList<TestOrganizationDenorm | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<TestOrganizationDenorm | null> | null): ObjList<TestOrganizationDenorm | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<TestOrganizationDenorm | null> | null): ObjList<TestOrganizationDenorm | null>;
   ...
   */
  static afterCreate(objs: C3.Array<TestOrganizationDenorm | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<TestOrganizationDenorm | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<TestOrganizationDenorm | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<TestOrganizationDenorm | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<TestOrganizationDenorm | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): TestOrganizationDenorm | null;
   ...
   */
  withoutIdentity(): TestOrganizationDenorm | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<TestOrganizationDenorm | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: TestOrganizationDenorm | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<TestOrganizationDenorm | null> | null, callback?: λFunction<TestOrganizationDenorm | null, TestOrganizationDenorm | null> | null): ObjList<TestOrganizationDenorm | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<TestOrganizationDenorm | null> | null, callback?: λFunction<TestOrganizationDenorm | null, TestOrganizationDenorm | null> | null): C3.Array<ObjError | null>;
