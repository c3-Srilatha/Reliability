// TypeScript definitions for the C3 type TestOrganization

/**
 * @remarks this represents a value passed to a method that expects an instance of TestOrganization
 */
declare interface ITestOrganization {
  ...
  children?: C3.Array<TestOrganization | null> | Array<ITestOrganization | null>;

  parent?: ITestOrganization | null;

  /**
   * Denormalized parents which are used to show the hierarchy.
   */
  denormParents?: C3.Array<TestOrganizationDenorm | null> | Array<ITestOrganizationDenorm | null>;

  /**
   * Denormalized children which are used to show the hierarchy.
   */
  denormChildren?: C3.Array<TestOrganizationDenorm | null> | Array<ITestOrganizationDenorm | null>;
}

/**
 * @remarks this represents a made instance of TestOrganization
 */
declare class TestOrganization extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): TestOrganization | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): TestOrganization | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): TestOrganization | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): TestOrganization | null;
   ...
   */
  replaceType(old: Type, new_: Type): TestOrganization;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): TestOrganization;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): TestOrganization;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<TestOrganization | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<TestOrganization | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): TestOrganization;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TestOrganization;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TestOrganization;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): TestOrganization;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): TestOrganization;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): TestOrganization;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): TestOrganization;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): TestOrganization;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): TestOrganization;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): TestOrganization;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): TestOrganization;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): TestOrganization;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): TestOrganization;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): TestOrganization;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): TestOrganization;
   ...
   * @see #unsetField
   */
  defaultField(field: string): TestOrganization;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): TestOrganization;
   ...
   * @see #removeField
   */
  unsetField(field: string): TestOrganization;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): TestOrganization;
   ...
   * @see #unsetField
   */
  removeField(field: string): TestOrganization;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): TestOrganization;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): TestOrganization;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): TestOrganization;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): TestOrganization;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): TestOrganization;

  mergeJson(json: any | null): TestOrganization;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): TestOrganization;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): TestOrganization;
   ...
   */
  singletonArray(): C3.Array<TestOrganization | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<TestOrganization | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<TestOrganization | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<TestOrganization | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<TestOrganization | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, TestOrganization | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, TestOrganization | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<TestOrganization | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<TestOrganization | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): TestOrganization;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): TestOrganization;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): TestOrganization;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): TestOrganization;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): TestOrganization;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): TestOrganization;
   ...
   * @see #fromString
   */
  static make(s: string | null): TestOrganization | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): TestOrganization;
   ...
   */
  static cachedEmptyInst(): TestOrganization;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<TestOrganization>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): TestOrganization;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<TestOrganization | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<TestOrganization | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<TestOrganization | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<TestOrganization | null> | null>;
   ...
   */
  get(include?: string | null): TestOrganization | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): TestOrganization | null;
   ...
   */
  getMissing(spec: GetMissingSpec): TestOrganization;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): TestOrganization | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): TestOrganization;
   ...
   * @see #toString
   */
  static fromString(s: string | null): TestOrganization | null;
   ...
   */
  create(spec?: UpsertSpec | null): TestOrganization | null;
   ...
   */
  static createBatch(objs: C3.Array<TestOrganization | null> | null, spec?: UpsertSpec | null): ObjList<TestOrganization | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<TestOrganization | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<TestOrganization | null> | null;
   ...
   */
  update(srcObj?: TestOrganization | null, spec?: UpsertSpec | null): TestOrganization | null;
   ...
   */
  upsert(srcObj?: TestOrganization | null, spec?: UpsertSpec | null): TestOrganization | null;
   ...
   */
  merge(spec?: MergeSpec | null): TestOrganization | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): TestOrganization | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): TestOrganization | null;
   ...
   */
  static updateBatch(objs: C3.Array<TestOrganization | null> | null, srcObjs?: C3.Array<TestOrganization | null>, spec?: UpsertSpec | null): ObjList<TestOrganization | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<TestOrganization | null>>, spec?: UpsertSpec | null): ObjList<TestOrganization | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<TestOrganization | null> | null, srcObjs?: C3.Array<TestOrganization | null>, spec?: UpsertSpec | null): ObjList<TestOrganization | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<TestOrganization | null>>, spec?: UpsertSpec | null): ObjList<TestOrganization | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<TestOrganization | null> | null, spec?: TouchSpec | null): ObjList<TestOrganization | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<TestOrganization | null> | null, spec?: MergeSpec | null): ObjList<TestOrganization | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<TestOrganization | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<TestOrganization | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<TestOrganization | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<TestOrganization | null> | null;
   ...
   */
  static mergeAll(mergeObj: TestOrganization | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: TestOrganization | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<TestOrganization | null> | null, spec?: UpsertSpec | null): ObjList<TestOrganization | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<TestOrganization | null> | null, spec?: UpsertSpec | null): ObjList<TestOrganization | null> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): TestOrganization | null;
   ...
   */
  static beforeCreate(objs: C3.Array<TestOrganization | null> | null): ObjList<TestOrganization | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<TestOrganization | null> | null): ObjList<TestOrganization | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<TestOrganization | null> | null): ObjList<TestOrganization | null>;
   ...
   */
  static afterCreate(objs: C3.Array<TestOrganization | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<TestOrganization | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<TestOrganization | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<TestOrganization | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<TestOrganization | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): TestOrganization | null;
   ...
   */
  withoutIdentity(): TestOrganization | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<TestOrganization | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: TestOrganization | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<TestOrganization | null> | null, callback?: λFunction<TestOrganization | null, TestOrganization | null> | null): ObjList<TestOrganization | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<TestOrganization | null> | null, callback?: λFunction<TestOrganization | null, TestOrganization | null> | null): C3.Array<ObjError | null>;
