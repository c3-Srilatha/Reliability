// TypeScript definitions for the C3 type TestDepartmentDenorm

/**
 * @remarks this represents a value passed to a method that expects an instance of TestDepartmentDenorm
 */
declare interface ITestDepartmentDenorm {
   ...
   */
  from?: ITestDepartment | null;

  /**
   * To vertex for this edge
   */
  to?: ITestDepartment | null;
 ...
 */
declare class TestDepartmentDenorm extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): TestDepartmentDenorm | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): TestDepartmentDenorm | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): TestDepartmentDenorm | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): TestDepartmentDenorm | null;
   ...
   */
  replaceType(old: Type, new_: Type): TestDepartmentDenorm;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): TestDepartmentDenorm;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): TestDepartmentDenorm;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<TestDepartmentDenorm | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<TestDepartmentDenorm | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): TestDepartmentDenorm;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TestDepartmentDenorm;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TestDepartmentDenorm;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): TestDepartmentDenorm;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): TestDepartmentDenorm;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): TestDepartmentDenorm;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): TestDepartmentDenorm;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): TestDepartmentDenorm;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): TestDepartmentDenorm;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): TestDepartmentDenorm;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): TestDepartmentDenorm;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): TestDepartmentDenorm;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): TestDepartmentDenorm;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): TestDepartmentDenorm;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): TestDepartmentDenorm;
   ...
   * @see #unsetField
   */
  defaultField(field: string): TestDepartmentDenorm;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): TestDepartmentDenorm;
   ...
   * @see #removeField
   */
  unsetField(field: string): TestDepartmentDenorm;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): TestDepartmentDenorm;
   ...
   * @see #unsetField
   */
  removeField(field: string): TestDepartmentDenorm;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): TestDepartmentDenorm;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): TestDepartmentDenorm;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): TestDepartmentDenorm;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): TestDepartmentDenorm;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): TestDepartmentDenorm;

  mergeJson(json: any | null): TestDepartmentDenorm;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): TestDepartmentDenorm;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): TestDepartmentDenorm;
   ...
   */
  singletonArray(): C3.Array<TestDepartmentDenorm | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<TestDepartmentDenorm | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<TestDepartmentDenorm | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<TestDepartmentDenorm | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<TestDepartmentDenorm | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, TestDepartmentDenorm | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, TestDepartmentDenorm | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<TestDepartmentDenorm | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<TestDepartmentDenorm | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): TestDepartmentDenorm;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): TestDepartmentDenorm;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): TestDepartmentDenorm;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): TestDepartmentDenorm;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): TestDepartmentDenorm;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): TestDepartmentDenorm;
   ...
   * @see #fromString
   */
  static make(s: string | null): TestDepartmentDenorm | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): TestDepartmentDenorm;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): TestDepartmentDenorm;
   ...
   */
  static cachedEmptyInst(): TestDepartmentDenorm;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<TestDepartmentDenorm>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): TestDepartmentDenorm;
   ...
   * @see #toString
   */
  static fromString(s: string | null): TestDepartmentDenorm | null;
   ...
   */
  static getDescendants(parents?: C3.Array<TestDepartment | null>, spec?: DescendantsSpec | null): DescendantsResult | null;
   ...
   */
  static countDescendants(parents?: C3.Array<TestDepartment | null>, spec?: DescendantsSpec | null): DescendantsResult | null;
   ...
   */
  static getAncestors(nodes?: C3.Array<TestDepartment | null>, spec?: AncestorsSpec | null): C3.Array<AncestorsResult | null>;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<TestDepartmentDenorm | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<TestDepartmentDenorm | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<TestDepartmentDenorm | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<TestDepartmentDenorm | null> | null>;
   ...
   */
  get(include?: string | null): TestDepartmentDenorm | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): TestDepartmentDenorm | null;
   ...
   */
  getMissing(spec: GetMissingSpec): TestDepartmentDenorm;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): TestDepartmentDenorm | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): TestDepartmentDenorm;
   ...
   */
  create(spec?: UpsertSpec | null): TestDepartmentDenorm | null;
   ...
   */
  static createBatch(objs: C3.Array<TestDepartmentDenorm | null> | null, spec?: UpsertSpec | null): ObjList<TestDepartmentDenorm | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<TestDepartmentDenorm | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<TestDepartmentDenorm | null> | null;
   ...
   */
  update(srcObj?: TestDepartmentDenorm | null, spec?: UpsertSpec | null): TestDepartmentDenorm | null;
   ...
   */
  upsert(srcObj?: TestDepartmentDenorm | null, spec?: UpsertSpec | null): TestDepartmentDenorm | null;
   ...
   */
  merge(spec?: MergeSpec | null): TestDepartmentDenorm | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): TestDepartmentDenorm | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): TestDepartmentDenorm | null;
   ...
   */
  static updateBatch(objs: C3.Array<TestDepartmentDenorm | null> | null, srcObjs?: C3.Array<TestDepartmentDenorm | null>, spec?: UpsertSpec | null): ObjList<TestDepartmentDenorm | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<TestDepartmentDenorm | null>>, spec?: UpsertSpec | null): ObjList<TestDepartmentDenorm | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<TestDepartmentDenorm | null> | null, srcObjs?: C3.Array<TestDepartmentDenorm | null>, spec?: UpsertSpec | null): ObjList<TestDepartmentDenorm | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<TestDepartmentDenorm | null>>, spec?: UpsertSpec | null): ObjList<TestDepartmentDenorm | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<TestDepartmentDenorm | null> | null, spec?: TouchSpec | null): ObjList<TestDepartmentDenorm | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<TestDepartmentDenorm | null> | null, spec?: MergeSpec | null): ObjList<TestDepartmentDenorm | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<TestDepartmentDenorm | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<TestDepartmentDenorm | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<TestDepartmentDenorm | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<TestDepartmentDenorm | null> | null;
   ...
   */
  static mergeAll(mergeObj: TestDepartmentDenorm | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: TestDepartmentDenorm | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<TestDepartmentDenorm | null> | null, spec?: UpsertSpec | null): ObjList<TestDepartmentDenorm | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<TestDepartmentDenorm | null> | null, spec?: UpsertSpec | null): ObjList<TestDepartmentDenorm | null> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): TestDepartmentDenorm | null;
   ...
   */
  static beforeCreate(objs: C3.Array<TestDepartmentDenorm | null> | null): ObjList<TestDepartmentDenorm | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<TestDepartmentDenorm | null> | null): ObjList<TestDepartmentDenorm | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<TestDepartmentDenorm | null> | null): ObjList<TestDepartmentDenorm | null>;
   ...
   */
  static afterCreate(objs: C3.Array<TestDepartmentDenorm | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<TestDepartmentDenorm | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<TestDepartmentDenorm | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<TestDepartmentDenorm | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<TestDepartmentDenorm | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): TestDepartmentDenorm | null;
   ...
   */
  withoutIdentity(): TestDepartmentDenorm | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<TestDepartmentDenorm | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: TestDepartmentDenorm | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<TestDepartmentDenorm | null> | null, callback?: λFunction<TestDepartmentDenorm | null, TestDepartmentDenorm | null> | null): ObjList<TestDepartmentDenorm | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<TestDepartmentDenorm | null> | null, callback?: λFunction<TestDepartmentDenorm | null, TestDepartmentDenorm | null> | null): C3.Array<ObjError | null>;
