// TypeScript definitions for the C3 type Hierarchy
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of Hierarchy
 */
declare interface IHierarchy {
   ...
   */
  hierarchyLevels?: C3.Map<string | null, HierarchyLevel | null> | {[key: string | null]: IHierarchyLevel | null};

  /**
   * A list of current root nodes
   */
  rootNodeList?: C3.Array<any> | Array<any>;
 ...
 */
declare class Hierarchy extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): Hierarchy | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): Hierarchy | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): Hierarchy | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): Hierarchy | null;
   ...
   */
  replaceType(old: Type, new_: Type): Hierarchy;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Hierarchy;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Hierarchy;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Hierarchy | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Hierarchy | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Hierarchy;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Hierarchy;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Hierarchy;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): Hierarchy;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): Hierarchy;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): Hierarchy;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Hierarchy;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Hierarchy;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): Hierarchy;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): Hierarchy;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): Hierarchy;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): Hierarchy;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Hierarchy;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): Hierarchy;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Hierarchy;
   ...
   * @see #unsetField
   */
  defaultField(field: string): Hierarchy;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): Hierarchy;
   ...
   * @see #removeField
   */
  unsetField(field: string): Hierarchy;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): Hierarchy;
   ...
   * @see #unsetField
   */
  removeField(field: string): Hierarchy;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): Hierarchy;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Hierarchy;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): Hierarchy;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Hierarchy;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Hierarchy;

  mergeJson(json: any | null): Hierarchy;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Hierarchy;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): Hierarchy;
   ...
   */
  singletonArray(): C3.Array<Hierarchy | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<Hierarchy | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<Hierarchy | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<Hierarchy | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<Hierarchy | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, Hierarchy | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, Hierarchy | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<Hierarchy | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<Hierarchy | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Hierarchy;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Hierarchy;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Hierarchy;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): Hierarchy;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Hierarchy;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): Hierarchy;
   ...
   * @see #fromString
   */
  static make(s: string | null): Hierarchy | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Hierarchy;
   ...
   */
  static cachedEmptyInst(): Hierarchy;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Hierarchy>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): Hierarchy;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<Hierarchy | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<Hierarchy | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<Hierarchy | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): Hierarchy | null;
   ...
   * @see findByCacheKey
   */
  static forCacheKey(key: string | null): Hierarchy | null;
   ...
   * @see findByCacheKey
   */
  getCached(): Hierarchy | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): Hierarchy | null;
   ...
   */
  static produce(key: string): Hierarchy | null;
   ...
   */
  static produceAll(): C3.Map<string | null, Hierarchy | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, Hierarchy | null>;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<Hierarchy | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<Hierarchy | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<Hierarchy | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<Hierarchy | null> | null>;
   ...
   */
  get(include?: string | null): Hierarchy | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): Hierarchy | null;
   ...
   */
  getMissing(spec: GetMissingSpec): Hierarchy;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): Hierarchy | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): Hierarchy;
   ...
   * @see #toString
   */
  static fromString(s: string | null): Hierarchy | null;
   ...
   */
  create(spec?: UpsertSpec | null): Hierarchy | null;
   ...
   */
  static createBatch(objs: C3.Array<Hierarchy | null> | null, spec?: UpsertSpec | null): ObjList<Hierarchy | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<Hierarchy | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<Hierarchy | null> | null;
   ...
   */
  update(srcObj?: Hierarchy | null, spec?: UpsertSpec | null): Hierarchy | null;
   ...
   */
  upsert(srcObj?: Hierarchy | null, spec?: UpsertSpec | null): Hierarchy | null;
   ...
   */
  merge(spec?: MergeSpec | null): Hierarchy | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): Hierarchy | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): Hierarchy | null;
   ...
   */
  static updateBatch(objs: C3.Array<Hierarchy | null> | null, srcObjs?: C3.Array<Hierarchy | null>, spec?: UpsertSpec | null): ObjList<Hierarchy | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<Hierarchy | null>>, spec?: UpsertSpec | null): ObjList<Hierarchy | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<Hierarchy | null> | null, srcObjs?: C3.Array<Hierarchy | null>, spec?: UpsertSpec | null): ObjList<Hierarchy | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<Hierarchy | null>>, spec?: UpsertSpec | null): ObjList<Hierarchy | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<Hierarchy | null> | null, spec?: TouchSpec | null): ObjList<Hierarchy | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<Hierarchy | null> | null, spec?: MergeSpec | null): ObjList<Hierarchy | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<Hierarchy | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<Hierarchy | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<Hierarchy | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<Hierarchy | null> | null;
   ...
   */
  static mergeAll(mergeObj: Hierarchy | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: Hierarchy | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<Hierarchy | null> | null, spec?: UpsertSpec | null): ObjList<Hierarchy | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<Hierarchy | null> | null, spec?: UpsertSpec | null): ObjList<Hierarchy | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<Hierarchy | null> | null): ObjList<Hierarchy | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<Hierarchy | null> | null): ObjList<Hierarchy | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<Hierarchy | null> | null): ObjList<Hierarchy | null>;
   ...
   */
  static afterCreate(objs: C3.Array<Hierarchy | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<Hierarchy | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<Hierarchy | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<Hierarchy | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<Hierarchy | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): Hierarchy | null;
   ...
   */
  withoutIdentity(): Hierarchy | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<Hierarchy | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: Hierarchy | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<Hierarchy | null> | null, callback?: λFunction<Hierarchy | null, Hierarchy | null> | null): ObjList<Hierarchy | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<Hierarchy | null> | null, callback?: λFunction<Hierarchy | null, Hierarchy | null> | null): C3.Array<ObjError | null>;
   ...
   */
  publish(subPath?: string | null, contentType?: string | null): Hierarchy;
   ...
   */
  static removeSeedDataBatch(objs?: C3.Array<SeedData | null>, spec?: UpsertSpec | null): ObjList<Hierarchy | null> | null;
   ...
   */
  createSeedData(spec?: UpsertSpec | null): Hierarchy | null;
   ...
   */
  static createSeedDataBatch(objs?: C3.Array<SeedData | null>, spec?: UpsertSpec | null): ObjList<Hierarchy | null> | null;
   ...
   */
  updateSeedData(srcObj?: SeedData | null, spec?: UpsertSpec | null): Hierarchy | null;
   ...
   */
  static updateSeedDataBatch(objs?: C3.Array<SeedData | null>, srcObjs?: C3.Array<SeedData | null>, spec?: UpsertSpec | null): ObjList<Hierarchy | null> | null;
   ...
   * @return updated obj instance, same as {@link Persistable#update} return value.
   */
  clearUserUpdates(spec?: MergeSpec | null): Hierarchy | null;
   ...
   *         {@link Persistable#updateBatch}.
   */
  static clearUserUpdatesBatch(objs?: C3.Array<SeedData | null>, spec?: MergeSpec | null): ObjList<Hierarchy | null> | null;
  ...
  dependencies(): SeedDataDeps<Hierarchy | null> | null;
   ...
   */
  static getChildren(currentNode?: HierarchyNode | null, hierarchyId?: string | null, rootLimit?: number | null, rootOffset?: number | null, searchString?: string | null, includeHasChildrenInformation?: boolean, spec?: any): C3.Array<HierarchyNode | null>;
   ...
   */
  static getHasChildrenInformation(hierarchyNodes: C3.Array<HierarchyNode | null>, hierarchyId: string, spec?: any): C3.Array<HierarchyNode | null>;
   ...
   */
  static getMetadataFileChildren(parentFolderPath?: string | null, isTestFile?: boolean, fileExt?: string | null): C3.Array<MetadataFileChild | null>;
   ...
   */
  static searchByName(hierarchyId?: string | null, searchString?: string | null, rootOnly?: boolean): C3.Array<HierarchyNode | null>;
   ...
   *  all the way up to the root.
   */
  static searchById(hierarchyId?: string | null, nodeType?: string | null, id?: string | null): C3.Array<HierarchyNode | null>;
   ...
   */
  static fetchData(hierarchyId: string, columnFieldMappings?: any, spec?: any, currentNode?: HierarchyNode | null, limit?: number | null, offset?: number | null, searchString?: string | null, expandedParentList?: any): any;
   ...
   */
  static findChildren(node?: HierarchyNode | null, hierarchyMap?: any, idToObjectMap?: any, expandedParentList?: any, dataArray?: C3.Array<any>): void;
   ...
   *      }
   */
  static buildTypeIdMap(hierarchyNodes?: C3.Array<HierarchyNode | null>): any;
   ...
   */
  static buildHierarchyMap(hierarchyMap?: any, currentNode: HierarchyNode, hierarchyNodes?: C3.Array<HierarchyNode | null>): any;
   ...
   */
  static fetchDataAndBuildIdToObjectMap(idToObjectMap?: any, typeIdMap?: any, spec?: C3.Map<string | null, any>, columnFieldMappings?: any, filterString?: string | null, rootNodes?: C3.Array<HierarchyNode | null>, expandedParentList?: any, hierarchyId?: string | null): any;
   ...
   * @return the latest idToObjectMap
   */
  static buildMetadataFileObjectMap(idToObjectMap?: any, hierarchyNodes?: C3.Array<HierarchyNode | null>): any;
}
