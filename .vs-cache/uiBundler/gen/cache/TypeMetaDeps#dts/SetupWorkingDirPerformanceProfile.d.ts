// TypeScript definitions for the C3 type SetupWorkingDirPerformanceProfile

/**
 * Used to report {@link WebpackBundler#setupWorkingDir} performance profiling results.
 *
 * @remarks this represents a value passed to a method that expects an instance of SetupWorkingDirPerformanceProfile
 */
declare interface ISetupWorkingDirPerformanceProfile {
   ...
   */
  uiBundlerPerformanceProfile: IUiBundlerPerformanceProfile;
   ...
   */
  setupWorkingDirTime?: number | null;
}
 ...
 */
declare class SetupWorkingDirPerformanceProfile extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): SetupWorkingDirPerformanceProfile | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): SetupWorkingDirPerformanceProfile | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): SetupWorkingDirPerformanceProfile | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): SetupWorkingDirPerformanceProfile | null;
   ...
   */
  replaceType(old: Type, new_: Type): SetupWorkingDirPerformanceProfile;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): SetupWorkingDirPerformanceProfile;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): SetupWorkingDirPerformanceProfile;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<SetupWorkingDirPerformanceProfile | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<SetupWorkingDirPerformanceProfile | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): SetupWorkingDirPerformanceProfile;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SetupWorkingDirPerformanceProfile;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SetupWorkingDirPerformanceProfile;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): SetupWorkingDirPerformanceProfile;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): SetupWorkingDirPerformanceProfile;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): SetupWorkingDirPerformanceProfile;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): SetupWorkingDirPerformanceProfile;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): SetupWorkingDirPerformanceProfile;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): SetupWorkingDirPerformanceProfile;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): SetupWorkingDirPerformanceProfile;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): SetupWorkingDirPerformanceProfile;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): SetupWorkingDirPerformanceProfile;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): SetupWorkingDirPerformanceProfile;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): SetupWorkingDirPerformanceProfile;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): SetupWorkingDirPerformanceProfile;
   ...
   * @see #unsetField
   */
  defaultField(field: string): SetupWorkingDirPerformanceProfile;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): SetupWorkingDirPerformanceProfile;
   ...
   * @see #removeField
   */
  unsetField(field: string): SetupWorkingDirPerformanceProfile;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): SetupWorkingDirPerformanceProfile;
   ...
   * @see #unsetField
   */
  removeField(field: string): SetupWorkingDirPerformanceProfile;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): SetupWorkingDirPerformanceProfile;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): SetupWorkingDirPerformanceProfile;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): SetupWorkingDirPerformanceProfile;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): SetupWorkingDirPerformanceProfile;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): SetupWorkingDirPerformanceProfile;

  mergeJson(json: any | null): SetupWorkingDirPerformanceProfile;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): SetupWorkingDirPerformanceProfile;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): SetupWorkingDirPerformanceProfile;
   ...
   */
  singletonArray(): C3.Array<SetupWorkingDirPerformanceProfile | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<SetupWorkingDirPerformanceProfile | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<SetupWorkingDirPerformanceProfile | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<SetupWorkingDirPerformanceProfile | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<SetupWorkingDirPerformanceProfile | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, SetupWorkingDirPerformanceProfile | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, SetupWorkingDirPerformanceProfile | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<SetupWorkingDirPerformanceProfile | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<SetupWorkingDirPerformanceProfile | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): SetupWorkingDirPerformanceProfile;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): SetupWorkingDirPerformanceProfile;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): SetupWorkingDirPerformanceProfile;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): SetupWorkingDirPerformanceProfile;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): SetupWorkingDirPerformanceProfile;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): SetupWorkingDirPerformanceProfile;
   ...
   * @see #fromString
   */
  static make(s: string | null): SetupWorkingDirPerformanceProfile | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): SetupWorkingDirPerformanceProfile;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): SetupWorkingDirPerformanceProfile;
   ...
   */
  static cachedEmptyInst(): SetupWorkingDirPerformanceProfile;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<SetupWorkingDirPerformanceProfile>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): SetupWorkingDirPerformanceProfile;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<SetupWorkingDirPerformanceProfile | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<SetupWorkingDirPerformanceProfile | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<SetupWorkingDirPerformanceProfile | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<SetupWorkingDirPerformanceProfile | null> | null>;
   ...
   */
  get(include?: string | null): SetupWorkingDirPerformanceProfile | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): SetupWorkingDirPerformanceProfile | null;
   ...
   */
  getMissing(spec: GetMissingSpec): SetupWorkingDirPerformanceProfile;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): SetupWorkingDirPerformanceProfile | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): SetupWorkingDirPerformanceProfile;
   ...
   * @see #toString
   */
  static fromString(s: string | null): SetupWorkingDirPerformanceProfile | null;
   ...
   */
  create(spec?: UpsertSpec | null): SetupWorkingDirPerformanceProfile | null;
   ...
   */
  static createBatch(objs: C3.Array<SetupWorkingDirPerformanceProfile | null> | null, spec?: UpsertSpec | null): ObjList<SetupWorkingDirPerformanceProfile | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<SetupWorkingDirPerformanceProfile | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<SetupWorkingDirPerformanceProfile | null> | null;
   ...
   */
  update(srcObj?: SetupWorkingDirPerformanceProfile | null, spec?: UpsertSpec | null): SetupWorkingDirPerformanceProfile | null;
   ...
   */
  upsert(srcObj?: SetupWorkingDirPerformanceProfile | null, spec?: UpsertSpec | null): SetupWorkingDirPerformanceProfile | null;
   ...
   */
  merge(spec?: MergeSpec | null): SetupWorkingDirPerformanceProfile | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): SetupWorkingDirPerformanceProfile | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): SetupWorkingDirPerformanceProfile | null;
   ...
   */
  static updateBatch(objs: C3.Array<SetupWorkingDirPerformanceProfile | null> | null, srcObjs?: C3.Array<SetupWorkingDirPerformanceProfile | null>, spec?: UpsertSpec | null): ObjList<SetupWorkingDirPerformanceProfile | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<SetupWorkingDirPerformanceProfile | null>>, spec?: UpsertSpec | null): ObjList<SetupWorkingDirPerformanceProfile | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<SetupWorkingDirPerformanceProfile | null> | null, srcObjs?: C3.Array<SetupWorkingDirPerformanceProfile | null>, spec?: UpsertSpec | null): ObjList<SetupWorkingDirPerformanceProfile | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<SetupWorkingDirPerformanceProfile | null>>, spec?: UpsertSpec | null): ObjList<SetupWorkingDirPerformanceProfile | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<SetupWorkingDirPerformanceProfile | null> | null, spec?: TouchSpec | null): ObjList<SetupWorkingDirPerformanceProfile | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<SetupWorkingDirPerformanceProfile | null> | null, spec?: MergeSpec | null): ObjList<SetupWorkingDirPerformanceProfile | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<SetupWorkingDirPerformanceProfile | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<SetupWorkingDirPerformanceProfile | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<SetupWorkingDirPerformanceProfile | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<SetupWorkingDirPerformanceProfile | null> | null;
   ...
   */
  static mergeAll(mergeObj: SetupWorkingDirPerformanceProfile | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: SetupWorkingDirPerformanceProfile | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<SetupWorkingDirPerformanceProfile | null> | null, spec?: UpsertSpec | null): ObjList<SetupWorkingDirPerformanceProfile | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<SetupWorkingDirPerformanceProfile | null> | null, spec?: UpsertSpec | null): ObjList<SetupWorkingDirPerformanceProfile | null> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): SetupWorkingDirPerformanceProfile | null;
   ...
   */
  static beforeCreate(objs: C3.Array<SetupWorkingDirPerformanceProfile | null> | null): ObjList<SetupWorkingDirPerformanceProfile | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<SetupWorkingDirPerformanceProfile | null> | null): ObjList<SetupWorkingDirPerformanceProfile | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<SetupWorkingDirPerformanceProfile | null> | null): ObjList<SetupWorkingDirPerformanceProfile | null>;
   ...
   */
  static afterCreate(objs: C3.Array<SetupWorkingDirPerformanceProfile | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<SetupWorkingDirPerformanceProfile | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<SetupWorkingDirPerformanceProfile | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<SetupWorkingDirPerformanceProfile | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<SetupWorkingDirPerformanceProfile | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): SetupWorkingDirPerformanceProfile | null;
   ...
   */
  withoutIdentity(): SetupWorkingDirPerformanceProfile | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<SetupWorkingDirPerformanceProfile | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: SetupWorkingDirPerformanceProfile | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<SetupWorkingDirPerformanceProfile | null> | null, callback?: λFunction<SetupWorkingDirPerformanceProfile | null, SetupWorkingDirPerformanceProfile | null> | null): ObjList<SetupWorkingDirPerformanceProfile | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<SetupWorkingDirPerformanceProfile | null> | null, callback?: λFunction<SetupWorkingDirPerformanceProfile | null, SetupWorkingDirPerformanceProfile | null> | null): C3.Array<ObjError | null>;
