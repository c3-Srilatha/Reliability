// TypeScript definitions for the C3 type BundleStatus

/**
 * Bundler status.
 *
 * @remarks this represents a value passed to a method that expects an instance of BundleStatus
 */
declare interface IBundleStatus {
 ...
 */
declare class BundleStatus extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): BundleStatus | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): BundleStatus | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): BundleStatus | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): BundleStatus | null;
   ...
   */
  replaceType(old: Type, new_: Type): BundleStatus;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): BundleStatus;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): BundleStatus;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<BundleStatus | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<BundleStatus | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): BundleStatus;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): BundleStatus;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): BundleStatus;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): BundleStatus;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): BundleStatus;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): BundleStatus;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): BundleStatus;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): BundleStatus;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): BundleStatus;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): BundleStatus;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): BundleStatus;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): BundleStatus;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): BundleStatus;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): BundleStatus;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): BundleStatus;
   ...
   * @see #unsetField
   */
  defaultField(field: string): BundleStatus;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): BundleStatus;
   ...
   * @see #removeField
   */
  unsetField(field: string): BundleStatus;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): BundleStatus;
   ...
   * @see #unsetField
   */
  removeField(field: string): BundleStatus;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): BundleStatus;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): BundleStatus;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): BundleStatus;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): BundleStatus;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): BundleStatus;

  mergeJson(json: any | null): BundleStatus;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): BundleStatus;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): BundleStatus;
   ...
   */
  singletonArray(): C3.Array<BundleStatus | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<BundleStatus | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<BundleStatus | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<BundleStatus | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<BundleStatus | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, BundleStatus | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, BundleStatus | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<BundleStatus | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<BundleStatus | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): BundleStatus;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): BundleStatus;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): BundleStatus;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): BundleStatus;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): BundleStatus;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): BundleStatus;
   ...
   * @see #fromString
   */
  static make(s: string | null): BundleStatus | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): BundleStatus;
   ...
   */
  static cachedEmptyInst(): BundleStatus;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<BundleStatus>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): BundleStatus;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<BundleStatus | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<BundleStatus | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<BundleStatus | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<BundleStatus | null> | null>;
   ...
   */
  get(include?: string | null): BundleStatus | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): BundleStatus | null;
   ...
   */
  getMissing(spec: GetMissingSpec): BundleStatus;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): BundleStatus | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): BundleStatus;
   ...
   * @see #toString
   */
  static fromString(s: string | null): BundleStatus | null;
   ...
   */
  create(spec?: UpsertSpec | null): BundleStatus | null;
   ...
   */
  static createBatch(objs: C3.Array<BundleStatus | null> | null, spec?: UpsertSpec | null): ObjList<BundleStatus | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<BundleStatus | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<BundleStatus | null> | null;
   ...
   */
  update(srcObj?: BundleStatus | null, spec?: UpsertSpec | null): BundleStatus | null;
   ...
   */
  upsert(srcObj?: BundleStatus | null, spec?: UpsertSpec | null): BundleStatus | null;
   ...
   */
  merge(spec?: MergeSpec | null): BundleStatus | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): BundleStatus | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): BundleStatus | null;
   ...
   */
  static updateBatch(objs: C3.Array<BundleStatus | null> | null, srcObjs?: C3.Array<BundleStatus | null>, spec?: UpsertSpec | null): ObjList<BundleStatus | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<BundleStatus | null>>, spec?: UpsertSpec | null): ObjList<BundleStatus | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<BundleStatus | null> | null, srcObjs?: C3.Array<BundleStatus | null>, spec?: UpsertSpec | null): ObjList<BundleStatus | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<BundleStatus | null>>, spec?: UpsertSpec | null): ObjList<BundleStatus | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<BundleStatus | null> | null, spec?: TouchSpec | null): ObjList<BundleStatus | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<BundleStatus | null> | null, spec?: MergeSpec | null): ObjList<BundleStatus | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<BundleStatus | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<BundleStatus | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<BundleStatus | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<BundleStatus | null> | null;
   ...
   */
  static mergeAll(mergeObj: BundleStatus | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: BundleStatus | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<BundleStatus | null> | null, spec?: UpsertSpec | null): ObjList<BundleStatus | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<BundleStatus | null> | null, spec?: UpsertSpec | null): ObjList<BundleStatus | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<BundleStatus | null> | null): ObjList<BundleStatus | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<BundleStatus | null> | null): ObjList<BundleStatus | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<BundleStatus | null> | null): ObjList<BundleStatus | null>;
   ...
   */
  static afterCreate(objs: C3.Array<BundleStatus | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<BundleStatus | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<BundleStatus | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<BundleStatus | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<BundleStatus | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): BundleStatus | null;
   ...
   */
  withoutIdentity(): BundleStatus | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<BundleStatus | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: BundleStatus | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<BundleStatus | null> | null, callback?: λFunction<BundleStatus | null, BundleStatus | null> | null): ObjList<BundleStatus | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<BundleStatus | null> | null, callback?: λFunction<BundleStatus | null, BundleStatus | null> | null): C3.Array<ObjError | null>;
