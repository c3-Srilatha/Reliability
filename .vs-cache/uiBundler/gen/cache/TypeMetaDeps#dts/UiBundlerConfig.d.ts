// TypeScript definitions for the C3 type UiBundlerConfig

/**
 * The UiBundlerConfig type defines configuration settings for {@link UiBundler}.
 *
 * @remarks this represents a value passed to a method that expects an instance of UiBundlerConfig
 */
declare interface IUiBundlerConfig {
  ...
  /**
   * When true, tests will only be generated for the root package.
   */
  onlyRootPackageTests?: boolean;

  /**
   * If specified, bundler job will be executed on a worker node with below hardware, e.g. r5.4xlarge.
   * Note: {@link UiBundler} needs a hardware/instance with minimum of 6GB of RAM.
   * See {@link HardwareProfile} for more info.
   */
  hardwareProfileInstanceType?: string | null;

  /**
   * The maximum number of invalidation queue entries that will be processed simultaneously for {@link UiBundler} job per node.
   * 1 means {@link UiBundler} runs webpack compilers sequentially. Set to higher number based on available workers' memory.
   */
  maxConcurrencyPerNode?: number | null;

  /**
   * The maximum number of invalidation queue entries that will be processed simultaneously for {@link UiBundler} job.
   * 1 means {@link UiBundler} runs webpack compilers sequentially. This number has to be equal or greater than
   * {@link maxConcurrencyPerNode} as it takes precedence in the total number of concurrent batches. When its value is -1, there
   * will be no limit and only {@link maxConcurrencyPerNode} and the number of nodes in the cluster will determine how many batches
   * are processed at the same time.
   */
  maxConcurrency?: number | null;

  /**
   * The time to wait for a connection to be established when cleaning the working directory.
   *
   * The number is specified in seconds.
   *
   * @see UiBundler.cleanWorkDir
   */
  workDirCleanupTimeout?: number | null;

  /**
   * "Time to live" for the output dir.
   * This will determine for how much time the directory will exist before
   * the platform can delete it.
   *
   * Note that the output directory will be deleted by the bundler after it is used
   * but this ensures that if the directory remains in the file system, the platform
   * can remove it automatically.
   *
   * Current value is 2 hours.
   */
  outputDirTtl?: number | null;

  /**
   * Determines if the {@link UiBundlerResult} records created by each job will be cleared or not once the job is finished.
   */
  keepUiBundlerResults?: boolean;

  /**
   * The batch sizes for UiBundler jobs in development mode. Each batch will bundle a set of
   * webpack configurations.
   *
   * The batch size will default to 3 webpack configurations to bundle per batch job.
   */
  developmentBatchSize?: number | null;

  /**
   * The batch sizes for UiBundler jobs in production mode. It is recommended to keep as default because production mode
   * requires a lot of resources in some packages.
   */
  productionBatchSize?: number | null;

  /**
   * Determines if the Webpack cache should be enabled.
   */
  enableWebpackCache?: boolean;

  /**
   * Determines if the Babel cache should be enabled.
   */
  enableBabelCache?: boolean;
}

/**
 * The UiBundlerConfig type defines configuration settings for {@link UiBundler}.
 *
 * @remarks this represents a made instance of UiBundlerConfig
 */
declare class UiBundlerConfig extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): UiBundlerConfig | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): UiBundlerConfig | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): UiBundlerConfig | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): UiBundlerConfig | null;
   ...
   */
  replaceType(old: Type, new_: Type): UiBundlerConfig;
   ...
   * This method is used during live metadata update
   */
  static replaceType(old: Type, new_: Type): UiBundlerConfig;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiBundlerConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiBundlerConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiBundlerConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiBundlerConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiBundlerConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiBundlerConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiBundlerConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiBundlerConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): UiBundlerConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): UiBundlerConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiBundlerConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiBundlerConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiBundlerConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiBundlerConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): UiBundlerConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  static validateObj(): UiBundlerConfig;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): UiBundlerConfig;
   ...
   * @see #defaultField
   */
  static withField(field: string, value: any, doNotConvert?: boolean): UiBundlerConfig;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): UiBundlerConfig;
   ...
   * @see #defaultField
   */
  static withField(field: FieldType, value: any, doNotConvert?: boolean): UiBundlerConfig;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): UiBundlerConfig;
   ...
   * @return new Obj
   */
  static withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): UiBundlerConfig;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): UiBundlerConfig;
   ...
   * @return new Obj
   */
  static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): UiBundlerConfig;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): UiBundlerConfig;
   ...
   * @see #withoutField
   */
  static withoutFieldAtPath(path: string): UiBundlerConfig;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): UiBundlerConfig;
   ...
   * @see #removeField
   */
  static withoutField(field: string | null): UiBundlerConfig;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): UiBundlerConfig;
   ...
   * @see #removeField
   */
  static withoutField(field: FieldType | null): UiBundlerConfig;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): UiBundlerConfig;
   ...
   * @return new Obj with removed fields
   */
  static withoutFields(fields: C3.Array<string | null> | null): UiBundlerConfig;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): UiBundlerConfig;
   ...
   * @return new Obj with removed fields
   */
  static withoutFieldsByType(fields: C3.Array<FieldType | null> | null): UiBundlerConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): UiBundlerConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  static withoutSecretFields(): UiBundlerConfig;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): UiBundlerConfig;
   ...
   * @see FieldType#defaultValue
   */
  static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): UiBundlerConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: string): UiBundlerConfig;
   ...
   * @see #unsetField
   */
  static defaultField(field: string): UiBundlerConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): UiBundlerConfig;
   ...
   * @see #unsetField
   */
  static defaultField(field: FieldType): UiBundlerConfig;
   ...
   * @see #removeField
   */
  unsetField(field: string): UiBundlerConfig;
   ...
   * @see #removeField
   */
  static unsetField(field: string): UiBundlerConfig;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): UiBundlerConfig;
   ...
   * @see #removeField
   */
  static unsetField(field: FieldType): UiBundlerConfig;
   ...
   * @see #unsetField
   */
  removeField(field: string): UiBundlerConfig;
   ...
   * @see #unsetField
   */
  static removeField(field: string): UiBundlerConfig;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): UiBundlerConfig;
   ...
   * @see #unsetField
   */
  static removeField(field: FieldType): UiBundlerConfig;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): UiBundlerConfig;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): UiBundlerConfig;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): UiBundlerConfig;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj | null, otherFieldsFilter: Type): UiBundlerConfig;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): UiBundlerConfig;
   ...
   *        the same key or index.
   */
  static mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): UiBundlerConfig;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): UiBundlerConfig;
   ...
   * traverse child reference and collection fields.
   */
  static mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): UiBundlerConfig;

  mergeJson(json: any | null): UiBundlerConfig;

  static mergeJson(json: any | null): UiBundlerConfig;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): UiBundlerConfig;
   ...
   * @return Obj with child references merged
   */
  static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): UiBundlerConfig;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): UiBundlerConfig;
   ...
   * references with same name and collection elements at same index or key.
   */
  static sumObj(other: Obj | null, deep?: boolean): UiBundlerConfig;
   ...
   */
  singletonArray(): C3.Array<UiBundlerConfig | null>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonArray(): C3.Array<UiBundlerConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<UiBundlerConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<UiBundlerConfig | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<UiBundlerConfig | null>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonSet(): C3.Set<UiBundlerConfig | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<UiBundlerConfig | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, UiBundlerConfig | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, UiBundlerConfig | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<UiBundlerConfig | null>;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  static toBuilder(): ObjBuilder<UiBundlerConfig | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<UiBundlerConfig | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): UiBundlerConfig;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): UiBundlerConfig;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): UiBundlerConfig;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): UiBundlerConfig;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): UiBundlerConfig;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): UiBundlerConfig;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): UiBundlerConfig;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  static afterMake(): UiBundlerConfig;
   ...
   */
  static cachedEmptyInst(): UiBundlerConfig;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<UiBundlerConfig>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): UiBundlerConfig;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<UiBundlerConfig | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<UiBundlerConfig | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<UiBundlerConfig | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): UiBundlerConfig | null;

  /**
   * Returns cached instance by key, with secrets removed.
   */
  static forCacheKey(key: string | null): UiBundlerConfig | null;
   ...
   * @see findByCacheKey
   */
  getCached(): UiBundlerConfig | null;
   ...
   * @see findByCacheKey
   */
  static getCached(): UiBundlerConfig | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): UiBundlerConfig | null;

  /**
   * @return newly produced cached instance.
   */
  static refreshCache(): UiBundlerConfig | null;
   ...
   */
  static produce(key: string): UiBundlerConfig | null;
   ...
   */
  static produceAll(): C3.Map<string | null, UiBundlerConfig | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, UiBundlerConfig | null>;
   ...
   * Note that typical pattern is to use Configurable#config instead of this method.
   */
  static getConfig(): UiBundlerConfig;
   ...
   * Note that typical pattern is to use Configurable#configWithSecrets instead of this method.
   */
  static getSecret(): UiBundlerConfig;
   ...
   */
  static forConfigKey(configKey: string | null): UiBundlerConfig | null;
   ...
   */
  static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<UiBundlerConfig | null>;
   ...
   * @see setConfigValue
   */
  setConfigValues(from: UiBundlerConfig, override?: string | null): void;

  /**
   * Sets multiple field values to be the same as the passed instance.
   * @see setConfigValue
   */
  static setConfigValues(from: UiBundlerConfig, override?: string | null): void;
   ...
   * @see setSecretValue
   */
  setSecretValues(from: UiBundlerConfig, override?: string | null): void;

  /**
   * Sets multiple secret field values to be the same as the passed instance.
   * @see setSecretValue
   */
  static setSecretValues(from: UiBundlerConfig, override?: string | null): void;
   ...
   */
  static loadConfigAndSecret(configKey: string): UiBundlerConfig | null;
   ...
   */
  removeSecrets(): UiBundlerConfig | null;

  /**
   * @return this config without any secret values.
   */
  static removeSecrets(): UiBundlerConfig | null;

  /**
   * @return this config with only secret values.
   */
  removeNonSecrets(): UiBundlerConfig | null;

  /**
   * @return this config with only secret values.
   */
  static removeNonSecrets(): UiBundlerConfig | null;

  /**
   * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
   * validation and setup.
   */
  validate(): UiBundlerConfig;

  /**
   * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
   * validation and setup.
   */
  static validate(): UiBundlerConfig;
