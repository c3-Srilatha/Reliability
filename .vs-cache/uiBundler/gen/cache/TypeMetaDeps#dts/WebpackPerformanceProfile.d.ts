// TypeScript definitions for the C3 type WebpackPerformanceProfile

/**
 * Used to report {@link Webpack} performance profiling results.
 *
 * @remarks this represents a value passed to a method that expects an instance of WebpackPerformanceProfile
 */
declare interface IWebpackPerformanceProfile {
   ...
   */
  uiBundlerPerformanceProfile?: IUiBundlerPerformanceProfile | null;
 ...
 */
declare class WebpackPerformanceProfile extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): WebpackPerformanceProfile | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): WebpackPerformanceProfile | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): WebpackPerformanceProfile | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): WebpackPerformanceProfile | null;
   ...
   */
  replaceType(old: Type, new_: Type): WebpackPerformanceProfile;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): WebpackPerformanceProfile;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): WebpackPerformanceProfile;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<WebpackPerformanceProfile | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<WebpackPerformanceProfile | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): WebpackPerformanceProfile;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): WebpackPerformanceProfile;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): WebpackPerformanceProfile;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): WebpackPerformanceProfile;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): WebpackPerformanceProfile;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): WebpackPerformanceProfile;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): WebpackPerformanceProfile;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): WebpackPerformanceProfile;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): WebpackPerformanceProfile;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): WebpackPerformanceProfile;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): WebpackPerformanceProfile;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): WebpackPerformanceProfile;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): WebpackPerformanceProfile;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): WebpackPerformanceProfile;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): WebpackPerformanceProfile;
   ...
   * @see #unsetField
   */
  defaultField(field: string): WebpackPerformanceProfile;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): WebpackPerformanceProfile;
   ...
   * @see #removeField
   */
  unsetField(field: string): WebpackPerformanceProfile;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): WebpackPerformanceProfile;
   ...
   * @see #unsetField
   */
  removeField(field: string): WebpackPerformanceProfile;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): WebpackPerformanceProfile;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): WebpackPerformanceProfile;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): WebpackPerformanceProfile;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): WebpackPerformanceProfile;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): WebpackPerformanceProfile;

  mergeJson(json: any | null): WebpackPerformanceProfile;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): WebpackPerformanceProfile;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): WebpackPerformanceProfile;
   ...
   */
  singletonArray(): C3.Array<WebpackPerformanceProfile | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<WebpackPerformanceProfile | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<WebpackPerformanceProfile | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<WebpackPerformanceProfile | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<WebpackPerformanceProfile | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, WebpackPerformanceProfile | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, WebpackPerformanceProfile | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<WebpackPerformanceProfile | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<WebpackPerformanceProfile | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): WebpackPerformanceProfile;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): WebpackPerformanceProfile;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): WebpackPerformanceProfile;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): WebpackPerformanceProfile;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): WebpackPerformanceProfile;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): WebpackPerformanceProfile;
   ...
   * @see #fromString
   */
  static make(s: string | null): WebpackPerformanceProfile | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): WebpackPerformanceProfile;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): WebpackPerformanceProfile;
   ...
   */
  static cachedEmptyInst(): WebpackPerformanceProfile;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<WebpackPerformanceProfile>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): WebpackPerformanceProfile;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<WebpackPerformanceProfile | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<WebpackPerformanceProfile | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<WebpackPerformanceProfile | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<WebpackPerformanceProfile | null> | null>;
   ...
   */
  get(include?: string | null): WebpackPerformanceProfile | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): WebpackPerformanceProfile | null;
   ...
   */
  getMissing(spec: GetMissingSpec): WebpackPerformanceProfile;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): WebpackPerformanceProfile | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): WebpackPerformanceProfile;
   ...
   * @see #toString
   */
  static fromString(s: string | null): WebpackPerformanceProfile | null;
   ...
   */
  create(spec?: UpsertSpec | null): WebpackPerformanceProfile | null;
   ...
   */
  static createBatch(objs: C3.Array<WebpackPerformanceProfile | null> | null, spec?: UpsertSpec | null): ObjList<WebpackPerformanceProfile | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<WebpackPerformanceProfile | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<WebpackPerformanceProfile | null> | null;
   ...
   */
  update(srcObj?: WebpackPerformanceProfile | null, spec?: UpsertSpec | null): WebpackPerformanceProfile | null;
   ...
   */
  upsert(srcObj?: WebpackPerformanceProfile | null, spec?: UpsertSpec | null): WebpackPerformanceProfile | null;
   ...
   */
  merge(spec?: MergeSpec | null): WebpackPerformanceProfile | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): WebpackPerformanceProfile | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): WebpackPerformanceProfile | null;
   ...
   */
  static updateBatch(objs: C3.Array<WebpackPerformanceProfile | null> | null, srcObjs?: C3.Array<WebpackPerformanceProfile | null>, spec?: UpsertSpec | null): ObjList<WebpackPerformanceProfile | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<WebpackPerformanceProfile | null>>, spec?: UpsertSpec | null): ObjList<WebpackPerformanceProfile | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<WebpackPerformanceProfile | null> | null, srcObjs?: C3.Array<WebpackPerformanceProfile | null>, spec?: UpsertSpec | null): ObjList<WebpackPerformanceProfile | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<WebpackPerformanceProfile | null>>, spec?: UpsertSpec | null): ObjList<WebpackPerformanceProfile | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<WebpackPerformanceProfile | null> | null, spec?: TouchSpec | null): ObjList<WebpackPerformanceProfile | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<WebpackPerformanceProfile | null> | null, spec?: MergeSpec | null): ObjList<WebpackPerformanceProfile | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<WebpackPerformanceProfile | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<WebpackPerformanceProfile | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<WebpackPerformanceProfile | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<WebpackPerformanceProfile | null> | null;
   ...
   */
  static mergeAll(mergeObj: WebpackPerformanceProfile | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: WebpackPerformanceProfile | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<WebpackPerformanceProfile | null> | null, spec?: UpsertSpec | null): ObjList<WebpackPerformanceProfile | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<WebpackPerformanceProfile | null> | null, spec?: UpsertSpec | null): ObjList<WebpackPerformanceProfile | null> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): WebpackPerformanceProfile | null;
   ...
   */
  static beforeCreate(objs: C3.Array<WebpackPerformanceProfile | null> | null): ObjList<WebpackPerformanceProfile | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<WebpackPerformanceProfile | null> | null): ObjList<WebpackPerformanceProfile | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<WebpackPerformanceProfile | null> | null): ObjList<WebpackPerformanceProfile | null>;
   ...
   */
  static afterCreate(objs: C3.Array<WebpackPerformanceProfile | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<WebpackPerformanceProfile | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<WebpackPerformanceProfile | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<WebpackPerformanceProfile | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<WebpackPerformanceProfile | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): WebpackPerformanceProfile | null;
   ...
   */
  withoutIdentity(): WebpackPerformanceProfile | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<WebpackPerformanceProfile | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: WebpackPerformanceProfile | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<WebpackPerformanceProfile | null> | null, callback?: λFunction<WebpackPerformanceProfile | null, WebpackPerformanceProfile | null> | null): ObjList<WebpackPerformanceProfile | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<WebpackPerformanceProfile | null> | null, callback?: λFunction<WebpackPerformanceProfile | null, WebpackPerformanceProfile | null> | null): C3.Array<ObjError | null>;
