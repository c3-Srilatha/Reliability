// TypeScript definitions for the C3 type UiBundlerPerformanceProfile

/**
 * Used to report {@link UiBundler} performance profiling results.
 *
 * @remarks this represents a value passed to a method that expects an instance of UiBundlerPerformanceProfile
 */
declare interface IUiBundlerPerformanceProfile {
   ...
   */
  jobStartTime?: DateTime | Date | string | null;

  /**
   * The time at which this job was completed.
   */
  jobEndTime?: DateTime | Date | string | null;
 ...
 */
declare class UiBundlerPerformanceProfile extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): UiBundlerPerformanceProfile | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): UiBundlerPerformanceProfile | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): UiBundlerPerformanceProfile | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): UiBundlerPerformanceProfile | null;
   ...
   */
  replaceType(old: Type, new_: Type): UiBundlerPerformanceProfile;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiBundlerPerformanceProfile;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiBundlerPerformanceProfile;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiBundlerPerformanceProfile | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiBundlerPerformanceProfile | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): UiBundlerPerformanceProfile;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiBundlerPerformanceProfile;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiBundlerPerformanceProfile;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): UiBundlerPerformanceProfile;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): UiBundlerPerformanceProfile;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): UiBundlerPerformanceProfile;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): UiBundlerPerformanceProfile;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): UiBundlerPerformanceProfile;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): UiBundlerPerformanceProfile;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): UiBundlerPerformanceProfile;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): UiBundlerPerformanceProfile;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): UiBundlerPerformanceProfile;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): UiBundlerPerformanceProfile;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): UiBundlerPerformanceProfile;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): UiBundlerPerformanceProfile;
   ...
   * @see #unsetField
   */
  defaultField(field: string): UiBundlerPerformanceProfile;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): UiBundlerPerformanceProfile;
   ...
   * @see #removeField
   */
  unsetField(field: string): UiBundlerPerformanceProfile;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): UiBundlerPerformanceProfile;
   ...
   * @see #unsetField
   */
  removeField(field: string): UiBundlerPerformanceProfile;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): UiBundlerPerformanceProfile;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): UiBundlerPerformanceProfile;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): UiBundlerPerformanceProfile;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): UiBundlerPerformanceProfile;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): UiBundlerPerformanceProfile;

  mergeJson(json: any | null): UiBundlerPerformanceProfile;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): UiBundlerPerformanceProfile;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): UiBundlerPerformanceProfile;
   ...
   */
  singletonArray(): C3.Array<UiBundlerPerformanceProfile | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<UiBundlerPerformanceProfile | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<UiBundlerPerformanceProfile | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<UiBundlerPerformanceProfile | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<UiBundlerPerformanceProfile | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, UiBundlerPerformanceProfile | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, UiBundlerPerformanceProfile | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<UiBundlerPerformanceProfile | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<UiBundlerPerformanceProfile | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): UiBundlerPerformanceProfile;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): UiBundlerPerformanceProfile;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): UiBundlerPerformanceProfile;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): UiBundlerPerformanceProfile;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): UiBundlerPerformanceProfile;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): UiBundlerPerformanceProfile;
   ...
   * @see #fromString
   */
  static make(s: string | null): UiBundlerPerformanceProfile | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): UiBundlerPerformanceProfile;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): UiBundlerPerformanceProfile;
   ...
   */
  static cachedEmptyInst(): UiBundlerPerformanceProfile;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<UiBundlerPerformanceProfile>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): UiBundlerPerformanceProfile;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<UiBundlerPerformanceProfile | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<UiBundlerPerformanceProfile | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<UiBundlerPerformanceProfile | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<UiBundlerPerformanceProfile | null> | null>;
   ...
   */
  get(include?: string | null): UiBundlerPerformanceProfile | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): UiBundlerPerformanceProfile | null;
   ...
   */
  getMissing(spec: GetMissingSpec): UiBundlerPerformanceProfile;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): UiBundlerPerformanceProfile | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): UiBundlerPerformanceProfile;
   ...
   * @see #toString
   */
  static fromString(s: string | null): UiBundlerPerformanceProfile | null;
   ...
   */
  create(spec?: UpsertSpec | null): UiBundlerPerformanceProfile | null;
   ...
   */
  static createBatch(objs: C3.Array<UiBundlerPerformanceProfile | null> | null, spec?: UpsertSpec | null): ObjList<UiBundlerPerformanceProfile | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<UiBundlerPerformanceProfile | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<UiBundlerPerformanceProfile | null> | null;
   ...
   */
  update(srcObj?: UiBundlerPerformanceProfile | null, spec?: UpsertSpec | null): UiBundlerPerformanceProfile | null;
   ...
   */
  upsert(srcObj?: UiBundlerPerformanceProfile | null, spec?: UpsertSpec | null): UiBundlerPerformanceProfile | null;
   ...
   */
  merge(spec?: MergeSpec | null): UiBundlerPerformanceProfile | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): UiBundlerPerformanceProfile | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): UiBundlerPerformanceProfile | null;
   ...
   */
  static updateBatch(objs: C3.Array<UiBundlerPerformanceProfile | null> | null, srcObjs?: C3.Array<UiBundlerPerformanceProfile | null>, spec?: UpsertSpec | null): ObjList<UiBundlerPerformanceProfile | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<UiBundlerPerformanceProfile | null>>, spec?: UpsertSpec | null): ObjList<UiBundlerPerformanceProfile | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<UiBundlerPerformanceProfile | null> | null, srcObjs?: C3.Array<UiBundlerPerformanceProfile | null>, spec?: UpsertSpec | null): ObjList<UiBundlerPerformanceProfile | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<UiBundlerPerformanceProfile | null>>, spec?: UpsertSpec | null): ObjList<UiBundlerPerformanceProfile | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<UiBundlerPerformanceProfile | null> | null, spec?: TouchSpec | null): ObjList<UiBundlerPerformanceProfile | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<UiBundlerPerformanceProfile | null> | null, spec?: MergeSpec | null): ObjList<UiBundlerPerformanceProfile | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<UiBundlerPerformanceProfile | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<UiBundlerPerformanceProfile | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<UiBundlerPerformanceProfile | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<UiBundlerPerformanceProfile | null> | null;
   ...
   */
  static mergeAll(mergeObj: UiBundlerPerformanceProfile | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: UiBundlerPerformanceProfile | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<UiBundlerPerformanceProfile | null> | null, spec?: UpsertSpec | null): ObjList<UiBundlerPerformanceProfile | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<UiBundlerPerformanceProfile | null> | null, spec?: UpsertSpec | null): ObjList<UiBundlerPerformanceProfile | null> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): UiBundlerPerformanceProfile | null;
   ...
   */
  static beforeCreate(objs: C3.Array<UiBundlerPerformanceProfile | null> | null): ObjList<UiBundlerPerformanceProfile | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<UiBundlerPerformanceProfile | null> | null): ObjList<UiBundlerPerformanceProfile | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<UiBundlerPerformanceProfile | null> | null): ObjList<UiBundlerPerformanceProfile | null>;
   ...
   */
  static afterCreate(objs: C3.Array<UiBundlerPerformanceProfile | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<UiBundlerPerformanceProfile | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<UiBundlerPerformanceProfile | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<UiBundlerPerformanceProfile | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<UiBundlerPerformanceProfile | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): UiBundlerPerformanceProfile | null;
   ...
   */
  withoutIdentity(): UiBundlerPerformanceProfile | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<UiBundlerPerformanceProfile | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: UiBundlerPerformanceProfile | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<UiBundlerPerformanceProfile | null> | null, callback?: λFunction<UiBundlerPerformanceProfile | null, UiBundlerPerformanceProfile | null> | null): ObjList<UiBundlerPerformanceProfile | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<UiBundlerPerformanceProfile | null> | null, callback?: λFunction<UiBundlerPerformanceProfile | null, UiBundlerPerformanceProfile | null> | null): C3.Array<ObjError | null>;
   ...
   */
  toPerformanceTestResultCustomMeasurementFields(): UiBundlerPerformanceProfileCustomMeasurementFields | null;
}
