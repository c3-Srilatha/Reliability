// TypeScript definitions for the C3 type DummyUiSdlConfig

/**
 * This is a Test config to mimic @{link UiSdlConfig}
 *
 * @remarks this represents a value passed to a method that expects an instance of DummyUiSdlConfig
 */
declare interface IDummyUiSdlConfig {
  ...
  /**
   * Configs for the infrastructure of the Webpack Bundler.
   */
  infrastructure?: IDummyUiSdlInfrastructureConfig | null;
}

/**
 * This is a Test config to mimic @{link UiSdlConfig}
 *
 * @remarks this represents a made instance of DummyUiSdlConfig
 */
declare class DummyUiSdlConfig extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): DummyUiSdlConfig | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): DummyUiSdlConfig | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): DummyUiSdlConfig | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): DummyUiSdlConfig | null;
   ...
   */
  replaceType(old: Type, new_: Type): DummyUiSdlConfig;
   ...
   * This method is used during live metadata update
   */
  static replaceType(old: Type, new_: Type): DummyUiSdlConfig;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): DummyUiSdlConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): DummyUiSdlConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): DummyUiSdlConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): DummyUiSdlConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<DummyUiSdlConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<DummyUiSdlConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<DummyUiSdlConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<DummyUiSdlConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): DummyUiSdlConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): DummyUiSdlConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DummyUiSdlConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DummyUiSdlConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DummyUiSdlConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DummyUiSdlConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): DummyUiSdlConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  static validateObj(): DummyUiSdlConfig;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): DummyUiSdlConfig;
   ...
   * @see #defaultField
   */
  static withField(field: string, value: any, doNotConvert?: boolean): DummyUiSdlConfig;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): DummyUiSdlConfig;
   ...
   * @see #defaultField
   */
  static withField(field: FieldType, value: any, doNotConvert?: boolean): DummyUiSdlConfig;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): DummyUiSdlConfig;
   ...
   * @return new Obj
   */
  static withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): DummyUiSdlConfig;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): DummyUiSdlConfig;
   ...
   * @return new Obj
   */
  static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): DummyUiSdlConfig;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): DummyUiSdlConfig;
   ...
   * @see #withoutField
   */
  static withoutFieldAtPath(path: string): DummyUiSdlConfig;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): DummyUiSdlConfig;
   ...
   * @see #removeField
   */
  static withoutField(field: string | null): DummyUiSdlConfig;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): DummyUiSdlConfig;
   ...
   * @see #removeField
   */
  static withoutField(field: FieldType | null): DummyUiSdlConfig;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): DummyUiSdlConfig;
   ...
   * @return new Obj with removed fields
   */
  static withoutFields(fields: C3.Array<string | null> | null): DummyUiSdlConfig;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): DummyUiSdlConfig;
   ...
   * @return new Obj with removed fields
   */
  static withoutFieldsByType(fields: C3.Array<FieldType | null> | null): DummyUiSdlConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): DummyUiSdlConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  static withoutSecretFields(): DummyUiSdlConfig;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): DummyUiSdlConfig;
   ...
   * @see FieldType#defaultValue
   */
  static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): DummyUiSdlConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: string): DummyUiSdlConfig;
   ...
   * @see #unsetField
   */
  static defaultField(field: string): DummyUiSdlConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): DummyUiSdlConfig;
   ...
   * @see #unsetField
   */
  static defaultField(field: FieldType): DummyUiSdlConfig;
   ...
   * @see #removeField
   */
  unsetField(field: string): DummyUiSdlConfig;
   ...
   * @see #removeField
   */
  static unsetField(field: string): DummyUiSdlConfig;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): DummyUiSdlConfig;
   ...
   * @see #removeField
   */
  static unsetField(field: FieldType): DummyUiSdlConfig;
   ...
   * @see #unsetField
   */
  removeField(field: string): DummyUiSdlConfig;
   ...
   * @see #unsetField
   */
  static removeField(field: string): DummyUiSdlConfig;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): DummyUiSdlConfig;
   ...
   * @see #unsetField
   */
  static removeField(field: FieldType): DummyUiSdlConfig;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): DummyUiSdlConfig;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): DummyUiSdlConfig;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): DummyUiSdlConfig;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj | null, otherFieldsFilter: Type): DummyUiSdlConfig;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): DummyUiSdlConfig;
   ...
   *        the same key or index.
   */
  static mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): DummyUiSdlConfig;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): DummyUiSdlConfig;
   ...
   * traverse child reference and collection fields.
   */
  static mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): DummyUiSdlConfig;

  mergeJson(json: any | null): DummyUiSdlConfig;

  static mergeJson(json: any | null): DummyUiSdlConfig;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): DummyUiSdlConfig;
   ...
   * @return Obj with child references merged
   */
  static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): DummyUiSdlConfig;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): DummyUiSdlConfig;
   ...
   * references with same name and collection elements at same index or key.
   */
  static sumObj(other: Obj | null, deep?: boolean): DummyUiSdlConfig;
   ...
   */
  singletonArray(): C3.Array<DummyUiSdlConfig | null>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonArray(): C3.Array<DummyUiSdlConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<DummyUiSdlConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<DummyUiSdlConfig | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<DummyUiSdlConfig | null>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonSet(): C3.Set<DummyUiSdlConfig | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<DummyUiSdlConfig | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, DummyUiSdlConfig | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, DummyUiSdlConfig | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<DummyUiSdlConfig | null>;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  static toBuilder(): ObjBuilder<DummyUiSdlConfig | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<DummyUiSdlConfig | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): DummyUiSdlConfig;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): DummyUiSdlConfig;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): DummyUiSdlConfig;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): DummyUiSdlConfig;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): DummyUiSdlConfig;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): DummyUiSdlConfig;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): DummyUiSdlConfig;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  static afterMake(): DummyUiSdlConfig;
   ...
   */
  static cachedEmptyInst(): DummyUiSdlConfig;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<DummyUiSdlConfig>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): DummyUiSdlConfig;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<DummyUiSdlConfig | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<DummyUiSdlConfig | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<DummyUiSdlConfig | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): DummyUiSdlConfig | null;

  /**
   * Returns cached instance by key, with secrets removed.
   */
  static forCacheKey(key: string | null): DummyUiSdlConfig | null;
   ...
   * @see findByCacheKey
   */
  getCached(): DummyUiSdlConfig | null;
   ...
   * @see findByCacheKey
   */
  static getCached(): DummyUiSdlConfig | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): DummyUiSdlConfig | null;

  /**
   * @return newly produced cached instance.
   */
  static refreshCache(): DummyUiSdlConfig | null;
   ...
   */
  static produce(key: string): DummyUiSdlConfig | null;
   ...
   */
  static produceAll(): C3.Map<string | null, DummyUiSdlConfig | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, DummyUiSdlConfig | null>;
   ...
   * Note that typical pattern is to use Configurable#config instead of this method.
   */
  static getConfig(): DummyUiSdlConfig;
   ...
   * Note that typical pattern is to use Configurable#configWithSecrets instead of this method.
   */
  static getSecret(): DummyUiSdlConfig;
   ...
   */
  static forConfigKey(configKey: string | null): DummyUiSdlConfig | null;
   ...
   */
  static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<DummyUiSdlConfig | null>;
   ...
   * @see setConfigValue
   */
  setConfigValues(from: DummyUiSdlConfig, override?: string | null): void;

  /**
   * Sets multiple field values to be the same as the passed instance.
   * @see setConfigValue
   */
  static setConfigValues(from: DummyUiSdlConfig, override?: string | null): void;
   ...
   * @see setSecretValue
   */
  setSecretValues(from: DummyUiSdlConfig, override?: string | null): void;

  /**
   * Sets multiple secret field values to be the same as the passed instance.
   * @see setSecretValue
   */
  static setSecretValues(from: DummyUiSdlConfig, override?: string | null): void;
   ...
   */
  static loadConfigAndSecret(configKey: string): DummyUiSdlConfig | null;
   ...
   */
  removeSecrets(): DummyUiSdlConfig | null;

  /**
   * @return this config without any secret values.
   */
  static removeSecrets(): DummyUiSdlConfig | null;

  /**
   * @return this config with only secret values.
   */
  removeNonSecrets(): DummyUiSdlConfig | null;

  /**
   * @return this config with only secret values.
   */
  static removeNonSecrets(): DummyUiSdlConfig | null;

  /**
   * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
   * validation and setup.
   */
  validate(): DummyUiSdlConfig;

  /**
   * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
   * validation and setup.
   */
  static validate(): DummyUiSdlConfig;
  ...
  /**
   * Retrieves the bundler max memory by getting the infrastructure.bundlerMaxMem config value.
   */
