// TypeScript definitions for the C3 type UiBundlerResult
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of UiBundlerResult
 */
declare interface IUiBundlerResult {
   ...
   */
  rawValue?: C3.Map<string | null, any | null> | {[key: string | null]: any | null};
}
 ...
 */
declare class UiBundlerResult extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): UiBundlerResult | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): UiBundlerResult | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): UiBundlerResult | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): UiBundlerResult | null;
   ...
   */
  replaceType(old: Type, new_: Type): UiBundlerResult;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiBundlerResult;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiBundlerResult;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiBundlerResult | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiBundlerResult | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): UiBundlerResult;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiBundlerResult;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiBundlerResult;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): UiBundlerResult;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): UiBundlerResult;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): UiBundlerResult;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): UiBundlerResult;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): UiBundlerResult;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): UiBundlerResult;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): UiBundlerResult;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): UiBundlerResult;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): UiBundlerResult;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): UiBundlerResult;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): UiBundlerResult;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): UiBundlerResult;
   ...
   * @see #unsetField
   */
  defaultField(field: string): UiBundlerResult;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): UiBundlerResult;
   ...
   * @see #removeField
   */
  unsetField(field: string): UiBundlerResult;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): UiBundlerResult;
   ...
   * @see #unsetField
   */
  removeField(field: string): UiBundlerResult;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): UiBundlerResult;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): UiBundlerResult;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): UiBundlerResult;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): UiBundlerResult;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): UiBundlerResult;

  mergeJson(json: any | null): UiBundlerResult;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): UiBundlerResult;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): UiBundlerResult;
   ...
   */
  singletonArray(): C3.Array<UiBundlerResult | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<UiBundlerResult | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<UiBundlerResult | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<UiBundlerResult | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<UiBundlerResult | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, UiBundlerResult | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, UiBundlerResult | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<UiBundlerResult | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<UiBundlerResult | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): UiBundlerResult;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): UiBundlerResult;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): UiBundlerResult;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): UiBundlerResult;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): UiBundlerResult;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): UiBundlerResult;
   ...
   * @see #fromString
   */
  static make(s: string | null): UiBundlerResult | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): UiBundlerResult;
   ...
   */
  static cachedEmptyInst(): UiBundlerResult;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<UiBundlerResult>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): UiBundlerResult;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<UiBundlerResult | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<UiBundlerResult | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<UiBundlerResult | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<UiBundlerResult | null> | null>;
   ...
   */
  get(include?: string | null): UiBundlerResult | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): UiBundlerResult | null;
   ...
   */
  getMissing(spec: GetMissingSpec): UiBundlerResult;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): UiBundlerResult | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): UiBundlerResult;
   ...
   * @see #toString
   */
  static fromString(s: string | null): UiBundlerResult | null;
   ...
   */
  create(spec?: UpsertSpec | null): UiBundlerResult | null;
   ...
   */
  static createBatch(objs: C3.Array<UiBundlerResult | null> | null, spec?: UpsertSpec | null): ObjList<UiBundlerResult | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<UiBundlerResult | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<UiBundlerResult | null> | null;
   ...
   */
  update(srcObj?: UiBundlerResult | null, spec?: UpsertSpec | null): UiBundlerResult | null;
   ...
   */
  upsert(srcObj?: UiBundlerResult | null, spec?: UpsertSpec | null): UiBundlerResult | null;
   ...
   */
  merge(spec?: MergeSpec | null): UiBundlerResult | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): UiBundlerResult | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): UiBundlerResult | null;
   ...
   */
  static updateBatch(objs: C3.Array<UiBundlerResult | null> | null, srcObjs?: C3.Array<UiBundlerResult | null>, spec?: UpsertSpec | null): ObjList<UiBundlerResult | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<UiBundlerResult | null>>, spec?: UpsertSpec | null): ObjList<UiBundlerResult | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<UiBundlerResult | null> | null, srcObjs?: C3.Array<UiBundlerResult | null>, spec?: UpsertSpec | null): ObjList<UiBundlerResult | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<UiBundlerResult | null>>, spec?: UpsertSpec | null): ObjList<UiBundlerResult | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<UiBundlerResult | null> | null, spec?: TouchSpec | null): ObjList<UiBundlerResult | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<UiBundlerResult | null> | null, spec?: MergeSpec | null): ObjList<UiBundlerResult | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<UiBundlerResult | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<UiBundlerResult | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<UiBundlerResult | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<UiBundlerResult | null> | null;
   ...
   */
  static mergeAll(mergeObj: UiBundlerResult | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: UiBundlerResult | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<UiBundlerResult | null> | null, spec?: UpsertSpec | null): ObjList<UiBundlerResult | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<UiBundlerResult | null> | null, spec?: UpsertSpec | null): ObjList<UiBundlerResult | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<UiBundlerResult | null> | null): ObjList<UiBundlerResult | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<UiBundlerResult | null> | null): ObjList<UiBundlerResult | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<UiBundlerResult | null> | null): ObjList<UiBundlerResult | null>;
   ...
   */
  static afterCreate(objs: C3.Array<UiBundlerResult | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<UiBundlerResult | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<UiBundlerResult | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<UiBundlerResult | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<UiBundlerResult | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): UiBundlerResult | null;
   ...
   */
  withoutIdentity(): UiBundlerResult | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<UiBundlerResult | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: UiBundlerResult | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<UiBundlerResult | null> | null, callback?: λFunction<UiBundlerResult | null, UiBundlerResult | null> | null): ObjList<UiBundlerResult | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<UiBundlerResult | null> | null, callback?: λFunction<UiBundlerResult | null, UiBundlerResult | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static forJob(job?: UiBundler | null, include?: string | null): C3.Array<UiBundlerResult | null>;
}
