...
# Python definitions for the C3 type UiSdlDiagramShapeRenderUpdateType


class UiSdlDiagramShapeRenderUpdateType():
    """
    ...
    EXECUTE_LAYOUT: Optional[str]=None
    """
    ...
    """
    def __init__(self, ADD: Optional[str]=None, REMOVE: Optional[str]=None, POSITION: Optional[str]=None, VISIBILITY: Optional[str]=None, REPLACE: Optional[str]=None, UPDATE: Optional[str]=None, EXPAND: Optional[str]=None, COLLAPSE: Optional[str]=None, EXECUTE_LAYOUT: Optional[str]=None, CENTER: Optional[str]=None, CLEAR: Optional[str]=None) -> None: ...
