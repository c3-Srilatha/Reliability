// TypeScript definitions for the C3 type UiSdlDiagramReact

/**
 * React renderer for {@link UiSdlDiagram}s
 *
 * @remarks this represents a value passed to a method that expects an instance of UiSdlDiagramReact
 */
declare interface IUiSdlDiagramReact {
 ...
 */
declare class UiSdlDiagramReact extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): UiSdlDiagramReact | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): UiSdlDiagramReact | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): UiSdlDiagramReact | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): UiSdlDiagramReact | null;
   ...
   */
  replaceType(old: Type, new_: Type): UiSdlDiagramReact;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlDiagramReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlDiagramReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlDiagramReact | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlDiagramReact | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): UiSdlDiagramReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlDiagramReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlDiagramReact;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): UiSdlDiagramReact;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): UiSdlDiagramReact;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): UiSdlDiagramReact;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): UiSdlDiagramReact;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): UiSdlDiagramReact;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): UiSdlDiagramReact;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): UiSdlDiagramReact;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): UiSdlDiagramReact;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): UiSdlDiagramReact;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): UiSdlDiagramReact;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): UiSdlDiagramReact;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): UiSdlDiagramReact;
   ...
   * @see #unsetField
   */
  defaultField(field: string): UiSdlDiagramReact;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): UiSdlDiagramReact;
   ...
   * @see #removeField
   */
  unsetField(field: string): UiSdlDiagramReact;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): UiSdlDiagramReact;
   ...
   * @see #unsetField
   */
  removeField(field: string): UiSdlDiagramReact;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): UiSdlDiagramReact;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): UiSdlDiagramReact;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): UiSdlDiagramReact;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): UiSdlDiagramReact;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): UiSdlDiagramReact;

  mergeJson(json: any | null): UiSdlDiagramReact;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): UiSdlDiagramReact;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): UiSdlDiagramReact;
   ...
   */
  singletonArray(): C3.Array<UiSdlDiagramReact | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<UiSdlDiagramReact | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<UiSdlDiagramReact | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<UiSdlDiagramReact | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<UiSdlDiagramReact | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, UiSdlDiagramReact | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, UiSdlDiagramReact | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<UiSdlDiagramReact | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<UiSdlDiagramReact | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): UiSdlDiagramReact;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): UiSdlDiagramReact;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): UiSdlDiagramReact;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): UiSdlDiagramReact;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): UiSdlDiagramReact;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): UiSdlDiagramReact;
   ...
   * @see #fromString
   */
  static make(s: string | null): UiSdlDiagramReact | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): UiSdlDiagramReact;
   ...
   */
  static cachedEmptyInst(): UiSdlDiagramReact;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<UiSdlDiagramReact>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): UiSdlDiagramReact;
   ...
   */
  static render(props?: UiSdlDiagramReact | null): void;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<UiSdlDiagramReact | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<UiSdlDiagramReact | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<UiSdlDiagramReact | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<UiSdlDiagramReact | null> | null>;
   ...
   */
  dependencies(): MetadataDeps<UiSdlDiagramReact | null>;

  save(subPath?: string | null, contentType?: string | null): UiSdlDiagramReact;
  ...
  update(srcObj?: UiSdlDiagramReact | null, spec?: UpsertSpec | null): UiSdlDiagramReact | null;

  upsert(srcObj?: UiSdlDiagramReact | null, spec?: UpsertSpec | null): UiSdlDiagramReact | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): UiSdlDiagramReact | null;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string | null, failIfMissing?: boolean): UiSdlDiagramReact | null;
   ...
   */
  static doDataMerge(componentId: string, dataSpecFieldName: string, dataDestinationFieldName: string, props: UiSdlDiagramReact, state: UiSdlReduxState): UiSdlDiagramReact | null;
