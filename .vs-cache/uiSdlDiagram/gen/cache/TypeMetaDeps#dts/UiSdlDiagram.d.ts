// TypeScript definitions for the C3 type UiSdlDiagram

/**
 * IMPORTANT: This component uses SDLDiagram under the hood. SDLDiagram only takes in the map of
 * {@link UiSdlDiagramShapeRenderData} along with the various actions as props (see {@link UiSdlDiagramReact}).
 * It does NOT make any use of {@link #shapeMap}, instead it EXPECTS {@link #shapeRenderData} to be passed as a derived
 * prop and hands it directly to UiSdlDiagram.
 *
 * At the component level, only {@link UiSdlDiagramShapeRenderData#renderFunctionKey} is present. The specific framework
 * implementation (ex. UiSdlDiagramReact) is EXPECTED to transform the key into an actual render function and correctly
 * populate {@link UiSdlDiagramShapeRenderData#renderFunction} for each shape.
 *
 * @remarks this represents a value passed to a method that expects an instance of UiSdlDiagram
 */
declare interface IUiSdlDiagram {
   ...
   * render a shape.
   */
  shapeRenderData?: C3.Map<string | null, UiSdlDiagramShapeRenderData | null> | {[key: string | null]: IUiSdlDiagramShapeRenderData | null};
   ...
   */
  shapeMap?: C3.Map<string | null, UiSdlDiagramShape | null> | {[key: string | null]: IUiSdlDiagramShape | null};

  /**
   * A queue of updates to the graph that may require a rerender. Used to prevent unecessary redraws when empty
   */
  renderUpdateQueue?: C3.Array<UiSdlDiagramUpdate | null> | Array<IUiSdlDiagramUpdate | null>;
   ...
   */
  layout?: IUiSdlDiagramLayout | null;

  /**
   * The Diagram Legend to display
   */
  legend?: IUiSdlComponentRef<UiSdlDiagramLegend | null> | null;

  /**
   * The toolbar to display
   */
  toolbar?: IUiSdlComponentRef<UiSdlDiagramToolbar | null> | null;
   ...
   */
  lastScrollPosition?: IPair<number | null, number | null> | null;

  /**
   * Custom style config.
   */
  styleConfig?: IUiSdlDiagramStyleConfig | null;
}
 ...
 * populate {@link UiSdlDiagramShapeRenderData#renderFunction} for each shape.
 *
 * @remarks this represents a made instance of UiSdlDiagram
 */
declare class UiSdlDiagram extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): UiSdlDiagram | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): UiSdlDiagram | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): UiSdlDiagram | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): UiSdlDiagram | null;
   ...
   */
  replaceType(old: Type, new_: Type): UiSdlDiagram;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlDiagram;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlDiagram;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlDiagram | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlDiagram | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): UiSdlDiagram;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlDiagram;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlDiagram;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): UiSdlDiagram;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): UiSdlDiagram;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): UiSdlDiagram;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): UiSdlDiagram;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): UiSdlDiagram;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): UiSdlDiagram;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): UiSdlDiagram;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): UiSdlDiagram;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): UiSdlDiagram;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): UiSdlDiagram;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): UiSdlDiagram;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): UiSdlDiagram;
   ...
   * @see #unsetField
   */
  defaultField(field: string): UiSdlDiagram;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): UiSdlDiagram;
   ...
   * @see #removeField
   */
  unsetField(field: string): UiSdlDiagram;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): UiSdlDiagram;
   ...
   * @see #unsetField
   */
  removeField(field: string): UiSdlDiagram;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): UiSdlDiagram;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): UiSdlDiagram;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): UiSdlDiagram;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): UiSdlDiagram;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): UiSdlDiagram;

  mergeJson(json: any | null): UiSdlDiagram;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): UiSdlDiagram;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): UiSdlDiagram;
   ...
   */
  singletonArray(): C3.Array<UiSdlDiagram | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<UiSdlDiagram | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<UiSdlDiagram | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<UiSdlDiagram | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<UiSdlDiagram | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, UiSdlDiagram | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, UiSdlDiagram | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<UiSdlDiagram | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<UiSdlDiagram | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): UiSdlDiagram;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): UiSdlDiagram;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): UiSdlDiagram;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): UiSdlDiagram;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): UiSdlDiagram;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): UiSdlDiagram;
   ...
   * @see #fromString
   */
  static make(s: string | null): UiSdlDiagram | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): UiSdlDiagram;
   ...
   */
  static cachedEmptyInst(): UiSdlDiagram;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<UiSdlDiagram>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): UiSdlDiagram;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<UiSdlDiagram | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<UiSdlDiagram | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<UiSdlDiagram | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<UiSdlDiagram | null> | null>;
   ...
   */
  dependencies(): MetadataDeps<UiSdlDiagram | null>;

  save(subPath?: string | null, contentType?: string | null): UiSdlDiagram;
  ...
  update(srcObj?: UiSdlDiagram | null, spec?: UpsertSpec | null): UiSdlDiagram | null;

  upsert(srcObj?: UiSdlDiagram | null, spec?: UpsertSpec | null): UiSdlDiagram | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): UiSdlDiagram | null;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string | null, failIfMissing?: boolean): UiSdlDiagram | null;
   ...
   */
  static doDataMerge(componentId: string, dataSpecFieldName: string, dataDestinationFieldName: string, props: UiSdlDiagram, state: UiSdlReduxState): UiSdlDiagram | null;
   ...
   */
  static getSelectedShapeId(diagramId?: string | null, state?: UiSdlReduxState | null): string | null;
   ...
   */
  static getShape(shapeId?: string | null, diagramId?: string | null, state?: UiSdlReduxState | null): UiSdlDiagramShape | null;
   ...
   */
  static clickShapeAction(id: string, shapeId: string): UiSdlReduxAction<any>;
   ...
   */
  static connectNodesAction(id?: string | null, sourceId?: string | null, targetId?: string | null): UiSdlReduxAction<any> | null;
   ...
   */
  static clearRenderQueueAction(id: string): UiSdlReduxAction<any>;
   ...
   */
  static updateShapesAction(id: string, updates: C3.Array<UiSdlDiagramUpdate | null>): UiSdlReduxAction<any>;
   ...
   */
  static executeLayoutAction(id: string): UiSdlReduxAction<any>;
   ...
   */
  static completeExecuteLayoutAction(id: string): UiSdlReduxAction<any>;
   ...
   */
  static visibleShapesAction(id: string, shapeIds: C3.Array<string | null>, visible?: boolean): UiSdlReduxAction<any>;
   ...
   */
  static clickShapeMenuItemAction(id: string, shapeId: string, menuItemId: string): UiSdlReduxAction<any>;
   ...
   * A {@link UiSdlReduxAction} for the event
   */
  static changeZoomAction(id: string, zoomScale: string): UiSdlReduxAction<any>;
   ...
   * A {@link UiSdlReduxAction} for the event
   */
  static resetDiagramAction(id: string): UiSdlReduxAction<any>;
   ...
   * A {@link UiSdlReduxAction} for the event
   */
  static setLastScrollPositionAction(id: string, lastScrollPosition?: Pair<number | null, number | null> | null): UiSdlReduxAction<any>;
   ...
   */
  static expandOrCollapseNodesAction(id: string, shapeIds: C3.Array<string | null>, expand?: boolean): UiSdlReduxAction<any>;
   ...
   */
  static triggerNodeAction(id?: string | null, actionSuffix?: string | null, dataItem?: UiSdlDiagramNodeDataItem | null): UiSdlReduxAction<any> | null;
   ...
   */
  static shapeClickReducer(state: UiSdlReduxState, action: UiSdlReduxAction<any>): UiSdlReduxState;
   ...
   *    A new Redux state
   */
  static expandOrCollapseNodesReducer(state: UiSdlReduxState, action: UiSdlReduxAction<any>): UiSdlReduxState;
   ...
   */
  static renderQueueClearReducer(state: UiSdlReduxState, action: UiSdlReduxAction<any>): UiSdlReduxState;
   ...
   */
  static shapesUpdateReducer(state: UiSdlReduxState, action: UiSdlReduxAction<any>): UiSdlReduxState;
   ...
   *    The new Redux state=
   */
  static layoutExecuteReducer(state: UiSdlReduxState, action: UiSdlReduxAction<any>): UiSdlReduxState;
   ...
   */
  static zoomChangeReducer(state: UiSdlReduxState, action: UiSdlReduxAction<any>): UiSdlReduxState;
   ...
   *    The new Redux state
   */
  static diagramResetReducer(state: UiSdlReduxState, action: UiSdlReduxAction<any>): UiSdlReduxState;
   ...
   *    The new Redux state
   */
  static lastScrollPositionSetReducer(state: UiSdlReduxState, action: UiSdlReduxAction<any>): UiSdlReduxState;
}
