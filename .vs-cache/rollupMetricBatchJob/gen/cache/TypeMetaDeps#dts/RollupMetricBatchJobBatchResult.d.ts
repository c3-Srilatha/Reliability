// TypeScript definitions for the C3 type RollupMetricBatchJobBatchResult

/**
 * Intermediate output for {@link RollupMetricBatchJob}.
 *
 * @remarks this represents a value passed to a method that expects an instance of RollupMetricBatchJobBatchResult
 */
declare interface IRollupMetricBatchJobBatchResult {

  /**
   * rollupMetric expression.
   */
  expression: string;

  /**
   * The result of the output of this job.
   */
  parent: IRollupMetricBatchJob;

  /**
   * Timeseries from rollupMetrics.
   */
  timeseries: ITimeseries<number>;
  ...
  /**
   * #timeseries.data is the result of those `ids`.
   * This field is created for debugging purposes.
   */
  ids: Array_Type<string> | Array<string>;

  /**
   * rollupFunc used to generate the data
   * This field is created for debugging purposes.
   */
  rollupFunc?: string;

  /**
   * A 0-indexed batch number
   * This field is created for debugging purposes.
   */
  batchId: number;
}
 ...
 * Intermediate output for {@link RollupMetricBatchJob}.
 *
 * @remarks this represents a made instance of RollupMetricBatchJobBatchResult
 */
declare class RollupMetricBatchJobBatchResult extends Obj  {

  /**
   * rollupMetric expression.
   */
  readonly expression: string;
  withExpression(expression: string): RollupMetricBatchJobBatchResult;

  /**
   * The result of the output of this job.
   */
  readonly parent: RollupMetricBatchJob;
  withParent(parent: IRollupMetricBatchJob): RollupMetricBatchJobBatchResult;

  /**
   * Timeseries from rollupMetrics.
   */
  readonly timeseries: Timeseries<number>;
  withTimeseries(timeseries: ITimeseries<number>): RollupMetricBatchJobBatchResult;
   ...
   */
  readonly id: string;
  withId(id: string): RollupMetricBatchJobBatchResult;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): RollupMetricBatchJobBatchResult;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): RollupMetricBatchJobBatchResult;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): RollupMetricBatchJobBatchResult;
  ...
  withVersion(version: number | null): RollupMetricBatchJobBatchResult;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): RollupMetricBatchJobBatchResult;

  /**
   * #timeseries.data is the result of those `ids`.
   * This field is created for debugging purposes.
   */
  readonly ids: Array_Type<string>;
  withIds(ids: Array_Type<string> | Array<string>): RollupMetricBatchJobBatchResult;
  ...
  withRollupFunc(rollupFunc: string | null): RollupMetricBatchJobBatchResult;
  ...
  withBatchId(batchId: number): RollupMetricBatchJobBatchResult;
   ...
   * @see #toJson
   */
  static fromJson(json: any): RollupMetricBatchJobBatchResult | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): RollupMetricBatchJobBatchResult | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): RollupMetricBatchJobBatchResult | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): RollupMetricBatchJobBatchResult | null;
   ...
   */
  replaceType(old: Type, new_: Type): RollupMetricBatchJobBatchResult;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): RollupMetricBatchJobBatchResult;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): RollupMetricBatchJobBatchResult;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<RollupMetricBatchJobBatchResult>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<RollupMetricBatchJobBatchResult>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): RollupMetricBatchJobBatchResult;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): RollupMetricBatchJobBatchResult;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): RollupMetricBatchJobBatchResult;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): RollupMetricBatchJobBatchResult;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): RollupMetricBatchJobBatchResult;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): RollupMetricBatchJobBatchResult;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): RollupMetricBatchJobBatchResult;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): RollupMetricBatchJobBatchResult;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): RollupMetricBatchJobBatchResult;
   ...
   * @see #removeField
   */
  withoutField(field: string): RollupMetricBatchJobBatchResult;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): RollupMetricBatchJobBatchResult;
   ...
   */
  withoutFields(fields: Array_Type<string>): RollupMetricBatchJobBatchResult;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): RollupMetricBatchJobBatchResult;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): RollupMetricBatchJobBatchResult;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): RollupMetricBatchJobBatchResult;
   ...
   * @see #unsetField
   */
  defaultField(field: string): RollupMetricBatchJobBatchResult;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): RollupMetricBatchJobBatchResult;
   ...
   * @see #removeField
   */
  unsetField(field: string): RollupMetricBatchJobBatchResult;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): RollupMetricBatchJobBatchResult;
   ...
   * @see #unsetField
   */
  removeField(field: string): RollupMetricBatchJobBatchResult;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): RollupMetricBatchJobBatchResult;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): RollupMetricBatchJobBatchResult;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): RollupMetricBatchJobBatchResult;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): RollupMetricBatchJobBatchResult;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): RollupMetricBatchJobBatchResult;

  mergeJson(json: any): RollupMetricBatchJobBatchResult;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): RollupMetricBatchJobBatchResult;
   ...
   */
  sumObj(other: Obj, deep?: boolean): RollupMetricBatchJobBatchResult;
   ...
   */
  singletonArray(): Array_Type<RollupMetricBatchJobBatchResult>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<RollupMetricBatchJobBatchResult> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<RollupMetricBatchJobBatchResult> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<RollupMetricBatchJobBatchResult>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<RollupMetricBatchJobBatchResult> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, RollupMetricBatchJobBatchResult> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, RollupMetricBatchJobBatchResult> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<RollupMetricBatchJobBatchResult>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<RollupMetricBatchJobBatchResult>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): RollupMetricBatchJobBatchResult;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): RollupMetricBatchJobBatchResult;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): RollupMetricBatchJobBatchResult;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): RollupMetricBatchJobBatchResult;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): RollupMetricBatchJobBatchResult;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): RollupMetricBatchJobBatchResult;
   ...
   * @see #fromString
   */
  static make(s: string): RollupMetricBatchJobBatchResult | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): RollupMetricBatchJobBatchResult;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): RollupMetricBatchJobBatchResult;
   ...
   */
  static cachedEmptyInst(): RollupMetricBatchJobBatchResult;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<RollupMetricBatchJobBatchResult> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): RollupMetricBatchJobBatchResult;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<RollupMetricBatchJobBatchResult>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<RollupMetricBatchJobBatchResult>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<RollupMetricBatchJobBatchResult> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<RollupMetricBatchJobBatchResult>> | null;
   ...
   */
  get(include?: string): RollupMetricBatchJobBatchResult | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): RollupMetricBatchJobBatchResult | null;
   ...
   */
  getMissing(spec: GetMissingSpec): RollupMetricBatchJobBatchResult;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): RollupMetricBatchJobBatchResult | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): RollupMetricBatchJobBatchResult;
   ...
   * @see #toString
   */
  static fromString(s: string): RollupMetricBatchJobBatchResult | null;
   ...
   */
  create(spec?: UpsertSpec): RollupMetricBatchJobBatchResult | null;
   ...
   */
  static createBatch(objs: Array_Type<RollupMetricBatchJobBatchResult>, spec?: UpsertSpec): ObjList<RollupMetricBatchJobBatchResult> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<RollupMetricBatchJobBatchResult>, spec?: CreateBatchObjStreamSpec): ObjList<RollupMetricBatchJobBatchResult> | null;
   ...
   */
  update(srcObj?: RollupMetricBatchJobBatchResult, spec?: UpsertSpec): RollupMetricBatchJobBatchResult | null;
   ...
   */
  upsert(srcObj?: RollupMetricBatchJobBatchResult, spec?: UpsertSpec): RollupMetricBatchJobBatchResult | null;
   ...
   */
  merge(spec?: MergeSpec): RollupMetricBatchJobBatchResult | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): RollupMetricBatchJobBatchResult | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): RollupMetricBatchJobBatchResult | null;
   ...
   */
  static updateBatch(objs: Array_Type<RollupMetricBatchJobBatchResult>, srcObjs?: Array_Type<RollupMetricBatchJobBatchResult>, spec?: UpsertSpec): ObjList<RollupMetricBatchJobBatchResult> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<RollupMetricBatchJobBatchResult> | null>, spec?: UpsertSpec): ObjList<RollupMetricBatchJobBatchResult> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<RollupMetricBatchJobBatchResult>, srcObjs?: Array_Type<RollupMetricBatchJobBatchResult>, spec?: UpsertSpec): ObjList<RollupMetricBatchJobBatchResult> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<RollupMetricBatchJobBatchResult> | null>, spec?: UpsertSpec): ObjList<RollupMetricBatchJobBatchResult> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<RollupMetricBatchJobBatchResult>, spec?: TouchSpec): ObjList<RollupMetricBatchJobBatchResult> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<RollupMetricBatchJobBatchResult>, spec?: MergeSpec): ObjList<RollupMetricBatchJobBatchResult> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<RollupMetricBatchJobBatchResult>, mergeInclude: string, spec?: MergeSpec): ObjList<RollupMetricBatchJobBatchResult> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<RollupMetricBatchJobBatchResult> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<RollupMetricBatchJobBatchResult> | null;
   ...
   */
  static mergeAll(mergeObj: RollupMetricBatchJobBatchResult, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: RollupMetricBatchJobBatchResult, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<RollupMetricBatchJobBatchResult>, spec?: UpsertSpec): ObjList<RollupMetricBatchJobBatchResult> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<RollupMetricBatchJobBatchResult>, spec?: UpsertSpec): ObjList<RollupMetricBatchJobBatchResult> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): RollupMetricBatchJobBatchResult | null;
   ...
   */
  static beforeCreate(objs: Array_Type<RollupMetricBatchJobBatchResult>): ObjList<RollupMetricBatchJobBatchResult>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<RollupMetricBatchJobBatchResult>): ObjList<RollupMetricBatchJobBatchResult>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<RollupMetricBatchJobBatchResult>): ObjList<RollupMetricBatchJobBatchResult>;
   ...
   */
  static afterCreate(objs: Array_Type<RollupMetricBatchJobBatchResult>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<RollupMetricBatchJobBatchResult>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<RollupMetricBatchJobBatchResult>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<RollupMetricBatchJobBatchResult>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<RollupMetricBatchJobBatchResult>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): RollupMetricBatchJobBatchResult | null;
   ...
   */
  withoutIdentity(): RollupMetricBatchJobBatchResult | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<RollupMetricBatchJobBatchResult>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: RollupMetricBatchJobBatchResult, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<RollupMetricBatchJobBatchResult>, callback?: λFunction<RollupMetricBatchJobBatchResult | null, RollupMetricBatchJobBatchResult | null>): ObjList<RollupMetricBatchJobBatchResult>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<RollupMetricBatchJobBatchResult>, callback?: λFunction<RollupMetricBatchJobBatchResult | null, RollupMetricBatchJobBatchResult | null>): Array_Type<ObjError> | null;
