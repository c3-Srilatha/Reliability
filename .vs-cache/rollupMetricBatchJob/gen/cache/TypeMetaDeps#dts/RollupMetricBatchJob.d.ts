// TypeScript definitions for the C3 type RollupMetricBatchJob
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of RollupMetricBatchJob
 */
declare interface IRollupMetricBatchJob {
   ...
   */
  postCompleteAction?: IPartiallyAppliedAction;
   ...
   */
  batchResult?: Array_Type<RollupMetricBatchJobBatchResult> | Array<IRollupMetricBatchJobBatchResult>;

  /**
   * Final results
   */
  finalResult?: Array_Type<RollupMetricBatchJobResult> | Array<IRollupMetricBatchJobResult>;
}
 ...
 */
declare class RollupMetricBatchJob extends Obj  {

  /**
   * current or last job execution for this instance
   */
  readonly run?: BatchJobRun;
  withRun(run: IBatchJobRun | null): RollupMetricBatchJob;

  /**
   * previous job executions for this instance
   */
  readonly runs?: Array_Type<BatchJobRun>;
  withRuns(runs: Array_Type<BatchJobRun> | Array<IBatchJobRun> | null): RollupMetricBatchJob;

  /**
   * FOR INTERNAL USE ONLY - Specify options in call to {@link start}.
   */
  readonly options?: Obj;
  withOptions(options: IObj | null): RollupMetricBatchJob;
  ...
  withOnCompleteCallback(onCompleteCallback: IJobBase.Callback | null): RollupMetricBatchJob;
  ...
  withPriority(priority: number | null): RollupMetricBatchJob;
  ...
  withDisabled(disabled: boolean): RollupMetricBatchJob;
  ...
  withMaxConcurrency(maxConcurrency: number | null): RollupMetricBatchJob;
  ...
  withMaxConcurrencyPerNode(maxConcurrencyPerNode: number | null): RollupMetricBatchJob;
  ...
  withRunAsUser(runAsUser: boolean): RollupMetricBatchJob;

  /**
   * Don't set this field in the BatchJob, set it in the BatchJobOptions when calling `start`
   */
  readonly nodePool?: string;
  withNodePool(nodePool: string | null): RollupMetricBatchJob;
  ...
  withSkipIfRunning(skipIfRunning: boolean): RollupMetricBatchJob;

  /**
   * Set to between 1 and 5 to enable auto recovery. See {@link invalidation-queues.c3doc Invalidation Queues} for detailed documentation.
   */
  readonly numAutoRecoveryAttempts?: number;
  withNumAutoRecoveryAttempts(numAutoRecoveryAttempts: number | null): RollupMetricBatchJob;
  ...
  withTypeIdent(typeIdent: string | null): RollupMetricBatchJob;
   ...
   */
  readonly id: string;
  withId(id: string): RollupMetricBatchJob;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): RollupMetricBatchJob;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): RollupMetricBatchJob;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): RollupMetricBatchJob;
  ...
  withVersion(version: number | null): RollupMetricBatchJob;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): RollupMetricBatchJob;
  ...
  withAbortOnError(abortOnError: boolean): RollupMetricBatchJob;

  /**
   * If this field is populated, this action will be called with a `job` argument after the batch job is complete.
   */
  readonly postCompleteAction?: PartiallyAppliedAction;
  withPostCompleteAction(postCompleteAction: IPartiallyAppliedAction | null): RollupMetricBatchJob;
  ...
  withCount(count: number | null): RollupMetricBatchJob;

  /**
   * rollupMetrics result for each batch.
   */
  readonly batchResult?: Array_Type<RollupMetricBatchJobBatchResult>;
  withBatchResult(batchResult: Array_Type<RollupMetricBatchJobBatchResult> | Array<IRollupMetricBatchJobBatchResult> | null): RollupMetricBatchJob;

  /**
   * Final results
   */
  readonly finalResult?: Array_Type<RollupMetricBatchJobResult>;
  withFinalResult(finalResult: Array_Type<RollupMetricBatchJobResult> | Array<IRollupMetricBatchJobResult> | null): RollupMetricBatchJob;
   ...
   * @see #toJson
   */
  static fromJson(json: any): RollupMetricBatchJob | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): RollupMetricBatchJob | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): RollupMetricBatchJob | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): RollupMetricBatchJob | null;
   ...
   */
  replaceType(old: Type, new_: Type): RollupMetricBatchJob;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): RollupMetricBatchJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): RollupMetricBatchJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<RollupMetricBatchJob>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<RollupMetricBatchJob>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): RollupMetricBatchJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): RollupMetricBatchJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): RollupMetricBatchJob;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): RollupMetricBatchJob;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): RollupMetricBatchJob;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): RollupMetricBatchJob;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): RollupMetricBatchJob;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): RollupMetricBatchJob;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): RollupMetricBatchJob;
   ...
   * @see #removeField
   */
  withoutField(field: string): RollupMetricBatchJob;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): RollupMetricBatchJob;
   ...
   */
  withoutFields(fields: Array_Type<string>): RollupMetricBatchJob;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): RollupMetricBatchJob;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): RollupMetricBatchJob;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): RollupMetricBatchJob;
   ...
   * @see #unsetField
   */
  defaultField(field: string): RollupMetricBatchJob;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): RollupMetricBatchJob;
   ...
   * @see #removeField
   */
  unsetField(field: string): RollupMetricBatchJob;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): RollupMetricBatchJob;
   ...
   * @see #unsetField
   */
  removeField(field: string): RollupMetricBatchJob;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): RollupMetricBatchJob;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): RollupMetricBatchJob;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): RollupMetricBatchJob;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): RollupMetricBatchJob;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): RollupMetricBatchJob;

  mergeJson(json: any): RollupMetricBatchJob;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): RollupMetricBatchJob;
   ...
   */
  sumObj(other: Obj, deep?: boolean): RollupMetricBatchJob;
   ...
   */
  singletonArray(): Array_Type<RollupMetricBatchJob>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<RollupMetricBatchJob> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<RollupMetricBatchJob> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<RollupMetricBatchJob>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<RollupMetricBatchJob> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, RollupMetricBatchJob> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, RollupMetricBatchJob> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<RollupMetricBatchJob>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<RollupMetricBatchJob>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): RollupMetricBatchJob;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): RollupMetricBatchJob;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): RollupMetricBatchJob;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): RollupMetricBatchJob;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): RollupMetricBatchJob;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): RollupMetricBatchJob;
   ...
   * @see #fromString
   */
  static make(s: string): RollupMetricBatchJob | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): RollupMetricBatchJob;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): RollupMetricBatchJob;
   ...
   */
  static cachedEmptyInst(): RollupMetricBatchJob;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<RollupMetricBatchJob> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): RollupMetricBatchJob;
   ...
   */
  start(options?: RollupMetricBatchJobOptions): BatchJobStatus | null;
   ...
   */
  cleanup(options?: RollupMetricBatchJobOptions): void;
  ...
  cancelJob(removeResults?: boolean, force?: boolean): JobBase<BatchJobRun, BatchJobStatus, RollupMetricBatchJobOptions> | null;

  failJob(run: JobRun<BatchJobStatusBase>): JobBase<BatchJobRun, BatchJobStatus, RollupMetricBatchJobOptions> | null;
  ...
  validateStart(options?: RollupMetricBatchJobOptions): void;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<RollupMetricBatchJob>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<RollupMetricBatchJob>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<RollupMetricBatchJob> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<RollupMetricBatchJob>> | null;
   ...
   */
  get(include?: string): RollupMetricBatchJob | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): RollupMetricBatchJob | null;
   ...
   */
  getMissing(spec: GetMissingSpec): RollupMetricBatchJob;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): RollupMetricBatchJob | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): RollupMetricBatchJob;
   ...
   * @see #toString
   */
  static fromString(s: string): RollupMetricBatchJob | null;
   ...
   */
  create(spec?: UpsertSpec): RollupMetricBatchJob | null;
   ...
   */
  static createBatch(objs: Array_Type<RollupMetricBatchJob>, spec?: UpsertSpec): ObjList<RollupMetricBatchJob> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<RollupMetricBatchJob>, spec?: CreateBatchObjStreamSpec): ObjList<RollupMetricBatchJob> | null;
   ...
   */
  update(srcObj?: RollupMetricBatchJob, spec?: UpsertSpec): RollupMetricBatchJob | null;
   ...
   */
  upsert(srcObj?: RollupMetricBatchJob, spec?: UpsertSpec): RollupMetricBatchJob | null;
   ...
   */
  merge(spec?: MergeSpec): RollupMetricBatchJob | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): RollupMetricBatchJob | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): RollupMetricBatchJob | null;
   ...
   */
  static updateBatch(objs: Array_Type<RollupMetricBatchJob>, srcObjs?: Array_Type<RollupMetricBatchJob>, spec?: UpsertSpec): ObjList<RollupMetricBatchJob> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<RollupMetricBatchJob> | null>, spec?: UpsertSpec): ObjList<RollupMetricBatchJob> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<RollupMetricBatchJob>, srcObjs?: Array_Type<RollupMetricBatchJob>, spec?: UpsertSpec): ObjList<RollupMetricBatchJob> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<RollupMetricBatchJob> | null>, spec?: UpsertSpec): ObjList<RollupMetricBatchJob> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<RollupMetricBatchJob>, spec?: TouchSpec): ObjList<RollupMetricBatchJob> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<RollupMetricBatchJob>, spec?: MergeSpec): ObjList<RollupMetricBatchJob> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<RollupMetricBatchJob>, mergeInclude: string, spec?: MergeSpec): ObjList<RollupMetricBatchJob> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<RollupMetricBatchJob> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<RollupMetricBatchJob> | null;
   ...
   */
  static mergeAll(mergeObj: RollupMetricBatchJob, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: RollupMetricBatchJob, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<RollupMetricBatchJob>, spec?: UpsertSpec): ObjList<RollupMetricBatchJob> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<RollupMetricBatchJob>, spec?: UpsertSpec): ObjList<RollupMetricBatchJob> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): RollupMetricBatchJob | null;
   ...
   */
  static beforeCreate(objs: Array_Type<RollupMetricBatchJob>): ObjList<RollupMetricBatchJob>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<RollupMetricBatchJob>): ObjList<RollupMetricBatchJob>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<RollupMetricBatchJob>): ObjList<RollupMetricBatchJob>;
   ...
   */
  static afterCreate(objs: Array_Type<RollupMetricBatchJob>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<RollupMetricBatchJob>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<RollupMetricBatchJob>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<RollupMetricBatchJob>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<RollupMetricBatchJob>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): RollupMetricBatchJob | null;
   ...
   */
  withoutIdentity(): RollupMetricBatchJob | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<RollupMetricBatchJob>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: RollupMetricBatchJob, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<RollupMetricBatchJob>, callback?: λFunction<RollupMetricBatchJob | null, RollupMetricBatchJob | null>): ObjList<RollupMetricBatchJob>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<RollupMetricBatchJob>, callback?: λFunction<RollupMetricBatchJob | null, RollupMetricBatchJob | null>): Array_Type<ObjError> | null;
   ...
   */
  static doStart(job?: RollupMetricBatchJob, options?: RollupMetricBatchJobOptions): void;
   ...
   */
  static processBatch(batch?: RollupMetricBatchJobBatch, job?: RollupMetricBatchJob, options?: RollupMetricBatchJobOptions): void;
   ...
   */
  static allComplete(job: RollupMetricBatchJob, options?: RollupMetricBatchJobOptions): string | null;
   ...
   *           Options the job was run with.
   */
  static failed(job: RollupMetricBatchJob, status: BatchJobStatus, options?: RollupMetricBatchJobOptions): void;
   ...
   *        Batch to schedule.
   */
  scheduleBatch(batch?: RollupMetricBatchJobBatch): void;
   ...
   *        Batches to schedule.
   */
  scheduleBatches(batches?: Array_Type<RollupMetricBatchJobBatch>): void;
   ...
   */
  static scheduleObjBatch(job?: RollupMetricBatchJob, objBatch?: ObjBatch, logPrefix?: string): number | null;
   ...
   */
  static startJob(options: RollupMetricBatchJobOptions, postCompleteAction?: PartiallyAppliedAction): RollupMetricBatchJob;

  /**
   * Return the result of this job.
   * @returns the mapping from the expressions to their {@link Timeseries}.
   */
  result(): Map_Type<string, Timeseries<number>>;
}
