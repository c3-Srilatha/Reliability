// TypeScript definitions for the C3 type RollupMetricPersistedResult
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of RollupMetricPersistedResult
 */
declare interface IRollupMetricPersistedResult {
 ...
 */
declare class RollupMetricPersistedResult extends Obj  {
   ...
   */
  readonly id: string;
  withId(id: string): RollupMetricPersistedResult;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): RollupMetricPersistedResult;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): RollupMetricPersistedResult;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): RollupMetricPersistedResult;
  ...
  withVersion(version: number | null): RollupMetricPersistedResult;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): RollupMetricPersistedResult;

  /**
   * Type name to run #rollupMetrics on.
   */
  readonly srcType: string;
  withSrcType(srcType: string): RollupMetricPersistedResult;

  /**
   * {@link RollupMetricSpec#filter}
   */
  readonly filter: string;
  withFilter(filter: string): RollupMetricPersistedResult;
  ...
  withRollupFunc(rollupFunc: string): RollupMetricPersistedResult;

  /**
   * {@link RollupMetricSpec#interval}
   */
  readonly interval: string;
  withInterval(interval: string): RollupMetricPersistedResult;

  /**
   * {@link RollupMetricSpec#expressions}
   */
  readonly expression: string;
  withExpression(expression: string): RollupMetricPersistedResult;

  /**
   * {@link RollupMetricSpec#timeZone}
   */
  readonly timeZone: string;
  withTimeZone(timeZone: string): RollupMetricPersistedResult;

  /**
   * Timeseries
   */
  readonly ts?: Timeseries<number>;
  withTs(ts: ITimeseries<number> | null): RollupMetricPersistedResult;
   ...
   * @see #toJson
   */
  static fromJson(json: any): RollupMetricPersistedResult | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): RollupMetricPersistedResult | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): RollupMetricPersistedResult | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): RollupMetricPersistedResult | null;
   ...
   */
  replaceType(old: Type, new_: Type): RollupMetricPersistedResult;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): RollupMetricPersistedResult;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): RollupMetricPersistedResult;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<RollupMetricPersistedResult>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<RollupMetricPersistedResult>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): RollupMetricPersistedResult;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): RollupMetricPersistedResult;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): RollupMetricPersistedResult;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): RollupMetricPersistedResult;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): RollupMetricPersistedResult;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): RollupMetricPersistedResult;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): RollupMetricPersistedResult;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): RollupMetricPersistedResult;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): RollupMetricPersistedResult;
   ...
   * @see #removeField
   */
  withoutField(field: string): RollupMetricPersistedResult;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): RollupMetricPersistedResult;
   ...
   */
  withoutFields(fields: Array_Type<string>): RollupMetricPersistedResult;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): RollupMetricPersistedResult;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): RollupMetricPersistedResult;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): RollupMetricPersistedResult;
   ...
   * @see #unsetField
   */
  defaultField(field: string): RollupMetricPersistedResult;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): RollupMetricPersistedResult;
   ...
   * @see #removeField
   */
  unsetField(field: string): RollupMetricPersistedResult;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): RollupMetricPersistedResult;
   ...
   * @see #unsetField
   */
  removeField(field: string): RollupMetricPersistedResult;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): RollupMetricPersistedResult;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): RollupMetricPersistedResult;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): RollupMetricPersistedResult;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): RollupMetricPersistedResult;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): RollupMetricPersistedResult;

  mergeJson(json: any): RollupMetricPersistedResult;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): RollupMetricPersistedResult;
   ...
   */
  sumObj(other: Obj, deep?: boolean): RollupMetricPersistedResult;
   ...
   */
  singletonArray(): Array_Type<RollupMetricPersistedResult>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<RollupMetricPersistedResult> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<RollupMetricPersistedResult> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<RollupMetricPersistedResult>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<RollupMetricPersistedResult> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, RollupMetricPersistedResult> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, RollupMetricPersistedResult> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<RollupMetricPersistedResult>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<RollupMetricPersistedResult>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): RollupMetricPersistedResult;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): RollupMetricPersistedResult;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): RollupMetricPersistedResult;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): RollupMetricPersistedResult;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): RollupMetricPersistedResult;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): RollupMetricPersistedResult;
   ...
   * @see #fromString
   */
  static make(s: string): RollupMetricPersistedResult | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): RollupMetricPersistedResult;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): RollupMetricPersistedResult;
   ...
   */
  static cachedEmptyInst(): RollupMetricPersistedResult;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<RollupMetricPersistedResult> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): RollupMetricPersistedResult;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<RollupMetricPersistedResult>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<RollupMetricPersistedResult>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<RollupMetricPersistedResult> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<RollupMetricPersistedResult>> | null;
   ...
   */
  get(include?: string): RollupMetricPersistedResult | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): RollupMetricPersistedResult | null;
   ...
   */
  getMissing(spec: GetMissingSpec): RollupMetricPersistedResult;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): RollupMetricPersistedResult | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): RollupMetricPersistedResult;
   ...
   * @see #toString
   */
  static fromString(s: string): RollupMetricPersistedResult | null;
   ...
   */
  create(spec?: UpsertSpec): RollupMetricPersistedResult | null;
   ...
   */
  static createBatch(objs: Array_Type<RollupMetricPersistedResult>, spec?: UpsertSpec): ObjList<RollupMetricPersistedResult> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<RollupMetricPersistedResult>, spec?: CreateBatchObjStreamSpec): ObjList<RollupMetricPersistedResult> | null;
   ...
   */
  update(srcObj?: RollupMetricPersistedResult, spec?: UpsertSpec): RollupMetricPersistedResult | null;
   ...
   */
  upsert(srcObj?: RollupMetricPersistedResult, spec?: UpsertSpec): RollupMetricPersistedResult | null;
   ...
   */
  merge(spec?: MergeSpec): RollupMetricPersistedResult | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): RollupMetricPersistedResult | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): RollupMetricPersistedResult | null;
   ...
   */
  static updateBatch(objs: Array_Type<RollupMetricPersistedResult>, srcObjs?: Array_Type<RollupMetricPersistedResult>, spec?: UpsertSpec): ObjList<RollupMetricPersistedResult> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<RollupMetricPersistedResult> | null>, spec?: UpsertSpec): ObjList<RollupMetricPersistedResult> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<RollupMetricPersistedResult>, srcObjs?: Array_Type<RollupMetricPersistedResult>, spec?: UpsertSpec): ObjList<RollupMetricPersistedResult> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<RollupMetricPersistedResult> | null>, spec?: UpsertSpec): ObjList<RollupMetricPersistedResult> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<RollupMetricPersistedResult>, spec?: TouchSpec): ObjList<RollupMetricPersistedResult> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<RollupMetricPersistedResult>, spec?: MergeSpec): ObjList<RollupMetricPersistedResult> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<RollupMetricPersistedResult>, mergeInclude: string, spec?: MergeSpec): ObjList<RollupMetricPersistedResult> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<RollupMetricPersistedResult> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<RollupMetricPersistedResult> | null;
   ...
   */
  static mergeAll(mergeObj: RollupMetricPersistedResult, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: RollupMetricPersistedResult, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<RollupMetricPersistedResult>, spec?: UpsertSpec): ObjList<RollupMetricPersistedResult> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<RollupMetricPersistedResult>, spec?: UpsertSpec): ObjList<RollupMetricPersistedResult> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): RollupMetricPersistedResult | null;
   ...
   */
  static beforeCreate(objs: Array_Type<RollupMetricPersistedResult>): ObjList<RollupMetricPersistedResult>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<RollupMetricPersistedResult>): ObjList<RollupMetricPersistedResult>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<RollupMetricPersistedResult>): ObjList<RollupMetricPersistedResult>;
   ...
   */
  static afterCreate(objs: Array_Type<RollupMetricPersistedResult>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<RollupMetricPersistedResult>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<RollupMetricPersistedResult>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<RollupMetricPersistedResult>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<RollupMetricPersistedResult>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): RollupMetricPersistedResult | null;
   ...
   */
  withoutIdentity(): RollupMetricPersistedResult | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<RollupMetricPersistedResult>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: RollupMetricPersistedResult, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<RollupMetricPersistedResult>, callback?: λFunction<RollupMetricPersistedResult | null, RollupMetricPersistedResult | null>): ObjList<RollupMetricPersistedResult>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<RollupMetricPersistedResult>, callback?: λFunction<RollupMetricPersistedResult | null, RollupMetricPersistedResult | null>): Array_Type<ObjError> | null;
   ...
   */
  static rollupMetrics(spec: RollupMetricPersistedResultRollupMetricSpec, srcType: string): Map_Type<string, Timeseries<number>> | null;
   ...
   */
  static persistResult(spec: RollupMetricSpec, srcType: string, result: Map_Type<string, Timeseries<number>>, replace?: boolean): void;
   ...
   *          If `false`, the existing {@link RollupMetricPersistedResult} will be concatenated with the new result.
   */
  static persistResultFromJob(job: RollupMetricBatchJob, replace?: boolean): void;
   ...
   */
  static startRollupMetricBatchJob(spec: RollupMetricStartPersistenceJobSpec): Array_Type<RollupMetricBatchJob>;
   ...
   * @returns The started {@link RollupMetricBatchJob}s.
   */
  static startRollupMetricBatchJobs(specs: Array_Type<RollupMetricStartPersistenceJobSpec>): Array_Type<RollupMetricBatchJob>;
   ...
   */
  persistRollupMetric(timeseries: Timeseries<any>): RollupMetricPersistedResult;
   ...
   */
  static createRollupMetricCache(srcType: string, expression: string, metricSpec: RollupMetricSpec): RollupMetricPersistedResult;
   ...
   */
  static startRollupMetricMapReduceJobs(spec: RollupMetricStartPersistenceJobSpec): Array_Type<RollupMetricMapReduceJob<any>>;
   ...
   */
  static fetchResultForSpec(spec: RollupMetricSpec, srcType: string, include?: string): Array_Type<RollupMetricPersistedResult> | null;
   ...
   */
  static _alignSpecDates(spec: EvalMetricsSpec): EvalMetricsSpec | null;
   ...
   */
  static _getExpressionsWithBindings(spec: EvalMetricsSpec): Array_Type<string> | null;
   ...
   */
  static _getExpressionsWithResultKey(spec: EvalMetricsSpec): Array_Type<string> | null;
   ...
   */
  static _getTimeZones(timeZones?: Set_Type<TimeZone>): Set_Type<TimeZone> | null;
}
