// TypeScript definitions for the C3 type RollupMetricMapReduceJob
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of RollupMetricMapReduceJob
 */
declare interface IRollupMetricMapReduceJob<T> {
   ...
   */
  caches?: Array_Type<RollupMetricPersistedResult> | Array<IRollupMetricPersistedResult>;
 ...
 */
declare class RollupMetricMapReduceJob<T> extends Obj  {

  /**
   * current or last job execution for this instance
   */
  readonly run?: MapReduceRun;
  withRun(run: IMapReduceRun | null): RollupMetricMapReduceJob;

  /**
   * previous job executions for this instance
   */
  readonly runs?: Array_Type<MapReduceRun>;
  withRuns(runs: Array_Type<MapReduceRun> | Array<IMapReduceRun> | null): RollupMetricMapReduceJob;

  /**
   * FOR INTERNAL USE ONLY - Specify options in call to {@link start}.
   */
  readonly options?: Obj;
  withOptions(options: IObj | null): RollupMetricMapReduceJob;
  ...
  withOnCompleteCallback(onCompleteCallback: IJobBase.Callback | null): RollupMetricMapReduceJob;
  ...
  withPriority(priority: number | null): RollupMetricMapReduceJob;
  ...
  withDisabled(disabled: boolean): RollupMetricMapReduceJob;
  ...
  withMaxConcurrency(maxConcurrency: number | null): RollupMetricMapReduceJob;
  ...
  withMaxConcurrencyPerNode(maxConcurrencyPerNode: number | null): RollupMetricMapReduceJob;
  ...
  withRunAsUser(runAsUser: boolean): RollupMetricMapReduceJob;

  /**
   * Don't set this field in the MapReduce job, set it in the MapReduceOptions when calling `start`.
   */
  readonly nodePool?: string;
  withNodePool(nodePool: string | null): RollupMetricMapReduceJob;
  ...
  withSkipIfRunning(skipIfRunning: boolean): RollupMetricMapReduceJob;

  /**
   * Set to between 1 and 5 to enable auto recovery. See {@link invalidation-queues.c3doc Invalidation Queues} for detailed documentation.
   */
  readonly numAutoRecoveryAttempts?: number;
  withNumAutoRecoveryAttempts(numAutoRecoveryAttempts: number | null): RollupMetricMapReduceJob;
  ...
  withTargetType(targetType: IType | null): RollupMetricMapReduceJob;
  ...
  withUseFileSystemForInterVals(useFileSystemForInterVals: boolean): RollupMetricMapReduceJob;
  ...
  withUseBatchIdsForReadInput(useBatchIdsForReadInput: boolean): RollupMetricMapReduceJob;
  ...
  withInclude(include: string | null): RollupMetricMapReduceJob;

  /**
   * The filter used to select the objs for the job.
   */
  readonly filter: string;
  withFilter(filter: string): RollupMetricMapReduceJob;
  ...
  withOrder(order: string | null): RollupMetricMapReduceJob;
  ...
  withLimit(limit: number | null): RollupMetricMapReduceJob;
  ...
  withSamplePct(samplePct: number | null): RollupMetricMapReduceJob;
  ...
  withBatchSize(batchSize: number | null): RollupMetricMapReduceJob;
  ...
  withSubBatchSize(subBatchSize: number | null): RollupMetricMapReduceJob;
  ...
  withNumBatches(numBatches: number | null): RollupMetricMapReduceJob;
  ...
  withAbortOnError(abortOnError: boolean): RollupMetricMapReduceJob;
  ...
  withTypeIdent(typeIdent: string | null): RollupMetricMapReduceJob;
   ...
   */
  readonly id: string;
  withId(id: string): RollupMetricMapReduceJob;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): RollupMetricMapReduceJob;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): RollupMetricMapReduceJob;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): RollupMetricMapReduceJob;
  ...
  withVersion(version: number | null): RollupMetricMapReduceJob;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): RollupMetricMapReduceJob;

  /**
   * Optional target type instance to be used as the filter for the job.  When specified, the {~link map} function will
   * only be called for that obj.
   */
  readonly targetFilter?: T;
  withTargetFilter(targetFilter: T | null): RollupMetricMapReduceJob;

  /**
   * The existing cache {@link RollupMetricPersistedResult} to save the results of the map job .
   */
  readonly caches?: Array_Type<RollupMetricPersistedResult>;
  withCaches(caches: Array_Type<RollupMetricPersistedResult> | Array<IRollupMetricPersistedResult> | null): RollupMetricMapReduceJob;

  /**
   * Can be any of the values valid for {@link RollupMetricSpec#rollupFunc}.
   */
  readonly rollupFunc: string;
  withRollupFunc(rollupFunc: string): RollupMetricMapReduceJob;

  /**
   * The expressions that will be rolled up in the Job.
   */
  readonly metrics: Array_Type<string>;
  withMetrics(metrics: Array_Type<string> | Array<string>): RollupMetricMapReduceJob;

  /**
   * The {@link RollupMetricSpec#start} to use.
   */
  readonly startDate: DateTime;
  withStartDate(startDate: DateTime | Date | string): RollupMetricMapReduceJob;

  /**
   * The {@link RollupMetricSpec#end} to use.
   */
  readonly endDate: DateTime;
  withEndDate(endDate: DateTime | Date | string): RollupMetricMapReduceJob;

  /**
   * The {@link RollupMetricSpec#interval} to use.
   */
  readonly interval: string;
  withInterval(interval: string): RollupMetricMapReduceJob;

  /**
   * The {@link RollupMetricSpec#timeZone} to use.
   */
  readonly timeZone?: string;
  withTimeZone(timeZone: string | null): RollupMetricMapReduceJob;
   ...
   * @see #toJson
   */
  static fromJson(json: any): RollupMetricMapReduceJob<T> | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): RollupMetricMapReduceJob<T> | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): RollupMetricMapReduceJob<T> | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): RollupMetricMapReduceJob<T> | null;
   ...
   */
  replaceType(old: Type, new_: Type): RollupMetricMapReduceJob<T>;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): RollupMetricMapReduceJob<T>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): RollupMetricMapReduceJob<T>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<RollupMetricMapReduceJob<T>>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<RollupMetricMapReduceJob<T>>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): RollupMetricMapReduceJob<T>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): RollupMetricMapReduceJob<T>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): RollupMetricMapReduceJob<T>;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): RollupMetricMapReduceJob<T>;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): RollupMetricMapReduceJob<T>;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): RollupMetricMapReduceJob<T>;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): RollupMetricMapReduceJob<T>;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): RollupMetricMapReduceJob<T>;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): RollupMetricMapReduceJob<T>;
   ...
   * @see #removeField
   */
  withoutField(field: string): RollupMetricMapReduceJob<T>;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): RollupMetricMapReduceJob<T>;
   ...
   */
  withoutFields(fields: Array_Type<string>): RollupMetricMapReduceJob<T>;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): RollupMetricMapReduceJob<T>;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): RollupMetricMapReduceJob<T>;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): RollupMetricMapReduceJob<T>;
   ...
   * @see #unsetField
   */
  defaultField(field: string): RollupMetricMapReduceJob<T>;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): RollupMetricMapReduceJob<T>;
   ...
   * @see #removeField
   */
  unsetField(field: string): RollupMetricMapReduceJob<T>;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): RollupMetricMapReduceJob<T>;
   ...
   * @see #unsetField
   */
  removeField(field: string): RollupMetricMapReduceJob<T>;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): RollupMetricMapReduceJob<T>;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): RollupMetricMapReduceJob<T>;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): RollupMetricMapReduceJob<T>;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): RollupMetricMapReduceJob<T>;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): RollupMetricMapReduceJob<T>;

  mergeJson(json: any): RollupMetricMapReduceJob<T>;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): RollupMetricMapReduceJob<T>;
   ...
   */
  sumObj(other: Obj, deep?: boolean): RollupMetricMapReduceJob<T>;
   ...
   */
  singletonArray(): Array_Type<RollupMetricMapReduceJob<T>>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<RollupMetricMapReduceJob<T>> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<RollupMetricMapReduceJob<T>> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<RollupMetricMapReduceJob<T>>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<RollupMetricMapReduceJob<T>> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, RollupMetricMapReduceJob<T>> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, RollupMetricMapReduceJob<T>> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<RollupMetricMapReduceJob<T>>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<RollupMetricMapReduceJob<T>>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): RollupMetricMapReduceJob<T>;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): RollupMetricMapReduceJob<T>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): RollupMetricMapReduceJob<T>;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): RollupMetricMapReduceJob<T>;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): RollupMetricMapReduceJob<T>;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): RollupMetricMapReduceJob<T>;
   ...
   * @see #fromString
   */
  static make(s: string): RollupMetricMapReduceJob<T> | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): RollupMetricMapReduceJob<T>;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): RollupMetricMapReduceJob<T>;
   ...
   */
  static cachedEmptyInst(): RollupMetricMapReduceJob<T>;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<RollupMetricMapReduceJob<T>> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): RollupMetricMapReduceJob<T>;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<RollupMetricMapReduceJob<T>>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<RollupMetricMapReduceJob<T>>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<RollupMetricMapReduceJob<T>> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<RollupMetricMapReduceJob<T>>> | null;
   ...
   */
  get(include?: string): RollupMetricMapReduceJob<T> | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): RollupMetricMapReduceJob<T> | null;
   ...
   */
  getMissing(spec: GetMissingSpec): RollupMetricMapReduceJob<T>;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): RollupMetricMapReduceJob<T> | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): RollupMetricMapReduceJob<T>;
   ...
   * @see #toString
   */
  static fromString(s: string): RollupMetricMapReduceJob<T> | null;
   ...
   */
  create(spec?: UpsertSpec): RollupMetricMapReduceJob<T> | null;
   ...
   */
  static createBatch(objs: Array_Type<RollupMetricMapReduceJob<T>>, spec?: UpsertSpec): ObjList<RollupMetricMapReduceJob<T>> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<RollupMetricMapReduceJob<T>>, spec?: CreateBatchObjStreamSpec): ObjList<RollupMetricMapReduceJob<T>> | null;
   ...
   */
  update(srcObj?: RollupMetricMapReduceJob<T>, spec?: UpsertSpec): RollupMetricMapReduceJob<T> | null;
   ...
   */
  upsert(srcObj?: RollupMetricMapReduceJob<T>, spec?: UpsertSpec): RollupMetricMapReduceJob<T> | null;
   ...
   */
  merge(spec?: MergeSpec): RollupMetricMapReduceJob<T> | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): RollupMetricMapReduceJob<T> | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): RollupMetricMapReduceJob<T> | null;
   ...
   */
  static updateBatch(objs: Array_Type<RollupMetricMapReduceJob<T>>, srcObjs?: Array_Type<RollupMetricMapReduceJob<T>>, spec?: UpsertSpec): ObjList<RollupMetricMapReduceJob<T>> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<RollupMetricMapReduceJob<T>> | null>, spec?: UpsertSpec): ObjList<RollupMetricMapReduceJob<T>> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<RollupMetricMapReduceJob<T>>, srcObjs?: Array_Type<RollupMetricMapReduceJob<T>>, spec?: UpsertSpec): ObjList<RollupMetricMapReduceJob<T>> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<RollupMetricMapReduceJob<T>> | null>, spec?: UpsertSpec): ObjList<RollupMetricMapReduceJob<T>> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<RollupMetricMapReduceJob<T>>, spec?: TouchSpec): ObjList<RollupMetricMapReduceJob<T>> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<RollupMetricMapReduceJob<T>>, spec?: MergeSpec): ObjList<RollupMetricMapReduceJob<T>> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<RollupMetricMapReduceJob<T>>, mergeInclude: string, spec?: MergeSpec): ObjList<RollupMetricMapReduceJob<T>> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<RollupMetricMapReduceJob<T>> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<RollupMetricMapReduceJob<T>> | null;
   ...
   */
  static mergeAll(mergeObj: RollupMetricMapReduceJob<T>, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: RollupMetricMapReduceJob<T>, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<RollupMetricMapReduceJob<T>>, spec?: UpsertSpec): ObjList<RollupMetricMapReduceJob<T>> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<RollupMetricMapReduceJob<T>>, spec?: UpsertSpec): ObjList<RollupMetricMapReduceJob<T>> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): RollupMetricMapReduceJob<T> | null;
   ...
   */
  static beforeCreate(objs: Array_Type<RollupMetricMapReduceJob<T>>): ObjList<RollupMetricMapReduceJob<T>>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<RollupMetricMapReduceJob<T>>): ObjList<RollupMetricMapReduceJob<T>>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<RollupMetricMapReduceJob<T>>): ObjList<RollupMetricMapReduceJob<T>>;
   ...
   */
  static afterCreate(objs: Array_Type<RollupMetricMapReduceJob<T>>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<RollupMetricMapReduceJob<T>>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<RollupMetricMapReduceJob<T>>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<RollupMetricMapReduceJob<T>>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<RollupMetricMapReduceJob<T>>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): RollupMetricMapReduceJob<T> | null;
   ...
   */
  withoutIdentity(): RollupMetricMapReduceJob<T> | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<RollupMetricMapReduceJob<T>>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: RollupMetricMapReduceJob<T>, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<RollupMetricMapReduceJob<T>>, callback?: λFunction<RollupMetricMapReduceJob<T> | null, RollupMetricMapReduceJob<T> | null>): ObjList<RollupMetricMapReduceJob<T>>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<RollupMetricMapReduceJob<T>>, callback?: λFunction<RollupMetricMapReduceJob<T> | null, RollupMetricMapReduceJob<T> | null>): Array_Type<ObjError> | null;
   ...
   */
  static map(batch?: number, objs?: Array_Type<T>, job?: MapReduce<T, string, RollupMetricMapReduceInterValue, Timeseries<double>>, subBatch?: number): Map_Type<string, RollupMetricMapReduceInterValue> | null;
   ...
   */
  static reduce(outKey?: string, interValues?: Array_Type<RollupMetricMapReduceInterValue>, job?: MapReduce<T, string, RollupMetricMapReduceInterValue, Timeseries<double>>): Timeseries<number> | Array_Type<Timeseries<number>> | null;
   ...
   */
  static mapCompleted(job?: MapReduce<T, string, RollupMetricMapReduceInterValue, Timeseries<double>>): void;
   ...
   *    The instance of {@link RollupMetricMapReduceJob}.
   */
  static completed(job?: MapReduce<T, string, RollupMetricMapReduceInterValue, Timeseries<double>>): string | null;
   ...
   */
  static failed(job: MapReduce<T, string, RollupMetricMapReduceInterValue, Timeseries<double>>, status: MapReduceStatus, options?: MapReduceOptions): void;
   ...
   */
  results(limit?: number = '10000'): Map_Type<string, Timeseries<number> | Array_Type<Timeseries<number>>> | null;
   ...
   */
  static rollupSum(spec: RollupSumSpec): Timeseries<any> | null;
   ...
   */
  static rollupSumOfSquares(sourceType: string, ids: Array_Type<string>, job: RollupMetricMapReduceJob<any>): Timeseries<any> | null;
   ...
   */
  static rollupSumWithCount(sourceType: string, ids: Array_Type<string>, job: RollupMetricMapReduceJob<any>): Map_Type<string, Timeseries<any>> | null;
   ...
   */
  static aggregate(metric1: Timeseries<any>, metric2: Timeseries<any>, aggregationFunction: string): void;
   ...
   */
  static safeDivide(numeratorTs: Timeseries<any>, denominatorTs: Timeseries<any>): Timeseries<any> | null;
}
