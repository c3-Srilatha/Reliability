// TypeScript definitions for the C3 type RollupMetricCacheConfig

/**
 * Type for configuring how data is cached / retrieved using
 * {@link RollupMetricPersistedResult}.
 *
 * @remarks this represents a value passed to a method that expects an instance of RollupMetricCacheConfig
 */
declare interface IRollupMetricCacheConfig {
  ...
  /**
   * **WARNING:** This is an advanced configuration option that will increase the total
   *              computation and the amount of data stored in {@link Cassandra} by a
   *              factor of `timeZones.length`. Only use this field if you are aware of
   *              your application's expected data size and data storage requirements and
   *              limits.
   *
   * All {@link TimeZone}s that should be cached when running
   * {@link RollupMetricPersistedResult#startRollupMetricBatchJobs}. A separate
   * {@link Timeseries} will be created for each {@link TimeZone} in this list.
   * If no {@link TimeZone}s are specified, metrics will be cached exclusively
   * [without a time zone](TimeZone#NONE).
   *
   * The {@link TimeZone}s to cache can be overridden for a given evaluation
   * through {@link RollupMetricStartPersistenceJobSpec#timeZones}.
   *
   * **NOTE:** {@link RollupMetricPersistedResult} is **not flexible** to treat different
   *           but equal [offset formats](TimeZone#isOffset) (e.g., `-08:00`, `GMT-08:00`,
   *           `GMT-8`) or [time zone IDs](TimeZone#isId) (e.g., `UTC`, `Zulu`, `Etc/UTC`)
   *           the same. When caching metrics with time zones, you must ensure that the
   *           time zone ID or offset format for caching and evaluation is consistent.
   */
  timeZones?: Set_Type<TimeZone> | Array<ITimeZone>;
}
 ...
 * {@link RollupMetricPersistedResult}.
 *
 * @remarks this represents a made instance of RollupMetricCacheConfig
 */
declare class RollupMetricCacheConfig extends Obj  {

  readonly configOverride?: string;
  withConfigOverride(configOverride: string | null): RollupMetricCacheConfig;

  static readonly configOverride?: string;

  readonly secretOverride?: string;
  withSecretOverride(secretOverride: string | null): RollupMetricCacheConfig;
  ...
  withIssues(issues: Array_Type<string> | Array<string> | null): RollupMetricCacheConfig;
   ...
   *           time zone ID or offset format for caching and evaluation is consistent.
   */
  readonly timeZones?: Set_Type<TimeZone>;
  withTimeZones(timeZones: Set_Type<TimeZone> | Array<ITimeZone> | null): RollupMetricCacheConfig;
   ...
   * @see #toJson
   */
  static fromJson(json: any): RollupMetricCacheConfig | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): RollupMetricCacheConfig | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): RollupMetricCacheConfig | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): RollupMetricCacheConfig | null;
   ...
   */
  replaceType(old: Type, new_: Type): RollupMetricCacheConfig;
   ...
   * This method is used during live metadata update
   */
  static replaceType(old: Type, new_: Type): RollupMetricCacheConfig;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): RollupMetricCacheConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): RollupMetricCacheConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): RollupMetricCacheConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): RollupMetricCacheConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<RollupMetricCacheConfig>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<RollupMetricCacheConfig>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<RollupMetricCacheConfig>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<RollupMetricCacheConfig>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): RollupMetricCacheConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): RollupMetricCacheConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): RollupMetricCacheConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): RollupMetricCacheConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): RollupMetricCacheConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): RollupMetricCacheConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): RollupMetricCacheConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  static validateObj(): RollupMetricCacheConfig;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): RollupMetricCacheConfig;
   ...
   * @see #defaultField
   */
  static withField(field: string, value: any, doNotConvert?: boolean): RollupMetricCacheConfig;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): RollupMetricCacheConfig;
   ...
   * @see #defaultField
   */
  static withField(field: FieldType, value: any, doNotConvert?: boolean): RollupMetricCacheConfig;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): RollupMetricCacheConfig;
   ...
   * @return new Obj
   */
  static withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): RollupMetricCacheConfig;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): RollupMetricCacheConfig;
   ...
   * @return new Obj
   */
  static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): RollupMetricCacheConfig;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): RollupMetricCacheConfig;
   ...
   * @see #withoutField
   */
  static withoutFieldAtPath(path: string): RollupMetricCacheConfig;
   ...
   * @see #removeField
   */
  withoutField(field: string): RollupMetricCacheConfig;
   ...
   * @see #removeField
   */
  static withoutField(field: string): RollupMetricCacheConfig;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): RollupMetricCacheConfig;
   ...
   * @see #removeField
   */
  static withoutField(field: FieldType): RollupMetricCacheConfig;
   ...
   */
  withoutFields(fields: Array_Type<string>): RollupMetricCacheConfig;
   ...
   * @return new Obj with removed fields
   */
  static withoutFields(fields: Array_Type<string>): RollupMetricCacheConfig;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): RollupMetricCacheConfig;
   ...
   * @return new Obj with removed fields
   */
  static withoutFieldsByType(fields: Array_Type<FieldType>): RollupMetricCacheConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): RollupMetricCacheConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  static withoutSecretFields(): RollupMetricCacheConfig;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): RollupMetricCacheConfig;
   ...
   * @see FieldType#defaultValue
   */
  static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): RollupMetricCacheConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: string): RollupMetricCacheConfig;
   ...
   * @see #unsetField
   */
  static defaultField(field: string): RollupMetricCacheConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): RollupMetricCacheConfig;
   ...
   * @see #unsetField
   */
  static defaultField(field: FieldType): RollupMetricCacheConfig;
   ...
   * @see #removeField
   */
  unsetField(field: string): RollupMetricCacheConfig;
   ...
   * @see #removeField
   */
  static unsetField(field: string): RollupMetricCacheConfig;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): RollupMetricCacheConfig;
   ...
   * @see #removeField
   */
  static unsetField(field: FieldType): RollupMetricCacheConfig;
   ...
   * @see #unsetField
   */
  removeField(field: string): RollupMetricCacheConfig;
   ...
   * @see #unsetField
   */
  static removeField(field: string): RollupMetricCacheConfig;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): RollupMetricCacheConfig;
   ...
   * @see #unsetField
   */
  static removeField(field: FieldType): RollupMetricCacheConfig;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): RollupMetricCacheConfig;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): RollupMetricCacheConfig;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): RollupMetricCacheConfig;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj, otherFieldsFilter: Type): RollupMetricCacheConfig;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): RollupMetricCacheConfig;
   ...
   *        the same key or index.
   */
  static mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): RollupMetricCacheConfig;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): RollupMetricCacheConfig;
   ...
   * traverse child reference and collection fields.
   */
  static mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): RollupMetricCacheConfig;

  mergeJson(json: any): RollupMetricCacheConfig;

  static mergeJson(json: any): RollupMetricCacheConfig;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): RollupMetricCacheConfig;
   ...
   * @return Obj with child references merged
   */
  static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): RollupMetricCacheConfig;
   ...
   */
  sumObj(other: Obj, deep?: boolean): RollupMetricCacheConfig;
   ...
   * references with same name and collection elements at same index or key.
   */
  static sumObj(other: Obj, deep?: boolean): RollupMetricCacheConfig;
   ...
   */
  singletonArray(): Array_Type<RollupMetricCacheConfig>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonArray(): Array_Type<RollupMetricCacheConfig>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<RollupMetricCacheConfig> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<RollupMetricCacheConfig> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<RollupMetricCacheConfig>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonSet(): Set_Type<RollupMetricCacheConfig>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<RollupMetricCacheConfig> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, RollupMetricCacheConfig> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, RollupMetricCacheConfig> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<RollupMetricCacheConfig>;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  static toBuilder(): ObjBuilder<RollupMetricCacheConfig>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<RollupMetricCacheConfig>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): RollupMetricCacheConfig;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): RollupMetricCacheConfig;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): RollupMetricCacheConfig;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): RollupMetricCacheConfig;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): RollupMetricCacheConfig;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): RollupMetricCacheConfig;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): RollupMetricCacheConfig;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): RollupMetricCacheConfig;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  static afterMake(): RollupMetricCacheConfig;
   ...
   */
  static cachedEmptyInst(): RollupMetricCacheConfig;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<RollupMetricCacheConfig> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): RollupMetricCacheConfig;
   ...
   */
  static allCached(): Stream<RollupMetricCacheConfig> | null;
   ...
   */
  static find(filter?: string): Stream<RollupMetricCacheConfig> | null;
   ...
   *         Otherwise no population will be performed.
   */
  static findBy(field: string, value: any): Stream<RollupMetricCacheConfig> | null;

  /**
   * @return cached instance.
   */
  getCached(): RollupMetricCacheConfig | null;

  /**
   * @return cached instance.
   */
  static getCached(): RollupMetricCacheConfig | null;

  /**
   * Returns cached instance by key, with secrets removed.
   */
  static forCacheKey(key: string): RollupMetricCacheConfig | null;
   ...
   */
  static produce(key: string): RollupMetricCacheConfig | null;

  /**
   * Should produces the entire content for the cached data. Will populate the cache with the produced data.
   */
  static produceAll(): Map_Type<string, RollupMetricCacheConfig> | null;
   ...
   */
  getConfig(): RollupMetricCacheConfig;
   ...
   * Note that typical pattern is to use Configurable#config instead of this method.
   */
  static getConfig(): RollupMetricCacheConfig;
   ...
   */
  getSecret(): RollupMetricCacheConfig;
   ...
   * Note that typical pattern is to use Configurable#configWithSecrets instead of this method.
   */
  static getSecret(): RollupMetricCacheConfig;
   ...
   */
  withConfigKey(configKey: string): RollupMetricCacheConfig;
   ...
   *     config.configKey() => "folder1/abc"
   */
  static withConfigKey(configKey: string): RollupMetricCacheConfig;

  /**
   * @return copy without config key.
   */
  withoutConfigKey(): RollupMetricCacheConfig;

  /**
   * @return copy without config key.
   */
  static withoutConfigKey(): RollupMetricCacheConfig;

  /**
   * @return return cached config instance for provided config key.
   */
  static forConfigKey(configKey: string): RollupMetricCacheConfig | null;
   ...
   */
  static listConfigs(parallel?: boolean, filter?: λPredicate<string>): Stream<RollupMetricCacheConfig> | null;
   ...
   * @see setConfigValue
   */
  setConfigValues(from: RollupMetricCacheConfig, override?: string): void;
   ...
   * @see setConfigValue
   */
  static setConfigValues(from: RollupMetricCacheConfig, override?: string): void;
   ...
   */
  static loadConfigAndSecret(configKey: string): RollupMetricCacheConfig | null;
   ...
   */
  removeSecrets(): RollupMetricCacheConfig | null;

  /**
   * @return this config without any secret values.
   */
  static removeSecrets(): RollupMetricCacheConfig | null;

  /**
   * @return this config with only secret values.
   */
  removeNonSecrets(): RollupMetricCacheConfig | null;

  /**
   * @return this config with only secret values.
   */
  static removeNonSecrets(): RollupMetricCacheConfig | null;

  /**
   * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
   * validation and setup.
   */
  validate(): RollupMetricCacheConfig;

  /**
   * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
   * validation and setup.
   */
  static validate(): RollupMetricCacheConfig;
