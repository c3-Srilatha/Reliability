// TypeScript definitions for the C3 type LoaderList

/**
 * @remarks this represents a value passed to a method that expects an instance of LoaderList
 */
declare interface ILoaderList {
 ...
 */
declare class LoaderList extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): LoaderList | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): LoaderList | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): LoaderList | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): LoaderList | null;
   ...
   */
  replaceType(old: Type, new_: Type): LoaderList;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): LoaderList;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): LoaderList;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<LoaderList | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<LoaderList | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): LoaderList;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): LoaderList;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): LoaderList;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): LoaderList;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): LoaderList;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): LoaderList;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): LoaderList;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): LoaderList;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): LoaderList;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): LoaderList;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): LoaderList;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): LoaderList;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): LoaderList;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): LoaderList;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): LoaderList;
   ...
   * @see #unsetField
   */
  defaultField(field: string): LoaderList;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): LoaderList;
   ...
   * @see #removeField
   */
  unsetField(field: string): LoaderList;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): LoaderList;
   ...
   * @see #unsetField
   */
  removeField(field: string): LoaderList;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): LoaderList;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): LoaderList;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): LoaderList;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): LoaderList;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): LoaderList;

  mergeJson(json: any | null): LoaderList;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): LoaderList;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): LoaderList;
   ...
   */
  singletonArray(): C3.Array<LoaderList | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<LoaderList | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<LoaderList | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<LoaderList | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<LoaderList | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, LoaderList | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, LoaderList | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<LoaderList | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<LoaderList | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): LoaderList;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): LoaderList;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): LoaderList;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): LoaderList;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): LoaderList;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): LoaderList;
   ...
   * @see #fromString
   */
  static make(s: string | null): LoaderList | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): LoaderList;
   ...
   */
  static cachedEmptyInst(): LoaderList;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<LoaderList>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): LoaderList;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<LoaderList | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<LoaderList | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<LoaderList | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<LoaderList | null> | null>;
   ...
   */
  dependencies(): MetadataDeps<LoaderList | null>;

  save(subPath?: string | null, contentType?: string | null): LoaderList;
  ...
  update(srcObj?: LoaderList | null, spec?: UpsertSpec | null): LoaderList | null;

  upsert(srcObj?: LoaderList | null, spec?: UpsertSpec | null): LoaderList | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): LoaderList | null;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string | null, failIfMissing?: boolean): LoaderList | null;
   ...
   */
  static doDataMerge(componentId: string, dataSpecFieldName: string, dataDestinationFieldName: string, props: LoaderList, state: UiSdlReduxState): LoaderList | null;
