// TypeScript definitions for the C3 type LoaderListReact

/**
 * @remarks this represents a value passed to a method that expects an instance of LoaderListReact
 */
declare interface ILoaderListReact {
 ...
 */
declare class LoaderListReact extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): LoaderListReact | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): LoaderListReact | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): LoaderListReact | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): LoaderListReact | null;
   ...
   */
  replaceType(old: Type, new_: Type): LoaderListReact;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): LoaderListReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): LoaderListReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<LoaderListReact | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<LoaderListReact | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): LoaderListReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): LoaderListReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): LoaderListReact;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): LoaderListReact;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): LoaderListReact;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): LoaderListReact;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): LoaderListReact;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): LoaderListReact;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): LoaderListReact;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): LoaderListReact;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): LoaderListReact;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): LoaderListReact;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): LoaderListReact;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): LoaderListReact;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): LoaderListReact;
   ...
   * @see #unsetField
   */
  defaultField(field: string): LoaderListReact;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): LoaderListReact;
   ...
   * @see #removeField
   */
  unsetField(field: string): LoaderListReact;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): LoaderListReact;
   ...
   * @see #unsetField
   */
  removeField(field: string): LoaderListReact;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): LoaderListReact;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): LoaderListReact;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): LoaderListReact;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): LoaderListReact;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): LoaderListReact;

  mergeJson(json: any | null): LoaderListReact;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): LoaderListReact;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): LoaderListReact;
   ...
   */
  singletonArray(): C3.Array<LoaderListReact | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<LoaderListReact | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<LoaderListReact | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<LoaderListReact | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<LoaderListReact | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, LoaderListReact | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, LoaderListReact | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<LoaderListReact | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<LoaderListReact | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): LoaderListReact;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): LoaderListReact;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): LoaderListReact;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): LoaderListReact;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): LoaderListReact;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): LoaderListReact;
   ...
   * @see #fromString
   */
  static make(s: string | null): LoaderListReact | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): LoaderListReact;
   ...
   */
  static cachedEmptyInst(): LoaderListReact;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<LoaderListReact>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): LoaderListReact;
   ...
   */
  static render(props?: LoaderListReact | null): void;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<LoaderListReact | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<LoaderListReact | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<LoaderListReact | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<LoaderListReact | null> | null>;
   ...
   */
  dependencies(): MetadataDeps<LoaderListReact | null>;

  save(subPath?: string | null, contentType?: string | null): LoaderListReact;
  ...
  update(srcObj?: LoaderListReact | null, spec?: UpsertSpec | null): LoaderListReact | null;

  upsert(srcObj?: LoaderListReact | null, spec?: UpsertSpec | null): LoaderListReact | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): LoaderListReact | null;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string | null, failIfMissing?: boolean): LoaderListReact | null;
   ...
   */
  static doDataMerge(componentId: string, dataSpecFieldName: string, dataDestinationFieldName: string, props: LoaderListReact, state: UiSdlReduxState): LoaderListReact | null;
