...
from c3.dataDiagnostics.DataTagSubject import DataTagSubject
...
# Python definitions for the C3 type DataTagSubject

DT = TypeVar('DT')
DTR = TypeVar('DTR')

class DataTagSubject(Generic[DT, DTR], FeatureEvaluatable, DataTagSubjectBase[DTR]):
    """
    Type that gets mixed into an entity type in order to be able to tag it with
    {@link DataTag}s. Should be used with parametric extensions of {@link DataTag}.
    
    @remarks this represents a made instance of DataTagSubject
    """
    
    dataTagRelations: Optional[Array[DTR]]=None
    """
    The data tags related to this type.
    """

    directDataTags: Optional[Array[DT]]=None
    """
    ...
    """
    def __init__(self, dataTagRelations: Optional[Array[DTR]]=None, directDataTags: Optional[Array[DT]]=None, dataTags: Optional[Array[str]]=None) -> None: ...
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[DataTagSubject[DTR, DT]]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[DataTagSubject[DTR, DT]]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[DataTagSubject[DTR, DT]]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[DataTagSubject[DTR, DT]]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> DataTagSubject[DTR, DT]:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> DataTagSubject[DTR, DT]:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> DataTagSubject[DTR, DT]:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[DataTagSubject[DTR, DT]]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[DataTagSubject[DTR, DT]]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> DataTagSubject[DTR, DT]:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> DataTagSubject[DTR, DT]:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> DataTagSubject[DTR, DT]:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> DataTagSubject[DTR, DT]:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> DataTagSubject[DTR, DT]:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> DataTagSubject[DTR, DT]:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> DataTagSubject[DTR, DT]:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> DataTagSubject[DTR, DT]:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> DataTagSubject[DTR, DT]:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> DataTagSubject[DTR, DT]:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> DataTagSubject[DTR, DT]:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> DataTagSubject[DTR, DT]:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> DataTagSubject[DTR, DT]:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> DataTagSubject[DTR, DT]:
    """
    @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> DataTagSubject[DTR, DT]:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> DataTagSubject[DTR, DT]:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> DataTagSubject[DTR, DT]:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> DataTagSubject[DTR, DT]:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> DataTagSubject[DTR, DT]:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> DataTagSubject[DTR, DT]:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> DataTagSubject[DTR, DT]:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> DataTagSubject[DTR, DT]:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> DataTagSubject[DTR, DT]:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> DataTagSubject[DTR, DT]:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> DataTagSubject[DTR, DT]:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> DataTagSubject[DTR, DT]:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> DataTagSubject[DTR, DT]:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> DataTagSubject[DTR, DT]:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[DataTagSubject[DTR, DT]]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[DataTagSubject[DTR, DT]]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[DataTagSubject[DTR, DT]]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[DataTagSubject[DTR, DT]]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[DataTagSubject[DTR, DT]]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, DataTagSubject[DTR, DT]]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, DataTagSubject[DTR, DT]]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[DataTagSubject[DTR, DT]]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[DataTagSubject[DTR, DT]]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> DataTagSubject[DTR, DT]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> DataTagSubject[DTR, DT]:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> DataTagSubject[DTR, DT]:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> DataTagSubject[DTR, DT]:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> DataTagSubject[DTR, DT]:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> DataTagSubject[DTR, DT]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> DataTagSubject[DTR, DT]:
    """
    ...
    """
        ...
    def afterMake(self) -> DataTagSubject[DTR, DT]:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> DataTagSubject[DTR, DT]:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[DataTagSubject[DTR, DT]]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> DataTagSubject[DTR, DT]:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, spec: FetchSpec=None) -> FetchResult[DataTagSubject[DTR, DT]]:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, filter: Filter) -> FetchResult[DataTagSubject[DTR, DT]]:
    """
    ...
    """
        ...
    @classmethod
    def fetchObjStream(cls, spec: FetchStreamSpec=None) -> Union[Stream[DataTagSubject[DTR, DT]]]:
    """
    Fetches multiple obj instances based on a specification.  Only objs that the caller is authorized to fetch will be
    returned.
    ...
    """
        ...
    @classmethod
    def fetchMultiLocale(cls, spec: MultiLocaleFetchSpec=None) -> Union[Map[str, FetchResult[DataTagSubject[DTR, DT]]]]:
    """
    ...
    @overload
    @classmethod
    def evalFeatureSetBatch(cls, batch: Array[DataTagSubject[DTR, DT]], featureSet: Feature.Set, spec: EvalFeatureSpec=None) -> Union[Data]:
    """
    ...
    @overload
    @classmethod
    def evalFeaturesBatch(cls, batch: Array[DataTagSubject[DTR, DT]], features: Array[str], spec: EvalFeaturesSpec=None) -> Union[Data]:
    """
