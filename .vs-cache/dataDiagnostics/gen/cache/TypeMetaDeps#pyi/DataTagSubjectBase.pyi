...
from c3.dataDiagnostics.DataTagSubjectBase import DataTagSubjectBase
...
# Python definitions for the C3 type DataTagSubjectBase

DTRB = TypeVar('DTRB')

class DataTagSubjectBase(Generic[DTRB], FeatureEvaluatable):
    """
    Type that gets mixed into an entity type in order to be able to tag it with
    {@link DataTagBase} instances. Should be used purely with {@link DataTagBase} and
    {@link DataTagRelationBase}.
    
    @remarks this represents a made instance of DataTagSubjectBase
    """
    
    dataTagRelations: Optional[Array[DTRB]]=None
    """
    The data tags related to this type.
    """
    def __init__(self, dataTagRelations: Optional[Array[DTRB]]=None) -> None: ...
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[DataTagSubjectBase[DTRB]]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[DataTagSubjectBase[DTRB]]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[DataTagSubjectBase[DTRB]]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[DataTagSubjectBase[DTRB]]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> DataTagSubjectBase[DTRB]:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> DataTagSubjectBase[DTRB]:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> DataTagSubjectBase[DTRB]:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[DataTagSubjectBase[DTRB]]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[DataTagSubjectBase[DTRB]]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> DataTagSubjectBase[DTRB]:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> DataTagSubjectBase[DTRB]:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> DataTagSubjectBase[DTRB]:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> DataTagSubjectBase[DTRB]:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> DataTagSubjectBase[DTRB]:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> DataTagSubjectBase[DTRB]:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> DataTagSubjectBase[DTRB]:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> DataTagSubjectBase[DTRB]:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> DataTagSubjectBase[DTRB]:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> DataTagSubjectBase[DTRB]:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> DataTagSubjectBase[DTRB]:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> DataTagSubjectBase[DTRB]:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> DataTagSubjectBase[DTRB]:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> DataTagSubjectBase[DTRB]:
    """
    @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> DataTagSubjectBase[DTRB]:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> DataTagSubjectBase[DTRB]:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> DataTagSubjectBase[DTRB]:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> DataTagSubjectBase[DTRB]:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> DataTagSubjectBase[DTRB]:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> DataTagSubjectBase[DTRB]:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> DataTagSubjectBase[DTRB]:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> DataTagSubjectBase[DTRB]:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> DataTagSubjectBase[DTRB]:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> DataTagSubjectBase[DTRB]:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> DataTagSubjectBase[DTRB]:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> DataTagSubjectBase[DTRB]:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> DataTagSubjectBase[DTRB]:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> DataTagSubjectBase[DTRB]:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[DataTagSubjectBase[DTRB]]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[DataTagSubjectBase[DTRB]]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[DataTagSubjectBase[DTRB]]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[DataTagSubjectBase[DTRB]]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[DataTagSubjectBase[DTRB]]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, DataTagSubjectBase[DTRB]]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, DataTagSubjectBase[DTRB]]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[DataTagSubjectBase[DTRB]]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[DataTagSubjectBase[DTRB]]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> DataTagSubjectBase[DTRB]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> DataTagSubjectBase[DTRB]:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> DataTagSubjectBase[DTRB]:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> DataTagSubjectBase[DTRB]:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> DataTagSubjectBase[DTRB]:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> DataTagSubjectBase[DTRB]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> DataTagSubjectBase[DTRB]:
    """
    ...
    """
        ...
    def afterMake(self) -> DataTagSubjectBase[DTRB]:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> DataTagSubjectBase[DTRB]:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[DataTagSubjectBase[DTRB]]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> DataTagSubjectBase[DTRB]:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, spec: FetchSpec=None) -> FetchResult[DataTagSubjectBase[DTRB]]:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, filter: Filter) -> FetchResult[DataTagSubjectBase[DTRB]]:
    """
    ...
    """
        ...
    @classmethod
    def fetchObjStream(cls, spec: FetchStreamSpec=None) -> Union[Stream[DataTagSubjectBase[DTRB]]]:
    """
    Fetches multiple obj instances based on a specification.  Only objs that the caller is authorized to fetch will be
    returned.
    ...
    """
        ...
    @classmethod
    def fetchMultiLocale(cls, spec: MultiLocaleFetchSpec=None) -> Union[Map[str, FetchResult[DataTagSubjectBase[DTRB]]]]:
    """
    ...
    @overload
    @classmethod
    def evalFeatureSetBatch(cls, batch: Array[DataTagSubjectBase[DTRB]], featureSet: Feature.Set, spec: EvalFeatureSpec=None) -> Union[Data]:
    """
    ...
    @overload
    @classmethod
    def evalFeaturesBatch(cls, batch: Array[DataTagSubjectBase[DTRB]], features: Array[str], spec: EvalFeaturesSpec=None) -> Union[Data]:
    """
