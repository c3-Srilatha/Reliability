...
# Python definitions for the C3 type PopulateDataTagsBatchJobConfig


class PopulateDataTagsBatchJobConfig(Config, Singleton):
    """
    ...
    batchAllScanningExpressions: Optional[bool]=None
    """
    ...
    scanningExpressionsBatchSize: Optional[int]=None
    """
    ...
    """
    def __init__(self, configOverride: Optional[str]=None, secretOverride: Optional[str]=None, issues: Optional[Array[str]]=None, batchAllScanningExpressions: Optional[bool]=None, scanningExpressionsBatchSize: Optional[int]=None, persistTagCountsAfterJob: Optional[bool]=None, persistEnabledTagCountsOnly: Optional[bool]=None, persistTagCountsAsynchronously: Optional[bool]=None) -> None: ...
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[PopulateDataTagsBatchJobConfig]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[PopulateDataTagsBatchJobConfig]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[PopulateDataTagsBatchJobConfig]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[PopulateDataTagsBatchJobConfig]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> PopulateDataTagsBatchJobConfig:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> PopulateDataTagsBatchJobConfig:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> PopulateDataTagsBatchJobConfig:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[PopulateDataTagsBatchJobConfig]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[PopulateDataTagsBatchJobConfig]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> PopulateDataTagsBatchJobConfig:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> PopulateDataTagsBatchJobConfig:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> PopulateDataTagsBatchJobConfig:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> PopulateDataTagsBatchJobConfig:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> PopulateDataTagsBatchJobConfig:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> PopulateDataTagsBatchJobConfig:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> PopulateDataTagsBatchJobConfig:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> PopulateDataTagsBatchJobConfig:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> PopulateDataTagsBatchJobConfig:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> PopulateDataTagsBatchJobConfig:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> PopulateDataTagsBatchJobConfig:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> PopulateDataTagsBatchJobConfig:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> PopulateDataTagsBatchJobConfig:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> PopulateDataTagsBatchJobConfig:
    """
    @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> PopulateDataTagsBatchJobConfig:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> PopulateDataTagsBatchJobConfig:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> PopulateDataTagsBatchJobConfig:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> PopulateDataTagsBatchJobConfig:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> PopulateDataTagsBatchJobConfig:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> PopulateDataTagsBatchJobConfig:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> PopulateDataTagsBatchJobConfig:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> PopulateDataTagsBatchJobConfig:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> PopulateDataTagsBatchJobConfig:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> PopulateDataTagsBatchJobConfig:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> PopulateDataTagsBatchJobConfig:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> PopulateDataTagsBatchJobConfig:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> PopulateDataTagsBatchJobConfig:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> PopulateDataTagsBatchJobConfig:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[PopulateDataTagsBatchJobConfig]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[PopulateDataTagsBatchJobConfig]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[PopulateDataTagsBatchJobConfig]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[PopulateDataTagsBatchJobConfig]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[PopulateDataTagsBatchJobConfig]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, PopulateDataTagsBatchJobConfig]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, PopulateDataTagsBatchJobConfig]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[PopulateDataTagsBatchJobConfig]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[PopulateDataTagsBatchJobConfig]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> PopulateDataTagsBatchJobConfig:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> PopulateDataTagsBatchJobConfig:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> PopulateDataTagsBatchJobConfig:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> PopulateDataTagsBatchJobConfig:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> PopulateDataTagsBatchJobConfig:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> PopulateDataTagsBatchJobConfig:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> PopulateDataTagsBatchJobConfig:
    """
    ...
    """
        ...
    def afterMake(self) -> PopulateDataTagsBatchJobConfig:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> PopulateDataTagsBatchJobConfig:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[PopulateDataTagsBatchJobConfig]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> PopulateDataTagsBatchJobConfig:
    """
    ...
    """
        ...
    @classmethod
    def allCached(cls) -> Union[Stream[PopulateDataTagsBatchJobConfig]]:
    """
    @return stream of all available Cached instances.
    """
        ...
    @classmethod
    def find(cls, filter: str=None) -> Union[Stream[PopulateDataTagsBatchJobConfig]]:
    """
    ...
    """
        ...
    @classmethod
    def findBy(cls, field: str, value: Any) -> Union[Stream[PopulateDataTagsBatchJobConfig]]:
    """
    @return existing instances of this type that satisfy filter from data cache. Will call `produceAll`
            if cache is empty or if Ann.cache.all is true & data has not previously been fetched.
            Otherwise no population will be performed.
    """
        ...
    def getCached(self) -> Union[PopulateDataTagsBatchJobConfig]:
    """
    @return cached instance.
    """
        ...
    @classmethod
    def forCacheKey(cls, key: str) -> Union[PopulateDataTagsBatchJobConfig]:
    """
    ...
    """
        ...
    @classmethod
    def produce(cls, key: str) -> Union[PopulateDataTagsBatchJobConfig]:
    """
    Should produce an entry for the cache key. This method should not be called directly.
    """
        ...
    @classmethod
    def produceAll(cls) -> Union[Map[str, PopulateDataTagsBatchJobConfig]]:
    """
    ...
    """
        ...
    def getConfig(self) -> PopulateDataTagsBatchJobConfig:
    """
    ...
    """
        ...
    def getSecret(self) -> PopulateDataTagsBatchJobConfig:
    """
    ...
    """
        ...
    def withConfigKey(self, configKey: str) -> PopulateDataTagsBatchJobConfig:
    """
    ...
    """
        ...
    def withoutConfigKey(self) -> PopulateDataTagsBatchJobConfig:
    """
    @return copy without config key.
    """
        ...
    @classmethod
    def forConfigKey(cls, configKey: str) -> Union[PopulateDataTagsBatchJobConfig]:
    """
    ...
    """
        ...
    @classmethod
    def listConfigs(cls, parallel: bool=None, filter: Callable[[str], bool]=None) -> Union[Stream[PopulateDataTagsBatchJobConfig]]:
    """
    @param
    ...
    """
        ...
    @overload
    def setConfigValues(self, from_: PopulateDataTagsBatchJobConfig, override: str=None) -> None:
    """
    ...
    """
        ...
    @classmethod
    def loadConfigAndSecret(cls, configKey: str) -> Union[PopulateDataTagsBatchJobConfig]:
    """
    ...
    """
        ...
    def removeSecrets(self) -> Union[PopulateDataTagsBatchJobConfig]:
    """
    @return this config without any secret values.
    """
        ...
    def removeNonSecrets(self) -> Union[PopulateDataTagsBatchJobConfig]:
    """
    @return this config with only secret values.
    """
        ...
    def validate(self) -> PopulateDataTagsBatchJobConfig:
    """
    ...
    """
        ...
    @classmethod
    def inst(cls) -> PopulateDataTagsBatchJobConfig:
    """
