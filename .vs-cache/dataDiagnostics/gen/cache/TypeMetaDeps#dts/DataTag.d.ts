// TypeScript definitions for the C3 type DataTag
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of DataTag
 */
declare interface IDataTag<ER> {
   ...
   */
  whiteListedEntities?: Array_Type<ER> | Array<ER>;
   ...
   */
  blackListedEntities?: Array_Type<ER> | Array<ER>;
 ...
 */
declare class DataTag<ER> extends Obj  {

  /**
   * The entities of a certain Type which this data diagnostic logic should be run on.
   * Gets "OR"ed with the filter on this data diagnostic during evaluation.
   */
  readonly whiteListedEntities?: Array_Type<ER>;
  withWhiteListedEntities(whiteListedEntities: Array_Type<ER> | Array<ER> | null): DataTag;

  /**
   * The entities of type srcType which this data diagnostic logic should not be run on.
   * Gets "AND"ed with the filter on this data diagnostic during evaluation.
   */
  readonly blackListedEntities?: Array_Type<ER>;
  withBlackListedEntities(blackListedEntities: Array_Type<ER> | Array<ER> | null): DataTag;
  ...
  withTypeIdent(typeIdent: string | null): DataTag;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): DataTag;
  ...
  withName(name: string): DataTag;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): DataTag;
  ...
  withVersion(version: number | null): DataTag;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): DataTag;

  /**
   * The entity type which this data diagnostic is running logic for.
   */
  readonly srcType: Type;
  withSrcType(srcType: IType): DataTag;

  /**
   * High level description of what this data diagnostic is doing.
   */
  readonly description?: string;
  withDescription(description: string | null): DataTag;

  /**
   * The metric expression used in the data diagnostic logic.
   */
  readonly metricExpression?: string;
  withMetricExpression(metricExpression: string | null): DataTag;
  ...
  withOverrideSimpleMetrics(overrideSimpleMetrics: Array_Type<SimpleMetric> | Array<ISimpleMetric> | null): DataTag;
  ...
  withOverrideCompoundMetrics(overrideCompoundMetrics: Array_Type<CompoundMetric> | Array<ICompoundMetric> | null): DataTag;

  /**
   * The unit used in the metric evaluation of the diagnostic logic.
   */
  readonly unit?: Unit;
  withUnit(unit: IUnit | null): DataTag;

  /**
   * Bindings to use with any metrics invoked by the metric expression.
   */
  readonly bindings?: Map_Type<string, any>;
  withBindings(bindings: Map_Type<string, any> | {[key: string]: any} | null): DataTag;

  /**
   * The {@link EvalMetricsOptions} to use when running the evalMetrics call.
   */
  readonly options?: EvalMetricsOptions;
  withOptions(options: IEvalMetricsOptions | null): DataTag;
  ...
  withRequiredBindings(requiredBindings: Array_Type<string> | Array<string> | null): DataTag;

  /**
   * Field to override bindings for specific {@link #srcType} entities.
   */
  readonly entitySpecificBindings?: Map_Type<string, OverrideBindings>;
  withEntitySpecificBindings(entitySpecificBindings: Map_Type<string, OverrideBindings> | {[key: string]: IOverrideBindings} | null): DataTag;
  ...
  withBatchConfig(batchConfig: IDataDiagnosticBatchConfig | null): DataTag;

  /**
   * {@link Interval} used for the metric evaluation.
   */
  readonly interval?: string;
  withInterval(interval: string | null): DataTag;

  /**
   * The {@link Period} of time the diagnostic runs the eval metric call on.
   */
  readonly period?: Period;
  withPeriod(period: IPeriod | null): DataTag;

  /**
   * The timezone the used in the evaluation of the metric.
   */
  readonly timeZone?: string;
  withTimeZone(timeZone: string | null): DataTag;

  /**
   * The cron job which will run this data diagnostic logic on a set schedule.
   */
  readonly cronJob?: CronJob;
  withCronJob(cronJob: ICronJob | null): DataTag;

  /**
   * A filter used to retrieve entities of type `srcType` to run the data diagnostic logic on.
   */
  readonly filter: Filter;
  withFilter(filter: IFilter): DataTag;

  /**
   * Include string to within the {@link FetchSpec} if the diagnostic is configured to perform a fetch.
   */
  readonly fetchInclude?: string;
  withFetchInclude(fetchInclude: string | null): DataTag;
  ...
  withExpression(expression: string | null): DataTag;
  ...
  withReferentialIntegrityString(referentialIntegrityString: string | null): DataTag;
  ...
  withEnabled(enabled: boolean): DataTag;

  /**
   * Lambda function that can be used to override the existing logic on a type that extends {@link DataDiagnostic}.
   */
  readonly customDiagnosticLogic?: λConsumer<any | null>;
  withCustomDiagnosticLogic(customDiagnosticLogic: λConsumer<any | null> | null): DataTag;

  /**
   * The history of counts and percentages of the {@link DataTagRelation}s for this data tag.
   */
  readonly countHistory?: Array_Type<DataTagCountHistory>;
  withCountHistory(countHistory: Array_Type<DataTagCountHistory> | Array<IDataTagCountHistory> | null): DataTag;
   ...
   * @see #toJson
   */
  static fromJson(json: any): DataTag<ER> | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): DataTag<ER> | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): DataTag<ER> | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): DataTag<ER> | null;
   ...
   */
  replaceType(old: Type, new_: Type): DataTag<ER>;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): DataTag<ER>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): DataTag<ER>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<DataTag<ER>>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<DataTag<ER>>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): DataTag<ER>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DataTag<ER>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DataTag<ER>;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): DataTag<ER>;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): DataTag<ER>;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): DataTag<ER>;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): DataTag<ER>;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): DataTag<ER>;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): DataTag<ER>;
   ...
   * @see #removeField
   */
  withoutField(field: string): DataTag<ER>;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): DataTag<ER>;
   ...
   */
  withoutFields(fields: Array_Type<string>): DataTag<ER>;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): DataTag<ER>;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): DataTag<ER>;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): DataTag<ER>;
   ...
   * @see #unsetField
   */
  defaultField(field: string): DataTag<ER>;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): DataTag<ER>;
   ...
   * @see #removeField
   */
  unsetField(field: string): DataTag<ER>;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): DataTag<ER>;
   ...
   * @see #unsetField
   */
  removeField(field: string): DataTag<ER>;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): DataTag<ER>;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): DataTag<ER>;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): DataTag<ER>;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): DataTag<ER>;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): DataTag<ER>;

  mergeJson(json: any): DataTag<ER>;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): DataTag<ER>;
   ...
   */
  sumObj(other: Obj, deep?: boolean): DataTag<ER>;
   ...
   */
  singletonArray(): Array_Type<DataTag<ER>>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<DataTag<ER>> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<DataTag<ER>> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<DataTag<ER>>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<DataTag<ER>> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, DataTag<ER>> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, DataTag<ER>> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<DataTag<ER>>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<DataTag<ER>>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): DataTag<ER>;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): DataTag<ER>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): DataTag<ER>;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): DataTag<ER>;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): DataTag<ER>;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): DataTag<ER>;
   ...
   * @see #fromString
   */
  static make(s: string): DataTag<ER> | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): DataTag<ER>;
   ...
   */
  static cachedEmptyInst(): DataTag<ER>;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<DataTag<ER>> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): DataTag<ER>;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<DataTag<ER>>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<DataTag<ER>>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<DataTag<ER>> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<DataTag<ER>>> | null;
   ...
   */
  static evalFeatureSetBatch(batch: Array_Type<DataTag<ER>>, featureSet: Feature.Set, spec?: EvalFeatureSpec): Data | null;
   ...
   * ```
   */
  static evalFeaturesBatch(batch: Array_Type<DataTag<ER>>, features: Array_Type<string>, spec?: EvalFeaturesSpec): Data | null;
   ...
   */
  get(include?: string): DataTag<ER> | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): DataTag<ER> | null;
   ...
   */
  getMissing(spec: GetMissingSpec): DataTag<ER>;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): DataTag<ER> | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): DataTag<ER>;
   ...
   * @see #toString
   */
  static fromString(s: string): DataTag<ER> | null;
   ...
   */
  create(spec?: UpsertSpec): DataTag<ER> | null;
   ...
   */
  static createBatch(objs: Array_Type<DataTag<ER>>, spec?: UpsertSpec): ObjList<DataTag<ER>> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<DataTag<ER>>, spec?: CreateBatchObjStreamSpec): ObjList<DataTag<ER>> | null;
   ...
   */
  update(srcObj?: DataTag<ER>, spec?: UpsertSpec): DataTag<ER> | null;
   ...
   */
  upsert(srcObj?: DataTag<ER>, spec?: UpsertSpec): DataTag<ER> | null;
   ...
   */
  merge(spec?: MergeSpec): DataTag<ER> | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): DataTag<ER> | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): DataTag<ER> | null;
   ...
   */
  static updateBatch(objs: Array_Type<DataTag<ER>>, srcObjs?: Array_Type<DataTag<ER>>, spec?: UpsertSpec): ObjList<DataTag<ER>> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<DataTag<ER>> | null>, spec?: UpsertSpec): ObjList<DataTag<ER>> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<DataTag<ER>>, srcObjs?: Array_Type<DataTag<ER>>, spec?: UpsertSpec): ObjList<DataTag<ER>> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<DataTag<ER>> | null>, spec?: UpsertSpec): ObjList<DataTag<ER>> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<DataTag<ER>>, spec?: TouchSpec): ObjList<DataTag<ER>> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<DataTag<ER>>, spec?: MergeSpec): ObjList<DataTag<ER>> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<DataTag<ER>>, mergeInclude: string, spec?: MergeSpec): ObjList<DataTag<ER>> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<DataTag<ER>> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<DataTag<ER>> | null;
   ...
   */
  static mergeAll(mergeObj: DataTag<ER>, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: DataTag<ER>, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<DataTag<ER>>, spec?: UpsertSpec): ObjList<DataTag<ER>> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<DataTag<ER>>, spec?: UpsertSpec): ObjList<DataTag<ER>> | null;
   ...
   */
  static beforeCreate(objs: Array_Type<DataTag<ER>>): ObjList<DataTag<ER>>;
   ...
   * {@link DataDiagnostic#filter} are all valid.
   */
  static beforeUpdate(objs: Array_Type<DataTag<ER>>): ObjList<DataTag<ER>>;
   ...
   */
  static beforeRemove(objs: Array_Type<DataTag<ER>>): ObjList<DataTag<ER>>;
   ...
   */
  static afterCreate(objs: Array_Type<DataTag<ER>>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<DataTag<ER>>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<DataTag<ER>>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<DataTag<ER>>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<DataTag<ER>>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): DataTag<ER> | null;
   ...
   */
  withoutIdentity(): DataTag<ER> | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<DataTag<ER>>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: DataTag<ER>, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<DataTag<ER>>, callback?: λFunction<DataTag<ER> | null, DataTag<ER> | null>): ObjList<DataTag<ER>>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<DataTag<ER>>, callback?: λFunction<DataTag<ER> | null, DataTag<ER> | null>): Array_Type<ObjError> | null;
   ...
   */
  retrieveEvalMetricsDiagnosticData(filter?: Filter, dataVariables?: DataTag<ER>, overrideDiagnosticSpec?: DataDiagnosticOverrideSpec = '{}'): EvalMetricsResult | null;
   ...
   */
  static processNewOrUpdatedDiagnostics(objs: Array_Type<DataTag<ER>>): ObjList<DataTag<ER>>;
