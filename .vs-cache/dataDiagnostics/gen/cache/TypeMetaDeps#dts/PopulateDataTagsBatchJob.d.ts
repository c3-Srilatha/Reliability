// TypeScript definitions for the C3 type PopulateDataTagsBatchJob

/**
 * The batch job to populate data tags on a cron schedule.
 *
 * @remarks this represents a value passed to a method that expects an instance of PopulateDataTagsBatchJob
 */
declare interface IPopulateDataTagsBatchJob {
 ...
 */
declare class PopulateDataTagsBatchJob extends Obj  {

  /**
   * current or last job execution for this instance
   */
  readonly run?: BatchJobRun;
  withRun(run: IBatchJobRun | null): PopulateDataTagsBatchJob;

  /**
   * previous job executions for this instance
   */
  readonly runs?: Array_Type<BatchJobRun>;
  withRuns(runs: Array_Type<BatchJobRun> | Array<IBatchJobRun> | null): PopulateDataTagsBatchJob;

  /**
   * FOR INTERNAL USE ONLY - Specify options in call to {@link start}.
   */
  readonly options?: Obj;
  withOptions(options: IObj | null): PopulateDataTagsBatchJob;
  ...
  withOnCompleteCallback(onCompleteCallback: IJobBase.Callback | null): PopulateDataTagsBatchJob;
  ...
  withPriority(priority: number | null): PopulateDataTagsBatchJob;
  ...
  withDisabled(disabled: boolean): PopulateDataTagsBatchJob;
  ...
  withMaxConcurrency(maxConcurrency: number | null): PopulateDataTagsBatchJob;
  ...
  withMaxConcurrencyPerNode(maxConcurrencyPerNode: number | null): PopulateDataTagsBatchJob;
  ...
  withRunAsUser(runAsUser: boolean): PopulateDataTagsBatchJob;

  /**
   * Don't set this field in the BatchJob, set it in the BatchJobOptions when calling `start`
   */
  readonly nodePool?: string;
  withNodePool(nodePool: string | null): PopulateDataTagsBatchJob;
  ...
  withSkipIfRunning(skipIfRunning: boolean): PopulateDataTagsBatchJob;

  /**
   * Set to between 1 and 5 to enable auto recovery. See {@link invalidation-queues.c3doc Invalidation Queues} for detailed documentation.
   */
  readonly numAutoRecoveryAttempts?: number;
  withNumAutoRecoveryAttempts(numAutoRecoveryAttempts: number | null): PopulateDataTagsBatchJob;
  ...
  withTypeIdent(typeIdent: string | null): PopulateDataTagsBatchJob;
   ...
   */
  readonly id: string;
  withId(id: string): PopulateDataTagsBatchJob;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): PopulateDataTagsBatchJob;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): PopulateDataTagsBatchJob;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): PopulateDataTagsBatchJob;
  ...
  withVersion(version: number | null): PopulateDataTagsBatchJob;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): PopulateDataTagsBatchJob;
  ...
  withAbortOnError(abortOnError: boolean): PopulateDataTagsBatchJob;
   ...
   * @see #toJson
   */
  static fromJson(json: any): PopulateDataTagsBatchJob | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): PopulateDataTagsBatchJob | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): PopulateDataTagsBatchJob | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): PopulateDataTagsBatchJob | null;
   ...
   */
  replaceType(old: Type, new_: Type): PopulateDataTagsBatchJob;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): PopulateDataTagsBatchJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): PopulateDataTagsBatchJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<PopulateDataTagsBatchJob>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<PopulateDataTagsBatchJob>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): PopulateDataTagsBatchJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): PopulateDataTagsBatchJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): PopulateDataTagsBatchJob;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): PopulateDataTagsBatchJob;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): PopulateDataTagsBatchJob;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): PopulateDataTagsBatchJob;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): PopulateDataTagsBatchJob;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): PopulateDataTagsBatchJob;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): PopulateDataTagsBatchJob;
   ...
   * @see #removeField
   */
  withoutField(field: string): PopulateDataTagsBatchJob;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): PopulateDataTagsBatchJob;
   ...
   */
  withoutFields(fields: Array_Type<string>): PopulateDataTagsBatchJob;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): PopulateDataTagsBatchJob;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): PopulateDataTagsBatchJob;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): PopulateDataTagsBatchJob;
   ...
   * @see #unsetField
   */
  defaultField(field: string): PopulateDataTagsBatchJob;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): PopulateDataTagsBatchJob;
   ...
   * @see #removeField
   */
  unsetField(field: string): PopulateDataTagsBatchJob;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): PopulateDataTagsBatchJob;
   ...
   * @see #unsetField
   */
  removeField(field: string): PopulateDataTagsBatchJob;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): PopulateDataTagsBatchJob;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): PopulateDataTagsBatchJob;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): PopulateDataTagsBatchJob;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): PopulateDataTagsBatchJob;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): PopulateDataTagsBatchJob;

  mergeJson(json: any): PopulateDataTagsBatchJob;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): PopulateDataTagsBatchJob;
   ...
   */
  sumObj(other: Obj, deep?: boolean): PopulateDataTagsBatchJob;
   ...
   */
  singletonArray(): Array_Type<PopulateDataTagsBatchJob>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<PopulateDataTagsBatchJob> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<PopulateDataTagsBatchJob> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<PopulateDataTagsBatchJob>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<PopulateDataTagsBatchJob> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, PopulateDataTagsBatchJob> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, PopulateDataTagsBatchJob> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<PopulateDataTagsBatchJob>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<PopulateDataTagsBatchJob>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): PopulateDataTagsBatchJob;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): PopulateDataTagsBatchJob;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): PopulateDataTagsBatchJob;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): PopulateDataTagsBatchJob;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): PopulateDataTagsBatchJob;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): PopulateDataTagsBatchJob;
   ...
   * @see #fromString
   */
  static make(s: string): PopulateDataTagsBatchJob | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): PopulateDataTagsBatchJob;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): PopulateDataTagsBatchJob;
   ...
   */
  static cachedEmptyInst(): PopulateDataTagsBatchJob;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<PopulateDataTagsBatchJob> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): PopulateDataTagsBatchJob;
   ...
   */
  start(options?: PopulateDataTagsBatchJobOptions): BatchJobStatus | null;
   ...
   */
  cleanup(options?: PopulateDataTagsBatchJobOptions): void;
  ...
  cancelJob(removeResults?: boolean, force?: boolean): JobBase<BatchJobRun, BatchJobStatus, PopulateDataTagsBatchJobOptions> | null;

  failJob(run: JobRun<BatchJobStatusBase>): JobBase<BatchJobRun, BatchJobStatus, PopulateDataTagsBatchJobOptions> | null;
  ...
  validateStart(options?: PopulateDataTagsBatchJobOptions): void;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<PopulateDataTagsBatchJob>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<PopulateDataTagsBatchJob>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<PopulateDataTagsBatchJob> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<PopulateDataTagsBatchJob>> | null;
   ...
   */
  get(include?: string): PopulateDataTagsBatchJob | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): PopulateDataTagsBatchJob | null;
   ...
   */
  getMissing(spec: GetMissingSpec): PopulateDataTagsBatchJob;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): PopulateDataTagsBatchJob | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): PopulateDataTagsBatchJob;
   ...
   * @see #toString
   */
  static fromString(s: string): PopulateDataTagsBatchJob | null;
   ...
   */
  create(spec?: UpsertSpec): PopulateDataTagsBatchJob | null;
   ...
   */
  static createBatch(objs: Array_Type<PopulateDataTagsBatchJob>, spec?: UpsertSpec): ObjList<PopulateDataTagsBatchJob> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<PopulateDataTagsBatchJob>, spec?: CreateBatchObjStreamSpec): ObjList<PopulateDataTagsBatchJob> | null;
   ...
   */
  update(srcObj?: PopulateDataTagsBatchJob, spec?: UpsertSpec): PopulateDataTagsBatchJob | null;
   ...
   */
  upsert(srcObj?: PopulateDataTagsBatchJob, spec?: UpsertSpec): PopulateDataTagsBatchJob | null;
   ...
   */
  merge(spec?: MergeSpec): PopulateDataTagsBatchJob | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): PopulateDataTagsBatchJob | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): PopulateDataTagsBatchJob | null;
   ...
   */
  static updateBatch(objs: Array_Type<PopulateDataTagsBatchJob>, srcObjs?: Array_Type<PopulateDataTagsBatchJob>, spec?: UpsertSpec): ObjList<PopulateDataTagsBatchJob> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<PopulateDataTagsBatchJob> | null>, spec?: UpsertSpec): ObjList<PopulateDataTagsBatchJob> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<PopulateDataTagsBatchJob>, srcObjs?: Array_Type<PopulateDataTagsBatchJob>, spec?: UpsertSpec): ObjList<PopulateDataTagsBatchJob> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<PopulateDataTagsBatchJob> | null>, spec?: UpsertSpec): ObjList<PopulateDataTagsBatchJob> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<PopulateDataTagsBatchJob>, spec?: TouchSpec): ObjList<PopulateDataTagsBatchJob> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<PopulateDataTagsBatchJob>, spec?: MergeSpec): ObjList<PopulateDataTagsBatchJob> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<PopulateDataTagsBatchJob>, mergeInclude: string, spec?: MergeSpec): ObjList<PopulateDataTagsBatchJob> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<PopulateDataTagsBatchJob> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<PopulateDataTagsBatchJob> | null;
   ...
   */
  static mergeAll(mergeObj: PopulateDataTagsBatchJob, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: PopulateDataTagsBatchJob, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<PopulateDataTagsBatchJob>, spec?: UpsertSpec): ObjList<PopulateDataTagsBatchJob> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<PopulateDataTagsBatchJob>, spec?: UpsertSpec): ObjList<PopulateDataTagsBatchJob> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): PopulateDataTagsBatchJob | null;
   ...
   */
  static beforeCreate(objs: Array_Type<PopulateDataTagsBatchJob>): ObjList<PopulateDataTagsBatchJob>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<PopulateDataTagsBatchJob>): ObjList<PopulateDataTagsBatchJob>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<PopulateDataTagsBatchJob>): ObjList<PopulateDataTagsBatchJob>;
   ...
   */
  static afterCreate(objs: Array_Type<PopulateDataTagsBatchJob>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<PopulateDataTagsBatchJob>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<PopulateDataTagsBatchJob>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<PopulateDataTagsBatchJob>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<PopulateDataTagsBatchJob>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): PopulateDataTagsBatchJob | null;
   ...
   */
  withoutIdentity(): PopulateDataTagsBatchJob | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<PopulateDataTagsBatchJob>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: PopulateDataTagsBatchJob, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<PopulateDataTagsBatchJob>, callback?: λFunction<PopulateDataTagsBatchJob | null, PopulateDataTagsBatchJob | null>): ObjList<PopulateDataTagsBatchJob>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<PopulateDataTagsBatchJob>, callback?: λFunction<PopulateDataTagsBatchJob | null, PopulateDataTagsBatchJob | null>): Array_Type<ObjError> | null;
   ...
   */
  static doStart(job?: PopulateDataTagsBatchJob, options?: PopulateDataTagsBatchJobOptions): void;
   ...
   */
  static processBatch(batch?: PopulateDataTagsBatch, job?: PopulateDataTagsBatchJob, options?: PopulateDataTagsBatchJobOptions): void;
   ...
   */
  static allComplete(job: PopulateDataTagsBatchJob, options?: PopulateDataTagsBatchJobOptions): string | null;
   ...
   */
  static failed(job: PopulateDataTagsBatchJob, status: BatchJobStatus, options?: PopulateDataTagsBatchJobOptions): void;
   ...
   *        Batch to schedule.
   */
  scheduleBatch(batch?: PopulateDataTagsBatch): void;
   ...
   *        Batches to schedule.
   */
  scheduleBatches(batches?: Array_Type<PopulateDataTagsBatch>): void;
   ...
   */
  static scheduleObjBatch(job?: PopulateDataTagsBatchJob, objBatch?: ObjBatch, logPrefix?: string): number | null;
   ...
   */
  static startJob(cronJob: CronJob, batchSize?: number = '10'): PopulateDataTagsBatchJob;
   ...
   */
  static applyBatchedExpressions(entityIds: Array_Type<string>, baseDataTags: Array_Type<DataTagBase>): void;
}
