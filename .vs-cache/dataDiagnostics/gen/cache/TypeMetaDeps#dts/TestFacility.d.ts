// TypeScript definitions for the C3 type TestFacility

/**
 * A test facility for testing data diagnostics.
 *
 * @remarks this represents a value passed to a method that expects an instance of TestFacility
 */
declare interface ITestFacility {

  /**
   * The data tags related to this type.
   */
  dataTagRelations?: Array_Type<TestFacilityDataTagRelation> | Array<ITestFacilityDataTagRelation>;

  /**
   * The direct data tags calculated on this type.
   */
  directDataTags?: Array_Type<TestFacilityDataTag> | Array<ITestFacilityDataTag>;
   ...
   */
  testOrganization?: ITestOrg;

  /**
   * The {@link TestServicePoint}s related to this test facility.
   */
  testServicePoints?: Array_Type<TestServicePoint> | Array<ITestServicePoint>;

  /**
   * The status of this test facility.
   */
  statusHistories?: Array_Type<TestFacilityStatusHistory> | Array<ITestFacilityStatusHistory>;
}
 ...
 */
declare class TestFacility extends Obj  {

  /**
   * The data tags related to this type.
   */
  readonly dataTagRelations?: Array_Type<TestFacilityDataTagRelation>;
  withDataTagRelations(dataTagRelations: Array_Type<TestFacilityDataTagRelation> | Array<ITestFacilityDataTagRelation> | null): TestFacility;

  /**
   * The direct data tags calculated on this type.
   */
  readonly directDataTags?: Array_Type<TestFacilityDataTag>;
  withDirectDataTags(directDataTags: Array_Type<TestFacilityDataTag> | Array<ITestFacilityDataTag> | null): TestFacility;
  ...
  withDataTags(dataTags: Array_Type<string> | Array<string> | null): TestFacility;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): TestFacility;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): TestFacility;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): TestFacility;
  ...
  withVersion(version: number | null): TestFacility;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): TestFacility;

  /**
   * The {@link TestOrg} related to this test facility.
   */
  readonly testOrganization?: TestOrg;
  withTestOrganization(testOrganization: ITestOrg | null): TestFacility;

  /**
   * The {@link TestServicePoint}s related to this test facility.
   */
  readonly testServicePoints?: Array_Type<TestServicePoint>;
  withTestServicePoints(testServicePoints: Array_Type<TestServicePoint> | Array<ITestServicePoint> | null): TestFacility;

  /**
   * The status of this test facility.
   */
  readonly statusHistories?: Array_Type<TestFacilityStatusHistory>;
  withStatusHistories(statusHistories: Array_Type<TestFacilityStatusHistory> | Array<ITestFacilityStatusHistory> | null): TestFacility;
   ...
   * @see #toJson
   */
  static fromJson(json: any): TestFacility | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): TestFacility | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): TestFacility | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): TestFacility | null;
   ...
   */
  replaceType(old: Type, new_: Type): TestFacility;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): TestFacility;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): TestFacility;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<TestFacility>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<TestFacility>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): TestFacility;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TestFacility;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TestFacility;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): TestFacility;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): TestFacility;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): TestFacility;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): TestFacility;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): TestFacility;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): TestFacility;
   ...
   * @see #removeField
   */
  withoutField(field: string): TestFacility;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): TestFacility;
   ...
   */
  withoutFields(fields: Array_Type<string>): TestFacility;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): TestFacility;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): TestFacility;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): TestFacility;
   ...
   * @see #unsetField
   */
  defaultField(field: string): TestFacility;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): TestFacility;
   ...
   * @see #removeField
   */
  unsetField(field: string): TestFacility;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): TestFacility;
   ...
   * @see #unsetField
   */
  removeField(field: string): TestFacility;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): TestFacility;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): TestFacility;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): TestFacility;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): TestFacility;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): TestFacility;

  mergeJson(json: any): TestFacility;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): TestFacility;
   ...
   */
  sumObj(other: Obj, deep?: boolean): TestFacility;
   ...
   */
  singletonArray(): Array_Type<TestFacility>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<TestFacility> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<TestFacility> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<TestFacility>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<TestFacility> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, TestFacility> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, TestFacility> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<TestFacility>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<TestFacility>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): TestFacility;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): TestFacility;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): TestFacility;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): TestFacility;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): TestFacility;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): TestFacility;
   ...
   * @see #fromString
   */
  static make(s: string): TestFacility | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): TestFacility;
   ...
   */
  static cachedEmptyInst(): TestFacility;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<TestFacility> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): TestFacility;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<TestFacility>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<TestFacility>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<TestFacility> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<TestFacility>> | null;
   ...
   */
  static evalFeatureSetBatch(batch: Array_Type<TestFacility>, featureSet: Feature.Set, spec?: EvalFeatureSpec): Data | null;
   ...
   * ```
   */
  static evalFeaturesBatch(batch: Array_Type<TestFacility>, features: Array_Type<string>, spec?: EvalFeaturesSpec): Data | null;
   ...
   */
  get(include?: string): TestFacility | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): TestFacility | null;
   ...
   */
  getMissing(spec: GetMissingSpec): TestFacility;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): TestFacility | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): TestFacility;
   ...
   * @see #toString
   */
  static fromString(s: string): TestFacility | null;
   ...
   */
  create(spec?: UpsertSpec): TestFacility | null;
   ...
   */
  static createBatch(objs: Array_Type<TestFacility>, spec?: UpsertSpec): ObjList<TestFacility> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<TestFacility>, spec?: CreateBatchObjStreamSpec): ObjList<TestFacility> | null;
   ...
   */
  update(srcObj?: TestFacility, spec?: UpsertSpec): TestFacility | null;
   ...
   */
  upsert(srcObj?: TestFacility, spec?: UpsertSpec): TestFacility | null;
   ...
   */
  merge(spec?: MergeSpec): TestFacility | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): TestFacility | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): TestFacility | null;
   ...
   */
  static updateBatch(objs: Array_Type<TestFacility>, srcObjs?: Array_Type<TestFacility>, spec?: UpsertSpec): ObjList<TestFacility> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<TestFacility> | null>, spec?: UpsertSpec): ObjList<TestFacility> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<TestFacility>, srcObjs?: Array_Type<TestFacility>, spec?: UpsertSpec): ObjList<TestFacility> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<TestFacility> | null>, spec?: UpsertSpec): ObjList<TestFacility> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<TestFacility>, spec?: TouchSpec): ObjList<TestFacility> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<TestFacility>, spec?: MergeSpec): ObjList<TestFacility> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<TestFacility>, mergeInclude: string, spec?: MergeSpec): ObjList<TestFacility> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<TestFacility> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<TestFacility> | null;
   ...
   */
  static mergeAll(mergeObj: TestFacility, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: TestFacility, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<TestFacility>, spec?: UpsertSpec): ObjList<TestFacility> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<TestFacility>, spec?: UpsertSpec): ObjList<TestFacility> | null;
   ...
   */
  static beforeCreate(objs: Array_Type<TestFacility>): ObjList<TestFacility>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<TestFacility>): ObjList<TestFacility>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<TestFacility>): ObjList<TestFacility>;
   ...
   */
  static afterCreate(objs: Array_Type<TestFacility>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<TestFacility>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<TestFacility>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<TestFacility>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<TestFacility>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): TestFacility | null;
   ...
   */
  withoutIdentity(): TestFacility | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<TestFacility>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: TestFacility, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<TestFacility>, callback?: λFunction<TestFacility | null, TestFacility | null>): ObjList<TestFacility>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<TestFacility>, callback?: λFunction<TestFacility | null, TestFacility | null>): Array_Type<ObjError> | null;
