// TypeScript definitions for the C3 type DataTagSubject
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of DataTagSubject
 */
declare interface IDataTagSubject<DTR, DT> {

  /**
   * The data tags related to this type.
   */
  dataTagRelations?: Array_Type<DTR> | Array<DTR>;

  /**
   * The direct data tags calculated on this type.
   */
  directDataTags?: Array_Type<DT> | Array<DT>;
 ...
 */
declare class DataTagSubject<DTR, DT> extends Obj  {

  /**
   * The data tags related to this type.
   */
  readonly dataTagRelations?: Array_Type<DTR>;
  withDataTagRelations(dataTagRelations: Array_Type<DTR> | Array<DTR> | null): DataTagSubject;

  /**
   * The direct data tags calculated on this type.
   */
  readonly directDataTags?: Array_Type<DT>;
  withDirectDataTags(directDataTags: Array_Type<DT> | Array<DT> | null): DataTagSubject;
  ...
  withDataTags(dataTags: Array_Type<string> | Array<string> | null): DataTagSubject;
   ...
   * @see #toJson
   */
  static fromJson(json: any): DataTagSubject<DTR, DT> | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): DataTagSubject<DTR, DT> | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): DataTagSubject<DTR, DT> | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): DataTagSubject<DTR, DT> | null;
   ...
   */
  replaceType(old: Type, new_: Type): DataTagSubject<DTR, DT>;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): DataTagSubject<DTR, DT>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): DataTagSubject<DTR, DT>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<DataTagSubject<DTR, DT>>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<DataTagSubject<DTR, DT>>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): DataTagSubject<DTR, DT>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DataTagSubject<DTR, DT>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DataTagSubject<DTR, DT>;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): DataTagSubject<DTR, DT>;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): DataTagSubject<DTR, DT>;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): DataTagSubject<DTR, DT>;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): DataTagSubject<DTR, DT>;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): DataTagSubject<DTR, DT>;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): DataTagSubject<DTR, DT>;
   ...
   * @see #removeField
   */
  withoutField(field: string): DataTagSubject<DTR, DT>;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): DataTagSubject<DTR, DT>;
   ...
   */
  withoutFields(fields: Array_Type<string>): DataTagSubject<DTR, DT>;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): DataTagSubject<DTR, DT>;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): DataTagSubject<DTR, DT>;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): DataTagSubject<DTR, DT>;
   ...
   * @see #unsetField
   */
  defaultField(field: string): DataTagSubject<DTR, DT>;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): DataTagSubject<DTR, DT>;
   ...
   * @see #removeField
   */
  unsetField(field: string): DataTagSubject<DTR, DT>;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): DataTagSubject<DTR, DT>;
   ...
   * @see #unsetField
   */
  removeField(field: string): DataTagSubject<DTR, DT>;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): DataTagSubject<DTR, DT>;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): DataTagSubject<DTR, DT>;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): DataTagSubject<DTR, DT>;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): DataTagSubject<DTR, DT>;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): DataTagSubject<DTR, DT>;

  mergeJson(json: any): DataTagSubject<DTR, DT>;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): DataTagSubject<DTR, DT>;
   ...
   */
  sumObj(other: Obj, deep?: boolean): DataTagSubject<DTR, DT>;
   ...
   */
  singletonArray(): Array_Type<DataTagSubject<DTR, DT>>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<DataTagSubject<DTR, DT>> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<DataTagSubject<DTR, DT>> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<DataTagSubject<DTR, DT>>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<DataTagSubject<DTR, DT>> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, DataTagSubject<DTR, DT>> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, DataTagSubject<DTR, DT>> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<DataTagSubject<DTR, DT>>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<DataTagSubject<DTR, DT>>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): DataTagSubject<DTR, DT>;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): DataTagSubject<DTR, DT>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): DataTagSubject<DTR, DT>;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): DataTagSubject<DTR, DT>;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): DataTagSubject<DTR, DT>;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): DataTagSubject<DTR, DT>;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): DataTagSubject<DTR, DT>;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): DataTagSubject<DTR, DT>;
   ...
   */
  static cachedEmptyInst(): DataTagSubject<DTR, DT>;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<DataTagSubject<DTR, DT>> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): DataTagSubject<DTR, DT>;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<DataTagSubject<DTR, DT>>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<DataTagSubject<DTR, DT>>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<DataTagSubject<DTR, DT>> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<DataTagSubject<DTR, DT>>> | null;
   ...
   */
  static evalFeatureSetBatch(batch: Array_Type<DataTagSubject<DTR, DT>>, featureSet: Feature.Set, spec?: EvalFeatureSpec): Data | null;
   ...
   * ```
   */
  static evalFeaturesBatch(batch: Array_Type<DataTagSubject<DTR, DT>>, features: Array_Type<string>, spec?: EvalFeaturesSpec): Data | null;
