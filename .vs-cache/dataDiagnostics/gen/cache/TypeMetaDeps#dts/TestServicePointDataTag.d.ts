// TypeScript definitions for the C3 type TestServicePointDataTag

/**
 * A data tag for the {@link TestServicePoint} entity.
 *
 * @remarks this represents a value passed to a method that expects an instance of TestServicePointDataTag
 */
declare interface ITestServicePointDataTag {

  /**
   * The entities of a certain Type which this data diagnostic logic should be run on.
   * Gets "OR"ed with the filter on this data diagnostic during evaluation.
   */
  whiteListedEntities?: Array_Type<TestServicePointDataTagEntityRelation> | Array<ITestServicePointDataTagEntityRelation>;

  /**
   * The entities of type srcType which this data diagnostic logic should not be run on.
   * Gets "AND"ed with the filter on this data diagnostic during evaluation.
   */
  blackListedEntities?: Array_Type<TestServicePointDataTagEntityRelation> | Array<ITestServicePointDataTagEntityRelation>;
   ...
   */
  overrideSimpleMetrics?: Array_Type<SimpleMetric> | Array<ISimpleMetric>;

  /**
   * Override compound metrics that the developer may optionally define and
   * call instead of seeded metrics.
   */
  overrideCompoundMetrics?: Array_Type<CompoundMetric> | Array<ICompoundMetric>;
   ...
   */
  bindings?: Map_Type<string, any> | {[key: string]: any};
   ...
   */
  requiredBindings?: Array_Type<string> | Array<string>;

  /**
   * Field to override bindings for specific {@link #srcType} entities.
   */
  entitySpecificBindings?: Map_Type<string, OverrideBindings> | {[key: string]: IOverrideBindings};
   ...
   */
  batchConfig?: IDataDiagnosticBatchConfig;
   ...
   */
  customDiagnosticLogic?: λConsumer<any | null>;

  /**
   * The history of counts and percentages of the {@link DataTagRelation}s for this data tag.
   */
  countHistory?: Array_Type<DataTagCountHistory> | Array<IDataTagCountHistory>;
}
 ...
 * A data tag for the {@link TestServicePoint} entity.
 *
 * @remarks this represents a made instance of TestServicePointDataTag
 */
declare class TestServicePointDataTag extends Obj  {

  /**
   * The entities of a certain Type which this data diagnostic logic should be run on.
   * Gets "OR"ed with the filter on this data diagnostic during evaluation.
   */
  readonly whiteListedEntities?: Array_Type<TestServicePointDataTagEntityRelation>;
  withWhiteListedEntities(whiteListedEntities: Array_Type<TestServicePointDataTagEntityRelation> | Array<ITestServicePointDataTagEntityRelation> | null): TestServicePointDataTag;

  /**
   * The entities of type srcType which this data diagnostic logic should not be run on.
   * Gets "AND"ed with the filter on this data diagnostic during evaluation.
   */
  readonly blackListedEntities?: Array_Type<TestServicePointDataTagEntityRelation>;
  withBlackListedEntities(blackListedEntities: Array_Type<TestServicePointDataTagEntityRelation> | Array<ITestServicePointDataTagEntityRelation> | null): TestServicePointDataTag;
  ...
  withTypeIdent(typeIdent: string | null): TestServicePointDataTag;
   ...
   */
  readonly id: string;
  withId(id: string): TestServicePointDataTag;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): TestServicePointDataTag;
  ...
  withName(name: string): TestServicePointDataTag;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): TestServicePointDataTag;
  ...
  withVersion(version: number | null): TestServicePointDataTag;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): TestServicePointDataTag;

  /**
   * The entity type which this data diagnostic is running logic for.
   */
  readonly srcType: Type;
  withSrcType(srcType: IType): TestServicePointDataTag;

  /**
   * High level description of what this data diagnostic is doing.
   */
  readonly description?: string;
  withDescription(description: string | null): TestServicePointDataTag;

  /**
   * The metric expression used in the data diagnostic logic.
   */
  readonly metricExpression?: string;
  withMetricExpression(metricExpression: string | null): TestServicePointDataTag;

  /**
   * Override simple metrics that the developer may optionally define and call
   * instead of seeded metrics.
   */
  readonly overrideSimpleMetrics?: Array_Type<SimpleMetric>;
  withOverrideSimpleMetrics(overrideSimpleMetrics: Array_Type<SimpleMetric> | Array<ISimpleMetric> | null): TestServicePointDataTag;

  /**
   * Override compound metrics that the developer may optionally define and
   * call instead of seeded metrics.
   */
  readonly overrideCompoundMetrics?: Array_Type<CompoundMetric>;
  withOverrideCompoundMetrics(overrideCompoundMetrics: Array_Type<CompoundMetric> | Array<ICompoundMetric> | null): TestServicePointDataTag;

  /**
   * The unit used in the metric evaluation of the diagnostic logic.
   */
  readonly unit?: Unit;
  withUnit(unit: IUnit | null): TestServicePointDataTag;

  /**
   * Bindings to use with any metrics invoked by the metric expression.
   */
  readonly bindings?: Map_Type<string, any>;
  withBindings(bindings: Map_Type<string, any> | {[key: string]: any} | null): TestServicePointDataTag;

  /**
   * The {@link EvalMetricsOptions} to use when running the evalMetrics call.
   */
  readonly options?: EvalMetricsOptions;
  withOptions(options: IEvalMetricsOptions | null): TestServicePointDataTag;

  /**
   * Bindings which are required for the diagnostic to function properly.
   * This field should be overridden with a default for subtypes which only support metric-based diagnostics and always require certain bindings.
   */
  readonly requiredBindings?: Array_Type<string>;
  withRequiredBindings(requiredBindings: Array_Type<string> | Array<string> | null): TestServicePointDataTag;

  /**
   * Field to override bindings for specific {@link #srcType} entities.
   */
  readonly entitySpecificBindings?: Map_Type<string, OverrideBindings>;
  withEntitySpecificBindings(entitySpecificBindings: Map_Type<string, OverrideBindings> | {[key: string]: IOverrideBindings} | null): TestServicePointDataTag;

  /**
   * {@link DataDiagnosticBatchConfig} for how this data diagnostic will be split into its own batches
   * or if it will be split at all.
   */
  readonly batchConfig?: DataDiagnosticBatchConfig;
  withBatchConfig(batchConfig: IDataDiagnosticBatchConfig | null): TestServicePointDataTag;

  /**
   * {@link Interval} used for the metric evaluation.
   */
  readonly interval?: string;
  withInterval(interval: string | null): TestServicePointDataTag;

  /**
   * The {@link Period} of time the diagnostic runs the eval metric call on.
   */
  readonly period?: Period;
  withPeriod(period: IPeriod | null): TestServicePointDataTag;

  /**
   * The timezone the used in the evaluation of the metric.
   */
  readonly timeZone?: string;
  withTimeZone(timeZone: string | null): TestServicePointDataTag;

  /**
   * The cron job which will run this data diagnostic logic on a set schedule.
   */
  readonly cronJob?: CronJob;
  withCronJob(cronJob: ICronJob | null): TestServicePointDataTag;

  /**
   * A filter used to retrieve entities of type `srcType` to run the data diagnostic logic on.
   */
  readonly filter: Filter;
  withFilter(filter: IFilter): TestServicePointDataTag;

  /**
   * Include string to within the {@link FetchSpec} if the diagnostic is configured to perform a fetch.
   */
  readonly fetchInclude?: string;
  withFetchInclude(fetchInclude: string | null): TestServicePointDataTag;
  ...
  withExpression(expression: string | null): TestServicePointDataTag;
   ...
   * an {@link #expression} by attaching `meta.referenceInvalid` to the end of each comma-separated path.
   */
  readonly referentialIntegrityString?: string;
  withReferentialIntegrityString(referentialIntegrityString: string | null): TestServicePointDataTag;
  ...
  withEnabled(enabled: boolean): TestServicePointDataTag;

  /**
   * Lambda function that can be used to override the existing logic on a type that extends {@link DataDiagnostic}.
   */
  readonly customDiagnosticLogic?: λConsumer<any | null>;
  withCustomDiagnosticLogic(customDiagnosticLogic: λConsumer<any | null> | null): TestServicePointDataTag;

  /**
   * The history of counts and percentages of the {@link DataTagRelation}s for this data tag.
   */
  readonly countHistory?: Array_Type<DataTagCountHistory>;
  withCountHistory(countHistory: Array_Type<DataTagCountHistory> | Array<IDataTagCountHistory> | null): TestServicePointDataTag;
   ...
   * @see #toJson
   */
  static fromJson(json: any): TestServicePointDataTag | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): TestServicePointDataTag | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): TestServicePointDataTag | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): TestServicePointDataTag | null;
   ...
   */
  replaceType(old: Type, new_: Type): TestServicePointDataTag;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): TestServicePointDataTag;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): TestServicePointDataTag;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<TestServicePointDataTag>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<TestServicePointDataTag>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): TestServicePointDataTag;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TestServicePointDataTag;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TestServicePointDataTag;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): TestServicePointDataTag;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): TestServicePointDataTag;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): TestServicePointDataTag;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): TestServicePointDataTag;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): TestServicePointDataTag;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): TestServicePointDataTag;
   ...
   * @see #removeField
   */
  withoutField(field: string): TestServicePointDataTag;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): TestServicePointDataTag;
   ...
   */
  withoutFields(fields: Array_Type<string>): TestServicePointDataTag;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): TestServicePointDataTag;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): TestServicePointDataTag;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): TestServicePointDataTag;
   ...
   * @see #unsetField
   */
  defaultField(field: string): TestServicePointDataTag;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): TestServicePointDataTag;
   ...
   * @see #removeField
   */
  unsetField(field: string): TestServicePointDataTag;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): TestServicePointDataTag;
   ...
   * @see #unsetField
   */
  removeField(field: string): TestServicePointDataTag;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): TestServicePointDataTag;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): TestServicePointDataTag;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): TestServicePointDataTag;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): TestServicePointDataTag;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): TestServicePointDataTag;

  mergeJson(json: any): TestServicePointDataTag;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): TestServicePointDataTag;
   ...
   */
  sumObj(other: Obj, deep?: boolean): TestServicePointDataTag;
   ...
   */
  singletonArray(): Array_Type<TestServicePointDataTag>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<TestServicePointDataTag> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<TestServicePointDataTag> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<TestServicePointDataTag>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<TestServicePointDataTag> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, TestServicePointDataTag> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, TestServicePointDataTag> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<TestServicePointDataTag>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<TestServicePointDataTag>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): TestServicePointDataTag;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): TestServicePointDataTag;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): TestServicePointDataTag;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): TestServicePointDataTag;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): TestServicePointDataTag;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): TestServicePointDataTag;
   ...
   * @see #fromString
   */
  static make(s: string): TestServicePointDataTag | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): TestServicePointDataTag;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): TestServicePointDataTag;
   ...
   */
  static cachedEmptyInst(): TestServicePointDataTag;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<TestServicePointDataTag> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): TestServicePointDataTag;

  /**
   * Get whiteList entity relation type name
   */
  getEntityRelationType(): string | null;

  /**
   * Add the entity with this id to the whitelist of entities, if there is such an entity with that id.
   */
  addEntityToWhiteList(id: string): TestServicePointDataTagEntityRelation | null;

  /**
   * Add the entiy with this id to the blacklist of entities, if there is such an entity with that id.
   */
  addEntityToBlackList(id: string): TestServicePointDataTagEntityRelation | null;

  /**
   * Remove the entity with this id from the white list of entities.
   */
  removeEntityFromWhiteList(id: string): boolean;

  /**
   * Remove the entity with this id from the black list of entities.
   */
  removeEntityFromBlackList(id: string): boolean;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<TestServicePointDataTag>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<TestServicePointDataTag>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<TestServicePointDataTag> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<TestServicePointDataTag>> | null;
   ...
   */
  static evalFeatureSetBatch(batch: Array_Type<TestServicePointDataTag>, featureSet: Feature.Set, spec?: EvalFeatureSpec): Data | null;
   ...
   * ```
   */
  static evalFeaturesBatch(batch: Array_Type<TestServicePointDataTag>, features: Array_Type<string>, spec?: EvalFeaturesSpec): Data | null;
   ...
   */
  get(include?: string): TestServicePointDataTag | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): TestServicePointDataTag | null;
   ...
   */
  getMissing(spec: GetMissingSpec): TestServicePointDataTag;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): TestServicePointDataTag | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): TestServicePointDataTag;
   ...
   * @see #toString
   */
  static fromString(s: string): TestServicePointDataTag | null;
   ...
   */
  create(spec?: UpsertSpec): TestServicePointDataTag | null;
   ...
   */
  static createBatch(objs: Array_Type<TestServicePointDataTag>, spec?: UpsertSpec): ObjList<TestServicePointDataTag> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<TestServicePointDataTag>, spec?: CreateBatchObjStreamSpec): ObjList<TestServicePointDataTag> | null;
   ...
   */
  update(srcObj?: TestServicePointDataTag, spec?: UpsertSpec): TestServicePointDataTag | null;
   ...
   */
  upsert(srcObj?: TestServicePointDataTag, spec?: UpsertSpec): TestServicePointDataTag | null;
   ...
   */
  merge(spec?: MergeSpec): TestServicePointDataTag | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): TestServicePointDataTag | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): TestServicePointDataTag | null;
   ...
   */
  static updateBatch(objs: Array_Type<TestServicePointDataTag>, srcObjs?: Array_Type<TestServicePointDataTag>, spec?: UpsertSpec): ObjList<TestServicePointDataTag> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<TestServicePointDataTag> | null>, spec?: UpsertSpec): ObjList<TestServicePointDataTag> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<TestServicePointDataTag>, srcObjs?: Array_Type<TestServicePointDataTag>, spec?: UpsertSpec): ObjList<TestServicePointDataTag> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<TestServicePointDataTag> | null>, spec?: UpsertSpec): ObjList<TestServicePointDataTag> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<TestServicePointDataTag>, spec?: TouchSpec): ObjList<TestServicePointDataTag> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<TestServicePointDataTag>, spec?: MergeSpec): ObjList<TestServicePointDataTag> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<TestServicePointDataTag>, mergeInclude: string, spec?: MergeSpec): ObjList<TestServicePointDataTag> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<TestServicePointDataTag> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<TestServicePointDataTag> | null;
   ...
   */
  static mergeAll(mergeObj: TestServicePointDataTag, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: TestServicePointDataTag, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<TestServicePointDataTag>, spec?: UpsertSpec): ObjList<TestServicePointDataTag> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<TestServicePointDataTag>, spec?: UpsertSpec): ObjList<TestServicePointDataTag> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): TestServicePointDataTag | null;
   ...
   */
  static beforeCreate(objs: Array_Type<TestServicePointDataTag>): ObjList<TestServicePointDataTag>;
   ...
   * {@link DataDiagnostic#filter} are all valid.
   */
  static beforeUpdate(objs: Array_Type<TestServicePointDataTag>): ObjList<TestServicePointDataTag>;
   ...
   */
  static beforeRemove(objs: Array_Type<TestServicePointDataTag>): ObjList<TestServicePointDataTag>;
   ...
   */
  static afterCreate(objs: Array_Type<TestServicePointDataTag>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<TestServicePointDataTag>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<TestServicePointDataTag>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<TestServicePointDataTag>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<TestServicePointDataTag>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): TestServicePointDataTag | null;
   ...
   */
  withoutIdentity(): TestServicePointDataTag | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<TestServicePointDataTag>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: TestServicePointDataTag, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<TestServicePointDataTag>, callback?: λFunction<TestServicePointDataTag | null, TestServicePointDataTag | null>): ObjList<TestServicePointDataTag>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<TestServicePointDataTag>, callback?: λFunction<TestServicePointDataTag | null, TestServicePointDataTag | null>): Array_Type<ObjError> | null;
   ...
   */
  hasComprehensiveFilter(): boolean;
   ...
   */
  getOverrideMetrics(): Array_Type<SimpleMetric | CompoundMetric> | null;
   ...
   */
  performEvalMetrics(srcType?: Type, metricsSpec?: EvalMetricsSpec): EvalMetricsResult | null;
   ...
   */
  retrieveEvalMetricsDiagnosticData(filter?: Filter, dataVariables?: TestServicePointDataTag, overrideDiagnosticSpec?: DataDiagnosticOverrideSpec = '{}'): EvalMetricsResult | null;
   ...
   */
  validateSourceId(sourceId?: string): DataDiagnostic | null;
   ...
   */
  getBindings(sourceId?: string, overrideDiagnosticSpec?: DataDiagnosticOverrideSpec = '{}'): any | null;
   ...
   */
  updateBindings(config: any, sourceId?: string, merge?: boolean): void;
   ...
   */
  fetchDiagnosticBindings(spec?: FetchSpec): FetchResult<any> | null;
   ...
   */
  fetchBindingValues(sourceIds?: Array_Type<string>, spec?: FetchSpec): FetchResult<any> | null;

  /**
   * Function that retrieves the data in this data diagnostic based on fields such as `metricExpression`, `expression`, `filter`,
   * `period`, and `interval`.
   */
  retrieveDiagnosticData(overrideDiagnosticSpec?: DataDiagnosticOverrideSpec = '{}'): FetchResult<any> | EvaluateResult | EvalMetricsResult;

  /**
   * Get the {@link Filter} that specifies which entities to evaluate the data diagnostic logic on. This filter will include the
   * white and blacklisted entities for the DataTag.
   */
  getDiagnosticFilter(overrideFilterSpec?: DataDiagnosticFilterSpec): Filter;

  /**
   * Run the lambda functions attached to a data diagnostic instance.
   */
  executeLambda(action?: λConsumer<any | null>): any | null;
   ...
   */
  static processNewOrUpdatedDiagnostics(objs: Array_Type<TestServicePointDataTag>): ObjList<TestServicePointDataTag>;

  /**
   * Updates a value in the diagnostic's {@link bindings} map.
   */
  updateBindingValue(bindingName: string, bindingValue: any): void;

  /**
   * Runs the data tagging logic for an instance.
   */
  populateDataTags(overrideDiagnosticSpec?: DataDiagnosticOverrideSpec = '{}'): void;
   ...
   */
  tagEntities(entities?: Array_Type<string>, overrideFilterSpec?: DataDiagnosticFilterSpec): void;
   ...
   */
  entitiesFromEvaluateResult(evaluateResult: EvaluateResult): Array_Type<string> | null;
   ...
   */
  entitiesFromEvalMetricsResult(evalMetricsResult: EvalMetricsResult): Array_Type<string> | null;
   ...
   */
  validateDataTagLogic(spec: ValidateDiagnosticSpec): boolean;
}
