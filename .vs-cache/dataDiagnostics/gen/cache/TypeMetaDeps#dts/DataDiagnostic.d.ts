// TypeScript definitions for the C3 type DataDiagnostic
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of DataDiagnostic
 */
declare interface IDataDiagnostic {
 ...
 * entities (those which satisfied the diagnostic logic).
 *
 * @remarks this represents a made instance of DataDiagnostic
 */
declare class DataDiagnostic extends Obj  {
  ...
  withTypeIdent(typeIdent: string | null): DataDiagnostic;
   ...
   */
  readonly id: string;
  withId(id: string): DataDiagnostic;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): DataDiagnostic;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): DataDiagnostic;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): DataDiagnostic;
  ...
  withVersion(version: number | null): DataDiagnostic;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): DataDiagnostic;

  /**
   * The entity type which this data diagnostic is running logic for.
   */
  readonly srcType: Type;
  withSrcType(srcType: IType): DataDiagnostic;

  /**
   * High level description of what this data diagnostic is doing.
   */
  readonly description?: string;
  withDescription(description: string | null): DataDiagnostic;

  /**
   * The metric expression used in the data diagnostic logic.
   */
  readonly metricExpression?: string;
  withMetricExpression(metricExpression: string | null): DataDiagnostic;
  ...
  withOverrideSimpleMetrics(overrideSimpleMetrics: Array_Type<SimpleMetric> | Array<ISimpleMetric> | null): DataDiagnostic;
  ...
  withOverrideCompoundMetrics(overrideCompoundMetrics: Array_Type<CompoundMetric> | Array<ICompoundMetric> | null): DataDiagnostic;

  /**
   * The unit used in the metric evaluation of the diagnostic logic.
   */
  readonly unit?: Unit;
  withUnit(unit: IUnit | null): DataDiagnostic;

  /**
   * Bindings to use with any metrics invoked by the metric expression.
   */
  readonly bindings?: Map_Type<string, any>;
  withBindings(bindings: Map_Type<string, any> | {[key: string]: any} | null): DataDiagnostic;

  /**
   * The {@link EvalMetricsOptions} to use when running the evalMetrics call.
   */
  readonly options?: EvalMetricsOptions;
  withOptions(options: IEvalMetricsOptions | null): DataDiagnostic;
  ...
  withRequiredBindings(requiredBindings: Array_Type<string> | Array<string> | null): DataDiagnostic;

  /**
   * Field to override bindings for specific {@link #srcType} entities.
   */
  readonly entitySpecificBindings?: Map_Type<string, OverrideBindings>;
  withEntitySpecificBindings(entitySpecificBindings: Map_Type<string, OverrideBindings> | {[key: string]: IOverrideBindings} | null): DataDiagnostic;
  ...
  withBatchConfig(batchConfig: IDataDiagnosticBatchConfig | null): DataDiagnostic;

  /**
   * {@link Interval} used for the metric evaluation.
   */
  readonly interval?: string;
  withInterval(interval: string | null): DataDiagnostic;

  /**
   * The {@link Period} of time the diagnostic runs the eval metric call on.
   */
  readonly period?: Period;
  withPeriod(period: IPeriod | null): DataDiagnostic;

  /**
   * The timezone the used in the evaluation of the metric.
   */
  readonly timeZone?: string;
  withTimeZone(timeZone: string | null): DataDiagnostic;

  /**
   * The cron job which will run this data diagnostic logic on a set schedule.
   */
  readonly cronJob?: CronJob;
  withCronJob(cronJob: ICronJob | null): DataDiagnostic;

  /**
   * A filter used to retrieve entities of type `srcType` to run the data diagnostic logic on.
   */
  readonly filter: Filter;
  withFilter(filter: IFilter): DataDiagnostic;

  /**
   * Include string to within the {@link FetchSpec} if the diagnostic is configured to perform a fetch.
   */
  readonly fetchInclude?: string;
  withFetchInclude(fetchInclude: string | null): DataDiagnostic;
  ...
  withExpression(expression: string | null): DataDiagnostic;
  ...
  withReferentialIntegrityString(referentialIntegrityString: string | null): DataDiagnostic;
  ...
  withEnabled(enabled: boolean): DataDiagnostic;

  /**
   * Lambda function that can be used to override the existing logic on a type that extends {@link DataDiagnostic}.
   */
  readonly customDiagnosticLogic?: λConsumer<any | null>;
  withCustomDiagnosticLogic(customDiagnosticLogic: λConsumer<any | null> | null): DataDiagnostic;
   ...
   * @see #toJson
   */
  static fromJson(json: any): DataDiagnostic | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): DataDiagnostic | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): DataDiagnostic | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): DataDiagnostic | null;
   ...
   */
  replaceType(old: Type, new_: Type): DataDiagnostic;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): DataDiagnostic;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): DataDiagnostic;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<DataDiagnostic>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<DataDiagnostic>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): DataDiagnostic;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DataDiagnostic;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DataDiagnostic;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): DataDiagnostic;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): DataDiagnostic;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): DataDiagnostic;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): DataDiagnostic;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): DataDiagnostic;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): DataDiagnostic;
   ...
   * @see #removeField
   */
  withoutField(field: string): DataDiagnostic;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): DataDiagnostic;
   ...
   */
  withoutFields(fields: Array_Type<string>): DataDiagnostic;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): DataDiagnostic;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): DataDiagnostic;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): DataDiagnostic;
   ...
   * @see #unsetField
   */
  defaultField(field: string): DataDiagnostic;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): DataDiagnostic;
   ...
   * @see #removeField
   */
  unsetField(field: string): DataDiagnostic;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): DataDiagnostic;
   ...
   * @see #unsetField
   */
  removeField(field: string): DataDiagnostic;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): DataDiagnostic;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): DataDiagnostic;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): DataDiagnostic;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): DataDiagnostic;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): DataDiagnostic;

  mergeJson(json: any): DataDiagnostic;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): DataDiagnostic;
   ...
   */
  sumObj(other: Obj, deep?: boolean): DataDiagnostic;
   ...
   */
  singletonArray(): Array_Type<DataDiagnostic>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<DataDiagnostic> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<DataDiagnostic> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<DataDiagnostic>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<DataDiagnostic> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, DataDiagnostic> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, DataDiagnostic> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<DataDiagnostic>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<DataDiagnostic>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): DataDiagnostic;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): DataDiagnostic;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): DataDiagnostic;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): DataDiagnostic;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): DataDiagnostic;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): DataDiagnostic;
   ...
   * @see #fromString
   */
  static make(s: string): DataDiagnostic | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): DataDiagnostic;
   ...
   */
  static cachedEmptyInst(): DataDiagnostic;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<DataDiagnostic> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): DataDiagnostic;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<DataDiagnostic>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<DataDiagnostic>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<DataDiagnostic> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<DataDiagnostic>> | null;
   ...
   */
  get(include?: string): DataDiagnostic | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): DataDiagnostic | null;
   ...
   */
  getMissing(spec: GetMissingSpec): DataDiagnostic;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): DataDiagnostic | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): DataDiagnostic;
   ...
   * @see #toString
   */
  static fromString(s: string): DataDiagnostic | null;
   ...
   */
  create(spec?: UpsertSpec): DataDiagnostic | null;
   ...
   */
  static createBatch(objs: Array_Type<DataDiagnostic>, spec?: UpsertSpec): ObjList<DataDiagnostic> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<DataDiagnostic>, spec?: CreateBatchObjStreamSpec): ObjList<DataDiagnostic> | null;
   ...
   */
  update(srcObj?: DataDiagnostic, spec?: UpsertSpec): DataDiagnostic | null;
   ...
   */
  upsert(srcObj?: DataDiagnostic, spec?: UpsertSpec): DataDiagnostic | null;
   ...
   */
  merge(spec?: MergeSpec): DataDiagnostic | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): DataDiagnostic | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): DataDiagnostic | null;
   ...
   */
  static updateBatch(objs: Array_Type<DataDiagnostic>, srcObjs?: Array_Type<DataDiagnostic>, spec?: UpsertSpec): ObjList<DataDiagnostic> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<DataDiagnostic> | null>, spec?: UpsertSpec): ObjList<DataDiagnostic> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<DataDiagnostic>, srcObjs?: Array_Type<DataDiagnostic>, spec?: UpsertSpec): ObjList<DataDiagnostic> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<DataDiagnostic> | null>, spec?: UpsertSpec): ObjList<DataDiagnostic> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<DataDiagnostic>, spec?: TouchSpec): ObjList<DataDiagnostic> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<DataDiagnostic>, spec?: MergeSpec): ObjList<DataDiagnostic> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<DataDiagnostic>, mergeInclude: string, spec?: MergeSpec): ObjList<DataDiagnostic> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<DataDiagnostic> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<DataDiagnostic> | null;
   ...
   */
  static mergeAll(mergeObj: DataDiagnostic, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: DataDiagnostic, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<DataDiagnostic>, spec?: UpsertSpec): ObjList<DataDiagnostic> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<DataDiagnostic>, spec?: UpsertSpec): ObjList<DataDiagnostic> | null;
   ...
   */
  static beforeCreate(objs: Array_Type<DataDiagnostic>): ObjList<DataDiagnostic>;
   ...
   * {@link DataDiagnostic#filter} are all valid.
   */
  static beforeUpdate(objs: Array_Type<DataDiagnostic>): ObjList<DataDiagnostic>;
   ...
   */
  static beforeRemove(objs: Array_Type<DataDiagnostic>): ObjList<DataDiagnostic>;
   ...
   */
  static afterCreate(objs: Array_Type<DataDiagnostic>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<DataDiagnostic>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<DataDiagnostic>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<DataDiagnostic>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<DataDiagnostic>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): DataDiagnostic | null;
   ...
   */
  withoutIdentity(): DataDiagnostic | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<DataDiagnostic>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: DataDiagnostic, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<DataDiagnostic>, callback?: λFunction<DataDiagnostic | null, DataDiagnostic | null>): ObjList<DataDiagnostic>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<DataDiagnostic>, callback?: λFunction<DataDiagnostic | null, DataDiagnostic | null>): Array_Type<ObjError> | null;
   ...
   */
  retrieveEvalMetricsDiagnosticData(filter?: Filter, dataVariables?: DataDiagnostic, overrideDiagnosticSpec?: DataDiagnosticOverrideSpec = '{}'): EvalMetricsResult | null;
   ...
   */
  static processNewOrUpdatedDiagnostics(objs: Array_Type<DataDiagnostic>): ObjList<DataDiagnostic>;
