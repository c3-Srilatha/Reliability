// TypeScript definitions for the C3 type TestFacilityDataTagRelation

/**
 * A relation between a {@link TestFacilityDataTag} and a {@link TestFacility}.
 *
 * @remarks this represents a value passed to a method that expects an instance of TestFacilityDataTagRelation
 */
declare interface ITestFacilityDataTagRelation {
 ...
 */
declare class TestFacilityDataTagRelation extends Obj  {

  /**
   * The entity that is a part of this relation.
   */
  readonly from: TestFacility;
  withFrom(from: ITestFacility): TestFacilityDataTagRelation;

  /**
   * The {@link DataTag} being linked to the entity in this relation.
   */
  readonly to: TestFacilityDataTag;
  withTo(to: ITestFacilityDataTag): TestFacilityDataTagRelation;
   ...
   */
  readonly id: string;
  withId(id: string): TestFacilityDataTagRelation;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): TestFacilityDataTagRelation;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): TestFacilityDataTagRelation;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): TestFacilityDataTagRelation;
  ...
  withVersion(version: number | null): TestFacilityDataTagRelation;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): TestFacilityDataTagRelation;
   ...
   * @see #toJson
   */
  static fromJson(json: any): TestFacilityDataTagRelation | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): TestFacilityDataTagRelation | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): TestFacilityDataTagRelation | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): TestFacilityDataTagRelation | null;
   ...
   */
  replaceType(old: Type, new_: Type): TestFacilityDataTagRelation;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): TestFacilityDataTagRelation;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): TestFacilityDataTagRelation;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<TestFacilityDataTagRelation>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<TestFacilityDataTagRelation>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): TestFacilityDataTagRelation;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TestFacilityDataTagRelation;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TestFacilityDataTagRelation;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): TestFacilityDataTagRelation;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): TestFacilityDataTagRelation;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): TestFacilityDataTagRelation;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): TestFacilityDataTagRelation;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): TestFacilityDataTagRelation;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): TestFacilityDataTagRelation;
   ...
   * @see #removeField
   */
  withoutField(field: string): TestFacilityDataTagRelation;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): TestFacilityDataTagRelation;
   ...
   */
  withoutFields(fields: Array_Type<string>): TestFacilityDataTagRelation;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): TestFacilityDataTagRelation;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): TestFacilityDataTagRelation;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): TestFacilityDataTagRelation;
   ...
   * @see #unsetField
   */
  defaultField(field: string): TestFacilityDataTagRelation;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): TestFacilityDataTagRelation;
   ...
   * @see #removeField
   */
  unsetField(field: string): TestFacilityDataTagRelation;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): TestFacilityDataTagRelation;
   ...
   * @see #unsetField
   */
  removeField(field: string): TestFacilityDataTagRelation;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): TestFacilityDataTagRelation;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): TestFacilityDataTagRelation;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): TestFacilityDataTagRelation;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): TestFacilityDataTagRelation;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): TestFacilityDataTagRelation;

  mergeJson(json: any): TestFacilityDataTagRelation;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): TestFacilityDataTagRelation;
   ...
   */
  sumObj(other: Obj, deep?: boolean): TestFacilityDataTagRelation;
   ...
   */
  singletonArray(): Array_Type<TestFacilityDataTagRelation>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<TestFacilityDataTagRelation> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<TestFacilityDataTagRelation> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<TestFacilityDataTagRelation>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<TestFacilityDataTagRelation> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, TestFacilityDataTagRelation> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, TestFacilityDataTagRelation> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<TestFacilityDataTagRelation>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<TestFacilityDataTagRelation>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): TestFacilityDataTagRelation;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): TestFacilityDataTagRelation;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): TestFacilityDataTagRelation;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): TestFacilityDataTagRelation;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): TestFacilityDataTagRelation;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): TestFacilityDataTagRelation;
   ...
   * @see #fromString
   */
  static make(s: string): TestFacilityDataTagRelation | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): TestFacilityDataTagRelation;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): TestFacilityDataTagRelation;
   ...
   */
  static cachedEmptyInst(): TestFacilityDataTagRelation;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<TestFacilityDataTagRelation> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): TestFacilityDataTagRelation;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<TestFacilityDataTagRelation>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<TestFacilityDataTagRelation>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<TestFacilityDataTagRelation> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<TestFacilityDataTagRelation>> | null;
   ...
   */
  get(include?: string): TestFacilityDataTagRelation | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): TestFacilityDataTagRelation | null;
   ...
   */
  getMissing(spec: GetMissingSpec): TestFacilityDataTagRelation;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): TestFacilityDataTagRelation | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): TestFacilityDataTagRelation;
   ...
   * @see #toString
   */
  static fromString(s: string): TestFacilityDataTagRelation | null;
   ...
   */
  create(spec?: UpsertSpec): TestFacilityDataTagRelation | null;
   ...
   */
  static createBatch(objs: Array_Type<TestFacilityDataTagRelation>, spec?: UpsertSpec): ObjList<TestFacilityDataTagRelation> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<TestFacilityDataTagRelation>, spec?: CreateBatchObjStreamSpec): ObjList<TestFacilityDataTagRelation> | null;
   ...
   */
  update(srcObj?: TestFacilityDataTagRelation, spec?: UpsertSpec): TestFacilityDataTagRelation | null;
   ...
   */
  upsert(srcObj?: TestFacilityDataTagRelation, spec?: UpsertSpec): TestFacilityDataTagRelation | null;
   ...
   */
  merge(spec?: MergeSpec): TestFacilityDataTagRelation | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): TestFacilityDataTagRelation | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): TestFacilityDataTagRelation | null;
   ...
   */
  static updateBatch(objs: Array_Type<TestFacilityDataTagRelation>, srcObjs?: Array_Type<TestFacilityDataTagRelation>, spec?: UpsertSpec): ObjList<TestFacilityDataTagRelation> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<TestFacilityDataTagRelation> | null>, spec?: UpsertSpec): ObjList<TestFacilityDataTagRelation> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<TestFacilityDataTagRelation>, srcObjs?: Array_Type<TestFacilityDataTagRelation>, spec?: UpsertSpec): ObjList<TestFacilityDataTagRelation> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<TestFacilityDataTagRelation> | null>, spec?: UpsertSpec): ObjList<TestFacilityDataTagRelation> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<TestFacilityDataTagRelation>, spec?: TouchSpec): ObjList<TestFacilityDataTagRelation> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<TestFacilityDataTagRelation>, spec?: MergeSpec): ObjList<TestFacilityDataTagRelation> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<TestFacilityDataTagRelation>, mergeInclude: string, spec?: MergeSpec): ObjList<TestFacilityDataTagRelation> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<TestFacilityDataTagRelation> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<TestFacilityDataTagRelation> | null;
   ...
   */
  static mergeAll(mergeObj: TestFacilityDataTagRelation, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: TestFacilityDataTagRelation, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<TestFacilityDataTagRelation>, spec?: UpsertSpec): ObjList<TestFacilityDataTagRelation> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<TestFacilityDataTagRelation>, spec?: UpsertSpec): ObjList<TestFacilityDataTagRelation> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): TestFacilityDataTagRelation | null;
   ...
   */
  static beforeCreate(objs: Array_Type<TestFacilityDataTagRelation>): ObjList<TestFacilityDataTagRelation>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<TestFacilityDataTagRelation>): ObjList<TestFacilityDataTagRelation>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<TestFacilityDataTagRelation>): ObjList<TestFacilityDataTagRelation>;
   ...
   */
  static afterCreate(objs: Array_Type<TestFacilityDataTagRelation>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<TestFacilityDataTagRelation>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<TestFacilityDataTagRelation>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<TestFacilityDataTagRelation>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<TestFacilityDataTagRelation>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): TestFacilityDataTagRelation | null;
   ...
   */
  withoutIdentity(): TestFacilityDataTagRelation | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<TestFacilityDataTagRelation>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: TestFacilityDataTagRelation, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<TestFacilityDataTagRelation>, callback?: λFunction<TestFacilityDataTagRelation | null, TestFacilityDataTagRelation | null>): ObjList<TestFacilityDataTagRelation>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<TestFacilityDataTagRelation>, callback?: λFunction<TestFacilityDataTagRelation | null, TestFacilityDataTagRelation | null>): Array_Type<ObjError> | null;
