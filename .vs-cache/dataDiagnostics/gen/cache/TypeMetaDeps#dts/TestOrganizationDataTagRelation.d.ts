// TypeScript definitions for the C3 type TestOrganizationDataTagRelation

/**
 * A relation between a {@link TestOrganizationDataTag} and a {@link TestOrg}.
 *
 * @remarks this represents a value passed to a method that expects an instance of TestOrganizationDataTagRelation
 */
declare interface ITestOrganizationDataTagRelation {
 ...
 */
declare class TestOrganizationDataTagRelation extends Obj  {

  /**
   * The entity that is a part of this relation.
   */
  readonly from: TestOrg;
  withFrom(from: ITestOrg): TestOrganizationDataTagRelation;

  /**
   * The {@link DataTag} being linked to the entity in this relation.
   */
  readonly to: TestOrganizationDataTag;
  withTo(to: ITestOrganizationDataTag): TestOrganizationDataTagRelation;
   ...
   */
  readonly id: string;
  withId(id: string): TestOrganizationDataTagRelation;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): TestOrganizationDataTagRelation;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): TestOrganizationDataTagRelation;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): TestOrganizationDataTagRelation;
  ...
  withVersion(version: number | null): TestOrganizationDataTagRelation;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): TestOrganizationDataTagRelation;
   ...
   * @see #toJson
   */
  static fromJson(json: any): TestOrganizationDataTagRelation | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): TestOrganizationDataTagRelation | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): TestOrganizationDataTagRelation | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): TestOrganizationDataTagRelation | null;
   ...
   */
  replaceType(old: Type, new_: Type): TestOrganizationDataTagRelation;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): TestOrganizationDataTagRelation;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): TestOrganizationDataTagRelation;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<TestOrganizationDataTagRelation>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<TestOrganizationDataTagRelation>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): TestOrganizationDataTagRelation;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TestOrganizationDataTagRelation;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TestOrganizationDataTagRelation;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): TestOrganizationDataTagRelation;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): TestOrganizationDataTagRelation;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): TestOrganizationDataTagRelation;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): TestOrganizationDataTagRelation;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): TestOrganizationDataTagRelation;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): TestOrganizationDataTagRelation;
   ...
   * @see #removeField
   */
  withoutField(field: string): TestOrganizationDataTagRelation;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): TestOrganizationDataTagRelation;
   ...
   */
  withoutFields(fields: Array_Type<string>): TestOrganizationDataTagRelation;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): TestOrganizationDataTagRelation;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): TestOrganizationDataTagRelation;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): TestOrganizationDataTagRelation;
   ...
   * @see #unsetField
   */
  defaultField(field: string): TestOrganizationDataTagRelation;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): TestOrganizationDataTagRelation;
   ...
   * @see #removeField
   */
  unsetField(field: string): TestOrganizationDataTagRelation;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): TestOrganizationDataTagRelation;
   ...
   * @see #unsetField
   */
  removeField(field: string): TestOrganizationDataTagRelation;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): TestOrganizationDataTagRelation;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): TestOrganizationDataTagRelation;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): TestOrganizationDataTagRelation;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): TestOrganizationDataTagRelation;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): TestOrganizationDataTagRelation;

  mergeJson(json: any): TestOrganizationDataTagRelation;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): TestOrganizationDataTagRelation;
   ...
   */
  sumObj(other: Obj, deep?: boolean): TestOrganizationDataTagRelation;
   ...
   */
  singletonArray(): Array_Type<TestOrganizationDataTagRelation>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<TestOrganizationDataTagRelation> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<TestOrganizationDataTagRelation> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<TestOrganizationDataTagRelation>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<TestOrganizationDataTagRelation> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, TestOrganizationDataTagRelation> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, TestOrganizationDataTagRelation> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<TestOrganizationDataTagRelation>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<TestOrganizationDataTagRelation>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): TestOrganizationDataTagRelation;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): TestOrganizationDataTagRelation;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): TestOrganizationDataTagRelation;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): TestOrganizationDataTagRelation;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): TestOrganizationDataTagRelation;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): TestOrganizationDataTagRelation;
   ...
   * @see #fromString
   */
  static make(s: string): TestOrganizationDataTagRelation | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): TestOrganizationDataTagRelation;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): TestOrganizationDataTagRelation;
   ...
   */
  static cachedEmptyInst(): TestOrganizationDataTagRelation;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<TestOrganizationDataTagRelation> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): TestOrganizationDataTagRelation;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<TestOrganizationDataTagRelation>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<TestOrganizationDataTagRelation>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<TestOrganizationDataTagRelation> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<TestOrganizationDataTagRelation>> | null;
   ...
   */
  get(include?: string): TestOrganizationDataTagRelation | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): TestOrganizationDataTagRelation | null;
   ...
   */
  getMissing(spec: GetMissingSpec): TestOrganizationDataTagRelation;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): TestOrganizationDataTagRelation | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): TestOrganizationDataTagRelation;
   ...
   * @see #toString
   */
  static fromString(s: string): TestOrganizationDataTagRelation | null;
   ...
   */
  create(spec?: UpsertSpec): TestOrganizationDataTagRelation | null;
   ...
   */
  static createBatch(objs: Array_Type<TestOrganizationDataTagRelation>, spec?: UpsertSpec): ObjList<TestOrganizationDataTagRelation> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<TestOrganizationDataTagRelation>, spec?: CreateBatchObjStreamSpec): ObjList<TestOrganizationDataTagRelation> | null;
   ...
   */
  update(srcObj?: TestOrganizationDataTagRelation, spec?: UpsertSpec): TestOrganizationDataTagRelation | null;
   ...
   */
  upsert(srcObj?: TestOrganizationDataTagRelation, spec?: UpsertSpec): TestOrganizationDataTagRelation | null;
   ...
   */
  merge(spec?: MergeSpec): TestOrganizationDataTagRelation | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): TestOrganizationDataTagRelation | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): TestOrganizationDataTagRelation | null;
   ...
   */
  static updateBatch(objs: Array_Type<TestOrganizationDataTagRelation>, srcObjs?: Array_Type<TestOrganizationDataTagRelation>, spec?: UpsertSpec): ObjList<TestOrganizationDataTagRelation> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<TestOrganizationDataTagRelation> | null>, spec?: UpsertSpec): ObjList<TestOrganizationDataTagRelation> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<TestOrganizationDataTagRelation>, srcObjs?: Array_Type<TestOrganizationDataTagRelation>, spec?: UpsertSpec): ObjList<TestOrganizationDataTagRelation> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<TestOrganizationDataTagRelation> | null>, spec?: UpsertSpec): ObjList<TestOrganizationDataTagRelation> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<TestOrganizationDataTagRelation>, spec?: TouchSpec): ObjList<TestOrganizationDataTagRelation> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<TestOrganizationDataTagRelation>, spec?: MergeSpec): ObjList<TestOrganizationDataTagRelation> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<TestOrganizationDataTagRelation>, mergeInclude: string, spec?: MergeSpec): ObjList<TestOrganizationDataTagRelation> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<TestOrganizationDataTagRelation> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<TestOrganizationDataTagRelation> | null;
   ...
   */
  static mergeAll(mergeObj: TestOrganizationDataTagRelation, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: TestOrganizationDataTagRelation, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<TestOrganizationDataTagRelation>, spec?: UpsertSpec): ObjList<TestOrganizationDataTagRelation> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<TestOrganizationDataTagRelation>, spec?: UpsertSpec): ObjList<TestOrganizationDataTagRelation> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): TestOrganizationDataTagRelation | null;
   ...
   */
  static beforeCreate(objs: Array_Type<TestOrganizationDataTagRelation>): ObjList<TestOrganizationDataTagRelation>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<TestOrganizationDataTagRelation>): ObjList<TestOrganizationDataTagRelation>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<TestOrganizationDataTagRelation>): ObjList<TestOrganizationDataTagRelation>;
   ...
   */
  static afterCreate(objs: Array_Type<TestOrganizationDataTagRelation>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<TestOrganizationDataTagRelation>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<TestOrganizationDataTagRelation>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<TestOrganizationDataTagRelation>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<TestOrganizationDataTagRelation>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): TestOrganizationDataTagRelation | null;
   ...
   */
  withoutIdentity(): TestOrganizationDataTagRelation | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<TestOrganizationDataTagRelation>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: TestOrganizationDataTagRelation, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<TestOrganizationDataTagRelation>, callback?: λFunction<TestOrganizationDataTagRelation | null, TestOrganizationDataTagRelation | null>): ObjList<TestOrganizationDataTagRelation>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<TestOrganizationDataTagRelation>, callback?: λFunction<TestOrganizationDataTagRelation | null, TestOrganizationDataTagRelation | null>): Array_Type<ObjError> | null;
