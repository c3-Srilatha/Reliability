// TypeScript definitions for the C3 type TestServicePointTwoDataTagRelation

/**
 * Type to test the {@link DataTagBase} and {@link DataTagRelationBase} functionality.
 *
 * @remarks this represents a value passed to a method that expects an instance of TestServicePointTwoDataTagRelation
 */
declare interface ITestServicePointTwoDataTagRelation {

  /**
   * The entity that is a part of this relation.
   */
  from: ITestServicePointTwo;
 ...
 */
declare class TestServicePointTwoDataTagRelation extends Obj  {

  /**
   * The entity that is a part of this relation.
   */
  readonly from: TestServicePointTwo;
  withFrom(from: ITestServicePointTwo): TestServicePointTwoDataTagRelation;

  /**
   * The {@link DataTagBase} being linked to the entity in this relation.
   */
  readonly to: DataTagBase;
  withTo(to: IDataTagBase): TestServicePointTwoDataTagRelation;
   ...
   */
  readonly id: string;
  withId(id: string): TestServicePointTwoDataTagRelation;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): TestServicePointTwoDataTagRelation;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): TestServicePointTwoDataTagRelation;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): TestServicePointTwoDataTagRelation;
  ...
  withVersion(version: number | null): TestServicePointTwoDataTagRelation;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): TestServicePointTwoDataTagRelation;
   ...
   * @see #toJson
   */
  static fromJson(json: any): TestServicePointTwoDataTagRelation | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): TestServicePointTwoDataTagRelation | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): TestServicePointTwoDataTagRelation | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): TestServicePointTwoDataTagRelation | null;
   ...
   */
  replaceType(old: Type, new_: Type): TestServicePointTwoDataTagRelation;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): TestServicePointTwoDataTagRelation;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): TestServicePointTwoDataTagRelation;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<TestServicePointTwoDataTagRelation>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<TestServicePointTwoDataTagRelation>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): TestServicePointTwoDataTagRelation;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TestServicePointTwoDataTagRelation;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TestServicePointTwoDataTagRelation;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): TestServicePointTwoDataTagRelation;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): TestServicePointTwoDataTagRelation;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): TestServicePointTwoDataTagRelation;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): TestServicePointTwoDataTagRelation;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): TestServicePointTwoDataTagRelation;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): TestServicePointTwoDataTagRelation;
   ...
   * @see #removeField
   */
  withoutField(field: string): TestServicePointTwoDataTagRelation;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): TestServicePointTwoDataTagRelation;
   ...
   */
  withoutFields(fields: Array_Type<string>): TestServicePointTwoDataTagRelation;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): TestServicePointTwoDataTagRelation;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): TestServicePointTwoDataTagRelation;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): TestServicePointTwoDataTagRelation;
   ...
   * @see #unsetField
   */
  defaultField(field: string): TestServicePointTwoDataTagRelation;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): TestServicePointTwoDataTagRelation;
   ...
   * @see #removeField
   */
  unsetField(field: string): TestServicePointTwoDataTagRelation;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): TestServicePointTwoDataTagRelation;
   ...
   * @see #unsetField
   */
  removeField(field: string): TestServicePointTwoDataTagRelation;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): TestServicePointTwoDataTagRelation;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): TestServicePointTwoDataTagRelation;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): TestServicePointTwoDataTagRelation;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): TestServicePointTwoDataTagRelation;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): TestServicePointTwoDataTagRelation;

  mergeJson(json: any): TestServicePointTwoDataTagRelation;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): TestServicePointTwoDataTagRelation;
   ...
   */
  sumObj(other: Obj, deep?: boolean): TestServicePointTwoDataTagRelation;
   ...
   */
  singletonArray(): Array_Type<TestServicePointTwoDataTagRelation>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<TestServicePointTwoDataTagRelation> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<TestServicePointTwoDataTagRelation> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<TestServicePointTwoDataTagRelation>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<TestServicePointTwoDataTagRelation> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, TestServicePointTwoDataTagRelation> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, TestServicePointTwoDataTagRelation> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<TestServicePointTwoDataTagRelation>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<TestServicePointTwoDataTagRelation>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): TestServicePointTwoDataTagRelation;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): TestServicePointTwoDataTagRelation;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): TestServicePointTwoDataTagRelation;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): TestServicePointTwoDataTagRelation;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): TestServicePointTwoDataTagRelation;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): TestServicePointTwoDataTagRelation;
   ...
   * @see #fromString
   */
  static make(s: string): TestServicePointTwoDataTagRelation | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): TestServicePointTwoDataTagRelation;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): TestServicePointTwoDataTagRelation;
   ...
   */
  static cachedEmptyInst(): TestServicePointTwoDataTagRelation;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<TestServicePointTwoDataTagRelation> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): TestServicePointTwoDataTagRelation;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<TestServicePointTwoDataTagRelation>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<TestServicePointTwoDataTagRelation>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<TestServicePointTwoDataTagRelation> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<TestServicePointTwoDataTagRelation>> | null;
   ...
   */
  get(include?: string): TestServicePointTwoDataTagRelation | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): TestServicePointTwoDataTagRelation | null;
   ...
   */
  getMissing(spec: GetMissingSpec): TestServicePointTwoDataTagRelation;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): TestServicePointTwoDataTagRelation | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): TestServicePointTwoDataTagRelation;
   ...
   * @see #toString
   */
  static fromString(s: string): TestServicePointTwoDataTagRelation | null;
   ...
   */
  create(spec?: UpsertSpec): TestServicePointTwoDataTagRelation | null;
   ...
   */
  static createBatch(objs: Array_Type<TestServicePointTwoDataTagRelation>, spec?: UpsertSpec): ObjList<TestServicePointTwoDataTagRelation> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<TestServicePointTwoDataTagRelation>, spec?: CreateBatchObjStreamSpec): ObjList<TestServicePointTwoDataTagRelation> | null;
   ...
   */
  update(srcObj?: TestServicePointTwoDataTagRelation, spec?: UpsertSpec): TestServicePointTwoDataTagRelation | null;
   ...
   */
  upsert(srcObj?: TestServicePointTwoDataTagRelation, spec?: UpsertSpec): TestServicePointTwoDataTagRelation | null;
   ...
   */
  merge(spec?: MergeSpec): TestServicePointTwoDataTagRelation | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): TestServicePointTwoDataTagRelation | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): TestServicePointTwoDataTagRelation | null;
   ...
   */
  static updateBatch(objs: Array_Type<TestServicePointTwoDataTagRelation>, srcObjs?: Array_Type<TestServicePointTwoDataTagRelation>, spec?: UpsertSpec): ObjList<TestServicePointTwoDataTagRelation> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<TestServicePointTwoDataTagRelation> | null>, spec?: UpsertSpec): ObjList<TestServicePointTwoDataTagRelation> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<TestServicePointTwoDataTagRelation>, srcObjs?: Array_Type<TestServicePointTwoDataTagRelation>, spec?: UpsertSpec): ObjList<TestServicePointTwoDataTagRelation> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<TestServicePointTwoDataTagRelation> | null>, spec?: UpsertSpec): ObjList<TestServicePointTwoDataTagRelation> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<TestServicePointTwoDataTagRelation>, spec?: TouchSpec): ObjList<TestServicePointTwoDataTagRelation> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<TestServicePointTwoDataTagRelation>, spec?: MergeSpec): ObjList<TestServicePointTwoDataTagRelation> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<TestServicePointTwoDataTagRelation>, mergeInclude: string, spec?: MergeSpec): ObjList<TestServicePointTwoDataTagRelation> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<TestServicePointTwoDataTagRelation> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<TestServicePointTwoDataTagRelation> | null;
   ...
   */
  static mergeAll(mergeObj: TestServicePointTwoDataTagRelation, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: TestServicePointTwoDataTagRelation, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<TestServicePointTwoDataTagRelation>, spec?: UpsertSpec): ObjList<TestServicePointTwoDataTagRelation> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<TestServicePointTwoDataTagRelation>, spec?: UpsertSpec): ObjList<TestServicePointTwoDataTagRelation> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): TestServicePointTwoDataTagRelation | null;
   ...
   */
  static beforeCreate(objs: Array_Type<TestServicePointTwoDataTagRelation>): ObjList<TestServicePointTwoDataTagRelation>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<TestServicePointTwoDataTagRelation>): ObjList<TestServicePointTwoDataTagRelation>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<TestServicePointTwoDataTagRelation>): ObjList<TestServicePointTwoDataTagRelation>;
   ...
   */
  static afterCreate(objs: Array_Type<TestServicePointTwoDataTagRelation>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<TestServicePointTwoDataTagRelation>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<TestServicePointTwoDataTagRelation>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<TestServicePointTwoDataTagRelation>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<TestServicePointTwoDataTagRelation>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): TestServicePointTwoDataTagRelation | null;
   ...
   */
  withoutIdentity(): TestServicePointTwoDataTagRelation | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<TestServicePointTwoDataTagRelation>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: TestServicePointTwoDataTagRelation, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<TestServicePointTwoDataTagRelation>, callback?: λFunction<TestServicePointTwoDataTagRelation | null, TestServicePointTwoDataTagRelation | null>): ObjList<TestServicePointTwoDataTagRelation>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<TestServicePointTwoDataTagRelation>, callback?: λFunction<TestServicePointTwoDataTagRelation | null, TestServicePointTwoDataTagRelation | null>): Array_Type<ObjError> | null;
