// TypeScript definitions for the C3 type TestFacilityDataTag

/**
 * A data tag for the {@link TestFacility} entity.
 *
 * @remarks this represents a value passed to a method that expects an instance of TestFacilityDataTag
 */
declare interface ITestFacilityDataTag {
   ...
   */
  whiteListedEntities?: Array_Type<TestFacilityDataTagEntityRelation> | Array<ITestFacilityDataTagEntityRelation>;
   ...
   */
  blackListedEntities?: Array_Type<TestFacilityDataTagEntityRelation> | Array<ITestFacilityDataTagEntityRelation>;
 ...
 * A data tag for the {@link TestFacility} entity.
 *
 * @remarks this represents a made instance of TestFacilityDataTag
 */
declare class TestFacilityDataTag extends Obj  {

  /**
   * The entities of a certain Type which this data diagnostic logic should be run on.
   * Gets "OR"ed with the filter on this data diagnostic during evaluation.
   */
  readonly whiteListedEntities?: Array_Type<TestFacilityDataTagEntityRelation>;
  withWhiteListedEntities(whiteListedEntities: Array_Type<TestFacilityDataTagEntityRelation> | Array<ITestFacilityDataTagEntityRelation> | null): TestFacilityDataTag;

  /**
   * The entities of type srcType which this data diagnostic logic should not be run on.
   * Gets "AND"ed with the filter on this data diagnostic during evaluation.
   */
  readonly blackListedEntities?: Array_Type<TestFacilityDataTagEntityRelation>;
  withBlackListedEntities(blackListedEntities: Array_Type<TestFacilityDataTagEntityRelation> | Array<ITestFacilityDataTagEntityRelation> | null): TestFacilityDataTag;
  ...
  withTypeIdent(typeIdent: string | null): TestFacilityDataTag;
   ...
   */
  readonly id: string;
  withId(id: string): TestFacilityDataTag;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): TestFacilityDataTag;
  ...
  withName(name: string): TestFacilityDataTag;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): TestFacilityDataTag;
  ...
  withVersion(version: number | null): TestFacilityDataTag;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): TestFacilityDataTag;

  /**
   * The entity type which this data diagnostic is running logic for.
   */
  readonly srcType: Type;
  withSrcType(srcType: IType): TestFacilityDataTag;

  /**
   * High level description of what this data diagnostic is doing.
   */
  readonly description?: string;
  withDescription(description: string | null): TestFacilityDataTag;

  /**
   * The metric expression used in the data diagnostic logic.
   */
  readonly metricExpression?: string;
  withMetricExpression(metricExpression: string | null): TestFacilityDataTag;
  ...
  withOverrideSimpleMetrics(overrideSimpleMetrics: Array_Type<SimpleMetric> | Array<ISimpleMetric> | null): TestFacilityDataTag;
  ...
  withOverrideCompoundMetrics(overrideCompoundMetrics: Array_Type<CompoundMetric> | Array<ICompoundMetric> | null): TestFacilityDataTag;

  /**
   * The unit used in the metric evaluation of the diagnostic logic.
   */
  readonly unit?: Unit;
  withUnit(unit: IUnit | null): TestFacilityDataTag;

  /**
   * Bindings to use with any metrics invoked by the metric expression.
   */
  readonly bindings?: Map_Type<string, any>;
  withBindings(bindings: Map_Type<string, any> | {[key: string]: any} | null): TestFacilityDataTag;

  /**
   * The {@link EvalMetricsOptions} to use when running the evalMetrics call.
   */
  readonly options?: EvalMetricsOptions;
  withOptions(options: IEvalMetricsOptions | null): TestFacilityDataTag;
  ...
  withRequiredBindings(requiredBindings: Array_Type<string> | Array<string> | null): TestFacilityDataTag;

  /**
   * Field to override bindings for specific {@link #srcType} entities.
   */
  readonly entitySpecificBindings?: Map_Type<string, OverrideBindings>;
  withEntitySpecificBindings(entitySpecificBindings: Map_Type<string, OverrideBindings> | {[key: string]: IOverrideBindings} | null): TestFacilityDataTag;
  ...
  withBatchConfig(batchConfig: IDataDiagnosticBatchConfig | null): TestFacilityDataTag;

  /**
   * {@link Interval} used for the metric evaluation.
   */
  readonly interval?: string;
  withInterval(interval: string | null): TestFacilityDataTag;

  /**
   * The {@link Period} of time the diagnostic runs the eval metric call on.
   */
  readonly period?: Period;
  withPeriod(period: IPeriod | null): TestFacilityDataTag;

  /**
   * The timezone the used in the evaluation of the metric.
   */
  readonly timeZone?: string;
  withTimeZone(timeZone: string | null): TestFacilityDataTag;

  /**
   * The cron job which will run this data diagnostic logic on a set schedule.
   */
  readonly cronJob?: CronJob;
  withCronJob(cronJob: ICronJob | null): TestFacilityDataTag;

  /**
   * A filter used to retrieve entities of type `srcType` to run the data diagnostic logic on.
   */
  readonly filter: Filter;
  withFilter(filter: IFilter): TestFacilityDataTag;

  /**
   * Include string to within the {@link FetchSpec} if the diagnostic is configured to perform a fetch.
   */
  readonly fetchInclude?: string;
  withFetchInclude(fetchInclude: string | null): TestFacilityDataTag;
  ...
  withExpression(expression: string | null): TestFacilityDataTag;
  ...
  withReferentialIntegrityString(referentialIntegrityString: string | null): TestFacilityDataTag;
  ...
  withEnabled(enabled: boolean): TestFacilityDataTag;

  /**
   * Lambda function that can be used to override the existing logic on a type that extends {@link DataDiagnostic}.
   */
  readonly customDiagnosticLogic?: λConsumer<any | null>;
  withCustomDiagnosticLogic(customDiagnosticLogic: λConsumer<any | null> | null): TestFacilityDataTag;

  /**
   * The history of counts and percentages of the {@link DataTagRelation}s for this data tag.
   */
  readonly countHistory?: Array_Type<DataTagCountHistory>;
  withCountHistory(countHistory: Array_Type<DataTagCountHistory> | Array<IDataTagCountHistory> | null): TestFacilityDataTag;
   ...
   * @see #toJson
   */
  static fromJson(json: any): TestFacilityDataTag | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): TestFacilityDataTag | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): TestFacilityDataTag | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): TestFacilityDataTag | null;
   ...
   */
  replaceType(old: Type, new_: Type): TestFacilityDataTag;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): TestFacilityDataTag;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): TestFacilityDataTag;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<TestFacilityDataTag>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<TestFacilityDataTag>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): TestFacilityDataTag;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TestFacilityDataTag;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TestFacilityDataTag;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): TestFacilityDataTag;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): TestFacilityDataTag;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): TestFacilityDataTag;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): TestFacilityDataTag;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): TestFacilityDataTag;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): TestFacilityDataTag;
   ...
   * @see #removeField
   */
  withoutField(field: string): TestFacilityDataTag;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): TestFacilityDataTag;
   ...
   */
  withoutFields(fields: Array_Type<string>): TestFacilityDataTag;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): TestFacilityDataTag;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): TestFacilityDataTag;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): TestFacilityDataTag;
   ...
   * @see #unsetField
   */
  defaultField(field: string): TestFacilityDataTag;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): TestFacilityDataTag;
   ...
   * @see #removeField
   */
  unsetField(field: string): TestFacilityDataTag;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): TestFacilityDataTag;
   ...
   * @see #unsetField
   */
  removeField(field: string): TestFacilityDataTag;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): TestFacilityDataTag;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): TestFacilityDataTag;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): TestFacilityDataTag;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): TestFacilityDataTag;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): TestFacilityDataTag;

  mergeJson(json: any): TestFacilityDataTag;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): TestFacilityDataTag;
   ...
   */
  sumObj(other: Obj, deep?: boolean): TestFacilityDataTag;
   ...
   */
  singletonArray(): Array_Type<TestFacilityDataTag>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<TestFacilityDataTag> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<TestFacilityDataTag> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<TestFacilityDataTag>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<TestFacilityDataTag> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, TestFacilityDataTag> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, TestFacilityDataTag> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<TestFacilityDataTag>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<TestFacilityDataTag>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): TestFacilityDataTag;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): TestFacilityDataTag;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): TestFacilityDataTag;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): TestFacilityDataTag;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): TestFacilityDataTag;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): TestFacilityDataTag;
   ...
   * @see #fromString
   */
  static make(s: string): TestFacilityDataTag | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): TestFacilityDataTag;
   ...
   */
  static cachedEmptyInst(): TestFacilityDataTag;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<TestFacilityDataTag> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): TestFacilityDataTag;
   ...
   */
  addEntityToWhiteList(id: string): TestFacilityDataTagEntityRelation | null;

  /**
   * Add the entiy with this id to the blacklist of entities, if there is such an entity with that id.
   */
  addEntityToBlackList(id: string): TestFacilityDataTagEntityRelation | null;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<TestFacilityDataTag>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<TestFacilityDataTag>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<TestFacilityDataTag> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<TestFacilityDataTag>> | null;
   ...
   */
  static evalFeatureSetBatch(batch: Array_Type<TestFacilityDataTag>, featureSet: Feature.Set, spec?: EvalFeatureSpec): Data | null;
   ...
   * ```
   */
  static evalFeaturesBatch(batch: Array_Type<TestFacilityDataTag>, features: Array_Type<string>, spec?: EvalFeaturesSpec): Data | null;
   ...
   */
  get(include?: string): TestFacilityDataTag | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): TestFacilityDataTag | null;
   ...
   */
  getMissing(spec: GetMissingSpec): TestFacilityDataTag;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): TestFacilityDataTag | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): TestFacilityDataTag;
   ...
   * @see #toString
   */
  static fromString(s: string): TestFacilityDataTag | null;
   ...
   */
  create(spec?: UpsertSpec): TestFacilityDataTag | null;
   ...
   */
  static createBatch(objs: Array_Type<TestFacilityDataTag>, spec?: UpsertSpec): ObjList<TestFacilityDataTag> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<TestFacilityDataTag>, spec?: CreateBatchObjStreamSpec): ObjList<TestFacilityDataTag> | null;
   ...
   */
  update(srcObj?: TestFacilityDataTag, spec?: UpsertSpec): TestFacilityDataTag | null;
   ...
   */
  upsert(srcObj?: TestFacilityDataTag, spec?: UpsertSpec): TestFacilityDataTag | null;
   ...
   */
  merge(spec?: MergeSpec): TestFacilityDataTag | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): TestFacilityDataTag | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): TestFacilityDataTag | null;
   ...
   */
  static updateBatch(objs: Array_Type<TestFacilityDataTag>, srcObjs?: Array_Type<TestFacilityDataTag>, spec?: UpsertSpec): ObjList<TestFacilityDataTag> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<TestFacilityDataTag> | null>, spec?: UpsertSpec): ObjList<TestFacilityDataTag> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<TestFacilityDataTag>, srcObjs?: Array_Type<TestFacilityDataTag>, spec?: UpsertSpec): ObjList<TestFacilityDataTag> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<TestFacilityDataTag> | null>, spec?: UpsertSpec): ObjList<TestFacilityDataTag> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<TestFacilityDataTag>, spec?: TouchSpec): ObjList<TestFacilityDataTag> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<TestFacilityDataTag>, spec?: MergeSpec): ObjList<TestFacilityDataTag> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<TestFacilityDataTag>, mergeInclude: string, spec?: MergeSpec): ObjList<TestFacilityDataTag> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<TestFacilityDataTag> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<TestFacilityDataTag> | null;
   ...
   */
  static mergeAll(mergeObj: TestFacilityDataTag, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: TestFacilityDataTag, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<TestFacilityDataTag>, spec?: UpsertSpec): ObjList<TestFacilityDataTag> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<TestFacilityDataTag>, spec?: UpsertSpec): ObjList<TestFacilityDataTag> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): TestFacilityDataTag | null;
   ...
   */
  static beforeCreate(objs: Array_Type<TestFacilityDataTag>): ObjList<TestFacilityDataTag>;
   ...
   * {@link DataDiagnostic#filter} are all valid.
   */
  static beforeUpdate(objs: Array_Type<TestFacilityDataTag>): ObjList<TestFacilityDataTag>;
   ...
   */
  static beforeRemove(objs: Array_Type<TestFacilityDataTag>): ObjList<TestFacilityDataTag>;
   ...
   */
  static afterCreate(objs: Array_Type<TestFacilityDataTag>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<TestFacilityDataTag>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<TestFacilityDataTag>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<TestFacilityDataTag>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<TestFacilityDataTag>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): TestFacilityDataTag | null;
   ...
   */
  withoutIdentity(): TestFacilityDataTag | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<TestFacilityDataTag>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: TestFacilityDataTag, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<TestFacilityDataTag>, callback?: λFunction<TestFacilityDataTag | null, TestFacilityDataTag | null>): ObjList<TestFacilityDataTag>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<TestFacilityDataTag>, callback?: λFunction<TestFacilityDataTag | null, TestFacilityDataTag | null>): Array_Type<ObjError> | null;
   ...
   */
  retrieveEvalMetricsDiagnosticData(filter?: Filter, dataVariables?: TestFacilityDataTag, overrideDiagnosticSpec?: DataDiagnosticOverrideSpec = '{}'): EvalMetricsResult | null;
   ...
   */
  static processNewOrUpdatedDiagnostics(objs: Array_Type<TestFacilityDataTag>): ObjList<TestFacilityDataTag>;
