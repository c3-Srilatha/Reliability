// TypeScript definitions for the C3 type TestOrganizationDataTag

/**
 * A data tag for the {@link TestOrg} entity.
 *
 * @remarks this represents a value passed to a method that expects an instance of TestOrganizationDataTag
 */
declare interface ITestOrganizationDataTag {
   ...
   */
  whiteListedEntities?: Array_Type<TestOrganizationDataTagEntityRelation> | Array<ITestOrganizationDataTagEntityRelation>;
   ...
   */
  blackListedEntities?: Array_Type<TestOrganizationDataTagEntityRelation> | Array<ITestOrganizationDataTagEntityRelation>;
 ...
 * A data tag for the {@link TestOrg} entity.
 *
 * @remarks this represents a made instance of TestOrganizationDataTag
 */
declare class TestOrganizationDataTag extends Obj  {

  /**
   * The entities of a certain Type which this data diagnostic logic should be run on.
   * Gets "OR"ed with the filter on this data diagnostic during evaluation.
   */
  readonly whiteListedEntities?: Array_Type<TestOrganizationDataTagEntityRelation>;
  withWhiteListedEntities(whiteListedEntities: Array_Type<TestOrganizationDataTagEntityRelation> | Array<ITestOrganizationDataTagEntityRelation> | null): TestOrganizationDataTag;

  /**
   * The entities of type srcType which this data diagnostic logic should not be run on.
   * Gets "AND"ed with the filter on this data diagnostic during evaluation.
   */
  readonly blackListedEntities?: Array_Type<TestOrganizationDataTagEntityRelation>;
  withBlackListedEntities(blackListedEntities: Array_Type<TestOrganizationDataTagEntityRelation> | Array<ITestOrganizationDataTagEntityRelation> | null): TestOrganizationDataTag;
  ...
  withTypeIdent(typeIdent: string | null): TestOrganizationDataTag;
   ...
   */
  readonly id: string;
  withId(id: string): TestOrganizationDataTag;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): TestOrganizationDataTag;
  ...
  withName(name: string): TestOrganizationDataTag;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): TestOrganizationDataTag;
  ...
  withVersion(version: number | null): TestOrganizationDataTag;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): TestOrganizationDataTag;

  /**
   * The entity type which this data diagnostic is running logic for.
   */
  readonly srcType: Type;
  withSrcType(srcType: IType): TestOrganizationDataTag;

  /**
   * High level description of what this data diagnostic is doing.
   */
  readonly description?: string;
  withDescription(description: string | null): TestOrganizationDataTag;

  /**
   * The metric expression used in the data diagnostic logic.
   */
  readonly metricExpression?: string;
  withMetricExpression(metricExpression: string | null): TestOrganizationDataTag;
  ...
  withOverrideSimpleMetrics(overrideSimpleMetrics: Array_Type<SimpleMetric> | Array<ISimpleMetric> | null): TestOrganizationDataTag;
  ...
  withOverrideCompoundMetrics(overrideCompoundMetrics: Array_Type<CompoundMetric> | Array<ICompoundMetric> | null): TestOrganizationDataTag;

  /**
   * The unit used in the metric evaluation of the diagnostic logic.
   */
  readonly unit?: Unit;
  withUnit(unit: IUnit | null): TestOrganizationDataTag;

  /**
   * Bindings to use with any metrics invoked by the metric expression.
   */
  readonly bindings?: Map_Type<string, any>;
  withBindings(bindings: Map_Type<string, any> | {[key: string]: any} | null): TestOrganizationDataTag;

  /**
   * The {@link EvalMetricsOptions} to use when running the evalMetrics call.
   */
  readonly options?: EvalMetricsOptions;
  withOptions(options: IEvalMetricsOptions | null): TestOrganizationDataTag;
  ...
  withRequiredBindings(requiredBindings: Array_Type<string> | Array<string> | null): TestOrganizationDataTag;

  /**
   * Field to override bindings for specific {@link #srcType} entities.
   */
  readonly entitySpecificBindings?: Map_Type<string, OverrideBindings>;
  withEntitySpecificBindings(entitySpecificBindings: Map_Type<string, OverrideBindings> | {[key: string]: IOverrideBindings} | null): TestOrganizationDataTag;
  ...
  withBatchConfig(batchConfig: IDataDiagnosticBatchConfig | null): TestOrganizationDataTag;

  /**
   * {@link Interval} used for the metric evaluation.
   */
  readonly interval?: string;
  withInterval(interval: string | null): TestOrganizationDataTag;

  /**
   * The {@link Period} of time the diagnostic runs the eval metric call on.
   */
  readonly period?: Period;
  withPeriod(period: IPeriod | null): TestOrganizationDataTag;

  /**
   * The timezone the used in the evaluation of the metric.
   */
  readonly timeZone?: string;
  withTimeZone(timeZone: string | null): TestOrganizationDataTag;

  /**
   * The cron job which will run this data diagnostic logic on a set schedule.
   */
  readonly cronJob?: CronJob;
  withCronJob(cronJob: ICronJob | null): TestOrganizationDataTag;

  /**
   * A filter used to retrieve entities of type `srcType` to run the data diagnostic logic on.
   */
  readonly filter: Filter;
  withFilter(filter: IFilter): TestOrganizationDataTag;

  /**
   * Include string to within the {@link FetchSpec} if the diagnostic is configured to perform a fetch.
   */
  readonly fetchInclude?: string;
  withFetchInclude(fetchInclude: string | null): TestOrganizationDataTag;
  ...
  withExpression(expression: string | null): TestOrganizationDataTag;
  ...
  withReferentialIntegrityString(referentialIntegrityString: string | null): TestOrganizationDataTag;
  ...
  withEnabled(enabled: boolean): TestOrganizationDataTag;

  /**
   * Lambda function that can be used to override the existing logic on a type that extends {@link DataDiagnostic}.
   */
  readonly customDiagnosticLogic?: λConsumer<any | null>;
  withCustomDiagnosticLogic(customDiagnosticLogic: λConsumer<any | null> | null): TestOrganizationDataTag;

  /**
   * The history of counts and percentages of the {@link DataTagRelation}s for this data tag.
   */
  readonly countHistory?: Array_Type<DataTagCountHistory>;
  withCountHistory(countHistory: Array_Type<DataTagCountHistory> | Array<IDataTagCountHistory> | null): TestOrganizationDataTag;
   ...
   * @see #toJson
   */
  static fromJson(json: any): TestOrganizationDataTag | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): TestOrganizationDataTag | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): TestOrganizationDataTag | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): TestOrganizationDataTag | null;
   ...
   */
  replaceType(old: Type, new_: Type): TestOrganizationDataTag;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): TestOrganizationDataTag;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): TestOrganizationDataTag;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<TestOrganizationDataTag>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<TestOrganizationDataTag>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): TestOrganizationDataTag;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TestOrganizationDataTag;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TestOrganizationDataTag;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): TestOrganizationDataTag;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): TestOrganizationDataTag;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): TestOrganizationDataTag;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): TestOrganizationDataTag;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): TestOrganizationDataTag;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): TestOrganizationDataTag;
   ...
   * @see #removeField
   */
  withoutField(field: string): TestOrganizationDataTag;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): TestOrganizationDataTag;
   ...
   */
  withoutFields(fields: Array_Type<string>): TestOrganizationDataTag;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): TestOrganizationDataTag;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): TestOrganizationDataTag;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): TestOrganizationDataTag;
   ...
   * @see #unsetField
   */
  defaultField(field: string): TestOrganizationDataTag;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): TestOrganizationDataTag;
   ...
   * @see #removeField
   */
  unsetField(field: string): TestOrganizationDataTag;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): TestOrganizationDataTag;
   ...
   * @see #unsetField
   */
  removeField(field: string): TestOrganizationDataTag;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): TestOrganizationDataTag;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): TestOrganizationDataTag;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): TestOrganizationDataTag;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): TestOrganizationDataTag;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): TestOrganizationDataTag;

  mergeJson(json: any): TestOrganizationDataTag;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): TestOrganizationDataTag;
   ...
   */
  sumObj(other: Obj, deep?: boolean): TestOrganizationDataTag;
   ...
   */
  singletonArray(): Array_Type<TestOrganizationDataTag>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<TestOrganizationDataTag> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<TestOrganizationDataTag> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<TestOrganizationDataTag>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<TestOrganizationDataTag> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, TestOrganizationDataTag> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, TestOrganizationDataTag> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<TestOrganizationDataTag>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<TestOrganizationDataTag>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): TestOrganizationDataTag;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): TestOrganizationDataTag;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): TestOrganizationDataTag;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): TestOrganizationDataTag;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): TestOrganizationDataTag;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): TestOrganizationDataTag;
   ...
   * @see #fromString
   */
  static make(s: string): TestOrganizationDataTag | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): TestOrganizationDataTag;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): TestOrganizationDataTag;
   ...
   */
  static cachedEmptyInst(): TestOrganizationDataTag;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<TestOrganizationDataTag> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): TestOrganizationDataTag;
   ...
   */
  addEntityToWhiteList(id: string): TestOrganizationDataTagEntityRelation | null;

  /**
   * Add the entiy with this id to the blacklist of entities, if there is such an entity with that id.
   */
  addEntityToBlackList(id: string): TestOrganizationDataTagEntityRelation | null;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<TestOrganizationDataTag>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<TestOrganizationDataTag>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<TestOrganizationDataTag> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<TestOrganizationDataTag>> | null;
   ...
   */
  static evalFeatureSetBatch(batch: Array_Type<TestOrganizationDataTag>, featureSet: Feature.Set, spec?: EvalFeatureSpec): Data | null;
   ...
   * ```
   */
  static evalFeaturesBatch(batch: Array_Type<TestOrganizationDataTag>, features: Array_Type<string>, spec?: EvalFeaturesSpec): Data | null;
   ...
   */
  get(include?: string): TestOrganizationDataTag | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): TestOrganizationDataTag | null;
   ...
   */
  getMissing(spec: GetMissingSpec): TestOrganizationDataTag;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): TestOrganizationDataTag | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): TestOrganizationDataTag;
   ...
   * @see #toString
   */
  static fromString(s: string): TestOrganizationDataTag | null;
   ...
   */
  create(spec?: UpsertSpec): TestOrganizationDataTag | null;
   ...
   */
  static createBatch(objs: Array_Type<TestOrganizationDataTag>, spec?: UpsertSpec): ObjList<TestOrganizationDataTag> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<TestOrganizationDataTag>, spec?: CreateBatchObjStreamSpec): ObjList<TestOrganizationDataTag> | null;
   ...
   */
  update(srcObj?: TestOrganizationDataTag, spec?: UpsertSpec): TestOrganizationDataTag | null;
   ...
   */
  upsert(srcObj?: TestOrganizationDataTag, spec?: UpsertSpec): TestOrganizationDataTag | null;
   ...
   */
  merge(spec?: MergeSpec): TestOrganizationDataTag | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): TestOrganizationDataTag | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): TestOrganizationDataTag | null;
   ...
   */
  static updateBatch(objs: Array_Type<TestOrganizationDataTag>, srcObjs?: Array_Type<TestOrganizationDataTag>, spec?: UpsertSpec): ObjList<TestOrganizationDataTag> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<TestOrganizationDataTag> | null>, spec?: UpsertSpec): ObjList<TestOrganizationDataTag> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<TestOrganizationDataTag>, srcObjs?: Array_Type<TestOrganizationDataTag>, spec?: UpsertSpec): ObjList<TestOrganizationDataTag> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<TestOrganizationDataTag> | null>, spec?: UpsertSpec): ObjList<TestOrganizationDataTag> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<TestOrganizationDataTag>, spec?: TouchSpec): ObjList<TestOrganizationDataTag> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<TestOrganizationDataTag>, spec?: MergeSpec): ObjList<TestOrganizationDataTag> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<TestOrganizationDataTag>, mergeInclude: string, spec?: MergeSpec): ObjList<TestOrganizationDataTag> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<TestOrganizationDataTag> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<TestOrganizationDataTag> | null;
   ...
   */
  static mergeAll(mergeObj: TestOrganizationDataTag, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: TestOrganizationDataTag, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<TestOrganizationDataTag>, spec?: UpsertSpec): ObjList<TestOrganizationDataTag> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<TestOrganizationDataTag>, spec?: UpsertSpec): ObjList<TestOrganizationDataTag> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): TestOrganizationDataTag | null;
   ...
   */
  static beforeCreate(objs: Array_Type<TestOrganizationDataTag>): ObjList<TestOrganizationDataTag>;
   ...
   * {@link DataDiagnostic#filter} are all valid.
   */
  static beforeUpdate(objs: Array_Type<TestOrganizationDataTag>): ObjList<TestOrganizationDataTag>;
   ...
   */
  static beforeRemove(objs: Array_Type<TestOrganizationDataTag>): ObjList<TestOrganizationDataTag>;
   ...
   */
  static afterCreate(objs: Array_Type<TestOrganizationDataTag>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<TestOrganizationDataTag>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<TestOrganizationDataTag>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<TestOrganizationDataTag>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<TestOrganizationDataTag>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): TestOrganizationDataTag | null;
   ...
   */
  withoutIdentity(): TestOrganizationDataTag | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<TestOrganizationDataTag>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: TestOrganizationDataTag, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<TestOrganizationDataTag>, callback?: λFunction<TestOrganizationDataTag | null, TestOrganizationDataTag | null>): ObjList<TestOrganizationDataTag>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<TestOrganizationDataTag>, callback?: λFunction<TestOrganizationDataTag | null, TestOrganizationDataTag | null>): Array_Type<ObjError> | null;
   ...
   */
  retrieveEvalMetricsDiagnosticData(filter?: Filter, dataVariables?: TestOrganizationDataTag, overrideDiagnosticSpec?: DataDiagnosticOverrideSpec = '{}'): EvalMetricsResult | null;
   ...
   */
  static processNewOrUpdatedDiagnostics(objs: Array_Type<TestOrganizationDataTag>): ObjList<TestOrganizationDataTag>;
