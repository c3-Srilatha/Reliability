// TypeScript definitions for the C3 type UiSdlSingletonApplicationState

/**
 * Singleton Application State that will only have 1 metadata instance with a known id.
 *
 * Any Type that mixes UiSdlSingletonApplicationState will need to manage their
 * own id field so each Type methods can internally use the same one.
 *
 * @remarks this represents a value passed to a method that expects an instance of UiSdlSingletonApplicationState
 */
declare interface IUiSdlSingletonApplicationState {
 ...
 * own id field so each Type methods can internally use the same one.
 *
 * @remarks this represents a made instance of UiSdlSingletonApplicationState
 */
declare class UiSdlSingletonApplicationState extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): UiSdlSingletonApplicationState | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): UiSdlSingletonApplicationState | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): UiSdlSingletonApplicationState | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): UiSdlSingletonApplicationState | null;
   ...
   */
  replaceType(old: Type, new_: Type): UiSdlSingletonApplicationState;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlSingletonApplicationState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlSingletonApplicationState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlSingletonApplicationState | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlSingletonApplicationState | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): UiSdlSingletonApplicationState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlSingletonApplicationState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlSingletonApplicationState;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): UiSdlSingletonApplicationState;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): UiSdlSingletonApplicationState;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): UiSdlSingletonApplicationState;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): UiSdlSingletonApplicationState;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): UiSdlSingletonApplicationState;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): UiSdlSingletonApplicationState;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): UiSdlSingletonApplicationState;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): UiSdlSingletonApplicationState;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): UiSdlSingletonApplicationState;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): UiSdlSingletonApplicationState;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): UiSdlSingletonApplicationState;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): UiSdlSingletonApplicationState;
   ...
   * @see #unsetField
   */
  defaultField(field: string): UiSdlSingletonApplicationState;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): UiSdlSingletonApplicationState;
   ...
   * @see #removeField
   */
  unsetField(field: string): UiSdlSingletonApplicationState;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): UiSdlSingletonApplicationState;
   ...
   * @see #unsetField
   */
  removeField(field: string): UiSdlSingletonApplicationState;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): UiSdlSingletonApplicationState;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): UiSdlSingletonApplicationState;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): UiSdlSingletonApplicationState;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): UiSdlSingletonApplicationState;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): UiSdlSingletonApplicationState;

  mergeJson(json: any | null): UiSdlSingletonApplicationState;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): UiSdlSingletonApplicationState;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): UiSdlSingletonApplicationState;
   ...
   */
  singletonArray(): C3.Array<UiSdlSingletonApplicationState | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<UiSdlSingletonApplicationState | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<UiSdlSingletonApplicationState | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<UiSdlSingletonApplicationState | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<UiSdlSingletonApplicationState | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, UiSdlSingletonApplicationState | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, UiSdlSingletonApplicationState | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<UiSdlSingletonApplicationState | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<UiSdlSingletonApplicationState | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): UiSdlSingletonApplicationState;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): UiSdlSingletonApplicationState;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): UiSdlSingletonApplicationState;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): UiSdlSingletonApplicationState;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): UiSdlSingletonApplicationState;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): UiSdlSingletonApplicationState;
   ...
   * @see #fromString
   */
  static make(s: string | null): UiSdlSingletonApplicationState | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): UiSdlSingletonApplicationState;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): UiSdlSingletonApplicationState;
   ...
   */
  static cachedEmptyInst(): UiSdlSingletonApplicationState;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<UiSdlSingletonApplicationState>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): UiSdlSingletonApplicationState;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<UiSdlSingletonApplicationState | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<UiSdlSingletonApplicationState | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<UiSdlSingletonApplicationState | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<UiSdlSingletonApplicationState | null> | null>;
   ...
   */
  dependencies(): MetadataDeps<UiSdlSingletonApplicationState | null>;

  save(subPath?: string | null, contentType?: string | null): UiSdlSingletonApplicationState;
  ...
  update(srcObj?: UiSdlSingletonApplicationState | null, spec?: UpsertSpec | null): UiSdlSingletonApplicationState | null;

  upsert(srcObj?: UiSdlSingletonApplicationState | null, spec?: UpsertSpec | null): UiSdlSingletonApplicationState | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): UiSdlSingletonApplicationState | null;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string | null, failIfMissing?: boolean): UiSdlSingletonApplicationState | null;
   ...
   */
  static doDataMerge(componentId: string, dataSpecFieldName: string, dataDestinationFieldName: string, props: UiSdlSingletonApplicationState, state: UiSdlReduxState): UiSdlSingletonApplicationState | null;
