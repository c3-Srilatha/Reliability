// TypeScript definitions for the C3 type BundlerTestAppMultiDataSpecComponentDataSpec

/**
 * A data spec for testing {@link UiSdlMetadataBundler} and {@link UiSdlMetadataLoader}.
 *
 * @remarks this represents a value passed to a method that expects an instance of BundlerTestAppMultiDataSpecComponentDataSpec
 */
declare interface IBundlerTestAppMultiDataSpecComponentDataSpec {
 ...
 */
declare class BundlerTestAppMultiDataSpecComponentDataSpec extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): BundlerTestAppMultiDataSpecComponentDataSpec | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): BundlerTestAppMultiDataSpecComponentDataSpec | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): BundlerTestAppMultiDataSpecComponentDataSpec | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): BundlerTestAppMultiDataSpecComponentDataSpec | null;
   ...
   */
  replaceType(old: Type, new_: Type): BundlerTestAppMultiDataSpecComponentDataSpec;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): BundlerTestAppMultiDataSpecComponentDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): BundlerTestAppMultiDataSpecComponentDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<BundlerTestAppMultiDataSpecComponentDataSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<BundlerTestAppMultiDataSpecComponentDataSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): BundlerTestAppMultiDataSpecComponentDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): BundlerTestAppMultiDataSpecComponentDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): BundlerTestAppMultiDataSpecComponentDataSpec;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): BundlerTestAppMultiDataSpecComponentDataSpec;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): BundlerTestAppMultiDataSpecComponentDataSpec;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): BundlerTestAppMultiDataSpecComponentDataSpec;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): BundlerTestAppMultiDataSpecComponentDataSpec;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): BundlerTestAppMultiDataSpecComponentDataSpec;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): BundlerTestAppMultiDataSpecComponentDataSpec;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): BundlerTestAppMultiDataSpecComponentDataSpec;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): BundlerTestAppMultiDataSpecComponentDataSpec;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): BundlerTestAppMultiDataSpecComponentDataSpec;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): BundlerTestAppMultiDataSpecComponentDataSpec;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): BundlerTestAppMultiDataSpecComponentDataSpec;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): BundlerTestAppMultiDataSpecComponentDataSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: string): BundlerTestAppMultiDataSpecComponentDataSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): BundlerTestAppMultiDataSpecComponentDataSpec;
   ...
   * @see #removeField
   */
  unsetField(field: string): BundlerTestAppMultiDataSpecComponentDataSpec;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): BundlerTestAppMultiDataSpecComponentDataSpec;
   ...
   * @see #unsetField
   */
  removeField(field: string): BundlerTestAppMultiDataSpecComponentDataSpec;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): BundlerTestAppMultiDataSpecComponentDataSpec;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): BundlerTestAppMultiDataSpecComponentDataSpec;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): BundlerTestAppMultiDataSpecComponentDataSpec;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): BundlerTestAppMultiDataSpecComponentDataSpec;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): BundlerTestAppMultiDataSpecComponentDataSpec;

  mergeJson(json: any | null): BundlerTestAppMultiDataSpecComponentDataSpec;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): BundlerTestAppMultiDataSpecComponentDataSpec;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): BundlerTestAppMultiDataSpecComponentDataSpec;
   ...
   */
  singletonArray(): C3.Array<BundlerTestAppMultiDataSpecComponentDataSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<BundlerTestAppMultiDataSpecComponentDataSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<BundlerTestAppMultiDataSpecComponentDataSpec | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<BundlerTestAppMultiDataSpecComponentDataSpec | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<BundlerTestAppMultiDataSpecComponentDataSpec | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, BundlerTestAppMultiDataSpecComponentDataSpec | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, BundlerTestAppMultiDataSpecComponentDataSpec | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<BundlerTestAppMultiDataSpecComponentDataSpec | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<BundlerTestAppMultiDataSpecComponentDataSpec | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): BundlerTestAppMultiDataSpecComponentDataSpec;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): BundlerTestAppMultiDataSpecComponentDataSpec;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): BundlerTestAppMultiDataSpecComponentDataSpec;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): BundlerTestAppMultiDataSpecComponentDataSpec;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): BundlerTestAppMultiDataSpecComponentDataSpec;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): BundlerTestAppMultiDataSpecComponentDataSpec;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): BundlerTestAppMultiDataSpecComponentDataSpec;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): BundlerTestAppMultiDataSpecComponentDataSpec;
   ...
   */
  static cachedEmptyInst(): BundlerTestAppMultiDataSpecComponentDataSpec;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<BundlerTestAppMultiDataSpecComponentDataSpec>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): BundlerTestAppMultiDataSpecComponentDataSpec;
   ...
   */
  static getDataTypeName(dataSpec?: BundlerTestAppMultiDataSpecComponentDataSpec | null): string | null;
