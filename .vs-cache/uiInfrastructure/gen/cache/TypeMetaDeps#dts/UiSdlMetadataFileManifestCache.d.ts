// TypeScript definitions for the C3 type UiSdlMetadataFileManifestCache

/**
 * A type to cache manifest as computing manifest is expensive.
 *
 * @remarks this represents a value passed to a method that expects an instance of UiSdlMetadataFileManifestCache
 */
declare interface IUiSdlMetadataFileManifestCache {
   ...
   */
  content?: C3.Map<string | null, UiSdlMetadataFileManifestEntry | null> | {[key: string | null]: IUiSdlMetadataFileManifestEntry | null};
}
 ...
 */
declare class UiSdlMetadataFileManifestCache extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): UiSdlMetadataFileManifestCache | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): UiSdlMetadataFileManifestCache | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): UiSdlMetadataFileManifestCache | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): UiSdlMetadataFileManifestCache | null;
   ...
   */
  replaceType(old: Type, new_: Type): UiSdlMetadataFileManifestCache;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlMetadataFileManifestCache;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlMetadataFileManifestCache;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlMetadataFileManifestCache | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlMetadataFileManifestCache | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): UiSdlMetadataFileManifestCache;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlMetadataFileManifestCache;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlMetadataFileManifestCache;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): UiSdlMetadataFileManifestCache;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): UiSdlMetadataFileManifestCache;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): UiSdlMetadataFileManifestCache;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): UiSdlMetadataFileManifestCache;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): UiSdlMetadataFileManifestCache;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): UiSdlMetadataFileManifestCache;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): UiSdlMetadataFileManifestCache;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): UiSdlMetadataFileManifestCache;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): UiSdlMetadataFileManifestCache;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): UiSdlMetadataFileManifestCache;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): UiSdlMetadataFileManifestCache;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): UiSdlMetadataFileManifestCache;
   ...
   * @see #unsetField
   */
  defaultField(field: string): UiSdlMetadataFileManifestCache;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): UiSdlMetadataFileManifestCache;
   ...
   * @see #removeField
   */
  unsetField(field: string): UiSdlMetadataFileManifestCache;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): UiSdlMetadataFileManifestCache;
   ...
   * @see #unsetField
   */
  removeField(field: string): UiSdlMetadataFileManifestCache;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): UiSdlMetadataFileManifestCache;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): UiSdlMetadataFileManifestCache;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): UiSdlMetadataFileManifestCache;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): UiSdlMetadataFileManifestCache;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): UiSdlMetadataFileManifestCache;

  mergeJson(json: any | null): UiSdlMetadataFileManifestCache;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): UiSdlMetadataFileManifestCache;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): UiSdlMetadataFileManifestCache;
   ...
   */
  singletonArray(): C3.Array<UiSdlMetadataFileManifestCache | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<UiSdlMetadataFileManifestCache | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<UiSdlMetadataFileManifestCache | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<UiSdlMetadataFileManifestCache | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<UiSdlMetadataFileManifestCache | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, UiSdlMetadataFileManifestCache | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, UiSdlMetadataFileManifestCache | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<UiSdlMetadataFileManifestCache | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<UiSdlMetadataFileManifestCache | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): UiSdlMetadataFileManifestCache;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): UiSdlMetadataFileManifestCache;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): UiSdlMetadataFileManifestCache;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): UiSdlMetadataFileManifestCache;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): UiSdlMetadataFileManifestCache;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): UiSdlMetadataFileManifestCache;
   ...
   * @see #fromString
   */
  static make(s: string | null): UiSdlMetadataFileManifestCache | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): UiSdlMetadataFileManifestCache;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): UiSdlMetadataFileManifestCache;
   ...
   */
  static cachedEmptyInst(): UiSdlMetadataFileManifestCache;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<UiSdlMetadataFileManifestCache>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): UiSdlMetadataFileManifestCache;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<UiSdlMetadataFileManifestCache | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<UiSdlMetadataFileManifestCache | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<UiSdlMetadataFileManifestCache | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<UiSdlMetadataFileManifestCache | null> | null>;
   ...
   */
  get(include?: string | null): UiSdlMetadataFileManifestCache | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): UiSdlMetadataFileManifestCache | null;
   ...
   */
  getMissing(spec: GetMissingSpec): UiSdlMetadataFileManifestCache;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): UiSdlMetadataFileManifestCache | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): UiSdlMetadataFileManifestCache;
   ...
   * @see #toString
   */
  static fromString(s: string | null): UiSdlMetadataFileManifestCache | null;
   ...
   */
  create(spec?: UpsertSpec | null): UiSdlMetadataFileManifestCache | null;
   ...
   */
  static createBatch(objs: C3.Array<UiSdlMetadataFileManifestCache | null> | null, spec?: UpsertSpec | null): ObjList<UiSdlMetadataFileManifestCache | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<UiSdlMetadataFileManifestCache | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<UiSdlMetadataFileManifestCache | null> | null;
   ...
   */
  update(srcObj?: UiSdlMetadataFileManifestCache | null, spec?: UpsertSpec | null): UiSdlMetadataFileManifestCache | null;
   ...
   */
  upsert(srcObj?: UiSdlMetadataFileManifestCache | null, spec?: UpsertSpec | null): UiSdlMetadataFileManifestCache | null;
   ...
   */
  merge(spec?: MergeSpec | null): UiSdlMetadataFileManifestCache | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): UiSdlMetadataFileManifestCache | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): UiSdlMetadataFileManifestCache | null;
   ...
   */
  static updateBatch(objs: C3.Array<UiSdlMetadataFileManifestCache | null> | null, srcObjs?: C3.Array<UiSdlMetadataFileManifestCache | null>, spec?: UpsertSpec | null): ObjList<UiSdlMetadataFileManifestCache | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<UiSdlMetadataFileManifestCache | null>>, spec?: UpsertSpec | null): ObjList<UiSdlMetadataFileManifestCache | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<UiSdlMetadataFileManifestCache | null> | null, srcObjs?: C3.Array<UiSdlMetadataFileManifestCache | null>, spec?: UpsertSpec | null): ObjList<UiSdlMetadataFileManifestCache | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<UiSdlMetadataFileManifestCache | null>>, spec?: UpsertSpec | null): ObjList<UiSdlMetadataFileManifestCache | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<UiSdlMetadataFileManifestCache | null> | null, spec?: TouchSpec | null): ObjList<UiSdlMetadataFileManifestCache | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<UiSdlMetadataFileManifestCache | null> | null, spec?: MergeSpec | null): ObjList<UiSdlMetadataFileManifestCache | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<UiSdlMetadataFileManifestCache | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<UiSdlMetadataFileManifestCache | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<UiSdlMetadataFileManifestCache | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<UiSdlMetadataFileManifestCache | null> | null;
   ...
   */
  static mergeAll(mergeObj: UiSdlMetadataFileManifestCache | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: UiSdlMetadataFileManifestCache | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<UiSdlMetadataFileManifestCache | null> | null, spec?: UpsertSpec | null): ObjList<UiSdlMetadataFileManifestCache | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<UiSdlMetadataFileManifestCache | null> | null, spec?: UpsertSpec | null): ObjList<UiSdlMetadataFileManifestCache | null> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): UiSdlMetadataFileManifestCache | null;
   ...
   */
  static beforeCreate(objs: C3.Array<UiSdlMetadataFileManifestCache | null> | null): ObjList<UiSdlMetadataFileManifestCache | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<UiSdlMetadataFileManifestCache | null> | null): ObjList<UiSdlMetadataFileManifestCache | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<UiSdlMetadataFileManifestCache | null> | null): ObjList<UiSdlMetadataFileManifestCache | null>;
   ...
   */
  static afterCreate(objs: C3.Array<UiSdlMetadataFileManifestCache | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<UiSdlMetadataFileManifestCache | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<UiSdlMetadataFileManifestCache | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<UiSdlMetadataFileManifestCache | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<UiSdlMetadataFileManifestCache | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): UiSdlMetadataFileManifestCache | null;
   ...
   */
  withoutIdentity(): UiSdlMetadataFileManifestCache | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<UiSdlMetadataFileManifestCache | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: UiSdlMetadataFileManifestCache | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<UiSdlMetadataFileManifestCache | null> | null, callback?: λFunction<UiSdlMetadataFileManifestCache | null, UiSdlMetadataFileManifestCache | null> | null): ObjList<UiSdlMetadataFileManifestCache | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<UiSdlMetadataFileManifestCache | null> | null, callback?: λFunction<UiSdlMetadataFileManifestCache | null, UiSdlMetadataFileManifestCache | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static generateManifest(regenerate?: boolean, files?: C3.Map<string | null, UiSdlMetadataFile | null>): C3.Map<string | null, UiSdlMetadataFileManifestEntry | null>;
}
