// TypeScript definitions for the C3 type BundlerTestAppDeepNestedComponentDataSpec

/**
 * A data spec for testing {@link UiSdlMetadataBundler} and {@link UiSdlMetadataLoader}.
 *
 * @remarks this represents a value passed to a method that expects an instance of BundlerTestAppDeepNestedComponentDataSpec
 */
declare interface IBundlerTestAppDeepNestedComponentDataSpec {
   ...
   */
  fieldSets?: C3.Array<BundlerTestAppFieldSet | null> | Array<IBundlerTestAppFieldSet | null> | C3.Array<C3.Array<BundlerTestAppFieldSet | null>> | Array<C3.Array<BundlerTestAppFieldSet | null> | Array<IBundlerTestAppFieldSet | null>> | null;

  /**
   * Field to showcase deeply nested data spec
   */
  fieldComponentArray?: any | null;
}
 ...
 */
declare class BundlerTestAppDeepNestedComponentDataSpec extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): BundlerTestAppDeepNestedComponentDataSpec | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): BundlerTestAppDeepNestedComponentDataSpec | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): BundlerTestAppDeepNestedComponentDataSpec | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): BundlerTestAppDeepNestedComponentDataSpec | null;
   ...
   */
  replaceType(old: Type, new_: Type): BundlerTestAppDeepNestedComponentDataSpec;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): BundlerTestAppDeepNestedComponentDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): BundlerTestAppDeepNestedComponentDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<BundlerTestAppDeepNestedComponentDataSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<BundlerTestAppDeepNestedComponentDataSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): BundlerTestAppDeepNestedComponentDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): BundlerTestAppDeepNestedComponentDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): BundlerTestAppDeepNestedComponentDataSpec;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): BundlerTestAppDeepNestedComponentDataSpec;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): BundlerTestAppDeepNestedComponentDataSpec;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): BundlerTestAppDeepNestedComponentDataSpec;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): BundlerTestAppDeepNestedComponentDataSpec;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): BundlerTestAppDeepNestedComponentDataSpec;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): BundlerTestAppDeepNestedComponentDataSpec;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): BundlerTestAppDeepNestedComponentDataSpec;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): BundlerTestAppDeepNestedComponentDataSpec;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): BundlerTestAppDeepNestedComponentDataSpec;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): BundlerTestAppDeepNestedComponentDataSpec;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): BundlerTestAppDeepNestedComponentDataSpec;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): BundlerTestAppDeepNestedComponentDataSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: string): BundlerTestAppDeepNestedComponentDataSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): BundlerTestAppDeepNestedComponentDataSpec;
   ...
   * @see #removeField
   */
  unsetField(field: string): BundlerTestAppDeepNestedComponentDataSpec;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): BundlerTestAppDeepNestedComponentDataSpec;
   ...
   * @see #unsetField
   */
  removeField(field: string): BundlerTestAppDeepNestedComponentDataSpec;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): BundlerTestAppDeepNestedComponentDataSpec;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): BundlerTestAppDeepNestedComponentDataSpec;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): BundlerTestAppDeepNestedComponentDataSpec;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): BundlerTestAppDeepNestedComponentDataSpec;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): BundlerTestAppDeepNestedComponentDataSpec;

  mergeJson(json: any | null): BundlerTestAppDeepNestedComponentDataSpec;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): BundlerTestAppDeepNestedComponentDataSpec;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): BundlerTestAppDeepNestedComponentDataSpec;
   ...
   */
  singletonArray(): C3.Array<BundlerTestAppDeepNestedComponentDataSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<BundlerTestAppDeepNestedComponentDataSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<BundlerTestAppDeepNestedComponentDataSpec | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<BundlerTestAppDeepNestedComponentDataSpec | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<BundlerTestAppDeepNestedComponentDataSpec | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, BundlerTestAppDeepNestedComponentDataSpec | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, BundlerTestAppDeepNestedComponentDataSpec | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<BundlerTestAppDeepNestedComponentDataSpec | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<BundlerTestAppDeepNestedComponentDataSpec | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): BundlerTestAppDeepNestedComponentDataSpec;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): BundlerTestAppDeepNestedComponentDataSpec;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): BundlerTestAppDeepNestedComponentDataSpec;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): BundlerTestAppDeepNestedComponentDataSpec;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): BundlerTestAppDeepNestedComponentDataSpec;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): BundlerTestAppDeepNestedComponentDataSpec;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): BundlerTestAppDeepNestedComponentDataSpec;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): BundlerTestAppDeepNestedComponentDataSpec;
   ...
   */
  static cachedEmptyInst(): BundlerTestAppDeepNestedComponentDataSpec;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<BundlerTestAppDeepNestedComponentDataSpec>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): BundlerTestAppDeepNestedComponentDataSpec;
   ...
   */
  static getDataTypeName(dataSpec?: BundlerTestAppDeepNestedComponentDataSpec | null): string | null;
