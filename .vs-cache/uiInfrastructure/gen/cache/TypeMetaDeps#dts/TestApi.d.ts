...
declare class TestApi {
   ...
   */
  static validateUiComponentDesignability(testDescription: string, componentType: Type, locales?: C3.Array<Locale | null>): void;
   ...
   *           The list of locales that you intend to support in UI Designer.
   */
  static validateTranslations(componentType: Type, locales?: C3.Array<Locale | null>): void;
   ...
   */
  static getMissingTranslationIds(missingTranslations?: C3.Array<any | null>): void;
   ...
   * @return The vanity url string
   */
  static setupUiInfrastructureBasedVanityUrl(context: TestApiContext, obj?: VanityUrl | null, namespace?: string | null): VanityUrl | null;
}
