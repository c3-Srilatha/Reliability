// TypeScript definitions for the C3 type BundlerTestAppGridDataSpec

/**
 * A data spec for testing {@link UiSdlMetadataBundler} and {@link UiSdlMetadataLoader}.
 *
 * @remarks this represents a value passed to a method that expects an instance of BundlerTestAppGridDataSpec
 */
declare interface IBundlerTestAppGridDataSpec {
  ...
  dynamicField?: IUiSdlFieldBasedDataDynamicValueSpecSetting | null;
}
 ...
 */
declare class BundlerTestAppGridDataSpec extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): BundlerTestAppGridDataSpec | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): BundlerTestAppGridDataSpec | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): BundlerTestAppGridDataSpec | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): BundlerTestAppGridDataSpec | null;
   ...
   */
  replaceType(old: Type, new_: Type): BundlerTestAppGridDataSpec;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): BundlerTestAppGridDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): BundlerTestAppGridDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<BundlerTestAppGridDataSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<BundlerTestAppGridDataSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): BundlerTestAppGridDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): BundlerTestAppGridDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): BundlerTestAppGridDataSpec;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): BundlerTestAppGridDataSpec;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): BundlerTestAppGridDataSpec;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): BundlerTestAppGridDataSpec;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): BundlerTestAppGridDataSpec;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): BundlerTestAppGridDataSpec;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): BundlerTestAppGridDataSpec;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): BundlerTestAppGridDataSpec;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): BundlerTestAppGridDataSpec;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): BundlerTestAppGridDataSpec;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): BundlerTestAppGridDataSpec;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): BundlerTestAppGridDataSpec;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): BundlerTestAppGridDataSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: string): BundlerTestAppGridDataSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): BundlerTestAppGridDataSpec;
   ...
   * @see #removeField
   */
  unsetField(field: string): BundlerTestAppGridDataSpec;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): BundlerTestAppGridDataSpec;
   ...
   * @see #unsetField
   */
  removeField(field: string): BundlerTestAppGridDataSpec;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): BundlerTestAppGridDataSpec;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): BundlerTestAppGridDataSpec;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): BundlerTestAppGridDataSpec;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): BundlerTestAppGridDataSpec;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): BundlerTestAppGridDataSpec;

  mergeJson(json: any | null): BundlerTestAppGridDataSpec;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): BundlerTestAppGridDataSpec;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): BundlerTestAppGridDataSpec;
   ...
   */
  singletonArray(): C3.Array<BundlerTestAppGridDataSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<BundlerTestAppGridDataSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<BundlerTestAppGridDataSpec | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<BundlerTestAppGridDataSpec | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<BundlerTestAppGridDataSpec | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, BundlerTestAppGridDataSpec | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, BundlerTestAppGridDataSpec | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<BundlerTestAppGridDataSpec | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<BundlerTestAppGridDataSpec | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): BundlerTestAppGridDataSpec;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): BundlerTestAppGridDataSpec;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): BundlerTestAppGridDataSpec;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): BundlerTestAppGridDataSpec;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): BundlerTestAppGridDataSpec;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): BundlerTestAppGridDataSpec;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): BundlerTestAppGridDataSpec;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): BundlerTestAppGridDataSpec;
   ...
   */
  static cachedEmptyInst(): BundlerTestAppGridDataSpec;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<BundlerTestAppGridDataSpec>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): BundlerTestAppGridDataSpec;
   ...
   */
  static getDataTypeName(dataSpec?: BundlerTestAppGridDataSpec | null): string | null;
