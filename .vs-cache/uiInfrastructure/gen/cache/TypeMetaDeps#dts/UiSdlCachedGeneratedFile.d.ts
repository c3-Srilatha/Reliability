// TypeScript definitions for the C3 type UiSdlCachedGeneratedFile

/**
 * Entity type to store the generated code for a given source code.
 *
 * @remarks this represents a value passed to a method that expects an instance of UiSdlCachedGeneratedFile
 */
declare interface IUiSdlCachedGeneratedFile {
   ...
   */
  associatedTypeName?: string | null;
 ...
 */
declare class UiSdlCachedGeneratedFile extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): UiSdlCachedGeneratedFile | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): UiSdlCachedGeneratedFile | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): UiSdlCachedGeneratedFile | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): UiSdlCachedGeneratedFile | null;
   ...
   */
  replaceType(old: Type, new_: Type): UiSdlCachedGeneratedFile;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlCachedGeneratedFile;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlCachedGeneratedFile;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlCachedGeneratedFile | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlCachedGeneratedFile | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): UiSdlCachedGeneratedFile;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlCachedGeneratedFile;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlCachedGeneratedFile;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): UiSdlCachedGeneratedFile;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): UiSdlCachedGeneratedFile;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): UiSdlCachedGeneratedFile;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): UiSdlCachedGeneratedFile;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): UiSdlCachedGeneratedFile;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): UiSdlCachedGeneratedFile;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): UiSdlCachedGeneratedFile;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): UiSdlCachedGeneratedFile;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): UiSdlCachedGeneratedFile;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): UiSdlCachedGeneratedFile;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): UiSdlCachedGeneratedFile;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): UiSdlCachedGeneratedFile;
   ...
   * @see #unsetField
   */
  defaultField(field: string): UiSdlCachedGeneratedFile;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): UiSdlCachedGeneratedFile;
   ...
   * @see #removeField
   */
  unsetField(field: string): UiSdlCachedGeneratedFile;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): UiSdlCachedGeneratedFile;
   ...
   * @see #unsetField
   */
  removeField(field: string): UiSdlCachedGeneratedFile;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): UiSdlCachedGeneratedFile;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): UiSdlCachedGeneratedFile;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): UiSdlCachedGeneratedFile;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): UiSdlCachedGeneratedFile;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): UiSdlCachedGeneratedFile;

  mergeJson(json: any | null): UiSdlCachedGeneratedFile;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): UiSdlCachedGeneratedFile;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): UiSdlCachedGeneratedFile;
   ...
   */
  singletonArray(): C3.Array<UiSdlCachedGeneratedFile | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<UiSdlCachedGeneratedFile | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<UiSdlCachedGeneratedFile | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<UiSdlCachedGeneratedFile | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<UiSdlCachedGeneratedFile | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, UiSdlCachedGeneratedFile | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, UiSdlCachedGeneratedFile | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<UiSdlCachedGeneratedFile | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<UiSdlCachedGeneratedFile | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): UiSdlCachedGeneratedFile;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): UiSdlCachedGeneratedFile;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): UiSdlCachedGeneratedFile;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): UiSdlCachedGeneratedFile;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): UiSdlCachedGeneratedFile;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): UiSdlCachedGeneratedFile;
   ...
   * @see #fromString
   */
  static make(s: string | null): UiSdlCachedGeneratedFile | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): UiSdlCachedGeneratedFile;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): UiSdlCachedGeneratedFile;
   ...
   */
  static cachedEmptyInst(): UiSdlCachedGeneratedFile;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<UiSdlCachedGeneratedFile>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): UiSdlCachedGeneratedFile;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<UiSdlCachedGeneratedFile | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<UiSdlCachedGeneratedFile | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<UiSdlCachedGeneratedFile | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): UiSdlCachedGeneratedFile | null;
   ...
   * @see findByCacheKey
   */
  static forCacheKey(key: string | null): UiSdlCachedGeneratedFile | null;
   ...
   * @see findByCacheKey
   */
  getCached(): UiSdlCachedGeneratedFile | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): UiSdlCachedGeneratedFile | null;
   ...
   */
  static produce(key: string): UiSdlCachedGeneratedFile | null;
   ...
   */
  static produceAll(): C3.Map<string | null, UiSdlCachedGeneratedFile | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, UiSdlCachedGeneratedFile | null>;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<UiSdlCachedGeneratedFile | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<UiSdlCachedGeneratedFile | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<UiSdlCachedGeneratedFile | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<UiSdlCachedGeneratedFile | null> | null>;
   ...
   */
  get(include?: string | null): UiSdlCachedGeneratedFile | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): UiSdlCachedGeneratedFile | null;
   ...
   */
  getMissing(spec: GetMissingSpec): UiSdlCachedGeneratedFile;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): UiSdlCachedGeneratedFile | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): UiSdlCachedGeneratedFile;
   ...
   * @see #toString
   */
  static fromString(s: string | null): UiSdlCachedGeneratedFile | null;
   ...
   */
  create(spec?: UpsertSpec | null): UiSdlCachedGeneratedFile | null;
   ...
   */
  static createBatch(objs: C3.Array<UiSdlCachedGeneratedFile | null> | null, spec?: UpsertSpec | null): ObjList<UiSdlCachedGeneratedFile | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<UiSdlCachedGeneratedFile | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<UiSdlCachedGeneratedFile | null> | null;
   ...
   */
  update(srcObj?: UiSdlCachedGeneratedFile | null, spec?: UpsertSpec | null): UiSdlCachedGeneratedFile | null;
   ...
   */
  upsert(srcObj?: UiSdlCachedGeneratedFile | null, spec?: UpsertSpec | null): UiSdlCachedGeneratedFile | null;
   ...
   */
  merge(spec?: MergeSpec | null): UiSdlCachedGeneratedFile | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): UiSdlCachedGeneratedFile | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): UiSdlCachedGeneratedFile | null;
   ...
   */
  static updateBatch(objs: C3.Array<UiSdlCachedGeneratedFile | null> | null, srcObjs?: C3.Array<UiSdlCachedGeneratedFile | null>, spec?: UpsertSpec | null): ObjList<UiSdlCachedGeneratedFile | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<UiSdlCachedGeneratedFile | null>>, spec?: UpsertSpec | null): ObjList<UiSdlCachedGeneratedFile | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<UiSdlCachedGeneratedFile | null> | null, srcObjs?: C3.Array<UiSdlCachedGeneratedFile | null>, spec?: UpsertSpec | null): ObjList<UiSdlCachedGeneratedFile | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<UiSdlCachedGeneratedFile | null>>, spec?: UpsertSpec | null): ObjList<UiSdlCachedGeneratedFile | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<UiSdlCachedGeneratedFile | null> | null, spec?: TouchSpec | null): ObjList<UiSdlCachedGeneratedFile | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<UiSdlCachedGeneratedFile | null> | null, spec?: MergeSpec | null): ObjList<UiSdlCachedGeneratedFile | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<UiSdlCachedGeneratedFile | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<UiSdlCachedGeneratedFile | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<UiSdlCachedGeneratedFile | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<UiSdlCachedGeneratedFile | null> | null;
   ...
   */
  static mergeAll(mergeObj: UiSdlCachedGeneratedFile | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: UiSdlCachedGeneratedFile | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<UiSdlCachedGeneratedFile | null> | null, spec?: UpsertSpec | null): ObjList<UiSdlCachedGeneratedFile | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<UiSdlCachedGeneratedFile | null> | null, spec?: UpsertSpec | null): ObjList<UiSdlCachedGeneratedFile | null> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): UiSdlCachedGeneratedFile | null;
   ...
   */
  static beforeCreate(objs: C3.Array<UiSdlCachedGeneratedFile | null> | null): ObjList<UiSdlCachedGeneratedFile | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<UiSdlCachedGeneratedFile | null> | null): ObjList<UiSdlCachedGeneratedFile | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<UiSdlCachedGeneratedFile | null> | null): ObjList<UiSdlCachedGeneratedFile | null>;
   ...
   */
  static afterCreate(objs: C3.Array<UiSdlCachedGeneratedFile | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<UiSdlCachedGeneratedFile | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<UiSdlCachedGeneratedFile | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<UiSdlCachedGeneratedFile | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<UiSdlCachedGeneratedFile | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): UiSdlCachedGeneratedFile | null;
   ...
   */
  withoutIdentity(): UiSdlCachedGeneratedFile | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<UiSdlCachedGeneratedFile | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: UiSdlCachedGeneratedFile | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<UiSdlCachedGeneratedFile | null> | null, callback?: λFunction<UiSdlCachedGeneratedFile | null, UiSdlCachedGeneratedFile | null> | null): ObjList<UiSdlCachedGeneratedFile | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<UiSdlCachedGeneratedFile | null> | null, callback?: λFunction<UiSdlCachedGeneratedFile | null, UiSdlCachedGeneratedFile | null> | null): C3.Array<ObjError | null>;
