// TypeScript definitions for the C3 type BundlerTestAppSingleSearchDataSpec

/**
 * The specification of data retrieval for instances of the {@BundlerTestAppSingleSearch} component type.
 *
 * @remarks this represents a value passed to a method that expects an instance of BundlerTestAppSingleSearchDataSpec
 */
declare interface IBundlerTestAppSingleSearchDataSpec {
 ...
 */
declare class BundlerTestAppSingleSearchDataSpec extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): BundlerTestAppSingleSearchDataSpec | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): BundlerTestAppSingleSearchDataSpec | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): BundlerTestAppSingleSearchDataSpec | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): BundlerTestAppSingleSearchDataSpec | null;
   ...
   */
  replaceType(old: Type, new_: Type): BundlerTestAppSingleSearchDataSpec;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): BundlerTestAppSingleSearchDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): BundlerTestAppSingleSearchDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<BundlerTestAppSingleSearchDataSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<BundlerTestAppSingleSearchDataSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): BundlerTestAppSingleSearchDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): BundlerTestAppSingleSearchDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): BundlerTestAppSingleSearchDataSpec;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): BundlerTestAppSingleSearchDataSpec;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): BundlerTestAppSingleSearchDataSpec;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): BundlerTestAppSingleSearchDataSpec;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): BundlerTestAppSingleSearchDataSpec;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): BundlerTestAppSingleSearchDataSpec;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): BundlerTestAppSingleSearchDataSpec;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): BundlerTestAppSingleSearchDataSpec;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): BundlerTestAppSingleSearchDataSpec;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): BundlerTestAppSingleSearchDataSpec;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): BundlerTestAppSingleSearchDataSpec;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): BundlerTestAppSingleSearchDataSpec;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): BundlerTestAppSingleSearchDataSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: string): BundlerTestAppSingleSearchDataSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): BundlerTestAppSingleSearchDataSpec;
   ...
   * @see #removeField
   */
  unsetField(field: string): BundlerTestAppSingleSearchDataSpec;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): BundlerTestAppSingleSearchDataSpec;
   ...
   * @see #unsetField
   */
  removeField(field: string): BundlerTestAppSingleSearchDataSpec;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): BundlerTestAppSingleSearchDataSpec;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): BundlerTestAppSingleSearchDataSpec;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): BundlerTestAppSingleSearchDataSpec;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): BundlerTestAppSingleSearchDataSpec;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): BundlerTestAppSingleSearchDataSpec;

  mergeJson(json: any | null): BundlerTestAppSingleSearchDataSpec;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): BundlerTestAppSingleSearchDataSpec;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): BundlerTestAppSingleSearchDataSpec;
   ...
   */
  singletonArray(): C3.Array<BundlerTestAppSingleSearchDataSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<BundlerTestAppSingleSearchDataSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<BundlerTestAppSingleSearchDataSpec | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<BundlerTestAppSingleSearchDataSpec | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<BundlerTestAppSingleSearchDataSpec | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, BundlerTestAppSingleSearchDataSpec | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, BundlerTestAppSingleSearchDataSpec | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<BundlerTestAppSingleSearchDataSpec | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<BundlerTestAppSingleSearchDataSpec | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): BundlerTestAppSingleSearchDataSpec;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): BundlerTestAppSingleSearchDataSpec;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): BundlerTestAppSingleSearchDataSpec;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): BundlerTestAppSingleSearchDataSpec;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): BundlerTestAppSingleSearchDataSpec;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): BundlerTestAppSingleSearchDataSpec;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): BundlerTestAppSingleSearchDataSpec;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): BundlerTestAppSingleSearchDataSpec;
   ...
   */
  static cachedEmptyInst(): BundlerTestAppSingleSearchDataSpec;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<BundlerTestAppSingleSearchDataSpec>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): BundlerTestAppSingleSearchDataSpec;
   ...
   */
  static getDataTypeName(dataSpec?: BundlerTestAppSingleSearchDataSpec | null): string | null;
