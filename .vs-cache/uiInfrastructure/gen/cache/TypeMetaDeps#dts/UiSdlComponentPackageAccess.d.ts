// TypeScript definitions for the C3 type UiSdlComponentPackageAccess
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of UiSdlComponentPackageAccess
 */
declare interface IUiSdlComponentPackageAccess {
 ...
 */
declare class UiSdlComponentPackageAccess extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): UiSdlComponentPackageAccess | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): UiSdlComponentPackageAccess | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): UiSdlComponentPackageAccess | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): UiSdlComponentPackageAccess | null;
   ...
   */
  replaceType(old: Type, new_: Type): UiSdlComponentPackageAccess;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlComponentPackageAccess;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlComponentPackageAccess;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlComponentPackageAccess | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlComponentPackageAccess | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): UiSdlComponentPackageAccess;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlComponentPackageAccess;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlComponentPackageAccess;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): UiSdlComponentPackageAccess;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): UiSdlComponentPackageAccess;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): UiSdlComponentPackageAccess;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): UiSdlComponentPackageAccess;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): UiSdlComponentPackageAccess;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): UiSdlComponentPackageAccess;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): UiSdlComponentPackageAccess;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): UiSdlComponentPackageAccess;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): UiSdlComponentPackageAccess;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): UiSdlComponentPackageAccess;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): UiSdlComponentPackageAccess;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): UiSdlComponentPackageAccess;
   ...
   * @see #unsetField
   */
  defaultField(field: string): UiSdlComponentPackageAccess;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): UiSdlComponentPackageAccess;
   ...
   * @see #removeField
   */
  unsetField(field: string): UiSdlComponentPackageAccess;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): UiSdlComponentPackageAccess;
   ...
   * @see #unsetField
   */
  removeField(field: string): UiSdlComponentPackageAccess;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): UiSdlComponentPackageAccess;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): UiSdlComponentPackageAccess;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): UiSdlComponentPackageAccess;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): UiSdlComponentPackageAccess;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): UiSdlComponentPackageAccess;

  mergeJson(json: any | null): UiSdlComponentPackageAccess;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): UiSdlComponentPackageAccess;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): UiSdlComponentPackageAccess;
   ...
   */
  singletonArray(): C3.Array<UiSdlComponentPackageAccess | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<UiSdlComponentPackageAccess | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<UiSdlComponentPackageAccess | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<UiSdlComponentPackageAccess | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<UiSdlComponentPackageAccess | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, UiSdlComponentPackageAccess | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, UiSdlComponentPackageAccess | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<UiSdlComponentPackageAccess | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<UiSdlComponentPackageAccess | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): UiSdlComponentPackageAccess;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): UiSdlComponentPackageAccess;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): UiSdlComponentPackageAccess;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): UiSdlComponentPackageAccess;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): UiSdlComponentPackageAccess;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): UiSdlComponentPackageAccess;
   ...
   * @see #fromString
   */
  static make(s: string | null): UiSdlComponentPackageAccess | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): UiSdlComponentPackageAccess;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): UiSdlComponentPackageAccess;
   ...
   */
  static cachedEmptyInst(): UiSdlComponentPackageAccess;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<UiSdlComponentPackageAccess>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): UiSdlComponentPackageAccess;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<UiSdlComponentPackageAccess | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<UiSdlComponentPackageAccess | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<UiSdlComponentPackageAccess | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): UiSdlComponentPackageAccess | null;

  /**
   * Returns cached instance by key, with secrets removed.
   */
  static forCacheKey(key: string | null): UiSdlComponentPackageAccess | null;
   ...
   * @see findByCacheKey
   */
  getCached(): UiSdlComponentPackageAccess | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): UiSdlComponentPackageAccess | null;
   ...
   */
  static produce(key: string): UiSdlComponentPackageAccess | null;
   ...
   */
  static produceAll(): C3.Map<string | null, UiSdlComponentPackageAccess | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, UiSdlComponentPackageAccess | null>;
   ...
   */
  getConfig(): UiSdlComponentPackageAccess;
   ...
   */
  getSecret(): UiSdlComponentPackageAccess;
   ...
   */
  static forConfigKey(configKey: string | null): UiSdlComponentPackageAccess | null;
   ...
   */
  static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<UiSdlComponentPackageAccess | null>;
   ...
   * @see setConfigValue
   */
  setConfigValues(from: UiSdlComponentPackageAccess, override?: string | null): void;
   ...
   * @see setSecretValue
   */
  setSecretValues(from: UiSdlComponentPackageAccess, override?: string | null): void;
   ...
   */
  static loadConfigAndSecret(configKey: string): UiSdlComponentPackageAccess | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): UiSdlComponentPackageAccess | null;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): UiSdlComponentPackageAccess | null;
}
