// TypeScript definitions for the C3 type BundlerTestApplicationState

/**
 * A simple application state component for testing {@link UiSdlMetadataBundler} and {@link UiSdlMetadataLoader}.
 *
 * @remarks this represents a value passed to a method that expects an instance of BundlerTestApplicationState
 */
declare interface IBundlerTestApplicationState {
   ...
   */
  heading?: IBundlerTestAppHeading | null;
 ...
 */
declare class BundlerTestApplicationState extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): BundlerTestApplicationState | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): BundlerTestApplicationState | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): BundlerTestApplicationState | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): BundlerTestApplicationState | null;
   ...
   */
  replaceType(old: Type, new_: Type): BundlerTestApplicationState;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): BundlerTestApplicationState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): BundlerTestApplicationState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<BundlerTestApplicationState | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<BundlerTestApplicationState | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): BundlerTestApplicationState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): BundlerTestApplicationState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): BundlerTestApplicationState;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): BundlerTestApplicationState;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): BundlerTestApplicationState;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): BundlerTestApplicationState;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): BundlerTestApplicationState;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): BundlerTestApplicationState;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): BundlerTestApplicationState;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): BundlerTestApplicationState;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): BundlerTestApplicationState;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): BundlerTestApplicationState;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): BundlerTestApplicationState;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): BundlerTestApplicationState;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): BundlerTestApplicationState;
   ...
   * @see #unsetField
   */
  defaultField(field: string): BundlerTestApplicationState;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): BundlerTestApplicationState;
   ...
   * @see #removeField
   */
  unsetField(field: string): BundlerTestApplicationState;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): BundlerTestApplicationState;
   ...
   * @see #unsetField
   */
  removeField(field: string): BundlerTestApplicationState;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): BundlerTestApplicationState;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): BundlerTestApplicationState;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): BundlerTestApplicationState;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): BundlerTestApplicationState;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): BundlerTestApplicationState;

  mergeJson(json: any | null): BundlerTestApplicationState;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): BundlerTestApplicationState;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): BundlerTestApplicationState;
   ...
   */
  singletonArray(): C3.Array<BundlerTestApplicationState | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<BundlerTestApplicationState | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<BundlerTestApplicationState | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<BundlerTestApplicationState | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<BundlerTestApplicationState | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, BundlerTestApplicationState | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, BundlerTestApplicationState | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<BundlerTestApplicationState | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<BundlerTestApplicationState | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): BundlerTestApplicationState;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): BundlerTestApplicationState;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): BundlerTestApplicationState;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): BundlerTestApplicationState;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): BundlerTestApplicationState;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): BundlerTestApplicationState;
   ...
   * @see #fromString
   */
  static make(s: string | null): BundlerTestApplicationState | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): BundlerTestApplicationState;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): BundlerTestApplicationState;
   ...
   */
  static cachedEmptyInst(): BundlerTestApplicationState;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<BundlerTestApplicationState>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): BundlerTestApplicationState;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<BundlerTestApplicationState | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<BundlerTestApplicationState | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<BundlerTestApplicationState | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<BundlerTestApplicationState | null> | null>;
   ...
   */
  dependencies(): MetadataDeps<BundlerTestApplicationState | null>;

  save(subPath?: string | null, contentType?: string | null): BundlerTestApplicationState;
  ...
  update(srcObj?: BundlerTestApplicationState | null, spec?: UpsertSpec | null): BundlerTestApplicationState | null;

  upsert(srcObj?: BundlerTestApplicationState | null, spec?: UpsertSpec | null): BundlerTestApplicationState | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): BundlerTestApplicationState | null;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string | null, failIfMissing?: boolean): BundlerTestApplicationState | null;
   ...
   */
  static doDataMerge(componentId: string, dataSpecFieldName: string, dataDestinationFieldName: string, props: BundlerTestApplicationState, state: UiSdlReduxState): BundlerTestApplicationState | null;
