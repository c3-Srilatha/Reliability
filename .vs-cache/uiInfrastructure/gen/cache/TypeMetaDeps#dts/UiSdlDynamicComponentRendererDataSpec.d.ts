// TypeScript definitions for the C3 type UiSdlDynamicComponentRendererDataSpec

/**
 * A data spec for dynamically retrieving {@link UiSdlComponent} configuration.
 *
 * @remarks this represents a value passed to a method that expects an instance of UiSdlDynamicComponentRendererDataSpec
 */
declare interface IUiSdlDynamicComponentRendererDataSpec {
 ...
 */
declare class UiSdlDynamicComponentRendererDataSpec extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): UiSdlDynamicComponentRendererDataSpec | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): UiSdlDynamicComponentRendererDataSpec | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): UiSdlDynamicComponentRendererDataSpec | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): UiSdlDynamicComponentRendererDataSpec | null;
   ...
   */
  replaceType(old: Type, new_: Type): UiSdlDynamicComponentRendererDataSpec;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlDynamicComponentRendererDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlDynamicComponentRendererDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlDynamicComponentRendererDataSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlDynamicComponentRendererDataSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): UiSdlDynamicComponentRendererDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlDynamicComponentRendererDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlDynamicComponentRendererDataSpec;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): UiSdlDynamicComponentRendererDataSpec;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): UiSdlDynamicComponentRendererDataSpec;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): UiSdlDynamicComponentRendererDataSpec;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): UiSdlDynamicComponentRendererDataSpec;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): UiSdlDynamicComponentRendererDataSpec;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): UiSdlDynamicComponentRendererDataSpec;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): UiSdlDynamicComponentRendererDataSpec;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): UiSdlDynamicComponentRendererDataSpec;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): UiSdlDynamicComponentRendererDataSpec;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): UiSdlDynamicComponentRendererDataSpec;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): UiSdlDynamicComponentRendererDataSpec;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): UiSdlDynamicComponentRendererDataSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: string): UiSdlDynamicComponentRendererDataSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): UiSdlDynamicComponentRendererDataSpec;
   ...
   * @see #removeField
   */
  unsetField(field: string): UiSdlDynamicComponentRendererDataSpec;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): UiSdlDynamicComponentRendererDataSpec;
   ...
   * @see #unsetField
   */
  removeField(field: string): UiSdlDynamicComponentRendererDataSpec;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): UiSdlDynamicComponentRendererDataSpec;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): UiSdlDynamicComponentRendererDataSpec;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): UiSdlDynamicComponentRendererDataSpec;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): UiSdlDynamicComponentRendererDataSpec;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): UiSdlDynamicComponentRendererDataSpec;

  mergeJson(json: any | null): UiSdlDynamicComponentRendererDataSpec;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): UiSdlDynamicComponentRendererDataSpec;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): UiSdlDynamicComponentRendererDataSpec;
   ...
   */
  singletonArray(): C3.Array<UiSdlDynamicComponentRendererDataSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<UiSdlDynamicComponentRendererDataSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<UiSdlDynamicComponentRendererDataSpec | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<UiSdlDynamicComponentRendererDataSpec | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<UiSdlDynamicComponentRendererDataSpec | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, UiSdlDynamicComponentRendererDataSpec | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, UiSdlDynamicComponentRendererDataSpec | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<UiSdlDynamicComponentRendererDataSpec | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<UiSdlDynamicComponentRendererDataSpec | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): UiSdlDynamicComponentRendererDataSpec;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): UiSdlDynamicComponentRendererDataSpec;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): UiSdlDynamicComponentRendererDataSpec;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): UiSdlDynamicComponentRendererDataSpec;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): UiSdlDynamicComponentRendererDataSpec;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): UiSdlDynamicComponentRendererDataSpec;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): UiSdlDynamicComponentRendererDataSpec;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): UiSdlDynamicComponentRendererDataSpec;
   ...
   */
  static cachedEmptyInst(): UiSdlDynamicComponentRendererDataSpec;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<UiSdlDynamicComponentRendererDataSpec>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): UiSdlDynamicComponentRendererDataSpec;
   ...
   */
  static getDataTypeName(dataSpec?: UiSdlDynamicComponentRendererDataSpec | null): string | null;
