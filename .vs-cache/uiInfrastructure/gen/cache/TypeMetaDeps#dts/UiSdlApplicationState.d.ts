// TypeScript definitions for the C3 type UiSdlApplicationState
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of UiSdlApplicationState
 */
declare interface IUiSdlApplicationState {
 ...
 */
declare class UiSdlApplicationState extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): UiSdlApplicationState | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): UiSdlApplicationState | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): UiSdlApplicationState | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): UiSdlApplicationState | null;
   ...
   */
  replaceType(old: Type, new_: Type): UiSdlApplicationState;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlApplicationState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlApplicationState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlApplicationState | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlApplicationState | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): UiSdlApplicationState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlApplicationState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlApplicationState;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): UiSdlApplicationState;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): UiSdlApplicationState;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): UiSdlApplicationState;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): UiSdlApplicationState;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): UiSdlApplicationState;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): UiSdlApplicationState;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): UiSdlApplicationState;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): UiSdlApplicationState;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): UiSdlApplicationState;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): UiSdlApplicationState;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): UiSdlApplicationState;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): UiSdlApplicationState;
   ...
   * @see #unsetField
   */
  defaultField(field: string): UiSdlApplicationState;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): UiSdlApplicationState;
   ...
   * @see #removeField
   */
  unsetField(field: string): UiSdlApplicationState;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): UiSdlApplicationState;
   ...
   * @see #unsetField
   */
  removeField(field: string): UiSdlApplicationState;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): UiSdlApplicationState;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): UiSdlApplicationState;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): UiSdlApplicationState;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): UiSdlApplicationState;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): UiSdlApplicationState;

  mergeJson(json: any | null): UiSdlApplicationState;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): UiSdlApplicationState;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): UiSdlApplicationState;
   ...
   */
  singletonArray(): C3.Array<UiSdlApplicationState | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<UiSdlApplicationState | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<UiSdlApplicationState | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<UiSdlApplicationState | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<UiSdlApplicationState | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, UiSdlApplicationState | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, UiSdlApplicationState | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<UiSdlApplicationState | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<UiSdlApplicationState | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): UiSdlApplicationState;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): UiSdlApplicationState;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): UiSdlApplicationState;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): UiSdlApplicationState;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): UiSdlApplicationState;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): UiSdlApplicationState;
   ...
   * @see #fromString
   */
  static make(s: string | null): UiSdlApplicationState | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): UiSdlApplicationState;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): UiSdlApplicationState;
   ...
   */
  static cachedEmptyInst(): UiSdlApplicationState;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<UiSdlApplicationState>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): UiSdlApplicationState;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<UiSdlApplicationState | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<UiSdlApplicationState | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<UiSdlApplicationState | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<UiSdlApplicationState | null> | null>;
   ...
   */
  dependencies(): MetadataDeps<UiSdlApplicationState | null>;

  save(subPath?: string | null, contentType?: string | null): UiSdlApplicationState;
  ...
  update(srcObj?: UiSdlApplicationState | null, spec?: UpsertSpec | null): UiSdlApplicationState | null;

  upsert(srcObj?: UiSdlApplicationState | null, spec?: UpsertSpec | null): UiSdlApplicationState | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): UiSdlApplicationState | null;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string | null, failIfMissing?: boolean): UiSdlApplicationState | null;
   ...
   */
  static doDataMerge(componentId: string, dataSpecFieldName: string, dataDestinationFieldName: string, props: UiSdlApplicationState, state: UiSdlReduxState): UiSdlApplicationState | null;
