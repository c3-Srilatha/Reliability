// TypeScript definitions for the C3 type BundlerTestAppNumericEnumType

/**
 * An enum test type with int values.
 *
 * @remarks this represents a value passed to a method that expects an instance of BundlerTestAppNumericEnumType
 */
declare interface IBundlerTestAppNumericEnumType {
 ...
 * An enum test type with int values.
 *
 * @remarks this represents a made instance of BundlerTestAppNumericEnumType
 */
declare class BundlerTestAppNumericEnumType {

  static readonly FIRST: 1;

  static readonly SECOND: 2;
