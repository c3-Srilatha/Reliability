// TypeScript definitions for the C3 type BundlerTestAppNestedTypeDataSpec

/**
 * A data spec for testing {@link UiSdlMetadataBundler} and {@link UiSdlMetadataLoader}.
 *
 * @remarks this represents a value passed to a method that expects an instance of BundlerTestAppNestedTypeDataSpec
 */
declare interface IBundlerTestAppNestedTypeDataSpec {
 ...
 */
declare class BundlerTestAppNestedTypeDataSpec extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): BundlerTestAppNestedTypeDataSpec | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): BundlerTestAppNestedTypeDataSpec | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): BundlerTestAppNestedTypeDataSpec | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): BundlerTestAppNestedTypeDataSpec | null;
   ...
   */
  replaceType(old: Type, new_: Type): BundlerTestAppNestedTypeDataSpec;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): BundlerTestAppNestedTypeDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): BundlerTestAppNestedTypeDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<BundlerTestAppNestedTypeDataSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<BundlerTestAppNestedTypeDataSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): BundlerTestAppNestedTypeDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): BundlerTestAppNestedTypeDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): BundlerTestAppNestedTypeDataSpec;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): BundlerTestAppNestedTypeDataSpec;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): BundlerTestAppNestedTypeDataSpec;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): BundlerTestAppNestedTypeDataSpec;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): BundlerTestAppNestedTypeDataSpec;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): BundlerTestAppNestedTypeDataSpec;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): BundlerTestAppNestedTypeDataSpec;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): BundlerTestAppNestedTypeDataSpec;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): BundlerTestAppNestedTypeDataSpec;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): BundlerTestAppNestedTypeDataSpec;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): BundlerTestAppNestedTypeDataSpec;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): BundlerTestAppNestedTypeDataSpec;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): BundlerTestAppNestedTypeDataSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: string): BundlerTestAppNestedTypeDataSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): BundlerTestAppNestedTypeDataSpec;
   ...
   * @see #removeField
   */
  unsetField(field: string): BundlerTestAppNestedTypeDataSpec;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): BundlerTestAppNestedTypeDataSpec;
   ...
   * @see #unsetField
   */
  removeField(field: string): BundlerTestAppNestedTypeDataSpec;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): BundlerTestAppNestedTypeDataSpec;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): BundlerTestAppNestedTypeDataSpec;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): BundlerTestAppNestedTypeDataSpec;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): BundlerTestAppNestedTypeDataSpec;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): BundlerTestAppNestedTypeDataSpec;

  mergeJson(json: any | null): BundlerTestAppNestedTypeDataSpec;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): BundlerTestAppNestedTypeDataSpec;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): BundlerTestAppNestedTypeDataSpec;
   ...
   */
  singletonArray(): C3.Array<BundlerTestAppNestedTypeDataSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<BundlerTestAppNestedTypeDataSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<BundlerTestAppNestedTypeDataSpec | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<BundlerTestAppNestedTypeDataSpec | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<BundlerTestAppNestedTypeDataSpec | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, BundlerTestAppNestedTypeDataSpec | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, BundlerTestAppNestedTypeDataSpec | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<BundlerTestAppNestedTypeDataSpec | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<BundlerTestAppNestedTypeDataSpec | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): BundlerTestAppNestedTypeDataSpec;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): BundlerTestAppNestedTypeDataSpec;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): BundlerTestAppNestedTypeDataSpec;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): BundlerTestAppNestedTypeDataSpec;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): BundlerTestAppNestedTypeDataSpec;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): BundlerTestAppNestedTypeDataSpec;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): BundlerTestAppNestedTypeDataSpec;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): BundlerTestAppNestedTypeDataSpec;
   ...
   */
  static cachedEmptyInst(): BundlerTestAppNestedTypeDataSpec;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<BundlerTestAppNestedTypeDataSpec>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): BundlerTestAppNestedTypeDataSpec;
   ...
   */
  static getDataTypeName(dataSpec?: BundlerTestAppNestedTypeDataSpec | null): string | null;
