// TypeScript definitions for the C3 type UiSdlMetadataFileManifest
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of UiSdlMetadataFileManifest
 */
declare interface IUiSdlMetadataFileManifest {
 ...
 */
declare class UiSdlMetadataFileManifest extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): UiSdlMetadataFileManifest | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): UiSdlMetadataFileManifest | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): UiSdlMetadataFileManifest | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): UiSdlMetadataFileManifest | null;
   ...
   */
  replaceType(old: Type, new_: Type): UiSdlMetadataFileManifest;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlMetadataFileManifest;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlMetadataFileManifest;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlMetadataFileManifest | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlMetadataFileManifest | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): UiSdlMetadataFileManifest;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlMetadataFileManifest;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlMetadataFileManifest;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): UiSdlMetadataFileManifest;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): UiSdlMetadataFileManifest;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): UiSdlMetadataFileManifest;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): UiSdlMetadataFileManifest;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): UiSdlMetadataFileManifest;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): UiSdlMetadataFileManifest;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): UiSdlMetadataFileManifest;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): UiSdlMetadataFileManifest;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): UiSdlMetadataFileManifest;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): UiSdlMetadataFileManifest;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): UiSdlMetadataFileManifest;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): UiSdlMetadataFileManifest;
   ...
   * @see #unsetField
   */
  defaultField(field: string): UiSdlMetadataFileManifest;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): UiSdlMetadataFileManifest;
   ...
   * @see #removeField
   */
  unsetField(field: string): UiSdlMetadataFileManifest;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): UiSdlMetadataFileManifest;
   ...
   * @see #unsetField
   */
  removeField(field: string): UiSdlMetadataFileManifest;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): UiSdlMetadataFileManifest;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): UiSdlMetadataFileManifest;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): UiSdlMetadataFileManifest;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): UiSdlMetadataFileManifest;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): UiSdlMetadataFileManifest;

  mergeJson(json: any | null): UiSdlMetadataFileManifest;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): UiSdlMetadataFileManifest;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): UiSdlMetadataFileManifest;
   ...
   */
  singletonArray(): C3.Array<UiSdlMetadataFileManifest | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<UiSdlMetadataFileManifest | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<UiSdlMetadataFileManifest | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<UiSdlMetadataFileManifest | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<UiSdlMetadataFileManifest | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, UiSdlMetadataFileManifest | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, UiSdlMetadataFileManifest | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<UiSdlMetadataFileManifest | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<UiSdlMetadataFileManifest | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): UiSdlMetadataFileManifest;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): UiSdlMetadataFileManifest;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): UiSdlMetadataFileManifest;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): UiSdlMetadataFileManifest;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): UiSdlMetadataFileManifest;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): UiSdlMetadataFileManifest;
   ...
   * @see #fromString
   */
  static make(s: string | null): UiSdlMetadataFileManifest | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): UiSdlMetadataFileManifest;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): UiSdlMetadataFileManifest;
   ...
   */
  static cachedEmptyInst(): UiSdlMetadataFileManifest;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<UiSdlMetadataFileManifest>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): UiSdlMetadataFileManifest;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<UiSdlMetadataFileManifest | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<UiSdlMetadataFileManifest | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<UiSdlMetadataFileManifest | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<UiSdlMetadataFileManifest | null> | null>;
   ...
   */
  get(include?: string | null): UiSdlMetadataFileManifest | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): UiSdlMetadataFileManifest | null;
   ...
   */
  getMissing(spec: GetMissingSpec): UiSdlMetadataFileManifest;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): UiSdlMetadataFileManifest | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): UiSdlMetadataFileManifest;
   ...
   * @see #toString
   */
  static fromString(s: string | null): UiSdlMetadataFileManifest | null;
   ...
   */
  create(spec?: UpsertSpec | null): UiSdlMetadataFileManifest | null;
   ...
   */
  static createBatch(objs: C3.Array<UiSdlMetadataFileManifest | null> | null, spec?: UpsertSpec | null): ObjList<UiSdlMetadataFileManifest | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<UiSdlMetadataFileManifest | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<UiSdlMetadataFileManifest | null> | null;
   ...
   */
  update(srcObj?: UiSdlMetadataFileManifest | null, spec?: UpsertSpec | null): UiSdlMetadataFileManifest | null;
   ...
   */
  upsert(srcObj?: UiSdlMetadataFileManifest | null, spec?: UpsertSpec | null): UiSdlMetadataFileManifest | null;
   ...
   */
  merge(spec?: MergeSpec | null): UiSdlMetadataFileManifest | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): UiSdlMetadataFileManifest | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): UiSdlMetadataFileManifest | null;
   ...
   */
  static updateBatch(objs: C3.Array<UiSdlMetadataFileManifest | null> | null, srcObjs?: C3.Array<UiSdlMetadataFileManifest | null>, spec?: UpsertSpec | null): ObjList<UiSdlMetadataFileManifest | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<UiSdlMetadataFileManifest | null>>, spec?: UpsertSpec | null): ObjList<UiSdlMetadataFileManifest | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<UiSdlMetadataFileManifest | null> | null, srcObjs?: C3.Array<UiSdlMetadataFileManifest | null>, spec?: UpsertSpec | null): ObjList<UiSdlMetadataFileManifest | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<UiSdlMetadataFileManifest | null>>, spec?: UpsertSpec | null): ObjList<UiSdlMetadataFileManifest | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<UiSdlMetadataFileManifest | null> | null, spec?: TouchSpec | null): ObjList<UiSdlMetadataFileManifest | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<UiSdlMetadataFileManifest | null> | null, spec?: MergeSpec | null): ObjList<UiSdlMetadataFileManifest | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<UiSdlMetadataFileManifest | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<UiSdlMetadataFileManifest | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<UiSdlMetadataFileManifest | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<UiSdlMetadataFileManifest | null> | null;
   ...
   */
  static mergeAll(mergeObj: UiSdlMetadataFileManifest | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: UiSdlMetadataFileManifest | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<UiSdlMetadataFileManifest | null> | null, spec?: UpsertSpec | null): ObjList<UiSdlMetadataFileManifest | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<UiSdlMetadataFileManifest | null> | null, spec?: UpsertSpec | null): ObjList<UiSdlMetadataFileManifest | null> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): UiSdlMetadataFileManifest | null;
   ...
   */
  static beforeCreate(objs: C3.Array<UiSdlMetadataFileManifest | null> | null): ObjList<UiSdlMetadataFileManifest | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<UiSdlMetadataFileManifest | null> | null): ObjList<UiSdlMetadataFileManifest | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<UiSdlMetadataFileManifest | null> | null): ObjList<UiSdlMetadataFileManifest | null>;
   ...
   */
  static afterCreate(objs: C3.Array<UiSdlMetadataFileManifest | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<UiSdlMetadataFileManifest | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<UiSdlMetadataFileManifest | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<UiSdlMetadataFileManifest | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<UiSdlMetadataFileManifest | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): UiSdlMetadataFileManifest | null;
   ...
   */
  withoutIdentity(): UiSdlMetadataFileManifest | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<UiSdlMetadataFileManifest | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: UiSdlMetadataFileManifest | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<UiSdlMetadataFileManifest | null> | null, callback?: λFunction<UiSdlMetadataFileManifest | null, UiSdlMetadataFileManifest | null> | null): ObjList<UiSdlMetadataFileManifest | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<UiSdlMetadataFileManifest | null> | null, callback?: λFunction<UiSdlMetadataFileManifest | null, UiSdlMetadataFileManifest | null> | null): C3.Array<ObjError | null>;
