...
# Python definitions for the C3 type UiSdlTemporalUnit


class UiSdlTemporalUnit():
    """
    ...
    def __init__(self, NANOSECOND: Optional[str]=None, MILLISECOND: Optional[str]=None, SECOND: Optional[str]=None, MINUTE: Optional[str]=None, HOUR: Optional[str]=None, DAY: Optional[str]=None, MONTH: Optional[str]=None, YEAR: Optional[str]=None) -> None: ...
