...
class UiSdlConfig(Config, DefaultInstance):
    ...
    """
    def __init__(self, configOverride: Optional[str]=None, secretOverride: Optional[str]=None, issues: Optional[Array[str]]=None, i18n: Optional[UiSdlI18nConfig]=None, infrastructure: Optional[UiSdlInfrastructureConfig]=None, security: Optional[UiSdlSecurityConfig]=None, style: Optional[UiSdlStyleConfig]=None, performanceMeasurement: Optional[UiSdlPerformanceMeasureConfig]=None, ignoreRequestsWithFalsyContextVars: Optional[Map[str, bool]]=None, app: Optional[UiSdlApplicationConfig]=None) -> None: ...
