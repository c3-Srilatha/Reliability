...
# Python definitions for the C3 type BundlerTestAppNumericEnumType


class BundlerTestAppNumericEnumType():
    """
    ...
    def __init__(self, FIRST: Optional[int]=None, SECOND: Optional[int]=None, THIRD: Optional[int]=None) -> None: ...
