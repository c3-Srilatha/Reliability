...
# Python definitions for the C3 type UiSdlPerformanceMark


class UiSdlPerformanceMark():
    """
    ...
    pageImportStartMark: Optional[str]=None
    """
    Performance mark for when page import starts.
    """

    appDataLoadedMark: Optional[str]=None
    """
    Performance mark for when application data load finishes.
    """

    pageLoadedMark: Optional[str]=None
    """
    Performance mark for when application page load finishes.
    """

    startXhrMarkPrefix: Optional[str]=None
    """
    Performance mark prefix for when an xhr request starts.
    """

    endXhrMarkPrefix: Optional[str]=None
    """
    Performance mark prefix for when an xhr request finished.
    """
    def __init__(self, pageImportStartMark: Optional[str]=None, appDataLoadedMark: Optional[str]=None, pageLoadedMark: Optional[str]=None, startXhrMarkPrefix: Optional[str]=None, endXhrMarkPrefix: Optional[str]=None) -> None: ...
