// TypeScript definitions for the C3 type GroupedLOVItem
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of GroupedLOVItem
 */
declare interface IGroupedLOVItem<T> {
 ...
 */
declare class GroupedLOVItem<T> extends Obj  {
   ...
   */
  readonly id: string;
  withId(id: string): GroupedLOVItem;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): GroupedLOVItem;

  /**
   * The name of this LOV item.
   */
  readonly name?: string;
  withName(name: string | null): GroupedLOVItem;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): GroupedLOVItem;
  ...
  withVersion(version: number | null): GroupedLOVItem;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): GroupedLOVItem;
  ...
  withUserUpdatedFields(userUpdatedFields: Array_Type<string> | Array<string> | null): GroupedLOVItem;
  ...
  withHidden(hidden: boolean): GroupedLOVItem;
  ...
  withUserOwned(userOwned: boolean): GroupedLOVItem;
  ...
  withTypeIdent(typeIdent: string | null): GroupedLOVItem;

  /**
   * The position of this LOV item in the list of values.
   */
  readonly position?: number;
  withPosition(position: number | null): GroupedLOVItem;
   ...
   */
  readonly parent?: T;
  withParent(parent: T | null): GroupedLOVItem;
   ...
   * @see #toJson
   */
  static fromJson(json: any): GroupedLOVItem<T> | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): GroupedLOVItem<T> | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): GroupedLOVItem<T> | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): GroupedLOVItem<T> | null;
   ...
   */
  replaceType(old: Type, new_: Type): GroupedLOVItem<T>;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GroupedLOVItem<T>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GroupedLOVItem<T>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<GroupedLOVItem<T>>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<GroupedLOVItem<T>>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): GroupedLOVItem<T>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GroupedLOVItem<T>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GroupedLOVItem<T>;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): GroupedLOVItem<T>;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): GroupedLOVItem<T>;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): GroupedLOVItem<T>;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): GroupedLOVItem<T>;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): GroupedLOVItem<T>;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): GroupedLOVItem<T>;
   ...
   * @see #removeField
   */
  withoutField(field: string): GroupedLOVItem<T>;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): GroupedLOVItem<T>;
   ...
   */
  withoutFields(fields: Array_Type<string>): GroupedLOVItem<T>;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): GroupedLOVItem<T>;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): GroupedLOVItem<T>;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): GroupedLOVItem<T>;
   ...
   * @see #unsetField
   */
  defaultField(field: string): GroupedLOVItem<T>;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): GroupedLOVItem<T>;
   ...
   * @see #removeField
   */
  unsetField(field: string): GroupedLOVItem<T>;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): GroupedLOVItem<T>;
   ...
   * @see #unsetField
   */
  removeField(field: string): GroupedLOVItem<T>;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): GroupedLOVItem<T>;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): GroupedLOVItem<T>;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): GroupedLOVItem<T>;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): GroupedLOVItem<T>;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): GroupedLOVItem<T>;

  mergeJson(json: any): GroupedLOVItem<T>;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): GroupedLOVItem<T>;
   ...
   */
  sumObj(other: Obj, deep?: boolean): GroupedLOVItem<T>;
   ...
   */
  singletonArray(): Array_Type<GroupedLOVItem<T>>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<GroupedLOVItem<T>> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<GroupedLOVItem<T>> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<GroupedLOVItem<T>>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<GroupedLOVItem<T>> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, GroupedLOVItem<T>> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, GroupedLOVItem<T>> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<GroupedLOVItem<T>>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<GroupedLOVItem<T>>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): GroupedLOVItem<T>;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): GroupedLOVItem<T>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): GroupedLOVItem<T>;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): GroupedLOVItem<T>;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): GroupedLOVItem<T>;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): GroupedLOVItem<T>;
   ...
   * @see #fromString
   */
  static make(s: string): GroupedLOVItem<T> | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): GroupedLOVItem<T>;
   ...
   */
  static cachedEmptyInst(): GroupedLOVItem<T>;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<GroupedLOVItem<T>> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): GroupedLOVItem<T>;
   ...
   */
  static allCached(): Stream<GroupedLOVItem<T>> | null;
   ...
   */
  static find(filter?: string): Stream<GroupedLOVItem<T>> | null;
   ...
   *         Otherwise no population will be performed.
   */
  static findBy(field: string, value: any): Stream<GroupedLOVItem<T>> | null;

  /**
   * @return cached instance.
   */
  getCached(): GroupedLOVItem<T> | null;

  /**
   * @return cached instance by the key.
   */
  static forCacheKey(key: string): GroupedLOVItem<T> | null;
   ...
   */
  static produce(key: string): GroupedLOVItem<T> | null;

  /**
   * Should produces the entire content for the cached data. Will populate the cache with the produced data.
   */
  static produceAll(): Map_Type<string, GroupedLOVItem<T>> | null;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<GroupedLOVItem<T>>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<GroupedLOVItem<T>>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<GroupedLOVItem<T>> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<GroupedLOVItem<T>>> | null;
   ...
   */
  get(include?: string): GroupedLOVItem<T> | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): GroupedLOVItem<T> | null;
   ...
   */
  getMissing(spec: GetMissingSpec): GroupedLOVItem<T>;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): GroupedLOVItem<T> | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): GroupedLOVItem<T>;
   ...
   * @see #toString
   */
  static fromString(s: string): GroupedLOVItem<T> | null;
   ...
   */
  create(spec?: UpsertSpec): GroupedLOVItem<T> | null;
   ...
   */
  static createBatch(objs: Array_Type<GroupedLOVItem<T>>, spec?: UpsertSpec): ObjList<GroupedLOVItem<T>> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<GroupedLOVItem<T>>, spec?: CreateBatchObjStreamSpec): ObjList<GroupedLOVItem<T>> | null;
   ...
   */
  update(srcObj?: GroupedLOVItem<T>, spec?: UpsertSpec): GroupedLOVItem<T> | null;
   ...
   */
  upsert(srcObj?: GroupedLOVItem<T>, spec?: UpsertSpec): GroupedLOVItem<T> | null;
   ...
   */
  merge(spec?: MergeSpec): GroupedLOVItem<T> | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): GroupedLOVItem<T> | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): GroupedLOVItem<T> | null;
   ...
   */
  static updateBatch(objs: Array_Type<GroupedLOVItem<T>>, srcObjs?: Array_Type<GroupedLOVItem<T>>, spec?: UpsertSpec): ObjList<GroupedLOVItem<T>> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<GroupedLOVItem<T>> | null>, spec?: UpsertSpec): ObjList<GroupedLOVItem<T>> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<GroupedLOVItem<T>>, srcObjs?: Array_Type<GroupedLOVItem<T>>, spec?: UpsertSpec): ObjList<GroupedLOVItem<T>> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<GroupedLOVItem<T>> | null>, spec?: UpsertSpec): ObjList<GroupedLOVItem<T>> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<GroupedLOVItem<T>>, spec?: TouchSpec): ObjList<GroupedLOVItem<T>> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<GroupedLOVItem<T>>, spec?: MergeSpec): ObjList<GroupedLOVItem<T>> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<GroupedLOVItem<T>>, mergeInclude: string, spec?: MergeSpec): ObjList<GroupedLOVItem<T>> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<GroupedLOVItem<T>> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<GroupedLOVItem<T>> | null;
   ...
   */
  static mergeAll(mergeObj: GroupedLOVItem<T>, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: GroupedLOVItem<T>, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<GroupedLOVItem<T>>, spec?: UpsertSpec): ObjList<GroupedLOVItem<T>> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<GroupedLOVItem<T>>, spec?: UpsertSpec): ObjList<GroupedLOVItem<T>> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): GroupedLOVItem<T> | null;
   ...
   */
  static beforeCreate(objs: Array_Type<GroupedLOVItem<T>>): ObjList<GroupedLOVItem<T>>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<GroupedLOVItem<T>>): ObjList<GroupedLOVItem<T>>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<GroupedLOVItem<T>>): ObjList<GroupedLOVItem<T>>;
   ...
   */
  static afterCreate(objs: Array_Type<GroupedLOVItem<T>>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<GroupedLOVItem<T>>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<GroupedLOVItem<T>>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<GroupedLOVItem<T>>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<GroupedLOVItem<T>>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): GroupedLOVItem<T> | null;
   ...
   */
  withoutIdentity(): GroupedLOVItem<T> | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<GroupedLOVItem<T>>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: GroupedLOVItem<T>, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<GroupedLOVItem<T>>, callback?: λFunction<GroupedLOVItem<T> | null, GroupedLOVItem<T> | null>): ObjList<GroupedLOVItem<T>>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<GroupedLOVItem<T>>, callback?: λFunction<GroupedLOVItem<T> | null, GroupedLOVItem<T> | null>): Array_Type<ObjError> | null;
   ...
   */
  publish(subPath?: string, contentType?: string): GroupedLOVItem<T>;
   ...
   */
  static removeSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<GroupedLOVItem<T>> | null;
   ...
   */
  createSeedData(spec?: UpsertSpec): GroupedLOVItem<T> | null;
   ...
   */
  static createSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<GroupedLOVItem<T>> | null;
   ...
   */
  updateSeedData(srcObj?: SeedData, spec?: UpsertSpec): GroupedLOVItem<T> | null;
   ...
   */
  static updateSeedDataBatch(objs?: Array_Type<SeedData>, srcObjs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<GroupedLOVItem<T>> | null;
   ...
   * @return updated obj instance, same as {@link Persistable#update} return value.
   */
  clearUserUpdates(spec?: MergeSpec): GroupedLOVItem<T> | null;
   ...
   *         {@link Persistable#updateBatch}.
   */
  static clearUserUpdatesBatch(objs?: Array_Type<SeedData>, spec?: MergeSpec): ObjList<GroupedLOVItem<T>> | null;
  ...
  dependencies(): SeedDataDeps<GroupedLOVItem<T>> | null;
