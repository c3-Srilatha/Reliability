// TypeScript definitions for the C3 type RecursiveLOVItem
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of RecursiveLOVItem
 */
declare interface IRecursiveLOVItem<T> {
 ...
 */
declare class RecursiveLOVItem<T> extends Obj  {
   ...
   */
  readonly id: string;
  withId(id: string): RecursiveLOVItem;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): RecursiveLOVItem;

  /**
   * The name of this LOV item.
   */
  readonly name?: string;
  withName(name: string | null): RecursiveLOVItem;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): RecursiveLOVItem;
  ...
  withVersion(version: number | null): RecursiveLOVItem;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): RecursiveLOVItem;
  ...
  withUserUpdatedFields(userUpdatedFields: Array_Type<string> | Array<string> | null): RecursiveLOVItem;
  ...
  withHidden(hidden: boolean): RecursiveLOVItem;
  ...
  withUserOwned(userOwned: boolean): RecursiveLOVItem;
  ...
  withTypeIdent(typeIdent: string | null): RecursiveLOVItem;

  /**
   * The position of this LOV item in the list of values.
   */
  readonly position?: number;
  withPosition(position: number | null): RecursiveLOVItem;
   ...
   */
  readonly parent?: T;
  withParent(parent: T | null): RecursiveLOVItem;
  ...
  withChildren(children: Array_Type<T> | Array<T> | null): RecursiveLOVItem;
   ...
   * @see #toJson
   */
  static fromJson(json: any): RecursiveLOVItem<T> | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): RecursiveLOVItem<T> | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): RecursiveLOVItem<T> | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): RecursiveLOVItem<T> | null;
   ...
   */
  replaceType(old: Type, new_: Type): RecursiveLOVItem<T>;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): RecursiveLOVItem<T>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): RecursiveLOVItem<T>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<RecursiveLOVItem<T>>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<RecursiveLOVItem<T>>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): RecursiveLOVItem<T>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): RecursiveLOVItem<T>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): RecursiveLOVItem<T>;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): RecursiveLOVItem<T>;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): RecursiveLOVItem<T>;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): RecursiveLOVItem<T>;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): RecursiveLOVItem<T>;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): RecursiveLOVItem<T>;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): RecursiveLOVItem<T>;
   ...
   * @see #removeField
   */
  withoutField(field: string): RecursiveLOVItem<T>;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): RecursiveLOVItem<T>;
   ...
   */
  withoutFields(fields: Array_Type<string>): RecursiveLOVItem<T>;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): RecursiveLOVItem<T>;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): RecursiveLOVItem<T>;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): RecursiveLOVItem<T>;
   ...
   * @see #unsetField
   */
  defaultField(field: string): RecursiveLOVItem<T>;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): RecursiveLOVItem<T>;
   ...
   * @see #removeField
   */
  unsetField(field: string): RecursiveLOVItem<T>;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): RecursiveLOVItem<T>;
   ...
   * @see #unsetField
   */
  removeField(field: string): RecursiveLOVItem<T>;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): RecursiveLOVItem<T>;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): RecursiveLOVItem<T>;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): RecursiveLOVItem<T>;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): RecursiveLOVItem<T>;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): RecursiveLOVItem<T>;

  mergeJson(json: any): RecursiveLOVItem<T>;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): RecursiveLOVItem<T>;
   ...
   */
  sumObj(other: Obj, deep?: boolean): RecursiveLOVItem<T>;
   ...
   */
  singletonArray(): Array_Type<RecursiveLOVItem<T>>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<RecursiveLOVItem<T>> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<RecursiveLOVItem<T>> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<RecursiveLOVItem<T>>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<RecursiveLOVItem<T>> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, RecursiveLOVItem<T>> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, RecursiveLOVItem<T>> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<RecursiveLOVItem<T>>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<RecursiveLOVItem<T>>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): RecursiveLOVItem<T>;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): RecursiveLOVItem<T>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): RecursiveLOVItem<T>;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): RecursiveLOVItem<T>;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): RecursiveLOVItem<T>;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): RecursiveLOVItem<T>;
   ...
   * @see #fromString
   */
  static make(s: string): RecursiveLOVItem<T> | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): RecursiveLOVItem<T>;
   ...
   */
  static cachedEmptyInst(): RecursiveLOVItem<T>;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<RecursiveLOVItem<T>> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): RecursiveLOVItem<T>;
   ...
   */
  static allCached(): Stream<RecursiveLOVItem<T>> | null;
   ...
   */
  static find(filter?: string): Stream<RecursiveLOVItem<T>> | null;
   ...
   *         Otherwise no population will be performed.
   */
  static findBy(field: string, value: any): Stream<RecursiveLOVItem<T>> | null;

  /**
   * @return cached instance.
   */
  getCached(): RecursiveLOVItem<T> | null;

  /**
   * @return cached instance by the key.
   */
  static forCacheKey(key: string): RecursiveLOVItem<T> | null;
   ...
   */
  static produce(key: string): RecursiveLOVItem<T> | null;

  /**
   * Should produces the entire content for the cached data. Will populate the cache with the produced data.
   */
  static produceAll(): Map_Type<string, RecursiveLOVItem<T>> | null;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<RecursiveLOVItem<T>>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<RecursiveLOVItem<T>>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<RecursiveLOVItem<T>> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<RecursiveLOVItem<T>>> | null;
   ...
   */
  get(include?: string): RecursiveLOVItem<T> | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): RecursiveLOVItem<T> | null;
   ...
   */
  getMissing(spec: GetMissingSpec): RecursiveLOVItem<T>;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): RecursiveLOVItem<T> | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): RecursiveLOVItem<T>;
   ...
   * @see #toString
   */
  static fromString(s: string): RecursiveLOVItem<T> | null;
   ...
   */
  create(spec?: UpsertSpec): RecursiveLOVItem<T> | null;
   ...
   */
  static createBatch(objs: Array_Type<RecursiveLOVItem<T>>, spec?: UpsertSpec): ObjList<RecursiveLOVItem<T>> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<RecursiveLOVItem<T>>, spec?: CreateBatchObjStreamSpec): ObjList<RecursiveLOVItem<T>> | null;
   ...
   */
  update(srcObj?: RecursiveLOVItem<T>, spec?: UpsertSpec): RecursiveLOVItem<T> | null;
   ...
   */
  upsert(srcObj?: RecursiveLOVItem<T>, spec?: UpsertSpec): RecursiveLOVItem<T> | null;
   ...
   */
  merge(spec?: MergeSpec): RecursiveLOVItem<T> | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): RecursiveLOVItem<T> | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): RecursiveLOVItem<T> | null;
   ...
   */
  static updateBatch(objs: Array_Type<RecursiveLOVItem<T>>, srcObjs?: Array_Type<RecursiveLOVItem<T>>, spec?: UpsertSpec): ObjList<RecursiveLOVItem<T>> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<RecursiveLOVItem<T>> | null>, spec?: UpsertSpec): ObjList<RecursiveLOVItem<T>> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<RecursiveLOVItem<T>>, srcObjs?: Array_Type<RecursiveLOVItem<T>>, spec?: UpsertSpec): ObjList<RecursiveLOVItem<T>> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<RecursiveLOVItem<T>> | null>, spec?: UpsertSpec): ObjList<RecursiveLOVItem<T>> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<RecursiveLOVItem<T>>, spec?: TouchSpec): ObjList<RecursiveLOVItem<T>> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<RecursiveLOVItem<T>>, spec?: MergeSpec): ObjList<RecursiveLOVItem<T>> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<RecursiveLOVItem<T>>, mergeInclude: string, spec?: MergeSpec): ObjList<RecursiveLOVItem<T>> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<RecursiveLOVItem<T>> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<RecursiveLOVItem<T>> | null;
   ...
   */
  static mergeAll(mergeObj: RecursiveLOVItem<T>, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: RecursiveLOVItem<T>, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<RecursiveLOVItem<T>>, spec?: UpsertSpec): ObjList<RecursiveLOVItem<T>> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<RecursiveLOVItem<T>>, spec?: UpsertSpec): ObjList<RecursiveLOVItem<T>> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): RecursiveLOVItem<T> | null;
   ...
   */
  static beforeCreate(objs: Array_Type<RecursiveLOVItem<T>>): ObjList<RecursiveLOVItem<T>>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<RecursiveLOVItem<T>>): ObjList<RecursiveLOVItem<T>>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<RecursiveLOVItem<T>>): ObjList<RecursiveLOVItem<T>>;
   ...
   */
  static afterCreate(objs: Array_Type<RecursiveLOVItem<T>>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<RecursiveLOVItem<T>>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<RecursiveLOVItem<T>>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<RecursiveLOVItem<T>>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<RecursiveLOVItem<T>>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): RecursiveLOVItem<T> | null;
   ...
   */
  withoutIdentity(): RecursiveLOVItem<T> | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<RecursiveLOVItem<T>>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: RecursiveLOVItem<T>, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<RecursiveLOVItem<T>>, callback?: λFunction<RecursiveLOVItem<T> | null, RecursiveLOVItem<T> | null>): ObjList<RecursiveLOVItem<T>>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<RecursiveLOVItem<T>>, callback?: λFunction<RecursiveLOVItem<T> | null, RecursiveLOVItem<T> | null>): Array_Type<ObjError> | null;
   ...
   */
  publish(subPath?: string, contentType?: string): RecursiveLOVItem<T>;
   ...
   */
  static removeSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<RecursiveLOVItem<T>> | null;
   ...
   */
  createSeedData(spec?: UpsertSpec): RecursiveLOVItem<T> | null;
   ...
   */
  static createSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<RecursiveLOVItem<T>> | null;
   ...
   */
  updateSeedData(srcObj?: SeedData, spec?: UpsertSpec): RecursiveLOVItem<T> | null;
   ...
   */
  static updateSeedDataBatch(objs?: Array_Type<SeedData>, srcObjs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<RecursiveLOVItem<T>> | null;
   ...
   * @return updated obj instance, same as {@link Persistable#update} return value.
   */
  clearUserUpdates(spec?: MergeSpec): RecursiveLOVItem<T> | null;
   ...
   *         {@link Persistable#updateBatch}.
   */
  static clearUserUpdatesBatch(objs?: Array_Type<SeedData>, spec?: MergeSpec): ObjList<RecursiveLOVItem<T>> | null;
  ...
  dependencies(): SeedDataDeps<RecursiveLOVItem<T>> | null;
