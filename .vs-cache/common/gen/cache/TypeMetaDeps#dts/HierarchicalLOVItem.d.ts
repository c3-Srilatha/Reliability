// TypeScript definitions for the C3 type HierarchicalLOVItem
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of HierarchicalLOVItem
 */
declare interface IHierarchicalLOVItem<T> {
 ...
 */
declare class HierarchicalLOVItem<T> extends Obj  {
   ...
   */
  readonly id: string;
  withId(id: string): HierarchicalLOVItem;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): HierarchicalLOVItem;

  /**
   * The name of this LOV item.
   */
  readonly name?: string;
  withName(name: string | null): HierarchicalLOVItem;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): HierarchicalLOVItem;
  ...
  withVersion(version: number | null): HierarchicalLOVItem;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): HierarchicalLOVItem;
  ...
  withUserUpdatedFields(userUpdatedFields: Array_Type<string> | Array<string> | null): HierarchicalLOVItem;
  ...
  withHidden(hidden: boolean): HierarchicalLOVItem;
  ...
  withUserOwned(userOwned: boolean): HierarchicalLOVItem;
  ...
  withTypeIdent(typeIdent: string | null): HierarchicalLOVItem;

  /**
   * The position of this LOV item in the list of values.
   */
  readonly position?: number;
  withPosition(position: number | null): HierarchicalLOVItem;

  /**
   * parent   : T
   */
  readonly children?: Array_Type<T>;
  withChildren(children: Array_Type<T> | Array<T> | null): HierarchicalLOVItem;
   ...
   * @see #toJson
   */
  static fromJson(json: any): HierarchicalLOVItem<T> | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): HierarchicalLOVItem<T> | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): HierarchicalLOVItem<T> | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): HierarchicalLOVItem<T> | null;
   ...
   */
  replaceType(old: Type, new_: Type): HierarchicalLOVItem<T>;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): HierarchicalLOVItem<T>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): HierarchicalLOVItem<T>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<HierarchicalLOVItem<T>>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<HierarchicalLOVItem<T>>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): HierarchicalLOVItem<T>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): HierarchicalLOVItem<T>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): HierarchicalLOVItem<T>;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): HierarchicalLOVItem<T>;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): HierarchicalLOVItem<T>;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): HierarchicalLOVItem<T>;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): HierarchicalLOVItem<T>;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): HierarchicalLOVItem<T>;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): HierarchicalLOVItem<T>;
   ...
   * @see #removeField
   */
  withoutField(field: string): HierarchicalLOVItem<T>;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): HierarchicalLOVItem<T>;
   ...
   */
  withoutFields(fields: Array_Type<string>): HierarchicalLOVItem<T>;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): HierarchicalLOVItem<T>;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): HierarchicalLOVItem<T>;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): HierarchicalLOVItem<T>;
   ...
   * @see #unsetField
   */
  defaultField(field: string): HierarchicalLOVItem<T>;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): HierarchicalLOVItem<T>;
   ...
   * @see #removeField
   */
  unsetField(field: string): HierarchicalLOVItem<T>;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): HierarchicalLOVItem<T>;
   ...
   * @see #unsetField
   */
  removeField(field: string): HierarchicalLOVItem<T>;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): HierarchicalLOVItem<T>;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): HierarchicalLOVItem<T>;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): HierarchicalLOVItem<T>;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): HierarchicalLOVItem<T>;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): HierarchicalLOVItem<T>;

  mergeJson(json: any): HierarchicalLOVItem<T>;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): HierarchicalLOVItem<T>;
   ...
   */
  sumObj(other: Obj, deep?: boolean): HierarchicalLOVItem<T>;
   ...
   */
  singletonArray(): Array_Type<HierarchicalLOVItem<T>>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<HierarchicalLOVItem<T>> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<HierarchicalLOVItem<T>> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<HierarchicalLOVItem<T>>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<HierarchicalLOVItem<T>> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, HierarchicalLOVItem<T>> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, HierarchicalLOVItem<T>> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<HierarchicalLOVItem<T>>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<HierarchicalLOVItem<T>>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): HierarchicalLOVItem<T>;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): HierarchicalLOVItem<T>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): HierarchicalLOVItem<T>;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): HierarchicalLOVItem<T>;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): HierarchicalLOVItem<T>;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): HierarchicalLOVItem<T>;
   ...
   * @see #fromString
   */
  static make(s: string): HierarchicalLOVItem<T> | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): HierarchicalLOVItem<T>;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): HierarchicalLOVItem<T>;
   ...
   */
  static cachedEmptyInst(): HierarchicalLOVItem<T>;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<HierarchicalLOVItem<T>> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): HierarchicalLOVItem<T>;
   ...
   */
  static allCached(): Stream<HierarchicalLOVItem<T>> | null;
   ...
   */
  static find(filter?: string): Stream<HierarchicalLOVItem<T>> | null;
   ...
   *         Otherwise no population will be performed.
   */
  static findBy(field: string, value: any): Stream<HierarchicalLOVItem<T>> | null;

  /**
   * @return cached instance.
   */
  getCached(): HierarchicalLOVItem<T> | null;

  /**
   * @return cached instance by the key.
   */
  static forCacheKey(key: string): HierarchicalLOVItem<T> | null;
   ...
   */
  static produce(key: string): HierarchicalLOVItem<T> | null;

  /**
   * Should produces the entire content for the cached data. Will populate the cache with the produced data.
   */
  static produceAll(): Map_Type<string, HierarchicalLOVItem<T>> | null;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<HierarchicalLOVItem<T>>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<HierarchicalLOVItem<T>>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<HierarchicalLOVItem<T>> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<HierarchicalLOVItem<T>>> | null;
   ...
   */
  get(include?: string): HierarchicalLOVItem<T> | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): HierarchicalLOVItem<T> | null;
   ...
   */
  getMissing(spec: GetMissingSpec): HierarchicalLOVItem<T>;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): HierarchicalLOVItem<T> | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): HierarchicalLOVItem<T>;
   ...
   * @see #toString
   */
  static fromString(s: string): HierarchicalLOVItem<T> | null;
   ...
   */
  create(spec?: UpsertSpec): HierarchicalLOVItem<T> | null;
   ...
   */
  static createBatch(objs: Array_Type<HierarchicalLOVItem<T>>, spec?: UpsertSpec): ObjList<HierarchicalLOVItem<T>> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<HierarchicalLOVItem<T>>, spec?: CreateBatchObjStreamSpec): ObjList<HierarchicalLOVItem<T>> | null;
   ...
   */
  update(srcObj?: HierarchicalLOVItem<T>, spec?: UpsertSpec): HierarchicalLOVItem<T> | null;
   ...
   */
  upsert(srcObj?: HierarchicalLOVItem<T>, spec?: UpsertSpec): HierarchicalLOVItem<T> | null;
   ...
   */
  merge(spec?: MergeSpec): HierarchicalLOVItem<T> | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): HierarchicalLOVItem<T> | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): HierarchicalLOVItem<T> | null;
   ...
   */
  static updateBatch(objs: Array_Type<HierarchicalLOVItem<T>>, srcObjs?: Array_Type<HierarchicalLOVItem<T>>, spec?: UpsertSpec): ObjList<HierarchicalLOVItem<T>> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<HierarchicalLOVItem<T>> | null>, spec?: UpsertSpec): ObjList<HierarchicalLOVItem<T>> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<HierarchicalLOVItem<T>>, srcObjs?: Array_Type<HierarchicalLOVItem<T>>, spec?: UpsertSpec): ObjList<HierarchicalLOVItem<T>> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<HierarchicalLOVItem<T>> | null>, spec?: UpsertSpec): ObjList<HierarchicalLOVItem<T>> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<HierarchicalLOVItem<T>>, spec?: TouchSpec): ObjList<HierarchicalLOVItem<T>> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<HierarchicalLOVItem<T>>, spec?: MergeSpec): ObjList<HierarchicalLOVItem<T>> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<HierarchicalLOVItem<T>>, mergeInclude: string, spec?: MergeSpec): ObjList<HierarchicalLOVItem<T>> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<HierarchicalLOVItem<T>> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<HierarchicalLOVItem<T>> | null;
   ...
   */
  static mergeAll(mergeObj: HierarchicalLOVItem<T>, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: HierarchicalLOVItem<T>, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<HierarchicalLOVItem<T>>, spec?: UpsertSpec): ObjList<HierarchicalLOVItem<T>> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<HierarchicalLOVItem<T>>, spec?: UpsertSpec): ObjList<HierarchicalLOVItem<T>> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): HierarchicalLOVItem<T> | null;
   ...
   */
  static beforeCreate(objs: Array_Type<HierarchicalLOVItem<T>>): ObjList<HierarchicalLOVItem<T>>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<HierarchicalLOVItem<T>>): ObjList<HierarchicalLOVItem<T>>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<HierarchicalLOVItem<T>>): ObjList<HierarchicalLOVItem<T>>;
   ...
   */
  static afterCreate(objs: Array_Type<HierarchicalLOVItem<T>>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<HierarchicalLOVItem<T>>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<HierarchicalLOVItem<T>>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<HierarchicalLOVItem<T>>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<HierarchicalLOVItem<T>>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): HierarchicalLOVItem<T> | null;
   ...
   */
  withoutIdentity(): HierarchicalLOVItem<T> | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<HierarchicalLOVItem<T>>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: HierarchicalLOVItem<T>, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<HierarchicalLOVItem<T>>, callback?: λFunction<HierarchicalLOVItem<T> | null, HierarchicalLOVItem<T> | null>): ObjList<HierarchicalLOVItem<T>>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<HierarchicalLOVItem<T>>, callback?: λFunction<HierarchicalLOVItem<T> | null, HierarchicalLOVItem<T> | null>): Array_Type<ObjError> | null;
   ...
   */
  publish(subPath?: string, contentType?: string): HierarchicalLOVItem<T>;
   ...
   */
  static removeSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<HierarchicalLOVItem<T>> | null;
   ...
   */
  createSeedData(spec?: UpsertSpec): HierarchicalLOVItem<T> | null;
   ...
   */
  static createSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<HierarchicalLOVItem<T>> | null;
   ...
   */
  updateSeedData(srcObj?: SeedData, spec?: UpsertSpec): HierarchicalLOVItem<T> | null;
   ...
   */
  static updateSeedDataBatch(objs?: Array_Type<SeedData>, srcObjs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<HierarchicalLOVItem<T>> | null;
   ...
   * @return updated obj instance, same as {@link Persistable#update} return value.
   */
  clearUserUpdates(spec?: MergeSpec): HierarchicalLOVItem<T> | null;
   ...
   *         {@link Persistable#updateBatch}.
   */
  static clearUserUpdatesBatch(objs?: Array_Type<SeedData>, spec?: MergeSpec): ObjList<HierarchicalLOVItem<T>> | null;
  ...
  dependencies(): SeedDataDeps<HierarchicalLOVItem<T>> | null;
