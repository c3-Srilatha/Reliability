...
from c3.reliabilityMl.ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter import ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter
from c3.platform.SetBuilder import SetBuilder
...
# Python definitions for the C3 type ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter

DX = TypeVar('DX')
DO = TypeVar('DO')

class DirectionallyWeightedResidualInterpreter(Generic[DX, DO], MlInterpreter[DX, DO]):
    """
    ...
    """
    def __init__(self, name: Optional[str]=None, explainer: Optional[Union[str,Lambda[Callable[[], Union[Any]]]]]=None, initKwargs: Optional[Map[str, Any]]=None, callKwargs: Optional[Map[str, Any]]=None, actionRequirement: Optional[str]=None, typeIdent: Optional[str]=None, id: Optional[str]=None, versionEdits: Optional[Array[VersionEdit]]=None, meta: Optional[Meta]=None, version: Optional[int]=None, typeWithBindings: Optional[Type]=None) -> None: ...
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]:
    """
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]:
    """
    ...
    """
        ...
    def afterMake(self) -> ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, spec: FetchSpec=None) -> FetchResult[ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]]:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, filter: Filter) -> FetchResult[ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]]:
    """
    ...
    """
        ...
    @classmethod
    def fetchObjStream(cls, spec: FetchStreamSpec=None) -> Union[Stream[ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]]]:
    """
    Fetches multiple obj instances based on a specification.  Only objs that the caller is authorized to fetch will be
    returned.
    ...
    """
        ...
    @classmethod
    def fetchMultiLocale(cls, spec: MultiLocaleFetchSpec=None) -> Union[Map[str, FetchResult[ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]]]]:
    """
    ...
    """
        ...
    def get(self, include: str=None) -> Union[ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]]:
    """
    ...
    """
        ...
    def getSpecific(self, include: str=None) -> Union[ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]]:
    """
    ...
    """
        ...
    def getMissing(self, spec: GetMissingSpec) -> ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]:
    """
    ...
    """
        ...
    def getDirect(self, include: str=None) -> Union[ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]]:
    """
    ...
    """
        ...
    def applyReverseEdit(self, versionEdit: VersionEdit) -> ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]:
    """
    ...
    """
        ...
    @classmethod
    def fromString(cls, s: str) -> Union[ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]]:
    """
    ...
    """
        ...
    def create(self, spec: UpsertSpec=None) -> Union[ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]]:
    """
    ...
    """
        ...
    @classmethod
    def createBatch(cls, objs: Array[ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]], spec: UpsertSpec=None) -> Union[ObjList[ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]]]:
    """
    ...
    """
        ...
    @classmethod
    def createBatchObjStream(cls, objs: Stream[ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]], spec: CreateBatchObjStreamSpec=None) -> Union[ObjList[ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]]]:
    """
    Creates multiple instances of a C3 type. If the operation fails and {@link UpsertSpec#dontThrowOnBatchError} is not
    specified (the default), then a C3BatchException will be thrown.  Otherwise {@link errors will be reported in the
    returned {@link ObjList}.  This will fail if any of the instances already exist.
    ...
    """
        ...
    def update(self, srcObj: ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]=None, spec: UpsertSpec=None) -> Union[ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]]:
    """
    ...
    """
        ...
    def upsert(self, srcObj: ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]=None, spec: UpsertSpec=None) -> Union[ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]]:
    """
    ...
    """
        ...
    @overload
    def merge(self, spec: MergeSpec=None) -> Union[ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]]:
    """
    ...
    """
        ...
    @overload
    def merge(self, mergeInclude: str, spec: MergeSpec=None) -> Union[ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]]:
    """
    ...
    """
        ...
    def touch(self, spec: TouchSpec=None) -> Union[ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]]:
    """
    ...
    """
        ...
    @classmethod
    def updateBatch(cls, objs: Array[ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]], srcObjs: Array[ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]]=None, spec: UpsertSpec=None) -> Union[ObjList[ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]]]:
    """
    ...
    """
        ...
    @classmethod
    def updateObjs(cls, objs: Callable[[], Union[Array[ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]]]], spec: UpsertSpec=None) -> Union[ObjList[ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]]]:
    """
    ...
    """
        ...
    @classmethod
    def upsertBatch(cls, objs: Array[ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]], srcObjs: Array[ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]]=None, spec: UpsertSpec=None) -> Union[ObjList[ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]]]:
    """
    ...
    """
        ...
    @classmethod
    def upsertObjs(cls, objs: Callable[[], Union[Array[ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]]]], spec: UpsertSpec=None) -> Union[ObjList[ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]]]:
    """
    Creates instances of a C3 type if they don't already exist and updates them if they do exist. If the operation
    ...
    """
        ...
    @classmethod
    def touchBatch(cls, objs: Array[ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]], spec: TouchSpec=None) -> Union[ObjList[ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]]]:
    """
    ...
    @overload
    @classmethod
    def mergeBatch(cls, objs: Array[ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]], spec: MergeSpec=None) -> Union[ObjList[ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]]]:
    """
    ...
    @overload
    @classmethod
    def mergeBatch(cls, objs: Array[ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]]]:
    """
    Merges multiple instances of a C3 type or creates them if they don't exist. If the operation fails and {@link
    UpsertSpec#dontThrowOnBatchError} is not specified (the default), then a C3BatchException will be thrown.
    Otherwise errors will be reported in the returned {@link ObjList}.  The merge operation is described in the {@link
    ...
    """
        ...
    @classmethod
    def mergeObjs(cls, objs: Callable[[], Union[Array[ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]]]], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]]]:
    """
    ...
    @overload
    @classmethod
    def mergeAll(cls, mergeObj: ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO], spec: MergeAllSpec=None) -> Union[int]:
    """
    ...
    @overload
    @classmethod
    def mergeAll(cls, mergeObj: ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO], mergeInclude: str, spec: MergeAllSpec=None) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def removeBatch(cls, objs: Array[ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]], spec: UpsertSpec=None) -> Union[ObjList[ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]]]:
    """
    ...
    """
        ...
    @classmethod
    def replace(cls, objs: Array[ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]], spec: UpsertSpec=None) -> Union[ObjList[ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]]]:
    """
    ...
    """
        ...
    def unremove(self) -> Union[ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]]:
    """
    ...
    """
        ...
    @classmethod
    def beforeCreate(cls, objs: Array[ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]]) -> ObjList[ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]]:
    """
    ...
    """
        ...
    @classmethod
    def beforeUpdate(cls, objs: Array[ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]]) -> ObjList[ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]]:
    """
    ...
    """
        ...
    @classmethod
    def beforeRemove(cls, objs: Array[ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]]) -> ObjList[ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]]:
    """
    ...
    """
        ...
    @classmethod
    def afterCreate(cls, objs: Array[ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def afterUpdate(cls, objs: Array[ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def afterRemove(cls, objs: Array[ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def startImportData(cls, spec: StartImportDataSpec=None) -> PushStream[ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]]:
    """
    @return a push stream to import instances of this type.
    """
        ...
    @classmethod
    def startImportDataWithStats(cls, spec: StartImportDataSpec=None) -> PushStreamWithStats[ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]]:
    """
    @return a push stream to import instances of this type.
    """
        ...
    ...
    """
        ...
    @classmethod
    def forId(cls, id: str, failIfMissing: bool=None) -> Union[ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]]:
    """
    ...
    """
        ...
    def withoutIdentity(self) -> Union[ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]]:
    """
    ...
    """
        ...
    @classmethod
    def typeOfBatch(cls, objs: Array[ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]]) -> Union[Array[EntityType]]:
    """
    ...
    """
        ...
    @classmethod
    def dbEcho(cls, template: ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]=None, count: int=None, sendBack: bool=None) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def callbackLogic(cls, objs: Array[ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]], callback: Callable[[Union[ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]]], Union[ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]]]=None) -> ObjList[ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]]:
    """
    ...
    """
        ...
    @classmethod
    def afterCallbackLogic(cls, objs: Array[ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]], callback: Callable[[Union[ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]]], Union[ReliabilityRiskMl.Pipeline.Interpreter.DirectionallyWeightedResidualInterpreter[DX, DO]]]=None) -> Union[Array[ObjError]]:
    """
