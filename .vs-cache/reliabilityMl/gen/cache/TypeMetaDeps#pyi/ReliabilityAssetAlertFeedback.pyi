...
from c3.reliabilityMl.SubmitAlertFeedbackSpec import SubmitAlertFeedbackSpec
from c3.platform.ExistsSpec import ExistsSpec

# Python definitions for the C3 type ReliabilityAssetAlertFeedback


class ReliabilityAssetAlertFeedback(TimedValue, UserInformation, FilterableByFacility):
    """
    Registers provided by the {@link User} on an alert, giving feedback about how functional the system-generated
    {@link ReliabilityAssetAlert}s are. This process prevents the occurrence of 'false positives,' ensuring the system's
    accuracy and reliability and ultimately improving the user experience to make it better and more efficient.
    
    **Purpose:**
    - This entity stores user feedback on the reliability alerts generated by the system.
    - The feedback helps in assessing and refining the quality of the alert system, especially in terms of reducing false positives.
    - The system uses this feedback to improve its accuracy and reliability over time.
    - The entity helps link the feedback to the relevant alert and maintains detailed user information for tracking purposes.
    
    @remarks this represents a made instance of ReliabilityAssetAlertFeedback
    """
    
    timestamp: Optional[datetime]=None
    """
    The timestamp when the feedback was provided.
    
    This field stores the exact date and time the user submitted their feedback in `datetime` format.
    It represents the time when the feedback was created.
    """

    createdByUser: Optional[User]=None
    """
    The information of the {@link User} that created it.
    """
    ...
    alert: Optional[ReliabilityAssetAlert]
    """
    The {@link ReliabilityAssetAlert} this feedback is for.
    
    This field stores the reference to the alert that the user is providing feedback about.
    The `ReliabilityAssetAlert` represents a system-generated alert, and this feedback helps assess whether the
    alert was useful or a 'false positive.'
    
    The `alert` field is a required field and must be set to the relevant alert for the feedback.
    """

    category: Optional[str]=None
    """
    The category of feedback that the user selected.
    
    This field specifies the feedback category that the user has selected from a predefined list. This categorization
    allows for structured feedback, helping to identify trends or common issues across multiple alerts.
    
    The `category` is a string field, and the values are enumerated by the {@link ReliabilityAssetAlertFeedbackCategory} enum,
    which defines various types of feedback such as 'False Positive', 'Useful', 'Requires More Data', etc.
    """

    comment: Optional[str]=None
    """
    The provided user feedback.
    
    This is the actual textual comment or feedback provided by the user. It is typically a free-form field where users
    can describe their experience or opinion on the alert, such as why they think the alert was or wasn't useful.
    
    This field helps provide qualitative context to the feedback, making it possible to understand the user's reasoning
    behind the chosen feedback category.
    """
    def __init__(self, timestamp: Optional[datetime]=None, createdByUser: Optional[User]=None, id: Optional[str]=None, versionEdits: Optional[Array[VersionEdit]]=None, name: Optional[str]=None, meta: Optional[Meta]=None, version: Optional[int]=None, typeWithBindings: Optional[Type]=None, facilityFilterPaths: Optional[Array[str]]=None, typeIdent: Optional[str]=None, alert: Optional[ReliabilityAssetAlert]=None, category: Optional[str]=None, comment: Optional[str]=None) -> None: ...
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[ReliabilityAssetAlertFeedback]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[ReliabilityAssetAlertFeedback]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[ReliabilityAssetAlertFeedback]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[ReliabilityAssetAlertFeedback]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> ReliabilityAssetAlertFeedback:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> ReliabilityAssetAlertFeedback:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> ReliabilityAssetAlertFeedback:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[ReliabilityAssetAlertFeedback]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[ReliabilityAssetAlertFeedback]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> ReliabilityAssetAlertFeedback:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> ReliabilityAssetAlertFeedback:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> ReliabilityAssetAlertFeedback:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> ReliabilityAssetAlertFeedback:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> ReliabilityAssetAlertFeedback:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> ReliabilityAssetAlertFeedback:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> ReliabilityAssetAlertFeedback:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> ReliabilityAssetAlertFeedback:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> ReliabilityAssetAlertFeedback:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> ReliabilityAssetAlertFeedback:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> ReliabilityAssetAlertFeedback:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> ReliabilityAssetAlertFeedback:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> ReliabilityAssetAlertFeedback:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> ReliabilityAssetAlertFeedback:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> ReliabilityAssetAlertFeedback:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> ReliabilityAssetAlertFeedback:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> ReliabilityAssetAlertFeedback:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> ReliabilityAssetAlertFeedback:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> ReliabilityAssetAlertFeedback:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> ReliabilityAssetAlertFeedback:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> ReliabilityAssetAlertFeedback:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> ReliabilityAssetAlertFeedback:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> ReliabilityAssetAlertFeedback:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> ReliabilityAssetAlertFeedback:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> ReliabilityAssetAlertFeedback:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> ReliabilityAssetAlertFeedback:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> ReliabilityAssetAlertFeedback:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> ReliabilityAssetAlertFeedback:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[ReliabilityAssetAlertFeedback]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[ReliabilityAssetAlertFeedback]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[ReliabilityAssetAlertFeedback]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[ReliabilityAssetAlertFeedback]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[ReliabilityAssetAlertFeedback]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, ReliabilityAssetAlertFeedback]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, ReliabilityAssetAlertFeedback]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[ReliabilityAssetAlertFeedback]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[ReliabilityAssetAlertFeedback]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> ReliabilityAssetAlertFeedback:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> ReliabilityAssetAlertFeedback:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> ReliabilityAssetAlertFeedback:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> ReliabilityAssetAlertFeedback:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> ReliabilityAssetAlertFeedback:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> ReliabilityAssetAlertFeedback:
    """
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[ReliabilityAssetAlertFeedback]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> ReliabilityAssetAlertFeedback:
    """
    ...
    """
        ...
    def afterMake(self) -> ReliabilityAssetAlertFeedback:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> ReliabilityAssetAlertFeedback:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[ReliabilityAssetAlertFeedback]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> ReliabilityAssetAlertFeedback:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, spec: FetchSpec=None) -> FetchResult[ReliabilityAssetAlertFeedback]:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, filter: Filter) -> FetchResult[ReliabilityAssetAlertFeedback]:
    """
    ...
    """
        ...
    @classmethod
    def fetchObjStream(cls, spec: FetchStreamSpec=None) -> Union[Stream[ReliabilityAssetAlertFeedback]]:
    """
    Fetches multiple obj instances based on a specification.  Only objs that the caller is authorized to fetch will be
    returned.
    ...
    """
        ...
    @classmethod
    def fetchMultiLocale(cls, spec: MultiLocaleFetchSpec=None) -> Union[Map[str, FetchResult[ReliabilityAssetAlertFeedback]]]:
    """
    ...
    """
        ...
    def get(self, include: str=None) -> Union[ReliabilityAssetAlertFeedback]:
    """
    ...
    """
        ...
    def getSpecific(self, include: str=None) -> Union[ReliabilityAssetAlertFeedback]:
    """
    ...
    """
        ...
    def getMissing(self, spec: GetMissingSpec) -> ReliabilityAssetAlertFeedback:
    """
    ...
    """
        ...
    def getDirect(self, include: str=None) -> Union[ReliabilityAssetAlertFeedback]:
    """
    ...
    """
        ...
    def applyReverseEdit(self, versionEdit: VersionEdit) -> ReliabilityAssetAlertFeedback:
    """
    ...
    """
        ...
    @classmethod
    def fromString(cls, s: str) -> Union[ReliabilityAssetAlertFeedback]:
    """
    ...
    """
        ...
    def create(self, spec: UpsertSpec=None) -> Union[ReliabilityAssetAlertFeedback]:
    """
    ...
    """
        ...
    @classmethod
    def createBatch(cls, objs: Array[ReliabilityAssetAlertFeedback], spec: UpsertSpec=None) -> Union[ObjList[ReliabilityAssetAlertFeedback]]:
    """
    ...
    """
        ...
    @classmethod
    def createBatchObjStream(cls, objs: Stream[ReliabilityAssetAlertFeedback], spec: CreateBatchObjStreamSpec=None) -> Union[ObjList[ReliabilityAssetAlertFeedback]]:
    """
    Creates multiple instances of a C3 type. If the operation fails and {@link UpsertSpec#dontThrowOnBatchError} is not
    specified (the default), then a C3BatchException will be thrown.  Otherwise {@link errors will be reported in the
    returned {@link ObjList}.  This will fail if any of the instances already exist.
    ...
    """
        ...
    def update(self, srcObj: ReliabilityAssetAlertFeedback=None, spec: UpsertSpec=None) -> Union[ReliabilityAssetAlertFeedback]:
    """
    ...
    """
        ...
    def upsert(self, srcObj: ReliabilityAssetAlertFeedback=None, spec: UpsertSpec=None) -> Union[ReliabilityAssetAlertFeedback]:
    """
    ...
    """
        ...
    @overload
    def merge(self, spec: MergeSpec=None) -> Union[ReliabilityAssetAlertFeedback]:
    """
    ...
    """
        ...
    @overload
    def merge(self, mergeInclude: str, spec: MergeSpec=None) -> Union[ReliabilityAssetAlertFeedback]:
    """
    ...
    """
        ...
    def touch(self, spec: TouchSpec=None) -> Union[ReliabilityAssetAlertFeedback]:
    """
    ...
    """
        ...
    @classmethod
    def updateBatch(cls, objs: Array[ReliabilityAssetAlertFeedback], srcObjs: Array[ReliabilityAssetAlertFeedback]=None, spec: UpsertSpec=None) -> Union[ObjList[ReliabilityAssetAlertFeedback]]:
    """
    ...
    """
        ...
    @classmethod
    def updateObjs(cls, objs: Callable[[], Union[Array[ReliabilityAssetAlertFeedback]]], spec: UpsertSpec=None) -> Union[ObjList[ReliabilityAssetAlertFeedback]]:
    """
    ...
    """
        ...
    @classmethod
    def upsertBatch(cls, objs: Array[ReliabilityAssetAlertFeedback], srcObjs: Array[ReliabilityAssetAlertFeedback]=None, spec: UpsertSpec=None) -> Union[ObjList[ReliabilityAssetAlertFeedback]]:
    """
    ...
    """
        ...
    @classmethod
    def upsertObjs(cls, objs: Callable[[], Union[Array[ReliabilityAssetAlertFeedback]]], spec: UpsertSpec=None) -> Union[ObjList[ReliabilityAssetAlertFeedback]]:
    """
    Creates instances of a C3 type if they don't already exist and updates them if they do exist. If the operation
    ...
    """
        ...
    @classmethod
    def touchBatch(cls, objs: Array[ReliabilityAssetAlertFeedback], spec: TouchSpec=None) -> Union[ObjList[ReliabilityAssetAlertFeedback]]:
    """
    ...
    @overload
    @classmethod
    def mergeBatch(cls, objs: Array[ReliabilityAssetAlertFeedback], spec: MergeSpec=None) -> Union[ObjList[ReliabilityAssetAlertFeedback]]:
    """
    ...
    @overload
    @classmethod
    def mergeBatch(cls, objs: Array[ReliabilityAssetAlertFeedback], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[ReliabilityAssetAlertFeedback]]:
    """
    Merges multiple instances of a C3 type or creates them if they don't exist. If the operation fails and {@link
    UpsertSpec#dontThrowOnBatchError} is not specified (the default), then a C3BatchException will be thrown.
    Otherwise errors will be reported in the returned {@link ObjList}.  The merge operation is described in the {@link
    ...
    """
        ...
    @classmethod
    def mergeObjs(cls, objs: Callable[[], Union[Array[ReliabilityAssetAlertFeedback]]], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[ReliabilityAssetAlertFeedback]]:
    """
    ...
    @overload
    @classmethod
    def mergeAll(cls, mergeObj: ReliabilityAssetAlertFeedback, spec: MergeAllSpec=None) -> Union[int]:
    """
    ...
    @overload
    @classmethod
    def mergeAll(cls, mergeObj: ReliabilityAssetAlertFeedback, mergeInclude: str, spec: MergeAllSpec=None) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def removeBatch(cls, objs: Array[ReliabilityAssetAlertFeedback], spec: UpsertSpec=None) -> Union[ObjList[ReliabilityAssetAlertFeedback]]:
    """
    ...
    """
        ...
    @classmethod
    def replace(cls, objs: Array[ReliabilityAssetAlertFeedback], spec: UpsertSpec=None) -> Union[ObjList[ReliabilityAssetAlertFeedback]]:
    """
    ...
    """
        ...
    def unremove(self) -> Union[ReliabilityAssetAlertFeedback]:
    """
    ...
    """
        ...
    @classmethod
    def beforeCreate(cls, objs: Array[ReliabilityAssetAlertFeedback]) -> ObjList[ReliabilityAssetAlertFeedback]:
    """
    ...
    """
        ...
    @classmethod
    def beforeUpdate(cls, objs: Array[ReliabilityAssetAlertFeedback]) -> ObjList[ReliabilityAssetAlertFeedback]:
    """
    ...
    """
        ...
    @classmethod
    def beforeRemove(cls, objs: Array[ReliabilityAssetAlertFeedback]) -> ObjList[ReliabilityAssetAlertFeedback]:
    """
    ...
    """
        ...
    @classmethod
    def afterCreate(cls, objs: Array[ReliabilityAssetAlertFeedback]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def afterUpdate(cls, objs: Array[ReliabilityAssetAlertFeedback]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def afterRemove(cls, objs: Array[ReliabilityAssetAlertFeedback]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def startImportData(cls, spec: StartImportDataSpec=None) -> PushStream[ReliabilityAssetAlertFeedback]:
    """
    @return a push stream to import instances of this type.
    """
        ...
    @classmethod
    def startImportDataWithStats(cls, spec: StartImportDataSpec=None) -> PushStreamWithStats[ReliabilityAssetAlertFeedback]:
    """
    @return a push stream to import instances of this type.
    """
        ...
    ...
    """
        ...
    @classmethod
    def forId(cls, id: str, failIfMissing: bool=None) -> Union[ReliabilityAssetAlertFeedback]:
    """
    ...
    """
        ...
    def withoutIdentity(self) -> Union[ReliabilityAssetAlertFeedback]:
    """
    ...
    """
        ...
    @classmethod
    def typeOfBatch(cls, objs: Array[ReliabilityAssetAlertFeedback]) -> Union[Array[EntityType]]:
    """
    ...
    """
        ...
    @classmethod
    def dbEcho(cls, template: ReliabilityAssetAlertFeedback=None, count: int=None, sendBack: bool=None) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def callbackLogic(cls, objs: Array[ReliabilityAssetAlertFeedback], callback: Callable[[Union[ReliabilityAssetAlertFeedback]], Union[ReliabilityAssetAlertFeedback]]=None) -> ObjList[ReliabilityAssetAlertFeedback]:
    """
    ...
    """
        ...
    @classmethod
    def afterCallbackLogic(cls, objs: Array[ReliabilityAssetAlertFeedback], callback: Callable[[Union[ReliabilityAssetAlertFeedback]], Union[ReliabilityAssetAlertFeedback]]=None) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def createAlertFeedbackOnFormSubmit(cls, formObject: SubmitAlertFeedbackSpec) -> Union[Array[ReliabilityAssetAlertFeedback]]:
    """
    The method is invoked after submitting Alert Feedback Modal from UI.
    It creates one or many objects of {@link ReliabilityAssetAlertFeedback}, each one associated with a
    {@link ReliabilityAssetAlert}.
    
    **Purpose**: This method processes the form data received when a user submits feedback through the alert feedback modal in the user interface.
    It creates the corresponding `ReliabilityAssetAlertFeedback` objects, which store the feedback related to the alerts.
    
    **Important Notes**:
    - All the feedback objects created by this method will share the same `category` and `comment` fields.
    - It is responsible for creating feedback entries for multiple alerts if the user provides feedback on more than one.
    
    @param formObject
           The form object containing the feedback data, which includes the IDs of the alerts associated with the feedback.
           It also contains the feedback `category` and an optional `comment` describing the user's feedback on the alert(s).
    
    @returns The created {@link ReliabilityAssetAlertFeedback} objects.
            These objects are returned as an array since multiple feedback entries can be created in one submission.
    """
        ...
