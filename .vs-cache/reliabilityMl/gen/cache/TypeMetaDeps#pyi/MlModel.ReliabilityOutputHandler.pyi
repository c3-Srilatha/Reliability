...
# Python definitions for the C3 type MlModel.ReliabilityOutputHandler


class ReliabilityOutputHandler(MlModel.DataOutputHandler):
    """
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[MlModel.ReliabilityOutputHandler]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[MlModel.ReliabilityOutputHandler]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[MlModel.ReliabilityOutputHandler]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[MlModel.ReliabilityOutputHandler]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> MlModel.ReliabilityOutputHandler:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> MlModel.ReliabilityOutputHandler:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> MlModel.ReliabilityOutputHandler:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[MlModel.ReliabilityOutputHandler]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[MlModel.ReliabilityOutputHandler]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> MlModel.ReliabilityOutputHandler:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> MlModel.ReliabilityOutputHandler:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> MlModel.ReliabilityOutputHandler:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> MlModel.ReliabilityOutputHandler:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> MlModel.ReliabilityOutputHandler:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> MlModel.ReliabilityOutputHandler:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> MlModel.ReliabilityOutputHandler:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> MlModel.ReliabilityOutputHandler:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> MlModel.ReliabilityOutputHandler:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> MlModel.ReliabilityOutputHandler:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> MlModel.ReliabilityOutputHandler:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> MlModel.ReliabilityOutputHandler:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> MlModel.ReliabilityOutputHandler:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> MlModel.ReliabilityOutputHandler:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> MlModel.ReliabilityOutputHandler:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> MlModel.ReliabilityOutputHandler:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> MlModel.ReliabilityOutputHandler:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> MlModel.ReliabilityOutputHandler:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> MlModel.ReliabilityOutputHandler:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> MlModel.ReliabilityOutputHandler:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> MlModel.ReliabilityOutputHandler:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> MlModel.ReliabilityOutputHandler:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> MlModel.ReliabilityOutputHandler:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> MlModel.ReliabilityOutputHandler:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> MlModel.ReliabilityOutputHandler:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> MlModel.ReliabilityOutputHandler:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> MlModel.ReliabilityOutputHandler:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> MlModel.ReliabilityOutputHandler:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[MlModel.ReliabilityOutputHandler]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[MlModel.ReliabilityOutputHandler]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[MlModel.ReliabilityOutputHandler]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[MlModel.ReliabilityOutputHandler]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[MlModel.ReliabilityOutputHandler]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, MlModel.ReliabilityOutputHandler]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, MlModel.ReliabilityOutputHandler]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[MlModel.ReliabilityOutputHandler]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[MlModel.ReliabilityOutputHandler]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> MlModel.ReliabilityOutputHandler:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> MlModel.ReliabilityOutputHandler:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> MlModel.ReliabilityOutputHandler:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> MlModel.ReliabilityOutputHandler:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> MlModel.ReliabilityOutputHandler:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> MlModel.ReliabilityOutputHandler:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> MlModel.ReliabilityOutputHandler:
    """
    ...
    """
        ...
    def afterMake(self) -> MlModel.ReliabilityOutputHandler:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> MlModel.ReliabilityOutputHandler:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[MlModel.ReliabilityOutputHandler]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> MlModel.ReliabilityOutputHandler:
    """
    ...
    """
        ...
    @classmethod
    def getExpectedOutputNames(cls, op: str=None) -> Union[Tuple]:
    """
    Method to get the expected output names for {@link MlDataOpName#PROCESS} and {@link MlDataOpName#INTERPRET}.
    """
        ...
    @classmethod
    def findOrCreateHeader(cls, headerType: Type, headerId: str, relation: Type, name: str, subject: MlSubject=None) -> Type:
    """
