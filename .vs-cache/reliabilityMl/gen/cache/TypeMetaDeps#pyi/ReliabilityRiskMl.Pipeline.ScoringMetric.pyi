...
# Python definitions for the C3 type ReliabilityRiskMl.Pipeline.ScoringMetric


class ScoringMetric(ReliabilityRiskMlScoringMetric[{ riskScore: Data, riskScoreNormalized: Data, alert: Data }, { features: Data, trainingMask: Data, inferenceMask: Data, alertContext: Data, target: Data }]):
    """
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[ReliabilityRiskMl.Pipeline.ScoringMetric]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[ReliabilityRiskMl.Pipeline.ScoringMetric]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[ReliabilityRiskMl.Pipeline.ScoringMetric]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[ReliabilityRiskMl.Pipeline.ScoringMetric]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> ReliabilityRiskMl.Pipeline.ScoringMetric:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> ReliabilityRiskMl.Pipeline.ScoringMetric:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> ReliabilityRiskMl.Pipeline.ScoringMetric:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[ReliabilityRiskMl.Pipeline.ScoringMetric]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[ReliabilityRiskMl.Pipeline.ScoringMetric]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> ReliabilityRiskMl.Pipeline.ScoringMetric:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> ReliabilityRiskMl.Pipeline.ScoringMetric:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> ReliabilityRiskMl.Pipeline.ScoringMetric:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> ReliabilityRiskMl.Pipeline.ScoringMetric:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> ReliabilityRiskMl.Pipeline.ScoringMetric:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> ReliabilityRiskMl.Pipeline.ScoringMetric:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> ReliabilityRiskMl.Pipeline.ScoringMetric:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> ReliabilityRiskMl.Pipeline.ScoringMetric:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> ReliabilityRiskMl.Pipeline.ScoringMetric:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> ReliabilityRiskMl.Pipeline.ScoringMetric:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> ReliabilityRiskMl.Pipeline.ScoringMetric:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> ReliabilityRiskMl.Pipeline.ScoringMetric:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> ReliabilityRiskMl.Pipeline.ScoringMetric:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> ReliabilityRiskMl.Pipeline.ScoringMetric:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> ReliabilityRiskMl.Pipeline.ScoringMetric:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> ReliabilityRiskMl.Pipeline.ScoringMetric:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> ReliabilityRiskMl.Pipeline.ScoringMetric:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> ReliabilityRiskMl.Pipeline.ScoringMetric:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> ReliabilityRiskMl.Pipeline.ScoringMetric:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> ReliabilityRiskMl.Pipeline.ScoringMetric:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> ReliabilityRiskMl.Pipeline.ScoringMetric:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> ReliabilityRiskMl.Pipeline.ScoringMetric:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> ReliabilityRiskMl.Pipeline.ScoringMetric:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> ReliabilityRiskMl.Pipeline.ScoringMetric:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> ReliabilityRiskMl.Pipeline.ScoringMetric:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> ReliabilityRiskMl.Pipeline.ScoringMetric:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> ReliabilityRiskMl.Pipeline.ScoringMetric:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> ReliabilityRiskMl.Pipeline.ScoringMetric:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[ReliabilityRiskMl.Pipeline.ScoringMetric]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[ReliabilityRiskMl.Pipeline.ScoringMetric]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[ReliabilityRiskMl.Pipeline.ScoringMetric]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[ReliabilityRiskMl.Pipeline.ScoringMetric]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[ReliabilityRiskMl.Pipeline.ScoringMetric]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, ReliabilityRiskMl.Pipeline.ScoringMetric]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, ReliabilityRiskMl.Pipeline.ScoringMetric]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[ReliabilityRiskMl.Pipeline.ScoringMetric]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[ReliabilityRiskMl.Pipeline.ScoringMetric]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> ReliabilityRiskMl.Pipeline.ScoringMetric:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> ReliabilityRiskMl.Pipeline.ScoringMetric:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> ReliabilityRiskMl.Pipeline.ScoringMetric:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> ReliabilityRiskMl.Pipeline.ScoringMetric:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> ReliabilityRiskMl.Pipeline.ScoringMetric:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> ReliabilityRiskMl.Pipeline.ScoringMetric:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> ReliabilityRiskMl.Pipeline.ScoringMetric:
    """
    ...
    """
        ...
    def afterMake(self) -> ReliabilityRiskMl.Pipeline.ScoringMetric:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> ReliabilityRiskMl.Pipeline.ScoringMetric:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[ReliabilityRiskMl.Pipeline.ScoringMetric]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> ReliabilityRiskMl.Pipeline.ScoringMetric:
    """
