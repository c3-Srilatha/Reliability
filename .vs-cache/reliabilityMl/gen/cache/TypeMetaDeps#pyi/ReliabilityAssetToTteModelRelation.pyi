...
from c3.platform.MlModel.Route.Status import MlModel.Route.Status
...
from c3.reliabilityMl.ReliabilityMl.ContributionHeader import ReliabilityMl.ContributionHeader
...
from c3.reliabilityMl.ReliabilityTteMlModel import ReliabilityTteMlModel
...
from c3.reliabilityMl.ReliabilityTtePredictionHeader import ReliabilityTtePredictionHeader
...
from c3.reliabilityMl.ReliabilityTteContributionHeader import ReliabilityTteContributionHeader
from c3.platform.Obj.GenerateSpec import Obj.GenerateSpec
from c3.platform.EvaluateResult import EvaluateResult
from c3.platform.SetBuilder import SetBuilder
from c3.platform.SimpleMetric import SimpleMetric
from c3.reliabilityMl.ReliabilityMl.PredictionHeader import ReliabilityMl.PredictionHeader
...
from c3.reliabilityMl.ReliabilityTteForecastContributionHeader import ReliabilityTteForecastContributionHeader
...
from c3.reliabilityMl.ReliabilityTteForecastPredictionHeader import ReliabilityTteForecastPredictionHeader
...
# Python definitions for the C3 type ReliabilityAssetToTteModelRelation


class ReliabilityAssetToTteModelRelation(ReliabilityAssetToModelRelation):
    """
    An extension of {@link ReliabilityAssetToModelRelation} representing the relations between
    a {@link ReliabilityAsset} and a model belonging to the `reliabilityTte` {@link MlProject}.
    This entity type links an asset in the system (e.g., a machine or component) to a specific model within
    the `reliabilityTte` machine learning project. It tracks the relationship between the asset and the model
    along with various predictions, contributions, and forecast values related to time-to-event (TTE) modeling.
    The relationship is essential for ensuring that the correct asset is associated with the appropriate model
    and that the results of the TTE model (such as predictions and contributions) are linked to the asset in a
    meaningful way for analysis and decision-making.
    
    @remarks this represents a made instance of ReliabilityAssetToTteModelRelation
    """
    ...
    from: Optional[ReliabilityAsset]
    """
    The instance of {@link MlSubject} referenced by the relation.
    """

    to: Optional[ReliabilityTteMlModel]
    """
    The {@link ReliabilityTteMlModel} referenced by the relation.
    
    This field links the asset to a specific model from the `reliabilityTte` machine learning project.
    The `ReliabilityTteMlModel` defines the time-to-event predictions and associated forecasts for the asset
    and is crucial for tracking the performance and predictions of the model on the asset's life cycle.
    
    The model could include various parameters such as failure probability, remaining useful life, and other
    critical time-to-event metrics.
    """
    ...
    """
    The {@link MlModel.Route} that originated this relation.
    """

    status: Optional[MlModel.Route.Status]
    """
    The deployment status of the relation, in particular if it is {@link MlModel.Route.Status.Label.CHAMPION CHAMPION},
    {@link MlModel.Route.Status.Label.CHALLENGER CHALLENGER} or {@link MlModel.Route.Status.Label.RETIRED RETIRED}.
    """

    groupId: Optional[str]=None
    """
    The group ID of the relation, which is used to group together relations that were created as part of the same
    batch. This can help optimize the fetch of these relations when doing batch operations.
    For example, see {@link MlModel.Router#updateRouteBatch}.
    """

    timedMlPredictions: Optional[Array[ReliabilityMl.PredictionHeader]]=None
    """
    Timed predictions for this relation.
    """

    timedMlContributions: Optional[Array[ReliabilityMl.ContributionHeader]]=None
    """
    Timed contribution for this relation.
    """

    timedPredictions: Optional[Array[ReliabilityTtePredictionHeader]]=None
    """
    A collection of time-based predictions related to the asset, including time-to-event predictions
    generated by the model.
    The `timedPredictions` field stores an array of predictions that are linked to specific time points.
    These predictions may represent different types of time-to-event data, such as predicted failure times,
    maintenance schedules, or other time-sensitive events related to the asset's performance.
    The `parent` indicates that this field is sourced from the parent entity (which could be a time-series
    or forecasting entity).
    """

    timedContributions: Optional[Array[ReliabilityTteContributionHeader]]=None
    """
    A collection of time-based contributions associated with the asset, representing how different factors
    or features contribute to the time-to-event predictions.
    The `timedContributions` field stores an array of contributions at various time points, helping to understand
    how different features (e.g., operating conditions, usage patterns) influence the predictions over time.
    This is essential for model explainability and can help users identify which variables are most important
    in forecasting the asset's time-to-event.
    As with `timedPredictions`, this field is populated from the parent entity.
    """

    timedForecastPredictions: Optional[Array[ReliabilityTteForecastPredictionHeader]]=None
    """
    A collection of time-based forecast predictions for the asset, representing forecasts of future time-to-event
    outcomes based on the model.
    
    `timedForecastPredictions` stores the forecasted predictions over a specific time horizon, such as predicted
    failure times or maintenance schedules. These predictions provide an outlook into future events, based on the
    model's understanding of the asset's behavior.
    
    The field is useful for predictive maintenance, asset management, and planning future interventions.
    """

    timedForecastContributions: Optional[Array[ReliabilityTteForecastContributionHeader]]=None
    """
    A collection of time-based forecast contributions for the asset, showing how different factors contribute
    to the forecasted time-to-event outcomes.
    
    `timedForecastContributions` captures contributions for future time periods, offering insight into how
    various factors will influence future forecasts. Understanding the factors contributing to the forecasted outcomes
    can be useful for optimizing asset management strategies and improving the reliability of predictions.
    """

    reliabilityTimeToEventMLProjectId: Optional[str]=None
    """
    The id of the current reliability time-to-event {@link MlProject}. Fetched from {@link ReliabilityMLConfig}.
    
    This field stores the ID of the time-to-event machine learning project, which provides a reference to the
    model configuration and parameters used in the analysis. The ID is fetched from the `ReliabilityMLConfig`
    configuration, ensuring that the asset is linked to the appropriate machine learning project.
    
    This field allows the system to retrieve relevant configuration values and ensures that the correct models
    are applied to the asset for analysis.
    """
    def __init__(self, id: Optional[str]=None, versionEdits: Optional[Array[VersionEdit]]=None, name: Optional[str]=None, meta: Optional[Meta]=None, version: Optional[int]=None, typeWithBindings: Optional[Type]=None, facilityFilterPaths: Optional[Array[str]]=None, start: Optional[datetime]=None, end: Optional[datetime]=None, from: Optional[ReliabilityAsset]=None, to: Optional[ReliabilityTteMlModel]=None, typeIdent: Optional[str]=None, route: Optional[MlModel.Route]=None, status: Optional[MlModel.Route.Status]=None, groupId: Optional[str]=None, timedMlPredictions: Optional[Array[ReliabilityMl.PredictionHeader]]=None, timedMlContributions: Optional[Array[ReliabilityMl.ContributionHeader]]=None, timedPredictions: Optional[Array[ReliabilityTtePredictionHeader]]=None, timedContributions: Optional[Array[ReliabilityTteContributionHeader]]=None, timedForecastPredictions: Optional[Array[ReliabilityTteForecastPredictionHeader]]=None, timedForecastContributions: Optional[Array[ReliabilityTteForecastContributionHeader]]=None, reliabilityTimeToEventMLProjectId: Optional[str]=None) -> None: ...
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[ReliabilityAssetToTteModelRelation]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[ReliabilityAssetToTteModelRelation]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[ReliabilityAssetToTteModelRelation]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[ReliabilityAssetToTteModelRelation]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> ReliabilityAssetToTteModelRelation:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> ReliabilityAssetToTteModelRelation:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> ReliabilityAssetToTteModelRelation:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[ReliabilityAssetToTteModelRelation]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[ReliabilityAssetToTteModelRelation]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> ReliabilityAssetToTteModelRelation:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> ReliabilityAssetToTteModelRelation:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> ReliabilityAssetToTteModelRelation:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> ReliabilityAssetToTteModelRelation:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> ReliabilityAssetToTteModelRelation:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> ReliabilityAssetToTteModelRelation:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> ReliabilityAssetToTteModelRelation:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> ReliabilityAssetToTteModelRelation:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> ReliabilityAssetToTteModelRelation:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> ReliabilityAssetToTteModelRelation:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> ReliabilityAssetToTteModelRelation:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> ReliabilityAssetToTteModelRelation:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> ReliabilityAssetToTteModelRelation:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> ReliabilityAssetToTteModelRelation:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> ReliabilityAssetToTteModelRelation:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> ReliabilityAssetToTteModelRelation:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> ReliabilityAssetToTteModelRelation:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> ReliabilityAssetToTteModelRelation:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> ReliabilityAssetToTteModelRelation:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> ReliabilityAssetToTteModelRelation:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> ReliabilityAssetToTteModelRelation:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> ReliabilityAssetToTteModelRelation:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> ReliabilityAssetToTteModelRelation:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> ReliabilityAssetToTteModelRelation:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> ReliabilityAssetToTteModelRelation:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> ReliabilityAssetToTteModelRelation:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> ReliabilityAssetToTteModelRelation:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> ReliabilityAssetToTteModelRelation:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[ReliabilityAssetToTteModelRelation]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[ReliabilityAssetToTteModelRelation]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[ReliabilityAssetToTteModelRelation]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[ReliabilityAssetToTteModelRelation]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[ReliabilityAssetToTteModelRelation]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, ReliabilityAssetToTteModelRelation]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, ReliabilityAssetToTteModelRelation]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[ReliabilityAssetToTteModelRelation]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[ReliabilityAssetToTteModelRelation]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> ReliabilityAssetToTteModelRelation:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> ReliabilityAssetToTteModelRelation:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> ReliabilityAssetToTteModelRelation:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> ReliabilityAssetToTteModelRelation:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> ReliabilityAssetToTteModelRelation:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> ReliabilityAssetToTteModelRelation:
    """
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[ReliabilityAssetToTteModelRelation]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> ReliabilityAssetToTteModelRelation:
    """
    ...
    """
        ...
    def afterMake(self) -> ReliabilityAssetToTteModelRelation:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> ReliabilityAssetToTteModelRelation:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[ReliabilityAssetToTteModelRelation]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> ReliabilityAssetToTteModelRelation:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, spec: FetchSpec=None) -> FetchResult[ReliabilityAssetToTteModelRelation]:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, filter: Filter) -> FetchResult[ReliabilityAssetToTteModelRelation]:
    """
    ...
    """
        ...
    @classmethod
    def fetchObjStream(cls, spec: FetchStreamSpec=None) -> Union[Stream[ReliabilityAssetToTteModelRelation]]:
    """
    Fetches multiple obj instances based on a specification.  Only objs that the caller is authorized to fetch will be
    returned.
    ...
    """
        ...
    @classmethod
    def fetchMultiLocale(cls, spec: MultiLocaleFetchSpec=None) -> Union[Map[str, FetchResult[ReliabilityAssetToTteModelRelation]]]:
    """
    ...
    @overload
    @classmethod
    def evalFeatureSetBatch(cls, batch: Array[ReliabilityAssetToTteModelRelation], featureSet: Feature.Set, spec: EvalFeatureSpec=None) -> Union[Data]:
    """
    ...
    @overload
    @classmethod
    def evalFeaturesBatch(cls, batch: Array[ReliabilityAssetToTteModelRelation], features: Array[str], spec: EvalFeaturesSpec=None) -> Union[Data]:
    """
    ...
    """
        ...
    def get(self, include: str=None) -> Union[ReliabilityAssetToTteModelRelation]:
    """
    ...
    """
        ...
    def getSpecific(self, include: str=None) -> Union[ReliabilityAssetToTteModelRelation]:
    """
    ...
    """
        ...
    def getMissing(self, spec: GetMissingSpec) -> ReliabilityAssetToTteModelRelation:
    """
    ...
    """
        ...
    def getDirect(self, include: str=None) -> Union[ReliabilityAssetToTteModelRelation]:
    """
    ...
    """
        ...
    def applyReverseEdit(self, versionEdit: VersionEdit) -> ReliabilityAssetToTteModelRelation:
    """
    ...
    """
        ...
    @classmethod
    def fromString(cls, s: str) -> Union[ReliabilityAssetToTteModelRelation]:
    """
    ...
    """
        ...
    def create(self, spec: UpsertSpec=None) -> Union[ReliabilityAssetToTteModelRelation]:
    """
    ...
    """
        ...
    @classmethod
    def createBatch(cls, objs: Array[ReliabilityAssetToTteModelRelation], spec: UpsertSpec=None) -> Union[ObjList[ReliabilityAssetToTteModelRelation]]:
    """
    ...
    """
        ...
    @classmethod
    def createBatchObjStream(cls, objs: Stream[ReliabilityAssetToTteModelRelation], spec: CreateBatchObjStreamSpec=None) -> Union[ObjList[ReliabilityAssetToTteModelRelation]]:
    """
    Creates multiple instances of a C3 type. If the operation fails and {@link UpsertSpec#dontThrowOnBatchError} is not
    specified (the default), then a C3BatchException will be thrown.  Otherwise {@link errors will be reported in the
    returned {@link ObjList}.  This will fail if any of the instances already exist.
    ...
    """
        ...
    def update(self, srcObj: ReliabilityAssetToTteModelRelation=None, spec: UpsertSpec=None) -> Union[ReliabilityAssetToTteModelRelation]:
    """
    ...
    """
        ...
    def upsert(self, srcObj: ReliabilityAssetToTteModelRelation=None, spec: UpsertSpec=None) -> Union[ReliabilityAssetToTteModelRelation]:
    """
    ...
    """
        ...
    @overload
    def merge(self, spec: MergeSpec=None) -> Union[ReliabilityAssetToTteModelRelation]:
    """
    ...
    """
        ...
    @overload
    def merge(self, mergeInclude: str, spec: MergeSpec=None) -> Union[ReliabilityAssetToTteModelRelation]:
    """
    ...
    """
        ...
    def touch(self, spec: TouchSpec=None) -> Union[ReliabilityAssetToTteModelRelation]:
    """
    ...
    """
        ...
    @classmethod
    def updateBatch(cls, objs: Array[ReliabilityAssetToTteModelRelation], srcObjs: Array[ReliabilityAssetToTteModelRelation]=None, spec: UpsertSpec=None) -> Union[ObjList[ReliabilityAssetToTteModelRelation]]:
    """
    ...
    """
        ...
    @classmethod
    def updateObjs(cls, objs: Callable[[], Union[Array[ReliabilityAssetToTteModelRelation]]], spec: UpsertSpec=None) -> Union[ObjList[ReliabilityAssetToTteModelRelation]]:
    """
    ...
    """
        ...
    @classmethod
    def upsertBatch(cls, objs: Array[ReliabilityAssetToTteModelRelation], srcObjs: Array[ReliabilityAssetToTteModelRelation]=None, spec: UpsertSpec=None) -> Union[ObjList[ReliabilityAssetToTteModelRelation]]:
    """
    ...
    """
        ...
    @classmethod
    def upsertObjs(cls, objs: Callable[[], Union[Array[ReliabilityAssetToTteModelRelation]]], spec: UpsertSpec=None) -> Union[ObjList[ReliabilityAssetToTteModelRelation]]:
    """
    Creates instances of a C3 type if they don't already exist and updates them if they do exist. If the operation
    ...
    """
        ...
    @classmethod
    def touchBatch(cls, objs: Array[ReliabilityAssetToTteModelRelation], spec: TouchSpec=None) -> Union[ObjList[ReliabilityAssetToTteModelRelation]]:
    """
    ...
    @overload
    @classmethod
    def mergeBatch(cls, objs: Array[ReliabilityAssetToTteModelRelation], spec: MergeSpec=None) -> Union[ObjList[ReliabilityAssetToTteModelRelation]]:
    """
    ...
    @overload
    @classmethod
    def mergeBatch(cls, objs: Array[ReliabilityAssetToTteModelRelation], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[ReliabilityAssetToTteModelRelation]]:
    """
    Merges multiple instances of a C3 type or creates them if they don't exist. If the operation fails and {@link
    UpsertSpec#dontThrowOnBatchError} is not specified (the default), then a C3BatchException will be thrown.
    Otherwise errors will be reported in the returned {@link ObjList}.  The merge operation is described in the {@link
    ...
    """
        ...
    @classmethod
    def mergeObjs(cls, objs: Callable[[], Union[Array[ReliabilityAssetToTteModelRelation]]], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[ReliabilityAssetToTteModelRelation]]:
    """
    ...
    @overload
    @classmethod
    def mergeAll(cls, mergeObj: ReliabilityAssetToTteModelRelation, spec: MergeAllSpec=None) -> Union[int]:
    """
    ...
    @overload
    @classmethod
    def mergeAll(cls, mergeObj: ReliabilityAssetToTteModelRelation, mergeInclude: str, spec: MergeAllSpec=None) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def removeBatch(cls, objs: Array[ReliabilityAssetToTteModelRelation], spec: UpsertSpec=None) -> Union[ObjList[ReliabilityAssetToTteModelRelation]]:
    """
    ...
    """
        ...
    @classmethod
    def replace(cls, objs: Array[ReliabilityAssetToTteModelRelation], spec: UpsertSpec=None) -> Union[ObjList[ReliabilityAssetToTteModelRelation]]:
    """
    ...
    """
        ...
    def unremove(self) -> Union[ReliabilityAssetToTteModelRelation]:
    """
    ...
    """
        ...
    @classmethod
    def beforeCreate(cls, objs: Array[ReliabilityAssetToTteModelRelation]) -> ObjList[ReliabilityAssetToTteModelRelation]:
    """
    ...
    """
        ...
    @classmethod
    def beforeUpdate(cls, objs: Array[ReliabilityAssetToTteModelRelation]) -> ObjList[ReliabilityAssetToTteModelRelation]:
    """
    ...
    """
        ...
    @classmethod
    def beforeRemove(cls, objs: Array[ReliabilityAssetToTteModelRelation]) -> ObjList[ReliabilityAssetToTteModelRelation]:
    """
    ...
    """
        ...
    @classmethod
    def afterCreate(cls, objs: Array[ReliabilityAssetToTteModelRelation]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def afterUpdate(cls, objs: Array[ReliabilityAssetToTteModelRelation]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def afterRemove(cls, objs: Array[ReliabilityAssetToTteModelRelation]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def startImportData(cls, spec: StartImportDataSpec=None) -> PushStream[ReliabilityAssetToTteModelRelation]:
    """
    @return a push stream to import instances of this type.
    """
        ...
    @classmethod
    def startImportDataWithStats(cls, spec: StartImportDataSpec=None) -> PushStreamWithStats[ReliabilityAssetToTteModelRelation]:
    """
    @return a push stream to import instances of this type.
    """
        ...
    ...
    """
        ...
    @classmethod
    def forId(cls, id: str, failIfMissing: bool=None) -> Union[ReliabilityAssetToTteModelRelation]:
    """
    ...
    """
        ...
    def withoutIdentity(self) -> Union[ReliabilityAssetToTteModelRelation]:
    """
    ...
    """
        ...
    @classmethod
    def typeOfBatch(cls, objs: Array[ReliabilityAssetToTteModelRelation]) -> Union[Array[EntityType]]:
    """
    ...
    """
        ...
    @classmethod
    def dbEcho(cls, template: ReliabilityAssetToTteModelRelation=None, count: int=None, sendBack: bool=None) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def callbackLogic(cls, objs: Array[ReliabilityAssetToTteModelRelation], callback: Callable[[Union[ReliabilityAssetToTteModelRelation]], Union[ReliabilityAssetToTteModelRelation]]=None) -> ObjList[ReliabilityAssetToTteModelRelation]:
    """
    ...
    """
        ...
    @classmethod
    def afterCallbackLogic(cls, objs: Array[ReliabilityAssetToTteModelRelation], callback: Callable[[Union[ReliabilityAssetToTteModelRelation]], Union[ReliabilityAssetToTteModelRelation]]=None) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def subjectType(cls) -> Type[[MlSubject]]:
    """
    @return the Type of the {@link #from} field;
            if the current Type is parametric with unbound parameters, an error is thrown.
    """
        ...
    @classmethod
    def forSubjectType(cls, subjectType: Type[[MlSubject]]) -> Type[[MlSubjectToModelRelation]]:
    """
    @return the subtype of {@link MlSubjectToModelRelation} for which the {@link from}
            field is of the given `subjectType`; if no such Type is found, an error is thrown.
    """
        ...
