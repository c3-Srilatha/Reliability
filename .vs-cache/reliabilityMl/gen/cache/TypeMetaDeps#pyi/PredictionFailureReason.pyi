...
# Python definitions for the C3 type PredictionFailureReason


class PredictionFailureReason():
    """
    ...
    """
    def __init__(self, INVALID_SPEC_ERROR: Optional[str]=None, FTR_DATA_NOT_AVAILABLE: Optional[str]=None, MLFLOW_JOB_ERROR: Optional[str]=None, GENERIC_ERROR: Optional[str]=None, NA: Optional[str]=None) -> None: ...
