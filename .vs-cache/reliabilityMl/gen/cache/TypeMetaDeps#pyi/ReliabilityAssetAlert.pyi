...
class ReliabilityAssetAlert(ReliabilityAssetAlertBase, FeatureEvaluatable, FilterableByFacility):
    """
    A persisted base type representing triggered alerts on {@link ReliabilityAsset}.
    They're generated when a selected attribute shows values outside the expected defined previously when a
    {@link ReliabilityMlModel} related a {@link ReliabilityAsset} is trained.
    ...
    """
    def __init__(self, timestamp: Optional[datetime]=None, id: Optional[str]=None, versionEdits: Optional[Array[VersionEdit]]=None, name: Optional[str]=None, meta: Optional[Meta]=None, version: Optional[int]=None, typeWithBindings: Optional[Type]=None, parent: Optional[ReliabilityAsset]=None, triggeringModel: Optional[ReliabilityMlModel]=None, triggeringModelId: Optional[str]=None, featureContributionMap: Optional[Map[str, float]]=None, primaryModelOutput: Optional[ReliabilityAssetAlert.ModelOutput]=None, allPrimaryModelOutputs: Optional[Map[str, ReliabilityAssetAlert.ModelOutput]]=None, facilityFilterPaths: Optional[Array[str]]=None, typeIdent: Optional[str]=None) -> None: ...
