...
# Python definitions for the C3 type ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe


class MinMaxScalerPipe(ReliabilityRiskMl.RiskScoreScaling.Pipe[{ trainingFeatures: Data, inferenceFeatures: Data, scaledTrainingFeatures: Data, scaledInferenceFeatures: Data, residuals: Data, scaledResiduals: Data, reconstructions: Data, scaledReconstructions: Data, riskScore: Data, alertContext: Data }, { riskScoreNormalized: Data }]):
    """
    This entity defines a custom pipeline for performing Min-Max scaling of risk scores and related data.
    It is part of the `ReliabilityRiskMl.RiskScoreScaling` module and extends the base `Pipe` type.
    The pipeline is used to scale various input data (e.g., training features, inference features, residuals)
    within the context of risk scoring and anomaly detection.
    
    The pipeline allows the following:
    - Min-Max scaling of the input features and other relevant data to the desired range (typically [0, 1]).
    - Support for both training and inference modes by using the `fit()` and `transform()` functions of the Min-Max scaler.
    - Option to perform scaling either in-place or on a copy of the input data.
    
    The pipeline's primary objective is to transform data into a normalized form where the features and residuals are scaled,
    and the risk score is normalized, making it suitable for downstream analysis or alert generation.
    
    Inputs:
    - `trainingFeatures`: The features used during the training phase for scaling.
    - `inferenceFeatures`: The features that will be scaled during inference.
    - `scaledTrainingFeatures`: The scaled version of the training features, output after scaling.
    - `scaledInferenceFeatures`: The scaled version of the inference features, output after scaling.
    - `residuals`: The residuals from the model output (used in anomaly detection or error assessment).
    - `scaledResiduals`: The scaled version of the residuals, output after scaling.
    - `reconstructions`: Reconstructed data used for comparison against the original data.
    - `scaledReconstructions`: The scaled version of the reconstructed data.
    - `riskScore`: The computed risk score to be normalized.
    - `alertContext`: Contextual data related to any alerts generated by the risk score model.
    
    Outputs:
    - `riskScoreNormalized`: The normalized risk score after applying Min-Max scaling.
    
    The Min-Max scaler adjusts the range of the input data to a predefined range (e.g., [0, 1]) and is used to ensure
    that the input data values are within a standard range, which is especially useful for models that rely on normalized
    features for effective performance.
    
    @remarks this represents a made instance of ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe
    """
    ...
    """
    Flag indicating whether to scale on a copy of the input data (i.e., creating a new scaled copy),
    or whether to perform scaling directly on the input data (in-place scaling).
    When set to `true`, scaling is performed on a new copy of the input data, leaving the original data unchanged.
    When set to `false`, scaling will modify the original input data directly.
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe:
    """
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe:
    """
    ...
    """
        ...
    def afterMake(self) -> ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe:
    """
    ...
    """
        ...
    def remakeTemplate(self) -> ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe:
    """
    ...
    """
        ...
    def withoutIdentity(self) -> ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe:
    """
    ...
    """
        ...
    def trainSync(self, x: , y: =None, spec: MlOperationSpec=None) -> ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe:
    """
    ...
    """
        ...
    @classmethod
    def allCached(cls, doNotProduceAll: bool=None) -> Union[Stream[ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe]]:
    """
    ...
    """
        ...
    @classmethod
    def find(cls, filter: str=None, doNotProduceAll: bool=None) -> Union[Stream[ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe]]:
    """
    ...
    """
        ...
    @classmethod
    def findBy(cls, field: str, value: Any, doNotProduceAll: bool=None) -> Union[Stream[ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe]]:
    """
    @param doNotProduceAll if true, will not populate cache and only return available cached instances. Will call
           `produceAll` if cache is empty or if Ann.cache.all is true & data has not previously been fetched.
    @return existing instances of this type that satisfy filter from data cache.
    """
        ...
    @classmethod
    def findByCacheKey(cls, key: str) -> Union[ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe]:
    """
    ...
    """
        ...
    @classmethod
    def forCacheKey(cls, key: str) -> Union[ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe]:
    """
    ...
    """
        ...
    def getCached(self) -> Union[ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe]:
    """
    ...
    """
        ...
    def refreshCache(self) -> Union[ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe]:
    """
    ...
    """
        ...
    @classmethod
    def produce(cls, key: str) -> Union[ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe]:
    """
    Should produce an entry for the cache key. This method should not be called directly.
    """
        ...
    @classmethod
    def produceAll(cls) -> Union[Map[str, ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe]]:
    """
    ...
    """
        ...
    @classmethod
    def doProduceAll(cls) -> Union[Map[str, ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe]]:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, spec: FetchSpec=None) -> FetchResult[ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe]:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, filter: Filter) -> FetchResult[ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe]:
    """
    ...
    """
        ...
    @classmethod
    def fetchObjStream(cls, spec: FetchStreamSpec=None) -> Union[Stream[ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe]]:
    """
    Fetches multiple obj instances based on a specification.  Only objs that the caller is authorized to fetch will be
    returned.
    ...
    """
        ...
    @classmethod
    def fetchMultiLocale(cls, spec: MultiLocaleFetchSpec=None) -> Union[Map[str, FetchResult[ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe]]]:
    """
    ...
    """
        ...
    def get(self, include: str=None) -> Union[ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe]:
    """
    ...
    """
        ...
    def getSpecific(self, include: str=None) -> Union[ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe]:
    """
    ...
    """
        ...
    def getMissing(self, spec: GetMissingSpec) -> ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe:
    """
    ...
    """
        ...
    def getDirect(self, include: str=None) -> Union[ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe]:
    """
    ...
    """
        ...
    def applyReverseEdit(self, versionEdit: VersionEdit) -> ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe:
    """
    ...
    """
        ...
    @classmethod
    def fromString(cls, s: str) -> Union[ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe]:
    """
    ...
    """
        ...
    def create(self, spec: UpsertSpec=None) -> Union[ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe]:
    """
    ...
    """
        ...
    @classmethod
    def createBatch(cls, objs: Array[ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe], spec: UpsertSpec=None) -> Union[ObjList[ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe]]:
    """
    ...
    """
        ...
    @classmethod
    def createBatchObjStream(cls, objs: Stream[ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe], spec: CreateBatchObjStreamSpec=None) -> Union[ObjList[ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe]]:
    """
    Creates multiple instances of a C3 type. If the operation fails and {@link UpsertSpec#dontThrowOnBatchError} is not
    specified (the default), then a C3BatchException will be thrown.  Otherwise {@link errors will be reported in the
    returned {@link ObjList}.  This will fail if any of the instances already exist.
    ...
    """
        ...
    def update(self, srcObj: ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe=None, spec: UpsertSpec=None) -> Union[ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe]:
    """
    ...
    """
        ...
    def upsert(self, srcObj: ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe=None, spec: UpsertSpec=None) -> Union[ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe]:
    """
    ...
    """
        ...
    @overload
    def merge(self, spec: MergeSpec=None) -> Union[ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe]:
    """
    ...
    """
        ...
    @overload
    def merge(self, mergeInclude: str, spec: MergeSpec=None) -> Union[ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe]:
    """
    ...
    """
        ...
    def touch(self, spec: TouchSpec=None) -> Union[ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe]:
    """
    ...
    """
        ...
    @classmethod
    def updateBatch(cls, objs: Array[ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe], srcObjs: Array[ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe]=None, spec: UpsertSpec=None) -> Union[ObjList[ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe]]:
    """
    ...
    """
        ...
    @classmethod
    def updateObjs(cls, objs: Callable[[], Union[Array[ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe]]], spec: UpsertSpec=None) -> Union[ObjList[ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe]]:
    """
    ...
    """
        ...
    @classmethod
    def upsertBatch(cls, objs: Array[ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe], srcObjs: Array[ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe]=None, spec: UpsertSpec=None) -> Union[ObjList[ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe]]:
    """
    ...
    """
        ...
    @classmethod
    def upsertObjs(cls, objs: Callable[[], Union[Array[ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe]]], spec: UpsertSpec=None) -> Union[ObjList[ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe]]:
    """
    Creates instances of a C3 type if they don't already exist and updates them if they do exist. If the operation
    ...
    """
        ...
    @classmethod
    def touchBatch(cls, objs: Array[ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe], spec: TouchSpec=None) -> Union[ObjList[ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe]]:
    """
    ...
    @overload
    @classmethod
    def mergeBatch(cls, objs: Array[ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe], spec: MergeSpec=None) -> Union[ObjList[ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe]]:
    """
    ...
    @overload
    @classmethod
    def mergeBatch(cls, objs: Array[ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe]]:
    """
    Merges multiple instances of a C3 type or creates them if they don't exist. If the operation fails and {@link
    UpsertSpec#dontThrowOnBatchError} is not specified (the default), then a C3BatchException will be thrown.
    Otherwise errors will be reported in the returned {@link ObjList}.  The merge operation is described in the {@link
    ...
    """
        ...
    @classmethod
    def mergeObjs(cls, objs: Callable[[], Union[Array[ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe]]], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe]]:
    """
    ...
    @overload
    @classmethod
    def mergeAll(cls, mergeObj: ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe, spec: MergeAllSpec=None) -> Union[int]:
    """
    ...
    @overload
    @classmethod
    def mergeAll(cls, mergeObj: ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe, mergeInclude: str, spec: MergeAllSpec=None) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def removeBatch(cls, objs: Array[ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe], spec: UpsertSpec=None) -> Union[ObjList[ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe]]:
    """
    ...
    """
        ...
    @classmethod
    def replace(cls, objs: Array[ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe], spec: UpsertSpec=None) -> Union[ObjList[ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe]]:
    """
    ...
    """
        ...
    def unremove(self) -> Union[ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe]:
    """
    ...
    """
        ...
    @classmethod
    def beforeCreate(cls, objs: Array[ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe]) -> ObjList[ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe]:
    """
    ...
    """
        ...
    @classmethod
    def beforeUpdate(cls, objs: Array[ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe]) -> ObjList[ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe]:
    """
    ...
    """
        ...
    @classmethod
    def beforeRemove(cls, objs: Array[ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe]) -> ObjList[ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe]:
    """
    ...
    """
        ...
    @classmethod
    def afterCreate(cls, objs: Array[ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def afterUpdate(cls, objs: Array[ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def afterRemove(cls, objs: Array[ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def startImportData(cls, spec: StartImportDataSpec=None) -> PushStream[ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe]:
    """
    @return a push stream to import instances of this type.
    """
        ...
    @classmethod
    def startImportDataWithStats(cls, spec: StartImportDataSpec=None) -> PushStreamWithStats[ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe]:
    """
    @return a push stream to import instances of this type.
    """
        ...
    ...
    """
        ...
    @classmethod
    def forId(cls, id: str, failIfMissing: bool=None) -> Union[ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe]:
    """
    ...
    """
        ...
    @classmethod
    def typeOfBatch(cls, objs: Array[ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe]) -> Union[Array[EntityType]]:
    """
    ...
    """
        ...
    @classmethod
    def dbEcho(cls, template: ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe=None, count: int=None, sendBack: bool=None) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def callbackLogic(cls, objs: Array[ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe], callback: Callable[[Union[ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe]], Union[ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe]]=None) -> ObjList[ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe]:
    """
    ...
    """
        ...
    @classmethod
    def afterCallbackLogic(cls, objs: Array[ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe], callback: Callable[[Union[ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe]], Union[ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe]]=None) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    def publish(self, subPath: str=None, contentType: str=None) -> ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe:
    """
    ...
    """
        ...
    @classmethod
    def removeSeedDataBatch(cls, objs: Array[SeedData]=None, spec: UpsertSpec=None) -> Union[ObjList[ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe]]:
    """
    ...
    """
        ...
    def createSeedData(self, spec: UpsertSpec=None) -> Union[ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe]:
    """
    ...
    """
        ...
    @classmethod
    def createSeedDataBatch(cls, objs: Array[SeedData]=None, spec: UpsertSpec=None) -> Union[ObjList[ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe]]:
    """
    ...
    """
        ...
    def updateSeedData(self, srcObj: SeedData=None, spec: UpsertSpec=None) -> Union[ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe]:
    """
    ...
    """
        ...
    @classmethod
    def updateSeedDataBatch(cls, objs: Array[SeedData]=None, srcObjs: Array[SeedData]=None, spec: UpsertSpec=None) -> Union[ObjList[ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe]]:
    """
    ...
    """
        ...
    def clearUserUpdates(self, spec: MergeSpec=None) -> Union[ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe]:
    """
    ...
    """
        ...
    @classmethod
    def clearUserUpdatesBatch(cls, objs: Array[SeedData]=None, spec: MergeSpec=None) -> Union[ObjList[ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe]]:
    """
    ...
    """
        ...
    def dependencies(self) -> Union[SeedDataDeps[ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe]]:
        ...
    ...
    """
        ...
    @classmethod
    def convert(cls, model: Any, spec: MlConvertSpec=None) -> ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe:
    """
    ...
    """
        ...
    def freeze(self) -> ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe:
    """
    Freezes an {@link MlPipe}
    @return modified copy of this {@link MlPipe} that cannot be trained
    """
        ...
    def unfreeze(self) -> ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe:
    """
    ...
    """
        ...
    def byReference(self) -> ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe:
    """
    ...
    """
        ...
    def updateModelFiles(self, modelFiles: Map[str, Url], spec: MlOperationSpec=None) -> ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe:
    """
    ...
    """
    This method invokes the `fit()` function of the Min-Max scaler model, which calculates the minimum and maximum
    values of the training data. These values are then used to scale both the training and inference features to the desired
    range. This method should be called during the training phase to "learn" the scaling transformation from the training data.
    """
        ...
    def afterTrain(self, doTrainOutputs: Any, spec: MlOperationSpec=None) -> ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe:
    """
    ...
    """
    This method invokes the `transform()` function of the Min-Max scaler model, applying the learned scaling parameters
    (i.e., the min and max values calculated during the `fit()` step) to the input data. This function is used during
    inference to scale new or unseen data in the same way as the training data.
    """
        ...
    ...
    """
        ...
    def withNewSpec(self, spec: MlConvertSpec=None) -> ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe:
    """
    ...
    """
        ...
    def afterConvert(self, model: Any, spec: MlConvertSpec=None) -> ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe:
    """
    ...
    """
        ...
    def withHyperparamSpaces(self, paramSpaces: Map[str, Hp.ParamSpace]) -> ReliabilityRiskMl.RiskScoreScaling.MinMaxScalerPipe:
    """
    ...
    """
    This function sets up the scaling pipeline using the `py-sklearn` library.
    It defines the scaling procedure, transforming the input data into the specified range (typically [0, 1]).
    This pipeline initialization is crucial for both training and inference, ensuring consistent data transformation.
    """
        ...
