...
from c3.reliabilityMl.ReliabilityRiskScoreMlValidationPredictionHeader import ReliabilityRiskScoreMlValidationPredictionHeader
...
# Python definitions for the C3 type ReliabilityAssetToRiskModelValidationRelation


class ReliabilityAssetToRiskModelValidationRelation(TimedIntervalRelation[ReliabilityAsset, ReliabilityRiskMlModel]):
    """
    A relational type to represent timed relations between a {@link ReliabilityAsset} and a {@link ReliabilityRiskMlModel} for model validation.
    
    @remarks this represents a made instance of ReliabilityAssetToRiskModelValidationRelation
    """
    ...
    to: Optional[ReliabilityRiskMlModel]=None
    """
    ...
    isBasedOnDataset: Optional[bool]=None
    """
    If true, this relation contains model validation data for the
    {@link ReliabilityRiskMlModel}'s training dataset (`to.datasetPreparationRun`).
    Otherwise, the validation period for this relation was explicitly set.
    """

    predictions: Optional[Array[ReliabilityRiskScoreMlValidationPredictionHeader]]=None
    """
    The predictions generated by the {@link ReliabilityRiskMlModel}.
    """

    contributions: Optional[Array[ReliabilityRiskScoreMlValidationContributionHeader]]=None
    """
    The feature contributions used for the predictions.
    """

    alerts: Optional[Array[ReliabilityAssetValidationAlert]]=None
    """
    The alerts generated by the {@link ReliabilityRiskMlModel} used for model validation.
    """
    def __init__(self, start: Optional[datetime]=None, end: Optional[datetime]=None, from: Optional[ReliabilityAsset]=None, to: Optional[ReliabilityRiskMlModel]=None, typeIdent: Optional[str]=None, id: Optional[str]=None, versionEdits: Optional[Array[VersionEdit]]=None, name: Optional[str]=None, meta: Optional[Meta]=None, version: Optional[int]=None, typeWithBindings: Optional[Type]=None, isBasedOnDataset: Optional[bool]=None, predictions: Optional[Array[ReliabilityRiskScoreMlValidationPredictionHeader]]=None, contributions: Optional[Array[ReliabilityRiskScoreMlValidationContributionHeader]]=None, alerts: Optional[Array[ReliabilityAssetValidationAlert]]=None) -> None: ...
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[ReliabilityAssetToRiskModelValidationRelation]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[ReliabilityAssetToRiskModelValidationRelation]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[ReliabilityAssetToRiskModelValidationRelation]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[ReliabilityAssetToRiskModelValidationRelation]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> ReliabilityAssetToRiskModelValidationRelation:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> ReliabilityAssetToRiskModelValidationRelation:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> ReliabilityAssetToRiskModelValidationRelation:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[ReliabilityAssetToRiskModelValidationRelation]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[ReliabilityAssetToRiskModelValidationRelation]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> ReliabilityAssetToRiskModelValidationRelation:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> ReliabilityAssetToRiskModelValidationRelation:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> ReliabilityAssetToRiskModelValidationRelation:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> ReliabilityAssetToRiskModelValidationRelation:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> ReliabilityAssetToRiskModelValidationRelation:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> ReliabilityAssetToRiskModelValidationRelation:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> ReliabilityAssetToRiskModelValidationRelation:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> ReliabilityAssetToRiskModelValidationRelation:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> ReliabilityAssetToRiskModelValidationRelation:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> ReliabilityAssetToRiskModelValidationRelation:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> ReliabilityAssetToRiskModelValidationRelation:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> ReliabilityAssetToRiskModelValidationRelation:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> ReliabilityAssetToRiskModelValidationRelation:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> ReliabilityAssetToRiskModelValidationRelation:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> ReliabilityAssetToRiskModelValidationRelation:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> ReliabilityAssetToRiskModelValidationRelation:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> ReliabilityAssetToRiskModelValidationRelation:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> ReliabilityAssetToRiskModelValidationRelation:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> ReliabilityAssetToRiskModelValidationRelation:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> ReliabilityAssetToRiskModelValidationRelation:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> ReliabilityAssetToRiskModelValidationRelation:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> ReliabilityAssetToRiskModelValidationRelation:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> ReliabilityAssetToRiskModelValidationRelation:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> ReliabilityAssetToRiskModelValidationRelation:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> ReliabilityAssetToRiskModelValidationRelation:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> ReliabilityAssetToRiskModelValidationRelation:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> ReliabilityAssetToRiskModelValidationRelation:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> ReliabilityAssetToRiskModelValidationRelation:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[ReliabilityAssetToRiskModelValidationRelation]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[ReliabilityAssetToRiskModelValidationRelation]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[ReliabilityAssetToRiskModelValidationRelation]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[ReliabilityAssetToRiskModelValidationRelation]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[ReliabilityAssetToRiskModelValidationRelation]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, ReliabilityAssetToRiskModelValidationRelation]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, ReliabilityAssetToRiskModelValidationRelation]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[ReliabilityAssetToRiskModelValidationRelation]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[ReliabilityAssetToRiskModelValidationRelation]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> ReliabilityAssetToRiskModelValidationRelation:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> ReliabilityAssetToRiskModelValidationRelation:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> ReliabilityAssetToRiskModelValidationRelation:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> ReliabilityAssetToRiskModelValidationRelation:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> ReliabilityAssetToRiskModelValidationRelation:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> ReliabilityAssetToRiskModelValidationRelation:
    """
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[ReliabilityAssetToRiskModelValidationRelation]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> ReliabilityAssetToRiskModelValidationRelation:
    """
    ...
    """
        ...
    def afterMake(self) -> ReliabilityAssetToRiskModelValidationRelation:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> ReliabilityAssetToRiskModelValidationRelation:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[ReliabilityAssetToRiskModelValidationRelation]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> ReliabilityAssetToRiskModelValidationRelation:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, spec: FetchSpec=None) -> FetchResult[ReliabilityAssetToRiskModelValidationRelation]:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, filter: Filter) -> FetchResult[ReliabilityAssetToRiskModelValidationRelation]:
    """
    ...
    """
        ...
    @classmethod
    def fetchObjStream(cls, spec: FetchStreamSpec=None) -> Union[Stream[ReliabilityAssetToRiskModelValidationRelation]]:
    """
    Fetches multiple obj instances based on a specification.  Only objs that the caller is authorized to fetch will be
    returned.
    ...
    """
        ...
    @classmethod
    def fetchMultiLocale(cls, spec: MultiLocaleFetchSpec=None) -> Union[Map[str, FetchResult[ReliabilityAssetToRiskModelValidationRelation]]]:
    """
    ...
    """
        ...
    def get(self, include: str=None) -> Union[ReliabilityAssetToRiskModelValidationRelation]:
    """
    ...
    """
        ...
    def getSpecific(self, include: str=None) -> Union[ReliabilityAssetToRiskModelValidationRelation]:
    """
    ...
    """
        ...
    def getMissing(self, spec: GetMissingSpec) -> ReliabilityAssetToRiskModelValidationRelation:
    """
    ...
    """
        ...
    def getDirect(self, include: str=None) -> Union[ReliabilityAssetToRiskModelValidationRelation]:
    """
    ...
    """
        ...
    def applyReverseEdit(self, versionEdit: VersionEdit) -> ReliabilityAssetToRiskModelValidationRelation:
    """
    ...
    """
        ...
    @classmethod
    def fromString(cls, s: str) -> Union[ReliabilityAssetToRiskModelValidationRelation]:
    """
    ...
    """
        ...
    def create(self, spec: UpsertSpec=None) -> Union[ReliabilityAssetToRiskModelValidationRelation]:
    """
    ...
    """
        ...
    @classmethod
    def createBatch(cls, objs: Array[ReliabilityAssetToRiskModelValidationRelation], spec: UpsertSpec=None) -> Union[ObjList[ReliabilityAssetToRiskModelValidationRelation]]:
    """
    ...
    """
        ...
    @classmethod
    def createBatchObjStream(cls, objs: Stream[ReliabilityAssetToRiskModelValidationRelation], spec: CreateBatchObjStreamSpec=None) -> Union[ObjList[ReliabilityAssetToRiskModelValidationRelation]]:
    """
    Creates multiple instances of a C3 type. If the operation fails and {@link UpsertSpec#dontThrowOnBatchError} is not
    specified (the default), then a C3BatchException will be thrown.  Otherwise {@link errors will be reported in the
    returned {@link ObjList}.  This will fail if any of the instances already exist.
    ...
    """
        ...
    def update(self, srcObj: ReliabilityAssetToRiskModelValidationRelation=None, spec: UpsertSpec=None) -> Union[ReliabilityAssetToRiskModelValidationRelation]:
    """
    ...
    """
        ...
    def upsert(self, srcObj: ReliabilityAssetToRiskModelValidationRelation=None, spec: UpsertSpec=None) -> Union[ReliabilityAssetToRiskModelValidationRelation]:
    """
    ...
    """
        ...
    @overload
    def merge(self, spec: MergeSpec=None) -> Union[ReliabilityAssetToRiskModelValidationRelation]:
    """
    ...
    """
        ...
    @overload
    def merge(self, mergeInclude: str, spec: MergeSpec=None) -> Union[ReliabilityAssetToRiskModelValidationRelation]:
    """
    ...
    """
        ...
    def touch(self, spec: TouchSpec=None) -> Union[ReliabilityAssetToRiskModelValidationRelation]:
    """
    ...
    """
        ...
    @classmethod
    def updateBatch(cls, objs: Array[ReliabilityAssetToRiskModelValidationRelation], srcObjs: Array[ReliabilityAssetToRiskModelValidationRelation]=None, spec: UpsertSpec=None) -> Union[ObjList[ReliabilityAssetToRiskModelValidationRelation]]:
    """
    ...
    """
        ...
    @classmethod
    def updateObjs(cls, objs: Callable[[], Union[Array[ReliabilityAssetToRiskModelValidationRelation]]], spec: UpsertSpec=None) -> Union[ObjList[ReliabilityAssetToRiskModelValidationRelation]]:
    """
    ...
    """
        ...
    @classmethod
    def upsertBatch(cls, objs: Array[ReliabilityAssetToRiskModelValidationRelation], srcObjs: Array[ReliabilityAssetToRiskModelValidationRelation]=None, spec: UpsertSpec=None) -> Union[ObjList[ReliabilityAssetToRiskModelValidationRelation]]:
    """
    ...
    """
        ...
    @classmethod
    def upsertObjs(cls, objs: Callable[[], Union[Array[ReliabilityAssetToRiskModelValidationRelation]]], spec: UpsertSpec=None) -> Union[ObjList[ReliabilityAssetToRiskModelValidationRelation]]:
    """
    Creates instances of a C3 type if they don't already exist and updates them if they do exist. If the operation
    ...
    """
        ...
    @classmethod
    def touchBatch(cls, objs: Array[ReliabilityAssetToRiskModelValidationRelation], spec: TouchSpec=None) -> Union[ObjList[ReliabilityAssetToRiskModelValidationRelation]]:
    """
    ...
    @overload
    @classmethod
    def mergeBatch(cls, objs: Array[ReliabilityAssetToRiskModelValidationRelation], spec: MergeSpec=None) -> Union[ObjList[ReliabilityAssetToRiskModelValidationRelation]]:
    """
    ...
    @overload
    @classmethod
    def mergeBatch(cls, objs: Array[ReliabilityAssetToRiskModelValidationRelation], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[ReliabilityAssetToRiskModelValidationRelation]]:
    """
    Merges multiple instances of a C3 type or creates them if they don't exist. If the operation fails and {@link
    UpsertSpec#dontThrowOnBatchError} is not specified (the default), then a C3BatchException will be thrown.
    Otherwise errors will be reported in the returned {@link ObjList}.  The merge operation is described in the {@link
    ...
    """
        ...
    @classmethod
    def mergeObjs(cls, objs: Callable[[], Union[Array[ReliabilityAssetToRiskModelValidationRelation]]], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[ReliabilityAssetToRiskModelValidationRelation]]:
    """
    ...
    @overload
    @classmethod
    def mergeAll(cls, mergeObj: ReliabilityAssetToRiskModelValidationRelation, spec: MergeAllSpec=None) -> Union[int]:
    """
    ...
    @overload
    @classmethod
    def mergeAll(cls, mergeObj: ReliabilityAssetToRiskModelValidationRelation, mergeInclude: str, spec: MergeAllSpec=None) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def removeBatch(cls, objs: Array[ReliabilityAssetToRiskModelValidationRelation], spec: UpsertSpec=None) -> Union[ObjList[ReliabilityAssetToRiskModelValidationRelation]]:
    """
    ...
    """
        ...
    @classmethod
    def replace(cls, objs: Array[ReliabilityAssetToRiskModelValidationRelation], spec: UpsertSpec=None) -> Union[ObjList[ReliabilityAssetToRiskModelValidationRelation]]:
    """
    ...
    """
        ...
    def unremove(self) -> Union[ReliabilityAssetToRiskModelValidationRelation]:
    """
    ...
    """
        ...
    @classmethod
    def beforeCreate(cls, objs: Array[ReliabilityAssetToRiskModelValidationRelation]) -> ObjList[ReliabilityAssetToRiskModelValidationRelation]:
    """
    ...
    """
        ...
    @classmethod
    def beforeUpdate(cls, objs: Array[ReliabilityAssetToRiskModelValidationRelation]) -> ObjList[ReliabilityAssetToRiskModelValidationRelation]:
    """
    ...
    """
        ...
    @classmethod
    def beforeRemove(cls, objs: Array[ReliabilityAssetToRiskModelValidationRelation]) -> ObjList[ReliabilityAssetToRiskModelValidationRelation]:
    """
    ...
    """
        ...
    @classmethod
    def afterCreate(cls, objs: Array[ReliabilityAssetToRiskModelValidationRelation]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def afterUpdate(cls, objs: Array[ReliabilityAssetToRiskModelValidationRelation]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def afterRemove(cls, objs: Array[ReliabilityAssetToRiskModelValidationRelation]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def startImportData(cls, spec: StartImportDataSpec=None) -> PushStream[ReliabilityAssetToRiskModelValidationRelation]:
    """
    @return a push stream to import instances of this type.
    """
        ...
    @classmethod
    def startImportDataWithStats(cls, spec: StartImportDataSpec=None) -> PushStreamWithStats[ReliabilityAssetToRiskModelValidationRelation]:
    """
    @return a push stream to import instances of this type.
    """
        ...
    ...
    """
        ...
    @classmethod
    def forId(cls, id: str, failIfMissing: bool=None) -> Union[ReliabilityAssetToRiskModelValidationRelation]:
    """
    ...
    """
        ...
    def withoutIdentity(self) -> Union[ReliabilityAssetToRiskModelValidationRelation]:
    """
    ...
    """
        ...
    @classmethod
    def typeOfBatch(cls, objs: Array[ReliabilityAssetToRiskModelValidationRelation]) -> Union[Array[EntityType]]:
    """
    ...
    """
        ...
    @classmethod
    def dbEcho(cls, template: ReliabilityAssetToRiskModelValidationRelation=None, count: int=None, sendBack: bool=None) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def callbackLogic(cls, objs: Array[ReliabilityAssetToRiskModelValidationRelation], callback: Callable[[Union[ReliabilityAssetToRiskModelValidationRelation]], Union[ReliabilityAssetToRiskModelValidationRelation]]=None) -> ObjList[ReliabilityAssetToRiskModelValidationRelation]:
    """
    ...
    """
        ...
    @classmethod
    def afterCallbackLogic(cls, objs: Array[ReliabilityAssetToRiskModelValidationRelation], callback: Callable[[Union[ReliabilityAssetToRiskModelValidationRelation]], Union[ReliabilityAssetToRiskModelValidationRelation]]=None) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def resolveValidationPeriod(cls, relation: ReliabilityAssetToRiskModelRelation, validationPeriod: TimeRange) -> Union[Array[TimeRange]]:
    """
    A helper function which de-duplicates passed in validation period over all previously run validations for the given relation.
    """
        ...
    def doValidate(self, validationPeriod: TimeRange) -> None:
    """
    Used to validate the given {@link ReliabilityRiskMlModel} against the {@link ReliabilityAsset} in this relation.
    Contains logic to do the following things in that sequence:
    1. {@link ReliabilityMlModel#process}
    2. {@link ReliabilityMlModel#interpret}
    3. {@link ReliabilityRiskScoreMlValidationPredictionHeader#refreshNormalization}
    4. {@link ReliabilityRiskScoreMlValidationContributionHeader#refreshNormalization}
    5. `ReliabilityRiskMlModel#processValidationAlertTimeseries`
    """
        ...
