...
from c3.reliabilityMl.ReliabilityTteForecastContribution import ReliabilityTteForecastContribution
...
# Python definitions for the C3 type ReliabilityTteForecastContributionHeader


class ReliabilityTteForecastContributionHeader(TimedDataHeader[ReliabilityTteForecastContribution]):
    """
    ...
    @remarks this represents a made instance of ReliabilityTteForecastContributionHeader
    """
    ...
    data: Optional[Array[ReliabilityTteForecastContribution]]=None
    """
    ...
    parent: Optional[ReliabilityAssetToTteModelRelation]
    """
    ...
    """
    def __init__(self, earliest: Optional[datetime]=None, latest: Optional[datetime]=None, earliestTsDp: Optional[Map[str, TSDataPoint]]=None, latestTsDp: Optional[Map[str, TSDataPoint]]=None, interval: Optional[str]=None, timeZone: Optional[str]=None, doNotNormalize: Optional[bool]=None, data: Optional[Array[ReliabilityTteForecastContribution]]=None, interpolator: Optional[str]=None, duplicateHandling: Optional[str]=None, overlapHandling: Optional[str]=None, bucketInterval: Optional[str]=None, normalizationPartitionStrategy: Optional[NormalizationPartitionStrategy]=None, extrapolate: Optional[bool]=None, typeIdent: Optional[str]=None, id: Optional[str]=None, versionEdits: Optional[Array[VersionEdit]]=None, name: Optional[str]=None, meta: Optional[Meta]=None, version: Optional[int]=None, typeWithBindings: Optional[Type]=None, parent: Optional[ReliabilityAssetToTteModelRelation]=None, treatment: Optional[str]=None) -> None: ...
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[ReliabilityTteForecastContributionHeader]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[ReliabilityTteForecastContributionHeader]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[ReliabilityTteForecastContributionHeader]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[ReliabilityTteForecastContributionHeader]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> ReliabilityTteForecastContributionHeader:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> ReliabilityTteForecastContributionHeader:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> ReliabilityTteForecastContributionHeader:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[ReliabilityTteForecastContributionHeader]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[ReliabilityTteForecastContributionHeader]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> ReliabilityTteForecastContributionHeader:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> ReliabilityTteForecastContributionHeader:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> ReliabilityTteForecastContributionHeader:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> ReliabilityTteForecastContributionHeader:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> ReliabilityTteForecastContributionHeader:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> ReliabilityTteForecastContributionHeader:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> ReliabilityTteForecastContributionHeader:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> ReliabilityTteForecastContributionHeader:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> ReliabilityTteForecastContributionHeader:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> ReliabilityTteForecastContributionHeader:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> ReliabilityTteForecastContributionHeader:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> ReliabilityTteForecastContributionHeader:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> ReliabilityTteForecastContributionHeader:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> ReliabilityTteForecastContributionHeader:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> ReliabilityTteForecastContributionHeader:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> ReliabilityTteForecastContributionHeader:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> ReliabilityTteForecastContributionHeader:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> ReliabilityTteForecastContributionHeader:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> ReliabilityTteForecastContributionHeader:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> ReliabilityTteForecastContributionHeader:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> ReliabilityTteForecastContributionHeader:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> ReliabilityTteForecastContributionHeader:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> ReliabilityTteForecastContributionHeader:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> ReliabilityTteForecastContributionHeader:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> ReliabilityTteForecastContributionHeader:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> ReliabilityTteForecastContributionHeader:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> ReliabilityTteForecastContributionHeader:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> ReliabilityTteForecastContributionHeader:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[ReliabilityTteForecastContributionHeader]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[ReliabilityTteForecastContributionHeader]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[ReliabilityTteForecastContributionHeader]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[ReliabilityTteForecastContributionHeader]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[ReliabilityTteForecastContributionHeader]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, ReliabilityTteForecastContributionHeader]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, ReliabilityTteForecastContributionHeader]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[ReliabilityTteForecastContributionHeader]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[ReliabilityTteForecastContributionHeader]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> ReliabilityTteForecastContributionHeader:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> ReliabilityTteForecastContributionHeader:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> ReliabilityTteForecastContributionHeader:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> ReliabilityTteForecastContributionHeader:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> ReliabilityTteForecastContributionHeader:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> ReliabilityTteForecastContributionHeader:
    """
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[ReliabilityTteForecastContributionHeader]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> ReliabilityTteForecastContributionHeader:
    """
    ...
    """
        ...
    def afterMake(self) -> ReliabilityTteForecastContributionHeader:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> ReliabilityTteForecastContributionHeader:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[ReliabilityTteForecastContributionHeader]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> ReliabilityTteForecastContributionHeader:
    """
    ...
    """
        ...
    @classmethod
    def normalizeTimeseries(cls, timeseries: TimedDataFields[ReliabilityTteForecastContribution]=None, start: datetime=None, end: datetime=None, overrideGrain: str=None, forceGrainDetection: bool=None, force: bool=None) -> None:
    """
    ...
    """
        ...
    @classmethod
    def normalize(cls, timeseries: TimedDataFields[ReliabilityTteForecastContribution]=None, start: datetime=None, end: datetime=None, overrideGrain: str=None, forceGrainDetection: bool=None) -> Union[NormalizationResult]:
    """
    ...
    **Note:**`` If data is removed, there will be no incremental normalization, but the series will be fully normalized at the appropriate time as defined in the {@link NormalizationMode}.
    ...
    """
        ...
    @classmethod
    def normalizationUnit(cls, rawHeader: TimedDataFields[ReliabilityTteForecastContribution], tsField: str) -> Union[Unit]:
    """
    ...
    """
        ...
    @classmethod
    def normalizationTreatment(cls, rawHeader: TimedDataFields[ReliabilityTteForecastContribution], tsField: str) -> str:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, spec: FetchSpec=None) -> FetchResult[ReliabilityTteForecastContributionHeader]:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, filter: Filter) -> FetchResult[ReliabilityTteForecastContributionHeader]:
    """
    ...
    """
        ...
    @classmethod
    def fetchObjStream(cls, spec: FetchStreamSpec=None) -> Union[Stream[ReliabilityTteForecastContributionHeader]]:
    """
    Fetches multiple obj instances based on a specification.  Only objs that the caller is authorized to fetch will be
    returned.
    ...
    """
        ...
    @classmethod
    def fetchMultiLocale(cls, spec: MultiLocaleFetchSpec=None) -> Union[Map[str, FetchResult[ReliabilityTteForecastContributionHeader]]]:
    """
    ...
    """
        ...
    def get(self, include: str=None) -> Union[ReliabilityTteForecastContributionHeader]:
    """
    ...
    """
        ...
    def getSpecific(self, include: str=None) -> Union[ReliabilityTteForecastContributionHeader]:
    """
    ...
    """
        ...
    def getMissing(self, spec: GetMissingSpec) -> ReliabilityTteForecastContributionHeader:
    """
    ...
    """
        ...
    def getDirect(self, include: str=None) -> Union[ReliabilityTteForecastContributionHeader]:
    """
    ...
    """
        ...
    def applyReverseEdit(self, versionEdit: VersionEdit) -> ReliabilityTteForecastContributionHeader:
    """
    ...
    """
        ...
    @classmethod
    def fromString(cls, s: str) -> Union[ReliabilityTteForecastContributionHeader]:
    """
    ...
    """
        ...
    def create(self, spec: UpsertSpec=None) -> Union[ReliabilityTteForecastContributionHeader]:
    """
    ...
    """
        ...
    @classmethod
    def createBatch(cls, objs: Array[ReliabilityTteForecastContributionHeader], spec: UpsertSpec=None) -> Union[ObjList[ReliabilityTteForecastContributionHeader]]:
    """
    ...
    """
        ...
    @classmethod
    def createBatchObjStream(cls, objs: Stream[ReliabilityTteForecastContributionHeader], spec: CreateBatchObjStreamSpec=None) -> Union[ObjList[ReliabilityTteForecastContributionHeader]]:
    """
    Creates multiple instances of a C3 type. If the operation fails and {@link UpsertSpec#dontThrowOnBatchError} is not
    specified (the default), then a C3BatchException will be thrown.  Otherwise {@link errors will be reported in the
    returned {@link ObjList}.  This will fail if any of the instances already exist.
    ...
    """
        ...
    def update(self, srcObj: ReliabilityTteForecastContributionHeader=None, spec: UpsertSpec=None) -> Union[ReliabilityTteForecastContributionHeader]:
    """
    ...
    """
        ...
    def upsert(self, srcObj: ReliabilityTteForecastContributionHeader=None, spec: UpsertSpec=None) -> Union[ReliabilityTteForecastContributionHeader]:
    """
    ...
    """
        ...
    @overload
    def merge(self, spec: MergeSpec=None) -> Union[ReliabilityTteForecastContributionHeader]:
    """
    ...
    """
        ...
    @overload
    def merge(self, mergeInclude: str, spec: MergeSpec=None) -> Union[ReliabilityTteForecastContributionHeader]:
    """
    ...
    """
        ...
    def touch(self, spec: TouchSpec=None) -> Union[ReliabilityTteForecastContributionHeader]:
    """
    ...
    """
        ...
    @classmethod
    def updateBatch(cls, objs: Array[ReliabilityTteForecastContributionHeader], srcObjs: Array[ReliabilityTteForecastContributionHeader]=None, spec: UpsertSpec=None) -> Union[ObjList[ReliabilityTteForecastContributionHeader]]:
    """
    ...
    """
        ...
    @classmethod
    def updateObjs(cls, objs: Callable[[], Union[Array[ReliabilityTteForecastContributionHeader]]], spec: UpsertSpec=None) -> Union[ObjList[ReliabilityTteForecastContributionHeader]]:
    """
    ...
    """
        ...
    @classmethod
    def upsertBatch(cls, objs: Array[ReliabilityTteForecastContributionHeader], srcObjs: Array[ReliabilityTteForecastContributionHeader]=None, spec: UpsertSpec=None) -> Union[ObjList[ReliabilityTteForecastContributionHeader]]:
    """
    ...
    """
        ...
    @classmethod
    def upsertObjs(cls, objs: Callable[[], Union[Array[ReliabilityTteForecastContributionHeader]]], spec: UpsertSpec=None) -> Union[ObjList[ReliabilityTteForecastContributionHeader]]:
    """
    Creates instances of a C3 type if they don't already exist and updates them if they do exist. If the operation
    ...
    """
        ...
    @classmethod
    def touchBatch(cls, objs: Array[ReliabilityTteForecastContributionHeader], spec: TouchSpec=None) -> Union[ObjList[ReliabilityTteForecastContributionHeader]]:
    """
    ...
    @overload
    @classmethod
    def mergeBatch(cls, objs: Array[ReliabilityTteForecastContributionHeader], spec: MergeSpec=None) -> Union[ObjList[ReliabilityTteForecastContributionHeader]]:
    """
    ...
    @overload
    @classmethod
    def mergeBatch(cls, objs: Array[ReliabilityTteForecastContributionHeader], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[ReliabilityTteForecastContributionHeader]]:
    """
    Merges multiple instances of a C3 type or creates them if they don't exist. If the operation fails and {@link
    UpsertSpec#dontThrowOnBatchError} is not specified (the default), then a C3BatchException will be thrown.
    Otherwise errors will be reported in the returned {@link ObjList}.  The merge operation is described in the {@link
    ...
    """
        ...
    @classmethod
    def mergeObjs(cls, objs: Callable[[], Union[Array[ReliabilityTteForecastContributionHeader]]], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[ReliabilityTteForecastContributionHeader]]:
    """
    ...
    @overload
    @classmethod
    def mergeAll(cls, mergeObj: ReliabilityTteForecastContributionHeader, spec: MergeAllSpec=None) -> Union[int]:
    """
    ...
    @overload
    @classmethod
    def mergeAll(cls, mergeObj: ReliabilityTteForecastContributionHeader, mergeInclude: str, spec: MergeAllSpec=None) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def removeBatch(cls, objs: Array[ReliabilityTteForecastContributionHeader], spec: UpsertSpec=None) -> Union[ObjList[ReliabilityTteForecastContributionHeader]]:
    """
    ...
    """
        ...
    @classmethod
    def replace(cls, objs: Array[ReliabilityTteForecastContributionHeader], spec: UpsertSpec=None) -> Union[ObjList[ReliabilityTteForecastContributionHeader]]:
    """
    ...
    """
        ...
    def unremove(self) -> Union[ReliabilityTteForecastContributionHeader]:
    """
    ...
    """
        ...
    @classmethod
    def beforeCreate(cls, objs: Array[ReliabilityTteForecastContributionHeader]) -> ObjList[ReliabilityTteForecastContributionHeader]:
    """
    ...
    """
        ...
    @classmethod
    def beforeUpdate(cls, objs: Array[ReliabilityTteForecastContributionHeader]) -> ObjList[ReliabilityTteForecastContributionHeader]:
    """
    ...
    """
        ...
    @classmethod
    def beforeRemove(cls, objs: Array[ReliabilityTteForecastContributionHeader]) -> ObjList[ReliabilityTteForecastContributionHeader]:
    """
    ...
    """
        ...
    @classmethod
    def afterCreate(cls, objs: Array[ReliabilityTteForecastContributionHeader]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def afterUpdate(cls, objs: Array[ReliabilityTteForecastContributionHeader]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def afterRemove(cls, objs: Array[ReliabilityTteForecastContributionHeader]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def startImportData(cls, spec: StartImportDataSpec=None) -> PushStream[ReliabilityTteForecastContributionHeader]:
    """
    @return a push stream to import instances of this type.
    """
        ...
    @classmethod
    def startImportDataWithStats(cls, spec: StartImportDataSpec=None) -> PushStreamWithStats[ReliabilityTteForecastContributionHeader]:
    """
    @return a push stream to import instances of this type.
    """
        ...
    ...
    """
        ...
    @classmethod
    def forId(cls, id: str, failIfMissing: bool=None) -> Union[ReliabilityTteForecastContributionHeader]:
    """
    ...
    """
        ...
    def withoutIdentity(self) -> Union[ReliabilityTteForecastContributionHeader]:
    """
    ...
    """
        ...
    @classmethod
    def typeOfBatch(cls, objs: Array[ReliabilityTteForecastContributionHeader]) -> Union[Array[EntityType]]:
    """
    ...
    """
        ...
    @classmethod
    def dbEcho(cls, template: ReliabilityTteForecastContributionHeader=None, count: int=None, sendBack: bool=None) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def callbackLogic(cls, objs: Array[ReliabilityTteForecastContributionHeader], callback: Callable[[Union[ReliabilityTteForecastContributionHeader]], Union[ReliabilityTteForecastContributionHeader]]=None) -> ObjList[ReliabilityTteForecastContributionHeader]:
    """
    ...
    """
        ...
    @classmethod
    def afterCallbackLogic(cls, objs: Array[ReliabilityTteForecastContributionHeader], callback: Callable[[Union[ReliabilityTteForecastContributionHeader]], Union[ReliabilityTteForecastContributionHeader]]=None) -> Union[Array[ObjError]]:
    """
