// TypeScript definitions for the C3 type ReliabilityTteForecastContributionHeader
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityTteForecastContributionHeader
 */
declare interface IReliabilityTteForecastContributionHeader {
   ...
   */
  data?: Array_Type<ReliabilityTteForecastContribution> | Array<IReliabilityTteForecastContribution>;
   ...
   */
  parent: IReliabilityAssetToTteModelRelation;
 ...
 */
declare class ReliabilityTteForecastContributionHeader extends Obj  {

  /**
   * Populated on normalization. Indicates the earliest data point across various timeseries fields.
   */
  readonly earliest?: DateTime;
  withEarliest(earliest: DateTime | Date | string | null): ReliabilityTteForecastContributionHeader;

  /**
   * Populated on normalization. Indicates the latest data point across various timeseries fields.
   */
  readonly latest?: DateTime;
  withLatest(latest: DateTime | Date | string | null): ReliabilityTteForecastContributionHeader;

  /**
   * Populated on normalization. Indicates the earliest data point for each {@link Ann.Ts} fields.
   */
  readonly earliestTsDp?: Map_Type<string, TSDataPoint>;
  withEarliestTsDp(earliestTsDp: Map_Type<string, TSDataPoint> | {[key: string]: ITSDataPoint} | null): ReliabilityTteForecastContributionHeader;

  /**
   * Populated on normalization. Indicates the latest data point for each {@link Ann.Ts} fields.
   */
  readonly latestTsDp?: Map_Type<string, TSDataPoint>;
  withLatestTsDp(latestTsDp: Map_Type<string, TSDataPoint> | {[key: string]: ITSDataPoint} | null): ReliabilityTteForecastContributionHeader;
  ...
  withInterval(interval: string | null): ReliabilityTteForecastContributionHeader;
  ...
  withTimeZone(timeZone: string | null): ReliabilityTteForecastContributionHeader;

  /**
   * If set, disables normalizing this time series. Invalidations will still continue to happen for this series normally.
   */
  readonly doNotNormalize?: boolean;
  withDoNotNormalize(doNotNormalize: boolean): ReliabilityTteForecastContributionHeader;

  /**
   * Data points corresponding to this timeseries header
   */
  readonly data?: Array_Type<ReliabilityTteForecastContribution>;
  withData(data: Array_Type<ReliabilityTteForecastContribution> | Array<IReliabilityTteForecastContribution> | null): ReliabilityTteForecastContributionHeader;

  /**
   * Use this field to specify the interpolation mechanism to be applied for gaps in interval timeseries. Default: `ZERO_INTERPOLATOR`.
   */
  readonly interpolator?: string;
  withInterpolator(interpolator: string | null): ReliabilityTteForecastContributionHeader;

  /**
   * Use this field to specify how normalization should handle duplicate data points. A duplicate point is one that has the same start, end, value, unit, and {@link TimedDataPointFields#isEstimated} values. Default: `IGNORE`.
   */
  readonly duplicateHandling?: string;
  withDuplicateHandling(duplicateHandling: string | null): ReliabilityTteForecastContributionHeader;

  /**
   * Used to specify how normalization should handle overlapping data points. Default: `AVG`.
   */
  readonly overlapHandling?: string;
  withOverlapHandling(overlapHandling: string | null): ReliabilityTteForecastContributionHeader;
  ...
  withBucketInterval(bucketInterval: string | null): ReliabilityTteForecastContributionHeader;
  ...
  withNormalizationPartitionStrategy(normalizationPartitionStrategy: INormalizationPartitionStrategy | null): ReliabilityTteForecastContributionHeader;

  /**
   * Indicates whether the last data point should be repeated until infinity
   */
  readonly extrapolate?: boolean;
  withExtrapolate(extrapolate: boolean): ReliabilityTteForecastContributionHeader;
  ...
  withTypeIdent(typeIdent: string | null): ReliabilityTteForecastContributionHeader;
   ...
   */
  readonly id: string;
  withId(id: string): ReliabilityTteForecastContributionHeader;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityTteForecastContributionHeader;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): ReliabilityTteForecastContributionHeader;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): ReliabilityTteForecastContributionHeader;
  ...
  withVersion(version: number | null): ReliabilityTteForecastContributionHeader;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): ReliabilityTteForecastContributionHeader;

  /**
   * The subject-model association related to this series header.
   */
  readonly parent: ReliabilityAssetToTteModelRelation;
  withParent(parent: IReliabilityAssetToTteModelRelation): ReliabilityTteForecastContributionHeader;

  /**
   * The treatment to use for the timeseries.
   */
  readonly treatment?: string;
  withTreatment(treatment: string | null): ReliabilityTteForecastContributionHeader;
   ...
   * @see #toJson
   */
  static fromJson(json: any): ReliabilityTteForecastContributionHeader | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): ReliabilityTteForecastContributionHeader | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): ReliabilityTteForecastContributionHeader | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): ReliabilityTteForecastContributionHeader | null;
   ...
   */
  replaceType(old: Type, new_: Type): ReliabilityTteForecastContributionHeader;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityTteForecastContributionHeader;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityTteForecastContributionHeader;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityTteForecastContributionHeader>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityTteForecastContributionHeader>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityTteForecastContributionHeader;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityTteForecastContributionHeader;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityTteForecastContributionHeader;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ReliabilityTteForecastContributionHeader;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ReliabilityTteForecastContributionHeader;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityTteForecastContributionHeader;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityTteForecastContributionHeader;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityTteForecastContributionHeader;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ReliabilityTteForecastContributionHeader;
   ...
   * @see #removeField
   */
  withoutField(field: string): ReliabilityTteForecastContributionHeader;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): ReliabilityTteForecastContributionHeader;
   ...
   */
  withoutFields(fields: Array_Type<string>): ReliabilityTteForecastContributionHeader;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityTteForecastContributionHeader;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ReliabilityTteForecastContributionHeader;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityTteForecastContributionHeader;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ReliabilityTteForecastContributionHeader;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ReliabilityTteForecastContributionHeader;
   ...
   * @see #removeField
   */
  unsetField(field: string): ReliabilityTteForecastContributionHeader;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ReliabilityTteForecastContributionHeader;
   ...
   * @see #unsetField
   */
  removeField(field: string): ReliabilityTteForecastContributionHeader;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ReliabilityTteForecastContributionHeader;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityTteForecastContributionHeader;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityTteForecastContributionHeader;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityTteForecastContributionHeader;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityTteForecastContributionHeader;

  mergeJson(json: any): ReliabilityTteForecastContributionHeader;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityTteForecastContributionHeader;
   ...
   */
  sumObj(other: Obj, deep?: boolean): ReliabilityTteForecastContributionHeader;
   ...
   */
  singletonArray(): Array_Type<ReliabilityTteForecastContributionHeader>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityTteForecastContributionHeader> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ReliabilityTteForecastContributionHeader> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<ReliabilityTteForecastContributionHeader>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ReliabilityTteForecastContributionHeader> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, ReliabilityTteForecastContributionHeader> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityTteForecastContributionHeader> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ReliabilityTteForecastContributionHeader>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ReliabilityTteForecastContributionHeader>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityTteForecastContributionHeader;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityTteForecastContributionHeader;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityTteForecastContributionHeader;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ReliabilityTteForecastContributionHeader;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityTteForecastContributionHeader;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ReliabilityTteForecastContributionHeader;
   ...
   * @see #fromString
   */
  static make(s: string): ReliabilityTteForecastContributionHeader | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityTteForecastContributionHeader;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): ReliabilityTteForecastContributionHeader;
   ...
   */
  static cachedEmptyInst(): ReliabilityTteForecastContributionHeader;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityTteForecastContributionHeader> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): ReliabilityTteForecastContributionHeader;
   ...
   */
  static normalizeTimeseries(timeseries?: TimedDataFields<ReliabilityTteForecastContribution>, start?: DateTime, end?: DateTime, overrideGrain?: string, forceGrainDetection?: boolean, force?: boolean): void;
   ...
   */
  static normalize(timeseries?: TimedDataFields<ReliabilityTteForecastContribution>, start?: DateTime, end?: DateTime, overrideGrain?: string, forceGrainDetection?: boolean): NormalizationResult | null;
   ...
   */
  static normalizationUnit(rawHeader: TimedDataFields<ReliabilityTteForecastContribution>, tsField: string): Unit | null;
   ...
   */
  static normalizationTreatment(rawHeader: TimedDataFields<ReliabilityTteForecastContribution>, tsField: string): string;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<ReliabilityTteForecastContributionHeader>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<ReliabilityTteForecastContributionHeader>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityTteForecastContributionHeader> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityTteForecastContributionHeader>> | null;
   ...
   */
  get(include?: string): ReliabilityTteForecastContributionHeader | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): ReliabilityTteForecastContributionHeader | null;
   ...
   */
  getMissing(spec: GetMissingSpec): ReliabilityTteForecastContributionHeader;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): ReliabilityTteForecastContributionHeader | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): ReliabilityTteForecastContributionHeader;
   ...
   * @see #toString
   */
  static fromString(s: string): ReliabilityTteForecastContributionHeader | null;
   ...
   */
  create(spec?: UpsertSpec): ReliabilityTteForecastContributionHeader | null;
   ...
   */
  static createBatch(objs: Array_Type<ReliabilityTteForecastContributionHeader>, spec?: UpsertSpec): ObjList<ReliabilityTteForecastContributionHeader> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<ReliabilityTteForecastContributionHeader>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityTteForecastContributionHeader> | null;
   ...
   */
  update(srcObj?: ReliabilityTteForecastContributionHeader, spec?: UpsertSpec): ReliabilityTteForecastContributionHeader | null;
   ...
   */
  upsert(srcObj?: ReliabilityTteForecastContributionHeader, spec?: UpsertSpec): ReliabilityTteForecastContributionHeader | null;
   ...
   */
  merge(spec?: MergeSpec): ReliabilityTteForecastContributionHeader | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): ReliabilityTteForecastContributionHeader | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): ReliabilityTteForecastContributionHeader | null;
   ...
   */
  static updateBatch(objs: Array_Type<ReliabilityTteForecastContributionHeader>, srcObjs?: Array_Type<ReliabilityTteForecastContributionHeader>, spec?: UpsertSpec): ObjList<ReliabilityTteForecastContributionHeader> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<ReliabilityTteForecastContributionHeader> | null>, spec?: UpsertSpec): ObjList<ReliabilityTteForecastContributionHeader> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<ReliabilityTteForecastContributionHeader>, srcObjs?: Array_Type<ReliabilityTteForecastContributionHeader>, spec?: UpsertSpec): ObjList<ReliabilityTteForecastContributionHeader> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<ReliabilityTteForecastContributionHeader> | null>, spec?: UpsertSpec): ObjList<ReliabilityTteForecastContributionHeader> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<ReliabilityTteForecastContributionHeader>, spec?: TouchSpec): ObjList<ReliabilityTteForecastContributionHeader> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityTteForecastContributionHeader>, spec?: MergeSpec): ObjList<ReliabilityTteForecastContributionHeader> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityTteForecastContributionHeader>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityTteForecastContributionHeader> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<ReliabilityTteForecastContributionHeader> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityTteForecastContributionHeader> | null;
   ...
   */
  static mergeAll(mergeObj: ReliabilityTteForecastContributionHeader, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: ReliabilityTteForecastContributionHeader, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<ReliabilityTteForecastContributionHeader>, spec?: UpsertSpec): ObjList<ReliabilityTteForecastContributionHeader> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<ReliabilityTteForecastContributionHeader>, spec?: UpsertSpec): ObjList<ReliabilityTteForecastContributionHeader> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): ReliabilityTteForecastContributionHeader | null;
   ...
   */
  static beforeCreate(objs: Array_Type<ReliabilityTteForecastContributionHeader>): ObjList<ReliabilityTteForecastContributionHeader>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<ReliabilityTteForecastContributionHeader>): ObjList<ReliabilityTteForecastContributionHeader>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<ReliabilityTteForecastContributionHeader>): ObjList<ReliabilityTteForecastContributionHeader>;
   ...
   */
  static afterCreate(objs: Array_Type<ReliabilityTteForecastContributionHeader>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<ReliabilityTteForecastContributionHeader>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<ReliabilityTteForecastContributionHeader>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityTteForecastContributionHeader>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityTteForecastContributionHeader>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): ReliabilityTteForecastContributionHeader | null;
   ...
   */
  withoutIdentity(): ReliabilityTteForecastContributionHeader | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<ReliabilityTteForecastContributionHeader>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: ReliabilityTteForecastContributionHeader, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<ReliabilityTteForecastContributionHeader>, callback?: λFunction<ReliabilityTteForecastContributionHeader | null, ReliabilityTteForecastContributionHeader | null>): ObjList<ReliabilityTteForecastContributionHeader>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<ReliabilityTteForecastContributionHeader>, callback?: λFunction<ReliabilityTteForecastContributionHeader | null, ReliabilityTteForecastContributionHeader | null>): Array_Type<ObjError> | null;
