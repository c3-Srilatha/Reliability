// TypeScript definitions for the C3 type ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe

/**
 * This type represents an {@link MlPipe} template which outputs a `riskScore` based on a dataset of residuals as input.
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe
 */
declare namespace ReliabilityRiskMl.RiskScoreComputation {
  export interface ISimpleComputationPipe {
    ...
    /**
     * `numpy` function to aggregate residual inputs.
     */
    aggFunc: string;
  }
}
 ...
 * This type represents an {@link MlPipe} template which outputs a `riskScore` based on a dataset of residuals as input.
 *
 * @remarks this represents a made instance of ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe
 */
declare namespace ReliabilityRiskMl.RiskScoreComputation {
  export class SimpleComputationPipe extends Obj  {
     ...
     */
    readonly id: string;
    withId(id: string): ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe;

    /**
     * Name of this pipe.
     */
    readonly name?: string;
    withName(name: string | null): ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe;
    ...
    withVersion(version: number | null): ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe;
    ...
    withUserUpdatedFields(userUpdatedFields: Array_Type<string> | Array<string> | null): ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe;
    ...
    withHidden(hidden: boolean): ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe;
    ...
    withUserOwned(userOwned: boolean): ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe;
    ...
    withTypeIdent(typeIdent: string | null): ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe;

    /**
     * If true, then the pipe shall not be retrained
     */
    readonly frozen?: boolean;
    withFrozen(frozen: boolean): ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe;

    /**
     * True if training has succeeded and false otherwise.
     */
    readonly trained?: boolean;
    withTrained(trained: boolean): ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe;

    /**
     * Errors from training.
     */
    readonly trainingErrors?: string;
    withTrainingErrors(trainingErrors: string | null): ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe;

    /**
     * If true, the underlying model only accepts flattened input.
     */
    readonly flattenInput?: boolean;
    withFlattenInput(flattenInput: boolean): ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe;

    /**
     * The hyperparameters overridden of a native model or pipe.
     */
    readonly hyperparamOverrides?: Map_Type<string, any>;
    withHyperparamOverrides(hyperparamOverrides: Map_Type<string, any> | {[key: string]: any} | null): ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe;
    ...
    withHyperparamSearchSpace(hyperparamSearchSpace: IHp.SearchSpace | null): ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe;
    ...
    withHpoSpec(hpoSpec: IHpo.Spec | null): ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe;

    /**
     * {@link Hpo.Experiment} stores the result of hyperparameter optimization to find the best model/pipeline.
     */
    readonly hpoExperiment?: Hpo.Experiment;
    withHpoExperiment(hpoExperiment: IHpo.Experiment | null): ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe;

    /**
     * Reference to the experiment that produced this {@link MlPipe}. For example, this could be a {@link Hpo.ExperimentBase}.
     */
    readonly experiment?: any;
    withExperiment(experiment: any | null): ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe;
    ...
    withModelFiles(modelFiles: Map_Type<string, Url> | {[key: string]: IUrl} | null): ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe;
    ...
    withCustomModelCode(customModelCode: Map_Type<string, any> | {[key: string]: any} | null): ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe;

    /**
     * Name for the function on the native model to call to do {@link MlProcessable#process}.
     */
    readonly processFunc?: string;
    withProcessFunc(processFunc: string | null): ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe;
    ...
    withUnderlyingPipe(underlyingPipe: IMlAtomicPipe<any, any, any> | null): ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe;
    ...
    withIsTrainableOverride(isTrainableOverride: boolean): ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe;
    ...
    withLookbackDuration(lookbackDuration: IDuration | null): ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe;

    /**
     * `numpy` function to aggregate residual inputs.
     */
    readonly aggFunc: string;
    withAggFunc(aggFunc: string): ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe;
     ...
     * @see #toJson
     */
    static fromJson(json: any): ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe | null;
     ...
     */
    replaceType(old: Type, new_: Type): ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe;
     ...
     * @see #removeField
     */
    withoutField(field: string): ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe;
     ...
     */
    withoutFields(fields: Array_Type<string>): ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe;
     ...
     * @see #unsetField
     */
    defaultField(field: string): ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe;
     ...
     * @see #removeField
     */
    unsetField(field: string): ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe;
     ...
     * @see #unsetField
     */
    removeField(field: string): ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe;

    mergeJson(json: any): ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe;
     ...
     */
    sumObj(other: Obj, deep?: boolean): ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe;
     ...
     */
    singletonArray(): Array_Type<ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe;
     ...
     * @see #fromString
     */
    static make(s: string): ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe;
     ...
     */
    static cachedEmptyInst(): ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe;
     ...
     */
    remakeTemplate(): ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe;
     ...
     */
    withoutIdentity(): ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe;
     ...
     */
    trainSync(x: , y?: , spec?: MlOperationSpec): ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe;
     ...
     */
    static allCached(doNotProduceAll?: boolean): Stream<ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe> | null;
     ...
     */
    static find(filter?: string, doNotProduceAll?: boolean): Stream<ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe> | null;
     ...
     * @return existing instances of this type that satisfy filter from data cache.
     */
    static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe> | null;
     ...
     * @see getCached
     */
    static findByCacheKey(key: string): ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe | null;
     ...
     * @see findByCacheKey
     */
    static forCacheKey(key: string): ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe | null;
     ...
     * @see findByCacheKey
     */
    getCached(): ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe | null;

    /**
     * @return newly produced cached instance.
     */
    refreshCache(): ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe | null;
     ...
     */
    static produce(key: string): ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe | null;
     ...
     */
    static produceAll(): Map_Type<string, ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe> | null;

    /**
     * Override for sub-types to produce all values.
     */
    static doProduceAll(): Map_Type<string, ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe> | null;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe>> | null;
     ...
     */
    get(include?: string): ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe | null;
     ...
     */
    getMissing(spec: GetMissingSpec): ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe;
     ...
     * @see #toString
     */
    static fromString(s: string): ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe | null;
     ...
     */
    create(spec?: UpsertSpec): ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe | null;
     ...
     */
    static createBatch(objs: Array_Type<ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe> | null;
     ...
     */
    update(srcObj?: ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe, spec?: UpsertSpec): ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe | null;
     ...
     */
    upsert(srcObj?: ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe, spec?: UpsertSpec): ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe | null;
     ...
     */
    merge(spec?: MergeSpec): ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe | null;
     ...
     */
    static updateBatch(objs: Array_Type<ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe>, srcObjs?: Array_Type<ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe> | null>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe>, srcObjs?: Array_Type<ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe> | null>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe>, spec?: TouchSpec): ObjList<ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe>, spec?: MergeSpec): ObjList<ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe> | null;
     ...
     */
    static mergeAll(mergeObj: ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe | null;
     ...
     */
    static beforeCreate(objs: Array_Type<ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe>): ObjList<ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe>;
     ...
     */
    static beforeUpdate(objs: Array_Type<ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe>): ObjList<ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe>): ObjList<ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe>;
     ...
     */
    static afterCreate(objs: Array_Type<ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe>, callback?: λFunction<ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe | null, ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe | null>): ObjList<ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe>, callback?: λFunction<ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe | null, ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe | null>): Array_Type<ObjError> | null;
     ...
     */
    publish(subPath?: string, contentType?: string): ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe;
     ...
     */
    static removeSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe> | null;
     ...
     */
    createSeedData(spec?: UpsertSpec): ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe | null;
     ...
     */
    static createSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe> | null;
     ...
     */
    updateSeedData(srcObj?: SeedData, spec?: UpsertSpec): ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe | null;
     ...
     */
    static updateSeedDataBatch(objs?: Array_Type<SeedData>, srcObjs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe> | null;
     ...
     * @return updated obj instance, same as {@link Persistable#update} return value.
     */
    clearUserUpdates(spec?: MergeSpec): ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe | null;
     ...
     *         {@link Persistable#updateBatch}.
     */
    static clearUserUpdatesBatch(objs?: Array_Type<SeedData>, spec?: MergeSpec): ObjList<ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe> | null;
    ...
    dependencies(): SeedDataDeps<ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe> | null;
     ...
     */
    static convert(model: any, spec?: MlConvertSpec): ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe;

    /**
     * Freezes an {@link MlPipe}
     * @return modified copy of this {@link MlPipe} that cannot be trained
     */
    freeze(): ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe;

    /**
     * Unfreezes an {@link MlPipe}
     * @return modified copy of this {@link MlPipe} that can be trained
     */
    unfreeze(): ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe;
     ...
     * be returned as-is.
     */
    byReference(): ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe;
     ...
     */
    updateModelFiles(modelFiles: Map_Type<string, Url>, spec?: MlOperationSpec): ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe;
     ...
     */
    afterTrain(doTrainOutputs: any, spec?: MlOperationSpec): ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe;
     ...
     */
    withNewSpec(spec?: MlConvertSpec): ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe;
     ...
     */
    afterConvert(model: any, spec?: MlConvertSpec): ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe;
     ...
     */
    withHyperparamSpaces(paramSpaces: Map_Type<string, Hp.ParamSpace>): ReliabilityRiskMl.RiskScoreComputation.SimpleComputationPipe;
