// TypeScript definitions for the C3 type ReliabilityAssetToModelValidationRelation
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityAssetToModelValidationRelation
 */
declare interface IReliabilityAssetToModelValidationRelation {
   ...
   */
  predictions?: Array_Type<ReliabilityMl.ValidationPredictionHeader> | Array<IReliabilityMl.ValidationPredictionHeader>;

  /**
   * The feature contributions used for the predictions.
   */
  contributions?: Array_Type<ReliabilityMl.ValidationContributionHeader> | Array<IReliabilityMl.ValidationContributionHeader>;
}
 ...
 */
declare class ReliabilityAssetToModelValidationRelation extends Obj  {

  /**
   * Start timestamp for the value.  If null, assumed to be beginning-of-time (BOT).
   */
  readonly start?: DateTime;
  withStart(start: DateTime | Date | string | null): ReliabilityAssetToModelValidationRelation;

  /**
   * End timestamp for the value.  If null, assumed to be end-of-time (EOT).
   */
  readonly end?: DateTime;
  withEnd(end: DateTime | Date | string | null): ReliabilityAssetToModelValidationRelation;

  /**
   * The from side of the relation.
   */
  readonly from?: ReliabilityAsset;
  withFrom(from: IReliabilityAsset | null): ReliabilityAssetToModelValidationRelation;

  /**
   * The to side of the relation.
   */
  readonly to?: ReliabilityMlModel;
  withTo(to: IReliabilityMlModel | null): ReliabilityAssetToModelValidationRelation;
   ...
   */
  readonly id: string;
  withId(id: string): ReliabilityAssetToModelValidationRelation;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityAssetToModelValidationRelation;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): ReliabilityAssetToModelValidationRelation;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): ReliabilityAssetToModelValidationRelation;
  ...
  withVersion(version: number | null): ReliabilityAssetToModelValidationRelation;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): ReliabilityAssetToModelValidationRelation;

  /**
   * @inheritdoc
   */
  readonly facilityFilterPaths?: Array_Type<string>;
  withFacilityFilterPaths(facilityFilterPaths: Array_Type<string> | Array<string> | null): ReliabilityAssetToModelValidationRelation;
  ...
  withTypeIdent(typeIdent: string | null): ReliabilityAssetToModelValidationRelation;

  /**
   * The predictions generated by the {@link ReliabilityMlModel}.
   */
  readonly predictions?: Array_Type<ReliabilityMl.ValidationPredictionHeader>;
  withPredictions(predictions: Array_Type<ReliabilityMl.ValidationPredictionHeader> | Array<IReliabilityMl.ValidationPredictionHeader> | null): ReliabilityAssetToModelValidationRelation;

  /**
   * The feature contributions used for the predictions.
   */
  readonly contributions?: Array_Type<ReliabilityMl.ValidationContributionHeader>;
  withContributions(contributions: Array_Type<ReliabilityMl.ValidationContributionHeader> | Array<IReliabilityMl.ValidationContributionHeader> | null): ReliabilityAssetToModelValidationRelation;
   ...
   * @see #toJson
   */
  static fromJson(json: any): ReliabilityAssetToModelValidationRelation | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): ReliabilityAssetToModelValidationRelation | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): ReliabilityAssetToModelValidationRelation | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): ReliabilityAssetToModelValidationRelation | null;
   ...
   */
  replaceType(old: Type, new_: Type): ReliabilityAssetToModelValidationRelation;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityAssetToModelValidationRelation;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityAssetToModelValidationRelation;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityAssetToModelValidationRelation>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityAssetToModelValidationRelation>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityAssetToModelValidationRelation;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityAssetToModelValidationRelation;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityAssetToModelValidationRelation;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ReliabilityAssetToModelValidationRelation;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ReliabilityAssetToModelValidationRelation;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityAssetToModelValidationRelation;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityAssetToModelValidationRelation;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityAssetToModelValidationRelation;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ReliabilityAssetToModelValidationRelation;
   ...
   * @see #removeField
   */
  withoutField(field: string): ReliabilityAssetToModelValidationRelation;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): ReliabilityAssetToModelValidationRelation;
   ...
   */
  withoutFields(fields: Array_Type<string>): ReliabilityAssetToModelValidationRelation;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityAssetToModelValidationRelation;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ReliabilityAssetToModelValidationRelation;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityAssetToModelValidationRelation;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ReliabilityAssetToModelValidationRelation;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ReliabilityAssetToModelValidationRelation;
   ...
   * @see #removeField
   */
  unsetField(field: string): ReliabilityAssetToModelValidationRelation;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ReliabilityAssetToModelValidationRelation;
   ...
   * @see #unsetField
   */
  removeField(field: string): ReliabilityAssetToModelValidationRelation;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ReliabilityAssetToModelValidationRelation;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityAssetToModelValidationRelation;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityAssetToModelValidationRelation;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityAssetToModelValidationRelation;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityAssetToModelValidationRelation;

  mergeJson(json: any): ReliabilityAssetToModelValidationRelation;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityAssetToModelValidationRelation;
   ...
   */
  sumObj(other: Obj, deep?: boolean): ReliabilityAssetToModelValidationRelation;
   ...
   */
  singletonArray(): Array_Type<ReliabilityAssetToModelValidationRelation>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityAssetToModelValidationRelation> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ReliabilityAssetToModelValidationRelation> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<ReliabilityAssetToModelValidationRelation>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ReliabilityAssetToModelValidationRelation> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, ReliabilityAssetToModelValidationRelation> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityAssetToModelValidationRelation> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ReliabilityAssetToModelValidationRelation>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ReliabilityAssetToModelValidationRelation>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityAssetToModelValidationRelation;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityAssetToModelValidationRelation;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityAssetToModelValidationRelation;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ReliabilityAssetToModelValidationRelation;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityAssetToModelValidationRelation;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ReliabilityAssetToModelValidationRelation;
   ...
   * @see #fromString
   */
  static make(s: string): ReliabilityAssetToModelValidationRelation | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityAssetToModelValidationRelation;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): ReliabilityAssetToModelValidationRelation;
   ...
   */
  static cachedEmptyInst(): ReliabilityAssetToModelValidationRelation;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityAssetToModelValidationRelation> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): ReliabilityAssetToModelValidationRelation;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<ReliabilityAssetToModelValidationRelation>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<ReliabilityAssetToModelValidationRelation>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityAssetToModelValidationRelation> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityAssetToModelValidationRelation>> | null;
   ...
   */
  get(include?: string): ReliabilityAssetToModelValidationRelation | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): ReliabilityAssetToModelValidationRelation | null;
   ...
   */
  getMissing(spec: GetMissingSpec): ReliabilityAssetToModelValidationRelation;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): ReliabilityAssetToModelValidationRelation | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): ReliabilityAssetToModelValidationRelation;
   ...
   * @see #toString
   */
  static fromString(s: string): ReliabilityAssetToModelValidationRelation | null;
   ...
   */
  create(spec?: UpsertSpec): ReliabilityAssetToModelValidationRelation | null;
   ...
   */
  static createBatch(objs: Array_Type<ReliabilityAssetToModelValidationRelation>, spec?: UpsertSpec): ObjList<ReliabilityAssetToModelValidationRelation> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<ReliabilityAssetToModelValidationRelation>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityAssetToModelValidationRelation> | null;
   ...
   */
  update(srcObj?: ReliabilityAssetToModelValidationRelation, spec?: UpsertSpec): ReliabilityAssetToModelValidationRelation | null;
   ...
   */
  upsert(srcObj?: ReliabilityAssetToModelValidationRelation, spec?: UpsertSpec): ReliabilityAssetToModelValidationRelation | null;
   ...
   */
  merge(spec?: MergeSpec): ReliabilityAssetToModelValidationRelation | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): ReliabilityAssetToModelValidationRelation | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): ReliabilityAssetToModelValidationRelation | null;
   ...
   */
  static updateBatch(objs: Array_Type<ReliabilityAssetToModelValidationRelation>, srcObjs?: Array_Type<ReliabilityAssetToModelValidationRelation>, spec?: UpsertSpec): ObjList<ReliabilityAssetToModelValidationRelation> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<ReliabilityAssetToModelValidationRelation> | null>, spec?: UpsertSpec): ObjList<ReliabilityAssetToModelValidationRelation> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<ReliabilityAssetToModelValidationRelation>, srcObjs?: Array_Type<ReliabilityAssetToModelValidationRelation>, spec?: UpsertSpec): ObjList<ReliabilityAssetToModelValidationRelation> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<ReliabilityAssetToModelValidationRelation> | null>, spec?: UpsertSpec): ObjList<ReliabilityAssetToModelValidationRelation> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<ReliabilityAssetToModelValidationRelation>, spec?: TouchSpec): ObjList<ReliabilityAssetToModelValidationRelation> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityAssetToModelValidationRelation>, spec?: MergeSpec): ObjList<ReliabilityAssetToModelValidationRelation> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityAssetToModelValidationRelation>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityAssetToModelValidationRelation> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<ReliabilityAssetToModelValidationRelation> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityAssetToModelValidationRelation> | null;
   ...
   */
  static mergeAll(mergeObj: ReliabilityAssetToModelValidationRelation, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: ReliabilityAssetToModelValidationRelation, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<ReliabilityAssetToModelValidationRelation>, spec?: UpsertSpec): ObjList<ReliabilityAssetToModelValidationRelation> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<ReliabilityAssetToModelValidationRelation>, spec?: UpsertSpec): ObjList<ReliabilityAssetToModelValidationRelation> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): ReliabilityAssetToModelValidationRelation | null;
   ...
   */
  static beforeCreate(objs: Array_Type<ReliabilityAssetToModelValidationRelation>): ObjList<ReliabilityAssetToModelValidationRelation>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<ReliabilityAssetToModelValidationRelation>): ObjList<ReliabilityAssetToModelValidationRelation>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<ReliabilityAssetToModelValidationRelation>): ObjList<ReliabilityAssetToModelValidationRelation>;
   ...
   */
  static afterCreate(objs: Array_Type<ReliabilityAssetToModelValidationRelation>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<ReliabilityAssetToModelValidationRelation>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<ReliabilityAssetToModelValidationRelation>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityAssetToModelValidationRelation>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityAssetToModelValidationRelation>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): ReliabilityAssetToModelValidationRelation | null;
   ...
   */
  withoutIdentity(): ReliabilityAssetToModelValidationRelation | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<ReliabilityAssetToModelValidationRelation>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: ReliabilityAssetToModelValidationRelation, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<ReliabilityAssetToModelValidationRelation>, callback?: λFunction<ReliabilityAssetToModelValidationRelation | null, ReliabilityAssetToModelValidationRelation | null>): ObjList<ReliabilityAssetToModelValidationRelation>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<ReliabilityAssetToModelValidationRelation>, callback?: λFunction<ReliabilityAssetToModelValidationRelation | null, ReliabilityAssetToModelValidationRelation | null>): Array_Type<ObjError> | null;
