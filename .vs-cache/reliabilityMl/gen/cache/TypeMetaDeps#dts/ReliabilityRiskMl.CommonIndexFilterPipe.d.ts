// TypeScript definitions for the C3 type ReliabilityRiskMl.CommonIndexFilterPipe

/**
 * This type represents a machine learning pipe template that filters the input datasets such that all of them have
 * the exact same length and indices. This ensures that the features being processed have consistent temporal
 * alignment and size, making them suitable for subsequent operations that require uniformity in input data.
 *
 * This pipe can be used as part of a larger machine learning pipeline where the consistency of input data is crucial.
 * The input datasets are filtered and adjusted to align in terms of length and index values before being processed
 * further.
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityRiskMl.CommonIndexFilterPipe
 */
declare namespace ReliabilityRiskMl {
  export interface ICommonIndexFilterPipe<DX, DO> {
    ...
    /**
     * A list of the names of the input features that will be processed by this pipe.
     * All inputs listed here must have the same length and indices for this pipe to function properly.
     */
 ...
 * further.
 *
 * @remarks this represents a made instance of ReliabilityRiskMl.CommonIndexFilterPipe
 */
declare namespace ReliabilityRiskMl {
  export class CommonIndexFilterPipe<DX, DO> extends Obj  {
     ...
     */
    readonly id: string;
    withId(id: string): ReliabilityRiskMl.CommonIndexFilterPipe;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityRiskMl.CommonIndexFilterPipe;

    /**
     * Name of this pipe.
     */
    readonly name?: string;
    withName(name: string | null): ReliabilityRiskMl.CommonIndexFilterPipe;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): ReliabilityRiskMl.CommonIndexFilterPipe;
    ...
    withVersion(version: number | null): ReliabilityRiskMl.CommonIndexFilterPipe;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): ReliabilityRiskMl.CommonIndexFilterPipe;
    ...
    withUserUpdatedFields(userUpdatedFields: Array_Type<string> | Array<string> | null): ReliabilityRiskMl.CommonIndexFilterPipe;
    ...
    withHidden(hidden: boolean): ReliabilityRiskMl.CommonIndexFilterPipe;
    ...
    withUserOwned(userOwned: boolean): ReliabilityRiskMl.CommonIndexFilterPipe;
    ...
    withTypeIdent(typeIdent: string | null): ReliabilityRiskMl.CommonIndexFilterPipe;

    /**
     * If true, then the pipe shall not be retrained
     */
    readonly frozen?: boolean;
    withFrozen(frozen: boolean): ReliabilityRiskMl.CommonIndexFilterPipe;

    /**
     * True if training has succeeded and false otherwise.
     */
    readonly trained?: boolean;
    withTrained(trained: boolean): ReliabilityRiskMl.CommonIndexFilterPipe;

    /**
     * Errors from training.
     */
    readonly trainingErrors?: string;
    withTrainingErrors(trainingErrors: string | null): ReliabilityRiskMl.CommonIndexFilterPipe;

    /**
     * If true, the underlying model only accepts flattened input.
     */
    readonly flattenInput?: boolean;
    withFlattenInput(flattenInput: boolean): ReliabilityRiskMl.CommonIndexFilterPipe;

    /**
     * The hyperparameters overridden of a native model or pipe.
     */
    readonly hyperparamOverrides?: Map_Type<string, any>;
    withHyperparamOverrides(hyperparamOverrides: Map_Type<string, any> | {[key: string]: any} | null): ReliabilityRiskMl.CommonIndexFilterPipe;
    ...
    withHyperparamSearchSpace(hyperparamSearchSpace: IHp.SearchSpace | null): ReliabilityRiskMl.CommonIndexFilterPipe;
    ...
    withHpoSpec(hpoSpec: IHpo.Spec | null): ReliabilityRiskMl.CommonIndexFilterPipe;

    /**
     * {@link Hpo.Experiment} stores the result of hyperparameter optimization to find the best model/pipeline.
     */
    readonly hpoExperiment?: Hpo.Experiment;
    withHpoExperiment(hpoExperiment: IHpo.Experiment | null): ReliabilityRiskMl.CommonIndexFilterPipe;

    /**
     * Reference to the experiment that produced this {@link MlPipe}. For example, this could be a {@link Hpo.ExperimentBase}.
     */
    readonly experiment?: any;
    withExperiment(experiment: any | null): ReliabilityRiskMl.CommonIndexFilterPipe;
    ...
    withModelFiles(modelFiles: Map_Type<string, Url> | {[key: string]: IUrl} | null): ReliabilityRiskMl.CommonIndexFilterPipe;
    ...
    withCustomModelCode(customModelCode: Map_Type<string, any> | {[key: string]: any} | null): ReliabilityRiskMl.CommonIndexFilterPipe;

    /**
     * Name for the function on the native model to call to do {@link MlProcessable#process}.
     */
    readonly processFunc?: string;
    withProcessFunc(processFunc: string | null): ReliabilityRiskMl.CommonIndexFilterPipe;
    ...
    withUnderlyingPipe(underlyingPipe: IMlAtomicPipe<any, any, any> | null): ReliabilityRiskMl.CommonIndexFilterPipe;
    ...
    withInputNames(inputNames: Array_Type<string> | Array<string>): ReliabilityRiskMl.CommonIndexFilterPipe;
     ...
     * @see #toJson
     */
    static fromJson(json: any): ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO> | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO> | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO> | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO> | null;
     ...
     */
    replaceType(old: Type, new_: Type): ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>;
     ...
     * @see #removeField
     */
    withoutField(field: string): ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>;
     ...
     */
    withoutFields(fields: Array_Type<string>): ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>;
     ...
     * @see #unsetField
     */
    defaultField(field: string): ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>;
     ...
     * @see #removeField
     */
    unsetField(field: string): ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>;
     ...
     * @see #unsetField
     */
    removeField(field: string): ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>;

    mergeJson(json: any): ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>;
     ...
     */
    sumObj(other: Obj, deep?: boolean): ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>;
     ...
     */
    singletonArray(): Array_Type<ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>;
     ...
     * @see #fromString
     */
    static make(s: string): ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO> | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>;
     ...
     */
    static cachedEmptyInst(): ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>;
     ...
     */
    remakeTemplate(): ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>;

    /**
     * A function used to generate type bindings for the pipe.
     * This ensures that the correct types are associated with the input and output of the pipe, maintaining
     * consistency and ensuring proper data handling during the process.
     */
     ...
     */
    withoutIdentity(): ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>;
     ...
     */
    trainSync(x: DX, y?: , spec?: MlOperationSpec): ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>;

    /**
     * Indicates whether this pipe is trainable.
     * This pipe does not include any machine learning model training, as it is a data preprocessing step
     * that ensures the uniformity of the input data. Therefore, it is marked as non-trainable.
     */
    isTrainable(): boolean;
     ...
     */
    static allCached(doNotProduceAll?: boolean): Stream<ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>> | null;
     ...
     */
    static find(filter?: string, doNotProduceAll?: boolean): Stream<ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>> | null;
     ...
     * @return existing instances of this type that satisfy filter from data cache.
     */
    static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>> | null;
     ...
     * @see getCached
     */
    static findByCacheKey(key: string): ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO> | null;
     ...
     * @see findByCacheKey
     */
    static forCacheKey(key: string): ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO> | null;
     ...
     * @see findByCacheKey
     */
    getCached(): ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO> | null;

    /**
     * @return newly produced cached instance.
     */
    refreshCache(): ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO> | null;
     ...
     */
    static produce(key: string): ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO> | null;
     ...
     */
    static produceAll(): Map_Type<string, ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>> | null;

    /**
     * Override for sub-types to produce all values.
     */
    static doProduceAll(): Map_Type<string, ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>> | null;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>>> | null;
     ...
     */
    get(include?: string): ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO> | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO> | null;
     ...
     */
    getMissing(spec: GetMissingSpec): ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO> | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>;
     ...
     * @see #toString
     */
    static fromString(s: string): ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO> | null;
     ...
     */
    create(spec?: UpsertSpec): ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO> | null;
     ...
     */
    static createBatch(objs: Array_Type<ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>> | null;
     ...
     */
    update(srcObj?: ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>, spec?: UpsertSpec): ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO> | null;
     ...
     */
    upsert(srcObj?: ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>, spec?: UpsertSpec): ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO> | null;
     ...
     */
    merge(spec?: MergeSpec): ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO> | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO> | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO> | null;
     ...
     */
    static updateBatch(objs: Array_Type<ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>>, srcObjs?: Array_Type<ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>> | null>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>>, srcObjs?: Array_Type<ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>> | null>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>>, spec?: TouchSpec): ObjList<ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>>, spec?: MergeSpec): ObjList<ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>> | null;
     ...
     */
    static mergeAll(mergeObj: ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO> | null;
     ...
     */
    static beforeCreate(objs: Array_Type<ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>>): ObjList<ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>>;
     ...
     */
    static beforeUpdate(objs: Array_Type<ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>>): ObjList<ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>>): ObjList<ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>>;
     ...
     */
    static afterCreate(objs: Array_Type<ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO> | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>>, callback?: λFunction<ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO> | null, ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO> | null>): ObjList<ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>>, callback?: λFunction<ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO> | null, ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO> | null>): Array_Type<ObjError> | null;
     ...
     */
    publish(subPath?: string, contentType?: string): ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>;
     ...
     */
    static removeSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>> | null;
     ...
     */
    createSeedData(spec?: UpsertSpec): ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO> | null;
     ...
     */
    static createSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>> | null;
     ...
     */
    updateSeedData(srcObj?: SeedData, spec?: UpsertSpec): ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO> | null;
     ...
     */
    static updateSeedDataBatch(objs?: Array_Type<SeedData>, srcObjs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>> | null;
     ...
     * @return updated obj instance, same as {@link Persistable#update} return value.
     */
    clearUserUpdates(spec?: MergeSpec): ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO> | null;
     ...
     *         {@link Persistable#updateBatch}.
     */
    static clearUserUpdatesBatch(objs?: Array_Type<SeedData>, spec?: MergeSpec): ObjList<ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>> | null;
    ...
    dependencies(): SeedDataDeps<ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>> | null;
     ...
     */
    static convert(model: any, spec?: MlConvertSpec): ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>;

    /**
     * Freezes an {@link MlPipe}
     * @return modified copy of this {@link MlPipe} that cannot be trained
     */
    freeze(): ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>;

    /**
     * Unfreezes an {@link MlPipe}
     * @return modified copy of this {@link MlPipe} that can be trained
     */
    unfreeze(): ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>;
     ...
     * be returned as-is.
     */
    byReference(): ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>;
     ...
     */
    updateModelFiles(modelFiles: Map_Type<string, Url>, spec?: MlOperationSpec): ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>;
     ...
     */
    afterTrain(doTrainOutputs: any, spec?: MlOperationSpec): ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>;
    ...
    /**
     * The function used to process the input data in this pipe.
     * This function performs the filtering of the input datasets to ensure that all inputs have the same length
     * and indices. The processing will be done in a data processing environment (`py-data`), which ensures that
     * the inputs are aligned correctly.
     */
     ...
     */
    withNewSpec(spec?: MlConvertSpec): ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>;
     ...
     */
    afterConvert(model: any, spec?: MlConvertSpec): ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>;
     ...
     */
    withHyperparamSpaces(paramSpaces: Map_Type<string, Hp.ParamSpace>): ReliabilityRiskMl.CommonIndexFilterPipe<DX, DO>;
    ...
    /**
     * A function used to generate the specific pipe for processing data.
     * This function is responsible for creating the necessary machine learning pipeline that includes this filter step.
     * It is defined as part of the generation logic, allowing for dynamic creation of processing pipelines.
     */
