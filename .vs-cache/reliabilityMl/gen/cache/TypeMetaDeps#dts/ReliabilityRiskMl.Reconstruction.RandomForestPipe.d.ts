// TypeScript definitions for the C3 type ReliabilityRiskMl.Reconstruction.RandomForestPipe

/**
 * This type represents an {@link MlPipe} template for a RandomForest regressor. This can be used as a regressor
 * in {@link ReliabilityRiskMl.Reconstruction.ControlValvesPipe#regressor}.
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityRiskMl.Reconstruction.RandomForestPipe
 */
declare namespace ReliabilityRiskMl.Reconstruction {
  export interface IRandomForestPipe {
     ...
     * leaves contain less than {@link #minSamplesSplit} samples.
     */
    maxDepth?: number;

    /**
     * The minimum number of samples required to split an internal node. Defaults to 2
     */
    ...
    /**
     * The number of jobs to run in parallel for both fit and predict. If -1, then all processors are used.s
     */
    nJobs?: number;
    ...
    /**
     * If {@link #bootstrap} is True, the number of samples to draw from X to train each base estimator.
     */
    maxSamples?: number;
  }
}
 ...
 * in {@link ReliabilityRiskMl.Reconstruction.ControlValvesPipe#regressor}.
 *
 * @remarks this represents a made instance of ReliabilityRiskMl.Reconstruction.RandomForestPipe
 */
declare namespace ReliabilityRiskMl.Reconstruction {
  export class RandomForestPipe extends Obj  {
     ...
     */
    readonly id: string;
    withId(id: string): ReliabilityRiskMl.Reconstruction.RandomForestPipe;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityRiskMl.Reconstruction.RandomForestPipe;

    /**
     * Name of this pipe.
     */
    readonly name?: string;
    withName(name: string | null): ReliabilityRiskMl.Reconstruction.RandomForestPipe;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): ReliabilityRiskMl.Reconstruction.RandomForestPipe;
    ...
    withVersion(version: number | null): ReliabilityRiskMl.Reconstruction.RandomForestPipe;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): ReliabilityRiskMl.Reconstruction.RandomForestPipe;
    ...
    withUserUpdatedFields(userUpdatedFields: Array_Type<string> | Array<string> | null): ReliabilityRiskMl.Reconstruction.RandomForestPipe;
    ...
    withHidden(hidden: boolean): ReliabilityRiskMl.Reconstruction.RandomForestPipe;
    ...
    withUserOwned(userOwned: boolean): ReliabilityRiskMl.Reconstruction.RandomForestPipe;
    ...
    withTypeIdent(typeIdent: string | null): ReliabilityRiskMl.Reconstruction.RandomForestPipe;

    /**
     * If true, then the pipe shall not be retrained
     */
    readonly frozen?: boolean;
    withFrozen(frozen: boolean): ReliabilityRiskMl.Reconstruction.RandomForestPipe;

    /**
     * True if training has succeeded and false otherwise.
     */
    readonly trained?: boolean;
    withTrained(trained: boolean): ReliabilityRiskMl.Reconstruction.RandomForestPipe;

    /**
     * Errors from training.
     */
    readonly trainingErrors?: string;
    withTrainingErrors(trainingErrors: string | null): ReliabilityRiskMl.Reconstruction.RandomForestPipe;

    /**
     * If true, the underlying model only accepts flattened input.
     */
    readonly flattenInput?: boolean;
    withFlattenInput(flattenInput: boolean): ReliabilityRiskMl.Reconstruction.RandomForestPipe;

    /**
     * The hyperparameters overridden of a native model or pipe.
     */
    readonly hyperparamOverrides?: Map_Type<string, any>;
    withHyperparamOverrides(hyperparamOverrides: Map_Type<string, any> | {[key: string]: any} | null): ReliabilityRiskMl.Reconstruction.RandomForestPipe;
    ...
    withHyperparamSearchSpace(hyperparamSearchSpace: IHp.SearchSpace | null): ReliabilityRiskMl.Reconstruction.RandomForestPipe;
    ...
    withHpoSpec(hpoSpec: IHpo.Spec | null): ReliabilityRiskMl.Reconstruction.RandomForestPipe;

    /**
     * {@link Hpo.Experiment} stores the result of hyperparameter optimization to find the best model/pipeline.
     */
    readonly hpoExperiment?: Hpo.Experiment;
    withHpoExperiment(hpoExperiment: IHpo.Experiment | null): ReliabilityRiskMl.Reconstruction.RandomForestPipe;

    /**
     * Reference to the experiment that produced this {@link MlPipe}. For example, this could be a {@link Hpo.ExperimentBase}.
     */
    readonly experiment?: any;
    withExperiment(experiment: any | null): ReliabilityRiskMl.Reconstruction.RandomForestPipe;
    ...
    withModelFiles(modelFiles: Map_Type<string, Url> | {[key: string]: IUrl} | null): ReliabilityRiskMl.Reconstruction.RandomForestPipe;
    ...
    withCustomModelCode(customModelCode: Map_Type<string, any> | {[key: string]: any} | null): ReliabilityRiskMl.Reconstruction.RandomForestPipe;

    /**
     * Name for the function on the native model to call to do {@link MlProcessable#process}.
     */
    readonly processFunc?: string;
    withProcessFunc(processFunc: string | null): ReliabilityRiskMl.Reconstruction.RandomForestPipe;
    ...
    withUnderlyingPipe(underlyingPipe: IMlAtomicPipe<any, any, any> | null): ReliabilityRiskMl.Reconstruction.RandomForestPipe;

    /**
     * The number of trees in the forest. Defaults to 100
     */
    readonly nEstimators?: number;
    withNEstimators(nEstimators: number | null): ReliabilityRiskMl.Reconstruction.RandomForestPipe;

    /**
     * The function to measure the quality of a split.
     */
    readonly criterion?: string;
    withCriterion(criterion: string | null): ReliabilityRiskMl.Reconstruction.RandomForestPipe;
    ...
    withMaxDepth(maxDepth: number | null): ReliabilityRiskMl.Reconstruction.RandomForestPipe;

    /**
     * The minimum number of samples required to split an internal node. Defaults to 2
     */
    readonly minSamplesSplit?: number;
    withMinSamplesSplit(minSamplesSplit: number | null): ReliabilityRiskMl.Reconstruction.RandomForestPipe;

    /**
     * The minimum number of samples required to be at a leaf node. Defaults to 1
     */
    readonly minSamplesLeaf?: number;
    withMinSamplesLeaf(minSamplesLeaf: number | null): ReliabilityRiskMl.Reconstruction.RandomForestPipe;

    /**
     * The minimum weighted fraction of the sum total of weights (of all the input samples) required to be at a leaf node.
     * Defaults to 0
     */
    readonly minWeightFractionLeaf?: number;
    withMinWeightFractionLeaf(minWeightFractionLeaf: number | null): ReliabilityRiskMl.Reconstruction.RandomForestPipe;

    /**
     * The number of features to consider when looking for the best split
     */
    readonly maxFeatures?: string | number;
    withMaxFeatures(maxFeatures: string | number | null): ReliabilityRiskMl.Reconstruction.RandomForestPipe;

    /**
     * Grow trees with max_leaf_nodes in best-first fashion.
     */
    readonly maxLeafNodes?: number;
    withMaxLeafNodes(maxLeafNodes: number | null): ReliabilityRiskMl.Reconstruction.RandomForestPipe;
    ...
    withMinImpurityDecrease(minImpurityDecrease: number | null): ReliabilityRiskMl.Reconstruction.RandomForestPipe;

    /**
     * Whether bootstrap samples are used when building trees. If False, the whole dataset is used to build each tree.
     */
    readonly bootstrap?: boolean;
    withBootstrap(bootstrap: boolean): ReliabilityRiskMl.Reconstruction.RandomForestPipe;

    /**
     * The number of jobs to run in parallel for both fit and predict. If -1, then all processors are used.s
     */
    readonly nJobs?: number;
    withNJobs(nJobs: number | null): ReliabilityRiskMl.Reconstruction.RandomForestPipe;

    /**
     * The seed of the pseudo random number generator that selects a random feature to update
     */
    readonly randomState?: number;
    withRandomState(randomState: number | null): ReliabilityRiskMl.Reconstruction.RandomForestPipe;

    /**
     * Complexity parameter used for Minimal Cost-Complexity Pruning
     */
    readonly ccpAlpha?: number;
    withCcpAlpha(ccpAlpha: number | null): ReliabilityRiskMl.Reconstruction.RandomForestPipe;

    /**
     * If {@link #bootstrap} is True, the number of samples to draw from X to train each base estimator.
     */
    readonly maxSamples?: number;
    withMaxSamples(maxSamples: number | null): ReliabilityRiskMl.Reconstruction.RandomForestPipe;
     ...
     * @see #toJson
     */
    static fromJson(json: any): ReliabilityRiskMl.Reconstruction.RandomForestPipe | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): ReliabilityRiskMl.Reconstruction.RandomForestPipe | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): ReliabilityRiskMl.Reconstruction.RandomForestPipe | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): ReliabilityRiskMl.Reconstruction.RandomForestPipe | null;
     ...
     */
    replaceType(old: Type, new_: Type): ReliabilityRiskMl.Reconstruction.RandomForestPipe;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityRiskMl.Reconstruction.RandomForestPipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityRiskMl.Reconstruction.RandomForestPipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityRiskMl.Reconstruction.RandomForestPipe>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityRiskMl.Reconstruction.RandomForestPipe>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityRiskMl.Reconstruction.RandomForestPipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityRiskMl.Reconstruction.RandomForestPipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityRiskMl.Reconstruction.RandomForestPipe;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): ReliabilityRiskMl.Reconstruction.RandomForestPipe;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): ReliabilityRiskMl.Reconstruction.RandomForestPipe;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityRiskMl.Reconstruction.RandomForestPipe;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityRiskMl.Reconstruction.RandomForestPipe;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityRiskMl.Reconstruction.RandomForestPipe;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): ReliabilityRiskMl.Reconstruction.RandomForestPipe;
     ...
     * @see #removeField
     */
    withoutField(field: string): ReliabilityRiskMl.Reconstruction.RandomForestPipe;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): ReliabilityRiskMl.Reconstruction.RandomForestPipe;
     ...
     */
    withoutFields(fields: Array_Type<string>): ReliabilityRiskMl.Reconstruction.RandomForestPipe;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityRiskMl.Reconstruction.RandomForestPipe;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): ReliabilityRiskMl.Reconstruction.RandomForestPipe;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityRiskMl.Reconstruction.RandomForestPipe;
     ...
     * @see #unsetField
     */
    defaultField(field: string): ReliabilityRiskMl.Reconstruction.RandomForestPipe;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): ReliabilityRiskMl.Reconstruction.RandomForestPipe;
     ...
     * @see #removeField
     */
    unsetField(field: string): ReliabilityRiskMl.Reconstruction.RandomForestPipe;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): ReliabilityRiskMl.Reconstruction.RandomForestPipe;
     ...
     * @see #unsetField
     */
    removeField(field: string): ReliabilityRiskMl.Reconstruction.RandomForestPipe;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): ReliabilityRiskMl.Reconstruction.RandomForestPipe;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityRiskMl.Reconstruction.RandomForestPipe;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityRiskMl.Reconstruction.RandomForestPipe;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityRiskMl.Reconstruction.RandomForestPipe;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityRiskMl.Reconstruction.RandomForestPipe;

    mergeJson(json: any): ReliabilityRiskMl.Reconstruction.RandomForestPipe;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityRiskMl.Reconstruction.RandomForestPipe;
     ...
     */
    sumObj(other: Obj, deep?: boolean): ReliabilityRiskMl.Reconstruction.RandomForestPipe;
     ...
     */
    singletonArray(): Array_Type<ReliabilityRiskMl.Reconstruction.RandomForestPipe>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityRiskMl.Reconstruction.RandomForestPipe> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<ReliabilityRiskMl.Reconstruction.RandomForestPipe> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<ReliabilityRiskMl.Reconstruction.RandomForestPipe>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<ReliabilityRiskMl.Reconstruction.RandomForestPipe> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, ReliabilityRiskMl.Reconstruction.RandomForestPipe> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityRiskMl.Reconstruction.RandomForestPipe> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<ReliabilityRiskMl.Reconstruction.RandomForestPipe>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<ReliabilityRiskMl.Reconstruction.RandomForestPipe>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityRiskMl.Reconstruction.RandomForestPipe;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityRiskMl.Reconstruction.RandomForestPipe;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityRiskMl.Reconstruction.RandomForestPipe;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): ReliabilityRiskMl.Reconstruction.RandomForestPipe;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityRiskMl.Reconstruction.RandomForestPipe;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): ReliabilityRiskMl.Reconstruction.RandomForestPipe;
     ...
     * @see #fromString
     */
    static make(s: string): ReliabilityRiskMl.Reconstruction.RandomForestPipe | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityRiskMl.Reconstruction.RandomForestPipe;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): ReliabilityRiskMl.Reconstruction.RandomForestPipe;
     ...
     */
    static cachedEmptyInst(): ReliabilityRiskMl.Reconstruction.RandomForestPipe;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityRiskMl.Reconstruction.RandomForestPipe> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): ReliabilityRiskMl.Reconstruction.RandomForestPipe;
     ...
     */
    remakeTemplate(): ReliabilityRiskMl.Reconstruction.RandomForestPipe;
     ...
     */
    withoutIdentity(): ReliabilityRiskMl.Reconstruction.RandomForestPipe;
     ...
     */
    train(x: Data, y?: Data, spec?: MlOperationSpec): MlOperationRun<any>;
     ...
     */
    trainSync(x: Data, y?: Data, spec?: MlOperationSpec): ReliabilityRiskMl.Reconstruction.RandomForestPipe;
     ...
     *           the operation run object to query status and to get the final result.
     */
    score(x: Data, y?: Data, context?: , spec?: MlOperationSpec): MlOperationRun<Map_Type<string, number>> | null;

    /**
     * Blocking, synchronous version of {@link #score}.
     */
    scoreSync(x: Data, y?: Data, context?: , spec?: MlOperationSpec): Map_Type<string, number> | null;
     ...
     *           the operation run object to query status and to get the final result.
     */
    scoreAll(x: Data, y?: Data, context?: , spec?: MlOperationSpec): MlOperationRun<Map_Type<string, number>> | null;

    /**
     * Blocking, synchronous version of {@link #scoreAll}.
     */
    scoreAllSync(x: Data, y?: Data, context?: , spec?: MlOperationSpec): Map_Type<string, number> | null;
     ...
     */
    static allCached(doNotProduceAll?: boolean): Stream<ReliabilityRiskMl.Reconstruction.RandomForestPipe> | null;
     ...
     */
    static find(filter?: string, doNotProduceAll?: boolean): Stream<ReliabilityRiskMl.Reconstruction.RandomForestPipe> | null;
     ...
     * @return existing instances of this type that satisfy filter from data cache.
     */
    static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<ReliabilityRiskMl.Reconstruction.RandomForestPipe> | null;
     ...
     * @see getCached
     */
    static findByCacheKey(key: string): ReliabilityRiskMl.Reconstruction.RandomForestPipe | null;
     ...
     * @see findByCacheKey
     */
    static forCacheKey(key: string): ReliabilityRiskMl.Reconstruction.RandomForestPipe | null;
     ...
     * @see findByCacheKey
     */
    getCached(): ReliabilityRiskMl.Reconstruction.RandomForestPipe | null;

    /**
     * @return newly produced cached instance.
     */
    refreshCache(): ReliabilityRiskMl.Reconstruction.RandomForestPipe | null;
     ...
     */
    static produce(key: string): ReliabilityRiskMl.Reconstruction.RandomForestPipe | null;
     ...
     */
    static produceAll(): Map_Type<string, ReliabilityRiskMl.Reconstruction.RandomForestPipe> | null;

    /**
     * Override for sub-types to produce all values.
     */
    static doProduceAll(): Map_Type<string, ReliabilityRiskMl.Reconstruction.RandomForestPipe> | null;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<ReliabilityRiskMl.Reconstruction.RandomForestPipe>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<ReliabilityRiskMl.Reconstruction.RandomForestPipe>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityRiskMl.Reconstruction.RandomForestPipe> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityRiskMl.Reconstruction.RandomForestPipe>> | null;
     ...
     */
    get(include?: string): ReliabilityRiskMl.Reconstruction.RandomForestPipe | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): ReliabilityRiskMl.Reconstruction.RandomForestPipe | null;
     ...
     */
    getMissing(spec: GetMissingSpec): ReliabilityRiskMl.Reconstruction.RandomForestPipe;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): ReliabilityRiskMl.Reconstruction.RandomForestPipe | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): ReliabilityRiskMl.Reconstruction.RandomForestPipe;
     ...
     * @see #toString
     */
    static fromString(s: string): ReliabilityRiskMl.Reconstruction.RandomForestPipe | null;
     ...
     */
    create(spec?: UpsertSpec): ReliabilityRiskMl.Reconstruction.RandomForestPipe | null;
     ...
     */
    static createBatch(objs: Array_Type<ReliabilityRiskMl.Reconstruction.RandomForestPipe>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Reconstruction.RandomForestPipe> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<ReliabilityRiskMl.Reconstruction.RandomForestPipe>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityRiskMl.Reconstruction.RandomForestPipe> | null;
     ...
     */
    update(srcObj?: ReliabilityRiskMl.Reconstruction.RandomForestPipe, spec?: UpsertSpec): ReliabilityRiskMl.Reconstruction.RandomForestPipe | null;
     ...
     */
    upsert(srcObj?: ReliabilityRiskMl.Reconstruction.RandomForestPipe, spec?: UpsertSpec): ReliabilityRiskMl.Reconstruction.RandomForestPipe | null;
     ...
     */
    merge(spec?: MergeSpec): ReliabilityRiskMl.Reconstruction.RandomForestPipe | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): ReliabilityRiskMl.Reconstruction.RandomForestPipe | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): ReliabilityRiskMl.Reconstruction.RandomForestPipe | null;
     ...
     */
    static updateBatch(objs: Array_Type<ReliabilityRiskMl.Reconstruction.RandomForestPipe>, srcObjs?: Array_Type<ReliabilityRiskMl.Reconstruction.RandomForestPipe>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Reconstruction.RandomForestPipe> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<ReliabilityRiskMl.Reconstruction.RandomForestPipe> | null>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Reconstruction.RandomForestPipe> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<ReliabilityRiskMl.Reconstruction.RandomForestPipe>, srcObjs?: Array_Type<ReliabilityRiskMl.Reconstruction.RandomForestPipe>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Reconstruction.RandomForestPipe> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<ReliabilityRiskMl.Reconstruction.RandomForestPipe> | null>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Reconstruction.RandomForestPipe> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<ReliabilityRiskMl.Reconstruction.RandomForestPipe>, spec?: TouchSpec): ObjList<ReliabilityRiskMl.Reconstruction.RandomForestPipe> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityRiskMl.Reconstruction.RandomForestPipe>, spec?: MergeSpec): ObjList<ReliabilityRiskMl.Reconstruction.RandomForestPipe> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityRiskMl.Reconstruction.RandomForestPipe>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityRiskMl.Reconstruction.RandomForestPipe> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<ReliabilityRiskMl.Reconstruction.RandomForestPipe> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityRiskMl.Reconstruction.RandomForestPipe> | null;
     ...
     */
    static mergeAll(mergeObj: ReliabilityRiskMl.Reconstruction.RandomForestPipe, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: ReliabilityRiskMl.Reconstruction.RandomForestPipe, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<ReliabilityRiskMl.Reconstruction.RandomForestPipe>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Reconstruction.RandomForestPipe> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<ReliabilityRiskMl.Reconstruction.RandomForestPipe>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Reconstruction.RandomForestPipe> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): ReliabilityRiskMl.Reconstruction.RandomForestPipe | null;
     ...
     */
    static beforeCreate(objs: Array_Type<ReliabilityRiskMl.Reconstruction.RandomForestPipe>): ObjList<ReliabilityRiskMl.Reconstruction.RandomForestPipe>;
     ...
     */
    static beforeUpdate(objs: Array_Type<ReliabilityRiskMl.Reconstruction.RandomForestPipe>): ObjList<ReliabilityRiskMl.Reconstruction.RandomForestPipe>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<ReliabilityRiskMl.Reconstruction.RandomForestPipe>): ObjList<ReliabilityRiskMl.Reconstruction.RandomForestPipe>;
     ...
     */
    static afterCreate(objs: Array_Type<ReliabilityRiskMl.Reconstruction.RandomForestPipe>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<ReliabilityRiskMl.Reconstruction.RandomForestPipe>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<ReliabilityRiskMl.Reconstruction.RandomForestPipe>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityRiskMl.Reconstruction.RandomForestPipe>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityRiskMl.Reconstruction.RandomForestPipe>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): ReliabilityRiskMl.Reconstruction.RandomForestPipe | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<ReliabilityRiskMl.Reconstruction.RandomForestPipe>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: ReliabilityRiskMl.Reconstruction.RandomForestPipe, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<ReliabilityRiskMl.Reconstruction.RandomForestPipe>, callback?: λFunction<ReliabilityRiskMl.Reconstruction.RandomForestPipe | null, ReliabilityRiskMl.Reconstruction.RandomForestPipe | null>): ObjList<ReliabilityRiskMl.Reconstruction.RandomForestPipe>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<ReliabilityRiskMl.Reconstruction.RandomForestPipe>, callback?: λFunction<ReliabilityRiskMl.Reconstruction.RandomForestPipe | null, ReliabilityRiskMl.Reconstruction.RandomForestPipe | null>): Array_Type<ObjError> | null;
     ...
     */
    publish(subPath?: string, contentType?: string): ReliabilityRiskMl.Reconstruction.RandomForestPipe;
     ...
     */
    static removeSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Reconstruction.RandomForestPipe> | null;
     ...
     */
    createSeedData(spec?: UpsertSpec): ReliabilityRiskMl.Reconstruction.RandomForestPipe | null;
     ...
     */
    static createSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Reconstruction.RandomForestPipe> | null;
     ...
     */
    updateSeedData(srcObj?: SeedData, spec?: UpsertSpec): ReliabilityRiskMl.Reconstruction.RandomForestPipe | null;
     ...
     */
    static updateSeedDataBatch(objs?: Array_Type<SeedData>, srcObjs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Reconstruction.RandomForestPipe> | null;
     ...
     * @return updated obj instance, same as {@link Persistable#update} return value.
     */
    clearUserUpdates(spec?: MergeSpec): ReliabilityRiskMl.Reconstruction.RandomForestPipe | null;
     ...
     *         {@link Persistable#updateBatch}.
     */
    static clearUserUpdatesBatch(objs?: Array_Type<SeedData>, spec?: MergeSpec): ObjList<ReliabilityRiskMl.Reconstruction.RandomForestPipe> | null;
    ...
    dependencies(): SeedDataDeps<ReliabilityRiskMl.Reconstruction.RandomForestPipe> | null;
     ...
     */
    static convert(model: any, spec?: MlConvertSpec): ReliabilityRiskMl.Reconstruction.RandomForestPipe;

    /**
     * Freezes an {@link MlPipe}
     * @return modified copy of this {@link MlPipe} that cannot be trained
     */
    freeze(): ReliabilityRiskMl.Reconstruction.RandomForestPipe;

    /**
     * Unfreezes an {@link MlPipe}
     * @return modified copy of this {@link MlPipe} that can be trained
     */
    unfreeze(): ReliabilityRiskMl.Reconstruction.RandomForestPipe;
     ...
     */
    newAuthoringVertex(x?: Data, y?: Data, context?: , suffix?: string = '""', spec?: MlConvertSpec): MlPipeline.PipeVertex.Authoring;
     ...
     * be returned as-is.
     */
    byReference(): ReliabilityRiskMl.Reconstruction.RandomForestPipe;
     ...
     */
    updateModelFiles(modelFiles: Map_Type<string, Url>, spec?: MlOperationSpec): ReliabilityRiskMl.Reconstruction.RandomForestPipe;
     ...
     */
    afterTrain(doTrainOutputs: any, spec?: MlOperationSpec): ReliabilityRiskMl.Reconstruction.RandomForestPipe;
     ...
     */
    convertPipeInputsToNative(x: Data, y?: Data, spec?: MlOperationSpec): any;
     ...
     * @return converted data.
     */
    convertYToNative(y: Data, spec?: MlOperationSpec): any;
     ...
     */
    withNewSpec(spec?: MlConvertSpec): ReliabilityRiskMl.Reconstruction.RandomForestPipe;
     ...
     */
    afterConvert(model: any, spec?: MlConvertSpec): ReliabilityRiskMl.Reconstruction.RandomForestPipe;
     ...
     */
    withHyperparamSpaces(paramSpaces: Map_Type<string, Hp.ParamSpace>): ReliabilityRiskMl.Reconstruction.RandomForestPipe;
