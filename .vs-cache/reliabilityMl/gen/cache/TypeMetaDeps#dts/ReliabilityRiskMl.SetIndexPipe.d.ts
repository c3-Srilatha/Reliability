// TypeScript definitions for the C3 type ReliabilityRiskMl.SetIndexPipe

/**
 * This type represents an {@link MlPipe} template for a data operation that takes in a {@link Data} object
 * and returns a {@link Data} object with the `subject` and `timestamp` set as index columns, if they haven't
 * been set already.
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityRiskMl.SetIndexPipe
 */
declare namespace ReliabilityRiskMl {
  export interface ISetIndexPipe {
 ...
 * been set already.
 *
 * @remarks this represents a made instance of ReliabilityRiskMl.SetIndexPipe
 */
declare namespace ReliabilityRiskMl {
  export class SetIndexPipe extends Obj  {
     ...
     */
    readonly id: string;
    withId(id: string): ReliabilityRiskMl.SetIndexPipe;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityRiskMl.SetIndexPipe;

    /**
     * Name of this pipe.
     */
    readonly name?: string;
    withName(name: string | null): ReliabilityRiskMl.SetIndexPipe;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): ReliabilityRiskMl.SetIndexPipe;
    ...
    withVersion(version: number | null): ReliabilityRiskMl.SetIndexPipe;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): ReliabilityRiskMl.SetIndexPipe;
    ...
    withUserUpdatedFields(userUpdatedFields: Array_Type<string> | Array<string> | null): ReliabilityRiskMl.SetIndexPipe;
    ...
    withHidden(hidden: boolean): ReliabilityRiskMl.SetIndexPipe;
    ...
    withUserOwned(userOwned: boolean): ReliabilityRiskMl.SetIndexPipe;
    ...
    withTypeIdent(typeIdent: string | null): ReliabilityRiskMl.SetIndexPipe;

    /**
     * If true, then the pipe shall not be retrained
     */
    readonly frozen?: boolean;
    withFrozen(frozen: boolean): ReliabilityRiskMl.SetIndexPipe;

    /**
     * True if training has succeeded and false otherwise.
     */
    readonly trained?: boolean;
    withTrained(trained: boolean): ReliabilityRiskMl.SetIndexPipe;

    /**
     * Errors from training.
     */
    readonly trainingErrors?: string;
    withTrainingErrors(trainingErrors: string | null): ReliabilityRiskMl.SetIndexPipe;

    /**
     * If true, the underlying model only accepts flattened input.
     */
    readonly flattenInput?: boolean;
    withFlattenInput(flattenInput: boolean): ReliabilityRiskMl.SetIndexPipe;

    /**
     * The hyperparameters overridden of a native model or pipe.
     */
    readonly hyperparamOverrides?: Map_Type<string, any>;
    withHyperparamOverrides(hyperparamOverrides: Map_Type<string, any> | {[key: string]: any} | null): ReliabilityRiskMl.SetIndexPipe;
    ...
    withHyperparamSearchSpace(hyperparamSearchSpace: IHp.SearchSpace | null): ReliabilityRiskMl.SetIndexPipe;
    ...
    withHpoSpec(hpoSpec: IHpo.Spec | null): ReliabilityRiskMl.SetIndexPipe;

    /**
     * {@link Hpo.Experiment} stores the result of hyperparameter optimization to find the best model/pipeline.
     */
    readonly hpoExperiment?: Hpo.Experiment;
    withHpoExperiment(hpoExperiment: IHpo.Experiment | null): ReliabilityRiskMl.SetIndexPipe;

    /**
     * Reference to the experiment that produced this {@link MlPipe}. For example, this could be a {@link Hpo.ExperimentBase}.
     */
    readonly experiment?: any;
    withExperiment(experiment: any | null): ReliabilityRiskMl.SetIndexPipe;
    ...
    withModelFiles(modelFiles: Map_Type<string, Url> | {[key: string]: IUrl} | null): ReliabilityRiskMl.SetIndexPipe;
    ...
    withCustomModelCode(customModelCode: Map_Type<string, any> | {[key: string]: any} | null): ReliabilityRiskMl.SetIndexPipe;

    /**
     * Name for the function on the native model to call to do {@link MlProcessable#process}.
     */
    readonly processFunc?: string;
    withProcessFunc(processFunc: string | null): ReliabilityRiskMl.SetIndexPipe;
    ...
    withUnderlyingPipe(underlyingPipe: IMlAtomicPipe<any, any, any> | null): ReliabilityRiskMl.SetIndexPipe;
     ...
     * @see #toJson
     */
    static fromJson(json: any): ReliabilityRiskMl.SetIndexPipe | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): ReliabilityRiskMl.SetIndexPipe | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): ReliabilityRiskMl.SetIndexPipe | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): ReliabilityRiskMl.SetIndexPipe | null;
     ...
     */
    replaceType(old: Type, new_: Type): ReliabilityRiskMl.SetIndexPipe;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityRiskMl.SetIndexPipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityRiskMl.SetIndexPipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityRiskMl.SetIndexPipe>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityRiskMl.SetIndexPipe>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityRiskMl.SetIndexPipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityRiskMl.SetIndexPipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityRiskMl.SetIndexPipe;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): ReliabilityRiskMl.SetIndexPipe;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): ReliabilityRiskMl.SetIndexPipe;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityRiskMl.SetIndexPipe;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityRiskMl.SetIndexPipe;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityRiskMl.SetIndexPipe;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): ReliabilityRiskMl.SetIndexPipe;
     ...
     * @see #removeField
     */
    withoutField(field: string): ReliabilityRiskMl.SetIndexPipe;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): ReliabilityRiskMl.SetIndexPipe;
     ...
     */
    withoutFields(fields: Array_Type<string>): ReliabilityRiskMl.SetIndexPipe;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityRiskMl.SetIndexPipe;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): ReliabilityRiskMl.SetIndexPipe;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityRiskMl.SetIndexPipe;
     ...
     * @see #unsetField
     */
    defaultField(field: string): ReliabilityRiskMl.SetIndexPipe;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): ReliabilityRiskMl.SetIndexPipe;
     ...
     * @see #removeField
     */
    unsetField(field: string): ReliabilityRiskMl.SetIndexPipe;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): ReliabilityRiskMl.SetIndexPipe;
     ...
     * @see #unsetField
     */
    removeField(field: string): ReliabilityRiskMl.SetIndexPipe;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): ReliabilityRiskMl.SetIndexPipe;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityRiskMl.SetIndexPipe;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityRiskMl.SetIndexPipe;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityRiskMl.SetIndexPipe;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityRiskMl.SetIndexPipe;

    mergeJson(json: any): ReliabilityRiskMl.SetIndexPipe;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityRiskMl.SetIndexPipe;
     ...
     */
    sumObj(other: Obj, deep?: boolean): ReliabilityRiskMl.SetIndexPipe;
     ...
     */
    singletonArray(): Array_Type<ReliabilityRiskMl.SetIndexPipe>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityRiskMl.SetIndexPipe> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<ReliabilityRiskMl.SetIndexPipe> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<ReliabilityRiskMl.SetIndexPipe>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<ReliabilityRiskMl.SetIndexPipe> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, ReliabilityRiskMl.SetIndexPipe> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityRiskMl.SetIndexPipe> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<ReliabilityRiskMl.SetIndexPipe>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<ReliabilityRiskMl.SetIndexPipe>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityRiskMl.SetIndexPipe;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityRiskMl.SetIndexPipe;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityRiskMl.SetIndexPipe;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): ReliabilityRiskMl.SetIndexPipe;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityRiskMl.SetIndexPipe;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): ReliabilityRiskMl.SetIndexPipe;
     ...
     * @see #fromString
     */
    static make(s: string): ReliabilityRiskMl.SetIndexPipe | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityRiskMl.SetIndexPipe;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): ReliabilityRiskMl.SetIndexPipe;
     ...
     */
    static cachedEmptyInst(): ReliabilityRiskMl.SetIndexPipe;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityRiskMl.SetIndexPipe> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): ReliabilityRiskMl.SetIndexPipe;
     ...
     */
    remakeTemplate(): ReliabilityRiskMl.SetIndexPipe;
     ...
     */
    withoutIdentity(): ReliabilityRiskMl.SetIndexPipe;
     ...
     */
    trainSync(x: Data, y?: , spec?: MlOperationSpec): ReliabilityRiskMl.SetIndexPipe;
     ...
     */
    static allCached(doNotProduceAll?: boolean): Stream<ReliabilityRiskMl.SetIndexPipe> | null;
     ...
     */
    static find(filter?: string, doNotProduceAll?: boolean): Stream<ReliabilityRiskMl.SetIndexPipe> | null;
     ...
     * @return existing instances of this type that satisfy filter from data cache.
     */
    static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<ReliabilityRiskMl.SetIndexPipe> | null;
     ...
     * @see getCached
     */
    static findByCacheKey(key: string): ReliabilityRiskMl.SetIndexPipe | null;
     ...
     * @see findByCacheKey
     */
    static forCacheKey(key: string): ReliabilityRiskMl.SetIndexPipe | null;
     ...
     * @see findByCacheKey
     */
    getCached(): ReliabilityRiskMl.SetIndexPipe | null;

    /**
     * @return newly produced cached instance.
     */
    refreshCache(): ReliabilityRiskMl.SetIndexPipe | null;
     ...
     */
    static produce(key: string): ReliabilityRiskMl.SetIndexPipe | null;
     ...
     */
    static produceAll(): Map_Type<string, ReliabilityRiskMl.SetIndexPipe> | null;

    /**
     * Override for sub-types to produce all values.
     */
    static doProduceAll(): Map_Type<string, ReliabilityRiskMl.SetIndexPipe> | null;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<ReliabilityRiskMl.SetIndexPipe>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<ReliabilityRiskMl.SetIndexPipe>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityRiskMl.SetIndexPipe> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityRiskMl.SetIndexPipe>> | null;
     ...
     */
    get(include?: string): ReliabilityRiskMl.SetIndexPipe | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): ReliabilityRiskMl.SetIndexPipe | null;
     ...
     */
    getMissing(spec: GetMissingSpec): ReliabilityRiskMl.SetIndexPipe;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): ReliabilityRiskMl.SetIndexPipe | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): ReliabilityRiskMl.SetIndexPipe;
     ...
     * @see #toString
     */
    static fromString(s: string): ReliabilityRiskMl.SetIndexPipe | null;
     ...
     */
    create(spec?: UpsertSpec): ReliabilityRiskMl.SetIndexPipe | null;
     ...
     */
    static createBatch(objs: Array_Type<ReliabilityRiskMl.SetIndexPipe>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.SetIndexPipe> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<ReliabilityRiskMl.SetIndexPipe>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityRiskMl.SetIndexPipe> | null;
     ...
     */
    update(srcObj?: ReliabilityRiskMl.SetIndexPipe, spec?: UpsertSpec): ReliabilityRiskMl.SetIndexPipe | null;
     ...
     */
    upsert(srcObj?: ReliabilityRiskMl.SetIndexPipe, spec?: UpsertSpec): ReliabilityRiskMl.SetIndexPipe | null;
     ...
     */
    merge(spec?: MergeSpec): ReliabilityRiskMl.SetIndexPipe | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): ReliabilityRiskMl.SetIndexPipe | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): ReliabilityRiskMl.SetIndexPipe | null;
     ...
     */
    static updateBatch(objs: Array_Type<ReliabilityRiskMl.SetIndexPipe>, srcObjs?: Array_Type<ReliabilityRiskMl.SetIndexPipe>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.SetIndexPipe> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<ReliabilityRiskMl.SetIndexPipe> | null>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.SetIndexPipe> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<ReliabilityRiskMl.SetIndexPipe>, srcObjs?: Array_Type<ReliabilityRiskMl.SetIndexPipe>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.SetIndexPipe> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<ReliabilityRiskMl.SetIndexPipe> | null>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.SetIndexPipe> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<ReliabilityRiskMl.SetIndexPipe>, spec?: TouchSpec): ObjList<ReliabilityRiskMl.SetIndexPipe> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityRiskMl.SetIndexPipe>, spec?: MergeSpec): ObjList<ReliabilityRiskMl.SetIndexPipe> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityRiskMl.SetIndexPipe>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityRiskMl.SetIndexPipe> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<ReliabilityRiskMl.SetIndexPipe> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityRiskMl.SetIndexPipe> | null;
     ...
     */
    static mergeAll(mergeObj: ReliabilityRiskMl.SetIndexPipe, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: ReliabilityRiskMl.SetIndexPipe, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<ReliabilityRiskMl.SetIndexPipe>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.SetIndexPipe> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<ReliabilityRiskMl.SetIndexPipe>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.SetIndexPipe> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): ReliabilityRiskMl.SetIndexPipe | null;
     ...
     */
    static beforeCreate(objs: Array_Type<ReliabilityRiskMl.SetIndexPipe>): ObjList<ReliabilityRiskMl.SetIndexPipe>;
     ...
     */
    static beforeUpdate(objs: Array_Type<ReliabilityRiskMl.SetIndexPipe>): ObjList<ReliabilityRiskMl.SetIndexPipe>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<ReliabilityRiskMl.SetIndexPipe>): ObjList<ReliabilityRiskMl.SetIndexPipe>;
     ...
     */
    static afterCreate(objs: Array_Type<ReliabilityRiskMl.SetIndexPipe>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<ReliabilityRiskMl.SetIndexPipe>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<ReliabilityRiskMl.SetIndexPipe>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityRiskMl.SetIndexPipe>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityRiskMl.SetIndexPipe>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): ReliabilityRiskMl.SetIndexPipe | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<ReliabilityRiskMl.SetIndexPipe>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: ReliabilityRiskMl.SetIndexPipe, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<ReliabilityRiskMl.SetIndexPipe>, callback?: λFunction<ReliabilityRiskMl.SetIndexPipe | null, ReliabilityRiskMl.SetIndexPipe | null>): ObjList<ReliabilityRiskMl.SetIndexPipe>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<ReliabilityRiskMl.SetIndexPipe>, callback?: λFunction<ReliabilityRiskMl.SetIndexPipe | null, ReliabilityRiskMl.SetIndexPipe | null>): Array_Type<ObjError> | null;
     ...
     */
    publish(subPath?: string, contentType?: string): ReliabilityRiskMl.SetIndexPipe;
     ...
     */
    static removeSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.SetIndexPipe> | null;
     ...
     */
    createSeedData(spec?: UpsertSpec): ReliabilityRiskMl.SetIndexPipe | null;
     ...
     */
    static createSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.SetIndexPipe> | null;
     ...
     */
    updateSeedData(srcObj?: SeedData, spec?: UpsertSpec): ReliabilityRiskMl.SetIndexPipe | null;
     ...
     */
    static updateSeedDataBatch(objs?: Array_Type<SeedData>, srcObjs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.SetIndexPipe> | null;
     ...
     * @return updated obj instance, same as {@link Persistable#update} return value.
     */
    clearUserUpdates(spec?: MergeSpec): ReliabilityRiskMl.SetIndexPipe | null;
     ...
     *         {@link Persistable#updateBatch}.
     */
    static clearUserUpdatesBatch(objs?: Array_Type<SeedData>, spec?: MergeSpec): ObjList<ReliabilityRiskMl.SetIndexPipe> | null;
    ...
    dependencies(): SeedDataDeps<ReliabilityRiskMl.SetIndexPipe> | null;
     ...
     * be returned as-is.
     */
    byReference(): ReliabilityRiskMl.SetIndexPipe;
     ...
     */
    updateModelFiles(modelFiles: Map_Type<string, Url>, spec?: MlOperationSpec): ReliabilityRiskMl.SetIndexPipe;
     ...
     */
    afterTrain(doTrainOutputs: any, spec?: MlOperationSpec): ReliabilityRiskMl.SetIndexPipe;
     ...
     */
    withNewSpec(spec?: MlConvertSpec): ReliabilityRiskMl.SetIndexPipe;
     ...
     */
    afterConvert(model: any, spec?: MlConvertSpec): ReliabilityRiskMl.SetIndexPipe;
     ...
     */
    withHyperparamSpaces(paramSpaces: Map_Type<string, Hp.ParamSpace>): ReliabilityRiskMl.SetIndexPipe;
