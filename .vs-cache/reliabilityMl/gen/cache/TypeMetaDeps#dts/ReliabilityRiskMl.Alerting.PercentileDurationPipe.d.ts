// TypeScript definitions for the C3 type ReliabilityRiskMl.Alerting.PercentileDurationPipe
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityRiskMl.Alerting.PercentileDurationPipe
 */
declare namespace ReliabilityRiskMl.Alerting {
  export interface IPercentileDurationPipe {
 ...
 */
declare namespace ReliabilityRiskMl.Alerting {
  export class PercentileDurationPipe extends Obj  {
     ...
     */
    readonly id: string;
    withId(id: string): ReliabilityRiskMl.Alerting.PercentileDurationPipe;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityRiskMl.Alerting.PercentileDurationPipe;

    /**
     * Name of this pipe.
     */
    readonly name?: string;
    withName(name: string | null): ReliabilityRiskMl.Alerting.PercentileDurationPipe;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): ReliabilityRiskMl.Alerting.PercentileDurationPipe;
    ...
    withVersion(version: number | null): ReliabilityRiskMl.Alerting.PercentileDurationPipe;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): ReliabilityRiskMl.Alerting.PercentileDurationPipe;
    ...
    withUserUpdatedFields(userUpdatedFields: Array_Type<string> | Array<string> | null): ReliabilityRiskMl.Alerting.PercentileDurationPipe;
    ...
    withHidden(hidden: boolean): ReliabilityRiskMl.Alerting.PercentileDurationPipe;
    ...
    withUserOwned(userOwned: boolean): ReliabilityRiskMl.Alerting.PercentileDurationPipe;
    ...
    withTypeIdent(typeIdent: string | null): ReliabilityRiskMl.Alerting.PercentileDurationPipe;

    /**
     * If true, then the pipe shall not be retrained
     */
    readonly frozen?: boolean;
    withFrozen(frozen: boolean): ReliabilityRiskMl.Alerting.PercentileDurationPipe;

    /**
     * True if training has succeeded and false otherwise.
     */
    readonly trained?: boolean;
    withTrained(trained: boolean): ReliabilityRiskMl.Alerting.PercentileDurationPipe;

    /**
     * Errors from training.
     */
    readonly trainingErrors?: string;
    withTrainingErrors(trainingErrors: string | null): ReliabilityRiskMl.Alerting.PercentileDurationPipe;

    /**
     * If true, the underlying model only accepts flattened input.
     */
    readonly flattenInput?: boolean;
    withFlattenInput(flattenInput: boolean): ReliabilityRiskMl.Alerting.PercentileDurationPipe;

    /**
     * The hyperparameters overridden of a native model or pipe.
     */
    readonly hyperparamOverrides?: Map_Type<string, any>;
    withHyperparamOverrides(hyperparamOverrides: Map_Type<string, any> | {[key: string]: any} | null): ReliabilityRiskMl.Alerting.PercentileDurationPipe;
    ...
    withHyperparamSearchSpace(hyperparamSearchSpace: IHp.SearchSpace | null): ReliabilityRiskMl.Alerting.PercentileDurationPipe;
    ...
    withHpoSpec(hpoSpec: IHpo.Spec | null): ReliabilityRiskMl.Alerting.PercentileDurationPipe;

    /**
     * {@link Hpo.Experiment} stores the result of hyperparameter optimization to find the best model/pipeline.
     */
    readonly hpoExperiment?: Hpo.Experiment;
    withHpoExperiment(hpoExperiment: IHpo.Experiment | null): ReliabilityRiskMl.Alerting.PercentileDurationPipe;

    /**
     * Reference to the experiment that produced this {@link MlPipe}. For example, this could be a {@link Hpo.ExperimentBase}.
     */
    readonly experiment?: any;
    withExperiment(experiment: any | null): ReliabilityRiskMl.Alerting.PercentileDurationPipe;
    ...
    withModelFiles(modelFiles: Map_Type<string, Url> | {[key: string]: IUrl} | null): ReliabilityRiskMl.Alerting.PercentileDurationPipe;
    ...
    withCustomModelCode(customModelCode: Map_Type<string, any> | {[key: string]: any} | null): ReliabilityRiskMl.Alerting.PercentileDurationPipe;

    /**
     * Name for the function on the native model to call to do {@link MlProcessable#process}.
     */
    readonly processFunc?: string;
    withProcessFunc(processFunc: string | null): ReliabilityRiskMl.Alerting.PercentileDurationPipe;
    ...
    withUnderlyingPipe(underlyingPipe: IMlAtomicPipe<any, any, any> | null): ReliabilityRiskMl.Alerting.PercentileDurationPipe;
    ...
    withLookbackDuration(lookbackDuration: IDuration | null): ReliabilityRiskMl.Alerting.PercentileDurationPipe;
    ...
    withRiskScoreColumnName(riskScoreColumnName: string): ReliabilityRiskMl.Alerting.PercentileDurationPipe;
    ...
    withAlertPercentile(alertPercentile: number | null): ReliabilityRiskMl.Alerting.PercentileDurationPipe;
    ...
    withAlertThreshold(alertThreshold: number | null): ReliabilityRiskMl.Alerting.PercentileDurationPipe;
    ...
    withIgnoreSpan(ignoreSpan: number | null): ReliabilityRiskMl.Alerting.PercentileDurationPipe;
    ...
    withReminderSpan(reminderSpan: number | null): ReliabilityRiskMl.Alerting.PercentileDurationPipe;
    ...
    withMergeSpan(mergeSpan: number | null): ReliabilityRiskMl.Alerting.PercentileDurationPipe;
    ...
    withInterval(interval: number | null): ReliabilityRiskMl.Alerting.PercentileDurationPipe;
    ...
    withMergeOnActualAlert(mergeOnActualAlert: boolean): ReliabilityRiskMl.Alerting.PercentileDurationPipe;
     ...
     * @see #toJson
     */
    static fromJson(json: any): ReliabilityRiskMl.Alerting.PercentileDurationPipe | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): ReliabilityRiskMl.Alerting.PercentileDurationPipe | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): ReliabilityRiskMl.Alerting.PercentileDurationPipe | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): ReliabilityRiskMl.Alerting.PercentileDurationPipe | null;
     ...
     */
    replaceType(old: Type, new_: Type): ReliabilityRiskMl.Alerting.PercentileDurationPipe;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityRiskMl.Alerting.PercentileDurationPipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityRiskMl.Alerting.PercentileDurationPipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityRiskMl.Alerting.PercentileDurationPipe>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityRiskMl.Alerting.PercentileDurationPipe>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityRiskMl.Alerting.PercentileDurationPipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityRiskMl.Alerting.PercentileDurationPipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityRiskMl.Alerting.PercentileDurationPipe;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): ReliabilityRiskMl.Alerting.PercentileDurationPipe;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): ReliabilityRiskMl.Alerting.PercentileDurationPipe;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityRiskMl.Alerting.PercentileDurationPipe;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityRiskMl.Alerting.PercentileDurationPipe;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityRiskMl.Alerting.PercentileDurationPipe;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): ReliabilityRiskMl.Alerting.PercentileDurationPipe;
     ...
     * @see #removeField
     */
    withoutField(field: string): ReliabilityRiskMl.Alerting.PercentileDurationPipe;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): ReliabilityRiskMl.Alerting.PercentileDurationPipe;
     ...
     */
    withoutFields(fields: Array_Type<string>): ReliabilityRiskMl.Alerting.PercentileDurationPipe;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityRiskMl.Alerting.PercentileDurationPipe;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): ReliabilityRiskMl.Alerting.PercentileDurationPipe;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityRiskMl.Alerting.PercentileDurationPipe;
     ...
     * @see #unsetField
     */
    defaultField(field: string): ReliabilityRiskMl.Alerting.PercentileDurationPipe;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): ReliabilityRiskMl.Alerting.PercentileDurationPipe;
     ...
     * @see #removeField
     */
    unsetField(field: string): ReliabilityRiskMl.Alerting.PercentileDurationPipe;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): ReliabilityRiskMl.Alerting.PercentileDurationPipe;
     ...
     * @see #unsetField
     */
    removeField(field: string): ReliabilityRiskMl.Alerting.PercentileDurationPipe;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): ReliabilityRiskMl.Alerting.PercentileDurationPipe;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityRiskMl.Alerting.PercentileDurationPipe;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityRiskMl.Alerting.PercentileDurationPipe;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityRiskMl.Alerting.PercentileDurationPipe;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityRiskMl.Alerting.PercentileDurationPipe;

    mergeJson(json: any): ReliabilityRiskMl.Alerting.PercentileDurationPipe;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityRiskMl.Alerting.PercentileDurationPipe;
     ...
     */
    sumObj(other: Obj, deep?: boolean): ReliabilityRiskMl.Alerting.PercentileDurationPipe;
     ...
     */
    singletonArray(): Array_Type<ReliabilityRiskMl.Alerting.PercentileDurationPipe>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityRiskMl.Alerting.PercentileDurationPipe> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<ReliabilityRiskMl.Alerting.PercentileDurationPipe> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<ReliabilityRiskMl.Alerting.PercentileDurationPipe>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<ReliabilityRiskMl.Alerting.PercentileDurationPipe> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, ReliabilityRiskMl.Alerting.PercentileDurationPipe> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityRiskMl.Alerting.PercentileDurationPipe> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<ReliabilityRiskMl.Alerting.PercentileDurationPipe>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<ReliabilityRiskMl.Alerting.PercentileDurationPipe>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityRiskMl.Alerting.PercentileDurationPipe;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityRiskMl.Alerting.PercentileDurationPipe;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityRiskMl.Alerting.PercentileDurationPipe;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): ReliabilityRiskMl.Alerting.PercentileDurationPipe;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityRiskMl.Alerting.PercentileDurationPipe;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): ReliabilityRiskMl.Alerting.PercentileDurationPipe;
     ...
     * @see #fromString
     */
    static make(s: string): ReliabilityRiskMl.Alerting.PercentileDurationPipe | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityRiskMl.Alerting.PercentileDurationPipe;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): ReliabilityRiskMl.Alerting.PercentileDurationPipe;
     ...
     */
    static cachedEmptyInst(): ReliabilityRiskMl.Alerting.PercentileDurationPipe;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityRiskMl.Alerting.PercentileDurationPipe> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): ReliabilityRiskMl.Alerting.PercentileDurationPipe;
     ...
     */
    remakeTemplate(): ReliabilityRiskMl.Alerting.PercentileDurationPipe;
     ...
     */
    withoutIdentity(): ReliabilityRiskMl.Alerting.PercentileDurationPipe;
     ...
     */
    trainSync(x: , y?: , spec?: MlOperationSpec): ReliabilityRiskMl.Alerting.PercentileDurationPipe;
     ...
     */
    static allCached(doNotProduceAll?: boolean): Stream<ReliabilityRiskMl.Alerting.PercentileDurationPipe> | null;
     ...
     */
    static find(filter?: string, doNotProduceAll?: boolean): Stream<ReliabilityRiskMl.Alerting.PercentileDurationPipe> | null;
     ...
     * @return existing instances of this type that satisfy filter from data cache.
     */
    static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<ReliabilityRiskMl.Alerting.PercentileDurationPipe> | null;
     ...
     * @see getCached
     */
    static findByCacheKey(key: string): ReliabilityRiskMl.Alerting.PercentileDurationPipe | null;
     ...
     * @see findByCacheKey
     */
    static forCacheKey(key: string): ReliabilityRiskMl.Alerting.PercentileDurationPipe | null;
     ...
     * @see findByCacheKey
     */
    getCached(): ReliabilityRiskMl.Alerting.PercentileDurationPipe | null;

    /**
     * @return newly produced cached instance.
     */
    refreshCache(): ReliabilityRiskMl.Alerting.PercentileDurationPipe | null;
     ...
     */
    static produce(key: string): ReliabilityRiskMl.Alerting.PercentileDurationPipe | null;
     ...
     */
    static produceAll(): Map_Type<string, ReliabilityRiskMl.Alerting.PercentileDurationPipe> | null;

    /**
     * Override for sub-types to produce all values.
     */
    static doProduceAll(): Map_Type<string, ReliabilityRiskMl.Alerting.PercentileDurationPipe> | null;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<ReliabilityRiskMl.Alerting.PercentileDurationPipe>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<ReliabilityRiskMl.Alerting.PercentileDurationPipe>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityRiskMl.Alerting.PercentileDurationPipe> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityRiskMl.Alerting.PercentileDurationPipe>> | null;
     ...
     */
    get(include?: string): ReliabilityRiskMl.Alerting.PercentileDurationPipe | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): ReliabilityRiskMl.Alerting.PercentileDurationPipe | null;
     ...
     */
    getMissing(spec: GetMissingSpec): ReliabilityRiskMl.Alerting.PercentileDurationPipe;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): ReliabilityRiskMl.Alerting.PercentileDurationPipe | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): ReliabilityRiskMl.Alerting.PercentileDurationPipe;
     ...
     * @see #toString
     */
    static fromString(s: string): ReliabilityRiskMl.Alerting.PercentileDurationPipe | null;
     ...
     */
    create(spec?: UpsertSpec): ReliabilityRiskMl.Alerting.PercentileDurationPipe | null;
     ...
     */
    static createBatch(objs: Array_Type<ReliabilityRiskMl.Alerting.PercentileDurationPipe>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Alerting.PercentileDurationPipe> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<ReliabilityRiskMl.Alerting.PercentileDurationPipe>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityRiskMl.Alerting.PercentileDurationPipe> | null;
     ...
     */
    update(srcObj?: ReliabilityRiskMl.Alerting.PercentileDurationPipe, spec?: UpsertSpec): ReliabilityRiskMl.Alerting.PercentileDurationPipe | null;
     ...
     */
    upsert(srcObj?: ReliabilityRiskMl.Alerting.PercentileDurationPipe, spec?: UpsertSpec): ReliabilityRiskMl.Alerting.PercentileDurationPipe | null;
     ...
     */
    merge(spec?: MergeSpec): ReliabilityRiskMl.Alerting.PercentileDurationPipe | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): ReliabilityRiskMl.Alerting.PercentileDurationPipe | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): ReliabilityRiskMl.Alerting.PercentileDurationPipe | null;
     ...
     */
    static updateBatch(objs: Array_Type<ReliabilityRiskMl.Alerting.PercentileDurationPipe>, srcObjs?: Array_Type<ReliabilityRiskMl.Alerting.PercentileDurationPipe>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Alerting.PercentileDurationPipe> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<ReliabilityRiskMl.Alerting.PercentileDurationPipe> | null>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Alerting.PercentileDurationPipe> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<ReliabilityRiskMl.Alerting.PercentileDurationPipe>, srcObjs?: Array_Type<ReliabilityRiskMl.Alerting.PercentileDurationPipe>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Alerting.PercentileDurationPipe> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<ReliabilityRiskMl.Alerting.PercentileDurationPipe> | null>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Alerting.PercentileDurationPipe> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<ReliabilityRiskMl.Alerting.PercentileDurationPipe>, spec?: TouchSpec): ObjList<ReliabilityRiskMl.Alerting.PercentileDurationPipe> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityRiskMl.Alerting.PercentileDurationPipe>, spec?: MergeSpec): ObjList<ReliabilityRiskMl.Alerting.PercentileDurationPipe> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityRiskMl.Alerting.PercentileDurationPipe>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityRiskMl.Alerting.PercentileDurationPipe> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<ReliabilityRiskMl.Alerting.PercentileDurationPipe> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityRiskMl.Alerting.PercentileDurationPipe> | null;
     ...
     */
    static mergeAll(mergeObj: ReliabilityRiskMl.Alerting.PercentileDurationPipe, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: ReliabilityRiskMl.Alerting.PercentileDurationPipe, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<ReliabilityRiskMl.Alerting.PercentileDurationPipe>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Alerting.PercentileDurationPipe> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<ReliabilityRiskMl.Alerting.PercentileDurationPipe>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Alerting.PercentileDurationPipe> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): ReliabilityRiskMl.Alerting.PercentileDurationPipe | null;
     ...
     */
    static beforeCreate(objs: Array_Type<ReliabilityRiskMl.Alerting.PercentileDurationPipe>): ObjList<ReliabilityRiskMl.Alerting.PercentileDurationPipe>;
     ...
     */
    static beforeUpdate(objs: Array_Type<ReliabilityRiskMl.Alerting.PercentileDurationPipe>): ObjList<ReliabilityRiskMl.Alerting.PercentileDurationPipe>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<ReliabilityRiskMl.Alerting.PercentileDurationPipe>): ObjList<ReliabilityRiskMl.Alerting.PercentileDurationPipe>;
     ...
     */
    static afterCreate(objs: Array_Type<ReliabilityRiskMl.Alerting.PercentileDurationPipe>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<ReliabilityRiskMl.Alerting.PercentileDurationPipe>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<ReliabilityRiskMl.Alerting.PercentileDurationPipe>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityRiskMl.Alerting.PercentileDurationPipe>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityRiskMl.Alerting.PercentileDurationPipe>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): ReliabilityRiskMl.Alerting.PercentileDurationPipe | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<ReliabilityRiskMl.Alerting.PercentileDurationPipe>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: ReliabilityRiskMl.Alerting.PercentileDurationPipe, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<ReliabilityRiskMl.Alerting.PercentileDurationPipe>, callback?: λFunction<ReliabilityRiskMl.Alerting.PercentileDurationPipe | null, ReliabilityRiskMl.Alerting.PercentileDurationPipe | null>): ObjList<ReliabilityRiskMl.Alerting.PercentileDurationPipe>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<ReliabilityRiskMl.Alerting.PercentileDurationPipe>, callback?: λFunction<ReliabilityRiskMl.Alerting.PercentileDurationPipe | null, ReliabilityRiskMl.Alerting.PercentileDurationPipe | null>): Array_Type<ObjError> | null;
     ...
     */
    publish(subPath?: string, contentType?: string): ReliabilityRiskMl.Alerting.PercentileDurationPipe;
     ...
     */
    static removeSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Alerting.PercentileDurationPipe> | null;
     ...
     */
    createSeedData(spec?: UpsertSpec): ReliabilityRiskMl.Alerting.PercentileDurationPipe | null;
     ...
     */
    static createSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Alerting.PercentileDurationPipe> | null;
     ...
     */
    updateSeedData(srcObj?: SeedData, spec?: UpsertSpec): ReliabilityRiskMl.Alerting.PercentileDurationPipe | null;
     ...
     */
    static updateSeedDataBatch(objs?: Array_Type<SeedData>, srcObjs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Alerting.PercentileDurationPipe> | null;
     ...
     * @return updated obj instance, same as {@link Persistable#update} return value.
     */
    clearUserUpdates(spec?: MergeSpec): ReliabilityRiskMl.Alerting.PercentileDurationPipe | null;
     ...
     *         {@link Persistable#updateBatch}.
     */
    static clearUserUpdatesBatch(objs?: Array_Type<SeedData>, spec?: MergeSpec): ObjList<ReliabilityRiskMl.Alerting.PercentileDurationPipe> | null;
    ...
    dependencies(): SeedDataDeps<ReliabilityRiskMl.Alerting.PercentileDurationPipe> | null;
     ...
     */
    static convert(model: any, spec?: MlConvertSpec): ReliabilityRiskMl.Alerting.PercentileDurationPipe;

    /**
     * Freezes an {@link MlPipe}
     * @return modified copy of this {@link MlPipe} that cannot be trained
     */
    freeze(): ReliabilityRiskMl.Alerting.PercentileDurationPipe;

    /**
     * Unfreezes an {@link MlPipe}
     * @return modified copy of this {@link MlPipe} that can be trained
     */
    unfreeze(): ReliabilityRiskMl.Alerting.PercentileDurationPipe;
     ...
     * be returned as-is.
     */
    byReference(): ReliabilityRiskMl.Alerting.PercentileDurationPipe;
     ...
     */
    updateModelFiles(modelFiles: Map_Type<string, Url>, spec?: MlOperationSpec): ReliabilityRiskMl.Alerting.PercentileDurationPipe;
     ...
     */
    afterTrain(doTrainOutputs: any, spec?: MlOperationSpec): ReliabilityRiskMl.Alerting.PercentileDurationPipe;
     ...
     */
    withNewSpec(spec?: MlConvertSpec): ReliabilityRiskMl.Alerting.PercentileDurationPipe;
     ...
     */
    afterConvert(model: any, spec?: MlConvertSpec): ReliabilityRiskMl.Alerting.PercentileDurationPipe;
     ...
     */
    withHyperparamSpaces(paramSpaces: Map_Type<string, Hp.ParamSpace>): ReliabilityRiskMl.Alerting.PercentileDurationPipe;
