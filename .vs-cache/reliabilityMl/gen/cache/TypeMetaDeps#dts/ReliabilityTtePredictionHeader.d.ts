// TypeScript definitions for the C3 type ReliabilityTtePredictionHeader

/**
 * A series keeping track of the "time series" predictions made for a {@link MlSubject} by a {@link MlModel}.
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityTtePredictionHeader
 */
declare interface IReliabilityTtePredictionHeader {
   ...
   */
  data?: Array_Type<ReliabilityTtePrediction> | Array<IReliabilityTtePrediction>;
 ...
 */
declare class ReliabilityTtePredictionHeader extends Obj  {

  /**
   * Populated on normalization. Indicates the earliest data point across various timeseries fields.
   */
  readonly earliest?: DateTime;
  withEarliest(earliest: DateTime | Date | string | null): ReliabilityTtePredictionHeader;

  /**
   * Populated on normalization. Indicates the latest data point across various timeseries fields.
   */
  readonly latest?: DateTime;
  withLatest(latest: DateTime | Date | string | null): ReliabilityTtePredictionHeader;

  /**
   * Populated on normalization. Indicates the earliest data point for each {@link Ann.Ts} fields.
   */
  readonly earliestTsDp?: Map_Type<string, TSDataPoint>;
  withEarliestTsDp(earliestTsDp: Map_Type<string, TSDataPoint> | {[key: string]: ITSDataPoint} | null): ReliabilityTtePredictionHeader;

  /**
   * Populated on normalization. Indicates the latest data point for each {@link Ann.Ts} fields.
   */
  readonly latestTsDp?: Map_Type<string, TSDataPoint>;
  withLatestTsDp(latestTsDp: Map_Type<string, TSDataPoint> | {[key: string]: ITSDataPoint} | null): ReliabilityTtePredictionHeader;
  ...
  withInterval(interval: string | null): ReliabilityTtePredictionHeader;
  ...
  withTimeZone(timeZone: string | null): ReliabilityTtePredictionHeader;

  /**
   * If set, disables normalizing this time series. Invalidations will still continue to happen for this series normally.
   */
  readonly doNotNormalize?: boolean;
  withDoNotNormalize(doNotNormalize: boolean): ReliabilityTtePredictionHeader;

  /**
   * Data points corresponding to this timeseries header
   */
  readonly data?: Array_Type<ReliabilityTtePrediction>;
  withData(data: Array_Type<ReliabilityTtePrediction> | Array<IReliabilityTtePrediction> | null): ReliabilityTtePredictionHeader;

  /**
   * Use this field to specify the interpolation mechanism to be applied for gaps in interval timeseries. Default: `ZERO_INTERPOLATOR`.
   */
  readonly interpolator?: string;
  withInterpolator(interpolator: string | null): ReliabilityTtePredictionHeader;

  /**
   * Use this field to specify how normalization should handle duplicate data points. A duplicate point is one that has the same start, end, value, unit, and {@link TimedDataPointFields#isEstimated} values. Default: `IGNORE`.
   */
  readonly duplicateHandling?: string;
  withDuplicateHandling(duplicateHandling: string | null): ReliabilityTtePredictionHeader;

  /**
   * Used to specify how normalization should handle overlapping data points. Default: `AVG`.
   */
  readonly overlapHandling?: string;
  withOverlapHandling(overlapHandling: string | null): ReliabilityTtePredictionHeader;
  ...
  withBucketInterval(bucketInterval: string | null): ReliabilityTtePredictionHeader;
  ...
  withNormalizationPartitionStrategy(normalizationPartitionStrategy: INormalizationPartitionStrategy | null): ReliabilityTtePredictionHeader;

  /**
   * Indicates whether the last data point should be repeated until infinity
   */
  readonly extrapolate?: boolean;
  withExtrapolate(extrapolate: boolean): ReliabilityTtePredictionHeader;
  ...
  withTypeIdent(typeIdent: string | null): ReliabilityTtePredictionHeader;
   ...
   */
  readonly id: string;
  withId(id: string): ReliabilityTtePredictionHeader;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityTtePredictionHeader;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): ReliabilityTtePredictionHeader;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): ReliabilityTtePredictionHeader;
  ...
  withVersion(version: number | null): ReliabilityTtePredictionHeader;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): ReliabilityTtePredictionHeader;

  /**
   * The subject-model association related to this series header.
   */
  readonly parent: ReliabilityAssetToTteModelRelation;
  withParent(parent: IReliabilityAssetToTteModelRelation): ReliabilityTtePredictionHeader;

  /**
   * The treatment to use for the timeseries.
   */
  readonly treatment?: string;
  withTreatment(treatment: string | null): ReliabilityTtePredictionHeader;
   ...
   * @see #toJson
   */
  static fromJson(json: any): ReliabilityTtePredictionHeader | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): ReliabilityTtePredictionHeader | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): ReliabilityTtePredictionHeader | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): ReliabilityTtePredictionHeader | null;
   ...
   */
  replaceType(old: Type, new_: Type): ReliabilityTtePredictionHeader;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityTtePredictionHeader;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityTtePredictionHeader;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityTtePredictionHeader>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityTtePredictionHeader>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityTtePredictionHeader;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityTtePredictionHeader;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityTtePredictionHeader;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ReliabilityTtePredictionHeader;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ReliabilityTtePredictionHeader;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityTtePredictionHeader;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityTtePredictionHeader;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityTtePredictionHeader;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ReliabilityTtePredictionHeader;
   ...
   * @see #removeField
   */
  withoutField(field: string): ReliabilityTtePredictionHeader;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): ReliabilityTtePredictionHeader;
   ...
   */
  withoutFields(fields: Array_Type<string>): ReliabilityTtePredictionHeader;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityTtePredictionHeader;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ReliabilityTtePredictionHeader;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityTtePredictionHeader;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ReliabilityTtePredictionHeader;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ReliabilityTtePredictionHeader;
   ...
   * @see #removeField
   */
  unsetField(field: string): ReliabilityTtePredictionHeader;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ReliabilityTtePredictionHeader;
   ...
   * @see #unsetField
   */
  removeField(field: string): ReliabilityTtePredictionHeader;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ReliabilityTtePredictionHeader;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityTtePredictionHeader;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityTtePredictionHeader;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityTtePredictionHeader;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityTtePredictionHeader;

  mergeJson(json: any): ReliabilityTtePredictionHeader;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityTtePredictionHeader;
   ...
   */
  sumObj(other: Obj, deep?: boolean): ReliabilityTtePredictionHeader;
   ...
   */
  singletonArray(): Array_Type<ReliabilityTtePredictionHeader>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityTtePredictionHeader> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ReliabilityTtePredictionHeader> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<ReliabilityTtePredictionHeader>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ReliabilityTtePredictionHeader> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, ReliabilityTtePredictionHeader> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityTtePredictionHeader> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ReliabilityTtePredictionHeader>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ReliabilityTtePredictionHeader>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityTtePredictionHeader;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityTtePredictionHeader;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityTtePredictionHeader;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ReliabilityTtePredictionHeader;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityTtePredictionHeader;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ReliabilityTtePredictionHeader;
   ...
   * @see #fromString
   */
  static make(s: string): ReliabilityTtePredictionHeader | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityTtePredictionHeader;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): ReliabilityTtePredictionHeader;
   ...
   */
  static cachedEmptyInst(): ReliabilityTtePredictionHeader;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityTtePredictionHeader> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): ReliabilityTtePredictionHeader;
   ...
   */
  static normalizeTimeseries(timeseries?: TimedDataFields<ReliabilityTtePrediction>, start?: DateTime, end?: DateTime, overrideGrain?: string, forceGrainDetection?: boolean, force?: boolean): void;
   ...
   */
  static normalize(timeseries?: TimedDataFields<ReliabilityTtePrediction>, start?: DateTime, end?: DateTime, overrideGrain?: string, forceGrainDetection?: boolean): NormalizationResult | null;
   ...
   */
  static normalizationUnit(rawHeader: TimedDataFields<ReliabilityTtePrediction>, tsField: string): Unit | null;
   ...
   */
  static normalizationTreatment(rawHeader: TimedDataFields<ReliabilityTtePrediction>, tsField: string): string;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<ReliabilityTtePredictionHeader>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<ReliabilityTtePredictionHeader>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityTtePredictionHeader> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityTtePredictionHeader>> | null;
   ...
   */
  get(include?: string): ReliabilityTtePredictionHeader | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): ReliabilityTtePredictionHeader | null;
   ...
   */
  getMissing(spec: GetMissingSpec): ReliabilityTtePredictionHeader;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): ReliabilityTtePredictionHeader | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): ReliabilityTtePredictionHeader;
   ...
   * @see #toString
   */
  static fromString(s: string): ReliabilityTtePredictionHeader | null;
   ...
   */
  create(spec?: UpsertSpec): ReliabilityTtePredictionHeader | null;
   ...
   */
  static createBatch(objs: Array_Type<ReliabilityTtePredictionHeader>, spec?: UpsertSpec): ObjList<ReliabilityTtePredictionHeader> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<ReliabilityTtePredictionHeader>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityTtePredictionHeader> | null;
   ...
   */
  update(srcObj?: ReliabilityTtePredictionHeader, spec?: UpsertSpec): ReliabilityTtePredictionHeader | null;
   ...
   */
  upsert(srcObj?: ReliabilityTtePredictionHeader, spec?: UpsertSpec): ReliabilityTtePredictionHeader | null;
   ...
   */
  merge(spec?: MergeSpec): ReliabilityTtePredictionHeader | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): ReliabilityTtePredictionHeader | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): ReliabilityTtePredictionHeader | null;
   ...
   */
  static updateBatch(objs: Array_Type<ReliabilityTtePredictionHeader>, srcObjs?: Array_Type<ReliabilityTtePredictionHeader>, spec?: UpsertSpec): ObjList<ReliabilityTtePredictionHeader> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<ReliabilityTtePredictionHeader> | null>, spec?: UpsertSpec): ObjList<ReliabilityTtePredictionHeader> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<ReliabilityTtePredictionHeader>, srcObjs?: Array_Type<ReliabilityTtePredictionHeader>, spec?: UpsertSpec): ObjList<ReliabilityTtePredictionHeader> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<ReliabilityTtePredictionHeader> | null>, spec?: UpsertSpec): ObjList<ReliabilityTtePredictionHeader> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<ReliabilityTtePredictionHeader>, spec?: TouchSpec): ObjList<ReliabilityTtePredictionHeader> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityTtePredictionHeader>, spec?: MergeSpec): ObjList<ReliabilityTtePredictionHeader> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityTtePredictionHeader>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityTtePredictionHeader> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<ReliabilityTtePredictionHeader> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityTtePredictionHeader> | null;
   ...
   */
  static mergeAll(mergeObj: ReliabilityTtePredictionHeader, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: ReliabilityTtePredictionHeader, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<ReliabilityTtePredictionHeader>, spec?: UpsertSpec): ObjList<ReliabilityTtePredictionHeader> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<ReliabilityTtePredictionHeader>, spec?: UpsertSpec): ObjList<ReliabilityTtePredictionHeader> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): ReliabilityTtePredictionHeader | null;
   ...
   */
  static beforeCreate(objs: Array_Type<ReliabilityTtePredictionHeader>): ObjList<ReliabilityTtePredictionHeader>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<ReliabilityTtePredictionHeader>): ObjList<ReliabilityTtePredictionHeader>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<ReliabilityTtePredictionHeader>): ObjList<ReliabilityTtePredictionHeader>;
   ...
   */
  static afterCreate(objs: Array_Type<ReliabilityTtePredictionHeader>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<ReliabilityTtePredictionHeader>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<ReliabilityTtePredictionHeader>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityTtePredictionHeader>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityTtePredictionHeader>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): ReliabilityTtePredictionHeader | null;
   ...
   */
  withoutIdentity(): ReliabilityTtePredictionHeader | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<ReliabilityTtePredictionHeader>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: ReliabilityTtePredictionHeader, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<ReliabilityTtePredictionHeader>, callback?: λFunction<ReliabilityTtePredictionHeader | null, ReliabilityTtePredictionHeader | null>): ObjList<ReliabilityTtePredictionHeader>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<ReliabilityTtePredictionHeader>, callback?: λFunction<ReliabilityTtePredictionHeader | null, ReliabilityTtePredictionHeader | null>): Array_Type<ObjError> | null;
