// TypeScript definitions for the C3 type ReliabilityHpoConfig

/**
 * Configurations for Hyperparameter Optimization (HPO).
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityHpoConfig
 */
declare interface IReliabilityHpoConfig {
  ...
  /**
   * Set this field to `Grid` to ignore the Max Combinations configuration and
   * allow users to start training with any number of HPO combinations.
   * Set this field to `Random` to enforce the Max Combinations configuration.
   */
  searchMethod?: string;

  /**
   * When the Search Method is set to `Random`, this field specifies the maximum number
   * of allowed combinations to be processed, i.e. the maximum number of training jobs
   * that can be started for a single HPO run.
   * If the number of HPO combinations is greater than this value, the user will not be
   * able to start training, to avoid excessive resource consumption.
   */
  maxCombinations?: number;

  /**
   * For model templates that have HPO hyperparameters, enable/disable
   * HPO values by default when configuring a new model.
   */
  hpoEnabledDefault?: boolean;
}

/**
 * Configurations for Hyperparameter Optimization (HPO).
 *
 * @remarks this represents a made instance of ReliabilityHpoConfig
 */
declare class ReliabilityHpoConfig extends Obj  {

  readonly configOverride?: string;
  withConfigOverride(configOverride: string | null): ReliabilityHpoConfig;

  static readonly configOverride?: string;

  readonly secretOverride?: string;
  withSecretOverride(secretOverride: string | null): ReliabilityHpoConfig;
  ...
  withIssues(issues: Array_Type<string> | Array<string> | null): ReliabilityHpoConfig;
  ...
  withSearchMethod(searchMethod: string | null): ReliabilityHpoConfig;
   ...
   * Set this field to `Random` to enforce the Max Combinations configuration.
   */
  static readonly searchMethod?: string;
  ...
  withMaxCombinations(maxCombinations: number | null): ReliabilityHpoConfig;
   ...
   * able to start training, to avoid excessive resource consumption.
   */
  static readonly maxCombinations?: number;

  /**
   * For model templates that have HPO hyperparameters, enable/disable
   * HPO values by default when configuring a new model.
   */
  readonly hpoEnabledDefault?: boolean;
  withHpoEnabledDefault(hpoEnabledDefault: boolean): ReliabilityHpoConfig;

  /**
   * For model templates that have HPO hyperparameters, enable/disable
   * HPO values by default when configuring a new model.
   */
  static readonly hpoEnabledDefault?: boolean;

  /**
   * @return the one and only instance to be used when member functions are called on this type.
   */
  static inst(): ReliabilityHpoConfig;

  /**
   * @return the cached instance if already cached, null otherwise. Does not instantiate if missing.
   */
  static cachedInst(): ReliabilityHpoConfig | null;
   ...
   * @see #toJson
   */
  static fromJson(json: any): ReliabilityHpoConfig | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): ReliabilityHpoConfig | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): ReliabilityHpoConfig | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): ReliabilityHpoConfig | null;
   ...
   */
  replaceType(old: Type, new_: Type): ReliabilityHpoConfig;
   ...
   * This method is used during live metadata update
   */
  static replaceType(old: Type, new_: Type): ReliabilityHpoConfig;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityHpoConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityHpoConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityHpoConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityHpoConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityHpoConfig>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityHpoConfig>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityHpoConfig>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityHpoConfig>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityHpoConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityHpoConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityHpoConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityHpoConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityHpoConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityHpoConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ReliabilityHpoConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  static validateObj(): ReliabilityHpoConfig;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ReliabilityHpoConfig;
   ...
   * @see #defaultField
   */
  static withField(field: string, value: any, doNotConvert?: boolean): ReliabilityHpoConfig;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityHpoConfig;
   ...
   * @see #defaultField
   */
  static withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityHpoConfig;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityHpoConfig;
   ...
   * @return new Obj
   */
  static withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityHpoConfig;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityHpoConfig;
   ...
   * @return new Obj
   */
  static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityHpoConfig;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ReliabilityHpoConfig;
   ...
   * @see #withoutField
   */
  static withoutFieldAtPath(path: string): ReliabilityHpoConfig;
   ...
   * @see #removeField
   */
  withoutField(field: string): ReliabilityHpoConfig;
   ...
   * @see #removeField
   */
  static withoutField(field: string): ReliabilityHpoConfig;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): ReliabilityHpoConfig;
   ...
   * @see #removeField
   */
  static withoutField(field: FieldType): ReliabilityHpoConfig;
   ...
   */
  withoutFields(fields: Array_Type<string>): ReliabilityHpoConfig;
   ...
   * @return new Obj with removed fields
   */
  static withoutFields(fields: Array_Type<string>): ReliabilityHpoConfig;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityHpoConfig;
   ...
   * @return new Obj with removed fields
   */
  static withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityHpoConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ReliabilityHpoConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  static withoutSecretFields(): ReliabilityHpoConfig;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityHpoConfig;
   ...
   * @see FieldType#defaultValue
   */
  static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityHpoConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ReliabilityHpoConfig;
   ...
   * @see #unsetField
   */
  static defaultField(field: string): ReliabilityHpoConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ReliabilityHpoConfig;
   ...
   * @see #unsetField
   */
  static defaultField(field: FieldType): ReliabilityHpoConfig;
   ...
   * @see #removeField
   */
  unsetField(field: string): ReliabilityHpoConfig;
   ...
   * @see #removeField
   */
  static unsetField(field: string): ReliabilityHpoConfig;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ReliabilityHpoConfig;
   ...
   * @see #removeField
   */
  static unsetField(field: FieldType): ReliabilityHpoConfig;
   ...
   * @see #unsetField
   */
  removeField(field: string): ReliabilityHpoConfig;
   ...
   * @see #unsetField
   */
  static removeField(field: string): ReliabilityHpoConfig;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ReliabilityHpoConfig;
   ...
   * @see #unsetField
   */
  static removeField(field: FieldType): ReliabilityHpoConfig;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityHpoConfig;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityHpoConfig;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityHpoConfig;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityHpoConfig;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityHpoConfig;
   ...
   *        the same key or index.
   */
  static mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityHpoConfig;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityHpoConfig;
   ...
   * traverse child reference and collection fields.
   */
  static mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityHpoConfig;

  mergeJson(json: any): ReliabilityHpoConfig;

  static mergeJson(json: any): ReliabilityHpoConfig;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityHpoConfig;
   ...
   * @return Obj with child references merged
   */
  static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityHpoConfig;
   ...
   */
  sumObj(other: Obj, deep?: boolean): ReliabilityHpoConfig;
   ...
   * references with same name and collection elements at same index or key.
   */
  static sumObj(other: Obj, deep?: boolean): ReliabilityHpoConfig;
   ...
   */
  singletonArray(): Array_Type<ReliabilityHpoConfig>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonArray(): Array_Type<ReliabilityHpoConfig>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityHpoConfig> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ReliabilityHpoConfig> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<ReliabilityHpoConfig>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonSet(): Set_Type<ReliabilityHpoConfig>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ReliabilityHpoConfig> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, ReliabilityHpoConfig> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityHpoConfig> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ReliabilityHpoConfig>;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  static toBuilder(): ObjBuilder<ReliabilityHpoConfig>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ReliabilityHpoConfig>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityHpoConfig;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityHpoConfig;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityHpoConfig;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ReliabilityHpoConfig;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityHpoConfig;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ReliabilityHpoConfig;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityHpoConfig;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): ReliabilityHpoConfig;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  static afterMake(): ReliabilityHpoConfig;
   ...
   */
  static cachedEmptyInst(): ReliabilityHpoConfig;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityHpoConfig> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): ReliabilityHpoConfig;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<ReliabilityHpoConfig> | null;
   ...
   */
  static find(filter?: string, doNotProduceAll?: boolean): Stream<ReliabilityHpoConfig> | null;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<ReliabilityHpoConfig> | null;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): ReliabilityHpoConfig | null;

  /**
   * Returns cached instance by key, with secrets removed.
   */
  static forCacheKey(key: string): ReliabilityHpoConfig | null;
   ...
   * @see findByCacheKey
   */
  getCached(): ReliabilityHpoConfig | null;
   ...
   * @see findByCacheKey
   */
  static getCached(): ReliabilityHpoConfig | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): ReliabilityHpoConfig | null;

  /**
   * @return newly produced cached instance.
   */
  static refreshCache(): ReliabilityHpoConfig | null;
   ...
   */
  static produce(key: string): ReliabilityHpoConfig | null;
   ...
   */
  static produceAll(): Map_Type<string, ReliabilityHpoConfig> | null;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): Map_Type<string, ReliabilityHpoConfig> | null;
   ...
   */
  getConfig(): ReliabilityHpoConfig;
   ...
   * Note that typical pattern is to use Configurable#config instead of this method.
   */
  static getConfig(): ReliabilityHpoConfig;
   ...
   */
  getSecret(): ReliabilityHpoConfig;
   ...
   * Note that typical pattern is to use Configurable#configWithSecrets instead of this method.
   */
  static getSecret(): ReliabilityHpoConfig;
   ...
   */
  withConfigKey(configKey: string): ReliabilityHpoConfig;
   ...
   *     config.configKey() => "folder1/abc"
   */
  static withConfigKey(configKey: string): ReliabilityHpoConfig;

  /**
   * @return copy without config key.
   */
  withoutConfigKey(): ReliabilityHpoConfig;

  /**
   * @return copy without config key.
   */
  static withoutConfigKey(): ReliabilityHpoConfig;

  /**
   * @return return cached config instance for provided config key.
   */
  static forConfigKey(configKey: string): ReliabilityHpoConfig | null;
   ...
   */
  static listConfigs(parallel?: boolean, filter?: λPredicate<string>): Stream<ReliabilityHpoConfig> | null;
   ...
   * @see setConfigValue
   */
  setConfigValues(from: ReliabilityHpoConfig, override?: string): void;

  /**
   * Sets multiple field values to be the same as the passed instance.
   * @see setConfigValue
   */
  static setConfigValues(from: ReliabilityHpoConfig, override?: string): void;
   ...
   * @see setSecretValue
   */
  setSecretValues(from: ReliabilityHpoConfig, override?: string): void;

  /**
   * Sets multiple secret field values to be the same as the passed instance.
   * @see setSecretValue
   */
  static setSecretValues(from: ReliabilityHpoConfig, override?: string): void;
   ...
   */
  static loadConfigAndSecret(configKey: string): ReliabilityHpoConfig | null;
   ...
   */
  removeSecrets(): ReliabilityHpoConfig | null;

  /**
   * @return this config without any secret values.
   */
  static removeSecrets(): ReliabilityHpoConfig | null;

  /**
   * @return this config with only secret values.
   */
  removeNonSecrets(): ReliabilityHpoConfig | null;

  /**
   * @return this config with only secret values.
   */
  static removeNonSecrets(): ReliabilityHpoConfig | null;

  /**
   * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
   * validation and setup.
   */
  validate(): ReliabilityHpoConfig;

  /**
   * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
   * validation and setup.
   */
  static validate(): ReliabilityHpoConfig;
