// TypeScript definitions for the C3 type ReliabilityMlPopulationDatasetPreparationRun

/**
 * {@link ReliabilityMlDatasetPreparationRun} refers to a dataset created for a single {@link ReliabilityAsset}.
 * This type represents a dataset created for a population of hierarchically similar {@link ReliabilityAsset}s.
 * A dataset created for a population essentially means that the individual datasets from each asset is vertically
 * stacked/concatenated to created a large enough dataset to train a machine learning model on.
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityMlPopulationDatasetPreparationRun
 */
declare interface IReliabilityMlPopulationDatasetPreparationRun {

  /**
   * The associated {@link ReliabilityMl.Project}.
   */
  ...
  /**
   * The `assetFilter` is a serialized filter that defines which {@link ReliabilityAsset}s should be included
   * in the dataset for preparation. This filter allows the population of assets to be narrowed down based on
   * specific criteria, such as asset attributes or statuses.
   */
  assetFilter: string;
}
 ...
 * stacked/concatenated to created a large enough dataset to train a machine learning model on.
 *
 * @remarks this represents a made instance of ReliabilityMlPopulationDatasetPreparationRun
 */
declare class ReliabilityMlPopulationDatasetPreparationRun extends Obj  {

  /**
   * The associated {@link ReliabilityMl.Project}.
   */
  readonly project?: ReliabilityMl.Project;
  withProject(project: IReliabilityMl.Project | null): ReliabilityMlPopulationDatasetPreparationRun;
  ...
  withTypeIdent(typeIdent: string | null): ReliabilityMlPopulationDatasetPreparationRun;
   ...
   */
  readonly id: string;
  withId(id: string): ReliabilityMlPopulationDatasetPreparationRun;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityMlPopulationDatasetPreparationRun;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): ReliabilityMlPopulationDatasetPreparationRun;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): ReliabilityMlPopulationDatasetPreparationRun;
  ...
  withVersion(version: number | null): ReliabilityMlPopulationDatasetPreparationRun;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): ReliabilityMlPopulationDatasetPreparationRun;
  ...
  withSpec(spec: IReliabilityMlDatasetPreparationSpec | null): ReliabilityMlPopulationDatasetPreparationRun;
  ...
  withStart(start: DateTime | Date | string | null): ReliabilityMlPopulationDatasetPreparationRun;
  ...
  withEnd(end: DateTime | Date | string | null): ReliabilityMlPopulationDatasetPreparationRun;
  ...
  withInterval(interval: string | null): ReliabilityMlPopulationDatasetPreparationRun;
  ...
  withFeaturePreparation(featurePreparation: IReliabilityMlDatasetPreparationStep | null): ReliabilityMlPopulationDatasetPreparationRun;

  /**
   * The dataset corresponding to the features that will be input to the {@link MlModel}.
   */
  readonly featureDatasets?: Map_Type<string, Feature.Set>;
  withFeatureDatasets(featureDatasets: Map_Type<string, Feature.Set> | {[key: string]: IFeature.Set} | null): ReliabilityMlPopulationDatasetPreparationRun;

  /**
   * The time range used to extract training data from {@link Feature.Set.Snapshot}.
   */
  readonly trainFeatureTimeRanges?: Map_Type<string, TimeRange>;
  withTrainFeatureTimeRanges(trainFeatureTimeRanges: Map_Type<string, TimeRange> | {[key: string]: ITimeRange} | null): ReliabilityMlPopulationDatasetPreparationRun;

  /**
   * The time range used to extract validation data from {@link Feature.Set.Snapshot}.
   */
  readonly valFeatureTimeRanges?: Map_Type<string, TimeRange>;
  withValFeatureTimeRanges(valFeatureTimeRanges: Map_Type<string, TimeRange> | {[key: string]: ITimeRange} | null): ReliabilityMlPopulationDatasetPreparationRun;
  ...
  withMaskPreparation(maskPreparation: IReliabilityMlDatasetPreparationStep | null): ReliabilityMlPopulationDatasetPreparationRun;
  ...
  withMaskDatasets(maskDatasets: Map_Type<string, Feature.Set> | {[key: string]: IFeature.Set} | null): ReliabilityMlPopulationDatasetPreparationRun;

  /**
   * The mask time range used to extract training data from {@link Feature.Set.Snapshot}.
   */
  readonly trainMaskTimeRanges?: Map_Type<string, TimeRange>;
  withTrainMaskTimeRanges(trainMaskTimeRanges: Map_Type<string, TimeRange> | {[key: string]: ITimeRange} | null): ReliabilityMlPopulationDatasetPreparationRun;

  /**
   * The mask time range used to extract validation data from {@link Feature.Set.Snapshot}.
   */
  readonly valMaskTimeRanges?: Map_Type<string, TimeRange>;
  withValMaskTimeRanges(valMaskTimeRanges: Map_Type<string, TimeRange> | {[key: string]: ITimeRange} | null): ReliabilityMlPopulationDatasetPreparationRun;
  ...
  withAlertContextPreparation(alertContextPreparation: IReliabilityMlDatasetPreparationStep | null): ReliabilityMlPopulationDatasetPreparationRun;

  /**
   * The dataset corresponding to the alertContext that will be input to the {@link MlModel}.
   */
  readonly alertContextDatasets?: Map_Type<string, Feature.Set>;
  withAlertContextDatasets(alertContextDatasets: Map_Type<string, Feature.Set> | {[key: string]: IFeature.Set} | null): ReliabilityMlPopulationDatasetPreparationRun;
  ...
  withTargetPreparation(targetPreparation: IReliabilityMlDatasetPreparationStep | null): ReliabilityMlPopulationDatasetPreparationRun;

  /**
   * The dataset corresponding to the targets that will be input to the {@link MlModel}.
   */
  readonly targetDatasets?: Map_Type<string, Feature.Set>;
  withTargetDatasets(targetDatasets: Map_Type<string, Feature.Set> | {[key: string]: IFeature.Set} | null): ReliabilityMlPopulationDatasetPreparationRun;

  /**
   * The target time range used to extract training data from {@link Feature.Set.Snapshot}.
   */
  readonly trainTargetTimeRanges?: Map_Type<string, TimeRange>;
  withTrainTargetTimeRanges(trainTargetTimeRanges: Map_Type<string, TimeRange> | {[key: string]: ITimeRange} | null): ReliabilityMlPopulationDatasetPreparationRun;

  /**
   * The target time range used to extract validation data from {@link Feature.Set.Snapshot}.
   */
  readonly valTargetTimeRanges?: Map_Type<string, TimeRange>;
  withValTargetTimeRanges(valTargetTimeRanges: Map_Type<string, TimeRange> | {[key: string]: ITimeRange} | null): ReliabilityMlPopulationDatasetPreparationRun;
  ...
  withTrainValSplit(trainValSplit: IReliabilityMlDatasetPreparationStep | null): ReliabilityMlPopulationDatasetPreparationRun;
  ...
  withXFeatures(xFeatures: Map_Type<string, Feature.Set> | {[key: string]: IFeature.Set} | null): ReliabilityMlPopulationDatasetPreparationRun;
  ...
  withFeatures(features: Array_Type<string> | Array<string> | null): ReliabilityMlPopulationDatasetPreparationRun;
  ...
  withNumFeatures(numFeatures: number | null): ReliabilityMlPopulationDatasetPreparationRun;
  ...
  withYFeatures(yFeatures: Map_Type<string, Feature.Set> | {[key: string]: IFeature.Set} | null): ReliabilityMlPopulationDatasetPreparationRun;
  ...
  withStatus(status: string | null): ReliabilityMlPopulationDatasetPreparationRun;
  ...
  withIncludeSensors(includeSensors: Array_Type<Sensor> | Array<ISensor> | null): ReliabilityMlPopulationDatasetPreparationRun;
  ...
  withExcludeSensors(excludeSensors: Array_Type<Sensor> | Array<ISensor> | null): ReliabilityMlPopulationDatasetPreparationRun;
  ...
  withTrainSnapshots(trainSnapshots: Map_Type<string, Map_Type<string, string>> | {[key: string]: Map_Type<string, string> | {[key: string]: string}} | null): ReliabilityMlPopulationDatasetPreparationRun;
  ...
  withValSnapshots(valSnapshots: Map_Type<string, Map_Type<string, string>> | {[key: string]: Map_Type<string, string> | {[key: string]: string}} | null): ReliabilityMlPopulationDatasetPreparationRun;
  ...
  withAssetFilter(assetFilter: string): ReliabilityMlPopulationDatasetPreparationRun;
   ...
   * @see #toJson
   */
  static fromJson(json: any): ReliabilityMlPopulationDatasetPreparationRun | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): ReliabilityMlPopulationDatasetPreparationRun | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): ReliabilityMlPopulationDatasetPreparationRun | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): ReliabilityMlPopulationDatasetPreparationRun | null;
   ...
   */
  replaceType(old: Type, new_: Type): ReliabilityMlPopulationDatasetPreparationRun;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityMlPopulationDatasetPreparationRun;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityMlPopulationDatasetPreparationRun;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityMlPopulationDatasetPreparationRun>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityMlPopulationDatasetPreparationRun>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityMlPopulationDatasetPreparationRun;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityMlPopulationDatasetPreparationRun;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityMlPopulationDatasetPreparationRun;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ReliabilityMlPopulationDatasetPreparationRun;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ReliabilityMlPopulationDatasetPreparationRun;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityMlPopulationDatasetPreparationRun;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityMlPopulationDatasetPreparationRun;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityMlPopulationDatasetPreparationRun;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ReliabilityMlPopulationDatasetPreparationRun;
   ...
   * @see #removeField
   */
  withoutField(field: string): ReliabilityMlPopulationDatasetPreparationRun;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): ReliabilityMlPopulationDatasetPreparationRun;
   ...
   */
  withoutFields(fields: Array_Type<string>): ReliabilityMlPopulationDatasetPreparationRun;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityMlPopulationDatasetPreparationRun;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ReliabilityMlPopulationDatasetPreparationRun;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityMlPopulationDatasetPreparationRun;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ReliabilityMlPopulationDatasetPreparationRun;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ReliabilityMlPopulationDatasetPreparationRun;
   ...
   * @see #removeField
   */
  unsetField(field: string): ReliabilityMlPopulationDatasetPreparationRun;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ReliabilityMlPopulationDatasetPreparationRun;
   ...
   * @see #unsetField
   */
  removeField(field: string): ReliabilityMlPopulationDatasetPreparationRun;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ReliabilityMlPopulationDatasetPreparationRun;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityMlPopulationDatasetPreparationRun;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityMlPopulationDatasetPreparationRun;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityMlPopulationDatasetPreparationRun;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityMlPopulationDatasetPreparationRun;

  mergeJson(json: any): ReliabilityMlPopulationDatasetPreparationRun;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityMlPopulationDatasetPreparationRun;
   ...
   */
  sumObj(other: Obj, deep?: boolean): ReliabilityMlPopulationDatasetPreparationRun;
   ...
   */
  singletonArray(): Array_Type<ReliabilityMlPopulationDatasetPreparationRun>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityMlPopulationDatasetPreparationRun> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ReliabilityMlPopulationDatasetPreparationRun> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<ReliabilityMlPopulationDatasetPreparationRun>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ReliabilityMlPopulationDatasetPreparationRun> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, ReliabilityMlPopulationDatasetPreparationRun> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityMlPopulationDatasetPreparationRun> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ReliabilityMlPopulationDatasetPreparationRun>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ReliabilityMlPopulationDatasetPreparationRun>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityMlPopulationDatasetPreparationRun;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityMlPopulationDatasetPreparationRun;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityMlPopulationDatasetPreparationRun;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ReliabilityMlPopulationDatasetPreparationRun;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityMlPopulationDatasetPreparationRun;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ReliabilityMlPopulationDatasetPreparationRun;
   ...
   * @see #fromString
   */
  static make(s: string): ReliabilityMlPopulationDatasetPreparationRun | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityMlPopulationDatasetPreparationRun;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): ReliabilityMlPopulationDatasetPreparationRun;
   ...
   */
  static cachedEmptyInst(): ReliabilityMlPopulationDatasetPreparationRun;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityMlPopulationDatasetPreparationRun> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): ReliabilityMlPopulationDatasetPreparationRun;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<ReliabilityMlPopulationDatasetPreparationRun>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<ReliabilityMlPopulationDatasetPreparationRun>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityMlPopulationDatasetPreparationRun> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityMlPopulationDatasetPreparationRun>> | null;
   ...
   */
  get(include?: string): ReliabilityMlPopulationDatasetPreparationRun | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): ReliabilityMlPopulationDatasetPreparationRun | null;
   ...
   */
  getMissing(spec: GetMissingSpec): ReliabilityMlPopulationDatasetPreparationRun;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): ReliabilityMlPopulationDatasetPreparationRun | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): ReliabilityMlPopulationDatasetPreparationRun;
   ...
   * @see #toString
   */
  static fromString(s: string): ReliabilityMlPopulationDatasetPreparationRun | null;
   ...
   */
  create(spec?: UpsertSpec): ReliabilityMlPopulationDatasetPreparationRun | null;
   ...
   */
  static createBatch(objs: Array_Type<ReliabilityMlPopulationDatasetPreparationRun>, spec?: UpsertSpec): ObjList<ReliabilityMlPopulationDatasetPreparationRun> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<ReliabilityMlPopulationDatasetPreparationRun>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityMlPopulationDatasetPreparationRun> | null;
   ...
   */
  update(srcObj?: ReliabilityMlPopulationDatasetPreparationRun, spec?: UpsertSpec): ReliabilityMlPopulationDatasetPreparationRun | null;
   ...
   */
  upsert(srcObj?: ReliabilityMlPopulationDatasetPreparationRun, spec?: UpsertSpec): ReliabilityMlPopulationDatasetPreparationRun | null;
   ...
   */
  merge(spec?: MergeSpec): ReliabilityMlPopulationDatasetPreparationRun | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): ReliabilityMlPopulationDatasetPreparationRun | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): ReliabilityMlPopulationDatasetPreparationRun | null;
   ...
   */
  static updateBatch(objs: Array_Type<ReliabilityMlPopulationDatasetPreparationRun>, srcObjs?: Array_Type<ReliabilityMlPopulationDatasetPreparationRun>, spec?: UpsertSpec): ObjList<ReliabilityMlPopulationDatasetPreparationRun> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<ReliabilityMlPopulationDatasetPreparationRun> | null>, spec?: UpsertSpec): ObjList<ReliabilityMlPopulationDatasetPreparationRun> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<ReliabilityMlPopulationDatasetPreparationRun>, srcObjs?: Array_Type<ReliabilityMlPopulationDatasetPreparationRun>, spec?: UpsertSpec): ObjList<ReliabilityMlPopulationDatasetPreparationRun> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<ReliabilityMlPopulationDatasetPreparationRun> | null>, spec?: UpsertSpec): ObjList<ReliabilityMlPopulationDatasetPreparationRun> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<ReliabilityMlPopulationDatasetPreparationRun>, spec?: TouchSpec): ObjList<ReliabilityMlPopulationDatasetPreparationRun> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityMlPopulationDatasetPreparationRun>, spec?: MergeSpec): ObjList<ReliabilityMlPopulationDatasetPreparationRun> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityMlPopulationDatasetPreparationRun>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityMlPopulationDatasetPreparationRun> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<ReliabilityMlPopulationDatasetPreparationRun> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityMlPopulationDatasetPreparationRun> | null;
   ...
   */
  static mergeAll(mergeObj: ReliabilityMlPopulationDatasetPreparationRun, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: ReliabilityMlPopulationDatasetPreparationRun, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<ReliabilityMlPopulationDatasetPreparationRun>, spec?: UpsertSpec): ObjList<ReliabilityMlPopulationDatasetPreparationRun> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<ReliabilityMlPopulationDatasetPreparationRun>, spec?: UpsertSpec): ObjList<ReliabilityMlPopulationDatasetPreparationRun> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): ReliabilityMlPopulationDatasetPreparationRun | null;
   ...
   */
  static beforeCreate(objs: Array_Type<ReliabilityMlPopulationDatasetPreparationRun>): ObjList<ReliabilityMlPopulationDatasetPreparationRun>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<ReliabilityMlPopulationDatasetPreparationRun>): ObjList<ReliabilityMlPopulationDatasetPreparationRun>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<ReliabilityMlPopulationDatasetPreparationRun>): ObjList<ReliabilityMlPopulationDatasetPreparationRun>;
   ...
   */
  static afterCreate(objs: Array_Type<ReliabilityMlPopulationDatasetPreparationRun>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<ReliabilityMlPopulationDatasetPreparationRun>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<ReliabilityMlPopulationDatasetPreparationRun>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityMlPopulationDatasetPreparationRun>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityMlPopulationDatasetPreparationRun>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): ReliabilityMlPopulationDatasetPreparationRun | null;
   ...
   */
  withoutIdentity(): ReliabilityMlPopulationDatasetPreparationRun | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<ReliabilityMlPopulationDatasetPreparationRun>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: ReliabilityMlPopulationDatasetPreparationRun, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<ReliabilityMlPopulationDatasetPreparationRun>, callback?: λFunction<ReliabilityMlPopulationDatasetPreparationRun | null, ReliabilityMlPopulationDatasetPreparationRun | null>): ObjList<ReliabilityMlPopulationDatasetPreparationRun>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<ReliabilityMlPopulationDatasetPreparationRun>, callback?: λFunction<ReliabilityMlPopulationDatasetPreparationRun | null, ReliabilityMlPopulationDatasetPreparationRun | null>): Array_Type<ObjError> | null;
  ...
  /**
   * This function refits the {@link ReliabilityMlDatasetPreparationRun} for a specific {@link ReliabilityAsset}.
   * It creates a new dataset that is tailored for the provided asset. This refitting may involve reprocessing or
   * restructuring the data to ensure it is specific and relevant to the asset in question. The refitted dataset is
   * then used to update the model's training data.
   *
   * @param assetId
   *        The ID of the {@link ReliabilityAsset} for which the dataset preparation run is being refitted.
   *
   * @returns A new instance of {@link ReliabilityMlDatasetPreparationRun} that is refitted for the specified asset.
   */
  refitForAsset(assetId: string): ReliabilityMlDatasetPreparationRun;
}
