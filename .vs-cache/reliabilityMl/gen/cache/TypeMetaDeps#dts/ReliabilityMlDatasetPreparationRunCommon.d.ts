// TypeScript definitions for the C3 type ReliabilityMlDatasetPreparationRunCommon
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityMlDatasetPreparationRunCommon
 */
declare interface IReliabilityMlDatasetPreparationRunCommon {
 ...
 * {@link ReliabilityMlPopulationDatasetPreparationRun} are the entity types that should be upserted.
 *
 * @remarks this represents a made instance of ReliabilityMlDatasetPreparationRunCommon
 */
declare class ReliabilityMlDatasetPreparationRunCommon extends Obj  {

  /**
   * The associated {@link ReliabilityMl.Project}.
   */
  readonly project?: ReliabilityMl.Project;
  withProject(project: IReliabilityMl.Project | null): ReliabilityMlDatasetPreparationRunCommon;
  ...
  withTypeIdent(typeIdent: string | null): ReliabilityMlDatasetPreparationRunCommon;
   ...
   */
  readonly id: string;
  withId(id: string): ReliabilityMlDatasetPreparationRunCommon;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityMlDatasetPreparationRunCommon;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): ReliabilityMlDatasetPreparationRunCommon;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): ReliabilityMlDatasetPreparationRunCommon;
  ...
  withVersion(version: number | null): ReliabilityMlDatasetPreparationRunCommon;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): ReliabilityMlDatasetPreparationRunCommon;
  ...
  withSpec(spec: IReliabilityMlDatasetPreparationSpec | null): ReliabilityMlDatasetPreparationRunCommon;
  ...
  withStart(start: DateTime | Date | string | null): ReliabilityMlDatasetPreparationRunCommon;
  ...
  withEnd(end: DateTime | Date | string | null): ReliabilityMlDatasetPreparationRunCommon;
  ...
  withInterval(interval: string | null): ReliabilityMlDatasetPreparationRunCommon;
  ...
  withFeaturePreparation(featurePreparation: IReliabilityMlDatasetPreparationStep | null): ReliabilityMlDatasetPreparationRunCommon;

  /**
   * The dataset corresponding to the features that will be input to the {@link MlModel}.
   */
  readonly featureDatasets?: Map_Type<string, Feature.Set>;
  withFeatureDatasets(featureDatasets: Map_Type<string, Feature.Set> | {[key: string]: IFeature.Set} | null): ReliabilityMlDatasetPreparationRunCommon;

  /**
   * The time range used to extract training data from {@link Feature.Set.Snapshot}.
   */
  readonly trainFeatureTimeRanges?: Map_Type<string, TimeRange>;
  withTrainFeatureTimeRanges(trainFeatureTimeRanges: Map_Type<string, TimeRange> | {[key: string]: ITimeRange} | null): ReliabilityMlDatasetPreparationRunCommon;

  /**
   * The time range used to extract validation data from {@link Feature.Set.Snapshot}.
   */
  readonly valFeatureTimeRanges?: Map_Type<string, TimeRange>;
  withValFeatureTimeRanges(valFeatureTimeRanges: Map_Type<string, TimeRange> | {[key: string]: ITimeRange} | null): ReliabilityMlDatasetPreparationRunCommon;
  ...
  withMaskPreparation(maskPreparation: IReliabilityMlDatasetPreparationStep | null): ReliabilityMlDatasetPreparationRunCommon;
  ...
  withMaskDatasets(maskDatasets: Map_Type<string, Feature.Set> | {[key: string]: IFeature.Set} | null): ReliabilityMlDatasetPreparationRunCommon;

  /**
   * The mask time range used to extract training data from {@link Feature.Set.Snapshot}.
   */
  readonly trainMaskTimeRanges?: Map_Type<string, TimeRange>;
  withTrainMaskTimeRanges(trainMaskTimeRanges: Map_Type<string, TimeRange> | {[key: string]: ITimeRange} | null): ReliabilityMlDatasetPreparationRunCommon;

  /**
   * The mask time range used to extract validation data from {@link Feature.Set.Snapshot}.
   */
  readonly valMaskTimeRanges?: Map_Type<string, TimeRange>;
  withValMaskTimeRanges(valMaskTimeRanges: Map_Type<string, TimeRange> | {[key: string]: ITimeRange} | null): ReliabilityMlDatasetPreparationRunCommon;
  ...
  withAlertContextPreparation(alertContextPreparation: IReliabilityMlDatasetPreparationStep | null): ReliabilityMlDatasetPreparationRunCommon;

  /**
   * The dataset corresponding to the alertContext that will be input to the {@link MlModel}.
   */
  readonly alertContextDatasets?: Map_Type<string, Feature.Set>;
  withAlertContextDatasets(alertContextDatasets: Map_Type<string, Feature.Set> | {[key: string]: IFeature.Set} | null): ReliabilityMlDatasetPreparationRunCommon;
  ...
  withTargetPreparation(targetPreparation: IReliabilityMlDatasetPreparationStep | null): ReliabilityMlDatasetPreparationRunCommon;

  /**
   * The dataset corresponding to the targets that will be input to the {@link MlModel}.
   */
  readonly targetDatasets?: Map_Type<string, Feature.Set>;
  withTargetDatasets(targetDatasets: Map_Type<string, Feature.Set> | {[key: string]: IFeature.Set} | null): ReliabilityMlDatasetPreparationRunCommon;

  /**
   * The target time range used to extract training data from {@link Feature.Set.Snapshot}.
   */
  readonly trainTargetTimeRanges?: Map_Type<string, TimeRange>;
  withTrainTargetTimeRanges(trainTargetTimeRanges: Map_Type<string, TimeRange> | {[key: string]: ITimeRange} | null): ReliabilityMlDatasetPreparationRunCommon;

  /**
   * The target time range used to extract validation data from {@link Feature.Set.Snapshot}.
   */
  readonly valTargetTimeRanges?: Map_Type<string, TimeRange>;
  withValTargetTimeRanges(valTargetTimeRanges: Map_Type<string, TimeRange> | {[key: string]: ITimeRange} | null): ReliabilityMlDatasetPreparationRunCommon;
  ...
  withTrainValSplit(trainValSplit: IReliabilityMlDatasetPreparationStep | null): ReliabilityMlDatasetPreparationRunCommon;
  ...
  withXFeatures(xFeatures: Map_Type<string, Feature.Set> | {[key: string]: IFeature.Set} | null): ReliabilityMlDatasetPreparationRunCommon;
  ...
  withFeatures(features: Array_Type<string> | Array<string> | null): ReliabilityMlDatasetPreparationRunCommon;
  ...
  withNumFeatures(numFeatures: number | null): ReliabilityMlDatasetPreparationRunCommon;
  ...
  withYFeatures(yFeatures: Map_Type<string, Feature.Set> | {[key: string]: IFeature.Set} | null): ReliabilityMlDatasetPreparationRunCommon;
  ...
  withStatus(status: string | null): ReliabilityMlDatasetPreparationRunCommon;
  ...
  withIncludeSensors(includeSensors: Array_Type<Sensor> | Array<ISensor> | null): ReliabilityMlDatasetPreparationRunCommon;
  ...
  withExcludeSensors(excludeSensors: Array_Type<Sensor> | Array<ISensor> | null): ReliabilityMlDatasetPreparationRunCommon;
  ...
  withTrainSnapshots(trainSnapshots: Map_Type<string, Map_Type<string, string>> | {[key: string]: Map_Type<string, string> | {[key: string]: string}} | null): ReliabilityMlDatasetPreparationRunCommon;
  ...
  withValSnapshots(valSnapshots: Map_Type<string, Map_Type<string, string>> | {[key: string]: Map_Type<string, string> | {[key: string]: string}} | null): ReliabilityMlDatasetPreparationRunCommon;
   ...
   * @see #toJson
   */
  static fromJson(json: any): ReliabilityMlDatasetPreparationRunCommon | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): ReliabilityMlDatasetPreparationRunCommon | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): ReliabilityMlDatasetPreparationRunCommon | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): ReliabilityMlDatasetPreparationRunCommon | null;
   ...
   */
  replaceType(old: Type, new_: Type): ReliabilityMlDatasetPreparationRunCommon;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityMlDatasetPreparationRunCommon;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityMlDatasetPreparationRunCommon;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityMlDatasetPreparationRunCommon>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityMlDatasetPreparationRunCommon>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityMlDatasetPreparationRunCommon;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityMlDatasetPreparationRunCommon;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityMlDatasetPreparationRunCommon;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ReliabilityMlDatasetPreparationRunCommon;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ReliabilityMlDatasetPreparationRunCommon;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityMlDatasetPreparationRunCommon;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityMlDatasetPreparationRunCommon;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityMlDatasetPreparationRunCommon;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ReliabilityMlDatasetPreparationRunCommon;
   ...
   * @see #removeField
   */
  withoutField(field: string): ReliabilityMlDatasetPreparationRunCommon;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): ReliabilityMlDatasetPreparationRunCommon;
   ...
   */
  withoutFields(fields: Array_Type<string>): ReliabilityMlDatasetPreparationRunCommon;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityMlDatasetPreparationRunCommon;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ReliabilityMlDatasetPreparationRunCommon;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityMlDatasetPreparationRunCommon;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ReliabilityMlDatasetPreparationRunCommon;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ReliabilityMlDatasetPreparationRunCommon;
   ...
   * @see #removeField
   */
  unsetField(field: string): ReliabilityMlDatasetPreparationRunCommon;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ReliabilityMlDatasetPreparationRunCommon;
   ...
   * @see #unsetField
   */
  removeField(field: string): ReliabilityMlDatasetPreparationRunCommon;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ReliabilityMlDatasetPreparationRunCommon;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityMlDatasetPreparationRunCommon;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityMlDatasetPreparationRunCommon;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityMlDatasetPreparationRunCommon;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityMlDatasetPreparationRunCommon;

  mergeJson(json: any): ReliabilityMlDatasetPreparationRunCommon;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityMlDatasetPreparationRunCommon;
   ...
   */
  sumObj(other: Obj, deep?: boolean): ReliabilityMlDatasetPreparationRunCommon;
   ...
   */
  singletonArray(): Array_Type<ReliabilityMlDatasetPreparationRunCommon>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityMlDatasetPreparationRunCommon> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ReliabilityMlDatasetPreparationRunCommon> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<ReliabilityMlDatasetPreparationRunCommon>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ReliabilityMlDatasetPreparationRunCommon> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, ReliabilityMlDatasetPreparationRunCommon> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityMlDatasetPreparationRunCommon> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ReliabilityMlDatasetPreparationRunCommon>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ReliabilityMlDatasetPreparationRunCommon>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityMlDatasetPreparationRunCommon;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityMlDatasetPreparationRunCommon;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityMlDatasetPreparationRunCommon;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ReliabilityMlDatasetPreparationRunCommon;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityMlDatasetPreparationRunCommon;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ReliabilityMlDatasetPreparationRunCommon;
   ...
   * @see #fromString
   */
  static make(s: string): ReliabilityMlDatasetPreparationRunCommon | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityMlDatasetPreparationRunCommon;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): ReliabilityMlDatasetPreparationRunCommon;
   ...
   */
  static cachedEmptyInst(): ReliabilityMlDatasetPreparationRunCommon;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityMlDatasetPreparationRunCommon> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): ReliabilityMlDatasetPreparationRunCommon;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<ReliabilityMlDatasetPreparationRunCommon>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<ReliabilityMlDatasetPreparationRunCommon>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityMlDatasetPreparationRunCommon> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityMlDatasetPreparationRunCommon>> | null;
   ...
   */
  get(include?: string): ReliabilityMlDatasetPreparationRunCommon | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): ReliabilityMlDatasetPreparationRunCommon | null;
   ...
   */
  getMissing(spec: GetMissingSpec): ReliabilityMlDatasetPreparationRunCommon;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): ReliabilityMlDatasetPreparationRunCommon | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): ReliabilityMlDatasetPreparationRunCommon;
   ...
   * @see #toString
   */
  static fromString(s: string): ReliabilityMlDatasetPreparationRunCommon | null;
   ...
   */
  create(spec?: UpsertSpec): ReliabilityMlDatasetPreparationRunCommon | null;
   ...
   */
  static createBatch(objs: Array_Type<ReliabilityMlDatasetPreparationRunCommon>, spec?: UpsertSpec): ObjList<ReliabilityMlDatasetPreparationRunCommon> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<ReliabilityMlDatasetPreparationRunCommon>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityMlDatasetPreparationRunCommon> | null;
   ...
   */
  update(srcObj?: ReliabilityMlDatasetPreparationRunCommon, spec?: UpsertSpec): ReliabilityMlDatasetPreparationRunCommon | null;
   ...
   */
  upsert(srcObj?: ReliabilityMlDatasetPreparationRunCommon, spec?: UpsertSpec): ReliabilityMlDatasetPreparationRunCommon | null;
   ...
   */
  merge(spec?: MergeSpec): ReliabilityMlDatasetPreparationRunCommon | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): ReliabilityMlDatasetPreparationRunCommon | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): ReliabilityMlDatasetPreparationRunCommon | null;
   ...
   */
  static updateBatch(objs: Array_Type<ReliabilityMlDatasetPreparationRunCommon>, srcObjs?: Array_Type<ReliabilityMlDatasetPreparationRunCommon>, spec?: UpsertSpec): ObjList<ReliabilityMlDatasetPreparationRunCommon> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<ReliabilityMlDatasetPreparationRunCommon> | null>, spec?: UpsertSpec): ObjList<ReliabilityMlDatasetPreparationRunCommon> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<ReliabilityMlDatasetPreparationRunCommon>, srcObjs?: Array_Type<ReliabilityMlDatasetPreparationRunCommon>, spec?: UpsertSpec): ObjList<ReliabilityMlDatasetPreparationRunCommon> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<ReliabilityMlDatasetPreparationRunCommon> | null>, spec?: UpsertSpec): ObjList<ReliabilityMlDatasetPreparationRunCommon> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<ReliabilityMlDatasetPreparationRunCommon>, spec?: TouchSpec): ObjList<ReliabilityMlDatasetPreparationRunCommon> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityMlDatasetPreparationRunCommon>, spec?: MergeSpec): ObjList<ReliabilityMlDatasetPreparationRunCommon> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityMlDatasetPreparationRunCommon>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityMlDatasetPreparationRunCommon> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<ReliabilityMlDatasetPreparationRunCommon> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityMlDatasetPreparationRunCommon> | null;
   ...
   */
  static mergeAll(mergeObj: ReliabilityMlDatasetPreparationRunCommon, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: ReliabilityMlDatasetPreparationRunCommon, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<ReliabilityMlDatasetPreparationRunCommon>, spec?: UpsertSpec): ObjList<ReliabilityMlDatasetPreparationRunCommon> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<ReliabilityMlDatasetPreparationRunCommon>, spec?: UpsertSpec): ObjList<ReliabilityMlDatasetPreparationRunCommon> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): ReliabilityMlDatasetPreparationRunCommon | null;
   ...
   */
  static beforeCreate(objs: Array_Type<ReliabilityMlDatasetPreparationRunCommon>): ObjList<ReliabilityMlDatasetPreparationRunCommon>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<ReliabilityMlDatasetPreparationRunCommon>): ObjList<ReliabilityMlDatasetPreparationRunCommon>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<ReliabilityMlDatasetPreparationRunCommon>): ObjList<ReliabilityMlDatasetPreparationRunCommon>;
   ...
   */
  static afterCreate(objs: Array_Type<ReliabilityMlDatasetPreparationRunCommon>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<ReliabilityMlDatasetPreparationRunCommon>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<ReliabilityMlDatasetPreparationRunCommon>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityMlDatasetPreparationRunCommon>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityMlDatasetPreparationRunCommon>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): ReliabilityMlDatasetPreparationRunCommon | null;
   ...
   */
  withoutIdentity(): ReliabilityMlDatasetPreparationRunCommon | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<ReliabilityMlDatasetPreparationRunCommon>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: ReliabilityMlDatasetPreparationRunCommon, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<ReliabilityMlDatasetPreparationRunCommon>, callback?: λFunction<ReliabilityMlDatasetPreparationRunCommon | null, ReliabilityMlDatasetPreparationRunCommon | null>): ObjList<ReliabilityMlDatasetPreparationRunCommon>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<ReliabilityMlDatasetPreparationRunCommon>, callback?: λFunction<ReliabilityMlDatasetPreparationRunCommon | null, ReliabilityMlDatasetPreparationRunCommon | null>): Array_Type<ObjError> | null;
