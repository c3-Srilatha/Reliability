// TypeScript definitions for the C3 type ControlValvesModelableBase
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of ControlValvesModelableBase
 */
declare interface IControlValvesModelableBase {
 ...
 */
declare class ControlValvesModelableBase extends Obj  {
  ...
  withTypeIdent(typeIdent: string | null): ControlValvesModelableBase;
   ...
   */
  readonly id: string;
  withId(id: string): ControlValvesModelableBase;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ControlValvesModelableBase;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): ControlValvesModelableBase;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): ControlValvesModelableBase;
  ...
  withVersion(version: number | null): ControlValvesModelableBase;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): ControlValvesModelableBase;

  /**
   * The {@link Feature} that represents the PERCENT_OPEN sensor instrumented on the Control Valve.
   */
  readonly percentOpen: string;
  withPercentOpen(percentOpen: string): ControlValvesModelableBase;
  ...
  withExcludeFeatures(excludeFeatures: Array_Type<string> | Array<string> | null): ControlValvesModelableBase;
   ...
   * @see #toJson
   */
  static fromJson(json: any): ControlValvesModelableBase | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): ControlValvesModelableBase | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): ControlValvesModelableBase | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): ControlValvesModelableBase | null;
   ...
   */
  replaceType(old: Type, new_: Type): ControlValvesModelableBase;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ControlValvesModelableBase;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ControlValvesModelableBase;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ControlValvesModelableBase>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ControlValvesModelableBase>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ControlValvesModelableBase;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ControlValvesModelableBase;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ControlValvesModelableBase;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ControlValvesModelableBase;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ControlValvesModelableBase;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ControlValvesModelableBase;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ControlValvesModelableBase;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ControlValvesModelableBase;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ControlValvesModelableBase;
   ...
   * @see #removeField
   */
  withoutField(field: string): ControlValvesModelableBase;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): ControlValvesModelableBase;
   ...
   */
  withoutFields(fields: Array_Type<string>): ControlValvesModelableBase;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): ControlValvesModelableBase;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ControlValvesModelableBase;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ControlValvesModelableBase;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ControlValvesModelableBase;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ControlValvesModelableBase;
   ...
   * @see #removeField
   */
  unsetField(field: string): ControlValvesModelableBase;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ControlValvesModelableBase;
   ...
   * @see #unsetField
   */
  removeField(field: string): ControlValvesModelableBase;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ControlValvesModelableBase;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ControlValvesModelableBase;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): ControlValvesModelableBase;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ControlValvesModelableBase;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ControlValvesModelableBase;

  mergeJson(json: any): ControlValvesModelableBase;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ControlValvesModelableBase;
   ...
   */
  sumObj(other: Obj, deep?: boolean): ControlValvesModelableBase;
   ...
   */
  singletonArray(): Array_Type<ControlValvesModelableBase>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<ControlValvesModelableBase> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ControlValvesModelableBase> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<ControlValvesModelableBase>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ControlValvesModelableBase> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, ControlValvesModelableBase> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ControlValvesModelableBase> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ControlValvesModelableBase>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ControlValvesModelableBase>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ControlValvesModelableBase;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ControlValvesModelableBase;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ControlValvesModelableBase;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ControlValvesModelableBase;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ControlValvesModelableBase;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ControlValvesModelableBase;
   ...
   * @see #fromString
   */
  static make(s: string): ControlValvesModelableBase | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ControlValvesModelableBase;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): ControlValvesModelableBase;
   ...
   */
  static cachedEmptyInst(): ControlValvesModelableBase;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<ControlValvesModelableBase> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): ControlValvesModelableBase;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<ControlValvesModelableBase>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<ControlValvesModelableBase>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<ControlValvesModelableBase> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ControlValvesModelableBase>> | null;
   ...
   */
  get(include?: string): ControlValvesModelableBase | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): ControlValvesModelableBase | null;
   ...
   */
  getMissing(spec: GetMissingSpec): ControlValvesModelableBase;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): ControlValvesModelableBase | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): ControlValvesModelableBase;
   ...
   * @see #toString
   */
  static fromString(s: string): ControlValvesModelableBase | null;
   ...
   */
  create(spec?: UpsertSpec): ControlValvesModelableBase | null;
   ...
   */
  static createBatch(objs: Array_Type<ControlValvesModelableBase>, spec?: UpsertSpec): ObjList<ControlValvesModelableBase> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<ControlValvesModelableBase>, spec?: CreateBatchObjStreamSpec): ObjList<ControlValvesModelableBase> | null;
   ...
   */
  update(srcObj?: ControlValvesModelableBase, spec?: UpsertSpec): ControlValvesModelableBase | null;
   ...
   */
  upsert(srcObj?: ControlValvesModelableBase, spec?: UpsertSpec): ControlValvesModelableBase | null;
   ...
   */
  merge(spec?: MergeSpec): ControlValvesModelableBase | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): ControlValvesModelableBase | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): ControlValvesModelableBase | null;
   ...
   */
  static updateBatch(objs: Array_Type<ControlValvesModelableBase>, srcObjs?: Array_Type<ControlValvesModelableBase>, spec?: UpsertSpec): ObjList<ControlValvesModelableBase> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<ControlValvesModelableBase> | null>, spec?: UpsertSpec): ObjList<ControlValvesModelableBase> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<ControlValvesModelableBase>, srcObjs?: Array_Type<ControlValvesModelableBase>, spec?: UpsertSpec): ObjList<ControlValvesModelableBase> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<ControlValvesModelableBase> | null>, spec?: UpsertSpec): ObjList<ControlValvesModelableBase> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<ControlValvesModelableBase>, spec?: TouchSpec): ObjList<ControlValvesModelableBase> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ControlValvesModelableBase>, spec?: MergeSpec): ObjList<ControlValvesModelableBase> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ControlValvesModelableBase>, mergeInclude: string, spec?: MergeSpec): ObjList<ControlValvesModelableBase> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<ControlValvesModelableBase> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ControlValvesModelableBase> | null;
   ...
   */
  static mergeAll(mergeObj: ControlValvesModelableBase, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: ControlValvesModelableBase, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<ControlValvesModelableBase>, spec?: UpsertSpec): ObjList<ControlValvesModelableBase> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<ControlValvesModelableBase>, spec?: UpsertSpec): ObjList<ControlValvesModelableBase> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): ControlValvesModelableBase | null;
   ...
   */
  static beforeCreate(objs: Array_Type<ControlValvesModelableBase>): ObjList<ControlValvesModelableBase>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<ControlValvesModelableBase>): ObjList<ControlValvesModelableBase>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<ControlValvesModelableBase>): ObjList<ControlValvesModelableBase>;
   ...
   */
  static afterCreate(objs: Array_Type<ControlValvesModelableBase>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<ControlValvesModelableBase>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<ControlValvesModelableBase>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<ControlValvesModelableBase>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ControlValvesModelableBase>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): ControlValvesModelableBase | null;
   ...
   */
  withoutIdentity(): ControlValvesModelableBase | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<ControlValvesModelableBase>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: ControlValvesModelableBase, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<ControlValvesModelableBase>, callback?: λFunction<ControlValvesModelableBase | null, ControlValvesModelableBase | null>): ObjList<ControlValvesModelableBase>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<ControlValvesModelableBase>, callback?: λFunction<ControlValvesModelableBase | null, ControlValvesModelableBase | null>): Array_Type<ObjError> | null;
