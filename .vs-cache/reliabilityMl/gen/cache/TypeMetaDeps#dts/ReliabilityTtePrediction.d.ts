// TypeScript definitions for the C3 type ReliabilityTtePrediction

/**
 * Represents a prediction related to the system's time-to-event (TTE), typically used to estimate the
 * remaining operational time until a failure, maintenance event, or any other significant system occurrence.
 * This entity is designed to store TTE predictions, along with associated upper and lower bounds to represent
 * the uncertainty in the prediction.
 * The `ReliabilityTtePrediction` entity combines time-series data functionality through the `TimedDataPoint` mixin
 * and metadata from `ReliabilityTtePredictionHeader`, allowing for both accurate prediction tracking over time and
 * inclusion of relevant metadata for system maintenance or reliability analysis.
 * For more information on additional data stored in this type, refer to the documentation for each field.
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityTtePrediction
 */
declare interface IReliabilityTtePrediction {
  ...
  parent: IReliabilityTtePredictionHeader;
  ...
  /**
   * The predicted value for the time-to-event (TTE). This field stores the primary output from the predictive model,
   * indicating the estimated time remaining until the event occurs (e.g., equipment failure or maintenance).
   * This is a required field and is typically the key value used to track the time-to-event prediction over time.
   *
   * ts(treatmentPath="parent.treatment") specifies the path to retrieve the treatment value from the parent entity,
   * which might represent any adjustments, business logic, or transformations that should be applied to the prediction.
   */
  value: number;

  /**
   * The upper bound for the time-to-event prediction.
   * This field defines the maximum possible value for the time-to-event estimate and represents the safety margin.
   * For instance, if the prediction is uncertain, the upper bound can indicate the latest possible time before the event.
   * It is useful in scenarios where risk management or precautionary measures require a safety margin.
   */
  valueUpperBound?: number;

  /**
   * The lower bound for the time-to-event prediction.
   * This field defines the minimum time until the event occurs and can be used to ensure the prediction does not fall
   * below a certain threshold. For example, it can help avoid underestimation in cases where the event cannot happen
   * before a specific time (e.g., certain maintenance intervals).
   */
 ...
 * For more information on additional data stored in this type, refer to the documentation for each field.
 *
 * @remarks this represents a made instance of ReliabilityTtePrediction
 */
declare class ReliabilityTtePrediction extends Obj  {

  /**
   * start date for the data point
   */
  readonly start: DateTime;
  withStart(start: DateTime | Date | string): ReliabilityTtePrediction;
  ...
  withOutlierCode(outlierCode: number | null): ReliabilityTtePrediction;

  /**
   * (Optional) any comments for the data point
   */
  readonly comments?: string;
  withComments(comments: string | null): ReliabilityTtePrediction;

  /**
   * Denotes if the value is an actual value or an estimated value. default = null (actual value)
   */
  readonly isEstimated?: boolean;
  withIsEstimated(isEstimated: boolean): ReliabilityTtePrediction;
  ...
  withDataVersion(dataVersion: number | null): ReliabilityTtePrediction;

  /**
   * Customer specific status code for the data point (may be used to denote data quality)
   */
  readonly statusCode?: string;
  withStatusCode(statusCode: string | null): ReliabilityTtePrediction;

  /**
   * Partition key Bin separator used to separate partition key from bin id
   */
  readonly PK_BIN_SEPARATOR?: string;
  withPK_BIN_SEPARATOR(PK_BIN_SEPARATOR: string | null): ReliabilityTtePrediction;

  readonly parent: ReliabilityTtePredictionHeader;
  withParent(parent: IReliabilityTtePredictionHeader): ReliabilityTtePrediction;
  ...
  withTypeIdent(typeIdent: string | null): ReliabilityTtePrediction;
   ...
   */
  readonly id: string;
  withId(id: string): ReliabilityTtePrediction;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityTtePrediction;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): ReliabilityTtePrediction;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): ReliabilityTtePrediction;
  ...
  withVersion(version: number | null): ReliabilityTtePrediction;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): ReliabilityTtePrediction;
  ...
  withValue(value: number): ReliabilityTtePrediction;
  ...
  withValueUpperBound(valueUpperBound: number | null): ReliabilityTtePrediction;
  ...
  withValueLowerBound(valueLowerBound: number | null): ReliabilityTtePrediction;
   ...
   * @see #toJson
   */
  static fromJson(json: any): ReliabilityTtePrediction | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): ReliabilityTtePrediction | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): ReliabilityTtePrediction | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): ReliabilityTtePrediction | null;
   ...
   */
  replaceType(old: Type, new_: Type): ReliabilityTtePrediction;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityTtePrediction;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityTtePrediction;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityTtePrediction>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityTtePrediction>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityTtePrediction;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityTtePrediction;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityTtePrediction;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ReliabilityTtePrediction;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ReliabilityTtePrediction;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityTtePrediction;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityTtePrediction;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityTtePrediction;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ReliabilityTtePrediction;
   ...
   * @see #removeField
   */
  withoutField(field: string): ReliabilityTtePrediction;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): ReliabilityTtePrediction;
   ...
   */
  withoutFields(fields: Array_Type<string>): ReliabilityTtePrediction;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityTtePrediction;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ReliabilityTtePrediction;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityTtePrediction;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ReliabilityTtePrediction;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ReliabilityTtePrediction;
   ...
   * @see #removeField
   */
  unsetField(field: string): ReliabilityTtePrediction;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ReliabilityTtePrediction;
   ...
   * @see #unsetField
   */
  removeField(field: string): ReliabilityTtePrediction;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ReliabilityTtePrediction;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityTtePrediction;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityTtePrediction;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityTtePrediction;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityTtePrediction;

  mergeJson(json: any): ReliabilityTtePrediction;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityTtePrediction;
   ...
   */
  sumObj(other: Obj, deep?: boolean): ReliabilityTtePrediction;
   ...
   */
  singletonArray(): Array_Type<ReliabilityTtePrediction>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityTtePrediction> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ReliabilityTtePrediction> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<ReliabilityTtePrediction>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ReliabilityTtePrediction> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, ReliabilityTtePrediction> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityTtePrediction> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ReliabilityTtePrediction>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ReliabilityTtePrediction>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityTtePrediction;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityTtePrediction;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityTtePrediction;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ReliabilityTtePrediction;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityTtePrediction;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ReliabilityTtePrediction;
   ...
   * @see #fromString
   */
  static make(s: string): ReliabilityTtePrediction | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityTtePrediction;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): ReliabilityTtePrediction;
   ...
   */
  static cachedEmptyInst(): ReliabilityTtePrediction;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityTtePrediction> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): ReliabilityTtePrediction;

  /**
   * Extract the partition key from the given obj
   */
  partitionKey(failIfMissing?: boolean): ReliabilityTtePredictionHeader | null;
   ...
   */
  static partition(objs?: Stream<ReliabilityTtePrediction>, spec?: PartitionBucketStrategy): Map_Type<string, KvDataPartition> | null;
   ...
   */
  static fromPartitions(partitions?: Stream<KvDataPartition>): Stream<ReliabilityTtePrediction> | null;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<ReliabilityTtePrediction>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<ReliabilityTtePrediction>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityTtePrediction> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityTtePrediction>> | null;
   ...
   */
  get(include?: string): ReliabilityTtePrediction | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): ReliabilityTtePrediction | null;
   ...
   */
  getMissing(spec: GetMissingSpec): ReliabilityTtePrediction;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): ReliabilityTtePrediction | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): ReliabilityTtePrediction;
   ...
   * @see #toString
   */
  static fromString(s: string): ReliabilityTtePrediction | null;
   ...
   */
  create(spec?: UpsertSpec): ReliabilityTtePrediction | null;
   ...
   */
  static createBatch(objs: Array_Type<ReliabilityTtePrediction>, spec?: UpsertSpec): ObjList<ReliabilityTtePrediction> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<ReliabilityTtePrediction>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityTtePrediction> | null;
   ...
   */
  update(srcObj?: ReliabilityTtePrediction, spec?: UpsertSpec): ReliabilityTtePrediction | null;
   ...
   */
  upsert(srcObj?: ReliabilityTtePrediction, spec?: UpsertSpec): ReliabilityTtePrediction | null;
   ...
   */
  merge(spec?: MergeSpec): ReliabilityTtePrediction | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): ReliabilityTtePrediction | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): ReliabilityTtePrediction | null;
   ...
   */
  static updateBatch(objs: Array_Type<ReliabilityTtePrediction>, srcObjs?: Array_Type<ReliabilityTtePrediction>, spec?: UpsertSpec): ObjList<ReliabilityTtePrediction> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<ReliabilityTtePrediction> | null>, spec?: UpsertSpec): ObjList<ReliabilityTtePrediction> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<ReliabilityTtePrediction>, srcObjs?: Array_Type<ReliabilityTtePrediction>, spec?: UpsertSpec): ObjList<ReliabilityTtePrediction> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<ReliabilityTtePrediction> | null>, spec?: UpsertSpec): ObjList<ReliabilityTtePrediction> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<ReliabilityTtePrediction>, spec?: TouchSpec): ObjList<ReliabilityTtePrediction> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityTtePrediction>, spec?: MergeSpec): ObjList<ReliabilityTtePrediction> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityTtePrediction>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityTtePrediction> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<ReliabilityTtePrediction> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityTtePrediction> | null;
   ...
   */
  static mergeAll(mergeObj: ReliabilityTtePrediction, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: ReliabilityTtePrediction, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<ReliabilityTtePrediction>, spec?: UpsertSpec): ObjList<ReliabilityTtePrediction> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<ReliabilityTtePrediction>, spec?: UpsertSpec): ObjList<ReliabilityTtePrediction> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): ReliabilityTtePrediction | null;
   ...
   */
  static beforeCreate(objs: Array_Type<ReliabilityTtePrediction>): ObjList<ReliabilityTtePrediction>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<ReliabilityTtePrediction>): ObjList<ReliabilityTtePrediction>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<ReliabilityTtePrediction>): ObjList<ReliabilityTtePrediction>;
   ...
   */
  static afterCreate(objs: Array_Type<ReliabilityTtePrediction>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<ReliabilityTtePrediction>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<ReliabilityTtePrediction>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityTtePrediction>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityTtePrediction>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): ReliabilityTtePrediction | null;
   ...
   */
  withoutIdentity(): ReliabilityTtePrediction | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<ReliabilityTtePrediction>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: ReliabilityTtePrediction, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<ReliabilityTtePrediction>, callback?: λFunction<ReliabilityTtePrediction | null, ReliabilityTtePrediction | null>): ObjList<ReliabilityTtePrediction>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<ReliabilityTtePrediction>, callback?: λFunction<ReliabilityTtePrediction | null, ReliabilityTtePrediction | null>): Array_Type<ObjError> | null;
