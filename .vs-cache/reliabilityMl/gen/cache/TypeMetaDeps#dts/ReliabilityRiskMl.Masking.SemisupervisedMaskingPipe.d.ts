// TypeScript definitions for the C3 type ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe
 */
declare namespace ReliabilityRiskMl.Masking {
  export interface ISemisupervisedMaskingPipe {
 ...
 */
declare namespace ReliabilityRiskMl.Masking {
  export class SemisupervisedMaskingPipe extends Obj  {
     ...
     */
    readonly id: string;
    withId(id: string): ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe;

    /**
     * Name of this pipe.
     */
    readonly name?: string;
    withName(name: string | null): ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe;
    ...
    withVersion(version: number | null): ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe;
    ...
    withUserUpdatedFields(userUpdatedFields: Array_Type<string> | Array<string> | null): ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe;
    ...
    withHidden(hidden: boolean): ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe;
    ...
    withUserOwned(userOwned: boolean): ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe;
    ...
    withTypeIdent(typeIdent: string | null): ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe;

    /**
     * If true, then the pipe shall not be retrained
     */
    readonly frozen?: boolean;
    withFrozen(frozen: boolean): ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe;

    /**
     * True if training has succeeded and false otherwise.
     */
    readonly trained?: boolean;
    withTrained(trained: boolean): ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe;

    /**
     * Errors from training.
     */
    readonly trainingErrors?: string;
    withTrainingErrors(trainingErrors: string | null): ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe;

    /**
     * If true, the underlying model only accepts flattened input.
     */
    readonly flattenInput?: boolean;
    withFlattenInput(flattenInput: boolean): ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe;

    /**
     * The hyperparameters overridden of a native model or pipe.
     */
    readonly hyperparamOverrides?: Map_Type<string, any>;
    withHyperparamOverrides(hyperparamOverrides: Map_Type<string, any> | {[key: string]: any} | null): ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe;
    ...
    withHyperparamSearchSpace(hyperparamSearchSpace: IHp.SearchSpace | null): ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe;
    ...
    withHpoSpec(hpoSpec: IHpo.Spec | null): ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe;

    /**
     * {@link Hpo.Experiment} stores the result of hyperparameter optimization to find the best model/pipeline.
     */
    readonly hpoExperiment?: Hpo.Experiment;
    withHpoExperiment(hpoExperiment: IHpo.Experiment | null): ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe;

    /**
     * Reference to the experiment that produced this {@link MlPipe}. For example, this could be a {@link Hpo.ExperimentBase}.
     */
    readonly experiment?: any;
    withExperiment(experiment: any | null): ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe;
    ...
    withModelFiles(modelFiles: Map_Type<string, Url> | {[key: string]: IUrl} | null): ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe;
    ...
    withCustomModelCode(customModelCode: Map_Type<string, any> | {[key: string]: any} | null): ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe;

    /**
     * Name for the function on the native model to call to do {@link MlProcessable#process}.
     */
    readonly processFunc?: string;
    withProcessFunc(processFunc: string | null): ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe;
    ...
    withUnderlyingPipe(underlyingPipe: IMlAtomicPipe<any, any, any> | null): ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe;
     ...
     * @see #toJson
     */
    static fromJson(json: any): ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe | null;
     ...
     */
    replaceType(old: Type, new_: Type): ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe;
     ...
     * @see #removeField
     */
    withoutField(field: string): ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe;
     ...
     */
    withoutFields(fields: Array_Type<string>): ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe;
     ...
     * @see #unsetField
     */
    defaultField(field: string): ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe;
     ...
     * @see #removeField
     */
    unsetField(field: string): ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe;
     ...
     * @see #unsetField
     */
    removeField(field: string): ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe;

    mergeJson(json: any): ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe;
     ...
     */
    sumObj(other: Obj, deep?: boolean): ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe;
     ...
     */
    singletonArray(): Array_Type<ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe;
     ...
     * @see #fromString
     */
    static make(s: string): ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe;
     ...
     */
    static cachedEmptyInst(): ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe;
     ...
     */
    remakeTemplate(): ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe;
     ...
     */
    withoutIdentity(): ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe;
     ...
     */
    trainSync(x: , y?: , spec?: MlOperationSpec): ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe;
     ...
     */
    static allCached(doNotProduceAll?: boolean): Stream<ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe> | null;
     ...
     */
    static find(filter?: string, doNotProduceAll?: boolean): Stream<ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe> | null;
     ...
     * @return existing instances of this type that satisfy filter from data cache.
     */
    static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe> | null;
     ...
     * @see getCached
     */
    static findByCacheKey(key: string): ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe | null;
     ...
     * @see findByCacheKey
     */
    static forCacheKey(key: string): ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe | null;
     ...
     * @see findByCacheKey
     */
    getCached(): ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe | null;

    /**
     * @return newly produced cached instance.
     */
    refreshCache(): ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe | null;
     ...
     */
    static produce(key: string): ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe | null;
     ...
     */
    static produceAll(): Map_Type<string, ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe> | null;

    /**
     * Override for sub-types to produce all values.
     */
    static doProduceAll(): Map_Type<string, ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe> | null;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe>> | null;
     ...
     */
    get(include?: string): ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe | null;
     ...
     */
    getMissing(spec: GetMissingSpec): ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe;
     ...
     * @see #toString
     */
    static fromString(s: string): ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe | null;
     ...
     */
    create(spec?: UpsertSpec): ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe | null;
     ...
     */
    static createBatch(objs: Array_Type<ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe> | null;
     ...
     */
    update(srcObj?: ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe, spec?: UpsertSpec): ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe | null;
     ...
     */
    upsert(srcObj?: ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe, spec?: UpsertSpec): ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe | null;
     ...
     */
    merge(spec?: MergeSpec): ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe | null;
     ...
     */
    static updateBatch(objs: Array_Type<ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe>, srcObjs?: Array_Type<ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe> | null>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe>, srcObjs?: Array_Type<ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe> | null>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe>, spec?: TouchSpec): ObjList<ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe>, spec?: MergeSpec): ObjList<ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe> | null;
     ...
     */
    static mergeAll(mergeObj: ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe | null;
     ...
     */
    static beforeCreate(objs: Array_Type<ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe>): ObjList<ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe>;
     ...
     */
    static beforeUpdate(objs: Array_Type<ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe>): ObjList<ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe>): ObjList<ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe>;
     ...
     */
    static afterCreate(objs: Array_Type<ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe>, callback?: λFunction<ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe | null, ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe | null>): ObjList<ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe>, callback?: λFunction<ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe | null, ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe | null>): Array_Type<ObjError> | null;
     ...
     */
    publish(subPath?: string, contentType?: string): ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe;
     ...
     */
    static removeSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe> | null;
     ...
     */
    createSeedData(spec?: UpsertSpec): ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe | null;
     ...
     */
    static createSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe> | null;
     ...
     */
    updateSeedData(srcObj?: SeedData, spec?: UpsertSpec): ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe | null;
     ...
     */
    static updateSeedDataBatch(objs?: Array_Type<SeedData>, srcObjs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe> | null;
     ...
     * @return updated obj instance, same as {@link Persistable#update} return value.
     */
    clearUserUpdates(spec?: MergeSpec): ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe | null;
     ...
     *         {@link Persistable#updateBatch}.
     */
    static clearUserUpdatesBatch(objs?: Array_Type<SeedData>, spec?: MergeSpec): ObjList<ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe> | null;
    ...
    dependencies(): SeedDataDeps<ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe> | null;
     ...
     */
    static convert(model: any, spec?: MlConvertSpec): ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe;

    /**
     * Freezes an {@link MlPipe}
     * @return modified copy of this {@link MlPipe} that cannot be trained
     */
    freeze(): ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe;

    /**
     * Unfreezes an {@link MlPipe}
     * @return modified copy of this {@link MlPipe} that can be trained
     */
    unfreeze(): ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe;
     ...
     * be returned as-is.
     */
    byReference(): ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe;
     ...
     */
    updateModelFiles(modelFiles: Map_Type<string, Url>, spec?: MlOperationSpec): ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe;
     ...
     */
    afterTrain(doTrainOutputs: any, spec?: MlOperationSpec): ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe;
     ...
     */
    withNewSpec(spec?: MlConvertSpec): ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe;
     ...
     */
    afterConvert(model: any, spec?: MlConvertSpec): ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe;
     ...
     */
    withHyperparamSpaces(paramSpaces: Map_Type<string, Hp.ParamSpace>): ReliabilityRiskMl.Masking.SemisupervisedMaskingPipe;
