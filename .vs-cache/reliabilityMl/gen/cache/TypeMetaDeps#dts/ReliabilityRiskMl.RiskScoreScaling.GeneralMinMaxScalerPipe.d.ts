// TypeScript definitions for the C3 type ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe

/**
 * `ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe` is an extendable entity type designed
 * to apply a general Min-Max scaling technique to the risk scores in the context of reliability risk analysis.
 * This type scales the risk scores by transforming them into a predefined range (typically [0, 1]).
 * The general Min-Max scaler allows for flexible and efficient normalization of risk scores and related features.
 *
 * The transformation can either be applied inplace or on a copy of the input data, and can optionally clip
 * values to the range [0, 1] after transformation.
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe
 */
declare namespace ReliabilityRiskMl.RiskScoreScaling {
  export interface IGeneralMinMaxScalerPipe {
    ...
    /**
     * If enabled, the scaling will be performed on a copy of the input data.
     * Otherwise, the scaling will be performed inplace on the original data.
     * Default is true, meaning the scaling will be done on a copy to avoid modifying the original input.
     */
    copy?: boolean;

    /**
     * If enabled, the scaled values will be clipped to the range [0, 1].
     * This can be useful for ensuring that the transformed values do not fall outside this range.
     * Default is true, meaning clipping will be performed to ensure the values stay within [0, 1].
     */
    clip?: boolean;
  }
}
 ...
 * values to the range [0, 1] after transformation.
 *
 * @remarks this represents a made instance of ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe
 */
declare namespace ReliabilityRiskMl.RiskScoreScaling {
  export class GeneralMinMaxScalerPipe extends Obj  {
     ...
     */
    readonly id: string;
    withId(id: string): ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe;

    /**
     * Name of this pipe.
     */
    readonly name?: string;
    withName(name: string | null): ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe;
    ...
    withVersion(version: number | null): ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe;
    ...
    withUserUpdatedFields(userUpdatedFields: Array_Type<string> | Array<string> | null): ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe;
    ...
    withHidden(hidden: boolean): ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe;
    ...
    withUserOwned(userOwned: boolean): ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe;
    ...
    withTypeIdent(typeIdent: string | null): ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe;

    /**
     * If true, then the pipe shall not be retrained
     */
    readonly frozen?: boolean;
    withFrozen(frozen: boolean): ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe;

    /**
     * True if training has succeeded and false otherwise.
     */
    readonly trained?: boolean;
    withTrained(trained: boolean): ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe;

    /**
     * Errors from training.
     */
    readonly trainingErrors?: string;
    withTrainingErrors(trainingErrors: string | null): ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe;

    /**
     * If true, the underlying model only accepts flattened input.
     */
    readonly flattenInput?: boolean;
    withFlattenInput(flattenInput: boolean): ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe;

    /**
     * The hyperparameters overridden of a native model or pipe.
     */
    readonly hyperparamOverrides?: Map_Type<string, any>;
    withHyperparamOverrides(hyperparamOverrides: Map_Type<string, any> | {[key: string]: any} | null): ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe;
    ...
    withHyperparamSearchSpace(hyperparamSearchSpace: IHp.SearchSpace | null): ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe;
    ...
    withHpoSpec(hpoSpec: IHpo.Spec | null): ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe;

    /**
     * {@link Hpo.Experiment} stores the result of hyperparameter optimization to find the best model/pipeline.
     */
    readonly hpoExperiment?: Hpo.Experiment;
    withHpoExperiment(hpoExperiment: IHpo.Experiment | null): ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe;

    /**
     * Reference to the experiment that produced this {@link MlPipe}. For example, this could be a {@link Hpo.ExperimentBase}.
     */
    readonly experiment?: any;
    withExperiment(experiment: any | null): ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe;
    ...
    withModelFiles(modelFiles: Map_Type<string, Url> | {[key: string]: IUrl} | null): ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe;
    ...
    withCustomModelCode(customModelCode: Map_Type<string, any> | {[key: string]: any} | null): ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe;

    /**
     * Name for the function on the native model to call to do {@link MlProcessable#process}.
     */
    readonly processFunc?: string;
    withProcessFunc(processFunc: string | null): ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe;
    ...
    withUnderlyingPipe(underlyingPipe: IMlAtomicPipe<any, any, any> | null): ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe;
    ...
    withLookbackDuration(lookbackDuration: IDuration | null): ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe;
    ...
    withCopy(copy: boolean): ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe;
    ...
    withClip(clip: boolean): ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe;
     ...
     * @see #toJson
     */
    static fromJson(json: any): ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe | null;
     ...
     */
    replaceType(old: Type, new_: Type): ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe;
     ...
     * @see #removeField
     */
    withoutField(field: string): ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe;
     ...
     */
    withoutFields(fields: Array_Type<string>): ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe;
     ...
     * @see #unsetField
     */
    defaultField(field: string): ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe;
     ...
     * @see #removeField
     */
    unsetField(field: string): ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe;
     ...
     * @see #unsetField
     */
    removeField(field: string): ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe;

    mergeJson(json: any): ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe;
     ...
     */
    sumObj(other: Obj, deep?: boolean): ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe;
     ...
     */
    singletonArray(): Array_Type<ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe;
     ...
     * @see #fromString
     */
    static make(s: string): ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe;
     ...
     */
    static cachedEmptyInst(): ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe;
     ...
     */
    remakeTemplate(): ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe;
     ...
     */
    withoutIdentity(): ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe;
     ...
     */
    trainSync(x: , y?: , spec?: MlOperationSpec): ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe;
     ...
     */
    static allCached(doNotProduceAll?: boolean): Stream<ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe> | null;
     ...
     */
    static find(filter?: string, doNotProduceAll?: boolean): Stream<ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe> | null;
     ...
     * @return existing instances of this type that satisfy filter from data cache.
     */
    static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe> | null;
     ...
     * @see getCached
     */
    static findByCacheKey(key: string): ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe | null;
     ...
     * @see findByCacheKey
     */
    static forCacheKey(key: string): ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe | null;
     ...
     * @see findByCacheKey
     */
    getCached(): ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe | null;

    /**
     * @return newly produced cached instance.
     */
    refreshCache(): ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe | null;
     ...
     */
    static produce(key: string): ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe | null;
     ...
     */
    static produceAll(): Map_Type<string, ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe> | null;

    /**
     * Override for sub-types to produce all values.
     */
    static doProduceAll(): Map_Type<string, ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe> | null;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe>> | null;
     ...
     */
    get(include?: string): ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe | null;
     ...
     */
    getMissing(spec: GetMissingSpec): ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe;
     ...
     * @see #toString
     */
    static fromString(s: string): ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe | null;
     ...
     */
    create(spec?: UpsertSpec): ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe | null;
     ...
     */
    static createBatch(objs: Array_Type<ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe> | null;
     ...
     */
    update(srcObj?: ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe, spec?: UpsertSpec): ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe | null;
     ...
     */
    upsert(srcObj?: ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe, spec?: UpsertSpec): ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe | null;
     ...
     */
    merge(spec?: MergeSpec): ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe | null;
     ...
     */
    static updateBatch(objs: Array_Type<ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe>, srcObjs?: Array_Type<ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe> | null>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe>, srcObjs?: Array_Type<ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe> | null>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe>, spec?: TouchSpec): ObjList<ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe>, spec?: MergeSpec): ObjList<ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe> | null;
     ...
     */
    static mergeAll(mergeObj: ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe | null;
     ...
     */
    static beforeCreate(objs: Array_Type<ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe>): ObjList<ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe>;
     ...
     */
    static beforeUpdate(objs: Array_Type<ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe>): ObjList<ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe>): ObjList<ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe>;
     ...
     */
    static afterCreate(objs: Array_Type<ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe>, callback?: λFunction<ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe | null, ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe | null>): ObjList<ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe>, callback?: λFunction<ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe | null, ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe | null>): Array_Type<ObjError> | null;
     ...
     */
    publish(subPath?: string, contentType?: string): ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe;
     ...
     */
    static removeSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe> | null;
     ...
     */
    createSeedData(spec?: UpsertSpec): ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe | null;
     ...
     */
    static createSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe> | null;
     ...
     */
    updateSeedData(srcObj?: SeedData, spec?: UpsertSpec): ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe | null;
     ...
     */
    static updateSeedDataBatch(objs?: Array_Type<SeedData>, srcObjs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe> | null;
     ...
     * @return updated obj instance, same as {@link Persistable#update} return value.
     */
    clearUserUpdates(spec?: MergeSpec): ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe | null;
     ...
     *         {@link Persistable#updateBatch}.
     */
    static clearUserUpdatesBatch(objs?: Array_Type<SeedData>, spec?: MergeSpec): ObjList<ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe> | null;
    ...
    dependencies(): SeedDataDeps<ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe> | null;
     ...
     */
    static convert(model: any, spec?: MlConvertSpec): ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe;

    /**
     * Freezes an {@link MlPipe}
     * @return modified copy of this {@link MlPipe} that cannot be trained
     */
    freeze(): ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe;

    /**
     * Unfreezes an {@link MlPipe}
     * @return modified copy of this {@link MlPipe} that can be trained
     */
    unfreeze(): ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe;
     ...
     * be returned as-is.
     */
    byReference(): ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe;
     ...
     */
    updateModelFiles(modelFiles: Map_Type<string, Url>, spec?: MlOperationSpec): ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe;
    ...
    /**
     * This method invokes the `fit()` method on the native model, which is responsible for fitting the scaler
     * to the data. The `fit()` method computes the scaling parameters (e.g., minimum and maximum values) from
     * the input data.
     *
     * The `doTrain` method is implemented using `py-sklearn`, which suggests that the scaling model is
     * trained using the `MinMaxScaler` from the `sklearn.preprocessing` module in Python.
     */
     ...
     */
    afterTrain(doTrainOutputs: any, spec?: MlOperationSpec): ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe;
    ...
    /**
     * This method invokes the `transform()` method on the native model, which applies the learned scaling
     * transformation to the input data. After transformation, the input data is scaled to the range defined
     * by the Min-Max scaler.
     *
     * This is the key method that applies the transformation to the data and returns the scaled risk scores.
     */
     ...
     */
    withNewSpec(spec?: MlConvertSpec): ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe;
     ...
     */
    afterConvert(model: any, spec?: MlConvertSpec): ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe;
     ...
     */
    withHyperparamSpaces(paramSpaces: Map_Type<string, Hp.ParamSpace>): ReliabilityRiskMl.RiskScoreScaling.GeneralMinMaxScalerPipe;
    ...
    /**
     * This method generates the scaling pipeline using `py-sklearn`, a Python-based data science library.
     * The `py-sklearn` implementation likely leverages the `MinMaxScaler` functionality from Scikit-learn to
