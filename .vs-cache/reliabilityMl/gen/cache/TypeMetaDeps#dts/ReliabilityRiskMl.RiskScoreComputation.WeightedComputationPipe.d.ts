// TypeScript definitions for the C3 type ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe

/**
 * This type represents an {@link MlPipe} template that outputs a `riskScore` that is a weighted average of the
 * input residuals.
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe
 */
declare namespace ReliabilityRiskMl.RiskScoreComputation {
  export interface IWeightedComputationPipe {
    ...
    /**
     * A map of input column name to the weight to be applied to the absolute value in that column. All weights must be
     * positive and the default is 1. If a weight is negative, it will be automatically replaced with 1.
     ...
     * ```
     * {'INLET_PRESSURE_residual': 1.5}
     * ```
     */
    weights?: Map_Type<string, number> | {[key: string]: number};
  }
}
 ...
 * input residuals.
 *
 * @remarks this represents a made instance of ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe
 */
declare namespace ReliabilityRiskMl.RiskScoreComputation {
  export class WeightedComputationPipe extends Obj  {
     ...
     */
    readonly id: string;
    withId(id: string): ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe;

    /**
     * Name of this pipe.
     */
    readonly name?: string;
    withName(name: string | null): ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe;
    ...
    withVersion(version: number | null): ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe;
    ...
    withUserUpdatedFields(userUpdatedFields: Array_Type<string> | Array<string> | null): ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe;
    ...
    withHidden(hidden: boolean): ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe;
    ...
    withUserOwned(userOwned: boolean): ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe;
    ...
    withTypeIdent(typeIdent: string | null): ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe;

    /**
     * If true, then the pipe shall not be retrained
     */
    readonly frozen?: boolean;
    withFrozen(frozen: boolean): ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe;

    /**
     * True if training has succeeded and false otherwise.
     */
    readonly trained?: boolean;
    withTrained(trained: boolean): ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe;

    /**
     * Errors from training.
     */
    readonly trainingErrors?: string;
    withTrainingErrors(trainingErrors: string | null): ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe;

    /**
     * If true, the underlying model only accepts flattened input.
     */
    readonly flattenInput?: boolean;
    withFlattenInput(flattenInput: boolean): ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe;

    /**
     * The hyperparameters overridden of a native model or pipe.
     */
    readonly hyperparamOverrides?: Map_Type<string, any>;
    withHyperparamOverrides(hyperparamOverrides: Map_Type<string, any> | {[key: string]: any} | null): ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe;
    ...
    withHyperparamSearchSpace(hyperparamSearchSpace: IHp.SearchSpace | null): ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe;
    ...
    withHpoSpec(hpoSpec: IHpo.Spec | null): ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe;

    /**
     * {@link Hpo.Experiment} stores the result of hyperparameter optimization to find the best model/pipeline.
     */
    readonly hpoExperiment?: Hpo.Experiment;
    withHpoExperiment(hpoExperiment: IHpo.Experiment | null): ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe;

    /**
     * Reference to the experiment that produced this {@link MlPipe}. For example, this could be a {@link Hpo.ExperimentBase}.
     */
    readonly experiment?: any;
    withExperiment(experiment: any | null): ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe;
    ...
    withModelFiles(modelFiles: Map_Type<string, Url> | {[key: string]: IUrl} | null): ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe;
    ...
    withCustomModelCode(customModelCode: Map_Type<string, any> | {[key: string]: any} | null): ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe;

    /**
     * Name for the function on the native model to call to do {@link MlProcessable#process}.
     */
    readonly processFunc?: string;
    withProcessFunc(processFunc: string | null): ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe;
    ...
    withUnderlyingPipe(underlyingPipe: IMlAtomicPipe<any, any, any> | null): ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe;
    ...
    withIsTrainableOverride(isTrainableOverride: boolean): ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe;
    ...
    withLookbackDuration(lookbackDuration: IDuration | null): ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe;
     ...
     * ```
     */
    readonly weights?: Map_Type<string, number>;
    withWeights(weights: Map_Type<string, number> | {[key: string]: number} | null): ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe;
     ...
     * @see #toJson
     */
    static fromJson(json: any): ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe | null;
     ...
     */
    replaceType(old: Type, new_: Type): ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe;
     ...
     * @see #removeField
     */
    withoutField(field: string): ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe;
     ...
     */
    withoutFields(fields: Array_Type<string>): ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe;
     ...
     * @see #unsetField
     */
    defaultField(field: string): ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe;
     ...
     * @see #removeField
     */
    unsetField(field: string): ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe;
     ...
     * @see #unsetField
     */
    removeField(field: string): ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe;

    mergeJson(json: any): ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe;
     ...
     */
    sumObj(other: Obj, deep?: boolean): ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe;
     ...
     */
    singletonArray(): Array_Type<ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe;
     ...
     * @see #fromString
     */
    static make(s: string): ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe;
     ...
     */
    static cachedEmptyInst(): ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe;
     ...
     */
    remakeTemplate(): ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe;
     ...
     */
    withoutIdentity(): ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe;
     ...
     */
    trainSync(x: , y?: , spec?: MlOperationSpec): ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe;
     ...
     */
    static allCached(doNotProduceAll?: boolean): Stream<ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe> | null;
     ...
     */
    static find(filter?: string, doNotProduceAll?: boolean): Stream<ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe> | null;
     ...
     * @return existing instances of this type that satisfy filter from data cache.
     */
    static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe> | null;
     ...
     * @see getCached
     */
    static findByCacheKey(key: string): ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe | null;
     ...
     * @see findByCacheKey
     */
    static forCacheKey(key: string): ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe | null;
     ...
     * @see findByCacheKey
     */
    getCached(): ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe | null;

    /**
     * @return newly produced cached instance.
     */
    refreshCache(): ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe | null;
     ...
     */
    static produce(key: string): ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe | null;
     ...
     */
    static produceAll(): Map_Type<string, ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe> | null;

    /**
     * Override for sub-types to produce all values.
     */
    static doProduceAll(): Map_Type<string, ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe> | null;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe>> | null;
     ...
     */
    get(include?: string): ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe | null;
     ...
     */
    getMissing(spec: GetMissingSpec): ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe;
     ...
     * @see #toString
     */
    static fromString(s: string): ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe | null;
     ...
     */
    create(spec?: UpsertSpec): ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe | null;
     ...
     */
    static createBatch(objs: Array_Type<ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe> | null;
     ...
     */
    update(srcObj?: ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe, spec?: UpsertSpec): ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe | null;
     ...
     */
    upsert(srcObj?: ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe, spec?: UpsertSpec): ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe | null;
     ...
     */
    merge(spec?: MergeSpec): ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe | null;
     ...
     */
    static updateBatch(objs: Array_Type<ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe>, srcObjs?: Array_Type<ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe> | null>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe>, srcObjs?: Array_Type<ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe> | null>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe>, spec?: TouchSpec): ObjList<ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe>, spec?: MergeSpec): ObjList<ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe> | null;
     ...
     */
    static mergeAll(mergeObj: ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe | null;
     ...
     */
    static beforeCreate(objs: Array_Type<ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe>): ObjList<ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe>;
     ...
     */
    static beforeUpdate(objs: Array_Type<ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe>): ObjList<ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe>): ObjList<ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe>;
     ...
     */
    static afterCreate(objs: Array_Type<ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe>, callback?: λFunction<ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe | null, ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe | null>): ObjList<ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe>, callback?: λFunction<ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe | null, ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe | null>): Array_Type<ObjError> | null;
     ...
     */
    publish(subPath?: string, contentType?: string): ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe;
     ...
     */
    static removeSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe> | null;
     ...
     */
    createSeedData(spec?: UpsertSpec): ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe | null;
     ...
     */
    static createSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe> | null;
     ...
     */
    updateSeedData(srcObj?: SeedData, spec?: UpsertSpec): ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe | null;
     ...
     */
    static updateSeedDataBatch(objs?: Array_Type<SeedData>, srcObjs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe> | null;
     ...
     * @return updated obj instance, same as {@link Persistable#update} return value.
     */
    clearUserUpdates(spec?: MergeSpec): ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe | null;
     ...
     *         {@link Persistable#updateBatch}.
     */
    static clearUserUpdatesBatch(objs?: Array_Type<SeedData>, spec?: MergeSpec): ObjList<ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe> | null;
    ...
    dependencies(): SeedDataDeps<ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe> | null;
     ...
     */
    static convert(model: any, spec?: MlConvertSpec): ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe;

    /**
     * Freezes an {@link MlPipe}
     * @return modified copy of this {@link MlPipe} that cannot be trained
     */
    freeze(): ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe;

    /**
     * Unfreezes an {@link MlPipe}
     * @return modified copy of this {@link MlPipe} that can be trained
     */
    unfreeze(): ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe;
     ...
     * be returned as-is.
     */
    byReference(): ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe;
     ...
     */
    updateModelFiles(modelFiles: Map_Type<string, Url>, spec?: MlOperationSpec): ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe;
     ...
     */
    afterTrain(doTrainOutputs: any, spec?: MlOperationSpec): ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe;
     ...
     */
    withNewSpec(spec?: MlConvertSpec): ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe;
     ...
     */
    afterConvert(model: any, spec?: MlConvertSpec): ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe;
     ...
     */
    withHyperparamSpaces(paramSpaces: Map_Type<string, Hp.ParamSpace>): ReliabilityRiskMl.RiskScoreComputation.WeightedComputationPipe;
