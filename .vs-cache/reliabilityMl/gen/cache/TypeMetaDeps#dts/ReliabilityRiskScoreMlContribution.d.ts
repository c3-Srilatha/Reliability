// TypeScript definitions for the C3 type ReliabilityRiskScoreMlContribution

/**
 * Represents a machine learning model contribution score used in the context of reliability risk assessments.
 * This entity captures the contribution of various factors or variables to the overall risk score prediction,
 * with upper and lower bounds indicating the range of uncertainty for each contribution.
 *
 * The `ReliabilityRiskScoreMlContribution` entity is specifically designed for capturing the contributions
 * made by individual features or components to the overall risk score in a machine learning model, with the
 * ability to track how the contribution evolves over time.
 *
 * This entity is valuable for analyzing the relative importance of different model features, assessing
 * model predictions, and ensuring that risk assessments are accurate and actionable.
 *
 * For more details on each field and its usage, refer to the documentation below.
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityRiskScoreMlContribution
 */
declare interface IReliabilityRiskScoreMlContribution {
  ...
  parent: IReliabilityRiskScoreMlContributionHeader;
  ...
  /**
   * Represents the contribution value of the model's prediction, typically a numerical value
   * indicating the influence of a particular feature or variable in the model's output.
   * The value of the contribution is essential for understanding how different factors
   * influence the overall risk score or prediction. This field provides a way to track
   * the impact of specific components on the model's results.
   * ts(treatmentPath='parent.treatment') specifies the treatment path for any necessary transformations or
   * adjustments to the contribution value, ensuring that any changes to the parent entity’s state are reflected here.
   */
  contribution: number;

  /**
   * The upper bound for the contribution score. This defines the maximum possible value
   * for the contribution and represents the highest level of influence or risk that a factor
   * can have according to the model.
   *
   * This field helps to identify the upper limit of the contribution for specific variables, providing
   * a safety threshold or margin of uncertainty in the prediction.
   */
  contributionUpperBound?: number;

  /**
   * The lower bound for the contribution score. This defines the minimum possible value
   * for the contribution and indicates the least amount of impact or risk that the factor can have
   * on the model's prediction.
   *
   * This lower bound can be used for validation, ensuring that the contribution does not fall below
   * a certain threshold, providing greater confidence in the stability of the risk score model.
   */
 ...
 * For more details on each field and its usage, refer to the documentation below.
 *
 * @remarks this represents a made instance of ReliabilityRiskScoreMlContribution
 */
declare class ReliabilityRiskScoreMlContribution extends Obj  {

  /**
   * start date for the data point
   */
  readonly start: DateTime;
  withStart(start: DateTime | Date | string): ReliabilityRiskScoreMlContribution;
  ...
  withOutlierCode(outlierCode: number | null): ReliabilityRiskScoreMlContribution;

  /**
   * (Optional) any comments for the data point
   */
  readonly comments?: string;
  withComments(comments: string | null): ReliabilityRiskScoreMlContribution;

  /**
   * Denotes if the value is an actual value or an estimated value. default = null (actual value)
   */
  readonly isEstimated?: boolean;
  withIsEstimated(isEstimated: boolean): ReliabilityRiskScoreMlContribution;
  ...
  withDataVersion(dataVersion: number | null): ReliabilityRiskScoreMlContribution;

  /**
   * Customer specific status code for the data point (may be used to denote data quality)
   */
  readonly statusCode?: string;
  withStatusCode(statusCode: string | null): ReliabilityRiskScoreMlContribution;

  /**
   * Partition key Bin separator used to separate partition key from bin id
   */
  readonly PK_BIN_SEPARATOR?: string;
  withPK_BIN_SEPARATOR(PK_BIN_SEPARATOR: string | null): ReliabilityRiskScoreMlContribution;

  readonly parent: ReliabilityRiskScoreMlContributionHeader;
  withParent(parent: IReliabilityRiskScoreMlContributionHeader): ReliabilityRiskScoreMlContribution;
  ...
  withTypeIdent(typeIdent: string | null): ReliabilityRiskScoreMlContribution;
   ...
   */
  readonly id: string;
  withId(id: string): ReliabilityRiskScoreMlContribution;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityRiskScoreMlContribution;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): ReliabilityRiskScoreMlContribution;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): ReliabilityRiskScoreMlContribution;
  ...
  withVersion(version: number | null): ReliabilityRiskScoreMlContribution;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): ReliabilityRiskScoreMlContribution;
  ...
  withContribution(contribution: number): ReliabilityRiskScoreMlContribution;
  ...
  withContributionUpperBound(contributionUpperBound: number | null): ReliabilityRiskScoreMlContribution;
  ...
  withContributionLowerBound(contributionLowerBound: number | null): ReliabilityRiskScoreMlContribution;
   ...
   * @see #toJson
   */
  static fromJson(json: any): ReliabilityRiskScoreMlContribution | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): ReliabilityRiskScoreMlContribution | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): ReliabilityRiskScoreMlContribution | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): ReliabilityRiskScoreMlContribution | null;
   ...
   */
  replaceType(old: Type, new_: Type): ReliabilityRiskScoreMlContribution;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityRiskScoreMlContribution;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityRiskScoreMlContribution;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityRiskScoreMlContribution>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityRiskScoreMlContribution>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityRiskScoreMlContribution;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityRiskScoreMlContribution;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityRiskScoreMlContribution;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ReliabilityRiskScoreMlContribution;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ReliabilityRiskScoreMlContribution;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityRiskScoreMlContribution;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityRiskScoreMlContribution;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityRiskScoreMlContribution;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ReliabilityRiskScoreMlContribution;
   ...
   * @see #removeField
   */
  withoutField(field: string): ReliabilityRiskScoreMlContribution;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): ReliabilityRiskScoreMlContribution;
   ...
   */
  withoutFields(fields: Array_Type<string>): ReliabilityRiskScoreMlContribution;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityRiskScoreMlContribution;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ReliabilityRiskScoreMlContribution;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityRiskScoreMlContribution;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ReliabilityRiskScoreMlContribution;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ReliabilityRiskScoreMlContribution;
   ...
   * @see #removeField
   */
  unsetField(field: string): ReliabilityRiskScoreMlContribution;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ReliabilityRiskScoreMlContribution;
   ...
   * @see #unsetField
   */
  removeField(field: string): ReliabilityRiskScoreMlContribution;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ReliabilityRiskScoreMlContribution;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityRiskScoreMlContribution;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityRiskScoreMlContribution;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityRiskScoreMlContribution;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityRiskScoreMlContribution;

  mergeJson(json: any): ReliabilityRiskScoreMlContribution;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityRiskScoreMlContribution;
   ...
   */
  sumObj(other: Obj, deep?: boolean): ReliabilityRiskScoreMlContribution;
   ...
   */
  singletonArray(): Array_Type<ReliabilityRiskScoreMlContribution>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityRiskScoreMlContribution> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ReliabilityRiskScoreMlContribution> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<ReliabilityRiskScoreMlContribution>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ReliabilityRiskScoreMlContribution> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, ReliabilityRiskScoreMlContribution> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityRiskScoreMlContribution> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ReliabilityRiskScoreMlContribution>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ReliabilityRiskScoreMlContribution>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityRiskScoreMlContribution;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityRiskScoreMlContribution;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityRiskScoreMlContribution;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ReliabilityRiskScoreMlContribution;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityRiskScoreMlContribution;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ReliabilityRiskScoreMlContribution;
   ...
   * @see #fromString
   */
  static make(s: string): ReliabilityRiskScoreMlContribution | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityRiskScoreMlContribution;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): ReliabilityRiskScoreMlContribution;
   ...
   */
  static cachedEmptyInst(): ReliabilityRiskScoreMlContribution;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityRiskScoreMlContribution> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): ReliabilityRiskScoreMlContribution;

  /**
   * Extract the partition key from the given obj
   */
  partitionKey(failIfMissing?: boolean): ReliabilityRiskScoreMlContributionHeader | null;
   ...
   */
  static partition(objs?: Stream<ReliabilityRiskScoreMlContribution>, spec?: PartitionBucketStrategy): Map_Type<string, KvDataPartition> | null;
   ...
   */
  static fromPartitions(partitions?: Stream<KvDataPartition>): Stream<ReliabilityRiskScoreMlContribution> | null;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<ReliabilityRiskScoreMlContribution>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<ReliabilityRiskScoreMlContribution>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityRiskScoreMlContribution> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityRiskScoreMlContribution>> | null;
   ...
   */
  get(include?: string): ReliabilityRiskScoreMlContribution | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): ReliabilityRiskScoreMlContribution | null;
   ...
   */
  getMissing(spec: GetMissingSpec): ReliabilityRiskScoreMlContribution;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): ReliabilityRiskScoreMlContribution | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): ReliabilityRiskScoreMlContribution;
   ...
   * @see #toString
   */
  static fromString(s: string): ReliabilityRiskScoreMlContribution | null;
   ...
   */
  create(spec?: UpsertSpec): ReliabilityRiskScoreMlContribution | null;
   ...
   */
  static createBatch(objs: Array_Type<ReliabilityRiskScoreMlContribution>, spec?: UpsertSpec): ObjList<ReliabilityRiskScoreMlContribution> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<ReliabilityRiskScoreMlContribution>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityRiskScoreMlContribution> | null;
   ...
   */
  update(srcObj?: ReliabilityRiskScoreMlContribution, spec?: UpsertSpec): ReliabilityRiskScoreMlContribution | null;
   ...
   */
  upsert(srcObj?: ReliabilityRiskScoreMlContribution, spec?: UpsertSpec): ReliabilityRiskScoreMlContribution | null;
   ...
   */
  merge(spec?: MergeSpec): ReliabilityRiskScoreMlContribution | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): ReliabilityRiskScoreMlContribution | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): ReliabilityRiskScoreMlContribution | null;
   ...
   */
  static updateBatch(objs: Array_Type<ReliabilityRiskScoreMlContribution>, srcObjs?: Array_Type<ReliabilityRiskScoreMlContribution>, spec?: UpsertSpec): ObjList<ReliabilityRiskScoreMlContribution> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<ReliabilityRiskScoreMlContribution> | null>, spec?: UpsertSpec): ObjList<ReliabilityRiskScoreMlContribution> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<ReliabilityRiskScoreMlContribution>, srcObjs?: Array_Type<ReliabilityRiskScoreMlContribution>, spec?: UpsertSpec): ObjList<ReliabilityRiskScoreMlContribution> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<ReliabilityRiskScoreMlContribution> | null>, spec?: UpsertSpec): ObjList<ReliabilityRiskScoreMlContribution> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<ReliabilityRiskScoreMlContribution>, spec?: TouchSpec): ObjList<ReliabilityRiskScoreMlContribution> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityRiskScoreMlContribution>, spec?: MergeSpec): ObjList<ReliabilityRiskScoreMlContribution> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityRiskScoreMlContribution>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityRiskScoreMlContribution> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<ReliabilityRiskScoreMlContribution> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityRiskScoreMlContribution> | null;
   ...
   */
  static mergeAll(mergeObj: ReliabilityRiskScoreMlContribution, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: ReliabilityRiskScoreMlContribution, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<ReliabilityRiskScoreMlContribution>, spec?: UpsertSpec): ObjList<ReliabilityRiskScoreMlContribution> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<ReliabilityRiskScoreMlContribution>, spec?: UpsertSpec): ObjList<ReliabilityRiskScoreMlContribution> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): ReliabilityRiskScoreMlContribution | null;
   ...
   */
  static beforeCreate(objs: Array_Type<ReliabilityRiskScoreMlContribution>): ObjList<ReliabilityRiskScoreMlContribution>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<ReliabilityRiskScoreMlContribution>): ObjList<ReliabilityRiskScoreMlContribution>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<ReliabilityRiskScoreMlContribution>): ObjList<ReliabilityRiskScoreMlContribution>;
   ...
   */
  static afterCreate(objs: Array_Type<ReliabilityRiskScoreMlContribution>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<ReliabilityRiskScoreMlContribution>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<ReliabilityRiskScoreMlContribution>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityRiskScoreMlContribution>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityRiskScoreMlContribution>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): ReliabilityRiskScoreMlContribution | null;
   ...
   */
  withoutIdentity(): ReliabilityRiskScoreMlContribution | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<ReliabilityRiskScoreMlContribution>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: ReliabilityRiskScoreMlContribution, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<ReliabilityRiskScoreMlContribution>, callback?: λFunction<ReliabilityRiskScoreMlContribution | null, ReliabilityRiskScoreMlContribution | null>): ObjList<ReliabilityRiskScoreMlContribution>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<ReliabilityRiskScoreMlContribution>, callback?: λFunction<ReliabilityRiskScoreMlContribution | null, ReliabilityRiskScoreMlContribution | null>): Array_Type<ObjError> | null;
