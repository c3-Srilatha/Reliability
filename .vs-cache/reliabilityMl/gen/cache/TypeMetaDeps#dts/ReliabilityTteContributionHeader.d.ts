// TypeScript definitions for the C3 type ReliabilityTteContributionHeader
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityTteContributionHeader
 */
declare interface IReliabilityTteContributionHeader {
   ...
   */
  data?: Array_Type<ReliabilityTteContribution> | Array<IReliabilityTteContribution>;
 ...
 */
declare class ReliabilityTteContributionHeader extends Obj  {

  /**
   * Populated on normalization. Indicates the earliest data point across various timeseries fields.
   */
  readonly earliest?: DateTime;
  withEarliest(earliest: DateTime | Date | string | null): ReliabilityTteContributionHeader;

  /**
   * Populated on normalization. Indicates the latest data point across various timeseries fields.
   */
  readonly latest?: DateTime;
  withLatest(latest: DateTime | Date | string | null): ReliabilityTteContributionHeader;

  /**
   * Populated on normalization. Indicates the earliest data point for each {@link Ann.Ts} fields.
   */
  readonly earliestTsDp?: Map_Type<string, TSDataPoint>;
  withEarliestTsDp(earliestTsDp: Map_Type<string, TSDataPoint> | {[key: string]: ITSDataPoint} | null): ReliabilityTteContributionHeader;

  /**
   * Populated on normalization. Indicates the latest data point for each {@link Ann.Ts} fields.
   */
  readonly latestTsDp?: Map_Type<string, TSDataPoint>;
  withLatestTsDp(latestTsDp: Map_Type<string, TSDataPoint> | {[key: string]: ITSDataPoint} | null): ReliabilityTteContributionHeader;
  ...
  withInterval(interval: string | null): ReliabilityTteContributionHeader;
  ...
  withTimeZone(timeZone: string | null): ReliabilityTteContributionHeader;

  /**
   * If set, disables normalizing this time series. Invalidations will still continue to happen for this series normally.
   */
  readonly doNotNormalize?: boolean;
  withDoNotNormalize(doNotNormalize: boolean): ReliabilityTteContributionHeader;

  /**
   * Data points corresponding to this timeseries header
   */
  readonly data?: Array_Type<ReliabilityTteContribution>;
  withData(data: Array_Type<ReliabilityTteContribution> | Array<IReliabilityTteContribution> | null): ReliabilityTteContributionHeader;

  /**
   * Use this field to specify the interpolation mechanism to be applied for gaps in interval timeseries. Default: `ZERO_INTERPOLATOR`.
   */
  readonly interpolator?: string;
  withInterpolator(interpolator: string | null): ReliabilityTteContributionHeader;

  /**
   * Use this field to specify how normalization should handle duplicate data points. A duplicate point is one that has the same start, end, value, unit, and {@link TimedDataPointFields#isEstimated} values. Default: `IGNORE`.
   */
  readonly duplicateHandling?: string;
  withDuplicateHandling(duplicateHandling: string | null): ReliabilityTteContributionHeader;

  /**
   * Used to specify how normalization should handle overlapping data points. Default: `AVG`.
   */
  readonly overlapHandling?: string;
  withOverlapHandling(overlapHandling: string | null): ReliabilityTteContributionHeader;
  ...
  withBucketInterval(bucketInterval: string | null): ReliabilityTteContributionHeader;
  ...
  withNormalizationPartitionStrategy(normalizationPartitionStrategy: INormalizationPartitionStrategy | null): ReliabilityTteContributionHeader;

  /**
   * Indicates whether the last data point should be repeated until infinity
   */
  readonly extrapolate?: boolean;
  withExtrapolate(extrapolate: boolean): ReliabilityTteContributionHeader;
  ...
  withTypeIdent(typeIdent: string | null): ReliabilityTteContributionHeader;
   ...
   */
  readonly id: string;
  withId(id: string): ReliabilityTteContributionHeader;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityTteContributionHeader;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): ReliabilityTteContributionHeader;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): ReliabilityTteContributionHeader;
  ...
  withVersion(version: number | null): ReliabilityTteContributionHeader;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): ReliabilityTteContributionHeader;

  /**
   * The subject-model association related to this series header.
   */
  readonly parent: ReliabilityAssetToTteModelRelation;
  withParent(parent: IReliabilityAssetToTteModelRelation): ReliabilityTteContributionHeader;

  /**
   * The treatment to use for the timeseries.
   */
  readonly treatment?: string;
  withTreatment(treatment: string | null): ReliabilityTteContributionHeader;
   ...
   * @see #toJson
   */
  static fromJson(json: any): ReliabilityTteContributionHeader | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): ReliabilityTteContributionHeader | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): ReliabilityTteContributionHeader | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): ReliabilityTteContributionHeader | null;
   ...
   */
  replaceType(old: Type, new_: Type): ReliabilityTteContributionHeader;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityTteContributionHeader;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityTteContributionHeader;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityTteContributionHeader>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityTteContributionHeader>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityTteContributionHeader;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityTteContributionHeader;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityTteContributionHeader;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ReliabilityTteContributionHeader;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ReliabilityTteContributionHeader;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityTteContributionHeader;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityTteContributionHeader;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityTteContributionHeader;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ReliabilityTteContributionHeader;
   ...
   * @see #removeField
   */
  withoutField(field: string): ReliabilityTteContributionHeader;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): ReliabilityTteContributionHeader;
   ...
   */
  withoutFields(fields: Array_Type<string>): ReliabilityTteContributionHeader;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityTteContributionHeader;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ReliabilityTteContributionHeader;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityTteContributionHeader;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ReliabilityTteContributionHeader;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ReliabilityTteContributionHeader;
   ...
   * @see #removeField
   */
  unsetField(field: string): ReliabilityTteContributionHeader;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ReliabilityTteContributionHeader;
   ...
   * @see #unsetField
   */
  removeField(field: string): ReliabilityTteContributionHeader;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ReliabilityTteContributionHeader;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityTteContributionHeader;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityTteContributionHeader;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityTteContributionHeader;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityTteContributionHeader;

  mergeJson(json: any): ReliabilityTteContributionHeader;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityTteContributionHeader;
   ...
   */
  sumObj(other: Obj, deep?: boolean): ReliabilityTteContributionHeader;
   ...
   */
  singletonArray(): Array_Type<ReliabilityTteContributionHeader>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityTteContributionHeader> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ReliabilityTteContributionHeader> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<ReliabilityTteContributionHeader>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ReliabilityTteContributionHeader> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, ReliabilityTteContributionHeader> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityTteContributionHeader> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ReliabilityTteContributionHeader>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ReliabilityTteContributionHeader>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityTteContributionHeader;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityTteContributionHeader;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityTteContributionHeader;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ReliabilityTteContributionHeader;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityTteContributionHeader;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ReliabilityTteContributionHeader;
   ...
   * @see #fromString
   */
  static make(s: string): ReliabilityTteContributionHeader | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityTteContributionHeader;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): ReliabilityTteContributionHeader;
   ...
   */
  static cachedEmptyInst(): ReliabilityTteContributionHeader;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityTteContributionHeader> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): ReliabilityTteContributionHeader;
   ...
   */
  static normalizeTimeseries(timeseries?: TimedDataFields<ReliabilityTteContribution>, start?: DateTime, end?: DateTime, overrideGrain?: string, forceGrainDetection?: boolean, force?: boolean): void;
   ...
   */
  static normalize(timeseries?: TimedDataFields<ReliabilityTteContribution>, start?: DateTime, end?: DateTime, overrideGrain?: string, forceGrainDetection?: boolean): NormalizationResult | null;
   ...
   */
  static normalizationUnit(rawHeader: TimedDataFields<ReliabilityTteContribution>, tsField: string): Unit | null;
   ...
   */
  static normalizationTreatment(rawHeader: TimedDataFields<ReliabilityTteContribution>, tsField: string): string;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<ReliabilityTteContributionHeader>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<ReliabilityTteContributionHeader>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityTteContributionHeader> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityTteContributionHeader>> | null;
   ...
   */
  get(include?: string): ReliabilityTteContributionHeader | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): ReliabilityTteContributionHeader | null;
   ...
   */
  getMissing(spec: GetMissingSpec): ReliabilityTteContributionHeader;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): ReliabilityTteContributionHeader | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): ReliabilityTteContributionHeader;
   ...
   * @see #toString
   */
  static fromString(s: string): ReliabilityTteContributionHeader | null;
   ...
   */
  create(spec?: UpsertSpec): ReliabilityTteContributionHeader | null;
   ...
   */
  static createBatch(objs: Array_Type<ReliabilityTteContributionHeader>, spec?: UpsertSpec): ObjList<ReliabilityTteContributionHeader> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<ReliabilityTteContributionHeader>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityTteContributionHeader> | null;
   ...
   */
  update(srcObj?: ReliabilityTteContributionHeader, spec?: UpsertSpec): ReliabilityTteContributionHeader | null;
   ...
   */
  upsert(srcObj?: ReliabilityTteContributionHeader, spec?: UpsertSpec): ReliabilityTteContributionHeader | null;
   ...
   */
  merge(spec?: MergeSpec): ReliabilityTteContributionHeader | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): ReliabilityTteContributionHeader | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): ReliabilityTteContributionHeader | null;
   ...
   */
  static updateBatch(objs: Array_Type<ReliabilityTteContributionHeader>, srcObjs?: Array_Type<ReliabilityTteContributionHeader>, spec?: UpsertSpec): ObjList<ReliabilityTteContributionHeader> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<ReliabilityTteContributionHeader> | null>, spec?: UpsertSpec): ObjList<ReliabilityTteContributionHeader> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<ReliabilityTteContributionHeader>, srcObjs?: Array_Type<ReliabilityTteContributionHeader>, spec?: UpsertSpec): ObjList<ReliabilityTteContributionHeader> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<ReliabilityTteContributionHeader> | null>, spec?: UpsertSpec): ObjList<ReliabilityTteContributionHeader> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<ReliabilityTteContributionHeader>, spec?: TouchSpec): ObjList<ReliabilityTteContributionHeader> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityTteContributionHeader>, spec?: MergeSpec): ObjList<ReliabilityTteContributionHeader> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityTteContributionHeader>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityTteContributionHeader> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<ReliabilityTteContributionHeader> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityTteContributionHeader> | null;
   ...
   */
  static mergeAll(mergeObj: ReliabilityTteContributionHeader, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: ReliabilityTteContributionHeader, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<ReliabilityTteContributionHeader>, spec?: UpsertSpec): ObjList<ReliabilityTteContributionHeader> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<ReliabilityTteContributionHeader>, spec?: UpsertSpec): ObjList<ReliabilityTteContributionHeader> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): ReliabilityTteContributionHeader | null;
   ...
   */
  static beforeCreate(objs: Array_Type<ReliabilityTteContributionHeader>): ObjList<ReliabilityTteContributionHeader>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<ReliabilityTteContributionHeader>): ObjList<ReliabilityTteContributionHeader>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<ReliabilityTteContributionHeader>): ObjList<ReliabilityTteContributionHeader>;
   ...
   */
  static afterCreate(objs: Array_Type<ReliabilityTteContributionHeader>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<ReliabilityTteContributionHeader>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<ReliabilityTteContributionHeader>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityTteContributionHeader>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityTteContributionHeader>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): ReliabilityTteContributionHeader | null;
   ...
   */
  withoutIdentity(): ReliabilityTteContributionHeader | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<ReliabilityTteContributionHeader>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: ReliabilityTteContributionHeader, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<ReliabilityTteContributionHeader>, callback?: λFunction<ReliabilityTteContributionHeader | null, ReliabilityTteContributionHeader | null>): ObjList<ReliabilityTteContributionHeader>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<ReliabilityTteContributionHeader>, callback?: λFunction<ReliabilityTteContributionHeader | null, ReliabilityTteContributionHeader | null>): Array_Type<ObjError> | null;
