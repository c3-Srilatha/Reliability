// TypeScript definitions for the C3 type ReliabilityRiskScoreMlScoreHeader
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityRiskScoreMlScoreHeader
 */
declare interface IReliabilityRiskScoreMlScoreHeader {
   ...
   */
  data?: Array_Type<ReliabilityRiskScoreMlScore> | Array<IReliabilityRiskScoreMlScore>;
 ...
 */
declare class ReliabilityRiskScoreMlScoreHeader extends Obj  {

  /**
   * Populated on normalization. Indicates the earliest data point across various timeseries fields.
   */
  readonly earliest?: DateTime;
  withEarliest(earliest: DateTime | Date | string | null): ReliabilityRiskScoreMlScoreHeader;

  /**
   * Populated on normalization. Indicates the latest data point across various timeseries fields.
   */
  readonly latest?: DateTime;
  withLatest(latest: DateTime | Date | string | null): ReliabilityRiskScoreMlScoreHeader;

  /**
   * Populated on normalization. Indicates the earliest data point for each {@link Ann.Ts} fields.
   */
  readonly earliestTsDp?: Map_Type<string, TSDataPoint>;
  withEarliestTsDp(earliestTsDp: Map_Type<string, TSDataPoint> | {[key: string]: ITSDataPoint} | null): ReliabilityRiskScoreMlScoreHeader;

  /**
   * Populated on normalization. Indicates the latest data point for each {@link Ann.Ts} fields.
   */
  readonly latestTsDp?: Map_Type<string, TSDataPoint>;
  withLatestTsDp(latestTsDp: Map_Type<string, TSDataPoint> | {[key: string]: ITSDataPoint} | null): ReliabilityRiskScoreMlScoreHeader;
  ...
  withInterval(interval: string | null): ReliabilityRiskScoreMlScoreHeader;
  ...
  withTimeZone(timeZone: string | null): ReliabilityRiskScoreMlScoreHeader;

  /**
   * If set, disables normalizing this time series. Invalidations will still continue to happen for this series normally.
   */
  readonly doNotNormalize?: boolean;
  withDoNotNormalize(doNotNormalize: boolean): ReliabilityRiskScoreMlScoreHeader;

  /**
   * Data points corresponding to this timeseries header
   */
  readonly data?: Array_Type<ReliabilityRiskScoreMlScore>;
  withData(data: Array_Type<ReliabilityRiskScoreMlScore> | Array<IReliabilityRiskScoreMlScore> | null): ReliabilityRiskScoreMlScoreHeader;

  /**
   * Use this field to specify the interpolation mechanism to be applied for gaps in interval timeseries. Default: `ZERO_INTERPOLATOR`.
   */
  readonly interpolator?: string;
  withInterpolator(interpolator: string | null): ReliabilityRiskScoreMlScoreHeader;

  /**
   * Use this field to specify how normalization should handle duplicate data points. A duplicate point is one that has the same start, end, value, unit, and {@link TimedDataPointFields#isEstimated} values. Default: `IGNORE`.
   */
  readonly duplicateHandling?: string;
  withDuplicateHandling(duplicateHandling: string | null): ReliabilityRiskScoreMlScoreHeader;

  /**
   * Used to specify how normalization should handle overlapping data points. Default: `AVG`.
   */
  readonly overlapHandling?: string;
  withOverlapHandling(overlapHandling: string | null): ReliabilityRiskScoreMlScoreHeader;
  ...
  withBucketInterval(bucketInterval: string | null): ReliabilityRiskScoreMlScoreHeader;
  ...
  withNormalizationPartitionStrategy(normalizationPartitionStrategy: INormalizationPartitionStrategy | null): ReliabilityRiskScoreMlScoreHeader;

  /**
   * Indicates whether the last data point should be repeated until infinity
   */
  readonly extrapolate?: boolean;
  withExtrapolate(extrapolate: boolean): ReliabilityRiskScoreMlScoreHeader;
  ...
  withTypeIdent(typeIdent: string | null): ReliabilityRiskScoreMlScoreHeader;
   ...
   */
  readonly id: string;
  withId(id: string): ReliabilityRiskScoreMlScoreHeader;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityRiskScoreMlScoreHeader;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): ReliabilityRiskScoreMlScoreHeader;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): ReliabilityRiskScoreMlScoreHeader;
  ...
  withVersion(version: number | null): ReliabilityRiskScoreMlScoreHeader;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): ReliabilityRiskScoreMlScoreHeader;

  /**
   * The subject-model association related to this series header.
   */
  readonly parent: ReliabilityAssetToRiskModelRelation;
  withParent(parent: IReliabilityAssetToRiskModelRelation): ReliabilityRiskScoreMlScoreHeader;

  /**
   * The treatment to use for the timeseries.
   */
  readonly treatment?: string;
  withTreatment(treatment: string | null): ReliabilityRiskScoreMlScoreHeader;
   ...
   * @see #toJson
   */
  static fromJson(json: any): ReliabilityRiskScoreMlScoreHeader | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): ReliabilityRiskScoreMlScoreHeader | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): ReliabilityRiskScoreMlScoreHeader | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): ReliabilityRiskScoreMlScoreHeader | null;
   ...
   */
  replaceType(old: Type, new_: Type): ReliabilityRiskScoreMlScoreHeader;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityRiskScoreMlScoreHeader;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityRiskScoreMlScoreHeader;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityRiskScoreMlScoreHeader>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityRiskScoreMlScoreHeader>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityRiskScoreMlScoreHeader;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityRiskScoreMlScoreHeader;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityRiskScoreMlScoreHeader;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ReliabilityRiskScoreMlScoreHeader;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ReliabilityRiskScoreMlScoreHeader;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityRiskScoreMlScoreHeader;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityRiskScoreMlScoreHeader;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityRiskScoreMlScoreHeader;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ReliabilityRiskScoreMlScoreHeader;
   ...
   * @see #removeField
   */
  withoutField(field: string): ReliabilityRiskScoreMlScoreHeader;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): ReliabilityRiskScoreMlScoreHeader;
   ...
   */
  withoutFields(fields: Array_Type<string>): ReliabilityRiskScoreMlScoreHeader;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityRiskScoreMlScoreHeader;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ReliabilityRiskScoreMlScoreHeader;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityRiskScoreMlScoreHeader;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ReliabilityRiskScoreMlScoreHeader;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ReliabilityRiskScoreMlScoreHeader;
   ...
   * @see #removeField
   */
  unsetField(field: string): ReliabilityRiskScoreMlScoreHeader;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ReliabilityRiskScoreMlScoreHeader;
   ...
   * @see #unsetField
   */
  removeField(field: string): ReliabilityRiskScoreMlScoreHeader;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ReliabilityRiskScoreMlScoreHeader;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityRiskScoreMlScoreHeader;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityRiskScoreMlScoreHeader;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityRiskScoreMlScoreHeader;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityRiskScoreMlScoreHeader;

  mergeJson(json: any): ReliabilityRiskScoreMlScoreHeader;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityRiskScoreMlScoreHeader;
   ...
   */
  sumObj(other: Obj, deep?: boolean): ReliabilityRiskScoreMlScoreHeader;
   ...
   */
  singletonArray(): Array_Type<ReliabilityRiskScoreMlScoreHeader>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityRiskScoreMlScoreHeader> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ReliabilityRiskScoreMlScoreHeader> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<ReliabilityRiskScoreMlScoreHeader>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ReliabilityRiskScoreMlScoreHeader> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, ReliabilityRiskScoreMlScoreHeader> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityRiskScoreMlScoreHeader> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ReliabilityRiskScoreMlScoreHeader>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ReliabilityRiskScoreMlScoreHeader>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityRiskScoreMlScoreHeader;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityRiskScoreMlScoreHeader;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityRiskScoreMlScoreHeader;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ReliabilityRiskScoreMlScoreHeader;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityRiskScoreMlScoreHeader;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ReliabilityRiskScoreMlScoreHeader;
   ...
   * @see #fromString
   */
  static make(s: string): ReliabilityRiskScoreMlScoreHeader | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityRiskScoreMlScoreHeader;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): ReliabilityRiskScoreMlScoreHeader;
   ...
   */
  static cachedEmptyInst(): ReliabilityRiskScoreMlScoreHeader;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityRiskScoreMlScoreHeader> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): ReliabilityRiskScoreMlScoreHeader;
   ...
   */
  static normalizeTimeseries(timeseries?: TimedDataFields<ReliabilityRiskScoreMlScore>, start?: DateTime, end?: DateTime, overrideGrain?: string, forceGrainDetection?: boolean, force?: boolean): void;
   ...
   */
  static normalize(timeseries?: TimedDataFields<ReliabilityRiskScoreMlScore>, start?: DateTime, end?: DateTime, overrideGrain?: string, forceGrainDetection?: boolean): NormalizationResult | null;
   ...
   */
  static normalizationUnit(rawHeader: TimedDataFields<ReliabilityRiskScoreMlScore>, tsField: string): Unit | null;
   ...
   */
  static normalizationTreatment(rawHeader: TimedDataFields<ReliabilityRiskScoreMlScore>, tsField: string): string;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<ReliabilityRiskScoreMlScoreHeader>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<ReliabilityRiskScoreMlScoreHeader>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityRiskScoreMlScoreHeader> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityRiskScoreMlScoreHeader>> | null;
   ...
   */
  get(include?: string): ReliabilityRiskScoreMlScoreHeader | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): ReliabilityRiskScoreMlScoreHeader | null;
   ...
   */
  getMissing(spec: GetMissingSpec): ReliabilityRiskScoreMlScoreHeader;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): ReliabilityRiskScoreMlScoreHeader | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): ReliabilityRiskScoreMlScoreHeader;
   ...
   * @see #toString
   */
  static fromString(s: string): ReliabilityRiskScoreMlScoreHeader | null;
   ...
   */
  create(spec?: UpsertSpec): ReliabilityRiskScoreMlScoreHeader | null;
   ...
   */
  static createBatch(objs: Array_Type<ReliabilityRiskScoreMlScoreHeader>, spec?: UpsertSpec): ObjList<ReliabilityRiskScoreMlScoreHeader> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<ReliabilityRiskScoreMlScoreHeader>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityRiskScoreMlScoreHeader> | null;
   ...
   */
  update(srcObj?: ReliabilityRiskScoreMlScoreHeader, spec?: UpsertSpec): ReliabilityRiskScoreMlScoreHeader | null;
   ...
   */
  upsert(srcObj?: ReliabilityRiskScoreMlScoreHeader, spec?: UpsertSpec): ReliabilityRiskScoreMlScoreHeader | null;
   ...
   */
  merge(spec?: MergeSpec): ReliabilityRiskScoreMlScoreHeader | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): ReliabilityRiskScoreMlScoreHeader | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): ReliabilityRiskScoreMlScoreHeader | null;
   ...
   */
  static updateBatch(objs: Array_Type<ReliabilityRiskScoreMlScoreHeader>, srcObjs?: Array_Type<ReliabilityRiskScoreMlScoreHeader>, spec?: UpsertSpec): ObjList<ReliabilityRiskScoreMlScoreHeader> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<ReliabilityRiskScoreMlScoreHeader> | null>, spec?: UpsertSpec): ObjList<ReliabilityRiskScoreMlScoreHeader> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<ReliabilityRiskScoreMlScoreHeader>, srcObjs?: Array_Type<ReliabilityRiskScoreMlScoreHeader>, spec?: UpsertSpec): ObjList<ReliabilityRiskScoreMlScoreHeader> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<ReliabilityRiskScoreMlScoreHeader> | null>, spec?: UpsertSpec): ObjList<ReliabilityRiskScoreMlScoreHeader> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<ReliabilityRiskScoreMlScoreHeader>, spec?: TouchSpec): ObjList<ReliabilityRiskScoreMlScoreHeader> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityRiskScoreMlScoreHeader>, spec?: MergeSpec): ObjList<ReliabilityRiskScoreMlScoreHeader> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityRiskScoreMlScoreHeader>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityRiskScoreMlScoreHeader> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<ReliabilityRiskScoreMlScoreHeader> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityRiskScoreMlScoreHeader> | null;
   ...
   */
  static mergeAll(mergeObj: ReliabilityRiskScoreMlScoreHeader, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: ReliabilityRiskScoreMlScoreHeader, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<ReliabilityRiskScoreMlScoreHeader>, spec?: UpsertSpec): ObjList<ReliabilityRiskScoreMlScoreHeader> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<ReliabilityRiskScoreMlScoreHeader>, spec?: UpsertSpec): ObjList<ReliabilityRiskScoreMlScoreHeader> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): ReliabilityRiskScoreMlScoreHeader | null;
   ...
   */
  static beforeCreate(objs: Array_Type<ReliabilityRiskScoreMlScoreHeader>): ObjList<ReliabilityRiskScoreMlScoreHeader>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<ReliabilityRiskScoreMlScoreHeader>): ObjList<ReliabilityRiskScoreMlScoreHeader>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<ReliabilityRiskScoreMlScoreHeader>): ObjList<ReliabilityRiskScoreMlScoreHeader>;
   ...
   */
  static afterCreate(objs: Array_Type<ReliabilityRiskScoreMlScoreHeader>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<ReliabilityRiskScoreMlScoreHeader>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<ReliabilityRiskScoreMlScoreHeader>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityRiskScoreMlScoreHeader>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityRiskScoreMlScoreHeader>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): ReliabilityRiskScoreMlScoreHeader | null;
   ...
   */
  withoutIdentity(): ReliabilityRiskScoreMlScoreHeader | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<ReliabilityRiskScoreMlScoreHeader>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: ReliabilityRiskScoreMlScoreHeader, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<ReliabilityRiskScoreMlScoreHeader>, callback?: λFunction<ReliabilityRiskScoreMlScoreHeader | null, ReliabilityRiskScoreMlScoreHeader | null>): ObjList<ReliabilityRiskScoreMlScoreHeader>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<ReliabilityRiskScoreMlScoreHeader>, callback?: λFunction<ReliabilityRiskScoreMlScoreHeader | null, ReliabilityRiskScoreMlScoreHeader | null>): Array_Type<ObjError> | null;
