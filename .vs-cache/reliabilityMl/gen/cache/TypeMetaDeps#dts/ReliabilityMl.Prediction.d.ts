// TypeScript definitions for the C3 type ReliabilityMl.Prediction
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityMl.Prediction
 */
declare namespace ReliabilityMl {
  export interface IPrediction {
    ...
    parent: IReliabilityMl.PredictionHeader;
 ...
 */
declare namespace ReliabilityMl {
  export class Prediction extends Obj  {

    /**
     * start date for the data point
     */
    readonly start: DateTime;
    withStart(start: DateTime | Date | string): ReliabilityMl.Prediction;
    ...
    withOutlierCode(outlierCode: number | null): ReliabilityMl.Prediction;

    /**
     * (Optional) any comments for the data point
     */
    readonly comments?: string;
    withComments(comments: string | null): ReliabilityMl.Prediction;

    /**
     * Denotes if the value is an actual value or an estimated value. default = null (actual value)
     */
    readonly isEstimated?: boolean;
    withIsEstimated(isEstimated: boolean): ReliabilityMl.Prediction;
    ...
    withDataVersion(dataVersion: number | null): ReliabilityMl.Prediction;

    /**
     * Customer specific status code for the data point (may be used to denote data quality)
     */
    readonly statusCode?: string;
    withStatusCode(statusCode: string | null): ReliabilityMl.Prediction;

    /**
     * Partition key Bin separator used to separate partition key from bin id
     */
    readonly PK_BIN_SEPARATOR?: string;
    withPK_BIN_SEPARATOR(PK_BIN_SEPARATOR: string | null): ReliabilityMl.Prediction;

    readonly parent: ReliabilityMl.PredictionHeader;
    withParent(parent: IReliabilityMl.PredictionHeader): ReliabilityMl.Prediction;
    ...
    withTypeIdent(typeIdent: string | null): ReliabilityMl.Prediction;
     ...
     */
    readonly id: string;
    withId(id: string): ReliabilityMl.Prediction;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityMl.Prediction;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): ReliabilityMl.Prediction;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): ReliabilityMl.Prediction;
    ...
    withVersion(version: number | null): ReliabilityMl.Prediction;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): ReliabilityMl.Prediction;
    ...
    withValue(value: number): ReliabilityMl.Prediction;
    ...
    withValueUpperBound(valueUpperBound: number | null): ReliabilityMl.Prediction;
    ...
    withValueLowerBound(valueLowerBound: number | null): ReliabilityMl.Prediction;
     ...
     * @see #toJson
     */
    static fromJson(json: any): ReliabilityMl.Prediction | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): ReliabilityMl.Prediction | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): ReliabilityMl.Prediction | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): ReliabilityMl.Prediction | null;
     ...
     */
    replaceType(old: Type, new_: Type): ReliabilityMl.Prediction;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityMl.Prediction;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityMl.Prediction;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityMl.Prediction>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityMl.Prediction>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityMl.Prediction;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityMl.Prediction;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityMl.Prediction;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): ReliabilityMl.Prediction;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): ReliabilityMl.Prediction;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityMl.Prediction;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityMl.Prediction;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityMl.Prediction;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): ReliabilityMl.Prediction;
     ...
     * @see #removeField
     */
    withoutField(field: string): ReliabilityMl.Prediction;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): ReliabilityMl.Prediction;
     ...
     */
    withoutFields(fields: Array_Type<string>): ReliabilityMl.Prediction;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityMl.Prediction;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): ReliabilityMl.Prediction;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityMl.Prediction;
     ...
     * @see #unsetField
     */
    defaultField(field: string): ReliabilityMl.Prediction;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): ReliabilityMl.Prediction;
     ...
     * @see #removeField
     */
    unsetField(field: string): ReliabilityMl.Prediction;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): ReliabilityMl.Prediction;
     ...
     * @see #unsetField
     */
    removeField(field: string): ReliabilityMl.Prediction;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): ReliabilityMl.Prediction;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityMl.Prediction;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityMl.Prediction;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityMl.Prediction;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityMl.Prediction;

    mergeJson(json: any): ReliabilityMl.Prediction;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityMl.Prediction;
     ...
     */
    sumObj(other: Obj, deep?: boolean): ReliabilityMl.Prediction;
     ...
     */
    singletonArray(): Array_Type<ReliabilityMl.Prediction>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityMl.Prediction> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<ReliabilityMl.Prediction> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<ReliabilityMl.Prediction>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<ReliabilityMl.Prediction> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, ReliabilityMl.Prediction> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityMl.Prediction> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<ReliabilityMl.Prediction>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<ReliabilityMl.Prediction>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityMl.Prediction;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityMl.Prediction;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityMl.Prediction;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): ReliabilityMl.Prediction;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityMl.Prediction;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): ReliabilityMl.Prediction;
     ...
     * @see #fromString
     */
    static make(s: string): ReliabilityMl.Prediction | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityMl.Prediction;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): ReliabilityMl.Prediction;
     ...
     */
    static cachedEmptyInst(): ReliabilityMl.Prediction;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityMl.Prediction> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): ReliabilityMl.Prediction;

    /**
     * Extract the partition key from the given obj
     */
    partitionKey(failIfMissing?: boolean): ReliabilityMl.PredictionHeader | null;
     ...
     */
    static partition(objs?: Stream<ReliabilityMl.Prediction>, spec?: PartitionBucketStrategy): Map_Type<string, KvDataPartition> | null;
     ...
     */
    static fromPartitions(partitions?: Stream<KvDataPartition>): Stream<ReliabilityMl.Prediction> | null;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<ReliabilityMl.Prediction>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<ReliabilityMl.Prediction>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityMl.Prediction> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityMl.Prediction>> | null;
     ...
     */
    get(include?: string): ReliabilityMl.Prediction | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): ReliabilityMl.Prediction | null;
     ...
     */
    getMissing(spec: GetMissingSpec): ReliabilityMl.Prediction;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): ReliabilityMl.Prediction | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): ReliabilityMl.Prediction;
     ...
     * @see #toString
     */
    static fromString(s: string): ReliabilityMl.Prediction | null;
     ...
     */
    create(spec?: UpsertSpec): ReliabilityMl.Prediction | null;
     ...
     */
    static createBatch(objs: Array_Type<ReliabilityMl.Prediction>, spec?: UpsertSpec): ObjList<ReliabilityMl.Prediction> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<ReliabilityMl.Prediction>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityMl.Prediction> | null;
     ...
     */
    update(srcObj?: ReliabilityMl.Prediction, spec?: UpsertSpec): ReliabilityMl.Prediction | null;
     ...
     */
    upsert(srcObj?: ReliabilityMl.Prediction, spec?: UpsertSpec): ReliabilityMl.Prediction | null;
     ...
     */
    merge(spec?: MergeSpec): ReliabilityMl.Prediction | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): ReliabilityMl.Prediction | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): ReliabilityMl.Prediction | null;
     ...
     */
    static updateBatch(objs: Array_Type<ReliabilityMl.Prediction>, srcObjs?: Array_Type<ReliabilityMl.Prediction>, spec?: UpsertSpec): ObjList<ReliabilityMl.Prediction> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<ReliabilityMl.Prediction> | null>, spec?: UpsertSpec): ObjList<ReliabilityMl.Prediction> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<ReliabilityMl.Prediction>, srcObjs?: Array_Type<ReliabilityMl.Prediction>, spec?: UpsertSpec): ObjList<ReliabilityMl.Prediction> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<ReliabilityMl.Prediction> | null>, spec?: UpsertSpec): ObjList<ReliabilityMl.Prediction> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<ReliabilityMl.Prediction>, spec?: TouchSpec): ObjList<ReliabilityMl.Prediction> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityMl.Prediction>, spec?: MergeSpec): ObjList<ReliabilityMl.Prediction> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityMl.Prediction>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityMl.Prediction> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<ReliabilityMl.Prediction> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityMl.Prediction> | null;
     ...
     */
    static mergeAll(mergeObj: ReliabilityMl.Prediction, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: ReliabilityMl.Prediction, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<ReliabilityMl.Prediction>, spec?: UpsertSpec): ObjList<ReliabilityMl.Prediction> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<ReliabilityMl.Prediction>, spec?: UpsertSpec): ObjList<ReliabilityMl.Prediction> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): ReliabilityMl.Prediction | null;
     ...
     */
    static beforeCreate(objs: Array_Type<ReliabilityMl.Prediction>): ObjList<ReliabilityMl.Prediction>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<ReliabilityMl.Prediction>): ObjList<ReliabilityMl.Prediction>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<ReliabilityMl.Prediction>): ObjList<ReliabilityMl.Prediction>;
     ...
     */
    static afterCreate(objs: Array_Type<ReliabilityMl.Prediction>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<ReliabilityMl.Prediction>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<ReliabilityMl.Prediction>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityMl.Prediction>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityMl.Prediction>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): ReliabilityMl.Prediction | null;
     ...
     */
    withoutIdentity(): ReliabilityMl.Prediction | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<ReliabilityMl.Prediction>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: ReliabilityMl.Prediction, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<ReliabilityMl.Prediction>, callback?: λFunction<ReliabilityMl.Prediction | null, ReliabilityMl.Prediction | null>): ObjList<ReliabilityMl.Prediction>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<ReliabilityMl.Prediction>, callback?: λFunction<ReliabilityMl.Prediction | null, ReliabilityMl.Prediction | null>): Array_Type<ObjError> | null;
