// TypeScript definitions for the C3 type ReliabilityRiskMl.Pipeline

/**
 * This type represents a pipeline that can be specifically used within the C3 AI Reliability application. This pipeline
 * computes, or learns to compute, a risk score from input time series data and generates an alert if the risk score
 * exceeds a certain threshold. There are 7 required inputs and 1 optional input (all of which should be {@link Data}
 * and should include a `subject` and `timestamp` index):
 * - `features`: The input time series data for a singular asset.
 * - `mask_IsAssetNotOperational`: A mask to exclude points when the asset is not operational.
 * - `mask_AssetEvent`: A mask to exclude points when there is an event on the asset.
 * - `mask_PreAssetEvent`: A pre-event mask to exclude likely anomalous behavior in the lead up to an event.
 * - `mask_PostAssetEvent`: A post-event mask to exclude likely transient behavior during startups.
 * - `mask_AdHocTraining`: User-defined training mask.
 * - `mask_AdHocInference`: User-defined inference mask.
 * - `target` (optional): The target risk score.
 *
 * This pipeline outputs 3 artifacts (the specific output keys are defined by {@link ReliabilityMLOutputConfig}):
 * - Risk scores: A risk score for various points in time (may not include all points from input)
 * - Normalized risk scores: The risk score for various points in time scaled to be between 0 and 1.
 * - Alerts: A value for various points in time signifying whether or not an alert should be raised based on the
 *   risk scores.
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityRiskMl.Pipeline
 */
declare namespace ReliabilityRiskMl {
  export interface IPipeline<DX, DY, DO, DI> {
     ...
     * If no pipe is specified, the default {@link ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe} will be used.
     */
     ...
     * {@link ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe} will be used.
     */
     ...
     * {@link ReliabilityMLOutputConfig}. If no pipe is specified, the default
     * {@link ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe} will be used.
     */
    riskScoreNormalizationPipe: IMlPipe<any, any, any, any, any>;

    /**
     * The interpreter is responsible for interpreting the {@link riskScorePipe}. If none is specified, a default will
     * be used if the specified {@link riskScorePipe} is one of the out-of-the-box {@link ReliabilityRiskMl.RiskScoreComputation.Pipe}
     * that are not based on reconstructions.
     */
 ...
 *   risk scores.
 *
 * @remarks this represents a made instance of ReliabilityRiskMl.Pipeline
 */
declare namespace ReliabilityRiskMl {
  export class Pipeline<DX, DY, DO, DI> extends Obj  {
    ...
    withVertices(vertices: Array_Type<MlPipeline.Vertex> | Array<IMlPipeline.Vertex> | null): ReliabilityRiskMl.Pipeline;

    /**
     * List of all edges in this graph.
     */
    readonly edges?: Array_Type<FlowGraph.Edge<MlPipeline.Vertex>>;
    withEdges(edges: Array_Type<FlowGraph.Edge<MlPipeline.Vertex>> | Array<IFlowGraph.Edge<MlPipeline.Vertex>> | null): ReliabilityRiskMl.Pipeline;
    ...
    withVertexConnections(vertexConnections: Map_Type<string, Map_Type<string, any>> | {[key: string]: Map_Type<string, any> | {[key: string]: any}} | null): ReliabilityRiskMl.Pipeline;
     ...
     */
    readonly id: string;
    withId(id: string): ReliabilityRiskMl.Pipeline;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityRiskMl.Pipeline;

    /**
     * Name of this pipe.
     */
    readonly name?: string;
    withName(name: string | null): ReliabilityRiskMl.Pipeline;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): ReliabilityRiskMl.Pipeline;
    ...
    withVersion(version: number | null): ReliabilityRiskMl.Pipeline;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): ReliabilityRiskMl.Pipeline;
    ...
    withUserUpdatedFields(userUpdatedFields: Array_Type<string> | Array<string> | null): ReliabilityRiskMl.Pipeline;
    ...
    withHidden(hidden: boolean): ReliabilityRiskMl.Pipeline;
    ...
    withUserOwned(userOwned: boolean): ReliabilityRiskMl.Pipeline;
    ...
    withTypeIdent(typeIdent: string | null): ReliabilityRiskMl.Pipeline;

    /**
     * If true, then the pipe shall not be retrained
     */
    readonly frozen?: boolean;
    withFrozen(frozen: boolean): ReliabilityRiskMl.Pipeline;

    /**
     * True if training has succeeded and false otherwise.
     */
    readonly trained?: boolean;
    withTrained(trained: boolean): ReliabilityRiskMl.Pipeline;

    /**
     * Errors from training.
     */
    readonly trainingErrors?: string;
    withTrainingErrors(trainingErrors: string | null): ReliabilityRiskMl.Pipeline;

    /**
     * If true, the underlying model only accepts flattened input.
     */
    readonly flattenInput?: boolean;
    withFlattenInput(flattenInput: boolean): ReliabilityRiskMl.Pipeline;

    /**
     * The hyperparameters overridden of a native model or pipe.
     */
    readonly hyperparamOverrides?: Map_Type<string, any>;
    withHyperparamOverrides(hyperparamOverrides: Map_Type<string, any> | {[key: string]: any} | null): ReliabilityRiskMl.Pipeline;
    ...
    withHyperparamSearchSpace(hyperparamSearchSpace: IHp.SearchSpace | null): ReliabilityRiskMl.Pipeline;
    ...
    withHpoSpec(hpoSpec: IHpo.Spec | null): ReliabilityRiskMl.Pipeline;

    /**
     * {@link Hpo.Experiment} stores the result of hyperparameter optimization to find the best model/pipeline.
     */
    readonly hpoExperiment?: Hpo.Experiment;
    withHpoExperiment(hpoExperiment: IHpo.Experiment | null): ReliabilityRiskMl.Pipeline;

    /**
     * Reference to the experiment that produced this {@link MlPipe}. For example, this could be a {@link Hpo.ExperimentBase}.
     */
    readonly experiment?: any;
    withExperiment(experiment: any | null): ReliabilityRiskMl.Pipeline;

    /**
     * Names of the {@link #score} outputs for this machine learning pipeline.
     */
    readonly scoreNames?: Set_Type<string>;
    withScoreNames(scoreNames: Set_Type<string> | Array<string> | null): ReliabilityRiskMl.Pipeline;
    ...
    withTrainRun(trainRun: IWorkflowExecutorRun | null): ReliabilityRiskMl.Pipeline;
    ...
    withTrainStatus(trainStatus: IWorkflow.Status | null): ReliabilityRiskMl.Pipeline;
    ...
    withDoNotAutoUpsert(doNotAutoUpsert: boolean): ReliabilityRiskMl.Pipeline;
    ...
    withLookbackDuration(lookbackDuration: IDuration | null): ReliabilityRiskMl.Pipeline;

    /**
     * If set, the {@link #riskScorePipe} must accept a `target` as an input.
     */
    readonly hasTarget?: boolean;
    withHasTarget(hasTarget: boolean): ReliabilityRiskMl.Pipeline;
    ...
    withMaskingPipe(maskingPipe: IMlPipe<any, any, any, any, any>): ReliabilityRiskMl.Pipeline;
    ...
    withAlertingPipe(alertingPipe: IMlPipe<any, any, any, any, any>): ReliabilityRiskMl.Pipeline;
    ...
    withRiskScorePipe(riskScorePipe: IMlPipe<any, any, any, any, any>): ReliabilityRiskMl.Pipeline;
    ...
    withRiskScoreNormalizationPipe(riskScoreNormalizationPipe: IMlPipe<any, any, any, any, any>): ReliabilityRiskMl.Pipeline;
    ...
    withInterpreter(interpreter: IMlInterpreter<any, any> | null): ReliabilityRiskMl.Pipeline;
    ...
    withPipelineScoringMetrics(pipelineScoringMetrics: Map_Type<string, ReliabilityRiskMl.Pipeline.ScoringMetric> | {[key: string]: IReliabilityRiskMl.Pipeline.ScoringMetric} | null): ReliabilityRiskMl.Pipeline;
    ...
    withTrainingMasks(trainingMasks: Array_Type<string> | Array<string> | null): ReliabilityRiskMl.Pipeline;
    ...
    withInferenceMasks(inferenceMasks: Array_Type<string> | Array<string> | null): ReliabilityRiskMl.Pipeline;
     ...
     * @see #toJson
     */
    static fromJson(json: any): ReliabilityRiskMl.Pipeline<DX, DY, DO, DI> | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): ReliabilityRiskMl.Pipeline<DX, DY, DO, DI> | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): ReliabilityRiskMl.Pipeline<DX, DY, DO, DI> | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): ReliabilityRiskMl.Pipeline<DX, DY, DO, DI> | null;
     ...
     */
    replaceType(old: Type, new_: Type): ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>;
     ...
     * @see #removeField
     */
    withoutField(field: string): ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>;
     ...
     */
    withoutFields(fields: Array_Type<string>): ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>;
     ...
     * @see #unsetField
     */
    defaultField(field: string): ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>;
     ...
     * @see #removeField
     */
    unsetField(field: string): ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>;
     ...
     * @see #unsetField
     */
    removeField(field: string): ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>;

    mergeJson(json: any): ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>;
     ...
     */
    sumObj(other: Obj, deep?: boolean): ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>;
     ...
     */
    singletonArray(): Array_Type<ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>;
     ...
     * @see #fromString
     */
    static make(s: string): ReliabilityRiskMl.Pipeline<DX, DY, DO, DI> | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>;
     ...
     */
    static cachedEmptyInst(): ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>;
     ...
     */
    remakeTemplate(): ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>;
     ...
     */
    precomputeVertexConnections(): ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>;
     ...
     */
    mapVertices(mapper: λFunction<MlPipeline.Vertex | null, T | null>): ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>;
     ...
     */
    topologicalSort(reverse?: boolean): ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>;
     ...
     */
    ancestorGraph(sink: FlowGraph.Vertex): ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>;
     ...
     */
    replaceVertex(oldVertex: FlowGraph.Vertex, newVertex: FlowGraph.Vertex, doNotMerge?: boolean, removeDisconnectedEdges?: boolean): ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>;
     ...
     */
    replaceVertices(oldVertices: Array_Type<FlowGraph.Vertex>, newVertex: FlowGraph.Vertex, spec?: FlowGraphReplaceSpec): ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>;
     ...
     * @return
     */
    replaceVertices(oldVertices: Array_Type<FlowGraph.Vertex>, newVertices: Array_Type<FlowGraph.Vertex>, newEdges?: Array_Type<FlowGraph.Edge<FlowGraph.Vertex>>, spec?: FlowGraphReplaceSpec): ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>;
     ...
     * connected.
     */
    removeVertex(toRemove: FlowGraph.Vertex): ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>;

    removeVertex(idToRemove: string): ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>;
     ...
     */
    removeVertices(toRemove?: Array_Type<FlowGraph.Vertex>): ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>;
     ...
     */
    mergeWith(other: ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>): ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>;
     ...
     */
    trainSync(x: DX, y?: DY, spec?: MlOperationSpec): ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>;
     ...
     */
    static allCached(doNotProduceAll?: boolean): Stream<ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>> | null;
     ...
     */
    static find(filter?: string, doNotProduceAll?: boolean): Stream<ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>> | null;
     ...
     * @return existing instances of this type that satisfy filter from data cache.
     */
    static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>> | null;
     ...
     * @see getCached
     */
    static findByCacheKey(key: string): ReliabilityRiskMl.Pipeline<DX, DY, DO, DI> | null;
     ...
     * @see findByCacheKey
     */
    static forCacheKey(key: string): ReliabilityRiskMl.Pipeline<DX, DY, DO, DI> | null;
     ...
     * @see findByCacheKey
     */
    getCached(): ReliabilityRiskMl.Pipeline<DX, DY, DO, DI> | null;

    /**
     * @return newly produced cached instance.
     */
    refreshCache(): ReliabilityRiskMl.Pipeline<DX, DY, DO, DI> | null;
     ...
     */
    static produce(key: string): ReliabilityRiskMl.Pipeline<DX, DY, DO, DI> | null;
     ...
     */
    static produceAll(): Map_Type<string, ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>> | null;

    /**
     * Override for sub-types to produce all values.
     */
    static doProduceAll(): Map_Type<string, ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>> | null;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>>> | null;
     ...
     */
    get(include?: string): ReliabilityRiskMl.Pipeline<DX, DY, DO, DI> | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): ReliabilityRiskMl.Pipeline<DX, DY, DO, DI> | null;
     ...
     */
    getMissing(spec: GetMissingSpec): ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): ReliabilityRiskMl.Pipeline<DX, DY, DO, DI> | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>;
     ...
     * @see #toString
     */
    static fromString(s: string): ReliabilityRiskMl.Pipeline<DX, DY, DO, DI> | null;
     ...
     */
    create(spec?: UpsertSpec): ReliabilityRiskMl.Pipeline<DX, DY, DO, DI> | null;
     ...
     */
    static createBatch(objs: Array_Type<ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>> | null;
     ...
     */
    update(srcObj?: ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>, spec?: UpsertSpec): ReliabilityRiskMl.Pipeline<DX, DY, DO, DI> | null;
     ...
     */
    upsert(srcObj?: ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>, spec?: UpsertSpec): ReliabilityRiskMl.Pipeline<DX, DY, DO, DI> | null;
     ...
     */
    merge(spec?: MergeSpec): ReliabilityRiskMl.Pipeline<DX, DY, DO, DI> | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): ReliabilityRiskMl.Pipeline<DX, DY, DO, DI> | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): ReliabilityRiskMl.Pipeline<DX, DY, DO, DI> | null;
     ...
     */
    static updateBatch(objs: Array_Type<ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>>, srcObjs?: Array_Type<ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>> | null>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>>, srcObjs?: Array_Type<ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>> | null>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>>, spec?: TouchSpec): ObjList<ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>>, spec?: MergeSpec): ObjList<ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>> | null;
     ...
     */
    static mergeAll(mergeObj: ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): ReliabilityRiskMl.Pipeline<DX, DY, DO, DI> | null;
     ...
     */
    static beforeCreate(objs: Array_Type<ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>>): ObjList<ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>>;
     ...
     */
    static beforeUpdate(objs: Array_Type<ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>>): ObjList<ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>>): ObjList<ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>>;
     ...
     */
    static afterCreate(objs: Array_Type<ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): ReliabilityRiskMl.Pipeline<DX, DY, DO, DI> | null;
     ...
     */
    withoutIdentity(): ReliabilityRiskMl.Pipeline<DX, DY, DO, DI> | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>>, callback?: λFunction<ReliabilityRiskMl.Pipeline<DX, DY, DO, DI> | null, ReliabilityRiskMl.Pipeline<DX, DY, DO, DI> | null>): ObjList<ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>>, callback?: λFunction<ReliabilityRiskMl.Pipeline<DX, DY, DO, DI> | null, ReliabilityRiskMl.Pipeline<DX, DY, DO, DI> | null>): Array_Type<ObjError> | null;
     ...
     */
    publish(subPath?: string, contentType?: string): ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>;
     ...
     */
    static removeSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>> | null;
     ...
     */
    createSeedData(spec?: UpsertSpec): ReliabilityRiskMl.Pipeline<DX, DY, DO, DI> | null;
     ...
     */
    static createSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>> | null;
     ...
     */
    updateSeedData(srcObj?: SeedData, spec?: UpsertSpec): ReliabilityRiskMl.Pipeline<DX, DY, DO, DI> | null;
     ...
     */
    static updateSeedDataBatch(objs?: Array_Type<SeedData>, srcObjs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>> | null;
     ...
     * @return updated obj instance, same as {@link Persistable#update} return value.
     */
    clearUserUpdates(spec?: MergeSpec): ReliabilityRiskMl.Pipeline<DX, DY, DO, DI> | null;
     ...
     *         {@link Persistable#updateBatch}.
     */
    static clearUserUpdatesBatch(objs?: Array_Type<SeedData>, spec?: MergeSpec): ObjList<ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>> | null;
    ...
    dependencies(): SeedDataDeps<ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>> | null;
     ...
     */
    static convert(model: any, spec?: MlConvertSpec): ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>;

    /**
     * Freezes an {@link MlPipe}
     * @return modified copy of this {@link MlPipe} that cannot be trained
     */
    freeze(): ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>;
     ...
     */
    freeze(paths?: Array_Type<string>): ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>;

    /**
     * Unfreezes an {@link MlPipe}
     * @return modified copy of this {@link MlPipe} that can be trained
     */
    unfreeze(): ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>;
     ...
     */
    unfreeze(paths?: Array_Type<string>): ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>;
     ...
     * be returned as-is.
     */
    byReference(): ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>;
     ...
     */
    train_verify(x?: DX, y?: DY, spec?: MlOperationSpec): ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>;
     ...
     */
    withHyperparamSpaces(paramSpaces: Map_Type<string, Map_Type<string, Hp.ParamSpace>>): ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>;
     ...
     */
    replacePipe(pipePath: string, newPipe: MlPipe<any, any, any, any, any>): ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>;
     ...
     */
    replaceInterpreter(interpreterPath: string, newInterpreter: MlInterpreter<any, any>): ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>;
     ...
     */
    flatten(): ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>;
     ...
     */
    static fromV7Json(pipeline: string, runtimeRequirements: Array_Type<string>): ReliabilityRiskMl.Pipeline<DX, DY, DO, DI>;
