// TypeScript definitions for the C3 type ReliabilityMlModel.ClassificationScore

/**
 * Represents the classification score for a given {@link ReliabilityMlModel} and {@link ReliabilityAsset}.
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityMlModel.ClassificationScore
 */
declare namespace ReliabilityMlModel {
  export interface IClassificationScore {
     ...
     */
    comparisonTimeRange: ITimeRange;
 ...
 */
declare namespace ReliabilityMlModel {
  export class ClassificationScore extends Obj  {

    /**
     * The {@link ReliabilityMl.Project} that the classification score is being generated for.
     */
    readonly project: ReliabilityMl.Project;
    withProject(project: IReliabilityMl.Project): ReliabilityMlModel.ClassificationScore;
     ...
     */
    readonly id: string;
    withId(id: string): ReliabilityMlModel.ClassificationScore;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityMlModel.ClassificationScore;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): ReliabilityMlModel.ClassificationScore;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): ReliabilityMlModel.ClassificationScore;
    ...
    withVersion(version: number | null): ReliabilityMlModel.ClassificationScore;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): ReliabilityMlModel.ClassificationScore;

    /**
     * @inheritdoc
     */
    readonly facilityFilterPaths?: Array_Type<string>;
    withFacilityFilterPaths(facilityFilterPaths: Array_Type<string> | Array<string> | null): ReliabilityMlModel.ClassificationScore;
    ...
    withTypeIdent(typeIdent: string | null): ReliabilityMlModel.ClassificationScore;

    /**
     * The {@link ReliabilityMlModel} for which the classification score is being computed.
     */
    readonly model: ReliabilityMlModel;
    withModel(model: IReliabilityMlModel): ReliabilityMlModel.ClassificationScore;

    /**
     * The {@link ReliabilityAsset} for which the classification score is being computed.
     */
    readonly asset: ReliabilityAsset;
    withAsset(asset: IReliabilityAsset): ReliabilityMlModel.ClassificationScore;
     ...
     * used to compare the model's performance over the two periods, in order to generate the classification/monitoring score.
     */
    readonly referenceTimeRange: TimeRange;
    withReferenceTimeRange(referenceTimeRange: ITimeRange): ReliabilityMlModel.ClassificationScore;
     ...
     * for monitoring the {@link #model}.
     */
    readonly comparisonTimeRange: TimeRange;
    withComparisonTimeRange(comparisonTimeRange: ITimeRange): ReliabilityMlModel.ClassificationScore;

    /**
     * The value of the score.
     */
    readonly value: number;
    withValue(value: number): ReliabilityMlModel.ClassificationScore;
    ...
    withNotes(notes: string | null): ReliabilityMlModel.ClassificationScore;

    /**
     * The {@link User} who manually entered this score if the score was not system-generated.
     */
    readonly user?: User;
    withUser(user: IUser | null): ReliabilityMlModel.ClassificationScore;
     ...
     * @see #toJson
     */
    static fromJson(json: any): ReliabilityMlModel.ClassificationScore | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): ReliabilityMlModel.ClassificationScore | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): ReliabilityMlModel.ClassificationScore | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): ReliabilityMlModel.ClassificationScore | null;
     ...
     */
    replaceType(old: Type, new_: Type): ReliabilityMlModel.ClassificationScore;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityMlModel.ClassificationScore;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityMlModel.ClassificationScore;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityMlModel.ClassificationScore>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityMlModel.ClassificationScore>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityMlModel.ClassificationScore;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityMlModel.ClassificationScore;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityMlModel.ClassificationScore;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): ReliabilityMlModel.ClassificationScore;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): ReliabilityMlModel.ClassificationScore;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityMlModel.ClassificationScore;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityMlModel.ClassificationScore;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityMlModel.ClassificationScore;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): ReliabilityMlModel.ClassificationScore;
     ...
     * @see #removeField
     */
    withoutField(field: string): ReliabilityMlModel.ClassificationScore;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): ReliabilityMlModel.ClassificationScore;
     ...
     */
    withoutFields(fields: Array_Type<string>): ReliabilityMlModel.ClassificationScore;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityMlModel.ClassificationScore;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): ReliabilityMlModel.ClassificationScore;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityMlModel.ClassificationScore;
     ...
     * @see #unsetField
     */
    defaultField(field: string): ReliabilityMlModel.ClassificationScore;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): ReliabilityMlModel.ClassificationScore;
     ...
     * @see #removeField
     */
    unsetField(field: string): ReliabilityMlModel.ClassificationScore;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): ReliabilityMlModel.ClassificationScore;
     ...
     * @see #unsetField
     */
    removeField(field: string): ReliabilityMlModel.ClassificationScore;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): ReliabilityMlModel.ClassificationScore;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityMlModel.ClassificationScore;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityMlModel.ClassificationScore;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityMlModel.ClassificationScore;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityMlModel.ClassificationScore;

    mergeJson(json: any): ReliabilityMlModel.ClassificationScore;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityMlModel.ClassificationScore;
     ...
     */
    sumObj(other: Obj, deep?: boolean): ReliabilityMlModel.ClassificationScore;
     ...
     */
    singletonArray(): Array_Type<ReliabilityMlModel.ClassificationScore>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityMlModel.ClassificationScore> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<ReliabilityMlModel.ClassificationScore> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<ReliabilityMlModel.ClassificationScore>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<ReliabilityMlModel.ClassificationScore> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, ReliabilityMlModel.ClassificationScore> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityMlModel.ClassificationScore> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<ReliabilityMlModel.ClassificationScore>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<ReliabilityMlModel.ClassificationScore>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityMlModel.ClassificationScore;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityMlModel.ClassificationScore;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityMlModel.ClassificationScore;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): ReliabilityMlModel.ClassificationScore;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityMlModel.ClassificationScore;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): ReliabilityMlModel.ClassificationScore;
     ...
     * @see #fromString
     */
    static make(s: string): ReliabilityMlModel.ClassificationScore | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityMlModel.ClassificationScore;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): ReliabilityMlModel.ClassificationScore;
     ...
     */
    static cachedEmptyInst(): ReliabilityMlModel.ClassificationScore;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityMlModel.ClassificationScore> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): ReliabilityMlModel.ClassificationScore;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<ReliabilityMlModel.ClassificationScore>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<ReliabilityMlModel.ClassificationScore>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityMlModel.ClassificationScore> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityMlModel.ClassificationScore>> | null;
     ...
     */
    get(include?: string): ReliabilityMlModel.ClassificationScore | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): ReliabilityMlModel.ClassificationScore | null;
     ...
     */
    getMissing(spec: GetMissingSpec): ReliabilityMlModel.ClassificationScore;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): ReliabilityMlModel.ClassificationScore | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): ReliabilityMlModel.ClassificationScore;
     ...
     * @see #toString
     */
    static fromString(s: string): ReliabilityMlModel.ClassificationScore | null;
     ...
     */
    create(spec?: UpsertSpec): ReliabilityMlModel.ClassificationScore | null;
     ...
     */
    static createBatch(objs: Array_Type<ReliabilityMlModel.ClassificationScore>, spec?: UpsertSpec): ObjList<ReliabilityMlModel.ClassificationScore> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<ReliabilityMlModel.ClassificationScore>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityMlModel.ClassificationScore> | null;
     ...
     */
    update(srcObj?: ReliabilityMlModel.ClassificationScore, spec?: UpsertSpec): ReliabilityMlModel.ClassificationScore | null;
     ...
     */
    upsert(srcObj?: ReliabilityMlModel.ClassificationScore, spec?: UpsertSpec): ReliabilityMlModel.ClassificationScore | null;
     ...
     */
    merge(spec?: MergeSpec): ReliabilityMlModel.ClassificationScore | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): ReliabilityMlModel.ClassificationScore | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): ReliabilityMlModel.ClassificationScore | null;
     ...
     */
    static updateBatch(objs: Array_Type<ReliabilityMlModel.ClassificationScore>, srcObjs?: Array_Type<ReliabilityMlModel.ClassificationScore>, spec?: UpsertSpec): ObjList<ReliabilityMlModel.ClassificationScore> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<ReliabilityMlModel.ClassificationScore> | null>, spec?: UpsertSpec): ObjList<ReliabilityMlModel.ClassificationScore> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<ReliabilityMlModel.ClassificationScore>, srcObjs?: Array_Type<ReliabilityMlModel.ClassificationScore>, spec?: UpsertSpec): ObjList<ReliabilityMlModel.ClassificationScore> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<ReliabilityMlModel.ClassificationScore> | null>, spec?: UpsertSpec): ObjList<ReliabilityMlModel.ClassificationScore> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<ReliabilityMlModel.ClassificationScore>, spec?: TouchSpec): ObjList<ReliabilityMlModel.ClassificationScore> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityMlModel.ClassificationScore>, spec?: MergeSpec): ObjList<ReliabilityMlModel.ClassificationScore> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityMlModel.ClassificationScore>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityMlModel.ClassificationScore> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<ReliabilityMlModel.ClassificationScore> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityMlModel.ClassificationScore> | null;
     ...
     */
    static mergeAll(mergeObj: ReliabilityMlModel.ClassificationScore, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: ReliabilityMlModel.ClassificationScore, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<ReliabilityMlModel.ClassificationScore>, spec?: UpsertSpec): ObjList<ReliabilityMlModel.ClassificationScore> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<ReliabilityMlModel.ClassificationScore>, spec?: UpsertSpec): ObjList<ReliabilityMlModel.ClassificationScore> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): ReliabilityMlModel.ClassificationScore | null;
     ...
     */
    static beforeCreate(objs: Array_Type<ReliabilityMlModel.ClassificationScore>): ObjList<ReliabilityMlModel.ClassificationScore>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<ReliabilityMlModel.ClassificationScore>): ObjList<ReliabilityMlModel.ClassificationScore>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<ReliabilityMlModel.ClassificationScore>): ObjList<ReliabilityMlModel.ClassificationScore>;
     ...
     */
    static afterCreate(objs: Array_Type<ReliabilityMlModel.ClassificationScore>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<ReliabilityMlModel.ClassificationScore>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<ReliabilityMlModel.ClassificationScore>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityMlModel.ClassificationScore>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityMlModel.ClassificationScore>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): ReliabilityMlModel.ClassificationScore | null;
     ...
     */
    withoutIdentity(): ReliabilityMlModel.ClassificationScore | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<ReliabilityMlModel.ClassificationScore>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: ReliabilityMlModel.ClassificationScore, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<ReliabilityMlModel.ClassificationScore>, callback?: λFunction<ReliabilityMlModel.ClassificationScore | null, ReliabilityMlModel.ClassificationScore | null>): ObjList<ReliabilityMlModel.ClassificationScore>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<ReliabilityMlModel.ClassificationScore>, callback?: λFunction<ReliabilityMlModel.ClassificationScore | null, ReliabilityMlModel.ClassificationScore | null>): Array_Type<ObjError> | null;
