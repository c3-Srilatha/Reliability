// TypeScript definitions for the C3 type ReliabilityMl.PredictionHeader
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityMl.PredictionHeader
 */
declare namespace ReliabilityMl {
  export interface IPredictionHeader {
     ...
     */
    data?: Array_Type<ReliabilityMl.Prediction> | Array<IReliabilityMl.Prediction>;
     ...
     */
    parent: IReliabilityAssetToModelRelation;
 ...
 */
declare namespace ReliabilityMl {
  export class PredictionHeader extends Obj  {

    /**
     * Populated on normalization. Indicates the earliest data point across various timeseries fields.
     */
    readonly earliest?: DateTime;
    withEarliest(earliest: DateTime | Date | string | null): ReliabilityMl.PredictionHeader;

    /**
     * Populated on normalization. Indicates the latest data point across various timeseries fields.
     */
    readonly latest?: DateTime;
    withLatest(latest: DateTime | Date | string | null): ReliabilityMl.PredictionHeader;

    /**
     * Populated on normalization. Indicates the earliest data point for each {@link Ann.Ts} fields.
     */
    readonly earliestTsDp?: Map_Type<string, TSDataPoint>;
    withEarliestTsDp(earliestTsDp: Map_Type<string, TSDataPoint> | {[key: string]: ITSDataPoint} | null): ReliabilityMl.PredictionHeader;

    /**
     * Populated on normalization. Indicates the latest data point for each {@link Ann.Ts} fields.
     */
    readonly latestTsDp?: Map_Type<string, TSDataPoint>;
    withLatestTsDp(latestTsDp: Map_Type<string, TSDataPoint> | {[key: string]: ITSDataPoint} | null): ReliabilityMl.PredictionHeader;
    ...
    withInterval(interval: string | null): ReliabilityMl.PredictionHeader;
    ...
    withTimeZone(timeZone: string | null): ReliabilityMl.PredictionHeader;

    /**
     * If set, disables normalizing this time series. Invalidations will still continue to happen for this series normally.
     */
    readonly doNotNormalize?: boolean;
    withDoNotNormalize(doNotNormalize: boolean): ReliabilityMl.PredictionHeader;

    /**
     * Data points corresponding to this timeseries header
     */
    readonly data?: Array_Type<ReliabilityMl.Prediction>;
    withData(data: Array_Type<ReliabilityMl.Prediction> | Array<IReliabilityMl.Prediction> | null): ReliabilityMl.PredictionHeader;

    /**
     * Use this field to specify the interpolation mechanism to be applied for gaps in interval timeseries. Default: `ZERO_INTERPOLATOR`.
     */
    readonly interpolator?: string;
    withInterpolator(interpolator: string | null): ReliabilityMl.PredictionHeader;

    /**
     * Use this field to specify how normalization should handle duplicate data points. A duplicate point is one that has the same start, end, value, unit, and {@link TimedDataPointFields#isEstimated} values. Default: `IGNORE`.
     */
    readonly duplicateHandling?: string;
    withDuplicateHandling(duplicateHandling: string | null): ReliabilityMl.PredictionHeader;

    /**
     * Used to specify how normalization should handle overlapping data points. Default: `AVG`.
     */
    readonly overlapHandling?: string;
    withOverlapHandling(overlapHandling: string | null): ReliabilityMl.PredictionHeader;
    ...
    withBucketInterval(bucketInterval: string | null): ReliabilityMl.PredictionHeader;
    ...
    withNormalizationPartitionStrategy(normalizationPartitionStrategy: INormalizationPartitionStrategy | null): ReliabilityMl.PredictionHeader;

    /**
     * Indicates whether the last data point should be repeated until infinity
     */
    readonly extrapolate?: boolean;
    withExtrapolate(extrapolate: boolean): ReliabilityMl.PredictionHeader;
     ...
     */
    readonly id: string;
    withId(id: string): ReliabilityMl.PredictionHeader;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityMl.PredictionHeader;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): ReliabilityMl.PredictionHeader;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): ReliabilityMl.PredictionHeader;
    ...
    withVersion(version: number | null): ReliabilityMl.PredictionHeader;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): ReliabilityMl.PredictionHeader;

    /**
     * @inheritdoc
     */
    readonly facilityFilterPaths?: Array_Type<string>;
    withFacilityFilterPaths(facilityFilterPaths: Array_Type<string> | Array<string> | null): ReliabilityMl.PredictionHeader;
    ...
    withTypeIdent(typeIdent: string | null): ReliabilityMl.PredictionHeader;

    /**
     * The subject-model association related to this series header.
     */
    readonly parent: ReliabilityAssetToModelRelation;
    withParent(parent: IReliabilityAssetToModelRelation): ReliabilityMl.PredictionHeader;

    /**
     * The treatment to use for the timeseries.
     */
    readonly treatment?: string;
    withTreatment(treatment: string | null): ReliabilityMl.PredictionHeader;

    /**
     * The unit to use for the timeseries.
     */
    readonly unitConstraint?: Unit;
    withUnitConstraint(unitConstraint: IUnit | null): ReliabilityMl.PredictionHeader;
     ...
     * @see #toJson
     */
    static fromJson(json: any): ReliabilityMl.PredictionHeader | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): ReliabilityMl.PredictionHeader | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): ReliabilityMl.PredictionHeader | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): ReliabilityMl.PredictionHeader | null;
     ...
     */
    replaceType(old: Type, new_: Type): ReliabilityMl.PredictionHeader;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityMl.PredictionHeader;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityMl.PredictionHeader;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityMl.PredictionHeader>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityMl.PredictionHeader>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityMl.PredictionHeader;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityMl.PredictionHeader;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityMl.PredictionHeader;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): ReliabilityMl.PredictionHeader;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): ReliabilityMl.PredictionHeader;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityMl.PredictionHeader;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityMl.PredictionHeader;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityMl.PredictionHeader;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): ReliabilityMl.PredictionHeader;
     ...
     * @see #removeField
     */
    withoutField(field: string): ReliabilityMl.PredictionHeader;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): ReliabilityMl.PredictionHeader;
     ...
     */
    withoutFields(fields: Array_Type<string>): ReliabilityMl.PredictionHeader;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityMl.PredictionHeader;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): ReliabilityMl.PredictionHeader;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityMl.PredictionHeader;
     ...
     * @see #unsetField
     */
    defaultField(field: string): ReliabilityMl.PredictionHeader;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): ReliabilityMl.PredictionHeader;
     ...
     * @see #removeField
     */
    unsetField(field: string): ReliabilityMl.PredictionHeader;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): ReliabilityMl.PredictionHeader;
     ...
     * @see #unsetField
     */
    removeField(field: string): ReliabilityMl.PredictionHeader;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): ReliabilityMl.PredictionHeader;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityMl.PredictionHeader;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityMl.PredictionHeader;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityMl.PredictionHeader;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityMl.PredictionHeader;

    mergeJson(json: any): ReliabilityMl.PredictionHeader;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityMl.PredictionHeader;
     ...
     */
    sumObj(other: Obj, deep?: boolean): ReliabilityMl.PredictionHeader;
     ...
     */
    singletonArray(): Array_Type<ReliabilityMl.PredictionHeader>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityMl.PredictionHeader> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<ReliabilityMl.PredictionHeader> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<ReliabilityMl.PredictionHeader>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<ReliabilityMl.PredictionHeader> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, ReliabilityMl.PredictionHeader> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityMl.PredictionHeader> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<ReliabilityMl.PredictionHeader>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<ReliabilityMl.PredictionHeader>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityMl.PredictionHeader;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityMl.PredictionHeader;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityMl.PredictionHeader;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): ReliabilityMl.PredictionHeader;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityMl.PredictionHeader;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): ReliabilityMl.PredictionHeader;
     ...
     * @see #fromString
     */
    static make(s: string): ReliabilityMl.PredictionHeader | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityMl.PredictionHeader;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): ReliabilityMl.PredictionHeader;
     ...
     */
    static cachedEmptyInst(): ReliabilityMl.PredictionHeader;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityMl.PredictionHeader> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): ReliabilityMl.PredictionHeader;
     ...
     */
    static normalizeTimeseries(timeseries?: TimedDataFields<ReliabilityMl.Prediction>, start?: DateTime, end?: DateTime, overrideGrain?: string, forceGrainDetection?: boolean, force?: boolean): void;
     ...
     */
    static normalize(timeseries?: TimedDataFields<ReliabilityMl.Prediction>, start?: DateTime, end?: DateTime, overrideGrain?: string, forceGrainDetection?: boolean): NormalizationResult | null;
     ...
     */
    static normalizationUnit(rawHeader: TimedDataFields<ReliabilityMl.Prediction>, tsField: string): Unit | null;
     ...
     */
    static normalizationTreatment(rawHeader: TimedDataFields<ReliabilityMl.Prediction>, tsField: string): string;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<ReliabilityMl.PredictionHeader>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<ReliabilityMl.PredictionHeader>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityMl.PredictionHeader> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityMl.PredictionHeader>> | null;
     ...
     */
    get(include?: string): ReliabilityMl.PredictionHeader | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): ReliabilityMl.PredictionHeader | null;
     ...
     */
    getMissing(spec: GetMissingSpec): ReliabilityMl.PredictionHeader;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): ReliabilityMl.PredictionHeader | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): ReliabilityMl.PredictionHeader;
     ...
     * @see #toString
     */
    static fromString(s: string): ReliabilityMl.PredictionHeader | null;
     ...
     */
    create(spec?: UpsertSpec): ReliabilityMl.PredictionHeader | null;
     ...
     */
    static createBatch(objs: Array_Type<ReliabilityMl.PredictionHeader>, spec?: UpsertSpec): ObjList<ReliabilityMl.PredictionHeader> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<ReliabilityMl.PredictionHeader>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityMl.PredictionHeader> | null;
     ...
     */
    update(srcObj?: ReliabilityMl.PredictionHeader, spec?: UpsertSpec): ReliabilityMl.PredictionHeader | null;
     ...
     */
    upsert(srcObj?: ReliabilityMl.PredictionHeader, spec?: UpsertSpec): ReliabilityMl.PredictionHeader | null;
     ...
     */
    merge(spec?: MergeSpec): ReliabilityMl.PredictionHeader | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): ReliabilityMl.PredictionHeader | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): ReliabilityMl.PredictionHeader | null;
     ...
     */
    static updateBatch(objs: Array_Type<ReliabilityMl.PredictionHeader>, srcObjs?: Array_Type<ReliabilityMl.PredictionHeader>, spec?: UpsertSpec): ObjList<ReliabilityMl.PredictionHeader> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<ReliabilityMl.PredictionHeader> | null>, spec?: UpsertSpec): ObjList<ReliabilityMl.PredictionHeader> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<ReliabilityMl.PredictionHeader>, srcObjs?: Array_Type<ReliabilityMl.PredictionHeader>, spec?: UpsertSpec): ObjList<ReliabilityMl.PredictionHeader> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<ReliabilityMl.PredictionHeader> | null>, spec?: UpsertSpec): ObjList<ReliabilityMl.PredictionHeader> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<ReliabilityMl.PredictionHeader>, spec?: TouchSpec): ObjList<ReliabilityMl.PredictionHeader> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityMl.PredictionHeader>, spec?: MergeSpec): ObjList<ReliabilityMl.PredictionHeader> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityMl.PredictionHeader>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityMl.PredictionHeader> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<ReliabilityMl.PredictionHeader> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityMl.PredictionHeader> | null;
     ...
     */
    static mergeAll(mergeObj: ReliabilityMl.PredictionHeader, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: ReliabilityMl.PredictionHeader, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<ReliabilityMl.PredictionHeader>, spec?: UpsertSpec): ObjList<ReliabilityMl.PredictionHeader> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<ReliabilityMl.PredictionHeader>, spec?: UpsertSpec): ObjList<ReliabilityMl.PredictionHeader> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): ReliabilityMl.PredictionHeader | null;
     ...
     */
    static beforeCreate(objs: Array_Type<ReliabilityMl.PredictionHeader>): ObjList<ReliabilityMl.PredictionHeader>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<ReliabilityMl.PredictionHeader>): ObjList<ReliabilityMl.PredictionHeader>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<ReliabilityMl.PredictionHeader>): ObjList<ReliabilityMl.PredictionHeader>;
     ...
     */
    static afterCreate(objs: Array_Type<ReliabilityMl.PredictionHeader>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<ReliabilityMl.PredictionHeader>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<ReliabilityMl.PredictionHeader>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityMl.PredictionHeader>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityMl.PredictionHeader>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): ReliabilityMl.PredictionHeader | null;
     ...
     */
    withoutIdentity(): ReliabilityMl.PredictionHeader | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<ReliabilityMl.PredictionHeader>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: ReliabilityMl.PredictionHeader, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<ReliabilityMl.PredictionHeader>, callback?: λFunction<ReliabilityMl.PredictionHeader | null, ReliabilityMl.PredictionHeader | null>): ObjList<ReliabilityMl.PredictionHeader>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<ReliabilityMl.PredictionHeader>, callback?: λFunction<ReliabilityMl.PredictionHeader | null, ReliabilityMl.PredictionHeader | null>): Array_Type<ObjError> | null;
