// TypeScript definitions for the C3 type ReliabilityAssetValidationAlert

/**
 * A persisted type representing validation alerts triggered on a {@link ReliabilityAsset}.
 *
 * Validation alerts are alerts for testing purposes; they are not "real" alerts. They're used to check that the
 * {@link ReliabilityMlModel} we are defining is working as expected and are generated from training a model and
 * performing the validation workflow via the `ReliabilityRiskMlModel#processValidationAlertTimeseries` method triggered
 * by `ReliabilityOrchestrator.ReliabilityRisk.ModelValidationJob` for Risk and
 * {@link ReliabilityMl.Project#processValidationAlertsForAsset} triggered by `ReliabilityOrchestrator.PostTrainingJob` for Project Agnostic.
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityAssetValidationAlert
 */
declare interface IReliabilityAssetValidationAlert {
  ...
  /**
   * The feedback that the user selected for this alert.
   */
  feedback?: string;

  /**
   * The reference to the relation that generated this alert.
   */
  relation?: IReliabilityAssetToRiskModelValidationRelation;

  /**
   * Whether this entity is a model validation type.
   */
 ...
 * {@link ReliabilityMl.Project#processValidationAlertsForAsset} triggered by `ReliabilityOrchestrator.PostTrainingJob` for Project Agnostic.
 *
 * @remarks this represents a made instance of ReliabilityAssetValidationAlert
 */
declare class ReliabilityAssetValidationAlert extends Obj  {

  /**
   * Timestamp for the value.
   */
  readonly timestamp?: DateTime;
  withTimestamp(timestamp: DateTime | Date | string | null): ReliabilityAssetValidationAlert;
   ...
   */
  readonly id: string;
  withId(id: string): ReliabilityAssetValidationAlert;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityAssetValidationAlert;

  /**
   * @inheritdoc
   */
  readonly name: string;
  withName(name: string): ReliabilityAssetValidationAlert;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): ReliabilityAssetValidationAlert;
  ...
  withVersion(version: number | null): ReliabilityAssetValidationAlert;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): ReliabilityAssetValidationAlert;

  /**
   * The {@link ReliabilityAsset} linked to this alert.
   */
  readonly parent: ReliabilityAsset;
  withParent(parent: IReliabilityAsset): ReliabilityAssetValidationAlert;

  /**
   * The {@link ReliabilityMlModel} which triggered this alert.
   */
  readonly triggeringModel?: ReliabilityMlModel;
  withTriggeringModel(triggeringModel: IReliabilityMlModel | null): ReliabilityAssetValidationAlert;

  /**
   * The id of the {@link ReliabilityAssetAlert#triggeringModel}.
   */
  readonly triggeringModelId?: string;
  withTriggeringModelId(triggeringModelId: string | null): ReliabilityAssetValidationAlert;
  ...
  withFeatureContributionMap(featureContributionMap: Map_Type<string, number> | {[key: string]: number} | null): ReliabilityAssetValidationAlert;
  ...
  withPrimaryModelOutput(primaryModelOutput: IReliabilityAssetAlert.ModelOutput | null): ReliabilityAssetValidationAlert;
  ...
  withAllPrimaryModelOutputs(allPrimaryModelOutputs: Map_Type<string, ReliabilityAssetAlert.ModelOutput> | {[key: string]: IReliabilityAssetAlert.ModelOutput} | null): ReliabilityAssetValidationAlert;

  /**
   * @inheritdoc
   */
  readonly facilityFilterPaths?: Array_Type<string>;
  withFacilityFilterPaths(facilityFilterPaths: Array_Type<string> | Array<string> | null): ReliabilityAssetValidationAlert;

  /**
   * The feedback that the user selected for this alert.
   */
  readonly feedback?: string;
  withFeedback(feedback: string | null): ReliabilityAssetValidationAlert;

  /**
   * The reference to the relation that generated this alert.
   */
  readonly relation?: ReliabilityAssetToRiskModelValidationRelation;
  withRelation(relation: IReliabilityAssetToRiskModelValidationRelation | null): ReliabilityAssetValidationAlert;

  /**
   * Whether this entity is a model validation type.
   */
  readonly isValidationType?: boolean;
  withIsValidationType(isValidationType: boolean): ReliabilityAssetValidationAlert;
   ...
   * @see #toJson
   */
  static fromJson(json: any): ReliabilityAssetValidationAlert | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): ReliabilityAssetValidationAlert | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): ReliabilityAssetValidationAlert | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): ReliabilityAssetValidationAlert | null;
   ...
   */
  replaceType(old: Type, new_: Type): ReliabilityAssetValidationAlert;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityAssetValidationAlert;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityAssetValidationAlert;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityAssetValidationAlert>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityAssetValidationAlert>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityAssetValidationAlert;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityAssetValidationAlert;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityAssetValidationAlert;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ReliabilityAssetValidationAlert;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ReliabilityAssetValidationAlert;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityAssetValidationAlert;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityAssetValidationAlert;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityAssetValidationAlert;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ReliabilityAssetValidationAlert;
   ...
   * @see #removeField
   */
  withoutField(field: string): ReliabilityAssetValidationAlert;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): ReliabilityAssetValidationAlert;
   ...
   */
  withoutFields(fields: Array_Type<string>): ReliabilityAssetValidationAlert;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityAssetValidationAlert;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ReliabilityAssetValidationAlert;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityAssetValidationAlert;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ReliabilityAssetValidationAlert;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ReliabilityAssetValidationAlert;
   ...
   * @see #removeField
   */
  unsetField(field: string): ReliabilityAssetValidationAlert;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ReliabilityAssetValidationAlert;
   ...
   * @see #unsetField
   */
  removeField(field: string): ReliabilityAssetValidationAlert;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ReliabilityAssetValidationAlert;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityAssetValidationAlert;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityAssetValidationAlert;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityAssetValidationAlert;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityAssetValidationAlert;

  mergeJson(json: any): ReliabilityAssetValidationAlert;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityAssetValidationAlert;
   ...
   */
  sumObj(other: Obj, deep?: boolean): ReliabilityAssetValidationAlert;
   ...
   */
  singletonArray(): Array_Type<ReliabilityAssetValidationAlert>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityAssetValidationAlert> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ReliabilityAssetValidationAlert> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<ReliabilityAssetValidationAlert>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ReliabilityAssetValidationAlert> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, ReliabilityAssetValidationAlert> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityAssetValidationAlert> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ReliabilityAssetValidationAlert>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ReliabilityAssetValidationAlert>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityAssetValidationAlert;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityAssetValidationAlert;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityAssetValidationAlert;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ReliabilityAssetValidationAlert;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityAssetValidationAlert;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ReliabilityAssetValidationAlert;
   ...
   * @see #fromString
   */
  static make(s: string): ReliabilityAssetValidationAlert | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityAssetValidationAlert;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): ReliabilityAssetValidationAlert;
   ...
   */
  static cachedEmptyInst(): ReliabilityAssetValidationAlert;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityAssetValidationAlert> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): ReliabilityAssetValidationAlert;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<ReliabilityAssetValidationAlert>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<ReliabilityAssetValidationAlert>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityAssetValidationAlert> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityAssetValidationAlert>> | null;
   ...
   */
  get(include?: string): ReliabilityAssetValidationAlert | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): ReliabilityAssetValidationAlert | null;
   ...
   */
  getMissing(spec: GetMissingSpec): ReliabilityAssetValidationAlert;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): ReliabilityAssetValidationAlert | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): ReliabilityAssetValidationAlert;
   ...
   * @see #toString
   */
  static fromString(s: string): ReliabilityAssetValidationAlert | null;
   ...
   */
  create(spec?: UpsertSpec): ReliabilityAssetValidationAlert | null;
   ...
   */
  static createBatch(objs: Array_Type<ReliabilityAssetValidationAlert>, spec?: UpsertSpec): ObjList<ReliabilityAssetValidationAlert> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<ReliabilityAssetValidationAlert>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityAssetValidationAlert> | null;
   ...
   */
  update(srcObj?: ReliabilityAssetValidationAlert, spec?: UpsertSpec): ReliabilityAssetValidationAlert | null;
   ...
   */
  upsert(srcObj?: ReliabilityAssetValidationAlert, spec?: UpsertSpec): ReliabilityAssetValidationAlert | null;
   ...
   */
  merge(spec?: MergeSpec): ReliabilityAssetValidationAlert | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): ReliabilityAssetValidationAlert | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): ReliabilityAssetValidationAlert | null;
   ...
   */
  static updateBatch(objs: Array_Type<ReliabilityAssetValidationAlert>, srcObjs?: Array_Type<ReliabilityAssetValidationAlert>, spec?: UpsertSpec): ObjList<ReliabilityAssetValidationAlert> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<ReliabilityAssetValidationAlert> | null>, spec?: UpsertSpec): ObjList<ReliabilityAssetValidationAlert> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<ReliabilityAssetValidationAlert>, srcObjs?: Array_Type<ReliabilityAssetValidationAlert>, spec?: UpsertSpec): ObjList<ReliabilityAssetValidationAlert> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<ReliabilityAssetValidationAlert> | null>, spec?: UpsertSpec): ObjList<ReliabilityAssetValidationAlert> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<ReliabilityAssetValidationAlert>, spec?: TouchSpec): ObjList<ReliabilityAssetValidationAlert> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityAssetValidationAlert>, spec?: MergeSpec): ObjList<ReliabilityAssetValidationAlert> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityAssetValidationAlert>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityAssetValidationAlert> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<ReliabilityAssetValidationAlert> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityAssetValidationAlert> | null;
   ...
   */
  static mergeAll(mergeObj: ReliabilityAssetValidationAlert, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: ReliabilityAssetValidationAlert, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<ReliabilityAssetValidationAlert>, spec?: UpsertSpec): ObjList<ReliabilityAssetValidationAlert> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<ReliabilityAssetValidationAlert>, spec?: UpsertSpec): ObjList<ReliabilityAssetValidationAlert> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): ReliabilityAssetValidationAlert | null;
   ...
   */
  static beforeCreate(objs: Array_Type<ReliabilityAssetValidationAlert>): ObjList<ReliabilityAssetValidationAlert>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<ReliabilityAssetValidationAlert>): ObjList<ReliabilityAssetValidationAlert>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<ReliabilityAssetValidationAlert>): ObjList<ReliabilityAssetValidationAlert>;
   ...
   */
  static afterCreate(objs: Array_Type<ReliabilityAssetValidationAlert>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<ReliabilityAssetValidationAlert>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<ReliabilityAssetValidationAlert>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityAssetValidationAlert>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityAssetValidationAlert>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): ReliabilityAssetValidationAlert | null;
   ...
   */
  withoutIdentity(): ReliabilityAssetValidationAlert | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<ReliabilityAssetValidationAlert>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: ReliabilityAssetValidationAlert, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<ReliabilityAssetValidationAlert>, callback?: λFunction<ReliabilityAssetValidationAlert | null, ReliabilityAssetValidationAlert | null>): ObjList<ReliabilityAssetValidationAlert>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<ReliabilityAssetValidationAlert>, callback?: λFunction<ReliabilityAssetValidationAlert | null, ReliabilityAssetValidationAlert | null>): Array_Type<ObjError> | null;
