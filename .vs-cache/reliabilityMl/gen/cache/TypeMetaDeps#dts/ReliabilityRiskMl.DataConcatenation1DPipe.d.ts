// TypeScript definitions for the C3 type ReliabilityRiskMl.DataConcatenation1DPipe

/**
 * This type represents an {@link MlPipe} template for a data operation that concatenates multiple 1-dimensional
 * input datasets horizontally. It combines the provided datasets into a single dataset by aligning their rows
 * based on the key values (the column names) provided by the user. This operation is typically used when merging
 * several data sources with 1-D structures (like time series data or simple feature vectors) into a unified dataset.
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityRiskMl.DataConcatenation1DPipe
 */
declare namespace ReliabilityRiskMl {
  export interface IDataConcatenation1DPipe<DX> {
    ...
    /**
     * A list of column names (or keys) that will be used to bind the input datasets.
     * These column names will be assigned to the datasets in the resulting concatenated dataset.
     *
     * The input datasets are expected to have 1-D structures, and this field helps define the column names
     * for each dataset after they are concatenated horizontally. The user needs to specify these names for the
     * process to ensure the proper alignment of the datasets.
     */
    inputNames: Array_Type<string> | Array<string>;
  }
}
 ...
 * several data sources with 1-D structures (like time series data or simple feature vectors) into a unified dataset.
 *
 * @remarks this represents a made instance of ReliabilityRiskMl.DataConcatenation1DPipe
 */
declare namespace ReliabilityRiskMl {
  export class DataConcatenation1DPipe<DX> extends Obj  {
     ...
     */
    readonly id: string;
    withId(id: string): ReliabilityRiskMl.DataConcatenation1DPipe;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityRiskMl.DataConcatenation1DPipe;

    /**
     * Name of this pipe.
     */
    readonly name?: string;
    withName(name: string | null): ReliabilityRiskMl.DataConcatenation1DPipe;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): ReliabilityRiskMl.DataConcatenation1DPipe;
    ...
    withVersion(version: number | null): ReliabilityRiskMl.DataConcatenation1DPipe;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): ReliabilityRiskMl.DataConcatenation1DPipe;
    ...
    withUserUpdatedFields(userUpdatedFields: Array_Type<string> | Array<string> | null): ReliabilityRiskMl.DataConcatenation1DPipe;
    ...
    withHidden(hidden: boolean): ReliabilityRiskMl.DataConcatenation1DPipe;
    ...
    withUserOwned(userOwned: boolean): ReliabilityRiskMl.DataConcatenation1DPipe;
    ...
    withTypeIdent(typeIdent: string | null): ReliabilityRiskMl.DataConcatenation1DPipe;

    /**
     * If true, then the pipe shall not be retrained
     */
    readonly frozen?: boolean;
    withFrozen(frozen: boolean): ReliabilityRiskMl.DataConcatenation1DPipe;

    /**
     * True if training has succeeded and false otherwise.
     */
    readonly trained?: boolean;
    withTrained(trained: boolean): ReliabilityRiskMl.DataConcatenation1DPipe;

    /**
     * Errors from training.
     */
    readonly trainingErrors?: string;
    withTrainingErrors(trainingErrors: string | null): ReliabilityRiskMl.DataConcatenation1DPipe;

    /**
     * If true, the underlying model only accepts flattened input.
     */
    readonly flattenInput?: boolean;
    withFlattenInput(flattenInput: boolean): ReliabilityRiskMl.DataConcatenation1DPipe;

    /**
     * The hyperparameters overridden of a native model or pipe.
     */
    readonly hyperparamOverrides?: Map_Type<string, any>;
    withHyperparamOverrides(hyperparamOverrides: Map_Type<string, any> | {[key: string]: any} | null): ReliabilityRiskMl.DataConcatenation1DPipe;
    ...
    withHyperparamSearchSpace(hyperparamSearchSpace: IHp.SearchSpace | null): ReliabilityRiskMl.DataConcatenation1DPipe;
    ...
    withHpoSpec(hpoSpec: IHpo.Spec | null): ReliabilityRiskMl.DataConcatenation1DPipe;

    /**
     * {@link Hpo.Experiment} stores the result of hyperparameter optimization to find the best model/pipeline.
     */
    readonly hpoExperiment?: Hpo.Experiment;
    withHpoExperiment(hpoExperiment: IHpo.Experiment | null): ReliabilityRiskMl.DataConcatenation1DPipe;

    /**
     * Reference to the experiment that produced this {@link MlPipe}. For example, this could be a {@link Hpo.ExperimentBase}.
     */
    readonly experiment?: any;
    withExperiment(experiment: any | null): ReliabilityRiskMl.DataConcatenation1DPipe;
    ...
    withModelFiles(modelFiles: Map_Type<string, Url> | {[key: string]: IUrl} | null): ReliabilityRiskMl.DataConcatenation1DPipe;
    ...
    withCustomModelCode(customModelCode: Map_Type<string, any> | {[key: string]: any} | null): ReliabilityRiskMl.DataConcatenation1DPipe;

    /**
     * Name for the function on the native model to call to do {@link MlProcessable#process}.
     */
    readonly processFunc?: string;
    withProcessFunc(processFunc: string | null): ReliabilityRiskMl.DataConcatenation1DPipe;
    ...
    withUnderlyingPipe(underlyingPipe: IMlAtomicPipe<any, any, any> | null): ReliabilityRiskMl.DataConcatenation1DPipe;
     ...
     * process to ensure the proper alignment of the datasets.
     */
    readonly inputNames: Array_Type<string>;
    withInputNames(inputNames: Array_Type<string> | Array<string>): ReliabilityRiskMl.DataConcatenation1DPipe;
     ...
     * @see #toJson
     */
    static fromJson(json: any): ReliabilityRiskMl.DataConcatenation1DPipe<DX> | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): ReliabilityRiskMl.DataConcatenation1DPipe<DX> | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): ReliabilityRiskMl.DataConcatenation1DPipe<DX> | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): ReliabilityRiskMl.DataConcatenation1DPipe<DX> | null;
     ...
     */
    replaceType(old: Type, new_: Type): ReliabilityRiskMl.DataConcatenation1DPipe<DX>;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityRiskMl.DataConcatenation1DPipe<DX>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityRiskMl.DataConcatenation1DPipe<DX>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityRiskMl.DataConcatenation1DPipe<DX>>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityRiskMl.DataConcatenation1DPipe<DX>>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityRiskMl.DataConcatenation1DPipe<DX>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityRiskMl.DataConcatenation1DPipe<DX>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityRiskMl.DataConcatenation1DPipe<DX>;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): ReliabilityRiskMl.DataConcatenation1DPipe<DX>;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): ReliabilityRiskMl.DataConcatenation1DPipe<DX>;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityRiskMl.DataConcatenation1DPipe<DX>;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityRiskMl.DataConcatenation1DPipe<DX>;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityRiskMl.DataConcatenation1DPipe<DX>;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): ReliabilityRiskMl.DataConcatenation1DPipe<DX>;
     ...
     * @see #removeField
     */
    withoutField(field: string): ReliabilityRiskMl.DataConcatenation1DPipe<DX>;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): ReliabilityRiskMl.DataConcatenation1DPipe<DX>;
     ...
     */
    withoutFields(fields: Array_Type<string>): ReliabilityRiskMl.DataConcatenation1DPipe<DX>;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityRiskMl.DataConcatenation1DPipe<DX>;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): ReliabilityRiskMl.DataConcatenation1DPipe<DX>;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityRiskMl.DataConcatenation1DPipe<DX>;
     ...
     * @see #unsetField
     */
    defaultField(field: string): ReliabilityRiskMl.DataConcatenation1DPipe<DX>;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): ReliabilityRiskMl.DataConcatenation1DPipe<DX>;
     ...
     * @see #removeField
     */
    unsetField(field: string): ReliabilityRiskMl.DataConcatenation1DPipe<DX>;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): ReliabilityRiskMl.DataConcatenation1DPipe<DX>;
     ...
     * @see #unsetField
     */
    removeField(field: string): ReliabilityRiskMl.DataConcatenation1DPipe<DX>;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): ReliabilityRiskMl.DataConcatenation1DPipe<DX>;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityRiskMl.DataConcatenation1DPipe<DX>;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityRiskMl.DataConcatenation1DPipe<DX>;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityRiskMl.DataConcatenation1DPipe<DX>;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityRiskMl.DataConcatenation1DPipe<DX>;

    mergeJson(json: any): ReliabilityRiskMl.DataConcatenation1DPipe<DX>;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityRiskMl.DataConcatenation1DPipe<DX>;
     ...
     */
    sumObj(other: Obj, deep?: boolean): ReliabilityRiskMl.DataConcatenation1DPipe<DX>;
     ...
     */
    singletonArray(): Array_Type<ReliabilityRiskMl.DataConcatenation1DPipe<DX>>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityRiskMl.DataConcatenation1DPipe<DX>> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<ReliabilityRiskMl.DataConcatenation1DPipe<DX>> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<ReliabilityRiskMl.DataConcatenation1DPipe<DX>>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<ReliabilityRiskMl.DataConcatenation1DPipe<DX>> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, ReliabilityRiskMl.DataConcatenation1DPipe<DX>> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityRiskMl.DataConcatenation1DPipe<DX>> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<ReliabilityRiskMl.DataConcatenation1DPipe<DX>>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<ReliabilityRiskMl.DataConcatenation1DPipe<DX>>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityRiskMl.DataConcatenation1DPipe<DX>;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityRiskMl.DataConcatenation1DPipe<DX>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityRiskMl.DataConcatenation1DPipe<DX>;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): ReliabilityRiskMl.DataConcatenation1DPipe<DX>;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityRiskMl.DataConcatenation1DPipe<DX>;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): ReliabilityRiskMl.DataConcatenation1DPipe<DX>;
     ...
     * @see #fromString
     */
    static make(s: string): ReliabilityRiskMl.DataConcatenation1DPipe<DX> | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityRiskMl.DataConcatenation1DPipe<DX>;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): ReliabilityRiskMl.DataConcatenation1DPipe<DX>;
     ...
     */
    static cachedEmptyInst(): ReliabilityRiskMl.DataConcatenation1DPipe<DX>;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityRiskMl.DataConcatenation1DPipe<DX>> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): ReliabilityRiskMl.DataConcatenation1DPipe<DX>;
     ...
     */
    remakeTemplate(): ReliabilityRiskMl.DataConcatenation1DPipe<DX>;

    /**
     * This method generates the type bindings for the operation. It creates the necessary data bindings based on the
     * input datasets and ensures the proper data flow through the pipe. This method is important for setting up
     * the type system and defining how the input data will be transformed and outputted.
     *
     * The `generateTypeBindings` function is responsible for ensuring the correct type matching between input and
     * output datasets, allowing the system to manage the data structures effectively.
     */
     ...
     */
    withoutIdentity(): ReliabilityRiskMl.DataConcatenation1DPipe<DX>;
     ...
     */
    trainSync(x: DX, y?: , spec?: MlOperationSpec): ReliabilityRiskMl.DataConcatenation1DPipe<DX>;

    /**
     * This field indicates whether the data operation can be trained. When set to true, it implies that the
     * concatenation operation can be adjusted or fine-tuned during the model training process. In the context of
     * the `DataConcatenation1DPipe`, it refers to the ability to modify the concatenation behavior based on the
     * training data.
     *
     * default false
     */
     ...
     *           the operation run object to query status and to get the final result.
     */
    process(x: DX, spec?: MlOperationSpec): MlOperationRun<Data> | null;
     ...
     */
    processSync(x: DX, spec?: MlOperationSpec): Data | null;
     ...
     */
    static allCached(doNotProduceAll?: boolean): Stream<ReliabilityRiskMl.DataConcatenation1DPipe<DX>> | null;
     ...
     */
    static find(filter?: string, doNotProduceAll?: boolean): Stream<ReliabilityRiskMl.DataConcatenation1DPipe<DX>> | null;
     ...
     * @return existing instances of this type that satisfy filter from data cache.
     */
    static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<ReliabilityRiskMl.DataConcatenation1DPipe<DX>> | null;
     ...
     * @see getCached
     */
    static findByCacheKey(key: string): ReliabilityRiskMl.DataConcatenation1DPipe<DX> | null;
     ...
     * @see findByCacheKey
     */
    static forCacheKey(key: string): ReliabilityRiskMl.DataConcatenation1DPipe<DX> | null;
     ...
     * @see findByCacheKey
     */
    getCached(): ReliabilityRiskMl.DataConcatenation1DPipe<DX> | null;

    /**
     * @return newly produced cached instance.
     */
    refreshCache(): ReliabilityRiskMl.DataConcatenation1DPipe<DX> | null;
     ...
     */
    static produce(key: string): ReliabilityRiskMl.DataConcatenation1DPipe<DX> | null;
     ...
     */
    static produceAll(): Map_Type<string, ReliabilityRiskMl.DataConcatenation1DPipe<DX>> | null;

    /**
     * Override for sub-types to produce all values.
     */
    static doProduceAll(): Map_Type<string, ReliabilityRiskMl.DataConcatenation1DPipe<DX>> | null;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<ReliabilityRiskMl.DataConcatenation1DPipe<DX>>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<ReliabilityRiskMl.DataConcatenation1DPipe<DX>>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityRiskMl.DataConcatenation1DPipe<DX>> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityRiskMl.DataConcatenation1DPipe<DX>>> | null;
     ...
     */
    get(include?: string): ReliabilityRiskMl.DataConcatenation1DPipe<DX> | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): ReliabilityRiskMl.DataConcatenation1DPipe<DX> | null;
     ...
     */
    getMissing(spec: GetMissingSpec): ReliabilityRiskMl.DataConcatenation1DPipe<DX>;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): ReliabilityRiskMl.DataConcatenation1DPipe<DX> | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): ReliabilityRiskMl.DataConcatenation1DPipe<DX>;
     ...
     * @see #toString
     */
    static fromString(s: string): ReliabilityRiskMl.DataConcatenation1DPipe<DX> | null;
     ...
     */
    create(spec?: UpsertSpec): ReliabilityRiskMl.DataConcatenation1DPipe<DX> | null;
     ...
     */
    static createBatch(objs: Array_Type<ReliabilityRiskMl.DataConcatenation1DPipe<DX>>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.DataConcatenation1DPipe<DX>> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<ReliabilityRiskMl.DataConcatenation1DPipe<DX>>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityRiskMl.DataConcatenation1DPipe<DX>> | null;
     ...
     */
    update(srcObj?: ReliabilityRiskMl.DataConcatenation1DPipe<DX>, spec?: UpsertSpec): ReliabilityRiskMl.DataConcatenation1DPipe<DX> | null;
     ...
     */
    upsert(srcObj?: ReliabilityRiskMl.DataConcatenation1DPipe<DX>, spec?: UpsertSpec): ReliabilityRiskMl.DataConcatenation1DPipe<DX> | null;
     ...
     */
    merge(spec?: MergeSpec): ReliabilityRiskMl.DataConcatenation1DPipe<DX> | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): ReliabilityRiskMl.DataConcatenation1DPipe<DX> | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): ReliabilityRiskMl.DataConcatenation1DPipe<DX> | null;
     ...
     */
    static updateBatch(objs: Array_Type<ReliabilityRiskMl.DataConcatenation1DPipe<DX>>, srcObjs?: Array_Type<ReliabilityRiskMl.DataConcatenation1DPipe<DX>>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.DataConcatenation1DPipe<DX>> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<ReliabilityRiskMl.DataConcatenation1DPipe<DX>> | null>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.DataConcatenation1DPipe<DX>> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<ReliabilityRiskMl.DataConcatenation1DPipe<DX>>, srcObjs?: Array_Type<ReliabilityRiskMl.DataConcatenation1DPipe<DX>>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.DataConcatenation1DPipe<DX>> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<ReliabilityRiskMl.DataConcatenation1DPipe<DX>> | null>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.DataConcatenation1DPipe<DX>> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<ReliabilityRiskMl.DataConcatenation1DPipe<DX>>, spec?: TouchSpec): ObjList<ReliabilityRiskMl.DataConcatenation1DPipe<DX>> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityRiskMl.DataConcatenation1DPipe<DX>>, spec?: MergeSpec): ObjList<ReliabilityRiskMl.DataConcatenation1DPipe<DX>> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityRiskMl.DataConcatenation1DPipe<DX>>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityRiskMl.DataConcatenation1DPipe<DX>> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<ReliabilityRiskMl.DataConcatenation1DPipe<DX>> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityRiskMl.DataConcatenation1DPipe<DX>> | null;
     ...
     */
    static mergeAll(mergeObj: ReliabilityRiskMl.DataConcatenation1DPipe<DX>, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: ReliabilityRiskMl.DataConcatenation1DPipe<DX>, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<ReliabilityRiskMl.DataConcatenation1DPipe<DX>>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.DataConcatenation1DPipe<DX>> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<ReliabilityRiskMl.DataConcatenation1DPipe<DX>>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.DataConcatenation1DPipe<DX>> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): ReliabilityRiskMl.DataConcatenation1DPipe<DX> | null;
     ...
     */
    static beforeCreate(objs: Array_Type<ReliabilityRiskMl.DataConcatenation1DPipe<DX>>): ObjList<ReliabilityRiskMl.DataConcatenation1DPipe<DX>>;
     ...
     */
    static beforeUpdate(objs: Array_Type<ReliabilityRiskMl.DataConcatenation1DPipe<DX>>): ObjList<ReliabilityRiskMl.DataConcatenation1DPipe<DX>>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<ReliabilityRiskMl.DataConcatenation1DPipe<DX>>): ObjList<ReliabilityRiskMl.DataConcatenation1DPipe<DX>>;
     ...
     */
    static afterCreate(objs: Array_Type<ReliabilityRiskMl.DataConcatenation1DPipe<DX>>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<ReliabilityRiskMl.DataConcatenation1DPipe<DX>>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<ReliabilityRiskMl.DataConcatenation1DPipe<DX>>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityRiskMl.DataConcatenation1DPipe<DX>>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityRiskMl.DataConcatenation1DPipe<DX>>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): ReliabilityRiskMl.DataConcatenation1DPipe<DX> | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<ReliabilityRiskMl.DataConcatenation1DPipe<DX>>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: ReliabilityRiskMl.DataConcatenation1DPipe<DX>, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<ReliabilityRiskMl.DataConcatenation1DPipe<DX>>, callback?: λFunction<ReliabilityRiskMl.DataConcatenation1DPipe<DX> | null, ReliabilityRiskMl.DataConcatenation1DPipe<DX> | null>): ObjList<ReliabilityRiskMl.DataConcatenation1DPipe<DX>>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<ReliabilityRiskMl.DataConcatenation1DPipe<DX>>, callback?: λFunction<ReliabilityRiskMl.DataConcatenation1DPipe<DX> | null, ReliabilityRiskMl.DataConcatenation1DPipe<DX> | null>): Array_Type<ObjError> | null;
     ...
     */
    publish(subPath?: string, contentType?: string): ReliabilityRiskMl.DataConcatenation1DPipe<DX>;
     ...
     */
    static removeSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.DataConcatenation1DPipe<DX>> | null;
     ...
     */
    createSeedData(spec?: UpsertSpec): ReliabilityRiskMl.DataConcatenation1DPipe<DX> | null;
     ...
     */
    static createSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.DataConcatenation1DPipe<DX>> | null;
     ...
     */
    updateSeedData(srcObj?: SeedData, spec?: UpsertSpec): ReliabilityRiskMl.DataConcatenation1DPipe<DX> | null;
     ...
     */
    static updateSeedDataBatch(objs?: Array_Type<SeedData>, srcObjs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.DataConcatenation1DPipe<DX>> | null;
     ...
     * @return updated obj instance, same as {@link Persistable#update} return value.
     */
    clearUserUpdates(spec?: MergeSpec): ReliabilityRiskMl.DataConcatenation1DPipe<DX> | null;
     ...
     *         {@link Persistable#updateBatch}.
     */
    static clearUserUpdatesBatch(objs?: Array_Type<SeedData>, spec?: MergeSpec): ObjList<ReliabilityRiskMl.DataConcatenation1DPipe<DX>> | null;
    ...
    dependencies(): SeedDataDeps<ReliabilityRiskMl.DataConcatenation1DPipe<DX>> | null;
     ...
     */
    static convert(model: any, spec?: MlConvertSpec): ReliabilityRiskMl.DataConcatenation1DPipe<DX>;

    /**
     * Freezes an {@link MlPipe}
     * @return modified copy of this {@link MlPipe} that cannot be trained
     */
    freeze(): ReliabilityRiskMl.DataConcatenation1DPipe<DX>;

    /**
     * Unfreezes an {@link MlPipe}
     * @return modified copy of this {@link MlPipe} that can be trained
     */
    unfreeze(): ReliabilityRiskMl.DataConcatenation1DPipe<DX>;
     ...
     * be returned as-is.
     */
    byReference(): ReliabilityRiskMl.DataConcatenation1DPipe<DX>;
     ...
     */
    updateModelFiles(modelFiles: Map_Type<string, Url>, spec?: MlOperationSpec): ReliabilityRiskMl.DataConcatenation1DPipe<DX>;
     ...
     */
    afterTrain(doTrainOutputs: any, spec?: MlOperationSpec): ReliabilityRiskMl.DataConcatenation1DPipe<DX>;
    ...
    /**
     * This method processes the data by concatenating the input datasets horizontally. It takes the 1-dimensional
     * datasets, aligns them based on the specified `inputNames`, and returns the concatenated dataset as the output.
     *
     * The `doProcess` function is called during data processing when new datasets need to be merged. It ensures
     * that the datasets are concatenated in the correct order with the appropriate column names.
     */
     ...
     */
    withNewSpec(spec?: MlConvertSpec): ReliabilityRiskMl.DataConcatenation1DPipe<DX>;
     ...
     */
    afterConvert(model: any, spec?: MlConvertSpec): ReliabilityRiskMl.DataConcatenation1DPipe<DX>;
     ...
     */
    withHyperparamSpaces(paramSpaces: Map_Type<string, Hp.ParamSpace>): ReliabilityRiskMl.DataConcatenation1DPipe<DX>;
    ...
    /**
     * This method generates the underlying pipe for performing the concatenation operation. It sets up the necessary
     * steps for the concatenation process based on the provided input datasets and column names.
     *
     * The `generatePipe` function is crucial for setting up the operation pipeline and should be invoked before
