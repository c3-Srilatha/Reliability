// TypeScript definitions for the C3 type ReliabilityRiskScoreMlValidationContribution

/**
 * This type represents the validation contributions related to a risk score prediction in a machine learning model.
 * The validation contribution provides an assessment of how much each factor (or feature) contributes to the
 * overall prediction, and it is used to assess the model’s accuracy and reliability.
 *
 * The entity is designed to capture and store the contribution of specific features or factors in the model's
 * prediction, including their associated uncertainty ranges (lower and upper bounds).
 * This type can be used in the context of model validation, where you want to understand the impact of each feature
 * on the predicted risk score, providing a more transparent and interpretable machine learning model.
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityRiskScoreMlValidationContribution
 */
declare interface IReliabilityRiskScoreMlValidationContribution {
  ...
  parent: IReliabilityRiskScoreMlValidationContributionHeader;
  ...
  /**
   * The numerical value for the contribution of the feature or factor to the overall risk score prediction.
   * This value represents the impact that the given feature has on the final prediction, based on the model's
   * learned parameters. The contribution can be positive (indicating an increase in the risk score) or negative
   * (indicating a decrease in the risk score).
   */
  contribution: number;

  /**
   * The numerical value of the lower bound for the contribution of the feature to the risk score prediction.
   * This represents the lower end of the confidence interval or the uncertainty in the contribution's value.
   * It provides insight into the potential variability of the contribution and helps quantify the confidence
   * in the model's prediction for this feature.
   */
  contributionLowerBound?: number;

  /**
   * The numerical value of the upper bound for the contribution of the feature to the risk score prediction.
   * This represents the upper end of the confidence interval or the uncertainty in the contribution's value.
   * It provides insight into the potential variability of the contribution and helps quantify the confidence
   * in the model's prediction for this feature.
   */
  contributionUpperBound?: number;
}
 ...
 * on the predicted risk score, providing a more transparent and interpretable machine learning model.
 *
 * @remarks this represents a made instance of ReliabilityRiskScoreMlValidationContribution
 */
declare class ReliabilityRiskScoreMlValidationContribution extends Obj  {

  /**
   * start date for the data point
   */
  readonly start: DateTime;
  withStart(start: DateTime | Date | string): ReliabilityRiskScoreMlValidationContribution;
  ...
  withOutlierCode(outlierCode: number | null): ReliabilityRiskScoreMlValidationContribution;

  /**
   * (Optional) any comments for the data point
   */
  readonly comments?: string;
  withComments(comments: string | null): ReliabilityRiskScoreMlValidationContribution;

  /**
   * Denotes if the value is an actual value or an estimated value. default = null (actual value)
   */
  readonly isEstimated?: boolean;
  withIsEstimated(isEstimated: boolean): ReliabilityRiskScoreMlValidationContribution;
  ...
  withDataVersion(dataVersion: number | null): ReliabilityRiskScoreMlValidationContribution;

  /**
   * Customer specific status code for the data point (may be used to denote data quality)
   */
  readonly statusCode?: string;
  withStatusCode(statusCode: string | null): ReliabilityRiskScoreMlValidationContribution;

  /**
   * Partition key Bin separator used to separate partition key from bin id
   */
  readonly PK_BIN_SEPARATOR?: string;
  withPK_BIN_SEPARATOR(PK_BIN_SEPARATOR: string | null): ReliabilityRiskScoreMlValidationContribution;

  readonly parent: ReliabilityRiskScoreMlValidationContributionHeader;
  withParent(parent: IReliabilityRiskScoreMlValidationContributionHeader): ReliabilityRiskScoreMlValidationContribution;
  ...
  withTypeIdent(typeIdent: string | null): ReliabilityRiskScoreMlValidationContribution;
   ...
   */
  readonly id: string;
  withId(id: string): ReliabilityRiskScoreMlValidationContribution;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityRiskScoreMlValidationContribution;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): ReliabilityRiskScoreMlValidationContribution;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): ReliabilityRiskScoreMlValidationContribution;
  ...
  withVersion(version: number | null): ReliabilityRiskScoreMlValidationContribution;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): ReliabilityRiskScoreMlValidationContribution;
  ...
  withContribution(contribution: number): ReliabilityRiskScoreMlValidationContribution;
   ...
   * in the model's prediction for this feature.
   */
  readonly contributionLowerBound?: number;
  withContributionLowerBound(contributionLowerBound: number | null): ReliabilityRiskScoreMlValidationContribution;
   ...
   * in the model's prediction for this feature.
   */
  readonly contributionUpperBound?: number;
  withContributionUpperBound(contributionUpperBound: number | null): ReliabilityRiskScoreMlValidationContribution;
   ...
   * @see #toJson
   */
  static fromJson(json: any): ReliabilityRiskScoreMlValidationContribution | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): ReliabilityRiskScoreMlValidationContribution | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): ReliabilityRiskScoreMlValidationContribution | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): ReliabilityRiskScoreMlValidationContribution | null;
   ...
   */
  replaceType(old: Type, new_: Type): ReliabilityRiskScoreMlValidationContribution;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityRiskScoreMlValidationContribution;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityRiskScoreMlValidationContribution;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityRiskScoreMlValidationContribution>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityRiskScoreMlValidationContribution>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityRiskScoreMlValidationContribution;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityRiskScoreMlValidationContribution;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityRiskScoreMlValidationContribution;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ReliabilityRiskScoreMlValidationContribution;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ReliabilityRiskScoreMlValidationContribution;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityRiskScoreMlValidationContribution;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityRiskScoreMlValidationContribution;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityRiskScoreMlValidationContribution;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ReliabilityRiskScoreMlValidationContribution;
   ...
   * @see #removeField
   */
  withoutField(field: string): ReliabilityRiskScoreMlValidationContribution;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): ReliabilityRiskScoreMlValidationContribution;
   ...
   */
  withoutFields(fields: Array_Type<string>): ReliabilityRiskScoreMlValidationContribution;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityRiskScoreMlValidationContribution;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ReliabilityRiskScoreMlValidationContribution;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityRiskScoreMlValidationContribution;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ReliabilityRiskScoreMlValidationContribution;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ReliabilityRiskScoreMlValidationContribution;
   ...
   * @see #removeField
   */
  unsetField(field: string): ReliabilityRiskScoreMlValidationContribution;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ReliabilityRiskScoreMlValidationContribution;
   ...
   * @see #unsetField
   */
  removeField(field: string): ReliabilityRiskScoreMlValidationContribution;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ReliabilityRiskScoreMlValidationContribution;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityRiskScoreMlValidationContribution;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityRiskScoreMlValidationContribution;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityRiskScoreMlValidationContribution;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityRiskScoreMlValidationContribution;

  mergeJson(json: any): ReliabilityRiskScoreMlValidationContribution;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityRiskScoreMlValidationContribution;
   ...
   */
  sumObj(other: Obj, deep?: boolean): ReliabilityRiskScoreMlValidationContribution;
   ...
   */
  singletonArray(): Array_Type<ReliabilityRiskScoreMlValidationContribution>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityRiskScoreMlValidationContribution> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ReliabilityRiskScoreMlValidationContribution> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<ReliabilityRiskScoreMlValidationContribution>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ReliabilityRiskScoreMlValidationContribution> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, ReliabilityRiskScoreMlValidationContribution> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityRiskScoreMlValidationContribution> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ReliabilityRiskScoreMlValidationContribution>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ReliabilityRiskScoreMlValidationContribution>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityRiskScoreMlValidationContribution;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityRiskScoreMlValidationContribution;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityRiskScoreMlValidationContribution;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ReliabilityRiskScoreMlValidationContribution;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityRiskScoreMlValidationContribution;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ReliabilityRiskScoreMlValidationContribution;
   ...
   * @see #fromString
   */
  static make(s: string): ReliabilityRiskScoreMlValidationContribution | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityRiskScoreMlValidationContribution;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): ReliabilityRiskScoreMlValidationContribution;
   ...
   */
  static cachedEmptyInst(): ReliabilityRiskScoreMlValidationContribution;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityRiskScoreMlValidationContribution> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): ReliabilityRiskScoreMlValidationContribution;

  /**
   * Extract the partition key from the given obj
   */
  partitionKey(failIfMissing?: boolean): ReliabilityRiskScoreMlValidationContributionHeader | null;
   ...
   */
  static partition(objs?: Stream<ReliabilityRiskScoreMlValidationContribution>, spec?: PartitionBucketStrategy): Map_Type<string, KvDataPartition> | null;
   ...
   */
  static fromPartitions(partitions?: Stream<KvDataPartition>): Stream<ReliabilityRiskScoreMlValidationContribution> | null;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<ReliabilityRiskScoreMlValidationContribution>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<ReliabilityRiskScoreMlValidationContribution>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityRiskScoreMlValidationContribution> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityRiskScoreMlValidationContribution>> | null;
   ...
   */
  get(include?: string): ReliabilityRiskScoreMlValidationContribution | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): ReliabilityRiskScoreMlValidationContribution | null;
   ...
   */
  getMissing(spec: GetMissingSpec): ReliabilityRiskScoreMlValidationContribution;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): ReliabilityRiskScoreMlValidationContribution | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): ReliabilityRiskScoreMlValidationContribution;
   ...
   * @see #toString
   */
  static fromString(s: string): ReliabilityRiskScoreMlValidationContribution | null;
   ...
   */
  create(spec?: UpsertSpec): ReliabilityRiskScoreMlValidationContribution | null;
   ...
   */
  static createBatch(objs: Array_Type<ReliabilityRiskScoreMlValidationContribution>, spec?: UpsertSpec): ObjList<ReliabilityRiskScoreMlValidationContribution> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<ReliabilityRiskScoreMlValidationContribution>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityRiskScoreMlValidationContribution> | null;
   ...
   */
  update(srcObj?: ReliabilityRiskScoreMlValidationContribution, spec?: UpsertSpec): ReliabilityRiskScoreMlValidationContribution | null;
   ...
   */
  upsert(srcObj?: ReliabilityRiskScoreMlValidationContribution, spec?: UpsertSpec): ReliabilityRiskScoreMlValidationContribution | null;
   ...
   */
  merge(spec?: MergeSpec): ReliabilityRiskScoreMlValidationContribution | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): ReliabilityRiskScoreMlValidationContribution | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): ReliabilityRiskScoreMlValidationContribution | null;
   ...
   */
  static updateBatch(objs: Array_Type<ReliabilityRiskScoreMlValidationContribution>, srcObjs?: Array_Type<ReliabilityRiskScoreMlValidationContribution>, spec?: UpsertSpec): ObjList<ReliabilityRiskScoreMlValidationContribution> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<ReliabilityRiskScoreMlValidationContribution> | null>, spec?: UpsertSpec): ObjList<ReliabilityRiskScoreMlValidationContribution> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<ReliabilityRiskScoreMlValidationContribution>, srcObjs?: Array_Type<ReliabilityRiskScoreMlValidationContribution>, spec?: UpsertSpec): ObjList<ReliabilityRiskScoreMlValidationContribution> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<ReliabilityRiskScoreMlValidationContribution> | null>, spec?: UpsertSpec): ObjList<ReliabilityRiskScoreMlValidationContribution> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<ReliabilityRiskScoreMlValidationContribution>, spec?: TouchSpec): ObjList<ReliabilityRiskScoreMlValidationContribution> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityRiskScoreMlValidationContribution>, spec?: MergeSpec): ObjList<ReliabilityRiskScoreMlValidationContribution> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityRiskScoreMlValidationContribution>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityRiskScoreMlValidationContribution> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<ReliabilityRiskScoreMlValidationContribution> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityRiskScoreMlValidationContribution> | null;
   ...
   */
  static mergeAll(mergeObj: ReliabilityRiskScoreMlValidationContribution, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: ReliabilityRiskScoreMlValidationContribution, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<ReliabilityRiskScoreMlValidationContribution>, spec?: UpsertSpec): ObjList<ReliabilityRiskScoreMlValidationContribution> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<ReliabilityRiskScoreMlValidationContribution>, spec?: UpsertSpec): ObjList<ReliabilityRiskScoreMlValidationContribution> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): ReliabilityRiskScoreMlValidationContribution | null;
   ...
   */
  static beforeCreate(objs: Array_Type<ReliabilityRiskScoreMlValidationContribution>): ObjList<ReliabilityRiskScoreMlValidationContribution>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<ReliabilityRiskScoreMlValidationContribution>): ObjList<ReliabilityRiskScoreMlValidationContribution>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<ReliabilityRiskScoreMlValidationContribution>): ObjList<ReliabilityRiskScoreMlValidationContribution>;
   ...
   */
  static afterCreate(objs: Array_Type<ReliabilityRiskScoreMlValidationContribution>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<ReliabilityRiskScoreMlValidationContribution>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<ReliabilityRiskScoreMlValidationContribution>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityRiskScoreMlValidationContribution>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityRiskScoreMlValidationContribution>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): ReliabilityRiskScoreMlValidationContribution | null;
   ...
   */
  withoutIdentity(): ReliabilityRiskScoreMlValidationContribution | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<ReliabilityRiskScoreMlValidationContribution>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: ReliabilityRiskScoreMlValidationContribution, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<ReliabilityRiskScoreMlValidationContribution>, callback?: λFunction<ReliabilityRiskScoreMlValidationContribution | null, ReliabilityRiskScoreMlValidationContribution | null>): ObjList<ReliabilityRiskScoreMlValidationContribution>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<ReliabilityRiskScoreMlValidationContribution>, callback?: λFunction<ReliabilityRiskScoreMlValidationContribution | null, ReliabilityRiskScoreMlValidationContribution | null>): Array_Type<ObjError> | null;
