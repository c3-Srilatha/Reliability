// TypeScript definitions for the C3 type ReliabilityRiskScoreMlPrediction

/**
 * Represents a prediction related to the risk score in the context of machine learning or reliability modeling.
 * This entity captures predicted values, along with their upper and lower bounds, for assessing potential risks.
 * The entity mixes the properties of `TimedDataPoint` and includes metadata from `ReliabilityRiskScoreMlPredictionHeader` for additional context.
 * For details on other information stored in this Type, refer to the documentation on each of the fields of this Type.
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityRiskScoreMlPrediction
 */
declare interface IReliabilityRiskScoreMlPrediction {
  ...
  parent: IReliabilityRiskScoreMlPredictionHeader;
  ...
  /**
   * The predicted risk score value derived from a machine learning model or reliability model.
   * It represents the forecasted risk score, which could be used for asset health assessments, failure probabilities,
   * or other risk-related metrics within reliability models.
   *
   * `@ts(treatmentPath="parent.treatment", unitPath="parent.unitConstraint")` - Specifies the path to retrieve the
   * treatment value and unit constraints from the parent entity. This ensures that the value is appropriately treated
   * and conforms to the expected units.
   */
  value: number;

  /**
   * The upper bound for the predicted risk score value.
   * This field defines the maximum allowable value for the risk score prediction. It serves as a threshold to ensure that
   * the predicted value doesn't exceed a reasonable or acceptable limit. For example, it could ensure that predictions
   * don't surpass 100% risk or any other pre-defined upper limit based on business logic or safety concerns.
   */
  valueUpperBound?: number;

  /**
   * The lower bound for the predicted risk score value.
   * This field defines the minimum allowable value for the risk score prediction. It ensures that the risk score does not
   * drop below a predefined minimum threshold, which might be useful to avoid implausibly low predictions or to guarantee
   * that the model does not produce invalid or extreme negative predictions.
   */
 ...
 * For details on other information stored in this Type, refer to the documentation on each of the fields of this Type.
 *
 * @remarks this represents a made instance of ReliabilityRiskScoreMlPrediction
 */
declare class ReliabilityRiskScoreMlPrediction extends Obj  {

  /**
   * start date for the data point
   */
  readonly start: DateTime;
  withStart(start: DateTime | Date | string): ReliabilityRiskScoreMlPrediction;
  ...
  withOutlierCode(outlierCode: number | null): ReliabilityRiskScoreMlPrediction;

  /**
   * (Optional) any comments for the data point
   */
  readonly comments?: string;
  withComments(comments: string | null): ReliabilityRiskScoreMlPrediction;

  /**
   * Denotes if the value is an actual value or an estimated value. default = null (actual value)
   */
  readonly isEstimated?: boolean;
  withIsEstimated(isEstimated: boolean): ReliabilityRiskScoreMlPrediction;
  ...
  withDataVersion(dataVersion: number | null): ReliabilityRiskScoreMlPrediction;

  /**
   * Customer specific status code for the data point (may be used to denote data quality)
   */
  readonly statusCode?: string;
  withStatusCode(statusCode: string | null): ReliabilityRiskScoreMlPrediction;

  /**
   * Partition key Bin separator used to separate partition key from bin id
   */
  readonly PK_BIN_SEPARATOR?: string;
  withPK_BIN_SEPARATOR(PK_BIN_SEPARATOR: string | null): ReliabilityRiskScoreMlPrediction;

  readonly parent: ReliabilityRiskScoreMlPredictionHeader;
  withParent(parent: IReliabilityRiskScoreMlPredictionHeader): ReliabilityRiskScoreMlPrediction;
  ...
  withTypeIdent(typeIdent: string | null): ReliabilityRiskScoreMlPrediction;
   ...
   */
  readonly id: string;
  withId(id: string): ReliabilityRiskScoreMlPrediction;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityRiskScoreMlPrediction;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): ReliabilityRiskScoreMlPrediction;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): ReliabilityRiskScoreMlPrediction;
  ...
  withVersion(version: number | null): ReliabilityRiskScoreMlPrediction;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): ReliabilityRiskScoreMlPrediction;
  ...
  withValue(value: number): ReliabilityRiskScoreMlPrediction;
  ...
  withValueUpperBound(valueUpperBound: number | null): ReliabilityRiskScoreMlPrediction;
  ...
  withValueLowerBound(valueLowerBound: number | null): ReliabilityRiskScoreMlPrediction;
   ...
   * @see #toJson
   */
  static fromJson(json: any): ReliabilityRiskScoreMlPrediction | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): ReliabilityRiskScoreMlPrediction | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): ReliabilityRiskScoreMlPrediction | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): ReliabilityRiskScoreMlPrediction | null;
   ...
   */
  replaceType(old: Type, new_: Type): ReliabilityRiskScoreMlPrediction;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityRiskScoreMlPrediction;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityRiskScoreMlPrediction;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityRiskScoreMlPrediction>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityRiskScoreMlPrediction>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityRiskScoreMlPrediction;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityRiskScoreMlPrediction;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityRiskScoreMlPrediction;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ReliabilityRiskScoreMlPrediction;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ReliabilityRiskScoreMlPrediction;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityRiskScoreMlPrediction;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityRiskScoreMlPrediction;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityRiskScoreMlPrediction;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ReliabilityRiskScoreMlPrediction;
   ...
   * @see #removeField
   */
  withoutField(field: string): ReliabilityRiskScoreMlPrediction;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): ReliabilityRiskScoreMlPrediction;
   ...
   */
  withoutFields(fields: Array_Type<string>): ReliabilityRiskScoreMlPrediction;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityRiskScoreMlPrediction;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ReliabilityRiskScoreMlPrediction;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityRiskScoreMlPrediction;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ReliabilityRiskScoreMlPrediction;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ReliabilityRiskScoreMlPrediction;
   ...
   * @see #removeField
   */
  unsetField(field: string): ReliabilityRiskScoreMlPrediction;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ReliabilityRiskScoreMlPrediction;
   ...
   * @see #unsetField
   */
  removeField(field: string): ReliabilityRiskScoreMlPrediction;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ReliabilityRiskScoreMlPrediction;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityRiskScoreMlPrediction;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityRiskScoreMlPrediction;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityRiskScoreMlPrediction;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityRiskScoreMlPrediction;

  mergeJson(json: any): ReliabilityRiskScoreMlPrediction;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityRiskScoreMlPrediction;
   ...
   */
  sumObj(other: Obj, deep?: boolean): ReliabilityRiskScoreMlPrediction;
   ...
   */
  singletonArray(): Array_Type<ReliabilityRiskScoreMlPrediction>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityRiskScoreMlPrediction> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ReliabilityRiskScoreMlPrediction> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<ReliabilityRiskScoreMlPrediction>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ReliabilityRiskScoreMlPrediction> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, ReliabilityRiskScoreMlPrediction> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityRiskScoreMlPrediction> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ReliabilityRiskScoreMlPrediction>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ReliabilityRiskScoreMlPrediction>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityRiskScoreMlPrediction;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityRiskScoreMlPrediction;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityRiskScoreMlPrediction;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ReliabilityRiskScoreMlPrediction;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityRiskScoreMlPrediction;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ReliabilityRiskScoreMlPrediction;
   ...
   * @see #fromString
   */
  static make(s: string): ReliabilityRiskScoreMlPrediction | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityRiskScoreMlPrediction;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): ReliabilityRiskScoreMlPrediction;
   ...
   */
  static cachedEmptyInst(): ReliabilityRiskScoreMlPrediction;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityRiskScoreMlPrediction> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): ReliabilityRiskScoreMlPrediction;

  /**
   * Extract the partition key from the given obj
   */
  partitionKey(failIfMissing?: boolean): ReliabilityRiskScoreMlPredictionHeader | null;
   ...
   */
  static partition(objs?: Stream<ReliabilityRiskScoreMlPrediction>, spec?: PartitionBucketStrategy): Map_Type<string, KvDataPartition> | null;
   ...
   */
  static fromPartitions(partitions?: Stream<KvDataPartition>): Stream<ReliabilityRiskScoreMlPrediction> | null;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<ReliabilityRiskScoreMlPrediction>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<ReliabilityRiskScoreMlPrediction>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityRiskScoreMlPrediction> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityRiskScoreMlPrediction>> | null;
   ...
   */
  get(include?: string): ReliabilityRiskScoreMlPrediction | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): ReliabilityRiskScoreMlPrediction | null;
   ...
   */
  getMissing(spec: GetMissingSpec): ReliabilityRiskScoreMlPrediction;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): ReliabilityRiskScoreMlPrediction | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): ReliabilityRiskScoreMlPrediction;
   ...
   * @see #toString
   */
  static fromString(s: string): ReliabilityRiskScoreMlPrediction | null;
   ...
   */
  create(spec?: UpsertSpec): ReliabilityRiskScoreMlPrediction | null;
   ...
   */
  static createBatch(objs: Array_Type<ReliabilityRiskScoreMlPrediction>, spec?: UpsertSpec): ObjList<ReliabilityRiskScoreMlPrediction> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<ReliabilityRiskScoreMlPrediction>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityRiskScoreMlPrediction> | null;
   ...
   */
  update(srcObj?: ReliabilityRiskScoreMlPrediction, spec?: UpsertSpec): ReliabilityRiskScoreMlPrediction | null;
   ...
   */
  upsert(srcObj?: ReliabilityRiskScoreMlPrediction, spec?: UpsertSpec): ReliabilityRiskScoreMlPrediction | null;
   ...
   */
  merge(spec?: MergeSpec): ReliabilityRiskScoreMlPrediction | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): ReliabilityRiskScoreMlPrediction | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): ReliabilityRiskScoreMlPrediction | null;
   ...
   */
  static updateBatch(objs: Array_Type<ReliabilityRiskScoreMlPrediction>, srcObjs?: Array_Type<ReliabilityRiskScoreMlPrediction>, spec?: UpsertSpec): ObjList<ReliabilityRiskScoreMlPrediction> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<ReliabilityRiskScoreMlPrediction> | null>, spec?: UpsertSpec): ObjList<ReliabilityRiskScoreMlPrediction> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<ReliabilityRiskScoreMlPrediction>, srcObjs?: Array_Type<ReliabilityRiskScoreMlPrediction>, spec?: UpsertSpec): ObjList<ReliabilityRiskScoreMlPrediction> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<ReliabilityRiskScoreMlPrediction> | null>, spec?: UpsertSpec): ObjList<ReliabilityRiskScoreMlPrediction> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<ReliabilityRiskScoreMlPrediction>, spec?: TouchSpec): ObjList<ReliabilityRiskScoreMlPrediction> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityRiskScoreMlPrediction>, spec?: MergeSpec): ObjList<ReliabilityRiskScoreMlPrediction> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityRiskScoreMlPrediction>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityRiskScoreMlPrediction> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<ReliabilityRiskScoreMlPrediction> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityRiskScoreMlPrediction> | null;
   ...
   */
  static mergeAll(mergeObj: ReliabilityRiskScoreMlPrediction, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: ReliabilityRiskScoreMlPrediction, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<ReliabilityRiskScoreMlPrediction>, spec?: UpsertSpec): ObjList<ReliabilityRiskScoreMlPrediction> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<ReliabilityRiskScoreMlPrediction>, spec?: UpsertSpec): ObjList<ReliabilityRiskScoreMlPrediction> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): ReliabilityRiskScoreMlPrediction | null;
   ...
   */
  static beforeCreate(objs: Array_Type<ReliabilityRiskScoreMlPrediction>): ObjList<ReliabilityRiskScoreMlPrediction>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<ReliabilityRiskScoreMlPrediction>): ObjList<ReliabilityRiskScoreMlPrediction>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<ReliabilityRiskScoreMlPrediction>): ObjList<ReliabilityRiskScoreMlPrediction>;
   ...
   */
  static afterCreate(objs: Array_Type<ReliabilityRiskScoreMlPrediction>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<ReliabilityRiskScoreMlPrediction>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<ReliabilityRiskScoreMlPrediction>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityRiskScoreMlPrediction>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityRiskScoreMlPrediction>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): ReliabilityRiskScoreMlPrediction | null;
   ...
   */
  withoutIdentity(): ReliabilityRiskScoreMlPrediction | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<ReliabilityRiskScoreMlPrediction>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: ReliabilityRiskScoreMlPrediction, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<ReliabilityRiskScoreMlPrediction>, callback?: λFunction<ReliabilityRiskScoreMlPrediction | null, ReliabilityRiskScoreMlPrediction | null>): ObjList<ReliabilityRiskScoreMlPrediction>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<ReliabilityRiskScoreMlPrediction>, callback?: λFunction<ReliabilityRiskScoreMlPrediction | null, ReliabilityRiskScoreMlPrediction | null>): Array_Type<ObjError> | null;
