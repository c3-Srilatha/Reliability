// TypeScript definitions for the C3 type ReliabilityMlControlValvesConfig

/**
 * Represents the configuration for setting up a model that works with control valves.
 * The configuration specifies various sensor types associated with control valves,
 * such as sensors for the valve's percent open, process variable, setpoint, and mode. It also includes lists
 * of sensors that should be modeled or excluded from specific tasks like dataset preparation for correlation jobs.
 *
 * This type is typically used to define how control valve data should be processed and integrated into machine
 * learning models aimed at predicting or analyzing control valve behaviors and performance.
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityMlControlValvesConfig
 */
declare interface IReliabilityMlControlValvesConfig {
  ...
  /**
   * The {@link ExpectedSensor} corresponding to the percent open {@link Sensor} instrumented on a control valve.
   * This sensor measures how much the valve is open, typically represented as a percentage.
   */
  percentOpenExpectedSensor?: string;

  /**
   * The {@link ExpectedSensor} corresponding to the process variable {@link Sensor} instrumented on a control valve.
   * This sensor measures the process variable (e.g., pressure, temperature) that the valve is controlling.
   */
  processVariableExpectedSensor?: string;

  /**
   * The {@link ExpectedSensor} corresponding to the setpoint {@link Sensor} instrumented on a control valve.
   * This sensor measures the setpoint value that the control system is trying to maintain for the process.
   */
  setpointExpectedSensor?: string;

  /**
   * The {@link ExpectedSensor} corresponding to the mode {@link Sensor} instrumented on a control valve.
   * This sensor tracks the mode of the control valve (e.g., manual, automatic).
   */
  modeExpectedSensor?: string;

  /**
   * A list of {@link ExpectedSensor}s that can be modeled on a control valve {@link ReliabilityAsset}.
   * This list specifies the sensors that will be used for modeling the valve's behavior or performance.
   * The sensors selected here are crucial to the machine learning model that will be trained on the data from
   * these sensors.
   */
  targetExpectedSensors?: Array_Type<ExpectedSensor> | Array<IExpectedSensor>;

  /**
   * A list of {@link ExpectedSensor}s to exclude from data preparation, specifically for correlation jobs
   * where data preparation happens automatically with model configuration.
   * This is useful when certain sensors (e.g., mode) should not be considered for correlation analysis or
   * should be excluded from the automatic data processing pipeline.
   */
  excludedExpectedSensorsFromDataPrep?: Array_Type<ExpectedSensor> | Array<IExpectedSensor>;
}
 ...
 * learning models aimed at predicting or analyzing control valve behaviors and performance.
 *
 * @remarks this represents a made instance of ReliabilityMlControlValvesConfig
 */
declare class ReliabilityMlControlValvesConfig extends Obj  {

  readonly configOverride?: string;
  withConfigOverride(configOverride: string | null): ReliabilityMlControlValvesConfig;

  static readonly configOverride?: string;

  readonly secretOverride?: string;
  withSecretOverride(secretOverride: string | null): ReliabilityMlControlValvesConfig;
  ...
  withIssues(issues: Array_Type<string> | Array<string> | null): ReliabilityMlControlValvesConfig;
   ...
   * This sensor measures how much the valve is open, typically represented as a percentage.
   */
  readonly percentOpenExpectedSensor?: string;
  withPercentOpenExpectedSensor(percentOpenExpectedSensor: string | null): ReliabilityMlControlValvesConfig;

  /**
   * The {@link ExpectedSensor} corresponding to the percent open {@link Sensor} instrumented on a control valve.
   * This sensor measures how much the valve is open, typically represented as a percentage.
   */
  static readonly percentOpenExpectedSensor?: string;

  /**
   * The {@link ExpectedSensor} corresponding to the process variable {@link Sensor} instrumented on a control valve.
   * This sensor measures the process variable (e.g., pressure, temperature) that the valve is controlling.
   */
  readonly processVariableExpectedSensor?: string;
  withProcessVariableExpectedSensor(processVariableExpectedSensor: string | null): ReliabilityMlControlValvesConfig;

  /**
   * The {@link ExpectedSensor} corresponding to the process variable {@link Sensor} instrumented on a control valve.
   * This sensor measures the process variable (e.g., pressure, temperature) that the valve is controlling.
   */
  static readonly processVariableExpectedSensor?: string;

  /**
   * The {@link ExpectedSensor} corresponding to the setpoint {@link Sensor} instrumented on a control valve.
   * This sensor measures the setpoint value that the control system is trying to maintain for the process.
   */
  readonly setpointExpectedSensor?: string;
  withSetpointExpectedSensor(setpointExpectedSensor: string | null): ReliabilityMlControlValvesConfig;

  /**
   * The {@link ExpectedSensor} corresponding to the setpoint {@link Sensor} instrumented on a control valve.
   * This sensor measures the setpoint value that the control system is trying to maintain for the process.
   */
  static readonly setpointExpectedSensor?: string;

  /**
   * The {@link ExpectedSensor} corresponding to the mode {@link Sensor} instrumented on a control valve.
   * This sensor tracks the mode of the control valve (e.g., manual, automatic).
   */
  readonly modeExpectedSensor?: string;
  withModeExpectedSensor(modeExpectedSensor: string | null): ReliabilityMlControlValvesConfig;

  /**
   * The {@link ExpectedSensor} corresponding to the mode {@link Sensor} instrumented on a control valve.
   * This sensor tracks the mode of the control valve (e.g., manual, automatic).
   */
  static readonly modeExpectedSensor?: string;
   ...
   * these sensors.
   */
  readonly targetExpectedSensors?: Array_Type<ExpectedSensor>;
  withTargetExpectedSensors(targetExpectedSensors: Array_Type<ExpectedSensor> | Array<IExpectedSensor> | null): ReliabilityMlControlValvesConfig;
   ...
   * these sensors.
   */
  static readonly targetExpectedSensors?: Array_Type<ExpectedSensor>;
   ...
   * should be excluded from the automatic data processing pipeline.
   */
  readonly excludedExpectedSensorsFromDataPrep?: Array_Type<ExpectedSensor>;
  withExcludedExpectedSensorsFromDataPrep(excludedExpectedSensorsFromDataPrep: Array_Type<ExpectedSensor> | Array<IExpectedSensor> | null): ReliabilityMlControlValvesConfig;
   ...
   * @see #toJson
   */
  static fromJson(json: any): ReliabilityMlControlValvesConfig | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): ReliabilityMlControlValvesConfig | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): ReliabilityMlControlValvesConfig | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): ReliabilityMlControlValvesConfig | null;
   ...
   */
  replaceType(old: Type, new_: Type): ReliabilityMlControlValvesConfig;
   ...
   * This method is used during live metadata update
   */
  static replaceType(old: Type, new_: Type): ReliabilityMlControlValvesConfig;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityMlControlValvesConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityMlControlValvesConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityMlControlValvesConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityMlControlValvesConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityMlControlValvesConfig>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityMlControlValvesConfig>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityMlControlValvesConfig>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityMlControlValvesConfig>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityMlControlValvesConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityMlControlValvesConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityMlControlValvesConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityMlControlValvesConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityMlControlValvesConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityMlControlValvesConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ReliabilityMlControlValvesConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  static validateObj(): ReliabilityMlControlValvesConfig;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ReliabilityMlControlValvesConfig;
   ...
   * @see #defaultField
   */
  static withField(field: string, value: any, doNotConvert?: boolean): ReliabilityMlControlValvesConfig;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityMlControlValvesConfig;
   ...
   * @see #defaultField
   */
  static withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityMlControlValvesConfig;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityMlControlValvesConfig;
   ...
   * @return new Obj
   */
  static withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityMlControlValvesConfig;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityMlControlValvesConfig;
   ...
   * @return new Obj
   */
  static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityMlControlValvesConfig;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ReliabilityMlControlValvesConfig;
   ...
   * @see #withoutField
   */
  static withoutFieldAtPath(path: string): ReliabilityMlControlValvesConfig;
   ...
   * @see #removeField
   */
  withoutField(field: string): ReliabilityMlControlValvesConfig;
   ...
   * @see #removeField
   */
  static withoutField(field: string): ReliabilityMlControlValvesConfig;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): ReliabilityMlControlValvesConfig;
   ...
   * @see #removeField
   */
  static withoutField(field: FieldType): ReliabilityMlControlValvesConfig;
   ...
   */
  withoutFields(fields: Array_Type<string>): ReliabilityMlControlValvesConfig;
   ...
   * @return new Obj with removed fields
   */
  static withoutFields(fields: Array_Type<string>): ReliabilityMlControlValvesConfig;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityMlControlValvesConfig;
   ...
   * @return new Obj with removed fields
   */
  static withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityMlControlValvesConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ReliabilityMlControlValvesConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  static withoutSecretFields(): ReliabilityMlControlValvesConfig;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityMlControlValvesConfig;
   ...
   * @see FieldType#defaultValue
   */
  static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityMlControlValvesConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ReliabilityMlControlValvesConfig;
   ...
   * @see #unsetField
   */
  static defaultField(field: string): ReliabilityMlControlValvesConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ReliabilityMlControlValvesConfig;
   ...
   * @see #unsetField
   */
  static defaultField(field: FieldType): ReliabilityMlControlValvesConfig;
   ...
   * @see #removeField
   */
  unsetField(field: string): ReliabilityMlControlValvesConfig;
   ...
   * @see #removeField
   */
  static unsetField(field: string): ReliabilityMlControlValvesConfig;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ReliabilityMlControlValvesConfig;
   ...
   * @see #removeField
   */
  static unsetField(field: FieldType): ReliabilityMlControlValvesConfig;
   ...
   * @see #unsetField
   */
  removeField(field: string): ReliabilityMlControlValvesConfig;
   ...
   * @see #unsetField
   */
  static removeField(field: string): ReliabilityMlControlValvesConfig;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ReliabilityMlControlValvesConfig;
   ...
   * @see #unsetField
   */
  static removeField(field: FieldType): ReliabilityMlControlValvesConfig;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityMlControlValvesConfig;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityMlControlValvesConfig;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityMlControlValvesConfig;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityMlControlValvesConfig;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityMlControlValvesConfig;
   ...
   *        the same key or index.
   */
  static mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityMlControlValvesConfig;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityMlControlValvesConfig;
   ...
   * traverse child reference and collection fields.
   */
  static mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityMlControlValvesConfig;

  mergeJson(json: any): ReliabilityMlControlValvesConfig;

  static mergeJson(json: any): ReliabilityMlControlValvesConfig;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityMlControlValvesConfig;
   ...
   * @return Obj with child references merged
   */
  static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityMlControlValvesConfig;
   ...
   */
  sumObj(other: Obj, deep?: boolean): ReliabilityMlControlValvesConfig;
   ...
   * references with same name and collection elements at same index or key.
   */
  static sumObj(other: Obj, deep?: boolean): ReliabilityMlControlValvesConfig;
   ...
   */
  singletonArray(): Array_Type<ReliabilityMlControlValvesConfig>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonArray(): Array_Type<ReliabilityMlControlValvesConfig>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityMlControlValvesConfig> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ReliabilityMlControlValvesConfig> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<ReliabilityMlControlValvesConfig>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonSet(): Set_Type<ReliabilityMlControlValvesConfig>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ReliabilityMlControlValvesConfig> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, ReliabilityMlControlValvesConfig> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityMlControlValvesConfig> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ReliabilityMlControlValvesConfig>;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  static toBuilder(): ObjBuilder<ReliabilityMlControlValvesConfig>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ReliabilityMlControlValvesConfig>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityMlControlValvesConfig;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityMlControlValvesConfig;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityMlControlValvesConfig;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ReliabilityMlControlValvesConfig;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityMlControlValvesConfig;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ReliabilityMlControlValvesConfig;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityMlControlValvesConfig;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): ReliabilityMlControlValvesConfig;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  static afterMake(): ReliabilityMlControlValvesConfig;
   ...
   */
  static cachedEmptyInst(): ReliabilityMlControlValvesConfig;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityMlControlValvesConfig> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): ReliabilityMlControlValvesConfig;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<ReliabilityMlControlValvesConfig> | null;
   ...
   */
  static find(filter?: string, doNotProduceAll?: boolean): Stream<ReliabilityMlControlValvesConfig> | null;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<ReliabilityMlControlValvesConfig> | null;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): ReliabilityMlControlValvesConfig | null;

  /**
   * Returns cached instance by key, with secrets removed.
   */
  static forCacheKey(key: string): ReliabilityMlControlValvesConfig | null;
   ...
   * @see findByCacheKey
   */
  getCached(): ReliabilityMlControlValvesConfig | null;
   ...
   * @see findByCacheKey
   */
  static getCached(): ReliabilityMlControlValvesConfig | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): ReliabilityMlControlValvesConfig | null;

  /**
   * @return newly produced cached instance.
   */
  static refreshCache(): ReliabilityMlControlValvesConfig | null;
   ...
   */
  static produce(key: string): ReliabilityMlControlValvesConfig | null;
   ...
   */
  static produceAll(): Map_Type<string, ReliabilityMlControlValvesConfig> | null;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): Map_Type<string, ReliabilityMlControlValvesConfig> | null;
   ...
   */
  getConfig(): ReliabilityMlControlValvesConfig;
   ...
   * Note that typical pattern is to use Configurable#config instead of this method.
   */
  static getConfig(): ReliabilityMlControlValvesConfig;
   ...
   */
  getSecret(): ReliabilityMlControlValvesConfig;
   ...
   * Note that typical pattern is to use Configurable#configWithSecrets instead of this method.
   */
  static getSecret(): ReliabilityMlControlValvesConfig;
   ...
   */
  withConfigKey(configKey: string): ReliabilityMlControlValvesConfig;
   ...
   *     config.configKey() => "folder1/abc"
   */
  static withConfigKey(configKey: string): ReliabilityMlControlValvesConfig;

  /**
   * @return copy without config key.
   */
  withoutConfigKey(): ReliabilityMlControlValvesConfig;

  /**
   * @return copy without config key.
   */
  static withoutConfigKey(): ReliabilityMlControlValvesConfig;

  /**
   * @return return cached config instance for provided config key.
   */
  static forConfigKey(configKey: string): ReliabilityMlControlValvesConfig | null;
   ...
   */
  static listConfigs(parallel?: boolean, filter?: λPredicate<string>): Stream<ReliabilityMlControlValvesConfig> | null;
   ...
   * @see setConfigValue
   */
  setConfigValues(from: ReliabilityMlControlValvesConfig, override?: string): void;

  /**
   * Sets multiple field values to be the same as the passed instance.
   * @see setConfigValue
   */
  static setConfigValues(from: ReliabilityMlControlValvesConfig, override?: string): void;
   ...
   * @see setSecretValue
   */
  setSecretValues(from: ReliabilityMlControlValvesConfig, override?: string): void;

  /**
   * Sets multiple secret field values to be the same as the passed instance.
   * @see setSecretValue
   */
  static setSecretValues(from: ReliabilityMlControlValvesConfig, override?: string): void;
   ...
   */
  static loadConfigAndSecret(configKey: string): ReliabilityMlControlValvesConfig | null;
   ...
   */
  removeSecrets(): ReliabilityMlControlValvesConfig | null;

  /**
   * @return this config without any secret values.
   */
  static removeSecrets(): ReliabilityMlControlValvesConfig | null;

  /**
   * @return this config with only secret values.
   */
  removeNonSecrets(): ReliabilityMlControlValvesConfig | null;

  /**
   * @return this config with only secret values.
   */
  static removeNonSecrets(): ReliabilityMlControlValvesConfig | null;

  /**
   * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
   * validation and setup.
   */
  validate(): ReliabilityMlControlValvesConfig;

  /**
   * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
   * validation and setup.
   */
  static validate(): ReliabilityMlControlValvesConfig;
