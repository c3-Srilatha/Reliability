// TypeScript definitions for the C3 type ControlValvesModelable
 ...
 * the risk score.
 *
 * @remarks this represents a value passed to a method that expects an instance of ControlValvesModelable
 */
declare interface IControlValvesModelable {
   ...
   */
  flowThroughValveThreshold?: number;
 ...
 * the risk score.
 *
 * @remarks this represents a made instance of ControlValvesModelable
 */
declare class ControlValvesModelable extends Obj  {
  ...
  withTypeIdent(typeIdent: string | null): ControlValvesModelable;
   ...
   */
  readonly id: string;
  withId(id: string): ControlValvesModelable;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ControlValvesModelable;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): ControlValvesModelable;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): ControlValvesModelable;
  ...
  withVersion(version: number | null): ControlValvesModelable;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): ControlValvesModelable;

  /**
   * The {@link Feature} that represents the PERCENT_OPEN sensor instrumented on the Control Valve.
   */
  readonly percentOpen: string;
  withPercentOpen(percentOpen: string): ControlValvesModelable;
  ...
  withExcludeFeatures(excludeFeatures: Array_Type<string> | Array<string> | null): ControlValvesModelable;

  /**
   * The {@link Feature} that represents the PROCESS_VARIABLE sensor instrumented on the Control Valve.
   */
  readonly processVariable: string;
  withProcessVariable(processVariable: string): ControlValvesModelable;

  /**
   * The {@link Feature} that represents the SETPOINT sensor instrumented on the Control Valve.
   */
  readonly setpoint: string;
  withSetpoint(setpoint: string): ControlValvesModelable;

  /**
   * The {@link Feature} that represents the MODE sensor instrumented on the Control Valve.
   */
  readonly mode: string;
  withMode(mode: string): ControlValvesModelable;

  /**
   * The {@link Feature} that represents the ON_OFF sensor instrumented on the Control Valve.
   */
  readonly onOff: string;
  withOnOff(onOff: string): ControlValvesModelable;

  /**
   * The {@link Feature} that represents the FLOW_THROUGH_VALVE sensor instrumented on the Control Valve.
   */
  readonly flowThroughValve?: string;
  withFlowThroughValve(flowThroughValve: string | null): ControlValvesModelable;
   ...
   * will be set to {@link highRiskScoreValue} indicating leakage, else it will be set to {@link lowRiskScoreValue}.
   */
  readonly flowThroughValveThreshold?: number;
  withFlowThroughValveThreshold(flowThroughValveThreshold: number | null): ControlValvesModelable;
   ...
   * If not specified, the risk score will be set to the maximum absolute residual value in the training data.
   */
  readonly highRiskScoreValue?: number;
  withHighRiskScoreValue(highRiskScoreValue: number | null): ControlValvesModelable;
   ...
   * If not specified, the risk score will be set to 0.
   */
  readonly lowRiskScoreValue?: number;
  withLowRiskScoreValue(lowRiskScoreValue: number | null): ControlValvesModelable;
  ...
  withTolerance(tolerance: number | null): ControlValvesModelable;
   ...
   * @see #toJson
   */
  static fromJson(json: any): ControlValvesModelable | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): ControlValvesModelable | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): ControlValvesModelable | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): ControlValvesModelable | null;
   ...
   */
  replaceType(old: Type, new_: Type): ControlValvesModelable;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ControlValvesModelable;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ControlValvesModelable;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ControlValvesModelable>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ControlValvesModelable>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ControlValvesModelable;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ControlValvesModelable;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ControlValvesModelable;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ControlValvesModelable;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ControlValvesModelable;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ControlValvesModelable;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ControlValvesModelable;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ControlValvesModelable;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ControlValvesModelable;
   ...
   * @see #removeField
   */
  withoutField(field: string): ControlValvesModelable;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): ControlValvesModelable;
   ...
   */
  withoutFields(fields: Array_Type<string>): ControlValvesModelable;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): ControlValvesModelable;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ControlValvesModelable;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ControlValvesModelable;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ControlValvesModelable;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ControlValvesModelable;
   ...
   * @see #removeField
   */
  unsetField(field: string): ControlValvesModelable;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ControlValvesModelable;
   ...
   * @see #unsetField
   */
  removeField(field: string): ControlValvesModelable;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ControlValvesModelable;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ControlValvesModelable;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): ControlValvesModelable;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ControlValvesModelable;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ControlValvesModelable;

  mergeJson(json: any): ControlValvesModelable;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ControlValvesModelable;
   ...
   */
  sumObj(other: Obj, deep?: boolean): ControlValvesModelable;
   ...
   */
  singletonArray(): Array_Type<ControlValvesModelable>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<ControlValvesModelable> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ControlValvesModelable> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<ControlValvesModelable>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ControlValvesModelable> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, ControlValvesModelable> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ControlValvesModelable> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ControlValvesModelable>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ControlValvesModelable>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ControlValvesModelable;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ControlValvesModelable;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ControlValvesModelable;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ControlValvesModelable;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ControlValvesModelable;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ControlValvesModelable;
   ...
   * @see #fromString
   */
  static make(s: string): ControlValvesModelable | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ControlValvesModelable;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): ControlValvesModelable;
   ...
   */
  static cachedEmptyInst(): ControlValvesModelable;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<ControlValvesModelable> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): ControlValvesModelable;
   ...
   * {@link ReliabilityRiskMl.ControlValvesReconstructionPipeline#reconstructionPipe}, and is a wrapper around
   * the {@link MlAtomicPipe#doTrain} API for the {@link ReliabilityRiskMl.Reconstruction.ControlValvesPipe}.
   *
   * @param pipe
   *        The {@link ReliabilityRiskMl.Reconstruction.ControlValvesPipe} that calls this method.
   ...
   * {@link ReliabilityRiskMl.ControlValvesReconstructionPipeline#reconstructionPipe}, and is a wrapper around
   * the {@link MlAtomicPipe#doProcess} API for the {@link ReliabilityRiskMl.Reconstruction.ControlValvesPipe}.
   *
   * @param pipe
   *        The {@link ReliabilityRiskMl.Reconstruction.ControlValvesPipe} that calls this method.
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<ControlValvesModelable>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<ControlValvesModelable>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<ControlValvesModelable> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ControlValvesModelable>> | null;
   ...
   */
  get(include?: string): ControlValvesModelable | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): ControlValvesModelable | null;
   ...
   */
  getMissing(spec: GetMissingSpec): ControlValvesModelable;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): ControlValvesModelable | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): ControlValvesModelable;
   ...
   * @see #toString
   */
  static fromString(s: string): ControlValvesModelable | null;
   ...
   */
  create(spec?: UpsertSpec): ControlValvesModelable | null;
   ...
   */
  static createBatch(objs: Array_Type<ControlValvesModelable>, spec?: UpsertSpec): ObjList<ControlValvesModelable> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<ControlValvesModelable>, spec?: CreateBatchObjStreamSpec): ObjList<ControlValvesModelable> | null;
   ...
   */
  update(srcObj?: ControlValvesModelable, spec?: UpsertSpec): ControlValvesModelable | null;
   ...
   */
  upsert(srcObj?: ControlValvesModelable, spec?: UpsertSpec): ControlValvesModelable | null;
   ...
   */
  merge(spec?: MergeSpec): ControlValvesModelable | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): ControlValvesModelable | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): ControlValvesModelable | null;
   ...
   */
  static updateBatch(objs: Array_Type<ControlValvesModelable>, srcObjs?: Array_Type<ControlValvesModelable>, spec?: UpsertSpec): ObjList<ControlValvesModelable> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<ControlValvesModelable> | null>, spec?: UpsertSpec): ObjList<ControlValvesModelable> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<ControlValvesModelable>, srcObjs?: Array_Type<ControlValvesModelable>, spec?: UpsertSpec): ObjList<ControlValvesModelable> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<ControlValvesModelable> | null>, spec?: UpsertSpec): ObjList<ControlValvesModelable> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<ControlValvesModelable>, spec?: TouchSpec): ObjList<ControlValvesModelable> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ControlValvesModelable>, spec?: MergeSpec): ObjList<ControlValvesModelable> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ControlValvesModelable>, mergeInclude: string, spec?: MergeSpec): ObjList<ControlValvesModelable> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<ControlValvesModelable> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ControlValvesModelable> | null;
   ...
   */
  static mergeAll(mergeObj: ControlValvesModelable, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: ControlValvesModelable, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<ControlValvesModelable>, spec?: UpsertSpec): ObjList<ControlValvesModelable> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<ControlValvesModelable>, spec?: UpsertSpec): ObjList<ControlValvesModelable> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): ControlValvesModelable | null;
   ...
   */
  static beforeCreate(objs: Array_Type<ControlValvesModelable>): ObjList<ControlValvesModelable>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<ControlValvesModelable>): ObjList<ControlValvesModelable>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<ControlValvesModelable>): ObjList<ControlValvesModelable>;
   ...
   */
  static afterCreate(objs: Array_Type<ControlValvesModelable>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<ControlValvesModelable>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<ControlValvesModelable>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<ControlValvesModelable>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ControlValvesModelable>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): ControlValvesModelable | null;
   ...
   */
  withoutIdentity(): ControlValvesModelable | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<ControlValvesModelable>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: ControlValvesModelable, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<ControlValvesModelable>, callback?: λFunction<ControlValvesModelable | null, ControlValvesModelable | null>): ObjList<ControlValvesModelable>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<ControlValvesModelable>, callback?: λFunction<ControlValvesModelable | null, ControlValvesModelable | null>): Array_Type<ObjError> | null;
