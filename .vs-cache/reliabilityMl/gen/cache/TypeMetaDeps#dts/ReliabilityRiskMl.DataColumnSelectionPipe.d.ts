// TypeScript definitions for the C3 type ReliabilityRiskMl.DataColumnSelectionPipe

/**
 * This type represents an {@link MlPipe} template for a data operation that selects specific columns from a dataset.
 * It enables the extraction of the specified columns for use in subsequent steps in a machine learning pipeline.
 * The `DataColumnSelectionPipe` is used for selecting features (columns) from a dataset based on a list of column names.
 *
 * This can be useful in scenarios where only a subset of columns is required for further processing or modeling.
 * It is typically used as a preprocessing step in a machine learning pipeline to narrow down the dataset to relevant features.
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityRiskMl.DataColumnSelectionPipe
 */
declare namespace ReliabilityRiskMl {
  export interface IDataColumnSelectionPipe {
    ...
    /**
     * A list of column names to be selected from the dataset.
     * This field specifies the exact columns to be included in the output dataset.
     * The selected columns will be returned in the resulting dataset, and any other columns will be excluded.
     */
 ...
 * It is typically used as a preprocessing step in a machine learning pipeline to narrow down the dataset to relevant features.
 *
 * @remarks this represents a made instance of ReliabilityRiskMl.DataColumnSelectionPipe
 */
declare namespace ReliabilityRiskMl {
  export class DataColumnSelectionPipe extends Obj  {
     ...
     */
    readonly id: string;
    withId(id: string): ReliabilityRiskMl.DataColumnSelectionPipe;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityRiskMl.DataColumnSelectionPipe;

    /**
     * Name of this pipe.
     */
    readonly name?: string;
    withName(name: string | null): ReliabilityRiskMl.DataColumnSelectionPipe;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): ReliabilityRiskMl.DataColumnSelectionPipe;
    ...
    withVersion(version: number | null): ReliabilityRiskMl.DataColumnSelectionPipe;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): ReliabilityRiskMl.DataColumnSelectionPipe;
    ...
    withUserUpdatedFields(userUpdatedFields: Array_Type<string> | Array<string> | null): ReliabilityRiskMl.DataColumnSelectionPipe;
    ...
    withHidden(hidden: boolean): ReliabilityRiskMl.DataColumnSelectionPipe;
    ...
    withUserOwned(userOwned: boolean): ReliabilityRiskMl.DataColumnSelectionPipe;
    ...
    withTypeIdent(typeIdent: string | null): ReliabilityRiskMl.DataColumnSelectionPipe;

    /**
     * If true, then the pipe shall not be retrained
     */
    readonly frozen?: boolean;
    withFrozen(frozen: boolean): ReliabilityRiskMl.DataColumnSelectionPipe;

    /**
     * True if training has succeeded and false otherwise.
     */
    readonly trained?: boolean;
    withTrained(trained: boolean): ReliabilityRiskMl.DataColumnSelectionPipe;

    /**
     * Errors from training.
     */
    readonly trainingErrors?: string;
    withTrainingErrors(trainingErrors: string | null): ReliabilityRiskMl.DataColumnSelectionPipe;

    /**
     * If true, the underlying model only accepts flattened input.
     */
    readonly flattenInput?: boolean;
    withFlattenInput(flattenInput: boolean): ReliabilityRiskMl.DataColumnSelectionPipe;

    /**
     * The hyperparameters overridden of a native model or pipe.
     */
    readonly hyperparamOverrides?: Map_Type<string, any>;
    withHyperparamOverrides(hyperparamOverrides: Map_Type<string, any> | {[key: string]: any} | null): ReliabilityRiskMl.DataColumnSelectionPipe;
    ...
    withHyperparamSearchSpace(hyperparamSearchSpace: IHp.SearchSpace | null): ReliabilityRiskMl.DataColumnSelectionPipe;
    ...
    withHpoSpec(hpoSpec: IHpo.Spec | null): ReliabilityRiskMl.DataColumnSelectionPipe;

    /**
     * {@link Hpo.Experiment} stores the result of hyperparameter optimization to find the best model/pipeline.
     */
    readonly hpoExperiment?: Hpo.Experiment;
    withHpoExperiment(hpoExperiment: IHpo.Experiment | null): ReliabilityRiskMl.DataColumnSelectionPipe;

    /**
     * Reference to the experiment that produced this {@link MlPipe}. For example, this could be a {@link Hpo.ExperimentBase}.
     */
    readonly experiment?: any;
    withExperiment(experiment: any | null): ReliabilityRiskMl.DataColumnSelectionPipe;
    ...
    withModelFiles(modelFiles: Map_Type<string, Url> | {[key: string]: IUrl} | null): ReliabilityRiskMl.DataColumnSelectionPipe;
    ...
    withCustomModelCode(customModelCode: Map_Type<string, any> | {[key: string]: any} | null): ReliabilityRiskMl.DataColumnSelectionPipe;

    /**
     * Name for the function on the native model to call to do {@link MlProcessable#process}.
     */
    readonly processFunc?: string;
    withProcessFunc(processFunc: string | null): ReliabilityRiskMl.DataColumnSelectionPipe;
    ...
    withUnderlyingPipe(underlyingPipe: IMlAtomicPipe<any, any, any> | null): ReliabilityRiskMl.DataColumnSelectionPipe;
    ...
    withColumns(columns: Array_Type<string> | Array<string>): ReliabilityRiskMl.DataColumnSelectionPipe;
     ...
     * @see #toJson
     */
    static fromJson(json: any): ReliabilityRiskMl.DataColumnSelectionPipe | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): ReliabilityRiskMl.DataColumnSelectionPipe | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): ReliabilityRiskMl.DataColumnSelectionPipe | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): ReliabilityRiskMl.DataColumnSelectionPipe | null;
     ...
     */
    replaceType(old: Type, new_: Type): ReliabilityRiskMl.DataColumnSelectionPipe;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityRiskMl.DataColumnSelectionPipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityRiskMl.DataColumnSelectionPipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityRiskMl.DataColumnSelectionPipe>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityRiskMl.DataColumnSelectionPipe>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityRiskMl.DataColumnSelectionPipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityRiskMl.DataColumnSelectionPipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityRiskMl.DataColumnSelectionPipe;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): ReliabilityRiskMl.DataColumnSelectionPipe;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): ReliabilityRiskMl.DataColumnSelectionPipe;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityRiskMl.DataColumnSelectionPipe;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityRiskMl.DataColumnSelectionPipe;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityRiskMl.DataColumnSelectionPipe;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): ReliabilityRiskMl.DataColumnSelectionPipe;
     ...
     * @see #removeField
     */
    withoutField(field: string): ReliabilityRiskMl.DataColumnSelectionPipe;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): ReliabilityRiskMl.DataColumnSelectionPipe;
     ...
     */
    withoutFields(fields: Array_Type<string>): ReliabilityRiskMl.DataColumnSelectionPipe;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityRiskMl.DataColumnSelectionPipe;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): ReliabilityRiskMl.DataColumnSelectionPipe;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityRiskMl.DataColumnSelectionPipe;
     ...
     * @see #unsetField
     */
    defaultField(field: string): ReliabilityRiskMl.DataColumnSelectionPipe;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): ReliabilityRiskMl.DataColumnSelectionPipe;
     ...
     * @see #removeField
     */
    unsetField(field: string): ReliabilityRiskMl.DataColumnSelectionPipe;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): ReliabilityRiskMl.DataColumnSelectionPipe;
     ...
     * @see #unsetField
     */
    removeField(field: string): ReliabilityRiskMl.DataColumnSelectionPipe;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): ReliabilityRiskMl.DataColumnSelectionPipe;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityRiskMl.DataColumnSelectionPipe;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityRiskMl.DataColumnSelectionPipe;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityRiskMl.DataColumnSelectionPipe;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityRiskMl.DataColumnSelectionPipe;

    mergeJson(json: any): ReliabilityRiskMl.DataColumnSelectionPipe;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityRiskMl.DataColumnSelectionPipe;
     ...
     */
    sumObj(other: Obj, deep?: boolean): ReliabilityRiskMl.DataColumnSelectionPipe;
     ...
     */
    singletonArray(): Array_Type<ReliabilityRiskMl.DataColumnSelectionPipe>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityRiskMl.DataColumnSelectionPipe> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<ReliabilityRiskMl.DataColumnSelectionPipe> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<ReliabilityRiskMl.DataColumnSelectionPipe>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<ReliabilityRiskMl.DataColumnSelectionPipe> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, ReliabilityRiskMl.DataColumnSelectionPipe> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityRiskMl.DataColumnSelectionPipe> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<ReliabilityRiskMl.DataColumnSelectionPipe>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<ReliabilityRiskMl.DataColumnSelectionPipe>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityRiskMl.DataColumnSelectionPipe;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityRiskMl.DataColumnSelectionPipe;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityRiskMl.DataColumnSelectionPipe;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): ReliabilityRiskMl.DataColumnSelectionPipe;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityRiskMl.DataColumnSelectionPipe;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): ReliabilityRiskMl.DataColumnSelectionPipe;
     ...
     * @see #fromString
     */
    static make(s: string): ReliabilityRiskMl.DataColumnSelectionPipe | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityRiskMl.DataColumnSelectionPipe;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): ReliabilityRiskMl.DataColumnSelectionPipe;
     ...
     */
    static cachedEmptyInst(): ReliabilityRiskMl.DataColumnSelectionPipe;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityRiskMl.DataColumnSelectionPipe> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): ReliabilityRiskMl.DataColumnSelectionPipe;
     ...
     */
    remakeTemplate(): ReliabilityRiskMl.DataColumnSelectionPipe;
     ...
     */
    withoutIdentity(): ReliabilityRiskMl.DataColumnSelectionPipe;
     ...
     */
    trainSync(x: Data, y?: , spec?: MlOperationSpec): ReliabilityRiskMl.DataColumnSelectionPipe;

    /**
     * A flag that indicates whether the column selection operation is trainable.
     * This is useful for operations that require training or learning from data, such as feature selection techniques.
     *
     * default false
     *
     * For example: true - The column selection process can be trained.
     * For example: false - The column selection is a fixed operation.
     */
    isTrainable(): boolean;
     ...
     */
    static allCached(doNotProduceAll?: boolean): Stream<ReliabilityRiskMl.DataColumnSelectionPipe> | null;
     ...
     */
    static find(filter?: string, doNotProduceAll?: boolean): Stream<ReliabilityRiskMl.DataColumnSelectionPipe> | null;
     ...
     * @return existing instances of this type that satisfy filter from data cache.
     */
    static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<ReliabilityRiskMl.DataColumnSelectionPipe> | null;
     ...
     * @see getCached
     */
    static findByCacheKey(key: string): ReliabilityRiskMl.DataColumnSelectionPipe | null;
     ...
     * @see findByCacheKey
     */
    static forCacheKey(key: string): ReliabilityRiskMl.DataColumnSelectionPipe | null;
     ...
     * @see findByCacheKey
     */
    getCached(): ReliabilityRiskMl.DataColumnSelectionPipe | null;

    /**
     * @return newly produced cached instance.
     */
    refreshCache(): ReliabilityRiskMl.DataColumnSelectionPipe | null;
     ...
     */
    static produce(key: string): ReliabilityRiskMl.DataColumnSelectionPipe | null;
     ...
     */
    static produceAll(): Map_Type<string, ReliabilityRiskMl.DataColumnSelectionPipe> | null;

    /**
     * Override for sub-types to produce all values.
     */
    static doProduceAll(): Map_Type<string, ReliabilityRiskMl.DataColumnSelectionPipe> | null;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<ReliabilityRiskMl.DataColumnSelectionPipe>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<ReliabilityRiskMl.DataColumnSelectionPipe>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityRiskMl.DataColumnSelectionPipe> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityRiskMl.DataColumnSelectionPipe>> | null;
     ...
     */
    get(include?: string): ReliabilityRiskMl.DataColumnSelectionPipe | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): ReliabilityRiskMl.DataColumnSelectionPipe | null;
     ...
     */
    getMissing(spec: GetMissingSpec): ReliabilityRiskMl.DataColumnSelectionPipe;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): ReliabilityRiskMl.DataColumnSelectionPipe | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): ReliabilityRiskMl.DataColumnSelectionPipe;
     ...
     * @see #toString
     */
    static fromString(s: string): ReliabilityRiskMl.DataColumnSelectionPipe | null;
     ...
     */
    create(spec?: UpsertSpec): ReliabilityRiskMl.DataColumnSelectionPipe | null;
     ...
     */
    static createBatch(objs: Array_Type<ReliabilityRiskMl.DataColumnSelectionPipe>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.DataColumnSelectionPipe> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<ReliabilityRiskMl.DataColumnSelectionPipe>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityRiskMl.DataColumnSelectionPipe> | null;
     ...
     */
    update(srcObj?: ReliabilityRiskMl.DataColumnSelectionPipe, spec?: UpsertSpec): ReliabilityRiskMl.DataColumnSelectionPipe | null;
     ...
     */
    upsert(srcObj?: ReliabilityRiskMl.DataColumnSelectionPipe, spec?: UpsertSpec): ReliabilityRiskMl.DataColumnSelectionPipe | null;
     ...
     */
    merge(spec?: MergeSpec): ReliabilityRiskMl.DataColumnSelectionPipe | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): ReliabilityRiskMl.DataColumnSelectionPipe | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): ReliabilityRiskMl.DataColumnSelectionPipe | null;
     ...
     */
    static updateBatch(objs: Array_Type<ReliabilityRiskMl.DataColumnSelectionPipe>, srcObjs?: Array_Type<ReliabilityRiskMl.DataColumnSelectionPipe>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.DataColumnSelectionPipe> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<ReliabilityRiskMl.DataColumnSelectionPipe> | null>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.DataColumnSelectionPipe> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<ReliabilityRiskMl.DataColumnSelectionPipe>, srcObjs?: Array_Type<ReliabilityRiskMl.DataColumnSelectionPipe>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.DataColumnSelectionPipe> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<ReliabilityRiskMl.DataColumnSelectionPipe> | null>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.DataColumnSelectionPipe> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<ReliabilityRiskMl.DataColumnSelectionPipe>, spec?: TouchSpec): ObjList<ReliabilityRiskMl.DataColumnSelectionPipe> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityRiskMl.DataColumnSelectionPipe>, spec?: MergeSpec): ObjList<ReliabilityRiskMl.DataColumnSelectionPipe> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityRiskMl.DataColumnSelectionPipe>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityRiskMl.DataColumnSelectionPipe> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<ReliabilityRiskMl.DataColumnSelectionPipe> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityRiskMl.DataColumnSelectionPipe> | null;
     ...
     */
    static mergeAll(mergeObj: ReliabilityRiskMl.DataColumnSelectionPipe, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: ReliabilityRiskMl.DataColumnSelectionPipe, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<ReliabilityRiskMl.DataColumnSelectionPipe>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.DataColumnSelectionPipe> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<ReliabilityRiskMl.DataColumnSelectionPipe>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.DataColumnSelectionPipe> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): ReliabilityRiskMl.DataColumnSelectionPipe | null;
     ...
     */
    static beforeCreate(objs: Array_Type<ReliabilityRiskMl.DataColumnSelectionPipe>): ObjList<ReliabilityRiskMl.DataColumnSelectionPipe>;
     ...
     */
    static beforeUpdate(objs: Array_Type<ReliabilityRiskMl.DataColumnSelectionPipe>): ObjList<ReliabilityRiskMl.DataColumnSelectionPipe>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<ReliabilityRiskMl.DataColumnSelectionPipe>): ObjList<ReliabilityRiskMl.DataColumnSelectionPipe>;
     ...
     */
    static afterCreate(objs: Array_Type<ReliabilityRiskMl.DataColumnSelectionPipe>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<ReliabilityRiskMl.DataColumnSelectionPipe>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<ReliabilityRiskMl.DataColumnSelectionPipe>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityRiskMl.DataColumnSelectionPipe>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityRiskMl.DataColumnSelectionPipe>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): ReliabilityRiskMl.DataColumnSelectionPipe | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<ReliabilityRiskMl.DataColumnSelectionPipe>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: ReliabilityRiskMl.DataColumnSelectionPipe, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<ReliabilityRiskMl.DataColumnSelectionPipe>, callback?: λFunction<ReliabilityRiskMl.DataColumnSelectionPipe | null, ReliabilityRiskMl.DataColumnSelectionPipe | null>): ObjList<ReliabilityRiskMl.DataColumnSelectionPipe>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<ReliabilityRiskMl.DataColumnSelectionPipe>, callback?: λFunction<ReliabilityRiskMl.DataColumnSelectionPipe | null, ReliabilityRiskMl.DataColumnSelectionPipe | null>): Array_Type<ObjError> | null;
     ...
     */
    publish(subPath?: string, contentType?: string): ReliabilityRiskMl.DataColumnSelectionPipe;
     ...
     */
    static removeSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.DataColumnSelectionPipe> | null;
     ...
     */
    createSeedData(spec?: UpsertSpec): ReliabilityRiskMl.DataColumnSelectionPipe | null;
     ...
     */
    static createSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.DataColumnSelectionPipe> | null;
     ...
     */
    updateSeedData(srcObj?: SeedData, spec?: UpsertSpec): ReliabilityRiskMl.DataColumnSelectionPipe | null;
     ...
     */
    static updateSeedDataBatch(objs?: Array_Type<SeedData>, srcObjs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.DataColumnSelectionPipe> | null;
     ...
     * @return updated obj instance, same as {@link Persistable#update} return value.
     */
    clearUserUpdates(spec?: MergeSpec): ReliabilityRiskMl.DataColumnSelectionPipe | null;
     ...
     *         {@link Persistable#updateBatch}.
     */
    static clearUserUpdatesBatch(objs?: Array_Type<SeedData>, spec?: MergeSpec): ObjList<ReliabilityRiskMl.DataColumnSelectionPipe> | null;
    ...
    dependencies(): SeedDataDeps<ReliabilityRiskMl.DataColumnSelectionPipe> | null;
     ...
     */
    static convert(model: any, spec?: MlConvertSpec): ReliabilityRiskMl.DataColumnSelectionPipe;

    /**
     * Freezes an {@link MlPipe}
     * @return modified copy of this {@link MlPipe} that cannot be trained
     */
    freeze(): ReliabilityRiskMl.DataColumnSelectionPipe;

    /**
     * Unfreezes an {@link MlPipe}
     * @return modified copy of this {@link MlPipe} that can be trained
     */
    unfreeze(): ReliabilityRiskMl.DataColumnSelectionPipe;
     ...
     * be returned as-is.
     */
    byReference(): ReliabilityRiskMl.DataColumnSelectionPipe;
     ...
     */
    updateModelFiles(modelFiles: Map_Type<string, Url>, spec?: MlOperationSpec): ReliabilityRiskMl.DataColumnSelectionPipe;
     ...
     */
    afterTrain(doTrainOutputs: any, spec?: MlOperationSpec): ReliabilityRiskMl.DataColumnSelectionPipe;
    ...
    /**
     * This function processes the input dataset by selecting the specified columns from the {@link columns} field.
     * It applies the column selection operation and returns the resulting dataset containing only the selected columns.
     * The `doProcess` method should be invoked when executing the pipeline, selecting the relevant columns for further processing.
     */
     ...
     */
    withNewSpec(spec?: MlConvertSpec): ReliabilityRiskMl.DataColumnSelectionPipe;
     ...
     */
    afterConvert(model: any, spec?: MlConvertSpec): ReliabilityRiskMl.DataColumnSelectionPipe;
     ...
     */
    withHyperparamSpaces(paramSpaces: Map_Type<string, Hp.ParamSpace>): ReliabilityRiskMl.DataColumnSelectionPipe;
    ...
    /**
     * This method generates the underlying pipeline for performing the column selection operation.
     * It sets up the necessary steps for extracting the selected columns from the input dataset.
     * The `generatePipe` function should be called when setting up the pipeline to ensure the correct steps are initialized.
     */
