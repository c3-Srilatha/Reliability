// TypeScript definitions for the C3 type ReliabilityRiskMl.ReconstructionPipeline
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityRiskMl.ReconstructionPipeline
 */
declare namespace ReliabilityRiskMl {
  export interface IReconstructionPipeline<DX, DY, DO> {
 ...
 */
declare namespace ReliabilityRiskMl {
  export class ReconstructionPipeline<DX, DY, DO> extends Obj  {

    /**
     * List of all vertices in this graph.
     */
    readonly vertices?: Array_Type<MlPipeline.Vertex>;
    withVertices(vertices: Array_Type<MlPipeline.Vertex> | Array<IMlPipeline.Vertex> | null): ReliabilityRiskMl.ReconstructionPipeline;

    /**
     * List of all edges in this graph.
     */
    readonly edges?: Array_Type<FlowGraph.Edge<MlPipeline.Vertex>>;
    withEdges(edges: Array_Type<FlowGraph.Edge<MlPipeline.Vertex>> | Array<IFlowGraph.Edge<MlPipeline.Vertex>> | null): ReliabilityRiskMl.ReconstructionPipeline;
    ...
    withVertexConnections(vertexConnections: Map_Type<string, Map_Type<string, any>> | {[key: string]: Map_Type<string, any> | {[key: string]: any}} | null): ReliabilityRiskMl.ReconstructionPipeline;
     ...
     */
    readonly id: string;
    withId(id: string): ReliabilityRiskMl.ReconstructionPipeline;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityRiskMl.ReconstructionPipeline;

    /**
     * Name of this pipe.
     */
    readonly name?: string;
    withName(name: string | null): ReliabilityRiskMl.ReconstructionPipeline;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): ReliabilityRiskMl.ReconstructionPipeline;
    ...
    withVersion(version: number | null): ReliabilityRiskMl.ReconstructionPipeline;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): ReliabilityRiskMl.ReconstructionPipeline;
    ...
    withUserUpdatedFields(userUpdatedFields: Array_Type<string> | Array<string> | null): ReliabilityRiskMl.ReconstructionPipeline;
    ...
    withHidden(hidden: boolean): ReliabilityRiskMl.ReconstructionPipeline;
    ...
    withUserOwned(userOwned: boolean): ReliabilityRiskMl.ReconstructionPipeline;
    ...
    withTypeIdent(typeIdent: string | null): ReliabilityRiskMl.ReconstructionPipeline;

    /**
     * If true, then the pipe shall not be retrained
     */
    readonly frozen?: boolean;
    withFrozen(frozen: boolean): ReliabilityRiskMl.ReconstructionPipeline;

    /**
     * True if training has succeeded and false otherwise.
     */
    readonly trained?: boolean;
    withTrained(trained: boolean): ReliabilityRiskMl.ReconstructionPipeline;

    /**
     * Errors from training.
     */
    readonly trainingErrors?: string;
    withTrainingErrors(trainingErrors: string | null): ReliabilityRiskMl.ReconstructionPipeline;

    /**
     * If true, the underlying model only accepts flattened input.
     */
    readonly flattenInput?: boolean;
    withFlattenInput(flattenInput: boolean): ReliabilityRiskMl.ReconstructionPipeline;

    /**
     * The hyperparameters overridden of a native model or pipe.
     */
    readonly hyperparamOverrides?: Map_Type<string, any>;
    withHyperparamOverrides(hyperparamOverrides: Map_Type<string, any> | {[key: string]: any} | null): ReliabilityRiskMl.ReconstructionPipeline;
    ...
    withHyperparamSearchSpace(hyperparamSearchSpace: IHp.SearchSpace | null): ReliabilityRiskMl.ReconstructionPipeline;
    ...
    withHpoSpec(hpoSpec: IHpo.Spec | null): ReliabilityRiskMl.ReconstructionPipeline;

    /**
     * {@link Hpo.Experiment} stores the result of hyperparameter optimization to find the best model/pipeline.
     */
    readonly hpoExperiment?: Hpo.Experiment;
    withHpoExperiment(hpoExperiment: IHpo.Experiment | null): ReliabilityRiskMl.ReconstructionPipeline;

    /**
     * Reference to the experiment that produced this {@link MlPipe}. For example, this could be a {@link Hpo.ExperimentBase}.
     */
    readonly experiment?: any;
    withExperiment(experiment: any | null): ReliabilityRiskMl.ReconstructionPipeline;

    /**
     * Names of the {@link #score} outputs for this machine learning pipeline.
     */
    readonly scoreNames?: Set_Type<string>;
    withScoreNames(scoreNames: Set_Type<string> | Array<string> | null): ReliabilityRiskMl.ReconstructionPipeline;
    ...
    withTrainRun(trainRun: IWorkflowExecutorRun | null): ReliabilityRiskMl.ReconstructionPipeline;
    ...
    withTrainStatus(trainStatus: IWorkflow.Status | null): ReliabilityRiskMl.ReconstructionPipeline;
    ...
    withDoNotAutoUpsert(doNotAutoUpsert: boolean): ReliabilityRiskMl.ReconstructionPipeline;
    ...
    withLookbackDuration(lookbackDuration: IDuration | null): ReliabilityRiskMl.ReconstructionPipeline;

    /**
     * If set, the {@link #riskScorePipe} must accept a `target` as an input.
     */
    readonly hasTarget?: boolean;
    withHasTarget(hasTarget: boolean): ReliabilityRiskMl.ReconstructionPipeline;
    ...
    withMaskingPipe(maskingPipe: IMlPipe<any, any, any, any, any>): ReliabilityRiskMl.ReconstructionPipeline;
    ...
    withAlertingPipe(alertingPipe: IMlPipe<any, any, any, any, any>): ReliabilityRiskMl.ReconstructionPipeline;
    ...
    withRiskScorePipe(riskScorePipe: IMlPipe<any, any, any, any, any>): ReliabilityRiskMl.ReconstructionPipeline;
    ...
    withRiskScoreNormalizationPipe(riskScoreNormalizationPipe: IMlPipe<any, any, any, any, any>): ReliabilityRiskMl.ReconstructionPipeline;
    ...
    withInterpreter(interpreter: IMlInterpreter<any, any> | null): ReliabilityRiskMl.ReconstructionPipeline;
    ...
    withPipelineScoringMetrics(pipelineScoringMetrics: Map_Type<string, ReliabilityRiskMl.Pipeline.ScoringMetric> | {[key: string]: IReliabilityRiskMl.Pipeline.ScoringMetric} | null): ReliabilityRiskMl.ReconstructionPipeline;
    ...
    withTrainingMasks(trainingMasks: Array_Type<string> | Array<string> | null): ReliabilityRiskMl.ReconstructionPipeline;
    ...
    withInferenceMasks(inferenceMasks: Array_Type<string> | Array<string> | null): ReliabilityRiskMl.ReconstructionPipeline;

    /**
     * If set, the {@link #reconstructionPipe} must also include `latentProjection` in its output.
     */
    readonly includeLatentProjection?: boolean;
    withIncludeLatentProjection(includeLatentProjection: boolean): ReliabilityRiskMl.ReconstructionPipeline;
    ...
    withDoNotApplyScaling(doNotApplyScaling: boolean): ReliabilityRiskMl.ReconstructionPipeline;
    ...
    withScalerPipe(scalerPipe: IMlPipe<any, any, any, any, any> | null): ReliabilityRiskMl.ReconstructionPipeline;
    ...
    withReconstructionPipe(reconstructionPipe: IMlPipe<any, any, any, any, any> | null): ReliabilityRiskMl.ReconstructionPipeline;
    ...
    withReconstructionPipelineScoringMetrics(reconstructionPipelineScoringMetrics: Map_Type<string, ReliabilityRiskMl.ReconstructionPipeline.ScoringMetric> | {[key: string]: IReliabilityRiskMl.ReconstructionPipeline.ScoringMetric} | null): ReliabilityRiskMl.ReconstructionPipeline;
    ...
    withPipeToInterpret(pipeToInterpret: string | null): ReliabilityRiskMl.ReconstructionPipeline;
     ...
     * @see #toJson
     */
    static fromJson(json: any): ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO> | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO> | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO> | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO> | null;
     ...
     */
    replaceType(old: Type, new_: Type): ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>;
     ...
     * @see #removeField
     */
    withoutField(field: string): ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>;
     ...
     */
    withoutFields(fields: Array_Type<string>): ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>;
     ...
     * @see #unsetField
     */
    defaultField(field: string): ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>;
     ...
     * @see #removeField
     */
    unsetField(field: string): ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>;
     ...
     * @see #unsetField
     */
    removeField(field: string): ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>;

    mergeJson(json: any): ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>;
     ...
     */
    sumObj(other: Obj, deep?: boolean): ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>;
     ...
     */
    singletonArray(): Array_Type<ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>;
     ...
     * @see #fromString
     */
    static make(s: string): ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO> | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>;
     ...
     */
    static cachedEmptyInst(): ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>;
     ...
     */
    remakeTemplate(): ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>;
     ...
     */
    precomputeVertexConnections(): ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>;
     ...
     */
    mapVertices(mapper: λFunction<MlPipeline.Vertex | null, T | null>): ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>;
     ...
     */
    topologicalSort(reverse?: boolean): ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>;
     ...
     */
    ancestorGraph(sink: FlowGraph.Vertex): ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>;
     ...
     */
    replaceVertex(oldVertex: FlowGraph.Vertex, newVertex: FlowGraph.Vertex, doNotMerge?: boolean, removeDisconnectedEdges?: boolean): ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>;
     ...
     */
    replaceVertices(oldVertices: Array_Type<FlowGraph.Vertex>, newVertex: FlowGraph.Vertex, spec?: FlowGraphReplaceSpec): ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>;
     ...
     * @return
     */
    replaceVertices(oldVertices: Array_Type<FlowGraph.Vertex>, newVertices: Array_Type<FlowGraph.Vertex>, newEdges?: Array_Type<FlowGraph.Edge<FlowGraph.Vertex>>, spec?: FlowGraphReplaceSpec): ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>;
     ...
     * connected.
     */
    removeVertex(toRemove: FlowGraph.Vertex): ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>;

    removeVertex(idToRemove: string): ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>;
     ...
     */
    removeVertices(toRemove?: Array_Type<FlowGraph.Vertex>): ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>;
     ...
     */
    mergeWith(other: ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>): ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>;
     ...
     */
    trainSync(x: DX, y?: DY, spec?: MlOperationSpec): ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>;
     ...
     */
    static allCached(doNotProduceAll?: boolean): Stream<ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>> | null;
     ...
     */
    static find(filter?: string, doNotProduceAll?: boolean): Stream<ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>> | null;
     ...
     * @return existing instances of this type that satisfy filter from data cache.
     */
    static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>> | null;
     ...
     * @see getCached
     */
    static findByCacheKey(key: string): ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO> | null;
     ...
     * @see findByCacheKey
     */
    static forCacheKey(key: string): ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO> | null;
     ...
     * @see findByCacheKey
     */
    getCached(): ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO> | null;

    /**
     * @return newly produced cached instance.
     */
    refreshCache(): ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO> | null;
     ...
     */
    static produce(key: string): ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO> | null;
     ...
     */
    static produceAll(): Map_Type<string, ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>> | null;

    /**
     * Override for sub-types to produce all values.
     */
    static doProduceAll(): Map_Type<string, ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>> | null;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>>> | null;
     ...
     */
    get(include?: string): ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO> | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO> | null;
     ...
     */
    getMissing(spec: GetMissingSpec): ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO> | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>;
     ...
     * @see #toString
     */
    static fromString(s: string): ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO> | null;
     ...
     */
    create(spec?: UpsertSpec): ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO> | null;
     ...
     */
    static createBatch(objs: Array_Type<ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>> | null;
     ...
     */
    update(srcObj?: ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>, spec?: UpsertSpec): ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO> | null;
     ...
     */
    upsert(srcObj?: ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>, spec?: UpsertSpec): ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO> | null;
     ...
     */
    merge(spec?: MergeSpec): ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO> | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO> | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO> | null;
     ...
     */
    static updateBatch(objs: Array_Type<ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>>, srcObjs?: Array_Type<ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>> | null>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>>, srcObjs?: Array_Type<ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>> | null>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>>, spec?: TouchSpec): ObjList<ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>>, spec?: MergeSpec): ObjList<ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>> | null;
     ...
     */
    static mergeAll(mergeObj: ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO> | null;
     ...
     */
    static beforeCreate(objs: Array_Type<ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>>): ObjList<ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>>;
     ...
     */
    static beforeUpdate(objs: Array_Type<ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>>): ObjList<ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>>): ObjList<ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>>;
     ...
     */
    static afterCreate(objs: Array_Type<ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO> | null;
     ...
     */
    withoutIdentity(): ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO> | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>>, callback?: λFunction<ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO> | null, ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO> | null>): ObjList<ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>>, callback?: λFunction<ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO> | null, ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO> | null>): Array_Type<ObjError> | null;
     ...
     */
    publish(subPath?: string, contentType?: string): ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>;
     ...
     */
    static removeSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>> | null;
     ...
     */
    createSeedData(spec?: UpsertSpec): ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO> | null;
     ...
     */
    static createSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>> | null;
     ...
     */
    updateSeedData(srcObj?: SeedData, spec?: UpsertSpec): ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO> | null;
     ...
     */
    static updateSeedDataBatch(objs?: Array_Type<SeedData>, srcObjs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>> | null;
     ...
     * @return updated obj instance, same as {@link Persistable#update} return value.
     */
    clearUserUpdates(spec?: MergeSpec): ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO> | null;
     ...
     *         {@link Persistable#updateBatch}.
     */
    static clearUserUpdatesBatch(objs?: Array_Type<SeedData>, spec?: MergeSpec): ObjList<ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>> | null;
    ...
    dependencies(): SeedDataDeps<ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>> | null;
     ...
     */
    static convert(model: any, spec?: MlConvertSpec): ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>;

    /**
     * Freezes an {@link MlPipe}
     * @return modified copy of this {@link MlPipe} that cannot be trained
     */
    freeze(): ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>;
     ...
     */
    freeze(paths?: Array_Type<string>): ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>;

    /**
     * Unfreezes an {@link MlPipe}
     * @return modified copy of this {@link MlPipe} that can be trained
     */
    unfreeze(): ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>;
     ...
     */
    unfreeze(paths?: Array_Type<string>): ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>;
     ...
     * be returned as-is.
     */
    byReference(): ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>;
     ...
     */
    train_verify(x?: DX, y?: DY, spec?: MlOperationSpec): ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>;
     ...
     */
    withHyperparamSpaces(paramSpaces: Map_Type<string, Map_Type<string, Hp.ParamSpace>>): ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>;
     ...
     */
    replacePipe(pipePath: string, newPipe: MlPipe<any, any, any, any, any>): ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>;
     ...
     */
    replaceInterpreter(interpreterPath: string, newInterpreter: MlInterpreter<any, any>): ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>;
     ...
     */
    flatten(): ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>;
     ...
     */
    static fromV7Json(pipeline: string, runtimeRequirements: Array_Type<string>): ReliabilityRiskMl.ReconstructionPipeline<DX, DY, DO>;
