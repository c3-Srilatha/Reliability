// TypeScript definitions for the C3 type ReliabilityMl.ModelReport

/**
 * A single exportable PDF model report.
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityMl.ModelReport
 */
declare namespace ReliabilityMl {
  export interface IModelReport {
    ...
    /**
     * The {@link ReliabilityMlModel} to which this report belongs.
     */
    model: IReliabilityMlModel;

    /**
     * The {@link ReliabilityAsset} to which this report belongs.
     */
    asset: IReliabilityAsset;

    /**
     * The generated PDF as a {@link File} for this report.
     */
    file: IFile;

    /**
     * The {@link TimeRange} over which the reference model output was generated for the {#model}.
     */
    referenceTimeRange: ITimeRange;

    /**
     * The {@link TimeRange} over which the comparison model output was generated for the {#model}.
     */
    comparisonTimeRange: ITimeRange;

    /**
     * Deduced from the {@link ReliabilityMlDatasetPreparationRunCommon#interval} used during generating this report.
     */
    interval?: string;
  }
}
 ...
 * A single exportable PDF model report.
 *
 * @remarks this represents a made instance of ReliabilityMl.ModelReport
 */
declare namespace ReliabilityMl {
  export class ModelReport extends Obj  {
     ...
     */
    readonly id: string;
    withId(id: string): ReliabilityMl.ModelReport;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityMl.ModelReport;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): ReliabilityMl.ModelReport;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): ReliabilityMl.ModelReport;
    ...
    withVersion(version: number | null): ReliabilityMl.ModelReport;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): ReliabilityMl.ModelReport;

    /**
     * @inheritdoc
     */
    readonly facilityFilterPaths?: Array_Type<string>;
    withFacilityFilterPaths(facilityFilterPaths: Array_Type<string> | Array<string> | null): ReliabilityMl.ModelReport;
    ...
    withTypeIdent(typeIdent: string | null): ReliabilityMl.ModelReport;

    /**
     * The {@link ReliabilityMlModel} to which this report belongs.
     */
    readonly model: ReliabilityMlModel;
    withModel(model: IReliabilityMlModel): ReliabilityMl.ModelReport;

    /**
     * The {@link ReliabilityAsset} to which this report belongs.
     */
    readonly asset: ReliabilityAsset;
    withAsset(asset: IReliabilityAsset): ReliabilityMl.ModelReport;

    /**
     * The generated PDF as a {@link File} for this report.
     */
    readonly file: File;
    withFile(file: IFile): ReliabilityMl.ModelReport;

    /**
     * The {@link TimeRange} over which the reference model output was generated for the {#model}.
     */
    readonly referenceTimeRange: TimeRange;
    withReferenceTimeRange(referenceTimeRange: ITimeRange): ReliabilityMl.ModelReport;

    /**
     * The {@link TimeRange} over which the comparison model output was generated for the {#model}.
     */
    readonly comparisonTimeRange: TimeRange;
    withComparisonTimeRange(comparisonTimeRange: ITimeRange): ReliabilityMl.ModelReport;

    /**
     * Deduced from the {@link ReliabilityMlDatasetPreparationRunCommon#interval} used during generating this report.
     */
    readonly interval?: string;
    withInterval(interval: string | null): ReliabilityMl.ModelReport;
     ...
     * @see #toJson
     */
    static fromJson(json: any): ReliabilityMl.ModelReport | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): ReliabilityMl.ModelReport | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): ReliabilityMl.ModelReport | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): ReliabilityMl.ModelReport | null;
     ...
     */
    replaceType(old: Type, new_: Type): ReliabilityMl.ModelReport;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityMl.ModelReport;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityMl.ModelReport;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityMl.ModelReport>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityMl.ModelReport>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityMl.ModelReport;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityMl.ModelReport;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityMl.ModelReport;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): ReliabilityMl.ModelReport;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): ReliabilityMl.ModelReport;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityMl.ModelReport;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityMl.ModelReport;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityMl.ModelReport;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): ReliabilityMl.ModelReport;
     ...
     * @see #removeField
     */
    withoutField(field: string): ReliabilityMl.ModelReport;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): ReliabilityMl.ModelReport;
     ...
     */
    withoutFields(fields: Array_Type<string>): ReliabilityMl.ModelReport;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityMl.ModelReport;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): ReliabilityMl.ModelReport;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityMl.ModelReport;
     ...
     * @see #unsetField
     */
    defaultField(field: string): ReliabilityMl.ModelReport;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): ReliabilityMl.ModelReport;
     ...
     * @see #removeField
     */
    unsetField(field: string): ReliabilityMl.ModelReport;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): ReliabilityMl.ModelReport;
     ...
     * @see #unsetField
     */
    removeField(field: string): ReliabilityMl.ModelReport;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): ReliabilityMl.ModelReport;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityMl.ModelReport;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityMl.ModelReport;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityMl.ModelReport;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityMl.ModelReport;

    mergeJson(json: any): ReliabilityMl.ModelReport;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityMl.ModelReport;
     ...
     */
    sumObj(other: Obj, deep?: boolean): ReliabilityMl.ModelReport;
     ...
     */
    singletonArray(): Array_Type<ReliabilityMl.ModelReport>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityMl.ModelReport> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<ReliabilityMl.ModelReport> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<ReliabilityMl.ModelReport>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<ReliabilityMl.ModelReport> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, ReliabilityMl.ModelReport> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityMl.ModelReport> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<ReliabilityMl.ModelReport>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<ReliabilityMl.ModelReport>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityMl.ModelReport;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityMl.ModelReport;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityMl.ModelReport;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): ReliabilityMl.ModelReport;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityMl.ModelReport;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): ReliabilityMl.ModelReport;
     ...
     * @see #fromString
     */
    static make(s: string): ReliabilityMl.ModelReport | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityMl.ModelReport;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): ReliabilityMl.ModelReport;
     ...
     */
    static cachedEmptyInst(): ReliabilityMl.ModelReport;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityMl.ModelReport> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): ReliabilityMl.ModelReport;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<ReliabilityMl.ModelReport>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<ReliabilityMl.ModelReport>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityMl.ModelReport> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityMl.ModelReport>> | null;
     ...
     */
    get(include?: string): ReliabilityMl.ModelReport | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): ReliabilityMl.ModelReport | null;
     ...
     */
    getMissing(spec: GetMissingSpec): ReliabilityMl.ModelReport;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): ReliabilityMl.ModelReport | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): ReliabilityMl.ModelReport;
     ...
     * @see #toString
     */
    static fromString(s: string): ReliabilityMl.ModelReport | null;
     ...
     */
    create(spec?: UpsertSpec): ReliabilityMl.ModelReport | null;
     ...
     */
    static createBatch(objs: Array_Type<ReliabilityMl.ModelReport>, spec?: UpsertSpec): ObjList<ReliabilityMl.ModelReport> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<ReliabilityMl.ModelReport>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityMl.ModelReport> | null;
     ...
     */
    update(srcObj?: ReliabilityMl.ModelReport, spec?: UpsertSpec): ReliabilityMl.ModelReport | null;
     ...
     */
    upsert(srcObj?: ReliabilityMl.ModelReport, spec?: UpsertSpec): ReliabilityMl.ModelReport | null;
     ...
     */
    merge(spec?: MergeSpec): ReliabilityMl.ModelReport | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): ReliabilityMl.ModelReport | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): ReliabilityMl.ModelReport | null;
     ...
     */
    static updateBatch(objs: Array_Type<ReliabilityMl.ModelReport>, srcObjs?: Array_Type<ReliabilityMl.ModelReport>, spec?: UpsertSpec): ObjList<ReliabilityMl.ModelReport> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<ReliabilityMl.ModelReport> | null>, spec?: UpsertSpec): ObjList<ReliabilityMl.ModelReport> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<ReliabilityMl.ModelReport>, srcObjs?: Array_Type<ReliabilityMl.ModelReport>, spec?: UpsertSpec): ObjList<ReliabilityMl.ModelReport> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<ReliabilityMl.ModelReport> | null>, spec?: UpsertSpec): ObjList<ReliabilityMl.ModelReport> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<ReliabilityMl.ModelReport>, spec?: TouchSpec): ObjList<ReliabilityMl.ModelReport> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityMl.ModelReport>, spec?: MergeSpec): ObjList<ReliabilityMl.ModelReport> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityMl.ModelReport>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityMl.ModelReport> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<ReliabilityMl.ModelReport> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityMl.ModelReport> | null;
     ...
     */
    static mergeAll(mergeObj: ReliabilityMl.ModelReport, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: ReliabilityMl.ModelReport, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<ReliabilityMl.ModelReport>, spec?: UpsertSpec): ObjList<ReliabilityMl.ModelReport> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<ReliabilityMl.ModelReport>, spec?: UpsertSpec): ObjList<ReliabilityMl.ModelReport> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): ReliabilityMl.ModelReport | null;
     ...
     */
    static beforeCreate(objs: Array_Type<ReliabilityMl.ModelReport>): ObjList<ReliabilityMl.ModelReport>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<ReliabilityMl.ModelReport>): ObjList<ReliabilityMl.ModelReport>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<ReliabilityMl.ModelReport>): ObjList<ReliabilityMl.ModelReport>;
     ...
     */
    static afterCreate(objs: Array_Type<ReliabilityMl.ModelReport>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<ReliabilityMl.ModelReport>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<ReliabilityMl.ModelReport>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityMl.ModelReport>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityMl.ModelReport>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): ReliabilityMl.ModelReport | null;
     ...
     */
    withoutIdentity(): ReliabilityMl.ModelReport | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<ReliabilityMl.ModelReport>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: ReliabilityMl.ModelReport, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<ReliabilityMl.ModelReport>, callback?: λFunction<ReliabilityMl.ModelReport | null, ReliabilityMl.ModelReport | null>): ObjList<ReliabilityMl.ModelReport>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<ReliabilityMl.ModelReport>, callback?: λFunction<ReliabilityMl.ModelReport | null, ReliabilityMl.ModelReport | null>): Array_Type<ObjError> | null;
