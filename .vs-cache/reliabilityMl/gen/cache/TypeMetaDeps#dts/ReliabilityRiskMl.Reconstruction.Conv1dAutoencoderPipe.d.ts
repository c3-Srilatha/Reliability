// TypeScript definitions for the C3 type ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe
 */
declare namespace ReliabilityRiskMl.Reconstruction {
  export interface IConv1dAutoencoderPipe {
     ...
     */
    underlyingPipe?: IMlAtomicPipe<any, any, any>;

    /**
     * The lookback duration of this pipe. Used for internal data handling in the model
    ...
    /**
     * Size of time window in the input of the autoencoder.
     */
    windowSize: number;
     ...
     */
    directionalWeights?: Map_Type<string, Pair<number, number>> | {[key: string]: IPair<number, number>};

    /**
     * Number of Conv layers in the encoder. Will also be used for number of Conv layers in the decoder.
     */
    numEncoderConvolutionalLayers: number;
     ...
     */
    optimizerClassName?: string;

    /**
     * Random seed used during model training. Use the same number for reproducible training results.
     */
    randomSeed?: number;
  }
}
 ...
 * projection of the original input in the autoencoder latent space.
 *
 * @remarks this represents a made instance of ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe
 */
declare namespace ReliabilityRiskMl.Reconstruction {
  export class Conv1dAutoencoderPipe extends Obj  {
     ...
     */
    readonly id: string;
    withId(id: string): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe;

    /**
     * Name of this pipe.
     */
    readonly name?: string;
    withName(name: string | null): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe;
    ...
    withVersion(version: number | null): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe;
    ...
    withUserUpdatedFields(userUpdatedFields: Array_Type<string> | Array<string> | null): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe;
    ...
    withHidden(hidden: boolean): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe;
    ...
    withUserOwned(userOwned: boolean): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe;
    ...
    withTypeIdent(typeIdent: string | null): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe;

    /**
     * If true, then the pipe shall not be retrained
     */
    readonly frozen?: boolean;
    withFrozen(frozen: boolean): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe;

    /**
     * True if training has succeeded and false otherwise.
     */
    readonly trained?: boolean;
    withTrained(trained: boolean): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe;

    /**
     * Errors from training.
     */
    readonly trainingErrors?: string;
    withTrainingErrors(trainingErrors: string | null): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe;

    /**
     * If true, the underlying model only accepts flattened input.
     */
    readonly flattenInput?: boolean;
    withFlattenInput(flattenInput: boolean): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe;

    /**
     * The hyperparameters overridden of a native model or pipe.
     */
    readonly hyperparamOverrides?: Map_Type<string, any>;
    withHyperparamOverrides(hyperparamOverrides: Map_Type<string, any> | {[key: string]: any} | null): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe;
    ...
    withHyperparamSearchSpace(hyperparamSearchSpace: IHp.SearchSpace | null): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe;
    ...
    withHpoSpec(hpoSpec: IHpo.Spec | null): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe;

    /**
     * {@link Hpo.Experiment} stores the result of hyperparameter optimization to find the best model/pipeline.
     */
    readonly hpoExperiment?: Hpo.Experiment;
    withHpoExperiment(hpoExperiment: IHpo.Experiment | null): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe;

    /**
     * Reference to the experiment that produced this {@link MlPipe}. For example, this could be a {@link Hpo.ExperimentBase}.
     */
    readonly experiment?: any;
    withExperiment(experiment: any | null): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe;
    ...
    withModelFiles(modelFiles: Map_Type<string, Url> | {[key: string]: IUrl} | null): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe;
    ...
    withCustomModelCode(customModelCode: Map_Type<string, any> | {[key: string]: any} | null): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe;

    /**
     * Name for the function on the native model to call to do {@link MlProcessable#process}.
     */
    readonly processFunc?: string;
    withProcessFunc(processFunc: string | null): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe;
     ...
     * override {@link MlTemplate.AtomicPipe#hasUnderlyingPipe} and return `True`
     */
    readonly underlyingPipe?: MlAtomicPipe<any, any, any>;
    withUnderlyingPipe(underlyingPipe: IMlAtomicPipe<any, any, any> | null): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe;
    ...
    withLookbackDuration(lookbackDuration: IDuration | null): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe;

    /**
     * Training epochs
     */
    readonly epochs: number;
    withEpochs(epochs: number): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe;

    /**
     * Training batch size
     */
    readonly batchSize: number;
    withBatchSize(batchSize: number): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe;

    /**
     * Number of features
     */
    readonly numFeatures: number;
    withNumFeatures(numFeatures: number): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe;

    /**
     * Size of time window in the input of the autoencoder.
     */
    readonly windowSize: number;
    withWindowSize(windowSize: number): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe;
     ...
     * inference time for the computation of risk scores.
     */
    readonly directionalWeights?: Map_Type<string, Pair<number, number>>;
    withDirectionalWeights(directionalWeights: Map_Type<string, Pair<number, number>> | {[key: string]: IPair<number, number>} | null): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe;

    /**
     * Number of Conv layers in the encoder. Will also be used for number of Conv layers in the decoder.
     */
    readonly numEncoderConvolutionalLayers: number;
    withNumEncoderConvolutionalLayers(numEncoderConvolutionalLayers: number): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe;

    /**
     * Dimension of the vector in the middle of the encoder, the output of "bottleneck" Dense layer
     */
    readonly latentDimension: number;
    withLatentDimension(latentDimension: number): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe;
     ...
     * `num_conv_layers=3` filter sizes for each conv layer = `[16, 8, 4]`.
     */
    readonly filterScaleFactor?: number;
    withFilterScaleFactor(filterScaleFactor: number | null): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe;

    /**
     * Size of the 1D convolution kernel sizes along the time axis.
     */
    readonly kernelSize: number;
    withKernelSize(kernelSize: number): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe;

    /**
     * Number of Dense layers in the encoder. Will also be used for number of Conv layers in the decoder.
     */
    readonly numEncoderDenseLayers: number;
    withNumEncoderDenseLayers(numEncoderDenseLayers: number): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe;

    /**
     * Activation function to use on all convolutional layers. (Middle Dense layers are both linear activation).
     */
    readonly activation?: string;
    withActivation(activation: string | null): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe;

    /**
     * Whether and where to use a dropout layer. Ignored if unspecified.
     */
    readonly useDropout?: string;
    withUseDropout(useDropout: string | null): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe;

    /**
     * Dropout layer's drop probability that must be between `0` and `1`, exclusive.
     */
    readonly dropoutProbability?: number;
    withDropoutProbability(dropoutProbability: number | null): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe;

    /**
     * Whether and where to use a batch normalization layer. Ignored if unspecified.
     */
    readonly useBatchNormalization?: string;
    withUseBatchNormalization(useBatchNormalization: string | null): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe;

    /**
     * Whether and where to use a kernel regularizer. Does not use if `null`.
     */
    readonly useKernelRegularizers?: string;
    withUseKernelRegularizers(useKernelRegularizers: string | null): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe;

    /**
     * Kernel regularizer type as specified in `tensorflow.keras.regularizers`. Ignored if {@link #useKernelRegularizers} is unspecified.
     */
    readonly kernelRegularizationType?: string;
    withKernelRegularizationType(kernelRegularizationType: string | null): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe;

    /**
     * Kernel regularization constant to use. Ignored if {@link #useKernelRegularizers} is unspecified.
     */
    readonly kernelRegularizationConstant?: number;
    withKernelRegularizationConstant(kernelRegularizationConstant: number | null): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe;

    /**
     * Reconstruction loss to be used by the autoencoder.
     */
    readonly reconstructionLoss: string;
    withReconstructionLoss(reconstructionLoss: string): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe;

    /**
     * Learning rate used to override the learning rate specified in the `optimizer` during training.
     * Will use optimizer's learning rate if `learningRateOverride` is unspecified.
     */
    readonly learningRateOverride?: number;
    withLearningRateOverride(learningRateOverride: number | null): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe;

    /**
     * Specifies the keras library optimizer.
     */
    readonly optimizerClassName?: string;
    withOptimizerClassName(optimizerClassName: string | null): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe;

    /**
     * Random seed used during model training. Use the same number for reproducible training results.
     */
    readonly randomSeed?: number;
    withRandomSeed(randomSeed: number | null): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe;
     ...
     * @see #toJson
     */
    static fromJson(json: any): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe | null;
     ...
     */
    replaceType(old: Type, new_: Type): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe;
     ...
     * @see #removeField
     */
    withoutField(field: string): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe;
     ...
     */
    withoutFields(fields: Array_Type<string>): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe;
     ...
     * @see #unsetField
     */
    defaultField(field: string): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe;
     ...
     * @see #removeField
     */
    unsetField(field: string): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe;
     ...
     * @see #unsetField
     */
    removeField(field: string): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe;

    mergeJson(json: any): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe;
     ...
     */
    sumObj(other: Obj, deep?: boolean): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe;
     ...
     */
    singletonArray(): Array_Type<ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe;
     ...
     * @see #fromString
     */
    static make(s: string): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe;
     ...
     */
    static cachedEmptyInst(): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe;
     ...
     */
    remakeTemplate(): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe;
     ...
     */
    withoutIdentity(): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe;
     ...
     */
    train(x: Data, y?: , spec?: MlOperationSpec): MlOperationRun<any>;
     ...
     */
    trainSync(x: Data, y?: , spec?: MlOperationSpec): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe;
     ...
     *           the operation run object to query status and to get the final result.
     */
    process(x: Data, spec?: MlOperationSpec): MlOperationRun<> | null;
     ...
     */
    processSync(x: Data, spec?: MlOperationSpec):  | null;
     ...
     *           the operation run object to query status and to get the final result.
     */
    score(x: Data, y?: , context?: , spec?: MlOperationSpec): MlOperationRun<Map_Type<string, number>> | null;

    /**
     * Blocking, synchronous version of {@link #score}.
     */
    scoreSync(x: Data, y?: , context?: , spec?: MlOperationSpec): Map_Type<string, number> | null;
     ...
     *           the operation run object to query status and to get the final result.
     */
    scoreAll(x: Data, y?: , context?: , spec?: MlOperationSpec): MlOperationRun<Map_Type<string, number>> | null;

    /**
     * Blocking, synchronous version of {@link #scoreAll}.
     */
    scoreAllSync(x: Data, y?: , context?: , spec?: MlOperationSpec): Map_Type<string, number> | null;
     ...
     *           the operation run object to query status and to get the final result.
     */
    interpret(x: Data, spec?: MlOperationSpec): MlOperationRun<> | null;

    /**
     * Blocking, synchronous version of {@link #interpret}.
     */
    interpretSync(x: Data, context?: Map_Type<string, any>, spec?: MlOperationSpec): void;
     ...
     */
    static allCached(doNotProduceAll?: boolean): Stream<ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe> | null;
     ...
     */
    static find(filter?: string, doNotProduceAll?: boolean): Stream<ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe> | null;
     ...
     * @return existing instances of this type that satisfy filter from data cache.
     */
    static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe> | null;
     ...
     * @see getCached
     */
    static findByCacheKey(key: string): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe | null;
     ...
     * @see findByCacheKey
     */
    static forCacheKey(key: string): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe | null;
     ...
     * @see findByCacheKey
     */
    getCached(): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe | null;

    /**
     * @return newly produced cached instance.
     */
    refreshCache(): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe | null;
     ...
     */
    static produce(key: string): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe | null;
     ...
     */
    static produceAll(): Map_Type<string, ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe> | null;

    /**
     * Override for sub-types to produce all values.
     */
    static doProduceAll(): Map_Type<string, ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe> | null;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe>> | null;
     ...
     */
    get(include?: string): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe | null;
     ...
     */
    getMissing(spec: GetMissingSpec): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe;
     ...
     * @see #toString
     */
    static fromString(s: string): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe | null;
     ...
     */
    create(spec?: UpsertSpec): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe | null;
     ...
     */
    static createBatch(objs: Array_Type<ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe> | null;
     ...
     */
    update(srcObj?: ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe, spec?: UpsertSpec): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe | null;
     ...
     */
    upsert(srcObj?: ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe, spec?: UpsertSpec): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe | null;
     ...
     */
    merge(spec?: MergeSpec): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe | null;
     ...
     */
    static updateBatch(objs: Array_Type<ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe>, srcObjs?: Array_Type<ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe> | null>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe>, srcObjs?: Array_Type<ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe> | null>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe>, spec?: TouchSpec): ObjList<ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe>, spec?: MergeSpec): ObjList<ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe> | null;
     ...
     */
    static mergeAll(mergeObj: ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe | null;
     ...
     */
    static beforeCreate(objs: Array_Type<ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe>): ObjList<ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe>;
     ...
     */
    static beforeUpdate(objs: Array_Type<ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe>): ObjList<ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe>): ObjList<ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe>;
     ...
     */
    static afterCreate(objs: Array_Type<ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe>, callback?: λFunction<ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe | null, ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe | null>): ObjList<ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe>, callback?: λFunction<ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe | null, ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe | null>): Array_Type<ObjError> | null;
     ...
     */
    publish(subPath?: string, contentType?: string): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe;
     ...
     */
    static removeSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe> | null;
     ...
     */
    createSeedData(spec?: UpsertSpec): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe | null;
     ...
     */
    static createSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe> | null;
     ...
     */
    updateSeedData(srcObj?: SeedData, spec?: UpsertSpec): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe | null;
     ...
     */
    static updateSeedDataBatch(objs?: Array_Type<SeedData>, srcObjs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe> | null;
     ...
     * @return updated obj instance, same as {@link Persistable#update} return value.
     */
    clearUserUpdates(spec?: MergeSpec): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe | null;
     ...
     *         {@link Persistable#updateBatch}.
     */
    static clearUserUpdatesBatch(objs?: Array_Type<SeedData>, spec?: MergeSpec): ObjList<ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe> | null;
    ...
    dependencies(): SeedDataDeps<ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe> | null;
     ...
     */
    static convert(model: any, spec?: MlConvertSpec): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe;

    /**
     * Freezes an {@link MlPipe}
     * @return modified copy of this {@link MlPipe} that cannot be trained
     */
    freeze(): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe;

    /**
     * Unfreezes an {@link MlPipe}
     * @return modified copy of this {@link MlPipe} that can be trained
     */
    unfreeze(): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe;
     ...
     */
    newAuthoringVertex(x?: Data, y?: , context?: , suffix?: string = '""', spec?: MlConvertSpec): MlPipeline.PipeVertex.Authoring;
     ...
     * be returned as-is.
     */
    byReference(): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe;
     ...
     */
    updateModelFiles(modelFiles: Map_Type<string, Url>, spec?: MlOperationSpec): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe;
     ...
     */
    afterTrain(doTrainOutputs: any, spec?: MlOperationSpec): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe;
     ...
     */
    convertPipeInputsToNative(x: Data, y?: , spec?: MlOperationSpec): any;
     ...
     */
    convertXToNative(x: Data, spec?: MlOperationSpec): any;
     ...
     */
    convertNativeToPipeOutputs(output: any, datasetId?: string): ;
     ...
     */
    withNewSpec(spec?: MlConvertSpec): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe;
     ...
     */
    afterConvert(model: any, spec?: MlConvertSpec): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe;
     ...
     */
    static getInputDatasetId(x?: Data): string;
     ...
     */
    withHyperparamSpaces(paramSpaces: Map_Type<string, Hp.ParamSpace>): ReliabilityRiskMl.Reconstruction.Conv1dAutoencoderPipe;
     ...
     */
    static hasUnderlyingPipe(): boolean;
     ...
     */
    generatePipe(): MlAtomicPipe<any, any, any>;
     ...
     */
    generateAndAbsorbPipe(force?: boolean, doNotCreate?: boolean): MlTemplate.AtomicPipe<any, any, any>;
     ...
     *           code populating it.
     */
    authoringCode(nativeModelCode?: boolean, asString?: boolean): string | null;
  }
}
