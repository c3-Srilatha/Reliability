// TypeScript definitions for the C3 type ReliabilityTteForecastContribution

/**
 * Represents the contribution of individual factors or variables to a forecasted value in the context of
 * reliability and time-to-event (TTE) predictions. This entity captures the contribution of different
 * features or components for the forecasted value, along with upper and lower bounds to track the uncertainty
 * or range for each contribution.
 *
 * The `ReliabilityTteForecastContribution` entity is used to understand and track how each variable contributes
 * to the model's forecast, which is essential for reliability engineering, predictive maintenance, and risk analysis.
 * The entity also records the timestamp for which the forecast is valid, ensuring that the contributions are linked
 * to specific forecast periods.
 *
 * For more details on each field, refer to the documentation below.
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityTteForecastContribution
 */
declare interface IReliabilityTteForecastContribution {
  ...
  parent: IReliabilityTteForecastContributionHeader;
  ...
  /**
   * The timestamp for which the forecast is generated.
   * This field records the specific time period when the forecast is valid.
   * It is important to know when a forecast was generated to track the evolution
   * of the predictions over time, especially in time-sensitive applications such as
   * predictive maintenance or reliability analysis.
   */
  forecastTimestamp: DateTime | Date | string;

  /**
   * Represents the contribution value of the forecast, typically a numerical value
   * indicating how much a particular factor or variable contributes to the forecasted outcome.
   * The contribution value is essential for understanding how individual features or
   * components impact the forecast. For example, this could represent how a specific
   * environmental condition, asset usage, or operational parameter contributes to the
   * time-to-event prediction.
   * `@ts(treatmentPath='parent.treatment')` - Ensures that any transformations or adjustments
   * to the treatment value in the parent entity are reflected in this contribution value.
   */
  contribution: number;

  /**
   * The upper bound for the contribution value. This defines the maximum possible contribution
   * from the feature or variable, setting a threshold that ensures the contribution does not exceed
   * a certain level in the forecast model.
   * This field helps track the upper limit of each factor's impact and provides a range within which
   * the contribution value can vary. It can be useful for validation and for understanding the model's
   * confidence in the predicted outcome.
   */
  contributionUpperBound?: number;

  /**
   * The lower bound for the contribution value. This defines the minimum possible contribution
   * that a feature or variable can have in the forecast. It sets a threshold to prevent contributions
   * from being too low and outside the expected range for model accuracy.
   * This lower bound provides further validation by ensuring that contributions do not fall
   * below a certain threshold, thus maintaining consistency and stability in the forecasted values.
   */
 ...
 * For more details on each field, refer to the documentation below.
 *
 * @remarks this represents a made instance of ReliabilityTteForecastContribution
 */
declare class ReliabilityTteForecastContribution extends Obj  {

  /**
   * start date for the data point
   */
  readonly start: DateTime;
  withStart(start: DateTime | Date | string): ReliabilityTteForecastContribution;
  ...
  withOutlierCode(outlierCode: number | null): ReliabilityTteForecastContribution;

  /**
   * (Optional) any comments for the data point
   */
  readonly comments?: string;
  withComments(comments: string | null): ReliabilityTteForecastContribution;

  /**
   * Denotes if the value is an actual value or an estimated value. default = null (actual value)
   */
  readonly isEstimated?: boolean;
  withIsEstimated(isEstimated: boolean): ReliabilityTteForecastContribution;
  ...
  withDataVersion(dataVersion: number | null): ReliabilityTteForecastContribution;

  /**
   * Customer specific status code for the data point (may be used to denote data quality)
   */
  readonly statusCode?: string;
  withStatusCode(statusCode: string | null): ReliabilityTteForecastContribution;

  /**
   * Partition key Bin separator used to separate partition key from bin id
   */
  readonly PK_BIN_SEPARATOR?: string;
  withPK_BIN_SEPARATOR(PK_BIN_SEPARATOR: string | null): ReliabilityTteForecastContribution;

  readonly parent: ReliabilityTteForecastContributionHeader;
  withParent(parent: IReliabilityTteForecastContributionHeader): ReliabilityTteForecastContribution;
  ...
  withTypeIdent(typeIdent: string | null): ReliabilityTteForecastContribution;
   ...
   */
  readonly id: string;
  withId(id: string): ReliabilityTteForecastContribution;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityTteForecastContribution;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): ReliabilityTteForecastContribution;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): ReliabilityTteForecastContribution;
  ...
  withVersion(version: number | null): ReliabilityTteForecastContribution;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): ReliabilityTteForecastContribution;
   ...
   * predictive maintenance or reliability analysis.
   */
  readonly forecastTimestamp: DateTime;
  withForecastTimestamp(forecastTimestamp: DateTime | Date | string): ReliabilityTteForecastContribution;
  ...
  withContribution(contribution: number): ReliabilityTteForecastContribution;
  ...
  withContributionUpperBound(contributionUpperBound: number | null): ReliabilityTteForecastContribution;
  ...
  withContributionLowerBound(contributionLowerBound: number | null): ReliabilityTteForecastContribution;
   ...
   * @see #toJson
   */
  static fromJson(json: any): ReliabilityTteForecastContribution | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): ReliabilityTteForecastContribution | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): ReliabilityTteForecastContribution | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): ReliabilityTteForecastContribution | null;
   ...
   */
  replaceType(old: Type, new_: Type): ReliabilityTteForecastContribution;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityTteForecastContribution;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityTteForecastContribution;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityTteForecastContribution>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityTteForecastContribution>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityTteForecastContribution;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityTteForecastContribution;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityTteForecastContribution;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ReliabilityTteForecastContribution;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ReliabilityTteForecastContribution;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityTteForecastContribution;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityTteForecastContribution;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityTteForecastContribution;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ReliabilityTteForecastContribution;
   ...
   * @see #removeField
   */
  withoutField(field: string): ReliabilityTteForecastContribution;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): ReliabilityTteForecastContribution;
   ...
   */
  withoutFields(fields: Array_Type<string>): ReliabilityTteForecastContribution;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityTteForecastContribution;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ReliabilityTteForecastContribution;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityTteForecastContribution;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ReliabilityTteForecastContribution;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ReliabilityTteForecastContribution;
   ...
   * @see #removeField
   */
  unsetField(field: string): ReliabilityTteForecastContribution;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ReliabilityTteForecastContribution;
   ...
   * @see #unsetField
   */
  removeField(field: string): ReliabilityTteForecastContribution;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ReliabilityTteForecastContribution;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityTteForecastContribution;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityTteForecastContribution;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityTteForecastContribution;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityTteForecastContribution;

  mergeJson(json: any): ReliabilityTteForecastContribution;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityTteForecastContribution;
   ...
   */
  sumObj(other: Obj, deep?: boolean): ReliabilityTteForecastContribution;
   ...
   */
  singletonArray(): Array_Type<ReliabilityTteForecastContribution>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityTteForecastContribution> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ReliabilityTteForecastContribution> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<ReliabilityTteForecastContribution>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ReliabilityTteForecastContribution> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, ReliabilityTteForecastContribution> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityTteForecastContribution> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ReliabilityTteForecastContribution>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ReliabilityTteForecastContribution>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityTteForecastContribution;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityTteForecastContribution;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityTteForecastContribution;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ReliabilityTteForecastContribution;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityTteForecastContribution;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ReliabilityTteForecastContribution;
   ...
   * @see #fromString
   */
  static make(s: string): ReliabilityTteForecastContribution | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityTteForecastContribution;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): ReliabilityTteForecastContribution;
   ...
   */
  static cachedEmptyInst(): ReliabilityTteForecastContribution;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityTteForecastContribution> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): ReliabilityTteForecastContribution;

  /**
   * Extract the partition key from the given obj
   */
  partitionKey(failIfMissing?: boolean): ReliabilityTteForecastContributionHeader | null;
   ...
   */
  static partition(objs?: Stream<ReliabilityTteForecastContribution>, spec?: PartitionBucketStrategy): Map_Type<string, KvDataPartition> | null;
   ...
   */
  static fromPartitions(partitions?: Stream<KvDataPartition>): Stream<ReliabilityTteForecastContribution> | null;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<ReliabilityTteForecastContribution>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<ReliabilityTteForecastContribution>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityTteForecastContribution> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityTteForecastContribution>> | null;
   ...
   */
  get(include?: string): ReliabilityTteForecastContribution | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): ReliabilityTteForecastContribution | null;
   ...
   */
  getMissing(spec: GetMissingSpec): ReliabilityTteForecastContribution;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): ReliabilityTteForecastContribution | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): ReliabilityTteForecastContribution;
   ...
   * @see #toString
   */
  static fromString(s: string): ReliabilityTteForecastContribution | null;
   ...
   */
  create(spec?: UpsertSpec): ReliabilityTteForecastContribution | null;
   ...
   */
  static createBatch(objs: Array_Type<ReliabilityTteForecastContribution>, spec?: UpsertSpec): ObjList<ReliabilityTteForecastContribution> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<ReliabilityTteForecastContribution>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityTteForecastContribution> | null;
   ...
   */
  update(srcObj?: ReliabilityTteForecastContribution, spec?: UpsertSpec): ReliabilityTteForecastContribution | null;
   ...
   */
  upsert(srcObj?: ReliabilityTteForecastContribution, spec?: UpsertSpec): ReliabilityTteForecastContribution | null;
   ...
   */
  merge(spec?: MergeSpec): ReliabilityTteForecastContribution | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): ReliabilityTteForecastContribution | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): ReliabilityTteForecastContribution | null;
   ...
   */
  static updateBatch(objs: Array_Type<ReliabilityTteForecastContribution>, srcObjs?: Array_Type<ReliabilityTteForecastContribution>, spec?: UpsertSpec): ObjList<ReliabilityTteForecastContribution> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<ReliabilityTteForecastContribution> | null>, spec?: UpsertSpec): ObjList<ReliabilityTteForecastContribution> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<ReliabilityTteForecastContribution>, srcObjs?: Array_Type<ReliabilityTteForecastContribution>, spec?: UpsertSpec): ObjList<ReliabilityTteForecastContribution> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<ReliabilityTteForecastContribution> | null>, spec?: UpsertSpec): ObjList<ReliabilityTteForecastContribution> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<ReliabilityTteForecastContribution>, spec?: TouchSpec): ObjList<ReliabilityTteForecastContribution> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityTteForecastContribution>, spec?: MergeSpec): ObjList<ReliabilityTteForecastContribution> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityTteForecastContribution>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityTteForecastContribution> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<ReliabilityTteForecastContribution> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityTteForecastContribution> | null;
   ...
   */
  static mergeAll(mergeObj: ReliabilityTteForecastContribution, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: ReliabilityTteForecastContribution, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<ReliabilityTteForecastContribution>, spec?: UpsertSpec): ObjList<ReliabilityTteForecastContribution> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<ReliabilityTteForecastContribution>, spec?: UpsertSpec): ObjList<ReliabilityTteForecastContribution> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): ReliabilityTteForecastContribution | null;
   ...
   */
  static beforeCreate(objs: Array_Type<ReliabilityTteForecastContribution>): ObjList<ReliabilityTteForecastContribution>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<ReliabilityTteForecastContribution>): ObjList<ReliabilityTteForecastContribution>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<ReliabilityTteForecastContribution>): ObjList<ReliabilityTteForecastContribution>;
   ...
   */
  static afterCreate(objs: Array_Type<ReliabilityTteForecastContribution>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<ReliabilityTteForecastContribution>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<ReliabilityTteForecastContribution>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityTteForecastContribution>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityTteForecastContribution>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): ReliabilityTteForecastContribution | null;
   ...
   */
  withoutIdentity(): ReliabilityTteForecastContribution | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<ReliabilityTteForecastContribution>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: ReliabilityTteForecastContribution, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<ReliabilityTteForecastContribution>, callback?: λFunction<ReliabilityTteForecastContribution | null, ReliabilityTteForecastContribution | null>): ObjList<ReliabilityTteForecastContribution>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<ReliabilityTteForecastContribution>, callback?: λFunction<ReliabilityTteForecastContribution | null, ReliabilityTteForecastContribution | null>): Array_Type<ObjError> | null;
