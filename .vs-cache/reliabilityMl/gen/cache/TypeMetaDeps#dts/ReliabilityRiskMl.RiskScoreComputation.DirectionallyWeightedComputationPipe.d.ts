// TypeScript definitions for the C3 type ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe

/**
 * This type represents an {@link MlPipe} template that outputs a `riskScore` that is a directionally weighted average
 * of the input residuals. Specifically, each column can accept two weights - a weight applied to all positive
 * residuals, and a weight for all negative residuals.
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe
 */
declare namespace ReliabilityRiskMl.RiskScoreComputation {
  export interface IDirectionallyWeightedComputationPipe {
    ...
    /**
     * If set, then this pipe can be trained and must implement `doTrain`. Otherwise, this pipe will be treated as
     * process-only.
     */
 ...
 * residuals, and a weight for all negative residuals.
 *
 * @remarks this represents a made instance of ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe
 */
declare namespace ReliabilityRiskMl.RiskScoreComputation {
  export class DirectionallyWeightedComputationPipe extends Obj  {
     ...
     */
    readonly id: string;
    withId(id: string): ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe;

    /**
     * Name of this pipe.
     */
    readonly name?: string;
    withName(name: string | null): ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe;
    ...
    withVersion(version: number | null): ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe;
    ...
    withUserUpdatedFields(userUpdatedFields: Array_Type<string> | Array<string> | null): ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe;
    ...
    withHidden(hidden: boolean): ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe;
    ...
    withUserOwned(userOwned: boolean): ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe;
    ...
    withTypeIdent(typeIdent: string | null): ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe;

    /**
     * If true, then the pipe shall not be retrained
     */
    readonly frozen?: boolean;
    withFrozen(frozen: boolean): ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe;

    /**
     * True if training has succeeded and false otherwise.
     */
    readonly trained?: boolean;
    withTrained(trained: boolean): ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe;

    /**
     * Errors from training.
     */
    readonly trainingErrors?: string;
    withTrainingErrors(trainingErrors: string | null): ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe;

    /**
     * If true, the underlying model only accepts flattened input.
     */
    readonly flattenInput?: boolean;
    withFlattenInput(flattenInput: boolean): ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe;

    /**
     * The hyperparameters overridden of a native model or pipe.
     */
    readonly hyperparamOverrides?: Map_Type<string, any>;
    withHyperparamOverrides(hyperparamOverrides: Map_Type<string, any> | {[key: string]: any} | null): ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe;
    ...
    withHyperparamSearchSpace(hyperparamSearchSpace: IHp.SearchSpace | null): ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe;
    ...
    withHpoSpec(hpoSpec: IHpo.Spec | null): ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe;

    /**
     * {@link Hpo.Experiment} stores the result of hyperparameter optimization to find the best model/pipeline.
     */
    readonly hpoExperiment?: Hpo.Experiment;
    withHpoExperiment(hpoExperiment: IHpo.Experiment | null): ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe;

    /**
     * Reference to the experiment that produced this {@link MlPipe}. For example, this could be a {@link Hpo.ExperimentBase}.
     */
    readonly experiment?: any;
    withExperiment(experiment: any | null): ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe;
    ...
    withModelFiles(modelFiles: Map_Type<string, Url> | {[key: string]: IUrl} | null): ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe;
    ...
    withCustomModelCode(customModelCode: Map_Type<string, any> | {[key: string]: any} | null): ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe;

    /**
     * Name for the function on the native model to call to do {@link MlProcessable#process}.
     */
    readonly processFunc?: string;
    withProcessFunc(processFunc: string | null): ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe;
    ...
    withUnderlyingPipe(underlyingPipe: IMlAtomicPipe<any, any, any> | null): ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe;
    ...
    withIsTrainableOverride(isTrainableOverride: boolean): ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe;
    ...
    withLookbackDuration(lookbackDuration: IDuration | null): ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe;
    ...
    withDirectionalWeights(directionalWeights: Map_Type<string, Pair<number, number>> | {[key: string]: IPair<number, number>} | null): ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe;
     ...
     * @see #toJson
     */
    static fromJson(json: any): ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe | null;
     ...
     */
    replaceType(old: Type, new_: Type): ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe;
     ...
     * @see #removeField
     */
    withoutField(field: string): ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe;
     ...
     */
    withoutFields(fields: Array_Type<string>): ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe;
     ...
     * @see #unsetField
     */
    defaultField(field: string): ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe;
     ...
     * @see #removeField
     */
    unsetField(field: string): ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe;
     ...
     * @see #unsetField
     */
    removeField(field: string): ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe;

    mergeJson(json: any): ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe;
     ...
     */
    sumObj(other: Obj, deep?: boolean): ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe;
     ...
     */
    singletonArray(): Array_Type<ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe;
     ...
     * @see #fromString
     */
    static make(s: string): ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe;
     ...
     */
    static cachedEmptyInst(): ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe;
     ...
     */
    remakeTemplate(): ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe;
     ...
     */
    withoutIdentity(): ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe;
     ...
     */
    trainSync(x: , y?: , spec?: MlOperationSpec): ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe;
     ...
     *           the operation run object to query status and to get the final result.
     */
    process(x: , spec?: MlOperationSpec): MlOperationRun<> | null;
     ...
     */
    processSync(x: , spec?: MlOperationSpec):  | null;
     ...
     */
    static allCached(doNotProduceAll?: boolean): Stream<ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe> | null;
     ...
     */
    static find(filter?: string, doNotProduceAll?: boolean): Stream<ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe> | null;
     ...
     * @return existing instances of this type that satisfy filter from data cache.
     */
    static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe> | null;
     ...
     * @see getCached
     */
    static findByCacheKey(key: string): ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe | null;
     ...
     * @see findByCacheKey
     */
    static forCacheKey(key: string): ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe | null;
     ...
     * @see findByCacheKey
     */
    getCached(): ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe | null;

    /**
     * @return newly produced cached instance.
     */
    refreshCache(): ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe | null;
     ...
     */
    static produce(key: string): ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe | null;
     ...
     */
    static produceAll(): Map_Type<string, ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe> | null;

    /**
     * Override for sub-types to produce all values.
     */
    static doProduceAll(): Map_Type<string, ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe> | null;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe>> | null;
     ...
     */
    get(include?: string): ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe | null;
     ...
     */
    getMissing(spec: GetMissingSpec): ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe;
     ...
     * @see #toString
     */
    static fromString(s: string): ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe | null;
     ...
     */
    create(spec?: UpsertSpec): ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe | null;
     ...
     */
    static createBatch(objs: Array_Type<ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe> | null;
     ...
     */
    update(srcObj?: ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe, spec?: UpsertSpec): ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe | null;
     ...
     */
    upsert(srcObj?: ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe, spec?: UpsertSpec): ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe | null;
     ...
     */
    merge(spec?: MergeSpec): ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe | null;
     ...
     */
    static updateBatch(objs: Array_Type<ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe>, srcObjs?: Array_Type<ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe> | null>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe>, srcObjs?: Array_Type<ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe> | null>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe>, spec?: TouchSpec): ObjList<ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe>, spec?: MergeSpec): ObjList<ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe> | null;
     ...
     */
    static mergeAll(mergeObj: ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe | null;
     ...
     */
    static beforeCreate(objs: Array_Type<ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe>): ObjList<ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe>;
     ...
     */
    static beforeUpdate(objs: Array_Type<ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe>): ObjList<ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe>): ObjList<ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe>;
     ...
     */
    static afterCreate(objs: Array_Type<ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe>, callback?: λFunction<ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe | null, ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe | null>): ObjList<ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe>, callback?: λFunction<ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe | null, ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe | null>): Array_Type<ObjError> | null;
     ...
     */
    publish(subPath?: string, contentType?: string): ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe;
     ...
     */
    static removeSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe> | null;
     ...
     */
    createSeedData(spec?: UpsertSpec): ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe | null;
     ...
     */
    static createSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe> | null;
     ...
     */
    updateSeedData(srcObj?: SeedData, spec?: UpsertSpec): ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe | null;
     ...
     */
    static updateSeedDataBatch(objs?: Array_Type<SeedData>, srcObjs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe> | null;
     ...
     * @return updated obj instance, same as {@link Persistable#update} return value.
     */
    clearUserUpdates(spec?: MergeSpec): ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe | null;
     ...
     *         {@link Persistable#updateBatch}.
     */
    static clearUserUpdatesBatch(objs?: Array_Type<SeedData>, spec?: MergeSpec): ObjList<ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe> | null;
    ...
    dependencies(): SeedDataDeps<ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe> | null;
     ...
     */
    static convert(model: any, spec?: MlConvertSpec): ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe;

    /**
     * Freezes an {@link MlPipe}
     * @return modified copy of this {@link MlPipe} that cannot be trained
     */
    freeze(): ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe;

    /**
     * Unfreezes an {@link MlPipe}
     * @return modified copy of this {@link MlPipe} that can be trained
     */
    unfreeze(): ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe;
     ...
     * be returned as-is.
     */
    byReference(): ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe;
     ...
     */
    updateModelFiles(modelFiles: Map_Type<string, Url>, spec?: MlOperationSpec): ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe;
     ...
     */
    afterTrain(doTrainOutputs: any, spec?: MlOperationSpec): ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe;
     ...
     */
    withNewSpec(spec?: MlConvertSpec): ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe;
     ...
     */
    afterConvert(model: any, spec?: MlConvertSpec): ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe;
     ...
     */
    withHyperparamSpaces(paramSpaces: Map_Type<string, Hp.ParamSpace>): ReliabilityRiskMl.RiskScoreComputation.DirectionallyWeightedComputationPipe;
    ...
    /**
     * Return the output name for risk scores according to the {@link ReliabilityMLOutputConfig}
     */
    static outputName(): string | null;
  }
}
