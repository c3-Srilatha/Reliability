// TypeScript definitions for the C3 type ReliabilityRiskMl.Scaler.MinMaxScalerPipe
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityRiskMl.Scaler.MinMaxScalerPipe
 */
declare namespace ReliabilityRiskMl.Scaler {
  export interface IMinMaxScalerPipe {
     ...
     */
    targetsToScale?: Array_Type<string> | Array<string>;
     ...
     */
    trainedResults?: Map_Type<string, Array_Type<number>> | {[key: string]: Array_Type<number> | Array<number>};
 ...
 */
declare namespace ReliabilityRiskMl.Scaler {
  export class MinMaxScalerPipe extends Obj  {
     ...
     */
    readonly id: string;
    withId(id: string): ReliabilityRiskMl.Scaler.MinMaxScalerPipe;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityRiskMl.Scaler.MinMaxScalerPipe;

    /**
     * Name of this pipe.
     */
    readonly name?: string;
    withName(name: string | null): ReliabilityRiskMl.Scaler.MinMaxScalerPipe;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): ReliabilityRiskMl.Scaler.MinMaxScalerPipe;
    ...
    withVersion(version: number | null): ReliabilityRiskMl.Scaler.MinMaxScalerPipe;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): ReliabilityRiskMl.Scaler.MinMaxScalerPipe;
    ...
    withUserUpdatedFields(userUpdatedFields: Array_Type<string> | Array<string> | null): ReliabilityRiskMl.Scaler.MinMaxScalerPipe;
    ...
    withHidden(hidden: boolean): ReliabilityRiskMl.Scaler.MinMaxScalerPipe;
    ...
    withUserOwned(userOwned: boolean): ReliabilityRiskMl.Scaler.MinMaxScalerPipe;
    ...
    withTypeIdent(typeIdent: string | null): ReliabilityRiskMl.Scaler.MinMaxScalerPipe;

    /**
     * If true, then the pipe shall not be retrained
     */
    readonly frozen?: boolean;
    withFrozen(frozen: boolean): ReliabilityRiskMl.Scaler.MinMaxScalerPipe;

    /**
     * True if training has succeeded and false otherwise.
     */
    readonly trained?: boolean;
    withTrained(trained: boolean): ReliabilityRiskMl.Scaler.MinMaxScalerPipe;

    /**
     * Errors from training.
     */
    readonly trainingErrors?: string;
    withTrainingErrors(trainingErrors: string | null): ReliabilityRiskMl.Scaler.MinMaxScalerPipe;

    /**
     * If true, the underlying model only accepts flattened input.
     */
    readonly flattenInput?: boolean;
    withFlattenInput(flattenInput: boolean): ReliabilityRiskMl.Scaler.MinMaxScalerPipe;

    /**
     * The hyperparameters overridden of a native model or pipe.
     */
    readonly hyperparamOverrides?: Map_Type<string, any>;
    withHyperparamOverrides(hyperparamOverrides: Map_Type<string, any> | {[key: string]: any} | null): ReliabilityRiskMl.Scaler.MinMaxScalerPipe;
    ...
    withHyperparamSearchSpace(hyperparamSearchSpace: IHp.SearchSpace | null): ReliabilityRiskMl.Scaler.MinMaxScalerPipe;
    ...
    withHpoSpec(hpoSpec: IHpo.Spec | null): ReliabilityRiskMl.Scaler.MinMaxScalerPipe;

    /**
     * {@link Hpo.Experiment} stores the result of hyperparameter optimization to find the best model/pipeline.
     */
    readonly hpoExperiment?: Hpo.Experiment;
    withHpoExperiment(hpoExperiment: IHpo.Experiment | null): ReliabilityRiskMl.Scaler.MinMaxScalerPipe;

    /**
     * Reference to the experiment that produced this {@link MlPipe}. For example, this could be a {@link Hpo.ExperimentBase}.
     */
    readonly experiment?: any;
    withExperiment(experiment: any | null): ReliabilityRiskMl.Scaler.MinMaxScalerPipe;
    ...
    withModelFiles(modelFiles: Map_Type<string, Url> | {[key: string]: IUrl} | null): ReliabilityRiskMl.Scaler.MinMaxScalerPipe;
    ...
    withCustomModelCode(customModelCode: Map_Type<string, any> | {[key: string]: any} | null): ReliabilityRiskMl.Scaler.MinMaxScalerPipe;
    ...
    withProcessFunc(processFunc: string | null): ReliabilityRiskMl.Scaler.MinMaxScalerPipe;
    ...
    withUnderlyingPipe(underlyingPipe: IMlAtomicPipe<any, any, any> | null): ReliabilityRiskMl.Scaler.MinMaxScalerPipe;
     ...
     * Example: If you want to scale `temperature` and `humidity`, set this to ['temperature', 'humidity'].
     */
    readonly targetsToScale?: Array_Type<string>;
    withTargetsToScale(targetsToScale: Array_Type<string> | Array<string> | null): ReliabilityRiskMl.Scaler.MinMaxScalerPipe;
     ...
     * The schema suffix 'SSTR' identifies the storage format for the scaling results.
     */
    readonly trainedResults?: Map_Type<string, Array_Type<number>>;
    withTrainedResults(trainedResults: Map_Type<string, Array_Type<number>> | {[key: string]: Array_Type<number> | Array<number>} | null): ReliabilityRiskMl.Scaler.MinMaxScalerPipe;
    ...
    withRangeMin(rangeMin: number | null): ReliabilityRiskMl.Scaler.MinMaxScalerPipe;
    ...
    withRangeMax(rangeMax: number | null): ReliabilityRiskMl.Scaler.MinMaxScalerPipe;
     ...
     * @see #toJson
     */
    static fromJson(json: any): ReliabilityRiskMl.Scaler.MinMaxScalerPipe | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): ReliabilityRiskMl.Scaler.MinMaxScalerPipe | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): ReliabilityRiskMl.Scaler.MinMaxScalerPipe | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): ReliabilityRiskMl.Scaler.MinMaxScalerPipe | null;
     ...
     */
    replaceType(old: Type, new_: Type): ReliabilityRiskMl.Scaler.MinMaxScalerPipe;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityRiskMl.Scaler.MinMaxScalerPipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityRiskMl.Scaler.MinMaxScalerPipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityRiskMl.Scaler.MinMaxScalerPipe>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityRiskMl.Scaler.MinMaxScalerPipe>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityRiskMl.Scaler.MinMaxScalerPipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityRiskMl.Scaler.MinMaxScalerPipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityRiskMl.Scaler.MinMaxScalerPipe;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): ReliabilityRiskMl.Scaler.MinMaxScalerPipe;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): ReliabilityRiskMl.Scaler.MinMaxScalerPipe;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityRiskMl.Scaler.MinMaxScalerPipe;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityRiskMl.Scaler.MinMaxScalerPipe;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityRiskMl.Scaler.MinMaxScalerPipe;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): ReliabilityRiskMl.Scaler.MinMaxScalerPipe;
     ...
     * @see #removeField
     */
    withoutField(field: string): ReliabilityRiskMl.Scaler.MinMaxScalerPipe;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): ReliabilityRiskMl.Scaler.MinMaxScalerPipe;
     ...
     */
    withoutFields(fields: Array_Type<string>): ReliabilityRiskMl.Scaler.MinMaxScalerPipe;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityRiskMl.Scaler.MinMaxScalerPipe;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): ReliabilityRiskMl.Scaler.MinMaxScalerPipe;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityRiskMl.Scaler.MinMaxScalerPipe;
     ...
     * @see #unsetField
     */
    defaultField(field: string): ReliabilityRiskMl.Scaler.MinMaxScalerPipe;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): ReliabilityRiskMl.Scaler.MinMaxScalerPipe;
     ...
     * @see #removeField
     */
    unsetField(field: string): ReliabilityRiskMl.Scaler.MinMaxScalerPipe;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): ReliabilityRiskMl.Scaler.MinMaxScalerPipe;
     ...
     * @see #unsetField
     */
    removeField(field: string): ReliabilityRiskMl.Scaler.MinMaxScalerPipe;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): ReliabilityRiskMl.Scaler.MinMaxScalerPipe;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityRiskMl.Scaler.MinMaxScalerPipe;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityRiskMl.Scaler.MinMaxScalerPipe;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityRiskMl.Scaler.MinMaxScalerPipe;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityRiskMl.Scaler.MinMaxScalerPipe;

    mergeJson(json: any): ReliabilityRiskMl.Scaler.MinMaxScalerPipe;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityRiskMl.Scaler.MinMaxScalerPipe;
     ...
     */
    sumObj(other: Obj, deep?: boolean): ReliabilityRiskMl.Scaler.MinMaxScalerPipe;
     ...
     */
    singletonArray(): Array_Type<ReliabilityRiskMl.Scaler.MinMaxScalerPipe>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityRiskMl.Scaler.MinMaxScalerPipe> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<ReliabilityRiskMl.Scaler.MinMaxScalerPipe> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<ReliabilityRiskMl.Scaler.MinMaxScalerPipe>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<ReliabilityRiskMl.Scaler.MinMaxScalerPipe> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, ReliabilityRiskMl.Scaler.MinMaxScalerPipe> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityRiskMl.Scaler.MinMaxScalerPipe> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<ReliabilityRiskMl.Scaler.MinMaxScalerPipe>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<ReliabilityRiskMl.Scaler.MinMaxScalerPipe>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityRiskMl.Scaler.MinMaxScalerPipe;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityRiskMl.Scaler.MinMaxScalerPipe;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityRiskMl.Scaler.MinMaxScalerPipe;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): ReliabilityRiskMl.Scaler.MinMaxScalerPipe;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityRiskMl.Scaler.MinMaxScalerPipe;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): ReliabilityRiskMl.Scaler.MinMaxScalerPipe;
     ...
     * @see #fromString
     */
    static make(s: string): ReliabilityRiskMl.Scaler.MinMaxScalerPipe | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityRiskMl.Scaler.MinMaxScalerPipe;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): ReliabilityRiskMl.Scaler.MinMaxScalerPipe;
     ...
     */
    static cachedEmptyInst(): ReliabilityRiskMl.Scaler.MinMaxScalerPipe;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityRiskMl.Scaler.MinMaxScalerPipe> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): ReliabilityRiskMl.Scaler.MinMaxScalerPipe;
     ...
     */
    remakeTemplate(): ReliabilityRiskMl.Scaler.MinMaxScalerPipe;
     ...
     */
    withoutIdentity(): ReliabilityRiskMl.Scaler.MinMaxScalerPipe;
     ...
     */
    trainSync(x: Data, y?: , spec?: MlOperationSpec): ReliabilityRiskMl.Scaler.MinMaxScalerPipe;
     ...
     *           the operation run object to query status and to get the final result.
     */
    process(x: Data, spec?: MlOperationSpec): MlOperationRun<Data> | null;
     ...
     */
    processSync(x: Data, spec?: MlOperationSpec): Data | null;
     ...
     */
    static allCached(doNotProduceAll?: boolean): Stream<ReliabilityRiskMl.Scaler.MinMaxScalerPipe> | null;
     ...
     */
    static find(filter?: string, doNotProduceAll?: boolean): Stream<ReliabilityRiskMl.Scaler.MinMaxScalerPipe> | null;
     ...
     * @return existing instances of this type that satisfy filter from data cache.
     */
    static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<ReliabilityRiskMl.Scaler.MinMaxScalerPipe> | null;
     ...
     * @see getCached
     */
    static findByCacheKey(key: string): ReliabilityRiskMl.Scaler.MinMaxScalerPipe | null;
     ...
     * @see findByCacheKey
     */
    static forCacheKey(key: string): ReliabilityRiskMl.Scaler.MinMaxScalerPipe | null;
     ...
     * @see findByCacheKey
     */
    getCached(): ReliabilityRiskMl.Scaler.MinMaxScalerPipe | null;

    /**
     * @return newly produced cached instance.
     */
    refreshCache(): ReliabilityRiskMl.Scaler.MinMaxScalerPipe | null;
     ...
     */
    static produce(key: string): ReliabilityRiskMl.Scaler.MinMaxScalerPipe | null;
     ...
     */
    static produceAll(): Map_Type<string, ReliabilityRiskMl.Scaler.MinMaxScalerPipe> | null;

    /**
     * Override for sub-types to produce all values.
     */
    static doProduceAll(): Map_Type<string, ReliabilityRiskMl.Scaler.MinMaxScalerPipe> | null;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<ReliabilityRiskMl.Scaler.MinMaxScalerPipe>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<ReliabilityRiskMl.Scaler.MinMaxScalerPipe>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityRiskMl.Scaler.MinMaxScalerPipe> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityRiskMl.Scaler.MinMaxScalerPipe>> | null;
     ...
     */
    get(include?: string): ReliabilityRiskMl.Scaler.MinMaxScalerPipe | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): ReliabilityRiskMl.Scaler.MinMaxScalerPipe | null;
     ...
     */
    getMissing(spec: GetMissingSpec): ReliabilityRiskMl.Scaler.MinMaxScalerPipe;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): ReliabilityRiskMl.Scaler.MinMaxScalerPipe | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): ReliabilityRiskMl.Scaler.MinMaxScalerPipe;
     ...
     * @see #toString
     */
    static fromString(s: string): ReliabilityRiskMl.Scaler.MinMaxScalerPipe | null;
     ...
     */
    create(spec?: UpsertSpec): ReliabilityRiskMl.Scaler.MinMaxScalerPipe | null;
     ...
     */
    static createBatch(objs: Array_Type<ReliabilityRiskMl.Scaler.MinMaxScalerPipe>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Scaler.MinMaxScalerPipe> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<ReliabilityRiskMl.Scaler.MinMaxScalerPipe>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityRiskMl.Scaler.MinMaxScalerPipe> | null;
     ...
     */
    update(srcObj?: ReliabilityRiskMl.Scaler.MinMaxScalerPipe, spec?: UpsertSpec): ReliabilityRiskMl.Scaler.MinMaxScalerPipe | null;
     ...
     */
    upsert(srcObj?: ReliabilityRiskMl.Scaler.MinMaxScalerPipe, spec?: UpsertSpec): ReliabilityRiskMl.Scaler.MinMaxScalerPipe | null;
     ...
     */
    merge(spec?: MergeSpec): ReliabilityRiskMl.Scaler.MinMaxScalerPipe | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): ReliabilityRiskMl.Scaler.MinMaxScalerPipe | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): ReliabilityRiskMl.Scaler.MinMaxScalerPipe | null;
     ...
     */
    static updateBatch(objs: Array_Type<ReliabilityRiskMl.Scaler.MinMaxScalerPipe>, srcObjs?: Array_Type<ReliabilityRiskMl.Scaler.MinMaxScalerPipe>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Scaler.MinMaxScalerPipe> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<ReliabilityRiskMl.Scaler.MinMaxScalerPipe> | null>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Scaler.MinMaxScalerPipe> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<ReliabilityRiskMl.Scaler.MinMaxScalerPipe>, srcObjs?: Array_Type<ReliabilityRiskMl.Scaler.MinMaxScalerPipe>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Scaler.MinMaxScalerPipe> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<ReliabilityRiskMl.Scaler.MinMaxScalerPipe> | null>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Scaler.MinMaxScalerPipe> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<ReliabilityRiskMl.Scaler.MinMaxScalerPipe>, spec?: TouchSpec): ObjList<ReliabilityRiskMl.Scaler.MinMaxScalerPipe> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityRiskMl.Scaler.MinMaxScalerPipe>, spec?: MergeSpec): ObjList<ReliabilityRiskMl.Scaler.MinMaxScalerPipe> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityRiskMl.Scaler.MinMaxScalerPipe>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityRiskMl.Scaler.MinMaxScalerPipe> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<ReliabilityRiskMl.Scaler.MinMaxScalerPipe> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityRiskMl.Scaler.MinMaxScalerPipe> | null;
     ...
     */
    static mergeAll(mergeObj: ReliabilityRiskMl.Scaler.MinMaxScalerPipe, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: ReliabilityRiskMl.Scaler.MinMaxScalerPipe, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<ReliabilityRiskMl.Scaler.MinMaxScalerPipe>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Scaler.MinMaxScalerPipe> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<ReliabilityRiskMl.Scaler.MinMaxScalerPipe>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Scaler.MinMaxScalerPipe> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): ReliabilityRiskMl.Scaler.MinMaxScalerPipe | null;
     ...
     */
    static beforeCreate(objs: Array_Type<ReliabilityRiskMl.Scaler.MinMaxScalerPipe>): ObjList<ReliabilityRiskMl.Scaler.MinMaxScalerPipe>;
     ...
     */
    static beforeUpdate(objs: Array_Type<ReliabilityRiskMl.Scaler.MinMaxScalerPipe>): ObjList<ReliabilityRiskMl.Scaler.MinMaxScalerPipe>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<ReliabilityRiskMl.Scaler.MinMaxScalerPipe>): ObjList<ReliabilityRiskMl.Scaler.MinMaxScalerPipe>;
     ...
     */
    static afterCreate(objs: Array_Type<ReliabilityRiskMl.Scaler.MinMaxScalerPipe>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<ReliabilityRiskMl.Scaler.MinMaxScalerPipe>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<ReliabilityRiskMl.Scaler.MinMaxScalerPipe>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityRiskMl.Scaler.MinMaxScalerPipe>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityRiskMl.Scaler.MinMaxScalerPipe>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): ReliabilityRiskMl.Scaler.MinMaxScalerPipe | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<ReliabilityRiskMl.Scaler.MinMaxScalerPipe>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: ReliabilityRiskMl.Scaler.MinMaxScalerPipe, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<ReliabilityRiskMl.Scaler.MinMaxScalerPipe>, callback?: λFunction<ReliabilityRiskMl.Scaler.MinMaxScalerPipe | null, ReliabilityRiskMl.Scaler.MinMaxScalerPipe | null>): ObjList<ReliabilityRiskMl.Scaler.MinMaxScalerPipe>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<ReliabilityRiskMl.Scaler.MinMaxScalerPipe>, callback?: λFunction<ReliabilityRiskMl.Scaler.MinMaxScalerPipe | null, ReliabilityRiskMl.Scaler.MinMaxScalerPipe | null>): Array_Type<ObjError> | null;
     ...
     */
    publish(subPath?: string, contentType?: string): ReliabilityRiskMl.Scaler.MinMaxScalerPipe;
     ...
     */
    static removeSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Scaler.MinMaxScalerPipe> | null;
     ...
     */
    createSeedData(spec?: UpsertSpec): ReliabilityRiskMl.Scaler.MinMaxScalerPipe | null;
     ...
     */
    static createSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Scaler.MinMaxScalerPipe> | null;
     ...
     */
    updateSeedData(srcObj?: SeedData, spec?: UpsertSpec): ReliabilityRiskMl.Scaler.MinMaxScalerPipe | null;
     ...
     */
    static updateSeedDataBatch(objs?: Array_Type<SeedData>, srcObjs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Scaler.MinMaxScalerPipe> | null;
     ...
     * @return updated obj instance, same as {@link Persistable#update} return value.
     */
    clearUserUpdates(spec?: MergeSpec): ReliabilityRiskMl.Scaler.MinMaxScalerPipe | null;
     ...
     *         {@link Persistable#updateBatch}.
     */
    static clearUserUpdatesBatch(objs?: Array_Type<SeedData>, spec?: MergeSpec): ObjList<ReliabilityRiskMl.Scaler.MinMaxScalerPipe> | null;
    ...
    dependencies(): SeedDataDeps<ReliabilityRiskMl.Scaler.MinMaxScalerPipe> | null;
     ...
     */
    static convert(model: any, spec?: MlConvertSpec): ReliabilityRiskMl.Scaler.MinMaxScalerPipe;

    /**
     * Freezes an {@link MlPipe}
     * @return modified copy of this {@link MlPipe} that cannot be trained
     */
    freeze(): ReliabilityRiskMl.Scaler.MinMaxScalerPipe;

    /**
     * Unfreezes an {@link MlPipe}
     * @return modified copy of this {@link MlPipe} that can be trained
     */
    unfreeze(): ReliabilityRiskMl.Scaler.MinMaxScalerPipe;
     ...
     * be returned as-is.
     */
    byReference(): ReliabilityRiskMl.Scaler.MinMaxScalerPipe;
     ...
     */
    updateModelFiles(modelFiles: Map_Type<string, Url>, spec?: MlOperationSpec): ReliabilityRiskMl.Scaler.MinMaxScalerPipe;
     ...
     */
    afterTrain(doTrainOutputs: any, spec?: MlOperationSpec): ReliabilityRiskMl.Scaler.MinMaxScalerPipe;
     ...
     */
    withNewSpec(spec?: MlConvertSpec): ReliabilityRiskMl.Scaler.MinMaxScalerPipe;
     ...
     */
    afterConvert(model: any, spec?: MlConvertSpec): ReliabilityRiskMl.Scaler.MinMaxScalerPipe;
     ...
     */
    afterConvert(model?: any, spec?: MlConvertSpec): ReliabilityRiskMl.Scaler.MinMaxScalerPipe | null;
     ...
     */
    withHyperparamSpaces(paramSpaces: Map_Type<string, Hp.ParamSpace>): ReliabilityRiskMl.Scaler.MinMaxScalerPipe;
