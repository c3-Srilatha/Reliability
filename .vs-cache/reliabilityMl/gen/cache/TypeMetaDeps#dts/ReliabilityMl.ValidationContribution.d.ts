// TypeScript definitions for the C3 type ReliabilityMl.ValidationContribution

/**
 * Represents a validation contribution within the context of machine learning or reliability modeling.
 * This entity captures contributions related to model validation, including bounds on the contribution
 * and other relevant metadata for tracking model performance and reliability.
 * For details on other information stored in this Type, refer to the documentation on each of the fields of this Type.
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityMl.ValidationContribution
 */
declare namespace ReliabilityMl {
  export interface IValidationContribution {
    ...
    parent: IReliabilityMl.ValidationContributionHeader;
    ...
    /**
     * Represents the contribution value of the validation, typically a numerical value indicating the importance or impact of the validation.
     *
     * `@ts(treatmentPath='parent.treatment')` - Specifies the path to retrieve the treatment value from the parent.
     */
    contribution: number;

    /**
     * The upper bound for the validation contribution.
     * This defines the maximum allowed value for the contribution and is typically used to set a limit or threshold.
     * It can be used for validation checks or to enforce certain boundaries on the data.
     */
    contributionUpperBound?: number;

    /**
     * The lower bound for the validation contribution.
     * This defines the minimum allowed value for the contribution and is useful for validation checks.
     * It ensures that the contribution value does not fall below a certain threshold.
     * This can be useful for validation checks, ensuring that values do not fall below a certain threshold.
     */
 ...
 * For details on other information stored in this Type, refer to the documentation on each of the fields of this Type.
 *
 * @remarks this represents a made instance of ReliabilityMl.ValidationContribution
 */
declare namespace ReliabilityMl {
  export class ValidationContribution extends Obj  {

    /**
     * start date for the data point
     */
    readonly start: DateTime;
    withStart(start: DateTime | Date | string): ReliabilityMl.ValidationContribution;
    ...
    withOutlierCode(outlierCode: number | null): ReliabilityMl.ValidationContribution;

    /**
     * (Optional) any comments for the data point
     */
    readonly comments?: string;
    withComments(comments: string | null): ReliabilityMl.ValidationContribution;

    /**
     * Denotes if the value is an actual value or an estimated value. default = null (actual value)
     */
    readonly isEstimated?: boolean;
    withIsEstimated(isEstimated: boolean): ReliabilityMl.ValidationContribution;
    ...
    withDataVersion(dataVersion: number | null): ReliabilityMl.ValidationContribution;

    /**
     * Customer specific status code for the data point (may be used to denote data quality)
     */
    readonly statusCode?: string;
    withStatusCode(statusCode: string | null): ReliabilityMl.ValidationContribution;

    /**
     * Partition key Bin separator used to separate partition key from bin id
     */
    readonly PK_BIN_SEPARATOR?: string;
    withPK_BIN_SEPARATOR(PK_BIN_SEPARATOR: string | null): ReliabilityMl.ValidationContribution;

    readonly parent: ReliabilityMl.ValidationContributionHeader;
    withParent(parent: IReliabilityMl.ValidationContributionHeader): ReliabilityMl.ValidationContribution;
    ...
    withTypeIdent(typeIdent: string | null): ReliabilityMl.ValidationContribution;
     ...
     */
    readonly id: string;
    withId(id: string): ReliabilityMl.ValidationContribution;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityMl.ValidationContribution;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): ReliabilityMl.ValidationContribution;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): ReliabilityMl.ValidationContribution;
    ...
    withVersion(version: number | null): ReliabilityMl.ValidationContribution;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): ReliabilityMl.ValidationContribution;
    ...
    withContribution(contribution: number): ReliabilityMl.ValidationContribution;
    ...
    withContributionUpperBound(contributionUpperBound: number | null): ReliabilityMl.ValidationContribution;
    ...
    withContributionLowerBound(contributionLowerBound: number | null): ReliabilityMl.ValidationContribution;
     ...
     * @see #toJson
     */
    static fromJson(json: any): ReliabilityMl.ValidationContribution | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): ReliabilityMl.ValidationContribution | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): ReliabilityMl.ValidationContribution | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): ReliabilityMl.ValidationContribution | null;
     ...
     */
    replaceType(old: Type, new_: Type): ReliabilityMl.ValidationContribution;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityMl.ValidationContribution;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityMl.ValidationContribution;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityMl.ValidationContribution>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityMl.ValidationContribution>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityMl.ValidationContribution;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityMl.ValidationContribution;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityMl.ValidationContribution;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): ReliabilityMl.ValidationContribution;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): ReliabilityMl.ValidationContribution;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityMl.ValidationContribution;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityMl.ValidationContribution;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityMl.ValidationContribution;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): ReliabilityMl.ValidationContribution;
     ...
     * @see #removeField
     */
    withoutField(field: string): ReliabilityMl.ValidationContribution;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): ReliabilityMl.ValidationContribution;
     ...
     */
    withoutFields(fields: Array_Type<string>): ReliabilityMl.ValidationContribution;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityMl.ValidationContribution;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): ReliabilityMl.ValidationContribution;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityMl.ValidationContribution;
     ...
     * @see #unsetField
     */
    defaultField(field: string): ReliabilityMl.ValidationContribution;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): ReliabilityMl.ValidationContribution;
     ...
     * @see #removeField
     */
    unsetField(field: string): ReliabilityMl.ValidationContribution;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): ReliabilityMl.ValidationContribution;
     ...
     * @see #unsetField
     */
    removeField(field: string): ReliabilityMl.ValidationContribution;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): ReliabilityMl.ValidationContribution;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityMl.ValidationContribution;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityMl.ValidationContribution;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityMl.ValidationContribution;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityMl.ValidationContribution;

    mergeJson(json: any): ReliabilityMl.ValidationContribution;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityMl.ValidationContribution;
     ...
     */
    sumObj(other: Obj, deep?: boolean): ReliabilityMl.ValidationContribution;
     ...
     */
    singletonArray(): Array_Type<ReliabilityMl.ValidationContribution>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityMl.ValidationContribution> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<ReliabilityMl.ValidationContribution> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<ReliabilityMl.ValidationContribution>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<ReliabilityMl.ValidationContribution> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, ReliabilityMl.ValidationContribution> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityMl.ValidationContribution> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<ReliabilityMl.ValidationContribution>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<ReliabilityMl.ValidationContribution>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityMl.ValidationContribution;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityMl.ValidationContribution;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityMl.ValidationContribution;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): ReliabilityMl.ValidationContribution;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityMl.ValidationContribution;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): ReliabilityMl.ValidationContribution;
     ...
     * @see #fromString
     */
    static make(s: string): ReliabilityMl.ValidationContribution | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityMl.ValidationContribution;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): ReliabilityMl.ValidationContribution;
     ...
     */
    static cachedEmptyInst(): ReliabilityMl.ValidationContribution;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityMl.ValidationContribution> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): ReliabilityMl.ValidationContribution;

    /**
     * Extract the partition key from the given obj
     */
    partitionKey(failIfMissing?: boolean): ReliabilityMl.ValidationContributionHeader | null;
     ...
     */
    static partition(objs?: Stream<ReliabilityMl.ValidationContribution>, spec?: PartitionBucketStrategy): Map_Type<string, KvDataPartition> | null;
     ...
     */
    static fromPartitions(partitions?: Stream<KvDataPartition>): Stream<ReliabilityMl.ValidationContribution> | null;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<ReliabilityMl.ValidationContribution>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<ReliabilityMl.ValidationContribution>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityMl.ValidationContribution> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityMl.ValidationContribution>> | null;
     ...
     */
    get(include?: string): ReliabilityMl.ValidationContribution | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): ReliabilityMl.ValidationContribution | null;
     ...
     */
    getMissing(spec: GetMissingSpec): ReliabilityMl.ValidationContribution;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): ReliabilityMl.ValidationContribution | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): ReliabilityMl.ValidationContribution;
     ...
     * @see #toString
     */
    static fromString(s: string): ReliabilityMl.ValidationContribution | null;
     ...
     */
    create(spec?: UpsertSpec): ReliabilityMl.ValidationContribution | null;
     ...
     */
    static createBatch(objs: Array_Type<ReliabilityMl.ValidationContribution>, spec?: UpsertSpec): ObjList<ReliabilityMl.ValidationContribution> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<ReliabilityMl.ValidationContribution>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityMl.ValidationContribution> | null;
     ...
     */
    update(srcObj?: ReliabilityMl.ValidationContribution, spec?: UpsertSpec): ReliabilityMl.ValidationContribution | null;
     ...
     */
    upsert(srcObj?: ReliabilityMl.ValidationContribution, spec?: UpsertSpec): ReliabilityMl.ValidationContribution | null;
     ...
     */
    merge(spec?: MergeSpec): ReliabilityMl.ValidationContribution | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): ReliabilityMl.ValidationContribution | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): ReliabilityMl.ValidationContribution | null;
     ...
     */
    static updateBatch(objs: Array_Type<ReliabilityMl.ValidationContribution>, srcObjs?: Array_Type<ReliabilityMl.ValidationContribution>, spec?: UpsertSpec): ObjList<ReliabilityMl.ValidationContribution> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<ReliabilityMl.ValidationContribution> | null>, spec?: UpsertSpec): ObjList<ReliabilityMl.ValidationContribution> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<ReliabilityMl.ValidationContribution>, srcObjs?: Array_Type<ReliabilityMl.ValidationContribution>, spec?: UpsertSpec): ObjList<ReliabilityMl.ValidationContribution> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<ReliabilityMl.ValidationContribution> | null>, spec?: UpsertSpec): ObjList<ReliabilityMl.ValidationContribution> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<ReliabilityMl.ValidationContribution>, spec?: TouchSpec): ObjList<ReliabilityMl.ValidationContribution> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityMl.ValidationContribution>, spec?: MergeSpec): ObjList<ReliabilityMl.ValidationContribution> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityMl.ValidationContribution>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityMl.ValidationContribution> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<ReliabilityMl.ValidationContribution> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityMl.ValidationContribution> | null;
     ...
     */
    static mergeAll(mergeObj: ReliabilityMl.ValidationContribution, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: ReliabilityMl.ValidationContribution, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<ReliabilityMl.ValidationContribution>, spec?: UpsertSpec): ObjList<ReliabilityMl.ValidationContribution> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<ReliabilityMl.ValidationContribution>, spec?: UpsertSpec): ObjList<ReliabilityMl.ValidationContribution> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): ReliabilityMl.ValidationContribution | null;
     ...
     */
    static beforeCreate(objs: Array_Type<ReliabilityMl.ValidationContribution>): ObjList<ReliabilityMl.ValidationContribution>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<ReliabilityMl.ValidationContribution>): ObjList<ReliabilityMl.ValidationContribution>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<ReliabilityMl.ValidationContribution>): ObjList<ReliabilityMl.ValidationContribution>;
     ...
     */
    static afterCreate(objs: Array_Type<ReliabilityMl.ValidationContribution>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<ReliabilityMl.ValidationContribution>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<ReliabilityMl.ValidationContribution>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityMl.ValidationContribution>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityMl.ValidationContribution>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): ReliabilityMl.ValidationContribution | null;
     ...
     */
    withoutIdentity(): ReliabilityMl.ValidationContribution | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<ReliabilityMl.ValidationContribution>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: ReliabilityMl.ValidationContribution, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<ReliabilityMl.ValidationContribution>, callback?: λFunction<ReliabilityMl.ValidationContribution | null, ReliabilityMl.ValidationContribution | null>): ObjList<ReliabilityMl.ValidationContribution>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<ReliabilityMl.ValidationContribution>, callback?: λFunction<ReliabilityMl.ValidationContribution | null, ReliabilityMl.ValidationContribution | null>): Array_Type<ObjError> | null;
