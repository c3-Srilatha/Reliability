// TypeScript definitions for the C3 type ReliabilityAssetToTteModelRelation
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityAssetToTteModelRelation
 */
declare interface IReliabilityAssetToTteModelRelation {
   ...
   */
  timedPredictions?: Array_Type<ReliabilityTtePredictionHeader> | Array<IReliabilityTtePredictionHeader>;
   ...
   */
  timedContributions?: Array_Type<ReliabilityTteContributionHeader> | Array<IReliabilityTteContributionHeader>;
   ...
   */
  timedForecastPredictions?: Array_Type<ReliabilityTteForecastPredictionHeader> | Array<IReliabilityTteForecastPredictionHeader>;
   ...
   */
  timedForecastContributions?: Array_Type<ReliabilityTteForecastContributionHeader> | Array<IReliabilityTteForecastContributionHeader>;
 ...
 */
declare class ReliabilityAssetToTteModelRelation extends Obj  {
   ...
   */
  readonly id: string;
  withId(id: string): ReliabilityAssetToTteModelRelation;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityAssetToTteModelRelation;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): ReliabilityAssetToTteModelRelation;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): ReliabilityAssetToTteModelRelation;
  ...
  withVersion(version: number | null): ReliabilityAssetToTteModelRelation;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): ReliabilityAssetToTteModelRelation;

  /**
   * @inheritdoc
   */
  readonly facilityFilterPaths?: Array_Type<string>;
  withFacilityFilterPaths(facilityFilterPaths: Array_Type<string> | Array<string> | null): ReliabilityAssetToTteModelRelation;

  /**
   * Start timestamp for the value.  If null, assumed to be beginning-of-time (BOT).
   */
  readonly start?: DateTime;
  withStart(start: DateTime | Date | string | null): ReliabilityAssetToTteModelRelation;

  /**
   * End timestamp for the value.  If null, assumed to be end-of-time (EOT).
   */
  readonly end?: DateTime;
  withEnd(end: DateTime | Date | string | null): ReliabilityAssetToTteModelRelation;

  /**
   * The instance of {@link MlSubject} referenced by the relation.
   */
  readonly from: ReliabilityAsset;
  withFrom(from: IReliabilityAsset): ReliabilityAssetToTteModelRelation;
   ...
   * critical time-to-event metrics.
   */
  readonly to: ReliabilityTteMlModel;
  withTo(to: IReliabilityTteMlModel): ReliabilityAssetToTteModelRelation;
  ...
  withTypeIdent(typeIdent: string | null): ReliabilityAssetToTteModelRelation;

  /**
   * The {@link MlModel.Route} that originated this relation.
   */
  readonly route: MlModel.Route;
  withRoute(route: IMlModel.Route): ReliabilityAssetToTteModelRelation;
  ...
  withStatus(status: IMlModel.Route.Status): ReliabilityAssetToTteModelRelation;
  ...
  withGroupId(groupId: string | null): ReliabilityAssetToTteModelRelation;

  /**
   * Timed predictions for this relation.
   */
  readonly timedMlPredictions?: Array_Type<ReliabilityMl.PredictionHeader>;
  withTimedMlPredictions(timedMlPredictions: Array_Type<ReliabilityMl.PredictionHeader> | Array<IReliabilityMl.PredictionHeader> | null): ReliabilityAssetToTteModelRelation;

  /**
   * Timed contribution for this relation.
   */
  readonly timedMlContributions?: Array_Type<ReliabilityMl.ContributionHeader>;
  withTimedMlContributions(timedMlContributions: Array_Type<ReliabilityMl.ContributionHeader> | Array<IReliabilityMl.ContributionHeader> | null): ReliabilityAssetToTteModelRelation;
   ...
   * or forecasting entity).
   */
  readonly timedPredictions?: Array_Type<ReliabilityTtePredictionHeader>;
  withTimedPredictions(timedPredictions: Array_Type<ReliabilityTtePredictionHeader> | Array<IReliabilityTtePredictionHeader> | null): ReliabilityAssetToTteModelRelation;
   ...
   * As with `timedPredictions`, this field is populated from the parent entity.
   */
  readonly timedContributions?: Array_Type<ReliabilityTteContributionHeader>;
  withTimedContributions(timedContributions: Array_Type<ReliabilityTteContributionHeader> | Array<IReliabilityTteContributionHeader> | null): ReliabilityAssetToTteModelRelation;
   ...
   * The field is useful for predictive maintenance, asset management, and planning future interventions.
   */
  readonly timedForecastPredictions?: Array_Type<ReliabilityTteForecastPredictionHeader>;
  withTimedForecastPredictions(timedForecastPredictions: Array_Type<ReliabilityTteForecastPredictionHeader> | Array<IReliabilityTteForecastPredictionHeader> | null): ReliabilityAssetToTteModelRelation;
   ...
   * can be useful for optimizing asset management strategies and improving the reliability of predictions.
   */
  readonly timedForecastContributions?: Array_Type<ReliabilityTteForecastContributionHeader>;
  withTimedForecastContributions(timedForecastContributions: Array_Type<ReliabilityTteForecastContributionHeader> | Array<IReliabilityTteForecastContributionHeader> | null): ReliabilityAssetToTteModelRelation;
  ...
  withReliabilityTimeToEventMLProjectId(reliabilityTimeToEventMLProjectId: string | null): ReliabilityAssetToTteModelRelation;
   ...
   * @see #toJson
   */
  static fromJson(json: any): ReliabilityAssetToTteModelRelation | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): ReliabilityAssetToTteModelRelation | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): ReliabilityAssetToTteModelRelation | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): ReliabilityAssetToTteModelRelation | null;
   ...
   */
  replaceType(old: Type, new_: Type): ReliabilityAssetToTteModelRelation;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityAssetToTteModelRelation;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityAssetToTteModelRelation;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityAssetToTteModelRelation>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityAssetToTteModelRelation>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityAssetToTteModelRelation;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityAssetToTteModelRelation;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityAssetToTteModelRelation;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ReliabilityAssetToTteModelRelation;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ReliabilityAssetToTteModelRelation;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityAssetToTteModelRelation;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityAssetToTteModelRelation;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityAssetToTteModelRelation;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ReliabilityAssetToTteModelRelation;
   ...
   * @see #removeField
   */
  withoutField(field: string): ReliabilityAssetToTteModelRelation;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): ReliabilityAssetToTteModelRelation;
   ...
   */
  withoutFields(fields: Array_Type<string>): ReliabilityAssetToTteModelRelation;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityAssetToTteModelRelation;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ReliabilityAssetToTteModelRelation;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityAssetToTteModelRelation;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ReliabilityAssetToTteModelRelation;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ReliabilityAssetToTteModelRelation;
   ...
   * @see #removeField
   */
  unsetField(field: string): ReliabilityAssetToTteModelRelation;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ReliabilityAssetToTteModelRelation;
   ...
   * @see #unsetField
   */
  removeField(field: string): ReliabilityAssetToTteModelRelation;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ReliabilityAssetToTteModelRelation;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityAssetToTteModelRelation;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityAssetToTteModelRelation;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityAssetToTteModelRelation;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityAssetToTteModelRelation;

  mergeJson(json: any): ReliabilityAssetToTteModelRelation;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityAssetToTteModelRelation;
   ...
   */
  sumObj(other: Obj, deep?: boolean): ReliabilityAssetToTteModelRelation;
   ...
   */
  singletonArray(): Array_Type<ReliabilityAssetToTteModelRelation>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityAssetToTteModelRelation> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ReliabilityAssetToTteModelRelation> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<ReliabilityAssetToTteModelRelation>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ReliabilityAssetToTteModelRelation> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, ReliabilityAssetToTteModelRelation> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityAssetToTteModelRelation> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ReliabilityAssetToTteModelRelation>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ReliabilityAssetToTteModelRelation>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityAssetToTteModelRelation;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityAssetToTteModelRelation;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityAssetToTteModelRelation;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ReliabilityAssetToTteModelRelation;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityAssetToTteModelRelation;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ReliabilityAssetToTteModelRelation;
   ...
   * @see #fromString
   */
  static make(s: string): ReliabilityAssetToTteModelRelation | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityAssetToTteModelRelation;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): ReliabilityAssetToTteModelRelation;
   ...
   */
  static cachedEmptyInst(): ReliabilityAssetToTteModelRelation;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityAssetToTteModelRelation> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): ReliabilityAssetToTteModelRelation;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<ReliabilityAssetToTteModelRelation>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<ReliabilityAssetToTteModelRelation>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityAssetToTteModelRelation> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityAssetToTteModelRelation>> | null;
   ...
   */
  static evalFeatureSetBatch(batch: Array_Type<ReliabilityAssetToTteModelRelation>, featureSet: Feature.Set, spec?: EvalFeatureSpec): Data | null;
   ...
   * ```
   */
  static evalFeaturesBatch(batch: Array_Type<ReliabilityAssetToTteModelRelation>, features: Array_Type<string>, spec?: EvalFeaturesSpec): Data | null;
   ...
   */
  get(include?: string): ReliabilityAssetToTteModelRelation | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): ReliabilityAssetToTteModelRelation | null;
   ...
   */
  getMissing(spec: GetMissingSpec): ReliabilityAssetToTteModelRelation;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): ReliabilityAssetToTteModelRelation | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): ReliabilityAssetToTteModelRelation;
   ...
   * @see #toString
   */
  static fromString(s: string): ReliabilityAssetToTteModelRelation | null;
   ...
   */
  create(spec?: UpsertSpec): ReliabilityAssetToTteModelRelation | null;
   ...
   */
  static createBatch(objs: Array_Type<ReliabilityAssetToTteModelRelation>, spec?: UpsertSpec): ObjList<ReliabilityAssetToTteModelRelation> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<ReliabilityAssetToTteModelRelation>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityAssetToTteModelRelation> | null;
   ...
   */
  update(srcObj?: ReliabilityAssetToTteModelRelation, spec?: UpsertSpec): ReliabilityAssetToTteModelRelation | null;
   ...
   */
  upsert(srcObj?: ReliabilityAssetToTteModelRelation, spec?: UpsertSpec): ReliabilityAssetToTteModelRelation | null;
   ...
   */
  merge(spec?: MergeSpec): ReliabilityAssetToTteModelRelation | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): ReliabilityAssetToTteModelRelation | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): ReliabilityAssetToTteModelRelation | null;
   ...
   */
  static updateBatch(objs: Array_Type<ReliabilityAssetToTteModelRelation>, srcObjs?: Array_Type<ReliabilityAssetToTteModelRelation>, spec?: UpsertSpec): ObjList<ReliabilityAssetToTteModelRelation> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<ReliabilityAssetToTteModelRelation> | null>, spec?: UpsertSpec): ObjList<ReliabilityAssetToTteModelRelation> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<ReliabilityAssetToTteModelRelation>, srcObjs?: Array_Type<ReliabilityAssetToTteModelRelation>, spec?: UpsertSpec): ObjList<ReliabilityAssetToTteModelRelation> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<ReliabilityAssetToTteModelRelation> | null>, spec?: UpsertSpec): ObjList<ReliabilityAssetToTteModelRelation> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<ReliabilityAssetToTteModelRelation>, spec?: TouchSpec): ObjList<ReliabilityAssetToTteModelRelation> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityAssetToTteModelRelation>, spec?: MergeSpec): ObjList<ReliabilityAssetToTteModelRelation> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityAssetToTteModelRelation>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityAssetToTteModelRelation> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<ReliabilityAssetToTteModelRelation> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityAssetToTteModelRelation> | null;
   ...
   */
  static mergeAll(mergeObj: ReliabilityAssetToTteModelRelation, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: ReliabilityAssetToTteModelRelation, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<ReliabilityAssetToTteModelRelation>, spec?: UpsertSpec): ObjList<ReliabilityAssetToTteModelRelation> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<ReliabilityAssetToTteModelRelation>, spec?: UpsertSpec): ObjList<ReliabilityAssetToTteModelRelation> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): ReliabilityAssetToTteModelRelation | null;
   ...
   */
  static beforeCreate(objs: Array_Type<ReliabilityAssetToTteModelRelation>): ObjList<ReliabilityAssetToTteModelRelation>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<ReliabilityAssetToTteModelRelation>): ObjList<ReliabilityAssetToTteModelRelation>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<ReliabilityAssetToTteModelRelation>): ObjList<ReliabilityAssetToTteModelRelation>;
   ...
   */
  static afterCreate(objs: Array_Type<ReliabilityAssetToTteModelRelation>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<ReliabilityAssetToTteModelRelation>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<ReliabilityAssetToTteModelRelation>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityAssetToTteModelRelation>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityAssetToTteModelRelation>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): ReliabilityAssetToTteModelRelation | null;
   ...
   */
  withoutIdentity(): ReliabilityAssetToTteModelRelation | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<ReliabilityAssetToTteModelRelation>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: ReliabilityAssetToTteModelRelation, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<ReliabilityAssetToTteModelRelation>, callback?: λFunction<ReliabilityAssetToTteModelRelation | null, ReliabilityAssetToTteModelRelation | null>): ObjList<ReliabilityAssetToTteModelRelation>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<ReliabilityAssetToTteModelRelation>, callback?: λFunction<ReliabilityAssetToTteModelRelation | null, ReliabilityAssetToTteModelRelation | null>): Array_Type<ObjError> | null;
