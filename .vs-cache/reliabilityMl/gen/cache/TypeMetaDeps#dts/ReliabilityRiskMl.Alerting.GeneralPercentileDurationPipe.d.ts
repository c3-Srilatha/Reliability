// TypeScript definitions for the C3 type ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe
 */
declare namespace ReliabilityRiskMl.Alerting {
  export interface IGeneralPercentileDurationPipe {
 ...
 */
declare namespace ReliabilityRiskMl.Alerting {
  export class GeneralPercentileDurationPipe extends Obj  {
     ...
     */
    readonly id: string;
    withId(id: string): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe;

    /**
     * Name of this pipe.
     */
    readonly name?: string;
    withName(name: string | null): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe;
    ...
    withVersion(version: number | null): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe;
    ...
    withUserUpdatedFields(userUpdatedFields: Array_Type<string> | Array<string> | null): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe;
    ...
    withHidden(hidden: boolean): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe;
    ...
    withUserOwned(userOwned: boolean): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe;
    ...
    withTypeIdent(typeIdent: string | null): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe;

    /**
     * If true, then the pipe shall not be retrained
     */
    readonly frozen?: boolean;
    withFrozen(frozen: boolean): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe;

    /**
     * True if training has succeeded and false otherwise.
     */
    readonly trained?: boolean;
    withTrained(trained: boolean): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe;

    /**
     * Errors from training.
     */
    readonly trainingErrors?: string;
    withTrainingErrors(trainingErrors: string | null): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe;

    /**
     * If true, the underlying model only accepts flattened input.
     */
    readonly flattenInput?: boolean;
    withFlattenInput(flattenInput: boolean): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe;

    /**
     * The hyperparameters overridden of a native model or pipe.
     */
    readonly hyperparamOverrides?: Map_Type<string, any>;
    withHyperparamOverrides(hyperparamOverrides: Map_Type<string, any> | {[key: string]: any} | null): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe;
    ...
    withHyperparamSearchSpace(hyperparamSearchSpace: IHp.SearchSpace | null): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe;
    ...
    withHpoSpec(hpoSpec: IHpo.Spec | null): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe;

    /**
     * {@link Hpo.Experiment} stores the result of hyperparameter optimization to find the best model/pipeline.
     */
    readonly hpoExperiment?: Hpo.Experiment;
    withHpoExperiment(hpoExperiment: IHpo.Experiment | null): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe;

    /**
     * Reference to the experiment that produced this {@link MlPipe}. For example, this could be a {@link Hpo.ExperimentBase}.
     */
    readonly experiment?: any;
    withExperiment(experiment: any | null): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe;
    ...
    withModelFiles(modelFiles: Map_Type<string, Url> | {[key: string]: IUrl} | null): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe;
    ...
    withCustomModelCode(customModelCode: Map_Type<string, any> | {[key: string]: any} | null): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe;

    /**
     * Name for the function on the native model to call to do {@link MlProcessable#process}.
     */
    readonly processFunc?: string;
    withProcessFunc(processFunc: string | null): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe;
    ...
    withUnderlyingPipe(underlyingPipe: IMlAtomicPipe<any, any, any> | null): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe;
    ...
    withLookbackDuration(lookbackDuration: IDuration | null): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe;

    /**
     * The name of the column representing the risk score in the dataset.
     * This is the column that will be used to determine whether to raise an alert.
     */
    readonly riskScoreColumnName: string;
    withRiskScoreColumnName(riskScoreColumnName: string): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe;
     ...
     * range [0, 100]
     */
    readonly alertPercentile?: number;
    withAlertPercentile(alertPercentile: number | null): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe;
    ...
    withAlertThreshold(alertThreshold: number | null): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe;

    /**
     * The duration of time (in seconds) that the `riskScore` must remain above the {@link alertThreshold}
     * before it is considered as a candidate for raising an alert. This helps to filter out transient spikes.
     */
    readonly ignoreSpan?: number;
    withIgnoreSpan(ignoreSpan: number | null): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe;

    /**
     * If an alert has been triggered within the last {@link reminderSpan} seconds, no new alert will be raised
     * even if the `riskScore` remains above the {@link alertThreshold} for a duration longer than the {@link ignoreSpan}.
     */
    readonly reminderSpan?: number;
    withReminderSpan(reminderSpan: number | null): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe;
     ...
     * range mergeSpan <= reminderSpan
     */
    readonly mergeSpan?: number;
    withMergeSpan(mergeSpan: number | null): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe;
    ...
    withInterval(interval: number | null): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe;
     ...
     * Default is `false`.
     */
    readonly mergeOnActualAlert?: boolean;
    withMergeOnActualAlert(mergeOnActualAlert: boolean): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe;
     ...
     * @see #toJson
     */
    static fromJson(json: any): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe | null;
     ...
     */
    replaceType(old: Type, new_: Type): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe;
     ...
     * @see #removeField
     */
    withoutField(field: string): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe;
     ...
     */
    withoutFields(fields: Array_Type<string>): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe;
     ...
     * @see #unsetField
     */
    defaultField(field: string): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe;
     ...
     * @see #removeField
     */
    unsetField(field: string): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe;
     ...
     * @see #unsetField
     */
    removeField(field: string): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe;

    mergeJson(json: any): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe;
     ...
     */
    sumObj(other: Obj, deep?: boolean): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe;
     ...
     */
    singletonArray(): Array_Type<ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe;
     ...
     * @see #fromString
     */
    static make(s: string): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe;
     ...
     */
    static cachedEmptyInst(): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe;
     ...
     */
    remakeTemplate(): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe;
     ...
     */
    withoutIdentity(): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe;
     ...
     */
    trainSync(x: , y?: , spec?: MlOperationSpec): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe;
     ...
     */
    static allCached(doNotProduceAll?: boolean): Stream<ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe> | null;
     ...
     */
    static find(filter?: string, doNotProduceAll?: boolean): Stream<ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe> | null;
     ...
     * @return existing instances of this type that satisfy filter from data cache.
     */
    static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe> | null;
     ...
     * @see getCached
     */
    static findByCacheKey(key: string): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe | null;
     ...
     * @see findByCacheKey
     */
    static forCacheKey(key: string): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe | null;
     ...
     * @see findByCacheKey
     */
    getCached(): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe | null;

    /**
     * @return newly produced cached instance.
     */
    refreshCache(): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe | null;
     ...
     */
    static produce(key: string): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe | null;
     ...
     */
    static produceAll(): Map_Type<string, ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe> | null;

    /**
     * Override for sub-types to produce all values.
     */
    static doProduceAll(): Map_Type<string, ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe> | null;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe>> | null;
     ...
     */
    get(include?: string): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe | null;
     ...
     */
    getMissing(spec: GetMissingSpec): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe;
     ...
     * @see #toString
     */
    static fromString(s: string): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe | null;
     ...
     */
    create(spec?: UpsertSpec): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe | null;
     ...
     */
    static createBatch(objs: Array_Type<ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe> | null;
     ...
     */
    update(srcObj?: ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe, spec?: UpsertSpec): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe | null;
     ...
     */
    upsert(srcObj?: ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe, spec?: UpsertSpec): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe | null;
     ...
     */
    merge(spec?: MergeSpec): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe | null;
     ...
     */
    static updateBatch(objs: Array_Type<ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe>, srcObjs?: Array_Type<ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe> | null>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe>, srcObjs?: Array_Type<ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe> | null>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe>, spec?: TouchSpec): ObjList<ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe>, spec?: MergeSpec): ObjList<ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe> | null;
     ...
     */
    static mergeAll(mergeObj: ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe | null;
     ...
     */
    static beforeCreate(objs: Array_Type<ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe>): ObjList<ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe>;
     ...
     */
    static beforeUpdate(objs: Array_Type<ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe>): ObjList<ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe>): ObjList<ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe>;
     ...
     */
    static afterCreate(objs: Array_Type<ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe>, callback?: λFunction<ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe | null, ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe | null>): ObjList<ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe>, callback?: λFunction<ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe | null, ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe | null>): Array_Type<ObjError> | null;
     ...
     */
    publish(subPath?: string, contentType?: string): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe;
     ...
     */
    static removeSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe> | null;
     ...
     */
    createSeedData(spec?: UpsertSpec): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe | null;
     ...
     */
    static createSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe> | null;
     ...
     */
    updateSeedData(srcObj?: SeedData, spec?: UpsertSpec): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe | null;
     ...
     */
    static updateSeedDataBatch(objs?: Array_Type<SeedData>, srcObjs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe> | null;
     ...
     * @return updated obj instance, same as {@link Persistable#update} return value.
     */
    clearUserUpdates(spec?: MergeSpec): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe | null;
     ...
     *         {@link Persistable#updateBatch}.
     */
    static clearUserUpdatesBatch(objs?: Array_Type<SeedData>, spec?: MergeSpec): ObjList<ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe> | null;
    ...
    dependencies(): SeedDataDeps<ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe> | null;
     ...
     */
    static convert(model: any, spec?: MlConvertSpec): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe;

    /**
     * Freezes an {@link MlPipe}
     * @return modified copy of this {@link MlPipe} that cannot be trained
     */
    freeze(): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe;

    /**
     * Unfreezes an {@link MlPipe}
     * @return modified copy of this {@link MlPipe} that can be trained
     */
    unfreeze(): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe;
     ...
     * be returned as-is.
     */
    byReference(): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe;
     ...
     */
    updateModelFiles(modelFiles: Map_Type<string, Url>, spec?: MlOperationSpec): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe;
     ...
     */
    afterTrain(doTrainOutputs: any, spec?: MlOperationSpec): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe;
     ...
     */
    withNewSpec(spec?: MlConvertSpec): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe;
     ...
     */
    afterConvert(model: any, spec?: MlConvertSpec): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe;
     ...
     */
    withHyperparamSpaces(paramSpaces: Map_Type<string, Hp.ParamSpace>): ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe;
