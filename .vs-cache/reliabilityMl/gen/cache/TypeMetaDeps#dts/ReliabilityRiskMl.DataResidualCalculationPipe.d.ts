// TypeScript definitions for the C3 type ReliabilityRiskMl.DataResidualCalculationPipe

/**
 * This type represents an {@link MlPipe} template for a data operation that takes in a map of datasets and calculates
 * the residuals between them. The input `actual` should be the ground truth values while `predicted` stands for
 * predicted values from a model.
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityRiskMl.DataResidualCalculationPipe
 */
declare namespace ReliabilityRiskMl {
  export interface IDataResidualCalculationPipe {
 ...
 * predicted values from a model.
 *
 * @remarks this represents a made instance of ReliabilityRiskMl.DataResidualCalculationPipe
 */
declare namespace ReliabilityRiskMl {
  export class DataResidualCalculationPipe extends Obj  {
     ...
     */
    readonly id: string;
    withId(id: string): ReliabilityRiskMl.DataResidualCalculationPipe;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityRiskMl.DataResidualCalculationPipe;

    /**
     * Name of this pipe.
     */
    readonly name?: string;
    withName(name: string | null): ReliabilityRiskMl.DataResidualCalculationPipe;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): ReliabilityRiskMl.DataResidualCalculationPipe;
    ...
    withVersion(version: number | null): ReliabilityRiskMl.DataResidualCalculationPipe;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): ReliabilityRiskMl.DataResidualCalculationPipe;
    ...
    withUserUpdatedFields(userUpdatedFields: Array_Type<string> | Array<string> | null): ReliabilityRiskMl.DataResidualCalculationPipe;
    ...
    withHidden(hidden: boolean): ReliabilityRiskMl.DataResidualCalculationPipe;
    ...
    withUserOwned(userOwned: boolean): ReliabilityRiskMl.DataResidualCalculationPipe;
    ...
    withTypeIdent(typeIdent: string | null): ReliabilityRiskMl.DataResidualCalculationPipe;

    /**
     * If true, then the pipe shall not be retrained
     */
    readonly frozen?: boolean;
    withFrozen(frozen: boolean): ReliabilityRiskMl.DataResidualCalculationPipe;

    /**
     * True if training has succeeded and false otherwise.
     */
    readonly trained?: boolean;
    withTrained(trained: boolean): ReliabilityRiskMl.DataResidualCalculationPipe;

    /**
     * Errors from training.
     */
    readonly trainingErrors?: string;
    withTrainingErrors(trainingErrors: string | null): ReliabilityRiskMl.DataResidualCalculationPipe;

    /**
     * If true, the underlying model only accepts flattened input.
     */
    readonly flattenInput?: boolean;
    withFlattenInput(flattenInput: boolean): ReliabilityRiskMl.DataResidualCalculationPipe;

    /**
     * The hyperparameters overridden of a native model or pipe.
     */
    readonly hyperparamOverrides?: Map_Type<string, any>;
    withHyperparamOverrides(hyperparamOverrides: Map_Type<string, any> | {[key: string]: any} | null): ReliabilityRiskMl.DataResidualCalculationPipe;
    ...
    withHyperparamSearchSpace(hyperparamSearchSpace: IHp.SearchSpace | null): ReliabilityRiskMl.DataResidualCalculationPipe;
    ...
    withHpoSpec(hpoSpec: IHpo.Spec | null): ReliabilityRiskMl.DataResidualCalculationPipe;

    /**
     * {@link Hpo.Experiment} stores the result of hyperparameter optimization to find the best model/pipeline.
     */
    readonly hpoExperiment?: Hpo.Experiment;
    withHpoExperiment(hpoExperiment: IHpo.Experiment | null): ReliabilityRiskMl.DataResidualCalculationPipe;

    /**
     * Reference to the experiment that produced this {@link MlPipe}. For example, this could be a {@link Hpo.ExperimentBase}.
     */
    readonly experiment?: any;
    withExperiment(experiment: any | null): ReliabilityRiskMl.DataResidualCalculationPipe;
    ...
    withModelFiles(modelFiles: Map_Type<string, Url> | {[key: string]: IUrl} | null): ReliabilityRiskMl.DataResidualCalculationPipe;
    ...
    withCustomModelCode(customModelCode: Map_Type<string, any> | {[key: string]: any} | null): ReliabilityRiskMl.DataResidualCalculationPipe;

    /**
     * Name for the function on the native model to call to do {@link MlProcessable#process}.
     */
    readonly processFunc?: string;
    withProcessFunc(processFunc: string | null): ReliabilityRiskMl.DataResidualCalculationPipe;
    ...
    withUnderlyingPipe(underlyingPipe: IMlAtomicPipe<any, any, any> | null): ReliabilityRiskMl.DataResidualCalculationPipe;
     ...
     * @see #toJson
     */
    static fromJson(json: any): ReliabilityRiskMl.DataResidualCalculationPipe | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): ReliabilityRiskMl.DataResidualCalculationPipe | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): ReliabilityRiskMl.DataResidualCalculationPipe | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): ReliabilityRiskMl.DataResidualCalculationPipe | null;
     ...
     */
    replaceType(old: Type, new_: Type): ReliabilityRiskMl.DataResidualCalculationPipe;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityRiskMl.DataResidualCalculationPipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityRiskMl.DataResidualCalculationPipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityRiskMl.DataResidualCalculationPipe>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityRiskMl.DataResidualCalculationPipe>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityRiskMl.DataResidualCalculationPipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityRiskMl.DataResidualCalculationPipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityRiskMl.DataResidualCalculationPipe;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): ReliabilityRiskMl.DataResidualCalculationPipe;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): ReliabilityRiskMl.DataResidualCalculationPipe;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityRiskMl.DataResidualCalculationPipe;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityRiskMl.DataResidualCalculationPipe;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityRiskMl.DataResidualCalculationPipe;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): ReliabilityRiskMl.DataResidualCalculationPipe;
     ...
     * @see #removeField
     */
    withoutField(field: string): ReliabilityRiskMl.DataResidualCalculationPipe;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): ReliabilityRiskMl.DataResidualCalculationPipe;
     ...
     */
    withoutFields(fields: Array_Type<string>): ReliabilityRiskMl.DataResidualCalculationPipe;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityRiskMl.DataResidualCalculationPipe;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): ReliabilityRiskMl.DataResidualCalculationPipe;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityRiskMl.DataResidualCalculationPipe;
     ...
     * @see #unsetField
     */
    defaultField(field: string): ReliabilityRiskMl.DataResidualCalculationPipe;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): ReliabilityRiskMl.DataResidualCalculationPipe;
     ...
     * @see #removeField
     */
    unsetField(field: string): ReliabilityRiskMl.DataResidualCalculationPipe;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): ReliabilityRiskMl.DataResidualCalculationPipe;
     ...
     * @see #unsetField
     */
    removeField(field: string): ReliabilityRiskMl.DataResidualCalculationPipe;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): ReliabilityRiskMl.DataResidualCalculationPipe;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityRiskMl.DataResidualCalculationPipe;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityRiskMl.DataResidualCalculationPipe;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityRiskMl.DataResidualCalculationPipe;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityRiskMl.DataResidualCalculationPipe;

    mergeJson(json: any): ReliabilityRiskMl.DataResidualCalculationPipe;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityRiskMl.DataResidualCalculationPipe;
     ...
     */
    sumObj(other: Obj, deep?: boolean): ReliabilityRiskMl.DataResidualCalculationPipe;
     ...
     */
    singletonArray(): Array_Type<ReliabilityRiskMl.DataResidualCalculationPipe>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityRiskMl.DataResidualCalculationPipe> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<ReliabilityRiskMl.DataResidualCalculationPipe> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<ReliabilityRiskMl.DataResidualCalculationPipe>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<ReliabilityRiskMl.DataResidualCalculationPipe> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, ReliabilityRiskMl.DataResidualCalculationPipe> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityRiskMl.DataResidualCalculationPipe> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<ReliabilityRiskMl.DataResidualCalculationPipe>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<ReliabilityRiskMl.DataResidualCalculationPipe>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityRiskMl.DataResidualCalculationPipe;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityRiskMl.DataResidualCalculationPipe;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityRiskMl.DataResidualCalculationPipe;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): ReliabilityRiskMl.DataResidualCalculationPipe;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityRiskMl.DataResidualCalculationPipe;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): ReliabilityRiskMl.DataResidualCalculationPipe;
     ...
     * @see #fromString
     */
    static make(s: string): ReliabilityRiskMl.DataResidualCalculationPipe | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityRiskMl.DataResidualCalculationPipe;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): ReliabilityRiskMl.DataResidualCalculationPipe;
     ...
     */
    static cachedEmptyInst(): ReliabilityRiskMl.DataResidualCalculationPipe;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityRiskMl.DataResidualCalculationPipe> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): ReliabilityRiskMl.DataResidualCalculationPipe;
     ...
     */
    remakeTemplate(): ReliabilityRiskMl.DataResidualCalculationPipe;
     ...
     */
    withoutIdentity(): ReliabilityRiskMl.DataResidualCalculationPipe;
     ...
     */
    trainSync(x: , y?: , spec?: MlOperationSpec): ReliabilityRiskMl.DataResidualCalculationPipe;
     ...
     */
    static allCached(doNotProduceAll?: boolean): Stream<ReliabilityRiskMl.DataResidualCalculationPipe> | null;
     ...
     */
    static find(filter?: string, doNotProduceAll?: boolean): Stream<ReliabilityRiskMl.DataResidualCalculationPipe> | null;
     ...
     * @return existing instances of this type that satisfy filter from data cache.
     */
    static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<ReliabilityRiskMl.DataResidualCalculationPipe> | null;
     ...
     * @see getCached
     */
    static findByCacheKey(key: string): ReliabilityRiskMl.DataResidualCalculationPipe | null;
     ...
     * @see findByCacheKey
     */
    static forCacheKey(key: string): ReliabilityRiskMl.DataResidualCalculationPipe | null;
     ...
     * @see findByCacheKey
     */
    getCached(): ReliabilityRiskMl.DataResidualCalculationPipe | null;

    /**
     * @return newly produced cached instance.
     */
    refreshCache(): ReliabilityRiskMl.DataResidualCalculationPipe | null;
     ...
     */
    static produce(key: string): ReliabilityRiskMl.DataResidualCalculationPipe | null;
     ...
     */
    static produceAll(): Map_Type<string, ReliabilityRiskMl.DataResidualCalculationPipe> | null;

    /**
     * Override for sub-types to produce all values.
     */
    static doProduceAll(): Map_Type<string, ReliabilityRiskMl.DataResidualCalculationPipe> | null;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<ReliabilityRiskMl.DataResidualCalculationPipe>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<ReliabilityRiskMl.DataResidualCalculationPipe>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityRiskMl.DataResidualCalculationPipe> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityRiskMl.DataResidualCalculationPipe>> | null;
     ...
     */
    get(include?: string): ReliabilityRiskMl.DataResidualCalculationPipe | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): ReliabilityRiskMl.DataResidualCalculationPipe | null;
     ...
     */
    getMissing(spec: GetMissingSpec): ReliabilityRiskMl.DataResidualCalculationPipe;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): ReliabilityRiskMl.DataResidualCalculationPipe | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): ReliabilityRiskMl.DataResidualCalculationPipe;
     ...
     * @see #toString
     */
    static fromString(s: string): ReliabilityRiskMl.DataResidualCalculationPipe | null;
     ...
     */
    create(spec?: UpsertSpec): ReliabilityRiskMl.DataResidualCalculationPipe | null;
     ...
     */
    static createBatch(objs: Array_Type<ReliabilityRiskMl.DataResidualCalculationPipe>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.DataResidualCalculationPipe> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<ReliabilityRiskMl.DataResidualCalculationPipe>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityRiskMl.DataResidualCalculationPipe> | null;
     ...
     */
    update(srcObj?: ReliabilityRiskMl.DataResidualCalculationPipe, spec?: UpsertSpec): ReliabilityRiskMl.DataResidualCalculationPipe | null;
     ...
     */
    upsert(srcObj?: ReliabilityRiskMl.DataResidualCalculationPipe, spec?: UpsertSpec): ReliabilityRiskMl.DataResidualCalculationPipe | null;
     ...
     */
    merge(spec?: MergeSpec): ReliabilityRiskMl.DataResidualCalculationPipe | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): ReliabilityRiskMl.DataResidualCalculationPipe | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): ReliabilityRiskMl.DataResidualCalculationPipe | null;
     ...
     */
    static updateBatch(objs: Array_Type<ReliabilityRiskMl.DataResidualCalculationPipe>, srcObjs?: Array_Type<ReliabilityRiskMl.DataResidualCalculationPipe>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.DataResidualCalculationPipe> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<ReliabilityRiskMl.DataResidualCalculationPipe> | null>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.DataResidualCalculationPipe> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<ReliabilityRiskMl.DataResidualCalculationPipe>, srcObjs?: Array_Type<ReliabilityRiskMl.DataResidualCalculationPipe>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.DataResidualCalculationPipe> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<ReliabilityRiskMl.DataResidualCalculationPipe> | null>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.DataResidualCalculationPipe> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<ReliabilityRiskMl.DataResidualCalculationPipe>, spec?: TouchSpec): ObjList<ReliabilityRiskMl.DataResidualCalculationPipe> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityRiskMl.DataResidualCalculationPipe>, spec?: MergeSpec): ObjList<ReliabilityRiskMl.DataResidualCalculationPipe> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityRiskMl.DataResidualCalculationPipe>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityRiskMl.DataResidualCalculationPipe> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<ReliabilityRiskMl.DataResidualCalculationPipe> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityRiskMl.DataResidualCalculationPipe> | null;
     ...
     */
    static mergeAll(mergeObj: ReliabilityRiskMl.DataResidualCalculationPipe, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: ReliabilityRiskMl.DataResidualCalculationPipe, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<ReliabilityRiskMl.DataResidualCalculationPipe>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.DataResidualCalculationPipe> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<ReliabilityRiskMl.DataResidualCalculationPipe>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.DataResidualCalculationPipe> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): ReliabilityRiskMl.DataResidualCalculationPipe | null;
     ...
     */
    static beforeCreate(objs: Array_Type<ReliabilityRiskMl.DataResidualCalculationPipe>): ObjList<ReliabilityRiskMl.DataResidualCalculationPipe>;
     ...
     */
    static beforeUpdate(objs: Array_Type<ReliabilityRiskMl.DataResidualCalculationPipe>): ObjList<ReliabilityRiskMl.DataResidualCalculationPipe>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<ReliabilityRiskMl.DataResidualCalculationPipe>): ObjList<ReliabilityRiskMl.DataResidualCalculationPipe>;
     ...
     */
    static afterCreate(objs: Array_Type<ReliabilityRiskMl.DataResidualCalculationPipe>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<ReliabilityRiskMl.DataResidualCalculationPipe>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<ReliabilityRiskMl.DataResidualCalculationPipe>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityRiskMl.DataResidualCalculationPipe>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityRiskMl.DataResidualCalculationPipe>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): ReliabilityRiskMl.DataResidualCalculationPipe | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<ReliabilityRiskMl.DataResidualCalculationPipe>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: ReliabilityRiskMl.DataResidualCalculationPipe, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<ReliabilityRiskMl.DataResidualCalculationPipe>, callback?: λFunction<ReliabilityRiskMl.DataResidualCalculationPipe | null, ReliabilityRiskMl.DataResidualCalculationPipe | null>): ObjList<ReliabilityRiskMl.DataResidualCalculationPipe>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<ReliabilityRiskMl.DataResidualCalculationPipe>, callback?: λFunction<ReliabilityRiskMl.DataResidualCalculationPipe | null, ReliabilityRiskMl.DataResidualCalculationPipe | null>): Array_Type<ObjError> | null;
     ...
     */
    publish(subPath?: string, contentType?: string): ReliabilityRiskMl.DataResidualCalculationPipe;
     ...
     */
    static removeSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.DataResidualCalculationPipe> | null;
     ...
     */
    createSeedData(spec?: UpsertSpec): ReliabilityRiskMl.DataResidualCalculationPipe | null;
     ...
     */
    static createSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.DataResidualCalculationPipe> | null;
     ...
     */
    updateSeedData(srcObj?: SeedData, spec?: UpsertSpec): ReliabilityRiskMl.DataResidualCalculationPipe | null;
     ...
     */
    static updateSeedDataBatch(objs?: Array_Type<SeedData>, srcObjs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.DataResidualCalculationPipe> | null;
     ...
     * @return updated obj instance, same as {@link Persistable#update} return value.
     */
    clearUserUpdates(spec?: MergeSpec): ReliabilityRiskMl.DataResidualCalculationPipe | null;
     ...
     *         {@link Persistable#updateBatch}.
     */
    static clearUserUpdatesBatch(objs?: Array_Type<SeedData>, spec?: MergeSpec): ObjList<ReliabilityRiskMl.DataResidualCalculationPipe> | null;
    ...
    dependencies(): SeedDataDeps<ReliabilityRiskMl.DataResidualCalculationPipe> | null;
     ...
     */
    static convert(model: any, spec?: MlConvertSpec): ReliabilityRiskMl.DataResidualCalculationPipe;

    /**
     * Freezes an {@link MlPipe}
     * @return modified copy of this {@link MlPipe} that cannot be trained
     */
    freeze(): ReliabilityRiskMl.DataResidualCalculationPipe;

    /**
     * Unfreezes an {@link MlPipe}
     * @return modified copy of this {@link MlPipe} that can be trained
     */
    unfreeze(): ReliabilityRiskMl.DataResidualCalculationPipe;
     ...
     * be returned as-is.
     */
    byReference(): ReliabilityRiskMl.DataResidualCalculationPipe;
     ...
     */
    updateModelFiles(modelFiles: Map_Type<string, Url>, spec?: MlOperationSpec): ReliabilityRiskMl.DataResidualCalculationPipe;
     ...
     */
    afterTrain(doTrainOutputs: any, spec?: MlOperationSpec): ReliabilityRiskMl.DataResidualCalculationPipe;
     ...
     */
    withNewSpec(spec?: MlConvertSpec): ReliabilityRiskMl.DataResidualCalculationPipe;
     ...
     */
    afterConvert(model: any, spec?: MlConvertSpec): ReliabilityRiskMl.DataResidualCalculationPipe;
     ...
     */
    withHyperparamSpaces(paramSpaces: Map_Type<string, Hp.ParamSpace>): ReliabilityRiskMl.DataResidualCalculationPipe;
