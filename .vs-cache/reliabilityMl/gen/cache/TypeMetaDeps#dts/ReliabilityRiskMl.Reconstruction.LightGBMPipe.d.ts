// TypeScript definitions for the C3 type ReliabilityRiskMl.Reconstruction.LightGBMPipe

/**
 * This type represents an {@link MlPipe} template for a LightGBM regressor. This can be used as a regressor
 * in {@link ReliabilityRiskMl.Reconstruction.ControlValvesPipe#regressor}.
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityRiskMl.Reconstruction.LightGBMPipe
 */
declare namespace ReliabilityRiskMl.Reconstruction {
  export interface ILightGBMPipe {
    ...
    /**
     * The method to use for boosting. 'gbdt' uses traditional Gradient Boosting Decision Tree. 'dart' uses Dropouts
     * meet Multiple Additive Regression Trees. 'rf' uses Random Forest.
     */
    boostingType?: string;
    ...
    /**
     * Learning rate to use for boosting
     */
    learningRate?: number;
    ...
    /**
     * Minimum amount of data needed in a child (leaf).
     */
    ...
    /**
     * Frequency of subsample, <=0 means not enabled.
     */
    ...
    /**
     * The number of jobs to run in parallel for both fit and predict. If -1, then all processors are used.
     */
    nJobs?: number;
 ...
 * in {@link ReliabilityRiskMl.Reconstruction.ControlValvesPipe#regressor}.
 *
 * @remarks this represents a made instance of ReliabilityRiskMl.Reconstruction.LightGBMPipe
 */
declare namespace ReliabilityRiskMl.Reconstruction {
  export class LightGBMPipe extends Obj  {
     ...
     */
    readonly id: string;
    withId(id: string): ReliabilityRiskMl.Reconstruction.LightGBMPipe;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityRiskMl.Reconstruction.LightGBMPipe;

    /**
     * Name of this pipe.
     */
    readonly name?: string;
    withName(name: string | null): ReliabilityRiskMl.Reconstruction.LightGBMPipe;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): ReliabilityRiskMl.Reconstruction.LightGBMPipe;
    ...
    withVersion(version: number | null): ReliabilityRiskMl.Reconstruction.LightGBMPipe;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): ReliabilityRiskMl.Reconstruction.LightGBMPipe;
    ...
    withUserUpdatedFields(userUpdatedFields: Array_Type<string> | Array<string> | null): ReliabilityRiskMl.Reconstruction.LightGBMPipe;
    ...
    withHidden(hidden: boolean): ReliabilityRiskMl.Reconstruction.LightGBMPipe;
    ...
    withUserOwned(userOwned: boolean): ReliabilityRiskMl.Reconstruction.LightGBMPipe;
    ...
    withTypeIdent(typeIdent: string | null): ReliabilityRiskMl.Reconstruction.LightGBMPipe;

    /**
     * If true, then the pipe shall not be retrained
     */
    readonly frozen?: boolean;
    withFrozen(frozen: boolean): ReliabilityRiskMl.Reconstruction.LightGBMPipe;

    /**
     * True if training has succeeded and false otherwise.
     */
    readonly trained?: boolean;
    withTrained(trained: boolean): ReliabilityRiskMl.Reconstruction.LightGBMPipe;

    /**
     * Errors from training.
     */
    readonly trainingErrors?: string;
    withTrainingErrors(trainingErrors: string | null): ReliabilityRiskMl.Reconstruction.LightGBMPipe;

    /**
     * If true, the underlying model only accepts flattened input.
     */
    readonly flattenInput?: boolean;
    withFlattenInput(flattenInput: boolean): ReliabilityRiskMl.Reconstruction.LightGBMPipe;

    /**
     * The hyperparameters overridden of a native model or pipe.
     */
    readonly hyperparamOverrides?: Map_Type<string, any>;
    withHyperparamOverrides(hyperparamOverrides: Map_Type<string, any> | {[key: string]: any} | null): ReliabilityRiskMl.Reconstruction.LightGBMPipe;
    ...
    withHyperparamSearchSpace(hyperparamSearchSpace: IHp.SearchSpace | null): ReliabilityRiskMl.Reconstruction.LightGBMPipe;
    ...
    withHpoSpec(hpoSpec: IHpo.Spec | null): ReliabilityRiskMl.Reconstruction.LightGBMPipe;

    /**
     * {@link Hpo.Experiment} stores the result of hyperparameter optimization to find the best model/pipeline.
     */
    readonly hpoExperiment?: Hpo.Experiment;
    withHpoExperiment(hpoExperiment: IHpo.Experiment | null): ReliabilityRiskMl.Reconstruction.LightGBMPipe;

    /**
     * Reference to the experiment that produced this {@link MlPipe}. For example, this could be a {@link Hpo.ExperimentBase}.
     */
    readonly experiment?: any;
    withExperiment(experiment: any | null): ReliabilityRiskMl.Reconstruction.LightGBMPipe;
    ...
    withModelFiles(modelFiles: Map_Type<string, Url> | {[key: string]: IUrl} | null): ReliabilityRiskMl.Reconstruction.LightGBMPipe;
    ...
    withCustomModelCode(customModelCode: Map_Type<string, any> | {[key: string]: any} | null): ReliabilityRiskMl.Reconstruction.LightGBMPipe;

    /**
     * Name for the function on the native model to call to do {@link MlProcessable#process}.
     */
    readonly processFunc?: string;
    withProcessFunc(processFunc: string | null): ReliabilityRiskMl.Reconstruction.LightGBMPipe;
    ...
    withUnderlyingPipe(underlyingPipe: IMlAtomicPipe<any, any, any> | null): ReliabilityRiskMl.Reconstruction.LightGBMPipe;
    ...
    withBoostingType(boostingType: string | null): ReliabilityRiskMl.Reconstruction.LightGBMPipe;

    /**
     * Maximum tree leaves for base learners
     */
    readonly numLeaves?: number;
    withNumLeaves(numLeaves: number | null): ReliabilityRiskMl.Reconstruction.LightGBMPipe;

    /**
     * Maximum tree depth for base learners, <=0 means no limit.
     */
    readonly maxDepth?: number;
    withMaxDepth(maxDepth: number | null): ReliabilityRiskMl.Reconstruction.LightGBMPipe;

    /**
     * Learning rate to use for boosting
     */
    readonly learningRate?: number;
    withLearningRate(learningRate: number | null): ReliabilityRiskMl.Reconstruction.LightGBMPipe;

    /**
     * The number of trees in the forest. Defaults to 100
     */
    readonly nEstimators?: number;
    withNEstimators(nEstimators: number | null): ReliabilityRiskMl.Reconstruction.LightGBMPipe;

    /**
     * Number of samples for constructing bins.
     */
    readonly subsampleForBin?: number;
    withSubsampleForBin(subsampleForBin: number | null): ReliabilityRiskMl.Reconstruction.LightGBMPipe;

    /**
     * Minimum loss reduction required to make a further partition on a leaf node of the tree.
     */
    readonly minSplitGain?: number;
    withMinSplitGain(minSplitGain: number | null): ReliabilityRiskMl.Reconstruction.LightGBMPipe;

    /**
     * Minimum sum of instance weight (Hessian) needed in a child (leaf).
     */
    readonly minChildWeight?: number;
    withMinChildWeight(minChildWeight: number | null): ReliabilityRiskMl.Reconstruction.LightGBMPipe;

    /**
     * Minimum amount of data needed in a child (leaf).
     */
    readonly minChildSamples?: number;
    withMinChildSamples(minChildSamples: number | null): ReliabilityRiskMl.Reconstruction.LightGBMPipe;

    /**
     * Subsample ratio of the training instance.
     */
    readonly subsample?: number;
    withSubsample(subsample: number | null): ReliabilityRiskMl.Reconstruction.LightGBMPipe;

    /**
     * Frequency of subsample, <=0 means not enabled.
     */
    readonly subsampleFreq?: number;
    withSubsampleFreq(subsampleFreq: number | null): ReliabilityRiskMl.Reconstruction.LightGBMPipe;

    /**
     * Subsample ratio of columns when constructing each tree.
     */
    readonly colsampleBytree?: number;
    withColsampleBytree(colsampleBytree: number | null): ReliabilityRiskMl.Reconstruction.LightGBMPipe;

    /**
     * L1 regularization term on weights.
     */
    readonly regAlpha?: number;
    withRegAlpha(regAlpha: number | null): ReliabilityRiskMl.Reconstruction.LightGBMPipe;

    /**
     * L2 regularization term on weights.
     */
    readonly regLambda?: number;
    withRegLambda(regLambda: number | null): ReliabilityRiskMl.Reconstruction.LightGBMPipe;

    /**
     * The seed of the pseudo random number generator that selects a random feature to update
     */
    readonly randomState?: number;
    withRandomState(randomState: number | null): ReliabilityRiskMl.Reconstruction.LightGBMPipe;

    /**
     * The number of jobs to run in parallel for both fit and predict. If -1, then all processors are used.
     */
    readonly nJobs?: number;
    withNJobs(nJobs: number | null): ReliabilityRiskMl.Reconstruction.LightGBMPipe;

    /**
     * The type of feature importance to be filled into feature_importances_
     */
    readonly importanceType?: string;
    withImportanceType(importanceType: string | null): ReliabilityRiskMl.Reconstruction.LightGBMPipe;
     ...
     * @see #toJson
     */
    static fromJson(json: any): ReliabilityRiskMl.Reconstruction.LightGBMPipe | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): ReliabilityRiskMl.Reconstruction.LightGBMPipe | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): ReliabilityRiskMl.Reconstruction.LightGBMPipe | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): ReliabilityRiskMl.Reconstruction.LightGBMPipe | null;
     ...
     */
    replaceType(old: Type, new_: Type): ReliabilityRiskMl.Reconstruction.LightGBMPipe;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityRiskMl.Reconstruction.LightGBMPipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityRiskMl.Reconstruction.LightGBMPipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityRiskMl.Reconstruction.LightGBMPipe>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityRiskMl.Reconstruction.LightGBMPipe>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityRiskMl.Reconstruction.LightGBMPipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityRiskMl.Reconstruction.LightGBMPipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityRiskMl.Reconstruction.LightGBMPipe;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): ReliabilityRiskMl.Reconstruction.LightGBMPipe;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): ReliabilityRiskMl.Reconstruction.LightGBMPipe;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityRiskMl.Reconstruction.LightGBMPipe;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityRiskMl.Reconstruction.LightGBMPipe;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityRiskMl.Reconstruction.LightGBMPipe;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): ReliabilityRiskMl.Reconstruction.LightGBMPipe;
     ...
     * @see #removeField
     */
    withoutField(field: string): ReliabilityRiskMl.Reconstruction.LightGBMPipe;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): ReliabilityRiskMl.Reconstruction.LightGBMPipe;
     ...
     */
    withoutFields(fields: Array_Type<string>): ReliabilityRiskMl.Reconstruction.LightGBMPipe;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityRiskMl.Reconstruction.LightGBMPipe;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): ReliabilityRiskMl.Reconstruction.LightGBMPipe;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityRiskMl.Reconstruction.LightGBMPipe;
     ...
     * @see #unsetField
     */
    defaultField(field: string): ReliabilityRiskMl.Reconstruction.LightGBMPipe;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): ReliabilityRiskMl.Reconstruction.LightGBMPipe;
     ...
     * @see #removeField
     */
    unsetField(field: string): ReliabilityRiskMl.Reconstruction.LightGBMPipe;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): ReliabilityRiskMl.Reconstruction.LightGBMPipe;
     ...
     * @see #unsetField
     */
    removeField(field: string): ReliabilityRiskMl.Reconstruction.LightGBMPipe;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): ReliabilityRiskMl.Reconstruction.LightGBMPipe;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityRiskMl.Reconstruction.LightGBMPipe;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityRiskMl.Reconstruction.LightGBMPipe;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityRiskMl.Reconstruction.LightGBMPipe;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityRiskMl.Reconstruction.LightGBMPipe;

    mergeJson(json: any): ReliabilityRiskMl.Reconstruction.LightGBMPipe;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityRiskMl.Reconstruction.LightGBMPipe;
     ...
     */
    sumObj(other: Obj, deep?: boolean): ReliabilityRiskMl.Reconstruction.LightGBMPipe;
     ...
     */
    singletonArray(): Array_Type<ReliabilityRiskMl.Reconstruction.LightGBMPipe>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityRiskMl.Reconstruction.LightGBMPipe> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<ReliabilityRiskMl.Reconstruction.LightGBMPipe> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<ReliabilityRiskMl.Reconstruction.LightGBMPipe>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<ReliabilityRiskMl.Reconstruction.LightGBMPipe> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, ReliabilityRiskMl.Reconstruction.LightGBMPipe> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityRiskMl.Reconstruction.LightGBMPipe> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<ReliabilityRiskMl.Reconstruction.LightGBMPipe>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<ReliabilityRiskMl.Reconstruction.LightGBMPipe>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityRiskMl.Reconstruction.LightGBMPipe;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityRiskMl.Reconstruction.LightGBMPipe;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityRiskMl.Reconstruction.LightGBMPipe;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): ReliabilityRiskMl.Reconstruction.LightGBMPipe;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityRiskMl.Reconstruction.LightGBMPipe;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): ReliabilityRiskMl.Reconstruction.LightGBMPipe;
     ...
     * @see #fromString
     */
    static make(s: string): ReliabilityRiskMl.Reconstruction.LightGBMPipe | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityRiskMl.Reconstruction.LightGBMPipe;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): ReliabilityRiskMl.Reconstruction.LightGBMPipe;
     ...
     */
    static cachedEmptyInst(): ReliabilityRiskMl.Reconstruction.LightGBMPipe;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityRiskMl.Reconstruction.LightGBMPipe> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): ReliabilityRiskMl.Reconstruction.LightGBMPipe;
     ...
     */
    remakeTemplate(): ReliabilityRiskMl.Reconstruction.LightGBMPipe;
     ...
     */
    withoutIdentity(): ReliabilityRiskMl.Reconstruction.LightGBMPipe;
     ...
     */
    trainSync(x: Data, y?: Data, spec?: MlOperationSpec): ReliabilityRiskMl.Reconstruction.LightGBMPipe;
     ...
     */
    static allCached(doNotProduceAll?: boolean): Stream<ReliabilityRiskMl.Reconstruction.LightGBMPipe> | null;
     ...
     */
    static find(filter?: string, doNotProduceAll?: boolean): Stream<ReliabilityRiskMl.Reconstruction.LightGBMPipe> | null;
     ...
     * @return existing instances of this type that satisfy filter from data cache.
     */
    static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<ReliabilityRiskMl.Reconstruction.LightGBMPipe> | null;
     ...
     * @see getCached
     */
    static findByCacheKey(key: string): ReliabilityRiskMl.Reconstruction.LightGBMPipe | null;
     ...
     * @see findByCacheKey
     */
    static forCacheKey(key: string): ReliabilityRiskMl.Reconstruction.LightGBMPipe | null;
     ...
     * @see findByCacheKey
     */
    getCached(): ReliabilityRiskMl.Reconstruction.LightGBMPipe | null;

    /**
     * @return newly produced cached instance.
     */
    refreshCache(): ReliabilityRiskMl.Reconstruction.LightGBMPipe | null;
     ...
     */
    static produce(key: string): ReliabilityRiskMl.Reconstruction.LightGBMPipe | null;
     ...
     */
    static produceAll(): Map_Type<string, ReliabilityRiskMl.Reconstruction.LightGBMPipe> | null;

    /**
     * Override for sub-types to produce all values.
     */
    static doProduceAll(): Map_Type<string, ReliabilityRiskMl.Reconstruction.LightGBMPipe> | null;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<ReliabilityRiskMl.Reconstruction.LightGBMPipe>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<ReliabilityRiskMl.Reconstruction.LightGBMPipe>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityRiskMl.Reconstruction.LightGBMPipe> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityRiskMl.Reconstruction.LightGBMPipe>> | null;
     ...
     */
    get(include?: string): ReliabilityRiskMl.Reconstruction.LightGBMPipe | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): ReliabilityRiskMl.Reconstruction.LightGBMPipe | null;
     ...
     */
    getMissing(spec: GetMissingSpec): ReliabilityRiskMl.Reconstruction.LightGBMPipe;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): ReliabilityRiskMl.Reconstruction.LightGBMPipe | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): ReliabilityRiskMl.Reconstruction.LightGBMPipe;
     ...
     * @see #toString
     */
    static fromString(s: string): ReliabilityRiskMl.Reconstruction.LightGBMPipe | null;
     ...
     */
    create(spec?: UpsertSpec): ReliabilityRiskMl.Reconstruction.LightGBMPipe | null;
     ...
     */
    static createBatch(objs: Array_Type<ReliabilityRiskMl.Reconstruction.LightGBMPipe>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Reconstruction.LightGBMPipe> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<ReliabilityRiskMl.Reconstruction.LightGBMPipe>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityRiskMl.Reconstruction.LightGBMPipe> | null;
     ...
     */
    update(srcObj?: ReliabilityRiskMl.Reconstruction.LightGBMPipe, spec?: UpsertSpec): ReliabilityRiskMl.Reconstruction.LightGBMPipe | null;
     ...
     */
    upsert(srcObj?: ReliabilityRiskMl.Reconstruction.LightGBMPipe, spec?: UpsertSpec): ReliabilityRiskMl.Reconstruction.LightGBMPipe | null;
     ...
     */
    merge(spec?: MergeSpec): ReliabilityRiskMl.Reconstruction.LightGBMPipe | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): ReliabilityRiskMl.Reconstruction.LightGBMPipe | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): ReliabilityRiskMl.Reconstruction.LightGBMPipe | null;
     ...
     */
    static updateBatch(objs: Array_Type<ReliabilityRiskMl.Reconstruction.LightGBMPipe>, srcObjs?: Array_Type<ReliabilityRiskMl.Reconstruction.LightGBMPipe>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Reconstruction.LightGBMPipe> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<ReliabilityRiskMl.Reconstruction.LightGBMPipe> | null>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Reconstruction.LightGBMPipe> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<ReliabilityRiskMl.Reconstruction.LightGBMPipe>, srcObjs?: Array_Type<ReliabilityRiskMl.Reconstruction.LightGBMPipe>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Reconstruction.LightGBMPipe> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<ReliabilityRiskMl.Reconstruction.LightGBMPipe> | null>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Reconstruction.LightGBMPipe> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<ReliabilityRiskMl.Reconstruction.LightGBMPipe>, spec?: TouchSpec): ObjList<ReliabilityRiskMl.Reconstruction.LightGBMPipe> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityRiskMl.Reconstruction.LightGBMPipe>, spec?: MergeSpec): ObjList<ReliabilityRiskMl.Reconstruction.LightGBMPipe> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityRiskMl.Reconstruction.LightGBMPipe>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityRiskMl.Reconstruction.LightGBMPipe> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<ReliabilityRiskMl.Reconstruction.LightGBMPipe> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityRiskMl.Reconstruction.LightGBMPipe> | null;
     ...
     */
    static mergeAll(mergeObj: ReliabilityRiskMl.Reconstruction.LightGBMPipe, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: ReliabilityRiskMl.Reconstruction.LightGBMPipe, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<ReliabilityRiskMl.Reconstruction.LightGBMPipe>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Reconstruction.LightGBMPipe> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<ReliabilityRiskMl.Reconstruction.LightGBMPipe>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Reconstruction.LightGBMPipe> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): ReliabilityRiskMl.Reconstruction.LightGBMPipe | null;
     ...
     */
    static beforeCreate(objs: Array_Type<ReliabilityRiskMl.Reconstruction.LightGBMPipe>): ObjList<ReliabilityRiskMl.Reconstruction.LightGBMPipe>;
     ...
     */
    static beforeUpdate(objs: Array_Type<ReliabilityRiskMl.Reconstruction.LightGBMPipe>): ObjList<ReliabilityRiskMl.Reconstruction.LightGBMPipe>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<ReliabilityRiskMl.Reconstruction.LightGBMPipe>): ObjList<ReliabilityRiskMl.Reconstruction.LightGBMPipe>;
     ...
     */
    static afterCreate(objs: Array_Type<ReliabilityRiskMl.Reconstruction.LightGBMPipe>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<ReliabilityRiskMl.Reconstruction.LightGBMPipe>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<ReliabilityRiskMl.Reconstruction.LightGBMPipe>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityRiskMl.Reconstruction.LightGBMPipe>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityRiskMl.Reconstruction.LightGBMPipe>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): ReliabilityRiskMl.Reconstruction.LightGBMPipe | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<ReliabilityRiskMl.Reconstruction.LightGBMPipe>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: ReliabilityRiskMl.Reconstruction.LightGBMPipe, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<ReliabilityRiskMl.Reconstruction.LightGBMPipe>, callback?: λFunction<ReliabilityRiskMl.Reconstruction.LightGBMPipe | null, ReliabilityRiskMl.Reconstruction.LightGBMPipe | null>): ObjList<ReliabilityRiskMl.Reconstruction.LightGBMPipe>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<ReliabilityRiskMl.Reconstruction.LightGBMPipe>, callback?: λFunction<ReliabilityRiskMl.Reconstruction.LightGBMPipe | null, ReliabilityRiskMl.Reconstruction.LightGBMPipe | null>): Array_Type<ObjError> | null;
     ...
     */
    publish(subPath?: string, contentType?: string): ReliabilityRiskMl.Reconstruction.LightGBMPipe;
     ...
     */
    static removeSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Reconstruction.LightGBMPipe> | null;
     ...
     */
    createSeedData(spec?: UpsertSpec): ReliabilityRiskMl.Reconstruction.LightGBMPipe | null;
     ...
     */
    static createSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Reconstruction.LightGBMPipe> | null;
     ...
     */
    updateSeedData(srcObj?: SeedData, spec?: UpsertSpec): ReliabilityRiskMl.Reconstruction.LightGBMPipe | null;
     ...
     */
    static updateSeedDataBatch(objs?: Array_Type<SeedData>, srcObjs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Reconstruction.LightGBMPipe> | null;
     ...
     * @return updated obj instance, same as {@link Persistable#update} return value.
     */
    clearUserUpdates(spec?: MergeSpec): ReliabilityRiskMl.Reconstruction.LightGBMPipe | null;
     ...
     *         {@link Persistable#updateBatch}.
     */
    static clearUserUpdatesBatch(objs?: Array_Type<SeedData>, spec?: MergeSpec): ObjList<ReliabilityRiskMl.Reconstruction.LightGBMPipe> | null;
    ...
    dependencies(): SeedDataDeps<ReliabilityRiskMl.Reconstruction.LightGBMPipe> | null;
     ...
     */
    static convert(model: any, spec?: MlConvertSpec): ReliabilityRiskMl.Reconstruction.LightGBMPipe;

    /**
     * Freezes an {@link MlPipe}
     * @return modified copy of this {@link MlPipe} that cannot be trained
     */
    freeze(): ReliabilityRiskMl.Reconstruction.LightGBMPipe;

    /**
     * Unfreezes an {@link MlPipe}
     * @return modified copy of this {@link MlPipe} that can be trained
     */
    unfreeze(): ReliabilityRiskMl.Reconstruction.LightGBMPipe;
     ...
     * be returned as-is.
     */
    byReference(): ReliabilityRiskMl.Reconstruction.LightGBMPipe;
     ...
     */
    updateModelFiles(modelFiles: Map_Type<string, Url>, spec?: MlOperationSpec): ReliabilityRiskMl.Reconstruction.LightGBMPipe;
     ...
     */
    afterTrain(doTrainOutputs: any, spec?: MlOperationSpec): ReliabilityRiskMl.Reconstruction.LightGBMPipe;
     ...
     */
    withNewSpec(spec?: MlConvertSpec): ReliabilityRiskMl.Reconstruction.LightGBMPipe;
     ...
     */
    afterConvert(model: any, spec?: MlConvertSpec): ReliabilityRiskMl.Reconstruction.LightGBMPipe;
     ...
     */
    withHyperparamSpaces(paramSpaces: Map_Type<string, Hp.ParamSpace>): ReliabilityRiskMl.Reconstruction.LightGBMPipe;
