// TypeScript definitions for the C3 type ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe
 */
declare namespace ReliabilityRiskMl.RiskScoreComputation {
  export interface ISigmoidWeightedComputationPipe {
     ...
     * Here, `a = 25` and `b = 2`.
     */
    sigmoidParams?: Map_Type<string, Pair<number, number>> | {[key: string]: IPair<number, number>};
  }
}
 ...
 * using a sigmoid evaluation of the corresponding sensor values in addition to the directional weights.
 *
 * @remarks this represents a made instance of ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe
 */
declare namespace ReliabilityRiskMl.RiskScoreComputation {
  export class SigmoidWeightedComputationPipe extends Obj  {
     ...
     */
    readonly id: string;
    withId(id: string): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe;

    /**
     * Name of this pipe.
     */
    readonly name?: string;
    withName(name: string | null): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe;
    ...
    withVersion(version: number | null): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe;
    ...
    withUserUpdatedFields(userUpdatedFields: Array_Type<string> | Array<string> | null): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe;
    ...
    withHidden(hidden: boolean): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe;
    ...
    withUserOwned(userOwned: boolean): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe;
    ...
    withTypeIdent(typeIdent: string | null): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe;

    /**
     * If true, then the pipe shall not be retrained
     */
    readonly frozen?: boolean;
    withFrozen(frozen: boolean): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe;

    /**
     * True if training has succeeded and false otherwise.
     */
    readonly trained?: boolean;
    withTrained(trained: boolean): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe;

    /**
     * Errors from training.
     */
    readonly trainingErrors?: string;
    withTrainingErrors(trainingErrors: string | null): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe;

    /**
     * If true, the underlying model only accepts flattened input.
     */
    readonly flattenInput?: boolean;
    withFlattenInput(flattenInput: boolean): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe;

    /**
     * The hyperparameters overridden of a native model or pipe.
     */
    readonly hyperparamOverrides?: Map_Type<string, any>;
    withHyperparamOverrides(hyperparamOverrides: Map_Type<string, any> | {[key: string]: any} | null): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe;
    ...
    withHyperparamSearchSpace(hyperparamSearchSpace: IHp.SearchSpace | null): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe;
    ...
    withHpoSpec(hpoSpec: IHpo.Spec | null): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe;

    /**
     * {@link Hpo.Experiment} stores the result of hyperparameter optimization to find the best model/pipeline.
     */
    readonly hpoExperiment?: Hpo.Experiment;
    withHpoExperiment(hpoExperiment: IHpo.Experiment | null): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe;

    /**
     * Reference to the experiment that produced this {@link MlPipe}. For example, this could be a {@link Hpo.ExperimentBase}.
     */
    readonly experiment?: any;
    withExperiment(experiment: any | null): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe;
    ...
    withModelFiles(modelFiles: Map_Type<string, Url> | {[key: string]: IUrl} | null): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe;
    ...
    withCustomModelCode(customModelCode: Map_Type<string, any> | {[key: string]: any} | null): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe;

    /**
     * Name for the function on the native model to call to do {@link MlProcessable#process}.
     */
    readonly processFunc?: string;
    withProcessFunc(processFunc: string | null): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe;
    ...
    withUnderlyingPipe(underlyingPipe: IMlAtomicPipe<any, any, any> | null): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe;
    ...
    withIsTrainableOverride(isTrainableOverride: boolean): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe;
    ...
    withLookbackDuration(lookbackDuration: IDuration | null): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe;
    ...
    withDirectionalWeights(directionalWeights: Map_Type<string, Pair<number, number>> | {[key: string]: IPair<number, number>} | null): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe;
     ...
     * Here, `a = 25` and `b = 2`.
     */
    readonly sigmoidParams?: Map_Type<string, Pair<number, number>>;
    withSigmoidParams(sigmoidParams: Map_Type<string, Pair<number, number>> | {[key: string]: IPair<number, number>} | null): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe;
     ...
     * @see #toJson
     */
    static fromJson(json: any): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe | null;
     ...
     */
    replaceType(old: Type, new_: Type): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe;
     ...
     * @see #removeField
     */
    withoutField(field: string): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe;
     ...
     */
    withoutFields(fields: Array_Type<string>): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe;
     ...
     * @see #unsetField
     */
    defaultField(field: string): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe;
     ...
     * @see #removeField
     */
    unsetField(field: string): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe;
     ...
     * @see #unsetField
     */
    removeField(field: string): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe;

    mergeJson(json: any): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe;
     ...
     */
    sumObj(other: Obj, deep?: boolean): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe;
     ...
     */
    singletonArray(): Array_Type<ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe;
     ...
     * @see #fromString
     */
    static make(s: string): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe;
     ...
     */
    static cachedEmptyInst(): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe;
     ...
     */
    remakeTemplate(): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe;
     ...
     */
    withoutIdentity(): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe;
     ...
     */
    trainSync(x: , y?: , spec?: MlOperationSpec): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe;
     ...
     */
    static allCached(doNotProduceAll?: boolean): Stream<ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe> | null;
     ...
     */
    static find(filter?: string, doNotProduceAll?: boolean): Stream<ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe> | null;
     ...
     * @return existing instances of this type that satisfy filter from data cache.
     */
    static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe> | null;
     ...
     * @see getCached
     */
    static findByCacheKey(key: string): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe | null;
     ...
     * @see findByCacheKey
     */
    static forCacheKey(key: string): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe | null;
     ...
     * @see findByCacheKey
     */
    getCached(): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe | null;

    /**
     * @return newly produced cached instance.
     */
    refreshCache(): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe | null;
     ...
     */
    static produce(key: string): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe | null;
     ...
     */
    static produceAll(): Map_Type<string, ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe> | null;

    /**
     * Override for sub-types to produce all values.
     */
    static doProduceAll(): Map_Type<string, ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe> | null;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe>> | null;
     ...
     */
    get(include?: string): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe | null;
     ...
     */
    getMissing(spec: GetMissingSpec): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe;
     ...
     * @see #toString
     */
    static fromString(s: string): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe | null;
     ...
     */
    create(spec?: UpsertSpec): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe | null;
     ...
     */
    static createBatch(objs: Array_Type<ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe> | null;
     ...
     */
    update(srcObj?: ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe, spec?: UpsertSpec): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe | null;
     ...
     */
    upsert(srcObj?: ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe, spec?: UpsertSpec): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe | null;
     ...
     */
    merge(spec?: MergeSpec): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe | null;
     ...
     */
    static updateBatch(objs: Array_Type<ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe>, srcObjs?: Array_Type<ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe> | null>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe>, srcObjs?: Array_Type<ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe> | null>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe>, spec?: TouchSpec): ObjList<ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe>, spec?: MergeSpec): ObjList<ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe> | null;
     ...
     */
    static mergeAll(mergeObj: ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe | null;
     ...
     */
    static beforeCreate(objs: Array_Type<ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe>): ObjList<ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe>;
     ...
     */
    static beforeUpdate(objs: Array_Type<ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe>): ObjList<ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe>): ObjList<ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe>;
     ...
     */
    static afterCreate(objs: Array_Type<ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe, count?: number, sendBack?: boolean): number | null;
     ...
     */
    publish(subPath?: string, contentType?: string): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe;
     ...
     */
    static removeSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe> | null;
     ...
     */
    createSeedData(spec?: UpsertSpec): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe | null;
     ...
     */
    static createSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe> | null;
     ...
     */
    updateSeedData(srcObj?: SeedData, spec?: UpsertSpec): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe | null;
     ...
     */
    static updateSeedDataBatch(objs?: Array_Type<SeedData>, srcObjs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe> | null;
     ...
     * @return updated obj instance, same as {@link Persistable#update} return value.
     */
    clearUserUpdates(spec?: MergeSpec): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe | null;
     ...
     *         {@link Persistable#updateBatch}.
     */
    static clearUserUpdatesBatch(objs?: Array_Type<SeedData>, spec?: MergeSpec): ObjList<ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe> | null;
    ...
    dependencies(): SeedDataDeps<ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe> | null;
     ...
     */
    static convert(model: any, spec?: MlConvertSpec): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe;

    /**
     * Freezes an {@link MlPipe}
     * @return modified copy of this {@link MlPipe} that cannot be trained
     */
    freeze(): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe;

    /**
     * Unfreezes an {@link MlPipe}
     * @return modified copy of this {@link MlPipe} that can be trained
     */
    unfreeze(): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe;
     ...
     * be returned as-is.
     */
    byReference(): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe;
     ...
     */
    updateModelFiles(modelFiles: Map_Type<string, Url>, spec?: MlOperationSpec): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe;
     ...
     */
    afterTrain(doTrainOutputs: any, spec?: MlOperationSpec): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe;
     ...
     */
    withNewSpec(spec?: MlConvertSpec): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe;
     ...
     */
    afterConvert(model: any, spec?: MlConvertSpec): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe;
     ...
     */
    withHyperparamSpaces(paramSpaces: Map_Type<string, Hp.ParamSpace>): ReliabilityRiskMl.RiskScoreComputation.SigmoidWeightedComputationPipe;
