// TypeScript definitions for the C3 type ReliabilityMl.CustomPopulationPipeFactory

/**
 * {@link ReliabilityMl.CustomPopulationPipeFactory} is an extension of the {@link ReliabilityMl.CustomPipeFactory}
 * that is designed to handle the creation and management of custom pipelines for a population of {@link ReliabilityAsset}s.
 * This factory is responsible for generating pipelines that operate on data from multiple assets, combining them to create
 * a unified dataset for training, inference, or other purposes.
 *
 * It can be used in scenarios where the processing logic needs to handle a group of assets.
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityMl.CustomPopulationPipeFactory
 */
declare namespace ReliabilityMl {
  export interface ICustomPopulationPipeFactory {
    ...
    /**
     * The {@link File} object which contains the python class implementation of the
     * algorithm.
     */
    file: IFile;

    /**
     * The {@link file} may contain many classes as part of its internal implementation detail.
     * However, there still is a single class which contains the overall logic of the algorithm.
     * This field defines the name of that python class.
     */
    className: string;

    /**
     * Defines all the named arguments to the `__init__` function of the python class defined
     * by {@link className}.
     */
    classKwargs?: Array_Type<ReliabilityMl.CustomPipeKwarg> | Array<IReliabilityMl.CustomPipeKwarg>;

    /**
     * The contents of the {@link file} must be run in a runtime / conda environment appropriate to
     * the execution requirements of the algorithm. Define the {@link Action.Requirement} in this field.
     */
    actionRequirement: string;

    /**
     * Defines additional metadata for the instantiation of the {@link ReliabilityMl.CustomPipe}.
     */
    convertSpec?: IMlConvertSpec;

    /**
     * If the class(es) in the python {@link file} either inherit from or employ the use of other
     * factory implementations, define those dependencies in this field. All the python class names
     * defined here MUST be instances of {@link ReliabilityMl.CustomPipeFactory}.
     */
    inheritsFrom?: Array_Type<string> | Array<string>;

    /**
     * The `childFactory` refers to a specific instance of {@link ReliabilityMl.CustomPipeFactory} that is used to create
     * individual custom pipes for the assets in the population.
     */
    childFactory: IReliabilityMl.CustomPipeFactory;
  }
}
 ...
 * It can be used in scenarios where the processing logic needs to handle a group of assets.
 *
 * @remarks this represents a made instance of ReliabilityMl.CustomPopulationPipeFactory
 */
declare namespace ReliabilityMl {
  export class CustomPopulationPipeFactory extends Obj  {
    ...
    withTypeIdent(typeIdent: string | null): ReliabilityMl.CustomPopulationPipeFactory;
     ...
     */
    readonly id: string;
    withId(id: string): ReliabilityMl.CustomPopulationPipeFactory;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityMl.CustomPopulationPipeFactory;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): ReliabilityMl.CustomPopulationPipeFactory;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): ReliabilityMl.CustomPopulationPipeFactory;
    ...
    withVersion(version: number | null): ReliabilityMl.CustomPopulationPipeFactory;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): ReliabilityMl.CustomPopulationPipeFactory;
     ...
     */
    readonly file: File;
    withFile(file: IFile): ReliabilityMl.CustomPopulationPipeFactory;
    ...
    withClassName(className: string): ReliabilityMl.CustomPopulationPipeFactory;
    ...
    withClassKwargs(classKwargs: Array_Type<ReliabilityMl.CustomPipeKwarg> | Array<IReliabilityMl.CustomPipeKwarg> | null): ReliabilityMl.CustomPopulationPipeFactory;
    ...
    withActionRequirement(actionRequirement: string): ReliabilityMl.CustomPopulationPipeFactory;

    /**
     * Defines additional metadata for the instantiation of the {@link ReliabilityMl.CustomPipe}.
     */
    readonly convertSpec?: MlConvertSpec;
    withConvertSpec(convertSpec: IMlConvertSpec | null): ReliabilityMl.CustomPopulationPipeFactory;
    ...
    withInheritsFrom(inheritsFrom: Array_Type<string> | Array<string> | null): ReliabilityMl.CustomPopulationPipeFactory;

    /**
     * The `childFactory` refers to a specific instance of {@link ReliabilityMl.CustomPipeFactory} that is used to create
     * individual custom pipes for the assets in the population.
     */
    readonly childFactory: ReliabilityMl.CustomPipeFactory;
    withChildFactory(childFactory: IReliabilityMl.CustomPipeFactory): ReliabilityMl.CustomPopulationPipeFactory;
     ...
     * @see #toJson
     */
    static fromJson(json: any): ReliabilityMl.CustomPopulationPipeFactory | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): ReliabilityMl.CustomPopulationPipeFactory | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): ReliabilityMl.CustomPopulationPipeFactory | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): ReliabilityMl.CustomPopulationPipeFactory | null;
     ...
     */
    replaceType(old: Type, new_: Type): ReliabilityMl.CustomPopulationPipeFactory;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityMl.CustomPopulationPipeFactory;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityMl.CustomPopulationPipeFactory;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityMl.CustomPopulationPipeFactory>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityMl.CustomPopulationPipeFactory>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityMl.CustomPopulationPipeFactory;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityMl.CustomPopulationPipeFactory;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityMl.CustomPopulationPipeFactory;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): ReliabilityMl.CustomPopulationPipeFactory;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): ReliabilityMl.CustomPopulationPipeFactory;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityMl.CustomPopulationPipeFactory;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityMl.CustomPopulationPipeFactory;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityMl.CustomPopulationPipeFactory;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): ReliabilityMl.CustomPopulationPipeFactory;
     ...
     * @see #removeField
     */
    withoutField(field: string): ReliabilityMl.CustomPopulationPipeFactory;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): ReliabilityMl.CustomPopulationPipeFactory;
     ...
     */
    withoutFields(fields: Array_Type<string>): ReliabilityMl.CustomPopulationPipeFactory;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityMl.CustomPopulationPipeFactory;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): ReliabilityMl.CustomPopulationPipeFactory;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityMl.CustomPopulationPipeFactory;
     ...
     * @see #unsetField
     */
    defaultField(field: string): ReliabilityMl.CustomPopulationPipeFactory;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): ReliabilityMl.CustomPopulationPipeFactory;
     ...
     * @see #removeField
     */
    unsetField(field: string): ReliabilityMl.CustomPopulationPipeFactory;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): ReliabilityMl.CustomPopulationPipeFactory;
     ...
     * @see #unsetField
     */
    removeField(field: string): ReliabilityMl.CustomPopulationPipeFactory;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): ReliabilityMl.CustomPopulationPipeFactory;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityMl.CustomPopulationPipeFactory;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityMl.CustomPopulationPipeFactory;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityMl.CustomPopulationPipeFactory;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityMl.CustomPopulationPipeFactory;

    mergeJson(json: any): ReliabilityMl.CustomPopulationPipeFactory;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityMl.CustomPopulationPipeFactory;
     ...
     */
    sumObj(other: Obj, deep?: boolean): ReliabilityMl.CustomPopulationPipeFactory;
     ...
     */
    singletonArray(): Array_Type<ReliabilityMl.CustomPopulationPipeFactory>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityMl.CustomPopulationPipeFactory> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<ReliabilityMl.CustomPopulationPipeFactory> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<ReliabilityMl.CustomPopulationPipeFactory>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<ReliabilityMl.CustomPopulationPipeFactory> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, ReliabilityMl.CustomPopulationPipeFactory> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityMl.CustomPopulationPipeFactory> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<ReliabilityMl.CustomPopulationPipeFactory>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<ReliabilityMl.CustomPopulationPipeFactory>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityMl.CustomPopulationPipeFactory;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityMl.CustomPopulationPipeFactory;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityMl.CustomPopulationPipeFactory;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): ReliabilityMl.CustomPopulationPipeFactory;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityMl.CustomPopulationPipeFactory;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): ReliabilityMl.CustomPopulationPipeFactory;
     ...
     * @see #fromString
     */
    static make(s: string): ReliabilityMl.CustomPopulationPipeFactory | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityMl.CustomPopulationPipeFactory;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): ReliabilityMl.CustomPopulationPipeFactory;
     ...
     */
    static cachedEmptyInst(): ReliabilityMl.CustomPopulationPipeFactory;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityMl.CustomPopulationPipeFactory> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): ReliabilityMl.CustomPopulationPipeFactory;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<ReliabilityMl.CustomPopulationPipeFactory>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<ReliabilityMl.CustomPopulationPipeFactory>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityMl.CustomPopulationPipeFactory> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityMl.CustomPopulationPipeFactory>> | null;
     ...
     */
    get(include?: string): ReliabilityMl.CustomPopulationPipeFactory | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): ReliabilityMl.CustomPopulationPipeFactory | null;
     ...
     */
    getMissing(spec: GetMissingSpec): ReliabilityMl.CustomPopulationPipeFactory;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): ReliabilityMl.CustomPopulationPipeFactory | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): ReliabilityMl.CustomPopulationPipeFactory;
     ...
     * @see #toString
     */
    static fromString(s: string): ReliabilityMl.CustomPopulationPipeFactory | null;
     ...
     */
    create(spec?: UpsertSpec): ReliabilityMl.CustomPopulationPipeFactory | null;
     ...
     */
    static createBatch(objs: Array_Type<ReliabilityMl.CustomPopulationPipeFactory>, spec?: UpsertSpec): ObjList<ReliabilityMl.CustomPopulationPipeFactory> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<ReliabilityMl.CustomPopulationPipeFactory>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityMl.CustomPopulationPipeFactory> | null;
     ...
     */
    update(srcObj?: ReliabilityMl.CustomPopulationPipeFactory, spec?: UpsertSpec): ReliabilityMl.CustomPopulationPipeFactory | null;
     ...
     */
    upsert(srcObj?: ReliabilityMl.CustomPopulationPipeFactory, spec?: UpsertSpec): ReliabilityMl.CustomPopulationPipeFactory | null;
     ...
     */
    merge(spec?: MergeSpec): ReliabilityMl.CustomPopulationPipeFactory | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): ReliabilityMl.CustomPopulationPipeFactory | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): ReliabilityMl.CustomPopulationPipeFactory | null;
     ...
     */
    static updateBatch(objs: Array_Type<ReliabilityMl.CustomPopulationPipeFactory>, srcObjs?: Array_Type<ReliabilityMl.CustomPopulationPipeFactory>, spec?: UpsertSpec): ObjList<ReliabilityMl.CustomPopulationPipeFactory> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<ReliabilityMl.CustomPopulationPipeFactory> | null>, spec?: UpsertSpec): ObjList<ReliabilityMl.CustomPopulationPipeFactory> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<ReliabilityMl.CustomPopulationPipeFactory>, srcObjs?: Array_Type<ReliabilityMl.CustomPopulationPipeFactory>, spec?: UpsertSpec): ObjList<ReliabilityMl.CustomPopulationPipeFactory> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<ReliabilityMl.CustomPopulationPipeFactory> | null>, spec?: UpsertSpec): ObjList<ReliabilityMl.CustomPopulationPipeFactory> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<ReliabilityMl.CustomPopulationPipeFactory>, spec?: TouchSpec): ObjList<ReliabilityMl.CustomPopulationPipeFactory> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityMl.CustomPopulationPipeFactory>, spec?: MergeSpec): ObjList<ReliabilityMl.CustomPopulationPipeFactory> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityMl.CustomPopulationPipeFactory>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityMl.CustomPopulationPipeFactory> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<ReliabilityMl.CustomPopulationPipeFactory> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityMl.CustomPopulationPipeFactory> | null;
     ...
     */
    static mergeAll(mergeObj: ReliabilityMl.CustomPopulationPipeFactory, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: ReliabilityMl.CustomPopulationPipeFactory, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<ReliabilityMl.CustomPopulationPipeFactory>, spec?: UpsertSpec): ObjList<ReliabilityMl.CustomPopulationPipeFactory> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<ReliabilityMl.CustomPopulationPipeFactory>, spec?: UpsertSpec): ObjList<ReliabilityMl.CustomPopulationPipeFactory> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): ReliabilityMl.CustomPopulationPipeFactory | null;
    ...
    /**
     * The `beforeCreate` function is invoked before the creation of the custom pipeline. It provides a point where
     * pre-processing or validation steps can be performed prior to the pipeline's initialization.
     */
    static beforeCreate(objs: Array_Type<ReliabilityMl.CustomPopulationPipeFactory>): ObjList<ReliabilityMl.CustomPopulationPipeFactory>;
     ...
     */
    static beforeUpdate(objs: Array_Type<ReliabilityMl.CustomPopulationPipeFactory>): ObjList<ReliabilityMl.CustomPopulationPipeFactory>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<ReliabilityMl.CustomPopulationPipeFactory>): ObjList<ReliabilityMl.CustomPopulationPipeFactory>;
     ...
     */
    static afterCreate(objs: Array_Type<ReliabilityMl.CustomPopulationPipeFactory>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<ReliabilityMl.CustomPopulationPipeFactory>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<ReliabilityMl.CustomPopulationPipeFactory>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityMl.CustomPopulationPipeFactory>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityMl.CustomPopulationPipeFactory>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): ReliabilityMl.CustomPopulationPipeFactory | null;
     ...
     */
    withoutIdentity(): ReliabilityMl.CustomPopulationPipeFactory | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<ReliabilityMl.CustomPopulationPipeFactory>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: ReliabilityMl.CustomPopulationPipeFactory, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<ReliabilityMl.CustomPopulationPipeFactory>, callback?: λFunction<ReliabilityMl.CustomPopulationPipeFactory | null, ReliabilityMl.CustomPopulationPipeFactory | null>): ObjList<ReliabilityMl.CustomPopulationPipeFactory>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<ReliabilityMl.CustomPopulationPipeFactory>, callback?: λFunction<ReliabilityMl.CustomPopulationPipeFactory | null, ReliabilityMl.CustomPopulationPipeFactory | null>): Array_Type<ObjError> | null;
    ...
    /**
     * The `initializePipe` function is used to initialize the custom pipeline after its creation.
     * It ensures that the pipeline is fully prepared and ready to process data.
     */
    initializePipe(): ReliabilityMl.CustomPipe<any, any, any>;

    /**
     * Helper function to list all the factory/template implementations defined by either
     * the C3 AI Reliability as out of the box algorithms or the additional implementations
     * custom-defined in a deployment.
     */
    static listPublished(): Array_Type<string> | null;
  }
}
