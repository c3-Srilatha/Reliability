// TypeScript definitions for the C3 type ReliabilityTteForecastPredictionHeader

/**
 * A series keeping track of the "time series" predictions made for a {@link MlSubject} by a {@link MlModel}.
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityTteForecastPredictionHeader
 */
declare interface IReliabilityTteForecastPredictionHeader {
   ...
   */
  data?: Array_Type<ReliabilityTteForecastPrediction> | Array<IReliabilityTteForecastPrediction>;
 ...
 */
declare class ReliabilityTteForecastPredictionHeader extends Obj  {

  /**
   * Populated on normalization. Indicates the earliest data point across various timeseries fields.
   */
  readonly earliest?: DateTime;
  withEarliest(earliest: DateTime | Date | string | null): ReliabilityTteForecastPredictionHeader;

  /**
   * Populated on normalization. Indicates the latest data point across various timeseries fields.
   */
  readonly latest?: DateTime;
  withLatest(latest: DateTime | Date | string | null): ReliabilityTteForecastPredictionHeader;

  /**
   * Populated on normalization. Indicates the earliest data point for each {@link Ann.Ts} fields.
   */
  readonly earliestTsDp?: Map_Type<string, TSDataPoint>;
  withEarliestTsDp(earliestTsDp: Map_Type<string, TSDataPoint> | {[key: string]: ITSDataPoint} | null): ReliabilityTteForecastPredictionHeader;

  /**
   * Populated on normalization. Indicates the latest data point for each {@link Ann.Ts} fields.
   */
  readonly latestTsDp?: Map_Type<string, TSDataPoint>;
  withLatestTsDp(latestTsDp: Map_Type<string, TSDataPoint> | {[key: string]: ITSDataPoint} | null): ReliabilityTteForecastPredictionHeader;
  ...
  withInterval(interval: string | null): ReliabilityTteForecastPredictionHeader;
  ...
  withTimeZone(timeZone: string | null): ReliabilityTteForecastPredictionHeader;

  /**
   * If set, disables normalizing this time series. Invalidations will still continue to happen for this series normally.
   */
  readonly doNotNormalize?: boolean;
  withDoNotNormalize(doNotNormalize: boolean): ReliabilityTteForecastPredictionHeader;

  /**
   * Data points corresponding to this timeseries header
   */
  readonly data?: Array_Type<ReliabilityTteForecastPrediction>;
  withData(data: Array_Type<ReliabilityTteForecastPrediction> | Array<IReliabilityTteForecastPrediction> | null): ReliabilityTteForecastPredictionHeader;

  /**
   * Use this field to specify the interpolation mechanism to be applied for gaps in interval timeseries. Default: `ZERO_INTERPOLATOR`.
   */
  readonly interpolator?: string;
  withInterpolator(interpolator: string | null): ReliabilityTteForecastPredictionHeader;

  /**
   * Use this field to specify how normalization should handle duplicate data points. A duplicate point is one that has the same start, end, value, unit, and {@link TimedDataPointFields#isEstimated} values. Default: `IGNORE`.
   */
  readonly duplicateHandling?: string;
  withDuplicateHandling(duplicateHandling: string | null): ReliabilityTteForecastPredictionHeader;

  /**
   * Used to specify how normalization should handle overlapping data points. Default: `AVG`.
   */
  readonly overlapHandling?: string;
  withOverlapHandling(overlapHandling: string | null): ReliabilityTteForecastPredictionHeader;
  ...
  withBucketInterval(bucketInterval: string | null): ReliabilityTteForecastPredictionHeader;
  ...
  withNormalizationPartitionStrategy(normalizationPartitionStrategy: INormalizationPartitionStrategy | null): ReliabilityTteForecastPredictionHeader;

  /**
   * Indicates whether the last data point should be repeated until infinity
   */
  readonly extrapolate?: boolean;
  withExtrapolate(extrapolate: boolean): ReliabilityTteForecastPredictionHeader;
  ...
  withTypeIdent(typeIdent: string | null): ReliabilityTteForecastPredictionHeader;
   ...
   */
  readonly id: string;
  withId(id: string): ReliabilityTteForecastPredictionHeader;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityTteForecastPredictionHeader;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): ReliabilityTteForecastPredictionHeader;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): ReliabilityTteForecastPredictionHeader;
  ...
  withVersion(version: number | null): ReliabilityTteForecastPredictionHeader;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): ReliabilityTteForecastPredictionHeader;

  /**
   * The subject-model association related to this series header.
   */
  readonly parent: ReliabilityAssetToTteModelRelation;
  withParent(parent: IReliabilityAssetToTteModelRelation): ReliabilityTteForecastPredictionHeader;

  /**
   * The treatment to use for the timeseries.
   */
  readonly treatment?: string;
  withTreatment(treatment: string | null): ReliabilityTteForecastPredictionHeader;
   ...
   * @see #toJson
   */
  static fromJson(json: any): ReliabilityTteForecastPredictionHeader | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): ReliabilityTteForecastPredictionHeader | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): ReliabilityTteForecastPredictionHeader | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): ReliabilityTteForecastPredictionHeader | null;
   ...
   */
  replaceType(old: Type, new_: Type): ReliabilityTteForecastPredictionHeader;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityTteForecastPredictionHeader;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityTteForecastPredictionHeader;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityTteForecastPredictionHeader>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityTteForecastPredictionHeader>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityTteForecastPredictionHeader;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityTteForecastPredictionHeader;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityTteForecastPredictionHeader;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ReliabilityTteForecastPredictionHeader;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ReliabilityTteForecastPredictionHeader;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityTteForecastPredictionHeader;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityTteForecastPredictionHeader;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityTteForecastPredictionHeader;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ReliabilityTteForecastPredictionHeader;
   ...
   * @see #removeField
   */
  withoutField(field: string): ReliabilityTteForecastPredictionHeader;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): ReliabilityTteForecastPredictionHeader;
   ...
   */
  withoutFields(fields: Array_Type<string>): ReliabilityTteForecastPredictionHeader;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityTteForecastPredictionHeader;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ReliabilityTteForecastPredictionHeader;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityTteForecastPredictionHeader;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ReliabilityTteForecastPredictionHeader;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ReliabilityTteForecastPredictionHeader;
   ...
   * @see #removeField
   */
  unsetField(field: string): ReliabilityTteForecastPredictionHeader;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ReliabilityTteForecastPredictionHeader;
   ...
   * @see #unsetField
   */
  removeField(field: string): ReliabilityTteForecastPredictionHeader;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ReliabilityTteForecastPredictionHeader;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityTteForecastPredictionHeader;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityTteForecastPredictionHeader;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityTteForecastPredictionHeader;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityTteForecastPredictionHeader;

  mergeJson(json: any): ReliabilityTteForecastPredictionHeader;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityTteForecastPredictionHeader;
   ...
   */
  sumObj(other: Obj, deep?: boolean): ReliabilityTteForecastPredictionHeader;
   ...
   */
  singletonArray(): Array_Type<ReliabilityTteForecastPredictionHeader>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityTteForecastPredictionHeader> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ReliabilityTteForecastPredictionHeader> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<ReliabilityTteForecastPredictionHeader>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ReliabilityTteForecastPredictionHeader> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, ReliabilityTteForecastPredictionHeader> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityTteForecastPredictionHeader> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ReliabilityTteForecastPredictionHeader>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ReliabilityTteForecastPredictionHeader>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityTteForecastPredictionHeader;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityTteForecastPredictionHeader;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityTteForecastPredictionHeader;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ReliabilityTteForecastPredictionHeader;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityTteForecastPredictionHeader;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ReliabilityTteForecastPredictionHeader;
   ...
   * @see #fromString
   */
  static make(s: string): ReliabilityTteForecastPredictionHeader | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityTteForecastPredictionHeader;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): ReliabilityTteForecastPredictionHeader;
   ...
   */
  static cachedEmptyInst(): ReliabilityTteForecastPredictionHeader;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityTteForecastPredictionHeader> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): ReliabilityTteForecastPredictionHeader;
   ...
   */
  static normalizeTimeseries(timeseries?: TimedDataFields<ReliabilityTteForecastPrediction>, start?: DateTime, end?: DateTime, overrideGrain?: string, forceGrainDetection?: boolean, force?: boolean): void;
   ...
   */
  static normalize(timeseries?: TimedDataFields<ReliabilityTteForecastPrediction>, start?: DateTime, end?: DateTime, overrideGrain?: string, forceGrainDetection?: boolean): NormalizationResult | null;
   ...
   */
  static normalizationUnit(rawHeader: TimedDataFields<ReliabilityTteForecastPrediction>, tsField: string): Unit | null;
   ...
   */
  static normalizationTreatment(rawHeader: TimedDataFields<ReliabilityTteForecastPrediction>, tsField: string): string;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<ReliabilityTteForecastPredictionHeader>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<ReliabilityTteForecastPredictionHeader>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityTteForecastPredictionHeader> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityTteForecastPredictionHeader>> | null;
   ...
   */
  get(include?: string): ReliabilityTteForecastPredictionHeader | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): ReliabilityTteForecastPredictionHeader | null;
   ...
   */
  getMissing(spec: GetMissingSpec): ReliabilityTteForecastPredictionHeader;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): ReliabilityTteForecastPredictionHeader | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): ReliabilityTteForecastPredictionHeader;
   ...
   * @see #toString
   */
  static fromString(s: string): ReliabilityTteForecastPredictionHeader | null;
   ...
   */
  create(spec?: UpsertSpec): ReliabilityTteForecastPredictionHeader | null;
   ...
   */
  static createBatch(objs: Array_Type<ReliabilityTteForecastPredictionHeader>, spec?: UpsertSpec): ObjList<ReliabilityTteForecastPredictionHeader> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<ReliabilityTteForecastPredictionHeader>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityTteForecastPredictionHeader> | null;
   ...
   */
  update(srcObj?: ReliabilityTteForecastPredictionHeader, spec?: UpsertSpec): ReliabilityTteForecastPredictionHeader | null;
   ...
   */
  upsert(srcObj?: ReliabilityTteForecastPredictionHeader, spec?: UpsertSpec): ReliabilityTteForecastPredictionHeader | null;
   ...
   */
  merge(spec?: MergeSpec): ReliabilityTteForecastPredictionHeader | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): ReliabilityTteForecastPredictionHeader | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): ReliabilityTteForecastPredictionHeader | null;
   ...
   */
  static updateBatch(objs: Array_Type<ReliabilityTteForecastPredictionHeader>, srcObjs?: Array_Type<ReliabilityTteForecastPredictionHeader>, spec?: UpsertSpec): ObjList<ReliabilityTteForecastPredictionHeader> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<ReliabilityTteForecastPredictionHeader> | null>, spec?: UpsertSpec): ObjList<ReliabilityTteForecastPredictionHeader> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<ReliabilityTteForecastPredictionHeader>, srcObjs?: Array_Type<ReliabilityTteForecastPredictionHeader>, spec?: UpsertSpec): ObjList<ReliabilityTteForecastPredictionHeader> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<ReliabilityTteForecastPredictionHeader> | null>, spec?: UpsertSpec): ObjList<ReliabilityTteForecastPredictionHeader> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<ReliabilityTteForecastPredictionHeader>, spec?: TouchSpec): ObjList<ReliabilityTteForecastPredictionHeader> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityTteForecastPredictionHeader>, spec?: MergeSpec): ObjList<ReliabilityTteForecastPredictionHeader> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityTteForecastPredictionHeader>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityTteForecastPredictionHeader> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<ReliabilityTteForecastPredictionHeader> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityTteForecastPredictionHeader> | null;
   ...
   */
  static mergeAll(mergeObj: ReliabilityTteForecastPredictionHeader, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: ReliabilityTteForecastPredictionHeader, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<ReliabilityTteForecastPredictionHeader>, spec?: UpsertSpec): ObjList<ReliabilityTteForecastPredictionHeader> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<ReliabilityTteForecastPredictionHeader>, spec?: UpsertSpec): ObjList<ReliabilityTteForecastPredictionHeader> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): ReliabilityTteForecastPredictionHeader | null;
   ...
   */
  static beforeCreate(objs: Array_Type<ReliabilityTteForecastPredictionHeader>): ObjList<ReliabilityTteForecastPredictionHeader>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<ReliabilityTteForecastPredictionHeader>): ObjList<ReliabilityTteForecastPredictionHeader>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<ReliabilityTteForecastPredictionHeader>): ObjList<ReliabilityTteForecastPredictionHeader>;
   ...
   */
  static afterCreate(objs: Array_Type<ReliabilityTteForecastPredictionHeader>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<ReliabilityTteForecastPredictionHeader>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<ReliabilityTteForecastPredictionHeader>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityTteForecastPredictionHeader>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityTteForecastPredictionHeader>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): ReliabilityTteForecastPredictionHeader | null;
   ...
   */
  withoutIdentity(): ReliabilityTteForecastPredictionHeader | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<ReliabilityTteForecastPredictionHeader>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: ReliabilityTteForecastPredictionHeader, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<ReliabilityTteForecastPredictionHeader>, callback?: λFunction<ReliabilityTteForecastPredictionHeader | null, ReliabilityTteForecastPredictionHeader | null>): ObjList<ReliabilityTteForecastPredictionHeader>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<ReliabilityTteForecastPredictionHeader>, callback?: λFunction<ReliabilityTteForecastPredictionHeader | null, ReliabilityTteForecastPredictionHeader | null>): Array_Type<ObjError> | null;
