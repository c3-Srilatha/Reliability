// TypeScript definitions for the C3 type ReliabilityRiskMl.Reconstruction.TranAdPipe

/**
 * This type represents an {@link MlPipe} template for a PyTorch-based transformer model.
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityRiskMl.Reconstruction.TranAdPipe
 */
declare namespace ReliabilityRiskMl.Reconstruction {
  export interface ITranAdPipe {
 ...
 * This type represents an {@link MlPipe} template for a PyTorch-based transformer model.
 *
 * @remarks this represents a made instance of ReliabilityRiskMl.Reconstruction.TranAdPipe
 */
declare namespace ReliabilityRiskMl.Reconstruction {
  export class TranAdPipe extends Obj  {
     ...
     */
    readonly id: string;
    withId(id: string): ReliabilityRiskMl.Reconstruction.TranAdPipe;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityRiskMl.Reconstruction.TranAdPipe;

    /**
     * Name of this pipe.
     */
    readonly name?: string;
    withName(name: string | null): ReliabilityRiskMl.Reconstruction.TranAdPipe;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): ReliabilityRiskMl.Reconstruction.TranAdPipe;
    ...
    withVersion(version: number | null): ReliabilityRiskMl.Reconstruction.TranAdPipe;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): ReliabilityRiskMl.Reconstruction.TranAdPipe;
    ...
    withUserUpdatedFields(userUpdatedFields: Array_Type<string> | Array<string> | null): ReliabilityRiskMl.Reconstruction.TranAdPipe;
    ...
    withHidden(hidden: boolean): ReliabilityRiskMl.Reconstruction.TranAdPipe;
    ...
    withUserOwned(userOwned: boolean): ReliabilityRiskMl.Reconstruction.TranAdPipe;
    ...
    withTypeIdent(typeIdent: string | null): ReliabilityRiskMl.Reconstruction.TranAdPipe;

    /**
     * If true, then the pipe shall not be retrained
     */
    readonly frozen?: boolean;
    withFrozen(frozen: boolean): ReliabilityRiskMl.Reconstruction.TranAdPipe;

    /**
     * True if training has succeeded and false otherwise.
     */
    readonly trained?: boolean;
    withTrained(trained: boolean): ReliabilityRiskMl.Reconstruction.TranAdPipe;

    /**
     * Errors from training.
     */
    readonly trainingErrors?: string;
    withTrainingErrors(trainingErrors: string | null): ReliabilityRiskMl.Reconstruction.TranAdPipe;

    /**
     * If true, the underlying model only accepts flattened input.
     */
    readonly flattenInput?: boolean;
    withFlattenInput(flattenInput: boolean): ReliabilityRiskMl.Reconstruction.TranAdPipe;

    /**
     * The hyperparameters overridden of a native model or pipe.
     */
    readonly hyperparamOverrides?: Map_Type<string, any>;
    withHyperparamOverrides(hyperparamOverrides: Map_Type<string, any> | {[key: string]: any} | null): ReliabilityRiskMl.Reconstruction.TranAdPipe;
    ...
    withHyperparamSearchSpace(hyperparamSearchSpace: IHp.SearchSpace | null): ReliabilityRiskMl.Reconstruction.TranAdPipe;
    ...
    withHpoSpec(hpoSpec: IHpo.Spec | null): ReliabilityRiskMl.Reconstruction.TranAdPipe;

    /**
     * {@link Hpo.Experiment} stores the result of hyperparameter optimization to find the best model/pipeline.
     */
    readonly hpoExperiment?: Hpo.Experiment;
    withHpoExperiment(hpoExperiment: IHpo.Experiment | null): ReliabilityRiskMl.Reconstruction.TranAdPipe;

    /**
     * Reference to the experiment that produced this {@link MlPipe}. For example, this could be a {@link Hpo.ExperimentBase}.
     */
    readonly experiment?: any;
    withExperiment(experiment: any | null): ReliabilityRiskMl.Reconstruction.TranAdPipe;
    ...
    withModelFiles(modelFiles: Map_Type<string, Url> | {[key: string]: IUrl} | null): ReliabilityRiskMl.Reconstruction.TranAdPipe;
    ...
    withCustomModelCode(customModelCode: Map_Type<string, any> | {[key: string]: any} | null): ReliabilityRiskMl.Reconstruction.TranAdPipe;

    /**
     * Name for the function on the native model to call to do {@link MlProcessable#process}.
     */
    readonly processFunc?: string;
    withProcessFunc(processFunc: string | null): ReliabilityRiskMl.Reconstruction.TranAdPipe;
    ...
    withUnderlyingPipe(underlyingPipe: IMlAtomicPipe<any, any, any> | null): ReliabilityRiskMl.Reconstruction.TranAdPipe;
    ...
    withLookbackDuration(lookbackDuration: IDuration | null): ReliabilityRiskMl.Reconstruction.TranAdPipe;

    /**
     * Training epochs
     */
    readonly epochs: number;
    withEpochs(epochs: number): ReliabilityRiskMl.Reconstruction.TranAdPipe;

    /**
     * Training batch size
     */
    readonly batchSize: number;
    withBatchSize(batchSize: number): ReliabilityRiskMl.Reconstruction.TranAdPipe;

    /**
     * Number of features
     */
    readonly numFeatures: number;
    withNumFeatures(numFeatures: number): ReliabilityRiskMl.Reconstruction.TranAdPipe;

    /**
     * Size of time window in the input of the autoencoder.
     */
    readonly windowSize: number;
    withWindowSize(windowSize: number): ReliabilityRiskMl.Reconstruction.TranAdPipe;
    ...
    withLearningRateOverride(learningRateOverride: number | null): ReliabilityRiskMl.Reconstruction.TranAdPipe;

    /**
     * Random seed used during model training. Use the same number for reproducible training results.
     */
    readonly randomSeed?: number;
    withRandomSeed(randomSeed: number | null): ReliabilityRiskMl.Reconstruction.TranAdPipe;
     ...
     * @see #toJson
     */
    static fromJson(json: any): ReliabilityRiskMl.Reconstruction.TranAdPipe | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): ReliabilityRiskMl.Reconstruction.TranAdPipe | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): ReliabilityRiskMl.Reconstruction.TranAdPipe | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): ReliabilityRiskMl.Reconstruction.TranAdPipe | null;
     ...
     */
    replaceType(old: Type, new_: Type): ReliabilityRiskMl.Reconstruction.TranAdPipe;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityRiskMl.Reconstruction.TranAdPipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityRiskMl.Reconstruction.TranAdPipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityRiskMl.Reconstruction.TranAdPipe>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityRiskMl.Reconstruction.TranAdPipe>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityRiskMl.Reconstruction.TranAdPipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityRiskMl.Reconstruction.TranAdPipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityRiskMl.Reconstruction.TranAdPipe;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): ReliabilityRiskMl.Reconstruction.TranAdPipe;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): ReliabilityRiskMl.Reconstruction.TranAdPipe;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityRiskMl.Reconstruction.TranAdPipe;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityRiskMl.Reconstruction.TranAdPipe;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityRiskMl.Reconstruction.TranAdPipe;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): ReliabilityRiskMl.Reconstruction.TranAdPipe;
     ...
     * @see #removeField
     */
    withoutField(field: string): ReliabilityRiskMl.Reconstruction.TranAdPipe;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): ReliabilityRiskMl.Reconstruction.TranAdPipe;
     ...
     */
    withoutFields(fields: Array_Type<string>): ReliabilityRiskMl.Reconstruction.TranAdPipe;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityRiskMl.Reconstruction.TranAdPipe;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): ReliabilityRiskMl.Reconstruction.TranAdPipe;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityRiskMl.Reconstruction.TranAdPipe;
     ...
     * @see #unsetField
     */
    defaultField(field: string): ReliabilityRiskMl.Reconstruction.TranAdPipe;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): ReliabilityRiskMl.Reconstruction.TranAdPipe;
     ...
     * @see #removeField
     */
    unsetField(field: string): ReliabilityRiskMl.Reconstruction.TranAdPipe;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): ReliabilityRiskMl.Reconstruction.TranAdPipe;
     ...
     * @see #unsetField
     */
    removeField(field: string): ReliabilityRiskMl.Reconstruction.TranAdPipe;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): ReliabilityRiskMl.Reconstruction.TranAdPipe;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityRiskMl.Reconstruction.TranAdPipe;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityRiskMl.Reconstruction.TranAdPipe;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityRiskMl.Reconstruction.TranAdPipe;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityRiskMl.Reconstruction.TranAdPipe;

    mergeJson(json: any): ReliabilityRiskMl.Reconstruction.TranAdPipe;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityRiskMl.Reconstruction.TranAdPipe;
     ...
     */
    sumObj(other: Obj, deep?: boolean): ReliabilityRiskMl.Reconstruction.TranAdPipe;
     ...
     */
    singletonArray(): Array_Type<ReliabilityRiskMl.Reconstruction.TranAdPipe>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityRiskMl.Reconstruction.TranAdPipe> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<ReliabilityRiskMl.Reconstruction.TranAdPipe> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<ReliabilityRiskMl.Reconstruction.TranAdPipe>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<ReliabilityRiskMl.Reconstruction.TranAdPipe> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, ReliabilityRiskMl.Reconstruction.TranAdPipe> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityRiskMl.Reconstruction.TranAdPipe> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<ReliabilityRiskMl.Reconstruction.TranAdPipe>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<ReliabilityRiskMl.Reconstruction.TranAdPipe>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityRiskMl.Reconstruction.TranAdPipe;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityRiskMl.Reconstruction.TranAdPipe;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityRiskMl.Reconstruction.TranAdPipe;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): ReliabilityRiskMl.Reconstruction.TranAdPipe;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityRiskMl.Reconstruction.TranAdPipe;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): ReliabilityRiskMl.Reconstruction.TranAdPipe;
     ...
     * @see #fromString
     */
    static make(s: string): ReliabilityRiskMl.Reconstruction.TranAdPipe | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityRiskMl.Reconstruction.TranAdPipe;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): ReliabilityRiskMl.Reconstruction.TranAdPipe;
     ...
     */
    static cachedEmptyInst(): ReliabilityRiskMl.Reconstruction.TranAdPipe;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityRiskMl.Reconstruction.TranAdPipe> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): ReliabilityRiskMl.Reconstruction.TranAdPipe;
     ...
     */
    remakeTemplate(): ReliabilityRiskMl.Reconstruction.TranAdPipe;
     ...
     */
    withoutIdentity(): ReliabilityRiskMl.Reconstruction.TranAdPipe;
     ...
     */
    trainSync(x: Data, y?: , spec?: MlOperationSpec): ReliabilityRiskMl.Reconstruction.TranAdPipe;
     ...
     */
    static allCached(doNotProduceAll?: boolean): Stream<ReliabilityRiskMl.Reconstruction.TranAdPipe> | null;
     ...
     */
    static find(filter?: string, doNotProduceAll?: boolean): Stream<ReliabilityRiskMl.Reconstruction.TranAdPipe> | null;
     ...
     * @return existing instances of this type that satisfy filter from data cache.
     */
    static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<ReliabilityRiskMl.Reconstruction.TranAdPipe> | null;
     ...
     * @see getCached
     */
    static findByCacheKey(key: string): ReliabilityRiskMl.Reconstruction.TranAdPipe | null;
     ...
     * @see findByCacheKey
     */
    static forCacheKey(key: string): ReliabilityRiskMl.Reconstruction.TranAdPipe | null;
     ...
     * @see findByCacheKey
     */
    getCached(): ReliabilityRiskMl.Reconstruction.TranAdPipe | null;

    /**
     * @return newly produced cached instance.
     */
    refreshCache(): ReliabilityRiskMl.Reconstruction.TranAdPipe | null;
     ...
     */
    static produce(key: string): ReliabilityRiskMl.Reconstruction.TranAdPipe | null;
     ...
     */
    static produceAll(): Map_Type<string, ReliabilityRiskMl.Reconstruction.TranAdPipe> | null;

    /**
     * Override for sub-types to produce all values.
     */
    static doProduceAll(): Map_Type<string, ReliabilityRiskMl.Reconstruction.TranAdPipe> | null;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<ReliabilityRiskMl.Reconstruction.TranAdPipe>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<ReliabilityRiskMl.Reconstruction.TranAdPipe>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityRiskMl.Reconstruction.TranAdPipe> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityRiskMl.Reconstruction.TranAdPipe>> | null;
     ...
     */
    get(include?: string): ReliabilityRiskMl.Reconstruction.TranAdPipe | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): ReliabilityRiskMl.Reconstruction.TranAdPipe | null;
     ...
     */
    getMissing(spec: GetMissingSpec): ReliabilityRiskMl.Reconstruction.TranAdPipe;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): ReliabilityRiskMl.Reconstruction.TranAdPipe | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): ReliabilityRiskMl.Reconstruction.TranAdPipe;
     ...
     * @see #toString
     */
    static fromString(s: string): ReliabilityRiskMl.Reconstruction.TranAdPipe | null;
     ...
     */
    create(spec?: UpsertSpec): ReliabilityRiskMl.Reconstruction.TranAdPipe | null;
     ...
     */
    static createBatch(objs: Array_Type<ReliabilityRiskMl.Reconstruction.TranAdPipe>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Reconstruction.TranAdPipe> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<ReliabilityRiskMl.Reconstruction.TranAdPipe>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityRiskMl.Reconstruction.TranAdPipe> | null;
     ...
     */
    update(srcObj?: ReliabilityRiskMl.Reconstruction.TranAdPipe, spec?: UpsertSpec): ReliabilityRiskMl.Reconstruction.TranAdPipe | null;
     ...
     */
    upsert(srcObj?: ReliabilityRiskMl.Reconstruction.TranAdPipe, spec?: UpsertSpec): ReliabilityRiskMl.Reconstruction.TranAdPipe | null;
     ...
     */
    merge(spec?: MergeSpec): ReliabilityRiskMl.Reconstruction.TranAdPipe | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): ReliabilityRiskMl.Reconstruction.TranAdPipe | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): ReliabilityRiskMl.Reconstruction.TranAdPipe | null;
     ...
     */
    static updateBatch(objs: Array_Type<ReliabilityRiskMl.Reconstruction.TranAdPipe>, srcObjs?: Array_Type<ReliabilityRiskMl.Reconstruction.TranAdPipe>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Reconstruction.TranAdPipe> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<ReliabilityRiskMl.Reconstruction.TranAdPipe> | null>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Reconstruction.TranAdPipe> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<ReliabilityRiskMl.Reconstruction.TranAdPipe>, srcObjs?: Array_Type<ReliabilityRiskMl.Reconstruction.TranAdPipe>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Reconstruction.TranAdPipe> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<ReliabilityRiskMl.Reconstruction.TranAdPipe> | null>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Reconstruction.TranAdPipe> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<ReliabilityRiskMl.Reconstruction.TranAdPipe>, spec?: TouchSpec): ObjList<ReliabilityRiskMl.Reconstruction.TranAdPipe> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityRiskMl.Reconstruction.TranAdPipe>, spec?: MergeSpec): ObjList<ReliabilityRiskMl.Reconstruction.TranAdPipe> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityRiskMl.Reconstruction.TranAdPipe>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityRiskMl.Reconstruction.TranAdPipe> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<ReliabilityRiskMl.Reconstruction.TranAdPipe> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityRiskMl.Reconstruction.TranAdPipe> | null;
     ...
     */
    static mergeAll(mergeObj: ReliabilityRiskMl.Reconstruction.TranAdPipe, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: ReliabilityRiskMl.Reconstruction.TranAdPipe, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<ReliabilityRiskMl.Reconstruction.TranAdPipe>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Reconstruction.TranAdPipe> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<ReliabilityRiskMl.Reconstruction.TranAdPipe>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Reconstruction.TranAdPipe> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): ReliabilityRiskMl.Reconstruction.TranAdPipe | null;
     ...
     */
    static beforeCreate(objs: Array_Type<ReliabilityRiskMl.Reconstruction.TranAdPipe>): ObjList<ReliabilityRiskMl.Reconstruction.TranAdPipe>;
     ...
     */
    static beforeUpdate(objs: Array_Type<ReliabilityRiskMl.Reconstruction.TranAdPipe>): ObjList<ReliabilityRiskMl.Reconstruction.TranAdPipe>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<ReliabilityRiskMl.Reconstruction.TranAdPipe>): ObjList<ReliabilityRiskMl.Reconstruction.TranAdPipe>;
     ...
     */
    static afterCreate(objs: Array_Type<ReliabilityRiskMl.Reconstruction.TranAdPipe>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<ReliabilityRiskMl.Reconstruction.TranAdPipe>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<ReliabilityRiskMl.Reconstruction.TranAdPipe>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityRiskMl.Reconstruction.TranAdPipe>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityRiskMl.Reconstruction.TranAdPipe>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): ReliabilityRiskMl.Reconstruction.TranAdPipe | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<ReliabilityRiskMl.Reconstruction.TranAdPipe>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: ReliabilityRiskMl.Reconstruction.TranAdPipe, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<ReliabilityRiskMl.Reconstruction.TranAdPipe>, callback?: λFunction<ReliabilityRiskMl.Reconstruction.TranAdPipe | null, ReliabilityRiskMl.Reconstruction.TranAdPipe | null>): ObjList<ReliabilityRiskMl.Reconstruction.TranAdPipe>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<ReliabilityRiskMl.Reconstruction.TranAdPipe>, callback?: λFunction<ReliabilityRiskMl.Reconstruction.TranAdPipe | null, ReliabilityRiskMl.Reconstruction.TranAdPipe | null>): Array_Type<ObjError> | null;
     ...
     */
    publish(subPath?: string, contentType?: string): ReliabilityRiskMl.Reconstruction.TranAdPipe;
     ...
     */
    static removeSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Reconstruction.TranAdPipe> | null;
     ...
     */
    createSeedData(spec?: UpsertSpec): ReliabilityRiskMl.Reconstruction.TranAdPipe | null;
     ...
     */
    static createSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Reconstruction.TranAdPipe> | null;
     ...
     */
    updateSeedData(srcObj?: SeedData, spec?: UpsertSpec): ReliabilityRiskMl.Reconstruction.TranAdPipe | null;
     ...
     */
    static updateSeedDataBatch(objs?: Array_Type<SeedData>, srcObjs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Reconstruction.TranAdPipe> | null;
     ...
     * @return updated obj instance, same as {@link Persistable#update} return value.
     */
    clearUserUpdates(spec?: MergeSpec): ReliabilityRiskMl.Reconstruction.TranAdPipe | null;
     ...
     *         {@link Persistable#updateBatch}.
     */
    static clearUserUpdatesBatch(objs?: Array_Type<SeedData>, spec?: MergeSpec): ObjList<ReliabilityRiskMl.Reconstruction.TranAdPipe> | null;
    ...
    dependencies(): SeedDataDeps<ReliabilityRiskMl.Reconstruction.TranAdPipe> | null;
     ...
     */
    static convert(model: any, spec?: MlConvertSpec): ReliabilityRiskMl.Reconstruction.TranAdPipe;

    /**
     * Freezes an {@link MlPipe}
     * @return modified copy of this {@link MlPipe} that cannot be trained
     */
    freeze(): ReliabilityRiskMl.Reconstruction.TranAdPipe;

    /**
     * Unfreezes an {@link MlPipe}
     * @return modified copy of this {@link MlPipe} that can be trained
     */
    unfreeze(): ReliabilityRiskMl.Reconstruction.TranAdPipe;
     ...
     * be returned as-is.
     */
    byReference(): ReliabilityRiskMl.Reconstruction.TranAdPipe;
     ...
     */
    updateModelFiles(modelFiles: Map_Type<string, Url>, spec?: MlOperationSpec): ReliabilityRiskMl.Reconstruction.TranAdPipe;
     ...
     */
    afterTrain(doTrainOutputs: any, spec?: MlOperationSpec): ReliabilityRiskMl.Reconstruction.TranAdPipe;
     ...
     */
    withNewSpec(spec?: MlConvertSpec): ReliabilityRiskMl.Reconstruction.TranAdPipe;
     ...
     */
    afterConvert(model: any, spec?: MlConvertSpec): ReliabilityRiskMl.Reconstruction.TranAdPipe;
     ...
     */
    withHyperparamSpaces(paramSpaces: Map_Type<string, Hp.ParamSpace>): ReliabilityRiskMl.Reconstruction.TranAdPipe;
