// TypeScript definitions for the C3 type ReliabilityMl.ContributionHeader
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityMl.ContributionHeader
 */
declare namespace ReliabilityMl {
  export interface IContributionHeader {
     ...
     */
    data?: Array_Type<ReliabilityMl.Contribution> | Array<IReliabilityMl.Contribution>;
 ...
 */
declare namespace ReliabilityMl {
  export class ContributionHeader extends Obj  {

    /**
     * Populated on normalization. Indicates the earliest data point across various timeseries fields.
     */
    readonly earliest?: DateTime;
    withEarliest(earliest: DateTime | Date | string | null): ReliabilityMl.ContributionHeader;

    /**
     * Populated on normalization. Indicates the latest data point across various timeseries fields.
     */
    readonly latest?: DateTime;
    withLatest(latest: DateTime | Date | string | null): ReliabilityMl.ContributionHeader;

    /**
     * Populated on normalization. Indicates the earliest data point for each {@link Ann.Ts} fields.
     */
    readonly earliestTsDp?: Map_Type<string, TSDataPoint>;
    withEarliestTsDp(earliestTsDp: Map_Type<string, TSDataPoint> | {[key: string]: ITSDataPoint} | null): ReliabilityMl.ContributionHeader;

    /**
     * Populated on normalization. Indicates the latest data point for each {@link Ann.Ts} fields.
     */
    readonly latestTsDp?: Map_Type<string, TSDataPoint>;
    withLatestTsDp(latestTsDp: Map_Type<string, TSDataPoint> | {[key: string]: ITSDataPoint} | null): ReliabilityMl.ContributionHeader;
    ...
    withInterval(interval: string | null): ReliabilityMl.ContributionHeader;
    ...
    withTimeZone(timeZone: string | null): ReliabilityMl.ContributionHeader;

    /**
     * If set, disables normalizing this time series. Invalidations will still continue to happen for this series normally.
     */
    readonly doNotNormalize?: boolean;
    withDoNotNormalize(doNotNormalize: boolean): ReliabilityMl.ContributionHeader;

    /**
     * Data points corresponding to this timeseries header
     */
    readonly data?: Array_Type<ReliabilityMl.Contribution>;
    withData(data: Array_Type<ReliabilityMl.Contribution> | Array<IReliabilityMl.Contribution> | null): ReliabilityMl.ContributionHeader;

    /**
     * Use this field to specify the interpolation mechanism to be applied for gaps in interval timeseries. Default: `ZERO_INTERPOLATOR`.
     */
    readonly interpolator?: string;
    withInterpolator(interpolator: string | null): ReliabilityMl.ContributionHeader;

    /**
     * Use this field to specify how normalization should handle duplicate data points. A duplicate point is one that has the same start, end, value, unit, and {@link TimedDataPointFields#isEstimated} values. Default: `IGNORE`.
     */
    readonly duplicateHandling?: string;
    withDuplicateHandling(duplicateHandling: string | null): ReliabilityMl.ContributionHeader;

    /**
     * Used to specify how normalization should handle overlapping data points. Default: `AVG`.
     */
    readonly overlapHandling?: string;
    withOverlapHandling(overlapHandling: string | null): ReliabilityMl.ContributionHeader;
    ...
    withBucketInterval(bucketInterval: string | null): ReliabilityMl.ContributionHeader;
    ...
    withNormalizationPartitionStrategy(normalizationPartitionStrategy: INormalizationPartitionStrategy | null): ReliabilityMl.ContributionHeader;

    /**
     * Indicates whether the last data point should be repeated until infinity
     */
    readonly extrapolate?: boolean;
    withExtrapolate(extrapolate: boolean): ReliabilityMl.ContributionHeader;
     ...
     */
    readonly id: string;
    withId(id: string): ReliabilityMl.ContributionHeader;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityMl.ContributionHeader;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): ReliabilityMl.ContributionHeader;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): ReliabilityMl.ContributionHeader;
    ...
    withVersion(version: number | null): ReliabilityMl.ContributionHeader;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): ReliabilityMl.ContributionHeader;

    /**
     * @inheritdoc
     */
    readonly facilityFilterPaths?: Array_Type<string>;
    withFacilityFilterPaths(facilityFilterPaths: Array_Type<string> | Array<string> | null): ReliabilityMl.ContributionHeader;
    ...
    withTypeIdent(typeIdent: string | null): ReliabilityMl.ContributionHeader;

    /**
     * The subject-model association related to this series header.
     */
    readonly parent: ReliabilityAssetToModelRelation;
    withParent(parent: IReliabilityAssetToModelRelation): ReliabilityMl.ContributionHeader;

    /**
     * The treatment to use for the timeseries.
     */
    readonly treatment?: string;
    withTreatment(treatment: string | null): ReliabilityMl.ContributionHeader;
     ...
     * @see #toJson
     */
    static fromJson(json: any): ReliabilityMl.ContributionHeader | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): ReliabilityMl.ContributionHeader | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): ReliabilityMl.ContributionHeader | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): ReliabilityMl.ContributionHeader | null;
     ...
     */
    replaceType(old: Type, new_: Type): ReliabilityMl.ContributionHeader;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityMl.ContributionHeader;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityMl.ContributionHeader;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityMl.ContributionHeader>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityMl.ContributionHeader>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityMl.ContributionHeader;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityMl.ContributionHeader;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityMl.ContributionHeader;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): ReliabilityMl.ContributionHeader;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): ReliabilityMl.ContributionHeader;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityMl.ContributionHeader;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityMl.ContributionHeader;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityMl.ContributionHeader;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): ReliabilityMl.ContributionHeader;
     ...
     * @see #removeField
     */
    withoutField(field: string): ReliabilityMl.ContributionHeader;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): ReliabilityMl.ContributionHeader;
     ...
     */
    withoutFields(fields: Array_Type<string>): ReliabilityMl.ContributionHeader;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityMl.ContributionHeader;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): ReliabilityMl.ContributionHeader;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityMl.ContributionHeader;
     ...
     * @see #unsetField
     */
    defaultField(field: string): ReliabilityMl.ContributionHeader;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): ReliabilityMl.ContributionHeader;
     ...
     * @see #removeField
     */
    unsetField(field: string): ReliabilityMl.ContributionHeader;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): ReliabilityMl.ContributionHeader;
     ...
     * @see #unsetField
     */
    removeField(field: string): ReliabilityMl.ContributionHeader;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): ReliabilityMl.ContributionHeader;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityMl.ContributionHeader;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityMl.ContributionHeader;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityMl.ContributionHeader;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityMl.ContributionHeader;

    mergeJson(json: any): ReliabilityMl.ContributionHeader;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityMl.ContributionHeader;
     ...
     */
    sumObj(other: Obj, deep?: boolean): ReliabilityMl.ContributionHeader;
     ...
     */
    singletonArray(): Array_Type<ReliabilityMl.ContributionHeader>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityMl.ContributionHeader> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<ReliabilityMl.ContributionHeader> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<ReliabilityMl.ContributionHeader>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<ReliabilityMl.ContributionHeader> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, ReliabilityMl.ContributionHeader> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityMl.ContributionHeader> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<ReliabilityMl.ContributionHeader>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<ReliabilityMl.ContributionHeader>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityMl.ContributionHeader;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityMl.ContributionHeader;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityMl.ContributionHeader;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): ReliabilityMl.ContributionHeader;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityMl.ContributionHeader;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): ReliabilityMl.ContributionHeader;
     ...
     * @see #fromString
     */
    static make(s: string): ReliabilityMl.ContributionHeader | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityMl.ContributionHeader;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): ReliabilityMl.ContributionHeader;
     ...
     */
    static cachedEmptyInst(): ReliabilityMl.ContributionHeader;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityMl.ContributionHeader> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): ReliabilityMl.ContributionHeader;
     ...
     */
    static normalizeTimeseries(timeseries?: TimedDataFields<ReliabilityMl.Contribution>, start?: DateTime, end?: DateTime, overrideGrain?: string, forceGrainDetection?: boolean, force?: boolean): void;
     ...
     */
    static normalize(timeseries?: TimedDataFields<ReliabilityMl.Contribution>, start?: DateTime, end?: DateTime, overrideGrain?: string, forceGrainDetection?: boolean): NormalizationResult | null;
     ...
     */
    static normalizationUnit(rawHeader: TimedDataFields<ReliabilityMl.Contribution>, tsField: string): Unit | null;
     ...
     */
    static normalizationTreatment(rawHeader: TimedDataFields<ReliabilityMl.Contribution>, tsField: string): string;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<ReliabilityMl.ContributionHeader>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<ReliabilityMl.ContributionHeader>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityMl.ContributionHeader> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityMl.ContributionHeader>> | null;
     ...
     */
    get(include?: string): ReliabilityMl.ContributionHeader | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): ReliabilityMl.ContributionHeader | null;
     ...
     */
    getMissing(spec: GetMissingSpec): ReliabilityMl.ContributionHeader;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): ReliabilityMl.ContributionHeader | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): ReliabilityMl.ContributionHeader;
     ...
     * @see #toString
     */
    static fromString(s: string): ReliabilityMl.ContributionHeader | null;
     ...
     */
    create(spec?: UpsertSpec): ReliabilityMl.ContributionHeader | null;
     ...
     */
    static createBatch(objs: Array_Type<ReliabilityMl.ContributionHeader>, spec?: UpsertSpec): ObjList<ReliabilityMl.ContributionHeader> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<ReliabilityMl.ContributionHeader>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityMl.ContributionHeader> | null;
     ...
     */
    update(srcObj?: ReliabilityMl.ContributionHeader, spec?: UpsertSpec): ReliabilityMl.ContributionHeader | null;
     ...
     */
    upsert(srcObj?: ReliabilityMl.ContributionHeader, spec?: UpsertSpec): ReliabilityMl.ContributionHeader | null;
     ...
     */
    merge(spec?: MergeSpec): ReliabilityMl.ContributionHeader | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): ReliabilityMl.ContributionHeader | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): ReliabilityMl.ContributionHeader | null;
     ...
     */
    static updateBatch(objs: Array_Type<ReliabilityMl.ContributionHeader>, srcObjs?: Array_Type<ReliabilityMl.ContributionHeader>, spec?: UpsertSpec): ObjList<ReliabilityMl.ContributionHeader> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<ReliabilityMl.ContributionHeader> | null>, spec?: UpsertSpec): ObjList<ReliabilityMl.ContributionHeader> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<ReliabilityMl.ContributionHeader>, srcObjs?: Array_Type<ReliabilityMl.ContributionHeader>, spec?: UpsertSpec): ObjList<ReliabilityMl.ContributionHeader> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<ReliabilityMl.ContributionHeader> | null>, spec?: UpsertSpec): ObjList<ReliabilityMl.ContributionHeader> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<ReliabilityMl.ContributionHeader>, spec?: TouchSpec): ObjList<ReliabilityMl.ContributionHeader> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityMl.ContributionHeader>, spec?: MergeSpec): ObjList<ReliabilityMl.ContributionHeader> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityMl.ContributionHeader>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityMl.ContributionHeader> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<ReliabilityMl.ContributionHeader> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityMl.ContributionHeader> | null;
     ...
     */
    static mergeAll(mergeObj: ReliabilityMl.ContributionHeader, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: ReliabilityMl.ContributionHeader, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<ReliabilityMl.ContributionHeader>, spec?: UpsertSpec): ObjList<ReliabilityMl.ContributionHeader> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<ReliabilityMl.ContributionHeader>, spec?: UpsertSpec): ObjList<ReliabilityMl.ContributionHeader> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): ReliabilityMl.ContributionHeader | null;
     ...
     */
    static beforeCreate(objs: Array_Type<ReliabilityMl.ContributionHeader>): ObjList<ReliabilityMl.ContributionHeader>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<ReliabilityMl.ContributionHeader>): ObjList<ReliabilityMl.ContributionHeader>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<ReliabilityMl.ContributionHeader>): ObjList<ReliabilityMl.ContributionHeader>;
     ...
     */
    static afterCreate(objs: Array_Type<ReliabilityMl.ContributionHeader>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<ReliabilityMl.ContributionHeader>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<ReliabilityMl.ContributionHeader>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityMl.ContributionHeader>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityMl.ContributionHeader>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): ReliabilityMl.ContributionHeader | null;
     ...
     */
    withoutIdentity(): ReliabilityMl.ContributionHeader | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<ReliabilityMl.ContributionHeader>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: ReliabilityMl.ContributionHeader, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<ReliabilityMl.ContributionHeader>, callback?: λFunction<ReliabilityMl.ContributionHeader | null, ReliabilityMl.ContributionHeader | null>): ObjList<ReliabilityMl.ContributionHeader>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<ReliabilityMl.ContributionHeader>, callback?: λFunction<ReliabilityMl.ContributionHeader | null, ReliabilityMl.ContributionHeader | null>): Array_Type<ObjError> | null;
