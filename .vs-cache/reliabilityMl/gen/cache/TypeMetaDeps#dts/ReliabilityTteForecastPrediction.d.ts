// TypeScript definitions for the C3 type ReliabilityTteForecastPrediction

/**
 * Represents a prediction made by a time-to-event (TTE) forecasting model
 * used to store the predicted time-to-event for a given asset, which is the predicted time until a specific event occurs.
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityTteForecastPrediction
 */
declare interface IReliabilityTteForecastPrediction {
  ...
  parent: IReliabilityTteForecastPredictionHeader;
   ...
   * This field represents the date and time when the time-to-event forecast was created.
   */
  forecastTimestamp: DateTime | Date | string;

  /**
   * The forecasted value for the time to event.
   * This is the predicted time or event occurrence, typically represented as a numeric value.
   */
  forecast: number;

  /**
   * The upper bound of the forecasted range.
   * This field represents the maximum predicted value within the forecast's confidence interval.
   */
  forecastUpperBound?: number;

  /**
   * The lower bound of the forecasted range.
   * This field represents the minimum predicted value within the forecast's confidence interval.
   */
  forecastLowerBound?: number;

  /**
   * A threshold against which the forecast is compared to estimate the time to event.
   * This threshold helps in determining whether the forecasted event will happen before or after a specific point in time.
   */
 ...
 * used to store the predicted time-to-event for a given asset, which is the predicted time until a specific event occurs.
 *
 * @remarks this represents a made instance of ReliabilityTteForecastPrediction
 */
declare class ReliabilityTteForecastPrediction extends Obj  {

  /**
   * start date for the data point
   */
  readonly start: DateTime;
  withStart(start: DateTime | Date | string): ReliabilityTteForecastPrediction;
  ...
  withOutlierCode(outlierCode: number | null): ReliabilityTteForecastPrediction;

  /**
   * (Optional) any comments for the data point
   */
  readonly comments?: string;
  withComments(comments: string | null): ReliabilityTteForecastPrediction;

  /**
   * Denotes if the value is an actual value or an estimated value. default = null (actual value)
   */
  readonly isEstimated?: boolean;
  withIsEstimated(isEstimated: boolean): ReliabilityTteForecastPrediction;
  ...
  withDataVersion(dataVersion: number | null): ReliabilityTteForecastPrediction;

  /**
   * Customer specific status code for the data point (may be used to denote data quality)
   */
  readonly statusCode?: string;
  withStatusCode(statusCode: string | null): ReliabilityTteForecastPrediction;

  /**
   * Partition key Bin separator used to separate partition key from bin id
   */
  readonly PK_BIN_SEPARATOR?: string;
  withPK_BIN_SEPARATOR(PK_BIN_SEPARATOR: string | null): ReliabilityTteForecastPrediction;

  readonly parent: ReliabilityTteForecastPredictionHeader;
  withParent(parent: IReliabilityTteForecastPredictionHeader): ReliabilityTteForecastPrediction;
  ...
  withTypeIdent(typeIdent: string | null): ReliabilityTteForecastPrediction;
   ...
   */
  readonly id: string;
  withId(id: string): ReliabilityTteForecastPrediction;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityTteForecastPrediction;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): ReliabilityTteForecastPrediction;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): ReliabilityTteForecastPrediction;
  ...
  withVersion(version: number | null): ReliabilityTteForecastPrediction;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): ReliabilityTteForecastPrediction;
  ...
  withForecastTimestamp(forecastTimestamp: DateTime | Date | string): ReliabilityTteForecastPrediction;
  ...
  withForecast(forecast: number): ReliabilityTteForecastPrediction;

  /**
   * The upper bound of the forecasted range.
   * This field represents the maximum predicted value within the forecast's confidence interval.
   */
  readonly forecastUpperBound?: number;
  withForecastUpperBound(forecastUpperBound: number | null): ReliabilityTteForecastPrediction;

  /**
   * The lower bound of the forecasted range.
   * This field represents the minimum predicted value within the forecast's confidence interval.
   */
  readonly forecastLowerBound?: number;
  withForecastLowerBound(forecastLowerBound: number | null): ReliabilityTteForecastPrediction;
  ...
  withForecastThreshold(forecastThreshold: number | null): ReliabilityTteForecastPrediction;
   ...
   * @see #toJson
   */
  static fromJson(json: any): ReliabilityTteForecastPrediction | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): ReliabilityTteForecastPrediction | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): ReliabilityTteForecastPrediction | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): ReliabilityTteForecastPrediction | null;
   ...
   */
  replaceType(old: Type, new_: Type): ReliabilityTteForecastPrediction;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityTteForecastPrediction;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityTteForecastPrediction;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityTteForecastPrediction>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityTteForecastPrediction>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityTteForecastPrediction;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityTteForecastPrediction;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityTteForecastPrediction;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ReliabilityTteForecastPrediction;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ReliabilityTteForecastPrediction;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityTteForecastPrediction;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityTteForecastPrediction;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityTteForecastPrediction;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ReliabilityTteForecastPrediction;
   ...
   * @see #removeField
   */
  withoutField(field: string): ReliabilityTteForecastPrediction;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): ReliabilityTteForecastPrediction;
   ...
   */
  withoutFields(fields: Array_Type<string>): ReliabilityTteForecastPrediction;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityTteForecastPrediction;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ReliabilityTteForecastPrediction;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityTteForecastPrediction;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ReliabilityTteForecastPrediction;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ReliabilityTteForecastPrediction;
   ...
   * @see #removeField
   */
  unsetField(field: string): ReliabilityTteForecastPrediction;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ReliabilityTteForecastPrediction;
   ...
   * @see #unsetField
   */
  removeField(field: string): ReliabilityTteForecastPrediction;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ReliabilityTteForecastPrediction;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityTteForecastPrediction;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityTteForecastPrediction;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityTteForecastPrediction;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityTteForecastPrediction;

  mergeJson(json: any): ReliabilityTteForecastPrediction;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityTteForecastPrediction;
   ...
   */
  sumObj(other: Obj, deep?: boolean): ReliabilityTteForecastPrediction;
   ...
   */
  singletonArray(): Array_Type<ReliabilityTteForecastPrediction>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityTteForecastPrediction> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ReliabilityTteForecastPrediction> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<ReliabilityTteForecastPrediction>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ReliabilityTteForecastPrediction> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, ReliabilityTteForecastPrediction> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityTteForecastPrediction> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ReliabilityTteForecastPrediction>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ReliabilityTteForecastPrediction>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityTteForecastPrediction;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityTteForecastPrediction;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityTteForecastPrediction;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ReliabilityTteForecastPrediction;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityTteForecastPrediction;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ReliabilityTteForecastPrediction;
   ...
   * @see #fromString
   */
  static make(s: string): ReliabilityTteForecastPrediction | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityTteForecastPrediction;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): ReliabilityTteForecastPrediction;
   ...
   */
  static cachedEmptyInst(): ReliabilityTteForecastPrediction;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityTteForecastPrediction> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): ReliabilityTteForecastPrediction;

  /**
   * Extract the partition key from the given obj
   */
  partitionKey(failIfMissing?: boolean): ReliabilityTteForecastPredictionHeader | null;
   ...
   */
  static partition(objs?: Stream<ReliabilityTteForecastPrediction>, spec?: PartitionBucketStrategy): Map_Type<string, KvDataPartition> | null;
   ...
   */
  static fromPartitions(partitions?: Stream<KvDataPartition>): Stream<ReliabilityTteForecastPrediction> | null;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<ReliabilityTteForecastPrediction>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<ReliabilityTteForecastPrediction>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityTteForecastPrediction> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityTteForecastPrediction>> | null;
   ...
   */
  get(include?: string): ReliabilityTteForecastPrediction | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): ReliabilityTteForecastPrediction | null;
   ...
   */
  getMissing(spec: GetMissingSpec): ReliabilityTteForecastPrediction;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): ReliabilityTteForecastPrediction | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): ReliabilityTteForecastPrediction;
   ...
   * @see #toString
   */
  static fromString(s: string): ReliabilityTteForecastPrediction | null;
   ...
   */
  create(spec?: UpsertSpec): ReliabilityTteForecastPrediction | null;
   ...
   */
  static createBatch(objs: Array_Type<ReliabilityTteForecastPrediction>, spec?: UpsertSpec): ObjList<ReliabilityTteForecastPrediction> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<ReliabilityTteForecastPrediction>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityTteForecastPrediction> | null;
   ...
   */
  update(srcObj?: ReliabilityTteForecastPrediction, spec?: UpsertSpec): ReliabilityTteForecastPrediction | null;
   ...
   */
  upsert(srcObj?: ReliabilityTteForecastPrediction, spec?: UpsertSpec): ReliabilityTteForecastPrediction | null;
   ...
   */
  merge(spec?: MergeSpec): ReliabilityTteForecastPrediction | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): ReliabilityTteForecastPrediction | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): ReliabilityTteForecastPrediction | null;
   ...
   */
  static updateBatch(objs: Array_Type<ReliabilityTteForecastPrediction>, srcObjs?: Array_Type<ReliabilityTteForecastPrediction>, spec?: UpsertSpec): ObjList<ReliabilityTteForecastPrediction> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<ReliabilityTteForecastPrediction> | null>, spec?: UpsertSpec): ObjList<ReliabilityTteForecastPrediction> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<ReliabilityTteForecastPrediction>, srcObjs?: Array_Type<ReliabilityTteForecastPrediction>, spec?: UpsertSpec): ObjList<ReliabilityTteForecastPrediction> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<ReliabilityTteForecastPrediction> | null>, spec?: UpsertSpec): ObjList<ReliabilityTteForecastPrediction> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<ReliabilityTteForecastPrediction>, spec?: TouchSpec): ObjList<ReliabilityTteForecastPrediction> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityTteForecastPrediction>, spec?: MergeSpec): ObjList<ReliabilityTteForecastPrediction> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityTteForecastPrediction>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityTteForecastPrediction> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<ReliabilityTteForecastPrediction> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityTteForecastPrediction> | null;
   ...
   */
  static mergeAll(mergeObj: ReliabilityTteForecastPrediction, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: ReliabilityTteForecastPrediction, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<ReliabilityTteForecastPrediction>, spec?: UpsertSpec): ObjList<ReliabilityTteForecastPrediction> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<ReliabilityTteForecastPrediction>, spec?: UpsertSpec): ObjList<ReliabilityTteForecastPrediction> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): ReliabilityTteForecastPrediction | null;
   ...
   */
  static beforeCreate(objs: Array_Type<ReliabilityTteForecastPrediction>): ObjList<ReliabilityTteForecastPrediction>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<ReliabilityTteForecastPrediction>): ObjList<ReliabilityTteForecastPrediction>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<ReliabilityTteForecastPrediction>): ObjList<ReliabilityTteForecastPrediction>;
   ...
   */
  static afterCreate(objs: Array_Type<ReliabilityTteForecastPrediction>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<ReliabilityTteForecastPrediction>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<ReliabilityTteForecastPrediction>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityTteForecastPrediction>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityTteForecastPrediction>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): ReliabilityTteForecastPrediction | null;
   ...
   */
  withoutIdentity(): ReliabilityTteForecastPrediction | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<ReliabilityTteForecastPrediction>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: ReliabilityTteForecastPrediction, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<ReliabilityTteForecastPrediction>, callback?: λFunction<ReliabilityTteForecastPrediction | null, ReliabilityTteForecastPrediction | null>): ObjList<ReliabilityTteForecastPrediction>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<ReliabilityTteForecastPrediction>, callback?: λFunction<ReliabilityTteForecastPrediction | null, ReliabilityTteForecastPrediction | null>): Array_Type<ObjError> | null;
