// TypeScript definitions for the C3 type ReliabilityMl.ValidationContributionHeader
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityMl.ValidationContributionHeader
 */
declare namespace ReliabilityMl {
  export interface IValidationContributionHeader {
     ...
     */
    data?: Array_Type<ReliabilityMl.ValidationContribution> | Array<IReliabilityMl.ValidationContribution>;
     ...
     */
    parent: IReliabilityAssetToModelValidationRelation;
 ...
 */
declare namespace ReliabilityMl {
  export class ValidationContributionHeader extends Obj  {

    /**
     * Populated on normalization. Indicates the earliest data point across various timeseries fields.
     */
    readonly earliest?: DateTime;
    withEarliest(earliest: DateTime | Date | string | null): ReliabilityMl.ValidationContributionHeader;

    /**
     * Populated on normalization. Indicates the latest data point across various timeseries fields.
     */
    readonly latest?: DateTime;
    withLatest(latest: DateTime | Date | string | null): ReliabilityMl.ValidationContributionHeader;

    /**
     * Populated on normalization. Indicates the earliest data point for each {@link Ann.Ts} fields.
     */
    readonly earliestTsDp?: Map_Type<string, TSDataPoint>;
    withEarliestTsDp(earliestTsDp: Map_Type<string, TSDataPoint> | {[key: string]: ITSDataPoint} | null): ReliabilityMl.ValidationContributionHeader;

    /**
     * Populated on normalization. Indicates the latest data point for each {@link Ann.Ts} fields.
     */
    readonly latestTsDp?: Map_Type<string, TSDataPoint>;
    withLatestTsDp(latestTsDp: Map_Type<string, TSDataPoint> | {[key: string]: ITSDataPoint} | null): ReliabilityMl.ValidationContributionHeader;
    ...
    withInterval(interval: string | null): ReliabilityMl.ValidationContributionHeader;
    ...
    withTimeZone(timeZone: string | null): ReliabilityMl.ValidationContributionHeader;

    /**
     * If set, disables normalizing this time series. Invalidations will still continue to happen for this series normally.
     */
    readonly doNotNormalize?: boolean;
    withDoNotNormalize(doNotNormalize: boolean): ReliabilityMl.ValidationContributionHeader;

    /**
     * Data points corresponding to this timeseries header
     */
    readonly data?: Array_Type<ReliabilityMl.ValidationContribution>;
    withData(data: Array_Type<ReliabilityMl.ValidationContribution> | Array<IReliabilityMl.ValidationContribution> | null): ReliabilityMl.ValidationContributionHeader;

    /**
     * Use this field to specify the interpolation mechanism to be applied for gaps in interval timeseries. Default: `ZERO_INTERPOLATOR`.
     */
    readonly interpolator?: string;
    withInterpolator(interpolator: string | null): ReliabilityMl.ValidationContributionHeader;

    /**
     * Use this field to specify how normalization should handle duplicate data points. A duplicate point is one that has the same start, end, value, unit, and {@link TimedDataPointFields#isEstimated} values. Default: `IGNORE`.
     */
    readonly duplicateHandling?: string;
    withDuplicateHandling(duplicateHandling: string | null): ReliabilityMl.ValidationContributionHeader;

    /**
     * Used to specify how normalization should handle overlapping data points. Default: `AVG`.
     */
    readonly overlapHandling?: string;
    withOverlapHandling(overlapHandling: string | null): ReliabilityMl.ValidationContributionHeader;
    ...
    withBucketInterval(bucketInterval: string | null): ReliabilityMl.ValidationContributionHeader;
    ...
    withNormalizationPartitionStrategy(normalizationPartitionStrategy: INormalizationPartitionStrategy | null): ReliabilityMl.ValidationContributionHeader;

    /**
     * Indicates whether the last data point should be repeated until infinity
     */
    readonly extrapolate?: boolean;
    withExtrapolate(extrapolate: boolean): ReliabilityMl.ValidationContributionHeader;
     ...
     */
    readonly id: string;
    withId(id: string): ReliabilityMl.ValidationContributionHeader;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityMl.ValidationContributionHeader;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): ReliabilityMl.ValidationContributionHeader;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): ReliabilityMl.ValidationContributionHeader;
    ...
    withVersion(version: number | null): ReliabilityMl.ValidationContributionHeader;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): ReliabilityMl.ValidationContributionHeader;

    /**
     * @inheritdoc
     */
    readonly facilityFilterPaths?: Array_Type<string>;
    withFacilityFilterPaths(facilityFilterPaths: Array_Type<string> | Array<string> | null): ReliabilityMl.ValidationContributionHeader;
    ...
    withTypeIdent(typeIdent: string | null): ReliabilityMl.ValidationContributionHeader;

    /**
     * The subject-model association related to this series header.
     */
    readonly parent: ReliabilityAssetToModelValidationRelation;
    withParent(parent: IReliabilityAssetToModelValidationRelation): ReliabilityMl.ValidationContributionHeader;

    /**
     * The treatment to use for the timeseries.
     */
    readonly treatment?: string;
    withTreatment(treatment: string | null): ReliabilityMl.ValidationContributionHeader;
     ...
     * @see #toJson
     */
    static fromJson(json: any): ReliabilityMl.ValidationContributionHeader | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): ReliabilityMl.ValidationContributionHeader | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): ReliabilityMl.ValidationContributionHeader | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): ReliabilityMl.ValidationContributionHeader | null;
     ...
     */
    replaceType(old: Type, new_: Type): ReliabilityMl.ValidationContributionHeader;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityMl.ValidationContributionHeader;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityMl.ValidationContributionHeader;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityMl.ValidationContributionHeader>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityMl.ValidationContributionHeader>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityMl.ValidationContributionHeader;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityMl.ValidationContributionHeader;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityMl.ValidationContributionHeader;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): ReliabilityMl.ValidationContributionHeader;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): ReliabilityMl.ValidationContributionHeader;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityMl.ValidationContributionHeader;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityMl.ValidationContributionHeader;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityMl.ValidationContributionHeader;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): ReliabilityMl.ValidationContributionHeader;
     ...
     * @see #removeField
     */
    withoutField(field: string): ReliabilityMl.ValidationContributionHeader;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): ReliabilityMl.ValidationContributionHeader;
     ...
     */
    withoutFields(fields: Array_Type<string>): ReliabilityMl.ValidationContributionHeader;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityMl.ValidationContributionHeader;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): ReliabilityMl.ValidationContributionHeader;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityMl.ValidationContributionHeader;
     ...
     * @see #unsetField
     */
    defaultField(field: string): ReliabilityMl.ValidationContributionHeader;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): ReliabilityMl.ValidationContributionHeader;
     ...
     * @see #removeField
     */
    unsetField(field: string): ReliabilityMl.ValidationContributionHeader;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): ReliabilityMl.ValidationContributionHeader;
     ...
     * @see #unsetField
     */
    removeField(field: string): ReliabilityMl.ValidationContributionHeader;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): ReliabilityMl.ValidationContributionHeader;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityMl.ValidationContributionHeader;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityMl.ValidationContributionHeader;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityMl.ValidationContributionHeader;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityMl.ValidationContributionHeader;

    mergeJson(json: any): ReliabilityMl.ValidationContributionHeader;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityMl.ValidationContributionHeader;
     ...
     */
    sumObj(other: Obj, deep?: boolean): ReliabilityMl.ValidationContributionHeader;
     ...
     */
    singletonArray(): Array_Type<ReliabilityMl.ValidationContributionHeader>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityMl.ValidationContributionHeader> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<ReliabilityMl.ValidationContributionHeader> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<ReliabilityMl.ValidationContributionHeader>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<ReliabilityMl.ValidationContributionHeader> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, ReliabilityMl.ValidationContributionHeader> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityMl.ValidationContributionHeader> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<ReliabilityMl.ValidationContributionHeader>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<ReliabilityMl.ValidationContributionHeader>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityMl.ValidationContributionHeader;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityMl.ValidationContributionHeader;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityMl.ValidationContributionHeader;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): ReliabilityMl.ValidationContributionHeader;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityMl.ValidationContributionHeader;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): ReliabilityMl.ValidationContributionHeader;
     ...
     * @see #fromString
     */
    static make(s: string): ReliabilityMl.ValidationContributionHeader | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityMl.ValidationContributionHeader;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): ReliabilityMl.ValidationContributionHeader;
     ...
     */
    static cachedEmptyInst(): ReliabilityMl.ValidationContributionHeader;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityMl.ValidationContributionHeader> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): ReliabilityMl.ValidationContributionHeader;
     ...
     */
    static normalizeTimeseries(timeseries?: TimedDataFields<ReliabilityMl.ValidationContribution>, start?: DateTime, end?: DateTime, overrideGrain?: string, forceGrainDetection?: boolean, force?: boolean): void;
     ...
     */
    static normalize(timeseries?: TimedDataFields<ReliabilityMl.ValidationContribution>, start?: DateTime, end?: DateTime, overrideGrain?: string, forceGrainDetection?: boolean): NormalizationResult | null;
     ...
     */
    static normalizationUnit(rawHeader: TimedDataFields<ReliabilityMl.ValidationContribution>, tsField: string): Unit | null;
     ...
     */
    static normalizationTreatment(rawHeader: TimedDataFields<ReliabilityMl.ValidationContribution>, tsField: string): string;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<ReliabilityMl.ValidationContributionHeader>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<ReliabilityMl.ValidationContributionHeader>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityMl.ValidationContributionHeader> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityMl.ValidationContributionHeader>> | null;
     ...
     */
    get(include?: string): ReliabilityMl.ValidationContributionHeader | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): ReliabilityMl.ValidationContributionHeader | null;
     ...
     */
    getMissing(spec: GetMissingSpec): ReliabilityMl.ValidationContributionHeader;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): ReliabilityMl.ValidationContributionHeader | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): ReliabilityMl.ValidationContributionHeader;
     ...
     * @see #toString
     */
    static fromString(s: string): ReliabilityMl.ValidationContributionHeader | null;
     ...
     */
    create(spec?: UpsertSpec): ReliabilityMl.ValidationContributionHeader | null;
     ...
     */
    static createBatch(objs: Array_Type<ReliabilityMl.ValidationContributionHeader>, spec?: UpsertSpec): ObjList<ReliabilityMl.ValidationContributionHeader> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<ReliabilityMl.ValidationContributionHeader>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityMl.ValidationContributionHeader> | null;
     ...
     */
    update(srcObj?: ReliabilityMl.ValidationContributionHeader, spec?: UpsertSpec): ReliabilityMl.ValidationContributionHeader | null;
     ...
     */
    upsert(srcObj?: ReliabilityMl.ValidationContributionHeader, spec?: UpsertSpec): ReliabilityMl.ValidationContributionHeader | null;
     ...
     */
    merge(spec?: MergeSpec): ReliabilityMl.ValidationContributionHeader | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): ReliabilityMl.ValidationContributionHeader | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): ReliabilityMl.ValidationContributionHeader | null;
     ...
     */
    static updateBatch(objs: Array_Type<ReliabilityMl.ValidationContributionHeader>, srcObjs?: Array_Type<ReliabilityMl.ValidationContributionHeader>, spec?: UpsertSpec): ObjList<ReliabilityMl.ValidationContributionHeader> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<ReliabilityMl.ValidationContributionHeader> | null>, spec?: UpsertSpec): ObjList<ReliabilityMl.ValidationContributionHeader> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<ReliabilityMl.ValidationContributionHeader>, srcObjs?: Array_Type<ReliabilityMl.ValidationContributionHeader>, spec?: UpsertSpec): ObjList<ReliabilityMl.ValidationContributionHeader> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<ReliabilityMl.ValidationContributionHeader> | null>, spec?: UpsertSpec): ObjList<ReliabilityMl.ValidationContributionHeader> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<ReliabilityMl.ValidationContributionHeader>, spec?: TouchSpec): ObjList<ReliabilityMl.ValidationContributionHeader> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityMl.ValidationContributionHeader>, spec?: MergeSpec): ObjList<ReliabilityMl.ValidationContributionHeader> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityMl.ValidationContributionHeader>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityMl.ValidationContributionHeader> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<ReliabilityMl.ValidationContributionHeader> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityMl.ValidationContributionHeader> | null;
     ...
     */
    static mergeAll(mergeObj: ReliabilityMl.ValidationContributionHeader, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: ReliabilityMl.ValidationContributionHeader, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<ReliabilityMl.ValidationContributionHeader>, spec?: UpsertSpec): ObjList<ReliabilityMl.ValidationContributionHeader> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<ReliabilityMl.ValidationContributionHeader>, spec?: UpsertSpec): ObjList<ReliabilityMl.ValidationContributionHeader> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): ReliabilityMl.ValidationContributionHeader | null;
     ...
     */
    static beforeCreate(objs: Array_Type<ReliabilityMl.ValidationContributionHeader>): ObjList<ReliabilityMl.ValidationContributionHeader>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<ReliabilityMl.ValidationContributionHeader>): ObjList<ReliabilityMl.ValidationContributionHeader>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<ReliabilityMl.ValidationContributionHeader>): ObjList<ReliabilityMl.ValidationContributionHeader>;
     ...
     */
    static afterCreate(objs: Array_Type<ReliabilityMl.ValidationContributionHeader>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<ReliabilityMl.ValidationContributionHeader>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<ReliabilityMl.ValidationContributionHeader>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityMl.ValidationContributionHeader>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityMl.ValidationContributionHeader>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): ReliabilityMl.ValidationContributionHeader | null;
     ...
     */
    withoutIdentity(): ReliabilityMl.ValidationContributionHeader | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<ReliabilityMl.ValidationContributionHeader>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: ReliabilityMl.ValidationContributionHeader, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<ReliabilityMl.ValidationContributionHeader>, callback?: λFunction<ReliabilityMl.ValidationContributionHeader | null, ReliabilityMl.ValidationContributionHeader | null>): ObjList<ReliabilityMl.ValidationContributionHeader>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<ReliabilityMl.ValidationContributionHeader>, callback?: λFunction<ReliabilityMl.ValidationContributionHeader | null, ReliabilityMl.ValidationContributionHeader | null>): Array_Type<ObjError> | null;
