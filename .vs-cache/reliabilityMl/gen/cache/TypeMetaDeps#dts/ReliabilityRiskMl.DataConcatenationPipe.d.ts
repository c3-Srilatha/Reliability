// TypeScript definitions for the C3 type ReliabilityRiskMl.DataConcatenationPipe

/**
 * This type represents an {@link MlPipe} template for a data operation that concatenates the input datasets horizontally.
 * The user needs to provide `inputNames` which will be used to construct the input type bindings.
 *
 * The `DataConcatenationPipe` is a machine learning pipeline component that takes multiple input datasets and
 * concatenates them horizontally (i.e., along the columns). This operation is typically used to combine different
 * features or datasets with a shared set of rows, allowing them to be processed as a single dataset for further analysis
 * or model training.
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityRiskMl.DataConcatenationPipe
 */
declare namespace ReliabilityRiskMl {
  export interface IDataConcatenationPipe<DX> {
    ...
    /**
     * A list of input names that are used to construct the input type bindings for the concatenation operation.
     * These names correspond to the columns or datasets that will be horizontally concatenated to form the final
     * output dataset. The operation will take these inputs and join them together side by side (along the columns).
     */
 ...
 * or model training.
 *
 * @remarks this represents a made instance of ReliabilityRiskMl.DataConcatenationPipe
 */
declare namespace ReliabilityRiskMl {
  export class DataConcatenationPipe<DX> extends Obj  {
     ...
     */
    readonly id: string;
    withId(id: string): ReliabilityRiskMl.DataConcatenationPipe;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityRiskMl.DataConcatenationPipe;

    /**
     * Name of this pipe.
     */
    readonly name?: string;
    withName(name: string | null): ReliabilityRiskMl.DataConcatenationPipe;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): ReliabilityRiskMl.DataConcatenationPipe;
    ...
    withVersion(version: number | null): ReliabilityRiskMl.DataConcatenationPipe;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): ReliabilityRiskMl.DataConcatenationPipe;
    ...
    withUserUpdatedFields(userUpdatedFields: Array_Type<string> | Array<string> | null): ReliabilityRiskMl.DataConcatenationPipe;
    ...
    withHidden(hidden: boolean): ReliabilityRiskMl.DataConcatenationPipe;
    ...
    withUserOwned(userOwned: boolean): ReliabilityRiskMl.DataConcatenationPipe;
    ...
    withTypeIdent(typeIdent: string | null): ReliabilityRiskMl.DataConcatenationPipe;

    /**
     * If true, then the pipe shall not be retrained
     */
    readonly frozen?: boolean;
    withFrozen(frozen: boolean): ReliabilityRiskMl.DataConcatenationPipe;

    /**
     * True if training has succeeded and false otherwise.
     */
    readonly trained?: boolean;
    withTrained(trained: boolean): ReliabilityRiskMl.DataConcatenationPipe;

    /**
     * Errors from training.
     */
    readonly trainingErrors?: string;
    withTrainingErrors(trainingErrors: string | null): ReliabilityRiskMl.DataConcatenationPipe;

    /**
     * If true, the underlying model only accepts flattened input.
     */
    readonly flattenInput?: boolean;
    withFlattenInput(flattenInput: boolean): ReliabilityRiskMl.DataConcatenationPipe;

    /**
     * The hyperparameters overridden of a native model or pipe.
     */
    readonly hyperparamOverrides?: Map_Type<string, any>;
    withHyperparamOverrides(hyperparamOverrides: Map_Type<string, any> | {[key: string]: any} | null): ReliabilityRiskMl.DataConcatenationPipe;
    ...
    withHyperparamSearchSpace(hyperparamSearchSpace: IHp.SearchSpace | null): ReliabilityRiskMl.DataConcatenationPipe;
    ...
    withHpoSpec(hpoSpec: IHpo.Spec | null): ReliabilityRiskMl.DataConcatenationPipe;

    /**
     * {@link Hpo.Experiment} stores the result of hyperparameter optimization to find the best model/pipeline.
     */
    readonly hpoExperiment?: Hpo.Experiment;
    withHpoExperiment(hpoExperiment: IHpo.Experiment | null): ReliabilityRiskMl.DataConcatenationPipe;

    /**
     * Reference to the experiment that produced this {@link MlPipe}. For example, this could be a {@link Hpo.ExperimentBase}.
     */
    readonly experiment?: any;
    withExperiment(experiment: any | null): ReliabilityRiskMl.DataConcatenationPipe;
    ...
    withModelFiles(modelFiles: Map_Type<string, Url> | {[key: string]: IUrl} | null): ReliabilityRiskMl.DataConcatenationPipe;
    ...
    withCustomModelCode(customModelCode: Map_Type<string, any> | {[key: string]: any} | null): ReliabilityRiskMl.DataConcatenationPipe;

    /**
     * Name for the function on the native model to call to do {@link MlProcessable#process}.
     */
    readonly processFunc?: string;
    withProcessFunc(processFunc: string | null): ReliabilityRiskMl.DataConcatenationPipe;
    ...
    withUnderlyingPipe(underlyingPipe: IMlAtomicPipe<any, any, any> | null): ReliabilityRiskMl.DataConcatenationPipe;
    ...
    withInputNames(inputNames: Array_Type<string> | Array<string>): ReliabilityRiskMl.DataConcatenationPipe;
     ...
     * @see #toJson
     */
    static fromJson(json: any): ReliabilityRiskMl.DataConcatenationPipe<DX> | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): ReliabilityRiskMl.DataConcatenationPipe<DX> | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): ReliabilityRiskMl.DataConcatenationPipe<DX> | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): ReliabilityRiskMl.DataConcatenationPipe<DX> | null;
     ...
     */
    replaceType(old: Type, new_: Type): ReliabilityRiskMl.DataConcatenationPipe<DX>;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityRiskMl.DataConcatenationPipe<DX>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityRiskMl.DataConcatenationPipe<DX>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityRiskMl.DataConcatenationPipe<DX>>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityRiskMl.DataConcatenationPipe<DX>>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityRiskMl.DataConcatenationPipe<DX>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityRiskMl.DataConcatenationPipe<DX>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityRiskMl.DataConcatenationPipe<DX>;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): ReliabilityRiskMl.DataConcatenationPipe<DX>;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): ReliabilityRiskMl.DataConcatenationPipe<DX>;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityRiskMl.DataConcatenationPipe<DX>;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityRiskMl.DataConcatenationPipe<DX>;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityRiskMl.DataConcatenationPipe<DX>;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): ReliabilityRiskMl.DataConcatenationPipe<DX>;
     ...
     * @see #removeField
     */
    withoutField(field: string): ReliabilityRiskMl.DataConcatenationPipe<DX>;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): ReliabilityRiskMl.DataConcatenationPipe<DX>;
     ...
     */
    withoutFields(fields: Array_Type<string>): ReliabilityRiskMl.DataConcatenationPipe<DX>;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityRiskMl.DataConcatenationPipe<DX>;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): ReliabilityRiskMl.DataConcatenationPipe<DX>;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityRiskMl.DataConcatenationPipe<DX>;
     ...
     * @see #unsetField
     */
    defaultField(field: string): ReliabilityRiskMl.DataConcatenationPipe<DX>;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): ReliabilityRiskMl.DataConcatenationPipe<DX>;
     ...
     * @see #removeField
     */
    unsetField(field: string): ReliabilityRiskMl.DataConcatenationPipe<DX>;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): ReliabilityRiskMl.DataConcatenationPipe<DX>;
     ...
     * @see #unsetField
     */
    removeField(field: string): ReliabilityRiskMl.DataConcatenationPipe<DX>;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): ReliabilityRiskMl.DataConcatenationPipe<DX>;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityRiskMl.DataConcatenationPipe<DX>;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityRiskMl.DataConcatenationPipe<DX>;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityRiskMl.DataConcatenationPipe<DX>;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityRiskMl.DataConcatenationPipe<DX>;

    mergeJson(json: any): ReliabilityRiskMl.DataConcatenationPipe<DX>;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityRiskMl.DataConcatenationPipe<DX>;
     ...
     */
    sumObj(other: Obj, deep?: boolean): ReliabilityRiskMl.DataConcatenationPipe<DX>;
     ...
     */
    singletonArray(): Array_Type<ReliabilityRiskMl.DataConcatenationPipe<DX>>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityRiskMl.DataConcatenationPipe<DX>> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<ReliabilityRiskMl.DataConcatenationPipe<DX>> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<ReliabilityRiskMl.DataConcatenationPipe<DX>>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<ReliabilityRiskMl.DataConcatenationPipe<DX>> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, ReliabilityRiskMl.DataConcatenationPipe<DX>> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityRiskMl.DataConcatenationPipe<DX>> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<ReliabilityRiskMl.DataConcatenationPipe<DX>>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<ReliabilityRiskMl.DataConcatenationPipe<DX>>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityRiskMl.DataConcatenationPipe<DX>;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityRiskMl.DataConcatenationPipe<DX>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityRiskMl.DataConcatenationPipe<DX>;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): ReliabilityRiskMl.DataConcatenationPipe<DX>;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityRiskMl.DataConcatenationPipe<DX>;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): ReliabilityRiskMl.DataConcatenationPipe<DX>;
     ...
     * @see #fromString
     */
    static make(s: string): ReliabilityRiskMl.DataConcatenationPipe<DX> | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityRiskMl.DataConcatenationPipe<DX>;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): ReliabilityRiskMl.DataConcatenationPipe<DX>;
     ...
     */
    static cachedEmptyInst(): ReliabilityRiskMl.DataConcatenationPipe<DX>;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityRiskMl.DataConcatenationPipe<DX>> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): ReliabilityRiskMl.DataConcatenationPipe<DX>;
     ...
     */
    remakeTemplate(): ReliabilityRiskMl.DataConcatenationPipe<DX>;

    /**
     * Method to generate type bindings for the concatenated data.
     * This method establishes the type definitions and bindings for the input datasets, ensuring that the datasets
     * being concatenated have compatible types and structures.
     */
     ...
     */
    withoutIdentity(): ReliabilityRiskMl.DataConcatenationPipe<DX>;
     ...
     */
    trainSync(x: DX, y?: , spec?: MlOperationSpec): ReliabilityRiskMl.DataConcatenationPipe<DX>;

    /**
     * Flag indicating whether the operation is trainable.
     * If `true`, the operation may require a training phase before it can be used for data processing.
     */
    isTrainable(): boolean;
     ...
     */
    static allCached(doNotProduceAll?: boolean): Stream<ReliabilityRiskMl.DataConcatenationPipe<DX>> | null;
     ...
     */
    static find(filter?: string, doNotProduceAll?: boolean): Stream<ReliabilityRiskMl.DataConcatenationPipe<DX>> | null;
     ...
     * @return existing instances of this type that satisfy filter from data cache.
     */
    static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<ReliabilityRiskMl.DataConcatenationPipe<DX>> | null;
     ...
     * @see getCached
     */
    static findByCacheKey(key: string): ReliabilityRiskMl.DataConcatenationPipe<DX> | null;
     ...
     * @see findByCacheKey
     */
    static forCacheKey(key: string): ReliabilityRiskMl.DataConcatenationPipe<DX> | null;
     ...
     * @see findByCacheKey
     */
    getCached(): ReliabilityRiskMl.DataConcatenationPipe<DX> | null;

    /**
     * @return newly produced cached instance.
     */
    refreshCache(): ReliabilityRiskMl.DataConcatenationPipe<DX> | null;
     ...
     */
    static produce(key: string): ReliabilityRiskMl.DataConcatenationPipe<DX> | null;
     ...
     */
    static produceAll(): Map_Type<string, ReliabilityRiskMl.DataConcatenationPipe<DX>> | null;

    /**
     * Override for sub-types to produce all values.
     */
    static doProduceAll(): Map_Type<string, ReliabilityRiskMl.DataConcatenationPipe<DX>> | null;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<ReliabilityRiskMl.DataConcatenationPipe<DX>>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<ReliabilityRiskMl.DataConcatenationPipe<DX>>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityRiskMl.DataConcatenationPipe<DX>> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityRiskMl.DataConcatenationPipe<DX>>> | null;
     ...
     */
    get(include?: string): ReliabilityRiskMl.DataConcatenationPipe<DX> | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): ReliabilityRiskMl.DataConcatenationPipe<DX> | null;
     ...
     */
    getMissing(spec: GetMissingSpec): ReliabilityRiskMl.DataConcatenationPipe<DX>;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): ReliabilityRiskMl.DataConcatenationPipe<DX> | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): ReliabilityRiskMl.DataConcatenationPipe<DX>;
     ...
     * @see #toString
     */
    static fromString(s: string): ReliabilityRiskMl.DataConcatenationPipe<DX> | null;
     ...
     */
    create(spec?: UpsertSpec): ReliabilityRiskMl.DataConcatenationPipe<DX> | null;
     ...
     */
    static createBatch(objs: Array_Type<ReliabilityRiskMl.DataConcatenationPipe<DX>>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.DataConcatenationPipe<DX>> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<ReliabilityRiskMl.DataConcatenationPipe<DX>>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityRiskMl.DataConcatenationPipe<DX>> | null;
     ...
     */
    update(srcObj?: ReliabilityRiskMl.DataConcatenationPipe<DX>, spec?: UpsertSpec): ReliabilityRiskMl.DataConcatenationPipe<DX> | null;
     ...
     */
    upsert(srcObj?: ReliabilityRiskMl.DataConcatenationPipe<DX>, spec?: UpsertSpec): ReliabilityRiskMl.DataConcatenationPipe<DX> | null;
     ...
     */
    merge(spec?: MergeSpec): ReliabilityRiskMl.DataConcatenationPipe<DX> | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): ReliabilityRiskMl.DataConcatenationPipe<DX> | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): ReliabilityRiskMl.DataConcatenationPipe<DX> | null;
     ...
     */
    static updateBatch(objs: Array_Type<ReliabilityRiskMl.DataConcatenationPipe<DX>>, srcObjs?: Array_Type<ReliabilityRiskMl.DataConcatenationPipe<DX>>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.DataConcatenationPipe<DX>> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<ReliabilityRiskMl.DataConcatenationPipe<DX>> | null>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.DataConcatenationPipe<DX>> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<ReliabilityRiskMl.DataConcatenationPipe<DX>>, srcObjs?: Array_Type<ReliabilityRiskMl.DataConcatenationPipe<DX>>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.DataConcatenationPipe<DX>> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<ReliabilityRiskMl.DataConcatenationPipe<DX>> | null>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.DataConcatenationPipe<DX>> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<ReliabilityRiskMl.DataConcatenationPipe<DX>>, spec?: TouchSpec): ObjList<ReliabilityRiskMl.DataConcatenationPipe<DX>> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityRiskMl.DataConcatenationPipe<DX>>, spec?: MergeSpec): ObjList<ReliabilityRiskMl.DataConcatenationPipe<DX>> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityRiskMl.DataConcatenationPipe<DX>>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityRiskMl.DataConcatenationPipe<DX>> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<ReliabilityRiskMl.DataConcatenationPipe<DX>> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityRiskMl.DataConcatenationPipe<DX>> | null;
     ...
     */
    static mergeAll(mergeObj: ReliabilityRiskMl.DataConcatenationPipe<DX>, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: ReliabilityRiskMl.DataConcatenationPipe<DX>, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<ReliabilityRiskMl.DataConcatenationPipe<DX>>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.DataConcatenationPipe<DX>> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<ReliabilityRiskMl.DataConcatenationPipe<DX>>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.DataConcatenationPipe<DX>> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): ReliabilityRiskMl.DataConcatenationPipe<DX> | null;
     ...
     */
    static beforeCreate(objs: Array_Type<ReliabilityRiskMl.DataConcatenationPipe<DX>>): ObjList<ReliabilityRiskMl.DataConcatenationPipe<DX>>;
     ...
     */
    static beforeUpdate(objs: Array_Type<ReliabilityRiskMl.DataConcatenationPipe<DX>>): ObjList<ReliabilityRiskMl.DataConcatenationPipe<DX>>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<ReliabilityRiskMl.DataConcatenationPipe<DX>>): ObjList<ReliabilityRiskMl.DataConcatenationPipe<DX>>;
     ...
     */
    static afterCreate(objs: Array_Type<ReliabilityRiskMl.DataConcatenationPipe<DX>>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<ReliabilityRiskMl.DataConcatenationPipe<DX>>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<ReliabilityRiskMl.DataConcatenationPipe<DX>>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityRiskMl.DataConcatenationPipe<DX>>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityRiskMl.DataConcatenationPipe<DX>>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): ReliabilityRiskMl.DataConcatenationPipe<DX> | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<ReliabilityRiskMl.DataConcatenationPipe<DX>>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: ReliabilityRiskMl.DataConcatenationPipe<DX>, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<ReliabilityRiskMl.DataConcatenationPipe<DX>>, callback?: λFunction<ReliabilityRiskMl.DataConcatenationPipe<DX> | null, ReliabilityRiskMl.DataConcatenationPipe<DX> | null>): ObjList<ReliabilityRiskMl.DataConcatenationPipe<DX>>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<ReliabilityRiskMl.DataConcatenationPipe<DX>>, callback?: λFunction<ReliabilityRiskMl.DataConcatenationPipe<DX> | null, ReliabilityRiskMl.DataConcatenationPipe<DX> | null>): Array_Type<ObjError> | null;
     ...
     */
    publish(subPath?: string, contentType?: string): ReliabilityRiskMl.DataConcatenationPipe<DX>;
     ...
     */
    static removeSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.DataConcatenationPipe<DX>> | null;
     ...
     */
    createSeedData(spec?: UpsertSpec): ReliabilityRiskMl.DataConcatenationPipe<DX> | null;
     ...
     */
    static createSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.DataConcatenationPipe<DX>> | null;
     ...
     */
    updateSeedData(srcObj?: SeedData, spec?: UpsertSpec): ReliabilityRiskMl.DataConcatenationPipe<DX> | null;
     ...
     */
    static updateSeedDataBatch(objs?: Array_Type<SeedData>, srcObjs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.DataConcatenationPipe<DX>> | null;
     ...
     * @return updated obj instance, same as {@link Persistable#update} return value.
     */
    clearUserUpdates(spec?: MergeSpec): ReliabilityRiskMl.DataConcatenationPipe<DX> | null;
     ...
     *         {@link Persistable#updateBatch}.
     */
    static clearUserUpdatesBatch(objs?: Array_Type<SeedData>, spec?: MergeSpec): ObjList<ReliabilityRiskMl.DataConcatenationPipe<DX>> | null;
    ...
    dependencies(): SeedDataDeps<ReliabilityRiskMl.DataConcatenationPipe<DX>> | null;
     ...
     */
    static convert(model: any, spec?: MlConvertSpec): ReliabilityRiskMl.DataConcatenationPipe<DX>;

    /**
     * Freezes an {@link MlPipe}
     * @return modified copy of this {@link MlPipe} that cannot be trained
     */
    freeze(): ReliabilityRiskMl.DataConcatenationPipe<DX>;

    /**
     * Unfreezes an {@link MlPipe}
     * @return modified copy of this {@link MlPipe} that can be trained
     */
    unfreeze(): ReliabilityRiskMl.DataConcatenationPipe<DX>;
     ...
     * be returned as-is.
     */
    byReference(): ReliabilityRiskMl.DataConcatenationPipe<DX>;
     ...
     */
    updateModelFiles(modelFiles: Map_Type<string, Url>, spec?: MlOperationSpec): ReliabilityRiskMl.DataConcatenationPipe<DX>;
     ...
     */
    afterTrain(doTrainOutputs: any, spec?: MlOperationSpec): ReliabilityRiskMl.DataConcatenationPipe<DX>;
    ...
    /**
     * Method to process the concatenation of datasets.
     * This function will combine the datasets specified in `inputNames` along the columns and generate the resulting
     * concatenated dataset.
     *
     * Typically, this method will be invoked after the pipeline has been generated and the input datasets are ready
     * to be concatenated.
     */
     ...
     */
    withNewSpec(spec?: MlConvertSpec): ReliabilityRiskMl.DataConcatenationPipe<DX>;
     ...
     */
    afterConvert(model: any, spec?: MlConvertSpec): ReliabilityRiskMl.DataConcatenationPipe<DX>;
     ...
     */
    withHyperparamSpaces(paramSpaces: Map_Type<string, Hp.ParamSpace>): ReliabilityRiskMl.DataConcatenationPipe<DX>;
    ...
    /**
     * Method to generate the pipeline that includes the data concatenation operation.
     * This method is used to prepare the concatenation operation as part of a larger machine learning pipeline.
     * The generated pipeline will include the logic required to combine the input datasets horizontally.
     */
