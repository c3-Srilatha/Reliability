// TypeScript definitions for the C3 type ReliabilityMlModel.ValidationStatus.History

/**
 * Persists the {@link ReliabilityMlModel.ValidationStatus} over time.
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityMlModel.ValidationStatus.History
 */
declare namespace ReliabilityMlModel.ValidationStatus {
...
declare namespace ReliabilityMlModel.ValidationStatus {
  export class History extends Obj  {
    ...
    withTimestamp(timestamp: DateTime | Date | string): ReliabilityMlModel.ValidationStatus.History;

    /**
     * Parent/owning obj instance.
     */
    readonly parent: ReliabilityMlModel;
    withParent(parent: IReliabilityMlModel): ReliabilityMlModel.ValidationStatus.History;

    /**
     * The value of the validation status.
     */
    readonly value: string;
    withValue(value: string): ReliabilityMlModel.ValidationStatus.History;
     ...
     */
    readonly id: string;
    withId(id: string): ReliabilityMlModel.ValidationStatus.History;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityMlModel.ValidationStatus.History;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): ReliabilityMlModel.ValidationStatus.History;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): ReliabilityMlModel.ValidationStatus.History;
    ...
    withVersion(version: number | null): ReliabilityMlModel.ValidationStatus.History;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): ReliabilityMlModel.ValidationStatus.History;

    /**
     * @inheritdoc
     */
    readonly facilityFilterPaths?: Array_Type<string>;
    withFacilityFilterPaths(facilityFilterPaths: Array_Type<string> | Array<string> | null): ReliabilityMlModel.ValidationStatus.History;
     ...
     * @see #toJson
     */
    static fromJson(json: any): ReliabilityMlModel.ValidationStatus.History | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): ReliabilityMlModel.ValidationStatus.History | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): ReliabilityMlModel.ValidationStatus.History | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): ReliabilityMlModel.ValidationStatus.History | null;
     ...
     */
    replaceType(old: Type, new_: Type): ReliabilityMlModel.ValidationStatus.History;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityMlModel.ValidationStatus.History;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityMlModel.ValidationStatus.History;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityMlModel.ValidationStatus.History>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityMlModel.ValidationStatus.History>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityMlModel.ValidationStatus.History;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityMlModel.ValidationStatus.History;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityMlModel.ValidationStatus.History;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): ReliabilityMlModel.ValidationStatus.History;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): ReliabilityMlModel.ValidationStatus.History;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityMlModel.ValidationStatus.History;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityMlModel.ValidationStatus.History;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityMlModel.ValidationStatus.History;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): ReliabilityMlModel.ValidationStatus.History;
     ...
     * @see #removeField
     */
    withoutField(field: string): ReliabilityMlModel.ValidationStatus.History;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): ReliabilityMlModel.ValidationStatus.History;
     ...
     */
    withoutFields(fields: Array_Type<string>): ReliabilityMlModel.ValidationStatus.History;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityMlModel.ValidationStatus.History;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): ReliabilityMlModel.ValidationStatus.History;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityMlModel.ValidationStatus.History;
     ...
     * @see #unsetField
     */
    defaultField(field: string): ReliabilityMlModel.ValidationStatus.History;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): ReliabilityMlModel.ValidationStatus.History;
     ...
     * @see #removeField
     */
    unsetField(field: string): ReliabilityMlModel.ValidationStatus.History;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): ReliabilityMlModel.ValidationStatus.History;
     ...
     * @see #unsetField
     */
    removeField(field: string): ReliabilityMlModel.ValidationStatus.History;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): ReliabilityMlModel.ValidationStatus.History;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityMlModel.ValidationStatus.History;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityMlModel.ValidationStatus.History;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityMlModel.ValidationStatus.History;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityMlModel.ValidationStatus.History;

    mergeJson(json: any): ReliabilityMlModel.ValidationStatus.History;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityMlModel.ValidationStatus.History;
     ...
     */
    sumObj(other: Obj, deep?: boolean): ReliabilityMlModel.ValidationStatus.History;
     ...
     */
    singletonArray(): Array_Type<ReliabilityMlModel.ValidationStatus.History>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityMlModel.ValidationStatus.History> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<ReliabilityMlModel.ValidationStatus.History> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<ReliabilityMlModel.ValidationStatus.History>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<ReliabilityMlModel.ValidationStatus.History> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, ReliabilityMlModel.ValidationStatus.History> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityMlModel.ValidationStatus.History> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<ReliabilityMlModel.ValidationStatus.History>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<ReliabilityMlModel.ValidationStatus.History>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityMlModel.ValidationStatus.History;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityMlModel.ValidationStatus.History;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityMlModel.ValidationStatus.History;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): ReliabilityMlModel.ValidationStatus.History;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityMlModel.ValidationStatus.History;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): ReliabilityMlModel.ValidationStatus.History;
     ...
     * @see #fromString
     */
    static make(s: string): ReliabilityMlModel.ValidationStatus.History | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityMlModel.ValidationStatus.History;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): ReliabilityMlModel.ValidationStatus.History;
     ...
     */
    static cachedEmptyInst(): ReliabilityMlModel.ValidationStatus.History;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityMlModel.ValidationStatus.History> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): ReliabilityMlModel.ValidationStatus.History;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<ReliabilityMlModel.ValidationStatus.History>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<ReliabilityMlModel.ValidationStatus.History>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityMlModel.ValidationStatus.History> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityMlModel.ValidationStatus.History>> | null;
     ...
     */
    get(include?: string): ReliabilityMlModel.ValidationStatus.History | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): ReliabilityMlModel.ValidationStatus.History | null;
     ...
     */
    getMissing(spec: GetMissingSpec): ReliabilityMlModel.ValidationStatus.History;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): ReliabilityMlModel.ValidationStatus.History | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): ReliabilityMlModel.ValidationStatus.History;
     ...
     * @see #toString
     */
    static fromString(s: string): ReliabilityMlModel.ValidationStatus.History | null;
     ...
     */
    create(spec?: UpsertSpec): ReliabilityMlModel.ValidationStatus.History | null;
     ...
     */
    static createBatch(objs: Array_Type<ReliabilityMlModel.ValidationStatus.History>, spec?: UpsertSpec): ObjList<ReliabilityMlModel.ValidationStatus.History> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<ReliabilityMlModel.ValidationStatus.History>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityMlModel.ValidationStatus.History> | null;
     ...
     */
    update(srcObj?: ReliabilityMlModel.ValidationStatus.History, spec?: UpsertSpec): ReliabilityMlModel.ValidationStatus.History | null;
     ...
     */
    upsert(srcObj?: ReliabilityMlModel.ValidationStatus.History, spec?: UpsertSpec): ReliabilityMlModel.ValidationStatus.History | null;
     ...
     */
    merge(spec?: MergeSpec): ReliabilityMlModel.ValidationStatus.History | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): ReliabilityMlModel.ValidationStatus.History | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): ReliabilityMlModel.ValidationStatus.History | null;
     ...
     */
    static updateBatch(objs: Array_Type<ReliabilityMlModel.ValidationStatus.History>, srcObjs?: Array_Type<ReliabilityMlModel.ValidationStatus.History>, spec?: UpsertSpec): ObjList<ReliabilityMlModel.ValidationStatus.History> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<ReliabilityMlModel.ValidationStatus.History> | null>, spec?: UpsertSpec): ObjList<ReliabilityMlModel.ValidationStatus.History> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<ReliabilityMlModel.ValidationStatus.History>, srcObjs?: Array_Type<ReliabilityMlModel.ValidationStatus.History>, spec?: UpsertSpec): ObjList<ReliabilityMlModel.ValidationStatus.History> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<ReliabilityMlModel.ValidationStatus.History> | null>, spec?: UpsertSpec): ObjList<ReliabilityMlModel.ValidationStatus.History> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<ReliabilityMlModel.ValidationStatus.History>, spec?: TouchSpec): ObjList<ReliabilityMlModel.ValidationStatus.History> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityMlModel.ValidationStatus.History>, spec?: MergeSpec): ObjList<ReliabilityMlModel.ValidationStatus.History> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityMlModel.ValidationStatus.History>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityMlModel.ValidationStatus.History> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<ReliabilityMlModel.ValidationStatus.History> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityMlModel.ValidationStatus.History> | null;
     ...
     */
    static mergeAll(mergeObj: ReliabilityMlModel.ValidationStatus.History, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: ReliabilityMlModel.ValidationStatus.History, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<ReliabilityMlModel.ValidationStatus.History>, spec?: UpsertSpec): ObjList<ReliabilityMlModel.ValidationStatus.History> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<ReliabilityMlModel.ValidationStatus.History>, spec?: UpsertSpec): ObjList<ReliabilityMlModel.ValidationStatus.History> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): ReliabilityMlModel.ValidationStatus.History | null;
     ...
     */
    static beforeCreate(objs: Array_Type<ReliabilityMlModel.ValidationStatus.History>): ObjList<ReliabilityMlModel.ValidationStatus.History>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<ReliabilityMlModel.ValidationStatus.History>): ObjList<ReliabilityMlModel.ValidationStatus.History>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<ReliabilityMlModel.ValidationStatus.History>): ObjList<ReliabilityMlModel.ValidationStatus.History>;
     ...
     */
    static afterCreate(objs: Array_Type<ReliabilityMlModel.ValidationStatus.History>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<ReliabilityMlModel.ValidationStatus.History>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<ReliabilityMlModel.ValidationStatus.History>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityMlModel.ValidationStatus.History>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityMlModel.ValidationStatus.History>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): ReliabilityMlModel.ValidationStatus.History | null;
     ...
     */
    withoutIdentity(): ReliabilityMlModel.ValidationStatus.History | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<ReliabilityMlModel.ValidationStatus.History>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: ReliabilityMlModel.ValidationStatus.History, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<ReliabilityMlModel.ValidationStatus.History>, callback?: λFunction<ReliabilityMlModel.ValidationStatus.History | null, ReliabilityMlModel.ValidationStatus.History | null>): ObjList<ReliabilityMlModel.ValidationStatus.History>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<ReliabilityMlModel.ValidationStatus.History>, callback?: λFunction<ReliabilityMlModel.ValidationStatus.History | null, ReliabilityMlModel.ValidationStatus.History | null>): Array_Type<ObjError> | null;
