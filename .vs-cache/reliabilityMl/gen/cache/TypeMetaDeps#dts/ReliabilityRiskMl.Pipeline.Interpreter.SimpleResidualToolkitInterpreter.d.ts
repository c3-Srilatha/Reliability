// TypeScript definitions for the C3 type ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter

/**
 * The `ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter` is an extendable entity type
 * that extends the `ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualInterpreter`. It is used to handle
 * the interpretation of the residuals in the context of reliability risk machine learning pipelines. This interpreter
 * processes data and performs necessary transformations to evaluate the residuals generated from a model.
 *
 * The `doInterpret` method is implemented to perform the interpretation task using Python-based data science libraries
 * or models.
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter
 */
declare namespace ReliabilityRiskMl.Pipeline.Interpreter {
  export interface ISimpleResidualToolkitInterpreter<DX, DO> {
    ...
    /**
     * The explainer type associated with this interpreter, which is set to 'SimpleResidual'. This field is used to specify
     * that the interpreter focuses on explaining the residuals in a simple, understandable way.
     */
 ...
 * or models.
 *
 * @remarks this represents a made instance of ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter
 */
declare namespace ReliabilityRiskMl.Pipeline.Interpreter {
  export class SimpleResidualToolkitInterpreter<DX, DO> extends Obj  {

    /**
     * A name for this interpreter
     */
    readonly name?: string;
    withName(name: string | null): ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter;
    ...
    withExplainer(explainer: string | ILambda<function(): any | null>): ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter;
    ...
    withInitKwargs(initKwargs: Map_Type<string, any> | {[key: string]: any} | null): ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter;
    ...
    withCallKwargs(callKwargs: Map_Type<string, any> | {[key: string]: any} | null): ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter;
    ...
    withActionRequirement(actionRequirement: string | null): ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter;
    ...
    withTypeIdent(typeIdent: string | null): ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter;
     ...
     */
    readonly id: string;
    withId(id: string): ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter;
    ...
    withVersion(version: number | null): ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter;
     ...
     * @see #toJson
     */
    static fromJson(json: any): ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO> | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO> | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO> | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO> | null;
     ...
     */
    replaceType(old: Type, new_: Type): ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO>;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO>>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO>>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO>;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO>;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO>;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO>;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO>;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO>;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO>;
     ...
     * @see #removeField
     */
    withoutField(field: string): ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO>;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO>;
     ...
     */
    withoutFields(fields: Array_Type<string>): ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO>;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO>;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO>;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO>;
     ...
     * @see #unsetField
     */
    defaultField(field: string): ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO>;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO>;
     ...
     * @see #removeField
     */
    unsetField(field: string): ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO>;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO>;
     ...
     * @see #unsetField
     */
    removeField(field: string): ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO>;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO>;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO>;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO>;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO>;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO>;

    mergeJson(json: any): ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO>;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO>;
     ...
     */
    sumObj(other: Obj, deep?: boolean): ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO>;
     ...
     */
    singletonArray(): Array_Type<ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO>>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO>> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO>> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO>>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO>> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO>> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO>> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO>>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO>>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO>;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO>;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO>;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO>;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO>;
     ...
     * @see #fromString
     */
    static make(s: string): ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO> | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO>;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO>;
     ...
     */
    static cachedEmptyInst(): ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO>;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO>> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO>;
    ...
    /**
     * The `makeExplainer` function is used to generate the explainer that can be applied to the model's residuals.
     * This function is invoked to build an explainer object that can analyze the residuals of model predictions and
     * provide insights based on the computed residuals.
     */
    ...
    /**
     * Method to interpret the residuals. It processes the input data and generates the necessary outputs
     * related to residuals in the context of reliability risk models.
     * The actual implementation relies on Python-based data processing to perform the required interpretation.
     *
     * @returns The result of the interpretation, typically a transformed version of the input data.
     */
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO>>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO>>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO>> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO>>> | null;
     ...
     */
    get(include?: string): ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO> | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO> | null;
     ...
     */
    getMissing(spec: GetMissingSpec): ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO>;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO> | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO>;
     ...
     * @see #toString
     */
    static fromString(s: string): ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO> | null;
     ...
     */
    create(spec?: UpsertSpec): ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO> | null;
     ...
     */
    static createBatch(objs: Array_Type<ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO>>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO>> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO>>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO>> | null;
     ...
     */
    update(srcObj?: ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO>, spec?: UpsertSpec): ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO> | null;
     ...
     */
    upsert(srcObj?: ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO>, spec?: UpsertSpec): ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO> | null;
     ...
     */
    merge(spec?: MergeSpec): ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO> | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO> | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO> | null;
     ...
     */
    static updateBatch(objs: Array_Type<ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO>>, srcObjs?: Array_Type<ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO>>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO>> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO>> | null>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO>> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO>>, srcObjs?: Array_Type<ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO>>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO>> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO>> | null>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO>> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO>>, spec?: TouchSpec): ObjList<ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO>> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO>>, spec?: MergeSpec): ObjList<ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO>> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO>>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO>> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO>> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO>> | null;
     ...
     */
    static mergeAll(mergeObj: ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO>, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO>, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO>>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO>> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO>>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO>> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO> | null;
     ...
     */
    static beforeCreate(objs: Array_Type<ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO>>): ObjList<ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO>>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO>>): ObjList<ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO>>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO>>): ObjList<ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO>>;
     ...
     */
    static afterCreate(objs: Array_Type<ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO>>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO>>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO>>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO>>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO>>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO> | null;
     ...
     */
    withoutIdentity(): ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO> | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO>>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO>, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO>>, callback?: λFunction<ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO> | null, ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO> | null>): ObjList<ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO>>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO>>, callback?: λFunction<ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO> | null, ReliabilityRiskMl.Pipeline.Interpreter.SimpleResidualToolkitInterpreter<DX, DO> | null>): Array_Type<ObjError> | null;
