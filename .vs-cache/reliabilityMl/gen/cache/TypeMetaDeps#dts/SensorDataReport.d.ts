// TypeScript definitions for the C3 type SensorDataReport

/**
 * Sensor Data report has calculated values in a specific time window.
 *
 * @remarks this represents a value passed to a method that expects an instance of SensorDataReport
 */
declare interface ISensorDataReport {
 ...
 */
declare class SensorDataReport extends Obj  {

  /**
   * The feature name that can be used to get the {@link #sensor} data
   */
  readonly featureName: string;
  withFeatureName(featureName: string): SensorDataReport;

  /**
   * Sensor that is the source of data for the data report.
   */
  readonly sensor: Sensor;
  withSensor(sensor: ISensor): SensorDataReport;

  /**
   * Latest value in the window {@link SensorDataReport#start} to {@link SensorDataReport#end}
   */
  readonly latestValue: number;
  withLatestValue(latestValue: number): SensorDataReport;
   ...
   */
  readonly id: string;
  withId(id: string): SensorDataReport;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): SensorDataReport;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): SensorDataReport;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): SensorDataReport;
  ...
  withVersion(version: number | null): SensorDataReport;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): SensorDataReport;
  ...
  withVariance(variance: number | null): SensorDataReport;

  /**
   * Start date selected to calculate the sensor data report.
   */
  readonly start: DateTime;
  withStart(start: DateTime | Date | string): SensorDataReport;

  /**
   * End date selected to calculate the sensor data report.
   */
  readonly end: DateTime;
  withEnd(end: DateTime | Date | string): SensorDataReport;

  /**
   * {@link Interval} selected to calculate the sensor data report.
   */
  readonly interval?: string;
  withInterval(interval: string | null): SensorDataReport;
   ...
   * flatlineRatio is a value between 0 and 100
   */
  readonly flatlineRatio: number;
  withFlatlineRatio(flatlineRatio: number): SensorDataReport;
  ...
  withMissingDataRatio(missingDataRatio: number): SensorDataReport;

  /**
   * {@link ReliabilityAsset} name purely used for display purposes. Denotes the participating asset from a {@link ReliabilityAssetSensorRelation} during the creation of this report.
   */
  readonly assetName?: string;
  withAssetName(assetName: string | null): SensorDataReport;
  ...
  withUserAdded(userAdded: boolean): SensorDataReport;
   ...
   * @see #toJson
   */
  static fromJson(json: any): SensorDataReport | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): SensorDataReport | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): SensorDataReport | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): SensorDataReport | null;
   ...
   */
  replaceType(old: Type, new_: Type): SensorDataReport;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): SensorDataReport;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): SensorDataReport;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<SensorDataReport>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<SensorDataReport>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): SensorDataReport;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SensorDataReport;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SensorDataReport;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): SensorDataReport;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): SensorDataReport;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): SensorDataReport;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): SensorDataReport;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): SensorDataReport;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): SensorDataReport;
   ...
   * @see #removeField
   */
  withoutField(field: string): SensorDataReport;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): SensorDataReport;
   ...
   */
  withoutFields(fields: Array_Type<string>): SensorDataReport;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): SensorDataReport;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): SensorDataReport;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): SensorDataReport;
   ...
   * @see #unsetField
   */
  defaultField(field: string): SensorDataReport;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): SensorDataReport;
   ...
   * @see #removeField
   */
  unsetField(field: string): SensorDataReport;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): SensorDataReport;
   ...
   * @see #unsetField
   */
  removeField(field: string): SensorDataReport;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): SensorDataReport;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): SensorDataReport;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): SensorDataReport;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): SensorDataReport;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): SensorDataReport;

  mergeJson(json: any): SensorDataReport;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): SensorDataReport;
   ...
   */
  sumObj(other: Obj, deep?: boolean): SensorDataReport;
   ...
   */
  singletonArray(): Array_Type<SensorDataReport>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<SensorDataReport> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<SensorDataReport> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<SensorDataReport>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<SensorDataReport> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, SensorDataReport> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, SensorDataReport> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<SensorDataReport>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<SensorDataReport>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): SensorDataReport;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): SensorDataReport;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): SensorDataReport;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): SensorDataReport;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): SensorDataReport;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): SensorDataReport;
   ...
   * @see #fromString
   */
  static make(s: string): SensorDataReport | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): SensorDataReport;
   ...
   */
  static cachedEmptyInst(): SensorDataReport;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<SensorDataReport> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): SensorDataReport;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<SensorDataReport>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<SensorDataReport>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<SensorDataReport> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<SensorDataReport>> | null;
   ...
   */
  get(include?: string): SensorDataReport | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): SensorDataReport | null;
   ...
   */
  getMissing(spec: GetMissingSpec): SensorDataReport;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): SensorDataReport | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): SensorDataReport;
   ...
   * @see #toString
   */
  static fromString(s: string): SensorDataReport | null;
   ...
   */
  create(spec?: UpsertSpec): SensorDataReport | null;
   ...
   */
  static createBatch(objs: Array_Type<SensorDataReport>, spec?: UpsertSpec): ObjList<SensorDataReport> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<SensorDataReport>, spec?: CreateBatchObjStreamSpec): ObjList<SensorDataReport> | null;
   ...
   */
  update(srcObj?: SensorDataReport, spec?: UpsertSpec): SensorDataReport | null;
   ...
   */
  upsert(srcObj?: SensorDataReport, spec?: UpsertSpec): SensorDataReport | null;
   ...
   */
  merge(spec?: MergeSpec): SensorDataReport | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): SensorDataReport | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): SensorDataReport | null;
   ...
   */
  static updateBatch(objs: Array_Type<SensorDataReport>, srcObjs?: Array_Type<SensorDataReport>, spec?: UpsertSpec): ObjList<SensorDataReport> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<SensorDataReport> | null>, spec?: UpsertSpec): ObjList<SensorDataReport> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<SensorDataReport>, srcObjs?: Array_Type<SensorDataReport>, spec?: UpsertSpec): ObjList<SensorDataReport> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<SensorDataReport> | null>, spec?: UpsertSpec): ObjList<SensorDataReport> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<SensorDataReport>, spec?: TouchSpec): ObjList<SensorDataReport> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<SensorDataReport>, spec?: MergeSpec): ObjList<SensorDataReport> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<SensorDataReport>, mergeInclude: string, spec?: MergeSpec): ObjList<SensorDataReport> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<SensorDataReport> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<SensorDataReport> | null;
   ...
   */
  static mergeAll(mergeObj: SensorDataReport, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: SensorDataReport, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<SensorDataReport>, spec?: UpsertSpec): ObjList<SensorDataReport> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<SensorDataReport>, spec?: UpsertSpec): ObjList<SensorDataReport> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): SensorDataReport | null;
   ...
   */
  static beforeCreate(objs: Array_Type<SensorDataReport>): ObjList<SensorDataReport>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<SensorDataReport>): ObjList<SensorDataReport>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<SensorDataReport>): ObjList<SensorDataReport>;
   ...
   */
  static afterCreate(objs: Array_Type<SensorDataReport>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<SensorDataReport>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<SensorDataReport>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<SensorDataReport>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<SensorDataReport>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): SensorDataReport | null;
   ...
   */
  withoutIdentity(): SensorDataReport | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<SensorDataReport>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: SensorDataReport, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<SensorDataReport>, callback?: λFunction<SensorDataReport | null, SensorDataReport | null>): ObjList<SensorDataReport>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<SensorDataReport>, callback?: λFunction<SensorDataReport | null, SensorDataReport | null>): Array_Type<ObjError> | null;
   ...
   */
  static fetchForDatasetDetail(spec: FetchSpec, datasetId: string): FetchResultWithTotalCount<SensorDataReport>;
}
