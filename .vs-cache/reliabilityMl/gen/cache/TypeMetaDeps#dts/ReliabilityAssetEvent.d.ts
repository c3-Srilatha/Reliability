// TypeScript definitions for the C3 type ReliabilityAssetEvent

/**
 * @inheritdoc
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityAssetEvent
 */
declare interface IReliabilityAssetEvent {
  ...
  /**
   * A user-provided name for this event.
   */
  name?: string;
  ...
  /**
   * Value for the {@link PhysicalAssetEvent}
   */
  value?: string;

  /**
   * The responses for this event
   */
  responses?: Array_Type<PhysicalAssetEventResponse> | Array<IPhysicalAssetEventResponse>;

  /**
   * The {@link ReliabilityAsset} this event is for
   */
   ...
   * Start Date
   */
  eventStartDatetime?: DateTime | Date | string;

  /**
   * End Date
   */
  eventEndDatetime?: DateTime | Date | string;

  /**
   * Total Losses Quantity (in Barrel of Oil Equivalent)
   */
  eventLossGrossQuantity?: number;

  /**
   * Overall Cause Code for the event (if any)
   */
  eventCauseCode?: string;

  /**
   * Cause Category
   */
  eventCauseCategory?: string;

  /**
   * Cause Sub Category
   */
  eventCauseSubCategory?: string;
  ...
  /**
   * Equipment Generic/Catalog Profile
   */
   ...
   */
  rootCauseAnalysisCode?: string;

  /**
   * Facility associated with this Event
   */
  facility?: IFacility;

  /**
   * Well associated with this Event
   */
  well?: string;

  /**
   * {@link ReliabilityAsset} associated with this event.
   */
  asset?: IReliabilityAsset;

  /**
   * The category the event can be classified as
   */
  category?: string;

  /**
   * Yes or No depending on if this event was detected
   */
  detected?: boolean;

  /**
   * The `MLProject` that this event is associated with
   */
  detectedBy?: IMlProject;

  /**
   * The entity that logged this event
   */
  loggedBy?: IUser;
   ...
   */
  loggedDate?: DateTime | Date | string;
  ...
  /**
   * The {@link ReliabilityAssetAlert} that corresponds to this event.
   */
  detectionAlert?: IReliabilityAssetAlert;

  /**
   * Represents whether the {@link ReliabilityAssetEvent} is user added.
   */
  userAdded?: boolean;
}
 ...
 * @inheritdoc
 *
 * @remarks this represents a made instance of ReliabilityAssetEvent
 */
declare class ReliabilityAssetEvent extends Obj  {
   ...
   */
  readonly id: string;
  withId(id: string): ReliabilityAssetEvent;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityAssetEvent;

  /**
   * A user-provided name for this event.
   */
  readonly name?: string;
  withName(name: string | null): ReliabilityAssetEvent;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): ReliabilityAssetEvent;
  ...
  withVersion(version: number | null): ReliabilityAssetEvent;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): ReliabilityAssetEvent;

  /**
   * @inheritdoc
   */
  readonly facilityFilterPaths?: Array_Type<string>;
  withFacilityFilterPaths(facilityFilterPaths: Array_Type<string> | Array<string> | null): ReliabilityAssetEvent;
  ...
  withTypeIdent(typeIdent: string | null): ReliabilityAssetEvent;

  /**
   * Value for the {@link PhysicalAssetEvent}
   */
  readonly value?: string;
  withValue(value: string | null): ReliabilityAssetEvent;

  /**
   * The responses for this event
   */
  readonly responses?: Array_Type<PhysicalAssetEventResponse>;
  withResponses(responses: Array_Type<PhysicalAssetEventResponse> | Array<IPhysicalAssetEventResponse> | null): ReliabilityAssetEvent;

  /**
   * The {@link ReliabilityAsset} this event is for
   */
  readonly parent: ReliabilityAsset;
  withParent(parent: IReliabilityAsset): ReliabilityAssetEvent;

  /**
   * The time at which the event occurred.
   */
  readonly timestamp: DateTime;
  withTimestamp(timestamp: DateTime | Date | string): ReliabilityAssetEvent;

  /**
   * Planned vs Unplanned Indicator
   */
  readonly eventType?: string;
  withEventType(eventType: string | null): ReliabilityAssetEvent;

  /**
   * Start Date
   */
  readonly eventStartDatetime?: DateTime;
  withEventStartDatetime(eventStartDatetime: DateTime | Date | string | null): ReliabilityAssetEvent;

  /**
   * End Date
   */
  readonly eventEndDatetime?: DateTime;
  withEventEndDatetime(eventEndDatetime: DateTime | Date | string | null): ReliabilityAssetEvent;

  /**
   * Total Losses Quantity (in Barrel of Oil Equivalent)
   */
  readonly eventLossGrossQuantity?: number;
  withEventLossGrossQuantity(eventLossGrossQuantity: number | null): ReliabilityAssetEvent;

  /**
   * Overall Cause Code for the event (if any)
   */
  readonly eventCauseCode?: string;
  withEventCauseCode(eventCauseCode: string | null): ReliabilityAssetEvent;

  /**
   * Cause Category
   */
  readonly eventCauseCategory?: string;
  withEventCauseCategory(eventCauseCategory: string | null): ReliabilityAssetEvent;

  /**
   * Cause Sub Category
   */
  readonly eventCauseSubCategory?: string;
  withEventCauseSubCategory(eventCauseSubCategory: string | null): ReliabilityAssetEvent;

  /**
   * Event Description
   */
  readonly eventDescription?: string;
  withEventDescription(eventDescription: string | null): ReliabilityAssetEvent;

  /**
   * Equipment associated with the event
   */
  readonly equipment?: ReliabilityAsset;
  withEquipment(equipment: IReliabilityAsset | null): ReliabilityAssetEvent;

  /**
   * Equipment Number
   */
  readonly equipmentNo?: string;
  withEquipmentNo(equipmentNo: string | null): ReliabilityAssetEvent;

  /**
   * Equipment Area
   */
  readonly equipmentArea?: string;
  withEquipmentArea(equipmentArea: string | null): ReliabilityAssetEvent;

  /**
   * Equipment Class
   */
  readonly equipmentClass?: string;
  withEquipmentClass(equipmentClass: string | null): ReliabilityAssetEvent;

  /**
   * Equipment Generic/Catalog Profile
   */
  readonly equipmentProfile?: string;
  withEquipmentProfile(equipmentProfile: string | null): ReliabilityAssetEvent;

  /**
   * Root cause analysis code
   */
  readonly rootCauseAnalysisCode?: string;
  withRootCauseAnalysisCode(rootCauseAnalysisCode: string | null): ReliabilityAssetEvent;

  /**
   * Facility associated with this Event
   */
  readonly facility?: Facility;
  withFacility(facility: IFacility | null): ReliabilityAssetEvent;

  /**
   * Well associated with this Event
   */
  readonly well?: string;
  withWell(well: string | null): ReliabilityAssetEvent;

  /**
   * {@link ReliabilityAsset} associated with this event.
   */
  readonly asset?: ReliabilityAsset;
  withAsset(asset: IReliabilityAsset | null): ReliabilityAssetEvent;

  /**
   * The category the event can be classified as
   */
  readonly category?: string;
  withCategory(category: string | null): ReliabilityAssetEvent;

  /**
   * Yes or No depending on if this event was detected
   */
  readonly detected?: boolean;
  withDetected(detected: boolean): ReliabilityAssetEvent;

  /**
   * The `MLProject` that this event is associated with
   */
  readonly detectedBy?: MlProject;
  withDetectedBy(detectedBy: IMlProject | null): ReliabilityAssetEvent;

  /**
   * The entity that logged this event
   */
  readonly loggedBy?: User;
  withLoggedBy(loggedBy: IUser | null): ReliabilityAssetEvent;

  /**
   * When this event was logged
   */
  readonly loggedDate?: DateTime;
  withLoggedDate(loggedDate: DateTime | Date | string | null): ReliabilityAssetEvent;

  /**
   * Event duration in milliseconds.
   */
  readonly eventDuration?: number;
  withEventDuration(eventDuration: number | null): ReliabilityAssetEvent;

  /**
   * The {@link ReliabilityAssetAlert} that corresponds to this event.
   */
  readonly detectionAlert?: ReliabilityAssetAlert;
  withDetectionAlert(detectionAlert: IReliabilityAssetAlert | null): ReliabilityAssetEvent;

  /**
   * Represents whether the {@link ReliabilityAssetEvent} is user added.
   */
  readonly userAdded?: boolean;
  withUserAdded(userAdded: boolean): ReliabilityAssetEvent;
   ...
   * @see #toJson
   */
  static fromJson(json: any): ReliabilityAssetEvent | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): ReliabilityAssetEvent | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): ReliabilityAssetEvent | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): ReliabilityAssetEvent | null;
   ...
   */
  replaceType(old: Type, new_: Type): ReliabilityAssetEvent;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityAssetEvent;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityAssetEvent;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityAssetEvent>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityAssetEvent>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityAssetEvent;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityAssetEvent;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityAssetEvent;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ReliabilityAssetEvent;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ReliabilityAssetEvent;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityAssetEvent;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityAssetEvent;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityAssetEvent;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ReliabilityAssetEvent;
   ...
   * @see #removeField
   */
  withoutField(field: string): ReliabilityAssetEvent;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): ReliabilityAssetEvent;
   ...
   */
  withoutFields(fields: Array_Type<string>): ReliabilityAssetEvent;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityAssetEvent;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ReliabilityAssetEvent;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityAssetEvent;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ReliabilityAssetEvent;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ReliabilityAssetEvent;
   ...
   * @see #removeField
   */
  unsetField(field: string): ReliabilityAssetEvent;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ReliabilityAssetEvent;
   ...
   * @see #unsetField
   */
  removeField(field: string): ReliabilityAssetEvent;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ReliabilityAssetEvent;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityAssetEvent;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityAssetEvent;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityAssetEvent;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityAssetEvent;

  mergeJson(json: any): ReliabilityAssetEvent;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityAssetEvent;
   ...
   */
  sumObj(other: Obj, deep?: boolean): ReliabilityAssetEvent;
   ...
   */
  singletonArray(): Array_Type<ReliabilityAssetEvent>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityAssetEvent> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ReliabilityAssetEvent> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<ReliabilityAssetEvent>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ReliabilityAssetEvent> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, ReliabilityAssetEvent> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityAssetEvent> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ReliabilityAssetEvent>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ReliabilityAssetEvent>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityAssetEvent;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityAssetEvent;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityAssetEvent;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ReliabilityAssetEvent;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityAssetEvent;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ReliabilityAssetEvent;
   ...
   * @see #fromString
   */
  static make(s: string): ReliabilityAssetEvent | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityAssetEvent;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): ReliabilityAssetEvent;
   ...
   */
  static cachedEmptyInst(): ReliabilityAssetEvent;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityAssetEvent> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): ReliabilityAssetEvent;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<ReliabilityAssetEvent>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<ReliabilityAssetEvent>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityAssetEvent> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityAssetEvent>> | null;
   ...
   */
  get(include?: string): ReliabilityAssetEvent | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): ReliabilityAssetEvent | null;
   ...
   */
  getMissing(spec: GetMissingSpec): ReliabilityAssetEvent;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): ReliabilityAssetEvent | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): ReliabilityAssetEvent;
   ...
   * @see #toString
   */
  static fromString(s: string): ReliabilityAssetEvent | null;
   ...
   */
  create(spec?: UpsertSpec): ReliabilityAssetEvent | null;
   ...
   */
  static createBatch(objs: Array_Type<ReliabilityAssetEvent>, spec?: UpsertSpec): ObjList<ReliabilityAssetEvent> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<ReliabilityAssetEvent>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityAssetEvent> | null;
   ...
   */
  update(srcObj?: ReliabilityAssetEvent, spec?: UpsertSpec): ReliabilityAssetEvent | null;
   ...
   */
  upsert(srcObj?: ReliabilityAssetEvent, spec?: UpsertSpec): ReliabilityAssetEvent | null;
   ...
   */
  merge(spec?: MergeSpec): ReliabilityAssetEvent | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): ReliabilityAssetEvent | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): ReliabilityAssetEvent | null;
   ...
   */
  static updateBatch(objs: Array_Type<ReliabilityAssetEvent>, srcObjs?: Array_Type<ReliabilityAssetEvent>, spec?: UpsertSpec): ObjList<ReliabilityAssetEvent> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<ReliabilityAssetEvent> | null>, spec?: UpsertSpec): ObjList<ReliabilityAssetEvent> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<ReliabilityAssetEvent>, srcObjs?: Array_Type<ReliabilityAssetEvent>, spec?: UpsertSpec): ObjList<ReliabilityAssetEvent> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<ReliabilityAssetEvent> | null>, spec?: UpsertSpec): ObjList<ReliabilityAssetEvent> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<ReliabilityAssetEvent>, spec?: TouchSpec): ObjList<ReliabilityAssetEvent> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityAssetEvent>, spec?: MergeSpec): ObjList<ReliabilityAssetEvent> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityAssetEvent>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityAssetEvent> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<ReliabilityAssetEvent> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityAssetEvent> | null;
   ...
   */
  static mergeAll(mergeObj: ReliabilityAssetEvent, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: ReliabilityAssetEvent, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<ReliabilityAssetEvent>, spec?: UpsertSpec): ObjList<ReliabilityAssetEvent> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<ReliabilityAssetEvent>, spec?: UpsertSpec): ObjList<ReliabilityAssetEvent> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): ReliabilityAssetEvent | null;
   ...
   */
  static beforeCreate(objs: Array_Type<ReliabilityAssetEvent>): ObjList<ReliabilityAssetEvent>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<ReliabilityAssetEvent>): ObjList<ReliabilityAssetEvent>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<ReliabilityAssetEvent>): ObjList<ReliabilityAssetEvent>;
   ...
   */
  static afterCreate(objs: Array_Type<ReliabilityAssetEvent>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<ReliabilityAssetEvent>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<ReliabilityAssetEvent>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityAssetEvent>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityAssetEvent>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): ReliabilityAssetEvent | null;
   ...
   */
  withoutIdentity(): ReliabilityAssetEvent | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<ReliabilityAssetEvent>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: ReliabilityAssetEvent, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<ReliabilityAssetEvent>, callback?: λFunction<ReliabilityAssetEvent | null, ReliabilityAssetEvent | null>): ObjList<ReliabilityAssetEvent>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<ReliabilityAssetEvent>, callback?: λFunction<ReliabilityAssetEvent | null, ReliabilityAssetEvent | null>): Array_Type<ObjError> | null;
  ...
  /**
   * The method computes maximum, minimum, and average {@link eventDuration} in milliseconds for {@link ReliabilityAssetEvent} specified by spec.
   * @param spec - FetchSpec
   *        fetchSpec for {@link ReliabilityAssetEvent}
   * @return JSON object containing the computed statistics.
   */
  static getEventDurationStatistics(spec: FetchSpec): any | null;
}
