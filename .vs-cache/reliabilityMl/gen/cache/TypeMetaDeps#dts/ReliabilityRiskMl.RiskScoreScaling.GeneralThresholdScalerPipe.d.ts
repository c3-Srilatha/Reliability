// TypeScript definitions for the C3 type ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe

/**
 * This is an implementation of {@link ReliabilityRiskMl.RiskScoreScaling.Pipe} for the
 * {@link ReliabilityRiskMl.Pipeline#riskScoreNormalizationPipe} that normalizes risk scores based on how
 * close they are to the provided {@link #alertThreshold}. The normalized risk score is capped at 1.0.
 *
 * When using this pipe in conjunction with the {@link ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe}, the provided
 * {@link #alertThreshold} or {@link alertPercentile} must be the same as the {@link ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe}
 *
 * riskScoreNormalized = min(1.0, riskScore / alertThreshold)
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe
 */
declare namespace ReliabilityRiskMl.RiskScoreScaling {
  export interface IGeneralThresholdScalerPipe {
     ...
     * alertPercentile must be between [0, 100]. If alertThreshold is set, overrides alertPercentile.
     * This must be the same as {@link ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe#alertPercentile}
     */
    alertPercentile?: number;

    /**
     * Risk score threshold above which a risk score is considered "high" and could raise an alert.
     * If alertThreshold is set, overrides alertPercentile. The provided alertThreshold must be greater than 0.0.
     * This must be the same as {@link ReliabilityRiskMl.Alerting.GeneralPercentileDurationPipe#alertThreshold}
     */
 ...
 * riskScoreNormalized = min(1.0, riskScore / alertThreshold)
 *
 * @remarks this represents a made instance of ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe
 */
declare namespace ReliabilityRiskMl.RiskScoreScaling {
  export class GeneralThresholdScalerPipe extends Obj  {
     ...
     */
    readonly id: string;
    withId(id: string): ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe;

    /**
     * Name of this pipe.
     */
    readonly name?: string;
    withName(name: string | null): ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe;
    ...
    withVersion(version: number | null): ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe;
    ...
    withUserUpdatedFields(userUpdatedFields: Array_Type<string> | Array<string> | null): ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe;
    ...
    withHidden(hidden: boolean): ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe;
    ...
    withUserOwned(userOwned: boolean): ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe;
    ...
    withTypeIdent(typeIdent: string | null): ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe;

    /**
     * If true, then the pipe shall not be retrained
     */
    readonly frozen?: boolean;
    withFrozen(frozen: boolean): ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe;

    /**
     * True if training has succeeded and false otherwise.
     */
    readonly trained?: boolean;
    withTrained(trained: boolean): ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe;

    /**
     * Errors from training.
     */
    readonly trainingErrors?: string;
    withTrainingErrors(trainingErrors: string | null): ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe;

    /**
     * If true, the underlying model only accepts flattened input.
     */
    readonly flattenInput?: boolean;
    withFlattenInput(flattenInput: boolean): ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe;

    /**
     * The hyperparameters overridden of a native model or pipe.
     */
    readonly hyperparamOverrides?: Map_Type<string, any>;
    withHyperparamOverrides(hyperparamOverrides: Map_Type<string, any> | {[key: string]: any} | null): ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe;
    ...
    withHyperparamSearchSpace(hyperparamSearchSpace: IHp.SearchSpace | null): ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe;
    ...
    withHpoSpec(hpoSpec: IHpo.Spec | null): ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe;

    /**
     * {@link Hpo.Experiment} stores the result of hyperparameter optimization to find the best model/pipeline.
     */
    readonly hpoExperiment?: Hpo.Experiment;
    withHpoExperiment(hpoExperiment: IHpo.Experiment | null): ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe;

    /**
     * Reference to the experiment that produced this {@link MlPipe}. For example, this could be a {@link Hpo.ExperimentBase}.
     */
    readonly experiment?: any;
    withExperiment(experiment: any | null): ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe;
    ...
    withModelFiles(modelFiles: Map_Type<string, Url> | {[key: string]: IUrl} | null): ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe;
    ...
    withCustomModelCode(customModelCode: Map_Type<string, any> | {[key: string]: any} | null): ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe;

    /**
     * Name for the function on the native model to call to do {@link MlProcessable#process}.
     */
    readonly processFunc?: string;
    withProcessFunc(processFunc: string | null): ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe;
    ...
    withUnderlyingPipe(underlyingPipe: IMlAtomicPipe<any, any, any> | null): ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe;
    ...
    withLookbackDuration(lookbackDuration: IDuration | null): ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe;
    ...
    withAlertPercentile(alertPercentile: number | null): ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe;
    ...
    withAlertThreshold(alertThreshold: number | null): ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe;
     ...
     * @see #toJson
     */
    static fromJson(json: any): ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe | null;
     ...
     */
    replaceType(old: Type, new_: Type): ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe;
     ...
     * @see #removeField
     */
    withoutField(field: string): ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe;
     ...
     */
    withoutFields(fields: Array_Type<string>): ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe;
     ...
     * @see #unsetField
     */
    defaultField(field: string): ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe;
     ...
     * @see #removeField
     */
    unsetField(field: string): ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe;
     ...
     * @see #unsetField
     */
    removeField(field: string): ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe;

    mergeJson(json: any): ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe;
     ...
     */
    sumObj(other: Obj, deep?: boolean): ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe;
     ...
     */
    singletonArray(): Array_Type<ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe;
     ...
     * @see #fromString
     */
    static make(s: string): ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe;
     ...
     */
    static cachedEmptyInst(): ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe;
     ...
     */
    remakeTemplate(): ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe;
     ...
     */
    withoutIdentity(): ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe;
     ...
     */
    trainSync(x: , y?: , spec?: MlOperationSpec): ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe;
     ...
     */
    static allCached(doNotProduceAll?: boolean): Stream<ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe> | null;
     ...
     */
    static find(filter?: string, doNotProduceAll?: boolean): Stream<ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe> | null;
     ...
     * @return existing instances of this type that satisfy filter from data cache.
     */
    static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe> | null;
     ...
     * @see getCached
     */
    static findByCacheKey(key: string): ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe | null;
     ...
     * @see findByCacheKey
     */
    static forCacheKey(key: string): ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe | null;
     ...
     * @see findByCacheKey
     */
    getCached(): ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe | null;

    /**
     * @return newly produced cached instance.
     */
    refreshCache(): ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe | null;
     ...
     */
    static produce(key: string): ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe | null;
     ...
     */
    static produceAll(): Map_Type<string, ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe> | null;

    /**
     * Override for sub-types to produce all values.
     */
    static doProduceAll(): Map_Type<string, ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe> | null;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe>> | null;
     ...
     */
    get(include?: string): ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe | null;
     ...
     */
    getMissing(spec: GetMissingSpec): ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe;
     ...
     * @see #toString
     */
    static fromString(s: string): ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe | null;
     ...
     */
    create(spec?: UpsertSpec): ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe | null;
     ...
     */
    static createBatch(objs: Array_Type<ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe> | null;
     ...
     */
    update(srcObj?: ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe, spec?: UpsertSpec): ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe | null;
     ...
     */
    upsert(srcObj?: ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe, spec?: UpsertSpec): ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe | null;
     ...
     */
    merge(spec?: MergeSpec): ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe | null;
     ...
     */
    static updateBatch(objs: Array_Type<ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe>, srcObjs?: Array_Type<ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe> | null>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe>, srcObjs?: Array_Type<ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe> | null>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe>, spec?: TouchSpec): ObjList<ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe>, spec?: MergeSpec): ObjList<ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe> | null;
     ...
     */
    static mergeAll(mergeObj: ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe | null;
     ...
     */
    static beforeCreate(objs: Array_Type<ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe>): ObjList<ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe>;
     ...
     */
    static beforeUpdate(objs: Array_Type<ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe>): ObjList<ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe>): ObjList<ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe>;
     ...
     */
    static afterCreate(objs: Array_Type<ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe>, callback?: λFunction<ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe | null, ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe | null>): ObjList<ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe>, callback?: λFunction<ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe | null, ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe | null>): Array_Type<ObjError> | null;
     ...
     */
    publish(subPath?: string, contentType?: string): ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe;
     ...
     */
    static removeSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe> | null;
     ...
     */
    createSeedData(spec?: UpsertSpec): ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe | null;
     ...
     */
    static createSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe> | null;
     ...
     */
    updateSeedData(srcObj?: SeedData, spec?: UpsertSpec): ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe | null;
     ...
     */
    static updateSeedDataBatch(objs?: Array_Type<SeedData>, srcObjs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe> | null;
     ...
     * @return updated obj instance, same as {@link Persistable#update} return value.
     */
    clearUserUpdates(spec?: MergeSpec): ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe | null;
     ...
     *         {@link Persistable#updateBatch}.
     */
    static clearUserUpdatesBatch(objs?: Array_Type<SeedData>, spec?: MergeSpec): ObjList<ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe> | null;
    ...
    dependencies(): SeedDataDeps<ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe> | null;
     ...
     */
    static convert(model: any, spec?: MlConvertSpec): ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe;

    /**
     * Freezes an {@link MlPipe}
     * @return modified copy of this {@link MlPipe} that cannot be trained
     */
    freeze(): ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe;

    /**
     * Unfreezes an {@link MlPipe}
     * @return modified copy of this {@link MlPipe} that can be trained
     */
    unfreeze(): ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe;
     ...
     * be returned as-is.
     */
    byReference(): ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe;
     ...
     */
    updateModelFiles(modelFiles: Map_Type<string, Url>, spec?: MlOperationSpec): ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe;
     ...
     */
    afterTrain(doTrainOutputs: any, spec?: MlOperationSpec): ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe;
     ...
     */
    withNewSpec(spec?: MlConvertSpec): ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe;
     ...
     */
    afterConvert(model: any, spec?: MlConvertSpec): ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe;
     ...
     */
    withHyperparamSpaces(paramSpaces: Map_Type<string, Hp.ParamSpace>): ReliabilityRiskMl.RiskScoreScaling.GeneralThresholdScalerPipe;
