// TypeScript definitions for the C3 type ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline

/**
 * This type represents an {@link MlPipeline} template for a Virtual Sensor Pipeline. The user can use this template to
 * build and train a regression-based reconstruction pipeline on 2D timeseries data based on the user-specified
 * hyperparameters. The outputs will be the reconstructed input and the residual between the reconstruction and the
 * original input.
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline
 */
declare namespace ReliabilityRiskMl.Reconstruction {
  export interface IVirtualSensorPipeline<DX, DO, DI> {
    ...
    /**
     * Define the list of all the feature names in this field. This is a
     * COMPULSORY field to define.
     */
    features: Array_Type<string> | Array<string>;

    /**
     * By default, all the features from {@link features} will be regressed
     * against. However, if the user does not want to train regressors for all
     * {@link features}, then they can specify a subset of features to build
     * estimators for.
     */
    targetsToReconstruct?: Array_Type<string> | Array<string>;

    /**
     * By default, for all the {@link targetsToReconstruct}, all the other features
     * will be used to train the regressors. However, if the user has additional
     * information that may aid the model training process, for example, to estimate
     * feature4 we only need feature1 and feature3, then that may be encoded here as
     * `{"feature4": ["feature1","feature3"]}`. For all features that are not found
     * in the keys of this map object, all other features will be used to train
     * regressors.
     */
    targetToFeaturesMap?: Map_Type<string, Array_Type<string>> | {[key: string]: Array_Type<string> | Array<string>};

    /**
     * By default, if not overridden by {@link targetToRegressorMap}, every feature
     * will be regressed against using this template regressor.
     */
    templateRegressor: IMlPipe<any, any, any, any, any>;

    /**
     * If the {@link templateRegressor} is not deemed appropriate for some features,
     * then the particular regressor to be applied to those features may be specified
     * in this map object. The key of this map represents the feature, i.e., column name
     * in the input dataset. The value should be a regressor.
     */
    targetToRegressorMap?: Map_Type<string, MlPipe<any, any, any, any, any>> | {[key: string]: IMlPipe<any, any, any, any, any>};
  }
}
 ...
 * original input.
 *
 * @remarks this represents a made instance of ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline
 */
declare namespace ReliabilityRiskMl.Reconstruction {
  export class VirtualSensorPipeline<DX, DO, DI> extends Obj  {

    /**
     * List of all vertices in this graph.
     */
    readonly vertices?: Array_Type<MlPipeline.Vertex>;
    withVertices(vertices: Array_Type<MlPipeline.Vertex> | Array<IMlPipeline.Vertex> | null): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline;

    /**
     * List of all edges in this graph.
     */
    readonly edges?: Array_Type<FlowGraph.Edge<MlPipeline.Vertex>>;
    withEdges(edges: Array_Type<FlowGraph.Edge<MlPipeline.Vertex>> | Array<IFlowGraph.Edge<MlPipeline.Vertex>> | null): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline;
    ...
    withVertexConnections(vertexConnections: Map_Type<string, Map_Type<string, any>> | {[key: string]: Map_Type<string, any> | {[key: string]: any}} | null): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline;
     ...
     */
    readonly id: string;
    withId(id: string): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline;

    /**
     * Name of this pipe.
     */
    readonly name?: string;
    withName(name: string | null): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline;
    ...
    withVersion(version: number | null): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline;
    ...
    withUserUpdatedFields(userUpdatedFields: Array_Type<string> | Array<string> | null): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline;
    ...
    withHidden(hidden: boolean): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline;
    ...
    withUserOwned(userOwned: boolean): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline;
    ...
    withTypeIdent(typeIdent: string | null): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline;

    /**
     * If true, then the pipe shall not be retrained
     */
    readonly frozen?: boolean;
    withFrozen(frozen: boolean): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline;

    /**
     * True if training has succeeded and false otherwise.
     */
    readonly trained?: boolean;
    withTrained(trained: boolean): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline;

    /**
     * Errors from training.
     */
    readonly trainingErrors?: string;
    withTrainingErrors(trainingErrors: string | null): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline;

    /**
     * If true, the underlying model only accepts flattened input.
     */
    readonly flattenInput?: boolean;
    withFlattenInput(flattenInput: boolean): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline;

    /**
     * The hyperparameters overridden of a native model or pipe.
     */
    readonly hyperparamOverrides?: Map_Type<string, any>;
    withHyperparamOverrides(hyperparamOverrides: Map_Type<string, any> | {[key: string]: any} | null): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline;
    ...
    withHyperparamSearchSpace(hyperparamSearchSpace: IHp.SearchSpace | null): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline;
    ...
    withHpoSpec(hpoSpec: IHpo.Spec | null): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline;

    /**
     * {@link Hpo.Experiment} stores the result of hyperparameter optimization to find the best model/pipeline.
     */
    readonly hpoExperiment?: Hpo.Experiment;
    withHpoExperiment(hpoExperiment: IHpo.Experiment | null): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline;

    /**
     * Reference to the experiment that produced this {@link MlPipe}. For example, this could be a {@link Hpo.ExperimentBase}.
     */
    readonly experiment?: any;
    withExperiment(experiment: any | null): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline;

    /**
     * Names of the {@link #score} outputs for this machine learning pipeline.
     */
    readonly scoreNames?: Set_Type<string>;
    withScoreNames(scoreNames: Set_Type<string> | Array<string> | null): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline;
    ...
    withTrainRun(trainRun: IWorkflowExecutorRun | null): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline;
    ...
    withTrainStatus(trainStatus: IWorkflow.Status | null): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline;
    ...
    withDoNotAutoUpsert(doNotAutoUpsert: boolean): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline;
    ...
    withFeatures(features: Array_Type<string> | Array<string>): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline;
     ...
     * estimators for.
     */
    readonly targetsToReconstruct?: Array_Type<string>;
    withTargetsToReconstruct(targetsToReconstruct: Array_Type<string> | Array<string> | null): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline;
     ...
     * regressors.
     */
    readonly targetToFeaturesMap?: Map_Type<string, Array_Type<string>>;
    withTargetToFeaturesMap(targetToFeaturesMap: Map_Type<string, Array_Type<string>> | {[key: string]: Array_Type<string> | Array<string>} | null): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline;

    /**
     * By default, if not overridden by {@link targetToRegressorMap}, every feature
     * will be regressed against using this template regressor.
     */
    readonly templateRegressor: MlPipe<any, any, any, any, any>;
    withTemplateRegressor(templateRegressor: IMlPipe<any, any, any, any, any>): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline;
     ...
     * in the input dataset. The value should be a regressor.
     */
    readonly targetToRegressorMap?: Map_Type<string, MlPipe<any, any, any, any, any>>;
    withTargetToRegressorMap(targetToRegressorMap: Map_Type<string, MlPipe<any, any, any, any, any>> | {[key: string]: IMlPipe<any, any, any, any, any>} | null): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline;
     ...
     * @see #toJson
     */
    static fromJson(json: any): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI> | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI> | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI> | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI> | null;
     ...
     */
    replaceType(old: Type, new_: Type): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>;
     ...
     * @see #removeField
     */
    withoutField(field: string): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>;
     ...
     */
    withoutFields(fields: Array_Type<string>): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>;
     ...
     * @see #unsetField
     */
    defaultField(field: string): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>;
     ...
     * @see #removeField
     */
    unsetField(field: string): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>;
     ...
     * @see #unsetField
     */
    removeField(field: string): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>;

    mergeJson(json: any): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>;
     ...
     */
    sumObj(other: Obj, deep?: boolean): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>;
     ...
     */
    singletonArray(): Array_Type<ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>;
     ...
     * @see #fromString
     */
    static make(s: string): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI> | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>;
     ...
     */
    static cachedEmptyInst(): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>;
     ...
     */
    remakeTemplate(): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>;
     ...
     */
    precomputeVertexConnections(): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>;
     ...
     */
    mapVertices(mapper: λFunction<MlPipeline.Vertex | null, T | null>): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>;
     ...
     */
    topologicalSort(reverse?: boolean): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>;
     ...
     */
    ancestorGraph(sink: FlowGraph.Vertex): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>;
     ...
     */
    replaceVertex(oldVertex: FlowGraph.Vertex, newVertex: FlowGraph.Vertex, doNotMerge?: boolean, removeDisconnectedEdges?: boolean): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>;
     ...
     */
    replaceVertices(oldVertices: Array_Type<FlowGraph.Vertex>, newVertex: FlowGraph.Vertex, spec?: FlowGraphReplaceSpec): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>;
     ...
     * @return
     */
    replaceVertices(oldVertices: Array_Type<FlowGraph.Vertex>, newVertices: Array_Type<FlowGraph.Vertex>, newEdges?: Array_Type<FlowGraph.Edge<FlowGraph.Vertex>>, spec?: FlowGraphReplaceSpec): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>;
     ...
     * connected.
     */
    removeVertex(toRemove: FlowGraph.Vertex): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>;

    removeVertex(idToRemove: string): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>;
     ...
     */
    removeVertices(toRemove?: Array_Type<FlowGraph.Vertex>): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>;
     ...
     */
    mergeWith(other: ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>;
     ...
     */
    train(x: DX, y?: , spec?: MlOperationSpec): MlOperationRun<any>;

    /**
     * Blocking, synchronous version of {@link #train}.
     */
    trainSync(x: DX, y?: , spec?: MlOperationSpec): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>;
     ...
     *           the operation run object to query status and to get the final result.
     */
    score(x: DX, y?: , context?: , spec?: MlOperationSpec): MlOperationRun<Map_Type<string, number>> | null;

    /**
     * Blocking, synchronous version of {@link #score}.
     */
    scoreSync(x: DX, y?: , context?: , spec?: MlOperationSpec): Map_Type<string, number> | null;
     ...
     *           the operation run object to query status and to get the final result.
     */
    scoreAll(x: DX, y?: , context?: , spec?: MlOperationSpec): MlOperationRun<Map_Type<string, number>> | null;

    /**
     * Blocking, synchronous version of {@link #scoreAll}.
     */
    scoreAllSync(x: DX, y?: , context?: , spec?: MlOperationSpec): Map_Type<string, number> | null;
     ...
     *           the operation run object to query status and to get the final result.
     */
    interpret(x: DX, spec?: MlOperationSpec): MlOperationRun<DI> | null;

    /**
     * Blocking, synchronous version of {@link #interpret}.
     */
    interpretSync(x: DX, context?: Map_Type<string, any>, spec?: MlOperationSpec): DI | null;
     ...
     */
    static allCached(doNotProduceAll?: boolean): Stream<ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>> | null;
     ...
     */
    static find(filter?: string, doNotProduceAll?: boolean): Stream<ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>> | null;
     ...
     * @return existing instances of this type that satisfy filter from data cache.
     */
    static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>> | null;
     ...
     * @see getCached
     */
    static findByCacheKey(key: string): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI> | null;
     ...
     * @see findByCacheKey
     */
    static forCacheKey(key: string): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI> | null;
     ...
     * @see findByCacheKey
     */
    getCached(): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI> | null;

    /**
     * @return newly produced cached instance.
     */
    refreshCache(): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI> | null;
     ...
     */
    static produce(key: string): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI> | null;
     ...
     */
    static produceAll(): Map_Type<string, ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>> | null;

    /**
     * Override for sub-types to produce all values.
     */
    static doProduceAll(): Map_Type<string, ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>> | null;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>>> | null;
     ...
     */
    get(include?: string): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI> | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI> | null;
     ...
     */
    getMissing(spec: GetMissingSpec): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI> | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>;
     ...
     * @see #toString
     */
    static fromString(s: string): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI> | null;
     ...
     */
    create(spec?: UpsertSpec): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI> | null;
     ...
     */
    static createBatch(objs: Array_Type<ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>> | null;
     ...
     */
    update(srcObj?: ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>, spec?: UpsertSpec): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI> | null;
     ...
     */
    upsert(srcObj?: ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>, spec?: UpsertSpec): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI> | null;
     ...
     */
    merge(spec?: MergeSpec): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI> | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI> | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI> | null;
     ...
     */
    static updateBatch(objs: Array_Type<ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>>, srcObjs?: Array_Type<ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>> | null>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>>, srcObjs?: Array_Type<ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>> | null>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>>, spec?: TouchSpec): ObjList<ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>>, spec?: MergeSpec): ObjList<ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>> | null;
     ...
     */
    static mergeAll(mergeObj: ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI> | null;
     ...
     */
    static beforeCreate(objs: Array_Type<ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>>): ObjList<ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>>;
     ...
     */
    static beforeUpdate(objs: Array_Type<ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>>): ObjList<ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>>): ObjList<ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>>;
     ...
     */
    static afterCreate(objs: Array_Type<ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI> | null;
     ...
     */
    withoutIdentity(): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI> | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>>, callback?: λFunction<ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI> | null, ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI> | null>): ObjList<ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>>, callback?: λFunction<ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI> | null, ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI> | null>): Array_Type<ObjError> | null;
     ...
     */
    publish(subPath?: string, contentType?: string): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>;
     ...
     */
    static removeSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>> | null;
     ...
     */
    createSeedData(spec?: UpsertSpec): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI> | null;
     ...
     */
    static createSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>> | null;
     ...
     */
    updateSeedData(srcObj?: SeedData, spec?: UpsertSpec): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI> | null;
     ...
     */
    static updateSeedDataBatch(objs?: Array_Type<SeedData>, srcObjs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>> | null;
     ...
     * @return updated obj instance, same as {@link Persistable#update} return value.
     */
    clearUserUpdates(spec?: MergeSpec): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI> | null;
     ...
     *         {@link Persistable#updateBatch}.
     */
    static clearUserUpdatesBatch(objs?: Array_Type<SeedData>, spec?: MergeSpec): ObjList<ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>> | null;
    ...
    dependencies(): SeedDataDeps<ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>> | null;
     ...
     */
    static convert(model: any, spec?: MlConvertSpec): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>;

    /**
     * Freezes an {@link MlPipe}
     * @return modified copy of this {@link MlPipe} that cannot be trained
     */
    freeze(): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>;
     ...
     */
    freeze(paths?: Array_Type<string>): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>;

    /**
     * Unfreezes an {@link MlPipe}
     * @return modified copy of this {@link MlPipe} that can be trained
     */
    unfreeze(): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>;
     ...
     */
    unfreeze(paths?: Array_Type<string>): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>;
     ...
     */
    newAuthoringVertex(x?: DX, y?: , context?: , suffix?: string = '""', spec?: MlConvertSpec): MlPipeline.PipeVertex.Authoring;
     ...
     * be returned as-is.
     */
    byReference(): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>;
     ...
     */
    translate(x?: DX, y?: , context?: , spec?: MlOperationSpec, opName?: Array_Type<string>, workflowId?: string): ;
     ...
     */
    translateAndExecute(x?: DX, y?: , context?: , spec?: MlOperationSpec, opName?: Array_Type<string>, workflowId?: string): MlOperationRun<any>;
     ...
     */
    train_verify(x?: DX, y?: , spec?: MlOperationSpec): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>;
     ...
     */
    trainOnly(x?: DX, y?: , spec?: MlOperationSpec): MlOperationRun<any>;
    ...
    trainOnServer(x: DX, y?: , spec?: MlOperationSpec): MlOperationRun<any>;

    processOnServer(x: DX, spec?: MlOperationSpec): MlOperationRun<DO> | null;

    scoreOnServer(x: DX, y?: , context?: , spec?: MlOperationSpec): MlOperationRun<Map_Type<string, number>> | null;

    scoreAllOnServer(x: DX, y?: , context?: , spec?: MlOperationSpec): MlOperationRun<Map_Type<string, number>> | null;

    interpretOnServer(x: DX, spec?: MlOperationSpec): MlOperationRun<DI> | null;
     ...
     */
    withHyperparamSpaces(paramSpaces: Map_Type<string, Map_Type<string, Hp.ParamSpace>>): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>;
     ...
     */
    replacePipe(pipePath: string, newPipe: MlPipe<any, any, any, any, any>): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>;
     ...
     */
    replaceInterpreter(interpreterPath: string, newInterpreter: MlInterpreter<any, any>): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>;
     ...
     */
    flatten(): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>;
     ...
     */
    static fromV7Json(pipeline: string, runtimeRequirements: Array_Type<string>): ReliabilityRiskMl.Reconstruction.VirtualSensorPipeline<DX, DO, DI>;
