// TypeScript definitions for the C3 type ReliabilityRiskMlScoringMetric

/**
 * This abstract type represents a template for {@link ReliabilityRiskMl.Pipeline.ScoringMetric} and
 * {@link ReliabilityRiskMl.ReconstructionPipeline.ScoringMetric}.
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityRiskMlScoringMetric
 */
declare interface IReliabilityRiskMlScoringMetric<DO, DY> {
  ...
  /**
   * A list of model outputs to select for scoring.
   */
  outputsToSelect: Array_Type<string> | Array<string>;

  /**
   * A list of model inputs or targets to select for scoring.
   */
 ...
 * {@link ReliabilityRiskMl.ReconstructionPipeline.ScoringMetric}.
 *
 * @remarks this represents a made instance of ReliabilityRiskMlScoringMetric
 */
declare class ReliabilityRiskMlScoringMetric<DO, DY> extends Obj  {

  /**
   * Name of this scoring metric.
   */
  readonly name?: string;
  withName(name: string | null): ReliabilityRiskMlScoringMetric;
  ...
  withUseIndex(useIndex: boolean): ReliabilityRiskMlScoringMetric;
  ...
  withBatchSize(batchSize: number | null): ReliabilityRiskMlScoringMetric;
  ...
  withActualScoringMetric(actualScoringMetric: IMlScoringMetric<any, any, any>): ReliabilityRiskMlScoringMetric;

  /**
   * A list of model outputs to select for scoring.
   */
  readonly outputsToSelect: Array_Type<string>;
  withOutputsToSelect(outputsToSelect: Array_Type<string> | Array<string>): ReliabilityRiskMlScoringMetric;

  /**
   * A list of model inputs or targets to select for scoring.
   */
  readonly targetsToSelect?: Array_Type<string>;
  withTargetsToSelect(targetsToSelect: Array_Type<string> | Array<string> | null): ReliabilityRiskMlScoringMetric;
   ...
   * @see #toJson
   */
  static fromJson(json: any): ReliabilityRiskMlScoringMetric<DO, DY> | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): ReliabilityRiskMlScoringMetric<DO, DY> | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): ReliabilityRiskMlScoringMetric<DO, DY> | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): ReliabilityRiskMlScoringMetric<DO, DY> | null;
   ...
   */
  replaceType(old: Type, new_: Type): ReliabilityRiskMlScoringMetric<DO, DY>;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityRiskMlScoringMetric<DO, DY>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityRiskMlScoringMetric<DO, DY>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityRiskMlScoringMetric<DO, DY>>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityRiskMlScoringMetric<DO, DY>>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityRiskMlScoringMetric<DO, DY>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityRiskMlScoringMetric<DO, DY>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityRiskMlScoringMetric<DO, DY>;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ReliabilityRiskMlScoringMetric<DO, DY>;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ReliabilityRiskMlScoringMetric<DO, DY>;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityRiskMlScoringMetric<DO, DY>;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityRiskMlScoringMetric<DO, DY>;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityRiskMlScoringMetric<DO, DY>;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ReliabilityRiskMlScoringMetric<DO, DY>;
   ...
   * @see #removeField
   */
  withoutField(field: string): ReliabilityRiskMlScoringMetric<DO, DY>;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): ReliabilityRiskMlScoringMetric<DO, DY>;
   ...
   */
  withoutFields(fields: Array_Type<string>): ReliabilityRiskMlScoringMetric<DO, DY>;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityRiskMlScoringMetric<DO, DY>;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ReliabilityRiskMlScoringMetric<DO, DY>;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityRiskMlScoringMetric<DO, DY>;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ReliabilityRiskMlScoringMetric<DO, DY>;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ReliabilityRiskMlScoringMetric<DO, DY>;
   ...
   * @see #removeField
   */
  unsetField(field: string): ReliabilityRiskMlScoringMetric<DO, DY>;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ReliabilityRiskMlScoringMetric<DO, DY>;
   ...
   * @see #unsetField
   */
  removeField(field: string): ReliabilityRiskMlScoringMetric<DO, DY>;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ReliabilityRiskMlScoringMetric<DO, DY>;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityRiskMlScoringMetric<DO, DY>;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityRiskMlScoringMetric<DO, DY>;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityRiskMlScoringMetric<DO, DY>;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityRiskMlScoringMetric<DO, DY>;

  mergeJson(json: any): ReliabilityRiskMlScoringMetric<DO, DY>;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityRiskMlScoringMetric<DO, DY>;
   ...
   */
  sumObj(other: Obj, deep?: boolean): ReliabilityRiskMlScoringMetric<DO, DY>;
   ...
   */
  singletonArray(): Array_Type<ReliabilityRiskMlScoringMetric<DO, DY>>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityRiskMlScoringMetric<DO, DY>> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ReliabilityRiskMlScoringMetric<DO, DY>> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<ReliabilityRiskMlScoringMetric<DO, DY>>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ReliabilityRiskMlScoringMetric<DO, DY>> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, ReliabilityRiskMlScoringMetric<DO, DY>> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityRiskMlScoringMetric<DO, DY>> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ReliabilityRiskMlScoringMetric<DO, DY>>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ReliabilityRiskMlScoringMetric<DO, DY>>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityRiskMlScoringMetric<DO, DY>;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityRiskMlScoringMetric<DO, DY>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityRiskMlScoringMetric<DO, DY>;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ReliabilityRiskMlScoringMetric<DO, DY>;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityRiskMlScoringMetric<DO, DY>;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ReliabilityRiskMlScoringMetric<DO, DY>;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityRiskMlScoringMetric<DO, DY>;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): ReliabilityRiskMlScoringMetric<DO, DY>;
   ...
   */
  static cachedEmptyInst(): ReliabilityRiskMlScoringMetric<DO, DY>;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityRiskMlScoringMetric<DO, DY>> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): ReliabilityRiskMlScoringMetric<DO, DY>;
   ...
   */
  convertInputsToNative(targetOutput: DY, modelOutput: DO, context?: ): any;
