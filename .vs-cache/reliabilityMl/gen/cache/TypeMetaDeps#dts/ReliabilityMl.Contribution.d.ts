// TypeScript definitions for the C3 type ReliabilityMl.Contribution

/**
 * Represents a contribution related to model predictions, such as machine learning model outputs
 * or reliability assessments. This entity captures a contribution value with associated upper and lower bounds,
 * which may be used in various predictive or diagnostic applications for tracking model contributions and assessing their significance.
 * This entity type mixes the properties of `TimedDataPoint` and includes metadata from `ReliabilityMl.ContributionHeader`.
 * The fields provided here allow storing and tracking the contribution value over time, along with its bounds for validation purposes.
 * For details on other information stored in this Type, refer to the documentation on each of the fields of this Type.
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityMl.Contribution
 */
declare namespace ReliabilityMl {
  export interface IContribution {
    ...
    parent: IReliabilityMl.ContributionHeader;
    ...
    /**
     * The contribution value associated with the model prediction or reliability assessment.
     * This value could represent the importance, significance, or impact of a given prediction in the context
     * of the overall model output or reliability model.
     * `@ts(treatmentPath='parent.treatment')` - Specifies the path to retrieve the treatment value from the parent entity.
     * The treatment may involve scaling, adjusting, or interpreting the value based on specific treatment rules or configurations.
     */
    contribution: number;

    /**
     * The upper bound for the contribution value.
     * This defines the maximum permissible value for the contribution. This can be useful for ensuring that
     * the model predictions or assessments do not exceed a certain threshold, whether for business logic or for safety concerns.
     * For example, if the contribution represents the percentage impact of a model, the upper bound may be constrained to 100%.
     */
    contributionUpperBound?: number;

    /**
     * The lower bound for the contribution value.
     * This defines the minimum permissible value for the contribution. It ensures that the contribution does not
     * fall below a predefined threshold, which may be useful for avoiding overly small or negative values that are not meaningful in the given context.
     * For example, in reliability models, a negative contribution may be illogical, so the lower bound might ensure that the value is positive.
     */
 ...
 * For details on other information stored in this Type, refer to the documentation on each of the fields of this Type.
 *
 * @remarks this represents a made instance of ReliabilityMl.Contribution
 */
declare namespace ReliabilityMl {
  export class Contribution extends Obj  {

    /**
     * start date for the data point
     */
    readonly start: DateTime;
    withStart(start: DateTime | Date | string): ReliabilityMl.Contribution;
    ...
    withOutlierCode(outlierCode: number | null): ReliabilityMl.Contribution;

    /**
     * (Optional) any comments for the data point
     */
    readonly comments?: string;
    withComments(comments: string | null): ReliabilityMl.Contribution;

    /**
     * Denotes if the value is an actual value or an estimated value. default = null (actual value)
     */
    readonly isEstimated?: boolean;
    withIsEstimated(isEstimated: boolean): ReliabilityMl.Contribution;
    ...
    withDataVersion(dataVersion: number | null): ReliabilityMl.Contribution;

    /**
     * Customer specific status code for the data point (may be used to denote data quality)
     */
    readonly statusCode?: string;
    withStatusCode(statusCode: string | null): ReliabilityMl.Contribution;

    /**
     * Partition key Bin separator used to separate partition key from bin id
     */
    readonly PK_BIN_SEPARATOR?: string;
    withPK_BIN_SEPARATOR(PK_BIN_SEPARATOR: string | null): ReliabilityMl.Contribution;

    readonly parent: ReliabilityMl.ContributionHeader;
    withParent(parent: IReliabilityMl.ContributionHeader): ReliabilityMl.Contribution;
    ...
    withTypeIdent(typeIdent: string | null): ReliabilityMl.Contribution;
     ...
     */
    readonly id: string;
    withId(id: string): ReliabilityMl.Contribution;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityMl.Contribution;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): ReliabilityMl.Contribution;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): ReliabilityMl.Contribution;
    ...
    withVersion(version: number | null): ReliabilityMl.Contribution;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): ReliabilityMl.Contribution;
    ...
    withContribution(contribution: number): ReliabilityMl.Contribution;
    ...
    withContributionUpperBound(contributionUpperBound: number | null): ReliabilityMl.Contribution;
    ...
    withContributionLowerBound(contributionLowerBound: number | null): ReliabilityMl.Contribution;
     ...
     * @see #toJson
     */
    static fromJson(json: any): ReliabilityMl.Contribution | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): ReliabilityMl.Contribution | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): ReliabilityMl.Contribution | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): ReliabilityMl.Contribution | null;
     ...
     */
    replaceType(old: Type, new_: Type): ReliabilityMl.Contribution;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityMl.Contribution;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityMl.Contribution;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityMl.Contribution>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityMl.Contribution>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityMl.Contribution;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityMl.Contribution;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityMl.Contribution;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): ReliabilityMl.Contribution;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): ReliabilityMl.Contribution;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityMl.Contribution;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityMl.Contribution;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityMl.Contribution;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): ReliabilityMl.Contribution;
     ...
     * @see #removeField
     */
    withoutField(field: string): ReliabilityMl.Contribution;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): ReliabilityMl.Contribution;
     ...
     */
    withoutFields(fields: Array_Type<string>): ReliabilityMl.Contribution;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityMl.Contribution;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): ReliabilityMl.Contribution;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityMl.Contribution;
     ...
     * @see #unsetField
     */
    defaultField(field: string): ReliabilityMl.Contribution;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): ReliabilityMl.Contribution;
     ...
     * @see #removeField
     */
    unsetField(field: string): ReliabilityMl.Contribution;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): ReliabilityMl.Contribution;
     ...
     * @see #unsetField
     */
    removeField(field: string): ReliabilityMl.Contribution;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): ReliabilityMl.Contribution;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityMl.Contribution;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityMl.Contribution;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityMl.Contribution;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityMl.Contribution;

    mergeJson(json: any): ReliabilityMl.Contribution;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityMl.Contribution;
     ...
     */
    sumObj(other: Obj, deep?: boolean): ReliabilityMl.Contribution;
     ...
     */
    singletonArray(): Array_Type<ReliabilityMl.Contribution>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityMl.Contribution> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<ReliabilityMl.Contribution> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<ReliabilityMl.Contribution>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<ReliabilityMl.Contribution> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, ReliabilityMl.Contribution> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityMl.Contribution> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<ReliabilityMl.Contribution>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<ReliabilityMl.Contribution>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityMl.Contribution;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityMl.Contribution;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityMl.Contribution;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): ReliabilityMl.Contribution;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityMl.Contribution;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): ReliabilityMl.Contribution;
     ...
     * @see #fromString
     */
    static make(s: string): ReliabilityMl.Contribution | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityMl.Contribution;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): ReliabilityMl.Contribution;
     ...
     */
    static cachedEmptyInst(): ReliabilityMl.Contribution;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityMl.Contribution> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): ReliabilityMl.Contribution;

    /**
     * Extract the partition key from the given obj
     */
    partitionKey(failIfMissing?: boolean): ReliabilityMl.ContributionHeader | null;
     ...
     */
    static partition(objs?: Stream<ReliabilityMl.Contribution>, spec?: PartitionBucketStrategy): Map_Type<string, KvDataPartition> | null;
     ...
     */
    static fromPartitions(partitions?: Stream<KvDataPartition>): Stream<ReliabilityMl.Contribution> | null;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<ReliabilityMl.Contribution>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<ReliabilityMl.Contribution>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityMl.Contribution> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityMl.Contribution>> | null;
     ...
     */
    get(include?: string): ReliabilityMl.Contribution | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): ReliabilityMl.Contribution | null;
     ...
     */
    getMissing(spec: GetMissingSpec): ReliabilityMl.Contribution;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): ReliabilityMl.Contribution | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): ReliabilityMl.Contribution;
     ...
     * @see #toString
     */
    static fromString(s: string): ReliabilityMl.Contribution | null;
     ...
     */
    create(spec?: UpsertSpec): ReliabilityMl.Contribution | null;
     ...
     */
    static createBatch(objs: Array_Type<ReliabilityMl.Contribution>, spec?: UpsertSpec): ObjList<ReliabilityMl.Contribution> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<ReliabilityMl.Contribution>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityMl.Contribution> | null;
     ...
     */
    update(srcObj?: ReliabilityMl.Contribution, spec?: UpsertSpec): ReliabilityMl.Contribution | null;
     ...
     */
    upsert(srcObj?: ReliabilityMl.Contribution, spec?: UpsertSpec): ReliabilityMl.Contribution | null;
     ...
     */
    merge(spec?: MergeSpec): ReliabilityMl.Contribution | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): ReliabilityMl.Contribution | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): ReliabilityMl.Contribution | null;
     ...
     */
    static updateBatch(objs: Array_Type<ReliabilityMl.Contribution>, srcObjs?: Array_Type<ReliabilityMl.Contribution>, spec?: UpsertSpec): ObjList<ReliabilityMl.Contribution> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<ReliabilityMl.Contribution> | null>, spec?: UpsertSpec): ObjList<ReliabilityMl.Contribution> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<ReliabilityMl.Contribution>, srcObjs?: Array_Type<ReliabilityMl.Contribution>, spec?: UpsertSpec): ObjList<ReliabilityMl.Contribution> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<ReliabilityMl.Contribution> | null>, spec?: UpsertSpec): ObjList<ReliabilityMl.Contribution> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<ReliabilityMl.Contribution>, spec?: TouchSpec): ObjList<ReliabilityMl.Contribution> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityMl.Contribution>, spec?: MergeSpec): ObjList<ReliabilityMl.Contribution> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityMl.Contribution>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityMl.Contribution> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<ReliabilityMl.Contribution> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityMl.Contribution> | null;
     ...
     */
    static mergeAll(mergeObj: ReliabilityMl.Contribution, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: ReliabilityMl.Contribution, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<ReliabilityMl.Contribution>, spec?: UpsertSpec): ObjList<ReliabilityMl.Contribution> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<ReliabilityMl.Contribution>, spec?: UpsertSpec): ObjList<ReliabilityMl.Contribution> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): ReliabilityMl.Contribution | null;
     ...
     */
    static beforeCreate(objs: Array_Type<ReliabilityMl.Contribution>): ObjList<ReliabilityMl.Contribution>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<ReliabilityMl.Contribution>): ObjList<ReliabilityMl.Contribution>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<ReliabilityMl.Contribution>): ObjList<ReliabilityMl.Contribution>;
     ...
     */
    static afterCreate(objs: Array_Type<ReliabilityMl.Contribution>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<ReliabilityMl.Contribution>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<ReliabilityMl.Contribution>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityMl.Contribution>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityMl.Contribution>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): ReliabilityMl.Contribution | null;
     ...
     */
    withoutIdentity(): ReliabilityMl.Contribution | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<ReliabilityMl.Contribution>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: ReliabilityMl.Contribution, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<ReliabilityMl.Contribution>, callback?: λFunction<ReliabilityMl.Contribution | null, ReliabilityMl.Contribution | null>): ObjList<ReliabilityMl.Contribution>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<ReliabilityMl.Contribution>, callback?: λFunction<ReliabilityMl.Contribution | null, ReliabilityMl.Contribution | null>): Array_Type<ObjError> | null;
