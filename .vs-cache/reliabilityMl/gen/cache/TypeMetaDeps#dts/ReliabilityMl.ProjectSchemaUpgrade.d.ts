// TypeScript definitions for the C3 type ReliabilityMl.ProjectSchemaUpgrade

/**
 * Schema upgrade for {@link ReliabilityMl.Project}.
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityMl.ProjectSchemaUpgrade
 */
declare namespace ReliabilityMl {
  export interface IProjectSchemaUpgrade {
  }
}
 ...
 */
declare namespace ReliabilityMl {
  export class ProjectSchemaUpgrade extends Obj  {
     ...
     * @see #toJson
     */
    static fromJson(json: any): ReliabilityMl.ProjectSchemaUpgrade | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): ReliabilityMl.ProjectSchemaUpgrade | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): ReliabilityMl.ProjectSchemaUpgrade | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): ReliabilityMl.ProjectSchemaUpgrade | null;
     ...
     */
    replaceType(old: Type, new_: Type): ReliabilityMl.ProjectSchemaUpgrade;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityMl.ProjectSchemaUpgrade;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityMl.ProjectSchemaUpgrade;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityMl.ProjectSchemaUpgrade>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityMl.ProjectSchemaUpgrade>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityMl.ProjectSchemaUpgrade;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityMl.ProjectSchemaUpgrade;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityMl.ProjectSchemaUpgrade;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): ReliabilityMl.ProjectSchemaUpgrade;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): ReliabilityMl.ProjectSchemaUpgrade;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityMl.ProjectSchemaUpgrade;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityMl.ProjectSchemaUpgrade;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityMl.ProjectSchemaUpgrade;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): ReliabilityMl.ProjectSchemaUpgrade;
     ...
     * @see #removeField
     */
    withoutField(field: string): ReliabilityMl.ProjectSchemaUpgrade;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): ReliabilityMl.ProjectSchemaUpgrade;
     ...
     */
    withoutFields(fields: Array_Type<string>): ReliabilityMl.ProjectSchemaUpgrade;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityMl.ProjectSchemaUpgrade;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): ReliabilityMl.ProjectSchemaUpgrade;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityMl.ProjectSchemaUpgrade;
     ...
     * @see #unsetField
     */
    defaultField(field: string): ReliabilityMl.ProjectSchemaUpgrade;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): ReliabilityMl.ProjectSchemaUpgrade;
     ...
     * @see #removeField
     */
    unsetField(field: string): ReliabilityMl.ProjectSchemaUpgrade;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): ReliabilityMl.ProjectSchemaUpgrade;
     ...
     * @see #unsetField
     */
    removeField(field: string): ReliabilityMl.ProjectSchemaUpgrade;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): ReliabilityMl.ProjectSchemaUpgrade;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityMl.ProjectSchemaUpgrade;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityMl.ProjectSchemaUpgrade;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityMl.ProjectSchemaUpgrade;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityMl.ProjectSchemaUpgrade;

    mergeJson(json: any): ReliabilityMl.ProjectSchemaUpgrade;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityMl.ProjectSchemaUpgrade;
     ...
     */
    sumObj(other: Obj, deep?: boolean): ReliabilityMl.ProjectSchemaUpgrade;
     ...
     */
    singletonArray(): Array_Type<ReliabilityMl.ProjectSchemaUpgrade>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityMl.ProjectSchemaUpgrade> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<ReliabilityMl.ProjectSchemaUpgrade> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<ReliabilityMl.ProjectSchemaUpgrade>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<ReliabilityMl.ProjectSchemaUpgrade> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, ReliabilityMl.ProjectSchemaUpgrade> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityMl.ProjectSchemaUpgrade> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<ReliabilityMl.ProjectSchemaUpgrade>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<ReliabilityMl.ProjectSchemaUpgrade>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityMl.ProjectSchemaUpgrade;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityMl.ProjectSchemaUpgrade;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityMl.ProjectSchemaUpgrade;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): ReliabilityMl.ProjectSchemaUpgrade;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityMl.ProjectSchemaUpgrade;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): ReliabilityMl.ProjectSchemaUpgrade;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityMl.ProjectSchemaUpgrade;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): ReliabilityMl.ProjectSchemaUpgrade;
     ...
     */
    static cachedEmptyInst(): ReliabilityMl.ProjectSchemaUpgrade;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityMl.ProjectSchemaUpgrade> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): ReliabilityMl.ProjectSchemaUpgrade;
     ...
     * field populated.
     */
    static migrateResidualRiskFeatureOutputs_7(): void;
  }
}
