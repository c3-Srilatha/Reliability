// TypeScript definitions for the C3 type ReliabilityMl.ValidationPrediction

/**
 * Represents a predicted value within the context of machine learning or reliability modeling.
 * This entity captures the predicted value for model validation, including bounds on the predicted value
 * and other relevant metadata for tracking the performance and reliability of the model.
 * For details on other information stored in this Type, refer to the documentation on each of the fields of this Type.
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityMl.ValidationPrediction
 */
declare namespace ReliabilityMl {
  export interface IValidationPrediction {
    ...
    parent: IReliabilityMl.ValidationPredictionHeader;
    ...
    /**
     * Represents the predicted value for a validation, typically a numerical value that indicates
     * the expected outcome of a model validation.
     * `@ts(treatmentPath="parent.treatment", unitPath="parent.unitConstraint")` - Specifies the paths to retrieve
     * the treatment value and unit constraint from the parent entity.
     */
    value: number;

    /**
     * The upper bound for the predicted value.
     * This defines the maximum allowed value for the prediction and can be used to set a threshold or boundary
     * for validation. It helps in ensuring the prediction doesn't exceed certain predefined limits.
     */
    valueUpperBound?: number;

    /**
     * The lower bound for the predicted value.
     * This defines the minimum allowed value for the prediction, ensuring it stays within a meaningful and
     * acceptable range. This can be useful for validation checks, ensuring the value does not fall below a certain threshold.
     */
 ...
 * For details on other information stored in this Type, refer to the documentation on each of the fields of this Type.
 *
 * @remarks this represents a made instance of ReliabilityMl.ValidationPrediction
 */
declare namespace ReliabilityMl {
  export class ValidationPrediction extends Obj  {

    /**
     * start date for the data point
     */
    readonly start: DateTime;
    withStart(start: DateTime | Date | string): ReliabilityMl.ValidationPrediction;
    ...
    withOutlierCode(outlierCode: number | null): ReliabilityMl.ValidationPrediction;

    /**
     * (Optional) any comments for the data point
     */
    readonly comments?: string;
    withComments(comments: string | null): ReliabilityMl.ValidationPrediction;

    /**
     * Denotes if the value is an actual value or an estimated value. default = null (actual value)
     */
    readonly isEstimated?: boolean;
    withIsEstimated(isEstimated: boolean): ReliabilityMl.ValidationPrediction;
    ...
    withDataVersion(dataVersion: number | null): ReliabilityMl.ValidationPrediction;

    /**
     * Customer specific status code for the data point (may be used to denote data quality)
     */
    readonly statusCode?: string;
    withStatusCode(statusCode: string | null): ReliabilityMl.ValidationPrediction;

    /**
     * Partition key Bin separator used to separate partition key from bin id
     */
    readonly PK_BIN_SEPARATOR?: string;
    withPK_BIN_SEPARATOR(PK_BIN_SEPARATOR: string | null): ReliabilityMl.ValidationPrediction;

    readonly parent: ReliabilityMl.ValidationPredictionHeader;
    withParent(parent: IReliabilityMl.ValidationPredictionHeader): ReliabilityMl.ValidationPrediction;
    ...
    withTypeIdent(typeIdent: string | null): ReliabilityMl.ValidationPrediction;
     ...
     */
    readonly id: string;
    withId(id: string): ReliabilityMl.ValidationPrediction;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityMl.ValidationPrediction;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): ReliabilityMl.ValidationPrediction;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): ReliabilityMl.ValidationPrediction;
    ...
    withVersion(version: number | null): ReliabilityMl.ValidationPrediction;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): ReliabilityMl.ValidationPrediction;
    ...
    withValue(value: number): ReliabilityMl.ValidationPrediction;
    ...
    withValueUpperBound(valueUpperBound: number | null): ReliabilityMl.ValidationPrediction;
    ...
    withValueLowerBound(valueLowerBound: number | null): ReliabilityMl.ValidationPrediction;
     ...
     * @see #toJson
     */
    static fromJson(json: any): ReliabilityMl.ValidationPrediction | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): ReliabilityMl.ValidationPrediction | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): ReliabilityMl.ValidationPrediction | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): ReliabilityMl.ValidationPrediction | null;
     ...
     */
    replaceType(old: Type, new_: Type): ReliabilityMl.ValidationPrediction;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityMl.ValidationPrediction;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityMl.ValidationPrediction;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityMl.ValidationPrediction>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityMl.ValidationPrediction>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityMl.ValidationPrediction;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityMl.ValidationPrediction;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityMl.ValidationPrediction;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): ReliabilityMl.ValidationPrediction;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): ReliabilityMl.ValidationPrediction;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityMl.ValidationPrediction;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityMl.ValidationPrediction;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityMl.ValidationPrediction;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): ReliabilityMl.ValidationPrediction;
     ...
     * @see #removeField
     */
    withoutField(field: string): ReliabilityMl.ValidationPrediction;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): ReliabilityMl.ValidationPrediction;
     ...
     */
    withoutFields(fields: Array_Type<string>): ReliabilityMl.ValidationPrediction;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityMl.ValidationPrediction;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): ReliabilityMl.ValidationPrediction;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityMl.ValidationPrediction;
     ...
     * @see #unsetField
     */
    defaultField(field: string): ReliabilityMl.ValidationPrediction;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): ReliabilityMl.ValidationPrediction;
     ...
     * @see #removeField
     */
    unsetField(field: string): ReliabilityMl.ValidationPrediction;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): ReliabilityMl.ValidationPrediction;
     ...
     * @see #unsetField
     */
    removeField(field: string): ReliabilityMl.ValidationPrediction;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): ReliabilityMl.ValidationPrediction;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityMl.ValidationPrediction;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityMl.ValidationPrediction;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityMl.ValidationPrediction;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityMl.ValidationPrediction;

    mergeJson(json: any): ReliabilityMl.ValidationPrediction;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityMl.ValidationPrediction;
     ...
     */
    sumObj(other: Obj, deep?: boolean): ReliabilityMl.ValidationPrediction;
     ...
     */
    singletonArray(): Array_Type<ReliabilityMl.ValidationPrediction>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityMl.ValidationPrediction> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<ReliabilityMl.ValidationPrediction> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<ReliabilityMl.ValidationPrediction>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<ReliabilityMl.ValidationPrediction> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, ReliabilityMl.ValidationPrediction> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityMl.ValidationPrediction> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<ReliabilityMl.ValidationPrediction>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<ReliabilityMl.ValidationPrediction>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityMl.ValidationPrediction;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityMl.ValidationPrediction;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityMl.ValidationPrediction;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): ReliabilityMl.ValidationPrediction;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityMl.ValidationPrediction;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): ReliabilityMl.ValidationPrediction;
     ...
     * @see #fromString
     */
    static make(s: string): ReliabilityMl.ValidationPrediction | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityMl.ValidationPrediction;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): ReliabilityMl.ValidationPrediction;
     ...
     */
    static cachedEmptyInst(): ReliabilityMl.ValidationPrediction;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityMl.ValidationPrediction> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): ReliabilityMl.ValidationPrediction;

    /**
     * Extract the partition key from the given obj
     */
    partitionKey(failIfMissing?: boolean): ReliabilityMl.ValidationPredictionHeader | null;
     ...
     */
    static partition(objs?: Stream<ReliabilityMl.ValidationPrediction>, spec?: PartitionBucketStrategy): Map_Type<string, KvDataPartition> | null;
     ...
     */
    static fromPartitions(partitions?: Stream<KvDataPartition>): Stream<ReliabilityMl.ValidationPrediction> | null;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<ReliabilityMl.ValidationPrediction>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<ReliabilityMl.ValidationPrediction>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityMl.ValidationPrediction> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityMl.ValidationPrediction>> | null;
     ...
     */
    get(include?: string): ReliabilityMl.ValidationPrediction | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): ReliabilityMl.ValidationPrediction | null;
     ...
     */
    getMissing(spec: GetMissingSpec): ReliabilityMl.ValidationPrediction;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): ReliabilityMl.ValidationPrediction | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): ReliabilityMl.ValidationPrediction;
     ...
     * @see #toString
     */
    static fromString(s: string): ReliabilityMl.ValidationPrediction | null;
     ...
     */
    create(spec?: UpsertSpec): ReliabilityMl.ValidationPrediction | null;
     ...
     */
    static createBatch(objs: Array_Type<ReliabilityMl.ValidationPrediction>, spec?: UpsertSpec): ObjList<ReliabilityMl.ValidationPrediction> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<ReliabilityMl.ValidationPrediction>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityMl.ValidationPrediction> | null;
     ...
     */
    update(srcObj?: ReliabilityMl.ValidationPrediction, spec?: UpsertSpec): ReliabilityMl.ValidationPrediction | null;
     ...
     */
    upsert(srcObj?: ReliabilityMl.ValidationPrediction, spec?: UpsertSpec): ReliabilityMl.ValidationPrediction | null;
     ...
     */
    merge(spec?: MergeSpec): ReliabilityMl.ValidationPrediction | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): ReliabilityMl.ValidationPrediction | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): ReliabilityMl.ValidationPrediction | null;
     ...
     */
    static updateBatch(objs: Array_Type<ReliabilityMl.ValidationPrediction>, srcObjs?: Array_Type<ReliabilityMl.ValidationPrediction>, spec?: UpsertSpec): ObjList<ReliabilityMl.ValidationPrediction> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<ReliabilityMl.ValidationPrediction> | null>, spec?: UpsertSpec): ObjList<ReliabilityMl.ValidationPrediction> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<ReliabilityMl.ValidationPrediction>, srcObjs?: Array_Type<ReliabilityMl.ValidationPrediction>, spec?: UpsertSpec): ObjList<ReliabilityMl.ValidationPrediction> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<ReliabilityMl.ValidationPrediction> | null>, spec?: UpsertSpec): ObjList<ReliabilityMl.ValidationPrediction> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<ReliabilityMl.ValidationPrediction>, spec?: TouchSpec): ObjList<ReliabilityMl.ValidationPrediction> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityMl.ValidationPrediction>, spec?: MergeSpec): ObjList<ReliabilityMl.ValidationPrediction> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityMl.ValidationPrediction>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityMl.ValidationPrediction> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<ReliabilityMl.ValidationPrediction> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityMl.ValidationPrediction> | null;
     ...
     */
    static mergeAll(mergeObj: ReliabilityMl.ValidationPrediction, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: ReliabilityMl.ValidationPrediction, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<ReliabilityMl.ValidationPrediction>, spec?: UpsertSpec): ObjList<ReliabilityMl.ValidationPrediction> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<ReliabilityMl.ValidationPrediction>, spec?: UpsertSpec): ObjList<ReliabilityMl.ValidationPrediction> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): ReliabilityMl.ValidationPrediction | null;
     ...
     */
    static beforeCreate(objs: Array_Type<ReliabilityMl.ValidationPrediction>): ObjList<ReliabilityMl.ValidationPrediction>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<ReliabilityMl.ValidationPrediction>): ObjList<ReliabilityMl.ValidationPrediction>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<ReliabilityMl.ValidationPrediction>): ObjList<ReliabilityMl.ValidationPrediction>;
     ...
     */
    static afterCreate(objs: Array_Type<ReliabilityMl.ValidationPrediction>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<ReliabilityMl.ValidationPrediction>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<ReliabilityMl.ValidationPrediction>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityMl.ValidationPrediction>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityMl.ValidationPrediction>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): ReliabilityMl.ValidationPrediction | null;
     ...
     */
    withoutIdentity(): ReliabilityMl.ValidationPrediction | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<ReliabilityMl.ValidationPrediction>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: ReliabilityMl.ValidationPrediction, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<ReliabilityMl.ValidationPrediction>, callback?: λFunction<ReliabilityMl.ValidationPrediction | null, ReliabilityMl.ValidationPrediction | null>): ObjList<ReliabilityMl.ValidationPrediction>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<ReliabilityMl.ValidationPrediction>, callback?: λFunction<ReliabilityMl.ValidationPrediction | null, ReliabilityMl.ValidationPrediction | null>): Array_Type<ObjError> | null;
