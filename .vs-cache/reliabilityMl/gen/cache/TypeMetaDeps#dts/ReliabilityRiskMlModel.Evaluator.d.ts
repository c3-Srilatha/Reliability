// TypeScript definitions for the C3 type ReliabilityRiskMlModel.Evaluator

/**
 * A custom {@link MlModel.Evaluator} for the input {@link ReliabilityRiskMlModel}.
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityRiskMlModel.Evaluator
 */
declare namespace ReliabilityRiskMlModel {
  export interface IEvaluator {
     ...
     */
    scope?: IMlModel.Evaluator.Scope;
     ...
     */
    operations: Map_Type<string, MlModel.Evaluator.Operation> | {[key: string]: IMlModel.Evaluator.Operation};
     ...
     */
    operationFeatures?: IMlModel.Evaluator.OperationFeatures;
 ...
 */
declare namespace ReliabilityRiskMlModel {
  export class Evaluator extends Obj  {
    ...
    withTypeIdent(typeIdent: string | null): ReliabilityRiskMlModel.Evaluator;
     ...
     */
    readonly id: string;
    withId(id: string): ReliabilityRiskMlModel.Evaluator;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityRiskMlModel.Evaluator;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): ReliabilityRiskMlModel.Evaluator;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): ReliabilityRiskMlModel.Evaluator;
    ...
    withVersion(version: number | null): ReliabilityRiskMlModel.Evaluator;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): ReliabilityRiskMlModel.Evaluator;

    /**
     * The scope of the evaluations made by this evaluator. For example, subjects, feature start time, and feature end time.
     * In general, scope will define all {@link Feature.Set} evaluations made by this evaluator.
     */
    readonly scope?: MlModel.Evaluator.Scope;
    withScope(scope: IMlModel.Evaluator.Scope | null): ReliabilityRiskMlModel.Evaluator;
     ...
     * NOTE: this evaluator's evaluation results will be keyed by the same operation name defined here.
     */
    readonly operations: Map_Type<string, MlModel.Evaluator.Operation>;
    withOperations(operations: Map_Type<string, MlModel.Evaluator.Operation> | {[key: string]: IMlModel.Evaluator.Operation}): ReliabilityRiskMlModel.Evaluator;
     ...
     * See {@link MlModel.Evaluator.OperationFeatures} for details.
     */
    readonly operationFeatures?: MlModel.Evaluator.OperationFeatures;
    withOperationFeatures(operationFeatures: IMlModel.Evaluator.OperationFeatures | null): ReliabilityRiskMlModel.Evaluator;

    /**
     * Specify whether the evaluator is created for the training or validation period of the {@link ReliabilityRiskMlModel}s.
     */
    readonly isValidation?: boolean;
    withIsValidation(isValidation: boolean): ReliabilityRiskMlModel.Evaluator;

    /**
     * If the evaluator should be created for a custom period that does not correspond to training or validation, use this field
     * to specify the period for which model evaluation should be run. If specified, the {@link isValidation} field will be ignored.
     */
    readonly customTimeRange?: TimeRange;
    withCustomTimeRange(customTimeRange: ITimeRange | null): ReliabilityRiskMlModel.Evaluator;
     ...
     * @see #toJson
     */
    static fromJson(json: any): ReliabilityRiskMlModel.Evaluator | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): ReliabilityRiskMlModel.Evaluator | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): ReliabilityRiskMlModel.Evaluator | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): ReliabilityRiskMlModel.Evaluator | null;
     ...
     */
    replaceType(old: Type, new_: Type): ReliabilityRiskMlModel.Evaluator;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityRiskMlModel.Evaluator;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityRiskMlModel.Evaluator;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityRiskMlModel.Evaluator>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityRiskMlModel.Evaluator>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityRiskMlModel.Evaluator;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityRiskMlModel.Evaluator;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityRiskMlModel.Evaluator;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): ReliabilityRiskMlModel.Evaluator;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): ReliabilityRiskMlModel.Evaluator;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityRiskMlModel.Evaluator;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityRiskMlModel.Evaluator;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityRiskMlModel.Evaluator;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): ReliabilityRiskMlModel.Evaluator;
     ...
     * @see #removeField
     */
    withoutField(field: string): ReliabilityRiskMlModel.Evaluator;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): ReliabilityRiskMlModel.Evaluator;
     ...
     */
    withoutFields(fields: Array_Type<string>): ReliabilityRiskMlModel.Evaluator;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityRiskMlModel.Evaluator;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): ReliabilityRiskMlModel.Evaluator;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityRiskMlModel.Evaluator;
     ...
     * @see #unsetField
     */
    defaultField(field: string): ReliabilityRiskMlModel.Evaluator;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): ReliabilityRiskMlModel.Evaluator;
     ...
     * @see #removeField
     */
    unsetField(field: string): ReliabilityRiskMlModel.Evaluator;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): ReliabilityRiskMlModel.Evaluator;
     ...
     * @see #unsetField
     */
    removeField(field: string): ReliabilityRiskMlModel.Evaluator;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): ReliabilityRiskMlModel.Evaluator;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityRiskMlModel.Evaluator;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityRiskMlModel.Evaluator;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityRiskMlModel.Evaluator;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityRiskMlModel.Evaluator;

    mergeJson(json: any): ReliabilityRiskMlModel.Evaluator;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityRiskMlModel.Evaluator;
     ...
     */
    sumObj(other: Obj, deep?: boolean): ReliabilityRiskMlModel.Evaluator;
     ...
     */
    singletonArray(): Array_Type<ReliabilityRiskMlModel.Evaluator>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityRiskMlModel.Evaluator> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<ReliabilityRiskMlModel.Evaluator> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<ReliabilityRiskMlModel.Evaluator>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<ReliabilityRiskMlModel.Evaluator> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, ReliabilityRiskMlModel.Evaluator> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityRiskMlModel.Evaluator> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<ReliabilityRiskMlModel.Evaluator>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<ReliabilityRiskMlModel.Evaluator>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityRiskMlModel.Evaluator;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityRiskMlModel.Evaluator;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityRiskMlModel.Evaluator;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): ReliabilityRiskMlModel.Evaluator;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityRiskMlModel.Evaluator;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): ReliabilityRiskMlModel.Evaluator;
     ...
     * @see #fromString
     */
    static make(s: string): ReliabilityRiskMlModel.Evaluator | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityRiskMlModel.Evaluator;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): ReliabilityRiskMlModel.Evaluator;
     ...
     */
    static cachedEmptyInst(): ReliabilityRiskMlModel.Evaluator;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityRiskMlModel.Evaluator> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): ReliabilityRiskMlModel.Evaluator;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<ReliabilityRiskMlModel.Evaluator>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<ReliabilityRiskMlModel.Evaluator>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityRiskMlModel.Evaluator> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityRiskMlModel.Evaluator>> | null;
     ...
     */
    get(include?: string): ReliabilityRiskMlModel.Evaluator | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): ReliabilityRiskMlModel.Evaluator | null;
     ...
     */
    getMissing(spec: GetMissingSpec): ReliabilityRiskMlModel.Evaluator;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): ReliabilityRiskMlModel.Evaluator | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): ReliabilityRiskMlModel.Evaluator;
     ...
     * @see #toString
     */
    static fromString(s: string): ReliabilityRiskMlModel.Evaluator | null;
     ...
     */
    create(spec?: UpsertSpec): ReliabilityRiskMlModel.Evaluator | null;
     ...
     */
    static createBatch(objs: Array_Type<ReliabilityRiskMlModel.Evaluator>, spec?: UpsertSpec): ObjList<ReliabilityRiskMlModel.Evaluator> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<ReliabilityRiskMlModel.Evaluator>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityRiskMlModel.Evaluator> | null;
     ...
     */
    update(srcObj?: ReliabilityRiskMlModel.Evaluator, spec?: UpsertSpec): ReliabilityRiskMlModel.Evaluator | null;
     ...
     */
    upsert(srcObj?: ReliabilityRiskMlModel.Evaluator, spec?: UpsertSpec): ReliabilityRiskMlModel.Evaluator | null;
     ...
     */
    merge(spec?: MergeSpec): ReliabilityRiskMlModel.Evaluator | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): ReliabilityRiskMlModel.Evaluator | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): ReliabilityRiskMlModel.Evaluator | null;
     ...
     */
    static updateBatch(objs: Array_Type<ReliabilityRiskMlModel.Evaluator>, srcObjs?: Array_Type<ReliabilityRiskMlModel.Evaluator>, spec?: UpsertSpec): ObjList<ReliabilityRiskMlModel.Evaluator> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<ReliabilityRiskMlModel.Evaluator> | null>, spec?: UpsertSpec): ObjList<ReliabilityRiskMlModel.Evaluator> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<ReliabilityRiskMlModel.Evaluator>, srcObjs?: Array_Type<ReliabilityRiskMlModel.Evaluator>, spec?: UpsertSpec): ObjList<ReliabilityRiskMlModel.Evaluator> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<ReliabilityRiskMlModel.Evaluator> | null>, spec?: UpsertSpec): ObjList<ReliabilityRiskMlModel.Evaluator> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<ReliabilityRiskMlModel.Evaluator>, spec?: TouchSpec): ObjList<ReliabilityRiskMlModel.Evaluator> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityRiskMlModel.Evaluator>, spec?: MergeSpec): ObjList<ReliabilityRiskMlModel.Evaluator> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityRiskMlModel.Evaluator>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityRiskMlModel.Evaluator> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<ReliabilityRiskMlModel.Evaluator> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityRiskMlModel.Evaluator> | null;
     ...
     */
    static mergeAll(mergeObj: ReliabilityRiskMlModel.Evaluator, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: ReliabilityRiskMlModel.Evaluator, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<ReliabilityRiskMlModel.Evaluator>, spec?: UpsertSpec): ObjList<ReliabilityRiskMlModel.Evaluator> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<ReliabilityRiskMlModel.Evaluator>, spec?: UpsertSpec): ObjList<ReliabilityRiskMlModel.Evaluator> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): ReliabilityRiskMlModel.Evaluator | null;
     ...
     */
    static beforeCreate(objs: Array_Type<ReliabilityRiskMlModel.Evaluator>): ObjList<ReliabilityRiskMlModel.Evaluator>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<ReliabilityRiskMlModel.Evaluator>): ObjList<ReliabilityRiskMlModel.Evaluator>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<ReliabilityRiskMlModel.Evaluator>): ObjList<ReliabilityRiskMlModel.Evaluator>;
     ...
     */
    static afterCreate(objs: Array_Type<ReliabilityRiskMlModel.Evaluator>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<ReliabilityRiskMlModel.Evaluator>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<ReliabilityRiskMlModel.Evaluator>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityRiskMlModel.Evaluator>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityRiskMlModel.Evaluator>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): ReliabilityRiskMlModel.Evaluator | null;
     ...
     */
    withoutIdentity(): ReliabilityRiskMlModel.Evaluator | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<ReliabilityRiskMlModel.Evaluator>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: ReliabilityRiskMlModel.Evaluator, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<ReliabilityRiskMlModel.Evaluator>, callback?: λFunction<ReliabilityRiskMlModel.Evaluator | null, ReliabilityRiskMlModel.Evaluator | null>): ObjList<ReliabilityRiskMlModel.Evaluator>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<ReliabilityRiskMlModel.Evaluator>, callback?: λFunction<ReliabilityRiskMlModel.Evaluator | null, ReliabilityRiskMlModel.Evaluator | null>): Array_Type<ObjError> | null;
     ...
     */
    evaluatorForModel(model: MlModel): ReliabilityRiskMlModel.Evaluator;
  }
}
