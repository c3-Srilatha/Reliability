// TypeScript definitions for the C3 type RiskMlModelPredictionHistory

/**
 * The type stores the historical information about the prediction status and error reasons
 * for a {@link ReliabilityAssetToModelRelation}s.
 *
 * @remarks this represents a value passed to a method that expects an instance of RiskMlModelPredictionHistory
 */
declare interface IRiskMlModelPredictionHistory {
  ...
  /**
   * The timestamp in UTC zone of when the object instance was created via {#createWithOverlapsResolved}.
   * Since {@link RiskMlModelPredictionHistory} objects created through {#createWithOverlapsResolved} can potentially lead to
   * existing objects to be re-upserted without identity after resolution,
   * this field is being used to retain the original timestamp at which it was created.
   * This field should be preferred over meta.createdAt for the timestamp at which the object was created.
   */
  createdAt?: DateTime | Date | string;

  /**
   * Status of the current predictions made.
   */
  isPredicting?: number;

  /**
   * Reason for empty predictions.
   * If predictions are correctly made, then the value would be N/A
   */
  predictionFailureReason?: string;
}
 ...
 * for a {@link ReliabilityAssetToModelRelation}s.
 *
 * @remarks this represents a made instance of RiskMlModelPredictionHistory
 */
declare class RiskMlModelPredictionHistory extends Obj  {

  /**
   * Start timestamp for the value.  If null, assumed to be beginning-of-time (BOT).
   */
  readonly start?: DateTime;
  withStart(start: DateTime | Date | string | null): RiskMlModelPredictionHistory;

  /**
   * End timestamp for the value.  If null, assumed to be end-of-time (EOT).
   */
  readonly end?: DateTime;
  withEnd(end: DateTime | Date | string | null): RiskMlModelPredictionHistory;

  /**
   * Parent/owning obj instance.
   */
  readonly parent: ReliabilityAssetToRiskModelRelation;
  withParent(parent: IReliabilityAssetToRiskModelRelation): RiskMlModelPredictionHistory;
   ...
   */
  readonly id: string;
  withId(id: string): RiskMlModelPredictionHistory;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): RiskMlModelPredictionHistory;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): RiskMlModelPredictionHistory;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): RiskMlModelPredictionHistory;
  ...
  withVersion(version: number | null): RiskMlModelPredictionHistory;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): RiskMlModelPredictionHistory;
  ...
  withCreatedAt(createdAt: DateTime | Date | string | null): RiskMlModelPredictionHistory;

  /**
   * Status of the current predictions made.
   */
  readonly isPredicting?: number;
  withIsPredicting(isPredicting: number | null): RiskMlModelPredictionHistory;

  /**
   * Reason for empty predictions.
   * If predictions are correctly made, then the value would be N/A
   */
  readonly predictionFailureReason?: string;
  withPredictionFailureReason(predictionFailureReason: string | null): RiskMlModelPredictionHistory;
   ...
   * @see #toJson
   */
  static fromJson(json: any): RiskMlModelPredictionHistory | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): RiskMlModelPredictionHistory | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): RiskMlModelPredictionHistory | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): RiskMlModelPredictionHistory | null;
   ...
   */
  replaceType(old: Type, new_: Type): RiskMlModelPredictionHistory;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): RiskMlModelPredictionHistory;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): RiskMlModelPredictionHistory;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<RiskMlModelPredictionHistory>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<RiskMlModelPredictionHistory>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): RiskMlModelPredictionHistory;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): RiskMlModelPredictionHistory;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): RiskMlModelPredictionHistory;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): RiskMlModelPredictionHistory;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): RiskMlModelPredictionHistory;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): RiskMlModelPredictionHistory;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): RiskMlModelPredictionHistory;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): RiskMlModelPredictionHistory;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): RiskMlModelPredictionHistory;
   ...
   * @see #removeField
   */
  withoutField(field: string): RiskMlModelPredictionHistory;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): RiskMlModelPredictionHistory;
   ...
   */
  withoutFields(fields: Array_Type<string>): RiskMlModelPredictionHistory;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): RiskMlModelPredictionHistory;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): RiskMlModelPredictionHistory;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): RiskMlModelPredictionHistory;
   ...
   * @see #unsetField
   */
  defaultField(field: string): RiskMlModelPredictionHistory;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): RiskMlModelPredictionHistory;
   ...
   * @see #removeField
   */
  unsetField(field: string): RiskMlModelPredictionHistory;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): RiskMlModelPredictionHistory;
   ...
   * @see #unsetField
   */
  removeField(field: string): RiskMlModelPredictionHistory;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): RiskMlModelPredictionHistory;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): RiskMlModelPredictionHistory;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): RiskMlModelPredictionHistory;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): RiskMlModelPredictionHistory;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): RiskMlModelPredictionHistory;

  mergeJson(json: any): RiskMlModelPredictionHistory;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): RiskMlModelPredictionHistory;
   ...
   */
  sumObj(other: Obj, deep?: boolean): RiskMlModelPredictionHistory;
   ...
   */
  singletonArray(): Array_Type<RiskMlModelPredictionHistory>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<RiskMlModelPredictionHistory> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<RiskMlModelPredictionHistory> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<RiskMlModelPredictionHistory>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<RiskMlModelPredictionHistory> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, RiskMlModelPredictionHistory> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, RiskMlModelPredictionHistory> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<RiskMlModelPredictionHistory>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<RiskMlModelPredictionHistory>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): RiskMlModelPredictionHistory;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): RiskMlModelPredictionHistory;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): RiskMlModelPredictionHistory;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): RiskMlModelPredictionHistory;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): RiskMlModelPredictionHistory;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): RiskMlModelPredictionHistory;
   ...
   * @see #fromString
   */
  static make(s: string): RiskMlModelPredictionHistory | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): RiskMlModelPredictionHistory;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): RiskMlModelPredictionHistory;
   ...
   */
  static cachedEmptyInst(): RiskMlModelPredictionHistory;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<RiskMlModelPredictionHistory> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): RiskMlModelPredictionHistory;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<RiskMlModelPredictionHistory>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<RiskMlModelPredictionHistory>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<RiskMlModelPredictionHistory> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<RiskMlModelPredictionHistory>> | null;
   ...
   */
  get(include?: string): RiskMlModelPredictionHistory | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): RiskMlModelPredictionHistory | null;
   ...
   */
  getMissing(spec: GetMissingSpec): RiskMlModelPredictionHistory;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): RiskMlModelPredictionHistory | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): RiskMlModelPredictionHistory;
   ...
   * @see #toString
   */
  static fromString(s: string): RiskMlModelPredictionHistory | null;
   ...
   */
  create(spec?: UpsertSpec): RiskMlModelPredictionHistory | null;
   ...
   */
  static createBatch(objs: Array_Type<RiskMlModelPredictionHistory>, spec?: UpsertSpec): ObjList<RiskMlModelPredictionHistory> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<RiskMlModelPredictionHistory>, spec?: CreateBatchObjStreamSpec): ObjList<RiskMlModelPredictionHistory> | null;
   ...
   */
  update(srcObj?: RiskMlModelPredictionHistory, spec?: UpsertSpec): RiskMlModelPredictionHistory | null;
   ...
   */
  upsert(srcObj?: RiskMlModelPredictionHistory, spec?: UpsertSpec): RiskMlModelPredictionHistory | null;
   ...
   */
  merge(spec?: MergeSpec): RiskMlModelPredictionHistory | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): RiskMlModelPredictionHistory | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): RiskMlModelPredictionHistory | null;
   ...
   */
  static updateBatch(objs: Array_Type<RiskMlModelPredictionHistory>, srcObjs?: Array_Type<RiskMlModelPredictionHistory>, spec?: UpsertSpec): ObjList<RiskMlModelPredictionHistory> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<RiskMlModelPredictionHistory> | null>, spec?: UpsertSpec): ObjList<RiskMlModelPredictionHistory> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<RiskMlModelPredictionHistory>, srcObjs?: Array_Type<RiskMlModelPredictionHistory>, spec?: UpsertSpec): ObjList<RiskMlModelPredictionHistory> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<RiskMlModelPredictionHistory> | null>, spec?: UpsertSpec): ObjList<RiskMlModelPredictionHistory> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<RiskMlModelPredictionHistory>, spec?: TouchSpec): ObjList<RiskMlModelPredictionHistory> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<RiskMlModelPredictionHistory>, spec?: MergeSpec): ObjList<RiskMlModelPredictionHistory> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<RiskMlModelPredictionHistory>, mergeInclude: string, spec?: MergeSpec): ObjList<RiskMlModelPredictionHistory> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<RiskMlModelPredictionHistory> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<RiskMlModelPredictionHistory> | null;
   ...
   */
  static mergeAll(mergeObj: RiskMlModelPredictionHistory, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: RiskMlModelPredictionHistory, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<RiskMlModelPredictionHistory>, spec?: UpsertSpec): ObjList<RiskMlModelPredictionHistory> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<RiskMlModelPredictionHistory>, spec?: UpsertSpec): ObjList<RiskMlModelPredictionHistory> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): RiskMlModelPredictionHistory | null;
   ...
   */
  static beforeCreate(objs: Array_Type<RiskMlModelPredictionHistory>): ObjList<RiskMlModelPredictionHistory>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<RiskMlModelPredictionHistory>): ObjList<RiskMlModelPredictionHistory>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<RiskMlModelPredictionHistory>): ObjList<RiskMlModelPredictionHistory>;
   ...
   */
  static afterCreate(objs: Array_Type<RiskMlModelPredictionHistory>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<RiskMlModelPredictionHistory>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<RiskMlModelPredictionHistory>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<RiskMlModelPredictionHistory>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<RiskMlModelPredictionHistory>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): RiskMlModelPredictionHistory | null;
   ...
   */
  withoutIdentity(): RiskMlModelPredictionHistory | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<RiskMlModelPredictionHistory>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: RiskMlModelPredictionHistory, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<RiskMlModelPredictionHistory>, callback?: λFunction<RiskMlModelPredictionHistory | null, RiskMlModelPredictionHistory | null>): ObjList<RiskMlModelPredictionHistory>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<RiskMlModelPredictionHistory>, callback?: λFunction<RiskMlModelPredictionHistory | null, RiskMlModelPredictionHistory | null>): Array_Type<ObjError> | null;
  ...
  /**
   * Any {@link RiskMlModelPredictionHistory} objects should be created using this function to ensure there
   * are no overlaps between prediction histories belonging to a given parent ({@link ReliabilityAssetToRiskModelRelation}).
   * The overlap resolution is mainly done in 3 steps:
   * 1. Fetch all the overlapping prediction histories.
   * 2. Resolve the overlaps depending on the type of ovelap:
   *   2.1. If the end of a previously existing history lies between start and end of new history, aligns the end to start of new history being created.
   *   2.2. If the start of previously existing history lies between start and end of new history, aligns the start to end of new history being created.
   *   2.3. If the start and end of a previously existing history lie between start and end of new history, delete previously existing history.
   *   2.4. If the start and end of a previously existing history subsume the new history, aligns both the start and end of previously existing history.
   * 3. Create resolved histories (from step 2.) along with the new history with {#createdAt} populated.
   */
  createWithOverlapsResolved(): void;
}
