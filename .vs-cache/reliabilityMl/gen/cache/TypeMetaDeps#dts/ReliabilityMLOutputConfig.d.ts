// TypeScript definitions for the C3 type ReliabilityMLOutputConfig

/**
 * ML Configurations for Reliability application.
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityMLOutputConfig
 */
declare interface IReliabilityMLOutputConfig {
  ...
  /**
   * Timestamp timezone for model outputs. IF not set, UTC will be used.
   * If you are using {@link PointMeasurement}s with a non-UTC timezone, you should set this config to match.
   */
  outputTimeZone?: ITimeZone;

  /**
   * Dataset column name for the risk score.
   */
  riskScoreColumnName?: string;

  /**
   * Dataset column name for the feature contributions sum.
   */
  featureContributionsSumColumnName?: string;

  /**
   * Dataset column name suffix for the residuals. The residual column names will be constructed by appending this suffix
   * to the column name of each of the input features.
   */
  residualColumnNameSuffix?: string;

  /**
   * Dataset column name suffix for the reconstructed features/signals. The reconstruction column names will be constructed
   * by appending this suffix to the column name of each of the input features. If not specified, the column
   * names of the reconstructed features will be the same as those of the input features.
   */
  reconstructionColumnNameSuffix?: string;

  /**
   * Dataset column name for generated alerts.
   */
  alertColumnName?: string;

  /**
   * Dataset column name suffix for the generated normalized risk scores.
   * The column name will be constructed by appending this suffix to the column name of the risk scores column.
   */
  normalizerColumnNameSuffix?: string;

  /**
   * The interpretations {@link Feature.Set} key that maps to the generated feature contributions on the {@link ReliabilityRiskMl.Pipeline}.
   */
  interpretationOutputName?: string;

  /**
   * Field name for contributions on {@link ReliabilityRiskScoreMlContribution}
   */
  reliabilityRiskScoreMlContributionField?: string;

  /**
   * Field name for contributions on {@link ReliabilityRiskScoreMlValidationContribution}.
   */
  reliabilityRiskScoreMlValidationContributionField?: string;

  /**
   * Field name for predictions on {@link ReliabilityRiskScoreMlPrediction}
   */
  reliabilityRiskScoreMlPredictionField?: string;

  /**
   * Field name for predictions on {@link ReliabilityRiskScoreMlValidationPrediction}.
   */
  reliabilityRiskScoreMlValidationPredictionField?: string;

  /**
   * Field name for scores on {@link ReliabilityRiskScoreMlScore}
   */
  reliabilityRiskScoreMlScoreField?: string;

  /**
   * Default mapping between the columns of the {@link TensorSpec} outputs of the
   * {@link MlPipeline#process} method of a model's {@link MlPipeline} to the name of the timeSeries
   * each prediction data point must be to persisted in.
   */
  columnsToPredictionTimeseries?: Map_Type<string, string> | {[key: string]: string} | Map_Type<string, Pair<string, Unit>> | {[key: string]: IPair<string, Unit>};

  /**
   * Default mapping between the columns of the {@link MlInterpretResult#processOutput} outputs of the
   * {@link MlPipeline#interpret} method of a model's {@link MlPipeline} to the name of the timeSeries
   * each prediction data point along with its associated contributions must be persisted in.
   */
  columnsToContributionTimeseries?: Map_Type<string, string> | {[key: string]: string};

  /**
   * Dataset column name for the time to event.
   * This should also be the output port name of the pipeline.
   */
  timeToEventColumnName?: string;

  /**
   * Dataset column name for the optional time to event forecast value.
   * This should also be the output port name of the pipeline.
   */
  timeToEventForecastColumnName?: string;

  /**
   * During incremental inference, the start of the inference range is determind by the latest prediction time for
   * each {@link MlSubject}. This config determines how far back to look for the latest prediction time.
   *
   * This is especially useful when there are no prior predictions for a specific subject.
   */
  maximumPredictionLookbackForIncrementalInference?: IPeriod;
}

/**
 * ML Configurations for Reliability application.
 *
 * @remarks this represents a made instance of ReliabilityMLOutputConfig
 */
declare class ReliabilityMLOutputConfig extends Obj  {

  readonly configOverride?: string;
  withConfigOverride(configOverride: string | null): ReliabilityMLOutputConfig;

  static readonly configOverride?: string;

  readonly secretOverride?: string;
  withSecretOverride(secretOverride: string | null): ReliabilityMLOutputConfig;
  ...
  withIssues(issues: Array_Type<string> | Array<string> | null): ReliabilityMLOutputConfig;
   ...
   * If you are using {@link PointMeasurement}s with a non-UTC timezone, you should set this config to match.
   */
  readonly outputTimeZone?: TimeZone;
  withOutputTimeZone(outputTimeZone: ITimeZone | null): ReliabilityMLOutputConfig;

  /**
   * Timestamp timezone for model outputs. IF not set, UTC will be used.
   * If you are using {@link PointMeasurement}s with a non-UTC timezone, you should set this config to match.
   */
  static readonly outputTimeZone?: TimeZone;

  /**
   * Dataset column name for the risk score.
   */
  readonly riskScoreColumnName?: string;
  withRiskScoreColumnName(riskScoreColumnName: string | null): ReliabilityMLOutputConfig;

  /**
   * Dataset column name for the risk score.
   */
  static readonly riskScoreColumnName?: string;

  /**
   * Dataset column name for the feature contributions sum.
   */
  readonly featureContributionsSumColumnName?: string;
  withFeatureContributionsSumColumnName(featureContributionsSumColumnName: string | null): ReliabilityMLOutputConfig;

  /**
   * Dataset column name for the feature contributions sum.
   */
  static readonly featureContributionsSumColumnName?: string;

  /**
   * Dataset column name suffix for the residuals. The residual column names will be constructed by appending this suffix
   * to the column name of each of the input features.
   */
  readonly residualColumnNameSuffix?: string;
  withResidualColumnNameSuffix(residualColumnNameSuffix: string | null): ReliabilityMLOutputConfig;

  /**
   * Dataset column name suffix for the residuals. The residual column names will be constructed by appending this suffix
   * to the column name of each of the input features.
   */
  static readonly residualColumnNameSuffix?: string;
   ...
   * names of the reconstructed features will be the same as those of the input features.
   */
  readonly reconstructionColumnNameSuffix?: string;
  withReconstructionColumnNameSuffix(reconstructionColumnNameSuffix: string | null): ReliabilityMLOutputConfig;
   ...
   * names of the reconstructed features will be the same as those of the input features.
   */
  static readonly reconstructionColumnNameSuffix?: string;

  /**
   * Dataset column name for generated alerts.
   */
  readonly alertColumnName?: string;
  withAlertColumnName(alertColumnName: string | null): ReliabilityMLOutputConfig;

  /**
   * Dataset column name for generated alerts.
   */
  static readonly alertColumnName?: string;

  /**
   * Dataset column name suffix for the generated normalized risk scores.
   * The column name will be constructed by appending this suffix to the column name of the risk scores column.
   */
  readonly normalizerColumnNameSuffix?: string;
  withNormalizerColumnNameSuffix(normalizerColumnNameSuffix: string | null): ReliabilityMLOutputConfig;

  /**
   * Dataset column name suffix for the generated normalized risk scores.
   * The column name will be constructed by appending this suffix to the column name of the risk scores column.
   */
  static readonly normalizerColumnNameSuffix?: string;

  /**
   * The interpretations {@link Feature.Set} key that maps to the generated feature contributions on the {@link ReliabilityRiskMl.Pipeline}.
   */
  readonly interpretationOutputName?: string;
  withInterpretationOutputName(interpretationOutputName: string | null): ReliabilityMLOutputConfig;

  /**
   * The interpretations {@link Feature.Set} key that maps to the generated feature contributions on the {@link ReliabilityRiskMl.Pipeline}.
   */
  static readonly interpretationOutputName?: string;

  /**
   * Field name for contributions on {@link ReliabilityRiskScoreMlContribution}
   */
  readonly reliabilityRiskScoreMlContributionField?: string;
  withReliabilityRiskScoreMlContributionField(reliabilityRiskScoreMlContributionField: string | null): ReliabilityMLOutputConfig;

  /**
   * Field name for contributions on {@link ReliabilityRiskScoreMlContribution}
   */
  static readonly reliabilityRiskScoreMlContributionField?: string;

  /**
   * Field name for contributions on {@link ReliabilityRiskScoreMlValidationContribution}.
   */
  readonly reliabilityRiskScoreMlValidationContributionField?: string;
  withReliabilityRiskScoreMlValidationContributionField(reliabilityRiskScoreMlValidationContributionField: string | null): ReliabilityMLOutputConfig;

  /**
   * Field name for contributions on {@link ReliabilityRiskScoreMlValidationContribution}.
   */
  static readonly reliabilityRiskScoreMlValidationContributionField?: string;

  /**
   * Field name for predictions on {@link ReliabilityRiskScoreMlPrediction}
   */
  readonly reliabilityRiskScoreMlPredictionField?: string;
  withReliabilityRiskScoreMlPredictionField(reliabilityRiskScoreMlPredictionField: string | null): ReliabilityMLOutputConfig;

  /**
   * Field name for predictions on {@link ReliabilityRiskScoreMlPrediction}
   */
  static readonly reliabilityRiskScoreMlPredictionField?: string;

  /**
   * Field name for predictions on {@link ReliabilityRiskScoreMlValidationPrediction}.
   */
  readonly reliabilityRiskScoreMlValidationPredictionField?: string;
  withReliabilityRiskScoreMlValidationPredictionField(reliabilityRiskScoreMlValidationPredictionField: string | null): ReliabilityMLOutputConfig;

  /**
   * Field name for predictions on {@link ReliabilityRiskScoreMlValidationPrediction}.
   */
  static readonly reliabilityRiskScoreMlValidationPredictionField?: string;

  /**
   * Field name for scores on {@link ReliabilityRiskScoreMlScore}
   */
  readonly reliabilityRiskScoreMlScoreField?: string;
  withReliabilityRiskScoreMlScoreField(reliabilityRiskScoreMlScoreField: string | null): ReliabilityMLOutputConfig;

  /**
   * Field name for scores on {@link ReliabilityRiskScoreMlScore}
   */
  static readonly reliabilityRiskScoreMlScoreField?: string;
   ...
   * each prediction data point must be to persisted in.
   */
  readonly columnsToPredictionTimeseries?: Map_Type<string, string> | Map_Type<string, Pair<string, Unit>>;
  withColumnsToPredictionTimeseries(columnsToPredictionTimeseries: Map_Type<string, string> | {[key: string]: string} | Map_Type<string, Pair<string, Unit>> | {[key: string]: IPair<string, Unit>} | null): ReliabilityMLOutputConfig;
   ...
   * each prediction data point must be to persisted in.
   */
  static readonly columnsToPredictionTimeseries?: Map_Type<string, string> | Map_Type<string, Pair<string, Unit>>;
   ...
   * each prediction data point along with its associated contributions must be persisted in.
   */
  readonly columnsToContributionTimeseries?: Map_Type<string, string>;
  withColumnsToContributionTimeseries(columnsToContributionTimeseries: Map_Type<string, string> | {[key: string]: string} | null): ReliabilityMLOutputConfig;
   ...
   * each prediction data point along with its associated contributions must be persisted in.
   */
  static readonly columnsToContributionTimeseries?: Map_Type<string, string>;

  /**
   * Dataset column name for the time to event.
   * This should also be the output port name of the pipeline.
   */
  readonly timeToEventColumnName?: string;
  withTimeToEventColumnName(timeToEventColumnName: string | null): ReliabilityMLOutputConfig;

  /**
   * Dataset column name for the time to event.
   * This should also be the output port name of the pipeline.
   */
  static readonly timeToEventColumnName?: string;

  /**
   * Dataset column name for the optional time to event forecast value.
   * This should also be the output port name of the pipeline.
   */
  readonly timeToEventForecastColumnName?: string;
  withTimeToEventForecastColumnName(timeToEventForecastColumnName: string | null): ReliabilityMLOutputConfig;

  /**
   * Dataset column name for the optional time to event forecast value.
   * This should also be the output port name of the pipeline.
   */
  static readonly timeToEventForecastColumnName?: string;
   ...
   * This is especially useful when there are no prior predictions for a specific subject.
   */
  readonly maximumPredictionLookbackForIncrementalInference?: Period;
  withMaximumPredictionLookbackForIncrementalInference(maximumPredictionLookbackForIncrementalInference: IPeriod | null): ReliabilityMLOutputConfig;
   ...
   * This is especially useful when there are no prior predictions for a specific subject.
   */
  static readonly maximumPredictionLookbackForIncrementalInference?: Period;
   ...
   * @see #toJson
   */
  static fromJson(json: any): ReliabilityMLOutputConfig | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): ReliabilityMLOutputConfig | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): ReliabilityMLOutputConfig | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): ReliabilityMLOutputConfig | null;
   ...
   */
  replaceType(old: Type, new_: Type): ReliabilityMLOutputConfig;
   ...
   * This method is used during live metadata update
   */
  static replaceType(old: Type, new_: Type): ReliabilityMLOutputConfig;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityMLOutputConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityMLOutputConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityMLOutputConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityMLOutputConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityMLOutputConfig>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityMLOutputConfig>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityMLOutputConfig>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityMLOutputConfig>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityMLOutputConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityMLOutputConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityMLOutputConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityMLOutputConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityMLOutputConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityMLOutputConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ReliabilityMLOutputConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  static validateObj(): ReliabilityMLOutputConfig;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ReliabilityMLOutputConfig;
   ...
   * @see #defaultField
   */
  static withField(field: string, value: any, doNotConvert?: boolean): ReliabilityMLOutputConfig;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityMLOutputConfig;
   ...
   * @see #defaultField
   */
  static withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityMLOutputConfig;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityMLOutputConfig;
   ...
   * @return new Obj
   */
  static withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityMLOutputConfig;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityMLOutputConfig;
   ...
   * @return new Obj
   */
  static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityMLOutputConfig;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ReliabilityMLOutputConfig;
   ...
   * @see #withoutField
   */
  static withoutFieldAtPath(path: string): ReliabilityMLOutputConfig;
   ...
   * @see #removeField
   */
  withoutField(field: string): ReliabilityMLOutputConfig;
   ...
   * @see #removeField
   */
  static withoutField(field: string): ReliabilityMLOutputConfig;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): ReliabilityMLOutputConfig;
   ...
   * @see #removeField
   */
  static withoutField(field: FieldType): ReliabilityMLOutputConfig;
   ...
   */
  withoutFields(fields: Array_Type<string>): ReliabilityMLOutputConfig;
   ...
   * @return new Obj with removed fields
   */
  static withoutFields(fields: Array_Type<string>): ReliabilityMLOutputConfig;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityMLOutputConfig;
   ...
   * @return new Obj with removed fields
   */
  static withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityMLOutputConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ReliabilityMLOutputConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  static withoutSecretFields(): ReliabilityMLOutputConfig;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityMLOutputConfig;
   ...
   * @see FieldType#defaultValue
   */
  static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityMLOutputConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ReliabilityMLOutputConfig;
   ...
   * @see #unsetField
   */
  static defaultField(field: string): ReliabilityMLOutputConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ReliabilityMLOutputConfig;
   ...
   * @see #unsetField
   */
  static defaultField(field: FieldType): ReliabilityMLOutputConfig;
   ...
   * @see #removeField
   */
  unsetField(field: string): ReliabilityMLOutputConfig;
   ...
   * @see #removeField
   */
  static unsetField(field: string): ReliabilityMLOutputConfig;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ReliabilityMLOutputConfig;
   ...
   * @see #removeField
   */
  static unsetField(field: FieldType): ReliabilityMLOutputConfig;
   ...
   * @see #unsetField
   */
  removeField(field: string): ReliabilityMLOutputConfig;
   ...
   * @see #unsetField
   */
  static removeField(field: string): ReliabilityMLOutputConfig;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ReliabilityMLOutputConfig;
   ...
   * @see #unsetField
   */
  static removeField(field: FieldType): ReliabilityMLOutputConfig;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityMLOutputConfig;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityMLOutputConfig;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityMLOutputConfig;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityMLOutputConfig;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityMLOutputConfig;
   ...
   *        the same key or index.
   */
  static mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityMLOutputConfig;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityMLOutputConfig;
   ...
   * traverse child reference and collection fields.
   */
  static mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityMLOutputConfig;

  mergeJson(json: any): ReliabilityMLOutputConfig;

  static mergeJson(json: any): ReliabilityMLOutputConfig;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityMLOutputConfig;
   ...
   * @return Obj with child references merged
   */
  static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityMLOutputConfig;
   ...
   */
  sumObj(other: Obj, deep?: boolean): ReliabilityMLOutputConfig;
   ...
   * references with same name and collection elements at same index or key.
   */
  static sumObj(other: Obj, deep?: boolean): ReliabilityMLOutputConfig;
   ...
   */
  singletonArray(): Array_Type<ReliabilityMLOutputConfig>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonArray(): Array_Type<ReliabilityMLOutputConfig>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityMLOutputConfig> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ReliabilityMLOutputConfig> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<ReliabilityMLOutputConfig>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonSet(): Set_Type<ReliabilityMLOutputConfig>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ReliabilityMLOutputConfig> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, ReliabilityMLOutputConfig> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityMLOutputConfig> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ReliabilityMLOutputConfig>;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  static toBuilder(): ObjBuilder<ReliabilityMLOutputConfig>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ReliabilityMLOutputConfig>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityMLOutputConfig;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityMLOutputConfig;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityMLOutputConfig;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ReliabilityMLOutputConfig;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityMLOutputConfig;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ReliabilityMLOutputConfig;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityMLOutputConfig;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): ReliabilityMLOutputConfig;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  static afterMake(): ReliabilityMLOutputConfig;
   ...
   */
  static cachedEmptyInst(): ReliabilityMLOutputConfig;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityMLOutputConfig> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): ReliabilityMLOutputConfig;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<ReliabilityMLOutputConfig> | null;
   ...
   */
  static find(filter?: string, doNotProduceAll?: boolean): Stream<ReliabilityMLOutputConfig> | null;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<ReliabilityMLOutputConfig> | null;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): ReliabilityMLOutputConfig | null;

  /**
   * Returns cached instance by key, with secrets removed.
   */
  static forCacheKey(key: string): ReliabilityMLOutputConfig | null;
   ...
   * @see findByCacheKey
   */
  getCached(): ReliabilityMLOutputConfig | null;
   ...
   * @see findByCacheKey
   */
  static getCached(): ReliabilityMLOutputConfig | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): ReliabilityMLOutputConfig | null;

  /**
   * @return newly produced cached instance.
   */
  static refreshCache(): ReliabilityMLOutputConfig | null;
   ...
   */
  static produce(key: string): ReliabilityMLOutputConfig | null;
   ...
   */
  static produceAll(): Map_Type<string, ReliabilityMLOutputConfig> | null;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): Map_Type<string, ReliabilityMLOutputConfig> | null;
   ...
   */
  getConfig(): ReliabilityMLOutputConfig;
   ...
   * Note that typical pattern is to use Configurable#config instead of this method.
   */
  static getConfig(): ReliabilityMLOutputConfig;
   ...
   */
  getSecret(): ReliabilityMLOutputConfig;
   ...
   * Note that typical pattern is to use Configurable#configWithSecrets instead of this method.
   */
  static getSecret(): ReliabilityMLOutputConfig;
   ...
   */
  withConfigKey(configKey: string): ReliabilityMLOutputConfig;
   ...
   *     config.configKey() => "folder1/abc"
   */
  static withConfigKey(configKey: string): ReliabilityMLOutputConfig;

  /**
   * @return copy without config key.
   */
  withoutConfigKey(): ReliabilityMLOutputConfig;

  /**
   * @return copy without config key.
   */
  static withoutConfigKey(): ReliabilityMLOutputConfig;

  /**
   * @return return cached config instance for provided config key.
   */
  static forConfigKey(configKey: string): ReliabilityMLOutputConfig | null;
   ...
   */
  static listConfigs(parallel?: boolean, filter?: λPredicate<string>): Stream<ReliabilityMLOutputConfig> | null;
   ...
   * @see setConfigValue
   */
  setConfigValues(from: ReliabilityMLOutputConfig, override?: string): void;

  /**
   * Sets multiple field values to be the same as the passed instance.
   * @see setConfigValue
   */
  static setConfigValues(from: ReliabilityMLOutputConfig, override?: string): void;
   ...
   * @see setSecretValue
   */
  setSecretValues(from: ReliabilityMLOutputConfig, override?: string): void;

  /**
   * Sets multiple secret field values to be the same as the passed instance.
   * @see setSecretValue
   */
  static setSecretValues(from: ReliabilityMLOutputConfig, override?: string): void;
   ...
   */
  static loadConfigAndSecret(configKey: string): ReliabilityMLOutputConfig | null;
   ...
   */
  removeSecrets(): ReliabilityMLOutputConfig | null;

  /**
   * @return this config without any secret values.
   */
  static removeSecrets(): ReliabilityMLOutputConfig | null;

  /**
   * @return this config with only secret values.
   */
  removeNonSecrets(): ReliabilityMLOutputConfig | null;

  /**
   * @return this config with only secret values.
   */
  static removeNonSecrets(): ReliabilityMLOutputConfig | null;

  /**
   * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
   * validation and setup.
   */
  validate(): ReliabilityMLOutputConfig;

  /**
   * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
   * validation and setup.
   */
  static validate(): ReliabilityMLOutputConfig;
