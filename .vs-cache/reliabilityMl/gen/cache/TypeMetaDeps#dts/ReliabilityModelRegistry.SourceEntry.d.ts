// TypeScript definitions for the C3 type ReliabilityModelRegistry.SourceEntry

/**
 * This type stores the information in the source environment required to migrate a {@link ReliabilityMlModel}
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityModelRegistry.SourceEntry
 */
 ...
 */
declare namespace ReliabilityModelRegistry {
  export class SourceEntry extends Obj  {
     ...
     */
    readonly id: string;
    withId(id: string): ReliabilityModelRegistry.SourceEntry;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityModelRegistry.SourceEntry;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): ReliabilityModelRegistry.SourceEntry;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): ReliabilityModelRegistry.SourceEntry;
    ...
    withVersion(version: number | null): ReliabilityModelRegistry.SourceEntry;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): ReliabilityModelRegistry.SourceEntry;

    /**
     * @inheritdoc
     */
    readonly facilityFilterPaths?: Array_Type<string>;
    withFacilityFilterPaths(facilityFilterPaths: Array_Type<string> | Array<string> | null): ReliabilityModelRegistry.SourceEntry;

    /**
     * The source {@link ReliabilityMlModel} that needs to be migrated to the target environment.
     */
    readonly model: ReliabilityMlModel;
    withModel(model: IReliabilityMlModel): ReliabilityModelRegistry.SourceEntry;
    ...
    withEntry(entry: IModelRegistry.Entry): ReliabilityModelRegistry.SourceEntry;
     ...
     * @see #toJson
     */
    static fromJson(json: any): ReliabilityModelRegistry.SourceEntry | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): ReliabilityModelRegistry.SourceEntry | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): ReliabilityModelRegistry.SourceEntry | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): ReliabilityModelRegistry.SourceEntry | null;
     ...
     */
    replaceType(old: Type, new_: Type): ReliabilityModelRegistry.SourceEntry;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityModelRegistry.SourceEntry;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityModelRegistry.SourceEntry;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityModelRegistry.SourceEntry>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityModelRegistry.SourceEntry>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityModelRegistry.SourceEntry;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityModelRegistry.SourceEntry;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityModelRegistry.SourceEntry;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): ReliabilityModelRegistry.SourceEntry;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): ReliabilityModelRegistry.SourceEntry;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityModelRegistry.SourceEntry;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityModelRegistry.SourceEntry;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityModelRegistry.SourceEntry;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): ReliabilityModelRegistry.SourceEntry;
     ...
     * @see #removeField
     */
    withoutField(field: string): ReliabilityModelRegistry.SourceEntry;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): ReliabilityModelRegistry.SourceEntry;
     ...
     */
    withoutFields(fields: Array_Type<string>): ReliabilityModelRegistry.SourceEntry;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityModelRegistry.SourceEntry;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): ReliabilityModelRegistry.SourceEntry;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityModelRegistry.SourceEntry;
     ...
     * @see #unsetField
     */
    defaultField(field: string): ReliabilityModelRegistry.SourceEntry;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): ReliabilityModelRegistry.SourceEntry;
     ...
     * @see #removeField
     */
    unsetField(field: string): ReliabilityModelRegistry.SourceEntry;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): ReliabilityModelRegistry.SourceEntry;
     ...
     * @see #unsetField
     */
    removeField(field: string): ReliabilityModelRegistry.SourceEntry;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): ReliabilityModelRegistry.SourceEntry;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityModelRegistry.SourceEntry;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityModelRegistry.SourceEntry;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityModelRegistry.SourceEntry;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityModelRegistry.SourceEntry;

    mergeJson(json: any): ReliabilityModelRegistry.SourceEntry;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityModelRegistry.SourceEntry;
     ...
     */
    sumObj(other: Obj, deep?: boolean): ReliabilityModelRegistry.SourceEntry;
     ...
     */
    singletonArray(): Array_Type<ReliabilityModelRegistry.SourceEntry>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityModelRegistry.SourceEntry> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<ReliabilityModelRegistry.SourceEntry> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<ReliabilityModelRegistry.SourceEntry>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<ReliabilityModelRegistry.SourceEntry> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, ReliabilityModelRegistry.SourceEntry> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityModelRegistry.SourceEntry> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<ReliabilityModelRegistry.SourceEntry>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<ReliabilityModelRegistry.SourceEntry>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityModelRegistry.SourceEntry;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityModelRegistry.SourceEntry;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityModelRegistry.SourceEntry;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): ReliabilityModelRegistry.SourceEntry;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityModelRegistry.SourceEntry;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): ReliabilityModelRegistry.SourceEntry;
     ...
     * @see #fromString
     */
    static make(s: string): ReliabilityModelRegistry.SourceEntry | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityModelRegistry.SourceEntry;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): ReliabilityModelRegistry.SourceEntry;
     ...
     */
    static cachedEmptyInst(): ReliabilityModelRegistry.SourceEntry;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityModelRegistry.SourceEntry> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): ReliabilityModelRegistry.SourceEntry;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<ReliabilityModelRegistry.SourceEntry>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<ReliabilityModelRegistry.SourceEntry>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityModelRegistry.SourceEntry> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityModelRegistry.SourceEntry>> | null;
     ...
     */
    get(include?: string): ReliabilityModelRegistry.SourceEntry | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): ReliabilityModelRegistry.SourceEntry | null;
     ...
     */
    getMissing(spec: GetMissingSpec): ReliabilityModelRegistry.SourceEntry;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): ReliabilityModelRegistry.SourceEntry | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): ReliabilityModelRegistry.SourceEntry;
     ...
     * @see #toString
     */
    static fromString(s: string): ReliabilityModelRegistry.SourceEntry | null;
     ...
     */
    create(spec?: UpsertSpec): ReliabilityModelRegistry.SourceEntry | null;
     ...
     */
    static createBatch(objs: Array_Type<ReliabilityModelRegistry.SourceEntry>, spec?: UpsertSpec): ObjList<ReliabilityModelRegistry.SourceEntry> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<ReliabilityModelRegistry.SourceEntry>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityModelRegistry.SourceEntry> | null;
     ...
     */
    update(srcObj?: ReliabilityModelRegistry.SourceEntry, spec?: UpsertSpec): ReliabilityModelRegistry.SourceEntry | null;
     ...
     */
    upsert(srcObj?: ReliabilityModelRegistry.SourceEntry, spec?: UpsertSpec): ReliabilityModelRegistry.SourceEntry | null;
     ...
     */
    merge(spec?: MergeSpec): ReliabilityModelRegistry.SourceEntry | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): ReliabilityModelRegistry.SourceEntry | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): ReliabilityModelRegistry.SourceEntry | null;
     ...
     */
    static updateBatch(objs: Array_Type<ReliabilityModelRegistry.SourceEntry>, srcObjs?: Array_Type<ReliabilityModelRegistry.SourceEntry>, spec?: UpsertSpec): ObjList<ReliabilityModelRegistry.SourceEntry> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<ReliabilityModelRegistry.SourceEntry> | null>, spec?: UpsertSpec): ObjList<ReliabilityModelRegistry.SourceEntry> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<ReliabilityModelRegistry.SourceEntry>, srcObjs?: Array_Type<ReliabilityModelRegistry.SourceEntry>, spec?: UpsertSpec): ObjList<ReliabilityModelRegistry.SourceEntry> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<ReliabilityModelRegistry.SourceEntry> | null>, spec?: UpsertSpec): ObjList<ReliabilityModelRegistry.SourceEntry> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<ReliabilityModelRegistry.SourceEntry>, spec?: TouchSpec): ObjList<ReliabilityModelRegistry.SourceEntry> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityModelRegistry.SourceEntry>, spec?: MergeSpec): ObjList<ReliabilityModelRegistry.SourceEntry> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityModelRegistry.SourceEntry>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityModelRegistry.SourceEntry> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<ReliabilityModelRegistry.SourceEntry> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityModelRegistry.SourceEntry> | null;
     ...
     */
    static mergeAll(mergeObj: ReliabilityModelRegistry.SourceEntry, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: ReliabilityModelRegistry.SourceEntry, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<ReliabilityModelRegistry.SourceEntry>, spec?: UpsertSpec): ObjList<ReliabilityModelRegistry.SourceEntry> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<ReliabilityModelRegistry.SourceEntry>, spec?: UpsertSpec): ObjList<ReliabilityModelRegistry.SourceEntry> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): ReliabilityModelRegistry.SourceEntry | null;
     ...
     */
    static beforeCreate(objs: Array_Type<ReliabilityModelRegistry.SourceEntry>): ObjList<ReliabilityModelRegistry.SourceEntry>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<ReliabilityModelRegistry.SourceEntry>): ObjList<ReliabilityModelRegistry.SourceEntry>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<ReliabilityModelRegistry.SourceEntry>): ObjList<ReliabilityModelRegistry.SourceEntry>;
     ...
     */
    static afterCreate(objs: Array_Type<ReliabilityModelRegistry.SourceEntry>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<ReliabilityModelRegistry.SourceEntry>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<ReliabilityModelRegistry.SourceEntry>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityModelRegistry.SourceEntry>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityModelRegistry.SourceEntry>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): ReliabilityModelRegistry.SourceEntry | null;
     ...
     */
    withoutIdentity(): ReliabilityModelRegistry.SourceEntry | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<ReliabilityModelRegistry.SourceEntry>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: ReliabilityModelRegistry.SourceEntry, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<ReliabilityModelRegistry.SourceEntry>, callback?: λFunction<ReliabilityModelRegistry.SourceEntry | null, ReliabilityModelRegistry.SourceEntry | null>): ObjList<ReliabilityModelRegistry.SourceEntry>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<ReliabilityModelRegistry.SourceEntry>, callback?: λFunction<ReliabilityModelRegistry.SourceEntry | null, ReliabilityModelRegistry.SourceEntry | null>): Array_Type<ObjError> | null;
