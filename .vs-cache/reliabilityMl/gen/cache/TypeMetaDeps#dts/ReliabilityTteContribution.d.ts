// TypeScript definitions for the C3 type ReliabilityTteContribution

/**
 * Represents a contribution value within the context of time-to-event (TTE) analysis for reliability modeling.
 * This entity stores the contribution to the time-to-event prediction model, including upper and lower bounds
 * for the contribution value, and tracks the contribution over time. For details on other information stored in this Type,
 * refer to the documentation on each of the fields of this Type.
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityTteContribution
 */
declare interface IReliabilityTteContribution {
  ...
  parent: IReliabilityTteContributionHeader;
  ...
  /**
   * Represents the main contribution value for the time-to-event (TTE) model. This numerical value indicates the
   * importance or influence of the contribution in predicting the time-to-event.
   *
   ...
   * This defines the maximum allowed value for the contribution and is used to enforce boundaries or validation checks.
   * It ensures that the contribution does not exceed a predefined threshold.
   */
  contributionUpperBound?: number;

  /**
   * The lower bound for the contribution value.
   * This defines the minimum allowed value for the contribution and ensures that it does not fall below a certain threshold.
   * It can be useful for validation checks or ensuring that contributions are within a meaningful range.
   */
 ...
 * refer to the documentation on each of the fields of this Type.
 *
 * @remarks this represents a made instance of ReliabilityTteContribution
 */
declare class ReliabilityTteContribution extends Obj  {

  /**
   * start date for the data point
   */
  readonly start: DateTime;
  withStart(start: DateTime | Date | string): ReliabilityTteContribution;
  ...
  withOutlierCode(outlierCode: number | null): ReliabilityTteContribution;

  /**
   * (Optional) any comments for the data point
   */
  readonly comments?: string;
  withComments(comments: string | null): ReliabilityTteContribution;

  /**
   * Denotes if the value is an actual value or an estimated value. default = null (actual value)
   */
  readonly isEstimated?: boolean;
  withIsEstimated(isEstimated: boolean): ReliabilityTteContribution;
  ...
  withDataVersion(dataVersion: number | null): ReliabilityTteContribution;

  /**
   * Customer specific status code for the data point (may be used to denote data quality)
   */
  readonly statusCode?: string;
  withStatusCode(statusCode: string | null): ReliabilityTteContribution;

  /**
   * Partition key Bin separator used to separate partition key from bin id
   */
  readonly PK_BIN_SEPARATOR?: string;
  withPK_BIN_SEPARATOR(PK_BIN_SEPARATOR: string | null): ReliabilityTteContribution;

  readonly parent: ReliabilityTteContributionHeader;
  withParent(parent: IReliabilityTteContributionHeader): ReliabilityTteContribution;
  ...
  withTypeIdent(typeIdent: string | null): ReliabilityTteContribution;
   ...
   */
  readonly id: string;
  withId(id: string): ReliabilityTteContribution;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityTteContribution;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): ReliabilityTteContribution;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): ReliabilityTteContribution;
  ...
  withVersion(version: number | null): ReliabilityTteContribution;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): ReliabilityTteContribution;
  ...
  withContribution(contribution: number): ReliabilityTteContribution;
  ...
  withContributionUpperBound(contributionUpperBound: number | null): ReliabilityTteContribution;
  ...
  withContributionLowerBound(contributionLowerBound: number | null): ReliabilityTteContribution;
   ...
   * @see #toJson
   */
  static fromJson(json: any): ReliabilityTteContribution | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): ReliabilityTteContribution | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): ReliabilityTteContribution | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): ReliabilityTteContribution | null;
   ...
   */
  replaceType(old: Type, new_: Type): ReliabilityTteContribution;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityTteContribution;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityTteContribution;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityTteContribution>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityTteContribution>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityTteContribution;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityTteContribution;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityTteContribution;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ReliabilityTteContribution;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ReliabilityTteContribution;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityTteContribution;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityTteContribution;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityTteContribution;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ReliabilityTteContribution;
   ...
   * @see #removeField
   */
  withoutField(field: string): ReliabilityTteContribution;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): ReliabilityTteContribution;
   ...
   */
  withoutFields(fields: Array_Type<string>): ReliabilityTteContribution;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityTteContribution;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ReliabilityTteContribution;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityTteContribution;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ReliabilityTteContribution;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ReliabilityTteContribution;
   ...
   * @see #removeField
   */
  unsetField(field: string): ReliabilityTteContribution;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ReliabilityTteContribution;
   ...
   * @see #unsetField
   */
  removeField(field: string): ReliabilityTteContribution;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ReliabilityTteContribution;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityTteContribution;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityTteContribution;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityTteContribution;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityTteContribution;

  mergeJson(json: any): ReliabilityTteContribution;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityTteContribution;
   ...
   */
  sumObj(other: Obj, deep?: boolean): ReliabilityTteContribution;
   ...
   */
  singletonArray(): Array_Type<ReliabilityTteContribution>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityTteContribution> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ReliabilityTteContribution> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<ReliabilityTteContribution>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ReliabilityTteContribution> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, ReliabilityTteContribution> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityTteContribution> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ReliabilityTteContribution>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ReliabilityTteContribution>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityTteContribution;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityTteContribution;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityTteContribution;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ReliabilityTteContribution;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityTteContribution;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ReliabilityTteContribution;
   ...
   * @see #fromString
   */
  static make(s: string): ReliabilityTteContribution | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityTteContribution;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): ReliabilityTteContribution;
   ...
   */
  static cachedEmptyInst(): ReliabilityTteContribution;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityTteContribution> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): ReliabilityTteContribution;

  /**
   * Extract the partition key from the given obj
   */
  partitionKey(failIfMissing?: boolean): ReliabilityTteContributionHeader | null;
   ...
   */
  static partition(objs?: Stream<ReliabilityTteContribution>, spec?: PartitionBucketStrategy): Map_Type<string, KvDataPartition> | null;
   ...
   */
  static fromPartitions(partitions?: Stream<KvDataPartition>): Stream<ReliabilityTteContribution> | null;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<ReliabilityTteContribution>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<ReliabilityTteContribution>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityTteContribution> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityTteContribution>> | null;
   ...
   */
  get(include?: string): ReliabilityTteContribution | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): ReliabilityTteContribution | null;
   ...
   */
  getMissing(spec: GetMissingSpec): ReliabilityTteContribution;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): ReliabilityTteContribution | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): ReliabilityTteContribution;
   ...
   * @see #toString
   */
  static fromString(s: string): ReliabilityTteContribution | null;
   ...
   */
  create(spec?: UpsertSpec): ReliabilityTteContribution | null;
   ...
   */
  static createBatch(objs: Array_Type<ReliabilityTteContribution>, spec?: UpsertSpec): ObjList<ReliabilityTteContribution> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<ReliabilityTteContribution>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityTteContribution> | null;
   ...
   */
  update(srcObj?: ReliabilityTteContribution, spec?: UpsertSpec): ReliabilityTteContribution | null;
   ...
   */
  upsert(srcObj?: ReliabilityTteContribution, spec?: UpsertSpec): ReliabilityTteContribution | null;
   ...
   */
  merge(spec?: MergeSpec): ReliabilityTteContribution | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): ReliabilityTteContribution | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): ReliabilityTteContribution | null;
   ...
   */
  static updateBatch(objs: Array_Type<ReliabilityTteContribution>, srcObjs?: Array_Type<ReliabilityTteContribution>, spec?: UpsertSpec): ObjList<ReliabilityTteContribution> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<ReliabilityTteContribution> | null>, spec?: UpsertSpec): ObjList<ReliabilityTteContribution> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<ReliabilityTteContribution>, srcObjs?: Array_Type<ReliabilityTteContribution>, spec?: UpsertSpec): ObjList<ReliabilityTteContribution> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<ReliabilityTteContribution> | null>, spec?: UpsertSpec): ObjList<ReliabilityTteContribution> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<ReliabilityTteContribution>, spec?: TouchSpec): ObjList<ReliabilityTteContribution> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityTteContribution>, spec?: MergeSpec): ObjList<ReliabilityTteContribution> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityTteContribution>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityTteContribution> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<ReliabilityTteContribution> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityTteContribution> | null;
   ...
   */
  static mergeAll(mergeObj: ReliabilityTteContribution, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: ReliabilityTteContribution, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<ReliabilityTteContribution>, spec?: UpsertSpec): ObjList<ReliabilityTteContribution> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<ReliabilityTteContribution>, spec?: UpsertSpec): ObjList<ReliabilityTteContribution> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): ReliabilityTteContribution | null;
   ...
   */
  static beforeCreate(objs: Array_Type<ReliabilityTteContribution>): ObjList<ReliabilityTteContribution>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<ReliabilityTteContribution>): ObjList<ReliabilityTteContribution>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<ReliabilityTteContribution>): ObjList<ReliabilityTteContribution>;
   ...
   */
  static afterCreate(objs: Array_Type<ReliabilityTteContribution>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<ReliabilityTteContribution>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<ReliabilityTteContribution>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityTteContribution>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityTteContribution>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): ReliabilityTteContribution | null;
   ...
   */
  withoutIdentity(): ReliabilityTteContribution | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<ReliabilityTteContribution>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: ReliabilityTteContribution, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<ReliabilityTteContribution>, callback?: λFunction<ReliabilityTteContribution | null, ReliabilityTteContribution | null>): ObjList<ReliabilityTteContribution>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<ReliabilityTteContribution>, callback?: λFunction<ReliabilityTteContribution | null, ReliabilityTteContribution | null>): Array_Type<ObjError> | null;
