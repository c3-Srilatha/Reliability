// TypeScript definitions for the C3 type ReliabilityRiskScoreMlValidationPrediction

/**
 * Represents the validation prediction of a reliability risk score.
 * This entity type stores the prediction values, along with the bounds (lower and upper) of the predicted score,
 * as well as the time at which the prediction was made. It extends the `TimedDataPoint` to include temporal data.
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityRiskScoreMlValidationPrediction
 */
declare interface IReliabilityRiskScoreMlValidationPrediction {
  ...
  parent: IReliabilityRiskScoreMlValidationPredictionHeader;
  ...
  /**
   * The numerical value for the prediction.
   * This is the predicted risk score based on the machine learning model.
   * The value represents the core prediction without any bounds.
   */
  value: number;

  /**
   * The numerical value of the lower bound for the prediction.
   * This represents the lower bound of the prediction interval, giving a range within which the true risk score
   * is likely to lie with a certain level of confidence.
   */
  valueLowerBound?: number;

  /**
   * The numerical value of the upper bound for the prediction.
   * This represents the upper bound of the prediction interval, defining the range of possible values for the risk score.
   * The upper bound helps assess the uncertainty in the prediction.
   */
 ...
 * as well as the time at which the prediction was made. It extends the `TimedDataPoint` to include temporal data.
 *
 * @remarks this represents a made instance of ReliabilityRiskScoreMlValidationPrediction
 */
declare class ReliabilityRiskScoreMlValidationPrediction extends Obj  {

  /**
   * start date for the data point
   */
  readonly start: DateTime;
  withStart(start: DateTime | Date | string): ReliabilityRiskScoreMlValidationPrediction;
  ...
  withOutlierCode(outlierCode: number | null): ReliabilityRiskScoreMlValidationPrediction;

  /**
   * (Optional) any comments for the data point
   */
  readonly comments?: string;
  withComments(comments: string | null): ReliabilityRiskScoreMlValidationPrediction;

  /**
   * Denotes if the value is an actual value or an estimated value. default = null (actual value)
   */
  readonly isEstimated?: boolean;
  withIsEstimated(isEstimated: boolean): ReliabilityRiskScoreMlValidationPrediction;
  ...
  withDataVersion(dataVersion: number | null): ReliabilityRiskScoreMlValidationPrediction;

  /**
   * Customer specific status code for the data point (may be used to denote data quality)
   */
  readonly statusCode?: string;
  withStatusCode(statusCode: string | null): ReliabilityRiskScoreMlValidationPrediction;

  /**
   * Partition key Bin separator used to separate partition key from bin id
   */
  readonly PK_BIN_SEPARATOR?: string;
  withPK_BIN_SEPARATOR(PK_BIN_SEPARATOR: string | null): ReliabilityRiskScoreMlValidationPrediction;

  readonly parent: ReliabilityRiskScoreMlValidationPredictionHeader;
  withParent(parent: IReliabilityRiskScoreMlValidationPredictionHeader): ReliabilityRiskScoreMlValidationPrediction;
  ...
  withTypeIdent(typeIdent: string | null): ReliabilityRiskScoreMlValidationPrediction;
   ...
   */
  readonly id: string;
  withId(id: string): ReliabilityRiskScoreMlValidationPrediction;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityRiskScoreMlValidationPrediction;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): ReliabilityRiskScoreMlValidationPrediction;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): ReliabilityRiskScoreMlValidationPrediction;
  ...
  withVersion(version: number | null): ReliabilityRiskScoreMlValidationPrediction;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): ReliabilityRiskScoreMlValidationPrediction;
  ...
  withValue(value: number): ReliabilityRiskScoreMlValidationPrediction;
   ...
   * is likely to lie with a certain level of confidence.
   */
  readonly valueLowerBound?: number;
  withValueLowerBound(valueLowerBound: number | null): ReliabilityRiskScoreMlValidationPrediction;
   ...
   * The upper bound helps assess the uncertainty in the prediction.
   */
  readonly valueUpperBound?: number;
  withValueUpperBound(valueUpperBound: number | null): ReliabilityRiskScoreMlValidationPrediction;
   ...
   * @see #toJson
   */
  static fromJson(json: any): ReliabilityRiskScoreMlValidationPrediction | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): ReliabilityRiskScoreMlValidationPrediction | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): ReliabilityRiskScoreMlValidationPrediction | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): ReliabilityRiskScoreMlValidationPrediction | null;
   ...
   */
  replaceType(old: Type, new_: Type): ReliabilityRiskScoreMlValidationPrediction;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityRiskScoreMlValidationPrediction;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityRiskScoreMlValidationPrediction;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityRiskScoreMlValidationPrediction>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityRiskScoreMlValidationPrediction>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityRiskScoreMlValidationPrediction;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityRiskScoreMlValidationPrediction;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityRiskScoreMlValidationPrediction;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ReliabilityRiskScoreMlValidationPrediction;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ReliabilityRiskScoreMlValidationPrediction;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityRiskScoreMlValidationPrediction;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityRiskScoreMlValidationPrediction;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityRiskScoreMlValidationPrediction;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ReliabilityRiskScoreMlValidationPrediction;
   ...
   * @see #removeField
   */
  withoutField(field: string): ReliabilityRiskScoreMlValidationPrediction;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): ReliabilityRiskScoreMlValidationPrediction;
   ...
   */
  withoutFields(fields: Array_Type<string>): ReliabilityRiskScoreMlValidationPrediction;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityRiskScoreMlValidationPrediction;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ReliabilityRiskScoreMlValidationPrediction;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityRiskScoreMlValidationPrediction;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ReliabilityRiskScoreMlValidationPrediction;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ReliabilityRiskScoreMlValidationPrediction;
   ...
   * @see #removeField
   */
  unsetField(field: string): ReliabilityRiskScoreMlValidationPrediction;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ReliabilityRiskScoreMlValidationPrediction;
   ...
   * @see #unsetField
   */
  removeField(field: string): ReliabilityRiskScoreMlValidationPrediction;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ReliabilityRiskScoreMlValidationPrediction;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityRiskScoreMlValidationPrediction;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityRiskScoreMlValidationPrediction;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityRiskScoreMlValidationPrediction;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityRiskScoreMlValidationPrediction;

  mergeJson(json: any): ReliabilityRiskScoreMlValidationPrediction;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityRiskScoreMlValidationPrediction;
   ...
   */
  sumObj(other: Obj, deep?: boolean): ReliabilityRiskScoreMlValidationPrediction;
   ...
   */
  singletonArray(): Array_Type<ReliabilityRiskScoreMlValidationPrediction>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityRiskScoreMlValidationPrediction> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ReliabilityRiskScoreMlValidationPrediction> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<ReliabilityRiskScoreMlValidationPrediction>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ReliabilityRiskScoreMlValidationPrediction> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, ReliabilityRiskScoreMlValidationPrediction> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityRiskScoreMlValidationPrediction> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ReliabilityRiskScoreMlValidationPrediction>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ReliabilityRiskScoreMlValidationPrediction>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityRiskScoreMlValidationPrediction;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityRiskScoreMlValidationPrediction;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityRiskScoreMlValidationPrediction;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ReliabilityRiskScoreMlValidationPrediction;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityRiskScoreMlValidationPrediction;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ReliabilityRiskScoreMlValidationPrediction;
   ...
   * @see #fromString
   */
  static make(s: string): ReliabilityRiskScoreMlValidationPrediction | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityRiskScoreMlValidationPrediction;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): ReliabilityRiskScoreMlValidationPrediction;
   ...
   */
  static cachedEmptyInst(): ReliabilityRiskScoreMlValidationPrediction;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityRiskScoreMlValidationPrediction> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): ReliabilityRiskScoreMlValidationPrediction;

  /**
   * Extract the partition key from the given obj
   */
  partitionKey(failIfMissing?: boolean): ReliabilityRiskScoreMlValidationPredictionHeader | null;
   ...
   */
  static partition(objs?: Stream<ReliabilityRiskScoreMlValidationPrediction>, spec?: PartitionBucketStrategy): Map_Type<string, KvDataPartition> | null;
   ...
   */
  static fromPartitions(partitions?: Stream<KvDataPartition>): Stream<ReliabilityRiskScoreMlValidationPrediction> | null;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<ReliabilityRiskScoreMlValidationPrediction>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<ReliabilityRiskScoreMlValidationPrediction>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityRiskScoreMlValidationPrediction> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityRiskScoreMlValidationPrediction>> | null;
   ...
   */
  get(include?: string): ReliabilityRiskScoreMlValidationPrediction | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): ReliabilityRiskScoreMlValidationPrediction | null;
   ...
   */
  getMissing(spec: GetMissingSpec): ReliabilityRiskScoreMlValidationPrediction;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): ReliabilityRiskScoreMlValidationPrediction | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): ReliabilityRiskScoreMlValidationPrediction;
   ...
   * @see #toString
   */
  static fromString(s: string): ReliabilityRiskScoreMlValidationPrediction | null;
   ...
   */
  create(spec?: UpsertSpec): ReliabilityRiskScoreMlValidationPrediction | null;
   ...
   */
  static createBatch(objs: Array_Type<ReliabilityRiskScoreMlValidationPrediction>, spec?: UpsertSpec): ObjList<ReliabilityRiskScoreMlValidationPrediction> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<ReliabilityRiskScoreMlValidationPrediction>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityRiskScoreMlValidationPrediction> | null;
   ...
   */
  update(srcObj?: ReliabilityRiskScoreMlValidationPrediction, spec?: UpsertSpec): ReliabilityRiskScoreMlValidationPrediction | null;
   ...
   */
  upsert(srcObj?: ReliabilityRiskScoreMlValidationPrediction, spec?: UpsertSpec): ReliabilityRiskScoreMlValidationPrediction | null;
   ...
   */
  merge(spec?: MergeSpec): ReliabilityRiskScoreMlValidationPrediction | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): ReliabilityRiskScoreMlValidationPrediction | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): ReliabilityRiskScoreMlValidationPrediction | null;
   ...
   */
  static updateBatch(objs: Array_Type<ReliabilityRiskScoreMlValidationPrediction>, srcObjs?: Array_Type<ReliabilityRiskScoreMlValidationPrediction>, spec?: UpsertSpec): ObjList<ReliabilityRiskScoreMlValidationPrediction> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<ReliabilityRiskScoreMlValidationPrediction> | null>, spec?: UpsertSpec): ObjList<ReliabilityRiskScoreMlValidationPrediction> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<ReliabilityRiskScoreMlValidationPrediction>, srcObjs?: Array_Type<ReliabilityRiskScoreMlValidationPrediction>, spec?: UpsertSpec): ObjList<ReliabilityRiskScoreMlValidationPrediction> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<ReliabilityRiskScoreMlValidationPrediction> | null>, spec?: UpsertSpec): ObjList<ReliabilityRiskScoreMlValidationPrediction> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<ReliabilityRiskScoreMlValidationPrediction>, spec?: TouchSpec): ObjList<ReliabilityRiskScoreMlValidationPrediction> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityRiskScoreMlValidationPrediction>, spec?: MergeSpec): ObjList<ReliabilityRiskScoreMlValidationPrediction> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityRiskScoreMlValidationPrediction>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityRiskScoreMlValidationPrediction> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<ReliabilityRiskScoreMlValidationPrediction> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityRiskScoreMlValidationPrediction> | null;
   ...
   */
  static mergeAll(mergeObj: ReliabilityRiskScoreMlValidationPrediction, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: ReliabilityRiskScoreMlValidationPrediction, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<ReliabilityRiskScoreMlValidationPrediction>, spec?: UpsertSpec): ObjList<ReliabilityRiskScoreMlValidationPrediction> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<ReliabilityRiskScoreMlValidationPrediction>, spec?: UpsertSpec): ObjList<ReliabilityRiskScoreMlValidationPrediction> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): ReliabilityRiskScoreMlValidationPrediction | null;
   ...
   */
  static beforeCreate(objs: Array_Type<ReliabilityRiskScoreMlValidationPrediction>): ObjList<ReliabilityRiskScoreMlValidationPrediction>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<ReliabilityRiskScoreMlValidationPrediction>): ObjList<ReliabilityRiskScoreMlValidationPrediction>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<ReliabilityRiskScoreMlValidationPrediction>): ObjList<ReliabilityRiskScoreMlValidationPrediction>;
   ...
   */
  static afterCreate(objs: Array_Type<ReliabilityRiskScoreMlValidationPrediction>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<ReliabilityRiskScoreMlValidationPrediction>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<ReliabilityRiskScoreMlValidationPrediction>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityRiskScoreMlValidationPrediction>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityRiskScoreMlValidationPrediction>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): ReliabilityRiskScoreMlValidationPrediction | null;
   ...
   */
  withoutIdentity(): ReliabilityRiskScoreMlValidationPrediction | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<ReliabilityRiskScoreMlValidationPrediction>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: ReliabilityRiskScoreMlValidationPrediction, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<ReliabilityRiskScoreMlValidationPrediction>, callback?: λFunction<ReliabilityRiskScoreMlValidationPrediction | null, ReliabilityRiskScoreMlValidationPrediction | null>): ObjList<ReliabilityRiskScoreMlValidationPrediction>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<ReliabilityRiskScoreMlValidationPrediction>, callback?: λFunction<ReliabilityRiskScoreMlValidationPrediction | null, ReliabilityRiskScoreMlValidationPrediction | null>): Array_Type<ObjError> | null;
