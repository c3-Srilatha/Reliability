// TypeScript definitions for the C3 type ReliabilityMl.Setup
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityMl.Setup
 */
 ...
 */
declare namespace ReliabilityMl {
  export class Setup extends Obj  {
    ...
    withTypeIdent(typeIdent: string | null): ReliabilityMl.Setup;
     ...
     */
    readonly id: string;
    withId(id: string): ReliabilityMl.Setup;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityMl.Setup;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): ReliabilityMl.Setup;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): ReliabilityMl.Setup;
    ...
    withVersion(version: number | null): ReliabilityMl.Setup;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): ReliabilityMl.Setup;
     ...
     */
    readonly file: File;
    withFile(file: IFile): ReliabilityMl.Setup;
    ...
    withActionRequirement(actionRequirement: string): ReliabilityMl.Setup;
     ...
     * @see #toJson
     */
    static fromJson(json: any): ReliabilityMl.Setup | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): ReliabilityMl.Setup | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): ReliabilityMl.Setup | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): ReliabilityMl.Setup | null;
     ...
     */
    replaceType(old: Type, new_: Type): ReliabilityMl.Setup;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityMl.Setup;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityMl.Setup;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityMl.Setup>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityMl.Setup>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityMl.Setup;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityMl.Setup;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityMl.Setup;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): ReliabilityMl.Setup;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): ReliabilityMl.Setup;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityMl.Setup;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityMl.Setup;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityMl.Setup;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): ReliabilityMl.Setup;
     ...
     * @see #removeField
     */
    withoutField(field: string): ReliabilityMl.Setup;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): ReliabilityMl.Setup;
     ...
     */
    withoutFields(fields: Array_Type<string>): ReliabilityMl.Setup;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityMl.Setup;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): ReliabilityMl.Setup;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityMl.Setup;
     ...
     * @see #unsetField
     */
    defaultField(field: string): ReliabilityMl.Setup;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): ReliabilityMl.Setup;
     ...
     * @see #removeField
     */
    unsetField(field: string): ReliabilityMl.Setup;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): ReliabilityMl.Setup;
     ...
     * @see #unsetField
     */
    removeField(field: string): ReliabilityMl.Setup;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): ReliabilityMl.Setup;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityMl.Setup;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityMl.Setup;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityMl.Setup;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityMl.Setup;

    mergeJson(json: any): ReliabilityMl.Setup;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityMl.Setup;
     ...
     */
    sumObj(other: Obj, deep?: boolean): ReliabilityMl.Setup;
     ...
     */
    singletonArray(): Array_Type<ReliabilityMl.Setup>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityMl.Setup> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<ReliabilityMl.Setup> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<ReliabilityMl.Setup>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<ReliabilityMl.Setup> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, ReliabilityMl.Setup> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityMl.Setup> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<ReliabilityMl.Setup>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<ReliabilityMl.Setup>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityMl.Setup;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityMl.Setup;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityMl.Setup;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): ReliabilityMl.Setup;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityMl.Setup;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): ReliabilityMl.Setup;
     ...
     * @see #fromString
     */
    static make(s: string): ReliabilityMl.Setup | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityMl.Setup;
     ...
     */
    static cachedEmptyInst(): ReliabilityMl.Setup;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityMl.Setup> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): ReliabilityMl.Setup;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<ReliabilityMl.Setup>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<ReliabilityMl.Setup>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityMl.Setup> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityMl.Setup>> | null;
     ...
     */
    get(include?: string): ReliabilityMl.Setup | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): ReliabilityMl.Setup | null;
     ...
     */
    getMissing(spec: GetMissingSpec): ReliabilityMl.Setup;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): ReliabilityMl.Setup | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): ReliabilityMl.Setup;
     ...
     * @see #toString
     */
    static fromString(s: string): ReliabilityMl.Setup | null;
     ...
     */
    create(spec?: UpsertSpec): ReliabilityMl.Setup | null;
     ...
     */
    static createBatch(objs: Array_Type<ReliabilityMl.Setup>, spec?: UpsertSpec): ObjList<ReliabilityMl.Setup> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<ReliabilityMl.Setup>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityMl.Setup> | null;
     ...
     */
    update(srcObj?: ReliabilityMl.Setup, spec?: UpsertSpec): ReliabilityMl.Setup | null;
     ...
     */
    upsert(srcObj?: ReliabilityMl.Setup, spec?: UpsertSpec): ReliabilityMl.Setup | null;
     ...
     */
    merge(spec?: MergeSpec): ReliabilityMl.Setup | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): ReliabilityMl.Setup | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): ReliabilityMl.Setup | null;
     ...
     */
    static updateBatch(objs: Array_Type<ReliabilityMl.Setup>, srcObjs?: Array_Type<ReliabilityMl.Setup>, spec?: UpsertSpec): ObjList<ReliabilityMl.Setup> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<ReliabilityMl.Setup> | null>, spec?: UpsertSpec): ObjList<ReliabilityMl.Setup> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<ReliabilityMl.Setup>, srcObjs?: Array_Type<ReliabilityMl.Setup>, spec?: UpsertSpec): ObjList<ReliabilityMl.Setup> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<ReliabilityMl.Setup> | null>, spec?: UpsertSpec): ObjList<ReliabilityMl.Setup> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<ReliabilityMl.Setup>, spec?: TouchSpec): ObjList<ReliabilityMl.Setup> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityMl.Setup>, spec?: MergeSpec): ObjList<ReliabilityMl.Setup> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityMl.Setup>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityMl.Setup> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<ReliabilityMl.Setup> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityMl.Setup> | null;
     ...
     */
    static mergeAll(mergeObj: ReliabilityMl.Setup, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: ReliabilityMl.Setup, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<ReliabilityMl.Setup>, spec?: UpsertSpec): ObjList<ReliabilityMl.Setup> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<ReliabilityMl.Setup>, spec?: UpsertSpec): ObjList<ReliabilityMl.Setup> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): ReliabilityMl.Setup | null;
     ...
     */
    static beforeCreate(objs: Array_Type<ReliabilityMl.Setup>): ObjList<ReliabilityMl.Setup>;
     ...
     */
    static beforeUpdate(objs: Array_Type<ReliabilityMl.Setup>): ObjList<ReliabilityMl.Setup>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<ReliabilityMl.Setup>): ObjList<ReliabilityMl.Setup>;
     ...
     */
    static afterCreate(objs: Array_Type<ReliabilityMl.Setup>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<ReliabilityMl.Setup>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<ReliabilityMl.Setup>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityMl.Setup>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityMl.Setup>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): ReliabilityMl.Setup | null;
     ...
     */
    withoutIdentity(): ReliabilityMl.Setup | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<ReliabilityMl.Setup>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: ReliabilityMl.Setup, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<ReliabilityMl.Setup>, callback?: λFunction<ReliabilityMl.Setup | null, ReliabilityMl.Setup | null>): ObjList<ReliabilityMl.Setup>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<ReliabilityMl.Setup>, callback?: λFunction<ReliabilityMl.Setup | null, ReliabilityMl.Setup | null>): Array_Type<ObjError> | null;
     ...
     */
    static setup(file: File, actionRequirement: string): void;
  }
}
