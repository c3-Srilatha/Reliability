// TypeScript definitions for the C3 type ReliabilityRiskScoreMlValidationContributionHeader
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityRiskScoreMlValidationContributionHeader
 */
declare interface IReliabilityRiskScoreMlValidationContributionHeader {
   ...
   */
  data?: Array_Type<ReliabilityRiskScoreMlValidationContribution> | Array<IReliabilityRiskScoreMlValidationContribution>;
 ...
 */
declare class ReliabilityRiskScoreMlValidationContributionHeader extends Obj  {

  /**
   * Populated on normalization. Indicates the earliest data point across various timeseries fields.
   */
  readonly earliest?: DateTime;
  withEarliest(earliest: DateTime | Date | string | null): ReliabilityRiskScoreMlValidationContributionHeader;

  /**
   * Populated on normalization. Indicates the latest data point across various timeseries fields.
   */
  readonly latest?: DateTime;
  withLatest(latest: DateTime | Date | string | null): ReliabilityRiskScoreMlValidationContributionHeader;

  /**
   * Populated on normalization. Indicates the earliest data point for each {@link Ann.Ts} fields.
   */
  readonly earliestTsDp?: Map_Type<string, TSDataPoint>;
  withEarliestTsDp(earliestTsDp: Map_Type<string, TSDataPoint> | {[key: string]: ITSDataPoint} | null): ReliabilityRiskScoreMlValidationContributionHeader;

  /**
   * Populated on normalization. Indicates the latest data point for each {@link Ann.Ts} fields.
   */
  readonly latestTsDp?: Map_Type<string, TSDataPoint>;
  withLatestTsDp(latestTsDp: Map_Type<string, TSDataPoint> | {[key: string]: ITSDataPoint} | null): ReliabilityRiskScoreMlValidationContributionHeader;
  ...
  withInterval(interval: string | null): ReliabilityRiskScoreMlValidationContributionHeader;
  ...
  withTimeZone(timeZone: string | null): ReliabilityRiskScoreMlValidationContributionHeader;

  /**
   * If set, disables normalizing this time series. Invalidations will still continue to happen for this series normally.
   */
  readonly doNotNormalize?: boolean;
  withDoNotNormalize(doNotNormalize: boolean): ReliabilityRiskScoreMlValidationContributionHeader;

  /**
   * Data points corresponding to this timeseries header
   */
  readonly data?: Array_Type<ReliabilityRiskScoreMlValidationContribution>;
  withData(data: Array_Type<ReliabilityRiskScoreMlValidationContribution> | Array<IReliabilityRiskScoreMlValidationContribution> | null): ReliabilityRiskScoreMlValidationContributionHeader;

  /**
   * Use this field to specify the interpolation mechanism to be applied for gaps in interval timeseries. Default: `ZERO_INTERPOLATOR`.
   */
  readonly interpolator?: string;
  withInterpolator(interpolator: string | null): ReliabilityRiskScoreMlValidationContributionHeader;

  /**
   * Use this field to specify how normalization should handle duplicate data points. A duplicate point is one that has the same start, end, value, unit, and {@link TimedDataPointFields#isEstimated} values. Default: `IGNORE`.
   */
  readonly duplicateHandling?: string;
  withDuplicateHandling(duplicateHandling: string | null): ReliabilityRiskScoreMlValidationContributionHeader;

  /**
   * Used to specify how normalization should handle overlapping data points. Default: `AVG`.
   */
  readonly overlapHandling?: string;
  withOverlapHandling(overlapHandling: string | null): ReliabilityRiskScoreMlValidationContributionHeader;
  ...
  withBucketInterval(bucketInterval: string | null): ReliabilityRiskScoreMlValidationContributionHeader;
  ...
  withNormalizationPartitionStrategy(normalizationPartitionStrategy: INormalizationPartitionStrategy | null): ReliabilityRiskScoreMlValidationContributionHeader;

  /**
   * Indicates whether the last data point should be repeated until infinity
   */
  readonly extrapolate?: boolean;
  withExtrapolate(extrapolate: boolean): ReliabilityRiskScoreMlValidationContributionHeader;
  ...
  withTypeIdent(typeIdent: string | null): ReliabilityRiskScoreMlValidationContributionHeader;
   ...
   */
  readonly id: string;
  withId(id: string): ReliabilityRiskScoreMlValidationContributionHeader;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityRiskScoreMlValidationContributionHeader;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): ReliabilityRiskScoreMlValidationContributionHeader;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): ReliabilityRiskScoreMlValidationContributionHeader;
  ...
  withVersion(version: number | null): ReliabilityRiskScoreMlValidationContributionHeader;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): ReliabilityRiskScoreMlValidationContributionHeader;

  /**
   * The reference to the parent relation that generated this feature contribution timeseries.
   */
  readonly parent: ReliabilityAssetToRiskModelValidationRelation;
  withParent(parent: IReliabilityAssetToRiskModelValidationRelation): ReliabilityRiskScoreMlValidationContributionHeader;

  /**
   * The treatment to use for the timeseries.
   */
  readonly treatment?: string;
  withTreatment(treatment: string | null): ReliabilityRiskScoreMlValidationContributionHeader;
   ...
   * @see #toJson
   */
  static fromJson(json: any): ReliabilityRiskScoreMlValidationContributionHeader | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): ReliabilityRiskScoreMlValidationContributionHeader | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): ReliabilityRiskScoreMlValidationContributionHeader | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): ReliabilityRiskScoreMlValidationContributionHeader | null;
   ...
   */
  replaceType(old: Type, new_: Type): ReliabilityRiskScoreMlValidationContributionHeader;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityRiskScoreMlValidationContributionHeader;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityRiskScoreMlValidationContributionHeader;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityRiskScoreMlValidationContributionHeader>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityRiskScoreMlValidationContributionHeader>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityRiskScoreMlValidationContributionHeader;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityRiskScoreMlValidationContributionHeader;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityRiskScoreMlValidationContributionHeader;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ReliabilityRiskScoreMlValidationContributionHeader;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ReliabilityRiskScoreMlValidationContributionHeader;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityRiskScoreMlValidationContributionHeader;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityRiskScoreMlValidationContributionHeader;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityRiskScoreMlValidationContributionHeader;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ReliabilityRiskScoreMlValidationContributionHeader;
   ...
   * @see #removeField
   */
  withoutField(field: string): ReliabilityRiskScoreMlValidationContributionHeader;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): ReliabilityRiskScoreMlValidationContributionHeader;
   ...
   */
  withoutFields(fields: Array_Type<string>): ReliabilityRiskScoreMlValidationContributionHeader;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityRiskScoreMlValidationContributionHeader;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ReliabilityRiskScoreMlValidationContributionHeader;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityRiskScoreMlValidationContributionHeader;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ReliabilityRiskScoreMlValidationContributionHeader;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ReliabilityRiskScoreMlValidationContributionHeader;
   ...
   * @see #removeField
   */
  unsetField(field: string): ReliabilityRiskScoreMlValidationContributionHeader;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ReliabilityRiskScoreMlValidationContributionHeader;
   ...
   * @see #unsetField
   */
  removeField(field: string): ReliabilityRiskScoreMlValidationContributionHeader;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ReliabilityRiskScoreMlValidationContributionHeader;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityRiskScoreMlValidationContributionHeader;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityRiskScoreMlValidationContributionHeader;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityRiskScoreMlValidationContributionHeader;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityRiskScoreMlValidationContributionHeader;

  mergeJson(json: any): ReliabilityRiskScoreMlValidationContributionHeader;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityRiskScoreMlValidationContributionHeader;
   ...
   */
  sumObj(other: Obj, deep?: boolean): ReliabilityRiskScoreMlValidationContributionHeader;
   ...
   */
  singletonArray(): Array_Type<ReliabilityRiskScoreMlValidationContributionHeader>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityRiskScoreMlValidationContributionHeader> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ReliabilityRiskScoreMlValidationContributionHeader> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<ReliabilityRiskScoreMlValidationContributionHeader>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ReliabilityRiskScoreMlValidationContributionHeader> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, ReliabilityRiskScoreMlValidationContributionHeader> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityRiskScoreMlValidationContributionHeader> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ReliabilityRiskScoreMlValidationContributionHeader>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ReliabilityRiskScoreMlValidationContributionHeader>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityRiskScoreMlValidationContributionHeader;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityRiskScoreMlValidationContributionHeader;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityRiskScoreMlValidationContributionHeader;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ReliabilityRiskScoreMlValidationContributionHeader;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityRiskScoreMlValidationContributionHeader;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ReliabilityRiskScoreMlValidationContributionHeader;
   ...
   * @see #fromString
   */
  static make(s: string): ReliabilityRiskScoreMlValidationContributionHeader | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityRiskScoreMlValidationContributionHeader;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): ReliabilityRiskScoreMlValidationContributionHeader;
   ...
   */
  static cachedEmptyInst(): ReliabilityRiskScoreMlValidationContributionHeader;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityRiskScoreMlValidationContributionHeader> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): ReliabilityRiskScoreMlValidationContributionHeader;
   ...
   */
  static normalizeTimeseries(timeseries?: TimedDataFields<ReliabilityRiskScoreMlValidationContribution>, start?: DateTime, end?: DateTime, overrideGrain?: string, forceGrainDetection?: boolean, force?: boolean): void;
   ...
   */
  static normalize(timeseries?: TimedDataFields<ReliabilityRiskScoreMlValidationContribution>, start?: DateTime, end?: DateTime, overrideGrain?: string, forceGrainDetection?: boolean): NormalizationResult | null;
   ...
   */
  static normalizationUnit(rawHeader: TimedDataFields<ReliabilityRiskScoreMlValidationContribution>, tsField: string): Unit | null;
   ...
   */
  static normalizationTreatment(rawHeader: TimedDataFields<ReliabilityRiskScoreMlValidationContribution>, tsField: string): string;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<ReliabilityRiskScoreMlValidationContributionHeader>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<ReliabilityRiskScoreMlValidationContributionHeader>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityRiskScoreMlValidationContributionHeader> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityRiskScoreMlValidationContributionHeader>> | null;
   ...
   */
  get(include?: string): ReliabilityRiskScoreMlValidationContributionHeader | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): ReliabilityRiskScoreMlValidationContributionHeader | null;
   ...
   */
  getMissing(spec: GetMissingSpec): ReliabilityRiskScoreMlValidationContributionHeader;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): ReliabilityRiskScoreMlValidationContributionHeader | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): ReliabilityRiskScoreMlValidationContributionHeader;
   ...
   * @see #toString
   */
  static fromString(s: string): ReliabilityRiskScoreMlValidationContributionHeader | null;
   ...
   */
  create(spec?: UpsertSpec): ReliabilityRiskScoreMlValidationContributionHeader | null;
   ...
   */
  static createBatch(objs: Array_Type<ReliabilityRiskScoreMlValidationContributionHeader>, spec?: UpsertSpec): ObjList<ReliabilityRiskScoreMlValidationContributionHeader> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<ReliabilityRiskScoreMlValidationContributionHeader>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityRiskScoreMlValidationContributionHeader> | null;
   ...
   */
  update(srcObj?: ReliabilityRiskScoreMlValidationContributionHeader, spec?: UpsertSpec): ReliabilityRiskScoreMlValidationContributionHeader | null;
   ...
   */
  upsert(srcObj?: ReliabilityRiskScoreMlValidationContributionHeader, spec?: UpsertSpec): ReliabilityRiskScoreMlValidationContributionHeader | null;
   ...
   */
  merge(spec?: MergeSpec): ReliabilityRiskScoreMlValidationContributionHeader | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): ReliabilityRiskScoreMlValidationContributionHeader | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): ReliabilityRiskScoreMlValidationContributionHeader | null;
   ...
   */
  static updateBatch(objs: Array_Type<ReliabilityRiskScoreMlValidationContributionHeader>, srcObjs?: Array_Type<ReliabilityRiskScoreMlValidationContributionHeader>, spec?: UpsertSpec): ObjList<ReliabilityRiskScoreMlValidationContributionHeader> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<ReliabilityRiskScoreMlValidationContributionHeader> | null>, spec?: UpsertSpec): ObjList<ReliabilityRiskScoreMlValidationContributionHeader> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<ReliabilityRiskScoreMlValidationContributionHeader>, srcObjs?: Array_Type<ReliabilityRiskScoreMlValidationContributionHeader>, spec?: UpsertSpec): ObjList<ReliabilityRiskScoreMlValidationContributionHeader> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<ReliabilityRiskScoreMlValidationContributionHeader> | null>, spec?: UpsertSpec): ObjList<ReliabilityRiskScoreMlValidationContributionHeader> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<ReliabilityRiskScoreMlValidationContributionHeader>, spec?: TouchSpec): ObjList<ReliabilityRiskScoreMlValidationContributionHeader> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityRiskScoreMlValidationContributionHeader>, spec?: MergeSpec): ObjList<ReliabilityRiskScoreMlValidationContributionHeader> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityRiskScoreMlValidationContributionHeader>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityRiskScoreMlValidationContributionHeader> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<ReliabilityRiskScoreMlValidationContributionHeader> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityRiskScoreMlValidationContributionHeader> | null;
   ...
   */
  static mergeAll(mergeObj: ReliabilityRiskScoreMlValidationContributionHeader, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: ReliabilityRiskScoreMlValidationContributionHeader, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<ReliabilityRiskScoreMlValidationContributionHeader>, spec?: UpsertSpec): ObjList<ReliabilityRiskScoreMlValidationContributionHeader> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<ReliabilityRiskScoreMlValidationContributionHeader>, spec?: UpsertSpec): ObjList<ReliabilityRiskScoreMlValidationContributionHeader> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): ReliabilityRiskScoreMlValidationContributionHeader | null;
   ...
   */
  static beforeCreate(objs: Array_Type<ReliabilityRiskScoreMlValidationContributionHeader>): ObjList<ReliabilityRiskScoreMlValidationContributionHeader>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<ReliabilityRiskScoreMlValidationContributionHeader>): ObjList<ReliabilityRiskScoreMlValidationContributionHeader>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<ReliabilityRiskScoreMlValidationContributionHeader>): ObjList<ReliabilityRiskScoreMlValidationContributionHeader>;
   ...
   */
  static afterCreate(objs: Array_Type<ReliabilityRiskScoreMlValidationContributionHeader>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<ReliabilityRiskScoreMlValidationContributionHeader>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<ReliabilityRiskScoreMlValidationContributionHeader>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityRiskScoreMlValidationContributionHeader>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityRiskScoreMlValidationContributionHeader>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): ReliabilityRiskScoreMlValidationContributionHeader | null;
   ...
   */
  withoutIdentity(): ReliabilityRiskScoreMlValidationContributionHeader | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<ReliabilityRiskScoreMlValidationContributionHeader>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: ReliabilityRiskScoreMlValidationContributionHeader, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<ReliabilityRiskScoreMlValidationContributionHeader>, callback?: λFunction<ReliabilityRiskScoreMlValidationContributionHeader | null, ReliabilityRiskScoreMlValidationContributionHeader | null>): ObjList<ReliabilityRiskScoreMlValidationContributionHeader>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<ReliabilityRiskScoreMlValidationContributionHeader>, callback?: λFunction<ReliabilityRiskScoreMlValidationContributionHeader | null, ReliabilityRiskScoreMlValidationContributionHeader | null>): Array_Type<ObjError> | null;
