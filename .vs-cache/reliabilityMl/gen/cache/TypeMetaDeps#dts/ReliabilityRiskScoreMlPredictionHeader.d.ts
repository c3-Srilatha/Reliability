// TypeScript definitions for the C3 type ReliabilityRiskScoreMlPredictionHeader
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityRiskScoreMlPredictionHeader
 */
declare interface IReliabilityRiskScoreMlPredictionHeader {
   ...
   */
  data?: Array_Type<ReliabilityRiskScoreMlPrediction> | Array<IReliabilityRiskScoreMlPrediction>;
 ...
 */
declare class ReliabilityRiskScoreMlPredictionHeader extends Obj  {

  /**
   * Populated on normalization. Indicates the earliest data point across various timeseries fields.
   */
  readonly earliest?: DateTime;
  withEarliest(earliest: DateTime | Date | string | null): ReliabilityRiskScoreMlPredictionHeader;

  /**
   * Populated on normalization. Indicates the latest data point across various timeseries fields.
   */
  readonly latest?: DateTime;
  withLatest(latest: DateTime | Date | string | null): ReliabilityRiskScoreMlPredictionHeader;

  /**
   * Populated on normalization. Indicates the earliest data point for each {@link Ann.Ts} fields.
   */
  readonly earliestTsDp?: Map_Type<string, TSDataPoint>;
  withEarliestTsDp(earliestTsDp: Map_Type<string, TSDataPoint> | {[key: string]: ITSDataPoint} | null): ReliabilityRiskScoreMlPredictionHeader;

  /**
   * Populated on normalization. Indicates the latest data point for each {@link Ann.Ts} fields.
   */
  readonly latestTsDp?: Map_Type<string, TSDataPoint>;
  withLatestTsDp(latestTsDp: Map_Type<string, TSDataPoint> | {[key: string]: ITSDataPoint} | null): ReliabilityRiskScoreMlPredictionHeader;
  ...
  withInterval(interval: string | null): ReliabilityRiskScoreMlPredictionHeader;
  ...
  withTimeZone(timeZone: string | null): ReliabilityRiskScoreMlPredictionHeader;

  /**
   * If set, disables normalizing this time series. Invalidations will still continue to happen for this series normally.
   */
  readonly doNotNormalize?: boolean;
  withDoNotNormalize(doNotNormalize: boolean): ReliabilityRiskScoreMlPredictionHeader;

  /**
   * Data points corresponding to this timeseries header
   */
  readonly data?: Array_Type<ReliabilityRiskScoreMlPrediction>;
  withData(data: Array_Type<ReliabilityRiskScoreMlPrediction> | Array<IReliabilityRiskScoreMlPrediction> | null): ReliabilityRiskScoreMlPredictionHeader;

  /**
   * Use this field to specify the interpolation mechanism to be applied for gaps in interval timeseries. Default: `ZERO_INTERPOLATOR`.
   */
  readonly interpolator?: string;
  withInterpolator(interpolator: string | null): ReliabilityRiskScoreMlPredictionHeader;

  /**
   * Use this field to specify how normalization should handle duplicate data points. A duplicate point is one that has the same start, end, value, unit, and {@link TimedDataPointFields#isEstimated} values. Default: `IGNORE`.
   */
  readonly duplicateHandling?: string;
  withDuplicateHandling(duplicateHandling: string | null): ReliabilityRiskScoreMlPredictionHeader;

  /**
   * Used to specify how normalization should handle overlapping data points. Default: `AVG`.
   */
  readonly overlapHandling?: string;
  withOverlapHandling(overlapHandling: string | null): ReliabilityRiskScoreMlPredictionHeader;
  ...
  withBucketInterval(bucketInterval: string | null): ReliabilityRiskScoreMlPredictionHeader;
  ...
  withNormalizationPartitionStrategy(normalizationPartitionStrategy: INormalizationPartitionStrategy | null): ReliabilityRiskScoreMlPredictionHeader;

  /**
   * Indicates whether the last data point should be repeated until infinity
   */
  readonly extrapolate?: boolean;
  withExtrapolate(extrapolate: boolean): ReliabilityRiskScoreMlPredictionHeader;
  ...
  withTypeIdent(typeIdent: string | null): ReliabilityRiskScoreMlPredictionHeader;
   ...
   */
  readonly id: string;
  withId(id: string): ReliabilityRiskScoreMlPredictionHeader;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityRiskScoreMlPredictionHeader;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): ReliabilityRiskScoreMlPredictionHeader;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): ReliabilityRiskScoreMlPredictionHeader;
  ...
  withVersion(version: number | null): ReliabilityRiskScoreMlPredictionHeader;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): ReliabilityRiskScoreMlPredictionHeader;

  /**
   * The subject-model association related to this series header.
   */
  readonly parent: ReliabilityAssetToRiskModelRelation;
  withParent(parent: IReliabilityAssetToRiskModelRelation): ReliabilityRiskScoreMlPredictionHeader;

  /**
   * The treatment to use for the timeseries.
   */
  readonly treatment?: string;
  withTreatment(treatment: string | null): ReliabilityRiskScoreMlPredictionHeader;

  /**
   * The unit to use for the timeseries.
   */
  readonly unitConstraint?: Unit;
  withUnitConstraint(unitConstraint: IUnit | null): ReliabilityRiskScoreMlPredictionHeader;
   ...
   * @see #toJson
   */
  static fromJson(json: any): ReliabilityRiskScoreMlPredictionHeader | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): ReliabilityRiskScoreMlPredictionHeader | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): ReliabilityRiskScoreMlPredictionHeader | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): ReliabilityRiskScoreMlPredictionHeader | null;
   ...
   */
  replaceType(old: Type, new_: Type): ReliabilityRiskScoreMlPredictionHeader;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityRiskScoreMlPredictionHeader;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityRiskScoreMlPredictionHeader;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityRiskScoreMlPredictionHeader>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityRiskScoreMlPredictionHeader>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityRiskScoreMlPredictionHeader;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityRiskScoreMlPredictionHeader;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityRiskScoreMlPredictionHeader;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ReliabilityRiskScoreMlPredictionHeader;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ReliabilityRiskScoreMlPredictionHeader;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityRiskScoreMlPredictionHeader;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityRiskScoreMlPredictionHeader;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityRiskScoreMlPredictionHeader;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ReliabilityRiskScoreMlPredictionHeader;
   ...
   * @see #removeField
   */
  withoutField(field: string): ReliabilityRiskScoreMlPredictionHeader;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): ReliabilityRiskScoreMlPredictionHeader;
   ...
   */
  withoutFields(fields: Array_Type<string>): ReliabilityRiskScoreMlPredictionHeader;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityRiskScoreMlPredictionHeader;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ReliabilityRiskScoreMlPredictionHeader;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityRiskScoreMlPredictionHeader;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ReliabilityRiskScoreMlPredictionHeader;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ReliabilityRiskScoreMlPredictionHeader;
   ...
   * @see #removeField
   */
  unsetField(field: string): ReliabilityRiskScoreMlPredictionHeader;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ReliabilityRiskScoreMlPredictionHeader;
   ...
   * @see #unsetField
   */
  removeField(field: string): ReliabilityRiskScoreMlPredictionHeader;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ReliabilityRiskScoreMlPredictionHeader;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityRiskScoreMlPredictionHeader;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityRiskScoreMlPredictionHeader;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityRiskScoreMlPredictionHeader;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityRiskScoreMlPredictionHeader;

  mergeJson(json: any): ReliabilityRiskScoreMlPredictionHeader;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityRiskScoreMlPredictionHeader;
   ...
   */
  sumObj(other: Obj, deep?: boolean): ReliabilityRiskScoreMlPredictionHeader;
   ...
   */
  singletonArray(): Array_Type<ReliabilityRiskScoreMlPredictionHeader>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityRiskScoreMlPredictionHeader> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ReliabilityRiskScoreMlPredictionHeader> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<ReliabilityRiskScoreMlPredictionHeader>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ReliabilityRiskScoreMlPredictionHeader> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, ReliabilityRiskScoreMlPredictionHeader> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityRiskScoreMlPredictionHeader> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ReliabilityRiskScoreMlPredictionHeader>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ReliabilityRiskScoreMlPredictionHeader>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityRiskScoreMlPredictionHeader;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityRiskScoreMlPredictionHeader;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityRiskScoreMlPredictionHeader;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ReliabilityRiskScoreMlPredictionHeader;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityRiskScoreMlPredictionHeader;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ReliabilityRiskScoreMlPredictionHeader;
   ...
   * @see #fromString
   */
  static make(s: string): ReliabilityRiskScoreMlPredictionHeader | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityRiskScoreMlPredictionHeader;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): ReliabilityRiskScoreMlPredictionHeader;
   ...
   */
  static cachedEmptyInst(): ReliabilityRiskScoreMlPredictionHeader;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityRiskScoreMlPredictionHeader> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): ReliabilityRiskScoreMlPredictionHeader;
   ...
   */
  static normalizeTimeseries(timeseries?: TimedDataFields<ReliabilityRiskScoreMlPrediction>, start?: DateTime, end?: DateTime, overrideGrain?: string, forceGrainDetection?: boolean, force?: boolean): void;
   ...
   */
  static normalize(timeseries?: TimedDataFields<ReliabilityRiskScoreMlPrediction>, start?: DateTime, end?: DateTime, overrideGrain?: string, forceGrainDetection?: boolean): NormalizationResult | null;
   ...
   */
  static normalizationUnit(rawHeader: TimedDataFields<ReliabilityRiskScoreMlPrediction>, tsField: string): Unit | null;
   ...
   */
  static normalizationTreatment(rawHeader: TimedDataFields<ReliabilityRiskScoreMlPrediction>, tsField: string): string;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<ReliabilityRiskScoreMlPredictionHeader>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<ReliabilityRiskScoreMlPredictionHeader>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityRiskScoreMlPredictionHeader> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityRiskScoreMlPredictionHeader>> | null;
   ...
   */
  get(include?: string): ReliabilityRiskScoreMlPredictionHeader | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): ReliabilityRiskScoreMlPredictionHeader | null;
   ...
   */
  getMissing(spec: GetMissingSpec): ReliabilityRiskScoreMlPredictionHeader;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): ReliabilityRiskScoreMlPredictionHeader | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): ReliabilityRiskScoreMlPredictionHeader;
   ...
   * @see #toString
   */
  static fromString(s: string): ReliabilityRiskScoreMlPredictionHeader | null;
   ...
   */
  create(spec?: UpsertSpec): ReliabilityRiskScoreMlPredictionHeader | null;
   ...
   */
  static createBatch(objs: Array_Type<ReliabilityRiskScoreMlPredictionHeader>, spec?: UpsertSpec): ObjList<ReliabilityRiskScoreMlPredictionHeader> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<ReliabilityRiskScoreMlPredictionHeader>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityRiskScoreMlPredictionHeader> | null;
   ...
   */
  update(srcObj?: ReliabilityRiskScoreMlPredictionHeader, spec?: UpsertSpec): ReliabilityRiskScoreMlPredictionHeader | null;
   ...
   */
  upsert(srcObj?: ReliabilityRiskScoreMlPredictionHeader, spec?: UpsertSpec): ReliabilityRiskScoreMlPredictionHeader | null;
   ...
   */
  merge(spec?: MergeSpec): ReliabilityRiskScoreMlPredictionHeader | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): ReliabilityRiskScoreMlPredictionHeader | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): ReliabilityRiskScoreMlPredictionHeader | null;
   ...
   */
  static updateBatch(objs: Array_Type<ReliabilityRiskScoreMlPredictionHeader>, srcObjs?: Array_Type<ReliabilityRiskScoreMlPredictionHeader>, spec?: UpsertSpec): ObjList<ReliabilityRiskScoreMlPredictionHeader> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<ReliabilityRiskScoreMlPredictionHeader> | null>, spec?: UpsertSpec): ObjList<ReliabilityRiskScoreMlPredictionHeader> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<ReliabilityRiskScoreMlPredictionHeader>, srcObjs?: Array_Type<ReliabilityRiskScoreMlPredictionHeader>, spec?: UpsertSpec): ObjList<ReliabilityRiskScoreMlPredictionHeader> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<ReliabilityRiskScoreMlPredictionHeader> | null>, spec?: UpsertSpec): ObjList<ReliabilityRiskScoreMlPredictionHeader> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<ReliabilityRiskScoreMlPredictionHeader>, spec?: TouchSpec): ObjList<ReliabilityRiskScoreMlPredictionHeader> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityRiskScoreMlPredictionHeader>, spec?: MergeSpec): ObjList<ReliabilityRiskScoreMlPredictionHeader> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityRiskScoreMlPredictionHeader>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityRiskScoreMlPredictionHeader> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<ReliabilityRiskScoreMlPredictionHeader> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityRiskScoreMlPredictionHeader> | null;
   ...
   */
  static mergeAll(mergeObj: ReliabilityRiskScoreMlPredictionHeader, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: ReliabilityRiskScoreMlPredictionHeader, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<ReliabilityRiskScoreMlPredictionHeader>, spec?: UpsertSpec): ObjList<ReliabilityRiskScoreMlPredictionHeader> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<ReliabilityRiskScoreMlPredictionHeader>, spec?: UpsertSpec): ObjList<ReliabilityRiskScoreMlPredictionHeader> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): ReliabilityRiskScoreMlPredictionHeader | null;
   ...
   */
  static beforeCreate(objs: Array_Type<ReliabilityRiskScoreMlPredictionHeader>): ObjList<ReliabilityRiskScoreMlPredictionHeader>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<ReliabilityRiskScoreMlPredictionHeader>): ObjList<ReliabilityRiskScoreMlPredictionHeader>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<ReliabilityRiskScoreMlPredictionHeader>): ObjList<ReliabilityRiskScoreMlPredictionHeader>;
   ...
   */
  static afterCreate(objs: Array_Type<ReliabilityRiskScoreMlPredictionHeader>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<ReliabilityRiskScoreMlPredictionHeader>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<ReliabilityRiskScoreMlPredictionHeader>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityRiskScoreMlPredictionHeader>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityRiskScoreMlPredictionHeader>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): ReliabilityRiskScoreMlPredictionHeader | null;
   ...
   */
  withoutIdentity(): ReliabilityRiskScoreMlPredictionHeader | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<ReliabilityRiskScoreMlPredictionHeader>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: ReliabilityRiskScoreMlPredictionHeader, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<ReliabilityRiskScoreMlPredictionHeader>, callback?: λFunction<ReliabilityRiskScoreMlPredictionHeader | null, ReliabilityRiskScoreMlPredictionHeader | null>): ObjList<ReliabilityRiskScoreMlPredictionHeader>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<ReliabilityRiskScoreMlPredictionHeader>, callback?: λFunction<ReliabilityRiskScoreMlPredictionHeader | null, ReliabilityRiskScoreMlPredictionHeader | null>): Array_Type<ObjError> | null;
