// TypeScript definitions for the C3 type ReliabilityMl.CustomPipe
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityMl.CustomPipe
 */
declare namespace ReliabilityMl {
  export interface ICustomPipe<DX, DY, DO> {

    /**
     * Defined in number of seconds, this field represents the duration of historical data
     * required to run model inference for a timestamp `t`.
     * An example is a model which needs `t-4hours : t` duration of data to make a prediction
     * for timestamp `t`. In this example, {@link lookbackDuration} must be set to 14,400, i.e.,
     ...
     */
    inheritsFrom?: Array_Type<string> | Array<string>;

    /**
     * The keyword arguments required for instantiating an object of class, {@link className}.
     */
    classKwargs?: Array_Type<ReliabilityMl.CustomPipeKwarg> | Array<IReliabilityMl.CustomPipeKwarg>;
     ...
     */
    trainedHyperparamValues?: Map_Type<string, any> | {[key: string]: any};
  }
}
 ...
 * python classes in `.py` files rather than defining them as `.c3typ` files.
 *
 * @remarks this represents a made instance of ReliabilityMl.CustomPipe
 */
declare namespace ReliabilityMl {
  export class CustomPipe<DX, DY, DO> extends Obj  {
    ...
    withLookbackDuration(lookbackDuration: number): ReliabilityMl.CustomPipe;
     ...
     */
    readonly id: string;
    withId(id: string): ReliabilityMl.CustomPipe;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityMl.CustomPipe;

    /**
     * Name of this pipe.
     */
    readonly name?: string;
    withName(name: string | null): ReliabilityMl.CustomPipe;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): ReliabilityMl.CustomPipe;
    ...
    withVersion(version: number | null): ReliabilityMl.CustomPipe;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): ReliabilityMl.CustomPipe;
    ...
    withUserUpdatedFields(userUpdatedFields: Array_Type<string> | Array<string> | null): ReliabilityMl.CustomPipe;
    ...
    withHidden(hidden: boolean): ReliabilityMl.CustomPipe;
    ...
    withUserOwned(userOwned: boolean): ReliabilityMl.CustomPipe;
    ...
    withTypeIdent(typeIdent: string | null): ReliabilityMl.CustomPipe;

    /**
     * If true, then the pipe shall not be retrained
     */
    readonly frozen?: boolean;
    withFrozen(frozen: boolean): ReliabilityMl.CustomPipe;

    /**
     * True if training has succeeded and false otherwise.
     */
    readonly trained?: boolean;
    withTrained(trained: boolean): ReliabilityMl.CustomPipe;

    /**
     * Errors from training.
     */
    readonly trainingErrors?: string;
    withTrainingErrors(trainingErrors: string | null): ReliabilityMl.CustomPipe;

    /**
     * If true, the underlying model only accepts flattened input.
     */
    readonly flattenInput?: boolean;
    withFlattenInput(flattenInput: boolean): ReliabilityMl.CustomPipe;

    /**
     * The hyperparameters overridden of a native model or pipe.
     */
    readonly hyperparamOverrides?: Map_Type<string, any>;
    withHyperparamOverrides(hyperparamOverrides: Map_Type<string, any> | {[key: string]: any} | null): ReliabilityMl.CustomPipe;
    ...
    withHyperparamSearchSpace(hyperparamSearchSpace: IHp.SearchSpace | null): ReliabilityMl.CustomPipe;
    ...
    withHpoSpec(hpoSpec: IHpo.Spec | null): ReliabilityMl.CustomPipe;

    /**
     * {@link Hpo.Experiment} stores the result of hyperparameter optimization to find the best model/pipeline.
     */
    readonly hpoExperiment?: Hpo.Experiment;
    withHpoExperiment(hpoExperiment: IHpo.Experiment | null): ReliabilityMl.CustomPipe;

    /**
     * Reference to the experiment that produced this {@link MlPipe}. For example, this could be a {@link Hpo.ExperimentBase}.
     */
    readonly experiment?: any;
    withExperiment(experiment: any | null): ReliabilityMl.CustomPipe;
    ...
    withModelFiles(modelFiles: Map_Type<string, Url> | {[key: string]: IUrl} | null): ReliabilityMl.CustomPipe;
    ...
    withCustomModelCode(customModelCode: Map_Type<string, any> | {[key: string]: any} | null): ReliabilityMl.CustomPipe;

    /**
     * Name for the function on the native model to call to do {@link MlProcessable#process}.
     */
    readonly processFunc?: string;
    withProcessFunc(processFunc: string | null): ReliabilityMl.CustomPipe;
    ...
    withActionRequirement(actionRequirement: string | null): ReliabilityMl.CustomPipe;

    /**
     * Set if user provides a `do_train` function.
     */
    readonly isTrainableOverride?: boolean;
    withIsTrainableOverride(isTrainableOverride: boolean): ReliabilityMl.CustomPipe;

    /**
     * The url for accessing the saved native class source code
     */
    readonly nativeClassUrl?: Url;
    withNativeClassUrl(nativeClassUrl: IUrl | null): ReliabilityMl.CustomPipe;

    /**
     * Serialized instance of custom, native Python class.
     * Allows for these classes to be stateful.
     */
    readonly nativeInstance?: string;
    withNativeInstance(nativeInstance: string | null): ReliabilityMl.CustomPipe;

    /**
     * The name of the python class that contains the implementation of the ML algorithm.
     */
    readonly className: string;
    withClassName(className: string): ReliabilityMl.CustomPipe;

    /**
     * The `childClassName` property holds the name of the child class associated with the current entity.
     */
    readonly childClassName?: string;
    withChildClassName(childClassName: string | null): ReliabilityMl.CustomPipe;
     ...
     * must be defined as instances of {@link ReliabilityMl.CustomPipeFactory}, first.
     */
    readonly inheritsFrom?: Array_Type<string>;
    withInheritsFrom(inheritsFrom: Array_Type<string> | Array<string> | null): ReliabilityMl.CustomPipe;

    /**
     * The keyword arguments required for instantiating an object of class, {@link className}.
     */
    readonly classKwargs?: Array_Type<ReliabilityMl.CustomPipeKwarg>;
    withClassKwargs(classKwargs: Array_Type<ReliabilityMl.CustomPipeKwarg> | Array<IReliabilityMl.CustomPipeKwarg> | null): ReliabilityMl.CustomPipe;

    /**
     * The {@link MlConvertSpec} used to instantiate an object of type {@link ReliabilityMl.CustomPipe}.
     * Specifies the conversion details for the data that will be processed by the custom ML pipeline.
     */
    readonly convertSpec?: MlConvertSpec;
    withConvertSpec(convertSpec: IMlConvertSpec | null): ReliabilityMl.CustomPipe;
     ...
     * If false, the model operates as a "black-box" and its decisions may not be easily interpretable.
     */
    readonly is_interpretable?: boolean;
    withIs_interpretable(is_interpretable: boolean): ReliabilityMl.CustomPipe;
     ...
     * during training to optimize the model's performance.
     */
    readonly trainedHyperparamValues?: Map_Type<string, any>;
    withTrainedHyperparamValues(trainedHyperparamValues: Map_Type<string, any> | {[key: string]: any} | null): ReliabilityMl.CustomPipe;
     ...
     * @see #toJson
     */
    static fromJson(json: any): ReliabilityMl.CustomPipe<DX, DY, DO> | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): ReliabilityMl.CustomPipe<DX, DY, DO> | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): ReliabilityMl.CustomPipe<DX, DY, DO> | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): ReliabilityMl.CustomPipe<DX, DY, DO> | null;
     ...
     */
    replaceType(old: Type, new_: Type): ReliabilityMl.CustomPipe<DX, DY, DO>;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityMl.CustomPipe<DX, DY, DO>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityMl.CustomPipe<DX, DY, DO>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityMl.CustomPipe<DX, DY, DO>>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityMl.CustomPipe<DX, DY, DO>>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityMl.CustomPipe<DX, DY, DO>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityMl.CustomPipe<DX, DY, DO>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityMl.CustomPipe<DX, DY, DO>;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): ReliabilityMl.CustomPipe<DX, DY, DO>;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): ReliabilityMl.CustomPipe<DX, DY, DO>;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityMl.CustomPipe<DX, DY, DO>;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityMl.CustomPipe<DX, DY, DO>;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityMl.CustomPipe<DX, DY, DO>;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): ReliabilityMl.CustomPipe<DX, DY, DO>;
     ...
     * @see #removeField
     */
    withoutField(field: string): ReliabilityMl.CustomPipe<DX, DY, DO>;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): ReliabilityMl.CustomPipe<DX, DY, DO>;
     ...
     */
    withoutFields(fields: Array_Type<string>): ReliabilityMl.CustomPipe<DX, DY, DO>;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityMl.CustomPipe<DX, DY, DO>;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): ReliabilityMl.CustomPipe<DX, DY, DO>;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityMl.CustomPipe<DX, DY, DO>;
     ...
     * @see #unsetField
     */
    defaultField(field: string): ReliabilityMl.CustomPipe<DX, DY, DO>;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): ReliabilityMl.CustomPipe<DX, DY, DO>;
     ...
     * @see #removeField
     */
    unsetField(field: string): ReliabilityMl.CustomPipe<DX, DY, DO>;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): ReliabilityMl.CustomPipe<DX, DY, DO>;
     ...
     * @see #unsetField
     */
    removeField(field: string): ReliabilityMl.CustomPipe<DX, DY, DO>;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): ReliabilityMl.CustomPipe<DX, DY, DO>;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityMl.CustomPipe<DX, DY, DO>;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityMl.CustomPipe<DX, DY, DO>;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityMl.CustomPipe<DX, DY, DO>;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityMl.CustomPipe<DX, DY, DO>;

    mergeJson(json: any): ReliabilityMl.CustomPipe<DX, DY, DO>;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityMl.CustomPipe<DX, DY, DO>;
     ...
     */
    sumObj(other: Obj, deep?: boolean): ReliabilityMl.CustomPipe<DX, DY, DO>;
     ...
     */
    singletonArray(): Array_Type<ReliabilityMl.CustomPipe<DX, DY, DO>>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityMl.CustomPipe<DX, DY, DO>> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<ReliabilityMl.CustomPipe<DX, DY, DO>> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<ReliabilityMl.CustomPipe<DX, DY, DO>>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<ReliabilityMl.CustomPipe<DX, DY, DO>> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, ReliabilityMl.CustomPipe<DX, DY, DO>> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityMl.CustomPipe<DX, DY, DO>> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<ReliabilityMl.CustomPipe<DX, DY, DO>>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<ReliabilityMl.CustomPipe<DX, DY, DO>>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityMl.CustomPipe<DX, DY, DO>;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityMl.CustomPipe<DX, DY, DO>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityMl.CustomPipe<DX, DY, DO>;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): ReliabilityMl.CustomPipe<DX, DY, DO>;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityMl.CustomPipe<DX, DY, DO>;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): ReliabilityMl.CustomPipe<DX, DY, DO>;
     ...
     * @see #fromString
     */
    static make(s: string): ReliabilityMl.CustomPipe<DX, DY, DO> | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityMl.CustomPipe<DX, DY, DO>;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): ReliabilityMl.CustomPipe<DX, DY, DO>;
     ...
     */
    static cachedEmptyInst(): ReliabilityMl.CustomPipe<DX, DY, DO>;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityMl.CustomPipe<DX, DY, DO>> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): ReliabilityMl.CustomPipe<DX, DY, DO>;
     ...
     */
    resolveForDatasetPreparationRun(datasetPreparationRun?: ReliabilityMlDatasetPreparationRun | ReliabilityMlPopulationDatasetPreparationRun): ReliabilityMl.CustomPipe<DX, DY, DO>;
     ...
     */
    withoutIdentity(): ReliabilityMl.CustomPipe<DX, DY, DO>;
     ...
     */
    trainSync(x: DX, y?: DY, spec?: MlOperationSpec): ReliabilityMl.CustomPipe<DX, DY, DO>;
     ...
     */
    interpretSync(x: DX, context?: Map_Type<string, any>, spec?: MlOperationSpec): void;
     ...
     */
    static allCached(doNotProduceAll?: boolean): Stream<ReliabilityMl.CustomPipe<DX, DY, DO>> | null;
     ...
     */
    static find(filter?: string, doNotProduceAll?: boolean): Stream<ReliabilityMl.CustomPipe<DX, DY, DO>> | null;
     ...
     * @return existing instances of this type that satisfy filter from data cache.
     */
    static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<ReliabilityMl.CustomPipe<DX, DY, DO>> | null;
     ...
     * @see getCached
     */
    static findByCacheKey(key: string): ReliabilityMl.CustomPipe<DX, DY, DO> | null;
     ...
     * @see findByCacheKey
     */
    static forCacheKey(key: string): ReliabilityMl.CustomPipe<DX, DY, DO> | null;
     ...
     * @see findByCacheKey
     */
    getCached(): ReliabilityMl.CustomPipe<DX, DY, DO> | null;

    /**
     * @return newly produced cached instance.
     */
    refreshCache(): ReliabilityMl.CustomPipe<DX, DY, DO> | null;
     ...
     */
    static produce(key: string): ReliabilityMl.CustomPipe<DX, DY, DO> | null;
     ...
     */
    static produceAll(): Map_Type<string, ReliabilityMl.CustomPipe<DX, DY, DO>> | null;

    /**
     * Override for sub-types to produce all values.
     */
    static doProduceAll(): Map_Type<string, ReliabilityMl.CustomPipe<DX, DY, DO>> | null;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<ReliabilityMl.CustomPipe<DX, DY, DO>>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<ReliabilityMl.CustomPipe<DX, DY, DO>>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityMl.CustomPipe<DX, DY, DO>> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityMl.CustomPipe<DX, DY, DO>>> | null;
     ...
     */
    get(include?: string): ReliabilityMl.CustomPipe<DX, DY, DO> | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): ReliabilityMl.CustomPipe<DX, DY, DO> | null;
     ...
     */
    getMissing(spec: GetMissingSpec): ReliabilityMl.CustomPipe<DX, DY, DO>;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): ReliabilityMl.CustomPipe<DX, DY, DO> | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): ReliabilityMl.CustomPipe<DX, DY, DO>;
     ...
     * @see #toString
     */
    static fromString(s: string): ReliabilityMl.CustomPipe<DX, DY, DO> | null;
     ...
     */
    create(spec?: UpsertSpec): ReliabilityMl.CustomPipe<DX, DY, DO> | null;
     ...
     */
    static createBatch(objs: Array_Type<ReliabilityMl.CustomPipe<DX, DY, DO>>, spec?: UpsertSpec): ObjList<ReliabilityMl.CustomPipe<DX, DY, DO>> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<ReliabilityMl.CustomPipe<DX, DY, DO>>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityMl.CustomPipe<DX, DY, DO>> | null;
     ...
     */
    update(srcObj?: ReliabilityMl.CustomPipe<DX, DY, DO>, spec?: UpsertSpec): ReliabilityMl.CustomPipe<DX, DY, DO> | null;
     ...
     */
    upsert(srcObj?: ReliabilityMl.CustomPipe<DX, DY, DO>, spec?: UpsertSpec): ReliabilityMl.CustomPipe<DX, DY, DO> | null;
     ...
     */
    merge(spec?: MergeSpec): ReliabilityMl.CustomPipe<DX, DY, DO> | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): ReliabilityMl.CustomPipe<DX, DY, DO> | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): ReliabilityMl.CustomPipe<DX, DY, DO> | null;
     ...
     */
    static updateBatch(objs: Array_Type<ReliabilityMl.CustomPipe<DX, DY, DO>>, srcObjs?: Array_Type<ReliabilityMl.CustomPipe<DX, DY, DO>>, spec?: UpsertSpec): ObjList<ReliabilityMl.CustomPipe<DX, DY, DO>> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<ReliabilityMl.CustomPipe<DX, DY, DO>> | null>, spec?: UpsertSpec): ObjList<ReliabilityMl.CustomPipe<DX, DY, DO>> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<ReliabilityMl.CustomPipe<DX, DY, DO>>, srcObjs?: Array_Type<ReliabilityMl.CustomPipe<DX, DY, DO>>, spec?: UpsertSpec): ObjList<ReliabilityMl.CustomPipe<DX, DY, DO>> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<ReliabilityMl.CustomPipe<DX, DY, DO>> | null>, spec?: UpsertSpec): ObjList<ReliabilityMl.CustomPipe<DX, DY, DO>> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<ReliabilityMl.CustomPipe<DX, DY, DO>>, spec?: TouchSpec): ObjList<ReliabilityMl.CustomPipe<DX, DY, DO>> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityMl.CustomPipe<DX, DY, DO>>, spec?: MergeSpec): ObjList<ReliabilityMl.CustomPipe<DX, DY, DO>> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityMl.CustomPipe<DX, DY, DO>>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityMl.CustomPipe<DX, DY, DO>> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<ReliabilityMl.CustomPipe<DX, DY, DO>> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityMl.CustomPipe<DX, DY, DO>> | null;
     ...
     */
    static mergeAll(mergeObj: ReliabilityMl.CustomPipe<DX, DY, DO>, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: ReliabilityMl.CustomPipe<DX, DY, DO>, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<ReliabilityMl.CustomPipe<DX, DY, DO>>, spec?: UpsertSpec): ObjList<ReliabilityMl.CustomPipe<DX, DY, DO>> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<ReliabilityMl.CustomPipe<DX, DY, DO>>, spec?: UpsertSpec): ObjList<ReliabilityMl.CustomPipe<DX, DY, DO>> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): ReliabilityMl.CustomPipe<DX, DY, DO> | null;
     ...
     */
    static beforeCreate(objs: Array_Type<ReliabilityMl.CustomPipe<DX, DY, DO>>): ObjList<ReliabilityMl.CustomPipe<DX, DY, DO>>;
     ...
     */
    static beforeUpdate(objs: Array_Type<ReliabilityMl.CustomPipe<DX, DY, DO>>): ObjList<ReliabilityMl.CustomPipe<DX, DY, DO>>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<ReliabilityMl.CustomPipe<DX, DY, DO>>): ObjList<ReliabilityMl.CustomPipe<DX, DY, DO>>;
     ...
     */
    static afterCreate(objs: Array_Type<ReliabilityMl.CustomPipe<DX, DY, DO>>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<ReliabilityMl.CustomPipe<DX, DY, DO>>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<ReliabilityMl.CustomPipe<DX, DY, DO>>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityMl.CustomPipe<DX, DY, DO>>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityMl.CustomPipe<DX, DY, DO>>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): ReliabilityMl.CustomPipe<DX, DY, DO> | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<ReliabilityMl.CustomPipe<DX, DY, DO>>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: ReliabilityMl.CustomPipe<DX, DY, DO>, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<ReliabilityMl.CustomPipe<DX, DY, DO>>, callback?: λFunction<ReliabilityMl.CustomPipe<DX, DY, DO> | null, ReliabilityMl.CustomPipe<DX, DY, DO> | null>): ObjList<ReliabilityMl.CustomPipe<DX, DY, DO>>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<ReliabilityMl.CustomPipe<DX, DY, DO>>, callback?: λFunction<ReliabilityMl.CustomPipe<DX, DY, DO> | null, ReliabilityMl.CustomPipe<DX, DY, DO> | null>): Array_Type<ObjError> | null;
     ...
     */
    publish(subPath?: string, contentType?: string): ReliabilityMl.CustomPipe<DX, DY, DO>;
     ...
     */
    static removeSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<ReliabilityMl.CustomPipe<DX, DY, DO>> | null;
     ...
     */
    createSeedData(spec?: UpsertSpec): ReliabilityMl.CustomPipe<DX, DY, DO> | null;
     ...
     */
    static createSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<ReliabilityMl.CustomPipe<DX, DY, DO>> | null;
     ...
     */
    updateSeedData(srcObj?: SeedData, spec?: UpsertSpec): ReliabilityMl.CustomPipe<DX, DY, DO> | null;
     ...
     */
    static updateSeedDataBatch(objs?: Array_Type<SeedData>, srcObjs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<ReliabilityMl.CustomPipe<DX, DY, DO>> | null;
     ...
     * @return updated obj instance, same as {@link Persistable#update} return value.
     */
    clearUserUpdates(spec?: MergeSpec): ReliabilityMl.CustomPipe<DX, DY, DO> | null;
     ...
     *         {@link Persistable#updateBatch}.
     */
    static clearUserUpdatesBatch(objs?: Array_Type<SeedData>, spec?: MergeSpec): ObjList<ReliabilityMl.CustomPipe<DX, DY, DO>> | null;
    ...
    dependencies(): SeedDataDeps<ReliabilityMl.CustomPipe<DX, DY, DO>> | null;
     ...
     * be returned as-is.
     */
    byReference(): ReliabilityMl.CustomPipe<DX, DY, DO>;
     ...
     */
    updateModelFiles(modelFiles: Map_Type<string, Url>, spec?: MlOperationSpec): ReliabilityMl.CustomPipe<DX, DY, DO>;
     ...
     */
    afterTrain(doTrainOutputs: any, spec?: MlOperationSpec): ReliabilityMl.CustomPipe<DX, DY, DO>;
     ...
     */
    convertPipeInputsToNative(x: DX, y?: DY, spec?: MlOperationSpec): any;
     ...
     */
    convertXToNative(x: DX, spec?: MlOperationSpec): any;
     ...
     * present) are always indices on all {@link Data} inputs.
     */
    convertYToNative(y: DY, spec?: MlOperationSpec): any;
     ...
     */
    convertNativeToPipeOutputs(output: any, datasetId?: string): DO;
     ...
     */
    withNewSpec(spec?: MlConvertSpec): ReliabilityMl.CustomPipe<DX, DY, DO>;
     ...
     */
    afterConvert(model: any, spec?: MlConvertSpec): ReliabilityMl.CustomPipe<DX, DY, DO>;
     ...
     *           A native Python class.
     */
    static downloadPyNativeClass(nativeClassUrl?: Url, doNotCleanUp?: boolean): any | null;
     ...
     */
    static getInputDatasetId(x?: DX): string;
     ...
     */
    withHyperparamSpaces(paramSpaces: Map_Type<string, Hp.ParamSpace>): ReliabilityMl.CustomPipe<DX, DY, DO>;
     ...
     */
    static overridesConvertPipeInputsToNative(): boolean;
     ...
     */
    static typeStrFromSpec(spec?: MlConvertSpec): string;
     ...
     */
    callNativeMethod(method_name: string, args?: Array_Type<any>, kwargs?: Map_Type<string, any>): Map_Type<string, any> | null;
     ...
     */
    initialize(model?: any, args?: Array_Type<any>, kwargs?: Map_Type<string, any>, spec?: MlConvertSpec): MlDynamicPipe<any, any, any>;
     ...
     */
    static portNamesFromTypeStr(typeStr: string): Array_Type<string> | null;
     ...
     */
    static typeStrFromPortNames(portNames: Array_Type<string>): string;
     ...
     */
    static fromFactory(factory: string): ReliabilityMl.CustomPipe;
     ...
     */
    static fromClassImpl(file: File, className: string, actionRequirement: string, classKwargs?: Array_Type<ReliabilityMl.CustomPipeKwarg>, inheritsFrom?: Array_Type<string>, spec?: MlConvertSpec, childClassName?: string): ReliabilityMl.CustomPipe;
     ...
     */
    static remakeForIoTypes(pipe: ReliabilityMl.CustomPipe, xNames?: Array_Type<string>, yNames?: Array_Type<string>, outNames?: Array_Type<string>, force?: boolean): ReliabilityMl.CustomPipe;
     ...
     */
    replicate(newHps?: Map_Type<string, any>): ReliabilityMl.CustomPipe<any, any, any>;
     ...
     */
    static listImplementations(): Array_Type<string> | null;
     ...
     */
    refitForAsset(assetId: string): ReliabilityMl.CustomPipe<any, any, any>;
  }
}
