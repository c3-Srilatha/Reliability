// TypeScript definitions for the C3 type ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter

/**
 * This type represents an {@link MlInterpreter} that interprets the outputs of machine learning models using
 * the Sigmoid Weighted Residual (SWRI) method. This method applies a sigmoid transformation to the weighted residuals
 * for better interpretation of risk scores or predictions. It helps in generating human-readable explanations
 * for the model’s output, especially in the context of reliability and risk assessment models.
 *
 * The SWRI is useful in cases where risk scores need to be smoothed or transformed in a way that their relationship
 * with features can be better understood. It can provide insights into how much each feature contributes to the
 * final risk prediction after applying a weighted residual approach.
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter
 */
declare namespace ReliabilityRiskMl.Pipeline.Interpreter {
  export interface ISigmoidWeightedResidualInterpreter<DX, DO> {
    ...
    /**
     * The explainer used for interpreting the results of the model. This reference points to the method or
     * technique employed to provide human-readable explanations of the model’s outputs.
     * In this case, the explainer is related to the Sigmoid Weighted Residual method.
     */
 ...
 * final risk prediction after applying a weighted residual approach.
 *
 * @remarks this represents a made instance of ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter
 */
declare namespace ReliabilityRiskMl.Pipeline.Interpreter {
  export class SigmoidWeightedResidualInterpreter<DX, DO> extends Obj  {

    /**
     * A name for this interpreter
     */
    readonly name?: string;
    withName(name: string | null): ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter;
    ...
    withExplainer(explainer: string | ILambda<function(): any | null>): ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter;
    ...
    withInitKwargs(initKwargs: Map_Type<string, any> | {[key: string]: any} | null): ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter;
    ...
    withCallKwargs(callKwargs: Map_Type<string, any> | {[key: string]: any} | null): ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter;
    ...
    withActionRequirement(actionRequirement: string | null): ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter;
    ...
    withTypeIdent(typeIdent: string | null): ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter;
     ...
     */
    readonly id: string;
    withId(id: string): ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter;
    ...
    withVersion(version: number | null): ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter;
     ...
     * @see #toJson
     */
    static fromJson(json: any): ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO> | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO> | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO> | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO> | null;
     ...
     */
    replaceType(old: Type, new_: Type): ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO>;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO>>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO>>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO>;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO>;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO>;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO>;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO>;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO>;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO>;
     ...
     * @see #removeField
     */
    withoutField(field: string): ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO>;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO>;
     ...
     */
    withoutFields(fields: Array_Type<string>): ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO>;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO>;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO>;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO>;
     ...
     * @see #unsetField
     */
    defaultField(field: string): ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO>;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO>;
     ...
     * @see #removeField
     */
    unsetField(field: string): ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO>;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO>;
     ...
     * @see #unsetField
     */
    removeField(field: string): ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO>;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO>;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO>;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO>;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO>;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO>;

    mergeJson(json: any): ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO>;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO>;
     ...
     */
    sumObj(other: Obj, deep?: boolean): ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO>;
     ...
     */
    singletonArray(): Array_Type<ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO>>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO>> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO>> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO>>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO>> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO>> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO>> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO>>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO>>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO>;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO>;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO>;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO>;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO>;
     ...
     * @see #fromString
     */
    static make(s: string): ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO> | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO>;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO>;
     ...
     */
    static cachedEmptyInst(): ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO>;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO>> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO>;
    ...
    /**
     * This function generates an explainer that prepares the necessary explanation mechanisms for interpreting the
     * machine learning model's output. The explainer could use Python-based libraries or custom logic to generate
     * meaningful visualizations or descriptions of the model's decision-making process.
     * It aids in making complex model outputs more understandable to stakeholders.
     */
    ...
    /**
     * This function performs the actual interpretation of the model's results, providing insights into the behavior
     * of the model. It analyzes how features interact with each other and contributes to the final risk prediction
     * using the Sigmoid Weighted Residuals. The output could include explanations such as which features are most
     * influential or how adjustments in certain variables lead to different predictions or risk scores.
     */
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO>>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO>>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO>> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO>>> | null;
     ...
     */
    get(include?: string): ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO> | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO> | null;
     ...
     */
    getMissing(spec: GetMissingSpec): ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO>;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO> | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO>;
     ...
     * @see #toString
     */
    static fromString(s: string): ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO> | null;
     ...
     */
    create(spec?: UpsertSpec): ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO> | null;
     ...
     */
    static createBatch(objs: Array_Type<ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO>>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO>> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO>>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO>> | null;
     ...
     */
    update(srcObj?: ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO>, spec?: UpsertSpec): ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO> | null;
     ...
     */
    upsert(srcObj?: ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO>, spec?: UpsertSpec): ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO> | null;
     ...
     */
    merge(spec?: MergeSpec): ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO> | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO> | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO> | null;
     ...
     */
    static updateBatch(objs: Array_Type<ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO>>, srcObjs?: Array_Type<ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO>>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO>> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO>> | null>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO>> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO>>, srcObjs?: Array_Type<ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO>>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO>> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO>> | null>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO>> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO>>, spec?: TouchSpec): ObjList<ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO>> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO>>, spec?: MergeSpec): ObjList<ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO>> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO>>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO>> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO>> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO>> | null;
     ...
     */
    static mergeAll(mergeObj: ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO>, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO>, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO>>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO>> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO>>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO>> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO> | null;
     ...
     */
    static beforeCreate(objs: Array_Type<ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO>>): ObjList<ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO>>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO>>): ObjList<ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO>>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO>>): ObjList<ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO>>;
     ...
     */
    static afterCreate(objs: Array_Type<ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO>>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO>>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO>>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO>>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO>>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO> | null;
     ...
     */
    withoutIdentity(): ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO> | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO>>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO>, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO>>, callback?: λFunction<ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO> | null, ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO> | null>): ObjList<ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO>>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO>>, callback?: λFunction<ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO> | null, ReliabilityRiskMl.Pipeline.Interpreter.SigmoidWeightedResidualInterpreter<DX, DO> | null>): Array_Type<ObjError> | null;
