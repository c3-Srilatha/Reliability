// TypeScript definitions for the C3 type ReliabilityMl.Pipeline
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityMl.Pipeline
 */
declare namespace ReliabilityMl {
  export interface IPipeline<DX, DY, DO, DI> {
     ...
     */
    algorithmPipe?: IReliabilityMl.CustomPipe<any, any, any>;
     ...
     */
    alertPipe: IReliabilityMl.CustomPipe<any, any, any>;
 ...
 * The outputs include at least one artifact, typically an alert, and optionally, outputs from custom pipes such as risk scores.
 *
 * @remarks this represents a made instance of ReliabilityMl.Pipeline
 */
declare namespace ReliabilityMl {
  export class Pipeline<DX, DY, DO, DI> extends Obj  {
    ...
    withLookbackDuration(lookbackDuration: number): ReliabilityMl.Pipeline;

    /**
     * List of all vertices in this graph.
     */
    readonly vertices?: Array_Type<MlPipeline.Vertex>;
    withVertices(vertices: Array_Type<MlPipeline.Vertex> | Array<IMlPipeline.Vertex> | null): ReliabilityMl.Pipeline;

    /**
     * List of all edges in this graph.
     */
    readonly edges?: Array_Type<FlowGraph.Edge<MlPipeline.Vertex>>;
    withEdges(edges: Array_Type<FlowGraph.Edge<MlPipeline.Vertex>> | Array<IFlowGraph.Edge<MlPipeline.Vertex>> | null): ReliabilityMl.Pipeline;
    ...
    withVertexConnections(vertexConnections: Map_Type<string, Map_Type<string, any>> | {[key: string]: Map_Type<string, any> | {[key: string]: any}} | null): ReliabilityMl.Pipeline;
     ...
     */
    readonly id: string;
    withId(id: string): ReliabilityMl.Pipeline;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityMl.Pipeline;

    /**
     * Name of this pipe.
     */
    readonly name?: string;
    withName(name: string | null): ReliabilityMl.Pipeline;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): ReliabilityMl.Pipeline;
    ...
    withVersion(version: number | null): ReliabilityMl.Pipeline;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): ReliabilityMl.Pipeline;
    ...
    withUserUpdatedFields(userUpdatedFields: Array_Type<string> | Array<string> | null): ReliabilityMl.Pipeline;
    ...
    withHidden(hidden: boolean): ReliabilityMl.Pipeline;
    ...
    withUserOwned(userOwned: boolean): ReliabilityMl.Pipeline;
    ...
    withTypeIdent(typeIdent: string | null): ReliabilityMl.Pipeline;

    /**
     * If true, then the pipe shall not be retrained
     */
    readonly frozen?: boolean;
    withFrozen(frozen: boolean): ReliabilityMl.Pipeline;

    /**
     * True if training has succeeded and false otherwise.
     */
    readonly trained?: boolean;
    withTrained(trained: boolean): ReliabilityMl.Pipeline;

    /**
     * Errors from training.
     */
    readonly trainingErrors?: string;
    withTrainingErrors(trainingErrors: string | null): ReliabilityMl.Pipeline;

    /**
     * If true, the underlying model only accepts flattened input.
     */
    readonly flattenInput?: boolean;
    withFlattenInput(flattenInput: boolean): ReliabilityMl.Pipeline;

    /**
     * The hyperparameters overridden of a native model or pipe.
     */
    readonly hyperparamOverrides?: Map_Type<string, any>;
    withHyperparamOverrides(hyperparamOverrides: Map_Type<string, any> | {[key: string]: any} | null): ReliabilityMl.Pipeline;
    ...
    withHyperparamSearchSpace(hyperparamSearchSpace: IHp.SearchSpace | null): ReliabilityMl.Pipeline;
    ...
    withHpoSpec(hpoSpec: IHpo.Spec | null): ReliabilityMl.Pipeline;

    /**
     * {@link Hpo.Experiment} stores the result of hyperparameter optimization to find the best model/pipeline.
     */
    readonly hpoExperiment?: Hpo.Experiment;
    withHpoExperiment(hpoExperiment: IHpo.Experiment | null): ReliabilityMl.Pipeline;

    /**
     * Reference to the experiment that produced this {@link MlPipe}. For example, this could be a {@link Hpo.ExperimentBase}.
     */
    readonly experiment?: any;
    withExperiment(experiment: any | null): ReliabilityMl.Pipeline;

    /**
     * Names of the {@link #score} outputs for this machine learning pipeline.
     */
    readonly scoreNames?: Set_Type<string>;
    withScoreNames(scoreNames: Set_Type<string> | Array<string> | null): ReliabilityMl.Pipeline;
    ...
    withTrainRun(trainRun: IWorkflowExecutorRun | null): ReliabilityMl.Pipeline;
    ...
    withTrainStatus(trainStatus: IWorkflow.Status | null): ReliabilityMl.Pipeline;
    ...
    withDoNotAutoUpsert(doNotAutoUpsert: boolean): ReliabilityMl.Pipeline;
     ...
     * Example: The `algorithmPipe` may output a risk score that indicates the likelihood of an asset failure or an anomaly.
     */
    readonly algorithmPipe?: ReliabilityMl.CustomPipe<any, any, any>;
    withAlgorithmPipe(algorithmPipe: IReliabilityMl.CustomPipe<any, any, any> | null): ReliabilityMl.Pipeline;
     ...
     * Example: The `alertPipe` could output a binary value indicating whether an alert should be raised for a specific asset at a particular time.
     */
    readonly alertPipe: ReliabilityMl.CustomPipe<any, any, any>;
    withAlertPipe(alertPipe: IReliabilityMl.CustomPipe<any, any, any>): ReliabilityMl.Pipeline;
    ...
    withPipeToInterpret(pipeToInterpret: string | null): ReliabilityMl.Pipeline;
    ...
    withHasTarget(hasTarget: boolean): ReliabilityMl.Pipeline;
    ...
    withTrainingMasks(trainingMasks: Array_Type<string> | Array<string> | null): ReliabilityMl.Pipeline;
    ...
    withInferenceMasks(inferenceMasks: Array_Type<string> | Array<string> | null): ReliabilityMl.Pipeline;

    /**
     * The ID of the Hyperparameter Optimization (HPO) job that created this pipeline.
     * If no HPO job was used, this value will be empty.
     */
    readonly hpoJobId?: string;
    withHpoJobId(hpoJobId: string | null): ReliabilityMl.Pipeline;
     ...
     * @see #toJson
     */
    static fromJson(json: any): ReliabilityMl.Pipeline<DX, DY, DO, DI> | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): ReliabilityMl.Pipeline<DX, DY, DO, DI> | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): ReliabilityMl.Pipeline<DX, DY, DO, DI> | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): ReliabilityMl.Pipeline<DX, DY, DO, DI> | null;
     ...
     */
    replaceType(old: Type, new_: Type): ReliabilityMl.Pipeline<DX, DY, DO, DI>;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityMl.Pipeline<DX, DY, DO, DI>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityMl.Pipeline<DX, DY, DO, DI>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityMl.Pipeline<DX, DY, DO, DI>>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityMl.Pipeline<DX, DY, DO, DI>>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityMl.Pipeline<DX, DY, DO, DI>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityMl.Pipeline<DX, DY, DO, DI>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityMl.Pipeline<DX, DY, DO, DI>;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): ReliabilityMl.Pipeline<DX, DY, DO, DI>;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): ReliabilityMl.Pipeline<DX, DY, DO, DI>;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityMl.Pipeline<DX, DY, DO, DI>;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityMl.Pipeline<DX, DY, DO, DI>;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityMl.Pipeline<DX, DY, DO, DI>;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): ReliabilityMl.Pipeline<DX, DY, DO, DI>;
     ...
     * @see #removeField
     */
    withoutField(field: string): ReliabilityMl.Pipeline<DX, DY, DO, DI>;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): ReliabilityMl.Pipeline<DX, DY, DO, DI>;
     ...
     */
    withoutFields(fields: Array_Type<string>): ReliabilityMl.Pipeline<DX, DY, DO, DI>;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityMl.Pipeline<DX, DY, DO, DI>;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): ReliabilityMl.Pipeline<DX, DY, DO, DI>;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityMl.Pipeline<DX, DY, DO, DI>;
     ...
     * @see #unsetField
     */
    defaultField(field: string): ReliabilityMl.Pipeline<DX, DY, DO, DI>;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): ReliabilityMl.Pipeline<DX, DY, DO, DI>;
     ...
     * @see #removeField
     */
    unsetField(field: string): ReliabilityMl.Pipeline<DX, DY, DO, DI>;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): ReliabilityMl.Pipeline<DX, DY, DO, DI>;
     ...
     * @see #unsetField
     */
    removeField(field: string): ReliabilityMl.Pipeline<DX, DY, DO, DI>;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): ReliabilityMl.Pipeline<DX, DY, DO, DI>;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityMl.Pipeline<DX, DY, DO, DI>;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityMl.Pipeline<DX, DY, DO, DI>;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityMl.Pipeline<DX, DY, DO, DI>;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityMl.Pipeline<DX, DY, DO, DI>;

    mergeJson(json: any): ReliabilityMl.Pipeline<DX, DY, DO, DI>;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityMl.Pipeline<DX, DY, DO, DI>;
     ...
     */
    sumObj(other: Obj, deep?: boolean): ReliabilityMl.Pipeline<DX, DY, DO, DI>;
     ...
     */
    singletonArray(): Array_Type<ReliabilityMl.Pipeline<DX, DY, DO, DI>>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityMl.Pipeline<DX, DY, DO, DI>> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<ReliabilityMl.Pipeline<DX, DY, DO, DI>> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<ReliabilityMl.Pipeline<DX, DY, DO, DI>>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<ReliabilityMl.Pipeline<DX, DY, DO, DI>> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, ReliabilityMl.Pipeline<DX, DY, DO, DI>> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityMl.Pipeline<DX, DY, DO, DI>> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<ReliabilityMl.Pipeline<DX, DY, DO, DI>>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<ReliabilityMl.Pipeline<DX, DY, DO, DI>>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityMl.Pipeline<DX, DY, DO, DI>;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityMl.Pipeline<DX, DY, DO, DI>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityMl.Pipeline<DX, DY, DO, DI>;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): ReliabilityMl.Pipeline<DX, DY, DO, DI>;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityMl.Pipeline<DX, DY, DO, DI>;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): ReliabilityMl.Pipeline<DX, DY, DO, DI>;
     ...
     * @see #fromString
     */
    static make(s: string): ReliabilityMl.Pipeline<DX, DY, DO, DI> | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityMl.Pipeline<DX, DY, DO, DI>;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): ReliabilityMl.Pipeline<DX, DY, DO, DI>;
     ...
     */
    static cachedEmptyInst(): ReliabilityMl.Pipeline<DX, DY, DO, DI>;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityMl.Pipeline<DX, DY, DO, DI>> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): ReliabilityMl.Pipeline<DX, DY, DO, DI>;
     ...
     */
    resolveForDatasetPreparationRun(datasetPreparationRun?: ReliabilityMlDatasetPreparationRun | ReliabilityMlPopulationDatasetPreparationRun): ReliabilityMl.Pipeline<DX, DY, DO, DI>;
     ...
     */
    remakeTemplate(): ReliabilityMl.Pipeline<DX, DY, DO, DI>;
     ...
     */
    precomputeVertexConnections(): ReliabilityMl.Pipeline<DX, DY, DO, DI>;
     ...
     */
    mapVertices(mapper: λFunction<MlPipeline.Vertex | null, T | null>): ReliabilityMl.Pipeline<DX, DY, DO, DI>;
     ...
     */
    topologicalSort(reverse?: boolean): ReliabilityMl.Pipeline<DX, DY, DO, DI>;
     ...
     */
    ancestorGraph(sink: FlowGraph.Vertex): ReliabilityMl.Pipeline<DX, DY, DO, DI>;
     ...
     */
    replaceVertex(oldVertex: FlowGraph.Vertex, newVertex: FlowGraph.Vertex, doNotMerge?: boolean, removeDisconnectedEdges?: boolean): ReliabilityMl.Pipeline<DX, DY, DO, DI>;
     ...
     */
    replaceVertices(oldVertices: Array_Type<FlowGraph.Vertex>, newVertex: FlowGraph.Vertex, spec?: FlowGraphReplaceSpec): ReliabilityMl.Pipeline<DX, DY, DO, DI>;
     ...
     * @return
     */
    replaceVertices(oldVertices: Array_Type<FlowGraph.Vertex>, newVertices: Array_Type<FlowGraph.Vertex>, newEdges?: Array_Type<FlowGraph.Edge<FlowGraph.Vertex>>, spec?: FlowGraphReplaceSpec): ReliabilityMl.Pipeline<DX, DY, DO, DI>;
     ...
     * connected.
     */
    removeVertex(toRemove: FlowGraph.Vertex): ReliabilityMl.Pipeline<DX, DY, DO, DI>;

    removeVertex(idToRemove: string): ReliabilityMl.Pipeline<DX, DY, DO, DI>;
     ...
     */
    removeVertices(toRemove?: Array_Type<FlowGraph.Vertex>): ReliabilityMl.Pipeline<DX, DY, DO, DI>;
     ...
     */
    mergeWith(other: ReliabilityMl.Pipeline<DX, DY, DO, DI>): ReliabilityMl.Pipeline<DX, DY, DO, DI>;
     ...
     */
    trainSync(x: DX, y?: DY, spec?: MlOperationSpec): ReliabilityMl.Pipeline<DX, DY, DO, DI>;
     ...
     */
    static allCached(doNotProduceAll?: boolean): Stream<ReliabilityMl.Pipeline<DX, DY, DO, DI>> | null;
     ...
     */
    static find(filter?: string, doNotProduceAll?: boolean): Stream<ReliabilityMl.Pipeline<DX, DY, DO, DI>> | null;
     ...
     * @return existing instances of this type that satisfy filter from data cache.
     */
    static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<ReliabilityMl.Pipeline<DX, DY, DO, DI>> | null;
     ...
     * @see getCached
     */
    static findByCacheKey(key: string): ReliabilityMl.Pipeline<DX, DY, DO, DI> | null;
     ...
     * @see findByCacheKey
     */
    static forCacheKey(key: string): ReliabilityMl.Pipeline<DX, DY, DO, DI> | null;
     ...
     * @see findByCacheKey
     */
    getCached(): ReliabilityMl.Pipeline<DX, DY, DO, DI> | null;

    /**
     * @return newly produced cached instance.
     */
    refreshCache(): ReliabilityMl.Pipeline<DX, DY, DO, DI> | null;
     ...
     */
    static produce(key: string): ReliabilityMl.Pipeline<DX, DY, DO, DI> | null;
     ...
     */
    static produceAll(): Map_Type<string, ReliabilityMl.Pipeline<DX, DY, DO, DI>> | null;

    /**
     * Override for sub-types to produce all values.
     */
    static doProduceAll(): Map_Type<string, ReliabilityMl.Pipeline<DX, DY, DO, DI>> | null;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<ReliabilityMl.Pipeline<DX, DY, DO, DI>>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<ReliabilityMl.Pipeline<DX, DY, DO, DI>>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityMl.Pipeline<DX, DY, DO, DI>> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityMl.Pipeline<DX, DY, DO, DI>>> | null;
     ...
     */
    get(include?: string): ReliabilityMl.Pipeline<DX, DY, DO, DI> | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): ReliabilityMl.Pipeline<DX, DY, DO, DI> | null;
     ...
     */
    getMissing(spec: GetMissingSpec): ReliabilityMl.Pipeline<DX, DY, DO, DI>;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): ReliabilityMl.Pipeline<DX, DY, DO, DI> | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): ReliabilityMl.Pipeline<DX, DY, DO, DI>;
     ...
     * @see #toString
     */
    static fromString(s: string): ReliabilityMl.Pipeline<DX, DY, DO, DI> | null;
     ...
     */
    create(spec?: UpsertSpec): ReliabilityMl.Pipeline<DX, DY, DO, DI> | null;
     ...
     */
    static createBatch(objs: Array_Type<ReliabilityMl.Pipeline<DX, DY, DO, DI>>, spec?: UpsertSpec): ObjList<ReliabilityMl.Pipeline<DX, DY, DO, DI>> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<ReliabilityMl.Pipeline<DX, DY, DO, DI>>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityMl.Pipeline<DX, DY, DO, DI>> | null;
     ...
     */
    update(srcObj?: ReliabilityMl.Pipeline<DX, DY, DO, DI>, spec?: UpsertSpec): ReliabilityMl.Pipeline<DX, DY, DO, DI> | null;
     ...
     */
    upsert(srcObj?: ReliabilityMl.Pipeline<DX, DY, DO, DI>, spec?: UpsertSpec): ReliabilityMl.Pipeline<DX, DY, DO, DI> | null;
     ...
     */
    merge(spec?: MergeSpec): ReliabilityMl.Pipeline<DX, DY, DO, DI> | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): ReliabilityMl.Pipeline<DX, DY, DO, DI> | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): ReliabilityMl.Pipeline<DX, DY, DO, DI> | null;
     ...
     */
    static updateBatch(objs: Array_Type<ReliabilityMl.Pipeline<DX, DY, DO, DI>>, srcObjs?: Array_Type<ReliabilityMl.Pipeline<DX, DY, DO, DI>>, spec?: UpsertSpec): ObjList<ReliabilityMl.Pipeline<DX, DY, DO, DI>> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<ReliabilityMl.Pipeline<DX, DY, DO, DI>> | null>, spec?: UpsertSpec): ObjList<ReliabilityMl.Pipeline<DX, DY, DO, DI>> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<ReliabilityMl.Pipeline<DX, DY, DO, DI>>, srcObjs?: Array_Type<ReliabilityMl.Pipeline<DX, DY, DO, DI>>, spec?: UpsertSpec): ObjList<ReliabilityMl.Pipeline<DX, DY, DO, DI>> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<ReliabilityMl.Pipeline<DX, DY, DO, DI>> | null>, spec?: UpsertSpec): ObjList<ReliabilityMl.Pipeline<DX, DY, DO, DI>> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<ReliabilityMl.Pipeline<DX, DY, DO, DI>>, spec?: TouchSpec): ObjList<ReliabilityMl.Pipeline<DX, DY, DO, DI>> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityMl.Pipeline<DX, DY, DO, DI>>, spec?: MergeSpec): ObjList<ReliabilityMl.Pipeline<DX, DY, DO, DI>> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityMl.Pipeline<DX, DY, DO, DI>>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityMl.Pipeline<DX, DY, DO, DI>> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<ReliabilityMl.Pipeline<DX, DY, DO, DI>> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityMl.Pipeline<DX, DY, DO, DI>> | null;
     ...
     */
    static mergeAll(mergeObj: ReliabilityMl.Pipeline<DX, DY, DO, DI>, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: ReliabilityMl.Pipeline<DX, DY, DO, DI>, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<ReliabilityMl.Pipeline<DX, DY, DO, DI>>, spec?: UpsertSpec): ObjList<ReliabilityMl.Pipeline<DX, DY, DO, DI>> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<ReliabilityMl.Pipeline<DX, DY, DO, DI>>, spec?: UpsertSpec): ObjList<ReliabilityMl.Pipeline<DX, DY, DO, DI>> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): ReliabilityMl.Pipeline<DX, DY, DO, DI> | null;
     ...
     */
    static beforeCreate(objs: Array_Type<ReliabilityMl.Pipeline<DX, DY, DO, DI>>): ObjList<ReliabilityMl.Pipeline<DX, DY, DO, DI>>;
     ...
     */
    static beforeUpdate(objs: Array_Type<ReliabilityMl.Pipeline<DX, DY, DO, DI>>): ObjList<ReliabilityMl.Pipeline<DX, DY, DO, DI>>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<ReliabilityMl.Pipeline<DX, DY, DO, DI>>): ObjList<ReliabilityMl.Pipeline<DX, DY, DO, DI>>;
     ...
     */
    static afterCreate(objs: Array_Type<ReliabilityMl.Pipeline<DX, DY, DO, DI>>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<ReliabilityMl.Pipeline<DX, DY, DO, DI>>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<ReliabilityMl.Pipeline<DX, DY, DO, DI>>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityMl.Pipeline<DX, DY, DO, DI>>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityMl.Pipeline<DX, DY, DO, DI>>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): ReliabilityMl.Pipeline<DX, DY, DO, DI> | null;
     ...
     */
    withoutIdentity(): ReliabilityMl.Pipeline<DX, DY, DO, DI> | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<ReliabilityMl.Pipeline<DX, DY, DO, DI>>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: ReliabilityMl.Pipeline<DX, DY, DO, DI>, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<ReliabilityMl.Pipeline<DX, DY, DO, DI>>, callback?: λFunction<ReliabilityMl.Pipeline<DX, DY, DO, DI> | null, ReliabilityMl.Pipeline<DX, DY, DO, DI> | null>): ObjList<ReliabilityMl.Pipeline<DX, DY, DO, DI>>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<ReliabilityMl.Pipeline<DX, DY, DO, DI>>, callback?: λFunction<ReliabilityMl.Pipeline<DX, DY, DO, DI> | null, ReliabilityMl.Pipeline<DX, DY, DO, DI> | null>): Array_Type<ObjError> | null;
     ...
     */
    publish(subPath?: string, contentType?: string): ReliabilityMl.Pipeline<DX, DY, DO, DI>;
     ...
     */
    static removeSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<ReliabilityMl.Pipeline<DX, DY, DO, DI>> | null;
     ...
     */
    createSeedData(spec?: UpsertSpec): ReliabilityMl.Pipeline<DX, DY, DO, DI> | null;
     ...
     */
    static createSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<ReliabilityMl.Pipeline<DX, DY, DO, DI>> | null;
     ...
     */
    updateSeedData(srcObj?: SeedData, spec?: UpsertSpec): ReliabilityMl.Pipeline<DX, DY, DO, DI> | null;
     ...
     */
    static updateSeedDataBatch(objs?: Array_Type<SeedData>, srcObjs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<ReliabilityMl.Pipeline<DX, DY, DO, DI>> | null;
     ...
     * @return updated obj instance, same as {@link Persistable#update} return value.
     */
    clearUserUpdates(spec?: MergeSpec): ReliabilityMl.Pipeline<DX, DY, DO, DI> | null;
     ...
     *         {@link Persistable#updateBatch}.
     */
    static clearUserUpdatesBatch(objs?: Array_Type<SeedData>, spec?: MergeSpec): ObjList<ReliabilityMl.Pipeline<DX, DY, DO, DI>> | null;
    ...
    dependencies(): SeedDataDeps<ReliabilityMl.Pipeline<DX, DY, DO, DI>> | null;
     ...
     */
    static convert(model: any, spec?: MlConvertSpec): ReliabilityMl.Pipeline<DX, DY, DO, DI>;

    /**
     * Freezes an {@link MlPipe}
     * @return modified copy of this {@link MlPipe} that cannot be trained
     */
    freeze(): ReliabilityMl.Pipeline<DX, DY, DO, DI>;
     ...
     */
    freeze(paths?: Array_Type<string>): ReliabilityMl.Pipeline<DX, DY, DO, DI>;

    /**
     * Unfreezes an {@link MlPipe}
     * @return modified copy of this {@link MlPipe} that can be trained
     */
    unfreeze(): ReliabilityMl.Pipeline<DX, DY, DO, DI>;
     ...
     */
    unfreeze(paths?: Array_Type<string>): ReliabilityMl.Pipeline<DX, DY, DO, DI>;
     ...
     * be returned as-is.
     */
    byReference(): ReliabilityMl.Pipeline<DX, DY, DO, DI>;
     ...
     */
    train_verify(x?: DX, y?: DY, spec?: MlOperationSpec): ReliabilityMl.Pipeline<DX, DY, DO, DI>;
     ...
     */
    withHyperparamSpaces(paramSpaces: Map_Type<string, Map_Type<string, Hp.ParamSpace>>): ReliabilityMl.Pipeline<DX, DY, DO, DI>;
     ...
     */
    replacePipe(pipePath: string, newPipe: MlPipe<any, any, any, any, any>): ReliabilityMl.Pipeline<DX, DY, DO, DI>;
     ...
     */
    replaceInterpreter(interpreterPath: string, newInterpreter: MlInterpreter<any, any>): ReliabilityMl.Pipeline<DX, DY, DO, DI>;
     ...
     */
    flatten(): ReliabilityMl.Pipeline<DX, DY, DO, DI>;
     ...
     */
    static fromV7Json(pipeline: string, runtimeRequirements: Array_Type<string>): ReliabilityMl.Pipeline<DX, DY, DO, DI>;
     ...
     */
    validateTrainingAndInferenceMasks(): void;
     ...
     */
    hyperparamsForModelSetupUi(): Array_Type<any> | null;
     ...
     * ready for inference.
     */
    replicate(newHps?: Map_Type<string, Map_Type<string, any>>): ReliabilityMl.Pipeline<any, any, any, any>;
     ...
     */
    refitForAsset(assetId: string): ReliabilityMl.Pipeline<any, any, any, any>;
  }
}
