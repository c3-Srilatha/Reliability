// TypeScript definitions for the C3 type ReliabilityRiskScoreMlContributionHeader
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityRiskScoreMlContributionHeader
 */
declare interface IReliabilityRiskScoreMlContributionHeader {
   ...
   */
  data?: Array_Type<ReliabilityRiskScoreMlContribution> | Array<IReliabilityRiskScoreMlContribution>;
   ...
   */
  parent: IReliabilityAssetToRiskModelRelation;
 ...
 */
declare class ReliabilityRiskScoreMlContributionHeader extends Obj  {

  /**
   * Populated on normalization. Indicates the earliest data point across various timeseries fields.
   */
  readonly earliest?: DateTime;
  withEarliest(earliest: DateTime | Date | string | null): ReliabilityRiskScoreMlContributionHeader;

  /**
   * Populated on normalization. Indicates the latest data point across various timeseries fields.
   */
  readonly latest?: DateTime;
  withLatest(latest: DateTime | Date | string | null): ReliabilityRiskScoreMlContributionHeader;

  /**
   * Populated on normalization. Indicates the earliest data point for each {@link Ann.Ts} fields.
   */
  readonly earliestTsDp?: Map_Type<string, TSDataPoint>;
  withEarliestTsDp(earliestTsDp: Map_Type<string, TSDataPoint> | {[key: string]: ITSDataPoint} | null): ReliabilityRiskScoreMlContributionHeader;

  /**
   * Populated on normalization. Indicates the latest data point for each {@link Ann.Ts} fields.
   */
  readonly latestTsDp?: Map_Type<string, TSDataPoint>;
  withLatestTsDp(latestTsDp: Map_Type<string, TSDataPoint> | {[key: string]: ITSDataPoint} | null): ReliabilityRiskScoreMlContributionHeader;
  ...
  withInterval(interval: string | null): ReliabilityRiskScoreMlContributionHeader;
  ...
  withTimeZone(timeZone: string | null): ReliabilityRiskScoreMlContributionHeader;

  /**
   * If set, disables normalizing this time series. Invalidations will still continue to happen for this series normally.
   */
  readonly doNotNormalize?: boolean;
  withDoNotNormalize(doNotNormalize: boolean): ReliabilityRiskScoreMlContributionHeader;

  /**
   * Data points corresponding to this timeseries header
   */
  readonly data?: Array_Type<ReliabilityRiskScoreMlContribution>;
  withData(data: Array_Type<ReliabilityRiskScoreMlContribution> | Array<IReliabilityRiskScoreMlContribution> | null): ReliabilityRiskScoreMlContributionHeader;

  /**
   * Use this field to specify the interpolation mechanism to be applied for gaps in interval timeseries. Default: `ZERO_INTERPOLATOR`.
   */
  readonly interpolator?: string;
  withInterpolator(interpolator: string | null): ReliabilityRiskScoreMlContributionHeader;

  /**
   * Use this field to specify how normalization should handle duplicate data points. A duplicate point is one that has the same start, end, value, unit, and {@link TimedDataPointFields#isEstimated} values. Default: `IGNORE`.
   */
  readonly duplicateHandling?: string;
  withDuplicateHandling(duplicateHandling: string | null): ReliabilityRiskScoreMlContributionHeader;

  /**
   * Used to specify how normalization should handle overlapping data points. Default: `AVG`.
   */
  readonly overlapHandling?: string;
  withOverlapHandling(overlapHandling: string | null): ReliabilityRiskScoreMlContributionHeader;
  ...
  withBucketInterval(bucketInterval: string | null): ReliabilityRiskScoreMlContributionHeader;
  ...
  withNormalizationPartitionStrategy(normalizationPartitionStrategy: INormalizationPartitionStrategy | null): ReliabilityRiskScoreMlContributionHeader;

  /**
   * Indicates whether the last data point should be repeated until infinity
   */
  readonly extrapolate?: boolean;
  withExtrapolate(extrapolate: boolean): ReliabilityRiskScoreMlContributionHeader;
  ...
  withTypeIdent(typeIdent: string | null): ReliabilityRiskScoreMlContributionHeader;
   ...
   */
  readonly id: string;
  withId(id: string): ReliabilityRiskScoreMlContributionHeader;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityRiskScoreMlContributionHeader;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): ReliabilityRiskScoreMlContributionHeader;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): ReliabilityRiskScoreMlContributionHeader;
  ...
  withVersion(version: number | null): ReliabilityRiskScoreMlContributionHeader;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): ReliabilityRiskScoreMlContributionHeader;

  /**
   * The subject-model association related to this series header.
   */
  readonly parent: ReliabilityAssetToRiskModelRelation;
  withParent(parent: IReliabilityAssetToRiskModelRelation): ReliabilityRiskScoreMlContributionHeader;

  /**
   * The treatment to use for the timeseries.
   */
  readonly treatment?: string;
  withTreatment(treatment: string | null): ReliabilityRiskScoreMlContributionHeader;
   ...
   * @see #toJson
   */
  static fromJson(json: any): ReliabilityRiskScoreMlContributionHeader | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): ReliabilityRiskScoreMlContributionHeader | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): ReliabilityRiskScoreMlContributionHeader | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): ReliabilityRiskScoreMlContributionHeader | null;
   ...
   */
  replaceType(old: Type, new_: Type): ReliabilityRiskScoreMlContributionHeader;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityRiskScoreMlContributionHeader;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityRiskScoreMlContributionHeader;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityRiskScoreMlContributionHeader>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityRiskScoreMlContributionHeader>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityRiskScoreMlContributionHeader;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityRiskScoreMlContributionHeader;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityRiskScoreMlContributionHeader;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ReliabilityRiskScoreMlContributionHeader;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ReliabilityRiskScoreMlContributionHeader;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityRiskScoreMlContributionHeader;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityRiskScoreMlContributionHeader;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityRiskScoreMlContributionHeader;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ReliabilityRiskScoreMlContributionHeader;
   ...
   * @see #removeField
   */
  withoutField(field: string): ReliabilityRiskScoreMlContributionHeader;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): ReliabilityRiskScoreMlContributionHeader;
   ...
   */
  withoutFields(fields: Array_Type<string>): ReliabilityRiskScoreMlContributionHeader;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityRiskScoreMlContributionHeader;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ReliabilityRiskScoreMlContributionHeader;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityRiskScoreMlContributionHeader;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ReliabilityRiskScoreMlContributionHeader;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ReliabilityRiskScoreMlContributionHeader;
   ...
   * @see #removeField
   */
  unsetField(field: string): ReliabilityRiskScoreMlContributionHeader;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ReliabilityRiskScoreMlContributionHeader;
   ...
   * @see #unsetField
   */
  removeField(field: string): ReliabilityRiskScoreMlContributionHeader;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ReliabilityRiskScoreMlContributionHeader;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityRiskScoreMlContributionHeader;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityRiskScoreMlContributionHeader;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityRiskScoreMlContributionHeader;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityRiskScoreMlContributionHeader;

  mergeJson(json: any): ReliabilityRiskScoreMlContributionHeader;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityRiskScoreMlContributionHeader;
   ...
   */
  sumObj(other: Obj, deep?: boolean): ReliabilityRiskScoreMlContributionHeader;
   ...
   */
  singletonArray(): Array_Type<ReliabilityRiskScoreMlContributionHeader>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityRiskScoreMlContributionHeader> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ReliabilityRiskScoreMlContributionHeader> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<ReliabilityRiskScoreMlContributionHeader>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ReliabilityRiskScoreMlContributionHeader> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, ReliabilityRiskScoreMlContributionHeader> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityRiskScoreMlContributionHeader> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ReliabilityRiskScoreMlContributionHeader>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ReliabilityRiskScoreMlContributionHeader>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityRiskScoreMlContributionHeader;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityRiskScoreMlContributionHeader;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityRiskScoreMlContributionHeader;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ReliabilityRiskScoreMlContributionHeader;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityRiskScoreMlContributionHeader;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ReliabilityRiskScoreMlContributionHeader;
   ...
   * @see #fromString
   */
  static make(s: string): ReliabilityRiskScoreMlContributionHeader | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityRiskScoreMlContributionHeader;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): ReliabilityRiskScoreMlContributionHeader;
   ...
   */
  static cachedEmptyInst(): ReliabilityRiskScoreMlContributionHeader;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityRiskScoreMlContributionHeader> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): ReliabilityRiskScoreMlContributionHeader;
   ...
   */
  static normalizeTimeseries(timeseries?: TimedDataFields<ReliabilityRiskScoreMlContribution>, start?: DateTime, end?: DateTime, overrideGrain?: string, forceGrainDetection?: boolean, force?: boolean): void;
   ...
   */
  static normalize(timeseries?: TimedDataFields<ReliabilityRiskScoreMlContribution>, start?: DateTime, end?: DateTime, overrideGrain?: string, forceGrainDetection?: boolean): NormalizationResult | null;
   ...
   */
  static normalizationUnit(rawHeader: TimedDataFields<ReliabilityRiskScoreMlContribution>, tsField: string): Unit | null;
   ...
   */
  static normalizationTreatment(rawHeader: TimedDataFields<ReliabilityRiskScoreMlContribution>, tsField: string): string;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<ReliabilityRiskScoreMlContributionHeader>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<ReliabilityRiskScoreMlContributionHeader>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityRiskScoreMlContributionHeader> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityRiskScoreMlContributionHeader>> | null;
   ...
   */
  get(include?: string): ReliabilityRiskScoreMlContributionHeader | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): ReliabilityRiskScoreMlContributionHeader | null;
   ...
   */
  getMissing(spec: GetMissingSpec): ReliabilityRiskScoreMlContributionHeader;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): ReliabilityRiskScoreMlContributionHeader | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): ReliabilityRiskScoreMlContributionHeader;
   ...
   * @see #toString
   */
  static fromString(s: string): ReliabilityRiskScoreMlContributionHeader | null;
   ...
   */
  create(spec?: UpsertSpec): ReliabilityRiskScoreMlContributionHeader | null;
   ...
   */
  static createBatch(objs: Array_Type<ReliabilityRiskScoreMlContributionHeader>, spec?: UpsertSpec): ObjList<ReliabilityRiskScoreMlContributionHeader> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<ReliabilityRiskScoreMlContributionHeader>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityRiskScoreMlContributionHeader> | null;
   ...
   */
  update(srcObj?: ReliabilityRiskScoreMlContributionHeader, spec?: UpsertSpec): ReliabilityRiskScoreMlContributionHeader | null;
   ...
   */
  upsert(srcObj?: ReliabilityRiskScoreMlContributionHeader, spec?: UpsertSpec): ReliabilityRiskScoreMlContributionHeader | null;
   ...
   */
  merge(spec?: MergeSpec): ReliabilityRiskScoreMlContributionHeader | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): ReliabilityRiskScoreMlContributionHeader | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): ReliabilityRiskScoreMlContributionHeader | null;
   ...
   */
  static updateBatch(objs: Array_Type<ReliabilityRiskScoreMlContributionHeader>, srcObjs?: Array_Type<ReliabilityRiskScoreMlContributionHeader>, spec?: UpsertSpec): ObjList<ReliabilityRiskScoreMlContributionHeader> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<ReliabilityRiskScoreMlContributionHeader> | null>, spec?: UpsertSpec): ObjList<ReliabilityRiskScoreMlContributionHeader> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<ReliabilityRiskScoreMlContributionHeader>, srcObjs?: Array_Type<ReliabilityRiskScoreMlContributionHeader>, spec?: UpsertSpec): ObjList<ReliabilityRiskScoreMlContributionHeader> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<ReliabilityRiskScoreMlContributionHeader> | null>, spec?: UpsertSpec): ObjList<ReliabilityRiskScoreMlContributionHeader> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<ReliabilityRiskScoreMlContributionHeader>, spec?: TouchSpec): ObjList<ReliabilityRiskScoreMlContributionHeader> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityRiskScoreMlContributionHeader>, spec?: MergeSpec): ObjList<ReliabilityRiskScoreMlContributionHeader> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityRiskScoreMlContributionHeader>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityRiskScoreMlContributionHeader> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<ReliabilityRiskScoreMlContributionHeader> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityRiskScoreMlContributionHeader> | null;
   ...
   */
  static mergeAll(mergeObj: ReliabilityRiskScoreMlContributionHeader, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: ReliabilityRiskScoreMlContributionHeader, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<ReliabilityRiskScoreMlContributionHeader>, spec?: UpsertSpec): ObjList<ReliabilityRiskScoreMlContributionHeader> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<ReliabilityRiskScoreMlContributionHeader>, spec?: UpsertSpec): ObjList<ReliabilityRiskScoreMlContributionHeader> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): ReliabilityRiskScoreMlContributionHeader | null;
   ...
   */
  static beforeCreate(objs: Array_Type<ReliabilityRiskScoreMlContributionHeader>): ObjList<ReliabilityRiskScoreMlContributionHeader>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<ReliabilityRiskScoreMlContributionHeader>): ObjList<ReliabilityRiskScoreMlContributionHeader>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<ReliabilityRiskScoreMlContributionHeader>): ObjList<ReliabilityRiskScoreMlContributionHeader>;
   ...
   */
  static afterCreate(objs: Array_Type<ReliabilityRiskScoreMlContributionHeader>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<ReliabilityRiskScoreMlContributionHeader>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<ReliabilityRiskScoreMlContributionHeader>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityRiskScoreMlContributionHeader>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityRiskScoreMlContributionHeader>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): ReliabilityRiskScoreMlContributionHeader | null;
   ...
   */
  withoutIdentity(): ReliabilityRiskScoreMlContributionHeader | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<ReliabilityRiskScoreMlContributionHeader>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: ReliabilityRiskScoreMlContributionHeader, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<ReliabilityRiskScoreMlContributionHeader>, callback?: λFunction<ReliabilityRiskScoreMlContributionHeader | null, ReliabilityRiskScoreMlContributionHeader | null>): ObjList<ReliabilityRiskScoreMlContributionHeader>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<ReliabilityRiskScoreMlContributionHeader>, callback?: λFunction<ReliabilityRiskScoreMlContributionHeader | null, ReliabilityRiskScoreMlContributionHeader | null>): Array_Type<ObjError> | null;
