// TypeScript definitions for the C3 type ReliabilityMl.CustomPipeFactory

/**
 * While {@link ReliabilityMl.CustomPipe}s are used to execute the python classes that contain ML algorithm implementations,
 * there must exist a system to preserve implemented algorithms such that users may reuse said implementations repeatedly.
 * This Type contains the implementations of all algorithms that are deemed important enough to warrant repeated use.
 * Every instance represents a unique algorithm and contains all information necessary to instantiate a
 * {@link ReliabilityMl.CustomPipe}.
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityMl.CustomPipeFactory
 */
declare namespace ReliabilityMl {
  export interface ICustomPipeFactory {
 ...
 * {@link ReliabilityMl.CustomPipe}.
 *
 * @remarks this represents a made instance of ReliabilityMl.CustomPipeFactory
 */
declare namespace ReliabilityMl {
  export class CustomPipeFactory extends Obj  {
    ...
    withTypeIdent(typeIdent: string | null): ReliabilityMl.CustomPipeFactory;
     ...
     */
    readonly id: string;
    withId(id: string): ReliabilityMl.CustomPipeFactory;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityMl.CustomPipeFactory;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): ReliabilityMl.CustomPipeFactory;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): ReliabilityMl.CustomPipeFactory;
    ...
    withVersion(version: number | null): ReliabilityMl.CustomPipeFactory;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): ReliabilityMl.CustomPipeFactory;
     ...
     */
    readonly file: File;
    withFile(file: IFile): ReliabilityMl.CustomPipeFactory;
    ...
    withClassName(className: string): ReliabilityMl.CustomPipeFactory;
    ...
    withClassKwargs(classKwargs: Array_Type<ReliabilityMl.CustomPipeKwarg> | Array<IReliabilityMl.CustomPipeKwarg> | null): ReliabilityMl.CustomPipeFactory;
    ...
    withActionRequirement(actionRequirement: string): ReliabilityMl.CustomPipeFactory;

    /**
     * Defines additional metadata for the instantiation of the {@link ReliabilityMl.CustomPipe}.
     */
    readonly convertSpec?: MlConvertSpec;
    withConvertSpec(convertSpec: IMlConvertSpec | null): ReliabilityMl.CustomPipeFactory;
    ...
    withInheritsFrom(inheritsFrom: Array_Type<string> | Array<string> | null): ReliabilityMl.CustomPipeFactory;
     ...
     * @see #toJson
     */
    static fromJson(json: any): ReliabilityMl.CustomPipeFactory | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): ReliabilityMl.CustomPipeFactory | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): ReliabilityMl.CustomPipeFactory | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): ReliabilityMl.CustomPipeFactory | null;
     ...
     */
    replaceType(old: Type, new_: Type): ReliabilityMl.CustomPipeFactory;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityMl.CustomPipeFactory;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityMl.CustomPipeFactory;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityMl.CustomPipeFactory>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityMl.CustomPipeFactory>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityMl.CustomPipeFactory;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityMl.CustomPipeFactory;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityMl.CustomPipeFactory;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): ReliabilityMl.CustomPipeFactory;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): ReliabilityMl.CustomPipeFactory;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityMl.CustomPipeFactory;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityMl.CustomPipeFactory;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityMl.CustomPipeFactory;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): ReliabilityMl.CustomPipeFactory;
     ...
     * @see #removeField
     */
    withoutField(field: string): ReliabilityMl.CustomPipeFactory;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): ReliabilityMl.CustomPipeFactory;
     ...
     */
    withoutFields(fields: Array_Type<string>): ReliabilityMl.CustomPipeFactory;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityMl.CustomPipeFactory;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): ReliabilityMl.CustomPipeFactory;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityMl.CustomPipeFactory;
     ...
     * @see #unsetField
     */
    defaultField(field: string): ReliabilityMl.CustomPipeFactory;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): ReliabilityMl.CustomPipeFactory;
     ...
     * @see #removeField
     */
    unsetField(field: string): ReliabilityMl.CustomPipeFactory;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): ReliabilityMl.CustomPipeFactory;
     ...
     * @see #unsetField
     */
    removeField(field: string): ReliabilityMl.CustomPipeFactory;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): ReliabilityMl.CustomPipeFactory;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityMl.CustomPipeFactory;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityMl.CustomPipeFactory;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityMl.CustomPipeFactory;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityMl.CustomPipeFactory;

    mergeJson(json: any): ReliabilityMl.CustomPipeFactory;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityMl.CustomPipeFactory;
     ...
     */
    sumObj(other: Obj, deep?: boolean): ReliabilityMl.CustomPipeFactory;
     ...
     */
    singletonArray(): Array_Type<ReliabilityMl.CustomPipeFactory>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityMl.CustomPipeFactory> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<ReliabilityMl.CustomPipeFactory> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<ReliabilityMl.CustomPipeFactory>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<ReliabilityMl.CustomPipeFactory> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, ReliabilityMl.CustomPipeFactory> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityMl.CustomPipeFactory> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<ReliabilityMl.CustomPipeFactory>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<ReliabilityMl.CustomPipeFactory>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityMl.CustomPipeFactory;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityMl.CustomPipeFactory;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityMl.CustomPipeFactory;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): ReliabilityMl.CustomPipeFactory;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityMl.CustomPipeFactory;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): ReliabilityMl.CustomPipeFactory;
     ...
     * @see #fromString
     */
    static make(s: string): ReliabilityMl.CustomPipeFactory | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityMl.CustomPipeFactory;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): ReliabilityMl.CustomPipeFactory;
     ...
     */
    static cachedEmptyInst(): ReliabilityMl.CustomPipeFactory;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityMl.CustomPipeFactory> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): ReliabilityMl.CustomPipeFactory;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<ReliabilityMl.CustomPipeFactory>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<ReliabilityMl.CustomPipeFactory>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityMl.CustomPipeFactory> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityMl.CustomPipeFactory>> | null;
     ...
     */
    get(include?: string): ReliabilityMl.CustomPipeFactory | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): ReliabilityMl.CustomPipeFactory | null;
     ...
     */
    getMissing(spec: GetMissingSpec): ReliabilityMl.CustomPipeFactory;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): ReliabilityMl.CustomPipeFactory | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): ReliabilityMl.CustomPipeFactory;
     ...
     * @see #toString
     */
    static fromString(s: string): ReliabilityMl.CustomPipeFactory | null;
     ...
     */
    create(spec?: UpsertSpec): ReliabilityMl.CustomPipeFactory | null;
     ...
     */
    static createBatch(objs: Array_Type<ReliabilityMl.CustomPipeFactory>, spec?: UpsertSpec): ObjList<ReliabilityMl.CustomPipeFactory> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<ReliabilityMl.CustomPipeFactory>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityMl.CustomPipeFactory> | null;
     ...
     */
    update(srcObj?: ReliabilityMl.CustomPipeFactory, spec?: UpsertSpec): ReliabilityMl.CustomPipeFactory | null;
     ...
     */
    upsert(srcObj?: ReliabilityMl.CustomPipeFactory, spec?: UpsertSpec): ReliabilityMl.CustomPipeFactory | null;
     ...
     */
    merge(spec?: MergeSpec): ReliabilityMl.CustomPipeFactory | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): ReliabilityMl.CustomPipeFactory | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): ReliabilityMl.CustomPipeFactory | null;
     ...
     */
    static updateBatch(objs: Array_Type<ReliabilityMl.CustomPipeFactory>, srcObjs?: Array_Type<ReliabilityMl.CustomPipeFactory>, spec?: UpsertSpec): ObjList<ReliabilityMl.CustomPipeFactory> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<ReliabilityMl.CustomPipeFactory> | null>, spec?: UpsertSpec): ObjList<ReliabilityMl.CustomPipeFactory> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<ReliabilityMl.CustomPipeFactory>, srcObjs?: Array_Type<ReliabilityMl.CustomPipeFactory>, spec?: UpsertSpec): ObjList<ReliabilityMl.CustomPipeFactory> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<ReliabilityMl.CustomPipeFactory> | null>, spec?: UpsertSpec): ObjList<ReliabilityMl.CustomPipeFactory> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<ReliabilityMl.CustomPipeFactory>, spec?: TouchSpec): ObjList<ReliabilityMl.CustomPipeFactory> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityMl.CustomPipeFactory>, spec?: MergeSpec): ObjList<ReliabilityMl.CustomPipeFactory> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityMl.CustomPipeFactory>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityMl.CustomPipeFactory> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<ReliabilityMl.CustomPipeFactory> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityMl.CustomPipeFactory> | null;
     ...
     */
    static mergeAll(mergeObj: ReliabilityMl.CustomPipeFactory, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: ReliabilityMl.CustomPipeFactory, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<ReliabilityMl.CustomPipeFactory>, spec?: UpsertSpec): ObjList<ReliabilityMl.CustomPipeFactory> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<ReliabilityMl.CustomPipeFactory>, spec?: UpsertSpec): ObjList<ReliabilityMl.CustomPipeFactory> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): ReliabilityMl.CustomPipeFactory | null;
     ...
     */
    static beforeCreate(objs: Array_Type<ReliabilityMl.CustomPipeFactory>): ObjList<ReliabilityMl.CustomPipeFactory>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<ReliabilityMl.CustomPipeFactory>): ObjList<ReliabilityMl.CustomPipeFactory>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<ReliabilityMl.CustomPipeFactory>): ObjList<ReliabilityMl.CustomPipeFactory>;
     ...
     */
    static afterCreate(objs: Array_Type<ReliabilityMl.CustomPipeFactory>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<ReliabilityMl.CustomPipeFactory>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<ReliabilityMl.CustomPipeFactory>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityMl.CustomPipeFactory>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityMl.CustomPipeFactory>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): ReliabilityMl.CustomPipeFactory | null;
     ...
     */
    withoutIdentity(): ReliabilityMl.CustomPipeFactory | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<ReliabilityMl.CustomPipeFactory>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: ReliabilityMl.CustomPipeFactory, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<ReliabilityMl.CustomPipeFactory>, callback?: λFunction<ReliabilityMl.CustomPipeFactory | null, ReliabilityMl.CustomPipeFactory | null>): ObjList<ReliabilityMl.CustomPipeFactory>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<ReliabilityMl.CustomPipeFactory>, callback?: λFunction<ReliabilityMl.CustomPipeFactory | null, ReliabilityMl.CustomPipeFactory | null>): Array_Type<ObjError> | null;
    ...
    /**
     * Based on information in the fields defined on an instance of this Type, instantiate
     * a {@link ReliabilityMl.CustomPipe} which can be trained/processed.
     * @returns {@link ReliabilityMl.CustomPipe}.
     */
