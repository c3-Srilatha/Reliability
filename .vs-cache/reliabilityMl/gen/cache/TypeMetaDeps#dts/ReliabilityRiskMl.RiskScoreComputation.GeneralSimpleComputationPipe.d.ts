// TypeScript definitions for the C3 type ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe

/**
 * This type represents an {@link MlPipe} template for the {@link ReliabilityRiskMl.Pipeline} which outputs a `riskScore` based on a dataset of features as input.
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe
 */
declare namespace ReliabilityRiskMl.RiskScoreComputation {
  export interface IGeneralSimpleComputationPipe {
    ...
    /**
     * `numpy` function to aggregate feature inputs.
     */
    aggFunc: string;
  }
}
 ...
 * This type represents an {@link MlPipe} template for the {@link ReliabilityRiskMl.Pipeline} which outputs a `riskScore` based on a dataset of features as input.
 *
 * @remarks this represents a made instance of ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe
 */
declare namespace ReliabilityRiskMl.RiskScoreComputation {
  export class GeneralSimpleComputationPipe extends Obj  {
     ...
     */
    readonly id: string;
    withId(id: string): ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe;

    /**
     * Name of this pipe.
     */
    readonly name?: string;
    withName(name: string | null): ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe;
    ...
    withVersion(version: number | null): ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe;
    ...
    withUserUpdatedFields(userUpdatedFields: Array_Type<string> | Array<string> | null): ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe;
    ...
    withHidden(hidden: boolean): ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe;
    ...
    withUserOwned(userOwned: boolean): ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe;
    ...
    withTypeIdent(typeIdent: string | null): ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe;

    /**
     * If true, then the pipe shall not be retrained
     */
    readonly frozen?: boolean;
    withFrozen(frozen: boolean): ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe;

    /**
     * True if training has succeeded and false otherwise.
     */
    readonly trained?: boolean;
    withTrained(trained: boolean): ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe;

    /**
     * Errors from training.
     */
    readonly trainingErrors?: string;
    withTrainingErrors(trainingErrors: string | null): ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe;

    /**
     * If true, the underlying model only accepts flattened input.
     */
    readonly flattenInput?: boolean;
    withFlattenInput(flattenInput: boolean): ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe;

    /**
     * The hyperparameters overridden of a native model or pipe.
     */
    readonly hyperparamOverrides?: Map_Type<string, any>;
    withHyperparamOverrides(hyperparamOverrides: Map_Type<string, any> | {[key: string]: any} | null): ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe;
    ...
    withHyperparamSearchSpace(hyperparamSearchSpace: IHp.SearchSpace | null): ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe;
    ...
    withHpoSpec(hpoSpec: IHpo.Spec | null): ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe;

    /**
     * {@link Hpo.Experiment} stores the result of hyperparameter optimization to find the best model/pipeline.
     */
    readonly hpoExperiment?: Hpo.Experiment;
    withHpoExperiment(hpoExperiment: IHpo.Experiment | null): ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe;

    /**
     * Reference to the experiment that produced this {@link MlPipe}. For example, this could be a {@link Hpo.ExperimentBase}.
     */
    readonly experiment?: any;
    withExperiment(experiment: any | null): ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe;
    ...
    withModelFiles(modelFiles: Map_Type<string, Url> | {[key: string]: IUrl} | null): ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe;
    ...
    withCustomModelCode(customModelCode: Map_Type<string, any> | {[key: string]: any} | null): ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe;

    /**
     * Name for the function on the native model to call to do {@link MlProcessable#process}.
     */
    readonly processFunc?: string;
    withProcessFunc(processFunc: string | null): ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe;
    ...
    withUnderlyingPipe(underlyingPipe: IMlAtomicPipe<any, any, any> | null): ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe;
    ...
    withIsTrainableOverride(isTrainableOverride: boolean): ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe;
    ...
    withLookbackDuration(lookbackDuration: IDuration | null): ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe;

    /**
     * `numpy` function to aggregate feature inputs.
     */
    readonly aggFunc: string;
    withAggFunc(aggFunc: string): ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe;
     ...
     * @see #toJson
     */
    static fromJson(json: any): ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe | null;
     ...
     */
    replaceType(old: Type, new_: Type): ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe;
     ...
     * @see #removeField
     */
    withoutField(field: string): ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe;
     ...
     */
    withoutFields(fields: Array_Type<string>): ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe;
     ...
     * @see #unsetField
     */
    defaultField(field: string): ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe;
     ...
     * @see #removeField
     */
    unsetField(field: string): ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe;
     ...
     * @see #unsetField
     */
    removeField(field: string): ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe;

    mergeJson(json: any): ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe;
     ...
     */
    sumObj(other: Obj, deep?: boolean): ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe;
     ...
     */
    singletonArray(): Array_Type<ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe;
     ...
     * @see #fromString
     */
    static make(s: string): ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe;
     ...
     */
    static cachedEmptyInst(): ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe;
     ...
     */
    remakeTemplate(): ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe;
     ...
     */
    withoutIdentity(): ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe;
     ...
     */
    trainSync(x: , y?: , spec?: MlOperationSpec): ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe;
     ...
     */
    static allCached(doNotProduceAll?: boolean): Stream<ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe> | null;
     ...
     */
    static find(filter?: string, doNotProduceAll?: boolean): Stream<ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe> | null;
     ...
     * @return existing instances of this type that satisfy filter from data cache.
     */
    static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe> | null;
     ...
     * @see getCached
     */
    static findByCacheKey(key: string): ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe | null;
     ...
     * @see findByCacheKey
     */
    static forCacheKey(key: string): ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe | null;
     ...
     * @see findByCacheKey
     */
    getCached(): ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe | null;

    /**
     * @return newly produced cached instance.
     */
    refreshCache(): ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe | null;
     ...
     */
    static produce(key: string): ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe | null;
     ...
     */
    static produceAll(): Map_Type<string, ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe> | null;

    /**
     * Override for sub-types to produce all values.
     */
    static doProduceAll(): Map_Type<string, ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe> | null;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe>> | null;
     ...
     */
    get(include?: string): ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe | null;
     ...
     */
    getMissing(spec: GetMissingSpec): ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe;
     ...
     * @see #toString
     */
    static fromString(s: string): ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe | null;
     ...
     */
    create(spec?: UpsertSpec): ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe | null;
     ...
     */
    static createBatch(objs: Array_Type<ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe> | null;
     ...
     */
    update(srcObj?: ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe, spec?: UpsertSpec): ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe | null;
     ...
     */
    upsert(srcObj?: ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe, spec?: UpsertSpec): ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe | null;
     ...
     */
    merge(spec?: MergeSpec): ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe | null;
     ...
     */
    static updateBatch(objs: Array_Type<ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe>, srcObjs?: Array_Type<ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe> | null>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe>, srcObjs?: Array_Type<ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe> | null>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe>, spec?: TouchSpec): ObjList<ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe>, spec?: MergeSpec): ObjList<ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe> | null;
     ...
     */
    static mergeAll(mergeObj: ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe | null;
     ...
     */
    static beforeCreate(objs: Array_Type<ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe>): ObjList<ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe>;
     ...
     */
    static beforeUpdate(objs: Array_Type<ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe>): ObjList<ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe>): ObjList<ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe>;
     ...
     */
    static afterCreate(objs: Array_Type<ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe>, callback?: λFunction<ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe | null, ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe | null>): ObjList<ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe>, callback?: λFunction<ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe | null, ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe | null>): Array_Type<ObjError> | null;
     ...
     */
    publish(subPath?: string, contentType?: string): ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe;
     ...
     */
    static removeSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe> | null;
     ...
     */
    createSeedData(spec?: UpsertSpec): ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe | null;
     ...
     */
    static createSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe> | null;
     ...
     */
    updateSeedData(srcObj?: SeedData, spec?: UpsertSpec): ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe | null;
     ...
     */
    static updateSeedDataBatch(objs?: Array_Type<SeedData>, srcObjs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe> | null;
     ...
     * @return updated obj instance, same as {@link Persistable#update} return value.
     */
    clearUserUpdates(spec?: MergeSpec): ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe | null;
     ...
     *         {@link Persistable#updateBatch}.
     */
    static clearUserUpdatesBatch(objs?: Array_Type<SeedData>, spec?: MergeSpec): ObjList<ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe> | null;
    ...
    dependencies(): SeedDataDeps<ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe> | null;
     ...
     */
    static convert(model: any, spec?: MlConvertSpec): ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe;

    /**
     * Freezes an {@link MlPipe}
     * @return modified copy of this {@link MlPipe} that cannot be trained
     */
    freeze(): ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe;

    /**
     * Unfreezes an {@link MlPipe}
     * @return modified copy of this {@link MlPipe} that can be trained
     */
    unfreeze(): ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe;
     ...
     * be returned as-is.
     */
    byReference(): ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe;
     ...
     */
    updateModelFiles(modelFiles: Map_Type<string, Url>, spec?: MlOperationSpec): ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe;
     ...
     */
    afterTrain(doTrainOutputs: any, spec?: MlOperationSpec): ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe;
     ...
     */
    withNewSpec(spec?: MlConvertSpec): ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe;
     ...
     */
    afterConvert(model: any, spec?: MlConvertSpec): ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe;
     ...
     */
    withHyperparamSpaces(paramSpaces: Map_Type<string, Hp.ParamSpace>): ReliabilityRiskMl.RiskScoreComputation.GeneralSimpleComputationPipe;
