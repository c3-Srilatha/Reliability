// TypeScript definitions for the C3 type Es.Package.Config

/**
 * Configuration for {@link Es#Package}.
 *
 * @remarks this represents a value passed to a method that expects an instance of Es.Package.Config
 */
...
declare namespace Es.Package {
  export class Config extends Obj {
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): Es.Package.Config | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): Es.Package.Config | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): Es.Package.Config | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): Es.Package.Config | null;
     ...
     */
    replaceType(old: Type, new_: Type): Es.Package.Config;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Es.Package.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Es.Package.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Es.Package.Config | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Es.Package.Config | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Es.Package.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Es.Package.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Es.Package.Config;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Es.Package.Config;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Es.Package.Config;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Es.Package.Config;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Es.Package.Config;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Es.Package.Config;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Es.Package.Config;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): Es.Package.Config;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): Es.Package.Config;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): Es.Package.Config;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Es.Package.Config;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Es.Package.Config;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Es.Package.Config;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Es.Package.Config;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Es.Package.Config;
     ...
     * @see #removeField
     */
    unsetField(field: string): Es.Package.Config;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Es.Package.Config;
     ...
     * @see #unsetField
     */
    removeField(field: string): Es.Package.Config;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Es.Package.Config;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Es.Package.Config;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): Es.Package.Config;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Es.Package.Config;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Es.Package.Config;

    mergeJson(json: any | null): Es.Package.Config;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Es.Package.Config;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): Es.Package.Config;
     ...
     */
    singletonArray(): C3.Array<Es.Package.Config | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<Es.Package.Config | null>;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Es.Package.Config | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<Es.Package.Config | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Es.Package.Config | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, Es.Package.Config | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Es.Package.Config | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Es.Package.Config | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Es.Package.Config | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Es.Package.Config;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Es.Package.Config;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Es.Package.Config;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Es.Package.Config;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Es.Package.Config;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Es.Package.Config;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Es.Package.Config;
     ...
     */
    static cachedEmptyInst(): Es.Package.Config;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Es.Package.Config>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): Es.Package.Config;
     ...
     */
    static allCached(doNotProduceAll?: boolean): Stream<Es.Package.Config | null>;
     ...
     */
    static find(filter?: string | null, doNotProduceAll?: boolean): Stream<Es.Package.Config | null>;
     ...
     * @return existing instances of this type that satisfy filter from data cache.
     */
    static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<Es.Package.Config | null>;
     ...
     * @see getCached
     */
    static findByCacheKey(key: string): Es.Package.Config | null;

    /**
     * Returns cached instance by key, with secrets removed.
     */
    static forCacheKey(key: string | null): Es.Package.Config | null;
     ...
     * @see findByCacheKey
     */
    getCached(): Es.Package.Config | null;

    /**
     * @return newly produced cached instance.
     */
    refreshCache(): Es.Package.Config | null;
     ...
     */
    static produce(key: string): Es.Package.Config | null;
     ...
     */
    static produceAll(): C3.Map<string | null, Es.Package.Config | null>;

    /**
     * Override for sub-types to produce all values.
     */
    static doProduceAll(): C3.Map<string | null, Es.Package.Config | null>;
     ...
     */
    static forConfigKey(configKey: string | null): Es.Package.Config | null;
     ...
     */
    static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<Es.Package.Config | null>;
     ...
     * @see setConfigValue
     */
    setConfigValues(from: Es.Package.Config, override?: string | null): void;
     ...
     * @see setSecretValue
     */
    setSecretValues(from: Es.Package.Config, override?: string | null): void;
     ...
     */
    static loadConfigAndSecret(configKey: string): Es.Package.Config | null;
