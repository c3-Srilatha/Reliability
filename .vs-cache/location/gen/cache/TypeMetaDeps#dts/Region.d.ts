// TypeScript definitions for the C3 type Region

/**
 * Represents a geographical region with hierarchical, business, and geopolitical relationships.
 * Extends {@link SeedData}, {@link WeatherAware}, and {@link MetricEvaluatable} types for additional weather
 * and metric data storage.
 *
 * @remarks this represents a value passed to a method that expects an instance of Region
 */
declare interface IRegion {
  ...
  /**
   * Relationships to child regions.
   */
  regionRelations?: Array_Type<RegionRelation> | Array<IRegionRelation>;
 ...
 * and metric data storage.
 *
 * @remarks this represents a made instance of Region
 */
declare class Region extends Obj  {
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Region;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): Region;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): Region;
  ...
  withVersion(version: number | null): Region;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): Region;
  ...
  withUserUpdatedFields(userUpdatedFields: Array_Type<string> | Array<string> | null): Region;
  ...
  withHidden(hidden: boolean): Region;
  ...
  withUserOwned(userOwned: boolean): Region;

  readonly weatherStation?: WeatherStation;
  withWeatherStation(weatherStation: IWeatherStation | null): Region;
  ...
  withTypeIdent(typeIdent: string | null): Region;

  /**
   * A description of the region.
   */
  readonly description?: string;
  withDescription(description: string | null): Region;

  /**
   * Relationships to child regions.
   */
  readonly regionRelations?: Array_Type<RegionRelation>;
  withRegionRelations(regionRelations: Array_Type<RegionRelation> | Array<IRegionRelation> | null): Region;

  /**
   * Parent regions, denormalized from `regionRelations`.
   */
  readonly parents?: Array_Type<Region>;
  withParents(parents: Array_Type<Region> | Array<IRegion> | null): Region;

  /**
   * Geographical entity associated with the region.
   */
  readonly geography?: GeographicalEntity;
  withGeography(geography: IGeographicalEntity | null): Region;

  /**
   * Denormalized list of parent regions from `RegionHierarchyDenorm`.
   */
  readonly denormChildren?: Array_Type<RegionHierarchyDenorm>;
  withDenormChildren(denormChildren: Array_Type<RegionHierarchyDenorm> | Array<IRegionHierarchyDenorm> | null): Region;

  /**
   * Business region parent relationships.
   */
  readonly businessRegionParents?: Array_Type<BusinessRegionRelation>;
  withBusinessRegionParents(businessRegionParents: Array_Type<BusinessRegionRelation> | Array<IBusinessRegionRelation> | null): Region;

  /**
   * Geopolitical region parent relationships.
   */
  readonly geoPoliticalRegionParents?: Array_Type<GeoPoliticalRegionRelation>;
  withGeoPoliticalRegionParents(geoPoliticalRegionParents: Array_Type<GeoPoliticalRegionRelation> | Array<IGeoPoliticalRegionRelation> | null): Region;

  /**
   * Business region child relationships.
   */
  readonly businessRegionChildren?: Array_Type<BusinessRegionRelation>;
  withBusinessRegionChildren(businessRegionChildren: Array_Type<BusinessRegionRelation> | Array<IBusinessRegionRelation> | null): Region;

  /**
   * Geopolitical region child relationships.
   */
  readonly geoPoliticalRegionChildren?: Array_Type<GeoPoliticalRegionRelation>;
  withGeoPoliticalRegionChildren(geoPoliticalRegionChildren: Array_Type<GeoPoliticalRegionRelation> | Array<IGeoPoliticalRegionRelation> | null): Region;
   ...
   * @see #toJson
   */
  static fromJson(json: any): Region | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): Region | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): Region | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): Region | null;
   ...
   */
  replaceType(old: Type, new_: Type): Region;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Region;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Region;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Region>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Region>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Region;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Region;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Region;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): Region;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): Region;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Region;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Region;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): Region;
   ...
   * @see #removeField
   */
  withoutField(field: string): Region;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): Region;
   ...
   */
  withoutFields(fields: Array_Type<string>): Region;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): Region;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): Region;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Region;
   ...
   * @see #unsetField
   */
  defaultField(field: string): Region;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): Region;
   ...
   * @see #removeField
   */
  unsetField(field: string): Region;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): Region;
   ...
   * @see #unsetField
   */
  removeField(field: string): Region;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): Region;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Region;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): Region;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Region;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Region;

  mergeJson(json: any): Region;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Region;
   ...
   */
  sumObj(other: Obj, deep?: boolean): Region;
   ...
   */
  singletonArray(): Array_Type<Region>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<Region> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<Region> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<Region>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<Region> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, Region> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, Region> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<Region>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<Region>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Region;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Region;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Region;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): Region;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Region;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): Region;
   ...
   * @see #fromString
   */
  static make(s: string): Region | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Region;
   ...
   */
  static cachedEmptyInst(): Region;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<Region> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): Region;
   ...
   */
  static allCached(): Stream<Region> | null;
   ...
   */
  static find(filter?: string): Stream<Region> | null;
   ...
   *         Otherwise no population will be performed.
   */
  static findBy(field: string, value: any): Stream<Region> | null;

  /**
   * @return cached instance.
   */
  getCached(): Region | null;

  /**
   * @return cached instance by the key.
   */
  static forCacheKey(key: string): Region | null;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<Region>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<Region>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<Region> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Region>> | null;
   ...
   */
  get(include?: string): Region | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): Region | null;
   ...
   */
  getMissing(spec: GetMissingSpec): Region;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): Region | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): Region;
   ...
   * @see #toString
   */
  static fromString(s: string): Region | null;
   ...
   */
  create(spec?: UpsertSpec): Region | null;
   ...
   */
  static createBatch(objs: Array_Type<Region>, spec?: UpsertSpec): ObjList<Region> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<Region>, spec?: CreateBatchObjStreamSpec): ObjList<Region> | null;
   ...
   */
  update(srcObj?: Region, spec?: UpsertSpec): Region | null;
   ...
   */
  upsert(srcObj?: Region, spec?: UpsertSpec): Region | null;
   ...
   */
  merge(spec?: MergeSpec): Region | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): Region | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): Region | null;
   ...
   */
  static updateBatch(objs: Array_Type<Region>, srcObjs?: Array_Type<Region>, spec?: UpsertSpec): ObjList<Region> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<Region> | null>, spec?: UpsertSpec): ObjList<Region> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<Region>, srcObjs?: Array_Type<Region>, spec?: UpsertSpec): ObjList<Region> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<Region> | null>, spec?: UpsertSpec): ObjList<Region> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<Region>, spec?: TouchSpec): ObjList<Region> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<Region>, spec?: MergeSpec): ObjList<Region> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<Region>, mergeInclude: string, spec?: MergeSpec): ObjList<Region> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<Region> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Region> | null;
   ...
   */
  static mergeAll(mergeObj: Region, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: Region, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<Region>, spec?: UpsertSpec): ObjList<Region> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<Region>, spec?: UpsertSpec): ObjList<Region> | null;
   ...
   */
  static beforeCreate(objs: Array_Type<Region>): ObjList<Region>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<Region>): ObjList<Region>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<Region>): ObjList<Region>;
   ...
   */
  static afterCreate(objs: Array_Type<Region>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<Region>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<Region>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<Region>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Region>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): Region | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<Region>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: Region, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<Region>, callback?: λFunction<Region | null, Region | null>): ObjList<Region>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<Region>, callback?: λFunction<Region | null, Region | null>): Array_Type<ObjError> | null;
   ...
   */
  publish(subPath?: string, contentType?: string): Region;
   ...
   */
  static removeSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<Region> | null;
   ...
   */
  createSeedData(spec?: UpsertSpec): Region | null;
   ...
   */
  static createSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<Region> | null;
   ...
   */
  updateSeedData(srcObj?: SeedData, spec?: UpsertSpec): Region | null;
   ...
   */
  static updateSeedDataBatch(objs?: Array_Type<SeedData>, srcObjs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<Region> | null;
   ...
   * @return updated obj instance, same as {@link Persistable#update} return value.
   */
  clearUserUpdates(spec?: MergeSpec): Region | null;
   ...
   *         {@link Persistable#updateBatch}.
   */
  static clearUserUpdatesBatch(objs?: Array_Type<SeedData>, spec?: MergeSpec): ObjList<Region> | null;
  ...
  dependencies(): SeedDataDeps<Region> | null;
