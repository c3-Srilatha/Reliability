// TypeScript definitions for the C3 type LocationGeocodingJob

/**
 * MapReduce job on Location to update geocoding.
 *
 * @remarks this represents a value passed to a method that expects an instance of LocationGeocodingJob
 */
declare interface ILocationGeocodingJob {
 ...
 */
declare class LocationGeocodingJob extends Obj  {

  /**
   * current or last job execution for this instance
   */
  readonly run?: MapReduceRun;
  withRun(run: IMapReduceRun | null): LocationGeocodingJob;

  /**
   * previous job executions for this instance
   */
  readonly runs?: Array_Type<MapReduceRun>;
  withRuns(runs: Array_Type<MapReduceRun> | Array<IMapReduceRun> | null): LocationGeocodingJob;

  /**
   * FOR INTERNAL USE ONLY - Specify options in call to {@link start}.
   */
  readonly options?: Obj;
  withOptions(options: IObj | null): LocationGeocodingJob;
  ...
  withOnCompleteCallback(onCompleteCallback: IJobBase.Callback | null): LocationGeocodingJob;
  ...
  withPriority(priority: number | null): LocationGeocodingJob;
  ...
  withDisabled(disabled: boolean): LocationGeocodingJob;
  ...
  withMaxConcurrency(maxConcurrency: number | null): LocationGeocodingJob;
  ...
  withMaxConcurrencyPerNode(maxConcurrencyPerNode: number | null): LocationGeocodingJob;
  ...
  withRunAsUser(runAsUser: boolean): LocationGeocodingJob;

  /**
   * Don't set this field in the MapReduce job, set it in the MapReduceOptions when calling `start`.
   */
  readonly nodePool?: string;
  withNodePool(nodePool: string | null): LocationGeocodingJob;
  ...
  withSkipIfRunning(skipIfRunning: boolean): LocationGeocodingJob;

  /**
   * Set to between 1 and 5 to enable auto recovery. See {@link invalidation-queues.c3doc Invalidation Queues} for detailed documentation.
   */
  readonly numAutoRecoveryAttempts?: number;
  withNumAutoRecoveryAttempts(numAutoRecoveryAttempts: number | null): LocationGeocodingJob;
  ...
  withTargetType(targetType: IType | null): LocationGeocodingJob;
  ...
  withUseFileSystemForInterVals(useFileSystemForInterVals: boolean): LocationGeocodingJob;
  ...
  withUseBatchIdsForReadInput(useBatchIdsForReadInput: boolean): LocationGeocodingJob;
  ...
  withInclude(include: string | null): LocationGeocodingJob;

  /**
   * optional filter spec
   */
  readonly filter?: string;
  withFilter(filter: string | null): LocationGeocodingJob;
  ...
  withOrder(order: string | null): LocationGeocodingJob;
  ...
  withLimit(limit: number | null): LocationGeocodingJob;
  ...
  withSamplePct(samplePct: number | null): LocationGeocodingJob;
  ...
  withBatchSize(batchSize: number | null): LocationGeocodingJob;
  ...
  withSubBatchSize(subBatchSize: number | null): LocationGeocodingJob;
  ...
  withNumBatches(numBatches: number | null): LocationGeocodingJob;
  ...
  withAbortOnError(abortOnError: boolean): LocationGeocodingJob;
  ...
  withTypeIdent(typeIdent: string | null): LocationGeocodingJob;
   ...
   */
  readonly id: string;
  withId(id: string): LocationGeocodingJob;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): LocationGeocodingJob;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): LocationGeocodingJob;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): LocationGeocodingJob;
  ...
  withVersion(version: number | null): LocationGeocodingJob;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): LocationGeocodingJob;

  /**
   * Optional target type instance to be used as the filter for the job.  When specified, the {~link map} function will
   * only be called for that obj.
   */
  readonly targetFilter?: Location;
  withTargetFilter(targetFilter: ILocation | null): LocationGeocodingJob;
  ...
  withIncludeComponents(includeComponents: boolean): LocationGeocodingJob;
   ...
   * @see #toJson
   */
  static fromJson(json: any): LocationGeocodingJob | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): LocationGeocodingJob | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): LocationGeocodingJob | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): LocationGeocodingJob | null;
   ...
   */
  replaceType(old: Type, new_: Type): LocationGeocodingJob;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): LocationGeocodingJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): LocationGeocodingJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<LocationGeocodingJob>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<LocationGeocodingJob>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): LocationGeocodingJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): LocationGeocodingJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): LocationGeocodingJob;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): LocationGeocodingJob;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): LocationGeocodingJob;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): LocationGeocodingJob;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): LocationGeocodingJob;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): LocationGeocodingJob;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): LocationGeocodingJob;
   ...
   * @see #removeField
   */
  withoutField(field: string): LocationGeocodingJob;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): LocationGeocodingJob;
   ...
   */
  withoutFields(fields: Array_Type<string>): LocationGeocodingJob;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): LocationGeocodingJob;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): LocationGeocodingJob;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): LocationGeocodingJob;
   ...
   * @see #unsetField
   */
  defaultField(field: string): LocationGeocodingJob;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): LocationGeocodingJob;
   ...
   * @see #removeField
   */
  unsetField(field: string): LocationGeocodingJob;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): LocationGeocodingJob;
   ...
   * @see #unsetField
   */
  removeField(field: string): LocationGeocodingJob;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): LocationGeocodingJob;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): LocationGeocodingJob;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): LocationGeocodingJob;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): LocationGeocodingJob;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): LocationGeocodingJob;

  mergeJson(json: any): LocationGeocodingJob;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): LocationGeocodingJob;
   ...
   */
  sumObj(other: Obj, deep?: boolean): LocationGeocodingJob;
   ...
   */
  singletonArray(): Array_Type<LocationGeocodingJob>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<LocationGeocodingJob> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<LocationGeocodingJob> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<LocationGeocodingJob>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<LocationGeocodingJob> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, LocationGeocodingJob> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, LocationGeocodingJob> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<LocationGeocodingJob>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<LocationGeocodingJob>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): LocationGeocodingJob;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): LocationGeocodingJob;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): LocationGeocodingJob;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): LocationGeocodingJob;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): LocationGeocodingJob;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): LocationGeocodingJob;
   ...
   * @see #fromString
   */
  static make(s: string): LocationGeocodingJob | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): LocationGeocodingJob;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): LocationGeocodingJob;
   ...
   */
  static cachedEmptyInst(): LocationGeocodingJob;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<LocationGeocodingJob> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): LocationGeocodingJob;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<LocationGeocodingJob>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<LocationGeocodingJob>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<LocationGeocodingJob> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<LocationGeocodingJob>> | null;
   ...
   */
  get(include?: string): LocationGeocodingJob | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): LocationGeocodingJob | null;
   ...
   */
  getMissing(spec: GetMissingSpec): LocationGeocodingJob;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): LocationGeocodingJob | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): LocationGeocodingJob;
   ...
   * @see #toString
   */
  static fromString(s: string): LocationGeocodingJob | null;
   ...
   */
  create(spec?: UpsertSpec): LocationGeocodingJob | null;
   ...
   */
  static createBatch(objs: Array_Type<LocationGeocodingJob>, spec?: UpsertSpec): ObjList<LocationGeocodingJob> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<LocationGeocodingJob>, spec?: CreateBatchObjStreamSpec): ObjList<LocationGeocodingJob> | null;
   ...
   */
  update(srcObj?: LocationGeocodingJob, spec?: UpsertSpec): LocationGeocodingJob | null;
   ...
   */
  upsert(srcObj?: LocationGeocodingJob, spec?: UpsertSpec): LocationGeocodingJob | null;
   ...
   */
  merge(spec?: MergeSpec): LocationGeocodingJob | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): LocationGeocodingJob | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): LocationGeocodingJob | null;
   ...
   */
  static updateBatch(objs: Array_Type<LocationGeocodingJob>, srcObjs?: Array_Type<LocationGeocodingJob>, spec?: UpsertSpec): ObjList<LocationGeocodingJob> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<LocationGeocodingJob> | null>, spec?: UpsertSpec): ObjList<LocationGeocodingJob> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<LocationGeocodingJob>, srcObjs?: Array_Type<LocationGeocodingJob>, spec?: UpsertSpec): ObjList<LocationGeocodingJob> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<LocationGeocodingJob> | null>, spec?: UpsertSpec): ObjList<LocationGeocodingJob> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<LocationGeocodingJob>, spec?: TouchSpec): ObjList<LocationGeocodingJob> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<LocationGeocodingJob>, spec?: MergeSpec): ObjList<LocationGeocodingJob> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<LocationGeocodingJob>, mergeInclude: string, spec?: MergeSpec): ObjList<LocationGeocodingJob> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<LocationGeocodingJob> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<LocationGeocodingJob> | null;
   ...
   */
  static mergeAll(mergeObj: LocationGeocodingJob, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: LocationGeocodingJob, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<LocationGeocodingJob>, spec?: UpsertSpec): ObjList<LocationGeocodingJob> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<LocationGeocodingJob>, spec?: UpsertSpec): ObjList<LocationGeocodingJob> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): LocationGeocodingJob | null;
   ...
   */
  static beforeCreate(objs: Array_Type<LocationGeocodingJob>): ObjList<LocationGeocodingJob>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<LocationGeocodingJob>): ObjList<LocationGeocodingJob>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<LocationGeocodingJob>): ObjList<LocationGeocodingJob>;
   ...
   */
  static afterCreate(objs: Array_Type<LocationGeocodingJob>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<LocationGeocodingJob>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<LocationGeocodingJob>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<LocationGeocodingJob>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<LocationGeocodingJob>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): LocationGeocodingJob | null;
   ...
   */
  withoutIdentity(): LocationGeocodingJob | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<LocationGeocodingJob>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: LocationGeocodingJob, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<LocationGeocodingJob>, callback?: λFunction<LocationGeocodingJob | null, LocationGeocodingJob | null>): ObjList<LocationGeocodingJob>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<LocationGeocodingJob>, callback?: λFunction<LocationGeocodingJob | null, LocationGeocodingJob | null>): Array_Type<ObjError> | null;
   ...
   *         key type.
   */
  static map(batch?: number, objs?: Array_Type<Location>, job?: MapReduce<Location, string, number, number>, subBatch?: number): Map_Type<string, number> | null;
   ...
   */
  static reduce(outKey?: string, interValues?: Array_Type<number>, job?: MapReduce<Location, string, number, number>): number | Array_Type<number> | null;
   ...
   */
  static mapCompleted(job?: MapReduce<Location, string, number, number>): void;
   ...
   */
  static completed(job?: MapReduce<Location, string, number, number>): string | null;
   ...
   */
  static failed(job: MapReduce<Location, string, number, number>, status: MapReduceStatus, options?: MapReduceOptions): void;
   ...
   */
  results(limit?: number = '10000'): Map_Type<string, number | Array_Type<number>> | null;
   ...
   */
  static startJob(filter?: string, includeComponents?: boolean, forceUpdate?: boolean): LocationGeocodingJob | null;
}
