// TypeScript definitions for the C3 type RegionRelation
 ...
 * key 'RREL'
 *
 * @remarks this represents a value passed to a method that expects an instance of RegionRelation
 */
declare interface IRegionRelation {
 ...
 */
declare class RegionRelation extends Obj  {

  /**
   * The id of this instance.
   */
  readonly id: string;
  withId(id: string): RegionRelation;

  /**
   * Denormalized fields for easy access to parent and child regions.
   */
  readonly from?: Region;
  withFrom(from: IRegion | null): RegionRelation;
   ...
   */
  readonly to?: Region;
  withTo(to: IRegion | null): RegionRelation;

  /**
   * Relationship type, default value is 'RREL'.
   */
  readonly relationship?: string;
  withRelationship(relationship: string | null): RegionRelation;

  /**
   * Denormalized geographical name of the parent region.
   */
  readonly fromInfo?: string;
  withFromInfo(fromInfo: string | null): RegionRelation;

  /**
   * Denormalized geographical name of the child region.
   */
  readonly toInfo?: string;
  withToInfo(toInfo: string | null): RegionRelation;

  /**
   * Placeholder field. Not used in regular computation
   */
  readonly involvement?: number;
  withInvolvement(involvement: number | null): RegionRelation;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): RegionRelation;

  /**
   * The relationship name, formatted as "parent region -> child region".
   */
  readonly name?: string;
  withName(name: string | null): RegionRelation;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): RegionRelation;
  ...
  withVersion(version: number | null): RegionRelation;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): RegionRelation;
  ...
  withUserUpdatedFields(userUpdatedFields: Array_Type<string> | Array<string> | null): RegionRelation;
  ...
  withHidden(hidden: boolean): RegionRelation;
  ...
  withUserOwned(userOwned: boolean): RegionRelation;
  ...
  withTypeIdent(typeIdent: string | null): RegionRelation;
  ...
  withParent(parent: IRegion): RegionRelation;
   ...
   * This field references the child region.
   */
  readonly child: Region;
  withChild(child: IRegion): RegionRelation;
   ...
   * @see #toJson
   */
  static fromJson(json: any): RegionRelation | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): RegionRelation | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): RegionRelation | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): RegionRelation | null;
   ...
   */
  replaceType(old: Type, new_: Type): RegionRelation;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): RegionRelation;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): RegionRelation;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<RegionRelation>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<RegionRelation>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): RegionRelation;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): RegionRelation;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): RegionRelation;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): RegionRelation;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): RegionRelation;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): RegionRelation;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): RegionRelation;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): RegionRelation;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): RegionRelation;
   ...
   * @see #removeField
   */
  withoutField(field: string): RegionRelation;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): RegionRelation;
   ...
   */
  withoutFields(fields: Array_Type<string>): RegionRelation;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): RegionRelation;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): RegionRelation;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): RegionRelation;
   ...
   * @see #unsetField
   */
  defaultField(field: string): RegionRelation;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): RegionRelation;
   ...
   * @see #removeField
   */
  unsetField(field: string): RegionRelation;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): RegionRelation;
   ...
   * @see #unsetField
   */
  removeField(field: string): RegionRelation;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): RegionRelation;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): RegionRelation;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): RegionRelation;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): RegionRelation;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): RegionRelation;

  mergeJson(json: any): RegionRelation;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): RegionRelation;
   ...
   */
  sumObj(other: Obj, deep?: boolean): RegionRelation;
   ...
   */
  singletonArray(): Array_Type<RegionRelation>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<RegionRelation> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<RegionRelation> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<RegionRelation>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<RegionRelation> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, RegionRelation> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, RegionRelation> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<RegionRelation>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<RegionRelation>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): RegionRelation;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): RegionRelation;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): RegionRelation;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): RegionRelation;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): RegionRelation;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): RegionRelation;
   ...
   * @see #fromString
   */
  static make(s: string): RegionRelation | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): RegionRelation;
   ...
   */
  static cachedEmptyInst(): RegionRelation;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<RegionRelation> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): RegionRelation;
   ...
   * @see #toString
   */
  static fromString(s: string): RegionRelation | null;
   ...
   */
  static allCached(): Stream<RegionRelation> | null;
   ...
   */
  static find(filter?: string): Stream<RegionRelation> | null;
   ...
   *         Otherwise no population will be performed.
   */
  static findBy(field: string, value: any): Stream<RegionRelation> | null;

  /**
   * @return cached instance.
   */
  getCached(): RegionRelation | null;

  /**
   * @return cached instance by the key.
   */
  static forCacheKey(key: string): RegionRelation | null;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<RegionRelation>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<RegionRelation>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<RegionRelation> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<RegionRelation>> | null;
   ...
   */
  get(include?: string): RegionRelation | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): RegionRelation | null;
   ...
   */
  getMissing(spec: GetMissingSpec): RegionRelation;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): RegionRelation | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): RegionRelation;
   ...
   */
  create(spec?: UpsertSpec): RegionRelation | null;
   ...
   */
  static createBatch(objs: Array_Type<RegionRelation>, spec?: UpsertSpec): ObjList<RegionRelation> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<RegionRelation>, spec?: CreateBatchObjStreamSpec): ObjList<RegionRelation> | null;
   ...
   */
  update(srcObj?: RegionRelation, spec?: UpsertSpec): RegionRelation | null;
   ...
   */
  upsert(srcObj?: RegionRelation, spec?: UpsertSpec): RegionRelation | null;
   ...
   */
  merge(spec?: MergeSpec): RegionRelation | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): RegionRelation | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): RegionRelation | null;
   ...
   */
  static updateBatch(objs: Array_Type<RegionRelation>, srcObjs?: Array_Type<RegionRelation>, spec?: UpsertSpec): ObjList<RegionRelation> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<RegionRelation> | null>, spec?: UpsertSpec): ObjList<RegionRelation> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<RegionRelation>, srcObjs?: Array_Type<RegionRelation>, spec?: UpsertSpec): ObjList<RegionRelation> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<RegionRelation> | null>, spec?: UpsertSpec): ObjList<RegionRelation> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<RegionRelation>, spec?: TouchSpec): ObjList<RegionRelation> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<RegionRelation>, spec?: MergeSpec): ObjList<RegionRelation> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<RegionRelation>, mergeInclude: string, spec?: MergeSpec): ObjList<RegionRelation> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<RegionRelation> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<RegionRelation> | null;
   ...
   */
  static mergeAll(mergeObj: RegionRelation, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: RegionRelation, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<RegionRelation>, spec?: UpsertSpec): ObjList<RegionRelation> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<RegionRelation>, spec?: UpsertSpec): ObjList<RegionRelation> | null;
   ...
   */
  static beforeCreate(objs: Array_Type<RegionRelation>): ObjList<RegionRelation>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<RegionRelation>): ObjList<RegionRelation>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<RegionRelation>): ObjList<RegionRelation>;
   ...
   */
  static afterCreate(objs: Array_Type<RegionRelation>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<RegionRelation>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<RegionRelation>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<RegionRelation>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<RegionRelation>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): RegionRelation | null;
   ...
   */
  withoutIdentity(): RegionRelation | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<RegionRelation>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: RegionRelation, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<RegionRelation>, callback?: λFunction<RegionRelation | null, RegionRelation | null>): ObjList<RegionRelation>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<RegionRelation>, callback?: λFunction<RegionRelation | null, RegionRelation | null>): Array_Type<ObjError> | null;
   ...
   */
  publish(subPath?: string, contentType?: string): RegionRelation;
   ...
   */
  static removeSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<RegionRelation> | null;
   ...
   */
  createSeedData(spec?: UpsertSpec): RegionRelation | null;
   ...
   */
  static createSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<RegionRelation> | null;
   ...
   */
  updateSeedData(srcObj?: SeedData, spec?: UpsertSpec): RegionRelation | null;
   ...
   */
  static updateSeedDataBatch(objs?: Array_Type<SeedData>, srcObjs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<RegionRelation> | null;
   ...
   * @return updated obj instance, same as {@link Persistable#update} return value.
   */
  clearUserUpdates(spec?: MergeSpec): RegionRelation | null;
   ...
   *         {@link Persistable#updateBatch}.
   */
  static clearUserUpdatesBatch(objs?: Array_Type<SeedData>, spec?: MergeSpec): ObjList<RegionRelation> | null;
  ...
  dependencies(): SeedDataDeps<RegionRelation> | null;
