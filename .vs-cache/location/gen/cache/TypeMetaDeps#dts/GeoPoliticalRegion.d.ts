// TypeScript definitions for the C3 type GeoPoliticalRegion

/**
 * Entity representing a geopolitical region. This entity extends the {@link Region} type and mixes in {@link SeedData} functionality.
 *
 * It defines a region with its associated relationships to other geopolitical regions.
 *
 * @remarks this represents a value passed to a method that expects an instance of GeoPoliticalRegion
 */
declare interface IGeoPoliticalRegion {
  ...
  /**
   * A list of relationships between this region and other geopolitical regions.
   *
   * Each relationship is represented by a {@link GeoPoliticalRegionRelation}, which links the current region to
   * other regions, establishing hierarchical or relational connections.
   */
  regionRelations?: Array_Type<GeoPoliticalRegionRelation> | Array<IGeoPoliticalRegionRelation>;

  /**
   * Parent regions, denormalized from `regionRelations`.
   */
  parents?: Array_Type<Region> | Array<IRegion>;

  /**
   * Geographical entity associated with the region.
   */
  geography?: IGeographicalEntity;

  /**
   * Denormalized list of parent regions from `RegionHierarchyDenorm`.
   */
  denormChildren?: Array_Type<RegionHierarchyDenorm> | Array<IRegionHierarchyDenorm>;

  /**
   * Business region parent relationships.
   */
  businessRegionParents?: Array_Type<BusinessRegionRelation> | Array<IBusinessRegionRelation>;

  /**
   * Geopolitical region parent relationships.
   */
  geoPoliticalRegionParents?: Array_Type<GeoPoliticalRegionRelation> | Array<IGeoPoliticalRegionRelation>;

  /**
   * Business region child relationships.
   */
  businessRegionChildren?: Array_Type<BusinessRegionRelation> | Array<IBusinessRegionRelation>;

  /**
   * Geopolitical region child relationships.
   */
  geoPoliticalRegionChildren?: Array_Type<GeoPoliticalRegionRelation> | Array<IGeoPoliticalRegionRelation>;
}
 ...
 * It defines a region with its associated relationships to other geopolitical regions.
 *
 * @remarks this represents a made instance of GeoPoliticalRegion
 */
declare class GeoPoliticalRegion extends Obj  {
   ...
   */
  readonly id: string;
  withId(id: string): GeoPoliticalRegion;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): GeoPoliticalRegion;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): GeoPoliticalRegion;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): GeoPoliticalRegion;
  ...
  withVersion(version: number | null): GeoPoliticalRegion;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): GeoPoliticalRegion;
  ...
  withUserUpdatedFields(userUpdatedFields: Array_Type<string> | Array<string> | null): GeoPoliticalRegion;
  ...
  withHidden(hidden: boolean): GeoPoliticalRegion;
  ...
  withUserOwned(userOwned: boolean): GeoPoliticalRegion;

  readonly weatherStation?: WeatherStation;
  withWeatherStation(weatherStation: IWeatherStation | null): GeoPoliticalRegion;
  ...
  withTypeIdent(typeIdent: string | null): GeoPoliticalRegion;

  /**
   * A description of the region.
   */
  readonly description?: string;
  withDescription(description: string | null): GeoPoliticalRegion;
   ...
   * other regions, establishing hierarchical or relational connections.
   */
  readonly regionRelations?: Array_Type<GeoPoliticalRegionRelation>;
  withRegionRelations(regionRelations: Array_Type<GeoPoliticalRegionRelation> | Array<IGeoPoliticalRegionRelation> | null): GeoPoliticalRegion;

  /**
   * Parent regions, denormalized from `regionRelations`.
   */
  readonly parents?: Array_Type<Region>;
  withParents(parents: Array_Type<Region> | Array<IRegion> | null): GeoPoliticalRegion;

  /**
   * Geographical entity associated with the region.
   */
  readonly geography?: GeographicalEntity;
  withGeography(geography: IGeographicalEntity | null): GeoPoliticalRegion;

  /**
   * Denormalized list of parent regions from `RegionHierarchyDenorm`.
   */
  readonly denormChildren?: Array_Type<RegionHierarchyDenorm>;
  withDenormChildren(denormChildren: Array_Type<RegionHierarchyDenorm> | Array<IRegionHierarchyDenorm> | null): GeoPoliticalRegion;

  /**
   * Business region parent relationships.
   */
  readonly businessRegionParents?: Array_Type<BusinessRegionRelation>;
  withBusinessRegionParents(businessRegionParents: Array_Type<BusinessRegionRelation> | Array<IBusinessRegionRelation> | null): GeoPoliticalRegion;

  /**
   * Geopolitical region parent relationships.
   */
  readonly geoPoliticalRegionParents?: Array_Type<GeoPoliticalRegionRelation>;
  withGeoPoliticalRegionParents(geoPoliticalRegionParents: Array_Type<GeoPoliticalRegionRelation> | Array<IGeoPoliticalRegionRelation> | null): GeoPoliticalRegion;

  /**
   * Business region child relationships.
   */
  readonly businessRegionChildren?: Array_Type<BusinessRegionRelation>;
  withBusinessRegionChildren(businessRegionChildren: Array_Type<BusinessRegionRelation> | Array<IBusinessRegionRelation> | null): GeoPoliticalRegion;

  /**
   * Geopolitical region child relationships.
   */
  readonly geoPoliticalRegionChildren?: Array_Type<GeoPoliticalRegionRelation>;
  withGeoPoliticalRegionChildren(geoPoliticalRegionChildren: Array_Type<GeoPoliticalRegionRelation> | Array<IGeoPoliticalRegionRelation> | null): GeoPoliticalRegion;
   ...
   * @see #toJson
   */
  static fromJson(json: any): GeoPoliticalRegion | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): GeoPoliticalRegion | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): GeoPoliticalRegion | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): GeoPoliticalRegion | null;
   ...
   */
  replaceType(old: Type, new_: Type): GeoPoliticalRegion;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GeoPoliticalRegion;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GeoPoliticalRegion;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<GeoPoliticalRegion>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<GeoPoliticalRegion>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): GeoPoliticalRegion;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GeoPoliticalRegion;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GeoPoliticalRegion;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): GeoPoliticalRegion;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): GeoPoliticalRegion;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): GeoPoliticalRegion;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): GeoPoliticalRegion;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): GeoPoliticalRegion;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): GeoPoliticalRegion;
   ...
   * @see #removeField
   */
  withoutField(field: string): GeoPoliticalRegion;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): GeoPoliticalRegion;
   ...
   */
  withoutFields(fields: Array_Type<string>): GeoPoliticalRegion;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): GeoPoliticalRegion;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): GeoPoliticalRegion;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): GeoPoliticalRegion;
   ...
   * @see #unsetField
   */
  defaultField(field: string): GeoPoliticalRegion;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): GeoPoliticalRegion;
   ...
   * @see #removeField
   */
  unsetField(field: string): GeoPoliticalRegion;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): GeoPoliticalRegion;
   ...
   * @see #unsetField
   */
  removeField(field: string): GeoPoliticalRegion;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): GeoPoliticalRegion;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): GeoPoliticalRegion;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): GeoPoliticalRegion;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): GeoPoliticalRegion;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): GeoPoliticalRegion;

  mergeJson(json: any): GeoPoliticalRegion;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): GeoPoliticalRegion;
   ...
   */
  sumObj(other: Obj, deep?: boolean): GeoPoliticalRegion;
   ...
   */
  singletonArray(): Array_Type<GeoPoliticalRegion>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<GeoPoliticalRegion> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<GeoPoliticalRegion> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<GeoPoliticalRegion>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<GeoPoliticalRegion> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, GeoPoliticalRegion> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, GeoPoliticalRegion> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<GeoPoliticalRegion>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<GeoPoliticalRegion>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): GeoPoliticalRegion;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): GeoPoliticalRegion;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): GeoPoliticalRegion;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): GeoPoliticalRegion;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): GeoPoliticalRegion;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): GeoPoliticalRegion;
   ...
   * @see #fromString
   */
  static make(s: string): GeoPoliticalRegion | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): GeoPoliticalRegion;
   ...
   */
  static cachedEmptyInst(): GeoPoliticalRegion;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<GeoPoliticalRegion> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): GeoPoliticalRegion;
   ...
   */
  static allCached(): Stream<GeoPoliticalRegion> | null;
   ...
   */
  static find(filter?: string): Stream<GeoPoliticalRegion> | null;
   ...
   *         Otherwise no population will be performed.
   */
  static findBy(field: string, value: any): Stream<GeoPoliticalRegion> | null;

  /**
   * @return cached instance.
   */
  getCached(): GeoPoliticalRegion | null;

  /**
   * @return cached instance by the key.
   */
  static forCacheKey(key: string): GeoPoliticalRegion | null;
   ...
   */
  static produce(key: string): GeoPoliticalRegion | null;

  /**
   * Should produces the entire content for the cached data. Will populate the cache with the produced data.
   */
  static produceAll(): Map_Type<string, GeoPoliticalRegion> | null;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<GeoPoliticalRegion>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<GeoPoliticalRegion>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<GeoPoliticalRegion> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<GeoPoliticalRegion>> | null;
   ...
   */
  get(include?: string): GeoPoliticalRegion | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): GeoPoliticalRegion | null;
   ...
   */
  getMissing(spec: GetMissingSpec): GeoPoliticalRegion;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): GeoPoliticalRegion | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): GeoPoliticalRegion;
   ...
   * @see #toString
   */
  static fromString(s: string): GeoPoliticalRegion | null;
   ...
   */
  create(spec?: UpsertSpec): GeoPoliticalRegion | null;
   ...
   */
  static createBatch(objs: Array_Type<GeoPoliticalRegion>, spec?: UpsertSpec): ObjList<GeoPoliticalRegion> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<GeoPoliticalRegion>, spec?: CreateBatchObjStreamSpec): ObjList<GeoPoliticalRegion> | null;
   ...
   */
  update(srcObj?: GeoPoliticalRegion, spec?: UpsertSpec): GeoPoliticalRegion | null;
   ...
   */
  upsert(srcObj?: GeoPoliticalRegion, spec?: UpsertSpec): GeoPoliticalRegion | null;
   ...
   */
  merge(spec?: MergeSpec): GeoPoliticalRegion | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): GeoPoliticalRegion | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): GeoPoliticalRegion | null;
   ...
   */
  static updateBatch(objs: Array_Type<GeoPoliticalRegion>, srcObjs?: Array_Type<GeoPoliticalRegion>, spec?: UpsertSpec): ObjList<GeoPoliticalRegion> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<GeoPoliticalRegion> | null>, spec?: UpsertSpec): ObjList<GeoPoliticalRegion> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<GeoPoliticalRegion>, srcObjs?: Array_Type<GeoPoliticalRegion>, spec?: UpsertSpec): ObjList<GeoPoliticalRegion> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<GeoPoliticalRegion> | null>, spec?: UpsertSpec): ObjList<GeoPoliticalRegion> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<GeoPoliticalRegion>, spec?: TouchSpec): ObjList<GeoPoliticalRegion> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<GeoPoliticalRegion>, spec?: MergeSpec): ObjList<GeoPoliticalRegion> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<GeoPoliticalRegion>, mergeInclude: string, spec?: MergeSpec): ObjList<GeoPoliticalRegion> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<GeoPoliticalRegion> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<GeoPoliticalRegion> | null;
   ...
   */
  static mergeAll(mergeObj: GeoPoliticalRegion, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: GeoPoliticalRegion, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<GeoPoliticalRegion>, spec?: UpsertSpec): ObjList<GeoPoliticalRegion> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<GeoPoliticalRegion>, spec?: UpsertSpec): ObjList<GeoPoliticalRegion> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): GeoPoliticalRegion | null;
   ...
   */
  static beforeCreate(objs: Array_Type<GeoPoliticalRegion>): ObjList<GeoPoliticalRegion>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<GeoPoliticalRegion>): ObjList<GeoPoliticalRegion>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<GeoPoliticalRegion>): ObjList<GeoPoliticalRegion>;
   ...
   */
  static afterCreate(objs: Array_Type<GeoPoliticalRegion>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<GeoPoliticalRegion>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<GeoPoliticalRegion>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<GeoPoliticalRegion>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<GeoPoliticalRegion>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): GeoPoliticalRegion | null;
   ...
   */
  withoutIdentity(): GeoPoliticalRegion | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<GeoPoliticalRegion>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: GeoPoliticalRegion, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<GeoPoliticalRegion>, callback?: λFunction<GeoPoliticalRegion | null, GeoPoliticalRegion | null>): ObjList<GeoPoliticalRegion>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<GeoPoliticalRegion>, callback?: λFunction<GeoPoliticalRegion | null, GeoPoliticalRegion | null>): Array_Type<ObjError> | null;
   ...
   */
  publish(subPath?: string, contentType?: string): GeoPoliticalRegion;
   ...
   */
  static removeSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<GeoPoliticalRegion> | null;
   ...
   */
  createSeedData(spec?: UpsertSpec): GeoPoliticalRegion | null;
   ...
   */
  static createSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<GeoPoliticalRegion> | null;
   ...
   */
  updateSeedData(srcObj?: SeedData, spec?: UpsertSpec): GeoPoliticalRegion | null;
   ...
   */
  static updateSeedDataBatch(objs?: Array_Type<SeedData>, srcObjs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<GeoPoliticalRegion> | null;
   ...
   * @return updated obj instance, same as {@link Persistable#update} return value.
   */
  clearUserUpdates(spec?: MergeSpec): GeoPoliticalRegion | null;
   ...
   *         {@link Persistable#updateBatch}.
   */
  static clearUserUpdatesBatch(objs?: Array_Type<SeedData>, spec?: MergeSpec): ObjList<GeoPoliticalRegion> | null;
  ...
  dependencies(): SeedDataDeps<GeoPoliticalRegion> | null;
