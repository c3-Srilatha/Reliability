// TypeScript definitions for the C3 type Location
 ...
 * ]")
 *
 * @remarks this represents a value passed to a method that expects an instance of Location
 */
declare interface ILocation {
   ...
   */
  points?: Array_Type<OldGeoPoint> | Array<IOldGeoPoint>;

  /**
   * a rectangle indicating the influence/spen of the object
   */
  envelope?: IGeoEnvelope;
 ...
 */
declare class Location extends Obj  {

  /**
   * set global positions defined to identify the object
   */
  readonly points?: Array_Type<OldGeoPoint>;
  withPoints(points: Array_Type<OldGeoPoint> | Array<IOldGeoPoint> | null): Location;

  /**
   * a rectangle indicating the influence/spen of the object
   */
  readonly envelope?: GeoEnvelope;
  withEnvelope(envelope: IGeoEnvelope | null): Location;
  ...
  withMode(mode: string): Location;

  /**
   * The id of this instance.
   */
  readonly id: string;
  withId(id: string): Location;

  readonly weatherStation?: WeatherStation;
  withWeatherStation(weatherStation: IWeatherStation | null): Location;

  /**
   * List of {@link AclEntry} entries governing who can read/update/remove Objs.
   */
  readonly acl?: Array_Type<AclEntry>;
  withAcl(acl: Array_Type<AclEntry> | Array<IAclEntry> | null): Location;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Location;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): Location;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): Location;
  ...
  withVersion(version: number | null): Location;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): Location;

  /**
   * Detailed address components of the location.
   */
  readonly address?: InlineAddress;
  withAddress(address: IInlineAddress | null): Location;

  /**
   * Postal code of the location, extracted from the address components.
   */
  readonly postalCode?: string;
  withPostalCode(postalCode: string | null): Location;

  /**
   * Street address of the location, extracted from the address components.
   */
  readonly streetAddress?: string;
  withStreetAddress(streetAddress: string | null): Location;

  /**
   * City of the location, extracted from the address components.
   */
  readonly city?: string;
  withCity(city: string | null): Location;

  /**
   * State abbreviation of the location, extracted from the address components.
   */
  readonly state?: string;
  withState(state: string | null): Location;

  /**
   * A shortened version of the postal code.
   */
  readonly shortPostalCode?: string;
  withShortPostalCode(shortPostalCode: string | null): Location;

  /**
   * Elevation of the location above sea level.
   */
  readonly elevation?: Dimension;
  withElevation(elevation: IDimension | null): Location;
   ...
   * @see #toJson
   */
  static fromJson(json: any): Location | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): Location | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): Location | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): Location | null;
   ...
   */
  replaceType(old: Type, new_: Type): Location;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Location;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Location;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Location>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Location>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Location;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Location;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Location;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): Location;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): Location;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): Location;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Location;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Location;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): Location;
   ...
   * @see #removeField
   */
  withoutField(field: string): Location;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): Location;
   ...
   */
  withoutFields(fields: Array_Type<string>): Location;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): Location;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): Location;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Location;
   ...
   * @see #unsetField
   */
  defaultField(field: string): Location;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): Location;
   ...
   * @see #removeField
   */
  unsetField(field: string): Location;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): Location;
   ...
   * @see #unsetField
   */
  removeField(field: string): Location;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): Location;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Location;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): Location;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Location;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Location;

  mergeJson(json: any): Location;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Location;
   ...
   */
  sumObj(other: Obj, deep?: boolean): Location;
   ...
   */
  singletonArray(): Array_Type<Location>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<Location> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<Location> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<Location>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<Location> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, Location> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, Location> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<Location>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<Location>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Location;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Location;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Location;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): Location;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Location;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): Location;
   ...
   * @see #fromString
   */
  static make(s: string): Location | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Location;
   ...
   */
  static cachedEmptyInst(): Location;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<Location> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): Location;
   ...
   * @see #toString
   */
  static fromString(s: string): Location | null;
   ...
   */
  create(spec?: UpsertSpec): Location | null;
   ...
   */
  static createBatch(objs: Array_Type<Location>, spec?: UpsertSpec): ObjList<Location> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<Location>, spec?: CreateBatchObjStreamSpec): ObjList<Location> | null;
   ...
   */
  update(srcObj?: Location, spec?: UpsertSpec): Location | null;
   ...
   */
  upsert(srcObj?: Location, spec?: UpsertSpec): Location | null;
   ...
   */
  merge(spec?: MergeSpec): Location | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): Location | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): Location | null;
   ...
   */
  static updateBatch(objs: Array_Type<Location>, srcObjs?: Array_Type<Location>, spec?: UpsertSpec): ObjList<Location> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<Location> | null>, spec?: UpsertSpec): ObjList<Location> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<Location>, srcObjs?: Array_Type<Location>, spec?: UpsertSpec): ObjList<Location> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<Location> | null>, spec?: UpsertSpec): ObjList<Location> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<Location>, spec?: TouchSpec): ObjList<Location> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<Location>, spec?: MergeSpec): ObjList<Location> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<Location>, mergeInclude: string, spec?: MergeSpec): ObjList<Location> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<Location> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Location> | null;
   ...
   */
  static mergeAll(mergeObj: Location, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: Location, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<Location>, spec?: UpsertSpec): ObjList<Location> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<Location>, spec?: UpsertSpec): ObjList<Location> | null;
   ...
   */
  static beforeCreate(objs: Array_Type<Location>): ObjList<Location>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<Location>): ObjList<Location>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<Location>): ObjList<Location>;
   ...
   */
  static afterCreate(objs: Array_Type<Location>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<Location>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<Location>): Array_Type<ObjError> | null;
   ...
   */
  static populateAcl(objs?: Array_Type<Location>): number | null;
   ...
   */
  grantMemberReadUpdateRemove(member: AccessControlEntity): Location;
   ...
   */
  mergeAclEntry(entry: AclEntry): Location;
   ...
   * @return the obj with the new acl after merging the indicated entry.
   */
  mergeAclEntries(entries: Array_Type<AclEntry>): Location;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<Location>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<Location>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<Location> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Location>> | null;
   ...
   */
  get(include?: string): Location | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): Location | null;
   ...
   */
  getMissing(spec: GetMissingSpec): Location;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): Location | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): Location;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<Location>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Location>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): Location | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<Location>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: Location, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<Location>, callback?: λFunction<Location | null, Location | null>): ObjList<Location>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<Location>, callback?: λFunction<Location | null, Location | null>): Array_Type<ObjError> | null;
   ...
   */
  static findAddressComponent(loc?: Location, addressType?: string, field?: string): string | null;
   ...
   */
  static updateGeocoding(loc?: Location, includeComponents?: boolean): boolean;
   ...
   */
  static updateGeocodingBatch(locations?: Array_Type<Location>, includeComponents?: boolean): ObjList<Location> | null;
   ...
   */
  static updateGeocodingAll(filter?: string, includeComponents?: boolean, forceUpdate?: boolean): LocationGeocodingJob | null;
}
