...
class ScheduleCalendar(SeedData):
    ...
    """
    def __init__(self, id: Optional[str]=None, versionEdits: Optional[Array[VersionEdit]]=None, name: Optional[str]=None, meta: Optional[Meta]=None, version: Optional[int]=None, typeWithBindings: Optional[Type]=None, userUpdatedFields: Optional[Array[str]]=None, hidden: Optional[bool]=None, userOwned: Optional[bool]=None, scheduleType: Optional[str]=None, effectiveDate: Optional[datetime]=None, effectiveEndDate: Optional[datetime]=None, scheduleHolidaySchedule: Optional[Array[ScheduleHolidaySchedule]]=None, scheduleExceptionDatetimeWindow: Optional[Array[ScheduleExceptionDatetimeWindow]]=None, scheduleRecurringDayRule: Optional[Array[ScheduleRecurringDayRule]]=None) -> None: ...
