// TypeScript definitions for the C3 type ScheduleHolidaySchedule

/**
 * The association of a holiday to a schedule plus a window of time
 * for reduced or extended hours for the related holiday
 * e.g. Holidays that apply to this schedule.
 * 00:00 to 00:00 means no hours  00:00 to null means all 24 hours of the day
 * Business Key: schedule+scheduleHoliday+non overlapping effective dates
 *
 * @remarks this represents a value passed to a method that expects an instance of ScheduleHolidaySchedule
 */
declare interface IScheduleHolidaySchedule {
  ...
  /**
   * date that the holiday is in effect for the schedule, inclusive
   */
  effectiveDate?: DateTime | Date | string;

  /**
   * date that the holiday is no longer in effect for the schedule, exclusive
   */
  effectiveEndDate?: DateTime | Date | string;

  /**
   * time of the day for the associated holiday that is in effect for the schedule
   * i.e. hours of operation.  inclusive HH:MM - will change to time datatype
   */
  startTime: string;

  /**
   * time of the day for the associated holiday that is no longer in effect for the
   * schedule.  i.e. hours of operation.  exclusive.  null implies unbounded to end of the day
  ...
  scheduleHoliday: IScheduleHoliday;
}
 ...
 * Business Key: schedule+scheduleHoliday+non overlapping effective dates
 *
 * @remarks this represents a made instance of ScheduleHolidaySchedule
 */
declare class ScheduleHolidaySchedule extends Obj  {
   ...
   */
  readonly id: string;
  withId(id: string): ScheduleHolidaySchedule;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ScheduleHolidaySchedule;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): ScheduleHolidaySchedule;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): ScheduleHolidaySchedule;
  ...
  withVersion(version: number | null): ScheduleHolidaySchedule;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): ScheduleHolidaySchedule;

  /**
   * date that the holiday is in effect for the schedule, inclusive
   */
  readonly effectiveDate?: DateTime;
  withEffectiveDate(effectiveDate: DateTime | Date | string | null): ScheduleHolidaySchedule;

  /**
   * date that the holiday is no longer in effect for the schedule, exclusive
   */
  readonly effectiveEndDate?: DateTime;
  withEffectiveEndDate(effectiveEndDate: DateTime | Date | string | null): ScheduleHolidaySchedule;
  ...
  withStartTime(startTime: string): ScheduleHolidaySchedule;
  ...
  withEndTime(endTime: string | null): ScheduleHolidaySchedule;

  /**
   * FK references FROM parents
   */
  readonly scheduleCalendar: ScheduleCalendar;
  withScheduleCalendar(scheduleCalendar: IScheduleCalendar): ScheduleHolidaySchedule;

  readonly scheduleHoliday: ScheduleHoliday;
  withScheduleHoliday(scheduleHoliday: IScheduleHoliday): ScheduleHolidaySchedule;
   ...
   * @see #toJson
   */
  static fromJson(json: any): ScheduleHolidaySchedule | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): ScheduleHolidaySchedule | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): ScheduleHolidaySchedule | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): ScheduleHolidaySchedule | null;
   ...
   */
  replaceType(old: Type, new_: Type): ScheduleHolidaySchedule;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ScheduleHolidaySchedule;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ScheduleHolidaySchedule;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ScheduleHolidaySchedule>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ScheduleHolidaySchedule>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ScheduleHolidaySchedule;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ScheduleHolidaySchedule;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ScheduleHolidaySchedule;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ScheduleHolidaySchedule;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ScheduleHolidaySchedule;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ScheduleHolidaySchedule;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ScheduleHolidaySchedule;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ScheduleHolidaySchedule;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ScheduleHolidaySchedule;
   ...
   * @see #removeField
   */
  withoutField(field: string): ScheduleHolidaySchedule;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): ScheduleHolidaySchedule;
   ...
   */
  withoutFields(fields: Array_Type<string>): ScheduleHolidaySchedule;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): ScheduleHolidaySchedule;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ScheduleHolidaySchedule;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ScheduleHolidaySchedule;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ScheduleHolidaySchedule;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ScheduleHolidaySchedule;
   ...
   * @see #removeField
   */
  unsetField(field: string): ScheduleHolidaySchedule;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ScheduleHolidaySchedule;
   ...
   * @see #unsetField
   */
  removeField(field: string): ScheduleHolidaySchedule;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ScheduleHolidaySchedule;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ScheduleHolidaySchedule;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): ScheduleHolidaySchedule;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ScheduleHolidaySchedule;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ScheduleHolidaySchedule;

  mergeJson(json: any): ScheduleHolidaySchedule;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ScheduleHolidaySchedule;
   ...
   */
  sumObj(other: Obj, deep?: boolean): ScheduleHolidaySchedule;
   ...
   */
  singletonArray(): Array_Type<ScheduleHolidaySchedule>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<ScheduleHolidaySchedule> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ScheduleHolidaySchedule> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<ScheduleHolidaySchedule>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ScheduleHolidaySchedule> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, ScheduleHolidaySchedule> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ScheduleHolidaySchedule> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ScheduleHolidaySchedule>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ScheduleHolidaySchedule>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ScheduleHolidaySchedule;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ScheduleHolidaySchedule;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ScheduleHolidaySchedule;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ScheduleHolidaySchedule;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ScheduleHolidaySchedule;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ScheduleHolidaySchedule;
   ...
   * @see #fromString
   */
  static make(s: string): ScheduleHolidaySchedule | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ScheduleHolidaySchedule;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): ScheduleHolidaySchedule;
   ...
   */
  static cachedEmptyInst(): ScheduleHolidaySchedule;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<ScheduleHolidaySchedule> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): ScheduleHolidaySchedule;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<ScheduleHolidaySchedule>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<ScheduleHolidaySchedule>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<ScheduleHolidaySchedule> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ScheduleHolidaySchedule>> | null;
   ...
   */
  get(include?: string): ScheduleHolidaySchedule | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): ScheduleHolidaySchedule | null;
   ...
   */
  getMissing(spec: GetMissingSpec): ScheduleHolidaySchedule;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): ScheduleHolidaySchedule | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): ScheduleHolidaySchedule;
   ...
   * @see #toString
   */
  static fromString(s: string): ScheduleHolidaySchedule | null;
   ...
   */
  create(spec?: UpsertSpec): ScheduleHolidaySchedule | null;
   ...
   */
  static createBatch(objs: Array_Type<ScheduleHolidaySchedule>, spec?: UpsertSpec): ObjList<ScheduleHolidaySchedule> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<ScheduleHolidaySchedule>, spec?: CreateBatchObjStreamSpec): ObjList<ScheduleHolidaySchedule> | null;
   ...
   */
  update(srcObj?: ScheduleHolidaySchedule, spec?: UpsertSpec): ScheduleHolidaySchedule | null;
   ...
   */
  upsert(srcObj?: ScheduleHolidaySchedule, spec?: UpsertSpec): ScheduleHolidaySchedule | null;
   ...
   */
  merge(spec?: MergeSpec): ScheduleHolidaySchedule | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): ScheduleHolidaySchedule | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): ScheduleHolidaySchedule | null;
   ...
   */
  static updateBatch(objs: Array_Type<ScheduleHolidaySchedule>, srcObjs?: Array_Type<ScheduleHolidaySchedule>, spec?: UpsertSpec): ObjList<ScheduleHolidaySchedule> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<ScheduleHolidaySchedule> | null>, spec?: UpsertSpec): ObjList<ScheduleHolidaySchedule> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<ScheduleHolidaySchedule>, srcObjs?: Array_Type<ScheduleHolidaySchedule>, spec?: UpsertSpec): ObjList<ScheduleHolidaySchedule> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<ScheduleHolidaySchedule> | null>, spec?: UpsertSpec): ObjList<ScheduleHolidaySchedule> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<ScheduleHolidaySchedule>, spec?: TouchSpec): ObjList<ScheduleHolidaySchedule> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ScheduleHolidaySchedule>, spec?: MergeSpec): ObjList<ScheduleHolidaySchedule> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ScheduleHolidaySchedule>, mergeInclude: string, spec?: MergeSpec): ObjList<ScheduleHolidaySchedule> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<ScheduleHolidaySchedule> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ScheduleHolidaySchedule> | null;
   ...
   */
  static mergeAll(mergeObj: ScheduleHolidaySchedule, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: ScheduleHolidaySchedule, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<ScheduleHolidaySchedule>, spec?: UpsertSpec): ObjList<ScheduleHolidaySchedule> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<ScheduleHolidaySchedule>, spec?: UpsertSpec): ObjList<ScheduleHolidaySchedule> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): ScheduleHolidaySchedule | null;
   ...
   */
  static beforeCreate(objs: Array_Type<ScheduleHolidaySchedule>): ObjList<ScheduleHolidaySchedule>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<ScheduleHolidaySchedule>): ObjList<ScheduleHolidaySchedule>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<ScheduleHolidaySchedule>): ObjList<ScheduleHolidaySchedule>;
   ...
   */
  static afterCreate(objs: Array_Type<ScheduleHolidaySchedule>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<ScheduleHolidaySchedule>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<ScheduleHolidaySchedule>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<ScheduleHolidaySchedule>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ScheduleHolidaySchedule>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): ScheduleHolidaySchedule | null;
   ...
   */
  withoutIdentity(): ScheduleHolidaySchedule | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<ScheduleHolidaySchedule>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: ScheduleHolidaySchedule, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<ScheduleHolidaySchedule>, callback?: λFunction<ScheduleHolidaySchedule | null, ScheduleHolidaySchedule | null>): ObjList<ScheduleHolidaySchedule>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<ScheduleHolidaySchedule>, callback?: λFunction<ScheduleHolidaySchedule | null, ScheduleHolidaySchedule | null>): Array_Type<ObjError> | null;
