// TypeScript definitions for the C3 type ScheduleRecurringDayRule

/**
 * Settings to define a recurring day and optional window of time
 * Allows multiple time windows for a day to support a restaurant that may close in
 * the afternoon for a few hours or a business that takes a siesta
 * May define normal work hours for a day of week Mon-Sun (i.e. when a facility is occupied)
 * 00:00 to 00:00 means no hours  00:00 to null means all 24 hours of the day
 * Business Key: all core attributes, not meaningful to enforce
 *
 * @remarks this represents a value passed to a method that expects an instance of ScheduleRecurringDayRule
 */
declare interface IScheduleRecurringDayRule {
  ...
  /**
   * optional descriptor, i.e. every monday 9-5 or first monday of the month
   */
  name?: string;
  ...
  /**
   * recurring base calendar unit monthly, weekly, daily, annually
   */
  calendarUnit: string;

  /**
   * repeat frequency i.e. every 2 months
   */
  calendarUnitFrequency: number;
  ...
  /**
   * Allows picking a day of week by month or year
   * i.e. ON last Thursday of the month
   */
  onQualifier?: string;

  /**
   * start window of time during the day described by the rule, inclusive
   * 00:00 to 00:00 means no work hours  HH:MM - will change to time datatype
   * HH:MM - will change to time datatype
   */
  startTime: string;

  /**
   * end window of time during the day described by the rule, exclusive
   * null implies unbounded in context of the day (end of day)
   * HH:MM - will change to time datatype
   */
  endTime?: string;

  /**
   * date range of when this rule is in effect for a schedule
   * inclusive
   */
  effectiveDate?: DateTime | Date | string;

  /**
   * exclusive
   */
  effectiveEndDate?: DateTime | Date | string;
 ...
 * Business Key: all core attributes, not meaningful to enforce
 *
 * @remarks this represents a made instance of ScheduleRecurringDayRule
 */
declare class ScheduleRecurringDayRule extends Obj  {
   ...
   */
  readonly id: string;
  withId(id: string): ScheduleRecurringDayRule;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ScheduleRecurringDayRule;

  /**
   * optional descriptor, i.e. every monday 9-5 or first monday of the month
   */
  readonly name?: string;
  withName(name: string | null): ScheduleRecurringDayRule;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): ScheduleRecurringDayRule;
  ...
  withVersion(version: number | null): ScheduleRecurringDayRule;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): ScheduleRecurringDayRule;

  /**
   * recurring base calendar unit monthly, weekly, daily, annually
   */
  readonly calendarUnit: string;
  withCalendarUnit(calendarUnit: string): ScheduleRecurringDayRule;

  /**
   * repeat frequency i.e. every 2 months
   */
  readonly calendarUnitFrequency: number;
  withCalendarUnitFrequency(calendarUnitFrequency: number): ScheduleRecurringDayRule;

  readonly isoDayOfWeek?: number;
  withIsoDayOfWeek(isoDayOfWeek: number | null): ScheduleRecurringDayRule;

  /**
   * 1-31
   */
  readonly dayOfMonth?: number;
  withDayOfMonth(dayOfMonth: number | null): ScheduleRecurringDayRule;

  /**
   * Allows picking a day of week by month or year
   * i.e. ON last Thursday of the month
   */
  readonly onQualifier?: string;
  withOnQualifier(onQualifier: string | null): ScheduleRecurringDayRule;
  ...
  withStartTime(startTime: string): ScheduleRecurringDayRule;
  ...
  withEndTime(endTime: string | null): ScheduleRecurringDayRule;
  ...
  withEffectiveDate(effectiveDate: DateTime | Date | string | null): ScheduleRecurringDayRule;

  /**
   * exclusive
   */
  readonly effectiveEndDate?: DateTime;
  withEffectiveEndDate(effectiveEndDate: DateTime | Date | string | null): ScheduleRecurringDayRule;

  /**
   * FK references FROM parents
   */
  readonly scheduleCalendar?: ScheduleCalendar;
  withScheduleCalendar(scheduleCalendar: IScheduleCalendar | null): ScheduleRecurringDayRule;
   ...
   * @see #toJson
   */
  static fromJson(json: any): ScheduleRecurringDayRule | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): ScheduleRecurringDayRule | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): ScheduleRecurringDayRule | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): ScheduleRecurringDayRule | null;
   ...
   */
  replaceType(old: Type, new_: Type): ScheduleRecurringDayRule;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ScheduleRecurringDayRule;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ScheduleRecurringDayRule;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ScheduleRecurringDayRule>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ScheduleRecurringDayRule>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ScheduleRecurringDayRule;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ScheduleRecurringDayRule;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ScheduleRecurringDayRule;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ScheduleRecurringDayRule;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ScheduleRecurringDayRule;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ScheduleRecurringDayRule;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ScheduleRecurringDayRule;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ScheduleRecurringDayRule;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ScheduleRecurringDayRule;
   ...
   * @see #removeField
   */
  withoutField(field: string): ScheduleRecurringDayRule;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): ScheduleRecurringDayRule;
   ...
   */
  withoutFields(fields: Array_Type<string>): ScheduleRecurringDayRule;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): ScheduleRecurringDayRule;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ScheduleRecurringDayRule;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ScheduleRecurringDayRule;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ScheduleRecurringDayRule;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ScheduleRecurringDayRule;
   ...
   * @see #removeField
   */
  unsetField(field: string): ScheduleRecurringDayRule;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ScheduleRecurringDayRule;
   ...
   * @see #unsetField
   */
  removeField(field: string): ScheduleRecurringDayRule;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ScheduleRecurringDayRule;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ScheduleRecurringDayRule;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): ScheduleRecurringDayRule;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ScheduleRecurringDayRule;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ScheduleRecurringDayRule;

  mergeJson(json: any): ScheduleRecurringDayRule;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ScheduleRecurringDayRule;
   ...
   */
  sumObj(other: Obj, deep?: boolean): ScheduleRecurringDayRule;
   ...
   */
  singletonArray(): Array_Type<ScheduleRecurringDayRule>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<ScheduleRecurringDayRule> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ScheduleRecurringDayRule> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<ScheduleRecurringDayRule>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ScheduleRecurringDayRule> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, ScheduleRecurringDayRule> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ScheduleRecurringDayRule> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ScheduleRecurringDayRule>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ScheduleRecurringDayRule>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ScheduleRecurringDayRule;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ScheduleRecurringDayRule;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ScheduleRecurringDayRule;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ScheduleRecurringDayRule;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ScheduleRecurringDayRule;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ScheduleRecurringDayRule;
   ...
   * @see #fromString
   */
  static make(s: string): ScheduleRecurringDayRule | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ScheduleRecurringDayRule;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): ScheduleRecurringDayRule;
   ...
   */
  static cachedEmptyInst(): ScheduleRecurringDayRule;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<ScheduleRecurringDayRule> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): ScheduleRecurringDayRule;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<ScheduleRecurringDayRule>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<ScheduleRecurringDayRule>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<ScheduleRecurringDayRule> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ScheduleRecurringDayRule>> | null;
   ...
   */
  get(include?: string): ScheduleRecurringDayRule | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): ScheduleRecurringDayRule | null;
   ...
   */
  getMissing(spec: GetMissingSpec): ScheduleRecurringDayRule;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): ScheduleRecurringDayRule | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): ScheduleRecurringDayRule;
   ...
   * @see #toString
   */
  static fromString(s: string): ScheduleRecurringDayRule | null;
   ...
   */
  create(spec?: UpsertSpec): ScheduleRecurringDayRule | null;
   ...
   */
  static createBatch(objs: Array_Type<ScheduleRecurringDayRule>, spec?: UpsertSpec): ObjList<ScheduleRecurringDayRule> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<ScheduleRecurringDayRule>, spec?: CreateBatchObjStreamSpec): ObjList<ScheduleRecurringDayRule> | null;
   ...
   */
  update(srcObj?: ScheduleRecurringDayRule, spec?: UpsertSpec): ScheduleRecurringDayRule | null;
   ...
   */
  upsert(srcObj?: ScheduleRecurringDayRule, spec?: UpsertSpec): ScheduleRecurringDayRule | null;
   ...
   */
  merge(spec?: MergeSpec): ScheduleRecurringDayRule | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): ScheduleRecurringDayRule | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): ScheduleRecurringDayRule | null;
   ...
   */
  static updateBatch(objs: Array_Type<ScheduleRecurringDayRule>, srcObjs?: Array_Type<ScheduleRecurringDayRule>, spec?: UpsertSpec): ObjList<ScheduleRecurringDayRule> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<ScheduleRecurringDayRule> | null>, spec?: UpsertSpec): ObjList<ScheduleRecurringDayRule> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<ScheduleRecurringDayRule>, srcObjs?: Array_Type<ScheduleRecurringDayRule>, spec?: UpsertSpec): ObjList<ScheduleRecurringDayRule> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<ScheduleRecurringDayRule> | null>, spec?: UpsertSpec): ObjList<ScheduleRecurringDayRule> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<ScheduleRecurringDayRule>, spec?: TouchSpec): ObjList<ScheduleRecurringDayRule> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ScheduleRecurringDayRule>, spec?: MergeSpec): ObjList<ScheduleRecurringDayRule> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ScheduleRecurringDayRule>, mergeInclude: string, spec?: MergeSpec): ObjList<ScheduleRecurringDayRule> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<ScheduleRecurringDayRule> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ScheduleRecurringDayRule> | null;
   ...
   */
  static mergeAll(mergeObj: ScheduleRecurringDayRule, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: ScheduleRecurringDayRule, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<ScheduleRecurringDayRule>, spec?: UpsertSpec): ObjList<ScheduleRecurringDayRule> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<ScheduleRecurringDayRule>, spec?: UpsertSpec): ObjList<ScheduleRecurringDayRule> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): ScheduleRecurringDayRule | null;
   ...
   */
  static beforeCreate(objs: Array_Type<ScheduleRecurringDayRule>): ObjList<ScheduleRecurringDayRule>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<ScheduleRecurringDayRule>): ObjList<ScheduleRecurringDayRule>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<ScheduleRecurringDayRule>): ObjList<ScheduleRecurringDayRule>;
   ...
   */
  static afterCreate(objs: Array_Type<ScheduleRecurringDayRule>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<ScheduleRecurringDayRule>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<ScheduleRecurringDayRule>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<ScheduleRecurringDayRule>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ScheduleRecurringDayRule>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): ScheduleRecurringDayRule | null;
   ...
   */
  withoutIdentity(): ScheduleRecurringDayRule | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<ScheduleRecurringDayRule>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: ScheduleRecurringDayRule, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<ScheduleRecurringDayRule>, callback?: λFunction<ScheduleRecurringDayRule | null, ScheduleRecurringDayRule | null>): ObjList<ScheduleRecurringDayRule>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<ScheduleRecurringDayRule>, callback?: λFunction<ScheduleRecurringDayRule | null, ScheduleRecurringDayRule | null>): Array_Type<ObjError> | null;
