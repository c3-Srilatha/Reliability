// TypeScript definitions for the C3 type ScheduleExceptionDatetimeWindow

/**
 * A window of time that may span multiple days associated to a schedule that overrides
 * and time calculated from the ScheduleRecurringDayRule or Holidays associated to a schedule
 * Initial use is exceptions to standard daily time schedule defined by
 * rules set up in scheduleRecurringDayRule.
 * 00:00 to 00:00 on the same date implies no hours
 * 00:00 to 00:00 the next day implies all day
 * Business Key: Schedule+reason+non overlapping windows of time
 *
 * @remarks this represents a value passed to a method that expects an instance of ScheduleExceptionDatetimeWindow
 */
declare interface IScheduleExceptionDatetimeWindow {
  ...
  /**
   * why is this time window is an exception to a standard calendar?
   */
  exceptionReason?: string;

  /**
   * Start date and time of day this exception begins, inclusive
   * Typical use is work hours start time for a day
   */
  startDatetime: DateTime | Date | string;

  /**
   * End date and time of day this exception ends, exclusive
   * 00:00 start and end time on the same day implies no time for the day
   */
  endDatetime: DateTime | Date | string;

  /**
   * FK references FROM parents
   * Schedule this date is an exception to
   */
  scheduleCalendar: IScheduleCalendar;
}
 ...
 * Business Key: Schedule+reason+non overlapping windows of time
 *
 * @remarks this represents a made instance of ScheduleExceptionDatetimeWindow
 */
declare class ScheduleExceptionDatetimeWindow extends Obj  {
   ...
   */
  readonly id: string;
  withId(id: string): ScheduleExceptionDatetimeWindow;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ScheduleExceptionDatetimeWindow;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): ScheduleExceptionDatetimeWindow;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): ScheduleExceptionDatetimeWindow;
  ...
  withVersion(version: number | null): ScheduleExceptionDatetimeWindow;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): ScheduleExceptionDatetimeWindow;

  /**
   * why is this time window is an exception to a standard calendar?
   */
  readonly exceptionReason?: string;
  withExceptionReason(exceptionReason: string | null): ScheduleExceptionDatetimeWindow;
  ...
  withStartDatetime(startDatetime: DateTime | Date | string): ScheduleExceptionDatetimeWindow;
  ...
  withEndDatetime(endDatetime: DateTime | Date | string): ScheduleExceptionDatetimeWindow;

  /**
   * FK references FROM parents
   * Schedule this date is an exception to
   */
  readonly scheduleCalendar: ScheduleCalendar;
  withScheduleCalendar(scheduleCalendar: IScheduleCalendar): ScheduleExceptionDatetimeWindow;
   ...
   * @see #toJson
   */
  static fromJson(json: any): ScheduleExceptionDatetimeWindow | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): ScheduleExceptionDatetimeWindow | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): ScheduleExceptionDatetimeWindow | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): ScheduleExceptionDatetimeWindow | null;
   ...
   */
  replaceType(old: Type, new_: Type): ScheduleExceptionDatetimeWindow;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ScheduleExceptionDatetimeWindow;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ScheduleExceptionDatetimeWindow;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ScheduleExceptionDatetimeWindow>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ScheduleExceptionDatetimeWindow>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ScheduleExceptionDatetimeWindow;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ScheduleExceptionDatetimeWindow;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ScheduleExceptionDatetimeWindow;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ScheduleExceptionDatetimeWindow;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ScheduleExceptionDatetimeWindow;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ScheduleExceptionDatetimeWindow;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ScheduleExceptionDatetimeWindow;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ScheduleExceptionDatetimeWindow;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ScheduleExceptionDatetimeWindow;
   ...
   * @see #removeField
   */
  withoutField(field: string): ScheduleExceptionDatetimeWindow;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): ScheduleExceptionDatetimeWindow;
   ...
   */
  withoutFields(fields: Array_Type<string>): ScheduleExceptionDatetimeWindow;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): ScheduleExceptionDatetimeWindow;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ScheduleExceptionDatetimeWindow;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ScheduleExceptionDatetimeWindow;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ScheduleExceptionDatetimeWindow;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ScheduleExceptionDatetimeWindow;
   ...
   * @see #removeField
   */
  unsetField(field: string): ScheduleExceptionDatetimeWindow;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ScheduleExceptionDatetimeWindow;
   ...
   * @see #unsetField
   */
  removeField(field: string): ScheduleExceptionDatetimeWindow;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ScheduleExceptionDatetimeWindow;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ScheduleExceptionDatetimeWindow;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): ScheduleExceptionDatetimeWindow;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ScheduleExceptionDatetimeWindow;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ScheduleExceptionDatetimeWindow;

  mergeJson(json: any): ScheduleExceptionDatetimeWindow;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ScheduleExceptionDatetimeWindow;
   ...
   */
  sumObj(other: Obj, deep?: boolean): ScheduleExceptionDatetimeWindow;
   ...
   */
  singletonArray(): Array_Type<ScheduleExceptionDatetimeWindow>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<ScheduleExceptionDatetimeWindow> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ScheduleExceptionDatetimeWindow> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<ScheduleExceptionDatetimeWindow>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ScheduleExceptionDatetimeWindow> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, ScheduleExceptionDatetimeWindow> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ScheduleExceptionDatetimeWindow> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ScheduleExceptionDatetimeWindow>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ScheduleExceptionDatetimeWindow>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ScheduleExceptionDatetimeWindow;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ScheduleExceptionDatetimeWindow;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ScheduleExceptionDatetimeWindow;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ScheduleExceptionDatetimeWindow;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ScheduleExceptionDatetimeWindow;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ScheduleExceptionDatetimeWindow;
   ...
   * @see #fromString
   */
  static make(s: string): ScheduleExceptionDatetimeWindow | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ScheduleExceptionDatetimeWindow;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): ScheduleExceptionDatetimeWindow;
   ...
   */
  static cachedEmptyInst(): ScheduleExceptionDatetimeWindow;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<ScheduleExceptionDatetimeWindow> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): ScheduleExceptionDatetimeWindow;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<ScheduleExceptionDatetimeWindow>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<ScheduleExceptionDatetimeWindow>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<ScheduleExceptionDatetimeWindow> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ScheduleExceptionDatetimeWindow>> | null;
   ...
   */
  get(include?: string): ScheduleExceptionDatetimeWindow | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): ScheduleExceptionDatetimeWindow | null;
   ...
   */
  getMissing(spec: GetMissingSpec): ScheduleExceptionDatetimeWindow;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): ScheduleExceptionDatetimeWindow | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): ScheduleExceptionDatetimeWindow;
   ...
   * @see #toString
   */
  static fromString(s: string): ScheduleExceptionDatetimeWindow | null;
   ...
   */
  create(spec?: UpsertSpec): ScheduleExceptionDatetimeWindow | null;
   ...
   */
  static createBatch(objs: Array_Type<ScheduleExceptionDatetimeWindow>, spec?: UpsertSpec): ObjList<ScheduleExceptionDatetimeWindow> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<ScheduleExceptionDatetimeWindow>, spec?: CreateBatchObjStreamSpec): ObjList<ScheduleExceptionDatetimeWindow> | null;
   ...
   */
  update(srcObj?: ScheduleExceptionDatetimeWindow, spec?: UpsertSpec): ScheduleExceptionDatetimeWindow | null;
   ...
   */
  upsert(srcObj?: ScheduleExceptionDatetimeWindow, spec?: UpsertSpec): ScheduleExceptionDatetimeWindow | null;
   ...
   */
  merge(spec?: MergeSpec): ScheduleExceptionDatetimeWindow | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): ScheduleExceptionDatetimeWindow | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): ScheduleExceptionDatetimeWindow | null;
   ...
   */
  static updateBatch(objs: Array_Type<ScheduleExceptionDatetimeWindow>, srcObjs?: Array_Type<ScheduleExceptionDatetimeWindow>, spec?: UpsertSpec): ObjList<ScheduleExceptionDatetimeWindow> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<ScheduleExceptionDatetimeWindow> | null>, spec?: UpsertSpec): ObjList<ScheduleExceptionDatetimeWindow> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<ScheduleExceptionDatetimeWindow>, srcObjs?: Array_Type<ScheduleExceptionDatetimeWindow>, spec?: UpsertSpec): ObjList<ScheduleExceptionDatetimeWindow> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<ScheduleExceptionDatetimeWindow> | null>, spec?: UpsertSpec): ObjList<ScheduleExceptionDatetimeWindow> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<ScheduleExceptionDatetimeWindow>, spec?: TouchSpec): ObjList<ScheduleExceptionDatetimeWindow> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ScheduleExceptionDatetimeWindow>, spec?: MergeSpec): ObjList<ScheduleExceptionDatetimeWindow> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ScheduleExceptionDatetimeWindow>, mergeInclude: string, spec?: MergeSpec): ObjList<ScheduleExceptionDatetimeWindow> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<ScheduleExceptionDatetimeWindow> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ScheduleExceptionDatetimeWindow> | null;
   ...
   */
  static mergeAll(mergeObj: ScheduleExceptionDatetimeWindow, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: ScheduleExceptionDatetimeWindow, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<ScheduleExceptionDatetimeWindow>, spec?: UpsertSpec): ObjList<ScheduleExceptionDatetimeWindow> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<ScheduleExceptionDatetimeWindow>, spec?: UpsertSpec): ObjList<ScheduleExceptionDatetimeWindow> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): ScheduleExceptionDatetimeWindow | null;
   ...
   */
  static beforeCreate(objs: Array_Type<ScheduleExceptionDatetimeWindow>): ObjList<ScheduleExceptionDatetimeWindow>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<ScheduleExceptionDatetimeWindow>): ObjList<ScheduleExceptionDatetimeWindow>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<ScheduleExceptionDatetimeWindow>): ObjList<ScheduleExceptionDatetimeWindow>;
   ...
   */
  static afterCreate(objs: Array_Type<ScheduleExceptionDatetimeWindow>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<ScheduleExceptionDatetimeWindow>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<ScheduleExceptionDatetimeWindow>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<ScheduleExceptionDatetimeWindow>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ScheduleExceptionDatetimeWindow>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): ScheduleExceptionDatetimeWindow | null;
   ...
   */
  withoutIdentity(): ScheduleExceptionDatetimeWindow | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<ScheduleExceptionDatetimeWindow>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: ScheduleExceptionDatetimeWindow, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<ScheduleExceptionDatetimeWindow>, callback?: λFunction<ScheduleExceptionDatetimeWindow | null, ScheduleExceptionDatetimeWindow | null>): ObjList<ScheduleExceptionDatetimeWindow>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<ScheduleExceptionDatetimeWindow>, callback?: λFunction<ScheduleExceptionDatetimeWindow | null, ScheduleExceptionDatetimeWindow | null>): Array_Type<ObjError> | null;
