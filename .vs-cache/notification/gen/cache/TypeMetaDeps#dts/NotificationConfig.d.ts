...
/**
 * This type defines configuration for notifications.
 *
...
declare interface INotificationConfig {
  ...
  /**
   * The email subject for batch notifications
   */
  batchSubject?: string;
...
declare class NotificationConfig extends Obj  {
   ...
   */
  static allCached(): Stream<NotificationConfig> | null;
   ...
   */
  static find(filter?: string): Stream<NotificationConfig> | null;
   ...
   *         Otherwise no population will be performed.
   */
  static findBy(field: string, value: any): Stream<NotificationConfig> | null;
