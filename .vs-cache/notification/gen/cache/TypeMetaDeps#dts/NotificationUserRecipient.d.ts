// TypeScript definitions for the C3 type NotificationUserRecipient

/**
 * A type for user as recipient.
 *
 * @remarks this represents a value passed to a method that expects an instance of NotificationUserRecipient
 */
declare interface INotificationUserRecipient {
   ...
   */
  preferences?: Array_Type<NotificationCategoryPreference> | Array<INotificationCategoryPreference>;

  /**
   * Count of notifications that have not been sent
   */
  unsentNotificationCount?: number;

  /**
   * The notification histories for the current recipient
   */
  notifications?: Array_Type<NotificationHistory> | Array<INotificationHistory>;

  /**
   * Unsent notification histories for the current recipient
   */
  unsentNotifications?: Array_Type<NotificationHistory> | Array<INotificationHistory>;

  /**
   * The next time a batch notification will be sent out for the current recipient
   */
  nextRunTime?: DateTime | Date | string;
 ...
 * A type for user as recipient.
 *
 * @remarks this represents a made instance of NotificationUserRecipient
 */
declare class NotificationUserRecipient extends Obj  {
  ...
  withTypeIdent(typeIdent: string | null): NotificationUserRecipient;
   ...
   */
  readonly id: string;
  withId(id: string): NotificationUserRecipient;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): NotificationUserRecipient;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): NotificationUserRecipient;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): NotificationUserRecipient;
  ...
  withVersion(version: number | null): NotificationUserRecipient;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): NotificationUserRecipient;

  /**
   * Email address to notify user
   */
  readonly email?: string;
  withEmail(email: string | null): NotificationUserRecipient;

  /**
   * Recipient's phone number
   */
  readonly phoneNumber?: string;
  withPhoneNumber(phoneNumber: string | null): NotificationUserRecipient;

  /**
   * How often to receive emails in batch mode
   * Unit: number of minutes
   */
  readonly batchPeriod?: number;
  withBatchPeriod(batchPeriod: number | null): NotificationUserRecipient;

  /**
   * Flag to indicate whether the notification should be in batch or not
   */
  readonly isBatch?: boolean;
  withIsBatch(isBatch: boolean): NotificationUserRecipient;

  /**
   * Current recipient's preferences in different types
   */
  readonly preferences?: Array_Type<NotificationCategoryPreference>;
  withPreferences(preferences: Array_Type<NotificationCategoryPreference> | Array<INotificationCategoryPreference> | null): NotificationUserRecipient;

  /**
   * Count of notifications that have not been sent
   */
  readonly unsentNotificationCount?: number;
  withUnsentNotificationCount(unsentNotificationCount: number | null): NotificationUserRecipient;

  /**
   * The notification histories for the current recipient
   */
  readonly notifications?: Array_Type<NotificationHistory>;
  withNotifications(notifications: Array_Type<NotificationHistory> | Array<INotificationHistory> | null): NotificationUserRecipient;

  /**
   * Unsent notification histories for the current recipient
   */
  readonly unsentNotifications?: Array_Type<NotificationHistory>;
  withUnsentNotifications(unsentNotifications: Array_Type<NotificationHistory> | Array<INotificationHistory> | null): NotificationUserRecipient;

  /**
   * The next time a batch notification will be sent out for the current recipient
   */
  readonly nextRunTime?: DateTime;
  withNextRunTime(nextRunTime: DateTime | Date | string | null): NotificationUserRecipient;

  /**
   * Current user as the recipient
   */
  readonly user: User;
  withUser(user: IUser): NotificationUserRecipient;
   ...
   * @see #toJson
   */
  static fromJson(json: any): NotificationUserRecipient | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): NotificationUserRecipient | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): NotificationUserRecipient | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): NotificationUserRecipient | null;
   ...
   */
  replaceType(old: Type, new_: Type): NotificationUserRecipient;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): NotificationUserRecipient;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): NotificationUserRecipient;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<NotificationUserRecipient>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<NotificationUserRecipient>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): NotificationUserRecipient;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): NotificationUserRecipient;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): NotificationUserRecipient;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): NotificationUserRecipient;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): NotificationUserRecipient;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): NotificationUserRecipient;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): NotificationUserRecipient;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): NotificationUserRecipient;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): NotificationUserRecipient;
   ...
   * @see #removeField
   */
  withoutField(field: string): NotificationUserRecipient;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): NotificationUserRecipient;
   ...
   */
  withoutFields(fields: Array_Type<string>): NotificationUserRecipient;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): NotificationUserRecipient;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): NotificationUserRecipient;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): NotificationUserRecipient;
   ...
   * @see #unsetField
   */
  defaultField(field: string): NotificationUserRecipient;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): NotificationUserRecipient;
   ...
   * @see #removeField
   */
  unsetField(field: string): NotificationUserRecipient;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): NotificationUserRecipient;
   ...
   * @see #unsetField
   */
  removeField(field: string): NotificationUserRecipient;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): NotificationUserRecipient;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): NotificationUserRecipient;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): NotificationUserRecipient;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): NotificationUserRecipient;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): NotificationUserRecipient;

  mergeJson(json: any): NotificationUserRecipient;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): NotificationUserRecipient;
   ...
   */
  sumObj(other: Obj, deep?: boolean): NotificationUserRecipient;
   ...
   */
  singletonArray(): Array_Type<NotificationUserRecipient>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<NotificationUserRecipient> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<NotificationUserRecipient> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<NotificationUserRecipient>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<NotificationUserRecipient> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, NotificationUserRecipient> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, NotificationUserRecipient> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<NotificationUserRecipient>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<NotificationUserRecipient>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): NotificationUserRecipient;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): NotificationUserRecipient;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): NotificationUserRecipient;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): NotificationUserRecipient;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): NotificationUserRecipient;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): NotificationUserRecipient;
   ...
   * @see #fromString
   */
  static make(s: string): NotificationUserRecipient | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): NotificationUserRecipient;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): NotificationUserRecipient;
   ...
   */
  static cachedEmptyInst(): NotificationUserRecipient;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<NotificationUserRecipient> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): NotificationUserRecipient;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<NotificationUserRecipient>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<NotificationUserRecipient>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<NotificationUserRecipient> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<NotificationUserRecipient>> | null;
   ...
   */
  get(include?: string): NotificationUserRecipient | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): NotificationUserRecipient | null;
   ...
   */
  getMissing(spec: GetMissingSpec): NotificationUserRecipient;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): NotificationUserRecipient | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): NotificationUserRecipient;
   ...
   * @see #toString
   */
  static fromString(s: string): NotificationUserRecipient | null;
   ...
   */
  create(spec?: UpsertSpec): NotificationUserRecipient | null;
   ...
   */
  static createBatch(objs: Array_Type<NotificationUserRecipient>, spec?: UpsertSpec): ObjList<NotificationUserRecipient> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<NotificationUserRecipient>, spec?: CreateBatchObjStreamSpec): ObjList<NotificationUserRecipient> | null;
   ...
   */
  update(srcObj?: NotificationUserRecipient, spec?: UpsertSpec): NotificationUserRecipient | null;
   ...
   */
  upsert(srcObj?: NotificationUserRecipient, spec?: UpsertSpec): NotificationUserRecipient | null;
   ...
   */
  merge(spec?: MergeSpec): NotificationUserRecipient | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): NotificationUserRecipient | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): NotificationUserRecipient | null;
   ...
   */
  static updateBatch(objs: Array_Type<NotificationUserRecipient>, srcObjs?: Array_Type<NotificationUserRecipient>, spec?: UpsertSpec): ObjList<NotificationUserRecipient> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<NotificationUserRecipient> | null>, spec?: UpsertSpec): ObjList<NotificationUserRecipient> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<NotificationUserRecipient>, srcObjs?: Array_Type<NotificationUserRecipient>, spec?: UpsertSpec): ObjList<NotificationUserRecipient> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<NotificationUserRecipient> | null>, spec?: UpsertSpec): ObjList<NotificationUserRecipient> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<NotificationUserRecipient>, spec?: TouchSpec): ObjList<NotificationUserRecipient> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<NotificationUserRecipient>, spec?: MergeSpec): ObjList<NotificationUserRecipient> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<NotificationUserRecipient>, mergeInclude: string, spec?: MergeSpec): ObjList<NotificationUserRecipient> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<NotificationUserRecipient> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<NotificationUserRecipient> | null;
   ...
   */
  static mergeAll(mergeObj: NotificationUserRecipient, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: NotificationUserRecipient, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<NotificationUserRecipient>, spec?: UpsertSpec): ObjList<NotificationUserRecipient> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<NotificationUserRecipient>, spec?: UpsertSpec): ObjList<NotificationUserRecipient> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): NotificationUserRecipient | null;
   ...
   */
  static beforeCreate(objs: Array_Type<NotificationUserRecipient>): ObjList<NotificationUserRecipient>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<NotificationUserRecipient>): ObjList<NotificationUserRecipient>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<NotificationUserRecipient>): ObjList<NotificationUserRecipient>;
   ...
   */
  static afterCreate(objs: Array_Type<NotificationUserRecipient>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<NotificationUserRecipient>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<NotificationUserRecipient>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<NotificationUserRecipient>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<NotificationUserRecipient>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): NotificationUserRecipient | null;
   ...
   */
  withoutIdentity(): NotificationUserRecipient | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<NotificationUserRecipient>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: NotificationUserRecipient, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<NotificationUserRecipient>, callback?: λFunction<NotificationUserRecipient | null, NotificationUserRecipient | null>): ObjList<NotificationUserRecipient>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<NotificationUserRecipient>, callback?: λFunction<NotificationUserRecipient | null, NotificationUserRecipient | null>): Array_Type<ObjError> | null;
   ...
   */
  scheduleNotification(spec: NotificationSpec): void;
   ...
   */
  static sendScheduledNotifications(): void;

  /**
   * Send a message to a group of users according to the preference setting
   * It will fetch NotificationUserRecipient for all the users and create NotificationUserRecipients if not found.
   * It will call NotificationUserRecipient.scheduleNotification iteratively.
   * @param users
   *          List of users to notify
   * @param spec
   *          Specification for the notification
   */
  static scheduleNotificationToUsers(users: Array_Type<User>, spec: NotificationSpec): void;
}
