// TypeScript definitions for the C3 type UiSdlFormReact

/**
 * The react component type of {@link UiSdlForm}.
 *
 * @remarks this represents a value passed to a method that expects an instance of UiSdlFormReact
 */
declare interface IUiSdlFormReact {
 ...
 */
declare class UiSdlFormReact extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): UiSdlFormReact | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): UiSdlFormReact | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): UiSdlFormReact | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): UiSdlFormReact | null;
   ...
   */
  replaceType(old: Type, new_: Type): UiSdlFormReact;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlFormReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlFormReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlFormReact | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlFormReact | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): UiSdlFormReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlFormReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlFormReact;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): UiSdlFormReact;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): UiSdlFormReact;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): UiSdlFormReact;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): UiSdlFormReact;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): UiSdlFormReact;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): UiSdlFormReact;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): UiSdlFormReact;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): UiSdlFormReact;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): UiSdlFormReact;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): UiSdlFormReact;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): UiSdlFormReact;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): UiSdlFormReact;
   ...
   * @see #unsetField
   */
  defaultField(field: string): UiSdlFormReact;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): UiSdlFormReact;
   ...
   * @see #removeField
   */
  unsetField(field: string): UiSdlFormReact;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): UiSdlFormReact;
   ...
   * @see #unsetField
   */
  removeField(field: string): UiSdlFormReact;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): UiSdlFormReact;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): UiSdlFormReact;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): UiSdlFormReact;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): UiSdlFormReact;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): UiSdlFormReact;

  mergeJson(json: any | null): UiSdlFormReact;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): UiSdlFormReact;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): UiSdlFormReact;
   ...
   */
  singletonArray(): C3.Array<UiSdlFormReact | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<UiSdlFormReact | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<UiSdlFormReact | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<UiSdlFormReact | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<UiSdlFormReact | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, UiSdlFormReact | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, UiSdlFormReact | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<UiSdlFormReact | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<UiSdlFormReact | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): UiSdlFormReact;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): UiSdlFormReact;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): UiSdlFormReact;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): UiSdlFormReact;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): UiSdlFormReact;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): UiSdlFormReact;
   ...
   * @see #fromString
   */
  static make(s: string | null): UiSdlFormReact | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): UiSdlFormReact;
   ...
   */
  static cachedEmptyInst(): UiSdlFormReact;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<UiSdlFormReact>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): UiSdlFormReact;
   ...
   */
  static render(props?: UiSdlFormReact | null): void;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<UiSdlFormReact | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<UiSdlFormReact | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<UiSdlFormReact | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<UiSdlFormReact | null> | null>;
   ...
   */
  dependencies(): MetadataDeps<UiSdlFormReact | null>;

  save(subPath?: string | null, contentType?: string | null): UiSdlFormReact;
  ...
  update(srcObj?: UiSdlFormReact | null, spec?: UpsertSpec | null): UiSdlFormReact | null;

  upsert(srcObj?: UiSdlFormReact | null, spec?: UpsertSpec | null): UiSdlFormReact | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): UiSdlFormReact | null;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string | null, failIfMissing?: boolean): UiSdlFormReact | null;
   ...
   */
  static doDataMerge(componentId: string, dataSpecFieldName: string, dataDestinationFieldName: string, props: UiSdlFormReact, state: UiSdlReduxState): UiSdlFormReact | null;
