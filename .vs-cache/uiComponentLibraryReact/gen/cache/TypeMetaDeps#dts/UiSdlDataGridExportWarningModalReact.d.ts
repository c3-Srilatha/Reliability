// TypeScript definitions for the C3 type UiSdlDataGridExportWarningModalReact

/**
 * The react component type of {@link UiSdlDataGridExportWarningModal}.
 *
 * @remarks this represents a value passed to a method that expects an instance of UiSdlDataGridExportWarningModalReact
 */
declare interface IUiSdlDataGridExportWarningModalReact {
   ...
   */
  uiDataGridComponentId?: string | null;
}
 ...
 */
declare class UiSdlDataGridExportWarningModalReact extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): UiSdlDataGridExportWarningModalReact | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): UiSdlDataGridExportWarningModalReact | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): UiSdlDataGridExportWarningModalReact | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): UiSdlDataGridExportWarningModalReact | null;
   ...
   */
  replaceType(old: Type, new_: Type): UiSdlDataGridExportWarningModalReact;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlDataGridExportWarningModalReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlDataGridExportWarningModalReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlDataGridExportWarningModalReact | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlDataGridExportWarningModalReact | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): UiSdlDataGridExportWarningModalReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlDataGridExportWarningModalReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlDataGridExportWarningModalReact;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): UiSdlDataGridExportWarningModalReact;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): UiSdlDataGridExportWarningModalReact;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): UiSdlDataGridExportWarningModalReact;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): UiSdlDataGridExportWarningModalReact;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): UiSdlDataGridExportWarningModalReact;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): UiSdlDataGridExportWarningModalReact;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): UiSdlDataGridExportWarningModalReact;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): UiSdlDataGridExportWarningModalReact;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): UiSdlDataGridExportWarningModalReact;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): UiSdlDataGridExportWarningModalReact;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): UiSdlDataGridExportWarningModalReact;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): UiSdlDataGridExportWarningModalReact;
   ...
   * @see #unsetField
   */
  defaultField(field: string): UiSdlDataGridExportWarningModalReact;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): UiSdlDataGridExportWarningModalReact;
   ...
   * @see #removeField
   */
  unsetField(field: string): UiSdlDataGridExportWarningModalReact;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): UiSdlDataGridExportWarningModalReact;
   ...
   * @see #unsetField
   */
  removeField(field: string): UiSdlDataGridExportWarningModalReact;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): UiSdlDataGridExportWarningModalReact;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): UiSdlDataGridExportWarningModalReact;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): UiSdlDataGridExportWarningModalReact;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): UiSdlDataGridExportWarningModalReact;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): UiSdlDataGridExportWarningModalReact;

  mergeJson(json: any | null): UiSdlDataGridExportWarningModalReact;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): UiSdlDataGridExportWarningModalReact;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): UiSdlDataGridExportWarningModalReact;
   ...
   */
  singletonArray(): C3.Array<UiSdlDataGridExportWarningModalReact | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<UiSdlDataGridExportWarningModalReact | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<UiSdlDataGridExportWarningModalReact | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<UiSdlDataGridExportWarningModalReact | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<UiSdlDataGridExportWarningModalReact | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, UiSdlDataGridExportWarningModalReact | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, UiSdlDataGridExportWarningModalReact | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<UiSdlDataGridExportWarningModalReact | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<UiSdlDataGridExportWarningModalReact | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): UiSdlDataGridExportWarningModalReact;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): UiSdlDataGridExportWarningModalReact;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): UiSdlDataGridExportWarningModalReact;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): UiSdlDataGridExportWarningModalReact;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): UiSdlDataGridExportWarningModalReact;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): UiSdlDataGridExportWarningModalReact;
   ...
   * @see #fromString
   */
  static make(s: string | null): UiSdlDataGridExportWarningModalReact | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): UiSdlDataGridExportWarningModalReact;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): UiSdlDataGridExportWarningModalReact;
   ...
   */
  static cachedEmptyInst(): UiSdlDataGridExportWarningModalReact;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<UiSdlDataGridExportWarningModalReact>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): UiSdlDataGridExportWarningModalReact;
   ...
   */
  static render(props?: UiSdlDataGridExportWarningModalReact | null): void;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<UiSdlDataGridExportWarningModalReact | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<UiSdlDataGridExportWarningModalReact | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<UiSdlDataGridExportWarningModalReact | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<UiSdlDataGridExportWarningModalReact | null> | null>;
   ...
   */
  dependencies(): MetadataDeps<UiSdlDataGridExportWarningModalReact | null>;

  save(subPath?: string | null, contentType?: string | null): UiSdlDataGridExportWarningModalReact;
  ...
  update(srcObj?: UiSdlDataGridExportWarningModalReact | null, spec?: UpsertSpec | null): UiSdlDataGridExportWarningModalReact | null;

  upsert(srcObj?: UiSdlDataGridExportWarningModalReact | null, spec?: UpsertSpec | null): UiSdlDataGridExportWarningModalReact | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): UiSdlDataGridExportWarningModalReact | null;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string | null, failIfMissing?: boolean): UiSdlDataGridExportWarningModalReact | null;
   ...
   */
  static doDataMerge(componentId: string, dataSpecFieldName: string, dataDestinationFieldName: string, props: UiSdlDataGridExportWarningModalReact, state: UiSdlReduxState): UiSdlDataGridExportWarningModalReact | null;
   ...
   */
  static setUiSdlDataGridComponentIdAction(id?: string | null, uiDataGridComponentId?: string | null): UiSdlUiDataGridComponentIdSetAction | null;
   ...
   * @returns A new Redux state.
   */
  static uiDataGridComponentIdSetEffect(state: UiSdlReduxState, action?: UiSdlUiDataGridComponentIdSetAction | null): UiSdlReduxState;
}
