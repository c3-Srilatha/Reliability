// TypeScript definitions for the C3 type UiSdlDataGridReact

/**
 * The react component type of {@link UiSdlDataGrid}.
 *
 * @remarks this represents a value passed to a method that expects an instance of UiSdlDataGridReact
 */
declare interface IUiSdlDataGridReact {
   ...
   */
  dataSpec?: IUiSdlDataGridDataSpec | null;
   ...
   */
  disableExportWarningModal?: boolean;

  /**
   * Pagination configuration options for the data grid.
   */
  paginationConfig?: IUiSdlDataGridPaginationConfig | null;
   ...
   */
  numberFormatSpec?: IUiSdlNumberParamKindFormatSpec | null;
   ...
   */
  paginationDataSkipSize?: number | null;
   ...
   */
  rowActionAlignment?: string | null;

  /**
   * Displays the nested/detail component in full width of the grid.
   */
  fullWidthNestedComponent?: boolean;
   ...
   */
  exportWarningRecordThreshold?: number | null;

  /**
   * Stores threshold for the row actions to collapse into a modal
   */
  rowActionsCollapseThreshold?: number | null;
   ...
   */
  exportData?: IUiSdlDataGridDataSpec | null;
   ...
   */
  headerMaxLinesWhenTruncated?: number | null;
   ...
   * The content will be accessible in a tooltip by hovering over the cell.
   */
  maxLinesWhenTruncated?: number | null;

  /**
   * Holds the data to be exported.
   */
  exportDataCollection?: C3.Array<Obj | null> | Array<IObj | null>;
   ...
   */
  userHasAcknowledgedExportWarning?: boolean;
   ...
   */
  columnsOrder?: C3.Map<string | null, number | null> | {[key: string | null]: number | null};

  /**
   * A flag that makes the {@link tableActions} always visible even if {@link multipleRowActions} is displayed.
   */
  tableActionsAlwaysVisible?: boolean;
}
 ...
 */
declare class UiSdlDataGridReact extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): UiSdlDataGridReact | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): UiSdlDataGridReact | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): UiSdlDataGridReact | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): UiSdlDataGridReact | null;
   ...
   */
  replaceType(old: Type, new_: Type): UiSdlDataGridReact;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlDataGridReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlDataGridReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlDataGridReact | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlDataGridReact | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): UiSdlDataGridReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlDataGridReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlDataGridReact;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): UiSdlDataGridReact;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): UiSdlDataGridReact;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): UiSdlDataGridReact;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): UiSdlDataGridReact;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): UiSdlDataGridReact;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): UiSdlDataGridReact;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): UiSdlDataGridReact;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): UiSdlDataGridReact;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): UiSdlDataGridReact;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): UiSdlDataGridReact;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): UiSdlDataGridReact;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): UiSdlDataGridReact;
   ...
   * @see #unsetField
   */
  defaultField(field: string): UiSdlDataGridReact;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): UiSdlDataGridReact;
   ...
   * @see #removeField
   */
  unsetField(field: string): UiSdlDataGridReact;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): UiSdlDataGridReact;
   ...
   * @see #unsetField
   */
  removeField(field: string): UiSdlDataGridReact;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): UiSdlDataGridReact;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): UiSdlDataGridReact;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): UiSdlDataGridReact;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): UiSdlDataGridReact;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): UiSdlDataGridReact;

  mergeJson(json: any | null): UiSdlDataGridReact;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): UiSdlDataGridReact;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): UiSdlDataGridReact;
   ...
   */
  singletonArray(): C3.Array<UiSdlDataGridReact | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<UiSdlDataGridReact | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<UiSdlDataGridReact | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<UiSdlDataGridReact | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<UiSdlDataGridReact | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, UiSdlDataGridReact | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, UiSdlDataGridReact | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<UiSdlDataGridReact | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<UiSdlDataGridReact | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): UiSdlDataGridReact;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): UiSdlDataGridReact;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): UiSdlDataGridReact;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): UiSdlDataGridReact;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): UiSdlDataGridReact;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): UiSdlDataGridReact;
   ...
   * @see #fromString
   */
  static make(s: string | null): UiSdlDataGridReact | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): UiSdlDataGridReact;
   ...
   */
  static cachedEmptyInst(): UiSdlDataGridReact;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<UiSdlDataGridReact>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): UiSdlDataGridReact;
   ...
   */
  static render(props?: UiSdlDataGridReact | null): void;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<UiSdlDataGridReact | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<UiSdlDataGridReact | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<UiSdlDataGridReact | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<UiSdlDataGridReact | null> | null>;
   ...
   */
  dependencies(): MetadataDeps<UiSdlDataGridReact | null>;

  save(subPath?: string | null, contentType?: string | null): UiSdlDataGridReact;
  ...
  update(srcObj?: UiSdlDataGridReact | null, spec?: UpsertSpec | null): UiSdlDataGridReact | null;

  upsert(srcObj?: UiSdlDataGridReact | null, spec?: UpsertSpec | null): UiSdlDataGridReact | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): UiSdlDataGridReact | null;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string | null, failIfMissing?: boolean): UiSdlDataGridReact | null;
   ...
   */
  static doDataMerge(componentId: string, dataSpecFieldName: string, dataDestinationFieldName: string, props: UiSdlDataGridReact, state: UiSdlReduxState): UiSdlDataGridReact | null;
   ...
   * - meta.dataSourceId {string} The `id` of the data source to which the items belong.
   */
  static changeScrollAction(id?: string | null, paginationDataSkipSize: number, pageSize: number): UiSdlScrollChangeAction | null;
   ...
   *        Id of the component.
   */
  static unmountedAction(id?: string | null): UiSdlDataGridUnmountedAction | null;
   ...
   * - meta.dataSourceId {string} The `id` of the data source to which the items belong
   */
  static changeSortAction(id?: string | null, field?: string | null, descending?: boolean, sortNullsLast?: boolean): UiSdlSortChangeAction | null;
   ...
   * - payload.descending {boolean} True to sort in descending order, false to sort in ascending order.
   */
  changeSortColumnAction(id?: string | null, field?: string | null, descending?: boolean): UiSdlSortColumnChangeAction | null;
   ...
   */
  static changePaginationSkipSizeDataOffsetAction(id?: string | null, paginationDataSkipSize: number, dataOffset: number): UiSdlPaginationSkipSizeDataOffsetChangeAction | null;
   ...
   */
  static changePageAction(id?: string | null, event?: any, ownProps?: any): UiSdlPageChangeAction | null;
   ...
   */
  static countDataAction(id?: string | null): UiSdlDataCountAction | null;
   ...
   */
  static checkboxSelectAllDataAction(id?: string | null): UiSdlCheckboxSelectAllDataAction | null;
   ...
   */
  static checkboxClearAllSelectedIdsAction(id?: string | null): UiSdlCheckboxClearAllSelectedIdsAction | null;
   ...
   */
  static loadExportDataAction(id?: string | null): UiSdlExportDataLoadAction | null;
   ...
   * @returns An `EXPORT_DATA_LOAD` action for this instance.
   */
  static loadCustomExportDataAction(id?: string | null, c3function?: string | null, c3type?: string | null, c3arguments?: any | null): UiSdlCustomExportDataLoadAction | null;
   ...
   */
  static getExportDataActions(componentId?: string | null, c3type?: string | null, c3function?: string | null, customArguments?: any | null, exportDataSourceId?: string | null, contextVars?: C3.Map<string | null, UiSdlDynamicValueSpecParam | null>, dataTransforms?: C3.Array<string | null>): UiSdlActionsObservable | null;
   ...
   */
  static clearExportDataAction(id?: string | null): UiSdlExportDataClearAction | null;
   ...
   */
  static clickColumnHeaderAction(id?: string | null, columField?: string | null): UiSdlClickColumnHeaderAction | null;
   ...
   * - payload.componentId {string} id of the grid that originated the export.
   */
  static acknowledgeWarningModalAction(id?: string | null): UiSdlWarningModalAcknowledgeAction | null;
   ...
   * - payload.componentId {string} id of the grid that originated the export.
   */
  static resetWarningModalAction(id?: string | null): UiSdlWarningModalResetAction | null;
   ...
   * @returns A new Redux state.
   */
  static syncExportArgumentsAction(id?: string | null): UiSdlExportArgumentsSyncAction | null;
   ...
   * @returns A new Redux state.
   */
  static acknowledgeWarningModalEffect(state?: UiSdlReduxState | null, action?: UiSdlWarningModalAcknowledgeAction | null): UiSdlReduxState | null;
   ...
   * @returns a new Redux state
   */
  static resetWarningModalEffect(state?: UiSdlReduxState | null, action?: UiSdlWarningModalResetAction | null): UiSdlReduxState | null;
   ...
   * @returns a new Redux state
   */
  static sortColumnChangeEffect(state?: UiSdlReduxState | null, action?: UiSdlSortColumnChangeAction | null): UiSdlReduxState | null;
   ...
   * @returns A new Redux state.
   */
  static pageChangeEffect(state?: UiSdlReduxState | null, action?: UiSdlPageChangeAction | null): UiSdlReduxState | null;
   ...
   * @returns A new Redux state.
   */
  static paginationSkipSizeDataOffsetChangeEffect(state?: UiSdlReduxState | null, action?: UiSdlPaginationSkipSizeDataOffsetChangeAction | null): UiSdlReduxState | null;
   ...
   * @returns A new Redux state.
   */
  static exportArgumentsSyncReducer(state?: UiSdlReduxState | null, action?: UiSdlExportArgumentsSyncAction | null): UiSdlReduxState | null;
   ...
   * @returns A new Redux state.
   */
  static checkboxSetAllSelectedIdsEffect(state?: UiSdlReduxState | null, action?: UiSdlCheckboxSetAllSelectedIdsAction | null): UiSdlReduxState | null;
   ...
   * @returns A new Redux state.
   */
  static checkboxClearAllSelectedIdsEffect(state?: UiSdlReduxState | null, action?: UiSdlCheckboxClearAllSelectedIdsAction | null): UiSdlReduxState | null;
   ...
   * @returns An Observable action stream.
   */
  static dataGridInitialRenderEpic(actionStream?: UiSdlActionsObservable | null, stateStream?: UiSdlStatesObservable | null): UiSdlActionsObservable | null;
   ...
   * @returns An Observable action stream.
   */
  static dataGridUnmountedEpic(actionStream?: UiSdlActionsObservable | null, stateStream?: UiSdlStatesObservable | null): UiSdlActionsObservable | null;
   ...
   * @returns An Observable action stream.
   */
  static loadExportDataEpic(actionStream?: UiSdlActionsObservable | null, stateStream?: UiSdlStatesObservable | null): UiSdlActionsObservable | null;
   ...
   * @returns An Observable action stream.
   */
  static loadCustomExportDataEpic(actionStream?: UiSdlActionsObservable | null, stateStream?: UiSdlStatesObservable | null): UiSdlActionsObservable | null;
   ...
   * @returns An Observable action stream.
   */
  static clearExportDataEpic(actionStream?: UiSdlActionsObservable | null, stateStream?: UiSdlStatesObservable | null): UiSdlActionsObservable | null;
   ...
   * @returns An Observable action stream.
   */
  static pageChangeEpic(actionStream?: UiSdlActionsObservable | null, stateStream?: UiSdlStatesObservable | null): UiSdlActionsObservable | null;
   ...
   * @returns An Observable action stream.
   */
  static checkboxSelectAllDataEpic(actionStream?: UiSdlActionsObservable | null, stateStream?: UiSdlStatesObservable | null): UiSdlActionsObservable | null;
   ...
   * @returns An Observable action stream.
   */
  static scrollChangeEpic(actionStream?: UiSdlActionsObservable | null, stateStream?: UiSdlStatesObservable | null): UiSdlActionsObservable | null;
   ...
   * @returns An Observable action stream.
   */
  static sortChangeEpic(actionStream?: UiSdlActionsObservable | null, stateStream?: UiSdlStatesObservable | null): UiSdlActionsObservable | null;
}
