// TypeScript definitions for the C3 type UiSdlMapReact

/**
 * The react component type of {@link UiSdlMap}.
 *
 * @remarks this represents a value passed to a method that expects an instance of UiSdlMapReact
 */
declare interface IUiSdlMapReact {
 ...
 */
declare class UiSdlMapReact extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): UiSdlMapReact | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): UiSdlMapReact | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): UiSdlMapReact | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): UiSdlMapReact | null;
   ...
   */
  replaceType(old: Type, new_: Type): UiSdlMapReact;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlMapReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlMapReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlMapReact | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlMapReact | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): UiSdlMapReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlMapReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlMapReact;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): UiSdlMapReact;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): UiSdlMapReact;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): UiSdlMapReact;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): UiSdlMapReact;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): UiSdlMapReact;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): UiSdlMapReact;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): UiSdlMapReact;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): UiSdlMapReact;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): UiSdlMapReact;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): UiSdlMapReact;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): UiSdlMapReact;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): UiSdlMapReact;
   ...
   * @see #unsetField
   */
  defaultField(field: string): UiSdlMapReact;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): UiSdlMapReact;
   ...
   * @see #removeField
   */
  unsetField(field: string): UiSdlMapReact;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): UiSdlMapReact;
   ...
   * @see #unsetField
   */
  removeField(field: string): UiSdlMapReact;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): UiSdlMapReact;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): UiSdlMapReact;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): UiSdlMapReact;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): UiSdlMapReact;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): UiSdlMapReact;

  mergeJson(json: any | null): UiSdlMapReact;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): UiSdlMapReact;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): UiSdlMapReact;
   ...
   */
  singletonArray(): C3.Array<UiSdlMapReact | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<UiSdlMapReact | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<UiSdlMapReact | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<UiSdlMapReact | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<UiSdlMapReact | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, UiSdlMapReact | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, UiSdlMapReact | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<UiSdlMapReact | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<UiSdlMapReact | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): UiSdlMapReact;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): UiSdlMapReact;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): UiSdlMapReact;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): UiSdlMapReact;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): UiSdlMapReact;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): UiSdlMapReact;
   ...
   * @see #fromString
   */
  static make(s: string | null): UiSdlMapReact | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): UiSdlMapReact;
   ...
   */
  static cachedEmptyInst(): UiSdlMapReact;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<UiSdlMapReact>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): UiSdlMapReact;
   ...
   */
  static render(props?: UiSdlMapReact | null): void;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<UiSdlMapReact | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<UiSdlMapReact | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<UiSdlMapReact | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<UiSdlMapReact | null> | null>;
   ...
   */
  dependencies(): MetadataDeps<UiSdlMapReact | null>;

  save(subPath?: string | null, contentType?: string | null): UiSdlMapReact;
  ...
  update(srcObj?: UiSdlMapReact | null, spec?: UpsertSpec | null): UiSdlMapReact | null;

  upsert(srcObj?: UiSdlMapReact | null, spec?: UpsertSpec | null): UiSdlMapReact | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): UiSdlMapReact | null;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string | null, failIfMissing?: boolean): UiSdlMapReact | null;
   ...
   */
  static doDataMerge(componentId: string, dataSpecFieldName: string, dataDestinationFieldName: string, props: UiSdlMapReact, state: UiSdlReduxState): UiSdlMapReact | null;
