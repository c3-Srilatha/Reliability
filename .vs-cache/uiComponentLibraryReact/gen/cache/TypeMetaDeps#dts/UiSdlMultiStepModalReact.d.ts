// TypeScript definitions for the C3 type UiSdlMultiStepModalReact

/**
 * The react component type of {@link UiSdlMultiStepModal}.
 *
 * @remarks this represents a value passed to a method that expects an instance of UiSdlMultiStepModalReact
 */
declare interface IUiSdlMultiStepModalReact {
 ...
 */
declare class UiSdlMultiStepModalReact extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): UiSdlMultiStepModalReact | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): UiSdlMultiStepModalReact | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): UiSdlMultiStepModalReact | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): UiSdlMultiStepModalReact | null;
   ...
   */
  replaceType(old: Type, new_: Type): UiSdlMultiStepModalReact;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlMultiStepModalReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlMultiStepModalReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlMultiStepModalReact | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlMultiStepModalReact | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): UiSdlMultiStepModalReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlMultiStepModalReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlMultiStepModalReact;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): UiSdlMultiStepModalReact;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): UiSdlMultiStepModalReact;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): UiSdlMultiStepModalReact;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): UiSdlMultiStepModalReact;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): UiSdlMultiStepModalReact;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): UiSdlMultiStepModalReact;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): UiSdlMultiStepModalReact;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): UiSdlMultiStepModalReact;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): UiSdlMultiStepModalReact;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): UiSdlMultiStepModalReact;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): UiSdlMultiStepModalReact;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): UiSdlMultiStepModalReact;
   ...
   * @see #unsetField
   */
  defaultField(field: string): UiSdlMultiStepModalReact;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): UiSdlMultiStepModalReact;
   ...
   * @see #removeField
   */
  unsetField(field: string): UiSdlMultiStepModalReact;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): UiSdlMultiStepModalReact;
   ...
   * @see #unsetField
   */
  removeField(field: string): UiSdlMultiStepModalReact;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): UiSdlMultiStepModalReact;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): UiSdlMultiStepModalReact;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): UiSdlMultiStepModalReact;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): UiSdlMultiStepModalReact;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): UiSdlMultiStepModalReact;

  mergeJson(json: any | null): UiSdlMultiStepModalReact;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): UiSdlMultiStepModalReact;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): UiSdlMultiStepModalReact;
   ...
   */
  singletonArray(): C3.Array<UiSdlMultiStepModalReact | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<UiSdlMultiStepModalReact | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<UiSdlMultiStepModalReact | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<UiSdlMultiStepModalReact | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<UiSdlMultiStepModalReact | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, UiSdlMultiStepModalReact | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, UiSdlMultiStepModalReact | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<UiSdlMultiStepModalReact | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<UiSdlMultiStepModalReact | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): UiSdlMultiStepModalReact;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): UiSdlMultiStepModalReact;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): UiSdlMultiStepModalReact;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): UiSdlMultiStepModalReact;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): UiSdlMultiStepModalReact;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): UiSdlMultiStepModalReact;
   ...
   * @see #fromString
   */
  static make(s: string | null): UiSdlMultiStepModalReact | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): UiSdlMultiStepModalReact;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): UiSdlMultiStepModalReact;
   ...
   */
  static cachedEmptyInst(): UiSdlMultiStepModalReact;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<UiSdlMultiStepModalReact>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): UiSdlMultiStepModalReact;
   ...
   */
  static render(props?: UiSdlMultiStepModalReact | null): void;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<UiSdlMultiStepModalReact | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<UiSdlMultiStepModalReact | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<UiSdlMultiStepModalReact | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<UiSdlMultiStepModalReact | null> | null>;
   ...
   */
  dependencies(): MetadataDeps<UiSdlMultiStepModalReact | null>;

  save(subPath?: string | null, contentType?: string | null): UiSdlMultiStepModalReact;
  ...
  update(srcObj?: UiSdlMultiStepModalReact | null, spec?: UpsertSpec | null): UiSdlMultiStepModalReact | null;

  upsert(srcObj?: UiSdlMultiStepModalReact | null, spec?: UpsertSpec | null): UiSdlMultiStepModalReact | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): UiSdlMultiStepModalReact | null;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string | null, failIfMissing?: boolean): UiSdlMultiStepModalReact | null;
   ...
   */
  static doDataMerge(componentId: string, dataSpecFieldName: string, dataDestinationFieldName: string, props: UiSdlMultiStepModalReact, state: UiSdlReduxState): UiSdlMultiStepModalReact | null;
   ...
   */
  static updateStepAction(id: string, index: number): UiSdlStepUpdateAction;
   ...
   * @returns A new Redux state.
   */
  static stepUpdateReducer(state: UiSdlReduxState, action: UiSdlStepUpdateAction): UiSdlReduxState;
}
