// TypeScript definitions for the C3 type UiSdlCategoricalLineBarChartReact

/**
 * The react component type of {@link UiSdlCategoricalLineBarChart}.
 *
 * @remarks this represents a value passed to a method that expects an instance of UiSdlCategoricalLineBarChartReact
 */
declare interface IUiSdlCategoricalLineBarChartReact {
 ...
 */
declare class UiSdlCategoricalLineBarChartReact extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): UiSdlCategoricalLineBarChartReact | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): UiSdlCategoricalLineBarChartReact | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): UiSdlCategoricalLineBarChartReact | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): UiSdlCategoricalLineBarChartReact | null;
   ...
   */
  replaceType(old: Type, new_: Type): UiSdlCategoricalLineBarChartReact;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlCategoricalLineBarChartReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlCategoricalLineBarChartReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlCategoricalLineBarChartReact | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlCategoricalLineBarChartReact | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): UiSdlCategoricalLineBarChartReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlCategoricalLineBarChartReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlCategoricalLineBarChartReact;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): UiSdlCategoricalLineBarChartReact;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): UiSdlCategoricalLineBarChartReact;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): UiSdlCategoricalLineBarChartReact;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): UiSdlCategoricalLineBarChartReact;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): UiSdlCategoricalLineBarChartReact;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): UiSdlCategoricalLineBarChartReact;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): UiSdlCategoricalLineBarChartReact;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): UiSdlCategoricalLineBarChartReact;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): UiSdlCategoricalLineBarChartReact;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): UiSdlCategoricalLineBarChartReact;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): UiSdlCategoricalLineBarChartReact;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): UiSdlCategoricalLineBarChartReact;
   ...
   * @see #unsetField
   */
  defaultField(field: string): UiSdlCategoricalLineBarChartReact;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): UiSdlCategoricalLineBarChartReact;
   ...
   * @see #removeField
   */
  unsetField(field: string): UiSdlCategoricalLineBarChartReact;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): UiSdlCategoricalLineBarChartReact;
   ...
   * @see #unsetField
   */
  removeField(field: string): UiSdlCategoricalLineBarChartReact;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): UiSdlCategoricalLineBarChartReact;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): UiSdlCategoricalLineBarChartReact;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): UiSdlCategoricalLineBarChartReact;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): UiSdlCategoricalLineBarChartReact;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): UiSdlCategoricalLineBarChartReact;

  mergeJson(json: any | null): UiSdlCategoricalLineBarChartReact;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): UiSdlCategoricalLineBarChartReact;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): UiSdlCategoricalLineBarChartReact;
   ...
   */
  singletonArray(): C3.Array<UiSdlCategoricalLineBarChartReact | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<UiSdlCategoricalLineBarChartReact | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<UiSdlCategoricalLineBarChartReact | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<UiSdlCategoricalLineBarChartReact | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<UiSdlCategoricalLineBarChartReact | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, UiSdlCategoricalLineBarChartReact | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, UiSdlCategoricalLineBarChartReact | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<UiSdlCategoricalLineBarChartReact | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<UiSdlCategoricalLineBarChartReact | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): UiSdlCategoricalLineBarChartReact;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): UiSdlCategoricalLineBarChartReact;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): UiSdlCategoricalLineBarChartReact;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): UiSdlCategoricalLineBarChartReact;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): UiSdlCategoricalLineBarChartReact;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): UiSdlCategoricalLineBarChartReact;
   ...
   * @see #fromString
   */
  static make(s: string | null): UiSdlCategoricalLineBarChartReact | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): UiSdlCategoricalLineBarChartReact;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): UiSdlCategoricalLineBarChartReact;
   ...
   */
  static cachedEmptyInst(): UiSdlCategoricalLineBarChartReact;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<UiSdlCategoricalLineBarChartReact>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): UiSdlCategoricalLineBarChartReact;
   ...
   */
  static render(props?: UiSdlCategoricalLineBarChartReact | null): void;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<UiSdlCategoricalLineBarChartReact | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<UiSdlCategoricalLineBarChartReact | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<UiSdlCategoricalLineBarChartReact | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<UiSdlCategoricalLineBarChartReact | null> | null>;
   ...
   */
  dependencies(): MetadataDeps<UiSdlCategoricalLineBarChartReact | null>;

  save(subPath?: string | null, contentType?: string | null): UiSdlCategoricalLineBarChartReact;
  ...
  update(srcObj?: UiSdlCategoricalLineBarChartReact | null, spec?: UpsertSpec | null): UiSdlCategoricalLineBarChartReact | null;

  upsert(srcObj?: UiSdlCategoricalLineBarChartReact | null, spec?: UpsertSpec | null): UiSdlCategoricalLineBarChartReact | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): UiSdlCategoricalLineBarChartReact | null;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string | null, failIfMissing?: boolean): UiSdlCategoricalLineBarChartReact | null;
   ...
   */
  static doDataMerge(componentId: string, dataSpecFieldName: string, dataDestinationFieldName: string, props: UiSdlCategoricalLineBarChartReact, state: UiSdlReduxState): UiSdlCategoricalLineBarChartReact | null;
