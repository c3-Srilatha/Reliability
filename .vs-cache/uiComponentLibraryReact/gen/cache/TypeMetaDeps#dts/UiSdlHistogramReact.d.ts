// TypeScript definitions for the C3 type UiSdlHistogramReact

/**
 * The react component type of {@link UiSdlHistogram}.
 *
 * @remarks this represents a value passed to a method that expects an instance of UiSdlHistogramReact
 */
declare interface IUiSdlHistogramReact {
   ...
   */
  dataSpec?: IUiSdlHistogramDataSpec | null;
   ...
   */
  data?: IUiSdlChartEChartConfig | null;
   ...
   * X-axis config type.
   */
  xAxis?: IUiSdlHistogramXAxisConfig | null;

  /**
   * Y-axis config type.
   */
  yAxis?: IUiSdlHistogramYAxisConfig | null;
 ...
 */
declare class UiSdlHistogramReact extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): UiSdlHistogramReact | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): UiSdlHistogramReact | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): UiSdlHistogramReact | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): UiSdlHistogramReact | null;
   ...
   */
  replaceType(old: Type, new_: Type): UiSdlHistogramReact;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlHistogramReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlHistogramReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlHistogramReact | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlHistogramReact | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): UiSdlHistogramReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlHistogramReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlHistogramReact;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): UiSdlHistogramReact;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): UiSdlHistogramReact;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): UiSdlHistogramReact;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): UiSdlHistogramReact;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): UiSdlHistogramReact;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): UiSdlHistogramReact;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): UiSdlHistogramReact;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): UiSdlHistogramReact;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): UiSdlHistogramReact;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): UiSdlHistogramReact;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): UiSdlHistogramReact;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): UiSdlHistogramReact;
   ...
   * @see #unsetField
   */
  defaultField(field: string): UiSdlHistogramReact;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): UiSdlHistogramReact;
   ...
   * @see #removeField
   */
  unsetField(field: string): UiSdlHistogramReact;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): UiSdlHistogramReact;
   ...
   * @see #unsetField
   */
  removeField(field: string): UiSdlHistogramReact;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): UiSdlHistogramReact;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): UiSdlHistogramReact;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): UiSdlHistogramReact;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): UiSdlHistogramReact;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): UiSdlHistogramReact;

  mergeJson(json: any | null): UiSdlHistogramReact;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): UiSdlHistogramReact;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): UiSdlHistogramReact;
   ...
   */
  singletonArray(): C3.Array<UiSdlHistogramReact | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<UiSdlHistogramReact | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<UiSdlHistogramReact | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<UiSdlHistogramReact | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<UiSdlHistogramReact | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, UiSdlHistogramReact | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, UiSdlHistogramReact | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<UiSdlHistogramReact | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<UiSdlHistogramReact | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): UiSdlHistogramReact;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): UiSdlHistogramReact;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): UiSdlHistogramReact;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): UiSdlHistogramReact;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): UiSdlHistogramReact;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): UiSdlHistogramReact;
   ...
   * @see #fromString
   */
  static make(s: string | null): UiSdlHistogramReact | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): UiSdlHistogramReact;
   ...
   */
  static cachedEmptyInst(): UiSdlHistogramReact;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<UiSdlHistogramReact>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): UiSdlHistogramReact;
   ...
   */
  static render(props?: UiSdlHistogramReact | null): void;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<UiSdlHistogramReact | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<UiSdlHistogramReact | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<UiSdlHistogramReact | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<UiSdlHistogramReact | null> | null>;
   ...
   */
  dependencies(): MetadataDeps<UiSdlHistogramReact | null>;

  save(subPath?: string | null, contentType?: string | null): UiSdlHistogramReact;
  ...
  update(srcObj?: UiSdlHistogramReact | null, spec?: UpsertSpec | null): UiSdlHistogramReact | null;

  upsert(srcObj?: UiSdlHistogramReact | null, spec?: UpsertSpec | null): UiSdlHistogramReact | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): UiSdlHistogramReact | null;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string | null, failIfMissing?: boolean): UiSdlHistogramReact | null;
   ...
   */
  static doDataMerge(componentId: string, dataSpecFieldName: string, dataDestinationFieldName: string, props: UiSdlHistogramReact, state: UiSdlReduxState): UiSdlHistogramReact | null;
   ...
   */
  static clickHistogramAction(id?: string | null, point?: Obj | null): UiSdlHistogramClickAction | null;
}
