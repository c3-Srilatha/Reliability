// TypeScript definitions for the C3 type UiSdlApplicationStateTestApp

/**
 * Test component to test {@link UiSdlApplicationState} functionality.
 *
 * @remarks this represents a value passed to a method that expects an instance of UiSdlApplicationStateTestApp
 */
declare interface IUiSdlApplicationStateTestApp {
   ...
   */
  buttonClickCountById?: C3.Map<string | null, number | null> | {[key: string | null]: number | null};
}
 ...
 */
declare class UiSdlApplicationStateTestApp extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): UiSdlApplicationStateTestApp | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): UiSdlApplicationStateTestApp | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): UiSdlApplicationStateTestApp | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): UiSdlApplicationStateTestApp | null;
   ...
   */
  replaceType(old: Type, new_: Type): UiSdlApplicationStateTestApp;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlApplicationStateTestApp;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlApplicationStateTestApp;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlApplicationStateTestApp | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlApplicationStateTestApp | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): UiSdlApplicationStateTestApp;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlApplicationStateTestApp;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlApplicationStateTestApp;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): UiSdlApplicationStateTestApp;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): UiSdlApplicationStateTestApp;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): UiSdlApplicationStateTestApp;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): UiSdlApplicationStateTestApp;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): UiSdlApplicationStateTestApp;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): UiSdlApplicationStateTestApp;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): UiSdlApplicationStateTestApp;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): UiSdlApplicationStateTestApp;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): UiSdlApplicationStateTestApp;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): UiSdlApplicationStateTestApp;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): UiSdlApplicationStateTestApp;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): UiSdlApplicationStateTestApp;
   ...
   * @see #unsetField
   */
  defaultField(field: string): UiSdlApplicationStateTestApp;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): UiSdlApplicationStateTestApp;
   ...
   * @see #removeField
   */
  unsetField(field: string): UiSdlApplicationStateTestApp;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): UiSdlApplicationStateTestApp;
   ...
   * @see #unsetField
   */
  removeField(field: string): UiSdlApplicationStateTestApp;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): UiSdlApplicationStateTestApp;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): UiSdlApplicationStateTestApp;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): UiSdlApplicationStateTestApp;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): UiSdlApplicationStateTestApp;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): UiSdlApplicationStateTestApp;

  mergeJson(json: any | null): UiSdlApplicationStateTestApp;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): UiSdlApplicationStateTestApp;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): UiSdlApplicationStateTestApp;
   ...
   */
  singletonArray(): C3.Array<UiSdlApplicationStateTestApp | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<UiSdlApplicationStateTestApp | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<UiSdlApplicationStateTestApp | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<UiSdlApplicationStateTestApp | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<UiSdlApplicationStateTestApp | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, UiSdlApplicationStateTestApp | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, UiSdlApplicationStateTestApp | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<UiSdlApplicationStateTestApp | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<UiSdlApplicationStateTestApp | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): UiSdlApplicationStateTestApp;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): UiSdlApplicationStateTestApp;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): UiSdlApplicationStateTestApp;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): UiSdlApplicationStateTestApp;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): UiSdlApplicationStateTestApp;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): UiSdlApplicationStateTestApp;
   ...
   * @see #fromString
   */
  static make(s: string | null): UiSdlApplicationStateTestApp | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): UiSdlApplicationStateTestApp;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): UiSdlApplicationStateTestApp;
   ...
   */
  static cachedEmptyInst(): UiSdlApplicationStateTestApp;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<UiSdlApplicationStateTestApp>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): UiSdlApplicationStateTestApp;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<UiSdlApplicationStateTestApp | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<UiSdlApplicationStateTestApp | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<UiSdlApplicationStateTestApp | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<UiSdlApplicationStateTestApp | null> | null>;
   ...
   */
  dependencies(): MetadataDeps<UiSdlApplicationStateTestApp | null>;

  save(subPath?: string | null, contentType?: string | null): UiSdlApplicationStateTestApp;
  ...
  update(srcObj?: UiSdlApplicationStateTestApp | null, spec?: UpsertSpec | null): UiSdlApplicationStateTestApp | null;

  upsert(srcObj?: UiSdlApplicationStateTestApp | null, spec?: UpsertSpec | null): UiSdlApplicationStateTestApp | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): UiSdlApplicationStateTestApp | null;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string | null, failIfMissing?: boolean): UiSdlApplicationStateTestApp | null;
   ...
   */
  static doDataMerge(componentId: string, dataSpecFieldName: string, dataDestinationFieldName: string, props: UiSdlApplicationStateTestApp, state: UiSdlReduxState): UiSdlApplicationStateTestApp | null;
   ...
   */
  static increaseClickCountAction(id?: string | null, buttonComponentId?: string | null): UiSdlReduxAction<any> | null;
   ...
   * @returns a new Redux state
   */
  static clickCountIncreaseEffect(state?: UiSdlReduxState | null, action?: UiSdlReduxAction<any> | null): UiSdlReduxState | null;
}
