// TypeScript definitions for the C3 type UiSdlFilterPanelReact

/**
 * The react component type of {@link UiSdlFilterPanel}.
 *
 * @remarks this represents a value passed to a method that expects an instance of UiSdlFilterPanelReact
 */
declare interface IUiSdlFilterPanelReact {
 ...
 */
declare class UiSdlFilterPanelReact extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): UiSdlFilterPanelReact | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): UiSdlFilterPanelReact | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): UiSdlFilterPanelReact | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): UiSdlFilterPanelReact | null;
   ...
   */
  replaceType(old: Type, new_: Type): UiSdlFilterPanelReact;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlFilterPanelReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlFilterPanelReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlFilterPanelReact | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlFilterPanelReact | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): UiSdlFilterPanelReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlFilterPanelReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlFilterPanelReact;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): UiSdlFilterPanelReact;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): UiSdlFilterPanelReact;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): UiSdlFilterPanelReact;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): UiSdlFilterPanelReact;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): UiSdlFilterPanelReact;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): UiSdlFilterPanelReact;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): UiSdlFilterPanelReact;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): UiSdlFilterPanelReact;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): UiSdlFilterPanelReact;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): UiSdlFilterPanelReact;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): UiSdlFilterPanelReact;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): UiSdlFilterPanelReact;
   ...
   * @see #unsetField
   */
  defaultField(field: string): UiSdlFilterPanelReact;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): UiSdlFilterPanelReact;
   ...
   * @see #removeField
   */
  unsetField(field: string): UiSdlFilterPanelReact;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): UiSdlFilterPanelReact;
   ...
   * @see #unsetField
   */
  removeField(field: string): UiSdlFilterPanelReact;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): UiSdlFilterPanelReact;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): UiSdlFilterPanelReact;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): UiSdlFilterPanelReact;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): UiSdlFilterPanelReact;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): UiSdlFilterPanelReact;

  mergeJson(json: any | null): UiSdlFilterPanelReact;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): UiSdlFilterPanelReact;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): UiSdlFilterPanelReact;
   ...
   */
  singletonArray(): C3.Array<UiSdlFilterPanelReact | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<UiSdlFilterPanelReact | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<UiSdlFilterPanelReact | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<UiSdlFilterPanelReact | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<UiSdlFilterPanelReact | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, UiSdlFilterPanelReact | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, UiSdlFilterPanelReact | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<UiSdlFilterPanelReact | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<UiSdlFilterPanelReact | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): UiSdlFilterPanelReact;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): UiSdlFilterPanelReact;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): UiSdlFilterPanelReact;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): UiSdlFilterPanelReact;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): UiSdlFilterPanelReact;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): UiSdlFilterPanelReact;
   ...
   * @see #fromString
   */
  static make(s: string | null): UiSdlFilterPanelReact | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): UiSdlFilterPanelReact;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): UiSdlFilterPanelReact;
   ...
   */
  static cachedEmptyInst(): UiSdlFilterPanelReact;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<UiSdlFilterPanelReact>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): UiSdlFilterPanelReact;
   ...
   */
  static render(props?: UiSdlFilterPanelReact | null): void;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<UiSdlFilterPanelReact | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<UiSdlFilterPanelReact | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<UiSdlFilterPanelReact | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<UiSdlFilterPanelReact | null> | null>;
   ...
   */
  dependencies(): MetadataDeps<UiSdlFilterPanelReact | null>;

  save(subPath?: string | null, contentType?: string | null): UiSdlFilterPanelReact;
  ...
  update(srcObj?: UiSdlFilterPanelReact | null, spec?: UpsertSpec | null): UiSdlFilterPanelReact | null;

  upsert(srcObj?: UiSdlFilterPanelReact | null, spec?: UpsertSpec | null): UiSdlFilterPanelReact | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): UiSdlFilterPanelReact | null;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string | null, failIfMissing?: boolean): UiSdlFilterPanelReact | null;
   ...
   */
  static doDataMerge(componentId: string, dataSpecFieldName: string, dataDestinationFieldName: string, props: UiSdlFilterPanelReact, state: UiSdlReduxState): UiSdlFilterPanelReact | null;
