// TypeScript definitions for the C3 type UiSdlPieChartReact

/**
 * The react component type of {@link UiSdlPieChart}.
 *
 * @remarks this represents a value passed to a method that expects an instance of UiSdlPieChartReact
 */
declare interface IUiSdlPieChartReact {
   ...
   */
  dataSpec?: IUiSdlPieChartDataSpec | null;
   ...
   */
  breakpoints?: C3.Array<number | null> | Array<number | null>;
 ...
 */
declare class UiSdlPieChartReact extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): UiSdlPieChartReact | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): UiSdlPieChartReact | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): UiSdlPieChartReact | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): UiSdlPieChartReact | null;
   ...
   */
  replaceType(old: Type, new_: Type): UiSdlPieChartReact;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlPieChartReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlPieChartReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlPieChartReact | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlPieChartReact | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): UiSdlPieChartReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlPieChartReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlPieChartReact;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): UiSdlPieChartReact;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): UiSdlPieChartReact;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): UiSdlPieChartReact;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): UiSdlPieChartReact;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): UiSdlPieChartReact;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): UiSdlPieChartReact;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): UiSdlPieChartReact;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): UiSdlPieChartReact;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): UiSdlPieChartReact;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): UiSdlPieChartReact;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): UiSdlPieChartReact;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): UiSdlPieChartReact;
   ...
   * @see #unsetField
   */
  defaultField(field: string): UiSdlPieChartReact;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): UiSdlPieChartReact;
   ...
   * @see #removeField
   */
  unsetField(field: string): UiSdlPieChartReact;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): UiSdlPieChartReact;
   ...
   * @see #unsetField
   */
  removeField(field: string): UiSdlPieChartReact;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): UiSdlPieChartReact;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): UiSdlPieChartReact;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): UiSdlPieChartReact;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): UiSdlPieChartReact;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): UiSdlPieChartReact;

  mergeJson(json: any | null): UiSdlPieChartReact;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): UiSdlPieChartReact;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): UiSdlPieChartReact;
   ...
   */
  singletonArray(): C3.Array<UiSdlPieChartReact | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<UiSdlPieChartReact | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<UiSdlPieChartReact | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<UiSdlPieChartReact | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<UiSdlPieChartReact | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, UiSdlPieChartReact | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, UiSdlPieChartReact | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<UiSdlPieChartReact | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<UiSdlPieChartReact | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): UiSdlPieChartReact;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): UiSdlPieChartReact;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): UiSdlPieChartReact;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): UiSdlPieChartReact;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): UiSdlPieChartReact;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): UiSdlPieChartReact;
   ...
   * @see #fromString
   */
  static make(s: string | null): UiSdlPieChartReact | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): UiSdlPieChartReact;
   ...
   */
  static cachedEmptyInst(): UiSdlPieChartReact;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<UiSdlPieChartReact>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): UiSdlPieChartReact;
   ...
   */
  static render(props?: UiSdlPieChartReact | null): void;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<UiSdlPieChartReact | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<UiSdlPieChartReact | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<UiSdlPieChartReact | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<UiSdlPieChartReact | null> | null>;
   ...
   */
  dependencies(): MetadataDeps<UiSdlPieChartReact | null>;

  save(subPath?: string | null, contentType?: string | null): UiSdlPieChartReact;
  ...
  update(srcObj?: UiSdlPieChartReact | null, spec?: UpsertSpec | null): UiSdlPieChartReact | null;

  upsert(srcObj?: UiSdlPieChartReact | null, spec?: UpsertSpec | null): UiSdlPieChartReact | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): UiSdlPieChartReact | null;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string | null, failIfMissing?: boolean): UiSdlPieChartReact | null;
   ...
   */
  static doDataMerge(componentId: string, dataSpecFieldName: string, dataDestinationFieldName: string, props: UiSdlPieChartReact, state: UiSdlReduxState): UiSdlPieChartReact | null;
