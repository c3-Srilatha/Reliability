// TypeScript definitions for the C3 type UiSdlLineBarChartReact

/**
 * The react component type of {@link UiSdlLineBarChart}.
 *
 * @remarks this represents a value passed to a method that expects an instance of UiSdlLineBarChartReact
 */
declare interface IUiSdlLineBarChartReact {
 ...
 */
declare class UiSdlLineBarChartReact extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): UiSdlLineBarChartReact | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): UiSdlLineBarChartReact | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): UiSdlLineBarChartReact | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): UiSdlLineBarChartReact | null;
   ...
   */
  replaceType(old: Type, new_: Type): UiSdlLineBarChartReact;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlLineBarChartReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlLineBarChartReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlLineBarChartReact | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlLineBarChartReact | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): UiSdlLineBarChartReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlLineBarChartReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlLineBarChartReact;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): UiSdlLineBarChartReact;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): UiSdlLineBarChartReact;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): UiSdlLineBarChartReact;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): UiSdlLineBarChartReact;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): UiSdlLineBarChartReact;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): UiSdlLineBarChartReact;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): UiSdlLineBarChartReact;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): UiSdlLineBarChartReact;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): UiSdlLineBarChartReact;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): UiSdlLineBarChartReact;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): UiSdlLineBarChartReact;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): UiSdlLineBarChartReact;
   ...
   * @see #unsetField
   */
  defaultField(field: string): UiSdlLineBarChartReact;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): UiSdlLineBarChartReact;
   ...
   * @see #removeField
   */
  unsetField(field: string): UiSdlLineBarChartReact;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): UiSdlLineBarChartReact;
   ...
   * @see #unsetField
   */
  removeField(field: string): UiSdlLineBarChartReact;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): UiSdlLineBarChartReact;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): UiSdlLineBarChartReact;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): UiSdlLineBarChartReact;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): UiSdlLineBarChartReact;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): UiSdlLineBarChartReact;

  mergeJson(json: any | null): UiSdlLineBarChartReact;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): UiSdlLineBarChartReact;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): UiSdlLineBarChartReact;
   ...
   */
  singletonArray(): C3.Array<UiSdlLineBarChartReact | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<UiSdlLineBarChartReact | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<UiSdlLineBarChartReact | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<UiSdlLineBarChartReact | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<UiSdlLineBarChartReact | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, UiSdlLineBarChartReact | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, UiSdlLineBarChartReact | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<UiSdlLineBarChartReact | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<UiSdlLineBarChartReact | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): UiSdlLineBarChartReact;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): UiSdlLineBarChartReact;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): UiSdlLineBarChartReact;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): UiSdlLineBarChartReact;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): UiSdlLineBarChartReact;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): UiSdlLineBarChartReact;
   ...
   * @see #fromString
   */
  static make(s: string | null): UiSdlLineBarChartReact | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): UiSdlLineBarChartReact;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): UiSdlLineBarChartReact;
   ...
   */
  static cachedEmptyInst(): UiSdlLineBarChartReact;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<UiSdlLineBarChartReact>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): UiSdlLineBarChartReact;
   ...
   */
  static render(props?: UiSdlLineBarChartReact | null): void;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<UiSdlLineBarChartReact | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<UiSdlLineBarChartReact | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<UiSdlLineBarChartReact | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<UiSdlLineBarChartReact | null> | null>;
   ...
   */
  dependencies(): MetadataDeps<UiSdlLineBarChartReact | null>;

  save(subPath?: string | null, contentType?: string | null): UiSdlLineBarChartReact;
  ...
  update(srcObj?: UiSdlLineBarChartReact | null, spec?: UpsertSpec | null): UiSdlLineBarChartReact | null;

  upsert(srcObj?: UiSdlLineBarChartReact | null, spec?: UpsertSpec | null): UiSdlLineBarChartReact | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): UiSdlLineBarChartReact | null;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string | null, failIfMissing?: boolean): UiSdlLineBarChartReact | null;
   ...
   */
  static doDataMerge(componentId: string, dataSpecFieldName: string, dataDestinationFieldName: string, props: UiSdlLineBarChartReact, state: UiSdlReduxState): UiSdlLineBarChartReact | null;
