// TypeScript definitions for the C3 type UiSdlTimeseriesLineBarChartReact

/**
 * The react component type of {@link UiSdlTimeseriesLineBarChart}.
 *
 * @remarks this represents a value passed to a method that expects an instance of UiSdlTimeseriesLineBarChartReact
 */
declare interface IUiSdlTimeseriesLineBarChartReact {
 ...
 * The react component type of {@link UiSdlTimeseriesLineBarChart}.
 *
 * @remarks this represents a made instance of UiSdlTimeseriesLineBarChartReact
 */
declare class UiSdlTimeseriesLineBarChartReact extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): UiSdlTimeseriesLineBarChartReact | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): UiSdlTimeseriesLineBarChartReact | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): UiSdlTimeseriesLineBarChartReact | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): UiSdlTimeseriesLineBarChartReact | null;
   ...
   */
  replaceType(old: Type, new_: Type): UiSdlTimeseriesLineBarChartReact;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlTimeseriesLineBarChartReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlTimeseriesLineBarChartReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlTimeseriesLineBarChartReact | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlTimeseriesLineBarChartReact | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): UiSdlTimeseriesLineBarChartReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlTimeseriesLineBarChartReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlTimeseriesLineBarChartReact;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): UiSdlTimeseriesLineBarChartReact;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): UiSdlTimeseriesLineBarChartReact;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): UiSdlTimeseriesLineBarChartReact;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): UiSdlTimeseriesLineBarChartReact;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): UiSdlTimeseriesLineBarChartReact;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): UiSdlTimeseriesLineBarChartReact;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): UiSdlTimeseriesLineBarChartReact;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): UiSdlTimeseriesLineBarChartReact;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): UiSdlTimeseriesLineBarChartReact;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): UiSdlTimeseriesLineBarChartReact;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): UiSdlTimeseriesLineBarChartReact;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): UiSdlTimeseriesLineBarChartReact;
   ...
   * @see #unsetField
   */
  defaultField(field: string): UiSdlTimeseriesLineBarChartReact;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): UiSdlTimeseriesLineBarChartReact;
   ...
   * @see #removeField
   */
  unsetField(field: string): UiSdlTimeseriesLineBarChartReact;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): UiSdlTimeseriesLineBarChartReact;
   ...
   * @see #unsetField
   */
  removeField(field: string): UiSdlTimeseriesLineBarChartReact;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): UiSdlTimeseriesLineBarChartReact;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): UiSdlTimeseriesLineBarChartReact;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): UiSdlTimeseriesLineBarChartReact;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): UiSdlTimeseriesLineBarChartReact;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): UiSdlTimeseriesLineBarChartReact;

  mergeJson(json: any | null): UiSdlTimeseriesLineBarChartReact;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): UiSdlTimeseriesLineBarChartReact;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): UiSdlTimeseriesLineBarChartReact;
   ...
   */
  singletonArray(): C3.Array<UiSdlTimeseriesLineBarChartReact | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<UiSdlTimeseriesLineBarChartReact | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<UiSdlTimeseriesLineBarChartReact | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<UiSdlTimeseriesLineBarChartReact | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<UiSdlTimeseriesLineBarChartReact | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, UiSdlTimeseriesLineBarChartReact | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, UiSdlTimeseriesLineBarChartReact | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<UiSdlTimeseriesLineBarChartReact | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<UiSdlTimeseriesLineBarChartReact | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): UiSdlTimeseriesLineBarChartReact;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): UiSdlTimeseriesLineBarChartReact;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): UiSdlTimeseriesLineBarChartReact;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): UiSdlTimeseriesLineBarChartReact;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): UiSdlTimeseriesLineBarChartReact;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): UiSdlTimeseriesLineBarChartReact;
   ...
   * @see #fromString
   */
  static make(s: string | null): UiSdlTimeseriesLineBarChartReact | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): UiSdlTimeseriesLineBarChartReact;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): UiSdlTimeseriesLineBarChartReact;
   ...
   */
  static cachedEmptyInst(): UiSdlTimeseriesLineBarChartReact;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<UiSdlTimeseriesLineBarChartReact>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): UiSdlTimeseriesLineBarChartReact;
   ...
   */
  static render(props?: UiSdlTimeseriesLineBarChartReact | null): void;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<UiSdlTimeseriesLineBarChartReact | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<UiSdlTimeseriesLineBarChartReact | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<UiSdlTimeseriesLineBarChartReact | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<UiSdlTimeseriesLineBarChartReact | null> | null>;
   ...
   */
  dependencies(): MetadataDeps<UiSdlTimeseriesLineBarChartReact | null>;

  save(subPath?: string | null, contentType?: string | null): UiSdlTimeseriesLineBarChartReact;
  ...
  update(srcObj?: UiSdlTimeseriesLineBarChartReact | null, spec?: UpsertSpec | null): UiSdlTimeseriesLineBarChartReact | null;

  upsert(srcObj?: UiSdlTimeseriesLineBarChartReact | null, spec?: UpsertSpec | null): UiSdlTimeseriesLineBarChartReact | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): UiSdlTimeseriesLineBarChartReact | null;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string | null, failIfMissing?: boolean): UiSdlTimeseriesLineBarChartReact | null;
   ...
   */
  static doDataMerge(componentId: string, dataSpecFieldName: string, dataDestinationFieldName: string, props: UiSdlTimeseriesLineBarChartReact, state: UiSdlReduxState): UiSdlTimeseriesLineBarChartReact | null;
