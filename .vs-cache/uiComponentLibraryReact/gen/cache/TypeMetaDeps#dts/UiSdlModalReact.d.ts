// TypeScript definitions for the C3 type UiSdlModalReact

/**
 * The react component type of {@link UiSdlModal}.
 *
 * @remarks this represents a value passed to a method that expects an instance of UiSdlModalReact
 */
declare interface IUiSdlModalReact {
 ...
 */
declare class UiSdlModalReact extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): UiSdlModalReact | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): UiSdlModalReact | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): UiSdlModalReact | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): UiSdlModalReact | null;
   ...
   */
  replaceType(old: Type, new_: Type): UiSdlModalReact;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlModalReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlModalReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlModalReact | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlModalReact | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): UiSdlModalReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlModalReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlModalReact;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): UiSdlModalReact;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): UiSdlModalReact;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): UiSdlModalReact;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): UiSdlModalReact;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): UiSdlModalReact;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): UiSdlModalReact;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): UiSdlModalReact;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): UiSdlModalReact;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): UiSdlModalReact;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): UiSdlModalReact;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): UiSdlModalReact;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): UiSdlModalReact;
   ...
   * @see #unsetField
   */
  defaultField(field: string): UiSdlModalReact;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): UiSdlModalReact;
   ...
   * @see #removeField
   */
  unsetField(field: string): UiSdlModalReact;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): UiSdlModalReact;
   ...
   * @see #unsetField
   */
  removeField(field: string): UiSdlModalReact;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): UiSdlModalReact;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): UiSdlModalReact;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): UiSdlModalReact;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): UiSdlModalReact;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): UiSdlModalReact;

  mergeJson(json: any | null): UiSdlModalReact;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): UiSdlModalReact;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): UiSdlModalReact;
   ...
   */
  singletonArray(): C3.Array<UiSdlModalReact | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<UiSdlModalReact | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<UiSdlModalReact | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<UiSdlModalReact | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<UiSdlModalReact | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, UiSdlModalReact | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, UiSdlModalReact | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<UiSdlModalReact | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<UiSdlModalReact | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): UiSdlModalReact;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): UiSdlModalReact;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): UiSdlModalReact;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): UiSdlModalReact;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): UiSdlModalReact;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): UiSdlModalReact;
   ...
   * @see #fromString
   */
  static make(s: string | null): UiSdlModalReact | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): UiSdlModalReact;
   ...
   */
  static cachedEmptyInst(): UiSdlModalReact;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<UiSdlModalReact>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): UiSdlModalReact;
   ...
   */
  static render(props?: UiSdlModalReact | null): void;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<UiSdlModalReact | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<UiSdlModalReact | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<UiSdlModalReact | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<UiSdlModalReact | null> | null>;
   ...
   */
  dependencies(): MetadataDeps<UiSdlModalReact | null>;

  save(subPath?: string | null, contentType?: string | null): UiSdlModalReact;
  ...
  update(srcObj?: UiSdlModalReact | null, spec?: UpsertSpec | null): UiSdlModalReact | null;

  upsert(srcObj?: UiSdlModalReact | null, spec?: UpsertSpec | null): UiSdlModalReact | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): UiSdlModalReact | null;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string | null, failIfMissing?: boolean): UiSdlModalReact | null;
   ...
   */
  static doDataMerge(componentId: string, dataSpecFieldName: string, dataDestinationFieldName: string, props: UiSdlModalReact, state: UiSdlReduxState): UiSdlModalReact | null;
