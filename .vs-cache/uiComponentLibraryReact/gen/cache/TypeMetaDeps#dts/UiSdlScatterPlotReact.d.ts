// TypeScript definitions for the C3 type UiSdlScatterPlotReact

/**
 * The react component type of {@link UiSdlScatterPlot}.
 *
 * @remarks this represents a value passed to a method that expects an instance of UiSdlScatterPlotReact
 */
declare interface IUiSdlScatterPlotReact {
   ...
   */
  dataSpec?: IUiSdlScatterPlotDataSpec | null;
   ...
   */
  xAxisConfig?: IUiSdlScatterPlotAxisConfig | null;

  /**
   * Configuration of y-Axis.
   */
  yAxisConfig?: IUiSdlScatterPlotAxisConfig | null;
   ...
   */
  legendConfig?: IUiSdlChartLegend | null;

  /**
   * Configuration for the visualMap.
   */
  visualMapConfig?: IUiSdlChartEChartVisualMapConfig | null;
   ...
   */
  exportSelectedData?: boolean;

  /**
   * Configuration of tooltip.
   */
  tooltipConfig?: IUiSdlScatterPlotTooltipConfig | null;
 ...
 */
declare class UiSdlScatterPlotReact extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): UiSdlScatterPlotReact | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): UiSdlScatterPlotReact | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): UiSdlScatterPlotReact | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): UiSdlScatterPlotReact | null;
   ...
   */
  replaceType(old: Type, new_: Type): UiSdlScatterPlotReact;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlScatterPlotReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlScatterPlotReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlScatterPlotReact | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlScatterPlotReact | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): UiSdlScatterPlotReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlScatterPlotReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlScatterPlotReact;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): UiSdlScatterPlotReact;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): UiSdlScatterPlotReact;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): UiSdlScatterPlotReact;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): UiSdlScatterPlotReact;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): UiSdlScatterPlotReact;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): UiSdlScatterPlotReact;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): UiSdlScatterPlotReact;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): UiSdlScatterPlotReact;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): UiSdlScatterPlotReact;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): UiSdlScatterPlotReact;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): UiSdlScatterPlotReact;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): UiSdlScatterPlotReact;
   ...
   * @see #unsetField
   */
  defaultField(field: string): UiSdlScatterPlotReact;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): UiSdlScatterPlotReact;
   ...
   * @see #removeField
   */
  unsetField(field: string): UiSdlScatterPlotReact;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): UiSdlScatterPlotReact;
   ...
   * @see #unsetField
   */
  removeField(field: string): UiSdlScatterPlotReact;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): UiSdlScatterPlotReact;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): UiSdlScatterPlotReact;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): UiSdlScatterPlotReact;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): UiSdlScatterPlotReact;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): UiSdlScatterPlotReact;

  mergeJson(json: any | null): UiSdlScatterPlotReact;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): UiSdlScatterPlotReact;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): UiSdlScatterPlotReact;
   ...
   */
  singletonArray(): C3.Array<UiSdlScatterPlotReact | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<UiSdlScatterPlotReact | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<UiSdlScatterPlotReact | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<UiSdlScatterPlotReact | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<UiSdlScatterPlotReact | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, UiSdlScatterPlotReact | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, UiSdlScatterPlotReact | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<UiSdlScatterPlotReact | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<UiSdlScatterPlotReact | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): UiSdlScatterPlotReact;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): UiSdlScatterPlotReact;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): UiSdlScatterPlotReact;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): UiSdlScatterPlotReact;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): UiSdlScatterPlotReact;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): UiSdlScatterPlotReact;
   ...
   * @see #fromString
   */
  static make(s: string | null): UiSdlScatterPlotReact | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): UiSdlScatterPlotReact;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): UiSdlScatterPlotReact;
   ...
   */
  static cachedEmptyInst(): UiSdlScatterPlotReact;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<UiSdlScatterPlotReact>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): UiSdlScatterPlotReact;
   ...
   */
  static render(props?: UiSdlScatterPlotReact | null): void;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<UiSdlScatterPlotReact | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<UiSdlScatterPlotReact | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<UiSdlScatterPlotReact | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<UiSdlScatterPlotReact | null> | null>;
   ...
   */
  dependencies(): MetadataDeps<UiSdlScatterPlotReact | null>;

  save(subPath?: string | null, contentType?: string | null): UiSdlScatterPlotReact;
  ...
  update(srcObj?: UiSdlScatterPlotReact | null, spec?: UpsertSpec | null): UiSdlScatterPlotReact | null;

  upsert(srcObj?: UiSdlScatterPlotReact | null, spec?: UpsertSpec | null): UiSdlScatterPlotReact | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): UiSdlScatterPlotReact | null;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string | null, failIfMissing?: boolean): UiSdlScatterPlotReact | null;
   ...
   */
  static doDataMerge(componentId: string, dataSpecFieldName: string, dataDestinationFieldName: string, props: UiSdlScatterPlotReact, state: UiSdlReduxState): UiSdlScatterPlotReact | null;
   ...
   */
  static triggerItemClick(id?: string | null, payload?: any | null): UiSdlReduxAction<any> | null;
   ...
   */
  static triggerChartActionsAction(id: string, actionSuffix: string): UiSdlReduxAction<UiSdlComponentActionPayload | null> | null;
}
