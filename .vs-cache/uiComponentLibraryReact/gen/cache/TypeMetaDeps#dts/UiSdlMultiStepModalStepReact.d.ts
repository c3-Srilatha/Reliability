// TypeScript definitions for the C3 type UiSdlMultiStepModalStepReact

/**
 * The react component type of {@link UiSdlMultiStepModalStep}.
 *
 * @remarks this represents a value passed to a method that expects an instance of UiSdlMultiStepModalStepReact
 */
declare interface IUiSdlMultiStepModalStepReact {
 ...
 */
declare class UiSdlMultiStepModalStepReact extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): UiSdlMultiStepModalStepReact | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): UiSdlMultiStepModalStepReact | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): UiSdlMultiStepModalStepReact | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): UiSdlMultiStepModalStepReact | null;
   ...
   */
  replaceType(old: Type, new_: Type): UiSdlMultiStepModalStepReact;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlMultiStepModalStepReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlMultiStepModalStepReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlMultiStepModalStepReact | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlMultiStepModalStepReact | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): UiSdlMultiStepModalStepReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlMultiStepModalStepReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlMultiStepModalStepReact;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): UiSdlMultiStepModalStepReact;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): UiSdlMultiStepModalStepReact;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): UiSdlMultiStepModalStepReact;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): UiSdlMultiStepModalStepReact;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): UiSdlMultiStepModalStepReact;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): UiSdlMultiStepModalStepReact;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): UiSdlMultiStepModalStepReact;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): UiSdlMultiStepModalStepReact;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): UiSdlMultiStepModalStepReact;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): UiSdlMultiStepModalStepReact;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): UiSdlMultiStepModalStepReact;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): UiSdlMultiStepModalStepReact;
   ...
   * @see #unsetField
   */
  defaultField(field: string): UiSdlMultiStepModalStepReact;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): UiSdlMultiStepModalStepReact;
   ...
   * @see #removeField
   */
  unsetField(field: string): UiSdlMultiStepModalStepReact;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): UiSdlMultiStepModalStepReact;
   ...
   * @see #unsetField
   */
  removeField(field: string): UiSdlMultiStepModalStepReact;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): UiSdlMultiStepModalStepReact;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): UiSdlMultiStepModalStepReact;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): UiSdlMultiStepModalStepReact;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): UiSdlMultiStepModalStepReact;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): UiSdlMultiStepModalStepReact;

  mergeJson(json: any | null): UiSdlMultiStepModalStepReact;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): UiSdlMultiStepModalStepReact;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): UiSdlMultiStepModalStepReact;
   ...
   */
  singletonArray(): C3.Array<UiSdlMultiStepModalStepReact | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<UiSdlMultiStepModalStepReact | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<UiSdlMultiStepModalStepReact | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<UiSdlMultiStepModalStepReact | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<UiSdlMultiStepModalStepReact | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, UiSdlMultiStepModalStepReact | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, UiSdlMultiStepModalStepReact | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<UiSdlMultiStepModalStepReact | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<UiSdlMultiStepModalStepReact | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): UiSdlMultiStepModalStepReact;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): UiSdlMultiStepModalStepReact;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): UiSdlMultiStepModalStepReact;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): UiSdlMultiStepModalStepReact;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): UiSdlMultiStepModalStepReact;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): UiSdlMultiStepModalStepReact;
   ...
   * @see #fromString
   */
  static make(s: string | null): UiSdlMultiStepModalStepReact | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): UiSdlMultiStepModalStepReact;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): UiSdlMultiStepModalStepReact;
   ...
   */
  static cachedEmptyInst(): UiSdlMultiStepModalStepReact;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<UiSdlMultiStepModalStepReact>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): UiSdlMultiStepModalStepReact;
   ...
   */
  static render(props?: UiSdlMultiStepModalStepReact | null): void;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<UiSdlMultiStepModalStepReact | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<UiSdlMultiStepModalStepReact | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<UiSdlMultiStepModalStepReact | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<UiSdlMultiStepModalStepReact | null> | null>;
   ...
   */
  dependencies(): MetadataDeps<UiSdlMultiStepModalStepReact | null>;

  save(subPath?: string | null, contentType?: string | null): UiSdlMultiStepModalStepReact;
  ...
  update(srcObj?: UiSdlMultiStepModalStepReact | null, spec?: UpsertSpec | null): UiSdlMultiStepModalStepReact | null;

  upsert(srcObj?: UiSdlMultiStepModalStepReact | null, spec?: UpsertSpec | null): UiSdlMultiStepModalStepReact | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): UiSdlMultiStepModalStepReact | null;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string | null, failIfMissing?: boolean): UiSdlMultiStepModalStepReact | null;
   ...
   */
  static doDataMerge(componentId: string, dataSpecFieldName: string, dataDestinationFieldName: string, props: UiSdlMultiStepModalStepReact, state: UiSdlReduxState): UiSdlMultiStepModalStepReact | null;
