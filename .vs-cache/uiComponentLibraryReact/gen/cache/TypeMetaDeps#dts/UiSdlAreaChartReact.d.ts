// TypeScript definitions for the C3 type UiSdlAreaChartReact

/**
 * The react component type of {@link UiSdlAreaChart}.
 *
 * @remarks this represents a value passed to a method that expects an instance of UiSdlAreaChartReact
 */
declare interface IUiSdlAreaChartReact {
   ...
   */
  dataSpec?: IUiSdlAreaChartDataSpec | null;
   ...
   */
  displayStartDate?: DateTime | Date | string | null;

  /**
   * End date displayed in the chart shown only when dataSelection is enabled
   */
  displayEndDate?: DateTime | Date | string | null;
 ...
 */
declare class UiSdlAreaChartReact extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): UiSdlAreaChartReact | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): UiSdlAreaChartReact | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): UiSdlAreaChartReact | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): UiSdlAreaChartReact | null;
   ...
   */
  replaceType(old: Type, new_: Type): UiSdlAreaChartReact;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlAreaChartReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlAreaChartReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlAreaChartReact | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlAreaChartReact | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): UiSdlAreaChartReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlAreaChartReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlAreaChartReact;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): UiSdlAreaChartReact;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): UiSdlAreaChartReact;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): UiSdlAreaChartReact;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): UiSdlAreaChartReact;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): UiSdlAreaChartReact;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): UiSdlAreaChartReact;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): UiSdlAreaChartReact;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): UiSdlAreaChartReact;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): UiSdlAreaChartReact;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): UiSdlAreaChartReact;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): UiSdlAreaChartReact;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): UiSdlAreaChartReact;
   ...
   * @see #unsetField
   */
  defaultField(field: string): UiSdlAreaChartReact;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): UiSdlAreaChartReact;
   ...
   * @see #removeField
   */
  unsetField(field: string): UiSdlAreaChartReact;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): UiSdlAreaChartReact;
   ...
   * @see #unsetField
   */
  removeField(field: string): UiSdlAreaChartReact;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): UiSdlAreaChartReact;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): UiSdlAreaChartReact;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): UiSdlAreaChartReact;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): UiSdlAreaChartReact;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): UiSdlAreaChartReact;

  mergeJson(json: any | null): UiSdlAreaChartReact;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): UiSdlAreaChartReact;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): UiSdlAreaChartReact;
   ...
   */
  singletonArray(): C3.Array<UiSdlAreaChartReact | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<UiSdlAreaChartReact | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<UiSdlAreaChartReact | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<UiSdlAreaChartReact | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<UiSdlAreaChartReact | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, UiSdlAreaChartReact | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, UiSdlAreaChartReact | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<UiSdlAreaChartReact | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<UiSdlAreaChartReact | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): UiSdlAreaChartReact;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): UiSdlAreaChartReact;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): UiSdlAreaChartReact;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): UiSdlAreaChartReact;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): UiSdlAreaChartReact;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): UiSdlAreaChartReact;
   ...
   * @see #fromString
   */
  static make(s: string | null): UiSdlAreaChartReact | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): UiSdlAreaChartReact;
   ...
   */
  static cachedEmptyInst(): UiSdlAreaChartReact;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<UiSdlAreaChartReact>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): UiSdlAreaChartReact;
   ...
   */
  static render(props?: UiSdlAreaChartReact | null): void;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<UiSdlAreaChartReact | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<UiSdlAreaChartReact | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<UiSdlAreaChartReact | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<UiSdlAreaChartReact | null> | null>;
   ...
   */
  dependencies(): MetadataDeps<UiSdlAreaChartReact | null>;

  save(subPath?: string | null, contentType?: string | null): UiSdlAreaChartReact;
  ...
  update(srcObj?: UiSdlAreaChartReact | null, spec?: UpsertSpec | null): UiSdlAreaChartReact | null;

  upsert(srcObj?: UiSdlAreaChartReact | null, spec?: UpsertSpec | null): UiSdlAreaChartReact | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): UiSdlAreaChartReact | null;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string | null, failIfMissing?: boolean): UiSdlAreaChartReact | null;
   ...
   */
  static doDataMerge(componentId: string, dataSpecFieldName: string, dataDestinationFieldName: string, props: UiSdlAreaChartReact, state: UiSdlReduxState): UiSdlAreaChartReact | null;
   ...
   * @returns An Observable action stream.
   */
  static areaChartInitialRenderEpic(actionStream?: UiSdlActionsObservable | null, stateStream?: UiSdlStatesObservable | null): UiSdlActionsObservable | null;
}
