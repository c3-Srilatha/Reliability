// TypeScript definitions for the C3 type UiSdlFileUploadEventModalReact

/**
 * The react component type of {@link UiSdlFileUploadEventModal}.
 *
 * @remarks this represents a value passed to a method that expects an instance of UiSdlFileUploadEventModalReact
 */
declare interface IUiSdlFileUploadEventModalReact {
   ...
   */
  modalType?: IUiSdlTwoButtonModal | null;
   ...
   */
  uiFileUploadComponentId?: string | null;
}
 ...
 */
declare class UiSdlFileUploadEventModalReact extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): UiSdlFileUploadEventModalReact | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): UiSdlFileUploadEventModalReact | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): UiSdlFileUploadEventModalReact | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): UiSdlFileUploadEventModalReact | null;
   ...
   */
  replaceType(old: Type, new_: Type): UiSdlFileUploadEventModalReact;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlFileUploadEventModalReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlFileUploadEventModalReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlFileUploadEventModalReact | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlFileUploadEventModalReact | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): UiSdlFileUploadEventModalReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlFileUploadEventModalReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlFileUploadEventModalReact;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): UiSdlFileUploadEventModalReact;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): UiSdlFileUploadEventModalReact;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): UiSdlFileUploadEventModalReact;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): UiSdlFileUploadEventModalReact;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): UiSdlFileUploadEventModalReact;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): UiSdlFileUploadEventModalReact;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): UiSdlFileUploadEventModalReact;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): UiSdlFileUploadEventModalReact;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): UiSdlFileUploadEventModalReact;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): UiSdlFileUploadEventModalReact;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): UiSdlFileUploadEventModalReact;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): UiSdlFileUploadEventModalReact;
   ...
   * @see #unsetField
   */
  defaultField(field: string): UiSdlFileUploadEventModalReact;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): UiSdlFileUploadEventModalReact;
   ...
   * @see #removeField
   */
  unsetField(field: string): UiSdlFileUploadEventModalReact;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): UiSdlFileUploadEventModalReact;
   ...
   * @see #unsetField
   */
  removeField(field: string): UiSdlFileUploadEventModalReact;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): UiSdlFileUploadEventModalReact;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): UiSdlFileUploadEventModalReact;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): UiSdlFileUploadEventModalReact;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): UiSdlFileUploadEventModalReact;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): UiSdlFileUploadEventModalReact;

  mergeJson(json: any | null): UiSdlFileUploadEventModalReact;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): UiSdlFileUploadEventModalReact;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): UiSdlFileUploadEventModalReact;
   ...
   */
  singletonArray(): C3.Array<UiSdlFileUploadEventModalReact | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<UiSdlFileUploadEventModalReact | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<UiSdlFileUploadEventModalReact | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<UiSdlFileUploadEventModalReact | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<UiSdlFileUploadEventModalReact | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, UiSdlFileUploadEventModalReact | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, UiSdlFileUploadEventModalReact | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<UiSdlFileUploadEventModalReact | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<UiSdlFileUploadEventModalReact | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): UiSdlFileUploadEventModalReact;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): UiSdlFileUploadEventModalReact;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): UiSdlFileUploadEventModalReact;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): UiSdlFileUploadEventModalReact;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): UiSdlFileUploadEventModalReact;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): UiSdlFileUploadEventModalReact;
   ...
   * @see #fromString
   */
  static make(s: string | null): UiSdlFileUploadEventModalReact | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): UiSdlFileUploadEventModalReact;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): UiSdlFileUploadEventModalReact;
   ...
   */
  static cachedEmptyInst(): UiSdlFileUploadEventModalReact;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<UiSdlFileUploadEventModalReact>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): UiSdlFileUploadEventModalReact;
   ...
   */
  static render(props?: UiSdlFileUploadEventModalReact | null): void;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<UiSdlFileUploadEventModalReact | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<UiSdlFileUploadEventModalReact | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<UiSdlFileUploadEventModalReact | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<UiSdlFileUploadEventModalReact | null> | null>;
   ...
   */
  dependencies(): MetadataDeps<UiSdlFileUploadEventModalReact | null>;

  save(subPath?: string | null, contentType?: string | null): UiSdlFileUploadEventModalReact;
  ...
  update(srcObj?: UiSdlFileUploadEventModalReact | null, spec?: UpsertSpec | null): UiSdlFileUploadEventModalReact | null;

  upsert(srcObj?: UiSdlFileUploadEventModalReact | null, spec?: UpsertSpec | null): UiSdlFileUploadEventModalReact | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): UiSdlFileUploadEventModalReact | null;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string | null, failIfMissing?: boolean): UiSdlFileUploadEventModalReact | null;
   ...
   */
  static doDataMerge(componentId: string, dataSpecFieldName: string, dataDestinationFieldName: string, props: UiSdlFileUploadEventModalReact, state: UiSdlReduxState): UiSdlFileUploadEventModalReact | null;
   ...
   */
  static setUiSdlFileUploadComponentIdAction(id?: string | null, uiFileUploadComponentId?: string | null): UiSdlUiFileUploadComponentIdSetAction | null;
   ...
   * @returns A new Redux state.
   */
  static uiFileUploadComponentIdSetEffect(state: UiSdlReduxState, action?: UiSdlUiFileUploadComponentIdSetAction | null): UiSdlReduxState;
}
