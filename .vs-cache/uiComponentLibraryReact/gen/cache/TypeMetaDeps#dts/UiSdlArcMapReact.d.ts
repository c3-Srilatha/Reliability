// TypeScript definitions for the C3 type UiSdlArcMapReact

/**
 * The react component type of {@link UiSdlArcMap}.
 *
 * @remarks this represents a value passed to a method that expects an instance of UiSdlArcMapReact
 */
declare interface IUiSdlArcMapReact {
   ...
   */
  dataSpec?: IUiSdlArcMapDataSpec | null;
   ...
   */
  arcData?: IFetchResult<Obj | null> | null;
 ...
 */
declare class UiSdlArcMapReact extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): UiSdlArcMapReact | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): UiSdlArcMapReact | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): UiSdlArcMapReact | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): UiSdlArcMapReact | null;
   ...
   */
  replaceType(old: Type, new_: Type): UiSdlArcMapReact;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlArcMapReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlArcMapReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlArcMapReact | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlArcMapReact | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): UiSdlArcMapReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlArcMapReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlArcMapReact;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): UiSdlArcMapReact;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): UiSdlArcMapReact;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): UiSdlArcMapReact;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): UiSdlArcMapReact;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): UiSdlArcMapReact;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): UiSdlArcMapReact;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): UiSdlArcMapReact;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): UiSdlArcMapReact;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): UiSdlArcMapReact;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): UiSdlArcMapReact;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): UiSdlArcMapReact;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): UiSdlArcMapReact;
   ...
   * @see #unsetField
   */
  defaultField(field: string): UiSdlArcMapReact;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): UiSdlArcMapReact;
   ...
   * @see #removeField
   */
  unsetField(field: string): UiSdlArcMapReact;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): UiSdlArcMapReact;
   ...
   * @see #unsetField
   */
  removeField(field: string): UiSdlArcMapReact;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): UiSdlArcMapReact;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): UiSdlArcMapReact;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): UiSdlArcMapReact;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): UiSdlArcMapReact;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): UiSdlArcMapReact;

  mergeJson(json: any | null): UiSdlArcMapReact;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): UiSdlArcMapReact;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): UiSdlArcMapReact;
   ...
   */
  singletonArray(): C3.Array<UiSdlArcMapReact | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<UiSdlArcMapReact | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<UiSdlArcMapReact | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<UiSdlArcMapReact | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<UiSdlArcMapReact | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, UiSdlArcMapReact | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, UiSdlArcMapReact | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<UiSdlArcMapReact | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<UiSdlArcMapReact | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): UiSdlArcMapReact;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): UiSdlArcMapReact;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): UiSdlArcMapReact;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): UiSdlArcMapReact;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): UiSdlArcMapReact;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): UiSdlArcMapReact;
   ...
   * @see #fromString
   */
  static make(s: string | null): UiSdlArcMapReact | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): UiSdlArcMapReact;
   ...
   */
  static cachedEmptyInst(): UiSdlArcMapReact;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<UiSdlArcMapReact>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): UiSdlArcMapReact;
   ...
   */
  static render(props?: UiSdlArcMapReact | null): void;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<UiSdlArcMapReact | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<UiSdlArcMapReact | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<UiSdlArcMapReact | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<UiSdlArcMapReact | null> | null>;
   ...
   */
  dependencies(): MetadataDeps<UiSdlArcMapReact | null>;

  save(subPath?: string | null, contentType?: string | null): UiSdlArcMapReact;
  ...
  update(srcObj?: UiSdlArcMapReact | null, spec?: UpsertSpec | null): UiSdlArcMapReact | null;

  upsert(srcObj?: UiSdlArcMapReact | null, spec?: UpsertSpec | null): UiSdlArcMapReact | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): UiSdlArcMapReact | null;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string | null, failIfMissing?: boolean): UiSdlArcMapReact | null;
   ...
   */
  static doDataMerge(componentId: string, dataSpecFieldName: string, dataDestinationFieldName: string, props: UiSdlArcMapReact, state: UiSdlReduxState): UiSdlArcMapReact | null;
