// TypeScript definitions for the C3 type UiSdlWaterfallChartReact

/**
 * Waterfall Chart component renderer.
 *
 * @remarks this represents a value passed to a method that expects an instance of UiSdlWaterfallChartReact
 */
declare interface IUiSdlWaterfallChartReact {
   ...
   */
  dataSpec?: IUiSdlWaterfallChartDataSpec | null;
   ...
   */
  yAxis?: IUiSdlWaterfallChartYAxisConfig | null;

  /**
   * Configuration of x-Axis.
   */
  xAxis?: IUiSdlWaterfallChartXAxisConfig | null;
   ...
   */
  legendStyle?: string | null;

  /**
   * Configuration of tooltip.
   */
  tooltip?: IUiSdlWaterfallChartTooltip | null;
   ...
   */
  gradientSettings?: C3.Array<UiSdlWaterfallChartGradientColorSettings | null> | Array<IUiSdlWaterfallChartGradientColorSettings | null>;

  /**
   * Total gradient settings.
   */
  totalGradientSettings?: C3.Array<UiSdlWaterfallChartGradientColorSettings | null> | Array<IUiSdlWaterfallChartGradientColorSettings | null>;
}
 ...
 */
declare class UiSdlWaterfallChartReact extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): UiSdlWaterfallChartReact | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): UiSdlWaterfallChartReact | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): UiSdlWaterfallChartReact | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): UiSdlWaterfallChartReact | null;
   ...
   */
  replaceType(old: Type, new_: Type): UiSdlWaterfallChartReact;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlWaterfallChartReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlWaterfallChartReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlWaterfallChartReact | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlWaterfallChartReact | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): UiSdlWaterfallChartReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlWaterfallChartReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlWaterfallChartReact;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): UiSdlWaterfallChartReact;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): UiSdlWaterfallChartReact;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): UiSdlWaterfallChartReact;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): UiSdlWaterfallChartReact;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): UiSdlWaterfallChartReact;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): UiSdlWaterfallChartReact;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): UiSdlWaterfallChartReact;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): UiSdlWaterfallChartReact;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): UiSdlWaterfallChartReact;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): UiSdlWaterfallChartReact;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): UiSdlWaterfallChartReact;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): UiSdlWaterfallChartReact;
   ...
   * @see #unsetField
   */
  defaultField(field: string): UiSdlWaterfallChartReact;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): UiSdlWaterfallChartReact;
   ...
   * @see #removeField
   */
  unsetField(field: string): UiSdlWaterfallChartReact;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): UiSdlWaterfallChartReact;
   ...
   * @see #unsetField
   */
  removeField(field: string): UiSdlWaterfallChartReact;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): UiSdlWaterfallChartReact;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): UiSdlWaterfallChartReact;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): UiSdlWaterfallChartReact;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): UiSdlWaterfallChartReact;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): UiSdlWaterfallChartReact;

  mergeJson(json: any | null): UiSdlWaterfallChartReact;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): UiSdlWaterfallChartReact;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): UiSdlWaterfallChartReact;
   ...
   */
  singletonArray(): C3.Array<UiSdlWaterfallChartReact | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<UiSdlWaterfallChartReact | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<UiSdlWaterfallChartReact | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<UiSdlWaterfallChartReact | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<UiSdlWaterfallChartReact | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, UiSdlWaterfallChartReact | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, UiSdlWaterfallChartReact | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<UiSdlWaterfallChartReact | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<UiSdlWaterfallChartReact | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): UiSdlWaterfallChartReact;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): UiSdlWaterfallChartReact;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): UiSdlWaterfallChartReact;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): UiSdlWaterfallChartReact;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): UiSdlWaterfallChartReact;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): UiSdlWaterfallChartReact;
   ...
   * @see #fromString
   */
  static make(s: string | null): UiSdlWaterfallChartReact | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): UiSdlWaterfallChartReact;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): UiSdlWaterfallChartReact;
   ...
   */
  static cachedEmptyInst(): UiSdlWaterfallChartReact;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<UiSdlWaterfallChartReact>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): UiSdlWaterfallChartReact;
   ...
   */
  static render(props?: UiSdlWaterfallChartReact | null): void;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<UiSdlWaterfallChartReact | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<UiSdlWaterfallChartReact | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<UiSdlWaterfallChartReact | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<UiSdlWaterfallChartReact | null> | null>;
   ...
   */
  dependencies(): MetadataDeps<UiSdlWaterfallChartReact | null>;

  save(subPath?: string | null, contentType?: string | null): UiSdlWaterfallChartReact;
  ...
  update(srcObj?: UiSdlWaterfallChartReact | null, spec?: UpsertSpec | null): UiSdlWaterfallChartReact | null;

  upsert(srcObj?: UiSdlWaterfallChartReact | null, spec?: UpsertSpec | null): UiSdlWaterfallChartReact | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): UiSdlWaterfallChartReact | null;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string | null, failIfMissing?: boolean): UiSdlWaterfallChartReact | null;
   ...
   */
  static doDataMerge(componentId: string, dataSpecFieldName: string, dataDestinationFieldName: string, props: UiSdlWaterfallChartReact, state: UiSdlReduxState): UiSdlWaterfallChartReact | null;
   ...
   */
  static triggerItemClick(id?: string | null, payload?: any | null): UiSdlClickItemAction | null;
}
