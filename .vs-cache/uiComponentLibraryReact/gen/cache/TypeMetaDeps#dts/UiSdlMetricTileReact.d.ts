// TypeScript definitions for the C3 type UiSdlMetricTileReact

/**
 * The react component type of {@link UiSdlMetricTile}.
 *
 * @remarks this represents a value passed to a method that expects an instance of UiSdlMetricTileReact
 */
declare interface IUiSdlMetricTileReact {
   ...
   */
  dataSpec?: IUiSdlMetricTileDataSpec | null;
   ...
   */
  header?: IUiSdlMetricTileHeader | null;
   ...
   */
  dataCollection?: IUiSdlMetricTileDataCollection | null;
   ...
   */
  evalDataSpec?: IUiSdlMetricTileEvalDataSpec | null;
   ...
   */
  tooltipPositionBias?: string | null;
   ...
   */
  missingValueHolderValue?: number | null;

  /**
   * Tooltip title interval display value in the chart.
   */
  displayTooltipTitleInterval?: string | null;
}
 ...
 */
declare class UiSdlMetricTileReact extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): UiSdlMetricTileReact | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): UiSdlMetricTileReact | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): UiSdlMetricTileReact | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): UiSdlMetricTileReact | null;
   ...
   */
  replaceType(old: Type, new_: Type): UiSdlMetricTileReact;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlMetricTileReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlMetricTileReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlMetricTileReact | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlMetricTileReact | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): UiSdlMetricTileReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlMetricTileReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlMetricTileReact;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): UiSdlMetricTileReact;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): UiSdlMetricTileReact;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): UiSdlMetricTileReact;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): UiSdlMetricTileReact;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): UiSdlMetricTileReact;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): UiSdlMetricTileReact;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): UiSdlMetricTileReact;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): UiSdlMetricTileReact;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): UiSdlMetricTileReact;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): UiSdlMetricTileReact;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): UiSdlMetricTileReact;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): UiSdlMetricTileReact;
   ...
   * @see #unsetField
   */
  defaultField(field: string): UiSdlMetricTileReact;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): UiSdlMetricTileReact;
   ...
   * @see #removeField
   */
  unsetField(field: string): UiSdlMetricTileReact;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): UiSdlMetricTileReact;
   ...
   * @see #unsetField
   */
  removeField(field: string): UiSdlMetricTileReact;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): UiSdlMetricTileReact;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): UiSdlMetricTileReact;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): UiSdlMetricTileReact;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): UiSdlMetricTileReact;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): UiSdlMetricTileReact;

  mergeJson(json: any | null): UiSdlMetricTileReact;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): UiSdlMetricTileReact;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): UiSdlMetricTileReact;
   ...
   */
  singletonArray(): C3.Array<UiSdlMetricTileReact | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<UiSdlMetricTileReact | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<UiSdlMetricTileReact | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<UiSdlMetricTileReact | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<UiSdlMetricTileReact | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, UiSdlMetricTileReact | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, UiSdlMetricTileReact | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<UiSdlMetricTileReact | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<UiSdlMetricTileReact | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): UiSdlMetricTileReact;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): UiSdlMetricTileReact;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): UiSdlMetricTileReact;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): UiSdlMetricTileReact;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): UiSdlMetricTileReact;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): UiSdlMetricTileReact;
   ...
   * @see #fromString
   */
  static make(s: string | null): UiSdlMetricTileReact | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): UiSdlMetricTileReact;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): UiSdlMetricTileReact;
   ...
   */
  static cachedEmptyInst(): UiSdlMetricTileReact;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<UiSdlMetricTileReact>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): UiSdlMetricTileReact;
   ...
   */
  static render(props?: UiSdlMetricTileReact | null): void;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<UiSdlMetricTileReact | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<UiSdlMetricTileReact | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<UiSdlMetricTileReact | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<UiSdlMetricTileReact | null> | null>;
   ...
   */
  dependencies(): MetadataDeps<UiSdlMetricTileReact | null>;

  save(subPath?: string | null, contentType?: string | null): UiSdlMetricTileReact;
  ...
  update(srcObj?: UiSdlMetricTileReact | null, spec?: UpsertSpec | null): UiSdlMetricTileReact | null;

  upsert(srcObj?: UiSdlMetricTileReact | null, spec?: UpsertSpec | null): UiSdlMetricTileReact | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): UiSdlMetricTileReact | null;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string | null, failIfMissing?: boolean): UiSdlMetricTileReact | null;
   ...
   */
  static doDataMerge(componentId: string, dataSpecFieldName: string, dataDestinationFieldName: string, props: UiSdlMetricTileReact, state: UiSdlReduxState): UiSdlMetricTileReact | null;
   ...
   */
  static updateUnitSymbolEffect(state?: UiSdlReduxState | null, action?: UiSdlReduxAction<any> | null): UiSdlReduxState | null;
}
