...
from c3.reliabilityDataModel.FailureModeLibrary import FailureModeLibrary
from c3.platform.MergeSpec import MergeSpec
from c3.platform.MergeAllSpec import MergeAllSpec
from c3.reliabilityDataModel.AssetClassParentChildRelation import AssetClassParentChildRelation
...
from c3.reliabilityDataModel.AssetHierarchyTemplate import AssetHierarchyTemplate
...
# Python definitions for the C3 type AssetClass


class AssetClass(FeatureEvaluatable, ExemptFromFacilityFilter, UserGeneratable, AssetOnboardingImportTracking):
    """
    ...
    @remarks this represents a made instance of AssetClass
    """
    ...
    notUserGenerated: Optional[bool]=None
    """
    This field indicates whether the data is generated by System or User.
    """

    source: Optional[str]=None
    """
    This field indicates the source of the data. `displaySource` should be fetched instead of this field.
    """

    displaySource: Optional[str]=None
    """
    This field is used by the UI to show the translated value of {@link source}.
    """
    ...
    **DISPLAY USE ONLY**
    ...
    parentAssetClassRelations: Optional[Array[AssetClassParentChildRelation]]=None
    """
    The relations to parents for this class.
    """

    childAssetClassRelations: Optional[Array[AssetClassParentChildRelation]]=None
    """
    ...
    countAssets: Optional[int]=None
    """
    Number of {@link ReliabilityAsset}s of this asset class.
    """

    failureModeLibrary: Optional[FailureModeLibrary]=None
    """
    ...
    countFailureModes: Optional[int]=None
    """
    Number of {@link FailureMode}s associated with this asset class.
    """

    expectedSensors: Optional[Array[ExpectedSensor]]=None
    """
    ...
    expectedSensorCount: Optional[int]=None
    """
    Number of {@link ExpectedSensor}s associated with this asset class.
    """

    kpis: Optional[Array[str]]=None
    """
    ...
    hierarchyTemplate: Optional[AssetHierarchyTemplate]=None
    """
    Defines the hierarchy that assets using this `AssetClass` should be the root of.
    """

    definitionVersion: Optional[ReliabilityAssetClassDefinitionVersion]=None
    """
    ...
    mapModel: Optional[str]=None
    """
    Ion Cesium Asset Model to use for this asset class.
    """

    displayParent: Optional[AssetClass]=None
    """
    The parent of this asset class to be displayed in the UI.
    """

    mapIcon: Optional[str]=None
    """
    This icon is used to represent assets that belongs to this class on "Asset Map" page.
    
    **NOTE**: This icon string should be a valid icon name from the SDL icon library, additionally if not icon is
              provided, the nodes in the map will be empty.
    """
    def __init__(self, id: Optional[str]=None, versionEdits: Optional[Array[VersionEdit]]=None, name: Optional[str]=None, meta: Optional[Meta]=None, version: Optional[int]=None, typeWithBindings: Optional[Type]=None, notUserGenerated: Optional[bool]=None, source: Optional[str]=None, displaySource: Optional[str]=None, trackingIdForImport: Optional[str]=None, typeIdent: Optional[str]=None, translatedName: Optional[str]=None, parentAssetClassRelations: Optional[Array[AssetClassParentChildRelation]]=None, childAssetClassRelations: Optional[Array[AssetClassParentChildRelation]]=None, countChildren: Optional[int]=None, hasChildren: Optional[bool]=None, assets: Optional[Array[ReliabilityAsset]]=None, countAssets: Optional[int]=None, failureModeLibrary: Optional[FailureModeLibrary]=None, failureModes: Optional[Array[FailureMode]]=None, countFailureModes: Optional[int]=None, expectedSensors: Optional[Array[ExpectedSensor]]=None, expectedSensorCount: Optional[int]=None, kpis: Optional[Array[str]]=None, linked3DModel: Optional[ReliabilityAsset3dmodel]=None, status: Optional[str]=None, hierarchyTemplate: Optional[AssetHierarchyTemplate]=None, definitionVersion: Optional[ReliabilityAssetClassDefinitionVersion]=None, mapModel: Optional[str]=None, displayParent: Optional[AssetClass]=None, mapIcon: Optional[str]=None) -> None: ...
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[AssetClass]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[AssetClass]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[AssetClass]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[AssetClass]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> AssetClass:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> AssetClass:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> AssetClass:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[AssetClass]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[AssetClass]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> AssetClass:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> AssetClass:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> AssetClass:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> AssetClass:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> AssetClass:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> AssetClass:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> AssetClass:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> AssetClass:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> AssetClass:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> AssetClass:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> AssetClass:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> AssetClass:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> AssetClass:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> AssetClass:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> AssetClass:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> AssetClass:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> AssetClass:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> AssetClass:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> AssetClass:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> AssetClass:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> AssetClass:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> AssetClass:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> AssetClass:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> AssetClass:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> AssetClass:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> AssetClass:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> AssetClass:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> AssetClass:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[AssetClass]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[AssetClass]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[AssetClass]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[AssetClass]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[AssetClass]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, AssetClass]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, AssetClass]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[AssetClass]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[AssetClass]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> AssetClass:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> AssetClass:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> AssetClass:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> AssetClass:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> AssetClass:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> AssetClass:
    """
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[AssetClass]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> AssetClass:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> AssetClass:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[AssetClass]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> AssetClass:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, spec: FetchSpec=None) -> FetchResult[AssetClass]:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, filter: Filter) -> FetchResult[AssetClass]:
    """
    ...
    """
        ...
    @classmethod
    def fetchObjStream(cls, spec: FetchStreamSpec=None) -> Union[Stream[AssetClass]]:
    """
    Fetches multiple obj instances based on a specification.  Only objs that the caller is authorized to fetch will be
    returned.
    ...
    """
        ...
    @classmethod
    def fetchMultiLocale(cls, spec: MultiLocaleFetchSpec=None) -> Union[Map[str, FetchResult[AssetClass]]]:
    """
    ...
    @overload
    @classmethod
    def evalFeatureSetBatch(cls, batch: Array[AssetClass], featureSet: Feature.Set, spec: EvalFeatureSpec=None) -> Union[Data]:
    """
    ...
    @overload
    @classmethod
    def evalFeaturesBatch(cls, batch: Array[AssetClass], features: Array[str], spec: EvalFeaturesSpec=None) -> Union[Data]:
    """
    ...
    """
        ...
    def get(self, include: str=None) -> Union[AssetClass]:
    """
    ...
    """
        ...
    def getSpecific(self, include: str=None) -> Union[AssetClass]:
    """
    ...
    """
        ...
    def getMissing(self, spec: GetMissingSpec) -> AssetClass:
    """
    ...
    """
        ...
    def getDirect(self, include: str=None) -> Union[AssetClass]:
    """
    ...
    """
        ...
    def applyReverseEdit(self, versionEdit: VersionEdit) -> AssetClass:
    """
    ...
    """
        ...
    @classmethod
    def fromString(cls, s: str) -> Union[AssetClass]:
    """
    ...
    """
        ...
    def create(self, spec: UpsertSpec=None) -> Union[AssetClass]:
    """
    ...
    """
        ...
    @classmethod
    def createBatch(cls, objs: Array[AssetClass], spec: UpsertSpec=None) -> Union[ObjList[AssetClass]]:
    """
    ...
    """
        ...
    @classmethod
    def createBatchObjStream(cls, objs: Stream[AssetClass], spec: CreateBatchObjStreamSpec=None) -> Union[ObjList[AssetClass]]:
    """
    Creates multiple instances of a C3 type. If the operation fails and {@link UpsertSpec#dontThrowOnBatchError} is not
    specified (the default), then a C3BatchException will be thrown.  Otherwise {@link errors will be reported in the
    returned {@link ObjList}.  This will fail if any of the instances already exist.
    ...
    """
        ...
    def update(self, srcObj: AssetClass=None, spec: UpsertSpec=None) -> Union[AssetClass]:
    """
    ...
    """
        ...
    def upsert(self, srcObj: AssetClass=None, spec: UpsertSpec=None) -> Union[AssetClass]:
    """
    ...
    """
        ...
    @overload
    def merge(self, spec: MergeSpec=None) -> Union[AssetClass]:
    """
    ...
    """
        ...
    @overload
    def merge(self, mergeInclude: str, spec: MergeSpec=None) -> Union[AssetClass]:
    """
    ...
    """
        ...
    def touch(self, spec: TouchSpec=None) -> Union[AssetClass]:
    """
    ...
    """
        ...
    @classmethod
    def updateBatch(cls, objs: Array[AssetClass], srcObjs: Array[AssetClass]=None, spec: UpsertSpec=None) -> Union[ObjList[AssetClass]]:
    """
    ...
    """
        ...
    @classmethod
    def updateObjs(cls, objs: Callable[[], Union[Array[AssetClass]]], spec: UpsertSpec=None) -> Union[ObjList[AssetClass]]:
    """
    ...
    """
        ...
    @classmethod
    def upsertBatch(cls, objs: Array[AssetClass], srcObjs: Array[AssetClass]=None, spec: UpsertSpec=None) -> Union[ObjList[AssetClass]]:
    """
    ...
    """
        ...
    @classmethod
    def upsertObjs(cls, objs: Callable[[], Union[Array[AssetClass]]], spec: UpsertSpec=None) -> Union[ObjList[AssetClass]]:
    """
    Creates instances of a C3 type if they don't already exist and updates them if they do exist. If the operation
    ...
    """
        ...
    @classmethod
    def touchBatch(cls, objs: Array[AssetClass], spec: TouchSpec=None) -> Union[ObjList[AssetClass]]:
    """
    ...
    @overload
    @classmethod
    def mergeBatch(cls, objs: Array[AssetClass], spec: MergeSpec=None) -> Union[ObjList[AssetClass]]:
    """
    ...
    @overload
    @classmethod
    def mergeBatch(cls, objs: Array[AssetClass], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[AssetClass]]:
    """
    Merges multiple instances of a C3 type or creates them if they don't exist. If the operation fails and {@link
    UpsertSpec#dontThrowOnBatchError} is not specified (the default), then a C3BatchException will be thrown.
    Otherwise errors will be reported in the returned {@link ObjList}.  The merge operation is described in the {@link
    ...
    """
        ...
    @classmethod
    def mergeObjs(cls, objs: Callable[[], Union[Array[AssetClass]]], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[AssetClass]]:
    """
    ...
    @overload
    @classmethod
    def mergeAll(cls, mergeObj: AssetClass, spec: MergeAllSpec=None) -> Union[int]:
    """
    ...
    @overload
    @classmethod
    def mergeAll(cls, mergeObj: AssetClass, mergeInclude: str, spec: MergeAllSpec=None) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def removeBatch(cls, objs: Array[AssetClass], spec: UpsertSpec=None) -> Union[ObjList[AssetClass]]:
    """
    ...
    """
        ...
    @classmethod
    def replace(cls, objs: Array[AssetClass], spec: UpsertSpec=None) -> Union[ObjList[AssetClass]]:
    """
    ...
    """
        ...
    def unremove(self) -> Union[AssetClass]:
    """
    ...
    """
        ...
    @classmethod
    def beforeCreate(cls, objs: Array[AssetClass]) -> ObjList[AssetClass]:
    """
    ...
    """
        ...
    @classmethod
    def beforeUpdate(cls, objs: Array[AssetClass]) -> ObjList[AssetClass]:
    """
    ...
    """
        ...
    @classmethod
    def beforeRemove(cls, objs: Array[AssetClass]) -> ObjList[AssetClass]:
    """
    ...
    """
        ...
    @classmethod
    def afterCreate(cls, objs: Array[AssetClass]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def afterUpdate(cls, objs: Array[AssetClass]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def afterRemove(cls, objs: Array[AssetClass]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def startImportData(cls, spec: StartImportDataSpec=None) -> PushStream[AssetClass]:
    """
    @return a push stream to import instances of this type.
    """
        ...
    @classmethod
    def startImportDataWithStats(cls, spec: StartImportDataSpec=None) -> PushStreamWithStats[AssetClass]:
    """
    @return a push stream to import instances of this type.
    """
        ...
    ...
    """
        ...
    @classmethod
    def forId(cls, id: str, failIfMissing: bool=None) -> Union[AssetClass]:
    """
    ...
    """
        ...
    def withoutIdentity(self) -> Union[AssetClass]:
    """
    ...
    """
        ...
    @classmethod
    def typeOfBatch(cls, objs: Array[AssetClass]) -> Union[Array[EntityType]]:
    """
    ...
    """
        ...
    @classmethod
    def dbEcho(cls, template: AssetClass=None, count: int=None, sendBack: bool=None) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def callbackLogic(cls, objs: Array[AssetClass], callback: Callable[[Union[AssetClass]], Union[AssetClass]]=None) -> ObjList[AssetClass]:
    """
    ...
    """
        ...
    @classmethod
    def afterCallbackLogic(cls, objs: Array[AssetClass], callback: Callable[[Union[AssetClass]], Union[AssetClass]]=None) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def createSensorRelationsForAllChildAssetsAndSensors(cls, parentAsset: ReliabilityAsset=None) -> Union[Array[str]]:
    """
    ...
    """
        ...
    @classmethod
    def createDiagramConfigs(cls, parentAsset: ReliabilityAsset=None) -> None:
    """
    ...
    """
        ...
    @classmethod
    def fetchAllClassMetricsForDiagram(cls, includeKpis: bool=None) -> Union[Array[str]]:
    """
    ...
    """
        ...
    @classmethod
    def fetchAllClassMetrics(cls, includeKpis: bool=None) -> Union[Array[str]]:
    """
    ...
    """
        ...
    @classmethod
    def fetchClassMetrics(cls, assetClasses: Array[AssetClass]=None, includeKpis: bool=None) -> Union[Array[str]]:
    """
    ...
    """
        ...
    def createCopy(self, newName: str=None) -> Union[AssetClass]:
    """
    ...
    """
        ...
    def addMissingAssetsFromHierarchyTemplate(self, filter: Filter=None) -> Union[Array[ReliabilityAsset]]:
    """
    ...
    """
        ...
    def createInstanceWithHierarchy(self, rootAssetName: str=None) -> Union[Array[ReliabilityAsset]]:
    """
    ...
    """
        ...
    def validateHierarchyForInstances(self, filter: Filter=None) -> bool:
    """
    ...
    """
        ...
    @classmethod
    def generateAssetHierarchyGraphFromRelationships(cls, asset: ReliabilityAsset=None) -> Union[any]:
    """
    ...
    """
        ...
    @classmethod
    def generateAssetHierarchyGraphFromAssetClass(cls, rootAssetClass: AssetClass=None) -> Union[any]:
    """
    Helper function to generate a graph of all asset relationships based on the asset children hierarchal relationships.
    ...
    """
        ...
    def addExpectedSensor(self, expectedSensor: ExpectedSensor=None) -> None:
    """
