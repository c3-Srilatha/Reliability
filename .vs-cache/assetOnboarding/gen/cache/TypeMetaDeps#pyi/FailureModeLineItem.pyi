...
from c3.reliabilityDataModel.FailureModePriority import FailureModePriority
from c3.platform.ObjError import ObjError
from c3.platform.ValueSpec import ValueSpec
from c3.platform.ObjBuilder import ObjBuilder
from c3.platform.Data import Data
from c3.platform.SchemaInfo import SchemaInfo
from c3.reliabilityCapability.OpenFailureModeLineItemExistingSpec import OpenFailureModeLineItemExistingSpec
...
from c3.reliabilityCapability.OpenFailureModeLineItemSpec import OpenFailureModeLineItemSpec
...
from c3.reliabilityCapability.ReliabilityAssetAlertFailureModeRelation import ReliabilityAssetAlertFailureModeRelation
...
from c3.reliabilityCapability.DeleteFailureModeLineItemSpec import DeleteFailureModeLineItemSpec
...
from c3.reliabilityDataModel.FailureModeRecommendation import FailureModeRecommendation
...
from c3.platform.MapBuilder import MapBuilder
from c3.reliabilityDataModel.FailureModeDiagnostic import FailureModeDiagnostic
from c3.platform.ExistsSpec import ExistsSpec

# Python definitions for the C3 type FailureModeLineItem


class FailureModeLineItem(AssetOnboardingMeta, ExemptFromFacilityFilter, AssetOnboardingImportTracking):
    """
    ...
    failureMode: Optional[FailureMode]=None
    """
    ...
    diagnostic: Optional[FailureModeDiagnostic]=None
    """
    The diagnostic to apply on the sensor data
    """

    sensorThreshold: Optional[float]=None
    """
    ...
    priority: Optional[FailureModePriority]=None
    """
    Priority
    """
    ...
    failureRecommendation: Optional[Array[FailureModeRecommendation]]=None
    """
    Recommended actions if this failure mode is recommended
    """

    numRecommendations: Optional[int]=None
    """
    Number of recommended actions
    """

    recommendedActionsCountString: Optional[str]=None
    """
    String that denotes how many recommended actions are associated with this entity.
    """

    alertRelations: Optional[Array[ReliabilityAssetAlertFailureModeRelation]]=None
    """
    ...
    """
    def __init__(self, assetOnboardingSourceFile: Optional[AssetOnboardingSourceFile]=None, configurationLastUpdated: Optional[datetime]=None, id: Optional[str]=None, versionEdits: Optional[Array[VersionEdit]]=None, name: Optional[str]=None, meta: Optional[Meta]=None, version: Optional[int]=None, typeWithBindings: Optional[Type]=None, trackingIdForImport: Optional[str]=None, description: Optional[str]=None, failureMode: Optional[FailureMode]=None, expectedSensor: Optional[ExpectedSensor]=None, diagnostic: Optional[FailureModeDiagnostic]=None, sensorThreshold: Optional[float]=None, exceptions: Optional[str]=None, faultCategory: Optional[str]=None, priority: Optional[FailureModePriority]=None, failureModeLibrary: Optional[FailureModeLibrary]=None, failureRecommendation: Optional[Array[FailureModeRecommendation]]=None, numRecommendations: Optional[int]=None, recommendedActionsCountString: Optional[str]=None, alertRelations: Optional[Array[ReliabilityAssetAlertFailureModeRelation]]=None, updatedTimestamp: Optional[datetime]=None) -> None: ...
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[FailureModeLineItem]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[FailureModeLineItem]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[FailureModeLineItem]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[FailureModeLineItem]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> FailureModeLineItem:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> FailureModeLineItem:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> FailureModeLineItem:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[FailureModeLineItem]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[FailureModeLineItem]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> FailureModeLineItem:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> FailureModeLineItem:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> FailureModeLineItem:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> FailureModeLineItem:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> FailureModeLineItem:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> FailureModeLineItem:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> FailureModeLineItem:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> FailureModeLineItem:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> FailureModeLineItem:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> FailureModeLineItem:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> FailureModeLineItem:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> FailureModeLineItem:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> FailureModeLineItem:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> FailureModeLineItem:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> FailureModeLineItem:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> FailureModeLineItem:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> FailureModeLineItem:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> FailureModeLineItem:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> FailureModeLineItem:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> FailureModeLineItem:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> FailureModeLineItem:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> FailureModeLineItem:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> FailureModeLineItem:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> FailureModeLineItem:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> FailureModeLineItem:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> FailureModeLineItem:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> FailureModeLineItem:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> FailureModeLineItem:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[FailureModeLineItem]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[FailureModeLineItem]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[FailureModeLineItem]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[FailureModeLineItem]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[FailureModeLineItem]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, FailureModeLineItem]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, FailureModeLineItem]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[FailureModeLineItem]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[FailureModeLineItem]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> FailureModeLineItem:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> FailureModeLineItem:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> FailureModeLineItem:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> FailureModeLineItem:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> FailureModeLineItem:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> FailureModeLineItem:
    """
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[FailureModeLineItem]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> FailureModeLineItem:
    """
    ...
    """
        ...
    def afterMake(self) -> FailureModeLineItem:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> FailureModeLineItem:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[FailureModeLineItem]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> FailureModeLineItem:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, spec: FetchSpec=None) -> FetchResult[FailureModeLineItem]:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, filter: Filter) -> FetchResult[FailureModeLineItem]:
    """
    ...
    """
        ...
    @classmethod
    def fetchObjStream(cls, spec: FetchStreamSpec=None) -> Union[Stream[FailureModeLineItem]]:
    """
    Fetches multiple obj instances based on a specification.  Only objs that the caller is authorized to fetch will be
    returned.
    ...
    """
        ...
    @classmethod
    def fetchMultiLocale(cls, spec: MultiLocaleFetchSpec=None) -> Union[Map[str, FetchResult[FailureModeLineItem]]]:
    """
    ...
    """
        ...
    def get(self, include: str=None) -> Union[FailureModeLineItem]:
    """
    ...
    """
        ...
    def getSpecific(self, include: str=None) -> Union[FailureModeLineItem]:
    """
    ...
    """
        ...
    def getMissing(self, spec: GetMissingSpec) -> FailureModeLineItem:
    """
    ...
    """
        ...
    def getDirect(self, include: str=None) -> Union[FailureModeLineItem]:
    """
    ...
    """
        ...
    def applyReverseEdit(self, versionEdit: VersionEdit) -> FailureModeLineItem:
    """
    ...
    """
        ...
    @classmethod
    def fromString(cls, s: str) -> Union[FailureModeLineItem]:
    """
    ...
    """
        ...
    def create(self, spec: UpsertSpec=None) -> Union[FailureModeLineItem]:
    """
    ...
    """
        ...
    @classmethod
    def createBatch(cls, objs: Array[FailureModeLineItem], spec: UpsertSpec=None) -> Union[ObjList[FailureModeLineItem]]:
    """
    ...
    """
        ...
    @classmethod
    def createBatchObjStream(cls, objs: Stream[FailureModeLineItem], spec: CreateBatchObjStreamSpec=None) -> Union[ObjList[FailureModeLineItem]]:
    """
    Creates multiple instances of a C3 type. If the operation fails and {@link UpsertSpec#dontThrowOnBatchError} is not
    specified (the default), then a C3BatchException will be thrown.  Otherwise {@link errors will be reported in the
    returned {@link ObjList}.  This will fail if any of the instances already exist.
    ...
    """
        ...
    def update(self, srcObj: FailureModeLineItem=None, spec: UpsertSpec=None) -> Union[FailureModeLineItem]:
    """
    ...
    """
        ...
    def upsert(self, srcObj: FailureModeLineItem=None, spec: UpsertSpec=None) -> Union[FailureModeLineItem]:
    """
    ...
    """
        ...
    @overload
    def merge(self, spec: MergeSpec=None) -> Union[FailureModeLineItem]:
    """
    ...
    """
        ...
    @overload
    def merge(self, mergeInclude: str, spec: MergeSpec=None) -> Union[FailureModeLineItem]:
    """
    ...
    """
        ...
    def touch(self, spec: TouchSpec=None) -> Union[FailureModeLineItem]:
    """
    ...
    """
        ...
    @classmethod
    def updateBatch(cls, objs: Array[FailureModeLineItem], srcObjs: Array[FailureModeLineItem]=None, spec: UpsertSpec=None) -> Union[ObjList[FailureModeLineItem]]:
    """
    ...
    """
        ...
    @classmethod
    def updateObjs(cls, objs: Callable[[], Union[Array[FailureModeLineItem]]], spec: UpsertSpec=None) -> Union[ObjList[FailureModeLineItem]]:
    """
    ...
    """
        ...
    @classmethod
    def upsertBatch(cls, objs: Array[FailureModeLineItem], srcObjs: Array[FailureModeLineItem]=None, spec: UpsertSpec=None) -> Union[ObjList[FailureModeLineItem]]:
    """
    ...
    """
        ...
    @classmethod
    def upsertObjs(cls, objs: Callable[[], Union[Array[FailureModeLineItem]]], spec: UpsertSpec=None) -> Union[ObjList[FailureModeLineItem]]:
    """
    Creates instances of a C3 type if they don't already exist and updates them if they do exist. If the operation
    ...
    """
        ...
    @classmethod
    def touchBatch(cls, objs: Array[FailureModeLineItem], spec: TouchSpec=None) -> Union[ObjList[FailureModeLineItem]]:
    """
    ...
    @overload
    @classmethod
    def mergeBatch(cls, objs: Array[FailureModeLineItem], spec: MergeSpec=None) -> Union[ObjList[FailureModeLineItem]]:
    """
    ...
    @overload
    @classmethod
    def mergeBatch(cls, objs: Array[FailureModeLineItem], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[FailureModeLineItem]]:
    """
    Merges multiple instances of a C3 type or creates them if they don't exist. If the operation fails and {@link
    UpsertSpec#dontThrowOnBatchError} is not specified (the default), then a C3BatchException will be thrown.
    Otherwise errors will be reported in the returned {@link ObjList}.  The merge operation is described in the {@link
    ...
    """
        ...
    @classmethod
    def mergeObjs(cls, objs: Callable[[], Union[Array[FailureModeLineItem]]], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[FailureModeLineItem]]:
    """
    ...
    @overload
    @classmethod
    def mergeAll(cls, mergeObj: FailureModeLineItem, spec: MergeAllSpec=None) -> Union[int]:
    """
    ...
    @overload
    @classmethod
    def mergeAll(cls, mergeObj: FailureModeLineItem, mergeInclude: str, spec: MergeAllSpec=None) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def removeBatch(cls, objs: Array[FailureModeLineItem], spec: UpsertSpec=None) -> Union[ObjList[FailureModeLineItem]]:
    """
    ...
    """
        ...
    @classmethod
    def replace(cls, objs: Array[FailureModeLineItem], spec: UpsertSpec=None) -> Union[ObjList[FailureModeLineItem]]:
    """
    ...
    """
        ...
    def unremove(self) -> Union[FailureModeLineItem]:
    """
    ...
    """
        ...
    @classmethod
    def beforeCreate(cls, objs: Array[FailureModeLineItem]) -> ObjList[FailureModeLineItem]:
    """
    ...
    """
        ...
    @classmethod
    def beforeUpdate(cls, objs: Array[FailureModeLineItem]) -> ObjList[FailureModeLineItem]:
    """
    ...
    """
        ...
    @classmethod
    def beforeRemove(cls, objs: Array[FailureModeLineItem]) -> ObjList[FailureModeLineItem]:
    """
    ...
    """
        ...
    @classmethod
    def afterCreate(cls, objs: Array[FailureModeLineItem]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def afterUpdate(cls, objs: Array[FailureModeLineItem]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def afterRemove(cls, objs: Array[FailureModeLineItem]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def startImportData(cls, spec: StartImportDataSpec=None) -> PushStream[FailureModeLineItem]:
    """
    @return a push stream to import instances of this type.
    """
        ...
    @classmethod
    def startImportDataWithStats(cls, spec: StartImportDataSpec=None) -> PushStreamWithStats[FailureModeLineItem]:
    """
    @return a push stream to import instances of this type.
    """
        ...
    ...
    """
        ...
    @classmethod
    def forId(cls, id: str, failIfMissing: bool=None) -> Union[FailureModeLineItem]:
    """
    ...
    """
        ...
    def withoutIdentity(self) -> Union[FailureModeLineItem]:
    """
    ...
    """
        ...
    @classmethod
    def typeOfBatch(cls, objs: Array[FailureModeLineItem]) -> Union[Array[EntityType]]:
    """
    ...
    """
        ...
    @classmethod
    def dbEcho(cls, template: FailureModeLineItem=None, count: int=None, sendBack: bool=None) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def callbackLogic(cls, objs: Array[FailureModeLineItem], callback: Callable[[Union[FailureModeLineItem]], Union[FailureModeLineItem]]=None) -> ObjList[FailureModeLineItem]:
    """
    ...
    """
        ...
    @classmethod
    def afterCallbackLogic(cls, objs: Array[FailureModeLineItem], callback: Callable[[Union[FailureModeLineItem]], Union[FailureModeLineItem]]=None) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def filterLineItemsByExpectedSensor(cls, lineItems: Array[FailureModeLineItem]=None, expectedSensors: Array[ExpectedSensor]=None) -> Union[Array[FailureModeLineItem]]:
    """
    ...
    """
        ...
    @classmethod
    def fetchWithActiveStatus(cls, spec: FetchSpec=None, expectedSensors: Array[ExpectedSensor]=None) -> Union[FetchResult[FailureModeLineItemWithActiveStatus]]:
    """
    ...
    """
        ...
    @classmethod
    def cleanupFailureModeRelations(cls, failureModeLineItemIds: Array[FailureModeLineItem]) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def editFailureModeLineItemOnFormSubmit(cls, formObject: any=None) -> None:
    """
    The method to be edit {@link FailureModeLineItem} after submitting EditFailureModeLibraryDetailForm from the UI.
    """
        ...
    @classmethod
    def deleteAlertFailureModeLineItemRelations(cls, formObject: DeleteFailureModeLineItemSpec=None) -> None:
    """
    ...
    """
        ...
    @classmethod
    def createFailureModeRecommendation(cls, formObject: any=None) -> None:
    """
    The method to be create FailureModeRecommendations after submitting FailureModeRecommendationAddModal from the UI.
    """
        ...
    @classmethod
    def deleteFailureModeLineItemOnFormSubmit(cls, formObject: DeleteFailureModeLineItemSpec) -> None:
    """
    ...
    """
        ...
    @classmethod
    def doDeleteFailureModeLineItemRelations(cls, recRelationType: Type, from_: str=None, relation: str=None) -> None:
    """
    Helper function for {@link deleteAlertFailureModeLineItemRelations}.
    """
        ...
    @classmethod
    def createFailureModeLineItemNew(cls, formObject: OpenFailureModeLineItemSpec) -> Union[FailureModeLineItem]:
    """
    Creates a new @{link FailureModeLineItem} from scratch.
    """
        ...
    @classmethod
    def createFailureModeLineItemExisting(cls, formObject: OpenFailureModeLineItemExistingSpec) -> Union[FailureModeLineItem]:
    """
