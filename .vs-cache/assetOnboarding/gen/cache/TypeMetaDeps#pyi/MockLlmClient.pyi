...
# Python definitions for the C3 type MockLlmClient


class MockLlmClient(GenaiCore.Llm.Completion.Client):
    """
    ...
    **NOTE** the client's {@link #model}'s `defaultOptions` has precedence over the client's.
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[MockLlmClient]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[MockLlmClient]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[MockLlmClient]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[MockLlmClient]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> MockLlmClient:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> MockLlmClient:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> MockLlmClient:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[MockLlmClient]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[MockLlmClient]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> MockLlmClient:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> MockLlmClient:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> MockLlmClient:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> MockLlmClient:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> MockLlmClient:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> MockLlmClient:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> MockLlmClient:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> MockLlmClient:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> MockLlmClient:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> MockLlmClient:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> MockLlmClient:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> MockLlmClient:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> MockLlmClient:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> MockLlmClient:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> MockLlmClient:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> MockLlmClient:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> MockLlmClient:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> MockLlmClient:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> MockLlmClient:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> MockLlmClient:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> MockLlmClient:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> MockLlmClient:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> MockLlmClient:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> MockLlmClient:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> MockLlmClient:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> MockLlmClient:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> MockLlmClient:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> MockLlmClient:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[MockLlmClient]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[MockLlmClient]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[MockLlmClient]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[MockLlmClient]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[MockLlmClient]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, MockLlmClient]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, MockLlmClient]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[MockLlmClient]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[MockLlmClient]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> MockLlmClient:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> MockLlmClient:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> MockLlmClient:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> MockLlmClient:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> MockLlmClient:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> MockLlmClient:
    """
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[MockLlmClient]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> MockLlmClient:
    """
    ...
    """
        ...
    def afterMake(self) -> MockLlmClient:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> MockLlmClient:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[MockLlmClient]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> MockLlmClient:
    """
    ...
    """
        ...
    @classmethod
    def fromString(cls, s: str) -> Union[MockLlmClient]:
    """
    ...
    """
        ...
    @classmethod
    def forName(cls, name: str, failIfMissing: bool=None) -> Union[MockLlmClient]:
    """
    ...
    """
        ...
    @classmethod
    def allCached(cls, doNotProduceAll: bool=None) -> Union[Stream[MockLlmClient]]:
    """
    ...
    """
        ...
    @classmethod
    def find(cls, filter: str=None, doNotProduceAll: bool=None) -> Union[Stream[MockLlmClient]]:
    """
    ...
    """
        ...
    @classmethod
    def findBy(cls, field: str, value: Any, doNotProduceAll: bool=None) -> Union[Stream[MockLlmClient]]:
    """
    @param doNotProduceAll if true, will not populate cache and only return available cached instances. Will call
           `produceAll` if cache is empty or if Ann.cache.all is true & data has not previously been fetched.
    @return existing instances of this type that satisfy filter from data cache.
    """
        ...
    @classmethod
    def findByCacheKey(cls, key: str) -> Union[MockLlmClient]:
    """
    ...
    """
        ...
    @classmethod
    def forCacheKey(cls, key: str) -> Union[MockLlmClient]:
    """
    Returns cached instance by key, with secrets removed.
    """
        ...
    def getCached(self) -> Union[MockLlmClient]:
    """
    ...
    """
        ...
    def refreshCache(self) -> Union[MockLlmClient]:
    """
    ...
    """
        ...
    @classmethod
    def produce(cls, key: str) -> Union[MockLlmClient]:
    """
    Should produce an entry for the cache key. This method should not be called directly.
    """
        ...
    @classmethod
    def produceAll(cls) -> Union[Map[str, MockLlmClient]]:
    """
    ...
    """
        ...
    @classmethod
    def doProduceAll(cls) -> Union[Map[str, MockLlmClient]]:
    """
    ...
    """
        ...
    def getConfig(self) -> MockLlmClient:
    """
    ...
    """
        ...
    def getSecret(self) -> MockLlmClient:
    """
    ...
    """
        ...
    def withConfigKey(self, configKey: str) -> MockLlmClient:
    """
    ...
    """
        ...
    def withoutConfigKey(self) -> MockLlmClient:
    """
    @return copy without config key.
    """
        ...
    @classmethod
    def forConfigKey(cls, configKey: str) -> Union[MockLlmClient]:
    """
    ...
    """
        ...
    @classmethod
    def listConfigs(cls, parallel: bool=None, filter: Callable[[str], bool]=None) -> Union[Stream[MockLlmClient]]:
    """
    @param
    ...
    """
        ...
    @overload
    def setConfigValues(self, from_: MockLlmClient, override: str=None) -> None:
    """
    ...
    """
        ...
    @overload
    def setSecretValues(self, from_: MockLlmClient, override: str=None) -> None:
    """
    ...
    """
        ...
    @classmethod
    def loadConfigAndSecret(cls, configKey: str) -> Union[MockLlmClient]:
    """
    ...
    """
        ...
    def removeSecrets(self) -> Union[MockLlmClient]:
    """
    @return this config without any secret values.
    """
        ...
    def removeNonSecrets(self) -> Union[MockLlmClient]:
    """
    @return this config with only secret values.
    """
        ...
    def validate(self) -> MockLlmClient:
    """
