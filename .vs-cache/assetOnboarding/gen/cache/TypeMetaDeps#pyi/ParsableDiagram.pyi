...
# Python definitions for the C3 type ParsableDiagram


class ParsableDiagram(MlSubject, AssetOnboardingImportTracking):
    """
    ...
    """
    def __init__(self, id: Optional[str]=None, trackingIdForImport: Optional[str]=None, typeIdent: Optional[str]=None, versionEdits: Optional[Array[VersionEdit]]=None, name: Optional[str]=None, meta: Optional[Meta]=None, version: Optional[int]=None, typeWithBindings: Optional[Type]=None, source: Optional[File]=None, imageFile: Optional[File]=None, sourceDiagram: Optional[SourceParsableDiagram]=None, pidNumber: Optional[str]=None, extracts: Optional[Array[ParsedDiagramExtract]]=None, latestExtract: Optional[ParsedDiagramExtract]=None, latestExtractSensorCount: Optional[int]=None, assets: Optional[Array[ParsedAsset]]=None, sensors: Optional[Array[ParsedSensor]]=None, connectedAssetRelations: Optional[Array[ParsableDiagramToPhysicalAssetRelation]]=None, numConnectedAssets: Optional[int]=None, lastUpdate: Optional[ParsableDiagramUpdateInfo]=None, parsingStatus: Optional[str]=None, displayStatus: Optional[str]=None) -> None: ...
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[ParsableDiagram]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[ParsableDiagram]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[ParsableDiagram]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[ParsableDiagram]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> ParsableDiagram:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> ParsableDiagram:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> ParsableDiagram:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[ParsableDiagram]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[ParsableDiagram]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> ParsableDiagram:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> ParsableDiagram:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> ParsableDiagram:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> ParsableDiagram:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> ParsableDiagram:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> ParsableDiagram:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> ParsableDiagram:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> ParsableDiagram:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> ParsableDiagram:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> ParsableDiagram:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> ParsableDiagram:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> ParsableDiagram:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> ParsableDiagram:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> ParsableDiagram:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> ParsableDiagram:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> ParsableDiagram:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> ParsableDiagram:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> ParsableDiagram:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> ParsableDiagram:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> ParsableDiagram:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> ParsableDiagram:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> ParsableDiagram:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> ParsableDiagram:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> ParsableDiagram:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> ParsableDiagram:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> ParsableDiagram:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> ParsableDiagram:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> ParsableDiagram:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[ParsableDiagram]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[ParsableDiagram]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[ParsableDiagram]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[ParsableDiagram]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[ParsableDiagram]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, ParsableDiagram]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, ParsableDiagram]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[ParsableDiagram]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[ParsableDiagram]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> ParsableDiagram:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> ParsableDiagram:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> ParsableDiagram:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> ParsableDiagram:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> ParsableDiagram:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> ParsableDiagram:
    """
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[ParsableDiagram]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> ParsableDiagram:
    """
    ...
    """
        ...
    def afterMake(self) -> ParsableDiagram:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> ParsableDiagram:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[ParsableDiagram]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> ParsableDiagram:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, spec: FetchSpec=None) -> FetchResult[ParsableDiagram]:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, filter: Filter) -> FetchResult[ParsableDiagram]:
    """
    ...
    """
        ...
    @classmethod
    def fetchObjStream(cls, spec: FetchStreamSpec=None) -> Union[Stream[ParsableDiagram]]:
    """
    Fetches multiple obj instances based on a specification.  Only objs that the caller is authorized to fetch will be
    returned.
    ...
    """
        ...
    @classmethod
    def fetchMultiLocale(cls, spec: MultiLocaleFetchSpec=None) -> Union[Map[str, FetchResult[ParsableDiagram]]]:
    """
    ...
    @overload
    @classmethod
    def evalFeatureSetBatch(cls, batch: Array[ParsableDiagram], featureSet: Feature.Set, spec: EvalFeatureSpec=None) -> Union[Data]:
    """
    ...
    @overload
    @classmethod
    def evalFeaturesBatch(cls, batch: Array[ParsableDiagram], features: Array[str], spec: EvalFeaturesSpec=None) -> Union[Data]:
    """
    ...
    """
        ...
    @classmethod
    def fromString(cls, s: str) -> Union[ParsableDiagram]:
    """
    ...
    **NOTE**: The method is synchronous and is not meant to be used for large population. For large-scale inference
    ...
    """
        ...
    def get(self, include: str=None) -> Union[ParsableDiagram]:
    """
    ...
    """
        ...
    def getSpecific(self, include: str=None) -> Union[ParsableDiagram]:
    """
    ...
    """
        ...
    def getMissing(self, spec: GetMissingSpec) -> ParsableDiagram:
    """
    ...
    """
        ...
    def getDirect(self, include: str=None) -> Union[ParsableDiagram]:
    """
    ...
    """
        ...
    def applyReverseEdit(self, versionEdit: VersionEdit) -> ParsableDiagram:
    """
    ...
    """
        ...
    def create(self, spec: UpsertSpec=None) -> Union[ParsableDiagram]:
    """
    ...
    """
        ...
    @classmethod
    def createBatch(cls, objs: Array[ParsableDiagram], spec: UpsertSpec=None) -> Union[ObjList[ParsableDiagram]]:
    """
    ...
    """
        ...
    @classmethod
    def createBatchObjStream(cls, objs: Stream[ParsableDiagram], spec: CreateBatchObjStreamSpec=None) -> Union[ObjList[ParsableDiagram]]:
    """
    Creates multiple instances of a C3 type. If the operation fails and {@link UpsertSpec#dontThrowOnBatchError} is not
    specified (the default), then a C3BatchException will be thrown.  Otherwise {@link errors will be reported in the
    returned {@link ObjList}.  This will fail if any of the instances already exist.
    ...
    """
        ...
    def update(self, srcObj: ParsableDiagram=None, spec: UpsertSpec=None) -> Union[ParsableDiagram]:
    """
    ...
    """
        ...
    def upsert(self, srcObj: ParsableDiagram=None, spec: UpsertSpec=None) -> Union[ParsableDiagram]:
    """
    ...
    """
        ...
    @overload
    def merge(self, spec: MergeSpec=None) -> Union[ParsableDiagram]:
    """
    ...
    """
        ...
    @overload
    def merge(self, mergeInclude: str, spec: MergeSpec=None) -> Union[ParsableDiagram]:
    """
    ...
    """
        ...
    def touch(self, spec: TouchSpec=None) -> Union[ParsableDiagram]:
    """
    ...
    """
        ...
    @classmethod
    def updateBatch(cls, objs: Array[ParsableDiagram], srcObjs: Array[ParsableDiagram]=None, spec: UpsertSpec=None) -> Union[ObjList[ParsableDiagram]]:
    """
    ...
    """
        ...
    @classmethod
    def updateObjs(cls, objs: Callable[[], Union[Array[ParsableDiagram]]], spec: UpsertSpec=None) -> Union[ObjList[ParsableDiagram]]:
    """
    ...
    """
        ...
    @classmethod
    def upsertBatch(cls, objs: Array[ParsableDiagram], srcObjs: Array[ParsableDiagram]=None, spec: UpsertSpec=None) -> Union[ObjList[ParsableDiagram]]:
    """
    ...
    """
        ...
    @classmethod
    def upsertObjs(cls, objs: Callable[[], Union[Array[ParsableDiagram]]], spec: UpsertSpec=None) -> Union[ObjList[ParsableDiagram]]:
    """
    Creates instances of a C3 type if they don't already exist and updates them if they do exist. If the operation
    ...
    """
        ...
    @classmethod
    def touchBatch(cls, objs: Array[ParsableDiagram], spec: TouchSpec=None) -> Union[ObjList[ParsableDiagram]]:
    """
    ...
    @overload
    @classmethod
    def mergeBatch(cls, objs: Array[ParsableDiagram], spec: MergeSpec=None) -> Union[ObjList[ParsableDiagram]]:
    """
    ...
    @overload
    @classmethod
    def mergeBatch(cls, objs: Array[ParsableDiagram], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[ParsableDiagram]]:
    """
    Merges multiple instances of a C3 type or creates them if they don't exist. If the operation fails and {@link
    UpsertSpec#dontThrowOnBatchError} is not specified (the default), then a C3BatchException will be thrown.
    Otherwise errors will be reported in the returned {@link ObjList}.  The merge operation is described in the {@link
    ...
    """
        ...
    @classmethod
    def mergeObjs(cls, objs: Callable[[], Union[Array[ParsableDiagram]]], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[ParsableDiagram]]:
    """
    ...
    @overload
    @classmethod
    def mergeAll(cls, mergeObj: ParsableDiagram, spec: MergeAllSpec=None) -> Union[int]:
    """
    ...
    @overload
    @classmethod
    def mergeAll(cls, mergeObj: ParsableDiagram, mergeInclude: str, spec: MergeAllSpec=None) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def removeBatch(cls, objs: Array[ParsableDiagram], spec: UpsertSpec=None) -> Union[ObjList[ParsableDiagram]]:
    """
    ...
    """
        ...
    @classmethod
    def replace(cls, objs: Array[ParsableDiagram], spec: UpsertSpec=None) -> Union[ObjList[ParsableDiagram]]:
    """
    ...
    """
        ...
    def unremove(self) -> Union[ParsableDiagram]:
    """
    ...
    """
        ...
    @classmethod
    def beforeCreate(cls, objs: Array[ParsableDiagram]) -> ObjList[ParsableDiagram]:
    """
    ...
    """
        ...
    @classmethod
    def beforeUpdate(cls, objs: Array[ParsableDiagram]) -> ObjList[ParsableDiagram]:
    """
    ...
    """
        ...
    @classmethod
    def beforeRemove(cls, objs: Array[ParsableDiagram]) -> ObjList[ParsableDiagram]:
    """
    ...
    """
        ...
    @classmethod
    def afterCreate(cls, objs: Array[ParsableDiagram]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def afterUpdate(cls, objs: Array[ParsableDiagram]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def afterRemove(cls, objs: Array[ParsableDiagram]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def startImportData(cls, spec: StartImportDataSpec=None) -> PushStream[ParsableDiagram]:
    """
    @return a push stream to import instances of this type.
    """
        ...
    @classmethod
    def startImportDataWithStats(cls, spec: StartImportDataSpec=None) -> PushStreamWithStats[ParsableDiagram]:
    """
    @return a push stream to import instances of this type.
    """
        ...
    ...
    """
        ...
    @classmethod
    def forId(cls, id: str, failIfMissing: bool=None) -> Union[ParsableDiagram]:
    """
    ...
    """
        ...
    def withoutIdentity(self) -> Union[ParsableDiagram]:
    """
    ...
    """
        ...
    @classmethod
    def typeOfBatch(cls, objs: Array[ParsableDiagram]) -> Union[Array[EntityType]]:
    """
    ...
    """
        ...
    @classmethod
    def dbEcho(cls, template: ParsableDiagram=None, count: int=None, sendBack: bool=None) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def callbackLogic(cls, objs: Array[ParsableDiagram], callback: Callable[[Union[ParsableDiagram]], Union[ParsableDiagram]]=None) -> ObjList[ParsableDiagram]:
    """
    ...
    """
        ...
    @classmethod
    def afterCallbackLogic(cls, objs: Array[ParsableDiagram], callback: Callable[[Union[ParsableDiagram]], Union[ParsableDiagram]]=None) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def deleteBatch(cls, diagrams: Array[ParsableDiagram]) -> Union[ObjList[ParsableDiagram]]:
    """
