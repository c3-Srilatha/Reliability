...
from c3.assetOnboarding.SensorSettingsModalConfigData import SensorSettingsModalConfigData
...
from c3.uiConfigurability.UiConfigGetSpec import UiConfigGetSpec
...
from c3.assetOnboarding.PendingSensorSettingsChanges import PendingSensorSettingsChanges
...
# Python definitions for the C3 type ReliabilityApplicationState


class ReliabilityApplicationState(UiSdlApplicationState, UiConfigGetter, UiTimezoneState):
    """
    ...
    selectedEntityIds: Optional[Array[str]]=None
    """
    ...
    selectedSidePanelEntityId: Optional[str]=None
    """
    ...
    selectedTopFailureModeCardListItemId: Optional[str]=None
    """
    The id of the selected item on CaseDetail and AlertDetail Page.
    """

    selectedRowData: Optional[any]=None
    """
    ...
    selectedCardData: Optional[any]=None
    """
    ...
    filterPanelValue: Optional[any]=None
    """
    ...
    isUserUnauthorized: Optional[bool]=None
    """
    ...
    **Note**: This field is used for Latest Correlation Configuration Page, and is populated using
    ...
    selectedAlertParentIds: Optional[Array[str]]=None
    """
    ...
    alertFilteringStartDate: Optional[str]=None
    """
    ...
    **NOTE**: Is expected that this field contains a date in ISO format. (ex: `2024-04-11T06:00:00.000Z`)
    ...
    pendingSensorSettingsChanges: Optional[PendingSensorSettingsChanges]=None
    """
    ...
    """
    def __init__(self, meta: Optional[Meta]=None, id: Optional[str]=None, name: Optional[str]=None, dataSpec: Optional[UiSdlNoData]=None, disableDataRequestOnFirstRender: Optional[bool]=None, triggersRegistered: Optional[bool]=None, wrapWithMetadataId: Optional[bool]=None, REDUX_NAMESPACE: Optional[str]=None, effectTriggers: Optional[Array[UiSdlEffectTrigger]]=None, uiTimezone: Optional[str]=None, uiTimezoneLabel: Optional[str]=None, uiTimezoneOffset: Optional[str]=None, selectedEntityId: Optional[str]=None, selectedEntityIds: Optional[Array[str]]=None, selectedAssetId: Optional[str]=None, selectedSidePanelEntityId: Optional[str]=None, selectedTopFailureModeCardListItemId: Optional[str]=None, selectedRowData: Optional[any]=None, selectedCardData: Optional[any]=None, inlineNotificationConfig: Optional[any]=None, filterPanelValue: Optional[any]=None, configIds: Optional[Array[str]]=None, selectedTopFailureModeCardListItemFMLIId: Optional[str]=None, selectedFMRecommendationsGridItemId: Optional[str]=None, selectedName: Optional[str]=None, selectedNameSidePanel: Optional[str]=None, addToCaseFromSidePanel: Optional[bool]=None, allFacilities: Optional[Array[Facility]]=None, isUserUnauthorized: Optional[bool]=None, selectedFacilities: Optional[Array[str]]=None, contentFrameSubtitle: Optional[str]=None, fmliToBeDeleted: Optional[str]=None, comparisonModel: Optional[any]=None, presetFilterPanelStatus: Optional[bool]=None, latestCorrelationConfig: Optional[BulkSensorAssociationUiSettings]=None, selectedAlertParentIds: Optional[Array[str]]=None, selectedComment: Optional[str]=None, showSwapAssetAffectedSensorGrid: Optional[bool]=None, selectedAssetModelRelation: Optional[ReliabilityAssetToModelRelation]=None, selectedChartDate: Optional[TimeInfo]=None, alertFilteringStartDate: Optional[str]=None, alertFilteringStartDatePeriod: Optional[str]=None, workOrdersGridId: Optional[str]=None, retrainModelDataSourceId: Optional[str]=None, sensorSettingsModalConfigData: Optional[SensorSettingsModalConfigData]=None, pendingSensorSettingsChanges: Optional[PendingSensorSettingsChanges]=None, mlProjectId: Optional[str]=None) -> None: ...
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[ReliabilityApplicationState]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[ReliabilityApplicationState]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[ReliabilityApplicationState]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[ReliabilityApplicationState]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> ReliabilityApplicationState:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> ReliabilityApplicationState:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> ReliabilityApplicationState:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[ReliabilityApplicationState]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[ReliabilityApplicationState]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> ReliabilityApplicationState:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> ReliabilityApplicationState:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> ReliabilityApplicationState:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> ReliabilityApplicationState:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> ReliabilityApplicationState:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> ReliabilityApplicationState:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> ReliabilityApplicationState:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> ReliabilityApplicationState:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> ReliabilityApplicationState:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> ReliabilityApplicationState:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> ReliabilityApplicationState:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> ReliabilityApplicationState:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> ReliabilityApplicationState:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> ReliabilityApplicationState:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> ReliabilityApplicationState:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> ReliabilityApplicationState:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> ReliabilityApplicationState:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> ReliabilityApplicationState:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> ReliabilityApplicationState:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> ReliabilityApplicationState:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> ReliabilityApplicationState:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> ReliabilityApplicationState:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> ReliabilityApplicationState:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> ReliabilityApplicationState:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> ReliabilityApplicationState:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> ReliabilityApplicationState:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> ReliabilityApplicationState:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> ReliabilityApplicationState:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[ReliabilityApplicationState]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[ReliabilityApplicationState]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[ReliabilityApplicationState]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[ReliabilityApplicationState]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[ReliabilityApplicationState]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, ReliabilityApplicationState]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, ReliabilityApplicationState]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[ReliabilityApplicationState]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[ReliabilityApplicationState]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> ReliabilityApplicationState:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> ReliabilityApplicationState:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> ReliabilityApplicationState:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> ReliabilityApplicationState:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> ReliabilityApplicationState:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> ReliabilityApplicationState:
    """
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[ReliabilityApplicationState]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> ReliabilityApplicationState:
    """
    ...
    """
        ...
    def afterMake(self) -> ReliabilityApplicationState:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> ReliabilityApplicationState:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[ReliabilityApplicationState]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> ReliabilityApplicationState:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, spec: FetchSpec=None) -> FetchResult[ReliabilityApplicationState]:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, filter: Filter) -> FetchResult[ReliabilityApplicationState]:
    """
    ...
    """
        ...
    @classmethod
    def fetchObjStream(cls, spec: FetchStreamSpec=None) -> Union[Stream[ReliabilityApplicationState]]:
    """
    Fetches multiple obj instances based on a specification.  Only objs that the caller is authorized to fetch will be
    returned.
    ...
    """
        ...
    @classmethod
    def fetchMultiLocale(cls, spec: MultiLocaleFetchSpec=None) -> Union[Map[str, FetchResult[ReliabilityApplicationState]]]:
    """
    ...
    """
        ...
    def dependencies(self) -> MetadataDeps[ReliabilityApplicationState]:
    """
    Retrieves dependencies to types or other metadata elements for the given instance of metadata.
    """
        ...
    def save(self, subPath: str=None, contentType: str=None) -> ReliabilityApplicationState:
        ...
    ...
    def removeAll(cls, removeFilter: str=None) -> int:
        ...
    def update(self, srcObj: ReliabilityApplicationState=None, spec: UpsertSpec=None) -> Union[ReliabilityApplicationState]:
        ...
    def upsert(self, srcObj: ReliabilityApplicationState=None, spec: UpsertSpec=None) -> Union[ReliabilityApplicationState]:
        ...
    @classmethod
    ...
    """
        ...
    @classmethod
    def fromString(cls, s: str) -> Union[ReliabilityApplicationState]:
    """
    ...
    """
        ...
    @classmethod
    def forId(cls, id: str, failIfMissing: bool=None) -> Union[ReliabilityApplicationState]:
    """
    ...
    def jsonify(cls, value: Any=None) -> Union[str]:
        ...
    @classmethod
    def doDataMerge(cls, componentId: str, dataSpecFieldName: str, dataDestinationFieldName: str, props: ReliabilityApplicationState, state: UiSdlReduxState) -> Union[ReliabilityApplicationState]:
    """
    ...
    """
        ...
    @classmethod
    def getConfigsAction(cls, componentId: str, configs: Array[UiConfigGetSpec]) -> Union[UiSdlReduxAction[Any]]:
    """
    ...
    """
        ...
    @classmethod
    def configGetEpic(cls, actionStream: UiSdlActionsObservable=None, stateStream: UiSdlStatesObservable=None) -> Union[UiSdlActionsObservable]:
    """
    ...
    """
        ...
    @classmethod
    def getConfigs(cls, getConfigSpecs: Array[UiConfigGetSpec]=None) -> Union[Map[str, Any]]:
    """
    ...
    """
        ...
    @classmethod
    def setUiTimezoneAction(cls, timezoneInfo: any) -> UiSdlReduxAction[Any]:
    """
    ...
    """
        ...
    @classmethod
    def setUiTimezoneReducer(cls, state: UiSdlReduxState, action: UiSdlReduxAction[Any]) -> UiSdlReduxState:
    """
    ...
    """
        ...
    @classmethod
    def setNavMenuSectionsAction(cls, navMenuSections: any) -> UiSdlReduxAction[Any]:
    """
    ...
    """
        ...
    @classmethod
    def setNavMenuSectionsReducer(cls, state: UiSdlReduxState, action: UiSdlReduxAction[Any]) -> UiSdlReduxState:
    """
    ...
    """
        ...
    @classmethod
    def setPageTitleTabsAction(cls, pageTitleTabs: any) -> UiSdlReduxAction[Any]:
    """
    ...
    """
        ...
    @classmethod
    def setPageTitleTabsReducer(cls, state: UiSdlReduxState, action: UiSdlReduxAction[Any]) -> UiSdlReduxState:
    """
    ...
    """
        ...
    @classmethod
    def setFieldAction(cls, stateId: str, field: str, value: Any=None, path: str=None, sourceId: str=None) -> UiSdlReduxAction[Any]:
    """
    ...
    """
        ...
    @classmethod
    def toggleSelectedIdReducer(cls, state: UiSdlReduxState, action: UiSdlReduxAction[Any]) -> UiSdlReduxState:
    """
    ...
    """
        ...
    @classmethod
    def selectIdSetReducer(cls, state: UiSdlReduxState, action: UiSdlReduxAction[Any]) -> UiSdlReduxState:
    """
    ...
    """
        ...
    @classmethod
    def selectSidePanelIdSetReducer(cls, state: UiSdlReduxState, action: UiSdlReduxAction[Any]) -> UiSdlReduxState:
    """
    ...
    """
        ...
    @classmethod
    def selectTopFailureModeCardListItemIdSetReducer(cls, state: UiSdlReduxState, action: UiSdlReduxAction[Any]) -> UiSdlReduxState:
    """
    ...
    """
        ...
    @classmethod
    def selectedRowSetReducer(cls, state: UiSdlReduxState, action: UiSdlReduxAction[Any]) -> UiSdlReduxState:
    """
    ...
    """
        ...
    @classmethod
    def selectedMultipleRowSetReducer(cls, state: UiSdlReduxState, action: UiSdlReduxAction[Any]) -> UiSdlReduxState:
    """
    ...
    """
        ...
    @classmethod
    def selectedRowsConfigIdSetReducer(cls, state: UiSdlReduxState, action: UiSdlReduxAction[Any]) -> UiSdlReduxState:
    """
    ...
    """
        ...
    @classmethod
    def selectedTopFailureModeCardListItemFMLIIdSetReducer(cls, state: UiSdlReduxState, action: UiSdlReduxAction[Any]) -> UiSdlReduxState:
    """
    ...
    """
        ...
    @classmethod
    def selectedFMRecommendationsGridItemIdSetReducer(cls, state: UiSdlReduxState, action: UiSdlReduxAction[Any]) -> UiSdlReduxState:
    """
    Listens for actions of type `TOP_FAILURE_MODES_CARD_FMLI_ID_SET` and store selected id in application state.
    ...
    """
        ...
    @classmethod
    def selectedCardSetReducer(cls, state: UiSdlReduxState, action: UiSdlReduxAction[Any]) -> UiSdlReduxState:
    """
    ...
    """
        ...
    @classmethod
    def setSelectedNameAction(cls, stateId: str, name: str) -> UiSdlReduxAction[Any]:
    """
    ...
    """
        ...
    @classmethod
    def selectedNameSetReducer(cls, state: UiSdlReduxState, action: UiSdlReduxAction[Any]) -> UiSdlReduxState:
    """
    ...
    """
        ...
    @classmethod
    def setSelectedNameSidePanelAction(cls, stateId: str, name: str) -> UiSdlReduxAction[Any]:
    """
    An action to set selected entity's name.
    ...
    """
        ...
    @classmethod
    def selectedNameSidePanelSetReducer(cls, state: UiSdlReduxState, action: UiSdlReduxAction[Any]) -> UiSdlReduxState:
    """
    Listens for actions of type `SELECTED_NAME_SET` and store selected entity's name in application state.
    ...
    """
        ...
    @classmethod
    def fmlToBeDeletedSetReducer(cls, state: UiSdlReduxState, action: UiSdlReduxAction[Any]) -> UiSdlReduxState:
    """
    ...
    """
        ...
    @classmethod
    def clearFormReducer(cls, state: UiSdlReduxState, action: UiSdlReduxAction[Any]) -> UiSdlReduxState:
    """
    ...
    """
        ...
    @classmethod
    def updatePresetFilterPanelStatusAction(cls, stateId: str, status: bool=None) -> UiSdlReduxAction[Any]:
    """
    ...
    """
        ...
    @classmethod
    def presetFilterStatusUpdateReducer(cls, state: UiSdlReduxState, action: UiSdlReduxAction[Any]) -> UiSdlReduxState:
    """
    ...
    """
        ...
    @classmethod
    def enableDisableGroupedInputAction(cls, id: str, field: str, disable: bool=None) -> UiSdlInputEnableDisableAction:
    """
    ...
    * Custom implementation of the action defined in {@link UiSdlForm} to accomodate for {@link UiSdlFieldGroup}s.
    ...
    """
        ...
    @classmethod
    def groupedInputEnableEffect(cls, state: UiSdlReduxState, action: UiSdlInputEnableDisableAction) -> UiSdlReduxState:
    """
    ...
    """
        ...
    @classmethod
    def groupedInputDisableEffect(cls, state: UiSdlReduxState, action: UiSdlInputEnableDisableAction) -> UiSdlReduxState:
    """
    ...
    """
        ...
    @classmethod
    def enableDisableGroupedInputEffect(cls, state: UiSdlReduxState, fieldName: str, componentId: str, disable: bool=None) -> UiSdlReduxState:
    """
    Listens for actions of type `INPUT_ENABLE`,and sets the 'disabled' property on the input to be false.
    ...
    """
        ...
    @classmethod
    def setDataInStateAction(cls, dataSource: str, values: Array[str]=None) -> None:
    """
    ...
    """
        ...
    @classmethod
    def setComponentFieldAction(cls, stateId: str, componentId: str, dataPath: Array[str], newValue: Any=None) -> UiSdlReduxAction[Any]:
    """
    ...
    """
        ...
    @classmethod
    def setDataInStateReducer(cls, state: UiSdlReduxState, action: UiSdlReduxAction[Any]) -> UiSdlReduxState:
    """
    ...
    """
        ...
    @classmethod
    def hideFormFieldGroupsReducer(cls, state: UiSdlReduxState, action: UiSdlReduxAction[Any]) -> UiSdlReduxState:
    """
    ...
    """
        ...
    @classmethod
    def setDataSourceReducer(cls, state: UiSdlReduxState, action: UiSdlReduxAction[Any]) -> UiSdlReduxState:
    """
    ...
    """
        ...
    @classmethod
    def setDataSourceAction(cls, newValue: str, stateId: str=None, componentId: str=None, path: str=None) -> UiSdlReduxAction[Any]:
    """
    ...
    """
        ...
    @classmethod
    def removeDynamicComponentFromStateReducer(cls, state: UiSdlReduxState, action: UiSdlReduxAction[Any]) -> UiSdlReduxState:
    """
    ...
    """
        ...
    @classmethod
    def workOrderPartsQuantityEdit(cls, state: UiSdlReduxState, action: UiSdlReduxAction[Any]) -> UiSdlReduxState:
    """
    ...
    """
        ...
    @classmethod
    def primaryButtonClickListener(cls, state: UiSdlReduxState, action: UiSdlReduxAction[Any]) -> UiSdlReduxState:
    """
    ...
    """
        ...
    @classmethod
    def setComponentFieldReducer(cls, state: UiSdlReduxState, action: UiSdlReduxAction[Any]) -> UiSdlReduxState:
    """
    ...
    """
        ...
    @classmethod
    def getFormFieldPath(cls, state: UiSdlReduxState, componentId: str, fieldName: str, trailingPath: Array[Union[str,int]]='[]') -> Array[Union[str,int]]:
    """
