// TypeScript definitions for the C3 type Facility

/**
 * Represents a facility in a potential hierarchy (denormalized) of facilities
 *
 * @remarks this represents a value passed to a method that expects an instance of Facility
 */
declare interface IFacility {
  ...
  /**
   * Field to track when this facility was last updated in the asset hierarchy
   */
   ...
   * These users' access controls to the facility are determined by seeded {@link AclPrivilege} for {@link Facility}.
   */
  users?: Array_Type<User> | Array<IUser>;
  ...
  /**
   * The relations to the parent facilies of a given facility.
   */
  parentRelations?: Array_Type<FacilityHierarchicalRelation> | Array<IFacilityHierarchicalRelation>;

  /**
   * The relations to the children facilies of a given facility.
   */
  childRelations?: Array_Type<FacilityHierarchicalRelation> | Array<IFacilityHierarchicalRelation>;
   ...
   */
  events?: Array_Type<PhysicalAssetEvent> | Array<IPhysicalAssetEvent>;
  ...
  /**
   * Gets the direct parent associated with this {@link Facility}.
   */
  parent?: IFacility;
   ...
   */
  children?: Array_Type<FixedAsset> | Array<IFixedAsset>;

  /**
   * Records representing all ancestors in the asset hierarchy
   */
  denormParents?: Array_Type<AssetHierarchyDenorm> | Array<IAssetHierarchyDenorm>;

  /**
   * Records representing all descendants in the asset hierarchy
   */
  denormChildren?: Array_Type<AssetHierarchyDenorm> | Array<IAssetHierarchyDenorm>;

  /**
   * All fixed asset owners for this asset.
   */
  assetOwners?: Array_Type<AssetOwner> | Array<IAssetOwner>;

  /**
   * All organizations that are owners of this fixed asset.
   */
  orgs?: Array_Type<Organization> | Array<IOrganization>;

  /**
   * All relationships in the party role hierarchy.
   */
  partyRelations?: Array_Type<AssetPartyRole> | Array<IAssetPartyRole>;

  /**
   * The specific party roles attached via AssetPartyRole.
   */
  partyRoles?: Array_Type<PartyRole> | Array<IPartyRole>;
   ...
   */
  regions?: Array_Type<Region> | Array<IRegion>;

  /**
   * Regions linked to this asset or its ancestor assets
   */
  regionParents?: Array_Type<Region> | Array<IRegion>;

  /**
   * Regions linked to this asset or its ancestor asset and all their parent regions
   */
  allRegionParents?: Array_Type<Region> | Array<IRegion>;

  /**
   * Geometry component of {@link Location#address placedAt.address}.
   *
   * @see LatLong
   */
  geometry?: ILatLong;
  ...
  /**
   * Street address component of {@link Location#address placedAt.address}.
   */
  address1?: string;

  /**
   * Name of locality (city/town) component of {@link Location#address placedAt.address}.
   */
  city?: string;

  /**
   * Abbreviation of State/Province/administrative_area component of {@link Location#address placedAt.address}.
   */
  state?: string;

  /**
   * Postal or zip code component of {@link Location#address placedAt.address}.
   */
  postal_code?: string;

  /**
   * Utility defined building type of facility such as APT, RES, MARINA, B&B, AUTOGAS etc.
   */
  facilityType?: string;

  /**
   * Facility characteristics with historical values.
   *
   * @see FacilityCharacteristicSet
   */
  characteristics?: Array_Type<FacilityCharacteristicSet> | Array<IFacilityCharacteristicSet>;

  /**
   * This field is used by the UI to show the translated value of {@link hierarchyStatus}.
   */
  displayHierarchyStatus?: string;

  /**
   * This field indicates the current status of the asset hierarchy setup.
   */
  hierarchyStatus?: string;

  /**
   * This field indicates whether the asset hierarchy setup has been completed for this facility.
   */
 ...
 * Represents a facility in a potential hierarchy (denormalized) of facilities
 *
 * @remarks this represents a made instance of Facility
 */
declare class Facility extends Obj  {

  /**
   * Latest uploaded asset hierarchy file or spreadsheet containing the entity.
   */
  readonly assetOnboardingSourceFile?: AssetOnboardingSourceFile;
  withAssetOnboardingSourceFile(assetOnboardingSourceFile: IAssetOnboardingSourceFile | null): Facility;

  /**
   * Field to track when this facility was last updated in the asset hierarchy
   */
  readonly configurationLastUpdated?: DateTime;
  withConfigurationLastUpdated(configurationLastUpdated: DateTime | Date | string | null): Facility;

  /**
   * List of {@link AclEntry} entries governing who can read/update/remove Objs.
   */
  readonly acl?: Array_Type<AclEntry>;
  withAcl(acl: Array_Type<AclEntry> | Array<IAclEntry> | null): Facility;
   ...
   * These users' access controls to the facility are determined by seeded {@link AclPrivilege} for {@link Facility}.
   */
  readonly adminGroups?: Array_Type<Role>;
  withAdminGroups(adminGroups: Array_Type<Role> | Array<IRole> | null): Facility;

  /**
   * Additional {@link Role}s.
   * Only {@link User}s belonging to these roles are considered as additional users in the UI.
   */
  readonly additionalGroups?: Array_Type<Role>;
  withAdditionalGroups(additionalGroups: Array_Type<Role> | Array<IRole> | null): Facility;

  /**
   * Any additional {@link User}s apart from users belonging to {@link FacilityAccessManager#adminGroups} that have access to a facility.
   * These users' access controls to the facility are determined by seeded {@link AclPrivilege} for {@link Facility}.
   */
  readonly users?: Array_Type<User>;
  withUsers(users: Array_Type<User> | Array<IUser> | null): Facility;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Facility;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): Facility;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): Facility;
  ...
  withVersion(version: number | null): Facility;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): Facility;

  /**
   * This ID is used to determine which import this entity belongs to.
   */
  readonly trackingIdForImport?: string;
  withTrackingIdForImport(trackingIdForImport: string | null): Facility;

  /**
   * The weather station associated with the location of the asset.
   */
  readonly weatherStation?: WeatherStation;
  withWeatherStation(weatherStation: IWeatherStation | null): Facility;

  /**
   * References to MemberToEntity that map to this instance.
   */
  readonly memberIntersections?: Array_Type<MemberToPhysicalAsset>;
  withMemberIntersections(memberIntersections: Array_Type<MemberToPhysicalAsset> | Array<IMemberToPhysicalAsset> | null): Facility;
  ...
  withTypeIdent(typeIdent: string | null): Facility;

  /**
   * The historical location/address for the asset.
   */
  readonly locationHistory?: Array_Type<PhysicalAssetLocationHistory>;
  withLocationHistory(locationHistory: Array_Type<PhysicalAssetLocationHistory> | Array<IPhysicalAssetLocationHistory> | null): Facility;

  /**
   * The current location/address for this asset.
   */
  readonly location?: PhysicalAssetLocation;
  withLocation(location: IPhysicalAssetLocation | null): Facility;

  /**
   * A description of the asset.
   */
  readonly description?: string;
  withDescription(description: string | null): Facility;

  /**
   * Real-time location data for a moving asset.
   */
  readonly realTimeLocations?: Array_Type<PhysicalAssetRealTimeLocation>;
  withRealTimeLocations(realTimeLocations: Array_Type<PhysicalAssetRealTimeLocation> | Array<IPhysicalAssetRealTimeLocation> | null): Facility;

  /**
   * The relations to the parent facilies of a given facility.
   */
  readonly parentRelations?: Array_Type<FacilityHierarchicalRelation>;
  withParentRelations(parentRelations: Array_Type<FacilityHierarchicalRelation> | Array<IFacilityHierarchicalRelation> | null): Facility;

  /**
   * The relations to the children facilies of a given facility.
   */
  readonly childRelations?: Array_Type<FacilityHierarchicalRelation>;
  withChildRelations(childRelations: Array_Type<FacilityHierarchicalRelation> | Array<IFacilityHierarchicalRelation> | null): Facility;

  /**
   * Ancestors in the asset hierarchy throughout history.
   */
  readonly denormAncestors?: Array_Type<PhysicalAssetHierarchyDenorm>;
  withDenormAncestors(denormAncestors: Array_Type<PhysicalAssetHierarchyDenorm> | Array<IPhysicalAssetHierarchyDenorm> | null): Facility;

  /**
   * Descendants in the asset hierarchy throughout history.
   */
  readonly denormDescendants?: Array_Type<PhysicalAssetHierarchyDenorm>;
  withDenormDescendants(denormDescendants: Array_Type<PhysicalAssetHierarchyDenorm> | Array<IPhysicalAssetHierarchyDenorm> | null): Facility;

  /**
   * The historical relative positions of this physical asset.
   */
  readonly relativePositionHistory?: Array_Type<PhysicalAssetRelativePositionHistory>;
  withRelativePositionHistory(relativePositionHistory: Array_Type<PhysicalAssetRelativePositionHistory> | Array<IPhysicalAssetRelativePositionHistory> | null): Facility;

  /**
   * The current relative position of this physical asset.
   */
  readonly relativePosition?: PhysicalAssetRelativePosition;
  withRelativePosition(relativePosition: IPhysicalAssetRelativePosition | null): Facility;

  /**
   * Physical measurement series related to this asset.
   */
  readonly measurements?: Array_Type<BasePhysicalMeasurementSeries>;
  withMeasurements(measurements: Array_Type<BasePhysicalMeasurementSeries> | Array<IBasePhysicalMeasurementSeries> | null): Facility;

  /**
   * Point measurement series for time-series metrics related to the asset.
   */
  readonly pointMeasurements?: Array_Type<PointPhysicalMeasurementSeries>;
  withPointMeasurements(pointMeasurements: Array_Type<PointPhysicalMeasurementSeries> | Array<IPointPhysicalMeasurementSeries> | null): Facility;

  /**
   * The event history for this physical asset.
   */
  readonly events?: Array_Type<PhysicalAssetEvent>;
  withEvents(events: Array_Type<PhysicalAssetEvent> | Array<IPhysicalAssetEvent> | null): Facility;
  ...
  withChildSensorRelations(childSensorRelations: Array_Type<PhysicalAssetHierarchyRelation> | Array<IPhysicalAssetHierarchyRelation> | null): Facility;

  /**
   * Relations to {@link ParsableDiagram}s which have been linked to this asset.
   */
  readonly diagramRelations?: Array_Type<ParsableDiagramToPhysicalAssetRelation>;
  withDiagramRelations(diagramRelations: Array_Type<ParsableDiagramToPhysicalAssetRelation> | Array<IParsableDiagramToPhysicalAssetRelation> | null): Facility;

  /**
   * Count of {@link ParsableDiagram}s which have been linked to this asset.
   */
  readonly numDiagramRelations?: number;
  withNumDiagramRelations(numDiagramRelations: number | null): Facility;

  /**
   * The active {@link TimeToEventPrediction} objects directly belonging to this asset
   */
  readonly timeToEventPredictions?: Array_Type<TimeToEventPrediction>;
  withTimeToEventPredictions(timeToEventPredictions: Array_Type<TimeToEventPrediction> | Array<ITimeToEventPrediction> | null): Facility;

  /**
   * The relations to {@link EventCategory} this asset has
   */
  readonly eventCategoryRelations?: Array_Type<PhysicalAssetEventCategoryRelation>;
  withEventCategoryRelations(eventCategoryRelations: Array_Type<PhysicalAssetEventCategoryRelation> | Array<IPhysicalAssetEventCategoryRelation> | null): Facility;

  /**
   * The location of the asset. Certain assets can be moved from one place to another, such as electrical meters,
   * but currently, placedAt is just one location fixed across all of time.
   */
  readonly placedAt?: Location;
  withPlacedAt(placedAt: ILocation | null): Facility;

  /**
   * Gets the direct parent associated with this {@link Facility}.
   */
  readonly parent?: Facility;
  withParent(parent: IFacility | null): Facility;

  /**
   * The assets directly included by this one
   */
  readonly children?: Array_Type<FixedAsset>;
  withChildren(children: Array_Type<FixedAsset> | Array<IFixedAsset> | null): Facility;

  /**
   * Records representing all ancestors in the asset hierarchy
   */
  readonly denormParents?: Array_Type<AssetHierarchyDenorm>;
  withDenormParents(denormParents: Array_Type<AssetHierarchyDenorm> | Array<IAssetHierarchyDenorm> | null): Facility;

  /**
   * Records representing all descendants in the asset hierarchy
   */
  readonly denormChildren?: Array_Type<AssetHierarchyDenorm>;
  withDenormChildren(denormChildren: Array_Type<AssetHierarchyDenorm> | Array<IAssetHierarchyDenorm> | null): Facility;

  /**
   * All fixed asset owners for this asset.
   */
  readonly assetOwners?: Array_Type<AssetOwner>;
  withAssetOwners(assetOwners: Array_Type<AssetOwner> | Array<IAssetOwner> | null): Facility;

  /**
   * All organizations that are owners of this fixed asset.
   */
  readonly orgs?: Array_Type<Organization>;
  withOrgs(orgs: Array_Type<Organization> | Array<IOrganization> | null): Facility;

  /**
   * All relationships in the party role hierarchy.
   */
  readonly partyRelations?: Array_Type<AssetPartyRole>;
  withPartyRelations(partyRelations: Array_Type<AssetPartyRole> | Array<IAssetPartyRole> | null): Facility;

  /**
   * The specific party roles attached via AssetPartyRole.
   */
  readonly partyRoles?: Array_Type<PartyRole>;
  withPartyRoles(partyRoles: Array_Type<PartyRole> | Array<IPartyRole> | null): Facility;
   ...
   * stored calc "businessRegion + geoPoliticalRegion + utilityRateRegion"
   */
  readonly regions?: Array_Type<Region>;
  withRegions(regions: Array_Type<Region> | Array<IRegion> | null): Facility;

  /**
   * Regions linked to this asset or its ancestor assets
   */
  readonly regionParents?: Array_Type<Region>;
  withRegionParents(regionParents: Array_Type<Region> | Array<IRegion> | null): Facility;

  /**
   * Regions linked to this asset or its ancestor asset and all their parent regions
   */
  readonly allRegionParents?: Array_Type<Region>;
  withAllRegionParents(allRegionParents: Array_Type<Region> | Array<IRegion> | null): Facility;
   ...
   * @see LatLong
   */
  readonly geometry?: LatLong;
  withGeometry(geometry: ILatLong | null): Facility;

  /**
   * Street address component of {@link Location#address placedAt.address}.
   */
  readonly address1?: string;
  withAddress1(address1: string | null): Facility;

  /**
   * Name of locality (city/town) component of {@link Location#address placedAt.address}.
   */
  readonly city?: string;
  withCity(city: string | null): Facility;

  /**
   * Abbreviation of State/Province/administrative_area component of {@link Location#address placedAt.address}.
   */
  readonly state?: string;
  withState(state: string | null): Facility;

  /**
   * Postal or zip code component of {@link Location#address placedAt.address}.
   */
  readonly postal_code?: string;
  withPostal_code(postal_code: string | null): Facility;

  /**
   * Utility defined building type of facility such as APT, RES, MARINA, B&B, AUTOGAS etc.
   */
  readonly facilityType?: string;
  withFacilityType(facilityType: string | null): Facility;
   ...
   * @see FacilityCharacteristicSet
   */
  readonly characteristics?: Array_Type<FacilityCharacteristicSet>;
  withCharacteristics(characteristics: Array_Type<FacilityCharacteristicSet> | Array<IFacilityCharacteristicSet> | null): Facility;

  /**
   * This field is used by the UI to show the translated value of {@link hierarchyStatus}.
   */
  readonly displayHierarchyStatus?: string;
  withDisplayHierarchyStatus(displayHierarchyStatus: string | null): Facility;

  /**
   * This field indicates the current status of the asset hierarchy setup.
   */
  readonly hierarchyStatus?: string;
  withHierarchyStatus(hierarchyStatus: string | null): Facility;

  /**
   * This field indicates whether the asset hierarchy setup has been completed for this facility.
   */
  readonly isHierarchyComplete?: boolean;
  withIsHierarchyComplete(isHierarchyComplete: boolean): Facility;
   ...
   * @see #toJson
   */
  static fromJson(json: any): Facility | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): Facility | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): Facility | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): Facility | null;
   ...
   */
  replaceType(old: Type, new_: Type): Facility;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Facility;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Facility;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Facility>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Facility>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Facility;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Facility;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Facility;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): Facility;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): Facility;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): Facility;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Facility;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Facility;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): Facility;
   ...
   * @see #removeField
   */
  withoutField(field: string): Facility;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): Facility;
   ...
   */
  withoutFields(fields: Array_Type<string>): Facility;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): Facility;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): Facility;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Facility;
   ...
   * @see #unsetField
   */
  defaultField(field: string): Facility;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): Facility;
   ...
   * @see #removeField
   */
  unsetField(field: string): Facility;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): Facility;
   ...
   * @see #unsetField
   */
  removeField(field: string): Facility;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): Facility;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Facility;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): Facility;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Facility;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Facility;

  mergeJson(json: any): Facility;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Facility;
   ...
   */
  sumObj(other: Obj, deep?: boolean): Facility;
   ...
   */
  singletonArray(): Array_Type<Facility>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<Facility> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<Facility> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<Facility>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<Facility> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, Facility> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, Facility> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<Facility>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<Facility>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Facility;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Facility;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Facility;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): Facility;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Facility;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): Facility;
   ...
   * @see #fromString
   */
  static make(s: string): Facility | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Facility;
   ...
   */
  static cachedEmptyInst(): Facility;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<Facility> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): Facility;
   ...
   */
  static populateAcl(objs?: Array_Type<Facility>): number | null;
   ...
   */
  grantMemberReadUpdateRemove(member: AccessControlEntity): Facility;
   ...
   */
  mergeAclEntry(entry: AclEntry): Facility;
   ...
   * @return the obj with the new acl after merging the indicated entry.
   */
  mergeAclEntries(entries: Array_Type<AclEntry>): Facility;
   ...
   */
  static getUsersForFacilities(facilityIds: string, spec?: FetchSpec = '{}'): FetchResult<User> | null;
   ...
   */
  static getUsersCountForFacilities(facilityIds: string, spec?: FetchSpec = '{}'): number | null;
   ...
   */
  getUnassignedUsersForFacility(include?: string, spec?: FetchSpec = '{}'): FetchResult<User> | null;
   ...
   */
  removeUserAccess(users: Array_Type<User>): number | null;
   ...
   */
  addUserAccess(users: Array_Type<User>): number | null;
   ...
   */
  addUserGroups(roles: Array_Type<Role>, groupType: string): number | null;
   ...
   */
  removeUserGroups(roles: Array_Type<Role>, groupType: string): number | null;
   ...
   */
  _getGroupFieldFromType(groupType: string): string | null;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<Facility>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<Facility>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<Facility> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Facility>> | null;
   ...
   */
  get(include?: string): Facility | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): Facility | null;
   ...
   */
  getMissing(spec: GetMissingSpec): Facility;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): Facility | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): Facility;
   ...
   * @see #toString
   */
  static fromString(s: string): Facility | null;
   ...
   */
  create(spec?: UpsertSpec): Facility | null;
   ...
   */
  static createBatch(objs: Array_Type<Facility>, spec?: UpsertSpec): ObjList<Facility> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<Facility>, spec?: CreateBatchObjStreamSpec): ObjList<Facility> | null;
   ...
   */
  update(srcObj?: Facility, spec?: UpsertSpec): Facility | null;
   ...
   */
  upsert(srcObj?: Facility, spec?: UpsertSpec): Facility | null;
   ...
   */
  merge(spec?: MergeSpec): Facility | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): Facility | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): Facility | null;
   ...
   */
  static updateBatch(objs: Array_Type<Facility>, srcObjs?: Array_Type<Facility>, spec?: UpsertSpec): ObjList<Facility> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<Facility> | null>, spec?: UpsertSpec): ObjList<Facility> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<Facility>, srcObjs?: Array_Type<Facility>, spec?: UpsertSpec): ObjList<Facility> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<Facility> | null>, spec?: UpsertSpec): ObjList<Facility> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<Facility>, spec?: TouchSpec): ObjList<Facility> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<Facility>, spec?: MergeSpec): ObjList<Facility> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<Facility>, mergeInclude: string, spec?: MergeSpec): ObjList<Facility> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<Facility> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Facility> | null;
   ...
   */
  static mergeAll(mergeObj: Facility, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: Facility, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<Facility>, spec?: UpsertSpec): ObjList<Facility> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<Facility>, spec?: UpsertSpec): ObjList<Facility> | null;
   ...
   */
  static beforeCreate(objs: Array_Type<Facility>): ObjList<Facility>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<Facility>): ObjList<Facility>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<Facility>): ObjList<Facility>;
   ...
   */
  static afterCreate(objs: Array_Type<Facility>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<Facility>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<Facility>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<Facility>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Facility>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): Facility | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<Facility>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: Facility, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<Facility>, callback?: λFunction<Facility | null, Facility | null>): ObjList<Facility>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<Facility>, callback?: λFunction<Facility | null, Facility | null>): Array_Type<ObjError> | null;
  ...
  /**
   * Create weatherStations on the type invoked, if the type mixes in WeatherAware.
   *
   * @return WeatherStationCreator mapr job information.
   */
  static refreshWeatherStations(): WeatherStationCreator | null;

  /**
   * Check the status for running refreshWeatherStations mapr job.
   *
   * @return The MapReduce job information.
   */
  static refreshWeatherStationsStatus(): MapReduceStatus | null;
   ...
   */
  static evalFeatureSetBatch(batch: Array_Type<Facility>, featureSet: Feature.Set, spec?: EvalFeatureSpec): Data | null;
   ...
   * ```
   */
  static evalFeaturesBatch(batch: Array_Type<Facility>, features: Array_Type<string>, spec?: EvalFeaturesSpec): Data | null;
  ...
  /**
   * Removes an instance of a {@link Facility}
   * @param deleteDescendents
   *        If set to true, deletes all descendent {@link ReliabilityAsset}s of the {@link Facility}
   *        If set to false, does not delete descendents of the {@link Facility}
   */
  removeFacilityFromHierarchy(deleteDescendents?: boolean = 'true'): void;

  /**
   * This method updates the hierarchy status of this facility.
   * @param markAsComplete
   *        Denotes if the hierarchy status shuold be marked as complete.
   */
  updateHierarchyStatus(markAsComplete?: boolean): void;
}
