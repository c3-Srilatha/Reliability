// TypeScript definitions for the C3 type GlobalWorkflowBannerConfig

/**
 * Global configuration for displaying workflow-related banner messages across the application.
 *
 * This configuration provides an array of mappings between workflow expressions
 * and their corresponding banner text key prefixes. Each mapping defines how to match
 * a workflow ID using an expression and specifies the primary and secondary
 * banner text keys to display.
 *
 * Each entry in `expressionToTranslations` includes a {@link WorkflowBannerTranslationEntry} object:
 * - `expression`: A string representing the matching condition applied to workflow IDs.
 * - `primaryKeyPrefix`: The prefix used to resolve the primary banner text.
 * - `secondaryKeyPrefix`: The prefix used to resolve the secondary banner text.
 *
 * Example configuration:
 * ```json
 * {
 *   "expressionToTranslations": [
 *     {
 *       "expression": "startsWith('asset-onboarding-export')",
 *       "primaryKeyPrefix": "Reliability.Banner.ExportData.PrimaryText",
 *       "secondaryKeyPrefix": "Reliability.Banner.ExportData.SecondaryText"
 *     }
 *   ]
 * }
 * ```
 *
 * @remarks this represents a value passed to a method that expects an instance of GlobalWorkflowBannerConfig
 */
declare interface IGlobalWorkflowBannerConfig {
  ...
  /**
   * An array of translation mappings based on expression matching.
   * Each entry maps a workflow expression to its corresponding banner text key prefixes.
   */
  expressionToTranslations?: Array_Type<WorkflowBannerTranslationEntry> | Array<IWorkflowBannerTranslationEntry>;
}
 ...
 * ```
 *
 * @remarks this represents a made instance of GlobalWorkflowBannerConfig
 */
declare class GlobalWorkflowBannerConfig extends Obj  {

  readonly configOverride?: string;
  withConfigOverride(configOverride: string | null): GlobalWorkflowBannerConfig;

  static readonly configOverride?: string;

  readonly secretOverride?: string;
  withSecretOverride(secretOverride: string | null): GlobalWorkflowBannerConfig;
  ...
  withIssues(issues: Array_Type<string> | Array<string> | null): GlobalWorkflowBannerConfig;
   ...
   * Each entry maps a workflow expression to its corresponding banner text key prefixes.
   */
  readonly expressionToTranslations?: Array_Type<WorkflowBannerTranslationEntry>;
  withExpressionToTranslations(expressionToTranslations: Array_Type<WorkflowBannerTranslationEntry> | Array<IWorkflowBannerTranslationEntry> | null): GlobalWorkflowBannerConfig;

  /**
   * An array of translation mappings based on expression matching.
   * Each entry maps a workflow expression to its corresponding banner text key prefixes.
   */
  static readonly expressionToTranslations?: Array_Type<WorkflowBannerTranslationEntry>;

  /**
   * @return the one and only instance to be used when member functions are called on this type.
   */
  static inst(): GlobalWorkflowBannerConfig;

  /**
   * @return the cached instance if already cached, null otherwise. Does not instantiate if missing.
   */
  static cachedInst(): GlobalWorkflowBannerConfig | null;
   ...
   * @see #toJson
   */
  static fromJson(json: any): GlobalWorkflowBannerConfig | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): GlobalWorkflowBannerConfig | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): GlobalWorkflowBannerConfig | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): GlobalWorkflowBannerConfig | null;
   ...
   */
  replaceType(old: Type, new_: Type): GlobalWorkflowBannerConfig;
   ...
   * This method is used during live metadata update
   */
  static replaceType(old: Type, new_: Type): GlobalWorkflowBannerConfig;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GlobalWorkflowBannerConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GlobalWorkflowBannerConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GlobalWorkflowBannerConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GlobalWorkflowBannerConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<GlobalWorkflowBannerConfig>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<GlobalWorkflowBannerConfig>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<GlobalWorkflowBannerConfig>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<GlobalWorkflowBannerConfig>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): GlobalWorkflowBannerConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): GlobalWorkflowBannerConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GlobalWorkflowBannerConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GlobalWorkflowBannerConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GlobalWorkflowBannerConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GlobalWorkflowBannerConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): GlobalWorkflowBannerConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  static validateObj(): GlobalWorkflowBannerConfig;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): GlobalWorkflowBannerConfig;
   ...
   * @see #defaultField
   */
  static withField(field: string, value: any, doNotConvert?: boolean): GlobalWorkflowBannerConfig;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): GlobalWorkflowBannerConfig;
   ...
   * @see #defaultField
   */
  static withField(field: FieldType, value: any, doNotConvert?: boolean): GlobalWorkflowBannerConfig;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): GlobalWorkflowBannerConfig;
   ...
   * @return new Obj
   */
  static withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): GlobalWorkflowBannerConfig;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): GlobalWorkflowBannerConfig;
   ...
   * @return new Obj
   */
  static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): GlobalWorkflowBannerConfig;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): GlobalWorkflowBannerConfig;
   ...
   * @see #withoutField
   */
  static withoutFieldAtPath(path: string): GlobalWorkflowBannerConfig;
   ...
   * @see #removeField
   */
  withoutField(field: string): GlobalWorkflowBannerConfig;
   ...
   * @see #removeField
   */
  static withoutField(field: string): GlobalWorkflowBannerConfig;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): GlobalWorkflowBannerConfig;
   ...
   * @see #removeField
   */
  static withoutField(field: FieldType): GlobalWorkflowBannerConfig;
   ...
   */
  withoutFields(fields: Array_Type<string>): GlobalWorkflowBannerConfig;
   ...
   * @return new Obj with removed fields
   */
  static withoutFields(fields: Array_Type<string>): GlobalWorkflowBannerConfig;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): GlobalWorkflowBannerConfig;
   ...
   * @return new Obj with removed fields
   */
  static withoutFieldsByType(fields: Array_Type<FieldType>): GlobalWorkflowBannerConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): GlobalWorkflowBannerConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  static withoutSecretFields(): GlobalWorkflowBannerConfig;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): GlobalWorkflowBannerConfig;
   ...
   * @see FieldType#defaultValue
   */
  static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): GlobalWorkflowBannerConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: string): GlobalWorkflowBannerConfig;
   ...
   * @see #unsetField
   */
  static defaultField(field: string): GlobalWorkflowBannerConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): GlobalWorkflowBannerConfig;
   ...
   * @see #unsetField
   */
  static defaultField(field: FieldType): GlobalWorkflowBannerConfig;
   ...
   * @see #removeField
   */
  unsetField(field: string): GlobalWorkflowBannerConfig;
   ...
   * @see #removeField
   */
  static unsetField(field: string): GlobalWorkflowBannerConfig;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): GlobalWorkflowBannerConfig;
   ...
   * @see #removeField
   */
  static unsetField(field: FieldType): GlobalWorkflowBannerConfig;
   ...
   * @see #unsetField
   */
  removeField(field: string): GlobalWorkflowBannerConfig;
   ...
   * @see #unsetField
   */
  static removeField(field: string): GlobalWorkflowBannerConfig;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): GlobalWorkflowBannerConfig;
   ...
   * @see #unsetField
   */
  static removeField(field: FieldType): GlobalWorkflowBannerConfig;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): GlobalWorkflowBannerConfig;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): GlobalWorkflowBannerConfig;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): GlobalWorkflowBannerConfig;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj, otherFieldsFilter: Type): GlobalWorkflowBannerConfig;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): GlobalWorkflowBannerConfig;
   ...
   *        the same key or index.
   */
  static mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): GlobalWorkflowBannerConfig;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): GlobalWorkflowBannerConfig;
   ...
   * traverse child reference and collection fields.
   */
  static mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): GlobalWorkflowBannerConfig;

  mergeJson(json: any): GlobalWorkflowBannerConfig;

  static mergeJson(json: any): GlobalWorkflowBannerConfig;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): GlobalWorkflowBannerConfig;
   ...
   * @return Obj with child references merged
   */
  static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): GlobalWorkflowBannerConfig;
   ...
   */
  sumObj(other: Obj, deep?: boolean): GlobalWorkflowBannerConfig;
   ...
   * references with same name and collection elements at same index or key.
   */
  static sumObj(other: Obj, deep?: boolean): GlobalWorkflowBannerConfig;
   ...
   */
  singletonArray(): Array_Type<GlobalWorkflowBannerConfig>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonArray(): Array_Type<GlobalWorkflowBannerConfig>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<GlobalWorkflowBannerConfig> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<GlobalWorkflowBannerConfig> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<GlobalWorkflowBannerConfig>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonSet(): Set_Type<GlobalWorkflowBannerConfig>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<GlobalWorkflowBannerConfig> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, GlobalWorkflowBannerConfig> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, GlobalWorkflowBannerConfig> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<GlobalWorkflowBannerConfig>;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  static toBuilder(): ObjBuilder<GlobalWorkflowBannerConfig>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<GlobalWorkflowBannerConfig>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): GlobalWorkflowBannerConfig;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): GlobalWorkflowBannerConfig;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): GlobalWorkflowBannerConfig;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): GlobalWorkflowBannerConfig;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): GlobalWorkflowBannerConfig;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): GlobalWorkflowBannerConfig;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): GlobalWorkflowBannerConfig;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): GlobalWorkflowBannerConfig;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  static afterMake(): GlobalWorkflowBannerConfig;
   ...
   */
  static cachedEmptyInst(): GlobalWorkflowBannerConfig;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<GlobalWorkflowBannerConfig> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): GlobalWorkflowBannerConfig;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<GlobalWorkflowBannerConfig> | null;
   ...
   */
  static find(filter?: string, doNotProduceAll?: boolean): Stream<GlobalWorkflowBannerConfig> | null;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<GlobalWorkflowBannerConfig> | null;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): GlobalWorkflowBannerConfig | null;

  /**
   * Returns cached instance by key, with secrets removed.
   */
  static forCacheKey(key: string): GlobalWorkflowBannerConfig | null;
   ...
   * @see findByCacheKey
   */
  getCached(): GlobalWorkflowBannerConfig | null;
   ...
   * @see findByCacheKey
   */
  static getCached(): GlobalWorkflowBannerConfig | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): GlobalWorkflowBannerConfig | null;

  /**
   * @return newly produced cached instance.
   */
  static refreshCache(): GlobalWorkflowBannerConfig | null;
   ...
   */
  static produce(key: string): GlobalWorkflowBannerConfig | null;
   ...
   */
  static produceAll(): Map_Type<string, GlobalWorkflowBannerConfig> | null;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): Map_Type<string, GlobalWorkflowBannerConfig> | null;
   ...
   */
  getConfig(): GlobalWorkflowBannerConfig;
   ...
   * Note that typical pattern is to use Configurable#config instead of this method.
   */
  static getConfig(): GlobalWorkflowBannerConfig;
   ...
   */
  getSecret(): GlobalWorkflowBannerConfig;
   ...
   * Note that typical pattern is to use Configurable#configWithSecrets instead of this method.
   */
  static getSecret(): GlobalWorkflowBannerConfig;
   ...
   */
  withConfigKey(configKey: string): GlobalWorkflowBannerConfig;
   ...
   *     config.configKey() => "folder1/abc"
   */
  static withConfigKey(configKey: string): GlobalWorkflowBannerConfig;

  /**
   * @return copy without config key.
   */
  withoutConfigKey(): GlobalWorkflowBannerConfig;

  /**
   * @return copy without config key.
   */
  static withoutConfigKey(): GlobalWorkflowBannerConfig;

  /**
   * @return return cached config instance for provided config key.
   */
  static forConfigKey(configKey: string): GlobalWorkflowBannerConfig | null;
   ...
   */
  static listConfigs(parallel?: boolean, filter?: λPredicate<string>): Stream<GlobalWorkflowBannerConfig> | null;
   ...
   * @see setConfigValue
   */
  setConfigValues(from: GlobalWorkflowBannerConfig, override?: string): void;

  /**
   * Sets multiple field values to be the same as the passed instance.
   * @see setConfigValue
   */
  static setConfigValues(from: GlobalWorkflowBannerConfig, override?: string): void;
   ...
   * @see setSecretValue
   */
  setSecretValues(from: GlobalWorkflowBannerConfig, override?: string): void;

  /**
   * Sets multiple secret field values to be the same as the passed instance.
   * @see setSecretValue
   */
  static setSecretValues(from: GlobalWorkflowBannerConfig, override?: string): void;
   ...
   */
  static loadConfigAndSecret(configKey: string): GlobalWorkflowBannerConfig | null;
   ...
   */
  removeSecrets(): GlobalWorkflowBannerConfig | null;

  /**
   * @return this config without any secret values.
   */
  static removeSecrets(): GlobalWorkflowBannerConfig | null;

  /**
   * @return this config with only secret values.
   */
  removeNonSecrets(): GlobalWorkflowBannerConfig | null;

  /**
   * @return this config with only secret values.
   */
  static removeNonSecrets(): GlobalWorkflowBannerConfig | null;

  /**
   * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
   * validation and setup.
   */
  validate(): GlobalWorkflowBannerConfig;

  /**
   * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
   * validation and setup.
   */
  static validate(): GlobalWorkflowBannerConfig;
