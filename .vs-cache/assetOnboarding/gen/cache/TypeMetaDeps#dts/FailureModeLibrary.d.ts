// TypeScript definitions for the C3 type FailureModeLibrary

/**
 * A collection of {@link FailureMode}s which are relevant to a single kind of asset..
 *
 * @remarks this represents a value passed to a method that expects an instance of FailureModeLibrary
 */
declare interface IFailureModeLibrary {
 ...
 */
declare class FailureModeLibrary extends Obj  {

  /**
   * Latest uploaded asset hierarchy file or spreadsheet containing the entity.
   */
  readonly assetOnboardingSourceFile?: AssetOnboardingSourceFile;
  withAssetOnboardingSourceFile(assetOnboardingSourceFile: IAssetOnboardingSourceFile | null): FailureModeLibrary;

  /**
   * Indicates when the configuration of this asset was last updated.
   */
  readonly configurationLastUpdated?: DateTime;
  withConfigurationLastUpdated(configurationLastUpdated: DateTime | Date | string | null): FailureModeLibrary;
   ...
   */
  readonly id: string;
  withId(id: string): FailureModeLibrary;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): FailureModeLibrary;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): FailureModeLibrary;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): FailureModeLibrary;
  ...
  withVersion(version: number | null): FailureModeLibrary;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): FailureModeLibrary;

  /**
   * This ID is used to determine which import this entity belongs to.
   */
  readonly trackingIdForImport?: string;
  withTrackingIdForImport(trackingIdForImport: string | null): FailureModeLibrary;
  ...
  withTypeIdent(typeIdent: string | null): FailureModeLibrary;

  /**
   * Failure modes which belong to this library.
   */
  readonly failureModes?: Array_Type<FailureMode>;
  withFailureModes(failureModes: Array_Type<FailureMode> | Array<IFailureMode> | null): FailureModeLibrary;

  /**
   * Number of {@link FailureMode}s this {@link FailureModeLibrary} has.
   */
  readonly countFailureModes?: number;
  withCountFailureModes(countFailureModes: number | null): FailureModeLibrary;
   ...
   * @see #toJson
   */
  static fromJson(json: any): FailureModeLibrary | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): FailureModeLibrary | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): FailureModeLibrary | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): FailureModeLibrary | null;
   ...
   */
  replaceType(old: Type, new_: Type): FailureModeLibrary;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): FailureModeLibrary;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): FailureModeLibrary;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<FailureModeLibrary>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<FailureModeLibrary>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): FailureModeLibrary;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): FailureModeLibrary;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): FailureModeLibrary;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): FailureModeLibrary;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): FailureModeLibrary;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): FailureModeLibrary;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): FailureModeLibrary;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): FailureModeLibrary;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): FailureModeLibrary;
   ...
   * @see #removeField
   */
  withoutField(field: string): FailureModeLibrary;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): FailureModeLibrary;
   ...
   */
  withoutFields(fields: Array_Type<string>): FailureModeLibrary;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): FailureModeLibrary;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): FailureModeLibrary;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): FailureModeLibrary;
   ...
   * @see #unsetField
   */
  defaultField(field: string): FailureModeLibrary;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): FailureModeLibrary;
   ...
   * @see #removeField
   */
  unsetField(field: string): FailureModeLibrary;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): FailureModeLibrary;
   ...
   * @see #unsetField
   */
  removeField(field: string): FailureModeLibrary;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): FailureModeLibrary;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): FailureModeLibrary;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): FailureModeLibrary;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): FailureModeLibrary;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): FailureModeLibrary;

  mergeJson(json: any): FailureModeLibrary;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): FailureModeLibrary;
   ...
   */
  sumObj(other: Obj, deep?: boolean): FailureModeLibrary;
   ...
   */
  singletonArray(): Array_Type<FailureModeLibrary>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<FailureModeLibrary> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<FailureModeLibrary> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<FailureModeLibrary>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<FailureModeLibrary> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, FailureModeLibrary> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, FailureModeLibrary> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<FailureModeLibrary>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<FailureModeLibrary>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): FailureModeLibrary;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): FailureModeLibrary;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): FailureModeLibrary;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): FailureModeLibrary;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): FailureModeLibrary;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): FailureModeLibrary;
   ...
   * @see #fromString
   */
  static make(s: string): FailureModeLibrary | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): FailureModeLibrary;
   ...
   */
  static cachedEmptyInst(): FailureModeLibrary;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<FailureModeLibrary> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): FailureModeLibrary;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<FailureModeLibrary>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<FailureModeLibrary>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<FailureModeLibrary> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<FailureModeLibrary>> | null;
   ...
   */
  get(include?: string): FailureModeLibrary | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): FailureModeLibrary | null;
   ...
   */
  getMissing(spec: GetMissingSpec): FailureModeLibrary;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): FailureModeLibrary | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): FailureModeLibrary;
   ...
   * @see #toString
   */
  static fromString(s: string): FailureModeLibrary | null;
   ...
   */
  create(spec?: UpsertSpec): FailureModeLibrary | null;
   ...
   */
  static createBatch(objs: Array_Type<FailureModeLibrary>, spec?: UpsertSpec): ObjList<FailureModeLibrary> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<FailureModeLibrary>, spec?: CreateBatchObjStreamSpec): ObjList<FailureModeLibrary> | null;
   ...
   */
  update(srcObj?: FailureModeLibrary, spec?: UpsertSpec): FailureModeLibrary | null;
   ...
   */
  upsert(srcObj?: FailureModeLibrary, spec?: UpsertSpec): FailureModeLibrary | null;
   ...
   */
  merge(spec?: MergeSpec): FailureModeLibrary | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): FailureModeLibrary | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): FailureModeLibrary | null;
   ...
   */
  static updateBatch(objs: Array_Type<FailureModeLibrary>, srcObjs?: Array_Type<FailureModeLibrary>, spec?: UpsertSpec): ObjList<FailureModeLibrary> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<FailureModeLibrary> | null>, spec?: UpsertSpec): ObjList<FailureModeLibrary> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<FailureModeLibrary>, srcObjs?: Array_Type<FailureModeLibrary>, spec?: UpsertSpec): ObjList<FailureModeLibrary> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<FailureModeLibrary> | null>, spec?: UpsertSpec): ObjList<FailureModeLibrary> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<FailureModeLibrary>, spec?: TouchSpec): ObjList<FailureModeLibrary> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<FailureModeLibrary>, spec?: MergeSpec): ObjList<FailureModeLibrary> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<FailureModeLibrary>, mergeInclude: string, spec?: MergeSpec): ObjList<FailureModeLibrary> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<FailureModeLibrary> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<FailureModeLibrary> | null;
   ...
   */
  static mergeAll(mergeObj: FailureModeLibrary, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: FailureModeLibrary, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<FailureModeLibrary>, spec?: UpsertSpec): ObjList<FailureModeLibrary> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<FailureModeLibrary>, spec?: UpsertSpec): ObjList<FailureModeLibrary> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): FailureModeLibrary | null;
   ...
   */
  static beforeCreate(objs: Array_Type<FailureModeLibrary>): ObjList<FailureModeLibrary>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<FailureModeLibrary>): ObjList<FailureModeLibrary>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<FailureModeLibrary>): ObjList<FailureModeLibrary>;
   ...
   */
  static afterCreate(objs: Array_Type<FailureModeLibrary>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<FailureModeLibrary>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<FailureModeLibrary>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<FailureModeLibrary>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<FailureModeLibrary>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): FailureModeLibrary | null;
   ...
   */
  withoutIdentity(): FailureModeLibrary | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<FailureModeLibrary>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: FailureModeLibrary, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<FailureModeLibrary>, callback?: λFunction<FailureModeLibrary | null, FailureModeLibrary | null>): ObjList<FailureModeLibrary>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<FailureModeLibrary>, callback?: λFunction<FailureModeLibrary | null, FailureModeLibrary | null>): Array_Type<ObjError> | null;
   ...
   */
  static evaluateFailureModeRecommendation(data: Array_Type<FailureModeRecommendationEvaluationSensorDataSpec>, diagnosticMode: string, failureModeLibrary?: FailureModeLibrary): Array_Type<FailureModeLineItem> | null;
   ...
   */
  createCopy(newName?: string): FailureModeLibrary | null;
   ...
   */
  removeWithRelatedEntities(): void;

  /**
   * Creates new failure mode library
   */
  static createFailureModeLibrary(formObject: any): FailureModeLibrary | null;

  /**
   * Copies existing failure mode library into new failure mode library
   */
  static duplicateFailureModeLibrary(formObject: OpenFailureModeLibrarySpec): FailureModeLibrary | null;
}
