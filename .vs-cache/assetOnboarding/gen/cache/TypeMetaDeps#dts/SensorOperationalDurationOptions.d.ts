// TypeScript definitions for the C3 type SensorOperationalDurationOptions

/**
 * Type used to represent the allowed options and {@link Duration} value when marking a sensor as {@link SensorOperationalStatusEnum#FAULTY}
 *
 * @remarks this represents a value passed to a method that expects an instance of SensorOperationalDurationOptions
 */
declare interface ISensorOperationalDurationOptions {
  ...
  /**
   * Translation string used as the display name
   */
  displayName: string;

  /**
   * The {@link Duration} a {@link Sensor} should be marked {@link SensorOperationalStatusEnum#FAULTY}. If null, the {@link Sensor} has no expiration date and will remain faulty indefinitely.
   */
  duration?: IDuration;

  /**
   * Field used to maintain an ASCENDING sort order for display
   */
  order?: number;
}
 ...
 * Type used to represent the allowed options and {@link Duration} value when marking a sensor as {@link SensorOperationalStatusEnum#FAULTY}
 *
 * @remarks this represents a made instance of SensorOperationalDurationOptions
 */
declare class SensorOperationalDurationOptions extends Obj  {
   ...
   */
  readonly id: string;
  withId(id: string): SensorOperationalDurationOptions;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): SensorOperationalDurationOptions;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): SensorOperationalDurationOptions;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): SensorOperationalDurationOptions;
  ...
  withVersion(version: number | null): SensorOperationalDurationOptions;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): SensorOperationalDurationOptions;

  /**
   * Translation string used as the display name
   */
  readonly displayName: string;
  withDisplayName(displayName: string): SensorOperationalDurationOptions;

  /**
   * The {@link Duration} a {@link Sensor} should be marked {@link SensorOperationalStatusEnum#FAULTY}. If null, the {@link Sensor} has no expiration date and will remain faulty indefinitely.
   */
  readonly duration?: Duration;
  withDuration(duration: IDuration | null): SensorOperationalDurationOptions;

  /**
   * Field used to maintain an ASCENDING sort order for display
   */
  readonly order?: number;
  withOrder(order: number | null): SensorOperationalDurationOptions;
   ...
   * @see #toJson
   */
  static fromJson(json: any): SensorOperationalDurationOptions | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): SensorOperationalDurationOptions | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): SensorOperationalDurationOptions | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): SensorOperationalDurationOptions | null;
   ...
   */
  replaceType(old: Type, new_: Type): SensorOperationalDurationOptions;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): SensorOperationalDurationOptions;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): SensorOperationalDurationOptions;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<SensorOperationalDurationOptions>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<SensorOperationalDurationOptions>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): SensorOperationalDurationOptions;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SensorOperationalDurationOptions;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SensorOperationalDurationOptions;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): SensorOperationalDurationOptions;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): SensorOperationalDurationOptions;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): SensorOperationalDurationOptions;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): SensorOperationalDurationOptions;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): SensorOperationalDurationOptions;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): SensorOperationalDurationOptions;
   ...
   * @see #removeField
   */
  withoutField(field: string): SensorOperationalDurationOptions;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): SensorOperationalDurationOptions;
   ...
   */
  withoutFields(fields: Array_Type<string>): SensorOperationalDurationOptions;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): SensorOperationalDurationOptions;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): SensorOperationalDurationOptions;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): SensorOperationalDurationOptions;
   ...
   * @see #unsetField
   */
  defaultField(field: string): SensorOperationalDurationOptions;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): SensorOperationalDurationOptions;
   ...
   * @see #removeField
   */
  unsetField(field: string): SensorOperationalDurationOptions;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): SensorOperationalDurationOptions;
   ...
   * @see #unsetField
   */
  removeField(field: string): SensorOperationalDurationOptions;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): SensorOperationalDurationOptions;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): SensorOperationalDurationOptions;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): SensorOperationalDurationOptions;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): SensorOperationalDurationOptions;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): SensorOperationalDurationOptions;

  mergeJson(json: any): SensorOperationalDurationOptions;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): SensorOperationalDurationOptions;
   ...
   */
  sumObj(other: Obj, deep?: boolean): SensorOperationalDurationOptions;
   ...
   */
  singletonArray(): Array_Type<SensorOperationalDurationOptions>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<SensorOperationalDurationOptions> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<SensorOperationalDurationOptions> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<SensorOperationalDurationOptions>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<SensorOperationalDurationOptions> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, SensorOperationalDurationOptions> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, SensorOperationalDurationOptions> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<SensorOperationalDurationOptions>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<SensorOperationalDurationOptions>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): SensorOperationalDurationOptions;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): SensorOperationalDurationOptions;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): SensorOperationalDurationOptions;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): SensorOperationalDurationOptions;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): SensorOperationalDurationOptions;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): SensorOperationalDurationOptions;
   ...
   * @see #fromString
   */
  static make(s: string): SensorOperationalDurationOptions | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): SensorOperationalDurationOptions;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): SensorOperationalDurationOptions;
   ...
   */
  static cachedEmptyInst(): SensorOperationalDurationOptions;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<SensorOperationalDurationOptions> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): SensorOperationalDurationOptions;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<SensorOperationalDurationOptions>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<SensorOperationalDurationOptions>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<SensorOperationalDurationOptions> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<SensorOperationalDurationOptions>> | null;
   ...
   */
  get(include?: string): SensorOperationalDurationOptions | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): SensorOperationalDurationOptions | null;
   ...
   */
  getMissing(spec: GetMissingSpec): SensorOperationalDurationOptions;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): SensorOperationalDurationOptions | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): SensorOperationalDurationOptions;
   ...
   * @see #toString
   */
  static fromString(s: string): SensorOperationalDurationOptions | null;
   ...
   */
  create(spec?: UpsertSpec): SensorOperationalDurationOptions | null;
   ...
   */
  static createBatch(objs: Array_Type<SensorOperationalDurationOptions>, spec?: UpsertSpec): ObjList<SensorOperationalDurationOptions> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<SensorOperationalDurationOptions>, spec?: CreateBatchObjStreamSpec): ObjList<SensorOperationalDurationOptions> | null;
   ...
   */
  update(srcObj?: SensorOperationalDurationOptions, spec?: UpsertSpec): SensorOperationalDurationOptions | null;
   ...
   */
  upsert(srcObj?: SensorOperationalDurationOptions, spec?: UpsertSpec): SensorOperationalDurationOptions | null;
   ...
   */
  merge(spec?: MergeSpec): SensorOperationalDurationOptions | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): SensorOperationalDurationOptions | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): SensorOperationalDurationOptions | null;
   ...
   */
  static updateBatch(objs: Array_Type<SensorOperationalDurationOptions>, srcObjs?: Array_Type<SensorOperationalDurationOptions>, spec?: UpsertSpec): ObjList<SensorOperationalDurationOptions> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<SensorOperationalDurationOptions> | null>, spec?: UpsertSpec): ObjList<SensorOperationalDurationOptions> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<SensorOperationalDurationOptions>, srcObjs?: Array_Type<SensorOperationalDurationOptions>, spec?: UpsertSpec): ObjList<SensorOperationalDurationOptions> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<SensorOperationalDurationOptions> | null>, spec?: UpsertSpec): ObjList<SensorOperationalDurationOptions> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<SensorOperationalDurationOptions>, spec?: TouchSpec): ObjList<SensorOperationalDurationOptions> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<SensorOperationalDurationOptions>, spec?: MergeSpec): ObjList<SensorOperationalDurationOptions> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<SensorOperationalDurationOptions>, mergeInclude: string, spec?: MergeSpec): ObjList<SensorOperationalDurationOptions> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<SensorOperationalDurationOptions> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<SensorOperationalDurationOptions> | null;
   ...
   */
  static mergeAll(mergeObj: SensorOperationalDurationOptions, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: SensorOperationalDurationOptions, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<SensorOperationalDurationOptions>, spec?: UpsertSpec): ObjList<SensorOperationalDurationOptions> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<SensorOperationalDurationOptions>, spec?: UpsertSpec): ObjList<SensorOperationalDurationOptions> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): SensorOperationalDurationOptions | null;
   ...
   */
  static beforeCreate(objs: Array_Type<SensorOperationalDurationOptions>): ObjList<SensorOperationalDurationOptions>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<SensorOperationalDurationOptions>): ObjList<SensorOperationalDurationOptions>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<SensorOperationalDurationOptions>): ObjList<SensorOperationalDurationOptions>;
   ...
   */
  static afterCreate(objs: Array_Type<SensorOperationalDurationOptions>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<SensorOperationalDurationOptions>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<SensorOperationalDurationOptions>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<SensorOperationalDurationOptions>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<SensorOperationalDurationOptions>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): SensorOperationalDurationOptions | null;
   ...
   */
  withoutIdentity(): SensorOperationalDurationOptions | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<SensorOperationalDurationOptions>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: SensorOperationalDurationOptions, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<SensorOperationalDurationOptions>, callback?: λFunction<SensorOperationalDurationOptions | null, SensorOperationalDurationOptions | null>): ObjList<SensorOperationalDurationOptions>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<SensorOperationalDurationOptions>, callback?: λFunction<SensorOperationalDurationOptions | null, SensorOperationalDurationOptions | null>): Array_Type<ObjError> | null;
