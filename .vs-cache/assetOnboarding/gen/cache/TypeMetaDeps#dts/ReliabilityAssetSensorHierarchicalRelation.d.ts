// TypeScript definitions for the C3 type ReliabilityAssetSensorHierarchicalRelation

/**
 * Represents the relationship between a {@link ReliabilityAsset} and a child {@link Sensor}.
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityAssetSensorHierarchicalRelation
 */
declare interface IReliabilityAssetSensorHierarchicalRelation {
  ...
  /**
   * The parent {@link ReliabilityAsset} in the relation.
   */
  from: IReliabilityAsset;

  /**
   * The child {@link Sensor} in the relation.
   */
  to: ISensor;
 ...
 * Represents the relationship between a {@link ReliabilityAsset} and a child {@link Sensor}.
 *
 * @remarks this represents a made instance of ReliabilityAssetSensorHierarchicalRelation
 */
declare class ReliabilityAssetSensorHierarchicalRelation extends Obj  {

  /**
   * This ID is used to determine which import this entity belongs to.
   */
  readonly trackingIdForImport?: string;
  withTrackingIdForImport(trackingIdForImport: string | null): ReliabilityAssetSensorHierarchicalRelation;

  /**
   * The id of this instance.
   */
  readonly id: string;
  withId(id: string): ReliabilityAssetSensorHierarchicalRelation;

  /**
   * The parent {@link ReliabilityAsset} in the relation.
   */
  readonly from: ReliabilityAsset;
  withFrom(from: IReliabilityAsset): ReliabilityAssetSensorHierarchicalRelation;

  /**
   * The child {@link Sensor} in the relation.
   */
  readonly to: Sensor;
  withTo(to: ISensor): ReliabilityAssetSensorHierarchicalRelation;
  ...
  withRelationship(relationship: string | null): ReliabilityAssetSensorHierarchicalRelation;

  /**
   * Additional info for the 'from' vertex can be stored here
   */
  readonly fromInfo?: string;
  withFromInfo(fromInfo: string | null): ReliabilityAssetSensorHierarchicalRelation;

  /**
   * Additional info for the 'to' vertex can be stored here
   */
  readonly toInfo?: string;
  withToInfo(toInfo: string | null): ReliabilityAssetSensorHierarchicalRelation;

  /**
   * Placeholder field. Not used in regular computation
   */
  readonly involvement?: number;
  withInvolvement(involvement: number | null): ReliabilityAssetSensorHierarchicalRelation;

  /**
   * Start timestamp for the value.  If null, assumed to be beginning-of-time (BOT).
   */
  readonly start?: DateTime;
  withStart(start: DateTime | Date | string | null): ReliabilityAssetSensorHierarchicalRelation;

  /**
   * End timestamp for the value.  If null, assumed to be end-of-time (EOT).
   */
  readonly end?: DateTime;
  withEnd(end: DateTime | Date | string | null): ReliabilityAssetSensorHierarchicalRelation;
  ...
  withTypeIdent(typeIdent: string | null): ReliabilityAssetSensorHierarchicalRelation;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityAssetSensorHierarchicalRelation;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): ReliabilityAssetSensorHierarchicalRelation;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): ReliabilityAssetSensorHierarchicalRelation;
  ...
  withVersion(version: number | null): ReliabilityAssetSensorHierarchicalRelation;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): ReliabilityAssetSensorHierarchicalRelation;
   ...
   * @see #toJson
   */
  static fromJson(json: any): ReliabilityAssetSensorHierarchicalRelation | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): ReliabilityAssetSensorHierarchicalRelation | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): ReliabilityAssetSensorHierarchicalRelation | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): ReliabilityAssetSensorHierarchicalRelation | null;
   ...
   */
  replaceType(old: Type, new_: Type): ReliabilityAssetSensorHierarchicalRelation;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityAssetSensorHierarchicalRelation;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityAssetSensorHierarchicalRelation;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityAssetSensorHierarchicalRelation>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityAssetSensorHierarchicalRelation>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityAssetSensorHierarchicalRelation;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityAssetSensorHierarchicalRelation;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityAssetSensorHierarchicalRelation;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ReliabilityAssetSensorHierarchicalRelation;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ReliabilityAssetSensorHierarchicalRelation;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityAssetSensorHierarchicalRelation;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityAssetSensorHierarchicalRelation;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityAssetSensorHierarchicalRelation;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ReliabilityAssetSensorHierarchicalRelation;
   ...
   * @see #removeField
   */
  withoutField(field: string): ReliabilityAssetSensorHierarchicalRelation;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): ReliabilityAssetSensorHierarchicalRelation;
   ...
   */
  withoutFields(fields: Array_Type<string>): ReliabilityAssetSensorHierarchicalRelation;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityAssetSensorHierarchicalRelation;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ReliabilityAssetSensorHierarchicalRelation;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityAssetSensorHierarchicalRelation;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ReliabilityAssetSensorHierarchicalRelation;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ReliabilityAssetSensorHierarchicalRelation;
   ...
   * @see #removeField
   */
  unsetField(field: string): ReliabilityAssetSensorHierarchicalRelation;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ReliabilityAssetSensorHierarchicalRelation;
   ...
   * @see #unsetField
   */
  removeField(field: string): ReliabilityAssetSensorHierarchicalRelation;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ReliabilityAssetSensorHierarchicalRelation;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityAssetSensorHierarchicalRelation;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityAssetSensorHierarchicalRelation;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityAssetSensorHierarchicalRelation;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityAssetSensorHierarchicalRelation;

  mergeJson(json: any): ReliabilityAssetSensorHierarchicalRelation;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityAssetSensorHierarchicalRelation;
   ...
   */
  sumObj(other: Obj, deep?: boolean): ReliabilityAssetSensorHierarchicalRelation;
   ...
   */
  singletonArray(): Array_Type<ReliabilityAssetSensorHierarchicalRelation>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityAssetSensorHierarchicalRelation> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ReliabilityAssetSensorHierarchicalRelation> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<ReliabilityAssetSensorHierarchicalRelation>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ReliabilityAssetSensorHierarchicalRelation> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, ReliabilityAssetSensorHierarchicalRelation> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityAssetSensorHierarchicalRelation> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ReliabilityAssetSensorHierarchicalRelation>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ReliabilityAssetSensorHierarchicalRelation>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityAssetSensorHierarchicalRelation;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityAssetSensorHierarchicalRelation;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityAssetSensorHierarchicalRelation;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ReliabilityAssetSensorHierarchicalRelation;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityAssetSensorHierarchicalRelation;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ReliabilityAssetSensorHierarchicalRelation;
   ...
   * @see #fromString
   */
  static make(s: string): ReliabilityAssetSensorHierarchicalRelation | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityAssetSensorHierarchicalRelation;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): ReliabilityAssetSensorHierarchicalRelation;
   ...
   */
  static cachedEmptyInst(): ReliabilityAssetSensorHierarchicalRelation;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityAssetSensorHierarchicalRelation> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): ReliabilityAssetSensorHierarchicalRelation;
   ...
   * @see #toString
   */
  static fromString(s: string): ReliabilityAssetSensorHierarchicalRelation | null;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<ReliabilityAssetSensorHierarchicalRelation>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<ReliabilityAssetSensorHierarchicalRelation>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityAssetSensorHierarchicalRelation> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityAssetSensorHierarchicalRelation>> | null;
   ...
   */
  get(include?: string): ReliabilityAssetSensorHierarchicalRelation | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): ReliabilityAssetSensorHierarchicalRelation | null;
   ...
   */
  getMissing(spec: GetMissingSpec): ReliabilityAssetSensorHierarchicalRelation;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): ReliabilityAssetSensorHierarchicalRelation | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): ReliabilityAssetSensorHierarchicalRelation;
   ...
   */
  create(spec?: UpsertSpec): ReliabilityAssetSensorHierarchicalRelation | null;
   ...
   */
  static createBatch(objs: Array_Type<ReliabilityAssetSensorHierarchicalRelation>, spec?: UpsertSpec): ObjList<ReliabilityAssetSensorHierarchicalRelation> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<ReliabilityAssetSensorHierarchicalRelation>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityAssetSensorHierarchicalRelation> | null;
   ...
   */
  update(srcObj?: ReliabilityAssetSensorHierarchicalRelation, spec?: UpsertSpec): ReliabilityAssetSensorHierarchicalRelation | null;
   ...
   */
  upsert(srcObj?: ReliabilityAssetSensorHierarchicalRelation, spec?: UpsertSpec): ReliabilityAssetSensorHierarchicalRelation | null;
   ...
   */
  merge(spec?: MergeSpec): ReliabilityAssetSensorHierarchicalRelation | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): ReliabilityAssetSensorHierarchicalRelation | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): ReliabilityAssetSensorHierarchicalRelation | null;
   ...
   */
  static updateBatch(objs: Array_Type<ReliabilityAssetSensorHierarchicalRelation>, srcObjs?: Array_Type<ReliabilityAssetSensorHierarchicalRelation>, spec?: UpsertSpec): ObjList<ReliabilityAssetSensorHierarchicalRelation> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<ReliabilityAssetSensorHierarchicalRelation> | null>, spec?: UpsertSpec): ObjList<ReliabilityAssetSensorHierarchicalRelation> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<ReliabilityAssetSensorHierarchicalRelation>, srcObjs?: Array_Type<ReliabilityAssetSensorHierarchicalRelation>, spec?: UpsertSpec): ObjList<ReliabilityAssetSensorHierarchicalRelation> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<ReliabilityAssetSensorHierarchicalRelation> | null>, spec?: UpsertSpec): ObjList<ReliabilityAssetSensorHierarchicalRelation> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<ReliabilityAssetSensorHierarchicalRelation>, spec?: TouchSpec): ObjList<ReliabilityAssetSensorHierarchicalRelation> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityAssetSensorHierarchicalRelation>, spec?: MergeSpec): ObjList<ReliabilityAssetSensorHierarchicalRelation> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityAssetSensorHierarchicalRelation>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityAssetSensorHierarchicalRelation> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<ReliabilityAssetSensorHierarchicalRelation> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityAssetSensorHierarchicalRelation> | null;
   ...
   */
  static mergeAll(mergeObj: ReliabilityAssetSensorHierarchicalRelation, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: ReliabilityAssetSensorHierarchicalRelation, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<ReliabilityAssetSensorHierarchicalRelation>, spec?: UpsertSpec): ObjList<ReliabilityAssetSensorHierarchicalRelation> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<ReliabilityAssetSensorHierarchicalRelation>, spec?: UpsertSpec): ObjList<ReliabilityAssetSensorHierarchicalRelation> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): ReliabilityAssetSensorHierarchicalRelation | null;
   ...
   */
  static beforeCreate(objs: Array_Type<ReliabilityAssetSensorHierarchicalRelation>): ObjList<ReliabilityAssetSensorHierarchicalRelation>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<ReliabilityAssetSensorHierarchicalRelation>): ObjList<ReliabilityAssetSensorHierarchicalRelation>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<ReliabilityAssetSensorHierarchicalRelation>): ObjList<ReliabilityAssetSensorHierarchicalRelation>;
   ...
   */
  static afterCreate(objs: Array_Type<ReliabilityAssetSensorHierarchicalRelation>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<ReliabilityAssetSensorHierarchicalRelation>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<ReliabilityAssetSensorHierarchicalRelation>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityAssetSensorHierarchicalRelation>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityAssetSensorHierarchicalRelation>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): ReliabilityAssetSensorHierarchicalRelation | null;
   ...
   */
  withoutIdentity(): ReliabilityAssetSensorHierarchicalRelation | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<ReliabilityAssetSensorHierarchicalRelation>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: ReliabilityAssetSensorHierarchicalRelation, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<ReliabilityAssetSensorHierarchicalRelation>, callback?: λFunction<ReliabilityAssetSensorHierarchicalRelation | null, ReliabilityAssetSensorHierarchicalRelation | null>): ObjList<ReliabilityAssetSensorHierarchicalRelation>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<ReliabilityAssetSensorHierarchicalRelation>, callback?: λFunction<ReliabilityAssetSensorHierarchicalRelation | null, ReliabilityAssetSensorHierarchicalRelation | null>): Array_Type<ObjError> | null;
