// TypeScript definitions for the C3 type ReliabilityAssetHierarchicalRelation

/**
 * Represents the relationship between a {@link ReliabilityAsset} and a child {@link ReliabilityAsset} or {@link Sensor}. Acts as the edge in the hierarchy denorm graph.
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityAssetHierarchicalRelation
 */
declare interface IReliabilityAssetHierarchicalRelation {
  ...
  /**
   * The {@link ReliabilityAsset} this relation comes from.
   */
  from: IReliabilityAsset;

  /**
   * The {@link PhysicalAsset} this relation connects to. Could be a {@link ReliabilityAsset} or a {@link Sensor}.
   */
 ...
 * Represents the relationship between a {@link ReliabilityAsset} and a child {@link ReliabilityAsset} or {@link Sensor}. Acts as the edge in the hierarchy denorm graph.
 *
 * @remarks this represents a made instance of ReliabilityAssetHierarchicalRelation
 */
declare class ReliabilityAssetHierarchicalRelation extends Obj  {
   ...
   */
  readonly id: string;
  withId(id: string): ReliabilityAssetHierarchicalRelation;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityAssetHierarchicalRelation;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): ReliabilityAssetHierarchicalRelation;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): ReliabilityAssetHierarchicalRelation;
  ...
  withVersion(version: number | null): ReliabilityAssetHierarchicalRelation;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): ReliabilityAssetHierarchicalRelation;

  /**
   * @inheritdoc
   */
  readonly facilityFilterPaths?: Array_Type<string>;
  withFacilityFilterPaths(facilityFilterPaths: Array_Type<string> | Array<string> | null): ReliabilityAssetHierarchicalRelation;

  /**
   * This ID is used to determine which import this entity belongs to.
   */
  readonly trackingIdForImport?: string;
  withTrackingIdForImport(trackingIdForImport: string | null): ReliabilityAssetHierarchicalRelation;

  /**
   * The {@link ReliabilityAsset} this relation comes from.
   */
  readonly from: ReliabilityAsset;
  withFrom(from: IReliabilityAsset): ReliabilityAssetHierarchicalRelation;

  /**
   * The {@link PhysicalAsset} this relation connects to. Could be a {@link ReliabilityAsset} or a {@link Sensor}.
   */
  readonly to: ReliabilityAsset;
  withTo(to: IReliabilityAsset): ReliabilityAssetHierarchicalRelation;
  ...
  withRelationship(relationship: string | null): ReliabilityAssetHierarchicalRelation;

  /**
   * Additional info for the 'from' vertex can be stored here
   */
  readonly fromInfo?: string;
  withFromInfo(fromInfo: string | null): ReliabilityAssetHierarchicalRelation;

  /**
   * Additional info for the 'to' vertex can be stored here
   */
  readonly toInfo?: string;
  withToInfo(toInfo: string | null): ReliabilityAssetHierarchicalRelation;

  /**
   * Placeholder field. Not used in regular computation
   */
  readonly involvement?: number;
  withInvolvement(involvement: number | null): ReliabilityAssetHierarchicalRelation;

  /**
   * Start timestamp for the value.  If null, assumed to be beginning-of-time (BOT).
   */
  readonly start?: DateTime;
  withStart(start: DateTime | Date | string | null): ReliabilityAssetHierarchicalRelation;

  /**
   * End timestamp for the value.  If null, assumed to be end-of-time (EOT).
   */
  readonly end?: DateTime;
  withEnd(end: DateTime | Date | string | null): ReliabilityAssetHierarchicalRelation;
  ...
  withTypeIdent(typeIdent: string | null): ReliabilityAssetHierarchicalRelation;
   ...
   * @see #toJson
   */
  static fromJson(json: any): ReliabilityAssetHierarchicalRelation | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): ReliabilityAssetHierarchicalRelation | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): ReliabilityAssetHierarchicalRelation | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): ReliabilityAssetHierarchicalRelation | null;
   ...
   */
  replaceType(old: Type, new_: Type): ReliabilityAssetHierarchicalRelation;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityAssetHierarchicalRelation;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityAssetHierarchicalRelation;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityAssetHierarchicalRelation>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityAssetHierarchicalRelation>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityAssetHierarchicalRelation;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityAssetHierarchicalRelation;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityAssetHierarchicalRelation;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ReliabilityAssetHierarchicalRelation;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ReliabilityAssetHierarchicalRelation;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityAssetHierarchicalRelation;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityAssetHierarchicalRelation;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityAssetHierarchicalRelation;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ReliabilityAssetHierarchicalRelation;
   ...
   * @see #removeField
   */
  withoutField(field: string): ReliabilityAssetHierarchicalRelation;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): ReliabilityAssetHierarchicalRelation;
   ...
   */
  withoutFields(fields: Array_Type<string>): ReliabilityAssetHierarchicalRelation;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityAssetHierarchicalRelation;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ReliabilityAssetHierarchicalRelation;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityAssetHierarchicalRelation;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ReliabilityAssetHierarchicalRelation;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ReliabilityAssetHierarchicalRelation;
   ...
   * @see #removeField
   */
  unsetField(field: string): ReliabilityAssetHierarchicalRelation;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ReliabilityAssetHierarchicalRelation;
   ...
   * @see #unsetField
   */
  removeField(field: string): ReliabilityAssetHierarchicalRelation;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ReliabilityAssetHierarchicalRelation;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityAssetHierarchicalRelation;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityAssetHierarchicalRelation;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityAssetHierarchicalRelation;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityAssetHierarchicalRelation;

  mergeJson(json: any): ReliabilityAssetHierarchicalRelation;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityAssetHierarchicalRelation;
   ...
   */
  sumObj(other: Obj, deep?: boolean): ReliabilityAssetHierarchicalRelation;
   ...
   */
  singletonArray(): Array_Type<ReliabilityAssetHierarchicalRelation>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityAssetHierarchicalRelation> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ReliabilityAssetHierarchicalRelation> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<ReliabilityAssetHierarchicalRelation>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ReliabilityAssetHierarchicalRelation> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, ReliabilityAssetHierarchicalRelation> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityAssetHierarchicalRelation> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ReliabilityAssetHierarchicalRelation>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ReliabilityAssetHierarchicalRelation>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityAssetHierarchicalRelation;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityAssetHierarchicalRelation;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityAssetHierarchicalRelation;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ReliabilityAssetHierarchicalRelation;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityAssetHierarchicalRelation;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ReliabilityAssetHierarchicalRelation;
   ...
   * @see #fromString
   */
  static make(s: string): ReliabilityAssetHierarchicalRelation | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityAssetHierarchicalRelation;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): ReliabilityAssetHierarchicalRelation;
   ...
   */
  static cachedEmptyInst(): ReliabilityAssetHierarchicalRelation;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityAssetHierarchicalRelation> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): ReliabilityAssetHierarchicalRelation;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<ReliabilityAssetHierarchicalRelation>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<ReliabilityAssetHierarchicalRelation>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityAssetHierarchicalRelation> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityAssetHierarchicalRelation>> | null;
   ...
   */
  get(include?: string): ReliabilityAssetHierarchicalRelation | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): ReliabilityAssetHierarchicalRelation | null;
   ...
   */
  getMissing(spec: GetMissingSpec): ReliabilityAssetHierarchicalRelation;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): ReliabilityAssetHierarchicalRelation | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): ReliabilityAssetHierarchicalRelation;
   ...
   * @see #toString
   */
  static fromString(s: string): ReliabilityAssetHierarchicalRelation | null;
   ...
   */
  create(spec?: UpsertSpec): ReliabilityAssetHierarchicalRelation | null;
   ...
   */
  static createBatch(objs: Array_Type<ReliabilityAssetHierarchicalRelation>, spec?: UpsertSpec): ObjList<ReliabilityAssetHierarchicalRelation> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<ReliabilityAssetHierarchicalRelation>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityAssetHierarchicalRelation> | null;
   ...
   */
  update(srcObj?: ReliabilityAssetHierarchicalRelation, spec?: UpsertSpec): ReliabilityAssetHierarchicalRelation | null;
   ...
   */
  upsert(srcObj?: ReliabilityAssetHierarchicalRelation, spec?: UpsertSpec): ReliabilityAssetHierarchicalRelation | null;
   ...
   */
  merge(spec?: MergeSpec): ReliabilityAssetHierarchicalRelation | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): ReliabilityAssetHierarchicalRelation | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): ReliabilityAssetHierarchicalRelation | null;
   ...
   */
  static updateBatch(objs: Array_Type<ReliabilityAssetHierarchicalRelation>, srcObjs?: Array_Type<ReliabilityAssetHierarchicalRelation>, spec?: UpsertSpec): ObjList<ReliabilityAssetHierarchicalRelation> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<ReliabilityAssetHierarchicalRelation> | null>, spec?: UpsertSpec): ObjList<ReliabilityAssetHierarchicalRelation> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<ReliabilityAssetHierarchicalRelation>, srcObjs?: Array_Type<ReliabilityAssetHierarchicalRelation>, spec?: UpsertSpec): ObjList<ReliabilityAssetHierarchicalRelation> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<ReliabilityAssetHierarchicalRelation> | null>, spec?: UpsertSpec): ObjList<ReliabilityAssetHierarchicalRelation> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<ReliabilityAssetHierarchicalRelation>, spec?: TouchSpec): ObjList<ReliabilityAssetHierarchicalRelation> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityAssetHierarchicalRelation>, spec?: MergeSpec): ObjList<ReliabilityAssetHierarchicalRelation> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityAssetHierarchicalRelation>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityAssetHierarchicalRelation> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<ReliabilityAssetHierarchicalRelation> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityAssetHierarchicalRelation> | null;
   ...
   */
  static mergeAll(mergeObj: ReliabilityAssetHierarchicalRelation, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: ReliabilityAssetHierarchicalRelation, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<ReliabilityAssetHierarchicalRelation>, spec?: UpsertSpec): ObjList<ReliabilityAssetHierarchicalRelation> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<ReliabilityAssetHierarchicalRelation>, spec?: UpsertSpec): ObjList<ReliabilityAssetHierarchicalRelation> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): ReliabilityAssetHierarchicalRelation | null;
   ...
   */
  static beforeCreate(objs: Array_Type<ReliabilityAssetHierarchicalRelation>): ObjList<ReliabilityAssetHierarchicalRelation>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<ReliabilityAssetHierarchicalRelation>): ObjList<ReliabilityAssetHierarchicalRelation>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<ReliabilityAssetHierarchicalRelation>): ObjList<ReliabilityAssetHierarchicalRelation>;
   ...
   */
  static afterCreate(objs: Array_Type<ReliabilityAssetHierarchicalRelation>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<ReliabilityAssetHierarchicalRelation>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<ReliabilityAssetHierarchicalRelation>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityAssetHierarchicalRelation>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityAssetHierarchicalRelation>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): ReliabilityAssetHierarchicalRelation | null;
   ...
   */
  withoutIdentity(): ReliabilityAssetHierarchicalRelation | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<ReliabilityAssetHierarchicalRelation>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: ReliabilityAssetHierarchicalRelation, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<ReliabilityAssetHierarchicalRelation>, callback?: λFunction<ReliabilityAssetHierarchicalRelation | null, ReliabilityAssetHierarchicalRelation | null>): ObjList<ReliabilityAssetHierarchicalRelation>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<ReliabilityAssetHierarchicalRelation>, callback?: λFunction<ReliabilityAssetHierarchicalRelation | null, ReliabilityAssetHierarchicalRelation | null>): Array_Type<ObjError> | null;
  ...
  /**
   * Creates a new {@link ReliabilityAsset} which is the direct child of a {@link Facility} (i.e. a root node of the asset hierarchy).
   *
   * @param formObject
   *        The specification object containing the data for creating the parent asset.
   */
  static createParentAsset(formObject: CreateParentAssetSpec): void;

  /**
   * Creates a new {@link ReliabilityAsset} which is the child of an existing {@link ReliabilityAsset}.
   *
   * @param formObject
   *        The specification object containing the data for creating the child asset.
   */
  static createChildAsset(formObject: CreateChildAssetSpec): void;
}
