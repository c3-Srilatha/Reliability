// TypeScript definitions for the C3 type ParsedSensor

/**
 * This type represents a detected sensor from a parsed diagram.
 *
 * @remarks this represents a value passed to a method that expects an instance of ParsedSensor
 */
declare interface IParsedSensor {
   ...
   */
  originalMatchedActualSensor?: IMasterSensor;
   ...
   */
  collidingSensors?: Array_Type<ParsedSensor> | Array<IParsedSensor>;
 ...
 */
declare class ParsedSensor extends Obj  {

  /**
   * This ID is used to determine which import this entity belongs to.
   */
  readonly trackingIdForImport?: string;
  withTrackingIdForImport(trackingIdForImport: string | null): ParsedSensor;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ParsedSensor;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): ParsedSensor;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): ParsedSensor;
  ...
  withVersion(version: number | null): ParsedSensor;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): ParsedSensor;

  /**
   * {@link ParsedDiagramExtract} this ParsedSensor is from.
   */
  readonly diagramExtract?: ParsedDiagramExtract;
  withDiagramExtract(diagramExtract: IParsedDiagramExtract | null): ParsedSensor;

  /**
   * {@link ParsableDiagram} this asset is extracted from.
   */
  readonly diagram: ParsableDiagram;
  withDiagram(diagram: IParsableDiagram): ParsedSensor;

  /**
   * {@link DiagramParsingBoundingBox} of the detected sensor.
   */
  readonly boundingBox?: DiagramParsingBoundingBox;
  withBoundingBox(boundingBox: IDiagramParsingBoundingBox | null): ParsedSensor;

  /**
   * The text associated with the detected sensor.
   */
  readonly parsedText?: string;
  withParsedText(parsedText: string | null): ParsedSensor;

  /**
   * Reference to the currently proposed {@link MasterSensor} entity corresponding to this detected sensor.
   */
  readonly actualSensor?: MasterSensor;
  withActualSensor(actualSensor: IMasterSensor | null): ParsedSensor;

  /**
   * Reference to the original {@link MasterSensor} entity matched to this {@link ParsedSensor} by the {@link StringMatchingPipe}.
   * This field should not be changed after it is set.
   */
  readonly originalMatchedActualSensor?: MasterSensor;
  withOriginalMatchedActualSensor(originalMatchedActualSensor: IMasterSensor | null): ParsedSensor;

  /**
   * Flag indicating if this parsed sensor has been manually verified to be a match to the linked {@link actualSensor}.
   */
  readonly isVerified?: boolean;
  withIsVerified(isVerified: boolean): ParsedSensor;

  /**
   * All parsed sensors from any {@link ParsableDiagram} which is currently matched to the same {@link Sensor}.
   */
  readonly collidingSensors?: Array_Type<ParsedSensor>;
  withCollidingSensors(collidingSensors: Array_Type<ParsedSensor> | Array<IParsedSensor> | null): ParsedSensor;

  /**
   * Flag indicating if any other parsed sensors are matched to the same {@link actualSensor} as this parsed sensor.
   */
  readonly isDuplicate?: boolean;
  withIsDuplicate(isDuplicate: boolean): ParsedSensor;

  /**
   * Match confidence score of this {@link ParsedSensor} computed in the {@link ImageToTextPipe}.
   */
  readonly matchConfidenceScore?: number;
  withMatchConfidenceScore(matchConfidenceScore: number | null): ParsedSensor;

  /**
   * The current match confidence level of this {@link ParsedSensor} calculated based on {@link matchConfidenceScore}.
   */
  readonly matchConfidenceLevel?: string;
  withMatchConfidenceLevel(matchConfidenceLevel: string | null): ParsedSensor;
   ...
   * @see #toJson
   */
  static fromJson(json: any): ParsedSensor | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): ParsedSensor | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): ParsedSensor | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): ParsedSensor | null;
   ...
   */
  replaceType(old: Type, new_: Type): ParsedSensor;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ParsedSensor;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ParsedSensor;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ParsedSensor>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ParsedSensor>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ParsedSensor;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ParsedSensor;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ParsedSensor;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ParsedSensor;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ParsedSensor;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ParsedSensor;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ParsedSensor;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ParsedSensor;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ParsedSensor;
   ...
   * @see #removeField
   */
  withoutField(field: string): ParsedSensor;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): ParsedSensor;
   ...
   */
  withoutFields(fields: Array_Type<string>): ParsedSensor;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): ParsedSensor;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ParsedSensor;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ParsedSensor;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ParsedSensor;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ParsedSensor;
   ...
   * @see #removeField
   */
  unsetField(field: string): ParsedSensor;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ParsedSensor;
   ...
   * @see #unsetField
   */
  removeField(field: string): ParsedSensor;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ParsedSensor;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ParsedSensor;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): ParsedSensor;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ParsedSensor;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ParsedSensor;

  mergeJson(json: any): ParsedSensor;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ParsedSensor;
   ...
   */
  sumObj(other: Obj, deep?: boolean): ParsedSensor;
   ...
   */
  singletonArray(): Array_Type<ParsedSensor>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<ParsedSensor> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ParsedSensor> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<ParsedSensor>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ParsedSensor> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, ParsedSensor> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ParsedSensor> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ParsedSensor>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ParsedSensor>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ParsedSensor;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ParsedSensor;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ParsedSensor;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ParsedSensor;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ParsedSensor;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ParsedSensor;
   ...
   * @see #fromString
   */
  static make(s: string): ParsedSensor | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ParsedSensor;
   ...
   */
  static cachedEmptyInst(): ParsedSensor;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<ParsedSensor> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): ParsedSensor;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<ParsedSensor>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<ParsedSensor>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<ParsedSensor> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ParsedSensor>> | null;
   ...
   */
  get(include?: string): ParsedSensor | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): ParsedSensor | null;
   ...
   */
  getMissing(spec: GetMissingSpec): ParsedSensor;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): ParsedSensor | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): ParsedSensor;
   ...
   * @see #toString
   */
  static fromString(s: string): ParsedSensor | null;
   ...
   */
  create(spec?: UpsertSpec): ParsedSensor | null;
   ...
   */
  static createBatch(objs: Array_Type<ParsedSensor>, spec?: UpsertSpec): ObjList<ParsedSensor> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<ParsedSensor>, spec?: CreateBatchObjStreamSpec): ObjList<ParsedSensor> | null;
   ...
   */
  update(srcObj?: ParsedSensor, spec?: UpsertSpec): ParsedSensor | null;
   ...
   */
  upsert(srcObj?: ParsedSensor, spec?: UpsertSpec): ParsedSensor | null;
   ...
   */
  merge(spec?: MergeSpec): ParsedSensor | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): ParsedSensor | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): ParsedSensor | null;
   ...
   */
  static updateBatch(objs: Array_Type<ParsedSensor>, srcObjs?: Array_Type<ParsedSensor>, spec?: UpsertSpec): ObjList<ParsedSensor> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<ParsedSensor> | null>, spec?: UpsertSpec): ObjList<ParsedSensor> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<ParsedSensor>, srcObjs?: Array_Type<ParsedSensor>, spec?: UpsertSpec): ObjList<ParsedSensor> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<ParsedSensor> | null>, spec?: UpsertSpec): ObjList<ParsedSensor> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<ParsedSensor>, spec?: TouchSpec): ObjList<ParsedSensor> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ParsedSensor>, spec?: MergeSpec): ObjList<ParsedSensor> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ParsedSensor>, mergeInclude: string, spec?: MergeSpec): ObjList<ParsedSensor> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<ParsedSensor> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ParsedSensor> | null;
   ...
   */
  static mergeAll(mergeObj: ParsedSensor, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: ParsedSensor, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<ParsedSensor>, spec?: UpsertSpec): ObjList<ParsedSensor> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<ParsedSensor>, spec?: UpsertSpec): ObjList<ParsedSensor> | null;
   ...
   */
  static beforeCreate(objs: Array_Type<ParsedSensor>): ObjList<ParsedSensor>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<ParsedSensor>): ObjList<ParsedSensor>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<ParsedSensor>): ObjList<ParsedSensor>;
   ...
   */
  static afterCreate(objs: Array_Type<ParsedSensor>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<ParsedSensor>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<ParsedSensor>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<ParsedSensor>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ParsedSensor>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): ParsedSensor | null;
   ...
   */
  withoutIdentity(): ParsedSensor | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<ParsedSensor>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: ParsedSensor, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<ParsedSensor>, callback?: λFunction<ParsedSensor | null, ParsedSensor | null>): ObjList<ParsedSensor>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<ParsedSensor>, callback?: λFunction<ParsedSensor | null, ParsedSensor | null>): Array_Type<ObjError> | null;
   ...
   */
  static deleteBatch(parsedSensorObjs: Array_Type<ParsedSensor>): ObjList<ParsedSensor>;

  /**
   * Manually creates a {@link ParsedSensor} entity with the passed in {@link Sensor}
   */
  static createArtificialParsedSensor(formObject: any, diagramId?: string): Array_Type<ParsedSensor> | null;
   ...
   */
  static verifyBatch(parsedSensorObjs: Array_Type<ParsedSensor>): number | null;
   ...
   */
  static fetchForDiagramViewer(spec?: FetchSpec): any;
}
