// TypeScript definitions for the C3 type FailureModePriority

/**
 * Represents the priority level of a failure mode.
 *
 * @remarks this represents a value passed to a method that expects an instance of FailureModePriority
 */
declare interface IFailureModePriority {
 ...
 */
declare class FailureModePriority extends Obj  {
   ...
   */
  readonly id: string;
  withId(id: string): FailureModePriority;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): FailureModePriority;

  /**
   * Name of the priority
   */
  readonly name?: string;
  withName(name: string | null): FailureModePriority;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): FailureModePriority;
  ...
  withVersion(version: number | null): FailureModePriority;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): FailureModePriority;

  /**
   * This ID is used to determine which import this entity belongs to.
   */
  readonly trackingIdForImport?: string;
  withTrackingIdForImport(trackingIdForImport: string | null): FailureModePriority;

  /**
   * Ranking of the priority. 0 is the highest rank
   */
  readonly rank: number;
  withRank(rank: number): FailureModePriority;

  /**
   * Translated {@link FailureModePriority#name}, to be used in the UI.
   */
  readonly translatedName?: string;
  withTranslatedName(translatedName: string | null): FailureModePriority;
   ...
   * @see #toJson
   */
  static fromJson(json: any): FailureModePriority | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): FailureModePriority | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): FailureModePriority | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): FailureModePriority | null;
   ...
   */
  replaceType(old: Type, new_: Type): FailureModePriority;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): FailureModePriority;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): FailureModePriority;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<FailureModePriority>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<FailureModePriority>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): FailureModePriority;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): FailureModePriority;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): FailureModePriority;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): FailureModePriority;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): FailureModePriority;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): FailureModePriority;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): FailureModePriority;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): FailureModePriority;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): FailureModePriority;
   ...
   * @see #removeField
   */
  withoutField(field: string): FailureModePriority;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): FailureModePriority;
   ...
   */
  withoutFields(fields: Array_Type<string>): FailureModePriority;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): FailureModePriority;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): FailureModePriority;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): FailureModePriority;
   ...
   * @see #unsetField
   */
  defaultField(field: string): FailureModePriority;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): FailureModePriority;
   ...
   * @see #removeField
   */
  unsetField(field: string): FailureModePriority;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): FailureModePriority;
   ...
   * @see #unsetField
   */
  removeField(field: string): FailureModePriority;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): FailureModePriority;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): FailureModePriority;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): FailureModePriority;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): FailureModePriority;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): FailureModePriority;

  mergeJson(json: any): FailureModePriority;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): FailureModePriority;
   ...
   */
  sumObj(other: Obj, deep?: boolean): FailureModePriority;
   ...
   */
  singletonArray(): Array_Type<FailureModePriority>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<FailureModePriority> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<FailureModePriority> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<FailureModePriority>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<FailureModePriority> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, FailureModePriority> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, FailureModePriority> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<FailureModePriority>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<FailureModePriority>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): FailureModePriority;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): FailureModePriority;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): FailureModePriority;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): FailureModePriority;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): FailureModePriority;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): FailureModePriority;
   ...
   * @see #fromString
   */
  static make(s: string): FailureModePriority | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): FailureModePriority;
   ...
   */
  static cachedEmptyInst(): FailureModePriority;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<FailureModePriority> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): FailureModePriority;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<FailureModePriority>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<FailureModePriority>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<FailureModePriority> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<FailureModePriority>> | null;
   ...
   */
  get(include?: string): FailureModePriority | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): FailureModePriority | null;
   ...
   */
  getMissing(spec: GetMissingSpec): FailureModePriority;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): FailureModePriority | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): FailureModePriority;
   ...
   * @see #toString
   */
  static fromString(s: string): FailureModePriority | null;
   ...
   */
  create(spec?: UpsertSpec): FailureModePriority | null;
   ...
   */
  static createBatch(objs: Array_Type<FailureModePriority>, spec?: UpsertSpec): ObjList<FailureModePriority> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<FailureModePriority>, spec?: CreateBatchObjStreamSpec): ObjList<FailureModePriority> | null;
   ...
   */
  update(srcObj?: FailureModePriority, spec?: UpsertSpec): FailureModePriority | null;
   ...
   */
  upsert(srcObj?: FailureModePriority, spec?: UpsertSpec): FailureModePriority | null;
   ...
   */
  merge(spec?: MergeSpec): FailureModePriority | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): FailureModePriority | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): FailureModePriority | null;
   ...
   */
  static updateBatch(objs: Array_Type<FailureModePriority>, srcObjs?: Array_Type<FailureModePriority>, spec?: UpsertSpec): ObjList<FailureModePriority> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<FailureModePriority> | null>, spec?: UpsertSpec): ObjList<FailureModePriority> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<FailureModePriority>, srcObjs?: Array_Type<FailureModePriority>, spec?: UpsertSpec): ObjList<FailureModePriority> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<FailureModePriority> | null>, spec?: UpsertSpec): ObjList<FailureModePriority> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<FailureModePriority>, spec?: TouchSpec): ObjList<FailureModePriority> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<FailureModePriority>, spec?: MergeSpec): ObjList<FailureModePriority> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<FailureModePriority>, mergeInclude: string, spec?: MergeSpec): ObjList<FailureModePriority> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<FailureModePriority> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<FailureModePriority> | null;
   ...
   */
  static mergeAll(mergeObj: FailureModePriority, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: FailureModePriority, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<FailureModePriority>, spec?: UpsertSpec): ObjList<FailureModePriority> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<FailureModePriority>, spec?: UpsertSpec): ObjList<FailureModePriority> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): FailureModePriority | null;
   ...
   */
  static beforeCreate(objs: Array_Type<FailureModePriority>): ObjList<FailureModePriority>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<FailureModePriority>): ObjList<FailureModePriority>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<FailureModePriority>): ObjList<FailureModePriority>;
   ...
   */
  static afterCreate(objs: Array_Type<FailureModePriority>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<FailureModePriority>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<FailureModePriority>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<FailureModePriority>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<FailureModePriority>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): FailureModePriority | null;
   ...
   */
  withoutIdentity(): FailureModePriority | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<FailureModePriority>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: FailureModePriority, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<FailureModePriority>, callback?: λFunction<FailureModePriority | null, FailureModePriority | null>): ObjList<FailureModePriority>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<FailureModePriority>, callback?: λFunction<FailureModePriority | null, FailureModePriority | null>): Array_Type<ObjError> | null;
