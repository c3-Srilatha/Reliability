// TypeScript definitions for the C3 type AssetOnboardingFailureModeApplicationState

/**
 * Application state for the target {@link FailureMode}.
 *
 * @remarks this represents a value passed to a method that expects an instance of AssetOnboardingFailureModeApplicationState
 */
declare interface IAssetOnboardingFailureModeApplicationState {
  ...
  /**
   * The target {@link FailureMode}.
   */
  targetFailureMode?: IFailureMode;
 ...
 * Application state for the target {@link FailureMode}.
 *
 * @remarks this represents a made instance of AssetOnboardingFailureModeApplicationState
 */
declare class AssetOnboardingFailureModeApplicationState extends Obj  {

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): AssetOnboardingFailureModeApplicationState;

  /**
   * Unique identifier for the logical object that instance of this type represents.
   */
  readonly id?: string;
  withId(id: string | null): AssetOnboardingFailureModeApplicationState;

  /**
   * The name of the component. Optional field for informational purposes only.
   */
  readonly name?: string;
  withName(name: string | null): AssetOnboardingFailureModeApplicationState;
  ...
  withDataSpec(dataSpec: IUiSdlNoData | null): AssetOnboardingFailureModeApplicationState;

  /**
   * Disable if you want to avoid sending any and all requests for this component on first render.
   */
  readonly disableDataRequestOnFirstRender?: boolean;
  withDisableDataRequestOnFirstRender(disableDataRequestOnFirstRender: boolean): AssetOnboardingFailureModeApplicationState;

  /**
   * Whether the effect triggers and epics have been registered
   */
  readonly triggersRegistered?: boolean;
  withTriggersRegistered(triggersRegistered: boolean): AssetOnboardingFailureModeApplicationState;

  /**
   * Whether to wrap the component with a div which has a class name of its metdata id. Useful for targeting with css.
   */
  readonly wrapWithMetadataId?: boolean;
  withWrapWithMetadataId(wrapWithMetadataId: boolean): AssetOnboardingFailureModeApplicationState;

  /**
   * The Redux namespace for the application state to indicate where the application data is stored in the Redux state.
   */
  readonly REDUX_NAMESPACE?: string;
  withREDUX_NAMESPACE(REDUX_NAMESPACE: string | null): AssetOnboardingFailureModeApplicationState;

  /**
   * Collection of extra async {@link UiSdlEffectTrigger}.
   */
  readonly effectTriggers?: Array_Type<UiSdlEffectTrigger>;
  withEffectTriggers(effectTriggers: Array_Type<UiSdlEffectTrigger> | Array<IUiSdlEffectTrigger> | null): AssetOnboardingFailureModeApplicationState;

  /**
   * The target {@link FailureMode}.
   */
  readonly targetFailureMode?: FailureMode;
  withTargetFailureMode(targetFailureMode: IFailureMode | null): AssetOnboardingFailureModeApplicationState;

  /**
   * The entity to be deleted.
   */
  readonly entityToDelete?: any;
  withEntityToDelete(entityToDelete: any | null): AssetOnboardingFailureModeApplicationState;

  /**
   * The name of the entity to be deleted.
   */
  readonly entityToDeleteName?: string;
  withEntityToDeleteName(entityToDeleteName: string | null): AssetOnboardingFailureModeApplicationState;
   ...
   * @see #toJson
   */
  static fromJson(json: any): AssetOnboardingFailureModeApplicationState | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): AssetOnboardingFailureModeApplicationState | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): AssetOnboardingFailureModeApplicationState | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): AssetOnboardingFailureModeApplicationState | null;
   ...
   */
  replaceType(old: Type, new_: Type): AssetOnboardingFailureModeApplicationState;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): AssetOnboardingFailureModeApplicationState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): AssetOnboardingFailureModeApplicationState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<AssetOnboardingFailureModeApplicationState>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<AssetOnboardingFailureModeApplicationState>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): AssetOnboardingFailureModeApplicationState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): AssetOnboardingFailureModeApplicationState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): AssetOnboardingFailureModeApplicationState;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): AssetOnboardingFailureModeApplicationState;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): AssetOnboardingFailureModeApplicationState;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): AssetOnboardingFailureModeApplicationState;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): AssetOnboardingFailureModeApplicationState;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): AssetOnboardingFailureModeApplicationState;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): AssetOnboardingFailureModeApplicationState;
   ...
   * @see #removeField
   */
  withoutField(field: string): AssetOnboardingFailureModeApplicationState;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): AssetOnboardingFailureModeApplicationState;
   ...
   */
  withoutFields(fields: Array_Type<string>): AssetOnboardingFailureModeApplicationState;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): AssetOnboardingFailureModeApplicationState;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): AssetOnboardingFailureModeApplicationState;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): AssetOnboardingFailureModeApplicationState;
   ...
   * @see #unsetField
   */
  defaultField(field: string): AssetOnboardingFailureModeApplicationState;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): AssetOnboardingFailureModeApplicationState;
   ...
   * @see #removeField
   */
  unsetField(field: string): AssetOnboardingFailureModeApplicationState;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): AssetOnboardingFailureModeApplicationState;
   ...
   * @see #unsetField
   */
  removeField(field: string): AssetOnboardingFailureModeApplicationState;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): AssetOnboardingFailureModeApplicationState;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): AssetOnboardingFailureModeApplicationState;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): AssetOnboardingFailureModeApplicationState;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): AssetOnboardingFailureModeApplicationState;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): AssetOnboardingFailureModeApplicationState;

  mergeJson(json: any): AssetOnboardingFailureModeApplicationState;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): AssetOnboardingFailureModeApplicationState;
   ...
   */
  sumObj(other: Obj, deep?: boolean): AssetOnboardingFailureModeApplicationState;
   ...
   */
  singletonArray(): Array_Type<AssetOnboardingFailureModeApplicationState>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<AssetOnboardingFailureModeApplicationState> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<AssetOnboardingFailureModeApplicationState> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<AssetOnboardingFailureModeApplicationState>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<AssetOnboardingFailureModeApplicationState> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, AssetOnboardingFailureModeApplicationState> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, AssetOnboardingFailureModeApplicationState> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<AssetOnboardingFailureModeApplicationState>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<AssetOnboardingFailureModeApplicationState>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): AssetOnboardingFailureModeApplicationState;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): AssetOnboardingFailureModeApplicationState;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): AssetOnboardingFailureModeApplicationState;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): AssetOnboardingFailureModeApplicationState;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): AssetOnboardingFailureModeApplicationState;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): AssetOnboardingFailureModeApplicationState;
   ...
   * @see #fromString
   */
  static make(s: string): AssetOnboardingFailureModeApplicationState | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): AssetOnboardingFailureModeApplicationState;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): AssetOnboardingFailureModeApplicationState;
   ...
   */
  static cachedEmptyInst(): AssetOnboardingFailureModeApplicationState;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<AssetOnboardingFailureModeApplicationState> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): AssetOnboardingFailureModeApplicationState;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<AssetOnboardingFailureModeApplicationState>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<AssetOnboardingFailureModeApplicationState>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<AssetOnboardingFailureModeApplicationState> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<AssetOnboardingFailureModeApplicationState>> | null;
   ...
   */
  dependencies(): MetadataDeps<AssetOnboardingFailureModeApplicationState>;

  save(subPath?: string, contentType?: string): AssetOnboardingFailureModeApplicationState;
  ...
  update(srcObj?: AssetOnboardingFailureModeApplicationState, spec?: UpsertSpec): AssetOnboardingFailureModeApplicationState | null;

  upsert(srcObj?: AssetOnboardingFailureModeApplicationState, spec?: UpsertSpec): AssetOnboardingFailureModeApplicationState | null;
   ...
   * @see #toString
   */
  static fromString(s: string): AssetOnboardingFailureModeApplicationState | null;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string, failIfMissing?: boolean): AssetOnboardingFailureModeApplicationState | null;
   ...
   */
  static doDataMerge(componentId: string, dataSpecFieldName: string, dataDestinationFieldName: string, props: AssetOnboardingFailureModeApplicationState, state: UiSdlReduxState): AssetOnboardingFailureModeApplicationState | null;
