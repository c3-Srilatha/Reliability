// TypeScript definitions for the C3 type AssetOnboardingExportJobBatchResult

/**
 * Represents the result of each batch of {@link AssetOnboardingExportJob}.
 *
 * @remarks this represents a value passed to a method that expects an instance of AssetOnboardingExportJobBatchResult
 */
declare interface IAssetOnboardingExportJobBatchResult {
   ...
   * equal to "AssetOnboardingExportJob", since this type is a singleton.
   */
  job: IAssetOnboardingExportJob;
  ...
  /**
   * The basePath the files are created in.
   */
  basePath: string;

  /**
   * An identifier to give this result. Used to aggregate the result of the parser job
   * for a particular {@link Workflow.Run} of {@link AssetOnboardingExport}.
   */
  trackingId: string;

  /**
   * A zip file created by the batch job containing the exported data.
   */
  zipFile?: string;

  /**
   * The error message that occurred during the processing of this batch.
   */
  error?: string;
}
 ...
 * Represents the result of each batch of {@link AssetOnboardingExportJob}.
 *
 * @remarks this represents a made instance of AssetOnboardingExportJobBatchResult
 */
declare class AssetOnboardingExportJobBatchResult extends Obj  {
   ...
   */
  readonly id: string;
  withId(id: string): AssetOnboardingExportJobBatchResult;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): AssetOnboardingExportJobBatchResult;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): AssetOnboardingExportJobBatchResult;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): AssetOnboardingExportJobBatchResult;
  ...
  withVersion(version: number | null): AssetOnboardingExportJobBatchResult;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): AssetOnboardingExportJobBatchResult;

  /**
   * The job that was executed to produce this result. This will always be the job with `id`
   * equal to "AssetOnboardingExportJob", since this type is a singleton.
   */
  readonly job: AssetOnboardingExportJob;
  withJob(job: IAssetOnboardingExportJob): AssetOnboardingExportJobBatchResult;

  /**
   * Indicates whether the batch was successfully processed or not.
   */
  readonly status: string;
  withStatus(status: string): AssetOnboardingExportJobBatchResult;

  /**
   * The basePath the files are created in.
   */
  readonly basePath: string;
  withBasePath(basePath: string): AssetOnboardingExportJobBatchResult;
  ...
  withTrackingId(trackingId: string): AssetOnboardingExportJobBatchResult;

  /**
   * A zip file created by the batch job containing the exported data.
   */
  readonly zipFile?: string;
  withZipFile(zipFile: string | null): AssetOnboardingExportJobBatchResult;

  /**
   * The error message that occurred during the processing of this batch.
   */
  readonly error?: string;
  withError(error: string | null): AssetOnboardingExportJobBatchResult;
   ...
   * @see #toJson
   */
  static fromJson(json: any): AssetOnboardingExportJobBatchResult | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): AssetOnboardingExportJobBatchResult | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): AssetOnboardingExportJobBatchResult | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): AssetOnboardingExportJobBatchResult | null;
   ...
   */
  replaceType(old: Type, new_: Type): AssetOnboardingExportJobBatchResult;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): AssetOnboardingExportJobBatchResult;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): AssetOnboardingExportJobBatchResult;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<AssetOnboardingExportJobBatchResult>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<AssetOnboardingExportJobBatchResult>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): AssetOnboardingExportJobBatchResult;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): AssetOnboardingExportJobBatchResult;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): AssetOnboardingExportJobBatchResult;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): AssetOnboardingExportJobBatchResult;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): AssetOnboardingExportJobBatchResult;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): AssetOnboardingExportJobBatchResult;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): AssetOnboardingExportJobBatchResult;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): AssetOnboardingExportJobBatchResult;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): AssetOnboardingExportJobBatchResult;
   ...
   * @see #removeField
   */
  withoutField(field: string): AssetOnboardingExportJobBatchResult;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): AssetOnboardingExportJobBatchResult;
   ...
   */
  withoutFields(fields: Array_Type<string>): AssetOnboardingExportJobBatchResult;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): AssetOnboardingExportJobBatchResult;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): AssetOnboardingExportJobBatchResult;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): AssetOnboardingExportJobBatchResult;
   ...
   * @see #unsetField
   */
  defaultField(field: string): AssetOnboardingExportJobBatchResult;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): AssetOnboardingExportJobBatchResult;
   ...
   * @see #removeField
   */
  unsetField(field: string): AssetOnboardingExportJobBatchResult;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): AssetOnboardingExportJobBatchResult;
   ...
   * @see #unsetField
   */
  removeField(field: string): AssetOnboardingExportJobBatchResult;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): AssetOnboardingExportJobBatchResult;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): AssetOnboardingExportJobBatchResult;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): AssetOnboardingExportJobBatchResult;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): AssetOnboardingExportJobBatchResult;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): AssetOnboardingExportJobBatchResult;

  mergeJson(json: any): AssetOnboardingExportJobBatchResult;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): AssetOnboardingExportJobBatchResult;
   ...
   */
  sumObj(other: Obj, deep?: boolean): AssetOnboardingExportJobBatchResult;
   ...
   */
  singletonArray(): Array_Type<AssetOnboardingExportJobBatchResult>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<AssetOnboardingExportJobBatchResult> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<AssetOnboardingExportJobBatchResult> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<AssetOnboardingExportJobBatchResult>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<AssetOnboardingExportJobBatchResult> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, AssetOnboardingExportJobBatchResult> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, AssetOnboardingExportJobBatchResult> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<AssetOnboardingExportJobBatchResult>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<AssetOnboardingExportJobBatchResult>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): AssetOnboardingExportJobBatchResult;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): AssetOnboardingExportJobBatchResult;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): AssetOnboardingExportJobBatchResult;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): AssetOnboardingExportJobBatchResult;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): AssetOnboardingExportJobBatchResult;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): AssetOnboardingExportJobBatchResult;
   ...
   * @see #fromString
   */
  static make(s: string): AssetOnboardingExportJobBatchResult | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): AssetOnboardingExportJobBatchResult;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): AssetOnboardingExportJobBatchResult;
   ...
   */
  static cachedEmptyInst(): AssetOnboardingExportJobBatchResult;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<AssetOnboardingExportJobBatchResult> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): AssetOnboardingExportJobBatchResult;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<AssetOnboardingExportJobBatchResult>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<AssetOnboardingExportJobBatchResult>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<AssetOnboardingExportJobBatchResult> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<AssetOnboardingExportJobBatchResult>> | null;
   ...
   */
  get(include?: string): AssetOnboardingExportJobBatchResult | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): AssetOnboardingExportJobBatchResult | null;
   ...
   */
  getMissing(spec: GetMissingSpec): AssetOnboardingExportJobBatchResult;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): AssetOnboardingExportJobBatchResult | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): AssetOnboardingExportJobBatchResult;
   ...
   * @see #toString
   */
  static fromString(s: string): AssetOnboardingExportJobBatchResult | null;
   ...
   */
  create(spec?: UpsertSpec): AssetOnboardingExportJobBatchResult | null;
   ...
   */
  static createBatch(objs: Array_Type<AssetOnboardingExportJobBatchResult>, spec?: UpsertSpec): ObjList<AssetOnboardingExportJobBatchResult> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<AssetOnboardingExportJobBatchResult>, spec?: CreateBatchObjStreamSpec): ObjList<AssetOnboardingExportJobBatchResult> | null;
   ...
   */
  update(srcObj?: AssetOnboardingExportJobBatchResult, spec?: UpsertSpec): AssetOnboardingExportJobBatchResult | null;
   ...
   */
  upsert(srcObj?: AssetOnboardingExportJobBatchResult, spec?: UpsertSpec): AssetOnboardingExportJobBatchResult | null;
   ...
   */
  merge(spec?: MergeSpec): AssetOnboardingExportJobBatchResult | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): AssetOnboardingExportJobBatchResult | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): AssetOnboardingExportJobBatchResult | null;
   ...
   */
  static updateBatch(objs: Array_Type<AssetOnboardingExportJobBatchResult>, srcObjs?: Array_Type<AssetOnboardingExportJobBatchResult>, spec?: UpsertSpec): ObjList<AssetOnboardingExportJobBatchResult> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<AssetOnboardingExportJobBatchResult> | null>, spec?: UpsertSpec): ObjList<AssetOnboardingExportJobBatchResult> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<AssetOnboardingExportJobBatchResult>, srcObjs?: Array_Type<AssetOnboardingExportJobBatchResult>, spec?: UpsertSpec): ObjList<AssetOnboardingExportJobBatchResult> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<AssetOnboardingExportJobBatchResult> | null>, spec?: UpsertSpec): ObjList<AssetOnboardingExportJobBatchResult> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<AssetOnboardingExportJobBatchResult>, spec?: TouchSpec): ObjList<AssetOnboardingExportJobBatchResult> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<AssetOnboardingExportJobBatchResult>, spec?: MergeSpec): ObjList<AssetOnboardingExportJobBatchResult> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<AssetOnboardingExportJobBatchResult>, mergeInclude: string, spec?: MergeSpec): ObjList<AssetOnboardingExportJobBatchResult> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<AssetOnboardingExportJobBatchResult> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<AssetOnboardingExportJobBatchResult> | null;
   ...
   */
  static mergeAll(mergeObj: AssetOnboardingExportJobBatchResult, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: AssetOnboardingExportJobBatchResult, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<AssetOnboardingExportJobBatchResult>, spec?: UpsertSpec): ObjList<AssetOnboardingExportJobBatchResult> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<AssetOnboardingExportJobBatchResult>, spec?: UpsertSpec): ObjList<AssetOnboardingExportJobBatchResult> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): AssetOnboardingExportJobBatchResult | null;
   ...
   */
  static beforeCreate(objs: Array_Type<AssetOnboardingExportJobBatchResult>): ObjList<AssetOnboardingExportJobBatchResult>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<AssetOnboardingExportJobBatchResult>): ObjList<AssetOnboardingExportJobBatchResult>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<AssetOnboardingExportJobBatchResult>): ObjList<AssetOnboardingExportJobBatchResult>;
   ...
   */
  static afterCreate(objs: Array_Type<AssetOnboardingExportJobBatchResult>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<AssetOnboardingExportJobBatchResult>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<AssetOnboardingExportJobBatchResult>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<AssetOnboardingExportJobBatchResult>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<AssetOnboardingExportJobBatchResult>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): AssetOnboardingExportJobBatchResult | null;
   ...
   */
  withoutIdentity(): AssetOnboardingExportJobBatchResult | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<AssetOnboardingExportJobBatchResult>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: AssetOnboardingExportJobBatchResult, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<AssetOnboardingExportJobBatchResult>, callback?: λFunction<AssetOnboardingExportJobBatchResult | null, AssetOnboardingExportJobBatchResult | null>): ObjList<AssetOnboardingExportJobBatchResult>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<AssetOnboardingExportJobBatchResult>, callback?: λFunction<AssetOnboardingExportJobBatchResult | null, AssetOnboardingExportJobBatchResult | null>): Array_Type<ObjError> | null;
