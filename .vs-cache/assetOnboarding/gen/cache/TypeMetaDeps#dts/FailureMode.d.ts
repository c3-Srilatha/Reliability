// TypeScript definitions for the C3 type FailureMode
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of FailureMode
 */
declare interface IFailureMode {
 ...
 * It contains various attributes and methods to track and manage failure modes in the system.
 *
 * @remarks this represents a made instance of FailureMode
 */
declare class FailureMode extends Obj  {

  /**
   * Latest uploaded asset hierarchy file or spreadsheet containing the entity.
   */
  readonly assetOnboardingSourceFile?: AssetOnboardingSourceFile;
  withAssetOnboardingSourceFile(assetOnboardingSourceFile: IAssetOnboardingSourceFile | null): FailureMode;

  /**
   * Indicates when the configuration of this asset was last updated.
   */
  readonly configurationLastUpdated?: DateTime;
  withConfigurationLastUpdated(configurationLastUpdated: DateTime | Date | string | null): FailureMode;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): FailureMode;
  ...
  withName(name: string): FailureMode;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): FailureMode;
  ...
  withVersion(version: number | null): FailureMode;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): FailureMode;

  /**
   * This ID is used to determine which import this entity belongs to.
   */
  readonly trackingIdForImport?: string;
  withTrackingIdForImport(trackingIdForImport: string | null): FailureMode;

  /**
   * Text that describes the failure mode.
   */
  readonly description?: string;
  withDescription(description: string | null): FailureMode;
  ...
  withSingleUse(singleUse: boolean): FailureMode;
  ...
  withAutoLinkAlert(autoLinkAlert: boolean): FailureMode;
  ...
  withUserCreated(userCreated: boolean): FailureMode;

  /**
   * The library to which this failure mode record belongs.
   */
  readonly failureModeLibrary?: FailureModeLibrary;
  withFailureModeLibrary(failureModeLibrary: IFailureModeLibrary | null): FailureMode;

  /**
   * List of failure mode line items detailing this failure mode.
   */
  readonly failureModeLineItems?: Array_Type<FailureModeLineItem>;
  withFailureModeLineItems(failureModeLineItems: Array_Type<FailureModeLineItem> | Array<IFailureModeLineItem> | null): FailureMode;
  ...
  withExpectedSensors(expectedSensors: Array_Type<ExpectedSensor> | Array<IExpectedSensor> | null): FailureMode;

  /**
   * All recommendations linked to this failure mode.
   */
  readonly recommendations?: Array_Type<FailureModeRecommendation>;
  withRecommendations(recommendations: Array_Type<FailureModeRecommendation> | Array<IFailureModeRecommendation> | null): FailureMode;
  ...
  withCountRecommendations(countRecommendations: number | null): FailureMode;
  ...
  withCountLineItems(countLineItems: number | null): FailureMode;
   ...
   * @see #toJson
   */
  static fromJson(json: any): FailureMode | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): FailureMode | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): FailureMode | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): FailureMode | null;
   ...
   */
  replaceType(old: Type, new_: Type): FailureMode;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): FailureMode;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): FailureMode;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<FailureMode>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<FailureMode>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): FailureMode;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): FailureMode;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): FailureMode;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): FailureMode;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): FailureMode;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): FailureMode;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): FailureMode;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): FailureMode;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): FailureMode;
   ...
   * @see #removeField
   */
  withoutField(field: string): FailureMode;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): FailureMode;
   ...
   */
  withoutFields(fields: Array_Type<string>): FailureMode;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): FailureMode;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): FailureMode;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): FailureMode;
   ...
   * @see #unsetField
   */
  defaultField(field: string): FailureMode;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): FailureMode;
   ...
   * @see #removeField
   */
  unsetField(field: string): FailureMode;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): FailureMode;
   ...
   * @see #unsetField
   */
  removeField(field: string): FailureMode;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): FailureMode;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): FailureMode;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): FailureMode;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): FailureMode;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): FailureMode;

  mergeJson(json: any): FailureMode;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): FailureMode;
   ...
   */
  sumObj(other: Obj, deep?: boolean): FailureMode;
   ...
   */
  singletonArray(): Array_Type<FailureMode>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<FailureMode> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<FailureMode> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<FailureMode>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<FailureMode> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, FailureMode> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, FailureMode> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<FailureMode>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<FailureMode>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): FailureMode;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): FailureMode;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): FailureMode;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): FailureMode;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): FailureMode;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): FailureMode;
   ...
   * @see #fromString
   */
  static make(s: string): FailureMode | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): FailureMode;
   ...
   */
  static cachedEmptyInst(): FailureMode;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<FailureMode> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): FailureMode;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<FailureMode>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<FailureMode>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<FailureMode> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<FailureMode>> | null;
   ...
   */
  get(include?: string): FailureMode | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): FailureMode | null;
   ...
   */
  getMissing(spec: GetMissingSpec): FailureMode;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): FailureMode | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): FailureMode;
   ...
   * @see #toString
   */
  static fromString(s: string): FailureMode | null;
   ...
   */
  create(spec?: UpsertSpec): FailureMode | null;
   ...
   */
  static createBatch(objs: Array_Type<FailureMode>, spec?: UpsertSpec): ObjList<FailureMode> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<FailureMode>, spec?: CreateBatchObjStreamSpec): ObjList<FailureMode> | null;
   ...
   */
  update(srcObj?: FailureMode, spec?: UpsertSpec): FailureMode | null;
   ...
   */
  upsert(srcObj?: FailureMode, spec?: UpsertSpec): FailureMode | null;
   ...
   */
  merge(spec?: MergeSpec): FailureMode | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): FailureMode | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): FailureMode | null;
   ...
   */
  static updateBatch(objs: Array_Type<FailureMode>, srcObjs?: Array_Type<FailureMode>, spec?: UpsertSpec): ObjList<FailureMode> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<FailureMode> | null>, spec?: UpsertSpec): ObjList<FailureMode> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<FailureMode>, srcObjs?: Array_Type<FailureMode>, spec?: UpsertSpec): ObjList<FailureMode> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<FailureMode> | null>, spec?: UpsertSpec): ObjList<FailureMode> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<FailureMode>, spec?: TouchSpec): ObjList<FailureMode> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<FailureMode>, spec?: MergeSpec): ObjList<FailureMode> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<FailureMode>, mergeInclude: string, spec?: MergeSpec): ObjList<FailureMode> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<FailureMode> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<FailureMode> | null;
   ...
   */
  static mergeAll(mergeObj: FailureMode, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: FailureMode, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<FailureMode>, spec?: UpsertSpec): ObjList<FailureMode> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<FailureMode>, spec?: UpsertSpec): ObjList<FailureMode> | null;
   ...
   */
  static beforeCreate(objs: Array_Type<FailureMode>): ObjList<FailureMode>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<FailureMode>): ObjList<FailureMode>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<FailureMode>): ObjList<FailureMode>;
   ...
   */
  static afterCreate(objs: Array_Type<FailureMode>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<FailureMode>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<FailureMode>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<FailureMode>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<FailureMode>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): FailureMode | null;
   ...
   */
  withoutIdentity(): FailureMode | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<FailureMode>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: FailureMode, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<FailureMode>, callback?: λFunction<FailureMode | null, FailureMode | null>): ObjList<FailureMode>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<FailureMode>, callback?: λFunction<FailureMode | null, FailureMode | null>): Array_Type<ObjError> | null;
