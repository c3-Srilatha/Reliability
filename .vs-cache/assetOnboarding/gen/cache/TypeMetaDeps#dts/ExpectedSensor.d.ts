// TypeScript definitions for the C3 type ExpectedSensor

/**
 * An abstract, conceptual representation of a sensor which serves some function in the context
 * of an asset. Can be associated with actual sensors providing measurements.
 *
 * @remarks this represents a value passed to a method that expects an instance of ExpectedSensor
 */
declare interface IExpectedSensor {
  ...
  /**
   * Failure mode line items where this expected sensor is used.
   */
  failureModeLineItems?: Array_Type<FailureModeLineItem> | Array<IFailureModeLineItem>;

  /**
   * Failure mode libraries this expected sensor belongs to.
   */
  failureModeLibraries?: Array_Type<FailureModeLibrary> | Array<IFailureModeLibrary>;

  /**
   * Expected {@link Unit} of the sensor measurement.
   */
  unit?: IUnit;

  /**
   * The type of unit represented by this {@link ExpectedSensor}. For example "Temperature", "Pressure", etc.
   */
  unitType?: string;

  /**
   * Whether this is a minimum required sensor for asset class purposes.
   */
  isMinRequired?: boolean;

  /**
   * This field answers the question, "If the actual value
   * of the sensor is more than the expected value, then
   * how much of a weight does it have on determining the
   * seriousness of the anomaly?"
   */
  sensorPositiveAnomalyWeight?: number;

  /**
   * This field answers the question, "If the actual value
   * of the sensor is less than the expected value, then
   * how much of a weight does it have on determining the
   * seriousness of the anomaly?"
   */
  sensorNegativeAnomalyWeight?: number;

  /**
   * A sensor can (broadly) be a CONTROL, INDEPENDENT,
   * or DEPENDENT sensor.
   * A CONTROL sensor is a process parameter that is set to a
   * pre-determined value by an operator. Eg. a setpoint sensor.
   * An INDEPENDENT sensor is a parameter whose values change
   * independent of the process. Eg. ambient temperature.
   * A DEPENDENT sensor is a parameter whose values change because
   * of the CONTROL and INDEPENDENT sensors. Eg. yield of a reactor.
   * If there are other types of sensors in your project, `remix` this
   * Type and add to the `string enum`s in this field.
   */
  sensorType?: string;

  /**
   * Display name which attempts to use {@link ExpectedSensor#name name} field; otherwise, uses the {@link ExpectedSensor#id id} field.
   */
  displayName?: string;

  /**
   * The values of a sensor may fall into different buckets:
   * 1. CATEGORICAL - sensor outputs are from a specific set
   * 2. CONTINUOUS - sensor outputs can be any numeric value in a finite/infinite range
   * If there are other types of sensor data in your project, `remix` this
   * Type and add to the `string enum`s in this field.
   */
  sensorDataType?: string;

  /**
   * All related {@link ReliabilityAssetSensorRelation}. See {@link ExpectedSensor} top level doc.
   */
  assetSensorRelations?: Array_Type<ReliabilityAssetSensorRelation> | Array<IReliabilityAssetSensorRelation>;

  /**
   * String that represents the first (alphabetical order) 3 {@link FailureModeLibrary} associated with this
   * {@link ExpectedSensor}. "..." is appended if more than 3 {@link FailureModeLibrary} are associated.
   */
  failureModeLibrariesDisplayStr?: string;
}
 ...
 * of an asset. Can be associated with actual sensors providing measurements.
 *
 * @remarks this represents a made instance of ExpectedSensor
 */
declare class ExpectedSensor extends Obj  {

  /**
   * Latest uploaded asset hierarchy file or spreadsheet containing the entity.
   */
  readonly assetOnboardingSourceFile?: AssetOnboardingSourceFile;
  withAssetOnboardingSourceFile(assetOnboardingSourceFile: IAssetOnboardingSourceFile | null): ExpectedSensor;

  /**
   * Indicates when the configuration of this asset was last updated.
   */
  readonly configurationLastUpdated?: DateTime;
  withConfigurationLastUpdated(configurationLastUpdated: DateTime | Date | string | null): ExpectedSensor;
   ...
   */
  readonly id: string;
  withId(id: string): ExpectedSensor;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ExpectedSensor;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): ExpectedSensor;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): ExpectedSensor;
  ...
  withVersion(version: number | null): ExpectedSensor;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): ExpectedSensor;

  /**
   * This ID is used to determine which import this entity belongs to.
   */
  readonly trackingIdForImport?: string;
  withTrackingIdForImport(trackingIdForImport: string | null): ExpectedSensor;

  /**
   * Failure mode line items where this expected sensor is used.
   */
  readonly failureModeLineItems?: Array_Type<FailureModeLineItem>;
  withFailureModeLineItems(failureModeLineItems: Array_Type<FailureModeLineItem> | Array<IFailureModeLineItem> | null): ExpectedSensor;

  /**
   * Failure mode libraries this expected sensor belongs to.
   */
  readonly failureModeLibraries?: Array_Type<FailureModeLibrary>;
  withFailureModeLibraries(failureModeLibraries: Array_Type<FailureModeLibrary> | Array<IFailureModeLibrary> | null): ExpectedSensor;

  /**
   * Expected {@link Unit} of the sensor measurement.
   */
  readonly unit?: Unit;
  withUnit(unit: IUnit | null): ExpectedSensor;

  /**
   * The type of unit represented by this {@link ExpectedSensor}. For example "Temperature", "Pressure", etc.
   */
  readonly unitType?: string;
  withUnitType(unitType: string | null): ExpectedSensor;

  /**
   * Whether this is a minimum required sensor for asset class purposes.
   */
  readonly isMinRequired?: boolean;
  withIsMinRequired(isMinRequired: boolean): ExpectedSensor;
   ...
   * seriousness of the anomaly?"
   */
  readonly sensorPositiveAnomalyWeight?: number;
  withSensorPositiveAnomalyWeight(sensorPositiveAnomalyWeight: number | null): ExpectedSensor;
   ...
   * seriousness of the anomaly?"
   */
  readonly sensorNegativeAnomalyWeight?: number;
  withSensorNegativeAnomalyWeight(sensorNegativeAnomalyWeight: number | null): ExpectedSensor;
  ...
  withSensorType(sensorType: string | null): ExpectedSensor;

  /**
   * Display name which attempts to use {@link ExpectedSensor#name name} field; otherwise, uses the {@link ExpectedSensor#id id} field.
   */
  readonly displayName?: string;
  withDisplayName(displayName: string | null): ExpectedSensor;
   ...
   * Type and add to the `string enum`s in this field.
   */
  readonly sensorDataType?: string;
  withSensorDataType(sensorDataType: string | null): ExpectedSensor;

  /**
   * All related {@link ReliabilityAssetSensorRelation}. See {@link ExpectedSensor} top level doc.
   */
  readonly assetSensorRelations?: Array_Type<ReliabilityAssetSensorRelation>;
  withAssetSensorRelations(assetSensorRelations: Array_Type<ReliabilityAssetSensorRelation> | Array<IReliabilityAssetSensorRelation> | null): ExpectedSensor;

  /**
   * String that represents the first (alphabetical order) 3 {@link FailureModeLibrary} associated with this
   * {@link ExpectedSensor}. "..." is appended if more than 3 {@link FailureModeLibrary} are associated.
   */
  readonly failureModeLibrariesDisplayStr?: string;
  withFailureModeLibrariesDisplayStr(failureModeLibrariesDisplayStr: string | null): ExpectedSensor;
   ...
   * @see #toJson
   */
  static fromJson(json: any): ExpectedSensor | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): ExpectedSensor | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): ExpectedSensor | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): ExpectedSensor | null;
   ...
   */
  replaceType(old: Type, new_: Type): ExpectedSensor;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ExpectedSensor;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ExpectedSensor;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ExpectedSensor>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ExpectedSensor>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ExpectedSensor;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ExpectedSensor;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ExpectedSensor;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ExpectedSensor;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ExpectedSensor;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ExpectedSensor;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ExpectedSensor;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ExpectedSensor;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ExpectedSensor;
   ...
   * @see #removeField
   */
  withoutField(field: string): ExpectedSensor;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): ExpectedSensor;
   ...
   */
  withoutFields(fields: Array_Type<string>): ExpectedSensor;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): ExpectedSensor;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ExpectedSensor;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ExpectedSensor;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ExpectedSensor;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ExpectedSensor;
   ...
   * @see #removeField
   */
  unsetField(field: string): ExpectedSensor;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ExpectedSensor;
   ...
   * @see #unsetField
   */
  removeField(field: string): ExpectedSensor;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ExpectedSensor;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ExpectedSensor;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): ExpectedSensor;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ExpectedSensor;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ExpectedSensor;

  mergeJson(json: any): ExpectedSensor;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ExpectedSensor;
   ...
   */
  sumObj(other: Obj, deep?: boolean): ExpectedSensor;
   ...
   */
  singletonArray(): Array_Type<ExpectedSensor>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<ExpectedSensor> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ExpectedSensor> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<ExpectedSensor>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ExpectedSensor> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, ExpectedSensor> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ExpectedSensor> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ExpectedSensor>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ExpectedSensor>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ExpectedSensor;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ExpectedSensor;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ExpectedSensor;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ExpectedSensor;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ExpectedSensor;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ExpectedSensor;
   ...
   * @see #fromString
   */
  static make(s: string): ExpectedSensor | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ExpectedSensor;
   ...
   */
  static cachedEmptyInst(): ExpectedSensor;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<ExpectedSensor> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): ExpectedSensor;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<ExpectedSensor>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<ExpectedSensor>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<ExpectedSensor> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ExpectedSensor>> | null;
   ...
   */
  get(include?: string): ExpectedSensor | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): ExpectedSensor | null;
   ...
   */
  getMissing(spec: GetMissingSpec): ExpectedSensor;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): ExpectedSensor | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): ExpectedSensor;
   ...
   * @see #toString
   */
  static fromString(s: string): ExpectedSensor | null;
   ...
   */
  create(spec?: UpsertSpec): ExpectedSensor | null;
   ...
   */
  static createBatch(objs: Array_Type<ExpectedSensor>, spec?: UpsertSpec): ObjList<ExpectedSensor> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<ExpectedSensor>, spec?: CreateBatchObjStreamSpec): ObjList<ExpectedSensor> | null;
   ...
   */
  update(srcObj?: ExpectedSensor, spec?: UpsertSpec): ExpectedSensor | null;
   ...
   */
  upsert(srcObj?: ExpectedSensor, spec?: UpsertSpec): ExpectedSensor | null;
   ...
   */
  merge(spec?: MergeSpec): ExpectedSensor | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): ExpectedSensor | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): ExpectedSensor | null;
   ...
   */
  static updateBatch(objs: Array_Type<ExpectedSensor>, srcObjs?: Array_Type<ExpectedSensor>, spec?: UpsertSpec): ObjList<ExpectedSensor> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<ExpectedSensor> | null>, spec?: UpsertSpec): ObjList<ExpectedSensor> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<ExpectedSensor>, srcObjs?: Array_Type<ExpectedSensor>, spec?: UpsertSpec): ObjList<ExpectedSensor> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<ExpectedSensor> | null>, spec?: UpsertSpec): ObjList<ExpectedSensor> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<ExpectedSensor>, spec?: TouchSpec): ObjList<ExpectedSensor> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ExpectedSensor>, spec?: MergeSpec): ObjList<ExpectedSensor> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ExpectedSensor>, mergeInclude: string, spec?: MergeSpec): ObjList<ExpectedSensor> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<ExpectedSensor> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ExpectedSensor> | null;
   ...
   */
  static mergeAll(mergeObj: ExpectedSensor, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: ExpectedSensor, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<ExpectedSensor>, spec?: UpsertSpec): ObjList<ExpectedSensor> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<ExpectedSensor>, spec?: UpsertSpec): ObjList<ExpectedSensor> | null;
   ...
   */
  static beforeCreate(objs: Array_Type<ExpectedSensor>): ObjList<ExpectedSensor>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<ExpectedSensor>): ObjList<ExpectedSensor>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<ExpectedSensor>): ObjList<ExpectedSensor>;
   ...
   */
  static afterCreate(objs: Array_Type<ExpectedSensor>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<ExpectedSensor>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<ExpectedSensor>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<ExpectedSensor>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ExpectedSensor>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): ExpectedSensor | null;
   ...
   */
  withoutIdentity(): ExpectedSensor | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<ExpectedSensor>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: ExpectedSensor, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<ExpectedSensor>, callback?: λFunction<ExpectedSensor | null, ExpectedSensor | null>): ObjList<ExpectedSensor>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<ExpectedSensor>, callback?: λFunction<ExpectedSensor | null, ExpectedSensor | null>): Array_Type<ObjError> | null;
