// TypeScript definitions for the C3 type FailureModeDiagnostic

/**
 * Represents the failure mode diagnostic for assessing failure modes.
 *
 * @remarks this represents a value passed to a method that expects an instance of FailureModeDiagnostic
 */
declare interface IFailureModeDiagnostic {
   ...
   */
  lambda?: λTriPredicate<Array_Type<number>, number, string>;
}
 ...
 */
declare class FailureModeDiagnostic extends Obj  {
   ...
   */
  readonly id: string;
  withId(id: string): FailureModeDiagnostic;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): FailureModeDiagnostic;

  /**
   * The name of the diagnostic.
   */
  readonly name?: string;
  withName(name: string | null): FailureModeDiagnostic;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): FailureModeDiagnostic;
  ...
  withVersion(version: number | null): FailureModeDiagnostic;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): FailureModeDiagnostic;

  /**
   * This ID is used to determine which import this entity belongs to.
   */
  readonly trackingIdForImport?: string;
  withTrackingIdForImport(trackingIdForImport: string | null): FailureModeDiagnostic;

  /**
   * The display name of the diagnostic translated based on id.
   */
  readonly displayName?: string;
  withDisplayName(displayName: string | null): FailureModeDiagnostic;

  /**
   * Description to display translated based on id.
   */
  readonly displayDescription?: string;
  withDisplayDescription(displayDescription: string | null): FailureModeDiagnostic;

  /**
   * The font awesome icon that represents a diagnostic.
   */
  readonly faIconConfig?: FaIconConfig;
  withFaIconConfig(faIconConfig: IFaIconConfig | null): FailureModeDiagnostic;
   ...
   * return `true` if diagnostic is triggered, otherwise `false`.
   */
  readonly lambda?: λTriPredicate<Array_Type<number>, number, string>;
  withLambda(lambda: λTriPredicate<Array_Type<number>, number, string> | null): FailureModeDiagnostic;
   ...
   * @see #toJson
   */
  static fromJson(json: any): FailureModeDiagnostic | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): FailureModeDiagnostic | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): FailureModeDiagnostic | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): FailureModeDiagnostic | null;
   ...
   */
  replaceType(old: Type, new_: Type): FailureModeDiagnostic;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): FailureModeDiagnostic;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): FailureModeDiagnostic;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<FailureModeDiagnostic>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<FailureModeDiagnostic>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): FailureModeDiagnostic;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): FailureModeDiagnostic;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): FailureModeDiagnostic;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): FailureModeDiagnostic;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): FailureModeDiagnostic;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): FailureModeDiagnostic;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): FailureModeDiagnostic;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): FailureModeDiagnostic;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): FailureModeDiagnostic;
   ...
   * @see #removeField
   */
  withoutField(field: string): FailureModeDiagnostic;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): FailureModeDiagnostic;
   ...
   */
  withoutFields(fields: Array_Type<string>): FailureModeDiagnostic;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): FailureModeDiagnostic;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): FailureModeDiagnostic;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): FailureModeDiagnostic;
   ...
   * @see #unsetField
   */
  defaultField(field: string): FailureModeDiagnostic;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): FailureModeDiagnostic;
   ...
   * @see #removeField
   */
  unsetField(field: string): FailureModeDiagnostic;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): FailureModeDiagnostic;
   ...
   * @see #unsetField
   */
  removeField(field: string): FailureModeDiagnostic;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): FailureModeDiagnostic;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): FailureModeDiagnostic;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): FailureModeDiagnostic;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): FailureModeDiagnostic;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): FailureModeDiagnostic;

  mergeJson(json: any): FailureModeDiagnostic;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): FailureModeDiagnostic;
   ...
   */
  sumObj(other: Obj, deep?: boolean): FailureModeDiagnostic;
   ...
   */
  singletonArray(): Array_Type<FailureModeDiagnostic>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<FailureModeDiagnostic> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<FailureModeDiagnostic> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<FailureModeDiagnostic>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<FailureModeDiagnostic> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, FailureModeDiagnostic> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, FailureModeDiagnostic> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<FailureModeDiagnostic>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<FailureModeDiagnostic>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): FailureModeDiagnostic;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): FailureModeDiagnostic;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): FailureModeDiagnostic;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): FailureModeDiagnostic;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): FailureModeDiagnostic;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): FailureModeDiagnostic;
   ...
   * @see #fromString
   */
  static make(s: string): FailureModeDiagnostic | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): FailureModeDiagnostic;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): FailureModeDiagnostic;
   ...
   */
  static cachedEmptyInst(): FailureModeDiagnostic;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<FailureModeDiagnostic> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): FailureModeDiagnostic;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<FailureModeDiagnostic>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<FailureModeDiagnostic>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<FailureModeDiagnostic> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<FailureModeDiagnostic>> | null;
   ...
   */
  get(include?: string): FailureModeDiagnostic | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): FailureModeDiagnostic | null;
   ...
   */
  getMissing(spec: GetMissingSpec): FailureModeDiagnostic;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): FailureModeDiagnostic | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): FailureModeDiagnostic;
   ...
   * @see #toString
   */
  static fromString(s: string): FailureModeDiagnostic | null;
   ...
   */
  create(spec?: UpsertSpec): FailureModeDiagnostic | null;
   ...
   */
  static createBatch(objs: Array_Type<FailureModeDiagnostic>, spec?: UpsertSpec): ObjList<FailureModeDiagnostic> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<FailureModeDiagnostic>, spec?: CreateBatchObjStreamSpec): ObjList<FailureModeDiagnostic> | null;
   ...
   */
  update(srcObj?: FailureModeDiagnostic, spec?: UpsertSpec): FailureModeDiagnostic | null;
   ...
   */
  upsert(srcObj?: FailureModeDiagnostic, spec?: UpsertSpec): FailureModeDiagnostic | null;
   ...
   */
  merge(spec?: MergeSpec): FailureModeDiagnostic | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): FailureModeDiagnostic | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): FailureModeDiagnostic | null;
   ...
   */
  static updateBatch(objs: Array_Type<FailureModeDiagnostic>, srcObjs?: Array_Type<FailureModeDiagnostic>, spec?: UpsertSpec): ObjList<FailureModeDiagnostic> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<FailureModeDiagnostic> | null>, spec?: UpsertSpec): ObjList<FailureModeDiagnostic> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<FailureModeDiagnostic>, srcObjs?: Array_Type<FailureModeDiagnostic>, spec?: UpsertSpec): ObjList<FailureModeDiagnostic> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<FailureModeDiagnostic> | null>, spec?: UpsertSpec): ObjList<FailureModeDiagnostic> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<FailureModeDiagnostic>, spec?: TouchSpec): ObjList<FailureModeDiagnostic> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<FailureModeDiagnostic>, spec?: MergeSpec): ObjList<FailureModeDiagnostic> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<FailureModeDiagnostic>, mergeInclude: string, spec?: MergeSpec): ObjList<FailureModeDiagnostic> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<FailureModeDiagnostic> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<FailureModeDiagnostic> | null;
   ...
   */
  static mergeAll(mergeObj: FailureModeDiagnostic, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: FailureModeDiagnostic, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<FailureModeDiagnostic>, spec?: UpsertSpec): ObjList<FailureModeDiagnostic> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<FailureModeDiagnostic>, spec?: UpsertSpec): ObjList<FailureModeDiagnostic> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): FailureModeDiagnostic | null;
   ...
   */
  static beforeCreate(objs: Array_Type<FailureModeDiagnostic>): ObjList<FailureModeDiagnostic>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<FailureModeDiagnostic>): ObjList<FailureModeDiagnostic>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<FailureModeDiagnostic>): ObjList<FailureModeDiagnostic>;
   ...
   */
  static afterCreate(objs: Array_Type<FailureModeDiagnostic>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<FailureModeDiagnostic>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<FailureModeDiagnostic>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<FailureModeDiagnostic>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<FailureModeDiagnostic>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): FailureModeDiagnostic | null;
   ...
   */
  withoutIdentity(): FailureModeDiagnostic | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<FailureModeDiagnostic>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: FailureModeDiagnostic, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<FailureModeDiagnostic>, callback?: λFunction<FailureModeDiagnostic | null, FailureModeDiagnostic | null>): ObjList<FailureModeDiagnostic>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<FailureModeDiagnostic>, callback?: λFunction<FailureModeDiagnostic | null, FailureModeDiagnostic | null>): Array_Type<ObjError> | null;
   ...
   */
  static linearRegression(data: Array_Type<number>): Pair<number, number> | null;
}
