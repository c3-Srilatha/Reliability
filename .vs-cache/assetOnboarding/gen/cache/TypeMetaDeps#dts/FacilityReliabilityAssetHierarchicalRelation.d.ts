// TypeScript definitions for the C3 type FacilityReliabilityAssetHierarchicalRelation

/**
 * Represents the relationship between a {@link Facility} and a child {@link ReliabilityAsset}.
 *
 * @remarks this represents a value passed to a method that expects an instance of FacilityReliabilityAssetHierarchicalRelation
 */
declare interface IFacilityReliabilityAssetHierarchicalRelation {
  ...
  /**
   * The parent {@link Facility} in the relation.
   */
  from: IFacility;

  /**
   * The child {@link ReliabilityAsset} in the relation.
   */
  to: IReliabilityAsset;

  /**
   * Relationship between the parent asset and child asset. For example, position of the asset with respect to the parent asset:
   * An aircraft(PhysicalAsset) can have 2 wings, Left Wing(position='left') and Right Wing(position='right'),
   * which are both also PhysicalAssets that a level below in the tree structure representing the
   * PhysicalAsset Hierarchical System
   */
  relationship?: string;
  ...
  /**
   * Placeholder field. Not used in regular computation
   */
  involvement?: number;
 ...
 * Represents the relationship between a {@link Facility} and a child {@link ReliabilityAsset}.
 *
 * @remarks this represents a made instance of FacilityReliabilityAssetHierarchicalRelation
 */
declare class FacilityReliabilityAssetHierarchicalRelation extends Obj  {
   ...
   */
  readonly id: string;
  withId(id: string): FacilityReliabilityAssetHierarchicalRelation;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): FacilityReliabilityAssetHierarchicalRelation;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): FacilityReliabilityAssetHierarchicalRelation;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): FacilityReliabilityAssetHierarchicalRelation;
  ...
  withVersion(version: number | null): FacilityReliabilityAssetHierarchicalRelation;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): FacilityReliabilityAssetHierarchicalRelation;

  /**
   * @inheritdoc
   */
  readonly facilityFilterPaths?: Array_Type<string>;
  withFacilityFilterPaths(facilityFilterPaths: Array_Type<string> | Array<string> | null): FacilityReliabilityAssetHierarchicalRelation;

  /**
   * This ID is used to determine which import this entity belongs to.
   */
  readonly trackingIdForImport?: string;
  withTrackingIdForImport(trackingIdForImport: string | null): FacilityReliabilityAssetHierarchicalRelation;

  /**
   * The parent {@link Facility} in the relation.
   */
  readonly from: Facility;
  withFrom(from: IFacility): FacilityReliabilityAssetHierarchicalRelation;

  /**
   * The child {@link ReliabilityAsset} in the relation.
   */
  readonly to: ReliabilityAsset;
  withTo(to: IReliabilityAsset): FacilityReliabilityAssetHierarchicalRelation;
  ...
  withRelationship(relationship: string | null): FacilityReliabilityAssetHierarchicalRelation;

  /**
   * Additional info for the 'from' vertex can be stored here
   */
  readonly fromInfo?: string;
  withFromInfo(fromInfo: string | null): FacilityReliabilityAssetHierarchicalRelation;

  /**
   * Additional info for the 'to' vertex can be stored here
   */
  readonly toInfo?: string;
  withToInfo(toInfo: string | null): FacilityReliabilityAssetHierarchicalRelation;

  /**
   * Placeholder field. Not used in regular computation
   */
  readonly involvement?: number;
  withInvolvement(involvement: number | null): FacilityReliabilityAssetHierarchicalRelation;

  /**
   * Start timestamp for the value.  If null, assumed to be beginning-of-time (BOT).
   */
  readonly start?: DateTime;
  withStart(start: DateTime | Date | string | null): FacilityReliabilityAssetHierarchicalRelation;

  /**
   * End timestamp for the value.  If null, assumed to be end-of-time (EOT).
   */
  readonly end?: DateTime;
  withEnd(end: DateTime | Date | string | null): FacilityReliabilityAssetHierarchicalRelation;
  ...
  withTypeIdent(typeIdent: string | null): FacilityReliabilityAssetHierarchicalRelation;
   ...
   * @see #toJson
   */
  static fromJson(json: any): FacilityReliabilityAssetHierarchicalRelation | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): FacilityReliabilityAssetHierarchicalRelation | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): FacilityReliabilityAssetHierarchicalRelation | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): FacilityReliabilityAssetHierarchicalRelation | null;
   ...
   */
  replaceType(old: Type, new_: Type): FacilityReliabilityAssetHierarchicalRelation;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): FacilityReliabilityAssetHierarchicalRelation;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): FacilityReliabilityAssetHierarchicalRelation;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<FacilityReliabilityAssetHierarchicalRelation>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<FacilityReliabilityAssetHierarchicalRelation>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): FacilityReliabilityAssetHierarchicalRelation;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): FacilityReliabilityAssetHierarchicalRelation;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): FacilityReliabilityAssetHierarchicalRelation;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): FacilityReliabilityAssetHierarchicalRelation;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): FacilityReliabilityAssetHierarchicalRelation;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): FacilityReliabilityAssetHierarchicalRelation;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): FacilityReliabilityAssetHierarchicalRelation;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): FacilityReliabilityAssetHierarchicalRelation;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): FacilityReliabilityAssetHierarchicalRelation;
   ...
   * @see #removeField
   */
  withoutField(field: string): FacilityReliabilityAssetHierarchicalRelation;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): FacilityReliabilityAssetHierarchicalRelation;
   ...
   */
  withoutFields(fields: Array_Type<string>): FacilityReliabilityAssetHierarchicalRelation;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): FacilityReliabilityAssetHierarchicalRelation;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): FacilityReliabilityAssetHierarchicalRelation;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): FacilityReliabilityAssetHierarchicalRelation;
   ...
   * @see #unsetField
   */
  defaultField(field: string): FacilityReliabilityAssetHierarchicalRelation;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): FacilityReliabilityAssetHierarchicalRelation;
   ...
   * @see #removeField
   */
  unsetField(field: string): FacilityReliabilityAssetHierarchicalRelation;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): FacilityReliabilityAssetHierarchicalRelation;
   ...
   * @see #unsetField
   */
  removeField(field: string): FacilityReliabilityAssetHierarchicalRelation;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): FacilityReliabilityAssetHierarchicalRelation;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): FacilityReliabilityAssetHierarchicalRelation;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): FacilityReliabilityAssetHierarchicalRelation;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): FacilityReliabilityAssetHierarchicalRelation;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): FacilityReliabilityAssetHierarchicalRelation;

  mergeJson(json: any): FacilityReliabilityAssetHierarchicalRelation;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): FacilityReliabilityAssetHierarchicalRelation;
   ...
   */
  sumObj(other: Obj, deep?: boolean): FacilityReliabilityAssetHierarchicalRelation;
   ...
   */
  singletonArray(): Array_Type<FacilityReliabilityAssetHierarchicalRelation>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<FacilityReliabilityAssetHierarchicalRelation> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<FacilityReliabilityAssetHierarchicalRelation> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<FacilityReliabilityAssetHierarchicalRelation>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<FacilityReliabilityAssetHierarchicalRelation> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, FacilityReliabilityAssetHierarchicalRelation> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, FacilityReliabilityAssetHierarchicalRelation> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<FacilityReliabilityAssetHierarchicalRelation>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<FacilityReliabilityAssetHierarchicalRelation>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): FacilityReliabilityAssetHierarchicalRelation;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): FacilityReliabilityAssetHierarchicalRelation;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): FacilityReliabilityAssetHierarchicalRelation;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): FacilityReliabilityAssetHierarchicalRelation;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): FacilityReliabilityAssetHierarchicalRelation;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): FacilityReliabilityAssetHierarchicalRelation;
   ...
   * @see #fromString
   */
  static make(s: string): FacilityReliabilityAssetHierarchicalRelation | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): FacilityReliabilityAssetHierarchicalRelation;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): FacilityReliabilityAssetHierarchicalRelation;
   ...
   */
  static cachedEmptyInst(): FacilityReliabilityAssetHierarchicalRelation;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<FacilityReliabilityAssetHierarchicalRelation> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): FacilityReliabilityAssetHierarchicalRelation;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<FacilityReliabilityAssetHierarchicalRelation>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<FacilityReliabilityAssetHierarchicalRelation>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<FacilityReliabilityAssetHierarchicalRelation> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<FacilityReliabilityAssetHierarchicalRelation>> | null;
   ...
   */
  get(include?: string): FacilityReliabilityAssetHierarchicalRelation | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): FacilityReliabilityAssetHierarchicalRelation | null;
   ...
   */
  getMissing(spec: GetMissingSpec): FacilityReliabilityAssetHierarchicalRelation;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): FacilityReliabilityAssetHierarchicalRelation | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): FacilityReliabilityAssetHierarchicalRelation;
   ...
   * @see #toString
   */
  static fromString(s: string): FacilityReliabilityAssetHierarchicalRelation | null;
   ...
   */
  create(spec?: UpsertSpec): FacilityReliabilityAssetHierarchicalRelation | null;
   ...
   */
  static createBatch(objs: Array_Type<FacilityReliabilityAssetHierarchicalRelation>, spec?: UpsertSpec): ObjList<FacilityReliabilityAssetHierarchicalRelation> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<FacilityReliabilityAssetHierarchicalRelation>, spec?: CreateBatchObjStreamSpec): ObjList<FacilityReliabilityAssetHierarchicalRelation> | null;
   ...
   */
  update(srcObj?: FacilityReliabilityAssetHierarchicalRelation, spec?: UpsertSpec): FacilityReliabilityAssetHierarchicalRelation | null;
   ...
   */
  upsert(srcObj?: FacilityReliabilityAssetHierarchicalRelation, spec?: UpsertSpec): FacilityReliabilityAssetHierarchicalRelation | null;
   ...
   */
  merge(spec?: MergeSpec): FacilityReliabilityAssetHierarchicalRelation | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): FacilityReliabilityAssetHierarchicalRelation | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): FacilityReliabilityAssetHierarchicalRelation | null;
   ...
   */
  static updateBatch(objs: Array_Type<FacilityReliabilityAssetHierarchicalRelation>, srcObjs?: Array_Type<FacilityReliabilityAssetHierarchicalRelation>, spec?: UpsertSpec): ObjList<FacilityReliabilityAssetHierarchicalRelation> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<FacilityReliabilityAssetHierarchicalRelation> | null>, spec?: UpsertSpec): ObjList<FacilityReliabilityAssetHierarchicalRelation> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<FacilityReliabilityAssetHierarchicalRelation>, srcObjs?: Array_Type<FacilityReliabilityAssetHierarchicalRelation>, spec?: UpsertSpec): ObjList<FacilityReliabilityAssetHierarchicalRelation> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<FacilityReliabilityAssetHierarchicalRelation> | null>, spec?: UpsertSpec): ObjList<FacilityReliabilityAssetHierarchicalRelation> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<FacilityReliabilityAssetHierarchicalRelation>, spec?: TouchSpec): ObjList<FacilityReliabilityAssetHierarchicalRelation> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<FacilityReliabilityAssetHierarchicalRelation>, spec?: MergeSpec): ObjList<FacilityReliabilityAssetHierarchicalRelation> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<FacilityReliabilityAssetHierarchicalRelation>, mergeInclude: string, spec?: MergeSpec): ObjList<FacilityReliabilityAssetHierarchicalRelation> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<FacilityReliabilityAssetHierarchicalRelation> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<FacilityReliabilityAssetHierarchicalRelation> | null;
   ...
   */
  static mergeAll(mergeObj: FacilityReliabilityAssetHierarchicalRelation, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: FacilityReliabilityAssetHierarchicalRelation, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<FacilityReliabilityAssetHierarchicalRelation>, spec?: UpsertSpec): ObjList<FacilityReliabilityAssetHierarchicalRelation> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<FacilityReliabilityAssetHierarchicalRelation>, spec?: UpsertSpec): ObjList<FacilityReliabilityAssetHierarchicalRelation> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): FacilityReliabilityAssetHierarchicalRelation | null;
   ...
   */
  static beforeCreate(objs: Array_Type<FacilityReliabilityAssetHierarchicalRelation>): ObjList<FacilityReliabilityAssetHierarchicalRelation>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<FacilityReliabilityAssetHierarchicalRelation>): ObjList<FacilityReliabilityAssetHierarchicalRelation>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<FacilityReliabilityAssetHierarchicalRelation>): ObjList<FacilityReliabilityAssetHierarchicalRelation>;
   ...
   */
  static afterCreate(objs: Array_Type<FacilityReliabilityAssetHierarchicalRelation>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<FacilityReliabilityAssetHierarchicalRelation>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<FacilityReliabilityAssetHierarchicalRelation>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<FacilityReliabilityAssetHierarchicalRelation>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<FacilityReliabilityAssetHierarchicalRelation>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): FacilityReliabilityAssetHierarchicalRelation | null;
   ...
   */
  withoutIdentity(): FacilityReliabilityAssetHierarchicalRelation | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<FacilityReliabilityAssetHierarchicalRelation>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: FacilityReliabilityAssetHierarchicalRelation, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<FacilityReliabilityAssetHierarchicalRelation>, callback?: λFunction<FacilityReliabilityAssetHierarchicalRelation | null, FacilityReliabilityAssetHierarchicalRelation | null>): ObjList<FacilityReliabilityAssetHierarchicalRelation>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<FacilityReliabilityAssetHierarchicalRelation>, callback?: λFunction<FacilityReliabilityAssetHierarchicalRelation | null, FacilityReliabilityAssetHierarchicalRelation | null>): Array_Type<ObjError> | null;
