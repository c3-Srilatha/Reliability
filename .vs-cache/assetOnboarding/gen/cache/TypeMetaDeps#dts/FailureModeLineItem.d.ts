// TypeScript definitions for the C3 type FailureModeLineItem
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of FailureModeLineItem
 */
declare interface IFailureModeLineItem {
   ...
   */
  diagnostic?: IFailureModeDiagnostic;
   ...
   */
  failureRecommendation?: Array_Type<FailureModeRecommendation> | Array<IFailureModeRecommendation>;
  ...
  /**
   * String that denotes how many recommended actions are associated with this entity.
   */
  recommendedActionsCountString?: string;

  /**
   * Foreign key to the {@link ReliabilityAssetAlert} associated with this {@link FailureModeLineItem}.
   */
  alertRelations?: Array_Type<ReliabilityAssetAlertFailureModeRelation> | Array<IReliabilityAssetAlertFailureModeRelation>;

  /**
   * The latest time that {@link FailureModeLineItem} and/or its {@link ExpectedSensor} gets updated, specifically for FailureModeLibraryGrid UI.
   */
  updatedTimestamp?: DateTime | Date | string;
}
 ...
 * to the parent failure mode and can be used as a feature in training models for the failure mode.
 *
 * @remarks this represents a made instance of FailureModeLineItem
 */
declare class FailureModeLineItem extends Obj  {

  /**
   * Latest uploaded asset hierarchy file or spreadsheet containing the entity.
   */
  readonly assetOnboardingSourceFile?: AssetOnboardingSourceFile;
  withAssetOnboardingSourceFile(assetOnboardingSourceFile: IAssetOnboardingSourceFile | null): FailureModeLineItem;

  /**
   * Indicates when the configuration of this asset was last updated.
   */
  readonly configurationLastUpdated?: DateTime;
  withConfigurationLastUpdated(configurationLastUpdated: DateTime | Date | string | null): FailureModeLineItem;
   ...
   */
  readonly id: string;
  withId(id: string): FailureModeLineItem;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): FailureModeLineItem;

  /**
   * Name of the failure mechanism
   */
  readonly name?: string;
  withName(name: string | null): FailureModeLineItem;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): FailureModeLineItem;
  ...
  withVersion(version: number | null): FailureModeLineItem;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): FailureModeLineItem;

  /**
   * This ID is used to determine which import this entity belongs to.
   */
  readonly trackingIdForImport?: string;
  withTrackingIdForImport(trackingIdForImport: string | null): FailureModeLineItem;

  /**
   * Description of the failure mode.
   */
  readonly description?: string;
  withDescription(description: string | null): FailureModeLineItem;

  /**
   * The failure mode that contains this record
   */
  readonly failureMode?: FailureMode;
  withFailureMode(failureMode: IFailureMode | null): FailureModeLineItem;

  /**
   * Sensor to which the failure mode applies
   */
  readonly expectedSensor?: ExpectedSensor;
  withExpectedSensor(expectedSensor: IExpectedSensor | null): FailureModeLineItem;

  /**
   * The diagnostic to apply on the sensor data
   */
  readonly diagnostic?: FailureModeDiagnostic;
  withDiagnostic(diagnostic: IFailureModeDiagnostic | null): FailureModeLineItem;

  /**
   * The failure mode will be recommended if the {@link diagnostic} exceeds this threshold
   */
  readonly sensorThreshold?: number;
  withSensorThreshold(sensorThreshold: number | null): FailureModeLineItem;

  /**
   * Exceptions to the failure mechanism
   */
  readonly exceptions?: string;
  withExceptions(exceptions: string | null): FailureModeLineItem;

  /**
   * Category of this record
   */
  readonly faultCategory?: string;
  withFaultCategory(faultCategory: string | null): FailureModeLineItem;

  /**
   * Priority
   */
  readonly priority?: FailureModePriority;
  withPriority(priority: IFailureModePriority | null): FailureModeLineItem;

  /**
   * The failure mode library that contains this record
   */
  readonly failureModeLibrary?: FailureModeLibrary;
  withFailureModeLibrary(failureModeLibrary: IFailureModeLibrary | null): FailureModeLineItem;

  /**
   * Recommended actions if this failure mode is recommended
   */
  readonly failureRecommendation?: Array_Type<FailureModeRecommendation>;
  withFailureRecommendation(failureRecommendation: Array_Type<FailureModeRecommendation> | Array<IFailureModeRecommendation> | null): FailureModeLineItem;

  /**
   * Number of recommended actions
   */
  readonly numRecommendations?: number;
  withNumRecommendations(numRecommendations: number | null): FailureModeLineItem;

  /**
   * String that denotes how many recommended actions are associated with this entity.
   */
  readonly recommendedActionsCountString?: string;
  withRecommendedActionsCountString(recommendedActionsCountString: string | null): FailureModeLineItem;

  /**
   * Foreign key to the {@link ReliabilityAssetAlert} associated with this {@link FailureModeLineItem}.
   */
  readonly alertRelations?: Array_Type<ReliabilityAssetAlertFailureModeRelation>;
  withAlertRelations(alertRelations: Array_Type<ReliabilityAssetAlertFailureModeRelation> | Array<IReliabilityAssetAlertFailureModeRelation> | null): FailureModeLineItem;

  /**
   * The latest time that {@link FailureModeLineItem} and/or its {@link ExpectedSensor} gets updated, specifically for FailureModeLibraryGrid UI.
   */
  readonly updatedTimestamp?: DateTime;
  withUpdatedTimestamp(updatedTimestamp: DateTime | Date | string | null): FailureModeLineItem;
   ...
   * @see #toJson
   */
  static fromJson(json: any): FailureModeLineItem | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): FailureModeLineItem | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): FailureModeLineItem | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): FailureModeLineItem | null;
   ...
   */
  replaceType(old: Type, new_: Type): FailureModeLineItem;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): FailureModeLineItem;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): FailureModeLineItem;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<FailureModeLineItem>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<FailureModeLineItem>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): FailureModeLineItem;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): FailureModeLineItem;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): FailureModeLineItem;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): FailureModeLineItem;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): FailureModeLineItem;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): FailureModeLineItem;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): FailureModeLineItem;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): FailureModeLineItem;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): FailureModeLineItem;
   ...
   * @see #removeField
   */
  withoutField(field: string): FailureModeLineItem;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): FailureModeLineItem;
   ...
   */
  withoutFields(fields: Array_Type<string>): FailureModeLineItem;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): FailureModeLineItem;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): FailureModeLineItem;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): FailureModeLineItem;
   ...
   * @see #unsetField
   */
  defaultField(field: string): FailureModeLineItem;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): FailureModeLineItem;
   ...
   * @see #removeField
   */
  unsetField(field: string): FailureModeLineItem;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): FailureModeLineItem;
   ...
   * @see #unsetField
   */
  removeField(field: string): FailureModeLineItem;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): FailureModeLineItem;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): FailureModeLineItem;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): FailureModeLineItem;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): FailureModeLineItem;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): FailureModeLineItem;

  mergeJson(json: any): FailureModeLineItem;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): FailureModeLineItem;
   ...
   */
  sumObj(other: Obj, deep?: boolean): FailureModeLineItem;
   ...
   */
  singletonArray(): Array_Type<FailureModeLineItem>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<FailureModeLineItem> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<FailureModeLineItem> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<FailureModeLineItem>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<FailureModeLineItem> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, FailureModeLineItem> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, FailureModeLineItem> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<FailureModeLineItem>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<FailureModeLineItem>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): FailureModeLineItem;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): FailureModeLineItem;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): FailureModeLineItem;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): FailureModeLineItem;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): FailureModeLineItem;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): FailureModeLineItem;
   ...
   * @see #fromString
   */
  static make(s: string): FailureModeLineItem | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): FailureModeLineItem;
   ...
   */
  static cachedEmptyInst(): FailureModeLineItem;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<FailureModeLineItem> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): FailureModeLineItem;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<FailureModeLineItem>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<FailureModeLineItem>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<FailureModeLineItem> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<FailureModeLineItem>> | null;
   ...
   */
  get(include?: string): FailureModeLineItem | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): FailureModeLineItem | null;
   ...
   */
  getMissing(spec: GetMissingSpec): FailureModeLineItem;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): FailureModeLineItem | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): FailureModeLineItem;
   ...
   * @see #toString
   */
  static fromString(s: string): FailureModeLineItem | null;
   ...
   */
  create(spec?: UpsertSpec): FailureModeLineItem | null;
   ...
   */
  static createBatch(objs: Array_Type<FailureModeLineItem>, spec?: UpsertSpec): ObjList<FailureModeLineItem> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<FailureModeLineItem>, spec?: CreateBatchObjStreamSpec): ObjList<FailureModeLineItem> | null;
   ...
   */
  update(srcObj?: FailureModeLineItem, spec?: UpsertSpec): FailureModeLineItem | null;
   ...
   */
  upsert(srcObj?: FailureModeLineItem, spec?: UpsertSpec): FailureModeLineItem | null;
   ...
   */
  merge(spec?: MergeSpec): FailureModeLineItem | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): FailureModeLineItem | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): FailureModeLineItem | null;
   ...
   */
  static updateBatch(objs: Array_Type<FailureModeLineItem>, srcObjs?: Array_Type<FailureModeLineItem>, spec?: UpsertSpec): ObjList<FailureModeLineItem> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<FailureModeLineItem> | null>, spec?: UpsertSpec): ObjList<FailureModeLineItem> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<FailureModeLineItem>, srcObjs?: Array_Type<FailureModeLineItem>, spec?: UpsertSpec): ObjList<FailureModeLineItem> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<FailureModeLineItem> | null>, spec?: UpsertSpec): ObjList<FailureModeLineItem> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<FailureModeLineItem>, spec?: TouchSpec): ObjList<FailureModeLineItem> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<FailureModeLineItem>, spec?: MergeSpec): ObjList<FailureModeLineItem> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<FailureModeLineItem>, mergeInclude: string, spec?: MergeSpec): ObjList<FailureModeLineItem> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<FailureModeLineItem> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<FailureModeLineItem> | null;
   ...
   */
  static mergeAll(mergeObj: FailureModeLineItem, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: FailureModeLineItem, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<FailureModeLineItem>, spec?: UpsertSpec): ObjList<FailureModeLineItem> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<FailureModeLineItem>, spec?: UpsertSpec): ObjList<FailureModeLineItem> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): FailureModeLineItem | null;
   ...
   */
  static beforeCreate(objs: Array_Type<FailureModeLineItem>): ObjList<FailureModeLineItem>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<FailureModeLineItem>): ObjList<FailureModeLineItem>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<FailureModeLineItem>): ObjList<FailureModeLineItem>;
   ...
   */
  static afterCreate(objs: Array_Type<FailureModeLineItem>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<FailureModeLineItem>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<FailureModeLineItem>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<FailureModeLineItem>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<FailureModeLineItem>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): FailureModeLineItem | null;
   ...
   */
  withoutIdentity(): FailureModeLineItem | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<FailureModeLineItem>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: FailureModeLineItem, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<FailureModeLineItem>, callback?: λFunction<FailureModeLineItem | null, FailureModeLineItem | null>): ObjList<FailureModeLineItem>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<FailureModeLineItem>, callback?: λFunction<FailureModeLineItem | null, FailureModeLineItem | null>): Array_Type<ObjError> | null;
   ...
   */
  static filterLineItemsByExpectedSensor(lineItems?: Array_Type<FailureModeLineItem>, expectedSensors?: Array_Type<ExpectedSensor>): Array_Type<FailureModeLineItem> | null;
   ...
   */
  static fetchWithActiveStatus(spec?: FetchSpec, expectedSensors?: Array_Type<ExpectedSensor>): FetchResult<FailureModeLineItemWithActiveStatus> | null;
   ...
   */
  static cleanupFailureModeRelations(failureModeLineItemIds: Array_Type<FailureModeLineItem>): number | null;

  /**
   * The method to be edit {@link FailureModeLineItem} after submitting EditFailureModeLibraryDetailForm from the UI.
   */
  static editFailureModeLineItemOnFormSubmit(formObject?: any): void;

  /**
   * Deletes all {@link ReliabilityAssetAlertFailureRecommendationRelation}s and {@link ReliabilityAssetAlertFailureModeRelation}s associated with
   * the {@link DeleteFailureModeLineItemSpec#alert} and {@link DeleteFailureModeLineItemSpec#failureModeLineItem}.
   */
  static deleteAlertFailureModeLineItemRelations(formObject?: DeleteFailureModeLineItemSpec): void;

  /**
   * The method to be create FailureModeRecommendations after submitting FailureModeRecommendationAddModal from the UI.
   */
  static createFailureModeRecommendation(formObject?: any): void;

  /**
   * Deletes all {@link FailureModeRecommendation}s, {@link FailureRecommendationRelation}s, and {@link FailureModeRelation}s
   * associated with the Line Item and then deletes the FailureModeLineItem instance.
   */
  static deleteFailureModeLineItemOnFormSubmit(formObject: DeleteFailureModeLineItemSpec): void;

  /**
   * Return the url for the FML data zip file.
   * Zip file includes all the failure mode library types.
   */
  static getExportDataUrl(filename?: string, filter?: string): string | null;

  /**
   * Helper function for {@link deleteAlertFailureModeLineItemRelations}.
   */
  static doDeleteFailureModeLineItemRelations(from?: string, relation?: string, recRelationType: Type): void;

  /**
   * Creates a new @{link FailureModeLineItem} from scratch.
   */
  static createFailureModeLineItemNew(formObject: OpenFailureModeLineItemSpec): FailureModeLineItem | null;

  /**
   * Create Failure Mode From Existing Failure Mode.
   */
  static createFailureModeLineItemExisting(formObject: OpenFailureModeLineItemExistingSpec): FailureModeLineItem | null;
}
