// TypeScript definitions for the C3 type ReliabilityAssetSensorRelation

/**
 * Clusters a {@link Sensor} together with a {@link ReliabilityAsset} for ML modeling purposes.
 * Represents a conceptual relation. Physical/hierarchical relations are represented with the {@link ReliabilityAssetSensorHierarchicalRelation} type.
 *
 * **Note**: Since this type mixes {@link TimedIntervalRelation}, it is important to specify an {@link id} when
 * attempting to create a new instance if you want to guarantee a new instance is actually created. Otherwise, if you
 * attempt to create a new instance with the same {@link from} as an existing instance, it may just be merged into the
 * existing instance.
 *
 * For additional usage documentation, look to {@link Sensor} and the reliability dev guide topic titled
 * "Tags and Sensors".
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityAssetSensorRelation
 */
declare interface IReliabilityAssetSensorRelation {
  ...
  /**
   * The asset for this relation.
   */
  from: IReliabilityAsset;

  /**
   * The sensor for this relation.
   */
  to: ISensor;
  ...
  /**
   * Matched sensor in {@link FailureModeLibrary} for this asset-sensor pair. Sensors may be
   * associated with different expected sensors when being considered in the context of different
   * assets, e.g. a sensor which acts as OUTLET_PRESSURE for one asset could be INLET_PRESSURE
   * for a different asset.
   */
  expectedSensor?: IExpectedSensor;

  /**
   * Header name for the reconstruction series associated with this asset-sensor pair.
   */
  reconstructionHeaderName?: string;

  /**
   * Determines if there's a {@link PhysicalAssetHierarchyRelation} with a valid time range.
   */
  isPhysicallyConnected?: boolean;

  /**
   * The {@link GlobalFeatureImportanceHistory#importanceValue} of the subsytem tag pair according to the latest trained ML model for the subsytem.
   */
  globalFeatureImportanceValue?: number;

  /**
   * The global feature importance of the subsytem tag pair according to the latest trained ML model for the subsytem.
   */
  globalFeatureImportancePercentage?: number;

  /**
   * If this relation is associated with a #sensorAssociationJob, then this field stores the corresponding correlation
   * value. This is a value between 0 and 1 where 1 means that the sensor (to) is highly correlated with the asset
   * (from). To better understand the process of calculating this field, see
   * {@link ReliabilityAssetSensorAssociationJob}.
   */
  correlationValue?: number;

  /**
   * Represents the historical records of feature importance values
   * for the current {@link ReliabilityAssetSensorRelation} object
   * The relation is captured in {@link GlobalFeatureImportanceHistory}.
   */
  globalFeatureImportanceHistory?: Array_Type<GlobalFeatureImportanceHistory> | Array<IGlobalFeatureImportanceHistory>;

  /**
   * The display value for globalFeatureImportancePercentage in UI, rounded to 2 decimal places
   */
  displayGlobalFeatureImportancePercentage?: number;

  /**
   * Internal use only. Prevents undefined behavior in isPhysicallyConnected.
   */
  localEnd?: DateTime | Date | string;

  /**
   * Internal use only. Prevents undefined behavior in isPhysicallyConnected.
   */
  localStart?: DateTime | Date | string;

  /**
   * The {@link ReliabilityAssetSensorAssociationJob} associated with this relation. Details can be found on
   * {@link ReliabilityAssetSensorAssociationJob}.
   *
   * See #isUpdatedByJob and #correlationValue.
   */
  sensorAssociationJob?: IReliabilityAssetSensorAssociationJob;

  /**
   * Whether the relation is created explicitly from a #sensorAssociationJob.
   */
  isUpdatedByJob?: boolean;
}
 ...
 * "Tags and Sensors".
 *
 * @remarks this represents a made instance of ReliabilityAssetSensorRelation
 */
declare class ReliabilityAssetSensorRelation extends Obj  {

  /**
   * Start timestamp for the value.  If null, assumed to be beginning-of-time (BOT).
   */
  readonly start?: DateTime;
  withStart(start: DateTime | Date | string | null): ReliabilityAssetSensorRelation;

  /**
   * End timestamp for the value.  If null, assumed to be end-of-time (EOT).
   */
  readonly end?: DateTime;
  withEnd(end: DateTime | Date | string | null): ReliabilityAssetSensorRelation;

  /**
   * The asset for this relation.
   */
  readonly from: ReliabilityAsset;
  withFrom(from: IReliabilityAsset): ReliabilityAssetSensorRelation;

  /**
   * The sensor for this relation.
   */
  readonly to: Sensor;
  withTo(to: ISensor): ReliabilityAssetSensorRelation;
   ...
   */
  readonly id: string;
  withId(id: string): ReliabilityAssetSensorRelation;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityAssetSensorRelation;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): ReliabilityAssetSensorRelation;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): ReliabilityAssetSensorRelation;
  ...
  withVersion(version: number | null): ReliabilityAssetSensorRelation;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): ReliabilityAssetSensorRelation;

  /**
   * @inheritdoc
   */
  readonly facilityFilterPaths?: Array_Type<string>;
  withFacilityFilterPaths(facilityFilterPaths: Array_Type<string> | Array<string> | null): ReliabilityAssetSensorRelation;

  /**
   * This ID is used to determine which import this entity belongs to.
   */
  readonly trackingIdForImport?: string;
  withTrackingIdForImport(trackingIdForImport: string | null): ReliabilityAssetSensorRelation;
   ...
   * for a different asset.
   */
  readonly expectedSensor?: ExpectedSensor;
  withExpectedSensor(expectedSensor: IExpectedSensor | null): ReliabilityAssetSensorRelation;

  /**
   * Header name for the reconstruction series associated with this asset-sensor pair.
   */
  readonly reconstructionHeaderName?: string;
  withReconstructionHeaderName(reconstructionHeaderName: string | null): ReliabilityAssetSensorRelation;

  /**
   * Determines if there's a {@link PhysicalAssetHierarchyRelation} with a valid time range.
   */
  readonly isPhysicallyConnected?: boolean;
  withIsPhysicallyConnected(isPhysicallyConnected: boolean): ReliabilityAssetSensorRelation;

  /**
   * The {@link GlobalFeatureImportanceHistory#importanceValue} of the subsytem tag pair according to the latest trained ML model for the subsytem.
   */
  readonly globalFeatureImportanceValue?: number;
  withGlobalFeatureImportanceValue(globalFeatureImportanceValue: number | null): ReliabilityAssetSensorRelation;

  /**
   * The global feature importance of the subsytem tag pair according to the latest trained ML model for the subsytem.
   */
  readonly globalFeatureImportancePercentage?: number;
  withGlobalFeatureImportancePercentage(globalFeatureImportancePercentage: number | null): ReliabilityAssetSensorRelation;
   ...
   * {@link ReliabilityAssetSensorAssociationJob}.
   */
  readonly correlationValue?: number;
  withCorrelationValue(correlationValue: number | null): ReliabilityAssetSensorRelation;
   ...
   * The relation is captured in {@link GlobalFeatureImportanceHistory}.
   */
  readonly globalFeatureImportanceHistory?: Array_Type<GlobalFeatureImportanceHistory>;
  withGlobalFeatureImportanceHistory(globalFeatureImportanceHistory: Array_Type<GlobalFeatureImportanceHistory> | Array<IGlobalFeatureImportanceHistory> | null): ReliabilityAssetSensorRelation;

  /**
   * The display value for globalFeatureImportancePercentage in UI, rounded to 2 decimal places
   */
  readonly displayGlobalFeatureImportancePercentage?: number;
  withDisplayGlobalFeatureImportancePercentage(displayGlobalFeatureImportancePercentage: number | null): ReliabilityAssetSensorRelation;

  /**
   * Internal use only. Prevents undefined behavior in isPhysicallyConnected.
   */
  readonly localEnd?: DateTime;
  withLocalEnd(localEnd: DateTime | Date | string | null): ReliabilityAssetSensorRelation;

  /**
   * Internal use only. Prevents undefined behavior in isPhysicallyConnected.
   */
  readonly localStart?: DateTime;
  withLocalStart(localStart: DateTime | Date | string | null): ReliabilityAssetSensorRelation;
   ...
   * See #isUpdatedByJob and #correlationValue.
   */
  readonly sensorAssociationJob?: ReliabilityAssetSensorAssociationJob;
  withSensorAssociationJob(sensorAssociationJob: IReliabilityAssetSensorAssociationJob | null): ReliabilityAssetSensorRelation;

  /**
   * Whether the relation is created explicitly from a #sensorAssociationJob.
   */
  readonly isUpdatedByJob?: boolean;
  withIsUpdatedByJob(isUpdatedByJob: boolean): ReliabilityAssetSensorRelation;
   ...
   * @see #toJson
   */
  static fromJson(json: any): ReliabilityAssetSensorRelation | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): ReliabilityAssetSensorRelation | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): ReliabilityAssetSensorRelation | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): ReliabilityAssetSensorRelation | null;
   ...
   */
  replaceType(old: Type, new_: Type): ReliabilityAssetSensorRelation;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityAssetSensorRelation;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityAssetSensorRelation;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityAssetSensorRelation>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityAssetSensorRelation>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityAssetSensorRelation;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityAssetSensorRelation;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityAssetSensorRelation;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ReliabilityAssetSensorRelation;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ReliabilityAssetSensorRelation;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityAssetSensorRelation;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityAssetSensorRelation;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityAssetSensorRelation;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ReliabilityAssetSensorRelation;
   ...
   * @see #removeField
   */
  withoutField(field: string): ReliabilityAssetSensorRelation;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): ReliabilityAssetSensorRelation;
   ...
   */
  withoutFields(fields: Array_Type<string>): ReliabilityAssetSensorRelation;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityAssetSensorRelation;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ReliabilityAssetSensorRelation;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityAssetSensorRelation;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ReliabilityAssetSensorRelation;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ReliabilityAssetSensorRelation;
   ...
   * @see #removeField
   */
  unsetField(field: string): ReliabilityAssetSensorRelation;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ReliabilityAssetSensorRelation;
   ...
   * @see #unsetField
   */
  removeField(field: string): ReliabilityAssetSensorRelation;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ReliabilityAssetSensorRelation;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityAssetSensorRelation;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityAssetSensorRelation;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityAssetSensorRelation;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityAssetSensorRelation;

  mergeJson(json: any): ReliabilityAssetSensorRelation;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityAssetSensorRelation;
   ...
   */
  sumObj(other: Obj, deep?: boolean): ReliabilityAssetSensorRelation;
   ...
   */
  singletonArray(): Array_Type<ReliabilityAssetSensorRelation>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityAssetSensorRelation> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ReliabilityAssetSensorRelation> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<ReliabilityAssetSensorRelation>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ReliabilityAssetSensorRelation> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, ReliabilityAssetSensorRelation> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityAssetSensorRelation> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ReliabilityAssetSensorRelation>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ReliabilityAssetSensorRelation>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityAssetSensorRelation;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityAssetSensorRelation;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityAssetSensorRelation;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ReliabilityAssetSensorRelation;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityAssetSensorRelation;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ReliabilityAssetSensorRelation;
   ...
   * @see #fromString
   */
  static make(s: string): ReliabilityAssetSensorRelation | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityAssetSensorRelation;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): ReliabilityAssetSensorRelation;
   ...
   */
  static cachedEmptyInst(): ReliabilityAssetSensorRelation;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityAssetSensorRelation> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): ReliabilityAssetSensorRelation;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<ReliabilityAssetSensorRelation>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<ReliabilityAssetSensorRelation>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityAssetSensorRelation> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityAssetSensorRelation>> | null;
   ...
   */
  static evalFeatureSetBatch(batch: Array_Type<ReliabilityAssetSensorRelation>, featureSet: Feature.Set, spec?: EvalFeatureSpec): Data | null;
   ...
   * ```
   */
  static evalFeaturesBatch(batch: Array_Type<ReliabilityAssetSensorRelation>, features: Array_Type<string>, spec?: EvalFeaturesSpec): Data | null;
   ...
   */
  get(include?: string): ReliabilityAssetSensorRelation | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): ReliabilityAssetSensorRelation | null;
   ...
   */
  getMissing(spec: GetMissingSpec): ReliabilityAssetSensorRelation;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): ReliabilityAssetSensorRelation | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): ReliabilityAssetSensorRelation;
   ...
   * @see #toString
   */
  static fromString(s: string): ReliabilityAssetSensorRelation | null;
   ...
   */
  create(spec?: UpsertSpec): ReliabilityAssetSensorRelation | null;
   ...
   */
  static createBatch(objs: Array_Type<ReliabilityAssetSensorRelation>, spec?: UpsertSpec): ObjList<ReliabilityAssetSensorRelation> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<ReliabilityAssetSensorRelation>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityAssetSensorRelation> | null;
   ...
   */
  update(srcObj?: ReliabilityAssetSensorRelation, spec?: UpsertSpec): ReliabilityAssetSensorRelation | null;
   ...
   */
  upsert(srcObj?: ReliabilityAssetSensorRelation, spec?: UpsertSpec): ReliabilityAssetSensorRelation | null;
   ...
   */
  merge(spec?: MergeSpec): ReliabilityAssetSensorRelation | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): ReliabilityAssetSensorRelation | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): ReliabilityAssetSensorRelation | null;
   ...
   */
  static updateBatch(objs: Array_Type<ReliabilityAssetSensorRelation>, srcObjs?: Array_Type<ReliabilityAssetSensorRelation>, spec?: UpsertSpec): ObjList<ReliabilityAssetSensorRelation> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<ReliabilityAssetSensorRelation> | null>, spec?: UpsertSpec): ObjList<ReliabilityAssetSensorRelation> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<ReliabilityAssetSensorRelation>, srcObjs?: Array_Type<ReliabilityAssetSensorRelation>, spec?: UpsertSpec): ObjList<ReliabilityAssetSensorRelation> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<ReliabilityAssetSensorRelation> | null>, spec?: UpsertSpec): ObjList<ReliabilityAssetSensorRelation> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<ReliabilityAssetSensorRelation>, spec?: TouchSpec): ObjList<ReliabilityAssetSensorRelation> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityAssetSensorRelation>, spec?: MergeSpec): ObjList<ReliabilityAssetSensorRelation> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityAssetSensorRelation>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityAssetSensorRelation> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<ReliabilityAssetSensorRelation> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityAssetSensorRelation> | null;
   ...
   */
  static mergeAll(mergeObj: ReliabilityAssetSensorRelation, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: ReliabilityAssetSensorRelation, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<ReliabilityAssetSensorRelation>, spec?: UpsertSpec): ObjList<ReliabilityAssetSensorRelation> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<ReliabilityAssetSensorRelation>, spec?: UpsertSpec): ObjList<ReliabilityAssetSensorRelation> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): ReliabilityAssetSensorRelation | null;
   ...
   */
  static beforeCreate(objs: Array_Type<ReliabilityAssetSensorRelation>): ObjList<ReliabilityAssetSensorRelation>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<ReliabilityAssetSensorRelation>): ObjList<ReliabilityAssetSensorRelation>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<ReliabilityAssetSensorRelation>): ObjList<ReliabilityAssetSensorRelation>;
   ...
   */
  static afterCreate(objs: Array_Type<ReliabilityAssetSensorRelation>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<ReliabilityAssetSensorRelation>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<ReliabilityAssetSensorRelation>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityAssetSensorRelation>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityAssetSensorRelation>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): ReliabilityAssetSensorRelation | null;
   ...
   */
  withoutIdentity(): ReliabilityAssetSensorRelation | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<ReliabilityAssetSensorRelation>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: ReliabilityAssetSensorRelation, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<ReliabilityAssetSensorRelation>, callback?: λFunction<ReliabilityAssetSensorRelation | null, ReliabilityAssetSensorRelation | null>): ObjList<ReliabilityAssetSensorRelation>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<ReliabilityAssetSensorRelation>, callback?: λFunction<ReliabilityAssetSensorRelation | null, ReliabilityAssetSensorRelation | null>): Array_Type<ObjError> | null;
  ...
  /**
   * Create a {@link Feature} that is defined on the {@link ReliabilityAsset}
   * and provides access to the time series data for the {@link to} Sensor.
   * The {@link Feature} can be created by either using the {@link expectedSensor}
   * so that it is more readable or it can be created by using {@link Sensor#metricSafeId}.
   * There is a third (default) option which attempts to create a {@link Feature}
   * based on {@link expectedSensor} and, if that doesn't work, tries to create the
   * {@link Feature} based on {@link Sensor#metricSafeId}. The default option
   * is the safest option for a new user who is not familiar with `reliabilityRisk`.
   * If `start` and `end` arguments are not provided, then they are automatically
   * inferred from {@link PointPhysicalMeasurementSeries#earliest} and
   * {@link PointPhysicalMeasurementSeries#latest}, respectively. If the {@link Sensor}
   * time series data is not normalized, then this function will raise an error.
   * If such an error is raised, then normalize the time series data and rerun.
   */
  createSensorFeature(start?: DateTime, end?: DateTime, interval?: string = 'QUARTER_HOUR', method?: string = 'BEST'): Feature | null;
}
