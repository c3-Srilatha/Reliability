// TypeScript definitions for the C3 type AssetOnboardingImportJobBatchResult

/**
 * Represents the result of each batch of {@link AssetOnboardingImportJob}.
 *
 * @remarks this represents a value passed to a method that expects an instance of AssetOnboardingImportJobBatchResult
 */
declare interface IAssetOnboardingImportJobBatchResult {
  ...
  /**
   * Entity type which was being upserted in the batch job
   */
  entityType: string;

  /**
   * The job that was executed to produce this result. This will always be the job with `id`
   * equal to {@link AssetOnboardingImportJob}, since this type is a singleton.
   */
  job: IAssetOnboardingImportJob;

  /**
   * File used by the job to get the objects to upsert.
   */
  fileName: string;
  ...
  /**
   * The tracking Id used in the specific import job
   */
 ...
 * Represents the result of each batch of {@link AssetOnboardingImportJob}.
 *
 * @remarks this represents a made instance of AssetOnboardingImportJobBatchResult
 */
declare class AssetOnboardingImportJobBatchResult extends Obj  {
   ...
   */
  readonly id: string;
  withId(id: string): AssetOnboardingImportJobBatchResult;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): AssetOnboardingImportJobBatchResult;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): AssetOnboardingImportJobBatchResult;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): AssetOnboardingImportJobBatchResult;
  ...
  withVersion(version: number | null): AssetOnboardingImportJobBatchResult;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): AssetOnboardingImportJobBatchResult;

  /**
   * Entity type which was being upserted in the batch job
   */
  readonly entityType: string;
  withEntityType(entityType: string): AssetOnboardingImportJobBatchResult;

  /**
   * The job that was executed to produce this result. This will always be the job with `id`
   * equal to {@link AssetOnboardingImportJob}, since this type is a singleton.
   */
  readonly job: AssetOnboardingImportJob;
  withJob(job: IAssetOnboardingImportJob): AssetOnboardingImportJobBatchResult;

  /**
   * File used by the job to get the objects to upsert.
   */
  readonly fileName: string;
  withFileName(fileName: string): AssetOnboardingImportJobBatchResult;

  /**
   * Indicates whether the batch was successfully processed or not.
   */
  readonly status: string;
  withStatus(status: string): AssetOnboardingImportJobBatchResult;

  /**
   * The tracking Id used in the specific import job
   */
  readonly trackingIdForImport: string;
  withTrackingIdForImport(trackingIdForImport: string): AssetOnboardingImportJobBatchResult;
   ...
   * @see #toJson
   */
  static fromJson(json: any): AssetOnboardingImportJobBatchResult | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): AssetOnboardingImportJobBatchResult | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): AssetOnboardingImportJobBatchResult | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): AssetOnboardingImportJobBatchResult | null;
   ...
   */
  replaceType(old: Type, new_: Type): AssetOnboardingImportJobBatchResult;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): AssetOnboardingImportJobBatchResult;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): AssetOnboardingImportJobBatchResult;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<AssetOnboardingImportJobBatchResult>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<AssetOnboardingImportJobBatchResult>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): AssetOnboardingImportJobBatchResult;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): AssetOnboardingImportJobBatchResult;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): AssetOnboardingImportJobBatchResult;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): AssetOnboardingImportJobBatchResult;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): AssetOnboardingImportJobBatchResult;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): AssetOnboardingImportJobBatchResult;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): AssetOnboardingImportJobBatchResult;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): AssetOnboardingImportJobBatchResult;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): AssetOnboardingImportJobBatchResult;
   ...
   * @see #removeField
   */
  withoutField(field: string): AssetOnboardingImportJobBatchResult;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): AssetOnboardingImportJobBatchResult;
   ...
   */
  withoutFields(fields: Array_Type<string>): AssetOnboardingImportJobBatchResult;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): AssetOnboardingImportJobBatchResult;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): AssetOnboardingImportJobBatchResult;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): AssetOnboardingImportJobBatchResult;
   ...
   * @see #unsetField
   */
  defaultField(field: string): AssetOnboardingImportJobBatchResult;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): AssetOnboardingImportJobBatchResult;
   ...
   * @see #removeField
   */
  unsetField(field: string): AssetOnboardingImportJobBatchResult;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): AssetOnboardingImportJobBatchResult;
   ...
   * @see #unsetField
   */
  removeField(field: string): AssetOnboardingImportJobBatchResult;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): AssetOnboardingImportJobBatchResult;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): AssetOnboardingImportJobBatchResult;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): AssetOnboardingImportJobBatchResult;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): AssetOnboardingImportJobBatchResult;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): AssetOnboardingImportJobBatchResult;

  mergeJson(json: any): AssetOnboardingImportJobBatchResult;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): AssetOnboardingImportJobBatchResult;
   ...
   */
  sumObj(other: Obj, deep?: boolean): AssetOnboardingImportJobBatchResult;
   ...
   */
  singletonArray(): Array_Type<AssetOnboardingImportJobBatchResult>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<AssetOnboardingImportJobBatchResult> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<AssetOnboardingImportJobBatchResult> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<AssetOnboardingImportJobBatchResult>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<AssetOnboardingImportJobBatchResult> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, AssetOnboardingImportJobBatchResult> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, AssetOnboardingImportJobBatchResult> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<AssetOnboardingImportJobBatchResult>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<AssetOnboardingImportJobBatchResult>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): AssetOnboardingImportJobBatchResult;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): AssetOnboardingImportJobBatchResult;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): AssetOnboardingImportJobBatchResult;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): AssetOnboardingImportJobBatchResult;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): AssetOnboardingImportJobBatchResult;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): AssetOnboardingImportJobBatchResult;
   ...
   * @see #fromString
   */
  static make(s: string): AssetOnboardingImportJobBatchResult | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): AssetOnboardingImportJobBatchResult;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): AssetOnboardingImportJobBatchResult;
   ...
   */
  static cachedEmptyInst(): AssetOnboardingImportJobBatchResult;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<AssetOnboardingImportJobBatchResult> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): AssetOnboardingImportJobBatchResult;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<AssetOnboardingImportJobBatchResult>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<AssetOnboardingImportJobBatchResult>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<AssetOnboardingImportJobBatchResult> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<AssetOnboardingImportJobBatchResult>> | null;
   ...
   */
  get(include?: string): AssetOnboardingImportJobBatchResult | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): AssetOnboardingImportJobBatchResult | null;
   ...
   */
  getMissing(spec: GetMissingSpec): AssetOnboardingImportJobBatchResult;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): AssetOnboardingImportJobBatchResult | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): AssetOnboardingImportJobBatchResult;
   ...
   * @see #toString
   */
  static fromString(s: string): AssetOnboardingImportJobBatchResult | null;
   ...
   */
  create(spec?: UpsertSpec): AssetOnboardingImportJobBatchResult | null;
   ...
   */
  static createBatch(objs: Array_Type<AssetOnboardingImportJobBatchResult>, spec?: UpsertSpec): ObjList<AssetOnboardingImportJobBatchResult> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<AssetOnboardingImportJobBatchResult>, spec?: CreateBatchObjStreamSpec): ObjList<AssetOnboardingImportJobBatchResult> | null;
   ...
   */
  update(srcObj?: AssetOnboardingImportJobBatchResult, spec?: UpsertSpec): AssetOnboardingImportJobBatchResult | null;
   ...
   */
  upsert(srcObj?: AssetOnboardingImportJobBatchResult, spec?: UpsertSpec): AssetOnboardingImportJobBatchResult | null;
   ...
   */
  merge(spec?: MergeSpec): AssetOnboardingImportJobBatchResult | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): AssetOnboardingImportJobBatchResult | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): AssetOnboardingImportJobBatchResult | null;
   ...
   */
  static updateBatch(objs: Array_Type<AssetOnboardingImportJobBatchResult>, srcObjs?: Array_Type<AssetOnboardingImportJobBatchResult>, spec?: UpsertSpec): ObjList<AssetOnboardingImportJobBatchResult> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<AssetOnboardingImportJobBatchResult> | null>, spec?: UpsertSpec): ObjList<AssetOnboardingImportJobBatchResult> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<AssetOnboardingImportJobBatchResult>, srcObjs?: Array_Type<AssetOnboardingImportJobBatchResult>, spec?: UpsertSpec): ObjList<AssetOnboardingImportJobBatchResult> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<AssetOnboardingImportJobBatchResult> | null>, spec?: UpsertSpec): ObjList<AssetOnboardingImportJobBatchResult> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<AssetOnboardingImportJobBatchResult>, spec?: TouchSpec): ObjList<AssetOnboardingImportJobBatchResult> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<AssetOnboardingImportJobBatchResult>, spec?: MergeSpec): ObjList<AssetOnboardingImportJobBatchResult> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<AssetOnboardingImportJobBatchResult>, mergeInclude: string, spec?: MergeSpec): ObjList<AssetOnboardingImportJobBatchResult> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<AssetOnboardingImportJobBatchResult> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<AssetOnboardingImportJobBatchResult> | null;
   ...
   */
  static mergeAll(mergeObj: AssetOnboardingImportJobBatchResult, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: AssetOnboardingImportJobBatchResult, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<AssetOnboardingImportJobBatchResult>, spec?: UpsertSpec): ObjList<AssetOnboardingImportJobBatchResult> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<AssetOnboardingImportJobBatchResult>, spec?: UpsertSpec): ObjList<AssetOnboardingImportJobBatchResult> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): AssetOnboardingImportJobBatchResult | null;
   ...
   */
  static beforeCreate(objs: Array_Type<AssetOnboardingImportJobBatchResult>): ObjList<AssetOnboardingImportJobBatchResult>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<AssetOnboardingImportJobBatchResult>): ObjList<AssetOnboardingImportJobBatchResult>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<AssetOnboardingImportJobBatchResult>): ObjList<AssetOnboardingImportJobBatchResult>;
   ...
   */
  static afterCreate(objs: Array_Type<AssetOnboardingImportJobBatchResult>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<AssetOnboardingImportJobBatchResult>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<AssetOnboardingImportJobBatchResult>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<AssetOnboardingImportJobBatchResult>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<AssetOnboardingImportJobBatchResult>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): AssetOnboardingImportJobBatchResult | null;
   ...
   */
  withoutIdentity(): AssetOnboardingImportJobBatchResult | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<AssetOnboardingImportJobBatchResult>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: AssetOnboardingImportJobBatchResult, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<AssetOnboardingImportJobBatchResult>, callback?: λFunction<AssetOnboardingImportJobBatchResult | null, AssetOnboardingImportJobBatchResult | null>): ObjList<AssetOnboardingImportJobBatchResult>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<AssetOnboardingImportJobBatchResult>, callback?: λFunction<AssetOnboardingImportJobBatchResult | null, AssetOnboardingImportJobBatchResult | null>): Array_Type<ObjError> | null;
