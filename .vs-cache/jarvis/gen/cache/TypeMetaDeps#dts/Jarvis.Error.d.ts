// TypeScript definitions for the C3 type Jarvis.Error

/**
 * Type that contains metadata about errors thrown within {@link Jarvis.Executor}
 *
 * @remarks this represents a value passed to a method that expects an instance of Jarvis.Error
 */
...
declare namespace Jarvis {
  export class Error extends Obj {
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): Jarvis.Error | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): Jarvis.Error | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): Jarvis.Error | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): Jarvis.Error | null;
     ...
     */
    replaceType(old: Type, new_: Type): Jarvis.Error;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Jarvis.Error;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Jarvis.Error;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Jarvis.Error | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Jarvis.Error | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Jarvis.Error;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Jarvis.Error;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Jarvis.Error;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Jarvis.Error;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Jarvis.Error;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Jarvis.Error;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Jarvis.Error;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Jarvis.Error;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Jarvis.Error;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): Jarvis.Error;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): Jarvis.Error;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): Jarvis.Error;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Jarvis.Error;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Jarvis.Error;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Jarvis.Error;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Jarvis.Error;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Jarvis.Error;
     ...
     * @see #removeField
     */
    unsetField(field: string): Jarvis.Error;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Jarvis.Error;
     ...
     * @see #unsetField
     */
    removeField(field: string): Jarvis.Error;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Jarvis.Error;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Jarvis.Error;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): Jarvis.Error;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Jarvis.Error;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Jarvis.Error;

    mergeJson(json: any | null): Jarvis.Error;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Jarvis.Error;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): Jarvis.Error;
     ...
     */
    singletonArray(): C3.Array<Jarvis.Error | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<Jarvis.Error | null>;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Jarvis.Error | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<Jarvis.Error | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Jarvis.Error | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, Jarvis.Error | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Jarvis.Error | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Jarvis.Error | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Jarvis.Error | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Jarvis.Error;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Jarvis.Error;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Jarvis.Error;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Jarvis.Error;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Jarvis.Error;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Jarvis.Error;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Jarvis.Error;
     ...
     */
    static cachedEmptyInst(): Jarvis.Error;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Jarvis.Error>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): Jarvis.Error;
     ...
     */
    withFormattedMessage(): Jarvis.Error;
     ...
     */
    static formatted(format: string, ...args: any[]): Jarvis.Error;

    /**
     * Construct an error with just the message.
     */
    static fromMessage(s: string | null): Jarvis.Error;
     ...
     */
    static fromJavaException(ex: any): Jarvis.Error;

    /**
     * Construct an error from the system exception.
     */
    static fromJavaException(message: string, ex: any): Jarvis.Error;
     ...
     */
    static fromTemplate(template: string | null, bindings: C3.Map<string | null, any> | null): Jarvis.Error;

    /**
     * Construct an error and a system exception around it to throw an error.
     */
    static fromHttpCodeAndTemplate(httpCode: number | null, template: string | null, bindings: C3.Map<string | null, any> | null): Jarvis.Error;
     ...
     */
    static constructError(notRetryable?: boolean, format?: string | null, ...args: any[]): Jarvis.Error | null;
  }
}
