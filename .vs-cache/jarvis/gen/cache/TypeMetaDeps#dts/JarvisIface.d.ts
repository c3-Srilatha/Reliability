// TypeScript definitions for the C3 type JarvisIface

/**
 * Interface to J.A.R.V.I.S.
 *
 * @remarks this represents a value passed to a method that expects an instance of JarvisIface
 */
declare interface IJarvisIface {
}
 ...
 */
declare class JarvisIface extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): JarvisIface | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): JarvisIface | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): JarvisIface | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): JarvisIface | null;
   ...
   */
  replaceType(old: Type, new_: Type): JarvisIface;
   ...
   * This method is used during live metadata update
   */
  static replaceType(old: Type, new_: Type): JarvisIface;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): JarvisIface;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): JarvisIface;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): JarvisIface;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): JarvisIface;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<JarvisIface | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<JarvisIface | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<JarvisIface | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<JarvisIface | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): JarvisIface;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): JarvisIface;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): JarvisIface;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): JarvisIface;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): JarvisIface;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): JarvisIface;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): JarvisIface;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  static validateObj(): JarvisIface;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): JarvisIface;
   ...
   * @see #defaultField
   */
  static withField(field: string, value: any, doNotConvert?: boolean): JarvisIface;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): JarvisIface;
   ...
   * @see #defaultField
   */
  static withField(field: FieldType, value: any, doNotConvert?: boolean): JarvisIface;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): JarvisIface;
   ...
   * @return new Obj
   */
  static withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): JarvisIface;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): JarvisIface;
   ...
   * @return new Obj
   */
  static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): JarvisIface;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): JarvisIface;
   ...
   * @see #withoutField
   */
  static withoutFieldAtPath(path: string): JarvisIface;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): JarvisIface;
   ...
   * @see #removeField
   */
  static withoutField(field: string | null): JarvisIface;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): JarvisIface;
   ...
   * @see #removeField
   */
  static withoutField(field: FieldType | null): JarvisIface;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): JarvisIface;
   ...
   * @return new Obj with removed fields
   */
  static withoutFields(fields: C3.Array<string | null> | null): JarvisIface;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): JarvisIface;
   ...
   * @return new Obj with removed fields
   */
  static withoutFieldsByType(fields: C3.Array<FieldType | null> | null): JarvisIface;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): JarvisIface;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  static withoutSecretFields(): JarvisIface;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): JarvisIface;
   ...
   * @see FieldType#defaultValue
   */
  static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): JarvisIface;
   ...
   * @see #unsetField
   */
  defaultField(field: string): JarvisIface;
   ...
   * @see #unsetField
   */
  static defaultField(field: string): JarvisIface;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): JarvisIface;
   ...
   * @see #unsetField
   */
  static defaultField(field: FieldType): JarvisIface;
   ...
   * @see #removeField
   */
  unsetField(field: string): JarvisIface;
   ...
   * @see #removeField
   */
  static unsetField(field: string): JarvisIface;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): JarvisIface;
   ...
   * @see #removeField
   */
  static unsetField(field: FieldType): JarvisIface;
   ...
   * @see #unsetField
   */
  removeField(field: string): JarvisIface;
   ...
   * @see #unsetField
   */
  static removeField(field: string): JarvisIface;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): JarvisIface;
   ...
   * @see #unsetField
   */
  static removeField(field: FieldType): JarvisIface;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): JarvisIface;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): JarvisIface;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): JarvisIface;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj | null, otherFieldsFilter: Type): JarvisIface;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): JarvisIface;
   ...
   *        the same key or index.
   */
  static mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): JarvisIface;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): JarvisIface;
   ...
   * traverse child reference and collection fields.
   */
  static mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): JarvisIface;

  mergeJson(json: any | null): JarvisIface;

  static mergeJson(json: any | null): JarvisIface;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): JarvisIface;
   ...
   * @return Obj with child references merged
   */
  static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): JarvisIface;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): JarvisIface;
   ...
   * references with same name and collection elements at same index or key.
   */
  static sumObj(other: Obj | null, deep?: boolean): JarvisIface;
   ...
   */
  singletonArray(): C3.Array<JarvisIface | null>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonArray(): C3.Array<JarvisIface | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<JarvisIface | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<JarvisIface | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<JarvisIface | null>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonSet(): C3.Set<JarvisIface | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<JarvisIface | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, JarvisIface | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, JarvisIface | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<JarvisIface | null>;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  static toBuilder(): ObjBuilder<JarvisIface | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<JarvisIface | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): JarvisIface;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): JarvisIface;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): JarvisIface;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): JarvisIface;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): JarvisIface;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): JarvisIface;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): JarvisIface;
   ...
   */
  static cachedEmptyInst(): JarvisIface;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<JarvisIface>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): JarvisIface;
