// TypeScript definitions for the C3 type Jarvis.Content
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of Jarvis.Content
 */
declare namespace Jarvis {
  export interface IContent {
     ...
     */
    expiresWithBuildEntity?: boolean;
...
declare namespace Jarvis {
  export class Content extends Obj {
     ...
     * @see #toString
     */
    static fromString(s: string | null): Jarvis.Content | null;
     ...
     * @see #fromString
     */
    static make(s: string | null): Jarvis.Content | null;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Jarvis.Content;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Jarvis.Content;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Jarvis.Content;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Jarvis.Content;
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): Jarvis.Content | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): Jarvis.Content | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): Jarvis.Content | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): Jarvis.Content | null;
     ...
     */
    replaceType(old: Type, new_: Type): Jarvis.Content;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Jarvis.Content;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Jarvis.Content;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Jarvis.Content | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Jarvis.Content | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Jarvis.Content;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Jarvis.Content;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Jarvis.Content;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Jarvis.Content;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Jarvis.Content;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Jarvis.Content;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Jarvis.Content;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Jarvis.Content;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Jarvis.Content;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): Jarvis.Content;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): Jarvis.Content;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): Jarvis.Content;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Jarvis.Content;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Jarvis.Content;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Jarvis.Content;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Jarvis.Content;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Jarvis.Content;
     ...
     * @see #removeField
     */
    unsetField(field: string): Jarvis.Content;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Jarvis.Content;
     ...
     * @see #unsetField
     */
    removeField(field: string): Jarvis.Content;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Jarvis.Content;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Jarvis.Content;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): Jarvis.Content;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Jarvis.Content;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Jarvis.Content;

    mergeJson(json: any | null): Jarvis.Content;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Jarvis.Content;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): Jarvis.Content;
     ...
     */
    singletonArray(): C3.Array<Jarvis.Content | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<Jarvis.Content | null>;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Jarvis.Content | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<Jarvis.Content | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Jarvis.Content | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, Jarvis.Content | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Jarvis.Content | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Jarvis.Content | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Jarvis.Content | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Jarvis.Content;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Jarvis.Content;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Jarvis.Content;
     ...
     */
    static cachedEmptyInst(): Jarvis.Content;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Jarvis.Content>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): Jarvis.Content;
     ...
     */
    static forId(id: string | null, failIfMissing?: boolean): Jarvis.Content | null;
     ...
     */
    withFileName(fileName: string | null): Jarvis.Content;

    /**
     * Changes file extension in this instance.
     */
    withFileExt(fileExt: string | null): Jarvis.Content;
     ...
     */
    identify(suffix?: string | null): Jarvis.Content;
     ...
     */
    readMetadata(spec?: FileOperationSpec | null): Jarvis.Content;
     ...
     */
    refreshMetadata(spec?: FileOperationSpec | null): Jarvis.Content;
     ...
     */
    encodedPushStream(spec?: FileOperationSpec | null): Pair<Jarvis.Content | null, BytePushStream | null>;

    /**
     * @return byte push stream to be used for writing un-encoded data into this content object.
     */
    pushStream(spec?: FileOperationSpec | null): Pair<Jarvis.Content | null, BytePushStream | null>;

    /**
     * @return character push stream to be used for writing un-encoded data into this content object.
     */
    charPushStream(spec?: FileOperationSpec | null): Pair<Jarvis.Content | null, CharPushStream | null>;
     ...
     */
    encodedStream(spec?: FileOperationSpec | null): Pair<Jarvis.Content | null, ByteStream | null> | null;
     ...
     */
    writeStream(content: ByteStream | null, spec?: FileOperationSpec | null): Jarvis.Content;

    /**
     * Truncates file and replaces it's content with provided binary content.
     */
    writeInputStream(inputStream: any, spec?: FileOperationSpec | null): Jarvis.Content;

    /**
     * Truncates file and replaces its content with provided binary content from zipInputStream
     */
    writeZipInputStream(zipInputStream: any, spec?: FileOperationSpec | null): Jarvis.Content;
     ...
     */
    writeEncodedStream(encodedContent: ByteStream | null, spec?: FileOperationSpec | null): Jarvis.Content;

    /**
     * Truncates file and replaces it's encoded content with provided binary content.
     */
    writeEncodedInputStream(inputStream: any, spec?: FileOperationSpec | null): Jarvis.Content;
     ...
     *           content that needs to be written
     */
    write(content: any | null, spec?: FileOperationSpec | null): Jarvis.Content;
     ...
     *           encoded content that needs to be written
     */
    writeEncoded(encodedContent: any | null, spec?: FileOperationSpec | null): Jarvis.Content;
     ...
     *           content that needs to be written
     */
    writeString(content: string | null, spec?: FileOperationSpec | null): Jarvis.Content;
     ...
     */
    writeObj(obj: Obj | null, spec?: FileObjsOperSpec | null): Jarvis.Content;
     ...
     * @return pair of update instance of this content and number of objs written
     */
    startWriteObjs(spec?: FileObjsOperSpec | null): Pair<Jarvis.Content | null, PushStream<Obj | null> | null>;
     ...
     */
    compress(contentEncoding?: string | null, spec?: FileCompressSpec | null): Jarvis.Content;

    /**
     * Uncompresses content.
     */
    uncompress(spec?: FileCompressSpec | null): Jarvis.Content;
     ...
     */
    transcode(contentType: string, contentEncoding: string, spec?: FileCompressSpec | null): Jarvis.Content;

    /**
     * Copies content to a given target.
     */
    copyContentTo(target: Jarvis.Content, spec?: FileOperationSpec | null): void;
