...
# Python definitions for the C3 type Jarvis.OptimizerStrategy
...
class OptimizerStrategy():
    ...
    LONGEST_PROCESSING_TIME_FIRST: Optional[str]=None
    """
    Tests are ordered based on longest processing time first algorithm.
    """
    def __init__(self, MANUAL: Optional[str]=None, SERIAL: Optional[str]=None, ROUND_ROBIN: Optional[str]=None, LONGEST_PROCESSING_TIME_FIRST: Optional[str]=None) -> None: ...
