// TypeScript definitions for the C3 type TestDuckyEdgeReact

/**
 * @remarks this represents a value passed to a method that expects an instance of TestDuckyEdgeReact
 */
declare interface ITestDuckyEdgeReact {
   ...
   */
  data?: ITestDuckyEdge | null;
}

/**
 * @remarks this represents a made instance of TestDuckyEdgeReact
 */
declare class TestDuckyEdgeReact extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): TestDuckyEdgeReact | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): TestDuckyEdgeReact | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): TestDuckyEdgeReact | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): TestDuckyEdgeReact | null;
   ...
   */
  replaceType(old: Type, new_: Type): TestDuckyEdgeReact;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): TestDuckyEdgeReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): TestDuckyEdgeReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<TestDuckyEdgeReact | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<TestDuckyEdgeReact | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): TestDuckyEdgeReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TestDuckyEdgeReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TestDuckyEdgeReact;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): TestDuckyEdgeReact;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): TestDuckyEdgeReact;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): TestDuckyEdgeReact;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): TestDuckyEdgeReact;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): TestDuckyEdgeReact;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): TestDuckyEdgeReact;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): TestDuckyEdgeReact;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): TestDuckyEdgeReact;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): TestDuckyEdgeReact;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): TestDuckyEdgeReact;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): TestDuckyEdgeReact;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): TestDuckyEdgeReact;
   ...
   * @see #unsetField
   */
  defaultField(field: string): TestDuckyEdgeReact;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): TestDuckyEdgeReact;
   ...
   * @see #removeField
   */
  unsetField(field: string): TestDuckyEdgeReact;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): TestDuckyEdgeReact;
   ...
   * @see #unsetField
   */
  removeField(field: string): TestDuckyEdgeReact;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): TestDuckyEdgeReact;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): TestDuckyEdgeReact;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): TestDuckyEdgeReact;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): TestDuckyEdgeReact;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): TestDuckyEdgeReact;

  mergeJson(json: any | null): TestDuckyEdgeReact;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): TestDuckyEdgeReact;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): TestDuckyEdgeReact;
   ...
   */
  singletonArray(): C3.Array<TestDuckyEdgeReact | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<TestDuckyEdgeReact | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<TestDuckyEdgeReact | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<TestDuckyEdgeReact | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<TestDuckyEdgeReact | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, TestDuckyEdgeReact | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, TestDuckyEdgeReact | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<TestDuckyEdgeReact | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<TestDuckyEdgeReact | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): TestDuckyEdgeReact;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): TestDuckyEdgeReact;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): TestDuckyEdgeReact;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): TestDuckyEdgeReact;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): TestDuckyEdgeReact;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): TestDuckyEdgeReact;
   ...
   * @see #fromString
   */
  static make(s: string | null): TestDuckyEdgeReact | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): TestDuckyEdgeReact;
   ...
   */
  static cachedEmptyInst(): TestDuckyEdgeReact;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<TestDuckyEdgeReact>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): TestDuckyEdgeReact;
   ...
   */
  static render(props?: TestDuckyEdgeReact | null): void;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<TestDuckyEdgeReact | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<TestDuckyEdgeReact | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<TestDuckyEdgeReact | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<TestDuckyEdgeReact | null> | null>;
   ...
   */
  dependencies(): MetadataDeps<TestDuckyEdgeReact | null>;

  save(subPath?: string | null, contentType?: string | null): TestDuckyEdgeReact;
  ...
  update(srcObj?: TestDuckyEdgeReact | null, spec?: UpsertSpec | null): TestDuckyEdgeReact | null;

  upsert(srcObj?: TestDuckyEdgeReact | null, spec?: UpsertSpec | null): TestDuckyEdgeReact | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): TestDuckyEdgeReact | null;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string | null, failIfMissing?: boolean): TestDuckyEdgeReact | null;
   ...
   */
  static doDataMerge(componentId: string, dataSpecFieldName: string, dataDestinationFieldName: string, props: TestDuckyEdgeReact, state: UiSdlReduxState): TestDuckyEdgeReact | null;
