// TypeScript definitions for the C3 type BasicDiagramEdgeReact

/**
 * @remarks this represents a value passed to a method that expects an instance of BasicDiagramEdgeReact
 */
declare interface IBasicDiagramEdgeReact {
   ...
   */
  data?: IBasicDiagramEdge | null;
}

/**
 * @remarks this represents a made instance of BasicDiagramEdgeReact
 */
declare class BasicDiagramEdgeReact extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): BasicDiagramEdgeReact | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): BasicDiagramEdgeReact | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): BasicDiagramEdgeReact | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): BasicDiagramEdgeReact | null;
   ...
   */
  replaceType(old: Type, new_: Type): BasicDiagramEdgeReact;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): BasicDiagramEdgeReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): BasicDiagramEdgeReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<BasicDiagramEdgeReact | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<BasicDiagramEdgeReact | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): BasicDiagramEdgeReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): BasicDiagramEdgeReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): BasicDiagramEdgeReact;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): BasicDiagramEdgeReact;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): BasicDiagramEdgeReact;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): BasicDiagramEdgeReact;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): BasicDiagramEdgeReact;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): BasicDiagramEdgeReact;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): BasicDiagramEdgeReact;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): BasicDiagramEdgeReact;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): BasicDiagramEdgeReact;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): BasicDiagramEdgeReact;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): BasicDiagramEdgeReact;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): BasicDiagramEdgeReact;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): BasicDiagramEdgeReact;
   ...
   * @see #unsetField
   */
  defaultField(field: string): BasicDiagramEdgeReact;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): BasicDiagramEdgeReact;
   ...
   * @see #removeField
   */
  unsetField(field: string): BasicDiagramEdgeReact;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): BasicDiagramEdgeReact;
   ...
   * @see #unsetField
   */
  removeField(field: string): BasicDiagramEdgeReact;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): BasicDiagramEdgeReact;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): BasicDiagramEdgeReact;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): BasicDiagramEdgeReact;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): BasicDiagramEdgeReact;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): BasicDiagramEdgeReact;

  mergeJson(json: any | null): BasicDiagramEdgeReact;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): BasicDiagramEdgeReact;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): BasicDiagramEdgeReact;
   ...
   */
  singletonArray(): C3.Array<BasicDiagramEdgeReact | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<BasicDiagramEdgeReact | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<BasicDiagramEdgeReact | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<BasicDiagramEdgeReact | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<BasicDiagramEdgeReact | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, BasicDiagramEdgeReact | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, BasicDiagramEdgeReact | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<BasicDiagramEdgeReact | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<BasicDiagramEdgeReact | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): BasicDiagramEdgeReact;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): BasicDiagramEdgeReact;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): BasicDiagramEdgeReact;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): BasicDiagramEdgeReact;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): BasicDiagramEdgeReact;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): BasicDiagramEdgeReact;
   ...
   * @see #fromString
   */
  static make(s: string | null): BasicDiagramEdgeReact | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): BasicDiagramEdgeReact;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): BasicDiagramEdgeReact;
   ...
   */
  static cachedEmptyInst(): BasicDiagramEdgeReact;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<BasicDiagramEdgeReact>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): BasicDiagramEdgeReact;
   ...
   */
  static render(props?: BasicDiagramEdgeReact | null): void;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<BasicDiagramEdgeReact | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<BasicDiagramEdgeReact | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<BasicDiagramEdgeReact | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<BasicDiagramEdgeReact | null> | null>;
   ...
   */
  dependencies(): MetadataDeps<BasicDiagramEdgeReact | null>;

  save(subPath?: string | null, contentType?: string | null): BasicDiagramEdgeReact;
  ...
  update(srcObj?: BasicDiagramEdgeReact | null, spec?: UpsertSpec | null): BasicDiagramEdgeReact | null;

  upsert(srcObj?: BasicDiagramEdgeReact | null, spec?: UpsertSpec | null): BasicDiagramEdgeReact | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): BasicDiagramEdgeReact | null;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string | null, failIfMissing?: boolean): BasicDiagramEdgeReact | null;
   ...
   */
  static doDataMerge(componentId: string, dataSpecFieldName: string, dataDestinationFieldName: string, props: BasicDiagramEdgeReact, state: UiSdlReduxState): BasicDiagramEdgeReact | null;
