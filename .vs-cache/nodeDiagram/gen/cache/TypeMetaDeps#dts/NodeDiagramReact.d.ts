// TypeScript definitions for the C3 type NodeDiagramReact

/**
 * React renderer for {@link NodeDiagram}s
 *
 * @remarks this represents a value passed to a method that expects an instance of NodeDiagramReact
 */
declare interface INodeDiagramReact {
 ...
 */
declare class NodeDiagramReact extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): NodeDiagramReact | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): NodeDiagramReact | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): NodeDiagramReact | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): NodeDiagramReact | null;
   ...
   */
  replaceType(old: Type, new_: Type): NodeDiagramReact;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): NodeDiagramReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): NodeDiagramReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<NodeDiagramReact | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<NodeDiagramReact | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): NodeDiagramReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): NodeDiagramReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): NodeDiagramReact;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): NodeDiagramReact;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): NodeDiagramReact;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): NodeDiagramReact;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): NodeDiagramReact;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): NodeDiagramReact;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): NodeDiagramReact;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): NodeDiagramReact;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): NodeDiagramReact;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): NodeDiagramReact;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): NodeDiagramReact;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): NodeDiagramReact;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): NodeDiagramReact;
   ...
   * @see #unsetField
   */
  defaultField(field: string): NodeDiagramReact;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): NodeDiagramReact;
   ...
   * @see #removeField
   */
  unsetField(field: string): NodeDiagramReact;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): NodeDiagramReact;
   ...
   * @see #unsetField
   */
  removeField(field: string): NodeDiagramReact;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): NodeDiagramReact;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): NodeDiagramReact;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): NodeDiagramReact;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): NodeDiagramReact;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): NodeDiagramReact;

  mergeJson(json: any | null): NodeDiagramReact;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): NodeDiagramReact;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): NodeDiagramReact;
   ...
   */
  singletonArray(): C3.Array<NodeDiagramReact | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<NodeDiagramReact | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<NodeDiagramReact | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<NodeDiagramReact | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<NodeDiagramReact | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, NodeDiagramReact | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, NodeDiagramReact | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<NodeDiagramReact | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<NodeDiagramReact | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): NodeDiagramReact;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): NodeDiagramReact;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): NodeDiagramReact;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): NodeDiagramReact;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): NodeDiagramReact;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): NodeDiagramReact;
   ...
   * @see #fromString
   */
  static make(s: string | null): NodeDiagramReact | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): NodeDiagramReact;
   ...
   */
  static cachedEmptyInst(): NodeDiagramReact;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<NodeDiagramReact>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): NodeDiagramReact;
   ...
   */
  static render(props?: NodeDiagramReact | null): void;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<NodeDiagramReact | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<NodeDiagramReact | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<NodeDiagramReact | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<NodeDiagramReact | null> | null>;
   ...
   */
  dependencies(): MetadataDeps<NodeDiagramReact | null>;

  save(subPath?: string | null, contentType?: string | null): NodeDiagramReact;
  ...
  update(srcObj?: NodeDiagramReact | null, spec?: UpsertSpec | null): NodeDiagramReact | null;

  upsert(srcObj?: NodeDiagramReact | null, spec?: UpsertSpec | null): NodeDiagramReact | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): NodeDiagramReact | null;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string | null, failIfMissing?: boolean): NodeDiagramReact | null;
   ...
   */
  static doDataMerge(componentId: string, dataSpecFieldName: string, dataDestinationFieldName: string, props: NodeDiagramReact, state: UiSdlReduxState): NodeDiagramReact | null;
