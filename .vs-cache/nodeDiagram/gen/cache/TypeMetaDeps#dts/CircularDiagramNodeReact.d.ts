// TypeScript definitions for the C3 type CircularDiagramNodeReact

/**
 * @remarks this represents a value passed to a method that expects an instance of CircularDiagramNodeReact
 */
declare interface ICircularDiagramNodeReact {
   ...
   */
  data?: ICircularDiagramNode | null;
}

/**
 * @remarks this represents a made instance of CircularDiagramNodeReact
 */
declare class CircularDiagramNodeReact extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): CircularDiagramNodeReact | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): CircularDiagramNodeReact | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): CircularDiagramNodeReact | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): CircularDiagramNodeReact | null;
   ...
   */
  replaceType(old: Type, new_: Type): CircularDiagramNodeReact;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): CircularDiagramNodeReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): CircularDiagramNodeReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<CircularDiagramNodeReact | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<CircularDiagramNodeReact | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): CircularDiagramNodeReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): CircularDiagramNodeReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): CircularDiagramNodeReact;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): CircularDiagramNodeReact;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): CircularDiagramNodeReact;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): CircularDiagramNodeReact;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): CircularDiagramNodeReact;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): CircularDiagramNodeReact;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): CircularDiagramNodeReact;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): CircularDiagramNodeReact;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): CircularDiagramNodeReact;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): CircularDiagramNodeReact;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): CircularDiagramNodeReact;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): CircularDiagramNodeReact;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): CircularDiagramNodeReact;
   ...
   * @see #unsetField
   */
  defaultField(field: string): CircularDiagramNodeReact;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): CircularDiagramNodeReact;
   ...
   * @see #removeField
   */
  unsetField(field: string): CircularDiagramNodeReact;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): CircularDiagramNodeReact;
   ...
   * @see #unsetField
   */
  removeField(field: string): CircularDiagramNodeReact;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): CircularDiagramNodeReact;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): CircularDiagramNodeReact;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): CircularDiagramNodeReact;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): CircularDiagramNodeReact;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): CircularDiagramNodeReact;

  mergeJson(json: any | null): CircularDiagramNodeReact;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): CircularDiagramNodeReact;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): CircularDiagramNodeReact;
   ...
   */
  singletonArray(): C3.Array<CircularDiagramNodeReact | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<CircularDiagramNodeReact | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<CircularDiagramNodeReact | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<CircularDiagramNodeReact | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<CircularDiagramNodeReact | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, CircularDiagramNodeReact | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, CircularDiagramNodeReact | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<CircularDiagramNodeReact | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<CircularDiagramNodeReact | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): CircularDiagramNodeReact;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): CircularDiagramNodeReact;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): CircularDiagramNodeReact;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): CircularDiagramNodeReact;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): CircularDiagramNodeReact;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): CircularDiagramNodeReact;
   ...
   * @see #fromString
   */
  static make(s: string | null): CircularDiagramNodeReact | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): CircularDiagramNodeReact;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): CircularDiagramNodeReact;
   ...
   */
  static cachedEmptyInst(): CircularDiagramNodeReact;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<CircularDiagramNodeReact>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): CircularDiagramNodeReact;
   ...
   */
  static render(props?: CircularDiagramNodeReact | null): void;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<CircularDiagramNodeReact | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<CircularDiagramNodeReact | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<CircularDiagramNodeReact | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<CircularDiagramNodeReact | null> | null>;
   ...
   */
  dependencies(): MetadataDeps<CircularDiagramNodeReact | null>;

  save(subPath?: string | null, contentType?: string | null): CircularDiagramNodeReact;
  ...
  update(srcObj?: CircularDiagramNodeReact | null, spec?: UpsertSpec | null): CircularDiagramNodeReact | null;

  upsert(srcObj?: CircularDiagramNodeReact | null, spec?: UpsertSpec | null): CircularDiagramNodeReact | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): CircularDiagramNodeReact | null;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string | null, failIfMissing?: boolean): CircularDiagramNodeReact | null;
   ...
   */
  static doDataMerge(componentId: string, dataSpecFieldName: string, dataDestinationFieldName: string, props: CircularDiagramNodeReact, state: UiSdlReduxState): CircularDiagramNodeReact | null;
