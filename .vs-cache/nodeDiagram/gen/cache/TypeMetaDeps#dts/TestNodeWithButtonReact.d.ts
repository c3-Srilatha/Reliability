// TypeScript definitions for the C3 type TestNodeWithButtonReact

/**
 * @remarks this represents a value passed to a method that expects an instance of TestNodeWithButtonReact
 */
declare interface ITestNodeWithButtonReact {
   ...
   */
  data?: ITestNodeWithButton | null;
}

/**
 * @remarks this represents a made instance of TestNodeWithButtonReact
 */
declare class TestNodeWithButtonReact extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): TestNodeWithButtonReact | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): TestNodeWithButtonReact | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): TestNodeWithButtonReact | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): TestNodeWithButtonReact | null;
   ...
   */
  replaceType(old: Type, new_: Type): TestNodeWithButtonReact;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): TestNodeWithButtonReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): TestNodeWithButtonReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<TestNodeWithButtonReact | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<TestNodeWithButtonReact | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): TestNodeWithButtonReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TestNodeWithButtonReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TestNodeWithButtonReact;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): TestNodeWithButtonReact;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): TestNodeWithButtonReact;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): TestNodeWithButtonReact;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): TestNodeWithButtonReact;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): TestNodeWithButtonReact;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): TestNodeWithButtonReact;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): TestNodeWithButtonReact;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): TestNodeWithButtonReact;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): TestNodeWithButtonReact;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): TestNodeWithButtonReact;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): TestNodeWithButtonReact;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): TestNodeWithButtonReact;
   ...
   * @see #unsetField
   */
  defaultField(field: string): TestNodeWithButtonReact;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): TestNodeWithButtonReact;
   ...
   * @see #removeField
   */
  unsetField(field: string): TestNodeWithButtonReact;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): TestNodeWithButtonReact;
   ...
   * @see #unsetField
   */
  removeField(field: string): TestNodeWithButtonReact;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): TestNodeWithButtonReact;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): TestNodeWithButtonReact;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): TestNodeWithButtonReact;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): TestNodeWithButtonReact;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): TestNodeWithButtonReact;

  mergeJson(json: any | null): TestNodeWithButtonReact;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): TestNodeWithButtonReact;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): TestNodeWithButtonReact;
   ...
   */
  singletonArray(): C3.Array<TestNodeWithButtonReact | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<TestNodeWithButtonReact | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<TestNodeWithButtonReact | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<TestNodeWithButtonReact | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<TestNodeWithButtonReact | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, TestNodeWithButtonReact | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, TestNodeWithButtonReact | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<TestNodeWithButtonReact | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<TestNodeWithButtonReact | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): TestNodeWithButtonReact;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): TestNodeWithButtonReact;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): TestNodeWithButtonReact;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): TestNodeWithButtonReact;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): TestNodeWithButtonReact;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): TestNodeWithButtonReact;
   ...
   * @see #fromString
   */
  static make(s: string | null): TestNodeWithButtonReact | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): TestNodeWithButtonReact;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): TestNodeWithButtonReact;
   ...
   */
  static cachedEmptyInst(): TestNodeWithButtonReact;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<TestNodeWithButtonReact>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): TestNodeWithButtonReact;
   ...
   */
  static render(props?: TestNodeWithButtonReact | null): void;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<TestNodeWithButtonReact | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<TestNodeWithButtonReact | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<TestNodeWithButtonReact | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<TestNodeWithButtonReact | null> | null>;
   ...
   */
  dependencies(): MetadataDeps<TestNodeWithButtonReact | null>;

  save(subPath?: string | null, contentType?: string | null): TestNodeWithButtonReact;
  ...
  update(srcObj?: TestNodeWithButtonReact | null, spec?: UpsertSpec | null): TestNodeWithButtonReact | null;

  upsert(srcObj?: TestNodeWithButtonReact | null, spec?: UpsertSpec | null): TestNodeWithButtonReact | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): TestNodeWithButtonReact | null;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string | null, failIfMissing?: boolean): TestNodeWithButtonReact | null;
   ...
   */
  static doDataMerge(componentId: string, dataSpecFieldName: string, dataDestinationFieldName: string, props: TestNodeWithButtonReact, state: UiSdlReduxState): TestNodeWithButtonReact | null;
