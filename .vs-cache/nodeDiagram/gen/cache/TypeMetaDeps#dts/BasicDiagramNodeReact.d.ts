// TypeScript definitions for the C3 type BasicDiagramNodeReact

/**
 * @remarks this represents a value passed to a method that expects an instance of BasicDiagramNodeReact
 */
declare interface IBasicDiagramNodeReact {
 ...
 */
declare class BasicDiagramNodeReact extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): BasicDiagramNodeReact | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): BasicDiagramNodeReact | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): BasicDiagramNodeReact | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): BasicDiagramNodeReact | null;
   ...
   */
  replaceType(old: Type, new_: Type): BasicDiagramNodeReact;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): BasicDiagramNodeReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): BasicDiagramNodeReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<BasicDiagramNodeReact | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<BasicDiagramNodeReact | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): BasicDiagramNodeReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): BasicDiagramNodeReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): BasicDiagramNodeReact;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): BasicDiagramNodeReact;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): BasicDiagramNodeReact;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): BasicDiagramNodeReact;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): BasicDiagramNodeReact;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): BasicDiagramNodeReact;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): BasicDiagramNodeReact;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): BasicDiagramNodeReact;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): BasicDiagramNodeReact;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): BasicDiagramNodeReact;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): BasicDiagramNodeReact;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): BasicDiagramNodeReact;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): BasicDiagramNodeReact;
   ...
   * @see #unsetField
   */
  defaultField(field: string): BasicDiagramNodeReact;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): BasicDiagramNodeReact;
   ...
   * @see #removeField
   */
  unsetField(field: string): BasicDiagramNodeReact;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): BasicDiagramNodeReact;
   ...
   * @see #unsetField
   */
  removeField(field: string): BasicDiagramNodeReact;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): BasicDiagramNodeReact;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): BasicDiagramNodeReact;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): BasicDiagramNodeReact;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): BasicDiagramNodeReact;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): BasicDiagramNodeReact;

  mergeJson(json: any | null): BasicDiagramNodeReact;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): BasicDiagramNodeReact;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): BasicDiagramNodeReact;
   ...
   */
  singletonArray(): C3.Array<BasicDiagramNodeReact | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<BasicDiagramNodeReact | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<BasicDiagramNodeReact | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<BasicDiagramNodeReact | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<BasicDiagramNodeReact | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, BasicDiagramNodeReact | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, BasicDiagramNodeReact | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<BasicDiagramNodeReact | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<BasicDiagramNodeReact | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): BasicDiagramNodeReact;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): BasicDiagramNodeReact;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): BasicDiagramNodeReact;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): BasicDiagramNodeReact;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): BasicDiagramNodeReact;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): BasicDiagramNodeReact;
   ...
   * @see #fromString
   */
  static make(s: string | null): BasicDiagramNodeReact | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): BasicDiagramNodeReact;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): BasicDiagramNodeReact;
   ...
   */
  static cachedEmptyInst(): BasicDiagramNodeReact;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<BasicDiagramNodeReact>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): BasicDiagramNodeReact;
   ...
   */
  static render(props?: BasicDiagramNodeReact | null): void;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<BasicDiagramNodeReact | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<BasicDiagramNodeReact | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<BasicDiagramNodeReact | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<BasicDiagramNodeReact | null> | null>;
   ...
   */
  dependencies(): MetadataDeps<BasicDiagramNodeReact | null>;

  save(subPath?: string | null, contentType?: string | null): BasicDiagramNodeReact;
  ...
  update(srcObj?: BasicDiagramNodeReact | null, spec?: UpsertSpec | null): BasicDiagramNodeReact | null;

  upsert(srcObj?: BasicDiagramNodeReact | null, spec?: UpsertSpec | null): BasicDiagramNodeReact | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): BasicDiagramNodeReact | null;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string | null, failIfMissing?: boolean): BasicDiagramNodeReact | null;
   ...
   */
  static doDataMerge(componentId: string, dataSpecFieldName: string, dataDestinationFieldName: string, props: BasicDiagramNodeReact, state: UiSdlReduxState): BasicDiagramNodeReact | null;
