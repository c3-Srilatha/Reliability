// TypeScript definitions for the C3 type RenderLoggingNodeReact

/**
 * @remarks this represents a value passed to a method that expects an instance of RenderLoggingNodeReact
 */
declare interface IRenderLoggingNodeReact {
   ...
   */
  data?: IRenderLoggingNode | null;
}

/**
 * @remarks this represents a made instance of RenderLoggingNodeReact
 */
declare class RenderLoggingNodeReact extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): RenderLoggingNodeReact | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): RenderLoggingNodeReact | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): RenderLoggingNodeReact | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): RenderLoggingNodeReact | null;
   ...
   */
  replaceType(old: Type, new_: Type): RenderLoggingNodeReact;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): RenderLoggingNodeReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): RenderLoggingNodeReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<RenderLoggingNodeReact | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<RenderLoggingNodeReact | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): RenderLoggingNodeReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): RenderLoggingNodeReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): RenderLoggingNodeReact;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): RenderLoggingNodeReact;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): RenderLoggingNodeReact;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): RenderLoggingNodeReact;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): RenderLoggingNodeReact;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): RenderLoggingNodeReact;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): RenderLoggingNodeReact;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): RenderLoggingNodeReact;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): RenderLoggingNodeReact;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): RenderLoggingNodeReact;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): RenderLoggingNodeReact;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): RenderLoggingNodeReact;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): RenderLoggingNodeReact;
   ...
   * @see #unsetField
   */
  defaultField(field: string): RenderLoggingNodeReact;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): RenderLoggingNodeReact;
   ...
   * @see #removeField
   */
  unsetField(field: string): RenderLoggingNodeReact;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): RenderLoggingNodeReact;
   ...
   * @see #unsetField
   */
  removeField(field: string): RenderLoggingNodeReact;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): RenderLoggingNodeReact;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): RenderLoggingNodeReact;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): RenderLoggingNodeReact;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): RenderLoggingNodeReact;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): RenderLoggingNodeReact;

  mergeJson(json: any | null): RenderLoggingNodeReact;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): RenderLoggingNodeReact;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): RenderLoggingNodeReact;
   ...
   */
  singletonArray(): C3.Array<RenderLoggingNodeReact | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<RenderLoggingNodeReact | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<RenderLoggingNodeReact | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<RenderLoggingNodeReact | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<RenderLoggingNodeReact | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, RenderLoggingNodeReact | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, RenderLoggingNodeReact | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<RenderLoggingNodeReact | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<RenderLoggingNodeReact | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): RenderLoggingNodeReact;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): RenderLoggingNodeReact;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): RenderLoggingNodeReact;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): RenderLoggingNodeReact;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): RenderLoggingNodeReact;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): RenderLoggingNodeReact;
   ...
   * @see #fromString
   */
  static make(s: string | null): RenderLoggingNodeReact | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): RenderLoggingNodeReact;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): RenderLoggingNodeReact;
   ...
   */
  static cachedEmptyInst(): RenderLoggingNodeReact;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<RenderLoggingNodeReact>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): RenderLoggingNodeReact;
   ...
   */
  static render(props?: RenderLoggingNodeReact | null): void;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<RenderLoggingNodeReact | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<RenderLoggingNodeReact | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<RenderLoggingNodeReact | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<RenderLoggingNodeReact | null> | null>;
   ...
   */
  dependencies(): MetadataDeps<RenderLoggingNodeReact | null>;

  save(subPath?: string | null, contentType?: string | null): RenderLoggingNodeReact;
  ...
  update(srcObj?: RenderLoggingNodeReact | null, spec?: UpsertSpec | null): RenderLoggingNodeReact | null;

  upsert(srcObj?: RenderLoggingNodeReact | null, spec?: UpsertSpec | null): RenderLoggingNodeReact | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): RenderLoggingNodeReact | null;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string | null, failIfMissing?: boolean): RenderLoggingNodeReact | null;
   ...
   */
  static doDataMerge(componentId: string, dataSpecFieldName: string, dataDestinationFieldName: string, props: RenderLoggingNodeReact, state: UiSdlReduxState): RenderLoggingNodeReact | null;
