// TypeScript definitions for the C3 type TestNodeWithDropdownReact

/**
 * @remarks this represents a value passed to a method that expects an instance of TestNodeWithDropdownReact
 */
declare interface ITestNodeWithDropdownReact {
   ...
   */
  data?: ITestNodeWithDropdown | null;
}

/**
 * @remarks this represents a made instance of TestNodeWithDropdownReact
 */
declare class TestNodeWithDropdownReact extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): TestNodeWithDropdownReact | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): TestNodeWithDropdownReact | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): TestNodeWithDropdownReact | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): TestNodeWithDropdownReact | null;
   ...
   */
  replaceType(old: Type, new_: Type): TestNodeWithDropdownReact;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): TestNodeWithDropdownReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): TestNodeWithDropdownReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<TestNodeWithDropdownReact | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<TestNodeWithDropdownReact | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): TestNodeWithDropdownReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TestNodeWithDropdownReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TestNodeWithDropdownReact;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): TestNodeWithDropdownReact;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): TestNodeWithDropdownReact;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): TestNodeWithDropdownReact;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): TestNodeWithDropdownReact;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): TestNodeWithDropdownReact;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): TestNodeWithDropdownReact;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): TestNodeWithDropdownReact;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): TestNodeWithDropdownReact;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): TestNodeWithDropdownReact;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): TestNodeWithDropdownReact;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): TestNodeWithDropdownReact;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): TestNodeWithDropdownReact;
   ...
   * @see #unsetField
   */
  defaultField(field: string): TestNodeWithDropdownReact;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): TestNodeWithDropdownReact;
   ...
   * @see #removeField
   */
  unsetField(field: string): TestNodeWithDropdownReact;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): TestNodeWithDropdownReact;
   ...
   * @see #unsetField
   */
  removeField(field: string): TestNodeWithDropdownReact;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): TestNodeWithDropdownReact;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): TestNodeWithDropdownReact;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): TestNodeWithDropdownReact;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): TestNodeWithDropdownReact;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): TestNodeWithDropdownReact;

  mergeJson(json: any | null): TestNodeWithDropdownReact;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): TestNodeWithDropdownReact;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): TestNodeWithDropdownReact;
   ...
   */
  singletonArray(): C3.Array<TestNodeWithDropdownReact | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<TestNodeWithDropdownReact | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<TestNodeWithDropdownReact | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<TestNodeWithDropdownReact | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<TestNodeWithDropdownReact | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, TestNodeWithDropdownReact | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, TestNodeWithDropdownReact | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<TestNodeWithDropdownReact | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<TestNodeWithDropdownReact | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): TestNodeWithDropdownReact;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): TestNodeWithDropdownReact;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): TestNodeWithDropdownReact;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): TestNodeWithDropdownReact;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): TestNodeWithDropdownReact;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): TestNodeWithDropdownReact;
   ...
   * @see #fromString
   */
  static make(s: string | null): TestNodeWithDropdownReact | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): TestNodeWithDropdownReact;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): TestNodeWithDropdownReact;
   ...
   */
  static cachedEmptyInst(): TestNodeWithDropdownReact;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<TestNodeWithDropdownReact>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): TestNodeWithDropdownReact;
   ...
   */
  static render(props?: TestNodeWithDropdownReact | null): void;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<TestNodeWithDropdownReact | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<TestNodeWithDropdownReact | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<TestNodeWithDropdownReact | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<TestNodeWithDropdownReact | null> | null>;
   ...
   */
  dependencies(): MetadataDeps<TestNodeWithDropdownReact | null>;

  save(subPath?: string | null, contentType?: string | null): TestNodeWithDropdownReact;
  ...
  update(srcObj?: TestNodeWithDropdownReact | null, spec?: UpsertSpec | null): TestNodeWithDropdownReact | null;

  upsert(srcObj?: TestNodeWithDropdownReact | null, spec?: UpsertSpec | null): TestNodeWithDropdownReact | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): TestNodeWithDropdownReact | null;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string | null, failIfMissing?: boolean): TestNodeWithDropdownReact | null;
   ...
   */
  static doDataMerge(componentId: string, dataSpecFieldName: string, dataDestinationFieldName: string, props: TestNodeWithDropdownReact, state: UiSdlReduxState): TestNodeWithDropdownReact | null;
