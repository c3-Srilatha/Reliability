// TypeScript definitions for the C3 type RenderLoggingEdgeReact

/**
 * @remarks this represents a value passed to a method that expects an instance of RenderLoggingEdgeReact
 */
declare interface IRenderLoggingEdgeReact {
   ...
   */
  data?: IRenderLoggingEdge | null;
}

/**
 * @remarks this represents a made instance of RenderLoggingEdgeReact
 */
declare class RenderLoggingEdgeReact extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): RenderLoggingEdgeReact | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): RenderLoggingEdgeReact | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): RenderLoggingEdgeReact | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): RenderLoggingEdgeReact | null;
   ...
   */
  replaceType(old: Type, new_: Type): RenderLoggingEdgeReact;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): RenderLoggingEdgeReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): RenderLoggingEdgeReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<RenderLoggingEdgeReact | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<RenderLoggingEdgeReact | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): RenderLoggingEdgeReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): RenderLoggingEdgeReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): RenderLoggingEdgeReact;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): RenderLoggingEdgeReact;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): RenderLoggingEdgeReact;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): RenderLoggingEdgeReact;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): RenderLoggingEdgeReact;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): RenderLoggingEdgeReact;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): RenderLoggingEdgeReact;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): RenderLoggingEdgeReact;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): RenderLoggingEdgeReact;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): RenderLoggingEdgeReact;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): RenderLoggingEdgeReact;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): RenderLoggingEdgeReact;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): RenderLoggingEdgeReact;
   ...
   * @see #unsetField
   */
  defaultField(field: string): RenderLoggingEdgeReact;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): RenderLoggingEdgeReact;
   ...
   * @see #removeField
   */
  unsetField(field: string): RenderLoggingEdgeReact;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): RenderLoggingEdgeReact;
   ...
   * @see #unsetField
   */
  removeField(field: string): RenderLoggingEdgeReact;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): RenderLoggingEdgeReact;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): RenderLoggingEdgeReact;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): RenderLoggingEdgeReact;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): RenderLoggingEdgeReact;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): RenderLoggingEdgeReact;

  mergeJson(json: any | null): RenderLoggingEdgeReact;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): RenderLoggingEdgeReact;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): RenderLoggingEdgeReact;
   ...
   */
  singletonArray(): C3.Array<RenderLoggingEdgeReact | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<RenderLoggingEdgeReact | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<RenderLoggingEdgeReact | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<RenderLoggingEdgeReact | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<RenderLoggingEdgeReact | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, RenderLoggingEdgeReact | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, RenderLoggingEdgeReact | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<RenderLoggingEdgeReact | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<RenderLoggingEdgeReact | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): RenderLoggingEdgeReact;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): RenderLoggingEdgeReact;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): RenderLoggingEdgeReact;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): RenderLoggingEdgeReact;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): RenderLoggingEdgeReact;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): RenderLoggingEdgeReact;
   ...
   * @see #fromString
   */
  static make(s: string | null): RenderLoggingEdgeReact | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): RenderLoggingEdgeReact;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): RenderLoggingEdgeReact;
   ...
   */
  static cachedEmptyInst(): RenderLoggingEdgeReact;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<RenderLoggingEdgeReact>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): RenderLoggingEdgeReact;
   ...
   */
  static render(props?: RenderLoggingEdgeReact | null): void;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<RenderLoggingEdgeReact | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<RenderLoggingEdgeReact | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<RenderLoggingEdgeReact | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<RenderLoggingEdgeReact | null> | null>;
   ...
   */
  dependencies(): MetadataDeps<RenderLoggingEdgeReact | null>;

  save(subPath?: string | null, contentType?: string | null): RenderLoggingEdgeReact;
  ...
  update(srcObj?: RenderLoggingEdgeReact | null, spec?: UpsertSpec | null): RenderLoggingEdgeReact | null;

  upsert(srcObj?: RenderLoggingEdgeReact | null, spec?: UpsertSpec | null): RenderLoggingEdgeReact | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): RenderLoggingEdgeReact | null;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string | null, failIfMissing?: boolean): RenderLoggingEdgeReact | null;
   ...
   */
  static doDataMerge(componentId: string, dataSpecFieldName: string, dataDestinationFieldName: string, props: RenderLoggingEdgeReact, state: UiSdlReduxState): RenderLoggingEdgeReact | null;
