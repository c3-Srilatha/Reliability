// TypeScript definitions for the C3 type NodeDiagramGroupReact

/**
 * @remarks this represents a value passed to a method that expects an instance of NodeDiagramGroupReact
 */
declare interface INodeDiagramGroupReact {
 ...
 */
declare class NodeDiagramGroupReact extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): NodeDiagramGroupReact | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): NodeDiagramGroupReact | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): NodeDiagramGroupReact | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): NodeDiagramGroupReact | null;
   ...
   */
  replaceType(old: Type, new_: Type): NodeDiagramGroupReact;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): NodeDiagramGroupReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): NodeDiagramGroupReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<NodeDiagramGroupReact | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<NodeDiagramGroupReact | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): NodeDiagramGroupReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): NodeDiagramGroupReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): NodeDiagramGroupReact;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): NodeDiagramGroupReact;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): NodeDiagramGroupReact;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): NodeDiagramGroupReact;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): NodeDiagramGroupReact;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): NodeDiagramGroupReact;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): NodeDiagramGroupReact;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): NodeDiagramGroupReact;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): NodeDiagramGroupReact;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): NodeDiagramGroupReact;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): NodeDiagramGroupReact;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): NodeDiagramGroupReact;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): NodeDiagramGroupReact;
   ...
   * @see #unsetField
   */
  defaultField(field: string): NodeDiagramGroupReact;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): NodeDiagramGroupReact;
   ...
   * @see #removeField
   */
  unsetField(field: string): NodeDiagramGroupReact;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): NodeDiagramGroupReact;
   ...
   * @see #unsetField
   */
  removeField(field: string): NodeDiagramGroupReact;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): NodeDiagramGroupReact;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): NodeDiagramGroupReact;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): NodeDiagramGroupReact;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): NodeDiagramGroupReact;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): NodeDiagramGroupReact;

  mergeJson(json: any | null): NodeDiagramGroupReact;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): NodeDiagramGroupReact;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): NodeDiagramGroupReact;
   ...
   */
  singletonArray(): C3.Array<NodeDiagramGroupReact | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<NodeDiagramGroupReact | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<NodeDiagramGroupReact | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<NodeDiagramGroupReact | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<NodeDiagramGroupReact | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, NodeDiagramGroupReact | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, NodeDiagramGroupReact | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<NodeDiagramGroupReact | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<NodeDiagramGroupReact | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): NodeDiagramGroupReact;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): NodeDiagramGroupReact;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): NodeDiagramGroupReact;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): NodeDiagramGroupReact;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): NodeDiagramGroupReact;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): NodeDiagramGroupReact;
   ...
   * @see #fromString
   */
  static make(s: string | null): NodeDiagramGroupReact | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): NodeDiagramGroupReact;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): NodeDiagramGroupReact;
   ...
   */
  static cachedEmptyInst(): NodeDiagramGroupReact;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<NodeDiagramGroupReact>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): NodeDiagramGroupReact;
   ...
   */
  static render(props?: NodeDiagramGroupReact | null): void;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<NodeDiagramGroupReact | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<NodeDiagramGroupReact | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<NodeDiagramGroupReact | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<NodeDiagramGroupReact | null> | null>;
   ...
   */
  dependencies(): MetadataDeps<NodeDiagramGroupReact | null>;

  save(subPath?: string | null, contentType?: string | null): NodeDiagramGroupReact;
  ...
  update(srcObj?: NodeDiagramGroupReact | null, spec?: UpsertSpec | null): NodeDiagramGroupReact | null;

  upsert(srcObj?: NodeDiagramGroupReact | null, spec?: UpsertSpec | null): NodeDiagramGroupReact | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): NodeDiagramGroupReact | null;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string | null, failIfMissing?: boolean): NodeDiagramGroupReact | null;
   ...
   */
  static doDataMerge(componentId: string, dataSpecFieldName: string, dataDestinationFieldName: string, props: NodeDiagramGroupReact, state: UiSdlReduxState): NodeDiagramGroupReact | null;
