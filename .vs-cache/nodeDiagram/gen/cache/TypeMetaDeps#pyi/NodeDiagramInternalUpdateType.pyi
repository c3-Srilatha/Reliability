...
# Python definitions for the C3 type NodeDiagramInternalUpdateType


class NodeDiagramInternalUpdateType():
    """
    ...
    CLEAR_UPDATE_QUEUE: Optional[str]=None
    """
    ...
    """
    def __init__(self, CLEAR_UPDATE_QUEUE: Optional[str]=None, NODE_POSITION: Optional[str]=None, NODE_SIZE: Optional[str]=None) -> None: ...
