// TypeScript definitions for the C3 type TestGraphVisualizationEdge

/**
 * Type to represent a test edge.
 *
 * @remarks this represents a value passed to a method that expects an instance of TestGraphVisualizationEdge
 */
declare interface ITestGraphVisualizationEdge {
   ...
   * The `from` node.
   */
  from?: ITestGraphVisualizationNode | null;

  /**
   * The `to` node.
   */
  to?: ITestGraphVisualizationNode | null;
}
 ...
 */
declare class TestGraphVisualizationEdge extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): TestGraphVisualizationEdge | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): TestGraphVisualizationEdge | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): TestGraphVisualizationEdge | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): TestGraphVisualizationEdge | null;
   ...
   */
  replaceType(old: Type, new_: Type): TestGraphVisualizationEdge;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): TestGraphVisualizationEdge;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): TestGraphVisualizationEdge;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<TestGraphVisualizationEdge | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<TestGraphVisualizationEdge | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): TestGraphVisualizationEdge;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TestGraphVisualizationEdge;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TestGraphVisualizationEdge;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): TestGraphVisualizationEdge;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): TestGraphVisualizationEdge;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): TestGraphVisualizationEdge;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): TestGraphVisualizationEdge;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): TestGraphVisualizationEdge;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): TestGraphVisualizationEdge;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): TestGraphVisualizationEdge;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): TestGraphVisualizationEdge;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): TestGraphVisualizationEdge;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): TestGraphVisualizationEdge;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): TestGraphVisualizationEdge;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): TestGraphVisualizationEdge;
   ...
   * @see #unsetField
   */
  defaultField(field: string): TestGraphVisualizationEdge;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): TestGraphVisualizationEdge;
   ...
   * @see #removeField
   */
  unsetField(field: string): TestGraphVisualizationEdge;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): TestGraphVisualizationEdge;
   ...
   * @see #unsetField
   */
  removeField(field: string): TestGraphVisualizationEdge;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): TestGraphVisualizationEdge;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): TestGraphVisualizationEdge;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): TestGraphVisualizationEdge;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): TestGraphVisualizationEdge;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): TestGraphVisualizationEdge;

  mergeJson(json: any | null): TestGraphVisualizationEdge;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): TestGraphVisualizationEdge;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): TestGraphVisualizationEdge;
   ...
   */
  singletonArray(): C3.Array<TestGraphVisualizationEdge | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<TestGraphVisualizationEdge | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<TestGraphVisualizationEdge | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<TestGraphVisualizationEdge | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<TestGraphVisualizationEdge | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, TestGraphVisualizationEdge | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, TestGraphVisualizationEdge | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<TestGraphVisualizationEdge | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<TestGraphVisualizationEdge | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): TestGraphVisualizationEdge;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): TestGraphVisualizationEdge;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): TestGraphVisualizationEdge;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): TestGraphVisualizationEdge;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): TestGraphVisualizationEdge;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): TestGraphVisualizationEdge;
   ...
   * @see #fromString
   */
  static make(s: string | null): TestGraphVisualizationEdge | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): TestGraphVisualizationEdge;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): TestGraphVisualizationEdge;
   ...
   */
  static cachedEmptyInst(): TestGraphVisualizationEdge;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<TestGraphVisualizationEdge>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): TestGraphVisualizationEdge;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<TestGraphVisualizationEdge | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<TestGraphVisualizationEdge | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<TestGraphVisualizationEdge | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<TestGraphVisualizationEdge | null> | null>;
   ...
   */
  get(include?: string | null): TestGraphVisualizationEdge | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): TestGraphVisualizationEdge | null;
   ...
   */
  getMissing(spec: GetMissingSpec): TestGraphVisualizationEdge;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): TestGraphVisualizationEdge | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): TestGraphVisualizationEdge;
   ...
   * @see #toString
   */
  static fromString(s: string | null): TestGraphVisualizationEdge | null;
   ...
   */
  create(spec?: UpsertSpec | null): TestGraphVisualizationEdge | null;
   ...
   */
  static createBatch(objs: C3.Array<TestGraphVisualizationEdge | null> | null, spec?: UpsertSpec | null): ObjList<TestGraphVisualizationEdge | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<TestGraphVisualizationEdge | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<TestGraphVisualizationEdge | null> | null;
   ...
   */
  update(srcObj?: TestGraphVisualizationEdge | null, spec?: UpsertSpec | null): TestGraphVisualizationEdge | null;
   ...
   */
  upsert(srcObj?: TestGraphVisualizationEdge | null, spec?: UpsertSpec | null): TestGraphVisualizationEdge | null;
   ...
   */
  merge(spec?: MergeSpec | null): TestGraphVisualizationEdge | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): TestGraphVisualizationEdge | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): TestGraphVisualizationEdge | null;
   ...
   */
  static updateBatch(objs: C3.Array<TestGraphVisualizationEdge | null> | null, srcObjs?: C3.Array<TestGraphVisualizationEdge | null>, spec?: UpsertSpec | null): ObjList<TestGraphVisualizationEdge | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<TestGraphVisualizationEdge | null>>, spec?: UpsertSpec | null): ObjList<TestGraphVisualizationEdge | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<TestGraphVisualizationEdge | null> | null, srcObjs?: C3.Array<TestGraphVisualizationEdge | null>, spec?: UpsertSpec | null): ObjList<TestGraphVisualizationEdge | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<TestGraphVisualizationEdge | null>>, spec?: UpsertSpec | null): ObjList<TestGraphVisualizationEdge | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<TestGraphVisualizationEdge | null> | null, spec?: TouchSpec | null): ObjList<TestGraphVisualizationEdge | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<TestGraphVisualizationEdge | null> | null, spec?: MergeSpec | null): ObjList<TestGraphVisualizationEdge | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<TestGraphVisualizationEdge | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<TestGraphVisualizationEdge | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<TestGraphVisualizationEdge | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<TestGraphVisualizationEdge | null> | null;
   ...
   */
  static mergeAll(mergeObj: TestGraphVisualizationEdge | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: TestGraphVisualizationEdge | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<TestGraphVisualizationEdge | null> | null, spec?: UpsertSpec | null): ObjList<TestGraphVisualizationEdge | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<TestGraphVisualizationEdge | null> | null, spec?: UpsertSpec | null): ObjList<TestGraphVisualizationEdge | null> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): TestGraphVisualizationEdge | null;
   ...
   */
  static beforeCreate(objs: C3.Array<TestGraphVisualizationEdge | null> | null): ObjList<TestGraphVisualizationEdge | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<TestGraphVisualizationEdge | null> | null): ObjList<TestGraphVisualizationEdge | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<TestGraphVisualizationEdge | null> | null): ObjList<TestGraphVisualizationEdge | null>;
   ...
   */
  static afterCreate(objs: C3.Array<TestGraphVisualizationEdge | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<TestGraphVisualizationEdge | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<TestGraphVisualizationEdge | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<TestGraphVisualizationEdge | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<TestGraphVisualizationEdge | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): TestGraphVisualizationEdge | null;
   ...
   */
  withoutIdentity(): TestGraphVisualizationEdge | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<TestGraphVisualizationEdge | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: TestGraphVisualizationEdge | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<TestGraphVisualizationEdge | null> | null, callback?: λFunction<TestGraphVisualizationEdge | null, TestGraphVisualizationEdge | null> | null): ObjList<TestGraphVisualizationEdge | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<TestGraphVisualizationEdge | null> | null, callback?: λFunction<TestGraphVisualizationEdge | null, TestGraphVisualizationEdge | null> | null): C3.Array<ObjError | null>;
