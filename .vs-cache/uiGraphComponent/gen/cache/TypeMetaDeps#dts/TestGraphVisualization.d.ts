// TypeScript definitions for the C3 type TestGraphVisualization

/**
 * Represent a test graph.
 *
 * @remarks this represents a value passed to a method that expects an instance of TestGraphVisualization
 */
declare interface ITestGraphVisualization {

  /**
   * All vertices in this graph
   */
  m_vertices?: C3.Array<TestGraphVisualizationNode | null> | Array<ITestGraphVisualizationNode | null>;

  /**
   * All edges in this graph
   */
  m_edges?: C3.Array<TestGraphVisualizationEdge | null> | Array<ITestGraphVisualizationEdge | null>;

  /**
   * Set of all vertices that are not traversable
   * E.g Graph is : A - B - C, and if B is not traversable then A and C are disconnected
   */
  m_nonTraversableVertices?: C3.Array<TestGraphVisualizationNode | null> | Array<ITestGraphVisualizationNode | null>;
 ...
 */
declare class TestGraphVisualization extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): TestGraphVisualization | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): TestGraphVisualization | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): TestGraphVisualization | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): TestGraphVisualization | null;
   ...
   */
  replaceType(old: Type, new_: Type): TestGraphVisualization;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): TestGraphVisualization;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): TestGraphVisualization;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<TestGraphVisualization | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<TestGraphVisualization | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): TestGraphVisualization;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TestGraphVisualization;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TestGraphVisualization;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): TestGraphVisualization;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): TestGraphVisualization;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): TestGraphVisualization;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): TestGraphVisualization;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): TestGraphVisualization;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): TestGraphVisualization;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): TestGraphVisualization;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): TestGraphVisualization;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): TestGraphVisualization;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): TestGraphVisualization;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): TestGraphVisualization;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): TestGraphVisualization;
   ...
   * @see #unsetField
   */
  defaultField(field: string): TestGraphVisualization;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): TestGraphVisualization;
   ...
   * @see #removeField
   */
  unsetField(field: string): TestGraphVisualization;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): TestGraphVisualization;
   ...
   * @see #unsetField
   */
  removeField(field: string): TestGraphVisualization;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): TestGraphVisualization;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): TestGraphVisualization;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): TestGraphVisualization;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): TestGraphVisualization;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): TestGraphVisualization;

  mergeJson(json: any | null): TestGraphVisualization;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): TestGraphVisualization;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): TestGraphVisualization;
   ...
   */
  singletonArray(): C3.Array<TestGraphVisualization | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<TestGraphVisualization | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<TestGraphVisualization | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<TestGraphVisualization | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<TestGraphVisualization | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, TestGraphVisualization | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, TestGraphVisualization | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<TestGraphVisualization | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<TestGraphVisualization | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): TestGraphVisualization;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): TestGraphVisualization;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): TestGraphVisualization;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): TestGraphVisualization;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): TestGraphVisualization;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): TestGraphVisualization;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): TestGraphVisualization;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): TestGraphVisualization;
   ...
   */
  static cachedEmptyInst(): TestGraphVisualization;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<TestGraphVisualization>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): TestGraphVisualization;
   ...
   */
  vertices(filter?: string | null, bindings?: ObjMapp | null): C3.Array<TestGraphVisualizationNode | null>;
   ...
   */
  containsVertex(vertex: TestGraphVisualizationNode): boolean;
   ...
   */
  edges(filter?: string | null, bindings?: ObjMapp | null): C3.Array<TestGraphVisualizationEdge | null>;
   ...
   */
  containsEdge(edge: TestGraphVisualizationEdge): boolean;
   ...
   */
  connectedVertices(vertex?: TestGraphVisualizationNode | null, depth?: number | null): C3.Array<TestGraphVisualizationNode | null>;
   ...
   */
  connectedEdges(vertex?: TestGraphVisualizationNode | null): C3.Array<TestGraphVisualizationEdge | null>;
   ...
   */
  connectedPaths(fromVertex?: TestGraphVisualizationNode | null, toVertex?: TestGraphVisualizationNode | null, noOfPaths?: number | null, allowCycles?: boolean, maxDepth?: number | null): C3.Array<C3.Array<TestGraphVisualizationNode | null>>;

  /**
   * @return List of all the connected sub-graphs
   */
  allSubGraphs(): C3.Array<Graph<TestGraphVisualizationNode | null, TestGraphVisualizationEdge | null> | null>;
   ...
   */
  connectedSubGraph(vertex?: TestGraphVisualizationNode | null): Graph<TestGraphVisualizationNode | null, TestGraphVisualizationEdge | null> | null;
   ...
   * @return The sub-graph connected with the given vertex
   */
  filteredSubGraph(vertex?: TestGraphVisualizationNode | null, vertexFilter?: string | null, edgeFilter?: string | null, bindings?: ObjMapp | null, doCache?: boolean): Graph<TestGraphVisualizationNode | null, TestGraphVisualizationEdge | null> | null;
   ...
   * @return The sub-graph connected with the given vertex
   */
  filteredDirectedSubGraph(vertex: TestGraphVisualizationNode, spec: TraverseGraphSpec): Graph<TestGraphVisualizationNode | null, TestGraphVisualizationEdge | null>;
   ...
   */
  collectCounts(vertex: TestGraphVisualizationNode, countsSpec?: CollectCountsSpec | null): C3.Map<string | null, number | null>;
   ...
   * @see #collectCounts
   */
  collectCountsBatch(vertices?: C3.Array<TestGraphVisualizationNode | null>, countsSpec?: CollectCountsSpec | null): C3.Array<C3.Map<string | null, number | null>>;
   ...
   */
  pathToSinkNodes(vertex: TestGraphVisualizationNode, allowCycles?: boolean): C3.Array<C3.Array<TestGraphVisualizationNode | null>>;
   ...
   */
  static makeGraph(vertices?: C3.Array<TestGraphVisualizationNode | null>, edges?: C3.Array<TestGraphVisualizationEdge | null>, nonTraversableVertices?: C3.Array<TestGraphVisualizationNode | null>, doCache?: boolean): Graph<TestGraphVisualizationNode | null, TestGraphVisualizationEdge | null> | null;
   ...
   *              the cached graph (on the root action context) for any further computation on the graph
   */
  static loadGraph(batchSize?: number | null, threads?: number | null, vertexSpec?: GraphDataSpec | null, edgeSpec?: GraphDataSpec | null, doCache?: boolean): Graph<TestGraphVisualizationNode | null, TestGraphVisualizationEdge | null> | null;
   ...
   */
  addVertices(vertices: Stream<TestGraphVisualizationNode | null>): Graph<TestGraphVisualizationNode | null, TestGraphVisualizationEdge | null>;
   ...
   * @return pointer to the graph object
   */
  addEdges(edges: Stream<TestGraphVisualizationEdge | null>): Graph<TestGraphVisualizationNode | null, TestGraphVisualizationEdge | null>;
   ...
   */
  static saveGraph(spec: LoadGraphSpec): Graph<TestGraphVisualizationNode | null, TestGraphVisualizationEdge | null>;
   ...
   */
  static generateRandomGraph(vertexCount?: number | null, edgeCount?: number | null, vertexInclude?: string | null, edgeInclude?: string | null, doCache?: boolean): Graph<TestGraphVisualizationNode | null, TestGraphVisualizationEdge | null> | null;

  /**
   * topological sort the graph (only works for directed graph)
   * @return the id of vertex in topological sequence
   */
  topologicalSort(): C3.Array<TestGraphVisualizationNode | null>;
   ...
   */
  static getVertexSpec(): GraphDataSpec | null;
   ...
   */
  static getEdgeSpec(): GraphDataSpec | null;
   ...
   */
  static loadFullGraphInMemory(vertexSpec?: GraphDataSpec | null, edgeSpec?: GraphDataSpec | null, batchSize?: number | null, threads?: number | null): TestGraphVisualization | null;
   ...
   * @return The instance of {@link DataVisualizationGraph}.
   */
  static loadFullGraph(vertexSpec?: GraphDataSpec | null, edgeSpec?: GraphDataSpec | null, batchSize?: number | null, threads?: number | null): TestGraphVisualization | null;
   ...
   * @return The instance of {@link DataVisualizationGraph}.
   */
  static getFilteredGraph(verticesIds?: string | null, edgesIds?: string | null): TestGraphVisualization | null;
}
