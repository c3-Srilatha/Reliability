// TypeScript definitions for the C3 type UiSdlGraphVisualizationGraphWarningModal
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of UiSdlGraphVisualizationGraphWarningModal
 */
declare interface IUiSdlGraphVisualizationGraphWarningModal {
 ...
 */
declare class UiSdlGraphVisualizationGraphWarningModal extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): UiSdlGraphVisualizationGraphWarningModal | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): UiSdlGraphVisualizationGraphWarningModal | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): UiSdlGraphVisualizationGraphWarningModal | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): UiSdlGraphVisualizationGraphWarningModal | null;
   ...
   */
  replaceType(old: Type, new_: Type): UiSdlGraphVisualizationGraphWarningModal;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlGraphVisualizationGraphWarningModal;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlGraphVisualizationGraphWarningModal;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlGraphVisualizationGraphWarningModal | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlGraphVisualizationGraphWarningModal | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): UiSdlGraphVisualizationGraphWarningModal;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlGraphVisualizationGraphWarningModal;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlGraphVisualizationGraphWarningModal;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): UiSdlGraphVisualizationGraphWarningModal;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): UiSdlGraphVisualizationGraphWarningModal;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): UiSdlGraphVisualizationGraphWarningModal;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): UiSdlGraphVisualizationGraphWarningModal;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): UiSdlGraphVisualizationGraphWarningModal;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): UiSdlGraphVisualizationGraphWarningModal;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): UiSdlGraphVisualizationGraphWarningModal;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): UiSdlGraphVisualizationGraphWarningModal;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): UiSdlGraphVisualizationGraphWarningModal;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): UiSdlGraphVisualizationGraphWarningModal;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): UiSdlGraphVisualizationGraphWarningModal;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): UiSdlGraphVisualizationGraphWarningModal;
   ...
   * @see #unsetField
   */
  defaultField(field: string): UiSdlGraphVisualizationGraphWarningModal;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): UiSdlGraphVisualizationGraphWarningModal;
   ...
   * @see #removeField
   */
  unsetField(field: string): UiSdlGraphVisualizationGraphWarningModal;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): UiSdlGraphVisualizationGraphWarningModal;
   ...
   * @see #unsetField
   */
  removeField(field: string): UiSdlGraphVisualizationGraphWarningModal;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): UiSdlGraphVisualizationGraphWarningModal;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): UiSdlGraphVisualizationGraphWarningModal;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): UiSdlGraphVisualizationGraphWarningModal;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): UiSdlGraphVisualizationGraphWarningModal;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): UiSdlGraphVisualizationGraphWarningModal;

  mergeJson(json: any | null): UiSdlGraphVisualizationGraphWarningModal;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): UiSdlGraphVisualizationGraphWarningModal;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): UiSdlGraphVisualizationGraphWarningModal;
   ...
   */
  singletonArray(): C3.Array<UiSdlGraphVisualizationGraphWarningModal | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<UiSdlGraphVisualizationGraphWarningModal | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<UiSdlGraphVisualizationGraphWarningModal | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<UiSdlGraphVisualizationGraphWarningModal | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<UiSdlGraphVisualizationGraphWarningModal | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, UiSdlGraphVisualizationGraphWarningModal | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, UiSdlGraphVisualizationGraphWarningModal | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<UiSdlGraphVisualizationGraphWarningModal | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<UiSdlGraphVisualizationGraphWarningModal | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): UiSdlGraphVisualizationGraphWarningModal;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): UiSdlGraphVisualizationGraphWarningModal;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): UiSdlGraphVisualizationGraphWarningModal;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): UiSdlGraphVisualizationGraphWarningModal;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): UiSdlGraphVisualizationGraphWarningModal;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): UiSdlGraphVisualizationGraphWarningModal;
   ...
   * @see #fromString
   */
  static make(s: string | null): UiSdlGraphVisualizationGraphWarningModal | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): UiSdlGraphVisualizationGraphWarningModal;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): UiSdlGraphVisualizationGraphWarningModal;
   ...
   */
  static cachedEmptyInst(): UiSdlGraphVisualizationGraphWarningModal;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<UiSdlGraphVisualizationGraphWarningModal>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): UiSdlGraphVisualizationGraphWarningModal;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<UiSdlGraphVisualizationGraphWarningModal | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<UiSdlGraphVisualizationGraphWarningModal | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<UiSdlGraphVisualizationGraphWarningModal | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<UiSdlGraphVisualizationGraphWarningModal | null> | null>;
   ...
   */
  dependencies(): MetadataDeps<UiSdlGraphVisualizationGraphWarningModal | null>;

  save(subPath?: string | null, contentType?: string | null): UiSdlGraphVisualizationGraphWarningModal;
  ...
  update(srcObj?: UiSdlGraphVisualizationGraphWarningModal | null, spec?: UpsertSpec | null): UiSdlGraphVisualizationGraphWarningModal | null;

  upsert(srcObj?: UiSdlGraphVisualizationGraphWarningModal | null, spec?: UpsertSpec | null): UiSdlGraphVisualizationGraphWarningModal | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): UiSdlGraphVisualizationGraphWarningModal | null;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string | null, failIfMissing?: boolean): UiSdlGraphVisualizationGraphWarningModal | null;
   ...
   */
  static doDataMerge(componentId: string, dataSpecFieldName: string, dataDestinationFieldName: string, props: UiSdlGraphVisualizationGraphWarningModal, state: UiSdlReduxState): UiSdlGraphVisualizationGraphWarningModal | null;
