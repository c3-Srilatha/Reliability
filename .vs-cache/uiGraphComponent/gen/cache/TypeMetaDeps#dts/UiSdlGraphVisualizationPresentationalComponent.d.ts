// TypeScript definitions for the C3 type UiSdlGraphVisualizationPresentationalComponent

/**
 * The presentational component for a {@link UiSdlGraphVisualization} instance.
 *
 * @remarks this represents a value passed to a method that expects an instance of UiSdlGraphVisualizationPresentationalComponent
 */
declare interface IUiSdlGraphVisualizationPresentationalComponent {
 ...
 */
declare class UiSdlGraphVisualizationPresentationalComponent extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): UiSdlGraphVisualizationPresentationalComponent | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): UiSdlGraphVisualizationPresentationalComponent | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): UiSdlGraphVisualizationPresentationalComponent | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): UiSdlGraphVisualizationPresentationalComponent | null;
   ...
   */
  replaceType(old: Type, new_: Type): UiSdlGraphVisualizationPresentationalComponent;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlGraphVisualizationPresentationalComponent;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlGraphVisualizationPresentationalComponent;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlGraphVisualizationPresentationalComponent | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlGraphVisualizationPresentationalComponent | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): UiSdlGraphVisualizationPresentationalComponent;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlGraphVisualizationPresentationalComponent;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlGraphVisualizationPresentationalComponent;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): UiSdlGraphVisualizationPresentationalComponent;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): UiSdlGraphVisualizationPresentationalComponent;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): UiSdlGraphVisualizationPresentationalComponent;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): UiSdlGraphVisualizationPresentationalComponent;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): UiSdlGraphVisualizationPresentationalComponent;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): UiSdlGraphVisualizationPresentationalComponent;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): UiSdlGraphVisualizationPresentationalComponent;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): UiSdlGraphVisualizationPresentationalComponent;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): UiSdlGraphVisualizationPresentationalComponent;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): UiSdlGraphVisualizationPresentationalComponent;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): UiSdlGraphVisualizationPresentationalComponent;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): UiSdlGraphVisualizationPresentationalComponent;
   ...
   * @see #unsetField
   */
  defaultField(field: string): UiSdlGraphVisualizationPresentationalComponent;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): UiSdlGraphVisualizationPresentationalComponent;
   ...
   * @see #removeField
   */
  unsetField(field: string): UiSdlGraphVisualizationPresentationalComponent;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): UiSdlGraphVisualizationPresentationalComponent;
   ...
   * @see #unsetField
   */
  removeField(field: string): UiSdlGraphVisualizationPresentationalComponent;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): UiSdlGraphVisualizationPresentationalComponent;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): UiSdlGraphVisualizationPresentationalComponent;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): UiSdlGraphVisualizationPresentationalComponent;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): UiSdlGraphVisualizationPresentationalComponent;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): UiSdlGraphVisualizationPresentationalComponent;

  mergeJson(json: any | null): UiSdlGraphVisualizationPresentationalComponent;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): UiSdlGraphVisualizationPresentationalComponent;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): UiSdlGraphVisualizationPresentationalComponent;
   ...
   */
  singletonArray(): C3.Array<UiSdlGraphVisualizationPresentationalComponent | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<UiSdlGraphVisualizationPresentationalComponent | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<UiSdlGraphVisualizationPresentationalComponent | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<UiSdlGraphVisualizationPresentationalComponent | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<UiSdlGraphVisualizationPresentationalComponent | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, UiSdlGraphVisualizationPresentationalComponent | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, UiSdlGraphVisualizationPresentationalComponent | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<UiSdlGraphVisualizationPresentationalComponent | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<UiSdlGraphVisualizationPresentationalComponent | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): UiSdlGraphVisualizationPresentationalComponent;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): UiSdlGraphVisualizationPresentationalComponent;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): UiSdlGraphVisualizationPresentationalComponent;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): UiSdlGraphVisualizationPresentationalComponent;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): UiSdlGraphVisualizationPresentationalComponent;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): UiSdlGraphVisualizationPresentationalComponent;
   ...
   * @see #fromString
   */
  static make(s: string | null): UiSdlGraphVisualizationPresentationalComponent | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): UiSdlGraphVisualizationPresentationalComponent;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): UiSdlGraphVisualizationPresentationalComponent;
   ...
   */
  static cachedEmptyInst(): UiSdlGraphVisualizationPresentationalComponent;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<UiSdlGraphVisualizationPresentationalComponent>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): UiSdlGraphVisualizationPresentationalComponent;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<UiSdlGraphVisualizationPresentationalComponent | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<UiSdlGraphVisualizationPresentationalComponent | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<UiSdlGraphVisualizationPresentationalComponent | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<UiSdlGraphVisualizationPresentationalComponent | null> | null>;
   ...
   */
  dependencies(): MetadataDeps<UiSdlGraphVisualizationPresentationalComponent | null>;

  save(subPath?: string | null, contentType?: string | null): UiSdlGraphVisualizationPresentationalComponent;
  ...
  update(srcObj?: UiSdlGraphVisualizationPresentationalComponent | null, spec?: UpsertSpec | null): UiSdlGraphVisualizationPresentationalComponent | null;

  upsert(srcObj?: UiSdlGraphVisualizationPresentationalComponent | null, spec?: UpsertSpec | null): UiSdlGraphVisualizationPresentationalComponent | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): UiSdlGraphVisualizationPresentationalComponent | null;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string | null, failIfMissing?: boolean): UiSdlGraphVisualizationPresentationalComponent | null;
   ...
   */
  static doDataMerge(componentId: string, dataSpecFieldName: string, dataDestinationFieldName: string, props: UiSdlGraphVisualizationPresentationalComponent, state: UiSdlReduxState): UiSdlGraphVisualizationPresentationalComponent | null;
