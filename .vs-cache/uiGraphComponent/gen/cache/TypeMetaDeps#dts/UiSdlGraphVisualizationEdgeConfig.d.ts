// TypeScript definitions for the C3 type UiSdlGraphVisualizationEdgeConfig

/**
 * The edge configuration for a graph component.
 *
 * @remarks this represents a value passed to a method that expects an instance of UiSdlGraphVisualizationEdgeConfig
 */
declare interface IUiSdlGraphVisualizationEdgeConfig {
   ...
   */
  glyphConfig?: IUiSdlGraphVisualizationEdgeGlyphConfig | null;
   ...
   */
  style?: IUiSdlGraphVisualizationEdgeStyleConfig | null;
 ...
 */
declare class UiSdlGraphVisualizationEdgeConfig extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): UiSdlGraphVisualizationEdgeConfig | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): UiSdlGraphVisualizationEdgeConfig | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): UiSdlGraphVisualizationEdgeConfig | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): UiSdlGraphVisualizationEdgeConfig | null;
   ...
   */
  replaceType(old: Type, new_: Type): UiSdlGraphVisualizationEdgeConfig;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlGraphVisualizationEdgeConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlGraphVisualizationEdgeConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlGraphVisualizationEdgeConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlGraphVisualizationEdgeConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): UiSdlGraphVisualizationEdgeConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlGraphVisualizationEdgeConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlGraphVisualizationEdgeConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): UiSdlGraphVisualizationEdgeConfig;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): UiSdlGraphVisualizationEdgeConfig;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): UiSdlGraphVisualizationEdgeConfig;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): UiSdlGraphVisualizationEdgeConfig;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): UiSdlGraphVisualizationEdgeConfig;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): UiSdlGraphVisualizationEdgeConfig;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): UiSdlGraphVisualizationEdgeConfig;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): UiSdlGraphVisualizationEdgeConfig;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): UiSdlGraphVisualizationEdgeConfig;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): UiSdlGraphVisualizationEdgeConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): UiSdlGraphVisualizationEdgeConfig;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): UiSdlGraphVisualizationEdgeConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: string): UiSdlGraphVisualizationEdgeConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): UiSdlGraphVisualizationEdgeConfig;
   ...
   * @see #removeField
   */
  unsetField(field: string): UiSdlGraphVisualizationEdgeConfig;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): UiSdlGraphVisualizationEdgeConfig;
   ...
   * @see #unsetField
   */
  removeField(field: string): UiSdlGraphVisualizationEdgeConfig;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): UiSdlGraphVisualizationEdgeConfig;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): UiSdlGraphVisualizationEdgeConfig;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): UiSdlGraphVisualizationEdgeConfig;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): UiSdlGraphVisualizationEdgeConfig;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): UiSdlGraphVisualizationEdgeConfig;

  mergeJson(json: any | null): UiSdlGraphVisualizationEdgeConfig;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): UiSdlGraphVisualizationEdgeConfig;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): UiSdlGraphVisualizationEdgeConfig;
   ...
   */
  singletonArray(): C3.Array<UiSdlGraphVisualizationEdgeConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<UiSdlGraphVisualizationEdgeConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<UiSdlGraphVisualizationEdgeConfig | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<UiSdlGraphVisualizationEdgeConfig | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<UiSdlGraphVisualizationEdgeConfig | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, UiSdlGraphVisualizationEdgeConfig | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, UiSdlGraphVisualizationEdgeConfig | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<UiSdlGraphVisualizationEdgeConfig | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<UiSdlGraphVisualizationEdgeConfig | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): UiSdlGraphVisualizationEdgeConfig;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): UiSdlGraphVisualizationEdgeConfig;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): UiSdlGraphVisualizationEdgeConfig;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): UiSdlGraphVisualizationEdgeConfig;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): UiSdlGraphVisualizationEdgeConfig;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): UiSdlGraphVisualizationEdgeConfig;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): UiSdlGraphVisualizationEdgeConfig;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): UiSdlGraphVisualizationEdgeConfig;
   ...
   */
  static cachedEmptyInst(): UiSdlGraphVisualizationEdgeConfig;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<UiSdlGraphVisualizationEdgeConfig>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): UiSdlGraphVisualizationEdgeConfig;
   ...
   */
  static getDataTypeName(dataSpec?: UiSdlGraphVisualizationEdgeConfig | null): string | null;
