// TypeScript definitions for the C3 type DataVisualizationGraph
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of DataVisualizationGraph
 */
declare interface IDataVisualizationGraph<V, E> {
 ...
 */
declare class DataVisualizationGraph<V, E> extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): DataVisualizationGraph<V, E> | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): DataVisualizationGraph<V, E> | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): DataVisualizationGraph<V, E> | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): DataVisualizationGraph<V, E> | null;
   ...
   */
  replaceType(old: Type, new_: Type): DataVisualizationGraph<V, E>;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): DataVisualizationGraph<V, E>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): DataVisualizationGraph<V, E>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<DataVisualizationGraph<V, E> | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<DataVisualizationGraph<V, E> | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): DataVisualizationGraph<V, E>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DataVisualizationGraph<V, E>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DataVisualizationGraph<V, E>;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): DataVisualizationGraph<V, E>;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): DataVisualizationGraph<V, E>;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): DataVisualizationGraph<V, E>;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): DataVisualizationGraph<V, E>;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): DataVisualizationGraph<V, E>;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): DataVisualizationGraph<V, E>;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): DataVisualizationGraph<V, E>;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): DataVisualizationGraph<V, E>;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): DataVisualizationGraph<V, E>;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): DataVisualizationGraph<V, E>;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): DataVisualizationGraph<V, E>;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): DataVisualizationGraph<V, E>;
   ...
   * @see #unsetField
   */
  defaultField(field: string): DataVisualizationGraph<V, E>;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): DataVisualizationGraph<V, E>;
   ...
   * @see #removeField
   */
  unsetField(field: string): DataVisualizationGraph<V, E>;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): DataVisualizationGraph<V, E>;
   ...
   * @see #unsetField
   */
  removeField(field: string): DataVisualizationGraph<V, E>;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): DataVisualizationGraph<V, E>;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): DataVisualizationGraph<V, E>;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): DataVisualizationGraph<V, E>;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): DataVisualizationGraph<V, E>;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): DataVisualizationGraph<V, E>;

  mergeJson(json: any | null): DataVisualizationGraph<V, E>;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): DataVisualizationGraph<V, E>;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): DataVisualizationGraph<V, E>;
   ...
   */
  singletonArray(): C3.Array<DataVisualizationGraph<V, E> | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<DataVisualizationGraph<V, E> | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<DataVisualizationGraph<V, E> | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<DataVisualizationGraph<V, E> | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<DataVisualizationGraph<V, E> | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, DataVisualizationGraph<V, E> | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, DataVisualizationGraph<V, E> | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<DataVisualizationGraph<V, E> | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<DataVisualizationGraph<V, E> | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): DataVisualizationGraph<V, E>;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): DataVisualizationGraph<V, E>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): DataVisualizationGraph<V, E>;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): DataVisualizationGraph<V, E>;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): DataVisualizationGraph<V, E>;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): DataVisualizationGraph<V, E>;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): DataVisualizationGraph<V, E>;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): DataVisualizationGraph<V, E>;
   ...
   */
  static cachedEmptyInst(): DataVisualizationGraph<V, E>;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<DataVisualizationGraph<V, E>>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): DataVisualizationGraph<V, E>;
   ...
   */
  static loadFullGraphInMemory(vertexSpec?: GraphDataSpec | null, edgeSpec?: GraphDataSpec | null, batchSize?: number | null, threads?: number | null): DataVisualizationGraph | null;
   ...
   * @return The instance of {@link DataVisualizationGraph}.
   */
  static loadFullGraph(vertexSpec?: GraphDataSpec | null, edgeSpec?: GraphDataSpec | null, batchSize?: number | null, threads?: number | null): DataVisualizationGraph | null;
   ...
   * @return The instance of {@link DataVisualizationGraph}.
   */
  static getFilteredGraph(verticesIds?: string | null, edgesIds?: string | null): DataVisualizationGraph | null;
}
