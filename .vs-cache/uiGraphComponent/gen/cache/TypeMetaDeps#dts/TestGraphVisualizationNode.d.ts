// TypeScript definitions for the C3 type TestGraphVisualizationNode

/**
 * Type to represent a test node.
 *
 * @remarks this represents a value passed to a method that expects an instance of TestGraphVisualizationNode
 */
declare interface ITestGraphVisualizationNode {
 ...
 * Type to represent a test node.
 *
 * @remarks this represents a made instance of TestGraphVisualizationNode
 */
declare class TestGraphVisualizationNode extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): TestGraphVisualizationNode | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): TestGraphVisualizationNode | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): TestGraphVisualizationNode | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): TestGraphVisualizationNode | null;
   ...
   */
  replaceType(old: Type, new_: Type): TestGraphVisualizationNode;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): TestGraphVisualizationNode;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): TestGraphVisualizationNode;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<TestGraphVisualizationNode | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<TestGraphVisualizationNode | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): TestGraphVisualizationNode;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TestGraphVisualizationNode;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TestGraphVisualizationNode;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): TestGraphVisualizationNode;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): TestGraphVisualizationNode;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): TestGraphVisualizationNode;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): TestGraphVisualizationNode;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): TestGraphVisualizationNode;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): TestGraphVisualizationNode;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): TestGraphVisualizationNode;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): TestGraphVisualizationNode;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): TestGraphVisualizationNode;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): TestGraphVisualizationNode;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): TestGraphVisualizationNode;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): TestGraphVisualizationNode;
   ...
   * @see #unsetField
   */
  defaultField(field: string): TestGraphVisualizationNode;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): TestGraphVisualizationNode;
   ...
   * @see #removeField
   */
  unsetField(field: string): TestGraphVisualizationNode;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): TestGraphVisualizationNode;
   ...
   * @see #unsetField
   */
  removeField(field: string): TestGraphVisualizationNode;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): TestGraphVisualizationNode;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): TestGraphVisualizationNode;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): TestGraphVisualizationNode;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): TestGraphVisualizationNode;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): TestGraphVisualizationNode;

  mergeJson(json: any | null): TestGraphVisualizationNode;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): TestGraphVisualizationNode;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): TestGraphVisualizationNode;
   ...
   */
  singletonArray(): C3.Array<TestGraphVisualizationNode | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<TestGraphVisualizationNode | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<TestGraphVisualizationNode | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<TestGraphVisualizationNode | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<TestGraphVisualizationNode | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, TestGraphVisualizationNode | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, TestGraphVisualizationNode | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<TestGraphVisualizationNode | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<TestGraphVisualizationNode | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): TestGraphVisualizationNode;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): TestGraphVisualizationNode;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): TestGraphVisualizationNode;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): TestGraphVisualizationNode;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): TestGraphVisualizationNode;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): TestGraphVisualizationNode;
   ...
   * @see #fromString
   */
  static make(s: string | null): TestGraphVisualizationNode | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): TestGraphVisualizationNode;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): TestGraphVisualizationNode;
   ...
   */
  static cachedEmptyInst(): TestGraphVisualizationNode;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<TestGraphVisualizationNode>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): TestGraphVisualizationNode;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<TestGraphVisualizationNode | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<TestGraphVisualizationNode | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<TestGraphVisualizationNode | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<TestGraphVisualizationNode | null> | null>;
   ...
   */
  get(include?: string | null): TestGraphVisualizationNode | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): TestGraphVisualizationNode | null;
   ...
   */
  getMissing(spec: GetMissingSpec): TestGraphVisualizationNode;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): TestGraphVisualizationNode | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): TestGraphVisualizationNode;
   ...
   * @see #toString
   */
  static fromString(s: string | null): TestGraphVisualizationNode | null;
   ...
   */
  create(spec?: UpsertSpec | null): TestGraphVisualizationNode | null;
   ...
   */
  static createBatch(objs: C3.Array<TestGraphVisualizationNode | null> | null, spec?: UpsertSpec | null): ObjList<TestGraphVisualizationNode | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<TestGraphVisualizationNode | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<TestGraphVisualizationNode | null> | null;
   ...
   */
  update(srcObj?: TestGraphVisualizationNode | null, spec?: UpsertSpec | null): TestGraphVisualizationNode | null;
   ...
   */
  upsert(srcObj?: TestGraphVisualizationNode | null, spec?: UpsertSpec | null): TestGraphVisualizationNode | null;
   ...
   */
  merge(spec?: MergeSpec | null): TestGraphVisualizationNode | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): TestGraphVisualizationNode | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): TestGraphVisualizationNode | null;
   ...
   */
  static updateBatch(objs: C3.Array<TestGraphVisualizationNode | null> | null, srcObjs?: C3.Array<TestGraphVisualizationNode | null>, spec?: UpsertSpec | null): ObjList<TestGraphVisualizationNode | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<TestGraphVisualizationNode | null>>, spec?: UpsertSpec | null): ObjList<TestGraphVisualizationNode | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<TestGraphVisualizationNode | null> | null, srcObjs?: C3.Array<TestGraphVisualizationNode | null>, spec?: UpsertSpec | null): ObjList<TestGraphVisualizationNode | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<TestGraphVisualizationNode | null>>, spec?: UpsertSpec | null): ObjList<TestGraphVisualizationNode | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<TestGraphVisualizationNode | null> | null, spec?: TouchSpec | null): ObjList<TestGraphVisualizationNode | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<TestGraphVisualizationNode | null> | null, spec?: MergeSpec | null): ObjList<TestGraphVisualizationNode | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<TestGraphVisualizationNode | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<TestGraphVisualizationNode | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<TestGraphVisualizationNode | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<TestGraphVisualizationNode | null> | null;
   ...
   */
  static mergeAll(mergeObj: TestGraphVisualizationNode | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: TestGraphVisualizationNode | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<TestGraphVisualizationNode | null> | null, spec?: UpsertSpec | null): ObjList<TestGraphVisualizationNode | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<TestGraphVisualizationNode | null> | null, spec?: UpsertSpec | null): ObjList<TestGraphVisualizationNode | null> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): TestGraphVisualizationNode | null;
   ...
   */
  static beforeCreate(objs: C3.Array<TestGraphVisualizationNode | null> | null): ObjList<TestGraphVisualizationNode | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<TestGraphVisualizationNode | null> | null): ObjList<TestGraphVisualizationNode | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<TestGraphVisualizationNode | null> | null): ObjList<TestGraphVisualizationNode | null>;
   ...
   */
  static afterCreate(objs: C3.Array<TestGraphVisualizationNode | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<TestGraphVisualizationNode | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<TestGraphVisualizationNode | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<TestGraphVisualizationNode | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<TestGraphVisualizationNode | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): TestGraphVisualizationNode | null;
   ...
   */
  withoutIdentity(): TestGraphVisualizationNode | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<TestGraphVisualizationNode | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: TestGraphVisualizationNode | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<TestGraphVisualizationNode | null> | null, callback?: λFunction<TestGraphVisualizationNode | null, TestGraphVisualizationNode | null> | null): ObjList<TestGraphVisualizationNode | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<TestGraphVisualizationNode | null> | null, callback?: λFunction<TestGraphVisualizationNode | null, TestGraphVisualizationNode | null> | null): C3.Array<ObjError | null>;
