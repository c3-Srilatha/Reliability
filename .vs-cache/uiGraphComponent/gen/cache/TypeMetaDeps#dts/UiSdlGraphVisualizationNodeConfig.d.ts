// TypeScript definitions for the C3 type UiSdlGraphVisualizationNodeConfig

/**
 * The node data spec configuration for a graph component.
 *
 * @remarks this represents a value passed to a method that expects an instance of UiSdlGraphVisualizationNodeConfig
 */
declare interface IUiSdlGraphVisualizationNodeConfig {
   ...
   */
  coordinatesConfig?: IUiSdlGraphVisualizationNodeCoordinatesConfig | null;
   ...
   */
  donutConfig?: IUiSdlGraphVisualizationNodeSegmentDonutConfig | null | IUiSdlGraphVisualizationNodePercentageDonutConfig | null | null;

  /**
   * The configuration for the node glyphs.
   */
  glyphConfig?: IUiSdlGraphVisualizationNodeGlyphConfig | null;

  /**
   * The configuration for the node tooltip.
   */
  tooltipConfig?: IUiSdlGraphVisualizationTooltipConfig | null;

  /**
   * The configuration for the node style.
   */
  style?: IUiSdlGraphVisualizationNodeStyleConfig | null;

  /**
   * Actions to be displayed in a context menu, when the node is right-clicked.
   */
  contextMenuConfig?: C3.Array<UiSdlAction | null> | Array<IUiSdlAction | null>;
}
 ...
 */
declare class UiSdlGraphVisualizationNodeConfig extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): UiSdlGraphVisualizationNodeConfig | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): UiSdlGraphVisualizationNodeConfig | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): UiSdlGraphVisualizationNodeConfig | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): UiSdlGraphVisualizationNodeConfig | null;
   ...
   */
  replaceType(old: Type, new_: Type): UiSdlGraphVisualizationNodeConfig;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlGraphVisualizationNodeConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlGraphVisualizationNodeConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlGraphVisualizationNodeConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlGraphVisualizationNodeConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): UiSdlGraphVisualizationNodeConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlGraphVisualizationNodeConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlGraphVisualizationNodeConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): UiSdlGraphVisualizationNodeConfig;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): UiSdlGraphVisualizationNodeConfig;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): UiSdlGraphVisualizationNodeConfig;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): UiSdlGraphVisualizationNodeConfig;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): UiSdlGraphVisualizationNodeConfig;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): UiSdlGraphVisualizationNodeConfig;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): UiSdlGraphVisualizationNodeConfig;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): UiSdlGraphVisualizationNodeConfig;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): UiSdlGraphVisualizationNodeConfig;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): UiSdlGraphVisualizationNodeConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): UiSdlGraphVisualizationNodeConfig;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): UiSdlGraphVisualizationNodeConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: string): UiSdlGraphVisualizationNodeConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): UiSdlGraphVisualizationNodeConfig;
   ...
   * @see #removeField
   */
  unsetField(field: string): UiSdlGraphVisualizationNodeConfig;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): UiSdlGraphVisualizationNodeConfig;
   ...
   * @see #unsetField
   */
  removeField(field: string): UiSdlGraphVisualizationNodeConfig;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): UiSdlGraphVisualizationNodeConfig;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): UiSdlGraphVisualizationNodeConfig;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): UiSdlGraphVisualizationNodeConfig;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): UiSdlGraphVisualizationNodeConfig;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): UiSdlGraphVisualizationNodeConfig;

  mergeJson(json: any | null): UiSdlGraphVisualizationNodeConfig;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): UiSdlGraphVisualizationNodeConfig;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): UiSdlGraphVisualizationNodeConfig;
   ...
   */
  singletonArray(): C3.Array<UiSdlGraphVisualizationNodeConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<UiSdlGraphVisualizationNodeConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<UiSdlGraphVisualizationNodeConfig | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<UiSdlGraphVisualizationNodeConfig | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<UiSdlGraphVisualizationNodeConfig | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, UiSdlGraphVisualizationNodeConfig | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, UiSdlGraphVisualizationNodeConfig | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<UiSdlGraphVisualizationNodeConfig | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<UiSdlGraphVisualizationNodeConfig | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): UiSdlGraphVisualizationNodeConfig;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): UiSdlGraphVisualizationNodeConfig;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): UiSdlGraphVisualizationNodeConfig;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): UiSdlGraphVisualizationNodeConfig;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): UiSdlGraphVisualizationNodeConfig;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): UiSdlGraphVisualizationNodeConfig;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): UiSdlGraphVisualizationNodeConfig;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): UiSdlGraphVisualizationNodeConfig;
   ...
   */
  static cachedEmptyInst(): UiSdlGraphVisualizationNodeConfig;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<UiSdlGraphVisualizationNodeConfig>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): UiSdlGraphVisualizationNodeConfig;
   ...
   */
  static getDataTypeName(dataSpec?: UiSdlGraphVisualizationNodeConfig | null): string | null;
