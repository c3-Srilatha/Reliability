...
# Python definitions for the C3 type UiSdlGraphVisualizationDefaultFitOptionOnSelect


class UiSdlGraphVisualizationDefaultFitOptionOnSelect():
    """
    ...
    """
    def __init__(self, AUTO: Optional[str]=None, NONE: Optional[str]=None, ALL: Optional[str]=None, SELECTION: Optional[str]=None) -> None: ...
