...
from c3.testtools.CanonicalReplicationSpec import CanonicalReplicationSpec
...
# Python definitions for the C3 type DataReplicatorSpec


class DataReplicatorSpec():
    """
    Spec that configures the replication, post-replication and sanity check processes during setup
    
    @remarks this represents a made instance of DataReplicatorSpec
    """
    ...
    """
    The start of the replication period
    """

    end: Optional[datetime]
    """
    The end of the replication period
    """

    data: Optional[Array[CanonicalReplicationSpec]]
    """
    Array of {@link CanonicalReplicationSpec} that specifies replication logic for canonicals
    """

    postReplication: Optional[Callable[[Union[datetime], Union[datetime]]]]=None
    """
    Logic for post-replication process
    @param start The start of the replication period
    @param end The end of the replication period
    """

    sanityCheck: Optional[Callable[[Union[datetime], Union[datetime]], bool]]=None
    """
    Logic for sanity check process.
    @param start The start of the replication period
    @param end The end of the replication period
    @return True if sanity check passes successfully, false otherwise
    """
    def __init__(self, id: Optional[str]=None, versionEdits: Optional[Array[VersionEdit]]=None, name: Optional[str]=None, meta: Optional[Meta]=None, version: Optional[int]=None, typeWithBindings: Optional[Type]=None, start: Optional[datetime]=None, end: Optional[datetime]=None, data: Optional[Array[CanonicalReplicationSpec]]=None, postReplication: Optional[Callable[[Union[datetime], Union[datetime]]]]=None, sanityCheck: Optional[Callable[[Union[datetime], Union[datetime]], bool]]=None) -> None: ...
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[DataReplicatorSpec]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[DataReplicatorSpec]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[DataReplicatorSpec]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[DataReplicatorSpec]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> DataReplicatorSpec:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> DataReplicatorSpec:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> DataReplicatorSpec:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[DataReplicatorSpec]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[DataReplicatorSpec]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> DataReplicatorSpec:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> DataReplicatorSpec:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> DataReplicatorSpec:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> DataReplicatorSpec:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> DataReplicatorSpec:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> DataReplicatorSpec:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> DataReplicatorSpec:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> DataReplicatorSpec:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> DataReplicatorSpec:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> DataReplicatorSpec:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> DataReplicatorSpec:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> DataReplicatorSpec:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> DataReplicatorSpec:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> DataReplicatorSpec:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> DataReplicatorSpec:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> DataReplicatorSpec:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> DataReplicatorSpec:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> DataReplicatorSpec:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> DataReplicatorSpec:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> DataReplicatorSpec:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> DataReplicatorSpec:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> DataReplicatorSpec:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> DataReplicatorSpec:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> DataReplicatorSpec:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> DataReplicatorSpec:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> DataReplicatorSpec:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> DataReplicatorSpec:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> DataReplicatorSpec:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[DataReplicatorSpec]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[DataReplicatorSpec]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[DataReplicatorSpec]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[DataReplicatorSpec]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[DataReplicatorSpec]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, DataReplicatorSpec]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, DataReplicatorSpec]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[DataReplicatorSpec]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[DataReplicatorSpec]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> DataReplicatorSpec:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> DataReplicatorSpec:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> DataReplicatorSpec:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> DataReplicatorSpec:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> DataReplicatorSpec:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> DataReplicatorSpec:
    """
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[DataReplicatorSpec]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> DataReplicatorSpec:
    """
    ...
    """
        ...
    def afterMake(self) -> DataReplicatorSpec:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> DataReplicatorSpec:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[DataReplicatorSpec]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> DataReplicatorSpec:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, spec: FetchSpec=None) -> FetchResult[DataReplicatorSpec]:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, filter: Filter) -> FetchResult[DataReplicatorSpec]:
    """
    ...
    """
        ...
    @classmethod
    def fetchObjStream(cls, spec: FetchStreamSpec=None) -> Union[Stream[DataReplicatorSpec]]:
    """
    Fetches multiple obj instances based on a specification.  Only objs that the caller is authorized to fetch will be
    returned.
    ...
    """
        ...
    @classmethod
    def fetchMultiLocale(cls, spec: MultiLocaleFetchSpec=None) -> Union[Map[str, FetchResult[DataReplicatorSpec]]]:
    """
    ...
    """
        ...
    def get(self, include: str=None) -> Union[DataReplicatorSpec]:
    """
    ...
    """
        ...
    def getSpecific(self, include: str=None) -> Union[DataReplicatorSpec]:
    """
    ...
    """
        ...
    def getMissing(self, spec: GetMissingSpec) -> DataReplicatorSpec:
    """
    ...
    """
        ...
    def getDirect(self, include: str=None) -> Union[DataReplicatorSpec]:
    """
    ...
    """
        ...
    def applyReverseEdit(self, versionEdit: VersionEdit) -> DataReplicatorSpec:
    """
    ...
    """
        ...
    @classmethod
    def fromString(cls, s: str) -> Union[DataReplicatorSpec]:
    """
    ...
    """
        ...
    def create(self, spec: UpsertSpec=None) -> Union[DataReplicatorSpec]:
    """
    ...
    """
        ...
    @classmethod
    def createBatch(cls, objs: Array[DataReplicatorSpec], spec: UpsertSpec=None) -> Union[ObjList[DataReplicatorSpec]]:
    """
    ...
    """
        ...
    @classmethod
    def createBatchObjStream(cls, objs: Stream[DataReplicatorSpec], spec: CreateBatchObjStreamSpec=None) -> Union[ObjList[DataReplicatorSpec]]:
    """
    Creates multiple instances of a C3 type. If the operation fails and {@link UpsertSpec#dontThrowOnBatchError} is not
    specified (the default), then a C3BatchException will be thrown.  Otherwise {@link errors will be reported in the
    returned {@link ObjList}.  This will fail if any of the instances already exist.
    ...
    """
        ...
    def update(self, srcObj: DataReplicatorSpec=None, spec: UpsertSpec=None) -> Union[DataReplicatorSpec]:
    """
    ...
    """
        ...
    def upsert(self, srcObj: DataReplicatorSpec=None, spec: UpsertSpec=None) -> Union[DataReplicatorSpec]:
    """
    ...
    """
        ...
    @overload
    def merge(self, spec: MergeSpec=None) -> Union[DataReplicatorSpec]:
    """
    ...
    """
        ...
    @overload
    def merge(self, mergeInclude: str, spec: MergeSpec=None) -> Union[DataReplicatorSpec]:
    """
    ...
    """
        ...
    def touch(self, spec: TouchSpec=None) -> Union[DataReplicatorSpec]:
    """
    ...
    """
        ...
    @classmethod
    def updateBatch(cls, objs: Array[DataReplicatorSpec], srcObjs: Array[DataReplicatorSpec]=None, spec: UpsertSpec=None) -> Union[ObjList[DataReplicatorSpec]]:
    """
    ...
    """
        ...
    @classmethod
    def updateObjs(cls, objs: Callable[[], Union[Array[DataReplicatorSpec]]], spec: UpsertSpec=None) -> Union[ObjList[DataReplicatorSpec]]:
    """
    ...
    """
        ...
    @classmethod
    def upsertBatch(cls, objs: Array[DataReplicatorSpec], srcObjs: Array[DataReplicatorSpec]=None, spec: UpsertSpec=None) -> Union[ObjList[DataReplicatorSpec]]:
    """
    ...
    """
        ...
    @classmethod
    def upsertObjs(cls, objs: Callable[[], Union[Array[DataReplicatorSpec]]], spec: UpsertSpec=None) -> Union[ObjList[DataReplicatorSpec]]:
    """
    Creates instances of a C3 type if they don't already exist and updates them if they do exist. If the operation
    ...
    """
        ...
    @classmethod
    def touchBatch(cls, objs: Array[DataReplicatorSpec], spec: TouchSpec=None) -> Union[ObjList[DataReplicatorSpec]]:
    """
    ...
    @overload
    @classmethod
    def mergeBatch(cls, objs: Array[DataReplicatorSpec], spec: MergeSpec=None) -> Union[ObjList[DataReplicatorSpec]]:
    """
    ...
    @overload
    @classmethod
    def mergeBatch(cls, objs: Array[DataReplicatorSpec], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[DataReplicatorSpec]]:
    """
    Merges multiple instances of a C3 type or creates them if they don't exist. If the operation fails and {@link
    UpsertSpec#dontThrowOnBatchError} is not specified (the default), then a C3BatchException will be thrown.
    Otherwise errors will be reported in the returned {@link ObjList}.  The merge operation is described in the {@link
    ...
    """
        ...
    @classmethod
    def mergeObjs(cls, objs: Callable[[], Union[Array[DataReplicatorSpec]]], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[DataReplicatorSpec]]:
    """
    ...
    @overload
    @classmethod
    def mergeAll(cls, mergeObj: DataReplicatorSpec, spec: MergeAllSpec=None) -> Union[int]:
    """
    ...
    @overload
    @classmethod
    def mergeAll(cls, mergeObj: DataReplicatorSpec, mergeInclude: str, spec: MergeAllSpec=None) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def removeBatch(cls, objs: Array[DataReplicatorSpec], spec: UpsertSpec=None) -> Union[ObjList[DataReplicatorSpec]]:
    """
    ...
    """
        ...
    @classmethod
    def replace(cls, objs: Array[DataReplicatorSpec], spec: UpsertSpec=None) -> Union[ObjList[DataReplicatorSpec]]:
    """
    ...
    """
        ...
    def unremove(self) -> Union[DataReplicatorSpec]:
    """
    ...
    """
        ...
    @classmethod
    def beforeCreate(cls, objs: Array[DataReplicatorSpec]) -> ObjList[DataReplicatorSpec]:
    """
    ...
    """
        ...
    @classmethod
    def beforeUpdate(cls, objs: Array[DataReplicatorSpec]) -> ObjList[DataReplicatorSpec]:
    """
    ...
    """
        ...
    @classmethod
    def beforeRemove(cls, objs: Array[DataReplicatorSpec]) -> ObjList[DataReplicatorSpec]:
    """
    ...
    """
        ...
    @classmethod
    def afterCreate(cls, objs: Array[DataReplicatorSpec]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def afterUpdate(cls, objs: Array[DataReplicatorSpec]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def afterRemove(cls, objs: Array[DataReplicatorSpec]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def startImportData(cls, spec: StartImportDataSpec=None) -> PushStream[DataReplicatorSpec]:
    """
    @return a push stream to import instances of this type.
    """
        ...
    @classmethod
    def startImportDataWithStats(cls, spec: StartImportDataSpec=None) -> PushStreamWithStats[DataReplicatorSpec]:
    """
    @return a push stream to import instances of this type.
    """
        ...
    ...
    """
        ...
    @classmethod
    def forId(cls, id: str, failIfMissing: bool=None) -> Union[DataReplicatorSpec]:
    """
    ...
    """
        ...
    def withoutIdentity(self) -> Union[DataReplicatorSpec]:
    """
    ...
    """
        ...
    @classmethod
    def typeOfBatch(cls, objs: Array[DataReplicatorSpec]) -> Union[Array[EntityType]]:
    """
    ...
    """
        ...
    @classmethod
    def dbEcho(cls, template: DataReplicatorSpec=None, count: int=None, sendBack: bool=None) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def callbackLogic(cls, objs: Array[DataReplicatorSpec], callback: Callable[[Union[DataReplicatorSpec]], Union[DataReplicatorSpec]]=None) -> ObjList[DataReplicatorSpec]:
    """
    ...
    """
        ...
    @classmethod
    def afterCallbackLogic(cls, objs: Array[DataReplicatorSpec], callback: Callable[[Union[DataReplicatorSpec]], Union[DataReplicatorSpec]]=None) -> Union[Array[ObjError]]:
    """
