...
from c3.testtools.TestApiObj import TestApiObj
...
from c3.testtools.TestApiTearDownFilter import TestApiTearDownFilter
...
# Python definitions for the C3 type TestApiContext
...
class TestApiContext():
    ...
    @remarks this represents a made instance of TestApiContext
    """
    ...
    setupOK: Optional[bool]=None
    """
    Set to false if we timeout in waitFor...
    """

    localeChanged: Optional[bool]=None
    """
    Has the context's locale change
    """

    originalLocale: Optional[str]=None
    """
    The original locale in this context
    """

    removeLimit: Optional[int]=None
    """
    Max number of entities you can remove with external filter
    """

    parent: Optional[TestApiContext]=None
    """
    Parent context
    """

    failOnQueueErrors: Optional[bool]=None
    """
    Fail a test if a queue error is detected
    """

    waitForTeardown: Optional[int]=None
    """
    Call waitForSetup on teardown for _waitForTeardown seconds
    """

    queueBlacklist: Optional[Array[Type]]=None
    """
    Don't check these queues in waitForSetup
    """

    tryToRecover: Optional[int]=None
    """
    A number of attempts to recover
    """

    fsFiles: Optional[Array[str]]=None
    """
    FileSystem (e.g. S3 or Azure) file names
    """

    mocks: Optional[Array[Action.Spy]]=None
    """
    ActionMocks that have been registered with this context.
    """

    testApiObjs: Optional[Array[TestApiObj]]=None
    """
    TestApiObjs
    """

    testUsers: Optional[Array[str]]=None
    """
    An array of TestApiObj ids for {@link User}s created using this test context
    """

    teardownFilters: Optional[Array[TestApiTearDownFilter]]=None
    """
    Filters for tearing down
    """

    uuidCounter: Optional[int]=None
    """
    Counter for creating unique ids or names for test objects
    """

    c3Queues: Optional[Array[Type]]=None
    """
    c3 queues
    """

    vanityHostname: Optional[str]=None
    """
    Hostname for vanity url (private)
    """
    def __init__(self, id: Optional[str]=None, versionEdits: Optional[Array[VersionEdit]]=None, name: Optional[str]=None, meta: Optional[Meta]=None, version: Optional[int]=None, typeWithBindings: Optional[Type]=None, filename: Optional[str]=None, debugEnabled: Optional[bool]=None, setupOK: Optional[bool]=None, localeChanged: Optional[bool]=None, originalLocale: Optional[str]=None, removeLimit: Optional[int]=None, parent: Optional[TestApiContext]=None, failOnQueueErrors: Optional[bool]=None, waitForTeardown: Optional[int]=None, queueBlacklist: Optional[Array[Type]]=None, tryToRecover: Optional[int]=None, fsFiles: Optional[Array[str]]=None, mocks: Optional[Array[Action.Spy]]=None, testApiObjs: Optional[Array[TestApiObj]]=None, testUsers: Optional[Array[str]]=None, teardownFilters: Optional[Array[TestApiTearDownFilter]]=None, uuidCounter: Optional[int]=None, c3Queues: Optional[Array[Type]]=None, vanityHostname: Optional[str]=None) -> None: ...
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[TestApiContext]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[TestApiContext]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[TestApiContext]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[TestApiContext]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> TestApiContext:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> TestApiContext:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> TestApiContext:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[TestApiContext]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[TestApiContext]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> TestApiContext:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> TestApiContext:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> TestApiContext:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> TestApiContext:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> TestApiContext:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> TestApiContext:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> TestApiContext:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> TestApiContext:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> TestApiContext:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> TestApiContext:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> TestApiContext:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> TestApiContext:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> TestApiContext:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> TestApiContext:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> TestApiContext:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> TestApiContext:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> TestApiContext:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> TestApiContext:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> TestApiContext:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> TestApiContext:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> TestApiContext:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> TestApiContext:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> TestApiContext:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> TestApiContext:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> TestApiContext:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> TestApiContext:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> TestApiContext:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> TestApiContext:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[TestApiContext]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[TestApiContext]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[TestApiContext]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[TestApiContext]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[TestApiContext]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, TestApiContext]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, TestApiContext]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[TestApiContext]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[TestApiContext]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> TestApiContext:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> TestApiContext:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> TestApiContext:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> TestApiContext:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> TestApiContext:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> TestApiContext:
    """
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[TestApiContext]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> TestApiContext:
    """
    ...
    """
        ...
    def afterMake(self) -> TestApiContext:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> TestApiContext:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[TestApiContext]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> TestApiContext:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, spec: FetchSpec=None) -> FetchResult[TestApiContext]:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, filter: Filter) -> FetchResult[TestApiContext]:
    """
    ...
    """
        ...
    @classmethod
    def fetchObjStream(cls, spec: FetchStreamSpec=None) -> Union[Stream[TestApiContext]]:
    """
    Fetches multiple obj instances based on a specification.  Only objs that the caller is authorized to fetch will be
    returned.
    ...
    """
        ...
    @classmethod
    def fetchMultiLocale(cls, spec: MultiLocaleFetchSpec=None) -> Union[Map[str, FetchResult[TestApiContext]]]:
    """
    ...
    """
        ...
    def get(self, include: str=None) -> Union[TestApiContext]:
    """
    ...
    """
        ...
    def getSpecific(self, include: str=None) -> Union[TestApiContext]:
    """
    ...
    """
        ...
    def getMissing(self, spec: GetMissingSpec) -> TestApiContext:
    """
    ...
    """
        ...
    def getDirect(self, include: str=None) -> Union[TestApiContext]:
    """
    ...
    """
        ...
    def applyReverseEdit(self, versionEdit: VersionEdit) -> TestApiContext:
    """
    ...
    """
        ...
    @classmethod
    def fromString(cls, s: str) -> Union[TestApiContext]:
    """
    ...
    """
        ...
    def create(self, spec: UpsertSpec=None) -> Union[TestApiContext]:
    """
    ...
    """
        ...
    @classmethod
    def createBatch(cls, objs: Array[TestApiContext], spec: UpsertSpec=None) -> Union[ObjList[TestApiContext]]:
    """
    ...
    """
        ...
    @classmethod
    def createBatchObjStream(cls, objs: Stream[TestApiContext], spec: CreateBatchObjStreamSpec=None) -> Union[ObjList[TestApiContext]]:
    """
    Creates multiple instances of a C3 type. If the operation fails and {@link UpsertSpec#dontThrowOnBatchError} is not
    specified (the default), then a C3BatchException will be thrown.  Otherwise {@link errors will be reported in the
    returned {@link ObjList}.  This will fail if any of the instances already exist.
    ...
    """
        ...
    def update(self, srcObj: TestApiContext=None, spec: UpsertSpec=None) -> Union[TestApiContext]:
    """
    ...
    """
        ...
    def upsert(self, srcObj: TestApiContext=None, spec: UpsertSpec=None) -> Union[TestApiContext]:
    """
    ...
    """
        ...
    @overload
    def merge(self, spec: MergeSpec=None) -> Union[TestApiContext]:
    """
    ...
    """
        ...
    @overload
    def merge(self, mergeInclude: str, spec: MergeSpec=None) -> Union[TestApiContext]:
    """
    ...
    """
        ...
    def touch(self, spec: TouchSpec=None) -> Union[TestApiContext]:
    """
    ...
    """
        ...
    @classmethod
    def updateBatch(cls, objs: Array[TestApiContext], srcObjs: Array[TestApiContext]=None, spec: UpsertSpec=None) -> Union[ObjList[TestApiContext]]:
    """
    ...
    """
        ...
    @classmethod
    def updateObjs(cls, objs: Callable[[], Union[Array[TestApiContext]]], spec: UpsertSpec=None) -> Union[ObjList[TestApiContext]]:
    """
    ...
    """
        ...
    @classmethod
    def upsertBatch(cls, objs: Array[TestApiContext], srcObjs: Array[TestApiContext]=None, spec: UpsertSpec=None) -> Union[ObjList[TestApiContext]]:
    """
    ...
    """
        ...
    @classmethod
    def upsertObjs(cls, objs: Callable[[], Union[Array[TestApiContext]]], spec: UpsertSpec=None) -> Union[ObjList[TestApiContext]]:
    """
    Creates instances of a C3 type if they don't already exist and updates them if they do exist. If the operation
    ...
    """
        ...
    @classmethod
    def touchBatch(cls, objs: Array[TestApiContext], spec: TouchSpec=None) -> Union[ObjList[TestApiContext]]:
    """
    ...
    @overload
    @classmethod
    def mergeBatch(cls, objs: Array[TestApiContext], spec: MergeSpec=None) -> Union[ObjList[TestApiContext]]:
    """
    ...
    @overload
    @classmethod
    def mergeBatch(cls, objs: Array[TestApiContext], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[TestApiContext]]:
    """
    Merges multiple instances of a C3 type or creates them if they don't exist. If the operation fails and {@link
    UpsertSpec#dontThrowOnBatchError} is not specified (the default), then a C3BatchException will be thrown.
    Otherwise errors will be reported in the returned {@link ObjList}.  The merge operation is described in the {@link
    ...
    """
        ...
    @classmethod
    def mergeObjs(cls, objs: Callable[[], Union[Array[TestApiContext]]], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[TestApiContext]]:
    """
    ...
    @overload
    @classmethod
    def mergeAll(cls, mergeObj: TestApiContext, spec: MergeAllSpec=None) -> Union[int]:
    """
    ...
    @overload
    @classmethod
    def mergeAll(cls, mergeObj: TestApiContext, mergeInclude: str, spec: MergeAllSpec=None) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def removeBatch(cls, objs: Array[TestApiContext], spec: UpsertSpec=None) -> Union[ObjList[TestApiContext]]:
    """
    ...
    """
        ...
    @classmethod
    def replace(cls, objs: Array[TestApiContext], spec: UpsertSpec=None) -> Union[ObjList[TestApiContext]]:
    """
    ...
    """
        ...
    def unremove(self) -> Union[TestApiContext]:
    """
    ...
    """
        ...
    @classmethod
    def beforeCreate(cls, objs: Array[TestApiContext]) -> ObjList[TestApiContext]:
    """
    ...
    """
        ...
    @classmethod
    def beforeUpdate(cls, objs: Array[TestApiContext]) -> ObjList[TestApiContext]:
    """
    ...
    """
        ...
    @classmethod
    def beforeRemove(cls, objs: Array[TestApiContext]) -> ObjList[TestApiContext]:
    """
    ...
    """
        ...
    @classmethod
    def afterCreate(cls, objs: Array[TestApiContext]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def afterUpdate(cls, objs: Array[TestApiContext]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def afterRemove(cls, objs: Array[TestApiContext]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def startImportData(cls, spec: StartImportDataSpec=None) -> PushStream[TestApiContext]:
    """
    @return a push stream to import instances of this type.
    """
        ...
    @classmethod
    def startImportDataWithStats(cls, spec: StartImportDataSpec=None) -> PushStreamWithStats[TestApiContext]:
    """
    @return a push stream to import instances of this type.
    """
        ...
    ...
    """
        ...
    @classmethod
    def forId(cls, id: str, failIfMissing: bool=None) -> Union[TestApiContext]:
    """
    ...
    """
        ...
    def withoutIdentity(self) -> Union[TestApiContext]:
    """
    ...
    """
        ...
    @classmethod
    def typeOfBatch(cls, objs: Array[TestApiContext]) -> Union[Array[EntityType]]:
    """
    ...
    """
        ...
    @classmethod
    def dbEcho(cls, template: TestApiContext=None, count: int=None, sendBack: bool=None) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def callbackLogic(cls, objs: Array[TestApiContext], callback: Callable[[Union[TestApiContext]], Union[TestApiContext]]=None) -> ObjList[TestApiContext]:
    """
    ...
    """
        ...
    @classmethod
    def afterCallbackLogic(cls, objs: Array[TestApiContext], callback: Callable[[Union[TestApiContext]], Union[TestApiContext]]=None) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    def contextID(self) -> Union[str]:
    """
    Return the unique identifier for this context.
    @return unique context identifier
    """
        ...
    def uuid(self, uuidCounterValue: int=None) -> Union[str]:
    """
    Generate a unique id starting with the contextID
    @return unique identifier
    """
        ...
    def reserveUuids(self, count: int) -> Union[int]:
        ...
    def uniqueName(self, name: str=None, uuidCounterValue: int=None) -> Union[str]:
    """
    ...
    """
        ...
    def findObjectById(self, id: str, typeRef: Type) -> Union[TestApiObj]:
    """
    ...
    """
        ...
    def removeObjectById(self, id: str, typeRef: Type) -> Union[int]:
    """
    ...
    """
        ...
    def removeObjectByParent(self, id: str, typeRef: Type) -> Union[int]:
    """
    ...
    """
        ...
    def addTeardownFilter(self, filter: str=None, typeRef: Type=None, limit: int=None) -> None:
    """
    ...
    """
        ...
    def getTeardownFilters(self) -> Union[Array[TestApiTearDownFilter]]:
    """
    ...
    """
        ...
    def setRemoveLimit(self, limit: int=None) -> None:
    """
    ...
    """
        ...
    def getRemoveLimit(self) -> Union[int]:
    """
    ...
    """
        ...
    def setDebug(self, debug: bool=None) -> None:
    """
    ...
    """
        ...
    def printQueueInformation(self) -> None:
    """
    Print message listing what queues are enabled/disabled.
    """
        ...
    def disableQueues(self, queues: Array[Type]=None) -> None:
    """
    ...
    """
        ...
    def enableQueues(self, queues: Array[Type]=None) -> None:
    """
    ...
    """
        ...
    def getQueueBlacklist(self) -> Union[Array[Type]]:
    """
    Return list of blacklisted (disabled) queues
    @return
    """
        ...
    def setSetupOK(self, ok: bool=None) -> None:
    """
    ...
    """
        ...
    def getParent(self) -> Union[TestApiContext]:
    """
    Return the parent context
    @return
    """
        ...
    def setFailOnQueueErrors(self, failOnQueueErrors: bool=None) -> None:
    """
    Enable/disable failing a test if queue errors have been detected
    @param failOnQueueErrors
    """
        ...
    def isFailOnQueueErrors(self) -> bool:
    """
    ...
    """
        ...
    def setWaitForTeardown(self, waitForTeardown: int=None) -> None:
    """
    ...
    """
        ...
    def getWaitForTeardown(self) -> Union[int]:
    """
    ...
    """
        ...
    def getFileNames(self) -> Union[Array[str]]:
    """
    Return list of FileSystem (e.g. S3 or Azure) files associated with the context
    @return [string]
    """
        ...
    def getVanityUrl(self) -> str:
    """
    Vanity url
    """
        ...
    def setField(self, fieldName: str=None, value: Any=None) -> None:
        ...
