// TypeScript definitions for the C3 type MetricProfileSpec

/**
 * @remarks this represents a value passed to a method that expects an instance of MetricProfileSpec
 */
declare interface IMetricProfileSpec {
  ...
  parent?: IMetricProfilerSpec | null;
 ...
 */
declare class MetricProfileSpec extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): MetricProfileSpec | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): MetricProfileSpec | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): MetricProfileSpec | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): MetricProfileSpec | null;
   ...
   */
  replaceType(old: Type, new_: Type): MetricProfileSpec;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): MetricProfileSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): MetricProfileSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<MetricProfileSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<MetricProfileSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): MetricProfileSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): MetricProfileSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): MetricProfileSpec;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): MetricProfileSpec;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): MetricProfileSpec;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): MetricProfileSpec;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): MetricProfileSpec;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): MetricProfileSpec;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): MetricProfileSpec;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): MetricProfileSpec;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): MetricProfileSpec;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): MetricProfileSpec;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): MetricProfileSpec;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): MetricProfileSpec;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): MetricProfileSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: string): MetricProfileSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): MetricProfileSpec;
   ...
   * @see #removeField
   */
  unsetField(field: string): MetricProfileSpec;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): MetricProfileSpec;
   ...
   * @see #unsetField
   */
  removeField(field: string): MetricProfileSpec;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): MetricProfileSpec;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): MetricProfileSpec;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): MetricProfileSpec;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): MetricProfileSpec;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): MetricProfileSpec;

  mergeJson(json: any | null): MetricProfileSpec;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): MetricProfileSpec;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): MetricProfileSpec;
   ...
   */
  singletonArray(): C3.Array<MetricProfileSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<MetricProfileSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<MetricProfileSpec | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<MetricProfileSpec | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<MetricProfileSpec | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, MetricProfileSpec | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, MetricProfileSpec | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<MetricProfileSpec | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<MetricProfileSpec | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): MetricProfileSpec;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): MetricProfileSpec;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): MetricProfileSpec;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): MetricProfileSpec;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): MetricProfileSpec;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): MetricProfileSpec;
   ...
   * @see #fromString
   */
  static make(s: string | null): MetricProfileSpec | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): MetricProfileSpec;
   ...
   */
  static cachedEmptyInst(): MetricProfileSpec;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<MetricProfileSpec>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): MetricProfileSpec;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<MetricProfileSpec | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<MetricProfileSpec | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<MetricProfileSpec | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<MetricProfileSpec | null> | null>;
   ...
   */
  get(include?: string | null): MetricProfileSpec | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): MetricProfileSpec | null;
   ...
   */
  getMissing(spec: GetMissingSpec): MetricProfileSpec;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): MetricProfileSpec | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): MetricProfileSpec;
   ...
   * @see #toString
   */
  static fromString(s: string | null): MetricProfileSpec | null;
   ...
   */
  create(spec?: UpsertSpec | null): MetricProfileSpec | null;
   ...
   */
  static createBatch(objs: C3.Array<MetricProfileSpec | null> | null, spec?: UpsertSpec | null): ObjList<MetricProfileSpec | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<MetricProfileSpec | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<MetricProfileSpec | null> | null;
   ...
   */
  update(srcObj?: MetricProfileSpec | null, spec?: UpsertSpec | null): MetricProfileSpec | null;
   ...
   */
  upsert(srcObj?: MetricProfileSpec | null, spec?: UpsertSpec | null): MetricProfileSpec | null;
   ...
   */
  merge(spec?: MergeSpec | null): MetricProfileSpec | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): MetricProfileSpec | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): MetricProfileSpec | null;
   ...
   */
  static updateBatch(objs: C3.Array<MetricProfileSpec | null> | null, srcObjs?: C3.Array<MetricProfileSpec | null>, spec?: UpsertSpec | null): ObjList<MetricProfileSpec | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<MetricProfileSpec | null>>, spec?: UpsertSpec | null): ObjList<MetricProfileSpec | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<MetricProfileSpec | null> | null, srcObjs?: C3.Array<MetricProfileSpec | null>, spec?: UpsertSpec | null): ObjList<MetricProfileSpec | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<MetricProfileSpec | null>>, spec?: UpsertSpec | null): ObjList<MetricProfileSpec | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<MetricProfileSpec | null> | null, spec?: TouchSpec | null): ObjList<MetricProfileSpec | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<MetricProfileSpec | null> | null, spec?: MergeSpec | null): ObjList<MetricProfileSpec | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<MetricProfileSpec | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<MetricProfileSpec | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<MetricProfileSpec | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<MetricProfileSpec | null> | null;
   ...
   */
  static mergeAll(mergeObj: MetricProfileSpec | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: MetricProfileSpec | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<MetricProfileSpec | null> | null, spec?: UpsertSpec | null): ObjList<MetricProfileSpec | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<MetricProfileSpec | null> | null, spec?: UpsertSpec | null): ObjList<MetricProfileSpec | null> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): MetricProfileSpec | null;
   ...
   */
  static beforeCreate(objs: C3.Array<MetricProfileSpec | null> | null): ObjList<MetricProfileSpec | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<MetricProfileSpec | null> | null): ObjList<MetricProfileSpec | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<MetricProfileSpec | null> | null): ObjList<MetricProfileSpec | null>;
   ...
   */
  static afterCreate(objs: C3.Array<MetricProfileSpec | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<MetricProfileSpec | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<MetricProfileSpec | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<MetricProfileSpec | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<MetricProfileSpec | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): MetricProfileSpec | null;
   ...
   */
  withoutIdentity(): MetricProfileSpec | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<MetricProfileSpec | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: MetricProfileSpec | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<MetricProfileSpec | null> | null, callback?: λFunction<MetricProfileSpec | null, MetricProfileSpec | null> | null): ObjList<MetricProfileSpec | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<MetricProfileSpec | null> | null, callback?: λFunction<MetricProfileSpec | null, MetricProfileSpec | null> | null): C3.Array<ObjError | null>;
