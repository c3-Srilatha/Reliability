// TypeScript definitions for the C3 type TestMetricChartData

/**
 * @remarks this represents a value passed to a method that expects an instance of TestMetricChartData
 */
declare interface ITestMetricChartData {
 ...
 */
declare class TestMetricChartData extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): TestMetricChartData | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): TestMetricChartData | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): TestMetricChartData | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): TestMetricChartData | null;
   ...
   */
  replaceType(old: Type, new_: Type): TestMetricChartData;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): TestMetricChartData;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): TestMetricChartData;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<TestMetricChartData | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<TestMetricChartData | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): TestMetricChartData;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TestMetricChartData;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TestMetricChartData;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): TestMetricChartData;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): TestMetricChartData;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): TestMetricChartData;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): TestMetricChartData;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): TestMetricChartData;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): TestMetricChartData;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): TestMetricChartData;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): TestMetricChartData;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): TestMetricChartData;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): TestMetricChartData;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): TestMetricChartData;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): TestMetricChartData;
   ...
   * @see #unsetField
   */
  defaultField(field: string): TestMetricChartData;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): TestMetricChartData;
   ...
   * @see #removeField
   */
  unsetField(field: string): TestMetricChartData;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): TestMetricChartData;
   ...
   * @see #unsetField
   */
  removeField(field: string): TestMetricChartData;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): TestMetricChartData;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): TestMetricChartData;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): TestMetricChartData;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): TestMetricChartData;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): TestMetricChartData;

  mergeJson(json: any | null): TestMetricChartData;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): TestMetricChartData;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): TestMetricChartData;
   ...
   */
  singletonArray(): C3.Array<TestMetricChartData | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<TestMetricChartData | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<TestMetricChartData | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<TestMetricChartData | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<TestMetricChartData | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, TestMetricChartData | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, TestMetricChartData | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<TestMetricChartData | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<TestMetricChartData | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): TestMetricChartData;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): TestMetricChartData;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): TestMetricChartData;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): TestMetricChartData;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): TestMetricChartData;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): TestMetricChartData;
   ...
   * @see #fromString
   */
  static make(s: string | null): TestMetricChartData | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): TestMetricChartData;
   ...
   */
  static cachedEmptyInst(): TestMetricChartData;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<TestMetricChartData>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): TestMetricChartData;

  /**
   * Extract the partition key from the given obj
   */
  partitionKey(failIfMissing?: boolean): TestMetricEvaluatable | null;
   ...
   */
  static partition(objs?: Stream<TestMetricChartData | null>, spec?: PartitionBucketStrategy | null): C3.Map<string | null, KvDataPartition | null>;
   ...
   */
  static fromPartitions(partitions?: Stream<KvDataPartition | null>): Stream<TestMetricChartData | null>;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<TestMetricChartData | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<TestMetricChartData | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<TestMetricChartData | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<TestMetricChartData | null> | null>;
   ...
   */
  get(include?: string | null): TestMetricChartData | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): TestMetricChartData | null;
   ...
   */
  getMissing(spec: GetMissingSpec): TestMetricChartData;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): TestMetricChartData | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): TestMetricChartData;
   ...
   * @see #toString
   */
  static fromString(s: string | null): TestMetricChartData | null;
   ...
   */
  create(spec?: UpsertSpec | null): TestMetricChartData | null;
   ...
   */
  static createBatch(objs: C3.Array<TestMetricChartData | null> | null, spec?: UpsertSpec | null): ObjList<TestMetricChartData | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<TestMetricChartData | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<TestMetricChartData | null> | null;
   ...
   */
  update(srcObj?: TestMetricChartData | null, spec?: UpsertSpec | null): TestMetricChartData | null;
   ...
   */
  upsert(srcObj?: TestMetricChartData | null, spec?: UpsertSpec | null): TestMetricChartData | null;
   ...
   */
  merge(spec?: MergeSpec | null): TestMetricChartData | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): TestMetricChartData | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): TestMetricChartData | null;
   ...
   */
  static updateBatch(objs: C3.Array<TestMetricChartData | null> | null, srcObjs?: C3.Array<TestMetricChartData | null>, spec?: UpsertSpec | null): ObjList<TestMetricChartData | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<TestMetricChartData | null>>, spec?: UpsertSpec | null): ObjList<TestMetricChartData | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<TestMetricChartData | null> | null, srcObjs?: C3.Array<TestMetricChartData | null>, spec?: UpsertSpec | null): ObjList<TestMetricChartData | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<TestMetricChartData | null>>, spec?: UpsertSpec | null): ObjList<TestMetricChartData | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<TestMetricChartData | null> | null, spec?: TouchSpec | null): ObjList<TestMetricChartData | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<TestMetricChartData | null> | null, spec?: MergeSpec | null): ObjList<TestMetricChartData | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<TestMetricChartData | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<TestMetricChartData | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<TestMetricChartData | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<TestMetricChartData | null> | null;
   ...
   */
  static mergeAll(mergeObj: TestMetricChartData | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: TestMetricChartData | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<TestMetricChartData | null> | null, spec?: UpsertSpec | null): ObjList<TestMetricChartData | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<TestMetricChartData | null> | null, spec?: UpsertSpec | null): ObjList<TestMetricChartData | null> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): TestMetricChartData | null;
   ...
   */
  static beforeCreate(objs: C3.Array<TestMetricChartData | null> | null): ObjList<TestMetricChartData | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<TestMetricChartData | null> | null): ObjList<TestMetricChartData | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<TestMetricChartData | null> | null): ObjList<TestMetricChartData | null>;
   ...
   */
  static afterCreate(objs: C3.Array<TestMetricChartData | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<TestMetricChartData | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<TestMetricChartData | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<TestMetricChartData | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<TestMetricChartData | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): TestMetricChartData | null;
   ...
   */
  withoutIdentity(): TestMetricChartData | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<TestMetricChartData | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: TestMetricChartData | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<TestMetricChartData | null> | null, callback?: λFunction<TestMetricChartData | null, TestMetricChartData | null> | null): ObjList<TestMetricChartData | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<TestMetricChartData | null> | null, callback?: λFunction<TestMetricChartData | null, TestMetricChartData | null> | null): C3.Array<ObjError | null>;
