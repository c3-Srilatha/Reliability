// TypeScript definitions for the C3 type DataApiEntityType

/**
 * Test entity type
 *
 * @remarks this represents a value passed to a method that expects an instance of DataApiEntityType
 */
declare interface IDataApiEntityType {

  /**
   * Mixin int field
   */
  mixinIntField?: number | null;
   ...
   * Datetime field
   */
  datetimeField?: DateTime | Date | string | null;
   ...
   * Reference field
   */
  referenceField?: ITestApiEntityType | null;
   ...
   */
  foreignKeyReferenceField?: ITestApiEntityType | null;

  /**
   * Foreign key reference collection field
   */
  foreignKeyReferenceCollectionField?: C3.Array<TestApiEntityType | null> | Array<ITestApiEntityType | null>;

  /**
   * Dimension field
   */
  dimensionField?: IDimension | null;

  /**
   * Unit field
   */
  unitField?: IUnit | null;

  /**
   * Stored calc field
   */
  storedCalcField?: number | null;

  /**
   * Stored collection field
   */
  storedCollectionField?: C3.Array<TestApiEntityType | null> | Array<ITestApiEntityType | null>;

  /**
   * Duration field
   */
  durationField?: IDuration | null;
}
 ...
 */
declare class DataApiEntityType extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): DataApiEntityType | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): DataApiEntityType | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): DataApiEntityType | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): DataApiEntityType | null;
   ...
   */
  replaceType(old: Type, new_: Type): DataApiEntityType;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): DataApiEntityType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): DataApiEntityType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<DataApiEntityType | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<DataApiEntityType | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): DataApiEntityType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DataApiEntityType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DataApiEntityType;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): DataApiEntityType;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): DataApiEntityType;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): DataApiEntityType;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): DataApiEntityType;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): DataApiEntityType;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): DataApiEntityType;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): DataApiEntityType;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): DataApiEntityType;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): DataApiEntityType;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): DataApiEntityType;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): DataApiEntityType;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): DataApiEntityType;
   ...
   * @see #unsetField
   */
  defaultField(field: string): DataApiEntityType;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): DataApiEntityType;
   ...
   * @see #removeField
   */
  unsetField(field: string): DataApiEntityType;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): DataApiEntityType;
   ...
   * @see #unsetField
   */
  removeField(field: string): DataApiEntityType;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): DataApiEntityType;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): DataApiEntityType;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): DataApiEntityType;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): DataApiEntityType;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): DataApiEntityType;

  mergeJson(json: any | null): DataApiEntityType;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): DataApiEntityType;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): DataApiEntityType;
   ...
   */
  singletonArray(): C3.Array<DataApiEntityType | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<DataApiEntityType | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<DataApiEntityType | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<DataApiEntityType | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<DataApiEntityType | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, DataApiEntityType | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, DataApiEntityType | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<DataApiEntityType | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<DataApiEntityType | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): DataApiEntityType;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): DataApiEntityType;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): DataApiEntityType;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): DataApiEntityType;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): DataApiEntityType;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): DataApiEntityType;
   ...
   * @see #fromString
   */
  static make(s: string | null): DataApiEntityType | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): DataApiEntityType;
   ...
   */
  static cachedEmptyInst(): DataApiEntityType;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<DataApiEntityType>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): DataApiEntityType;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<DataApiEntityType | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<DataApiEntityType | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<DataApiEntityType | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<DataApiEntityType | null> | null>;
   ...
   */
  get(include?: string | null): DataApiEntityType | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): DataApiEntityType | null;
   ...
   */
  getMissing(spec: GetMissingSpec): DataApiEntityType;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): DataApiEntityType | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): DataApiEntityType;
   ...
   * @see #toString
   */
  static fromString(s: string | null): DataApiEntityType | null;
   ...
   */
  create(spec?: UpsertSpec | null): DataApiEntityType | null;
   ...
   */
  static createBatch(objs: C3.Array<DataApiEntityType | null> | null, spec?: UpsertSpec | null): ObjList<DataApiEntityType | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<DataApiEntityType | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<DataApiEntityType | null> | null;
   ...
   */
  update(srcObj?: DataApiEntityType | null, spec?: UpsertSpec | null): DataApiEntityType | null;
   ...
   */
  upsert(srcObj?: DataApiEntityType | null, spec?: UpsertSpec | null): DataApiEntityType | null;
   ...
   */
  merge(spec?: MergeSpec | null): DataApiEntityType | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): DataApiEntityType | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): DataApiEntityType | null;
   ...
   */
  static updateBatch(objs: C3.Array<DataApiEntityType | null> | null, srcObjs?: C3.Array<DataApiEntityType | null>, spec?: UpsertSpec | null): ObjList<DataApiEntityType | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<DataApiEntityType | null>>, spec?: UpsertSpec | null): ObjList<DataApiEntityType | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<DataApiEntityType | null> | null, srcObjs?: C3.Array<DataApiEntityType | null>, spec?: UpsertSpec | null): ObjList<DataApiEntityType | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<DataApiEntityType | null>>, spec?: UpsertSpec | null): ObjList<DataApiEntityType | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<DataApiEntityType | null> | null, spec?: TouchSpec | null): ObjList<DataApiEntityType | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<DataApiEntityType | null> | null, spec?: MergeSpec | null): ObjList<DataApiEntityType | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<DataApiEntityType | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<DataApiEntityType | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<DataApiEntityType | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<DataApiEntityType | null> | null;
   ...
   */
  static mergeAll(mergeObj: DataApiEntityType | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: DataApiEntityType | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<DataApiEntityType | null> | null, spec?: UpsertSpec | null): ObjList<DataApiEntityType | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<DataApiEntityType | null> | null, spec?: UpsertSpec | null): ObjList<DataApiEntityType | null> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): DataApiEntityType | null;
   ...
   */
  static beforeCreate(objs: C3.Array<DataApiEntityType | null> | null): ObjList<DataApiEntityType | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<DataApiEntityType | null> | null): ObjList<DataApiEntityType | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<DataApiEntityType | null> | null): ObjList<DataApiEntityType | null>;
   ...
   */
  static afterCreate(objs: C3.Array<DataApiEntityType | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<DataApiEntityType | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<DataApiEntityType | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<DataApiEntityType | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<DataApiEntityType | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): DataApiEntityType | null;
   ...
   */
  withoutIdentity(): DataApiEntityType | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<DataApiEntityType | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: DataApiEntityType | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<DataApiEntityType | null> | null, callback?: λFunction<DataApiEntityType | null, DataApiEntityType | null> | null): ObjList<DataApiEntityType | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<DataApiEntityType | null> | null, callback?: λFunction<DataApiEntityType | null, DataApiEntityType | null> | null): C3.Array<ObjError | null>;
