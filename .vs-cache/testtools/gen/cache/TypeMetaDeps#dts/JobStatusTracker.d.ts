// TypeScript definitions for the C3 type JobStatusTracker

/**
 * JobStatusTracker is used to run jobs and generate information about the jobs run.
 *
 * @remarks this represents a value passed to a method that expects an instance of JobStatusTracker
 */
declare interface IJobStatusTracker {
   ...
   */
  reports?: C3.Array<JobStatusReport | null> | Array<IJobStatusReport | null>;

  /**
   * IDs for the jobs being tracked by the tracker
   */
  jobIds?: C3.Array<string | null> | Array<string | null>;
}
 ...
 */
declare class JobStatusTracker extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): JobStatusTracker | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): JobStatusTracker | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): JobStatusTracker | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): JobStatusTracker | null;
   ...
   */
  replaceType(old: Type, new_: Type): JobStatusTracker;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): JobStatusTracker;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): JobStatusTracker;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<JobStatusTracker | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<JobStatusTracker | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): JobStatusTracker;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): JobStatusTracker;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): JobStatusTracker;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): JobStatusTracker;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): JobStatusTracker;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): JobStatusTracker;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): JobStatusTracker;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): JobStatusTracker;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): JobStatusTracker;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): JobStatusTracker;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): JobStatusTracker;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): JobStatusTracker;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): JobStatusTracker;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): JobStatusTracker;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): JobStatusTracker;
   ...
   * @see #unsetField
   */
  defaultField(field: string): JobStatusTracker;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): JobStatusTracker;
   ...
   * @see #removeField
   */
  unsetField(field: string): JobStatusTracker;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): JobStatusTracker;
   ...
   * @see #unsetField
   */
  removeField(field: string): JobStatusTracker;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): JobStatusTracker;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): JobStatusTracker;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): JobStatusTracker;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): JobStatusTracker;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): JobStatusTracker;

  mergeJson(json: any | null): JobStatusTracker;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): JobStatusTracker;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): JobStatusTracker;
   ...
   */
  singletonArray(): C3.Array<JobStatusTracker | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<JobStatusTracker | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<JobStatusTracker | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<JobStatusTracker | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<JobStatusTracker | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, JobStatusTracker | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, JobStatusTracker | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<JobStatusTracker | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<JobStatusTracker | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): JobStatusTracker;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): JobStatusTracker;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): JobStatusTracker;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): JobStatusTracker;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): JobStatusTracker;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): JobStatusTracker;
   ...
   * @see #fromString
   */
  static make(s: string | null): JobStatusTracker | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): JobStatusTracker;
   ...
   */
  static cachedEmptyInst(): JobStatusTracker;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<JobStatusTracker>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): JobStatusTracker;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<JobStatusTracker | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<JobStatusTracker | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<JobStatusTracker | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<JobStatusTracker | null> | null>;
   ...
   */
  get(include?: string | null): JobStatusTracker | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): JobStatusTracker | null;
   ...
   */
  getMissing(spec: GetMissingSpec): JobStatusTracker;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): JobStatusTracker | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): JobStatusTracker;
   ...
   * @see #toString
   */
  static fromString(s: string | null): JobStatusTracker | null;
   ...
   */
  create(spec?: UpsertSpec | null): JobStatusTracker | null;
   ...
   */
  static createBatch(objs: C3.Array<JobStatusTracker | null> | null, spec?: UpsertSpec | null): ObjList<JobStatusTracker | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<JobStatusTracker | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<JobStatusTracker | null> | null;
   ...
   */
  update(srcObj?: JobStatusTracker | null, spec?: UpsertSpec | null): JobStatusTracker | null;
   ...
   */
  upsert(srcObj?: JobStatusTracker | null, spec?: UpsertSpec | null): JobStatusTracker | null;
   ...
   */
  merge(spec?: MergeSpec | null): JobStatusTracker | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): JobStatusTracker | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): JobStatusTracker | null;
   ...
   */
  static updateBatch(objs: C3.Array<JobStatusTracker | null> | null, srcObjs?: C3.Array<JobStatusTracker | null>, spec?: UpsertSpec | null): ObjList<JobStatusTracker | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<JobStatusTracker | null>>, spec?: UpsertSpec | null): ObjList<JobStatusTracker | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<JobStatusTracker | null> | null, srcObjs?: C3.Array<JobStatusTracker | null>, spec?: UpsertSpec | null): ObjList<JobStatusTracker | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<JobStatusTracker | null>>, spec?: UpsertSpec | null): ObjList<JobStatusTracker | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<JobStatusTracker | null> | null, spec?: TouchSpec | null): ObjList<JobStatusTracker | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<JobStatusTracker | null> | null, spec?: MergeSpec | null): ObjList<JobStatusTracker | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<JobStatusTracker | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<JobStatusTracker | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<JobStatusTracker | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<JobStatusTracker | null> | null;
   ...
   */
  static mergeAll(mergeObj: JobStatusTracker | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: JobStatusTracker | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<JobStatusTracker | null> | null, spec?: UpsertSpec | null): ObjList<JobStatusTracker | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<JobStatusTracker | null> | null, spec?: UpsertSpec | null): ObjList<JobStatusTracker | null> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): JobStatusTracker | null;
   ...
   */
  static beforeCreate(objs: C3.Array<JobStatusTracker | null> | null): ObjList<JobStatusTracker | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<JobStatusTracker | null> | null): ObjList<JobStatusTracker | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<JobStatusTracker | null> | null): ObjList<JobStatusTracker | null>;
   ...
   */
  static afterCreate(objs: C3.Array<JobStatusTracker | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<JobStatusTracker | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<JobStatusTracker | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<JobStatusTracker | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<JobStatusTracker | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): JobStatusTracker | null;
   ...
   */
  withoutIdentity(): JobStatusTracker | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<JobStatusTracker | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: JobStatusTracker | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<JobStatusTracker | null> | null, callback?: λFunction<JobStatusTracker | null, JobStatusTracker | null> | null): ObjList<JobStatusTracker | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<JobStatusTracker | null> | null, callback?: λFunction<JobStatusTracker | null, JobStatusTracker | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static run(jobs: C3.Array<any>, spec?: JobStatusTrackerSpec | null): JobStatusTracker | null;

  /**
   * Generate the job status report for a job
   */
  generateJobStatusReport(job: any): JobStatusReport | null;
   ...
   */
  startJobAndPollAsync(jobs: C3.Array<any>, cronExpression: string): CronJob | null;

  /**
   * Check the status of a list of jobs
   * If the job has completed or failed, generate the {@see JobStatusReport}
   */
  checkJobStatus(jobs: C3.Array<any>): boolean;
   ...
   */
  statusReport(): JobStatusTracker | null;
}
