// TypeScript definitions for the C3 type TestApiOtherEntityType

/**
 * Test entity type for testing TestApiFetchSpy for mocking fetch-like actions on a different type.
 *
 * @remarks this represents a value passed to a method that expects an instance of TestApiOtherEntityType
 */
declare interface ITestApiOtherEntityType {
 ...
 * Test entity type for testing TestApiFetchSpy for mocking fetch-like actions on a different type.
 *
 * @remarks this represents a made instance of TestApiOtherEntityType
 */
declare class TestApiOtherEntityType extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): TestApiOtherEntityType | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): TestApiOtherEntityType | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): TestApiOtherEntityType | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): TestApiOtherEntityType | null;
   ...
   */
  replaceType(old: Type, new_: Type): TestApiOtherEntityType;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): TestApiOtherEntityType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): TestApiOtherEntityType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<TestApiOtherEntityType | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<TestApiOtherEntityType | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): TestApiOtherEntityType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TestApiOtherEntityType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TestApiOtherEntityType;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): TestApiOtherEntityType;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): TestApiOtherEntityType;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): TestApiOtherEntityType;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): TestApiOtherEntityType;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): TestApiOtherEntityType;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): TestApiOtherEntityType;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): TestApiOtherEntityType;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): TestApiOtherEntityType;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): TestApiOtherEntityType;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): TestApiOtherEntityType;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): TestApiOtherEntityType;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): TestApiOtherEntityType;
   ...
   * @see #unsetField
   */
  defaultField(field: string): TestApiOtherEntityType;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): TestApiOtherEntityType;
   ...
   * @see #removeField
   */
  unsetField(field: string): TestApiOtherEntityType;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): TestApiOtherEntityType;
   ...
   * @see #unsetField
   */
  removeField(field: string): TestApiOtherEntityType;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): TestApiOtherEntityType;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): TestApiOtherEntityType;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): TestApiOtherEntityType;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): TestApiOtherEntityType;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): TestApiOtherEntityType;

  mergeJson(json: any | null): TestApiOtherEntityType;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): TestApiOtherEntityType;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): TestApiOtherEntityType;
   ...
   */
  singletonArray(): C3.Array<TestApiOtherEntityType | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<TestApiOtherEntityType | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<TestApiOtherEntityType | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<TestApiOtherEntityType | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<TestApiOtherEntityType | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, TestApiOtherEntityType | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, TestApiOtherEntityType | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<TestApiOtherEntityType | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<TestApiOtherEntityType | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): TestApiOtherEntityType;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): TestApiOtherEntityType;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): TestApiOtherEntityType;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): TestApiOtherEntityType;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): TestApiOtherEntityType;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): TestApiOtherEntityType;
   ...
   * @see #fromString
   */
  static make(s: string | null): TestApiOtherEntityType | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): TestApiOtherEntityType;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): TestApiOtherEntityType;
   ...
   */
  static cachedEmptyInst(): TestApiOtherEntityType;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<TestApiOtherEntityType>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): TestApiOtherEntityType;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<TestApiOtherEntityType | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<TestApiOtherEntityType | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<TestApiOtherEntityType | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<TestApiOtherEntityType | null> | null>;
   ...
   */
  get(include?: string | null): TestApiOtherEntityType | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): TestApiOtherEntityType | null;
   ...
   */
  getMissing(spec: GetMissingSpec): TestApiOtherEntityType;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): TestApiOtherEntityType | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): TestApiOtherEntityType;
   ...
   * @see #toString
   */
  static fromString(s: string | null): TestApiOtherEntityType | null;
   ...
   */
  create(spec?: UpsertSpec | null): TestApiOtherEntityType | null;
   ...
   */
  static createBatch(objs: C3.Array<TestApiOtherEntityType | null> | null, spec?: UpsertSpec | null): ObjList<TestApiOtherEntityType | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<TestApiOtherEntityType | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<TestApiOtherEntityType | null> | null;
   ...
   */
  update(srcObj?: TestApiOtherEntityType | null, spec?: UpsertSpec | null): TestApiOtherEntityType | null;
   ...
   */
  upsert(srcObj?: TestApiOtherEntityType | null, spec?: UpsertSpec | null): TestApiOtherEntityType | null;
   ...
   */
  merge(spec?: MergeSpec | null): TestApiOtherEntityType | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): TestApiOtherEntityType | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): TestApiOtherEntityType | null;
   ...
   */
  static updateBatch(objs: C3.Array<TestApiOtherEntityType | null> | null, srcObjs?: C3.Array<TestApiOtherEntityType | null>, spec?: UpsertSpec | null): ObjList<TestApiOtherEntityType | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<TestApiOtherEntityType | null>>, spec?: UpsertSpec | null): ObjList<TestApiOtherEntityType | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<TestApiOtherEntityType | null> | null, srcObjs?: C3.Array<TestApiOtherEntityType | null>, spec?: UpsertSpec | null): ObjList<TestApiOtherEntityType | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<TestApiOtherEntityType | null>>, spec?: UpsertSpec | null): ObjList<TestApiOtherEntityType | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<TestApiOtherEntityType | null> | null, spec?: TouchSpec | null): ObjList<TestApiOtherEntityType | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<TestApiOtherEntityType | null> | null, spec?: MergeSpec | null): ObjList<TestApiOtherEntityType | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<TestApiOtherEntityType | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<TestApiOtherEntityType | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<TestApiOtherEntityType | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<TestApiOtherEntityType | null> | null;
   ...
   */
  static mergeAll(mergeObj: TestApiOtherEntityType | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: TestApiOtherEntityType | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<TestApiOtherEntityType | null> | null, spec?: UpsertSpec | null): ObjList<TestApiOtherEntityType | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<TestApiOtherEntityType | null> | null, spec?: UpsertSpec | null): ObjList<TestApiOtherEntityType | null> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): TestApiOtherEntityType | null;
   ...
   */
  static beforeCreate(objs: C3.Array<TestApiOtherEntityType | null> | null): ObjList<TestApiOtherEntityType | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<TestApiOtherEntityType | null> | null): ObjList<TestApiOtherEntityType | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<TestApiOtherEntityType | null> | null): ObjList<TestApiOtherEntityType | null>;
   ...
   */
  static afterCreate(objs: C3.Array<TestApiOtherEntityType | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<TestApiOtherEntityType | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<TestApiOtherEntityType | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<TestApiOtherEntityType | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<TestApiOtherEntityType | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): TestApiOtherEntityType | null;
   ...
   */
  withoutIdentity(): TestApiOtherEntityType | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<TestApiOtherEntityType | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: TestApiOtherEntityType | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<TestApiOtherEntityType | null> | null, callback?: λFunction<TestApiOtherEntityType | null, TestApiOtherEntityType | null> | null): ObjList<TestApiOtherEntityType | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<TestApiOtherEntityType | null> | null, callback?: λFunction<TestApiOtherEntityType | null, TestApiOtherEntityType | null> | null): C3.Array<ObjError | null>;
