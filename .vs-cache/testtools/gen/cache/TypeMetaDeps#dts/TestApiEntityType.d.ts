// TypeScript definitions for the C3 type TestApiEntityType

/**
 * Test entity type
 *
 * @remarks this represents a value passed to a method that expects an instance of TestApiEntityType
 */
declare interface ITestApiEntityType {
   ...
   */
  referenceField?: IDataApiEntityType | null;
}
 ...
 */
declare class TestApiEntityType extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): TestApiEntityType | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): TestApiEntityType | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): TestApiEntityType | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): TestApiEntityType | null;
   ...
   */
  replaceType(old: Type, new_: Type): TestApiEntityType;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): TestApiEntityType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): TestApiEntityType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<TestApiEntityType | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<TestApiEntityType | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): TestApiEntityType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TestApiEntityType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TestApiEntityType;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): TestApiEntityType;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): TestApiEntityType;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): TestApiEntityType;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): TestApiEntityType;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): TestApiEntityType;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): TestApiEntityType;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): TestApiEntityType;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): TestApiEntityType;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): TestApiEntityType;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): TestApiEntityType;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): TestApiEntityType;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): TestApiEntityType;
   ...
   * @see #unsetField
   */
  defaultField(field: string): TestApiEntityType;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): TestApiEntityType;
   ...
   * @see #removeField
   */
  unsetField(field: string): TestApiEntityType;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): TestApiEntityType;
   ...
   * @see #unsetField
   */
  removeField(field: string): TestApiEntityType;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): TestApiEntityType;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): TestApiEntityType;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): TestApiEntityType;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): TestApiEntityType;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): TestApiEntityType;

  mergeJson(json: any | null): TestApiEntityType;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): TestApiEntityType;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): TestApiEntityType;
   ...
   */
  singletonArray(): C3.Array<TestApiEntityType | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<TestApiEntityType | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<TestApiEntityType | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<TestApiEntityType | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<TestApiEntityType | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, TestApiEntityType | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, TestApiEntityType | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<TestApiEntityType | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<TestApiEntityType | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): TestApiEntityType;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): TestApiEntityType;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): TestApiEntityType;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): TestApiEntityType;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): TestApiEntityType;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): TestApiEntityType;
   ...
   * @see #fromString
   */
  static make(s: string | null): TestApiEntityType | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): TestApiEntityType;
   ...
   */
  static cachedEmptyInst(): TestApiEntityType;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<TestApiEntityType>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): TestApiEntityType;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<TestApiEntityType | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<TestApiEntityType | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<TestApiEntityType | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<TestApiEntityType | null> | null>;
   ...
   */
  get(include?: string | null): TestApiEntityType | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): TestApiEntityType | null;
   ...
   */
  getMissing(spec: GetMissingSpec): TestApiEntityType;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): TestApiEntityType | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): TestApiEntityType;
   ...
   * @see #toString
   */
  static fromString(s: string | null): TestApiEntityType | null;
   ...
   */
  create(spec?: UpsertSpec | null): TestApiEntityType | null;
   ...
   */
  static createBatch(objs: C3.Array<TestApiEntityType | null> | null, spec?: UpsertSpec | null): ObjList<TestApiEntityType | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<TestApiEntityType | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<TestApiEntityType | null> | null;
   ...
   */
  update(srcObj?: TestApiEntityType | null, spec?: UpsertSpec | null): TestApiEntityType | null;
   ...
   */
  upsert(srcObj?: TestApiEntityType | null, spec?: UpsertSpec | null): TestApiEntityType | null;
   ...
   */
  merge(spec?: MergeSpec | null): TestApiEntityType | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): TestApiEntityType | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): TestApiEntityType | null;
   ...
   */
  static updateBatch(objs: C3.Array<TestApiEntityType | null> | null, srcObjs?: C3.Array<TestApiEntityType | null>, spec?: UpsertSpec | null): ObjList<TestApiEntityType | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<TestApiEntityType | null>>, spec?: UpsertSpec | null): ObjList<TestApiEntityType | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<TestApiEntityType | null> | null, srcObjs?: C3.Array<TestApiEntityType | null>, spec?: UpsertSpec | null): ObjList<TestApiEntityType | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<TestApiEntityType | null>>, spec?: UpsertSpec | null): ObjList<TestApiEntityType | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<TestApiEntityType | null> | null, spec?: TouchSpec | null): ObjList<TestApiEntityType | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<TestApiEntityType | null> | null, spec?: MergeSpec | null): ObjList<TestApiEntityType | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<TestApiEntityType | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<TestApiEntityType | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<TestApiEntityType | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<TestApiEntityType | null> | null;
   ...
   */
  static mergeAll(mergeObj: TestApiEntityType | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: TestApiEntityType | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<TestApiEntityType | null> | null, spec?: UpsertSpec | null): ObjList<TestApiEntityType | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<TestApiEntityType | null> | null, spec?: UpsertSpec | null): ObjList<TestApiEntityType | null> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): TestApiEntityType | null;
   ...
   */
  static beforeCreate(objs: C3.Array<TestApiEntityType | null> | null): ObjList<TestApiEntityType | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<TestApiEntityType | null> | null): ObjList<TestApiEntityType | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<TestApiEntityType | null> | null): ObjList<TestApiEntityType | null>;
   ...
   */
  static afterCreate(objs: C3.Array<TestApiEntityType | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<TestApiEntityType | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<TestApiEntityType | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<TestApiEntityType | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<TestApiEntityType | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): TestApiEntityType | null;
   ...
   */
  withoutIdentity(): TestApiEntityType | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<TestApiEntityType | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: TestApiEntityType | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<TestApiEntityType | null> | null, callback?: λFunction<TestApiEntityType | null, TestApiEntityType | null> | null): ObjList<TestApiEntityType | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<TestApiEntityType | null> | null, callback?: λFunction<TestApiEntityType | null, TestApiEntityType | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static fetchThisType(spec: FetchSpec): FetchResult<TestApiEntityType | null> | null;

  /**
   * Fetch-like method for another type.
   */
  static fetchOtherType(spec: FetchSpec): FetchResult<TestApiOtherEntityType | null> | null;

  /**
   * Fetch-like method that returns just the objects instead of a {@link FetchResult}.
   */
  static fetchOtherTypeAsArray(spec: FetchSpec): C3.Array<TestApiOtherEntityType | null>;
}
