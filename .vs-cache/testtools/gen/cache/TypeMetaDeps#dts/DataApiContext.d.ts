// TypeScript definitions for the C3 type DataApiContext

/**
 * This table should be empty unless there is a test running.
 *
 * The main, and only use, is to keep track of the state of the random number generator
 * being used in a particular DataApiContext. Users should always
 * remove any DataApiContext's at the end of a test/use-case.
 *
 * @see DataApi.createContext
 * @see DataApi.destroyContext
 *
 * @remarks this represents a value passed to a method that expects an instance of DataApiContext
 */
declare interface IDataApiContext {
  ...
  /**
   * The random number generator seed, or the next value returned from the random number generator.
   */
  next?: number | null;
}
 ...
 * @see DataApi.destroyContext
 *
 * @remarks this represents a made instance of DataApiContext
 */
declare class DataApiContext extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): DataApiContext | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): DataApiContext | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): DataApiContext | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): DataApiContext | null;
   ...
   */
  replaceType(old: Type, new_: Type): DataApiContext;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): DataApiContext;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): DataApiContext;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<DataApiContext | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<DataApiContext | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): DataApiContext;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DataApiContext;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DataApiContext;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): DataApiContext;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): DataApiContext;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): DataApiContext;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): DataApiContext;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): DataApiContext;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): DataApiContext;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): DataApiContext;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): DataApiContext;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): DataApiContext;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): DataApiContext;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): DataApiContext;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): DataApiContext;
   ...
   * @see #unsetField
   */
  defaultField(field: string): DataApiContext;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): DataApiContext;
   ...
   * @see #removeField
   */
  unsetField(field: string): DataApiContext;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): DataApiContext;
   ...
   * @see #unsetField
   */
  removeField(field: string): DataApiContext;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): DataApiContext;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): DataApiContext;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): DataApiContext;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): DataApiContext;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): DataApiContext;

  mergeJson(json: any | null): DataApiContext;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): DataApiContext;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): DataApiContext;
   ...
   */
  singletonArray(): C3.Array<DataApiContext | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<DataApiContext | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<DataApiContext | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<DataApiContext | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<DataApiContext | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, DataApiContext | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, DataApiContext | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<DataApiContext | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<DataApiContext | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): DataApiContext;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): DataApiContext;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): DataApiContext;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): DataApiContext;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): DataApiContext;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): DataApiContext;
   ...
   * @see #fromString
   */
  static make(s: string | null): DataApiContext | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): DataApiContext;
   ...
   */
  static cachedEmptyInst(): DataApiContext;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<DataApiContext>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): DataApiContext;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<DataApiContext | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<DataApiContext | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<DataApiContext | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<DataApiContext | null> | null>;
   ...
   */
  get(include?: string | null): DataApiContext | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): DataApiContext | null;
   ...
   */
  getMissing(spec: GetMissingSpec): DataApiContext;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): DataApiContext | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): DataApiContext;
   ...
   * @see #toString
   */
  static fromString(s: string | null): DataApiContext | null;
   ...
   */
  create(spec?: UpsertSpec | null): DataApiContext | null;
   ...
   */
  static createBatch(objs: C3.Array<DataApiContext | null> | null, spec?: UpsertSpec | null): ObjList<DataApiContext | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<DataApiContext | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<DataApiContext | null> | null;
   ...
   */
  update(srcObj?: DataApiContext | null, spec?: UpsertSpec | null): DataApiContext | null;
   ...
   */
  upsert(srcObj?: DataApiContext | null, spec?: UpsertSpec | null): DataApiContext | null;
   ...
   */
  merge(spec?: MergeSpec | null): DataApiContext | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): DataApiContext | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): DataApiContext | null;
   ...
   */
  static updateBatch(objs: C3.Array<DataApiContext | null> | null, srcObjs?: C3.Array<DataApiContext | null>, spec?: UpsertSpec | null): ObjList<DataApiContext | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<DataApiContext | null>>, spec?: UpsertSpec | null): ObjList<DataApiContext | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<DataApiContext | null> | null, srcObjs?: C3.Array<DataApiContext | null>, spec?: UpsertSpec | null): ObjList<DataApiContext | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<DataApiContext | null>>, spec?: UpsertSpec | null): ObjList<DataApiContext | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<DataApiContext | null> | null, spec?: TouchSpec | null): ObjList<DataApiContext | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<DataApiContext | null> | null, spec?: MergeSpec | null): ObjList<DataApiContext | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<DataApiContext | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<DataApiContext | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<DataApiContext | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<DataApiContext | null> | null;
   ...
   */
  static mergeAll(mergeObj: DataApiContext | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: DataApiContext | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<DataApiContext | null> | null, spec?: UpsertSpec | null): ObjList<DataApiContext | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<DataApiContext | null> | null, spec?: UpsertSpec | null): ObjList<DataApiContext | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<DataApiContext | null> | null): ObjList<DataApiContext | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<DataApiContext | null> | null): ObjList<DataApiContext | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<DataApiContext | null> | null): ObjList<DataApiContext | null>;
   ...
   */
  static afterCreate(objs: C3.Array<DataApiContext | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<DataApiContext | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<DataApiContext | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<DataApiContext | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<DataApiContext | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): DataApiContext | null;
   ...
   */
  withoutIdentity(): DataApiContext | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<DataApiContext | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: DataApiContext | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<DataApiContext | null> | null, callback?: λFunction<DataApiContext | null, DataApiContext | null> | null): ObjList<DataApiContext | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<DataApiContext | null> | null, callback?: λFunction<DataApiContext | null, DataApiContext | null> | null): C3.Array<ObjError | null>;
