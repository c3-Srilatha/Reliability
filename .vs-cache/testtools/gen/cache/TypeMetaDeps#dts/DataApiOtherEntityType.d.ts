// TypeScript definitions for the C3 type DataApiOtherEntityType

/**
 * Test entity type
 *
 * @remarks this represents a value passed to a method that expects an instance of DataApiOtherEntityType
 */
declare interface IDataApiOtherEntityType {
 ...
 * Test entity type
 *
 * @remarks this represents a made instance of DataApiOtherEntityType
 */
declare class DataApiOtherEntityType extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): DataApiOtherEntityType | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): DataApiOtherEntityType | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): DataApiOtherEntityType | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): DataApiOtherEntityType | null;
   ...
   */
  replaceType(old: Type, new_: Type): DataApiOtherEntityType;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): DataApiOtherEntityType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): DataApiOtherEntityType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<DataApiOtherEntityType | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<DataApiOtherEntityType | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): DataApiOtherEntityType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DataApiOtherEntityType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DataApiOtherEntityType;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): DataApiOtherEntityType;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): DataApiOtherEntityType;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): DataApiOtherEntityType;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): DataApiOtherEntityType;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): DataApiOtherEntityType;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): DataApiOtherEntityType;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): DataApiOtherEntityType;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): DataApiOtherEntityType;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): DataApiOtherEntityType;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): DataApiOtherEntityType;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): DataApiOtherEntityType;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): DataApiOtherEntityType;
   ...
   * @see #unsetField
   */
  defaultField(field: string): DataApiOtherEntityType;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): DataApiOtherEntityType;
   ...
   * @see #removeField
   */
  unsetField(field: string): DataApiOtherEntityType;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): DataApiOtherEntityType;
   ...
   * @see #unsetField
   */
  removeField(field: string): DataApiOtherEntityType;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): DataApiOtherEntityType;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): DataApiOtherEntityType;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): DataApiOtherEntityType;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): DataApiOtherEntityType;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): DataApiOtherEntityType;

  mergeJson(json: any | null): DataApiOtherEntityType;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): DataApiOtherEntityType;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): DataApiOtherEntityType;
   ...
   */
  singletonArray(): C3.Array<DataApiOtherEntityType | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<DataApiOtherEntityType | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<DataApiOtherEntityType | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<DataApiOtherEntityType | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<DataApiOtherEntityType | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, DataApiOtherEntityType | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, DataApiOtherEntityType | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<DataApiOtherEntityType | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<DataApiOtherEntityType | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): DataApiOtherEntityType;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): DataApiOtherEntityType;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): DataApiOtherEntityType;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): DataApiOtherEntityType;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): DataApiOtherEntityType;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): DataApiOtherEntityType;
   ...
   * @see #fromString
   */
  static make(s: string | null): DataApiOtherEntityType | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): DataApiOtherEntityType;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): DataApiOtherEntityType;
   ...
   */
  static cachedEmptyInst(): DataApiOtherEntityType;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<DataApiOtherEntityType>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): DataApiOtherEntityType;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<DataApiOtherEntityType | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<DataApiOtherEntityType | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<DataApiOtherEntityType | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<DataApiOtherEntityType | null> | null>;
   ...
   */
  get(include?: string | null): DataApiOtherEntityType | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): DataApiOtherEntityType | null;
   ...
   */
  getMissing(spec: GetMissingSpec): DataApiOtherEntityType;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): DataApiOtherEntityType | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): DataApiOtherEntityType;
   ...
   * @see #toString
   */
  static fromString(s: string | null): DataApiOtherEntityType | null;
   ...
   */
  create(spec?: UpsertSpec | null): DataApiOtherEntityType | null;
   ...
   */
  static createBatch(objs: C3.Array<DataApiOtherEntityType | null> | null, spec?: UpsertSpec | null): ObjList<DataApiOtherEntityType | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<DataApiOtherEntityType | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<DataApiOtherEntityType | null> | null;
   ...
   */
  update(srcObj?: DataApiOtherEntityType | null, spec?: UpsertSpec | null): DataApiOtherEntityType | null;
   ...
   */
  upsert(srcObj?: DataApiOtherEntityType | null, spec?: UpsertSpec | null): DataApiOtherEntityType | null;
   ...
   */
  merge(spec?: MergeSpec | null): DataApiOtherEntityType | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): DataApiOtherEntityType | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): DataApiOtherEntityType | null;
   ...
   */
  static updateBatch(objs: C3.Array<DataApiOtherEntityType | null> | null, srcObjs?: C3.Array<DataApiOtherEntityType | null>, spec?: UpsertSpec | null): ObjList<DataApiOtherEntityType | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<DataApiOtherEntityType | null>>, spec?: UpsertSpec | null): ObjList<DataApiOtherEntityType | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<DataApiOtherEntityType | null> | null, srcObjs?: C3.Array<DataApiOtherEntityType | null>, spec?: UpsertSpec | null): ObjList<DataApiOtherEntityType | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<DataApiOtherEntityType | null>>, spec?: UpsertSpec | null): ObjList<DataApiOtherEntityType | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<DataApiOtherEntityType | null> | null, spec?: TouchSpec | null): ObjList<DataApiOtherEntityType | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<DataApiOtherEntityType | null> | null, spec?: MergeSpec | null): ObjList<DataApiOtherEntityType | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<DataApiOtherEntityType | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<DataApiOtherEntityType | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<DataApiOtherEntityType | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<DataApiOtherEntityType | null> | null;
   ...
   */
  static mergeAll(mergeObj: DataApiOtherEntityType | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: DataApiOtherEntityType | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<DataApiOtherEntityType | null> | null, spec?: UpsertSpec | null): ObjList<DataApiOtherEntityType | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<DataApiOtherEntityType | null> | null, spec?: UpsertSpec | null): ObjList<DataApiOtherEntityType | null> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): DataApiOtherEntityType | null;
   ...
   */
  static beforeCreate(objs: C3.Array<DataApiOtherEntityType | null> | null): ObjList<DataApiOtherEntityType | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<DataApiOtherEntityType | null> | null): ObjList<DataApiOtherEntityType | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<DataApiOtherEntityType | null> | null): ObjList<DataApiOtherEntityType | null>;
   ...
   */
  static afterCreate(objs: C3.Array<DataApiOtherEntityType | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<DataApiOtherEntityType | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<DataApiOtherEntityType | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<DataApiOtherEntityType | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<DataApiOtherEntityType | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): DataApiOtherEntityType | null;
   ...
   */
  withoutIdentity(): DataApiOtherEntityType | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<DataApiOtherEntityType | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: DataApiOtherEntityType | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<DataApiOtherEntityType | null> | null, callback?: λFunction<DataApiOtherEntityType | null, DataApiOtherEntityType | null> | null): ObjList<DataApiOtherEntityType | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<DataApiOtherEntityType | null> | null, callback?: λFunction<DataApiOtherEntityType | null, DataApiOtherEntityType | null> | null): C3.Array<ObjError | null>;
