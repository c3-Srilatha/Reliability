// TypeScript definitions for the C3 type JobStatusReport

/**
 * Report holds status information and measurements for one job
 *
 * @remarks this represents a value passed to a method that expects an instance of JobStatusReport
 */
declare interface IJobStatusReport {
 ...
 */
declare class JobStatusReport extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): JobStatusReport | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): JobStatusReport | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): JobStatusReport | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): JobStatusReport | null;
   ...
   */
  replaceType(old: Type, new_: Type): JobStatusReport;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): JobStatusReport;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): JobStatusReport;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<JobStatusReport | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<JobStatusReport | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): JobStatusReport;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): JobStatusReport;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): JobStatusReport;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): JobStatusReport;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): JobStatusReport;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): JobStatusReport;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): JobStatusReport;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): JobStatusReport;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): JobStatusReport;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): JobStatusReport;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): JobStatusReport;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): JobStatusReport;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): JobStatusReport;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): JobStatusReport;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): JobStatusReport;
   ...
   * @see #unsetField
   */
  defaultField(field: string): JobStatusReport;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): JobStatusReport;
   ...
   * @see #removeField
   */
  unsetField(field: string): JobStatusReport;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): JobStatusReport;
   ...
   * @see #unsetField
   */
  removeField(field: string): JobStatusReport;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): JobStatusReport;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): JobStatusReport;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): JobStatusReport;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): JobStatusReport;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): JobStatusReport;

  mergeJson(json: any | null): JobStatusReport;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): JobStatusReport;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): JobStatusReport;
   ...
   */
  singletonArray(): C3.Array<JobStatusReport | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<JobStatusReport | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<JobStatusReport | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<JobStatusReport | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<JobStatusReport | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, JobStatusReport | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, JobStatusReport | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<JobStatusReport | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<JobStatusReport | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): JobStatusReport;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): JobStatusReport;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): JobStatusReport;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): JobStatusReport;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): JobStatusReport;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): JobStatusReport;
   ...
   * @see #fromString
   */
  static make(s: string | null): JobStatusReport | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): JobStatusReport;
   ...
   */
  static cachedEmptyInst(): JobStatusReport;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<JobStatusReport>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): JobStatusReport;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<JobStatusReport | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<JobStatusReport | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<JobStatusReport | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<JobStatusReport | null> | null>;
   ...
   */
  get(include?: string | null): JobStatusReport | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): JobStatusReport | null;
   ...
   */
  getMissing(spec: GetMissingSpec): JobStatusReport;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): JobStatusReport | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): JobStatusReport;
   ...
   * @see #toString
   */
  static fromString(s: string | null): JobStatusReport | null;
   ...
   */
  create(spec?: UpsertSpec | null): JobStatusReport | null;
   ...
   */
  static createBatch(objs: C3.Array<JobStatusReport | null> | null, spec?: UpsertSpec | null): ObjList<JobStatusReport | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<JobStatusReport | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<JobStatusReport | null> | null;
   ...
   */
  update(srcObj?: JobStatusReport | null, spec?: UpsertSpec | null): JobStatusReport | null;
   ...
   */
  upsert(srcObj?: JobStatusReport | null, spec?: UpsertSpec | null): JobStatusReport | null;
   ...
   */
  merge(spec?: MergeSpec | null): JobStatusReport | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): JobStatusReport | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): JobStatusReport | null;
   ...
   */
  static updateBatch(objs: C3.Array<JobStatusReport | null> | null, srcObjs?: C3.Array<JobStatusReport | null>, spec?: UpsertSpec | null): ObjList<JobStatusReport | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<JobStatusReport | null>>, spec?: UpsertSpec | null): ObjList<JobStatusReport | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<JobStatusReport | null> | null, srcObjs?: C3.Array<JobStatusReport | null>, spec?: UpsertSpec | null): ObjList<JobStatusReport | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<JobStatusReport | null>>, spec?: UpsertSpec | null): ObjList<JobStatusReport | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<JobStatusReport | null> | null, spec?: TouchSpec | null): ObjList<JobStatusReport | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<JobStatusReport | null> | null, spec?: MergeSpec | null): ObjList<JobStatusReport | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<JobStatusReport | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<JobStatusReport | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<JobStatusReport | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<JobStatusReport | null> | null;
   ...
   */
  static mergeAll(mergeObj: JobStatusReport | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: JobStatusReport | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<JobStatusReport | null> | null, spec?: UpsertSpec | null): ObjList<JobStatusReport | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<JobStatusReport | null> | null, spec?: UpsertSpec | null): ObjList<JobStatusReport | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<JobStatusReport | null> | null): ObjList<JobStatusReport | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<JobStatusReport | null> | null): ObjList<JobStatusReport | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<JobStatusReport | null> | null): ObjList<JobStatusReport | null>;
   ...
   */
  static afterCreate(objs: C3.Array<JobStatusReport | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<JobStatusReport | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<JobStatusReport | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<JobStatusReport | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<JobStatusReport | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): JobStatusReport | null;
   ...
   */
  withoutIdentity(): JobStatusReport | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<JobStatusReport | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: JobStatusReport | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<JobStatusReport | null> | null, callback?: λFunction<JobStatusReport | null, JobStatusReport | null> | null): ObjList<JobStatusReport | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<JobStatusReport | null> | null, callback?: λFunction<JobStatusReport | null, JobStatusReport | null> | null): C3.Array<ObjError | null>;
