// TypeScript definitions for the C3 type TestPersistable

/**
 * Type for testing persistable data
 *
 * @remarks this represents a value passed to a method that expects an instance of TestPersistable
 */
declare interface ITestPersistable {
  ...
  /**
   * A dummy field to allow grouping
   */
 ...
 * Type for testing persistable data
 *
 * @remarks this represents a made instance of TestPersistable
 */
declare class TestPersistable extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): TestPersistable | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): TestPersistable | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): TestPersistable | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): TestPersistable | null;
   ...
   */
  replaceType(old: Type, new_: Type): TestPersistable;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): TestPersistable;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): TestPersistable;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<TestPersistable | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<TestPersistable | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): TestPersistable;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TestPersistable;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TestPersistable;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): TestPersistable;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): TestPersistable;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): TestPersistable;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): TestPersistable;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): TestPersistable;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): TestPersistable;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): TestPersistable;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): TestPersistable;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): TestPersistable;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): TestPersistable;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): TestPersistable;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): TestPersistable;
   ...
   * @see #unsetField
   */
  defaultField(field: string): TestPersistable;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): TestPersistable;
   ...
   * @see #removeField
   */
  unsetField(field: string): TestPersistable;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): TestPersistable;
   ...
   * @see #unsetField
   */
  removeField(field: string): TestPersistable;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): TestPersistable;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): TestPersistable;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): TestPersistable;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): TestPersistable;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): TestPersistable;

  mergeJson(json: any | null): TestPersistable;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): TestPersistable;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): TestPersistable;
   ...
   */
  singletonArray(): C3.Array<TestPersistable | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<TestPersistable | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<TestPersistable | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<TestPersistable | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<TestPersistable | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, TestPersistable | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, TestPersistable | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<TestPersistable | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<TestPersistable | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): TestPersistable;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): TestPersistable;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): TestPersistable;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): TestPersistable;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): TestPersistable;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): TestPersistable;
   ...
   * @see #fromString
   */
  static make(s: string | null): TestPersistable | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): TestPersistable;
   ...
   */
  static cachedEmptyInst(): TestPersistable;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<TestPersistable>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): TestPersistable;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<TestPersistable | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<TestPersistable | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<TestPersistable | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<TestPersistable | null> | null>;
   ...
   */
  get(include?: string | null): TestPersistable | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): TestPersistable | null;
   ...
   */
  getMissing(spec: GetMissingSpec): TestPersistable;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): TestPersistable | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): TestPersistable;
   ...
   * @see #toString
   */
  static fromString(s: string | null): TestPersistable | null;
   ...
   */
  create(spec?: UpsertSpec | null): TestPersistable | null;
   ...
   */
  static createBatch(objs: C3.Array<TestPersistable | null> | null, spec?: UpsertSpec | null): ObjList<TestPersistable | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<TestPersistable | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<TestPersistable | null> | null;
   ...
   */
  update(srcObj?: TestPersistable | null, spec?: UpsertSpec | null): TestPersistable | null;
   ...
   */
  upsert(srcObj?: TestPersistable | null, spec?: UpsertSpec | null): TestPersistable | null;
   ...
   */
  merge(spec?: MergeSpec | null): TestPersistable | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): TestPersistable | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): TestPersistable | null;
   ...
   */
  static updateBatch(objs: C3.Array<TestPersistable | null> | null, srcObjs?: C3.Array<TestPersistable | null>, spec?: UpsertSpec | null): ObjList<TestPersistable | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<TestPersistable | null>>, spec?: UpsertSpec | null): ObjList<TestPersistable | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<TestPersistable | null> | null, srcObjs?: C3.Array<TestPersistable | null>, spec?: UpsertSpec | null): ObjList<TestPersistable | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<TestPersistable | null>>, spec?: UpsertSpec | null): ObjList<TestPersistable | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<TestPersistable | null> | null, spec?: TouchSpec | null): ObjList<TestPersistable | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<TestPersistable | null> | null, spec?: MergeSpec | null): ObjList<TestPersistable | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<TestPersistable | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<TestPersistable | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<TestPersistable | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<TestPersistable | null> | null;
   ...
   */
  static mergeAll(mergeObj: TestPersistable | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: TestPersistable | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<TestPersistable | null> | null, spec?: UpsertSpec | null): ObjList<TestPersistable | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<TestPersistable | null> | null, spec?: UpsertSpec | null): ObjList<TestPersistable | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<TestPersistable | null> | null): ObjList<TestPersistable | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<TestPersistable | null> | null): ObjList<TestPersistable | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<TestPersistable | null> | null): ObjList<TestPersistable | null>;
   ...
   */
  static afterCreate(objs: C3.Array<TestPersistable | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<TestPersistable | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<TestPersistable | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<TestPersistable | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<TestPersistable | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): TestPersistable | null;
   ...
   */
  withoutIdentity(): TestPersistable | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<TestPersistable | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: TestPersistable | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<TestPersistable | null> | null, callback?: λFunction<TestPersistable | null, TestPersistable | null> | null): ObjList<TestPersistable | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<TestPersistable | null> | null, callback?: λFunction<TestPersistable | null, TestPersistable | null> | null): C3.Array<ObjError | null>;
