// TypeScript definitions for the C3 type TSPerfTestResult

/**
 * @remarks this represents a value passed to a method that expects an instance of TSPerfTestResult
 */
declare interface ITSPerfTestResult {
   ...
   */
  normMode?: string | null;

  /**
   * in seconds
   */
  totalDataLoadTime?: number | null;

  /**
   * in seconds
   */
  totalNormTime?: number | null;

  /**
   * normalization start time
   */
  normStartTime?: DateTime | Date | string | null;

  /**
   * normalization end time
   */
  normEndTime?: DateTime | Date | string | null;

  splunkQuery?: string | null;
 ...
 */
declare class TSPerfTestResult extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): TSPerfTestResult | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): TSPerfTestResult | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): TSPerfTestResult | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): TSPerfTestResult | null;
   ...
   */
  replaceType(old: Type, new_: Type): TSPerfTestResult;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): TSPerfTestResult;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): TSPerfTestResult;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<TSPerfTestResult | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<TSPerfTestResult | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): TSPerfTestResult;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TSPerfTestResult;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TSPerfTestResult;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): TSPerfTestResult;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): TSPerfTestResult;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): TSPerfTestResult;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): TSPerfTestResult;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): TSPerfTestResult;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): TSPerfTestResult;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): TSPerfTestResult;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): TSPerfTestResult;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): TSPerfTestResult;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): TSPerfTestResult;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): TSPerfTestResult;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): TSPerfTestResult;
   ...
   * @see #unsetField
   */
  defaultField(field: string): TSPerfTestResult;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): TSPerfTestResult;
   ...
   * @see #removeField
   */
  unsetField(field: string): TSPerfTestResult;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): TSPerfTestResult;
   ...
   * @see #unsetField
   */
  removeField(field: string): TSPerfTestResult;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): TSPerfTestResult;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): TSPerfTestResult;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): TSPerfTestResult;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): TSPerfTestResult;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): TSPerfTestResult;

  mergeJson(json: any | null): TSPerfTestResult;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): TSPerfTestResult;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): TSPerfTestResult;
   ...
   */
  singletonArray(): C3.Array<TSPerfTestResult | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<TSPerfTestResult | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<TSPerfTestResult | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<TSPerfTestResult | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<TSPerfTestResult | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, TSPerfTestResult | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, TSPerfTestResult | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<TSPerfTestResult | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<TSPerfTestResult | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): TSPerfTestResult;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): TSPerfTestResult;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): TSPerfTestResult;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): TSPerfTestResult;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): TSPerfTestResult;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): TSPerfTestResult;
   ...
   * @see #fromString
   */
  static make(s: string | null): TSPerfTestResult | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): TSPerfTestResult;
   ...
   */
  static cachedEmptyInst(): TSPerfTestResult;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<TSPerfTestResult>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): TSPerfTestResult;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<TSPerfTestResult | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<TSPerfTestResult | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<TSPerfTestResult | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<TSPerfTestResult | null> | null>;
   ...
   */
  get(include?: string | null): TSPerfTestResult | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): TSPerfTestResult | null;
   ...
   */
  getMissing(spec: GetMissingSpec): TSPerfTestResult;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): TSPerfTestResult | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): TSPerfTestResult;
   ...
   * @see #toString
   */
  static fromString(s: string | null): TSPerfTestResult | null;
   ...
   */
  create(spec?: UpsertSpec | null): TSPerfTestResult | null;
   ...
   */
  static createBatch(objs: C3.Array<TSPerfTestResult | null> | null, spec?: UpsertSpec | null): ObjList<TSPerfTestResult | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<TSPerfTestResult | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<TSPerfTestResult | null> | null;
   ...
   */
  update(srcObj?: TSPerfTestResult | null, spec?: UpsertSpec | null): TSPerfTestResult | null;
   ...
   */
  upsert(srcObj?: TSPerfTestResult | null, spec?: UpsertSpec | null): TSPerfTestResult | null;
   ...
   */
  merge(spec?: MergeSpec | null): TSPerfTestResult | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): TSPerfTestResult | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): TSPerfTestResult | null;
   ...
   */
  static updateBatch(objs: C3.Array<TSPerfTestResult | null> | null, srcObjs?: C3.Array<TSPerfTestResult | null>, spec?: UpsertSpec | null): ObjList<TSPerfTestResult | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<TSPerfTestResult | null>>, spec?: UpsertSpec | null): ObjList<TSPerfTestResult | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<TSPerfTestResult | null> | null, srcObjs?: C3.Array<TSPerfTestResult | null>, spec?: UpsertSpec | null): ObjList<TSPerfTestResult | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<TSPerfTestResult | null>>, spec?: UpsertSpec | null): ObjList<TSPerfTestResult | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<TSPerfTestResult | null> | null, spec?: TouchSpec | null): ObjList<TSPerfTestResult | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<TSPerfTestResult | null> | null, spec?: MergeSpec | null): ObjList<TSPerfTestResult | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<TSPerfTestResult | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<TSPerfTestResult | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<TSPerfTestResult | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<TSPerfTestResult | null> | null;
   ...
   */
  static mergeAll(mergeObj: TSPerfTestResult | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: TSPerfTestResult | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<TSPerfTestResult | null> | null, spec?: UpsertSpec | null): ObjList<TSPerfTestResult | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<TSPerfTestResult | null> | null, spec?: UpsertSpec | null): ObjList<TSPerfTestResult | null> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): TSPerfTestResult | null;
   ...
   */
  static beforeCreate(objs: C3.Array<TSPerfTestResult | null> | null): ObjList<TSPerfTestResult | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<TSPerfTestResult | null> | null): ObjList<TSPerfTestResult | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<TSPerfTestResult | null> | null): ObjList<TSPerfTestResult | null>;
   ...
   */
  static afterCreate(objs: C3.Array<TSPerfTestResult | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<TSPerfTestResult | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<TSPerfTestResult | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<TSPerfTestResult | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<TSPerfTestResult | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): TSPerfTestResult | null;
   ...
   */
  withoutIdentity(): TSPerfTestResult | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<TSPerfTestResult | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: TSPerfTestResult | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<TSPerfTestResult | null> | null, callback?: λFunction<TSPerfTestResult | null, TSPerfTestResult | null> | null): ObjList<TSPerfTestResult | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<TSPerfTestResult | null> | null, callback?: λFunction<TSPerfTestResult | null, TSPerfTestResult | null> | null): C3.Array<ObjError | null>;
