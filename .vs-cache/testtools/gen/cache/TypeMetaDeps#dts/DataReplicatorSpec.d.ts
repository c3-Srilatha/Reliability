// TypeScript definitions for the C3 type DataReplicatorSpec

/**
 * Spec that configures the replication, post-replication and sanity check processes during setup
 *
 * @remarks this represents a value passed to a method that expects an instance of DataReplicatorSpec
 */
declare interface IDataReplicatorSpec {
   ...
   */
  data: C3.Array<CanonicalReplicationSpec | null> | Array<ICanonicalReplicationSpec | null>;
   ...
   */
  postReplication?: λBiConsumer<DateTime | null, DateTime | null> | null;
   ...
   */
  sanityCheck?: λBiPredicate<DateTime | null, DateTime | null> | null;
}
 ...
 */
declare class DataReplicatorSpec extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): DataReplicatorSpec | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): DataReplicatorSpec | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): DataReplicatorSpec | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): DataReplicatorSpec | null;
   ...
   */
  replaceType(old: Type, new_: Type): DataReplicatorSpec;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): DataReplicatorSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): DataReplicatorSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<DataReplicatorSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<DataReplicatorSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): DataReplicatorSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DataReplicatorSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DataReplicatorSpec;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): DataReplicatorSpec;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): DataReplicatorSpec;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): DataReplicatorSpec;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): DataReplicatorSpec;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): DataReplicatorSpec;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): DataReplicatorSpec;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): DataReplicatorSpec;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): DataReplicatorSpec;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): DataReplicatorSpec;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): DataReplicatorSpec;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): DataReplicatorSpec;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): DataReplicatorSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: string): DataReplicatorSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): DataReplicatorSpec;
   ...
   * @see #removeField
   */
  unsetField(field: string): DataReplicatorSpec;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): DataReplicatorSpec;
   ...
   * @see #unsetField
   */
  removeField(field: string): DataReplicatorSpec;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): DataReplicatorSpec;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): DataReplicatorSpec;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): DataReplicatorSpec;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): DataReplicatorSpec;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): DataReplicatorSpec;

  mergeJson(json: any | null): DataReplicatorSpec;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): DataReplicatorSpec;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): DataReplicatorSpec;
   ...
   */
  singletonArray(): C3.Array<DataReplicatorSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<DataReplicatorSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<DataReplicatorSpec | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<DataReplicatorSpec | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<DataReplicatorSpec | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, DataReplicatorSpec | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, DataReplicatorSpec | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<DataReplicatorSpec | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<DataReplicatorSpec | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): DataReplicatorSpec;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): DataReplicatorSpec;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): DataReplicatorSpec;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): DataReplicatorSpec;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): DataReplicatorSpec;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): DataReplicatorSpec;
   ...
   * @see #fromString
   */
  static make(s: string | null): DataReplicatorSpec | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): DataReplicatorSpec;
   ...
   */
  static cachedEmptyInst(): DataReplicatorSpec;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<DataReplicatorSpec>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): DataReplicatorSpec;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<DataReplicatorSpec | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<DataReplicatorSpec | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<DataReplicatorSpec | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<DataReplicatorSpec | null> | null>;
   ...
   */
  get(include?: string | null): DataReplicatorSpec | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): DataReplicatorSpec | null;
   ...
   */
  getMissing(spec: GetMissingSpec): DataReplicatorSpec;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): DataReplicatorSpec | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): DataReplicatorSpec;
   ...
   * @see #toString
   */
  static fromString(s: string | null): DataReplicatorSpec | null;
   ...
   */
  create(spec?: UpsertSpec | null): DataReplicatorSpec | null;
   ...
   */
  static createBatch(objs: C3.Array<DataReplicatorSpec | null> | null, spec?: UpsertSpec | null): ObjList<DataReplicatorSpec | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<DataReplicatorSpec | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<DataReplicatorSpec | null> | null;
   ...
   */
  update(srcObj?: DataReplicatorSpec | null, spec?: UpsertSpec | null): DataReplicatorSpec | null;
   ...
   */
  upsert(srcObj?: DataReplicatorSpec | null, spec?: UpsertSpec | null): DataReplicatorSpec | null;
   ...
   */
  merge(spec?: MergeSpec | null): DataReplicatorSpec | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): DataReplicatorSpec | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): DataReplicatorSpec | null;
   ...
   */
  static updateBatch(objs: C3.Array<DataReplicatorSpec | null> | null, srcObjs?: C3.Array<DataReplicatorSpec | null>, spec?: UpsertSpec | null): ObjList<DataReplicatorSpec | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<DataReplicatorSpec | null>>, spec?: UpsertSpec | null): ObjList<DataReplicatorSpec | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<DataReplicatorSpec | null> | null, srcObjs?: C3.Array<DataReplicatorSpec | null>, spec?: UpsertSpec | null): ObjList<DataReplicatorSpec | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<DataReplicatorSpec | null>>, spec?: UpsertSpec | null): ObjList<DataReplicatorSpec | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<DataReplicatorSpec | null> | null, spec?: TouchSpec | null): ObjList<DataReplicatorSpec | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<DataReplicatorSpec | null> | null, spec?: MergeSpec | null): ObjList<DataReplicatorSpec | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<DataReplicatorSpec | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<DataReplicatorSpec | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<DataReplicatorSpec | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<DataReplicatorSpec | null> | null;
   ...
   */
  static mergeAll(mergeObj: DataReplicatorSpec | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: DataReplicatorSpec | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<DataReplicatorSpec | null> | null, spec?: UpsertSpec | null): ObjList<DataReplicatorSpec | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<DataReplicatorSpec | null> | null, spec?: UpsertSpec | null): ObjList<DataReplicatorSpec | null> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): DataReplicatorSpec | null;
   ...
   */
  static beforeCreate(objs: C3.Array<DataReplicatorSpec | null> | null): ObjList<DataReplicatorSpec | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<DataReplicatorSpec | null> | null): ObjList<DataReplicatorSpec | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<DataReplicatorSpec | null> | null): ObjList<DataReplicatorSpec | null>;
   ...
   */
  static afterCreate(objs: C3.Array<DataReplicatorSpec | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<DataReplicatorSpec | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<DataReplicatorSpec | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<DataReplicatorSpec | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<DataReplicatorSpec | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): DataReplicatorSpec | null;
   ...
   */
  withoutIdentity(): DataReplicatorSpec | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<DataReplicatorSpec | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: DataReplicatorSpec | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<DataReplicatorSpec | null> | null, callback?: λFunction<DataReplicatorSpec | null, DataReplicatorSpec | null> | null): ObjList<DataReplicatorSpec | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<DataReplicatorSpec | null> | null, callback?: λFunction<DataReplicatorSpec | null, DataReplicatorSpec | null> | null): C3.Array<ObjError | null>;
