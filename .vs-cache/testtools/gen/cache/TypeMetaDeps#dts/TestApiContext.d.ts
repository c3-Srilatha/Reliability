// TypeScript definitions for the C3 type TestApiContext
 ...
 * directly.
 *
 * @remarks this represents a value passed to a method that expects an instance of TestApiContext
 */
declare interface ITestApiContext {
   ...
   */
  removeLimit?: number | null;

  /**
   * Parent context
   */
  parent?: ITestApiContext | null;
   ...
   */
  waitForTeardown?: number | null;

  /**
   * Don't check these queues in waitForSetup
   */
  queueBlacklist?: C3.Array<Type | null> | Array<IType | null>;

  /**
   * A number of attempts to recover
   */
  tryToRecover?: number | null;

  /**
   * FileSystem (e.g. S3 or Azure) file names
   */
  fsFiles?: C3.Array<string | null> | Array<string | null>;

  /**
   * ActionMocks that have been registered with this context.
   */
  mocks?: C3.Array<Action.Spy | null> | Array<IAction.Spy | null>;

  /**
   * TestApiObjs
   */
  testApiObjs?: C3.Array<TestApiObj | null> | Array<ITestApiObj | null>;

  /**
   * An array of TestApiObj ids for {@link User}s created using this test context
   */
  testUsers?: C3.Array<string | null> | Array<string | null>;

  /**
   * Filters for tearing down
   */
  teardownFilters?: C3.Array<TestApiTearDownFilter | null> | Array<ITestApiTearDownFilter | null>;

  /**
   * Counter for creating unique ids or names for test objects
   */
  uuidCounter?: number | null;

  /**
   * c3 queues
   */
  c3Queues?: C3.Array<Type | null> | Array<IType | null>;
 ...
 */
declare class TestApiContext extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): TestApiContext | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): TestApiContext | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): TestApiContext | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): TestApiContext | null;
   ...
   */
  replaceType(old: Type, new_: Type): TestApiContext;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): TestApiContext;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): TestApiContext;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<TestApiContext | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<TestApiContext | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): TestApiContext;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TestApiContext;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TestApiContext;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): TestApiContext;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): TestApiContext;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): TestApiContext;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): TestApiContext;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): TestApiContext;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): TestApiContext;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): TestApiContext;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): TestApiContext;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): TestApiContext;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): TestApiContext;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): TestApiContext;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): TestApiContext;
   ...
   * @see #unsetField
   */
  defaultField(field: string): TestApiContext;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): TestApiContext;
   ...
   * @see #removeField
   */
  unsetField(field: string): TestApiContext;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): TestApiContext;
   ...
   * @see #unsetField
   */
  removeField(field: string): TestApiContext;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): TestApiContext;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): TestApiContext;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): TestApiContext;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): TestApiContext;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): TestApiContext;

  mergeJson(json: any | null): TestApiContext;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): TestApiContext;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): TestApiContext;
   ...
   */
  singletonArray(): C3.Array<TestApiContext | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<TestApiContext | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<TestApiContext | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<TestApiContext | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<TestApiContext | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, TestApiContext | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, TestApiContext | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<TestApiContext | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<TestApiContext | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): TestApiContext;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): TestApiContext;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): TestApiContext;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): TestApiContext;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): TestApiContext;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): TestApiContext;
   ...
   * @see #fromString
   */
  static make(s: string | null): TestApiContext | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): TestApiContext;
   ...
   */
  static cachedEmptyInst(): TestApiContext;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<TestApiContext>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): TestApiContext;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<TestApiContext | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<TestApiContext | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<TestApiContext | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<TestApiContext | null> | null>;
   ...
   */
  get(include?: string | null): TestApiContext | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): TestApiContext | null;
   ...
   */
  getMissing(spec: GetMissingSpec): TestApiContext;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): TestApiContext | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): TestApiContext;
   ...
   * @see #toString
   */
  static fromString(s: string | null): TestApiContext | null;
   ...
   */
  create(spec?: UpsertSpec | null): TestApiContext | null;
   ...
   */
  static createBatch(objs: C3.Array<TestApiContext | null> | null, spec?: UpsertSpec | null): ObjList<TestApiContext | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<TestApiContext | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<TestApiContext | null> | null;
   ...
   */
  update(srcObj?: TestApiContext | null, spec?: UpsertSpec | null): TestApiContext | null;
   ...
   */
  upsert(srcObj?: TestApiContext | null, spec?: UpsertSpec | null): TestApiContext | null;
   ...
   */
  merge(spec?: MergeSpec | null): TestApiContext | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): TestApiContext | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): TestApiContext | null;
   ...
   */
  static updateBatch(objs: C3.Array<TestApiContext | null> | null, srcObjs?: C3.Array<TestApiContext | null>, spec?: UpsertSpec | null): ObjList<TestApiContext | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<TestApiContext | null>>, spec?: UpsertSpec | null): ObjList<TestApiContext | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<TestApiContext | null> | null, srcObjs?: C3.Array<TestApiContext | null>, spec?: UpsertSpec | null): ObjList<TestApiContext | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<TestApiContext | null>>, spec?: UpsertSpec | null): ObjList<TestApiContext | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<TestApiContext | null> | null, spec?: TouchSpec | null): ObjList<TestApiContext | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<TestApiContext | null> | null, spec?: MergeSpec | null): ObjList<TestApiContext | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<TestApiContext | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<TestApiContext | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<TestApiContext | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<TestApiContext | null> | null;
   ...
   */
  static mergeAll(mergeObj: TestApiContext | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: TestApiContext | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<TestApiContext | null> | null, spec?: UpsertSpec | null): ObjList<TestApiContext | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<TestApiContext | null> | null, spec?: UpsertSpec | null): ObjList<TestApiContext | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<TestApiContext | null> | null): ObjList<TestApiContext | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<TestApiContext | null> | null): ObjList<TestApiContext | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<TestApiContext | null> | null): ObjList<TestApiContext | null>;
   ...
   */
  static afterCreate(objs: C3.Array<TestApiContext | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<TestApiContext | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<TestApiContext | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<TestApiContext | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<TestApiContext | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): TestApiContext | null;
   ...
   */
  withoutIdentity(): TestApiContext | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<TestApiContext | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: TestApiContext | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<TestApiContext | null> | null, callback?: λFunction<TestApiContext | null, TestApiContext | null> | null): ObjList<TestApiContext | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<TestApiContext | null> | null, callback?: λFunction<TestApiContext | null, TestApiContext | null> | null): C3.Array<ObjError | null>;
   ...
   */
  uuid(uuidCounterValue?: number | null): string | null;

  reserveUuids(count: number): number | null;
   ...
   * @return unique name
   */
  uniqueName(name?: string | null, uuidCounterValue?: number | null): string | null;
   ...
   */
  findObjectById(id: string, typeRef: Type): TestApiObj | null;
   ...
   */
  removeObjectById(id: string, typeRef: Type): number | null;
   ...
   */
  removeObjectByParent(id: string, typeRef: Type): number | null;
   ...
   */
  addTeardownFilter(filter?: string | null, typeRef?: Type | null, limit?: number | null): void;
   ...
   * @return
   */
  getTeardownFilters(): C3.Array<TestApiTearDownFilter | null>;
   ...
   */
  setRemoveLimit(limit?: number | null): void;
   ...
   */
  disableQueues(queues?: C3.Array<Type | null>): void;
   ...
   * @param var_args InvalidationQueue(s) to disable
   */
  enableQueues(queues?: C3.Array<Type | null>): void;

  /**
   * Return list of blacklisted (disabled) queues
   * @return
   */
  getQueueBlacklist(): C3.Array<Type | null>;
   ...
   */
  setWaitForTeardown(waitForTeardown?: number | null): void;
  ...
  setField(fieldName?: string | null, value?: any): void;
}
