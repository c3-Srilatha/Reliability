// TypeScript definitions for the C3 type TestCassandraType

/**
 * @remarks this represents a value passed to a method that expects an instance of TestCassandraType
 */
declare interface ITestCassandraType {
...
/**
 * @remarks this represents a made instance of TestCassandraType
 */
declare class TestCassandraType extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): TestCassandraType | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): TestCassandraType | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): TestCassandraType | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): TestCassandraType | null;
   ...
   */
  replaceType(old: Type, new_: Type): TestCassandraType;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): TestCassandraType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): TestCassandraType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<TestCassandraType | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<TestCassandraType | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): TestCassandraType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TestCassandraType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TestCassandraType;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): TestCassandraType;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): TestCassandraType;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): TestCassandraType;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): TestCassandraType;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): TestCassandraType;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): TestCassandraType;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): TestCassandraType;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): TestCassandraType;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): TestCassandraType;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): TestCassandraType;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): TestCassandraType;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): TestCassandraType;
   ...
   * @see #unsetField
   */
  defaultField(field: string): TestCassandraType;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): TestCassandraType;
   ...
   * @see #removeField
   */
  unsetField(field: string): TestCassandraType;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): TestCassandraType;
   ...
   * @see #unsetField
   */
  removeField(field: string): TestCassandraType;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): TestCassandraType;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): TestCassandraType;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): TestCassandraType;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): TestCassandraType;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): TestCassandraType;

  mergeJson(json: any | null): TestCassandraType;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): TestCassandraType;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): TestCassandraType;
   ...
   */
  singletonArray(): C3.Array<TestCassandraType | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<TestCassandraType | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<TestCassandraType | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<TestCassandraType | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<TestCassandraType | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, TestCassandraType | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, TestCassandraType | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<TestCassandraType | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<TestCassandraType | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): TestCassandraType;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): TestCassandraType;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): TestCassandraType;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): TestCassandraType;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): TestCassandraType;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): TestCassandraType;
   ...
   * @see #fromString
   */
  static make(s: string | null): TestCassandraType | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): TestCassandraType;
   ...
   */
  static cachedEmptyInst(): TestCassandraType;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<TestCassandraType>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): TestCassandraType;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<TestCassandraType | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<TestCassandraType | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<TestCassandraType | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<TestCassandraType | null> | null>;
   ...
   */
  get(include?: string | null): TestCassandraType | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): TestCassandraType | null;
   ...
   */
  getMissing(spec: GetMissingSpec): TestCassandraType;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): TestCassandraType | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): TestCassandraType;
   ...
   * @see #toString
   */
  static fromString(s: string | null): TestCassandraType | null;
   ...
   */
  create(spec?: UpsertSpec | null): TestCassandraType | null;
   ...
   */
  static createBatch(objs: C3.Array<TestCassandraType | null> | null, spec?: UpsertSpec | null): ObjList<TestCassandraType | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<TestCassandraType | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<TestCassandraType | null> | null;
   ...
   */
  update(srcObj?: TestCassandraType | null, spec?: UpsertSpec | null): TestCassandraType | null;
   ...
   */
  upsert(srcObj?: TestCassandraType | null, spec?: UpsertSpec | null): TestCassandraType | null;
   ...
   */
  merge(spec?: MergeSpec | null): TestCassandraType | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): TestCassandraType | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): TestCassandraType | null;
   ...
   */
  static updateBatch(objs: C3.Array<TestCassandraType | null> | null, srcObjs?: C3.Array<TestCassandraType | null>, spec?: UpsertSpec | null): ObjList<TestCassandraType | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<TestCassandraType | null>>, spec?: UpsertSpec | null): ObjList<TestCassandraType | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<TestCassandraType | null> | null, srcObjs?: C3.Array<TestCassandraType | null>, spec?: UpsertSpec | null): ObjList<TestCassandraType | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<TestCassandraType | null>>, spec?: UpsertSpec | null): ObjList<TestCassandraType | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<TestCassandraType | null> | null, spec?: TouchSpec | null): ObjList<TestCassandraType | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<TestCassandraType | null> | null, spec?: MergeSpec | null): ObjList<TestCassandraType | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<TestCassandraType | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<TestCassandraType | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<TestCassandraType | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<TestCassandraType | null> | null;
   ...
   */
  static mergeAll(mergeObj: TestCassandraType | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: TestCassandraType | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<TestCassandraType | null> | null, spec?: UpsertSpec | null): ObjList<TestCassandraType | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<TestCassandraType | null> | null, spec?: UpsertSpec | null): ObjList<TestCassandraType | null> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): TestCassandraType | null;
   ...
   */
  static beforeCreate(objs: C3.Array<TestCassandraType | null> | null): ObjList<TestCassandraType | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<TestCassandraType | null> | null): ObjList<TestCassandraType | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<TestCassandraType | null> | null): ObjList<TestCassandraType | null>;
   ...
   */
  static afterCreate(objs: C3.Array<TestCassandraType | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<TestCassandraType | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<TestCassandraType | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<TestCassandraType | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<TestCassandraType | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): TestCassandraType | null;
   ...
   */
  withoutIdentity(): TestCassandraType | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<TestCassandraType | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: TestCassandraType | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<TestCassandraType | null> | null, callback?: λFunction<TestCassandraType | null, TestCassandraType | null> | null): ObjList<TestCassandraType | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<TestCassandraType | null> | null, callback?: λFunction<TestCassandraType | null, TestCassandraType | null> | null): C3.Array<ObjError | null>;
