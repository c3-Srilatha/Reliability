// TypeScript definitions for the C3 type TestSpyAnimalBatchJob

/**
 * BatchJob to call TestSpyAnimal#createAnimal
 *
 * @remarks this represents a value passed to a method that expects an instance of TestSpyAnimalBatchJob
 */
declare interface ITestSpyAnimalBatchJob {
 ...
 */
declare class TestSpyAnimalBatchJob extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): TestSpyAnimalBatchJob | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): TestSpyAnimalBatchJob | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): TestSpyAnimalBatchJob | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): TestSpyAnimalBatchJob | null;
   ...
   */
  replaceType(old: Type, new_: Type): TestSpyAnimalBatchJob;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): TestSpyAnimalBatchJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): TestSpyAnimalBatchJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<TestSpyAnimalBatchJob | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<TestSpyAnimalBatchJob | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): TestSpyAnimalBatchJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TestSpyAnimalBatchJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TestSpyAnimalBatchJob;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): TestSpyAnimalBatchJob;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): TestSpyAnimalBatchJob;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): TestSpyAnimalBatchJob;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): TestSpyAnimalBatchJob;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): TestSpyAnimalBatchJob;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): TestSpyAnimalBatchJob;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): TestSpyAnimalBatchJob;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): TestSpyAnimalBatchJob;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): TestSpyAnimalBatchJob;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): TestSpyAnimalBatchJob;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): TestSpyAnimalBatchJob;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): TestSpyAnimalBatchJob;
   ...
   * @see #unsetField
   */
  defaultField(field: string): TestSpyAnimalBatchJob;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): TestSpyAnimalBatchJob;
   ...
   * @see #removeField
   */
  unsetField(field: string): TestSpyAnimalBatchJob;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): TestSpyAnimalBatchJob;
   ...
   * @see #unsetField
   */
  removeField(field: string): TestSpyAnimalBatchJob;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): TestSpyAnimalBatchJob;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): TestSpyAnimalBatchJob;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): TestSpyAnimalBatchJob;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): TestSpyAnimalBatchJob;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): TestSpyAnimalBatchJob;

  mergeJson(json: any | null): TestSpyAnimalBatchJob;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): TestSpyAnimalBatchJob;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): TestSpyAnimalBatchJob;
   ...
   */
  singletonArray(): C3.Array<TestSpyAnimalBatchJob | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<TestSpyAnimalBatchJob | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<TestSpyAnimalBatchJob | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<TestSpyAnimalBatchJob | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<TestSpyAnimalBatchJob | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, TestSpyAnimalBatchJob | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, TestSpyAnimalBatchJob | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<TestSpyAnimalBatchJob | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<TestSpyAnimalBatchJob | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): TestSpyAnimalBatchJob;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): TestSpyAnimalBatchJob;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): TestSpyAnimalBatchJob;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): TestSpyAnimalBatchJob;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): TestSpyAnimalBatchJob;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): TestSpyAnimalBatchJob;
   ...
   * @see #fromString
   */
  static make(s: string | null): TestSpyAnimalBatchJob | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): TestSpyAnimalBatchJob;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): TestSpyAnimalBatchJob;
   ...
   */
  static cachedEmptyInst(): TestSpyAnimalBatchJob;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<TestSpyAnimalBatchJob>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): TestSpyAnimalBatchJob;
   ...
   */
  start(options?: TestSpyAnimalBatchJobOptions | null): BatchJobStatus | null;
   ...
   */
  cleanup(options?: TestSpyAnimalBatchJobOptions | null): void;
  ...
  cancelJob(removeResults?: boolean, force?: boolean): JobBase<BatchJobRun | null, BatchJobStatus | null, TestSpyAnimalBatchJobOptions | null> | null;

  failJob(run: JobRun<BatchJobStatusBase | null>): JobBase<BatchJobRun | null, BatchJobStatus | null, TestSpyAnimalBatchJobOptions | null> | null;
  ...
  validateStart(options?: TestSpyAnimalBatchJobOptions | null): void;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<TestSpyAnimalBatchJob | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<TestSpyAnimalBatchJob | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<TestSpyAnimalBatchJob | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<TestSpyAnimalBatchJob | null> | null>;
   ...
   */
  get(include?: string | null): TestSpyAnimalBatchJob | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): TestSpyAnimalBatchJob | null;
   ...
   */
  getMissing(spec: GetMissingSpec): TestSpyAnimalBatchJob;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): TestSpyAnimalBatchJob | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): TestSpyAnimalBatchJob;
   ...
   * @see #toString
   */
  static fromString(s: string | null): TestSpyAnimalBatchJob | null;
   ...
   */
  create(spec?: UpsertSpec | null): TestSpyAnimalBatchJob | null;
   ...
   */
  static createBatch(objs: C3.Array<TestSpyAnimalBatchJob | null> | null, spec?: UpsertSpec | null): ObjList<TestSpyAnimalBatchJob | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<TestSpyAnimalBatchJob | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<TestSpyAnimalBatchJob | null> | null;
   ...
   */
  update(srcObj?: TestSpyAnimalBatchJob | null, spec?: UpsertSpec | null): TestSpyAnimalBatchJob | null;
   ...
   */
  upsert(srcObj?: TestSpyAnimalBatchJob | null, spec?: UpsertSpec | null): TestSpyAnimalBatchJob | null;
   ...
   */
  merge(spec?: MergeSpec | null): TestSpyAnimalBatchJob | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): TestSpyAnimalBatchJob | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): TestSpyAnimalBatchJob | null;
   ...
   */
  static updateBatch(objs: C3.Array<TestSpyAnimalBatchJob | null> | null, srcObjs?: C3.Array<TestSpyAnimalBatchJob | null>, spec?: UpsertSpec | null): ObjList<TestSpyAnimalBatchJob | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<TestSpyAnimalBatchJob | null>>, spec?: UpsertSpec | null): ObjList<TestSpyAnimalBatchJob | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<TestSpyAnimalBatchJob | null> | null, srcObjs?: C3.Array<TestSpyAnimalBatchJob | null>, spec?: UpsertSpec | null): ObjList<TestSpyAnimalBatchJob | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<TestSpyAnimalBatchJob | null>>, spec?: UpsertSpec | null): ObjList<TestSpyAnimalBatchJob | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<TestSpyAnimalBatchJob | null> | null, spec?: TouchSpec | null): ObjList<TestSpyAnimalBatchJob | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<TestSpyAnimalBatchJob | null> | null, spec?: MergeSpec | null): ObjList<TestSpyAnimalBatchJob | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<TestSpyAnimalBatchJob | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<TestSpyAnimalBatchJob | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<TestSpyAnimalBatchJob | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<TestSpyAnimalBatchJob | null> | null;
   ...
   */
  static mergeAll(mergeObj: TestSpyAnimalBatchJob | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: TestSpyAnimalBatchJob | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<TestSpyAnimalBatchJob | null> | null, spec?: UpsertSpec | null): ObjList<TestSpyAnimalBatchJob | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<TestSpyAnimalBatchJob | null> | null, spec?: UpsertSpec | null): ObjList<TestSpyAnimalBatchJob | null> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): TestSpyAnimalBatchJob | null;
   ...
   */
  static beforeCreate(objs: C3.Array<TestSpyAnimalBatchJob | null> | null): ObjList<TestSpyAnimalBatchJob | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<TestSpyAnimalBatchJob | null> | null): ObjList<TestSpyAnimalBatchJob | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<TestSpyAnimalBatchJob | null> | null): ObjList<TestSpyAnimalBatchJob | null>;
   ...
   */
  static afterCreate(objs: C3.Array<TestSpyAnimalBatchJob | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<TestSpyAnimalBatchJob | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<TestSpyAnimalBatchJob | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<TestSpyAnimalBatchJob | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<TestSpyAnimalBatchJob | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): TestSpyAnimalBatchJob | null;
   ...
   */
  withoutIdentity(): TestSpyAnimalBatchJob | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<TestSpyAnimalBatchJob | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: TestSpyAnimalBatchJob | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<TestSpyAnimalBatchJob | null> | null, callback?: λFunction<TestSpyAnimalBatchJob | null, TestSpyAnimalBatchJob | null> | null): ObjList<TestSpyAnimalBatchJob | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<TestSpyAnimalBatchJob | null> | null, callback?: λFunction<TestSpyAnimalBatchJob | null, TestSpyAnimalBatchJob | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static doStart(job?: TestSpyAnimalBatchJob | null, options?: TestSpyAnimalBatchJobOptions | null): void;
   ...
   */
  static processBatch(batch?: TestSpyAnimalBatch | null, job?: TestSpyAnimalBatchJob | null, options?: TestSpyAnimalBatchJobOptions | null): void;
   ...
   */
  static allComplete(job: TestSpyAnimalBatchJob, options?: TestSpyAnimalBatchJobOptions | null): string | null;
   ...
   *           Options the job was run with.
   */
  static failed(job: TestSpyAnimalBatchJob, status: BatchJobStatus, options?: TestSpyAnimalBatchJobOptions | null): void;
   ...
   *        Batch to schedule.
   */
  scheduleBatch(batch?: TestSpyAnimalBatch | null): void;
   ...
   *        Batches to schedule.
   */
  scheduleBatches(batches?: C3.Array<TestSpyAnimalBatch | null>): void;
   ...
   */
  static scheduleObjBatch(job?: TestSpyAnimalBatchJob | null, objBatch?: ObjBatch | null, logPrefix?: string | null): number | null;
