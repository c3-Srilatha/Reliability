// TypeScript definitions for the C3 type TestActionMock

/**
 * @remarks this represents a value passed to a method that expects an instance of TestActionMock
 */
declare interface ITestActionMock {
  ...
  actionSpy?: IAction.Spy | null;
}

/**
 * @remarks this represents a made instance of TestActionMock
 */
declare class TestActionMock extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): TestActionMock | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): TestActionMock | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): TestActionMock | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): TestActionMock | null;
   ...
   */
  replaceType(old: Type, new_: Type): TestActionMock;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): TestActionMock;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): TestActionMock;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<TestActionMock | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<TestActionMock | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): TestActionMock;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TestActionMock;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TestActionMock;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): TestActionMock;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): TestActionMock;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): TestActionMock;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): TestActionMock;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): TestActionMock;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): TestActionMock;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): TestActionMock;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): TestActionMock;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): TestActionMock;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): TestActionMock;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): TestActionMock;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): TestActionMock;
   ...
   * @see #unsetField
   */
  defaultField(field: string): TestActionMock;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): TestActionMock;
   ...
   * @see #removeField
   */
  unsetField(field: string): TestActionMock;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): TestActionMock;
   ...
   * @see #unsetField
   */
  removeField(field: string): TestActionMock;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): TestActionMock;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): TestActionMock;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): TestActionMock;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): TestActionMock;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): TestActionMock;

  mergeJson(json: any | null): TestActionMock;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): TestActionMock;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): TestActionMock;
   ...
   */
  singletonArray(): C3.Array<TestActionMock | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<TestActionMock | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<TestActionMock | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<TestActionMock | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<TestActionMock | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, TestActionMock | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, TestActionMock | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<TestActionMock | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<TestActionMock | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): TestActionMock;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): TestActionMock;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): TestActionMock;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): TestActionMock;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): TestActionMock;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): TestActionMock;
   ...
   * @see #fromString
   */
  static make(s: string | null): TestActionMock | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): TestActionMock;
   ...
   */
  static cachedEmptyInst(): TestActionMock;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<TestActionMock>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): TestActionMock;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<TestActionMock | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<TestActionMock | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<TestActionMock | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<TestActionMock | null> | null>;
   ...
   */
  get(include?: string | null): TestActionMock | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): TestActionMock | null;
   ...
   */
  getMissing(spec: GetMissingSpec): TestActionMock;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): TestActionMock | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): TestActionMock;
   ...
   * @see #toString
   */
  static fromString(s: string | null): TestActionMock | null;
   ...
   */
  create(spec?: UpsertSpec | null): TestActionMock | null;
   ...
   */
  static createBatch(objs: C3.Array<TestActionMock | null> | null, spec?: UpsertSpec | null): ObjList<TestActionMock | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<TestActionMock | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<TestActionMock | null> | null;
   ...
   */
  update(srcObj?: TestActionMock | null, spec?: UpsertSpec | null): TestActionMock | null;
   ...
   */
  upsert(srcObj?: TestActionMock | null, spec?: UpsertSpec | null): TestActionMock | null;
   ...
   */
  merge(spec?: MergeSpec | null): TestActionMock | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): TestActionMock | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): TestActionMock | null;
   ...
   */
  static updateBatch(objs: C3.Array<TestActionMock | null> | null, srcObjs?: C3.Array<TestActionMock | null>, spec?: UpsertSpec | null): ObjList<TestActionMock | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<TestActionMock | null>>, spec?: UpsertSpec | null): ObjList<TestActionMock | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<TestActionMock | null> | null, srcObjs?: C3.Array<TestActionMock | null>, spec?: UpsertSpec | null): ObjList<TestActionMock | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<TestActionMock | null>>, spec?: UpsertSpec | null): ObjList<TestActionMock | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<TestActionMock | null> | null, spec?: TouchSpec | null): ObjList<TestActionMock | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<TestActionMock | null> | null, spec?: MergeSpec | null): ObjList<TestActionMock | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<TestActionMock | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<TestActionMock | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<TestActionMock | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<TestActionMock | null> | null;
   ...
   */
  static mergeAll(mergeObj: TestActionMock | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: TestActionMock | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<TestActionMock | null> | null, spec?: UpsertSpec | null): ObjList<TestActionMock | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<TestActionMock | null> | null, spec?: UpsertSpec | null): ObjList<TestActionMock | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<TestActionMock | null> | null): ObjList<TestActionMock | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<TestActionMock | null> | null): ObjList<TestActionMock | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<TestActionMock | null> | null): ObjList<TestActionMock | null>;
   ...
   */
  static afterCreate(objs: C3.Array<TestActionMock | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<TestActionMock | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<TestActionMock | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<TestActionMock | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<TestActionMock | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): TestActionMock | null;
   ...
   */
  withoutIdentity(): TestActionMock | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<TestActionMock | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: TestActionMock | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<TestActionMock | null> | null, callback?: λFunction<TestActionMock | null, TestActionMock | null> | null): ObjList<TestActionMock | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<TestActionMock | null> | null, callback?: λFunction<TestActionMock | null, TestActionMock | null> | null): C3.Array<ObjError | null>;
   ...
   */
  callArgs(): C3.Array<C3.Map<string | null, any>>;

  /**
   * Register all action mocks.
   */
  static registerAll(group?: string | null): void;

  /**
   * Unregister action mocks.
   */
  static unregisterAll(group?: string | null): void;

  /**
   * @return all registered action mocks.
   */
  static allRegistered(group?: string | null): C3.Array<TestActionMock | null>;

  internalSpy(): Action.Spy | null;
}
