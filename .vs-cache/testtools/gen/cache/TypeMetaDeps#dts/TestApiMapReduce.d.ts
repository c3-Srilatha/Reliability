// TypeScript definitions for the C3 type TestApiMapReduce
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of TestApiMapReduce
 */
declare interface ITestApiMapReduce {
 ...
 */
declare class TestApiMapReduce extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): TestApiMapReduce | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): TestApiMapReduce | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): TestApiMapReduce | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): TestApiMapReduce | null;
   ...
   */
  replaceType(old: Type, new_: Type): TestApiMapReduce;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): TestApiMapReduce;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): TestApiMapReduce;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<TestApiMapReduce | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<TestApiMapReduce | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): TestApiMapReduce;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TestApiMapReduce;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TestApiMapReduce;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): TestApiMapReduce;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): TestApiMapReduce;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): TestApiMapReduce;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): TestApiMapReduce;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): TestApiMapReduce;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): TestApiMapReduce;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): TestApiMapReduce;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): TestApiMapReduce;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): TestApiMapReduce;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): TestApiMapReduce;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): TestApiMapReduce;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): TestApiMapReduce;
   ...
   * @see #unsetField
   */
  defaultField(field: string): TestApiMapReduce;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): TestApiMapReduce;
   ...
   * @see #removeField
   */
  unsetField(field: string): TestApiMapReduce;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): TestApiMapReduce;
   ...
   * @see #unsetField
   */
  removeField(field: string): TestApiMapReduce;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): TestApiMapReduce;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): TestApiMapReduce;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): TestApiMapReduce;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): TestApiMapReduce;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): TestApiMapReduce;

  mergeJson(json: any | null): TestApiMapReduce;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): TestApiMapReduce;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): TestApiMapReduce;
   ...
   */
  singletonArray(): C3.Array<TestApiMapReduce | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<TestApiMapReduce | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<TestApiMapReduce | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<TestApiMapReduce | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<TestApiMapReduce | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, TestApiMapReduce | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, TestApiMapReduce | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<TestApiMapReduce | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<TestApiMapReduce | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): TestApiMapReduce;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): TestApiMapReduce;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): TestApiMapReduce;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): TestApiMapReduce;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): TestApiMapReduce;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): TestApiMapReduce;
   ...
   * @see #fromString
   */
  static make(s: string | null): TestApiMapReduce | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): TestApiMapReduce;
   ...
   */
  static cachedEmptyInst(): TestApiMapReduce;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<TestApiMapReduce>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): TestApiMapReduce;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<TestApiMapReduce | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<TestApiMapReduce | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<TestApiMapReduce | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<TestApiMapReduce | null> | null>;
   ...
   */
  get(include?: string | null): TestApiMapReduce | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): TestApiMapReduce | null;
   ...
   */
  getMissing(spec: GetMissingSpec): TestApiMapReduce;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): TestApiMapReduce | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): TestApiMapReduce;
   ...
   * @see #toString
   */
  static fromString(s: string | null): TestApiMapReduce | null;
   ...
   */
  create(spec?: UpsertSpec | null): TestApiMapReduce | null;
   ...
   */
  static createBatch(objs: C3.Array<TestApiMapReduce | null> | null, spec?: UpsertSpec | null): ObjList<TestApiMapReduce | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<TestApiMapReduce | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<TestApiMapReduce | null> | null;
   ...
   */
  update(srcObj?: TestApiMapReduce | null, spec?: UpsertSpec | null): TestApiMapReduce | null;
   ...
   */
  upsert(srcObj?: TestApiMapReduce | null, spec?: UpsertSpec | null): TestApiMapReduce | null;
   ...
   */
  merge(spec?: MergeSpec | null): TestApiMapReduce | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): TestApiMapReduce | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): TestApiMapReduce | null;
   ...
   */
  static updateBatch(objs: C3.Array<TestApiMapReduce | null> | null, srcObjs?: C3.Array<TestApiMapReduce | null>, spec?: UpsertSpec | null): ObjList<TestApiMapReduce | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<TestApiMapReduce | null>>, spec?: UpsertSpec | null): ObjList<TestApiMapReduce | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<TestApiMapReduce | null> | null, srcObjs?: C3.Array<TestApiMapReduce | null>, spec?: UpsertSpec | null): ObjList<TestApiMapReduce | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<TestApiMapReduce | null>>, spec?: UpsertSpec | null): ObjList<TestApiMapReduce | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<TestApiMapReduce | null> | null, spec?: TouchSpec | null): ObjList<TestApiMapReduce | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<TestApiMapReduce | null> | null, spec?: MergeSpec | null): ObjList<TestApiMapReduce | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<TestApiMapReduce | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<TestApiMapReduce | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<TestApiMapReduce | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<TestApiMapReduce | null> | null;
   ...
   */
  static mergeAll(mergeObj: TestApiMapReduce | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: TestApiMapReduce | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<TestApiMapReduce | null> | null, spec?: UpsertSpec | null): ObjList<TestApiMapReduce | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<TestApiMapReduce | null> | null, spec?: UpsertSpec | null): ObjList<TestApiMapReduce | null> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): TestApiMapReduce | null;
   ...
   */
  static beforeCreate(objs: C3.Array<TestApiMapReduce | null> | null): ObjList<TestApiMapReduce | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<TestApiMapReduce | null> | null): ObjList<TestApiMapReduce | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<TestApiMapReduce | null> | null): ObjList<TestApiMapReduce | null>;
   ...
   */
  static afterCreate(objs: C3.Array<TestApiMapReduce | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<TestApiMapReduce | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<TestApiMapReduce | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<TestApiMapReduce | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<TestApiMapReduce | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): TestApiMapReduce | null;
   ...
   */
  withoutIdentity(): TestApiMapReduce | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<TestApiMapReduce | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: TestApiMapReduce | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<TestApiMapReduce | null> | null, callback?: λFunction<TestApiMapReduce | null, TestApiMapReduce | null> | null): ObjList<TestApiMapReduce | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<TestApiMapReduce | null> | null, callback?: λFunction<TestApiMapReduce | null, TestApiMapReduce | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static map(batch?: number | null, objs?: C3.Array<TestApiMapReduceEntity | null>, job?: MapReduce<TestApiMapReduceEntity | null, string | null, string | null, string | null> | null, subBatch?: number | null): C3.Map<string | null, string | null>;
   ...
   */
  static reduce(outKey?: string | null, interValues?: C3.Array<string | null>, job?: MapReduce<TestApiMapReduceEntity | null, string | null, string | null, string | null> | null): string | null | C3.Array<string | null> | null;
   ...
   */
  static mapCompleted(job?: MapReduce<TestApiMapReduceEntity | null, string | null, string | null, string | null> | null): void;
   ...
   */
  static completed(job?: MapReduce<TestApiMapReduceEntity | null, string | null, string | null, string | null> | null): string | null;
   ...
   */
  static failed(job: MapReduce<TestApiMapReduceEntity | null, string | null, string | null, string | null>, status: MapReduceStatus, options?: MapReduceOptions | null): void;
   ...
   */
  results(limit?: number | null): C3.Map<string | null, string | null | C3.Array<string | null> | null>;
