// TypeScript definitions for the C3 type TestMetricData

/**
 * A type to store test data of a child metric
 *
 * @remarks this represents a value passed to a method that expects an instance of TestMetricData
 */
declare interface ITestMetricData {
   ...
   */
  data: C3.Array<number | null> | Array<number | null>;

  /**
   * The missing array of the child metric
   */
  missing?: C3.Array<number | null> | Array<number | null>;
 ...
 */
declare class TestMetricData extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): TestMetricData | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): TestMetricData | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): TestMetricData | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): TestMetricData | null;
   ...
   */
  replaceType(old: Type, new_: Type): TestMetricData;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): TestMetricData;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): TestMetricData;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<TestMetricData | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<TestMetricData | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): TestMetricData;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TestMetricData;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TestMetricData;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): TestMetricData;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): TestMetricData;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): TestMetricData;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): TestMetricData;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): TestMetricData;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): TestMetricData;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): TestMetricData;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): TestMetricData;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): TestMetricData;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): TestMetricData;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): TestMetricData;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): TestMetricData;
   ...
   * @see #unsetField
   */
  defaultField(field: string): TestMetricData;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): TestMetricData;
   ...
   * @see #removeField
   */
  unsetField(field: string): TestMetricData;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): TestMetricData;
   ...
   * @see #unsetField
   */
  removeField(field: string): TestMetricData;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): TestMetricData;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): TestMetricData;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): TestMetricData;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): TestMetricData;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): TestMetricData;

  mergeJson(json: any | null): TestMetricData;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): TestMetricData;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): TestMetricData;
   ...
   */
  singletonArray(): C3.Array<TestMetricData | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<TestMetricData | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<TestMetricData | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<TestMetricData | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<TestMetricData | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, TestMetricData | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, TestMetricData | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<TestMetricData | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<TestMetricData | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): TestMetricData;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): TestMetricData;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): TestMetricData;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): TestMetricData;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): TestMetricData;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): TestMetricData;
   ...
   * @see #fromString
   */
  static make(s: string | null): TestMetricData | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): TestMetricData;
   ...
   */
  static cachedEmptyInst(): TestMetricData;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<TestMetricData>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): TestMetricData;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<TestMetricData | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<TestMetricData | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<TestMetricData | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): TestMetricData | null;
   ...
   * @see findByCacheKey
   */
  static forCacheKey(key: string | null): TestMetricData | null;
   ...
   * @see findByCacheKey
   */
  getCached(): TestMetricData | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): TestMetricData | null;
   ...
   */
  static produce(key: string): TestMetricData | null;
   ...
   */
  static produceAll(): C3.Map<string | null, TestMetricData | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, TestMetricData | null>;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<TestMetricData | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<TestMetricData | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<TestMetricData | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<TestMetricData | null> | null>;
   ...
   */
  get(include?: string | null): TestMetricData | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): TestMetricData | null;
   ...
   */
  getMissing(spec: GetMissingSpec): TestMetricData;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): TestMetricData | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): TestMetricData;
   ...
   * @see #toString
   */
  static fromString(s: string | null): TestMetricData | null;
   ...
   */
  create(spec?: UpsertSpec | null): TestMetricData | null;
   ...
   */
  static createBatch(objs: C3.Array<TestMetricData | null> | null, spec?: UpsertSpec | null): ObjList<TestMetricData | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<TestMetricData | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<TestMetricData | null> | null;
   ...
   */
  update(srcObj?: TestMetricData | null, spec?: UpsertSpec | null): TestMetricData | null;
   ...
   */
  upsert(srcObj?: TestMetricData | null, spec?: UpsertSpec | null): TestMetricData | null;
   ...
   */
  merge(spec?: MergeSpec | null): TestMetricData | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): TestMetricData | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): TestMetricData | null;
   ...
   */
  static updateBatch(objs: C3.Array<TestMetricData | null> | null, srcObjs?: C3.Array<TestMetricData | null>, spec?: UpsertSpec | null): ObjList<TestMetricData | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<TestMetricData | null>>, spec?: UpsertSpec | null): ObjList<TestMetricData | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<TestMetricData | null> | null, srcObjs?: C3.Array<TestMetricData | null>, spec?: UpsertSpec | null): ObjList<TestMetricData | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<TestMetricData | null>>, spec?: UpsertSpec | null): ObjList<TestMetricData | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<TestMetricData | null> | null, spec?: TouchSpec | null): ObjList<TestMetricData | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<TestMetricData | null> | null, spec?: MergeSpec | null): ObjList<TestMetricData | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<TestMetricData | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<TestMetricData | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<TestMetricData | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<TestMetricData | null> | null;
   ...
   */
  static mergeAll(mergeObj: TestMetricData | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: TestMetricData | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<TestMetricData | null> | null, spec?: UpsertSpec | null): ObjList<TestMetricData | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<TestMetricData | null> | null, spec?: UpsertSpec | null): ObjList<TestMetricData | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<TestMetricData | null> | null): ObjList<TestMetricData | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<TestMetricData | null> | null): ObjList<TestMetricData | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<TestMetricData | null> | null): ObjList<TestMetricData | null>;
   ...
   */
  static afterCreate(objs: C3.Array<TestMetricData | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<TestMetricData | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<TestMetricData | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<TestMetricData | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<TestMetricData | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): TestMetricData | null;
   ...
   */
  withoutIdentity(): TestMetricData | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<TestMetricData | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: TestMetricData | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<TestMetricData | null> | null, callback?: λFunction<TestMetricData | null, TestMetricData | null> | null): ObjList<TestMetricData | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<TestMetricData | null> | null, callback?: λFunction<TestMetricData | null, TestMetricData | null> | null): C3.Array<ObjError | null>;
   ...
   */
  publish(subPath?: string | null, contentType?: string | null): TestMetricData;
   ...
   */
  static removeSeedDataBatch(objs?: C3.Array<SeedData | null>, spec?: UpsertSpec | null): ObjList<TestMetricData | null> | null;
   ...
   */
  createSeedData(spec?: UpsertSpec | null): TestMetricData | null;
   ...
   */
  static createSeedDataBatch(objs?: C3.Array<SeedData | null>, spec?: UpsertSpec | null): ObjList<TestMetricData | null> | null;
   ...
   */
  updateSeedData(srcObj?: SeedData | null, spec?: UpsertSpec | null): TestMetricData | null;
   ...
   */
  static updateSeedDataBatch(objs?: C3.Array<SeedData | null>, srcObjs?: C3.Array<SeedData | null>, spec?: UpsertSpec | null): ObjList<TestMetricData | null> | null;
   ...
   * @return updated obj instance, same as {@link Persistable#update} return value.
   */
  clearUserUpdates(spec?: MergeSpec | null): TestMetricData | null;
   ...
   *         {@link Persistable#updateBatch}.
   */
  static clearUserUpdatesBatch(objs?: C3.Array<SeedData | null>, spec?: MergeSpec | null): ObjList<TestMetricData | null> | null;
  ...
  dependencies(): SeedDataDeps<TestMetricData | null> | null;
