// TypeScript definitions for the C3 type TestApiMapReduceEntity

/**
 * Used explicitly for {@link TestApiMapReduce}.
 *
 * @remarks this represents a value passed to a method that expects an instance of TestApiMapReduceEntity
 */
declare interface ITestApiMapReduceEntity {
 ...
 * Used explicitly for {@link TestApiMapReduce}.
 *
 * @remarks this represents a made instance of TestApiMapReduceEntity
 */
declare class TestApiMapReduceEntity extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): TestApiMapReduceEntity | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): TestApiMapReduceEntity | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): TestApiMapReduceEntity | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): TestApiMapReduceEntity | null;
   ...
   */
  replaceType(old: Type, new_: Type): TestApiMapReduceEntity;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): TestApiMapReduceEntity;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): TestApiMapReduceEntity;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<TestApiMapReduceEntity | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<TestApiMapReduceEntity | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): TestApiMapReduceEntity;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TestApiMapReduceEntity;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TestApiMapReduceEntity;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): TestApiMapReduceEntity;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): TestApiMapReduceEntity;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): TestApiMapReduceEntity;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): TestApiMapReduceEntity;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): TestApiMapReduceEntity;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): TestApiMapReduceEntity;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): TestApiMapReduceEntity;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): TestApiMapReduceEntity;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): TestApiMapReduceEntity;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): TestApiMapReduceEntity;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): TestApiMapReduceEntity;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): TestApiMapReduceEntity;
   ...
   * @see #unsetField
   */
  defaultField(field: string): TestApiMapReduceEntity;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): TestApiMapReduceEntity;
   ...
   * @see #removeField
   */
  unsetField(field: string): TestApiMapReduceEntity;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): TestApiMapReduceEntity;
   ...
   * @see #unsetField
   */
  removeField(field: string): TestApiMapReduceEntity;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): TestApiMapReduceEntity;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): TestApiMapReduceEntity;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): TestApiMapReduceEntity;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): TestApiMapReduceEntity;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): TestApiMapReduceEntity;

  mergeJson(json: any | null): TestApiMapReduceEntity;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): TestApiMapReduceEntity;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): TestApiMapReduceEntity;
   ...
   */
  singletonArray(): C3.Array<TestApiMapReduceEntity | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<TestApiMapReduceEntity | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<TestApiMapReduceEntity | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<TestApiMapReduceEntity | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<TestApiMapReduceEntity | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, TestApiMapReduceEntity | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, TestApiMapReduceEntity | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<TestApiMapReduceEntity | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<TestApiMapReduceEntity | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): TestApiMapReduceEntity;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): TestApiMapReduceEntity;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): TestApiMapReduceEntity;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): TestApiMapReduceEntity;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): TestApiMapReduceEntity;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): TestApiMapReduceEntity;
   ...
   * @see #fromString
   */
  static make(s: string | null): TestApiMapReduceEntity | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): TestApiMapReduceEntity;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): TestApiMapReduceEntity;
   ...
   */
  static cachedEmptyInst(): TestApiMapReduceEntity;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<TestApiMapReduceEntity>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): TestApiMapReduceEntity;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<TestApiMapReduceEntity | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<TestApiMapReduceEntity | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<TestApiMapReduceEntity | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<TestApiMapReduceEntity | null> | null>;
   ...
   */
  get(include?: string | null): TestApiMapReduceEntity | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): TestApiMapReduceEntity | null;
   ...
   */
  getMissing(spec: GetMissingSpec): TestApiMapReduceEntity;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): TestApiMapReduceEntity | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): TestApiMapReduceEntity;
   ...
   * @see #toString
   */
  static fromString(s: string | null): TestApiMapReduceEntity | null;
   ...
   */
  create(spec?: UpsertSpec | null): TestApiMapReduceEntity | null;
   ...
   */
  static createBatch(objs: C3.Array<TestApiMapReduceEntity | null> | null, spec?: UpsertSpec | null): ObjList<TestApiMapReduceEntity | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<TestApiMapReduceEntity | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<TestApiMapReduceEntity | null> | null;
   ...
   */
  update(srcObj?: TestApiMapReduceEntity | null, spec?: UpsertSpec | null): TestApiMapReduceEntity | null;
   ...
   */
  upsert(srcObj?: TestApiMapReduceEntity | null, spec?: UpsertSpec | null): TestApiMapReduceEntity | null;
   ...
   */
  merge(spec?: MergeSpec | null): TestApiMapReduceEntity | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): TestApiMapReduceEntity | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): TestApiMapReduceEntity | null;
   ...
   */
  static updateBatch(objs: C3.Array<TestApiMapReduceEntity | null> | null, srcObjs?: C3.Array<TestApiMapReduceEntity | null>, spec?: UpsertSpec | null): ObjList<TestApiMapReduceEntity | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<TestApiMapReduceEntity | null>>, spec?: UpsertSpec | null): ObjList<TestApiMapReduceEntity | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<TestApiMapReduceEntity | null> | null, srcObjs?: C3.Array<TestApiMapReduceEntity | null>, spec?: UpsertSpec | null): ObjList<TestApiMapReduceEntity | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<TestApiMapReduceEntity | null>>, spec?: UpsertSpec | null): ObjList<TestApiMapReduceEntity | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<TestApiMapReduceEntity | null> | null, spec?: TouchSpec | null): ObjList<TestApiMapReduceEntity | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<TestApiMapReduceEntity | null> | null, spec?: MergeSpec | null): ObjList<TestApiMapReduceEntity | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<TestApiMapReduceEntity | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<TestApiMapReduceEntity | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<TestApiMapReduceEntity | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<TestApiMapReduceEntity | null> | null;
   ...
   */
  static mergeAll(mergeObj: TestApiMapReduceEntity | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: TestApiMapReduceEntity | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<TestApiMapReduceEntity | null> | null, spec?: UpsertSpec | null): ObjList<TestApiMapReduceEntity | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<TestApiMapReduceEntity | null> | null, spec?: UpsertSpec | null): ObjList<TestApiMapReduceEntity | null> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): TestApiMapReduceEntity | null;
   ...
   */
  static beforeCreate(objs: C3.Array<TestApiMapReduceEntity | null> | null): ObjList<TestApiMapReduceEntity | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<TestApiMapReduceEntity | null> | null): ObjList<TestApiMapReduceEntity | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<TestApiMapReduceEntity | null> | null): ObjList<TestApiMapReduceEntity | null>;
   ...
   */
  static afterCreate(objs: C3.Array<TestApiMapReduceEntity | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<TestApiMapReduceEntity | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<TestApiMapReduceEntity | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<TestApiMapReduceEntity | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<TestApiMapReduceEntity | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): TestApiMapReduceEntity | null;
   ...
   */
  withoutIdentity(): TestApiMapReduceEntity | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<TestApiMapReduceEntity | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: TestApiMapReduceEntity | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<TestApiMapReduceEntity | null> | null, callback?: λFunction<TestApiMapReduceEntity | null, TestApiMapReduceEntity | null> | null): ObjList<TestApiMapReduceEntity | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<TestApiMapReduceEntity | null> | null, callback?: λFunction<TestApiMapReduceEntity | null, TestApiMapReduceEntity | null> | null): C3.Array<ObjError | null>;
