// TypeScript definitions for the C3 type TestSpyAnimal

/**
 * This type is for test_TestApiSpyBatch
 *
 * @remarks this represents a value passed to a method that expects an instance of TestSpyAnimal
 */
declare interface ITestSpyAnimal {
 ...
 * This type is for test_TestApiSpyBatch
 *
 * @remarks this represents a made instance of TestSpyAnimal
 */
declare class TestSpyAnimal extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): TestSpyAnimal | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): TestSpyAnimal | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): TestSpyAnimal | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): TestSpyAnimal | null;
   ...
   */
  replaceType(old: Type, new_: Type): TestSpyAnimal;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): TestSpyAnimal;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): TestSpyAnimal;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<TestSpyAnimal | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<TestSpyAnimal | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): TestSpyAnimal;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TestSpyAnimal;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TestSpyAnimal;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): TestSpyAnimal;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): TestSpyAnimal;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): TestSpyAnimal;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): TestSpyAnimal;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): TestSpyAnimal;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): TestSpyAnimal;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): TestSpyAnimal;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): TestSpyAnimal;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): TestSpyAnimal;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): TestSpyAnimal;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): TestSpyAnimal;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): TestSpyAnimal;
   ...
   * @see #unsetField
   */
  defaultField(field: string): TestSpyAnimal;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): TestSpyAnimal;
   ...
   * @see #removeField
   */
  unsetField(field: string): TestSpyAnimal;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): TestSpyAnimal;
   ...
   * @see #unsetField
   */
  removeField(field: string): TestSpyAnimal;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): TestSpyAnimal;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): TestSpyAnimal;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): TestSpyAnimal;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): TestSpyAnimal;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): TestSpyAnimal;

  mergeJson(json: any | null): TestSpyAnimal;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): TestSpyAnimal;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): TestSpyAnimal;
   ...
   */
  singletonArray(): C3.Array<TestSpyAnimal | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<TestSpyAnimal | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<TestSpyAnimal | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<TestSpyAnimal | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<TestSpyAnimal | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, TestSpyAnimal | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, TestSpyAnimal | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<TestSpyAnimal | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<TestSpyAnimal | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): TestSpyAnimal;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): TestSpyAnimal;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): TestSpyAnimal;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): TestSpyAnimal;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): TestSpyAnimal;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): TestSpyAnimal;
   ...
   * @see #fromString
   */
  static make(s: string | null): TestSpyAnimal | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): TestSpyAnimal;
   ...
   */
  static cachedEmptyInst(): TestSpyAnimal;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<TestSpyAnimal>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): TestSpyAnimal;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<TestSpyAnimal | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<TestSpyAnimal | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<TestSpyAnimal | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<TestSpyAnimal | null> | null>;
   ...
   */
  get(include?: string | null): TestSpyAnimal | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): TestSpyAnimal | null;
   ...
   */
  getMissing(spec: GetMissingSpec): TestSpyAnimal;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): TestSpyAnimal | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): TestSpyAnimal;
   ...
   * @see #toString
   */
  static fromString(s: string | null): TestSpyAnimal | null;
   ...
   */
  create(spec?: UpsertSpec | null): TestSpyAnimal | null;
   ...
   */
  static createBatch(objs: C3.Array<TestSpyAnimal | null> | null, spec?: UpsertSpec | null): ObjList<TestSpyAnimal | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<TestSpyAnimal | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<TestSpyAnimal | null> | null;
   ...
   */
  update(srcObj?: TestSpyAnimal | null, spec?: UpsertSpec | null): TestSpyAnimal | null;
   ...
   */
  upsert(srcObj?: TestSpyAnimal | null, spec?: UpsertSpec | null): TestSpyAnimal | null;
   ...
   */
  merge(spec?: MergeSpec | null): TestSpyAnimal | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): TestSpyAnimal | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): TestSpyAnimal | null;
   ...
   */
  static updateBatch(objs: C3.Array<TestSpyAnimal | null> | null, srcObjs?: C3.Array<TestSpyAnimal | null>, spec?: UpsertSpec | null): ObjList<TestSpyAnimal | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<TestSpyAnimal | null>>, spec?: UpsertSpec | null): ObjList<TestSpyAnimal | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<TestSpyAnimal | null> | null, srcObjs?: C3.Array<TestSpyAnimal | null>, spec?: UpsertSpec | null): ObjList<TestSpyAnimal | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<TestSpyAnimal | null>>, spec?: UpsertSpec | null): ObjList<TestSpyAnimal | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<TestSpyAnimal | null> | null, spec?: TouchSpec | null): ObjList<TestSpyAnimal | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<TestSpyAnimal | null> | null, spec?: MergeSpec | null): ObjList<TestSpyAnimal | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<TestSpyAnimal | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<TestSpyAnimal | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<TestSpyAnimal | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<TestSpyAnimal | null> | null;
   ...
   */
  static mergeAll(mergeObj: TestSpyAnimal | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: TestSpyAnimal | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<TestSpyAnimal | null> | null, spec?: UpsertSpec | null): ObjList<TestSpyAnimal | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<TestSpyAnimal | null> | null, spec?: UpsertSpec | null): ObjList<TestSpyAnimal | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<TestSpyAnimal | null> | null): ObjList<TestSpyAnimal | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<TestSpyAnimal | null> | null): ObjList<TestSpyAnimal | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<TestSpyAnimal | null> | null): ObjList<TestSpyAnimal | null>;
   ...
   */
  static afterCreate(objs: C3.Array<TestSpyAnimal | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<TestSpyAnimal | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<TestSpyAnimal | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<TestSpyAnimal | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<TestSpyAnimal | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): TestSpyAnimal | null;
   ...
   */
  withoutIdentity(): TestSpyAnimal | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<TestSpyAnimal | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: TestSpyAnimal | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<TestSpyAnimal | null> | null, callback?: λFunction<TestSpyAnimal | null, TestSpyAnimal | null> | null): ObjList<TestSpyAnimal | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<TestSpyAnimal | null> | null, callback?: λFunction<TestSpyAnimal | null, TestSpyAnimal | null> | null): C3.Array<ObjError | null>;
  ...
  static createAnimal(animals?: C3.Array<string | null>): string | null;
}
