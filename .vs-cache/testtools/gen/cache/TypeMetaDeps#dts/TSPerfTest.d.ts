// TypeScript definitions for the C3 type TSPerfTest

/**
 * @remarks this represents a value passed to a method that expects an instance of TSPerfTest
 */
declare interface ITSPerfTest {
   ...
   */
  asyncRootId?: string | null;
}

/**
 * @remarks this represents a made instance of TSPerfTest
 */
declare class TSPerfTest extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): TSPerfTest | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): TSPerfTest | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): TSPerfTest | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): TSPerfTest | null;
   ...
   */
  replaceType(old: Type, new_: Type): TSPerfTest;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): TSPerfTest;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): TSPerfTest;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<TSPerfTest | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<TSPerfTest | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): TSPerfTest;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TSPerfTest;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TSPerfTest;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): TSPerfTest;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): TSPerfTest;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): TSPerfTest;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): TSPerfTest;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): TSPerfTest;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): TSPerfTest;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): TSPerfTest;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): TSPerfTest;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): TSPerfTest;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): TSPerfTest;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): TSPerfTest;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): TSPerfTest;
   ...
   * @see #unsetField
   */
  defaultField(field: string): TSPerfTest;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): TSPerfTest;
   ...
   * @see #removeField
   */
  unsetField(field: string): TSPerfTest;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): TSPerfTest;
   ...
   * @see #unsetField
   */
  removeField(field: string): TSPerfTest;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): TSPerfTest;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): TSPerfTest;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): TSPerfTest;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): TSPerfTest;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): TSPerfTest;

  mergeJson(json: any | null): TSPerfTest;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): TSPerfTest;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): TSPerfTest;
   ...
   */
  singletonArray(): C3.Array<TSPerfTest | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<TSPerfTest | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<TSPerfTest | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<TSPerfTest | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<TSPerfTest | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, TSPerfTest | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, TSPerfTest | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<TSPerfTest | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<TSPerfTest | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): TSPerfTest;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): TSPerfTest;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): TSPerfTest;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): TSPerfTest;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): TSPerfTest;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): TSPerfTest;
   ...
   * @see #fromString
   */
  static make(s: string | null): TSPerfTest | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): TSPerfTest;
   ...
   */
  static cachedEmptyInst(): TSPerfTest;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<TSPerfTest>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): TSPerfTest;
   ...
   */
  start(options?: TSPerfTestConfig | null): BatchJobStatus | null;
   ...
   */
  cleanup(options?: TSPerfTestConfig | null): void;
  ...
  cancelJob(removeResults?: boolean, force?: boolean): JobBase<BatchJobRun | null, BatchJobStatus | null, TSPerfTestConfig | null> | null;

  failJob(run: JobRun<BatchJobStatusBase | null>): JobBase<BatchJobRun | null, BatchJobStatus | null, TSPerfTestConfig | null> | null;
  ...
  validateStart(options?: TSPerfTestConfig | null): void;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<TSPerfTest | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<TSPerfTest | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<TSPerfTest | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<TSPerfTest | null> | null>;
   ...
   */
  get(include?: string | null): TSPerfTest | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): TSPerfTest | null;
   ...
   */
  getMissing(spec: GetMissingSpec): TSPerfTest;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): TSPerfTest | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): TSPerfTest;
   ...
   * @see #toString
   */
  static fromString(s: string | null): TSPerfTest | null;
   ...
   */
  create(spec?: UpsertSpec | null): TSPerfTest | null;
   ...
   */
  static createBatch(objs: C3.Array<TSPerfTest | null> | null, spec?: UpsertSpec | null): ObjList<TSPerfTest | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<TSPerfTest | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<TSPerfTest | null> | null;
   ...
   */
  update(srcObj?: TSPerfTest | null, spec?: UpsertSpec | null): TSPerfTest | null;
   ...
   */
  upsert(srcObj?: TSPerfTest | null, spec?: UpsertSpec | null): TSPerfTest | null;
   ...
   */
  merge(spec?: MergeSpec | null): TSPerfTest | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): TSPerfTest | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): TSPerfTest | null;
   ...
   */
  static updateBatch(objs: C3.Array<TSPerfTest | null> | null, srcObjs?: C3.Array<TSPerfTest | null>, spec?: UpsertSpec | null): ObjList<TSPerfTest | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<TSPerfTest | null>>, spec?: UpsertSpec | null): ObjList<TSPerfTest | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<TSPerfTest | null> | null, srcObjs?: C3.Array<TSPerfTest | null>, spec?: UpsertSpec | null): ObjList<TSPerfTest | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<TSPerfTest | null>>, spec?: UpsertSpec | null): ObjList<TSPerfTest | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<TSPerfTest | null> | null, spec?: TouchSpec | null): ObjList<TSPerfTest | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<TSPerfTest | null> | null, spec?: MergeSpec | null): ObjList<TSPerfTest | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<TSPerfTest | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<TSPerfTest | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<TSPerfTest | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<TSPerfTest | null> | null;
   ...
   */
  static mergeAll(mergeObj: TSPerfTest | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: TSPerfTest | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<TSPerfTest | null> | null, spec?: UpsertSpec | null): ObjList<TSPerfTest | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<TSPerfTest | null> | null, spec?: UpsertSpec | null): ObjList<TSPerfTest | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<TSPerfTest | null> | null): ObjList<TSPerfTest | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<TSPerfTest | null> | null): ObjList<TSPerfTest | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<TSPerfTest | null> | null): ObjList<TSPerfTest | null>;
   ...
   */
  static afterCreate(objs: C3.Array<TSPerfTest | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<TSPerfTest | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<TSPerfTest | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<TSPerfTest | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<TSPerfTest | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): TSPerfTest | null;
   ...
   */
  withoutIdentity(): TSPerfTest | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<TSPerfTest | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: TSPerfTest | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<TSPerfTest | null> | null, callback?: λFunction<TSPerfTest | null, TSPerfTest | null> | null): ObjList<TSPerfTest | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<TSPerfTest | null> | null, callback?: λFunction<TSPerfTest | null, TSPerfTest | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static doStart(job?: TSPerfTest | null, options?: TSPerfTestConfig | null): void;
   ...
   */
  static processBatch(batch?: TSPerfTestConfig | null, job?: TSPerfTest | null, options?: TSPerfTestConfig | null): void;
   ...
   */
  static allComplete(job: TSPerfTest, options?: TSPerfTestConfig | null): string | null;
   ...
   *           Options the job was run with.
   */
  static failed(job: TSPerfTest, status: BatchJobStatus, options?: TSPerfTestConfig | null): void;
   ...
   *        Batch to schedule.
   */
  scheduleBatch(batch?: TSPerfTestConfig | null): void;
   ...
   *        Batches to schedule.
   */
  scheduleBatches(batches?: C3.Array<TSPerfTestConfig | null>): void;
   ...
   */
  static scheduleObjBatch(job?: TSPerfTest | null, objBatch?: ObjBatch | null, logPrefix?: string | null): number | null;
  ...
  static startCreate(numberOfThreads?: number | null, config?: TSPerfTestConfig | null): TSPerfTest | null;

  static startEvaluate(numberOfThreads?: number | null, config?: TSPerfTestConfig | null): TSPerfTest | null;
   ...
   */
  static startPerfTest(noOfHeaders?: number | null, noOfDays?: number | null, noOfIncrementalDays?: number | null, targetObjIdSuffix?: string | null, grain?: string | null): TSPerfTestResult | null;
   ...
   */
  static startConcurrencyTest(headerIdNo?: number | null, noOfConcurrentJobs?: number | null, grain?: string | null, noOfIterations?: number | null): void;
   ...
   */
  static startConcurrencyAndValidate(headerIdNo?: number | null, noOfConcurrentJobs?: number | null, grain?: string | null, noOfIterations?: number | null): void;
   ...
   */
  static startSerialTest(headerIdNo?: number | null, noOfSerialJobs?: number | null, grain?: string | null, noOfConcurrentInSerial?: number | null, noOfIterations?: number | null): void;
}
