// TypeScript definitions for the C3 type BaseCodeAnalysis.Metric.NotebookCount

/**
 * Code analysis metric that counts the number of Jupyter notebooks in the package.
 *
 * @remarks this represents a value passed to a method that expects an instance of BaseCodeAnalysis.Metric.NotebookCount
 */
declare namespace BaseCodeAnalysis.Metric {
  export interface INotebookCount {
  }
}
 ...
 */
declare namespace BaseCodeAnalysis.Metric {
  export class NotebookCount extends Obj  {
     ...
     * @see #toJson
     */
    static fromJson(json: any): BaseCodeAnalysis.Metric.NotebookCount | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): BaseCodeAnalysis.Metric.NotebookCount | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): BaseCodeAnalysis.Metric.NotebookCount | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): BaseCodeAnalysis.Metric.NotebookCount | null;
     ...
     */
    replaceType(old: Type, new_: Type): BaseCodeAnalysis.Metric.NotebookCount;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): BaseCodeAnalysis.Metric.NotebookCount;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): BaseCodeAnalysis.Metric.NotebookCount;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<BaseCodeAnalysis.Metric.NotebookCount>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<BaseCodeAnalysis.Metric.NotebookCount>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): BaseCodeAnalysis.Metric.NotebookCount;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): BaseCodeAnalysis.Metric.NotebookCount;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): BaseCodeAnalysis.Metric.NotebookCount;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): BaseCodeAnalysis.Metric.NotebookCount;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): BaseCodeAnalysis.Metric.NotebookCount;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): BaseCodeAnalysis.Metric.NotebookCount;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): BaseCodeAnalysis.Metric.NotebookCount;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): BaseCodeAnalysis.Metric.NotebookCount;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): BaseCodeAnalysis.Metric.NotebookCount;
     ...
     * @see #removeField
     */
    withoutField(field: string): BaseCodeAnalysis.Metric.NotebookCount;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): BaseCodeAnalysis.Metric.NotebookCount;
     ...
     */
    withoutFields(fields: Array_Type<string>): BaseCodeAnalysis.Metric.NotebookCount;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): BaseCodeAnalysis.Metric.NotebookCount;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): BaseCodeAnalysis.Metric.NotebookCount;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): BaseCodeAnalysis.Metric.NotebookCount;
     ...
     * @see #unsetField
     */
    defaultField(field: string): BaseCodeAnalysis.Metric.NotebookCount;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): BaseCodeAnalysis.Metric.NotebookCount;
     ...
     * @see #removeField
     */
    unsetField(field: string): BaseCodeAnalysis.Metric.NotebookCount;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): BaseCodeAnalysis.Metric.NotebookCount;
     ...
     * @see #unsetField
     */
    removeField(field: string): BaseCodeAnalysis.Metric.NotebookCount;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): BaseCodeAnalysis.Metric.NotebookCount;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): BaseCodeAnalysis.Metric.NotebookCount;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): BaseCodeAnalysis.Metric.NotebookCount;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): BaseCodeAnalysis.Metric.NotebookCount;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): BaseCodeAnalysis.Metric.NotebookCount;

    mergeJson(json: any): BaseCodeAnalysis.Metric.NotebookCount;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): BaseCodeAnalysis.Metric.NotebookCount;
     ...
     */
    sumObj(other: Obj, deep?: boolean): BaseCodeAnalysis.Metric.NotebookCount;
     ...
     */
    singletonArray(): Array_Type<BaseCodeAnalysis.Metric.NotebookCount>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<BaseCodeAnalysis.Metric.NotebookCount> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<BaseCodeAnalysis.Metric.NotebookCount> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<BaseCodeAnalysis.Metric.NotebookCount>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<BaseCodeAnalysis.Metric.NotebookCount> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, BaseCodeAnalysis.Metric.NotebookCount> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, BaseCodeAnalysis.Metric.NotebookCount> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<BaseCodeAnalysis.Metric.NotebookCount>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<BaseCodeAnalysis.Metric.NotebookCount>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): BaseCodeAnalysis.Metric.NotebookCount;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): BaseCodeAnalysis.Metric.NotebookCount;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): BaseCodeAnalysis.Metric.NotebookCount;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): BaseCodeAnalysis.Metric.NotebookCount;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): BaseCodeAnalysis.Metric.NotebookCount;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): BaseCodeAnalysis.Metric.NotebookCount;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): BaseCodeAnalysis.Metric.NotebookCount;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): BaseCodeAnalysis.Metric.NotebookCount;
     ...
     */
    static cachedEmptyInst(): BaseCodeAnalysis.Metric.NotebookCount;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<BaseCodeAnalysis.Metric.NotebookCount> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): BaseCodeAnalysis.Metric.NotebookCount;
