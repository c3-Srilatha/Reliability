// TypeScript definitions for the C3 type BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule
 */
declare namespace BaseCodeAnalysis.Metric.HardcodedCredentials {
 ...
 */
declare namespace BaseCodeAnalysis.Metric.HardcodedCredentials {
  export class RegexRule extends Obj  {

    /**
     * The unique identifier of the rule.
     */
    readonly id?: string;
    withId(id: string | null): BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule;
    ...
    withVersion(version: number | null): BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule;
    ...
    withUserUpdatedFields(userUpdatedFields: Array_Type<string> | Array<string> | null): BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule;
    ...
    withHidden(hidden: boolean): BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule;
    ...
    withUserOwned(userOwned: boolean): BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule;

    /**
     * The description of the rule to construct the message.
     */
    readonly description?: string;
    withDescription(description: string | null): BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule;

    /**
     * The regex to detect the hardcoded credentials.
     */
    readonly regex?: string;
    withRegex(regex: string | null): BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule;
    ...
    withModifiers(modifiers: string | null): BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule;

    /**
     * Configuration to enable/disable the rule.
     */
    readonly enabled?: boolean;
    withEnabled(enabled: boolean): BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule;
     ...
     * @see #toJson
     */
    static fromJson(json: any): BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule | null;
     ...
     */
    replaceType(old: Type, new_: Type): BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule;
     ...
     * @see #removeField
     */
    withoutField(field: string): BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule;
     ...
     */
    withoutFields(fields: Array_Type<string>): BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule;
     ...
     * @see #unsetField
     */
    defaultField(field: string): BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule;
     ...
     * @see #removeField
     */
    unsetField(field: string): BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule;
     ...
     * @see #unsetField
     */
    removeField(field: string): BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule;

    mergeJson(json: any): BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule;
     ...
     */
    sumObj(other: Obj, deep?: boolean): BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule;
     ...
     */
    singletonArray(): Array_Type<BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule;
     ...
     * @see #fromString
     */
    static make(s: string): BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule;
     ...
     */
    static cachedEmptyInst(): BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule;
     ...
     */
    static allCached(): Stream<BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule> | null;
     ...
     */
    static find(filter?: string): Stream<BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule> | null;
     ...
     *         Otherwise no population will be performed.
     */
    static findBy(field: string, value: any): Stream<BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule> | null;

    /**
     * @return cached instance.
     */
    getCached(): BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule | null;

    /**
     * @return cached instance by the key.
     */
    static forCacheKey(key: string): BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule | null;
     ...
     */
    static produce(key: string): BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule | null;

    /**
     * Should produces the entire content for the cached data. Will populate the cache with the produced data.
     */
    static produceAll(): Map_Type<string, BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule> | null;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule>> | null;
     ...
     */
    get(include?: string): BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule | null;
     ...
     */
    getMissing(spec: GetMissingSpec): BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule;
     ...
     * @see #toString
     */
    static fromString(s: string): BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule | null;
     ...
     */
    create(spec?: UpsertSpec): BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule | null;
     ...
     */
    static createBatch(objs: Array_Type<BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule>, spec?: UpsertSpec): ObjList<BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule>, spec?: CreateBatchObjStreamSpec): ObjList<BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule> | null;
     ...
     */
    update(srcObj?: BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule, spec?: UpsertSpec): BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule | null;
     ...
     */
    upsert(srcObj?: BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule, spec?: UpsertSpec): BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule | null;
     ...
     */
    merge(spec?: MergeSpec): BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule | null;
     ...
     */
    static updateBatch(objs: Array_Type<BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule>, srcObjs?: Array_Type<BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule>, spec?: UpsertSpec): ObjList<BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule> | null>, spec?: UpsertSpec): ObjList<BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule>, srcObjs?: Array_Type<BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule>, spec?: UpsertSpec): ObjList<BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule> | null>, spec?: UpsertSpec): ObjList<BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule>, spec?: TouchSpec): ObjList<BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule>, spec?: MergeSpec): ObjList<BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule>, mergeInclude: string, spec?: MergeSpec): ObjList<BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule> | null;
     ...
     */
    static mergeAll(mergeObj: BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule>, spec?: UpsertSpec): ObjList<BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule>, spec?: UpsertSpec): ObjList<BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule | null;
     ...
     */
    static beforeCreate(objs: Array_Type<BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule>): ObjList<BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule>): ObjList<BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule>): ObjList<BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule>;
     ...
     */
    static afterCreate(objs: Array_Type<BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule | null;
     ...
     */
    withoutIdentity(): BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule>, callback?: λFunction<BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule | null, BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule | null>): ObjList<BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule>, callback?: λFunction<BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule | null, BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule | null>): Array_Type<ObjError> | null;
     ...
     */
    publish(subPath?: string, contentType?: string): BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule;
     ...
     */
    static removeSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule> | null;
     ...
     */
    createSeedData(spec?: UpsertSpec): BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule | null;
     ...
     */
    static createSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule> | null;
     ...
     */
    updateSeedData(srcObj?: SeedData, spec?: UpsertSpec): BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule | null;
     ...
     */
    static updateSeedDataBatch(objs?: Array_Type<SeedData>, srcObjs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule> | null;
     ...
     * @return updated obj instance, same as {@link Persistable#update} return value.
     */
    clearUserUpdates(spec?: MergeSpec): BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule | null;
     ...
     *         {@link Persistable#updateBatch}.
     */
    static clearUserUpdatesBatch(objs?: Array_Type<SeedData>, spec?: MergeSpec): ObjList<BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule> | null;
    ...
    dependencies(): SeedDataDeps<BaseCodeAnalysis.Metric.HardcodedCredentials.RegexRule> | null;
