// TypeScript definitions for the C3 type BaseCodeAnalysis.VersionDiff.Metric.Deprecation
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of BaseCodeAnalysis.VersionDiff.Metric.Deprecation
 */
...
declare namespace BaseCodeAnalysis.VersionDiff.Metric {
  export class Deprecation {
    ...
    withMETRIC_CODE(METRIC_CODE: string | null): BaseCodeAnalysis.VersionDiff.Metric.Deprecation;

    /**
     * The sub-category code for when a Type has been deprecated
     */
    readonly DEPRECATED_TYPE_CODE?: string;
    withDEPRECATED_TYPE_CODE(DEPRECATED_TYPE_CODE: string | null): BaseCodeAnalysis.VersionDiff.Metric.Deprecation;

    /**
     * The sub-category code for when a [field](DeclaredFieldType) has been deprecated
     */
    readonly DEPRECATED_FIELD_CODE?: string;
    withDEPRECATED_FIELD_CODE(DEPRECATED_FIELD_CODE: string | null): BaseCodeAnalysis.VersionDiff.Metric.Deprecation;

    /**
     * The sub-category code for when a [method](MethodType) has been deprecated
     */
    readonly DEPRECATED_METHOD_CODE?: string;
    withDEPRECATED_METHOD_CODE(DEPRECATED_METHOD_CODE: string | null): BaseCodeAnalysis.VersionDiff.Metric.Deprecation;
