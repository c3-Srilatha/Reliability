// TypeScript definitions for the C3 type BaseCodeAnalysis.VersionDiff.Metric.Rename
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of BaseCodeAnalysis.VersionDiff.Metric.Rename
 */
...
declare namespace BaseCodeAnalysis.VersionDiff.Metric {
  export class Rename {
    ...
    withMETRIC_CODE(METRIC_CODE: string | null): BaseCodeAnalysis.VersionDiff.Metric.Rename;

    /**
     * The sub-category code for when a Type has been renamed
     */
    readonly RENAMED_TYPE_CODE?: string;
    withRENAMED_TYPE_CODE(RENAMED_TYPE_CODE: string | null): BaseCodeAnalysis.VersionDiff.Metric.Rename;

    /**
     * The sub-category code for when a [field](DeclaredFieldType) has been renamed
     */
    readonly RENAMED_FIELD_CODE?: string;
    withRENAMED_FIELD_CODE(RENAMED_FIELD_CODE: string | null): BaseCodeAnalysis.VersionDiff.Metric.Rename;

    /**
     * The sub-category code for when a [method](MethodType) has been renamed
     */
    readonly RENAMED_METHOD_CODE?: string;
    withRENAMED_METHOD_CODE(RENAMED_METHOD_CODE: string | null): BaseCodeAnalysis.VersionDiff.Metric.Rename;
