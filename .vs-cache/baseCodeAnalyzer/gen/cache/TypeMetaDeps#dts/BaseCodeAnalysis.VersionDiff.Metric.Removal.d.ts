// TypeScript definitions for the C3 type BaseCodeAnalysis.VersionDiff.Metric.Removal
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of BaseCodeAnalysis.VersionDiff.Metric.Removal
 */
...
declare namespace BaseCodeAnalysis.VersionDiff.Metric {
  export class Removal {
    ...
    withMETRIC_CODE(METRIC_CODE: string | null): BaseCodeAnalysis.VersionDiff.Metric.Removal;

    /**
     * The sub-category code for when a Type has been removed
     */
    readonly REMOVED_TYPE_CODE?: string;
    withREMOVED_TYPE_CODE(REMOVED_TYPE_CODE: string | null): BaseCodeAnalysis.VersionDiff.Metric.Removal;

    /**
     * The sub-category code for when a [field](DeclaredFieldType) has been removed
     */
    readonly REMOVED_FIELD_CODE?: string;
    withREMOVED_FIELD_CODE(REMOVED_FIELD_CODE: string | null): BaseCodeAnalysis.VersionDiff.Metric.Removal;

    /**
     * The sub-category code for when a [method](MethodType) has been removed
     */
    readonly REMOVED_METHOD_CODE?: string;
    withREMOVED_METHOD_CODE(REMOVED_METHOD_CODE: string | null): BaseCodeAnalysis.VersionDiff.Metric.Removal;

    /**
     * The sub-category code for when a [function parameter](FunctionParam) has been removed
     */
    readonly REMOVED_PARAM_CODE?: string;
    withREMOVED_PARAM_CODE(REMOVED_PARAM_CODE: string | null): BaseCodeAnalysis.VersionDiff.Metric.Removal;
