// TypeScript definitions for the C3 type RenameEntityNoDeclaredSchema_2_0_0_R

/**
 * This entity Type is renamed in the next version and doesn't have a declared schema name.
 *
 * @remarks this represents a value passed to a method that expects an instance of RenameEntityNoDeclaredSchema_2_0_0_R
 */
declare interface IRenameEntityNoDeclaredSchema_2_0_0_R {
 ...
 */
declare class RenameEntityNoDeclaredSchema_2_0_0_R extends Obj  {
   ...
   */
  readonly id: string;
  withId(id: string): RenameEntityNoDeclaredSchema_2_0_0_R;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): RenameEntityNoDeclaredSchema_2_0_0_R;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): RenameEntityNoDeclaredSchema_2_0_0_R;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): RenameEntityNoDeclaredSchema_2_0_0_R;
  ...
  withVersion(version: number | null): RenameEntityNoDeclaredSchema_2_0_0_R;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): RenameEntityNoDeclaredSchema_2_0_0_R;
   ...
   * @see #toJson
   */
  static fromJson(json: any): RenameEntityNoDeclaredSchema_2_0_0_R | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): RenameEntityNoDeclaredSchema_2_0_0_R | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): RenameEntityNoDeclaredSchema_2_0_0_R | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): RenameEntityNoDeclaredSchema_2_0_0_R | null;
   ...
   */
  replaceType(old: Type, new_: Type): RenameEntityNoDeclaredSchema_2_0_0_R;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): RenameEntityNoDeclaredSchema_2_0_0_R;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): RenameEntityNoDeclaredSchema_2_0_0_R;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<RenameEntityNoDeclaredSchema_2_0_0_R>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<RenameEntityNoDeclaredSchema_2_0_0_R>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): RenameEntityNoDeclaredSchema_2_0_0_R;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): RenameEntityNoDeclaredSchema_2_0_0_R;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): RenameEntityNoDeclaredSchema_2_0_0_R;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): RenameEntityNoDeclaredSchema_2_0_0_R;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): RenameEntityNoDeclaredSchema_2_0_0_R;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): RenameEntityNoDeclaredSchema_2_0_0_R;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): RenameEntityNoDeclaredSchema_2_0_0_R;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): RenameEntityNoDeclaredSchema_2_0_0_R;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): RenameEntityNoDeclaredSchema_2_0_0_R;
   ...
   * @see #removeField
   */
  withoutField(field: string): RenameEntityNoDeclaredSchema_2_0_0_R;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): RenameEntityNoDeclaredSchema_2_0_0_R;
   ...
   */
  withoutFields(fields: Array_Type<string>): RenameEntityNoDeclaredSchema_2_0_0_R;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): RenameEntityNoDeclaredSchema_2_0_0_R;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): RenameEntityNoDeclaredSchema_2_0_0_R;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): RenameEntityNoDeclaredSchema_2_0_0_R;
   ...
   * @see #unsetField
   */
  defaultField(field: string): RenameEntityNoDeclaredSchema_2_0_0_R;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): RenameEntityNoDeclaredSchema_2_0_0_R;
   ...
   * @see #removeField
   */
  unsetField(field: string): RenameEntityNoDeclaredSchema_2_0_0_R;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): RenameEntityNoDeclaredSchema_2_0_0_R;
   ...
   * @see #unsetField
   */
  removeField(field: string): RenameEntityNoDeclaredSchema_2_0_0_R;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): RenameEntityNoDeclaredSchema_2_0_0_R;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): RenameEntityNoDeclaredSchema_2_0_0_R;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): RenameEntityNoDeclaredSchema_2_0_0_R;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): RenameEntityNoDeclaredSchema_2_0_0_R;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): RenameEntityNoDeclaredSchema_2_0_0_R;

  mergeJson(json: any): RenameEntityNoDeclaredSchema_2_0_0_R;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): RenameEntityNoDeclaredSchema_2_0_0_R;
   ...
   */
  sumObj(other: Obj, deep?: boolean): RenameEntityNoDeclaredSchema_2_0_0_R;
   ...
   */
  singletonArray(): Array_Type<RenameEntityNoDeclaredSchema_2_0_0_R>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<RenameEntityNoDeclaredSchema_2_0_0_R> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<RenameEntityNoDeclaredSchema_2_0_0_R> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<RenameEntityNoDeclaredSchema_2_0_0_R>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<RenameEntityNoDeclaredSchema_2_0_0_R> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, RenameEntityNoDeclaredSchema_2_0_0_R> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, RenameEntityNoDeclaredSchema_2_0_0_R> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<RenameEntityNoDeclaredSchema_2_0_0_R>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<RenameEntityNoDeclaredSchema_2_0_0_R>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): RenameEntityNoDeclaredSchema_2_0_0_R;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): RenameEntityNoDeclaredSchema_2_0_0_R;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): RenameEntityNoDeclaredSchema_2_0_0_R;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): RenameEntityNoDeclaredSchema_2_0_0_R;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): RenameEntityNoDeclaredSchema_2_0_0_R;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): RenameEntityNoDeclaredSchema_2_0_0_R;
   ...
   * @see #fromString
   */
  static make(s: string): RenameEntityNoDeclaredSchema_2_0_0_R | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): RenameEntityNoDeclaredSchema_2_0_0_R;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): RenameEntityNoDeclaredSchema_2_0_0_R;
   ...
   */
  static cachedEmptyInst(): RenameEntityNoDeclaredSchema_2_0_0_R;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<RenameEntityNoDeclaredSchema_2_0_0_R> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): RenameEntityNoDeclaredSchema_2_0_0_R;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<RenameEntityNoDeclaredSchema_2_0_0_R>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<RenameEntityNoDeclaredSchema_2_0_0_R>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<RenameEntityNoDeclaredSchema_2_0_0_R> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<RenameEntityNoDeclaredSchema_2_0_0_R>> | null;
   ...
   */
  get(include?: string): RenameEntityNoDeclaredSchema_2_0_0_R | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): RenameEntityNoDeclaredSchema_2_0_0_R | null;
   ...
   */
  getMissing(spec: GetMissingSpec): RenameEntityNoDeclaredSchema_2_0_0_R;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): RenameEntityNoDeclaredSchema_2_0_0_R | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): RenameEntityNoDeclaredSchema_2_0_0_R;
   ...
   * @see #toString
   */
  static fromString(s: string): RenameEntityNoDeclaredSchema_2_0_0_R | null;
   ...
   */
  create(spec?: UpsertSpec): RenameEntityNoDeclaredSchema_2_0_0_R | null;
   ...
   */
  static createBatch(objs: Array_Type<RenameEntityNoDeclaredSchema_2_0_0_R>, spec?: UpsertSpec): ObjList<RenameEntityNoDeclaredSchema_2_0_0_R> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<RenameEntityNoDeclaredSchema_2_0_0_R>, spec?: CreateBatchObjStreamSpec): ObjList<RenameEntityNoDeclaredSchema_2_0_0_R> | null;
   ...
   */
  update(srcObj?: RenameEntityNoDeclaredSchema_2_0_0_R, spec?: UpsertSpec): RenameEntityNoDeclaredSchema_2_0_0_R | null;
   ...
   */
  upsert(srcObj?: RenameEntityNoDeclaredSchema_2_0_0_R, spec?: UpsertSpec): RenameEntityNoDeclaredSchema_2_0_0_R | null;
   ...
   */
  merge(spec?: MergeSpec): RenameEntityNoDeclaredSchema_2_0_0_R | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): RenameEntityNoDeclaredSchema_2_0_0_R | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): RenameEntityNoDeclaredSchema_2_0_0_R | null;
   ...
   */
  static updateBatch(objs: Array_Type<RenameEntityNoDeclaredSchema_2_0_0_R>, srcObjs?: Array_Type<RenameEntityNoDeclaredSchema_2_0_0_R>, spec?: UpsertSpec): ObjList<RenameEntityNoDeclaredSchema_2_0_0_R> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<RenameEntityNoDeclaredSchema_2_0_0_R> | null>, spec?: UpsertSpec): ObjList<RenameEntityNoDeclaredSchema_2_0_0_R> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<RenameEntityNoDeclaredSchema_2_0_0_R>, srcObjs?: Array_Type<RenameEntityNoDeclaredSchema_2_0_0_R>, spec?: UpsertSpec): ObjList<RenameEntityNoDeclaredSchema_2_0_0_R> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<RenameEntityNoDeclaredSchema_2_0_0_R> | null>, spec?: UpsertSpec): ObjList<RenameEntityNoDeclaredSchema_2_0_0_R> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<RenameEntityNoDeclaredSchema_2_0_0_R>, spec?: TouchSpec): ObjList<RenameEntityNoDeclaredSchema_2_0_0_R> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<RenameEntityNoDeclaredSchema_2_0_0_R>, spec?: MergeSpec): ObjList<RenameEntityNoDeclaredSchema_2_0_0_R> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<RenameEntityNoDeclaredSchema_2_0_0_R>, mergeInclude: string, spec?: MergeSpec): ObjList<RenameEntityNoDeclaredSchema_2_0_0_R> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<RenameEntityNoDeclaredSchema_2_0_0_R> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<RenameEntityNoDeclaredSchema_2_0_0_R> | null;
   ...
   */
  static mergeAll(mergeObj: RenameEntityNoDeclaredSchema_2_0_0_R, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: RenameEntityNoDeclaredSchema_2_0_0_R, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<RenameEntityNoDeclaredSchema_2_0_0_R>, spec?: UpsertSpec): ObjList<RenameEntityNoDeclaredSchema_2_0_0_R> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<RenameEntityNoDeclaredSchema_2_0_0_R>, spec?: UpsertSpec): ObjList<RenameEntityNoDeclaredSchema_2_0_0_R> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): RenameEntityNoDeclaredSchema_2_0_0_R | null;
   ...
   */
  static beforeCreate(objs: Array_Type<RenameEntityNoDeclaredSchema_2_0_0_R>): ObjList<RenameEntityNoDeclaredSchema_2_0_0_R>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<RenameEntityNoDeclaredSchema_2_0_0_R>): ObjList<RenameEntityNoDeclaredSchema_2_0_0_R>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<RenameEntityNoDeclaredSchema_2_0_0_R>): ObjList<RenameEntityNoDeclaredSchema_2_0_0_R>;
   ...
   */
  static afterCreate(objs: Array_Type<RenameEntityNoDeclaredSchema_2_0_0_R>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<RenameEntityNoDeclaredSchema_2_0_0_R>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<RenameEntityNoDeclaredSchema_2_0_0_R>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<RenameEntityNoDeclaredSchema_2_0_0_R>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<RenameEntityNoDeclaredSchema_2_0_0_R>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): RenameEntityNoDeclaredSchema_2_0_0_R | null;
   ...
   */
  withoutIdentity(): RenameEntityNoDeclaredSchema_2_0_0_R | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<RenameEntityNoDeclaredSchema_2_0_0_R>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: RenameEntityNoDeclaredSchema_2_0_0_R, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<RenameEntityNoDeclaredSchema_2_0_0_R>, callback?: λFunction<RenameEntityNoDeclaredSchema_2_0_0_R | null, RenameEntityNoDeclaredSchema_2_0_0_R | null>): ObjList<RenameEntityNoDeclaredSchema_2_0_0_R>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<RenameEntityNoDeclaredSchema_2_0_0_R>, callback?: λFunction<RenameEntityNoDeclaredSchema_2_0_0_R | null, RenameEntityNoDeclaredSchema_2_0_0_R | null>): Array_Type<ObjError> | null;
