// TypeScript definitions for the C3 type BaseCodeAnalysis.VersionDiff.Metric.ValueTypeChange
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of BaseCodeAnalysis.VersionDiff.Metric.ValueTypeChange
 */
declare namespace BaseCodeAnalysis.VersionDiff.Metric {
  export interface IValueTypeChange {
 ...
 */
declare namespace BaseCodeAnalysis.VersionDiff.Metric {
  export class ValueTypeChange {

    /**
     * The code for this version diff metric.
     */
    readonly METRIC_CODE?: string;
    withMETRIC_CODE(METRIC_CODE: string | null): BaseCodeAnalysis.VersionDiff.Metric.ValueTypeChange;

    /**
     * The sub-category code for when a [field's](DeclaredFieldType) {@link ValueType} has changed
     */
    readonly CHANGED_FIELD_CODE?: string;
    withCHANGED_FIELD_CODE(CHANGED_FIELD_CODE: string | null): BaseCodeAnalysis.VersionDiff.Metric.ValueTypeChange;

    /**
     * The sub-category code for when a [method parameter's](FunctionParam) {@link ValueType} has changed
     */
    readonly CHANGED_PARAM_CODE?: string;
    withCHANGED_PARAM_CODE(CHANGED_PARAM_CODE: string | null): BaseCodeAnalysis.VersionDiff.Metric.ValueTypeChange;

    /**
     * The sub-category code for when a [method's return type](MethodType#returnType) has changed
     */
    readonly CHANGED_RETURN_CODE?: string;
    withCHANGED_RETURN_CODE(CHANGED_RETURN_CODE: string | null): BaseCodeAnalysis.VersionDiff.Metric.ValueTypeChange;
