// TypeScript definitions for the C3 type BaseCodeAnalysis.Metric

/**
 * Abstract type for all {@link BaseCodeAnalysis} metrics. All metrics will extend this type.
 *
 * @remarks this represents a value passed to a method that expects an instance of BaseCodeAnalysis.Metric
 */
 ...
 * Abstract type for all {@link BaseCodeAnalysis} metrics. All metrics will extend this type.
 *
 * @remarks this represents a made instance of BaseCodeAnalysis.Metric
 */
declare namespace BaseCodeAnalysis {
  export class Metric extends Obj  {
     ...
     * @see #toJson
     */
    static fromJson(json: any): BaseCodeAnalysis.Metric | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): BaseCodeAnalysis.Metric | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): BaseCodeAnalysis.Metric | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): BaseCodeAnalysis.Metric | null;
     ...
     */
    replaceType(old: Type, new_: Type): BaseCodeAnalysis.Metric;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): BaseCodeAnalysis.Metric;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): BaseCodeAnalysis.Metric;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<BaseCodeAnalysis.Metric>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<BaseCodeAnalysis.Metric>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): BaseCodeAnalysis.Metric;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): BaseCodeAnalysis.Metric;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): BaseCodeAnalysis.Metric;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): BaseCodeAnalysis.Metric;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): BaseCodeAnalysis.Metric;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): BaseCodeAnalysis.Metric;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): BaseCodeAnalysis.Metric;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): BaseCodeAnalysis.Metric;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): BaseCodeAnalysis.Metric;
     ...
     * @see #removeField
     */
    withoutField(field: string): BaseCodeAnalysis.Metric;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): BaseCodeAnalysis.Metric;
     ...
     */
    withoutFields(fields: Array_Type<string>): BaseCodeAnalysis.Metric;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): BaseCodeAnalysis.Metric;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): BaseCodeAnalysis.Metric;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): BaseCodeAnalysis.Metric;
     ...
     * @see #unsetField
     */
    defaultField(field: string): BaseCodeAnalysis.Metric;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): BaseCodeAnalysis.Metric;
     ...
     * @see #removeField
     */
    unsetField(field: string): BaseCodeAnalysis.Metric;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): BaseCodeAnalysis.Metric;
     ...
     * @see #unsetField
     */
    removeField(field: string): BaseCodeAnalysis.Metric;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): BaseCodeAnalysis.Metric;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): BaseCodeAnalysis.Metric;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): BaseCodeAnalysis.Metric;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): BaseCodeAnalysis.Metric;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): BaseCodeAnalysis.Metric;

    mergeJson(json: any): BaseCodeAnalysis.Metric;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): BaseCodeAnalysis.Metric;
     ...
     */
    sumObj(other: Obj, deep?: boolean): BaseCodeAnalysis.Metric;
     ...
     */
    singletonArray(): Array_Type<BaseCodeAnalysis.Metric>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<BaseCodeAnalysis.Metric> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<BaseCodeAnalysis.Metric> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<BaseCodeAnalysis.Metric>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<BaseCodeAnalysis.Metric> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, BaseCodeAnalysis.Metric> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, BaseCodeAnalysis.Metric> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<BaseCodeAnalysis.Metric>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<BaseCodeAnalysis.Metric>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): BaseCodeAnalysis.Metric;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): BaseCodeAnalysis.Metric;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): BaseCodeAnalysis.Metric;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): BaseCodeAnalysis.Metric;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): BaseCodeAnalysis.Metric;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): BaseCodeAnalysis.Metric;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): BaseCodeAnalysis.Metric;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): BaseCodeAnalysis.Metric;
     ...
     */
    static cachedEmptyInst(): BaseCodeAnalysis.Metric;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<BaseCodeAnalysis.Metric> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): BaseCodeAnalysis.Metric;
