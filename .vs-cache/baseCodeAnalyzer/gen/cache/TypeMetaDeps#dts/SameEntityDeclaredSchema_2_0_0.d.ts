// TypeScript definitions for the C3 type SameEntityDeclaredSchema_2_0_0

/**
 * This entity Type's declared schema name doesn't change.
 *
 * @remarks this represents a value passed to a method that expects an instance of SameEntityDeclaredSchema_2_0_0
 */
declare interface ISameEntityDeclaredSchema_2_0_0 {
 ...
 */
declare class SameEntityDeclaredSchema_2_0_0 extends Obj  {
  ...
  withTypeIdent(typeIdent: string | null): SameEntityDeclaredSchema_2_0_0;
   ...
   */
  readonly id: string;
  withId(id: string): SameEntityDeclaredSchema_2_0_0;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): SameEntityDeclaredSchema_2_0_0;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): SameEntityDeclaredSchema_2_0_0;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): SameEntityDeclaredSchema_2_0_0;
  ...
  withVersion(version: number | null): SameEntityDeclaredSchema_2_0_0;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): SameEntityDeclaredSchema_2_0_0;
   ...
   * @see #toJson
   */
  static fromJson(json: any): SameEntityDeclaredSchema_2_0_0 | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): SameEntityDeclaredSchema_2_0_0 | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): SameEntityDeclaredSchema_2_0_0 | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): SameEntityDeclaredSchema_2_0_0 | null;
   ...
   */
  replaceType(old: Type, new_: Type): SameEntityDeclaredSchema_2_0_0;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): SameEntityDeclaredSchema_2_0_0;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): SameEntityDeclaredSchema_2_0_0;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<SameEntityDeclaredSchema_2_0_0>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<SameEntityDeclaredSchema_2_0_0>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): SameEntityDeclaredSchema_2_0_0;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SameEntityDeclaredSchema_2_0_0;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SameEntityDeclaredSchema_2_0_0;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): SameEntityDeclaredSchema_2_0_0;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): SameEntityDeclaredSchema_2_0_0;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): SameEntityDeclaredSchema_2_0_0;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): SameEntityDeclaredSchema_2_0_0;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): SameEntityDeclaredSchema_2_0_0;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): SameEntityDeclaredSchema_2_0_0;
   ...
   * @see #removeField
   */
  withoutField(field: string): SameEntityDeclaredSchema_2_0_0;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): SameEntityDeclaredSchema_2_0_0;
   ...
   */
  withoutFields(fields: Array_Type<string>): SameEntityDeclaredSchema_2_0_0;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): SameEntityDeclaredSchema_2_0_0;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): SameEntityDeclaredSchema_2_0_0;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): SameEntityDeclaredSchema_2_0_0;
   ...
   * @see #unsetField
   */
  defaultField(field: string): SameEntityDeclaredSchema_2_0_0;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): SameEntityDeclaredSchema_2_0_0;
   ...
   * @see #removeField
   */
  unsetField(field: string): SameEntityDeclaredSchema_2_0_0;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): SameEntityDeclaredSchema_2_0_0;
   ...
   * @see #unsetField
   */
  removeField(field: string): SameEntityDeclaredSchema_2_0_0;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): SameEntityDeclaredSchema_2_0_0;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): SameEntityDeclaredSchema_2_0_0;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): SameEntityDeclaredSchema_2_0_0;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): SameEntityDeclaredSchema_2_0_0;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): SameEntityDeclaredSchema_2_0_0;

  mergeJson(json: any): SameEntityDeclaredSchema_2_0_0;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): SameEntityDeclaredSchema_2_0_0;
   ...
   */
  sumObj(other: Obj, deep?: boolean): SameEntityDeclaredSchema_2_0_0;
   ...
   */
  singletonArray(): Array_Type<SameEntityDeclaredSchema_2_0_0>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<SameEntityDeclaredSchema_2_0_0> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<SameEntityDeclaredSchema_2_0_0> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<SameEntityDeclaredSchema_2_0_0>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<SameEntityDeclaredSchema_2_0_0> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, SameEntityDeclaredSchema_2_0_0> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, SameEntityDeclaredSchema_2_0_0> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<SameEntityDeclaredSchema_2_0_0>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<SameEntityDeclaredSchema_2_0_0>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): SameEntityDeclaredSchema_2_0_0;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): SameEntityDeclaredSchema_2_0_0;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): SameEntityDeclaredSchema_2_0_0;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): SameEntityDeclaredSchema_2_0_0;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): SameEntityDeclaredSchema_2_0_0;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): SameEntityDeclaredSchema_2_0_0;
   ...
   * @see #fromString
   */
  static make(s: string): SameEntityDeclaredSchema_2_0_0 | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): SameEntityDeclaredSchema_2_0_0;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): SameEntityDeclaredSchema_2_0_0;
   ...
   */
  static cachedEmptyInst(): SameEntityDeclaredSchema_2_0_0;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<SameEntityDeclaredSchema_2_0_0> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): SameEntityDeclaredSchema_2_0_0;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<SameEntityDeclaredSchema_2_0_0>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<SameEntityDeclaredSchema_2_0_0>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<SameEntityDeclaredSchema_2_0_0> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<SameEntityDeclaredSchema_2_0_0>> | null;
   ...
   */
  get(include?: string): SameEntityDeclaredSchema_2_0_0 | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): SameEntityDeclaredSchema_2_0_0 | null;
   ...
   */
  getMissing(spec: GetMissingSpec): SameEntityDeclaredSchema_2_0_0;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): SameEntityDeclaredSchema_2_0_0 | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): SameEntityDeclaredSchema_2_0_0;
   ...
   * @see #toString
   */
  static fromString(s: string): SameEntityDeclaredSchema_2_0_0 | null;
   ...
   */
  create(spec?: UpsertSpec): SameEntityDeclaredSchema_2_0_0 | null;
   ...
   */
  static createBatch(objs: Array_Type<SameEntityDeclaredSchema_2_0_0>, spec?: UpsertSpec): ObjList<SameEntityDeclaredSchema_2_0_0> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<SameEntityDeclaredSchema_2_0_0>, spec?: CreateBatchObjStreamSpec): ObjList<SameEntityDeclaredSchema_2_0_0> | null;
   ...
   */
  update(srcObj?: SameEntityDeclaredSchema_2_0_0, spec?: UpsertSpec): SameEntityDeclaredSchema_2_0_0 | null;
   ...
   */
  upsert(srcObj?: SameEntityDeclaredSchema_2_0_0, spec?: UpsertSpec): SameEntityDeclaredSchema_2_0_0 | null;
   ...
   */
  merge(spec?: MergeSpec): SameEntityDeclaredSchema_2_0_0 | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): SameEntityDeclaredSchema_2_0_0 | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): SameEntityDeclaredSchema_2_0_0 | null;
   ...
   */
  static updateBatch(objs: Array_Type<SameEntityDeclaredSchema_2_0_0>, srcObjs?: Array_Type<SameEntityDeclaredSchema_2_0_0>, spec?: UpsertSpec): ObjList<SameEntityDeclaredSchema_2_0_0> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<SameEntityDeclaredSchema_2_0_0> | null>, spec?: UpsertSpec): ObjList<SameEntityDeclaredSchema_2_0_0> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<SameEntityDeclaredSchema_2_0_0>, srcObjs?: Array_Type<SameEntityDeclaredSchema_2_0_0>, spec?: UpsertSpec): ObjList<SameEntityDeclaredSchema_2_0_0> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<SameEntityDeclaredSchema_2_0_0> | null>, spec?: UpsertSpec): ObjList<SameEntityDeclaredSchema_2_0_0> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<SameEntityDeclaredSchema_2_0_0>, spec?: TouchSpec): ObjList<SameEntityDeclaredSchema_2_0_0> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<SameEntityDeclaredSchema_2_0_0>, spec?: MergeSpec): ObjList<SameEntityDeclaredSchema_2_0_0> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<SameEntityDeclaredSchema_2_0_0>, mergeInclude: string, spec?: MergeSpec): ObjList<SameEntityDeclaredSchema_2_0_0> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<SameEntityDeclaredSchema_2_0_0> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<SameEntityDeclaredSchema_2_0_0> | null;
   ...
   */
  static mergeAll(mergeObj: SameEntityDeclaredSchema_2_0_0, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: SameEntityDeclaredSchema_2_0_0, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<SameEntityDeclaredSchema_2_0_0>, spec?: UpsertSpec): ObjList<SameEntityDeclaredSchema_2_0_0> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<SameEntityDeclaredSchema_2_0_0>, spec?: UpsertSpec): ObjList<SameEntityDeclaredSchema_2_0_0> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): SameEntityDeclaredSchema_2_0_0 | null;
   ...
   */
  static beforeCreate(objs: Array_Type<SameEntityDeclaredSchema_2_0_0>): ObjList<SameEntityDeclaredSchema_2_0_0>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<SameEntityDeclaredSchema_2_0_0>): ObjList<SameEntityDeclaredSchema_2_0_0>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<SameEntityDeclaredSchema_2_0_0>): ObjList<SameEntityDeclaredSchema_2_0_0>;
   ...
   */
  static afterCreate(objs: Array_Type<SameEntityDeclaredSchema_2_0_0>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<SameEntityDeclaredSchema_2_0_0>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<SameEntityDeclaredSchema_2_0_0>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<SameEntityDeclaredSchema_2_0_0>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<SameEntityDeclaredSchema_2_0_0>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): SameEntityDeclaredSchema_2_0_0 | null;
   ...
   */
  withoutIdentity(): SameEntityDeclaredSchema_2_0_0 | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<SameEntityDeclaredSchema_2_0_0>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: SameEntityDeclaredSchema_2_0_0, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<SameEntityDeclaredSchema_2_0_0>, callback?: λFunction<SameEntityDeclaredSchema_2_0_0 | null, SameEntityDeclaredSchema_2_0_0 | null>): ObjList<SameEntityDeclaredSchema_2_0_0>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<SameEntityDeclaredSchema_2_0_0>, callback?: λFunction<SameEntityDeclaredSchema_2_0_0 | null, SameEntityDeclaredSchema_2_0_0 | null>): Array_Type<ObjError> | null;
