// TypeScript definitions for the C3 type BaseCodeAnalysis.Metric.FieldCount

/**
 * Code analysis metric that counts the number of fields and methods in c3typ files in the file specs.
 *
 * @remarks this represents a value passed to a method that expects an instance of BaseCodeAnalysis.Metric.FieldCount
 */
declare namespace BaseCodeAnalysis.Metric {
  export interface IFieldCount {
  }
}
 ...
 */
declare namespace BaseCodeAnalysis.Metric {
  export class FieldCount extends Obj  {
     ...
     * @see #toJson
     */
    static fromJson(json: any): BaseCodeAnalysis.Metric.FieldCount | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): BaseCodeAnalysis.Metric.FieldCount | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): BaseCodeAnalysis.Metric.FieldCount | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): BaseCodeAnalysis.Metric.FieldCount | null;
     ...
     */
    replaceType(old: Type, new_: Type): BaseCodeAnalysis.Metric.FieldCount;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): BaseCodeAnalysis.Metric.FieldCount;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): BaseCodeAnalysis.Metric.FieldCount;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<BaseCodeAnalysis.Metric.FieldCount>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<BaseCodeAnalysis.Metric.FieldCount>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): BaseCodeAnalysis.Metric.FieldCount;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): BaseCodeAnalysis.Metric.FieldCount;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): BaseCodeAnalysis.Metric.FieldCount;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): BaseCodeAnalysis.Metric.FieldCount;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): BaseCodeAnalysis.Metric.FieldCount;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): BaseCodeAnalysis.Metric.FieldCount;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): BaseCodeAnalysis.Metric.FieldCount;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): BaseCodeAnalysis.Metric.FieldCount;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): BaseCodeAnalysis.Metric.FieldCount;
     ...
     * @see #removeField
     */
    withoutField(field: string): BaseCodeAnalysis.Metric.FieldCount;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): BaseCodeAnalysis.Metric.FieldCount;
     ...
     */
    withoutFields(fields: Array_Type<string>): BaseCodeAnalysis.Metric.FieldCount;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): BaseCodeAnalysis.Metric.FieldCount;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): BaseCodeAnalysis.Metric.FieldCount;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): BaseCodeAnalysis.Metric.FieldCount;
     ...
     * @see #unsetField
     */
    defaultField(field: string): BaseCodeAnalysis.Metric.FieldCount;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): BaseCodeAnalysis.Metric.FieldCount;
     ...
     * @see #removeField
     */
    unsetField(field: string): BaseCodeAnalysis.Metric.FieldCount;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): BaseCodeAnalysis.Metric.FieldCount;
     ...
     * @see #unsetField
     */
    removeField(field: string): BaseCodeAnalysis.Metric.FieldCount;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): BaseCodeAnalysis.Metric.FieldCount;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): BaseCodeAnalysis.Metric.FieldCount;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): BaseCodeAnalysis.Metric.FieldCount;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): BaseCodeAnalysis.Metric.FieldCount;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): BaseCodeAnalysis.Metric.FieldCount;

    mergeJson(json: any): BaseCodeAnalysis.Metric.FieldCount;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): BaseCodeAnalysis.Metric.FieldCount;
     ...
     */
    sumObj(other: Obj, deep?: boolean): BaseCodeAnalysis.Metric.FieldCount;
     ...
     */
    singletonArray(): Array_Type<BaseCodeAnalysis.Metric.FieldCount>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<BaseCodeAnalysis.Metric.FieldCount> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<BaseCodeAnalysis.Metric.FieldCount> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<BaseCodeAnalysis.Metric.FieldCount>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<BaseCodeAnalysis.Metric.FieldCount> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, BaseCodeAnalysis.Metric.FieldCount> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, BaseCodeAnalysis.Metric.FieldCount> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<BaseCodeAnalysis.Metric.FieldCount>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<BaseCodeAnalysis.Metric.FieldCount>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): BaseCodeAnalysis.Metric.FieldCount;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): BaseCodeAnalysis.Metric.FieldCount;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): BaseCodeAnalysis.Metric.FieldCount;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): BaseCodeAnalysis.Metric.FieldCount;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): BaseCodeAnalysis.Metric.FieldCount;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): BaseCodeAnalysis.Metric.FieldCount;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): BaseCodeAnalysis.Metric.FieldCount;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): BaseCodeAnalysis.Metric.FieldCount;
     ...
     */
    static cachedEmptyInst(): BaseCodeAnalysis.Metric.FieldCount;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<BaseCodeAnalysis.Metric.FieldCount> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): BaseCodeAnalysis.Metric.FieldCount;
