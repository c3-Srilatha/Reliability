// TypeScript definitions for the C3 type BaseCodeAnalysis.VersionDiff.Metric.ValueModifierChange
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of BaseCodeAnalysis.VersionDiff.Metric.ValueModifierChange
 */
declare namespace BaseCodeAnalysis.VersionDiff.Metric {
  export interface IValueModifierChange {
 ...
 */
declare namespace BaseCodeAnalysis.VersionDiff.Metric {
  export class ValueModifierChange {

    /**
     * The code for this version diff metric
     */
    readonly METRIC_CODE?: string;
    withMETRIC_CODE(METRIC_CODE: string | null): BaseCodeAnalysis.VersionDiff.Metric.ValueModifierChange;

    /**
     * The sub-category code for when a [field's](DeclaredFieldType) {@link ValueModifier}
     * has changed
     */
    readonly CHANGED_FIELD_CODE?: string;
    withCHANGED_FIELD_CODE(CHANGED_FIELD_CODE: string | null): BaseCodeAnalysis.VersionDiff.Metric.ValueModifierChange;

    /**
     * The sub-category code for when a [method parameter's](FunctionParam) {@link ValueModifier}
     * has changed
     */
    readonly CHANGED_PARAM_CODE?: string;
    withCHANGED_PARAM_CODE(CHANGED_PARAM_CODE: string | null): BaseCodeAnalysis.VersionDiff.Metric.ValueModifierChange;

    /**
     * The sub-category code for when a [method's return type's](MethodType#returnType)
     * {@link ValueModifier} has changed
     */
    readonly CHANGED_RETURN_CODE?: string;
    withCHANGED_RETURN_CODE(CHANGED_RETURN_CODE: string | null): BaseCodeAnalysis.VersionDiff.Metric.ValueModifierChange;
