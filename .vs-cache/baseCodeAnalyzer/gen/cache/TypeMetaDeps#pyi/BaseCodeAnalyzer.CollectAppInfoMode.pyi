...
# Python definitions for the C3 type BaseCodeAnalyzer.CollectAppInfoMode


class CollectAppInfoMode():
    """
    ...
    **TESTING PURPOSES ONLY**
    ...
    """
    def __init__(self, DEEP: Optional[str]=None, CUSTOM: Optional[str]=None, TEST: Optional[str]=None) -> None: ...
