...
# Python definitions for the C3 type ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0


class ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0():
    """
    ...
    renameFieldSameSchema_R: Optional[str]=None
    """
    ...
    renameFieldChangeDeclaredSchema_R: Optional[str]=None
    """
    ...
    renameFieldNoDeclaredSchema_R: Optional[str]=None
    """
    This field is renamed and has no declared schema name.
    """
    def __init__(self, id: Optional[str]=None, versionEdits: Optional[Array[VersionEdit]]=None, name: Optional[str]=None, meta: Optional[Meta]=None, version: Optional[int]=None, typeWithBindings: Optional[Type]=None, renameFieldSameSchema: Optional[str]=None, renameFieldSameSchema_R: Optional[str]=None, renameFieldChangeDeclaredSchema: Optional[str]=None, renameFieldChangeDeclaredSchema_R: Optional[str]=None, renameFieldNoDeclaredSchema: Optional[str]=None, renameFieldNoDeclaredSchema_R: Optional[str]=None) -> None: ...
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0:
    """
    @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0:
    """
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0:
    """
    ...
    """
        ...
    def afterMake(self) -> ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, spec: FetchSpec=None) -> FetchResult[ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0]:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, filter: Filter) -> FetchResult[ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0]:
    """
    ...
    """
        ...
    @classmethod
    def fetchObjStream(cls, spec: FetchStreamSpec=None) -> Union[Stream[ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0]]:
    """
    Fetches multiple obj instances based on a specification.  Only objs that the caller is authorized to fetch will be
    returned.
    ...
    """
        ...
    @classmethod
    def fetchMultiLocale(cls, spec: MultiLocaleFetchSpec=None) -> Union[Map[str, FetchResult[ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0]]]:
    """
    ...
    """
        ...
    def get(self, include: str=None) -> Union[ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0]:
    """
    ...
    """
        ...
    def getSpecific(self, include: str=None) -> Union[ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0]:
    """
    ...
    """
        ...
    def getMissing(self, spec: GetMissingSpec) -> ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0:
    """
    ...
    """
        ...
    def getDirect(self, include: str=None) -> Union[ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0]:
    """
    ...
    """
        ...
    def applyReverseEdit(self, versionEdit: VersionEdit) -> ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0:
    """
    ...
    """
        ...
    @classmethod
    def fromString(cls, s: str) -> Union[ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0]:
    """
    ...
    """
        ...
    def create(self, spec: UpsertSpec=None) -> Union[ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0]:
    """
    ...
    """
        ...
    @classmethod
    def createBatch(cls, objs: Array[ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0], spec: UpsertSpec=None) -> Union[ObjList[ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0]]:
    """
    ...
    """
        ...
    @classmethod
    def createBatchObjStream(cls, objs: Stream[ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0], spec: CreateBatchObjStreamSpec=None) -> Union[ObjList[ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0]]:
    """
    Creates multiple instances of a C3 type. If the operation fails and {@link UpsertSpec#dontThrowOnBatchError} is not
    specified (the default), then a C3BatchException will be thrown.  Otherwise {@link errors will be reported in the
    returned {@link ObjList}.  This will fail if any of the instances already exist.
    ...
    """
        ...
    def update(self, srcObj: ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0=None, spec: UpsertSpec=None) -> Union[ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0]:
    """
    ...
    """
        ...
    def upsert(self, srcObj: ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0=None, spec: UpsertSpec=None) -> Union[ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0]:
    """
    ...
    """
        ...
    @overload
    def merge(self, spec: MergeSpec=None) -> Union[ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0]:
    """
    ...
    """
        ...
    @overload
    def merge(self, mergeInclude: str, spec: MergeSpec=None) -> Union[ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0]:
    """
    ...
    """
        ...
    def touch(self, spec: TouchSpec=None) -> Union[ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0]:
    """
    ...
    """
        ...
    @classmethod
    def updateBatch(cls, objs: Array[ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0], srcObjs: Array[ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0]=None, spec: UpsertSpec=None) -> Union[ObjList[ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0]]:
    """
    ...
    """
        ...
    @classmethod
    def updateObjs(cls, objs: Callable[[], Union[Array[ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0]]], spec: UpsertSpec=None) -> Union[ObjList[ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0]]:
    """
    ...
    """
        ...
    @classmethod
    def upsertBatch(cls, objs: Array[ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0], srcObjs: Array[ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0]=None, spec: UpsertSpec=None) -> Union[ObjList[ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0]]:
    """
    ...
    """
        ...
    @classmethod
    def upsertObjs(cls, objs: Callable[[], Union[Array[ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0]]], spec: UpsertSpec=None) -> Union[ObjList[ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0]]:
    """
    Creates instances of a C3 type if they don't already exist and updates them if they do exist. If the operation
    ...
    """
        ...
    @classmethod
    def touchBatch(cls, objs: Array[ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0], spec: TouchSpec=None) -> Union[ObjList[ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0]]:
    """
    ...
    @overload
    @classmethod
    def mergeBatch(cls, objs: Array[ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0], spec: MergeSpec=None) -> Union[ObjList[ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0]]:
    """
    ...
    @overload
    @classmethod
    def mergeBatch(cls, objs: Array[ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0]]:
    """
    Merges multiple instances of a C3 type or creates them if they don't exist. If the operation fails and {@link
    UpsertSpec#dontThrowOnBatchError} is not specified (the default), then a C3BatchException will be thrown.
    Otherwise errors will be reported in the returned {@link ObjList}.  The merge operation is described in the {@link
    ...
    """
        ...
    @classmethod
    def mergeObjs(cls, objs: Callable[[], Union[Array[ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0]]], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0]]:
    """
    ...
    @overload
    @classmethod
    def mergeAll(cls, mergeObj: ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0, spec: MergeAllSpec=None) -> Union[int]:
    """
    ...
    @overload
    @classmethod
    def mergeAll(cls, mergeObj: ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0, mergeInclude: str, spec: MergeAllSpec=None) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def removeBatch(cls, objs: Array[ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0], spec: UpsertSpec=None) -> Union[ObjList[ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0]]:
    """
    ...
    """
        ...
    @classmethod
    def replace(cls, objs: Array[ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0], spec: UpsertSpec=None) -> Union[ObjList[ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0]]:
    """
    ...
    """
        ...
    def unremove(self) -> Union[ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0]:
    """
    ...
    """
        ...
    @classmethod
    def beforeCreate(cls, objs: Array[ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0]) -> ObjList[ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0]:
    """
    ...
    """
        ...
    @classmethod
    def beforeUpdate(cls, objs: Array[ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0]) -> ObjList[ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0]:
    """
    ...
    """
        ...
    @classmethod
    def beforeRemove(cls, objs: Array[ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0]) -> ObjList[ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0]:
    """
    ...
    """
        ...
    @classmethod
    def afterCreate(cls, objs: Array[ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def afterUpdate(cls, objs: Array[ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def afterRemove(cls, objs: Array[ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def startImportData(cls, spec: StartImportDataSpec=None) -> PushStream[ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0]:
    """
    @return a push stream to import instances of this type.
    """
        ...
    @classmethod
    def startImportDataWithStats(cls, spec: StartImportDataSpec=None) -> PushStreamWithStats[ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0]:
    """
    @return a push stream to import instances of this type.
    """
        ...
    ...
    """
        ...
    @classmethod
    def forId(cls, id: str, failIfMissing: bool=None) -> Union[ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0]:
    """
    ...
    """
        ...
    def withoutIdentity(self) -> Union[ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0]:
    """
    ...
    """
        ...
    @classmethod
    def typeOfBatch(cls, objs: Array[ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0]) -> Union[Array[EntityType]]:
    """
    ...
    """
        ...
    @classmethod
    def dbEcho(cls, template: ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0=None, count: int=None, sendBack: bool=None) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def callbackLogic(cls, objs: Array[ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0], callback: Callable[[Union[ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0]], Union[ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0]]=None) -> ObjList[ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0]:
    """
    ...
    """
        ...
    @classmethod
    def afterCallbackLogic(cls, objs: Array[ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0], callback: Callable[[Union[ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0]], Union[ChangeEntityRenameFieldRemoveFieldDeclaredSchema_2_0_0]]=None) -> Union[Array[ObjError]]:
    """
