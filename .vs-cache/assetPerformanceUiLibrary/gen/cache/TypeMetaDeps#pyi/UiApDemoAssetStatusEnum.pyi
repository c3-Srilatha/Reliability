...
# Python definitions for the C3 type UiApDemoAssetStatusEnum


class UiApDemoAssetStatusEnum():
    """
    ...
    """
    def __init__(self, OPERATIONAL: Optional[str]=None, MAINTENANCE: Optional[str]=None, OFFLINE: Optional[str]=None, WARNING: Optional[str]=None, ERROR: Optional[str]=None) -> None: ...
