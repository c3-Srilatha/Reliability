// TypeScript definitions for the C3 type UiApTimeseriesDataStore
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of UiApTimeseriesDataStore
 */
declare interface IUiApTimeseriesDataStore {
 ...
 */
declare class UiApTimeseriesDataStore extends Obj  {

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): UiApTimeseriesDataStore;

  /**
   * Unique identifier for the logical object that instance of this type represents.
   */
  readonly id?: string;
  withId(id: string | null): UiApTimeseriesDataStore;

  /**
   * The name of the component. Optional field for informational purposes only.
   */
  readonly name?: string;
  withName(name: string | null): UiApTimeseriesDataStore;
  ...
  withDataSpec(dataSpec: IUiSdlNoData | null): UiApTimeseriesDataStore;

  /**
   * Disable if you want to avoid sending any and all requests for this component on first render.
   */
  readonly disableDataRequestOnFirstRender?: boolean;
  withDisableDataRequestOnFirstRender(disableDataRequestOnFirstRender: boolean): UiApTimeseriesDataStore;

  /**
   * Whether the effect triggers and epics have been registered
   */
  readonly triggersRegistered?: boolean;
  withTriggersRegistered(triggersRegistered: boolean): UiApTimeseriesDataStore;

  /**
   * Whether to wrap the component with a div which has a class name of its metdata id. Useful for targeting with css.
   */
  readonly wrapWithMetadataId?: boolean;
  withWrapWithMetadataId(wrapWithMetadataId: boolean): UiApTimeseriesDataStore;

  /**
   * The Redux namespace for the application state to indicate where the application data is stored in the Redux state.
   */
  readonly REDUX_NAMESPACE?: string;
  withREDUX_NAMESPACE(REDUX_NAMESPACE: string | null): UiApTimeseriesDataStore;

  /**
   * Collection of extra async {@link UiSdlEffectTrigger}.
   */
  readonly effectTriggers?: Array_Type<UiSdlEffectTrigger>;
  withEffectTriggers(effectTriggers: Array_Type<UiSdlEffectTrigger> | Array<IUiSdlEffectTrigger> | null): UiApTimeseriesDataStore;
  ...
  withActionMap(actionMap: Map_Type<string, UiApDataStoreAction> | {[key: string]: IUiApDataStoreAction} | null): UiApTimeseriesDataStore;
  ...
  withResolvedActionMap(resolvedActionMap: Map_Type<string, UiApDataStoreAction> | {[key: string]: IUiApDataStoreAction} | null): UiApTimeseriesDataStore;

  /**
   * A map of data IDs to the data that has been fetched.
   */
  readonly dataMap?: Map_Type<string, any>;
  withDataMap(dataMap: Map_Type<string, any> | {[key: string]: any} | null): UiApTimeseriesDataStore;
  ...
  withContextVars(contextVars: Map_Type<string, UiSdlDynamicValueSpecParam> | {[key: string]: IUiSdlDynamicValueSpecParam} | null): UiApTimeseriesDataStore;
  ...
  withResolvedContextVars(resolvedContextVars: Map_Type<string, any> | {[key: string]: any} | null): UiApTimeseriesDataStore;

  /**
   * A map of data IDs to a boolean indicating if the data is currently being fetched.
   */
  readonly isLoadingMap?: Map_Type<string, boolean>;
  withIsLoadingMap(isLoadingMap: Map_Type<string, boolean> | {[key: string]: boolean} | null): UiApTimeseriesDataStore;
   ...
   * @see #toJson
   */
  static fromJson(json: any): UiApTimeseriesDataStore | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): UiApTimeseriesDataStore | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): UiApTimeseriesDataStore | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): UiApTimeseriesDataStore | null;
   ...
   */
  replaceType(old: Type, new_: Type): UiApTimeseriesDataStore;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): UiApTimeseriesDataStore;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): UiApTimeseriesDataStore;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<UiApTimeseriesDataStore>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<UiApTimeseriesDataStore>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): UiApTimeseriesDataStore;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiApTimeseriesDataStore;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiApTimeseriesDataStore;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): UiApTimeseriesDataStore;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): UiApTimeseriesDataStore;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): UiApTimeseriesDataStore;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): UiApTimeseriesDataStore;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): UiApTimeseriesDataStore;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): UiApTimeseriesDataStore;
   ...
   * @see #removeField
   */
  withoutField(field: string): UiApTimeseriesDataStore;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): UiApTimeseriesDataStore;
   ...
   */
  withoutFields(fields: Array_Type<string>): UiApTimeseriesDataStore;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): UiApTimeseriesDataStore;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): UiApTimeseriesDataStore;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): UiApTimeseriesDataStore;
   ...
   * @see #unsetField
   */
  defaultField(field: string): UiApTimeseriesDataStore;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): UiApTimeseriesDataStore;
   ...
   * @see #removeField
   */
  unsetField(field: string): UiApTimeseriesDataStore;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): UiApTimeseriesDataStore;
   ...
   * @see #unsetField
   */
  removeField(field: string): UiApTimeseriesDataStore;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): UiApTimeseriesDataStore;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): UiApTimeseriesDataStore;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): UiApTimeseriesDataStore;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): UiApTimeseriesDataStore;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): UiApTimeseriesDataStore;

  mergeJson(json: any): UiApTimeseriesDataStore;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): UiApTimeseriesDataStore;
   ...
   */
  sumObj(other: Obj, deep?: boolean): UiApTimeseriesDataStore;
   ...
   */
  singletonArray(): Array_Type<UiApTimeseriesDataStore>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<UiApTimeseriesDataStore> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<UiApTimeseriesDataStore> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<UiApTimeseriesDataStore>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<UiApTimeseriesDataStore> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, UiApTimeseriesDataStore> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, UiApTimeseriesDataStore> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<UiApTimeseriesDataStore>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<UiApTimeseriesDataStore>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): UiApTimeseriesDataStore;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): UiApTimeseriesDataStore;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): UiApTimeseriesDataStore;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): UiApTimeseriesDataStore;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): UiApTimeseriesDataStore;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): UiApTimeseriesDataStore;
   ...
   * @see #fromString
   */
  static make(s: string): UiApTimeseriesDataStore | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): UiApTimeseriesDataStore;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): UiApTimeseriesDataStore;
   ...
   */
  static cachedEmptyInst(): UiApTimeseriesDataStore;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<UiApTimeseriesDataStore> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): UiApTimeseriesDataStore;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<UiApTimeseriesDataStore>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<UiApTimeseriesDataStore>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<UiApTimeseriesDataStore> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<UiApTimeseriesDataStore>> | null;
   ...
   */
  dependencies(): MetadataDeps<UiApTimeseriesDataStore>;

  save(subPath?: string, contentType?: string): UiApTimeseriesDataStore;
  ...
  update(srcObj?: UiApTimeseriesDataStore, spec?: UpsertSpec): UiApTimeseriesDataStore | null;

  upsert(srcObj?: UiApTimeseriesDataStore, spec?: UpsertSpec): UiApTimeseriesDataStore | null;
   ...
   * @see #toString
   */
  static fromString(s: string): UiApTimeseriesDataStore | null;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string, failIfMissing?: boolean): UiApTimeseriesDataStore | null;
   ...
   */
  static doDataMerge(componentId: string, dataSpecFieldName: string, dataDestinationFieldName: string, props: UiApTimeseriesDataStore, state: UiSdlReduxState): UiApTimeseriesDataStore | null;
