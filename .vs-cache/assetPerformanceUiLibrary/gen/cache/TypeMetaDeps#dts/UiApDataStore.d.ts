// TypeScript definitions for the C3 type UiApDataStore
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of UiApDataStore
 */
declare interface IUiApDataStore {
 ...
 */
declare class UiApDataStore extends Obj  {

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): UiApDataStore;

  /**
   * Unique identifier for the logical object that instance of this type represents.
   */
  readonly id?: string;
  withId(id: string | null): UiApDataStore;

  /**
   * The name of the component. Optional field for informational purposes only.
   */
  readonly name?: string;
  withName(name: string | null): UiApDataStore;
  ...
  withDataSpec(dataSpec: IUiSdlNoData | null): UiApDataStore;

  /**
   * Disable if you want to avoid sending any and all requests for this component on first render.
   */
  readonly disableDataRequestOnFirstRender?: boolean;
  withDisableDataRequestOnFirstRender(disableDataRequestOnFirstRender: boolean): UiApDataStore;

  /**
   * Whether the effect triggers and epics have been registered
   */
  readonly triggersRegistered?: boolean;
  withTriggersRegistered(triggersRegistered: boolean): UiApDataStore;

  /**
   * Whether to wrap the component with a div which has a class name of its metdata id. Useful for targeting with css.
   */
  readonly wrapWithMetadataId?: boolean;
  withWrapWithMetadataId(wrapWithMetadataId: boolean): UiApDataStore;

  /**
   * The Redux namespace for the application state to indicate where the application data is stored in the Redux state.
   */
  readonly REDUX_NAMESPACE?: string;
  withREDUX_NAMESPACE(REDUX_NAMESPACE: string | null): UiApDataStore;

  /**
   * Collection of extra async {@link UiSdlEffectTrigger}.
   */
  readonly effectTriggers?: Array_Type<UiSdlEffectTrigger>;
  withEffectTriggers(effectTriggers: Array_Type<UiSdlEffectTrigger> | Array<IUiSdlEffectTrigger> | null): UiApDataStore;
  ...
  withActionMap(actionMap: Map_Type<string, UiApDataStoreAction> | {[key: string]: IUiApDataStoreAction} | null): UiApDataStore;
  ...
  withResolvedActionMap(resolvedActionMap: Map_Type<string, UiApDataStoreAction> | {[key: string]: IUiApDataStoreAction} | null): UiApDataStore;

  /**
   * A map of data IDs to the data that has been fetched.
   */
  readonly dataMap?: Map_Type<string, any>;
  withDataMap(dataMap: Map_Type<string, any> | {[key: string]: any} | null): UiApDataStore;
  ...
  withContextVars(contextVars: Map_Type<string, UiSdlDynamicValueSpecParam> | {[key: string]: IUiSdlDynamicValueSpecParam} | null): UiApDataStore;
  ...
  withResolvedContextVars(resolvedContextVars: Map_Type<string, any> | {[key: string]: any} | null): UiApDataStore;

  /**
   * A map of data IDs to a boolean indicating if the data is currently being fetched.
   */
  readonly isLoadingMap?: Map_Type<string, boolean>;
  withIsLoadingMap(isLoadingMap: Map_Type<string, boolean> | {[key: string]: boolean} | null): UiApDataStore;
   ...
   * @see #toJson
   */
  static fromJson(json: any): UiApDataStore | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): UiApDataStore | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): UiApDataStore | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): UiApDataStore | null;
   ...
   */
  replaceType(old: Type, new_: Type): UiApDataStore;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): UiApDataStore;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): UiApDataStore;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<UiApDataStore>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<UiApDataStore>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): UiApDataStore;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiApDataStore;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiApDataStore;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): UiApDataStore;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): UiApDataStore;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): UiApDataStore;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): UiApDataStore;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): UiApDataStore;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): UiApDataStore;
   ...
   * @see #removeField
   */
  withoutField(field: string): UiApDataStore;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): UiApDataStore;
   ...
   */
  withoutFields(fields: Array_Type<string>): UiApDataStore;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): UiApDataStore;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): UiApDataStore;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): UiApDataStore;
   ...
   * @see #unsetField
   */
  defaultField(field: string): UiApDataStore;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): UiApDataStore;
   ...
   * @see #removeField
   */
  unsetField(field: string): UiApDataStore;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): UiApDataStore;
   ...
   * @see #unsetField
   */
  removeField(field: string): UiApDataStore;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): UiApDataStore;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): UiApDataStore;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): UiApDataStore;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): UiApDataStore;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): UiApDataStore;

  mergeJson(json: any): UiApDataStore;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): UiApDataStore;
   ...
   */
  sumObj(other: Obj, deep?: boolean): UiApDataStore;
   ...
   */
  singletonArray(): Array_Type<UiApDataStore>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<UiApDataStore> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<UiApDataStore> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<UiApDataStore>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<UiApDataStore> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, UiApDataStore> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, UiApDataStore> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<UiApDataStore>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<UiApDataStore>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): UiApDataStore;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): UiApDataStore;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): UiApDataStore;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): UiApDataStore;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): UiApDataStore;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): UiApDataStore;
   ...
   * @see #fromString
   */
  static make(s: string): UiApDataStore | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): UiApDataStore;
   ...
   */
  static cachedEmptyInst(): UiApDataStore;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<UiApDataStore> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): UiApDataStore;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<UiApDataStore>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<UiApDataStore>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<UiApDataStore> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<UiApDataStore>> | null;
   ...
   */
  dependencies(): MetadataDeps<UiApDataStore>;

  save(subPath?: string, contentType?: string): UiApDataStore;
  ...
  update(srcObj?: UiApDataStore, spec?: UpsertSpec): UiApDataStore | null;

  upsert(srcObj?: UiApDataStore, spec?: UpsertSpec): UiApDataStore | null;
   ...
   * @see #toString
   */
  static fromString(s: string): UiApDataStore | null;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string, failIfMissing?: boolean): UiApDataStore | null;
   ...
   */
  static doDataMerge(componentId: string, dataSpecFieldName: string, dataDestinationFieldName: string, props: UiApDataStore, state: UiSdlReduxState): UiApDataStore | null;
