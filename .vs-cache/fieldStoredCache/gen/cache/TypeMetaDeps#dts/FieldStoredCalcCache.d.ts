// TypeScript definitions for the C3 type FieldStoredCalcCache

/**
 * A way to configure a {@link FieldStoredCalcCacheBatchJob} to cache read `calc` values directly on a persisted type's field.
 *
 * @remarks this represents a value passed to a method that expects an instance of FieldStoredCalcCache
 */
declare interface IFieldStoredCalcCache {
  ...
  /**
   * {@link DataDiagnostic#retrieveDiagnosticData} should only include the #calcField.
   */
  fetchInclude?: string;
  ...
  /**
   * The field on #srcType to store the metric result.
   */
  fieldName: string;

  /**
   * The read `calc` field defined on #srcType to read from and store on #fieldName.
   */
  calcField: string;
}
 ...
 * A way to configure a {@link FieldStoredCalcCacheBatchJob} to cache read `calc` values directly on a persisted type's field.
 *
 * @remarks this represents a made instance of FieldStoredCalcCache
 */
declare class FieldStoredCalcCache extends Obj  {
  ...
  withTypeIdent(typeIdent: string | null): FieldStoredCalcCache;
   ...
   */
  readonly id: string;
  withId(id: string): FieldStoredCalcCache;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): FieldStoredCalcCache;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): FieldStoredCalcCache;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): FieldStoredCalcCache;
  ...
  withVersion(version: number | null): FieldStoredCalcCache;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): FieldStoredCalcCache;

  /**
   * The entity type which this data diagnostic is running logic for.
   */
  readonly srcType: Type;
  withSrcType(srcType: IType): FieldStoredCalcCache;

  /**
   * High level description of what this data diagnostic is doing.
   */
  readonly description?: string;
  withDescription(description: string | null): FieldStoredCalcCache;

  /**
   * The metric expression used in the data diagnostic logic.
   */
  readonly metricExpression?: string;
  withMetricExpression(metricExpression: string | null): FieldStoredCalcCache;
  ...
  withOverrideSimpleMetrics(overrideSimpleMetrics: Array_Type<SimpleMetric> | Array<ISimpleMetric> | null): FieldStoredCalcCache;
  ...
  withOverrideCompoundMetrics(overrideCompoundMetrics: Array_Type<CompoundMetric> | Array<ICompoundMetric> | null): FieldStoredCalcCache;

  /**
   * The unit used in the metric evaluation of the diagnostic logic.
   */
  readonly unit?: Unit;
  withUnit(unit: IUnit | null): FieldStoredCalcCache;

  /**
   * Bindings to use with any metrics invoked by the metric expression.
   */
  readonly bindings?: Map_Type<string, any>;
  withBindings(bindings: Map_Type<string, any> | {[key: string]: any} | null): FieldStoredCalcCache;

  /**
   * The {@link EvalMetricsOptions} to use when running the evalMetrics call.
   */
  readonly options?: EvalMetricsOptions;
  withOptions(options: IEvalMetricsOptions | null): FieldStoredCalcCache;
  ...
  withRequiredBindings(requiredBindings: Array_Type<string> | Array<string> | null): FieldStoredCalcCache;

  /**
   * Field to override bindings for specific {@link #srcType} entities.
   */
  readonly entitySpecificBindings?: Map_Type<string, OverrideBindings>;
  withEntitySpecificBindings(entitySpecificBindings: Map_Type<string, OverrideBindings> | {[key: string]: IOverrideBindings} | null): FieldStoredCalcCache;
  ...
  withBatchConfig(batchConfig: IDataDiagnosticBatchConfig | null): FieldStoredCalcCache;

  /**
   * {@link Interval} used for the metric evaluation.
   */
  readonly interval?: string;
  withInterval(interval: string | null): FieldStoredCalcCache;

  /**
   * The {@link Period} of time the diagnostic runs the eval metric call on.
   */
  readonly period?: Period;
  withPeriod(period: IPeriod | null): FieldStoredCalcCache;

  /**
   * The timezone the used in the evaluation of the metric.
   */
  readonly timeZone?: string;
  withTimeZone(timeZone: string | null): FieldStoredCalcCache;

  /**
   * The cron job which will run this data diagnostic logic on a set schedule.
   */
  readonly cronJob?: CronJob;
  withCronJob(cronJob: ICronJob | null): FieldStoredCalcCache;

  /**
   * A filter used to retrieve entities of type `srcType` to run the data diagnostic logic on.
   */
  readonly filter: Filter;
  withFilter(filter: IFilter): FieldStoredCalcCache;

  /**
   * {@link DataDiagnostic#retrieveDiagnosticData} should only include the #calcField.
   */
  readonly fetchInclude?: string;
  withFetchInclude(fetchInclude: string | null): FieldStoredCalcCache;
  ...
  withExpression(expression: string | null): FieldStoredCalcCache;
  ...
  withReferentialIntegrityString(referentialIntegrityString: string | null): FieldStoredCalcCache;
  ...
  withEnabled(enabled: boolean): FieldStoredCalcCache;

  /**
   * Lambda function that can be used to override the existing logic on a type that extends {@link DataDiagnostic}.
   */
  readonly customDiagnosticLogic?: λConsumer<any | null>;
  withCustomDiagnosticLogic(customDiagnosticLogic: λConsumer<any | null> | null): FieldStoredCalcCache;

  /**
   * The field on #srcType to store the metric result.
   */
  readonly fieldName: string;
  withFieldName(fieldName: string): FieldStoredCalcCache;

  /**
   * The read `calc` field defined on #srcType to read from and store on #fieldName.
   */
  readonly calcField: string;
  withCalcField(calcField: string): FieldStoredCalcCache;
   ...
   * @see #toJson
   */
  static fromJson(json: any): FieldStoredCalcCache | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): FieldStoredCalcCache | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): FieldStoredCalcCache | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): FieldStoredCalcCache | null;
   ...
   */
  replaceType(old: Type, new_: Type): FieldStoredCalcCache;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): FieldStoredCalcCache;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): FieldStoredCalcCache;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<FieldStoredCalcCache>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<FieldStoredCalcCache>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): FieldStoredCalcCache;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): FieldStoredCalcCache;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): FieldStoredCalcCache;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): FieldStoredCalcCache;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): FieldStoredCalcCache;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): FieldStoredCalcCache;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): FieldStoredCalcCache;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): FieldStoredCalcCache;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): FieldStoredCalcCache;
   ...
   * @see #removeField
   */
  withoutField(field: string): FieldStoredCalcCache;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): FieldStoredCalcCache;
   ...
   */
  withoutFields(fields: Array_Type<string>): FieldStoredCalcCache;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): FieldStoredCalcCache;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): FieldStoredCalcCache;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): FieldStoredCalcCache;
   ...
   * @see #unsetField
   */
  defaultField(field: string): FieldStoredCalcCache;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): FieldStoredCalcCache;
   ...
   * @see #removeField
   */
  unsetField(field: string): FieldStoredCalcCache;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): FieldStoredCalcCache;
   ...
   * @see #unsetField
   */
  removeField(field: string): FieldStoredCalcCache;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): FieldStoredCalcCache;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): FieldStoredCalcCache;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): FieldStoredCalcCache;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): FieldStoredCalcCache;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): FieldStoredCalcCache;

  mergeJson(json: any): FieldStoredCalcCache;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): FieldStoredCalcCache;
   ...
   */
  sumObj(other: Obj, deep?: boolean): FieldStoredCalcCache;
   ...
   */
  singletonArray(): Array_Type<FieldStoredCalcCache>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<FieldStoredCalcCache> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<FieldStoredCalcCache> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<FieldStoredCalcCache>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<FieldStoredCalcCache> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, FieldStoredCalcCache> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, FieldStoredCalcCache> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<FieldStoredCalcCache>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<FieldStoredCalcCache>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): FieldStoredCalcCache;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): FieldStoredCalcCache;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): FieldStoredCalcCache;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): FieldStoredCalcCache;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): FieldStoredCalcCache;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): FieldStoredCalcCache;
   ...
   * @see #fromString
   */
  static make(s: string): FieldStoredCalcCache | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): FieldStoredCalcCache;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): FieldStoredCalcCache;
   ...
   */
  static cachedEmptyInst(): FieldStoredCalcCache;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<FieldStoredCalcCache> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): FieldStoredCalcCache;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<FieldStoredCalcCache>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<FieldStoredCalcCache>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<FieldStoredCalcCache> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<FieldStoredCalcCache>> | null;
   ...
   */
  get(include?: string): FieldStoredCalcCache | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): FieldStoredCalcCache | null;
   ...
   */
  getMissing(spec: GetMissingSpec): FieldStoredCalcCache;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): FieldStoredCalcCache | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): FieldStoredCalcCache;
   ...
   * @see #toString
   */
  static fromString(s: string): FieldStoredCalcCache | null;
   ...
   */
  create(spec?: UpsertSpec): FieldStoredCalcCache | null;
   ...
   */
  static createBatch(objs: Array_Type<FieldStoredCalcCache>, spec?: UpsertSpec): ObjList<FieldStoredCalcCache> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<FieldStoredCalcCache>, spec?: CreateBatchObjStreamSpec): ObjList<FieldStoredCalcCache> | null;
   ...
   */
  update(srcObj?: FieldStoredCalcCache, spec?: UpsertSpec): FieldStoredCalcCache | null;
   ...
   */
  upsert(srcObj?: FieldStoredCalcCache, spec?: UpsertSpec): FieldStoredCalcCache | null;
   ...
   */
  merge(spec?: MergeSpec): FieldStoredCalcCache | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): FieldStoredCalcCache | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): FieldStoredCalcCache | null;
   ...
   */
  static updateBatch(objs: Array_Type<FieldStoredCalcCache>, srcObjs?: Array_Type<FieldStoredCalcCache>, spec?: UpsertSpec): ObjList<FieldStoredCalcCache> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<FieldStoredCalcCache> | null>, spec?: UpsertSpec): ObjList<FieldStoredCalcCache> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<FieldStoredCalcCache>, srcObjs?: Array_Type<FieldStoredCalcCache>, spec?: UpsertSpec): ObjList<FieldStoredCalcCache> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<FieldStoredCalcCache> | null>, spec?: UpsertSpec): ObjList<FieldStoredCalcCache> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<FieldStoredCalcCache>, spec?: TouchSpec): ObjList<FieldStoredCalcCache> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<FieldStoredCalcCache>, spec?: MergeSpec): ObjList<FieldStoredCalcCache> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<FieldStoredCalcCache>, mergeInclude: string, spec?: MergeSpec): ObjList<FieldStoredCalcCache> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<FieldStoredCalcCache> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<FieldStoredCalcCache> | null;
   ...
   */
  static mergeAll(mergeObj: FieldStoredCalcCache, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: FieldStoredCalcCache, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<FieldStoredCalcCache>, spec?: UpsertSpec): ObjList<FieldStoredCalcCache> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<FieldStoredCalcCache>, spec?: UpsertSpec): ObjList<FieldStoredCalcCache> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): FieldStoredCalcCache | null;
   ...
   */
  static beforeCreate(objs: Array_Type<FieldStoredCalcCache>): ObjList<FieldStoredCalcCache>;
   ...
   * {@link DataDiagnostic#filter} are all valid.
   */
  static beforeUpdate(objs: Array_Type<FieldStoredCalcCache>): ObjList<FieldStoredCalcCache>;
   ...
   */
  static beforeRemove(objs: Array_Type<FieldStoredCalcCache>): ObjList<FieldStoredCalcCache>;
   ...
   */
  static afterCreate(objs: Array_Type<FieldStoredCalcCache>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<FieldStoredCalcCache>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<FieldStoredCalcCache>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<FieldStoredCalcCache>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<FieldStoredCalcCache>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): FieldStoredCalcCache | null;
   ...
   */
  withoutIdentity(): FieldStoredCalcCache | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<FieldStoredCalcCache>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: FieldStoredCalcCache, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<FieldStoredCalcCache>, callback?: λFunction<FieldStoredCalcCache | null, FieldStoredCalcCache | null>): ObjList<FieldStoredCalcCache>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<FieldStoredCalcCache>, callback?: λFunction<FieldStoredCalcCache | null, FieldStoredCalcCache | null>): Array_Type<ObjError> | null;
   ...
   */
  retrieveEvalMetricsDiagnosticData(filter?: Filter, dataVariables?: FieldStoredCalcCache, overrideDiagnosticSpec?: DataDiagnosticOverrideSpec = '{}'): EvalMetricsResult | null;
   ...
   */
  static processNewOrUpdatedDiagnostics(objs: Array_Type<FieldStoredCalcCache>): ObjList<FieldStoredCalcCache>;
  ...
  /**
   * Take a `fetchResult` with data for multiple entities and store the value of #calcField onto #fieldName.
   */
  storeFetchResult(fetchResult: FetchResult<any>): void;

  /**
   * Refresh cache #fieldName on the #srcType.
   * Returns the batch job created to perform this refresh.
   */
  refreshCacheFields(overrideFilterSpec?: DataDiagnosticFilterSpec): FieldStoredCalcCacheBatchJob;
}
