// TypeScript definitions for the C3 type FieldStoredMetricCacheTestDestination

/**
 * This type is used by the tests for {@link FieldStoredMetricCache}.
 * It is placed in the src folder since we need to use meta data of this type in the function.
 *
 * @remarks this represents a value passed to a method that expects an instance of FieldStoredMetricCacheTestDestination
 */
declare interface IFieldStoredMetricCacheTestDestination {
  ...
  /**
   * Average value of `metric1` over the past day.
   */
  metric1PastDay?: number;

  /**
   * Average value of `metric2` over the past day.
   */
  metric2PastDay?: number;

  /**
   * Average value of `metric3` over the past day.
   */
  metric3PastDay?: IDimension;
}
 ...
 * It is placed in the src folder since we need to use meta data of this type in the function.
 *
 * @remarks this represents a made instance of FieldStoredMetricCacheTestDestination
 */
declare class FieldStoredMetricCacheTestDestination extends Obj  {
   ...
   */
  readonly id: string;
  withId(id: string): FieldStoredMetricCacheTestDestination;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): FieldStoredMetricCacheTestDestination;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): FieldStoredMetricCacheTestDestination;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): FieldStoredMetricCacheTestDestination;
  ...
  withVersion(version: number | null): FieldStoredMetricCacheTestDestination;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): FieldStoredMetricCacheTestDestination;

  /**
   * Average value of `metric1` over the past day.
   */
  readonly metric1PastDay?: number;
  withMetric1PastDay(metric1PastDay: number | null): FieldStoredMetricCacheTestDestination;

  /**
   * Average value of `metric2` over the past day.
   */
  readonly metric2PastDay?: number;
  withMetric2PastDay(metric2PastDay: number | null): FieldStoredMetricCacheTestDestination;

  /**
   * Average value of `metric3` over the past day.
   */
  readonly metric3PastDay?: Dimension;
  withMetric3PastDay(metric3PastDay: IDimension | null): FieldStoredMetricCacheTestDestination;
   ...
   * @see #toJson
   */
  static fromJson(json: any): FieldStoredMetricCacheTestDestination | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): FieldStoredMetricCacheTestDestination | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): FieldStoredMetricCacheTestDestination | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): FieldStoredMetricCacheTestDestination | null;
   ...
   */
  replaceType(old: Type, new_: Type): FieldStoredMetricCacheTestDestination;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): FieldStoredMetricCacheTestDestination;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): FieldStoredMetricCacheTestDestination;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<FieldStoredMetricCacheTestDestination>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<FieldStoredMetricCacheTestDestination>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): FieldStoredMetricCacheTestDestination;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): FieldStoredMetricCacheTestDestination;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): FieldStoredMetricCacheTestDestination;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): FieldStoredMetricCacheTestDestination;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): FieldStoredMetricCacheTestDestination;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): FieldStoredMetricCacheTestDestination;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): FieldStoredMetricCacheTestDestination;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): FieldStoredMetricCacheTestDestination;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): FieldStoredMetricCacheTestDestination;
   ...
   * @see #removeField
   */
  withoutField(field: string): FieldStoredMetricCacheTestDestination;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): FieldStoredMetricCacheTestDestination;
   ...
   */
  withoutFields(fields: Array_Type<string>): FieldStoredMetricCacheTestDestination;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): FieldStoredMetricCacheTestDestination;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): FieldStoredMetricCacheTestDestination;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): FieldStoredMetricCacheTestDestination;
   ...
   * @see #unsetField
   */
  defaultField(field: string): FieldStoredMetricCacheTestDestination;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): FieldStoredMetricCacheTestDestination;
   ...
   * @see #removeField
   */
  unsetField(field: string): FieldStoredMetricCacheTestDestination;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): FieldStoredMetricCacheTestDestination;
   ...
   * @see #unsetField
   */
  removeField(field: string): FieldStoredMetricCacheTestDestination;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): FieldStoredMetricCacheTestDestination;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): FieldStoredMetricCacheTestDestination;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): FieldStoredMetricCacheTestDestination;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): FieldStoredMetricCacheTestDestination;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): FieldStoredMetricCacheTestDestination;

  mergeJson(json: any): FieldStoredMetricCacheTestDestination;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): FieldStoredMetricCacheTestDestination;
   ...
   */
  sumObj(other: Obj, deep?: boolean): FieldStoredMetricCacheTestDestination;
   ...
   */
  singletonArray(): Array_Type<FieldStoredMetricCacheTestDestination>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<FieldStoredMetricCacheTestDestination> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<FieldStoredMetricCacheTestDestination> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<FieldStoredMetricCacheTestDestination>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<FieldStoredMetricCacheTestDestination> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, FieldStoredMetricCacheTestDestination> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, FieldStoredMetricCacheTestDestination> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<FieldStoredMetricCacheTestDestination>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<FieldStoredMetricCacheTestDestination>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): FieldStoredMetricCacheTestDestination;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): FieldStoredMetricCacheTestDestination;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): FieldStoredMetricCacheTestDestination;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): FieldStoredMetricCacheTestDestination;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): FieldStoredMetricCacheTestDestination;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): FieldStoredMetricCacheTestDestination;
   ...
   * @see #fromString
   */
  static make(s: string): FieldStoredMetricCacheTestDestination | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): FieldStoredMetricCacheTestDestination;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): FieldStoredMetricCacheTestDestination;
   ...
   */
  static cachedEmptyInst(): FieldStoredMetricCacheTestDestination;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<FieldStoredMetricCacheTestDestination> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): FieldStoredMetricCacheTestDestination;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<FieldStoredMetricCacheTestDestination>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<FieldStoredMetricCacheTestDestination>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<FieldStoredMetricCacheTestDestination> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<FieldStoredMetricCacheTestDestination>> | null;
   ...
   */
  static evalFeatureSetBatch(batch: Array_Type<FieldStoredMetricCacheTestDestination>, featureSet: Feature.Set, spec?: EvalFeatureSpec): Data | null;
   ...
   * ```
   */
  static evalFeaturesBatch(batch: Array_Type<FieldStoredMetricCacheTestDestination>, features: Array_Type<string>, spec?: EvalFeaturesSpec): Data | null;
   ...
   */
  get(include?: string): FieldStoredMetricCacheTestDestination | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): FieldStoredMetricCacheTestDestination | null;
   ...
   */
  getMissing(spec: GetMissingSpec): FieldStoredMetricCacheTestDestination;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): FieldStoredMetricCacheTestDestination | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): FieldStoredMetricCacheTestDestination;
   ...
   * @see #toString
   */
  static fromString(s: string): FieldStoredMetricCacheTestDestination | null;
   ...
   */
  create(spec?: UpsertSpec): FieldStoredMetricCacheTestDestination | null;
   ...
   */
  static createBatch(objs: Array_Type<FieldStoredMetricCacheTestDestination>, spec?: UpsertSpec): ObjList<FieldStoredMetricCacheTestDestination> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<FieldStoredMetricCacheTestDestination>, spec?: CreateBatchObjStreamSpec): ObjList<FieldStoredMetricCacheTestDestination> | null;
   ...
   */
  update(srcObj?: FieldStoredMetricCacheTestDestination, spec?: UpsertSpec): FieldStoredMetricCacheTestDestination | null;
   ...
   */
  upsert(srcObj?: FieldStoredMetricCacheTestDestination, spec?: UpsertSpec): FieldStoredMetricCacheTestDestination | null;
   ...
   */
  merge(spec?: MergeSpec): FieldStoredMetricCacheTestDestination | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): FieldStoredMetricCacheTestDestination | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): FieldStoredMetricCacheTestDestination | null;
   ...
   */
  static updateBatch(objs: Array_Type<FieldStoredMetricCacheTestDestination>, srcObjs?: Array_Type<FieldStoredMetricCacheTestDestination>, spec?: UpsertSpec): ObjList<FieldStoredMetricCacheTestDestination> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<FieldStoredMetricCacheTestDestination> | null>, spec?: UpsertSpec): ObjList<FieldStoredMetricCacheTestDestination> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<FieldStoredMetricCacheTestDestination>, srcObjs?: Array_Type<FieldStoredMetricCacheTestDestination>, spec?: UpsertSpec): ObjList<FieldStoredMetricCacheTestDestination> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<FieldStoredMetricCacheTestDestination> | null>, spec?: UpsertSpec): ObjList<FieldStoredMetricCacheTestDestination> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<FieldStoredMetricCacheTestDestination>, spec?: TouchSpec): ObjList<FieldStoredMetricCacheTestDestination> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<FieldStoredMetricCacheTestDestination>, spec?: MergeSpec): ObjList<FieldStoredMetricCacheTestDestination> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<FieldStoredMetricCacheTestDestination>, mergeInclude: string, spec?: MergeSpec): ObjList<FieldStoredMetricCacheTestDestination> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<FieldStoredMetricCacheTestDestination> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<FieldStoredMetricCacheTestDestination> | null;
   ...
   */
  static mergeAll(mergeObj: FieldStoredMetricCacheTestDestination, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: FieldStoredMetricCacheTestDestination, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<FieldStoredMetricCacheTestDestination>, spec?: UpsertSpec): ObjList<FieldStoredMetricCacheTestDestination> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<FieldStoredMetricCacheTestDestination>, spec?: UpsertSpec): ObjList<FieldStoredMetricCacheTestDestination> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): FieldStoredMetricCacheTestDestination | null;
   ...
   */
  static beforeCreate(objs: Array_Type<FieldStoredMetricCacheTestDestination>): ObjList<FieldStoredMetricCacheTestDestination>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<FieldStoredMetricCacheTestDestination>): ObjList<FieldStoredMetricCacheTestDestination>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<FieldStoredMetricCacheTestDestination>): ObjList<FieldStoredMetricCacheTestDestination>;
   ...
   */
  static afterCreate(objs: Array_Type<FieldStoredMetricCacheTestDestination>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<FieldStoredMetricCacheTestDestination>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<FieldStoredMetricCacheTestDestination>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<FieldStoredMetricCacheTestDestination>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<FieldStoredMetricCacheTestDestination>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): FieldStoredMetricCacheTestDestination | null;
   ...
   */
  withoutIdentity(): FieldStoredMetricCacheTestDestination | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<FieldStoredMetricCacheTestDestination>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: FieldStoredMetricCacheTestDestination, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<FieldStoredMetricCacheTestDestination>, callback?: λFunction<FieldStoredMetricCacheTestDestination | null, FieldStoredMetricCacheTestDestination | null>): ObjList<FieldStoredMetricCacheTestDestination>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<FieldStoredMetricCacheTestDestination>, callback?: λFunction<FieldStoredMetricCacheTestDestination | null, FieldStoredMetricCacheTestDestination | null>): Array_Type<ObjError> | null;
