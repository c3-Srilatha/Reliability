// TypeScript definitions for the C3 type FieldStoredCalcCacheBatchJob

/**
 * Batch job to update a single or group of {@link FieldStoredCalcCache}(s).
 *
 * @remarks this represents a value passed to a method that expects an instance of FieldStoredCalcCacheBatchJob
 */
declare interface IFieldStoredCalcCacheBatchJob {
 ...
 */
declare class FieldStoredCalcCacheBatchJob extends Obj  {

  /**
   * current or last job execution for this instance
   */
  readonly run?: BatchJobRun;
  withRun(run: IBatchJobRun | null): FieldStoredCalcCacheBatchJob;

  /**
   * previous job executions for this instance
   */
  readonly runs?: Array_Type<BatchJobRun>;
  withRuns(runs: Array_Type<BatchJobRun> | Array<IBatchJobRun> | null): FieldStoredCalcCacheBatchJob;

  /**
   * FOR INTERNAL USE ONLY - Specify options in call to {@link start}.
   */
  readonly options?: Obj;
  withOptions(options: IObj | null): FieldStoredCalcCacheBatchJob;
  ...
  withOnCompleteCallback(onCompleteCallback: IJobBase.Callback | null): FieldStoredCalcCacheBatchJob;
  ...
  withPriority(priority: number | null): FieldStoredCalcCacheBatchJob;
  ...
  withDisabled(disabled: boolean): FieldStoredCalcCacheBatchJob;
  ...
  withMaxConcurrency(maxConcurrency: number | null): FieldStoredCalcCacheBatchJob;
  ...
  withMaxConcurrencyPerNode(maxConcurrencyPerNode: number | null): FieldStoredCalcCacheBatchJob;
  ...
  withRunAsUser(runAsUser: boolean): FieldStoredCalcCacheBatchJob;

  /**
   * Don't set this field in the BatchJob, set it in the BatchJobOptions when calling `start`
   */
  readonly nodePool?: string;
  withNodePool(nodePool: string | null): FieldStoredCalcCacheBatchJob;
  ...
  withSkipIfRunning(skipIfRunning: boolean): FieldStoredCalcCacheBatchJob;

  /**
   * Set to between 1 and 5 to enable auto recovery. See {@link invalidation-queues.c3doc Invalidation Queues} for detailed documentation.
   */
  readonly numAutoRecoveryAttempts?: number;
  withNumAutoRecoveryAttempts(numAutoRecoveryAttempts: number | null): FieldStoredCalcCacheBatchJob;
  ...
  withTypeIdent(typeIdent: string | null): FieldStoredCalcCacheBatchJob;
   ...
   */
  readonly id: string;
  withId(id: string): FieldStoredCalcCacheBatchJob;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): FieldStoredCalcCacheBatchJob;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): FieldStoredCalcCacheBatchJob;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): FieldStoredCalcCacheBatchJob;
  ...
  withVersion(version: number | null): FieldStoredCalcCacheBatchJob;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): FieldStoredCalcCacheBatchJob;
  ...
  withAbortOnError(abortOnError: boolean): FieldStoredCalcCacheBatchJob;
   ...
   * @see #toJson
   */
  static fromJson(json: any): FieldStoredCalcCacheBatchJob | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): FieldStoredCalcCacheBatchJob | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): FieldStoredCalcCacheBatchJob | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): FieldStoredCalcCacheBatchJob | null;
   ...
   */
  replaceType(old: Type, new_: Type): FieldStoredCalcCacheBatchJob;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): FieldStoredCalcCacheBatchJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): FieldStoredCalcCacheBatchJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<FieldStoredCalcCacheBatchJob>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<FieldStoredCalcCacheBatchJob>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): FieldStoredCalcCacheBatchJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): FieldStoredCalcCacheBatchJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): FieldStoredCalcCacheBatchJob;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): FieldStoredCalcCacheBatchJob;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): FieldStoredCalcCacheBatchJob;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): FieldStoredCalcCacheBatchJob;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): FieldStoredCalcCacheBatchJob;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): FieldStoredCalcCacheBatchJob;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): FieldStoredCalcCacheBatchJob;
   ...
   * @see #removeField
   */
  withoutField(field: string): FieldStoredCalcCacheBatchJob;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): FieldStoredCalcCacheBatchJob;
   ...
   */
  withoutFields(fields: Array_Type<string>): FieldStoredCalcCacheBatchJob;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): FieldStoredCalcCacheBatchJob;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): FieldStoredCalcCacheBatchJob;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): FieldStoredCalcCacheBatchJob;
   ...
   * @see #unsetField
   */
  defaultField(field: string): FieldStoredCalcCacheBatchJob;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): FieldStoredCalcCacheBatchJob;
   ...
   * @see #removeField
   */
  unsetField(field: string): FieldStoredCalcCacheBatchJob;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): FieldStoredCalcCacheBatchJob;
   ...
   * @see #unsetField
   */
  removeField(field: string): FieldStoredCalcCacheBatchJob;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): FieldStoredCalcCacheBatchJob;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): FieldStoredCalcCacheBatchJob;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): FieldStoredCalcCacheBatchJob;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): FieldStoredCalcCacheBatchJob;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): FieldStoredCalcCacheBatchJob;

  mergeJson(json: any): FieldStoredCalcCacheBatchJob;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): FieldStoredCalcCacheBatchJob;
   ...
   */
  sumObj(other: Obj, deep?: boolean): FieldStoredCalcCacheBatchJob;
   ...
   */
  singletonArray(): Array_Type<FieldStoredCalcCacheBatchJob>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<FieldStoredCalcCacheBatchJob> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<FieldStoredCalcCacheBatchJob> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<FieldStoredCalcCacheBatchJob>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<FieldStoredCalcCacheBatchJob> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, FieldStoredCalcCacheBatchJob> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, FieldStoredCalcCacheBatchJob> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<FieldStoredCalcCacheBatchJob>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<FieldStoredCalcCacheBatchJob>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): FieldStoredCalcCacheBatchJob;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): FieldStoredCalcCacheBatchJob;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): FieldStoredCalcCacheBatchJob;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): FieldStoredCalcCacheBatchJob;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): FieldStoredCalcCacheBatchJob;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): FieldStoredCalcCacheBatchJob;
   ...
   * @see #fromString
   */
  static make(s: string): FieldStoredCalcCacheBatchJob | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): FieldStoredCalcCacheBatchJob;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): FieldStoredCalcCacheBatchJob;
   ...
   */
  static cachedEmptyInst(): FieldStoredCalcCacheBatchJob;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<FieldStoredCalcCacheBatchJob> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): FieldStoredCalcCacheBatchJob;
   ...
   */
  start(options?: FieldStoredCalcCacheBatchJobOptions): BatchJobStatus | null;
   ...
   */
  cleanup(options?: FieldStoredCalcCacheBatchJobOptions): void;
  ...
  cancelJob(removeResults?: boolean, force?: boolean): JobBase<BatchJobRun, BatchJobStatus, FieldStoredCalcCacheBatchJobOptions> | null;

  failJob(run: JobRun<BatchJobStatusBase>): JobBase<BatchJobRun, BatchJobStatus, FieldStoredCalcCacheBatchJobOptions> | null;
  ...
  validateStart(options?: FieldStoredCalcCacheBatchJobOptions): void;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<FieldStoredCalcCacheBatchJob>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<FieldStoredCalcCacheBatchJob>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<FieldStoredCalcCacheBatchJob> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<FieldStoredCalcCacheBatchJob>> | null;
   ...
   */
  get(include?: string): FieldStoredCalcCacheBatchJob | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): FieldStoredCalcCacheBatchJob | null;
   ...
   */
  getMissing(spec: GetMissingSpec): FieldStoredCalcCacheBatchJob;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): FieldStoredCalcCacheBatchJob | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): FieldStoredCalcCacheBatchJob;
   ...
   * @see #toString
   */
  static fromString(s: string): FieldStoredCalcCacheBatchJob | null;
   ...
   */
  create(spec?: UpsertSpec): FieldStoredCalcCacheBatchJob | null;
   ...
   */
  static createBatch(objs: Array_Type<FieldStoredCalcCacheBatchJob>, spec?: UpsertSpec): ObjList<FieldStoredCalcCacheBatchJob> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<FieldStoredCalcCacheBatchJob>, spec?: CreateBatchObjStreamSpec): ObjList<FieldStoredCalcCacheBatchJob> | null;
   ...
   */
  update(srcObj?: FieldStoredCalcCacheBatchJob, spec?: UpsertSpec): FieldStoredCalcCacheBatchJob | null;
   ...
   */
  upsert(srcObj?: FieldStoredCalcCacheBatchJob, spec?: UpsertSpec): FieldStoredCalcCacheBatchJob | null;
   ...
   */
  merge(spec?: MergeSpec): FieldStoredCalcCacheBatchJob | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): FieldStoredCalcCacheBatchJob | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): FieldStoredCalcCacheBatchJob | null;
   ...
   */
  static updateBatch(objs: Array_Type<FieldStoredCalcCacheBatchJob>, srcObjs?: Array_Type<FieldStoredCalcCacheBatchJob>, spec?: UpsertSpec): ObjList<FieldStoredCalcCacheBatchJob> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<FieldStoredCalcCacheBatchJob> | null>, spec?: UpsertSpec): ObjList<FieldStoredCalcCacheBatchJob> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<FieldStoredCalcCacheBatchJob>, srcObjs?: Array_Type<FieldStoredCalcCacheBatchJob>, spec?: UpsertSpec): ObjList<FieldStoredCalcCacheBatchJob> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<FieldStoredCalcCacheBatchJob> | null>, spec?: UpsertSpec): ObjList<FieldStoredCalcCacheBatchJob> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<FieldStoredCalcCacheBatchJob>, spec?: TouchSpec): ObjList<FieldStoredCalcCacheBatchJob> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<FieldStoredCalcCacheBatchJob>, spec?: MergeSpec): ObjList<FieldStoredCalcCacheBatchJob> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<FieldStoredCalcCacheBatchJob>, mergeInclude: string, spec?: MergeSpec): ObjList<FieldStoredCalcCacheBatchJob> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<FieldStoredCalcCacheBatchJob> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<FieldStoredCalcCacheBatchJob> | null;
   ...
   */
  static mergeAll(mergeObj: FieldStoredCalcCacheBatchJob, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: FieldStoredCalcCacheBatchJob, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<FieldStoredCalcCacheBatchJob>, spec?: UpsertSpec): ObjList<FieldStoredCalcCacheBatchJob> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<FieldStoredCalcCacheBatchJob>, spec?: UpsertSpec): ObjList<FieldStoredCalcCacheBatchJob> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): FieldStoredCalcCacheBatchJob | null;
   ...
   */
  static beforeCreate(objs: Array_Type<FieldStoredCalcCacheBatchJob>): ObjList<FieldStoredCalcCacheBatchJob>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<FieldStoredCalcCacheBatchJob>): ObjList<FieldStoredCalcCacheBatchJob>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<FieldStoredCalcCacheBatchJob>): ObjList<FieldStoredCalcCacheBatchJob>;
   ...
   */
  static afterCreate(objs: Array_Type<FieldStoredCalcCacheBatchJob>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<FieldStoredCalcCacheBatchJob>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<FieldStoredCalcCacheBatchJob>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<FieldStoredCalcCacheBatchJob>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<FieldStoredCalcCacheBatchJob>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): FieldStoredCalcCacheBatchJob | null;
   ...
   */
  withoutIdentity(): FieldStoredCalcCacheBatchJob | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<FieldStoredCalcCacheBatchJob>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: FieldStoredCalcCacheBatchJob, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<FieldStoredCalcCacheBatchJob>, callback?: λFunction<FieldStoredCalcCacheBatchJob | null, FieldStoredCalcCacheBatchJob | null>): ObjList<FieldStoredCalcCacheBatchJob>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<FieldStoredCalcCacheBatchJob>, callback?: λFunction<FieldStoredCalcCacheBatchJob | null, FieldStoredCalcCacheBatchJob | null>): Array_Type<ObjError> | null;
   ...
   */
  static doStart(job?: FieldStoredCalcCacheBatchJob, options?: FieldStoredCalcCacheBatchJobOptions): void;
   ...
   */
  static processBatch(batch?: FieldStoredCalcCacheBatch, job?: FieldStoredCalcCacheBatchJob, options?: FieldStoredCalcCacheBatchJobOptions): void;
   ...
   */
  static allComplete(job: FieldStoredCalcCacheBatchJob, options?: FieldStoredCalcCacheBatchJobOptions): string | null;
   ...
   *           Options the job was run with.
   */
  static failed(job: FieldStoredCalcCacheBatchJob, status: BatchJobStatus, options?: FieldStoredCalcCacheBatchJobOptions): void;
   ...
   *        Batch to schedule.
   */
  scheduleBatch(batch?: FieldStoredCalcCacheBatch): void;
   ...
   *        Batches to schedule.
   */
  scheduleBatches(batches?: Array_Type<FieldStoredCalcCacheBatch>): void;
   ...
   */
  static scheduleObjBatch(job?: FieldStoredCalcCacheBatchJob, objBatch?: ObjBatch, logPrefix?: string): number | null;
   ...
   */
  static startJob(options?: FieldStoredCalcCacheBatchJobOptions): FieldStoredCalcCacheBatchJob;
}
