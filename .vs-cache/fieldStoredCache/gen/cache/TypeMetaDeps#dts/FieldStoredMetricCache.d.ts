// TypeScript definitions for the C3 type FieldStoredMetricCache

/**
 * A way to configure a {@link FieldStoredMetricCacheBatchJob} to cache metric evaluations directly on a type's field.
 *
 * @remarks this represents a value passed to a method that expects an instance of FieldStoredMetricCache
 */
declare interface IFieldStoredMetricCache {
 ...
 * A way to configure a {@link FieldStoredMetricCacheBatchJob} to cache metric evaluations directly on a type's field.
 *
 * @remarks this represents a made instance of FieldStoredMetricCache
 */
declare class FieldStoredMetricCache extends Obj  {
  ...
  withTypeIdent(typeIdent: string | null): FieldStoredMetricCache;
   ...
   */
  readonly id: string;
  withId(id: string): FieldStoredMetricCache;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): FieldStoredMetricCache;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): FieldStoredMetricCache;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): FieldStoredMetricCache;
  ...
  withVersion(version: number | null): FieldStoredMetricCache;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): FieldStoredMetricCache;

  /**
   * The entity type which this data diagnostic is running logic for.
   */
  readonly srcType: Type;
  withSrcType(srcType: IType): FieldStoredMetricCache;

  /**
   * High level description of what this data diagnostic is doing.
   */
  readonly description?: string;
  withDescription(description: string | null): FieldStoredMetricCache;
  ...
  withMetricExpression(metricExpression: string): FieldStoredMetricCache;
  ...
  withOverrideSimpleMetrics(overrideSimpleMetrics: Array_Type<SimpleMetric> | Array<ISimpleMetric> | null): FieldStoredMetricCache;
  ...
  withOverrideCompoundMetrics(overrideCompoundMetrics: Array_Type<CompoundMetric> | Array<ICompoundMetric> | null): FieldStoredMetricCache;

  /**
   * The unit used in the metric evaluation of the diagnostic logic.
   */
  readonly unit?: Unit;
  withUnit(unit: IUnit | null): FieldStoredMetricCache;

  /**
   * Bindings to use with any metrics invoked by the metric expression.
   */
  readonly bindings?: Map_Type<string, any>;
  withBindings(bindings: Map_Type<string, any> | {[key: string]: any} | null): FieldStoredMetricCache;

  /**
   * The {@link EvalMetricsOptions} to use when running the evalMetrics call.
   */
  readonly options?: EvalMetricsOptions;
  withOptions(options: IEvalMetricsOptions | null): FieldStoredMetricCache;
  ...
  withRequiredBindings(requiredBindings: Array_Type<string> | Array<string> | null): FieldStoredMetricCache;

  /**
   * Field to override bindings for specific {@link #srcType} entities.
   */
  readonly entitySpecificBindings?: Map_Type<string, OverrideBindings>;
  withEntitySpecificBindings(entitySpecificBindings: Map_Type<string, OverrideBindings> | {[key: string]: IOverrideBindings} | null): FieldStoredMetricCache;
  ...
  withBatchConfig(batchConfig: IDataDiagnosticBatchConfig | null): FieldStoredMetricCache;

  /**
   * {@link Interval} used for the metric evaluation.
   */
  readonly interval?: string;
  withInterval(interval: string | null): FieldStoredMetricCache;

  /**
   * The period and interval should be the same because only the last data point of metric result is saved to the field.
   */
  readonly period?: Period;
  withPeriod(period: IPeriod | null): FieldStoredMetricCache;

  /**
   * The timezone the used in the evaluation of the metric.
   */
  readonly timeZone?: string;
  withTimeZone(timeZone: string | null): FieldStoredMetricCache;

  /**
   * The cron job which will run this data diagnostic logic on a set schedule.
   */
  readonly cronJob?: CronJob;
  withCronJob(cronJob: ICronJob | null): FieldStoredMetricCache;

  /**
   * A filter used to retrieve entities of type `srcType` to run the data diagnostic logic on.
   */
  readonly filter: Filter;
  withFilter(filter: IFilter): FieldStoredMetricCache;

  /**
   * Include string to within the {@link FetchSpec} if the diagnostic is configured to perform a fetch.
   */
  readonly fetchInclude?: string;
  withFetchInclude(fetchInclude: string | null): FieldStoredMetricCache;
  ...
  withExpression(expression: string | null): FieldStoredMetricCache;
  ...
  withReferentialIntegrityString(referentialIntegrityString: string | null): FieldStoredMetricCache;
  ...
  withEnabled(enabled: boolean): FieldStoredMetricCache;

  /**
   * Lambda function that can be used to override the existing logic on a type that extends {@link DataDiagnostic}.
   */
  readonly customDiagnosticLogic?: λConsumer<any | null>;
  withCustomDiagnosticLogic(customDiagnosticLogic: λConsumer<any | null> | null): FieldStoredMetricCache;
  ...
  withFieldName(fieldName: string): FieldStoredMetricCache;

  /**
   * Whether this instance was generated because of an {@link Ann.MetricCache} annotation.
   */
  readonly generatedByAnnotation?: boolean;
  withGeneratedByAnnotation(generatedByAnnotation: boolean): FieldStoredMetricCache;
   ...
   * @see #toJson
   */
  static fromJson(json: any): FieldStoredMetricCache | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): FieldStoredMetricCache | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): FieldStoredMetricCache | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): FieldStoredMetricCache | null;
   ...
   */
  replaceType(old: Type, new_: Type): FieldStoredMetricCache;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): FieldStoredMetricCache;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): FieldStoredMetricCache;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<FieldStoredMetricCache>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<FieldStoredMetricCache>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): FieldStoredMetricCache;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): FieldStoredMetricCache;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): FieldStoredMetricCache;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): FieldStoredMetricCache;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): FieldStoredMetricCache;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): FieldStoredMetricCache;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): FieldStoredMetricCache;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): FieldStoredMetricCache;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): FieldStoredMetricCache;
   ...
   * @see #removeField
   */
  withoutField(field: string): FieldStoredMetricCache;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): FieldStoredMetricCache;
   ...
   */
  withoutFields(fields: Array_Type<string>): FieldStoredMetricCache;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): FieldStoredMetricCache;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): FieldStoredMetricCache;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): FieldStoredMetricCache;
   ...
   * @see #unsetField
   */
  defaultField(field: string): FieldStoredMetricCache;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): FieldStoredMetricCache;
   ...
   * @see #removeField
   */
  unsetField(field: string): FieldStoredMetricCache;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): FieldStoredMetricCache;
   ...
   * @see #unsetField
   */
  removeField(field: string): FieldStoredMetricCache;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): FieldStoredMetricCache;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): FieldStoredMetricCache;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): FieldStoredMetricCache;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): FieldStoredMetricCache;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): FieldStoredMetricCache;

  mergeJson(json: any): FieldStoredMetricCache;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): FieldStoredMetricCache;
   ...
   */
  sumObj(other: Obj, deep?: boolean): FieldStoredMetricCache;
   ...
   */
  singletonArray(): Array_Type<FieldStoredMetricCache>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<FieldStoredMetricCache> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<FieldStoredMetricCache> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<FieldStoredMetricCache>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<FieldStoredMetricCache> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, FieldStoredMetricCache> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, FieldStoredMetricCache> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<FieldStoredMetricCache>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<FieldStoredMetricCache>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): FieldStoredMetricCache;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): FieldStoredMetricCache;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): FieldStoredMetricCache;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): FieldStoredMetricCache;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): FieldStoredMetricCache;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): FieldStoredMetricCache;
   ...
   * @see #fromString
   */
  static make(s: string): FieldStoredMetricCache | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): FieldStoredMetricCache;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): FieldStoredMetricCache;
   ...
   */
  static cachedEmptyInst(): FieldStoredMetricCache;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<FieldStoredMetricCache> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): FieldStoredMetricCache;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<FieldStoredMetricCache>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<FieldStoredMetricCache>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<FieldStoredMetricCache> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<FieldStoredMetricCache>> | null;
   ...
   */
  get(include?: string): FieldStoredMetricCache | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): FieldStoredMetricCache | null;
   ...
   */
  getMissing(spec: GetMissingSpec): FieldStoredMetricCache;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): FieldStoredMetricCache | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): FieldStoredMetricCache;
   ...
   * @see #toString
   */
  static fromString(s: string): FieldStoredMetricCache | null;
   ...
   */
  create(spec?: UpsertSpec): FieldStoredMetricCache | null;
   ...
   */
  static createBatch(objs: Array_Type<FieldStoredMetricCache>, spec?: UpsertSpec): ObjList<FieldStoredMetricCache> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<FieldStoredMetricCache>, spec?: CreateBatchObjStreamSpec): ObjList<FieldStoredMetricCache> | null;
   ...
   */
  update(srcObj?: FieldStoredMetricCache, spec?: UpsertSpec): FieldStoredMetricCache | null;
   ...
   */
  upsert(srcObj?: FieldStoredMetricCache, spec?: UpsertSpec): FieldStoredMetricCache | null;
   ...
   */
  merge(spec?: MergeSpec): FieldStoredMetricCache | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): FieldStoredMetricCache | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): FieldStoredMetricCache | null;
   ...
   */
  static updateBatch(objs: Array_Type<FieldStoredMetricCache>, srcObjs?: Array_Type<FieldStoredMetricCache>, spec?: UpsertSpec): ObjList<FieldStoredMetricCache> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<FieldStoredMetricCache> | null>, spec?: UpsertSpec): ObjList<FieldStoredMetricCache> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<FieldStoredMetricCache>, srcObjs?: Array_Type<FieldStoredMetricCache>, spec?: UpsertSpec): ObjList<FieldStoredMetricCache> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<FieldStoredMetricCache> | null>, spec?: UpsertSpec): ObjList<FieldStoredMetricCache> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<FieldStoredMetricCache>, spec?: TouchSpec): ObjList<FieldStoredMetricCache> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<FieldStoredMetricCache>, spec?: MergeSpec): ObjList<FieldStoredMetricCache> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<FieldStoredMetricCache>, mergeInclude: string, spec?: MergeSpec): ObjList<FieldStoredMetricCache> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<FieldStoredMetricCache> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<FieldStoredMetricCache> | null;
   ...
   */
  static mergeAll(mergeObj: FieldStoredMetricCache, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: FieldStoredMetricCache, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<FieldStoredMetricCache>, spec?: UpsertSpec): ObjList<FieldStoredMetricCache> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<FieldStoredMetricCache>, spec?: UpsertSpec): ObjList<FieldStoredMetricCache> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): FieldStoredMetricCache | null;
   ...
   */
  static beforeCreate(objs: Array_Type<FieldStoredMetricCache>): ObjList<FieldStoredMetricCache>;
   ...
   * {@link DataDiagnostic#filter} are all valid.
   */
  static beforeUpdate(objs: Array_Type<FieldStoredMetricCache>): ObjList<FieldStoredMetricCache>;
   ...
   */
  static beforeRemove(objs: Array_Type<FieldStoredMetricCache>): ObjList<FieldStoredMetricCache>;
   ...
   */
  static afterCreate(objs: Array_Type<FieldStoredMetricCache>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<FieldStoredMetricCache>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<FieldStoredMetricCache>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<FieldStoredMetricCache>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<FieldStoredMetricCache>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): FieldStoredMetricCache | null;
   ...
   */
  withoutIdentity(): FieldStoredMetricCache | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<FieldStoredMetricCache>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: FieldStoredMetricCache, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<FieldStoredMetricCache>, callback?: λFunction<FieldStoredMetricCache | null, FieldStoredMetricCache | null>): ObjList<FieldStoredMetricCache>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<FieldStoredMetricCache>, callback?: λFunction<FieldStoredMetricCache | null, FieldStoredMetricCache | null>): Array_Type<ObjError> | null;
   ...
   */
  retrieveEvalMetricsDiagnosticData(filter?: Filter, dataVariables?: FieldStoredMetricCache, overrideDiagnosticSpec?: DataDiagnosticOverrideSpec = '{}'): EvalMetricsResult | null;
   ...
   */
  static processNewOrUpdatedDiagnostics(objs: Array_Type<FieldStoredMetricCache>): ObjList<FieldStoredMetricCache>;
   ...
   */
  storeMetricsResult(evalMetricsResult: EvalMetricsResult): void;

  /**
   * Refresh cache {@link #fieldName} on the {@link #srcType}.
   * Returns the batch job created to perform this refresh.
   */
  refreshCacheFields(overrideFilterSpec?: DataDiagnosticFilterSpec): FieldStoredMetricCacheBatchJob;

  /**
   * Get a list of all types and fieldNames pairs that contain the annotation {@link Ann.MetricCache}.
   */
  static getFscAnnotatedTypeFieldPairs(): Array_Type<TypeFieldAndAnnotationPayload> | null;
   ...
   */
  static generateSeedDataForAnnotations(payload?: Array_Type<TypeFieldAndAnnotationPayload>): Array_Type<Pair<FieldStoredMetricCache, CronJob>> | null;
   ...
   */
  static transformListOfPairsToPairOfLists(listOfPairs?: Array_Type<Pair<FieldStoredMetricCache, CronJob>>): Pair<Array_Type<FieldStoredMetricCache>, Array_Type<CronJob>> | null;
   ...
   */
  static generateSeedDataForAllAnnotations(): Pair<Array_Type<FieldStoredMetricCache>, Array_Type<CronJob>> | null;
}
