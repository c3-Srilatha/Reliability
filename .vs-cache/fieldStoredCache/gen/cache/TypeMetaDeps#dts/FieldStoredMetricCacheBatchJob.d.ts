// TypeScript definitions for the C3 type FieldStoredMetricCacheBatchJob
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of FieldStoredMetricCacheBatchJob
 */
declare interface IFieldStoredMetricCacheBatchJob {
 ...
 */
declare class FieldStoredMetricCacheBatchJob extends Obj  {

  /**
   * current or last job execution for this instance
   */
  readonly run?: BatchJobRun;
  withRun(run: IBatchJobRun | null): FieldStoredMetricCacheBatchJob;

  /**
   * previous job executions for this instance
   */
  readonly runs?: Array_Type<BatchJobRun>;
  withRuns(runs: Array_Type<BatchJobRun> | Array<IBatchJobRun> | null): FieldStoredMetricCacheBatchJob;

  /**
   * FOR INTERNAL USE ONLY - Specify options in call to {@link start}.
   */
  readonly options?: Obj;
  withOptions(options: IObj | null): FieldStoredMetricCacheBatchJob;
  ...
  withOnCompleteCallback(onCompleteCallback: IJobBase.Callback | null): FieldStoredMetricCacheBatchJob;
  ...
  withPriority(priority: number | null): FieldStoredMetricCacheBatchJob;
  ...
  withDisabled(disabled: boolean): FieldStoredMetricCacheBatchJob;
  ...
  withMaxConcurrency(maxConcurrency: number | null): FieldStoredMetricCacheBatchJob;
  ...
  withMaxConcurrencyPerNode(maxConcurrencyPerNode: number | null): FieldStoredMetricCacheBatchJob;
  ...
  withRunAsUser(runAsUser: boolean): FieldStoredMetricCacheBatchJob;

  /**
   * Don't set this field in the BatchJob, set it in the BatchJobOptions when calling `start`
   */
  readonly nodePool?: string;
  withNodePool(nodePool: string | null): FieldStoredMetricCacheBatchJob;
  ...
  withSkipIfRunning(skipIfRunning: boolean): FieldStoredMetricCacheBatchJob;

  /**
   * Set to between 1 and 5 to enable auto recovery. See {@link invalidation-queues.c3doc Invalidation Queues} for detailed documentation.
   */
  readonly numAutoRecoveryAttempts?: number;
  withNumAutoRecoveryAttempts(numAutoRecoveryAttempts: number | null): FieldStoredMetricCacheBatchJob;
  ...
  withTypeIdent(typeIdent: string | null): FieldStoredMetricCacheBatchJob;
   ...
   */
  readonly id: string;
  withId(id: string): FieldStoredMetricCacheBatchJob;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): FieldStoredMetricCacheBatchJob;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): FieldStoredMetricCacheBatchJob;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): FieldStoredMetricCacheBatchJob;
  ...
  withVersion(version: number | null): FieldStoredMetricCacheBatchJob;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): FieldStoredMetricCacheBatchJob;
  ...
  withAbortOnError(abortOnError: boolean): FieldStoredMetricCacheBatchJob;
   ...
   * @see #toJson
   */
  static fromJson(json: any): FieldStoredMetricCacheBatchJob | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): FieldStoredMetricCacheBatchJob | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): FieldStoredMetricCacheBatchJob | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): FieldStoredMetricCacheBatchJob | null;
   ...
   */
  replaceType(old: Type, new_: Type): FieldStoredMetricCacheBatchJob;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): FieldStoredMetricCacheBatchJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): FieldStoredMetricCacheBatchJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<FieldStoredMetricCacheBatchJob>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<FieldStoredMetricCacheBatchJob>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): FieldStoredMetricCacheBatchJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): FieldStoredMetricCacheBatchJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): FieldStoredMetricCacheBatchJob;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): FieldStoredMetricCacheBatchJob;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): FieldStoredMetricCacheBatchJob;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): FieldStoredMetricCacheBatchJob;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): FieldStoredMetricCacheBatchJob;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): FieldStoredMetricCacheBatchJob;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): FieldStoredMetricCacheBatchJob;
   ...
   * @see #removeField
   */
  withoutField(field: string): FieldStoredMetricCacheBatchJob;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): FieldStoredMetricCacheBatchJob;
   ...
   */
  withoutFields(fields: Array_Type<string>): FieldStoredMetricCacheBatchJob;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): FieldStoredMetricCacheBatchJob;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): FieldStoredMetricCacheBatchJob;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): FieldStoredMetricCacheBatchJob;
   ...
   * @see #unsetField
   */
  defaultField(field: string): FieldStoredMetricCacheBatchJob;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): FieldStoredMetricCacheBatchJob;
   ...
   * @see #removeField
   */
  unsetField(field: string): FieldStoredMetricCacheBatchJob;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): FieldStoredMetricCacheBatchJob;
   ...
   * @see #unsetField
   */
  removeField(field: string): FieldStoredMetricCacheBatchJob;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): FieldStoredMetricCacheBatchJob;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): FieldStoredMetricCacheBatchJob;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): FieldStoredMetricCacheBatchJob;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): FieldStoredMetricCacheBatchJob;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): FieldStoredMetricCacheBatchJob;

  mergeJson(json: any): FieldStoredMetricCacheBatchJob;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): FieldStoredMetricCacheBatchJob;
   ...
   */
  sumObj(other: Obj, deep?: boolean): FieldStoredMetricCacheBatchJob;
   ...
   */
  singletonArray(): Array_Type<FieldStoredMetricCacheBatchJob>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<FieldStoredMetricCacheBatchJob> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<FieldStoredMetricCacheBatchJob> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<FieldStoredMetricCacheBatchJob>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<FieldStoredMetricCacheBatchJob> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, FieldStoredMetricCacheBatchJob> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, FieldStoredMetricCacheBatchJob> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<FieldStoredMetricCacheBatchJob>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<FieldStoredMetricCacheBatchJob>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): FieldStoredMetricCacheBatchJob;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): FieldStoredMetricCacheBatchJob;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): FieldStoredMetricCacheBatchJob;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): FieldStoredMetricCacheBatchJob;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): FieldStoredMetricCacheBatchJob;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): FieldStoredMetricCacheBatchJob;
   ...
   * @see #fromString
   */
  static make(s: string): FieldStoredMetricCacheBatchJob | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): FieldStoredMetricCacheBatchJob;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): FieldStoredMetricCacheBatchJob;
   ...
   */
  static cachedEmptyInst(): FieldStoredMetricCacheBatchJob;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<FieldStoredMetricCacheBatchJob> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): FieldStoredMetricCacheBatchJob;
   ...
   */
  start(options?: FieldStoredMetricCacheBatchJobOptions): BatchJobStatus | null;
   ...
   */
  cleanup(options?: FieldStoredMetricCacheBatchJobOptions): void;
  ...
  cancelJob(removeResults?: boolean, force?: boolean): JobBase<BatchJobRun, BatchJobStatus, FieldStoredMetricCacheBatchJobOptions> | null;

  failJob(run: JobRun<BatchJobStatusBase>): JobBase<BatchJobRun, BatchJobStatus, FieldStoredMetricCacheBatchJobOptions> | null;
  ...
  validateStart(options?: FieldStoredMetricCacheBatchJobOptions): void;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<FieldStoredMetricCacheBatchJob>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<FieldStoredMetricCacheBatchJob>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<FieldStoredMetricCacheBatchJob> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<FieldStoredMetricCacheBatchJob>> | null;
   ...
   */
  get(include?: string): FieldStoredMetricCacheBatchJob | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): FieldStoredMetricCacheBatchJob | null;
   ...
   */
  getMissing(spec: GetMissingSpec): FieldStoredMetricCacheBatchJob;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): FieldStoredMetricCacheBatchJob | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): FieldStoredMetricCacheBatchJob;
   ...
   * @see #toString
   */
  static fromString(s: string): FieldStoredMetricCacheBatchJob | null;
   ...
   */
  create(spec?: UpsertSpec): FieldStoredMetricCacheBatchJob | null;
   ...
   */
  static createBatch(objs: Array_Type<FieldStoredMetricCacheBatchJob>, spec?: UpsertSpec): ObjList<FieldStoredMetricCacheBatchJob> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<FieldStoredMetricCacheBatchJob>, spec?: CreateBatchObjStreamSpec): ObjList<FieldStoredMetricCacheBatchJob> | null;
   ...
   */
  update(srcObj?: FieldStoredMetricCacheBatchJob, spec?: UpsertSpec): FieldStoredMetricCacheBatchJob | null;
   ...
   */
  upsert(srcObj?: FieldStoredMetricCacheBatchJob, spec?: UpsertSpec): FieldStoredMetricCacheBatchJob | null;
   ...
   */
  merge(spec?: MergeSpec): FieldStoredMetricCacheBatchJob | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): FieldStoredMetricCacheBatchJob | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): FieldStoredMetricCacheBatchJob | null;
   ...
   */
  static updateBatch(objs: Array_Type<FieldStoredMetricCacheBatchJob>, srcObjs?: Array_Type<FieldStoredMetricCacheBatchJob>, spec?: UpsertSpec): ObjList<FieldStoredMetricCacheBatchJob> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<FieldStoredMetricCacheBatchJob> | null>, spec?: UpsertSpec): ObjList<FieldStoredMetricCacheBatchJob> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<FieldStoredMetricCacheBatchJob>, srcObjs?: Array_Type<FieldStoredMetricCacheBatchJob>, spec?: UpsertSpec): ObjList<FieldStoredMetricCacheBatchJob> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<FieldStoredMetricCacheBatchJob> | null>, spec?: UpsertSpec): ObjList<FieldStoredMetricCacheBatchJob> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<FieldStoredMetricCacheBatchJob>, spec?: TouchSpec): ObjList<FieldStoredMetricCacheBatchJob> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<FieldStoredMetricCacheBatchJob>, spec?: MergeSpec): ObjList<FieldStoredMetricCacheBatchJob> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<FieldStoredMetricCacheBatchJob>, mergeInclude: string, spec?: MergeSpec): ObjList<FieldStoredMetricCacheBatchJob> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<FieldStoredMetricCacheBatchJob> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<FieldStoredMetricCacheBatchJob> | null;
   ...
   */
  static mergeAll(mergeObj: FieldStoredMetricCacheBatchJob, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: FieldStoredMetricCacheBatchJob, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<FieldStoredMetricCacheBatchJob>, spec?: UpsertSpec): ObjList<FieldStoredMetricCacheBatchJob> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<FieldStoredMetricCacheBatchJob>, spec?: UpsertSpec): ObjList<FieldStoredMetricCacheBatchJob> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): FieldStoredMetricCacheBatchJob | null;
   ...
   */
  static beforeCreate(objs: Array_Type<FieldStoredMetricCacheBatchJob>): ObjList<FieldStoredMetricCacheBatchJob>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<FieldStoredMetricCacheBatchJob>): ObjList<FieldStoredMetricCacheBatchJob>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<FieldStoredMetricCacheBatchJob>): ObjList<FieldStoredMetricCacheBatchJob>;
   ...
   */
  static afterCreate(objs: Array_Type<FieldStoredMetricCacheBatchJob>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<FieldStoredMetricCacheBatchJob>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<FieldStoredMetricCacheBatchJob>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<FieldStoredMetricCacheBatchJob>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<FieldStoredMetricCacheBatchJob>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): FieldStoredMetricCacheBatchJob | null;
   ...
   */
  withoutIdentity(): FieldStoredMetricCacheBatchJob | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<FieldStoredMetricCacheBatchJob>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: FieldStoredMetricCacheBatchJob, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<FieldStoredMetricCacheBatchJob>, callback?: λFunction<FieldStoredMetricCacheBatchJob | null, FieldStoredMetricCacheBatchJob | null>): ObjList<FieldStoredMetricCacheBatchJob>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<FieldStoredMetricCacheBatchJob>, callback?: λFunction<FieldStoredMetricCacheBatchJob | null, FieldStoredMetricCacheBatchJob | null>): Array_Type<ObjError> | null;
   ...
   */
  static doStart(job?: FieldStoredMetricCacheBatchJob, options?: FieldStoredMetricCacheBatchJobOptions): void;
   ...
   */
  static processBatch(batch?: FieldStoredMetricCacheBatch, job?: FieldStoredMetricCacheBatchJob, options?: FieldStoredMetricCacheBatchJobOptions): void;
   ...
   */
  static allComplete(job: FieldStoredMetricCacheBatchJob, options?: FieldStoredMetricCacheBatchJobOptions): string | null;
   ...
   *           Options the job was run with.
   */
  static failed(job: FieldStoredMetricCacheBatchJob, status: BatchJobStatus, options?: FieldStoredMetricCacheBatchJobOptions): void;
   ...
   *        Batch to schedule.
   */
  scheduleBatch(batch?: FieldStoredMetricCacheBatch): void;
   ...
   *        Batches to schedule.
   */
  scheduleBatches(batches?: Array_Type<FieldStoredMetricCacheBatch>): void;
   ...
   */
  static scheduleObjBatch(job?: FieldStoredMetricCacheBatchJob, objBatch?: ObjBatch, logPrefix?: string): number | null;
   ...
   */
  static startJob(options?: FieldStoredMetricCacheBatchJobOptions): FieldStoredMetricCacheBatchJob;
}
