// TypeScript definitions for the C3 type FieldStoredMetricCacheListenerTestRemoved

/**
 * Entity type `FieldStoredMetricCacheListenerTestRemoved` represents a schema named 'FSMC_TST_RMVD'.
 * It contains metric and non-metric fields. Metric fields use caching and are calculated based on
 * metric expressions with time intervals. Constraints can be applied to control when a metric field is
 * calculated.
 *
 * @remarks this represents a value passed to a method that expects an instance of FieldStoredMetricCacheListenerTestRemoved
 */
declare interface IFieldStoredMetricCacheListenerTestRemoved {
  ...
  /**
   * `nonMetricField`: A simple `double` field that does not use metric caching.
   * This is for storing non-metric data.
   */
  nonMetricField?: number;

  /**
   * `metricField1`: A metric field cached using the expression 'identity(3)' and updated daily ('DAY').
   */
  metricField1?: number;

  /**
   * `metricField2`: A metric field cached using the expression 'identity(4)' and updated daily ('DAY').
   * A constraint ensures that this field is only calculated when `metricField2 > 0`.
   */
  metricField2?: number;
}
 ...
 * calculated.
 *
 * @remarks this represents a made instance of FieldStoredMetricCacheListenerTestRemoved
 */
declare class FieldStoredMetricCacheListenerTestRemoved extends Obj  {
   ...
   */
  readonly id: string;
  withId(id: string): FieldStoredMetricCacheListenerTestRemoved;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): FieldStoredMetricCacheListenerTestRemoved;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): FieldStoredMetricCacheListenerTestRemoved;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): FieldStoredMetricCacheListenerTestRemoved;
  ...
  withVersion(version: number | null): FieldStoredMetricCacheListenerTestRemoved;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): FieldStoredMetricCacheListenerTestRemoved;
  ...
  withNonMetricField(nonMetricField: number | null): FieldStoredMetricCacheListenerTestRemoved;

  /**
   * `metricField1`: A metric field cached using the expression 'identity(3)' and updated daily ('DAY').
   */
  readonly metricField1?: number;
  withMetricField1(metricField1: number | null): FieldStoredMetricCacheListenerTestRemoved;
  ...
  withMetricField2(metricField2: number | null): FieldStoredMetricCacheListenerTestRemoved;
   ...
   * @see #toJson
   */
  static fromJson(json: any): FieldStoredMetricCacheListenerTestRemoved | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): FieldStoredMetricCacheListenerTestRemoved | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): FieldStoredMetricCacheListenerTestRemoved | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): FieldStoredMetricCacheListenerTestRemoved | null;
   ...
   */
  replaceType(old: Type, new_: Type): FieldStoredMetricCacheListenerTestRemoved;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): FieldStoredMetricCacheListenerTestRemoved;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): FieldStoredMetricCacheListenerTestRemoved;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<FieldStoredMetricCacheListenerTestRemoved>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<FieldStoredMetricCacheListenerTestRemoved>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): FieldStoredMetricCacheListenerTestRemoved;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): FieldStoredMetricCacheListenerTestRemoved;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): FieldStoredMetricCacheListenerTestRemoved;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): FieldStoredMetricCacheListenerTestRemoved;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): FieldStoredMetricCacheListenerTestRemoved;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): FieldStoredMetricCacheListenerTestRemoved;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): FieldStoredMetricCacheListenerTestRemoved;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): FieldStoredMetricCacheListenerTestRemoved;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): FieldStoredMetricCacheListenerTestRemoved;
   ...
   * @see #removeField
   */
  withoutField(field: string): FieldStoredMetricCacheListenerTestRemoved;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): FieldStoredMetricCacheListenerTestRemoved;
   ...
   */
  withoutFields(fields: Array_Type<string>): FieldStoredMetricCacheListenerTestRemoved;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): FieldStoredMetricCacheListenerTestRemoved;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): FieldStoredMetricCacheListenerTestRemoved;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): FieldStoredMetricCacheListenerTestRemoved;
   ...
   * @see #unsetField
   */
  defaultField(field: string): FieldStoredMetricCacheListenerTestRemoved;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): FieldStoredMetricCacheListenerTestRemoved;
   ...
   * @see #removeField
   */
  unsetField(field: string): FieldStoredMetricCacheListenerTestRemoved;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): FieldStoredMetricCacheListenerTestRemoved;
   ...
   * @see #unsetField
   */
  removeField(field: string): FieldStoredMetricCacheListenerTestRemoved;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): FieldStoredMetricCacheListenerTestRemoved;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): FieldStoredMetricCacheListenerTestRemoved;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): FieldStoredMetricCacheListenerTestRemoved;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): FieldStoredMetricCacheListenerTestRemoved;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): FieldStoredMetricCacheListenerTestRemoved;

  mergeJson(json: any): FieldStoredMetricCacheListenerTestRemoved;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): FieldStoredMetricCacheListenerTestRemoved;
   ...
   */
  sumObj(other: Obj, deep?: boolean): FieldStoredMetricCacheListenerTestRemoved;
   ...
   */
  singletonArray(): Array_Type<FieldStoredMetricCacheListenerTestRemoved>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<FieldStoredMetricCacheListenerTestRemoved> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<FieldStoredMetricCacheListenerTestRemoved> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<FieldStoredMetricCacheListenerTestRemoved>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<FieldStoredMetricCacheListenerTestRemoved> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, FieldStoredMetricCacheListenerTestRemoved> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, FieldStoredMetricCacheListenerTestRemoved> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<FieldStoredMetricCacheListenerTestRemoved>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<FieldStoredMetricCacheListenerTestRemoved>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): FieldStoredMetricCacheListenerTestRemoved;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): FieldStoredMetricCacheListenerTestRemoved;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): FieldStoredMetricCacheListenerTestRemoved;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): FieldStoredMetricCacheListenerTestRemoved;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): FieldStoredMetricCacheListenerTestRemoved;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): FieldStoredMetricCacheListenerTestRemoved;
   ...
   * @see #fromString
   */
  static make(s: string): FieldStoredMetricCacheListenerTestRemoved | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): FieldStoredMetricCacheListenerTestRemoved;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): FieldStoredMetricCacheListenerTestRemoved;
   ...
   */
  static cachedEmptyInst(): FieldStoredMetricCacheListenerTestRemoved;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<FieldStoredMetricCacheListenerTestRemoved> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): FieldStoredMetricCacheListenerTestRemoved;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<FieldStoredMetricCacheListenerTestRemoved>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<FieldStoredMetricCacheListenerTestRemoved>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<FieldStoredMetricCacheListenerTestRemoved> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<FieldStoredMetricCacheListenerTestRemoved>> | null;
   ...
   */
  get(include?: string): FieldStoredMetricCacheListenerTestRemoved | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): FieldStoredMetricCacheListenerTestRemoved | null;
   ...
   */
  getMissing(spec: GetMissingSpec): FieldStoredMetricCacheListenerTestRemoved;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): FieldStoredMetricCacheListenerTestRemoved | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): FieldStoredMetricCacheListenerTestRemoved;
   ...
   * @see #toString
   */
  static fromString(s: string): FieldStoredMetricCacheListenerTestRemoved | null;
   ...
   */
  create(spec?: UpsertSpec): FieldStoredMetricCacheListenerTestRemoved | null;
   ...
   */
  static createBatch(objs: Array_Type<FieldStoredMetricCacheListenerTestRemoved>, spec?: UpsertSpec): ObjList<FieldStoredMetricCacheListenerTestRemoved> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<FieldStoredMetricCacheListenerTestRemoved>, spec?: CreateBatchObjStreamSpec): ObjList<FieldStoredMetricCacheListenerTestRemoved> | null;
   ...
   */
  update(srcObj?: FieldStoredMetricCacheListenerTestRemoved, spec?: UpsertSpec): FieldStoredMetricCacheListenerTestRemoved | null;
   ...
   */
  upsert(srcObj?: FieldStoredMetricCacheListenerTestRemoved, spec?: UpsertSpec): FieldStoredMetricCacheListenerTestRemoved | null;
   ...
   */
  merge(spec?: MergeSpec): FieldStoredMetricCacheListenerTestRemoved | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): FieldStoredMetricCacheListenerTestRemoved | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): FieldStoredMetricCacheListenerTestRemoved | null;
   ...
   */
  static updateBatch(objs: Array_Type<FieldStoredMetricCacheListenerTestRemoved>, srcObjs?: Array_Type<FieldStoredMetricCacheListenerTestRemoved>, spec?: UpsertSpec): ObjList<FieldStoredMetricCacheListenerTestRemoved> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<FieldStoredMetricCacheListenerTestRemoved> | null>, spec?: UpsertSpec): ObjList<FieldStoredMetricCacheListenerTestRemoved> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<FieldStoredMetricCacheListenerTestRemoved>, srcObjs?: Array_Type<FieldStoredMetricCacheListenerTestRemoved>, spec?: UpsertSpec): ObjList<FieldStoredMetricCacheListenerTestRemoved> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<FieldStoredMetricCacheListenerTestRemoved> | null>, spec?: UpsertSpec): ObjList<FieldStoredMetricCacheListenerTestRemoved> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<FieldStoredMetricCacheListenerTestRemoved>, spec?: TouchSpec): ObjList<FieldStoredMetricCacheListenerTestRemoved> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<FieldStoredMetricCacheListenerTestRemoved>, spec?: MergeSpec): ObjList<FieldStoredMetricCacheListenerTestRemoved> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<FieldStoredMetricCacheListenerTestRemoved>, mergeInclude: string, spec?: MergeSpec): ObjList<FieldStoredMetricCacheListenerTestRemoved> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<FieldStoredMetricCacheListenerTestRemoved> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<FieldStoredMetricCacheListenerTestRemoved> | null;
   ...
   */
  static mergeAll(mergeObj: FieldStoredMetricCacheListenerTestRemoved, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: FieldStoredMetricCacheListenerTestRemoved, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<FieldStoredMetricCacheListenerTestRemoved>, spec?: UpsertSpec): ObjList<FieldStoredMetricCacheListenerTestRemoved> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<FieldStoredMetricCacheListenerTestRemoved>, spec?: UpsertSpec): ObjList<FieldStoredMetricCacheListenerTestRemoved> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): FieldStoredMetricCacheListenerTestRemoved | null;
   ...
   */
  static beforeCreate(objs: Array_Type<FieldStoredMetricCacheListenerTestRemoved>): ObjList<FieldStoredMetricCacheListenerTestRemoved>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<FieldStoredMetricCacheListenerTestRemoved>): ObjList<FieldStoredMetricCacheListenerTestRemoved>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<FieldStoredMetricCacheListenerTestRemoved>): ObjList<FieldStoredMetricCacheListenerTestRemoved>;
   ...
   */
  static afterCreate(objs: Array_Type<FieldStoredMetricCacheListenerTestRemoved>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<FieldStoredMetricCacheListenerTestRemoved>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<FieldStoredMetricCacheListenerTestRemoved>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<FieldStoredMetricCacheListenerTestRemoved>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<FieldStoredMetricCacheListenerTestRemoved>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): FieldStoredMetricCacheListenerTestRemoved | null;
   ...
   */
  withoutIdentity(): FieldStoredMetricCacheListenerTestRemoved | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<FieldStoredMetricCacheListenerTestRemoved>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: FieldStoredMetricCacheListenerTestRemoved, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<FieldStoredMetricCacheListenerTestRemoved>, callback?: λFunction<FieldStoredMetricCacheListenerTestRemoved | null, FieldStoredMetricCacheListenerTestRemoved | null>): ObjList<FieldStoredMetricCacheListenerTestRemoved>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<FieldStoredMetricCacheListenerTestRemoved>, callback?: λFunction<FieldStoredMetricCacheListenerTestRemoved | null, FieldStoredMetricCacheListenerTestRemoved | null>): Array_Type<ObjError> | null;
