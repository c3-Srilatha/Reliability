...
# Python definitions for the C3 type UiSdlDensityCategory


class UiSdlDensityCategory():
    """
    ...
    """
    def __init__(self, CLASSIC: Optional[str]=None, DENSE: Optional[str]=None) -> None: ...
