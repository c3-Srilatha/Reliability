...
# Python definitions for the C3 type UiSdlClassicDensity


class UiSdlClassicDensity(UiSdlDensityTemplate):
    """
    UiSdlClassicDensity type mixes UiSdlDensityTemplate and embeds the C3DefaultDensity theme values.
    Users can remix this type in their package and override/add variables.
    
    @remarks this represents a made instance of UiSdlClassicDensity
    """
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[UiSdlClassicDensity]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[UiSdlClassicDensity]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[UiSdlClassicDensity]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[UiSdlClassicDensity]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> UiSdlClassicDensity:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> UiSdlClassicDensity:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> UiSdlClassicDensity:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[UiSdlClassicDensity]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[UiSdlClassicDensity]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> UiSdlClassicDensity:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> UiSdlClassicDensity:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> UiSdlClassicDensity:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> UiSdlClassicDensity:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> UiSdlClassicDensity:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> UiSdlClassicDensity:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> UiSdlClassicDensity:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> UiSdlClassicDensity:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> UiSdlClassicDensity:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> UiSdlClassicDensity:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> UiSdlClassicDensity:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> UiSdlClassicDensity:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> UiSdlClassicDensity:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> UiSdlClassicDensity:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> UiSdlClassicDensity:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> UiSdlClassicDensity:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> UiSdlClassicDensity:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> UiSdlClassicDensity:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> UiSdlClassicDensity:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> UiSdlClassicDensity:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> UiSdlClassicDensity:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> UiSdlClassicDensity:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> UiSdlClassicDensity:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> UiSdlClassicDensity:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> UiSdlClassicDensity:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> UiSdlClassicDensity:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> UiSdlClassicDensity:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> UiSdlClassicDensity:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[UiSdlClassicDensity]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[UiSdlClassicDensity]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[UiSdlClassicDensity]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[UiSdlClassicDensity]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[UiSdlClassicDensity]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, UiSdlClassicDensity]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, UiSdlClassicDensity]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[UiSdlClassicDensity]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[UiSdlClassicDensity]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> UiSdlClassicDensity:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> UiSdlClassicDensity:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> UiSdlClassicDensity:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> UiSdlClassicDensity:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> UiSdlClassicDensity:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> UiSdlClassicDensity:
    """
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[UiSdlClassicDensity]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> UiSdlClassicDensity:
    """
    ...
    """
        ...
    def afterMake(self) -> UiSdlClassicDensity:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> UiSdlClassicDensity:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[UiSdlClassicDensity]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> UiSdlClassicDensity:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, spec: FetchSpec=None) -> FetchResult[UiSdlClassicDensity]:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, filter: Filter) -> FetchResult[UiSdlClassicDensity]:
    """
    ...
    """
        ...
    @classmethod
    def fetchObjStream(cls, spec: FetchStreamSpec=None) -> Union[Stream[UiSdlClassicDensity]]:
    """
    Fetches multiple obj instances based on a specification.  Only objs that the caller is authorized to fetch will be
    returned.
    ...
    """
        ...
    @classmethod
    def fetchMultiLocale(cls, spec: MultiLocaleFetchSpec=None) -> Union[Map[str, FetchResult[UiSdlClassicDensity]]]:
    """
    ...
    """
        ...
    def dependencies(self) -> MetadataDeps[UiSdlClassicDensity]:
    """
    Retrieves dependencies to types or other metadata elements for the given instance of metadata.
    """
        ...
    def save(self, subPath: str=None, contentType: str=None) -> UiSdlClassicDensity:
        ...
    ...
    def removeAll(cls, removeFilter: str=None) -> int:
        ...
    def update(self, srcObj: UiSdlClassicDensity=None, spec: UpsertSpec=None) -> Union[UiSdlClassicDensity]:
        ...
    def upsert(self, srcObj: UiSdlClassicDensity=None, spec: UpsertSpec=None) -> Union[UiSdlClassicDensity]:
        ...
    @classmethod
    ...
    """
        ...
    @classmethod
    def fromString(cls, s: str) -> Union[UiSdlClassicDensity]:
    """
    ...
    """
        ...
    @classmethod
    def forId(cls, id: str, failIfMissing: bool=None) -> Union[UiSdlClassicDensity]:
    """
