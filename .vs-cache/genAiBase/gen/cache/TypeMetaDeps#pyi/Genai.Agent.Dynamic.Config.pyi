...
from c3.genAiBase.Genai.Agent.Tool.FunctionCalling import Genai.Agent.Tool.FunctionCalling
...
from c3.platform.MapBuilder import MapBuilder
from c3.genAiBase.Genai.Agent.Dynamic.Toolkit import Genai.Agent.Dynamic.Toolkit
from c3.platform.ValidateObjResult import ValidateObjResult
from c3.genAiBase.Genai.Agent.Dynamic.OnStepCallbackSpec import Genai.Agent.Dynamic.OnStepCallbackSpec
...
from c3.genAiBase.Genai.Agent.Dynamic.ChatManagerSpec import Genai.Agent.Dynamic.ChatManagerSpec
from c3.genAiBase.Genai.Agent.Dynamic.CodeExecutionCallbackSpec import Genai.Agent.Dynamic.CodeExecutionCallbackSpec
...
# Python definitions for the C3 type Genai.Agent.Dynamic.Config


class Config(DefaultInstance, Named, Config, Genai.ParentConfig, Genai.Agent.Dynamic.ConfigParams, Genai.WithAllTools):
    """
    ...
    enableFollowUpSuggestions: Optional[bool]=None
    """
    This option is used to enable or disable the follow-up suggestions feature.
    """

    toolkit: Optional[Genai.Agent.Dynamic.Toolkit]=None
    """
    ...
    chatManagerSpec: Optional[Genai.Agent.Dynamic.ChatManagerSpec]
    """
    Spec containing the arguments that we want to pass to the agent's interal chat manager.
    """

    tagStepMap: Optional[Map[str, str]]=None
    """
    ...
    numFewShots: Optional[int]=None
    """
    The maximum number of few-shot examples to retrieve for prompt generation.
    """

    codeExecutionCallbacks: Optional[Genai.Agent.Dynamic.CodeExecutionCallbackSpec]=None
    """
    Manages the lifecycle of `PythonAgentCodeExecutor` callbacks for code execution workflows.
    """

    onStepCallbacksSpec: Optional[Genai.Agent.Dynamic.OnStepCallbackSpec]=None
    """
    ...
    imageFileFolderPath: Optional[str]=None
    """
    ...
    formatObjectForLLMKwargs: Optional[any]=None
    """
    ...
    sessionStoreInMemoryCacheParams: Optional[GenaiCore.SessionStore.InMemory.CacheParams]=None
    """
    The parameters for the in-memory session store cache.
    """

    objectReferenceCreator: Optional[Lambda[Callable[[Any, Union[Any], Union[any]], Any]]]=None
    """
    A {@link Lambda} that can be used to override the default object reference creation defined in object_reference.py.
    execution outputs.
    """

    uiDataCreator: Optional[any]=None
    """
    ...
    testAgentConfigName: Optional[str]=None
    """
    The name of the {@link Genai.Agent.Dynamic.Config} to use
    for {@link Genai.Agent.Dynamic.Persistable#queryFromTestCase}
    """
    def __init__(self, name: Optional[str]=None, configOverride: Optional[str]=None, secretOverride: Optional[str]=None, issues: Optional[Array[str]]=None, llmConfigName: Optional[str]=None, enableFollowUpSuggestions: Optional[bool]=None, toolkit: Optional[Genai.Agent.Dynamic.Toolkit]=None, maxSteps: Optional[int]=None, maxSeconds: Optional[int]=None, chatManagerSpec: Optional[Genai.Agent.Dynamic.ChatManagerSpec]=None, tagStepMap: Optional[Map[str, str]]=None, specialization: Optional[str]=None, numFewShots: Optional[int]=None, codeExecutionCallbacks: Optional[Genai.Agent.Dynamic.CodeExecutionCallbackSpec]=None, onStepCallbacksSpec: Optional[Genai.Agent.Dynamic.OnStepCallbackSpec]=None, inputVariablesPrompt: Optional[str]=None, rewriteConversationToSingleStepPrompt: Optional[str]=None, verbosity: Optional[int]=None, imageFileFolderPath: Optional[str]=None, formatObjectForLLMKwargs: Optional[any]=None, sessionStoreInMemoryCacheParams: Optional[GenaiCore.SessionStore.InMemory.CacheParams]=None, objectReferenceCreator: Optional[Lambda[Callable[[Any, Union[Any], Union[any]], Any]]]=None, uiDataCreator: Optional[any]=None, testAgentConfigName: Optional[str]=None) -> None: ...

    @classmethod
    def inst(cls) -> Genai.Agent.Dynamic.Config:
    """
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[Genai.Agent.Dynamic.Config]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[Genai.Agent.Dynamic.Config]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[Genai.Agent.Dynamic.Config]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[Genai.Agent.Dynamic.Config]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> Genai.Agent.Dynamic.Config:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> Genai.Agent.Dynamic.Config:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> Genai.Agent.Dynamic.Config:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[Genai.Agent.Dynamic.Config]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[Genai.Agent.Dynamic.Config]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> Genai.Agent.Dynamic.Config:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> Genai.Agent.Dynamic.Config:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> Genai.Agent.Dynamic.Config:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> Genai.Agent.Dynamic.Config:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> Genai.Agent.Dynamic.Config:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> Genai.Agent.Dynamic.Config:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> Genai.Agent.Dynamic.Config:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> Genai.Agent.Dynamic.Config:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> Genai.Agent.Dynamic.Config:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> Genai.Agent.Dynamic.Config:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> Genai.Agent.Dynamic.Config:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> Genai.Agent.Dynamic.Config:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> Genai.Agent.Dynamic.Config:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> Genai.Agent.Dynamic.Config:
    """
    @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> Genai.Agent.Dynamic.Config:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> Genai.Agent.Dynamic.Config:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> Genai.Agent.Dynamic.Config:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> Genai.Agent.Dynamic.Config:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> Genai.Agent.Dynamic.Config:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> Genai.Agent.Dynamic.Config:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> Genai.Agent.Dynamic.Config:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> Genai.Agent.Dynamic.Config:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> Genai.Agent.Dynamic.Config:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> Genai.Agent.Dynamic.Config:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> Genai.Agent.Dynamic.Config:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> Genai.Agent.Dynamic.Config:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> Genai.Agent.Dynamic.Config:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> Genai.Agent.Dynamic.Config:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[Genai.Agent.Dynamic.Config]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[Genai.Agent.Dynamic.Config]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[Genai.Agent.Dynamic.Config]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[Genai.Agent.Dynamic.Config]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[Genai.Agent.Dynamic.Config]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, Genai.Agent.Dynamic.Config]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, Genai.Agent.Dynamic.Config]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[Genai.Agent.Dynamic.Config]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[Genai.Agent.Dynamic.Config]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> Genai.Agent.Dynamic.Config:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> Genai.Agent.Dynamic.Config:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> Genai.Agent.Dynamic.Config:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> Genai.Agent.Dynamic.Config:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> Genai.Agent.Dynamic.Config:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> Genai.Agent.Dynamic.Config:
    """
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[Genai.Agent.Dynamic.Config]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> Genai.Agent.Dynamic.Config:
    """
    ...
    """
        ...
    def afterMake(self) -> Genai.Agent.Dynamic.Config:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> Genai.Agent.Dynamic.Config:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[Genai.Agent.Dynamic.Config]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> Genai.Agent.Dynamic.Config:
    """
    ...
    """
        ...
    @classmethod
    def fromString(cls, s: str) -> Union[Genai.Agent.Dynamic.Config]:
    """
    ...
    """
        ...
    @classmethod
    def forName(cls, name: str, failIfMissing: bool=None) -> Union[Genai.Agent.Dynamic.Config]:
    """
    ...
    """
        ...
    @classmethod
    def allCached(cls) -> Union[Stream[Genai.Agent.Dynamic.Config]]:
    """
    @return stream of all available Cached instances.
    """
        ...
    @classmethod
    def find(cls, filter: str=None) -> Union[Stream[Genai.Agent.Dynamic.Config]]:
    """
    ...
    """
        ...
    @classmethod
    def findBy(cls, field: str, value: Any) -> Union[Stream[Genai.Agent.Dynamic.Config]]:
    """
    @return existing instances of this type that satisfy filter from data cache. Will call `produceAll`
            if cache is empty or if Ann.cache.all is true & data has not previously been fetched.
            Otherwise no population will be performed.
    """
        ...
    def getCached(self) -> Union[Genai.Agent.Dynamic.Config]:
    """
    @return cached instance.
    """
        ...
    @classmethod
    def forCacheKey(cls, key: str) -> Union[Genai.Agent.Dynamic.Config]:
    """
    ...
    """
        ...
    @classmethod
    def produce(cls, key: str) -> Union[Genai.Agent.Dynamic.Config]:
    """
    Should produce an entry for the cache key. This method should not be called directly.
    """
        ...
    @classmethod
    def produceAll(cls) -> Union[Map[str, Genai.Agent.Dynamic.Config]]:
    """
    ...
    """
        ...
    def getConfig(self) -> Genai.Agent.Dynamic.Config:
    """
    ...
    """
        ...
    def getSecret(self) -> Genai.Agent.Dynamic.Config:
    """
    ...
    """
        ...
    def withConfigKey(self, configKey: str) -> Genai.Agent.Dynamic.Config:
    """
    ...
    """
        ...
    def withoutConfigKey(self) -> Genai.Agent.Dynamic.Config:
    """
    @return copy without config key.
    """
        ...
    @classmethod
    def forConfigKey(cls, configKey: str) -> Union[Genai.Agent.Dynamic.Config]:
    """
    ...
    """
        ...
    @classmethod
    def listConfigs(cls, parallel: bool=None, filter: Callable[[str], bool]=None) -> Union[Stream[Genai.Agent.Dynamic.Config]]:
    """
    @param
    ...
    """
        ...
    @overload
    def setConfigValues(self, from_: Genai.Agent.Dynamic.Config, override: str=None) -> None:
    """
    ...
    """
        ...
    @classmethod
    def loadConfigAndSecret(cls, configKey: str) -> Union[Genai.Agent.Dynamic.Config]:
    """
    ...
    """
        ...
    def removeSecrets(self) -> Union[Genai.Agent.Dynamic.Config]:
    """
    @return this config without any secret values.
    """
        ...
    def removeNonSecrets(self) -> Union[Genai.Agent.Dynamic.Config]:
    """
    @return this config with only secret values.
    """
        ...
    def validate(self) -> Genai.Agent.Dynamic.Config:
    """
    ...
    """
        ...
    @classmethod
    def setRecursive(cls, configJson: any, useSetConfigValues: bool=None, override: str=None) -> Genai.Agent.Dynamic.Config:
    """
    ...
    """
        ...
    def allTools(self) -> Array[Union[Genai.Agent.Tool[Any],Genai.Agent.Tool.FunctionCalling]]:
    """
    Abstract function for returning all the tools associated with this config
    """
        ...
    def getWhitelistedDataModels(self) -> Union[Array[any]]:
    """
    ...
    """
        ...
    def updateSystemPromptWithDataModel(self, dataModelGraph: Genai.StructuredData.DataModelGraph) -> None:
    """
