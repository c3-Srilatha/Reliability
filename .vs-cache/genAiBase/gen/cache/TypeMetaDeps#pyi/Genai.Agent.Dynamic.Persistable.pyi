...
from c3.genAiBase.Genai.Agent.Dynamic.TestSpec import Genai.Agent.Dynamic.TestSpec
...
from c3.genAiBase.Genai.Agent.Dynamic.Config import Genai.Agent.Dynamic.Config
...
from c3.platform.SetBuilder import SetBuilder
from c3.genAiBase.Genai.Agent.Persistable.SaveSpec import Genai.Agent.Persistable.SaveSpec
...
# Python definitions for the C3 type Genai.Agent.Dynamic.Persistable


class Persistable(Genai.Agent.Persistable[Genai.Agent.Dynamic.Config, Genai.Agent.Dynamic.InitializationSpec]):
    """
    Helper Type to configure agents in the context of a project. Provides methods to save
    and test specific configurations, as well as to toggle the agent's active state.
    
    @remarks this represents a made instance of Genai.Agent.Dynamic.Persistable
    """
    ...
    name: Optional[str]
    """
    User friendly name of the agent. It must be unique.
    """
    ...
    promptParamValues: Optional[Map[str, str]]=None
    """
    Set of prompt param values that will be injected in the agent's system prompt on initialization.
    These values can be extended, as long as the prompt used in the agent's config also references them.
    Currently, this is used for storing the "instructions" users can set from the UI for the agent.
    """

    config: Optional[Genai.Agent.Dynamic.Config]
    """
    ...
    """
    The agent's active state. If inactive, the agent will not be displayed in the tool selector in the UI.
    """
    ...
    """
    def __init__(self, projects: Optional[Array[Genai.Project]]=None, typeIdent: Optional[str]=None, id: Optional[str]=None, versionEdits: Optional[Array[VersionEdit]]=None, name: Optional[str]=None, meta: Optional[Meta]=None, version: Optional[int]=None, typeWithBindings: Optional[Type]=None, promptParamValues: Optional[Map[str, str]]=None, config: Optional[Genai.Agent.Dynamic.Config]=None, inactive: Optional[bool]=None, uiOptions: Optional[Genai.Agent.Tool.Config.UiOptions]=None) -> None: ...
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[Genai.Agent.Dynamic.Persistable]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[Genai.Agent.Dynamic.Persistable]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[Genai.Agent.Dynamic.Persistable]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[Genai.Agent.Dynamic.Persistable]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> Genai.Agent.Dynamic.Persistable:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> Genai.Agent.Dynamic.Persistable:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> Genai.Agent.Dynamic.Persistable:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[Genai.Agent.Dynamic.Persistable]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[Genai.Agent.Dynamic.Persistable]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> Genai.Agent.Dynamic.Persistable:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> Genai.Agent.Dynamic.Persistable:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> Genai.Agent.Dynamic.Persistable:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> Genai.Agent.Dynamic.Persistable:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> Genai.Agent.Dynamic.Persistable:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> Genai.Agent.Dynamic.Persistable:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> Genai.Agent.Dynamic.Persistable:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> Genai.Agent.Dynamic.Persistable:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> Genai.Agent.Dynamic.Persistable:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> Genai.Agent.Dynamic.Persistable:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> Genai.Agent.Dynamic.Persistable:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> Genai.Agent.Dynamic.Persistable:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> Genai.Agent.Dynamic.Persistable:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> Genai.Agent.Dynamic.Persistable:
    """
    @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> Genai.Agent.Dynamic.Persistable:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> Genai.Agent.Dynamic.Persistable:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> Genai.Agent.Dynamic.Persistable:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> Genai.Agent.Dynamic.Persistable:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> Genai.Agent.Dynamic.Persistable:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> Genai.Agent.Dynamic.Persistable:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> Genai.Agent.Dynamic.Persistable:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> Genai.Agent.Dynamic.Persistable:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> Genai.Agent.Dynamic.Persistable:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> Genai.Agent.Dynamic.Persistable:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> Genai.Agent.Dynamic.Persistable:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> Genai.Agent.Dynamic.Persistable:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> Genai.Agent.Dynamic.Persistable:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> Genai.Agent.Dynamic.Persistable:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[Genai.Agent.Dynamic.Persistable]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[Genai.Agent.Dynamic.Persistable]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[Genai.Agent.Dynamic.Persistable]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[Genai.Agent.Dynamic.Persistable]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[Genai.Agent.Dynamic.Persistable]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, Genai.Agent.Dynamic.Persistable]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, Genai.Agent.Dynamic.Persistable]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[Genai.Agent.Dynamic.Persistable]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[Genai.Agent.Dynamic.Persistable]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> Genai.Agent.Dynamic.Persistable:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> Genai.Agent.Dynamic.Persistable:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> Genai.Agent.Dynamic.Persistable:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> Genai.Agent.Dynamic.Persistable:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> Genai.Agent.Dynamic.Persistable:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> Genai.Agent.Dynamic.Persistable:
    """
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[Genai.Agent.Dynamic.Persistable]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> Genai.Agent.Dynamic.Persistable:
    """
    ...
    """
        ...
    def afterMake(self) -> Genai.Agent.Dynamic.Persistable:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> Genai.Agent.Dynamic.Persistable:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[Genai.Agent.Dynamic.Persistable]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> Genai.Agent.Dynamic.Persistable:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, spec: FetchSpec=None) -> FetchResult[Genai.Agent.Dynamic.Persistable]:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, filter: Filter) -> FetchResult[Genai.Agent.Dynamic.Persistable]:
    """
    ...
    """
        ...
    @classmethod
    def fetchObjStream(cls, spec: FetchStreamSpec=None) -> Union[Stream[Genai.Agent.Dynamic.Persistable]]:
    """
    Fetches multiple obj instances based on a specification.  Only objs that the caller is authorized to fetch will be
    returned.
    ...
    """
        ...
    @classmethod
    def fetchMultiLocale(cls, spec: MultiLocaleFetchSpec=None) -> Union[Map[str, FetchResult[Genai.Agent.Dynamic.Persistable]]]:
    """
    ...
    """
        ...
    def get(self, include: str=None) -> Union[Genai.Agent.Dynamic.Persistable]:
    """
    ...
    """
        ...
    def getSpecific(self, include: str=None) -> Union[Genai.Agent.Dynamic.Persistable]:
    """
    ...
    """
        ...
    def getMissing(self, spec: GetMissingSpec) -> Genai.Agent.Dynamic.Persistable:
    """
    ...
    """
        ...
    def getDirect(self, include: str=None) -> Union[Genai.Agent.Dynamic.Persistable]:
    """
    ...
    """
        ...
    def applyReverseEdit(self, versionEdit: VersionEdit) -> Genai.Agent.Dynamic.Persistable:
    """
    ...
    """
        ...
    @classmethod
    def fromString(cls, s: str) -> Union[Genai.Agent.Dynamic.Persistable]:
    """
    ...
    """
        ...
    def create(self, spec: UpsertSpec=None) -> Union[Genai.Agent.Dynamic.Persistable]:
    """
    ...
    """
        ...
    @classmethod
    def createBatch(cls, objs: Array[Genai.Agent.Dynamic.Persistable], spec: UpsertSpec=None) -> Union[ObjList[Genai.Agent.Dynamic.Persistable]]:
    """
    ...
    """
        ...
    @classmethod
    def createBatchObjStream(cls, objs: Stream[Genai.Agent.Dynamic.Persistable], spec: CreateBatchObjStreamSpec=None) -> Union[ObjList[Genai.Agent.Dynamic.Persistable]]:
    """
    Creates multiple instances of a C3 type. If the operation fails and {@link UpsertSpec#dontThrowOnBatchError} is not
    specified (the default), then a C3BatchException will be thrown.  Otherwise {@link errors will be reported in the
    returned {@link ObjList}.  This will fail if any of the instances already exist.
    ...
    """
        ...
    def update(self, srcObj: Genai.Agent.Dynamic.Persistable=None, spec: UpsertSpec=None) -> Union[Genai.Agent.Dynamic.Persistable]:
    """
    ...
    """
        ...
    def upsert(self, srcObj: Genai.Agent.Dynamic.Persistable=None, spec: UpsertSpec=None) -> Union[Genai.Agent.Dynamic.Persistable]:
    """
    ...
    """
        ...
    @overload
    def merge(self, spec: MergeSpec=None) -> Union[Genai.Agent.Dynamic.Persistable]:
    """
    ...
    """
        ...
    @overload
    def merge(self, mergeInclude: str, spec: MergeSpec=None) -> Union[Genai.Agent.Dynamic.Persistable]:
    """
    ...
    """
        ...
    def touch(self, spec: TouchSpec=None) -> Union[Genai.Agent.Dynamic.Persistable]:
    """
    ...
    """
        ...
    @classmethod
    def updateBatch(cls, objs: Array[Genai.Agent.Dynamic.Persistable], srcObjs: Array[Genai.Agent.Dynamic.Persistable]=None, spec: UpsertSpec=None) -> Union[ObjList[Genai.Agent.Dynamic.Persistable]]:
    """
    ...
    """
        ...
    @classmethod
    def updateObjs(cls, objs: Callable[[], Union[Array[Genai.Agent.Dynamic.Persistable]]], spec: UpsertSpec=None) -> Union[ObjList[Genai.Agent.Dynamic.Persistable]]:
    """
    ...
    """
        ...
    @classmethod
    def upsertBatch(cls, objs: Array[Genai.Agent.Dynamic.Persistable], srcObjs: Array[Genai.Agent.Dynamic.Persistable]=None, spec: UpsertSpec=None) -> Union[ObjList[Genai.Agent.Dynamic.Persistable]]:
    """
    ...
    """
        ...
    @classmethod
    def upsertObjs(cls, objs: Callable[[], Union[Array[Genai.Agent.Dynamic.Persistable]]], spec: UpsertSpec=None) -> Union[ObjList[Genai.Agent.Dynamic.Persistable]]:
    """
    Creates instances of a C3 type if they don't already exist and updates them if they do exist. If the operation
    ...
    """
        ...
    @classmethod
    def touchBatch(cls, objs: Array[Genai.Agent.Dynamic.Persistable], spec: TouchSpec=None) -> Union[ObjList[Genai.Agent.Dynamic.Persistable]]:
    """
    ...
    @overload
    @classmethod
    def mergeBatch(cls, objs: Array[Genai.Agent.Dynamic.Persistable], spec: MergeSpec=None) -> Union[ObjList[Genai.Agent.Dynamic.Persistable]]:
    """
    ...
    @overload
    @classmethod
    def mergeBatch(cls, objs: Array[Genai.Agent.Dynamic.Persistable], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[Genai.Agent.Dynamic.Persistable]]:
    """
    Merges multiple instances of a C3 type or creates them if they don't exist. If the operation fails and {@link
    UpsertSpec#dontThrowOnBatchError} is not specified (the default), then a C3BatchException will be thrown.
    Otherwise errors will be reported in the returned {@link ObjList}.  The merge operation is described in the {@link
    ...
    """
        ...
    @classmethod
    def mergeObjs(cls, objs: Callable[[], Union[Array[Genai.Agent.Dynamic.Persistable]]], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[Genai.Agent.Dynamic.Persistable]]:
    """
    ...
    @overload
    @classmethod
    def mergeAll(cls, mergeObj: Genai.Agent.Dynamic.Persistable, spec: MergeAllSpec=None) -> Union[int]:
    """
    ...
    @overload
    @classmethod
    def mergeAll(cls, mergeObj: Genai.Agent.Dynamic.Persistable, mergeInclude: str, spec: MergeAllSpec=None) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def removeBatch(cls, objs: Array[Genai.Agent.Dynamic.Persistable], spec: UpsertSpec=None) -> Union[ObjList[Genai.Agent.Dynamic.Persistable]]:
    """
    ...
    """
        ...
    @classmethod
    def replace(cls, objs: Array[Genai.Agent.Dynamic.Persistable], spec: UpsertSpec=None) -> Union[ObjList[Genai.Agent.Dynamic.Persistable]]:
    """
    ...
    """
        ...
    def unremove(self) -> Union[Genai.Agent.Dynamic.Persistable]:
    """
    ...
    """
        ...
    @classmethod
    def beforeCreate(cls, objs: Array[Genai.Agent.Dynamic.Persistable]) -> ObjList[Genai.Agent.Dynamic.Persistable]:
    """
    ...
    """
        ...
    @classmethod
    def beforeUpdate(cls, objs: Array[Genai.Agent.Dynamic.Persistable]) -> ObjList[Genai.Agent.Dynamic.Persistable]:
    """
    ...
    """
        ...
    @classmethod
    def beforeRemove(cls, objs: Array[Genai.Agent.Dynamic.Persistable]) -> ObjList[Genai.Agent.Dynamic.Persistable]:
    """
    ...
    """
        ...
    @classmethod
    def afterCreate(cls, objs: Array[Genai.Agent.Dynamic.Persistable]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def afterUpdate(cls, objs: Array[Genai.Agent.Dynamic.Persistable]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def afterRemove(cls, objs: Array[Genai.Agent.Dynamic.Persistable]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def startImportData(cls, spec: StartImportDataSpec=None) -> PushStream[Genai.Agent.Dynamic.Persistable]:
    """
    @return a push stream to import instances of this type.
    """
        ...
    @classmethod
    def startImportDataWithStats(cls, spec: StartImportDataSpec=None) -> PushStreamWithStats[Genai.Agent.Dynamic.Persistable]:
    """
    @return a push stream to import instances of this type.
    """
        ...
    ...
    """
        ...
    @classmethod
    def forId(cls, id: str, failIfMissing: bool=None) -> Union[Genai.Agent.Dynamic.Persistable]:
    """
    ...
    """
        ...
    def withoutIdentity(self) -> Union[Genai.Agent.Dynamic.Persistable]:
    """
    ...
    """
        ...
    @classmethod
    def typeOfBatch(cls, objs: Array[Genai.Agent.Dynamic.Persistable]) -> Union[Array[EntityType]]:
    """
    ...
    """
        ...
    @classmethod
    def dbEcho(cls, template: Genai.Agent.Dynamic.Persistable=None, count: int=None, sendBack: bool=None) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def callbackLogic(cls, objs: Array[Genai.Agent.Dynamic.Persistable], callback: Callable[[Union[Genai.Agent.Dynamic.Persistable]], Union[Genai.Agent.Dynamic.Persistable]]=None) -> ObjList[Genai.Agent.Dynamic.Persistable]:
    """
    ...
    """
        ...
    @classmethod
    def afterCallbackLogic(cls, objs: Array[Genai.Agent.Dynamic.Persistable], callback: Callable[[Union[Genai.Agent.Dynamic.Persistable]], Union[Genai.Agent.Dynamic.Persistable]]=None) -> Union[Array[ObjError]]:
    """
    ...
    """
    Initializes the agent, loading the configuration and setting it up.
    @param forceReload
              If true, all configs and setup will be re-run (instead of reusing already-loaded values)
    @return The native python globals set during initialization.
    """
        ...
    def setActiveOrInactive(self, active: bool) -> None:
    """
    Helper method to toggle the agent's active state.
    """
        ...
    @classmethod
    def save(cls, spec: Genai.Agent.Persistable.SaveSpec[Genai.Agent.Dynamic.InitializationSpec]) -> Genai.Agent.Persistable[Any, Any]:
    """
    Saves a configuration for the agent.
    @param spec The save spec that should be saved for the agent.
    
    @return The saved agent.
    """
        ...
    @classmethod
    def fetchFormData(cls, id: str=None) -> Genai.Agent.Persistable[Any, Any]:
    """
    Returns the {@link Genai.Agent.Dynamic.Config} for the agent.
    @param id
             The ID of the agent whose configuration should be fetched.
    @return The agent's configuration.
    """
        ...
    @classmethod
    def getTools(cls, id: str=None) -> any:
    """
    Returns the Tools for the agent.
    @param id
             The ID of the agent whose tools should be fetched.
    @return An array of Genai.Agent.Tool.Config.
    """
        ...
    def queryFromTestCase(self, spec: Genai.Agent.Dynamic.TestSpec, inProgressQueryResult: Genai.Query.Result) -> Genai.Query.Result:
    """
    Answers a user query using a specific agent configuration. It does not require the configuration to be saved,
    and is useful for testing purposes.
    @param spec
              The initialization spec that should be used to answer the query.
    @param inProgressQueryResult
              The in-progress query result that should be used to answer the query.
    
    @return The query result.
    """
        ...
    def engine(self) -> Genai.Agent.Dynamic.Persistable.Engine:
    """
    Convenience function to get the {@link Genai.Agent.Dynamic.Persistable.Engine}.
    @return the engine
    """
        ...
    def terminateEngine(self) -> None:
    """
    Convenience function to call {@link Genai.Agent.Dynamic.Persistable.Engine#terminate}.
    """
        ...
    @classmethod
    ...
    """
    Convenience function to call {@link Genai.Agent.Dynamic.Persistable.Engine#terminate}
    on all running {@link Genai.Agent.Dynamic.Persistable.Engine}s.
    """
        ...
    
    class Engine(Engine[Genai.Agent.Dynamic.Persistable.Engine.Deployment, Engine.DeploySpec]):
        """
        Engine for persisted agents. Allows running tests and saving configurations.
        
        @remarks this represents a made instance of Genai.Agent.Dynamic.Persistable.Engine
        """
        ...
        """
            ...
        @classmethod
        def fromJson(cls, json: any) -> Union[Genai.Agent.Dynamic.Persistable.Engine]:
        """
        Load the JSON-based representation and reconstruct the corresponding object.
        ...
        """
            ...
        @classmethod
        def fromJsonString(cls, json: str) -> Union[Genai.Agent.Dynamic.Persistable.Engine]:
        """
        Load the JSON-based representation and reconstruct the corresponding object.
        ...
        """
            ...
        @classmethod
        def fromXmlString(cls, xml: str) -> Union[Genai.Agent.Dynamic.Persistable.Engine]:
        """
        Load the XML-based representation and reconstruct the corresponding object.
        ...
        """
            ...
        @classmethod
        def deserialize(cls, contentStr: str, contentType: str) -> Union[Genai.Agent.Dynamic.Persistable.Engine]:
        """
        Load from contentType representation and reconstruct the corresponding object.
        ...
        """
            ...
        def replaceType(self, old: Type, new: Type) -> Genai.Agent.Dynamic.Persistable.Engine:
        """
        Returns new instance with all references to old type, including result of #type, replaced with new type. If new
        type does not contain fields from old or field value types are not convertable then drops the field.
        ...
        """
            ...
        @overload
        def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> Genai.Agent.Dynamic.Persistable.Engine:
        """
        Result of this function call is a copy of current instance with all non empty fields replaced based on results of
        the `mapper` invocation.
        ...
        """
            ...
        @overload
        def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> Genai.Agent.Dynamic.Persistable.Engine:
        """
        Result of this function call is a copy of current instance with all fields replaced based on results of the
        `mapper` invocation.
        ...
        """
            ...
        @overload
        def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[Genai.Agent.Dynamic.Persistable.Engine]:
        """
        Result of this function call is a copy of current instance with all non empty fields replaced based on results of
        the asynchronous `mapper` invocation.
        ...
        """
            ...
        @overload
        def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[Genai.Agent.Dynamic.Persistable.Engine]:
        """
        Result of this function call is a copy of current instance with all fields replaced based on results of the
        asynchronous `mapper` invocation.
        ...
        """
            ...
        def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> Genai.Agent.Dynamic.Persistable.Engine:
        """
        Result of this function call is a copy of current instance with specified field value replaced based on result of
        the `mapper` invocation.
        @param field
        ...
        """
            ...
        @overload
        def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> Genai.Agent.Dynamic.Persistable.Engine:
        """
        Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
        lambda application.
        ...
        """
            ...
        @overload
        def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> Genai.Agent.Dynamic.Persistable.Engine:
        """
        Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
        lambda application.
        ...
        """
            ...
        @overload
        def validateObj(self) -> Genai.Agent.Dynamic.Persistable.Engine:
        """
        Populates all missing default values and throws error if any constraint is violated.
        """
            ...
        ...
        """
            ...
        @overload
        def withField(self, field: str, value: Any, doNotConvert: bool=None) -> Genai.Agent.Dynamic.Persistable.Engine:
        """
        Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
        defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
        ...
        """
            ...
        @overload
        def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> Genai.Agent.Dynamic.Persistable.Engine:
        """
        Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
        defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
        ...
        """
            ...
        def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> Genai.Agent.Dynamic.Persistable.Engine:
        """
        Builds a new Obj instance by adding the provided fields in it. The name must correspond to an existing fields
        defined on this type or its mixins. The values must be of the correct type if doNotConvert flag is true.
        ...
        """
            ...
        def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> Genai.Agent.Dynamic.Persistable.Engine:
        """
        Builds a new Obj with the value at the specified path field. If the field is null, the field #isFieldSet to null.
        If you would like to #unsetField, you should call #withoutFieldAtPath instead.
        ...
        """
            ...
        def withoutFieldAtPath(self, path: str) -> Genai.Agent.Dynamic.Persistable.Engine:
        """
        Builds a new Obj without the specified path field.
        ...
        """
            ...
        @overload
        def withoutField(self, field: str) -> Genai.Agent.Dynamic.Persistable.Engine:
        """
        Builds a new Obj, removing the field with the provided name.
        ...
        """
            ...
        @overload
        def withoutField(self, field: FieldType) -> Genai.Agent.Dynamic.Persistable.Engine:
        """
        Builds a new Obj, removing the field with the provided field type.
        ...
        """
            ...
        def withoutFields(self, fields: Array[str]) -> Genai.Agent.Dynamic.Persistable.Engine:
        """
        Builds a new Obj, removing the fields with the provided names.
        ...
        """
            ...
        def withoutFieldsByType(self, fields: Array[FieldType]) -> Genai.Agent.Dynamic.Persistable.Engine:
        """
        Builds a new Obj, removing the fields with the provided field types. Be sure to use the FieldType instance for the
        exact same type as the type of the obj to respect the "ordinal" of the field type
        ...
        """
            ...
        def withoutSecretFields(self) -> Genai.Agent.Dynamic.Persistable.Engine:
        """
        @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
        """
            ...
        def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> Genai.Agent.Dynamic.Persistable.Engine:
        """
        Builds a new Obj instance by adding the default values (if defined) for all unset fields. This is implemented by
        calling {@link FieldType#defaultValue defaultValue} for a field if it is not already set and
        {@link FieldType#hasDefault has a default}. It will also set {@see ValueType#initialValue initial values} for
        ...
        """
            ...
        @overload
        def defaultField(self, field: str) -> Genai.Agent.Dynamic.Persistable.Engine:
        """
        Builds a new Obj, by setting a field on this `Obj` to the field's default value. If the field has no default, this
        method will behave the same as {@link #unsetField}.
        ...
        """
            ...
        @overload
        def defaultField(self, field: FieldType) -> Genai.Agent.Dynamic.Persistable.Engine:
        """
        Builds a new Obj, by setting a field on this `Obj` to the fields default value. If the field has no default, this
        method will behave the same as {@link #unsetField}.
        ...
        """
            ...
        @overload
        def unsetField(self, field: str) -> Genai.Agent.Dynamic.Persistable.Engine:
        """
        Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
        is different from {@link removeField}
        ...
        """
            ...
        @overload
        def unsetField(self, field: FieldType) -> Genai.Agent.Dynamic.Persistable.Engine:
        """
        Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
        is different from {@link removeField}
        ...
        """
            ...
        @overload
        def removeField(self, field: str) -> Genai.Agent.Dynamic.Persistable.Engine:
        """
        Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
        is different from {@link #unsetField}
        ...
        """
            ...
        @overload
        def removeField(self, field: FieldType) -> Genai.Agent.Dynamic.Persistable.Engine:
        """
        Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
        is different from {@link #unsetField}
        ...
        """
            ...
        @overload
        def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> Genai.Agent.Dynamic.Persistable.Engine:
        """
        Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
        In case of conflicts, fields of other instance take precedence unless otherwise specified by the fieldPathMergeSpec
        ...
        """
            ...
        @overload
        def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> Genai.Agent.Dynamic.Persistable.Engine:
        """
        Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
        In case of conflicts, fields of other instance take precedence.
        ...
        """
            ...
        @overload
        def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> Genai.Agent.Dynamic.Persistable.Engine:
        """
        Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
        fields that exist on other Obj and do not exist on this Obj will not be added to final Obj.
        @param deep
        ...
        """
            ...
        @overload
        def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> Genai.Agent.Dynamic.Persistable.Engine:
        """
        Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
        fields that exist other Obj and do not exist on this Obj will not be added to final Obj or evaluated. Does not
        traverse child reference and collection fields.
        ...
        """
            ...
        def mergeJson(self, json: any) -> Genai.Agent.Dynamic.Persistable.Engine:
            ...
        def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> Genai.Agent.Dynamic.Persistable.Engine:
        """
        Merge the obj references within the current obj
        @param deep
               If set, traverses the reference fields within the obj as well for a deep merge
        ...
        """
            ...
        def sumObj(self, other: Obj, deep: bool=None) -> Genai.Agent.Dynamic.Persistable.Engine:
        """
        Adds the numeric Obj fields with the other Objs respective fields.
        If deep is set it will traverse reference and collection fields and sum corresponding numeric fields in
        references with same name and collection elements at same index or key.
        """
            ...
        def singletonArray(self) -> Array[Genai.Agent.Dynamic.Persistable.Engine]:
        """
        Build an array of the correct type with a single element which is this instance.
        ...
        """
            ...
        @classmethod
        def array(cls, *elements: Array[Any]) -> Union[Array[Genai.Agent.Dynamic.Persistable.Engine]]:
        """
        Creates an array of instances of this type.
        """
            ...
        @classmethod
        def arrayBuilder(cls) -> Union[ArrayBuilder[Genai.Agent.Dynamic.Persistable.Engine]]:
        """
        Creates an array of instances of this type.
        """
            ...
        def singletonSet(self) -> Set[Genai.Agent.Dynamic.Persistable.Engine]:
        """
        Build an set of the correct type with a single element which is this instance.
        ...
        """
            ...
        @classmethod
        def setBuilder(cls) -> Union[SetBuilder[Genai.Agent.Dynamic.Persistable.Engine]]:
        """
        Creates a set of instances of this type.
        """
            ...
        @classmethod
        def mapBuilder(cls) -> Union[MapBuilder[str, Genai.Agent.Dynamic.Persistable.Engine]]:
        """
        Create a map of string to elements of this type.
        """
            ...
        @classmethod
        def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, Genai.Agent.Dynamic.Persistable.Engine]]:
        """
        Create a map with the given key type and elements of this type.
        """
            ...
        ...
        def myStreamType(cls) -> StreamType:
            ...
        def toBuilder(self) -> ObjBuilder[Genai.Agent.Dynamic.Persistable.Engine]:
        """
        @return new ObjBuilder with initial state set to fields of this instance.
        """
            ...
        @classmethod
        def builder(cls) -> ObjBuilder[Genai.Agent.Dynamic.Persistable.Engine]:
        """
        @return new ObjBuilder of this instance.
        """
            ...
        @overload
        @classmethod
        def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> Genai.Agent.Dynamic.Persistable.Engine:
        """
        Construct instance of this type from provided field values and options
        """
            ...
        @overload
        @classmethod
        def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> Genai.Agent.Dynamic.Persistable.Engine:
        """
        Construct an instance of this type from provided fields
        @param fields
                   Fields to construct the instance of the obj with
        ...
        @overload
        @classmethod
        def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> Genai.Agent.Dynamic.Persistable.Engine:
        """
        Construct instance of this type from provided field values and options
        """
            ...
        @overload
        @classmethod
        def make(cls, withDefaults: bool=None) -> Genai.Agent.Dynamic.Persistable.Engine:
        """
        Construct an instance of this type with no non-default field values unless explicitly specified by passing param true
        @param withDefaults
                   If set, then the Obj is made with default & initial values (required primitive fields e.g. !int32 -> 0)
        ...
        @overload
        @classmethod
        def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> Genai.Agent.Dynamic.Persistable.Engine:
        """
        Construct an instance from provided fields
        @param fields
                   Fields (in the format <field_name, value>) to construct an instance of the obj. Note that "type" as a
        ...
        @overload
        @classmethod
        def make(cls, fields: Any, withDefaults: bool=None) -> Genai.Agent.Dynamic.Persistable.Engine:
        """
        Construct an instance of this type from provided fields. Note it is more efficient to use #fromFields and other overloads
        ...
        @overload
        @classmethod
        def make(cls, s: str) -> Union[Genai.Agent.Dynamic.Persistable.Engine]:
        """
        Construct an instance of this type from the string. This is an alias for #fromString, as a specific overload
        when the argument is a known string.
        ...
        """
            ...
        @classmethod
        def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> Genai.Agent.Dynamic.Persistable.Engine:
        """
        Construct an instance of this type from provided instance of a subtype or a "duck type".
        """
            ...
        ...
        """
            ...
        def afterMake(self) -> Genai.Agent.Dynamic.Persistable.Engine:
        """
        Optional override that will be called after every instance creation.
        ...
        """
            ...
        @classmethod
        def cachedEmptyInst(cls) -> Genai.Agent.Dynamic.Persistable.Engine:
        """
        Creates an empty inst using `MyType.make()` and caches it. Avoid recreating multiple copies of the spec for
        every action dispatch. The cached inst can also be used for comparing whether the object is an empty or not
        Will only create empty instance for immutable Obj e.g. if an Obj is Mutable, this method will throw an error
        ...
        """
            ...
        @classmethod
        def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[Genai.Agent.Dynamic.Persistable.Engine]]:
        """
        Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
        value is read.
        """
            ...
        @classmethod
        def generateObj(cls, spec: Obj.GenerateSpec=None) -> Genai.Agent.Dynamic.Persistable.Engine:
        """
        Generate a single instance of this type. The base implementation uses {@link DataGenObj} to generate uniform
        random (gibberish) values for all fields, but it may be overridden by specific types with custom logic that
        populates fields in a more realistic way.
        ...
        """
            ...
        @classmethod
        def fromString(cls, s: str) -> Union[Genai.Agent.Dynamic.Persistable.Engine]:
        """
        Parse the string-based representation and reconstruct the corresponding instance. This must be implemented to
        provide deserialization.
        ...
        """
            ...
        @classmethod
        def forName(cls, name: str, failIfMissing: bool=None) -> Union[Genai.Agent.Dynamic.Persistable.Engine]:
        """
        ...
        """
            ...
        @classmethod
        def forId(cls, id: str, failIfMissing: bool=None) -> Union[Genai.Agent.Dynamic.Persistable.Engine]:
        """
        @return single instance of this Identified type by id.
        """
            ...
        ...
        """
            ...
        @classmethod
        def deploy(cls, spec: Engine.DeploySpec) -> Genai.Agent.Dynamic.Persistable.Engine:
        """
        ...
        """
            ...
        def deployment(self) -> Genai.Agent.Dynamic.Persistable.Engine.Deployment:
        """
        ...
        """
            ...
        def configuredDeployment(self) -> Genai.Agent.Dynamic.Persistable.Engine.Deployment:
        """
        ...
        """
            ...
        @classmethod
        def deploymentType(cls) -> Type[[Genai.Agent.Dynamic.Persistable.Engine.Deployment]]:
        """
        ...
        """
            ...
        def restart(self) -> Genai.Agent.Dynamic.Persistable.Engine:
        """
        Restarts this engine
        """
            ...
        def start(self, waitForReady: bool=None, spec: WaitableSpec=None) -> Union[Genai.Agent.Dynamic.Persistable.Engine]:
        """
        ...
        """
            ...
        def doStart(self) -> Genai.Agent.Dynamic.Persistable.Engine:
            ...
        ...
        """
            ...
        def call(self, action: Lambda[Callable[[Genai.Agent.Dynamic.Persistable.Engine], Union[T]]]) -> Union[T]:
        """
        call `action` on a specific engine
        """
            ...
        def onStart(self) -> Genai.Agent.Dynamic.Persistable.Engine:
        """
        ...
        """
            ...
        def onUpdate(self, oldDeployment: Genai.Agent.Dynamic.Persistable.Engine.Deployment) -> None:
        """
        ...
        """
            ...
        @classmethod
        def list(cls) -> Union[Array[Genai.Agent.Dynamic.Persistable.Engine]]:
        """
        ...
        class Deployment(Genai.Agent.Dynamic.Persistable.Engine.DeployBase, Engine.Deployment[Genai.Agent.Dynamic.Persistable.Engine]):
            """
            The Engine Deployment for {@link Genai.Agent.Dynamic.Persistable.Engine}.
            
            @remarks this represents a made instance of Genai.Agent.Dynamic.Persistable.Engine.Deployment
            """
            
            agentId: Optional[str]
            """
            The {@link Genai.Agent.Dynamic.Persistable#id} for which the engine is executing.
            """
            ...
            """
            def __init__(self, agentId: Optional[str]=None, name: Optional[str]=None, nodeRole: Optional[str]=None, altNodeRoles: Optional[Array[str]]=None, nodePools: Optional[Array[str]]=None, dedicatedThreadPool: Optional[bool]=None, autoStart: Optional[bool]=None, inactive: Optional[bool]=None, failActionIfEngineNotReady: Optional[bool]=None, initializingNodeAvoidanceDuration: Optional[str]=None, configOverride: Optional[str]=None, secretOverride: Optional[str]=None, issues: Optional[Array[str]]=None) -> None: ...
            ...
            """
                ...
            @classmethod
            def fromJson(cls, json: any) -> Union[Genai.Agent.Dynamic.Persistable.Engine.Deployment]:
            """
            Load the JSON-based representation and reconstruct the corresponding object.
            ...
            """
                ...
            @classmethod
            def fromJsonString(cls, json: str) -> Union[Genai.Agent.Dynamic.Persistable.Engine.Deployment]:
            """
            Load the JSON-based representation and reconstruct the corresponding object.
            ...
            """
                ...
            @classmethod
            def fromXmlString(cls, xml: str) -> Union[Genai.Agent.Dynamic.Persistable.Engine.Deployment]:
            """
            Load the XML-based representation and reconstruct the corresponding object.
            ...
            """
                ...
            @classmethod
            def deserialize(cls, contentStr: str, contentType: str) -> Union[Genai.Agent.Dynamic.Persistable.Engine.Deployment]:
            """
            Load from contentType representation and reconstruct the corresponding object.
            ...
            """
                ...
            def replaceType(self, old: Type, new: Type) -> Genai.Agent.Dynamic.Persistable.Engine.Deployment:
            """
            Returns new instance with all references to old type, including result of #type, replaced with new type. If new
            type does not contain fields from old or field value types are not convertable then drops the field.
            ...
            """
                ...
            @overload
            def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> Genai.Agent.Dynamic.Persistable.Engine.Deployment:
            """
            Result of this function call is a copy of current instance with all non empty fields replaced based on results of
            the `mapper` invocation.
            ...
            """
                ...
            @overload
            def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> Genai.Agent.Dynamic.Persistable.Engine.Deployment:
            """
            Result of this function call is a copy of current instance with all fields replaced based on results of the
            `mapper` invocation.
            ...
            """
                ...
            @overload
            def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[Genai.Agent.Dynamic.Persistable.Engine.Deployment]:
            """
            Result of this function call is a copy of current instance with all non empty fields replaced based on results of
            the asynchronous `mapper` invocation.
            ...
            """
                ...
            @overload
            def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[Genai.Agent.Dynamic.Persistable.Engine.Deployment]:
            """
            Result of this function call is a copy of current instance with all fields replaced based on results of the
            asynchronous `mapper` invocation.
            ...
            """
                ...
            def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> Genai.Agent.Dynamic.Persistable.Engine.Deployment:
            """
            Result of this function call is a copy of current instance with specified field value replaced based on result of
            the `mapper` invocation.
            @param field
            ...
            """
                ...
            @overload
            def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> Genai.Agent.Dynamic.Persistable.Engine.Deployment:
            """
            Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
            lambda application.
            ...
            """
                ...
            @overload
            def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> Genai.Agent.Dynamic.Persistable.Engine.Deployment:
            """
            Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
            lambda application.
            ...
            """
                ...
            @overload
            def validateObj(self) -> Genai.Agent.Dynamic.Persistable.Engine.Deployment:
            """
            Populates all missing default values and throws error if any constraint is violated.
            """
                ...
            ...
            """
                ...
            @overload
            def withField(self, field: str, value: Any, doNotConvert: bool=None) -> Genai.Agent.Dynamic.Persistable.Engine.Deployment:
            """
            Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
            defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
            ...
            """
                ...
            @overload
            def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> Genai.Agent.Dynamic.Persistable.Engine.Deployment:
            """
            Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
            defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
            ...
            """
                ...
            def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> Genai.Agent.Dynamic.Persistable.Engine.Deployment:
            """
            Builds a new Obj instance by adding the provided fields in it. The name must correspond to an existing fields
            defined on this type or its mixins. The values must be of the correct type if doNotConvert flag is true.
            ...
            """
                ...
            def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> Genai.Agent.Dynamic.Persistable.Engine.Deployment:
            """
            Builds a new Obj with the value at the specified path field. If the field is null, the field #isFieldSet to null.
            If you would like to #unsetField, you should call #withoutFieldAtPath instead.
            ...
            """
                ...
            def withoutFieldAtPath(self, path: str) -> Genai.Agent.Dynamic.Persistable.Engine.Deployment:
            """
            Builds a new Obj without the specified path field.
            ...
            """
                ...
            @overload
            def withoutField(self, field: str) -> Genai.Agent.Dynamic.Persistable.Engine.Deployment:
            """
            Builds a new Obj, removing the field with the provided name.
            ...
            """
                ...
            @overload
            def withoutField(self, field: FieldType) -> Genai.Agent.Dynamic.Persistable.Engine.Deployment:
            """
            Builds a new Obj, removing the field with the provided field type.
            ...
            """
                ...
            def withoutFields(self, fields: Array[str]) -> Genai.Agent.Dynamic.Persistable.Engine.Deployment:
            """
            Builds a new Obj, removing the fields with the provided names.
            ...
            """
                ...
            def withoutFieldsByType(self, fields: Array[FieldType]) -> Genai.Agent.Dynamic.Persistable.Engine.Deployment:
            """
            Builds a new Obj, removing the fields with the provided field types. Be sure to use the FieldType instance for the
            exact same type as the type of the obj to respect the "ordinal" of the field type
            ...
            """
                ...
            def withoutSecretFields(self) -> Genai.Agent.Dynamic.Persistable.Engine.Deployment:
            """
            @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
            """
                ...
            def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> Genai.Agent.Dynamic.Persistable.Engine.Deployment:
            """
            Builds a new Obj instance by adding the default values (if defined) for all unset fields. This is implemented by
            calling {@link FieldType#defaultValue defaultValue} for a field if it is not already set and
            {@link FieldType#hasDefault has a default}. It will also set {@see ValueType#initialValue initial values} for
            ...
            """
                ...
            @overload
            def defaultField(self, field: str) -> Genai.Agent.Dynamic.Persistable.Engine.Deployment:
            """
            Builds a new Obj, by setting a field on this `Obj` to the field's default value. If the field has no default, this
            method will behave the same as {@link #unsetField}.
            ...
            """
                ...
            @overload
            def defaultField(self, field: FieldType) -> Genai.Agent.Dynamic.Persistable.Engine.Deployment:
            """
            Builds a new Obj, by setting a field on this `Obj` to the fields default value. If the field has no default, this
            method will behave the same as {@link #unsetField}.
            ...
            """
                ...
            @overload
            def unsetField(self, field: str) -> Genai.Agent.Dynamic.Persistable.Engine.Deployment:
            """
            Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
            is different from {@link removeField}
            ...
            """
                ...
            @overload
            def unsetField(self, field: FieldType) -> Genai.Agent.Dynamic.Persistable.Engine.Deployment:
            """
            Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
            is different from {@link removeField}
            ...
            """
                ...
            @overload
            def removeField(self, field: str) -> Genai.Agent.Dynamic.Persistable.Engine.Deployment:
            """
            Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
            is different from {@link #unsetField}
            ...
            """
                ...
            @overload
            def removeField(self, field: FieldType) -> Genai.Agent.Dynamic.Persistable.Engine.Deployment:
            """
            Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
            is different from {@link #unsetField}
            ...
            """
                ...
            @overload
            def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> Genai.Agent.Dynamic.Persistable.Engine.Deployment:
            """
            Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
            In case of conflicts, fields of other instance take precedence unless otherwise specified by the fieldPathMergeSpec
            ...
            """
                ...
            @overload
            def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> Genai.Agent.Dynamic.Persistable.Engine.Deployment:
            """
            Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
            In case of conflicts, fields of other instance take precedence.
            ...
            """
                ...
            @overload
            def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> Genai.Agent.Dynamic.Persistable.Engine.Deployment:
            """
            Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
            fields that exist on other Obj and do not exist on this Obj will not be added to final Obj.
            @param deep
            ...
            """
                ...
            @overload
            def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> Genai.Agent.Dynamic.Persistable.Engine.Deployment:
            """
            Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
            fields that exist other Obj and do not exist on this Obj will not be added to final Obj or evaluated. Does not
            traverse child reference and collection fields.
            ...
            """
                ...
            def mergeJson(self, json: any) -> Genai.Agent.Dynamic.Persistable.Engine.Deployment:
                ...
            def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> Genai.Agent.Dynamic.Persistable.Engine.Deployment:
            """
            Merge the obj references within the current obj
            @param deep
                   If set, traverses the reference fields within the obj as well for a deep merge
            ...
            """
                ...
            def sumObj(self, other: Obj, deep: bool=None) -> Genai.Agent.Dynamic.Persistable.Engine.Deployment:
            """
            Adds the numeric Obj fields with the other Objs respective fields.
            If deep is set it will traverse reference and collection fields and sum corresponding numeric fields in
            references with same name and collection elements at same index or key.
            """
                ...
            def singletonArray(self) -> Array[Genai.Agent.Dynamic.Persistable.Engine.Deployment]:
            """
            Build an array of the correct type with a single element which is this instance.
            ...
            """
                ...
            @classmethod
            def array(cls, *elements: Array[Any]) -> Union[Array[Genai.Agent.Dynamic.Persistable.Engine.Deployment]]:
            """
            Creates an array of instances of this type.
            """
                ...
            @classmethod
            def arrayBuilder(cls) -> Union[ArrayBuilder[Genai.Agent.Dynamic.Persistable.Engine.Deployment]]:
            """
            Creates an array of instances of this type.
            """
                ...
            def singletonSet(self) -> Set[Genai.Agent.Dynamic.Persistable.Engine.Deployment]:
            """
            Build an set of the correct type with a single element which is this instance.
            ...
            """
                ...
            @classmethod
            def setBuilder(cls) -> Union[SetBuilder[Genai.Agent.Dynamic.Persistable.Engine.Deployment]]:
            """
            Creates a set of instances of this type.
            """
                ...
            @classmethod
            def mapBuilder(cls) -> Union[MapBuilder[str, Genai.Agent.Dynamic.Persistable.Engine.Deployment]]:
            """
            Create a map of string to elements of this type.
            """
                ...
            @classmethod
            def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, Genai.Agent.Dynamic.Persistable.Engine.Deployment]]:
            """
            Create a map with the given key type and elements of this type.
            """
                ...
            ...
            def myStreamType(cls) -> StreamType:
                ...
            def toBuilder(self) -> ObjBuilder[Genai.Agent.Dynamic.Persistable.Engine.Deployment]:
            """
            @return new ObjBuilder with initial state set to fields of this instance.
            """
                ...
            @classmethod
            def builder(cls) -> ObjBuilder[Genai.Agent.Dynamic.Persistable.Engine.Deployment]:
            """
            @return new ObjBuilder of this instance.
            """
                ...
            @overload
            @classmethod
            def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> Genai.Agent.Dynamic.Persistable.Engine.Deployment:
            """
            Construct instance of this type from provided field values and options
            """
                ...
            @overload
            @classmethod
            def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> Genai.Agent.Dynamic.Persistable.Engine.Deployment:
            """
            Construct an instance of this type from provided fields
            @param fields
                       Fields to construct the instance of the obj with
            ...
            @overload
            @classmethod
            def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> Genai.Agent.Dynamic.Persistable.Engine.Deployment:
            """
            Construct instance of this type from provided field values and options
            """
                ...
            @overload
            @classmethod
            def make(cls, withDefaults: bool=None) -> Genai.Agent.Dynamic.Persistable.Engine.Deployment:
            """
            Construct an instance of this type with no non-default field values unless explicitly specified by passing param true
            @param withDefaults
                       If set, then the Obj is made with default & initial values (required primitive fields e.g. !int32 -> 0)
            ...
            @overload
            @classmethod
            def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> Genai.Agent.Dynamic.Persistable.Engine.Deployment:
            """
            Construct an instance from provided fields
            @param fields
                       Fields (in the format <field_name, value>) to construct an instance of the obj. Note that "type" as a
            ...
            @overload
            @classmethod
            def make(cls, fields: Any, withDefaults: bool=None) -> Genai.Agent.Dynamic.Persistable.Engine.Deployment:
            """
            Construct an instance of this type from provided fields. Note it is more efficient to use #fromFields and other overloads
            ...
            @overload
            @classmethod
            def make(cls, s: str) -> Union[Genai.Agent.Dynamic.Persistable.Engine.Deployment]:
            """
            Construct an instance of this type from the string. This is an alias for #fromString, as a specific overload
            when the argument is a known string.
            ...
            """
                ...
            @classmethod
            def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> Genai.Agent.Dynamic.Persistable.Engine.Deployment:
            """
            Construct an instance of this type from provided instance of a subtype or a "duck type".
            """
                ...
            ...
            """
                ...
            def afterMake(self) -> Genai.Agent.Dynamic.Persistable.Engine.Deployment:
            """
            Optional override that will be called after every instance creation.
            ...
            """
                ...
            @classmethod
            def cachedEmptyInst(cls) -> Genai.Agent.Dynamic.Persistable.Engine.Deployment:
            """
            Creates an empty inst using `MyType.make()` and caches it. Avoid recreating multiple copies of the spec for
            every action dispatch. The cached inst can also be used for comparing whether the object is an empty or not
            Will only create empty instance for immutable Obj e.g. if an Obj is Mutable, this method will throw an error
            ...
            """
                ...
            @classmethod
            def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[Genai.Agent.Dynamic.Persistable.Engine.Deployment]]:
            """
            Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
            value is read.
            """
                ...
            @classmethod
            def generateObj(cls, spec: Obj.GenerateSpec=None) -> Genai.Agent.Dynamic.Persistable.Engine.Deployment:
            """
            Generate a single instance of this type. The base implementation uses {@link DataGenObj} to generate uniform
            random (gibberish) values for all fields, but it may be overridden by specific types with custom logic that
            populates fields in a more realistic way.
            ...
            """
                ...
            @classmethod
            def fromString(cls, s: str) -> Union[Genai.Agent.Dynamic.Persistable.Engine.Deployment]:
            """
            Parse the string-based representation and reconstruct the corresponding instance. This must be implemented to
            provide deserialization.
            ...
            """
                ...
            @classmethod
            def forName(cls, name: str, failIfMissing: bool=None) -> Union[Genai.Agent.Dynamic.Persistable.Engine.Deployment]:
            """
            @return single instance of this Nameable type by name. Note that if this type is also Cached then it will
            retrieve instance from cache.
            """
            ...
            """
                ...
            @classmethod
            def allCached(cls) -> Union[Stream[Genai.Agent.Dynamic.Persistable.Engine.Deployment]]:
            """
            @return stream of all available Cached instances.
            """
                ...
            @classmethod
            def find(cls, filter: str=None) -> Union[Stream[Genai.Agent.Dynamic.Persistable.Engine.Deployment]]:
            """
            ...
            """
                ...
            @classmethod
            def findBy(cls, field: str, value: Any) -> Union[Stream[Genai.Agent.Dynamic.Persistable.Engine.Deployment]]:
            """
            @return existing instances of this type that satisfy filter from data cache. Will call `produceAll`
                    if cache is empty or if Ann.cache.all is true & data has not previously been fetched.
                    Otherwise no population will be performed.
            """
                ...
            def getCached(self) -> Union[Genai.Agent.Dynamic.Persistable.Engine.Deployment]:
            """
            @return cached instance.
            """
                ...
            @classmethod
            def forCacheKey(cls, key: str) -> Union[Genai.Agent.Dynamic.Persistable.Engine.Deployment]:
            """
            ...
            """
                ...
            @classmethod
            def produce(cls, key: str) -> Union[Genai.Agent.Dynamic.Persistable.Engine.Deployment]:
            """
            Should produce an entry for the cache key. This method should not be called directly.
            """
                ...
            @classmethod
            def produceAll(cls) -> Union[Map[str, Genai.Agent.Dynamic.Persistable.Engine.Deployment]]:
            """
            ...
            """
                ...
            def getConfig(self) -> Genai.Agent.Dynamic.Persistable.Engine.Deployment:
            """
            ...
            """
                ...
            def getSecret(self) -> Genai.Agent.Dynamic.Persistable.Engine.Deployment:
            """
            ...
            """
                ...
            def withConfigKey(self, configKey: str) -> Genai.Agent.Dynamic.Persistable.Engine.Deployment:
            """
            ...
            """
                ...
            def withoutConfigKey(self) -> Genai.Agent.Dynamic.Persistable.Engine.Deployment:
            """
            @return copy without config key.
            """
                ...
            @classmethod
            def forConfigKey(cls, configKey: str) -> Union[Genai.Agent.Dynamic.Persistable.Engine.Deployment]:
            """
            ...
            """
                ...
            @classmethod
            def listConfigs(cls, parallel: bool=None, filter: Callable[[str], bool]=None) -> Union[Stream[Genai.Agent.Dynamic.Persistable.Engine.Deployment]]:
            """
            @param
            ...
            """
                ...
            @overload
            def setConfigValues(self, from_: Genai.Agent.Dynamic.Persistable.Engine.Deployment, override: str=None) -> None:
            """
            ...
            """
                ...
            @classmethod
            def loadConfigAndSecret(cls, configKey: str) -> Union[Genai.Agent.Dynamic.Persistable.Engine.Deployment]:
            """
            ...
            """
                ...
            def removeSecrets(self) -> Union[Genai.Agent.Dynamic.Persistable.Engine.Deployment]:
            """
            @return this config without any secret values.
            """
                ...
            def removeNonSecrets(self) -> Union[Genai.Agent.Dynamic.Persistable.Engine.Deployment]:
            """
            @return this config with only secret values.
            """
                ...
            def validate(self) -> Genai.Agent.Dynamic.Persistable.Engine.Deployment:
            """
            ...
            """
                ...
            def engineType(self) -> Union[Type[[Genai.Agent.Dynamic.Persistable.Engine]]]:
            """
            Return the subtype of {@link Engine} to which this {@link Engine.Deployment} belongs.
            """
                ...
            @classmethod
            def fromDeploySpec(cls, spec: Engine.DeploySpec) -> Union[Genai.Agent.Dynamic.Persistable.Engine.Deployment]:
            """
        ...
        class DeploySpec(Genai.Agent.Dynamic.Persistable.Engine.DeployBase, Engine.DeploySpec):
            """
            The Engine Deployment spec for {@link Genai.Agent.Dynamic.Persistable.Engine}.
            
            @remarks this represents a made instance of Genai.Agent.Dynamic.Persistable.Engine.DeploySpec
            """
            ...
            """
                ...
            @classmethod
            def fromJson(cls, json: any) -> Union[Genai.Agent.Dynamic.Persistable.Engine.DeploySpec]:
            """
            Load the JSON-based representation and reconstruct the corresponding object.
            ...
            """
                ...
            @classmethod
            def fromJsonString(cls, json: str) -> Union[Genai.Agent.Dynamic.Persistable.Engine.DeploySpec]:
            """
            Load the JSON-based representation and reconstruct the corresponding object.
            ...
            """
                ...
            @classmethod
            def fromXmlString(cls, xml: str) -> Union[Genai.Agent.Dynamic.Persistable.Engine.DeploySpec]:
            """
            Load the XML-based representation and reconstruct the corresponding object.
            ...
            """
                ...
            @classmethod
            def deserialize(cls, contentStr: str, contentType: str) -> Union[Genai.Agent.Dynamic.Persistable.Engine.DeploySpec]:
            """
            Load from contentType representation and reconstruct the corresponding object.
            ...
            """
                ...
            def replaceType(self, old: Type, new: Type) -> Genai.Agent.Dynamic.Persistable.Engine.DeploySpec:
            """
            Returns new instance with all references to old type, including result of #type, replaced with new type. If new
            type does not contain fields from old or field value types are not convertable then drops the field.
            ...
            """
                ...
            @overload
            def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> Genai.Agent.Dynamic.Persistable.Engine.DeploySpec:
            """
            Result of this function call is a copy of current instance with all non empty fields replaced based on results of
            the `mapper` invocation.
            ...
            """
                ...
            @overload
            def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> Genai.Agent.Dynamic.Persistable.Engine.DeploySpec:
            """
            Result of this function call is a copy of current instance with all fields replaced based on results of the
            `mapper` invocation.
            ...
            """
                ...
            @overload
            def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[Genai.Agent.Dynamic.Persistable.Engine.DeploySpec]:
            """
            Result of this function call is a copy of current instance with all non empty fields replaced based on results of
            the asynchronous `mapper` invocation.
            ...
            """
                ...
            @overload
            def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[Genai.Agent.Dynamic.Persistable.Engine.DeploySpec]:
            """
            Result of this function call is a copy of current instance with all fields replaced based on results of the
            asynchronous `mapper` invocation.
            ...
            """
                ...
            def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> Genai.Agent.Dynamic.Persistable.Engine.DeploySpec:
            """
            Result of this function call is a copy of current instance with specified field value replaced based on result of
            the `mapper` invocation.
            @param field
            ...
            """
                ...
            @overload
            def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> Genai.Agent.Dynamic.Persistable.Engine.DeploySpec:
            """
            Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
            lambda application.
            ...
            """
                ...
            @overload
            def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> Genai.Agent.Dynamic.Persistable.Engine.DeploySpec:
            """
            Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
            lambda application.
            ...
            """
                ...
            @overload
            def validateObj(self) -> Genai.Agent.Dynamic.Persistable.Engine.DeploySpec:
            """
            Populates all missing default values and throws error if any constraint is violated.
            """
                ...
            ...
            """
                ...
            @overload
            def withField(self, field: str, value: Any, doNotConvert: bool=None) -> Genai.Agent.Dynamic.Persistable.Engine.DeploySpec:
            """
            Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
            defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
            ...
            """
                ...
            @overload
            def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> Genai.Agent.Dynamic.Persistable.Engine.DeploySpec:
            """
            Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
            defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
            ...
            """
                ...
            def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> Genai.Agent.Dynamic.Persistable.Engine.DeploySpec:
            """
            Builds a new Obj instance by adding the provided fields in it. The name must correspond to an existing fields
            defined on this type or its mixins. The values must be of the correct type if doNotConvert flag is true.
            ...
            """
                ...
            def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> Genai.Agent.Dynamic.Persistable.Engine.DeploySpec:
            """
            Builds a new Obj with the value at the specified path field. If the field is null, the field #isFieldSet to null.
            If you would like to #unsetField, you should call #withoutFieldAtPath instead.
            ...
            """
                ...
            def withoutFieldAtPath(self, path: str) -> Genai.Agent.Dynamic.Persistable.Engine.DeploySpec:
            """
            Builds a new Obj without the specified path field.
            ...
            """
                ...
            @overload
            def withoutField(self, field: str) -> Genai.Agent.Dynamic.Persistable.Engine.DeploySpec:
            """
            Builds a new Obj, removing the field with the provided name.
            ...
            """
                ...
            @overload
            def withoutField(self, field: FieldType) -> Genai.Agent.Dynamic.Persistable.Engine.DeploySpec:
            """
            Builds a new Obj, removing the field with the provided field type.
            ...
            """
                ...
            def withoutFields(self, fields: Array[str]) -> Genai.Agent.Dynamic.Persistable.Engine.DeploySpec:
            """
            Builds a new Obj, removing the fields with the provided names.
            ...
            """
                ...
            def withoutFieldsByType(self, fields: Array[FieldType]) -> Genai.Agent.Dynamic.Persistable.Engine.DeploySpec:
            """
            Builds a new Obj, removing the fields with the provided field types. Be sure to use the FieldType instance for the
            exact same type as the type of the obj to respect the "ordinal" of the field type
            ...
            """
                ...
            def withoutSecretFields(self) -> Genai.Agent.Dynamic.Persistable.Engine.DeploySpec:
            """
            @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
            """
                ...
            def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> Genai.Agent.Dynamic.Persistable.Engine.DeploySpec:
            """
            Builds a new Obj instance by adding the default values (if defined) for all unset fields. This is implemented by
            calling {@link FieldType#defaultValue defaultValue} for a field if it is not already set and
            {@link FieldType#hasDefault has a default}. It will also set {@see ValueType#initialValue initial values} for
            ...
            """
                ...
            @overload
            def defaultField(self, field: str) -> Genai.Agent.Dynamic.Persistable.Engine.DeploySpec:
            """
            Builds a new Obj, by setting a field on this `Obj` to the field's default value. If the field has no default, this
            method will behave the same as {@link #unsetField}.
            ...
            """
                ...
            @overload
            def defaultField(self, field: FieldType) -> Genai.Agent.Dynamic.Persistable.Engine.DeploySpec:
            """
            Builds a new Obj, by setting a field on this `Obj` to the fields default value. If the field has no default, this
            method will behave the same as {@link #unsetField}.
            ...
            """
                ...
            @overload
            def unsetField(self, field: str) -> Genai.Agent.Dynamic.Persistable.Engine.DeploySpec:
            """
            Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
            is different from {@link removeField}
            ...
            """
                ...
            @overload
            def unsetField(self, field: FieldType) -> Genai.Agent.Dynamic.Persistable.Engine.DeploySpec:
            """
            Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
            is different from {@link removeField}
            ...
            """
                ...
            @overload
            def removeField(self, field: str) -> Genai.Agent.Dynamic.Persistable.Engine.DeploySpec:
            """
            Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
            is different from {@link #unsetField}
            ...
            """
                ...
            @overload
            def removeField(self, field: FieldType) -> Genai.Agent.Dynamic.Persistable.Engine.DeploySpec:
            """
            Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
            is different from {@link #unsetField}
            ...
            """
                ...
            @overload
            def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> Genai.Agent.Dynamic.Persistable.Engine.DeploySpec:
            """
            Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
            In case of conflicts, fields of other instance take precedence unless otherwise specified by the fieldPathMergeSpec
            ...
            """
                ...
            @overload
            def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> Genai.Agent.Dynamic.Persistable.Engine.DeploySpec:
            """
            Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
            In case of conflicts, fields of other instance take precedence.
            ...
            """
                ...
            @overload
            def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> Genai.Agent.Dynamic.Persistable.Engine.DeploySpec:
            """
            Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
            fields that exist on other Obj and do not exist on this Obj will not be added to final Obj.
            @param deep
            ...
            """
                ...
            @overload
            def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> Genai.Agent.Dynamic.Persistable.Engine.DeploySpec:
            """
            Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
            fields that exist other Obj and do not exist on this Obj will not be added to final Obj or evaluated. Does not
            traverse child reference and collection fields.
            ...
            """
                ...
            def mergeJson(self, json: any) -> Genai.Agent.Dynamic.Persistable.Engine.DeploySpec:
                ...
            def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> Genai.Agent.Dynamic.Persistable.Engine.DeploySpec:
            """
            Merge the obj references within the current obj
            @param deep
                   If set, traverses the reference fields within the obj as well for a deep merge
            ...
            """
                ...
            def sumObj(self, other: Obj, deep: bool=None) -> Genai.Agent.Dynamic.Persistable.Engine.DeploySpec:
            """
            Adds the numeric Obj fields with the other Objs respective fields.
            If deep is set it will traverse reference and collection fields and sum corresponding numeric fields in
            references with same name and collection elements at same index or key.
            """
                ...
            def singletonArray(self) -> Array[Genai.Agent.Dynamic.Persistable.Engine.DeploySpec]:
            """
            Build an array of the correct type with a single element which is this instance.
            ...
            """
                ...
            @classmethod
            def array(cls, *elements: Array[Any]) -> Union[Array[Genai.Agent.Dynamic.Persistable.Engine.DeploySpec]]:
            """
            Creates an array of instances of this type.
            """
                ...
            @classmethod
            def arrayBuilder(cls) -> Union[ArrayBuilder[Genai.Agent.Dynamic.Persistable.Engine.DeploySpec]]:
            """
            Creates an array of instances of this type.
            """
                ...
            def singletonSet(self) -> Set[Genai.Agent.Dynamic.Persistable.Engine.DeploySpec]:
            """
            Build an set of the correct type with a single element which is this instance.
            ...
            """
                ...
            @classmethod
            def setBuilder(cls) -> Union[SetBuilder[Genai.Agent.Dynamic.Persistable.Engine.DeploySpec]]:
            """
            Creates a set of instances of this type.
            """
                ...
            @classmethod
            def mapBuilder(cls) -> Union[MapBuilder[str, Genai.Agent.Dynamic.Persistable.Engine.DeploySpec]]:
            """
            Create a map of string to elements of this type.
            """
                ...
            @classmethod
            def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, Genai.Agent.Dynamic.Persistable.Engine.DeploySpec]]:
            """
            Create a map with the given key type and elements of this type.
            """
                ...
            ...
            def myStreamType(cls) -> StreamType:
                ...
            def toBuilder(self) -> ObjBuilder[Genai.Agent.Dynamic.Persistable.Engine.DeploySpec]:
            """
            @return new ObjBuilder with initial state set to fields of this instance.
            """
                ...
            @classmethod
            def builder(cls) -> ObjBuilder[Genai.Agent.Dynamic.Persistable.Engine.DeploySpec]:
            """
            @return new ObjBuilder of this instance.
            """
                ...
            @overload
            @classmethod
            def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> Genai.Agent.Dynamic.Persistable.Engine.DeploySpec:
            """
            Construct instance of this type from provided field values and options
            """
                ...
            @overload
            @classmethod
            def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> Genai.Agent.Dynamic.Persistable.Engine.DeploySpec:
            """
            Construct an instance of this type from provided fields
            @param fields
                       Fields to construct the instance of the obj with
            ...
            @overload
            @classmethod
            def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> Genai.Agent.Dynamic.Persistable.Engine.DeploySpec:
            """
            Construct instance of this type from provided field values and options
            """
                ...
            @overload
            @classmethod
            def make(cls, withDefaults: bool=None) -> Genai.Agent.Dynamic.Persistable.Engine.DeploySpec:
            """
            Construct an instance of this type with no non-default field values unless explicitly specified by passing param true
            @param withDefaults
                       If set, then the Obj is made with default & initial values (required primitive fields e.g. !int32 -> 0)
            ...
            @overload
            @classmethod
            def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> Genai.Agent.Dynamic.Persistable.Engine.DeploySpec:
            """
            Construct an instance from provided fields
            @param fields
                       Fields (in the format <field_name, value>) to construct an instance of the obj. Note that "type" as a
            ...
            @overload
            @classmethod
            def make(cls, fields: Any, withDefaults: bool=None) -> Genai.Agent.Dynamic.Persistable.Engine.DeploySpec:
            """
            Construct an instance of this type from provided fields. Note it is more efficient to use #fromFields and other overloads
            ...
            """
                ...
            @classmethod
            def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> Genai.Agent.Dynamic.Persistable.Engine.DeploySpec:
            """
            Construct an instance of this type from provided instance of a subtype or a "duck type".
            """
                ...
            ...
            """
                ...
            def afterMake(self) -> Genai.Agent.Dynamic.Persistable.Engine.DeploySpec:
            """
            Optional override that will be called after every instance creation.
            ...
            """
                ...
            @classmethod
            def cachedEmptyInst(cls) -> Genai.Agent.Dynamic.Persistable.Engine.DeploySpec:
            """
            Creates an empty inst using `MyType.make()` and caches it. Avoid recreating multiple copies of the spec for
            every action dispatch. The cached inst can also be used for comparing whether the object is an empty or not
            Will only create empty instance for immutable Obj e.g. if an Obj is Mutable, this method will throw an error
            ...
            """
                ...
            @classmethod
            def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[Genai.Agent.Dynamic.Persistable.Engine.DeploySpec]]:
            """
            Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
            value is read.
            """
                ...
            @classmethod
            def generateObj(cls, spec: Obj.GenerateSpec=None) -> Genai.Agent.Dynamic.Persistable.Engine.DeploySpec:
            """
            Generate a single instance of this type. The base implementation uses {@link DataGenObj} to generate uniform
            random (gibberish) values for all fields, but it may be overridden by specific types with custom logic that
            populates fields in a more realistic way.
        ...
        class DeployBase():
            """
            Specifies common fields used in {@link Genai.Agent.Dynamic.Persistable.Engine.Deployment}
            and {@link Genai.Agent.Dynamic.Persistable.Engine.DeploySpec} for deploying a
            {@link Genai.Agent.Dynamic.Persistable.Engine}.
            
            @remarks this represents a made instance of Genai.Agent.Dynamic.Persistable.Engine.DeployBase
            """
            ...
            The {@link Genai.Agent.Dynamic.Persistable#id} for which the engine is executing.
            """
            def __init__(self, agentId: Optional[str]=None) -> None: ...
            ...
            """
                ...
            @classmethod
            def fromJson(cls, json: any) -> Union[Genai.Agent.Dynamic.Persistable.Engine.DeployBase]:
            """
            Load the JSON-based representation and reconstruct the corresponding object.
            ...
            """
                ...
            @classmethod
            def fromJsonString(cls, json: str) -> Union[Genai.Agent.Dynamic.Persistable.Engine.DeployBase]:
            """
            Load the JSON-based representation and reconstruct the corresponding object.
            ...
            """
                ...
            @classmethod
            def fromXmlString(cls, xml: str) -> Union[Genai.Agent.Dynamic.Persistable.Engine.DeployBase]:
            """
            Load the XML-based representation and reconstruct the corresponding object.
            ...
            """
                ...
            @classmethod
            def deserialize(cls, contentStr: str, contentType: str) -> Union[Genai.Agent.Dynamic.Persistable.Engine.DeployBase]:
            """
            Load from contentType representation and reconstruct the corresponding object.
            ...
            """
                ...
            def replaceType(self, old: Type, new: Type) -> Genai.Agent.Dynamic.Persistable.Engine.DeployBase:
            """
            Returns new instance with all references to old type, including result of #type, replaced with new type. If new
            type does not contain fields from old or field value types are not convertable then drops the field.
            ...
            """
                ...
            @overload
            def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> Genai.Agent.Dynamic.Persistable.Engine.DeployBase:
            """
            Result of this function call is a copy of current instance with all non empty fields replaced based on results of
            the `mapper` invocation.
            ...
            """
                ...
            @overload
            def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> Genai.Agent.Dynamic.Persistable.Engine.DeployBase:
            """
            Result of this function call is a copy of current instance with all fields replaced based on results of the
            `mapper` invocation.
            ...
            """
                ...
            @overload
            def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[Genai.Agent.Dynamic.Persistable.Engine.DeployBase]:
            """
            Result of this function call is a copy of current instance with all non empty fields replaced based on results of
            the asynchronous `mapper` invocation.
            ...
            """
                ...
            @overload
            def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[Genai.Agent.Dynamic.Persistable.Engine.DeployBase]:
            """
            Result of this function call is a copy of current instance with all fields replaced based on results of the
            asynchronous `mapper` invocation.
            ...
            """
                ...
            def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> Genai.Agent.Dynamic.Persistable.Engine.DeployBase:
            """
            Result of this function call is a copy of current instance with specified field value replaced based on result of
            the `mapper` invocation.
            @param field
            ...
            """
                ...
            @overload
            def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> Genai.Agent.Dynamic.Persistable.Engine.DeployBase:
            """
            Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
            lambda application.
            ...
            """
                ...
            @overload
            def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> Genai.Agent.Dynamic.Persistable.Engine.DeployBase:
            """
            Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
            lambda application.
            ...
            """
                ...
            @overload
            def validateObj(self) -> Genai.Agent.Dynamic.Persistable.Engine.DeployBase:
            """
            Populates all missing default values and throws error if any constraint is violated.
            """
                ...
            ...
            """
                ...
            @overload
            def withField(self, field: str, value: Any, doNotConvert: bool=None) -> Genai.Agent.Dynamic.Persistable.Engine.DeployBase:
            """
            Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
            defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
            ...
            """
                ...
            @overload
            def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> Genai.Agent.Dynamic.Persistable.Engine.DeployBase:
            """
            Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
            defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
            ...
            """
                ...
            def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> Genai.Agent.Dynamic.Persistable.Engine.DeployBase:
            """
            Builds a new Obj instance by adding the provided fields in it. The name must correspond to an existing fields
            defined on this type or its mixins. The values must be of the correct type if doNotConvert flag is true.
            ...
            """
                ...
            def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> Genai.Agent.Dynamic.Persistable.Engine.DeployBase:
            """
            Builds a new Obj with the value at the specified path field. If the field is null, the field #isFieldSet to null.
            If you would like to #unsetField, you should call #withoutFieldAtPath instead.
            ...
            """
                ...
            def withoutFieldAtPath(self, path: str) -> Genai.Agent.Dynamic.Persistable.Engine.DeployBase:
            """
            Builds a new Obj without the specified path field.
            ...
            """
                ...
            @overload
            def withoutField(self, field: str) -> Genai.Agent.Dynamic.Persistable.Engine.DeployBase:
            """
            Builds a new Obj, removing the field with the provided name.
            ...
            """
                ...
            @overload
            def withoutField(self, field: FieldType) -> Genai.Agent.Dynamic.Persistable.Engine.DeployBase:
            """
            Builds a new Obj, removing the field with the provided field type.
            ...
            """
                ...
            def withoutFields(self, fields: Array[str]) -> Genai.Agent.Dynamic.Persistable.Engine.DeployBase:
            """
            Builds a new Obj, removing the fields with the provided names.
            ...
            """
                ...
            def withoutFieldsByType(self, fields: Array[FieldType]) -> Genai.Agent.Dynamic.Persistable.Engine.DeployBase:
            """
            Builds a new Obj, removing the fields with the provided field types. Be sure to use the FieldType instance for the
            exact same type as the type of the obj to respect the "ordinal" of the field type
            ...
            """
                ...
            def withoutSecretFields(self) -> Genai.Agent.Dynamic.Persistable.Engine.DeployBase:
            """
            @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
            """
                ...
            def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> Genai.Agent.Dynamic.Persistable.Engine.DeployBase:
            """
            Builds a new Obj instance by adding the default values (if defined) for all unset fields. This is implemented by
            calling {@link FieldType#defaultValue defaultValue} for a field if it is not already set and
            {@link FieldType#hasDefault has a default}. It will also set {@see ValueType#initialValue initial values} for
            ...
            """
                ...
            @overload
            def defaultField(self, field: str) -> Genai.Agent.Dynamic.Persistable.Engine.DeployBase:
            """
            Builds a new Obj, by setting a field on this `Obj` to the field's default value. If the field has no default, this
            method will behave the same as {@link #unsetField}.
            ...
            """
                ...
            @overload
            def defaultField(self, field: FieldType) -> Genai.Agent.Dynamic.Persistable.Engine.DeployBase:
            """
            Builds a new Obj, by setting a field on this `Obj` to the fields default value. If the field has no default, this
            method will behave the same as {@link #unsetField}.
            ...
            """
                ...
            @overload
            def unsetField(self, field: str) -> Genai.Agent.Dynamic.Persistable.Engine.DeployBase:
            """
            Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
            is different from {@link removeField}
            ...
            """
                ...
            @overload
            def unsetField(self, field: FieldType) -> Genai.Agent.Dynamic.Persistable.Engine.DeployBase:
            """
            Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
            is different from {@link removeField}
            ...
            """
                ...
            @overload
            def removeField(self, field: str) -> Genai.Agent.Dynamic.Persistable.Engine.DeployBase:
            """
            Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
            is different from {@link #unsetField}
            ...
            """
                ...
            @overload
            def removeField(self, field: FieldType) -> Genai.Agent.Dynamic.Persistable.Engine.DeployBase:
            """
            Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
            is different from {@link #unsetField}
            ...
            """
                ...
            @overload
            def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> Genai.Agent.Dynamic.Persistable.Engine.DeployBase:
            """
            Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
            In case of conflicts, fields of other instance take precedence unless otherwise specified by the fieldPathMergeSpec
            ...
            """
                ...
            @overload
            def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> Genai.Agent.Dynamic.Persistable.Engine.DeployBase:
            """
            Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
            In case of conflicts, fields of other instance take precedence.
            ...
            """
                ...
            @overload
            def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> Genai.Agent.Dynamic.Persistable.Engine.DeployBase:
            """
            Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
            fields that exist on other Obj and do not exist on this Obj will not be added to final Obj.
            @param deep
            ...
            """
                ...
            @overload
            def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> Genai.Agent.Dynamic.Persistable.Engine.DeployBase:
            """
            Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
            fields that exist other Obj and do not exist on this Obj will not be added to final Obj or evaluated. Does not
            traverse child reference and collection fields.
            ...
            """
                ...
            def mergeJson(self, json: any) -> Genai.Agent.Dynamic.Persistable.Engine.DeployBase:
                ...
            def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> Genai.Agent.Dynamic.Persistable.Engine.DeployBase:
            """
            Merge the obj references within the current obj
            @param deep
                   If set, traverses the reference fields within the obj as well for a deep merge
            ...
            """
                ...
            def sumObj(self, other: Obj, deep: bool=None) -> Genai.Agent.Dynamic.Persistable.Engine.DeployBase:
            """
            Adds the numeric Obj fields with the other Objs respective fields.
            If deep is set it will traverse reference and collection fields and sum corresponding numeric fields in
            references with same name and collection elements at same index or key.
            """
                ...
            def singletonArray(self) -> Array[Genai.Agent.Dynamic.Persistable.Engine.DeployBase]:
            """
            Build an array of the correct type with a single element which is this instance.
            ...
            """
                ...
            @classmethod
            def array(cls, *elements: Array[Any]) -> Union[Array[Genai.Agent.Dynamic.Persistable.Engine.DeployBase]]:
            """
            Creates an array of instances of this type.
            """
                ...
            @classmethod
            def arrayBuilder(cls) -> Union[ArrayBuilder[Genai.Agent.Dynamic.Persistable.Engine.DeployBase]]:
            """
            Creates an array of instances of this type.
            """
                ...
            def singletonSet(self) -> Set[Genai.Agent.Dynamic.Persistable.Engine.DeployBase]:
            """
            Build an set of the correct type with a single element which is this instance.
            ...
            """
                ...
            @classmethod
            def setBuilder(cls) -> Union[SetBuilder[Genai.Agent.Dynamic.Persistable.Engine.DeployBase]]:
            """
            Creates a set of instances of this type.
            """
                ...
            @classmethod
            def mapBuilder(cls) -> Union[MapBuilder[str, Genai.Agent.Dynamic.Persistable.Engine.DeployBase]]:
            """
            Create a map of string to elements of this type.
            """
                ...
            @classmethod
            def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, Genai.Agent.Dynamic.Persistable.Engine.DeployBase]]:
            """
            Create a map with the given key type and elements of this type.
            """
                ...
            ...
            def myStreamType(cls) -> StreamType:
                ...
            def toBuilder(self) -> ObjBuilder[Genai.Agent.Dynamic.Persistable.Engine.DeployBase]:
            """
            @return new ObjBuilder with initial state set to fields of this instance.
            """
                ...
            @classmethod
            def builder(cls) -> ObjBuilder[Genai.Agent.Dynamic.Persistable.Engine.DeployBase]:
            """
            @return new ObjBuilder of this instance.
            """
                ...
            @overload
            @classmethod
            def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> Genai.Agent.Dynamic.Persistable.Engine.DeployBase:
            """
            Construct instance of this type from provided field values and options
            """
                ...
            @overload
            @classmethod
            def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> Genai.Agent.Dynamic.Persistable.Engine.DeployBase:
            """
            Construct an instance of this type from provided fields
            @param fields
                       Fields to construct the instance of the obj with
            ...
            @overload
            @classmethod
            def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> Genai.Agent.Dynamic.Persistable.Engine.DeployBase:
            """
            Construct instance of this type from provided field values and options
            """
                ...
            @overload
            @classmethod
            def make(cls, withDefaults: bool=None) -> Genai.Agent.Dynamic.Persistable.Engine.DeployBase:
            """
            Construct an instance of this type with no non-default field values unless explicitly specified by passing param true
            @param withDefaults
                       If set, then the Obj is made with default & initial values (required primitive fields e.g. !int32 -> 0)
            ...
            @overload
            @classmethod
            def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> Genai.Agent.Dynamic.Persistable.Engine.DeployBase:
            """
            Construct an instance from provided fields
            @param fields
                       Fields (in the format <field_name, value>) to construct an instance of the obj. Note that "type" as a
            ...
            @overload
            @classmethod
            def make(cls, fields: Any, withDefaults: bool=None) -> Genai.Agent.Dynamic.Persistable.Engine.DeployBase:
            """
            Construct an instance of this type from provided fields. Note it is more efficient to use #fromFields and other overloads
            ...
            """
                ...
            @classmethod
            def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> Genai.Agent.Dynamic.Persistable.Engine.DeployBase:
            """
            Construct an instance of this type from provided instance of a subtype or a "duck type".
            """
                ...
            ...
            """
                ...
            def afterMake(self) -> Genai.Agent.Dynamic.Persistable.Engine.DeployBase:
            """
            Optional override that will be called after every instance creation.
            ...
            """
                ...
            @classmethod
            def cachedEmptyInst(cls) -> Genai.Agent.Dynamic.Persistable.Engine.DeployBase:
            """
            Creates an empty inst using `MyType.make()` and caches it. Avoid recreating multiple copies of the spec for
            every action dispatch. The cached inst can also be used for comparing whether the object is an empty or not
            Will only create empty instance for immutable Obj e.g. if an Obj is Mutable, this method will throw an error
            ...
            """
                ...
            @classmethod
            def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[Genai.Agent.Dynamic.Persistable.Engine.DeployBase]]:
            """
            Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
            value is read.
            """
                ...
            @classmethod
            def generateObj(cls, spec: Obj.GenerateSpec=None) -> Genai.Agent.Dynamic.Persistable.Engine.DeployBase:
            """
            Generate a single instance of this type. The base implementation uses {@link DataGenObj} to generate uniform
            random (gibberish) values for all fields, but it may be overridden by specific types with custom logic that
            populates fields in a more realistic way.
