...
from c3.genAiBase.Genai.UnstructuredQuery.Engine.REA.ModelInference.Prompt.Config.ExampleBase import Genai.UnstructuredQuery.Engine.REA.ModelInference.Prompt.Config.ExampleBase
...
# Python definitions for the C3 type Genai.Prompt


class Prompt(StringSerializable, PyReprProtocol):
    """
    Base type for prompts passed to LLMs
    
    @remarks this represents a made instance of Genai.Prompt
    """
    ...
    """
    Description for the prompt containing information on how and when it should be used.
    """

    rawTemplate: Optional[str]=None
    """
    The string representation of the prompt, where parameters are not yet set. Parameters are conventionally
    signalled with double brackets, i.e. {{parameter}}. If such parameters are in the input `template`,
    they will be used as keys to #parameters.
    """

    templateFile: Optional[File]=None
    """
    The file where the prompt is defined.
    """

    parameters: Optional[any]=None
    """
    This prompt's parameters. Parameters can be accessed with #params, set with #setParam and #setParams, reset
    with #resetParams or renamed with #renameParam and #renameParams.
    """
    ...
    """
    def __init__(self, typeIdent: Optional[str]=None, id: Optional[str]=None, versionEdits: Optional[Array[VersionEdit]]=None, name: Optional[str]=None, meta: Optional[Meta]=None, version: Optional[int]=None, typeWithBindings: Optional[Type]=None, description: Optional[str]=None, rawTemplate: Optional[str]=None, templateFile: Optional[File]=None, parameters: Optional[any]=None, defaultExamples: Optional[Array[Genai.UnstructuredQuery.Engine.REA.ModelInference.Prompt.Config.ExampleBase]]=None, staticExamples: Optional[Array[Genai.UnstructuredQuery.Engine.REA.ModelInference.Prompt.Config.ExampleBase]]=None, promptCreatorType: Optional[str]=None) -> None: ...

    def toString(self) -> Union[str]:
    """
    Returns this prompt's flattened template.
    """
        ...
    @classmethod
    def fromString(cls, s: str) -> Union[Genai.Prompt]:
    """
    Instantiates a prompt from a string. Identifies parameters in the input template string, with the convention that
    they are prefixed and suffixed by double brackets, e.g. {{param_name}}.
    """
        ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[Genai.Prompt]:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> Genai.Prompt:
    """
    ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> Genai.Prompt:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> Genai.Prompt:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> Genai.Prompt:
    """
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[Genai.Prompt]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[Genai.Prompt]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[Genai.Prompt]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[Genai.Prompt]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> Genai.Prompt:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> Genai.Prompt:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> Genai.Prompt:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[Genai.Prompt]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[Genai.Prompt]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> Genai.Prompt:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> Genai.Prompt:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> Genai.Prompt:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> Genai.Prompt:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> Genai.Prompt:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> Genai.Prompt:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> Genai.Prompt:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> Genai.Prompt:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> Genai.Prompt:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> Genai.Prompt:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> Genai.Prompt:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> Genai.Prompt:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> Genai.Prompt:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> Genai.Prompt:
    """
    @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> Genai.Prompt:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> Genai.Prompt:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> Genai.Prompt:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> Genai.Prompt:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> Genai.Prompt:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> Genai.Prompt:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> Genai.Prompt:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> Genai.Prompt:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> Genai.Prompt:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> Genai.Prompt:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> Genai.Prompt:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> Genai.Prompt:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> Genai.Prompt:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> Genai.Prompt:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[Genai.Prompt]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[Genai.Prompt]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[Genai.Prompt]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[Genai.Prompt]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[Genai.Prompt]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, Genai.Prompt]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, Genai.Prompt]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[Genai.Prompt]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[Genai.Prompt]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> Genai.Prompt:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> Genai.Prompt:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> Genai.Prompt:
    """
    ...
    """
        ...
    def afterMake(self) -> Genai.Prompt:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> Genai.Prompt:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[Genai.Prompt]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> Genai.Prompt:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, spec: FetchSpec=None) -> FetchResult[Genai.Prompt]:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, filter: Filter) -> FetchResult[Genai.Prompt]:
    """
    ...
    """
        ...
    @classmethod
    def fetchObjStream(cls, spec: FetchStreamSpec=None) -> Union[Stream[Genai.Prompt]]:
    """
    Fetches multiple obj instances based on a specification.  Only objs that the caller is authorized to fetch will be
    returned.
    ...
    """
        ...
    @classmethod
    def fetchMultiLocale(cls, spec: MultiLocaleFetchSpec=None) -> Union[Map[str, FetchResult[Genai.Prompt]]]:
    """
    ...
    """
        ...
    def get(self, include: str=None) -> Union[Genai.Prompt]:
    """
    ...
    """
        ...
    def getSpecific(self, include: str=None) -> Union[Genai.Prompt]:
    """
    ...
    """
        ...
    def getMissing(self, spec: GetMissingSpec) -> Genai.Prompt:
    """
    ...
    """
        ...
    def getDirect(self, include: str=None) -> Union[Genai.Prompt]:
    """
    ...
    """
        ...
    def applyReverseEdit(self, versionEdit: VersionEdit) -> Genai.Prompt:
    """
    ...
    """
        ...
    def create(self, spec: UpsertSpec=None) -> Union[Genai.Prompt]:
    """
    ...
    """
        ...
    @classmethod
    def createBatch(cls, objs: Array[Genai.Prompt], spec: UpsertSpec=None) -> Union[ObjList[Genai.Prompt]]:
    """
    ...
    """
        ...
    @classmethod
    def createBatchObjStream(cls, objs: Stream[Genai.Prompt], spec: CreateBatchObjStreamSpec=None) -> Union[ObjList[Genai.Prompt]]:
    """
    Creates multiple instances of a C3 type. If the operation fails and {@link UpsertSpec#dontThrowOnBatchError} is not
    specified (the default), then a C3BatchException will be thrown.  Otherwise {@link errors will be reported in the
    returned {@link ObjList}.  This will fail if any of the instances already exist.
    ...
    """
        ...
    def update(self, srcObj: Genai.Prompt=None, spec: UpsertSpec=None) -> Union[Genai.Prompt]:
    """
    ...
    """
        ...
    def upsert(self, srcObj: Genai.Prompt=None, spec: UpsertSpec=None) -> Union[Genai.Prompt]:
    """
    ...
    """
        ...
    @overload
    def merge(self, spec: MergeSpec=None) -> Union[Genai.Prompt]:
    """
    ...
    """
        ...
    @overload
    def merge(self, mergeInclude: str, spec: MergeSpec=None) -> Union[Genai.Prompt]:
    """
    ...
    """
        ...
    def touch(self, spec: TouchSpec=None) -> Union[Genai.Prompt]:
    """
    ...
    """
        ...
    @classmethod
    def updateBatch(cls, objs: Array[Genai.Prompt], srcObjs: Array[Genai.Prompt]=None, spec: UpsertSpec=None) -> Union[ObjList[Genai.Prompt]]:
    """
    ...
    """
        ...
    @classmethod
    def updateObjs(cls, objs: Callable[[], Union[Array[Genai.Prompt]]], spec: UpsertSpec=None) -> Union[ObjList[Genai.Prompt]]:
    """
    ...
    """
        ...
    @classmethod
    def upsertBatch(cls, objs: Array[Genai.Prompt], srcObjs: Array[Genai.Prompt]=None, spec: UpsertSpec=None) -> Union[ObjList[Genai.Prompt]]:
    """
    ...
    """
        ...
    @classmethod
    def upsertObjs(cls, objs: Callable[[], Union[Array[Genai.Prompt]]], spec: UpsertSpec=None) -> Union[ObjList[Genai.Prompt]]:
    """
    Creates instances of a C3 type if they don't already exist and updates them if they do exist. If the operation
    ...
    """
        ...
    @classmethod
    def touchBatch(cls, objs: Array[Genai.Prompt], spec: TouchSpec=None) -> Union[ObjList[Genai.Prompt]]:
    """
    ...
    @overload
    @classmethod
    def mergeBatch(cls, objs: Array[Genai.Prompt], spec: MergeSpec=None) -> Union[ObjList[Genai.Prompt]]:
    """
    ...
    @overload
    @classmethod
    def mergeBatch(cls, objs: Array[Genai.Prompt], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[Genai.Prompt]]:
    """
    Merges multiple instances of a C3 type or creates them if they don't exist. If the operation fails and {@link
    UpsertSpec#dontThrowOnBatchError} is not specified (the default), then a C3BatchException will be thrown.
    Otherwise errors will be reported in the returned {@link ObjList}.  The merge operation is described in the {@link
    ...
    """
        ...
    @classmethod
    def mergeObjs(cls, objs: Callable[[], Union[Array[Genai.Prompt]]], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[Genai.Prompt]]:
    """
    ...
    @overload
    @classmethod
    def mergeAll(cls, mergeObj: Genai.Prompt, spec: MergeAllSpec=None) -> Union[int]:
    """
    ...
    @overload
    @classmethod
    def mergeAll(cls, mergeObj: Genai.Prompt, mergeInclude: str, spec: MergeAllSpec=None) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def removeBatch(cls, objs: Array[Genai.Prompt], spec: UpsertSpec=None) -> Union[ObjList[Genai.Prompt]]:
    """
    ...
    """
        ...
    @classmethod
    def replace(cls, objs: Array[Genai.Prompt], spec: UpsertSpec=None) -> Union[ObjList[Genai.Prompt]]:
    """
    ...
    """
        ...
    def unremove(self) -> Union[Genai.Prompt]:
    """
    ...
    """
        ...
    @classmethod
    def beforeCreate(cls, objs: Array[Genai.Prompt]) -> ObjList[Genai.Prompt]:
    """
    ...
    """
        ...
    @classmethod
    def beforeUpdate(cls, objs: Array[Genai.Prompt]) -> ObjList[Genai.Prompt]:
    """
    ...
    """
        ...
    @classmethod
    def beforeRemove(cls, objs: Array[Genai.Prompt]) -> ObjList[Genai.Prompt]:
    """
    ...
    """
        ...
    @classmethod
    def afterCreate(cls, objs: Array[Genai.Prompt]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def afterUpdate(cls, objs: Array[Genai.Prompt]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def afterRemove(cls, objs: Array[Genai.Prompt]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def startImportData(cls, spec: StartImportDataSpec=None) -> PushStream[Genai.Prompt]:
    """
    @return a push stream to import instances of this type.
    """
        ...
    @classmethod
    def startImportDataWithStats(cls, spec: StartImportDataSpec=None) -> PushStreamWithStats[Genai.Prompt]:
    """
    @return a push stream to import instances of this type.
    """
        ...
    ...
    """
        ...
    @classmethod
    def forId(cls, id: str, failIfMissing: bool=None) -> Union[Genai.Prompt]:
    """
    ...
    """
        ...
    def withoutIdentity(self) -> Union[Genai.Prompt]:
    """
    ...
    """
        ...
    @classmethod
    def typeOfBatch(cls, objs: Array[Genai.Prompt]) -> Union[Array[EntityType]]:
    """
    ...
    """
        ...
    @classmethod
    def dbEcho(cls, template: Genai.Prompt=None, count: int=None, sendBack: bool=None) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def callbackLogic(cls, objs: Array[Genai.Prompt], callback: Callable[[Union[Genai.Prompt]], Union[Genai.Prompt]]=None) -> ObjList[Genai.Prompt]:
    """
    ...
    """
        ...
    @classmethod
    def afterCallbackLogic(cls, objs: Array[Genai.Prompt], callback: Callable[[Union[Genai.Prompt]], Union[Genai.Prompt]]=None) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def fromFile(cls, file: File) -> Genai.Prompt:
    """
    Reads the input file's string and parses its content.
    """
        ...
    def params(self) -> Union[Any]:
    """
    Allows access to this prompt's parameters in an attribute-like syntax. Returns a native dictionary.
    """
        ...
    def setParam(self, name: str, value: Union[str,any]=None) -> Genai.Prompt:
    """
    Sets the specified parameter with the specified value.
    """
        ...
    def setParams(self, params: any) -> Genai.Prompt:
    """
    Sets the specified parameters with the specified values.
    """
        ...
    def resetParams(self, params: Array[str]) -> Genai.Prompt:
    """
    Reset all values for the specified `params` in #parameters to null.
    """
        ...
    def renameParam(self, oldName: str, newName: str) -> Genai.Prompt:
    """
    Rename the specified parameter with the specified new name.
    """
        ...
    def renameParams(self, names: any) -> Genai.Prompt:
    """
    Rename the specified parameters with the specified new names.
    """
        ...
    def flatten(self) -> Genai.Prompt:
    """
    "Flatten" this prompt, i.e. replace all set parameters with their values. Only unset parameters will be
    referenced in the returned prompt's parameters.
    """
        ...
    def status(self) -> str:
    """
    This prompt's status:
    - "INITIAL" if no parameter is set
    - "COMPLETE" if all parameters are set
    - "PARTIAL" otherwise
    """
        ...
    ...
    """
        ...
    def toC3AgentsPromptTemplate(self) -> Union[Any]:
    """
    Converts the prompt to a c3agents `PromptTemplate`.
    """
        ...
    
    class TestConfig(Identified, Config):
        """
        Test type for having prompts in configs.
        
        @remarks this represents a made instance of Genai.Prompt.TestConfig
        """
        ...
        jsonInConfig: Optional[Genai.Prompt]
        """
        Test field
        """

        stringInConfig: Optional[Genai.Prompt]
        """
        Test field
        """

        entityIdInConfig: Optional[Genai.Prompt]
        """
        Test field
        """

        filePathInConfig: Optional[Genai.Prompt]
        """
        Test field
        """
        def __init__(self, id: Optional[str]=None, configOverride: Optional[str]=None, secretOverride: Optional[str]=None, issues: Optional[Array[str]]=None, jsonInConfig: Optional[Genai.Prompt]=None, stringInConfig: Optional[Genai.Prompt]=None, entityIdInConfig: Optional[Genai.Prompt]=None, filePathInConfig: Optional[Genai.Prompt]=None) -> None: ...
        ...
        """
            ...
        @classmethod
        def fromString(cls, s: str) -> Union[Genai.Prompt.TestConfig]:
        """
        ...
        @overload
        @classmethod
        def make(cls, s: str) -> Union[Genai.Prompt.TestConfig]:
        """
        Construct an instance of this type from the string. This is an alias for #fromString, as a specific overload
        when the argument is a known string.
        ...
        @overload
        @classmethod
        def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> Genai.Prompt.TestConfig:
        """
        Construct instance of this type from provided field values and options
        """
            ...
        @overload
        @classmethod
        def make(cls, withDefaults: bool=None) -> Genai.Prompt.TestConfig:
        """
        Construct an instance of this type with no non-default field values unless explicitly specified by passing param true
        @param withDefaults
                   If set, then the Obj is made with default & initial values (required primitive fields e.g. !int32 -> 0)
        ...
        @overload
        @classmethod
        def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> Genai.Prompt.TestConfig:
        """
        Construct an instance from provided fields
        @param fields
                   Fields (in the format <field_name, value>) to construct an instance of the obj. Note that "type" as a
        ...
        @overload
        @classmethod
        def make(cls, fields: Any, withDefaults: bool=None) -> Genai.Prompt.TestConfig:
        """
        Construct an instance of this type from provided fields. Note it is more efficient to use #fromFields and other overloads
        ...
        """
            ...
        @classmethod
        def fromJson(cls, json: any) -> Union[Genai.Prompt.TestConfig]:
        """
        Load the JSON-based representation and reconstruct the corresponding object.
        ...
        """
            ...
        @classmethod
        def fromJsonString(cls, json: str) -> Union[Genai.Prompt.TestConfig]:
        """
        Load the JSON-based representation and reconstruct the corresponding object.
        ...
        """
            ...
        @classmethod
        def fromXmlString(cls, xml: str) -> Union[Genai.Prompt.TestConfig]:
        """
        Load the XML-based representation and reconstruct the corresponding object.
        ...
        """
            ...
        @classmethod
        def deserialize(cls, contentStr: str, contentType: str) -> Union[Genai.Prompt.TestConfig]:
        """
        Load from contentType representation and reconstruct the corresponding object.
        ...
        """
            ...
        def replaceType(self, old: Type, new: Type) -> Genai.Prompt.TestConfig:
        """
        Returns new instance with all references to old type, including result of #type, replaced with new type. If new
        type does not contain fields from old or field value types are not convertable then drops the field.
        ...
        """
            ...
        @overload
        def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> Genai.Prompt.TestConfig:
        """
        Result of this function call is a copy of current instance with all non empty fields replaced based on results of
        the `mapper` invocation.
        ...
        """
            ...
        @overload
        def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> Genai.Prompt.TestConfig:
        """
        Result of this function call is a copy of current instance with all fields replaced based on results of the
        `mapper` invocation.
        ...
        """
            ...
        @overload
        def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[Genai.Prompt.TestConfig]:
        """
        Result of this function call is a copy of current instance with all non empty fields replaced based on results of
        the asynchronous `mapper` invocation.
        ...
        """
            ...
        @overload
        def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[Genai.Prompt.TestConfig]:
        """
        Result of this function call is a copy of current instance with all fields replaced based on results of the
        asynchronous `mapper` invocation.
        ...
        """
            ...
        def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> Genai.Prompt.TestConfig:
        """
        Result of this function call is a copy of current instance with specified field value replaced based on result of
        the `mapper` invocation.
        @param field
        ...
        """
            ...
        @overload
        def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> Genai.Prompt.TestConfig:
        """
        Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
        lambda application.
        ...
        """
            ...
        @overload
        def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> Genai.Prompt.TestConfig:
        """
        Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
        lambda application.
        ...
        """
            ...
        @overload
        def validateObj(self) -> Genai.Prompt.TestConfig:
        """
        Populates all missing default values and throws error if any constraint is violated.
        """
            ...
        ...
        """
            ...
        @overload
        def withField(self, field: str, value: Any, doNotConvert: bool=None) -> Genai.Prompt.TestConfig:
        """
        Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
        defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
        ...
        """
            ...
        @overload
        def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> Genai.Prompt.TestConfig:
        """
        Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
        defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
        ...
        """
            ...
        def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> Genai.Prompt.TestConfig:
        """
        Builds a new Obj instance by adding the provided fields in it. The name must correspond to an existing fields
        defined on this type or its mixins. The values must be of the correct type if doNotConvert flag is true.
        ...
        """
            ...
        def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> Genai.Prompt.TestConfig:
        """
        Builds a new Obj with the value at the specified path field. If the field is null, the field #isFieldSet to null.
        If you would like to #unsetField, you should call #withoutFieldAtPath instead.
        ...
        """
            ...
        def withoutFieldAtPath(self, path: str) -> Genai.Prompt.TestConfig:
        """
        Builds a new Obj without the specified path field.
        ...
        """
            ...
        @overload
        def withoutField(self, field: str) -> Genai.Prompt.TestConfig:
        """
        Builds a new Obj, removing the field with the provided name.
        ...
        """
            ...
        @overload
        def withoutField(self, field: FieldType) -> Genai.Prompt.TestConfig:
        """
        Builds a new Obj, removing the field with the provided field type.
        ...
        """
            ...
        def withoutFields(self, fields: Array[str]) -> Genai.Prompt.TestConfig:
        """
        Builds a new Obj, removing the fields with the provided names.
        ...
        """
            ...
        def withoutFieldsByType(self, fields: Array[FieldType]) -> Genai.Prompt.TestConfig:
        """
        Builds a new Obj, removing the fields with the provided field types. Be sure to use the FieldType instance for the
        exact same type as the type of the obj to respect the "ordinal" of the field type
        ...
        """
            ...
        def withoutSecretFields(self) -> Genai.Prompt.TestConfig:
        """
        @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
        """
            ...
        def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> Genai.Prompt.TestConfig:
        """
        Builds a new Obj instance by adding the default values (if defined) for all unset fields. This is implemented by
        calling {@link FieldType#defaultValue defaultValue} for a field if it is not already set and
        {@link FieldType#hasDefault has a default}. It will also set {@see ValueType#initialValue initial values} for
        ...
        """
            ...
        @overload
        def defaultField(self, field: str) -> Genai.Prompt.TestConfig:
        """
        Builds a new Obj, by setting a field on this `Obj` to the field's default value. If the field has no default, this
        method will behave the same as {@link #unsetField}.
        ...
        """
            ...
        @overload
        def defaultField(self, field: FieldType) -> Genai.Prompt.TestConfig:
        """
        Builds a new Obj, by setting a field on this `Obj` to the fields default value. If the field has no default, this
        method will behave the same as {@link #unsetField}.
        ...
        """
            ...
        @overload
        def unsetField(self, field: str) -> Genai.Prompt.TestConfig:
        """
        Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
        is different from {@link removeField}
        ...
        """
            ...
        @overload
        def unsetField(self, field: FieldType) -> Genai.Prompt.TestConfig:
        """
        Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
        is different from {@link removeField}
        ...
        """
            ...
        @overload
        def removeField(self, field: str) -> Genai.Prompt.TestConfig:
        """
        Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
        is different from {@link #unsetField}
        ...
        """
            ...
        @overload
        def removeField(self, field: FieldType) -> Genai.Prompt.TestConfig:
        """
        Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
        is different from {@link #unsetField}
        ...
        """
            ...
        @overload
        def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> Genai.Prompt.TestConfig:
        """
        Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
        In case of conflicts, fields of other instance take precedence unless otherwise specified by the fieldPathMergeSpec
        ...
        """
            ...
        @overload
        def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> Genai.Prompt.TestConfig:
        """
        Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
        In case of conflicts, fields of other instance take precedence.
        ...
        """
            ...
        @overload
        def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> Genai.Prompt.TestConfig:
        """
        Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
        fields that exist on other Obj and do not exist on this Obj will not be added to final Obj.
        @param deep
        ...
        """
            ...
        @overload
        def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> Genai.Prompt.TestConfig:
        """
        Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
        fields that exist other Obj and do not exist on this Obj will not be added to final Obj or evaluated. Does not
        traverse child reference and collection fields.
        ...
        """
            ...
        def mergeJson(self, json: any) -> Genai.Prompt.TestConfig:
            ...
        def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> Genai.Prompt.TestConfig:
        """
        Merge the obj references within the current obj
        @param deep
               If set, traverses the reference fields within the obj as well for a deep merge
        ...
        """
            ...
        def sumObj(self, other: Obj, deep: bool=None) -> Genai.Prompt.TestConfig:
        """
        Adds the numeric Obj fields with the other Objs respective fields.
        If deep is set it will traverse reference and collection fields and sum corresponding numeric fields in
        references with same name and collection elements at same index or key.
        """
            ...
        def singletonArray(self) -> Array[Genai.Prompt.TestConfig]:
        """
        Build an array of the correct type with a single element which is this instance.
        ...
        """
            ...
        @classmethod
        def array(cls, *elements: Array[Any]) -> Union[Array[Genai.Prompt.TestConfig]]:
        """
        Creates an array of instances of this type.
        """
            ...
        @classmethod
        def arrayBuilder(cls) -> Union[ArrayBuilder[Genai.Prompt.TestConfig]]:
        """
        Creates an array of instances of this type.
        """
            ...
        def singletonSet(self) -> Set[Genai.Prompt.TestConfig]:
        """
        Build an set of the correct type with a single element which is this instance.
        ...
        """
            ...
        @classmethod
        def setBuilder(cls) -> Union[SetBuilder[Genai.Prompt.TestConfig]]:
        """
        Creates a set of instances of this type.
        """
            ...
        @classmethod
        def mapBuilder(cls) -> Union[MapBuilder[str, Genai.Prompt.TestConfig]]:
        """
        Create a map of string to elements of this type.
        """
            ...
        @classmethod
        def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, Genai.Prompt.TestConfig]]:
        """
        Create a map with the given key type and elements of this type.
        """
            ...
        ...
        def myStreamType(cls) -> StreamType:
            ...
        def toBuilder(self) -> ObjBuilder[Genai.Prompt.TestConfig]:
        """
        @return new ObjBuilder with initial state set to fields of this instance.
        """
            ...
        @classmethod
        def builder(cls) -> ObjBuilder[Genai.Prompt.TestConfig]:
        """
        @return new ObjBuilder of this instance.
        """
            ...
        @overload
        @classmethod
        def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> Genai.Prompt.TestConfig:
        """
        Construct instance of this type from provided field values and options
        """
            ...
        @overload
        @classmethod
        def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> Genai.Prompt.TestConfig:
        """
        Construct an instance of this type from provided fields
        @param fields
                   Fields to construct the instance of the obj with
        ...
        """
            ...
        @classmethod
        def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> Genai.Prompt.TestConfig:
        """
        Construct an instance of this type from provided instance of a subtype or a "duck type".
        """
            ...
        ...
        """
            ...
        def afterMake(self) -> Genai.Prompt.TestConfig:
        """
        Optional override that will be called after every instance creation.
        ...
        """
            ...
        @classmethod
        def cachedEmptyInst(cls) -> Genai.Prompt.TestConfig:
        """
        Creates an empty inst using `MyType.make()` and caches it. Avoid recreating multiple copies of the spec for
        every action dispatch. The cached inst can also be used for comparing whether the object is an empty or not
        Will only create empty instance for immutable Obj e.g. if an Obj is Mutable, this method will throw an error
        ...
        """
            ...
        @classmethod
        def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[Genai.Prompt.TestConfig]]:
        """
        Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
        value is read.
        """
            ...
        @classmethod
        def generateObj(cls, spec: Obj.GenerateSpec=None) -> Genai.Prompt.TestConfig:
        """
        Generate a single instance of this type. The base implementation uses {@link DataGenObj} to generate uniform
        random (gibberish) values for all fields, but it may be overridden by specific types with custom logic that
        populates fields in a more realistic way.
        ...
        """
            ...
        @classmethod
        def forId(cls, id: str, failIfMissing: bool=None) -> Union[Genai.Prompt.TestConfig]:
        """
        @return single instance of this Identified type by id.
        """
            ...
        ...
        """
            ...
        @classmethod
        def allCached(cls) -> Union[Stream[Genai.Prompt.TestConfig]]:
        """
        @return stream of all available Cached instances.
        """
            ...
        @classmethod
        def find(cls, filter: str=None) -> Union[Stream[Genai.Prompt.TestConfig]]:
        """
        ...
        """
            ...
        @classmethod
        def findBy(cls, field: str, value: Any) -> Union[Stream[Genai.Prompt.TestConfig]]:
        """
        @return existing instances of this type that satisfy filter from data cache. Will call `produceAll`
                if cache is empty or if Ann.cache.all is true & data has not previously been fetched.
                Otherwise no population will be performed.
        """
            ...
        def getCached(self) -> Union[Genai.Prompt.TestConfig]:
        """
        @return cached instance.
        """
            ...
        @classmethod
        def forCacheKey(cls, key: str) -> Union[Genai.Prompt.TestConfig]:
        """
        ...
        """
            ...
        @classmethod
        def produce(cls, key: str) -> Union[Genai.Prompt.TestConfig]:
        """
        Should produce an entry for the cache key. This method should not be called directly.
        """
            ...
        @classmethod
        def produceAll(cls) -> Union[Map[str, Genai.Prompt.TestConfig]]:
        """
        ...
        """
            ...
        def getConfig(self) -> Genai.Prompt.TestConfig:
        """
        ...
        """
            ...
        def getSecret(self) -> Genai.Prompt.TestConfig:
        """
        ...
        """
            ...
        def withConfigKey(self, configKey: str) -> Genai.Prompt.TestConfig:
        """
        ...
        """
            ...
        def withoutConfigKey(self) -> Genai.Prompt.TestConfig:
        """
        @return copy without config key.
        """
            ...
        @classmethod
        def forConfigKey(cls, configKey: str) -> Union[Genai.Prompt.TestConfig]:
        """
        ...
        """
            ...
        @classmethod
        def listConfigs(cls, parallel: bool=None, filter: Callable[[str], bool]=None) -> Union[Stream[Genai.Prompt.TestConfig]]:
        """
        @param
        ...
        """
            ...
        @overload
        def setConfigValues(self, from_: Genai.Prompt.TestConfig, override: str=None) -> None:
        """
        ...
        """
            ...
        @classmethod
        def loadConfigAndSecret(cls, configKey: str) -> Union[Genai.Prompt.TestConfig]:
        """
        ...
        """
            ...
        def removeSecrets(self) -> Union[Genai.Prompt.TestConfig]:
        """
        @return this config without any secret values.
        """
            ...
        def removeNonSecrets(self) -> Union[Genai.Prompt.TestConfig]:
        """
        @return this config with only secret values.
        """
            ...
        def validate(self) -> Genai.Prompt.TestConfig:
        """
