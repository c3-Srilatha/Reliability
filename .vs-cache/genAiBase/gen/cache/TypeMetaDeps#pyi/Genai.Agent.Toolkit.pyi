...
# Python definitions for the C3 type Genai.Agent.Toolkit


class Toolkit(Named, Config):
    """
    ...
    tools: Optional[Array[Genai.Agent.Tool[Any]]]
    """
    The {@link Genai.Agent.Tool} that are available as part of this toolkit.
    """

    toolkits: Optional[Array[Genai.Agent.Toolkit]]=None
    """
    The child toolkits part of this toolkit. Including a toolkit makes all of that toolkits tools
    available to this toolkit.
    """
    def __init__(self, name: Optional[str]=None, configOverride: Optional[str]=None, secretOverride: Optional[str]=None, issues: Optional[Array[str]]=None, description: Optional[str]=None, tools: Optional[Array[Genai.Agent.Tool[Any]]]=None, toolkits: Optional[Array[Genai.Agent.Toolkit]]=None) -> None: ...
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[Genai.Agent.Toolkit]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[Genai.Agent.Toolkit]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[Genai.Agent.Toolkit]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[Genai.Agent.Toolkit]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> Genai.Agent.Toolkit:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> Genai.Agent.Toolkit:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> Genai.Agent.Toolkit:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[Genai.Agent.Toolkit]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[Genai.Agent.Toolkit]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> Genai.Agent.Toolkit:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> Genai.Agent.Toolkit:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> Genai.Agent.Toolkit:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> Genai.Agent.Toolkit:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> Genai.Agent.Toolkit:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> Genai.Agent.Toolkit:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> Genai.Agent.Toolkit:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> Genai.Agent.Toolkit:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> Genai.Agent.Toolkit:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> Genai.Agent.Toolkit:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> Genai.Agent.Toolkit:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> Genai.Agent.Toolkit:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> Genai.Agent.Toolkit:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> Genai.Agent.Toolkit:
    """
    @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> Genai.Agent.Toolkit:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> Genai.Agent.Toolkit:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> Genai.Agent.Toolkit:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> Genai.Agent.Toolkit:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> Genai.Agent.Toolkit:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> Genai.Agent.Toolkit:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> Genai.Agent.Toolkit:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> Genai.Agent.Toolkit:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> Genai.Agent.Toolkit:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> Genai.Agent.Toolkit:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> Genai.Agent.Toolkit:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> Genai.Agent.Toolkit:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> Genai.Agent.Toolkit:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> Genai.Agent.Toolkit:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[Genai.Agent.Toolkit]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[Genai.Agent.Toolkit]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[Genai.Agent.Toolkit]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[Genai.Agent.Toolkit]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[Genai.Agent.Toolkit]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, Genai.Agent.Toolkit]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, Genai.Agent.Toolkit]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[Genai.Agent.Toolkit]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[Genai.Agent.Toolkit]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> Genai.Agent.Toolkit:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> Genai.Agent.Toolkit:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> Genai.Agent.Toolkit:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> Genai.Agent.Toolkit:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> Genai.Agent.Toolkit:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> Genai.Agent.Toolkit:
    """
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[Genai.Agent.Toolkit]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> Genai.Agent.Toolkit:
    """
    ...
    """
        ...
    def afterMake(self) -> Genai.Agent.Toolkit:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> Genai.Agent.Toolkit:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[Genai.Agent.Toolkit]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> Genai.Agent.Toolkit:
    """
    ...
    """
        ...
    @classmethod
    def fromString(cls, s: str) -> Union[Genai.Agent.Toolkit]:
    """
    ...
    """
        ...
    @classmethod
    def forName(cls, name: str, failIfMissing: bool=None) -> Union[Genai.Agent.Toolkit]:
    """
    ...
    """
        ...
    @classmethod
    def allCached(cls) -> Union[Stream[Genai.Agent.Toolkit]]:
    """
    @return stream of all available Cached instances.
    """
        ...
    @classmethod
    def find(cls, filter: str=None) -> Union[Stream[Genai.Agent.Toolkit]]:
    """
    ...
    """
        ...
    @classmethod
    def findBy(cls, field: str, value: Any) -> Union[Stream[Genai.Agent.Toolkit]]:
    """
    @return existing instances of this type that satisfy filter from data cache. Will call `produceAll`
            if cache is empty or if Ann.cache.all is true & data has not previously been fetched.
            Otherwise no population will be performed.
    """
        ...
    def getCached(self) -> Union[Genai.Agent.Toolkit]:
    """
    @return cached instance.
    """
        ...
    @classmethod
    def forCacheKey(cls, key: str) -> Union[Genai.Agent.Toolkit]:
    """
    ...
    """
        ...
    @classmethod
    def produce(cls, key: str) -> Union[Genai.Agent.Toolkit]:
    """
    Should produce an entry for the cache key. This method should not be called directly.
    """
        ...
    @classmethod
    def produceAll(cls) -> Union[Map[str, Genai.Agent.Toolkit]]:
    """
    ...
    """
        ...
    def getConfig(self) -> Genai.Agent.Toolkit:
    """
    ...
    """
        ...
    def getSecret(self) -> Genai.Agent.Toolkit:
    """
    ...
    """
        ...
    def withConfigKey(self, configKey: str) -> Genai.Agent.Toolkit:
    """
    ...
    """
        ...
    def withoutConfigKey(self) -> Genai.Agent.Toolkit:
    """
    @return copy without config key.
    """
        ...
    @classmethod
    def forConfigKey(cls, configKey: str) -> Union[Genai.Agent.Toolkit]:
    """
    ...
    """
        ...
    @classmethod
    def listConfigs(cls, parallel: bool=None, filter: Callable[[str], bool]=None) -> Union[Stream[Genai.Agent.Toolkit]]:
    """
    @param
    ...
    """
        ...
    @overload
    def setConfigValues(self, from_: Genai.Agent.Toolkit, override: str=None) -> None:
    """
    ...
    """
        ...
    @classmethod
    def loadConfigAndSecret(cls, configKey: str) -> Union[Genai.Agent.Toolkit]:
    """
    ...
    """
        ...
    def removeSecrets(self) -> Union[Genai.Agent.Toolkit]:
    """
    @return this config without any secret values.
    """
        ...
    def removeNonSecrets(self) -> Union[Genai.Agent.Toolkit]:
    """
    @return this config with only secret values.
    """
        ...
    def validate(self) -> Genai.Agent.Toolkit:
    """
    ...
    """
        ...
    def descriptionForAgent(self) -> Union[Array[Genai.Agent.Tool.Description]]:
    """
    Generate string representation of the toolkit by concatenating descriptions of individual tools.
    """
        ...
    def allTools(self) -> Array[Genai.Agent.Tool[Any]]:
    """
