...
from c3.genAiBase.Genai.Query.Result.Source.AbstractSourceType import Genai.Query.Result.Source.AbstractSourceType
...
# Python definitions for the C3 type Genai.Query.ResultToSourceRelation


class ResultToSourceRelation(Genai.Query.Result.Relation):
    """
    Represents a relation between a query result and a source that was used to generate that result. This relation type
    allows for a many-to-many relationship between query results and sources and offers a many (source relations)
    -to-one (query result) solution for source information that's specific to a single query. Information specific to the
    current query should be added to this record, while common source information should be added to the source record
    linked in #to.
    
    @remarks this represents a made instance of Genai.Query.ResultToSourceRelation
    """
    ...
    to: Optional[Genai.Query.Result.Source.AbstractSourceType]
    """
    The source that was used to generate the query result.
    """
    ...
    source in the UI.
    """
    def __init__(self, typeIdent: Optional[str]=None, id: Optional[str]=None, versionEdits: Optional[Array[VersionEdit]]=None, name: Optional[str]=None, meta: Optional[Meta]=None, version: Optional[int]=None, typeWithBindings: Optional[Type]=None, from: Optional[Genai.Query.Result]=None, fromStep: Optional[Genai.Agent.DynamicTrajectory.Step]=None, to: Optional[Genai.Query.Result.Source.AbstractSourceType]=None, passageUiDisplayIndex: Optional[int]=None, displayName: Optional[str]=None) -> None: ...
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[Genai.Query.ResultToSourceRelation]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[Genai.Query.ResultToSourceRelation]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[Genai.Query.ResultToSourceRelation]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[Genai.Query.ResultToSourceRelation]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> Genai.Query.ResultToSourceRelation:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> Genai.Query.ResultToSourceRelation:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> Genai.Query.ResultToSourceRelation:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[Genai.Query.ResultToSourceRelation]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[Genai.Query.ResultToSourceRelation]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> Genai.Query.ResultToSourceRelation:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> Genai.Query.ResultToSourceRelation:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> Genai.Query.ResultToSourceRelation:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> Genai.Query.ResultToSourceRelation:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> Genai.Query.ResultToSourceRelation:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> Genai.Query.ResultToSourceRelation:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> Genai.Query.ResultToSourceRelation:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> Genai.Query.ResultToSourceRelation:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> Genai.Query.ResultToSourceRelation:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> Genai.Query.ResultToSourceRelation:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> Genai.Query.ResultToSourceRelation:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> Genai.Query.ResultToSourceRelation:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> Genai.Query.ResultToSourceRelation:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> Genai.Query.ResultToSourceRelation:
    """
    @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> Genai.Query.ResultToSourceRelation:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> Genai.Query.ResultToSourceRelation:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> Genai.Query.ResultToSourceRelation:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> Genai.Query.ResultToSourceRelation:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> Genai.Query.ResultToSourceRelation:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> Genai.Query.ResultToSourceRelation:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> Genai.Query.ResultToSourceRelation:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> Genai.Query.ResultToSourceRelation:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> Genai.Query.ResultToSourceRelation:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> Genai.Query.ResultToSourceRelation:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> Genai.Query.ResultToSourceRelation:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> Genai.Query.ResultToSourceRelation:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> Genai.Query.ResultToSourceRelation:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> Genai.Query.ResultToSourceRelation:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[Genai.Query.ResultToSourceRelation]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[Genai.Query.ResultToSourceRelation]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[Genai.Query.ResultToSourceRelation]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[Genai.Query.ResultToSourceRelation]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[Genai.Query.ResultToSourceRelation]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, Genai.Query.ResultToSourceRelation]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, Genai.Query.ResultToSourceRelation]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[Genai.Query.ResultToSourceRelation]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[Genai.Query.ResultToSourceRelation]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> Genai.Query.ResultToSourceRelation:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> Genai.Query.ResultToSourceRelation:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> Genai.Query.ResultToSourceRelation:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> Genai.Query.ResultToSourceRelation:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> Genai.Query.ResultToSourceRelation:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> Genai.Query.ResultToSourceRelation:
    """
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[Genai.Query.ResultToSourceRelation]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> Genai.Query.ResultToSourceRelation:
    """
    ...
    """
        ...
    def afterMake(self) -> Genai.Query.ResultToSourceRelation:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> Genai.Query.ResultToSourceRelation:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[Genai.Query.ResultToSourceRelation]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> Genai.Query.ResultToSourceRelation:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, spec: FetchSpec=None) -> FetchResult[Genai.Query.ResultToSourceRelation]:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, filter: Filter) -> FetchResult[Genai.Query.ResultToSourceRelation]:
    """
    ...
    """
        ...
    @classmethod
    def fetchObjStream(cls, spec: FetchStreamSpec=None) -> Union[Stream[Genai.Query.ResultToSourceRelation]]:
    """
    Fetches multiple obj instances based on a specification.  Only objs that the caller is authorized to fetch will be
    returned.
    ...
    """
        ...
    @classmethod
    def fetchMultiLocale(cls, spec: MultiLocaleFetchSpec=None) -> Union[Map[str, FetchResult[Genai.Query.ResultToSourceRelation]]]:
    """
    ...
    """
        ...
    def get(self, include: str=None) -> Union[Genai.Query.ResultToSourceRelation]:
    """
    ...
    """
        ...
    def getSpecific(self, include: str=None) -> Union[Genai.Query.ResultToSourceRelation]:
    """
    ...
    """
        ...
    def getMissing(self, spec: GetMissingSpec) -> Genai.Query.ResultToSourceRelation:
    """
    ...
    """
        ...
    def getDirect(self, include: str=None) -> Union[Genai.Query.ResultToSourceRelation]:
    """
    ...
    """
        ...
    def applyReverseEdit(self, versionEdit: VersionEdit) -> Genai.Query.ResultToSourceRelation:
    """
    ...
    """
        ...
    @classmethod
    def fromString(cls, s: str) -> Union[Genai.Query.ResultToSourceRelation]:
    """
    ...
    """
        ...
    def create(self, spec: UpsertSpec=None) -> Union[Genai.Query.ResultToSourceRelation]:
    """
    ...
    """
        ...
    @classmethod
    def createBatch(cls, objs: Array[Genai.Query.ResultToSourceRelation], spec: UpsertSpec=None) -> Union[ObjList[Genai.Query.ResultToSourceRelation]]:
    """
    ...
    """
        ...
    @classmethod
    def createBatchObjStream(cls, objs: Stream[Genai.Query.ResultToSourceRelation], spec: CreateBatchObjStreamSpec=None) -> Union[ObjList[Genai.Query.ResultToSourceRelation]]:
    """
    Creates multiple instances of a C3 type. If the operation fails and {@link UpsertSpec#dontThrowOnBatchError} is not
    specified (the default), then a C3BatchException will be thrown.  Otherwise {@link errors will be reported in the
    returned {@link ObjList}.  This will fail if any of the instances already exist.
    ...
    """
        ...
    def update(self, srcObj: Genai.Query.ResultToSourceRelation=None, spec: UpsertSpec=None) -> Union[Genai.Query.ResultToSourceRelation]:
    """
    ...
    """
        ...
    def upsert(self, srcObj: Genai.Query.ResultToSourceRelation=None, spec: UpsertSpec=None) -> Union[Genai.Query.ResultToSourceRelation]:
    """
    ...
    """
        ...
    @overload
    def merge(self, spec: MergeSpec=None) -> Union[Genai.Query.ResultToSourceRelation]:
    """
    ...
    """
        ...
    @overload
    def merge(self, mergeInclude: str, spec: MergeSpec=None) -> Union[Genai.Query.ResultToSourceRelation]:
    """
    ...
    """
        ...
    def touch(self, spec: TouchSpec=None) -> Union[Genai.Query.ResultToSourceRelation]:
    """
    ...
    """
        ...
    @classmethod
    def updateBatch(cls, objs: Array[Genai.Query.ResultToSourceRelation], srcObjs: Array[Genai.Query.ResultToSourceRelation]=None, spec: UpsertSpec=None) -> Union[ObjList[Genai.Query.ResultToSourceRelation]]:
    """
    ...
    """
        ...
    @classmethod
    def updateObjs(cls, objs: Callable[[], Union[Array[Genai.Query.ResultToSourceRelation]]], spec: UpsertSpec=None) -> Union[ObjList[Genai.Query.ResultToSourceRelation]]:
    """
    ...
    """
        ...
    @classmethod
    def upsertBatch(cls, objs: Array[Genai.Query.ResultToSourceRelation], srcObjs: Array[Genai.Query.ResultToSourceRelation]=None, spec: UpsertSpec=None) -> Union[ObjList[Genai.Query.ResultToSourceRelation]]:
    """
    ...
    """
        ...
    @classmethod
    def upsertObjs(cls, objs: Callable[[], Union[Array[Genai.Query.ResultToSourceRelation]]], spec: UpsertSpec=None) -> Union[ObjList[Genai.Query.ResultToSourceRelation]]:
    """
    Creates instances of a C3 type if they don't already exist and updates them if they do exist. If the operation
    ...
    """
        ...
    @classmethod
    def touchBatch(cls, objs: Array[Genai.Query.ResultToSourceRelation], spec: TouchSpec=None) -> Union[ObjList[Genai.Query.ResultToSourceRelation]]:
    """
    ...
    @overload
    @classmethod
    def mergeBatch(cls, objs: Array[Genai.Query.ResultToSourceRelation], spec: MergeSpec=None) -> Union[ObjList[Genai.Query.ResultToSourceRelation]]:
    """
    ...
    @overload
    @classmethod
    def mergeBatch(cls, objs: Array[Genai.Query.ResultToSourceRelation], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[Genai.Query.ResultToSourceRelation]]:
    """
    Merges multiple instances of a C3 type or creates them if they don't exist. If the operation fails and {@link
    UpsertSpec#dontThrowOnBatchError} is not specified (the default), then a C3BatchException will be thrown.
    Otherwise errors will be reported in the returned {@link ObjList}.  The merge operation is described in the {@link
    ...
    """
        ...
    @classmethod
    def mergeObjs(cls, objs: Callable[[], Union[Array[Genai.Query.ResultToSourceRelation]]], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[Genai.Query.ResultToSourceRelation]]:
    """
    ...
    @overload
    @classmethod
    def mergeAll(cls, mergeObj: Genai.Query.ResultToSourceRelation, spec: MergeAllSpec=None) -> Union[int]:
    """
    ...
    @overload
    @classmethod
    def mergeAll(cls, mergeObj: Genai.Query.ResultToSourceRelation, mergeInclude: str, spec: MergeAllSpec=None) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def removeBatch(cls, objs: Array[Genai.Query.ResultToSourceRelation], spec: UpsertSpec=None) -> Union[ObjList[Genai.Query.ResultToSourceRelation]]:
    """
    ...
    """
        ...
    @classmethod
    def replace(cls, objs: Array[Genai.Query.ResultToSourceRelation], spec: UpsertSpec=None) -> Union[ObjList[Genai.Query.ResultToSourceRelation]]:
    """
    ...
    """
        ...
    def unremove(self) -> Union[Genai.Query.ResultToSourceRelation]:
    """
    ...
    """
        ...
    @classmethod
    def beforeCreate(cls, objs: Array[Genai.Query.ResultToSourceRelation]) -> ObjList[Genai.Query.ResultToSourceRelation]:
    """
    ...
    """
        ...
    @classmethod
    def beforeUpdate(cls, objs: Array[Genai.Query.ResultToSourceRelation]) -> ObjList[Genai.Query.ResultToSourceRelation]:
    """
    ...
    """
        ...
    @classmethod
    def beforeRemove(cls, objs: Array[Genai.Query.ResultToSourceRelation]) -> ObjList[Genai.Query.ResultToSourceRelation]:
    """
    ...
    """
        ...
    @classmethod
    def afterCreate(cls, objs: Array[Genai.Query.ResultToSourceRelation]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def afterUpdate(cls, objs: Array[Genai.Query.ResultToSourceRelation]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def afterRemove(cls, objs: Array[Genai.Query.ResultToSourceRelation]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def startImportData(cls, spec: StartImportDataSpec=None) -> PushStream[Genai.Query.ResultToSourceRelation]:
    """
    @return a push stream to import instances of this type.
    """
        ...
    @classmethod
    def startImportDataWithStats(cls, spec: StartImportDataSpec=None) -> PushStreamWithStats[Genai.Query.ResultToSourceRelation]:
    """
    @return a push stream to import instances of this type.
    """
        ...
    ...
    """
        ...
    @classmethod
    def forId(cls, id: str, failIfMissing: bool=None) -> Union[Genai.Query.ResultToSourceRelation]:
    """
    ...
    """
        ...
    def withoutIdentity(self) -> Union[Genai.Query.ResultToSourceRelation]:
    """
    ...
    """
        ...
    @classmethod
    def typeOfBatch(cls, objs: Array[Genai.Query.ResultToSourceRelation]) -> Union[Array[EntityType]]:
    """
    ...
    """
        ...
    @classmethod
    def dbEcho(cls, template: Genai.Query.ResultToSourceRelation=None, count: int=None, sendBack: bool=None) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def callbackLogic(cls, objs: Array[Genai.Query.ResultToSourceRelation], callback: Callable[[Union[Genai.Query.ResultToSourceRelation]], Union[Genai.Query.ResultToSourceRelation]]=None) -> ObjList[Genai.Query.ResultToSourceRelation]:
    """
    ...
    """
        ...
    @classmethod
    def afterCallbackLogic(cls, objs: Array[Genai.Query.ResultToSourceRelation], callback: Callable[[Union[Genai.Query.ResultToSourceRelation]], Union[Genai.Query.ResultToSourceRelation]]=None) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def cloneTo(cls, srcResult: Genai.Query.Result, destResult: Genai.Query.Result) -> Array[Genai.Query.ResultToSourceRelation]:
    """
    ...
    """
        ...
    @classmethod
    def cloneRelationsToParent(cls, queryResult: Genai.Query.Result) -> Union[Array[Genai.Query.ResultToSourceRelation]]:
    """
    ...
    """
        ...
    @classmethod
    def relationsForParent(cls, queryResult: Genai.Query.Result) -> Union[Array[Genai.Query.ResultToSourceRelation]]:
    """
