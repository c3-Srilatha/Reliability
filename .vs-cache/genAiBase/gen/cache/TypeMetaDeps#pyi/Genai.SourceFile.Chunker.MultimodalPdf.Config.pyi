...
from c3.genAiBase.Genai.SourceFile.Chunker.MultimodalPdf.TableParserSpec import Genai.SourceFile.Chunker.MultimodalPdf.TableParserSpec
from c3.platform.SetBuilder import SetBuilder
from c3.platform.Type import Type
from c3.platform.Promise import Promise
from c3.genAiBase.Genai.SourceFile.Chunker.MultimodalPdf.LayoutParserSpec import Genai.SourceFile.Chunker.MultimodalPdf.LayoutParserSpec
from c3.platform.Obj import Obj
from c3.platform.ValueType import ValueType
from c3.platform.ValueSpec import ValueSpec
from c3.platform.Obj.GenerateSpec import Obj.GenerateSpec
from c3.genAiBase.Genai.SourceFile.Chunker.MultimodalPdf.TextParserSpec import Genai.SourceFile.Chunker.MultimodalPdf.TextParserSpec
from c3.platform.Data import Data
from c3.platform.SetBuilder import SetBuilder
from c3.platform.Expr.CompileOptions import Expr.CompileOptions
from c3.platform.ArrayBuilder import ArrayBuilder
from c3.platform.FieldValue import FieldValue
from c3.genAiBase.Genai.SourceFile.Chunker.MultimodalPdf.ImageParserSpec import Genai.SourceFile.Chunker.MultimodalPdf.ImageParserSpec
...
# Python definitions for the C3 type Genai.SourceFile.Chunker.MultimodalPdf.Config
...
class Config(Singleton, Config):
    ...
    textParserSpec: Optional[Genai.SourceFile.Chunker.MultimodalPdf.TextParserSpec]
    """
    Defines the text parser spec
    """

    imageParserSpec: Optional[Genai.SourceFile.Chunker.MultimodalPdf.ImageParserSpec]=None
    """
    ...
    tableParserSpec: Optional[Genai.SourceFile.Chunker.MultimodalPdf.TableParserSpec]=None
    """
    ...
    layoutParserSpec: Optional[Genai.SourceFile.Chunker.MultimodalPdf.LayoutParserSpec]
    """
    Defines the layout parser spec
    """

    enableLayoutParser: Optional[bool]=None
    """
    Enable the layout parser
    """

    disableImageParser: Optional[bool]=None
    """
    Disable the Image parser (default: False). If set to True, then the image parsing will be skipped.
    """

    disableTableParser: Optional[bool]=None
    """
    Disable the Table parser (default: False). If set to True, then the table parsing will be skipped.
    """
    def __init__(self, configOverride: Optional[str]=None, secretOverride: Optional[str]=None, issues: Optional[Array[str]]=None, textParserSpec: Optional[Genai.SourceFile.Chunker.MultimodalPdf.TextParserSpec]=None, imageParserSpec: Optional[Genai.SourceFile.Chunker.MultimodalPdf.ImageParserSpec]=None, tableParserSpec: Optional[Genai.SourceFile.Chunker.MultimodalPdf.TableParserSpec]=None, layoutParserSpec: Optional[Genai.SourceFile.Chunker.MultimodalPdf.LayoutParserSpec]=None, enableLayoutParser: Optional[bool]=None, disableImageParser: Optional[bool]=None, disableTableParser: Optional[bool]=None) -> None: ...

    @classmethod
    def inst(cls) -> Genai.SourceFile.Chunker.MultimodalPdf.Config:
    """
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[Genai.SourceFile.Chunker.MultimodalPdf.Config]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[Genai.SourceFile.Chunker.MultimodalPdf.Config]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[Genai.SourceFile.Chunker.MultimodalPdf.Config]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[Genai.SourceFile.Chunker.MultimodalPdf.Config]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> Genai.SourceFile.Chunker.MultimodalPdf.Config:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> Genai.SourceFile.Chunker.MultimodalPdf.Config:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> Genai.SourceFile.Chunker.MultimodalPdf.Config:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[Genai.SourceFile.Chunker.MultimodalPdf.Config]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[Genai.SourceFile.Chunker.MultimodalPdf.Config]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> Genai.SourceFile.Chunker.MultimodalPdf.Config:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> Genai.SourceFile.Chunker.MultimodalPdf.Config:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> Genai.SourceFile.Chunker.MultimodalPdf.Config:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> Genai.SourceFile.Chunker.MultimodalPdf.Config:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> Genai.SourceFile.Chunker.MultimodalPdf.Config:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> Genai.SourceFile.Chunker.MultimodalPdf.Config:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> Genai.SourceFile.Chunker.MultimodalPdf.Config:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> Genai.SourceFile.Chunker.MultimodalPdf.Config:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> Genai.SourceFile.Chunker.MultimodalPdf.Config:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> Genai.SourceFile.Chunker.MultimodalPdf.Config:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> Genai.SourceFile.Chunker.MultimodalPdf.Config:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> Genai.SourceFile.Chunker.MultimodalPdf.Config:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> Genai.SourceFile.Chunker.MultimodalPdf.Config:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> Genai.SourceFile.Chunker.MultimodalPdf.Config:
    """
    @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> Genai.SourceFile.Chunker.MultimodalPdf.Config:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> Genai.SourceFile.Chunker.MultimodalPdf.Config:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> Genai.SourceFile.Chunker.MultimodalPdf.Config:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> Genai.SourceFile.Chunker.MultimodalPdf.Config:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> Genai.SourceFile.Chunker.MultimodalPdf.Config:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> Genai.SourceFile.Chunker.MultimodalPdf.Config:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> Genai.SourceFile.Chunker.MultimodalPdf.Config:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> Genai.SourceFile.Chunker.MultimodalPdf.Config:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> Genai.SourceFile.Chunker.MultimodalPdf.Config:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> Genai.SourceFile.Chunker.MultimodalPdf.Config:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> Genai.SourceFile.Chunker.MultimodalPdf.Config:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> Genai.SourceFile.Chunker.MultimodalPdf.Config:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> Genai.SourceFile.Chunker.MultimodalPdf.Config:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> Genai.SourceFile.Chunker.MultimodalPdf.Config:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[Genai.SourceFile.Chunker.MultimodalPdf.Config]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[Genai.SourceFile.Chunker.MultimodalPdf.Config]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[Genai.SourceFile.Chunker.MultimodalPdf.Config]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[Genai.SourceFile.Chunker.MultimodalPdf.Config]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[Genai.SourceFile.Chunker.MultimodalPdf.Config]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, Genai.SourceFile.Chunker.MultimodalPdf.Config]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, Genai.SourceFile.Chunker.MultimodalPdf.Config]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[Genai.SourceFile.Chunker.MultimodalPdf.Config]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[Genai.SourceFile.Chunker.MultimodalPdf.Config]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> Genai.SourceFile.Chunker.MultimodalPdf.Config:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> Genai.SourceFile.Chunker.MultimodalPdf.Config:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> Genai.SourceFile.Chunker.MultimodalPdf.Config:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> Genai.SourceFile.Chunker.MultimodalPdf.Config:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> Genai.SourceFile.Chunker.MultimodalPdf.Config:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> Genai.SourceFile.Chunker.MultimodalPdf.Config:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> Genai.SourceFile.Chunker.MultimodalPdf.Config:
    """
    ...
    """
        ...
    def afterMake(self) -> Genai.SourceFile.Chunker.MultimodalPdf.Config:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> Genai.SourceFile.Chunker.MultimodalPdf.Config:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[Genai.SourceFile.Chunker.MultimodalPdf.Config]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> Genai.SourceFile.Chunker.MultimodalPdf.Config:
    """
    ...
    """
        ...
    @classmethod
    def allCached(cls) -> Union[Stream[Genai.SourceFile.Chunker.MultimodalPdf.Config]]:
    """
    @return stream of all available Cached instances.
    """
        ...
    @classmethod
    def find(cls, filter: str=None) -> Union[Stream[Genai.SourceFile.Chunker.MultimodalPdf.Config]]:
    """
    ...
    """
        ...
    @classmethod
    def findBy(cls, field: str, value: Any) -> Union[Stream[Genai.SourceFile.Chunker.MultimodalPdf.Config]]:
    """
    @return existing instances of this type that satisfy filter from data cache. Will call `produceAll`
            if cache is empty or if Ann.cache.all is true & data has not previously been fetched.
            Otherwise no population will be performed.
    """
        ...
    def getCached(self) -> Union[Genai.SourceFile.Chunker.MultimodalPdf.Config]:
    """
    @return cached instance.
    """
        ...
    @classmethod
    def forCacheKey(cls, key: str) -> Union[Genai.SourceFile.Chunker.MultimodalPdf.Config]:
    """
    ...
    """
        ...
    @classmethod
    def produce(cls, key: str) -> Union[Genai.SourceFile.Chunker.MultimodalPdf.Config]:
    """
    Should produce an entry for the cache key. This method should not be called directly.
    """
        ...
    @classmethod
    def produceAll(cls) -> Union[Map[str, Genai.SourceFile.Chunker.MultimodalPdf.Config]]:
    """
    ...
    """
        ...
    def getConfig(self) -> Genai.SourceFile.Chunker.MultimodalPdf.Config:
    """
    ...
    """
        ...
    def getSecret(self) -> Genai.SourceFile.Chunker.MultimodalPdf.Config:
    """
    ...
    """
        ...
    def withConfigKey(self, configKey: str) -> Genai.SourceFile.Chunker.MultimodalPdf.Config:
    """
    ...
    """
        ...
    def withoutConfigKey(self) -> Genai.SourceFile.Chunker.MultimodalPdf.Config:
    """
    @return copy without config key.
    """
        ...
    @classmethod
    def forConfigKey(cls, configKey: str) -> Union[Genai.SourceFile.Chunker.MultimodalPdf.Config]:
    """
    ...
    """
        ...
    @classmethod
    def listConfigs(cls, parallel: bool=None, filter: Callable[[str], bool]=None) -> Union[Stream[Genai.SourceFile.Chunker.MultimodalPdf.Config]]:
    """
    @param
    ...
    """
        ...
    @overload
    def setConfigValues(self, from_: Genai.SourceFile.Chunker.MultimodalPdf.Config, override: str=None) -> None:
    """
    ...
    """
        ...
    @classmethod
    def loadConfigAndSecret(cls, configKey: str) -> Union[Genai.SourceFile.Chunker.MultimodalPdf.Config]:
    """
    ...
    """
        ...
    def removeSecrets(self) -> Union[Genai.SourceFile.Chunker.MultimodalPdf.Config]:
    """
    @return this config without any secret values.
    """
        ...
    def removeNonSecrets(self) -> Union[Genai.SourceFile.Chunker.MultimodalPdf.Config]:
    """
    @return this config with only secret values.
    """
        ...
    def validate(self) -> Genai.SourceFile.Chunker.MultimodalPdf.Config:
    """
