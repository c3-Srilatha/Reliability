...
# Python definitions for the C3 type Genai.UnstructuredQuery.Engine.REA.SummaryBufferConfig


class SummaryBufferConfig(Genai.UnstructuredQuery.Engine.REA.SummaryConfig):
    """
    ...
    questionPrefix: Optional[str]
    """
    The prefix to be used for the question.
    """

    answerPrefix: Optional[str]
    """
    ...
    summaryBufferPrompt: Optional[str]
    """
    The prompt to be used for the summary buffer for the conversation.
    """
    def __init__(self, name: Optional[str]=None, configOverride: Optional[str]=None, secretOverride: Optional[str]=None, issues: Optional[Array[str]]=None, modelInferenceConfigName: Optional[str]=None, questionPrefix: Optional[str]=None, answerPrefix: Optional[str]=None, bufferSize: Optional[int]=None, summaryBufferPrompt: Optional[str]=None) -> None: ...
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[Genai.UnstructuredQuery.Engine.REA.SummaryBufferConfig]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[Genai.UnstructuredQuery.Engine.REA.SummaryBufferConfig]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[Genai.UnstructuredQuery.Engine.REA.SummaryBufferConfig]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[Genai.UnstructuredQuery.Engine.REA.SummaryBufferConfig]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> Genai.UnstructuredQuery.Engine.REA.SummaryBufferConfig:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> Genai.UnstructuredQuery.Engine.REA.SummaryBufferConfig:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> Genai.UnstructuredQuery.Engine.REA.SummaryBufferConfig:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[Genai.UnstructuredQuery.Engine.REA.SummaryBufferConfig]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[Genai.UnstructuredQuery.Engine.REA.SummaryBufferConfig]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> Genai.UnstructuredQuery.Engine.REA.SummaryBufferConfig:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> Genai.UnstructuredQuery.Engine.REA.SummaryBufferConfig:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> Genai.UnstructuredQuery.Engine.REA.SummaryBufferConfig:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> Genai.UnstructuredQuery.Engine.REA.SummaryBufferConfig:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> Genai.UnstructuredQuery.Engine.REA.SummaryBufferConfig:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> Genai.UnstructuredQuery.Engine.REA.SummaryBufferConfig:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> Genai.UnstructuredQuery.Engine.REA.SummaryBufferConfig:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> Genai.UnstructuredQuery.Engine.REA.SummaryBufferConfig:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> Genai.UnstructuredQuery.Engine.REA.SummaryBufferConfig:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> Genai.UnstructuredQuery.Engine.REA.SummaryBufferConfig:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> Genai.UnstructuredQuery.Engine.REA.SummaryBufferConfig:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> Genai.UnstructuredQuery.Engine.REA.SummaryBufferConfig:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> Genai.UnstructuredQuery.Engine.REA.SummaryBufferConfig:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> Genai.UnstructuredQuery.Engine.REA.SummaryBufferConfig:
    """
    @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> Genai.UnstructuredQuery.Engine.REA.SummaryBufferConfig:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> Genai.UnstructuredQuery.Engine.REA.SummaryBufferConfig:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> Genai.UnstructuredQuery.Engine.REA.SummaryBufferConfig:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> Genai.UnstructuredQuery.Engine.REA.SummaryBufferConfig:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> Genai.UnstructuredQuery.Engine.REA.SummaryBufferConfig:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> Genai.UnstructuredQuery.Engine.REA.SummaryBufferConfig:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> Genai.UnstructuredQuery.Engine.REA.SummaryBufferConfig:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> Genai.UnstructuredQuery.Engine.REA.SummaryBufferConfig:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> Genai.UnstructuredQuery.Engine.REA.SummaryBufferConfig:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> Genai.UnstructuredQuery.Engine.REA.SummaryBufferConfig:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> Genai.UnstructuredQuery.Engine.REA.SummaryBufferConfig:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> Genai.UnstructuredQuery.Engine.REA.SummaryBufferConfig:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> Genai.UnstructuredQuery.Engine.REA.SummaryBufferConfig:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> Genai.UnstructuredQuery.Engine.REA.SummaryBufferConfig:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[Genai.UnstructuredQuery.Engine.REA.SummaryBufferConfig]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[Genai.UnstructuredQuery.Engine.REA.SummaryBufferConfig]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[Genai.UnstructuredQuery.Engine.REA.SummaryBufferConfig]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[Genai.UnstructuredQuery.Engine.REA.SummaryBufferConfig]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[Genai.UnstructuredQuery.Engine.REA.SummaryBufferConfig]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, Genai.UnstructuredQuery.Engine.REA.SummaryBufferConfig]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, Genai.UnstructuredQuery.Engine.REA.SummaryBufferConfig]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[Genai.UnstructuredQuery.Engine.REA.SummaryBufferConfig]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[Genai.UnstructuredQuery.Engine.REA.SummaryBufferConfig]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> Genai.UnstructuredQuery.Engine.REA.SummaryBufferConfig:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> Genai.UnstructuredQuery.Engine.REA.SummaryBufferConfig:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> Genai.UnstructuredQuery.Engine.REA.SummaryBufferConfig:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> Genai.UnstructuredQuery.Engine.REA.SummaryBufferConfig:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> Genai.UnstructuredQuery.Engine.REA.SummaryBufferConfig:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> Genai.UnstructuredQuery.Engine.REA.SummaryBufferConfig:
    """
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[Genai.UnstructuredQuery.Engine.REA.SummaryBufferConfig]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> Genai.UnstructuredQuery.Engine.REA.SummaryBufferConfig:
    """
    ...
    """
        ...
    def afterMake(self) -> Genai.UnstructuredQuery.Engine.REA.SummaryBufferConfig:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> Genai.UnstructuredQuery.Engine.REA.SummaryBufferConfig:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[Genai.UnstructuredQuery.Engine.REA.SummaryBufferConfig]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> Genai.UnstructuredQuery.Engine.REA.SummaryBufferConfig:
    """
    ...
    """
        ...
    @classmethod
    def fromString(cls, s: str) -> Union[Genai.UnstructuredQuery.Engine.REA.SummaryBufferConfig]:
    """
    ...
    """
        ...
    @classmethod
    def forName(cls, name: str, failIfMissing: bool=None) -> Union[Genai.UnstructuredQuery.Engine.REA.SummaryBufferConfig]:
    """
    ...
    """
        ...
    @classmethod
    def allCached(cls) -> Union[Stream[Genai.UnstructuredQuery.Engine.REA.SummaryBufferConfig]]:
    """
    @return stream of all available Cached instances.
    """
        ...
    @classmethod
    def find(cls, filter: str=None) -> Union[Stream[Genai.UnstructuredQuery.Engine.REA.SummaryBufferConfig]]:
    """
    ...
    """
        ...
    @classmethod
    def findBy(cls, field: str, value: Any) -> Union[Stream[Genai.UnstructuredQuery.Engine.REA.SummaryBufferConfig]]:
    """
    @return existing instances of this type that satisfy filter from data cache. Will call `produceAll`
            if cache is empty or if Ann.cache.all is true & data has not previously been fetched.
            Otherwise no population will be performed.
    """
        ...
    def getCached(self) -> Union[Genai.UnstructuredQuery.Engine.REA.SummaryBufferConfig]:
    """
    @return cached instance.
    """
        ...
    @classmethod
    def forCacheKey(cls, key: str) -> Union[Genai.UnstructuredQuery.Engine.REA.SummaryBufferConfig]:
    """
    ...
    """
        ...
    @classmethod
    def produce(cls, key: str) -> Union[Genai.UnstructuredQuery.Engine.REA.SummaryBufferConfig]:
    """
    Should produce an entry for the cache key. This method should not be called directly.
    """
        ...
    @classmethod
    def produceAll(cls) -> Union[Map[str, Genai.UnstructuredQuery.Engine.REA.SummaryBufferConfig]]:
    """
    ...
    """
        ...
    def getConfig(self) -> Genai.UnstructuredQuery.Engine.REA.SummaryBufferConfig:
    """
    ...
    """
        ...
    def getSecret(self) -> Genai.UnstructuredQuery.Engine.REA.SummaryBufferConfig:
    """
    ...
    """
        ...
    def withConfigKey(self, configKey: str) -> Genai.UnstructuredQuery.Engine.REA.SummaryBufferConfig:
    """
    ...
    """
        ...
    def withoutConfigKey(self) -> Genai.UnstructuredQuery.Engine.REA.SummaryBufferConfig:
    """
    @return copy without config key.
    """
        ...
    @classmethod
    def forConfigKey(cls, configKey: str) -> Union[Genai.UnstructuredQuery.Engine.REA.SummaryBufferConfig]:
    """
    ...
    """
        ...
    @classmethod
    def listConfigs(cls, parallel: bool=None, filter: Callable[[str], bool]=None) -> Union[Stream[Genai.UnstructuredQuery.Engine.REA.SummaryBufferConfig]]:
    """
    @param
    ...
    """
        ...
    @overload
    def setConfigValues(self, from_: Genai.UnstructuredQuery.Engine.REA.SummaryBufferConfig, override: str=None) -> None:
    """
    ...
    """
        ...
    @classmethod
    def loadConfigAndSecret(cls, configKey: str) -> Union[Genai.UnstructuredQuery.Engine.REA.SummaryBufferConfig]:
    """
    ...
    """
        ...
    def removeSecrets(self) -> Union[Genai.UnstructuredQuery.Engine.REA.SummaryBufferConfig]:
    """
    @return this config without any secret values.
    """
        ...
    def removeNonSecrets(self) -> Union[Genai.UnstructuredQuery.Engine.REA.SummaryBufferConfig]:
    """
    @return this config with only secret values.
    """
        ...
    def validate(self) -> Genai.UnstructuredQuery.Engine.REA.SummaryBufferConfig:
    """
    ...
    """
        ...
    @classmethod
    def setRecursive(cls, configJson: any, useSetConfigValues: bool=None, override: str=None) -> Genai.UnstructuredQuery.Engine.REA.SummaryBufferConfig:
    """
