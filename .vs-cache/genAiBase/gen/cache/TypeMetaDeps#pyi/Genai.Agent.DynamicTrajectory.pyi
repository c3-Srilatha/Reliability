...
from c3.platform.ObjBuilder import ObjBuilder
from c3.genAiBase.Genai.Query.ResultToSourceFileRelation import Genai.Query.ResultToSourceFileRelation
from c3.platform.Promise import Promise
...
from c3.platform.MapBuilder import MapBuilder
from c3.genAiBase.Genai.Agent.Dynamic.Tool.UiConfig import Genai.Agent.Dynamic.Tool.UiConfig
...
from c3.genAiBase.Genai.Query.ResultToSourceRelation import Genai.Query.ResultToSourceRelation
from c3.platform.PushStream import PushStream
...
# Python definitions for the C3 type Genai.Agent.DynamicTrajectory


class DynamicTrajectory(Genai.Agent.Trajectory):
    """
    Mutable series of steps for answering a user query.
    
    @remarks this represents a made instance of Genai.Agent.DynamicTrajectory
    """
    
    queryResult: Optional[Genai.Query.Result]
    """
    The {@link Genai.Query.Result} that the plan is created for.
    """
    ...
    steps: Optional[Array[Genai.Agent.DynamicTrajectory.Step]]=None
    """
    The steps to execute the plan.
    """

    planGenerationLatency: Optional[int]=None
    """
    Returns the time taken to generate the plan in milliseconds.
    """

    planExecutionLatency: Optional[int]=None
    """
    Returns the time taken to execute the plan in milliseconds.
    """
    def __init__(self, queryResult: Optional[Genai.Query.Result]=None, id: Optional[str]=None, versionEdits: Optional[Array[VersionEdit]]=None, name: Optional[str]=None, meta: Optional[Meta]=None, version: Optional[int]=None, typeWithBindings: Optional[Type]=None, steps: Optional[Array[Genai.Agent.DynamicTrajectory.Step]]=None, planGenerationLatency: Optional[int]=None, planExecutionLatency: Optional[int]=None) -> None: ...
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[Genai.Agent.DynamicTrajectory]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[Genai.Agent.DynamicTrajectory]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[Genai.Agent.DynamicTrajectory]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[Genai.Agent.DynamicTrajectory]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> Genai.Agent.DynamicTrajectory:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> Genai.Agent.DynamicTrajectory:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> Genai.Agent.DynamicTrajectory:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[Genai.Agent.DynamicTrajectory]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[Genai.Agent.DynamicTrajectory]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> Genai.Agent.DynamicTrajectory:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> Genai.Agent.DynamicTrajectory:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> Genai.Agent.DynamicTrajectory:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> Genai.Agent.DynamicTrajectory:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> Genai.Agent.DynamicTrajectory:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> Genai.Agent.DynamicTrajectory:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> Genai.Agent.DynamicTrajectory:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> Genai.Agent.DynamicTrajectory:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> Genai.Agent.DynamicTrajectory:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> Genai.Agent.DynamicTrajectory:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> Genai.Agent.DynamicTrajectory:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> Genai.Agent.DynamicTrajectory:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> Genai.Agent.DynamicTrajectory:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> Genai.Agent.DynamicTrajectory:
    """
    @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> Genai.Agent.DynamicTrajectory:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> Genai.Agent.DynamicTrajectory:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> Genai.Agent.DynamicTrajectory:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> Genai.Agent.DynamicTrajectory:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> Genai.Agent.DynamicTrajectory:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> Genai.Agent.DynamicTrajectory:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> Genai.Agent.DynamicTrajectory:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> Genai.Agent.DynamicTrajectory:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> Genai.Agent.DynamicTrajectory:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> Genai.Agent.DynamicTrajectory:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> Genai.Agent.DynamicTrajectory:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> Genai.Agent.DynamicTrajectory:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> Genai.Agent.DynamicTrajectory:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> Genai.Agent.DynamicTrajectory:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[Genai.Agent.DynamicTrajectory]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[Genai.Agent.DynamicTrajectory]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[Genai.Agent.DynamicTrajectory]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[Genai.Agent.DynamicTrajectory]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[Genai.Agent.DynamicTrajectory]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, Genai.Agent.DynamicTrajectory]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, Genai.Agent.DynamicTrajectory]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[Genai.Agent.DynamicTrajectory]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[Genai.Agent.DynamicTrajectory]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> Genai.Agent.DynamicTrajectory:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> Genai.Agent.DynamicTrajectory:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> Genai.Agent.DynamicTrajectory:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> Genai.Agent.DynamicTrajectory:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> Genai.Agent.DynamicTrajectory:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> Genai.Agent.DynamicTrajectory:
    """
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[Genai.Agent.DynamicTrajectory]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> Genai.Agent.DynamicTrajectory:
    """
    ...
    """
        ...
    def afterMake(self) -> Genai.Agent.DynamicTrajectory:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> Genai.Agent.DynamicTrajectory:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[Genai.Agent.DynamicTrajectory]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> Genai.Agent.DynamicTrajectory:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, spec: FetchSpec=None) -> FetchResult[Genai.Agent.DynamicTrajectory]:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, filter: Filter) -> FetchResult[Genai.Agent.DynamicTrajectory]:
    """
    ...
    """
        ...
    @classmethod
    def fetchObjStream(cls, spec: FetchStreamSpec=None) -> Union[Stream[Genai.Agent.DynamicTrajectory]]:
    """
    Fetches multiple obj instances based on a specification.  Only objs that the caller is authorized to fetch will be
    returned.
    ...
    """
        ...
    @classmethod
    def fetchMultiLocale(cls, spec: MultiLocaleFetchSpec=None) -> Union[Map[str, FetchResult[Genai.Agent.DynamicTrajectory]]]:
    """
    ...
    """
        ...
    def get(self, include: str=None) -> Union[Genai.Agent.DynamicTrajectory]:
    """
    ...
    """
        ...
    def getSpecific(self, include: str=None) -> Union[Genai.Agent.DynamicTrajectory]:
    """
    ...
    """
        ...
    def getMissing(self, spec: GetMissingSpec) -> Genai.Agent.DynamicTrajectory:
    """
    ...
    """
        ...
    def getDirect(self, include: str=None) -> Union[Genai.Agent.DynamicTrajectory]:
    """
    ...
    """
        ...
    def applyReverseEdit(self, versionEdit: VersionEdit) -> Genai.Agent.DynamicTrajectory:
    """
    ...
    """
        ...
    @classmethod
    def fromString(cls, s: str) -> Union[Genai.Agent.DynamicTrajectory]:
    """
    ...
    """
        ...
    def create(self, spec: UpsertSpec=None) -> Union[Genai.Agent.DynamicTrajectory]:
    """
    ...
    """
        ...
    @classmethod
    def createBatch(cls, objs: Array[Genai.Agent.DynamicTrajectory], spec: UpsertSpec=None) -> Union[ObjList[Genai.Agent.DynamicTrajectory]]:
    """
    ...
    """
        ...
    @classmethod
    def createBatchObjStream(cls, objs: Stream[Genai.Agent.DynamicTrajectory], spec: CreateBatchObjStreamSpec=None) -> Union[ObjList[Genai.Agent.DynamicTrajectory]]:
    """
    Creates multiple instances of a C3 type. If the operation fails and {@link UpsertSpec#dontThrowOnBatchError} is not
    specified (the default), then a C3BatchException will be thrown.  Otherwise {@link errors will be reported in the
    returned {@link ObjList}.  This will fail if any of the instances already exist.
    ...
    """
        ...
    def update(self, srcObj: Genai.Agent.DynamicTrajectory=None, spec: UpsertSpec=None) -> Union[Genai.Agent.DynamicTrajectory]:
    """
    ...
    """
        ...
    def upsert(self, srcObj: Genai.Agent.DynamicTrajectory=None, spec: UpsertSpec=None) -> Union[Genai.Agent.DynamicTrajectory]:
    """
    ...
    """
        ...
    @overload
    def merge(self, spec: MergeSpec=None) -> Union[Genai.Agent.DynamicTrajectory]:
    """
    ...
    """
        ...
    @overload
    def merge(self, mergeInclude: str, spec: MergeSpec=None) -> Union[Genai.Agent.DynamicTrajectory]:
    """
    ...
    """
        ...
    def touch(self, spec: TouchSpec=None) -> Union[Genai.Agent.DynamicTrajectory]:
    """
    ...
    """
        ...
    @classmethod
    def updateBatch(cls, objs: Array[Genai.Agent.DynamicTrajectory], srcObjs: Array[Genai.Agent.DynamicTrajectory]=None, spec: UpsertSpec=None) -> Union[ObjList[Genai.Agent.DynamicTrajectory]]:
    """
    ...
    """
        ...
    @classmethod
    def updateObjs(cls, objs: Callable[[], Union[Array[Genai.Agent.DynamicTrajectory]]], spec: UpsertSpec=None) -> Union[ObjList[Genai.Agent.DynamicTrajectory]]:
    """
    ...
    """
        ...
    @classmethod
    def upsertBatch(cls, objs: Array[Genai.Agent.DynamicTrajectory], srcObjs: Array[Genai.Agent.DynamicTrajectory]=None, spec: UpsertSpec=None) -> Union[ObjList[Genai.Agent.DynamicTrajectory]]:
    """
    ...
    """
        ...
    @classmethod
    def upsertObjs(cls, objs: Callable[[], Union[Array[Genai.Agent.DynamicTrajectory]]], spec: UpsertSpec=None) -> Union[ObjList[Genai.Agent.DynamicTrajectory]]:
    """
    Creates instances of a C3 type if they don't already exist and updates them if they do exist. If the operation
    ...
    """
        ...
    @classmethod
    def touchBatch(cls, objs: Array[Genai.Agent.DynamicTrajectory], spec: TouchSpec=None) -> Union[ObjList[Genai.Agent.DynamicTrajectory]]:
    """
    ...
    @overload
    @classmethod
    def mergeBatch(cls, objs: Array[Genai.Agent.DynamicTrajectory], spec: MergeSpec=None) -> Union[ObjList[Genai.Agent.DynamicTrajectory]]:
    """
    ...
    @overload
    @classmethod
    def mergeBatch(cls, objs: Array[Genai.Agent.DynamicTrajectory], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[Genai.Agent.DynamicTrajectory]]:
    """
    Merges multiple instances of a C3 type or creates them if they don't exist. If the operation fails and {@link
    UpsertSpec#dontThrowOnBatchError} is not specified (the default), then a C3BatchException will be thrown.
    Otherwise errors will be reported in the returned {@link ObjList}.  The merge operation is described in the {@link
    ...
    """
        ...
    @classmethod
    def mergeObjs(cls, objs: Callable[[], Union[Array[Genai.Agent.DynamicTrajectory]]], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[Genai.Agent.DynamicTrajectory]]:
    """
    ...
    @overload
    @classmethod
    def mergeAll(cls, mergeObj: Genai.Agent.DynamicTrajectory, spec: MergeAllSpec=None) -> Union[int]:
    """
    ...
    @overload
    @classmethod
    def mergeAll(cls, mergeObj: Genai.Agent.DynamicTrajectory, mergeInclude: str, spec: MergeAllSpec=None) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def removeBatch(cls, objs: Array[Genai.Agent.DynamicTrajectory], spec: UpsertSpec=None) -> Union[ObjList[Genai.Agent.DynamicTrajectory]]:
    """
    ...
    """
        ...
    @classmethod
    def replace(cls, objs: Array[Genai.Agent.DynamicTrajectory], spec: UpsertSpec=None) -> Union[ObjList[Genai.Agent.DynamicTrajectory]]:
    """
    ...
    """
        ...
    def unremove(self) -> Union[Genai.Agent.DynamicTrajectory]:
    """
    ...
    """
        ...
    @classmethod
    def beforeCreate(cls, objs: Array[Genai.Agent.DynamicTrajectory]) -> ObjList[Genai.Agent.DynamicTrajectory]:
    """
    ...
    """
        ...
    @classmethod
    def beforeUpdate(cls, objs: Array[Genai.Agent.DynamicTrajectory]) -> ObjList[Genai.Agent.DynamicTrajectory]:
    """
    ...
    """
        ...
    @classmethod
    def beforeRemove(cls, objs: Array[Genai.Agent.DynamicTrajectory]) -> ObjList[Genai.Agent.DynamicTrajectory]:
    """
    ...
    """
        ...
    @classmethod
    def afterCreate(cls, objs: Array[Genai.Agent.DynamicTrajectory]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def afterUpdate(cls, objs: Array[Genai.Agent.DynamicTrajectory]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def afterRemove(cls, objs: Array[Genai.Agent.DynamicTrajectory]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def startImportData(cls, spec: StartImportDataSpec=None) -> PushStream[Genai.Agent.DynamicTrajectory]:
    """
    @return a push stream to import instances of this type.
    """
        ...
    @classmethod
    def startImportDataWithStats(cls, spec: StartImportDataSpec=None) -> PushStreamWithStats[Genai.Agent.DynamicTrajectory]:
    """
    @return a push stream to import instances of this type.
    """
        ...
    ...
    """
        ...
    @classmethod
    def forId(cls, id: str, failIfMissing: bool=None) -> Union[Genai.Agent.DynamicTrajectory]:
    """
    ...
    """
        ...
    def withoutIdentity(self) -> Union[Genai.Agent.DynamicTrajectory]:
    """
    ...
    """
        ...
    @classmethod
    def typeOfBatch(cls, objs: Array[Genai.Agent.DynamicTrajectory]) -> Union[Array[EntityType]]:
    """
    ...
    """
        ...
    @classmethod
    def dbEcho(cls, template: Genai.Agent.DynamicTrajectory=None, count: int=None, sendBack: bool=None) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def callbackLogic(cls, objs: Array[Genai.Agent.DynamicTrajectory], callback: Callable[[Union[Genai.Agent.DynamicTrajectory]], Union[Genai.Agent.DynamicTrajectory]]=None) -> ObjList[Genai.Agent.DynamicTrajectory]:
    """
    ...
    """
        ...
    @classmethod
    def afterCallbackLogic(cls, objs: Array[Genai.Agent.DynamicTrajectory], callback: Callable[[Union[Genai.Agent.DynamicTrajectory]], Union[Genai.Agent.DynamicTrajectory]]=None) -> Union[Array[ObjError]]:
    """
    ...
    class ExpressionEngineFunction(ExpressionEngineFunction):
        """
        Custom {@link ExpressionEngineFunction}s used to calculate complex calc fields for {@link Genai.Agent.DynamicTrajectory}
        
        @remarks this represents a made instance of Genai.Agent.DynamicTrajectory.ExpressionEngineFunction
        """
        ...
        **Note on ML applications**
        ...
        """
            ...
        @classmethod
        def getAgentInitializationLatency(cls, id: str) -> int:
        """
        Function to obtain the time in milliseconds that the query took to initialize the agent.
        @param id
               The ID of the {@link Genai.Query.Result}.
        @return The plan generation latency of the query in milliseconds.
        """
            ...
        @classmethod
        def getAgentExecutionLatency(cls, id: str) -> int:
        """
        Function to obtain the time in milliseconds that the query took to execute the dynamic agent.
        @param id
               The ID of the {@link Genai.Query.Result}.
        @return The plan execution latency of the query in milliseconds.
        """
            ...
    
    class Step(Genai.Agent.Trajectory.Step):
        """
        A step in a {@link Genai.Agent.DynamicTrajectory.StepSequence}.
        
        @remarks this represents a made instance of Genai.Agent.DynamicTrajectory.Step
        """
        ...
        output: Optional[Union[any,Array[Genai.Agent.DynamicData]]]=None
        """
        ...
        """
        The agent that this step is associated to.
        """

        trajectory: Optional[Genai.Agent.DynamicTrajectory]=None
        """
        The trajectory that this step is a part of.
        """

        content: Optional[str]=None
        """
        The llm-generated content of this step, which may include code, a plan, or the final answer.
        """

        tag: Optional[Genai.Agent.DynamicTrajectory.Step.Tag]=None
        """
        The tag indicating the type of content in this step.
        """

        query: Optional[str]=None
        """
        The query or command for this step.
        """

        stdoutLabel: Optional[str]=None
        """
        Label used when printing the stdout of the code execution
        """

        toolsUsed: Optional[Array[Genai.Agent.Dynamic.Tool.UiConfig]]=None
        """
        The tools that were used in this step.
        """

        rationaleSources: Optional[Array[Genai.Query.ResultToSourceFileRelation]]=None
        """
        The files were used as part of the rationale to generate the answer.
        """

        sourceRelations: Optional[Array[Genai.Query.ResultToSourceRelation]]=None
        """
        ...
        """
        def __init__(self, stepId: Optional[str]=None, output: Optional[Union[any,Array[Genai.Agent.DynamicData]]]=None, status: Optional[str]=None, logs: Optional[any]=None, id: Optional[str]=None, versionEdits: Optional[Array[VersionEdit]]=None, name: Optional[str]=None, meta: Optional[Meta]=None, version: Optional[int]=None, typeWithBindings: Optional[Type]=None, agentName: Optional[str]=None, trajectory: Optional[Genai.Agent.DynamicTrajectory]=None, content: Optional[str]=None, tag: Optional[Genai.Agent.DynamicTrajectory.Step.Tag]=None, query: Optional[str]=None, stdoutLabel: Optional[str]=None, toolsUsed: Optional[Array[Genai.Agent.Dynamic.Tool.UiConfig]]=None, rationaleSources: Optional[Array[Genai.Query.ResultToSourceFileRelation]]=None, sourceRelations: Optional[Array[Genai.Query.ResultToSourceRelation]]=None) -> None: ...
        ...
        """
            ...
        @classmethod
        def fromJson(cls, json: any) -> Union[Genai.Agent.DynamicTrajectory.Step]:
        """
        Load the JSON-based representation and reconstruct the corresponding object.
        ...
        """
            ...
        @classmethod
        def fromJsonString(cls, json: str) -> Union[Genai.Agent.DynamicTrajectory.Step]:
        """
        Load the JSON-based representation and reconstruct the corresponding object.
        ...
        """
            ...
        @classmethod
        def fromXmlString(cls, xml: str) -> Union[Genai.Agent.DynamicTrajectory.Step]:
        """
        Load the XML-based representation and reconstruct the corresponding object.
        ...
        """
            ...
        @classmethod
        def deserialize(cls, contentStr: str, contentType: str) -> Union[Genai.Agent.DynamicTrajectory.Step]:
        """
        Load from contentType representation and reconstruct the corresponding object.
        ...
        """
            ...
        def replaceType(self, old: Type, new: Type) -> Genai.Agent.DynamicTrajectory.Step:
        """
        Returns new instance with all references to old type, including result of #type, replaced with new type. If new
        type does not contain fields from old or field value types are not convertable then drops the field.
        ...
        """
            ...
        @overload
        def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> Genai.Agent.DynamicTrajectory.Step:
        """
        Result of this function call is a copy of current instance with all non empty fields replaced based on results of
        the `mapper` invocation.
        ...
        """
            ...
        @overload
        def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> Genai.Agent.DynamicTrajectory.Step:
        """
        Result of this function call is a copy of current instance with all fields replaced based on results of the
        `mapper` invocation.
        ...
        """
            ...
        @overload
        def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[Genai.Agent.DynamicTrajectory.Step]:
        """
        Result of this function call is a copy of current instance with all non empty fields replaced based on results of
        the asynchronous `mapper` invocation.
        ...
        """
            ...
        @overload
        def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[Genai.Agent.DynamicTrajectory.Step]:
        """
        Result of this function call is a copy of current instance with all fields replaced based on results of the
        asynchronous `mapper` invocation.
        ...
        """
            ...
        def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> Genai.Agent.DynamicTrajectory.Step:
        """
        Result of this function call is a copy of current instance with specified field value replaced based on result of
        the `mapper` invocation.
        @param field
        ...
        """
            ...
        @overload
        def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> Genai.Agent.DynamicTrajectory.Step:
        """
        Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
        lambda application.
        ...
        """
            ...
        @overload
        def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> Genai.Agent.DynamicTrajectory.Step:
        """
        Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
        lambda application.
        ...
        """
            ...
        @overload
        def validateObj(self) -> Genai.Agent.DynamicTrajectory.Step:
        """
        Populates all missing default values and throws error if any constraint is violated.
        """
            ...
        ...
        """
            ...
        @overload
        def withField(self, field: str, value: Any, doNotConvert: bool=None) -> Genai.Agent.DynamicTrajectory.Step:
        """
        Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
        defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
        ...
        """
            ...
        @overload
        def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> Genai.Agent.DynamicTrajectory.Step:
        """
        Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
        defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
        ...
        """
            ...
        def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> Genai.Agent.DynamicTrajectory.Step:
        """
        Builds a new Obj instance by adding the provided fields in it. The name must correspond to an existing fields
        defined on this type or its mixins. The values must be of the correct type if doNotConvert flag is true.
        ...
        """
            ...
        def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> Genai.Agent.DynamicTrajectory.Step:
        """
        Builds a new Obj with the value at the specified path field. If the field is null, the field #isFieldSet to null.
        If you would like to #unsetField, you should call #withoutFieldAtPath instead.
        ...
        """
            ...
        def withoutFieldAtPath(self, path: str) -> Genai.Agent.DynamicTrajectory.Step:
        """
        Builds a new Obj without the specified path field.
        ...
        """
            ...
        @overload
        def withoutField(self, field: str) -> Genai.Agent.DynamicTrajectory.Step:
        """
        Builds a new Obj, removing the field with the provided name.
        ...
        """
            ...
        @overload
        def withoutField(self, field: FieldType) -> Genai.Agent.DynamicTrajectory.Step:
        """
        Builds a new Obj, removing the field with the provided field type.
        ...
        """
            ...
        def withoutFields(self, fields: Array[str]) -> Genai.Agent.DynamicTrajectory.Step:
        """
        Builds a new Obj, removing the fields with the provided names.
        ...
        """
            ...
        def withoutFieldsByType(self, fields: Array[FieldType]) -> Genai.Agent.DynamicTrajectory.Step:
        """
        Builds a new Obj, removing the fields with the provided field types. Be sure to use the FieldType instance for the
        exact same type as the type of the obj to respect the "ordinal" of the field type
        ...
        """
            ...
        def withoutSecretFields(self) -> Genai.Agent.DynamicTrajectory.Step:
        """
        @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
        """
            ...
        def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> Genai.Agent.DynamicTrajectory.Step:
        """
        Builds a new Obj instance by adding the default values (if defined) for all unset fields. This is implemented by
        calling {@link FieldType#defaultValue defaultValue} for a field if it is not already set and
        {@link FieldType#hasDefault has a default}. It will also set {@see ValueType#initialValue initial values} for
        ...
        """
            ...
        @overload
        def defaultField(self, field: str) -> Genai.Agent.DynamicTrajectory.Step:
        """
        Builds a new Obj, by setting a field on this `Obj` to the field's default value. If the field has no default, this
        method will behave the same as {@link #unsetField}.
        ...
        """
            ...
        @overload
        def defaultField(self, field: FieldType) -> Genai.Agent.DynamicTrajectory.Step:
        """
        Builds a new Obj, by setting a field on this `Obj` to the fields default value. If the field has no default, this
        method will behave the same as {@link #unsetField}.
        ...
        """
            ...
        @overload
        def unsetField(self, field: str) -> Genai.Agent.DynamicTrajectory.Step:
        """
        Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
        is different from {@link removeField}
        ...
        """
            ...
        @overload
        def unsetField(self, field: FieldType) -> Genai.Agent.DynamicTrajectory.Step:
        """
        Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
        is different from {@link removeField}
        ...
        """
            ...
        @overload
        def removeField(self, field: str) -> Genai.Agent.DynamicTrajectory.Step:
        """
        Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
        is different from {@link #unsetField}
        ...
        """
            ...
        @overload
        def removeField(self, field: FieldType) -> Genai.Agent.DynamicTrajectory.Step:
        """
        Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
        is different from {@link #unsetField}
        ...
        """
            ...
        @overload
        def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> Genai.Agent.DynamicTrajectory.Step:
        """
        Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
        In case of conflicts, fields of other instance take precedence unless otherwise specified by the fieldPathMergeSpec
        ...
        """
            ...
        @overload
        def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> Genai.Agent.DynamicTrajectory.Step:
        """
        Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
        In case of conflicts, fields of other instance take precedence.
        ...
        """
            ...
        @overload
        def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> Genai.Agent.DynamicTrajectory.Step:
        """
        Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
        fields that exist on other Obj and do not exist on this Obj will not be added to final Obj.
        @param deep
        ...
        """
            ...
        @overload
        def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> Genai.Agent.DynamicTrajectory.Step:
        """
        Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
        fields that exist other Obj and do not exist on this Obj will not be added to final Obj or evaluated. Does not
        traverse child reference and collection fields.
        ...
        """
            ...
        def mergeJson(self, json: any) -> Genai.Agent.DynamicTrajectory.Step:
            ...
        def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> Genai.Agent.DynamicTrajectory.Step:
        """
        Merge the obj references within the current obj
        @param deep
               If set, traverses the reference fields within the obj as well for a deep merge
        ...
        """
            ...
        def sumObj(self, other: Obj, deep: bool=None) -> Genai.Agent.DynamicTrajectory.Step:
        """
        Adds the numeric Obj fields with the other Objs respective fields.
        If deep is set it will traverse reference and collection fields and sum corresponding numeric fields in
        references with same name and collection elements at same index or key.
        """
            ...
        def singletonArray(self) -> Array[Genai.Agent.DynamicTrajectory.Step]:
        """
        Build an array of the correct type with a single element which is this instance.
        ...
        """
            ...
        @classmethod
        def array(cls, *elements: Array[Any]) -> Union[Array[Genai.Agent.DynamicTrajectory.Step]]:
        """
        Creates an array of instances of this type.
        """
            ...
        @classmethod
        def arrayBuilder(cls) -> Union[ArrayBuilder[Genai.Agent.DynamicTrajectory.Step]]:
        """
        Creates an array of instances of this type.
        """
            ...
        def singletonSet(self) -> Set[Genai.Agent.DynamicTrajectory.Step]:
        """
        Build an set of the correct type with a single element which is this instance.
        ...
        """
            ...
        @classmethod
        def setBuilder(cls) -> Union[SetBuilder[Genai.Agent.DynamicTrajectory.Step]]:
        """
        Creates a set of instances of this type.
        """
            ...
        @classmethod
        def mapBuilder(cls) -> Union[MapBuilder[str, Genai.Agent.DynamicTrajectory.Step]]:
        """
        Create a map of string to elements of this type.
        """
            ...
        @classmethod
        def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, Genai.Agent.DynamicTrajectory.Step]]:
        """
        Create a map with the given key type and elements of this type.
        """
            ...
        ...
        def myStreamType(cls) -> StreamType:
            ...
        def toBuilder(self) -> ObjBuilder[Genai.Agent.DynamicTrajectory.Step]:
        """
        @return new ObjBuilder with initial state set to fields of this instance.
        """
            ...
        @classmethod
        def builder(cls) -> ObjBuilder[Genai.Agent.DynamicTrajectory.Step]:
        """
        @return new ObjBuilder of this instance.
        """
            ...
        @overload
        @classmethod
        def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> Genai.Agent.DynamicTrajectory.Step:
        """
        Construct instance of this type from provided field values and options
        """
            ...
        @overload
        @classmethod
        def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> Genai.Agent.DynamicTrajectory.Step:
        """
        Construct an instance of this type from provided fields
        @param fields
                   Fields to construct the instance of the obj with
        ...
        @overload
        @classmethod
        def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> Genai.Agent.DynamicTrajectory.Step:
        """
        Construct instance of this type from provided field values and options
        """
            ...
        @overload
        @classmethod
        def make(cls, withDefaults: bool=None) -> Genai.Agent.DynamicTrajectory.Step:
        """
        Construct an instance of this type with no non-default field values unless explicitly specified by passing param true
        @param withDefaults
                   If set, then the Obj is made with default & initial values (required primitive fields e.g. !int32 -> 0)
        ...
        @overload
        @classmethod
        def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> Genai.Agent.DynamicTrajectory.Step:
        """
        Construct an instance from provided fields
        @param fields
                   Fields (in the format <field_name, value>) to construct an instance of the obj. Note that "type" as a
        ...
        @overload
        @classmethod
        def make(cls, fields: Any, withDefaults: bool=None) -> Genai.Agent.DynamicTrajectory.Step:
        """
        Construct an instance of this type from provided fields. Note it is more efficient to use #fromFields and other overloads
        ...
        @overload
        @classmethod
        def make(cls, s: str) -> Union[Genai.Agent.DynamicTrajectory.Step]:
        """
        Construct an instance of this type from the string. This is an alias for #fromString, as a specific overload
        when the argument is a known string.
        ...
        """
            ...
        @classmethod
        def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> Genai.Agent.DynamicTrajectory.Step:
        """
        Construct an instance of this type from provided instance of a subtype or a "duck type".
        """
            ...
        ...
        """
            ...
        def afterMake(self) -> Genai.Agent.DynamicTrajectory.Step:
        """
        Optional override that will be called after every instance creation.
        ...
        """
            ...
        @classmethod
        def cachedEmptyInst(cls) -> Genai.Agent.DynamicTrajectory.Step:
        """
        Creates an empty inst using `MyType.make()` and caches it. Avoid recreating multiple copies of the spec for
        every action dispatch. The cached inst can also be used for comparing whether the object is an empty or not
        Will only create empty instance for immutable Obj e.g. if an Obj is Mutable, this method will throw an error
        ...
        """
            ...
        @classmethod
        def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[Genai.Agent.DynamicTrajectory.Step]]:
        """
        Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
        value is read.
        """
            ...
        @classmethod
        def generateObj(cls, spec: Obj.GenerateSpec=None) -> Genai.Agent.DynamicTrajectory.Step:
        """
        Generate a single instance of this type. The base implementation uses {@link DataGenObj} to generate uniform
        random (gibberish) values for all fields, but it may be overridden by specific types with custom logic that
        populates fields in a more realistic way.
        ...
        @overload
        @classmethod
        def fetch(cls, spec: FetchSpec=None) -> FetchResult[Genai.Agent.DynamicTrajectory.Step]:
        """
        Fetches multiple obj instances based on a specification.  Only objs that the caller is authorized to fetch will be
        returned.
        ...
        @overload
        @classmethod
        def fetch(cls, filter: Filter) -> FetchResult[Genai.Agent.DynamicTrajectory.Step]:
        """
        Fetches multiple obj instances based on a filter.  Only objs that the caller is authorized to fetch will be
        returned.
        ...
        """
            ...
        @classmethod
        def fetchObjStream(cls, spec: FetchStreamSpec=None) -> Union[Stream[Genai.Agent.DynamicTrajectory.Step]]:
        """
        Fetches multiple obj instances based on a specification.  Only objs that the caller is authorized to fetch will be
        returned.
        ...
        """
            ...
        @classmethod
        def fetchMultiLocale(cls, spec: MultiLocaleFetchSpec=None) -> Union[Map[str, FetchResult[Genai.Agent.DynamicTrajectory.Step]]]:
        """
        Fetched multiple obj instances in multiple locales based on specification.
        ...
        """
            ...
        def get(self, include: str=None) -> Union[Genai.Agent.DynamicTrajectory.Step]:
        """
        Gets an instance of a single obj.  If the caller is not authorized to fetch the obj, it will not be returned.
        ...
        """
            ...
        def getSpecific(self, include: str=None) -> Union[Genai.Agent.DynamicTrajectory.Step]:
        """
        Gets an instance of a single obj in it's leaf type if the type is extendable.  If the caller is not authorized
        to fetch the obj, it will not be returned.
        ...
        """
            ...
        def getMissing(self, spec: GetMissingSpec) -> Genai.Agent.DynamicTrajectory.Step:
        """
        Function to check if an obj was already fetched with an include that contains at least the fields of a specified
        include and fetches the missing data if it wasn't.  The returned instance, by default will be the original instance
        if it included at least the data for the requested include spec.  Otherwise it will perform a fetch with the
        ...
        """
            ...
        def getDirect(self, include: str=None) -> Union[Genai.Agent.DynamicTrajectory.Step]:
        """
        Gets an obj instance directly from Cassandra, bypassing the normal fetch framework.  It is only valid for C3 types
        that are stored in Cassandra.
        ...
        """
            ...
        def applyReverseEdit(self, versionEdit: VersionEdit) -> Genai.Agent.DynamicTrajectory.Step:
        """
        Applies a reverse edit (e.g. VersionEdit) to an instance.
        ...
        """
            ...
        @classmethod
        def fromString(cls, s: str) -> Union[Genai.Agent.DynamicTrajectory.Step]:
        """
        Parse the string-based representation and reconstruct the corresponding instance. This must be implemented to
        provide deserialization.
        ...
        """
            ...
        def create(self, spec: UpsertSpec=None) -> Union[Genai.Agent.DynamicTrajectory.Step]:
        """
        Creates an instance of a C3 type. If the operation fails an exception will be thrown.  This will fail if the
        instance already exist.
        ...
        """
            ...
        @classmethod
        def createBatch(cls, objs: Array[Genai.Agent.DynamicTrajectory.Step], spec: UpsertSpec=None) -> Union[ObjList[Genai.Agent.DynamicTrajectory.Step]]:
        """
        Creates multiple instances of a C3 type. If the operation fails and {@link UpsertSpec#dontThrowOnBatchError} is not
        specified (the default), then a C3BatchException will be thrown.  Otherwise {@link errors will be reported in the
        returned {@link ObjList}.  This will fail if any of the instances already exist.
        ...
        """
            ...
        @classmethod
        def createBatchObjStream(cls, objs: Stream[Genai.Agent.DynamicTrajectory.Step], spec: CreateBatchObjStreamSpec=None) -> Union[ObjList[Genai.Agent.DynamicTrajectory.Step]]:
        """
        Creates multiple instances of a C3 type. If the operation fails and {@link UpsertSpec#dontThrowOnBatchError} is not
        specified (the default), then a C3BatchException will be thrown.  Otherwise {@link errors will be reported in the
        returned {@link ObjList}.  This will fail if any of the instances already exist.
        ...
        """
            ...
        def update(self, srcObj: Genai.Agent.DynamicTrajectory.Step=None, spec: UpsertSpec=None) -> Union[Genai.Agent.DynamicTrajectory.Step]:
        """
        Updates an instance of a C3 type. If the operation fails an exception will be thrown.  This will fail if the
        instance does not already exist.
        ...
        """
            ...
        def upsert(self, srcObj: Genai.Agent.DynamicTrajectory.Step=None, spec: UpsertSpec=None) -> Union[Genai.Agent.DynamicTrajectory.Step]:
        """
        Creates an instance of a C3 type if it doesn't exist or updates it if it does. If the operation fails an
        exception will be thrown.
        ...
        """
            ...
        @overload
        def merge(self, spec: MergeSpec=None) -> Union[Genai.Agent.DynamicTrajectory.Step]:
        """
        Merges an instance of a C3 type if it exists and creates it if it doesn't. Merging an obj instance by default only
        updates the non-null field values in the input obj.  Null field values are ignored.  Nullness of field values
        is honored at every level for fields that have an included type (e.g. non-entity type) as their value type. To
        ...
        """
            ...
        @overload
        def merge(self, mergeInclude: str, spec: MergeSpec=None) -> Union[Genai.Agent.DynamicTrajectory.Step]:
        """
        Merges an instance of a C3 type if it exists and creates it if it doesn't.
        ...
        """
            ...
        def touch(self, spec: TouchSpec=None) -> Union[Genai.Agent.DynamicTrajectory.Step]:
        """
        Updates the 'meta.updated' field to the current time.  If the obj doesn't exist an error will be returned.
        ...
        """
            ...
        @classmethod
        def updateBatch(cls, objs: Array[Genai.Agent.DynamicTrajectory.Step], srcObjs: Array[Genai.Agent.DynamicTrajectory.Step]=None, spec: UpsertSpec=None) -> Union[ObjList[Genai.Agent.DynamicTrajectory.Step]]:
        """
        Updates multiple instances of a C3 type. If the operation fails and {@link UpsertSpec#dontThrowOnBatchError} is not
        specified (the default), then a C3BatchException will be thrown.  Otherwise {@linkerrors will be reported in the
        returned {@link ObjList}.  This will fail if any of the instances don't already exist.
        ...
        """
            ...
        @classmethod
        def updateObjs(cls, objs: Callable[[], Union[Array[Genai.Agent.DynamicTrajectory.Step]]], spec: UpsertSpec=None) -> Union[ObjList[Genai.Agent.DynamicTrajectory.Step]]:
        """
        Updates multiple instances of a C3 type. If the operation fails due to a version conflict error, the lambda will be
        called again to provide updated instances to be updated. If the operation fails for other reasons and
        {@link UpsertSpec#dontThrowOnBatchError} is not specified (the default), then a C3BatchException will be thrown.
        ...
        """
            ...
        @classmethod
        def upsertBatch(cls, objs: Array[Genai.Agent.DynamicTrajectory.Step], srcObjs: Array[Genai.Agent.DynamicTrajectory.Step]=None, spec: UpsertSpec=None) -> Union[ObjList[Genai.Agent.DynamicTrajectory.Step]]:
        """
        Creates instances of a C3 type if they don't already exist and updates them if they do exist. If the operation
        fails errors will be reported in the returned {@link ObjList}.
        ...
        """
            ...
        @classmethod
        def upsertObjs(cls, objs: Callable[[], Union[Array[Genai.Agent.DynamicTrajectory.Step]]], spec: UpsertSpec=None) -> Union[ObjList[Genai.Agent.DynamicTrajectory.Step]]:
        """
        Creates instances of a C3 type if they don't already exist and updates them if they do exist. If the operation
        fails due to a version conflict error, the lambda will be called again to provide updated instances to be upserted.
        If the operation fails for other reasons and {@link UpsertSpec#dontThrowOnBatchError} is not specified (the
        ...
        """
            ...
        @classmethod
        def touchBatch(cls, objs: Array[Genai.Agent.DynamicTrajectory.Step], spec: TouchSpec=None) -> Union[ObjList[Genai.Agent.DynamicTrajectory.Step]]:
        """
        Updates the 'meta.updated' field to the current time for a batch of objs.  Attempts to touch non-existing
        objs will be considered an error.
        ...
        @overload
        @classmethod
        def mergeBatch(cls, objs: Array[Genai.Agent.DynamicTrajectory.Step], spec: MergeSpec=None) -> Union[ObjList[Genai.Agent.DynamicTrajectory.Step]]:
        """
        Merges multiple instances of a C3 type or creates them if they don't exist. If the operation fails and {@link
        UpsertSpec#dontThrowOnBatchError} is not specified (the default), then a C3BatchException will be thrown.
        Otherwise errors will be reported in the returned {@link ObjList}.  The merge operation is described in the {@link
        ...
        @overload
        @classmethod
        def mergeBatch(cls, objs: Array[Genai.Agent.DynamicTrajectory.Step], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[Genai.Agent.DynamicTrajectory.Step]]:
        """
        Merges multiple instances of a C3 type or creates them if they don't exist. If the operation fails and {@link
        UpsertSpec#dontThrowOnBatchError} is not specified (the default), then a C3BatchException will be thrown.
        Otherwise errors will be reported in the returned {@link ObjList}.  The merge operation is described in the {@link
        ...
        """
            ...
        @classmethod
        def mergeObjs(cls, objs: Callable[[], Union[Array[Genai.Agent.DynamicTrajectory.Step]]], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[Genai.Agent.DynamicTrajectory.Step]]:
        """
        Merges multiple instances of a C3 type or creates them if they don't exist. If the operation fails due to a version
        conflict error, the lambda will be called again to provide updated instances to be upserted. If the operation
        fails for other reasons and {@link UpsertSpec#dontThrowOnBatchError} is not specified (the default), then a
        ...
        @overload
        @classmethod
        def mergeAll(cls, mergeObj: Genai.Agent.DynamicTrajectory.Step, spec: MergeAllSpec=None) -> Union[int]:
        """
        Merges an obj into multiple instances of a C3 type (e.g. mass merge). Like the {@link merge} and {@link mergeBatch}
        functions, the set of fields to be merged can be controlled by specifying an include spec in either
        {@link Mergespec#mergeInclude} or {@link Mergespec#csvInclude}.  Additionally, the objs to perform the operation on
        ...
        @overload
        @classmethod
        def mergeAll(cls, mergeObj: Genai.Agent.DynamicTrajectory.Step, mergeInclude: str, spec: MergeAllSpec=None) -> Union[int]:
        """
        Merges an obj into multiple instances of a C3 type (e.g. mass merge). The objs to perform the operation on can be
        controlled by specifying the {@link MergeAllspec#filter}.  Valid filter expressions follow the same rules as in
        {@link FetchSpec#filter}.  If not specified, all instances will be merged.
        ...
        """
            ...
        @classmethod
        def removeBatch(cls, objs: Array[Genai.Agent.DynamicTrajectory.Step], spec: UpsertSpec=None) -> Union[ObjList[Genai.Agent.DynamicTrajectory.Step]]:
        """
        Removes multiple instances of a C3 type. If the operation fails and {@link UpsertSpec#dontThrowOnBatchError} is not
        specified (the default), then a C3BatchException will be thrown.  Otherwise {@link ObjList#errors errors} will be
        reported in the returned {@link ObjList}.
        ...
        """
            ...
        @classmethod
        def replace(cls, objs: Array[Genai.Agent.DynamicTrajectory.Step], spec: UpsertSpec=None) -> Union[ObjList[Genai.Agent.DynamicTrajectory.Step]]:
        """
        Replaces all instances of a C3 type. If the operation fails errors will be reported in the returned {@link ObjList}.
        ...
        """
            ...
        def unremove(self) -> Union[Genai.Agent.DynamicTrajectory.Step]:
        """
        Recovers archived instances of a C3 type (e.g. those removed via the {@link remove}, {@link removeAll} and
        {@link removeBatch} functions). If the operation fails an exception will be thrown.
        ...
        """
            ...
        @classmethod
        def beforeCreate(cls, objs: Array[Genai.Agent.DynamicTrajectory.Step]) -> ObjList[Genai.Agent.DynamicTrajectory.Step]:
        """
        Callback that is called synchronously during an operation that creates objs before those objs are created.  The
        implementer can perform validation or additional logic.
        ...
        """
            ...
        @classmethod
        def beforeUpdate(cls, objs: Array[Genai.Agent.DynamicTrajectory.Step]) -> ObjList[Genai.Agent.DynamicTrajectory.Step]:
        """
        Callback that is called synchronously during an operation that updates objs before those objs are updated.  The
        implementer can perform validation or additional logic.
        ...
        """
            ...
        @classmethod
        def beforeRemove(cls, objs: Array[Genai.Agent.DynamicTrajectory.Step]) -> ObjList[Genai.Agent.DynamicTrajectory.Step]:
        """
        Callback that is called synchronously during an operation that removes objs before those objs are removed.  The
        implementer can perform validation or additional logic.
        ...
        """
            ...
        @classmethod
        def afterCreate(cls, objs: Array[Genai.Agent.DynamicTrajectory.Step]) -> Union[Array[ObjError]]:
        """
        Callback that is called synchronously during a request that creates objs after those objs are created.  The
        implementer can perform additional logic.
        ...
        """
            ...
        @classmethod
        def afterUpdate(cls, objs: Array[Genai.Agent.DynamicTrajectory.Step]) -> Union[Array[ObjError]]:
        """
        Callback that is called synchronously during a request that updates objs after those objs are updated.  The
        implementer can perform additional logic.
        ...
        """
            ...
        @classmethod
        def afterRemove(cls, objs: Array[Genai.Agent.DynamicTrajectory.Step]) -> Union[Array[ObjError]]:
        """
        Callback that is called synchronously during a request that removes objs after those objs are removed.  The
        implementer can perform additional logic.
        ...
        """
            ...
        @classmethod
        def startImportData(cls, spec: StartImportDataSpec=None) -> PushStream[Genai.Agent.DynamicTrajectory.Step]:
        """
        @return a push stream to import instances of this type.
        """
            ...
        @classmethod
        def startImportDataWithStats(cls, spec: StartImportDataSpec=None) -> PushStreamWithStats[Genai.Agent.DynamicTrajectory.Step]:
        """
        @return a push stream to import instances of this type.
        """
            ...
        ...
        """
            ...
        @classmethod
        def forId(cls, id: str, failIfMissing: bool=None) -> Union[Genai.Agent.DynamicTrajectory.Step]:
        """
        @return single instance of this Identified type by id.
        """
            ...
        ...
        """
            ...
        def withoutIdentity(self) -> Union[Genai.Agent.DynamicTrajectory.Step]:
        """
        Removes the identifying fields {@link #id}, {@link #meta}, and {@link #version} of the instance it's called on,
        such that a subsequent upsert will create a new instance.
        ...
        """
            ...
        @classmethod
        def typeOfBatch(cls, objs: Array[Genai.Agent.DynamicTrajectory.Step]) -> Union[Array[EntityType]]:
        """
        Gets the specific C3 type hierarchy for multiple obj instances.  For a non-extendable type the hierarchy will be the
        C3 type of the input obj.  For extendable types it will contain the concrete extension type for the instance as well
        as that type's base type chain.
        ...
        """
            ...
        @classmethod
        def dbEcho(cls, template: Genai.Agent.DynamicTrajectory.Step=None, count: int=None, sendBack: bool=None) -> Union[int]:
        """
        Used only by DatabaseTestEngine
        """
            ...
        ...
        """
            ...
        @classmethod
        def callbackLogic(cls, objs: Array[Genai.Agent.DynamicTrajectory.Step], callback: Callable[[Union[Genai.Agent.DynamicTrajectory.Step]], Union[Genai.Agent.DynamicTrajectory.Step]]=None) -> ObjList[Genai.Agent.DynamicTrajectory.Step]:
        """
        Implements a simple logic for Persistable call-backs like before create by looping each input obj and
        calling a transform for it.
        ...
        """
            ...
        @classmethod
        def afterCallbackLogic(cls, objs: Array[Genai.Agent.DynamicTrajectory.Step], callback: Callable[[Union[Genai.Agent.DynamicTrajectory.Step]], Union[Genai.Agent.DynamicTrajectory.Step]]=None) -> Union[Array[ObjError]]:
        """
        Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
        calling a transform for it.
        """
        ...
        """
            ...
        @classmethod
        def lastStepForAgent(cls, agentName: str, trajectory: Genai.Agent.DynamicTrajectory) -> Union[Genai.Agent.DynamicTrajectory.Step]:
        """
        Returns the step that was last create for the given agent, in a given trajectory.
        """
            ...
        
        class TagType():
            """
            Enum type for the type of a {@link Genai.Agent.DynamicTrajectory.Step.Tag}
            
            @remarks this represents a made instance of Genai.Agent.DynamicTrajectory.Step.TagType
            """
            
            TEXT: Optional[str]=None
            """
            Tag type for a step intended to generate text (ie. generate a plan, a thought, some reasoning, etc.)
            """

            EXECUTE: Optional[str]=None
            """
            Tag type for a step intended to execute some code.
            """

            FINAL_ANSWER: Optional[str]=None
            """
            Tag type for a step intended to produce the final answer to a user query.
            """
            def __init__(self, TEXT: Optional[str]=None, EXECUTE: Optional[str]=None, FINAL_ANSWER: Optional[str]=None) -> None: ...
        ...
        class Tag():
            """
            Type for the tag of a {@link Genai.Agent.DynamicTrajectory.Step}
            
            @remarks this represents a made instance of Genai.Agent.DynamicTrajectory.Step.Tag
            """
            
            tagType: Optional[str]
            """
            Categorization of the type of tag.
            """
            def __init__(self, tagType: Optional[str]=None) -> None: ...
            ...
            """
                ...
            @classmethod
            def fromJson(cls, json: any) -> Union[Genai.Agent.DynamicTrajectory.Step.Tag]:
            """
            Load the JSON-based representation and reconstruct the corresponding object.
            ...
            """
                ...
            @classmethod
            def fromJsonString(cls, json: str) -> Union[Genai.Agent.DynamicTrajectory.Step.Tag]:
            """
            Load the JSON-based representation and reconstruct the corresponding object.
            ...
            """
                ...
            @classmethod
            def fromXmlString(cls, xml: str) -> Union[Genai.Agent.DynamicTrajectory.Step.Tag]:
            """
            Load the XML-based representation and reconstruct the corresponding object.
            ...
            """
                ...
            @classmethod
            def deserialize(cls, contentStr: str, contentType: str) -> Union[Genai.Agent.DynamicTrajectory.Step.Tag]:
            """
            Load from contentType representation and reconstruct the corresponding object.
            ...
            """
                ...
            def replaceType(self, old: Type, new: Type) -> Genai.Agent.DynamicTrajectory.Step.Tag:
            """
            Returns new instance with all references to old type, including result of #type, replaced with new type. If new
            type does not contain fields from old or field value types are not convertable then drops the field.
            ...
            """
                ...
            @overload
            def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> Genai.Agent.DynamicTrajectory.Step.Tag:
            """
            Result of this function call is a copy of current instance with all non empty fields replaced based on results of
            the `mapper` invocation.
            ...
            """
                ...
            @overload
            def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> Genai.Agent.DynamicTrajectory.Step.Tag:
            """
            Result of this function call is a copy of current instance with all fields replaced based on results of the
            `mapper` invocation.
            ...
            """
                ...
            @overload
            def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[Genai.Agent.DynamicTrajectory.Step.Tag]:
            """
            Result of this function call is a copy of current instance with all non empty fields replaced based on results of
            the asynchronous `mapper` invocation.
            ...
            """
                ...
            @overload
            def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[Genai.Agent.DynamicTrajectory.Step.Tag]:
            """
            Result of this function call is a copy of current instance with all fields replaced based on results of the
            asynchronous `mapper` invocation.
            ...
            """
                ...
            def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> Genai.Agent.DynamicTrajectory.Step.Tag:
            """
            Result of this function call is a copy of current instance with specified field value replaced based on result of
            the `mapper` invocation.
            @param field
            ...
            """
                ...
            @overload
            def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> Genai.Agent.DynamicTrajectory.Step.Tag:
            """
            Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
            lambda application.
            ...
            """
                ...
            @overload
            def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> Genai.Agent.DynamicTrajectory.Step.Tag:
            """
            Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
            lambda application.
            ...
            """
                ...
            @overload
            def validateObj(self) -> Genai.Agent.DynamicTrajectory.Step.Tag:
            """
            Populates all missing default values and throws error if any constraint is violated.
            """
                ...
            ...
            """
                ...
            @overload
            def withField(self, field: str, value: Any, doNotConvert: bool=None) -> Genai.Agent.DynamicTrajectory.Step.Tag:
            """
            Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
            defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
            ...
            """
                ...
            @overload
            def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> Genai.Agent.DynamicTrajectory.Step.Tag:
            """
            Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
            defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
            ...
            """
                ...
            def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> Genai.Agent.DynamicTrajectory.Step.Tag:
            """
            Builds a new Obj instance by adding the provided fields in it. The name must correspond to an existing fields
            defined on this type or its mixins. The values must be of the correct type if doNotConvert flag is true.
            ...
            """
                ...
            def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> Genai.Agent.DynamicTrajectory.Step.Tag:
            """
            Builds a new Obj with the value at the specified path field. If the field is null, the field #isFieldSet to null.
            If you would like to #unsetField, you should call #withoutFieldAtPath instead.
            ...
            """
                ...
            def withoutFieldAtPath(self, path: str) -> Genai.Agent.DynamicTrajectory.Step.Tag:
            """
            Builds a new Obj without the specified path field.
            ...
            """
                ...
            @overload
            def withoutField(self, field: str) -> Genai.Agent.DynamicTrajectory.Step.Tag:
            """
            Builds a new Obj, removing the field with the provided name.
            ...
            """
                ...
            @overload
            def withoutField(self, field: FieldType) -> Genai.Agent.DynamicTrajectory.Step.Tag:
            """
            Builds a new Obj, removing the field with the provided field type.
            ...
            """
                ...
            def withoutFields(self, fields: Array[str]) -> Genai.Agent.DynamicTrajectory.Step.Tag:
            """
            Builds a new Obj, removing the fields with the provided names.
            ...
            """
                ...
            def withoutFieldsByType(self, fields: Array[FieldType]) -> Genai.Agent.DynamicTrajectory.Step.Tag:
            """
            Builds a new Obj, removing the fields with the provided field types. Be sure to use the FieldType instance for the
            exact same type as the type of the obj to respect the "ordinal" of the field type
            ...
            """
                ...
            def withoutSecretFields(self) -> Genai.Agent.DynamicTrajectory.Step.Tag:
            """
            @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
            """
                ...
            def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> Genai.Agent.DynamicTrajectory.Step.Tag:
            """
            Builds a new Obj instance by adding the default values (if defined) for all unset fields. This is implemented by
            calling {@link FieldType#defaultValue defaultValue} for a field if it is not already set and
            {@link FieldType#hasDefault has a default}. It will also set {@see ValueType#initialValue initial values} for
            ...
            """
                ...
            @overload
            def defaultField(self, field: str) -> Genai.Agent.DynamicTrajectory.Step.Tag:
            """
            Builds a new Obj, by setting a field on this `Obj` to the field's default value. If the field has no default, this
            method will behave the same as {@link #unsetField}.
            ...
            """
                ...
            @overload
            def defaultField(self, field: FieldType) -> Genai.Agent.DynamicTrajectory.Step.Tag:
            """
            Builds a new Obj, by setting a field on this `Obj` to the fields default value. If the field has no default, this
            method will behave the same as {@link #unsetField}.
            ...
            """
                ...
            @overload
            def unsetField(self, field: str) -> Genai.Agent.DynamicTrajectory.Step.Tag:
            """
            Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
            is different from {@link removeField}
            ...
            """
                ...
            @overload
            def unsetField(self, field: FieldType) -> Genai.Agent.DynamicTrajectory.Step.Tag:
            """
            Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
            is different from {@link removeField}
            ...
            """
                ...
            @overload
            def removeField(self, field: str) -> Genai.Agent.DynamicTrajectory.Step.Tag:
            """
            Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
            is different from {@link #unsetField}
            ...
            """
                ...
            @overload
            def removeField(self, field: FieldType) -> Genai.Agent.DynamicTrajectory.Step.Tag:
            """
            Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
            is different from {@link #unsetField}
            ...
            """
                ...
            @overload
            def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> Genai.Agent.DynamicTrajectory.Step.Tag:
            """
            Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
            In case of conflicts, fields of other instance take precedence unless otherwise specified by the fieldPathMergeSpec
            ...
            """
                ...
            @overload
            def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> Genai.Agent.DynamicTrajectory.Step.Tag:
            """
            Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
            In case of conflicts, fields of other instance take precedence.
            ...
            """
                ...
            @overload
            def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> Genai.Agent.DynamicTrajectory.Step.Tag:
            """
            Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
            fields that exist on other Obj and do not exist on this Obj will not be added to final Obj.
            @param deep
            ...
            """
                ...
            @overload
            def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> Genai.Agent.DynamicTrajectory.Step.Tag:
            """
            Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
            fields that exist other Obj and do not exist on this Obj will not be added to final Obj or evaluated. Does not
            traverse child reference and collection fields.
            ...
            """
                ...
            def mergeJson(self, json: any) -> Genai.Agent.DynamicTrajectory.Step.Tag:
                ...
            def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> Genai.Agent.DynamicTrajectory.Step.Tag:
            """
            Merge the obj references within the current obj
            @param deep
                   If set, traverses the reference fields within the obj as well for a deep merge
            ...
            """
                ...
            def sumObj(self, other: Obj, deep: bool=None) -> Genai.Agent.DynamicTrajectory.Step.Tag:
            """
            Adds the numeric Obj fields with the other Objs respective fields.
            If deep is set it will traverse reference and collection fields and sum corresponding numeric fields in
            references with same name and collection elements at same index or key.
            """
                ...
            def singletonArray(self) -> Array[Genai.Agent.DynamicTrajectory.Step.Tag]:
            """
            Build an array of the correct type with a single element which is this instance.
            ...
            """
                ...
            @classmethod
            def array(cls, *elements: Array[Any]) -> Union[Array[Genai.Agent.DynamicTrajectory.Step.Tag]]:
            """
            Creates an array of instances of this type.
            """
                ...
            @classmethod
            def arrayBuilder(cls) -> Union[ArrayBuilder[Genai.Agent.DynamicTrajectory.Step.Tag]]:
            """
            Creates an array of instances of this type.
            """
                ...
            def singletonSet(self) -> Set[Genai.Agent.DynamicTrajectory.Step.Tag]:
            """
            Build an set of the correct type with a single element which is this instance.
            ...
            """
                ...
            @classmethod
            def setBuilder(cls) -> Union[SetBuilder[Genai.Agent.DynamicTrajectory.Step.Tag]]:
            """
            Creates a set of instances of this type.
            """
                ...
            @classmethod
            def mapBuilder(cls) -> Union[MapBuilder[str, Genai.Agent.DynamicTrajectory.Step.Tag]]:
            """
            Create a map of string to elements of this type.
            """
                ...
            @classmethod
            def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, Genai.Agent.DynamicTrajectory.Step.Tag]]:
            """
            Create a map with the given key type and elements of this type.
            """
                ...
            ...
            def myStreamType(cls) -> StreamType:
                ...
            def toBuilder(self) -> ObjBuilder[Genai.Agent.DynamicTrajectory.Step.Tag]:
            """
            @return new ObjBuilder with initial state set to fields of this instance.
            """
                ...
            @classmethod
            def builder(cls) -> ObjBuilder[Genai.Agent.DynamicTrajectory.Step.Tag]:
            """
            @return new ObjBuilder of this instance.
            """
                ...
            @overload
            @classmethod
            def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> Genai.Agent.DynamicTrajectory.Step.Tag:
            """
            Construct instance of this type from provided field values and options
            """
                ...
            @overload
            @classmethod
            def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> Genai.Agent.DynamicTrajectory.Step.Tag:
            """
            Construct an instance of this type from provided fields
            @param fields
                       Fields to construct the instance of the obj with
            ...
            @overload
            @classmethod
            def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> Genai.Agent.DynamicTrajectory.Step.Tag:
            """
            Construct instance of this type from provided field values and options
            """
                ...
            @overload
            @classmethod
            def make(cls, withDefaults: bool=None) -> Genai.Agent.DynamicTrajectory.Step.Tag:
            """
            Construct an instance of this type with no non-default field values unless explicitly specified by passing param true
            @param withDefaults
                       If set, then the Obj is made with default & initial values (required primitive fields e.g. !int32 -> 0)
            ...
            @overload
            @classmethod
            def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> Genai.Agent.DynamicTrajectory.Step.Tag:
            """
            Construct an instance from provided fields
            @param fields
                       Fields (in the format <field_name, value>) to construct an instance of the obj. Note that "type" as a
            ...
            @overload
            @classmethod
            def make(cls, fields: Any, withDefaults: bool=None) -> Genai.Agent.DynamicTrajectory.Step.Tag:
            """
            Construct an instance of this type from provided fields. Note it is more efficient to use #fromFields and other overloads
            ...
            """
                ...
            @classmethod
            def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> Genai.Agent.DynamicTrajectory.Step.Tag:
            """
            Construct an instance of this type from provided instance of a subtype or a "duck type".
            """
                ...
            ...
            """
                ...
            def afterMake(self) -> Genai.Agent.DynamicTrajectory.Step.Tag:
            """
            Optional override that will be called after every instance creation.
            ...
            """
                ...
            @classmethod
            def cachedEmptyInst(cls) -> Genai.Agent.DynamicTrajectory.Step.Tag:
            """
            Creates an empty inst using `MyType.make()` and caches it. Avoid recreating multiple copies of the spec for
            every action dispatch. The cached inst can also be used for comparing whether the object is an empty or not
            Will only create empty instance for immutable Obj e.g. if an Obj is Mutable, this method will throw an error
            ...
            """
                ...
            @classmethod
            def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[Genai.Agent.DynamicTrajectory.Step.Tag]]:
            """
            Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
            value is read.
            """
                ...
            @classmethod
            def generateObj(cls, spec: Obj.GenerateSpec=None) -> Genai.Agent.DynamicTrajectory.Step.Tag:
            """
            Generate a single instance of this type. The base implementation uses {@link DataGenObj} to generate uniform
            random (gibberish) values for all fields, but it may be overridden by specific types with custom logic that
            populates fields in a more realistic way.
    ...
    class StepSequence(Genai.Agent.Trajectory.Step):
        """
        A step in a {@link Genai.Agent.DynamicTrajectory}. May contain one or more {@link Genai.Agent.DynamicTrajectory.Step} substeps.
        
        @remarks this represents a made instance of Genai.Agent.DynamicTrajectory.StepSequence
        """
        ...
        steps: Optional[Array[Genai.Agent.DynamicTrajectory.Step]]=None
        """
        The sub-steps within this step.
        """
        ...
        The query or command for this step.
        """
        def __init__(self, stepId: Optional[str]=None, output: Optional[Union[any,Array[Genai.Agent.DynamicData]]]=None, status: Optional[str]=None, logs: Optional[any]=None, steps: Optional[Array[Genai.Agent.DynamicTrajectory.Step]]=None, query: Optional[str]=None) -> None: ...
        ...
        """
            ...
        @classmethod
        def fromJson(cls, json: any) -> Union[Genai.Agent.DynamicTrajectory.StepSequence]:
        """
        Load the JSON-based representation and reconstruct the corresponding object.
        ...
        """
            ...
        @classmethod
        def fromJsonString(cls, json: str) -> Union[Genai.Agent.DynamicTrajectory.StepSequence]:
        """
        Load the JSON-based representation and reconstruct the corresponding object.
        ...
        """
            ...
        @classmethod
        def fromXmlString(cls, xml: str) -> Union[Genai.Agent.DynamicTrajectory.StepSequence]:
        """
        Load the XML-based representation and reconstruct the corresponding object.
        ...
        """
            ...
        @classmethod
        def deserialize(cls, contentStr: str, contentType: str) -> Union[Genai.Agent.DynamicTrajectory.StepSequence]:
        """
        Load from contentType representation and reconstruct the corresponding object.
        ...
        """
            ...
        def replaceType(self, old: Type, new: Type) -> Genai.Agent.DynamicTrajectory.StepSequence:
        """
        Returns new instance with all references to old type, including result of #type, replaced with new type. If new
        type does not contain fields from old or field value types are not convertable then drops the field.
        ...
        """
            ...
        @overload
        def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> Genai.Agent.DynamicTrajectory.StepSequence:
        """
        Result of this function call is a copy of current instance with all non empty fields replaced based on results of
        the `mapper` invocation.
        ...
        """
            ...
        @overload
        def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> Genai.Agent.DynamicTrajectory.StepSequence:
        """
        Result of this function call is a copy of current instance with all fields replaced based on results of the
        `mapper` invocation.
        ...
        """
            ...
        @overload
        def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[Genai.Agent.DynamicTrajectory.StepSequence]:
        """
        Result of this function call is a copy of current instance with all non empty fields replaced based on results of
        the asynchronous `mapper` invocation.
        ...
        """
            ...
        @overload
        def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[Genai.Agent.DynamicTrajectory.StepSequence]:
        """
        Result of this function call is a copy of current instance with all fields replaced based on results of the
        asynchronous `mapper` invocation.
        ...
        """
            ...
        def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> Genai.Agent.DynamicTrajectory.StepSequence:
        """
        Result of this function call is a copy of current instance with specified field value replaced based on result of
        the `mapper` invocation.
        @param field
        ...
        """
            ...
        @overload
        def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> Genai.Agent.DynamicTrajectory.StepSequence:
        """
        Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
        lambda application.
        ...
        """
            ...
        @overload
        def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> Genai.Agent.DynamicTrajectory.StepSequence:
        """
        Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
        lambda application.
        ...
        """
            ...
        @overload
        def validateObj(self) -> Genai.Agent.DynamicTrajectory.StepSequence:
        """
        Populates all missing default values and throws error if any constraint is violated.
        """
            ...
        ...
        """
            ...
        @overload
        def withField(self, field: str, value: Any, doNotConvert: bool=None) -> Genai.Agent.DynamicTrajectory.StepSequence:
        """
        Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
        defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
        ...
        """
            ...
        @overload
        def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> Genai.Agent.DynamicTrajectory.StepSequence:
        """
        Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
        defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
        ...
        """
            ...
        def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> Genai.Agent.DynamicTrajectory.StepSequence:
        """
        Builds a new Obj instance by adding the provided fields in it. The name must correspond to an existing fields
        defined on this type or its mixins. The values must be of the correct type if doNotConvert flag is true.
        ...
        """
            ...
        def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> Genai.Agent.DynamicTrajectory.StepSequence:
        """
        Builds a new Obj with the value at the specified path field. If the field is null, the field #isFieldSet to null.
        If you would like to #unsetField, you should call #withoutFieldAtPath instead.
        ...
        """
            ...
        def withoutFieldAtPath(self, path: str) -> Genai.Agent.DynamicTrajectory.StepSequence:
        """
        Builds a new Obj without the specified path field.
        ...
        """
            ...
        @overload
        def withoutField(self, field: str) -> Genai.Agent.DynamicTrajectory.StepSequence:
        """
        Builds a new Obj, removing the field with the provided name.
        ...
        """
            ...
        @overload
        def withoutField(self, field: FieldType) -> Genai.Agent.DynamicTrajectory.StepSequence:
        """
        Builds a new Obj, removing the field with the provided field type.
        ...
        """
            ...
        def withoutFields(self, fields: Array[str]) -> Genai.Agent.DynamicTrajectory.StepSequence:
        """
        Builds a new Obj, removing the fields with the provided names.
        ...
        """
            ...
        def withoutFieldsByType(self, fields: Array[FieldType]) -> Genai.Agent.DynamicTrajectory.StepSequence:
        """
        Builds a new Obj, removing the fields with the provided field types. Be sure to use the FieldType instance for the
        exact same type as the type of the obj to respect the "ordinal" of the field type
        ...
        """
            ...
        def withoutSecretFields(self) -> Genai.Agent.DynamicTrajectory.StepSequence:
        """
        @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
        """
            ...
        def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> Genai.Agent.DynamicTrajectory.StepSequence:
        """
        Builds a new Obj instance by adding the default values (if defined) for all unset fields. This is implemented by
        calling {@link FieldType#defaultValue defaultValue} for a field if it is not already set and
        {@link FieldType#hasDefault has a default}. It will also set {@see ValueType#initialValue initial values} for
        ...
        """
            ...
        @overload
        def defaultField(self, field: str) -> Genai.Agent.DynamicTrajectory.StepSequence:
        """
        Builds a new Obj, by setting a field on this `Obj` to the field's default value. If the field has no default, this
        method will behave the same as {@link #unsetField}.
        ...
        """
            ...
        @overload
        def defaultField(self, field: FieldType) -> Genai.Agent.DynamicTrajectory.StepSequence:
        """
        Builds a new Obj, by setting a field on this `Obj` to the fields default value. If the field has no default, this
        method will behave the same as {@link #unsetField}.
        ...
        """
            ...
        @overload
        def unsetField(self, field: str) -> Genai.Agent.DynamicTrajectory.StepSequence:
        """
        Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
        is different from {@link removeField}
        ...
        """
            ...
        @overload
        def unsetField(self, field: FieldType) -> Genai.Agent.DynamicTrajectory.StepSequence:
        """
        Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
        is different from {@link removeField}
        ...
        """
            ...
        @overload
        def removeField(self, field: str) -> Genai.Agent.DynamicTrajectory.StepSequence:
        """
        Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
        is different from {@link #unsetField}
        ...
        """
            ...
        @overload
        def removeField(self, field: FieldType) -> Genai.Agent.DynamicTrajectory.StepSequence:
        """
        Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
        is different from {@link #unsetField}
        ...
        """
            ...
        @overload
        def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> Genai.Agent.DynamicTrajectory.StepSequence:
        """
        Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
        In case of conflicts, fields of other instance take precedence unless otherwise specified by the fieldPathMergeSpec
        ...
        """
            ...
        @overload
        def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> Genai.Agent.DynamicTrajectory.StepSequence:
        """
        Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
        In case of conflicts, fields of other instance take precedence.
        ...
        """
            ...
        @overload
        def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> Genai.Agent.DynamicTrajectory.StepSequence:
        """
        Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
        fields that exist on other Obj and do not exist on this Obj will not be added to final Obj.
        @param deep
        ...
        """
            ...
        @overload
        def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> Genai.Agent.DynamicTrajectory.StepSequence:
        """
        Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
        fields that exist other Obj and do not exist on this Obj will not be added to final Obj or evaluated. Does not
        traverse child reference and collection fields.
        ...
        """
            ...
        def mergeJson(self, json: any) -> Genai.Agent.DynamicTrajectory.StepSequence:
            ...
        def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> Genai.Agent.DynamicTrajectory.StepSequence:
        """
        Merge the obj references within the current obj
        @param deep
               If set, traverses the reference fields within the obj as well for a deep merge
        ...
        """
            ...
        def sumObj(self, other: Obj, deep: bool=None) -> Genai.Agent.DynamicTrajectory.StepSequence:
        """
        Adds the numeric Obj fields with the other Objs respective fields.
        If deep is set it will traverse reference and collection fields and sum corresponding numeric fields in
        references with same name and collection elements at same index or key.
        """
            ...
        def singletonArray(self) -> Array[Genai.Agent.DynamicTrajectory.StepSequence]:
        """
        Build an array of the correct type with a single element which is this instance.
        ...
        """
            ...
        @classmethod
        def array(cls, *elements: Array[Any]) -> Union[Array[Genai.Agent.DynamicTrajectory.StepSequence]]:
        """
        Creates an array of instances of this type.
        """
            ...
        @classmethod
        def arrayBuilder(cls) -> Union[ArrayBuilder[Genai.Agent.DynamicTrajectory.StepSequence]]:
        """
        Creates an array of instances of this type.
        """
            ...
        def singletonSet(self) -> Set[Genai.Agent.DynamicTrajectory.StepSequence]:
        """
        Build an set of the correct type with a single element which is this instance.
        ...
        """
            ...
        @classmethod
        def setBuilder(cls) -> Union[SetBuilder[Genai.Agent.DynamicTrajectory.StepSequence]]:
        """
        Creates a set of instances of this type.
        """
            ...
        @classmethod
        def mapBuilder(cls) -> Union[MapBuilder[str, Genai.Agent.DynamicTrajectory.StepSequence]]:
        """
        Create a map of string to elements of this type.
        """
            ...
        @classmethod
        def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, Genai.Agent.DynamicTrajectory.StepSequence]]:
        """
        Create a map with the given key type and elements of this type.
        """
            ...
        ...
        def myStreamType(cls) -> StreamType:
            ...
        def toBuilder(self) -> ObjBuilder[Genai.Agent.DynamicTrajectory.StepSequence]:
        """
        @return new ObjBuilder with initial state set to fields of this instance.
        """
            ...
        @classmethod
        def builder(cls) -> ObjBuilder[Genai.Agent.DynamicTrajectory.StepSequence]:
        """
        @return new ObjBuilder of this instance.
        """
            ...
        @overload
        @classmethod
        def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> Genai.Agent.DynamicTrajectory.StepSequence:
        """
        Construct instance of this type from provided field values and options
        """
            ...
        @overload
        @classmethod
        def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> Genai.Agent.DynamicTrajectory.StepSequence:
        """
        Construct an instance of this type from provided fields
        @param fields
                   Fields to construct the instance of the obj with
        ...
        @overload
        @classmethod
        def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> Genai.Agent.DynamicTrajectory.StepSequence:
        """
        Construct instance of this type from provided field values and options
        """
            ...
        @overload
        @classmethod
        def make(cls, withDefaults: bool=None) -> Genai.Agent.DynamicTrajectory.StepSequence:
        """
        Construct an instance of this type with no non-default field values unless explicitly specified by passing param true
        @param withDefaults
                   If set, then the Obj is made with default & initial values (required primitive fields e.g. !int32 -> 0)
        ...
        @overload
        @classmethod
        def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> Genai.Agent.DynamicTrajectory.StepSequence:
        """
        Construct an instance from provided fields
        @param fields
                   Fields (in the format <field_name, value>) to construct an instance of the obj. Note that "type" as a
        ...
        @overload
        @classmethod
        def make(cls, fields: Any, withDefaults: bool=None) -> Genai.Agent.DynamicTrajectory.StepSequence:
        """
        Construct an instance of this type from provided fields. Note it is more efficient to use #fromFields and other overloads
        ...
        """
            ...
        @classmethod
        def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> Genai.Agent.DynamicTrajectory.StepSequence:
        """
        Construct an instance of this type from provided instance of a subtype or a "duck type".
        """
            ...
        ...
        """
            ...
        def afterMake(self) -> Genai.Agent.DynamicTrajectory.StepSequence:
        """
        Optional override that will be called after every instance creation.
        ...
        """
            ...
        @classmethod
        def cachedEmptyInst(cls) -> Genai.Agent.DynamicTrajectory.StepSequence:
        """
        Creates an empty inst using `MyType.make()` and caches it. Avoid recreating multiple copies of the spec for
        every action dispatch. The cached inst can also be used for comparing whether the object is an empty or not
        Will only create empty instance for immutable Obj e.g. if an Obj is Mutable, this method will throw an error
        ...
        """
            ...
        @classmethod
        def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[Genai.Agent.DynamicTrajectory.StepSequence]]:
        """
        Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
        value is read.
        """
            ...
        @classmethod
        def generateObj(cls, spec: Obj.GenerateSpec=None) -> Genai.Agent.DynamicTrajectory.StepSequence:
        """
        Generate a single instance of this type. The base implementation uses {@link DataGenObj} to generate uniform
        random (gibberish) values for all fields, but it may be overridden by specific types with custom logic that
        populates fields in a more realistic way.
