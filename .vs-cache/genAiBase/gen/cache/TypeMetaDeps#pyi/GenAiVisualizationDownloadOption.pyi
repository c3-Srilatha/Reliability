...
# Python definitions for the C3 type GenAiVisualizationDownloadOption


class GenAiVisualizationDownloadOption():
    """
    ...
    """
    def __init__(self, CSV: Optional[str]=None, PNG: Optional[str]=None, JPEG: Optional[str]=None) -> None: ...
