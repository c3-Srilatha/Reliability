...
# Python definitions for the C3 type Genai.Agent.Tool.TestTool2


class TestTool2(Genai.Agent.Tool.TestTool1):
    """
    Genai.Agent.Tool for testing purposes.
    
    @remarks this represents a made instance of Genai.Agent.Tool.TestTool2
    """
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[Genai.Agent.Tool.TestTool2]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[Genai.Agent.Tool.TestTool2]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[Genai.Agent.Tool.TestTool2]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[Genai.Agent.Tool.TestTool2]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> Genai.Agent.Tool.TestTool2:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> Genai.Agent.Tool.TestTool2:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> Genai.Agent.Tool.TestTool2:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[Genai.Agent.Tool.TestTool2]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[Genai.Agent.Tool.TestTool2]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> Genai.Agent.Tool.TestTool2:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> Genai.Agent.Tool.TestTool2:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> Genai.Agent.Tool.TestTool2:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> Genai.Agent.Tool.TestTool2:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> Genai.Agent.Tool.TestTool2:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> Genai.Agent.Tool.TestTool2:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> Genai.Agent.Tool.TestTool2:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> Genai.Agent.Tool.TestTool2:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> Genai.Agent.Tool.TestTool2:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> Genai.Agent.Tool.TestTool2:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> Genai.Agent.Tool.TestTool2:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> Genai.Agent.Tool.TestTool2:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> Genai.Agent.Tool.TestTool2:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> Genai.Agent.Tool.TestTool2:
    """
    @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> Genai.Agent.Tool.TestTool2:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> Genai.Agent.Tool.TestTool2:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> Genai.Agent.Tool.TestTool2:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> Genai.Agent.Tool.TestTool2:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> Genai.Agent.Tool.TestTool2:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> Genai.Agent.Tool.TestTool2:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> Genai.Agent.Tool.TestTool2:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> Genai.Agent.Tool.TestTool2:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> Genai.Agent.Tool.TestTool2:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> Genai.Agent.Tool.TestTool2:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> Genai.Agent.Tool.TestTool2:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> Genai.Agent.Tool.TestTool2:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> Genai.Agent.Tool.TestTool2:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> Genai.Agent.Tool.TestTool2:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[Genai.Agent.Tool.TestTool2]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[Genai.Agent.Tool.TestTool2]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[Genai.Agent.Tool.TestTool2]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[Genai.Agent.Tool.TestTool2]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[Genai.Agent.Tool.TestTool2]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, Genai.Agent.Tool.TestTool2]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, Genai.Agent.Tool.TestTool2]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[Genai.Agent.Tool.TestTool2]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[Genai.Agent.Tool.TestTool2]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> Genai.Agent.Tool.TestTool2:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> Genai.Agent.Tool.TestTool2:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> Genai.Agent.Tool.TestTool2:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> Genai.Agent.Tool.TestTool2:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> Genai.Agent.Tool.TestTool2:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> Genai.Agent.Tool.TestTool2:
    """
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[Genai.Agent.Tool.TestTool2]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> Genai.Agent.Tool.TestTool2:
    """
    ...
    """
        ...
    def afterMake(self) -> Genai.Agent.Tool.TestTool2:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> Genai.Agent.Tool.TestTool2:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[Genai.Agent.Tool.TestTool2]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> Genai.Agent.Tool.TestTool2:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, spec: FetchSpec=None) -> FetchResult[Genai.Agent.Tool.TestTool2]:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, filter: Filter) -> FetchResult[Genai.Agent.Tool.TestTool2]:
    """
    ...
    """
        ...
    @classmethod
    def fetchObjStream(cls, spec: FetchStreamSpec=None) -> Union[Stream[Genai.Agent.Tool.TestTool2]]:
    """
    Fetches multiple obj instances based on a specification.  Only objs that the caller is authorized to fetch will be
    returned.
    ...
    """
        ...
    @classmethod
    def fetchMultiLocale(cls, spec: MultiLocaleFetchSpec=None) -> Union[Map[str, FetchResult[Genai.Agent.Tool.TestTool2]]]:
    """
    ...
    """
        ...
    def dependencies(self) -> MetadataDeps[Genai.Agent.Tool.TestTool2]:
    """
    Retrieves dependencies to types or other metadata elements for the given instance of metadata.
    """
        ...
    def save(self, subPath: str=None, contentType: str=None) -> Genai.Agent.Tool.TestTool2:
        ...
    ...
    def removeAll(cls, removeFilter: str=None) -> int:
        ...
    def update(self, srcObj: Genai.Agent.Tool.TestTool2=None, spec: UpsertSpec=None) -> Union[Genai.Agent.Tool.TestTool2]:
        ...
    def upsert(self, srcObj: Genai.Agent.Tool.TestTool2=None, spec: UpsertSpec=None) -> Union[Genai.Agent.Tool.TestTool2]:
        ...
    @classmethod
    ...
    """
        ...
    @classmethod
    def fromString(cls, s: str) -> Union[Genai.Agent.Tool.TestTool2]:
    """
    ...
    """
        ...
    @classmethod
    def forId(cls, id: str, failIfMissing: bool=None) -> Union[Genai.Agent.Tool.TestTool2]:
    """
    ...
    """
        ...
    @classmethod
    def ensureId(cls, tool: Genai.Agent.Tool[Any]) -> Genai.Agent.Tool.TestTool2:
    """
