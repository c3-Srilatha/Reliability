...
# Python definitions for the C3 type Genai.Llm.Vllm


class Vllm(Genai.Llm):
    """
    Type for VLLM
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[Genai.Llm.Vllm]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[Genai.Llm.Vllm]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[Genai.Llm.Vllm]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[Genai.Llm.Vllm]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> Genai.Llm.Vllm:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> Genai.Llm.Vllm:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> Genai.Llm.Vllm:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[Genai.Llm.Vllm]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[Genai.Llm.Vllm]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> Genai.Llm.Vllm:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> Genai.Llm.Vllm:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> Genai.Llm.Vllm:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> Genai.Llm.Vllm:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> Genai.Llm.Vllm:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> Genai.Llm.Vllm:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> Genai.Llm.Vllm:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> Genai.Llm.Vllm:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> Genai.Llm.Vllm:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> Genai.Llm.Vllm:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> Genai.Llm.Vllm:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> Genai.Llm.Vllm:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> Genai.Llm.Vllm:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> Genai.Llm.Vllm:
    """
    @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> Genai.Llm.Vllm:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> Genai.Llm.Vllm:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> Genai.Llm.Vllm:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> Genai.Llm.Vllm:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> Genai.Llm.Vllm:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> Genai.Llm.Vllm:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> Genai.Llm.Vllm:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> Genai.Llm.Vllm:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> Genai.Llm.Vllm:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> Genai.Llm.Vllm:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> Genai.Llm.Vllm:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> Genai.Llm.Vllm:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> Genai.Llm.Vllm:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> Genai.Llm.Vllm:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[Genai.Llm.Vllm]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[Genai.Llm.Vllm]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[Genai.Llm.Vllm]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[Genai.Llm.Vllm]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[Genai.Llm.Vllm]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, Genai.Llm.Vllm]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, Genai.Llm.Vllm]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[Genai.Llm.Vllm]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[Genai.Llm.Vllm]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> Genai.Llm.Vllm:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> Genai.Llm.Vllm:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> Genai.Llm.Vllm:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> Genai.Llm.Vllm:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> Genai.Llm.Vllm:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> Genai.Llm.Vllm:
    """
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[Genai.Llm.Vllm]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> Genai.Llm.Vllm:
    """
    ...
    """
        ...
    def afterMake(self) -> Genai.Llm.Vllm:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> Genai.Llm.Vllm:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[Genai.Llm.Vllm]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> Genai.Llm.Vllm:
    """
    ...
    """
        ...
    @classmethod
    def fromString(cls, s: str) -> Union[Genai.Llm.Vllm]:
    """
    ...
    """
        ...
    @classmethod
    def forName(cls, name: str, failIfMissing: bool=None) -> Union[Genai.Llm.Vllm]:
    """
    ...
    """
        ...
    @classmethod
    def forId(cls, id: str, failIfMissing: bool=None) -> Union[Genai.Llm.Vllm]:
    """
    ...
    """
        ...
    @classmethod
    def deploy(cls, spec: Engine.DeploySpec) -> Genai.Llm.Vllm:
    """
    ...
    """
        ...
    def restart(self) -> Genai.Llm.Vllm:
    """
    Restarts this engine
    """
        ...
    def start(self, waitForReady: bool=None, spec: WaitableSpec=None) -> Union[Genai.Llm.Vllm]:
    """
    ...
    """
        ...
    def doStart(self) -> Genai.Llm.Vllm:
        ...
    ...
    """
        ...
    def call(self, action: Lambda[Callable[[Genai.Llm.Vllm], Union[T]]]) -> Union[T]:
    """
    call `action` on a specific engine
    """
        ...
    def onStart(self) -> Genai.Llm.Vllm:
    """
    ...
    """
        ...
    @classmethod
    def list(cls) -> Union[Array[Genai.Llm.Vllm]]:
    """
    ...
    """
        ...
    @classmethod
    def allHandlers(cls) -> Union[Array[Genai.Llm.Vllm]]:
    """
    Returns all handlers that can be used for requests
    """
        ...
    @classmethod
    def stopAllHandlers(cls) -> Union[Array[Genai.Llm.Vllm]]:
    """
