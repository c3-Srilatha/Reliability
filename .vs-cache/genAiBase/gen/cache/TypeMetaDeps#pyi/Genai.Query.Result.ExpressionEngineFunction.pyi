...
# Python definitions for the C3 type Genai.Query.Result.ExpressionEngineFunction
...
class ExpressionEngineFunction(ExpressionEngineFunction):
    ...
    **Note on ML applications**
    ...
    """
        ...
    @classmethod
    def getQueryLatency(cls, id: str) -> int:
    """
    ...
    """
        ...
    @classmethod
    def getParsedEngineLog(cls, id: str) -> any:
    """
    ...
    """
        ...
    @classmethod
    def getUserEmail(cls, userId: str=None) -> str:
    """
    ...
    """
        ...
    @classmethod
    def retrieveGetForUiResult(cls, id: str) -> Genai.Query.Result.GetForUiResult:
    """
