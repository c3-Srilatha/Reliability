...
# Python definitions for the C3 type Genai.Llm.UserFriendlyName


class UserFriendlyName():
    """
    ...
    GCP_PALM: Optional[str]=None
    """
    Family of language models available through Google Cloud Platform
    """
    def __init__(self, AWS_BEDROCK: Optional[str]=None, AZURE_OPENAI: Optional[str]=None, GCP_PALM: Optional[str]=None) -> None: ...
