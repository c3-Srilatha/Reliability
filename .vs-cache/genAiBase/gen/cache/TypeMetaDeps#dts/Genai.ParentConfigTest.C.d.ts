// TypeScript definitions for the C3 type Genai.ParentConfigTest.C

/**
 * Test type
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.ParentConfigTest.C
 */
 ...
 */
declare namespace Genai.ParentConfigTest {
  export class C extends Obj  {

    readonly configOverride?: string;
    withConfigOverride(configOverride: string | null): Genai.ParentConfigTest.C;

    readonly secretOverride?: string;
    withSecretOverride(secretOverride: string | null): Genai.ParentConfigTest.C;

    /**
     * Captures any issues that occurred while deserializing from filesystem
     */
    readonly issues?: Array_Type<string>;
    withIssues(issues: Array_Type<string> | Array<string> | null): Genai.ParentConfigTest.C;

    /**
     * The unique and required id of this instance.
     */
    readonly id: string;
    withId(id: string): Genai.ParentConfigTest.C;

    /**
     * Test string
     */
    readonly str?: string;
    withStr(str: string | null): Genai.ParentConfigTest.C;

    /**
     * Test number
     */
    readonly num?: number;
    withNum(num: number | null): Genai.ParentConfigTest.C;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.ParentConfigTest.C | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.ParentConfigTest.C | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.ParentConfigTest.C | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.ParentConfigTest.C | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.ParentConfigTest.C;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.ParentConfigTest.C;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.ParentConfigTest.C;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.ParentConfigTest.C>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.ParentConfigTest.C>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.ParentConfigTest.C;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.ParentConfigTest.C;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.ParentConfigTest.C;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.ParentConfigTest.C;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.ParentConfigTest.C;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.ParentConfigTest.C;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.ParentConfigTest.C;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.ParentConfigTest.C;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.ParentConfigTest.C;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.ParentConfigTest.C;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.ParentConfigTest.C;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.ParentConfigTest.C;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.ParentConfigTest.C;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.ParentConfigTest.C;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.ParentConfigTest.C;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.ParentConfigTest.C;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.ParentConfigTest.C;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.ParentConfigTest.C;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.ParentConfigTest.C;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.ParentConfigTest.C;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.ParentConfigTest.C;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.ParentConfigTest.C;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.ParentConfigTest.C;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.ParentConfigTest.C;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.ParentConfigTest.C;

    mergeJson(json: any): Genai.ParentConfigTest.C;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.ParentConfigTest.C;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.ParentConfigTest.C;
     ...
     */
    singletonArray(): Array_Type<Genai.ParentConfigTest.C>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.ParentConfigTest.C> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.ParentConfigTest.C> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.ParentConfigTest.C>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.ParentConfigTest.C> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.ParentConfigTest.C> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.ParentConfigTest.C> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.ParentConfigTest.C>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.ParentConfigTest.C>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.ParentConfigTest.C;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.ParentConfigTest.C;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.ParentConfigTest.C;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.ParentConfigTest.C;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.ParentConfigTest.C;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.ParentConfigTest.C;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.ParentConfigTest.C | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.ParentConfigTest.C;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.ParentConfigTest.C;
     ...
     */
    static cachedEmptyInst(): Genai.ParentConfigTest.C;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.ParentConfigTest.C> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.ParentConfigTest.C;
     ...
     */
    static allCached(): Stream<Genai.ParentConfigTest.C> | null;
     ...
     */
    static find(filter?: string): Stream<Genai.ParentConfigTest.C> | null;
     ...
     *         Otherwise no population will be performed.
     */
    static findBy(field: string, value: any): Stream<Genai.ParentConfigTest.C> | null;

    /**
     * @return cached instance.
     */
    getCached(): Genai.ParentConfigTest.C | null;

    /**
     * Returns cached instance by key, with secrets removed.
     */
    static forCacheKey(key: string): Genai.ParentConfigTest.C | null;
     ...
     */
    static produce(key: string): Genai.ParentConfigTest.C | null;

    /**
     * Should produces the entire content for the cached data. Will populate the cache with the produced data.
     */
    static produceAll(): Map_Type<string, Genai.ParentConfigTest.C> | null;
     ...
     */
    getConfig(): Genai.ParentConfigTest.C;
     ...
     */
    getSecret(): Genai.ParentConfigTest.C;
     ...
     */
    withConfigKey(configKey: string): Genai.ParentConfigTest.C;

    /**
     * @return copy without config key.
     */
    withoutConfigKey(): Genai.ParentConfigTest.C;

    /**
     * @return return cached config instance for provided config key.
     */
    static forConfigKey(configKey: string): Genai.ParentConfigTest.C | null;
     ...
     */
    static listConfigs(parallel?: boolean, filter?: λPredicate<string>): Stream<Genai.ParentConfigTest.C> | null;
     ...
     * @see setConfigValue
     */
    setConfigValues(from: Genai.ParentConfigTest.C, override?: string): void;
     ...
     */
    static loadConfigAndSecret(configKey: string): Genai.ParentConfigTest.C | null;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.ParentConfigTest.C | null;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Genai.ParentConfigTest.C | null;
  }
}
