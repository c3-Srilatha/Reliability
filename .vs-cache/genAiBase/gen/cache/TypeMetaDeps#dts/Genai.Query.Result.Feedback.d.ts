// TypeScript definitions for the C3 type Genai.Query.Result.Feedback

/**
 * Feedback given to the linked {@link Genai.Query.Result}.
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.Query.Result.Feedback
 */
 ...
 */
declare namespace Genai.Query.Result {
  export class Feedback extends Obj  {

    /**
     * Whether the {@link Genai.Query.Result} was helpful for the question asked.
     */
    readonly helpful: boolean;
    withHelpful(helpful: boolean): Genai.Query.Result.Feedback;

    /**
     * The user's comment, if any, about the result.
     */
    readonly comment?: string;
    withComment(comment: string | null): Genai.Query.Result.Feedback;

    /**
     * Additional feedback options selected.
     */
    readonly additionalFeedback?: Array_Type<string>;
    withAdditionalFeedback(additionalFeedback: Array_Type<string> | Array<string> | null): Genai.Query.Result.Feedback;

    /**
     * The step in the {@link Genai.Agent.DynamicTrajectory} that this feedback is associated with.
     */
    readonly trajectoryStep?: Genai.Agent.DynamicTrajectory.Step;
    withTrajectoryStep(trajectoryStep: IGenai.Agent.DynamicTrajectory.Step | null): Genai.Query.Result.Feedback;
     ...
     */
    readonly id: string;
    withId(id: string): Genai.Query.Result.Feedback;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Genai.Query.Result.Feedback;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): Genai.Query.Result.Feedback;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): Genai.Query.Result.Feedback;
    ...
    withVersion(version: number | null): Genai.Query.Result.Feedback;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): Genai.Query.Result.Feedback;

    /**
     * The {@link Genai.Query.Result} the feedback is for.
     */
    readonly generativeAiResult: Genai.Query.Result;
    withGenerativeAiResult(generativeAiResult: IGenai.Query.Result): Genai.Query.Result.Feedback;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.Query.Result.Feedback | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.Query.Result.Feedback | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.Query.Result.Feedback | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.Query.Result.Feedback | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.Query.Result.Feedback;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Query.Result.Feedback;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Query.Result.Feedback;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Query.Result.Feedback>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Query.Result.Feedback>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.Query.Result.Feedback;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Query.Result.Feedback;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Query.Result.Feedback;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.Query.Result.Feedback;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.Query.Result.Feedback;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.Query.Result.Feedback;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.Query.Result.Feedback;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.Query.Result.Feedback;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.Query.Result.Feedback;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.Query.Result.Feedback;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.Query.Result.Feedback;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.Query.Result.Feedback;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.Query.Result.Feedback;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.Query.Result.Feedback;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.Query.Result.Feedback;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.Query.Result.Feedback;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.Query.Result.Feedback;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.Query.Result.Feedback;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.Query.Result.Feedback;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.Query.Result.Feedback;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.Query.Result.Feedback;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.Query.Result.Feedback;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.Query.Result.Feedback;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.Query.Result.Feedback;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.Query.Result.Feedback;

    mergeJson(json: any): Genai.Query.Result.Feedback;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.Query.Result.Feedback;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.Query.Result.Feedback;
     ...
     */
    singletonArray(): Array_Type<Genai.Query.Result.Feedback>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.Query.Result.Feedback> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.Query.Result.Feedback> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.Query.Result.Feedback>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.Query.Result.Feedback> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.Query.Result.Feedback> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.Query.Result.Feedback> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.Query.Result.Feedback>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.Query.Result.Feedback>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.Query.Result.Feedback;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.Query.Result.Feedback;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.Query.Result.Feedback;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.Query.Result.Feedback;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.Query.Result.Feedback;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.Query.Result.Feedback;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.Query.Result.Feedback | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.Query.Result.Feedback;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.Query.Result.Feedback;
     ...
     */
    static cachedEmptyInst(): Genai.Query.Result.Feedback;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.Query.Result.Feedback> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.Query.Result.Feedback;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<Genai.Query.Result.Feedback>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Genai.Query.Result.Feedback>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<Genai.Query.Result.Feedback> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Genai.Query.Result.Feedback>> | null;
     ...
     */
    get(include?: string): Genai.Query.Result.Feedback | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): Genai.Query.Result.Feedback | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Genai.Query.Result.Feedback;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): Genai.Query.Result.Feedback | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Genai.Query.Result.Feedback;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.Query.Result.Feedback | null;
     ...
     */
    create(spec?: UpsertSpec): Genai.Query.Result.Feedback | null;
     ...
     */
    static createBatch(objs: Array_Type<Genai.Query.Result.Feedback>, spec?: UpsertSpec): ObjList<Genai.Query.Result.Feedback> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Genai.Query.Result.Feedback>, spec?: CreateBatchObjStreamSpec): ObjList<Genai.Query.Result.Feedback> | null;
     ...
     */
    update(srcObj?: Genai.Query.Result.Feedback, spec?: UpsertSpec): Genai.Query.Result.Feedback | null;
     ...
     */
    upsert(srcObj?: Genai.Query.Result.Feedback, spec?: UpsertSpec): Genai.Query.Result.Feedback | null;
     ...
     */
    merge(spec?: MergeSpec): Genai.Query.Result.Feedback | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): Genai.Query.Result.Feedback | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): Genai.Query.Result.Feedback | null;
     ...
     */
    static updateBatch(objs: Array_Type<Genai.Query.Result.Feedback>, srcObjs?: Array_Type<Genai.Query.Result.Feedback>, spec?: UpsertSpec): ObjList<Genai.Query.Result.Feedback> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<Genai.Query.Result.Feedback> | null>, spec?: UpsertSpec): ObjList<Genai.Query.Result.Feedback> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<Genai.Query.Result.Feedback>, srcObjs?: Array_Type<Genai.Query.Result.Feedback>, spec?: UpsertSpec): ObjList<Genai.Query.Result.Feedback> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<Genai.Query.Result.Feedback> | null>, spec?: UpsertSpec): ObjList<Genai.Query.Result.Feedback> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<Genai.Query.Result.Feedback>, spec?: TouchSpec): ObjList<Genai.Query.Result.Feedback> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.Query.Result.Feedback>, spec?: MergeSpec): ObjList<Genai.Query.Result.Feedback> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.Query.Result.Feedback>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.Query.Result.Feedback> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<Genai.Query.Result.Feedback> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.Query.Result.Feedback> | null;
     ...
     */
    static mergeAll(mergeObj: Genai.Query.Result.Feedback, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Genai.Query.Result.Feedback, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<Genai.Query.Result.Feedback>, spec?: UpsertSpec): ObjList<Genai.Query.Result.Feedback> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<Genai.Query.Result.Feedback>, spec?: UpsertSpec): ObjList<Genai.Query.Result.Feedback> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): Genai.Query.Result.Feedback | null;
     ...
     */
    static beforeCreate(objs: Array_Type<Genai.Query.Result.Feedback>): ObjList<Genai.Query.Result.Feedback>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<Genai.Query.Result.Feedback>): ObjList<Genai.Query.Result.Feedback>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<Genai.Query.Result.Feedback>): ObjList<Genai.Query.Result.Feedback>;
     ...
     */
    static afterCreate(objs: Array_Type<Genai.Query.Result.Feedback>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<Genai.Query.Result.Feedback>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<Genai.Query.Result.Feedback>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<Genai.Query.Result.Feedback>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Genai.Query.Result.Feedback>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Genai.Query.Result.Feedback | null;
     ...
     */
    withoutIdentity(): Genai.Query.Result.Feedback | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<Genai.Query.Result.Feedback>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: Genai.Query.Result.Feedback, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<Genai.Query.Result.Feedback>, callback?: λFunction<Genai.Query.Result.Feedback | null, Genai.Query.Result.Feedback | null>): ObjList<Genai.Query.Result.Feedback>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<Genai.Query.Result.Feedback>, callback?: λFunction<Genai.Query.Result.Feedback | null, Genai.Query.Result.Feedback | null>): Array_Type<ObjError> | null;
