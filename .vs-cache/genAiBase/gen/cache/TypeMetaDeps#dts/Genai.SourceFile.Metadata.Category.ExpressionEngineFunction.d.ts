// TypeScript definitions for the C3 type Genai.SourceFile.Metadata.Category.ExpressionEngineFunction
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.SourceFile.Metadata.Category.ExpressionEngineFunction
 */
declare namespace Genai.SourceFile.Metadata.Category {
  export interface IExpressionEngineFunction {
  }
}
 ...
 */
declare namespace Genai.SourceFile.Metadata.Category {
  export class ExpressionEngineFunction {
     ...
     */
    static generateCreatedBy(id: string, user: string): string | null;
     ...
     */
    static getNumberOfDocuments(id: string): number;
  }
}
