// TypeScript definitions for the C3 type Genai.PrivilegedAction
 ...
 * ```
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.PrivilegedAction
 */
...
declare namespace Genai {
  export class PrivilegedAction {
     ...
     */
    static setFileSystemMount(rootUrl: string, mountName: string): void;
     ...
     *      The name of the mount in {@link FileSystem#mounts} for the {@link Genai.SourceSystem}
     */
    static removeFileSystemMount(rootUrl: string, mountName: string): void;
     ...
     */
    static setCredentialsForResource(rootUrl: string, bucketName: string, credentials: CloudCredentials): void;
     ...
     */
    static getDefaultCredentials(rootUrl: string): CloudCredentials;
     ...
     */
    static getCloudResource(rootUrl: string, bucketName: string): CloudResource;

    /**
     * Clears the cache for {@link AwsS3Bucket}
     */
    static clearAwsBucketCache(): void;

    /**
     * Enables the {@link S3FileSystem}
     */
    static enableS3FileSystem(): void;

    /**
     * Returns the {@link Genai.Llm.OpenAI.Config#apiKey}
     */
    static getOpenAiConfigSecret(config: Genai.Llm.OpenAI.Config): Genai.Llm.OpenAI.Config;

    /**
     * Returns the {@link Genai.Llm.AwsBedrock.Config#secretAccessKey}
     */
    static getAwsBedrockConfigSecret(config: Genai.Llm.AwsBedrock.Config): Genai.Llm.AwsBedrock.Config;

    /**
     * Returns the {@link Genai.Llm.Gcp.Config#serviceAccountInfo}
     */
    static getGcpPalmConfigSecret(config: Genai.Llm.Gcp.Config): Genai.Llm.Gcp.Config;

    /**
     * Returns the {@link Genai.Llm.VllmHostedModel.Config#endpoint}
     */
    static getVllmHostedModelConfigSecret(config: Genai.Llm.VllmHostedModel.Config): Genai.Llm.VllmHostedModel.Config;

    /**
     * Returns the {@link Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig#vllmEndpoint}
     */
    static getModelInferenceConfigSecret(config: Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig): Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig;
  }
}
