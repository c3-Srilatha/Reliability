// TypeScript definitions for the C3 type Genai.Agent.DynamicTrajectory.ExpressionEngineFunction

/**
 * Custom {@link ExpressionEngineFunction}s used to calculate complex calc fields for {@link Genai.Agent.DynamicTrajectory}
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.Agent.DynamicTrajectory.ExpressionEngineFunction
 */
declare namespace Genai.Agent.DynamicTrajectory {
...
declare namespace Genai.Agent.DynamicTrajectory {
  export class ExpressionEngineFunction {
     ...
     */
    static getAgentInitializationLatency(id: string): number;
     ...
     */
    static getAgentExecutionLatency(id: string): number;
  }
}
