// TypeScript definitions for the C3 type Genai.Retriever.Dense

/**
 * The Dense Genai.Retriever. Allows selecting the embedder and retriever to use.
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.Retriever.Dense
 */
declare namespace Genai.Retriever {
  export interface IDense {
 ...
 */
declare namespace Genai.Retriever {
  export class Dense extends Obj  {
    ...
    withReadOnly(readOnly: boolean): Genai.Retriever.Dense;

    /**
     * If true, when loading a seeded read-only retriever, `initialize` will also call `populateSourceFilesForName`
     */
    readonly fabricateSources?: boolean;
    withFabricateSources(fabricateSources: boolean): Genai.Retriever.Dense;

    /**
     * If #fabricateSources is true, this will be set to true if the sources have been fabricated.
     */
    readonly sourcesFabricated?: boolean;
    withSourcesFabricated(sourcesFabricated: boolean): Genai.Retriever.Dense;
    ...
    withIndexZipUrl(indexZipUrl: string | null): Genai.Retriever.Dense;
    ...
    withDevice(device: string): Genai.Retriever.Dense;
    ...
    withIndexerNodePoolMatrix(indexerNodePoolMatrix: Map_Type<number, string> | {[key: number]: string} | null): Genai.Retriever.Dense;
    ...
    withMaxTries(maxTries: number | null): Genai.Retriever.Dense;
    ...
    withIndexingBatchSize(indexingBatchSize: number | null): Genai.Retriever.Dense;
    ...
    withQueryPreprocessLambda(queryPreprocessLambda: λFunction<string, string> | null): Genai.Retriever.Dense;

    /**
     * The {@link Genai.Project} this instance is linked to.
     */
    readonly projects?: Array_Type<Genai.Project>;
    withProjects(projects: Array_Type<Genai.Project> | Array<IGenai.Project> | null): Genai.Retriever.Dense;
    ...
    withTypeIdent(typeIdent: string | null): Genai.Retriever.Dense;
     ...
     */
    readonly id: string;
    withId(id: string): Genai.Retriever.Dense;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Genai.Retriever.Dense;

    /**
     * Name of the Obj instance
     */
    readonly name: string;
    withName(name: string): Genai.Retriever.Dense;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): Genai.Retriever.Dense;
    ...
    withVersion(version: number | null): Genai.Retriever.Dense;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): Genai.Retriever.Dense;

    /**
     * All of the index actions dispatched asynchronously for this retriever
     */
    readonly indexActions?: Array_Type<Genai.Retriever.IndexAction>;
    withIndexActions(indexActions: Array_Type<Genai.Retriever.IndexAction> | Array<IGenai.Retriever.IndexAction> | null): Genai.Retriever.Dense;
    ...
    withEmbedderSpec(embedderSpec: IGenai.Embedder.Spec | null): Genai.Retriever.Dense;
    ...
    withQueryMaxlen(queryMaxlen: number): Genai.Retriever.Dense;

    /**
     * Ignored.
     */
    readonly embedderModelName?: string;
    withEmbedderModelName(embedderModelName: string | null): Genai.Retriever.Dense;

    /**
     * The dense retriever to use.
     */
    readonly denseRetrieverName: string;
    withDenseRetrieverName(denseRetrieverName: string): Genai.Retriever.Dense;
    ...
    withEngineThreadPoolSpec(engineThreadPoolSpec: IApp.Node.ThreadPool.Spec | null): Genai.Retriever.Dense;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.Retriever.Dense | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.Retriever.Dense | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.Retriever.Dense | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.Retriever.Dense | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.Retriever.Dense;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Retriever.Dense;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Retriever.Dense;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Retriever.Dense>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Retriever.Dense>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.Retriever.Dense;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Retriever.Dense;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Retriever.Dense;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.Retriever.Dense;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.Retriever.Dense;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.Retriever.Dense;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.Retriever.Dense;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.Retriever.Dense;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.Retriever.Dense;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.Retriever.Dense;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.Retriever.Dense;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.Retriever.Dense;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.Retriever.Dense;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.Retriever.Dense;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.Retriever.Dense;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.Retriever.Dense;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.Retriever.Dense;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.Retriever.Dense;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.Retriever.Dense;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.Retriever.Dense;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.Retriever.Dense;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.Retriever.Dense;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.Retriever.Dense;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.Retriever.Dense;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.Retriever.Dense;

    mergeJson(json: any): Genai.Retriever.Dense;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.Retriever.Dense;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.Retriever.Dense;
     ...
     */
    singletonArray(): Array_Type<Genai.Retriever.Dense>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.Retriever.Dense> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.Retriever.Dense> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.Retriever.Dense>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.Retriever.Dense> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.Retriever.Dense> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.Retriever.Dense> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.Retriever.Dense>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.Retriever.Dense>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.Retriever.Dense;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.Retriever.Dense;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.Retriever.Dense;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.Retriever.Dense;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.Retriever.Dense;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.Retriever.Dense;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.Retriever.Dense | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.Retriever.Dense;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.Retriever.Dense;
     ...
     */
    static cachedEmptyInst(): Genai.Retriever.Dense;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.Retriever.Dense> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.Retriever.Dense;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<Genai.Retriever.Dense>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Genai.Retriever.Dense>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<Genai.Retriever.Dense> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Genai.Retriever.Dense>> | null;
     ...
     */
    get(include?: string): Genai.Retriever.Dense | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): Genai.Retriever.Dense | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Genai.Retriever.Dense;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): Genai.Retriever.Dense | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Genai.Retriever.Dense;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.Retriever.Dense | null;
     ...
     */
    create(spec?: UpsertSpec): Genai.Retriever.Dense | null;
     ...
     */
    static createBatch(objs: Array_Type<Genai.Retriever.Dense>, spec?: UpsertSpec): ObjList<Genai.Retriever.Dense> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Genai.Retriever.Dense>, spec?: CreateBatchObjStreamSpec): ObjList<Genai.Retriever.Dense> | null;
     ...
     */
    update(srcObj?: Genai.Retriever.Dense, spec?: UpsertSpec): Genai.Retriever.Dense | null;
     ...
     */
    upsert(srcObj?: Genai.Retriever.Dense, spec?: UpsertSpec): Genai.Retriever.Dense | null;
     ...
     */
    merge(spec?: MergeSpec): Genai.Retriever.Dense | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): Genai.Retriever.Dense | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): Genai.Retriever.Dense | null;
     ...
     */
    static updateBatch(objs: Array_Type<Genai.Retriever.Dense>, srcObjs?: Array_Type<Genai.Retriever.Dense>, spec?: UpsertSpec): ObjList<Genai.Retriever.Dense> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<Genai.Retriever.Dense> | null>, spec?: UpsertSpec): ObjList<Genai.Retriever.Dense> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<Genai.Retriever.Dense>, srcObjs?: Array_Type<Genai.Retriever.Dense>, spec?: UpsertSpec): ObjList<Genai.Retriever.Dense> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<Genai.Retriever.Dense> | null>, spec?: UpsertSpec): ObjList<Genai.Retriever.Dense> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<Genai.Retriever.Dense>, spec?: TouchSpec): ObjList<Genai.Retriever.Dense> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.Retriever.Dense>, spec?: MergeSpec): ObjList<Genai.Retriever.Dense> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.Retriever.Dense>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.Retriever.Dense> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<Genai.Retriever.Dense> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.Retriever.Dense> | null;
     ...
     */
    static mergeAll(mergeObj: Genai.Retriever.Dense, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Genai.Retriever.Dense, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<Genai.Retriever.Dense>, spec?: UpsertSpec): ObjList<Genai.Retriever.Dense> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<Genai.Retriever.Dense>, spec?: UpsertSpec): ObjList<Genai.Retriever.Dense> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): Genai.Retriever.Dense | null;
     ...
     */
    static beforeCreate(objs: Array_Type<Genai.Retriever.Dense>): ObjList<Genai.Retriever.Dense>;
     ...
     */
    static beforeUpdate(objs: Array_Type<Genai.Retriever.Dense>): ObjList<Genai.Retriever.Dense>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<Genai.Retriever.Dense>): ObjList<Genai.Retriever.Dense>;
     ...
     */
    static afterCreate(objs: Array_Type<Genai.Retriever.Dense>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<Genai.Retriever.Dense>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<Genai.Retriever.Dense>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<Genai.Retriever.Dense>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Genai.Retriever.Dense>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Genai.Retriever.Dense | null;
     ...
     */
    withoutIdentity(): Genai.Retriever.Dense | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<Genai.Retriever.Dense>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: Genai.Retriever.Dense, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<Genai.Retriever.Dense>, callback?: λFunction<Genai.Retriever.Dense | null, Genai.Retriever.Dense | null>): ObjList<Genai.Retriever.Dense>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<Genai.Retriever.Dense>, callback?: λFunction<Genai.Retriever.Dense | null, Genai.Retriever.Dense | null>): Array_Type<ObjError> | null;
