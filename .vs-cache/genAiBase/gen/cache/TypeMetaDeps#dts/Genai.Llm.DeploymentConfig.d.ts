// TypeScript definitions for the C3 type Genai.Llm.DeploymentConfig

/**
 * Provides configuration for {@link Genai.Llm} deployments.
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.Llm.DeploymentConfig
 */
 ...
 */
declare namespace Genai.Llm {
  export class DeploymentConfig extends Obj  {

    /**
     * The unique and required name of this instance.
     */
    readonly name: string;
    withName(name: string): Genai.Llm.DeploymentConfig;

    readonly configOverride?: string;
    withConfigOverride(configOverride: string | null): Genai.Llm.DeploymentConfig;

    readonly secretOverride?: string;
    withSecretOverride(secretOverride: string | null): Genai.Llm.DeploymentConfig;

    /**
     * Captures any issues that occurred while deserializing from filesystem
     */
    readonly issues?: Array_Type<string>;
    withIssues(issues: Array_Type<string> | Array<string> | null): Genai.Llm.DeploymentConfig;
    ...
    withDeploySpec(deploySpec: IEngine.DeploySpec | null): Genai.Llm.DeploymentConfig;
    ...
    withEngineThreadPoolSpec(engineThreadPoolSpec: IApp.Node.ThreadPool.Spec | null): Genai.Llm.DeploymentConfig;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.Llm.DeploymentConfig | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.Llm.DeploymentConfig | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.Llm.DeploymentConfig | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.Llm.DeploymentConfig | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.Llm.DeploymentConfig;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Llm.DeploymentConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Llm.DeploymentConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Llm.DeploymentConfig>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Llm.DeploymentConfig>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.Llm.DeploymentConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Llm.DeploymentConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Llm.DeploymentConfig;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.Llm.DeploymentConfig;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.Llm.DeploymentConfig;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.Llm.DeploymentConfig;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.Llm.DeploymentConfig;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.Llm.DeploymentConfig;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.Llm.DeploymentConfig;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.Llm.DeploymentConfig;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.Llm.DeploymentConfig;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.Llm.DeploymentConfig;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.Llm.DeploymentConfig;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.Llm.DeploymentConfig;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.Llm.DeploymentConfig;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.Llm.DeploymentConfig;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.Llm.DeploymentConfig;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.Llm.DeploymentConfig;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.Llm.DeploymentConfig;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.Llm.DeploymentConfig;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.Llm.DeploymentConfig;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.Llm.DeploymentConfig;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.Llm.DeploymentConfig;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.Llm.DeploymentConfig;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.Llm.DeploymentConfig;

    mergeJson(json: any): Genai.Llm.DeploymentConfig;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.Llm.DeploymentConfig;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.Llm.DeploymentConfig;
     ...
     */
    singletonArray(): Array_Type<Genai.Llm.DeploymentConfig>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.Llm.DeploymentConfig> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.Llm.DeploymentConfig> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.Llm.DeploymentConfig>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.Llm.DeploymentConfig> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.Llm.DeploymentConfig> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.Llm.DeploymentConfig> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.Llm.DeploymentConfig>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.Llm.DeploymentConfig>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.Llm.DeploymentConfig;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.Llm.DeploymentConfig;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.Llm.DeploymentConfig;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.Llm.DeploymentConfig;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.Llm.DeploymentConfig;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.Llm.DeploymentConfig;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.Llm.DeploymentConfig | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.Llm.DeploymentConfig;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.Llm.DeploymentConfig;
     ...
     */
    static cachedEmptyInst(): Genai.Llm.DeploymentConfig;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.Llm.DeploymentConfig> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.Llm.DeploymentConfig;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.Llm.DeploymentConfig | null;
     ...
     */
    static forName(name: string, failIfMissing?: boolean): Genai.Llm.DeploymentConfig | null;
     ...
     */
    static allCached(): Stream<Genai.Llm.DeploymentConfig> | null;
     ...
     */
    static find(filter?: string): Stream<Genai.Llm.DeploymentConfig> | null;
     ...
     *         Otherwise no population will be performed.
     */
    static findBy(field: string, value: any): Stream<Genai.Llm.DeploymentConfig> | null;

    /**
     * @return cached instance.
     */
    getCached(): Genai.Llm.DeploymentConfig | null;

    /**
     * Returns cached instance by key, with secrets removed.
     */
    static forCacheKey(key: string): Genai.Llm.DeploymentConfig | null;
     ...
     */
    static produce(key: string): Genai.Llm.DeploymentConfig | null;

    /**
     * Should produces the entire content for the cached data. Will populate the cache with the produced data.
     */
    static produceAll(): Map_Type<string, Genai.Llm.DeploymentConfig> | null;
     ...
     */
    getConfig(): Genai.Llm.DeploymentConfig;
     ...
     */
    getSecret(): Genai.Llm.DeploymentConfig;
     ...
     */
    withConfigKey(configKey: string): Genai.Llm.DeploymentConfig;

    /**
     * @return copy without config key.
     */
    withoutConfigKey(): Genai.Llm.DeploymentConfig;

    /**
     * @return return cached config instance for provided config key.
     */
    static forConfigKey(configKey: string): Genai.Llm.DeploymentConfig | null;
     ...
     */
    static listConfigs(parallel?: boolean, filter?: λPredicate<string>): Stream<Genai.Llm.DeploymentConfig> | null;
     ...
     * @see setConfigValue
     */
    setConfigValues(from: Genai.Llm.DeploymentConfig, override?: string): void;
     ...
     */
    static loadConfigAndSecret(configKey: string): Genai.Llm.DeploymentConfig | null;
     ...
     */
    static getDeploymentConfigKey(typeName: string): string;
  }
}
