// TypeScript definitions for the C3 type Genai.Llm.Vllm

/**
 * Type for VLLM
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.Llm.Vllm
 */
 ...
 * Type for VLLM
 *
 * @remarks this represents a made instance of Genai.Llm.Vllm
 */
declare namespace Genai.Llm {
  export class Vllm extends Obj  {

    /**
     * The unique and required name of this instance.
     */
    readonly name: string;
    withName(name: string): Genai.Llm.Vllm;
     ...
     */
    readonly id: string;
    withId(id: string): Genai.Llm.Vllm;
    ...
    with_deploymentCache(_deploymentCache: any | null): Genai.Llm.Vllm;
    ...
    with_onStartError(_onStartError: string | null): Genai.Llm.Vllm;
    ...
    withLlmType(llmType: string): Genai.Llm.Vllm;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.Llm.Vllm | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.Llm.Vllm | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.Llm.Vllm | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.Llm.Vllm | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.Llm.Vllm;
     ...
     * This method is used during live metadata update
     */
    static replaceType(old: Type, new_: Type): Genai.Llm.Vllm;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Llm.Vllm;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Llm.Vllm;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Llm.Vllm;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Llm.Vllm;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Llm.Vllm>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Llm.Vllm>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Llm.Vllm>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Llm.Vllm>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.Llm.Vllm;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.Llm.Vllm;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Llm.Vllm;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Llm.Vllm;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Llm.Vllm;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Llm.Vllm;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.Llm.Vllm;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    static validateObj(): Genai.Llm.Vllm;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.Llm.Vllm;
     ...
     * @see #defaultField
     */
    static withField(field: string, value: any, doNotConvert?: boolean): Genai.Llm.Vllm;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.Llm.Vllm;
     ...
     * @see #defaultField
     */
    static withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.Llm.Vllm;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.Llm.Vllm;
     ...
     * @return new Obj
     */
    static withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.Llm.Vllm;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.Llm.Vllm;
     ...
     * @return new Obj
     */
    static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.Llm.Vllm;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.Llm.Vllm;
     ...
     * @see #withoutField
     */
    static withoutFieldAtPath(path: string): Genai.Llm.Vllm;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.Llm.Vllm;
     ...
     * @see #removeField
     */
    static withoutField(field: string): Genai.Llm.Vllm;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.Llm.Vllm;
     ...
     * @see #removeField
     */
    static withoutField(field: FieldType): Genai.Llm.Vllm;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.Llm.Vllm;
     ...
     * @return new Obj with removed fields
     */
    static withoutFields(fields: Array_Type<string>): Genai.Llm.Vllm;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.Llm.Vllm;
     ...
     * @return new Obj with removed fields
     */
    static withoutFieldsByType(fields: Array_Type<FieldType>): Genai.Llm.Vllm;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.Llm.Vllm;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    static withoutSecretFields(): Genai.Llm.Vllm;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.Llm.Vllm;
     ...
     * @see FieldType#defaultValue
     */
    static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.Llm.Vllm;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.Llm.Vllm;
     ...
     * @see #unsetField
     */
    static defaultField(field: string): Genai.Llm.Vllm;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.Llm.Vllm;
     ...
     * @see #unsetField
     */
    static defaultField(field: FieldType): Genai.Llm.Vllm;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.Llm.Vllm;
     ...
     * @see #removeField
     */
    static unsetField(field: string): Genai.Llm.Vllm;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.Llm.Vllm;
     ...
     * @see #removeField
     */
    static unsetField(field: FieldType): Genai.Llm.Vllm;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.Llm.Vllm;
     ...
     * @see #unsetField
     */
    static removeField(field: string): Genai.Llm.Vllm;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.Llm.Vllm;
     ...
     * @see #unsetField
     */
    static removeField(field: FieldType): Genai.Llm.Vllm;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.Llm.Vllm;
     ...
     * @return the new merged Obj
     */
    static mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.Llm.Vllm;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.Llm.Vllm;
     ...
     * @return the new merged Obj
     */
    static mergeObj(other: Obj, otherFieldsFilter: Type): Genai.Llm.Vllm;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.Llm.Vllm;
     ...
     *        the same key or index.
     */
    static mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.Llm.Vllm;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.Llm.Vllm;
     ...
     * traverse child reference and collection fields.
     */
    static mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.Llm.Vllm;

    mergeJson(json: any): Genai.Llm.Vllm;

    static mergeJson(json: any): Genai.Llm.Vllm;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.Llm.Vllm;
     ...
     * @return Obj with child references merged
     */
    static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.Llm.Vllm;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.Llm.Vllm;
     ...
     * references with same name and collection elements at same index or key.
     */
    static sumObj(other: Obj, deep?: boolean): Genai.Llm.Vllm;
     ...
     */
    singletonArray(): Array_Type<Genai.Llm.Vllm>;
     ...
     * @return new array instance with this as only element.
     */
    static singletonArray(): Array_Type<Genai.Llm.Vllm>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.Llm.Vllm> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.Llm.Vllm> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.Llm.Vllm>;
     ...
     * @return new array instance with this as only element.
     */
    static singletonSet(): Set_Type<Genai.Llm.Vllm>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.Llm.Vllm> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.Llm.Vllm> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.Llm.Vllm> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.Llm.Vllm>;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    static toBuilder(): ObjBuilder<Genai.Llm.Vllm>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.Llm.Vllm>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.Llm.Vllm;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.Llm.Vllm;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.Llm.Vllm;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.Llm.Vllm;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.Llm.Vllm;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.Llm.Vllm;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.Llm.Vllm | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.Llm.Vllm;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    static afterMake(): Genai.Llm.Vllm;
     ...
     */
    static cachedEmptyInst(): Genai.Llm.Vllm;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.Llm.Vllm> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.Llm.Vllm;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.Llm.Vllm | null;
     ...
     */
    static forName(name: string, failIfMissing?: boolean): Genai.Llm.Vllm | null;

    /**
     * @return single instance of this Identified type by id.
     */
    static forId(id: string, failIfMissing?: boolean): Genai.Llm.Vllm | null;
     ...
     */
    static deploy(spec: Engine.DeploySpec): Genai.Llm.Vllm;
     ...
     */
    restart(): Genai.Llm.Vllm;

    /**
     * Restarts this engine
     */
    static restart(): Genai.Llm.Vllm;
     ...
     */
    start(waitForReady?: boolean, spec?: WaitableSpec): Genai.Llm.Vllm | null;
     ...
     * @return `null` if not waiting for ready and ready instance of the {@link Engine} otherwise.
     */
    static start(waitForReady?: boolean, spec?: WaitableSpec): Genai.Llm.Vllm | null;

    doStart(): Genai.Llm.Vllm;

    static doStart(): Genai.Llm.Vllm;
     ...
     */
    call(action: Lambda<function(engine: Genai.Llm.Vllm): T | null>): T | null;

    /**
     * call `action` on a specific engine
     */
    static call(action: Lambda<function(engine: Genai.Llm.Vllm): T | null>): T | null;
     ...
     * @see: #terminate
     */
    static list(): Array_Type<Genai.Llm.Vllm> | null;
     ...
     */
    static inst(): Genai.Llm.Vllm;

    /**
     * Returns all handlers that can be used for requests
     */
    static allHandlers(): Array_Type<Genai.Llm.Vllm> | null;

    /**
     * Stops all running handlers
     */
    static stopAllHandlers(): Array_Type<Genai.Llm.Vllm> | null;
