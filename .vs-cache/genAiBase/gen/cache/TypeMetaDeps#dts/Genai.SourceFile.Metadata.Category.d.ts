// TypeScript definitions for the C3 type Genai.SourceFile.Metadata.Category
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.SourceFile.Metadata.Category
 */
...
declare namespace Genai.SourceFile.Metadata {
  export class Category extends Obj  {
    ...
    withMetadataType(metadataType: string): Genai.SourceFile.Metadata.Category;

    /**
     * The {@link Genai.Project} this instance is linked to.
     */
    readonly projects?: Array_Type<Genai.Project>;
    withProjects(projects: Array_Type<Genai.Project> | Array<IGenai.Project> | null): Genai.SourceFile.Metadata.Category;
     ...
     */
    readonly id: string;
    withId(id: string): Genai.SourceFile.Metadata.Category;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Genai.SourceFile.Metadata.Category;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): Genai.SourceFile.Metadata.Category;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): Genai.SourceFile.Metadata.Category;
    ...
    withVersion(version: number | null): Genai.SourceFile.Metadata.Category;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): Genai.SourceFile.Metadata.Category;

    /**
     * The label of the category.
     */
    readonly label: string;
    withLabel(label: string): Genai.SourceFile.Metadata.Category;
    ...
    withExamples(examples: Array_Type<string> | Array<string> | null): Genai.SourceFile.Metadata.Category;

    /**
     * The {@link Genai.SourceFile.Metadata.Tag}s that belong to this category.
     */
    readonly tags?: Array_Type<Genai.SourceFile.Metadata.Tag>;
    withTags(tags: Array_Type<Genai.SourceFile.Metadata.Tag> | Array<IGenai.SourceFile.Metadata.Tag> | null): Genai.SourceFile.Metadata.Category;

    /**
     * The {@link User} that created this category.
     */
    readonly createdBy?: string;
    withCreatedBy(createdBy: string | null): Genai.SourceFile.Metadata.Category;

    /**
     * Number of {@link Genai.SourceFile} documents that have the {@link Genai.SourceFile.Metadata.Tag}s that belong to this category.
     */
    readonly documentsCount?: number;
    withDocumentsCount(documentsCount: number | null): Genai.SourceFile.Metadata.Category;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.SourceFile.Metadata.Category | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.SourceFile.Metadata.Category | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.SourceFile.Metadata.Category | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.SourceFile.Metadata.Category | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.SourceFile.Metadata.Category;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.SourceFile.Metadata.Category;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.SourceFile.Metadata.Category;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.SourceFile.Metadata.Category>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.SourceFile.Metadata.Category>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.SourceFile.Metadata.Category;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.SourceFile.Metadata.Category;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.SourceFile.Metadata.Category;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.SourceFile.Metadata.Category;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.SourceFile.Metadata.Category;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.SourceFile.Metadata.Category;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.SourceFile.Metadata.Category;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.SourceFile.Metadata.Category;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.SourceFile.Metadata.Category;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.SourceFile.Metadata.Category;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.SourceFile.Metadata.Category;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.SourceFile.Metadata.Category;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.SourceFile.Metadata.Category;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.SourceFile.Metadata.Category;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.SourceFile.Metadata.Category;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.SourceFile.Metadata.Category;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.SourceFile.Metadata.Category;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.SourceFile.Metadata.Category;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.SourceFile.Metadata.Category;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.SourceFile.Metadata.Category;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.SourceFile.Metadata.Category;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.SourceFile.Metadata.Category;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.SourceFile.Metadata.Category;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.SourceFile.Metadata.Category;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.SourceFile.Metadata.Category;

    mergeJson(json: any): Genai.SourceFile.Metadata.Category;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.SourceFile.Metadata.Category;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.SourceFile.Metadata.Category;
     ...
     */
    singletonArray(): Array_Type<Genai.SourceFile.Metadata.Category>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.SourceFile.Metadata.Category> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.SourceFile.Metadata.Category> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.SourceFile.Metadata.Category>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.SourceFile.Metadata.Category> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.SourceFile.Metadata.Category> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.SourceFile.Metadata.Category> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.SourceFile.Metadata.Category>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.SourceFile.Metadata.Category>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.SourceFile.Metadata.Category;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.SourceFile.Metadata.Category;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.SourceFile.Metadata.Category;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.SourceFile.Metadata.Category;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.SourceFile.Metadata.Category;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.SourceFile.Metadata.Category;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.SourceFile.Metadata.Category | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.SourceFile.Metadata.Category;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.SourceFile.Metadata.Category;
     ...
     */
    static cachedEmptyInst(): Genai.SourceFile.Metadata.Category;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.SourceFile.Metadata.Category> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.SourceFile.Metadata.Category;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<Genai.SourceFile.Metadata.Category>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Genai.SourceFile.Metadata.Category>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<Genai.SourceFile.Metadata.Category> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Genai.SourceFile.Metadata.Category>> | null;
     ...
     */
    get(include?: string): Genai.SourceFile.Metadata.Category | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): Genai.SourceFile.Metadata.Category | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Genai.SourceFile.Metadata.Category;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): Genai.SourceFile.Metadata.Category | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Genai.SourceFile.Metadata.Category;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.SourceFile.Metadata.Category | null;
     ...
     */
    create(spec?: UpsertSpec): Genai.SourceFile.Metadata.Category | null;
     ...
     */
    static createBatch(objs: Array_Type<Genai.SourceFile.Metadata.Category>, spec?: UpsertSpec): ObjList<Genai.SourceFile.Metadata.Category> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Genai.SourceFile.Metadata.Category>, spec?: CreateBatchObjStreamSpec): ObjList<Genai.SourceFile.Metadata.Category> | null;
     ...
     */
    update(srcObj?: Genai.SourceFile.Metadata.Category, spec?: UpsertSpec): Genai.SourceFile.Metadata.Category | null;
     ...
     */
    upsert(srcObj?: Genai.SourceFile.Metadata.Category, spec?: UpsertSpec): Genai.SourceFile.Metadata.Category | null;
     ...
     */
    merge(spec?: MergeSpec): Genai.SourceFile.Metadata.Category | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): Genai.SourceFile.Metadata.Category | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): Genai.SourceFile.Metadata.Category | null;
     ...
     */
    static updateBatch(objs: Array_Type<Genai.SourceFile.Metadata.Category>, srcObjs?: Array_Type<Genai.SourceFile.Metadata.Category>, spec?: UpsertSpec): ObjList<Genai.SourceFile.Metadata.Category> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<Genai.SourceFile.Metadata.Category> | null>, spec?: UpsertSpec): ObjList<Genai.SourceFile.Metadata.Category> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<Genai.SourceFile.Metadata.Category>, srcObjs?: Array_Type<Genai.SourceFile.Metadata.Category>, spec?: UpsertSpec): ObjList<Genai.SourceFile.Metadata.Category> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<Genai.SourceFile.Metadata.Category> | null>, spec?: UpsertSpec): ObjList<Genai.SourceFile.Metadata.Category> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<Genai.SourceFile.Metadata.Category>, spec?: TouchSpec): ObjList<Genai.SourceFile.Metadata.Category> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.SourceFile.Metadata.Category>, spec?: MergeSpec): ObjList<Genai.SourceFile.Metadata.Category> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.SourceFile.Metadata.Category>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.SourceFile.Metadata.Category> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<Genai.SourceFile.Metadata.Category> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.SourceFile.Metadata.Category> | null;
     ...
     */
    static mergeAll(mergeObj: Genai.SourceFile.Metadata.Category, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Genai.SourceFile.Metadata.Category, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<Genai.SourceFile.Metadata.Category>, spec?: UpsertSpec): ObjList<Genai.SourceFile.Metadata.Category> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<Genai.SourceFile.Metadata.Category>, spec?: UpsertSpec): ObjList<Genai.SourceFile.Metadata.Category> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): Genai.SourceFile.Metadata.Category | null;
     ...
     */
    static beforeCreate(objs: Array_Type<Genai.SourceFile.Metadata.Category>): ObjList<Genai.SourceFile.Metadata.Category>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<Genai.SourceFile.Metadata.Category>): ObjList<Genai.SourceFile.Metadata.Category>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<Genai.SourceFile.Metadata.Category>): ObjList<Genai.SourceFile.Metadata.Category>;
     ...
     */
    static afterCreate(objs: Array_Type<Genai.SourceFile.Metadata.Category>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<Genai.SourceFile.Metadata.Category>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<Genai.SourceFile.Metadata.Category>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<Genai.SourceFile.Metadata.Category>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Genai.SourceFile.Metadata.Category>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Genai.SourceFile.Metadata.Category | null;
     ...
     */
    withoutIdentity(): Genai.SourceFile.Metadata.Category | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<Genai.SourceFile.Metadata.Category>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: Genai.SourceFile.Metadata.Category, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<Genai.SourceFile.Metadata.Category>, callback?: λFunction<Genai.SourceFile.Metadata.Category | null, Genai.SourceFile.Metadata.Category | null>): ObjList<Genai.SourceFile.Metadata.Category>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<Genai.SourceFile.Metadata.Category>, callback?: λFunction<Genai.SourceFile.Metadata.Category | null, Genai.SourceFile.Metadata.Category | null>): Array_Type<ObjError> | null;
     ...
     */
    static fromSpec(spec: Genai.SourceFile.Metadata.Category.Spec): Genai.SourceFile.Metadata.Category;
  }
}
