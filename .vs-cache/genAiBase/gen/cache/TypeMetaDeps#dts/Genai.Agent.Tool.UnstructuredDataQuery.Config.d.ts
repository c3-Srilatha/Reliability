// TypeScript definitions for the C3 type Genai.Agent.Tool.UnstructuredDataQuery.Config

/**
 * Config for {@link Genai.Agent.Tool.UnstructuredDataQuery}
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.Agent.Tool.UnstructuredDataQuery.Config
 */
declare namespace Genai.Agent.Tool.UnstructuredDataQuery {
...
declare namespace Genai.Agent.Tool.UnstructuredDataQuery {
  export class Config extends Obj  {
     ...
     */
    readonly id: string;
    withId(id: string): Genai.Agent.Tool.UnstructuredDataQuery.Config;
    ...
    withConfigOverride(configOverride: string | null): Genai.Agent.Tool.UnstructuredDataQuery.Config;

    static readonly configOverride?: string;

    readonly secretOverride?: string;
    withSecretOverride(secretOverride: string | null): Genai.Agent.Tool.UnstructuredDataQuery.Config;
    ...
    withIssues(issues: Array_Type<string> | Array<string> | null): Genai.Agent.Tool.UnstructuredDataQuery.Config;
    ...
    withToolName(toolName: string): Genai.Agent.Tool.UnstructuredDataQuery.Config;
    ...
    withToolDescription(toolDescription: string): Genai.Agent.Tool.UnstructuredDataQuery.Config;
    ...
    withFormattingMessage(formattingMessage: string | null): Genai.Agent.Tool.UnstructuredDataQuery.Config;
    ...
    withExamples(examples: Array_Type<Genai.Agent.Tool.Example> | Array<IGenai.Agent.Tool.Example> | null): Genai.Agent.Tool.UnstructuredDataQuery.Config;
    ...
    withUiOptions(uiOptions: IGenai.Agent.Tool.Config.UiOptions | null): Genai.Agent.Tool.UnstructuredDataQuery.Config;
    ...
    withOverrideRuntimeKwargs(overrideRuntimeKwargs: any | null): Genai.Agent.Tool.UnstructuredDataQuery.Config;
     ...
     * Tool description used by {@link Genai.Agent.Tool.MultiSourceSynthesizer}
     */
    readonly descriptionForMultiTool?: string;
    withDescriptionForMultiTool(descriptionForMultiTool: string | null): Genai.Agent.Tool.UnstructuredDataQuery.Config;

    /**
     * Tool description used by {@link Genai.Agent.Tool.MultiSourceSynthesizer}
     */
    static readonly descriptionForMultiTool?: string;

    /**
     * Description for data returned by {@link Genai.Agent.Tool.DataRetriever.Output}
     */
    readonly retrievedDataDescription?: Array_Type<string>;
    withRetrievedDataDescription(retrievedDataDescription: Array_Type<string> | Array<string> | null): Genai.Agent.Tool.UnstructuredDataQuery.Config;

    /**
     * Description for data returned by {@link Genai.Agent.Tool.DataRetriever.Output}
     */
    static readonly retrievedDataDescription?: Array_Type<string>;

    /**
     * Prompt for {@link Genai.Agent.Tool.DataRetriever#formatData}
     */
    readonly formatDataPrompt?: Genai.Prompt;
    withFormatDataPrompt(formatDataPrompt: IGenai.Prompt | null): Genai.Agent.Tool.UnstructuredDataQuery.Config;

    /**
     * Prompt for {@link Genai.Agent.Tool.DataRetriever#formatData}
     */
    static readonly formatDataPrompt?: Genai.Prompt;
    ...
    withNativeToolDocumentationOverride(nativeToolDocumentationOverride: any | null): Genai.Agent.Tool.UnstructuredDataQuery.Config;
    ...
    withSerializeInputsForFunctionCall(serializeInputsForFunctionCall: boolean): Genai.Agent.Tool.UnstructuredDataQuery.Config;
     ...
     * If set to true then the time information will be extracted from the query and search results will be filtered on #dateFieldToFilter
     */
    readonly extractTimeInfoFromQuery?: boolean;
    withExtractTimeInfoFromQuery(extractTimeInfoFromQuery: boolean): Genai.Agent.Tool.UnstructuredDataQuery.Config;

    /**
     * If set to true then the time information will be extracted from the query and search results will be filtered on #dateFieldToFilter
     */
    static readonly extractTimeInfoFromQuery?: boolean;

    /**
     * {@link Genai.SourceFile.Metadata} field to filter on when #extractTimeInfoFromQuery is set to true
     */
    readonly dateFieldToFilter?: string;
    withDateFieldToFilter(dateFieldToFilter: string | null): Genai.Agent.Tool.UnstructuredDataQuery.Config;

    /**
     * {@link Genai.SourceFile.Metadata} field to filter on when #extractTimeInfoFromQuery is set to true
     */
    static readonly dateFieldToFilter?: string;
    ...
    withConfigName(configName: string | null): Genai.Agent.Tool.UnstructuredDataQuery.Config;

    /**
     * The name of the {@link Genai.UnstructuredQuery.Engine.Config} that this tool should use.
     * If not set, then the default pipeline config will be used.
     */
    static readonly configName?: string;

    /**
     * The name of the {@link Genai.UnstructuredQuery.Engine.REA.PipelineConfig} that this tool should use.
     * If not set, then the default pipeline config will be used.
     */
    readonly pipelineConfigName?: string;
    withPipelineConfigName(pipelineConfigName: string | null): Genai.Agent.Tool.UnstructuredDataQuery.Config;

    /**
     * The name of the {@link Genai.UnstructuredQuery.Engine.REA.PipelineConfig} that this tool should use.
     * If not set, then the default pipeline config will be used.
     */
    static readonly pipelineConfigName?: string;
     ...
     */
    static inst(): Genai.Agent.Tool.UnstructuredDataQuery.Config;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.Agent.Tool.UnstructuredDataQuery.Config | null;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.Agent.Tool.UnstructuredDataQuery.Config | null;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.Agent.Tool.UnstructuredDataQuery.Config;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.Agent.Tool.UnstructuredDataQuery.Config;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.Agent.Tool.UnstructuredDataQuery.Config;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.Agent.Tool.UnstructuredDataQuery.Config;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.Agent.Tool.UnstructuredDataQuery.Config | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.Agent.Tool.UnstructuredDataQuery.Config | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.Agent.Tool.UnstructuredDataQuery.Config | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.Agent.Tool.UnstructuredDataQuery.Config | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.Agent.Tool.UnstructuredDataQuery.Config;
     ...
     * This method is used during live metadata update
     */
    static replaceType(old: Type, new_: Type): Genai.Agent.Tool.UnstructuredDataQuery.Config;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Agent.Tool.UnstructuredDataQuery.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Agent.Tool.UnstructuredDataQuery.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Agent.Tool.UnstructuredDataQuery.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Agent.Tool.UnstructuredDataQuery.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Agent.Tool.UnstructuredDataQuery.Config>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Agent.Tool.UnstructuredDataQuery.Config>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Agent.Tool.UnstructuredDataQuery.Config>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Agent.Tool.UnstructuredDataQuery.Config>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.Agent.Tool.UnstructuredDataQuery.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.Agent.Tool.UnstructuredDataQuery.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Agent.Tool.UnstructuredDataQuery.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Agent.Tool.UnstructuredDataQuery.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Agent.Tool.UnstructuredDataQuery.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Agent.Tool.UnstructuredDataQuery.Config;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.Agent.Tool.UnstructuredDataQuery.Config;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    static validateObj(): Genai.Agent.Tool.UnstructuredDataQuery.Config;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.Agent.Tool.UnstructuredDataQuery.Config;
     ...
     * @see #defaultField
     */
    static withField(field: string, value: any, doNotConvert?: boolean): Genai.Agent.Tool.UnstructuredDataQuery.Config;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.Agent.Tool.UnstructuredDataQuery.Config;
     ...
     * @see #defaultField
     */
    static withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.Agent.Tool.UnstructuredDataQuery.Config;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.Agent.Tool.UnstructuredDataQuery.Config;
     ...
     * @return new Obj
     */
    static withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.Agent.Tool.UnstructuredDataQuery.Config;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.Agent.Tool.UnstructuredDataQuery.Config;
     ...
     * @return new Obj
     */
    static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.Agent.Tool.UnstructuredDataQuery.Config;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.Agent.Tool.UnstructuredDataQuery.Config;
     ...
     * @see #withoutField
     */
    static withoutFieldAtPath(path: string): Genai.Agent.Tool.UnstructuredDataQuery.Config;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.Agent.Tool.UnstructuredDataQuery.Config;
     ...
     * @see #removeField
     */
    static withoutField(field: string): Genai.Agent.Tool.UnstructuredDataQuery.Config;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.Agent.Tool.UnstructuredDataQuery.Config;
     ...
     * @see #removeField
     */
    static withoutField(field: FieldType): Genai.Agent.Tool.UnstructuredDataQuery.Config;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.Agent.Tool.UnstructuredDataQuery.Config;
     ...
     * @return new Obj with removed fields
     */
    static withoutFields(fields: Array_Type<string>): Genai.Agent.Tool.UnstructuredDataQuery.Config;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.Agent.Tool.UnstructuredDataQuery.Config;
     ...
     * @return new Obj with removed fields
     */
    static withoutFieldsByType(fields: Array_Type<FieldType>): Genai.Agent.Tool.UnstructuredDataQuery.Config;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.Agent.Tool.UnstructuredDataQuery.Config;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    static withoutSecretFields(): Genai.Agent.Tool.UnstructuredDataQuery.Config;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.Agent.Tool.UnstructuredDataQuery.Config;
     ...
     * @see FieldType#defaultValue
     */
    static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.Agent.Tool.UnstructuredDataQuery.Config;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.Agent.Tool.UnstructuredDataQuery.Config;
     ...
     * @see #unsetField
     */
    static defaultField(field: string): Genai.Agent.Tool.UnstructuredDataQuery.Config;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.Agent.Tool.UnstructuredDataQuery.Config;
     ...
     * @see #unsetField
     */
    static defaultField(field: FieldType): Genai.Agent.Tool.UnstructuredDataQuery.Config;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.Agent.Tool.UnstructuredDataQuery.Config;
     ...
     * @see #removeField
     */
    static unsetField(field: string): Genai.Agent.Tool.UnstructuredDataQuery.Config;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.Agent.Tool.UnstructuredDataQuery.Config;
     ...
     * @see #removeField
     */
    static unsetField(field: FieldType): Genai.Agent.Tool.UnstructuredDataQuery.Config;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.Agent.Tool.UnstructuredDataQuery.Config;
     ...
     * @see #unsetField
     */
    static removeField(field: string): Genai.Agent.Tool.UnstructuredDataQuery.Config;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.Agent.Tool.UnstructuredDataQuery.Config;
     ...
     * @see #unsetField
     */
    static removeField(field: FieldType): Genai.Agent.Tool.UnstructuredDataQuery.Config;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.Agent.Tool.UnstructuredDataQuery.Config;
     ...
     * @return the new merged Obj
     */
    static mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.Agent.Tool.UnstructuredDataQuery.Config;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.Agent.Tool.UnstructuredDataQuery.Config;
     ...
     * @return the new merged Obj
     */
    static mergeObj(other: Obj, otherFieldsFilter: Type): Genai.Agent.Tool.UnstructuredDataQuery.Config;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.Agent.Tool.UnstructuredDataQuery.Config;
     ...
     *        the same key or index.
     */
    static mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.Agent.Tool.UnstructuredDataQuery.Config;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.Agent.Tool.UnstructuredDataQuery.Config;
     ...
     * traverse child reference and collection fields.
     */
    static mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.Agent.Tool.UnstructuredDataQuery.Config;

    mergeJson(json: any): Genai.Agent.Tool.UnstructuredDataQuery.Config;

    static mergeJson(json: any): Genai.Agent.Tool.UnstructuredDataQuery.Config;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.Agent.Tool.UnstructuredDataQuery.Config;
     ...
     * @return Obj with child references merged
     */
    static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.Agent.Tool.UnstructuredDataQuery.Config;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.Agent.Tool.UnstructuredDataQuery.Config;
     ...
     * references with same name and collection elements at same index or key.
     */
    static sumObj(other: Obj, deep?: boolean): Genai.Agent.Tool.UnstructuredDataQuery.Config;
     ...
     */
    singletonArray(): Array_Type<Genai.Agent.Tool.UnstructuredDataQuery.Config>;
     ...
     * @return new array instance with this as only element.
     */
    static singletonArray(): Array_Type<Genai.Agent.Tool.UnstructuredDataQuery.Config>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.Agent.Tool.UnstructuredDataQuery.Config> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.Agent.Tool.UnstructuredDataQuery.Config> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.Agent.Tool.UnstructuredDataQuery.Config>;
     ...
     * @return new array instance with this as only element.
     */
    static singletonSet(): Set_Type<Genai.Agent.Tool.UnstructuredDataQuery.Config>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.Agent.Tool.UnstructuredDataQuery.Config> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.Agent.Tool.UnstructuredDataQuery.Config> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.Agent.Tool.UnstructuredDataQuery.Config> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.Agent.Tool.UnstructuredDataQuery.Config>;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    static toBuilder(): ObjBuilder<Genai.Agent.Tool.UnstructuredDataQuery.Config>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.Agent.Tool.UnstructuredDataQuery.Config>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.Agent.Tool.UnstructuredDataQuery.Config;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.Agent.Tool.UnstructuredDataQuery.Config;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.Agent.Tool.UnstructuredDataQuery.Config;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.Agent.Tool.UnstructuredDataQuery.Config;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    static afterMake(): Genai.Agent.Tool.UnstructuredDataQuery.Config;
     ...
     */
    static cachedEmptyInst(): Genai.Agent.Tool.UnstructuredDataQuery.Config;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.Agent.Tool.UnstructuredDataQuery.Config> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.Agent.Tool.UnstructuredDataQuery.Config;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Genai.Agent.Tool.UnstructuredDataQuery.Config | null;
     ...
     */
    static allCached(): Stream<Genai.Agent.Tool.UnstructuredDataQuery.Config> | null;
     ...
     */
    static find(filter?: string): Stream<Genai.Agent.Tool.UnstructuredDataQuery.Config> | null;
     ...
     *         Otherwise no population will be performed.
     */
    static findBy(field: string, value: any): Stream<Genai.Agent.Tool.UnstructuredDataQuery.Config> | null;

    /**
     * @return cached instance.
     */
    getCached(): Genai.Agent.Tool.UnstructuredDataQuery.Config | null;

    /**
     * @return cached instance.
     */
    static getCached(): Genai.Agent.Tool.UnstructuredDataQuery.Config | null;

    /**
     * Returns cached instance by key, with secrets removed.
     */
    static forCacheKey(key: string): Genai.Agent.Tool.UnstructuredDataQuery.Config | null;
     ...
     */
    static produce(key: string): Genai.Agent.Tool.UnstructuredDataQuery.Config | null;

    /**
     * Should produces the entire content for the cached data. Will populate the cache with the produced data.
     */
    static produceAll(): Map_Type<string, Genai.Agent.Tool.UnstructuredDataQuery.Config> | null;
     ...
     */
    getConfig(): Genai.Agent.Tool.UnstructuredDataQuery.Config;
     ...
     * Note that typical pattern is to use Configurable#config instead of this method.
     */
    static getConfig(): Genai.Agent.Tool.UnstructuredDataQuery.Config;
     ...
     */
    getSecret(): Genai.Agent.Tool.UnstructuredDataQuery.Config;
     ...
     * Note that typical pattern is to use Configurable#configWithSecrets instead of this method.
     */
    static getSecret(): Genai.Agent.Tool.UnstructuredDataQuery.Config;
     ...
     */
    withConfigKey(configKey: string): Genai.Agent.Tool.UnstructuredDataQuery.Config;
     ...
     *     config.configKey() => "folder1/abc"
     */
    static withConfigKey(configKey: string): Genai.Agent.Tool.UnstructuredDataQuery.Config;

    /**
     * @return copy without config key.
     */
    withoutConfigKey(): Genai.Agent.Tool.UnstructuredDataQuery.Config;

    /**
     * @return copy without config key.
     */
    static withoutConfigKey(): Genai.Agent.Tool.UnstructuredDataQuery.Config;

    /**
     * @return return cached config instance for provided config key.
     */
    static forConfigKey(configKey: string): Genai.Agent.Tool.UnstructuredDataQuery.Config | null;
     ...
     */
    static listConfigs(parallel?: boolean, filter?: λPredicate<string>): Stream<Genai.Agent.Tool.UnstructuredDataQuery.Config> | null;
     ...
     * @see setConfigValue
     */
    setConfigValues(from: Genai.Agent.Tool.UnstructuredDataQuery.Config, override?: string): void;
     ...
     * @see setConfigValue
     */
    static setConfigValues(from: Genai.Agent.Tool.UnstructuredDataQuery.Config, override?: string): void;
     ...
     */
    static loadConfigAndSecret(configKey: string): Genai.Agent.Tool.UnstructuredDataQuery.Config | null;
     ...
     */
    removeSecrets(): Genai.Agent.Tool.UnstructuredDataQuery.Config | null;

    /**
     * @return this config without any secret values.
     */
    static removeSecrets(): Genai.Agent.Tool.UnstructuredDataQuery.Config | null;

    /**
     * @return this config with only secret values.
     */
    removeNonSecrets(): Genai.Agent.Tool.UnstructuredDataQuery.Config | null;

    /**
     * @return this config with only secret values.
     */
    static removeNonSecrets(): Genai.Agent.Tool.UnstructuredDataQuery.Config | null;

    /**
     * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
     * validation and setup.
     */
    validate(): Genai.Agent.Tool.UnstructuredDataQuery.Config;

    /**
     * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
     * validation and setup.
     */
    static validate(): Genai.Agent.Tool.UnstructuredDataQuery.Config;
     ...
     */
    static setRecursive(configJson: any, useSetConfigValues?: boolean, override?: string): Genai.Agent.Tool.UnstructuredDataQuery.Config;
