// TypeScript definitions for the C3 type Genai.SourceFile.Chunker.MultimodalPdf.Config

/**
 * Defines the config for {@link Genai.SourceFile.Chunker.MultimodalPdf}.
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.SourceFile.Chunker.MultimodalPdf.Config
 */
declare namespace Genai.SourceFile.Chunker.MultimodalPdf {
  export interface IConfig {
    ...
    /**
     * Defines the text parser spec
     */
    textParserSpec: IGenai.SourceFile.Chunker.MultimodalPdf.TextParserSpec;

    /**
     * Defines the image parser spec (optional). If the param is not passed,
     * even if #disableImageParser is set to False, then the image parsing will be skipped.
     */
    imageParserSpec?: IGenai.SourceFile.Chunker.MultimodalPdf.ImageParserSpec;

    /**
     * Defines the table parser spec (optional). If the param is not passed,
     * even if #disableTableParser is set to False, then the table parsing will be skipped.
     */
    tableParserSpec?: IGenai.SourceFile.Chunker.MultimodalPdf.TableParserSpec;

    /**
     * Defines the layout parser spec
     */
    layoutParserSpec: IGenai.SourceFile.Chunker.MultimodalPdf.LayoutParserSpec;

    /**
     * Enable the layout parser
     */
    enableLayoutParser?: boolean;

    /**
     * Disable the Image parser (default: False). If set to True, then the image parsing will be skipped.
     */
    disableImageParser?: boolean;

    /**
     * Disable the Table parser (default: False). If set to True, then the table parsing will be skipped.
     */
    disableTableParser?: boolean;
  }
}
 ...
 * Defines the config for {@link Genai.SourceFile.Chunker.MultimodalPdf}.
 *
 * @remarks this represents a made instance of Genai.SourceFile.Chunker.MultimodalPdf.Config
 */
declare namespace Genai.SourceFile.Chunker.MultimodalPdf {
  export class Config extends Obj  {

    readonly configOverride?: string;
    withConfigOverride(configOverride: string | null): Genai.SourceFile.Chunker.MultimodalPdf.Config;

    static readonly configOverride?: string;

    readonly secretOverride?: string;
    withSecretOverride(secretOverride: string | null): Genai.SourceFile.Chunker.MultimodalPdf.Config;
    ...
    withIssues(issues: Array_Type<string> | Array<string> | null): Genai.SourceFile.Chunker.MultimodalPdf.Config;
     ...
     * Defines the text parser spec
     */
    readonly textParserSpec: Genai.SourceFile.Chunker.MultimodalPdf.TextParserSpec;
    withTextParserSpec(textParserSpec: IGenai.SourceFile.Chunker.MultimodalPdf.TextParserSpec): Genai.SourceFile.Chunker.MultimodalPdf.Config;

    /**
     * Defines the text parser spec
     */
    static readonly textParserSpec: Genai.SourceFile.Chunker.MultimodalPdf.TextParserSpec;

    /**
     * Defines the image parser spec (optional). If the param is not passed,
     * even if #disableImageParser is set to False, then the image parsing will be skipped.
     */
    readonly imageParserSpec?: Genai.SourceFile.Chunker.MultimodalPdf.ImageParserSpec;
    withImageParserSpec(imageParserSpec: IGenai.SourceFile.Chunker.MultimodalPdf.ImageParserSpec | null): Genai.SourceFile.Chunker.MultimodalPdf.Config;

    /**
     * Defines the image parser spec (optional). If the param is not passed,
     * even if #disableImageParser is set to False, then the image parsing will be skipped.
     */
    static readonly imageParserSpec?: Genai.SourceFile.Chunker.MultimodalPdf.ImageParserSpec;

    /**
     * Defines the table parser spec (optional). If the param is not passed,
     * even if #disableTableParser is set to False, then the table parsing will be skipped.
     */
    readonly tableParserSpec?: Genai.SourceFile.Chunker.MultimodalPdf.TableParserSpec;
    withTableParserSpec(tableParserSpec: IGenai.SourceFile.Chunker.MultimodalPdf.TableParserSpec | null): Genai.SourceFile.Chunker.MultimodalPdf.Config;

    /**
     * Defines the table parser spec (optional). If the param is not passed,
     * even if #disableTableParser is set to False, then the table parsing will be skipped.
     */
    static readonly tableParserSpec?: Genai.SourceFile.Chunker.MultimodalPdf.TableParserSpec;

    /**
     * Defines the layout parser spec
     */
    readonly layoutParserSpec: Genai.SourceFile.Chunker.MultimodalPdf.LayoutParserSpec;
    withLayoutParserSpec(layoutParserSpec: IGenai.SourceFile.Chunker.MultimodalPdf.LayoutParserSpec): Genai.SourceFile.Chunker.MultimodalPdf.Config;

    /**
     * Defines the layout parser spec
     */
    static readonly layoutParserSpec: Genai.SourceFile.Chunker.MultimodalPdf.LayoutParserSpec;

    /**
     * Enable the layout parser
     */
    readonly enableLayoutParser?: boolean;
    withEnableLayoutParser(enableLayoutParser: boolean): Genai.SourceFile.Chunker.MultimodalPdf.Config;

    /**
     * Enable the layout parser
     */
    static readonly enableLayoutParser?: boolean;

    /**
     * Disable the Image parser (default: False). If set to True, then the image parsing will be skipped.
     */
    readonly disableImageParser?: boolean;
    withDisableImageParser(disableImageParser: boolean): Genai.SourceFile.Chunker.MultimodalPdf.Config;

    /**
     * Disable the Image parser (default: False). If set to True, then the image parsing will be skipped.
     */
    static readonly disableImageParser?: boolean;

    /**
     * Disable the Table parser (default: False). If set to True, then the table parsing will be skipped.
     */
    readonly disableTableParser?: boolean;
    withDisableTableParser(disableTableParser: boolean): Genai.SourceFile.Chunker.MultimodalPdf.Config;

    /**
     * Disable the Table parser (default: False). If set to True, then the table parsing will be skipped.
     */
    static readonly disableTableParser?: boolean;

    /**
     * @return the one and only instance to be used when member functions are called on this type.
     */
    static inst(): Genai.SourceFile.Chunker.MultimodalPdf.Config;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.SourceFile.Chunker.MultimodalPdf.Config | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.SourceFile.Chunker.MultimodalPdf.Config | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.SourceFile.Chunker.MultimodalPdf.Config | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.SourceFile.Chunker.MultimodalPdf.Config | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.SourceFile.Chunker.MultimodalPdf.Config;
     ...
     * This method is used during live metadata update
     */
    static replaceType(old: Type, new_: Type): Genai.SourceFile.Chunker.MultimodalPdf.Config;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.SourceFile.Chunker.MultimodalPdf.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.SourceFile.Chunker.MultimodalPdf.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.SourceFile.Chunker.MultimodalPdf.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.SourceFile.Chunker.MultimodalPdf.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.SourceFile.Chunker.MultimodalPdf.Config>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.SourceFile.Chunker.MultimodalPdf.Config>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.SourceFile.Chunker.MultimodalPdf.Config>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.SourceFile.Chunker.MultimodalPdf.Config>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.SourceFile.Chunker.MultimodalPdf.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.SourceFile.Chunker.MultimodalPdf.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.SourceFile.Chunker.MultimodalPdf.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.SourceFile.Chunker.MultimodalPdf.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.SourceFile.Chunker.MultimodalPdf.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.SourceFile.Chunker.MultimodalPdf.Config;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.SourceFile.Chunker.MultimodalPdf.Config;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    static validateObj(): Genai.SourceFile.Chunker.MultimodalPdf.Config;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.SourceFile.Chunker.MultimodalPdf.Config;
     ...
     * @see #defaultField
     */
    static withField(field: string, value: any, doNotConvert?: boolean): Genai.SourceFile.Chunker.MultimodalPdf.Config;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.SourceFile.Chunker.MultimodalPdf.Config;
     ...
     * @see #defaultField
     */
    static withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.SourceFile.Chunker.MultimodalPdf.Config;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.SourceFile.Chunker.MultimodalPdf.Config;
     ...
     * @return new Obj
     */
    static withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.SourceFile.Chunker.MultimodalPdf.Config;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.SourceFile.Chunker.MultimodalPdf.Config;
     ...
     * @return new Obj
     */
    static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.SourceFile.Chunker.MultimodalPdf.Config;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.SourceFile.Chunker.MultimodalPdf.Config;
     ...
     * @see #withoutField
     */
    static withoutFieldAtPath(path: string): Genai.SourceFile.Chunker.MultimodalPdf.Config;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.SourceFile.Chunker.MultimodalPdf.Config;
     ...
     * @see #removeField
     */
    static withoutField(field: string): Genai.SourceFile.Chunker.MultimodalPdf.Config;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.SourceFile.Chunker.MultimodalPdf.Config;
     ...
     * @see #removeField
     */
    static withoutField(field: FieldType): Genai.SourceFile.Chunker.MultimodalPdf.Config;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.SourceFile.Chunker.MultimodalPdf.Config;
     ...
     * @return new Obj with removed fields
     */
    static withoutFields(fields: Array_Type<string>): Genai.SourceFile.Chunker.MultimodalPdf.Config;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.SourceFile.Chunker.MultimodalPdf.Config;
     ...
     * @return new Obj with removed fields
     */
    static withoutFieldsByType(fields: Array_Type<FieldType>): Genai.SourceFile.Chunker.MultimodalPdf.Config;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.SourceFile.Chunker.MultimodalPdf.Config;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    static withoutSecretFields(): Genai.SourceFile.Chunker.MultimodalPdf.Config;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.SourceFile.Chunker.MultimodalPdf.Config;
     ...
     * @see FieldType#defaultValue
     */
    static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.SourceFile.Chunker.MultimodalPdf.Config;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.SourceFile.Chunker.MultimodalPdf.Config;
     ...
     * @see #unsetField
     */
    static defaultField(field: string): Genai.SourceFile.Chunker.MultimodalPdf.Config;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.SourceFile.Chunker.MultimodalPdf.Config;
     ...
     * @see #unsetField
     */
    static defaultField(field: FieldType): Genai.SourceFile.Chunker.MultimodalPdf.Config;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.SourceFile.Chunker.MultimodalPdf.Config;
     ...
     * @see #removeField
     */
    static unsetField(field: string): Genai.SourceFile.Chunker.MultimodalPdf.Config;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.SourceFile.Chunker.MultimodalPdf.Config;
     ...
     * @see #removeField
     */
    static unsetField(field: FieldType): Genai.SourceFile.Chunker.MultimodalPdf.Config;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.SourceFile.Chunker.MultimodalPdf.Config;
     ...
     * @see #unsetField
     */
    static removeField(field: string): Genai.SourceFile.Chunker.MultimodalPdf.Config;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.SourceFile.Chunker.MultimodalPdf.Config;
     ...
     * @see #unsetField
     */
    static removeField(field: FieldType): Genai.SourceFile.Chunker.MultimodalPdf.Config;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.SourceFile.Chunker.MultimodalPdf.Config;
     ...
     * @return the new merged Obj
     */
    static mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.SourceFile.Chunker.MultimodalPdf.Config;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.SourceFile.Chunker.MultimodalPdf.Config;
     ...
     * @return the new merged Obj
     */
    static mergeObj(other: Obj, otherFieldsFilter: Type): Genai.SourceFile.Chunker.MultimodalPdf.Config;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.SourceFile.Chunker.MultimodalPdf.Config;
     ...
     *        the same key or index.
     */
    static mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.SourceFile.Chunker.MultimodalPdf.Config;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.SourceFile.Chunker.MultimodalPdf.Config;
     ...
     * traverse child reference and collection fields.
     */
    static mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.SourceFile.Chunker.MultimodalPdf.Config;

    mergeJson(json: any): Genai.SourceFile.Chunker.MultimodalPdf.Config;

    static mergeJson(json: any): Genai.SourceFile.Chunker.MultimodalPdf.Config;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.SourceFile.Chunker.MultimodalPdf.Config;
     ...
     * @return Obj with child references merged
     */
    static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.SourceFile.Chunker.MultimodalPdf.Config;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.SourceFile.Chunker.MultimodalPdf.Config;
     ...
     * references with same name and collection elements at same index or key.
     */
    static sumObj(other: Obj, deep?: boolean): Genai.SourceFile.Chunker.MultimodalPdf.Config;
     ...
     */
    singletonArray(): Array_Type<Genai.SourceFile.Chunker.MultimodalPdf.Config>;
     ...
     * @return new array instance with this as only element.
     */
    static singletonArray(): Array_Type<Genai.SourceFile.Chunker.MultimodalPdf.Config>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.SourceFile.Chunker.MultimodalPdf.Config> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.SourceFile.Chunker.MultimodalPdf.Config> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.SourceFile.Chunker.MultimodalPdf.Config>;
     ...
     * @return new array instance with this as only element.
     */
    static singletonSet(): Set_Type<Genai.SourceFile.Chunker.MultimodalPdf.Config>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.SourceFile.Chunker.MultimodalPdf.Config> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.SourceFile.Chunker.MultimodalPdf.Config> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.SourceFile.Chunker.MultimodalPdf.Config> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.SourceFile.Chunker.MultimodalPdf.Config>;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    static toBuilder(): ObjBuilder<Genai.SourceFile.Chunker.MultimodalPdf.Config>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.SourceFile.Chunker.MultimodalPdf.Config>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.SourceFile.Chunker.MultimodalPdf.Config;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.SourceFile.Chunker.MultimodalPdf.Config;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.SourceFile.Chunker.MultimodalPdf.Config;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.SourceFile.Chunker.MultimodalPdf.Config;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.SourceFile.Chunker.MultimodalPdf.Config;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.SourceFile.Chunker.MultimodalPdf.Config;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.SourceFile.Chunker.MultimodalPdf.Config;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.SourceFile.Chunker.MultimodalPdf.Config;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    static afterMake(): Genai.SourceFile.Chunker.MultimodalPdf.Config;
     ...
     */
    static cachedEmptyInst(): Genai.SourceFile.Chunker.MultimodalPdf.Config;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.SourceFile.Chunker.MultimodalPdf.Config> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.SourceFile.Chunker.MultimodalPdf.Config;
     ...
     */
    static allCached(): Stream<Genai.SourceFile.Chunker.MultimodalPdf.Config> | null;
     ...
     */
    static find(filter?: string): Stream<Genai.SourceFile.Chunker.MultimodalPdf.Config> | null;
     ...
     *         Otherwise no population will be performed.
     */
    static findBy(field: string, value: any): Stream<Genai.SourceFile.Chunker.MultimodalPdf.Config> | null;

    /**
     * @return cached instance.
     */
    getCached(): Genai.SourceFile.Chunker.MultimodalPdf.Config | null;

    /**
     * @return cached instance.
     */
    static getCached(): Genai.SourceFile.Chunker.MultimodalPdf.Config | null;

    /**
     * Returns cached instance by key, with secrets removed.
     */
    static forCacheKey(key: string): Genai.SourceFile.Chunker.MultimodalPdf.Config | null;
     ...
     */
    static produce(key: string): Genai.SourceFile.Chunker.MultimodalPdf.Config | null;

    /**
     * Should produces the entire content for the cached data. Will populate the cache with the produced data.
     */
    static produceAll(): Map_Type<string, Genai.SourceFile.Chunker.MultimodalPdf.Config> | null;
     ...
     */
    getConfig(): Genai.SourceFile.Chunker.MultimodalPdf.Config;
     ...
     * Note that typical pattern is to use Configurable#config instead of this method.
     */
    static getConfig(): Genai.SourceFile.Chunker.MultimodalPdf.Config;
     ...
     */
    getSecret(): Genai.SourceFile.Chunker.MultimodalPdf.Config;
     ...
     * Note that typical pattern is to use Configurable#configWithSecrets instead of this method.
     */
    static getSecret(): Genai.SourceFile.Chunker.MultimodalPdf.Config;
     ...
     */
    withConfigKey(configKey: string): Genai.SourceFile.Chunker.MultimodalPdf.Config;
     ...
     *     config.configKey() => "folder1/abc"
     */
    static withConfigKey(configKey: string): Genai.SourceFile.Chunker.MultimodalPdf.Config;

    /**
     * @return copy without config key.
     */
    withoutConfigKey(): Genai.SourceFile.Chunker.MultimodalPdf.Config;

    /**
     * @return copy without config key.
     */
    static withoutConfigKey(): Genai.SourceFile.Chunker.MultimodalPdf.Config;

    /**
     * @return return cached config instance for provided config key.
     */
    static forConfigKey(configKey: string): Genai.SourceFile.Chunker.MultimodalPdf.Config | null;
     ...
     */
    static listConfigs(parallel?: boolean, filter?: λPredicate<string>): Stream<Genai.SourceFile.Chunker.MultimodalPdf.Config> | null;
     ...
     * @see setConfigValue
     */
    setConfigValues(from: Genai.SourceFile.Chunker.MultimodalPdf.Config, override?: string): void;
     ...
     * @see setConfigValue
     */
    static setConfigValues(from: Genai.SourceFile.Chunker.MultimodalPdf.Config, override?: string): void;
     ...
     */
    static loadConfigAndSecret(configKey: string): Genai.SourceFile.Chunker.MultimodalPdf.Config | null;
     ...
     */
    removeSecrets(): Genai.SourceFile.Chunker.MultimodalPdf.Config | null;

    /**
     * @return this config without any secret values.
     */
    static removeSecrets(): Genai.SourceFile.Chunker.MultimodalPdf.Config | null;

    /**
     * @return this config with only secret values.
     */
    removeNonSecrets(): Genai.SourceFile.Chunker.MultimodalPdf.Config | null;

    /**
     * @return this config with only secret values.
     */
    static removeNonSecrets(): Genai.SourceFile.Chunker.MultimodalPdf.Config | null;

    /**
     * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
     * validation and setup.
     */
    validate(): Genai.SourceFile.Chunker.MultimodalPdf.Config;

    /**
     * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
     * validation and setup.
     */
    static validate(): Genai.SourceFile.Chunker.MultimodalPdf.Config;
