// TypeScript definitions for the C3 type Genai.FewShotExample.Context

/**
 * Persists few-shot examples for a python agent along with its embedding in pgvector.
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.FewShotExample.Context
 */
...
declare namespace Genai.FewShotExample {
  export class Context extends Obj  {
    ...
    withTypeIdent(typeIdent: string | null): Genai.FewShotExample.Context;
     ...
     */
    readonly id: string;
    withId(id: string): Genai.FewShotExample.Context;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Genai.FewShotExample.Context;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): Genai.FewShotExample.Context;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): Genai.FewShotExample.Context;
    ...
    withVersion(version: number | null): Genai.FewShotExample.Context;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): Genai.FewShotExample.Context;

    /**
     * The query associated with the example.
     */
    readonly query: string;
    withQuery(query: string): Genai.FewShotExample.Context;

    /**
     * An E5 embedding of the query.
     */
    readonly emb?: string;
    withEmb(emb: string | null): Genai.FewShotExample.Context;

    /**
     * Flag indicating if this was added manually or by an automatic process.
     */
    readonly manuallyAdded?: boolean;
    withManuallyAdded(manuallyAdded: boolean): Genai.FewShotExample.Context;
    ...
    withProject(project: IGenai.Project | null): Genai.FewShotExample.Context;

    /**
     * The {@link User} who created the {@link Genai.FewShotExample}.
     */
    readonly createdBy?: User;
    withCreatedBy(createdBy: IUser | null): Genai.FewShotExample.Context;

    /**
     * The context attached to the query which will serve as an example for the llm.
     */
    readonly context: string;
    withContext(context: string): Genai.FewShotExample.Context;

    /**
     * Description of the few-shot.
     */
    readonly description?: string;
    withDescription(description: string | null): Genai.FewShotExample.Context;
     ...
     * Here some examples that are used for the agentic REA pipeline: `query_rewriting`, `retrieval_filters`, `reranker`, `message_builder`
     */
    readonly fewShotExampleType: string;
    withFewShotExampleType(fewShotExampleType: string): Genai.FewShotExample.Context;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.FewShotExample.Context | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.FewShotExample.Context | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.FewShotExample.Context | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.FewShotExample.Context | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.FewShotExample.Context;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.FewShotExample.Context;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.FewShotExample.Context;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.FewShotExample.Context>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.FewShotExample.Context>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.FewShotExample.Context;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.FewShotExample.Context;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.FewShotExample.Context;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.FewShotExample.Context;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.FewShotExample.Context;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.FewShotExample.Context;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.FewShotExample.Context;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.FewShotExample.Context;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.FewShotExample.Context;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.FewShotExample.Context;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.FewShotExample.Context;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.FewShotExample.Context;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.FewShotExample.Context;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.FewShotExample.Context;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.FewShotExample.Context;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.FewShotExample.Context;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.FewShotExample.Context;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.FewShotExample.Context;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.FewShotExample.Context;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.FewShotExample.Context;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.FewShotExample.Context;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.FewShotExample.Context;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.FewShotExample.Context;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.FewShotExample.Context;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.FewShotExample.Context;

    mergeJson(json: any): Genai.FewShotExample.Context;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.FewShotExample.Context;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.FewShotExample.Context;
     ...
     */
    singletonArray(): Array_Type<Genai.FewShotExample.Context>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.FewShotExample.Context> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.FewShotExample.Context> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.FewShotExample.Context>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.FewShotExample.Context> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.FewShotExample.Context> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.FewShotExample.Context> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.FewShotExample.Context>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.FewShotExample.Context>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.FewShotExample.Context;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.FewShotExample.Context;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.FewShotExample.Context;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.FewShotExample.Context;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.FewShotExample.Context;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.FewShotExample.Context;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.FewShotExample.Context | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.FewShotExample.Context;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.FewShotExample.Context;
     ...
     */
    static cachedEmptyInst(): Genai.FewShotExample.Context;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.FewShotExample.Context> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.FewShotExample.Context;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<Genai.FewShotExample.Context>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Genai.FewShotExample.Context>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<Genai.FewShotExample.Context> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Genai.FewShotExample.Context>> | null;
     ...
     */
    get(include?: string): Genai.FewShotExample.Context | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): Genai.FewShotExample.Context | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Genai.FewShotExample.Context;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): Genai.FewShotExample.Context | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Genai.FewShotExample.Context;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.FewShotExample.Context | null;
     ...
     */
    create(spec?: UpsertSpec): Genai.FewShotExample.Context | null;
     ...
     */
    static createBatch(objs: Array_Type<Genai.FewShotExample.Context>, spec?: UpsertSpec): ObjList<Genai.FewShotExample.Context> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Genai.FewShotExample.Context>, spec?: CreateBatchObjStreamSpec): ObjList<Genai.FewShotExample.Context> | null;
     ...
     */
    update(srcObj?: Genai.FewShotExample.Context, spec?: UpsertSpec): Genai.FewShotExample.Context | null;
     ...
     */
    upsert(srcObj?: Genai.FewShotExample.Context, spec?: UpsertSpec): Genai.FewShotExample.Context | null;
     ...
     */
    merge(spec?: MergeSpec): Genai.FewShotExample.Context | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): Genai.FewShotExample.Context | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): Genai.FewShotExample.Context | null;
     ...
     */
    static updateBatch(objs: Array_Type<Genai.FewShotExample.Context>, srcObjs?: Array_Type<Genai.FewShotExample.Context>, spec?: UpsertSpec): ObjList<Genai.FewShotExample.Context> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<Genai.FewShotExample.Context> | null>, spec?: UpsertSpec): ObjList<Genai.FewShotExample.Context> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<Genai.FewShotExample.Context>, srcObjs?: Array_Type<Genai.FewShotExample.Context>, spec?: UpsertSpec): ObjList<Genai.FewShotExample.Context> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<Genai.FewShotExample.Context> | null>, spec?: UpsertSpec): ObjList<Genai.FewShotExample.Context> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<Genai.FewShotExample.Context>, spec?: TouchSpec): ObjList<Genai.FewShotExample.Context> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.FewShotExample.Context>, spec?: MergeSpec): ObjList<Genai.FewShotExample.Context> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.FewShotExample.Context>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.FewShotExample.Context> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<Genai.FewShotExample.Context> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.FewShotExample.Context> | null;
     ...
     */
    static mergeAll(mergeObj: Genai.FewShotExample.Context, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Genai.FewShotExample.Context, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<Genai.FewShotExample.Context>, spec?: UpsertSpec): ObjList<Genai.FewShotExample.Context> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<Genai.FewShotExample.Context>, spec?: UpsertSpec): ObjList<Genai.FewShotExample.Context> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): Genai.FewShotExample.Context | null;
     ...
     */
    static beforeCreate(objs: Array_Type<Genai.FewShotExample.Context>): ObjList<Genai.FewShotExample.Context>;
     ...
     */
    static beforeUpdate(objs: Array_Type<Genai.FewShotExample.Context>): ObjList<Genai.FewShotExample.Context>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<Genai.FewShotExample.Context>): ObjList<Genai.FewShotExample.Context>;
     ...
     */
    static afterCreate(objs: Array_Type<Genai.FewShotExample.Context>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<Genai.FewShotExample.Context>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<Genai.FewShotExample.Context>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<Genai.FewShotExample.Context>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Genai.FewShotExample.Context>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Genai.FewShotExample.Context | null;
     ...
     */
    withoutIdentity(): Genai.FewShotExample.Context | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<Genai.FewShotExample.Context>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: Genai.FewShotExample.Context, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<Genai.FewShotExample.Context>, callback?: λFunction<Genai.FewShotExample.Context | null, Genai.FewShotExample.Context | null>): ObjList<Genai.FewShotExample.Context>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<Genai.FewShotExample.Context>, callback?: λFunction<Genai.FewShotExample.Context | null, Genai.FewShotExample.Context | null>): Array_Type<ObjError> | null;
     ...
     */
    static addEmbeddingsForQueries(objs: Array_Type<Genai.FewShotExample>, queries: Array_Type<string>): ObjList<Genai.FewShotExample.Context>;
  }
}
