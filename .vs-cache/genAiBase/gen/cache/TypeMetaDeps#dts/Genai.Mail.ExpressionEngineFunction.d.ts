// TypeScript definitions for the C3 type Genai.Mail.ExpressionEngineFunction

/**
 * Type containing Expression Engine Functions for {@link Genai.Mail}.
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.Mail.ExpressionEngineFunction
 */
declare namespace Genai.Mail {
...
declare namespace Genai.Mail {
  export class ExpressionEngineFunction {
     ...
     */
    static getUserEmailsForRoles(roleIds?: Array_Type<string>): Array_Type<string> | null;
  }
}
