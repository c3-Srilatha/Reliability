// TypeScript definitions for the C3 type Genai.Project.Settings

/**
 * Project settings for the app.
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.Project.Settings
 */
declare namespace Genai.Project {
  export interface ISettings {
     ...
     */
    tutorialProject?: IGenai.Project;

    /**
     * The non-tutorial project for the app
     */
    defaultProject: IGenai.Project;
  }
}
 ...
 */
declare namespace Genai.Project {
  export class Settings extends Obj  {
     ...
     */
    readonly id: string;
    withId(id: string): Genai.Project.Settings;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Genai.Project.Settings;
    ...
    withName(name: string | null): Genai.Project.Settings;
     ...
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): Genai.Project.Settings;
    ...
    withVersion(version: number | null): Genai.Project.Settings;
    ...
    withTypeWithBindings(typeWithBindings: IType | null): Genai.Project.Settings;
     ...
     * The tutorial project for the app
     */
    readonly tutorialProject?: Genai.Project;
    withTutorialProject(tutorialProject: IGenai.Project | null): Genai.Project.Settings;

    /**
     * The tutorial project for the app
     */
    static readonly tutorialProject?: Genai.Project;

    /**
     * The non-tutorial project for the app
     */
    readonly defaultProject: Genai.Project;
    withDefaultProject(defaultProject: IGenai.Project): Genai.Project.Settings;

    /**
     * The non-tutorial project for the app
     */
    static readonly defaultProject: Genai.Project;
     ...
     */
    static inst(): Genai.Project.Settings;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.Project.Settings | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.Project.Settings | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.Project.Settings | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.Project.Settings | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.Project.Settings;
     ...
     * This method is used during live metadata update
     */
    static replaceType(old: Type, new_: Type): Genai.Project.Settings;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Project.Settings;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Project.Settings;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Project.Settings;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Project.Settings;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Project.Settings>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Project.Settings>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Project.Settings>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Project.Settings>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.Project.Settings;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.Project.Settings;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Project.Settings;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Project.Settings;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Project.Settings;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Project.Settings;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.Project.Settings;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    static validateObj(): Genai.Project.Settings;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.Project.Settings;
     ...
     * @see #defaultField
     */
    static withField(field: string, value: any, doNotConvert?: boolean): Genai.Project.Settings;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.Project.Settings;
     ...
     * @see #defaultField
     */
    static withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.Project.Settings;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.Project.Settings;
     ...
     * @return new Obj
     */
    static withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.Project.Settings;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.Project.Settings;
     ...
     * @return new Obj
     */
    static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.Project.Settings;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.Project.Settings;
     ...
     * @see #withoutField
     */
    static withoutFieldAtPath(path: string): Genai.Project.Settings;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.Project.Settings;
     ...
     * @see #removeField
     */
    static withoutField(field: string): Genai.Project.Settings;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.Project.Settings;
     ...
     * @see #removeField
     */
    static withoutField(field: FieldType): Genai.Project.Settings;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.Project.Settings;
     ...
     * @return new Obj with removed fields
     */
    static withoutFields(fields: Array_Type<string>): Genai.Project.Settings;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.Project.Settings;
     ...
     * @return new Obj with removed fields
     */
    static withoutFieldsByType(fields: Array_Type<FieldType>): Genai.Project.Settings;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.Project.Settings;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    static withoutSecretFields(): Genai.Project.Settings;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.Project.Settings;
     ...
     * @see FieldType#defaultValue
     */
    static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.Project.Settings;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.Project.Settings;
     ...
     * @see #unsetField
     */
    static defaultField(field: string): Genai.Project.Settings;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.Project.Settings;
     ...
     * @see #unsetField
     */
    static defaultField(field: FieldType): Genai.Project.Settings;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.Project.Settings;
     ...
     * @see #removeField
     */
    static unsetField(field: string): Genai.Project.Settings;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.Project.Settings;
     ...
     * @see #removeField
     */
    static unsetField(field: FieldType): Genai.Project.Settings;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.Project.Settings;
     ...
     * @see #unsetField
     */
    static removeField(field: string): Genai.Project.Settings;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.Project.Settings;
     ...
     * @see #unsetField
     */
    static removeField(field: FieldType): Genai.Project.Settings;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.Project.Settings;
     ...
     * @return the new merged Obj
     */
    static mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.Project.Settings;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.Project.Settings;
     ...
     * @return the new merged Obj
     */
    static mergeObj(other: Obj, otherFieldsFilter: Type): Genai.Project.Settings;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.Project.Settings;
     ...
     *        the same key or index.
     */
    static mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.Project.Settings;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.Project.Settings;
     ...
     * traverse child reference and collection fields.
     */
    static mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.Project.Settings;

    mergeJson(json: any): Genai.Project.Settings;

    static mergeJson(json: any): Genai.Project.Settings;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.Project.Settings;
     ...
     * @return Obj with child references merged
     */
    static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.Project.Settings;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.Project.Settings;
     ...
     * references with same name and collection elements at same index or key.
     */
    static sumObj(other: Obj, deep?: boolean): Genai.Project.Settings;
     ...
     */
    singletonArray(): Array_Type<Genai.Project.Settings>;
     ...
     * @return new array instance with this as only element.
     */
    static singletonArray(): Array_Type<Genai.Project.Settings>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.Project.Settings> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.Project.Settings> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.Project.Settings>;
     ...
     * @return new array instance with this as only element.
     */
    static singletonSet(): Set_Type<Genai.Project.Settings>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.Project.Settings> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.Project.Settings> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.Project.Settings> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.Project.Settings>;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    static toBuilder(): ObjBuilder<Genai.Project.Settings>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.Project.Settings>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.Project.Settings;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.Project.Settings;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.Project.Settings;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.Project.Settings;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.Project.Settings;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.Project.Settings;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.Project.Settings | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.Project.Settings;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.Project.Settings;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    static afterMake(): Genai.Project.Settings;
     ...
     */
    static cachedEmptyInst(): Genai.Project.Settings;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.Project.Settings> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.Project.Settings;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<Genai.Project.Settings>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Genai.Project.Settings>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<Genai.Project.Settings> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Genai.Project.Settings>> | null;
     ...
     */
    get(include?: string): Genai.Project.Settings | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    static get(include?: string): Genai.Project.Settings | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): Genai.Project.Settings | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    static getSpecific(include?: string): Genai.Project.Settings | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Genai.Project.Settings;
     ...
     * @return instance of the obj with all requested fields.
     */
    static getMissing(spec: GetMissingSpec): Genai.Project.Settings;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): Genai.Project.Settings | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    static getDirect(include?: string): Genai.Project.Settings | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Genai.Project.Settings;
     ...
     * @return The instance after applying the reverse edit.
     */
    static applyReverseEdit(versionEdit: VersionEdit): Genai.Project.Settings;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.Project.Settings | null;
     ...
     */
    create(spec?: UpsertSpec): Genai.Project.Settings | null;
     ...
     *         will have only those fields populated. Otherwise only the id field will be populated.
     */
    static create(spec?: UpsertSpec): Genai.Project.Settings | null;
     ...
     */
    static createBatch(objs: Array_Type<Genai.Project.Settings>, spec?: UpsertSpec): ObjList<Genai.Project.Settings> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Genai.Project.Settings>, spec?: CreateBatchObjStreamSpec): ObjList<Genai.Project.Settings> | null;
     ...
     */
    update(srcObj?: Genai.Project.Settings, spec?: UpsertSpec): Genai.Project.Settings | null;
     ...
     *         obj will have only those fields populated. Otherwise only the id field will be populated.
     */
    static update(srcObj?: Genai.Project.Settings, spec?: UpsertSpec): Genai.Project.Settings | null;
     ...
     */
    upsert(srcObj?: Genai.Project.Settings, spec?: UpsertSpec): Genai.Project.Settings | null;
     ...
     *         returned obj will have only those fields populated. Otherwise only the id field will be populated.
     */
    static upsert(srcObj?: Genai.Project.Settings, spec?: UpsertSpec): Genai.Project.Settings | null;
     ...
     */
    merge(spec?: MergeSpec): Genai.Project.Settings | null;
     ...
     * @see Mergespec#csvInclude
     */
    static merge(spec?: MergeSpec): Genai.Project.Settings | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): Genai.Project.Settings | null;
     ...
     * @return The created or updated obj.
     */
    static merge(mergeInclude: string, spec?: MergeSpec): Genai.Project.Settings | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): Genai.Project.Settings | null;
     ...
     * @return The created or updated obj.
     */
    static touch(spec?: TouchSpec): Genai.Project.Settings | null;
     ...
     */
    static updateBatch(objs: Array_Type<Genai.Project.Settings>, srcObjs?: Array_Type<Genai.Project.Settings>, spec?: UpsertSpec): ObjList<Genai.Project.Settings> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<Genai.Project.Settings> | null>, spec?: UpsertSpec): ObjList<Genai.Project.Settings> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<Genai.Project.Settings>, srcObjs?: Array_Type<Genai.Project.Settings>, spec?: UpsertSpec): ObjList<Genai.Project.Settings> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<Genai.Project.Settings> | null>, spec?: UpsertSpec): ObjList<Genai.Project.Settings> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<Genai.Project.Settings>, spec?: TouchSpec): ObjList<Genai.Project.Settings> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.Project.Settings>, spec?: MergeSpec): ObjList<Genai.Project.Settings> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.Project.Settings>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.Project.Settings> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<Genai.Project.Settings> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.Project.Settings> | null;
     ...
     */
    static mergeAll(mergeObj: Genai.Project.Settings, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Genai.Project.Settings, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<Genai.Project.Settings>, spec?: UpsertSpec): ObjList<Genai.Project.Settings> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<Genai.Project.Settings>, spec?: UpsertSpec): ObjList<Genai.Project.Settings> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): Genai.Project.Settings | null;
     ...
     * @see Ann.Db#archive
     */
    static unremove(): Genai.Project.Settings | null;
     ...
     */
    static beforeCreate(objs: Array_Type<Genai.Project.Settings>): ObjList<Genai.Project.Settings>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<Genai.Project.Settings>): ObjList<Genai.Project.Settings>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<Genai.Project.Settings>): ObjList<Genai.Project.Settings>;
     ...
     */
    static afterCreate(objs: Array_Type<Genai.Project.Settings>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<Genai.Project.Settings>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<Genai.Project.Settings>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<Genai.Project.Settings>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Genai.Project.Settings>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Genai.Project.Settings | null;
     ...
     */
    withoutIdentity(): Genai.Project.Settings | null;
     ...
     * @return The requested obj without any of its identifying fields.
     */
    static withoutIdentity(): Genai.Project.Settings | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<Genai.Project.Settings>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: Genai.Project.Settings, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<Genai.Project.Settings>, callback?: λFunction<Genai.Project.Settings | null, Genai.Project.Settings | null>): ObjList<Genai.Project.Settings>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<Genai.Project.Settings>, callback?: λFunction<Genai.Project.Settings | null, Genai.Project.Settings | null>): Array_Type<ObjError> | null;
     ...
     */
    static getDefaultSettings(): Genai.Project.Settings;
     ...
     * Initialize the #tutorialProject and #defaultProject
     */
    static initializeProjects(): void;
  }
}
