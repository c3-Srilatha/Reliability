// TypeScript definitions for the C3 type Genai.Query.ResultToSourceRelation
 ...
 * linked in #to.
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.Query.ResultToSourceRelation
 */
declare namespace Genai.Query {
  export interface IResultToSourceRelation {
     ...
     */
    to: IGenai.Query.Result.Source.AbstractSourceType;
 ...
 */
declare namespace Genai.Query {
  export class ResultToSourceRelation extends Obj  {
    ...
    withTypeIdent(typeIdent: string | null): Genai.Query.ResultToSourceRelation;
     ...
     */
    readonly id: string;
    withId(id: string): Genai.Query.ResultToSourceRelation;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Genai.Query.ResultToSourceRelation;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): Genai.Query.ResultToSourceRelation;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): Genai.Query.ResultToSourceRelation;
    ...
    withVersion(version: number | null): Genai.Query.ResultToSourceRelation;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): Genai.Query.ResultToSourceRelation;

    /**
     * The {@link Genai.Query.Result} that this relation is associated with.
     */
    readonly from?: Genai.Query.Result;
    withFrom(from: IGenai.Query.Result | null): Genai.Query.ResultToSourceRelation;

    /**
     * The {@link Genai.Agent.DynamicTrajectory.Step} that this relation is associated with.
     */
    readonly fromStep?: Genai.Agent.DynamicTrajectory.Step;
    withFromStep(fromStep: IGenai.Agent.DynamicTrajectory.Step | null): Genai.Query.ResultToSourceRelation;

    /**
     * The source that was used to generate the query result.
     */
    readonly to: Genai.Query.Result.Source.AbstractSourceType;
    withTo(to: IGenai.Query.Result.Source.AbstractSourceType): Genai.Query.ResultToSourceRelation;
    ...
    withPassageUiDisplayIndex(passageUiDisplayIndex: number | null): Genai.Query.ResultToSourceRelation;
    ...
    withDisplayName(displayName: string | null): Genai.Query.ResultToSourceRelation;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.Query.ResultToSourceRelation | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.Query.ResultToSourceRelation | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.Query.ResultToSourceRelation | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.Query.ResultToSourceRelation | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.Query.ResultToSourceRelation;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Query.ResultToSourceRelation;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Query.ResultToSourceRelation;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Query.ResultToSourceRelation>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Query.ResultToSourceRelation>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.Query.ResultToSourceRelation;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Query.ResultToSourceRelation;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Query.ResultToSourceRelation;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.Query.ResultToSourceRelation;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.Query.ResultToSourceRelation;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.Query.ResultToSourceRelation;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.Query.ResultToSourceRelation;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.Query.ResultToSourceRelation;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.Query.ResultToSourceRelation;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.Query.ResultToSourceRelation;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.Query.ResultToSourceRelation;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.Query.ResultToSourceRelation;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.Query.ResultToSourceRelation;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.Query.ResultToSourceRelation;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.Query.ResultToSourceRelation;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.Query.ResultToSourceRelation;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.Query.ResultToSourceRelation;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.Query.ResultToSourceRelation;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.Query.ResultToSourceRelation;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.Query.ResultToSourceRelation;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.Query.ResultToSourceRelation;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.Query.ResultToSourceRelation;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.Query.ResultToSourceRelation;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.Query.ResultToSourceRelation;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.Query.ResultToSourceRelation;

    mergeJson(json: any): Genai.Query.ResultToSourceRelation;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.Query.ResultToSourceRelation;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.Query.ResultToSourceRelation;
     ...
     */
    singletonArray(): Array_Type<Genai.Query.ResultToSourceRelation>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.Query.ResultToSourceRelation> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.Query.ResultToSourceRelation> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.Query.ResultToSourceRelation>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.Query.ResultToSourceRelation> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.Query.ResultToSourceRelation> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.Query.ResultToSourceRelation> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.Query.ResultToSourceRelation>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.Query.ResultToSourceRelation>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.Query.ResultToSourceRelation;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.Query.ResultToSourceRelation;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.Query.ResultToSourceRelation;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.Query.ResultToSourceRelation;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.Query.ResultToSourceRelation;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.Query.ResultToSourceRelation;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.Query.ResultToSourceRelation | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.Query.ResultToSourceRelation;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.Query.ResultToSourceRelation;
     ...
     */
    static cachedEmptyInst(): Genai.Query.ResultToSourceRelation;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.Query.ResultToSourceRelation> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.Query.ResultToSourceRelation;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<Genai.Query.ResultToSourceRelation>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Genai.Query.ResultToSourceRelation>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<Genai.Query.ResultToSourceRelation> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Genai.Query.ResultToSourceRelation>> | null;
     ...
     */
    get(include?: string): Genai.Query.ResultToSourceRelation | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): Genai.Query.ResultToSourceRelation | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Genai.Query.ResultToSourceRelation;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): Genai.Query.ResultToSourceRelation | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Genai.Query.ResultToSourceRelation;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.Query.ResultToSourceRelation | null;
     ...
     */
    create(spec?: UpsertSpec): Genai.Query.ResultToSourceRelation | null;
     ...
     */
    static createBatch(objs: Array_Type<Genai.Query.ResultToSourceRelation>, spec?: UpsertSpec): ObjList<Genai.Query.ResultToSourceRelation> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Genai.Query.ResultToSourceRelation>, spec?: CreateBatchObjStreamSpec): ObjList<Genai.Query.ResultToSourceRelation> | null;
     ...
     */
    update(srcObj?: Genai.Query.ResultToSourceRelation, spec?: UpsertSpec): Genai.Query.ResultToSourceRelation | null;
     ...
     */
    upsert(srcObj?: Genai.Query.ResultToSourceRelation, spec?: UpsertSpec): Genai.Query.ResultToSourceRelation | null;
     ...
     */
    merge(spec?: MergeSpec): Genai.Query.ResultToSourceRelation | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): Genai.Query.ResultToSourceRelation | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): Genai.Query.ResultToSourceRelation | null;
     ...
     */
    static updateBatch(objs: Array_Type<Genai.Query.ResultToSourceRelation>, srcObjs?: Array_Type<Genai.Query.ResultToSourceRelation>, spec?: UpsertSpec): ObjList<Genai.Query.ResultToSourceRelation> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<Genai.Query.ResultToSourceRelation> | null>, spec?: UpsertSpec): ObjList<Genai.Query.ResultToSourceRelation> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<Genai.Query.ResultToSourceRelation>, srcObjs?: Array_Type<Genai.Query.ResultToSourceRelation>, spec?: UpsertSpec): ObjList<Genai.Query.ResultToSourceRelation> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<Genai.Query.ResultToSourceRelation> | null>, spec?: UpsertSpec): ObjList<Genai.Query.ResultToSourceRelation> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<Genai.Query.ResultToSourceRelation>, spec?: TouchSpec): ObjList<Genai.Query.ResultToSourceRelation> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.Query.ResultToSourceRelation>, spec?: MergeSpec): ObjList<Genai.Query.ResultToSourceRelation> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.Query.ResultToSourceRelation>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.Query.ResultToSourceRelation> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<Genai.Query.ResultToSourceRelation> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.Query.ResultToSourceRelation> | null;
     ...
     */
    static mergeAll(mergeObj: Genai.Query.ResultToSourceRelation, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Genai.Query.ResultToSourceRelation, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<Genai.Query.ResultToSourceRelation>, spec?: UpsertSpec): ObjList<Genai.Query.ResultToSourceRelation> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<Genai.Query.ResultToSourceRelation>, spec?: UpsertSpec): ObjList<Genai.Query.ResultToSourceRelation> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): Genai.Query.ResultToSourceRelation | null;
     ...
     */
    static beforeCreate(objs: Array_Type<Genai.Query.ResultToSourceRelation>): ObjList<Genai.Query.ResultToSourceRelation>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<Genai.Query.ResultToSourceRelation>): ObjList<Genai.Query.ResultToSourceRelation>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<Genai.Query.ResultToSourceRelation>): ObjList<Genai.Query.ResultToSourceRelation>;
     ...
     */
    static afterCreate(objs: Array_Type<Genai.Query.ResultToSourceRelation>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<Genai.Query.ResultToSourceRelation>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<Genai.Query.ResultToSourceRelation>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<Genai.Query.ResultToSourceRelation>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Genai.Query.ResultToSourceRelation>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Genai.Query.ResultToSourceRelation | null;
     ...
     */
    withoutIdentity(): Genai.Query.ResultToSourceRelation | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<Genai.Query.ResultToSourceRelation>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: Genai.Query.ResultToSourceRelation, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<Genai.Query.ResultToSourceRelation>, callback?: λFunction<Genai.Query.ResultToSourceRelation | null, Genai.Query.ResultToSourceRelation | null>): ObjList<Genai.Query.ResultToSourceRelation>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<Genai.Query.ResultToSourceRelation>, callback?: λFunction<Genai.Query.ResultToSourceRelation | null, Genai.Query.ResultToSourceRelation | null>): Array_Type<ObjError> | null;
     ...
     */
    static cloneTo(srcResult: Genai.Query.Result, destResult: Genai.Query.Result): Array_Type<Genai.Query.ResultToSourceRelation>;
     ...
     */
    static cloneRelationsToParent(queryResult: Genai.Query.Result): Array_Type<Genai.Query.ResultToSourceRelation> | null;
     ...
     * @return the list of relations for parent
     */
    static relationsForParent(queryResult: Genai.Query.Result): Array_Type<Genai.Query.ResultToSourceRelation> | null;
