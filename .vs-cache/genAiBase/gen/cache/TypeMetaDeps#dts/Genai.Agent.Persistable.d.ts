// TypeScript definitions for the C3 type Genai.Agent.Persistable
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.Agent.Persistable
 */
declare namespace Genai.Agent {
  export interface IPersistable<C, S> {
 ...
 */
declare namespace Genai.Agent {
  export class Persistable<C, S> extends Obj  {

    /**
     * The {@link Genai.Project} this instance is linked to.
     */
    readonly projects?: Array_Type<Genai.Project>;
    withProjects(projects: Array_Type<Genai.Project> | Array<IGenai.Project> | null): Genai.Agent.Persistable;
    ...
    withTypeIdent(typeIdent: string | null): Genai.Agent.Persistable;
     ...
     */
    readonly id: string;
    withId(id: string): Genai.Agent.Persistable;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Genai.Agent.Persistable;

    /**
     * User friendly name of the agent. It must be unique.
     */
    readonly name: string;
    withName(name: string): Genai.Agent.Persistable;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): Genai.Agent.Persistable;
    ...
    withVersion(version: number | null): Genai.Agent.Persistable;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): Genai.Agent.Persistable;
    ...
    withPromptParamValues(promptParamValues: Map_Type<string, string> | {[key: string]: string} | null): Genai.Agent.Persistable;

    /**
     * The configuration of the agent.
     */
    readonly config: C;
    withConfig(config: C): Genai.Agent.Persistable;

    /**
     * The agent's active state. If inactive, the agent will not be displayed in the tool selector in the UI.
     */
    readonly inactive?: boolean;
    withInactive(inactive: boolean): Genai.Agent.Persistable;

    /**
     * Configuration for how this will be shown as a UI drop-down option
     */
    readonly uiOptions?: Genai.Agent.Tool.Config.UiOptions;
    withUiOptions(uiOptions: IGenai.Agent.Tool.Config.UiOptions | null): Genai.Agent.Persistable;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.Agent.Persistable<C, S> | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.Agent.Persistable<C, S> | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.Agent.Persistable<C, S> | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.Agent.Persistable<C, S> | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.Agent.Persistable<C, S>;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Agent.Persistable<C, S>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Agent.Persistable<C, S>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Agent.Persistable<C, S>>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Agent.Persistable<C, S>>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.Agent.Persistable<C, S>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Agent.Persistable<C, S>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Agent.Persistable<C, S>;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.Agent.Persistable<C, S>;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.Agent.Persistable<C, S>;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.Agent.Persistable<C, S>;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.Agent.Persistable<C, S>;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.Agent.Persistable<C, S>;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.Agent.Persistable<C, S>;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.Agent.Persistable<C, S>;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.Agent.Persistable<C, S>;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.Agent.Persistable<C, S>;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.Agent.Persistable<C, S>;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.Agent.Persistable<C, S>;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.Agent.Persistable<C, S>;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.Agent.Persistable<C, S>;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.Agent.Persistable<C, S>;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.Agent.Persistable<C, S>;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.Agent.Persistable<C, S>;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.Agent.Persistable<C, S>;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.Agent.Persistable<C, S>;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.Agent.Persistable<C, S>;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.Agent.Persistable<C, S>;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.Agent.Persistable<C, S>;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.Agent.Persistable<C, S>;

    mergeJson(json: any): Genai.Agent.Persistable<C, S>;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.Agent.Persistable<C, S>;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.Agent.Persistable<C, S>;
     ...
     */
    singletonArray(): Array_Type<Genai.Agent.Persistable<C, S>>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.Agent.Persistable<C, S>> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.Agent.Persistable<C, S>> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.Agent.Persistable<C, S>>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.Agent.Persistable<C, S>> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.Agent.Persistable<C, S>> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.Agent.Persistable<C, S>> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.Agent.Persistable<C, S>>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.Agent.Persistable<C, S>>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.Agent.Persistable<C, S>;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.Agent.Persistable<C, S>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.Agent.Persistable<C, S>;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.Agent.Persistable<C, S>;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.Agent.Persistable<C, S>;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.Agent.Persistable<C, S>;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.Agent.Persistable<C, S> | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.Agent.Persistable<C, S>;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.Agent.Persistable<C, S>;
     ...
     */
    static cachedEmptyInst(): Genai.Agent.Persistable<C, S>;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.Agent.Persistable<C, S>> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.Agent.Persistable<C, S>;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<Genai.Agent.Persistable<C, S>>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Genai.Agent.Persistable<C, S>>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<Genai.Agent.Persistable<C, S>> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Genai.Agent.Persistable<C, S>>> | null;
     ...
     */
    get(include?: string): Genai.Agent.Persistable<C, S> | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): Genai.Agent.Persistable<C, S> | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Genai.Agent.Persistable<C, S>;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): Genai.Agent.Persistable<C, S> | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Genai.Agent.Persistable<C, S>;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.Agent.Persistable<C, S> | null;
     ...
     */
    create(spec?: UpsertSpec): Genai.Agent.Persistable<C, S> | null;
     ...
     */
    static createBatch(objs: Array_Type<Genai.Agent.Persistable<C, S>>, spec?: UpsertSpec): ObjList<Genai.Agent.Persistable<C, S>> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Genai.Agent.Persistable<C, S>>, spec?: CreateBatchObjStreamSpec): ObjList<Genai.Agent.Persistable<C, S>> | null;
     ...
     */
    update(srcObj?: Genai.Agent.Persistable<C, S>, spec?: UpsertSpec): Genai.Agent.Persistable<C, S> | null;
     ...
     */
    upsert(srcObj?: Genai.Agent.Persistable<C, S>, spec?: UpsertSpec): Genai.Agent.Persistable<C, S> | null;
     ...
     */
    merge(spec?: MergeSpec): Genai.Agent.Persistable<C, S> | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): Genai.Agent.Persistable<C, S> | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): Genai.Agent.Persistable<C, S> | null;
     ...
     */
    static updateBatch(objs: Array_Type<Genai.Agent.Persistable<C, S>>, srcObjs?: Array_Type<Genai.Agent.Persistable<C, S>>, spec?: UpsertSpec): ObjList<Genai.Agent.Persistable<C, S>> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<Genai.Agent.Persistable<C, S>> | null>, spec?: UpsertSpec): ObjList<Genai.Agent.Persistable<C, S>> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<Genai.Agent.Persistable<C, S>>, srcObjs?: Array_Type<Genai.Agent.Persistable<C, S>>, spec?: UpsertSpec): ObjList<Genai.Agent.Persistable<C, S>> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<Genai.Agent.Persistable<C, S>> | null>, spec?: UpsertSpec): ObjList<Genai.Agent.Persistable<C, S>> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<Genai.Agent.Persistable<C, S>>, spec?: TouchSpec): ObjList<Genai.Agent.Persistable<C, S>> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.Agent.Persistable<C, S>>, spec?: MergeSpec): ObjList<Genai.Agent.Persistable<C, S>> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.Agent.Persistable<C, S>>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.Agent.Persistable<C, S>> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<Genai.Agent.Persistable<C, S>> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.Agent.Persistable<C, S>> | null;
     ...
     */
    static mergeAll(mergeObj: Genai.Agent.Persistable<C, S>, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Genai.Agent.Persistable<C, S>, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<Genai.Agent.Persistable<C, S>>, spec?: UpsertSpec): ObjList<Genai.Agent.Persistable<C, S>> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<Genai.Agent.Persistable<C, S>>, spec?: UpsertSpec): ObjList<Genai.Agent.Persistable<C, S>> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): Genai.Agent.Persistable<C, S> | null;
     ...
     */
    static beforeCreate(objs: Array_Type<Genai.Agent.Persistable<C, S>>): ObjList<Genai.Agent.Persistable<C, S>>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<Genai.Agent.Persistable<C, S>>): ObjList<Genai.Agent.Persistable<C, S>>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<Genai.Agent.Persistable<C, S>>): ObjList<Genai.Agent.Persistable<C, S>>;
     ...
     */
    static afterCreate(objs: Array_Type<Genai.Agent.Persistable<C, S>>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<Genai.Agent.Persistable<C, S>>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<Genai.Agent.Persistable<C, S>>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<Genai.Agent.Persistable<C, S>>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Genai.Agent.Persistable<C, S>>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Genai.Agent.Persistable<C, S> | null;
     ...
     */
    withoutIdentity(): Genai.Agent.Persistable<C, S> | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<Genai.Agent.Persistable<C, S>>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: Genai.Agent.Persistable<C, S>, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<Genai.Agent.Persistable<C, S>>, callback?: λFunction<Genai.Agent.Persistable<C, S> | null, Genai.Agent.Persistable<C, S> | null>): ObjList<Genai.Agent.Persistable<C, S>>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<Genai.Agent.Persistable<C, S>>, callback?: λFunction<Genai.Agent.Persistable<C, S> | null, Genai.Agent.Persistable<C, S> | null>): Array_Type<ObjError> | null;
     ...
     */
    static save(spec: Genai.Agent.Persistable.SaveSpec<S>): Genai.Agent.Persistable<any, any>;
