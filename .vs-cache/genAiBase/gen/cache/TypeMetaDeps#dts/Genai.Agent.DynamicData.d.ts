// TypeScript definitions for the C3 type Genai.Agent.DynamicData

/**
 * Type for persisting the output of the {@link Genai.Agent.Dynamic}
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.Agent.DynamicData
 */
declare namespace Genai.Agent {
  export interface IDynamicData {
     ...
     */
    data?: string | IGenAiVisualizationBase | IFile;
  }
}
 ...
 */
declare namespace Genai.Agent {
  export class DynamicData extends Obj  {

    /**
     * The final data frame produced by the agent
     */
    readonly persistedData?: Data.Persisted;
    withPersistedData(persistedData: IData.Persisted | null): Genai.Agent.DynamicData;
     ...
     */
    readonly id: string;
    withId(id: string): Genai.Agent.DynamicData;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Genai.Agent.DynamicData;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): Genai.Agent.DynamicData;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): Genai.Agent.DynamicData;
    ...
    withVersion(version: number | null): Genai.Agent.DynamicData;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): Genai.Agent.DynamicData;

    /**
     * The data stored from the output of the {@link Genai.Agent.Dynamic}
     */
    readonly data?: string | GenAiVisualizationBase | File;
    withData(data: string | IGenAiVisualizationBase | IFile | null): Genai.Agent.DynamicData;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.Agent.DynamicData | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.Agent.DynamicData | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.Agent.DynamicData | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.Agent.DynamicData | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.Agent.DynamicData;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Agent.DynamicData;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Agent.DynamicData;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Agent.DynamicData>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Agent.DynamicData>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.Agent.DynamicData;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Agent.DynamicData;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Agent.DynamicData;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.Agent.DynamicData;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.Agent.DynamicData;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.Agent.DynamicData;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.Agent.DynamicData;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.Agent.DynamicData;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.Agent.DynamicData;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.Agent.DynamicData;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.Agent.DynamicData;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.Agent.DynamicData;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.Agent.DynamicData;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.Agent.DynamicData;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.Agent.DynamicData;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.Agent.DynamicData;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.Agent.DynamicData;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.Agent.DynamicData;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.Agent.DynamicData;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.Agent.DynamicData;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.Agent.DynamicData;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.Agent.DynamicData;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.Agent.DynamicData;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.Agent.DynamicData;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.Agent.DynamicData;

    mergeJson(json: any): Genai.Agent.DynamicData;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.Agent.DynamicData;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.Agent.DynamicData;
     ...
     */
    singletonArray(): Array_Type<Genai.Agent.DynamicData>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.Agent.DynamicData> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.Agent.DynamicData> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.Agent.DynamicData>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.Agent.DynamicData> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.Agent.DynamicData> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.Agent.DynamicData> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.Agent.DynamicData>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.Agent.DynamicData>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.Agent.DynamicData;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.Agent.DynamicData;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.Agent.DynamicData;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.Agent.DynamicData;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.Agent.DynamicData;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.Agent.DynamicData;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.Agent.DynamicData | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.Agent.DynamicData;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.Agent.DynamicData;
     ...
     */
    static cachedEmptyInst(): Genai.Agent.DynamicData;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.Agent.DynamicData> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.Agent.DynamicData;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<Genai.Agent.DynamicData>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Genai.Agent.DynamicData>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<Genai.Agent.DynamicData> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Genai.Agent.DynamicData>> | null;
     ...
     */
    get(include?: string): Genai.Agent.DynamicData | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): Genai.Agent.DynamicData | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Genai.Agent.DynamicData;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): Genai.Agent.DynamicData | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Genai.Agent.DynamicData;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.Agent.DynamicData | null;
     ...
     */
    create(spec?: UpsertSpec): Genai.Agent.DynamicData | null;
     ...
     */
    static createBatch(objs: Array_Type<Genai.Agent.DynamicData>, spec?: UpsertSpec): ObjList<Genai.Agent.DynamicData> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Genai.Agent.DynamicData>, spec?: CreateBatchObjStreamSpec): ObjList<Genai.Agent.DynamicData> | null;
     ...
     */
    update(srcObj?: Genai.Agent.DynamicData, spec?: UpsertSpec): Genai.Agent.DynamicData | null;
     ...
     */
    upsert(srcObj?: Genai.Agent.DynamicData, spec?: UpsertSpec): Genai.Agent.DynamicData | null;
     ...
     */
    merge(spec?: MergeSpec): Genai.Agent.DynamicData | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): Genai.Agent.DynamicData | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): Genai.Agent.DynamicData | null;
     ...
     */
    static updateBatch(objs: Array_Type<Genai.Agent.DynamicData>, srcObjs?: Array_Type<Genai.Agent.DynamicData>, spec?: UpsertSpec): ObjList<Genai.Agent.DynamicData> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<Genai.Agent.DynamicData> | null>, spec?: UpsertSpec): ObjList<Genai.Agent.DynamicData> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<Genai.Agent.DynamicData>, srcObjs?: Array_Type<Genai.Agent.DynamicData>, spec?: UpsertSpec): ObjList<Genai.Agent.DynamicData> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<Genai.Agent.DynamicData> | null>, spec?: UpsertSpec): ObjList<Genai.Agent.DynamicData> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<Genai.Agent.DynamicData>, spec?: TouchSpec): ObjList<Genai.Agent.DynamicData> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.Agent.DynamicData>, spec?: MergeSpec): ObjList<Genai.Agent.DynamicData> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.Agent.DynamicData>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.Agent.DynamicData> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<Genai.Agent.DynamicData> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.Agent.DynamicData> | null;
     ...
     */
    static mergeAll(mergeObj: Genai.Agent.DynamicData, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Genai.Agent.DynamicData, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<Genai.Agent.DynamicData>, spec?: UpsertSpec): ObjList<Genai.Agent.DynamicData> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<Genai.Agent.DynamicData>, spec?: UpsertSpec): ObjList<Genai.Agent.DynamicData> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): Genai.Agent.DynamicData | null;
     ...
     */
    static beforeCreate(objs: Array_Type<Genai.Agent.DynamicData>): ObjList<Genai.Agent.DynamicData>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<Genai.Agent.DynamicData>): ObjList<Genai.Agent.DynamicData>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<Genai.Agent.DynamicData>): ObjList<Genai.Agent.DynamicData>;
     ...
     */
    static afterCreate(objs: Array_Type<Genai.Agent.DynamicData>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<Genai.Agent.DynamicData>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<Genai.Agent.DynamicData>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<Genai.Agent.DynamicData>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Genai.Agent.DynamicData>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Genai.Agent.DynamicData | null;
     ...
     */
    withoutIdentity(): Genai.Agent.DynamicData | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<Genai.Agent.DynamicData>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: Genai.Agent.DynamicData, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<Genai.Agent.DynamicData>, callback?: λFunction<Genai.Agent.DynamicData | null, Genai.Agent.DynamicData | null>): ObjList<Genai.Agent.DynamicData>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<Genai.Agent.DynamicData>, callback?: λFunction<Genai.Agent.DynamicData | null, Genai.Agent.DynamicData | null>): Array_Type<ObjError> | null;
