// TypeScript definitions for the C3 type Genai.SourceCollection

/**
 * A Genai.SourceCollection defines a corpus of sources that can be parsed to serve a Generative AI search application.
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.SourceCollection
 */
declare namespace Genai {
  export interface ISourceCollection {
     ...
     */
    files?: Array_Type<Genai.SourceFile> | Array<IGenai.SourceFile>;
     ...
     */
    system?: IGenai.SourceSystem<Genai.SourceSystem.CreateSpec>;
     ...
     */
    combinedPassagesFileIsStale?: boolean;
     ...
     */
    indexedContentProvider?: λTriFunction<string, Genai.SourceFile, Genai.SourcePassage | null, string>;
     ...
     */
    syncMetadataLambda?: λFunction<Genai.SourceFile, IGenai.SourceFile.Metadata>;
     ...
     */
    lastSyncTime?: DateTime | Date | string;
 ...
 */
declare namespace Genai {
  export class SourceCollection extends Obj  {

    /**
     * The {@link Genai.Project} this instance is linked to.
     */
    readonly projects?: Array_Type<Genai.Project>;
    withProjects(projects: Array_Type<Genai.Project> | Array<IGenai.Project> | null): Genai.SourceCollection;

    /**
     * The name of this instance.
     */
    readonly name?: string;
    withName(name: string | null): Genai.SourceCollection;

    /**
     * List of {@link AclEntry} entries governing who can read/update/remove Objs.
     */
    readonly acl?: Array_Type<AclEntry>;
    withAcl(acl: Array_Type<AclEntry> | Array<IAclEntry> | null): Genai.SourceCollection;
     ...
     */
    readonly id: string;
    withId(id: string): Genai.SourceCollection;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Genai.SourceCollection;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): Genai.SourceCollection;
    ...
    withVersion(version: number | null): Genai.SourceCollection;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): Genai.SourceCollection;

    /**
     * An optional description of this source collection
     */
    readonly description?: string;
    withDescription(description: string | null): Genai.SourceCollection;
    ...
    withRootUrl(rootUrl: string): Genai.SourceCollection;

    /**
     * The url of the root folder where all files for embeddings, passages, etc for this collection should be stored.
     */
    readonly targetUrl: string;
    withTargetUrl(targetUrl: string): Genai.SourceCollection;

    /**
     * All files that come from this collection.
     */
    readonly files?: Array_Type<Genai.SourceFile>;
    withFiles(files: Array_Type<Genai.SourceFile> | Array<IGenai.SourceFile> | null): Genai.SourceCollection;

    /**
     * Count of all files for this collection.
     */
    readonly fileCount?: number;
    withFileCount(fileCount: number | null): Genai.SourceCollection;

    /**
     * The external source system this collection is a part of, if any.
     */
    readonly system?: Genai.SourceSystem<Genai.SourceSystem.CreateSpec>;
    withSystem(system: IGenai.SourceSystem<Genai.SourceSystem.CreateSpec> | null): Genai.SourceCollection;
     ...
     * This field should be accessed via `mergedPassages`
     */
    readonly combinedPassagesFile?: File;
    withCombinedPassagesFile(combinedPassagesFile: IFile | null): Genai.SourceCollection;

    /**
     * A flag to indicate when SourceFiles in this Collection have been added, removed, or updated since
     * combinedPassagesFile was last created.
     */
    readonly combinedPassagesFileIsStale?: boolean;
    withCombinedPassagesFileIsStale(combinedPassagesFileIsStale: boolean): Genai.SourceCollection;

    /**
     * The {@link User#email} who synced the source collection.
     */
    readonly lastSyncedBy?: string;
    withLastSyncedBy(lastSyncedBy: string | null): Genai.SourceCollection;

    /**
     * Information about the user who synced the source collection formatted for display in the UI
     */
    readonly displayLastSyncedBy?: string;
    withDisplayLastSyncedBy(displayLastSyncedBy: string | null): Genai.SourceCollection;
     ...
     * Also the contents of the Genai.SourcePassage can be added to the lambda and can be indexed.
     */
    readonly indexedContentProvider?: λTriFunction<string, Genai.SourceFile, Genai.SourcePassage | null, string>;
    withIndexedContentProvider(indexedContentProvider: λTriFunction<string, Genai.SourceFile, Genai.SourcePassage | null, string> | null): Genai.SourceCollection;

    /**
     * Lambda to override what {@link Genai.SourceFile.Metadata} is saved for a {@link Genai.SourceFile}
     * during the file syncing process
     */
    readonly syncMetadataLambda?: λFunction<Genai.SourceFile, Genai.SourceFile.Metadata>;
    withSyncMetadataLambda(syncMetadataLambda: λFunction<Genai.SourceFile, IGenai.SourceFile.Metadata> | null): Genai.SourceCollection;

    /**
     * Last sync metadata lambda function executed during sync (stringified)
     */
    readonly lastExecutedSyncMetadataLambda?: string;
    withLastExecutedSyncMetadataLambda(lastExecutedSyncMetadataLambda: string | null): Genai.SourceCollection;

    /**
     * The **start** time of the last sync
     */
    readonly lastSyncTime?: DateTime;
    withLastSyncTime(lastSyncTime: DateTime | Date | string | null): Genai.SourceCollection;

    /**
     * The groups with access to this collection.
     */
    readonly groups?: Array_Type<Role>;
    withGroups(groups: Array_Type<Role> | Array<IRole> | null): Genai.SourceCollection;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.SourceCollection | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.SourceCollection | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.SourceCollection | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.SourceCollection | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.SourceCollection;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.SourceCollection;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.SourceCollection;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.SourceCollection>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.SourceCollection>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.SourceCollection;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.SourceCollection;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.SourceCollection;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.SourceCollection;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.SourceCollection;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.SourceCollection;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.SourceCollection;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.SourceCollection;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.SourceCollection;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.SourceCollection;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.SourceCollection;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.SourceCollection;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.SourceCollection;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.SourceCollection;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.SourceCollection;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.SourceCollection;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.SourceCollection;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.SourceCollection;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.SourceCollection;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.SourceCollection;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.SourceCollection;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.SourceCollection;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.SourceCollection;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.SourceCollection;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.SourceCollection;

    mergeJson(json: any): Genai.SourceCollection;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.SourceCollection;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.SourceCollection;
     ...
     */
    singletonArray(): Array_Type<Genai.SourceCollection>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.SourceCollection> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.SourceCollection> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.SourceCollection>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.SourceCollection> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.SourceCollection> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.SourceCollection> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.SourceCollection>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.SourceCollection>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.SourceCollection;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.SourceCollection;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.SourceCollection;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.SourceCollection;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.SourceCollection;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.SourceCollection;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.SourceCollection | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.SourceCollection;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.SourceCollection;
     ...
     */
    static cachedEmptyInst(): Genai.SourceCollection;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.SourceCollection> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.SourceCollection;
     ...
     */
    config(secrets?: boolean): Genai.SourceCollection.Metadata.Config;
     ...
     */
    static typeConfig(): Genai.SourceCollection.Metadata.Config;
     ...
     */
    static populateAcl(objs?: Array_Type<Genai.SourceCollection>): number | null;
     ...
     */
    grantMemberReadUpdateRemove(member: AccessControlEntity): Genai.SourceCollection;
     ...
     */
    mergeAclEntry(entry: AclEntry): Genai.SourceCollection;
     ...
     * @return the obj with the new acl after merging the indicated entry.
     */
    mergeAclEntries(entries: Array_Type<AclEntry>): Genai.SourceCollection;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<Genai.SourceCollection>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Genai.SourceCollection>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<Genai.SourceCollection> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Genai.SourceCollection>> | null;
     ...
     */
    get(include?: string): Genai.SourceCollection | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): Genai.SourceCollection | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Genai.SourceCollection;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): Genai.SourceCollection | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Genai.SourceCollection;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.SourceCollection | null;
     ...
     */
    create(spec?: UpsertSpec): Genai.SourceCollection | null;
     ...
     */
    static createBatch(objs: Array_Type<Genai.SourceCollection>, spec?: UpsertSpec): ObjList<Genai.SourceCollection> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Genai.SourceCollection>, spec?: CreateBatchObjStreamSpec): ObjList<Genai.SourceCollection> | null;
     ...
     */
    update(srcObj?: Genai.SourceCollection, spec?: UpsertSpec): Genai.SourceCollection | null;
     ...
     */
    upsert(srcObj?: Genai.SourceCollection, spec?: UpsertSpec): Genai.SourceCollection | null;
     ...
     */
    merge(spec?: MergeSpec): Genai.SourceCollection | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): Genai.SourceCollection | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): Genai.SourceCollection | null;
     ...
     */
    static updateBatch(objs: Array_Type<Genai.SourceCollection>, srcObjs?: Array_Type<Genai.SourceCollection>, spec?: UpsertSpec): ObjList<Genai.SourceCollection> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<Genai.SourceCollection> | null>, spec?: UpsertSpec): ObjList<Genai.SourceCollection> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<Genai.SourceCollection>, srcObjs?: Array_Type<Genai.SourceCollection>, spec?: UpsertSpec): ObjList<Genai.SourceCollection> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<Genai.SourceCollection> | null>, spec?: UpsertSpec): ObjList<Genai.SourceCollection> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<Genai.SourceCollection>, spec?: TouchSpec): ObjList<Genai.SourceCollection> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.SourceCollection>, spec?: MergeSpec): ObjList<Genai.SourceCollection> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.SourceCollection>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.SourceCollection> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<Genai.SourceCollection> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.SourceCollection> | null;
     ...
     */
    static mergeAll(mergeObj: Genai.SourceCollection, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Genai.SourceCollection, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<Genai.SourceCollection>, spec?: UpsertSpec): ObjList<Genai.SourceCollection> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<Genai.SourceCollection>, spec?: UpsertSpec): ObjList<Genai.SourceCollection> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): Genai.SourceCollection | null;
     ...
     */
    static beforeCreate(objs: Array_Type<Genai.SourceCollection>): ObjList<Genai.SourceCollection>;
     ...
     */
    static beforeUpdate(objs: Array_Type<Genai.SourceCollection>): ObjList<Genai.SourceCollection>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<Genai.SourceCollection>): ObjList<Genai.SourceCollection>;
     ...
     */
    static afterCreate(objs: Array_Type<Genai.SourceCollection>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<Genai.SourceCollection>): Array_Type<ObjError> | null;
     ...
     */
    static afterRemove(objs: Array_Type<Genai.SourceCollection>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<Genai.SourceCollection>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Genai.SourceCollection>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Genai.SourceCollection | null;
     ...
     */
    withoutIdentity(): Genai.SourceCollection | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<Genai.SourceCollection>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: Genai.SourceCollection, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<Genai.SourceCollection>, callback?: λFunction<Genai.SourceCollection | null, Genai.SourceCollection | null>): ObjList<Genai.SourceCollection>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<Genai.SourceCollection>, callback?: λFunction<Genai.SourceCollection | null, Genai.SourceCollection | null>): Array_Type<ObjError> | null;
     ...
     */
    mergedPassages(refresh?: boolean, forceRefresh?: boolean): File;
     ...
     */
    processUnprocessSourceFiles(): void;
     ...
     */
    sync(syncSpec?: Genai.SourceCollection.SyncSpec, chunkerSpec?: Genai.SourceFile.Chunker.UniversalChunker.Spec): Genai.SourceCollection.SyncJobs;
     ...
     */
    syncFiles(sourceFiles: Array_Type<Genai.SourceFile>, chunkerSpec?: Genai.SourceFile.Chunker.UniversalChunker.Spec): void;
     ...
     */
    setMetadataConfig(config: Genai.SourceCollection.Metadata.Config): void;
     ...
     */
    archiveStaleFiles(filter?: string): string;
     ...
     */
    upload(files: Array_Type<File>): Array_Type<Genai.SourceFile>;
     ...
     */
    static uploadFileToRemote(sourceFilePath: string, destFilePath: string): void;
  }
}
