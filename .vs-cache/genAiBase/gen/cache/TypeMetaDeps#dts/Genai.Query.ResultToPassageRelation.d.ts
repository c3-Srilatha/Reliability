// TypeScript definitions for the C3 type Genai.Query.ResultToPassageRelation

/**
 * Link between a {@link Genai.Query.Result} and one of the {@link Genai.SourcePassage}s that was deemed 'relevant' to
 * the user's query. These results are used to populate the relevant documents section of the UI, but except for the
 * first few, are not used for generating the answer.
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.Query.ResultToPassageRelation
 */
declare namespace Genai.Query {
  export interface IResultToPassageRelation {

    /**
     * The passage that was selected
     */
    passage: IGenai.SourcePassage;

    /**
     * The {@link Genai.SourceFile} that the #passage belongs to.
     */
    sourceFile: IGenai.SourceFile;

    /**
     * The result from attribution with corroboration for this source relation.
     */
    sourceAttribution?: Array_Type<Genai.Agent.Tool.Util.Attributor.Segmentation.Source> | Array<IGenai.Agent.Tool.Util.Attributor.Segmentation.Source>;
    ...
    /**
     * The relevance score associated with this {@link Genai.SourceFile} for the {@link Genai.Query.Result#searchQuery}.
     * Between 0 and 1.
     */
    score?: number;

    /**
     * Relevance score scaled to 100, for UI display
     */
    scaledScore?: number;

    /**
     * Feedback on the inclusion of the file into the search results of the query
     */
    feedback?: Array_Type<Genai.Query.Result.PassageFeedback> | Array<IGenai.Query.Result.PassageFeedback>;
  }
}
 ...
 * first few, are not used for generating the answer.
 *
 * @remarks this represents a made instance of Genai.Query.ResultToPassageRelation
 */
declare namespace Genai.Query {
  export class ResultToPassageRelation extends Obj  {

    /**
     * The passage that was selected
     */
    readonly passage: Genai.SourcePassage;
    withPassage(passage: IGenai.SourcePassage): Genai.Query.ResultToPassageRelation;

    /**
     * The {@link Genai.SourceFile} that the #passage belongs to.
     */
    readonly sourceFile: Genai.SourceFile;
    withSourceFile(sourceFile: IGenai.SourceFile): Genai.Query.ResultToPassageRelation;

    /**
     * The result from attribution with corroboration for this source relation.
     */
    readonly sourceAttribution?: Array_Type<Genai.Agent.Tool.Util.Attributor.Segmentation.Source>;
    withSourceAttribution(sourceAttribution: Array_Type<Genai.Agent.Tool.Util.Attributor.Segmentation.Source> | Array<IGenai.Agent.Tool.Util.Attributor.Segmentation.Source> | null): Genai.Query.ResultToPassageRelation;
    ...
    withTypeIdent(typeIdent: string | null): Genai.Query.ResultToPassageRelation;
     ...
     */
    readonly id: string;
    withId(id: string): Genai.Query.ResultToPassageRelation;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Genai.Query.ResultToPassageRelation;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): Genai.Query.ResultToPassageRelation;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): Genai.Query.ResultToPassageRelation;
    ...
    withVersion(version: number | null): Genai.Query.ResultToPassageRelation;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): Genai.Query.ResultToPassageRelation;

    /**
     * The {@link Genai.Query.Result} that this relation is associated with.
     */
    readonly from?: Genai.Query.Result;
    withFrom(from: IGenai.Query.Result | null): Genai.Query.ResultToPassageRelation;

    /**
     * The {@link Genai.Agent.DynamicTrajectory.Step} that this relation is associated with.
     */
    readonly fromStep?: Genai.Agent.DynamicTrajectory.Step;
    withFromStep(fromStep: IGenai.Agent.DynamicTrajectory.Step | null): Genai.Query.ResultToPassageRelation;
    ...
    withScore(score: number | null): Genai.Query.ResultToPassageRelation;

    /**
     * Relevance score scaled to 100, for UI display
     */
    readonly scaledScore?: number;
    withScaledScore(scaledScore: number | null): Genai.Query.ResultToPassageRelation;

    /**
     * Feedback on the inclusion of the file into the search results of the query
     */
    readonly feedback?: Array_Type<Genai.Query.Result.PassageFeedback>;
    withFeedback(feedback: Array_Type<Genai.Query.Result.PassageFeedback> | Array<IGenai.Query.Result.PassageFeedback> | null): Genai.Query.ResultToPassageRelation;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.Query.ResultToPassageRelation | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.Query.ResultToPassageRelation | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.Query.ResultToPassageRelation | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.Query.ResultToPassageRelation | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.Query.ResultToPassageRelation;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Query.ResultToPassageRelation;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Query.ResultToPassageRelation;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Query.ResultToPassageRelation>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Query.ResultToPassageRelation>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.Query.ResultToPassageRelation;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Query.ResultToPassageRelation;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Query.ResultToPassageRelation;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.Query.ResultToPassageRelation;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.Query.ResultToPassageRelation;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.Query.ResultToPassageRelation;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.Query.ResultToPassageRelation;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.Query.ResultToPassageRelation;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.Query.ResultToPassageRelation;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.Query.ResultToPassageRelation;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.Query.ResultToPassageRelation;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.Query.ResultToPassageRelation;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.Query.ResultToPassageRelation;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.Query.ResultToPassageRelation;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.Query.ResultToPassageRelation;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.Query.ResultToPassageRelation;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.Query.ResultToPassageRelation;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.Query.ResultToPassageRelation;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.Query.ResultToPassageRelation;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.Query.ResultToPassageRelation;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.Query.ResultToPassageRelation;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.Query.ResultToPassageRelation;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.Query.ResultToPassageRelation;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.Query.ResultToPassageRelation;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.Query.ResultToPassageRelation;

    mergeJson(json: any): Genai.Query.ResultToPassageRelation;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.Query.ResultToPassageRelation;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.Query.ResultToPassageRelation;
     ...
     */
    singletonArray(): Array_Type<Genai.Query.ResultToPassageRelation>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.Query.ResultToPassageRelation> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.Query.ResultToPassageRelation> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.Query.ResultToPassageRelation>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.Query.ResultToPassageRelation> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.Query.ResultToPassageRelation> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.Query.ResultToPassageRelation> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.Query.ResultToPassageRelation>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.Query.ResultToPassageRelation>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.Query.ResultToPassageRelation;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.Query.ResultToPassageRelation;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.Query.ResultToPassageRelation;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.Query.ResultToPassageRelation;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.Query.ResultToPassageRelation;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.Query.ResultToPassageRelation;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.Query.ResultToPassageRelation | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.Query.ResultToPassageRelation;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.Query.ResultToPassageRelation;
     ...
     */
    static cachedEmptyInst(): Genai.Query.ResultToPassageRelation;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.Query.ResultToPassageRelation> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.Query.ResultToPassageRelation;
     ...
     */
    sourcePassage(): Genai.SourcePassage;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<Genai.Query.ResultToPassageRelation>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Genai.Query.ResultToPassageRelation>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<Genai.Query.ResultToPassageRelation> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Genai.Query.ResultToPassageRelation>> | null;
     ...
     */
    get(include?: string): Genai.Query.ResultToPassageRelation | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): Genai.Query.ResultToPassageRelation | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Genai.Query.ResultToPassageRelation;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): Genai.Query.ResultToPassageRelation | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Genai.Query.ResultToPassageRelation;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.Query.ResultToPassageRelation | null;
     ...
     */
    create(spec?: UpsertSpec): Genai.Query.ResultToPassageRelation | null;
     ...
     */
    static createBatch(objs: Array_Type<Genai.Query.ResultToPassageRelation>, spec?: UpsertSpec): ObjList<Genai.Query.ResultToPassageRelation> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Genai.Query.ResultToPassageRelation>, spec?: CreateBatchObjStreamSpec): ObjList<Genai.Query.ResultToPassageRelation> | null;
     ...
     */
    update(srcObj?: Genai.Query.ResultToPassageRelation, spec?: UpsertSpec): Genai.Query.ResultToPassageRelation | null;
     ...
     */
    upsert(srcObj?: Genai.Query.ResultToPassageRelation, spec?: UpsertSpec): Genai.Query.ResultToPassageRelation | null;
     ...
     */
    merge(spec?: MergeSpec): Genai.Query.ResultToPassageRelation | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): Genai.Query.ResultToPassageRelation | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): Genai.Query.ResultToPassageRelation | null;
     ...
     */
    static updateBatch(objs: Array_Type<Genai.Query.ResultToPassageRelation>, srcObjs?: Array_Type<Genai.Query.ResultToPassageRelation>, spec?: UpsertSpec): ObjList<Genai.Query.ResultToPassageRelation> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<Genai.Query.ResultToPassageRelation> | null>, spec?: UpsertSpec): ObjList<Genai.Query.ResultToPassageRelation> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<Genai.Query.ResultToPassageRelation>, srcObjs?: Array_Type<Genai.Query.ResultToPassageRelation>, spec?: UpsertSpec): ObjList<Genai.Query.ResultToPassageRelation> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<Genai.Query.ResultToPassageRelation> | null>, spec?: UpsertSpec): ObjList<Genai.Query.ResultToPassageRelation> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<Genai.Query.ResultToPassageRelation>, spec?: TouchSpec): ObjList<Genai.Query.ResultToPassageRelation> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.Query.ResultToPassageRelation>, spec?: MergeSpec): ObjList<Genai.Query.ResultToPassageRelation> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.Query.ResultToPassageRelation>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.Query.ResultToPassageRelation> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<Genai.Query.ResultToPassageRelation> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.Query.ResultToPassageRelation> | null;
     ...
     */
    static mergeAll(mergeObj: Genai.Query.ResultToPassageRelation, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Genai.Query.ResultToPassageRelation, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<Genai.Query.ResultToPassageRelation>, spec?: UpsertSpec): ObjList<Genai.Query.ResultToPassageRelation> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<Genai.Query.ResultToPassageRelation>, spec?: UpsertSpec): ObjList<Genai.Query.ResultToPassageRelation> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): Genai.Query.ResultToPassageRelation | null;
     ...
     */
    static beforeCreate(objs: Array_Type<Genai.Query.ResultToPassageRelation>): ObjList<Genai.Query.ResultToPassageRelation>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<Genai.Query.ResultToPassageRelation>): ObjList<Genai.Query.ResultToPassageRelation>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<Genai.Query.ResultToPassageRelation>): ObjList<Genai.Query.ResultToPassageRelation>;
     ...
     */
    static afterCreate(objs: Array_Type<Genai.Query.ResultToPassageRelation>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<Genai.Query.ResultToPassageRelation>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<Genai.Query.ResultToPassageRelation>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<Genai.Query.ResultToPassageRelation>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Genai.Query.ResultToPassageRelation>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Genai.Query.ResultToPassageRelation | null;
     ...
     */
    withoutIdentity(): Genai.Query.ResultToPassageRelation | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<Genai.Query.ResultToPassageRelation>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: Genai.Query.ResultToPassageRelation, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<Genai.Query.ResultToPassageRelation>, callback?: λFunction<Genai.Query.ResultToPassageRelation | null, Genai.Query.ResultToPassageRelation | null>): ObjList<Genai.Query.ResultToPassageRelation>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<Genai.Query.ResultToPassageRelation>, callback?: λFunction<Genai.Query.ResultToPassageRelation | null, Genai.Query.ResultToPassageRelation | null>): Array_Type<ObjError> | null;
     ...
     */
    static cloneTo(srcResult: Genai.Query.Result, destResult: Genai.Query.Result): Array_Type<Genai.Query.ResultToPassageRelation>;
     ...
     */
    static cloneRelationsToParent(queryResult: Genai.Query.Result): Array_Type<Genai.Query.ResultToPassageRelation> | null;
     ...
     * @return the list of relations for parent
     */
    static relationsForParent(queryResult: Genai.Query.Result): Array_Type<Genai.Query.ResultToPassageRelation> | null;

    /**
     * Leave feedback for a {@link Genai.Query.ResultToPassageRelation}.
     */
    leaveFeedback(feedback: Genai.Query.Result.BaseFeedback): Genai.Query.Result.PassageFeedback;
  }
}
