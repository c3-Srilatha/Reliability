// TypeScript definitions for the C3 type Genai.App.ReadOnlyConfig
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.App.ReadOnlyConfig
 */
 ...
 */
declare namespace Genai.App {
  export class ReadOnlyConfig extends Obj  {

    readonly configOverride?: string;
    withConfigOverride(configOverride: string | null): Genai.App.ReadOnlyConfig;

    static readonly configOverride?: string;

    readonly secretOverride?: string;
    withSecretOverride(secretOverride: string | null): Genai.App.ReadOnlyConfig;
    ...
    withIssues(issues: Array_Type<string> | Array<string> | null): Genai.App.ReadOnlyConfig;
     ...
     * Whether the app should allow to copy credentials from an existing source system when creating a new one
     */
    readonly isCopyCredentialsAllowed?: boolean;
    withIsCopyCredentialsAllowed(isCopyCredentialsAllowed: boolean): Genai.App.ReadOnlyConfig;

    /**
     * Whether the app should allow to copy credentials from an existing source system when creating a new one
     */
    static readonly isCopyCredentialsAllowed?: boolean;

    /**
     * Whether the app should allow users to manage external source directory operations.
     */
    readonly disableSourceDirectoryControl?: boolean;
    withDisableSourceDirectoryControl(disableSourceDirectoryControl: boolean): Genai.App.ReadOnlyConfig;

    /**
     * Whether the app should allow users to manage external source directory operations.
     */
    static readonly disableSourceDirectoryControl?: boolean;

    /**
     * All streaming related configurations
     */
    readonly streamConfig?: Genai.Streaming.Config;
    withStreamConfig(streamConfig: IGenai.Streaming.Config | null): Genai.App.ReadOnlyConfig;

    /**
     * All streaming related configurations
     */
    static readonly streamConfig?: Genai.Streaming.Config;
     ...
     * {@link Genai.SourceFile#transitionFilesToStatus}.
     */
    readonly sourceFileBatchSize?: number;
    withSourceFileBatchSize(sourceFileBatchSize: number | null): Genai.App.ReadOnlyConfig;
     ...
     * {@link Genai.SourceFile#transitionFilesToStatus}.
     */
    static readonly sourceFileBatchSize?: number;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.App.ReadOnlyConfig | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.App.ReadOnlyConfig | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.App.ReadOnlyConfig | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.App.ReadOnlyConfig | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.App.ReadOnlyConfig;
     ...
     * This method is used during live metadata update
     */
    static replaceType(old: Type, new_: Type): Genai.App.ReadOnlyConfig;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.App.ReadOnlyConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.App.ReadOnlyConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.App.ReadOnlyConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.App.ReadOnlyConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.App.ReadOnlyConfig>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.App.ReadOnlyConfig>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.App.ReadOnlyConfig>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.App.ReadOnlyConfig>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.App.ReadOnlyConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.App.ReadOnlyConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.App.ReadOnlyConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.App.ReadOnlyConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.App.ReadOnlyConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.App.ReadOnlyConfig;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.App.ReadOnlyConfig;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    static validateObj(): Genai.App.ReadOnlyConfig;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.App.ReadOnlyConfig;
     ...
     * @see #defaultField
     */
    static withField(field: string, value: any, doNotConvert?: boolean): Genai.App.ReadOnlyConfig;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.App.ReadOnlyConfig;
     ...
     * @see #defaultField
     */
    static withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.App.ReadOnlyConfig;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.App.ReadOnlyConfig;
     ...
     * @return new Obj
     */
    static withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.App.ReadOnlyConfig;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.App.ReadOnlyConfig;
     ...
     * @return new Obj
     */
    static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.App.ReadOnlyConfig;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.App.ReadOnlyConfig;
     ...
     * @see #withoutField
     */
    static withoutFieldAtPath(path: string): Genai.App.ReadOnlyConfig;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.App.ReadOnlyConfig;
     ...
     * @see #removeField
     */
    static withoutField(field: string): Genai.App.ReadOnlyConfig;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.App.ReadOnlyConfig;
     ...
     * @see #removeField
     */
    static withoutField(field: FieldType): Genai.App.ReadOnlyConfig;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.App.ReadOnlyConfig;
     ...
     * @return new Obj with removed fields
     */
    static withoutFields(fields: Array_Type<string>): Genai.App.ReadOnlyConfig;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.App.ReadOnlyConfig;
     ...
     * @return new Obj with removed fields
     */
    static withoutFieldsByType(fields: Array_Type<FieldType>): Genai.App.ReadOnlyConfig;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.App.ReadOnlyConfig;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    static withoutSecretFields(): Genai.App.ReadOnlyConfig;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.App.ReadOnlyConfig;
     ...
     * @see FieldType#defaultValue
     */
    static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.App.ReadOnlyConfig;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.App.ReadOnlyConfig;
     ...
     * @see #unsetField
     */
    static defaultField(field: string): Genai.App.ReadOnlyConfig;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.App.ReadOnlyConfig;
     ...
     * @see #unsetField
     */
    static defaultField(field: FieldType): Genai.App.ReadOnlyConfig;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.App.ReadOnlyConfig;
     ...
     * @see #removeField
     */
    static unsetField(field: string): Genai.App.ReadOnlyConfig;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.App.ReadOnlyConfig;
     ...
     * @see #removeField
     */
    static unsetField(field: FieldType): Genai.App.ReadOnlyConfig;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.App.ReadOnlyConfig;
     ...
     * @see #unsetField
     */
    static removeField(field: string): Genai.App.ReadOnlyConfig;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.App.ReadOnlyConfig;
     ...
     * @see #unsetField
     */
    static removeField(field: FieldType): Genai.App.ReadOnlyConfig;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.App.ReadOnlyConfig;
     ...
     * @return the new merged Obj
     */
    static mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.App.ReadOnlyConfig;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.App.ReadOnlyConfig;
     ...
     * @return the new merged Obj
     */
    static mergeObj(other: Obj, otherFieldsFilter: Type): Genai.App.ReadOnlyConfig;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.App.ReadOnlyConfig;
     ...
     *        the same key or index.
     */
    static mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.App.ReadOnlyConfig;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.App.ReadOnlyConfig;
     ...
     * traverse child reference and collection fields.
     */
    static mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.App.ReadOnlyConfig;

    mergeJson(json: any): Genai.App.ReadOnlyConfig;

    static mergeJson(json: any): Genai.App.ReadOnlyConfig;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.App.ReadOnlyConfig;
     ...
     * @return Obj with child references merged
     */
    static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.App.ReadOnlyConfig;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.App.ReadOnlyConfig;
     ...
     * references with same name and collection elements at same index or key.
     */
    static sumObj(other: Obj, deep?: boolean): Genai.App.ReadOnlyConfig;
     ...
     */
    singletonArray(): Array_Type<Genai.App.ReadOnlyConfig>;
     ...
     * @return new array instance with this as only element.
     */
    static singletonArray(): Array_Type<Genai.App.ReadOnlyConfig>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.App.ReadOnlyConfig> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.App.ReadOnlyConfig> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.App.ReadOnlyConfig>;
     ...
     * @return new array instance with this as only element.
     */
    static singletonSet(): Set_Type<Genai.App.ReadOnlyConfig>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.App.ReadOnlyConfig> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.App.ReadOnlyConfig> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.App.ReadOnlyConfig> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.App.ReadOnlyConfig>;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    static toBuilder(): ObjBuilder<Genai.App.ReadOnlyConfig>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.App.ReadOnlyConfig>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.App.ReadOnlyConfig;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.App.ReadOnlyConfig;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.App.ReadOnlyConfig;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.App.ReadOnlyConfig;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.App.ReadOnlyConfig;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.App.ReadOnlyConfig;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.App.ReadOnlyConfig;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.App.ReadOnlyConfig;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    static afterMake(): Genai.App.ReadOnlyConfig;
     ...
     */
    static cachedEmptyInst(): Genai.App.ReadOnlyConfig;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.App.ReadOnlyConfig> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.App.ReadOnlyConfig;
     ...
     */
    static allCached(): Stream<Genai.App.ReadOnlyConfig> | null;
     ...
     */
    static find(filter?: string): Stream<Genai.App.ReadOnlyConfig> | null;
     ...
     *         Otherwise no population will be performed.
     */
    static findBy(field: string, value: any): Stream<Genai.App.ReadOnlyConfig> | null;

    /**
     * @return cached instance.
     */
    getCached(): Genai.App.ReadOnlyConfig | null;

    /**
     * @return cached instance.
     */
    static getCached(): Genai.App.ReadOnlyConfig | null;

    /**
     * Returns cached instance by key, with secrets removed.
     */
    static forCacheKey(key: string): Genai.App.ReadOnlyConfig | null;
     ...
     */
    static produce(key: string): Genai.App.ReadOnlyConfig | null;

    /**
     * Should produces the entire content for the cached data. Will populate the cache with the produced data.
     */
    static produceAll(): Map_Type<string, Genai.App.ReadOnlyConfig> | null;
     ...
     */
    getConfig(): Genai.App.ReadOnlyConfig;
     ...
     * Note that typical pattern is to use Configurable#config instead of this method.
     */
    static getConfig(): Genai.App.ReadOnlyConfig;
     ...
     */
    getSecret(): Genai.App.ReadOnlyConfig;
     ...
     * Note that typical pattern is to use Configurable#configWithSecrets instead of this method.
     */
    static getSecret(): Genai.App.ReadOnlyConfig;
     ...
     */
    withConfigKey(configKey: string): Genai.App.ReadOnlyConfig;
     ...
     *     config.configKey() => "folder1/abc"
     */
    static withConfigKey(configKey: string): Genai.App.ReadOnlyConfig;

    /**
     * @return copy without config key.
     */
    withoutConfigKey(): Genai.App.ReadOnlyConfig;

    /**
     * @return copy without config key.
     */
    static withoutConfigKey(): Genai.App.ReadOnlyConfig;

    /**
     * @return return cached config instance for provided config key.
     */
    static forConfigKey(configKey: string): Genai.App.ReadOnlyConfig | null;
     ...
     */
    static listConfigs(parallel?: boolean, filter?: λPredicate<string>): Stream<Genai.App.ReadOnlyConfig> | null;
     ...
     * @see setConfigValue
     */
    setConfigValues(from: Genai.App.ReadOnlyConfig, override?: string): void;
     ...
     * @see setConfigValue
     */
    static setConfigValues(from: Genai.App.ReadOnlyConfig, override?: string): void;
     ...
     */
    static loadConfigAndSecret(configKey: string): Genai.App.ReadOnlyConfig | null;
     ...
     */
    removeSecrets(): Genai.App.ReadOnlyConfig | null;

    /**
     * @return this config without any secret values.
     */
    static removeSecrets(): Genai.App.ReadOnlyConfig | null;

    /**
     * @return this config with only secret values.
     */
    removeNonSecrets(): Genai.App.ReadOnlyConfig | null;

    /**
     * @return this config with only secret values.
     */
    static removeNonSecrets(): Genai.App.ReadOnlyConfig | null;

    /**
     * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
     * validation and setup.
     */
    validate(): Genai.App.ReadOnlyConfig;

    /**
     * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
     * validation and setup.
     */
    static validate(): Genai.App.ReadOnlyConfig;
     ...
     */
    static inst(): Genai.App.ReadOnlyConfig;

    /**
     * Convenience function to access the values of the {@link Genai.App.ReadOnlyConfig}
     */
    static getReadOnlyConfig(): Genai.App.ReadOnlyConfig;
  }
}
