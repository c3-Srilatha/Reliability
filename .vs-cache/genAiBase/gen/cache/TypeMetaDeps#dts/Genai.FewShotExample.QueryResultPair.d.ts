// TypeScript definitions for the C3 type Genai.FewShotExample.QueryResultPair
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.FewShotExample.QueryResultPair
 */
declare namespace Genai.FewShotExample {
  export interface IQueryResultPair {
     ...
     */
    result: IGenai.Query.Result;

    /**
     * The result from the follow-up query to the #result.
     */
    followUpResult: IGenai.Query.Result;
  }
}
 ...
 */
declare namespace Genai.FewShotExample {
  export class QueryResultPair extends Obj  {
    ...
    withTypeIdent(typeIdent: string | null): Genai.FewShotExample.QueryResultPair;
     ...
     */
    readonly id: string;
    withId(id: string): Genai.FewShotExample.QueryResultPair;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Genai.FewShotExample.QueryResultPair;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): Genai.FewShotExample.QueryResultPair;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): Genai.FewShotExample.QueryResultPair;
    ...
    withVersion(version: number | null): Genai.FewShotExample.QueryResultPair;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): Genai.FewShotExample.QueryResultPair;

    /**
     * The query associated with the example.
     */
    readonly query: string;
    withQuery(query: string): Genai.FewShotExample.QueryResultPair;

    /**
     * An E5 embedding of the query.
     */
    readonly emb?: string;
    withEmb(emb: string | null): Genai.FewShotExample.QueryResultPair;

    /**
     * Flag indicating if this was added manually or by an automatic process.
     */
    readonly manuallyAdded?: boolean;
    withManuallyAdded(manuallyAdded: boolean): Genai.FewShotExample.QueryResultPair;
    ...
    withProject(project: IGenai.Project | null): Genai.FewShotExample.QueryResultPair;

    /**
     * The {@link User} who created the {@link Genai.FewShotExample}.
     */
    readonly createdBy?: User;
    withCreatedBy(createdBy: IUser | null): Genai.FewShotExample.QueryResultPair;

    /**
     * The query result associated with the example.
     */
    readonly result: Genai.Query.Result;
    withResult(result: IGenai.Query.Result): Genai.FewShotExample.QueryResultPair;

    /**
     * The result from the follow-up query to the #result.
     */
    readonly followUpResult: Genai.Query.Result;
    withFollowUpResult(followUpResult: IGenai.Query.Result): Genai.FewShotExample.QueryResultPair;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.FewShotExample.QueryResultPair | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.FewShotExample.QueryResultPair | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.FewShotExample.QueryResultPair | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.FewShotExample.QueryResultPair | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.FewShotExample.QueryResultPair;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.FewShotExample.QueryResultPair;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.FewShotExample.QueryResultPair;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.FewShotExample.QueryResultPair>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.FewShotExample.QueryResultPair>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.FewShotExample.QueryResultPair;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.FewShotExample.QueryResultPair;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.FewShotExample.QueryResultPair;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.FewShotExample.QueryResultPair;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.FewShotExample.QueryResultPair;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.FewShotExample.QueryResultPair;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.FewShotExample.QueryResultPair;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.FewShotExample.QueryResultPair;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.FewShotExample.QueryResultPair;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.FewShotExample.QueryResultPair;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.FewShotExample.QueryResultPair;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.FewShotExample.QueryResultPair;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.FewShotExample.QueryResultPair;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.FewShotExample.QueryResultPair;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.FewShotExample.QueryResultPair;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.FewShotExample.QueryResultPair;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.FewShotExample.QueryResultPair;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.FewShotExample.QueryResultPair;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.FewShotExample.QueryResultPair;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.FewShotExample.QueryResultPair;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.FewShotExample.QueryResultPair;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.FewShotExample.QueryResultPair;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.FewShotExample.QueryResultPair;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.FewShotExample.QueryResultPair;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.FewShotExample.QueryResultPair;

    mergeJson(json: any): Genai.FewShotExample.QueryResultPair;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.FewShotExample.QueryResultPair;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.FewShotExample.QueryResultPair;
     ...
     */
    singletonArray(): Array_Type<Genai.FewShotExample.QueryResultPair>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.FewShotExample.QueryResultPair> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.FewShotExample.QueryResultPair> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.FewShotExample.QueryResultPair>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.FewShotExample.QueryResultPair> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.FewShotExample.QueryResultPair> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.FewShotExample.QueryResultPair> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.FewShotExample.QueryResultPair>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.FewShotExample.QueryResultPair>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.FewShotExample.QueryResultPair;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.FewShotExample.QueryResultPair;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.FewShotExample.QueryResultPair;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.FewShotExample.QueryResultPair;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.FewShotExample.QueryResultPair;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.FewShotExample.QueryResultPair;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.FewShotExample.QueryResultPair | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.FewShotExample.QueryResultPair;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.FewShotExample.QueryResultPair;
     ...
     */
    static cachedEmptyInst(): Genai.FewShotExample.QueryResultPair;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.FewShotExample.QueryResultPair> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.FewShotExample.QueryResultPair;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<Genai.FewShotExample.QueryResultPair>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Genai.FewShotExample.QueryResultPair>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<Genai.FewShotExample.QueryResultPair> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Genai.FewShotExample.QueryResultPair>> | null;
     ...
     */
    get(include?: string): Genai.FewShotExample.QueryResultPair | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): Genai.FewShotExample.QueryResultPair | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Genai.FewShotExample.QueryResultPair;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): Genai.FewShotExample.QueryResultPair | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Genai.FewShotExample.QueryResultPair;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.FewShotExample.QueryResultPair | null;
     ...
     */
    create(spec?: UpsertSpec): Genai.FewShotExample.QueryResultPair | null;
     ...
     */
    static createBatch(objs: Array_Type<Genai.FewShotExample.QueryResultPair>, spec?: UpsertSpec): ObjList<Genai.FewShotExample.QueryResultPair> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Genai.FewShotExample.QueryResultPair>, spec?: CreateBatchObjStreamSpec): ObjList<Genai.FewShotExample.QueryResultPair> | null;
     ...
     */
    update(srcObj?: Genai.FewShotExample.QueryResultPair, spec?: UpsertSpec): Genai.FewShotExample.QueryResultPair | null;
     ...
     */
    upsert(srcObj?: Genai.FewShotExample.QueryResultPair, spec?: UpsertSpec): Genai.FewShotExample.QueryResultPair | null;
     ...
     */
    merge(spec?: MergeSpec): Genai.FewShotExample.QueryResultPair | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): Genai.FewShotExample.QueryResultPair | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): Genai.FewShotExample.QueryResultPair | null;
     ...
     */
    static updateBatch(objs: Array_Type<Genai.FewShotExample.QueryResultPair>, srcObjs?: Array_Type<Genai.FewShotExample.QueryResultPair>, spec?: UpsertSpec): ObjList<Genai.FewShotExample.QueryResultPair> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<Genai.FewShotExample.QueryResultPair> | null>, spec?: UpsertSpec): ObjList<Genai.FewShotExample.QueryResultPair> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<Genai.FewShotExample.QueryResultPair>, srcObjs?: Array_Type<Genai.FewShotExample.QueryResultPair>, spec?: UpsertSpec): ObjList<Genai.FewShotExample.QueryResultPair> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<Genai.FewShotExample.QueryResultPair> | null>, spec?: UpsertSpec): ObjList<Genai.FewShotExample.QueryResultPair> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<Genai.FewShotExample.QueryResultPair>, spec?: TouchSpec): ObjList<Genai.FewShotExample.QueryResultPair> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.FewShotExample.QueryResultPair>, spec?: MergeSpec): ObjList<Genai.FewShotExample.QueryResultPair> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.FewShotExample.QueryResultPair>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.FewShotExample.QueryResultPair> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<Genai.FewShotExample.QueryResultPair> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.FewShotExample.QueryResultPair> | null;
     ...
     */
    static mergeAll(mergeObj: Genai.FewShotExample.QueryResultPair, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Genai.FewShotExample.QueryResultPair, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<Genai.FewShotExample.QueryResultPair>, spec?: UpsertSpec): ObjList<Genai.FewShotExample.QueryResultPair> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<Genai.FewShotExample.QueryResultPair>, spec?: UpsertSpec): ObjList<Genai.FewShotExample.QueryResultPair> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): Genai.FewShotExample.QueryResultPair | null;
     ...
     */
    static beforeCreate(objs: Array_Type<Genai.FewShotExample.QueryResultPair>): ObjList<Genai.FewShotExample.QueryResultPair>;
     ...
     */
    static beforeUpdate(objs: Array_Type<Genai.FewShotExample.QueryResultPair>): ObjList<Genai.FewShotExample.QueryResultPair>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<Genai.FewShotExample.QueryResultPair>): ObjList<Genai.FewShotExample.QueryResultPair>;
     ...
     */
    static afterCreate(objs: Array_Type<Genai.FewShotExample.QueryResultPair>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<Genai.FewShotExample.QueryResultPair>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<Genai.FewShotExample.QueryResultPair>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<Genai.FewShotExample.QueryResultPair>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Genai.FewShotExample.QueryResultPair>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Genai.FewShotExample.QueryResultPair | null;
     ...
     */
    withoutIdentity(): Genai.FewShotExample.QueryResultPair | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<Genai.FewShotExample.QueryResultPair>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: Genai.FewShotExample.QueryResultPair, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<Genai.FewShotExample.QueryResultPair>, callback?: λFunction<Genai.FewShotExample.QueryResultPair | null, Genai.FewShotExample.QueryResultPair | null>): ObjList<Genai.FewShotExample.QueryResultPair>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<Genai.FewShotExample.QueryResultPair>, callback?: λFunction<Genai.FewShotExample.QueryResultPair | null, Genai.FewShotExample.QueryResultPair | null>): Array_Type<ObjError> | null;
     ...
     */
    static addEmbeddingsForQueries(objs: Array_Type<Genai.FewShotExample>, queries: Array_Type<string>): ObjList<Genai.FewShotExample.QueryResultPair>;
     ...
     */
    static addFewShot(result: Genai.Query.Result, followUpResult: Genai.Query.Result, project?: Genai.Project): Genai.FewShotExample.QueryResultPair;
  }
}
