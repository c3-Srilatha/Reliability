// TypeScript definitions for the C3 type Genai.SourceSystem.Azure

/**
 * Represents the root of an external Azure file system.
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.SourceSystem.Azure
 */
 ...
 */
declare namespace Genai.SourceSystem {
  export class Azure extends Obj  {
    ...
    withTypeIdent(typeIdent: string | null): Genai.SourceSystem.Azure;
     ...
     */
    readonly id: string;
    withId(id: string): Genai.SourceSystem.Azure;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Genai.SourceSystem.Azure;

    /**
     * Name of the source system
     */
    readonly name: string;
    withName(name: string): Genai.SourceSystem.Azure;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): Genai.SourceSystem.Azure;
    ...
    withVersion(version: number | null): Genai.SourceSystem.Azure;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): Genai.SourceSystem.Azure;

    /**
     * The type of the source system
     */
    readonly sourceType?: string;
    withSourceType(sourceType: string | null): Genai.SourceSystem.Azure;

    /**
     * The {@link Genai.SourceCollection}s created as a part of this source system
     */
    readonly collections?: Array_Type<Genai.SourceCollection>;
    withCollections(collections: Array_Type<Genai.SourceCollection> | Array<IGenai.SourceCollection> | null): Genai.SourceSystem.Azure;

    /**
     * Description of the source system
     */
    readonly description?: string;
    withDescription(description: string | null): Genai.SourceSystem.Azure;

    /**
     * The name of the mount in {@link FileSystem#mounts} for this source system
     */
    readonly mountName: string;
    withMountName(mountName: string): Genai.SourceSystem.Azure;

    /**
     * The name of the bucket for the source system
     */
    readonly bucketName: string;
    withBucketName(bucketName: string): Genai.SourceSystem.Azure;

    /**
     * The url for the mount
     */
    readonly rootUrl?: string;
    withRootUrl(rootUrl: string | null): Genai.SourceSystem.Azure;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.SourceSystem.Azure | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.SourceSystem.Azure | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.SourceSystem.Azure | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.SourceSystem.Azure | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.SourceSystem.Azure;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.SourceSystem.Azure;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.SourceSystem.Azure;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.SourceSystem.Azure>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.SourceSystem.Azure>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.SourceSystem.Azure;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.SourceSystem.Azure;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.SourceSystem.Azure;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.SourceSystem.Azure;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.SourceSystem.Azure;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.SourceSystem.Azure;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.SourceSystem.Azure;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.SourceSystem.Azure;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.SourceSystem.Azure;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.SourceSystem.Azure;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.SourceSystem.Azure;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.SourceSystem.Azure;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.SourceSystem.Azure;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.SourceSystem.Azure;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.SourceSystem.Azure;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.SourceSystem.Azure;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.SourceSystem.Azure;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.SourceSystem.Azure;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.SourceSystem.Azure;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.SourceSystem.Azure;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.SourceSystem.Azure;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.SourceSystem.Azure;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.SourceSystem.Azure;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.SourceSystem.Azure;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.SourceSystem.Azure;

    mergeJson(json: any): Genai.SourceSystem.Azure;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.SourceSystem.Azure;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.SourceSystem.Azure;
     ...
     */
    singletonArray(): Array_Type<Genai.SourceSystem.Azure>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.SourceSystem.Azure> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.SourceSystem.Azure> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.SourceSystem.Azure>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.SourceSystem.Azure> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.SourceSystem.Azure> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.SourceSystem.Azure> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.SourceSystem.Azure>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.SourceSystem.Azure>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.SourceSystem.Azure;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.SourceSystem.Azure;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.SourceSystem.Azure;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.SourceSystem.Azure;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.SourceSystem.Azure;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.SourceSystem.Azure;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.SourceSystem.Azure | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.SourceSystem.Azure;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.SourceSystem.Azure;
     ...
     */
    static cachedEmptyInst(): Genai.SourceSystem.Azure;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.SourceSystem.Azure> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.SourceSystem.Azure;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<Genai.SourceSystem.Azure>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Genai.SourceSystem.Azure>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<Genai.SourceSystem.Azure> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Genai.SourceSystem.Azure>> | null;
     ...
     */
    get(include?: string): Genai.SourceSystem.Azure | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): Genai.SourceSystem.Azure | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Genai.SourceSystem.Azure;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): Genai.SourceSystem.Azure | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Genai.SourceSystem.Azure;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.SourceSystem.Azure | null;
     ...
     */
    create(spec?: UpsertSpec): Genai.SourceSystem.Azure | null;
     ...
     */
    static createBatch(objs: Array_Type<Genai.SourceSystem.Azure>, spec?: UpsertSpec): ObjList<Genai.SourceSystem.Azure> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Genai.SourceSystem.Azure>, spec?: CreateBatchObjStreamSpec): ObjList<Genai.SourceSystem.Azure> | null;
     ...
     */
    update(srcObj?: Genai.SourceSystem.Azure, spec?: UpsertSpec): Genai.SourceSystem.Azure | null;
     ...
     */
    upsert(srcObj?: Genai.SourceSystem.Azure, spec?: UpsertSpec): Genai.SourceSystem.Azure | null;
     ...
     */
    merge(spec?: MergeSpec): Genai.SourceSystem.Azure | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): Genai.SourceSystem.Azure | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): Genai.SourceSystem.Azure | null;
     ...
     */
    static updateBatch(objs: Array_Type<Genai.SourceSystem.Azure>, srcObjs?: Array_Type<Genai.SourceSystem.Azure>, spec?: UpsertSpec): ObjList<Genai.SourceSystem.Azure> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<Genai.SourceSystem.Azure> | null>, spec?: UpsertSpec): ObjList<Genai.SourceSystem.Azure> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<Genai.SourceSystem.Azure>, srcObjs?: Array_Type<Genai.SourceSystem.Azure>, spec?: UpsertSpec): ObjList<Genai.SourceSystem.Azure> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<Genai.SourceSystem.Azure> | null>, spec?: UpsertSpec): ObjList<Genai.SourceSystem.Azure> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<Genai.SourceSystem.Azure>, spec?: TouchSpec): ObjList<Genai.SourceSystem.Azure> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.SourceSystem.Azure>, spec?: MergeSpec): ObjList<Genai.SourceSystem.Azure> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.SourceSystem.Azure>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.SourceSystem.Azure> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<Genai.SourceSystem.Azure> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.SourceSystem.Azure> | null;
     ...
     */
    static mergeAll(mergeObj: Genai.SourceSystem.Azure, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Genai.SourceSystem.Azure, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<Genai.SourceSystem.Azure>, spec?: UpsertSpec): ObjList<Genai.SourceSystem.Azure> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<Genai.SourceSystem.Azure>, spec?: UpsertSpec): ObjList<Genai.SourceSystem.Azure> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): Genai.SourceSystem.Azure | null;
     ...
     */
    static beforeCreate(objs: Array_Type<Genai.SourceSystem.Azure>): ObjList<Genai.SourceSystem.Azure>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<Genai.SourceSystem.Azure>): ObjList<Genai.SourceSystem.Azure>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<Genai.SourceSystem.Azure>): ObjList<Genai.SourceSystem.Azure>;
     ...
     */
    static afterCreate(objs: Array_Type<Genai.SourceSystem.Azure>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<Genai.SourceSystem.Azure>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<Genai.SourceSystem.Azure>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<Genai.SourceSystem.Azure>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Genai.SourceSystem.Azure>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Genai.SourceSystem.Azure | null;
     ...
     */
    withoutIdentity(): Genai.SourceSystem.Azure | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<Genai.SourceSystem.Azure>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: Genai.SourceSystem.Azure, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<Genai.SourceSystem.Azure>, callback?: λFunction<Genai.SourceSystem.Azure | null, Genai.SourceSystem.Azure | null>): ObjList<Genai.SourceSystem.Azure>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<Genai.SourceSystem.Azure>, callback?: λFunction<Genai.SourceSystem.Azure | null, Genai.SourceSystem.Azure | null>): Array_Type<ObjError> | null;
     ...
     */
    static createSourceSystem(spec: Genai.SourceSystem.Azure.CreateSpec, rootUrls: Array_Type<string>): Genai.SourceSystem.Azure;
