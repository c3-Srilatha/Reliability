// TypeScript definitions for the C3 type Genai.Mail.Config

/**
 * Email-related configurations for Gen AI
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.Mail.Config
 */
declare namespace Genai.Mail {
  export interface IConfig {
     ...
     */
    newUserInvitationEmailDomainWhitelist?: Array_Type<string> | Array<string>;
     ...
     */
    userAlertsEmailList?: Array_Type<string> | Array<string>;
...
declare namespace Genai.Mail {
  export class Config extends Obj  {
    ...
    withConfigOverride(configOverride: string | null): Genai.Mail.Config;

    static readonly configOverride?: string;

    readonly secretOverride?: string;
    withSecretOverride(secretOverride: string | null): Genai.Mail.Config;
    ...
    withIssues(issues: Array_Type<string> | Array<string> | null): Genai.Mail.Config;
     ...
     * Example: ["@c3.ai", "@c3iot.com"]
     */
    readonly newUserInvitationEmailDomainWhitelist?: Array_Type<string>;
    withNewUserInvitationEmailDomainWhitelist(newUserInvitationEmailDomainWhitelist: Array_Type<string> | Array<string> | null): Genai.Mail.Config;
     ...
     * Example: ["@c3.ai", "@c3iot.com"]
     */
    static readonly newUserInvitationEmailDomainWhitelist?: Array_Type<string>;
     ...
     * to be sent, {@link SendGrid} must also be configured. See {@link SendGridApi} for setting keys.
     */
    readonly sendWelcomeEmail: string;
    withSendWelcomeEmail(sendWelcomeEmail: string): Genai.Mail.Config;
     ...
     * to be sent, {@link SendGrid} must also be configured. See {@link SendGridApi} for setting keys.
     */
    static readonly sendWelcomeEmail: string;
     ...
     * Example: ["support@c3.ai"]
     */
    readonly userAlertsEmailList?: Array_Type<string>;
    withUserAlertsEmailList(userAlertsEmailList: Array_Type<string> | Array<string> | null): Genai.Mail.Config;
     ...
     * Example: ["support@c3.ai"]
     */
    static readonly userAlertsEmailList?: Array_Type<string>;
     ...
     * via the {@link Genai.Alert#alertLongRunningIndexAction}
     */
    readonly sendAlertsEmail?: boolean;
    withSendAlertsEmail(sendAlertsEmail: boolean): Genai.Mail.Config;
     ...
     * via the {@link Genai.Alert#alertLongRunningIndexAction}
     */
    static readonly sendAlertsEmail?: boolean;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.Mail.Config | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.Mail.Config | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.Mail.Config | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.Mail.Config | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.Mail.Config;
     ...
     * This method is used during live metadata update
     */
    static replaceType(old: Type, new_: Type): Genai.Mail.Config;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Mail.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Mail.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Mail.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Mail.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Mail.Config>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Mail.Config>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Mail.Config>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Mail.Config>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.Mail.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.Mail.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Mail.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Mail.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Mail.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Mail.Config;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.Mail.Config;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    static validateObj(): Genai.Mail.Config;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.Mail.Config;
     ...
     * @see #defaultField
     */
    static withField(field: string, value: any, doNotConvert?: boolean): Genai.Mail.Config;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.Mail.Config;
     ...
     * @see #defaultField
     */
    static withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.Mail.Config;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.Mail.Config;
     ...
     * @return new Obj
     */
    static withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.Mail.Config;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.Mail.Config;
     ...
     * @return new Obj
     */
    static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.Mail.Config;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.Mail.Config;
     ...
     * @see #withoutField
     */
    static withoutFieldAtPath(path: string): Genai.Mail.Config;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.Mail.Config;
     ...
     * @see #removeField
     */
    static withoutField(field: string): Genai.Mail.Config;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.Mail.Config;
     ...
     * @see #removeField
     */
    static withoutField(field: FieldType): Genai.Mail.Config;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.Mail.Config;
     ...
     * @return new Obj with removed fields
     */
    static withoutFields(fields: Array_Type<string>): Genai.Mail.Config;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.Mail.Config;
     ...
     * @return new Obj with removed fields
     */
    static withoutFieldsByType(fields: Array_Type<FieldType>): Genai.Mail.Config;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.Mail.Config;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    static withoutSecretFields(): Genai.Mail.Config;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.Mail.Config;
     ...
     * @see FieldType#defaultValue
     */
    static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.Mail.Config;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.Mail.Config;
     ...
     * @see #unsetField
     */
    static defaultField(field: string): Genai.Mail.Config;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.Mail.Config;
     ...
     * @see #unsetField
     */
    static defaultField(field: FieldType): Genai.Mail.Config;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.Mail.Config;
     ...
     * @see #removeField
     */
    static unsetField(field: string): Genai.Mail.Config;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.Mail.Config;
     ...
     * @see #removeField
     */
    static unsetField(field: FieldType): Genai.Mail.Config;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.Mail.Config;
     ...
     * @see #unsetField
     */
    static removeField(field: string): Genai.Mail.Config;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.Mail.Config;
     ...
     * @see #unsetField
     */
    static removeField(field: FieldType): Genai.Mail.Config;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.Mail.Config;
     ...
     * @return the new merged Obj
     */
    static mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.Mail.Config;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.Mail.Config;
     ...
     * @return the new merged Obj
     */
    static mergeObj(other: Obj, otherFieldsFilter: Type): Genai.Mail.Config;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.Mail.Config;
     ...
     *        the same key or index.
     */
    static mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.Mail.Config;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.Mail.Config;
     ...
     * traverse child reference and collection fields.
     */
    static mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.Mail.Config;

    mergeJson(json: any): Genai.Mail.Config;

    static mergeJson(json: any): Genai.Mail.Config;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.Mail.Config;
     ...
     * @return Obj with child references merged
     */
    static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.Mail.Config;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.Mail.Config;
     ...
     * references with same name and collection elements at same index or key.
     */
    static sumObj(other: Obj, deep?: boolean): Genai.Mail.Config;
     ...
     */
    singletonArray(): Array_Type<Genai.Mail.Config>;
     ...
     * @return new array instance with this as only element.
     */
    static singletonArray(): Array_Type<Genai.Mail.Config>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.Mail.Config> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.Mail.Config> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.Mail.Config>;
     ...
     * @return new array instance with this as only element.
     */
    static singletonSet(): Set_Type<Genai.Mail.Config>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.Mail.Config> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.Mail.Config> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.Mail.Config> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.Mail.Config>;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    static toBuilder(): ObjBuilder<Genai.Mail.Config>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.Mail.Config>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.Mail.Config;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.Mail.Config;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.Mail.Config;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.Mail.Config;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.Mail.Config;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.Mail.Config;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.Mail.Config;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    static afterMake(): Genai.Mail.Config;
     ...
     */
    static cachedEmptyInst(): Genai.Mail.Config;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.Mail.Config> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.Mail.Config;
     ...
     */
    static allCached(): Stream<Genai.Mail.Config> | null;
     ...
     */
    static find(filter?: string): Stream<Genai.Mail.Config> | null;
     ...
     *         Otherwise no population will be performed.
     */
    static findBy(field: string, value: any): Stream<Genai.Mail.Config> | null;

    /**
     * @return cached instance.
     */
    getCached(): Genai.Mail.Config | null;

    /**
     * @return cached instance.
     */
    static getCached(): Genai.Mail.Config | null;

    /**
     * Returns cached instance by key, with secrets removed.
     */
    static forCacheKey(key: string): Genai.Mail.Config | null;
     ...
     */
    static produce(key: string): Genai.Mail.Config | null;

    /**
     * Should produces the entire content for the cached data. Will populate the cache with the produced data.
     */
    static produceAll(): Map_Type<string, Genai.Mail.Config> | null;
     ...
     * Note that typical pattern is to use Configurable#config instead of this method.
     */
    static getConfig(): Genai.Mail.Config;
     ...
     * Note that typical pattern is to use Configurable#configWithSecrets instead of this method.
     */
    static getSecret(): Genai.Mail.Config;
     ...
     */
    withConfigKey(configKey: string): Genai.Mail.Config;
     ...
     *     config.configKey() => "folder1/abc"
     */
    static withConfigKey(configKey: string): Genai.Mail.Config;

    /**
     * @return copy without config key.
     */
    withoutConfigKey(): Genai.Mail.Config;

    /**
     * @return copy without config key.
     */
    static withoutConfigKey(): Genai.Mail.Config;

    /**
     * @return return cached config instance for provided config key.
     */
    static forConfigKey(configKey: string): Genai.Mail.Config | null;
     ...
     */
    static listConfigs(parallel?: boolean, filter?: λPredicate<string>): Stream<Genai.Mail.Config> | null;
     ...
     * @see setConfigValue
     */
    setConfigValues(from: Genai.Mail.Config, override?: string): void;
     ...
     * @see setConfigValue
     */
    static setConfigValues(from: Genai.Mail.Config, override?: string): void;
     ...
     */
    static loadConfigAndSecret(configKey: string): Genai.Mail.Config | null;
     ...
     */
    removeSecrets(): Genai.Mail.Config | null;

    /**
     * @return this config without any secret values.
     */
    static removeSecrets(): Genai.Mail.Config | null;

    /**
     * @return this config with only secret values.
     */
    removeNonSecrets(): Genai.Mail.Config | null;

    /**
     * @return this config with only secret values.
     */
    static removeNonSecrets(): Genai.Mail.Config | null;

    /**
     * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
     * validation and setup.
     */
    validate(): Genai.Mail.Config;

    /**
     * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
     * validation and setup.
     */
    static validate(): Genai.Mail.Config;
