// TypeScript definitions for the C3 type Genai.WindTurbineMeasurement

/**
 * Measurements of gear oil temperature, generator rotation speed, and active power at a point in time for a given wind turbine
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.WindTurbineMeasurement
 */
declare namespace Genai {
  export interface IWindTurbineMeasurement {
    ...
    parent: IGenai.WindTurbineMeasurementSeries;
    ...
    /**
     * The measured gear oil temperature in degrees celsius.
     */
    gearOilTemperature?: number;

    /**
     * The measured generator rotation speed in revolutions per minute.
     */
    generatorRotationSpeed?: number;

    /**
     * The measured active power in megawatts.
     */
    activePower?: number;
  }
}
 ...
 * Measurements of gear oil temperature, generator rotation speed, and active power at a point in time for a given wind turbine
 *
 * @remarks this represents a made instance of Genai.WindTurbineMeasurement
 */
declare namespace Genai {
  export class WindTurbineMeasurement extends Obj  {

    /**
     * start date for the data point
     */
    readonly start: DateTime;
    withStart(start: DateTime | Date | string): Genai.WindTurbineMeasurement;
    ...
    withOutlierCode(outlierCode: number | null): Genai.WindTurbineMeasurement;

    /**
     * (Optional) any comments for the data point
     */
    readonly comments?: string;
    withComments(comments: string | null): Genai.WindTurbineMeasurement;

    /**
     * Denotes if the value is an actual value or an estimated value. default = null (actual value)
     */
    readonly isEstimated?: boolean;
    withIsEstimated(isEstimated: boolean): Genai.WindTurbineMeasurement;
    ...
    withDataVersion(dataVersion: number | null): Genai.WindTurbineMeasurement;

    /**
     * Customer specific status code for the data point (may be used to denote data quality)
     */
    readonly statusCode?: string;
    withStatusCode(statusCode: string | null): Genai.WindTurbineMeasurement;

    /**
     * Partition key Bin separator used to separate partition key from bin id
     */
    readonly PK_BIN_SEPARATOR?: string;
    withPK_BIN_SEPARATOR(PK_BIN_SEPARATOR: string | null): Genai.WindTurbineMeasurement;

    readonly parent: Genai.WindTurbineMeasurementSeries;
    withParent(parent: IGenai.WindTurbineMeasurementSeries): Genai.WindTurbineMeasurement;
     ...
     */
    readonly id: string;
    withId(id: string): Genai.WindTurbineMeasurement;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Genai.WindTurbineMeasurement;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): Genai.WindTurbineMeasurement;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): Genai.WindTurbineMeasurement;
    ...
    withVersion(version: number | null): Genai.WindTurbineMeasurement;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): Genai.WindTurbineMeasurement;

    /**
     * The measured gear oil temperature in degrees celsius.
     */
    readonly gearOilTemperature?: number;
    withGearOilTemperature(gearOilTemperature: number | null): Genai.WindTurbineMeasurement;

    /**
     * The measured generator rotation speed in revolutions per minute.
     */
    readonly generatorRotationSpeed?: number;
    withGeneratorRotationSpeed(generatorRotationSpeed: number | null): Genai.WindTurbineMeasurement;

    /**
     * The measured active power in megawatts.
     */
    readonly activePower?: number;
    withActivePower(activePower: number | null): Genai.WindTurbineMeasurement;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.WindTurbineMeasurement | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.WindTurbineMeasurement | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.WindTurbineMeasurement | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.WindTurbineMeasurement | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.WindTurbineMeasurement;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.WindTurbineMeasurement;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.WindTurbineMeasurement;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.WindTurbineMeasurement>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.WindTurbineMeasurement>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.WindTurbineMeasurement;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.WindTurbineMeasurement;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.WindTurbineMeasurement;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.WindTurbineMeasurement;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.WindTurbineMeasurement;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.WindTurbineMeasurement;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.WindTurbineMeasurement;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.WindTurbineMeasurement;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.WindTurbineMeasurement;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.WindTurbineMeasurement;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.WindTurbineMeasurement;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.WindTurbineMeasurement;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.WindTurbineMeasurement;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.WindTurbineMeasurement;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.WindTurbineMeasurement;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.WindTurbineMeasurement;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.WindTurbineMeasurement;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.WindTurbineMeasurement;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.WindTurbineMeasurement;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.WindTurbineMeasurement;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.WindTurbineMeasurement;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.WindTurbineMeasurement;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.WindTurbineMeasurement;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.WindTurbineMeasurement;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.WindTurbineMeasurement;

    mergeJson(json: any): Genai.WindTurbineMeasurement;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.WindTurbineMeasurement;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.WindTurbineMeasurement;
     ...
     */
    singletonArray(): Array_Type<Genai.WindTurbineMeasurement>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.WindTurbineMeasurement> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.WindTurbineMeasurement> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.WindTurbineMeasurement>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.WindTurbineMeasurement> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.WindTurbineMeasurement> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.WindTurbineMeasurement> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.WindTurbineMeasurement>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.WindTurbineMeasurement>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.WindTurbineMeasurement;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.WindTurbineMeasurement;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.WindTurbineMeasurement;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.WindTurbineMeasurement;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.WindTurbineMeasurement;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.WindTurbineMeasurement;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.WindTurbineMeasurement | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.WindTurbineMeasurement;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.WindTurbineMeasurement;
     ...
     */
    static cachedEmptyInst(): Genai.WindTurbineMeasurement;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.WindTurbineMeasurement> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.WindTurbineMeasurement;

    /**
     * Extract the partition key from the given obj
     */
    partitionKey(failIfMissing?: boolean): Genai.WindTurbineMeasurementSeries | null;
     ...
     */
    static partition(objs?: Stream<Genai.WindTurbineMeasurement>, spec?: PartitionBucketStrategy): Map_Type<string, KvDataPartition> | null;
     ...
     */
    static fromPartitions(partitions?: Stream<KvDataPartition>): Stream<Genai.WindTurbineMeasurement> | null;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<Genai.WindTurbineMeasurement>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Genai.WindTurbineMeasurement>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<Genai.WindTurbineMeasurement> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Genai.WindTurbineMeasurement>> | null;
     ...
     */
    get(include?: string): Genai.WindTurbineMeasurement | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): Genai.WindTurbineMeasurement | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Genai.WindTurbineMeasurement;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): Genai.WindTurbineMeasurement | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Genai.WindTurbineMeasurement;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.WindTurbineMeasurement | null;
     ...
     */
    create(spec?: UpsertSpec): Genai.WindTurbineMeasurement | null;
     ...
     */
    static createBatch(objs: Array_Type<Genai.WindTurbineMeasurement>, spec?: UpsertSpec): ObjList<Genai.WindTurbineMeasurement> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Genai.WindTurbineMeasurement>, spec?: CreateBatchObjStreamSpec): ObjList<Genai.WindTurbineMeasurement> | null;
     ...
     */
    update(srcObj?: Genai.WindTurbineMeasurement, spec?: UpsertSpec): Genai.WindTurbineMeasurement | null;
     ...
     */
    upsert(srcObj?: Genai.WindTurbineMeasurement, spec?: UpsertSpec): Genai.WindTurbineMeasurement | null;
     ...
     */
    merge(spec?: MergeSpec): Genai.WindTurbineMeasurement | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): Genai.WindTurbineMeasurement | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): Genai.WindTurbineMeasurement | null;
     ...
     */
    static updateBatch(objs: Array_Type<Genai.WindTurbineMeasurement>, srcObjs?: Array_Type<Genai.WindTurbineMeasurement>, spec?: UpsertSpec): ObjList<Genai.WindTurbineMeasurement> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<Genai.WindTurbineMeasurement> | null>, spec?: UpsertSpec): ObjList<Genai.WindTurbineMeasurement> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<Genai.WindTurbineMeasurement>, srcObjs?: Array_Type<Genai.WindTurbineMeasurement>, spec?: UpsertSpec): ObjList<Genai.WindTurbineMeasurement> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<Genai.WindTurbineMeasurement> | null>, spec?: UpsertSpec): ObjList<Genai.WindTurbineMeasurement> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<Genai.WindTurbineMeasurement>, spec?: TouchSpec): ObjList<Genai.WindTurbineMeasurement> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.WindTurbineMeasurement>, spec?: MergeSpec): ObjList<Genai.WindTurbineMeasurement> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.WindTurbineMeasurement>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.WindTurbineMeasurement> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<Genai.WindTurbineMeasurement> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.WindTurbineMeasurement> | null;
     ...
     */
    static mergeAll(mergeObj: Genai.WindTurbineMeasurement, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Genai.WindTurbineMeasurement, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<Genai.WindTurbineMeasurement>, spec?: UpsertSpec): ObjList<Genai.WindTurbineMeasurement> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<Genai.WindTurbineMeasurement>, spec?: UpsertSpec): ObjList<Genai.WindTurbineMeasurement> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): Genai.WindTurbineMeasurement | null;
     ...
     */
    static beforeCreate(objs: Array_Type<Genai.WindTurbineMeasurement>): ObjList<Genai.WindTurbineMeasurement>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<Genai.WindTurbineMeasurement>): ObjList<Genai.WindTurbineMeasurement>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<Genai.WindTurbineMeasurement>): ObjList<Genai.WindTurbineMeasurement>;
     ...
     */
    static afterCreate(objs: Array_Type<Genai.WindTurbineMeasurement>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<Genai.WindTurbineMeasurement>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<Genai.WindTurbineMeasurement>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<Genai.WindTurbineMeasurement>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Genai.WindTurbineMeasurement>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Genai.WindTurbineMeasurement | null;
     ...
     */
    withoutIdentity(): Genai.WindTurbineMeasurement | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<Genai.WindTurbineMeasurement>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: Genai.WindTurbineMeasurement, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<Genai.WindTurbineMeasurement>, callback?: λFunction<Genai.WindTurbineMeasurement | null, Genai.WindTurbineMeasurement | null>): ObjList<Genai.WindTurbineMeasurement>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<Genai.WindTurbineMeasurement>, callback?: λFunction<Genai.WindTurbineMeasurement | null, Genai.WindTurbineMeasurement | null>): Array_Type<ObjError> | null;
