// TypeScript definitions for the C3 type Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD

/**
 * An entity test type for {@link Genai.SourceFile.Chunker.TypeMetaChunker}
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD
 */
declare namespace Genai.SourceFile.Chunker.TypeMetaChunker {
  export interface ITestTypeD {
 ...
 */
declare namespace Genai.SourceFile.Chunker.TypeMetaChunker {
  export class TestTypeD extends Obj  {

    /**
     * inherited field on entity type
     */
    readonly abstractField?: string;
    withAbstractField(abstractField: string | null): Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD;
     ...
     */
    readonly id: string;
    withId(id: string): Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD;
    ...
    withVersion(version: number | null): Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD;

    /**
     * member field on entity type
     */
    readonly memberField?: string;
    withMemberField(memberField: string | null): Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD;

    mergeJson(json: any): Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD;
     ...
     */
    singletonArray(): Array_Type<Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD;
     ...
     */
    static cachedEmptyInst(): Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD;

    /**
     * function on an abstract type
     */
    abstractFunction(param?: boolean): void;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD>> | null;
     ...
     */
    get(include?: string): Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD | null;
     ...
     */
    create(spec?: UpsertSpec): Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD | null;
     ...
     */
    static createBatch(objs: Array_Type<Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD>, spec?: UpsertSpec): ObjList<Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD>, spec?: CreateBatchObjStreamSpec): ObjList<Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD> | null;
     ...
     */
    update(srcObj?: Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD, spec?: UpsertSpec): Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD | null;
     ...
     */
    upsert(srcObj?: Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD, spec?: UpsertSpec): Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD | null;
     ...
     */
    merge(spec?: MergeSpec): Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD | null;
     ...
     */
    static updateBatch(objs: Array_Type<Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD>, srcObjs?: Array_Type<Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD>, spec?: UpsertSpec): ObjList<Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD> | null>, spec?: UpsertSpec): ObjList<Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD>, srcObjs?: Array_Type<Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD>, spec?: UpsertSpec): ObjList<Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD> | null>, spec?: UpsertSpec): ObjList<Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD>, spec?: TouchSpec): ObjList<Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD>, spec?: MergeSpec): ObjList<Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD> | null;
     ...
     */
    static mergeAll(mergeObj: Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD>, spec?: UpsertSpec): ObjList<Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD>, spec?: UpsertSpec): ObjList<Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD | null;
     ...
     */
    static beforeCreate(objs: Array_Type<Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD>): ObjList<Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD>): ObjList<Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD>): ObjList<Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD>;
     ...
     */
    static afterCreate(objs: Array_Type<Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD | null;
     ...
     */
    withoutIdentity(): Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD>, callback?: λFunction<Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD | null, Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD | null>): ObjList<Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD>, callback?: λFunction<Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD | null, Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeD | null>): Array_Type<ObjError> | null;
     ...
     */
    static memberFunction(paramA?: string, paramB: number, spec?: Genai.SourceFile.Chunker.TypeMetaChunker.TestTypeE): boolean;
  }
}
