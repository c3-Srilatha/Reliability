// TypeScript definitions for the C3 type Genai.Llm.Guide.DefaultConfig

/**
 * Configuration to specify which {@link Genai.Llm.Guide.Config} should be used by the application.
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.Llm.Guide.DefaultConfig
 */
declare namespace Genai.Llm.Guide {
...
declare namespace Genai.Llm.Guide {
  export class DefaultConfig extends Obj  {
    ...
    withConfigOverride(configOverride: string | null): Genai.Llm.Guide.DefaultConfig;

    static readonly configOverride?: string;

    readonly secretOverride?: string;
    withSecretOverride(secretOverride: string | null): Genai.Llm.Guide.DefaultConfig;
    ...
    withIssues(issues: Array_Type<string> | Array<string> | null): Genai.Llm.Guide.DefaultConfig;
     ...
     * Name of {@link Genai.Llm.Guide.Config} that should be used by default.
     */
    readonly guideConfigName: string;
    withGuideConfigName(guideConfigName: string): Genai.Llm.Guide.DefaultConfig;

    /**
     * Name of {@link Genai.Llm.Guide.Config} that should be used by default.
     */
    static readonly guideConfigName: string;

    /**
     * @return the one and only instance to be used when member functions are called on this type.
     */
    static inst(): Genai.Llm.Guide.DefaultConfig;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.Llm.Guide.DefaultConfig | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.Llm.Guide.DefaultConfig | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.Llm.Guide.DefaultConfig | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.Llm.Guide.DefaultConfig | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.Llm.Guide.DefaultConfig;
     ...
     * This method is used during live metadata update
     */
    static replaceType(old: Type, new_: Type): Genai.Llm.Guide.DefaultConfig;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Llm.Guide.DefaultConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Llm.Guide.DefaultConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Llm.Guide.DefaultConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Llm.Guide.DefaultConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Llm.Guide.DefaultConfig>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Llm.Guide.DefaultConfig>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Llm.Guide.DefaultConfig>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Llm.Guide.DefaultConfig>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.Llm.Guide.DefaultConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.Llm.Guide.DefaultConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Llm.Guide.DefaultConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Llm.Guide.DefaultConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Llm.Guide.DefaultConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Llm.Guide.DefaultConfig;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.Llm.Guide.DefaultConfig;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    static validateObj(): Genai.Llm.Guide.DefaultConfig;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.Llm.Guide.DefaultConfig;
     ...
     * @see #defaultField
     */
    static withField(field: string, value: any, doNotConvert?: boolean): Genai.Llm.Guide.DefaultConfig;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.Llm.Guide.DefaultConfig;
     ...
     * @see #defaultField
     */
    static withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.Llm.Guide.DefaultConfig;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.Llm.Guide.DefaultConfig;
     ...
     * @return new Obj
     */
    static withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.Llm.Guide.DefaultConfig;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.Llm.Guide.DefaultConfig;
     ...
     * @return new Obj
     */
    static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.Llm.Guide.DefaultConfig;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.Llm.Guide.DefaultConfig;
     ...
     * @see #withoutField
     */
    static withoutFieldAtPath(path: string): Genai.Llm.Guide.DefaultConfig;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.Llm.Guide.DefaultConfig;
     ...
     * @see #removeField
     */
    static withoutField(field: string): Genai.Llm.Guide.DefaultConfig;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.Llm.Guide.DefaultConfig;
     ...
     * @see #removeField
     */
    static withoutField(field: FieldType): Genai.Llm.Guide.DefaultConfig;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.Llm.Guide.DefaultConfig;
     ...
     * @return new Obj with removed fields
     */
    static withoutFields(fields: Array_Type<string>): Genai.Llm.Guide.DefaultConfig;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.Llm.Guide.DefaultConfig;
     ...
     * @return new Obj with removed fields
     */
    static withoutFieldsByType(fields: Array_Type<FieldType>): Genai.Llm.Guide.DefaultConfig;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.Llm.Guide.DefaultConfig;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    static withoutSecretFields(): Genai.Llm.Guide.DefaultConfig;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.Llm.Guide.DefaultConfig;
     ...
     * @see FieldType#defaultValue
     */
    static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.Llm.Guide.DefaultConfig;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.Llm.Guide.DefaultConfig;
     ...
     * @see #unsetField
     */
    static defaultField(field: string): Genai.Llm.Guide.DefaultConfig;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.Llm.Guide.DefaultConfig;
     ...
     * @see #unsetField
     */
    static defaultField(field: FieldType): Genai.Llm.Guide.DefaultConfig;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.Llm.Guide.DefaultConfig;
     ...
     * @see #removeField
     */
    static unsetField(field: string): Genai.Llm.Guide.DefaultConfig;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.Llm.Guide.DefaultConfig;
     ...
     * @see #removeField
     */
    static unsetField(field: FieldType): Genai.Llm.Guide.DefaultConfig;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.Llm.Guide.DefaultConfig;
     ...
     * @see #unsetField
     */
    static removeField(field: string): Genai.Llm.Guide.DefaultConfig;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.Llm.Guide.DefaultConfig;
     ...
     * @see #unsetField
     */
    static removeField(field: FieldType): Genai.Llm.Guide.DefaultConfig;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.Llm.Guide.DefaultConfig;
     ...
     * @return the new merged Obj
     */
    static mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.Llm.Guide.DefaultConfig;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.Llm.Guide.DefaultConfig;
     ...
     * @return the new merged Obj
     */
    static mergeObj(other: Obj, otherFieldsFilter: Type): Genai.Llm.Guide.DefaultConfig;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.Llm.Guide.DefaultConfig;
     ...
     *        the same key or index.
     */
    static mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.Llm.Guide.DefaultConfig;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.Llm.Guide.DefaultConfig;
     ...
     * traverse child reference and collection fields.
     */
    static mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.Llm.Guide.DefaultConfig;

    mergeJson(json: any): Genai.Llm.Guide.DefaultConfig;

    static mergeJson(json: any): Genai.Llm.Guide.DefaultConfig;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.Llm.Guide.DefaultConfig;
     ...
     * @return Obj with child references merged
     */
    static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.Llm.Guide.DefaultConfig;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.Llm.Guide.DefaultConfig;
     ...
     * references with same name and collection elements at same index or key.
     */
    static sumObj(other: Obj, deep?: boolean): Genai.Llm.Guide.DefaultConfig;
     ...
     */
    singletonArray(): Array_Type<Genai.Llm.Guide.DefaultConfig>;
     ...
     * @return new array instance with this as only element.
     */
    static singletonArray(): Array_Type<Genai.Llm.Guide.DefaultConfig>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.Llm.Guide.DefaultConfig> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.Llm.Guide.DefaultConfig> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.Llm.Guide.DefaultConfig>;
     ...
     * @return new array instance with this as only element.
     */
    static singletonSet(): Set_Type<Genai.Llm.Guide.DefaultConfig>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.Llm.Guide.DefaultConfig> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.Llm.Guide.DefaultConfig> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.Llm.Guide.DefaultConfig> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.Llm.Guide.DefaultConfig>;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    static toBuilder(): ObjBuilder<Genai.Llm.Guide.DefaultConfig>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.Llm.Guide.DefaultConfig>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.Llm.Guide.DefaultConfig;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.Llm.Guide.DefaultConfig;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.Llm.Guide.DefaultConfig;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.Llm.Guide.DefaultConfig;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.Llm.Guide.DefaultConfig;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.Llm.Guide.DefaultConfig;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.Llm.Guide.DefaultConfig;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.Llm.Guide.DefaultConfig;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    static afterMake(): Genai.Llm.Guide.DefaultConfig;
     ...
     */
    static cachedEmptyInst(): Genai.Llm.Guide.DefaultConfig;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.Llm.Guide.DefaultConfig> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.Llm.Guide.DefaultConfig;
     ...
     */
    static allCached(): Stream<Genai.Llm.Guide.DefaultConfig> | null;
     ...
     */
    static find(filter?: string): Stream<Genai.Llm.Guide.DefaultConfig> | null;
     ...
     *         Otherwise no population will be performed.
     */
    static findBy(field: string, value: any): Stream<Genai.Llm.Guide.DefaultConfig> | null;

    /**
     * @return cached instance.
     */
    getCached(): Genai.Llm.Guide.DefaultConfig | null;

    /**
     * @return cached instance.
     */
    static getCached(): Genai.Llm.Guide.DefaultConfig | null;

    /**
     * Returns cached instance by key, with secrets removed.
     */
    static forCacheKey(key: string): Genai.Llm.Guide.DefaultConfig | null;
     ...
     */
    static produce(key: string): Genai.Llm.Guide.DefaultConfig | null;

    /**
     * Should produces the entire content for the cached data. Will populate the cache with the produced data.
     */
    static produceAll(): Map_Type<string, Genai.Llm.Guide.DefaultConfig> | null;
     ...
     */
    getConfig(): Genai.Llm.Guide.DefaultConfig;
     ...
     * Note that typical pattern is to use Configurable#config instead of this method.
     */
    static getConfig(): Genai.Llm.Guide.DefaultConfig;
     ...
     */
    getSecret(): Genai.Llm.Guide.DefaultConfig;
     ...
     * Note that typical pattern is to use Configurable#configWithSecrets instead of this method.
     */
    static getSecret(): Genai.Llm.Guide.DefaultConfig;
     ...
     */
    withConfigKey(configKey: string): Genai.Llm.Guide.DefaultConfig;
     ...
     *     config.configKey() => "folder1/abc"
     */
    static withConfigKey(configKey: string): Genai.Llm.Guide.DefaultConfig;

    /**
     * @return copy without config key.
     */
    withoutConfigKey(): Genai.Llm.Guide.DefaultConfig;

    /**
     * @return copy without config key.
     */
    static withoutConfigKey(): Genai.Llm.Guide.DefaultConfig;

    /**
     * @return return cached config instance for provided config key.
     */
    static forConfigKey(configKey: string): Genai.Llm.Guide.DefaultConfig | null;
     ...
     */
    static listConfigs(parallel?: boolean, filter?: λPredicate<string>): Stream<Genai.Llm.Guide.DefaultConfig> | null;
     ...
     * @see setConfigValue
     */
    setConfigValues(from: Genai.Llm.Guide.DefaultConfig, override?: string): void;
     ...
     * @see setConfigValue
     */
    static setConfigValues(from: Genai.Llm.Guide.DefaultConfig, override?: string): void;
     ...
     */
    static loadConfigAndSecret(configKey: string): Genai.Llm.Guide.DefaultConfig | null;
     ...
     */
    removeSecrets(): Genai.Llm.Guide.DefaultConfig | null;

    /**
     * @return this config without any secret values.
     */
    static removeSecrets(): Genai.Llm.Guide.DefaultConfig | null;

    /**
     * @return this config with only secret values.
     */
    removeNonSecrets(): Genai.Llm.Guide.DefaultConfig | null;

    /**
     * @return this config with only secret values.
     */
    static removeNonSecrets(): Genai.Llm.Guide.DefaultConfig | null;

    /**
     * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
     * validation and setup.
     */
    validate(): Genai.Llm.Guide.DefaultConfig;

    /**
     * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
     * validation and setup.
     */
    static validate(): Genai.Llm.Guide.DefaultConfig;
