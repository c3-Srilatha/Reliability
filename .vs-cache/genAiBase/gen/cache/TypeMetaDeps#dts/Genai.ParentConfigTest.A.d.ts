// TypeScript definitions for the C3 type Genai.ParentConfigTest.A

/**
 * Test type
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.ParentConfigTest.A
 */
declare namespace Genai.ParentConfigTest {
  export interface IA {
 ...
 */
declare namespace Genai.ParentConfigTest {
  export class A extends Obj  {

    readonly configOverride?: string;
    withConfigOverride(configOverride: string | null): Genai.ParentConfigTest.A;

    readonly secretOverride?: string;
    withSecretOverride(secretOverride: string | null): Genai.ParentConfigTest.A;

    /**
     * Captures any issues that occurred while deserializing from filesystem
     */
    readonly issues?: Array_Type<string>;
    withIssues(issues: Array_Type<string> | Array<string> | null): Genai.ParentConfigTest.A;

    /**
     * The unique and required name of this instance.
     */
    readonly name: string;
    withName(name: string): Genai.ParentConfigTest.A;

    /**
     * Test string
     */
    readonly str?: string;
    withStr(str: string | null): Genai.ParentConfigTest.A;

    /**
     * name of b config
     */
    readonly bConfigName?: string;
    withBConfigName(bConfigName: string | null): Genai.ParentConfigTest.A;

    /**
     * id of bc config
     */
    readonly cConfigId?: string;
    withCConfigId(cConfigId: string | null): Genai.ParentConfigTest.A;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.ParentConfigTest.A | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.ParentConfigTest.A | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.ParentConfigTest.A | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.ParentConfigTest.A | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.ParentConfigTest.A;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.ParentConfigTest.A;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.ParentConfigTest.A;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.ParentConfigTest.A>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.ParentConfigTest.A>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.ParentConfigTest.A;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.ParentConfigTest.A;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.ParentConfigTest.A;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.ParentConfigTest.A;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.ParentConfigTest.A;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.ParentConfigTest.A;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.ParentConfigTest.A;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.ParentConfigTest.A;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.ParentConfigTest.A;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.ParentConfigTest.A;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.ParentConfigTest.A;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.ParentConfigTest.A;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.ParentConfigTest.A;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.ParentConfigTest.A;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.ParentConfigTest.A;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.ParentConfigTest.A;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.ParentConfigTest.A;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.ParentConfigTest.A;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.ParentConfigTest.A;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.ParentConfigTest.A;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.ParentConfigTest.A;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.ParentConfigTest.A;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.ParentConfigTest.A;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.ParentConfigTest.A;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.ParentConfigTest.A;

    mergeJson(json: any): Genai.ParentConfigTest.A;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.ParentConfigTest.A;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.ParentConfigTest.A;
     ...
     */
    singletonArray(): Array_Type<Genai.ParentConfigTest.A>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.ParentConfigTest.A> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.ParentConfigTest.A> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.ParentConfigTest.A>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.ParentConfigTest.A> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.ParentConfigTest.A> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.ParentConfigTest.A> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.ParentConfigTest.A>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.ParentConfigTest.A>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.ParentConfigTest.A;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.ParentConfigTest.A;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.ParentConfigTest.A;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.ParentConfigTest.A;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.ParentConfigTest.A;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.ParentConfigTest.A;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.ParentConfigTest.A | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.ParentConfigTest.A;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.ParentConfigTest.A;
     ...
     */
    static cachedEmptyInst(): Genai.ParentConfigTest.A;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.ParentConfigTest.A> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.ParentConfigTest.A;
     ...
     */
    static allCached(): Stream<Genai.ParentConfigTest.A> | null;
     ...
     */
    static find(filter?: string): Stream<Genai.ParentConfigTest.A> | null;
     ...
     *         Otherwise no population will be performed.
     */
    static findBy(field: string, value: any): Stream<Genai.ParentConfigTest.A> | null;

    /**
     * @return cached instance.
     */
    getCached(): Genai.ParentConfigTest.A | null;

    /**
     * Returns cached instance by key, with secrets removed.
     */
    static forCacheKey(key: string): Genai.ParentConfigTest.A | null;
     ...
     */
    static produce(key: string): Genai.ParentConfigTest.A | null;

    /**
     * Should produces the entire content for the cached data. Will populate the cache with the produced data.
     */
    static produceAll(): Map_Type<string, Genai.ParentConfigTest.A> | null;
     ...
     */
    getConfig(): Genai.ParentConfigTest.A;
     ...
     */
    getSecret(): Genai.ParentConfigTest.A;
     ...
     */
    withConfigKey(configKey: string): Genai.ParentConfigTest.A;

    /**
     * @return copy without config key.
     */
    withoutConfigKey(): Genai.ParentConfigTest.A;

    /**
     * @return return cached config instance for provided config key.
     */
    static forConfigKey(configKey: string): Genai.ParentConfigTest.A | null;
     ...
     */
    static listConfigs(parallel?: boolean, filter?: λPredicate<string>): Stream<Genai.ParentConfigTest.A> | null;
     ...
     * @see setConfigValue
     */
    setConfigValues(from: Genai.ParentConfigTest.A, override?: string): void;
     ...
     */
    static loadConfigAndSecret(configKey: string): Genai.ParentConfigTest.A | null;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.ParentConfigTest.A | null;
     ...
     */
    static forName(name: string, failIfMissing?: boolean): Genai.ParentConfigTest.A | null;
     ...
     */
    static setRecursive(configJson: any, useSetConfigValues?: boolean, override?: string): Genai.ParentConfigTest.A;
