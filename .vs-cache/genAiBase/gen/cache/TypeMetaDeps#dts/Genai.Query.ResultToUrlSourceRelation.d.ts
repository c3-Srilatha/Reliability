// TypeScript definitions for the C3 type Genai.Query.ResultToUrlSourceRelation
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.Query.ResultToUrlSourceRelation
 */
declare namespace Genai.Query {
  export interface IResultToUrlSourceRelation {
     ...
     */
    to: IGenai.Query.Result.Source.Url;
 ...
 */
declare namespace Genai.Query {
  export class ResultToUrlSourceRelation extends Obj  {
    ...
    withTypeIdent(typeIdent: string | null): Genai.Query.ResultToUrlSourceRelation;
     ...
     */
    readonly id: string;
    withId(id: string): Genai.Query.ResultToUrlSourceRelation;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Genai.Query.ResultToUrlSourceRelation;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): Genai.Query.ResultToUrlSourceRelation;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): Genai.Query.ResultToUrlSourceRelation;
    ...
    withVersion(version: number | null): Genai.Query.ResultToUrlSourceRelation;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): Genai.Query.ResultToUrlSourceRelation;

    /**
     * The {@link Genai.Query.Result} that this relation is associated with.
     */
    readonly from?: Genai.Query.Result;
    withFrom(from: IGenai.Query.Result | null): Genai.Query.ResultToUrlSourceRelation;

    /**
     * The {@link Genai.Agent.DynamicTrajectory.Step} that this relation is associated with.
     */
    readonly fromStep?: Genai.Agent.DynamicTrajectory.Step;
    withFromStep(fromStep: IGenai.Agent.DynamicTrajectory.Step | null): Genai.Query.ResultToUrlSourceRelation;

    /**
     * The URL source that was used to generate the query result.
     */
    readonly to: Genai.Query.Result.Source.Url;
    withTo(to: IGenai.Query.Result.Source.Url): Genai.Query.ResultToUrlSourceRelation;
    ...
    withPassageUiDisplayIndex(passageUiDisplayIndex: number | null): Genai.Query.ResultToUrlSourceRelation;
    ...
    withDisplayName(displayName: string | null): Genai.Query.ResultToUrlSourceRelation;

    /**
     * The URL that can be visited to learn more about the source.
     */
    readonly url: string;
    withUrl(url: string): Genai.Query.ResultToUrlSourceRelation;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.Query.ResultToUrlSourceRelation | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.Query.ResultToUrlSourceRelation | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.Query.ResultToUrlSourceRelation | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.Query.ResultToUrlSourceRelation | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.Query.ResultToUrlSourceRelation;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Query.ResultToUrlSourceRelation;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Query.ResultToUrlSourceRelation;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Query.ResultToUrlSourceRelation>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Query.ResultToUrlSourceRelation>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.Query.ResultToUrlSourceRelation;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Query.ResultToUrlSourceRelation;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Query.ResultToUrlSourceRelation;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.Query.ResultToUrlSourceRelation;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.Query.ResultToUrlSourceRelation;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.Query.ResultToUrlSourceRelation;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.Query.ResultToUrlSourceRelation;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.Query.ResultToUrlSourceRelation;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.Query.ResultToUrlSourceRelation;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.Query.ResultToUrlSourceRelation;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.Query.ResultToUrlSourceRelation;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.Query.ResultToUrlSourceRelation;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.Query.ResultToUrlSourceRelation;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.Query.ResultToUrlSourceRelation;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.Query.ResultToUrlSourceRelation;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.Query.ResultToUrlSourceRelation;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.Query.ResultToUrlSourceRelation;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.Query.ResultToUrlSourceRelation;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.Query.ResultToUrlSourceRelation;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.Query.ResultToUrlSourceRelation;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.Query.ResultToUrlSourceRelation;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.Query.ResultToUrlSourceRelation;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.Query.ResultToUrlSourceRelation;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.Query.ResultToUrlSourceRelation;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.Query.ResultToUrlSourceRelation;

    mergeJson(json: any): Genai.Query.ResultToUrlSourceRelation;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.Query.ResultToUrlSourceRelation;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.Query.ResultToUrlSourceRelation;
     ...
     */
    singletonArray(): Array_Type<Genai.Query.ResultToUrlSourceRelation>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.Query.ResultToUrlSourceRelation> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.Query.ResultToUrlSourceRelation> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.Query.ResultToUrlSourceRelation>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.Query.ResultToUrlSourceRelation> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.Query.ResultToUrlSourceRelation> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.Query.ResultToUrlSourceRelation> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.Query.ResultToUrlSourceRelation>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.Query.ResultToUrlSourceRelation>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.Query.ResultToUrlSourceRelation;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.Query.ResultToUrlSourceRelation;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.Query.ResultToUrlSourceRelation;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.Query.ResultToUrlSourceRelation;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.Query.ResultToUrlSourceRelation;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.Query.ResultToUrlSourceRelation;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.Query.ResultToUrlSourceRelation | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.Query.ResultToUrlSourceRelation;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.Query.ResultToUrlSourceRelation;
     ...
     */
    static cachedEmptyInst(): Genai.Query.ResultToUrlSourceRelation;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.Query.ResultToUrlSourceRelation> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.Query.ResultToUrlSourceRelation;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<Genai.Query.ResultToUrlSourceRelation>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Genai.Query.ResultToUrlSourceRelation>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<Genai.Query.ResultToUrlSourceRelation> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Genai.Query.ResultToUrlSourceRelation>> | null;
     ...
     */
    get(include?: string): Genai.Query.ResultToUrlSourceRelation | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): Genai.Query.ResultToUrlSourceRelation | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Genai.Query.ResultToUrlSourceRelation;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): Genai.Query.ResultToUrlSourceRelation | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Genai.Query.ResultToUrlSourceRelation;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.Query.ResultToUrlSourceRelation | null;
     ...
     */
    create(spec?: UpsertSpec): Genai.Query.ResultToUrlSourceRelation | null;
     ...
     */
    static createBatch(objs: Array_Type<Genai.Query.ResultToUrlSourceRelation>, spec?: UpsertSpec): ObjList<Genai.Query.ResultToUrlSourceRelation> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Genai.Query.ResultToUrlSourceRelation>, spec?: CreateBatchObjStreamSpec): ObjList<Genai.Query.ResultToUrlSourceRelation> | null;
     ...
     */
    update(srcObj?: Genai.Query.ResultToUrlSourceRelation, spec?: UpsertSpec): Genai.Query.ResultToUrlSourceRelation | null;
     ...
     */
    upsert(srcObj?: Genai.Query.ResultToUrlSourceRelation, spec?: UpsertSpec): Genai.Query.ResultToUrlSourceRelation | null;
     ...
     */
    merge(spec?: MergeSpec): Genai.Query.ResultToUrlSourceRelation | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): Genai.Query.ResultToUrlSourceRelation | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): Genai.Query.ResultToUrlSourceRelation | null;
     ...
     */
    static updateBatch(objs: Array_Type<Genai.Query.ResultToUrlSourceRelation>, srcObjs?: Array_Type<Genai.Query.ResultToUrlSourceRelation>, spec?: UpsertSpec): ObjList<Genai.Query.ResultToUrlSourceRelation> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<Genai.Query.ResultToUrlSourceRelation> | null>, spec?: UpsertSpec): ObjList<Genai.Query.ResultToUrlSourceRelation> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<Genai.Query.ResultToUrlSourceRelation>, srcObjs?: Array_Type<Genai.Query.ResultToUrlSourceRelation>, spec?: UpsertSpec): ObjList<Genai.Query.ResultToUrlSourceRelation> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<Genai.Query.ResultToUrlSourceRelation> | null>, spec?: UpsertSpec): ObjList<Genai.Query.ResultToUrlSourceRelation> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<Genai.Query.ResultToUrlSourceRelation>, spec?: TouchSpec): ObjList<Genai.Query.ResultToUrlSourceRelation> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.Query.ResultToUrlSourceRelation>, spec?: MergeSpec): ObjList<Genai.Query.ResultToUrlSourceRelation> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.Query.ResultToUrlSourceRelation>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.Query.ResultToUrlSourceRelation> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<Genai.Query.ResultToUrlSourceRelation> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.Query.ResultToUrlSourceRelation> | null;
     ...
     */
    static mergeAll(mergeObj: Genai.Query.ResultToUrlSourceRelation, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Genai.Query.ResultToUrlSourceRelation, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<Genai.Query.ResultToUrlSourceRelation>, spec?: UpsertSpec): ObjList<Genai.Query.ResultToUrlSourceRelation> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<Genai.Query.ResultToUrlSourceRelation>, spec?: UpsertSpec): ObjList<Genai.Query.ResultToUrlSourceRelation> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): Genai.Query.ResultToUrlSourceRelation | null;
     ...
     */
    static beforeCreate(objs: Array_Type<Genai.Query.ResultToUrlSourceRelation>): ObjList<Genai.Query.ResultToUrlSourceRelation>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<Genai.Query.ResultToUrlSourceRelation>): ObjList<Genai.Query.ResultToUrlSourceRelation>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<Genai.Query.ResultToUrlSourceRelation>): ObjList<Genai.Query.ResultToUrlSourceRelation>;
     ...
     */
    static afterCreate(objs: Array_Type<Genai.Query.ResultToUrlSourceRelation>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<Genai.Query.ResultToUrlSourceRelation>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<Genai.Query.ResultToUrlSourceRelation>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<Genai.Query.ResultToUrlSourceRelation>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Genai.Query.ResultToUrlSourceRelation>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Genai.Query.ResultToUrlSourceRelation | null;
     ...
     */
    withoutIdentity(): Genai.Query.ResultToUrlSourceRelation | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<Genai.Query.ResultToUrlSourceRelation>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: Genai.Query.ResultToUrlSourceRelation, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<Genai.Query.ResultToUrlSourceRelation>, callback?: λFunction<Genai.Query.ResultToUrlSourceRelation | null, Genai.Query.ResultToUrlSourceRelation | null>): ObjList<Genai.Query.ResultToUrlSourceRelation>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<Genai.Query.ResultToUrlSourceRelation>, callback?: λFunction<Genai.Query.ResultToUrlSourceRelation | null, Genai.Query.ResultToUrlSourceRelation | null>): Array_Type<ObjError> | null;
     ...
     */
    static cloneTo(srcResult: Genai.Query.Result, destResult: Genai.Query.Result): Array_Type<Genai.Query.ResultToUrlSourceRelation>;
     ...
     */
    static cloneRelationsToParent(queryResult: Genai.Query.Result): Array_Type<Genai.Query.ResultToUrlSourceRelation> | null;
     ...
     * @return the list of relations for parent
     */
    static relationsForParent(queryResult: Genai.Query.Result): Array_Type<Genai.Query.ResultToUrlSourceRelation> | null;
