// TypeScript definitions for the C3 type Genai.SourceFile.Chunker.Engine.Deployment

/**
 * The Engine Deployment for {@link Genai.SourceFile.Chunker.Engine}.
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.SourceFile.Chunker.Engine.Deployment
 */
declare namespace Genai.SourceFile.Chunker.Engine {
...
declare namespace Genai.SourceFile.Chunker.Engine {
  export class Deployment extends Obj  {
    ...
    withName(name: string): Genai.SourceFile.Chunker.Engine.Deployment;
    ...
    withNodeRole(nodeRole: string | null): Genai.SourceFile.Chunker.Engine.Deployment;
    ...
    withAltNodeRoles(altNodeRoles: Array_Type<string> | Array<string> | null): Genai.SourceFile.Chunker.Engine.Deployment;
    ...
    withNodePools(nodePools: Array_Type<string> | Array<string> | null): Genai.SourceFile.Chunker.Engine.Deployment;
    ...
    withDedicatedThreadPool(dedicatedThreadPool: boolean): Genai.SourceFile.Chunker.Engine.Deployment;

    /**
     * If set to `true` then this {@link Engine} will auto start on every node of every target node-pool.
     */
    readonly autoStart?: boolean;
    withAutoStart(autoStart: boolean): Genai.SourceFile.Chunker.Engine.Deployment;
    ...
    withInactive(inactive: boolean): Genai.SourceFile.Chunker.Engine.Deployment;
    ...
    withFailActionIfEngineNotReady(failActionIfEngineNotReady: boolean): Genai.SourceFile.Chunker.Engine.Deployment;
    ...
    withInitializingNodeAvoidanceDuration(initializingNodeAvoidanceDuration: string | null): Genai.SourceFile.Chunker.Engine.Deployment;

    readonly configOverride?: string;
    withConfigOverride(configOverride: string | null): Genai.SourceFile.Chunker.Engine.Deployment;

    readonly secretOverride?: string;
    withSecretOverride(secretOverride: string | null): Genai.SourceFile.Chunker.Engine.Deployment;

    /**
     * Captures any issues that occurred while deserializing from filesystem
     */
    readonly issues?: Array_Type<string>;
    withIssues(issues: Array_Type<string> | Array<string> | null): Genai.SourceFile.Chunker.Engine.Deployment;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.SourceFile.Chunker.Engine.Deployment | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.SourceFile.Chunker.Engine.Deployment | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.SourceFile.Chunker.Engine.Deployment | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.SourceFile.Chunker.Engine.Deployment | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.SourceFile.Chunker.Engine.Deployment;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.SourceFile.Chunker.Engine.Deployment;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.SourceFile.Chunker.Engine.Deployment;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.SourceFile.Chunker.Engine.Deployment>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.SourceFile.Chunker.Engine.Deployment>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.SourceFile.Chunker.Engine.Deployment;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.SourceFile.Chunker.Engine.Deployment;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.SourceFile.Chunker.Engine.Deployment;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.SourceFile.Chunker.Engine.Deployment;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.SourceFile.Chunker.Engine.Deployment;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.SourceFile.Chunker.Engine.Deployment;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.SourceFile.Chunker.Engine.Deployment;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.SourceFile.Chunker.Engine.Deployment;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.SourceFile.Chunker.Engine.Deployment;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.SourceFile.Chunker.Engine.Deployment;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.SourceFile.Chunker.Engine.Deployment;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.SourceFile.Chunker.Engine.Deployment;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.SourceFile.Chunker.Engine.Deployment;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.SourceFile.Chunker.Engine.Deployment;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.SourceFile.Chunker.Engine.Deployment;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.SourceFile.Chunker.Engine.Deployment;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.SourceFile.Chunker.Engine.Deployment;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.SourceFile.Chunker.Engine.Deployment;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.SourceFile.Chunker.Engine.Deployment;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.SourceFile.Chunker.Engine.Deployment;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.SourceFile.Chunker.Engine.Deployment;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.SourceFile.Chunker.Engine.Deployment;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.SourceFile.Chunker.Engine.Deployment;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.SourceFile.Chunker.Engine.Deployment;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.SourceFile.Chunker.Engine.Deployment;

    mergeJson(json: any): Genai.SourceFile.Chunker.Engine.Deployment;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.SourceFile.Chunker.Engine.Deployment;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.SourceFile.Chunker.Engine.Deployment;
     ...
     */
    singletonArray(): Array_Type<Genai.SourceFile.Chunker.Engine.Deployment>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.SourceFile.Chunker.Engine.Deployment> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.SourceFile.Chunker.Engine.Deployment> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.SourceFile.Chunker.Engine.Deployment>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.SourceFile.Chunker.Engine.Deployment> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.SourceFile.Chunker.Engine.Deployment> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.SourceFile.Chunker.Engine.Deployment> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.SourceFile.Chunker.Engine.Deployment>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.SourceFile.Chunker.Engine.Deployment>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.SourceFile.Chunker.Engine.Deployment;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.SourceFile.Chunker.Engine.Deployment;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.SourceFile.Chunker.Engine.Deployment;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.SourceFile.Chunker.Engine.Deployment;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.SourceFile.Chunker.Engine.Deployment;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.SourceFile.Chunker.Engine.Deployment;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.SourceFile.Chunker.Engine.Deployment | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.SourceFile.Chunker.Engine.Deployment;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.SourceFile.Chunker.Engine.Deployment;
     ...
     */
    static cachedEmptyInst(): Genai.SourceFile.Chunker.Engine.Deployment;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.SourceFile.Chunker.Engine.Deployment> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.SourceFile.Chunker.Engine.Deployment;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.SourceFile.Chunker.Engine.Deployment | null;
     ...
     */
    static forName(name: string, failIfMissing?: boolean): Genai.SourceFile.Chunker.Engine.Deployment | null;
     ...
     */
    static allCached(): Stream<Genai.SourceFile.Chunker.Engine.Deployment> | null;
     ...
     */
    static find(filter?: string): Stream<Genai.SourceFile.Chunker.Engine.Deployment> | null;
     ...
     *         Otherwise no population will be performed.
     */
    static findBy(field: string, value: any): Stream<Genai.SourceFile.Chunker.Engine.Deployment> | null;

    /**
     * @return cached instance.
     */
    getCached(): Genai.SourceFile.Chunker.Engine.Deployment | null;

    /**
     * Returns cached instance by key, with secrets removed.
     */
    static forCacheKey(key: string): Genai.SourceFile.Chunker.Engine.Deployment | null;
     ...
     */
    static produce(key: string): Genai.SourceFile.Chunker.Engine.Deployment | null;

    /**
     * Should produces the entire content for the cached data. Will populate the cache with the produced data.
     */
    static produceAll(): Map_Type<string, Genai.SourceFile.Chunker.Engine.Deployment> | null;
     ...
     */
    getConfig(): Genai.SourceFile.Chunker.Engine.Deployment;
     ...
     */
    getSecret(): Genai.SourceFile.Chunker.Engine.Deployment;
     ...
     */
    withConfigKey(configKey: string): Genai.SourceFile.Chunker.Engine.Deployment;

    /**
     * @return copy without config key.
     */
    withoutConfigKey(): Genai.SourceFile.Chunker.Engine.Deployment;

    /**
     * @return return cached config instance for provided config key.
     */
    static forConfigKey(configKey: string): Genai.SourceFile.Chunker.Engine.Deployment | null;
     ...
     */
    static listConfigs(parallel?: boolean, filter?: λPredicate<string>): Stream<Genai.SourceFile.Chunker.Engine.Deployment> | null;
     ...
     * @see setConfigValue
     */
    setConfigValues(from: Genai.SourceFile.Chunker.Engine.Deployment, override?: string): void;
     ...
     */
    static loadConfigAndSecret(configKey: string): Genai.SourceFile.Chunker.Engine.Deployment | null;
     ...
     */
    removeSecrets(): Genai.SourceFile.Chunker.Engine.Deployment | null;

    /**
     * @return this config with only secret values.
     */
    removeNonSecrets(): Genai.SourceFile.Chunker.Engine.Deployment | null;

    /**
     * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
     * validation and setup.
     */
    validate(): Genai.SourceFile.Chunker.Engine.Deployment;
     ...
     */
    engineType(): Type<<Genai.SourceFile.Chunker.Engine>> | null;
     ...
     */
    static fromDeploySpec(spec: Engine.DeploySpec): Genai.SourceFile.Chunker.Engine.Deployment | null;
  }
}
