// TypeScript definitions for the C3 type Genai.Agent.Dynamic.Tool

/**
 * Type representing a tool in toolkit for a {@link Genai.Agent.Dynamic} agent.
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.Agent.Dynamic.Tool
 */
declare namespace Genai.Agent.Dynamic {
  export interface ITool {
     ...
     */
    uiConfigurationParams?: IGenai.Agent.Dynamic.Tool.UiConfig;
...
declare namespace Genai.Agent.Dynamic {
  export class Tool extends Obj  {
    ...
    withName(name: string | null): Genai.Agent.Dynamic.Tool;
     ...
     */
    readonly id: string;
    withId(id: string): Genai.Agent.Dynamic.Tool;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Genai.Agent.Dynamic.Tool;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): Genai.Agent.Dynamic.Tool;
    ...
    withVersion(version: number | null): Genai.Agent.Dynamic.Tool;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): Genai.Agent.Dynamic.Tool;
    ...
    withUserUpdatedFields(userUpdatedFields: Array_Type<string> | Array<string> | null): Genai.Agent.Dynamic.Tool;
    ...
    withHidden(hidden: boolean): Genai.Agent.Dynamic.Tool;
    ...
    withUserOwned(userOwned: boolean): Genai.Agent.Dynamic.Tool;
    ...
    withTypeIdent(typeIdent: string | null): Genai.Agent.Dynamic.Tool;

    /**
     * The flag used to mark whether the tool has been published. Defaults to `false`.
     */
    readonly isPublished?: boolean;
    withIsPublished(isPublished: boolean): Genai.Agent.Dynamic.Tool;

    /**
     * Optional persisted kwargs that will be passed to #initialize
     */
    readonly initKwargs?: any;
    withInitKwargs(initKwargs: any | null): Genai.Agent.Dynamic.Tool;
    ...
    withDescription(description: string | null): Genai.Agent.Dynamic.Tool;
    ...
    withDescriptionForLlm(descriptionForLlm: string): Genai.Agent.Dynamic.Tool;
    ...
    withArgsSchema(argsSchema: any | null): Genai.Agent.Dynamic.Tool;
    ...
    withOutputPyType(outputPyType: any | null): Genai.Agent.Dynamic.Tool;

    /**
     * The ui configuration for this tool.
     */
    readonly uiConfigurationParams?: Genai.Agent.Dynamic.Tool.UiConfig;
    withUiConfigurationParams(uiConfigurationParams: IGenai.Agent.Dynamic.Tool.UiConfig | null): Genai.Agent.Dynamic.Tool;
     ...
     */
    readonly pySrc: File;
    withPySrc(pySrc: IFile): Genai.Agent.Dynamic.Tool;
     ...
     * It can be used to configure parameters such as model name that we want to specify whithout having to hard code and change in the code.
     */
    readonly toolConfigurationParams?: any;
    withToolConfigurationParams(toolConfigurationParams: any | null): Genai.Agent.Dynamic.Tool;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.Agent.Dynamic.Tool | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.Agent.Dynamic.Tool | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.Agent.Dynamic.Tool | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.Agent.Dynamic.Tool | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.Agent.Dynamic.Tool;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Agent.Dynamic.Tool;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Agent.Dynamic.Tool;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Agent.Dynamic.Tool>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Agent.Dynamic.Tool>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.Agent.Dynamic.Tool;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Agent.Dynamic.Tool;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Agent.Dynamic.Tool;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.Agent.Dynamic.Tool;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.Agent.Dynamic.Tool;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.Agent.Dynamic.Tool;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.Agent.Dynamic.Tool;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.Agent.Dynamic.Tool;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.Agent.Dynamic.Tool;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.Agent.Dynamic.Tool;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.Agent.Dynamic.Tool;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.Agent.Dynamic.Tool;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.Agent.Dynamic.Tool;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.Agent.Dynamic.Tool;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.Agent.Dynamic.Tool;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.Agent.Dynamic.Tool;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.Agent.Dynamic.Tool;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.Agent.Dynamic.Tool;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.Agent.Dynamic.Tool;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.Agent.Dynamic.Tool;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.Agent.Dynamic.Tool;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.Agent.Dynamic.Tool;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.Agent.Dynamic.Tool;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.Agent.Dynamic.Tool;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.Agent.Dynamic.Tool;

    mergeJson(json: any): Genai.Agent.Dynamic.Tool;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.Agent.Dynamic.Tool;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.Agent.Dynamic.Tool;
     ...
     */
    singletonArray(): Array_Type<Genai.Agent.Dynamic.Tool>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.Agent.Dynamic.Tool> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.Agent.Dynamic.Tool> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.Agent.Dynamic.Tool>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.Agent.Dynamic.Tool> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.Agent.Dynamic.Tool> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.Agent.Dynamic.Tool> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.Agent.Dynamic.Tool>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.Agent.Dynamic.Tool>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.Agent.Dynamic.Tool;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.Agent.Dynamic.Tool;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.Agent.Dynamic.Tool;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.Agent.Dynamic.Tool;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.Agent.Dynamic.Tool;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.Agent.Dynamic.Tool;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.Agent.Dynamic.Tool | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.Agent.Dynamic.Tool;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.Agent.Dynamic.Tool;
     ...
     */
    static cachedEmptyInst(): Genai.Agent.Dynamic.Tool;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.Agent.Dynamic.Tool> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.Agent.Dynamic.Tool;
     ...
     */
    static filterGlobals(allGlobals?: any, globalNames?: Array_Type<string>): any;
     ...
     */
    static forName(name: string, failIfMissing?: boolean): any | null;
     ...
     */
    static allCached(): Stream<Genai.Agent.Dynamic.Tool> | null;
     ...
     */
    static find(filter?: string): Stream<Genai.Agent.Dynamic.Tool> | null;
     ...
     *         Otherwise no population will be performed.
     */
    static findBy(field: string, value: any): Stream<Genai.Agent.Dynamic.Tool> | null;

    /**
     * @return cached instance.
     */
    getCached(): Genai.Agent.Dynamic.Tool | null;

    /**
     * @return cached instance by the key.
     */
    static forCacheKey(key: string): Genai.Agent.Dynamic.Tool | null;
     ...
     */
    static produce(key: string): Genai.Agent.Dynamic.Tool | null;

    /**
     * Should produces the entire content for the cached data. Will populate the cache with the produced data.
     */
    static produceAll(): Map_Type<string, Genai.Agent.Dynamic.Tool> | null;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<Genai.Agent.Dynamic.Tool>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Genai.Agent.Dynamic.Tool>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<Genai.Agent.Dynamic.Tool> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Genai.Agent.Dynamic.Tool>> | null;
     ...
     */
    get(include?: string): Genai.Agent.Dynamic.Tool | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): Genai.Agent.Dynamic.Tool | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Genai.Agent.Dynamic.Tool;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): Genai.Agent.Dynamic.Tool | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Genai.Agent.Dynamic.Tool;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.Agent.Dynamic.Tool | null;
     ...
     */
    create(spec?: UpsertSpec): Genai.Agent.Dynamic.Tool | null;
     ...
     */
    static createBatch(objs: Array_Type<Genai.Agent.Dynamic.Tool>, spec?: UpsertSpec): ObjList<Genai.Agent.Dynamic.Tool> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Genai.Agent.Dynamic.Tool>, spec?: CreateBatchObjStreamSpec): ObjList<Genai.Agent.Dynamic.Tool> | null;
     ...
     */
    update(srcObj?: Genai.Agent.Dynamic.Tool, spec?: UpsertSpec): Genai.Agent.Dynamic.Tool | null;
     ...
     */
    upsert(srcObj?: Genai.Agent.Dynamic.Tool, spec?: UpsertSpec): Genai.Agent.Dynamic.Tool | null;
     ...
     */
    merge(spec?: MergeSpec): Genai.Agent.Dynamic.Tool | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): Genai.Agent.Dynamic.Tool | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): Genai.Agent.Dynamic.Tool | null;
     ...
     */
    static updateBatch(objs: Array_Type<Genai.Agent.Dynamic.Tool>, srcObjs?: Array_Type<Genai.Agent.Dynamic.Tool>, spec?: UpsertSpec): ObjList<Genai.Agent.Dynamic.Tool> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<Genai.Agent.Dynamic.Tool> | null>, spec?: UpsertSpec): ObjList<Genai.Agent.Dynamic.Tool> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<Genai.Agent.Dynamic.Tool>, srcObjs?: Array_Type<Genai.Agent.Dynamic.Tool>, spec?: UpsertSpec): ObjList<Genai.Agent.Dynamic.Tool> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<Genai.Agent.Dynamic.Tool> | null>, spec?: UpsertSpec): ObjList<Genai.Agent.Dynamic.Tool> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<Genai.Agent.Dynamic.Tool>, spec?: TouchSpec): ObjList<Genai.Agent.Dynamic.Tool> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.Agent.Dynamic.Tool>, spec?: MergeSpec): ObjList<Genai.Agent.Dynamic.Tool> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.Agent.Dynamic.Tool>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.Agent.Dynamic.Tool> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<Genai.Agent.Dynamic.Tool> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.Agent.Dynamic.Tool> | null;
     ...
     */
    static mergeAll(mergeObj: Genai.Agent.Dynamic.Tool, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Genai.Agent.Dynamic.Tool, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<Genai.Agent.Dynamic.Tool>, spec?: UpsertSpec): ObjList<Genai.Agent.Dynamic.Tool> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<Genai.Agent.Dynamic.Tool>, spec?: UpsertSpec): ObjList<Genai.Agent.Dynamic.Tool> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): Genai.Agent.Dynamic.Tool | null;
     ...
     */
    static beforeCreate(objs: Array_Type<Genai.Agent.Dynamic.Tool>): ObjList<Genai.Agent.Dynamic.Tool>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<Genai.Agent.Dynamic.Tool>): ObjList<Genai.Agent.Dynamic.Tool>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<Genai.Agent.Dynamic.Tool>): ObjList<Genai.Agent.Dynamic.Tool>;
     ...
     */
    static afterCreate(objs: Array_Type<Genai.Agent.Dynamic.Tool>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<Genai.Agent.Dynamic.Tool>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<Genai.Agent.Dynamic.Tool>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<Genai.Agent.Dynamic.Tool>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Genai.Agent.Dynamic.Tool>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Genai.Agent.Dynamic.Tool | null;
     ...
     */
    withoutIdentity(): Genai.Agent.Dynamic.Tool | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<Genai.Agent.Dynamic.Tool>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: Genai.Agent.Dynamic.Tool, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<Genai.Agent.Dynamic.Tool>, callback?: λFunction<Genai.Agent.Dynamic.Tool | null, Genai.Agent.Dynamic.Tool | null>): ObjList<Genai.Agent.Dynamic.Tool>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<Genai.Agent.Dynamic.Tool>, callback?: λFunction<Genai.Agent.Dynamic.Tool | null, Genai.Agent.Dynamic.Tool | null>): Array_Type<ObjError> | null;
     ...
     */
    publish(subPath?: string, contentType?: string): Genai.Agent.Dynamic.Tool;
     ...
     */
    static removeSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<Genai.Agent.Dynamic.Tool> | null;
     ...
     */
    createSeedData(spec?: UpsertSpec): Genai.Agent.Dynamic.Tool | null;
     ...
     */
    static createSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<Genai.Agent.Dynamic.Tool> | null;
     ...
     */
    updateSeedData(srcObj?: SeedData, spec?: UpsertSpec): Genai.Agent.Dynamic.Tool | null;
     ...
     */
    static updateSeedDataBatch(objs?: Array_Type<SeedData>, srcObjs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<Genai.Agent.Dynamic.Tool> | null;
     ...
     * @return updated obj instance, same as {@link Persistable#update} return value.
     */
    clearUserUpdates(spec?: MergeSpec): Genai.Agent.Dynamic.Tool | null;
     ...
     *         {@link Persistable#updateBatch}.
     */
    static clearUserUpdatesBatch(objs?: Array_Type<SeedData>, spec?: MergeSpec): ObjList<Genai.Agent.Dynamic.Tool> | null;
    ...
    dependencies(): SeedDataDeps<Genai.Agent.Dynamic.Tool> | null;
     ...
     * @return The tool.
     */
    static fromLocalFile(spec: Genai.Agent.Dynamic.Tool.FromLocalFileSpec, overrideIfExists?: boolean): Genai.Agent.Dynamic.Tool;
  }
}
