// TypeScript definitions for the C3 type Genai.LlmGuardrails.Manager

/**
 * Manages {@link Genai.LlmGuardrails.Processor}s and applies them to
 * all LLM input and output.
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.LlmGuardrails.Manager
 */
declare namespace Genai.LlmGuardrails {
  export interface IManager {
     ...
     */
    inputProcessors?: Array_Type<Genai.LlmGuardrails.Processor> | Array<IGenai.LlmGuardrails.Processor>;

    /**
     * All processors to apply in order to the output.
     */
    outputProcessors?: Array_Type<Genai.LlmGuardrails.Processor> | Array<IGenai.LlmGuardrails.Processor>;
  }
}
 ...
 */
declare namespace Genai.LlmGuardrails {
  export class Manager extends Obj  {

    readonly configOverride?: string;
    withConfigOverride(configOverride: string | null): Genai.LlmGuardrails.Manager;

    static readonly configOverride?: string;

    readonly secretOverride?: string;
    withSecretOverride(secretOverride: string | null): Genai.LlmGuardrails.Manager;
    ...
    withIssues(issues: Array_Type<string> | Array<string> | null): Genai.LlmGuardrails.Manager;
     ...
     * All processors to apply in order to the input.
     */
    readonly inputProcessors?: Array_Type<Genai.LlmGuardrails.Processor>;
    withInputProcessors(inputProcessors: Array_Type<Genai.LlmGuardrails.Processor> | Array<IGenai.LlmGuardrails.Processor> | null): Genai.LlmGuardrails.Manager;

    /**
     * All processors to apply in order to the input.
     */
    static readonly inputProcessors?: Array_Type<Genai.LlmGuardrails.Processor>;

    /**
     * All processors to apply in order to the output.
     */
    readonly outputProcessors?: Array_Type<Genai.LlmGuardrails.Processor>;
    withOutputProcessors(outputProcessors: Array_Type<Genai.LlmGuardrails.Processor> | Array<IGenai.LlmGuardrails.Processor> | null): Genai.LlmGuardrails.Manager;

    /**
     * All processors to apply in order to the output.
     */
    static readonly outputProcessors?: Array_Type<Genai.LlmGuardrails.Processor>;

    /**
     * @return the one and only instance to be used when member functions are called on this type.
     */
    static inst(): Genai.LlmGuardrails.Manager;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.LlmGuardrails.Manager | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.LlmGuardrails.Manager | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.LlmGuardrails.Manager | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.LlmGuardrails.Manager | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.LlmGuardrails.Manager;
     ...
     * This method is used during live metadata update
     */
    static replaceType(old: Type, new_: Type): Genai.LlmGuardrails.Manager;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.LlmGuardrails.Manager;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.LlmGuardrails.Manager;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.LlmGuardrails.Manager;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.LlmGuardrails.Manager;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.LlmGuardrails.Manager>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.LlmGuardrails.Manager>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.LlmGuardrails.Manager>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.LlmGuardrails.Manager>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.LlmGuardrails.Manager;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.LlmGuardrails.Manager;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.LlmGuardrails.Manager;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.LlmGuardrails.Manager;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.LlmGuardrails.Manager;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.LlmGuardrails.Manager;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.LlmGuardrails.Manager;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    static validateObj(): Genai.LlmGuardrails.Manager;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.LlmGuardrails.Manager;
     ...
     * @see #defaultField
     */
    static withField(field: string, value: any, doNotConvert?: boolean): Genai.LlmGuardrails.Manager;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.LlmGuardrails.Manager;
     ...
     * @see #defaultField
     */
    static withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.LlmGuardrails.Manager;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.LlmGuardrails.Manager;
     ...
     * @return new Obj
     */
    static withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.LlmGuardrails.Manager;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.LlmGuardrails.Manager;
     ...
     * @return new Obj
     */
    static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.LlmGuardrails.Manager;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.LlmGuardrails.Manager;
     ...
     * @see #withoutField
     */
    static withoutFieldAtPath(path: string): Genai.LlmGuardrails.Manager;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.LlmGuardrails.Manager;
     ...
     * @see #removeField
     */
    static withoutField(field: string): Genai.LlmGuardrails.Manager;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.LlmGuardrails.Manager;
     ...
     * @see #removeField
     */
    static withoutField(field: FieldType): Genai.LlmGuardrails.Manager;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.LlmGuardrails.Manager;
     ...
     * @return new Obj with removed fields
     */
    static withoutFields(fields: Array_Type<string>): Genai.LlmGuardrails.Manager;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.LlmGuardrails.Manager;
     ...
     * @return new Obj with removed fields
     */
    static withoutFieldsByType(fields: Array_Type<FieldType>): Genai.LlmGuardrails.Manager;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.LlmGuardrails.Manager;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    static withoutSecretFields(): Genai.LlmGuardrails.Manager;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.LlmGuardrails.Manager;
     ...
     * @see FieldType#defaultValue
     */
    static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.LlmGuardrails.Manager;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.LlmGuardrails.Manager;
     ...
     * @see #unsetField
     */
    static defaultField(field: string): Genai.LlmGuardrails.Manager;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.LlmGuardrails.Manager;
     ...
     * @see #unsetField
     */
    static defaultField(field: FieldType): Genai.LlmGuardrails.Manager;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.LlmGuardrails.Manager;
     ...
     * @see #removeField
     */
    static unsetField(field: string): Genai.LlmGuardrails.Manager;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.LlmGuardrails.Manager;
     ...
     * @see #removeField
     */
    static unsetField(field: FieldType): Genai.LlmGuardrails.Manager;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.LlmGuardrails.Manager;
     ...
     * @see #unsetField
     */
    static removeField(field: string): Genai.LlmGuardrails.Manager;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.LlmGuardrails.Manager;
     ...
     * @see #unsetField
     */
    static removeField(field: FieldType): Genai.LlmGuardrails.Manager;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.LlmGuardrails.Manager;
     ...
     * @return the new merged Obj
     */
    static mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.LlmGuardrails.Manager;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.LlmGuardrails.Manager;
     ...
     * @return the new merged Obj
     */
    static mergeObj(other: Obj, otherFieldsFilter: Type): Genai.LlmGuardrails.Manager;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.LlmGuardrails.Manager;
     ...
     *        the same key or index.
     */
    static mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.LlmGuardrails.Manager;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.LlmGuardrails.Manager;
     ...
     * traverse child reference and collection fields.
     */
    static mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.LlmGuardrails.Manager;

    mergeJson(json: any): Genai.LlmGuardrails.Manager;

    static mergeJson(json: any): Genai.LlmGuardrails.Manager;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.LlmGuardrails.Manager;
     ...
     * @return Obj with child references merged
     */
    static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.LlmGuardrails.Manager;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.LlmGuardrails.Manager;
     ...
     * references with same name and collection elements at same index or key.
     */
    static sumObj(other: Obj, deep?: boolean): Genai.LlmGuardrails.Manager;
     ...
     */
    singletonArray(): Array_Type<Genai.LlmGuardrails.Manager>;
     ...
     * @return new array instance with this as only element.
     */
    static singletonArray(): Array_Type<Genai.LlmGuardrails.Manager>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.LlmGuardrails.Manager> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.LlmGuardrails.Manager> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.LlmGuardrails.Manager>;
     ...
     * @return new array instance with this as only element.
     */
    static singletonSet(): Set_Type<Genai.LlmGuardrails.Manager>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.LlmGuardrails.Manager> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.LlmGuardrails.Manager> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.LlmGuardrails.Manager> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.LlmGuardrails.Manager>;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    static toBuilder(): ObjBuilder<Genai.LlmGuardrails.Manager>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.LlmGuardrails.Manager>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.LlmGuardrails.Manager;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.LlmGuardrails.Manager;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.LlmGuardrails.Manager;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.LlmGuardrails.Manager;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.LlmGuardrails.Manager;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.LlmGuardrails.Manager;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.LlmGuardrails.Manager;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.LlmGuardrails.Manager;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    static afterMake(): Genai.LlmGuardrails.Manager;
     ...
     */
    static cachedEmptyInst(): Genai.LlmGuardrails.Manager;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.LlmGuardrails.Manager> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.LlmGuardrails.Manager;
     ...
     */
    static allCached(): Stream<Genai.LlmGuardrails.Manager> | null;
     ...
     */
    static find(filter?: string): Stream<Genai.LlmGuardrails.Manager> | null;
     ...
     *         Otherwise no population will be performed.
     */
    static findBy(field: string, value: any): Stream<Genai.LlmGuardrails.Manager> | null;

    /**
     * @return cached instance.
     */
    getCached(): Genai.LlmGuardrails.Manager | null;

    /**
     * @return cached instance.
     */
    static getCached(): Genai.LlmGuardrails.Manager | null;

    /**
     * Returns cached instance by key, with secrets removed.
     */
    static forCacheKey(key: string): Genai.LlmGuardrails.Manager | null;
     ...
     */
    static produce(key: string): Genai.LlmGuardrails.Manager | null;

    /**
     * Should produces the entire content for the cached data. Will populate the cache with the produced data.
     */
    static produceAll(): Map_Type<string, Genai.LlmGuardrails.Manager> | null;
     ...
     */
    getConfig(): Genai.LlmGuardrails.Manager;
     ...
     * Note that typical pattern is to use Configurable#config instead of this method.
     */
    static getConfig(): Genai.LlmGuardrails.Manager;
     ...
     */
    getSecret(): Genai.LlmGuardrails.Manager;
     ...
     * Note that typical pattern is to use Configurable#configWithSecrets instead of this method.
     */
    static getSecret(): Genai.LlmGuardrails.Manager;
     ...
     */
    withConfigKey(configKey: string): Genai.LlmGuardrails.Manager;
     ...
     *     config.configKey() => "folder1/abc"
     */
    static withConfigKey(configKey: string): Genai.LlmGuardrails.Manager;

    /**
     * @return copy without config key.
     */
    withoutConfigKey(): Genai.LlmGuardrails.Manager;

    /**
     * @return copy without config key.
     */
    static withoutConfigKey(): Genai.LlmGuardrails.Manager;

    /**
     * @return return cached config instance for provided config key.
     */
    static forConfigKey(configKey: string): Genai.LlmGuardrails.Manager | null;
     ...
     */
    static listConfigs(parallel?: boolean, filter?: λPredicate<string>): Stream<Genai.LlmGuardrails.Manager> | null;
     ...
     * @see setConfigValue
     */
    setConfigValues(from: Genai.LlmGuardrails.Manager, override?: string): void;
     ...
     * @see setConfigValue
     */
    static setConfigValues(from: Genai.LlmGuardrails.Manager, override?: string): void;
     ...
     */
    static loadConfigAndSecret(configKey: string): Genai.LlmGuardrails.Manager | null;
     ...
     */
    removeSecrets(): Genai.LlmGuardrails.Manager | null;

    /**
     * @return this config without any secret values.
     */
    static removeSecrets(): Genai.LlmGuardrails.Manager | null;

    /**
     * @return this config with only secret values.
     */
    removeNonSecrets(): Genai.LlmGuardrails.Manager | null;

    /**
     * @return this config with only secret values.
     */
    static removeNonSecrets(): Genai.LlmGuardrails.Manager | null;

    /**
     * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
     * validation and setup.
     */
    validate(): Genai.LlmGuardrails.Manager;

    /**
     * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
     * validation and setup.
     */
    static validate(): Genai.LlmGuardrails.Manager;
     ...
     */
    processInput(inputPrompt: Genai.Prompt): Genai.LlmGuardrails.Processor.Result;
     ...
     * @return the processed LLM input.
     */
    static processInput(inputPrompt: Genai.Prompt): Genai.LlmGuardrails.Processor.Result;
     ...
     */
    processOutput(outputPrompt: string): Genai.LlmGuardrails.Processor.Result;
     ...
     * @return the processed LLM output.
     */
    static processOutput(outputPrompt: string): Genai.LlmGuardrails.Processor.Result;
  }
}
