// TypeScript definitions for the C3 type Genai.TestCoords

/**
 * Test type to test how we handle decimals.
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.TestCoords
 */
declare namespace Genai {
  export interface ITestCoords {
 ...
 */
declare namespace Genai {
  export class TestCoords extends Obj  {
     ...
     */
    readonly id: string;
    withId(id: string): Genai.TestCoords;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Genai.TestCoords;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): Genai.TestCoords;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): Genai.TestCoords;
    ...
    withVersion(version: number | null): Genai.TestCoords;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): Genai.TestCoords;

    /**
     * The latitude of the test coordinates.
     */
    readonly latitude?: number;
    withLatitude(latitude: number | null): Genai.TestCoords;

    /**
     * The longitude of the test coordinates.
     */
    readonly longitude?: number;
    withLongitude(longitude: number | null): Genai.TestCoords;

    /**
     * Some float field.
     */
    readonly someFloat?: number;
    withSomeFloat(someFloat: number | null): Genai.TestCoords;

    /**
     * Some double field.
     */
    readonly someDouble?: number;
    withSomeDouble(someDouble: number | null): Genai.TestCoords;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.TestCoords | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.TestCoords | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.TestCoords | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.TestCoords | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.TestCoords;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.TestCoords;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.TestCoords;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.TestCoords>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.TestCoords>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.TestCoords;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.TestCoords;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.TestCoords;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.TestCoords;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.TestCoords;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.TestCoords;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.TestCoords;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.TestCoords;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.TestCoords;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.TestCoords;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.TestCoords;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.TestCoords;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.TestCoords;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.TestCoords;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.TestCoords;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.TestCoords;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.TestCoords;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.TestCoords;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.TestCoords;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.TestCoords;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.TestCoords;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.TestCoords;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.TestCoords;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.TestCoords;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.TestCoords;

    mergeJson(json: any): Genai.TestCoords;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.TestCoords;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.TestCoords;
     ...
     */
    singletonArray(): Array_Type<Genai.TestCoords>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.TestCoords> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.TestCoords> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.TestCoords>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.TestCoords> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.TestCoords> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.TestCoords> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.TestCoords>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.TestCoords>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.TestCoords;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.TestCoords;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.TestCoords;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.TestCoords;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.TestCoords;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.TestCoords;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.TestCoords | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.TestCoords;
     ...
     */
    static cachedEmptyInst(): Genai.TestCoords;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.TestCoords> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.TestCoords;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<Genai.TestCoords>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Genai.TestCoords>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<Genai.TestCoords> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Genai.TestCoords>> | null;
     ...
     */
    get(include?: string): Genai.TestCoords | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): Genai.TestCoords | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Genai.TestCoords;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): Genai.TestCoords | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Genai.TestCoords;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.TestCoords | null;
     ...
     */
    create(spec?: UpsertSpec): Genai.TestCoords | null;
     ...
     */
    static createBatch(objs: Array_Type<Genai.TestCoords>, spec?: UpsertSpec): ObjList<Genai.TestCoords> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Genai.TestCoords>, spec?: CreateBatchObjStreamSpec): ObjList<Genai.TestCoords> | null;
     ...
     */
    update(srcObj?: Genai.TestCoords, spec?: UpsertSpec): Genai.TestCoords | null;
     ...
     */
    upsert(srcObj?: Genai.TestCoords, spec?: UpsertSpec): Genai.TestCoords | null;
     ...
     */
    merge(spec?: MergeSpec): Genai.TestCoords | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): Genai.TestCoords | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): Genai.TestCoords | null;
     ...
     */
    static updateBatch(objs: Array_Type<Genai.TestCoords>, srcObjs?: Array_Type<Genai.TestCoords>, spec?: UpsertSpec): ObjList<Genai.TestCoords> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<Genai.TestCoords> | null>, spec?: UpsertSpec): ObjList<Genai.TestCoords> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<Genai.TestCoords>, srcObjs?: Array_Type<Genai.TestCoords>, spec?: UpsertSpec): ObjList<Genai.TestCoords> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<Genai.TestCoords> | null>, spec?: UpsertSpec): ObjList<Genai.TestCoords> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<Genai.TestCoords>, spec?: TouchSpec): ObjList<Genai.TestCoords> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.TestCoords>, spec?: MergeSpec): ObjList<Genai.TestCoords> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.TestCoords>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.TestCoords> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<Genai.TestCoords> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.TestCoords> | null;
     ...
     */
    static mergeAll(mergeObj: Genai.TestCoords, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Genai.TestCoords, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<Genai.TestCoords>, spec?: UpsertSpec): ObjList<Genai.TestCoords> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<Genai.TestCoords>, spec?: UpsertSpec): ObjList<Genai.TestCoords> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): Genai.TestCoords | null;
     ...
     */
    static beforeCreate(objs: Array_Type<Genai.TestCoords>): ObjList<Genai.TestCoords>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<Genai.TestCoords>): ObjList<Genai.TestCoords>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<Genai.TestCoords>): ObjList<Genai.TestCoords>;
     ...
     */
    static afterCreate(objs: Array_Type<Genai.TestCoords>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<Genai.TestCoords>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<Genai.TestCoords>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<Genai.TestCoords>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Genai.TestCoords>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Genai.TestCoords | null;
     ...
     */
    withoutIdentity(): Genai.TestCoords | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<Genai.TestCoords>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: Genai.TestCoords, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<Genai.TestCoords>, callback?: λFunction<Genai.TestCoords | null, Genai.TestCoords | null>): ObjList<Genai.TestCoords>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<Genai.TestCoords>, callback?: λFunction<Genai.TestCoords | null, Genai.TestCoords | null>): Array_Type<ObjError> | null;
