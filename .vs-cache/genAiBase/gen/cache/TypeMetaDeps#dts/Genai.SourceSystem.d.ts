// TypeScript definitions for the C3 type Genai.SourceSystem

/**
 * Represents the root of an external file system integrated into the application
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.SourceSystem
 */
declare namespace Genai {
  export interface ISourceSystem<CS> {
 ...
 */
declare namespace Genai {
  export class SourceSystem<CS> extends Obj  {
    ...
    withTypeIdent(typeIdent: string | null): Genai.SourceSystem;
     ...
     */
    readonly id: string;
    withId(id: string): Genai.SourceSystem;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Genai.SourceSystem;

    /**
     * Name of the source system
     */
    readonly name: string;
    withName(name: string): Genai.SourceSystem;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): Genai.SourceSystem;
    ...
    withVersion(version: number | null): Genai.SourceSystem;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): Genai.SourceSystem;

    /**
     * The type of the source system
     */
    readonly sourceType: string;
    withSourceType(sourceType: string): Genai.SourceSystem;

    /**
     * The {@link Genai.SourceCollection}s created as a part of this source system
     */
    readonly collections?: Array_Type<Genai.SourceCollection>;
    withCollections(collections: Array_Type<Genai.SourceCollection> | Array<IGenai.SourceCollection> | null): Genai.SourceSystem;

    /**
     * Description of the source system
     */
    readonly description?: string;
    withDescription(description: string | null): Genai.SourceSystem;

    /**
     * The name of the mount in {@link FileSystem#mounts} for this source system
     */
    readonly mountName: string;
    withMountName(mountName: string): Genai.SourceSystem;

    /**
     * The name of the bucket for the source system
     */
    readonly bucketName: string;
    withBucketName(bucketName: string): Genai.SourceSystem;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.SourceSystem<CS> | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.SourceSystem<CS> | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.SourceSystem<CS> | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.SourceSystem<CS> | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.SourceSystem<CS>;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.SourceSystem<CS>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.SourceSystem<CS>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.SourceSystem<CS>>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.SourceSystem<CS>>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.SourceSystem<CS>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.SourceSystem<CS>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.SourceSystem<CS>;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.SourceSystem<CS>;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.SourceSystem<CS>;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.SourceSystem<CS>;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.SourceSystem<CS>;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.SourceSystem<CS>;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.SourceSystem<CS>;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.SourceSystem<CS>;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.SourceSystem<CS>;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.SourceSystem<CS>;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.SourceSystem<CS>;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.SourceSystem<CS>;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.SourceSystem<CS>;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.SourceSystem<CS>;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.SourceSystem<CS>;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.SourceSystem<CS>;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.SourceSystem<CS>;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.SourceSystem<CS>;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.SourceSystem<CS>;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.SourceSystem<CS>;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.SourceSystem<CS>;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.SourceSystem<CS>;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.SourceSystem<CS>;

    mergeJson(json: any): Genai.SourceSystem<CS>;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.SourceSystem<CS>;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.SourceSystem<CS>;
     ...
     */
    singletonArray(): Array_Type<Genai.SourceSystem<CS>>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.SourceSystem<CS>> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.SourceSystem<CS>> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.SourceSystem<CS>>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.SourceSystem<CS>> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.SourceSystem<CS>> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.SourceSystem<CS>> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.SourceSystem<CS>>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.SourceSystem<CS>>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.SourceSystem<CS>;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.SourceSystem<CS>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.SourceSystem<CS>;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.SourceSystem<CS>;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.SourceSystem<CS>;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.SourceSystem<CS>;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.SourceSystem<CS> | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.SourceSystem<CS>;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.SourceSystem<CS>;
     ...
     */
    static cachedEmptyInst(): Genai.SourceSystem<CS>;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.SourceSystem<CS>> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.SourceSystem<CS>;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<Genai.SourceSystem<CS>>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Genai.SourceSystem<CS>>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<Genai.SourceSystem<CS>> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Genai.SourceSystem<CS>>> | null;
     ...
     */
    get(include?: string): Genai.SourceSystem<CS> | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): Genai.SourceSystem<CS> | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Genai.SourceSystem<CS>;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): Genai.SourceSystem<CS> | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Genai.SourceSystem<CS>;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.SourceSystem<CS> | null;
     ...
     */
    create(spec?: UpsertSpec): Genai.SourceSystem<CS> | null;
     ...
     */
    static createBatch(objs: Array_Type<Genai.SourceSystem<CS>>, spec?: UpsertSpec): ObjList<Genai.SourceSystem<CS>> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Genai.SourceSystem<CS>>, spec?: CreateBatchObjStreamSpec): ObjList<Genai.SourceSystem<CS>> | null;
     ...
     */
    update(srcObj?: Genai.SourceSystem<CS>, spec?: UpsertSpec): Genai.SourceSystem<CS> | null;
     ...
     */
    upsert(srcObj?: Genai.SourceSystem<CS>, spec?: UpsertSpec): Genai.SourceSystem<CS> | null;
     ...
     */
    merge(spec?: MergeSpec): Genai.SourceSystem<CS> | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): Genai.SourceSystem<CS> | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): Genai.SourceSystem<CS> | null;
     ...
     */
    static updateBatch(objs: Array_Type<Genai.SourceSystem<CS>>, srcObjs?: Array_Type<Genai.SourceSystem<CS>>, spec?: UpsertSpec): ObjList<Genai.SourceSystem<CS>> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<Genai.SourceSystem<CS>> | null>, spec?: UpsertSpec): ObjList<Genai.SourceSystem<CS>> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<Genai.SourceSystem<CS>>, srcObjs?: Array_Type<Genai.SourceSystem<CS>>, spec?: UpsertSpec): ObjList<Genai.SourceSystem<CS>> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<Genai.SourceSystem<CS>> | null>, spec?: UpsertSpec): ObjList<Genai.SourceSystem<CS>> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<Genai.SourceSystem<CS>>, spec?: TouchSpec): ObjList<Genai.SourceSystem<CS>> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.SourceSystem<CS>>, spec?: MergeSpec): ObjList<Genai.SourceSystem<CS>> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.SourceSystem<CS>>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.SourceSystem<CS>> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<Genai.SourceSystem<CS>> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.SourceSystem<CS>> | null;
     ...
     */
    static mergeAll(mergeObj: Genai.SourceSystem<CS>, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Genai.SourceSystem<CS>, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<Genai.SourceSystem<CS>>, spec?: UpsertSpec): ObjList<Genai.SourceSystem<CS>> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<Genai.SourceSystem<CS>>, spec?: UpsertSpec): ObjList<Genai.SourceSystem<CS>> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): Genai.SourceSystem<CS> | null;
     ...
     */
    static beforeCreate(objs: Array_Type<Genai.SourceSystem<CS>>): ObjList<Genai.SourceSystem<CS>>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<Genai.SourceSystem<CS>>): ObjList<Genai.SourceSystem<CS>>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<Genai.SourceSystem<CS>>): ObjList<Genai.SourceSystem<CS>>;
     ...
     */
    static afterCreate(objs: Array_Type<Genai.SourceSystem<CS>>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<Genai.SourceSystem<CS>>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<Genai.SourceSystem<CS>>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<Genai.SourceSystem<CS>>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Genai.SourceSystem<CS>>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Genai.SourceSystem<CS> | null;
     ...
     */
    withoutIdentity(): Genai.SourceSystem<CS> | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<Genai.SourceSystem<CS>>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: Genai.SourceSystem<CS>, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<Genai.SourceSystem<CS>>, callback?: λFunction<Genai.SourceSystem<CS> | null, Genai.SourceSystem<CS> | null>): ObjList<Genai.SourceSystem<CS>>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<Genai.SourceSystem<CS>>, callback?: λFunction<Genai.SourceSystem<CS> | null, Genai.SourceSystem<CS> | null>): Array_Type<ObjError> | null;
     ...
     */
    static createSourceSystem(spec: CS, rootUrls: Array_Type<string>): Genai.SourceSystem;
