// TypeScript definitions for the C3 type Genai.Agent.Tool.FinalAnswer.Config

/**
 * Config for {@link Genai.Agent.Tool.FinalAnswer}
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.Agent.Tool.FinalAnswer.Config
 */
declare namespace Genai.Agent.Tool.FinalAnswer {
...
declare namespace Genai.Agent.Tool.FinalAnswer {
  export class Config extends Obj  {
     ...
     */
    readonly id: string;
    withId(id: string): Genai.Agent.Tool.FinalAnswer.Config;
    ...
    withNativeToolDocumentationOverride(nativeToolDocumentationOverride: any | null): Genai.Agent.Tool.FinalAnswer.Config;
    ...
    withSerializeInputsForFunctionCall(serializeInputsForFunctionCall: boolean): Genai.Agent.Tool.FinalAnswer.Config;

    readonly configOverride?: string;
    withConfigOverride(configOverride: string | null): Genai.Agent.Tool.FinalAnswer.Config;

    readonly secretOverride?: string;
    withSecretOverride(secretOverride: string | null): Genai.Agent.Tool.FinalAnswer.Config;

    /**
     * Captures any issues that occurred while deserializing from filesystem
     */
    readonly issues?: Array_Type<string>;
    withIssues(issues: Array_Type<string> | Array<string> | null): Genai.Agent.Tool.FinalAnswer.Config;

    /**
     * Name of the {@link Genai.UnstructuredQuery.Engine.ModelConfig} to use
     */
    readonly llmConfigName: string;
    withLlmConfigName(llmConfigName: string): Genai.Agent.Tool.FinalAnswer.Config;

    /**
     * The prompt to use for generating the final answer
     */
    readonly finalAnswerPrompt: Genai.Prompt;
    withFinalAnswerPrompt(finalAnswerPrompt: IGenai.Prompt): Genai.Agent.Tool.FinalAnswer.Config;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.Agent.Tool.FinalAnswer.Config | null;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.Agent.Tool.FinalAnswer.Config | null;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.Agent.Tool.FinalAnswer.Config;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.Agent.Tool.FinalAnswer.Config;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.Agent.Tool.FinalAnswer.Config;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.Agent.Tool.FinalAnswer.Config;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.Agent.Tool.FinalAnswer.Config | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.Agent.Tool.FinalAnswer.Config | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.Agent.Tool.FinalAnswer.Config | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.Agent.Tool.FinalAnswer.Config | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.Agent.Tool.FinalAnswer.Config;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Agent.Tool.FinalAnswer.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Agent.Tool.FinalAnswer.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Agent.Tool.FinalAnswer.Config>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Agent.Tool.FinalAnswer.Config>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.Agent.Tool.FinalAnswer.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Agent.Tool.FinalAnswer.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Agent.Tool.FinalAnswer.Config;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.Agent.Tool.FinalAnswer.Config;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.Agent.Tool.FinalAnswer.Config;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.Agent.Tool.FinalAnswer.Config;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.Agent.Tool.FinalAnswer.Config;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.Agent.Tool.FinalAnswer.Config;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.Agent.Tool.FinalAnswer.Config;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.Agent.Tool.FinalAnswer.Config;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.Agent.Tool.FinalAnswer.Config;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.Agent.Tool.FinalAnswer.Config;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.Agent.Tool.FinalAnswer.Config;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.Agent.Tool.FinalAnswer.Config;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.Agent.Tool.FinalAnswer.Config;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.Agent.Tool.FinalAnswer.Config;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.Agent.Tool.FinalAnswer.Config;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.Agent.Tool.FinalAnswer.Config;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.Agent.Tool.FinalAnswer.Config;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.Agent.Tool.FinalAnswer.Config;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.Agent.Tool.FinalAnswer.Config;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.Agent.Tool.FinalAnswer.Config;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.Agent.Tool.FinalAnswer.Config;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.Agent.Tool.FinalAnswer.Config;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.Agent.Tool.FinalAnswer.Config;

    mergeJson(json: any): Genai.Agent.Tool.FinalAnswer.Config;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.Agent.Tool.FinalAnswer.Config;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.Agent.Tool.FinalAnswer.Config;
     ...
     */
    singletonArray(): Array_Type<Genai.Agent.Tool.FinalAnswer.Config>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.Agent.Tool.FinalAnswer.Config> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.Agent.Tool.FinalAnswer.Config> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.Agent.Tool.FinalAnswer.Config>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.Agent.Tool.FinalAnswer.Config> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.Agent.Tool.FinalAnswer.Config> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.Agent.Tool.FinalAnswer.Config> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.Agent.Tool.FinalAnswer.Config>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.Agent.Tool.FinalAnswer.Config>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.Agent.Tool.FinalAnswer.Config;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.Agent.Tool.FinalAnswer.Config;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.Agent.Tool.FinalAnswer.Config;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.Agent.Tool.FinalAnswer.Config;
     ...
     */
    static cachedEmptyInst(): Genai.Agent.Tool.FinalAnswer.Config;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.Agent.Tool.FinalAnswer.Config> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.Agent.Tool.FinalAnswer.Config;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Genai.Agent.Tool.FinalAnswer.Config | null;
     ...
     */
    static setRecursive(configJson: any, useSetConfigValues?: boolean, override?: string): Genai.Agent.Tool.FinalAnswer.Config;
     ...
     */
    static allCached(): Stream<Genai.Agent.Tool.FinalAnswer.Config> | null;
     ...
     */
    static find(filter?: string): Stream<Genai.Agent.Tool.FinalAnswer.Config> | null;
     ...
     *         Otherwise no population will be performed.
     */
    static findBy(field: string, value: any): Stream<Genai.Agent.Tool.FinalAnswer.Config> | null;

    /**
     * @return cached instance.
     */
    getCached(): Genai.Agent.Tool.FinalAnswer.Config | null;

    /**
     * Returns cached instance by key, with secrets removed.
     */
    static forCacheKey(key: string): Genai.Agent.Tool.FinalAnswer.Config | null;
     ...
     */
    static produce(key: string): Genai.Agent.Tool.FinalAnswer.Config | null;

    /**
     * Should produces the entire content for the cached data. Will populate the cache with the produced data.
     */
    static produceAll(): Map_Type<string, Genai.Agent.Tool.FinalAnswer.Config> | null;
     ...
     */
    getConfig(): Genai.Agent.Tool.FinalAnswer.Config;
     ...
     */
    getSecret(): Genai.Agent.Tool.FinalAnswer.Config;
     ...
     */
    withConfigKey(configKey: string): Genai.Agent.Tool.FinalAnswer.Config;

    /**
     * @return copy without config key.
     */
    withoutConfigKey(): Genai.Agent.Tool.FinalAnswer.Config;

    /**
     * @return return cached config instance for provided config key.
     */
    static forConfigKey(configKey: string): Genai.Agent.Tool.FinalAnswer.Config | null;
     ...
     */
    static listConfigs(parallel?: boolean, filter?: λPredicate<string>): Stream<Genai.Agent.Tool.FinalAnswer.Config> | null;
     ...
     * @see setConfigValue
     */
    setConfigValues(from: Genai.Agent.Tool.FinalAnswer.Config, override?: string): void;
     ...
     */
    static loadConfigAndSecret(configKey: string): Genai.Agent.Tool.FinalAnswer.Config | null;
