// TypeScript definitions for the C3 type Genai.Agent.DynamicTrajectory.Step

/**
 * A step in a {@link Genai.Agent.DynamicTrajectory.StepSequence}.
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.Agent.DynamicTrajectory.Step
 */
declare namespace Genai.Agent.DynamicTrajectory {
  export interface IStep {
     ...
     */
    output?: any | Array_Type<Genai.Agent.DynamicData> | Array<IGenai.Agent.DynamicData>;
     ...
     */
    trajectory?: IGenai.Agent.DynamicTrajectory;
     ...
     */
    tag?: IGenai.Agent.DynamicTrajectory.Step.Tag;
     ...
     */
    toolsUsed?: Array_Type<Genai.Agent.Dynamic.Tool.UiConfig> | Array<IGenai.Agent.Dynamic.Tool.UiConfig>;
 ...
 */
declare namespace Genai.Agent.DynamicTrajectory {
  export class Step extends Obj  {

    /**
     * The id of the step.
     */
    readonly stepId?: string;
    withStepId(stepId: string | null): Genai.Agent.DynamicTrajectory.Step;

    /**
     * The output of the step.
     */
    readonly output?: any | Array_Type<Genai.Agent.DynamicData>;
    withOutput(output: any | Array_Type<Genai.Agent.DynamicData> | Array<IGenai.Agent.DynamicData> | null): Genai.Agent.DynamicTrajectory.Step;

    /**
     * The status of the step
     */
    readonly status?: string;
    withStatus(status: string | null): Genai.Agent.DynamicTrajectory.Step;

    /**
     * The logs for the step
     */
    readonly logs?: any;
    withLogs(logs: any | null): Genai.Agent.DynamicTrajectory.Step;
     ...
     */
    readonly id: string;
    withId(id: string): Genai.Agent.DynamicTrajectory.Step;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Genai.Agent.DynamicTrajectory.Step;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): Genai.Agent.DynamicTrajectory.Step;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): Genai.Agent.DynamicTrajectory.Step;
    ...
    withVersion(version: number | null): Genai.Agent.DynamicTrajectory.Step;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): Genai.Agent.DynamicTrajectory.Step;

    /**
     * The agent that this step is associated to.
     */
    readonly agentName: string;
    withAgentName(agentName: string): Genai.Agent.DynamicTrajectory.Step;

    /**
     * The trajectory that this step is a part of.
     */
    readonly trajectory?: Genai.Agent.DynamicTrajectory;
    withTrajectory(trajectory: IGenai.Agent.DynamicTrajectory | null): Genai.Agent.DynamicTrajectory.Step;

    /**
     * The llm-generated content of this step, which may include code, a plan, or the final answer.
     */
    readonly content?: string;
    withContent(content: string | null): Genai.Agent.DynamicTrajectory.Step;

    /**
     * The tag indicating the type of content in this step.
     */
    readonly tag?: Genai.Agent.DynamicTrajectory.Step.Tag;
    withTag(tag: IGenai.Agent.DynamicTrajectory.Step.Tag | null): Genai.Agent.DynamicTrajectory.Step;

    /**
     * The query or command for this step.
     */
    readonly query?: string;
    withQuery(query: string | null): Genai.Agent.DynamicTrajectory.Step;

    /**
     * Label used when printing the stdout of the code execution
     */
    readonly stdoutLabel?: string;
    withStdoutLabel(stdoutLabel: string | null): Genai.Agent.DynamicTrajectory.Step;

    /**
     * The tools that were used in this step.
     */
    readonly toolsUsed?: Array_Type<Genai.Agent.Dynamic.Tool.UiConfig>;
    withToolsUsed(toolsUsed: Array_Type<Genai.Agent.Dynamic.Tool.UiConfig> | Array<IGenai.Agent.Dynamic.Tool.UiConfig> | null): Genai.Agent.DynamicTrajectory.Step;

    /**
     * The files were used as part of the rationale to generate the answer.
     */
    readonly rationaleSources?: Array_Type<Genai.Query.ResultToSourceFileRelation>;
    withRationaleSources(rationaleSources: Array_Type<Genai.Query.ResultToSourceFileRelation> | Array<IGenai.Query.ResultToSourceFileRelation> | null): Genai.Agent.DynamicTrajectory.Step;
    ...
    withSourceRelations(sourceRelations: Array_Type<Genai.Query.ResultToSourceRelation> | Array<IGenai.Query.ResultToSourceRelation> | null): Genai.Agent.DynamicTrajectory.Step;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.Agent.DynamicTrajectory.Step | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.Agent.DynamicTrajectory.Step | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.Agent.DynamicTrajectory.Step | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.Agent.DynamicTrajectory.Step | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.Agent.DynamicTrajectory.Step;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Agent.DynamicTrajectory.Step;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Agent.DynamicTrajectory.Step;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Agent.DynamicTrajectory.Step>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Agent.DynamicTrajectory.Step>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.Agent.DynamicTrajectory.Step;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Agent.DynamicTrajectory.Step;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Agent.DynamicTrajectory.Step;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.Agent.DynamicTrajectory.Step;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.Agent.DynamicTrajectory.Step;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.Agent.DynamicTrajectory.Step;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.Agent.DynamicTrajectory.Step;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.Agent.DynamicTrajectory.Step;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.Agent.DynamicTrajectory.Step;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.Agent.DynamicTrajectory.Step;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.Agent.DynamicTrajectory.Step;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.Agent.DynamicTrajectory.Step;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.Agent.DynamicTrajectory.Step;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.Agent.DynamicTrajectory.Step;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.Agent.DynamicTrajectory.Step;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.Agent.DynamicTrajectory.Step;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.Agent.DynamicTrajectory.Step;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.Agent.DynamicTrajectory.Step;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.Agent.DynamicTrajectory.Step;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.Agent.DynamicTrajectory.Step;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.Agent.DynamicTrajectory.Step;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.Agent.DynamicTrajectory.Step;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.Agent.DynamicTrajectory.Step;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.Agent.DynamicTrajectory.Step;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.Agent.DynamicTrajectory.Step;

    mergeJson(json: any): Genai.Agent.DynamicTrajectory.Step;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.Agent.DynamicTrajectory.Step;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.Agent.DynamicTrajectory.Step;
     ...
     */
    singletonArray(): Array_Type<Genai.Agent.DynamicTrajectory.Step>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.Agent.DynamicTrajectory.Step> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.Agent.DynamicTrajectory.Step> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.Agent.DynamicTrajectory.Step>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.Agent.DynamicTrajectory.Step> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.Agent.DynamicTrajectory.Step> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.Agent.DynamicTrajectory.Step> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.Agent.DynamicTrajectory.Step>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.Agent.DynamicTrajectory.Step>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.Agent.DynamicTrajectory.Step;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.Agent.DynamicTrajectory.Step;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.Agent.DynamicTrajectory.Step;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.Agent.DynamicTrajectory.Step;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.Agent.DynamicTrajectory.Step;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.Agent.DynamicTrajectory.Step;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.Agent.DynamicTrajectory.Step | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.Agent.DynamicTrajectory.Step;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.Agent.DynamicTrajectory.Step;
     ...
     */
    static cachedEmptyInst(): Genai.Agent.DynamicTrajectory.Step;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.Agent.DynamicTrajectory.Step> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.Agent.DynamicTrajectory.Step;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<Genai.Agent.DynamicTrajectory.Step>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Genai.Agent.DynamicTrajectory.Step>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<Genai.Agent.DynamicTrajectory.Step> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Genai.Agent.DynamicTrajectory.Step>> | null;
     ...
     */
    get(include?: string): Genai.Agent.DynamicTrajectory.Step | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): Genai.Agent.DynamicTrajectory.Step | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Genai.Agent.DynamicTrajectory.Step;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): Genai.Agent.DynamicTrajectory.Step | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Genai.Agent.DynamicTrajectory.Step;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.Agent.DynamicTrajectory.Step | null;
     ...
     */
    create(spec?: UpsertSpec): Genai.Agent.DynamicTrajectory.Step | null;
     ...
     */
    static createBatch(objs: Array_Type<Genai.Agent.DynamicTrajectory.Step>, spec?: UpsertSpec): ObjList<Genai.Agent.DynamicTrajectory.Step> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Genai.Agent.DynamicTrajectory.Step>, spec?: CreateBatchObjStreamSpec): ObjList<Genai.Agent.DynamicTrajectory.Step> | null;
     ...
     */
    update(srcObj?: Genai.Agent.DynamicTrajectory.Step, spec?: UpsertSpec): Genai.Agent.DynamicTrajectory.Step | null;
     ...
     */
    upsert(srcObj?: Genai.Agent.DynamicTrajectory.Step, spec?: UpsertSpec): Genai.Agent.DynamicTrajectory.Step | null;
     ...
     */
    merge(spec?: MergeSpec): Genai.Agent.DynamicTrajectory.Step | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): Genai.Agent.DynamicTrajectory.Step | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): Genai.Agent.DynamicTrajectory.Step | null;
     ...
     */
    static updateBatch(objs: Array_Type<Genai.Agent.DynamicTrajectory.Step>, srcObjs?: Array_Type<Genai.Agent.DynamicTrajectory.Step>, spec?: UpsertSpec): ObjList<Genai.Agent.DynamicTrajectory.Step> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<Genai.Agent.DynamicTrajectory.Step> | null>, spec?: UpsertSpec): ObjList<Genai.Agent.DynamicTrajectory.Step> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<Genai.Agent.DynamicTrajectory.Step>, srcObjs?: Array_Type<Genai.Agent.DynamicTrajectory.Step>, spec?: UpsertSpec): ObjList<Genai.Agent.DynamicTrajectory.Step> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<Genai.Agent.DynamicTrajectory.Step> | null>, spec?: UpsertSpec): ObjList<Genai.Agent.DynamicTrajectory.Step> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<Genai.Agent.DynamicTrajectory.Step>, spec?: TouchSpec): ObjList<Genai.Agent.DynamicTrajectory.Step> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.Agent.DynamicTrajectory.Step>, spec?: MergeSpec): ObjList<Genai.Agent.DynamicTrajectory.Step> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.Agent.DynamicTrajectory.Step>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.Agent.DynamicTrajectory.Step> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<Genai.Agent.DynamicTrajectory.Step> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.Agent.DynamicTrajectory.Step> | null;
     ...
     */
    static mergeAll(mergeObj: Genai.Agent.DynamicTrajectory.Step, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Genai.Agent.DynamicTrajectory.Step, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<Genai.Agent.DynamicTrajectory.Step>, spec?: UpsertSpec): ObjList<Genai.Agent.DynamicTrajectory.Step> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<Genai.Agent.DynamicTrajectory.Step>, spec?: UpsertSpec): ObjList<Genai.Agent.DynamicTrajectory.Step> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): Genai.Agent.DynamicTrajectory.Step | null;
     ...
     */
    static beforeCreate(objs: Array_Type<Genai.Agent.DynamicTrajectory.Step>): ObjList<Genai.Agent.DynamicTrajectory.Step>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<Genai.Agent.DynamicTrajectory.Step>): ObjList<Genai.Agent.DynamicTrajectory.Step>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<Genai.Agent.DynamicTrajectory.Step>): ObjList<Genai.Agent.DynamicTrajectory.Step>;
     ...
     */
    static afterCreate(objs: Array_Type<Genai.Agent.DynamicTrajectory.Step>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<Genai.Agent.DynamicTrajectory.Step>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<Genai.Agent.DynamicTrajectory.Step>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<Genai.Agent.DynamicTrajectory.Step>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Genai.Agent.DynamicTrajectory.Step>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Genai.Agent.DynamicTrajectory.Step | null;
     ...
     */
    withoutIdentity(): Genai.Agent.DynamicTrajectory.Step | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<Genai.Agent.DynamicTrajectory.Step>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: Genai.Agent.DynamicTrajectory.Step, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<Genai.Agent.DynamicTrajectory.Step>, callback?: λFunction<Genai.Agent.DynamicTrajectory.Step | null, Genai.Agent.DynamicTrajectory.Step | null>): ObjList<Genai.Agent.DynamicTrajectory.Step>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<Genai.Agent.DynamicTrajectory.Step>, callback?: λFunction<Genai.Agent.DynamicTrajectory.Step | null, Genai.Agent.DynamicTrajectory.Step | null>): Array_Type<ObjError> | null;
     ...
     */
    static lastStepForAgent(agentName: string, trajectory: Genai.Agent.DynamicTrajectory): Genai.Agent.DynamicTrajectory.Step | null;
  }
}
