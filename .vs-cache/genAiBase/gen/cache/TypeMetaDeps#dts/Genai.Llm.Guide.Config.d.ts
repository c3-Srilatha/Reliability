// TypeScript definitions for the C3 type Genai.Llm.Guide.Config

/**
 * Config for {@link Genai.Llm.Guide} to define the model to use for guidance
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.Llm.Guide.Config
 */
...
declare namespace Genai.Llm.Guide {
  export class Config extends Obj  {
    ...
    withName(name: string): Genai.Llm.Guide.Config;
    ...
    withConfigOverride(configOverride: string | null): Genai.Llm.Guide.Config;

    static readonly configOverride?: string;

    readonly secretOverride?: string;
    withSecretOverride(secretOverride: string | null): Genai.Llm.Guide.Config;
    ...
    withIssues(issues: Array_Type<string> | Array<string> | null): Genai.Llm.Guide.Config;
    ...
    withModelConfigName(modelConfigName: string): Genai.Llm.Guide.Config;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.Llm.Guide.Config | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.Llm.Guide.Config | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.Llm.Guide.Config | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.Llm.Guide.Config | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.Llm.Guide.Config;
     ...
     * This method is used during live metadata update
     */
    static replaceType(old: Type, new_: Type): Genai.Llm.Guide.Config;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Llm.Guide.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Llm.Guide.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Llm.Guide.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Llm.Guide.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Llm.Guide.Config>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Llm.Guide.Config>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Llm.Guide.Config>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Llm.Guide.Config>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.Llm.Guide.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.Llm.Guide.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Llm.Guide.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Llm.Guide.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Llm.Guide.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Llm.Guide.Config;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.Llm.Guide.Config;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    static validateObj(): Genai.Llm.Guide.Config;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.Llm.Guide.Config;
     ...
     * @see #defaultField
     */
    static withField(field: string, value: any, doNotConvert?: boolean): Genai.Llm.Guide.Config;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.Llm.Guide.Config;
     ...
     * @see #defaultField
     */
    static withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.Llm.Guide.Config;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.Llm.Guide.Config;
     ...
     * @return new Obj
     */
    static withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.Llm.Guide.Config;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.Llm.Guide.Config;
     ...
     * @return new Obj
     */
    static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.Llm.Guide.Config;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.Llm.Guide.Config;
     ...
     * @see #withoutField
     */
    static withoutFieldAtPath(path: string): Genai.Llm.Guide.Config;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.Llm.Guide.Config;
     ...
     * @see #removeField
     */
    static withoutField(field: string): Genai.Llm.Guide.Config;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.Llm.Guide.Config;
     ...
     * @see #removeField
     */
    static withoutField(field: FieldType): Genai.Llm.Guide.Config;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.Llm.Guide.Config;
     ...
     * @return new Obj with removed fields
     */
    static withoutFields(fields: Array_Type<string>): Genai.Llm.Guide.Config;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.Llm.Guide.Config;
     ...
     * @return new Obj with removed fields
     */
    static withoutFieldsByType(fields: Array_Type<FieldType>): Genai.Llm.Guide.Config;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.Llm.Guide.Config;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    static withoutSecretFields(): Genai.Llm.Guide.Config;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.Llm.Guide.Config;
     ...
     * @see FieldType#defaultValue
     */
    static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.Llm.Guide.Config;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.Llm.Guide.Config;
     ...
     * @see #unsetField
     */
    static defaultField(field: string): Genai.Llm.Guide.Config;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.Llm.Guide.Config;
     ...
     * @see #unsetField
     */
    static defaultField(field: FieldType): Genai.Llm.Guide.Config;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.Llm.Guide.Config;
     ...
     * @see #removeField
     */
    static unsetField(field: string): Genai.Llm.Guide.Config;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.Llm.Guide.Config;
     ...
     * @see #removeField
     */
    static unsetField(field: FieldType): Genai.Llm.Guide.Config;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.Llm.Guide.Config;
     ...
     * @see #unsetField
     */
    static removeField(field: string): Genai.Llm.Guide.Config;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.Llm.Guide.Config;
     ...
     * @see #unsetField
     */
    static removeField(field: FieldType): Genai.Llm.Guide.Config;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.Llm.Guide.Config;
     ...
     * @return the new merged Obj
     */
    static mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.Llm.Guide.Config;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.Llm.Guide.Config;
     ...
     * @return the new merged Obj
     */
    static mergeObj(other: Obj, otherFieldsFilter: Type): Genai.Llm.Guide.Config;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.Llm.Guide.Config;
     ...
     *        the same key or index.
     */
    static mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.Llm.Guide.Config;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.Llm.Guide.Config;
     ...
     * traverse child reference and collection fields.
     */
    static mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.Llm.Guide.Config;

    mergeJson(json: any): Genai.Llm.Guide.Config;

    static mergeJson(json: any): Genai.Llm.Guide.Config;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.Llm.Guide.Config;
     ...
     * @return Obj with child references merged
     */
    static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.Llm.Guide.Config;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.Llm.Guide.Config;
     ...
     * references with same name and collection elements at same index or key.
     */
    static sumObj(other: Obj, deep?: boolean): Genai.Llm.Guide.Config;
     ...
     */
    singletonArray(): Array_Type<Genai.Llm.Guide.Config>;
     ...
     * @return new array instance with this as only element.
     */
    static singletonArray(): Array_Type<Genai.Llm.Guide.Config>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.Llm.Guide.Config> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.Llm.Guide.Config> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.Llm.Guide.Config>;
     ...
     * @return new array instance with this as only element.
     */
    static singletonSet(): Set_Type<Genai.Llm.Guide.Config>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.Llm.Guide.Config> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.Llm.Guide.Config> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.Llm.Guide.Config> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.Llm.Guide.Config>;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    static toBuilder(): ObjBuilder<Genai.Llm.Guide.Config>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.Llm.Guide.Config>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.Llm.Guide.Config;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.Llm.Guide.Config;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.Llm.Guide.Config;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.Llm.Guide.Config;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.Llm.Guide.Config;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.Llm.Guide.Config;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.Llm.Guide.Config | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.Llm.Guide.Config;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.Llm.Guide.Config;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    static afterMake(): Genai.Llm.Guide.Config;
     ...
     */
    static cachedEmptyInst(): Genai.Llm.Guide.Config;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.Llm.Guide.Config> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.Llm.Guide.Config;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.Llm.Guide.Config | null;
     ...
     */
    static forName(name: string, failIfMissing?: boolean): Genai.Llm.Guide.Config | null;
     ...
     */
    static inst(): Genai.Llm.Guide.Config;
     ...
     */
    static allCached(): Stream<Genai.Llm.Guide.Config> | null;
     ...
     */
    static find(filter?: string): Stream<Genai.Llm.Guide.Config> | null;
     ...
     *         Otherwise no population will be performed.
     */
    static findBy(field: string, value: any): Stream<Genai.Llm.Guide.Config> | null;

    /**
     * @return cached instance.
     */
    getCached(): Genai.Llm.Guide.Config | null;

    /**
     * @return cached instance.
     */
    static getCached(): Genai.Llm.Guide.Config | null;

    /**
     * Returns cached instance by key, with secrets removed.
     */
    static forCacheKey(key: string): Genai.Llm.Guide.Config | null;
     ...
     */
    static produce(key: string): Genai.Llm.Guide.Config | null;

    /**
     * Should produces the entire content for the cached data. Will populate the cache with the produced data.
     */
    static produceAll(): Map_Type<string, Genai.Llm.Guide.Config> | null;
     ...
     */
    getConfig(): Genai.Llm.Guide.Config;
     ...
     * Note that typical pattern is to use Configurable#config instead of this method.
     */
    static getConfig(): Genai.Llm.Guide.Config;
     ...
     */
    getSecret(): Genai.Llm.Guide.Config;
     ...
     * Note that typical pattern is to use Configurable#configWithSecrets instead of this method.
     */
    static getSecret(): Genai.Llm.Guide.Config;
     ...
     */
    withConfigKey(configKey: string): Genai.Llm.Guide.Config;
     ...
     *     config.configKey() => "folder1/abc"
     */
    static withConfigKey(configKey: string): Genai.Llm.Guide.Config;

    /**
     * @return copy without config key.
     */
    withoutConfigKey(): Genai.Llm.Guide.Config;

    /**
     * @return copy without config key.
     */
    static withoutConfigKey(): Genai.Llm.Guide.Config;

    /**
     * @return return cached config instance for provided config key.
     */
    static forConfigKey(configKey: string): Genai.Llm.Guide.Config | null;
     ...
     */
    static listConfigs(parallel?: boolean, filter?: λPredicate<string>): Stream<Genai.Llm.Guide.Config> | null;
     ...
     * @see setConfigValue
     */
    setConfigValues(from: Genai.Llm.Guide.Config, override?: string): void;
     ...
     * @see setConfigValue
     */
    static setConfigValues(from: Genai.Llm.Guide.Config, override?: string): void;
     ...
     */
    static loadConfigAndSecret(configKey: string): Genai.Llm.Guide.Config | null;
     ...
     */
    removeSecrets(): Genai.Llm.Guide.Config | null;

    /**
     * @return this config without any secret values.
     */
    static removeSecrets(): Genai.Llm.Guide.Config | null;

    /**
     * @return this config with only secret values.
     */
    removeNonSecrets(): Genai.Llm.Guide.Config | null;

    /**
     * @return this config with only secret values.
     */
    static removeNonSecrets(): Genai.Llm.Guide.Config | null;

    /**
     * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
     * validation and setup.
     */
    validate(): Genai.Llm.Guide.Config;

    /**
     * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
     * validation and setup.
     */
    static validate(): Genai.Llm.Guide.Config;
     ...
     */
    static setRecursive(configJson: any, useSetConfigValues?: boolean, override?: string): Genai.Llm.Guide.Config;
