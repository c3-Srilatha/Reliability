// TypeScript definitions for the C3 type Genai.Mail.MailToTemplate

/**
 * An email template that can be used to populate a `mailto` link in the UI.
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.Mail.MailToTemplate
 */
declare namespace Genai.Mail {
  export interface IMailToTemplate {
 ...
 */
declare namespace Genai.Mail {
  export class MailToTemplate extends Obj  {
     ...
     */
    readonly id: string;
    withId(id: string): Genai.Mail.MailToTemplate;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Genai.Mail.MailToTemplate;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): Genai.Mail.MailToTemplate;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): Genai.Mail.MailToTemplate;
    ...
    withVersion(version: number | null): Genai.Mail.MailToTemplate;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): Genai.Mail.MailToTemplate;

    /**
     * Who the email should be sent to
     */
    readonly to?: string;
    withTo(to: string | null): Genai.Mail.MailToTemplate;

    /**
     * The email subject
     */
    readonly subject?: string;
    withSubject(subject: string | null): Genai.Mail.MailToTemplate;

    /**
     * The email body
     */
    readonly body?: string;
    withBody(body: string | null): Genai.Mail.MailToTemplate;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.Mail.MailToTemplate | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.Mail.MailToTemplate | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.Mail.MailToTemplate | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.Mail.MailToTemplate | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.Mail.MailToTemplate;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Mail.MailToTemplate;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Mail.MailToTemplate;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Mail.MailToTemplate>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Mail.MailToTemplate>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.Mail.MailToTemplate;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Mail.MailToTemplate;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Mail.MailToTemplate;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.Mail.MailToTemplate;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.Mail.MailToTemplate;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.Mail.MailToTemplate;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.Mail.MailToTemplate;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.Mail.MailToTemplate;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.Mail.MailToTemplate;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.Mail.MailToTemplate;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.Mail.MailToTemplate;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.Mail.MailToTemplate;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.Mail.MailToTemplate;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.Mail.MailToTemplate;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.Mail.MailToTemplate;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.Mail.MailToTemplate;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.Mail.MailToTemplate;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.Mail.MailToTemplate;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.Mail.MailToTemplate;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.Mail.MailToTemplate;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.Mail.MailToTemplate;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.Mail.MailToTemplate;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.Mail.MailToTemplate;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.Mail.MailToTemplate;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.Mail.MailToTemplate;

    mergeJson(json: any): Genai.Mail.MailToTemplate;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.Mail.MailToTemplate;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.Mail.MailToTemplate;
     ...
     */
    singletonArray(): Array_Type<Genai.Mail.MailToTemplate>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.Mail.MailToTemplate> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.Mail.MailToTemplate> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.Mail.MailToTemplate>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.Mail.MailToTemplate> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.Mail.MailToTemplate> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.Mail.MailToTemplate> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.Mail.MailToTemplate>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.Mail.MailToTemplate>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.Mail.MailToTemplate;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.Mail.MailToTemplate;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.Mail.MailToTemplate;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.Mail.MailToTemplate;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.Mail.MailToTemplate;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.Mail.MailToTemplate;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.Mail.MailToTemplate | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.Mail.MailToTemplate;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.Mail.MailToTemplate;
     ...
     */
    static cachedEmptyInst(): Genai.Mail.MailToTemplate;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.Mail.MailToTemplate> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.Mail.MailToTemplate;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<Genai.Mail.MailToTemplate>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Genai.Mail.MailToTemplate>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<Genai.Mail.MailToTemplate> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Genai.Mail.MailToTemplate>> | null;
     ...
     */
    get(include?: string): Genai.Mail.MailToTemplate | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): Genai.Mail.MailToTemplate | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Genai.Mail.MailToTemplate;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): Genai.Mail.MailToTemplate | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Genai.Mail.MailToTemplate;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.Mail.MailToTemplate | null;
     ...
     */
    create(spec?: UpsertSpec): Genai.Mail.MailToTemplate | null;
     ...
     */
    static createBatch(objs: Array_Type<Genai.Mail.MailToTemplate>, spec?: UpsertSpec): ObjList<Genai.Mail.MailToTemplate> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Genai.Mail.MailToTemplate>, spec?: CreateBatchObjStreamSpec): ObjList<Genai.Mail.MailToTemplate> | null;
     ...
     */
    update(srcObj?: Genai.Mail.MailToTemplate, spec?: UpsertSpec): Genai.Mail.MailToTemplate | null;
     ...
     */
    upsert(srcObj?: Genai.Mail.MailToTemplate, spec?: UpsertSpec): Genai.Mail.MailToTemplate | null;
     ...
     */
    merge(spec?: MergeSpec): Genai.Mail.MailToTemplate | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): Genai.Mail.MailToTemplate | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): Genai.Mail.MailToTemplate | null;
     ...
     */
    static updateBatch(objs: Array_Type<Genai.Mail.MailToTemplate>, srcObjs?: Array_Type<Genai.Mail.MailToTemplate>, spec?: UpsertSpec): ObjList<Genai.Mail.MailToTemplate> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<Genai.Mail.MailToTemplate> | null>, spec?: UpsertSpec): ObjList<Genai.Mail.MailToTemplate> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<Genai.Mail.MailToTemplate>, srcObjs?: Array_Type<Genai.Mail.MailToTemplate>, spec?: UpsertSpec): ObjList<Genai.Mail.MailToTemplate> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<Genai.Mail.MailToTemplate> | null>, spec?: UpsertSpec): ObjList<Genai.Mail.MailToTemplate> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<Genai.Mail.MailToTemplate>, spec?: TouchSpec): ObjList<Genai.Mail.MailToTemplate> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.Mail.MailToTemplate>, spec?: MergeSpec): ObjList<Genai.Mail.MailToTemplate> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.Mail.MailToTemplate>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.Mail.MailToTemplate> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<Genai.Mail.MailToTemplate> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.Mail.MailToTemplate> | null;
     ...
     */
    static mergeAll(mergeObj: Genai.Mail.MailToTemplate, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Genai.Mail.MailToTemplate, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<Genai.Mail.MailToTemplate>, spec?: UpsertSpec): ObjList<Genai.Mail.MailToTemplate> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<Genai.Mail.MailToTemplate>, spec?: UpsertSpec): ObjList<Genai.Mail.MailToTemplate> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): Genai.Mail.MailToTemplate | null;
     ...
     */
    static beforeCreate(objs: Array_Type<Genai.Mail.MailToTemplate>): ObjList<Genai.Mail.MailToTemplate>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<Genai.Mail.MailToTemplate>): ObjList<Genai.Mail.MailToTemplate>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<Genai.Mail.MailToTemplate>): ObjList<Genai.Mail.MailToTemplate>;
     ...
     */
    static afterCreate(objs: Array_Type<Genai.Mail.MailToTemplate>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<Genai.Mail.MailToTemplate>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<Genai.Mail.MailToTemplate>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<Genai.Mail.MailToTemplate>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Genai.Mail.MailToTemplate>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Genai.Mail.MailToTemplate | null;
     ...
     */
    withoutIdentity(): Genai.Mail.MailToTemplate | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<Genai.Mail.MailToTemplate>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: Genai.Mail.MailToTemplate, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<Genai.Mail.MailToTemplate>, callback?: λFunction<Genai.Mail.MailToTemplate | null, Genai.Mail.MailToTemplate | null>): ObjList<Genai.Mail.MailToTemplate>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<Genai.Mail.MailToTemplate>, callback?: λFunction<Genai.Mail.MailToTemplate | null, Genai.Mail.MailToTemplate | null>): Array_Type<ObjError> | null;
     ...
     */
    static generateMailToLink(mailToTemplate?: Genai.Mail.MailToTemplate): string | null;
  }
}
