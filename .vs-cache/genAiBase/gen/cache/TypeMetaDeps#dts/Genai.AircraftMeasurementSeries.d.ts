// TypeScript definitions for the C3 type Genai.AircraftMeasurementSeries

/**
 * An aircraft sensor measurement series.
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.AircraftMeasurementSeries
 */
declare namespace Genai {
  export interface IAircraftMeasurementSeries {
     ...
     */
    data?: Array_Type<Genai.AircraftMeasurement> | Array<IGenai.AircraftMeasurement>;
 ...
 */
declare namespace Genai {
  export class AircraftMeasurementSeries extends Obj  {

    /**
     * Populated on normalization. Indicates the earliest data point across various timeseries fields.
     */
    readonly earliest?: DateTime;
    withEarliest(earliest: DateTime | Date | string | null): Genai.AircraftMeasurementSeries;

    /**
     * Populated on normalization. Indicates the latest data point across various timeseries fields.
     */
    readonly latest?: DateTime;
    withLatest(latest: DateTime | Date | string | null): Genai.AircraftMeasurementSeries;

    /**
     * Populated on normalization. Indicates the earliest data point for each {@link Ann.Ts} fields.
     */
    readonly earliestTsDp?: Map_Type<string, TSDataPoint>;
    withEarliestTsDp(earliestTsDp: Map_Type<string, TSDataPoint> | {[key: string]: ITSDataPoint} | null): Genai.AircraftMeasurementSeries;

    /**
     * Populated on normalization. Indicates the latest data point for each {@link Ann.Ts} fields.
     */
    readonly latestTsDp?: Map_Type<string, TSDataPoint>;
    withLatestTsDp(latestTsDp: Map_Type<string, TSDataPoint> | {[key: string]: ITSDataPoint} | null): Genai.AircraftMeasurementSeries;
    ...
    withInterval(interval: string | null): Genai.AircraftMeasurementSeries;

    /**
     * If set, the time series will be normalized in the specified zone.
     */
    readonly timeZone?: string;
    withTimeZone(timeZone: string | null): Genai.AircraftMeasurementSeries;

    /**
     * If set, disables normalizing this time series. Invalidations will still continue to happen for this series normally.
     */
    readonly doNotNormalize?: boolean;
    withDoNotNormalize(doNotNormalize: boolean): Genai.AircraftMeasurementSeries;

    /**
     * Data points corresponding to this timeseries header
     */
    readonly data?: Array_Type<Genai.AircraftMeasurement>;
    withData(data: Array_Type<Genai.AircraftMeasurement> | Array<IGenai.AircraftMeasurement> | null): Genai.AircraftMeasurementSeries;

    /**
     * Use this field to specify the interpolation mechanism to be applied for gaps in interval timeseries. Default: `ZERO_INTERPOLATOR`.
     */
    readonly interpolator?: string;
    withInterpolator(interpolator: string | null): Genai.AircraftMeasurementSeries;

    /**
     * Use this field to specify how normalization should handle duplicate data points. A duplicate point is one that has the same start, end, value, unit, and {@link TimedDataPointFields#isEstimated} values. Default: `IGNORE`.
     */
    readonly duplicateHandling?: string;
    withDuplicateHandling(duplicateHandling: string | null): Genai.AircraftMeasurementSeries;

    /**
     * Used to specify how normalization should handle overlapping data points. Default: `AVG`.
     */
    readonly overlapHandling?: string;
    withOverlapHandling(overlapHandling: string | null): Genai.AircraftMeasurementSeries;
    ...
    withBucketInterval(bucketInterval: string | null): Genai.AircraftMeasurementSeries;
    ...
    withNormalizationPartitionStrategy(normalizationPartitionStrategy: INormalizationPartitionStrategy | null): Genai.AircraftMeasurementSeries;

    /**
     * Indicates whether the last data point should be repeated until infinity
     */
    readonly extrapolate?: boolean;
    withExtrapolate(extrapolate: boolean): Genai.AircraftMeasurementSeries;
     ...
     */
    readonly id: string;
    withId(id: string): Genai.AircraftMeasurementSeries;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Genai.AircraftMeasurementSeries;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): Genai.AircraftMeasurementSeries;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): Genai.AircraftMeasurementSeries;
    ...
    withVersion(version: number | null): Genai.AircraftMeasurementSeries;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): Genai.AircraftMeasurementSeries;

    /**
     * Genai.Aircraft the sensor belongs to.
     */
    readonly aircraft?: Genai.Aircraft;
    withAircraft(aircraft: IGenai.Aircraft | null): Genai.AircraftMeasurementSeries;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.AircraftMeasurementSeries | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.AircraftMeasurementSeries | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.AircraftMeasurementSeries | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.AircraftMeasurementSeries | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.AircraftMeasurementSeries;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.AircraftMeasurementSeries;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.AircraftMeasurementSeries;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.AircraftMeasurementSeries>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.AircraftMeasurementSeries>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.AircraftMeasurementSeries;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.AircraftMeasurementSeries;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.AircraftMeasurementSeries;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.AircraftMeasurementSeries;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.AircraftMeasurementSeries;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.AircraftMeasurementSeries;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.AircraftMeasurementSeries;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.AircraftMeasurementSeries;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.AircraftMeasurementSeries;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.AircraftMeasurementSeries;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.AircraftMeasurementSeries;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.AircraftMeasurementSeries;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.AircraftMeasurementSeries;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.AircraftMeasurementSeries;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.AircraftMeasurementSeries;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.AircraftMeasurementSeries;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.AircraftMeasurementSeries;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.AircraftMeasurementSeries;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.AircraftMeasurementSeries;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.AircraftMeasurementSeries;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.AircraftMeasurementSeries;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.AircraftMeasurementSeries;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.AircraftMeasurementSeries;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.AircraftMeasurementSeries;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.AircraftMeasurementSeries;

    mergeJson(json: any): Genai.AircraftMeasurementSeries;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.AircraftMeasurementSeries;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.AircraftMeasurementSeries;
     ...
     */
    singletonArray(): Array_Type<Genai.AircraftMeasurementSeries>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.AircraftMeasurementSeries> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.AircraftMeasurementSeries> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.AircraftMeasurementSeries>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.AircraftMeasurementSeries> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.AircraftMeasurementSeries> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.AircraftMeasurementSeries> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.AircraftMeasurementSeries>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.AircraftMeasurementSeries>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.AircraftMeasurementSeries;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.AircraftMeasurementSeries;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.AircraftMeasurementSeries;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.AircraftMeasurementSeries;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.AircraftMeasurementSeries;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.AircraftMeasurementSeries;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.AircraftMeasurementSeries | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.AircraftMeasurementSeries;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.AircraftMeasurementSeries;
     ...
     */
    static cachedEmptyInst(): Genai.AircraftMeasurementSeries;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.AircraftMeasurementSeries> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.AircraftMeasurementSeries;
     ...
     */
    static normalizeTimeseries(timeseries?: TimedDataFields<Genai.AircraftMeasurement>, start?: DateTime, end?: DateTime, overrideGrain?: string, forceGrainDetection?: boolean, force?: boolean): void;
     ...
     */
    static normalize(timeseries?: TimedDataFields<Genai.AircraftMeasurement>, start?: DateTime, end?: DateTime, overrideGrain?: string, forceGrainDetection?: boolean): NormalizationResult | null;
     ...
     */
    static normalizationUnit(rawHeader: TimedDataFields<Genai.AircraftMeasurement>, tsField: string): Unit | null;
     ...
     */
    static normalizationTreatment(rawHeader: TimedDataFields<Genai.AircraftMeasurement>, tsField: string): string;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<Genai.AircraftMeasurementSeries>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Genai.AircraftMeasurementSeries>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<Genai.AircraftMeasurementSeries> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Genai.AircraftMeasurementSeries>> | null;
     ...
     */
    get(include?: string): Genai.AircraftMeasurementSeries | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): Genai.AircraftMeasurementSeries | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Genai.AircraftMeasurementSeries;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): Genai.AircraftMeasurementSeries | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Genai.AircraftMeasurementSeries;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.AircraftMeasurementSeries | null;
     ...
     */
    create(spec?: UpsertSpec): Genai.AircraftMeasurementSeries | null;
     ...
     */
    static createBatch(objs: Array_Type<Genai.AircraftMeasurementSeries>, spec?: UpsertSpec): ObjList<Genai.AircraftMeasurementSeries> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Genai.AircraftMeasurementSeries>, spec?: CreateBatchObjStreamSpec): ObjList<Genai.AircraftMeasurementSeries> | null;
     ...
     */
    update(srcObj?: Genai.AircraftMeasurementSeries, spec?: UpsertSpec): Genai.AircraftMeasurementSeries | null;
     ...
     */
    upsert(srcObj?: Genai.AircraftMeasurementSeries, spec?: UpsertSpec): Genai.AircraftMeasurementSeries | null;
     ...
     */
    merge(spec?: MergeSpec): Genai.AircraftMeasurementSeries | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): Genai.AircraftMeasurementSeries | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): Genai.AircraftMeasurementSeries | null;
     ...
     */
    static updateBatch(objs: Array_Type<Genai.AircraftMeasurementSeries>, srcObjs?: Array_Type<Genai.AircraftMeasurementSeries>, spec?: UpsertSpec): ObjList<Genai.AircraftMeasurementSeries> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<Genai.AircraftMeasurementSeries> | null>, spec?: UpsertSpec): ObjList<Genai.AircraftMeasurementSeries> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<Genai.AircraftMeasurementSeries>, srcObjs?: Array_Type<Genai.AircraftMeasurementSeries>, spec?: UpsertSpec): ObjList<Genai.AircraftMeasurementSeries> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<Genai.AircraftMeasurementSeries> | null>, spec?: UpsertSpec): ObjList<Genai.AircraftMeasurementSeries> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<Genai.AircraftMeasurementSeries>, spec?: TouchSpec): ObjList<Genai.AircraftMeasurementSeries> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.AircraftMeasurementSeries>, spec?: MergeSpec): ObjList<Genai.AircraftMeasurementSeries> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.AircraftMeasurementSeries>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.AircraftMeasurementSeries> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<Genai.AircraftMeasurementSeries> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.AircraftMeasurementSeries> | null;
     ...
     */
    static mergeAll(mergeObj: Genai.AircraftMeasurementSeries, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Genai.AircraftMeasurementSeries, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<Genai.AircraftMeasurementSeries>, spec?: UpsertSpec): ObjList<Genai.AircraftMeasurementSeries> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<Genai.AircraftMeasurementSeries>, spec?: UpsertSpec): ObjList<Genai.AircraftMeasurementSeries> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): Genai.AircraftMeasurementSeries | null;
     ...
     */
    static beforeCreate(objs: Array_Type<Genai.AircraftMeasurementSeries>): ObjList<Genai.AircraftMeasurementSeries>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<Genai.AircraftMeasurementSeries>): ObjList<Genai.AircraftMeasurementSeries>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<Genai.AircraftMeasurementSeries>): ObjList<Genai.AircraftMeasurementSeries>;
     ...
     */
    static afterCreate(objs: Array_Type<Genai.AircraftMeasurementSeries>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<Genai.AircraftMeasurementSeries>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<Genai.AircraftMeasurementSeries>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<Genai.AircraftMeasurementSeries>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Genai.AircraftMeasurementSeries>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Genai.AircraftMeasurementSeries | null;
     ...
     */
    withoutIdentity(): Genai.AircraftMeasurementSeries | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<Genai.AircraftMeasurementSeries>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: Genai.AircraftMeasurementSeries, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<Genai.AircraftMeasurementSeries>, callback?: λFunction<Genai.AircraftMeasurementSeries | null, Genai.AircraftMeasurementSeries | null>): ObjList<Genai.AircraftMeasurementSeries>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<Genai.AircraftMeasurementSeries>, callback?: λFunction<Genai.AircraftMeasurementSeries | null, Genai.AircraftMeasurementSeries | null>): Array_Type<ObjError> | null;
