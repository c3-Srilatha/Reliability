// TypeScript definitions for the C3 type Genai.SourcePassage.ExpressionEngineFunction

/**
 * Type containing Expression Engine Functions for {@link Genai.SourcePassage}.
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.SourcePassage.ExpressionEngineFunction
 */
declare namespace Genai.SourcePassage {
...
declare namespace Genai.SourcePassage {
  export class ExpressionEngineFunction {
     ...
     */
    static getSourceType(isImageSource?: boolean, isTableSource?: boolean): string;
  }
}
