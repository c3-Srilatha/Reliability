// TypeScript definitions for the C3 type Genai.Query.ResultToStructuredDataSourceRelationPythonAgent

/**
 * Represents a relation between a query result and a source that was used to generate that result. This relation type
 * allows for a many-to-many relationship between query results and sources.
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.Query.ResultToStructuredDataSourceRelationPythonAgent
 */
declare namespace Genai.Query {
  export interface IResultToStructuredDataSourceRelationPythonAgent {
    ...
    /**
     * The {@link Genai.Query.Result} that this relation is associated with.
     */
    from?: IGenai.Query.Result;

    /**
     * The {@link Genai.Agent.DynamicTrajectory.Step} that this relation is associated with.
     */
    fromStep?: IGenai.Agent.DynamicTrajectory.Step;

    /**
     * The structured data source that was used to generate the query result.
     */
    to: IGenai.Query.Result.Source.StructuredData.PythonAgent;

    /**
     * Stores the order in which cited sources appear in the UI.
     *
     * NOTE: this is 1-indexed
     */
    passageUiDisplayIndex?: number;

    /**
     * An optional display name for the source. Useful for providing quick context for a default presentation of the
     * source in the UI.
     */
    displayName?: string;
  }
 ...
 * allows for a many-to-many relationship between query results and sources.
 *
 * @remarks this represents a made instance of Genai.Query.ResultToStructuredDataSourceRelationPythonAgent
 */
declare namespace Genai.Query {
  export class ResultToStructuredDataSourceRelationPythonAgent extends Obj  {
    ...
    withTypeIdent(typeIdent: string | null): Genai.Query.ResultToStructuredDataSourceRelationPythonAgent;
     ...
     */
    readonly id: string;
    withId(id: string): Genai.Query.ResultToStructuredDataSourceRelationPythonAgent;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Genai.Query.ResultToStructuredDataSourceRelationPythonAgent;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): Genai.Query.ResultToStructuredDataSourceRelationPythonAgent;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): Genai.Query.ResultToStructuredDataSourceRelationPythonAgent;
    ...
    withVersion(version: number | null): Genai.Query.ResultToStructuredDataSourceRelationPythonAgent;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): Genai.Query.ResultToStructuredDataSourceRelationPythonAgent;

    /**
     * The {@link Genai.Query.Result} that this relation is associated with.
     */
    readonly from?: Genai.Query.Result;
    withFrom(from: IGenai.Query.Result | null): Genai.Query.ResultToStructuredDataSourceRelationPythonAgent;

    /**
     * The {@link Genai.Agent.DynamicTrajectory.Step} that this relation is associated with.
     */
    readonly fromStep?: Genai.Agent.DynamicTrajectory.Step;
    withFromStep(fromStep: IGenai.Agent.DynamicTrajectory.Step | null): Genai.Query.ResultToStructuredDataSourceRelationPythonAgent;

    /**
     * The structured data source that was used to generate the query result.
     */
    readonly to: Genai.Query.Result.Source.StructuredData.PythonAgent;
    withTo(to: IGenai.Query.Result.Source.StructuredData.PythonAgent): Genai.Query.ResultToStructuredDataSourceRelationPythonAgent;
     ...
     * NOTE: this is 1-indexed
     */
    readonly passageUiDisplayIndex?: number;
    withPassageUiDisplayIndex(passageUiDisplayIndex: number | null): Genai.Query.ResultToStructuredDataSourceRelationPythonAgent;
    ...
    withDisplayName(displayName: string | null): Genai.Query.ResultToStructuredDataSourceRelationPythonAgent;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.Query.ResultToStructuredDataSourceRelationPythonAgent | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.Query.ResultToStructuredDataSourceRelationPythonAgent | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.Query.ResultToStructuredDataSourceRelationPythonAgent | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.Query.ResultToStructuredDataSourceRelationPythonAgent | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.Query.ResultToStructuredDataSourceRelationPythonAgent;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Query.ResultToStructuredDataSourceRelationPythonAgent;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Query.ResultToStructuredDataSourceRelationPythonAgent;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Query.ResultToStructuredDataSourceRelationPythonAgent>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Query.ResultToStructuredDataSourceRelationPythonAgent>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.Query.ResultToStructuredDataSourceRelationPythonAgent;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Query.ResultToStructuredDataSourceRelationPythonAgent;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Query.ResultToStructuredDataSourceRelationPythonAgent;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.Query.ResultToStructuredDataSourceRelationPythonAgent;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.Query.ResultToStructuredDataSourceRelationPythonAgent;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.Query.ResultToStructuredDataSourceRelationPythonAgent;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.Query.ResultToStructuredDataSourceRelationPythonAgent;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.Query.ResultToStructuredDataSourceRelationPythonAgent;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.Query.ResultToStructuredDataSourceRelationPythonAgent;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.Query.ResultToStructuredDataSourceRelationPythonAgent;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.Query.ResultToStructuredDataSourceRelationPythonAgent;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.Query.ResultToStructuredDataSourceRelationPythonAgent;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.Query.ResultToStructuredDataSourceRelationPythonAgent;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.Query.ResultToStructuredDataSourceRelationPythonAgent;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.Query.ResultToStructuredDataSourceRelationPythonAgent;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.Query.ResultToStructuredDataSourceRelationPythonAgent;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.Query.ResultToStructuredDataSourceRelationPythonAgent;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.Query.ResultToStructuredDataSourceRelationPythonAgent;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.Query.ResultToStructuredDataSourceRelationPythonAgent;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.Query.ResultToStructuredDataSourceRelationPythonAgent;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.Query.ResultToStructuredDataSourceRelationPythonAgent;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.Query.ResultToStructuredDataSourceRelationPythonAgent;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.Query.ResultToStructuredDataSourceRelationPythonAgent;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.Query.ResultToStructuredDataSourceRelationPythonAgent;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.Query.ResultToStructuredDataSourceRelationPythonAgent;

    mergeJson(json: any): Genai.Query.ResultToStructuredDataSourceRelationPythonAgent;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.Query.ResultToStructuredDataSourceRelationPythonAgent;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.Query.ResultToStructuredDataSourceRelationPythonAgent;
     ...
     */
    singletonArray(): Array_Type<Genai.Query.ResultToStructuredDataSourceRelationPythonAgent>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.Query.ResultToStructuredDataSourceRelationPythonAgent> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.Query.ResultToStructuredDataSourceRelationPythonAgent> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.Query.ResultToStructuredDataSourceRelationPythonAgent>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.Query.ResultToStructuredDataSourceRelationPythonAgent> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.Query.ResultToStructuredDataSourceRelationPythonAgent> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.Query.ResultToStructuredDataSourceRelationPythonAgent> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.Query.ResultToStructuredDataSourceRelationPythonAgent>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.Query.ResultToStructuredDataSourceRelationPythonAgent>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.Query.ResultToStructuredDataSourceRelationPythonAgent;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.Query.ResultToStructuredDataSourceRelationPythonAgent;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.Query.ResultToStructuredDataSourceRelationPythonAgent;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.Query.ResultToStructuredDataSourceRelationPythonAgent;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.Query.ResultToStructuredDataSourceRelationPythonAgent;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.Query.ResultToStructuredDataSourceRelationPythonAgent;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.Query.ResultToStructuredDataSourceRelationPythonAgent | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.Query.ResultToStructuredDataSourceRelationPythonAgent;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.Query.ResultToStructuredDataSourceRelationPythonAgent;
     ...
     */
    static cachedEmptyInst(): Genai.Query.ResultToStructuredDataSourceRelationPythonAgent;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.Query.ResultToStructuredDataSourceRelationPythonAgent> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.Query.ResultToStructuredDataSourceRelationPythonAgent;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<Genai.Query.ResultToStructuredDataSourceRelationPythonAgent>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Genai.Query.ResultToStructuredDataSourceRelationPythonAgent>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<Genai.Query.ResultToStructuredDataSourceRelationPythonAgent> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Genai.Query.ResultToStructuredDataSourceRelationPythonAgent>> | null;
     ...
     */
    get(include?: string): Genai.Query.ResultToStructuredDataSourceRelationPythonAgent | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): Genai.Query.ResultToStructuredDataSourceRelationPythonAgent | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Genai.Query.ResultToStructuredDataSourceRelationPythonAgent;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): Genai.Query.ResultToStructuredDataSourceRelationPythonAgent | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Genai.Query.ResultToStructuredDataSourceRelationPythonAgent;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.Query.ResultToStructuredDataSourceRelationPythonAgent | null;
     ...
     */
    create(spec?: UpsertSpec): Genai.Query.ResultToStructuredDataSourceRelationPythonAgent | null;
     ...
     */
    static createBatch(objs: Array_Type<Genai.Query.ResultToStructuredDataSourceRelationPythonAgent>, spec?: UpsertSpec): ObjList<Genai.Query.ResultToStructuredDataSourceRelationPythonAgent> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Genai.Query.ResultToStructuredDataSourceRelationPythonAgent>, spec?: CreateBatchObjStreamSpec): ObjList<Genai.Query.ResultToStructuredDataSourceRelationPythonAgent> | null;
     ...
     */
    update(srcObj?: Genai.Query.ResultToStructuredDataSourceRelationPythonAgent, spec?: UpsertSpec): Genai.Query.ResultToStructuredDataSourceRelationPythonAgent | null;
     ...
     */
    upsert(srcObj?: Genai.Query.ResultToStructuredDataSourceRelationPythonAgent, spec?: UpsertSpec): Genai.Query.ResultToStructuredDataSourceRelationPythonAgent | null;
     ...
     */
    merge(spec?: MergeSpec): Genai.Query.ResultToStructuredDataSourceRelationPythonAgent | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): Genai.Query.ResultToStructuredDataSourceRelationPythonAgent | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): Genai.Query.ResultToStructuredDataSourceRelationPythonAgent | null;
     ...
     */
    static updateBatch(objs: Array_Type<Genai.Query.ResultToStructuredDataSourceRelationPythonAgent>, srcObjs?: Array_Type<Genai.Query.ResultToStructuredDataSourceRelationPythonAgent>, spec?: UpsertSpec): ObjList<Genai.Query.ResultToStructuredDataSourceRelationPythonAgent> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<Genai.Query.ResultToStructuredDataSourceRelationPythonAgent> | null>, spec?: UpsertSpec): ObjList<Genai.Query.ResultToStructuredDataSourceRelationPythonAgent> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<Genai.Query.ResultToStructuredDataSourceRelationPythonAgent>, srcObjs?: Array_Type<Genai.Query.ResultToStructuredDataSourceRelationPythonAgent>, spec?: UpsertSpec): ObjList<Genai.Query.ResultToStructuredDataSourceRelationPythonAgent> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<Genai.Query.ResultToStructuredDataSourceRelationPythonAgent> | null>, spec?: UpsertSpec): ObjList<Genai.Query.ResultToStructuredDataSourceRelationPythonAgent> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<Genai.Query.ResultToStructuredDataSourceRelationPythonAgent>, spec?: TouchSpec): ObjList<Genai.Query.ResultToStructuredDataSourceRelationPythonAgent> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.Query.ResultToStructuredDataSourceRelationPythonAgent>, spec?: MergeSpec): ObjList<Genai.Query.ResultToStructuredDataSourceRelationPythonAgent> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.Query.ResultToStructuredDataSourceRelationPythonAgent>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.Query.ResultToStructuredDataSourceRelationPythonAgent> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<Genai.Query.ResultToStructuredDataSourceRelationPythonAgent> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.Query.ResultToStructuredDataSourceRelationPythonAgent> | null;
     ...
     */
    static mergeAll(mergeObj: Genai.Query.ResultToStructuredDataSourceRelationPythonAgent, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Genai.Query.ResultToStructuredDataSourceRelationPythonAgent, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<Genai.Query.ResultToStructuredDataSourceRelationPythonAgent>, spec?: UpsertSpec): ObjList<Genai.Query.ResultToStructuredDataSourceRelationPythonAgent> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<Genai.Query.ResultToStructuredDataSourceRelationPythonAgent>, spec?: UpsertSpec): ObjList<Genai.Query.ResultToStructuredDataSourceRelationPythonAgent> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): Genai.Query.ResultToStructuredDataSourceRelationPythonAgent | null;
     ...
     */
    static beforeCreate(objs: Array_Type<Genai.Query.ResultToStructuredDataSourceRelationPythonAgent>): ObjList<Genai.Query.ResultToStructuredDataSourceRelationPythonAgent>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<Genai.Query.ResultToStructuredDataSourceRelationPythonAgent>): ObjList<Genai.Query.ResultToStructuredDataSourceRelationPythonAgent>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<Genai.Query.ResultToStructuredDataSourceRelationPythonAgent>): ObjList<Genai.Query.ResultToStructuredDataSourceRelationPythonAgent>;
     ...
     */
    static afterCreate(objs: Array_Type<Genai.Query.ResultToStructuredDataSourceRelationPythonAgent>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<Genai.Query.ResultToStructuredDataSourceRelationPythonAgent>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<Genai.Query.ResultToStructuredDataSourceRelationPythonAgent>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<Genai.Query.ResultToStructuredDataSourceRelationPythonAgent>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Genai.Query.ResultToStructuredDataSourceRelationPythonAgent>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Genai.Query.ResultToStructuredDataSourceRelationPythonAgent | null;
     ...
     */
    withoutIdentity(): Genai.Query.ResultToStructuredDataSourceRelationPythonAgent | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<Genai.Query.ResultToStructuredDataSourceRelationPythonAgent>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: Genai.Query.ResultToStructuredDataSourceRelationPythonAgent, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<Genai.Query.ResultToStructuredDataSourceRelationPythonAgent>, callback?: λFunction<Genai.Query.ResultToStructuredDataSourceRelationPythonAgent | null, Genai.Query.ResultToStructuredDataSourceRelationPythonAgent | null>): ObjList<Genai.Query.ResultToStructuredDataSourceRelationPythonAgent>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<Genai.Query.ResultToStructuredDataSourceRelationPythonAgent>, callback?: λFunction<Genai.Query.ResultToStructuredDataSourceRelationPythonAgent | null, Genai.Query.ResultToStructuredDataSourceRelationPythonAgent | null>): Array_Type<ObjError> | null;
    ...
    /**
     * Clones the relations from one {@link Genai.Query.Result} to another
     * @param srcResult
     *        The {@link Genai.Query.Result} to copy the passage relations from
     * @param destResult
     *        The {@link Genai.Query.Result} to copy the passage relations to
     * @return the cloned relations for the destResult
     */
    static cloneTo(srcResult: Genai.Query.Result, destResult: Genai.Query.Result): Array_Type<Genai.Query.ResultToStructuredDataSourceRelationPythonAgent>;

    /**
     * Helper function to clone and return all child relations to the parent query result
     * @param queryResult
     *           The {@link Genai.Query.Result} for which the relations from {@link Genai.Query.Result#childResults} have to be cloned
     * @return the list of relations for parent
     */
    static cloneRelationsToParent(queryResult: Genai.Query.Result): Array_Type<Genai.Query.ResultToStructuredDataSourceRelationPythonAgent> | null;

    /**
     * Helper function to clone the relations to the last {@link Genai.Agent.DynamicTrajectory.Step}.
     * Exposed only for testing purposes.
     * @param relations
     *        Array of {@link Genai.Query.Result.Relation}s to copy into the final step
     * @param step
     *        The {@link Genai.Agent.Trajectory.Step} for the final answer step
     * @param content
     *        The final answer string
     * @return
     *        A tuple containing the cloned relations and the updated final answer string
     */
    static cloneRelationsToTrajectory(relations?: Array_Type<Genai.Query.Result.Relation>, step: Genai.Agent.Trajectory.Step, content: string): Tuple | null;

    /**
     * Helper function to return all relations to the parent query result
     * @param queryResult
     *           The {@link Genai.Query.Result} for which the relations should be returned
     * @return the list of relations for parent
     */
    static relationsForParent(queryResult: Genai.Query.Result): Array_Type<Genai.Query.ResultToStructuredDataSourceRelationPythonAgent> | null;

    /**
     * Returns the ID of this relation that was given to the llm to use for citation.
     */
    llmCitationId(): string;

    /**
     * Optional details about the source. This field may be used to provide additional context about the source that can
     * be displayed in a popover/tooltip when the user hovers over the source in the UI. The returned string can be
     * formatted with HTML tags or Markdown to provide additional structure/style to the details presented in the popover.
     */
