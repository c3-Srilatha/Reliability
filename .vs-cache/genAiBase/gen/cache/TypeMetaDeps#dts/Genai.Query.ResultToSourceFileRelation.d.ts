// TypeScript definitions for the C3 type Genai.Query.ResultToSourceFileRelation

/**
 * Relationship indicating the {@link Genai.SourcePassage} was retrieved by the Query
 * Chain as a relevant file for the {@link Genai.Query.Result#searchQuery}
 * and that the passage was used by the language model as a source in the
 * {@link Genai.Query.Result#rationale}.
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.Query.ResultToSourceFileRelation
 */
declare namespace Genai.Query {
  export interface IResultToSourceFileRelation {
     ...
     *
     * An index of -1 means that the llm did not use this passage and therefore it did not appear in the UI.
     *
 ...
 * {@link Genai.Query.Result#rationale}.
 *
 * @remarks this represents a made instance of Genai.Query.ResultToSourceFileRelation
 */
declare namespace Genai.Query {
  export class ResultToSourceFileRelation extends Obj  {

    /**
     * The passage that was selected
     */
    readonly passage: Genai.SourcePassage;
    withPassage(passage: IGenai.SourcePassage): Genai.Query.ResultToSourceFileRelation;

    /**
     * The {@link Genai.SourceFile} that the #passage belongs to.
     */
    readonly sourceFile: Genai.SourceFile;
    withSourceFile(sourceFile: IGenai.SourceFile): Genai.Query.ResultToSourceFileRelation;

    /**
     * The result from attribution with corroboration for this source relation.
     */
    readonly sourceAttribution?: Array_Type<Genai.Agent.Tool.Util.Attributor.Segmentation.Source>;
    withSourceAttribution(sourceAttribution: Array_Type<Genai.Agent.Tool.Util.Attributor.Segmentation.Source> | Array<IGenai.Agent.Tool.Util.Attributor.Segmentation.Source> | null): Genai.Query.ResultToSourceFileRelation;
    ...
    withTypeIdent(typeIdent: string | null): Genai.Query.ResultToSourceFileRelation;
     ...
     */
    readonly id: string;
    withId(id: string): Genai.Query.ResultToSourceFileRelation;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Genai.Query.ResultToSourceFileRelation;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): Genai.Query.ResultToSourceFileRelation;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): Genai.Query.ResultToSourceFileRelation;
    ...
    withVersion(version: number | null): Genai.Query.ResultToSourceFileRelation;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): Genai.Query.ResultToSourceFileRelation;

    /**
     * The {@link Genai.Query.Result} that this relation is associated with.
     */
    readonly from?: Genai.Query.Result;
    withFrom(from: IGenai.Query.Result | null): Genai.Query.ResultToSourceFileRelation;

    /**
     * The {@link Genai.Agent.DynamicTrajectory.Step} that this relation is associated with.
     */
    readonly fromStep?: Genai.Agent.DynamicTrajectory.Step;
    withFromStep(fromStep: IGenai.Agent.DynamicTrajectory.Step | null): Genai.Query.ResultToSourceFileRelation;
    ...
    withPassageUiDisplayIndex(passageUiDisplayIndex: number | null): Genai.Query.ResultToSourceFileRelation;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.Query.ResultToSourceFileRelation | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.Query.ResultToSourceFileRelation | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.Query.ResultToSourceFileRelation | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.Query.ResultToSourceFileRelation | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.Query.ResultToSourceFileRelation;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Query.ResultToSourceFileRelation;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Query.ResultToSourceFileRelation;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Query.ResultToSourceFileRelation>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Query.ResultToSourceFileRelation>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.Query.ResultToSourceFileRelation;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Query.ResultToSourceFileRelation;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Query.ResultToSourceFileRelation;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.Query.ResultToSourceFileRelation;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.Query.ResultToSourceFileRelation;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.Query.ResultToSourceFileRelation;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.Query.ResultToSourceFileRelation;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.Query.ResultToSourceFileRelation;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.Query.ResultToSourceFileRelation;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.Query.ResultToSourceFileRelation;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.Query.ResultToSourceFileRelation;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.Query.ResultToSourceFileRelation;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.Query.ResultToSourceFileRelation;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.Query.ResultToSourceFileRelation;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.Query.ResultToSourceFileRelation;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.Query.ResultToSourceFileRelation;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.Query.ResultToSourceFileRelation;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.Query.ResultToSourceFileRelation;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.Query.ResultToSourceFileRelation;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.Query.ResultToSourceFileRelation;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.Query.ResultToSourceFileRelation;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.Query.ResultToSourceFileRelation;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.Query.ResultToSourceFileRelation;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.Query.ResultToSourceFileRelation;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.Query.ResultToSourceFileRelation;

    mergeJson(json: any): Genai.Query.ResultToSourceFileRelation;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.Query.ResultToSourceFileRelation;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.Query.ResultToSourceFileRelation;
     ...
     */
    singletonArray(): Array_Type<Genai.Query.ResultToSourceFileRelation>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.Query.ResultToSourceFileRelation> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.Query.ResultToSourceFileRelation> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.Query.ResultToSourceFileRelation>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.Query.ResultToSourceFileRelation> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.Query.ResultToSourceFileRelation> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.Query.ResultToSourceFileRelation> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.Query.ResultToSourceFileRelation>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.Query.ResultToSourceFileRelation>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.Query.ResultToSourceFileRelation;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.Query.ResultToSourceFileRelation;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.Query.ResultToSourceFileRelation;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.Query.ResultToSourceFileRelation;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.Query.ResultToSourceFileRelation;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.Query.ResultToSourceFileRelation;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.Query.ResultToSourceFileRelation | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.Query.ResultToSourceFileRelation;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.Query.ResultToSourceFileRelation;
     ...
     */
    static cachedEmptyInst(): Genai.Query.ResultToSourceFileRelation;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.Query.ResultToSourceFileRelation> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.Query.ResultToSourceFileRelation;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<Genai.Query.ResultToSourceFileRelation>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Genai.Query.ResultToSourceFileRelation>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<Genai.Query.ResultToSourceFileRelation> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Genai.Query.ResultToSourceFileRelation>> | null;
     ...
     */
    get(include?: string): Genai.Query.ResultToSourceFileRelation | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): Genai.Query.ResultToSourceFileRelation | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Genai.Query.ResultToSourceFileRelation;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): Genai.Query.ResultToSourceFileRelation | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Genai.Query.ResultToSourceFileRelation;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.Query.ResultToSourceFileRelation | null;
     ...
     */
    create(spec?: UpsertSpec): Genai.Query.ResultToSourceFileRelation | null;
     ...
     */
    static createBatch(objs: Array_Type<Genai.Query.ResultToSourceFileRelation>, spec?: UpsertSpec): ObjList<Genai.Query.ResultToSourceFileRelation> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Genai.Query.ResultToSourceFileRelation>, spec?: CreateBatchObjStreamSpec): ObjList<Genai.Query.ResultToSourceFileRelation> | null;
     ...
     */
    update(srcObj?: Genai.Query.ResultToSourceFileRelation, spec?: UpsertSpec): Genai.Query.ResultToSourceFileRelation | null;
     ...
     */
    upsert(srcObj?: Genai.Query.ResultToSourceFileRelation, spec?: UpsertSpec): Genai.Query.ResultToSourceFileRelation | null;
     ...
     */
    merge(spec?: MergeSpec): Genai.Query.ResultToSourceFileRelation | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): Genai.Query.ResultToSourceFileRelation | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): Genai.Query.ResultToSourceFileRelation | null;
     ...
     */
    static updateBatch(objs: Array_Type<Genai.Query.ResultToSourceFileRelation>, srcObjs?: Array_Type<Genai.Query.ResultToSourceFileRelation>, spec?: UpsertSpec): ObjList<Genai.Query.ResultToSourceFileRelation> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<Genai.Query.ResultToSourceFileRelation> | null>, spec?: UpsertSpec): ObjList<Genai.Query.ResultToSourceFileRelation> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<Genai.Query.ResultToSourceFileRelation>, srcObjs?: Array_Type<Genai.Query.ResultToSourceFileRelation>, spec?: UpsertSpec): ObjList<Genai.Query.ResultToSourceFileRelation> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<Genai.Query.ResultToSourceFileRelation> | null>, spec?: UpsertSpec): ObjList<Genai.Query.ResultToSourceFileRelation> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<Genai.Query.ResultToSourceFileRelation>, spec?: TouchSpec): ObjList<Genai.Query.ResultToSourceFileRelation> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.Query.ResultToSourceFileRelation>, spec?: MergeSpec): ObjList<Genai.Query.ResultToSourceFileRelation> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.Query.ResultToSourceFileRelation>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.Query.ResultToSourceFileRelation> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<Genai.Query.ResultToSourceFileRelation> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.Query.ResultToSourceFileRelation> | null;
     ...
     */
    static mergeAll(mergeObj: Genai.Query.ResultToSourceFileRelation, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Genai.Query.ResultToSourceFileRelation, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<Genai.Query.ResultToSourceFileRelation>, spec?: UpsertSpec): ObjList<Genai.Query.ResultToSourceFileRelation> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<Genai.Query.ResultToSourceFileRelation>, spec?: UpsertSpec): ObjList<Genai.Query.ResultToSourceFileRelation> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): Genai.Query.ResultToSourceFileRelation | null;
     ...
     */
    static beforeCreate(objs: Array_Type<Genai.Query.ResultToSourceFileRelation>): ObjList<Genai.Query.ResultToSourceFileRelation>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<Genai.Query.ResultToSourceFileRelation>): ObjList<Genai.Query.ResultToSourceFileRelation>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<Genai.Query.ResultToSourceFileRelation>): ObjList<Genai.Query.ResultToSourceFileRelation>;
     ...
     */
    static afterCreate(objs: Array_Type<Genai.Query.ResultToSourceFileRelation>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<Genai.Query.ResultToSourceFileRelation>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<Genai.Query.ResultToSourceFileRelation>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<Genai.Query.ResultToSourceFileRelation>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Genai.Query.ResultToSourceFileRelation>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Genai.Query.ResultToSourceFileRelation | null;
     ...
     */
    withoutIdentity(): Genai.Query.ResultToSourceFileRelation | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<Genai.Query.ResultToSourceFileRelation>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: Genai.Query.ResultToSourceFileRelation, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<Genai.Query.ResultToSourceFileRelation>, callback?: λFunction<Genai.Query.ResultToSourceFileRelation | null, Genai.Query.ResultToSourceFileRelation | null>): ObjList<Genai.Query.ResultToSourceFileRelation>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<Genai.Query.ResultToSourceFileRelation>, callback?: λFunction<Genai.Query.ResultToSourceFileRelation | null, Genai.Query.ResultToSourceFileRelation | null>): Array_Type<ObjError> | null;
     ...
     */
    static cloneTo(srcResult: Genai.Query.Result, destResult: Genai.Query.Result): Array_Type<Genai.Query.ResultToSourceFileRelation>;
     ...
     */
    static cloneRelationsToParent(queryResult: Genai.Query.Result): Array_Type<Genai.Query.ResultToSourceFileRelation> | null;
     ...
     * @return the list of relations for parent
     */
    static relationsForParent(queryResult: Genai.Query.Result): Array_Type<Genai.Query.ResultToSourceFileRelation> | null;
  }
}
