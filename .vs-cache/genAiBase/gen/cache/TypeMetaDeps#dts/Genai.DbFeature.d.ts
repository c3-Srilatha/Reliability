// TypeScript definitions for the C3 type Genai.DbFeature

/**
 * A data feature (metrics, ML features, etc.) with its embedding defined in pgvector.
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.DbFeature
 */
declare namespace Genai {
  export interface IDbFeature {
 ...
 */
declare namespace Genai {
  export class DbFeature extends Obj  {
     ...
     */
    readonly id: string;
    withId(id: string): Genai.DbFeature;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Genai.DbFeature;

    /**
     * The name of the feature.
     */
    readonly name: string;
    withName(name: string): Genai.DbFeature;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): Genai.DbFeature;
    ...
    withVersion(version: number | null): Genai.DbFeature;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): Genai.DbFeature;

    /**
     * The description of the feature.
     */
    readonly description?: string;
    withDescription(description: string | null): Genai.DbFeature;

    /**
     * An embedding of the feature representation.
     */
    readonly emb?: string;
    withEmb(emb: string | null): Genai.DbFeature;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.DbFeature | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.DbFeature | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.DbFeature | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.DbFeature | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.DbFeature;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.DbFeature;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.DbFeature;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.DbFeature>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.DbFeature>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.DbFeature;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.DbFeature;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.DbFeature;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.DbFeature;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.DbFeature;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.DbFeature;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.DbFeature;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.DbFeature;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.DbFeature;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.DbFeature;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.DbFeature;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.DbFeature;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.DbFeature;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.DbFeature;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.DbFeature;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.DbFeature;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.DbFeature;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.DbFeature;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.DbFeature;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.DbFeature;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.DbFeature;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.DbFeature;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.DbFeature;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.DbFeature;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.DbFeature;

    mergeJson(json: any): Genai.DbFeature;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.DbFeature;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.DbFeature;
     ...
     */
    singletonArray(): Array_Type<Genai.DbFeature>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.DbFeature> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.DbFeature> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.DbFeature>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.DbFeature> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.DbFeature> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.DbFeature> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.DbFeature>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.DbFeature>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.DbFeature;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.DbFeature;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.DbFeature;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.DbFeature;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.DbFeature;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.DbFeature;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.DbFeature | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.DbFeature;
     ...
     */
    static cachedEmptyInst(): Genai.DbFeature;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.DbFeature> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.DbFeature;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<Genai.DbFeature>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Genai.DbFeature>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<Genai.DbFeature> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Genai.DbFeature>> | null;
     ...
     */
    get(include?: string): Genai.DbFeature | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): Genai.DbFeature | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Genai.DbFeature;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): Genai.DbFeature | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Genai.DbFeature;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.DbFeature | null;
     ...
     */
    create(spec?: UpsertSpec): Genai.DbFeature | null;
     ...
     */
    static createBatch(objs: Array_Type<Genai.DbFeature>, spec?: UpsertSpec): ObjList<Genai.DbFeature> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Genai.DbFeature>, spec?: CreateBatchObjStreamSpec): ObjList<Genai.DbFeature> | null;
     ...
     */
    update(srcObj?: Genai.DbFeature, spec?: UpsertSpec): Genai.DbFeature | null;
     ...
     */
    upsert(srcObj?: Genai.DbFeature, spec?: UpsertSpec): Genai.DbFeature | null;
     ...
     */
    merge(spec?: MergeSpec): Genai.DbFeature | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): Genai.DbFeature | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): Genai.DbFeature | null;
     ...
     */
    static updateBatch(objs: Array_Type<Genai.DbFeature>, srcObjs?: Array_Type<Genai.DbFeature>, spec?: UpsertSpec): ObjList<Genai.DbFeature> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<Genai.DbFeature> | null>, spec?: UpsertSpec): ObjList<Genai.DbFeature> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<Genai.DbFeature>, srcObjs?: Array_Type<Genai.DbFeature>, spec?: UpsertSpec): ObjList<Genai.DbFeature> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<Genai.DbFeature> | null>, spec?: UpsertSpec): ObjList<Genai.DbFeature> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<Genai.DbFeature>, spec?: TouchSpec): ObjList<Genai.DbFeature> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.DbFeature>, spec?: MergeSpec): ObjList<Genai.DbFeature> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.DbFeature>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.DbFeature> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<Genai.DbFeature> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.DbFeature> | null;
     ...
     */
    static mergeAll(mergeObj: Genai.DbFeature, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Genai.DbFeature, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<Genai.DbFeature>, spec?: UpsertSpec): ObjList<Genai.DbFeature> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<Genai.DbFeature>, spec?: UpsertSpec): ObjList<Genai.DbFeature> | null;
     ...
     */
    static beforeCreate(objs: Array_Type<Genai.DbFeature>): ObjList<Genai.DbFeature>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<Genai.DbFeature>): ObjList<Genai.DbFeature>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<Genai.DbFeature>): ObjList<Genai.DbFeature>;
     ...
     */
    static afterCreate(objs: Array_Type<Genai.DbFeature>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<Genai.DbFeature>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<Genai.DbFeature>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<Genai.DbFeature>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Genai.DbFeature>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Genai.DbFeature | null;
     ...
     */
    withoutIdentity(): Genai.DbFeature | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<Genai.DbFeature>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: Genai.DbFeature, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<Genai.DbFeature>, callback?: λFunction<Genai.DbFeature | null, Genai.DbFeature | null>): ObjList<Genai.DbFeature>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<Genai.DbFeature>, callback?: λFunction<Genai.DbFeature | null, Genai.DbFeature | null>): Array_Type<ObjError> | null;
