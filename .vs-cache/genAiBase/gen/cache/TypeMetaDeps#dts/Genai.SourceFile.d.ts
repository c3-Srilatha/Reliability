// TypeScript definitions for the C3 type Genai.SourceFile

/**
 * A Genai.SourceFile represents a single file within a {@link Genai.SourceCollection}'s 'rootUrl`.
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.SourceFile
 */
declare namespace Genai {
  export interface ISourceFile {
     ...
     */
    projects?: Array_Type<Genai.Project> | Array<IGenai.Project>;
     ...
     */
    sourceUrl?: IGenai.Query.Result.Source.Url;
     ...
     */
    metadata?: IGenai.SourceFile.Metadata;
     ...
     */
    modifiedTimeWhenLastProcessed?: DateTime | Date | string;
     ...
     */
    groups?: Array_Type<Role> | Array<IRole>;

    /**
     * The current status of the source file with respect to data ingestion
     */
    status?: IGenai.SourceFile.StatusTimedValue;

    /**
     * The history of statuses for the source file
     */
    statusHistory?: Array_Type<Genai.SourceFile.StatusHistory> | Array<IGenai.SourceFile.StatusHistory>;
     ...
     */
    collection?: IGenai.SourceCollection;
     ...
     */
    tablePassagesFile?: IFile;

    /**
     * The file with all image parsing results
     */
    imagePassagesFile?: IFile;
 ...
 * A Genai.SourceFile represents a single file within a {@link Genai.SourceCollection}'s 'rootUrl`.
 *
 * @remarks this represents a made instance of Genai.SourceFile
 */
declare namespace Genai {
  export class SourceFile extends Obj  {

    /**
     * The {@link Genai.Project}s, if any, that this file belongs to
     */
    readonly projects?: Array_Type<Genai.Project>;
    withProjects(projects: Array_Type<Genai.Project> | Array<IGenai.Project> | null): Genai.SourceFile;

    /**
     * List of {@link AclEntry} entries governing who can read/update/remove Objs.
     */
    readonly acl?: Array_Type<AclEntry>;
    withAcl(acl: Array_Type<AclEntry> | Array<IAclEntry> | null): Genai.SourceFile;
    ...
    withTypeIdent(typeIdent: string | null): Genai.SourceFile;
     ...
     */
    readonly id: string;
    withId(id: string): Genai.SourceFile;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Genai.SourceFile;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): Genai.SourceFile;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): Genai.SourceFile;
    ...
    withVersion(version: number | null): Genai.SourceFile;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): Genai.SourceFile;

    /**
     * If set, a {@link Genai.Query.ResultToUrlSourceRelation} will be created for {@link Genai.Query.Result} that cites this source.
     */
    readonly sourceUrl?: Genai.Query.Result.Source.Url;
    withSourceUrl(sourceUrl: IGenai.Query.Result.Source.Url | null): Genai.SourceFile;
    ...
    withContentSize(contentSize: number | null): Genai.SourceFile;

    /**
     * The {@link Genai.SourceFile.Metadata} associated with a source. Used to filter out sources during similarity search.
     */
    readonly metadata?: Genai.SourceFile.Metadata;
    withMetadata(metadata: IGenai.SourceFile.Metadata | null): Genai.SourceFile;

    /**
     * The etag from the last time that the source pointed to by this source's #sourceUrl was processed. Used to check
     * whether the source has been updated since it was last processed.
     */
    readonly eTagWhenLastProcessed?: string;
    withETagWhenLastProcessed(eTagWhenLastProcessed: string | null): Genai.SourceFile;
     ...
     * not (yet) have etag support
     */
    readonly modifiedTimeWhenLastProcessed?: DateTime;
    withModifiedTimeWhenLastProcessed(modifiedTimeWhenLastProcessed: DateTime | Date | string | null): Genai.SourceFile;

    /**
     * The file where all passages from original source get stored. A representation of the Genai.SourcePassages for the
     * original source.
     */
    readonly passagesFile?: File;
    withPassagesFile(passagesFile: IFile | null): Genai.SourceFile;

    /**
     * The groups with access to this source.
     */
    readonly groups?: Array_Type<Role>;
    withGroups(groups: Array_Type<Role> | Array<IRole> | null): Genai.SourceFile;

    /**
     * The current status of the source file with respect to data ingestion
     */
    readonly status?: Genai.SourceFile.StatusTimedValue;
    withStatus(status: IGenai.SourceFile.StatusTimedValue | null): Genai.SourceFile;

    /**
     * The history of statuses for the source file
     */
    readonly statusHistory?: Array_Type<Genai.SourceFile.StatusHistory>;
    withStatusHistory(statusHistory: Array_Type<Genai.SourceFile.StatusHistory> | Array<IGenai.SourceFile.StatusHistory> | null): Genai.SourceFile;

    /**
     * Checks if the #statusHistory is curently indexing, syncing, or being removed from index.
     */
    readonly isProcessing?: boolean;
    withIsProcessing(isProcessing: boolean): Genai.SourceFile;
    ...
    withDisplayUrl(displayUrl: string | null): Genai.SourceFile;

    /**
     * The collection that this file belongs to
     */
    readonly collection?: Genai.SourceCollection;
    withCollection(collection: IGenai.SourceCollection | null): Genai.SourceFile;

    /**
     * The file that this SourceFile represents
     */
    readonly originalFile: File;
    withOriginalFile(originalFile: IFile): Genai.SourceFile;

    /**
     * The file with all table parsing results
     */
    readonly tablePassagesFile?: File;
    withTablePassagesFile(tablePassagesFile: IFile | null): Genai.SourceFile;

    /**
     * The file with all image parsing results
     */
    readonly imagePassagesFile?: File;
    withImagePassagesFile(imagePassagesFile: IFile | null): Genai.SourceFile;

    /**
     * True if user uploaded this document through the application,
     * otherwise false
     */
    readonly userUploaded?: boolean;
    withUserUploaded(userUploaded: boolean): Genai.SourceFile;

    /**
     * A formatted representation of #groups for easier readability.
     */
    readonly displayGroups?: string;
    withDisplayGroups(displayGroups: string | null): Genai.SourceFile;

    /**
     * The {@link User#email} who processed the source file.
     */
    readonly lastProcessedBy?: string;
    withLastProcessedBy(lastProcessedBy: string | null): Genai.SourceFile;
     ...
     * See Genai.SourceFile.StatusTimedValue#lastProcessedBy
     */
    readonly displayLastProcessedBy?: string;
    withDisplayLastProcessedBy(displayLastProcessedBy: string | null): Genai.SourceFile;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.SourceFile | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.SourceFile | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.SourceFile | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.SourceFile | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.SourceFile;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.SourceFile;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.SourceFile;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.SourceFile>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.SourceFile>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.SourceFile;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.SourceFile;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.SourceFile;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.SourceFile;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.SourceFile;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.SourceFile;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.SourceFile;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.SourceFile;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.SourceFile;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.SourceFile;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.SourceFile;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.SourceFile;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.SourceFile;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.SourceFile;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.SourceFile;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.SourceFile;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.SourceFile;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.SourceFile;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.SourceFile;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.SourceFile;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.SourceFile;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.SourceFile;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.SourceFile;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.SourceFile;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.SourceFile;

    mergeJson(json: any): Genai.SourceFile;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.SourceFile;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.SourceFile;
     ...
     */
    singletonArray(): Array_Type<Genai.SourceFile>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.SourceFile> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.SourceFile> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.SourceFile>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.SourceFile> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.SourceFile> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.SourceFile> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.SourceFile>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.SourceFile>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.SourceFile;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.SourceFile;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.SourceFile;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.SourceFile;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.SourceFile;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.SourceFile;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.SourceFile | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.SourceFile;
     ...
     */
    static cachedEmptyInst(): Genai.SourceFile;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.SourceFile> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.SourceFile;
     ...
     */
    static fetchForUser(spec?: FetchSpec, user?: User): FetchResult<any> | null;
     ...
     */
    static fetchCountForUser(spec?: FetchSpec, user?: User): number;

    /**
     * Read and return all passages that belong to this source
     */
    readPassages(): Array_Type<Genai.SourcePassage>;
     ...
     */
    static populateAcl(objs?: Array_Type<Genai.SourceFile>): number | null;
     ...
     */
    grantMemberReadUpdateRemove(member: AccessControlEntity): Genai.SourceFile;
     ...
     */
    mergeAclEntry(entry: AclEntry): Genai.SourceFile;
     ...
     * @return the obj with the new acl after merging the indicated entry.
     */
    mergeAclEntries(entries: Array_Type<AclEntry>): Genai.SourceFile;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<Genai.SourceFile>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Genai.SourceFile>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<Genai.SourceFile> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Genai.SourceFile>> | null;
     ...
     */
    get(include?: string): Genai.SourceFile | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): Genai.SourceFile | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Genai.SourceFile;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): Genai.SourceFile | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Genai.SourceFile;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.SourceFile | null;
     ...
     */
    create(spec?: UpsertSpec): Genai.SourceFile | null;
     ...
     */
    static createBatch(objs: Array_Type<Genai.SourceFile>, spec?: UpsertSpec): ObjList<Genai.SourceFile> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Genai.SourceFile>, spec?: CreateBatchObjStreamSpec): ObjList<Genai.SourceFile> | null;
     ...
     */
    update(srcObj?: Genai.SourceFile, spec?: UpsertSpec): Genai.SourceFile | null;
     ...
     */
    upsert(srcObj?: Genai.SourceFile, spec?: UpsertSpec): Genai.SourceFile | null;
     ...
     */
    merge(spec?: MergeSpec): Genai.SourceFile | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): Genai.SourceFile | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): Genai.SourceFile | null;
     ...
     */
    static updateBatch(objs: Array_Type<Genai.SourceFile>, srcObjs?: Array_Type<Genai.SourceFile>, spec?: UpsertSpec): ObjList<Genai.SourceFile> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<Genai.SourceFile> | null>, spec?: UpsertSpec): ObjList<Genai.SourceFile> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<Genai.SourceFile>, srcObjs?: Array_Type<Genai.SourceFile>, spec?: UpsertSpec): ObjList<Genai.SourceFile> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<Genai.SourceFile> | null>, spec?: UpsertSpec): ObjList<Genai.SourceFile> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<Genai.SourceFile>, spec?: TouchSpec): ObjList<Genai.SourceFile> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.SourceFile>, spec?: MergeSpec): ObjList<Genai.SourceFile> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.SourceFile>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.SourceFile> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<Genai.SourceFile> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.SourceFile> | null;
     ...
     */
    static mergeAll(mergeObj: Genai.SourceFile, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Genai.SourceFile, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<Genai.SourceFile>, spec?: UpsertSpec): ObjList<Genai.SourceFile> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<Genai.SourceFile>, spec?: UpsertSpec): ObjList<Genai.SourceFile> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): Genai.SourceFile | null;
     ...
     */
    static beforeCreate(objs: Array_Type<Genai.SourceFile>): ObjList<Genai.SourceFile>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<Genai.SourceFile>): ObjList<Genai.SourceFile>;

    /**
     * Implemented to ensure that all passages derived from this file are removed.
     */
    static beforeRemove(objs: Array_Type<Genai.SourceFile>): ObjList<Genai.SourceFile>;
     ...
     */
    static afterCreate(objs: Array_Type<Genai.SourceFile>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<Genai.SourceFile>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<Genai.SourceFile>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<Genai.SourceFile>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Genai.SourceFile>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Genai.SourceFile | null;
     ...
     */
    withoutIdentity(): Genai.SourceFile | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<Genai.SourceFile>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: Genai.SourceFile, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<Genai.SourceFile>, callback?: λFunction<Genai.SourceFile | null, Genai.SourceFile | null>): ObjList<Genai.SourceFile>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<Genai.SourceFile>, callback?: λFunction<Genai.SourceFile | null, Genai.SourceFile | null>): Array_Type<ObjError> | null;
     ...
     */
    static guessedContentSize(file: File): number | null;
     ...
     */
    writePassages(passages: Array_Type<Genai.SourcePassage>): File;
     ...
     */
    addTag(tagLabel: string): Genai.SourceFile.Metadata.Tag;
     ...
     */
    removeTag(tagLabel: string): boolean;
     ...
     */
    static getMetadataFields(predicate?: λPredicate<DeclaredFieldType | null>): Array_Type<DeclaredFieldType> | null;
     ...
     *          An optional lambda returning true if a metadata field satisfies the given predicate.
     */
    static getAllMetadataValues(predicate?: λPredicate<DeclaredFieldType | null>): Map_Type<string, Set_Type<string>>;
     ...
     */
    mergedPassages(forceRefresh?: boolean): File;
     ...
     */
    static generatePassages(source: Genai.Source, documents: Array_Type<any>): Array_Type<Genai.SourcePassage>;
     ...
     */
    static filterSourcesForFileTypes(sources?: Array_Type<File>): Array_Type<File> | null;

    /**
     * Triggers processing, chunking, and indexing of {@link Genai.SourceFile}s
     * @return the files processed
     */
    static process(files: Array_Type<Genai.SourceFile>, vectorStore?: Genai.Retriever, chunkerSpec?: Genai.SourceFile.Chunker.UniversalChunker.Spec, scanResult?: Genai.SourceFile.Metadata.Tagging.ScanResult, lastProcessedBy?: string): ObjList<Genai.SourceFile> | null;

    /**
     * Triggers automated metadata tagging and indexing of {@link Genai.SourceFile}s
     * @return the files processed
     */
    static processChunkingCompletion(chunkObjList?: ObjList<Genai.SourceFile>, files: Array_Type<Genai.SourceFile>, vectorStore?: Genai.Retriever, scanResult?: Genai.SourceFile.Metadata.Tagging.ScanResult, lastProcessedBy?: string): ObjList<Genai.SourceFile> | null;
     ...
     */
    static unprocess(files: Array_Type<Genai.SourceFile>, vectorStore?: Genai.Retriever, shouldTransitionToDeleted?: boolean): ObjList<Genai.SourceFile> | null;
     ...
     */
    static fromUrlsBatch(collection: Genai.SourceCollection, sourceUrls: Array_Type<string>, chunkerSpec?: Genai.SourceFile.Chunker.UniversalChunker.Spec): Array_Type<Genai.SourceFile> | null;
     ...
     */
    static fromFilesBatch(collection: Genai.SourceCollection, originalFiles: Array_Type<File>, chunkerSpec?: Genai.SourceFile.Chunker.UniversalChunker.Spec, userUploaded?: boolean): Array_Type<Genai.SourceFile> | null;
     ...
     */
    static syncFiles(sourceFiles: Array_Type<Genai.SourceFile>, chunkerSpec?: Genai.SourceFile.Chunker.UniversalChunker.Spec): void;
     ...
     * If `chunkerSpec` is not provided, the {@link Genai.SourceFile}s will not be chunked into {@link Genai.SourcePassage}s.
     */
    static syncFilesBatch(sourceFiles: Array_Type<Genai.SourceFile>, chunkerSpec?: Genai.SourceFile.Chunker.UniversalChunker.Spec): void;
     ...
     */
    static checkVectorStore(files: Array_Type<Genai.SourceFile>, vectorStore?: Genai.Retriever, lastProcessedBy?: string): Genai.Retriever;
     ...
     */
    static transitionFilesToStatus(files: Array_Type<Genai.SourceFile>, status: string, lastProcessedBy?: string, errorMessages?: Array_Type<string>): Array_Type<Genai.SourceFile.StatusHistory> | null;
     ...
     */
    static transitionCollectionToStatus(collection: Genai.SourceCollection, status: string, lastProcessedBy?: string, filter?: Filter, errorMessage?: string): Array_Type<Genai.SourceFile.StatusHistory> | null;
     ...
     */
    static transitionRelevantFilesToChunking(): Array_Type<Genai.SourceFile> | null;

    /**
     * Handles the transition of a list of source files to the `INDEXED` state.
     */
    static handleTransitionToIndexed(sourceFiles?: Array_Type<Genai.SourceFile>): void;

    /**
     * Handles the transition of the source files inside a {@link Genai.SourceCollection} to the `INDEXED` state.
     */
    static handleTransitionToIndexed(collection?: Genai.SourceCollection): void;
     ...
     */
    static handleTransitionToNotIndexed(sourceFiles?: Array_Type<Genai.SourceFile>): void;
     ...
     */
    static handleTransitionToNotIndexed(collection?: Genai.SourceCollection): void;

    /**
     * Handles the transition of a list of source files to the `CHUNKED` state.
     */
    static handleTransitionToChunked(sourceFiles?: Array_Type<Genai.SourceFile>): void;

    /**
     * Handles the transition of the source files inside a {@link Genai.SourceCollection} to the `CHUNKED` state.
     */
    static handleTransitionToChunked(collection?: Genai.SourceCollection): void;

    /**
     * Retrieves the status counts of {@link Genai.SourceFile}s over the last 24 hours
     */
    static getStatusCounts(): Genai.SourceFile.StatusCounts;
     ...
     */
    static addTags(tagLabels: Array_Type<string>, sourceFiles: Array_Type<Genai.SourceFile>): void;
     ...
     */
    static addManualTag(sourceFile: Genai.SourceFile, tagLabel: string, categoryLabel: string): void;
     ...
     */
    static updateManualTag(sourceFile: Genai.SourceFile, oldTag: Genai.SourceFile.Metadata.Tag, newTagLabel: string): void;
     ...
     *         The tag to remove.
     */
    static removeManualTag(sourceFile: Genai.SourceFile, tag: Genai.SourceFile.Metadata.Tag): void;
     ...
     */
    static addTagsByMap(sourceFileMap: Map_Type<string, Array_Type<string>>): void;

    /**
     * Takes in a map which is keyed by source file Ids and has values which are maps of category to tags
     * to add to each of those source files.
     */
    static addTagsByCategoryMap(sourceFileMap: Map_Type<string, Map_Type<string, Array_Type<string>>>): void;
     ...
     */
    static fileMeta(sourceFile: Genai.SourceFile, collection: Genai.SourceCollection): Genai.SourceFile.Metadata;
     ...
     * @return filtered out {@link Genai.SourceFile}s.
     */
    static filterSourceFilesBasedOnStatus(sourceFiles: Array_Type<Genai.SourceFile>, statuses: Array_Type<string>): Array_Type<Genai.SourceFile>;
     ...
     * @return count of {@link Genai.SourceFile}s.
     */
    static fetchNonDeletedCountForUser(spec?: FetchSpec, user?: User): number;
     ...
     */
    static fetchObjStreamForUser(spec?: FetchSpec, user?: User): Stream<Genai.SourceFile> | null;
     ...
     */
    getSanitizedSourceFileId(): string;
     ...
     */
    static unprocessAndTransitionToDeleted(files: Array_Type<Genai.SourceFile>, vectorStore?: Genai.Retriever): void;
     ...
     */
    static getValidSourceFiles(fetchSpec: FetchSpec): Array_Type<Genai.SourceFile> | null;
     ...
     */
    static getDeletedSourceFiles(fetchSpec: FetchSpec): Array_Type<Genai.SourceFile> | null;
     ...
     */
    static renameAndMoveToDeletedFolder(files: Array_Type<Genai.SourceFile>): void;
  }
}
