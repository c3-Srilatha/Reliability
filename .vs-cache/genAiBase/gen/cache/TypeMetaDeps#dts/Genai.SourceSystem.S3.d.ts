// TypeScript definitions for the C3 type Genai.SourceSystem.S3

/**
 * Represents the root of an external AWS S3 file system.
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.SourceSystem.S3
 */
declare namespace Genai.SourceSystem {
...
declare namespace Genai.SourceSystem {
  export class S3 extends Obj  {
    ...
    withTypeIdent(typeIdent: string | null): Genai.SourceSystem.S3;
     ...
     */
    readonly id: string;
    withId(id: string): Genai.SourceSystem.S3;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Genai.SourceSystem.S3;

    /**
     * Name of the source system
     */
    readonly name: string;
    withName(name: string): Genai.SourceSystem.S3;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): Genai.SourceSystem.S3;
    ...
    withVersion(version: number | null): Genai.SourceSystem.S3;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): Genai.SourceSystem.S3;

    /**
     * The type of the source system
     */
    readonly sourceType?: string;
    withSourceType(sourceType: string | null): Genai.SourceSystem.S3;

    /**
     * The {@link Genai.SourceCollection}s created as a part of this source system
     */
    readonly collections?: Array_Type<Genai.SourceCollection>;
    withCollections(collections: Array_Type<Genai.SourceCollection> | Array<IGenai.SourceCollection> | null): Genai.SourceSystem.S3;

    /**
     * Description of the source system
     */
    readonly description?: string;
    withDescription(description: string | null): Genai.SourceSystem.S3;

    /**
     * The name of the mount in {@link FileSystem#mounts} for this source system
     */
    readonly mountName: string;
    withMountName(mountName: string): Genai.SourceSystem.S3;

    /**
     * The name of the bucket for the source system
     */
    readonly bucketName: string;
    withBucketName(bucketName: string): Genai.SourceSystem.S3;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.SourceSystem.S3 | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.SourceSystem.S3 | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.SourceSystem.S3 | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.SourceSystem.S3 | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.SourceSystem.S3;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.SourceSystem.S3;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.SourceSystem.S3;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.SourceSystem.S3>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.SourceSystem.S3>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.SourceSystem.S3;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.SourceSystem.S3;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.SourceSystem.S3;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.SourceSystem.S3;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.SourceSystem.S3;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.SourceSystem.S3;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.SourceSystem.S3;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.SourceSystem.S3;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.SourceSystem.S3;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.SourceSystem.S3;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.SourceSystem.S3;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.SourceSystem.S3;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.SourceSystem.S3;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.SourceSystem.S3;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.SourceSystem.S3;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.SourceSystem.S3;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.SourceSystem.S3;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.SourceSystem.S3;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.SourceSystem.S3;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.SourceSystem.S3;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.SourceSystem.S3;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.SourceSystem.S3;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.SourceSystem.S3;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.SourceSystem.S3;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.SourceSystem.S3;

    mergeJson(json: any): Genai.SourceSystem.S3;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.SourceSystem.S3;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.SourceSystem.S3;
     ...
     */
    singletonArray(): Array_Type<Genai.SourceSystem.S3>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.SourceSystem.S3> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.SourceSystem.S3> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.SourceSystem.S3>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.SourceSystem.S3> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.SourceSystem.S3> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.SourceSystem.S3> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.SourceSystem.S3>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.SourceSystem.S3>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.SourceSystem.S3;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.SourceSystem.S3;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.SourceSystem.S3;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.SourceSystem.S3;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.SourceSystem.S3;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.SourceSystem.S3;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.SourceSystem.S3 | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.SourceSystem.S3;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.SourceSystem.S3;
     ...
     */
    static cachedEmptyInst(): Genai.SourceSystem.S3;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.SourceSystem.S3> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.SourceSystem.S3;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<Genai.SourceSystem.S3>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Genai.SourceSystem.S3>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<Genai.SourceSystem.S3> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Genai.SourceSystem.S3>> | null;
     ...
     */
    get(include?: string): Genai.SourceSystem.S3 | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): Genai.SourceSystem.S3 | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Genai.SourceSystem.S3;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): Genai.SourceSystem.S3 | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Genai.SourceSystem.S3;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.SourceSystem.S3 | null;
     ...
     */
    create(spec?: UpsertSpec): Genai.SourceSystem.S3 | null;
     ...
     */
    static createBatch(objs: Array_Type<Genai.SourceSystem.S3>, spec?: UpsertSpec): ObjList<Genai.SourceSystem.S3> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Genai.SourceSystem.S3>, spec?: CreateBatchObjStreamSpec): ObjList<Genai.SourceSystem.S3> | null;
     ...
     */
    update(srcObj?: Genai.SourceSystem.S3, spec?: UpsertSpec): Genai.SourceSystem.S3 | null;
     ...
     */
    upsert(srcObj?: Genai.SourceSystem.S3, spec?: UpsertSpec): Genai.SourceSystem.S3 | null;
     ...
     */
    merge(spec?: MergeSpec): Genai.SourceSystem.S3 | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): Genai.SourceSystem.S3 | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): Genai.SourceSystem.S3 | null;
     ...
     */
    static updateBatch(objs: Array_Type<Genai.SourceSystem.S3>, srcObjs?: Array_Type<Genai.SourceSystem.S3>, spec?: UpsertSpec): ObjList<Genai.SourceSystem.S3> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<Genai.SourceSystem.S3> | null>, spec?: UpsertSpec): ObjList<Genai.SourceSystem.S3> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<Genai.SourceSystem.S3>, srcObjs?: Array_Type<Genai.SourceSystem.S3>, spec?: UpsertSpec): ObjList<Genai.SourceSystem.S3> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<Genai.SourceSystem.S3> | null>, spec?: UpsertSpec): ObjList<Genai.SourceSystem.S3> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<Genai.SourceSystem.S3>, spec?: TouchSpec): ObjList<Genai.SourceSystem.S3> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.SourceSystem.S3>, spec?: MergeSpec): ObjList<Genai.SourceSystem.S3> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.SourceSystem.S3>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.SourceSystem.S3> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<Genai.SourceSystem.S3> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.SourceSystem.S3> | null;
     ...
     */
    static mergeAll(mergeObj: Genai.SourceSystem.S3, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Genai.SourceSystem.S3, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<Genai.SourceSystem.S3>, spec?: UpsertSpec): ObjList<Genai.SourceSystem.S3> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<Genai.SourceSystem.S3>, spec?: UpsertSpec): ObjList<Genai.SourceSystem.S3> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): Genai.SourceSystem.S3 | null;
     ...
     */
    static beforeCreate(objs: Array_Type<Genai.SourceSystem.S3>): ObjList<Genai.SourceSystem.S3>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<Genai.SourceSystem.S3>): ObjList<Genai.SourceSystem.S3>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<Genai.SourceSystem.S3>): ObjList<Genai.SourceSystem.S3>;
     ...
     */
    static afterCreate(objs: Array_Type<Genai.SourceSystem.S3>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<Genai.SourceSystem.S3>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<Genai.SourceSystem.S3>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<Genai.SourceSystem.S3>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Genai.SourceSystem.S3>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Genai.SourceSystem.S3 | null;
     ...
     */
    withoutIdentity(): Genai.SourceSystem.S3 | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<Genai.SourceSystem.S3>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: Genai.SourceSystem.S3, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<Genai.SourceSystem.S3>, callback?: λFunction<Genai.SourceSystem.S3 | null, Genai.SourceSystem.S3 | null>): ObjList<Genai.SourceSystem.S3>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<Genai.SourceSystem.S3>, callback?: λFunction<Genai.SourceSystem.S3 | null, Genai.SourceSystem.S3 | null>): Array_Type<ObjError> | null;
     ...
     */
    static createSourceSystem(spec: Genai.SourceSystem.S3.CreateSpec, rootUrls: Array_Type<string>): Genai.SourceSystem.S3;
     ...
     */
    static dedupRootUrls(rootUrls: Array_Type<string>): Array_Type<string>;

    /**
     * Validates the connection for the S3 source system.
     */
    static validateConnection(spec?: any | Genai.SourceSystem.CreateSpec, sourceSystem?: Genai.SourceSystem<Genai.SourceSystem.CreateSpec>): any | null;

    /**
     * Returns true if a source system has a unique name within existing S3 systems, false otherwise.
     */
    static doesNameExist(sourceName: string): boolean;

    /**
     * Gets the url for the mount
     */
    static getRootUrl(bucketName?: string): string;

    /**
     * Verifies if the provided credentials can access the provided bucket.
     */
    static testCredentials(credentials: CloudCredentials, bucketName: string): Genai.SourceSystem.ValidateConnectionResult;
     ...
     */
    static getNextMountName(bucketName: string): string;
  }
}
