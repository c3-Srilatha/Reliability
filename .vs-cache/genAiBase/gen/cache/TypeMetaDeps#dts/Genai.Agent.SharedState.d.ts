// TypeScript definitions for the C3 type Genai.Agent.SharedState
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.Agent.SharedState
 */
 ...
 */
declare namespace Genai.Agent {
  export class SharedState extends Obj  {
     ...
     */
    readonly id: string;
    withId(id: string): Genai.Agent.SharedState;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Genai.Agent.SharedState;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): Genai.Agent.SharedState;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): Genai.Agent.SharedState;
    ...
    withVersion(version: number | null): Genai.Agent.SharedState;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): Genai.Agent.SharedState;

    /**
     * A logical key used to reference a particular state entry.
     */
    readonly stateKey: string;
    withStateKey(stateKey: string): Genai.Agent.SharedState;

    /**
     * Value of the state entry.
     */
    readonly state: any;
    withState(state: any): Genai.Agent.SharedState;

    /**
     * The scope of the state entry.
     */
    readonly scope: string;
    withScope(scope: string): Genai.Agent.SharedState;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.Agent.SharedState | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.Agent.SharedState | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.Agent.SharedState | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.Agent.SharedState | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.Agent.SharedState;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Agent.SharedState;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Agent.SharedState;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Agent.SharedState>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Agent.SharedState>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.Agent.SharedState;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Agent.SharedState;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Agent.SharedState;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.Agent.SharedState;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.Agent.SharedState;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.Agent.SharedState;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.Agent.SharedState;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.Agent.SharedState;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.Agent.SharedState;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.Agent.SharedState;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.Agent.SharedState;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.Agent.SharedState;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.Agent.SharedState;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.Agent.SharedState;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.Agent.SharedState;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.Agent.SharedState;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.Agent.SharedState;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.Agent.SharedState;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.Agent.SharedState;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.Agent.SharedState;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.Agent.SharedState;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.Agent.SharedState;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.Agent.SharedState;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.Agent.SharedState;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.Agent.SharedState;

    mergeJson(json: any): Genai.Agent.SharedState;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.Agent.SharedState;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.Agent.SharedState;
     ...
     */
    singletonArray(): Array_Type<Genai.Agent.SharedState>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.Agent.SharedState> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.Agent.SharedState> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.Agent.SharedState>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.Agent.SharedState> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.Agent.SharedState> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.Agent.SharedState> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.Agent.SharedState>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.Agent.SharedState>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.Agent.SharedState;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.Agent.SharedState;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.Agent.SharedState;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.Agent.SharedState;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.Agent.SharedState;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.Agent.SharedState;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.Agent.SharedState | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.Agent.SharedState;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.Agent.SharedState;
     ...
     */
    static cachedEmptyInst(): Genai.Agent.SharedState;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.Agent.SharedState> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.Agent.SharedState;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<Genai.Agent.SharedState>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Genai.Agent.SharedState>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<Genai.Agent.SharedState> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Genai.Agent.SharedState>> | null;
     ...
     */
    get(include?: string): Genai.Agent.SharedState | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): Genai.Agent.SharedState | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Genai.Agent.SharedState;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): Genai.Agent.SharedState | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Genai.Agent.SharedState;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.Agent.SharedState | null;
     ...
     */
    create(spec?: UpsertSpec): Genai.Agent.SharedState | null;
     ...
     */
    static createBatch(objs: Array_Type<Genai.Agent.SharedState>, spec?: UpsertSpec): ObjList<Genai.Agent.SharedState> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Genai.Agent.SharedState>, spec?: CreateBatchObjStreamSpec): ObjList<Genai.Agent.SharedState> | null;
     ...
     */
    update(srcObj?: Genai.Agent.SharedState, spec?: UpsertSpec): Genai.Agent.SharedState | null;
     ...
     */
    upsert(srcObj?: Genai.Agent.SharedState, spec?: UpsertSpec): Genai.Agent.SharedState | null;
     ...
     */
    merge(spec?: MergeSpec): Genai.Agent.SharedState | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): Genai.Agent.SharedState | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): Genai.Agent.SharedState | null;
     ...
     */
    static updateBatch(objs: Array_Type<Genai.Agent.SharedState>, srcObjs?: Array_Type<Genai.Agent.SharedState>, spec?: UpsertSpec): ObjList<Genai.Agent.SharedState> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<Genai.Agent.SharedState> | null>, spec?: UpsertSpec): ObjList<Genai.Agent.SharedState> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<Genai.Agent.SharedState>, srcObjs?: Array_Type<Genai.Agent.SharedState>, spec?: UpsertSpec): ObjList<Genai.Agent.SharedState> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<Genai.Agent.SharedState> | null>, spec?: UpsertSpec): ObjList<Genai.Agent.SharedState> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<Genai.Agent.SharedState>, spec?: TouchSpec): ObjList<Genai.Agent.SharedState> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.Agent.SharedState>, spec?: MergeSpec): ObjList<Genai.Agent.SharedState> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.Agent.SharedState>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.Agent.SharedState> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<Genai.Agent.SharedState> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.Agent.SharedState> | null;
     ...
     */
    static mergeAll(mergeObj: Genai.Agent.SharedState, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Genai.Agent.SharedState, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<Genai.Agent.SharedState>, spec?: UpsertSpec): ObjList<Genai.Agent.SharedState> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<Genai.Agent.SharedState>, spec?: UpsertSpec): ObjList<Genai.Agent.SharedState> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): Genai.Agent.SharedState | null;
     ...
     */
    static beforeCreate(objs: Array_Type<Genai.Agent.SharedState>): ObjList<Genai.Agent.SharedState>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<Genai.Agent.SharedState>): ObjList<Genai.Agent.SharedState>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<Genai.Agent.SharedState>): ObjList<Genai.Agent.SharedState>;
     ...
     */
    static afterCreate(objs: Array_Type<Genai.Agent.SharedState>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<Genai.Agent.SharedState>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<Genai.Agent.SharedState>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<Genai.Agent.SharedState>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Genai.Agent.SharedState>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Genai.Agent.SharedState | null;
     ...
     */
    withoutIdentity(): Genai.Agent.SharedState | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<Genai.Agent.SharedState>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: Genai.Agent.SharedState, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<Genai.Agent.SharedState>, callback?: λFunction<Genai.Agent.SharedState | null, Genai.Agent.SharedState | null>): ObjList<Genai.Agent.SharedState>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<Genai.Agent.SharedState>, callback?: λFunction<Genai.Agent.SharedState | null, Genai.Agent.SharedState | null>): Array_Type<ObjError> | null;
     ...
     */
    static getSharedState(stateKey: string, scope?: string = '"user"'): any | null;
     ...
     */
    static setSharedState(stateKey: string, state: any, scope?: string = '"user"'): Genai.Agent.SharedState | null;

    /**
     * Lists shared state keys for a given scope.
     * Scope can be "user" (default) or "global".
     */
    static listSharedStates(limit?: number = '-1', scope?: string = '"user"'): Array_Type<string> | null;
  }
}
