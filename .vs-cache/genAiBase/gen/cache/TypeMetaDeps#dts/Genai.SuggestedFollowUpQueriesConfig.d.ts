// TypeScript definitions for the C3 type Genai.SuggestedFollowUpQueriesConfig

/**
 * Describes the config for setting up the SuggestedFollowUpQueries.
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.SuggestedFollowUpQueriesConfig
 */
declare namespace Genai {
  export interface ISuggestedFollowUpQueriesConfig {
    ...
    /**
     * The name of the {@link Genai.UnstructuredQuery.Engine.ModelConfig} to be used for the process of follow queries.
     */
    llmModelName: string;

    /**
     * The {@link Genai.Prompt} that should be used.
     */
    rewriterPrompt: IGenai.Prompt;
 ...
 * Describes the config for setting up the SuggestedFollowUpQueries.
 *
 * @remarks this represents a made instance of Genai.SuggestedFollowUpQueriesConfig
 */
declare namespace Genai {
  export class SuggestedFollowUpQueriesConfig extends Obj  {

    /**
     * The unique and required name of this instance.
     */
    readonly name: string;
    withName(name: string): Genai.SuggestedFollowUpQueriesConfig;

    readonly configOverride?: string;
    withConfigOverride(configOverride: string | null): Genai.SuggestedFollowUpQueriesConfig;

    readonly secretOverride?: string;
    withSecretOverride(secretOverride: string | null): Genai.SuggestedFollowUpQueriesConfig;

    /**
     * Captures any issues that occurred while deserializing from filesystem
     */
    readonly issues?: Array_Type<string>;
    withIssues(issues: Array_Type<string> | Array<string> | null): Genai.SuggestedFollowUpQueriesConfig;

    /**
     * The name of the {@link Genai.UnstructuredQuery.Engine.ModelConfig} to be used for the process of follow queries.
     */
    readonly llmModelName: string;
    withLlmModelName(llmModelName: string): Genai.SuggestedFollowUpQueriesConfig;

    /**
     * The {@link Genai.Prompt} that should be used.
     */
    readonly rewriterPrompt: Genai.Prompt;
    withRewriterPrompt(rewriterPrompt: IGenai.Prompt): Genai.SuggestedFollowUpQueriesConfig;

    /**
     * The maximum number of examples to retrieve.
     */
    readonly nExamples: number;
    withNExamples(nExamples: number): Genai.SuggestedFollowUpQueriesConfig;
    ...
    withMinVectorDistance(minVectorDistance: number | null): Genai.SuggestedFollowUpQueriesConfig;
    ...
    withMaxVectorDistance(maxVectorDistance: number | null): Genai.SuggestedFollowUpQueriesConfig;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.SuggestedFollowUpQueriesConfig | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.SuggestedFollowUpQueriesConfig | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.SuggestedFollowUpQueriesConfig | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.SuggestedFollowUpQueriesConfig | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.SuggestedFollowUpQueriesConfig;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.SuggestedFollowUpQueriesConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.SuggestedFollowUpQueriesConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.SuggestedFollowUpQueriesConfig>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.SuggestedFollowUpQueriesConfig>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.SuggestedFollowUpQueriesConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.SuggestedFollowUpQueriesConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.SuggestedFollowUpQueriesConfig;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.SuggestedFollowUpQueriesConfig;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.SuggestedFollowUpQueriesConfig;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.SuggestedFollowUpQueriesConfig;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.SuggestedFollowUpQueriesConfig;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.SuggestedFollowUpQueriesConfig;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.SuggestedFollowUpQueriesConfig;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.SuggestedFollowUpQueriesConfig;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.SuggestedFollowUpQueriesConfig;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.SuggestedFollowUpQueriesConfig;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.SuggestedFollowUpQueriesConfig;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.SuggestedFollowUpQueriesConfig;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.SuggestedFollowUpQueriesConfig;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.SuggestedFollowUpQueriesConfig;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.SuggestedFollowUpQueriesConfig;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.SuggestedFollowUpQueriesConfig;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.SuggestedFollowUpQueriesConfig;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.SuggestedFollowUpQueriesConfig;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.SuggestedFollowUpQueriesConfig;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.SuggestedFollowUpQueriesConfig;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.SuggestedFollowUpQueriesConfig;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.SuggestedFollowUpQueriesConfig;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.SuggestedFollowUpQueriesConfig;

    mergeJson(json: any): Genai.SuggestedFollowUpQueriesConfig;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.SuggestedFollowUpQueriesConfig;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.SuggestedFollowUpQueriesConfig;
     ...
     */
    singletonArray(): Array_Type<Genai.SuggestedFollowUpQueriesConfig>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.SuggestedFollowUpQueriesConfig> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.SuggestedFollowUpQueriesConfig> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.SuggestedFollowUpQueriesConfig>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.SuggestedFollowUpQueriesConfig> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.SuggestedFollowUpQueriesConfig> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.SuggestedFollowUpQueriesConfig> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.SuggestedFollowUpQueriesConfig>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.SuggestedFollowUpQueriesConfig>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.SuggestedFollowUpQueriesConfig;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.SuggestedFollowUpQueriesConfig;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.SuggestedFollowUpQueriesConfig;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.SuggestedFollowUpQueriesConfig;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.SuggestedFollowUpQueriesConfig;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.SuggestedFollowUpQueriesConfig;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.SuggestedFollowUpQueriesConfig | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.SuggestedFollowUpQueriesConfig;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.SuggestedFollowUpQueriesConfig;
     ...
     */
    static cachedEmptyInst(): Genai.SuggestedFollowUpQueriesConfig;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.SuggestedFollowUpQueriesConfig> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.SuggestedFollowUpQueriesConfig;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.SuggestedFollowUpQueriesConfig | null;
     ...
     */
    static forName(name: string, failIfMissing?: boolean): Genai.SuggestedFollowUpQueriesConfig | null;
     ...
     */
    static allCached(): Stream<Genai.SuggestedFollowUpQueriesConfig> | null;
     ...
     */
    static find(filter?: string): Stream<Genai.SuggestedFollowUpQueriesConfig> | null;
     ...
     *         Otherwise no population will be performed.
     */
    static findBy(field: string, value: any): Stream<Genai.SuggestedFollowUpQueriesConfig> | null;

    /**
     * @return cached instance.
     */
    getCached(): Genai.SuggestedFollowUpQueriesConfig | null;

    /**
     * Returns cached instance by key, with secrets removed.
     */
    static forCacheKey(key: string): Genai.SuggestedFollowUpQueriesConfig | null;
     ...
     */
    static produce(key: string): Genai.SuggestedFollowUpQueriesConfig | null;

    /**
     * Should produces the entire content for the cached data. Will populate the cache with the produced data.
     */
    static produceAll(): Map_Type<string, Genai.SuggestedFollowUpQueriesConfig> | null;
     ...
     */
    getConfig(): Genai.SuggestedFollowUpQueriesConfig;
     ...
     */
    getSecret(): Genai.SuggestedFollowUpQueriesConfig;
     ...
     */
    withConfigKey(configKey: string): Genai.SuggestedFollowUpQueriesConfig;

    /**
     * @return copy without config key.
     */
    withoutConfigKey(): Genai.SuggestedFollowUpQueriesConfig;

    /**
     * @return return cached config instance for provided config key.
     */
    static forConfigKey(configKey: string): Genai.SuggestedFollowUpQueriesConfig | null;
     ...
     */
    static listConfigs(parallel?: boolean, filter?: λPredicate<string>): Stream<Genai.SuggestedFollowUpQueriesConfig> | null;
     ...
     * @see setConfigValue
     */
    setConfigValues(from: Genai.SuggestedFollowUpQueriesConfig, override?: string): void;
     ...
     */
    static loadConfigAndSecret(configKey: string): Genai.SuggestedFollowUpQueriesConfig | null;
