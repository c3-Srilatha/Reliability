// TypeScript definitions for the C3 type Genai.Query.Result.Source.Url

/**
 * A source URL that was used to get information during a query.
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.Query.Result.Source.Url
 */
...
declare namespace Genai.Query.Result.Source {
  export class Url extends Obj  {
    ...
    withTypeIdent(typeIdent: string | null): Genai.Query.Result.Source.Url;
     ...
     */
    readonly id: string;
    withId(id: string): Genai.Query.Result.Source.Url;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Genai.Query.Result.Source.Url;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): Genai.Query.Result.Source.Url;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): Genai.Query.Result.Source.Url;
    ...
    withVersion(version: number | null): Genai.Query.Result.Source.Url;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): Genai.Query.Result.Source.Url;
    ...
    withDisplayName(displayName: string): Genai.Query.Result.Source.Url;
    ...
    withDomain(domain: string): Genai.Query.Result.Source.Url;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.Query.Result.Source.Url | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.Query.Result.Source.Url | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.Query.Result.Source.Url | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.Query.Result.Source.Url | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.Query.Result.Source.Url;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Query.Result.Source.Url;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Query.Result.Source.Url;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Query.Result.Source.Url>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Query.Result.Source.Url>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.Query.Result.Source.Url;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Query.Result.Source.Url;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Query.Result.Source.Url;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.Query.Result.Source.Url;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.Query.Result.Source.Url;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.Query.Result.Source.Url;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.Query.Result.Source.Url;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.Query.Result.Source.Url;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.Query.Result.Source.Url;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.Query.Result.Source.Url;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.Query.Result.Source.Url;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.Query.Result.Source.Url;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.Query.Result.Source.Url;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.Query.Result.Source.Url;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.Query.Result.Source.Url;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.Query.Result.Source.Url;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.Query.Result.Source.Url;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.Query.Result.Source.Url;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.Query.Result.Source.Url;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.Query.Result.Source.Url;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.Query.Result.Source.Url;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.Query.Result.Source.Url;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.Query.Result.Source.Url;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.Query.Result.Source.Url;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.Query.Result.Source.Url;

    mergeJson(json: any): Genai.Query.Result.Source.Url;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.Query.Result.Source.Url;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.Query.Result.Source.Url;
     ...
     */
    singletonArray(): Array_Type<Genai.Query.Result.Source.Url>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.Query.Result.Source.Url> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.Query.Result.Source.Url> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.Query.Result.Source.Url>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.Query.Result.Source.Url> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.Query.Result.Source.Url> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.Query.Result.Source.Url> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.Query.Result.Source.Url>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.Query.Result.Source.Url>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.Query.Result.Source.Url;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.Query.Result.Source.Url;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.Query.Result.Source.Url;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.Query.Result.Source.Url;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.Query.Result.Source.Url;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.Query.Result.Source.Url;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.Query.Result.Source.Url | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.Query.Result.Source.Url;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.Query.Result.Source.Url;
     ...
     */
    static cachedEmptyInst(): Genai.Query.Result.Source.Url;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.Query.Result.Source.Url> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.Query.Result.Source.Url;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<Genai.Query.Result.Source.Url>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Genai.Query.Result.Source.Url>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<Genai.Query.Result.Source.Url> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Genai.Query.Result.Source.Url>> | null;
     ...
     */
    get(include?: string): Genai.Query.Result.Source.Url | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): Genai.Query.Result.Source.Url | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Genai.Query.Result.Source.Url;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): Genai.Query.Result.Source.Url | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Genai.Query.Result.Source.Url;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.Query.Result.Source.Url | null;
     ...
     */
    create(spec?: UpsertSpec): Genai.Query.Result.Source.Url | null;
     ...
     */
    static createBatch(objs: Array_Type<Genai.Query.Result.Source.Url>, spec?: UpsertSpec): ObjList<Genai.Query.Result.Source.Url> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Genai.Query.Result.Source.Url>, spec?: CreateBatchObjStreamSpec): ObjList<Genai.Query.Result.Source.Url> | null;
     ...
     */
    update(srcObj?: Genai.Query.Result.Source.Url, spec?: UpsertSpec): Genai.Query.Result.Source.Url | null;
     ...
     */
    upsert(srcObj?: Genai.Query.Result.Source.Url, spec?: UpsertSpec): Genai.Query.Result.Source.Url | null;
     ...
     */
    merge(spec?: MergeSpec): Genai.Query.Result.Source.Url | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): Genai.Query.Result.Source.Url | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): Genai.Query.Result.Source.Url | null;
     ...
     */
    static updateBatch(objs: Array_Type<Genai.Query.Result.Source.Url>, srcObjs?: Array_Type<Genai.Query.Result.Source.Url>, spec?: UpsertSpec): ObjList<Genai.Query.Result.Source.Url> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<Genai.Query.Result.Source.Url> | null>, spec?: UpsertSpec): ObjList<Genai.Query.Result.Source.Url> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<Genai.Query.Result.Source.Url>, srcObjs?: Array_Type<Genai.Query.Result.Source.Url>, spec?: UpsertSpec): ObjList<Genai.Query.Result.Source.Url> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<Genai.Query.Result.Source.Url> | null>, spec?: UpsertSpec): ObjList<Genai.Query.Result.Source.Url> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<Genai.Query.Result.Source.Url>, spec?: TouchSpec): ObjList<Genai.Query.Result.Source.Url> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.Query.Result.Source.Url>, spec?: MergeSpec): ObjList<Genai.Query.Result.Source.Url> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.Query.Result.Source.Url>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.Query.Result.Source.Url> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<Genai.Query.Result.Source.Url> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.Query.Result.Source.Url> | null;
     ...
     */
    static mergeAll(mergeObj: Genai.Query.Result.Source.Url, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Genai.Query.Result.Source.Url, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<Genai.Query.Result.Source.Url>, spec?: UpsertSpec): ObjList<Genai.Query.Result.Source.Url> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<Genai.Query.Result.Source.Url>, spec?: UpsertSpec): ObjList<Genai.Query.Result.Source.Url> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): Genai.Query.Result.Source.Url | null;
     ...
     */
    static beforeCreate(objs: Array_Type<Genai.Query.Result.Source.Url>): ObjList<Genai.Query.Result.Source.Url>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<Genai.Query.Result.Source.Url>): ObjList<Genai.Query.Result.Source.Url>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<Genai.Query.Result.Source.Url>): ObjList<Genai.Query.Result.Source.Url>;
     ...
     */
    static afterCreate(objs: Array_Type<Genai.Query.Result.Source.Url>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<Genai.Query.Result.Source.Url>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<Genai.Query.Result.Source.Url>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<Genai.Query.Result.Source.Url>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Genai.Query.Result.Source.Url>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Genai.Query.Result.Source.Url | null;
     ...
     */
    withoutIdentity(): Genai.Query.Result.Source.Url | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<Genai.Query.Result.Source.Url>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: Genai.Query.Result.Source.Url, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<Genai.Query.Result.Source.Url>, callback?: λFunction<Genai.Query.Result.Source.Url | null, Genai.Query.Result.Source.Url | null>): ObjList<Genai.Query.Result.Source.Url>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<Genai.Query.Result.Source.Url>, callback?: λFunction<Genai.Query.Result.Source.Url | null, Genai.Query.Result.Source.Url | null>): Array_Type<ObjError> | null;
