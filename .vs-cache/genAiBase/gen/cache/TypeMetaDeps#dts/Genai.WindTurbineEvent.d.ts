// TypeScript definitions for the C3 type Genai.WindTurbineEvent

/**
 * A single event that occurred to or about a single {@link Genai.WindTurbine}.
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.WindTurbineEvent
 */
declare namespace Genai {
  export interface IWindTurbineEvent {
 ...
 */
declare namespace Genai {
  export class WindTurbineEvent extends Obj  {
     ...
     */
    readonly id: string;
    withId(id: string): Genai.WindTurbineEvent;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Genai.WindTurbineEvent;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): Genai.WindTurbineEvent;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): Genai.WindTurbineEvent;
    ...
    withVersion(version: number | null): Genai.WindTurbineEvent;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): Genai.WindTurbineEvent;

    /**
     * The time at which this event started.
     */
    readonly start?: DateTime;
    withStart(start: DateTime | Date | string | null): Genai.WindTurbineEvent;

    /**
     * The time at which this event ended.
     */
    readonly end?: DateTime;
    withEnd(end: DateTime | Date | string | null): Genai.WindTurbineEvent;

    /**
     * The {@link Genai.WindTurbine} connected to this event.
     */
    readonly asset?: Genai.WindTurbine;
    withAsset(asset: IGenai.WindTurbine | null): Genai.WindTurbineEvent;

    /**
     * The code representing the event type.
     */
    readonly eventCode?: string;
    withEventCode(eventCode: string | null): Genai.WindTurbineEvent;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.WindTurbineEvent | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.WindTurbineEvent | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.WindTurbineEvent | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.WindTurbineEvent | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.WindTurbineEvent;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.WindTurbineEvent;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.WindTurbineEvent;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.WindTurbineEvent>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.WindTurbineEvent>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.WindTurbineEvent;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.WindTurbineEvent;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.WindTurbineEvent;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.WindTurbineEvent;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.WindTurbineEvent;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.WindTurbineEvent;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.WindTurbineEvent;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.WindTurbineEvent;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.WindTurbineEvent;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.WindTurbineEvent;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.WindTurbineEvent;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.WindTurbineEvent;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.WindTurbineEvent;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.WindTurbineEvent;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.WindTurbineEvent;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.WindTurbineEvent;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.WindTurbineEvent;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.WindTurbineEvent;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.WindTurbineEvent;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.WindTurbineEvent;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.WindTurbineEvent;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.WindTurbineEvent;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.WindTurbineEvent;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.WindTurbineEvent;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.WindTurbineEvent;

    mergeJson(json: any): Genai.WindTurbineEvent;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.WindTurbineEvent;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.WindTurbineEvent;
     ...
     */
    singletonArray(): Array_Type<Genai.WindTurbineEvent>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.WindTurbineEvent> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.WindTurbineEvent> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.WindTurbineEvent>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.WindTurbineEvent> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.WindTurbineEvent> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.WindTurbineEvent> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.WindTurbineEvent>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.WindTurbineEvent>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.WindTurbineEvent;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.WindTurbineEvent;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.WindTurbineEvent;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.WindTurbineEvent;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.WindTurbineEvent;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.WindTurbineEvent;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.WindTurbineEvent | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.WindTurbineEvent;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.WindTurbineEvent;
     ...
     */
    static cachedEmptyInst(): Genai.WindTurbineEvent;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.WindTurbineEvent> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.WindTurbineEvent;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<Genai.WindTurbineEvent>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Genai.WindTurbineEvent>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<Genai.WindTurbineEvent> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Genai.WindTurbineEvent>> | null;
     ...
     */
    get(include?: string): Genai.WindTurbineEvent | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): Genai.WindTurbineEvent | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Genai.WindTurbineEvent;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): Genai.WindTurbineEvent | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Genai.WindTurbineEvent;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.WindTurbineEvent | null;
     ...
     */
    create(spec?: UpsertSpec): Genai.WindTurbineEvent | null;
     ...
     */
    static createBatch(objs: Array_Type<Genai.WindTurbineEvent>, spec?: UpsertSpec): ObjList<Genai.WindTurbineEvent> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Genai.WindTurbineEvent>, spec?: CreateBatchObjStreamSpec): ObjList<Genai.WindTurbineEvent> | null;
     ...
     */
    update(srcObj?: Genai.WindTurbineEvent, spec?: UpsertSpec): Genai.WindTurbineEvent | null;
     ...
     */
    upsert(srcObj?: Genai.WindTurbineEvent, spec?: UpsertSpec): Genai.WindTurbineEvent | null;
     ...
     */
    merge(spec?: MergeSpec): Genai.WindTurbineEvent | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): Genai.WindTurbineEvent | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): Genai.WindTurbineEvent | null;
     ...
     */
    static updateBatch(objs: Array_Type<Genai.WindTurbineEvent>, srcObjs?: Array_Type<Genai.WindTurbineEvent>, spec?: UpsertSpec): ObjList<Genai.WindTurbineEvent> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<Genai.WindTurbineEvent> | null>, spec?: UpsertSpec): ObjList<Genai.WindTurbineEvent> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<Genai.WindTurbineEvent>, srcObjs?: Array_Type<Genai.WindTurbineEvent>, spec?: UpsertSpec): ObjList<Genai.WindTurbineEvent> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<Genai.WindTurbineEvent> | null>, spec?: UpsertSpec): ObjList<Genai.WindTurbineEvent> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<Genai.WindTurbineEvent>, spec?: TouchSpec): ObjList<Genai.WindTurbineEvent> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.WindTurbineEvent>, spec?: MergeSpec): ObjList<Genai.WindTurbineEvent> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.WindTurbineEvent>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.WindTurbineEvent> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<Genai.WindTurbineEvent> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.WindTurbineEvent> | null;
     ...
     */
    static mergeAll(mergeObj: Genai.WindTurbineEvent, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Genai.WindTurbineEvent, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<Genai.WindTurbineEvent>, spec?: UpsertSpec): ObjList<Genai.WindTurbineEvent> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<Genai.WindTurbineEvent>, spec?: UpsertSpec): ObjList<Genai.WindTurbineEvent> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): Genai.WindTurbineEvent | null;
     ...
     */
    static beforeCreate(objs: Array_Type<Genai.WindTurbineEvent>): ObjList<Genai.WindTurbineEvent>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<Genai.WindTurbineEvent>): ObjList<Genai.WindTurbineEvent>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<Genai.WindTurbineEvent>): ObjList<Genai.WindTurbineEvent>;
     ...
     */
    static afterCreate(objs: Array_Type<Genai.WindTurbineEvent>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<Genai.WindTurbineEvent>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<Genai.WindTurbineEvent>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<Genai.WindTurbineEvent>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Genai.WindTurbineEvent>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Genai.WindTurbineEvent | null;
     ...
     */
    withoutIdentity(): Genai.WindTurbineEvent | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<Genai.WindTurbineEvent>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: Genai.WindTurbineEvent, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<Genai.WindTurbineEvent>, callback?: λFunction<Genai.WindTurbineEvent | null, Genai.WindTurbineEvent | null>): ObjList<Genai.WindTurbineEvent>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<Genai.WindTurbineEvent>, callback?: λFunction<Genai.WindTurbineEvent | null, Genai.WindTurbineEvent | null>): Array_Type<ObjError> | null;
