// TypeScript definitions for the C3 type Genai.Conversation

/**
 * Represents a conversation a user has initiated in the app.
 * A conversation is comprised of a parent query and any follow up chats.
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.Conversation
 */
declare namespace Genai {
  export interface IConversation {

    /**
     * Whether or not object has been marked removed. Note that using "removed" as the attribute instead will cause a
     * C3 package error, as it will override an existing method
     */
    softRemoved?: boolean;
    ...
    /**
     * The initial {@link Genai.Query.Result} of the conversation.
     */
    parentResult: IGenai.Query.Result;

    /**
     * Follow up chat queries associated with the original #parentResult.
     */
    chatMessages?: Array_Type<Genai.Query.ChatMessage> | Array<IGenai.Query.ChatMessage>;

    /**
     * Foreign key to the {@link Genai.Query.Result}s in this conversation.
     */
    queryResults?: Array_Type<Genai.Query.Result> | Array<IGenai.Query.Result>;

    /**
     * The timestamp of the last query from the conversation.
     */
    lastUpdated?: DateTime | Date | string;
  }
}
 ...
 * A conversation is comprised of a parent query and any follow up chats.
 *
 * @remarks this represents a made instance of Genai.Conversation
 */
declare namespace Genai {
  export class Conversation extends Obj  {

    /**
     * Whether or not object has been marked removed. Note that using "removed" as the attribute instead will cause a
     * C3 package error, as it will override an existing method
     */
    readonly softRemoved?: boolean;
    withSoftRemoved(softRemoved: boolean): Genai.Conversation;

    /**
     * The {@link Genai.Project} this instance is linked to.
     */
    readonly projects?: Array_Type<Genai.Project>;
    withProjects(projects: Array_Type<Genai.Project> | Array<IGenai.Project> | null): Genai.Conversation;
     ...
     */
    readonly id: string;
    withId(id: string): Genai.Conversation;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Genai.Conversation;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): Genai.Conversation;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): Genai.Conversation;
    ...
    withVersion(version: number | null): Genai.Conversation;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): Genai.Conversation;

    /**
     * Title of the conversation.
     */
    readonly title?: string;
    withTitle(title: string | null): Genai.Conversation;

    /**
     * The initial {@link Genai.Query.Result} of the conversation.
     */
    readonly parentResult: Genai.Query.Result;
    withParentResult(parentResult: IGenai.Query.Result): Genai.Conversation;

    /**
     * Follow up chat queries associated with the original #parentResult.
     */
    readonly chatMessages?: Array_Type<Genai.Query.ChatMessage>;
    withChatMessages(chatMessages: Array_Type<Genai.Query.ChatMessage> | Array<IGenai.Query.ChatMessage> | null): Genai.Conversation;

    /**
     * Foreign key to the {@link Genai.Query.Result}s in this conversation.
     */
    readonly queryResults?: Array_Type<Genai.Query.Result>;
    withQueryResults(queryResults: Array_Type<Genai.Query.Result> | Array<IGenai.Query.Result> | null): Genai.Conversation;

    /**
     * The timestamp of the last query from the conversation.
     */
    readonly lastUpdated?: DateTime;
    withLastUpdated(lastUpdated: DateTime | Date | string | null): Genai.Conversation;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.Conversation | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.Conversation | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.Conversation | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.Conversation | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.Conversation;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Conversation;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Conversation;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Conversation>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Conversation>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.Conversation;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Conversation;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Conversation;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.Conversation;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.Conversation;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.Conversation;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.Conversation;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.Conversation;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.Conversation;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.Conversation;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.Conversation;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.Conversation;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.Conversation;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.Conversation;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.Conversation;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.Conversation;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.Conversation;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.Conversation;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.Conversation;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.Conversation;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.Conversation;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.Conversation;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.Conversation;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.Conversation;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.Conversation;

    mergeJson(json: any): Genai.Conversation;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.Conversation;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.Conversation;
     ...
     */
    singletonArray(): Array_Type<Genai.Conversation>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.Conversation> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.Conversation> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.Conversation>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.Conversation> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.Conversation> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.Conversation> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.Conversation>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.Conversation>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.Conversation;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.Conversation;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.Conversation;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.Conversation;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.Conversation;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.Conversation;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.Conversation | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.Conversation;
     ...
     */
    static cachedEmptyInst(): Genai.Conversation;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.Conversation> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.Conversation;

    /**
     * Mark the object as removed
     * @return The object with the removed flag set to true
     */
    removeItem(): Genai.Conversation | null;

    /**
     * Fetches conversations for a specific user, ensuring users only see their own conversations.
     * Overrides the ProjectAware implementation to add user-based filtering.
     * @param spec
     *         {@link FetchSpec} for fetching the conversations.
     * @param user
     *         {@link User} for whom to fetch the conversations.
     * @return filtered conversations for the user.
     */
    static fetchForUser(spec?: FetchSpec, user?: User): FetchResult<any>;

    /**
     * Counts conversations for a specific user, ensuring users only see their own conversations.
     * Overrides the ProjectAware implementation to add user-based filtering.
     * @param spec
     *         {@link FetchSpec} for counting the conversations.
     * @param user
     *         {@link User} for whom to count the conversations.
     * @return count of filtered conversations for the user.
     */
    static fetchCountForUser(spec?: FetchSpec, user?: User): number | null;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<Genai.Conversation>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Genai.Conversation>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<Genai.Conversation> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Genai.Conversation>> | null;
     ...
     */
    get(include?: string): Genai.Conversation | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): Genai.Conversation | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Genai.Conversation;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): Genai.Conversation | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Genai.Conversation;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.Conversation | null;
     ...
     */
    create(spec?: UpsertSpec): Genai.Conversation | null;
     ...
     */
    static createBatch(objs: Array_Type<Genai.Conversation>, spec?: UpsertSpec): ObjList<Genai.Conversation> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Genai.Conversation>, spec?: CreateBatchObjStreamSpec): ObjList<Genai.Conversation> | null;
     ...
     */
    update(srcObj?: Genai.Conversation, spec?: UpsertSpec): Genai.Conversation | null;
     ...
     */
    upsert(srcObj?: Genai.Conversation, spec?: UpsertSpec): Genai.Conversation | null;
     ...
     */
    merge(spec?: MergeSpec): Genai.Conversation | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): Genai.Conversation | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): Genai.Conversation | null;
     ...
     */
    static updateBatch(objs: Array_Type<Genai.Conversation>, srcObjs?: Array_Type<Genai.Conversation>, spec?: UpsertSpec): ObjList<Genai.Conversation> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<Genai.Conversation> | null>, spec?: UpsertSpec): ObjList<Genai.Conversation> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<Genai.Conversation>, srcObjs?: Array_Type<Genai.Conversation>, spec?: UpsertSpec): ObjList<Genai.Conversation> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<Genai.Conversation> | null>, spec?: UpsertSpec): ObjList<Genai.Conversation> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<Genai.Conversation>, spec?: TouchSpec): ObjList<Genai.Conversation> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.Conversation>, spec?: MergeSpec): ObjList<Genai.Conversation> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.Conversation>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.Conversation> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<Genai.Conversation> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.Conversation> | null;
     ...
     */
    static mergeAll(mergeObj: Genai.Conversation, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Genai.Conversation, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<Genai.Conversation>, spec?: UpsertSpec): ObjList<Genai.Conversation> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<Genai.Conversation>, spec?: UpsertSpec): ObjList<Genai.Conversation> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): Genai.Conversation | null;
     ...
     */
    static beforeCreate(objs: Array_Type<Genai.Conversation>): ObjList<Genai.Conversation>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<Genai.Conversation>): ObjList<Genai.Conversation>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<Genai.Conversation>): ObjList<Genai.Conversation>;
     ...
     */
    static afterCreate(objs: Array_Type<Genai.Conversation>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<Genai.Conversation>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<Genai.Conversation>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<Genai.Conversation>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Genai.Conversation>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Genai.Conversation | null;
     ...
     */
    withoutIdentity(): Genai.Conversation | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<Genai.Conversation>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: Genai.Conversation, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<Genai.Conversation>, callback?: λFunction<Genai.Conversation | null, Genai.Conversation | null>): ObjList<Genai.Conversation>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<Genai.Conversation>, callback?: λFunction<Genai.Conversation | null, Genai.Conversation | null>): Array_Type<ObjError> | null;
    ...
    /**
     * Creates a new {@link Genai.Conversation} entity with the given {@link Genai.Query.Result}.
     * @param queryResult
     *      The first {@link Genai.Query.Result} in the conversation.
     * @return
     *      The same {@link Genai.Query.Result} with an updated {@link Genai.Query.Result#conversation} field.
     */
    static startConversation(queryResult: Genai.Query.Result): Genai.Query.Result;

    /**
     * Applies the {@link Genai.Conversation} from the parent {{@link Genai.Query.Result#conversation} to the follow-up
     * query's {@link Genai.Query.Result#conversation} field.
     * @param queryResult
     *      The follow-up {@link Genai.Query.Result} in the conversation.
     * @param parentQueryResult
     *      The original {@link Genai.Query.Result} that started the conversation.
     * @return
     *      The same {@link Genai.Query.Result} with an updated {@link Genai.Query.Result#conversation} field.
     */
    static continueConversation(queryResult: Genai.Query.Result, parentQueryResult: Genai.Query.Result): Genai.Query.Result;
     ...
     * @return
     *      The conversation entity with the new title.
     */
    rename(title: string): Genai.Conversation;

    /**
     * Returns a {@link Genai.Conversation} with the appropriate #parentResult and #chatMessages.
     * @param queryResult
     *      The result of the query that initiated the conversation.
     * @param hideEditedResults
     *      Whether the conversation should hide edited results.
     * @param fullResult
     *     Whether the conversation should include all fields in the result or only the main ones needed in the feed.
     */
    static forResult(queryResult: Genai.Query.Result, hideEditedResults?: boolean, fullResult?: boolean): Genai.Conversation;

    /**
     * Returns a string that include all the fields needs to be included in the query for UI.
     * @param fullResult
     *     Whether to include all fields in the result or only the main ones needed in the feed.
     */
    static queryResultIncludeString(fullResult?: boolean): string;

    /**
     * Gets the fields needed for the definition list on the query detail page.
     */
    static getFieldsForConversationDetailPage(queryResult: Genai.Query.Result): any;

    /**
     * Calculates the latency for {@link Genai.Conversation}.
     */
    static calculateLatency(result: Genai.Query.Result): number | null;
  }
}
