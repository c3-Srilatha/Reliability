// TypeScript definitions for the C3 type Genai.UnstructuredQuery.Engine.Config
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.UnstructuredQuery.Engine.Config
 */
declare namespace Genai.UnstructuredQuery.Engine {
 ...
 * after setting the config for the new value to take effect.
 *
 * @remarks this represents a made instance of Genai.UnstructuredQuery.Engine.Config
 */
declare namespace Genai.UnstructuredQuery.Engine {
  export class Config extends Obj  {
    ...
    withName(name: string): Genai.UnstructuredQuery.Engine.Config;
    ...
    withConfigOverride(configOverride: string | null): Genai.UnstructuredQuery.Engine.Config;

    static readonly configOverride?: string;

    readonly secretOverride?: string;
    withSecretOverride(secretOverride: string | null): Genai.UnstructuredQuery.Engine.Config;
    ...
    withIssues(issues: Array_Type<string> | Array<string> | null): Genai.UnstructuredQuery.Engine.Config;
    ...
    withVectorStore(vectorStore: IGenai.Retriever | null): Genai.UnstructuredQuery.Engine.Config;
    ...
    withNumPassages(numPassages: number): Genai.UnstructuredQuery.Engine.Config;
    ...
    withSuppressSourceRelations(suppressSourceRelations: boolean): Genai.UnstructuredQuery.Engine.Config;
    ...
    withCreateUrlSourceRelations(createUrlSourceRelations: boolean): Genai.UnstructuredQuery.Engine.Config;
    ...
    withDeploySpec(deploySpec: IEngine.DeploySpec | null): Genai.UnstructuredQuery.Engine.Config;
    ...
    withModelConfigName(modelConfigName: string): Genai.UnstructuredQuery.Engine.Config;

    /**
     * Name of {@link Genai.UnstructuredQuery.Engine.ModelConfig} that should be used by the Genai.UnstructuredQuery.Engine.
     */
    static readonly modelConfigName: string;

    /**
     * Name of {@link Genai.UnstructuredQuery.Engine.REA.ChatMemoryConfig} that should be used by the Genai.UnstructuredQuery.Engine for chat memory (if applicable)
     */
    readonly chatMemoryConfigName?: string;
    withChatMemoryConfigName(chatMemoryConfigName: string | null): Genai.UnstructuredQuery.Engine.Config;

    /**
     * Name of {@link Genai.UnstructuredQuery.Engine.REA.ChatMemoryConfig} that should be used by the Genai.UnstructuredQuery.Engine for chat memory (if applicable)
     */
    static readonly chatMemoryConfigName?: string;

    /**
     * Name of {@link Genai.UnstructuredQuery.Engine.ModelConfig} that should be used by the Genai.UnstructuredQuery.Engine for extraction (if applicable)
     */
    readonly extractionModelConfigName?: string;
    withExtractionModelConfigName(extractionModelConfigName: string | null): Genai.UnstructuredQuery.Engine.Config;

    /**
     * Name of {@link Genai.UnstructuredQuery.Engine.ModelConfig} that should be used by the Genai.UnstructuredQuery.Engine for extraction (if applicable)
     */
    static readonly extractionModelConfigName?: string;

    /**
     * The Question Answerer Config {@link Genai.UnstructuredQuery.Engine.REA.QuestionRewritingConfig} name.
     */
    readonly questionRewritingConfigName: string;
    withQuestionRewritingConfigName(questionRewritingConfigName: string): Genai.UnstructuredQuery.Engine.Config;
     ...
     * Parameters to be passed to the executor
     */
    readonly executorParams: any;
    withExecutorParams(executorParams: any): Genai.UnstructuredQuery.Engine.Config;

    /**
     * Parameters to be passed to the executor
     */
    static readonly executorParams: any;

    /**
     * The Retriever config {@link Genai.UnstructuredQuery.Engine.REA.RetrieverConfig} name.
     */
    readonly retrieverConfigName: string;
    withRetrieverConfigName(retrieverConfigName: string): Genai.UnstructuredQuery.Engine.Config;
    ...
    withExtractionConfigName(extractionConfigName: string | null): Genai.UnstructuredQuery.Engine.Config;
    ...
    withRerankerConfigName(rerankerConfigName: string | null): Genai.UnstructuredQuery.Engine.Config;
    ...
    withQuestionAnsweringConfigName(questionAnsweringConfigName: string): Genai.UnstructuredQuery.Engine.Config;
    ...
    withChatWithFullHistory(chatWithFullHistory: boolean): Genai.UnstructuredQuery.Engine.Config;
    ...
    withAttributionSpec(attributionSpec: IGenai.Agent.Tool.Util.Attributor.Spec | null): Genai.UnstructuredQuery.Engine.Config;
    ...
    withEngineThreadPoolSpec(engineThreadPoolSpec: IApp.Node.ThreadPool.Spec | null): Genai.UnstructuredQuery.Engine.Config;
    ...
    withStreamTimeoutSeconds(streamTimeoutSeconds: number | null): Genai.UnstructuredQuery.Engine.Config;
     ...
     */
    static inst(): Genai.UnstructuredQuery.Engine.Config;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.UnstructuredQuery.Engine.Config | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.UnstructuredQuery.Engine.Config | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.UnstructuredQuery.Engine.Config | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.UnstructuredQuery.Engine.Config | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.UnstructuredQuery.Engine.Config;
     ...
     * This method is used during live metadata update
     */
    static replaceType(old: Type, new_: Type): Genai.UnstructuredQuery.Engine.Config;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.UnstructuredQuery.Engine.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.UnstructuredQuery.Engine.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.UnstructuredQuery.Engine.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.UnstructuredQuery.Engine.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.UnstructuredQuery.Engine.Config>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.UnstructuredQuery.Engine.Config>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.UnstructuredQuery.Engine.Config>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.UnstructuredQuery.Engine.Config>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.UnstructuredQuery.Engine.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.UnstructuredQuery.Engine.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.UnstructuredQuery.Engine.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.UnstructuredQuery.Engine.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.UnstructuredQuery.Engine.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.UnstructuredQuery.Engine.Config;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.UnstructuredQuery.Engine.Config;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    static validateObj(): Genai.UnstructuredQuery.Engine.Config;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.UnstructuredQuery.Engine.Config;
     ...
     * @see #defaultField
     */
    static withField(field: string, value: any, doNotConvert?: boolean): Genai.UnstructuredQuery.Engine.Config;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.UnstructuredQuery.Engine.Config;
     ...
     * @see #defaultField
     */
    static withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.UnstructuredQuery.Engine.Config;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.UnstructuredQuery.Engine.Config;
     ...
     * @return new Obj
     */
    static withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.UnstructuredQuery.Engine.Config;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.UnstructuredQuery.Engine.Config;
     ...
     * @return new Obj
     */
    static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.UnstructuredQuery.Engine.Config;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.UnstructuredQuery.Engine.Config;
     ...
     * @see #withoutField
     */
    static withoutFieldAtPath(path: string): Genai.UnstructuredQuery.Engine.Config;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.UnstructuredQuery.Engine.Config;
     ...
     * @see #removeField
     */
    static withoutField(field: string): Genai.UnstructuredQuery.Engine.Config;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.UnstructuredQuery.Engine.Config;
     ...
     * @see #removeField
     */
    static withoutField(field: FieldType): Genai.UnstructuredQuery.Engine.Config;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.UnstructuredQuery.Engine.Config;
     ...
     * @return new Obj with removed fields
     */
    static withoutFields(fields: Array_Type<string>): Genai.UnstructuredQuery.Engine.Config;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.UnstructuredQuery.Engine.Config;
     ...
     * @return new Obj with removed fields
     */
    static withoutFieldsByType(fields: Array_Type<FieldType>): Genai.UnstructuredQuery.Engine.Config;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.UnstructuredQuery.Engine.Config;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    static withoutSecretFields(): Genai.UnstructuredQuery.Engine.Config;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.UnstructuredQuery.Engine.Config;
     ...
     * @see FieldType#defaultValue
     */
    static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.UnstructuredQuery.Engine.Config;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.UnstructuredQuery.Engine.Config;
     ...
     * @see #unsetField
     */
    static defaultField(field: string): Genai.UnstructuredQuery.Engine.Config;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.UnstructuredQuery.Engine.Config;
     ...
     * @see #unsetField
     */
    static defaultField(field: FieldType): Genai.UnstructuredQuery.Engine.Config;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.UnstructuredQuery.Engine.Config;
     ...
     * @see #removeField
     */
    static unsetField(field: string): Genai.UnstructuredQuery.Engine.Config;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.UnstructuredQuery.Engine.Config;
     ...
     * @see #removeField
     */
    static unsetField(field: FieldType): Genai.UnstructuredQuery.Engine.Config;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.UnstructuredQuery.Engine.Config;
     ...
     * @see #unsetField
     */
    static removeField(field: string): Genai.UnstructuredQuery.Engine.Config;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.UnstructuredQuery.Engine.Config;
     ...
     * @see #unsetField
     */
    static removeField(field: FieldType): Genai.UnstructuredQuery.Engine.Config;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.UnstructuredQuery.Engine.Config;
     ...
     * @return the new merged Obj
     */
    static mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.UnstructuredQuery.Engine.Config;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.UnstructuredQuery.Engine.Config;
     ...
     * @return the new merged Obj
     */
    static mergeObj(other: Obj, otherFieldsFilter: Type): Genai.UnstructuredQuery.Engine.Config;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.UnstructuredQuery.Engine.Config;
     ...
     *        the same key or index.
     */
    static mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.UnstructuredQuery.Engine.Config;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.UnstructuredQuery.Engine.Config;
     ...
     * traverse child reference and collection fields.
     */
    static mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.UnstructuredQuery.Engine.Config;

    mergeJson(json: any): Genai.UnstructuredQuery.Engine.Config;

    static mergeJson(json: any): Genai.UnstructuredQuery.Engine.Config;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.UnstructuredQuery.Engine.Config;
     ...
     * @return Obj with child references merged
     */
    static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.UnstructuredQuery.Engine.Config;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.UnstructuredQuery.Engine.Config;
     ...
     * references with same name and collection elements at same index or key.
     */
    static sumObj(other: Obj, deep?: boolean): Genai.UnstructuredQuery.Engine.Config;
     ...
     */
    singletonArray(): Array_Type<Genai.UnstructuredQuery.Engine.Config>;
     ...
     * @return new array instance with this as only element.
     */
    static singletonArray(): Array_Type<Genai.UnstructuredQuery.Engine.Config>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.UnstructuredQuery.Engine.Config> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.UnstructuredQuery.Engine.Config> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.UnstructuredQuery.Engine.Config>;
     ...
     * @return new array instance with this as only element.
     */
    static singletonSet(): Set_Type<Genai.UnstructuredQuery.Engine.Config>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.UnstructuredQuery.Engine.Config> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.UnstructuredQuery.Engine.Config> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.UnstructuredQuery.Engine.Config> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.UnstructuredQuery.Engine.Config>;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    static toBuilder(): ObjBuilder<Genai.UnstructuredQuery.Engine.Config>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.UnstructuredQuery.Engine.Config>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.UnstructuredQuery.Engine.Config;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.UnstructuredQuery.Engine.Config;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.UnstructuredQuery.Engine.Config;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.UnstructuredQuery.Engine.Config;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.UnstructuredQuery.Engine.Config;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.UnstructuredQuery.Engine.Config;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.UnstructuredQuery.Engine.Config | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.UnstructuredQuery.Engine.Config;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.UnstructuredQuery.Engine.Config;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    static afterMake(): Genai.UnstructuredQuery.Engine.Config;
     ...
     */
    static cachedEmptyInst(): Genai.UnstructuredQuery.Engine.Config;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.UnstructuredQuery.Engine.Config> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.UnstructuredQuery.Engine.Config;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.UnstructuredQuery.Engine.Config | null;
     ...
     */
    static forName(name: string, failIfMissing?: boolean): Genai.UnstructuredQuery.Engine.Config | null;
     ...
     */
    static allCached(): Stream<Genai.UnstructuredQuery.Engine.Config> | null;
     ...
     */
    static find(filter?: string): Stream<Genai.UnstructuredQuery.Engine.Config> | null;
     ...
     *         Otherwise no population will be performed.
     */
    static findBy(field: string, value: any): Stream<Genai.UnstructuredQuery.Engine.Config> | null;

    /**
     * @return cached instance.
     */
    getCached(): Genai.UnstructuredQuery.Engine.Config | null;

    /**
     * @return cached instance.
     */
    static getCached(): Genai.UnstructuredQuery.Engine.Config | null;

    /**
     * Returns cached instance by key, with secrets removed.
     */
    static forCacheKey(key: string): Genai.UnstructuredQuery.Engine.Config | null;
     ...
     */
    static produce(key: string): Genai.UnstructuredQuery.Engine.Config | null;

    /**
     * Should produces the entire content for the cached data. Will populate the cache with the produced data.
     */
    static produceAll(): Map_Type<string, Genai.UnstructuredQuery.Engine.Config> | null;
     ...
     */
    getConfig(): Genai.UnstructuredQuery.Engine.Config;
     ...
     * Note that typical pattern is to use Configurable#config instead of this method.
     */
    static getConfig(): Genai.UnstructuredQuery.Engine.Config;
     ...
     */
    getSecret(): Genai.UnstructuredQuery.Engine.Config;
     ...
     * Note that typical pattern is to use Configurable#configWithSecrets instead of this method.
     */
    static getSecret(): Genai.UnstructuredQuery.Engine.Config;
     ...
     */
    withConfigKey(configKey: string): Genai.UnstructuredQuery.Engine.Config;
     ...
     *     config.configKey() => "folder1/abc"
     */
    static withConfigKey(configKey: string): Genai.UnstructuredQuery.Engine.Config;

    /**
     * @return copy without config key.
     */
    withoutConfigKey(): Genai.UnstructuredQuery.Engine.Config;

    /**
     * @return copy without config key.
     */
    static withoutConfigKey(): Genai.UnstructuredQuery.Engine.Config;

    /**
     * @return return cached config instance for provided config key.
     */
    static forConfigKey(configKey: string): Genai.UnstructuredQuery.Engine.Config | null;
     ...
     */
    static listConfigs(parallel?: boolean, filter?: λPredicate<string>): Stream<Genai.UnstructuredQuery.Engine.Config> | null;
     ...
     * @see setConfigValue
     */
    setConfigValues(from: Genai.UnstructuredQuery.Engine.Config, override?: string): void;
     ...
     * @see setConfigValue
     */
    static setConfigValues(from: Genai.UnstructuredQuery.Engine.Config, override?: string): void;
     ...
     */
    static loadConfigAndSecret(configKey: string): Genai.UnstructuredQuery.Engine.Config | null;
     ...
     */
    removeSecrets(): Genai.UnstructuredQuery.Engine.Config | null;

    /**
     * @return this config without any secret values.
     */
    static removeSecrets(): Genai.UnstructuredQuery.Engine.Config | null;

    /**
     * @return this config with only secret values.
     */
    removeNonSecrets(): Genai.UnstructuredQuery.Engine.Config | null;

    /**
     * @return this config with only secret values.
     */
    static removeNonSecrets(): Genai.UnstructuredQuery.Engine.Config | null;

    /**
     * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
     * validation and setup.
     */
    validate(): Genai.UnstructuredQuery.Engine.Config;

    /**
     * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
     * validation and setup.
     */
    static validate(): Genai.UnstructuredQuery.Engine.Config;
     ...
     */
    static setRecursive(configJson: any, useSetConfigValues?: boolean, override?: string): Genai.UnstructuredQuery.Engine.Config;
     ...
     */
    static setDefault(configName: string): void;
     ...
     */
    static setReaConfigsBySuffix(suffix?: string): Array_Type<Genai.UnstructuredQuery.Engine.REA.RerankerConfig | Genai.UnstructuredQuery.Engine.REA.ExtractorConfig | Genai.UnstructuredQuery.Engine.REA.ContextualQaConfig | Genai.UnstructuredQuery.Engine.REA.QuestionRewritingConfig>;
     ...
     * * 'hosted'
     */
    static populateReaEngineConfigs(): void;
  }
}
