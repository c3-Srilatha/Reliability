// TypeScript definitions for the C3 type Genai.FewShotExample.StructuredQuery

/**
 * Persists few-shot examples for structured query tools along with its embedding in pgvector.
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.FewShotExample.StructuredQuery
 */
 ...
 */
declare namespace Genai.FewShotExample {
  export class StructuredQuery extends Obj  {
    ...
    withTypeIdent(typeIdent: string | null): Genai.FewShotExample.StructuredQuery;
     ...
     */
    readonly id: string;
    withId(id: string): Genai.FewShotExample.StructuredQuery;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Genai.FewShotExample.StructuredQuery;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): Genai.FewShotExample.StructuredQuery;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): Genai.FewShotExample.StructuredQuery;
    ...
    withVersion(version: number | null): Genai.FewShotExample.StructuredQuery;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): Genai.FewShotExample.StructuredQuery;

    /**
     * The query associated with the example.
     */
    readonly query: string;
    withQuery(query: string): Genai.FewShotExample.StructuredQuery;

    /**
     * An E5 embedding of the query.
     */
    readonly emb?: string;
    withEmb(emb: string | null): Genai.FewShotExample.StructuredQuery;

    /**
     * Flag indicating if this was added manually or by an automatic process.
     */
    readonly manuallyAdded?: boolean;
    withManuallyAdded(manuallyAdded: boolean): Genai.FewShotExample.StructuredQuery;
    ...
    withProject(project: IGenai.Project | null): Genai.FewShotExample.StructuredQuery;

    /**
     * The {@link User} who created the {@link Genai.FewShotExample}.
     */
    readonly createdBy?: User;
    withCreatedBy(createdBy: IUser | null): Genai.FewShotExample.StructuredQuery;

    /**
     * The {@link EvalSpec}, {@link EvaluateSpec} or {@link EvalMetricsSpec} that answers the query.
     */
    readonly spec: Genai.StructuredQuery.Spec;
    withSpec(spec: IGenai.StructuredQuery.Spec): Genai.FewShotExample.StructuredQuery;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.FewShotExample.StructuredQuery | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.FewShotExample.StructuredQuery | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.FewShotExample.StructuredQuery | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.FewShotExample.StructuredQuery | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.FewShotExample.StructuredQuery;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.FewShotExample.StructuredQuery;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.FewShotExample.StructuredQuery;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.FewShotExample.StructuredQuery>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.FewShotExample.StructuredQuery>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.FewShotExample.StructuredQuery;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.FewShotExample.StructuredQuery;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.FewShotExample.StructuredQuery;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.FewShotExample.StructuredQuery;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.FewShotExample.StructuredQuery;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.FewShotExample.StructuredQuery;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.FewShotExample.StructuredQuery;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.FewShotExample.StructuredQuery;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.FewShotExample.StructuredQuery;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.FewShotExample.StructuredQuery;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.FewShotExample.StructuredQuery;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.FewShotExample.StructuredQuery;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.FewShotExample.StructuredQuery;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.FewShotExample.StructuredQuery;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.FewShotExample.StructuredQuery;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.FewShotExample.StructuredQuery;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.FewShotExample.StructuredQuery;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.FewShotExample.StructuredQuery;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.FewShotExample.StructuredQuery;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.FewShotExample.StructuredQuery;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.FewShotExample.StructuredQuery;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.FewShotExample.StructuredQuery;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.FewShotExample.StructuredQuery;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.FewShotExample.StructuredQuery;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.FewShotExample.StructuredQuery;

    mergeJson(json: any): Genai.FewShotExample.StructuredQuery;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.FewShotExample.StructuredQuery;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.FewShotExample.StructuredQuery;
     ...
     */
    singletonArray(): Array_Type<Genai.FewShotExample.StructuredQuery>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.FewShotExample.StructuredQuery> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.FewShotExample.StructuredQuery> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.FewShotExample.StructuredQuery>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.FewShotExample.StructuredQuery> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.FewShotExample.StructuredQuery> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.FewShotExample.StructuredQuery> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.FewShotExample.StructuredQuery>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.FewShotExample.StructuredQuery>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.FewShotExample.StructuredQuery;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.FewShotExample.StructuredQuery;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.FewShotExample.StructuredQuery;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.FewShotExample.StructuredQuery;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.FewShotExample.StructuredQuery;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.FewShotExample.StructuredQuery;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.FewShotExample.StructuredQuery | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.FewShotExample.StructuredQuery;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.FewShotExample.StructuredQuery;
     ...
     */
    static cachedEmptyInst(): Genai.FewShotExample.StructuredQuery;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.FewShotExample.StructuredQuery> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.FewShotExample.StructuredQuery;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<Genai.FewShotExample.StructuredQuery>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Genai.FewShotExample.StructuredQuery>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<Genai.FewShotExample.StructuredQuery> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Genai.FewShotExample.StructuredQuery>> | null;
     ...
     */
    get(include?: string): Genai.FewShotExample.StructuredQuery | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): Genai.FewShotExample.StructuredQuery | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Genai.FewShotExample.StructuredQuery;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): Genai.FewShotExample.StructuredQuery | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Genai.FewShotExample.StructuredQuery;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.FewShotExample.StructuredQuery | null;
     ...
     */
    create(spec?: UpsertSpec): Genai.FewShotExample.StructuredQuery | null;
     ...
     */
    static createBatch(objs: Array_Type<Genai.FewShotExample.StructuredQuery>, spec?: UpsertSpec): ObjList<Genai.FewShotExample.StructuredQuery> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Genai.FewShotExample.StructuredQuery>, spec?: CreateBatchObjStreamSpec): ObjList<Genai.FewShotExample.StructuredQuery> | null;
     ...
     */
    update(srcObj?: Genai.FewShotExample.StructuredQuery, spec?: UpsertSpec): Genai.FewShotExample.StructuredQuery | null;
     ...
     */
    upsert(srcObj?: Genai.FewShotExample.StructuredQuery, spec?: UpsertSpec): Genai.FewShotExample.StructuredQuery | null;
     ...
     */
    merge(spec?: MergeSpec): Genai.FewShotExample.StructuredQuery | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): Genai.FewShotExample.StructuredQuery | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): Genai.FewShotExample.StructuredQuery | null;
     ...
     */
    static updateBatch(objs: Array_Type<Genai.FewShotExample.StructuredQuery>, srcObjs?: Array_Type<Genai.FewShotExample.StructuredQuery>, spec?: UpsertSpec): ObjList<Genai.FewShotExample.StructuredQuery> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<Genai.FewShotExample.StructuredQuery> | null>, spec?: UpsertSpec): ObjList<Genai.FewShotExample.StructuredQuery> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<Genai.FewShotExample.StructuredQuery>, srcObjs?: Array_Type<Genai.FewShotExample.StructuredQuery>, spec?: UpsertSpec): ObjList<Genai.FewShotExample.StructuredQuery> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<Genai.FewShotExample.StructuredQuery> | null>, spec?: UpsertSpec): ObjList<Genai.FewShotExample.StructuredQuery> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<Genai.FewShotExample.StructuredQuery>, spec?: TouchSpec): ObjList<Genai.FewShotExample.StructuredQuery> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.FewShotExample.StructuredQuery>, spec?: MergeSpec): ObjList<Genai.FewShotExample.StructuredQuery> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.FewShotExample.StructuredQuery>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.FewShotExample.StructuredQuery> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<Genai.FewShotExample.StructuredQuery> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.FewShotExample.StructuredQuery> | null;
     ...
     */
    static mergeAll(mergeObj: Genai.FewShotExample.StructuredQuery, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Genai.FewShotExample.StructuredQuery, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<Genai.FewShotExample.StructuredQuery>, spec?: UpsertSpec): ObjList<Genai.FewShotExample.StructuredQuery> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<Genai.FewShotExample.StructuredQuery>, spec?: UpsertSpec): ObjList<Genai.FewShotExample.StructuredQuery> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): Genai.FewShotExample.StructuredQuery | null;
     ...
     */
    static beforeCreate(objs: Array_Type<Genai.FewShotExample.StructuredQuery>): ObjList<Genai.FewShotExample.StructuredQuery>;
     ...
     */
    static beforeUpdate(objs: Array_Type<Genai.FewShotExample.StructuredQuery>): ObjList<Genai.FewShotExample.StructuredQuery>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<Genai.FewShotExample.StructuredQuery>): ObjList<Genai.FewShotExample.StructuredQuery>;
     ...
     */
    static afterCreate(objs: Array_Type<Genai.FewShotExample.StructuredQuery>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<Genai.FewShotExample.StructuredQuery>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<Genai.FewShotExample.StructuredQuery>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<Genai.FewShotExample.StructuredQuery>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Genai.FewShotExample.StructuredQuery>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Genai.FewShotExample.StructuredQuery | null;
     ...
     */
    withoutIdentity(): Genai.FewShotExample.StructuredQuery | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<Genai.FewShotExample.StructuredQuery>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: Genai.FewShotExample.StructuredQuery, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<Genai.FewShotExample.StructuredQuery>, callback?: λFunction<Genai.FewShotExample.StructuredQuery | null, Genai.FewShotExample.StructuredQuery | null>): ObjList<Genai.FewShotExample.StructuredQuery>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<Genai.FewShotExample.StructuredQuery>, callback?: λFunction<Genai.FewShotExample.StructuredQuery | null, Genai.FewShotExample.StructuredQuery | null>): Array_Type<ObjError> | null;
     ...
     */
    static addEmbeddingsForQueries(objs: Array_Type<Genai.FewShotExample>, queries: Array_Type<string>): ObjList<Genai.FewShotExample.StructuredQuery>;
