// TypeScript definitions for the C3 type Genai.GpsCoordinates

/**
 * Stores location as set of latitude and longitude coordinates.
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.GpsCoordinates
 */
 ...
 */
declare namespace Genai {
  export class GpsCoordinates extends Obj  {
     ...
     */
    readonly id: string;
    withId(id: string): Genai.GpsCoordinates;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Genai.GpsCoordinates;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): Genai.GpsCoordinates;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): Genai.GpsCoordinates;
    ...
    withVersion(version: number | null): Genai.GpsCoordinates;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): Genai.GpsCoordinates;

    /**
     * Latitude of the coordinate
     */
    readonly latitude?: number;
    withLatitude(latitude: number | null): Genai.GpsCoordinates;

    /**
     * Longitude of the coordinate
     */
    readonly longitude?: number;
    withLongitude(longitude: number | null): Genai.GpsCoordinates;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.GpsCoordinates | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.GpsCoordinates | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.GpsCoordinates | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.GpsCoordinates | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.GpsCoordinates;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.GpsCoordinates;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.GpsCoordinates;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.GpsCoordinates>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.GpsCoordinates>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.GpsCoordinates;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.GpsCoordinates;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.GpsCoordinates;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.GpsCoordinates;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.GpsCoordinates;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.GpsCoordinates;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.GpsCoordinates;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.GpsCoordinates;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.GpsCoordinates;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.GpsCoordinates;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.GpsCoordinates;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.GpsCoordinates;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.GpsCoordinates;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.GpsCoordinates;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.GpsCoordinates;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.GpsCoordinates;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.GpsCoordinates;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.GpsCoordinates;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.GpsCoordinates;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.GpsCoordinates;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.GpsCoordinates;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.GpsCoordinates;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.GpsCoordinates;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.GpsCoordinates;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.GpsCoordinates;

    mergeJson(json: any): Genai.GpsCoordinates;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.GpsCoordinates;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.GpsCoordinates;
     ...
     */
    singletonArray(): Array_Type<Genai.GpsCoordinates>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.GpsCoordinates> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.GpsCoordinates> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.GpsCoordinates>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.GpsCoordinates> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.GpsCoordinates> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.GpsCoordinates> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.GpsCoordinates>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.GpsCoordinates>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.GpsCoordinates;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.GpsCoordinates;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.GpsCoordinates;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.GpsCoordinates;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.GpsCoordinates;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.GpsCoordinates;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.GpsCoordinates | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.GpsCoordinates;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.GpsCoordinates;
     ...
     */
    static cachedEmptyInst(): Genai.GpsCoordinates;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.GpsCoordinates> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.GpsCoordinates;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<Genai.GpsCoordinates>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Genai.GpsCoordinates>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<Genai.GpsCoordinates> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Genai.GpsCoordinates>> | null;
     ...
     */
    get(include?: string): Genai.GpsCoordinates | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): Genai.GpsCoordinates | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Genai.GpsCoordinates;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): Genai.GpsCoordinates | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Genai.GpsCoordinates;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.GpsCoordinates | null;
     ...
     */
    create(spec?: UpsertSpec): Genai.GpsCoordinates | null;
     ...
     */
    static createBatch(objs: Array_Type<Genai.GpsCoordinates>, spec?: UpsertSpec): ObjList<Genai.GpsCoordinates> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Genai.GpsCoordinates>, spec?: CreateBatchObjStreamSpec): ObjList<Genai.GpsCoordinates> | null;
     ...
     */
    update(srcObj?: Genai.GpsCoordinates, spec?: UpsertSpec): Genai.GpsCoordinates | null;
     ...
     */
    upsert(srcObj?: Genai.GpsCoordinates, spec?: UpsertSpec): Genai.GpsCoordinates | null;
     ...
     */
    merge(spec?: MergeSpec): Genai.GpsCoordinates | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): Genai.GpsCoordinates | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): Genai.GpsCoordinates | null;
     ...
     */
    static updateBatch(objs: Array_Type<Genai.GpsCoordinates>, srcObjs?: Array_Type<Genai.GpsCoordinates>, spec?: UpsertSpec): ObjList<Genai.GpsCoordinates> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<Genai.GpsCoordinates> | null>, spec?: UpsertSpec): ObjList<Genai.GpsCoordinates> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<Genai.GpsCoordinates>, srcObjs?: Array_Type<Genai.GpsCoordinates>, spec?: UpsertSpec): ObjList<Genai.GpsCoordinates> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<Genai.GpsCoordinates> | null>, spec?: UpsertSpec): ObjList<Genai.GpsCoordinates> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<Genai.GpsCoordinates>, spec?: TouchSpec): ObjList<Genai.GpsCoordinates> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.GpsCoordinates>, spec?: MergeSpec): ObjList<Genai.GpsCoordinates> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.GpsCoordinates>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.GpsCoordinates> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<Genai.GpsCoordinates> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.GpsCoordinates> | null;
     ...
     */
    static mergeAll(mergeObj: Genai.GpsCoordinates, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Genai.GpsCoordinates, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<Genai.GpsCoordinates>, spec?: UpsertSpec): ObjList<Genai.GpsCoordinates> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<Genai.GpsCoordinates>, spec?: UpsertSpec): ObjList<Genai.GpsCoordinates> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): Genai.GpsCoordinates | null;
     ...
     */
    static beforeCreate(objs: Array_Type<Genai.GpsCoordinates>): ObjList<Genai.GpsCoordinates>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<Genai.GpsCoordinates>): ObjList<Genai.GpsCoordinates>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<Genai.GpsCoordinates>): ObjList<Genai.GpsCoordinates>;
     ...
     */
    static afterCreate(objs: Array_Type<Genai.GpsCoordinates>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<Genai.GpsCoordinates>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<Genai.GpsCoordinates>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<Genai.GpsCoordinates>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Genai.GpsCoordinates>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Genai.GpsCoordinates | null;
     ...
     */
    withoutIdentity(): Genai.GpsCoordinates | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<Genai.GpsCoordinates>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: Genai.GpsCoordinates, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<Genai.GpsCoordinates>, callback?: λFunction<Genai.GpsCoordinates | null, Genai.GpsCoordinates | null>): ObjList<Genai.GpsCoordinates>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<Genai.GpsCoordinates>, callback?: λFunction<Genai.GpsCoordinates | null, Genai.GpsCoordinates | null>): Array_Type<ObjError> | null;
