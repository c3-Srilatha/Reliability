// TypeScript definitions for the C3 type Genai.SourceSystem.Gcs

/**
 * Represents the root of an external GCS file system.
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.SourceSystem.Gcs
 */
...
declare namespace Genai.SourceSystem {
  export class Gcs extends Obj  {
    ...
    withTypeIdent(typeIdent: string | null): Genai.SourceSystem.Gcs;
     ...
     */
    readonly id: string;
    withId(id: string): Genai.SourceSystem.Gcs;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Genai.SourceSystem.Gcs;

    /**
     * Name of the source system
     */
    readonly name: string;
    withName(name: string): Genai.SourceSystem.Gcs;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): Genai.SourceSystem.Gcs;
    ...
    withVersion(version: number | null): Genai.SourceSystem.Gcs;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): Genai.SourceSystem.Gcs;

    /**
     * The type of the source system
     */
    readonly sourceType?: string;
    withSourceType(sourceType: string | null): Genai.SourceSystem.Gcs;

    /**
     * The {@link Genai.SourceCollection}s created as a part of this source system
     */
    readonly collections?: Array_Type<Genai.SourceCollection>;
    withCollections(collections: Array_Type<Genai.SourceCollection> | Array<IGenai.SourceCollection> | null): Genai.SourceSystem.Gcs;

    /**
     * Description of the source system
     */
    readonly description?: string;
    withDescription(description: string | null): Genai.SourceSystem.Gcs;

    /**
     * The name of the mount in {@link FileSystem#mounts} for this source system
     */
    readonly mountName: string;
    withMountName(mountName: string): Genai.SourceSystem.Gcs;

    /**
     * The name of the bucket for the source system
     */
    readonly bucketName: string;
    withBucketName(bucketName: string): Genai.SourceSystem.Gcs;

    /**
     * The url for the mount
     */
    readonly rootUrl?: string;
    withRootUrl(rootUrl: string | null): Genai.SourceSystem.Gcs;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.SourceSystem.Gcs | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.SourceSystem.Gcs | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.SourceSystem.Gcs | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.SourceSystem.Gcs | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.SourceSystem.Gcs;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.SourceSystem.Gcs;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.SourceSystem.Gcs;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.SourceSystem.Gcs>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.SourceSystem.Gcs>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.SourceSystem.Gcs;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.SourceSystem.Gcs;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.SourceSystem.Gcs;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.SourceSystem.Gcs;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.SourceSystem.Gcs;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.SourceSystem.Gcs;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.SourceSystem.Gcs;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.SourceSystem.Gcs;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.SourceSystem.Gcs;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.SourceSystem.Gcs;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.SourceSystem.Gcs;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.SourceSystem.Gcs;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.SourceSystem.Gcs;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.SourceSystem.Gcs;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.SourceSystem.Gcs;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.SourceSystem.Gcs;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.SourceSystem.Gcs;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.SourceSystem.Gcs;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.SourceSystem.Gcs;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.SourceSystem.Gcs;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.SourceSystem.Gcs;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.SourceSystem.Gcs;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.SourceSystem.Gcs;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.SourceSystem.Gcs;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.SourceSystem.Gcs;

    mergeJson(json: any): Genai.SourceSystem.Gcs;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.SourceSystem.Gcs;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.SourceSystem.Gcs;
     ...
     */
    singletonArray(): Array_Type<Genai.SourceSystem.Gcs>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.SourceSystem.Gcs> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.SourceSystem.Gcs> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.SourceSystem.Gcs>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.SourceSystem.Gcs> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.SourceSystem.Gcs> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.SourceSystem.Gcs> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.SourceSystem.Gcs>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.SourceSystem.Gcs>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.SourceSystem.Gcs;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.SourceSystem.Gcs;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.SourceSystem.Gcs;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.SourceSystem.Gcs;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.SourceSystem.Gcs;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.SourceSystem.Gcs;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.SourceSystem.Gcs | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.SourceSystem.Gcs;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.SourceSystem.Gcs;
     ...
     */
    static cachedEmptyInst(): Genai.SourceSystem.Gcs;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.SourceSystem.Gcs> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.SourceSystem.Gcs;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<Genai.SourceSystem.Gcs>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Genai.SourceSystem.Gcs>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<Genai.SourceSystem.Gcs> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Genai.SourceSystem.Gcs>> | null;
     ...
     */
    get(include?: string): Genai.SourceSystem.Gcs | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): Genai.SourceSystem.Gcs | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Genai.SourceSystem.Gcs;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): Genai.SourceSystem.Gcs | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Genai.SourceSystem.Gcs;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.SourceSystem.Gcs | null;
     ...
     */
    create(spec?: UpsertSpec): Genai.SourceSystem.Gcs | null;
     ...
     */
    static createBatch(objs: Array_Type<Genai.SourceSystem.Gcs>, spec?: UpsertSpec): ObjList<Genai.SourceSystem.Gcs> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Genai.SourceSystem.Gcs>, spec?: CreateBatchObjStreamSpec): ObjList<Genai.SourceSystem.Gcs> | null;
     ...
     */
    update(srcObj?: Genai.SourceSystem.Gcs, spec?: UpsertSpec): Genai.SourceSystem.Gcs | null;
     ...
     */
    upsert(srcObj?: Genai.SourceSystem.Gcs, spec?: UpsertSpec): Genai.SourceSystem.Gcs | null;
     ...
     */
    merge(spec?: MergeSpec): Genai.SourceSystem.Gcs | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): Genai.SourceSystem.Gcs | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): Genai.SourceSystem.Gcs | null;
     ...
     */
    static updateBatch(objs: Array_Type<Genai.SourceSystem.Gcs>, srcObjs?: Array_Type<Genai.SourceSystem.Gcs>, spec?: UpsertSpec): ObjList<Genai.SourceSystem.Gcs> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<Genai.SourceSystem.Gcs> | null>, spec?: UpsertSpec): ObjList<Genai.SourceSystem.Gcs> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<Genai.SourceSystem.Gcs>, srcObjs?: Array_Type<Genai.SourceSystem.Gcs>, spec?: UpsertSpec): ObjList<Genai.SourceSystem.Gcs> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<Genai.SourceSystem.Gcs> | null>, spec?: UpsertSpec): ObjList<Genai.SourceSystem.Gcs> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<Genai.SourceSystem.Gcs>, spec?: TouchSpec): ObjList<Genai.SourceSystem.Gcs> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.SourceSystem.Gcs>, spec?: MergeSpec): ObjList<Genai.SourceSystem.Gcs> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.SourceSystem.Gcs>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.SourceSystem.Gcs> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<Genai.SourceSystem.Gcs> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.SourceSystem.Gcs> | null;
     ...
     */
    static mergeAll(mergeObj: Genai.SourceSystem.Gcs, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Genai.SourceSystem.Gcs, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<Genai.SourceSystem.Gcs>, spec?: UpsertSpec): ObjList<Genai.SourceSystem.Gcs> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<Genai.SourceSystem.Gcs>, spec?: UpsertSpec): ObjList<Genai.SourceSystem.Gcs> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): Genai.SourceSystem.Gcs | null;
     ...
     */
    static beforeCreate(objs: Array_Type<Genai.SourceSystem.Gcs>): ObjList<Genai.SourceSystem.Gcs>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<Genai.SourceSystem.Gcs>): ObjList<Genai.SourceSystem.Gcs>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<Genai.SourceSystem.Gcs>): ObjList<Genai.SourceSystem.Gcs>;
     ...
     */
    static afterCreate(objs: Array_Type<Genai.SourceSystem.Gcs>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<Genai.SourceSystem.Gcs>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<Genai.SourceSystem.Gcs>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<Genai.SourceSystem.Gcs>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Genai.SourceSystem.Gcs>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Genai.SourceSystem.Gcs | null;
     ...
     */
    withoutIdentity(): Genai.SourceSystem.Gcs | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<Genai.SourceSystem.Gcs>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: Genai.SourceSystem.Gcs, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<Genai.SourceSystem.Gcs>, callback?: λFunction<Genai.SourceSystem.Gcs | null, Genai.SourceSystem.Gcs | null>): ObjList<Genai.SourceSystem.Gcs>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<Genai.SourceSystem.Gcs>, callback?: λFunction<Genai.SourceSystem.Gcs | null, Genai.SourceSystem.Gcs | null>): Array_Type<ObjError> | null;
     ...
     */
    static createSourceSystem(spec: Genai.SourceSystem.Gcs.CreateSpec, rootUrls: Array_Type<string>): Genai.SourceSystem.Gcs;
