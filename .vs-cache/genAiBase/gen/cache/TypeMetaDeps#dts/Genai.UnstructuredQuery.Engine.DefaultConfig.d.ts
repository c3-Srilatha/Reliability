// TypeScript definitions for the C3 type Genai.UnstructuredQuery.Engine.DefaultConfig

/**
 * Configuration to specify which {@link Genai.UnstructuredQuery.Engine.Config} should be used by the application.
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.UnstructuredQuery.Engine.DefaultConfig
 */
declare namespace Genai.UnstructuredQuery.Engine {
  export interface IDefaultConfig {
    ...
    /**
     * The name of the {@link Genai.UnstructuredQuery.Engine.Config} to use, for example, "default".
     */
    queryEngineConfigName: string;
  }
}
 ...
 * Configuration to specify which {@link Genai.UnstructuredQuery.Engine.Config} should be used by the application.
 *
 * @remarks this represents a made instance of Genai.UnstructuredQuery.Engine.DefaultConfig
 */
declare namespace Genai.UnstructuredQuery.Engine {
  export class DefaultConfig extends Obj  {

    readonly configOverride?: string;
    withConfigOverride(configOverride: string | null): Genai.UnstructuredQuery.Engine.DefaultConfig;

    static readonly configOverride?: string;

    readonly secretOverride?: string;
    withSecretOverride(secretOverride: string | null): Genai.UnstructuredQuery.Engine.DefaultConfig;
    ...
    withIssues(issues: Array_Type<string> | Array<string> | null): Genai.UnstructuredQuery.Engine.DefaultConfig;
     ...
     * The name of the {@link Genai.UnstructuredQuery.Engine.Config} to use, for example, "default".
     */
    readonly queryEngineConfigName: string;
    withQueryEngineConfigName(queryEngineConfigName: string): Genai.UnstructuredQuery.Engine.DefaultConfig;

    /**
     * The name of the {@link Genai.UnstructuredQuery.Engine.Config} to use, for example, "default".
     */
    static readonly queryEngineConfigName: string;

    /**
     * @return the one and only instance to be used when member functions are called on this type.
     */
    static inst(): Genai.UnstructuredQuery.Engine.DefaultConfig;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.UnstructuredQuery.Engine.DefaultConfig | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.UnstructuredQuery.Engine.DefaultConfig | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.UnstructuredQuery.Engine.DefaultConfig | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.UnstructuredQuery.Engine.DefaultConfig | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.UnstructuredQuery.Engine.DefaultConfig;
     ...
     * This method is used during live metadata update
     */
    static replaceType(old: Type, new_: Type): Genai.UnstructuredQuery.Engine.DefaultConfig;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.UnstructuredQuery.Engine.DefaultConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.UnstructuredQuery.Engine.DefaultConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.UnstructuredQuery.Engine.DefaultConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.UnstructuredQuery.Engine.DefaultConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.UnstructuredQuery.Engine.DefaultConfig>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.UnstructuredQuery.Engine.DefaultConfig>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.UnstructuredQuery.Engine.DefaultConfig>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.UnstructuredQuery.Engine.DefaultConfig>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.UnstructuredQuery.Engine.DefaultConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.UnstructuredQuery.Engine.DefaultConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.UnstructuredQuery.Engine.DefaultConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.UnstructuredQuery.Engine.DefaultConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.UnstructuredQuery.Engine.DefaultConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.UnstructuredQuery.Engine.DefaultConfig;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.UnstructuredQuery.Engine.DefaultConfig;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    static validateObj(): Genai.UnstructuredQuery.Engine.DefaultConfig;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.UnstructuredQuery.Engine.DefaultConfig;
     ...
     * @see #defaultField
     */
    static withField(field: string, value: any, doNotConvert?: boolean): Genai.UnstructuredQuery.Engine.DefaultConfig;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.UnstructuredQuery.Engine.DefaultConfig;
     ...
     * @see #defaultField
     */
    static withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.UnstructuredQuery.Engine.DefaultConfig;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.UnstructuredQuery.Engine.DefaultConfig;
     ...
     * @return new Obj
     */
    static withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.UnstructuredQuery.Engine.DefaultConfig;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.UnstructuredQuery.Engine.DefaultConfig;
     ...
     * @return new Obj
     */
    static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.UnstructuredQuery.Engine.DefaultConfig;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.UnstructuredQuery.Engine.DefaultConfig;
     ...
     * @see #withoutField
     */
    static withoutFieldAtPath(path: string): Genai.UnstructuredQuery.Engine.DefaultConfig;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.UnstructuredQuery.Engine.DefaultConfig;
     ...
     * @see #removeField
     */
    static withoutField(field: string): Genai.UnstructuredQuery.Engine.DefaultConfig;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.UnstructuredQuery.Engine.DefaultConfig;
     ...
     * @see #removeField
     */
    static withoutField(field: FieldType): Genai.UnstructuredQuery.Engine.DefaultConfig;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.UnstructuredQuery.Engine.DefaultConfig;
     ...
     * @return new Obj with removed fields
     */
    static withoutFields(fields: Array_Type<string>): Genai.UnstructuredQuery.Engine.DefaultConfig;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.UnstructuredQuery.Engine.DefaultConfig;
     ...
     * @return new Obj with removed fields
     */
    static withoutFieldsByType(fields: Array_Type<FieldType>): Genai.UnstructuredQuery.Engine.DefaultConfig;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.UnstructuredQuery.Engine.DefaultConfig;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    static withoutSecretFields(): Genai.UnstructuredQuery.Engine.DefaultConfig;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.UnstructuredQuery.Engine.DefaultConfig;
     ...
     * @see FieldType#defaultValue
     */
    static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.UnstructuredQuery.Engine.DefaultConfig;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.UnstructuredQuery.Engine.DefaultConfig;
     ...
     * @see #unsetField
     */
    static defaultField(field: string): Genai.UnstructuredQuery.Engine.DefaultConfig;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.UnstructuredQuery.Engine.DefaultConfig;
     ...
     * @see #unsetField
     */
    static defaultField(field: FieldType): Genai.UnstructuredQuery.Engine.DefaultConfig;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.UnstructuredQuery.Engine.DefaultConfig;
     ...
     * @see #removeField
     */
    static unsetField(field: string): Genai.UnstructuredQuery.Engine.DefaultConfig;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.UnstructuredQuery.Engine.DefaultConfig;
     ...
     * @see #removeField
     */
    static unsetField(field: FieldType): Genai.UnstructuredQuery.Engine.DefaultConfig;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.UnstructuredQuery.Engine.DefaultConfig;
     ...
     * @see #unsetField
     */
    static removeField(field: string): Genai.UnstructuredQuery.Engine.DefaultConfig;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.UnstructuredQuery.Engine.DefaultConfig;
     ...
     * @see #unsetField
     */
    static removeField(field: FieldType): Genai.UnstructuredQuery.Engine.DefaultConfig;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.UnstructuredQuery.Engine.DefaultConfig;
     ...
     * @return the new merged Obj
     */
    static mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.UnstructuredQuery.Engine.DefaultConfig;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.UnstructuredQuery.Engine.DefaultConfig;
     ...
     * @return the new merged Obj
     */
    static mergeObj(other: Obj, otherFieldsFilter: Type): Genai.UnstructuredQuery.Engine.DefaultConfig;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.UnstructuredQuery.Engine.DefaultConfig;
     ...
     *        the same key or index.
     */
    static mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.UnstructuredQuery.Engine.DefaultConfig;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.UnstructuredQuery.Engine.DefaultConfig;
     ...
     * traverse child reference and collection fields.
     */
    static mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.UnstructuredQuery.Engine.DefaultConfig;

    mergeJson(json: any): Genai.UnstructuredQuery.Engine.DefaultConfig;

    static mergeJson(json: any): Genai.UnstructuredQuery.Engine.DefaultConfig;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.UnstructuredQuery.Engine.DefaultConfig;
     ...
     * @return Obj with child references merged
     */
    static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.UnstructuredQuery.Engine.DefaultConfig;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.UnstructuredQuery.Engine.DefaultConfig;
     ...
     * references with same name and collection elements at same index or key.
     */
    static sumObj(other: Obj, deep?: boolean): Genai.UnstructuredQuery.Engine.DefaultConfig;
     ...
     */
    singletonArray(): Array_Type<Genai.UnstructuredQuery.Engine.DefaultConfig>;
     ...
     * @return new array instance with this as only element.
     */
    static singletonArray(): Array_Type<Genai.UnstructuredQuery.Engine.DefaultConfig>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.UnstructuredQuery.Engine.DefaultConfig> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.UnstructuredQuery.Engine.DefaultConfig> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.UnstructuredQuery.Engine.DefaultConfig>;
     ...
     * @return new array instance with this as only element.
     */
    static singletonSet(): Set_Type<Genai.UnstructuredQuery.Engine.DefaultConfig>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.UnstructuredQuery.Engine.DefaultConfig> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.UnstructuredQuery.Engine.DefaultConfig> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.UnstructuredQuery.Engine.DefaultConfig> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.UnstructuredQuery.Engine.DefaultConfig>;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    static toBuilder(): ObjBuilder<Genai.UnstructuredQuery.Engine.DefaultConfig>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.UnstructuredQuery.Engine.DefaultConfig>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.UnstructuredQuery.Engine.DefaultConfig;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.UnstructuredQuery.Engine.DefaultConfig;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.UnstructuredQuery.Engine.DefaultConfig;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.UnstructuredQuery.Engine.DefaultConfig;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.UnstructuredQuery.Engine.DefaultConfig;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.UnstructuredQuery.Engine.DefaultConfig;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.UnstructuredQuery.Engine.DefaultConfig;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.UnstructuredQuery.Engine.DefaultConfig;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    static afterMake(): Genai.UnstructuredQuery.Engine.DefaultConfig;
     ...
     */
    static cachedEmptyInst(): Genai.UnstructuredQuery.Engine.DefaultConfig;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.UnstructuredQuery.Engine.DefaultConfig> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.UnstructuredQuery.Engine.DefaultConfig;
     ...
     */
    static allCached(): Stream<Genai.UnstructuredQuery.Engine.DefaultConfig> | null;
     ...
     */
    static find(filter?: string): Stream<Genai.UnstructuredQuery.Engine.DefaultConfig> | null;
     ...
     *         Otherwise no population will be performed.
     */
    static findBy(field: string, value: any): Stream<Genai.UnstructuredQuery.Engine.DefaultConfig> | null;

    /**
     * @return cached instance.
     */
    getCached(): Genai.UnstructuredQuery.Engine.DefaultConfig | null;

    /**
     * @return cached instance.
     */
    static getCached(): Genai.UnstructuredQuery.Engine.DefaultConfig | null;

    /**
     * Returns cached instance by key, with secrets removed.
     */
    static forCacheKey(key: string): Genai.UnstructuredQuery.Engine.DefaultConfig | null;
     ...
     */
    static produce(key: string): Genai.UnstructuredQuery.Engine.DefaultConfig | null;

    /**
     * Should produces the entire content for the cached data. Will populate the cache with the produced data.
     */
    static produceAll(): Map_Type<string, Genai.UnstructuredQuery.Engine.DefaultConfig> | null;
     ...
     */
    getConfig(): Genai.UnstructuredQuery.Engine.DefaultConfig;
     ...
     * Note that typical pattern is to use Configurable#config instead of this method.
     */
    static getConfig(): Genai.UnstructuredQuery.Engine.DefaultConfig;
     ...
     */
    getSecret(): Genai.UnstructuredQuery.Engine.DefaultConfig;
     ...
     * Note that typical pattern is to use Configurable#configWithSecrets instead of this method.
     */
    static getSecret(): Genai.UnstructuredQuery.Engine.DefaultConfig;
     ...
     */
    withConfigKey(configKey: string): Genai.UnstructuredQuery.Engine.DefaultConfig;
     ...
     *     config.configKey() => "folder1/abc"
     */
    static withConfigKey(configKey: string): Genai.UnstructuredQuery.Engine.DefaultConfig;

    /**
     * @return copy without config key.
     */
    withoutConfigKey(): Genai.UnstructuredQuery.Engine.DefaultConfig;

    /**
     * @return copy without config key.
     */
    static withoutConfigKey(): Genai.UnstructuredQuery.Engine.DefaultConfig;

    /**
     * @return return cached config instance for provided config key.
     */
    static forConfigKey(configKey: string): Genai.UnstructuredQuery.Engine.DefaultConfig | null;
     ...
     */
    static listConfigs(parallel?: boolean, filter?: λPredicate<string>): Stream<Genai.UnstructuredQuery.Engine.DefaultConfig> | null;
     ...
     * @see setConfigValue
     */
    setConfigValues(from: Genai.UnstructuredQuery.Engine.DefaultConfig, override?: string): void;
     ...
     * @see setConfigValue
     */
    static setConfigValues(from: Genai.UnstructuredQuery.Engine.DefaultConfig, override?: string): void;
     ...
     */
    static loadConfigAndSecret(configKey: string): Genai.UnstructuredQuery.Engine.DefaultConfig | null;
     ...
     */
    removeSecrets(): Genai.UnstructuredQuery.Engine.DefaultConfig | null;

    /**
     * @return this config without any secret values.
     */
    static removeSecrets(): Genai.UnstructuredQuery.Engine.DefaultConfig | null;

    /**
     * @return this config with only secret values.
     */
    removeNonSecrets(): Genai.UnstructuredQuery.Engine.DefaultConfig | null;

    /**
     * @return this config with only secret values.
     */
    static removeNonSecrets(): Genai.UnstructuredQuery.Engine.DefaultConfig | null;

    /**
     * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
     * validation and setup.
     */
    validate(): Genai.UnstructuredQuery.Engine.DefaultConfig;

    /**
     * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
     * validation and setup.
     */
    static validate(): Genai.UnstructuredQuery.Engine.DefaultConfig;
