// TypeScript definitions for the C3 type Genai.Agent.Tool.Util.StringFuzzyMatcher.Deployment

/**
 * The Engine Deployment for {@link Genai.Agent.Tool.Util.StringFuzzyMatcher}.
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.Agent.Tool.Util.StringFuzzyMatcher.Deployment
 */
...
declare namespace Genai.Agent.Tool.Util.StringFuzzyMatcher {
  export class Deployment extends Obj  {
    ...
    withName(name: string): Genai.Agent.Tool.Util.StringFuzzyMatcher.Deployment;
    ...
    withNodeRole(nodeRole: string | null): Genai.Agent.Tool.Util.StringFuzzyMatcher.Deployment;
    ...
    withAltNodeRoles(altNodeRoles: Array_Type<string> | Array<string> | null): Genai.Agent.Tool.Util.StringFuzzyMatcher.Deployment;
    ...
    withNodePools(nodePools: Array_Type<string> | Array<string> | null): Genai.Agent.Tool.Util.StringFuzzyMatcher.Deployment;
    ...
    withDedicatedThreadPool(dedicatedThreadPool: boolean): Genai.Agent.Tool.Util.StringFuzzyMatcher.Deployment;

    /**
     * If set to `true` then this {@link Engine} will auto start on every node of every target node-pool.
     */
    readonly autoStart?: boolean;
    withAutoStart(autoStart: boolean): Genai.Agent.Tool.Util.StringFuzzyMatcher.Deployment;
    ...
    withInactive(inactive: boolean): Genai.Agent.Tool.Util.StringFuzzyMatcher.Deployment;
    ...
    withFailActionIfEngineNotReady(failActionIfEngineNotReady: boolean): Genai.Agent.Tool.Util.StringFuzzyMatcher.Deployment;
    ...
    withInitializingNodeAvoidanceDuration(initializingNodeAvoidanceDuration: string | null): Genai.Agent.Tool.Util.StringFuzzyMatcher.Deployment;

    readonly configOverride?: string;
    withConfigOverride(configOverride: string | null): Genai.Agent.Tool.Util.StringFuzzyMatcher.Deployment;

    readonly secretOverride?: string;
    withSecretOverride(secretOverride: string | null): Genai.Agent.Tool.Util.StringFuzzyMatcher.Deployment;

    /**
     * Captures any issues that occurred while deserializing from filesystem
     */
    readonly issues?: Array_Type<string>;
    withIssues(issues: Array_Type<string> | Array<string> | null): Genai.Agent.Tool.Util.StringFuzzyMatcher.Deployment;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.Agent.Tool.Util.StringFuzzyMatcher.Deployment | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.Agent.Tool.Util.StringFuzzyMatcher.Deployment | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.Agent.Tool.Util.StringFuzzyMatcher.Deployment | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.Agent.Tool.Util.StringFuzzyMatcher.Deployment | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.Agent.Tool.Util.StringFuzzyMatcher.Deployment;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Agent.Tool.Util.StringFuzzyMatcher.Deployment;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Agent.Tool.Util.StringFuzzyMatcher.Deployment;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Agent.Tool.Util.StringFuzzyMatcher.Deployment>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Agent.Tool.Util.StringFuzzyMatcher.Deployment>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.Agent.Tool.Util.StringFuzzyMatcher.Deployment;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Agent.Tool.Util.StringFuzzyMatcher.Deployment;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Agent.Tool.Util.StringFuzzyMatcher.Deployment;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.Agent.Tool.Util.StringFuzzyMatcher.Deployment;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.Agent.Tool.Util.StringFuzzyMatcher.Deployment;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.Agent.Tool.Util.StringFuzzyMatcher.Deployment;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.Agent.Tool.Util.StringFuzzyMatcher.Deployment;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.Agent.Tool.Util.StringFuzzyMatcher.Deployment;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.Agent.Tool.Util.StringFuzzyMatcher.Deployment;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.Agent.Tool.Util.StringFuzzyMatcher.Deployment;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.Agent.Tool.Util.StringFuzzyMatcher.Deployment;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.Agent.Tool.Util.StringFuzzyMatcher.Deployment;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.Agent.Tool.Util.StringFuzzyMatcher.Deployment;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.Agent.Tool.Util.StringFuzzyMatcher.Deployment;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.Agent.Tool.Util.StringFuzzyMatcher.Deployment;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.Agent.Tool.Util.StringFuzzyMatcher.Deployment;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.Agent.Tool.Util.StringFuzzyMatcher.Deployment;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.Agent.Tool.Util.StringFuzzyMatcher.Deployment;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.Agent.Tool.Util.StringFuzzyMatcher.Deployment;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.Agent.Tool.Util.StringFuzzyMatcher.Deployment;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.Agent.Tool.Util.StringFuzzyMatcher.Deployment;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.Agent.Tool.Util.StringFuzzyMatcher.Deployment;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.Agent.Tool.Util.StringFuzzyMatcher.Deployment;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.Agent.Tool.Util.StringFuzzyMatcher.Deployment;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.Agent.Tool.Util.StringFuzzyMatcher.Deployment;

    mergeJson(json: any): Genai.Agent.Tool.Util.StringFuzzyMatcher.Deployment;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.Agent.Tool.Util.StringFuzzyMatcher.Deployment;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.Agent.Tool.Util.StringFuzzyMatcher.Deployment;
     ...
     */
    singletonArray(): Array_Type<Genai.Agent.Tool.Util.StringFuzzyMatcher.Deployment>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.Agent.Tool.Util.StringFuzzyMatcher.Deployment> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.Agent.Tool.Util.StringFuzzyMatcher.Deployment> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.Agent.Tool.Util.StringFuzzyMatcher.Deployment>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.Agent.Tool.Util.StringFuzzyMatcher.Deployment> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.Agent.Tool.Util.StringFuzzyMatcher.Deployment> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.Agent.Tool.Util.StringFuzzyMatcher.Deployment> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.Agent.Tool.Util.StringFuzzyMatcher.Deployment>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.Agent.Tool.Util.StringFuzzyMatcher.Deployment>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.Agent.Tool.Util.StringFuzzyMatcher.Deployment;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.Agent.Tool.Util.StringFuzzyMatcher.Deployment;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.Agent.Tool.Util.StringFuzzyMatcher.Deployment;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.Agent.Tool.Util.StringFuzzyMatcher.Deployment;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.Agent.Tool.Util.StringFuzzyMatcher.Deployment;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.Agent.Tool.Util.StringFuzzyMatcher.Deployment;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.Agent.Tool.Util.StringFuzzyMatcher.Deployment | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.Agent.Tool.Util.StringFuzzyMatcher.Deployment;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.Agent.Tool.Util.StringFuzzyMatcher.Deployment;
     ...
     */
    static cachedEmptyInst(): Genai.Agent.Tool.Util.StringFuzzyMatcher.Deployment;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.Agent.Tool.Util.StringFuzzyMatcher.Deployment> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.Agent.Tool.Util.StringFuzzyMatcher.Deployment;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.Agent.Tool.Util.StringFuzzyMatcher.Deployment | null;
     ...
     */
    static forName(name: string, failIfMissing?: boolean): Genai.Agent.Tool.Util.StringFuzzyMatcher.Deployment | null;
     ...
     */
    static allCached(): Stream<Genai.Agent.Tool.Util.StringFuzzyMatcher.Deployment> | null;
     ...
     */
    static find(filter?: string): Stream<Genai.Agent.Tool.Util.StringFuzzyMatcher.Deployment> | null;
     ...
     *         Otherwise no population will be performed.
     */
    static findBy(field: string, value: any): Stream<Genai.Agent.Tool.Util.StringFuzzyMatcher.Deployment> | null;

    /**
     * @return cached instance.
     */
    getCached(): Genai.Agent.Tool.Util.StringFuzzyMatcher.Deployment | null;

    /**
     * Returns cached instance by key, with secrets removed.
     */
    static forCacheKey(key: string): Genai.Agent.Tool.Util.StringFuzzyMatcher.Deployment | null;
     ...
     */
    static produce(key: string): Genai.Agent.Tool.Util.StringFuzzyMatcher.Deployment | null;

    /**
     * Should produces the entire content for the cached data. Will populate the cache with the produced data.
     */
    static produceAll(): Map_Type<string, Genai.Agent.Tool.Util.StringFuzzyMatcher.Deployment> | null;
     ...
     */
    getConfig(): Genai.Agent.Tool.Util.StringFuzzyMatcher.Deployment;
     ...
     */
    getSecret(): Genai.Agent.Tool.Util.StringFuzzyMatcher.Deployment;
     ...
     */
    withConfigKey(configKey: string): Genai.Agent.Tool.Util.StringFuzzyMatcher.Deployment;

    /**
     * @return copy without config key.
     */
    withoutConfigKey(): Genai.Agent.Tool.Util.StringFuzzyMatcher.Deployment;

    /**
     * @return return cached config instance for provided config key.
     */
    static forConfigKey(configKey: string): Genai.Agent.Tool.Util.StringFuzzyMatcher.Deployment | null;
     ...
     */
    static listConfigs(parallel?: boolean, filter?: λPredicate<string>): Stream<Genai.Agent.Tool.Util.StringFuzzyMatcher.Deployment> | null;
     ...
     * @see setConfigValue
     */
    setConfigValues(from: Genai.Agent.Tool.Util.StringFuzzyMatcher.Deployment, override?: string): void;
     ...
     */
    static loadConfigAndSecret(configKey: string): Genai.Agent.Tool.Util.StringFuzzyMatcher.Deployment | null;
     ...
     */
    removeSecrets(): Genai.Agent.Tool.Util.StringFuzzyMatcher.Deployment | null;

    /**
     * @return this config with only secret values.
     */
    removeNonSecrets(): Genai.Agent.Tool.Util.StringFuzzyMatcher.Deployment | null;

    /**
     * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
     * validation and setup.
     */
    validate(): Genai.Agent.Tool.Util.StringFuzzyMatcher.Deployment;
     ...
     */
    engineType(): Type<<Genai.Agent.Tool.Util.StringFuzzyMatcher>> | null;
     ...
     */
    static fromDeploySpec(spec: Engine.DeploySpec): Genai.Agent.Tool.Util.StringFuzzyMatcher.Deployment | null;
  }
}
