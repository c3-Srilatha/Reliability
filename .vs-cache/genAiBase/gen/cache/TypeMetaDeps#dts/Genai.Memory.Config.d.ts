// TypeScript definitions for the C3 type Genai.Memory.Config

/**
 * The Config interface for interacting with {@link Genai.Memory} and its subtypes
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.Memory.Config
 */
...
declare namespace Genai.Memory {
  export class Config extends Obj  {
    ...
    withConfigOverride(configOverride: string | null): Genai.Memory.Config;

    readonly secretOverride?: string;
    withSecretOverride(secretOverride: string | null): Genai.Memory.Config;

    /**
     * Captures any issues that occurred while deserializing from filesystem
     */
    readonly issues?: Array_Type<string>;
    withIssues(issues: Array_Type<string> | Array<string> | null): Genai.Memory.Config;

    /**
     * The unique and required name of this instance.
     */
    readonly name: string;
    withName(name: string): Genai.Memory.Config;
    ...
    withTypeIdent(typeIdent: string | null): Genai.Memory.Config;

    /**
     * Type of memory this manager should handle. This should be a subtype of {@link Genai.Memory}.
     */
    readonly memoryType?: Type<<Genai.Memory>>;
    withMemoryType(memoryType: IType<<Genai.Memory>> | null): Genai.Memory.Config;

    /**
     * Spec of embedder to use for encoding memories.
     */
    readonly embedderSpec: Genai.Embedder.Spec;
    withEmbedderSpec(embedderSpec: IGenai.Embedder.Spec): Genai.Memory.Config;
    ...
    withMemoryEncodeKwargs(memoryEncodeKwargs: any | null): Genai.Memory.Config;
    ...
    withQueryEncodeKwargs(queryEncodeKwargs: any | null): Genai.Memory.Config;

    /**
     * Vector store to use for storing and retrieving memories.
     */
    readonly vectorStore?: GenaiCore.PgVector;
    withVectorStore(vectorStore: IGenaiCore.PgVector | null): Genai.Memory.Config;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.Memory.Config | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.Memory.Config | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.Memory.Config | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.Memory.Config | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.Memory.Config;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Memory.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Memory.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Memory.Config>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Memory.Config>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.Memory.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Memory.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Memory.Config;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.Memory.Config;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.Memory.Config;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.Memory.Config;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.Memory.Config;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.Memory.Config;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.Memory.Config;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.Memory.Config;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.Memory.Config;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.Memory.Config;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.Memory.Config;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.Memory.Config;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.Memory.Config;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.Memory.Config;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.Memory.Config;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.Memory.Config;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.Memory.Config;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.Memory.Config;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.Memory.Config;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.Memory.Config;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.Memory.Config;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.Memory.Config;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.Memory.Config;

    mergeJson(json: any): Genai.Memory.Config;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.Memory.Config;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.Memory.Config;
     ...
     */
    singletonArray(): Array_Type<Genai.Memory.Config>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.Memory.Config> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.Memory.Config> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.Memory.Config>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.Memory.Config> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.Memory.Config> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.Memory.Config> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.Memory.Config>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.Memory.Config>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.Memory.Config;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.Memory.Config;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.Memory.Config;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.Memory.Config;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.Memory.Config;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.Memory.Config;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.Memory.Config | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.Memory.Config;
     ...
     */
    static cachedEmptyInst(): Genai.Memory.Config;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.Memory.Config> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.Memory.Config;
     ...
     */
    static allCached(): Stream<Genai.Memory.Config> | null;
     ...
     */
    static find(filter?: string): Stream<Genai.Memory.Config> | null;
     ...
     *         Otherwise no population will be performed.
     */
    static findBy(field: string, value: any): Stream<Genai.Memory.Config> | null;

    /**
     * @return cached instance.
     */
    getCached(): Genai.Memory.Config | null;

    /**
     * Returns cached instance by key, with secrets removed.
     */
    static forCacheKey(key: string): Genai.Memory.Config | null;
     ...
     */
    static produce(key: string): Genai.Memory.Config | null;

    /**
     * Should produces the entire content for the cached data. Will populate the cache with the produced data.
     */
    static produceAll(): Map_Type<string, Genai.Memory.Config> | null;
     ...
     */
    withConfigKey(configKey: string): Genai.Memory.Config;

    /**
     * @return copy without config key.
     */
    withoutConfigKey(): Genai.Memory.Config;

    /**
     * @return return cached config instance for provided config key.
     */
    static forConfigKey(configKey: string): Genai.Memory.Config | null;
     ...
     */
    static listConfigs(parallel?: boolean, filter?: λPredicate<string>): Stream<Genai.Memory.Config> | null;
     ...
     * @see setConfigValue
     */
    setConfigValues(from: Genai.Memory.Config, override?: string): void;
     ...
     */
    static loadConfigAndSecret(configKey: string): Genai.Memory.Config | null;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.Memory.Config | null;
     ...
     */
    static forName(name: string, failIfMissing?: boolean): Genai.Memory.Config | null;
