// TypeScript definitions for the C3 type Genai.Agent.QueryOrchestrator.Prompt.Config

/**
 * Config for the prompts used in {@link Genai.Agent.QueryOrchestrator}
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.Agent.QueryOrchestrator.Prompt.Config
 */
declare namespace Genai.Agent.QueryOrchestrator.Prompt {
...
declare namespace Genai.Agent.QueryOrchestrator.Prompt {
  export class Config extends Obj  {
    ...
    withName(name: string): Genai.Agent.QueryOrchestrator.Prompt.Config;

    readonly configOverride?: string;
    withConfigOverride(configOverride: string | null): Genai.Agent.QueryOrchestrator.Prompt.Config;

    readonly secretOverride?: string;
    withSecretOverride(secretOverride: string | null): Genai.Agent.QueryOrchestrator.Prompt.Config;

    /**
     * Captures any issues that occurred while deserializing from filesystem
     */
    readonly issues?: Array_Type<string>;
    withIssues(issues: Array_Type<string> | Array<string> | null): Genai.Agent.QueryOrchestrator.Prompt.Config;

    /**
     * Instruction prompt used by the orchestrator to pick the next tool.
     */
    readonly nextToolPrompt: string;
    withNextToolPrompt(nextToolPrompt: string): Genai.Agent.QueryOrchestrator.Prompt.Config;

    /**
     * Name of {@link Genai.UnstructuredQuery.Engine.ModelConfig} used for picking the next tool by the orchestrator.
     */
    readonly nextToolModelConfigName: string;
    withNextToolModelConfigName(nextToolModelConfigName: string): Genai.Agent.QueryOrchestrator.Prompt.Config;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.Agent.QueryOrchestrator.Prompt.Config | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.Agent.QueryOrchestrator.Prompt.Config | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.Agent.QueryOrchestrator.Prompt.Config | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.Agent.QueryOrchestrator.Prompt.Config | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.Agent.QueryOrchestrator.Prompt.Config;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Agent.QueryOrchestrator.Prompt.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Agent.QueryOrchestrator.Prompt.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Agent.QueryOrchestrator.Prompt.Config>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Agent.QueryOrchestrator.Prompt.Config>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.Agent.QueryOrchestrator.Prompt.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Agent.QueryOrchestrator.Prompt.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Agent.QueryOrchestrator.Prompt.Config;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.Agent.QueryOrchestrator.Prompt.Config;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.Agent.QueryOrchestrator.Prompt.Config;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.Agent.QueryOrchestrator.Prompt.Config;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.Agent.QueryOrchestrator.Prompt.Config;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.Agent.QueryOrchestrator.Prompt.Config;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.Agent.QueryOrchestrator.Prompt.Config;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.Agent.QueryOrchestrator.Prompt.Config;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.Agent.QueryOrchestrator.Prompt.Config;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.Agent.QueryOrchestrator.Prompt.Config;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.Agent.QueryOrchestrator.Prompt.Config;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.Agent.QueryOrchestrator.Prompt.Config;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.Agent.QueryOrchestrator.Prompt.Config;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.Agent.QueryOrchestrator.Prompt.Config;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.Agent.QueryOrchestrator.Prompt.Config;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.Agent.QueryOrchestrator.Prompt.Config;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.Agent.QueryOrchestrator.Prompt.Config;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.Agent.QueryOrchestrator.Prompt.Config;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.Agent.QueryOrchestrator.Prompt.Config;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.Agent.QueryOrchestrator.Prompt.Config;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.Agent.QueryOrchestrator.Prompt.Config;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.Agent.QueryOrchestrator.Prompt.Config;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.Agent.QueryOrchestrator.Prompt.Config;

    mergeJson(json: any): Genai.Agent.QueryOrchestrator.Prompt.Config;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.Agent.QueryOrchestrator.Prompt.Config;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.Agent.QueryOrchestrator.Prompt.Config;
     ...
     */
    singletonArray(): Array_Type<Genai.Agent.QueryOrchestrator.Prompt.Config>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.Agent.QueryOrchestrator.Prompt.Config> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.Agent.QueryOrchestrator.Prompt.Config> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.Agent.QueryOrchestrator.Prompt.Config>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.Agent.QueryOrchestrator.Prompt.Config> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.Agent.QueryOrchestrator.Prompt.Config> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.Agent.QueryOrchestrator.Prompt.Config> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.Agent.QueryOrchestrator.Prompt.Config>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.Agent.QueryOrchestrator.Prompt.Config>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.Agent.QueryOrchestrator.Prompt.Config;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.Agent.QueryOrchestrator.Prompt.Config;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.Agent.QueryOrchestrator.Prompt.Config;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.Agent.QueryOrchestrator.Prompt.Config;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.Agent.QueryOrchestrator.Prompt.Config;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.Agent.QueryOrchestrator.Prompt.Config;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.Agent.QueryOrchestrator.Prompt.Config | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.Agent.QueryOrchestrator.Prompt.Config;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.Agent.QueryOrchestrator.Prompt.Config;
     ...
     */
    static cachedEmptyInst(): Genai.Agent.QueryOrchestrator.Prompt.Config;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.Agent.QueryOrchestrator.Prompt.Config> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.Agent.QueryOrchestrator.Prompt.Config;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.Agent.QueryOrchestrator.Prompt.Config | null;
     ...
     */
    static forName(name: string, failIfMissing?: boolean): Genai.Agent.QueryOrchestrator.Prompt.Config | null;
     ...
     */
    static allCached(): Stream<Genai.Agent.QueryOrchestrator.Prompt.Config> | null;
     ...
     */
    static find(filter?: string): Stream<Genai.Agent.QueryOrchestrator.Prompt.Config> | null;
     ...
     *         Otherwise no population will be performed.
     */
    static findBy(field: string, value: any): Stream<Genai.Agent.QueryOrchestrator.Prompt.Config> | null;

    /**
     * @return cached instance.
     */
    getCached(): Genai.Agent.QueryOrchestrator.Prompt.Config | null;

    /**
     * Returns cached instance by key, with secrets removed.
     */
    static forCacheKey(key: string): Genai.Agent.QueryOrchestrator.Prompt.Config | null;
     ...
     */
    static produce(key: string): Genai.Agent.QueryOrchestrator.Prompt.Config | null;

    /**
     * Should produces the entire content for the cached data. Will populate the cache with the produced data.
     */
    static produceAll(): Map_Type<string, Genai.Agent.QueryOrchestrator.Prompt.Config> | null;
     ...
     */
    getConfig(): Genai.Agent.QueryOrchestrator.Prompt.Config;
     ...
     */
    getSecret(): Genai.Agent.QueryOrchestrator.Prompt.Config;
     ...
     */
    withConfigKey(configKey: string): Genai.Agent.QueryOrchestrator.Prompt.Config;

    /**
     * @return copy without config key.
     */
    withoutConfigKey(): Genai.Agent.QueryOrchestrator.Prompt.Config;

    /**
     * @return return cached config instance for provided config key.
     */
    static forConfigKey(configKey: string): Genai.Agent.QueryOrchestrator.Prompt.Config | null;
     ...
     */
    static listConfigs(parallel?: boolean, filter?: λPredicate<string>): Stream<Genai.Agent.QueryOrchestrator.Prompt.Config> | null;
     ...
     * @see setConfigValue
     */
    setConfigValues(from: Genai.Agent.QueryOrchestrator.Prompt.Config, override?: string): void;
     ...
     */
    static loadConfigAndSecret(configKey: string): Genai.Agent.QueryOrchestrator.Prompt.Config | null;
     ...
     */
    removeSecrets(): Genai.Agent.QueryOrchestrator.Prompt.Config | null;

    /**
     * @return this config with only secret values.
     */
    removeNonSecrets(): Genai.Agent.QueryOrchestrator.Prompt.Config | null;

    /**
     * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
     * validation and setup.
     */
    validate(): Genai.Agent.QueryOrchestrator.Prompt.Config;
     ...
     */
    static setRecursive(configJson: any, useSetConfigValues?: boolean, override?: string): Genai.Agent.QueryOrchestrator.Prompt.Config;
