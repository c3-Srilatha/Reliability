// TypeScript definitions for the C3 type Genai.Retriever.Elser

/**
 * Representation of an elastic search vector store.
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.Retriever.Elser
 */
declare namespace Genai.Retriever {
  export interface IElser {
     ...
     */
    otherSearchIndexNames?: Array_Type<string> | Array<string>;
     ...
     */
    otherSearchParams?: Map_Type<string, any> | {[key: string]: any};
  }
}
 ...
 */
declare namespace Genai.Retriever {
  export class Elser extends Obj  {
    ...
    withReadOnly(readOnly: boolean): Genai.Retriever.Elser;

    /**
     * If true, when loading a seeded read-only retriever, `initialize` will also call `populateSourceFilesForName`
     */
    readonly fabricateSources?: boolean;
    withFabricateSources(fabricateSources: boolean): Genai.Retriever.Elser;

    /**
     * If #fabricateSources is true, this will be set to true if the sources have been fabricated.
     */
    readonly sourcesFabricated?: boolean;
    withSourcesFabricated(sourcesFabricated: boolean): Genai.Retriever.Elser;

    /**
     * The url of the zipfile containing the pre-indexed data to be searched by the engine
     */
    readonly indexZipUrl?: string;
    withIndexZipUrl(indexZipUrl: string | null): Genai.Retriever.Elser;
    ...
    withDevice(device: string): Genai.Retriever.Elser;
    ...
    withIndexerNodePoolMatrix(indexerNodePoolMatrix: Map_Type<number, string> | {[key: number]: string} | null): Genai.Retriever.Elser;
    ...
    withMaxTries(maxTries: number | null): Genai.Retriever.Elser;
    ...
    withIndexingBatchSize(indexingBatchSize: number | null): Genai.Retriever.Elser;
    ...
    withQueryPreprocessLambda(queryPreprocessLambda: λFunction<string, string> | null): Genai.Retriever.Elser;
    ...
    withTypeIdent(typeIdent: string | null): Genai.Retriever.Elser;
     ...
     */
    readonly id: string;
    withId(id: string): Genai.Retriever.Elser;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Genai.Retriever.Elser;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): Genai.Retriever.Elser;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): Genai.Retriever.Elser;
    ...
    withVersion(version: number | null): Genai.Retriever.Elser;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): Genai.Retriever.Elser;

    /**
     * All of the index actions dispatched asynchronously for this retriever
     */
    readonly indexActions?: Array_Type<Genai.Retriever.IndexAction>;
    withIndexActions(indexActions: Array_Type<Genai.Retriever.IndexAction> | Array<IGenai.Retriever.IndexAction> | null): Genai.Retriever.Elser;

    /**
     * Description of Elastic index store of documents.
     */
    readonly description?: string;
    withDescription(description: string | null): Genai.Retriever.Elser;

    /**
     * The name of the index store to be created within Elasticsearch
     */
    readonly indexName: string;
    withIndexName(indexName: string): Genai.Retriever.Elser;
     ...
     * specifying cross-cluster search.
     */
    readonly otherSearchIndexNames?: Array_Type<string>;
    withOtherSearchIndexNames(otherSearchIndexNames: Array_Type<string> | Array<string> | null): Genai.Retriever.Elser;

    /**
     * Other parameters to pass to Elasticsearch.search inside similaritySearch. See the search function in
     * {@link https://elasticsearch-py.readthedocs.io/en/v8.13.0/api/elasticsearch.html}
     */
    readonly otherSearchParams?: Map_Type<string, any>;
    withOtherSearchParams(otherSearchParams: Map_Type<string, any> | {[key: string]: any} | null): Genai.Retriever.Elser;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.Retriever.Elser | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.Retriever.Elser | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.Retriever.Elser | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.Retriever.Elser | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.Retriever.Elser;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Retriever.Elser;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Retriever.Elser;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Retriever.Elser>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Retriever.Elser>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.Retriever.Elser;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Retriever.Elser;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Retriever.Elser;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.Retriever.Elser;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.Retriever.Elser;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.Retriever.Elser;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.Retriever.Elser;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.Retriever.Elser;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.Retriever.Elser;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.Retriever.Elser;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.Retriever.Elser;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.Retriever.Elser;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.Retriever.Elser;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.Retriever.Elser;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.Retriever.Elser;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.Retriever.Elser;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.Retriever.Elser;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.Retriever.Elser;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.Retriever.Elser;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.Retriever.Elser;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.Retriever.Elser;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.Retriever.Elser;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.Retriever.Elser;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.Retriever.Elser;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.Retriever.Elser;

    mergeJson(json: any): Genai.Retriever.Elser;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.Retriever.Elser;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.Retriever.Elser;
     ...
     */
    singletonArray(): Array_Type<Genai.Retriever.Elser>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.Retriever.Elser> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.Retriever.Elser> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.Retriever.Elser>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.Retriever.Elser> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.Retriever.Elser> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.Retriever.Elser> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.Retriever.Elser>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.Retriever.Elser>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.Retriever.Elser;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.Retriever.Elser;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.Retriever.Elser;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.Retriever.Elser;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.Retriever.Elser;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.Retriever.Elser;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.Retriever.Elser | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.Retriever.Elser;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.Retriever.Elser;
     ...
     */
    static cachedEmptyInst(): Genai.Retriever.Elser;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.Retriever.Elser> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.Retriever.Elser;
     ...
     */
    config(secrets?: boolean): Genai.Retriever.Elser.Config;
     ...
     */
    static typeConfig(): Genai.Retriever.Elser.Config;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<Genai.Retriever.Elser>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Genai.Retriever.Elser>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<Genai.Retriever.Elser> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Genai.Retriever.Elser>> | null;
     ...
     */
    get(include?: string): Genai.Retriever.Elser | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): Genai.Retriever.Elser | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Genai.Retriever.Elser;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): Genai.Retriever.Elser | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Genai.Retriever.Elser;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.Retriever.Elser | null;
     ...
     */
    create(spec?: UpsertSpec): Genai.Retriever.Elser | null;
     ...
     */
    static createBatch(objs: Array_Type<Genai.Retriever.Elser>, spec?: UpsertSpec): ObjList<Genai.Retriever.Elser> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Genai.Retriever.Elser>, spec?: CreateBatchObjStreamSpec): ObjList<Genai.Retriever.Elser> | null;
     ...
     */
    update(srcObj?: Genai.Retriever.Elser, spec?: UpsertSpec): Genai.Retriever.Elser | null;
     ...
     */
    upsert(srcObj?: Genai.Retriever.Elser, spec?: UpsertSpec): Genai.Retriever.Elser | null;
     ...
     */
    merge(spec?: MergeSpec): Genai.Retriever.Elser | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): Genai.Retriever.Elser | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): Genai.Retriever.Elser | null;
     ...
     */
    static updateBatch(objs: Array_Type<Genai.Retriever.Elser>, srcObjs?: Array_Type<Genai.Retriever.Elser>, spec?: UpsertSpec): ObjList<Genai.Retriever.Elser> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<Genai.Retriever.Elser> | null>, spec?: UpsertSpec): ObjList<Genai.Retriever.Elser> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<Genai.Retriever.Elser>, srcObjs?: Array_Type<Genai.Retriever.Elser>, spec?: UpsertSpec): ObjList<Genai.Retriever.Elser> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<Genai.Retriever.Elser> | null>, spec?: UpsertSpec): ObjList<Genai.Retriever.Elser> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<Genai.Retriever.Elser>, spec?: TouchSpec): ObjList<Genai.Retriever.Elser> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.Retriever.Elser>, spec?: MergeSpec): ObjList<Genai.Retriever.Elser> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.Retriever.Elser>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.Retriever.Elser> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<Genai.Retriever.Elser> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.Retriever.Elser> | null;
     ...
     */
    static mergeAll(mergeObj: Genai.Retriever.Elser, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Genai.Retriever.Elser, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<Genai.Retriever.Elser>, spec?: UpsertSpec): ObjList<Genai.Retriever.Elser> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<Genai.Retriever.Elser>, spec?: UpsertSpec): ObjList<Genai.Retriever.Elser> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): Genai.Retriever.Elser | null;
     ...
     */
    static beforeCreate(objs: Array_Type<Genai.Retriever.Elser>): ObjList<Genai.Retriever.Elser>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<Genai.Retriever.Elser>): ObjList<Genai.Retriever.Elser>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<Genai.Retriever.Elser>): ObjList<Genai.Retriever.Elser>;
     ...
     */
    static afterCreate(objs: Array_Type<Genai.Retriever.Elser>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<Genai.Retriever.Elser>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<Genai.Retriever.Elser>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<Genai.Retriever.Elser>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Genai.Retriever.Elser>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Genai.Retriever.Elser | null;
     ...
     */
    withoutIdentity(): Genai.Retriever.Elser | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<Genai.Retriever.Elser>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: Genai.Retriever.Elser, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<Genai.Retriever.Elser>, callback?: λFunction<Genai.Retriever.Elser | null, Genai.Retriever.Elser | null>): ObjList<Genai.Retriever.Elser>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<Genai.Retriever.Elser>, callback?: λFunction<Genai.Retriever.Elser | null, Genai.Retriever.Elser | null>): Array_Type<ObjError> | null;
