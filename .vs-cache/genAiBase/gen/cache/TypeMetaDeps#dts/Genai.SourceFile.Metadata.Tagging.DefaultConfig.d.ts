// TypeScript definitions for the C3 type Genai.SourceFile.Metadata.Tagging.DefaultConfig

/**
 * Configuration to specify which {@link Genai.SourceFile.Metadata.Tagging.Config} should be used by the application.
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.SourceFile.Metadata.Tagging.DefaultConfig
 */
declare namespace Genai.SourceFile.Metadata.Tagging {
  export interface IDefaultConfig {
     ...
     */
    metadataTaggingConfigName: string;
  }
}
...
declare namespace Genai.SourceFile.Metadata.Tagging {
  export class DefaultConfig extends Obj  {
    ...
    withConfigOverride(configOverride: string | null): Genai.SourceFile.Metadata.Tagging.DefaultConfig;

    static readonly configOverride?: string;

    readonly secretOverride?: string;
    withSecretOverride(secretOverride: string | null): Genai.SourceFile.Metadata.Tagging.DefaultConfig;
    ...
    withIssues(issues: Array_Type<string> | Array<string> | null): Genai.SourceFile.Metadata.Tagging.DefaultConfig;
     ...
     * Name of {@link Genai.SourceFile.Metadata.Tagging.Config} that should be used by the Genai.SourceFile.Metadata.Tagging.Config.
     */
    readonly metadataTaggingConfigName: string;
    withMetadataTaggingConfigName(metadataTaggingConfigName: string): Genai.SourceFile.Metadata.Tagging.DefaultConfig;

    /**
     * Name of {@link Genai.SourceFile.Metadata.Tagging.Config} that should be used by the Genai.SourceFile.Metadata.Tagging.Config.
     */
    static readonly metadataTaggingConfigName: string;

    /**
     * @return the one and only instance to be used when member functions are called on this type.
     */
    static inst(): Genai.SourceFile.Metadata.Tagging.DefaultConfig;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.SourceFile.Metadata.Tagging.DefaultConfig | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.SourceFile.Metadata.Tagging.DefaultConfig | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.SourceFile.Metadata.Tagging.DefaultConfig | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.SourceFile.Metadata.Tagging.DefaultConfig | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.SourceFile.Metadata.Tagging.DefaultConfig;
     ...
     * This method is used during live metadata update
     */
    static replaceType(old: Type, new_: Type): Genai.SourceFile.Metadata.Tagging.DefaultConfig;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.SourceFile.Metadata.Tagging.DefaultConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.SourceFile.Metadata.Tagging.DefaultConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.SourceFile.Metadata.Tagging.DefaultConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.SourceFile.Metadata.Tagging.DefaultConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.SourceFile.Metadata.Tagging.DefaultConfig>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.SourceFile.Metadata.Tagging.DefaultConfig>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.SourceFile.Metadata.Tagging.DefaultConfig>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.SourceFile.Metadata.Tagging.DefaultConfig>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.SourceFile.Metadata.Tagging.DefaultConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.SourceFile.Metadata.Tagging.DefaultConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.SourceFile.Metadata.Tagging.DefaultConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.SourceFile.Metadata.Tagging.DefaultConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.SourceFile.Metadata.Tagging.DefaultConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.SourceFile.Metadata.Tagging.DefaultConfig;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.SourceFile.Metadata.Tagging.DefaultConfig;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    static validateObj(): Genai.SourceFile.Metadata.Tagging.DefaultConfig;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.SourceFile.Metadata.Tagging.DefaultConfig;
     ...
     * @see #defaultField
     */
    static withField(field: string, value: any, doNotConvert?: boolean): Genai.SourceFile.Metadata.Tagging.DefaultConfig;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.SourceFile.Metadata.Tagging.DefaultConfig;
     ...
     * @see #defaultField
     */
    static withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.SourceFile.Metadata.Tagging.DefaultConfig;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.SourceFile.Metadata.Tagging.DefaultConfig;
     ...
     * @return new Obj
     */
    static withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.SourceFile.Metadata.Tagging.DefaultConfig;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.SourceFile.Metadata.Tagging.DefaultConfig;
     ...
     * @return new Obj
     */
    static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.SourceFile.Metadata.Tagging.DefaultConfig;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.SourceFile.Metadata.Tagging.DefaultConfig;
     ...
     * @see #withoutField
     */
    static withoutFieldAtPath(path: string): Genai.SourceFile.Metadata.Tagging.DefaultConfig;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.SourceFile.Metadata.Tagging.DefaultConfig;
     ...
     * @see #removeField
     */
    static withoutField(field: string): Genai.SourceFile.Metadata.Tagging.DefaultConfig;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.SourceFile.Metadata.Tagging.DefaultConfig;
     ...
     * @see #removeField
     */
    static withoutField(field: FieldType): Genai.SourceFile.Metadata.Tagging.DefaultConfig;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.SourceFile.Metadata.Tagging.DefaultConfig;
     ...
     * @return new Obj with removed fields
     */
    static withoutFields(fields: Array_Type<string>): Genai.SourceFile.Metadata.Tagging.DefaultConfig;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.SourceFile.Metadata.Tagging.DefaultConfig;
     ...
     * @return new Obj with removed fields
     */
    static withoutFieldsByType(fields: Array_Type<FieldType>): Genai.SourceFile.Metadata.Tagging.DefaultConfig;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.SourceFile.Metadata.Tagging.DefaultConfig;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    static withoutSecretFields(): Genai.SourceFile.Metadata.Tagging.DefaultConfig;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.SourceFile.Metadata.Tagging.DefaultConfig;
     ...
     * @see FieldType#defaultValue
     */
    static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.SourceFile.Metadata.Tagging.DefaultConfig;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.SourceFile.Metadata.Tagging.DefaultConfig;
     ...
     * @see #unsetField
     */
    static defaultField(field: string): Genai.SourceFile.Metadata.Tagging.DefaultConfig;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.SourceFile.Metadata.Tagging.DefaultConfig;
     ...
     * @see #unsetField
     */
    static defaultField(field: FieldType): Genai.SourceFile.Metadata.Tagging.DefaultConfig;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.SourceFile.Metadata.Tagging.DefaultConfig;
     ...
     * @see #removeField
     */
    static unsetField(field: string): Genai.SourceFile.Metadata.Tagging.DefaultConfig;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.SourceFile.Metadata.Tagging.DefaultConfig;
     ...
     * @see #removeField
     */
    static unsetField(field: FieldType): Genai.SourceFile.Metadata.Tagging.DefaultConfig;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.SourceFile.Metadata.Tagging.DefaultConfig;
     ...
     * @see #unsetField
     */
    static removeField(field: string): Genai.SourceFile.Metadata.Tagging.DefaultConfig;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.SourceFile.Metadata.Tagging.DefaultConfig;
     ...
     * @see #unsetField
     */
    static removeField(field: FieldType): Genai.SourceFile.Metadata.Tagging.DefaultConfig;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.SourceFile.Metadata.Tagging.DefaultConfig;
     ...
     * @return the new merged Obj
     */
    static mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.SourceFile.Metadata.Tagging.DefaultConfig;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.SourceFile.Metadata.Tagging.DefaultConfig;
     ...
     * @return the new merged Obj
     */
    static mergeObj(other: Obj, otherFieldsFilter: Type): Genai.SourceFile.Metadata.Tagging.DefaultConfig;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.SourceFile.Metadata.Tagging.DefaultConfig;
     ...
     *        the same key or index.
     */
    static mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.SourceFile.Metadata.Tagging.DefaultConfig;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.SourceFile.Metadata.Tagging.DefaultConfig;
     ...
     * traverse child reference and collection fields.
     */
    static mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.SourceFile.Metadata.Tagging.DefaultConfig;

    mergeJson(json: any): Genai.SourceFile.Metadata.Tagging.DefaultConfig;

    static mergeJson(json: any): Genai.SourceFile.Metadata.Tagging.DefaultConfig;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.SourceFile.Metadata.Tagging.DefaultConfig;
     ...
     * @return Obj with child references merged
     */
    static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.SourceFile.Metadata.Tagging.DefaultConfig;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.SourceFile.Metadata.Tagging.DefaultConfig;
     ...
     * references with same name and collection elements at same index or key.
     */
    static sumObj(other: Obj, deep?: boolean): Genai.SourceFile.Metadata.Tagging.DefaultConfig;
     ...
     */
    singletonArray(): Array_Type<Genai.SourceFile.Metadata.Tagging.DefaultConfig>;
     ...
     * @return new array instance with this as only element.
     */
    static singletonArray(): Array_Type<Genai.SourceFile.Metadata.Tagging.DefaultConfig>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.SourceFile.Metadata.Tagging.DefaultConfig> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.SourceFile.Metadata.Tagging.DefaultConfig> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.SourceFile.Metadata.Tagging.DefaultConfig>;
     ...
     * @return new array instance with this as only element.
     */
    static singletonSet(): Set_Type<Genai.SourceFile.Metadata.Tagging.DefaultConfig>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.SourceFile.Metadata.Tagging.DefaultConfig> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.SourceFile.Metadata.Tagging.DefaultConfig> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.SourceFile.Metadata.Tagging.DefaultConfig> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.SourceFile.Metadata.Tagging.DefaultConfig>;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    static toBuilder(): ObjBuilder<Genai.SourceFile.Metadata.Tagging.DefaultConfig>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.SourceFile.Metadata.Tagging.DefaultConfig>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.SourceFile.Metadata.Tagging.DefaultConfig;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.SourceFile.Metadata.Tagging.DefaultConfig;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.SourceFile.Metadata.Tagging.DefaultConfig;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.SourceFile.Metadata.Tagging.DefaultConfig;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.SourceFile.Metadata.Tagging.DefaultConfig;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.SourceFile.Metadata.Tagging.DefaultConfig;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.SourceFile.Metadata.Tagging.DefaultConfig;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.SourceFile.Metadata.Tagging.DefaultConfig;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    static afterMake(): Genai.SourceFile.Metadata.Tagging.DefaultConfig;
     ...
     */
    static cachedEmptyInst(): Genai.SourceFile.Metadata.Tagging.DefaultConfig;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.SourceFile.Metadata.Tagging.DefaultConfig> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.SourceFile.Metadata.Tagging.DefaultConfig;
     ...
     */
    static allCached(): Stream<Genai.SourceFile.Metadata.Tagging.DefaultConfig> | null;
     ...
     */
    static find(filter?: string): Stream<Genai.SourceFile.Metadata.Tagging.DefaultConfig> | null;
     ...
     *         Otherwise no population will be performed.
     */
    static findBy(field: string, value: any): Stream<Genai.SourceFile.Metadata.Tagging.DefaultConfig> | null;

    /**
     * @return cached instance.
     */
    getCached(): Genai.SourceFile.Metadata.Tagging.DefaultConfig | null;

    /**
     * @return cached instance.
     */
    static getCached(): Genai.SourceFile.Metadata.Tagging.DefaultConfig | null;

    /**
     * Returns cached instance by key, with secrets removed.
     */
    static forCacheKey(key: string): Genai.SourceFile.Metadata.Tagging.DefaultConfig | null;
     ...
     */
    static produce(key: string): Genai.SourceFile.Metadata.Tagging.DefaultConfig | null;

    /**
     * Should produces the entire content for the cached data. Will populate the cache with the produced data.
     */
    static produceAll(): Map_Type<string, Genai.SourceFile.Metadata.Tagging.DefaultConfig> | null;
     ...
     */
    getConfig(): Genai.SourceFile.Metadata.Tagging.DefaultConfig;
     ...
     * Note that typical pattern is to use Configurable#config instead of this method.
     */
    static getConfig(): Genai.SourceFile.Metadata.Tagging.DefaultConfig;
     ...
     */
    getSecret(): Genai.SourceFile.Metadata.Tagging.DefaultConfig;
     ...
     * Note that typical pattern is to use Configurable#configWithSecrets instead of this method.
     */
    static getSecret(): Genai.SourceFile.Metadata.Tagging.DefaultConfig;
     ...
     */
    withConfigKey(configKey: string): Genai.SourceFile.Metadata.Tagging.DefaultConfig;
     ...
     *     config.configKey() => "folder1/abc"
     */
    static withConfigKey(configKey: string): Genai.SourceFile.Metadata.Tagging.DefaultConfig;

    /**
     * @return copy without config key.
     */
    withoutConfigKey(): Genai.SourceFile.Metadata.Tagging.DefaultConfig;

    /**
     * @return copy without config key.
     */
    static withoutConfigKey(): Genai.SourceFile.Metadata.Tagging.DefaultConfig;

    /**
     * @return return cached config instance for provided config key.
     */
    static forConfigKey(configKey: string): Genai.SourceFile.Metadata.Tagging.DefaultConfig | null;
     ...
     */
    static listConfigs(parallel?: boolean, filter?: λPredicate<string>): Stream<Genai.SourceFile.Metadata.Tagging.DefaultConfig> | null;
     ...
     * @see setConfigValue
     */
    setConfigValues(from: Genai.SourceFile.Metadata.Tagging.DefaultConfig, override?: string): void;
     ...
     * @see setConfigValue
     */
    static setConfigValues(from: Genai.SourceFile.Metadata.Tagging.DefaultConfig, override?: string): void;
     ...
     */
    static loadConfigAndSecret(configKey: string): Genai.SourceFile.Metadata.Tagging.DefaultConfig | null;
     ...
     */
    removeSecrets(): Genai.SourceFile.Metadata.Tagging.DefaultConfig | null;

    /**
     * @return this config without any secret values.
     */
    static removeSecrets(): Genai.SourceFile.Metadata.Tagging.DefaultConfig | null;

    /**
     * @return this config with only secret values.
     */
    removeNonSecrets(): Genai.SourceFile.Metadata.Tagging.DefaultConfig | null;

    /**
     * @return this config with only secret values.
     */
    static removeNonSecrets(): Genai.SourceFile.Metadata.Tagging.DefaultConfig | null;

    /**
     * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
     * validation and setup.
     */
    validate(): Genai.SourceFile.Metadata.Tagging.DefaultConfig;

    /**
     * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
     * validation and setup.
     */
    static validate(): Genai.SourceFile.Metadata.Tagging.DefaultConfig;
